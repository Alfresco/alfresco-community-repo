...
/**
 * Base class for running scripts against the {@link ScriptService}, in activiti's {@link
...
public class DelegateExecutionScriptBase extends ActivitiScriptBase {
    ...
    /**
     * Checks a valid Fully Authenticated User is set. If none is set then attempts to set the
     * workflow owner
     *
