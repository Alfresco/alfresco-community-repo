...
public class CompleteRecordTest extends BaseRMTestCase {
    private static final QName ASPECT_TEST =
            QName.createQName(
                    "http://www.alfresco.org/model/rmtest/1.0", "recordMetaDataWithProperty");
    private static final QName PROP_TEST =
            QName.createQName(
                    "http://www.alfresco.org/model/rmtest/1.0", "customMandatoryProperty");
    private static final QName CUSTOM_ELECTRONIC_TEST =
            QName.createQName(
                    RecordsManagementCustomModel.RM_CUSTOM_URI, "rmarecordCustomProperties");
    private static final QName CUSTOM_NON_ELECTRONIC_TEST =
            QName.createQName(
                    RecordsManagementCustomModel.RM_CUSTOM_URI,
                    "rmanonElectronicDocumentCustomProperties");
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * filed record is missing mandatory values When I try to complete the record Then the missing
     * properties parameter of the action will be populated And the record will not be complete
     */
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * filed record has all mandatory values When I try to complete the record Then the record is
     * completed
     */
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * filed record is missing custom mandatory values When I try to complete the record Then the
     * missing properties parameter of the action will be populated And the record will not be
     * complete
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() throws Exception {
                        ...
                        // create the custom metadata definition (that has a mandatory property) for
                        // electronic records
                        defineCustomMetadata(
                                CUSTOM_ELECTRONIC_TEST, ASPECT_RECORD, MANDATORY_METADATA);
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * filed record has all custom mandatory values When I try to complete the record Then the
     * record is completed
     */
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * non-electronic record is missing custom mandatory values When I try to complete the record
     * Then the missing properties parameter of the action will be populated And the record will not
     * be complete
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() throws Exception {
                        ...
                        defineCustomMetadata(
                                CUSTOM_NON_ELECTRONIC_TEST,
                                TYPE_NON_ELECTRONIC_DOCUMENT,
                                MANDATORY_METADATA);

                        // create a non-electronic record
                        nonElectronicRecord =
                                utils.createNonElectronicRecord(
                                        rmFolder, "non-electronicRecord.txt", "title");
                    }
                    ...
                    public void when() {
                        ...
                        result =
                                rmActionService.executeRecordsManagementAction(
                                        nonElectronicRecord, "declareRecord");
                    }
                    ...
                    public void then() {
                        ...
                        assertNotNull(result.getValue());
                        assertFalse(
                                nodeService.hasAspect(nonElectronicRecord, ASPECT_DECLARED_RECORD));
                    }
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * non-electronic record has all custom mandatory values When I try to complete the record Then
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And a
     * filed record is missing custom non-mandatory values When I try to complete the record Then
     * the record is completed
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() throws Exception {
                        ...
                        // create the custom metadata definition (that does not have a mandatory
                        // property)
                        defineCustomMetadata(
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And
     * custom mandatory metadata is required for electronic records And a non-electronic record has
     * no custom mandatory values When I try to complete the non-electronic record Then the record
     * is completed
     */
    public void testElectronicRecordCustomMandatoryNotAppliedToNonElectronicRecord()
            throws Exception {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    private NodeRef nonElectronicRecord;
                    ...
                    public void given() throws Exception {
                        ...
                        // create the record custom metadata definition (that has a mandatory
                        // property)
                        defineCustomMetadata(
                                CUSTOM_ELECTRONIC_TEST, ASPECT_RECORD, MANDATORY_METADATA);
    ...
    /**
     * Given the the application is configured to check for mandatory values before complete And
     * custom mandatory metadata is required for non-electronic records And an electronic record has
     * no custom mandatory values When I try to complete the electronic record Then the record is
     * completed
     */
    public void testNonElectronicRecordCustomMandatoryNotAppliedToElectronicRecord()
            throws Exception {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    private NodeRef record;
                    ...
                    public void given() throws Exception {
                        ...
                        // create the non-electronic record custom metadata definition (that has a
                        // mandatory property)
                        defineCustomMetadata(
                                CUSTOM_NON_ELECTRONIC_TEST,
                                TYPE_NON_ELECTRONIC_DOCUMENT,
    ...
    /**
     * Given the the application is configured not to check for mandatory values before complete And
     * a filed record is missing mandatory values When I try to complete the record Then the record
     * is completed
     */
     ...
     * And a filed record has all mandatory values When I try to complete the record Then the record
     * is completed
     */
     ...
     */
    private void defineCustomMetadata(QName propId, QName typeName, boolean mandatory)
            throws Exception {
