...
public class RecordsImplUnitTest {
    ...
    //        when(mockedDictionaryService.isSubClass(TYPE_UNFILED_RECORD_CONTAINER,
    // TYPE_RECORD_FOLDER)).thenReturn(false);
    //
    ...
    //        when(mockedNodes.getOrCreatePath(mockedTargetRecordFolder.getId(), null,
    // TYPE_CONTENT)).thenReturn(mockedTargetRecordFolder);
    //
    // when(mockedNodeService.getType(mockedTargetRecordFolder)).thenReturn(TYPE_RECORD_FOLDER);
    //        when(mockedDictionaryService.isSubClass(TYPE_RECORD_FOLDER,
    // TYPE_RECORD_FOLDER)).thenReturn(true);
    //
    //        /*
    //         * When trying to file the record in the record folder
    //         */
    ...
    //         * Then the record is moved under the destination folder
    //         */
    //        verify(mockedNodes).getOrCreatePath(mockedTargetRecordFolder.getId(), null,
    // TYPE_CONTENT);
    //        verify(mockedFileFolderService).moveFrom(mockedRecord, mockedPrimaryParent,
    // mockedTargetRecordFolder, null);
    //    }
    //
    //    /**
    ...
    //        NodeRef mockedTargetRecordFolder = AlfMock.generateNodeRef(mockedNodeService);
    //        when(mockedNodes.getOrCreatePath(fileplan.getId(), relativePath,
    // TYPE_CONTENT)).thenReturn(mockedTargetRecordFolder);
    //
    // when(mockedNodeService.getType(mockedTargetRecordFolder)).thenReturn(TYPE_RECORD_FOLDER);
    //        when(mockedDictionaryService.isSubClass(TYPE_RECORD_FOLDER,
    ...
    //    /**
    //     * Given an unfiled record
    //     *   and an existing record folder with relative path category/recordFolder from a given
    // category
    //     * When trying to file the record describing the target folder with the category id and
    // the relative path
    ...
    //    {
    //        /*
    //         * Given an unfiled record and an existing record folder with relative path
    // category/recordFolder from a given category
    //         */
    //        // mock the record to file
    //        NodeRef mockedRecord = AlfMock.generateNodeRef(mockedNodeService);
    //        when(mockedNodes.validateNode(mockedRecord.getId())).thenReturn(mockedRecord);
    ...
    //        String relativePath = "category/recordFolder";
    //        NodeRef mockedTargetRecordFolder = AlfMock.generateNodeRef(mockedNodeService);
    //        when(mockedNodes.getOrCreatePath(mockedTargetCategory.getId(), relativePath,
    // TYPE_CONTENT)).thenReturn(mockedTargetRecordFolder);
    //
    // when(mockedNodeService.getType(mockedTargetRecordFolder)).thenReturn(TYPE_RECORD_FOLDER);
    //        when(mockedDictionaryService.isSubClass(TYPE_RECORD_FOLDER,
    ...
    //
    //        /*
    //         *  When trying to file the record describing the target folder with the category id
    ...
    //         * Then the record is moved under the correct destination folder
    //         */
    //        verify(mockedNodes).getOrCreatePath(mockedTargetCategory.getId(), relativePath,
    // TYPE_CONTENT);
    //        verify(mockedFileFolderService).moveFrom(mockedRecord, mockedPrimaryParent,
    // mockedTargetRecordFolder, null);
    //    }
