...
public class JscriptWorkflowNode implements Serializable
{
     ...
     * @param description
     *            Description of workflow node
     * @param isTaskNode
     *            <code>true</code> if this node is a task node
     * @param transitions
     ...
     * 
     * @param workflowNode
     *            CMR workflow node object to create new <code>JscriptWorkflowNode</code> from
     * @param scope
     *            root scripting scope for this newly instantiated object
     * @param serviceRegistry
     *            service registry object
     */
