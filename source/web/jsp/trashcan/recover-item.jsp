...
<r:page titleId="title_recover_item">
               ...
               <tr>
                  ...
                  <td bgcolor="#dfe6ed">
                     ...
                     <table cellspacing="4" cellpadding="0" width="100%">
                        <tr>
                           <td width="32">
                              <h:graphicImage url="/images/icons/recover_large.gif"/>
                           </td>
                           <td>
                              <div class="mainTitle"><h:outputText value="#{msg.recover_item}" /> '<h:outputText value="#{TrashcanBean.item.name}" />'</div>
                              <div class="mainSubText"><h:outputText value="#{msg.recover_item_info}" /></div>
                           </td>
                        </tr>
                     </table>
                        ...
                        <tr>
                           ...
                           <td valign="top">
                              ...
                              <table cellpadding="1" cellspacing="1" border="0">
                                 <tr>
                                    <td align="center">
                                       <h:commandButton value="#{msg.yes}" action="#{TrashcanBean.recoverItemOK}" styleClass="dialogControls" />
                                    </td>
                                 </tr>
