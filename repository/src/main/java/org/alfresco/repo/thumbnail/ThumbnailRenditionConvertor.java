...
public class ThumbnailRenditionConvertor {
  ...
  public RenditionDefinition convert(
    ...
    Map<String, Serializable> parameters =
      this.convert(transformationOptions, assocDetails);
    ...
    putParameterIfNotNull(
      AbstractRenderingEngine.PARAM_RUN_AS,
      thumbnailDefinition.getRunAs(),
      parameters
    );

    QName namespacedRenditionName = QName.createQName(
    ...
    String renderingEngineName = isImageThumbnail
      ? ImageRenderingEngine.NAME
      : ReformatRenderingEngine.NAME;

    RenditionDefinition renditionDef = renditionService.createRenditionDefinition(
      namespacedRenditionName,
      renderingEngineName
    );
   ...
   */
  private boolean isImageBasedRendition(
    ThumbnailDefinition thumbnailDefinition
  ) {
  ...
  public Map<String, Serializable> convert(
    ...
    if (transformationOptions instanceof SWFTransformationOptions) {
      ...
      if (imgResizeOptions != null) {
        ...
        parameters.put(
          ImageRenderingEngine.PARAM_IS_PERCENT_RESIZE,
          percentResize
        );
  ...
  public ThumbnailDefinition convert(RenditionDefinition renditionDefinition) {
    ...
    if (flashVersion != null) {
      ...
      Serializable xsize = renditionDefinition.getParameterValue(
        ImageRenderingEngine.PARAM_RESIZE_WIDTH
      );
      if (xsize != null) {
        resizeOptions.setWidth(((Integer) xsize).intValue());
      }

      Serializable ysize = renditionDefinition.getParameterValue(
        ImageRenderingEngine.PARAM_RESIZE_HEIGHT
      );
      if (ysize != null) {
        resizeOptions.setHeight(((Integer) ysize).intValue());
      }

      Serializable maintainAspectRatio = renditionDefinition.getParameterValue(
        ImageRenderingEngine.PARAM_MAINTAIN_ASPECT_RATIO
      );
      ...
      Serializable resizeToThumbnail = renditionDefinition.getParameterValue(
        ImageRenderingEngine.PARAM_RESIZE_TO_THUMBNAIL
      );
      ...
      Serializable allowEnlargement = renditionDefinition.getParameterValue(
        ImageRenderingEngine.PARAM_ALLOW_ENLARGEMENT
      );
