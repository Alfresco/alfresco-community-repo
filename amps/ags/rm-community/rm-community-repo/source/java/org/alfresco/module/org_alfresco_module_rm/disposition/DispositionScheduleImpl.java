...
public class DispositionScheduleImpl
  implements DispositionSchedule, RecordsManagementModel {
  ...
  public String getDispositionAuthority() {
    return (String) this.nodeService.getProperty(
   ...
   */
  @Override
  public DispositionActionDefinition getDispositionActionDefinitionByName(
    String name
  ) {
  ...
  private void getDispositionActionsImpl() {
    ...
    for (ChildAssociationRef assoc : assocs) {
      DispositionActionDefinition da = new DispositionActionDefinitionImpl(
      ...
      String actionNodeName = (String) nodeService.getProperty(
        assoc.getChildRef(),
      ...
      String actionDefintionName = (String) nodeService.getProperty(
        assoc.getChildRef(),
