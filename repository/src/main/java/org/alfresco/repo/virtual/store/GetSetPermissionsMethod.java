...
public class GetSetPermissionsMethod
  ...
  @Override
  public NodePermissionEntry execute(
  ...
  private NodePermissionEntry execute(
    ...
    for (String permission : toAllow) {
      PermissionReference permissionReference = PermissionReferenceImpl.getPermissionReference(
        userPermissions.getPermissionTypeQName(),
        permission
      );
      permissions.add(
