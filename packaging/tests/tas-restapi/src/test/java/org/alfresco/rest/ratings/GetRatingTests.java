...
public class GetRatingTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role is able to retrieve rating of a document")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role is able to retrieve rating of a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user is not able to retrieve rating of a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that using invalid ratingId for get rating call returns status code"
                            + " 400.")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that using invalid node ID for get rating call returns status code 404.")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
