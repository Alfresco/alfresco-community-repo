...
public class CheckOutTests extends CmisTest {
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp = "^Check out failed.*This node is already checked out.$"
  )
  ...
  public void contributorCannotCheckOutDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void unauthorizedUserCannotCheckOutDocumentFromPrivateSite()
    throws Exception {
  ...
  public void unauthorizedUserCannotCheckOutDocumentModeratedSite()
    throws Exception {
