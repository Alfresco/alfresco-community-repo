...
public class DictionaryDAOTest {
    ...
    private void initDictionaryCaches(
            DictionaryDAOImpl dictionaryDAO, TenantService tenantService) {
    ...
    public void testLabels() {
        ...
        ListOfValuesConstraint lovConstraint =
                (ListOfValuesConstraint) constraintDef.getConstraint();
        assertEquals(
        ...
        assertEquals(
                ...
                lovConstraint.getDisplayLabel("VALUE WITH SPACES", service)); // Keys with spaces.
        assertEquals(
                "Wrong localised lov value.",
                "VALUE WITH TRAILING SPACE display",
                lovConstraint.getDisplayLabel(
                        "VALUE WITH TRAILING SPACE ", service)); // Keys with trailing space.
        ...
        assertEquals(
                "Wrong localised lov value.",
                "GAMMA, DELTA display",
                lovConstraint.getDisplayLabel("GAMMA, DELTA", service)); // Keys with commas
        assertEquals(
                "Wrong localised lov value.",
                "OMEGA",
