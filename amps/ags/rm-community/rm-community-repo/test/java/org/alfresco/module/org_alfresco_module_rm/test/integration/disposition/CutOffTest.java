...
public class CutOffTest extends BaseRMTestCase {
    /**
     * given we have a record folder that is eligible for cutoff ensure that the record can be cut
     * off successfully.
     */
     ...
     *
     * <p>relates to https://issues.alfresco.com/jira/browse/RM-1340
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void when() {
                        ...
                        Map<String, Serializable> params = new HashMap<>(1);
                        params.put(
                                RMDispositionActionExecuterAbstractBase.PARAM_NO_ERROR_CHECK,
                                Boolean.FALSE);
                        try {
                            rmActionService.executeRecordsManagementAction(
                                    recordFolder, CutOffAction.NAME, params);
