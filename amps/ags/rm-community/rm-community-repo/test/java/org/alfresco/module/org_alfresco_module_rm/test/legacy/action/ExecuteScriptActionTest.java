...
public class ExecuteScriptActionTest extends BaseRMTestCase {
    ...
    public void testExecuteScript() {
        ...
        String fileOriginalName =
                (String) nodeService.getProperty(dmDocument, ContentModel.PROP_NAME);

        // Valid Script
        NodeRef validScriptRef =
                addTempScript(
                        "valid-rm-script.js",
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public void test(Void result) throws Exception {
                        ...
                        String currentName =
                                (String)
                                        nodeService.getProperty(dmDocument, ContentModel.PROP_NAME);
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        nodeService.setProperty(
                                dmDocument, ContentModel.PROP_NAME, fileOriginalName);
                        return null;
                    }
                });
    }
    ...
    private NodeRef addTempScript(
            final String scriptFileName, final String javaScript, final NodeRef parentRef) {
        AuthenticationUtil.setFullyAuthenticatedUser(AuthenticationUtil.getAdminUserName());
                    ...
                    public NodeRef execute() throws Throwable {
                        ...
                        NodeRef script =
                                nodeService.getChildByName(
                                        parentRef, ContentModel.ASSOC_CONTAINS, scriptFileName);
                        ...
                        if (script == null) {
                            ...
                            ContentWriter contentWriter =
                                    contentService.getWriter(
                                            script, ContentModel.PROP_CONTENT, true);
