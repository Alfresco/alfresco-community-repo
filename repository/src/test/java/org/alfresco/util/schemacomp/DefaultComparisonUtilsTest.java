...
public class DefaultComparisonUtilsTest {
    ...
    public void compareSimple() {
        ...
        verify(differences)
                .add(Where.IN_BOTH_NO_DIFFERENCE, prop("not_null_string"), prop("not_null_string"));
    ...
    public void compareCollections() {
        ...
        verify(differences)
                .add(Where.IN_BOTH_BUT_DIFFERENCE, new DbProperty(db1), new DbProperty(db1));
        ...
        verify(differences)
                .add(Where.IN_BOTH_BUT_DIFFERENCE, new DbProperty(db4), new DbProperty(db4));
    }
    ...
    public void compareCollectionsWithMultipleMatches() {
        ...
        verify(differences)
                .add(Where.IN_BOTH_BUT_DIFFERENCE, new DbProperty(db1), new DbProperty(db1));
        verify(differences)
                .add(Where.IN_BOTH_BUT_DIFFERENCE, new DbProperty(db1), new DbProperty(db2));
        verify(differences)
                .add(Where.IN_BOTH_BUT_DIFFERENCE, new DbProperty(db1), new DbProperty(db3));
    }
    ...
    public void orderingFaultsWhenReferenceCollectionLonger() {
        ...
        verify(differences)
                .add(Where.ONLY_IN_REFERENCE, dbPropForValue(refDbObj, "collection[3]", "1"), null);
        verify(differences)
                .add(Where.ONLY_IN_REFERENCE, dbPropForValue(refDbObj, "collection[4]", "2"), null);
    }
    ...
    public void orderingFaultsWhenTargetCollectionLonger() {
        ...
        verify(differences)
                .add(
                        ...
                        dbPropForValue(targetDbObj, "collection[2]", "x"));
        verify(differences)
                .add(Where.ONLY_IN_TARGET, null, dbPropForValue(targetDbObj, "collection[3]", "1"));
        verify(differences)
                .add(Where.ONLY_IN_TARGET, null, dbPropForValue(targetDbObj, "collection[4]", "2"));
    }
