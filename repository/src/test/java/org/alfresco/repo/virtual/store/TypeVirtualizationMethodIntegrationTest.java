...
public class TypeVirtualizationMethodIntegrationTest
  ...
  public void testFiltering() throws Exception {
    ...
    ChildAssociationRef typedNodeAssocRef = createTypedNode(
    ...
    assertFalse(
      typeVirtualizationMethod.canVirtualize(environment, virtuaChildRef)
    );
  ...
  public void testVirtualizeCmFolder_recusive() throws Exception {
    ChildAssociationRef templateContentChildRef = addTypeTemplate(
  ...
  public void testCanVirtualizeAspect() throws Exception {
    ChildAssociationRef aspectNodeAssocRef = createTypedNode(
      testRootFolder.getNodeRef(),
      "TypeVirtualized",
      ContentModel.TYPE_FOLDER
    );
    ...
    assertFalse(
      typeVirtualizationMethod.canVirtualize(environment, aspectNode)
    );
  ...
  public void testVirtualizeAspect() throws Exception {
    ...
    virtualize(
      templateContentChildRef.getChildRef(),
      ContentModel.TYPE_FOLDER,
      TEST_ASPECT
    );
  }
  ...
  private void virtualize(
    NodeRef expectedTemplateNodeRef,
    QName fodlerType,
    QName... aspects
  ) throws Exception {
    ChildAssociationRef typedNodeAssocRef = createTypedNode(
    ...
    Reference theVirtualizedNode = typeVirtualizationMethod.virtualize(
      environment,
      typeNode
    );
    ...
    ResourceParameter vanillaResourceParameter = (ResourceParameter) parameters.get(
      VanillaProtocol.VANILLA_TEMPLATE_PARAM_INDEX
    );
    Resource vanillaResource = vanillaResourceParameter.getValue();

    NodeRef resourceNodeRef = vanillaResource.processWith(
  ...
  private synchronized ChildAssociationRef addTypeTemplate(
    QName theType,
    String cp
  ) {
    ...
    final String prefixedType = theType.toPrefixString(
    ...
    ChildAssociationRef templateContentChildRef = createContent(
      templatesLocation,
      contentName,
      testTemplsteJsonIS,
      "application/json",
