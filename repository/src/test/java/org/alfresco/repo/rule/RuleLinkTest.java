...
public class RuleLinkTest extends BaseSpringTest {
  ...
  protected static final String ACTION_DEF_NAME =
    AddFeaturesActionExecuter.NAME;
  protected static final String ACTION_PROP_NAME_1 =
    AddFeaturesActionExecuter.PARAM_ASPECT_NAME;
  protected static final QName ACTION_PROP_VALUE_1 =
    ContentModel.ASPECT_LOCKABLE;
  protected static final String CONDITION_DEF_NAME =
    ComparePropertyValueEvaluator.NAME;
  protected static final String COND_PROP_NAME_1 =
  ...
  public void before() throws Exception {
    ...
    folderOne =
      fileFolderService
        .create(folder, "folderOne", ContentModel.TYPE_FOLDER)
        .getNodeRef();
    folderTwo =
      fileFolderService
        .create(folder, "folderTwo", ContentModel.TYPE_FOLDER)
        .getNodeRef();
    folderThree =
      fileFolderService
        .create(folder, "folderThree", ContentModel.TYPE_FOLDER)
        .getNodeRef();
  }
  ...
  public void testRelink() {
    ...
    try {
      ...
      fail(
        "Shouldn't be able to link a folder that already has rules that it owns."
      );
  ...
  protected Rule createTestRule(boolean isAppliedToChildren, String title) {
    ...
    ActionCondition actionCondition =
      this.actionService.createActionCondition(CONDITION_DEF_NAME);
