...
/**
 * <p>Java class for relationshipCollection element declaration.
 * 
...
public class RelationshipCollection {
    ...
    protected List<RelationshipObjectType> object;
     ...
     * 
     */
    public List<RelationshipObjectType> getObject() {
        if (object == null) {
            object = new ArrayList<RelationshipObjectType>();
        }
        return this.object;
    }
