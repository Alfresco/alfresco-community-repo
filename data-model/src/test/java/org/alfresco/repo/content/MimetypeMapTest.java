...
public class MimetypeMapTest extends TestCase
{
    ...
    private static final String MIMETYPE_1A = "      <mimetype mimetype=\"mimetype1\" display=\"Mimetype ONE\">" +
            "        <extension display=\"Extension ONE\">ext1a</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_1B = "      <mimetype mimetype=\"mimetype1\" display=\"Mimetype ONE\">" +
            "        <extension display=\"Extension 1\">ext1a</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_1C = "      <mimetype mimetype=\"mimetype1\" display=\"Mimetype ONE\">" +
            "        <extension>ext1a</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_1D = "      <mimetype mimetype=\"mimetype1\" display=\"Mimetype 1\">" +
            "        <extension>ext1a</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_1E = "      <mimetype mimetype=\"mimetype1\" text=\"true\">" +
            "        <extension>ext1a</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_1F = "      <mimetype mimetype=\"mimetype1\" text=\"true\">" +
            "        <extension>ext1a</extension>" +
            "        <extension default=\"true\">ext1b</extension>" +
            "        <extension>ext1c</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_1G = "      <mimetype mimetype=\"mimetype1\" text=\"true\">" +
            "        <extension>ext1c</extension>" +
            "        <extension>ext1b</extension>" +
            "        <extension>ext1a</extension>" +
            "      </mimetype>";

    private static final String MIMETYPE_2A = "      <mimetype mimetype=\"mimetype2\" display=\"Mimetype TWO\" text=\"true\">" +
            "        <extension>ext2a</extension>" +
            "      </mimetype>";
    private static final String MIMETYPE_2B = "      <mimetype mimetype=\"mimetype2\" display=\"Mimetype TWO\">" +
            "        <extension>ext2a</extension>" +
            "      </mimetype>";

    private static final String MIMETYPE_3A = "      <mimetype mimetype=\"mimetype3\" display=\"Mimetype THREE\">" +
    ...
    private void setConfigService(final String mimetypes)
    {
        ConfigSource configSource = new ConfigSource() {
            ...
            {
                String xml = "<alfresco-config area=\"mimetype-map\">" +
