 ...
 *     <p>Render Date to ISO8601 format.<br>
 *     Or parse ISO6801 format string date to a Date object.
 *     <p>Usage: xmldate(Date date) xmldate(String date)
 */
public class ISO8601DateFormatMethod extends BaseTemplateProcessorExtension
