...
public class StandardQuotaStrategyMockTest {
    ...
    @Mock private CachedContentCleaner cleaner;
    ...
    public void testCanSetMaxUsageInMB() throws IllegalAccessException {
        ...
        assertEquals(
                0, ((Long) FieldUtils.readDeclaredField(quota, "maxUsageBytes", true)).longValue());

        quota.setMaxUsageMB(500);
        assertEquals(
                524288000,
                ((Long) FieldUtils.readDeclaredField(quota, "maxUsageBytes", true)).longValue());
