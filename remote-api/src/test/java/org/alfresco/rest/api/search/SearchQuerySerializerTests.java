...
public class SearchQuerySerializerTests {
    ...
    public void testSerializeContext() throws IOException {
        ...
        FacetFieldContext ffc =
                new FacetFieldContext(
                        "theLabel",
                        Arrays.asList(
        ...
        CollectionWithPagingInfo<ExecutionResult> coll =
                CollectionWithPagingInfo.asPaged(
                        null, Arrays.asList(exec1), false, 2, null, searchContext);
        ...
        assertTrue(
                ...
                out.contains("{\"label\":\"f1\",\"filterQuery\":\"creator:bob\",\"count\":15}"));
        assertTrue(
        ...
        assertTrue(
                ...
                out.contains("{\"label\":\"b2\",\"count\":34,\"display\":\"displayText2\"}"));
        assertTrue(
