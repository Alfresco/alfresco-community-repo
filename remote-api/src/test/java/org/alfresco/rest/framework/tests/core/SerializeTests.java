...
public class SerializeTests
  ...
  public void testInvokeEntity() throws IOException {
    ResourceWithMetadata entityResource = locator.locateEntityResource(
      api,
      "sheep",
      HttpMethod.GET
    );
    ...
    String out = writeResponse(
      helper.processAdditionsToTheResponse(
        mock(WebScriptResponse.class),
        api,
        null,
        NOT_USED,
        getter.readById("1234A3", NOT_USED)
      )
    );
    assertTrue(
      "There must be json output",
      StringUtils.startsWith(out, "{\"entry\":")
    );
    ...
    out =
      writeResponse(
        helper.processAdditionsToTheResponse(
          ...
          api,
          null,
          Params.valueOf("notUsed", null, null),
          resources
        )
      );
    assertTrue(
      "There must be json output as List",
      StringUtils.startsWith(out, "{\"list\":")
    );
  }
  ...
  public void testInvokeMultiPartEntity() throws IOException {
    ...
    MultiPartRequest reqBody = MultiPartBuilder
      .create()
      .setFileData(
        new FileData(file.getName(), file, MimetypeMap.MIMETYPE_TEXT_PLAIN)
      )
      .build();
    ...
    String out = writeResponse(
      helper.processAdditionsToTheResponse(
        ...
        null,
        NOT_USED,
        resource.create(new FormData(mockRequest), NOT_USED, callBack)
      )
    );
    assertTrue(
      "There must be json output",
  ...
  public void testSerializeResponse() throws IOException {
    ResourceWithMetadata relationResource = locator.locateRelationResource(
      api,
      "sheep",
      "baaahh",
      HttpMethod.GET
  ...
  public void testPagedCollection() throws IOException {
    ...
    assertTrue(
      "There must be json output as List with pagination",
    ...
    resources =
      getter.readAll(
        "123",
        ParamsExtender.valueOf(Paging.valueOf(0, 1), "123")
      );
  ...
  public void testExpandEmbedded() throws IOException {
    ...
    ExecutionResult res = (ExecutionResult) helper.processAdditionsToTheResponse(
      mock(WebScriptResponse.class),
      api,
      null,
      Params.valueOf("notUsed", null, null),
    ...
    ExecutionResult grassEmbed = (ExecutionResult) goat
      .getEmbedded()
      .get("grass");
  ...
  public void testExpandRelations() throws IOException {
    assertNotNull(helper);
    Map<String, BeanPropertiesFilter> rFilter = getRelationFilter(
      "blacksheep,baaahh"
    );
    ExecutionResult res = (ExecutionResult) helper.processAdditionsToTheResponse(
      mock(WebScriptResponse.class),
      api,
      "sheep",
      ParamsExtender.valueOf(rFilter, "1"),
      new Farmer("180")
    );
    assertNotNull(res);
    String out = writeResponse(res);
    ...
    Object resultCollection = helper.processAdditionsToTheResponse(
      mock(WebScriptResponse.class),
      api,
      "sheep",
      ParamsExtender.valueOf(rFilter, "1"),
      CollectionWithPagingInfo.asPaged(
        pageRequest,
        Arrays.asList(new Farmer("180"), new Farmer("190"), new Farmer("280"))
      )
    );
  ...
  public void testIncludeSource() throws IOException {
    ...
    CollectionWithPagingInfo<ExecutionResult> coll = CollectionWithPagingInfo.asPaged(
      null,
      Arrays.asList(exec1, exec2)
    );
    ...
    Object resultCollection = helper.processAdditionsToTheResponse(
      ...
      api,
      "sheep",
      ParamsExtender.valueOf(true, "1"),
      coll
    );
    assertNotNull(resultCollection);
    String out = writeResponse(resultCollection);
    assertTrue(
      "There must 'source' json output",
      StringUtils.contains(
        out,
        "\"source\":{\"name\":\"Dolly\",\"age\":3,\"sheepGuid\":\"1\"}"
      )
    );
    ...
    resultCollection =
      helper.processAdditionsToTheResponse(
        ...
        api,
        "sheep",
        ParamsExtender.valueOf(false, "1"),
        coll
      );
    assertNotNull(resultCollection);
    out = writeResponse(resultCollection);
    assertFalse(
      "There must not 'source' json output",
      StringUtils.contains(
        out,
        "\"source\":{\"name\":\"Dolly\",\"age\":3,\"sheepGuid\":\"1\"}"
      )
    ...
    assertTrue(
      ...
      StringUtils.contains(
        out,
        "\"source\":{\"name\":\"Dolly\",\"age\":3,\"sheepGuid\":\"barbie\""
      )
    );
  }
  ...
  public void testExpandRecursiveRelations() throws IOException {
    ExecutionResult exec1 = new ExecutionResult(new Farmer("180"), null);
    ExecutionResult exec2 = new ExecutionResult(
      new Farmer("456"),
      getFilter("age")
    );
    CollectionWithPagingInfo<ExecutionResult> coll = CollectionWithPagingInfo.asPaged(
    ...
    assertTrue("There must be json output", StringUtils.isNotBlank(out));
    assertFalse(
      "collections should be serialized correctly.  There may be a problem with this one.",
      StringUtils.contains(out, "\"collection\":[")
    );
    assertTrue(
      "collections should be serialized correctly.  There should be embed relations",
      StringUtils.contains(out, "\"relations\":{\"farmers\":{\"list\":")
    );
  }
  ...
  public void testSerializeExecutionResult() throws IOException {
    assertNotNull(helper);
    Object res = helper.processAdditionsToTheResponse(
      mock(WebScriptResponse.class),
      api,
      null,
      Params.valueOf("notUsed", null, null),
  ...
  public void testSerializePagedCollection() throws IOException {
    assertNotNull(helper);
    CollectionWithPagingInfo paged = CollectionWithPagingInfo.asPaged(
      null,
      null
    );
    String out = writeResponse(
    ...
    assertTrue(
      ...
      StringUtils.startsWith(
        out,
        "{\"list\":{\"pagination\":{\"count\":3,\"hasMoreItems\":true,\"totalItems\":5000"
      )
    );
  }
  ...
  public void testSerializeListOfSimpleType() throws IOException {
    assertNotNull(helper);
    CollectionWithPagingInfo<String> pString = CollectionWithPagingInfo.asPaged(
      null,
      Arrays.asList("goat", "sheep", "horse")
    );
    Object res = helper.processAdditionsToTheResponse(
      mock(WebScriptResponse.class),
      api,
    ...
    String out = writeResponse(res);
    assertTrue("There must be json output", StringUtils.isNotBlank(out));
    CollectionWithPagingInfo<Integer> pInts = CollectionWithPagingInfo.asPaged(
      null,
      Arrays.asList(234, 45, 890, 3456)
    );
    res =
      helper.processAdditionsToTheResponse(
        mock(WebScriptResponse.class),
  ...
  public void testSerializeUniqueId() throws IOException {
    ...
    String out = writeResponse(res);
    assertTrue(
      "Id field must be called sheepGuid.",
      StringUtils.contains(out, "\"sheepGuid\":\"ABCD\"")
    );
  }
  ...
  public void testInvokeRelation() throws IOException {
    ...
    String out = writeResponse(
      helper.processAdditionsToTheResponse(
        ...
        null,
        Params.valueOf("notUsed", null, null),
        getter.readAll("1234A3", Params.valueOf("notUsed", null, null))
      )
    );
    assertTrue("There must be json output", StringUtils.isNotBlank(out));
  }
  ...
  public void testSerializeBinaryProperty() throws IOException {
    ...
    assertTrue(
      "Only show the mimeType",
      out.equals("{\"mimeType\":\"application/json\"}")
    );
    prop = new BinaryProperty(Format.XML.mimetype(), "UTF-8", 45, null);
    out = writeResponse(prop);
    assertTrue(
      "Type is xml.",
      StringUtils.contains(out, "\"mimeType\":\"text/xml\"")
    );
    assertTrue(
      "Size must be serialized.",
      StringUtils.contains(out, "\"sizeInBytes\":45")
    );
    ...
    out = writeResponse(prop);
    assertFalse(
      "Locale should not be serialized",
      StringUtils.contains(out, "\"locale\"")
    );
    ...
    assertTrue(
      "Size must be serialized.",
      StringUtils.contains(out, "\"sizeInBytes\":99")
    );
  }
  ...
  public void testInvokeProperty() throws IOException {
    ...
    ResourceWithMetadata propResource = locator.locateRelationResource(
      api3,
      "flock",
      "photo",
      HttpMethod.GET
  ...
  public void testInvokeVersions() throws IOException {
    ...
    assertTrue(
      "Version 1 must be a goat.",
      Goat.class.equals(readById.getClass())
    );
    ...
    assertTrue(
      "Version 3 must be a slim goat.",
      SlimGoat.class.equals(readByIdForNewVersion.getClass())
    );
    ...
    try {
      entityResource =
        locator.locateEntityResource(v3, "grass", HttpMethod.GET);
  ...
  public void testFilter() throws IOException, JSONException {
    ...
    String out = writeResponse(res);
    assertTrue(
      "Filter must only return the age.",
      StringUtils.contains(out, "{\"age\":3}")
    );
    ...
    res =
      helper.processAdditionsToTheResponse(
        ...
        v3,
        "goat",
        ParamsExtender.valueOf(relFiler, "notUsed"),
        new SlimGoat()
      );
    out = writeResponse(res);
    jsonRsp = new JSONObject(new JSONTokener(out));
    ...
    out = writeResponse(res);
    assertTrue(
      "Must return only the herd name.",
      StringUtils.contains(out, "{\"name\":\"bigun\"}")
    );
  }
