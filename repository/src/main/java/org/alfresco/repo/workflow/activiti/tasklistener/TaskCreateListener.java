...
public class TaskCreateListener implements TaskListener {
  ...
  public void notify(DelegateTask task) {
    ...
    TypeDefinition typeDefinition = propertyConverter
    ...
    ActivitiScriptNode initiatorNode = (ActivitiScriptNode) task
      .getExecution()
      .getVariable(WorkflowConstants.PROP_INITIATOR);
  ...
  private String getFormKey(DelegateTask task) {
    ...
    TaskFormHandler taskFormHandler = taskEntity
      .getTaskDefinition()
      .getTaskFormHandler();
   ...
   */
  public void setPropertyConverter(
