// $ANTLR !Unknown version! W:\\alfresco\\HEAD\\root\\projects\\Repository\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g 2009-04-14 14:31:09
...
public class CMISParser extends Parser {
    ...
    public final CMISParser.valueFunction_return valueFunction() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: functionName, RPAREN, functionArgument, LPAREN
            // token labels: 
    ...
    public final CMISParser.quantifiedComparisonPredicate_return quantifiedComparisonPredicate() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: multiValuedColumnReference, literalOrParameterName, ANY, compOp
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final CMISParser.quantifiedInPredicate_return quantifiedInPredicate() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: inValueList, NOT, multiValuedColumnReference, ANY
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
