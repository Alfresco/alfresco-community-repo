 ...
 *
 * <p>POST: {@literal <host>:<port>/alfresco/api/<networkId>/public/search/versions/1/search}
 *
 * @author Gethin James
 */
...
public class BasicSearchApiIntegrationTest extends AbstractSingleNetworkSiteTest {
    ...
    private static final String json =
            "{ \"query\": {\"query\": \"cm:name:king\",\"userQuery\": \"great\",\"language\":"
                    + " \"afts\"}, \"fields\" : [\"id\",\"name\", \"search\"]}";
    private static final String bad_json =
            "{ \"query\": {\"qu\": \"cm:some nonsense \",\"userQuery\": \"great\",\"language\":"
                    + " \"afts\"}}";
    ...
    public void testQuery() throws Exception {
        ...
        try {
            // As user 1 ...
            // Try to get nodes with search term 'king*' - assume clean repo (ie. none to start
            // with)
            ...
            response =
                    post(URL_SEARCH, SerializerTestHelper.JSON, null, null, SEARCH_API_NAME, 200);
