...
/**
 * This component controls the execution of {@link org.alfresco.repo.module.ModuleComponent module
 * startup components}.
 *
 * <p>All required startup executions are performed in a single transaction, so this component
 * guarantees that the module initialization is consistent. Module components are executed in
 * dependency order <i>only</i>. The version numbering is not to be used for ordering purposes.
 *
 * <p>Afterwards, execution details are persisted in the {@link
 * org.alfresco.repo.admin.registry.RegistryService service registry} to be used when the server
 * starts up again.
 *
...
public class ModuleServiceImpl implements ApplicationContextAware, ModuleService {
        ...
        for (String moduleId : moduleIds) {
            ...
            if (moduleDetails == null) {
                ...
                ModuleDetails newModuleDetails =
                        new ModuleDetailsImpl(moduleId, currentVersion, "", "");
     ...
     *
     * <p>TODO: We will have to avoid caching or add context listening if we support reloading of
     * beans one day.
     */
            ...
            for (Resource resource : resources) {
                try {
                    ...
                    throw AlfrescoRuntimeException.create(
                            e, ERR_UNABLE_TO_OPEN_MODULE_PROPETIES, resource);
                }
            }
        } catch (IOException e) {
