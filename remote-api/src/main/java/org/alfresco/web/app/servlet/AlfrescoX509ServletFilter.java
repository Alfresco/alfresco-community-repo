...
public class AlfrescoX509ServletFilter extends X509ServletFilterBase {
  ...
  private static Log logger = LogFactory.getLog(
    AlfrescoX509ServletFilter.class
  );

  @Override
  protected boolean checkEnforce(ServletContext servletContext)
    throws IOException {
    /*
    ...
    Properties globalProperties = (Properties) wc.getBean(
      BEAN_GLOBAL_PROPERTIES
    );
