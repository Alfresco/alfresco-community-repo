 ...
 *
 * <p>Responsible for keeping a record of behaviours to execute at the end of a transaction.
 */
public class TransactionBehaviourQueue implements TransactionListener {
    ...
    private static final String QUEUE_CONTEXT_KEY =
            TransactionBehaviourQueue.class.getName() + ".context";
     ...
     * @param definition PolicyDefinition
     *     <p>
    ...
    public <P extends Policy> void queue(
            Behaviour behaviour,
        ...
        QueueContext queueContext =
                (QueueContext) AlfrescoTransactionSupport.getResource(QUEUE_CONTEXT_KEY);
        ...
        ExecutionInstanceKey key =
                new ExecutionInstanceKey(behaviour, definition.getArguments(), args);
        ...
        if (executionContext == null) {
            ...
            // Update behaviour instance execution context, in particular, argument state that is
            // marked END_TRANSACTION
    ...
    private class QueueContext {
        ...
        Map<ExecutionInstanceKey, ExecutionContext> index =
                new HashMap<ExecutionInstanceKey, ExecutionContext>();
