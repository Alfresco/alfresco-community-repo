...
public class RenditionTests extends CmisTest {
  ...
  public void adminShouldGetRenditionsForDocument() throws Exception {
    FileModel txtModel = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
    cmisApi
  ...
  @Test(
    groups = { TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.RENDITIONS },
  ...
  public void adminCannotGetRenditionsForInvalidDocument() throws Exception {
    FileModel invalidFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
  ...
  public void managerGetRenditionsForDocument() throws Exception {
    FileModel testFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
  ...
  public void managerGetRenditionsForCheckedOutDocument() throws Exception {
    FileModel checkedDoc = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
      .createFile(checkedDoc, VersioningState.CHECKEDOUT)
      .assertThat()
  ...
  public void nonInvitedUserCannotGetRenditionsInPrivateSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotGetRenditionsInModeratedSite()
    throws Exception {
    SiteModel moderatedSite = dataSite
      .usingUser(testUser)
      .createPrivateRandomSite();
    FileModel moderatedDoc = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
    cmisApi
