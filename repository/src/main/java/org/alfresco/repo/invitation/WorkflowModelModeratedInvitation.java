...
public interface WorkflowModelModeratedInvitation {
    ...
    // process name
    public static final QName WF_PROCESS_INVITATION_MODERATED =
            QName.createQName(NAMESPACE_URI, "invitation-moderated");
    ...
    // tasks
    public static final QName WF_START_TASK =
            QName.createQName(NAMESPACE_URI, "moderatedInvitationSubmitTask");
    public static final QName WF_ACTIVITI_REVIEW_TASK =
            QName.createQName(NAMESPACE_URI, "activitiModeratedInvitationReviewTask");
    ...
    public static final QName WF_PROP_INVITEE_COMMENTS =
            QName.createQName(NAMESPACE_URI, "inviteeComments");
    ...
    public static final QName WF_PROP_REVIEW_COMMENTS =
            QName.createQName(NAMESPACE_URI, "reviewComments");
    ...
    public static final QName WF_SHARED_LINK_BASE_URL =
            QName.createQName(NAMESPACE_URI, "sharedLinkBaseUrl");
    public static final QName WF_TEMPLATE_ASSETS_URL =
            QName.createQName(NAMESPACE_URI, "templateAssetsUrl");
