...
public class TestPeople extends AbstractBaseApiTest {
  ...
  private static final QName ASPECT_COMMS = QName.createQName(
    "test.people.api",
    "comms"
  );
  private static final QName PROP_TELEHASH = QName.createQName(
    "test.people.api",
    "telehash"
  );
  private static final QName ASPECT_LUNCHABLE = QName.createQName(
    "test.people.api",
    "lunchable"
  );
  private static final QName PROP_LUNCH = QName.createQName(
    "test.people.api",
    "lunch"
  );
  private static final QName PROP_LUNCH_COMMENTS = QName.createQName(
    "test.people.api",
    "lunchcomments"
  );
  ...
  private TestNetwork createNetwork(String networkPrefix) {
    TestNetwork network = getRepoService()
      .createNetwork(networkPrefix + GUID.generate(), true);
    network.create();
  ...
  public void testGetPerson() throws Exception {
    ...
    {
      publicApiClient.setRequestContext(
        new RequestContext(account1.getId(), person2)
      );
      Person resp = people.getPerson(person1);
      Person person1Entity = repoService.getPerson(person1);
    ...
    // "-me-" user
    {
      ...
      assertNotNull("Check if capabilities are present", respCapabilities);
      assertTrue(
        "Check if -me- user is mutable",
        respCapabilities.get("isMutable")
      );
    ...
    publicApiClient.setRequestContext(
      new RequestContext(account1.getId(), person3)
    );
    try {
    ...
    publicApiClient.setRequestContext(
      new RequestContext(account1.getId(), personId)
    );
  ...
  public void testCreatePerson() throws Exception {
    ...
    // create person with invalid characters {'/', '\\', '\n', '\r', '"'}
    {
      ...
      for (char invalidCharacter : invalidCharacters) {
        person.setUserName(
          "myUser" + invalidCharacter + "Name@" + account1.getId()
        );
        people.create(person, 400);
      }
    }
  ...
  @Test
  public void testCreatePerson_canCreateDisabledPerson()
  ...
  public void testCreatePerson_errorResponses() throws Exception {
    ...
    // -ve: API user does not have permission to create user.
    {
      ...
      publicApiClient.setRequestContext(
        new RequestContext(account2.getId(), apiUser)
      );
      Person person = new Person();
  ...
  public void testGetPerson_withCustomProps() throws PublicApiException {
    ...
    MutableAuthenticationService authService = applicationContext.getBean(
      "AuthenticationService",
      MutableAuthenticationService.class
    );
    PreferenceService prefService = applicationContext.getBean(
      "PreferenceService",
    ...
    prefService.setPreferences(
      userName,
      Collections.singletonMap("olives", "green")
    );
  ...
  public void testCreatePerson_withCustomProps() throws Exception {
    ...
    assertEquals(
      "724332b5796a8",
      retPerson.getProperties().get("papi:telehash")
    );

    // Get the NodeRef
    AuthenticationUtil.setFullyAuthenticatedUser("admin@" + account1.getId());
    NodeRef nodeRef = personService.getPerson(
      "jbloggs@" + account1.getId(),
      false
    );
  ...
  private Person createTestUpdatePerson() throws PublicApiException {
    ...
    person.setProperties(
      Collections.singletonMap("papi:jabber", "jbloggs@example.com")
    );
    ...
    assertEquals(
      "jbloggs@example.com",
      person.getProperties().get("papi:jabber")
    );
  ...
  public void testUpdatePerson_withCustomProps() throws Exception {
    ...
    // Remove a property by setting it to null
    {
      ...
      person =
        people.update(
          person.getId(),
          qjson("{`properties`: {`papi:jabber`: null}}"),
          200
        );
  ...
  public static class PersonJSONSerializer implements JSONAble {
    ...
    public JSONObject toJSON() {
      ...
      personJson.put(
        ...
        personUpdate.isEmailNotificationsEnabled()
      );
  ...
  @Test
  public void testUpdatePersonNonSelfAndNonAdminDisallowed()
    throws PublicApiException {
    ...
    people.update(
      personToUpdateId,
      qjson("{ `firstName`:`Updated firstName` }"),
      403
    );
  ...
  public void testUpdatePersonCanUpdateThemself() throws PublicApiException {
    ...
    {
      Person updatedPerson = people.update(
        personId,
        qjson("{ `firstName`: `Matt` }"),
        200
      );
  ...
  public void testUpdatePersonUsingPartialUpdate() throws PublicApiException {
    ...
    HttpResponse response = people.update(
      "people",
      personId,
      null,
      null,
    ...
    Person updatedPerson = Person.parsePerson(
  ...
  @Test
  public void testUpdatePersonWithRestrictedResponseFields()
    throws PublicApiException {
    final String personId = account3.createUser().getId();
  ...
  public void testUpdatePersonUpdateAsAdmin() throws Exception {
    ...
    assertEquals(
      emailNotificationsEnabled,
      updatedPerson.isEmailNotificationsEnabled()
    );
  ...
  @Test
  public void testUpdatePersonEnabledNonAdminNotAllowed()
    throws PublicApiException {
    final String personId = account3.createUser().getId();
    publicApiClient.setRequestContext(
      new RequestContext(account3.getId(), personId)
    );
  ...
  public void testUpdatePersonEnabled() throws PublicApiException {
    ...
    // Non-admin cannot set enabled flag
    {
      ...
      assertEquals(
        "Enabled state shouldn't have changed, but did",
        origEnabled,
        me.isEnabled()
      );
    }
  ...
  @Test
  public void testUpdatePersonAdminCannotBeDisabled()
    throws PublicApiException {
    publicApiClient.setRequestContext(
      new RequestContext(account3.getId(), account3Admin, "admin")
    );
  ...
  public void testUpdatePersonPasswordByThemself() throws PublicApiException {
    ...
    people.update(
      me.getId(),
      qjson("{ `oldPassword`:``, `password`:`newpassword456` }"),
      400
    );
    people.update(
      me.getId(),
      qjson("{ `oldPassword`:null, `password`:`newpassword456` }"),
      400
    );
    ...
    people.update(
      me.getId(),
      qjson("{ `oldPassword`:`newpassword456`, `password`:`` }"),
      400
    );
    people.update(
      me.getId(),
      qjson("{ `oldPassword`:`newpassword456`, `password`:null }"),
      400
    );
  }
  ...
  public void testUpdatePersonPasswordByAdmin() throws PublicApiException {
    ...
    publicApiClient.setRequestContext(
      new RequestContext(networkId, account3Admin, "admin")
    );
    ...
    publicApiClient.setRequestContext(
      new RequestContext(networkId, personId, invalidPassword)
    );
    try {
    ...
    publicApiClient.setRequestContext(
      new RequestContext(networkId, personId, updatedPassword)
    );
    this.people.getPerson(personId);
    ...
    people.update(
      personId,
      qjson(
        "{ `password`:`" + updatedPassword2 + "`, `oldPassword`:`rubbish` }"
      ),
      200
    );
  ...
  @Test
  public void testUpdatePersonWithNotUpdatableFields()
    throws PublicApiException {
    final String personId = account3.createUser().getId();
  ...
  private PublicApiClient.ListResponse<Person> listPeople(
    ...
    HttpResponse response = people.getAll(
      "people",
      null,
      null,
      null,
  ...
  @Test
  public void testListPeopleWithAspectNamesAndProperties()
    throws PublicApiException {
    publicApiClient.setRequestContext(
      new RequestContext(account3.getId(), account3Admin, "admin")
    );
    ...
    {
      PublicApiClient.ListResponse<Person> resp = listPeople(
  ...
  public void testPagingAndSortingByFirstNameAsc() throws Exception {
    ...
    int maxItems = 3;
    int totalResults = 5;
    PublicApiClient.Paging paging = getPaging(
      skipCount,
      maxItems,
      totalResults,
      totalResults
  ...
  public void testResetPassword() throws Exception {
    ...
    ResetPasswordServiceImpl passwordService = applicationContext.getBean(
    ...
    try {
      ...
      org.alfresco.util.Pair<String, String> pair = getWorkflowIdAndKeyFromUrl(
        resetPasswordUrl
      );
  ...
  public void retrieveAvatar() throws Exception {
    ...
    // If-Modified-Since behaviour
    {
      ...
      ClassPathResource thumbRes = new ClassPathResource(
        "publicapi/upload/quick.jpg"
      );
      deleteAvatarDirect(person1Ref);
      createAvatarDirect(person1Ref, thumbRes.getFile());
    ...
    // Attachment param
    {
      ...
      HttpResponse response = people.getAvatar(
        person1,
        attachmentParam,
        false,
        null,
  ...
  private NodeRef createAvatarDirect(NodeRef personRef, File avatarFile) {
    ...
    ContentService contentService = applicationContext.getBean(
      "ContentService",
    ...
    Renditions renditions = applicationContext.getBean(
      "Renditions",
      Renditions.class
    );
  ...
  public void updateAvatar()
    throws PublicApiException, IOException, InterruptedException {
    final String person1 = account1PersonIt.next();
    final String person2 = account1PersonIt.next();
    ...
    // Update allowed when no existing avatar
    {
      ...
      ClassPathResource avatar = new ClassPathResource(
        "publicapi/upload/quick.jpg"
      );
      HttpResponse response = people.updateAvatar(
        person2,
        avatar.getFile(),
        200
      );
    ...
    // 413: content exceeds individual file size limit
    {
      ...
      final ContentLimitProvider.SimpleFixedLimitProvider limitProvider = applicationContext.getBean(
  ...
  public void removeAvatar()
    throws IOException, PublicApiException, InterruptedException {
    final String person1 = account1PersonIt.next();
    final String person2 = account1PersonIt.next();
  ...
  public void testListPeopleWithCapabilities() throws Exception {
    ...
    // Are capabilities populated when requested?
    {
      ...
      assertFalse(
        personGuest.getCapabilities().get("isMutable").booleanValue()
      );
    }
  }
