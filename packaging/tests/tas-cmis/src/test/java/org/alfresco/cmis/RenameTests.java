...
public class RenameTests extends CmisTest {
  ...
  public void siteManagerCanRenameContent() throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    ...
    cmisApi
      ...
      .rename(testFile.getName() + prefix)
      .assertThat()
      .existsInRepo()
      .when()
      .usingResource(testFile)
      ...
      .rename(testFolder.getName() + prefix)
      .assertThat()
      .existsInRepo()
      .when()
      .usingResource(testFolder)
  ...
  public void siteManagerCanRenamePwcDocument() throws Exception {
    ...
    cmisApi
      ...
      .existsInRepo()
      .rename("pwc" + prefix);
    renamedPwc.setCmisLocation(
      testFile
        .getCmisLocation()
        .replace(testFile.getName(), renamedPwc.getName())
    );
  ...
  public void siteManagerCanRenameDocumentWithMultipleVersions()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    cmisApi
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorCanRenameDocumentCreatedByManager()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    cmisApi
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorCanRenameFolderCreatedByManager()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(managerUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanRenameFolderCreatedByCollaborator()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorCanRenameDocumentCreatedByHimself()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    cmisApi
  ...
  public void siteContributorCannotRenameDocumentCreatedByManager()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    cmisApi
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorCanRenameDocumentCreatedByHimself()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    cmisApi
  ...
  public void siteConsumerCannotRenameDocumentCreatedByManager()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    cmisApi
  ...
  public void nonInvitedUserCannotRenameDocumentInPrivateSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotRenameDocumentInModeratedSite()
    throws Exception {
  ...
  public void siteManagerCannotRenameDocumentWithSameNameFromOtherFile()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
    FileModel secondFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
    cmisApi
