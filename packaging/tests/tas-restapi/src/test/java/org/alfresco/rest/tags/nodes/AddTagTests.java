...
public class AddTagTests extends TagsDataPrep {
  ...
  public void contributorIsAbleToAddTagToHisContent() throws Exception {
    ...
    FileModel contributorDoc = dataContent
      .usingSite(siteModel)
      .usingUser(userModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);
    returnedModel =
      restClient.withCoreAPI().usingResource(contributorDoc).addTag(tagValue);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
    returnedModel
      .assertThat()
      .field("id")
  ...
  public void managerIsAbleToTagAFolder() throws Exception {
    ...
    returnedModel =
      restClient.withCoreAPI().usingResource(folderModel).addTag(tagValue);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
    returnedModel
      .assertThat()
      .field("tag")
  ...
  public void addTagToAComment() throws Exception {
    ...
    restClient.authenticateUser(adminUserModel);
    returnedModelComment =
      restClient.withCoreAPI().usingResource(file).addComment(comment);
