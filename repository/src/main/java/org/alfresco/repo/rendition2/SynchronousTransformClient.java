...
public interface SynchronousTransformClient
{
     ...
     * @param contentUrl
     *            The url of the content. Optional as it is only used in debug messages.
     ...
     * @param sourceNodeRef
     *            (optional) NodeRef of the source content. Only used in debug messages.
     ...
     *             if there is an unexpected failure to transform, normally in a pipeline, where an intermediate transform may not be performed after all because an intermediate converion is too big.
     * @throws ContentIOException
     *             there is an unexpected communication or transformation failure.
     * @throws UnsupportedTransformationException
     *             if isSupported has not been called and
     */
