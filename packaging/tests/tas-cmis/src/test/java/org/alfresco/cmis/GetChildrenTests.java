...
public class GetChildrenTests extends CmisTest {
  ...
  @TestRail(
    ...
    description = "Get children from valid folder"
  )
  ...
  public void getChildrenFromValidFolder() throws Exception {
    cmisApi
      ...
      .usingResource(testFolder)
      .assertThat()
      .hasChildren(testFile, secondFile, subFolder)
      .assertThat()
      .hasFiles(testFile, secondFile)
      .assertThat()
      .hasFolders(subFolder);
  }
  ...
  public void siteCollaboratorCanGetChildrenFromValidFolderCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorCanGetChildrenFromValidFolderCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorCanGetChildrenFromValidFolderCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorCanGetChildrenFromValidFolderCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void nonSiteMemberCannotGetChildrenFromValidFolderFromAPrivateSite()
    throws Exception {
  ...
  public void nonSiteMemberCannotGetChildrenFromValidFolderFromAModeratedSite()
    throws Exception {
