...
public class OnReferenceCreateEventType extends SimpleRecordsManagementEventTypeImpl
    ...
    public void onCreateReference(
            final NodeRef fromNodeRef, final NodeRef toNodeRef, final QName reference) {
                    ...
                    public Object doWork() {
                        ...
                        if (reference.equals(OnReferenceCreateEventType.this.reference)) {
                            DispositionAction da =
                                    dispositionService.getNextDispositionAction(toNodeRef);
                            if (da != null) {
                                List<EventCompletionDetails> events =
                                        da.getEventCompletionDetails();
                                    ...
                                    if (!event.isEventComplete()
                                        ...
                                        recordsManagementActionService
                                                .executeRecordsManagementAction(
                                                        toNodeRef, "completeEvent", params);
