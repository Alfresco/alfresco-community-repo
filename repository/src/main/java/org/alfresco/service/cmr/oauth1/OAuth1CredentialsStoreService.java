...
public interface OAuth1CredentialsStoreService {
  ...
  public abstract OAuth1CredentialsInfo storePersonalOAuth1Credentials(
  ...
  @Auditable(parameters = { "remoteSystemId" })
  public abstract OAuth1CredentialsInfo storeSharedOAuth1Credentials(
    String remoteSystemId,
    String token,
    String secret
  ) throws NoSuchSystemException;
  ...
  @Auditable(parameters = { "remoteSystemId" })
  public abstract List<OAuth1CredentialsInfo> listSharedOAuth1Credentials(
    String remoteSystemId
  ) throws NoSuchSystemException;

  @Auditable(parameters = { "remoteSystemId" })
  public abstract boolean deletePersonalOAuth1Credentials(
    String remoteSystemId
  ) throws NoSuchSystemException;

  @Auditable(parameters = { "remoteSystemId" })
  public abstract boolean deleteSharedOAuth1Credentials(
    String remoteSystemId,
