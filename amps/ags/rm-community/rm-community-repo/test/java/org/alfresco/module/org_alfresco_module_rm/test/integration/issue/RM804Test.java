...
public class RM804Test extends BaseRMTestCase {
    ...
    public void testTryAndDeleteSiteAsSiteManagerOnly() {
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        siteService.setMembership(
                                siteId, userName, SiteRole.SiteManager.toString());
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        filePlanRoleService.assignRoleToAuthority(
                                filePlan, FilePlanRoleService.ROLE_USER, userName);
        ...
        doTestInTransaction(
                new FailureTest(
                        "Should not be able to delete site as a site manager with an RM role that"
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        filePlanRoleService.assignRoleToAuthority(
                                filePlan, FilePlanRoleService.ROLE_ADMIN, userName);
