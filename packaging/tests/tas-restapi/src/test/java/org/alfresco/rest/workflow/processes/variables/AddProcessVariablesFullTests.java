...
public class AddProcessVariablesFullTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    siteModel =
      dataSite.usingUser(userWhoStartsProcess).createPublicRandomSite();
    document =
      dataContent
  ...
  public void addMultipleProcessVariableByUserInvolvedTheProcess()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:text");
    variableModel1 =
    ...
    processVariableCollection
      ...
      .assertThat()
      .field("name")
      .is(variableModel1.getName())
      .and()
      .field("type")
      .is(variableModel1.getType())
      .and()
      .field("value")
      .is(variableModel1.getValue());
    ...
    restClient
      ...
      .entriesListContains("name", variableModel.getName())
      .assertThat()
      .entriesListContains("name", variableModel1.getName());
  }
  ...
  public void failedAddingProcessVariableIfInvalidTypeIsProvided()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:textarea");
    restProcessModel =
      restClient
  ...
  public void failedAddingProcessVariableIfInvalidTypePrefixIsProvided()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("ddt:text");
    restProcessModel =
      restClient
        .authenticateUser(adminUser)
        .withWorkflowAPI()
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_NAMEPACE_PREFIX, "ddt")
      )
  ...
  public void failedAddingProcessVariableIfInvalidValueIsProvided()
    throws Exception {
    RestProcessVariableModel variableModel = RestProcessVariableModel.getRandomProcessVariableModel(
      "d:int"
    );
    ...
    restClient
      ...
      .containsErrorKey(RestErrorModel.API_DEFAULT_ERRORKEY)
      .containsSummary(
        String.format(RestErrorModel.FOR_INPUT_STRING, "invalidValue")
      )
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .stackTraceIs(RestErrorModel.STACKTRACE);
  }
  ...
  public void failedAddingProcessVariableIfInvalidBodyIsProvided()
    throws Exception {
    restProcessModel =
      restClient
        .authenticateUser(adminUser)
    ...
    RestRequest request = RestRequest.requestWithBody(
      HttpMethod.POST,
      "{\"name\": \"variableName\",\"scope\": \"local\",\"value\": \"testing\",\"type\": \"d:text\"}",
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.NO_CONTENT, "Unrecognized field \"scope\"")
      )
      .containsErrorKey(
        String.format(RestErrorModel.NO_CONTENT, "Unrecognized field \"scope\"")
      )
  ...
  public void failedAddingProcessVariableIfEmptyNameIsProvided()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void failedAddingProcessVariableUsingOnlyWhiteSpaceInName()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
    ...
    restClient
      ...
      .getProcessVariables()
      .assertThat()
      .entriesListContains("value", variableModel.getValue());
  }
  ...
  public void addingMultipleValidProcessVariables() throws Exception {
    ...
    processVariableCollection
      ...
      .entriesListContains("name", variableModel.getName())
      .assertThat()
      .entriesListContains("name", variableModel2.getName())
      .assertThat()
      .entriesListContains("name", variableModel3.getName());
    ...
    processVariableCollection
      ...
      .assertThat()
      .field("name")
      .is(variableModel2.getName())
      .and()
      .field("value")
      .is(variableModel2.getValue())
      .and()
      .field("type")
      .is(variableModel2.getType());
    processVariableCollection
      .getEntries()
      .get(2)
      .onModel()
      .assertThat()
      .field("name")
      .is(variableModel3.getName())
      .and()
      .field("value")
      .is(variableModel3.getValue())
      .and()
      .field("type")
      .is(variableModel3.getType());
  }
  ...
  public void failedAddingMultipleProcessVariablesInvalidType()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:text");
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.UNSUPPORTED_TYPE, "d:string")
      )
      .containsErrorKey(
        String.format(RestErrorModel.UNSUPPORTED_TYPE, "d:string")
      )
  ...
  public void failledAddingMultipleProcessVariablesInvalidTypePrefix()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:text");
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_NAMEPACE_PREFIX, "e")
      )
      .containsErrorKey(RestErrorModel.API_DEFAULT_ERRORKEY)
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .stackTraceIs(RestErrorModel.STACKTRACE);
  ...
  public void failledAddingMultipleProcessVariablesInvalidValue()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:int");
    variableModel.setValue("invalidValue");
    variableModel1 =
      RestProcessVariableModel.getRandomProcessVariableModel("d:text");
    variableModel2 =
