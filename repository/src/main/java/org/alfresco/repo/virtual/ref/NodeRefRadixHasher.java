...
/**
 * Creates string-pair hashes of {@link NodeRef}s where the first string is a stored hash
 * combination for {@link NodeRef} store elements (protocol and id) and the second is a radix 36
 * encoded {@link NodeRef} id.
 */
