 ...
 */
public abstract class ActionConditionEvaluatorAbstractBase extends ParameterizedItemAbstractBase
    ...
    public ActionConditionDefinition getActionConditionDefintion() {
        if (this.actionConditionDefinition == null) {
            ...
            ((ActionConditionDefinitionImpl) this.actionConditionDefinition)
            ...
            ((ActionConditionDefinitionImpl) this.actionConditionDefinition)
                    .setConditionEvaluator(this.name);
            ((ActionConditionDefinitionImpl) this.actionConditionDefinition)
    ...
    /**
     * @see
     *     org.alfresco.repo.action.evaluator.ActionConditionEvaluator#evaluate(org.alfresco.service.cmr.action.ActionCondition,
     ...
     */
    protected abstract boolean evaluateImpl(
            ActionCondition actionCondition, NodeRef actionedUponNodeRef);
}
