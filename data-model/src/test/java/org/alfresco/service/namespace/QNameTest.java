...
public class QNameTest extends TestCase {
    ...
    public void testCommonTypes() {
        ...
        QName qname5 =
                QName.createQName("{http://www.alfresco.org/model/content/1.0}content.mimetype");
        assertEquals(
                "{http://www.alfresco.org/model/content/1.0}content.mimetype", qname5.toString());
    }
    ...
    public void testPrefix() {
        ...
        QName qname1 =
                QName.createQName(
                        NamespaceService.ALFRESCO_PREFIX, "alfresco prefix", mockResolver);
