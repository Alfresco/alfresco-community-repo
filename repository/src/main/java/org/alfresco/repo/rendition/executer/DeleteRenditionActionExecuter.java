...
public class DeleteRenditionActionExecuter extends ActionExecuterAbstractBase {
  ...
  private static Log log = LogFactory.getLog(
    DeleteRenditionActionExecuter.class
  );
    ...
    AuthenticationUtil.runAsSystem(
      new RunAsWork<Void>() {
        ...
        public Void doWork() throws Exception {
          final boolean nodeExists = finalNodeService.exists(
            actionedUponNodeRef
          );
          if (nodeExists) {
            Map<String, Serializable> paramValues = action.getParameterValues();
            final QName renditionDefName = (QName) paramValues.get(
            ...
            if (existingRendition != null) {
              if (log.isDebugEnabled()) {
                ...
                msg
                  .append("Deleting rendition node: ")
