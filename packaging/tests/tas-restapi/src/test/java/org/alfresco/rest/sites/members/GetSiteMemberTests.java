...
public class GetSiteMemberTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role gets site member and status code is OK (200)")
    public void getSiteMemberWithManagerRole() throws Exception {
        restClient.authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteManager));
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteMember(consumer)
                .assertThat()
                .field("id")
                .is(consumer.getUsername())
                .and()
                .field("role")
                .is(consumer.getUserRole());
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role gets site member and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets site member and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets site member and gets status code OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with admin user gets site member and gets status code OK (200)")
    ...
    public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteMember()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Manager role doesn't get a site member of inexistent site and"
                            + " status code is Not Found (404)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Manager role doesn't get non site member of inexistent site"
                            + " and status code is Not Found (404)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Manager role doesn't get not existing site member and status"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Manager role can get site member using \"-me-\" in place of"
                            + " personId")
    public void getSiteMemberUsingMeForPersonId() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteMember(meUser)
                .assertThat()
                .field("id")
                .is(manager.getUsername())
                .and()
                .field("role")
                .is(manager.getUserRole());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Manager role gets site member with Manager role and status"
                            + " code is OK (200)")
    public void getSiteManagerMemberWithManagerRole() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteMember(anotherManager)
                .assertThat()
                .field("id")
                .is(anotherManager.getUsername())
                .and()
                .field("role")
                .is(anotherManager.getUserRole());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Collaborator role gets site member with Manager role and"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets site member with Manager role and status"
                            + " code is OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets site member with Manager role and"
                            + " status code is OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets admin site member and status code is OK"
                            + " (200)")
    public void getSiteAdminManagerMember() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteMember(adminUser)
                .assertThat()
                .field("id")
                .is(adminUser.getUsername())
                .and()
                .field("role")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Collaborator role gets site member with Contributor role and"
                            + " status code is OK (200)")
    public void getSiteContributorMemberWithCollaboratorRole() throws Exception {
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteMember(contributor)
                .assertThat()
                .field("id")
                .is(contributor.getUsername())
                .and()
                .field("role")
                .is(contributor.getUserRole());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets site member with Collaborator role and"
                            + " status code is OK (200)")
    public void getSiteCollaboratorMemberWithContributorRole() throws Exception {
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteMember(collaborator)
                .assertThat()
                .field("id")
                .is(collaborator.getUsername())
                .and()
                .field("role")
                .is(collaborator.getUserRole());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Collaborator role gets admin role and status code is OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Collaborator role gets site member with Consumer role and"
                            + " status code is OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user gets site member of private site and status code is OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify not joined user is not is not able to get site member of private site"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is not able to get from site a user that created a member request"
                            + " that was not accepted yet")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role can get site member using \"-me-\" in place of"
                            + " personId")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user gets site member of moderated site and status code is OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify not joined user gets site member of moderated site and status code is"
                            + " OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site member request with properties parameter returns status"
                            + " code 200 and parameter is applied")
    public void getSiteMemberUsingPropertiesParameter() throws Exception {
        restClient
                .authenticateUser(manager)
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .usingParams("properties=id")
                .getSiteMember(consumer)
                .assertThat()
                .fieldsCount()
                .is(2)
