...
public class CustomModelException extends AlfrescoRuntimeException {
  ...
  public static class InvalidCustomModelException extends CustomModelException {
    ...
    public InvalidCustomModelException(
      String msgId,
      Object[] msgParams,
      Throwable cause
    ) {
  ...
  public static class CustomModelConstraintException
    extends CustomModelException {
  ...
  public static class NamespaceConstraintException
    extends CustomModelConstraintException {
  ...
  public static class ActiveModelConstraintException
    extends CustomModelConstraintException {
