...
/**
 * Utility class providing methods to access the Locale of the current thread and to get Localised
 * strings. These strings may be loaded from resource bundles deployed in the Repository.
 */
@AlfrescoPublicApi
public interface MessageService extends TenantDeployer, MessageLookup {
     ...
     * @return Returns the best match from the available options, or the <tt>null</tt> if all
     *     matches fail
     */
     ...
     * @return Returns the locale instance, or the {@link Locale#getDefault() default} if the string
     *     is invalid
     */
     ...
     *
     * <p>This should be the bundle base path eg, alfresco/messages/errors or,
     * workspace://SpaceStore/app:company_home/app:dictionary/app:labels/cm:errors
     *
     * <p>Once registered the messages will be available via getMessage, assuming the bundle
     * resource exists at the given path location.
     *
     ...
     * workspace://SpaceStore/app:company_home/app:dictionary/app:labels/cm:errors
     *
     * <p>Once unregistered the messages will no longer be available via getMessage
     *
     ...
     *
     * <p>note: also used by Web Client (ResourceBundleWrapper)
     *
     ...
     * @return input stream
     */
    public ResourceBundle getRepoResourceBundle(StoreRef storeRef, String path, Locale locale)
            throws IOException;
