 ...
 *
 * <p>Note - this test will largely use a test shared credentials container, but one test puts
 * things into the real credentials folder
 *
 * @author Nick Burch
 * @since Odin
 */
...
public class RemoteCredentialsServicesTest {
    ...
    /**
     * Tests that read only methods don't create the shared credentials container, but that write
     * ones will do.
     */
    @Test
    ...
    /**
     * Creating shared and personal credentials, then checking how this affects the listing of
     * Remote Systems
     */
    @Test
    public void testCreateCredentialsAndSystemListing() throws Exception {
        ...
        BaseCredentialsInfo cc =
                REMOTE_CREDENTIALS_SERVICE.createSharedCredentials(
                        TEST_REMOTE_SYSTEM_THREE, credentials);
     ...
     * known and empty state. We have this one test that uses the real shared container, just to
     * check that it's correctly setup and available
     */
    @Test
