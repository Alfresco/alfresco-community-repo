...
public interface AuditService {
    ...
    /**
     * Remove audit entries for the given application between the time ranges. If no start time is
     * given then entries are deleted as far back as they exist. If no end time is given then
     * entries are deleted up until the current time.
     *
     * @param applicationName the name of the application for which to remove entries
     ...
     *
     * <p>This method should not be called <i>while</i> processing {@link
     * #auditQuery(AuditQueryCallback, AuditQueryParameters, int) query results}.
     *
