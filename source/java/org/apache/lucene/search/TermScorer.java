...
final class TermScorer extends Scorer {
  ...
  protected boolean score(HitCollector c, int end) throws IOException {
    ...
    while (doc < end) {                           // for docs in window
      ...
      score *= normDecoder[(norms == null ? DEFAULT_NORM : norms[doc]) & 0xFF];    // normalize for field
  ...
  public float score() {
    ...
    return raw * Similarity.decodeNorm(norms == null ? DEFAULT_NORM : norms[doc]); // normalize for field
  }
