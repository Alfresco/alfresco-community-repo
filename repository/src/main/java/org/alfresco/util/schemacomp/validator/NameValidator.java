...
/**
 * Validates the name of a DbObject using a regular expression. A regular expression can be supplied
 * for each supported {@link Dialect database dialect}. In addition to dialect specific regular
 * expressions, a default may be supplied - comparisons will fall back to the default if no specific
 * dialect is matched.
 *
 * @author Matt Ward
 */
