...
public class UnableToReleaseLockException extends RuntimeException {
    ...
    /** Error message */
    private static final String ERROR_MESSAGE_1 =
            I18NUtil.getMessage("lock_service.insufficent_privileges");

    private static final String ERROR_MESSAGE_2 =
            I18NUtil.getMessage("lock_service.unlock_checkedout");
