...
public class IntegrationFullTestsBulk3 extends IntegrationTest {
    ...
    /**
     * Scenario 64 1. Create folder1 with WEBDAV 2. Create wordFile inside folder1 with CMIS 3.
     * Delete wordFile content with CMIS 4. Update content using Collaborator role with CMIS 5.
     * Append content using Manager role with WebDAV 6. Delete content that Manager added using
     * Collaborator role with CMIS 7. Rename wordFile with WebDAV 9. Delete wordFile with WEBDAV
     *
     * @throws Exception
     */
    ...
    public void fileHandlingWithCollaboratorRole() throws Exception {
        ...
        cmisAPI.authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator))
                .usingResource(wordFile)
                .update(contentCollaborator)
                .assertThat()
                .contentIs(contentCollaborator);

        STEP("5. Append content using Manager role with WebDAV");
        webDavProtocol
                .authenticateUser(testUser1)
                .usingResource(wordFile)
                .update("content added by Manager")
                .assertThat()
                .contentIs("content added by Manager");
    ...
    /**
     * Scenario 65 1. Create folder1 with WEBDAV 2. Create wordFile inside folder1 with CMIS 3.
     * Delete wordFile content with CMIS 4. Update content using Contributor role with CMIS 5.
     * Append content using Manager role with WebDAV 6. Delete content that Manager added using
     * Collaborator role with CMIS 7. Rename wordFile with WEBDAV 8. Delete wordFile with FTP
     *
     * @throws Exception
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    ...
    /**
     * Scenario 76 1. Using CMIS create two users: u1 and u2 2. U1 creates a public site using CMIS
     * 3. U1 creates testFile1 in public site's document library using FTP 4. U1 adds comment1 for
     * testFile1 using REST API 5. U2 gets comment1 using REST API 6. U1 updates testFile1 using
     * WEBDAV 7. U2 gets comment1 using REST API 8. U1 deletes testFile1 using WebDAV 9. U2 can not
    ...
    /**
     * Scenario 77 1. Using CMIS create two users: u1 and u2 2. U1 creates a public site using CMIS
     * 3. U1 creates a file in public site's document library using FTP 4. U1 applyAcl(permission)
     * for U2 with role Site Manager to the document using CMIS 5. U2 edits the document using FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager permission to a document in a public site - is able to edit"
                            + " document.")
    public void addManagerPermissionToADocumentFromPublicSite() throws Exception {
        ...
        STEP(
                "* 4. U1 applyAcl(permission) for U2 with role Site Manager to the document using"
                        + " CMIS");
        cmisAPI.authenticateUser(testUser1)
                .usingResource(testFile1)
                .addAcl(testUser2, UserRole.SiteManager)
                .then()
                .assertThat()
                .permissionIsSetForUser(testUser2, UserRole.SiteManager);
        ...
        ftpProtocol
                ...
                .update("new Content")
                .assertThat()
                .contentIs("new Content");
    }

    /**
     * Scenario 78 1. Using CMIS create two users: u1 and u2 2. U1 creates a public site using CMIS
     * 3. U1 creates a file in public site's document library using FTP 4. U1 applyAcl(permission)
     * for U2 with role Site Collaborator to the document using CMIS 5. U2 edits the document using
     * FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator permission to a document in a public site - is able to"
                            + " edit document.")
    public void addCollaboratorPermissionToADocumentFromPublicSite() throws Exception {
        ...
        cmisAPI.authenticateUser(testUser1)
                .usingResource(testFile1)
                .addAcl(testUser2, UserRole.SiteCollaborator)
                .then()
                .assertThat()
                .permissionIsSetForUser(testUser2, UserRole.SiteCollaborator);
    ...
    /**
     * Scenario 79 1. Using CMIS create two users: u1 and u2 2. U1 creates a public site using CMIS
     * 3. U1 creates a file in public site's document library using FTP 4. U1 applyAcl(permission)
     * for U2 with role Site Contributor to the document using CMIS 5. U2 edits the document using
     * FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor permission to a document in a public site - is not able to"
                            + " edit document.")
    public void addContributorPermissionToADocumentFromPublicSite() throws Exception {
        ...
        cmisAPI.authenticateUser(testUser1)
                .usingResource(testFile1)
                .addAcl(testUser2, UserRole.SiteContributor)
                .then()
                .assertThat()
                .permissionIsSetForUser(testUser2, UserRole.SiteContributor);
        ...
        ftpProtocol
                ...
                .usingResource(testFile1)
                .assertThat()
                .contentIs("file1 content");
    }

    /**
     * Scenario 80 1. Using CMIS create two users: u1 and u2 2. U1 creates a public site using CMIS
     * 3. U1 creates a file in public site's document library using FTP 4. U1 applyAcl(permission)
     * for U2 with role Site Consumer to the document using CMIS 5. U2 edits the document using FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer permission to a document in a public site - is not able to"
                            + " edit document.")
    public void addConsumerPermissionToADocumentFromPublicSite() throws Exception {
        ...
        cmisAPI.authenticateUser(testUser1)
                .usingResource(testFile1)
                .addAcl(testUser2, UserRole.SiteConsumer)
                .then()
                .assertThat()
                .permissionIsSetForUser(testUser2, UserRole.SiteConsumer);
    ...
    /**
     * Scenario 107 1. Using CMIS create two users: u1 and u2 2. U1 creates a moderated site using
     * CMIS 3. U1 creates a file in moderated site's document library using FTP 4. U1
     * applyAcl(permission) for U2 with role Site Manager to the document using CMIS 5. U2 edits the
     * document using FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager permission to a document in a moderated site - is not able to"
                            + " edit document.")
    ...
    /**
     * Scenario 108 1. Using CMIS create two users: u1 and u2 2. U1 creates a private site using
     * CMIS 3. U1 creates a file in private site's document library using FTP 4. U1
     * applyAcl(permission) for U2 with role Site Manager to the document using CMIS 5. U2 edits the
     * document using FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.FULL})
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager permission to a document in a private site - is not able to"
                            + " edit document.")
    ...
    /**
     * Scenario 60 1. Using CMIS creates one test user: u1 2. U1 creates testFile1 in public site
     * using FTP 3. U1 creates testFile2 in public site using FTP 4. U1 updates testFile2 using FTP
    ...
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Compare Modified Date")
    public void manageModificationTimeOfFile() throws Exception {
        ...
        Assert.assertNotEquals(
                modifiedDate1, modifiedDate2, "Updated and modified dates are equal");
