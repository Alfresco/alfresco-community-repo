...
public class SiteActivitySystemTest extends TestCase {
  ...
  protected void createSite(String siteId, boolean isPublic, String ticket)
    throws Exception {
  ...
  protected void getSiteFeed(String siteId, String ticket, int expectedCount)
    throws Exception {
    String url =
      WEBSCRIPT_ENDPOINT +
      URL_ACTIVITIES +
  ...
  public void test08GetSiteFeedsAfterAddAndUpdateMemberships()
    throws Exception {
    test02CreateSites();
  ...
  protected void addAndUpdateMemberships(
    String siteId,
    String ticket,
  ...
  protected void removeMemberships(
    String siteId,
    String ticket,
    boolean includeUser4
  ) throws Exception {
  ...
  private void addFollower(String follower, String user, String ticket)
    throws Exception {
    ...
    String url =
      WEBSCRIPT_ENDPOINT + "/api/subscriptions/" + follower + "/follow";
  ...
  private void addMembership(
    ...
    String url =
      WEBSCRIPT_ENDPOINT + URL_SITES + "/" + siteId + URL_MEMBERSHIPS;
  ...
  private void removeMembership(String siteId, String userName, String ticket)
    throws Exception {
    String url =
      WEBSCRIPT_ENDPOINT +
      URL_SITES +
  ...
  protected String callPostWebScript(
    String urlString,
    String ticket,
    String data
  ) throws MalformedURLException, URISyntaxException, IOException {
  ...
  protected String callPutWebScript(
    String urlString,
    String ticket,
    String data
  ) throws MalformedURLException, URISyntaxException, IOException {
  ...
  private String callOutWebScript(
    String urlString,
    String method,
    String ticket
  ) throws MalformedURLException, URISyntaxException, IOException {
  ...
  private String callInOutWebScript(
    String urlString,
    String method,
    String ticket,
    String data
  ...
  protected String callLoginWebScript(
    String serviceUrl,
    String username,
    String password
  ) throws MalformedURLException, URISyntaxException, IOException {
