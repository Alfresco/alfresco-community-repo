...
/**
 * {@link ForumModel#ASPECT_COMMENTS_ROLLUP comments rollup} aspect behaviour bean. This aspect
 * should not be copied.
 *
 * @author Neil Mc Erlean
 * @since 4.0
 * @see ForumPostBehaviours#onUpdateProperties(org.alfresco.service.cmr.repository.NodeRef,
 *     java.util.Map, java.util.Map) for a {@link ForumModel#ASPECT_COMMENTS_ROLLUP}-related
 *     behaviour, which handles comment count recalculations.
 */
public class CommentsRollupAspect implements CopyServicePolicies.OnCopyNodePolicy {
     ...
     */
    private static class CommentsRollupAspectCopyBehaviourCallback
            extends DefaultCopyBehaviourCallback {
        private static final CopyBehaviourCallback INSTANCE =
                new CommentsRollupAspectCopyBehaviourCallback();
