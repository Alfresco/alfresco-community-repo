...
public class RecognizedParamsExtractorTest
  ...
  public void getFilterTest() {
    ...
    assertTrue(
      "Null passed in so must return the default BeanPropertiesFilter.ALLOW_ALL class",
      BeanPropertiesFilter.AllProperties.class.equals(theFilter.getClass())
    );
    ...
    assertNotNull(theFilter);
    assertTrue(
      "Must return the BeanPropertiesFilter class",
      theFilter instanceof BeanPropertiesFilter
    );
    assertTrue(theFilter.isAllowed("bob"));
  ...
  public void getSortingTest() {
    ...
    assertTrue(
      "Null passed in so empty sort list should be returned.",
      theSort.isEmpty()
    );
  ...
  private void getClauseTest(String paramName) {
    ...
    assertFalse(
      "Null passed in so nothing in the " + paramName,
      theClause.size() > 0
    );
    ...
    try {
      ...
      fail(
        "Should throw an InvalidSelectException. Legal identifiers must start with a letter not zero"
      );
    } catch (InvalidSelectException error) {
      //this is correct
    }
    ...
    theClause =
      getCorrectClause(
        paramName,
        "/foo/anArray/x,/person/age,/eggs/bacon/sausage,/p"
      );
  ...
  public void getRelationFilterTest() {
    ...
    assertTrue(
      "Must be a single relationship called bob",
      theFilter.containsKey("bob")
    );
    BeanPropertiesFilter aFilter = theFilter.get("bob");
    assertTrue(
      "No bean properties specified so need a BeanPropertiesFilter.ALLOW_ALL class",
      BeanPropertiesFilter.AllProperties.class.equals(aFilter.getClass())
    );
    ...
    assertTrue(
      "Bean properties specified so must be an BeanPropertiesFilter class",
      BeanPropertiesFilter.class.equals(aFilter.getClass())
    );
    ...
    assertTrue(
      "No bean properties specified so need a ReturnAllBeanProperties class",
      BeanPropertiesFilter.AllProperties.class.equals(aFilter.getClass())
    );
    aFilter = theFilter.get("hope");
    assertTrue(
  ...
  public void findPagingTest() {
    ...
    assertTrue(
      ...
      pagin.getSkipCount() == Paging.DEFAULT_SKIP_COUNT
    );
