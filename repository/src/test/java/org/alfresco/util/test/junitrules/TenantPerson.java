...
/**
 * This JUnit rule can be used to setup and teardown a single Alfresco user, within a tenant, for
 * test purposes.
 *
 * <p>Example usage:
 *
...
public class TenantPerson extends AlfrescoPerson {
     ...
     */
    public TenantPerson(
            ApplicationContextInit appContextInit, String userName, AlfrescoTenant tenant) {
