...
public class PersonFavouritesRelation
  ...
  private static final Log logger = LogFactory.getLog(
    PersonFavouritesRelation.class
  );
  ...
  @Override
  @WebApiDescription(
    title = "Get Person Favorites",
    description = "Get a paged list of the person's favorites"
  )
  public CollectionWithPagingInfo<Favourite> readAll(
    String personId,
  ...
  @Override
  @WebApiDescription(
    title = "Add Person Favorite",
    description = "Favorite something"
  )
  public List<Favourite> create(
    String personId,
  ...
  @Override
  @WebApiDescription(
    title = "Remove Person Favorite",
    description = "Un-favorite something"
  )
