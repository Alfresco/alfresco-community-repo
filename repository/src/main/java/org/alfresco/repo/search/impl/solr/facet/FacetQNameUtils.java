...
/**
 * This class provides some simple utility methods for dealing with {@link QName QNames} within the
 * faceted search feature. The whole thing should be considered a hack to handle 'special cases'.
 *
 * <p>These are not intended for general use, or else they'd be in the {@link QName} class.
 *
 * @since 5.0
 */
public abstract class FacetQNameUtils {
    /**
     * This method converts the supplied qname string into a {@link QName} object. It accepts both
     * short and long form qname strings.
     *
     * @param s a qname string, such as "cm:name" or
     ...
     * @throws IllegalArgumentException if the provided string could not be recognised as a valid
     *     QName.
     */
