...
public class CancelCheckOutTests extends CmisTest {
    ...
    @Test(
            groups = {
                TestGroup.NOT_SUPPORTED_ON_SINGLE_PIPELINE,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that cancel check out on document created with Versioning State CHECKED"
                            + " OUT deletes the document")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that collaborator user can cancel check out on document created by"
                            + " self")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that contributor user can cancel check out on document created by self")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
