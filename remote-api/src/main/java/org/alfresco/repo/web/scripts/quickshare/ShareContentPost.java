 ...
 *
 * <p>POST web script to "Share" access to some content (ie. enable unauthenticated access to this
 * node)
 *
...
public class ShareContentPost extends AbstractQuickShareContent {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            throw new WebScriptException(
                    HttpServletResponse.SC_NOT_FOUND, "Unable to find node: " + nodeRef);
        }
    }
}
