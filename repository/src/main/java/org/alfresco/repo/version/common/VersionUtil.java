...
public class VersionUtil {
  ...
  public static void convertFrozenToOriginalProps(
    ...
    if (props != null) {
      ...
      String versionLabel = (String) props.get(
      ...
      NodeRef nodeRef = (NodeRef) props.get(
      ...
      String creator = (String) props.get(
      ...
      String modifier = (String) props.get(
