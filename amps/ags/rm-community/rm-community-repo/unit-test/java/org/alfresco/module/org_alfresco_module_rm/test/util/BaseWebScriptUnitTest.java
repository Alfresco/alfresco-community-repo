...
public abstract class BaseWebScriptUnitTest extends BaseUnitTest
{
    ...
    /**
     * Helper method to build a map of web script parameter values mimicking those provided on the URL
     * 
     * @param values
     * @return
     */
     ...
     * 
     * @param template
     *            classpath location of webscripts ftl template
    ...
    /**
     * Creates a mock {@code people} object for use as a root object within FTL. This {@code people} object will return person nodes as specified in {@link #getMockedPeople()}.
     */
    ...
    /**
     * Creates a map of person ScriptNodes for use within FTL. The default implementation is an empty map, but this can be overridden by subclasses.
     * 
