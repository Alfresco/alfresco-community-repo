...
public class DeleteProcessVariableCoreTests extends RestTest {
  ...
  public void deleteInvalidProcessVariable() throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("x:InvalidVar");
    restProcessModel =
      restClient
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, variableModel.getName())
      )
  ...
  public void deleteProcessVariableEmptyProcessId()
