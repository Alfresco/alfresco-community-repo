...
public class DefaultFieldProcessor
  ...
  public Field generateField(
    ...
    Field fieldInfo = propProcessor.generateField(
      fullName,
      itemData,
      isForcedField
    );
    if (fieldInfo == null) {
      fieldInfo =
        assocProcessor.generateField(fullName, itemData, isForcedField);
    }
    return fieldInfo;
  }
  ...
  protected Field makeField(
    ClassAttributeDefinition typeDef,
    Object value,
    FieldGroup group
  ) {
    throw new UnsupportedOperationException(
