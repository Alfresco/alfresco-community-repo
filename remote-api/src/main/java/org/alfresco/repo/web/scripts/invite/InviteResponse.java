...
/**
 * Web Script invoked by Invitee to either accept (response='accept') an invitation from a Site
 * Manager (Inviter) to join a Site as a Site Collaborator, or to reject (response='reject') an
 * invitation that has already been sent out
 *
...
public class InviteResponse extends DeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(final WebScriptRequest req, final Status status) {
        ...
        return TenantUtil.runAsSystemTenant(
                new TenantRunAsWork<Map<String, Object>>() {
