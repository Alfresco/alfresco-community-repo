...
public class SiteMembershipRequestsRelation implements InitializingBean {
  ...
  public void afterPropertiesSet() {
    ParameterCheck.mandatory(
      ...
      this.siteMembershipRequests
    );
  }

  @Operation("approve")
  @WebApiParam(
    name = "siteMembershipApproval",
    title = "Site membership approval",
    description = "Site membership approval",
    kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
  )
  @WebApiDescription(
    title = "Approve a site membership request.",
  ...
  public void approve(
    ...
    siteMembershipRequests.approveSiteMembershipRequest(
      siteId,
      invitationId,
      siteMembershipApproval
    );
  }

  @Operation("reject")
  @WebApiParam(
    name = "siteMembershipRejection",
    title = "Site membership rejection",
    description = "Site membership rejection",
    kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
  )
  @WebApiDescription(
    title = "Reject a site membership request.",
  ...
  public void reject(
    ...
    siteMembershipRequests.rejectSiteMembershipRequest(
      siteId,
      invitationId,
      siteMembershipRejection
    );
  }
}
