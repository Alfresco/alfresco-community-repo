...
public interface EncryptionUtils {
    ...
    /**
     * Authenticate the http method response: validate the MAC, check that the remote IP is as
     * expected and that the timestamp is recent.
     *
     * @param method
     * @param remoteIP
     * @param decryptedBody
    ...
    /**
     * Authenticate the http request: validate the MAC, check that the remote IP is as expected and
