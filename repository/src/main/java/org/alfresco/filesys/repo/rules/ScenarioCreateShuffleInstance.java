...
public class ScenarioCreateShuffleInstance implements ScenarioInstance {
  ...
  private static Log logger = LogFactory.getLog(
    ScenarioCreateShuffleInstance.class
  );
        ...
        if (operation instanceof RenameFileOperation) {
          ...
          if (middle != null) {
            ...
            if (end != null) {
              ...
              RenameFileCommand r1 = new RenameFileCommand(
                end,
                middle,
                r.getRootNodeRef(),
                oldFolder + "\\" + end,
              ...
              CopyContentCommand copyContent = new CopyContentCommand(
                createName,
                move1,
                r.getRootNodeRef(),
              ...
              RenameFileCommand r2 = new RenameFileCommand(
                createName,
                end,
                r.getRootNodeRef(),
                oldFolder + "\\" + createName,
