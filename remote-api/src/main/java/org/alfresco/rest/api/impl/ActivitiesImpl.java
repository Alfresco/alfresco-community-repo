...
public class ActivitiesImpl implements Activities {
  ...
  public void setActivitySummaryParser(
    ActivitySummaryParser activitySummaryParser
  ) {
  ...
  public Map<String, Object> getActivitySummary(ActivityFeedEntity entity)
    ...
    Map<String, Object> activitySummary = activitySummaryParser.parse(
      entity.getActivityType(),
      entity.getActivitySummary()
    );
    ...
    if (who != null) {
      try {
        ...
        throw new InvalidArgumentException(
          "Parameter who should be one of " +
          Arrays.toString(ActivityWho.values())
        );
      }
    }
