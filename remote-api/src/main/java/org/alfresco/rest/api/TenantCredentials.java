...
/**
 * {@link WebCredentials} class which wraps the credentials from the {@link BasicHttpAuthenticator}
 * and adds additional information related to TenantBased logins.
 *
 * @author Alex Miller
        ...
        result =
                prime * result
                        + ((this.originalCredentials == null)
                                ? 0
                                : this.originalCredentials.hashCode());
