...
public class IntegrationFullTests1 extends IntegrationTest {
  ...
  public void updateSiteMembershipRequestWhenSiteVisibilityIsUpdated()
    throws Exception {
    ...
    RestSiteMembershipRequestModel request = restAPI
      .withCoreAPI()
      .usingMe()
    ...
    dataSite
      .usingUser(testUser1)
      .updateSiteVisibility(testSiteModerated, Visibility.PRIVATE);
    ...
    dataSite
      .usingUser(testUser1)
      .updateSiteVisibility(testSiteModerated, Visibility.MODERATED);
    ...
    dataSite
      .usingUser(testUser1)
      .updateSiteVisibility(testSiteModerated, Visibility.PUBLIC);
    ...
    RestTaskModel taskModel = restAPI
      .withWorkflowAPI()
      .getTasks()
      .getTaskModelByDescription(testSiteModerated);
    ...
    restAPI.withCoreAPI().usingMe().getSiteMembershipRequest(testSiteModerated);
    restAPI.assertStatusCodeIs(HttpStatus.NOT_FOUND);
    RestSiteEntry site = restAPI
      .withCoreAPI()
      .usingMe()
      .getSiteMembership(testSiteModerated);
    restAPI.assertStatusCodeIs(HttpStatus.OK);
    site
      .assertThat()
      .field("id")
  ...
  public void getSiteMembersWhenUsersAreAddedOrDeleted() throws Exception {
    ...
    RestSiteMemberModelsCollection members = restAPI
      .authenticateUser(testUser)
      .withCoreAPI()
      .usingSite(testSitePublic)
      .getSiteMembers();
