 ...
 * 
 * The firstNamePattern is used when seed = 0. Then a random element is added and randomNamePattern is used.
 *
 */
public class NameBasedUserNameGenerator implements UserNameGenerator
{
    ...
    /**
     * The pattern of the user name to generate e.g. %lastName%_%firstName% would generate Fred_Bloggs
     * 
     * Patterns available: %lastName%, lower case last name %firstName%, lower case first name %emailAddress% email address %i% lower case first name inital
     * 
