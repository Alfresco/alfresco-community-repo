...
public class TestAspects extends BaseModelApiTest {
  ...
  public void filterAspectsByParentId() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(parentId in ('smf:smartFolder','mycompany:testAspect'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(parentId in ('smf:smartFolder','mycompany:testAspect') AND namespaceUri matches('http://www.test.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(parentId in ('smf:smartFolder', 'mycompany:testAspect') AND not namespaceUri matches('http://www.test.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    aspects.getList().get(0).expected(childAspect);
    ...
    otherParams.put(
      "where",
      "(parentId in ('smf:smartFolder','mycompany:testAspect') AND namespaceUri matches('.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    assertEquals(aspects.getPaging().getTotalItems(), Integer.valueOf(4));
    ...
    otherParams.put(
      "where",
      "(parentId in ('smf:smartFolder', 'mycompany:testAspect') AND not namespaceUri matches('.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
  ...
  public void filterAspectsByModelId() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model','test:scan') AND namespaceUri matches('http://www.test.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model','test:scan') AND not namespaceUri matches('http://www.test.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    assertEquals(aspects.getPaging().getTotalItems(), Integer.valueOf(4));
  ...
  public void testIncludeAssociation() throws PublicApiException {
    ...
    assertEquals(
      aspects.getList().get(4).getAssociations(),
      testAllAspect.getAssociations()
    );
  ...
  public void testIncludeMandatoryAspect() throws PublicApiException {
    ...
    assertEquals(
      aspects.getList().get(4).getMandatoryAspects(),
      testAllAspect.getMandatoryAspects()
    );
  ...
  public void testSubAspects() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model INCLUDESUBASPECTS'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model INCLUDESUBASPECTS') AND namespaceUri matches('http://www.test.*'))"
    );
    aspects =
      publicApiClient.aspects().getAspects(createParams(paging, otherParams));
    aspects.getList().get(0).expected(smartFilterAspect);
  ...
  public void testAspectsById() throws PublicApiException {
    ...
    assertEquals(
      "mandatoryAspects not matched",
      aspect.getMandatoryAspects(),
      testAllAspect.getMandatoryAspects()
    );
    assertEquals(
      "association not matched",
      aspect.getAssociations(),
      testAllAspect.getAssociations()
    );
  ...
  public void testListAspectByInvalidValue() throws PublicApiException {
    ...
    testListAspectException(
      "(modelId in ('mycompany:model','unknown:model','known:model'))"
    );
    testListAspectException("(modelId in ('unknown:model','mycompany:model'))");
    testListAspectException("(modelId in (' ',' ',' ')");
    testListAspectException(
      "(parentId in ('smf:smartFolder','unknown:aspect'))"
    );
    testListAspectException(
      "(parentId in ('unknown:aspect','smf:smartFolder'))"
    );
