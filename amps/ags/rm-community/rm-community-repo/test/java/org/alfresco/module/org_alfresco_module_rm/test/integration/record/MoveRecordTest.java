...
public class MoveRecordTest extends BaseRMTestCase
{
    ...
    /**
     * Given a record is filed in a event disposition and moved then the record no longer has any disposition.
     * 
    ...
    /**
     * Given a record in a event disposition, when it moved to another event disposition then the record should have the new events, rather than the old ones.
     */
    ...
    /**
     * Given a record in a event disposition, when it moved to a time disposition then the record should have the correct as of date and no longer have the events.
     */
