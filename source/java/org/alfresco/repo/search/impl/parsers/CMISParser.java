// $ANTLR 3.2 Sep 23, 2009 12:02:23 W:\\alfresco\\HEAD\\root\\projects\\repository\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g 2010-04-26 13:41:27
...
public class CMISParser extends Parser {
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: functionArgument, cmisFunctionName, RPAREN, LPAREN
                    // token labels: 
    ...
    public final CMISParser.joinedTable_return joinedTable() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: joinType, tableReference, JOIN, joinSpecification
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final CMISParser.quantifiedComparisonPredicate_return quantifiedComparisonPredicate() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: literalOrParameterName, ANY, columnReference, compOp
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final CMISParser.quantifiedInPredicate_return quantifiedInPredicate() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: columnReference, NOT, inValueList, ANY
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
