...
/**
 * Interface to represent WebDAV lock info. This interface mainly exists to allow decoupling of the
 * LockStore classes from the rest of the WebDAV code base therefore allowing the LockStore related
 * classes to live in the repository project without creating a dependency on the remote-api
 * project.
 *
 * @author Matt Ward
 */
public interface LockInfo {
    ...
    /**
     * Whether this lock has expired. If no expiry is set (i.e. expires is null) then false is
     * always returned.
     *
    ...
    /**
     * Sets the expiry date/time to lockTimeout seconds into the future. Provide a lockTimeout of
     * WebDAV.TIMEOUT_INFINITY for never expires.
     *
    ...
    /**
     * Sets the expiry date/time to lockTimeout minutes into the future. Provide a lockTimeout of
     * WebDAV.TIMEOUT_INFINITY for never expires.
     *
