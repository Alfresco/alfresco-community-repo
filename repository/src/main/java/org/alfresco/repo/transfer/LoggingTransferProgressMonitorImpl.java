...
public class LoggingTransferProgressMonitorImpl
  ...
  private static final Log log = LogFactory.getLog(
    LoggingTransferProgressMonitorImpl.class
  );
   ...
   */
  public void logException(String transferId, Object obj, Throwable ex)
    throws TransferException {
  ...
  public void updateProgress(String transferId, int currPos, int endPos)
    ...
    if (loggingEnabled()) {
      localLog(
        transferId,
        "Progress update: " + currPos + " out of " + endPos,
        null
      );
    }
   ...
   */
  public void updateProgress(String transferId, int currPos)
    throws TransferException {
    if (loggingEnabled()) {
      localLog(
        transferId,
        "Progress update: current position = " + currPos,
        null
      );
    }
