 ...
 *
 * <p>Provides special handling for OpenOffice file saves that open the file, truncate, close, then
 * open the file again to write the data, as this causes multiple versions to be generated when the
 * file is versionable.
 *
 * @author gkspencer
 */
public class OpenOfficeContentNetworkFile extends ContentNetworkFile {
    ...
    protected OpenOfficeContentNetworkFile(
        ...
        if (logger.isDebugEnabled())
            logger.debug(
                    "Using OpenOffice network file for "
                            + name
                            + ", versionLabel="
