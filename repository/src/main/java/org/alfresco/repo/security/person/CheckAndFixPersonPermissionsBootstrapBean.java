...
/**
 * Check and fix permission for people. For each person check the permission config matches that
 * configured for the person service.
 *
 * @author andyh
 */
public class CheckAndFixPersonPermissionsBootstrapBean extends AbstractLifecycleBean {
    protected static final Log log =
            LogFactory.getLog(CheckAndFixPersonPermissionsBootstrapBean.class);
                                    ...
                                    public Integer execute() throws Exception {
                                        ...
                                        for (NodeRef person : people) {
                                            ...
                                            if ((excludedUsers != null)
                                                    && excludedUsers.contains(uid)) {
                                                continue;
                                            }
                                            if (!permissionsManager.validatePermissions(
                                                    person, uid, uid)) {
