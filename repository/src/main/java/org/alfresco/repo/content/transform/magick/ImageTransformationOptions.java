...
public class ImageTransformationOptions extends TransformationOptions {
     ...
     *
     * @deprecated will be removed in a future release and be replaced by individual options that
     *     can be checked.
    ...
    public String toString() {
        ...
        builder.append("ImageTransformationOptions [commandOptions=")
                .append(this.commandOptions)
                .append(", resizeOptions=")
                .append(this.resizeOptions)
                .append(", autoOrient=")
                .append(this.autoOrient)
                .append("]");
    ...
    /**
     * @return Will the image be automatically oriented(rotated) based on the EXIF "Orientation"
        ...
        if (origOptions != null) {
            if (origOptions instanceof ImageTransformationOptions) {
                ...
                this.setCommandOptions(
                        ((ImageTransformationOptions) origOptions).getCommandOptions());
                this.setResizeOptions(
                        ((ImageTransformationOptions) origOptions).getResizeOptions());
