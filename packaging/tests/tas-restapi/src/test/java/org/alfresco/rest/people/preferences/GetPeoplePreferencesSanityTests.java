...
public class GetPeoplePreferencesSanityTests extends RestTest {
  ...
  public void collaboratorUserGetsPeoplePreferencesWithSuccess()
    throws Exception {
  ...
  public void contributorUserGetsPeoplePreferencesWithSuccess()
    throws Exception {
  ...
  public void managerUserGetsPeoplePreferencesIsNotAuthorized()
    throws Exception {
    UserModel managerUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(userModel)
