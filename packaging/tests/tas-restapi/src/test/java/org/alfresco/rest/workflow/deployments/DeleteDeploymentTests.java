...
public class DeleteDeploymentTests extends RestTest {
  ...
  @TestRail(
    ...
    description = "Verify admin user deletes a specific deployment using REST API and status code is successful (204)"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void adminDeletesDeploymentWithSuccess() throws Exception {
    ...
    RestDeploymentModelsCollection allDeployments = restClient
    ...
    deployment =
      allDeployments.getDeploymentByName("customWorkflowExtentionForRest.bpmn");

    RestProcessDefinitionModel processDefinitionAssociated = restClient
      .withWorkflowAPI()
    ...
    List<RestTaskModel> processTasks = restClient
      .withWorkflowAPI()
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.DEPLOYMENTS },
    executionType = ExecutionType.SANITY,
    description = "Verify admin user cannot delete an inexistent deployment using REST API and status code is successful (204)"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
