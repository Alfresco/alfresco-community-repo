...
public class DispositionScheduleInheritanceTest extends BaseRMTestCase {
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() {
          ...
          NodeRef subcategory1 = filePlanService.createRecordCategory(
            category1,
            generate()
          );
          ...
          subcategory2 =
            filePlanService.createRecordCategory(category2, generate());

          // create folder under subcategory2
          folder =
            recordFolderService.createRecordFolder(subcategory2, generate());
      ...
      new BehaviourDrivenTest() {
        ...
        public void given() {
          ...
          createDispositionScheduleCutOff(
            category1,
            CutOffAction.NAME,
            CommonRMTestUtils.PERIOD_TEN_DAYS
          );
          ...
          createDispositionScheduleCutOff(
            category2,
            CutOffAction.NAME,
            CommonRMTestUtils.PERIOD_FIVE_DAYS
          );
        ...
        public void then() throws Exception {
          ...
          DispositionAction dispositionActionAfterMove = dispositionService.getNextDispositionAction(
            record
          );
          ...
          assertTrue(
            (Boolean) nodeService.getProperty(
              record,
              PROP_RS_HAS_DISPOITION_SCHEDULE
            )
          );
        }
      }
  ...
  private void createDispositionScheduleCutOff(
    NodeRef category,
    String action,
    String period
  ) {
  ...
  private void createDispositionScheduleCutOffAndRetainImmediately(
    NodeRef category
  ) {
    DispositionSchedule ds = utils.createDispositionSchedule(
      category,
  ...
  private void createDispositionScheduleRetainAndCutOffOneDay(
    NodeRef category
  ) {
    DispositionSchedule ds = utils.createDispositionSchedule(
      category,
    ...
    createDispositionScheduleStep(
      ds,
      RetainAction.NAME,
      CommonRMTestUtils.PERIOD_ONE_DAY
    );
    createDispositionScheduleStep(
      ds,
      DestroyAction.NAME,
  ...
  private void createDispositionScheduleCutOffAndDestroyOneDay(
    NodeRef category
  ) {
    DispositionSchedule ds = utils.createDispositionSchedule(
      category,
