...
public class WebApplicationContextLoader {
  ...
  public static synchronized ConfigurableApplicationContext getApplicationContext(
    ...
    AbstractApplicationContext ctx = (AbstractApplicationContext) BaseApplicationContextHelper.getApplicationContext(
      configLocations
    );

    CmisServiceFactory factory = (CmisServiceFactory) ctx.getBean(
      "CMISServiceFactory"
    );
    ...
    servletContext.setAttribute(
      GenericWebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE,
      gwac
    );
    servletContext.setAttribute(
  ...
  public static synchronized ConfigurableApplicationContext getApplicationContext(
    ...
    final AbstractApplicationContext ctx = (AbstractApplicationContext) BaseApplicationContextHelper.getApplicationContext(
      configLocations,
      classLocations
    );
    DefaultListableBeanFactory dlbf = new DefaultListableBeanFactory(
