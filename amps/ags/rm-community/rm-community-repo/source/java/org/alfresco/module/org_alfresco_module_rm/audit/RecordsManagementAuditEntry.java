...
public final class RecordsManagementAuditEntry {
    ...
    /** Default constructor */
    public RecordsManagementAuditEntry(
            Date timestamp,
            String userName,
            String fullName,
            String userRole,
    ...
    public String toString() {
        ...
        sb.append("(")
                ...
                .append(", path=")
                .append(path)
                .append(", beforeProperties=")
                .append(beforeProperties)
                .append(", afterProperties=")
                .append(afterProperties)
    ...
    /**
     * @return The human readable description of the reason for the audit log entry i.e. metadata
     *     updated, record declared
     */
    ...
    /**
     * An identifier for the item being audited, for example for a record it will be the unique
     * record identifier, for a user it would be the username etc.
     *
    ...
    private void initChangedProperties() {
        if (this.beforeProperties != null && this.afterProperties != null) {
            this.changedProperties =
                    new HashMap<>(this.beforeProperties.size() + this.afterProperties.size());
            ...
            for (Map.Entry<QName, Serializable> entry : this.beforeProperties.entrySet()) {
                ...
                Pair<Serializable, Serializable> values =
                        new Pair<>(entry.getValue(), this.afterProperties.get(valuePropName));
