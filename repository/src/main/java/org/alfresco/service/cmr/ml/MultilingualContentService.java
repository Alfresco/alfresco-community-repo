...
public interface MultilingualContentService {
     ...
     * creating a <b>cm:mlContainer</b> parent. If it is already a translation, then nothing is
     * done.
     *
     * @param contentNodeRef An existing <b>cm:content</b>
    ...
    /**
     * Removes the node from any associated translations. If the translation is the pivot
     * translation, then the entire set of translations will be unhooked.
     *
    ...
    /**
     * Make a translation out of an existing document. The necessary translation structures will be
     ...
     * locale. If there is not even a {@link
     * org.springframework.extensions.surf.util.I18NUtil#getNearestLocale(Locale, Set) partial
     * match}, then the {@link #getPivotTranslation(NodeRef) pivot translation} is used. If that
     * also gives no results then the translation itself is returned.
     *
    ...
    /**
     * Given a <b>cm:mlDocument</b> or <b>cm:mlContainer</b> this node returns each locale for which
     * there isn't a translation.
     *
     * @param localizedNodeRef the <b>cm:mlDocument</b> or <b>cm:mlContainer</b>
     * @param addThisNodeLocale if true, add the locale of the given <b>cm:mlDocument</b> in the
     *     list.
    ...
    /**
     * Given any node, this returns the pivot translation. All multilingual documents belong to a
     * group linked by a hidden parent node of type <b>cm:mlContainer</b>. The pivot language for
     * the translations is stored on the parent, and the child that has the same locale is the pivot
     * translation.
     *
     * @param nodeRef a <b>cm:mlDocument</b> translation or <b>cm:mlContainer</b> translation
     *     container
     * @return Returns a corresponding <b>cm:mlDocument</b> that matches the locale of of the
     *     <b>cm:mlContainer</b>. <tt>null</tt> is returned if there is no pivot translation.
     */
     ...
     * </pre>
     *
     * <p>The necessary translation structures will be created as necessary.
     *
     * @param translationOfNodeRef An existing <b>cm:mlDocument</b>
     * @param name The name of the file to create, or <tt>null</tt> to use the default naming
     *     convention.
     ...
     *
     * <p>This involves the copy of the <b>cm:mlContainer</b> node and the copy of its
     * <b>cm:mlDocument</b>.
     *
     * <p>
     *
    ...
    NodeRef copyTranslationContainer(
            NodeRef mlContainerNodeRef, NodeRef newParentRef, String prefixName)
            throws FileExistsException, FileNotFoundException, Exception;

    /**
     * Moves the location of the given <b>cm:mlContainer</b>.
     *
     * <p>This not involves changing the <b>cm:mlContainer</b> node but moves its
     * <b>cm:mlDocument</b>.
     *
     * <p>
     *
     ...
     */
    @Auditable(parameters = {"mlContainerNodeRef", "newParentRef"})
    void moveTranslationContainer(NodeRef mlContainerNodeRef, NodeRef newParentRef)
            throws FileExistsException, FileNotFoundException;

    /**
     * Delete the given mlContainer and its translations. The translations will lost their
     * <b>cm:mlDocument</b> aspect and will be archved. The empty translations will be permanently
     * deleted.
     *
