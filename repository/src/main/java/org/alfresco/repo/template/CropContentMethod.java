...
/**
 * @author Kevin Roast
 *     <p>FreeMarker custom method to return the first N characters of a content stream.
 *     <p>Usage: String cropContent(TemplateContentData content, int length)
 */
public final class CropContentMethod extends BaseProcessorExtension
