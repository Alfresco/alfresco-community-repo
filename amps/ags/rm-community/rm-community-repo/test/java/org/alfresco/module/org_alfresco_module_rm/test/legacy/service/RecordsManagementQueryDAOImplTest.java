...
public class RecordsManagementQueryDAOImplTest
  ...
  protected void initServices() {
    ...
    queryDAO =
      (RecordsManagementQueryDAO) applicationContext.getBean(
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          String existingID = (String) nodeService.getProperty(
            recordOne,
            PROP_IDENTIFIER
          );
   ...
   */
  @org.junit.Test
  public void testGetChildrenWithPropertyValues_childrenWithValues()
    throws Exception {
   ...
   */
  @org.junit.Test
  public void testGetChildrenWithPropertyValues_someChildrenWithValues()
    throws Exception {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        NodeRef parentFolder;
   ...
   */
  @org.junit.Test
  public void testGetChildrenWithPropertyValues_propertyNotSetOnChildren()
    throws Exception {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        NodeRef parentFolder;
   ...
   */
  @org.junit.Test
  public void testGetChildrenWithPropertyValues_propertyNotUsed()
    throws Exception {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        NodeRef parentFolder;
        ...
        public void when() throws Exception {
          propertyValues =
            queryDAO.getChildrenStringPropertyValues(folder, property);
        }
