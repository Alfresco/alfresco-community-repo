...
public interface AuditInfo {
    /**
     * The identifier for the application that performed the audit. Method interceptors around
     * public services will use the string 'SystemMethodInterceptor'.
     *
     ...
     * Filters are not applied in version 1.4.
     *
     * @return boolean
     */
     ...
     *
     * @return - the id of the key node - this may be null if there is no key or the key is not a
     *     node ref.
     */
    public String getKeyGUID();

    /**
     * The serialized properties on the key node, if one exists, after the method invocation. Note
     * these values are serialized before the method is called so they are unaffected by the method
     * invocation. In V1.4 these are not stored.
     *
     * @return Map
     */
    ...
    /**
     * The serialized properties on the key node, if one exists, before the method invocation. In
     * V1.4 these are not stored.
     *
     * @return Map
     */
     ...
     *
     * @return - the audit message. This may be null, and will be null for audit entries generated
     ...
     *
     * <p>These are not stored in V1.4.
     *
     * @return Serializable[]
     */
     ...
     *
     * <p>This is not available in V1.4.
     *
     * @return Serializable
     */
     ...
     *
     * @return - the string value of the return object. May be null if the method is of type void or
     *     returns null.
     */
