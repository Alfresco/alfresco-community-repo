...
public class TenantAdminSystemTest extends TestCase {
  ...
  private static final String TENANT_PREFIX =
  ...
  public void testLogin() throws Exception {
    String ticket = callLoginWebScript(
      WEBSCRIPT_ENDPOINT,
      ADMIN_USER,
      ADMIN_PW
    );
  ...
  protected static void createTenant(String tenantDomain, String ticket)
    throws Exception {
  ...
  protected static String callPostWebScript(
    String urlString,
    String ticket,
    String data
  ) throws MalformedURLException, URISyntaxException, IOException {
  ...
  protected static String callPutWebScript(
    String urlString,
    String ticket,
    String data
  ) throws MalformedURLException, URISyntaxException, IOException {
  ...
  private static String callOutWebScript(
    String urlString,
    String method,
    String ticket
  ) throws MalformedURLException, URISyntaxException, IOException {
  ...
  private static String callInOutWebScript(
    String urlString,
    String method,
    String ticket,
    String data
  ...
  private static String callInOutWeb(
    String urlString,
    String method,
    String ticket,
    String data,
  ...
  protected static String callLoginWebScript(
    String serviceUrl,
    String username,
    String password
  ) throws MalformedURLException, URISyntaxException, IOException {
    // Refer to: http://wiki.alfresco.com/wiki/Web_Scripts_Framework#HTTP_Basic_Authentication
    String ticketResult = callGetWebScript(
      serviceUrl + "/api/login?u=" + username + "&pw=" + password,
      null
    );
    ...
    if (ticketResult != null) {
      ...
      if ((startTag != -1) && (endTag != -1)) {
        ticketResult =
          ticketResult.substring(startTag + ("<ticket>".length()), endTag);
      }
    }
        ...
        for (int i = startId; i <= endId; i++) {
          ...
          switch (op) {
            case CREATE_TENANT:
              ...
              createTenant(
                TENANT_PREFIX + "--" + String.format("%05d", i),
                ticket
              );
              break;
            default:
