...
public abstract class AbstractAclCrudDAOImpl implements AclCrudDAO {
   ...
   */
  public void setAclEntityCache(
    TransactionalCache<Serializable, Object> aclEntityCache
  ) {
    this.aclEntityCache =
      new EntityLookupCache<Long, AclEntity, Serializable>(
        aclEntityCache,
        CACHE_REGION_ACL,
   ...
   */
  public void setAuthorityEntityCache(
    SimpleCache<Serializable, Object> authorityEntityCache
  ) {
    this.authorityEntityCache =
      new EntityLookupCache<Long, AuthorityEntity, String>(
   ...
   */
  public void setPermissionEntityCache(
    SimpleCache<Serializable, Object> permissionEntityCache
  ) {
    this.permissionEntityCache =
      new EntityLookupCache<Long, PermissionEntity, PermissionEntity>(
  ...
  public AclEntity createAcl(AclEntity entity) {
    ...
    Pair<Long, AclEntity> entityPair = aclEntityCache.getOrCreateByValue(
      entity
    );
  ...
  public void deleteAcl(long id) {
    ...
    if (deleted < 1) {
      ...
      throw new ConcurrencyFailureException(
        "AclEntity with ID " + id + " no longer exists"
      );
    }
  }
  ...
  private class AclEntityCallbackDAO
    implements EntityLookupCallbackDAO<Long, AclEntity, Serializable> {
  ...
  protected abstract List<Long> getADMNodeEntityIdsByAcl(
    long aclEntityId,
    int maxResults
  );
  ...
  public void addAclMembersToAcl(long aclId, List<Long> aceIds, int depth) {
    ...
    List<AclMemberEntity> newMembers = new ArrayList<AclMemberEntity>(
      aceIds.size()
    );
  ...
  public void addAclMembersToAcl(
    long aclId,
  ...
  public List<AclMemberEntity> getAclMembersByAclForUpdate(long idOfAcl) {
    ...
    List<AclMemberEntity> membersForUpdate = new ArrayList<AclMemberEntity>(
      members.size()
    );
  ...
  public List<AclMember> getAclMembersByAuthority(String authorityName) {
    List<AclMemberEntity> entities = getAclMemberEntitiesByAuthority(
      authorityName
    );
    List<AclMember> result = new ArrayList<AclMember>(entities.size());
    result.addAll(entities);
  ...
  protected abstract AclMemberEntity createAclMemberEntity(
    AclMemberEntity entity
  );

  protected abstract List<AclMemberEntity> getAclMemberEntitiesByAcl(
    long idOfAcl
  );

  protected abstract List<AclMemberEntity> getAclMemberEntitiesByAuthority(
  ...
  protected abstract AclMemberEntity getAclMemberEntity(
    long aclId,
    long aceId,
    int pos
  );
  ...
  public void updateAclChangeSet(Long aclChangeSetEntityId, long commitTimeMs) {
    ...
    if (updated != 1) {
      throw new ConcurrencyFailureException(
        "Update by ID should delete exactly 1: " + aclChangeSetEntityId
      );
    }
  }
  ...
  public void deleteAclChangeSet(Long changeSetId) {
    ...
    if (deleted != 1) {
      ...
      throw new ConcurrencyFailureException(
        "Deleted by ID should delete exactly 1: " + changeSetId
      );
    }
  }
  ...
  protected abstract AceEntity getAceEntity(
    long permissionId,
    long authorityId,
    boolean allowed,
    ACEType type
  ...
  protected abstract List<Map<String, Object>> getAceAndAuthorityEntitiesByAcl(
    long idOfAcl
  );
  ...
  public Permission createPermission(PermissionReference permissionReference) {
    ...
    Pair<Long, QName> qnamePair = qnameDAO.getOrCreateQName(
      permissionReference.getQName()
    );
    if (qnamePair != null) {
      ...
      Pair<Long, PermissionEntity> entityPair = permissionEntityCache.getOrCreateByValue(
        entity
      );
  ...
  public Permission getPermission(long id) {
    Pair<Long, PermissionEntity> entityPair = permissionEntityCache.getByKey(
      id
    );
    if (entityPair == null) {
      return null;
  ...
  private PermissionEntity getPermissionImpl(
    ...
    if (qnamePair != null) {
      ...
      PermissionEntity permission = new PermissionEntity(
        qnameId,
        permissionReference.getName()
      );
      Pair<Long, PermissionEntity> entityPair = permissionEntityCache.getByValue(
        permission
      );
      if (entityPair != null) {
        entity = entityPair.getSecond();
  ...
  private PermissionEntity getPermissionForUpdate(
    PermissionReference permissionReference
  ) {
  ...
  public Permission getOrCreatePermission(
    PermissionReference permissionReference
  ) {
  ...
  public void renamePermission(
    ...
    if (oldTypeQName.equals(newTypeQName) && oldName.equals(newName)) {
      throw new IllegalArgumentException(
        "Cannot move permission to itself: " + oldTypeQName + "-" + oldName
      );
    }

    SimplePermissionReference oldPermRef = SimplePermissionReference.getPermissionReference(
      oldTypeQName,
      oldName
    );
    ...
    if (permission != null) {
      ...
      int updated = permissionEntityCache.updateValue(
        permission.getId(),
        permission
      );
      if (updated < 1) {
  ...
  public void deletePermission(long id) {
    ...
    if (deleted < 1) {
      aclEntityCache.removeByKey(id);
      throw new ConcurrencyFailureException(
        "PermissionEntity with ID " + id + " no longer exists"
      );
    }
  }
  ...
  private class PermissionEntityCallbackDAO
    implements
      EntityLookupCallbackDAO<Long, PermissionEntity, PermissionEntity> {

    private final Pair<Long, PermissionEntity> convertEntityToPair(
    ...
    public Pair<Long, PermissionEntity> findByValue(PermissionEntity value) {
      if (
        ...
        throw new AlfrescoRuntimeException(
          "Unexpected: PermissionEntity / name / qnameId must not be null"
        );
      }
      return convertEntityToPair(
        getPermissionEntity(value.getTypeQNameId(), value.getName())
      );
    }
  ...
  protected abstract PermissionEntity createPermissionEntity(
    PermissionEntity entity
  );

  protected abstract PermissionEntity getPermissionEntity(long id);

  protected abstract PermissionEntity getPermissionEntity(
    long qnameId,
    String name
  );
  ...
  public Authority createAuthority(String authorityName) {
    ...
    entity.setCrc(
      CrcHelper.getStringCrcPair(authorityName, 32, true, true).getSecond()
    );

    entity.setVersion(0L);

    Pair<Long, AuthorityEntity> entityPair = authorityEntityCache.getOrCreateByValue(
      entity
    );
    return entityPair.getSecond();
  }
  ...
  private AuthorityEntity getAuthorityImpl(String authorityName) {
    ...
    Pair<Long, AuthorityEntity> entityPair = authorityEntityCache.getByValue(
      authority
    );
    if (entityPair == null) {
      return null;
  ...
  public void renameAuthority(String before, String after) {
    ...
    if (entity != null) {
      ...
      entity.setCrc(
        CrcHelper.getStringCrcPair(after, 32, true, true).getSecond()
      );
  ...
  public void deleteAuthority(long id) {
    ...
    if (deleted < 1) {
      aclEntityCache.removeByKey(id);
      throw new ConcurrencyFailureException(
        "AuthorityEntity with ID " + id + " no longer exists"
      );
    }
  }
  ...
  private class AuthorityEntityCallbackDAO
    implements EntityLookupCallbackDAO<Long, AuthorityEntity, String> {

    private final Pair<Long, AuthorityEntity> convertEntityToPair(
    ...
    public Pair<Long, AuthorityEntity> findByValue(AuthorityEntity value) {
      if ((value == null) || (value.getAuthority() == null)) {
        throw new AlfrescoRuntimeException(
          "Unexpected: AuthorityEntity / name must not be null"
        );
      }
  ...
  protected abstract AuthorityEntity createAuthorityEntity(
    AuthorityEntity entity
  );
  ...
  protected abstract long createAuthorityAliasEntity(
    AuthorityAliasEntity entity
  );
   ...
   * @return Long
   */
  protected abstract Long selectMaxChangeSetIdBeforeCommitTime(
    long maxCommitTime
  );
}
