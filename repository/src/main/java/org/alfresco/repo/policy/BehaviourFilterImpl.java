...
public class BehaviourFilterImpl implements BehaviourFilter, Extensible {
  ...
  private static final String KEY_FILTER_COUNT =
    "BehaviourFilterImpl.filterCount";
  private static final String KEY_GLOBAL_FILTERS =
    "BehaviourFilterImpl.globalFilters";
  private static final String KEY_CLASS_FILTERS =
    "BehaviourFilterImpl.classFilters";
  private static final String KEY_INSTANCE_CLASS_FILTERS =
    "BehaviourFilterImpl.instanceClassFilters";
  private static final String KEY_INSTANCE_FILTERS =
    "BehaviourFilterImpl.instanceFilters";

  private static final Log logger = LogFactory.getLog(
    BehaviourFilterImpl.class
  );
  ...
  public BehaviourFilterImpl() {
    super();
    this.behaviourFilterTrait =
      new ExtendedTrait<>(
        AJProxyTrait.create(this, BehaviourFilterTrait.class)
      );
  }
  ...
  // TODO
  @Extend(
    traitAPI = BehaviourFilterTrait.class,
    extensionAPI = BehaviourFilterExtension.class
  )
  ...
  public void disableBehaviour() {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
        "   Now: " + TransactionalResourceHelper.getCount(KEY_GLOBAL_FILTERS)
      );
    }
  }
  ...
  public void disableBehaviour(QName className, boolean includeSubClasses) {
    ...
    Map<ClassFilter, MutableInt> classFilters = TransactionalResourceHelper.getMap(
      KEY_CLASS_FILTERS
    );
  ...
  public void disableBehaviour(NodeRef nodeRef, QName className) {
    ...
    Map<NodeRef, Map<QName, MutableInt>> instanceClassFilters = TransactionalResourceHelper.getMap(
      KEY_INSTANCE_CLASS_FILTERS
    );
  ...
  public void disableBehaviour(NodeRef nodeRef) {
    ...
    Map<NodeRef, MutableInt> instanceFilters = TransactionalResourceHelper.getMap(
  ...
  public void enableBehaviour(NodeRef nodeRef, QName className) {
    ...
    if (
      !TransactionalResourceHelper.isResourcePresent(KEY_INSTANCE_CLASS_FILTERS)
    ) {
      // Nothing was disabled
      return;
    }
