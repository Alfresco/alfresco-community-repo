...
public class NodeVersionRenditionsApiTest extends AbstractSingleNetworkSiteTest {
     ...
     *
     * @literal
     *     <host>:<port>/alfresco/api/-default-/public/alfresco/versions/1/nodes/<nodeId>/versions/<versionId>/renditions}
     *     <p>GET: {@literal
     *     <host>:<port>/alfresco/api/<networkId>/public/alfresco/versions/1/nodes/<nodeId>/versions/<versionId>/renditions}
     *     {@literal
     *     <host>:<port>/alfresco/api/<networkId>/public/alfresco/versions/1/nodes/<nodeId>/versions/<versionId>/renditions/<renditionId>}
     *     {@literal
     *     <host>:<port>/alfresco/api/<networkId>/public/alfresco/versions/1/nodes/<nodeId>/versions/<versionId>/renditions/<renditionId>/content}
     * @throws Exception
     */
    @Test
    ...
    private void checkCreateAndGetVersionRendition(
            String docId, String versionId, String renditionId) throws Exception {
    ...
    private void checkAndGetVersionRendition(String docId, String versionId, String renditionId)
            throws Exception {
        String getRenditionsUrl;
        if ((versionId != null) && (!versionId.isEmpty())) {
            getRenditionsUrl = getNodeVersionRenditionsUrl(docId, versionId);
