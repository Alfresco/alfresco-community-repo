...
/**
 * Shared pipeline for the Search API web scripts. Subclasses only choose the pagination via {@link #applyPaginationContract}: {@link SearchApiWebscript} (offset) and {@link DeepSearchApiWebscript} (search_after).
 */
public abstract class AbstractSearchApiWebscript extends AbstractWebScript implements RecognizedParamsExtractor, RequestReader, ResponseWriter,
        InitializingBean
{
    ...
    public void execute(WebScriptRequest webScriptRequest, WebScriptResponse webScriptResponse) throws IOException
    {
        try
        {
            ...
            applyPaginationContract(searchParams, searchQuery);
    ...
    /**
     * Applies the endpoint's pagination to the search parameters (offset for /search, search_after for /deep-search).
     */
    protected abstract void applyPaginationContract(SearchParameters searchParams, SearchQuery searchQuery);
}
