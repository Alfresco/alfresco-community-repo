 ...
 *
 * <p>The implementation is responsible for creating job details, triggers and registering with a
 * scheduler.
 *
 * <p>This is not used anywhere at the moment. When we have a service then scheduled actions will be
...
public interface ScheduledActionDefinition extends InitializingBean {
    ...
    /**
     * Register with a scheduler. This should be called in the implementation afterPropertiesSet()
