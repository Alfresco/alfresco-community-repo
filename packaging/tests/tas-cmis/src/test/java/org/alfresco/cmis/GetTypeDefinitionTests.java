...
public class GetTypeDefinitionTests extends CmisTest {
  ...
  public void siteManagerShouldGetTypeDefinitionForValidFolder()
    throws Exception {
  ...
  @Test(groups = { TestGroup.SANITY, TestGroup.CMIS })
  public void siteManagerShouldGetTypeDefinitionForValidDocument()
    throws Exception {
  ...
  public void siteManagerShouldGetTypeDefinitionForDeletedDocument()
    throws Exception {
  ...
  public void deletedUserCannotGetTypeDefinitionForValidFolder()
    throws Exception {
    UserModel deletedUser = dataUser.createRandomTestUser();

    dataUser
      .usingUser(testUser)
      .addUserToSite(deletedUser, publicSite, UserRole.SiteManager);
    testFolder = FolderModel.getRandomFolderModel();
    ...
    cmisApi
      .disconnect()
      .assertThat()
      .baseTypeIdIs(BaseTypeId.CMIS_FOLDER.value());
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorGetTypeDefinitionForValidFolder()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorGetTypeDefinitionForValidFolder()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
  ...
  public void siteConsumerCantGetTypeDefinitionForValidFolder()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
  ...
  public void outsideUserPrivateSiteCantGetTypeDefinitionForValidFile()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.XML);
  ...
  public void outsideUserModeratedSiteGetTypeDefinitionForValidFile()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.XML);
  ...
  public void outsideUserPrivateSiteCantGetTypeDefinitionForValidFolder()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.XML);
  ...
  public void outsideUserModeratedSiteGetTypeDefinitionForValidFolder()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.XML);
