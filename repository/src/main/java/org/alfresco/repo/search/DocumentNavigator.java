...
public class DocumentNavigator
  ...
  public String getAttributeQName(Object o) {
    ...
    if (EqualsHelper.nullSafeEquals(escapedLocalName, qName.getLocalName())) {
      ...
      return QName
        .createQName(qName.getNamespaceURI(), escapedLocalName)
        .toString();
    }
  }
  ...
  public String getCommentStringValue(Object o) {
    ...
    throw new UnsupportedOperationException(
      "Comment string values are unsupported"
    );
  }
  ...
  public String getElementStringValue(Object o) {
    throw new UnsupportedOperationException(
      "Element string values are unsupported"
    );
  }
  ...
  public Iterator getChildAxisIterator(
    ...
    if (
      localName != null &&
      (
        localName.equalsIgnoreCase("true") ||
        localName.equalsIgnoreCase("false")
      )
    ) {
      return Collections
        .singletonList(new Boolean(Boolean.parseBoolean(localName)))
        .iterator();
    }
    ...
    list =
      nodeService.getChildAssocs(childRef, RegexQNamePattern.MATCH_ALL, qName);
    // done
    ...
    if (o instanceof ChildAssociationRef) {
      ...
      if (contextRef.getParentRef() != null) {
        if (followAllParentLinks) {
          for (ChildAssociationRef car : nodeService.getParentAssocs(
            contextRef.getChildRef()
          )) {
  ...
  public List<ChildAssociationRef> getNode(
    NodeRef nodeRef,
