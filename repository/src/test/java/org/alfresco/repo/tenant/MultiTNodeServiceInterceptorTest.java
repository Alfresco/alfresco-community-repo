        ...
        AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        RetryingTransactionCallback<Object> createTenantCallback =
                                new RetryingTransactionCallback<Object>() {
                                    public Object execute() throws Throwable {
                                        tenantAdminService.createTenant(
                                                tenant1, tenant1Pwd.toCharArray());
                                        return null;
                                    }
                                };
                        transactionService
                                .getRetryingTransactionHelper()
                                .doInTransaction(createTenantCallback, false, true);
                        return null;
                    }
                },
    ...
    public void tearDown() throws Exception {
        ...
        AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Void>() {
                    @Override
                    public Void doWork() throws Exception {
                        RetryingTransactionCallback<Object> deleteTenantCallback =
                                new RetryingTransactionCallback<Object>() {
                                    public Object execute() throws Throwable {
                        ...
                        transactionService
                                .getRetryingTransactionHelper()
                                .doInTransaction(deleteTenantCallback, false, true);
                        return null;
                    }
                },
                AuthenticationUtil.getAdminUserName());
