...
public class NodesEntityResource
  ...
  @WebApiDescription(
    title = "Copy Node",
    description = "Copy one or more nodes (files or folders) to a new target folder, with option to rename."
  )
  ...
  public DirectAccessUrl requestContentDirectUrl(
    ...
    try {
      directAccessUrl =
        nodes.requestContentDirectUrl(nodeRef, attachment, validFor);
