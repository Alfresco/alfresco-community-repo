...
public class FingerPrintTest extends AbstractE2EFunctionalTest
{
    ...
    /**
     * File to be created in dataprep with same content as fileOriginal File to be updated in test searchAfterVersionUpdate File to be reverted in test searchAfterVersionRevert
     */
