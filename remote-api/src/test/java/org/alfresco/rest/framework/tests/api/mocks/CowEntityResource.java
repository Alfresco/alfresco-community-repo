...
public class CowEntityResource
    ...
    public static final Cache CACHE_COW =
            new Cache(
    ...
    public CollectionWithPagingInfo<Goat> readAll(Parameters params, WithResponse withResponse) {
        return CollectionWithPagingInfo.asPaged(
                params.getPaging(), Arrays.asList(new Goat("Cow1")));
    }

    @Override
    public List<Goat> create(
            List<Goat> entities, Parameters parameters, WithResponse withResponse) {
