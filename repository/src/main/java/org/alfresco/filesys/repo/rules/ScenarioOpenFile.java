 ...
 *
 * <p>Only on the last close does the repo get closed. Open Files in the middle share the same file
 * handle.
 *
 * <p>For example:
 *
 * <p>1) open(readOnly) 2) open(readWrite) 3) open(readOnly) - does nothing. 4) close - does nothing
 * 5) close - does nothing 6) close - updates the repo
 */
public class ScenarioOpenFile implements Scenario {
    ...
    private boolean checkScenarioActive(
            String name, final List<ScenarioInstance> currentInstances) {
