...
public abstract class VirtualizationIntegrationTest
  ...
  private static Log logger = LogFactory.getLog(
    VirtualizationIntegrationTest.class
  );

  private static final String PROP_VM_TEMPLATE_CLASSPATH =
    "prop_smf_system-template-location";
  ...
  protected static final String TEST_TEMPLATE_CLASSPATH =
    "/org/alfresco/repo/virtual/template/";

  protected static final String TEST_TEMPLATE_1_JS_NAME = "testTemplate1.js";

  protected static final String TEST_TEMPLATE_1_JSON_NAME =
    "testTemplate1.json";

  protected static final String TEST_TEMPLATE_2_JSON_NAME =
    "testTemplate2.json";

  protected static final String TEST_TEMPLATE_3_JSON_NAME =
    "testTemplate3.json";

  protected static final String TEST_TEMPLATE_4_JSON_NAME =
    "testTemplate4.json";

  protected static final String TEST_TEMPLATE_5_JSON_NAME =
    "testTemplate5.json";

  protected static final String TEST_TEMPLATE_6_JSON_NAME =
    "testTemplate6.json";

  protected static final String TEST_TEMPLATE_1_JS_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_1_JS_NAME;

  protected static final String TEST_TEMPLATE_1_JSON_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_1_JSON_NAME;

  protected static final String TEST_TEMPLATE_2_JSON_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_2_JSON_NAME;

  protected static final String TEST_TEMPLATE_3_JSON_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_3_JSON_NAME;

  protected static final String TEST_TEMPLATE_4_JSON_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_4_JSON_NAME;

  protected static final String TEST_TEMPLATE_5_JSON_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_5_JSON_NAME;

  protected static final String TEST_TEMPLATE_6_JSON_CLASSPATH =
    TEST_TEMPLATE_CLASSPATH + TEST_TEMPLATE_6_JSON_NAME;

  protected static final String TEST_TEMPLATE_1_JSON_SYS_PATH =
    "C" + TEST_TEMPLATE_1_JSON_CLASSPATH;

  protected static final String TEST_TEMPLATE_2_JSON_SYS_PATH =
    "C" + TEST_TEMPLATE_2_JSON_CLASSPATH;

  protected static final String TEST_TEMPLATE_3_JSON_SYS_PATH =
    "C" + TEST_TEMPLATE_3_JSON_CLASSPATH;

  protected static final String TEST_TEMPLATE_4_JSON_SYS_PATH =
    "C" + TEST_TEMPLATE_4_JSON_CLASSPATH;

  protected static final String TEST_TEMPLATE_5_JSON_SYS_PATH =
    "C" + TEST_TEMPLATE_5_JSON_CLASSPATH;

  protected static final String TEST_TEMPLATE_6_JSON_SYS_PATH =
    "C" + TEST_TEMPLATE_6_JSON_CLASSPATH;

  protected static final String TEST_TEMPLATE_1_JS_SYS_PATH =
    "C" + TEST_TEMPLATE_1_JS_CLASSPATH;

  public static final String VANILLA_PROCESSOR_JS_CLASSPATH =
    "/org/alfresco/repo/virtual/node/vanilla.js";
  ...
  public void setUp() throws Exception {
    ...
    virtualizationConfigTestBootstrap =
      ctx.getBean(
        VIRTUALIZATION_CONFIG_TEST_BOOTSTRAP_BEAN_ID,
    ...
    authenticationComponent =
      ctx.getBean("authenticationComponent", AuthenticationComponent.class);

    environment = ctx.getBean("actualEnvironment", ActualEnvironment.class);

    typeAndAspectsFormProcessor =
      ctx.getBean(
        "typeAndAspectsFormProcessor",
    ...
    if (!virtualizationConfigTestBootstrap.areVirtualFoldersEnabled()) {
      ...
      SpringExtensionBundle vfBundle = ctx.getBean(
        "smartFoldersBundle",
  ...
  public void tearDown() throws Exception {
    ...
    try {
      ...
      logger.error(
        "Test tear down failed. Has the test setup transaction been tempered with ? Hint : " +
        txnTamperHint,
        e
      );
    }
   ...
   */
  protected NodeRef createVirtualizedFolder(
    NodeRef parent,
    String name,
    ...
    return (NodeRef) typeAndAspectsFormProcessor.persist(
      testItem,
      testFormData
    );
  }
  ...
  protected void assertVirtualNode(NodeRef nodeRef) {
    assertVirtualNode(nodeRef, Collections.<QName, Serializable>emptyMap());
  }

  protected void assertVirtualNode(
    NodeRef nodeRef,
    ...
    assertTrue(
      nodeService.hasAspect(nodeRef, VirtualContentModel.ASPECT_VIRTUAL)
    );
    Set<QName> aspects = nodeService.getAspects(nodeRef);
    assertTrue(
      "Smart virtual node missing virtual aspect",
      aspects.contains(VirtualContentModel.ASPECT_VIRTUAL)
    );
    //ACE-5303 injected properties title and description  require the titled aspect
    assertTrue(
      "Smaft virtual node missing titled aspect",
    ...
    List<QName> mandatoryProperties = Arrays.asList(
    ...
    assertTrue(
      "Mandatory properties are missing" + missingPropreties,
      missingPropreties.isEmpty()
    );

    assertFalse(
      "ACE-5303 : ContentModel.PROP_TITLE should remain unset",
      nodeProperties.containsKey(ContentModel.PROP_TITLE)
    );
    ...
    assertTrue(
      "Unexpected property values : " + unexpectedStr,
      unexpectedStr.isEmpty()
    );
  }

  protected ChildAssociationRef createTypedNode(
    NodeRef parent,
    final String name,
    QName type
  ) {
  ...
  protected ChildAssociationRef createTypedNode(
    ...
    newProperties.put(ContentModel.PROP_NAME, name);
  ...
  protected ChildAssociationRef createFolder(
    NodeRef parent,
    final String name
  ) {
    return createTypedNode(parent, name, ContentModel.TYPE_FOLDER);
  }
  ...
  protected ChildAssociationRef createFolder(
    ...
    return createTypedNode(parent, name, ContentModel.TYPE_FOLDER, properties);
  }

  protected ChildAssociationRef createContent(
    NodeRef parent,
    final String name
  ) {
    return createTypedNode(parent, name, ContentModel.TYPE_CONTENT);
  }
  ...
  protected ChildAssociationRef createContent(
    ...
    ChildAssociationRef nodeAssoc = createTypedNode(
      parent,
      name,
      ContentModel.TYPE_CONTENT
    );
  ...
  protected void setupMocks() {
    SearchServiceSubSystemDelegator searchServiceDelegator = (SearchServiceSubSystemDelegator) ctx.getBean(
      "searchService"
    );
    ...
    doReturn(dbResults)
      .when(searchServiceDelegatorSpy)
      .query(argThat(getArgMatcher()));
  }
  ...
  protected void prepareMocks(
    String queryMatcher,
    List<NodeRef> realNodesToReturn
  ) {
    this.queryMatcher = queryMatcher;
    List<ResultSetRow> dbRows = new ArrayList<ResultSetRow>();
  ...
  protected void prepareMocksCommon(List<ResultSetRow> dbRows) {
    ...
    when(dbResults.iterator())
      .thenAnswer(
        new Answer<Iterator<ResultSetRow>>() {
          public Iterator<ResultSetRow> answer(
  ...
  protected ArgumentMatcher<SearchParameters> getArgMatcher() {
    return argument -> {
      if (argument != null) {
        ...
        if (
          matchingString != null && argument.toString().contains(matchingString)
        ) {
          return true;
        }
      }
