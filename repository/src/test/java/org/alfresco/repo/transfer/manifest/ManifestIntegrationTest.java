    ...
    public void testSnapshot() throws Exception {
        ...
        try {
            ...
            ContentWriter writer =
                    contentService.getWriter(childNodeRef, ContentModel.PROP_CONTENT, true);
            ...
            /**
             * Write three nodes a: the root node of the workspace store b: the target node c: child
             * of the target node
             */
            ...
            for (NodeRef nodeRef : nodes) {
                TransferManifestNode node =
                        nodeFactory.createTransferManifestNode(
                                nodeRef, null, new TransferContext());
            ...
            for (NodeRef nodeId : nodes) {
                ...
                TransferManifestNormalNode readNode =
                        (TransferManifestNormalNode) processor.getNodes().get(nodeId);
                TransferManifestNormalNode writeNode =
                        (TransferManifestNormalNode) sentNodes.get(nodeId);
                ...
                if (readNode.getNodeRef().equals(childNodeRef)) {
                     ...
                     */
                    ContentData data =
                            (ContentData) readNode.getProperties().get(ContentModel.PROP_CONTENT);
                    assertEquals(
                            "content data wrong size", data.getSize(), CONTENT_STRING.length());
                    ...
                    String childName =
                            (String) readNode.getProperties().get(ContentModel.PROP_NAME);
