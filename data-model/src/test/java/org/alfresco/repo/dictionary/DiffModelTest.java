...
public class DiffModelTest extends AbstractModelTest {
    ...
    public static final String MODEL1_DUPLICATED_XML =
            "<model name=\"test1:model11\" xmlns=\"http://www.alfresco.org/model/dictionary/1.0\"> "
                ...
                + " </namespaces>   <aspects>      <aspect name=\"test1:aspect1\">       "
    ...
    public void testDeleteModel() {
        ByteArrayInputStream byteArrayInputStream =
                new ByteArrayInputStream(AbstractModelTest.MODEL1_XML.getBytes());
        ...
        Map<Pair<String, String>, Integer> expected =
                Map.of(
    ...
    public void testNoExistingModelToDelete() {
        try {
            ...
            assertTrue(
                    "Should throw exeception that there is no previous version of the model to"
                            + " delete",
                    true);
    ...
    public void testDuplicateModels() {
        ...
        ByteArrayInputStream byteArrayInputStream2 =
                new ByteArrayInputStream(MODEL1_DUPLICATED_XML.getBytes());
    ...
    public void testIncUpdatePropertiesAdded() {
        ...
        byteArrayInputStream =
                new ByteArrayInputStream(AbstractModelTest.MODEL2_EXTRA_PROPERTIES_XML.getBytes());
        model = M2Model.createModel(byteArrayInputStream);
        modelName = dictionaryDAO.putModel(model);
        CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    public void testIncUpdateTitleDescription() {
        ByteArrayInputStream byteArrayInputStream =
                new ByteArrayInputStream(AbstractModelTest.MODEL6_XML.getBytes());
        M2Model model = M2Model.createModel(byteArrayInputStream);
        QName modelName = dictionaryDAO.putModel(model);
        CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    public void testNonIncUpdateDefaultAspectAdded() {
        ByteArrayInputStream byteArrayInputStream =
                new ByteArrayInputStream(AbstractModelTest.MODEL4_XML.getBytes());
        M2Model model = M2Model.createModel(byteArrayInputStream);
        QName modelName = dictionaryDAO.putModel(model);
        CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    /**
     * Changing a property from mandatory/enforced/protected to NON mandatory/enforced/protected is
     * an incremental change and it should be allowed.
     */
    public void testIncChangeMandatoryProperties() {
        ...
        byteArrayInputStream =
                new ByteArrayInputStream(
                        AbstractModelTest.MODEL8_CHANGE_MANDATORY_PROPERTIES_ASPECTS_XML
                                .getBytes());
        model = M2Model.createModel(byteArrayInputStream);
        modelName = dictionaryDAO.putModel(model);
        CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    /**
     * Changing a property from NOT mandatory/enforced/protected to mandatory/enforced/protected is
     * considered to be a non incremental change.
     */
     ...
     * @return A map from (elementType, diffType) to the number of occurrences of matching diffs in
     *     the list.
     */
