...
public class DispositionActionDefinitionImpl
  ...
  public String getLabel() {
    if (label == null) {
      ...
      RecordsManagementAction action = recordsManagementActionService.getDispositionAction(
        name
      );
      if (action != null) {
  ...
  public Period getPeriod() {
    return (Period) nodeService.getProperty(
      this.dispositionActionNodeRef,
  ...
  public List<RecordsManagementEvent> getEvents() {
    ...
    Collection<String> eventNames = (Collection<String>) nodeService.getProperty(
      this.dispositionActionNodeRef,
    ...
    if (eventNames != null) {
      ...
      for (String eventName : eventNames) {
        RecordsManagementEvent event = recordsManagementEventService.getEvent(
          eventName
        );
        events.add(event);
      }
