...
public class ZeroStringifier implements Stringifier, ZeroEncoding {
  ...
  private int getProtocolEncoding(Protocol protocol)
  ...
  public String stringify(Reference reference)
    ...
    int protocolResourceEncoding =
      this.getProtocolEncoding(reference.getProtocol());
    protocolResourceEncoding += Integer.parseInt(resource.substring(0, 1));
    return (
      protocolResourceEncoding +
      DELIMITER +
  ...
  public String stringifyResource(Resource resource)
    ...
    throw new ReferenceEncodingException(
      "Invalid reference " + resource.getClass()
    );
  }
  ...
  public String stringifyRepositoryLocation(
    ...
    throw new ReferenceEncodingException(
      "Invalid location: " + repositoryLocation.getClass()
    );
  }
  ...
  public String stringifyParameter(Parameter parameter)
    throws ReferenceEncodingException {
    throw new ReferenceEncodingException(
      "Invalid parameter: " + parameter.getClass()
    );
  }
