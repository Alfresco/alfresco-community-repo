...
public class PermissionServiceTest extends BaseWebScriptTest {
    ...
    /**
     * Test for MNT-15509 Grant or/and Deny the same permission on multiple ancestors of a file and
     * check if the file has duplicate inherited permissions
     */
    public void testMultipleInheritedPermissions() throws Exception {
        ...
        NodeRef siteContainer =
                siteService.createContainer(
                        siteName, SiteService.DOCUMENT_LIBRARY, ContentModel.TYPE_FOLDER, null);
        ...
        NodeRef folder2 =
                fileFolderService.create(folder1, "Folder2", ContentModel.TYPE_FOLDER).getNodeRef();
        ...
        NodeRef folder3 =
                fileFolderService.create(folder2, "Folder3", ContentModel.TYPE_FOLDER).getNodeRef();
        ...
        for (int i = 0; i < directPermissionsArray.length(); i++) {
            AccessPermission permission =
                    new AccessPermission(directPermissionsArray.getJSONObject(i));
        ...
        for (int i = 0; i < inheritedPermissionsArray.length(); i++) {
            AccessPermission permission =
                    new AccessPermission(inheritedPermissionsArray.getJSONObject(i));
            if (USER_TWO.equals(permission.getAuthority().getName())
                    && PermissionService.CONTRIBUTOR.equals(permission.getRole())) {
                denyPermissionInheritedTest = permission;
            }
            if (USER_THREE.equals(permission.getAuthority().getName())
...
class AccessPermission {
    ...
    public boolean equals(Object obj) {
        ...
        return (role.equals(((AccessPermission) obj).getRole())
...
class PermissionAuthority {
    ...
    public boolean equals(Object obj) {
        ...
        return (name.equals(((PermissionAuthority) obj).getName())
