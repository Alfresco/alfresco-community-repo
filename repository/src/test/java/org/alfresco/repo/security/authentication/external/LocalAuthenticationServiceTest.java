...
public class LocalAuthenticationServiceTest {
  ...
  public void before() {
    ...
    localAuthenticationService =
      (AuthenticationService) childApplicationContextFactory
  ...
  public void testIsEnabledFlag() {
    ...
    assertTrue(
      "The isEnabed flag should be set to true for the enabled user",
    ...
    assertFalse(
      "The isEnabed flag should be set to false for the disabled user",
      localAuthenticationService.getAuthenticationEnabled(username)
    );
    assertFalse(
      "External authentication should not protect against brute force attacks",
      (
        (AuthenticationServiceImpl) localAuthenticationService
      ).isProtectionEnabled()
    );
  }
}
