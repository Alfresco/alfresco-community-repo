...
public class AbstractDbObjectTest {
  ...
  public void sameAs() {
    ...
    assertFalse(
      "Not the same.",
      dbObject.sameAs(new ConcreteDbObject("other_obj_name"))
    );
    ...
    assertFalse(
      "Not the same.",
      dbObject.sameAs(new ConcreteDbObject("different_name"))
    );
    assertFalse(
      "Not the same type",
      dbObject.sameAs(new AnotherConcreteDbObject("the_name"))
    );
    assertTrue(
      "Logically the same object.",
      dbObject.sameAs(new ConcreteDbObject("the_name"))
    );
    assertTrue(
      "The very same object with non-null name",
      dbObject.sameAs(dbObject)
    );
  }
  ...
  public void canGetValidators() {
    ...
    dbObject.setValidators(
      validatorList(new TestValidator1(), new TestValidator2())
    );
    validators = dbObject.getValidators();
