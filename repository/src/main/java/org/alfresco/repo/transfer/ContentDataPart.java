...
public class ContentDataPart extends PartBase {
  ...
  private static final byte[] FILE_NAME_BYTES = EncodingUtil.getAsciiBytes(
    FILE_NAME
  );
  ...
  protected void sendData(OutputStream out) throws IOException {
    ...
    InputStream is = contentService
      .getRawReader(data.getContentUrl())
