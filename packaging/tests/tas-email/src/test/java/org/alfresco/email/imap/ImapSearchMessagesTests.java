...
public class ImapSearchMessagesTests extends EmailTest {
  ...
  public void noResultsReturnedWhenSearchingForNotExistingMessage()
    throws Exception {
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY })
  public void searchedMessageIsReturnedWhenSearchingForFullMessageName()
    throws Exception {
    testUser = dataUser.createRandomTestUser();
    testSite = dataSite.usingUser(testUser).createIMAPSite();
    testFolder =
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE })
  public void siteManagerVerifySearchResultsForSpecialCharacters()
    throws Exception {
    testUser = dataUser.createRandomTestUser();
    testSite = dataSite.usingUser(testUser).createIMAPSite();
