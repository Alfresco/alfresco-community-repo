...
/**
 * A listener that ensures that an event is audited for every deleted node in a tree of nodes, not
 * just the top one captured by {@link AuditMethodInterceptor}!
 *
 * <p>The values passed to the audit component are:
 *
 * <pre>
 * /alfresco-node
 *    /beforeDeleteNode
...
public class NodeAuditor implements InitializingBean, NodeServicePolicies.BeforeDeleteNodePolicy {
    ...
    public void beforeDeleteNode(NodeRef nodeRef) {
        // Only continue if there is something listening for our events (note this may change
        // depending on audit
