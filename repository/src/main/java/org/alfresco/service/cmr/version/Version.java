 ...
 * Version interface.
 *
 * <p>Allows access to version property values and frozen state node references. The version history
 * tree can also be navigated.
 *
...
public interface Version extends Serializable {
     ...
     *
     * <p>Note that this reference will be to the current state of the versioned node which may now
     * correspond to a later version.
     *
