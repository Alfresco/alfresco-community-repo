...
public class AddTaskItemTestsBulk3 extends RestTest {
  ...
  public void addTaskItemByTheUserThatStartedTheProcess() throws Exception {
    taskItem =
      restClient
        ...
        .withWorkflowAPI()
        .usingTask(taskModel)
        .addTaskItem(fileModel);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);

    taskItem
      .assertThat()
      .field("createdAt")
      .is(taskItem.getCreatedAt())
      .and()
      .field("size")
      .is(taskItem.getSize())
      .and()
      .field("createdBy")
      .is(taskItem.getCreatedBy())
      .and()
      .field("modifiedAt")
      .is(taskItem.getModifiedAt())
      .and()
      .field("name")
      .is(taskItem.getName())
      .and()
      .field("modifiedBy")
      .is(taskItem.getModifiedBy())
      .and()
      .field("id")
      .is(taskItem.getId())
      .and()
      .field("mimeType")
      .is(taskItem.getMimeType());
  }
  ...
  public void addMultipleTaskItemByTheUserThatStartedTheProcess()
    throws Exception {
    fileModel1 =
    ...
    taskItems
      ...
      .assertThat()
      .field("createdAt")
      .is(taskItems.getEntries().get(0).onModel().getCreatedAt())
      .and()
      .field("size")
      .is(taskItems.getEntries().get(0).onModel().getSize())
      .and()
      .field("createdBy")
      .is(taskItems.getEntries().get(0).onModel().getCreatedBy())
      .and()
      .field("modifiedAt")
      .is(taskItems.getEntries().get(0).onModel().getModifiedAt())
      .and()
      .field("name")
      .is(taskItems.getEntries().get(0).onModel().getName())
      .and()
      .field("modifiedBy")
      .is(taskItems.getEntries().get(0).onModel().getModifiedBy())
      .and()
      .field("id")
      .is(taskItems.getEntries().get(0).onModel().getId())
      .and()
      .field("mimeType")
      .is(taskItems.getEntries().get(0).onModel().getMimeType());
    ...
    taskItems
      ...
      .assertThat()
      .field("createdAt")
      .is(taskItems.getEntries().get(1).onModel().getCreatedAt())
      .assertThat()
      .field("size")
      .is(taskItems.getEntries().get(1).onModel().getSize())
      .assertThat()
      .field("createdBy")
      .is(taskItems.getEntries().get(1).onModel().getCreatedBy())
      .assertThat()
      .field("modifiedAt")
      .is(taskItems.getEntries().get(1).onModel().getModifiedAt())
      .assertThat()
      .field("name")
      .is(taskItems.getEntries().get(1).onModel().getName())
      .assertThat()
      .field("modifiedBy")
      .is(taskItems.getEntries().get(1).onModel().getModifiedBy())
      .assertThat()
      .field("id")
      .is(taskItems.getEntries().get(1).onModel().getId())
      .assertThat()
      .field("mimeType")
      .is(taskItems.getEntries().get(1).onModel().getMimeType());
  }
  ...
  public void deleteMultipleTaskItemsThenCreateThemAgain() throws Exception {
    ...
    taskItems =
      restClient
        .withWorkflowAPI()
        .usingTask(taskModel)
        .addTaskItems(document2, document1, document3);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
    ...
    restClient
      .withWorkflowAPI()
      .usingTask(taskModel)
      .deleteTaskItem(taskItems.getEntries().get(2).onModel());
    restClient.assertStatusCodeIs(HttpStatus.NO_CONTENT);
