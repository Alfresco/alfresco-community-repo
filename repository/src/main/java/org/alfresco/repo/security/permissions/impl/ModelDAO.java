...
public interface ModelDAO {
    ...
    /**
     * Get the permissions that are exposed to be set for the given node. This is determined by the
     * node type.
     *
     * @param nodeRef NodeRef
     */
    ...
    /**
     * Get the permissions that must also be present on the node for the required permission to
     * apply.
     *
    ...
    /**
     * Find a permission by name in the type context. If the context is null and the permission name
     * is unique it will be found.
     *
     * @param qname QName
    ...
    /**
     * Get the global permissions for the model. Permissions that apply to all nodes and take
     * precedence over node specific permissions.
     *
     * @return Set
     */
