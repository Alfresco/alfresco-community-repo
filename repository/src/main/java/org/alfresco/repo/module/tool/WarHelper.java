...
public interface WarHelper {
    ...
    /**
     * This checks to see if the module that is being installed is compatible with the war. If not
     * module edition is specfied then it will just return. However, if an edition is specified and
     * it doesn't match then an error is thrown.
     *
     * @param war a valid war file or exploded directory from a war
     * @param installingModuleDetails ModuleDetails
     */
    ...
    /**
     * Indicates if the war file specified is a "Share" war. The default is FALSE Returns true if
     * the Share war manifest states its a share war.
     *
