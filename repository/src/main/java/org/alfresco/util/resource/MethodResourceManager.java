...
/**
 * A controller of system or in-transaction resources. Given a few statistics regarding a method's
 * call history, and using whatever other measurements are needed, implementations will decide
 * whether and how to clear up sufficient system resources.
 *
 * @author Derek Hulley
 */
public interface MethodResourceManager {
    ...
    /**
     * Check and free any required resources for an imminent. Details of the current transaction and
     * some gathered information about previous calls to associated methods is also provided.
     *
