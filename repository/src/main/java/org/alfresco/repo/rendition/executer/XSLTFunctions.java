...
public class XSLTFunctions {
    ...
    public Document parseXMLDocument(final NodeRef root, String repoPath)
    ...
    public Map<String, Document> parseXMLDocuments(
            final String typeName, NodeRef rootNode, String repoPath)
        ...
        try {
            ...
            if (file.isFolder()) {
                ...
                Set<QName> types =
                        new HashSet<QName>(dictionaryService.getSubTypes(typeQName, true));
                types.add(typeQName);
                List<ChildAssociationRef> children =
                        nodeService.getChildAssocs(file.getNodeRef(), types);
                for (ChildAssociationRef child : children) {
                    String name =
                            (String)
                                    nodeService.getProperty(
                                            child.getChildRef(), ContentModel.PROP_NAME);
    ...
    /**
     * Encodes invalid HTML characters. (Fix for ETWOTWO-504 issue) This code was adopted from
     * WebDAVHelper.encodeHTML() method with some restrictions.
     *
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            switch (c) {
                ...
                case '\u00DF':
                    ...
                    // misc
                    // case 0x80: enc = "&euro;"; break; sometimes euro symbol is ascii 128, should
                    // we suport it?
                case '\u20AC':
                    enc = "&euro;";
                    break;
