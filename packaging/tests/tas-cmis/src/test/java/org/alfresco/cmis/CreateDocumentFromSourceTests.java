...
public class CreateDocumentFromSourceTests extends CmisTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    sourceFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, sourceContent);
    cmisApi
  ...
  public void inexistentUserShouldNotCreateDocumentFromSource()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
  ...
  public void unauthorizedUserShouldNotCreateDocumentFromSource()
    throws Exception {
  ...
  @Test(
    groups = {
      ...
      TestGroup.CMIS,
      TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM,
    },
    expectedExceptions = CmisContentAlreadyExistsException.class
  )
  public void siteManagerCannotCreateDocumentFromSourceTwice()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void siteManagerCannotCreateDocFromSourceWithInvalidChars()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
  ...
  public void siteManagerCannotCreateDocFromSourceWithInvalidBaseTypeId()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void anotherSiteManagerShouldCreateDocumentFromSource()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
  ...
  public void managerCreatesDocumentFromSourceWithVersionMinor()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void managerShouldCreateDocumentFromSourceWithVersionNone()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void managerCreatesDocumentFromSourceWithVersionCHECKEDOUT()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void managerShouldCreateDocFromSourceThatIsCheckedOut()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
  ...
  public void managerShouldCreateDocFromSourceFromHisPrivateSite()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    FileModel sourceFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
  ...
  public void userShouldNotCreateDocFromSourceFromPrivateSite()
    throws Exception {
    newFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    FileModel sourceFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
