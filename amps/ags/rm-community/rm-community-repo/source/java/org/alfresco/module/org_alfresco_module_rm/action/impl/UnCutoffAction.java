  ...
  protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
    if (
      ...
      DispositionAction da = getDispositionService()
        .getLastCompletedDispostionAction(actionedUponNodeRef);
      ...
      if (da == null || !da.getName().equals("cutoff")) {
        ...
        throw new AlfrescoRuntimeException(
          I18NUtil.getMessage(MSG_UNDO_NOT_LAST)
        );
      }
      ...
      if (getRecordFolderService().isRecordFolder(actionedUponNodeRef)) {
        List<NodeRef> records = getRecordService()
      ...
      DispositionAction currentDa = getDispositionService()
      ...
      getNodeService()
        .setProperty(da.getNodeRef(), PROP_DISPOSITION_ACTION_STARTED_AT, null);
      getNodeService()
        .setProperty(da.getNodeRef(), PROP_DISPOSITION_ACTION_STARTED_BY, null);
      getNodeService()
        .setProperty(
          da.getNodeRef(),
