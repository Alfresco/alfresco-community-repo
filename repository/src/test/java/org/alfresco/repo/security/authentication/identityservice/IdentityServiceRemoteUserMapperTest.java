...
public class IdentityServiceRemoteUserMapperTest extends AbstractChainedSubsystemTest {
    ...
    protected void setUp() throws Exception {
        ...
        childApplicationContextFactory =
                getChildApplicationContextFactory(
                        childApplicationContextManager, "identity-service1");
    ...
    public void testKeycloakConfig() throws Exception {
        ...
        assertEquals(
                "identity-service.cors-max-age", 1000, this.identityServiceConfig.getCorsMaxAge());
        ...
        assertEquals(
                "identity-service.credentials.provider", "secret", credentials.get("provider"));
    }
