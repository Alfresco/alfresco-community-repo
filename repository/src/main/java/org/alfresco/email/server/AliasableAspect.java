...
public class AliasableAspect
  ...
  private static final String ERROR_MSG_DUPLICATE_ALIAS =
    "email.server.err.duplicate_alias";
  ...
  public NodeRef getByAlias(String alias) {
    Serializable value = attributeService.getAttribute(
      ALIASABLE_ATTRIBUTE_KEY_1,
      ALIASABLE_ATTRIBUTE_KEY_2,
      normaliseAlias(alias)
    );
  ...
  public void onAddAspect(NodeRef nodeRef, QName aspectTypeQName) {
    Object alias = nodeService.getProperty(
      nodeRef,
      EmailServerModel.PROP_ALIAS
    );
    if (alias != null) {
  ...
  public void beforeRemoveAspect(NodeRef nodeRef, QName aspectTypeQName) {
    String alias = (String) nodeService.getProperty(
      nodeRef,
      EmailServerModel.PROP_ALIAS
    );
    if (alias != null) {
