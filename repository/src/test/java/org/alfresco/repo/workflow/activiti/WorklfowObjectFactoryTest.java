...
public class WorklfowObjectFactoryTest extends TestCase {
    ...
    public void testTransitionDefaultLabel() {
        ...
        Mockito.when(mockedMessageService.getMessage(Mockito.anyString()))
                .thenAnswer(
                        new Answer<String>() {
        ...
        WorkflowObjectFactory factory =
                new WorkflowObjectFactory(
                        null, null, mockedMessageService, null, ActivitiConstants.ENGINE_ID, null);
        WorkflowTransition createTransition =
                factory.createTransition("test-transition", "title", null, true, "base.key");
