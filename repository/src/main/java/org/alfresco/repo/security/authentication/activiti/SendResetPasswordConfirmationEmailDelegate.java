 ...
 *     <p>This {@link JavaDelegate activiti delegate} is executed when a user is finished resetting
 *     his/her password.
...
public class SendResetPasswordConfirmationEmailDelegate extends AbstractResetPasswordDelegate {
    ...
    private static final String EMAIL_TEMPLATE_PATH =
            "alfresco/templates/reset-password-email-templates/reset-password-confirmation-email-template.ftl";

    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {
        resetPasswordService.sendResetPasswordConfirmationEmail(
                delegateExecution, EMAIL_TEMPLATE_PATH, EMAIL_SUBJECT_KEY);
    }
}
