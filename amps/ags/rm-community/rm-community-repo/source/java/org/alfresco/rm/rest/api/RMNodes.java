...
public interface RMNodes extends Nodes {
    ...
    /**
     * Gets or creates the relative path starting from the provided parent folder. The method
     * decides the type of the created elements considering the parent container's type and the type
     ...
     */
    public NodeRef getOrCreatePath(
            String parentFolderNodeId, String relativePath, QName nodeTypeQName);

    /**
     * Validates if the component with provided id and provided parameters belongs to the current
     * endpoint.
     *
    ...
    public void validateNodeType(
            String filePlanComponentId, Parameters parameters, QName requestedTypeQName);

    /**
     * Validates if the component with provided id and provided parameters from formData belongs to
     ...
     */
    public void validateNodeType(
            String filePlanComponentId, FormData formData, QName requestedTypeQName);

    /**
     * Validates if the component with provided id, relativePath from new created filePlanComponent
     * and provided parameters belongs to the current endpoint.
     *
     * @param filePlanComponentId - file plan component id to check
