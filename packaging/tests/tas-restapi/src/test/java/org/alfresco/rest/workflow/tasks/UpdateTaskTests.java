...
public class UpdateTaskTests extends RestTest {
  ...
  @TestRail(
    ...
    description = "Verify admin user updates task with Rest API and response is successfull (200)"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.SANITY,
    description = "Verify assignee user updates its assigned task with Rest API and response is successfull (200)"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.SANITY,
    description = "Verify user that started the task updates the started task with Rest API and response is successfull (200)"
  )
  ...
  @TestRail(
    ...
    description = "Verify any user with no relation to task is forbidden to update other task with Rest API (403)"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.SANITY,
    description = "Verify candidate user updates its specific task and no other user claimed the task with Rest API and response is successfull (200)"
  )
  ...
  public void taskAssigneeCanNotUpdateTaskWithResolveStateTwice()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(assigneeUser)
  ...
  public void taskCanNotBeUpdatedWithInvalidJsonBodyProperty()
    throws Exception {
  ...
  public void taskOwnerCannotCompleteTaskWithInvalidName() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.UNSUPPORTED_TYPE, "bpm_priorityx")
      );
  }
  ...
  public void taskOwnerCannotCompleteTaskWithInvalidScope() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ILLEGAL_SCOPE, "globalscope")
      );
  }
  ...
  public void taskAssigneeCannotDelegateTaskToInvalidAssignee()
    throws Exception {
  ...
  public void updateTaskUsingAnotherPriority() throws Exception {
    ...
    restTaskModel
      .assertThat()
      .field("priority")
      .is(CMISUtil.Priority.Low.getLevel());
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can not update task from completed to claimed and response is 404"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanNotUpdateTaskFromCompletedToClaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(owner)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can not update task from completed to unclaimed and response is 404"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanNotUpdateTaskFromCompletedToUnclaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(assigneeUser)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can not update task from completed to completed and response is 404"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanNotUpdateTaskWithCompleteStateTwice()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(assigneeUser)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can update task from claimed to completed and response is 200"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can update task from unclaimed to completed and response is 200"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanUpdateTaskFromUnclaimedToCompleted()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(assigneeUser)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can not update task from unclaimed to unclaimed and response is 404"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanNotUpdateTaskWithUnclaimedStateTwice()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(assigneeUser)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can not update task from delegated to completed and response is 422"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanNotUpdateTaskFromDelegatedToCompleted()
    throws Exception {
    restClient
      .authenticateUser(owner)
      .withParams("select=state,assignee")
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can not update task from delegated to delegated and response is 404"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void taskOwnerCanNotUpdateTaskWithDelegatedStateTwice()
    throws Exception {
    restClient
      .authenticateUser(owner)
      .withParams("select=state,assignee")
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify owner can update task from resolved to completed and response is 200"
  )
  @Test(
    groups = {
      TestGroup.REST_API,
  ...
  public void assigneeCannotUpdateTaskFromCompletedToDelegated()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(owner)
  ...
  public void assigneeCannotUpdateTaskFromCompletedToResolved()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(owner)
  ...
  public void assigneeCannotUpdateTaskFromCompletedToCompleted()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(owner)
  ...
  public void taskOwnerCanCompleteTaskWithValidVariables() throws Exception {
    ...
    RestVariableModelsCollection variables = restClient
      .authenticateUser(owner)
      .withWorkflowAPI()
  ...
  public void taskOwnerCannotUpdateTaskWithEmptyVariablesArray()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "completed")
  ...
  public void taskOwnerCannotUpdateTaskWithEmptyVariablesJsonBody()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "completed")
  ...
  public void taskOwnerUpdateTaskResolveStateAndOwnerAssignee()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "resolved")
  ...
  public void taskOwnerCannotUpdateTaskWithEmptyInputBody() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsErrorKey(
        String.format(RestErrorModel.TASK_INVALID_STATE, "null")
      )
      .containsSummary(
        String.format(RestErrorModel.TASK_INVALID_STATE, "null")
      );
  ...
  public void anyUserCannotUpdateTaskUsingAnotherDescription()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
  ...
  public void anyUserCannotUpdateTaskUsingInvalidDescription()
    throws Exception {
    restClient
      .authenticateUser(owner)
      .withParams("select=description")
  ...
  public void taskCreatorCanUpdateTaskFromUnclaimedToClaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void regularUserCannotUpdateTaskFromUnclaimedToClaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskCreatorCanUpdateTaskFromUnclaimedToDelegated()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void regularUserCannotUpdateTaskFromUnclaimedToDelegated()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskCreatorCanUpdateTaskFromUnclaimedToResolved()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void regularCanNotUpdateTaskFromUnclaimedToResolved()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskCreatorCanUpdateTaskFromUnclaimedToUnclaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void regularUserCannotUpdateTaskFromUnclaimedToUnclaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskCreatorCanUpdateTaskFromDelegatedToUnclaimed()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskAssigneeCanUpdateTaskFromDelegatedToUnclaimed()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskCreatorCannotUpdateTaskFromDelegatedToClaimed()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskAssigneeCanUpdateTaskFromDelegatedToClaimed()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskCreatorCanUpdateTaskFromDelegatedToCompleted()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskAssigneeCanUpdateTaskFromDelegatedToCompleted()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskCreatorCanUpdateTaskFromDelegatedToResolved()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskAssigneeCanUpdateTaskFromDelegatedToResolved()
    throws Exception {
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void taskCreatorCanUpdateTaskFromResolvedToUnclaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(owner)
  ...
  public void taskAssigneeCannotUpdateTaskFromResolvedToUnclaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(assigneeUser)
  ...
  public void taskAssigneeCanUpdateTaskFromResolvedToClaimed()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskCreatorCannotUpdateTaskFromResolvedToDelegated()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskAssigneeCannotUpdateTaskFromResolvedToDelegated()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskCreatorCannotUpdateTaskFromResolvedToResolved()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void taskAssigneeCannotUpdateTaskFromResolvedToResolved()
    throws Exception {
    restTaskModel =
      restClient
        .authenticateUser(adminUser)
