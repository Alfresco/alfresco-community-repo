...
public class MoveTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to move a file to an existent location in"
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is not able to move file to a nonexistent location in"
                            + " DocumentLibrary with CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to move a nonexistent file in DocumentLibrary"
                            + " with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisObjectNotFoundException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to move file that has multiple versions with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to move folder structure to an existent location"
