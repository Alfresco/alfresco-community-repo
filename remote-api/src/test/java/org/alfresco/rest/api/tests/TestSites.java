...
public class TestSites extends EnterpriseTestApi {
    ...
    private void initializeNetwork1() throws Exception {
        if (network1 == null) {
            network1 =
                    getRepoService()
                            .createNetwork(
                                    this.getClass().getName().toLowerCase() + "-1-" + RUNID, true);
            network1.create();
    ...
    private void initializeNetwork2WithSites() throws Exception {
        if (network2 == null) {
            network2 =
                    getRepoService()
                            .createNetwork(
                                    this.getClass().getName().toLowerCase() + "-2-" + RUNID, true);
            network2.create();
    ...
    private void initializeNetwork3WithSites() throws Exception {
        ...
        if (network3 == null) {
            network3 =
                    getRepoService()
                            .createNetwork(
                                    this.getClass().getName().toLowerCase() + "-3-" + RUNID, true);
            network3.create();
    ...
    public void testCreateAndDeleteSite() throws Exception {
        ...
        // -ve - cannot create site with same site id as an existing site (even if it is in the
        // trashcan/archive)
        {
            String siteId = "aaa";
    ...
    public void testUpdateSite() throws PublicApiException {
        ...
        {
            SiteImpl siteToCreate =
                    new SiteImpl("Initial Title", SiteVisibility.PRIVATE.toString());
            ...
            HttpResponse response =
                    sitesProxy.update(
                            ...
                            null,
                            updateJSON,
                            "Failed to update site " + site.getSiteId());

            Site updatedSite =
                    SiteImpl.parseSite((JSONObject) response.getJsonResponse().get("entry"));
            Site expectedUpdate =
                    new SiteImpl(
                            null,
                            "initial-title",
                            site.getGuid(),
                            "Updated Title",
                            "This is an updated description for the site",
                            SiteVisibility.PUBLIC.toString(),
                            null,
                            SiteRole.SiteManager);
            ...
            // Double check by do a fresh get of the details, since the details returned by
            // updateSite()
        ...
        // +ve test: partial updates must be allowed
        {
            ...
            Site updatedSite =
                    sitesProxy.updateSite(
                            site.getSiteId(), new SiteUpdate("title-v2", null, null), 200);
            ...
            updatedSite =
                    sitesProxy.updateSite(
                            site.getSiteId(), new SiteUpdate(null, "description-v2", null), 200);
        ...
        // -ve test: 400, bad requests
        {
            ...
            sitesProxy.update(
                    ...
                    "{\n"
                        ...
                        + "}",
                    null,
                    "Expected 400 response when updating " + site.getSiteId(),
                    400);
        ...
        // -ve test: 401 authorization failure
        {
            Site site =
                    sitesProxy.createSite(
                            new SiteImpl("SiteUpdate401", SiteVisibility.PRIVATE.toString()), 201);
        ...
        // -ve test: 403 for incorrect permissions
        {
            Site site =
                    sitesProxy.createSite(
                            new SiteImpl("SiteUpdate403", SiteVisibility.PUBLIC.toString()), 201);
    ...
    /**
     * Tests the capability to sort and paginate the sites list orderBy = title ASC skip = 1, count
     * = 2
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the capability to sort and paginate the sites list orderBy = title DESC skip = 1, count
     * = 2
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the capability to sort and paginate the sites list orderBy = description ASC skip = 1,
     * count = 2
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the capability to sort and paginate the sites list orderBy = description DESC skip = 1,
     * count = 2
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the capability to sort and paginate the sites list orderBy = id DESC skip = 1, count =
     * 2
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the capability to sort and paginate the sites list default sorting (id asc), all
     * results
     *
     * @throws Exception
     */
    ...
    private ListResponse<Site> listSites(final Paging paging, String sortColumn, boolean asc)
            throws Exception {
    ...
    private ListResponse<Site> listSitesWithWhere(
            final Paging paging, Map<String, String> filters, String predicate) throws Exception {
        final Sites sitesProxy = publicApiClient.sites();
    ...
    public static class SiteUpdateJSONSerializer implements JSONAble {
        ...
        public JSONObject toJSON() {
            ...
            if (siteUpdate.getVisibility() != null) {
                // JSONObject bug: if we don't toString() the visibility, it won't put quotes around
                // it.
        ...
        public static SiteUpdate parseSiteUpdate(JSONObject jsonObject) {
            ...
            SiteVisibility visibility =
                    SiteVisibility.valueOf((String) jsonObject.get("visibility"));
