 ...
 *
 * <p>During the crawl method the node finders find nodes related to the staring nodes and then the
 * filters can exclude unwanted nodes. For example you could use the finders to walk down a tree of
 * nodes and exclude nodes of a certain type.
 *
