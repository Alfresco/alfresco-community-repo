...
public class NonTransactionalRuleContentDiskDriver
  ...
  private static final Log logger = LogFactory.getLog(
    NonTransactionalRuleContentDiskDriver.class
  );
  ...
  public void closeFile(
    ...
    try {
      ...
      Operation o = new CloseFileOperation(
        file,
        param,
        rootNode,
        param.getFullName(),
      ...
      throw new AccessDeniedException(
        "Unable to close file " + param.getFullName(),
        ade
      );
    }
  }
  ...
  public void createDirectory(
    ...
    try {
      ...
      throw new AccessDeniedException(
        "Unable to create directory " + params.getPath(),
        ade
      );
    }
  }
  ...
  public NetworkFile createFile(
    ...
    try {
      ...
      if (logger.isDebugEnabled()) {
        ...
        String strSharedAccess = SharingMode.getSharingModeAsString(
          sharedAccess
        );
      ...
      Operation o = new CreateFileOperation(
        file,
        rootNode,
        params.getPath(),
        params.getAllocationSize(),
      ...
      throw new AccessDeniedException(
        "Unable to create file " + params.getPath(),
        ade
      );
    }
  }
  ...
  public NetworkFile openFile(
    ...
    try {
      Operation o = new OpenFileOperation(
        file,
        openMode,
        truncate,
        rootNode,
      ...
      if (ret != null && ret instanceof NetworkFile) {
        ...
        if (logger.isDebugEnabled()) {
          logger.debug(
            "returning open file: for path:" + path + ", ret:" + ret
          );
        }
        return x;
      } else {
      ...
      throw new AccessDeniedException(
        "Unable to open file " + param.getPath(),
        ade
      );
    }
  ...
  public int readFile(
    ...
    int readSize = diskInterface.readFile(
      sess,
      tree,
      file,
      buf,
  ...
  public void renameFile(
    ...
    try {
      if (oldFolder.equalsIgnoreCase(newFolder)) {
        ...
        Operation o = new RenameFileOperation(
          oldFile,
          newFile,
          oldPath,
          newPath,
        ...
        Operation o = new MoveFileOperation(
          oldFile,
          newFile,
          oldPath,
          newPath,
      ...
      throw new AccessDeniedException(
        "Unable to rename file file " + oldPath,
        ade
      );
    }
  }
  ...
  public SearchContext startSearch(
    ...
    FileFilterMode.setClient(ClientHelper.getClient(sess));
    try {
      SearchContext context = diskInterface.startSearch(
        sess,
        tree,
        searchPath,
        attrib
  ...
  public int writeFile(
    ...
    int writeSize = diskInterface.writeFile(
      sess,
      tree,
      file,
      buf,
  ...
  public void setRepositoryDiskInterface(
    RepositoryDiskInterface repositoryDiskInterface
  ) {
   ...
   */
  private EvaluatorContext getEvaluatorContext(
   ...
   * @param folder String
   */
  private void releaseEvaluatorContextIfEmpty(
    DriverState driverState,
    ...
    synchronized (driverState.contextMap) {
      if (ctx != null) {
        if (ctx.getScenarioInstances().size() > 0) {} else {
