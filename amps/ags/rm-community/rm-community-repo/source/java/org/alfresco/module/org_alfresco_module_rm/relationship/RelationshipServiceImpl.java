 ...
 * @since 2.3
 */
public class RelationshipServiceImpl extends RecordsManagementAdminBase
    ...
    public void init() {
        ...
        beforeCreateReferenceDelegate =
                getPolicyComponent().registerClassPolicy(BeforeCreateReference.class);
        onCreateReferenceDelegate =
                getPolicyComponent().registerClassPolicy(OnCreateReference.class);
        beforeRemoveReferenceDelegate =
                getPolicyComponent().registerClassPolicy(BeforeRemoveReference.class);
        onRemoveReferenceDelegate =
                getPolicyComponent().registerClassPolicy(OnRemoveReference.class);
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#getRelationshipDefinitions()
     */
    @Override
    public Set<RelationshipDefinition> getRelationshipDefinitions() {
        ...
        Set<Entry<QName, AssociationDefinition>> associationsEntrySet =
                getCustomAssociations().entrySet();
        for (Map.Entry<QName, AssociationDefinition> associationEntry : associationsEntrySet) {
            ...
            RelationshipDefinition relationshipDefinition =
                    createRelationshipDefinition(associationDefinition);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#getRelationshipDefinition(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#createRelationshipDefinition(org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipDisplayName)
     */
    @Override
    public RelationshipDefinition createRelationshipDefinition(
        ...
        if (existsTitle(title)) {
            ...
            sb.append("Cannot create a relationship definition for the display name: '")
                    ...
                    .append(
                            "' as there is already a relationship definition with this display"
                                    + " name.");
            throw new AlfrescoRuntimeException(sb.toString());
        }
        ...
        String generatedShortQName =
                relationshipDefinitionQName.toPrefixString(getNamespaceService());
        ...
        newAssoc.setTargetClassName(
                RecordsManagementModel.ASPECT_RECORD.toPrefixString(getNamespaceService()));
        writeCustomContentModel(modelRef, deserializedModel);

        return new RelationshipDefinitionImpl(
                relationshipDefinitionQName.getLocalName(), type, displayName);
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#updateRelationshipDefinition(java.lang.String,
     *     RelationshipDisplayName)
     */
    @Override
    public RelationshipDefinition updateRelationshipDefinition(
        ...
        QName updatedAssociationDefinitionQName =
                persistUpdatedAssocTitle(associationDefinitionQName, title);
        RelationshipDefinition updatedRelationshipDefinition =
                getRelationshipDefinition(updatedAssociationDefinitionQName.getLocalName());

        if (updatedRelationshipDefinition == null) {
            throw new AlfrescoRuntimeException(
                    "The relationship definition could not be updated successfully.");
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#removeRelationshipDefinition(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#existsRelationshipDefinition(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#getRelationshipsFrom(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    public Set<Relationship> getRelationshipsFrom(NodeRef nodeRef, String nameFilter) {
        ...
        List<AssociationRef> customReferencesFrom =
                getNodeService().getTargetAssocs(nodeRef, RegexQNamePattern.MATCH_ALL);
        relationships.addAll(
                generateRelationshipFromAssociationRef(customReferencesFrom, nameFilter));

        List<ChildAssociationRef> customChildReferences = getNodeService().getChildAssocs(nodeRef);
        relationships.addAll(
                generateRelationshipFromParentChildAssociationRef(
                        customChildReferences, nameFilter));
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#getRelationshipsTo(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    public Set<Relationship> getRelationshipsTo(NodeRef nodeRef, String nameFilter) {
        ...
        List<AssociationRef> customReferencesTo =
                getNodeService().getSourceAssocs(nodeRef, RegexQNamePattern.MATCH_ALL);
        relationships.addAll(
                generateRelationshipFromAssociationRef(customReferencesTo, nameFilter));

        List<ChildAssociationRef> customParentReferences =
                getNodeService().getParentAssocs(nodeRef);
        relationships.addAll(
                generateRelationshipFromParentChildAssociationRef(
                        customParentReferences, nameFilter));
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#addRelationship(java.lang.String,
    ...
    public void addRelationship(String uniqueName, NodeRef source, NodeRef target) {
        ...
        if (!getNodeService().exists(source)) {
            throw new AlfrescoRuntimeException(
                    "Can't create relationship '"
                            + uniqueName
                            + "', because source node doesn't exist.");
        }
        ...
        if (!getNodeService().exists(target)) {
            throw new AlfrescoRuntimeException(
                    "Can't create relationship "
                            + uniqueName
                            + ", because target node doesn't exist.");
        }
        ...
        if (associationDefinition.isChild()) {
            getNodeService()
                    .addChild(source, target, associationDefinitionName, associationDefinitionName);
        } else {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.relationship.RelationshipService#removeRelationship(java.lang.String,
     *     org.alfresco.service.cmr.repository.NodeRef, org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
                    ...
                    new RunAsWork<Void>() {
                        ...
                        public Void doWork() {
                            List<ChildAssociationRef> children =
                                    getNodeService().getChildAssocs(sourceNode);
                            for (ChildAssociationRef chRef : children) {
                                if (associationDefinitionName.equals(chRef.getTypeQName())
                                        && chRef.getChildRef().equals(targetNode)) {
     ...
     * @return The relationship definition if <code>associationDefinition</code> exists, <code>null
     *     </code> otherwise
     */
     ...
     */
    private RelationshipDisplayName getRelationshipDisplayName(
            RelationshipType type, String title) {
     ...
     */
    private Set<Relationship> generateRelationshipFromAssociationRef(
            List<AssociationRef> associationRefs, String nameFilter) {
        Set<Relationship> relationships = new HashSet<Relationship>();
     ...
     */
    private Set<Relationship> generateRelationshipFromParentChildAssociationRef(
            List<ChildAssociationRef> childAssociationRefs, String nameFilter) {
        Set<Relationship> relationships = new HashSet<Relationship>();
     ...
     */
    private RelationshipType determineRelationshipTypeFromDisplayName(
            RelationshipDisplayName displayName) {
        ...
        String errorMsg =
                "Relationship type could not be determined from the display name. It is neither"
                        + " biderectional nor parent/child relationship";
     ...
     */
    private void invokeBeforeCreateReference(
            NodeRef source, NodeRef target, QName associationDefinitionName) {
     ...
     * @param associationDefinitionName The association definition name
     */
    private void invokeOnCreateReference(
            NodeRef source, NodeRef target, QName associationDefinitionName) {
        // Get QNames to invoke against
        Set<QName> qnames = PoliciesUtil.getTypeAndAspectQNames(getNodeService(), source);
        // Execute policy for node type and aspects
     ...
     * @param associationDefinitionName The association definition name
     */
    private void invokeBeforeRemoveReference(
            NodeRef source, NodeRef target, QName associationDefinitionName) {
        // Get QNames to invoke against
        Set<QName> qnames = PoliciesUtil.getTypeAndAspectQNames(getNodeService(), source);
        // Execute policy for node type and aspects
     ...
     * @param associationDefinitionName The association definition name
     */
    private void invokeOnRemoveReference(
            NodeRef source, NodeRef target, QName associationDefinitionName) {
        // Get QNames to invoke against
        Set<QName> qnames = PoliciesUtil.getTypeAndAspectQNames(getNodeService(), source);
        // Execute policy for node type and aspects
    ...
    /**
     * Check if an instance of the association already exists from the given source node reference
     * to the given target node reference
     *
     * @param associationDefinition The association definition
     * @param source The source node reference
     * @param target The target node reference
    ...
    private boolean associationExists(
            AssociationDefinition associationDefinition, NodeRef source, NodeRef target) {
        ...
        if (associationDefinition.isChild()) {
            List<ChildAssociationRef> childAssocs =
                    getNodeService()
                            .getChildAssocs(
                                    source, associationDefinitionName, associationDefinitionName);
            ...
            List<AssociationRef> assocs =
                    getNodeService().getTargetAssocs(source, associationDefinitionName);
     ...
     * @return The association definition for the given unique name if exists, <code>null</code>
     *     otherwise
     */
    ...
    /**
     * This method writes the specified String into the association's title property. For RM custom
     * properties and references, Title is used to store the identifier.
     *
     * <p>NOTE: Currently RMC custom associations only
     *
    ...
    private QName persistUpdatedAssocTitle(QName associationDefinitionQName, String newTitle) {
        ...
        AssociationDefinition assocDefn =
                getDictionaryService().getAssociation(associationDefinitionQName);
        if (assocDefn == null) {
            StringBuilder sb = new StringBuilder();
        ...
        for (M2ClassAssociation assoc : customAssocsAspect.getAssociations()) {
            if (associationDefinitionQName
                            .toPrefixString(getNamespaceService())
                            .equals(assoc.getName())
                    && newTitle != null) {
