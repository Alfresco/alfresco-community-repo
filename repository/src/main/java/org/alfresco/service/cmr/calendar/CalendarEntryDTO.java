...
public class CalendarEntryDTO implements CalendarEntry, Serializable {
    ...
    /** Creates an empty {@link CalendarEntry}, which can be populated with set calls. */
    public CalendarEntryDTO() {}

    /** Creates a {@link CalendarEntry} with common properties. */
    public CalendarEntryDTO(
            String title, String description, String location, Date start, Date end) {
        this.title = title;
    ...
    /** Gets the UID used by Outlook for this event. See {@link CalendarEntry#isOutlook()} */
    public String getOutlookUID() {
        return outlookUID;
    }

    /**
     * Sets the UID used by Outlook for this event. When a UID is set, normally the isOutlook flag
     * is set too.
     */
    ...
    /**
     * Does the given {@link CalendarEntry} define an all-day event? An All Day Event is defined as
     * one starting at midnight on a day, and ending at midnight.
     *
     * <p>For a single day event, the start and end dates should be the same, and the times for both
     * are UTC midnight. For a multi day event, the start and end times are UTC midnight, for the
