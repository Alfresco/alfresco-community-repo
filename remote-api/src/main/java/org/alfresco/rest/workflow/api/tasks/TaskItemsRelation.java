...
public class TaskItemsRelation
    ...
    @Override
    public Item readById(String taskId, String itemId, Parameters parameters)
    ...
    @Override
    @WebApiDescription(
            title = "Get the attached items of a Task",
            description = "Get a paged list of all the items")
