...
public class ImporterActionExecuterTest {
  ...
  private static final String FILE_NAME =
    "import-archive-test/SuspiciousPathsArchive.zip";
    ...
    retryingTransactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() {
          ...
          NodeRef zipFileNodeRef = nodeService
            .createNode(
              rootNodeRef,
          ...
          NodeRef targetFolderNodeRef = nodeService
            .createNode(
              rootNodeRef,
              ContentModel.ASSOC_CHILDREN,
              QName.createQName(
          ...
          try {
            ...
            assertTrue(
              e
                .getMessage()
                .contains(
                  ImporterActionExecuter.ARCHIVE_CONTAINS_SUSPICIOUS_PATHS_ERROR
                )
            );
          } finally {
      ...
      new RetryingTransactionCallback<Void>() {
        public Void execute() {
          ...
          try {
            ...
            NodeRef importedFolder = nodeService.getChildByName(
              targetFolderNodeRef,
            ...
            boolean hasAspectTitled = nodeService.hasAspect(
              importedFolder,
