...
/**
 * The DeleteOnClose rename shuffle is a delete on close of a file resulting in a file being deleted
 * followed by a rename or a create
 *
 * <p>First case of this is Mac Mountain Lion Preview application. and then a new copy of the file
 * put into place.
 *
 * <p>a) DeleteOnClose fileA b) Close fileA c) Rename whatever fileA
 *
 * <p>Second case First case of this is Mac Drag and drop. and then a new copy of the file put into
 * place.
 *
 * <p>a) Delete fileA b) Close fileA c) Create fileA
 *
 * <p>Third case Gedit.
 *
 * <p>a) Delete fileA b) Rename .goutputstream fileA
 */
    ...
    public ScenarioInstance createInstance(final EvaluatorContext ctx, Operation operation) {
        ...
        if (operation instanceof CloseFileOperation) {
            ...
            if (m.matches() && c.getNetworkFile().hasDeleteOnClose()) {
                ...
                ScenarioDeleteRenameOrCreateInstance instance =
                        new ScenarioDeleteRenameOrCreateInstance();
