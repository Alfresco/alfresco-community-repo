...
public interface FilePlanRoleService {
    ...
    /** System roles */
    List<String> SYSTEM_ROLES = Arrays.asList(ROLE_EXTENDED_READERS, ROLE_EXTENDED_WRITERS);
    ...
    /**
     * Get all the available roles for the given records management root node (includes also the
     * system roles)
     *
     * @param filePlan file plan
     * @return
    ...
    /**
     * Get all the available roles for the given records management root node. System roles can be
     * filtered
     *
     * @param filePlan file plan
     ...
     */
    Role createRole(
            NodeRef filePlan, String role, String roleDisplayLabel, Set<Capability> capabilities);
