...
public abstract class CollectionUtils
{
     ...
     * 
     * @param first
     *            first set. can be null.
     * @param second
     *            second set. can be null.
     ...
     * @param second
     *            second set. can be null.
     * @param emptyResultIsNull
     *            if the result is empty, should we return null?
     ...
     * 
     * @param first
     *            first map. can be null.
     * @param second
     *            second map. can be null.
     ...
     * 
     * @param first
     *            first list. can be null.
     * @param second
     *            second list. can be null.
    ...
    /**
     * Converts a {@link Collection} of values of type F to a {@link Serializable} {@link List} of values of type T. Filters out all values converted to <code>null</code>.
     * 
     * @param <F>
     *            From type
     * @param <T>
    ...
    /**
     * Converts a {@link Map} having keys of type F to a new {@link Map} instance having keys of type T. The object references in the value set are copied to the transformed map, thus reusing the same objects.
     * 
     * @param <F>
     *            From type
     * @param <T>
     *            To type
     * @param <V>
     *            The value type of the before and after maps.
     * @param map
     *            the map to convert.
     * @param transformer
     ...
     * @param filter
     *            the {@link Function} used to filter the {@link Collection}.
    ...
    /**
     * This method flattens the provided collection of collections of values into a single {@code List} object containing each of the elements from the provided sub-collections.
     * <p/>
     * For example, {@code flatten( [1, 2], [3], [], [4, 5, 6] )} would produce a List like {@code [1, 2, 3, 4, 5, 6]}. Here, "[]" represents any Java collection.
     * 
     * @param <T>
     *            the element type of the collections. Note that this must be the same for all collections.
     * @param values
     *            a collection of collections of elements to be flattened.
     ...
     * 
     * @param collections
     *            a vararg of Collection objects to be flattened into a list.
    ...
    /**
     * This method can be used to filter a Map. Any keys in the supplied map, for which the supplied {@link Function filter function} returns <code>true</code>, will be included in the resultant Map, else they will not.
     * 
     * @param map
     *            the map whose entries are to be filtered.
     * @param filter
     *            the filter function which is applied to the key.
    ...
    /**
     * This method returns a new HashMap which is the intersection of the two Map parameters, based on {@link Object#equals(Object) equality} of their entries. Any references in the resultant map will be to elements within map1.
     * 
    ...
    /**
     * This method returns a new HashSet which is the intersection of the two Set parameters, based on {@link Object#equals(Object) equality} of their elements. Any references in the resultant set will be to elements within set1.
     * 
     ...
     * 
     * @param map
     *            the map which needs to be sorted
    ...
    /**
     * This method offers convenient conversion from value-based comparators to entry-based comparators for use with {@link #sortMapByValue(Map, Comparator)} above.
     * <p/>
     * Call it like so: {@code CollectionUtils.<String, Integer>toEntryComparator(valueComparator);}
     * 
     * @param valueComparator
     *            a comparator which compares the value types from a Map.
     ...
     * 
     * @param offset
     *            the number of places over which to move the specified element.
     * @param element
    ...
    /**
     * This method does the same as {@link #moveLeft(int, Object, List)} but it moves the specified element to the right instead of the left.
     */
