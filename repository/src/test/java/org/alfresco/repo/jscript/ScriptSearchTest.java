...
public class ScriptSearchTest {
  ...
  private ServiceRegistry mockServiceRegistry() {
    ...
    FacetLabelDisplayHandlerRegistry displayHandlerRegistry = mock(
      FacetLabelDisplayHandlerRegistry.class
    );
    ...
    when(displayHandlerRegistry.getDisplayHandler(fieldFacet2))
      .thenReturn(null);
    ...
    when(services.getFacetLabelDisplayHandlerRegistry())
      .thenReturn(displayHandlerRegistry);
    return services;
  }
  ...
  public void testSearchFacetDisplayHandlerCustom() throws Exception {
    ...
    Pair<Object[], Map<String, Object>> results = SEARCH_SCRIPT.queryResultMeta(
      sp,
      false
    );
    Map<String, Object> facets = (Map<String, Object>) results
      .getSecond()
      .get("facets");
