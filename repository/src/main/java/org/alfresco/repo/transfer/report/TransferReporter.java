...
public interface TransferReporter {
     ...
     *
     * @param transferName - the unique name of this transfer - probably based upon the time of
     *     transfer.
     ...
     *     transfer.
     * @param target the target of the transfer
     * @param tempFile the temporary file containing the contents of the destination side transfer
     *     report.
     * @return the node ref of the transfer report
     */
