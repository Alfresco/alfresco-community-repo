...
public class WorkflowInstanceDelete extends AbstractWorkflowWebscript {
    ...
    /**
     * Determines if the current user can cancel or delete the workflow instance with the given id.
     * Throws a WebscriptException with status-code 404 if workflow-instance to delete wasn't found.
     *
    ...
    private boolean canUserEndWorkflow(String instanceId) {
        ...
        if (wi == null) {
            throw new WebScriptException(
                    ...
                    "The workflow instance to delete/cancel with id "
                            + instanceId
                            + " doesn't exist: ");
        }
