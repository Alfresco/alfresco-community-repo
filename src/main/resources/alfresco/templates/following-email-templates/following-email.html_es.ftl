                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div style="font-size: 22px; padding-bottom: 4px;">
                                                      ${followerLink} está siguiéndole ahora.
                                                   </div>
                                                   <div style="font-size: 13px;">
                                                      <#if followerJobTitle??>${followerJobTitle?html}<br/></#if>
                                                   </div>
                                                   <div style="font-size: 13px;">
                                                      <#if followingCount &gt; 0><span style="font-weight:bold">Está siguiendo a ${followingCount}</span>. </#if><span style="font-weight:bold">Tiene ${followerCount}</span> seguidores.
                                                   </div>
                                                </td>
                                             </tr>
                                          </table>
