...
public interface ActivityService extends ActivityPostService
{
     ...
     * 
     * User filters are: - all user activities (excludeThisUser = false, excludeOtherUsers = false) - other user activities (excludeThisUser = true, excludeOtherUsers = false) - my user activities (excludeThisUser = false, excludeOtherUsers = true) note: if both excludes are true then no activities will be returned.
     * 
     * @param userId
     *            - required
     * @param siteId
     ...
     *            - if TRUE then will exclude activities for other users (hence returning this user only)
     * @param userFilter
     *            - if not NULL then will only return activities of users in this set
     * @param actvityFilter
