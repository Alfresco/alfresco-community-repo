...
public abstract class AbstractContentWriter
  ...
  public final ContentReader getReader() throws ContentIOException {
    ...
    if (reader == null) {
      ...
      !reader.getContentUrl().equals(contentUrl)
    ) {
      throw new AlfrescoRuntimeException(
  ...
  protected ContentLimitProvider getContentLimitProvider() {
    return this.limitProvider == null
      ? new NoLimitProvider()
      : this.limitProvider;
  }
   ...
   */
  public final synchronized WritableByteChannel getWritableChannel()
    throws ContentIOException {
  ...
  public FileChannel getFileChannel(boolean truncate)
    ...
    if (channel instanceof FileChannel) {
      ...
      ); // this ensures that the existing content is pulled in
      // Attach a listener
  ...
  public OutputStream getContentOutputStream() throws ContentIOException {
    try {
      ...
      OutputStream is = new BufferedOutputStream(
  ...
  public void guessEncoding() {
    if (mimetypeService == null) {
      logger.warn(
        "MimetypeService not supplied, but required for content guessing"
      );
      return;
    }
