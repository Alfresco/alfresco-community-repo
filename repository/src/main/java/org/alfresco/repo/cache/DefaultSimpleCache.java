...
public final class DefaultSimpleCache<K extends Serializable, V extends Object>
    ...
    public DefaultSimpleCache(
            int maxItems, boolean useMaxItems, int ttlSecs, int maxIdleSecs, String cacheName) {
        if (maxItems == 0) {
     ...
     *
     * @return <code>true</code> if the put resulted in a change in value, <code>false</code>
     *     otherwise.
     */
    ...
    public String toString() {
        return "DefaultSimpleCache[maxItems="
                + maxItems
                + ", useMaxItems="
                + useMaxItems
                + ", cacheName="
