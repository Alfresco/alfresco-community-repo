...
public class Rule implements Serializable
{
    ...
    /**
     * Indicates whether the rule is applied to all the children of the associated node rather than just the node itself.
     */
     ...
     *            true to execute action async, false otherwise
     */
     ...
     * 
     * @param ruleDisabled
     *            true id the rule has been disabled, false otherwise
     */
