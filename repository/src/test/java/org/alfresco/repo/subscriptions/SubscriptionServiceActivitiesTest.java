...
public class SubscriptionServiceActivitiesTest {
  ...
  private static final Log log = LogFactory.getLog(
    SubscriptionServiceActivitiesTest.class
  );
  ...
  public static void setUp() throws Exception {
    ...
    LocalFeedTaskProcessor feedProcessor = (LocalFeedTaskProcessor) activitiesFeedCtx.getBean(
      "feedTaskProcessor"
    );
  ...
  protected NodeRef addTextContent(String siteId, String name) {
    ...
    NodeRef parentRef = siteService.getContainer(
      siteId,
  ...
  public void testFollowingActivity() throws Exception {
    ...
    log.debug(
      "Made user '" + USER_ONE_NAME + "' a SiteManager in each test site."
    );
    ...
    doWorkAs(
      ...
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          log.debug(
            "Now to check if the activity tables have the correct number of entries for our test users"
          );

          List<String> feed = activityService.getUserFeedEntries(
            USER_ONE_NAME,
            null,
            false,
            false,
    ...
    doWorkAs(
      ...
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          log.debug(USER_ONE_NAME + "'s feed: " + prettyJson(feed));
          assertEquals(
            USER_ONE_NAME + "'s feed was wrong size",
            7,
            feed.size()
          );
          ...
          log.debug(USER_TWO_NAME + "'s feed: " + prettyJson(feed));
          assertEquals(
            USER_TWO_NAME + "'s feed was wrong size",
            2,
            feed.size()
          );
          return null;
    ...
    doWorkAs(
      ...
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          addTextContent(
            privateSite1.getShortName(),
            USER_ONE_NAME + "priv1-a"
          );
          addTextContent(
            privateSite2.getShortName(),
            USER_ONE_NAME + "priv2-a"
          );
    ...
    doWorkAs(
      ...
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          addTextContent(
            privateSite1.getShortName(),
            USER_ONE_NAME + "priv1-b"
          );
          addTextContent(
            privateSite2.getShortName(),
            USER_ONE_NAME + "priv2-b"
          );
