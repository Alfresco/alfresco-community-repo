...
public class CannedQueryDefImpl implements CannedQueryDef {
    ...
    private static final org.dom4j.QName QNAME =
            new org.dom4j.QName(
                    "qname",
                    new Namespace(NamespaceService.ALFRESCO_PREFIX, NamespaceService.ALFRESCO_URI));

    private static final org.dom4j.QName LANGUAGE =
            new org.dom4j.QName(
                    "language",
                    new Namespace(NamespaceService.ALFRESCO_PREFIX, NamespaceService.ALFRESCO_URI));

    private static final org.dom4j.QName QUERY =
            new org.dom4j.QName(
                    "query",
                    new Namespace(NamespaceService.ALFRESCO_PREFIX, NamespaceService.ALFRESCO_URI));
    ...
    private Map<QName, QueryParameterDefinition> queryParameterDefs =
    ...
    public static CannedQueryDefImpl createCannedQuery(
        ...
        if (element.getQName().getName().equals(ELEMENT_QNAME.getName())) {
            ...
            for (Iterator it = list.iterator(); it.hasNext(); /**/ ) {
                ...
                NamedQueryParameterDefinition nqpd =
                        QueryParameterRefImpl.createParameterReference(
                                refElement, dictionaryService, container);
