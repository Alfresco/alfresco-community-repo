...
public class UpdateSiteGroupTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify that collaborator is not able to update site group membership and gets"
    ...
    public void collaboratorIsNotAbleToUpdateSiteGroup() throws Exception {
        ...
        restClient
                ...
                .addSiteGroup(getId(groupToBeUpdated), UserRole.SiteConsumer);
        restClient.authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator));
        restClient
                .withCoreAPI()
                .usingSite(publicSite)
                .updateSiteGroup(getId(groupToBeUpdated), UserRole.SiteCollaborator);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that contributor is not able to update site membership and gets status"
                            + " code FORBIDDEN (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that consumer is not able to update site group and gets status code"
                            + " FORBIDDEN (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site group request returns status code 404 when nonexistent"
                            + " siteId is used")
    public void updateSiteGroupOfNonexistentSite() throws Exception {
        ...
        restClient
                ...
                .updateSiteGroup(getId(groupToBeUpdated), UserRole.SiteConsumer);
        restClient
    ...
    public void updateNotASiteMember() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary("authority is not a member of the site");
    }
    ...
    public void updateNonexistentSiteMember() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSite)
                .updateSiteGroup(getId(nonexistentUser), UserRole.SiteConsumer);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format("An authority was not found for %s", getId(nonexistentUser)));
    }
    ...
    public void updateSiteMemberUsingEmptySiteId() throws Exception {
        restClient
                ...
                .withCoreAPI()
                .usingSite("")
                .updateSiteGroup(getId(regularGroup), UserRole.SiteConsumer);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
    ...
    public void updateSiteMemberUsingEmptyPersonId() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSite)
                .updateSiteGroup(getId(emptyGroup), UserRole.SiteConsumer);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format("An authority was not found for %s", getId(emptyGroup)));
    }
