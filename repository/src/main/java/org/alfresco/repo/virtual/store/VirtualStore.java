 ...
 * <p>
 * Handles most virtualized {@link Reference} meta-data interactions analogous to actual Alfresco public Repository Services.
 * 
...
public interface VirtualStore
{
    ...
    /**
     * @param reference
     * @return all virtual properties of the referred virtualized artefact keyed by their qualified name
     * @throws VirtualizationException
     */
    Map<QName, Serializable> getProperties(Reference reference) throws VirtualizationException;

    /**
     * Get the reference of the virtualized artefact with the given name within the virtual context (only) of the parent reference.<br>
     * The name is case-insensitive as Alfresco has to support case-insensitive clients as standard.<br>
     * 
     * @param parentReference
     *            parent {@link Reference}
     * @param assocTypeQName
     * @param childName
     * @return the virtual child reference for the given name in the context of the given parent reference
     * @throws VirtualizationException
    ...
    /**
     * Gets a pair of child references associations where the pattern of the association qualified name is an exact match and the total number of matches.
     *
     * @param parentReference
     *            the parent node - usually a <b>container</b>
     * @param typeQNamePattern
     ...
     * @param preload
     *            <tt>true</tt> if the nodes must be preloaded into the cache
     * @return Returns a pair of list of <code>ChildAssociationRef</code> instances and total number of matches
     * @throws InvalidNodeRefException
     *             if the node could not be found
     * @see QName
     */
    Pair<List<ChildAssociationRef>, Integer> getChildAssocs(Reference parentReference, QNamePattern typeQNamePattern,
     ...
     * 
     * @param parentReference
     *            the parent reference - usually a <b>container</b>
     * @param propertyQName
    ...
    /**
     * Lists page of immediate children of the referred virtualized artefact with optional filtering (exclusion of certain child file/folder subtypes, actual-virtual filtering) and sorting.<br>
    ...
    /**
     * Perform a search against the name of the files or folders within a virtualized artefact {@link Reference} hierarchy. <br>
     ...
     * @throws VirtualizationException
     * @deprecated {@link FileFolderService#search(NodeRef, String, boolean, boolean, boolean)} alignment : for shallow search use list, listFolders, listFiles, searchSimple. For deep listing use listDeepFolders. Avoid calling this method with any name pattern except for "*".
     */
