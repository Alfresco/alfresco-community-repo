...
@EntityResource(
  name = "flock",
  title = "A resource used for testing binary properties"
)
public class FlockEntityResource
  implements
    BinaryResourceAction.Read,
    BinaryResourceAction.Delete,
    BinaryResourceAction.Update<Flock> {

  //versions/1/flock/xyz/photo PUT
  @Override
  @WebApiDescription(title = "Updates a photo")
  @BinaryProperties("photo")
  public Flock updateProperty(
    String entityId,
  ...
  @Override
  @WebApiDescription(
    title = "Reads a photo as a Stream",
    successStatus = Status.STATUS_FOUND
  )
  @BinaryProperties("photo")
