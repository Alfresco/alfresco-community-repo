...
public class SystemVirtualizationMethodTest extends VirtualizationIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        systemVirtualizationMethod =
                ctx.getBean("systemVirtualizationMethod", SystemVirtualizationMethod.class);
    }
    ...
    public void testDefaultSyspath() throws Exception {
        NodeRef vf =
                createVirtualizedFolder(
                        ...
                        null);
        assertFalse(systemVirtualizationMethod.canVirtualize(environment, vf));
        try {
            systemVirtualizationMethod.virtualize(environment, vf);
    ...
    public void testTemplateFromRepository() throws Exception {
        InputStream openContentStream =
                environment.openContentStream(TEST_TEMPLATE_1_JSON_CLASSPATH);
        NodeRef repositoryTemplate =
        ...
        ContentWriter writer =
                contentService.getWriter(repositoryTemplate, ContentModel.PROP_CONTENT, true);
        ...
        assertNotNull(
                nodeService.getChildByName(ref.toNodeRef(), ContentModel.ASSOC_CONTAINS, "Node1"));
        assertNotNull(
                nodeService.getChildByName(ref.toNodeRef(), ContentModel.ASSOC_CONTAINS, "Node2"));
    }
