...
/**
 * Base class of a processor, encapsulates the implementation reguarding the registration of the
 * processor with the relevant services and the handling of processor extensions.
 *
...
public abstract class BaseProcessor implements Processor {
    ...
    protected Map<String, ProcessorExtension> processorExtensions =
            new HashMap<String, ProcessorExtension>(16);
