...
public class CopyServiceImplUnitTest {
  ...
  public void testBuildNewName_FileWithExtension() {
    ...
    assertEquals(
      copyOfLabelTranslated + FILE_NAME + FILE_EXTENSION,
      copyServiceImpl.buildNewName(FILE_NAME + FILE_EXTENSION)
    );
    restoreLocale();
  }
  ...
  public void testBuildNewName_FileWithExtensionAndCopyOf() {
    ...
    assertEquals(
      copyOfLabelTranslated + fileNameOfCopy,
      copyServiceImpl.buildNewName(fileNameOfCopy)
    );
    restoreLocale();
  }
  ...
  public void testBuildNewName_FileWithoutExtension() {
    switchLocale(Locale.ENGLISH);
    assertEquals(
      copyOfLabelTranslated + FILE_NAME,
      copyServiceImpl.buildNewName(FILE_NAME)
    );
    restoreLocale();
  }
  ...
  public void testBuildNewName_FileWithExtension_JapaneseLocale() {
    ...
    assertEquals(
      FILE_NAME + copyOfLabelTranslated + FILE_EXTENSION,
      copyServiceImpl.buildNewName(FILE_NAME + FILE_EXTENSION)
    );
    restoreLocale();
  }
  ...
  public void testBuildNewName_FileWithExtensionAndCopyOf_JapaneseLocale() {
    ...
    assertEquals(
      fileNameOfCopy + copyOfLabelTranslated + FILE_EXTENSION,
      copyServiceImpl.buildNewName(fileNameOfCopy + FILE_EXTENSION)
    );
    restoreLocale();
  }
  ...
  public void testBuildNewName_FileWithoutExtension_JapaneseLocale() {
    switchLocale(Locale.JAPANESE);
    assertEquals(
      FILE_NAME + copyOfLabelTranslated,
      copyServiceImpl.buildNewName(FILE_NAME)
    );
    restoreLocale();
  }
