...
public class FacetablePropertiesGet
  ...
  protected Map<String, Object> unprotectedExecuteImpl(
    ...
    final Locale userLocale = (userLocaleString == null)
      ? Locale.getDefault()
      : new Locale(userLocaleString);
    ...
    try {
      ...
      throw new WebScriptException(
        ...
        "Unrecognised classname: " + contentClassName,
        e
      );
    }
    ...
    if (contentClassQName == null) {
      facetableProperties =
        toFacetablePropertyModel(
          facetService.getFacetableProperties(),
          userLocale
        );
      ...
      facetableProperties =
        toFacetablePropertyModel(
          facetService.getFacetableProperties(contentClassQName),
          userLocale
        );
    ...
    List<FacetablePropertyFTL<?>> filteredFacetableProperties = filter(
      facetableProperties,
      filters
    );
    ...
    model.put(
      PROPERTIES_KEY,
      ModelUtil.page(filteredFacetableProperties, paging)
    );
  ...
  private List<FacetablePropertyFTL<?>> filter(
    Collection<FacetablePropertyFTL<?>> propsData,
  ...
  private FacetablePropertyFTL<?> toFacetablePropertyModel(
    SyntheticPropertyDefinition propDef,
    Locale locale
  ) {
    ...
    final String i18nKeyPrefix =
      "cm_contentmodel.property.cm_content.cm_content.";
    final String localisedTitle = I18NUtil.getMessage(
      i18nKeyPrefix + propDef.syntheticPropertyName,
      locale
    );
  ...
  private SortedSet<FacetablePropertyFTL<?>> toFacetablePropertyModel(
    ...
    SortedSet<FacetablePropertyFTL<?>> result = new TreeSet<>(
      new FacetablePropertyFTLComparator()
    );
  ...
  private SortedSet<FacetablePropertyFTL<?>> toFacetablePropertyModel_(
    Collection<SyntheticPropertyDefinition> propDefs,
    Locale locale
  ) {
    SortedSet<FacetablePropertyFTL<?>> result = new TreeSet<>(
      new FacetablePropertyFTLComparator()
