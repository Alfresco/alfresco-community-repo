...
/**
 * ConfigSource that looks for a prefix to determine where to look for the config.</br> Valid
 * prefixes are:
 *
 * <ul>
 *   <li><b><storeProtocol>://<storeIdentifier></b> the location provided is a path to a repository
 *       file
 * </ul>
 *
 * as well as those defined in the core (UrlConfigSource)
 *
 * <p>Example store URLs <code>
        ...
        try {
            ...
            if (idx != -1) {
                ...
                List<NodeRef> nodeRefs =
                        searchService.selectNodes(rootNode, path, null, namespaceService, false);
                ...
                if (nodeRefs.size() == 0) {
                    ...
                    throw new ConfigException(
                            "Found duplicate config sources in the repository " + sourceUrl);
                }
