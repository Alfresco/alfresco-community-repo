...
public class NodeDescription {
    /**
     * An identifier for the node for monitoring purposes. Should help trace where the node
     * originated from.
     */
     ...
     *
     * @param sourceId An identifier for the node for monitoring purposes. Should help trace where
     *     the node originated from.
     */
    ...
    /**
     * Gets an identifier for the node for monitoring purposes. Should help trace where the node
     * originated from.
     *
