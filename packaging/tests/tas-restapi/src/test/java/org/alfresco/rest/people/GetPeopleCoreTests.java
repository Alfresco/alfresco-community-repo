...
public class GetPeopleCoreTests extends RestTest {
  ...
  @TestRail(
    ...
    description = "Verify inexistent user cannot get a person with Rest API and response is 401"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify user cannot get a person that doesn't exists with Rest API and response is 404"
  )
