...
public interface PermissionCheckedValue {
    /**
     * Helper 'introduction' to allow simple addition of the {@link PermissionCheckedValue}
    ...
    public static class PermissionCheckedValueMixin extends DelegatingIntroductionInterceptor
            implements PermissionCheckedValue {
        private PermissionCheckedValueMixin() {
            super();
        }
        /**
         * Helper method to create a {@link PermissionCheckedValue} from an existing <code>Object
         * </code>.
         *
         * @param object the <code>Object</code> to proxy
         * @return a <code>Object</code> of the same type but including the {@link
         *     PermissionCheckedValue} interface
         */
        ...
        public static final <T extends Object> T create(T object) {
            ...
            IntroductionAdvisor advisor =
                    new DefaultIntroductionAdvisor(mixin, PermissionCheckedValue.class);
            // Proxy
