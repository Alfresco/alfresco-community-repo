...
public class DispositionServiceImpl extends ServiceBaseImpl
    ...
    public enum WriteMode {
        ...
        DATE_ONLY,
        /**
         * Set the "disposition as of" date and the name of the next action. This only happens
         * during the creation of a disposition schedule impl node under a record or folder.
         */
        DATE_AND_NAME
    }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#refreshDispositionAction(NodeRef)
     */
    @Override
    public void refreshDispositionAction(NodeRef nodeRef) {
        ...
        if (di != null) {
            List<DispositionActionDefinition> dispositionActionDefinitions =
                    di.getDispositionActionDefinitions();
            if (!dispositionActionDefinitions.isEmpty()) {
                ...
                DispositionActionDefinition nextDispositionActionDefinition =
                        dispositionActionDefinitions.get(0);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#registerDispositionProperty(org.alfresco.module.org_alfresco_module_rm.disposition.property.DispositionProperty)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getDispositionProperties(boolean,
     *     java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getDispositionProperties()
     */
    @Override
    public Collection<DispositionProperty> getDispositionProperties() {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getDispositionSchedule(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    public DispositionSchedule getDispositionSchedule(final NodeRef nodeRef) {
        ...
        if (isRecord(nodeRef)) {
            ...
            DispositionSchedule originDispositionSchedule =
                    AuthenticationUtil.runAsSystem(
                            new RunAsWork<DispositionSchedule>() {
                                @Override
            ...
            final NextActionFromDisposition dsNextAction =
                ...
                if (isNotTrue((Boolean) nodeService.getProperty(action, PROP_MANUALLY_SET_AS_OF))) {
                    if (!dsNextAction.getWriteMode().equals(WriteMode.READ_ONLY)) {
                        ...
                        RunAsWork<Void> runAsWork =
                                () -> {
                                    nodeService.setProperty(
                                            action, PROP_DISPOSITION_AS_OF, dispositionActionDate);
                                    return null;
                                };
                        ...
                        if (AlfrescoTransactionSupport.getTransactionReadState()
                                .equals(TxnReadState.TXN_READ_ONLY)) {
                            transactionService
                        ...
                        if (dsNextAction.getWriteMode().equals(WriteMode.DATE_AND_NAME)) {
                            nodeService.setProperty(
                                    action, PROP_DISPOSITION_ACTION_NAME, dispositionActionName);
                        }
                    }
                }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getAssociatedDispositionSchedule(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    private NodeRef getAssociatedDispositionScheduleImpl(NodeRef nodeRef) {
        ...
        if (!filePlanService.isFilePlanComponent(nodeRef)) {
            throw new AlfrescoRuntimeException(
                    "Can not find the associated retention schedule for a non records management"
                            + " component. (nodeRef="
                            + nodeRef.toString()
                            + ")");
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getAssociatedRecordsManagementContainer(org.alfresco.module.org_alfresco_module_rm.disposition.DispositionSchedule)
     */
    @Override
    public NodeRef getAssociatedRecordsManagementContainer(
        ...
        if (nodeService.exists(dsNodeRef)) {
            List<ChildAssociationRef> assocs =
                    this.nodeService.getParentAssocs(
                            dsNodeRef, ASSOC_DISPOSITION_SCHEDULE, RegexQNamePattern.MATCH_ALL);
            if (!assocs.isEmpty()) {
                if (assocs.size() != 1) {
                    // TODO in the future we should be able to support disposition schedule reuse,
                    // but for now just warn that
                    //      only the first disposition schedule will be considered
                    if (LOGGER.isWarnEnabled()) {
                        LOGGER.warn(
                                "Retention schedule has more than one associated records management"
                                        + " container.  This is not currently supported so only the"
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#hasDisposableItems(org.alfresco.module.org_alfresco_module_rm.disposition.DispositionSchedule)
     */
    @Override
     ...
     * This method is similar to getDisposableItemsImpl(boolean isRecordLevelDisposition, NodeRef
     * rmContainer) but with improved performance: For RecordLevelDisposition it will limit Record
     * retrieval to 1. Early returns once the first occurrence is found.
     *
        ...
        for (NodeRef item : items) {
            if (recordFolderService.isRecordFolder(item)) {
                if (isRecordLevelDisposition) {
                    ...
                    && getAssociatedDispositionScheduleImpl(item) == null) {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getDisposableItems(org.alfresco.module.org_alfresco_module_rm.disposition.DispositionSchedule)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#isDisposableItem(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
     ...
     * @return
     */
    private List<NodeRef> getDisposableItemsImpl(
            boolean isRecordLevelDisposition, NodeRef rmContainer) {
        List<NodeRef> items = filePlanService.getAllContained(rmContainer);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#createDispositionSchedule(org.alfresco.service.cmr.repository.NodeRef,
     *     java.util.Map)
     */
    @Override
    public DispositionSchedule createDispositionSchedule(
            NodeRef nodeRef, Map<QName, Serializable> props) {
        NodeRef dsNodeRef = null;
        ...
        if (!nodeService.exists(nodeRef)) {
            throw new AlfrescoRuntimeException(
                    "Unable to create retention schedule, because node does not exist. (nodeRef="
                            + nodeRef.toString()
                            + ")");
        }
        ...
        if (!TYPE_RECORD_CATEGORY.equals(nodeRefType)
            ...
            throw new AlfrescoRuntimeException(
                    "Unable to create retention schedule on a node that is not a records management"
                            + " container.");
        }
        ...
        try {
            ...
            List<ChildAssociationRef> assocs =
                    nodeService.getChildAssocs(
                            nodeRef, ASSOC_DISPOSITION_SCHEDULE, RegexQNamePattern.MATCH_ALL);
            if (assocs.isEmpty()) {
                DispositionSchedule currentDispositionSchdule = getDispositionSchedule(nodeRef);
                if (currentDispositionSchdule != null) {
                    List<NodeRef> items =
                            getDisposableItemsImpl(
                                    currentDispositionSchdule.isRecordLevelDisposition(), nodeRef);
                    if (!items.isEmpty()) {
                        throw new AlfrescoRuntimeException(
                                "Can not create a retention schedule if there are disposable items"
                                    + " already under the control of an other retention schedule");
                    }
                }
                        ...
                        nodeService
                                .createNode(
                                        ...
                                        QName.createQName(
                                                ...
                                                QName.createValidLocalName("dispositionSchedule")),
                ...
                throw new AlfrescoRuntimeException(
                        "Unable to create retention schedule on node that already has a retention"
                                + " schedule.");
            }
        } finally {
    ...
    public DispositionActionDefinition addDispositionActionDefinition(
        ...
        if (name == null || name.length() == 0) {
            throw new IllegalArgumentException(
                    "'name' parameter is mandatory when creating a disposition action definition");
        }
        ...
        NodeRef actionNodeRef =
                this.nodeService
                        .createNode(
                                ...
                                RecordsManagementModel.TYPE_DISPOSITION_ACTION_DEFINITION,
                                actionDefinitionParams)
                        .getChildRef();

        // get the updated disposition schedule and retrieve the new action definition
        NodeRef scheduleParent =
                this.nodeService.getPrimaryParent(schedule.getNodeRef()).getParentRef();
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#removeDispositionActionDefinition(org.alfresco.module.org_alfresco_module_rm.disposition.DispositionSchedule,
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionActionDefinition)
     */
    @Override
    public void removeDispositionActionDefinition(
        ...
        if (hasDisposableItems(schedule)) {
            throw new AlfrescoRuntimeException(
                    "Can not remove action definitions from schedule '"
                            + schedule.getNodeRef()
                            + "' as one or more record or record folders are present.");
        }
    ...
    public DispositionActionDefinition updateDispositionActionDefinition(
        ...
        NodeRef ds =
                this.nodeService.getPrimaryParent(actionDefinition.getNodeRef()).getParentRef();
        DispositionSchedule updatedSchedule =
                new DispositionScheduleImpl(serviceRegistry, nodeService, ds);
     ...
     */
    private DispositionAction initialiseDispositionAction(
            final NodeRef nodeRef, DispositionActionDefinition dispositionActionDefinition) {
        List<ChildAssociationRef> childAssocs =
                nodeService.getChildAssocs(
                        nodeRef,
        ...
        // check if current transaction is a READ ONLY one and if true create the node in a READ
        // WRITE transaction
        if (AlfrescoTransactionSupport.getTransactionReadState()
                .equals(TxnReadState.TXN_READ_ONLY)) {
            da =
                    transactionService
                            .getRetryingTransactionHelper()
                            .doInTransaction(
                                    new RetryingTransactionCallback<DispositionAction>() {
     ...
     */
    private DispositionAction createDispositionAction(
            final NodeRef nodeRef, Map<QName, Serializable> props) {
        NodeRef dispositionActionNodeRef =
                nodeService
                        .createNode(
                                nodeRef,
                                ASSOC_NEXT_DISPOSITION_ACTION,
            ...
            if (periodProperty != null) {
                if (RecordsManagementModel.PROP_DISPOSITION_AS_OF.equals(periodProperty)) {
                    DispositionAction lastCompletedDispositionAction =
                            getLastCompletedDispostionAction(nodeRef);
                    ...
                    // doesn't matter if the period property isn't set ... the asOfDate will get
                    // updated later
                ...
                if (period.getPeriodType().equals(Immediately.PERIOD_TYPE)) {
                    contextDate =
                            (Date) nodeService.getProperty(nodeRef, ContentModel.PROP_CREATED);
                } else {
                    // for now use 'NOW' as the default context date
                    // TODO set the default period property ... cut off date or last disposition
                    // date depending on context
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#isNextDispositionActionEligible(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
        ...
        if (di != null
            ...
            if (nextDa.getName().equals("accession")) {
                NodeRef accessionNodeRef =
                        di.getDispositionActionDefinitionByName("accession").getNodeRef();
            ...
            Date asOf =
                    (Date)
                            getInternalNodeService()
                                    .getProperty(nextDa.getNodeRef(), PROP_DISPOSITION_AS_OF);
            ...
            if (dad != null) {
                boolean firstComplete =
                        authenticationUtil.runAsSystem(() -> dad.eligibleOnFirstCompleteEvent());
                ...
                for (ChildAssociationRef assoc : assocs) {
                    ...
                    Boolean isCompleteValue =
                            (Boolean)
                                    getInternalNodeService()
                                            .getProperty(
                                                    eventExecution, PROP_EVENT_EXECUTION_COMPLETE);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getNextDispositionAction(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getCompletedDispositionActions(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    public List<DispositionAction> getCompletedDispositionActions(NodeRef nodeRef) {
        List<ChildAssociationRef> assocs =
                nodeService.getChildAssocs(
                        nodeRef, ASSOC_DISPOSITION_ACTION_HISTORY, RegexQNamePattern.MATCH_ALL);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#getLastCompletedDispostionAction(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#isDisposableItemCutoff(NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#updateNextDispositionAction(NodeRef)
     */
    @Override
    public void updateNextDispositionAction(final NodeRef nodeRef) {
        ...
        RunAsWork<Void> runAsWork =
                new RunAsWork<Void>() {
                    /**
                     * @see
                     *     org.alfresco.repo.security.authentication.AuthenticationUtil.RunAsWork#doWork()
                     */
                    @Override
                    public Void doWork() {
                        // Get this disposition instructions for the node
     ...
     */
    @Override
    public void updateNextDispositionAction(
            final NodeRef nodeRef, final DispositionSchedule dispositionSchedule) {
                    ...
                    public Void doWork() {
                        ...
                        if (dispositionSchedule != null) {
                            ...
                            if (currentDispositionAction == null) {
                                ...
                                currentDispositionActionDefinition =
                                        dispositionSchedule.getDispositionActionDefinition(
                                                currentADId);

                                // When the record has multiple disposition schedules the current
                                // disposition action may not be found by id
                                ...
                                if (index < dispositionActionDefinitions.size()) {
                                    nextDispositionActionDefinition =
                                            dispositionActionDefinitions.get(index);
                                }
                            }
                            ...
                            if (nextDispositionActionDefinition != null) {
                                if (!nodeService.hasAspect(nodeRef, ASPECT_DISPOSITION_LIFECYCLE)) {
                                    ...
                                    nodeService.addAspect(
                                            nodeRef, ASPECT_DISPOSITION_LIFECYCLE, null);
                                }

                                initialiseDispositionAction(
                                        nodeRef, nextDispositionActionDefinition);
                            }
                        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.disposition.DispositionService#cutoffDisposableItem(NodeRef)
     */
    @Override
    public void cutoffDisposableItem(final NodeRef nodeRef) {
        ...
        if (FilePlanComponentKind.RECORD_FOLDER.equals(
            ...
            if (!isDisposableItemCutoff(nodeRef)) {
                ...
                throw new AlfrescoRuntimeException(
                        "unable to perform cutoff, because node is frozen or has frozen children");
            }
        } else {
            throw new AlfrescoRuntimeException(
                    "Unable to peform cutoff, because node is not a disposible item. (nodeRef="
                            + nodeRef.toString()
                            + ")");
        }
    }

    public Date getDispositionActionDate(
            NodeRef record, NodeRef dispositionSchedule, String dispositionActionName) {
        DispositionSchedule ds =
                new DispositionScheduleImpl(serviceRegistry, nodeService, dispositionSchedule);
        List<ChildAssociationRef> assocs =
                getInternalNodeService().getChildAssocs(dispositionSchedule);

        if (assocs != null && !assocs.isEmpty()) {
            for (ChildAssociationRef assoc : assocs) {
                if (assoc != null
                        && assoc.getQName().getLocalName().contains(dispositionActionName)) {
                    DispositionActionDefinition actionDefinition =
                            ds.getDispositionActionDefinition(assoc.getChildRef().getId());

                    return authenticationUtil.runAsSystem(
                            () -> calculateAsOfDate(record, actionDefinition));
                }
            }
        }
        return null;
    ...
    public void recalculateNextDispositionStep(NodeRef record) {
        ...
        if (nextDispositionAction != null) {
            NextActionFromDisposition dsNextAction =
                    getNextDispositionAction(record, recordFolders, nextDispositionAction);
            if (dsNextAction != null) {
                final NodeRef action = dsNextAction.getNextActionNodeRef();
                final Date dispositionActionDate = dsNextAction.getNextActionDateAsOf();
                AuthenticationUtil.runAsSystem(
    ...
    protected NextActionFromDisposition getDispositionActionByNameForRecord(NodeRef record) {
        ...
        if (nextDispositionAction == null) {
            DispositionAction lastCompletedDispositionAction =
                    getLastCompletedDispostionAction(record);
            if (lastCompletedDispositionAction != null) {
     ...
     */
    private NextActionFromDisposition getNextDispositionAction(
            NodeRef record, List<NodeRef> recordFolders, DispositionAction nextDispositionAction) {
        ...
        // Find the latest "disposition as of" date from all the schedules this record is subject
        // to.
            ...
            if (dsNodeRef != null) {
                Date dispActionDate =
                        getDispositionActionDate(
                                record, dsNodeRef, recordNextDispositionActionName);
                if (dispActionDate == null
                        || (nextDispositionActionDate != null
        ...
        WriteMode mode =
                determineWriteMode(recordNextDispositionActionDate, nextDispositionActionDate);

        return new NextActionFromDisposition(
                dispositionNodeRef,
                nextDispositionAction.getNodeRef(),
                recordNextDispositionActionName,
                nextDispositionActionDate,
                mode);
    }

    /**
     * Determine what should be updated for an existing disposition schedule impl. We only update
     * the date if the existing date is earlier than the calculated one.
     *
     * @param recordNextDispositionActionDate The next action date found on the record node (or
     *     folder node).
     * @param nextDispositionActionDate The next action date calculated from the current disposition
     *     schedule(s) affecting the node.
     * @return READ_ONLY if nothing should be updated, or DATE_ONLY if the date needs updating.
     */
    private WriteMode determineWriteMode(
            Date recordNextDispositionActionDate, Date nextDispositionActionDate) {
        // Treat null dates as being the latest possible date.
        Date maxDate = new Date(Long.MAX_VALUE);
        Date recordDate =
                (recordNextDispositionActionDate != null
                        ? recordNextDispositionActionDate
                        : maxDate);
        Date calculatedDate =
                (nextDispositionActionDate != null ? nextDispositionActionDate : maxDate);
     ...
     * @return next disposition action and the associated disposition schedule
     */
    private NextActionFromDisposition getFirstDispositionAction(
            NodeRef record, List<NodeRef> recordFolders) {
        ...
        for (NodeRef folder : recordFolders) {
            ...
            if (folderDS != null) {
                DispositionSchedule ds =
                        new DispositionScheduleImpl(serviceRegistry, nodeService, folderDS);
                List<DispositionActionDefinition> dispositionActionDefinitions =
                        ds.getDispositionActionDefinitions();

                if (dispositionActionDefinitions != null
                        && dispositionActionDefinitions.size() > 0) {
                    DispositionActionDefinition firstDispositionActionDef =
                            dispositionActionDefinitions.get(0);
                    ...
                    if (newAction == null) {
                        ...
                        DispositionAction firstDispositionAction =
                                initialiseDispositionAction(
                                        recordOrFolder, firstDispositionActionDef);
                        newAction = firstDispositionAction.getNodeRef();
                        newDispositionActionName =
                                (String)
                                        nodeService.getProperty(
                                                newAction, PROP_DISPOSITION_ACTION_NAME);
                        ...
                        if (firstActionDate == null
                                || (newDispositionActionDateAsOf != null
                            ...
                            if (firstActionDate == null) {
                                // Treat null as the latest date possible, so there's no point
                                // searching further.
                                break;
                            }
                        }
        ...
        return new NextActionFromDisposition(
                ...
                newAction,
                newDispositionActionName,
                newDispositionActionDateAsOf,
                WriteMode.DATE_AND_NAME);
    }
}
