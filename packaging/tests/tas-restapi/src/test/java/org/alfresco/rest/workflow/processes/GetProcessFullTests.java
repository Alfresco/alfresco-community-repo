...
public class GetProcessFullTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        addedProcess =
                restClient
                        ...
                        .withWorkflowAPI()
                        .addProcess("activitiAdhoc", assignee, false, CMISUtil.Priority.High);
        adhocProcessDefinition =
                restClient
                        .authenticateUser(userWhoStartsProcess)
                        .withWorkflowAPI()
                        .getAllProcessDefinitions()
                        .getProcessDefinitionByKey("activitiAdhoc");
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify user is able to get the process with properties parameter applied using"
                            + " REST API")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getProcessWithPropertiesParameter() throws Exception {
        process =
                restClient
                        .authenticateUser(userWhoStartsProcess)
                        .withWorkflowAPI()
                        .usingParams("properties=startUserId,id")
                        .usingProcess(addedProcess)
                        .getProcess();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to get a process that was deleted, but it has 'deleted"
                            + " through REST API call' deleteReason")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getDeletedProcess() throws Exception {
        ...
        process.assertThat()
                ...
                .is(adhocProcessDefinition.getId())
                .and()
                .field("startUserId")
                .is(addedProcess.getStartUserId())
                .and()
        ...
        process.assertThat()
                ...
                .and()
                .field("deleteReason")
                .is("deleted through REST API call")
                .and()
                .field("processDefinitionKey")
                .is("activitiAdhoc");
        ...
        restClient
                ...
                .getProcesses()
                .assertThat()
                .entriesListDoesNotContain("id", process.getId());
    }
}
