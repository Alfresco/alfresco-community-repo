...
public class VirtualPreferenceServiceExtensionTest extends VirtualizationIntegrationTest {
    private static final String DOCUMENTS_FAVOURITES_KEY =
    ...
    public void setUp() throws Exception {
        super.setUp();
        preferenceService = ctx.getBean("preferenceService", PreferenceService.class);
    }
    ...
    public void testSetFavoritesPreferencesForDocuments() throws Exception {
        ...
        NodeRef physicalTestfile1 =
                nodeService.getChildByName(
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "testfile-1.txt");
        ...
        preferenceService.setPreferences("admin", preferences);

        String preference =
                (String) preferenceService.getPreference("admin", DOCUMENTS_FAVOURITES_KEY);
        ...
        assertNull(
                (String)
                        preferenceService.getPreference(
                                "admin",
                                EXT_DOCUMENTS_FAVOURITES + testfile1.toString() + CREATED_AT));
        assertNotNull(
                (String)
                        preferenceService.getPreference(
                                "admin",
                                EXT_DOCUMENTS_FAVOURITES
        ...
        preference = (String) preferenceService.getPreference("admin", DOCUMENTS_FAVOURITES_KEY);
    ...
    public void testSetFavoritesPreferencesForFolders() throws Exception {
        ...
        try {
            ...
            Map<String, Serializable> preferences = new TreeMap<String, Serializable>();
            String key =
                    EXT_FOLDERS_FAVOURITES + physicalFolderInVirtualContext.toString() + CREATED_AT;
            preferences.put(key, "CREATED");
            preferences.put(FOLDERS_FAVOURITES_KEY, physicalFolderInVirtualContext.toString());
            preferenceService.setPreferences("admin", preferences);

            String preference =
                    (String) preferenceService.getPreference("admin", FOLDERS_FAVOURITES_KEY);
            ...
            preference = (String) preferenceService.getPreference("admin", FOLDERS_FAVOURITES_KEY);
            assertTrue(preference.isEmpty());
