...
public class ReplicationRestApiTest extends BaseWebScriptTest {
    ...
    public void testReplicationDefinitionsGet() throws Exception {
        ...
        ReplicationDefinition rd =
                replicationService.createReplicationDefinition("Test1", "Testing");
    ...
    public void testReplicationDefinitionGet() throws Exception {
        ...
        AuthenticationUtil.setFullyAuthenticatedUser(AuthenticationUtil.getGuestUserName());
        response =
                sendRequest(new GetRequest(URL_DEFINITION + "madeup"), Status.STATUS_UNAUTHORIZED);
        assertEquals(Status.STATUS_UNAUTHORIZED, response.getStatus());
        ...
        assertEquals(
                repositoryHelper.getCompanyHome().toString(), json.get("transferRemoteReport"));
    ...
    public void testReplicationDefinitionsPost() throws Exception {
        ...
        AuthenticationUtil.setFullyAuthenticatedUser(AuthenticationUtil.getGuestUserName());
        response =
                sendRequest(new PostRequest(URL_DEFINITIONS, "", JSON), Status.STATUS_UNAUTHORIZED);
        assertEquals(Status.STATUS_UNAUTHORIZED, response.getStatus());
        ...
        response =
                sendRequest(
                        new PostRequest(URL_DEFINITIONS, json.toString(), JSON), Status.STATUS_OK);
        assertEquals(Status.STATUS_OK, response.getStatus());
    ...
    public void testReplicationDefinitionPut() throws Exception {
        ...
        ReplicationDefinition rd =
                replicationService.createReplicationDefinition("Test", "Testing");
        replicationService.saveReplicationDefinition(rd);

        response =
                sendRequest(new PutRequest(URL_DEFINITION + "Test", "{}", JSON), Status.STATUS_OK);
        assertEquals(Status.STATUS_OK, response.getStatus());
    ...
    public void testReplicationDefinitionDelete() throws Exception {
        ...
        response =
                sendRequest(
                        new DeleteRequest(URL_DEFINITION + "MadeUp"), Status.STATUS_UNAUTHORIZED);
        assertEquals(Status.STATUS_UNAUTHORIZED, response.getStatus());
        ...
        // You need to specify a real definition
        response =
                sendRequest(new DeleteRequest(URL_DEFINITION + "MadeUp"), Status.STATUS_NOT_FOUND);
        assertEquals(Status.STATUS_NOT_FOUND, response.getStatus());
        ...
        response =
                sendRequest(new DeleteRequest(URL_DEFINITION + "Test"), Status.STATUS_NO_CONTENT);
        ...
        response =
                sendRequest(new DeleteRequest(URL_DEFINITION + "Test 3"), Status.STATUS_NO_CONTENT);
        assertEquals(Status.STATUS_NO_CONTENT, response.getStatus());
        ...
        response =
                sendRequest(new DeleteRequest(URL_DEFINITION + "Test 3"), Status.STATUS_NOT_FOUND);
        assertEquals(Status.STATUS_NOT_FOUND, response.getStatus());
     ...
     * "nasty" characters, things still work. Related to ALF-4610.
     */
    public void testReplicationDefinitionsNastyNames() throws Exception {
        ...
        assertEquals(
                nastyName,
                replicationService.loadReplicationDefinitions().get(0).getReplicationName());
        ...
        response =
                sendRequest(
                        new DeleteRequest(URL_DEFINITION + nastyNameURL), Status.STATUS_NO_CONTENT);
        assertEquals(Status.STATUS_NO_CONTENT, response.getStatus());
        ...
        // Check the details webscript to ensure it went
        response =
                sendRequest(new GetRequest(URL_DEFINITION + nastyNameURL), Status.STATUS_NOT_FOUND);
        assertEquals(Status.STATUS_NOT_FOUND, response.getStatus());
