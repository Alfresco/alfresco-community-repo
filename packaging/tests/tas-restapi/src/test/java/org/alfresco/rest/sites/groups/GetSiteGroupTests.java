...
public class GetSiteGroupTests extends RestTest {
    ...
    public void dataPreparation() throws DataPreparationException {
        ...
        restClient
                ...
                .addSiteGroup(getId(manager), UserRole.SiteManager);
        restClient
                .authenticateUser(adminUser)
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addSiteGroup(getId(consumer), UserRole.SiteConsumer);
    }
    ...
    public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteGroup()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Manager role doesn't get a site group of inexistent site and status"
    ...
    public void getSiteGroupOfInexistentSite() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_WAS_NOT_FOUND, invalidSite.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Manager role doesn't get non site group of inexistent site and status"
                            + " code is Not Found (404)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Manager role doesn't get not existing site group and status code is Not"
                            + " Found (404)")
    public void getSiteGroupForInexistentSiteGroup() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format("An authority was not found for %s", getId(inexistentGroup)));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Manager role gets site groups with Manager role and status code is OK"
                            + " (200)")
    public void getSiteGroupWithManagerRole() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addSiteGroup(getId(anotherManager), UserRole.SiteManager);

        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteGroup(getId(anotherManager))
                .assertThat()
                .field("id")
                .is(getId(anotherManager))
                .and()
                .field("role")
                .is(UserRole.SiteManager);
        restClient.assertStatusCodeIs(HttpStatus.OK);
