...
public class FileFolderServicePropagationTest extends TestCase {
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                assertEquals(
                                        testEmptyFolder
                                                .getProperties()
                                                .get(ContentModel.PROP_MODIFIER),
                                        actualParent
                                                .getProperties()
                                                .get(ContentModel.PROP_MODIFIER));
                                return null;
    ...
    private void moveObjectAndAssert(FileInfo object) throws FileNotFoundException {
        FileInfo moved =
                fileFolderService.move(
                        object.getNodeRef(), testEmptyFolder.getNodeRef(), object.getName());
                            ...
                            public Void execute() throws Throwable {
                                FileInfo actualParent =
                                        fileFolderService.getFileInfo(
                                                getAndAssertSingleParent(testFile));
                                assertTrue(
                                        "Modification time difference MUST BE greater or equal than"
                                                + " 1 000 milliseconds!",
    ...
    private void moveObjectAndAssertAbsenceOfPropertiesPreserving(FileInfo object)
        ...
        assertTrue(
                ...
                (moved.getModifiedDate().getTime() - object.getModifiedDate().getTime()) >= 1000);
