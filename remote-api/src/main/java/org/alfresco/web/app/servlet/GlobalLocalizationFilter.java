 ...
 *     <p>Servlet filter responsible for setting a fallback default locale for ALL requests.
 */
        ...
        chain.doFilter(
                ...
                new HttpServletResponseWrapper((HttpServletResponse) response) {
                    ...
                    public void setContentType(String type) {
                        ...
                        // Parse the parameters of the media type, since some app servers
                        // (Websphere) refuse to pay attention if the
