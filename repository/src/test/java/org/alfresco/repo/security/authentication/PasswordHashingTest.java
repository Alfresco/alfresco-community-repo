...
public class PasswordHashingTest {
    ...
    public void testRehashedPassword() throws Exception {
        ...
        assertEquals(
                CompositePasswordEncoder.MD4, properties.get(ContentModel.PROP_HASH_INDICATOR));
        assertTrue(
                "Should now contain the password",
                properties.containsKey(ContentModel.PROP_PASSWORD_HASH));
        assertFalse(
                "Should remove the property", properties.containsKey(ContentModel.PROP_PASSWORD));
        assertFalse(
        ...
        assertTrue("We have the property", properties.containsKey(ContentModel.PROP_PASSWORD));
        assertTrue(
                "We have the property", properties.containsKey(ContentModel.PROP_PASSWORD_SHA256));
        assertFalse("Should be empty", properties.containsKey(ContentModel.PROP_PASSWORD_HASH));
    ...
    public void testGetPasswordHash() throws Exception {
        ...
        properties.put(
                ContentModel.PROP_HASH_INDICATOR, (Serializable) Arrays.asList("myencoding"));
    ...
    private static boolean matches(
            String password, Map<QName, Serializable> properties, CompositePasswordEncoder cpe) {
