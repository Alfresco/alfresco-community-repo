...
public class ContentDiskDriverTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        ApplicationContextFactory fileServers =
                (ApplicationContextFactory) this.applicationContext.getBean("fileServers");
        ...
        authenticationService =
                (MutableAuthenticationService)
                        this.applicationContext.getBean("authenticationService");
        permissionService =
        ...
        fileFolderService =
                (FileFolderService) this.applicationContext.getBean("fileFolderService");
        ...
        RetryingTransactionCallback<Void> removeRootCB =
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef rootNode =
                                nodeService.getChildByName(
                                        companyHome, ContentModel.ASSOC_CONTAINS, TEST_ROOT_PATH);
                        if (rootNode != null) {
    ...
    private DiskSharedDevice getDiskSharedDevice() throws DeviceContextException {
        ...
        ContentContext ctx =
                new ContentContext(
                        "testContext", STORE_NAME, ROOT_PATH, repositoryHelper.getCompanyHome());
    ...
    public void testCreateFile() throws Exception {
        ...
        FileOpenParams params =
                new FileOpenParams(
                        FILE_PATH, openAction, AccessMode.ReadWrite, FileAttribute.NTNormal, 0);
        ...
        RetryingTransactionCallback<Void> writeStuffCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        driver.writeFile(
                                testSession, testConnection, file, stuff, 0, stuff.length, 0);
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef newNode =
                                nodeService.getChildByName(
                                        companyHome, ContentModel.ASSOC_CONTAINS, FILE_NAME);
                        testContext.testNodeRef = newNode;
                        assertNotNull("can't find new node", newNode);
                        Serializable content =
                                nodeService.getProperty(newNode, ContentModel.PROP_CONTENT);
        ...
        FileOpenParams file2Params =
                new FileOpenParams(
                        FILE2_PATH, openAction, AccessMode.ReadOnly, FileAttribute.NTNormal, 0);
    ...
    public void testSetFileInfo() throws Exception {
        ...
        /**
         * Step 1 : Create a new file in read/write mode and add some content. Call SetInfo to set
         * the creation date
         */
        int openAction = FileAction.CreateNotExist;
        ...
        RetryingTransactionCallback<Void> writeStuffCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        FileInfo info =
                                driver.getFileInformation(testSession, testConnection, FILE_PATH);
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertNotNull("content is null", content);
                        Date modified =
                                (Date) nodeService.getProperty(newNode, ContentModel.PROP_MODIFIED);
        ...
        RetryingTransactionCallback<Void> changeCreatedCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateCreatedCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertNotNull("content is null", content);
                        Date created =
                                (Date) nodeService.getProperty(newNode, ContentModel.PROP_CREATED);
        ...
        RetryingTransactionCallback<Void> deleteOnCloseCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateDeleteOnCloseCB =
                new RetryingTransactionCallback<Void>() {
    ...
    public void testOpenFile() throws Exception {
        ...
        FileOpenParams dirParams =
                new FileOpenParams(
                        TEST_ROOT_DOS_PATH, 0, AccessMode.ReadOnly, FileAttribute.NTDirectory, 0);
        driver.createDirectory(testSession, testConnection, dirParams);
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ChildAssociationRef ref =
                                nodeService.createNode(
                                        testContext.testDirNodeRef,
                                        ContentModel.ASSOC_CONTAINS,
                                        QName.createQName(
                                                NamespaceService.CONTENT_MODEL_1_0_URI, FILE_NAME),
                                        ContentModel.TYPE_CONTENT);
                        nodeService.setProperty(
                                ref.getChildRef(), ContentModel.PROP_NAME, FILE_NAME);
                        return null;
                    }
                };
    ...
    public void testRenameFile() throws Exception {
        ...
        FileOpenParams params1 =
                new FileOpenParams(FILE_PATH1, 0, AccessMode.ReadWrite, FileAttribute.NTNormal, 0);
        final NetworkFile file1 = driver.createFile(testSession, testConnection, params1);

        FileOpenParams params3 =
                new FileOpenParams(FILE_PATH3, 0, AccessMode.ReadWrite, FileAttribute.NTNormal, 0);
        ...
        RetryingTransactionCallback<Void> setPropertiesCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        nodeService.setProperty(
                                file1NodeRef, ContentModel.PROP_LASTNAME, LAST_NAME);
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // assertEquals("node ref has changed on a rename", file1NodeRef,
                        // file2NodeRef);
                        assertEquals(
                                nodeService.getProperty(file2NodeRef, ContentModel.PROP_LASTNAME),
                                LAST_NAME);
                        ChildAssociationRef parentRef = nodeService.getPrimaryParent(file2NodeRef);
                        assertTrue(
                                "file has wrong assoc local name",
        ...
        FileOpenParams params5 =
                new FileOpenParams(
                        DIR_NEW_PATH, 0, AccessMode.ReadWrite, FileAttribute.NTNormal, 0);
    ...
    public void testScenarioRenameVersionableFile() throws Exception {
        ...
        RetryingTransactionCallback<Void> makeVersionableCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ContentWriter contentWriter2 =
                                contentService.getWriter(
                                        file1NodeRef, ContentModel.PROP_CONTENT, true);
                        contentWriter2.putContent("test rename versionable");

                        nodeService.setProperty(
                                file1NodeRef, ContentModel.PROP_LASTNAME, LAST_NAME);
                        nodeService.setProperty(
                                file1NodeRef, TransferModel.PROP_ENDPOINT_PROTOCOL, "http");
        ...
        /**
         * Step 1: Successfully rename a versionable file - check the name, props and content. TODO
         * Check primary assoc, peer assocs, child assocs, modified date, created date, nodeid,
         * permissions.
         */
        driver.renameFile(testSession, testConnection, FILE_PATH1, FILE_PATH2);

        RetryingTransactionCallback<Void> validateVersionableCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // assertEquals(nodeService.getProperty(file2NodeRef,
                        // ContentModel.PROP_LASTNAME), LAST_NAME);
                        assertTrue(
                                "does not have versionable aspect",
                                nodeService.hasAspect(
                                        file2NodeRef, ContentModel.ASPECT_VERSIONABLE));
                        assertTrue(
                                "sample property is null",
                                nodeService.getProperty(
                                                file2NodeRef, TransferModel.PROP_ENDPOINT_PROTOCOL)
                                        != null);
     ...
     *
     * <p>a) TEST.DOC b) Save to ~WRDnnnn.TMP c) Delete ~WRLnnnn.TMP d) Rename TEST.DOC ~WDLnnnn.TMP
     * e) Delete TEST.DOC f) Rename ~WRDnnnn.TMP to TEST.DOC g) Delete ~WRLnnnn.TMP
     *
     * <p>We need to check that properties, aspects, primary assocs, secondary assocs, peer assocs,
     * node type, version history, creation date are maintained.
     */
    public void testScenarioMSWord2003SaveShuffle() throws Exception {
        ...
        RetryingTransactionCallback<Void> deleteGarbageFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        FileOpenParams createRootDirParams =
                                new FileOpenParams(
                                        TEST_ROOT_DOS_PATH,
                                        0,
                                        AccessMode.ReadWrite,
                                        FileAttribute.NTNormal,
                                        0);
                        FileOpenParams createDirParams =
                                new FileOpenParams(
                                        TEST_DIR,
                                        0,
                                        AccessMode.ReadWrite,
                        ...
                        FileOpenParams createFileParams =
                                new FileOpenParams(
                                        TEST_DIR + "\\" + FILE_NAME,
                                        0,
                                        AccessMode.ReadWrite,
                                        FileAttribute.NTNormal,
                                        0);
                        testContext.firstFileHandle =
                                driver.createFile(testSession, testConnection, createFileParams);
                        assertNotNull(testContext.firstFileHandle);

                        // now load up the node with lots of other stuff that we will test to see if
                        // it gets preserved during the
                        // shuffle.
                        testContext.testNodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);

                        // test non CM namespace property
                        nodeService.setProperty(
                                testContext.testNodeRef, TransferModel.PROP_ENABLED, true);
                        // test CM property not related to an aspect
                        nodeService.setProperty(
                                testContext.testNodeRef, ContentModel.PROP_ADDRESSEE, "Fred");

                        nodeService.setProperty(
                                testContext.testNodeRef, ContentModel.PROP_TITLE, FILE_TITLE);
                        nodeService.setProperty(
                                testContext.testNodeRef,
                        ...
                        mlAwareNodeService.setProperty(
                                testContext.testNodeRef, RESIDUAL_MTTEXT, mltext);

                        // classifiable chosen since its not related to any properties.
                        nodeService.addAspect(
                                testContext.testNodeRef, ContentModel.ASPECT_CLASSIFIABLE, null);
                        // nodeService.createAssociation(testContext.testNodeRef, targetRef,
                        // assocTypeQName);
        ...
        RetryingTransactionCallback<Void> writeFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        testContext.firstFileHandle.writeFile(
                                testContentBytes, testContentBytes.length, 0, 0);
                        testContext.firstFileHandle.close();

                        testContext.testCreatedDate =
                                nodeService.getProperty(
                                        testContext.testNodeRef, ContentModel.PROP_CREATED);

                        MLText multi =
                                (MLText)
                                        mlAwareNodeService.getProperty(
                                                testContext.testNodeRef, RESIDUAL_MTTEXT);
                        multi.getValues();
        ...
        /** b) Save the new file */
        RetryingTransactionCallback<Void> saveNewFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        byte[] testContentBytes = testContent.getBytes();
                        testContext.newFileHandle.writeFile(
                                testContentBytes, testContentBytes.length, 0, 0);
        ...
        /** rename the old file */
        RetryingTransactionCallback<Void> renameOldFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateOldFileGoneCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        try {
                            driver.deleteFile(
                                    testSession, testConnection, TEST_DIR + "\\" + FILE_NAME);
                        } catch (IOException e) {
        ...
        RetryingTransactionCallback<Void> moveNewFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                "node does not contain shuffled ENABLED property",
                        ...
                        assertEquals(
                                ...
                                FILE_DESCRIPTION,
                                nodeService.getProperty(
                                        shuffledNodeRef, ContentModel.PROP_DESCRIPTION));

                        // ALF-7641 - CIFS shuffle, does not preseve MLText values.
                        Map<QName, Serializable> mlProps =
                                mlAwareNodeService.getProperties(shuffledNodeRef);

                        MLText multi =
                                (MLText)
                                        mlAwareNodeService.getProperty(
                                                shuffledNodeRef, RESIDUAL_MTTEXT);
                        assertTrue("MLText has lost values", multi.getValues().size() > 2);

                        //               // ALF-7635 check auditable properties
                        assertEquals(
                                "creation date not preserved",
                                ((java.util.Date) testContext.testCreatedDate).getTime(),
                                ((java.util.Date)
                                                nodeService.getProperty(
                                                        shuffledNodeRef, ContentModel.PROP_CREATED))
                                        .getTime());

                        // ALF-7628 - preserve addressee and classifiable
                        assertEquals(
                                "ADDRESSEE PROPERTY Not copied",
                                "Fred",
                                nodeService.getProperty(
                                        shuffledNodeRef, ContentModel.PROP_ADDRESSEE));
                        assertTrue(
                                "CLASSIFIABLE aspect not present",
                                nodeService.hasAspect(
                                        shuffledNodeRef, ContentModel.ASPECT_CLASSIFIABLE));
        ...
        /** Clean up just in case garbage is left from a previous run */
        RetryingTransactionCallback<Void> deleteOldFileCB =
                new RetryingTransactionCallback<Void>() {

                    @Override
                    public Void execute() throws Throwable {
                        driver.deleteFile(
                                testSession, testConnection, TEST_DIR + "\\" + FILE_OLD_TEMP);
                        return null;
                    }
                };
    ...
    /**
     * This test tries to simulate the shuffling that is done by MS Word 2003 with backup enabled
     * upon file save
     *
     * <p>a) TEST.DOC b) Save to ~WRDnnnn.TMP c) Delete "Backup of TEST.DOC" d) Rename TEST.DOC to
     * "Backup of TEST.DOC" e) Delete TEST.DOC f) Rename ~WRDnnnn.TMP to TEST.DOC
     *
     * <p>We need to check that properties, aspects, primary assocs, secondary assocs, peer assocs,
     * node type, version history, creation date are maintained.
     */
    public void testScenarioMSWord2003SaveShuffleWithBackup() throws Exception {
        ...
        final String TEST_DIR =
                "\\ContentDiskDriverTest\\testScenarioMSWord2003SaveShuffleWithBackup";
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // assertEquals("created date changed", testContext.testCreatedDate,
                        // (Date)nodeService.getProperty(shuffledNodeRef,
                        // ContentModel.PROP_CREATED));

                        // assertTrue("CLASSIFIABLE aspect not present",
                        // nodeService.hasAspect(shuffledNodeRef,
                        // ContentModel.ASPECT_CLASSIFIABLE));

                        // assertEquals("noderef changed", testContext.testNodeRef,
                        // shuffledNodeRef);
                        return null;
                    }
                };
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done to support MS Word 2007
     *
     * <p>a) TEST.DOCX b) Save new to 00000001.TMP c) Rename TEST.DOCX to 00000002.TMP d) Rename
     * 000000001.TMP to TEST.DOCX e) Delete 000000002.TMP
     */
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // no need to test lots of different properties, that's already been tested
                        // above
                        testContext.testNodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);
                        nodeService.setProperty(
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done to support EMACS
     *
     * <p>a) emacsTest.txt b) Rename original file to emacsTest.txt~ c) Create emacsTest.txt
     */
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done to support vi
     *
     * <p>a) viTest.txt b) Rename original file to viTest.txt~ c) Create viTest.txt d) Delete
     * viTest.txt~
     */
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done to support smultron
     *
     * <p>a) smultronTest.txt b) Save new file to .dat04cd.004 c) Delete smultronTest.txt c) Rename
     * .dat04cd.004 to smultronTest.txt
     */
     ...
     * We check its no longer found by the driver.
     */
    public void testScenarioDeleteViaNodeService() throws Exception {
        ...
        RetryingTransactionCallback<Void> deleteNodeCB =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * This test tries to simulate the shuffling that is done by MS Word 2003 with regard to
     * metadata extraction.
     *
     * <p>1: Setup an inbound rule for ContentMetadataExtractor. 2: Write ContentDiskDriverTest1
     * file to ContentDiskDriver.docx 3: Check metadata extraction for non update test Simulate a
     * WORD 2003 CIFS shuffle 4: Write ContentDiskDriverTest2 file to ~WRD0003.TMP 5: Rename
     * ContentDiskDriver.docx to ~WRL0003.TMP 6: Rename ~WRD0003.TMP to ContentDiskDriver.docx 7:
    ...
    public void testMetadataExtraction() throws Exception {
        ...
        /** Clean up just in case garbage is left from a previous run */
        RetryingTransactionCallback<Void> deleteGarbageDirCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> createRuleCB =
                new RetryingTransactionCallback<Void>() {
        ...
        transactionService
                ...
                .doInTransaction(createRuleCB, false, true);
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(createFileCB, false, true);
                ...
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ClassPathResource fileResource =
                                new ClassPathResource("filesys/ContentDiskDriverTest1.docx");
                        assertNotNull(
                                "unable to find test resource filesys/ContentDiskDriverTest1.docx",
                                fileResource);
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                            public Void execute() throws Throwable {
                                Map<QName, Serializable> props =
                                        nodeService.getProperties(testContext.testNodeRef);

                                assertTrue(
                                        "Enabled property has been lost",
                                        props.containsKey(TransferModel.PROP_ENABLED));

                                ContentData data =
                                        (ContentData) props.get(ContentModel.PROP_CONTENT);
                                ...
                                assertEquals(
                                        ...
                                        nodeService.getProperty(
                                                testContext.testNodeRef, ContentModel.PROP_TITLE));
                                assertEquals(
                                        "author is not correct",
                                        "mrogers",
                                        nodeService.getProperty(
                                                testContext.testNodeRef, ContentModel.PROP_AUTHOR));
        ...
        RetryingTransactionCallback<Void> createUpdateFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(createUpdateFileCB, false, true);

        RetryingTransactionCallback<Void> writeFile2CB =
                new RetryingTransactionCallback<Void>() {

                    @Override
                    public Void execute() throws Throwable {
                        ClassPathResource fileResource =
                                new ClassPathResource("filesys/ContentDiskDriverTest2.docx");
                        assertNotNull(
                                "unable to find test resource filesys/ContentDiskDriverTest2.docx",
                                fileResource);
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(writeFile2CB, false, true);
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(renameOldFileCB, false, true);
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(validateOldFileGoneCB, false, true);

        //        /**
        //         * Check metadata extraction on intermediate new file
        //         */
        //        RetryingTransactionCallback<Void> validateIntermediateCB = new
        // RetryingTransactionCallback<Void>() {
        //
        //            @Override
        //            public Void execute() throws Throwable
        //            {
        //               NodeRef updateNodeRef = driver.getNodeForPath(testConnection, TEST_DIR +
        // "\\" + FILE_NEW_TEMP);
        //
        //               Map<QName, Serializable> props = nodeService.getProperties(updateNodeRef);
        //
        //               // These metadata values should be extracted from file2.
        //               assertEquals("intermediate file description is not correct", "Content Disk
        // Test 2", props.get(ContentModel.PROP_DESCRIPTION));
        //               assertEquals("intermediate file title is not correct", "Updated",
        // props.get(ContentModel.PROP_TITLE));
        //               assertEquals("intermediate file author is not correct", "mrogers",
        // props.get(ContentModel.PROP_AUTHOR));
        //
        //               return null;
        //            }
        //        };
        //
        //
        // transactionService.getRetryingTransactionHelper().doInTransaction(validateIntermediateCB,
        // true, true);
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(moveNewFileCB, false, true);

        logger.debug("validate update has run correctly.");
        RetryingTransactionCallback<Void> validateUpdateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // These metadata values should be extracted from file2.   However they will
                        // not be applied in PRAGMATIC mode.
                        //               assertEquals("description is not correct", "Content Disk
                        // Test 2", props.get(ContentModel.PROP_DESCRIPTION));
                        //               assertEquals("title is not correct", "Updated",
                        // props.get(ContentModel.PROP_TITLE));
        ...
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(validateUpdateCB, true, true);
    } // testScenarioShuffleMetadataExtraction

    /**
     * ALF-12812
     *
     * <p>This test tries to simulate the shuffling that is done by MS Word 2011 for Mac with regard
     * to metadata extraction. In particular the temporary file names are different.
     *
     * <p>1: Setup an update rule for ContentMetadataExtractor. Simulate a WORD 2011 for Mac Create
     * 2: Write "Word Work File D_1725484373.tmp" 3: Close file 4: Rename "Word Work File
     * D_1725484373.tmp" to ContentDiskDriver.docx 5: Check metadata extraction
     */
    public void testMetadataExtractionForMac() throws Exception {
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // shuffle.
                        testContext.testNodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NEW_TEMP);
                        assertNotNull("testContext.testNodeRef is null", testContext.testNodeRef);
                        ...
                        assertTrue(
                                "temporary aspect not applied",
                                nodeService.hasAspect(
                                        testContext.testNodeRef, ContentModel.ASPECT_TEMPORARY));
                        return null;
                    }
                };
        tran.doInTransaction(createFileCB, false, true);
        ...
        logger.debug("Step c: validate metadata has been extracted.");
        /** c: check simple case of meta-data extraction has worked. */
        RetryingTransactionCallback<Void> validateFirstExtractionCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // Check that the temporary aspect has been applied.
                        assertTrue(
                                "temporary aspect has not been removed",
                                !nodeService.hasAspect(
                                        testContext.testNodeRef, ContentModel.ASPECT_TEMPORARY));
                        assertTrue(
                                "hidden aspect has not been removed",
                                !nodeService.hasAspect(
                                        testContext.testNodeRef, ContentModel.ASPECT_HIDDEN));
                        ...
                        assertEquals(
                                ...
                                "This is a test file",
                                nodeService.getProperty(
                                        testContext.testNodeRef, ContentModel.PROP_DESCRIPTION));
                        assertEquals(
                                "title is not correct",
                                "ContentDiskDriverTest",
                                nodeService.getProperty(
    ...
    public void testDirListing() throws Exception {
        ...
        RetryingTransactionCallback<NodeRef> createNodesCB =
                    ...
                    public NodeRef execute() throws Throwable {
                        ...
                        NodeRef hiddenNode =
                                nodeService
                                        ...
                                        .getChildRef();
                        nodeService.setProperty(
                                hiddenNode, ContentModel.PROP_NAME, HIDDEN_FOLDER_NAME);
                        return parentNode;
                    }
                };
        ...
        SearchContext result =
                driver.startSearch(testSession, testConnection, "\\" + FOLDER_NAME + "\\*", 0);
    ...
    public void testFileInformationUpdatingByEditorUserForAlf8808() throws Exception {
        final Holder<org.alfresco.service.cmr.model.FileInfo> editorFolder =
                new Holder<org.alfresco.service.cmr.model.FileInfo>();
        final Holder<org.alfresco.service.cmr.model.FileInfo> testFile =
                new Holder<org.alfresco.service.cmr.model.FileInfo>();

        // Configuring test server with test server configuration and getting test tree connection
        // for test shared device
        ServerConfiguration config =
                new ServerConfiguration(ContentDiskDriverTest.TEST_SERVER_NAME);
        ...
        final ExtendedDiskInterface deviceInterface =
                (ExtendedDiskInterface) treeConnection.getInterface();
        // Creating mock-session
        final SrvSession session =
                new TestSrvSession(
                        13,
                        server,
                        ContentDiskDriverTest.TEST_PROTOTYPE_NAME,
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                try {
                                    ...
                                    // Creating test user to invite him as Editor for test content.
                                    // This user will be created correctly (with person and
                                    ...
                                    editorFolder.value =
                                            getOrCreateNode(
                                                            ...
                                                            ContentModel.TYPE_FOLDER)
                                                    .getFirst();
                                    // Creating test content which will be editable by user created
                                    // above
                                    testFile.value =
                                            getOrCreateNode(
                                                            rootNode,
                                    ...
                                    try {
                                        ...
                                        updatedInfo.setFileId(
                                                DefaultTypeConverter.INSTANCE.intValue(
                                                        testFile.value
                                                                .getProperties()
                                                                .get(ContentModel.PROP_NODE_DBID)));

                                        // Testing ContentDiskDriver.setFileInformation() with test
                                        // user authenticated who has 'Editor' role for test
                                        // content.
                                        // This method should fail if check on 'DELETE' permission
                                        // was not moved to 'DeleteOnClose' context
                                        AuthenticationUtil.runAs(
                                                new RunAsWork<Void>() {
                                                    @Override
                                                    public Void doWork() throws Exception {
                                                        deviceInterface.setFileInformation(
                                                                session,
                                                                treeConnection,
                                                                testFile.value.getName(),
                                                                updatedInfo);
                                                        return null;
                                                    }
                                                },
                                        ...
                                        // Informing about test failure. Expected exception is
                                    ...
                                    // Cleaning all test data and rolling back transaction to revert
                                    // all introduced changes during testing

                                    if (authenticationService.authenticationExists(
                                            ContentDiskDriverTest.TEST_USER_AUTHORITY)) {
     ...
     * @param type - {@link QName} instance which determines type of the object. It may be
     *     cm:content, cm:folder etc (see {@link ContentModel})
     * @return {@link Pair}&lt;{@link org.alfresco.service.cmr.model.FileInfo}, {@link Boolean}>
     *     instance which contains {@link NodeRef} of newly created object and <code>true</code>
     *     value if file object with specified name was not found or {@link NodeRef} of existent
     *     file object and <code>false</code> in other case
     */
    private Pair<org.alfresco.service.cmr.model.FileInfo, Boolean> getOrCreateNode(
            NodeRef parentRef, String name, QName type) {
        ...
        return new Pair<org.alfresco.service.cmr.model.FileInfo, Boolean>(
                fileFolderService.getFileInfo(result), created);
    }

    /**
     * Creates correct user entity with correct user home space, person and authentication with
     * password equal to '<code>password</code>' options if these options are not exist. Method
     * searches for space with name equal to '<code>name</code>' to make it user home space or
     * creates new folder with name equal to '<code>name</code>'. All required permissions and roles
     * will be applied to user home space
     *
     * @param name - {@link String} value which contains new user name
     * @param password - {@link String} value of text password for new user
     * @param parentNodeRef - {@link NodeRef} instance of parent folder where user home space should
     *     be found or created
     */
    private void createUser(String name, String password, NodeRef parentNodeRef) {
        ...
        Pair<org.alfresco.service.cmr.model.FileInfo, Boolean> userHome =
                getOrCreateNode(parentNodeRef, name, ContentModel.TYPE_FOLDER);
        if (userHome.getSecond()) {
            NodeRef nodeRef = userHome.getFirst().getNodeRef();
            permissionService.setPermission(
                    nodeRef, name, permissionService.getAllPermission(), true);
            permissionService.setPermission(
                    nodeRef,
     ...
     *
     * <p>CreateFile 5EE27100 RenameFile oldPath:\Espaces Utilisateurs\System\Cherries.xls,
     * newPath:\Espaces Utilisateurs\System\Cherries.xls~RF172f241.TMP RenameFile oldName=\Espaces
     * Utilisateurs\System\5EE27100, newName=\Espaces Utilisateurs\System\Cherries.xls, session:WNB0
     *
     * <p>Set Delete On Close for Cherries.xls~RF172f241.TMP
     */
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        nodeService.addAspect(
                                testContext.testNodeRef, ContentModel.ASPECT_VERSIONABLE, null);
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // MLText multi = (MLText)mlAwareNodeService.getProperty(shuffledNodeRef,
                        // RESIDUAL_MTTEXT) ;
                        // multi.getValues();
                        ...
                        // ((Date)testContext.testCreatedDate).getTime(),
                        // ((Date)nodeService.getProperty(shuffledNodeRef,
                        // ContentModel.PROP_CREATED)).getTime());
     ...
     *
     * <p>CreateFile Cherries.xlsx CreateFile ~herries.tmp CreateFile Cherries.xlsx~RF172f241.TMP
     * DeleteFile Cherries.xlsx~RF172f241.TMP RenameFile oldName: Cherries.xls, newName:
     * Cherries.xlsx~RF172f241.TMP Delete On Close for Cherries.xlsx~RF172f241.TMP RenameFile
     * oldName: ~herries.tmp, newName: Cherries.xlsx
     */
    public void testExcel2013SaveShuffle() throws Exception {
        ...
        /** Create a file in the test directory */
        RetryingTransactionCallback<Void> createOriginalFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertNotNull(testContext.firstFileHandle);
                        String testContent =
                                "MS Word 2013 shuffle test. This is first file content";
                        byte[] testContentBytes = testContent.getBytes();
                        testContext.firstFileHandle.writeFile(
                                testContentBytes, testContentBytes.length, 0, 0);
                        testContext.firstFileHandle.close();
                        ...
                        nodeService.addAspect(
                                testContext.testNodeRef, ContentModel.ASPECT_VERSIONABLE, null);
                        // need to remove. Otherwise file will be deleted (not placed into archive
                        // spaces store)
                        nodeService.removeAspect(
                                testContext.testNodeRef, ContentModel.ASPECT_NO_CONTENT);
                        // test non CM namespace property
                        nodeService.setProperty(
                                testContext.testNodeRef, TransferModel.PROP_ENABLED, true);
        ...
        /** Create a file in the test directory */
        RetryingTransactionCallback<Void> createUsedTempFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef usedRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_USED_TEMP);
        ...
        /** Create a file in the test directory */
        RetryingTransactionCallback<Void> createUnusedTempFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        FileOpenParams createFileParams =
                                new FileOpenParams(
                                        ...
                                        FileAttribute.NTNormal,
                                        0);
                        NetworkFile unusedFile =
                                driver.createFile(testSession, testConnection, createFileParams);
                        assertNotNull(unusedFile);

                        NodeRef unusedNodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_UNUSED_TEMP);
        ...
        RetryingTransactionCallback<Void> deleteUnusedFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> renameToUnusedFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> renameToUsedFileCB =
                new RetryingTransactionCallback<Void>() {
                ...
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                ...
                                props.containsKey(TransferModel.PROP_ENABLED));
                        assertTrue(
                                "node doesn't contain property 'TITLE'",
                                props.containsKey(ContentModel.PROP_TITLE));
                        assertEquals(
                                "propety 'TITLE' isn't correct",
                                FILE_ORIGINAL_TITLE,
                                props.get(ContentModel.PROP_TITLE));
                        assertEquals(
                                "name wrong",
     ...
     *
     * <p>CreateFile csv.csv and 5EE27101 Add versionable aspect RenameFile oldPath:\Espaces
     * Utilisateurs\System\csv.csv, newPath:\Espaces\Utilisateurs\System\5EE27101 CreateFile
    ...
    public void testCSVExcel2003SaveShuffle() throws Exception {
        ...
        /** Create a file in the test directory */
        RetryingTransactionCallback<Void> createTestFileFirstTime =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> writeToTestFileAndAddVersionableAspect =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        nodeService.addAspect(
                                ...
                                Collections.<QName, Serializable>singletonMap(
        ...
        RetryingTransactionCallback<Void> renameTestFileToTemp =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> createTestFileOneMore =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> writeUpdate =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        FileOpenParams createFileParams =
                                new FileOpenParams(
                                        ...
                                        0);
                        testContext.newFileHandle =
                                driver.openFile(testSession, testConnection, createFileParams);
                        assertNotNull(testContext.newFileHandle);
                        String testContent =
                                "MS Word 2003 for CSV shuffle test This is new content";
                        byte[] testContentBytes = testContent.getBytes();
                        testContext.newFileHandle.writeFile(
                                testContentBytes, testContentBytes.length, 0, 0);
                        testContext.newFileHandle.close();
        ...
        // Check results
        RetryingTransactionCallback<Void> validate =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                "VERSIONABLE aspect not present",
                                nodeService.hasAspect(
                                        shuffledNodeRef, ContentModel.ASPECT_VERSIONABLE));
                        assertEquals("nodeRef changed", testContext.testNodeRef, shuffledNodeRef);
        ...
        /** Clean up just in case garbage is left from a previous run */
        RetryingTransactionCallback<Void> deleteTestFile =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * Simulates a SaveAs from Word2003 1. Create new document SAVEAS.DOC, file did not exist 2.
     * Create -WRDnnnn.TMP file, where 'nnnn' is a 4 digit sequence to make the name unique 3.
     * Rename SAVEAS.DOC to Backup of SAVEAS.wbk 4. Rename -WRDnnnn.TMP to SAVEAS.DOC
     */
    public void testScenarioMSWord2003SaveAsShuffle() throws Exception {
        ...
        /** b) Save the new file Write ContentDiskDriverTest3.doc to the test file, */
        ...
        RetryingTransactionCallback<Void> writeFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ClassPathResource fileResource =
                                new ClassPathResource("filesys/ContentDiskDriverTest3.doc");
                        assertNotNull(
                                "unable to find test resource filesys/ContentDiskDriverTest3.doc",
                                fileResource);
     ...
     *
     * <p>1) open(readOnly) 2) open(readWrite) 3) open(readWrite) - does nothing. 4) close - does
     * nothing 5) close - does nothing 6) close - updates the repo
     */
    public void testScenarioOpenCloseFile() throws Exception {
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        //                assertTrue("file is not closed after close",
                        // dummy.isClosed());
                        return null;
                    }
                };
        ...
        // assertTrue("node does not have no content aspect",
        // nodeService.hasAspect(testContext.targetNodeRef, ContentModel.ASPECT_NO_CONTENT));
        ...
        //        assertFalse("node still has no content aspect",
        // nodeService.hasAspect(testContext.targetNodeRef, ContentModel.ASPECT_NO_CONTENT));
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        Map<QName, Serializable> props =
                                nodeService.getProperties(testContext.targetNodeRef);
                        ContentData data = (ContentData) props.get(ContentModel.PROP_CONTENT);
                        assertNotNull("data is null", data);
                        ...
                        ContentReader reader =
                                contentService.getReader(
                                        testContext.targetNodeRef, ContentModel.PROP_CONTENT);
    ...
    /**
     * Test Open Close File Scenario II ALF-13401 Open Read Only of a file already open for
     * read/write.
     *
     * <p>1) open(readWrite) 2) write some content. 3) open(readOnly). 4) read some content. 5)
     * close - updates the repo
     */
     ...
     *
     * <p>This is done with a CIFS shuffle from word. Basically Word holds the file open with a
     * read/write lock while the shuffle is going on.
     *
     * <p>Create a file. Apply versionable aspect Open the file ReadWrite + OpLocks Close the file
    ...
    public void testOpenCloseVersionableFile() throws Exception {
        ...
        RetryingTransactionCallback<String> readVersionCB =
        ...
        /**
         * Step 1: Open The file Read/Write TODO Check primary assoc, peer assocs, child assocs,
         * modified date, created date, nodeid, permissions.
         */
    ...
    /**
     * Frame maker save a) Lock File Created (X.fm.lck) b) Create new file (X.fm.C29) c) Existing
     * file rename out of the way. (X.backup.fm) d) New file rename into place. (X.fm.C29) e) Old
     * file deleted (open with delete on close) f) Lock file deleted (open with delete on close)
     */
    public void testScenarioFrameMakerShuffle() throws Exception {
        ...
        /** b) Save the new file Write X2.fm to the test file, */
        logger.debug("b) move new file into place");
        RetryingTransactionCallback<Void> writeFileCB =
                new RetryingTransactionCallback<Void>() {
                ...
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef file1NodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);
                        assertTrue(
                                "file has lost versionable aspect",
                                nodeService.hasAspect(
                                        file1NodeRef, ContentModel.ASPECT_VERSIONABLE));
    ...
    /**
     * Test that rules fire on zero byte long files. In this case check that a new file gets the
     * versionable aspect added.
     */
    public void testZeroByteRules() throws Exception {
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        testContext.testZeroNodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME_ZERO);
                        assertNotNull(
                                "testContext.testNodeRef is null", testContext.testZeroNodeRef);

                        /** Create the non zero byte file we are going to use to test */
                        FileOpenParams createFileParams2 =
                                new FileOpenParams(
                                        ...
                                        0);
                        testContext.secondFileHandle =
                                driver.createFile(testSession, testConnection, createFileParams2);
                        assertNotNull(testContext.secondFileHandle);

                        testContext.testNonZeroNodeRef =
                                getNodeForPath(
                                        testConnection, TEST_DIR + "\\" + FILE_NAME_NON_ZERO);
                        assertNotNull(
                                "testContext.testNodeRef is null", testContext.testNonZeroNodeRef);
        ...
        RetryingTransactionCallback<Void> validateFirstExtractionCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        assertTrue(
                                "versionable aspect not applied to non zero file.",
                                nodeService.hasAspect(
                                        testContext.testNonZeroNodeRef,
                                        ContentModel.ASPECT_VERSIONABLE));
                        assertTrue(
                                "versionable aspect not applied to zero byte file.",
                                nodeService.hasAspect(
                                        testContext.testZeroNodeRef,
                                        ContentModel.ASPECT_VERSIONABLE));
                        return null;
    ...
    /**
     * Test that files can be created with empty content and that existing content can be
     * over-wrriten by empty content.
     */
    public void testEmptyContent() throws Exception {
        ...
        RetryingTransactionCallback<Void> checkContentPropsCB =
                new RetryingTransactionCallback<Void>() {

                    @Override
                    public Void execute() throws Throwable {
                        assertNotNull(
                                "content missing create non zero file.",
                                nodeService.getProperty(
                                        testContext.testNonZeroNodeRef, ContentModel.PROP_CONTENT));
                        assertNotNull(
                                "content missing create zero byte file.",
                                nodeService.getProperty(
                                        testContext.testZeroNodeRef, ContentModel.PROP_CONTENT));
                        return null;
                    }
                };
        tran.doInTransaction(checkContentPropsCB, false, true);

        RetryingTransactionCallback<Void> truncateFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        FileOpenParams createFileParams2 =
                                new FileOpenParams(
                                        ...
                                        0);
                        testContext.secondFileHandle =
                                driver.openFile(testSession, testConnection, createFileParams2);
                        assertNotNull(testContext.secondFileHandle);
                        ...
                        driver.truncateFile(
                                testSession, testConnection, testContext.secondFileHandle, 0);
        ...
        /** d: check both files have content properties. */
        RetryingTransactionCallback<Void> checkContentProps2CB =
                new RetryingTransactionCallback<Void>() {
     ...
     *
     * <p>1. Create new document TESTFILE.DOC, file did not exist 2. CheckOut TESTFILE.DOC 3. Create
     * -WRDnnnn.TMP file, where 'nnnn' is a 4 digit sequence to make the name unique 4. Rename
     * TESTFILE(Working Copy).DOC to Backup of SAVEAS.wbk 5. Rename -WRDnnnn.TMP to TESTFILE(Working
     * Copy).DOC 6 CheckIn working copy. 7. Validate TESTFILE.DOC
     */
    public void testScenarioMSWord2003SaveAsShuffleCheckedOutFile() throws Exception {
        ...
        /** Now Check In */
        RetryingTransactionCallback<Void> checkInCB =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * ALF-10686 This scenario is executed by windows explorer.
     *
     * <p>A file is created and the file handle kept open. stuff is written Then the modified date
     * is set Then the file is closed.
     *
     * @throws Exception
     */
    public void testSetFileScenario() throws Exception {
        ...
        RetryingTransactionCallback<Void> closeFileCB =
                new RetryingTransactionCallback<Void>() {

                    @Override
                    public Void execute() throws Throwable {
                        // This close is in a different position to the simple setFileInformation
                        // scenarios above.
                        driver.closeFile(testSession, testConnection, file);
        ...
        // clean up so we could run the test again
        RetryingTransactionCallback<Void> deleteFile =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done from Save from Mac Lion by
     * TextEdit
     *
     * <p>a) Temp file created in temporary folder (test.txt) b) Resource fork file created in
     * temporary folder (._test.txt) b) Target file deleted c) Temp file moved to target file.
     */
    public void testScenarioMacLionTextEdit() throws Exception {
        ...
        final String TEST_TEMP_DIR =
                "\\ContentDiskDriverTest\\testScenarioLionTextEdit\\.Temporary Items";
                    ...
                    public Void execute() throws Throwable {
                        ...
                        FileOpenParams createDirParams =
                                new FileOpenParams(
                                        ...
                                        FileAttribute.NTNormal,
                                        0);
                        FileOpenParams createTempDirParams =
                                new FileOpenParams(
                                        TEST_TEMP_DIR,
                                        0,
                                        AccessMode.ReadWrite,
                        ...
                        FileOpenParams createTempFileParams =
                                new FileOpenParams(
                        ...
                        testContext.tempFileHandle =
                                driver.createFile(
                                        testSession, testConnection, createTempFileParams);
                        ...
                        createFileParams =
                                new FileOpenParams(
                                        TEST_TEMP_DIR + "\\" + FORK_FILE_NAME,
                                        0,
                                        AccessMode.ReadWrite,
                                        FileAttribute.NTNormal,
                                        0);
                        testContext.lockFileHandle =
                                driver.createFile(testSession, testConnection, createFileParams);
        ...
        RetryingTransactionCallback<Void> deleteTargetFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> moveTempFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ContentReader reader =
                                contentService.getReader(
                                        shuffledNodeRef, ContentModel.PROP_CONTENT);
    ...
    /**
     * Simulates a Save from Powerpoint 2011 Mac 0. FileA.pptx already exists. 1. Create new
     * document FileA1.pptx 2. Delete FileA.pptx 3. Rename FileA1.pptx to FileA.pptx
     */
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                "versionable aspect missing",
                                nodeService.hasAspect(
                                        shuffledNodeRef, ContentModel.ASPECT_VERSIONABLE));
                        assertTrue(
                                "hidden aspect still applied",
                                !nodeService.hasAspect(
                                        shuffledNodeRef, ContentModel.ASPECT_HIDDEN));
                        assertTrue(
                                "temporary aspect still applied",
                                !nodeService.hasAspect(
                                        shuffledNodeRef, ContentModel.ASPECT_TEMPORARY));
    ...
    /**
     * Simulates a Save from Excel 2011 Mac 0. FileA.xlsx already exists. 1. Create new document
     * ._A8A09200 2. Delete FileA.xlsx 3. Rename ._A8A09200 to FileA.xlsx
     */
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done to support MS Word 2011 on Mac
     * with backup turned on.
     *
     * <p>a) TEST.DOCX b) Create new temp file in temp dir Word Work File D_.tmp c) Delete backup
     * file. c) Rename TEST.DOCX to Backup of TEST.docx d) Move temp file to target dir d) Rename
     * Word Work File D_.tmp to TEST.docx
     */
    public void testScenarioMSWord20011MacSaveWithBackup() throws Exception {
        ...
        final String TEST_TEMP_DIR =
                "\\ContentDiskDriverTest\\testScenarioMSWord20011MacSaveWithBackup\\.Temporary"
                        + " Items";
        ...
        RetryingTransactionCallback<Void> renameTempFileCB =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * Simulates a Mac Lion Drag and Drop 0. ALF-15158.diff already exists and is versionable 1.
     * Delete ALF-15158.diff 2. Create new document ALF-15158.diff
     */
    public void testMacDragAndDrop() throws Exception {
        ...
        logger.debug("0) create new file");
        RetryingTransactionCallback<TestContext> createFileCB =
                new RetryingTransactionCallback<TestContext>() {
                    @Override
                    public TestContext execute() throws Throwable {
                        ...
                        ctx.file1NodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);
                        nodeService.addAspect(
                                ctx.file1NodeRef, ContentModel.ASPECT_VERSIONABLE, null);
        ...
        RetryingTransactionCallback<Void> restoreFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                "Node ref has changed", shuffledNodeRef, testContext.file1NodeRef);
                        return null;
                    }
                };
    ...
    /**
     * Mountain Lion 2011 Word a) Create new file (Word Work File D2.tmp) (Actually in real life its
     * renamed from a temp directory. c) Existing file rename out of the way. (Word Work File
     * L_5.tmp) d) New file rename into place. (MacWord1.docx) e) Old file deleted
     */
    public void testScenarioMountainLionWord2011() throws Exception {
        ...
        /** b) Save the new file Write ContentDiskDriverTest3.doc, */
        logger.debug("b) move new file into place");
        RetryingTransactionCallback<Void> writeFileCB =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done from Save from Mac Mountain Lion
     * by Preview
     *
     * <p>a) Temp file created in temporary folder (Crysanthemum.jpg) b) Target file deleted by open
     * / delete on close flag / close c) Temp file moved to target file.
     */
    public void testScenarioMacMountainLionPreview() throws Exception {
        ...
        final String TEST_TEMP_DIR =
                "\\ContentDiskDriverTest\\testScenarioMountainLionPreview\\.Temporary Items";
        ...
        //          */
        //         RetryingTransactionCallback<Void> deleteTargetFileCB = new
        // RetryingTransactionCallback<Void>() {
        //
        //             @Override
        //             public Void execute() throws Throwable
        //             {
        //                 FileOpenParams openFileParams = new FileOpenParams(TEST_DIR + "\\" +
        // FILE_NAME, 0, AccessMode.ReadWrite, FileAttribute.NTNormal, 0);
        //                 testContext.tempFileHandle = driver.openFile(testSession, testConnection,
        // openFileParams);
        ...
        //
        //                 driver.setFileInformation(testSession, testConnection, TEST_DIR + "\\" +
        // FILE_NAME, info);
        //
        //                 assertNotNull(testContext.tempFileHandle);
        //                 logger.debug("this close should result in a file being deleted");
        //                 driver.closeFile(testSession, testConnection,
        // testContext.tempFileHandle);
        //                 return null;
        //             }
        //         };
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done from Save from Mac Mountain Lion
     * by Preview when document is saved first time
     *
     * <p>a) Temp file created in temporary folder (temp\image.jpg.sb-1e5e1543-ajn3cR) b) Temp file
     * renamed to original name (temp\image.jpg.sb-1e5e1543-ajn3cR -> temp\image.jpg) c) Original
     * document renamed to backup copy name (test\image.jpg -> test\image.jpg.sb-1e5e1543-ajn3cR) d)
     * Renamed temp file moved to original (temp\image.jpg -> test\image.jpg)
     */
    public void testScenarioMacMountainLionPreview_MNT_263() throws Exception {
        ...
        RetryingTransactionCallback<Void> renameFileCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> moveRenamedTempFileCB =
                new RetryingTransactionCallback<Void>() {
                ...
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                ...
                                contentService
                                        .getReader(shuffledNodeRef, ContentModel.PROP_CONTENT)
                                        .getSize(),
                                UPDATED_TEXT.length());
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done from Save from Mac Mountain Lion
     * by Preview when document is opened/saved few time a row
     *
     * <p>a) Temp file created in temporary folder (temp\image.jpg) b) Original file is renamed for
     * deletion(test\image.jpg -> test\.smbdeleteAAA1b994.4) c) Renamed file has got deleteOnClose
     * flag d) Renamed file is closed. e) Temp file is moved into original file
     * location(temp\image.jpg -> test\image.jgp)
     */
    public void testScenarioMacMountainLionPreview_MNT_317() throws Exception {
                    ...
                    public Void execute() throws Throwable {
                        FileOpenParams openFileParams =
                                new FileOpenParams(
                                        ...
                                        0);
                        testContext.tempFileHandle =
                                driver.openFile(testSession, testConnection, openFileParams);
                        driver.renameFile(
                                testSession,
                                testConnection,
                                TEST_DIR + "\\" + FILE_NAME,
        ...
        //            {
        //
        //                driver.deleteFile(testSession, testConnection, TEST_DIR + "\\" +
        // TEMP_FILE_NAME);
        //                return null;
        //            }
        //        };
    ...
    /**
     * This test tries to simulate the cifs shuffling that is done from Save from Mac Mountain Lion
     * by Keynote when document is saved first time
     *
     * <p>a) Temp file created in temporary folder (temp\test.key) b) Original document renamed to
     * backup copy name (test\test.key -> test\test~.key) c) Temp file moved to original name
     * (temp\test.key -> test\test.key)
     */
    public void testScenarioMacMountainLionKeynote_MNT_8558() throws Exception {
        ...
        final String TEST_TEMP_DIR =
                "\\ContentDiskDriverTest\\testScenarioMountainLionKeynote\\.Temporary Items";
        ...
        // Make sure that during second rename test.key->test~.key deleted test~.key is not restored
        // and version history doesn't lost.
        RetryingTransactionCallback<Void> prepareForSecondRunCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        driver.deleteFile(
                                testSession, testConnection, TEST_DIR + "\\" + BCKP_FILE_NAME);
                        FileOpenParams createTempFileParams =
                                new FileOpenParams(
                                        TEST_TEMP_DIR + "\\" + TEMP_FILE_NAME,
                                        0,
    ...
    /**
     * Gedit has the nasty behaviour of renaming an open file. 1) create file (gedit12345678.txt) 2)
     * create temp file (.goutputStream-IRYDPW) write and flush 3) rename (fails name collision) 4)
     * delete target 5) rename this one succeeds 6) close temp file
     */
    public void testGedit() throws Exception {
        ...
        /** Create the temp file add content leave open */
        RetryingTransactionCallback<Void> createTempFile =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        byte[] testContentBytes = testContent.getBytes();
                        testContext.tempFileHandle.writeFile(
                                testContentBytes, testContentBytes.length, 0, 0);
                        /** driver.closeFile(testSession, testConnection, file); * */
                        return null;
                    }
        ...
        RetryingTransactionCallback<Void> deleteTargetFile =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> closeTempFile =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * Windows7 Explorer update 0) Existing file mark.jpg a) Create new file (~ark.tmp) b) Existing
     * file rename out of the way. (mark.jpg~RF5bb356.TMP) c) New file rename into place. (~ark.tmp
     * - mark.jpg) d) Old file opened attributes only e) set delete on close f) close
     */
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ClassPathResource fileResource =
                                new ClassPathResource("filesys/ContentDiskDriverTestMark.jpg");
                        assertNotNull(
                                "unable to find test resource"
                                        + " filesys/ContentDiskDriverTestMark.jpg",
                                fileResource);
                        writeResourceToNetworkFile(fileResource, testContext.firstFileHandle);
                        driver.closeFile(testSession, testConnection, testContext.firstFileHandle);
                        NodeRef file1NodeRef =
        ...
        RetryingTransactionCallback<Void> writeFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ClassPathResource fileResource =
                                new ClassPathResource("filesys/ContentDiskDriverTestMark2.jpg");
                        assertNotNull(
                                "unable to find test resource"
                                        + " filesys/ContentDiskDriverTestMark2.jpg",
                                fileResource);
                    ...
                    public Void execute() throws Throwable {
                        FileOpenParams openFileParams =
                                new FileOpenParams(
                                        TEST_DIR + "\\" + FILE_OLD_TEMP,
                                        0,
                                        AccessMode.NTReadAttributesOnly,
                                        FileAttribute.NTNormal,
                                        0);
                        testContext.secondFileHandle =
                                driver.openFile(testSession, testConnection, openFileParams);
                        ...
                        info.setFileInformationFlags(FileInfo.SetDeleteOnClose);
                        driver.setFileInformation(
                                testSession, testConnection, TEST_DIR + "\\" + FILE_OLD_TEMP, info);
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                ...
                                nodeService.hasAspect(
                                        shuffledNodeRef, ContentModel.ASPECT_VERSIONABLE));
                        assertEquals(
                                "node ref has changed", shuffledNodeRef, testContext.testNodeRef);
                        ...
                        // assertEquals(false,
                        // props.get(QName.createQName(NamespaceService.EXIF_MODEL_1_0_URI,
                        // "flash")));
    ...
    /** 0. test.txt and ~test.txt exist. 1. Delete test.txt 2. Rename test.txt~ to test.txt */
    public void testNFS() throws Exception {
        ...
        RetryingTransactionCallback<Void> deleteGarbageFileCB2 =
                new RetryingTransactionCallback<Void>() {

                    @Override
                    public Void execute() throws Throwable {
                        driver.deleteFile(
                                testSession, testConnection, TEST_DIR + "\\" + FILE_NAME_TEMP);
                        return null;
                    }
                };
        ...
        logger.debug("0) create new file");
        RetryingTransactionCallback<TestContext> setupCB =
                new RetryingTransactionCallback<TestContext>() {
                    @Override
                    public TestContext execute() throws Throwable {
                        ...
                        /** Create the file we are going to use */
                        {
                            ...
                            ctx.firstFileHandle =
                                    driver.createFile(
                                            testSession, testConnection, createFileParams);
                            assertNotNull(ctx.firstFileHandle);
                            driver.closeFile(testSession, testConnection, ctx.firstFileHandle);
                            ctx.file1NodeRef =
                                    getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);
    ...
    private void doTransactionWorkAsEditor(
            final RunAsWork<Void> work, RetryingTransactionHelper tran) {
        RetryingTransactionCallback<Void> transactionCallback =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        try {
                            AuthenticationUtil.runAs(
                                    work, ContentDiskDriverTest.TEST_USER_AUTHORITY);
                        } catch (Exception e) {
                            // Informing about test failure. Expected exception is
                            // 'AccessDeniedException' or 'PermissionDeniedException'
                            if (e.getCause() instanceof AccessDeniedException
    ...
    /**
     * 0. test.txt exist in folder where user has Editor permissions 1. as Editor create temporary
     * file in temporary directory 2. as Editor rename test.txt to test.txt.sb-1eefba7a-rkC6XE 3. as
     * Editor move temporary file to working directory
     */
    public void testScenarioMacLionTextEditByEditor_ALF_16257() throws Exception {
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        String testContent =
                                "CIFS: Collaborator/editor could not edit file on Mac Os Mountain"
                                        + " Lion";
                        byte[] testContentBytes = testContent.getBytes();
                        testContext.firstFileHandle.writeFile(
                                testContentBytes, testContentBytes.length, 0, 0);
                        ...
                        permissionService.setPermission(
                                getNodeForPath(testConnection, TEST_DIR),
                                ContentDiskDriverTest.TEST_USER_AUTHORITY,
                                PermissionService.EDITOR,
                                true);
                        // Apply full control on temporary directory
                        permissionService.setPermission(
                                getNodeForPath(testConnection, TEST_TEMP_DIR),
        ...
        RunAsWork<Void> saveNewFileCB =
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        NodeRef tempNodeRef =
                                getNodeForPath(
                                        testConnection, TEST_TEMP_DIR + "\\" + FILE_NEW_TEMP);
                        ContentReader reader =
                                contentService.getReader(tempNodeRef, ContentModel.PROP_CONTENT);
                        assertNotNull(reader);
                        String actualContent = reader.getContentString();
                        assertEquals(
                                "new contents were not written to temporary file",
                                UPDATED_TEXT,
                                actualContent);
                        return null;
                    }
        ...
        RunAsWork<Void> renameOldFileCB =
                new RunAsWork<Void>() {
                    @Override
                    public Void doWork() throws Exception {
                        driver.renameFile(
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ContentReader reader =
                                contentService.getReader(
                                        testContext.testNodeRef, ContentModel.PROP_CONTENT);
                        assertNotNull(reader);
                        String actualContent = reader.getContentString();
    ...
    /**
     * 0. MacWord1.docx exist in folder where user has Editor permissions 1. as Editor rename
     * MacWord1.docx to backup Word Work File L_5.tmp 2. as Editor create temporary file in
     * temporary directory and move it to working dir 3. as Editor rename Word Work File D_2.tmp to
     * MacWord1.docx
     */
    public void testScenarioMountainLionWord2011EditByEditor_ALF_16257() throws Exception {
        ...
        final String TEST_TEMP_DIR =
                TEST_DIR + "\\.TemporaryItems"; // need to match with interimPattern
        ...
        /**
         * c) as Editor Save the new file in .TemporaryItems and move it to working directory
         * (should be detected by scenario) Write ContentDiskDriverTest3.doc,
         */
        logger.debug("c) create temp file in temp dir");
        RunAsWork<Void> writeFileCB =
                new RunAsWork<Void>() {
                    @Override
                    public Void doWork() throws Exception {
                        FileOpenParams createFileParams =
    ...
    /**
     * Guess mimetype with sufficient data - originally related to ACE-4523 Simulate creating a
     * plain text document via Alfresco Share then updating it via CIFS/FTP
     *
     * <p>1. create a document called "foo" with just a little data with an explicit (incorrect)
     * mimetype set. 2. update the document with different text 3. check the mimetype of the test
     * doc has changed (since it can be guessed)
     */
    public void testMimetypeWithSufficientData() throws Exception {
        ...
        RetryingTransactionCallback<Void> createFileCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ClassPathResource fileResource =
                                new ClassPathResource("filesys/ContentDiskDriverTestTxt1.txt");
                        // Add the test content via the content writer to simulate being created via
                        // Share.
                        NodeRef file1NodeRef =
                                getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);
                        ContentWriter contentWriter2 =
        ...
        RetryingTransactionCallback<Void> updateFileCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
     ...
     * @throws IOException
     */
    private void writeResourceToNetworkFile(ClassPathResource resource, NetworkFile file)
            throws IOException {
