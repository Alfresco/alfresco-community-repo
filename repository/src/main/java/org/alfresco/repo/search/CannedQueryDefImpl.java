...
public class CannedQueryDefImpl implements CannedQueryDef {
  ...
  private static final org.dom4j.QName QNAME = new org.dom4j.QName(
    "qname",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName LANGUAGE = new org.dom4j.QName(
    "language",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName QUERY = new org.dom4j.QName(
    "query",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  public static CannedQueryDefImpl createCannedQuery(
    Element element,
    ...
    if (element.getQName().getName().equals(ELEMENT_QNAME.getName())) {
      ...
      for (Iterator it = list.iterator(); it.hasNext();/**/) {
        ...
        NamedQueryParameterDefinition nqpd = QueryParameterDefImpl.createParameterDefinition(
          defElement,
          dictionaryService,
          nspr
        );
      ...
      list =
        element.elements(QueryParameterRefImpl.getElementQName().getName());
      for (Iterator it = list.iterator(); it.hasNext();/**/) {
        Element refElement = (Element) it.next();
        NamedQueryParameterDefinition nqpd = QueryParameterRefImpl.createParameterReference(
          refElement,
          dictionaryService,
          container
        );
        ...
        if (resolved == null) {
          throw new AlfrescoRuntimeException(
            "Unable to find refernce parameter : " + nqpd.getQName()
          );
        }
        queryParameterDefs.add(resolved);
      }

      return new CannedQueryDefImpl(
        qName,
        language,
        query,
        queryParameterDefs,
