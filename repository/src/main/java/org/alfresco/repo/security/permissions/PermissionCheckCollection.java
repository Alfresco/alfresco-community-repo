...
/**
 * Interface for collection-based results that describe permission filtering behaviour around
 * cut-off limits.
 *
 * @author Derek Hulley
 * @since 4.0
...
public interface PermissionCheckCollection<T> {
    /**
     * Get the desired number of results. Permission checks can stop once the number of return
     * objects reaches this number.
     *
    ...
    /**
     * Helper 'introduction' to allow simple addition of the {@link PermissionCheckCollection}
    ...
    public static class PermissionCheckCollectionMixin<T> extends DelegatingIntroductionInterceptor
        ...
        private PermissionCheckCollectionMixin(
        ...
        /**
         * Helper method to create a {@link PermissionCheckCollection} from an existing <code>
         * Collection</code>
         *
         ...
         * @param cutOffAfterTimeMs the number of milliseconds to wait before cut-off or zero to use
         *     the system default time-based cut-off.
         * @param cutOffAfterCount the number of permission checks to process before cut-off or zero
         *     to use the system default count-based cut-off.
         * @return a <code>Collection</code> of the same type but including the {@link
         *     PermissionCheckCollection} interface
         */
        ...
        public static final <TT> Collection<TT> create(
            ...
            DelegatingIntroductionInterceptor mixin =
                    new PermissionCheckCollectionMixin<Integer>(
                            targetResultCount, cutOffAfterTimeMs, cutOffAfterCount);
            // Create the advisor
            IntroductionAdvisor advisor =
                    new DefaultIntroductionAdvisor(mixin, PermissionCheckCollection.class);
            // Proxy
