...
public class GetSiteMembershipCoreTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    dataUser
      .usingAdmin()
      .addUserToSite(privateSiteManager, privateSite, UserRole.SiteManager);
    dataUser
      .usingAdmin()
  ...
  public void getSiteMembershipUsingNonExistentPersonId() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "someUser")
      );
  }
  ...
  public void regularUserGetsSiteMembershipForModeratedSiteMember()
    throws Exception {
    restSiteEntry =
      restClient
        .authenticateUser(regularUser)
  ...
  public void getSiteMembershipAfterRemovingASiteMember() throws Exception {
    UserModel publicSiteConsumer = publicSiteUsers.getOneUserWithRole(
      UserRole.SiteConsumer
    );
    restClient
      .authenticateUser(publicSiteManager)
