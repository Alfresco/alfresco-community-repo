 ...
 *
 * <ul>
 *   <li>{@literal <host>:<port>/alfresco/api/<networkId>/public/alfresco/versions/1/queries/people}
 * </ul>
 *
 * @author Alan Davis
 */
...
public class QueriesPeopleApiTest extends AbstractSingleNetworkSiteTest {
    ...
    private static final String[][] userProperties =
            new String[][] {
    ...
    private void createTestUsers()
            throws IllegalArgumentException, SystemException, NotSupportedException,
        ...
        for (String[] properties : userProperties) {
            ...
            if (l > 0) {
                ...
                Person person =
                        new Person(
                                id,
                                null, // Not set to originalUsername, as the returned JSON does not
                                // set it
                                true, // enabled
                ...
                // We call tenantService.getName(nodeRef) to get a fully qualified NodeRef as Solr
                // returns this.
                // They look like:
                //
    ...
    public void testFieldsFirstLast() throws Exception {
        ...
        List<String> expectedPeople =
                Arrays.asList(
                        "Person [lastName=LastA, company=Company [address1=null, address2=null,"
                                + " address3=null, postcode=null, telephone=null, fax=null,"
                                + " email=null], ]", // USER4
                        "Person [firstName=FirstA, lastName=LastA, company=Company [address1=null,"
                                + " address2=null, address3=null, postcode=null, telephone=null,"
                                + " fax=null, email=null], ]", // USER0
                        "Person [firstName=FirstB, lastName=LastA, company=Company [address1=null,"
                                + " address2=null, address3=null, postcode=null, telephone=null,"
                                + " fax=null, email=null], ]" // USER2
                        );
    ...
    public void testFieldsId() throws Exception {
        ...
        List<String> expectedPeople =
                Arrays.asList(
                        "Person [id=user4"
                                + tenantSuffix
                                + ", company=Company [address1=null, address2=null, address3=null,"
                                + " postcode=null, telephone=null, fax=null, email=null],"
                                + " ]", // USER4
                        "Person [id=user0"
                                + tenantSuffix
                                + ", company=Company [address1=null, address2=null, address3=null,"
