...
public abstract class AbstractFieldProcessor<Data> implements FieldProcessor {
    ...
    /**
     * @return a {@link String} key used to identify this {@link FieldProcessor} in a {@link
     *     FieldProcessorRegistry}.
     */
    protected abstract String getRegistryKey();

    /**
     * @return the expected {@link Class} of the <code>data</code> parameter for the method <code>
     *     generateField</code>.
     */
     ...
     */
    protected abstract Field generateTypedField(
            String fieldName, FormCreationData formData, Data typedData);
}
