...
public class LockKeeperImplTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        ChildApplicationContextFactory fileServersSubSystem =
                (ChildApplicationContextFactory) applicationContext.getBean("fileServers");
        assertNotNull("fileServers subsystem is null", fileServersSubSystem);
        lockKeeper =
                (LockKeeper) fileServersSubSystem.getApplicationContext().getBean("lockKeeper");
    ...
    public void testBasicLockUnlock() throws Exception {
        ...
        RetryingTransactionCallback<Boolean> lockCB =
        ...
        RetryingTransactionCallback<Void> refreshCB =
        ...
        RetryingTransactionCallback<Boolean> removeCB =
                new RetryingTransactionCallback<Boolean>() {
                    @Override
                    public Boolean execute() throws Throwable {
                        NodeRef companyHome = repositoryHelper.getCompanyHome();
        ...
        RetryingTransactionCallback<Void> refreshAgainCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
    ...
    public void testBasicLockUnlockSeparateTrans() throws Exception {
        ...
        RetryingTransactionCallback<Void> lockCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> unlockCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertFalse(
                                ...
                                nodeService.hasAspect(
                                        testContext.testNodeRef, ContentModel.ASPECT_LOCKABLE));
