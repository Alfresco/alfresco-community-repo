...
public class GetDownloadsCannedQuery
  ...
  private static final String QUERY_SELECT_GET_DOWNLOADS =
    "select_GetDownloadsBeforeQuery";
  ...
  @Override
  protected List<DownloadEntity> queryAndFilter(
    ...
    List<DownloadEntity> results = cannedQueryDAO.executeQuery(
      QUERY_NAMESPACE,
    ...
    for (DownloadEntity entity : results) {
      ...
      Date modifiedDate = DefaultTypeConverter.INSTANCE.convert(
        Date.class,
