 ...
 *
 * <p>Note that the ID of the association might not be populated.
 *
 * @author Derek Hulley
 */
@AlfrescoPublicApi
public class AssociationRef implements EntityRef, Serializable {
     ...
     *
     * @param sourceRef the source reference - never null
     * @param assocTypeQName the qualified name of the association type - never null
     * @param targetRef the target node reference - never null.
     */
     ...
     * Construct a representation of a source --- name ----> target relationship.
     *
     * @param id unique identifier - may be null
     * @param sourceRef the source reference - never null
     * @param assocTypeQName the qualified name of the association type - never null
     * @param targetRef the target node reference - never null.
     */
    ...
    public AssociationRef(String assocRefStr) {
        ...
        if (tokenizer.countTokens() != 3 && tokenizer.countTokens() != 4) {
            throw new AlfrescoRuntimeException(
                    "Unable to parse association string: " + assocRefStr);
        }
    ...
    /**
     * @return Returns a string of the form
     *     <b>sourceNodeRef|targetNodeRef|assocTypeQName|assocQName</b>
     */
    public String toString() {
        StringBuilder sb = new StringBuilder(180);
        sb.append(id == null ? Long.valueOf(0) : id)
                .append(FILLER)
                .append(sourceRef)
                .append(FILLER)
                .append(targetRef)
     ...
     *
     * @return the unique identifier for this association, or <tt>null</tt> if the ID was not given
    ...
    /**
     * @return Returns the parent node reference, which may be null if this represents the imaginary
