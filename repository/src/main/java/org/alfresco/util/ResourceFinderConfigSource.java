...
/**
 * A Spring {@link ConfigSource} that is powered by a {@link ResourceFinder}. This allows for the loading of resources with wildcards, which {@link UrlConfigSource} does not.
 * 
 * @author Nick Burch
 * @since 4.0.1
 */
