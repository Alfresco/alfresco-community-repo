...
public class ExecutionTests
  ...
  public void testInvokeGet() throws IOException {
    ...
    ResourceWithMetadata baa = locator.locateRelationResource(
      api,
      "sheep",
      "baaahh",
      HttpMethod.GET
    ...
    ResourceWithMetadata cowResource = locator.locateRelationResource(
      api,
      "cow",
      "photo",
      HttpMethod.GET
    ...
    ResourceWithMetadata calf = locator.locateRelationResource(
      api,
      "cow",
      "calf",
      HttpMethod.GET
    ...
    ResourceWithMetadata baaPhoto = locator.locateRelationResource(
      api,
      "sheep/{entityId}/baaahh",
      "photo",
      HttpMethod.GET
    );
    executor.execute(
  ...
  public void testInvokePost() throws IOException {
    ...
    ResourceWithMetadata resource = locator.locateRelationResource(
      api,
      "sheep",
      "blacksheep",
      HttpMethod.POST
    ...
    ResourceWithMetadata grassResource = locator.locateEntityResource(
      api,
      "grass",
      HttpMethod.POST
    );
    ...
    ResourceWithMetadata cowresource = locator.locateEntityResource(
      api,
      "cow",
      HttpMethod.POST
    );
    ...
    ResourceWithMetadata entityResource = locator.locateRelationResource(
      api,
      "grass",
      "grow",
      HttpMethod.POST
    ...
    ResourceWithMetadata calfResource = locator.locateRelationResource(
      api,
      "cow",
      "calf",
      HttpMethod.POST
  ...
  public void testInvokeDelete() throws IOException {
    ...
    cowResource =
      locator.locateRelationResource(api, "cow", "photo", HttpMethod.DELETE);
    result =
      executor.execute(
        cowResource,
        Params.valueOf("4", null, mock(WebScriptRequest.class)),
    ...
    ResourceWithMetadata flockEntityResource = locator.locateRelationResource(
      api3,
      "flock",
      "photo",
      HttpMethod.DELETE
    ...
    ResourceWithMetadata goatDelete = locator.locateRelationResource(
      api3,
      "goat/{entityId}/herd",
      "content",
      HttpMethod.DELETE
  ...
  public void testInvokePut() throws IOException {
    ...
    cowResource =
      locator.locateRelationResource(api, "cow", "photo", HttpMethod.PUT);
    result =
      executor.execute(
        cowResource,
        Params.valueOf(
  ...
  public void testRenderError() throws IOException {
    ...
    ErrorResponse defaultError = new DefaultExceptionResolver()
      .resolveException(new NullPointerException());
    ...
    assertTrue(
      errorMessage.contains("\"errorKey\":\"framework.exception.ApiDefault\"")
    );
    ...
    ErrorResponse anError = simpleMappingExceptionResolver.resolveException(
      new ApiException("nothing")
    );
    ...
    assertFalse(
      "Only 500 errors should have a logId",
      errorMessage.contains("\"logId\":\" \"")
    );
  }
  ...
  private WebScriptResponse mockResponse(
