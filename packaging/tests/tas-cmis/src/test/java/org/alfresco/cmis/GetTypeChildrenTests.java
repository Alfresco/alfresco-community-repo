...
public class GetTypeChildrenTests extends CmisTest
{
    ...
    /**
     * Get type children for a valid type id and includePropertyDefinitions set to false (verify that Map<String, PropertyDefinition<?>> is empty)
     */
    ...
    /**
     * Get type children for a valid type id and includePropertyDefinitions set to true (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @TestRail(section = {"cmis-api"}, executionType = ExecutionType.SANITY,
    ...
    /**
     * Get invalid type children for a valid type id and includePropertyDefinitions set to true (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    ...
    /**
     * Get valid type children for a invalid type id and includePropertyDefinitions set to true (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @TestRail(section = {"cmis-api"}, executionType = ExecutionType.REGRESSION,
