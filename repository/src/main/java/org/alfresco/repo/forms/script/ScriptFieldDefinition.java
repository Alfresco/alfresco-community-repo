...
/**
 * FieldDefinition JavaScript Object. This object acts as a wrapper for the Java object {@link
 * org.alfresco.repo.forms.FieldDefinition} and all of its subclasses also.
 *
...
public class ScriptFieldDefinition extends ScriptableObject {
    ...
    /**
     * This method retrieves a named property value in the normal (Mozilla JS) way. If the named
     * property is not found, an attempt is made to discover a Java accessor method appropriate to
     * the named property e.g. getFoo() or isFoo() for a property named 'foo'. If such an accessor
     * method is found, it is invoked and the value is returned. (If there are both a getFoo() and
     * an isFoo() method, then the getFoo() method is invoked.)
     *
