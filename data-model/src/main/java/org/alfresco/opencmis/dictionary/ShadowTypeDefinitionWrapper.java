...
public abstract class ShadowTypeDefinitionWrapper extends AbstractTypeDefinitionWrapper {
    ...
    public List<TypeDefinitionWrapper> connectParentAndSubTypes(
        ...
        if (parentTypeId != null) {
            ...
            if (registry.getTenant() != null
                    && parent != null
                    && registry.getTypeDefByTypeId(parentTypeId, false) == null) {
                // this is a tenant registry and the parent is not defined locally so add this type
                // as a child of it
        ...
        //        if(parent != null)
        //        {
        //            List<TypeDefinitionWrapper> children = new
        // LinkedList<TypeDefinitionWrapper>();
        //            children.add(this);
        ...
        Collection<QName> childrenNames =
                dictionaryService.getSubTypes(
