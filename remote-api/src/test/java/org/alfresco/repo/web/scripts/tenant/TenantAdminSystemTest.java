...
public class TenantAdminSystemTest extends TestCase {
    ...
    private static String callInOutWebScript(
            String urlString, String method, String ticket, String data)
            throws MalformedURLException, URISyntaxException, IOException {
    ...
    protected static String callLoginWebScript(String serviceUrl, String username, String password)
        ...
        String ticketResult =
                callGetWebScript(serviceUrl + "/api/login?u=" + username + "&pw=" + password, null);
            ...
            try {
                ...
                for (int i = startId; i <= endId; i++) {
                    ...
                    switch (op) {
                        case CREATE_TENANT:
                            String ticket =
                                    callLoginWebScript(WEBSCRIPT_ENDPOINT, ADMIN_USER, ADMIN_PW);
