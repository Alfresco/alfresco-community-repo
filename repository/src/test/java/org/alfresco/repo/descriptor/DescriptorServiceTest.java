...
public class DescriptorServiceTest extends BaseSpringTest {
  ...
  public void before() throws Exception {
    ...
    systemBootstrap =
      (ImporterBootstrap) applicationContext.getBean("systemBootstrap");
  ...
  public void testServerDescriptor() {
    ...
    assertTrue(
      "Server schema version must be greater than 0",
      schemaVersion > 0
    );
  ...
  public void testCurrentRepositoryDescriptor() {
    ...
    assertTrue(
      "Repository schema version must be greater than -1",
      schemaVersion > -1
    );
  }
  ...
  public void testReadOnlyLicenseLoad_ALF10110() throws Exception {
    ...
    TransactionServiceImpl txnService = (TransactionServiceImpl) applicationContext.getBean(
      "TransactionService"
    );
    ServiceRegistry registry = (ServiceRegistry) applicationContext.getBean(
      ServiceRegistry.SERVICE_REGISTRY
