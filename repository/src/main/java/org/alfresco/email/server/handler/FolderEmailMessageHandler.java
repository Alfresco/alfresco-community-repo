...
public class FolderEmailMessageHandler extends AbstractEmailMessageHandler {
  ...
  private static final String MSG_RECEIVED_BY_SMTP =
    "email.server.msg.received_by_smtp";
  private static final String MSG_DEFAULT_SUBJECT =
    "email.server.msg.default_subject";
  private static final String ERR_MAIL_READ_ERROR =
    "email.server.err.mail_read_error";

  private static final Log log = LogFactory.getLog(
    FolderEmailMessageHandler.class
  );
   ...
   */
  public void addAlfrescoContent(NodeRef spaceNodeRef, EmailMessage message)
    throws IOException {
  ...
  private void addTitledAspect(NodeRef nodeRef, String title, String from) {
    ...
    titledProps.put(
      ...
      I18NUtil.getMessage(MSG_RECEIVED_BY_SMTP, from)
    );
    getNodeService()
      .addAspect(nodeRef, ContentModel.ASPECT_TITLED, titledProps);
