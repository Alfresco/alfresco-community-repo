...
public class VirtualProtocol extends Protocol {
  ...
  public String getTemplatePath(Reference reference) {
    StringParameter parameter = (StringParameter) getParameter(
      reference,
  ...
  public RepositoryLocation getActualNodeLocation(Reference reference) {
    ResourceParameter parameter = (ResourceParameter) getParameter(
      reference,
    ...
    if (systemToken == NODE_TEMPLATE_PATH_TOKEN) {
      templateResource =
        new RepositoryResource(
          new RepositoryPath(templateSysPath.substring(1))
        );
