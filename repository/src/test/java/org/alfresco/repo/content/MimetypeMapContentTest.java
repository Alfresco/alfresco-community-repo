...
public class MimetypeMapContentTest extends TestCase {
    ...
    public void testGuessMimetypeForFile() throws Exception {
        ...
        assertEquals(
                ...
                mimetypeService.guessMimetype(
                        "concept.dita", openQuickTestFile("quickConcept.dita")));

        // Commented out when the test class was reintroduced after many years of not being run.
        // Failed as the type was
        ...
        //        assertEquals(
        //              "application/acp",
        //              mimetypeService.guessMimetype("something.acp",
        // openQuickTestFile("quick.acp"))
        //        );
        ...
        assertEquals(
                "application/x-tika-msoffice", mimetypeService.guessMimetype(null, truncReader));
        // Commented out when the test class was reintroduced after many years of not being run.
        // Failed to open a
        // stream onto the channel. Reintroduced to check guessMimetype works without pdfbox
        // libraries.
        //
        ...
        assertEquals(
                "message/rfc822",
                mimetypeService.guessMimetype(
                        "something.eml", openQuickTestFile("quickLotus.eml")));
    }
