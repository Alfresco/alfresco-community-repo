...
public class AsynchronousExtractorTest extends BaseSpringTest {
  ...
  private class TestAsynchronousExtractor extends AsynchronousExtractor {
    ...
    protected Map<String, Serializable> mapSystemToRaw(
      ...
      Map<QName, Serializable> metadataWithCollection = new HashMap<>(
        systemMetadata
      );
    ...
    private void mockTransform(
      ...
      transformOptionsPassedToTEngine =
        renditionDefinition.getTransformOptions();
      try {
      ...
      int transformContentHashCode = changedHashcode == null
        ? sourceContentHashCode
        : changedHashcode;
      if (mockResult != null) {
        try (
          InputStream transformInputStream = getClass()
            .getClassLoader()
            .getResourceAsStream(mockResult)
        ) {
          ...
          throw new RuntimeException(
            "Could not read '" + mockResult + "' from the classpath.",
            e
          );
        }
      } else {
  ...
  private class MockCategoryService extends NoIndexCategoryServiceImpl {
    ...
    MockCategoryService(
      ...
      NodeRef catContainer = nodeService
        .createNode(
          rootNodeRef,
    ...
    @Override
    protected Set<NodeRef> getClassificationNodes(
      StoreRef storeRef,
      QName qname
    ) {
  ...
  public void before() throws Exception {
    ...
    mimetypeService =
      (MimetypeService) applicationContext.getBean("mimetypeService");
    namespacePrefixResolver =
      (NamespacePrefixResolver) applicationContext.getBean("namespaceService");
    transformerDebug =
      (TransformerDebug) applicationContext.getBean("transformerDebug");
    renditionService2 =
      (RenditionService2Impl) applicationContext.getBean("renditionService2");
    transactionService =
      (TransactionService) applicationContext.getBean("transactionService");
    transformServiceRegistry =
      (TransformServiceRegistry) applicationContext.getBean(
        "transformServiceRegistry"
      );
    renditionDefinitionRegistry2 =
      (RenditionDefinitionRegistry2Impl) applicationContext.getBean(
        "renditionDefinitionRegistry2"
      );
    taggingService =
      (TaggingServiceImpl) applicationContext.getBean("taggingService");
    transformClient =
      (TransformClient) applicationContext.getBean("transformClient");
    asynchronousExtractor =
      (AsynchronousExtractor) applicationContext.getBean(
        "extractor.Asynchronous"
      );
    categoryService =
    ...
    contentMetadataEmbedder.setMetadataExtracterRegistry(
      metadataExtracterRegistry
    );
      ...
      .doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            ContentWriter cw = contentService.getWriter(
              nodeRef,
  ...
  private void assertAsyncMetadataExecute(
    ...
    TestAsynchronousExtractor extractor = new TestAsynchronousExtractor(
      mockResult,
      changedHashcode,
      policy
    );
  ...
  private void executeAction(
    ActionExecuterAbstractBase extractor,
    TestAsynchronousExtractor asynchronousExtractor
  )
    ...
    ActionImpl action = new ActionImpl(
      null,
      ID,
      SetPropertyValueActionExecuter.NAME,
      null
    );
  ...
  void assertContentSize(NodeRef nodeRef, long expectSize, String state) {
    ...
    if (expectSize == origSize) {
      assertEquals(
        "The content should remain unchanged " + state,
        origSize,
        size
      );
    } else {
      assertEquals(
        "The content should have changed " + state,
        expectSize,
        size
      );
    }
  ...
  private void assertProperties(
    ...
    List<QName> ignoreKeys = new ArrayList<>(
      asList(
        PROP_MODIFIED,
        PROP_MODIFIER,
        PROP_CONTENT,
  ...
  public void testExtractMsg() throws Exception { // has dates as RFC822
    ...
    expectedProperties.put(
      ...
      SIMPLE_DATE_FORMAT.parse("Fri Jan 18 13:44:20 GMT 2013")
    ); // 2013-01-18T13:44:20Z
    expectedProperties.put(
    ...
    Serializable sentDate = properties.get(
      QName.createQName("cm:sentdate", namespacePrefixResolver)
    );
  }
  ...
  public void testEmbed() throws Exception {
    ...
    assertTrue(
      "There should have 3 elements: " + collection,
      collection.split(",").length == 3
    );
  ...
  public void testOverwritePolicyPrudent() throws Exception {
    QName author = QName.createQName("cm:author", namespacePrefixResolver);
    QName title = QName.createQName("cm:title", namespacePrefixResolver);
    QName description = QName.createQName(
      "cm:description",
      namespacePrefixResolver
    );
  ...
  public void testCarryAspectFalse() throws Exception {
    ...
    transactionService
      ...
      .doInTransaction(() -> {
        ...
        assertFalse(
          "Title should be removed from properties because the extracted value is null",
  ...
  public void testCarryAspectTrue() throws Exception {
    ...
    transactionService
      ...
      .doInTransaction(() -> {
        ...
        assertTrue(
          "Title should NOT be removed from properties because carryAspectProperties is true",
          properties.containsKey(title)
        );
        return null;
      });
  ...
  public void testExtractTagging() throws Exception {
    ...
    List<String> actualTags = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(() -> {
        Map<QName, Serializable> properties = nodeService.getProperties(
          nodeRef
  ...
  public void testExtractTaggingWhenDisabled() throws Exception {
    ...
    List<String> tags = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(() -> {
        Map<QName, Serializable> properties = nodeService.getProperties(
          nodeRef
  ...
  public void testStaticMethods() {
    assertTrue(
      ...
      AsynchronousExtractor.isMetadataExtractMimetype(
