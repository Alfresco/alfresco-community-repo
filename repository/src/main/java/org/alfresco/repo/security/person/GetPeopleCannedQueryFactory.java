...
public class GetPeopleCannedQueryFactory
  ...
  public CannedQuery<NodeRef> getCannedQuery(CannedQueryParameters parameters) {
    return (CannedQuery<NodeRef>) new GetPeopleCannedQuery(
      nodeDAO,
      qnameDAO,
      cannedQueryDAO,
      tenantService,
  ...
  public CannedQuery<NodeRef> getCannedQuery(
    ...
    GetPeopleCannedQueryParams paramBean = new GetPeopleCannedQueryParams(
    ...
    if (sortProps != null) {
      ...
      for (Pair<QName, Boolean> sortProp : sortProps) {
        boolean sortAsc =
          ((sortProp.getSecond() == null) || sortProp.getSecond());
        sortPairs.add(
