...
public class RemoteAlfrescoTicketServiceTest extends BaseWebScriptTest {
  ...
  private static final String INVALID_REMOTE_SYSTEM_ID =
    "testingInvalidRemoteSystem";
  ...
  protected void setUp() throws Exception {
    ...
    this.remoteAlfrescoTicketService =
      (RemoteAlfrescoTicketService) getServer()
        .getApplicationContext()
        .getBean("remoteAlfrescoTicketService");
    this.remoteCredentialsService =
      (RemoteCredentialsService) getServer()
        .getApplicationContext()
        .getBean("RemoteCredentialsService");
    this.ticketsCache =
      (SimpleCache<String, String>) getServer()
        .getApplicationContext()
    ...
    (
      (RemoteAlfrescoTicketServiceImpl) remoteAlfrescoTicketService
    ).setRemoteConnectorService(new LocalWebScriptConnectorServiceImpl(this));

    // Ensure the invalid one isn't registered
    remoteAlfrescoTicketService.registerRemoteSystem(
      INVALID_REMOTE_SYSTEM_ID,
      null,
      null
    );
  ...
  public void testGetStoreGetCredentials() throws Exception {
    ...
    try {
      remoteAlfrescoTicketService.getRemoteCredentials(
        INVALID_REMOTE_SYSTEM_ID
      );
      fail("Shouldn't work for an invalid system");
    } catch (NoSuchSystemException e) {}
    try {
      remoteAlfrescoTicketService.storeRemoteCredentials(
        INVALID_REMOTE_SYSTEM_ID,
        null,
        null
      );
    ...
    BaseCredentialsInfo credentials = remoteAlfrescoTicketService.getRemoteCredentials(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    boolean deleted = remoteAlfrescoTicketService.deleteRemoteCredentials(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    deleted =
      remoteAlfrescoTicketService.deleteRemoteCredentials(
        TEST_REMOTE_SYSTEM_ID
      );
  ...
  public void testGetTicket() throws Exception {
    ...
    try {
      remoteAlfrescoTicketService.refetchAlfrescoTicket(
        INVALID_REMOTE_SYSTEM_ID
      );
      fail("Shouldn't work for an invalid system");
    } catch (NoSuchSystemException e) {}
    ...
    RemoteAlfrescoTicketInfo ticket = remoteAlfrescoTicketService.getAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    RemoteAlfrescoTicketInfo ticket2 = remoteAlfrescoTicketService.getAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    RemoteAlfrescoTicketInfo ticket3 = remoteAlfrescoTicketService.refetchAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    RemoteAlfrescoTicketInfo ticket4 = remoteAlfrescoTicketService.getAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    RemoteAlfrescoTicketInfo ticket5 = remoteAlfrescoTicketService.getAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    PasswordCredentialsInfoImpl creds = (PasswordCredentialsInfoImpl) remoteCredentialsService.getPersonCredentials(
      TEST_REMOTE_SYSTEM_ID
    );
    assertNotNull(creds);
    ...
    RemoteAlfrescoTicketInfo ticket6 = remoteAlfrescoTicketService.getAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    creds =
      (PasswordCredentialsInfoImpl) remoteCredentialsService.getPersonCredentials(
        TEST_REMOTE_SYSTEM_ID
      );
    ...
    RemoteAlfrescoTicketInfo ticket7 = remoteAlfrescoTicketService.getAlfrescoTicket(
      TEST_REMOTE_SYSTEM_ID
    );
    ...
    retryingTransactionHelper.doInTransaction(
      ...
      false,
      true
    ); // after MNT-13871, POST api/login webscript now requires read-write transaction
