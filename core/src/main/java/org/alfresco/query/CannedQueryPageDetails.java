 ...
 * <p/>
 * Results are {@link #skipResults skipped}, chopped into pages of {@link #pageSize appropriate size} before the {@link #pageCount start page} and {@link #pageNumber number} are returned.
 * 
 * @author Derek Hulley
 * @since 4.0
 */
public class CannedQueryPageDetails
{
     ...
     * 
     * @param skipResults
     *            results to skip before <i>page one</i> (default <b>{@link #DEFAULT_SKIP_RESULTS}</b>)
     * @param pageSize
     *            the size of each page (default <b>{@link #DEFAULT_PAGE_SIZE}</b>)
     */
     ...
     *            the size of each page (default <b>{@link #DEFAULT_PAGE_SIZE}</b>)
     * @param pageNumber
     *            the first page number to return (default <b>{@link #DEFAULT_PAGE_NUMBER}</b>)
     * @param pageCount
     *            the number of pages to return (default <b>{@link #DEFAULT_PAGE_COUNT}</b>)
     */
