 ...
 *
 * <p>TODO: Support for other non attribute features such as parents and path
 *
 * @author andyh
 */
@AlfrescoPublicApi
public interface ResultSetRow {
    /**
     * Get the values of all available node properties. These are only properties that were stored
     * in the query results and can vary depending on the query language that was used.
     *
    ...
    /**
     * @return Returns the name of the child association leading down to the node represented by
     *     this row
     */
    public QName getQName();

    /**
     * Get the index of this result set in the result set If you want the overall position in paged
     * reults you have to add the skipCount fo the result set.
     *
     * @return int
     */
    public int getIndex();
