...
public interface Parameters {
    ...
    /**
     * Gets a single request query parameter passed in by the user. Currently doesn't support
     * multiple values.
     *
    ...
    /**
     * Gets a single request parameter passed in by the user. Attempts to convert the parameter to
     * the specified type. If unable to convert the parameter to the specified type then throws an
     * InvalidArgumentException. Currently doesn't support multiple values.
     *
     * @param parameterName String
    ...
    /**
     * Returns a representation of the Paging of collections of resources, with skip count and max
     * items. See {@link Paging} Specified by the "skipCount" and "maxItems" request parameters.
     *
    ...
    /**
     * Returns a List of {@link SortColumn} for sorting properties. Specified by the "orderBy"
     * request parameter.
     *
    ...
    /**
     * Returns a {@link BeanPropertiesFilter} for filtering out properties. Specified by the
     ...
     *
     * @param propertyName the property Specified as part of the url request.
    ...
    /**
     * Indicates if the source entity should be includes in the request. This will normally be done
     * by the framework but implentations may prefer to do it themselves.
     *
    ...
    /**
     * A list of property names passed in the request using the json pointer syntax Specified by the
