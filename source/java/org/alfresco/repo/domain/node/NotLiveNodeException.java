...
/* package */ class NotLiveNodeException extends ConcurrencyFailureException
{
    ...
    private final Pair<Long, Node> nodePair;
    
    public NotLiveNodeException(Pair<Long, Node> nodePair)
    {
    ...
    {
        return new Pair<Long,NodeRef>(nodePair.getFirst(), nodePair.getSecond().getNodeRef());
    }
}
