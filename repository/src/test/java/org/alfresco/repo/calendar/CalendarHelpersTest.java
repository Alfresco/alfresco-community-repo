...
/**
 * Test cases for the helpers relating to the {@link CalendarService}, but which don't need a full
 * repo
 *
 * @author Nick Burch
 * @since 4.0
...
public class CalendarHelpersTest {
    private static final long ONE_HOUR_MS = 1 * 60 * 60 * 1000L;
    private static final long TWO_DAYS_MS = 2 * 24 * ONE_HOUR_MS;
    ...
    public void dailyRecurrenceDates() {
        ...
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 10), date(2011, 7, 15), true, 1);
        assertEquals(0, dates.size());

        dates.clear();
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 10), date(2011, 7, 15), false, 1);
        assertEquals(0, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 19), date(2011, 7, 25), true, 1);
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 19), date(2011, 7, 25), false, 1);
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 20), date(2011, 7, 30), true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 20), date(2011, 7, 30), false, 1);
        ...
        RecurrenceHelper.buildDailyRecurrences(
                ...
                dates,
                null,
                date(2011, 11, 22, 12, 30),
                date(2011, 11, 27, 12, 30),
                false,
                1);
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 19), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-19", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildDailyRecurrences(
                currentDate, dates, null, date(2011, 7, 20), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-20", dateFmt.format(dates.get(0)));
        ...
        assertEquals(
                "2011-07-19",
                dateFmt.format(dates.get(0))); // This event starts before 2011-7-20, but it ends on
        // 2001-07-21
    }
    ...
    public void weeklyRecurrenceDates() {
        ...
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 10), date(2011, 7, 15), true, 1);
        assertEquals(0, dates.size());

        dates.clear();
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 10), date(2011, 7, 15), false, 1);
        assertEquals(0, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 17), date(2011, 7, 26), true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 19), date(2011, 7, 26), false, 1);
        assertEquals(2, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 19), date(2011, 7, 26), true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-21", dateFmt.format(dates.get(0))); // Thursday
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 7, 30), true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-21", dateFmt.format(dates.get(0))); // Thu
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 7, 30), false, 1);
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 8, 30), true, 3);
        assertEquals(1, dates.size());
        assertEquals("2011-07-21", dateFmt.format(dates.get(0))); // Thu
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 8, 30), false, 3);
        assertEquals(4, dates.size());
        assertEquals("2011-07-21", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 19), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-21", dateFmt.format(dates.get(0))); // Thu
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, dates, params, date(2011, 7, 22), null, true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildWeeklyRecurrences(
                currentDate, TWO_DAYS_MS, dates, params, date(2011, 7, 22), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals(
                "2011-07-21",
                dateFmt.format(dates.get(0))); // This event starts before 2011-7-22, but it ends on
        // 2001-07-23
    }
    ...
    public void monthlyRecurrenceByDateInMonth() {
        ...
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 1), date(2011, 7, 26), true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 1, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 1), date(2011, 7, 26), false, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-02", dateFmt.format(dates.get(0)));
        ...
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 2), date(2011, 7, 26), true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-02", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2011, 7 - 1, 2, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 2), date(2011, 7, 26), false, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-02", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 9, 20), true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 9, 20), false, 1);
        assertEquals(2, dates.size());
        assertEquals("2011-08-02", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 20), date(2011, 9, 20), false, 2);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 2, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 1), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals("2011-07-02", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, TWO_DAYS_MS, dates, params, date(2011, 8, 3), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals(
                "2011-08-02",
    ...
    public void reccurenceByLastDay() {
        ...
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2012, 7, 1), date(2012, 9, 30), false, 1);
        assertEquals(3, dates.size());
        ...
        currentDate.set(2012, 7 - 1, 15, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, TWO_DAYS_MS, dates, params, date(2012, 7, 31), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals(
                "2012-07-30",
                dateFmt.format(dates.get(0))); // This event starts before 2012-7-31, but it ends on
        // 2012-08-01
        ...
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 7, 1), date(2015, 10, 1), false, 1);
        assertEquals(4, dates.size());
        assertEquals("2012-07-30", dateFmt.format(dates.get(0)));
    ...
    public void monthlyRecurrenceByDayOfWeek() {
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 19), date(2012, 1, 5), false, 1);
        assertEquals(6, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, TWO_DAYS_MS, dates, params, date(2011, 8, 2), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals(
                "2011-08-01",
                dateFmt.format(dates.get(0))); // This event starts before 2011-8-02, but it ends on
        // 2001-08-03
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 19), date(2012, 1, 25), false, 1);
        assertEquals(6, dates.size());
        ...
        currentDate.set(2011, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 19), date(2012, 1, 25), false, 3);
        assertEquals(2, dates.size());
        ...
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 14), date(2012, 1, 25), false, 1);
        ...
        currentDate.set(2011, 7 - 1, 14, 10, 30);
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, date(2011, 7, 14), date(2012, 1, 25), false, 3);
        assertEquals(3, dates.size());
        assertEquals("2011-07-15", dateFmt.format(dates.get(0)));
    ...
    public void monthlyRecurrenceByFirstDayOfEveryFirstMonth() {
        ...
        RecurrenceHelper.buildMonthlyRecurrences(
                currentDate, dates, params, onOrAfter, until, false, interval);
        assertEquals(3, dates.size());
    ...
    public void yearlyRecurrenceByDateInMonth() {
        ...
        Map<String, String> paramsFIXED =
                RecurrenceHelper.fixOutlookRecurrenceQuirks(paramsOUTLOOK);
        assertEquals("YEARLY", paramsFIXED.get("FREQ"));
        ...
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 10), date(2012, 2, 15), true, 1);
        assertEquals(0, dates.size());

        dates.clear();
        currentDate.set(2012, 1 - 1, 19, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 10), date(2012, 2, 15), false, 1);
        assertEquals(0, dates.size());
        ...
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 1), date(2012, 2, 26), true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2012, 2 - 1, 1, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 1), date(2012, 2, 26), false, 1);
        assertEquals(1, dates.size());
        assertEquals("2012-02-21", dateFmt.format(dates.get(0)));
        ...
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 3, 1), date(2012, 3, 26), true, 1);
        assertEquals(0, dates.size());

        dates.clear();
        currentDate.set(2012, 3 - 1, 1, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 3, 1), date(2012, 3, 26), false, 1);
        assertEquals(0, dates.size());
        ...
        currentDate.set(2012, 2 - 1, 1, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 1), date(2013, 3, 26), true, 1);
        assertEquals(1, dates.size());
        assertEquals("2012-02-21", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2012, 2 - 1, 1, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 1), date(2013, 3, 26), false, 1);
        assertEquals(2, dates.size());
        assertEquals("2012-02-21", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2012, 3 - 1, 1, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 3, 1), date(2013, 2, 26), true, 1);
        assertEquals(1, dates.size());
        ...
        currentDate.set(2012, 3 - 1, 1, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 3, 1), date(2013, 3, 26), false, 1);
        assertEquals(1, dates.size());
        assertEquals("2013-02-21", dateFmt.format(dates.get(0)));
        ...
        currentDate.set(2012, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, TWO_DAYS_MS, dates, params, date(2013, 2, 22), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals(
                "2013-02-21",
                dateFmt.format(dates.get(0))); // This event starts before 2013-2-22, but it ends on
        // 2013-02-23
    }
    ...
    public void yearlyRecurrenceByDayOfWeekInMonth() {
        ...
        currentDate.set(2012, 1 - 1, 19, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 4), date(2012, 2, 5), true, 1);
        assertEquals(0, dates.size());

        dates.clear();
        currentDate.set(2012, 1 - 1, 19, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, dates, params, date(2012, 2, 4), date(2012, 2, 5), false, 1);
        assertEquals(0, dates.size());
        ...
        currentDate.set(2012, 7 - 1, 19, 10, 30);
        RecurrenceHelper.buildYearlyRecurrences(
                currentDate, TWO_DAYS_MS, dates, params, date(2013, 2, 10), null, true, 1);
        assertEquals(1, dates.size());
        assertEquals(
                "2013-02-09",
                dateFmt.format(dates.get(0))); // This event starts before 2013-2-10, but it ends on
        // 2013-02-11
    }
    ...
    /**
     * Checks we correctly build the Timezone for somewhere in the northern hemisphere with DST (eg
     * London)
     */
    @Test
    ...
    /**
     * Checks we correctly build the Timezone for somewhere in the southern hemisphere with DST (eg
     * Sydney) Note - Sydney is GMT+11 in December, GMT+10 in June
     */
    @Test
    ...
    public void testICalParams() {
        // Outlook sends 2 POST requests when we are going to update series (one updated occurrence
        // takes place).
        String icalText =
                "BEGIN:VCALENDAR\r\n"
        ...
        // The second Outlook POST request that updates occurrence, which has been updated before.
        // Outlook sets VTIMEZONE twice, we need the first one.
        icalText =
                "BEGIN:VCALENDAR\r\n"
                    + "PRODID:-//Microsoft Corporation//Outlook 14.0 MIMEDIR//EN\r\n"
                    + "VERSION:2.0\r\n"
    ...
    private static class RecurrenceHelper extends CalendarRecurrenceHelper {
        protected static void buildDailyRecurrences(
            ...
            buildDailyRecurrences(
                    currentDate, ONE_HOUR_MS, dates, params, onOrAfter, until, firstOnly, interval);
        }
        ...
        protected static void buildWeeklyRecurrences(
                Calendar currentDate,
                List<Date> dates,
                Map<String, String> params,
                Date onOrAfter,
        ...
        protected static void buildMonthlyRecurrences(
                Calendar currentDate,
                List<Date> dates,
                Map<String, String> params,
                Date onOrAfter,
        ...
        protected static void buildYearlyRecurrences(
                Calendar currentDate,
                List<Date> dates,
                Map<String, String> params,
                Date onOrAfter,
        ...
        protected static Map<String, String> fixOutlookRecurrenceQuirks(
                Map<String, String> params) {
