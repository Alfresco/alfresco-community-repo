...
/**
 * A benign implementation of the SessionListener interface. Allows the authentication subsystems to
 * share a uniform interface. Those without a need for a live session listeners can use this bean.
 *
 * @author dward
 */
