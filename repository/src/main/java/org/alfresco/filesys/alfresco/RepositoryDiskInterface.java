...
public interface RepositoryDiskInterface {
     ...
     */
    public void copyContent(NodeRef rootNode, String fromPath, String toPath)
            throws FileNotFoundException;
    ...
    public NetworkFile createFile(
            NodeRef rootNode, String Path, long allocationSize, boolean isHidden)
            throws IOException;

    /**
     * RestoreFile.
     *
     * <p>Either restores the file or creates a new one.
     *
     ...
     * @throws IOException
     */
    public NodeRef deleteFile2(
            final SrvSession session, final TreeConnection tree, NodeRef rootNode, String path)
            throws IOException;
    ...
    public void renameFile(
            NodeRef rootNode, String oldName, String newName, boolean soft, boolean moveAsSystem)
