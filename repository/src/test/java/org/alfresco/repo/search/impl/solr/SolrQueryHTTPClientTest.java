...
public class SolrQueryHTTPClientTest {
    ...
    public void testBuildHighlightQuery() throws UnsupportedEncodingException {
        ...
        GeneralHighlightParameters highlightParameters =
                new GeneralHighlightParameters(null, null, null, null, null, null, null, null);
        ...
        List<FieldHighlightParameters> fields =
                Arrays.asList(new FieldHighlightParameters(null, null, null, null, null, null));
        urlBuilder = new StringBuilder();
        highlightParameters =
                ...
                Arrays.asList(
                        ...
                        new Interval(
                                ...
                                new HashSet(
                                        Arrays.asList(
                                                new IntervalSet(
                                                        "2015", "2016-12", "special", false,
                                                        true)))));
        params.setInterval(
                new IntervalParameters(new HashSet(Arrays.asList(intervalSet)), intervalList));
        urlBuilder = new StringBuilder();
        client.buildFacetIntervalParameters(params, encoder, urlBuilder);
        url = urlBuilder.toString();
        assertNotNull(url);
    ...
    public void testBuildFieldFacets() throws UnsupportedEncodingException {
        ...
        SearchParameters.FieldFacet prefixff =
                new SearchParameters.FieldFacet("{!afts something=right}modifier");
        ...
        assertTrue(
                url.contains(
                        "facet.field="
                                + encoder.encode(
                                        "{!afts key=myLabel something=right}modifier", "UTF-8")));
        assertTrue(url.contains("f.modifier.facet.limit=100"));
        ...
        assertTrue(
                url.contains("facet.field=" + encoder.encode("{!afts key=myLabel}bill", "UTF-8")));
    ...
    public void testBuildStats() throws UnsupportedEncodingException {
        ...
        params.setStats(
                Arrays.asList(
                        new StatsRequestParameters(
                                "created", null, null, null, null, null, null, null, null, null,
        ...
        assertTrue(
                url.contains(
                        "stats.field="
                                + encoder.encode(
                                        "{! countDistinct=false distinctValues=false min=true"
                                            + " max=true sum=true count=true missing=true"
                                            + " sumOfSquares=true mean=true stddev=true}created",
                                        "UTF-8")));
        assertTrue(
                url.contains(
                        "stats.field="
                                + encoder.encode(
                                        "{! ex=excludeme tag=statLabel key=statLabel"
                                            + " percentiles='2.4,99.9' cardinality=0.5"
                                            + " countDistinct=true distinctValues=true min=true"
                                            + " max=true sum=false count=true missing=false"
                                            + " sumOfSquares=true mean=false stddev=true}cm:name",
                                        "UTF-8")));
    }
    ...
    public void testBuildPivots() throws UnsupportedEncodingException {
        ...
        params.setStats(
                Arrays.asList(
                        new StatsRequestParameters(
                                "created", "piv1", null, null, null, null, null, null, null, null,
                                null, null, null, null, null, null)));
    ...
    public void testBuildRange() throws UnsupportedEncodingException {
        ...
        assertTrue(
                url2.contains(
                        "&facet.range=" + encoder.encode("{!tag=doc }", "UTF-8") + "content.size"));
