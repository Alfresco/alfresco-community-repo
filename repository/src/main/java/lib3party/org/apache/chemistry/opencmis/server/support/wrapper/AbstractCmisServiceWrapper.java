 ...
 *
 * <p>All service wrappers managed by {@link CmisServiceWrapperManager} must be derived from this
 * class and must provide a constructor that takes a {@link CmisService} object as the sole
 * parameter.
 */
public abstract class AbstractCmisServiceWrapper
    ...
    /**
     * Sets the call context and propagates it down to the next service wrapper or service if it
     * implements the {@link CallContextAwareCmisService} interface.
     */
    @Override
    ...
    public TypeDefinitionList getTypeChildren(
        ...
        return service.getTypeChildren(
                repositoryId, typeId, includePropertyDefinitions, maxItems, skipCount, extension);
    }
    ...
    public List<TypeDefinitionContainer> getTypeDescendants(
            ...
            Boolean includePropertyDefinitions,
            ExtensionsData extension) {
        return service.getTypeDescendants(
    ...
    public List<ObjectParentData> getObjectParents(
            ...
            ExtensionsData extension) {
        return service.getObjectParents(
                repositoryId,
                objectId,
                filter,
                includeAllowableActions,
    ...
    public ObjectList getCheckedOutDocs(
            ...
            BigInteger skipCount,
            ExtensionsData extension) {
        return service.getCheckedOutDocs(
                repositoryId,
                folderId,
                filter,
                orderBy,
    ...
    public String createDocumentFromSource(
            ...
            Acl removeAces,
            ExtensionsData extension) {
        return service.createDocumentFromSource(
                repositoryId,
                sourceId,
                properties,
                folderId,
    ...
    public ObjectData getObjectByPath(
            ...
            Boolean includeAcl,
            ExtensionsData extension) {
        return service.getObjectByPath(
                repositoryId,
                path,
                filter,
                includeAllowableActions,
    ...
    public ContentStream getContentStream(
            ...
            BigInteger length,
            ExtensionsData extension) {
        return service.getContentStream(
    ...
    public List<BulkUpdateObjectIdAndChangeToken> bulkUpdateProperties(
            ...
            ExtensionsData extension) {
        return service.bulkUpdateProperties(
                repositoryId,
    ...
    public FailedToDeleteData deleteTree(
            ...
            ExtensionsData extension) {
        return service.deleteTree(
                repositoryId, folderId, allVersions, unfileObjects, continueOnFailure, extension);
    }
    ...
    public ObjectData getObjectOfLatestVersion(
            ...
            Boolean includeAcl,
            ExtensionsData extension) {
        return service.getObjectOfLatestVersion(
                repositoryId,
                objectId,
                versionSeriesId,
                major,
    ...
    public Properties getPropertiesOfLatestVersion(
            ...
            String filter,
            ExtensionsData extension) {
        return service.getPropertiesOfLatestVersion(
    ...
    public ObjectList getContentChanges(
            ...
            BigInteger maxItems,
            ExtensionsData extension) {
        return service.getContentChanges(
                repositoryId,
                changeLogToken,
                includeProperties,
                filter,
    ...
    public ObjectList getObjectRelationships(
            ...
            BigInteger skipCount,
            ExtensionsData extension) {
        return service.getObjectRelationships(
                repositoryId,
                objectId,
