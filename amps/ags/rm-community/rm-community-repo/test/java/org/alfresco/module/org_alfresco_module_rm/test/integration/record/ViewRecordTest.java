...
public class ViewRecordTest extends BaseRMTestCase {
   ...
   */
  public void testReadIsFiledPropertyWithoutReadPermissionOnParentFolder()
    throws Exception {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() {
          ...
          NodeRef rsc = filePlanService.createRecordCategory(
            rc,
            GUID.generate()
          );
          recordFolder =
            recordFolderService.createRecordFolder(rsc, GUID.generate());
          record =
