...
public class DeleteTests extends CmisTest {
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerShouldDeleteDocumentCreatedByAnotherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
  ...
  public void contributorShouldNotDeleteFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void contributorShouldNotDeleteFolderCreatedByOtherUser()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void collaboratorShouldNotDeleteFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
  ...
  public void collaboratorShouldNotDeleteFolderCreatedByOtherUser()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
