...
public class WebDAVHelperTest {
    ...
    public void canGetUrlPathPrefixWhenExplicitlySet() {
        ...
        MockHttpServletRequest request =
                new MockHttpServletRequest("GET", "/my/prefix/folder/filename.txt");
    ...
    public void canGetUrlPathPrefixFromServletPath() {
        ...
        MockHttpServletRequest request =
                new MockHttpServletRequest("GET", "/before/the-servlet/folder/filename.txt");
    ...
    public void canGetDestinationPathWhenNoServletName() {
        assertPathForURL(
                "/the-tenant.com/the-site/path/to/file",
    ...
    public void canGetDestinationPathWhenPrefixedWithContextPathAndServletName() {
        assertPathForURL(
                "/path/to/file", "http://webdav.alfresco.com/alfresco/webdav/path/to/file");

        assertPathForURL(
                "/alfresco/webdav/path/to/file",
                "http://webdav.alfresco.com/alfresco/webdav/alfresco/webdav/path/to/file");

        assertPathForURL(
                "/my/folder/alfresco/webdav/path/to/file",
