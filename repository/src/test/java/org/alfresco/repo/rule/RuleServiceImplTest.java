...
public class RuleServiceImplTest extends BaseRuleTest {
    ...
    public void testGetRulesOrder() {
        ...
        NodeRef ruleFolder =
                ((RuntimeRuleService) ruleService).getSavedRuleFolderAssoc(nodeRef).getChildRef();
        if (ruleFolder != null) {
                ...
                System.out.println(
                        " - Assoc index = "
                                ...
                                + nodeService.getProperty(
                                        ruleChildAssocRef.getChildRef(), ContentModel.PROP_TITLE));
            }
        }
    ...
    public void testRuleServicePermissionsConsumer() {
        ...
        this.permissionService.setPermission(
                this.nodeRef, "conUser", PermissionService.CONSUMER, true);
    ...
    public void testRuleServicePermissionsEditor() {
        ...
        this.permissionService.setPermission(
                this.nodeRef, "editorUser", PermissionService.EDITOR, true);
        this.permissionService.setInheritParentPermissions(this.nodeRef, true);
    ...
    public void testRuleServicePermissionsCoordinator() {
        ...
        this.permissionService.setPermission(
                this.nodeRef, "coordUser", PermissionService.COORDINATOR, true);
        this.permissionService.setInheritParentPermissions(this.nodeRef, true);
    ...
    public void testCyclicGraphWithInheritedRules() throws Exception {
        ...
        try {
            ...
            // expected
            // the node will still have been created in the current transaction, although the txn
            // will be rollback-only
        }
    ...
    public void testRuleDuplication() {
        ...
        this.nodeService.addChild(
                nodeRef4, nodeRef3, ContentModel.ASSOC_CHILDREN, QName.createQName("{test}test"));
    ...
    public void testCyclicAsyncRules() throws Exception {
        ...
        actionProps.put(
                ImageTransformActionExecuter.PARAM_MIME_TYPE, MimetypeMap.MIMETYPE_IMAGE_GIF);
        ...
        actionProps.put(
                ImageTransformActionExecuter.PARAM_ASSOC_QNAME, ContentModel.ASSOC_CHILDREN);
        ...
        actionProps2.put(
                ImageTransformActionExecuter.PARAM_MIME_TYPE, MimetypeMap.MIMETYPE_IMAGE_JPEG);
        ...
        ContentWriter writer =
                this.contentService.getWriter(contentNode, ContentModel.PROP_CONTENT, true);
        ...
        // RuleServiceImplTest.this.nodeService.getChildAssocs(finalNodeRef);
        //                        for (ChildAssociationRef ref : assocs)
        //                        {
        //                            NodeRef child = ref.getChildRef();
        //                            System.out.println("Child name: " +
        // RuleServiceImplTest.this.nodeService.getProperty(child, ContentModel.PROP_NAME));
        //                        }
        //
        //                        return true;
        //                    };
                        ...
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() {
                                ...
                                ActionCondition condition =
                                        actionService.createActionCondition("no-condition");
                                ...
                                Map<String, Serializable> repoActionParams =
    ...
    public void testPermissionsForPropagatedRules_ALF_8408() throws Exception {
        ...
        permissionService.setPermission(
                childNodeRef, username, PermissionService.CONTRIBUTOR, true);
        ...
        // Search rules
        List<Rule> rules =
                this.ruleService.getRules(childNodeRef, true, testRule.getRuleTypes().get(0));
        ...
        ((RuntimeRuleService) ruleService)
                .addRulePendingExecution(parentNodeRef, actionedUponNodeRef, testRule);
    ...
    /** ALF-12726 use FileFolderService to rename */
    @Test
    public void testOutboundRuleTriggeredAfterRename1() throws Exception {
        ...
        NodeRef actionedUponNodeRef =
                this.nodeService
                        ...
                        .getChildRef();
        ContentWriter writer =
                this.contentService.getWriter(actionedUponNodeRef, ContentModel.PROP_CONTENT, true);
        ...
        List<ChildAssociationRef> childAssoc =
                this.nodeService.getChildAssocs(
                        folder2NodeRef, RegexQNamePattern.MATCH_ALL, actionedQName);
        assertEquals(
        ...
        childAssoc =
                this.nodeService.getChildAssocs(
                        folder1NodeRef, RegexQNamePattern.MATCH_ALL, QName.createQName(newName));
        assertEquals(
    ...
    /** ALF-12726 use NodeService to rename */
    @Test
    public void testOutboundRuleTriggeredAfterRename2() throws Exception {
        ...
        childAssoc =
                this.nodeService.getChildAssocs(
                        folder1NodeRef, RegexQNamePattern.MATCH_ALL, actionedQName);
        assertEquals(
                "The rule should not be triggered and the document should be in folder1.",
                1,
                childAssoc.size());
    ...
    public void testRuleExecutionWhenSecurityContextIsEmpty() throws Exception {
        ...
        // Search rules
        List<Rule> rules =
                this.ruleService.getRules(parentNodeRef, true, testRule.getRuleTypes().get(0));
        assertNotNull("No rules found", rules);
        assertTrue("Created rule is not found", new HashSet<Rule>(rules).contains(testRule));
    ...
    /**
     * MNT-12819 Create two rules: outbound (enabled) and inbound (disabled). Then try to remove
     * them via removeAllRules method.
     */
    @Test
        ...
        try {
            FileInfo fileInfo =
                    fileFolderService.create(
                            scriptFolderRef, scriptName, ContentModel.TYPE_CONTENT);
