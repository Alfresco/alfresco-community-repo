...
public class GetDeploymentsFullTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify Admin user gets non-network deployments with skipCount parameter"
    ...
    public void getNonNetworkDeploymentsWithValidSkipCount()
        ...
        RestDeploymentModelsCollection deploymentsWithSkipCount =
                restClient.withParams("skipCount=2").withWorkflowAPI().getDeployments();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        deploymentsWithSkipCount
                .assertThat()
                .entriesListDoesNotContain("name", firstDeployment.getName())
                .assertThat()
                .entriesListDoesNotContain("name", secondDeployment.getName())
                .assertThat()
                .entriesListCountIs(deployments.getEntries().size() - 2);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user doesn't get non-network deployments when negative skipCount"
                            + " parameter is applied using REST API and status code is 400")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getNonNetworkDeploymentsWithNegativeSkipCount()
            throws JsonToModelConversionException, Exception {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user doesn't get non-network deployments when non numeric"
                        + " skipCount parameter is applied using REST API and status code is 400")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getNonNetworkDeploymentsWithNotNumericSkipCount()
            throws JsonToModelConversionException, Exception {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user gets non-network deployments with maxItems parameter applied"
    ...
    public void getNonNetworkDeploymentsWithValidMaxItems()
            throws JsonToModelConversionException, Exception {
        deployments = restClient.withWorkflowAPI().getDeployments();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        RestDeploymentModel firstDeployment = deployments.getEntries().get(0).onModel();
        RestDeploymentModel secondDeployment = deployments.getEntries().get(1).onModel();
        RestDeploymentModelsCollection deploymentsWithMaxItems =
                restClient.withParams("maxItems=2").withWorkflowAPI().getDeployments();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        deploymentsWithMaxItems
                .assertThat()
                .entriesListContains("name", firstDeployment.getName())
                .assertThat()
                .entriesListContains("name", secondDeployment.getName())
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user doesn't get non-network deployments when negative maxItems"
                            + " parameter is applied using REST API and status code is 400")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getNonNetworkDeploymentsWithNegativeMaxItems()
            throws JsonToModelConversionException, Exception {
    ...
    @TestRail(
            ...
            description =
                    "Verify Admin user doesn't get non-network deployments when non numeric"
                        + " maxItems parameter is applied using REST API and status code is 400")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getNonNetworkDeploymentsWithNotNumericMaxItems()
            throws JsonToModelConversionException, Exception {
    ...
    public void getNonNetworkDeploymentsWithValidProperties()
            throws JsonToModelConversionException, Exception {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user gets non-network deployments with non existing properties"
    ...
    public void getNonNetworkDeploymentsWithNonExistingProperties()
            throws JsonToModelConversionException, Exception {
