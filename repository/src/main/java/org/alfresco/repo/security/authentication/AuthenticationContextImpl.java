...
public class AuthenticationContextImpl implements AuthenticationContext {
    ...
    public Authentication setUserDetails(UserDetails ud) {
        ...
        try {
            // Apply the same validation that ACEGI would have to the user details - we may be going
            // through a 'back
            // door'.
            if (!ud.isEnabled()) {
    ...
    public Authentication setSystemUserAsCurrentUser(String tenantDomain) {
        ...
        return setUserDetails(
                new User(getSystemUserName(tenantDomain), "", true, true, true, true, gas));
    }
    ...
    public boolean isGuestUserName(String userName) {
        return AuthenticationUtil.getGuestUserName()
                .equalsIgnoreCase(this.tenantService.getBaseNameUser(userName));
    }
