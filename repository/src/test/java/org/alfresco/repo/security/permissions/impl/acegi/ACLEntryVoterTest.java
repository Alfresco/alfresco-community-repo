...
public class ACLEntryVoterTest extends AbstractPermissionTest {
  ...
  private static final String ACL_NODE_0_SYS_BASE_READ =
    "ACL_NODE.0.sys:base.Read";
  ...
  private static final String SHOULD_FAIL_DENIED =
    "Should fail because node is DENIED";
  private static final String SHOULD_FAIL_ABSTAINED =
    "Should fail because node is ABSTAINED";
  ...
  public void testBasicDenyNode() throws Exception {
    ...
    Method method = o
      .getClass()
      .getMethod("testOneNodeRef", new Class[] { NodeRef.class });
  ...
  public void testBasicDenyStore() throws Exception {
    ...
    Method method = o
      .getClass()
      .getMethod("testOneStoreRef", new Class[] { StoreRef.class });
  ...
  public void testMultiChildAssocRefMethodsArg0() throws Exception {
    ...
    try {
      method.invoke(
        proxy,
        new Object[] {
          nodeService.getPrimaryParent(rootNodeRef),
          null,
          null,
          null,
        }
  ...
  public void testMethodACL() throws Exception {
    ...
    proxyFactory.addAdvisor(
      advisorAdapterRegistry.wrap(
        new Interceptor("ACL_METHOD.andy", "ACL_METHOD.BANANA")
      )
    );
  ...
  public void testMethodACL2() throws Exception {
    ...
    proxyFactory.addAdvisor(
      advisorAdapterRegistry.wrap(
        new Interceptor(
          "ACL_METHOD.BANANA",
          "ACL_METHOD." + PermissionService.ALL_AUTHORITIES
        )
      )
    );
    proxyFactory.setTargetSource(new SingletonTargetSource(o));
  ...
  public void testMethodACL4() throws Exception {
    ...
    proxyFactory.addAdvisor(
      advisorAdapterRegistry.wrap(
        new Interceptor("ACL_METHOD.woof", "ACL_METHOD.BOO")
      )
    );
    proxyFactory.setTargetSource(new SingletonTargetSource(o));
    Object proxy = proxyFactory.getProxy();
  ...
  public void testAllowNodeCollection() throws Exception {
    ...
    method.invoke(
      proxy,
      Arrays.asList(systemNodeRef, systemNodeRef, systemNodeRef)
    );
  }

  public void testDenyNodeCollectionWhenOneElementShouldBeDenied()
    throws Exception {
    runAs(ANDY);
    permissionService.setPermission(
      new SimplePermissionEntry(
    ...
    try {
      method.invoke(
        proxy,
        Arrays.asList(systemNodeRef, rootNodeRef, systemNodeRef)
      );
      fail(SHOULD_FAIL_DENIED);
    } catch (InvocationTargetException e) {
      verifyAccessDenied(e);
  ...
  public void testAbstainNodeCollectionWhenOneElementShouldBeAbstained()
    throws Exception {
    runAs(ANDY);
    permissionService.setPermission(
      new SimplePermissionEntry(
    ...
    try {
      method.invoke(
        proxy,
        Arrays.asList(rootNodeRef, abstainedNode, rootNodeRef)
      );
      fail(SHOULD_FAIL_ABSTAINED);
    } catch (InvocationTargetException e) {
      verifyAccessAbstain(e);
  ...
  public void testDenyNodeCollectionWhenOneElementShouldBeDeniedAndThereAreAlsoAbstained()
    throws Exception {
    runAs(ANDY);
    permissionService.setPermission(
      new SimplePermissionEntry(
    ...
    try {
      method.invoke(
        proxy,
        Arrays.asList(abstainedNode, systemNodeRef, abstainedNode)
      );
      fail(SHOULD_FAIL_DENIED);
    } catch (InvocationTargetException e) {
      verifyAccessDenied(e);
  ...
  public static class ClassWithMethods {
    ...
    public void testManyChildAssociationRef(
