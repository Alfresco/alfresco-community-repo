...
public class VersionServiceImplTest extends BaseVersionStoreTest {
  ...
  public void before() throws Exception {
    ...
    versionableAspect =
      (VersionableAspect) applicationContext.getBean("versionableAspect");
    excludedOnUpdateProps = versionableAspect.getExcludedOnUpdateProps();
    globalProperties =
      (Properties) applicationContext.getBean("global-properties");
  ...
  private NodeRef addComment(
    ...
    if (
      !nodeService.hasAspect(nr, ForumModel.ASPECT_COMMENTS_ROLLUP) &&
      !suppressRollups
    ) {
    ...
    final List<ChildAssociationRef> existingTopics = nodeService.getChildAssocs(
      forumNode,
  ...
  private boolean isCommentExist(NodeRef nr, String commentForCheck) {
    ...
    Collection<ChildAssociationRef> comments = nodeService.getChildAssocsWithoutParentAssocsOfType(
      topicNode,
      ContentModel.ASSOC_CONTAINS
    );
  ...
  public void testGetCurrentVersion() {
    ...
    assertNotNull(
      "Failed to retrieve the current version from the head",
      currentVersion
    );
    ...
    try {
      ...
      fail(
        "Getting the current version is only allowed on live nodes, not on version nodes."
      );
  ...
  public void testVersioningChildren() {
    ...
    // Snap shot data
    String expectedVersionLabel = peekNextVersionLabel(
      versionableNode,
      versionProperties
    );
  ...
  private void CheckVersionCollection(
    ...
    for (Version version : versions) {
      ...
      if (
        ...
        frozenNodeId =
          (
            (NodeRef) version.getVersionProperty(
   ...
   */
  private Version addToVersionHistory(
  ...
  public void testRevert() {
    ...
    assertEquals(
      version1.getVersionLabel(),
      history.getHeadVersion().getVersionLabel()
    );
    assertEquals(
      version1.getVersionedNodeRef(),
    ...
    assertEquals(
      "0.1",
      nodeService.getProperty(versionableNode, ContentModel.PROP_VERSION_LABEL)
    );
    ...
    this.dbNodeService.addAspect(
        versionableNode,
        ApplicationModel.ASPECT_SIMPLE_WORKFLOW,
        null
      );
    ...
    assertEquals(
      version2.getVersionLabel(),
      history.getHeadVersion().getVersionLabel()
    );
    assertEquals(
      version2.getVersionedNodeRef(),
      history.getHeadVersion().getVersionedNodeRef()
    );
    ...
    String versionLabel = (String) this.dbNodeService.getProperty(
        versionableNode,
    ...
    assertEquals(
      UPDATED_VALUE_1,
      this.dbNodeService.getProperty(versionableNode, PROP_1)
    );
    assertNull(this.dbNodeService.getProperty(versionableNode, PROP_2));
    assertEquals(
      VALUE_3,
      this.dbNodeService.getProperty(versionableNode, PROP_3)
    );
    ...
    assertEquals(
      VALUE_2,
      this.dbNodeService.getProperty(versionableNode, PROP_2)
    );
    assertEquals(
      VALUE_3,
      this.dbNodeService.getProperty(versionableNode, PROP_3)
  ...
  public void testRevertWithComments() {
    ...
    assertTrue(
      nodeService.hasAspect(versionableNode, ForumModel.ASPECT_DISCUSSABLE)
    );
    assertTrue(
  ...
  public void testAssociationIsPresentAfterRevert() {
    ...
    assertFalse(
      "Order-product child association should not be primary",
      childAssoc.isPrimary()
    );
    ...
    assertTrue(
      "Order should have Order-Product association",
    ...
    assertTrue(
      "Order-Product association must exist after revert",
      childAssocs.size() > 0
    );
    assertTrue(
  ...
  private NodeRef createComment(
    ...
    // This is what happens within e.g. comment.put.json.js when comments are submitted via the REST API.
    if (
      !nodeService.hasAspect(discussableNode, ForumModel.ASPECT_DISCUSSABLE)
    ) {
  ...
  public void testScriptNodeRevert() {
    CheckOutCheckInService checkOutCheckIn = (CheckOutCheckInService) applicationContext.getBean(
    ...
    checkOutCheckIn.checkin(
      checkedOut,
      null,
      contentWriter.getContentUrl(),
      false
    );
    Version version1 = createVersion(versionableNode);
    ...
    history = versionService.getVersionHistory(versionableNode);
    assertEquals(
      version3.getVersionLabel(),
      history.getHeadVersion().getVersionLabel()
    );
    assertEquals(
      version3.getVersionedNodeRef(),
      history.getHeadVersion().getVersionedNodeRef()
    );
    ...
    ServiceRegistry services = applicationContext.getBean(
    ...
    assertEquals(
      VALUE_2,
      nodeService.getProperty(newNode.getNodeRef(), PROP_1)
    );
  ...
  public void testScriptNodeRevertWithChangeType() {
    CheckOutCheckInService checkOutCheckInService = (CheckOutCheckInService) applicationContext.getBean(
      "checkOutCheckInService"
    );
  ...
  public void testRestore() {
    ...
    try {
      ...
      fail(
        "An exception should have been raised since this node has no version history."
      );
    ...
    try {
      ...
      fail(
        "An exception should have been raised since this node exists and you can't restore a node that exists."
      );
    } catch (VersionServiceException exception) {
      // We where expecting this exception
    }
  ...
  public void testDeleteVersionHistory() {
    ...
    VersionHistory versionHistory1 =
      this.versionService.getVersionHistory(versionableNode);
    ...
    String versionLabel1 = (String) this.dbNodeService.getProperty(
        versionableNode,
        ContentModel.PROP_VERSION_LABEL
      );
    ...
    String versionLabel2 = (String) this.dbNodeService.getProperty(
        versionableNode,
        ContentModel.PROP_VERSION_LABEL
      );
    ...
    VersionHistory versionHistory4 =
      this.versionService.getVersionHistory(versionableNode);
    assertNotNull(versionHistory4);
    assertEquals(2, versionHistory4.getAllVersions().size());

    // Check that the version label is correct on the versionable node
    String versionLabel3 = (String) this.dbNodeService.getProperty(
        versionableNode,
        ContentModel.PROP_VERSION_LABEL
      );
  ...
  public void testDeleteLastVersion() {
    ...
    String name3 = (String) this.nodeService.getProperty(
        versionableNode,
        ContentModel.PROP_NAME
      );
    assertEquals(UPDATED_NAME_3, name3);
    String title3 = (String) this.nodeService.getProperty(
        versionableNode,
        ContentModel.PROP_TITLE
      );
    ...
    Version currentVersion =
      this.versionService.getCurrentVersion(versionableNode);
    ...
    String name2 = (String) this.nodeService.getProperty(
        versionableNode,
        ContentModel.PROP_NAME
      );
    assertEquals(UPDATED_NAME_2, name2);
    String title2 = (String) this.nodeService.getProperty(
        versionableNode,
        ContentModel.PROP_TITLE
      );
  ...
  public void testDeleteVersion() {
    ...
    assertEquals(
      currentVersion.getFrozenStateNodeRef(),
      version2.getFrozenStateNodeRef()
    );
    ...
    // Check that the version label is correct on the versionable node
    String versionLabel4 = (String) this.dbNodeService.getProperty(
        versionableNode,
        ContentModel.PROP_VERSION_LABEL
      );
    ...
    assertEquals(
      currentVersion.getFrozenStateNodeRef(),
      version4.getFrozenStateNodeRef()
    );
    ...
    assertEquals(
      currentVersion.getFrozenStateNodeRef(),
      version3n.getFrozenStateNodeRef()
    );
    ...
    assertEquals(
      currentVersion.getFrozenStateNodeRef(),
      version32.getFrozenStateNodeRef()
    );
    ...
    // Check that the current version property on the versionable node is no longer set
    versionLabel =
      (String) this.dbNodeService.getProperty(
          versionableNode,
          ContentModel.PROP_VERSION_LABEL
        );
    assertNull(versionLabel);
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            VersionHistory versionHistory = versionService.getVersionHistory(
              versionableNode
            );
  ...
  private void assertCorrectVersionLabel(
    final NodeRef nodeRef,
  ...
  private NodeRef createNodeWithVersionType(VersionType versionType) {
    ...
    final NodeRef nodeRef = dbNodeService
      .createNode(
        rootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        QName.createQName("{test}MyVersionableNode"),
  ...
  public void testAutoRemovalOfVersionHistory() {
    StoreRef spacesStoreRef = new StoreRef(
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            NodeRef archivedNodeRef = nodeArchiveService.getArchivedNode(
              nodeRef
            );
    ...
    txnHelper.doInTransaction(
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Exception {
          ...
          VersionHistory versionHistory12 = versionService.getVersionHistory(
            nodeRef
          );
          assertNull(versionHistory12);
          VersionHistory versionHistory23 = versionService.getVersionHistory(
            archivedNodeRef
          );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            VersionType vType = (VersionType) versionHistory
              .getHeadVersion()
              .getVersionProperty(VersionModel.PROP_VERSION_TYPE);
  ...
  public void testAutoVersionOnUpdatePropsOnlyWithExcludes() {
    ...
    NamespaceService namespaceService = (NamespaceService) applicationContext.getBean(
      "namespaceService"
    );
    excludedOnUpdateProps.add(
      ContentModel.PROP_AUTHOR.toPrefixString(namespaceService)
    );
    versionableAspect.setExcludedOnUpdateProps(excludedOnUpdateProps);
    versionableAspect.afterDictionaryInit();
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            assertEquals(
              VALUE_1,
              nodeService.getProperty(versionableNode, PROP_1)
            );
            assertEquals(
              "description 0",
              nodeService.getProperty(
  ...
  public void testALF5618() {
    ...
    final String lockToken =
      "opaquelocktoken:" + versionableNode.getId() + ":admin";
  ...
  public void testAR807() {
    QName prop = QName.createQName(
      "http://www.alfresco.org/test/versionstorebasetest/1.0",
      "intProp"
    );

    ChildAssociationRef childAssociation = nodeService.createNode(
      this.rootNodeRef,
      ContentModel.ASSOC_CHILDREN,
      QName.createQName(
        "http://www.alfresco.org/test/versionstorebasetest/1.0",
  ...
  public void testVersionTypeIsSet() {
    ...
    Serializable versionTypeProperty = nodeService.getProperty(
      newNode,
      ContentModel.PROP_VERSION_TYPE
    );
    assertNotNull(versionTypeProperty);
    assertTrue(
      versionTypeProperty.toString().equals(VersionType.MINOR.toString())
    );
  }
  ...
  public void testHasPermissionSwappedProtocol() {
    ...
    // Swap the protocol
    NodeRef versionNodeRefSwapped = new NodeRef(
      StoreRef.PROTOCOL_WORKSPACE,
  ...
  public void testALF_3962() {
    NodeRef versionableNode = createNode(
      true,
    ...
    NodeRef versionNodeRef = VersionUtil.convertNodeRef(
      ver.getFrozenStateNodeRef()
    );
    this.dbNodeService.setProperty(
        versionNodeRef,
        Version2Model.PROP_QNAME_FROZEN_MODIFIED,
        frozenModifiedDate
      );
    ...
    // corrupt versions
    Collection<Version> versions = versionService
    ...
    for (Version version : versions) {
      ...
      versionNodeRef =
        VersionUtil.convertNodeRef(version.getFrozenStateNodeRef());
      this.dbNodeService.setProperty(
          versionNodeRef,
    ...
    for (int i = 0; i < oldVersions.size(); i++) {
      ...
      assertEquals(
        oldVersion.getFrozenModifiedDate(),
  ...
  public void testVersioningAndAuditable() throws Exception {
    ...
    NodeRef nodeA = AuthenticationUtil.runAs(
    ...
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(nodeA, ContentModel.PROP_CREATOR)
    );
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(nodeA, ContentModel.PROP_MODIFIER)
    );
    assertEquals(
      false,
      nodeService.hasAspect(nodeA, ContentModel.ASPECT_VERSIONABLE)
    );
  ...
  public void testEnsureVersioningEnabled() throws Exception {
    ...
    assertEquals(
      false,
      nodeService.hasAspect(none, ContentModel.ASPECT_VERSIONABLE)
    );
    assertEquals(
      true,
      nodeService.hasAspect(aspect, ContentModel.ASPECT_VERSIONABLE)
    );
    assertEquals(
      true,
      nodeService.hasAspect(versioned, ContentModel.ASPECT_VERSIONABLE)
    );
    ...
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(none, ContentModel.PROP_CREATOR)
    );
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(none, ContentModel.PROP_MODIFIER)
    );
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(aspect, ContentModel.PROP_CREATOR)
    );
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(aspect, ContentModel.PROP_MODIFIER)
    );
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(versioned, ContentModel.PROP_CREATOR)
    );
    assertEquals(
      USER_NAME_A,
      nodeService.getProperty(versioned, ContentModel.PROP_MODIFIER)
    );
    ...
    assertEquals(
      Boolean.TRUE,
      nodeService.getProperty(none, ContentModel.PROP_AUTO_VERSION)
    );
    assertEquals(
      Boolean.TRUE,
      nodeService.getProperty(none, ContentModel.PROP_AUTO_VERSION_PROPS)
    );
    ...
    assertEquals(
      Boolean.FALSE,
      nodeService.getProperty(aspect, ContentModel.PROP_AUTO_VERSION)
    );
    assertEquals(
      Boolean.TRUE,
    ...
    assertEquals(
      null,
      nodeService.getProperty(aspect, ContentModel.PROP_TITLE)
    );
    ...
    assertEquals(
      Boolean.TRUE,
      nodeService.getProperty(versioned, ContentModel.PROP_AUTO_VERSION)
    );
    assertEquals(
      Boolean.FALSE,
    ...
    assertEquals(
      null,
      nodeService.getProperty(versioned, ContentModel.PROP_TITLE)
    );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            createVersion(versionableNode);
            VersionHistory vh = versionService.getVersionHistory(
              versionableNode
            );
            assertEquals(1, vh.getAllVersions().size());
            return null;
  ...
  private static void doMain(String... args) {
    ...
    final ServiceRegistry serviceRegistry = (ServiceRegistry) ctx.getBean(
      ServiceRegistry.SERVICE_REGISTRY
    );
    final FileFolderService fileFolderService = serviceRegistry.getFileFolderService();
    final NodeService nodeService = serviceRegistry.getNodeService();
    final VersionService versionService = serviceRegistry.getVersionService();
    final AuthenticationComponent authenticationComponent = (AuthenticationComponent) ctx.getBean(
    ...
    StoreRef storeRef = new StoreRef(
      "test",
      "VersionServiceImplTest-main-" + System.currentTimeMillis()
    );
  ...
  public void test_MNT10404() {
    ...
    try {
      ...
      assertTrue(
        nodeService.hasAspect(document, ContentModel.ASPECT_VERSIONABLE)
      );
  ...
  public void test_MNT14143() {
    ...
    Map<QName, Serializable> verProperties = new HashMap<QName, Serializable>(
      1
    );
  ...
  public void testbehaviourRevertVersion() throws Exception {
    ...
    assertEquals(
      1,
      versionBehavior.getExecutionCount(BeforeCreateVersionPolicy.QNAME)
    );
    assertTrue(
      "Behavior should be executed",
    ...
    assertEquals(
      1,
      versionBehavior.getExecutionCount(AfterCreateVersionPolicy.QNAME)
    );
    assertTrue(
      "Behavior should be executed",
    ...
    assertEquals(
      1,
      versionBehavior.getExecutionCount(OnCreateVersionPolicy.QNAME)
    );
    assertTrue(
      "Behavior should be executed",
    ...
    assertEquals(
      1,
      versionBehavior.getExecutionCount(AfterVersionRevertPolicy.QNAME)
    );
    assertTrue(
      "Behavior should be executed",
    ...
    assertEquals(
      3,
      versionBehavior.getExecutionCount(OnRevertVersionPolicy.QNAME)
    );
  }
  ...
  public class TestVersionPolicy
    ...
    protected void execute(QName className) {
      ...
      executionCount =
        Optional.ofNullable(executionCount).orElseGet(HashMap::new);
