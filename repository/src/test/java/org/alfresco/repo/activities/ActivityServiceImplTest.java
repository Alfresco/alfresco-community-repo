...
public class ActivityServiceImplTest extends TestCase {
  ...
  public void testPostValidActivities() throws Exception {
    activityService.postActivity(
      "org.alfresco.testActivityType1",
      null,
      null,
      ""
    );
    ...
    activityService.postActivity(
      "org.alfresco.testActivityType3",
      "site1",
      "appToolA",
      "{ \"var1\" : \"val1\" }"
    );
  ...
  public void testPostInvalidActivities() throws Exception {
    ...
    try {
      ...
      assertTrue(
        iae.getMessage().contains("activityType is a mandatory parameter")
      );
    }
  ...
  public void testGetEmptySiteFeed() throws Exception {
    ...
    List<String> siteFeedEntries = transactionService
  ...
  public void testGetEmptyUserFeed() throws Exception {
    List<String> userFeedEntries = activityService.getUserFeedEntries(
      "unknown user",
      null
    );
    ...
    userFeedEntries =
      activityService.getUserFeedEntries("unknown user", "some site");
  ...
  public void testJSAPI() throws Exception {
    ...
    String result = (String) this.scriptService.executeScript(
        location,
  ...
  public void testFeedControls() throws Exception {
    ...
    assertFalse(
      activityService.existsFeedControl(new FeedControl("mySite1", "appTool1"))
    );
