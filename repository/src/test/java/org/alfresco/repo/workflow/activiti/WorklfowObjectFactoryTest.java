...
public class WorklfowObjectFactoryTest extends TestCase {
  ...
  public void testTransitionDefaultLabel() {
    ...
    Mockito
      .when(mockedMessageService.getMessage(Mockito.anyString()))
      .thenAnswer(
        new Answer<String>() {
          @Override
    ...
    WorkflowObjectFactory factory = new WorkflowObjectFactory(
      null,
      null,
    ...
    WorkflowTransition createTransition = factory.createTransition(
      "test-transition",
      "title",
      null,
      true,
