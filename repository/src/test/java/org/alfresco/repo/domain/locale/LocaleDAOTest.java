...
public class LocaleDAOTest extends TestCase {
    ...
    private Pair<Long, Locale> getLocale(final Locale locale, boolean expectSuccess) {
        RetryingTransactionCallback<Pair<Long, Locale>> callback =
                new RetryingTransactionCallback<Pair<Long, Locale>>() {
        ...
        RetryingTransactionCallback<Pair<Long, Locale>> callback =
                new RetryingTransactionCallback<Pair<Long, Locale>>() {
                    public Pair<Long, Locale> execute() throws Throwable {
                        ...
                        assertEquals(
                                "The default locale returned must match the current thread's"
                                        + " default locale",
                                defaultLocale,
                                localePair.getSecond());
                        // Done
                        return localePair;
                    }
                };
    ...
    public void testConcurrentLocale() throws Throwable {
        ...
        final RetryingTransactionCallback<Long> callback =
