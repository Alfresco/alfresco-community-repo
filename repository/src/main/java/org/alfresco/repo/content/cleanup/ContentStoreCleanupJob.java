...
/**
 * Triggers the deletion of unused content using a {@link
 * org.alfresco.repo.content.cleanup.ContentStoreCleaner}.
 *
 * <p>The following parameters are required:
 *
 * <ul>
 *   <li><b>contentStoreCleaner</b>: The content store cleaner bean
 * </ul>
 *
 * @author Derek Hulley
 */
public class ContentStoreCleanupJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (contentStoreCleanerObj == null
                || !(contentStoreCleanerObj instanceof ContentStoreCleaner)) {
