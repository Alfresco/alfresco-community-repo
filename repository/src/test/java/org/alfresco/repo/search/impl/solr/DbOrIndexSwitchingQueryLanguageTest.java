...
public class DbOrIndexSwitchingQueryLanguageTest {
    ...
    public void hybridSearch() {
        ...
        when(solrDAO.getNodes(argThat(isNodeParamsFromTxnId(81L)), eq(null), eq(null)))
    ...
    public void findAfts() throws Exception {
        java.util.regex.Matcher matcher =
                LuceneQueryLanguageSPI.AFTS_QUERY.matcher("{!afts tag=desc1,desc2}description:xyz");
        ...
        matcher =
                LuceneQueryLanguageSPI.AFTS_QUERY.matcher(
                        "{!afts"
                            + " tag=desc1}{http://www.alfresco.org/model/content/1.0}title:workflow");
        assertTrue(matcher.find());
        ...
        return new BaseMatcher<SearchParameters>() {
            ...
            public void describeTo(Description description) {
                description.appendText(
                        SearchParameters.class.getSimpleName() + "[sinceTxId=" + sinceTxId + "]");
            }
