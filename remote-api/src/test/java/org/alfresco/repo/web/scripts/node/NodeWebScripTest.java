...
public class NodeWebScripTest extends BaseWebScriptTest {
    ...
    protected void setUp() throws Exception {
        ...
        AbstractRefreshableApplicationContext ctx =
                (AbstractRefreshableApplicationContext) getServer().getApplicationContext();
    ...
    public void testFolderCreation() throws Exception {
        ...
        NodeRef siteDocLib =
                siteService.getContainer(TEST_SITE.getShortName(), SiteService.DOCUMENT_LIBRARY);
        ...
        req =
                new Request(
                        "POST",
                        "/api/site/folder/" + TEST_SITE_NAME + "/" + SiteService.DOCUMENT_LIBRARY);
        jsonReq = new JSONObject();
        jsonReq.put("name", testNodeName);
                ...
                new RetryingTransactionCallback<Object>() {
                    public Object execute() throws Exception {
                        checkOutCheckInService.checkin(
                                workingCopy, new HashMap<String, Serializable>());
                        return null;
                    }
                });
    ...
    private NodeRef createNode(
            NodeRef parentNode, String nodeCmName, QName nodeType, String ownerUserName) {
