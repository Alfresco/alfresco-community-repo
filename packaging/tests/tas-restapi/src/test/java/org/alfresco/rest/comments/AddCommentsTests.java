...
public class AddCommentsTests extends RestTest {
  ...
  @TestRail(
    ...
    description = "Verify admin user adds multiple comments with Rest API and status code is 201"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.SANITY })
  public void adminIsAbleToAddComments()
    ...
    restClient
      ...
      .and()
      .entriesListContains("content", comment1)
      .and()
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.SANITY,
    description = "Verify unauthenticated user gets status code 401 on post multiple comments call"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.SANITY })
  public void unauthenticatedUserIsNotAbleToAddComments()
    throws JsonToModelConversionException, Exception {
    restClient
      .noAuthentication()
      .withCoreAPI()
  ...
  @TestRail(
    ...
    description = "Verify Manager user adds multiple comments with Rest API and status code is 201"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void managerIsAbleToAddComments()
    throws JsonToModelConversionException, Exception {
    restClient
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Contributor user adds multiple comments with Rest API and status code is 201"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void contributorIsAbleToAddComments()
    throws JsonToModelConversionException, Exception {
    restClient
      .authenticateUser(
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Collaborator user adds multiple comments with Rest API and status code is 201"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void collaboratorIsAbleToAddComments()
    throws JsonToModelConversionException, Exception {
    restClient
      .authenticateUser(
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Consumer user adds multiple comments with Rest API and status code is 201"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void consumerIsAbleToAddComments()
    throws JsonToModelConversionException, Exception {
    restClient
      .authenticateUser(
  ...
  public void userCanNotAddCommentsToANotJoinedPrivateSite() throws Exception {
    ...
    FileModel file = dataContent
      .usingSite(sitePrivateNotJoined)
      .usingUser(adminUserModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);
  ...
  public void userCanNotAddCommentsOnNonexistentFile() throws Exception {
    FileModel nonexistentFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN
    );
  ...
  public void userCanNotAddCommentsOnLink() throws Exception {
    LinkModel link = dataLink
      ...
      .usingSite(siteModel)
      .createRandomLink();
    FileModel fileWithNodeRefFromLink = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN
    );
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(RestErrorModel.UNABLE_TO_LOCATE);
  }
  ...
  public void userCanAddCommentWithTheSameContentAsExistingOne()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(file)
      .addComments(comment1, sameComment)
      .assertThat()
      .paginationExist()
      .and()
      .entriesListIsNotEmpty()
      ...
      .entriesListContains("content", comment1)
      .and()
      .entriesListContains("content", sameComment);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void addCommentsToAComment()
    throws JsonToModelConversionException, Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);
    RestCommentModel commentEntry = restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
      .usingResource(file)
      .addComment(comment1);
  ...
  public void addLongCommentsWithManagerAndCheckThatCommentIsReturned()
    throws Exception {
    document =
      dataContent
        .usingSite(siteModel)
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(document)
      .addComments(longString, longString1);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void addShortCommentsWithManagerAndCheckThatCommentIsReturned()
    throws Exception {
    document =
      dataContent
        .usingSite(siteModel)
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(document)
      .addComments(shortString, shortString1);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void addCommentsWithSpecialCharsWithCollaboratorCheckCommentIsReturned()
    throws Exception {
    document =
      dataContent
        .usingSite(siteModel)
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(document)
      .addComments(specialCharsString, shortString);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void addEmptyStringCommentsWithManagerCheckCommentIsReturned()
    throws Exception {
    document =
      dataContent
        .usingSite(siteModel)
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(document)
      .addComments(emptyString, spaceString);
    restClient
      .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
      .assertLastError()
      .containsSummary(RestErrorModel.NON_NULL_COMMENT);
  }
  ...
  public void addSeveralCommentsWithCollaboratorCheckCommentsAreReturned()
    throws Exception {
    document =
      dataContent
        .usingSite(siteModel)
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(document)
      .addComments(comment1, comment2, charString, charString1, charString2);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void invalidRequestBodyParameterCheckErrorModelSchema()
    throws Exception {
    document =
      dataContent
        .usingSite(siteModel)
    ...
    restClient
      .assertLastError()
      .containsErrorKey(
        String.format(RestErrorModel.UNRECOGNIZED_FIELD, "content2")
      );
    restClient
      .assertLastError()
      .containsSummary(
