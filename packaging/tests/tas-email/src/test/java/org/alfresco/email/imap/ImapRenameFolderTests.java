...
public class ImapRenameFolderTests extends EmailTest {
    ...
    public void adminShouldRenameFolder() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(adminSite)
                .assertThat()
                .contains(new FolderModel(newFolderName))
                .assertThat()
    ...
    @TestRail(
            ...
            description =
                    "Verify user with MANAGER role is not able to rename an nonexistent folder")
    @Test(
    ...
    public void siteManagerShouldNotRenameNonExistentFolder() throws Exception {
        ...
        imapProtocol
                ...
                .and()
                .assertThat()
                .doesNotContain(new FolderModel(newFolderName));
    }
    ...
    public void siteManagerShouldRenameFolderWithLongName() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(testSite)
                .assertThat()
                .contains(new FolderModel(longName))
                .assertThat()
                .doesNotContain(testFolder);
    }
    ...
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE},
            expectedExceptions = TestConfigurationException.class,
            expectedExceptionsMessageRegExp =
                    ".*You missed some configuration settings in your tests: User failed to connect"
                            + " to IMAP server LOGIN failed. Invalid login/password$")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify renaming folder by user with COLLABORATOR role - folder created by"
                            + " self")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with COLLABORATOR role is not able to rename a folder created by"
                            + " other user")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with CONTRIBUTOR role is able to rename a folder created by self")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with CONTRIBUTOR role is NOT able to rename a folder created by"
                            + " other user")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with CONSUMER role is not able to rename a folder created by other"
                            + " user")
    ...
    public void userCanRenameFolderToAFolderThatContainsWhiteSpaces() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(testSite)
                .assertThat()
                .contains(new FolderModel("folder with name that contains spaces"))
                .assertThat()
                .doesNotContain(testFolder);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can rename folder successfully with name that contains special"
                            + " characters")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can rename folder successfully with name that contains symbols")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL})
    ...
    public void userCannotRenameFolderWithNameThatContainsRestrictedCharacters() throws Exception {
        ...
        imapProtocol
                ...
                .contains(testFolder)
                .assertThat()
                .doesNotContain(new FolderModel("omegaΩ_<>./?"));
    }
    ...
    public void verifyASiteFolderCannotBeRenamedViaImap() throws Exception {
        ...
        imapProtocol
                ...
                .usingSites()
                .assertThat()
                .doesNotContain(new FolderModel("new site name"));
    }
    ...
    public void verifyFolderCanBeRenamedByChangingTheCase() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(testSite)
                .assertThat()
                .contains(new FolderModel(testFolder.getName().toUpperCase()))
                .assertThat()
                .doesNotContain(testFolder);
    }
}
