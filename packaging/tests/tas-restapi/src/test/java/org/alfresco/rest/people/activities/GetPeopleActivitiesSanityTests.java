...
/** @author Cristina Axinte Tests for getActivities (/people/{personId}/activities) RestAPI call */
public class GetPeopleActivitiesSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user gets its activities with Rest API and response is"
                            + " successful")
    public void managerUserShouldGetPeopleActivitiesList() throws Exception {
        ...
        restActivityModelsCollection
                ...
                .and()
                .entriesListContains("siteId", siteModel.getId())
                .and()
                .paginationExist();
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify collaborator user gets its activities with Rest API and response is"
                            + " successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify contributor user gets its activities with Rest API and response is"
                            + " successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify consumer user gets its activities with Rest API and response is"
                            + " successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify admin user gets another user activities with Rest API and response is"
                            + " successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user is NOT Authorized to gets another user activities"
                            + " with Rest API")
    public void unauthenticatedUserShouldNotGetPeopleActivitiesList() throws Exception {
        restClient
                .authenticateUser(unauthenticatedUser)
                .withCoreAPI()
                .usingUser(userModel)
                .getPersonActivities();
