...
public interface RecordService {
     ...
     *
     * <p>The file plan type indicates which file plan type the aspect applied to. Null indicates
     * that the aspect applies to rma:filePlan.
     *
     * <p>A record metadata aspect can be registered more than once if it applies to more than one
     * file plan type.
     *
    ...
    /**
     * Gets a list of all the record metadata aspects relevant to the file plan type of the file
     * plan component provided.
     *
     * <p>If a null context is provided all record meta-data aspects are returned, but this is not
     * recommended.
     *
     ...
     *
     * <p>If null is provided for the file plan type then record metadata aspects for the default
     ...
     *
     * <p>Note that the node reference of the record will be the same as the original document.
     *
     * @param filePlan The filePlan in which the record should be placed. filePlan can be <code>null
     *     </code> in this case the default RM site will be used.
     ...
     * @param isLinked indicates if the newly created record is linked to it's original location or
     *     not.
     */
    void createRecord(
            final NodeRef filePlan,
            final NodeRef nodeRef,
            final NodeRef locationNodeRef,
    ...
    /**
     * Creates a new document in the unfiled records container if the given node reference is a file
     * plan node reference otherwise the node reference will be used as the destination for the new
     * record.
     *
