...
/**
 * Test case which shows that the user who did not create a transfer folder will be able to see the
 * transfer folder if he gets read permissions, but will not be able to action on it.
 *
 * @author Tuna Aksoy
 * @since 2.3
 */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(testUser1) {
                    ...
                    public void when() {
                        ...
                        filePlanPermissionService.setPermission(
                                transferFolder, testUser2, READ_RECORDS);
                    }
                        ...
                        runAs(
                                new RunAsWork<Void>() {
                                    public Void doWork() {
                                        ...
                                        // Check if testUser2 filing permissions on the transfer
                                        // folder
                                        assertEquals(
                                                DENIED,
                                                permissionService.hasPermission(
                                        ...
                                        // Try to execute transfer complete action as testUser2 who
                                        // has no filing permissions on the transfer folder
                                        try {
                                            rmActionService.executeRecordsManagementAction(
