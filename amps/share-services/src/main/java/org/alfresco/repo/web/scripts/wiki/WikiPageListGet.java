...
public class WikiPageListGet extends AbstractWikiWebScript {
    ...
    protected Map<String, Object> executeImpl(
        ...
        boolean pageMetaOnly =
                strPageMetaOnly != null ? Boolean.parseBoolean(strPageMetaOnly) : false;
        ...
        if (pages.getPage().size() > 0) {
            ...
            container =
                    siteService.getContainer(site.getShortName(), WikiServiceImpl.WIKI_COMPONENT);
