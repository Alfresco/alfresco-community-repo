 ...
 *
 * <p>The create node trigger will only be fired if the object is NOT a sub-type of content.
 *
 * <p>Policy names supported are:
 *
 * <ul>
 *   <li>{@linkplain org.alfresco.repo.node.NodeServicePolicies.OnCreateChildAssociationPolicy}
 *   <li>{@linkplain org.alfresco.repo.node.NodeServicePolicies.BeforeDeleteChildAssociationPolicy}
 *   <li>{@linkplain org.alfresco.repo.node.NodeServicePolicies.OnCreateNodePolicy}
 * </ul>
 *
...
public class CreateNodeRuleTrigger extends RuleTriggerAbstractBase
            ...
            if (logger.isDebugEnabled() == true) {
                logger.debug(
                        "Create node rule trigger fired for parent node "
                                + this.nodeService.getType(parentNodeRef).toString()
                                + " "
                                + parentNodeRef
                                + " and child node "
    ...
    public void onRemoveAspect(NodeRef nodeRef, QName aspectTypeQName) {
        ...
        // is added.  It's added during create, therefore we must be talking about the primary
        // parent
