...
public class TenantAdminDAOTest extends TestCase {
    ...
    private TenantEntity createTenant(final String tenantDomain, final boolean enabled)
            throws Exception {
        RetryingTransactionCallback<TenantEntity> callback =
                new RetryingTransactionCallback<TenantEntity>() {
    ...
    private TenantUpdateEntity getTenantForUpdate(final String tenantDomain) throws Exception {
        RetryingTransactionCallback<TenantUpdateEntity> callback =
                new RetryingTransactionCallback<TenantUpdateEntity>() {
    ...
    private List<TenantEntity> listTenants(final boolean enabledOnly) throws Exception {
        RetryingTransactionCallback<List<TenantEntity>> callback =
                new RetryingTransactionCallback<List<TenantEntity>>() {
