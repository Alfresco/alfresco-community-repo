...
public class DefaultFieldBuilder {
  ...
  private static final String ASSOC_WARN =
    "Could not build Association Field as no valid FieldProcessor was specified";
  private static final String PROP_WARNING =
    "Could not build Property Field as no valid FieldProcessor was specified";

  private static final Log MY_LOGGER = LogFactory.getLog(
    DefaultFieldBuilder.class
  );
  ...
  private Field buildQNameField(
    ...
    if (
      fieldProcessor != null && fieldProcessor instanceof QNameFieldProcessor<?>
    ) {
    ...
    if (logger.isWarnEnabled()) logger.warn(warningMsg);
  ...
  public Field buildTransientField(String name) {
    ...
    if (logger.isWarnEnabled()) logger.warn(
      "Could not build Transient Field: " +
      name +
      " as no FieldProcessor specified"
    );
