...
public class Permission extends AbstractPermission implements XMLModelInitialisable {
    ...
    public void initialise(
            Element element, NamespacePrefixResolver nspr, PermissionModel permissionModel) {
    ...
    /**
     * Get the groups for which this permission is granted (by definition - filled in by the model
     * API)
     *
