...
public class WherePredicateApiTest extends AbstractSingleNetworkSiteTest {
    ...
    /**
     * {@literal
     * <host>:<port>/alfresco/api/-default-/public/alfresco/versions/1/nodes/<node>/children}
     */
    @Test
    public void testLogicalOperatorsGetChildren() throws Exception {
        String childrenUrl = getNodeChildrenUrl(folder0Id);
        // SIMPLE (+ve)
        String clause = new WhereClauseBuilder().predicate(Nodes.PARAM_ISFOLDER + "=true").build();
        ...
        getAll(childrenUrl, paging, getWhereClause(clause), 200);
        // NOT (-ve)
        clause = new WhereClauseBuilder().predicate(Nodes.PARAM_ISFOLDER + "=true", NOT).build();
    ...
    /**
     * {@literal
     * <host>:<port>/alfresco/api/-default-/public/alfresco/versions/1/nodes/<node>/secondary-children}
     */
    @Test
    public void testLogicalOperatorsGetSecondaryChildren() throws Exception {
        // SIMPLE (+ve)
        String clause =
                new WhereClauseBuilder().predicate(Nodes.PARAM_ASSOC_TYPE + "=cm:contains").build();
    ...
    /**
     * {@literal
     * <host>:<port>/alfresco/api/-default-/public/alfresco/versions/1/nodes/<node>/renditions}
     */
    @Test
    public void testLogicalOperatorsGetRenditions() throws Exception {
        // SIMPLE (+ve)
        String clause =
                new WhereClauseBuilder().predicate(Renditions.PARAM_STATUS + "=CREATED").build();
    ...
    /**
     * {@literal
     * <host>:<port>/alfresco/api/-default-/public/alfresco/versions/1/people/<personId>/favorites}
     */
    @Test
