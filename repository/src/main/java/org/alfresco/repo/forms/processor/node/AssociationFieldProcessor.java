...
public class AssociationFieldProcessor extends QNameFieldProcessor<AssociationDefinition> {
    ...
    /**
     * Gets the associated value from the {@link ContentModelItemData}. If the value is <code>null
     * </code> the method returns an empty {@link List}. If the value is a single Object (assumed to
     * be a NodeRef) it returns a {@link List} containing a {@link String} representation of that
     * object. If the value is a {@link Collection} of Objects, returns a {@link List} containing
     * {@link String} representations of all the objects.
     *
    ...
    public AssociationFieldDefinition makeAssociationFieldDefinition(
        ...
        AssociationFieldDefinition fieldDef =
                new AssociationFieldDefinition(name, endpointType, Direction.TARGET);
     ...
     */
    @Override
    protected AssociationDefinition getTypeDefinition(
