 ...
 *
 * <p>/alfresco/service/api/search/person?q=*
 *
 * @author Mark Rogers
 */
...
public class PersonSearchTest extends BaseWebScriptTest {
    ...
    public void testSearch() throws Exception {
        ...
        {
            Response response =
                    sendRequest(new GetRequest("/api/search/person?q=*"), Status.STATUS_OK);
        ...
        {
            Response response =
                    sendRequest(new GetRequest("/api/search/person.html?q=*"), Status.STATUS_OK);
            logger.debug(response.getContentAsString());
        }
    ...
    public void testAtomSearch() throws Exception {
        Response response =
                sendRequest(new GetRequest("/api/search/person.atom?q=*"), Status.STATUS_OK);
        logger.debug(response.getContentAsString());
    }
}
