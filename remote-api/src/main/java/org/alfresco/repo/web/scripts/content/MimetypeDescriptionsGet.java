...
/**
 * Returns the descriptions of all the mimetypes known to the system. This is normally used so that
 * things outside of the repo tier (eg Share) can display user-facing descriptions of the mimetypes
 * in the system.
 *
 * @author Nick Burch
 * @since 4.0.1
