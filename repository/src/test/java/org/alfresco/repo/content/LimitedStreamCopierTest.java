...
public class LimitedStreamCopierTest {
  ...
  private static final byte[] SHORT_BYTE_ARRAY =
    "This string is shorter than the limit".getBytes();
  private static final byte[] LIMIT_SIZED_BYTE_ARRAY =
    "This string's length exactly equals the limit".getBytes();
  private static final byte[] LONG_BYTE_ARRAY =
    "This test string is longer than the limit. Tum te tum te tum te tum.".getBytes();
