...
public abstract class BaseWebScriptTest extends TestCase {
  ...
  public static class BaseWebScriptTestListener
    ...
    public void addFailure(Test test, AssertionFailedError t) {
      getWriter()
        .println("*** Failed: " + ((BaseWebScriptTest) test).getName());
      t.printStackTrace(getWriter());
    }
    ...
    public void endTest(Test test) {
      getWriter().println();
      getWriter()
        .println("*** Test completed: " + ((BaseWebScriptTest) test).getName());
    }
   ...
   * @throws IOException
   */
  protected Response sendLocalRequest(
    final Request req,
    ...
    if (AuthenticationUtil.isMtEnabled()) {
      ...
      if (customAuthenticatorFactory == null) {
        tws.setServletAuthenticatorFactory(
