 ...
 *
 * <p>Implementations are responsible for triggering the Zip creation process and reporting on the
 * status of the of this process.
 *
 * @author Alex Miller
 */
public interface DownloadService {
    /**
     * Start the creation of a downlaodable archive file containing the content from the given
     * nodeRefs.
     *
     * <p>Implementations are expected to do this asynchronously, with clients using the returned
     * NodeRef to check on progress.
     *
     * <p>Initially, only zip files will be supported, however this could be extended in the future,
     * to support additional archive types.
     *
     ...
     *
     * <p>It also limits the number of deleted files for this batch of work to the specified
     * batchSize;
     *
     * <p>It can also look into deleting downloads files from all sys:Download folders affected by
     * MNT-20212
     */
