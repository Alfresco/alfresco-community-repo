...
public class AliasableAspect
     ...
     *
     * <p>Currently this involves trimmimg and lower casing, but it may change in future
     *
     * @param value
     ...
     *
     * <p>If the rule is broken, AlfrescoRuntimeException will be thrown.
     *
     * @param nodeRef Reference to target node
     * @param alias Alias that we want to set to the target node
     * @exception AlfrescoRuntimeException if the <b>alias</b> property is duplicated by another
     *     node.
     */
    ...
    public void removeAlias(String alias) {
        ...
        attributeService.removeAttribute(
                ALIASABLE_ATTRIBUTE_KEY_1, ALIASABLE_ATTRIBUTE_KEY_2, normaliseAlias(alias));
    }
    ...
    public void onUpdateProperties(
        ...
        if (oldAlias != null
                && newAlias != null
                && (normaliseAlias(oldAlias)).equals(normaliseAlias(newAlias))) {
