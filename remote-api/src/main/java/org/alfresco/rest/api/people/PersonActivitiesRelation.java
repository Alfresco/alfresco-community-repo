...
public class PersonActivitiesRelation
  implements RelationshipResourceAction.Read<Activity>, InitializingBean {

  private static final Log logger = LogFactory.getLog(
    PersonActivitiesRelation.class
  );
  ...
  @Override
  @WebApiDescription(
    title = "List the user's activities, excluding those of other users."
  )
  @WebApiParameters(
    {
      @WebApiParam(
  ...
  public CollectionWithPagingInfo<Activity> readAll(
    String personId,
