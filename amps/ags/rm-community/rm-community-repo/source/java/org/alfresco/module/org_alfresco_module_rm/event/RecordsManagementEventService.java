...
public interface RecordsManagementEventService {
    ...
    /**
     * Indicates whether a particular event can be created. Returns true if it is possible, false
     * otherwise.
     *
    ...
    /**
     * Indicates whether a particular event can be edited. Returns true if it is possible, false
     * otherwise.
     *
     * @param eventDisplayLabel event display label
     * @param eventName event name
