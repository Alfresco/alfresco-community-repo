...
/**
 * Override of the JavaScript API ScriptUtils bean "utilsScript" to provide additional Remote API
 * methods using objects not available to base Repository project.
 *
 * <p>See "web-scripts-application-context.xml" for bean definition.
 *
 * @since 4.2.0
...
public class WebScriptUtils extends ScriptUtils {
     ...
     *
     * @param family the family
     * @return An array of webscripts that match the given family name accessible to the current
     *     user
     * @since 7.1
     */
    public Object[] findWebScriptsForCurrentUser(String family) {
        ...
        for (WebScript webscript : this.repositoryContainer.getRegistry().getWebScripts()) {
            final RequiredAuthentication required =
                    webscript.getDescription().getRequiredAuthentication();
