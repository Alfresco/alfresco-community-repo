...
public interface RecordService
{
     ...
     *
     * @param recordMetadataAspect
     *            record metadata aspect qualified name
     * @param filePlanType
     *            file plan type
     *
     * @since 2.2
     ...
     * @param property
     *            property {@link QName}
     * @return boolean true if the property is declared on a registered record meta-data aspect, false otherwise
     *
     * @since 2.3
     */
     ...
     *
     * @param nodeRef
     *            node reference to file plan component providing context
     * @return {@link Set}&lt;{@link QName} &gt; list of record meta-data aspects
     *
     * @since 2.2
     */
     ...
     *
     * @param nodeRef
     *            node reference of the record for which the check would be performed
     ...
     *
     * @param filePlan
     *            The filePlan in which the record should be placed. filePlan can be <code>null</code> in this case the default RM site will be used.
     * @param nodeRef
     *            The node from which the record will be created
     ...
     * @param type
     *            content type, cm:content if null
     * @param properties
     *            properties
     * @param reader
     *            content reader
     ...
     *
     * @param nodeRef
     *            The record which will be rejected
     * @param reason
     ...
     * @param recordFolder
     *            the record folder to unlink it from
     *
     * @since 2.3
     */
