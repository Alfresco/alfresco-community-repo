...
public interface NodeServicePolicies {
    ...
    public interface BeforeMoveNodePolicy extends ClassPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "beforeMoveNode");
        /**
    ...
    public interface BeforeUpdateNodePolicy extends ClassPolicy {
        ...
        /**
         * Called before a node is updated. This includes the modification of properties, child and
         * target associations and the addition of aspects.
         *
    ...
    public interface OnUpdateNodePolicy extends ClassPolicy {
        ...
        /**
         * Called after a new node has been created. This includes the modification of properties
         * and the addition of aspects.
         *
    ...
    public interface BeforeArchiveNodePolicy extends ClassPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "beforeArchiveNode");
        /**
    ...
    public interface OnDeleteNodePolicy extends ClassPolicy {
        ...
        /**
         * Called after a node is deleted. The reference given is for an association which has been
         * deleted and cannot be used to retrieve node or associaton information from any of the
         * services.
         *
    ...
    public interface OnRestoreNodePolicy extends ClassPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "onRestoreNode");
        /**
    ...
    public interface OnCreateChildAssociationPolicy extends AssociationPolicy {
         ...
         * @param isNewNode <tt>true</tt> if the node is new or <tt>false</tt> if the node is being
         *     linked in
         */
    ...
    public interface BeforeDeleteAssociationPolicy extends AssociationPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "beforeDeleteAssociation");
        /**
    ...
    public interface BeforeSetNodeTypePolicy extends ClassPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "beforeSetNodeType");
        /**
