 ...
 *
 */
public class DefaultCorrespondingNodeResolverFactory
  implements CorrespondingNodeResolverFactory {
  ...
  public CorrespondingNodeResolver getResolver() {
    ...
    CachingCorrespondingNodeResolverImpl cachingResolver = new CachingCorrespondingNodeResolverImpl(
      basicResolver
    );
