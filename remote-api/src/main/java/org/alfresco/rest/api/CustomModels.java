...
public interface CustomModels {
    ...
    /**
     * Gets the {@code org.alfresco.rest.api.model.CustomType} representation of the given model's
     * type
     *
     * @param modelName the model name
    ...
    /**
     * Gets the {@code org.alfresco.rest.api.model.CustomAspect} representation of the given model's
     * aspect
     *
     * @param modelName the model name
    ...
    /**
     * Gets the {@code org.alfresco.rest.api.model.CustomModelConstraint} representation of the
     * given model's constraint
     *
     * @param modelName the model name
    ...
    /**
     * Starts the creation of a downloadable archive file containing the custom model file and its
     * associated Share extension module file (if requested).
     *
     * @param modelName the model name
     * @param parameters the {@link Parameters} object to get the parameters passed into the request
     * @return {@code org.alfresco.rest.api.model.CustomModelDownload} object containing the archive
     *     node reference
     */
