...
/**
 * This RenderingEngine is used for rendering {@link CompositeRenditionDefinition}s, which specify a list of {@link RenditionDefinition}s. The {@link CompositeRenderingEngine} iterates over the {@link RenditionDefinition}s sequentially and feeds the output of one definition in as the input of the next definition. The output of the last definition executed is the output of this rendering engine.
 * 
 * @author Nick Smith
 *
...
public class CompositeRenderingEngine extends AbstractRenderingEngine
{
    ...
    /**
     * Executes the specified subdefinition. Note that each of these component rendition definitions will be executed with the {@link RenditionService#PARAM_IS_COMPONENT_RENDITION is-component-rendition} flag set to true. This is so that the common pre- and post-rendition code in {@link AbstractRenderingEngine#executeImpl(Action, NodeRef)} will only be executed at the start and at the end of the chain of components.
     */
