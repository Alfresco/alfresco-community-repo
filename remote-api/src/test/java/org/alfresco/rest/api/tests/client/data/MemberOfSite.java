...
public class MemberOfSite
  implements Serializable, ExpectedComparison, Comparable<MemberOfSite> {
  ...
  public int hashCode() {
    ...
    result = prime * result + site.getSiteId().hashCode();
    return result;
  }
  ...
  public static ListResponse<MemberOfSite> parseMemberOfSites(
    ...
    ListResponse<MemberOfSite> resp = new ListResponse<MemberOfSite>(
      paging,
      siteMembers
    );
    return resp;
  ...
  public String toString() {
    return "MemberOfSite [role=" + role + ", siteShortName=" + site + "]";
  }
