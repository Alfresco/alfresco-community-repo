...
public class RecordsManagementActionServiceImpl
  ...
  private static final String MSG_NO_IMPLICIT_NODEREF =
    "rm.action.no-implicit-noderef";
  private static final String MSG_NODE_FROZEN =
    "rm.action.node.frozen.error-message";

  /** Registered records management actions */
  private Map<String, RecordsManagementAction> rmActions = new HashMap<>(13);
  private Map<String, RecordsManagementActionCondition> rmConditions = new HashMap<>(
    13
  );

  private Map<String, RecordsManagementAction> dispositionActions = new HashMap<>(
    5
  );
  ...
  protected void invokeBeforeRMActionExecution(
    ...
    BeforeRMActionExecution policy = beforeRMActionExecutionDelegate.get(
      qnames
    );
  ...
  public List<RecordsManagementAction> getRecordsManagementActions() {
    List<RecordsManagementAction> result = new ArrayList<>(
      this.rmActions.size()
    );
  ...
  public List<RecordsManagementActionCondition> getRecordsManagementActionConditions() {
    List<RecordsManagementActionCondition> result = new ArrayList<>(
      rmConditions.size()
    );
  ...
  public RecordsManagementActionResult executeRecordsManagementAction(
    ...
    if (
      retentionActions.contains(name.toLowerCase()) &&
    ...
    RecordsManagementActionResult result = rmAction.execute(
      nodeRef,
      parameters
    );
  ...
  public RecordsManagementActionResult executeRecordsManagementAction(
    ...
    if (implicitTargetNode == null) {
      ...
      return this.executeRecordsManagementAction(
          implicitTargetNode,
          name,
          parameters
        );
  ...
  public Map<NodeRef, RecordsManagementActionResult> executeRecordsManagementAction(
    ...
    Map<NodeRef, RecordsManagementActionResult> results = new HashMap<>(
      nodeRefs.size()
    );
    for (NodeRef nodeRef : nodeRefs) {
      RecordsManagementActionResult result = executeRecordsManagementAction(
        nodeRef,
        name,
        parameters
      );
