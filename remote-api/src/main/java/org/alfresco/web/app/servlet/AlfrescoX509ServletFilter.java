...
public class AlfrescoX509ServletFilter extends X509ServletFilterBase
{
    ...
    public void init(FilterConfig config) throws ServletException
    {
        ...
        if (secureComms == SecureCommsType.SECRET)
        {
            ...
            {
                logger.fatal("Missing value for solr.sharedSecret configuration property. If solr.secureComms is set to \"secret\", a value for solr.sharedSecret is required. See https://docs.hyland.com/search-services/latest/install/options/");
