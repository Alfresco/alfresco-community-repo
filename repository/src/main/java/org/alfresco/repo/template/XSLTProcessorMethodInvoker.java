...
public class XSLTProcessorMethodInvoker {
    ...
    private static final Map<String, TemplateProcessorMethod> PROCESSOR_METHODS =
            new TreeMap<String, TemplateProcessorMethod>();
    ...
    public Object invokeMethod(final String id, Object[] arguments) throws Exception {
        ...
        if (result == null) {
            ...
            return new NodeIterator() {
                ...
                public void detach() {
                    if (log.isDebugEnabled()) log.debug("detaching NodeIterator");
                    this.detached = true;
                }
                ...
                public Node nextNode() throws DOMException {
                    if (log.isDebugEnabled()) log.debug("NodeIterator.nextNode(" + index + ")");
                    if (this.detached) throw new DOMException(DOMException.INVALID_STATE_ERR, null);
                    return index == array.length ? null : array[index++];
                }

                public Node previousNode() throws DOMException {
                    if (log.isDebugEnabled()) log.debug("NodeIterator.previousNode(" + index + ")");
                    if (this.detached) throw new DOMException(DOMException.INVALID_STATE_ERR, null);
