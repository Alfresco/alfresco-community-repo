 ...
 *
 * <p>a) Original file is renamed. b) Renamed file is deleted via delete command or via
 * deleteOnClose flag and close operation. c) Temp file is moved into original file location.
 */
        ...
        if (operation instanceof RenameFileOperation) {
            ...
            if (m.matches()) {
                if (logger.isDebugEnabled()) {
                    logger.debug(
                            "New Scenario ScenarioRenameDeleteMoveInstance strPattern:" + pattern);
                }
