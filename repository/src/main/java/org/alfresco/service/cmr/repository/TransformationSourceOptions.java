...
/**
 * Defines options and demarcations needed to describe the details of how the source should be
 * transformed, independent of the target requirements.
 *
 * <p>See {@link PagedSourceOptions} for an example implementation that describes the page number
 * that should be used from the source content.
 *
 * @author Ray Gauss II
...
public interface TransformationSourceOptions {
    ...
    /**
     * Defines methods for serializing the source options into a parameter map and deserializing
     * from a serialized options accessor.
     *
     * <p>This is primarily used when interacting with the {@link RenditionService} with {@link
     * AbstractRenderingEngine}'s RenderContext being an implementer of this interface.
     */
    @AlfrescoPublicApi
    public interface TransformationSourceOptionsSerializer {
        ...
        /**
         * Gets the parameters from the serialized options accessor and builds a source options
         * object.
         *
