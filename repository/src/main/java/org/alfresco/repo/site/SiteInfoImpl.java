...
public class SiteInfoImpl implements SiteInfo {
     ...
     */
    /*package*/ SiteInfoImpl(
            String sitePreset,
            String shortName,
            String title,
            String description,
            SiteVisibility visibility,
            Map<QName, Serializable> customProperties,
            NodeRef nodeRef) {
    ...
    /**
     * @see
     *     org.alfresco.service.cmr.site.SiteInfo#setVisibility(org.alfresco.service.cmr.site.SiteVisibility)
     */
    ...
    /**
     * @see
     *     org.alfresco.service.cmr.site.SiteInfo#getCustomProperty(org.alfresco.service.namespace.QName)
     */
