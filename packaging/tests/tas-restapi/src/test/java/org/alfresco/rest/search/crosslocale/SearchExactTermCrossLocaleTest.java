 ...
 * These tests are based in AFTSDefaultTextQueryIT class, but an additional type of property has been added (tok:true)
 * in order to provide full coverage for the available options.
 */
public class SearchExactTermCrossLocaleTest extends AbstractSearchExactTermTest
{
    ...
    public void exactSearch_multiTerm_shouldReturnResultsContainingExactTerm()
    {
         ...
         * Document #5 has "runners" and "jumpers" in description You can see the difference between exact search and not
         */
