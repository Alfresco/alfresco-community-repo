...
/**
 * A singleton extension API implementor. The singleton extension continues to exist after the
 * extensible has been collected. The instance of this extension is shared among {@link Extensible}s
 * defining extension-points that this extension is bound to.The {@link Trait} it requires is set at
 * call-time on the local thread.
 *
 * @author Bogdan Horje
 */
