...
public interface DataTypeDefinition {
    ...
    public QName ENCRYPTED =
            QName.createQName(NamespaceService.DICTIONARY_MODEL_1_0_URI, "encrypted");
    ...
    public QName DATETIME =
            QName.createQName(NamespaceService.DICTIONARY_MODEL_1_0_URI, "datetime");
    ...
    public QName CATEGORY =
            QName.createQName(NamespaceService.DICTIONARY_MODEL_1_0_URI, "category");
    public QName NODE_REF = QName.createQName(NamespaceService.DICTIONARY_MODEL_1_0_URI, "noderef");
    public QName CHILD_ASSOC_REF =
            QName.createQName(NamespaceService.DICTIONARY_MODEL_1_0_URI, "childassocref");
    public QName ASSOC_REF =
            QName.createQName(NamespaceService.DICTIONARY_MODEL_1_0_URI, "assocref");
     ...
     * @see
     *     org.alfresco.service.cmr.dictionary.DataTypeDefinition#getTitle(org.alfresco.service.cmr.i18n.MessageLookup)
     */
     ...
     * @deprecated The problem identified in MNT-413 will still exist
     * @see
     *     org.alfresco.service.cmr.dictionary.DataTypeDefinition#getDescription(org.alfresco.service.cmr.i18n.MessageLookup)
     */
