...
public class StringLengthConstraint extends AbstractConstraint {
    private static final String ERR_INVALID_MIN_LENGTH =
            "d_dictionary.constraint.string_length.invalid_min_length";
    private static final String ERR_INVALID_MAX_LENGTH =
            "d_dictionary.constraint.string_length.invalid_max_length";
    ...
    private static final String ERR_INVALID_LENGTH =
            "d_dictionary.constraint.string_length.invalid_length";
    ...
    /**
     * Set the minimum number of characters allowed. Valid values are in the range [0, {@link
     * Integer#MAX_VALUE}].
     *
    ...
    /**
     * Set the maximum number of characters allowed. Valid values are in the range [0, {@link
     * Integer#MAX_VALUE}].
     *
