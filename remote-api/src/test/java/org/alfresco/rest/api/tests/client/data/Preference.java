...
public class Preference
  implements Serializable, ExpectedComparison, Comparable<Preference> {
  ...
  public static ListResponse<Preference> parsePreferences(
    ...
    ListResponse<Preference> resp = new ListResponse<Preference>(
      paging,
      preferences
    );
    return resp;
