...
public class ScriptFormService extends BaseScopableProcessorExtension {
     ...
     * @param itemKind The kind of item to retrieve a form for
     * @param itemId The identifier of the item to retrieve a form for
     * @param fields String array of fields to include, null indicates all possible fields for the
    ...
    public ScriptForm getForm(
            String itemKind, String itemId, String[] fields, String[] forcedFields) {
     ...
     * @param itemKind The kind of item to retrieve a form for
     * @param itemId The identifier of the item to retrieve a form for
     * @param postData The post data, this can be a Map of name value pairs, a webscript FormData
     *     object or a JSONObject
