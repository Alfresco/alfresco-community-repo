    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          assertNotNull(
            dispositionAction.getEventCompletionDetails(OTHER_EVENT)
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          // check for the lifecycle aspect
          assertTrue(
            nodeService.hasAspect(dmDocument, ASPECT_DISPOSITION_LIFECYCLE)
          );
          ...
          assertNotNull(dispositionAction.getAsOfDate());
          assertTrue(
            dispositionService.isNextDispositionActionEligible(dmDocument)
          );
          assertNull(
            dispositionAction.getEventCompletionDetails(
              CommonRMTestUtils.DEFAULT_EVENT_NAME
          ...
          assertEquals(
            CutOffAction.NAME,
            nodeService.getProperty(dmDocument, PROP_RS_DISPOSITION_ACTION_NAME)
          );
          assertNotNull(
          ...
          assertNotNull(
            nodeService.getProperty(dmDocument, PROP_RS_DISPOITION_INSTRUCTIONS)
          );
          assertNotNull(
