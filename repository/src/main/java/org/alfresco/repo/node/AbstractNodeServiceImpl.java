...
public abstract class AbstractNodeServiceImpl implements NodeService {
  ...
  private ClassPolicyDelegate<BeforeMoveNodePolicy> beforeMoveNodeDelegate;
  ...
  public void init() {
    ...
    onCreateStoreDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnCreateStorePolicy.class
      );
    ...
    onCreateNodeDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnCreateNodePolicy.class
      );
    beforeMoveNodeDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.BeforeMoveNodePolicy.class
      );
    onMoveNodeDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnMoveNodePolicy.class
      );
    ...
    onUpdateNodeDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnUpdateNodePolicy.class
      );
    onSetNodeTypeDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnSetNodeTypePolicy.class
      );
    ...
    onDeleteNodeDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnDeleteNodePolicy.class
      );
    onRestoreNodePolicy =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnRestoreNodePolicy.class
      );
    ...
    onRemoveAspectDelegate =
      policyComponent.registerClassPolicy(
        NodeServicePolicies.OnRemoveAspectPolicy.class
      );
  ...
  private boolean ignorePolicy(StoreRef storeRef) {
    return (
      storesToIgnorePolicies.contains(
        tenantService.getBaseName(storeRef).toString()
      )
    );
  }
   ...
   *      StoreRef)
   */
  protected void invokeBeforeCreateStore(
    QName nodeTypeQName,
    StoreRef storeRef
  ) {
  ...
  protected void invokeOnCreateStore(NodeRef rootNodeRef) {
    ...
    NodeServicePolicies.OnCreateStorePolicy policy = onCreateStoreDelegate.get(
      qnames
    );
  ...
  protected void invokeBeforeCreateNode(
    ...
    NodeServicePolicies.BeforeCreateNodePolicy policy = beforeCreateNodeDelegate.get(
      childNodeTypeQName
    );
    policy.beforeCreateNode(
      parentNodeRef,
      assocTypeQName,
      assocQName,
      childNodeTypeQName
  ...
  protected void invokeOnCreateNode(ChildAssociationRef childAssocRef) {
    ...
    // execute policy for node type and aspects
    NodeServicePolicies.OnCreateNodePolicy policy = onCreateNodeDelegate.get(
      childNodeRef,
      qnames
    );
  ...
  protected void invokeBeforeMoveNode(
    ...
    Set<QName> qnames = getTypeAndAspectQNames(childNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeMoveNodePolicy policy = beforeMoveNodeDelegate.get(
      childNodeRef,
      qnames
    );
  ...
  protected void invokeOnMoveNode(
    ...
    Set<QName> qnames = getTypeAndAspectQNames(childNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnMoveNodePolicy policy = onMoveNodeDelegate.get(
      childNodeRef,
      qnames
    );
  ...
  protected void invokeBeforeUpdateNode(NodeRef nodeRef) {
    ...
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeUpdateNodePolicy policy = beforeUpdateNodeDelegate.get(
      nodeRef,
      qnames
    );
  ...
  protected void invokeOnUpdateNode(NodeRef nodeRef) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(nodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnUpdateNodePolicy policy = onUpdateNodeDelegate.get(
      nodeRef,
      qnames
    );
   ...
   */
  protected void invokeOnSetType(
    NodeRef nodeRef,
    QName oldType,
    QName newType
  ) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(nodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnSetNodeTypePolicy policy = onSetNodeTypeDelegate.get(
      nodeRef,
      qnames
    );
   ...
   */
  protected void invokeBeforeSetType(
    NodeRef nodeRef,
    QName oldType,
    QName newType
  ) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(nodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeSetNodeTypePolicy policy = beforeSetNodeTypeDelegate.get(
      nodeRef,
      qnames
    );
  ...
  protected void invokeOnUpdateProperties(
    ...
    Set<QName> qnames = getTypeAndAspectQNames(nodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnUpdatePropertiesPolicy policy = onUpdatePropertiesDelegate.get(
      nodeRef,
      qnames
    );
  ...
  protected void invokeBeforeDeleteNode(NodeRef nodeRef) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(nodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeDeleteNodePolicy policy = beforeDeleteNodeDelegate.get(
      nodeRef,
      qnames
    );
  ...
  protected void invokeBeforeArchiveNode(NodeRef nodeRef) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(nodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeArchiveNodePolicy policy = beforeArchiveNodeDelegate.get(
      nodeRef,
      qnames
    );
  ...
  protected void invokeOnDeleteNode(
    ...
    if (ignorePolicy(childNodeRef)) {
      // special case
      if (
        childAspectQnames.contains(ContentModel.ASPECT_VERSIONABLE) ||
    ...
    if (qnames != null) {
      // execute policy for node type and aspects
      NodeServicePolicies.OnDeleteNodePolicy policy = onDeleteNodeDelegate.get(
  ...
  protected void invokeOnRestoreNode(ChildAssociationRef childAssocRef) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(childNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnRestoreNodePolicy policy = onRestoreNodePolicy.get(
      childAssocRef.getChildRef(),
      qnames
    );
  ...
  protected void invokeBeforeAddAspect(NodeRef nodeRef, QName aspectTypeQName) {
    ...
    NodeServicePolicies.BeforeAddAspectPolicy policy = beforeAddAspectDelegate.get(
      nodeRef,
      aspectTypeQName
    );
  ...
  protected void invokeOnAddAspect(NodeRef nodeRef, QName aspectTypeQName) {
    ...
    NodeServicePolicies.OnAddAspectPolicy policy = onAddAspectDelegate.get(
      nodeRef,
      aspectTypeQName
    );
   ...
   *      QName)
   */
  protected void invokeBeforeRemoveAspect(
    NodeRef nodeRef,
    ...
    NodeServicePolicies.BeforeRemoveAspectPolicy policy = beforeRemoveAspectDelegate.get(
      nodeRef,
      aspectTypeQName
    );
  ...
  protected void invokeOnRemoveAspect(NodeRef nodeRef, QName aspectTypeQName) {
    ...
    NodeServicePolicies.OnRemoveAspectPolicy policy = onRemoveAspectDelegate.get(
      nodeRef,
      aspectTypeQName
    );
  ...
  protected void invokeOnCreateChildAssociation(
    ...
    // execute policy for node type and aspects
    NodeServicePolicies.OnCreateChildAssociationPolicy policy = onCreateChildAssociationDelegate.get(
      parentNodeRef,
      qnames,
      assocTypeQName
    );
   ...
   */
  protected void invokeBeforeDeleteChildAssociation(
    ChildAssociationRef childAssocRef
  ) {
    NodeRef parentNodeRef = childAssocRef.getParentRef();
    ...
    Set<QName> qnames = getTypeAndAspectQNames(parentNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeDeleteChildAssociationPolicy policy = beforeDeleteChildAssociationDelegate.get(
      parentNodeRef,
      qnames,
      assocTypeQName
    );
   ...
   */
  protected void invokeOnDeleteChildAssociation(
    ChildAssociationRef childAssocRef
  ) {
    NodeRef parentNodeRef = childAssocRef.getParentRef();
    ...
    Set<QName> qnames = getTypeAndAspectQNames(parentNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnDeleteChildAssociationPolicy policy = onDeleteChildAssociationDelegate.get(
      parentNodeRef,
      qnames,
      assocTypeQName
    );
  ...
  protected void invokeOnCreateAssociation(AssociationRef nodeAssocRef) {
    ...
    // execute policy for node type and aspects
    NodeServicePolicies.OnCreateAssociationPolicy policy = onCreateAssociationDelegate.get(
      sourceNodeRef,
      qnames,
      assocTypeQName
    );
  ...
  protected void invokeBeforeDeleteAssociation(AssociationRef nodeAssocRef) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(sourceNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.BeforeDeleteAssociationPolicy policy = beforeDeleteAssociationDelegate.get(
      sourceNodeRef,
      qnames,
      assocTypeQName
    );
  ...
  protected void invokeOnDeleteAssociation(AssociationRef nodeAssocRef) {
    ...
    Set<QName> qnames = getTypeAndAspectQNames(sourceNodeRef);
    // execute policy for node type and aspects
    NodeServicePolicies.OnDeleteAssociationPolicy policy = onDeleteAssociationDelegate.get(
      sourceNodeRef,
      qnames,
      assocTypeQName
    );
  ...
  protected String generateGuid(
    Map<QName, Serializable> preCreationProperties
  ) {
    String uuid = (String) preCreationProperties.get(
  ...
  protected Map<QName, Serializable> getDefaultProperties(QName typeQName) {
    ClassDefinition classDefinition =
      this.dictionaryService.getClass(typeQName);
   ...
   */
  protected Map<QName, Serializable> getDefaultProperties(
    ClassDefinition classDefinition
  ) {
    PropertyMap properties = new PropertyMap();
    for (Map.Entry<QName, Serializable> entry : classDefinition
      .getDefaultValues()
      .entrySet()) {
      ...
      PropertyDefinition prop =
        this.dictionaryService.getProperty(entry.getKey());
      if (prop == null) {
      ...
      if (
        DataTypeDefinition.BOOLEAN.equals(prop.getDataType().getName()) == true
      ) {
  ...
  @Override
  @Extend(
    traitAPI = NodeServiceTrait.class,
    extensionAPI = NodeServiceExtension.class
  )
  public final boolean removeSeconaryChildAssociation(
    ChildAssociationRef childAssocRef
  ) {
