...
/**
 * A {@link Reference} model element that defines the type of the referred artefact and the
 * virtualization process that was applied when creating a reference.<br>
 * Protocols define the semantics of all elements of a reference. Protocol implementations add
 * syntactic processing methods.<br>
...
public class Protocol implements Serializable {
    ...
    public Reference replaceParameter(Reference reference, int index, String stringParameter) {
        return replaceParameter(reference, index, new StringParameter(stringParameter));
    }
    ...
    /**
     * {@link ProtocolMethod} double-dispatch/visitor protocol type selector. Subclasses should
     * override this method to select the appropriate type bound method.<br>
     * This particular implementation calls the default {@link ProtocolMethod#execute(Protocol,
     * Reference)} default method implementation.
     *
     * @param method
     * @param reference
     ...
     * @param reference
     * @return a mutated version of the given {@link Reference} corresponding to the given mutated
     *     node or the given {@link Reference} if no mutations are detected
     */
