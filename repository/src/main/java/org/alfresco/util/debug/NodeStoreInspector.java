...
public class NodeStoreInspector {
   ...
   */
  public static String dumpNodeStore(
  ...
  private static String outputNode(
    ...
    try {
      ...
      Collection<ChildAssociationRef> childAssocRefs = nodeService.getChildAssocs(
        nodeRef
      );
      for (ChildAssociationRef childAssocRef : childAssocRefs) {
        ...
        builder.append(
          outputNode(iIndent + 2, nodeService, childAssocRef.getChildRef())
        );
      }

      Collection<AssociationRef> assocRefs = nodeService.getTargetAssocs(
        nodeRef,
