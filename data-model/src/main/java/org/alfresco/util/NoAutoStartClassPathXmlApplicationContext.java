...
public class NoAutoStartClassPathXmlApplicationContext
  ...
  protected static void postInitBeanDefinitionReader(
    ...
    reader.setDocumentReaderClass(
      NoAutoStartBeanDefinitionDocumentReader.class
    );
  }
  ...
  protected static class NoAutoStartBeanDefinitionDocumentReader
    ...
    protected BeanDefinitionParserDelegate createDelegate(
      ...
      BeanDefinitionParserDelegate delegate = new NoAutoStartBeanDefinitionParserDelegate(
        readerContext
      );
  ...
  protected static class NoAutoStartBeanDefinitionParserDelegate
    ...
    protected NoAutoStartBeanDefinitionParserDelegate(
      XmlReaderContext readerContext
    ) {
      super(readerContext);
    }
