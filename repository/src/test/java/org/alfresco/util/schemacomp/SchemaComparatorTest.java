...
public class SchemaComparatorTest {
  ...
  public void canPerformDiff() {
    ...
    reference.add(
      new Table(
        ...
        pk("pk_tbl_no_diff", "id"),
        fkeys(fk("fk_tbl_no_diff", "nodeRef", "node", "nodeRef")),
    ...
    reference.add(
      new Table(
        reference,
        "tbl_has_diff_pk",
        columns("id NUMBER(10)", "nodeRef VARCHAR2(200)"),
        pk("pk_is_diff", "id"),
        fkeys(),
        indexes("idx_one id nodeRef", "idx_two id")
      )
    );
    ...
    target.add(
      new Table(
        ...
        "tbl_has_diff_pk",
        columns("id NUMBER(10)", "nodeRef VARCHAR2(200)"),
        pk("pk_is_diff", "nodeRef"),
        fkeys(),
        indexes("idx_one id nodeRef", "idx_two [unique] id")
      )
    );
    ...
    assertEquals(
      "schema.tbl_has_diff_pk.pk_is_diff.columnNames[0]",
      diff.getLeft().getPath()
    );
    assertEquals(
      "schema.tbl_has_diff_pk.pk_is_diff.columnNames[0]",
      diff.getRight().getPath()
    );
    ...
    diff = (Difference) it.next();
    assertEquals(
      "schema.tbl_has_diff_pk.idx_two.unique",
      diff.getLeft().getPath()
    );
    assertEquals(
      "schema.tbl_has_diff_pk.idx_two.unique",
  ...
  public void pkOrderingComparedCorrectly() {
    ...
    assertEquals(Where.IN_BOTH_BUT_DIFFERENCE, diff.getWhere());
    assertEquals(
      "schema.table_name.my_pk_name.columnOrders[0]",
      diff.getLeft().getPath()
    );
    assertEquals(
      "schema.table_name.my_pk_name.columnOrders[0]",
    ...
    assertEquals(Where.IN_BOTH_BUT_DIFFERENCE, diff.getWhere());
    assertEquals(
      "schema.table_name.my_pk_name.columnOrders[1]",
      diff.getLeft().getPath()
    );
    assertEquals(
      "schema.table_name.my_pk_name.columnOrders[1]",
  ...
  public void indexColumnOrderingComparedCorrectly() {
    ...
    assertEquals(Where.IN_BOTH_BUT_DIFFERENCE, diff.getWhere());
    assertEquals(
      "schema.table_name.index_name.columnNames[0]",
      diff.getLeft().getPath()
    );
    assertEquals(
      "schema.table_name.index_name.columnNames[0]",
    ...
    assertEquals(Where.IN_BOTH_BUT_DIFFERENCE, diff.getWhere());
    assertEquals(
      "schema.table_name.index_name.columnNames[1]",
      diff.getLeft().getPath()
    );
    assertEquals(
      "schema.table_name.index_name.columnNames[1]",
