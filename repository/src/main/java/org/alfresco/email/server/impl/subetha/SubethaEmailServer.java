...
public class SubethaEmailServer extends EmailServer {
    ...
    public void startup() {
        ...
        if (isAuthenticate()) {
            AuthenticationHandlerFactory authenticationHandler =
    ...
    class Handler implements MessageHandler {
        ...
        /**
         * 7 megs by default. The server will buffer incoming messages to disk when they hit this
        ...
        public void recipient(String recipient) throws RejectException {
            ...
            deliveries.add(
                    new EmailDelivery(
                            recipient, from, auth != null ? (String) auth.getIdentity() : null));
        }
