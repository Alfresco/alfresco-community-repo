...
public final class JSONtoFmModel {
    ...
    private static String REGEXP_ISO8061 =
     ...
     */
    public static Map<String, Object> convertJSONObjectToMap(String jsonString)
            throws JSONException {
    ...
    /**
     * JSONObject is an unordered collection of name/value pairs -> convert to Map (equivalent to
     * Freemarker "hash")
     */
     ...
     * @throws JSONException
     */
    public static Map<String, Object> convertJSONArrayToMap(String jsonString)
            throws JSONException {
        Map<String, Object> model = new HashMap<String, Object>();
    ...
    /**
     * JSONArray is an ordered sequence of values -> convert to List (equivalent to Freemarker
     * "sequence")
     */
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            if (entry.getValue() instanceof Map) {
                sb.append(tabs)
                        .append(entry.getKey())
                        .append(":")
                        .append(entry.getValue().getClass())
                        .append("\n");
                sb.append(
                        JSONtoFmModel.toStringBuffer(
                                (Map<String, Object>) entry.getValue(), indent + 1));
                ...
                for (int i = 0; i < l.size(); i++) {
                    sb.append(tabs)
                            .append(l.get(i))
                            .append(":")
                            .append((l.get(i) != null) ? l.get(i).getClass() : "null")
                            .append("\n");
                }
                sb.append(tabs).append("]\n");
            } else {
