...
public interface ModuleService {
    /**
     * Gets the module details for a given module id. If the module does not exist or is not
    ...
    /**
     * Start all the modules. For transaction purposes, each module should be regarded as a
     * self-contained unit and started in its own transaction. Where inter-module dependencies
     * exist, these will be pulled into the transaction.
     */
    void startModules();
