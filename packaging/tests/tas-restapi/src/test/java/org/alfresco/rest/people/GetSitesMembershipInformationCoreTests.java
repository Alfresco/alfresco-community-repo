...
public class GetSitesMembershipInformationCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is not able to retrieve site membership information for a"
                            + " personId that does not exist")
    public void siteManagerCantRetrieveSiteMembershipInformationForAPersonIdThatDoesNotExist()
            throws Exception {
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site membership information request returns status code 400 when"
                            + " invalid maxItems parameter is used")
    public void getSiteMembershipInformationRequestReturns400ForInvalidMaxItemsParameter()
            throws Exception {
        restClient
                .authenticateUser(userModel)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site membership information request returns status code 200 for"
                            + " valid maxItems parameter")
    public void getSiteMembershipInformationRequestReturns200ForValidMaxItemsParameter()
            throws Exception {
        restClient
                .authenticateUser(userModel)
    ...
    @TestRail(
            ...
            description =
                    "Verify if get site membership information request returns status code 400 when"
                            + " invalid skipCount parameter is used")
    public void getSiteMembershipInformationRequestReturns400ForInvalidSkipCountParameter()
            throws Exception {
        restClient
                .authenticateUser(userModel)
        ...
        restClient
                .assertLastError()
                .containsErrorKey(String.format(RestErrorModel.INVALID_SKIPCOUNT, "test"))
    ...
    @TestRail(
            ...
            description =
                    "Verify if get site membership information request returns status code 200 for"
                            + " valid skipCount parameter")
    public void getSiteMembershipInformationRequestReturns200ForValidSkipCountParameter()
            throws Exception {
        restClient
                .authenticateUser(userModel)
                .withParams("skipCount=1")
    ...
    public void siteMemberIsAbleToLeaveSite() throws Exception {
        restClient
                .authenticateUser(leaveSiteUserModel)
                .withCoreAPI()
                .usingAuthUser()
