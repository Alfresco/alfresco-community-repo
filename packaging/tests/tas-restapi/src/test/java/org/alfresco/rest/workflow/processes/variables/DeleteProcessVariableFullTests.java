...
public class DeleteProcessVariableFullTests extends RestTest {
  ...
  public void deleteProcessVariablesForADeletedProcess() throws Exception {
    ...
    RestProcessModel processModel = restClient
      .authenticateUser(userWhoStartsTask)
      .withWorkflowAPI()
  ...
  public void deleteProcessVariableByUserThatStartedTheProcess()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:text");
    processModel =
  ...
  public void deleteProcessVariableByUserInvolvedInTheProcess()
    throws Exception {
    variableModel =
      RestProcessVariableModel.getRandomProcessVariableModel("d:text");
    processModel =
