...
public class Floc implements Serializable {
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((propertyBag == null) ? 0 : propertyBag.hashCode());
    result =
      prime * result + ((shardMethod == null) ? 0 : shardMethod.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (propertyBag == null) {
      if (other.propertyBag != null) return false;
    } else if (!propertyBag.equals(other.propertyBag)) return false;
    if (shardMethod != other.shardMethod) return false;
    if (storeRefs == null) {
      if (other.storeRefs != null) return false;
    } else if (!storeRefs.equals(other.storeRefs)) return false;
    if (template == null) {
