...
/**
 * A strategy for locating a {@link NodeRef} in the repository, given a source node and an arbitrary
 * set of parameters.
 *
 * @author Nick Smith
 * @since 4.0
...
public interface NodeLocator {
    /**
     * Finds a {@link NodeRef} given a starting {@link NodeRef} and a {@link Map} of parameters.
     * Returns <code>null</code> if the specified node could not be found.
     *
     * @param source the starting point for locating a new node. The source node. Can be <code>null
     *     </code>.
