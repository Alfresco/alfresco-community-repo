...
public class DictionaryRestApiTest extends BaseWebScriptTest {
  ...
  private void validateChildAssociation(JSONObject result) throws Exception {
    ...
    assertEquals(
      "wca:workflowdefaults",
      result.getJSONObject("target").get("class")
    );
    assertEquals(false, result.getJSONObject("target").get("mandatory"));
    assertEquals(false, result.getJSONObject("target").get("many"));

    assertEquals(
      "/api/defclasses/wca/form/association/wca/formworkflowdefaults",
      result.get("url")
    );
  }
  ...
  private void validateAssociation(JSONObject result) throws Exception {
    ...
    assertEquals(
      "wca:renderingenginetemplate",
      result.getJSONObject("target").get("class")
    );
    assertEquals(
      "wca:presentation",
      result.getJSONObject("target").get("role")
    );
    assertEquals(false, result.getJSONObject("target").get("mandatory"));
  ...
  private void validateAssociationDef(JSONObject result) throws Exception {
    ...
    assertEquals(
      "/api/defclasses/cm/person/association/cm/avatar",
      result.get("url")
    );
  }
  ...
  private void validateTypeClass(JSONObject result) throws Exception {
    ...
    assertEquals(
      "/api/defclasses/sys/base",
      result.getJSONObject("parent").get("url")
    );
  ...
  private void validatePropertiesConformity(JSONArray classDefs)
    throws Exception {
    ...
    for (int i = 0; (i < itemsToTest) && (i < classDefs.length()); ++i) {
      ...
      Response responseFromGetClassDef = sendRequest(
        new GetRequest(classUrl),
        200
      );
      JSONObject classDef2 = new JSONObject(
        responseFromGetClassDef.getContentAsString()
      );
      ...
      Response responseFromGetPropertiesDef = sendRequest(
        new GetRequest(classUrl + "/properties"),
        200
      );
      JSONArray propertiesDefs = new JSONArray(
        responseFromGetPropertiesDef.getContentAsString()
      );
      assertEquals(200, responseFromGetClassDef.getStatus());
      // properties of class obtained by api/defclasses/class/properties
      List<String> propertyValues3 = new ArrayList<String>(
        propertiesDefs.length()
      );
  ...
  private void assertEquivalenceProperties(
    ...
    if (
      (propertyValues1.size() != propertyValues2.size()) ||
  ...
  public void testGetPropertyDef() throws Exception {
    Response response = sendRequest(
      new GetRequest("/api/defclasses/cm/auditable/property/cm/created"),
      200
    );
    ...
    response =
      sendRequest(
        new GetRequest("/api/defclasses/cm/hi/property/cm/welcome"),
        404
      );
    ...
    response =
      sendRequest(
        new GetRequest("/api/defclasses/cm/auditable/property/cm/welcome"),
        200
      );
  ...
  public void testGetPropertyDefs() throws Exception {
    ...
    req =
      new GetRequest(
        URL_PROPERTIES + "?name=cm:name&name=cm:title&name=cm:description"
      );
    response = sendRequest(req, 200);
    assertEquals(200, response.getStatus());
    result = new JSONArray(response.getContentAsString());
  ...
  public void testGetAssociationDef() throws Exception {
    GetRequest req = new GetRequest(
      URL_SITES + "/cm/person/association/cm/avatar"
    );
    Response response = sendRequest(req, 200);
    JSONObject result = new JSONObject(response.getContentAsString());
    assertEquals(200, response.getStatus());
    ...
    req =
      new GetRequest(
        URL_SITES + "/wca/form/association/wca/formworkflowdefaults"
      );
    response = sendRequest(req, 200);
    result = new JSONObject(response.getContentAsString());
    ...
    req =
      new GetRequest(
        URL_SITES + "/wca/form/association/wca/renderingenginetemplates"
      );
    response = sendRequest(req, 200);
    result = new JSONObject(response.getContentAsString());
    ...
    response =
      sendRequest(
        new GetRequest(URL_SITES + "/wca/form/association/cmsavatarsara"),
        404
      );
    assertEquals(404, response.getStatus());
  }
  ...
  public void testGetAssociationDefs() throws Exception {
    ...
    for (int i = 0; i < result.length(); i++) {
      if (
        result.getJSONObject(i).get("name").equals("wca:formworkflowdefaults")
    ...
    for (int i = 0; i < result.length(); i++) {
      if (
        result
          .getJSONObject(i)
          .get("name")
          .equals("wca:renderingenginetemplates")
    ...
    response =
      sendRequest(
        new GetRequest(URL_SITES + "/cmsa/personalbe/associations"),
        404
      );
    assertEquals(404, response.getStatus());
