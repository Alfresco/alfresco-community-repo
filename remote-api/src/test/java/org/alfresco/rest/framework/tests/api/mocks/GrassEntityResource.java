...
public class GrassEntityResource
        implements EntityResourceAction.ReadById<Grass>,
                EntityResourceAction.Create<Grass>,
    ...
    public String cutLawn(
            String id, Void notused, Parameters parameters, WithResponse withResponse) {
        return "All done";
    }
    ...
    public String growTheLawn(
            String id, Grass grass, Parameters parameters, WithResponse withResponse) {
        return "Growing well";
    }
    ...
    @WebApiNoAuth
    @WebApiDescription(title = "Cut the grass", successStatus = Status.STATUS_NOT_IMPLEMENTED)
    public String cutLawnWithoutAuth(
            String id, Void notused, Parameters parameters, WithResponse withResponse) {
