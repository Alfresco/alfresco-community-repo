...
public class TaggingServiceImplTest extends BaseSpringTest {
    ...
    public void setUp() throws Exception {
        ...
        AuditComponent auditComponent =
                (AuditComponent) applicationContext.getBean("auditComponent");
        auditComponent.setUserAuditFilter(userAuditFilter);
        AuditServiceImpl auditServiceImpl =
                (AuditServiceImpl) applicationContext.getBean("auditService");
        ...
        this.actionTrackingService =
                (ActionTrackingService) applicationContext.getBean("actionTrackingService");
        ...
        this.nodeRefPropInterceptor =
                (NodeRefPropertyMethodInterceptor)
                        applicationContext.getBean("nodeRefPropertyInterceptor");
                    ...
                    .doInTransaction(
                            new RetryingTransactionCallback<Void>() {
                                ...
                                public Void execute() throws Throwable {
                                    ...
                                    TaggingServiceImplTest.storeRef =
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                Map<QName, Serializable> docProps =
                                        new HashMap<QName, Serializable>(1);
                                docProps.put(
                                        ContentModel.PROP_NAME, "testDocument" + guid + ".txt");
                                document =
                                        nodeService
                                                .createNode(
                                                        folder,
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                NodeRef[] nodes =
                                        new NodeRef[] {subDocument, subFolder, document, folder};
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                // Get the tags
                                List<String> tags =
                                        taggingService.getTags(TaggingServiceImplTest.storeRef);
                                assertNotNull(tags);
                                ...
                                taggingService.createTag(
                                        TaggingServiceImplTest.storeRef, UPPER_TAG);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                Pair<List<String>, Integer> pagedTags =
                                        taggingService.getPagedTags(
                                                TaggingServiceImplTest.storeRef, "one", 0, 10);
                                ...
                                tagPage =
                                        taggingService.getTags(
                                                TaggingServiceImplTest.storeRef, "one");
                                assertNotNull(pagedTags);
                                ...
                                // Check isTag method
                                assertFalse(
                                        taggingService.isTag(
                                                TaggingServiceImplTest.storeRef, TAG_2));
                                assertTrue(
                                        taggingService.isTag(
                                                TaggingServiceImplTest.storeRef, TAG_1));
                                assertTrue(
                                        taggingService.isTag(
                                                TaggingServiceImplTest.storeRef, UPPER_TAG));
                                assertTrue(
                                        taggingService.isTag(
                                                TaggingServiceImplTest.storeRef, LOWER_TAG));

                                // Remove a tag
                                taggingService.deleteTag(
                                        TaggingServiceImplTest.storeRef, UPPER_TAG);
                                return null;
                            }
                        });
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                List<TagScope> tagScopes =
                                        taggingService.findAllTagScopes(subDocument);
    ...
    public void test4TagScope() throws Exception {
         ...
         */
        //
        //        this.transactionService.getRetryingTransactionHelper().doInTransaction(new
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                Serializable summaryObj =
                                        nodeService.getProperty(
                                                folder, ContentModel.PROP_TAGSCOPE_SUMMARY);
                                assertTrue(
                                        "TagScopeSummary value on main folder is not of correct"
                                                + " class: "
                                                + summaryObj.getClass().getName(),
                                        List.class.isAssignableFrom(summaryObj.getClass()));
                                assertEquals(3, ((List) summaryObj).size());

                                // Check that the next call for the same summary comes from the
                                // cache
                                Serializable summaryObj2 =
                                        nodeService.getProperty(
                                                folder, ContentModel.PROP_TAGSCOPE_SUMMARY);
                                assertTrue(
                                        "TagScopeSummary value on main folder did not come from the"
                                                + " cache",
                                        summaryObj == summaryObj2);

                                Map<QName, Serializable> props =
                                        nodeService.getProperties(subFolder);
                                assertTrue(
                                        "Properties of subfolder do not include tagScopeSummary",
                                        props.containsKey(ContentModel.PROP_TAGSCOPE_SUMMARY));
                                summaryObj = props.get(ContentModel.PROP_TAGSCOPE_SUMMARY);
                                assertTrue(
                                        "TagScopeSummary value on subfolder is not of correct"
                                                + " class: "
                                                + summaryObj.getClass().getName(),
                                        List.class.isAssignableFrom(summaryObj.getClass()));
                                assertEquals(3, ((List) summaryObj).size());
                                ...
                                summaryObj =
                                        nodeService.getProperty(
                                                folder, ContentModel.PROP_TAGSCOPE_SUMMARY);
                                assertNull(
                                        "TagScopeSummary value on main folder should be null: "
                                                + summaryObj,
                                        summaryObj);

                                props = nodeService.getProperties(subFolder);
                                assertFalse(
                                        "Properties of subfolder should not contain"
                                                + " tagScopeProperty",
                                        props.containsKey(ContentModel.PROP_TAGSCOPE_SUMMARY));
                                return null;
                            }
        ...
        this.transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            @Override
                            public Void execute() throws Throwable {
                                // Get the tag scope and check that all the values have been set
                                // correctly
    ...
    /**
     * Ensures that the tag scope is correctly updated when folders and content are created,
     * updated, moved, copied and deleted.
     */
    @Test
    @Category({RedundantTests.class, LuceneTests.class})
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        Map<QName, Serializable> container1Props =
                                new HashMap<QName, Serializable>(1);
                        ...
                        Map<QName, Serializable> container2Props =
                                new HashMap<QName, Serializable>(1);
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                assertEquals(
                                        0,
                                        taggingService
                                                .findTagScope(testData.container1)
                                                .getTags()
                                                .size());
                                assertEquals(
                                        0,
                                        taggingService
                                                .findTagScope(testData.container2)
                                                .getTags()
                                                .size());

                                // Create a folder, without any tags on it
                                Map<QName, Serializable> taggedFolderProps =
                                        new HashMap<QName, Serializable>(1);
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        assertEquals(
                                0,
                                taggingService.findTagScope(testData.container1).getTags().size());
                        assertEquals(
                                0,
                                taggingService.findTagScope(testData.container2).getTags().size());
                        ...
                        taggedFolderProps.put(
                                ContentModel.ASPECT_TAGGABLE, (Serializable) tagsList);
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        Map<QName, Serializable> taggedDocProps =
                                new HashMap<QName, Serializable>(1);
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // Check out the node
                        // Tags should be doubled up. (We don't care about
                        // ContentModel.ASPECT_WORKING_COPY
                        //  because it isn't applied at suitable times to take not of)
                        testData.checkedOutDoc =
                                checkOutCheckInService.checkout(testData.taggedDoc);
                        return null;
                    }
                });
        asyncOccurs.awaitExecution(
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                testData.container2,
                                nodeService.getPrimaryParent(testData.taggedDoc2).getParentRef());
                        assertEquals(
                                testData.container2,
                                taggingService.findTagScope(testData.taggedDoc2).getNodeRef());

                        // Copy the folder to another container
                        // Does a proper, recursing copy
                        testData.taggedFolder2 =
                                copyService.copy(
                                        testData.taggedFolder,
                                        testData.container2,
                                        ContentModel.ASSOC_CONTAINS,
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                testData.container2,
                                nodeService.getPrimaryParent(testData.taggedDoc).getParentRef());
                        assertEquals(
                                testData.container2,
                                taggingService.findTagScope(testData.taggedDoc).getNodeRef());
                        assertEquals(
                                testData.container2,
                                nodeService.getPrimaryParent(testData.taggedDoc2).getParentRef());
                        assertEquals(
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                null,
                                taggingService.findTagScope(testData.container2).getTag("bar"));
                ...
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        nodeService.deleteNode(
                                testData.taggedFolder); // container 1, "foo1", "foo3"
                        return null;
                    }
                });
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        nodeService.deleteNode(
                                testData.taggedFolder2); // container 2, has a child also
                        return null;
                    }
                });
        transactionService
                            ...
                            public Void execute() throws Throwable {
                                ...
                                assertEquals(
                                        ...
                                        taggingService
                                                ...
                                                .size());
                                assertEquals(
                                        0, nodeService.getChildAssocs(testData.container1).size());
                                assertEquals(
                                        0, nodeService.getChildAssocs(testData.container2).size());
                                return null;
                            }
                        });
    }
    ...
    /**
     * Ensures that a user can only tag a node they can write to, but that the tag scope updates
     * propagate upwards as the system (even to things the user can't write to) Also checks that
     * policies are disabled during tag scope updates, so that the auditable flags aren't
     * incorrectly set by the change
     */
    @Test
    @Category({RedundantTests.class, LuceneTests.class})
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        if (personService.personExists(USER_1)) personService.deletePerson(USER_1);
                        ...
                        personProperties.put(
                                ContentModel.PROP_AUTHORITY_DISPLAY_NAME, "title" + USER_1);
                        ...
                        nodeService.addAspect(
                                testData.auditableFolder, ContentModel.ASPECT_AUDITABLE, null);
                        taggingService.addTagScope(testData.auditableFolder);
                        permissionService.setPermission(
                                testData.auditableFolder, USER_1, PermissionService.CONSUMER, true);

                        // Auditable checks
                        assertEquals(
                                "System",
                                nodeService.getProperty(
                                        testData.auditableFolder, ContentModel.PROP_CREATOR));
                        assertEquals(
                                "System",
                                nodeService.getProperty(
                                        testData.auditableFolder, ContentModel.PROP_MODIFIER));
                        ...
                        testData.taggedNode =
                                nodeService
                                        .createNode(
                                                testData.auditableFolder,
                                                ContentModel.ASSOC_CONTAINS,
                                                QName.createQName("Tagged"),
                                                ContentModel.TYPE_CONTENT)
                                        .getChildRef();
                        permissionService.setPermission(
                                testData.taggedNode, USER_1, PermissionService.EDITOR, true);
                        ...
                        nodeService.setProperty(
                                ...
                                "To ensure we're allowed to write");
                        ...
                        assertEquals(
                                "System",
                                nodeService.getProperty(
                                        ts.getNodeRef(), ContentModel.PROP_MODIFIER));
                        return null;
                    }
                });
        // Due to timestamp propagation, we need to start a new transaction to get the current
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // Add a load of tags and tag scopes to the object and commit before
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                assertEquals(
                                        0,
                                        updateTagsAction.searchForTagScopesPendingUpdates().size());
                            ...
                            new Runnable() {
                                ...
                                public synchronized void run() {
                                    ...
                                    try {
                                        transactionService
                                                .getRetryingTransactionHelper()
                                                .doInTransaction(txnCallback);
                                    } catch (Throwable e) {
                                        logger.error("Tagging failed: " + e);
                                    }
                                    logger.debug(
                                            Thread.currentThread() + " - Done tagging for " + tag);
        ...
        for (int i = 0; i < 600; i++) {
            try {
                if (asyncOccurs.wantedActionsCount < tags.length) {
                    if (i % 50 == 0) {
                        logger.info(
                                "Done " + asyncOccurs.wantedActionsCount + " of " + tags.length);
                    }
                    Thread.sleep(100);
                    continue;
                }
     ...
     *
     * <p>When the audit queue for the tagging service contains more than 100 entries which aren't
     * update, {@link UpdateTagScopesActionExecuter} was failing to update the tag scope of
    ...
    public void testALF_17260() throws Exception {
        ...
        // Generate ~1800 audit entries, none of which are updates, as determined by
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        for (int j = 0; j < 10; j++) {
                            final int k = j;
                            RetryingTransactionCallback<NodeRef> createFoldersAndTags =
                            ...
                            NodeRef folder2 =
                                    transactionService
                                            .getRetryingTransactionHelper()
                                            .doInTransaction(createFoldersAndTags);
        ...
        // Prior to fixing ALF-17260, the tag scope of our container wasn't being updated correctly.
        // These
        ...
        asyncOccurs.awaitExecution(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        // Check that the tag scopes got populated
                        assertEquals(
                                "Wrong tags on folder: " + ts1.getTags(), 1, ts1.getTags().size());
                        assertEquals("Wrong tag name", TAG_1, ts1.getTags().get(0).getName());
                        assertEquals(
                                "Wrong number of documents", 1, ts1.getTags().get(0).getCount());
                        return null;
                    }
                });
    }
    ...
    public void testTagFileRead() throws UnsupportedEncodingException {
        List<TagDetails> tags =
                TaggingServiceImpl.readTagDetails(
    ...
    public void testPagedTags() throws UnsupportedEncodingException {
        ...
        assertNotNull(tags);
        PagingResults<Pair<NodeRef, String>> res =
                taggingService.getTags(storeRef, new PagingRequest(10));
        assertNotNull(res);
    ...
    /**
     * Tests that when the deleteTag() method runs, it will remove invalid references to the deleted
     * tag.
     */
    @Test
    @Category({RedundantTests.class, LuceneTests.class})
    public void testDeleteTag() throws Exception {
        ...
        try {
            ...
            // This is needed because this interceptor removes any properties which are invalid.
                    ...
                    .doInTransaction(
                            new RetryingTransactionCallback<Void>() {
                                ...
                                public Void execute() throws Throwable {
                                    ...
                                    // addTag uses lucene to get a reference to the existing TAG_1
                                    // tag node.
                                    // this fails without lucene
                                    taggingService.addTag(folder, TAG_1);

                                    // The deleteTag() should remove any reference to the deleted
                                    // tag
                                    List<NodeRef> taggableProperty =
                                            (List<NodeRef>)
                                                    nodeService.getProperty(
                                                            folder, ContentModel.PROP_TAGS);
                                    assertTrue(
                                            "Our folder should have a reference on one tag.",
                                            taggableProperty.size() == 1);
                                    ...
                                    taggableProperty =
                                            (List<NodeRef>)
                                                    nodeService.getProperty(
                                                            folder, ContentModel.PROP_TAGS);
                                    assertTrue(
                                            "Our folder shouldn't have any references left to"
                                                    + " deleted tags.",
                                            taggableProperty.size() == 0);
    ...
    public void testTagScopeIfUrlNull() {
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                // STEP1 CreateSite
                                SiteInfo siteInfo =
                                        createSite(siteName, "doclib", SiteVisibility.PUBLIC);

                                // STEP2 upload a document in documentLibrary
                                NodeRef documentLibraryOfSite =
                                        siteService.getContainer(siteInfo.getShortName(), "doclib");

                                NodeRef containerTagScope =
                                        fileFolderService
                                                .create(
                                                        documentLibraryOfSite,
                                                        "containerTagScope" + GUID.generate(),
                                                        ContentModel.TYPE_FOLDER)
                                                .getNodeRef();
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                final UpdateTagScopesActionExecuter updateTagsAction =
                                        (UpdateTagScopesActionExecuter)
                                                applicationContext.getBean("update-tagscope");
                                UpdateTagScopesQuartzJob job = new UpdateTagScopesQuartzJob();
                                job.execute(actionService, updateTagsAction);
        ...
        ScriptLocation location =
                new ClasspathScriptLocation(
                        "org/alfresco/repo/site/script/test_tagScopeALF_21875.js");
