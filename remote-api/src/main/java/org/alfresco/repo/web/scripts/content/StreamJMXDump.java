...
public class StreamJMXDump extends StreamContent {
    ...
    /**
     * @see
     *     org.springframework.extensions.webscripts.WebScript#execute(org.springframework.extensions.webscripts.WebScriptRequest,
    ...
    public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException {
        ...
        try {
            ...
            throw new WebScriptException(
                    ...
                    "Could not output JMX dump: " + ioe.getMessage(),
                    ioe);
        } finally {
