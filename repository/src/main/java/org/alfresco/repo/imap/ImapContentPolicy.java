...
public class ImapContentPolicy {
    ...
    public void init() {
        ...
        this.getPolicyComponent()
                .bindClassBehaviour(
                        ...
                        new JavaBehaviour(
                                this, "onAddAspect", NotificationFrequency.TRANSACTION_COMMIT));
        ...
        this.getPolicyComponent()
                .bindClassBehaviour(
                        ...
                        ImapModel.ASPECT_IMAP_CONTENT,
                        new JavaBehaviour(
                                this, "getCopyCallback", NotificationFrequency.EVERY_EVENT));
    }
    ...
    private static class ImapContentCopyBehaviourCallback extends DefaultCopyBehaviourCallback {
        private static final CopyBehaviourCallback INSTANCE =
                new ImapContentCopyBehaviourCallback();
        ...
        /**
         * Don't copy IMAP attachments or IMAP folder assocs since they belong to the "source"
         * message, not the "destination" message.
         *
         * @return Returns {@link AssocCopySourceAction#IGNORE} and {@link
