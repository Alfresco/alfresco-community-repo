...
public interface CopyBehaviourCallback {
   ...
   * @since 3.3SP3
   */
  public enum AssocCopySourceAction implements
    Comparable<AssocCopySourceAction> {
    /**
   ...
   * @since 3.3SP3
   */
  public enum AssocCopyTargetAction implements
    Comparable<AssocCopyTargetAction> {
    /**
   ...
   * @since 3.2
   */
  public enum ChildAssocRecurseAction implements
    Comparable<ChildAssocRecurseAction> {
    /**
  ...
  public static final class CopyAssociationDetails {
    ...
    public String toString() {
      ...
      sb
        .append("CopyChildAssociationDetails ")
        .append("[ assocRef=")
        .append(assocRef)
        .append(", copyTarget=")
        .append(copyTarget)
