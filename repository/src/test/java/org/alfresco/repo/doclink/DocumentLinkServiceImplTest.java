...
public class DocumentLinkServiceImplTest extends TestCase {
    ...
    public void testCreateFileLink() throws Exception {
        ...
        String site1File1LinkName =
                I18NUtil.getMessage("doclink_service.link_to_label", (site1File1Name + ".url"));
    ...
    public void testCreateFolderLink() throws Exception {
        ...
        // test if the link node is listed as a child of site1Folder2
        String site1Folder1LinkName =
                I18NUtil.getMessage("doclink_service.link_to_label", (site1Folder1Name + ".url"));
    ...
    /**
     * Tests the creation of a document link when the user doesn't have read permission on the
     * source node
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the creation of a document link when the user doesn't have write permission on the
     * destination node
     *
     * @throws Exception
     */
    public void testCreateDocLinkWithoutWritePermissionOnDestination() throws Exception {
        try {
            ...
            fail(
                    "no write permission on the destination node must generate"
    ...
    public void testCreateLinksNotAllowed() throws Exception {
        ...
        try {
            invalidLinkNodeRef =
                    documentLinkService.createDocumentLink(workingCopyNodeRef, site1Folder1);
            fail(
