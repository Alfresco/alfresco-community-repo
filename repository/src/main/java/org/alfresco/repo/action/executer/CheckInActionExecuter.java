...
public class CheckInActionExecuter extends ActionExecuterAbstractBase {
  ...
  public void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
    ...
    if (
      ...
      String description = (String) ruleAction.getParameterValue(
        PARAM_DESCRIPTION
      );
      ...
      Boolean minorChange = (Boolean) ruleAction.getParameterValue(
        PARAM_MINOR_CHANGE
      );
  ...
  protected void addParameterDefinitions(List<ParameterDefinition> paramList) {
    paramList.add(
      new ParameterDefinitionImpl(
        ...
        false,
        getParamDisplayLabel(PARAM_DESCRIPTION)
      )
    );
    paramList.add(
      new ParameterDefinitionImpl(
        ...
        false,
        getParamDisplayLabel(PARAM_MINOR_CHANGE)
      )
    );
  }
}
