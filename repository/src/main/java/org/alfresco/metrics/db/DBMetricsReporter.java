...
public interface DBMetricsReporter extends MetricsReporter
{
     ...
     *
     * @param milliseconds
     *            the delta time to record in milliseconds - must be positive
     * @param queryTpe
     *            mandatory, the type of query that we report for: e.g: "select", "insert", "update", "delete"
     * @param statementID
     *            optional. if this parameter is not provided, a metric without it will be recorded; this parameter is used only if "isQueryStatementsMetricsEnabled()" is true
     */
