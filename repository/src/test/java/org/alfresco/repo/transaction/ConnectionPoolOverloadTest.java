...
public class ConnectionPoolOverloadTest {
    ...
    public void testOverload() throws Exception {
        ...
        try {
            ...
            assertTrue(
                    "The number of open transactions should not be more that the db pool"
                            + " maximum.(Maybe a configuration of DB connection limit is less then"
                            + " db.pool.max) db.pool.max is "
                            + dbPoolMax
