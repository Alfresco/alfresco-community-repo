...
public interface AclDAO {
    /**
     * Transaction-scope setting to make the DAO guarantee the validity of all caches: some cache
     * data will be reloaded; some cache data will be considered safe.
     */
    ...
    /**
     * Delete the ACEs in position 0 (those set directly on the ACL and not inherited) Cleans up
     * existing acls
     *
     * @return - the id of all ACLs affected
     */
    ...
    /**
     * Delete the ACEs in position > 0 (those not set directly on the ACL but inherited) No affect
     * on any other acl
     *
     * @return - the id of all ACLs affected
     */
    ...
    /**
     * Delete all ACEs that reference this authority as no longer valid. THIS DOES NOT CAUSE ANY ACL
     * TO VERSION Used when deleting a user. No ACL is updated - the user has gone the aces and all
     * related info is deleted.
     *
     * @return - the id of all ACLs affected
     */
     ...
     *
     * @param pattern - non null elements are used for the match
     * @return - the id of all ACLs affected
     */
    ...
    /**
     * Get the id of the ACL inherited from the one given May return null if there is nothing to
     * inherit -> OLD world where nodes have their own ACL and we walk the parent chain
     */
    ...
    /**
     * @return the commit time of the current ACL change set entry or <tt>null</tt> if there have
