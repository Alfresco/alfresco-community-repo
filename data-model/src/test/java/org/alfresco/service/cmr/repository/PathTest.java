...
public class PathTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    typeQName =
      QName.createQName("http://www.alfresco.org/PathTest/1.0", "testType");
  ...
  public void testQNameElement() throws Exception {
    // plain
    Path.Element element = new Path.ChildAssocElement(
      new ChildAssociationRef(typeQName, parentRef, qname, childRef)
    );
    assertEquals(
      "Element string incorrect",
      qname.toString(),
    ...
    element =
      new Path.ChildAssocElement(
        new ChildAssociationRef(typeQName, parentRef, qname, childRef, true, 5)
      );
    assertEquals(
      "Element string incorrect",
      "{http://www.google.com}documentx[5]",
      element.getElementString()
    );
  }
  ...
  public void testAppendingAndPrepending() throws Exception {
    Path.Element element0 = new Path.ChildAssocElement(
      new ChildAssociationRef(null, null, null, parentRef)
    );
    Path.Element element1 = new Path.ChildAssocElement(
      new ChildAssociationRef(typeQName, parentRef, qname, childRef, true, 4)
    );
