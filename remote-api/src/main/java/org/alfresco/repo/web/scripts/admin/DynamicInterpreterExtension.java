...
/**
 * Console Interpeter script extension - dynamically binds to the configured BaseInterpreter
 * instance. This avoids the need for a specific bean class per script interpreter.
 *
 * @see org.alfresco.repo.admin.BaseInterpreter See script beans configured in
