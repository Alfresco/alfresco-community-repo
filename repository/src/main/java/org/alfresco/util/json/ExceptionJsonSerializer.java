...
public class ExceptionJsonSerializer
  ...
  public Throwable deserialize(JSONObject errorJSON) {
    ...
    try {
      ...
      JSONArray errorParamArray = errorJSON.optJSONArray(
        "alfrescoMessageParams"
      );
      ...
      try {
        try {
          ...
          try {
            ...
            createdObject =
              constructor.newInstance(errorId == null ? errorMessage : errorId);
      ...
      if (
        createdObject == null ||
        !Throwable.class.isAssignableFrom(createdObject.getClass())
      ) {
        result =
          new TransferException(
            errorId == null ? errorMessage : errorId,
            errorParams
          );
      } else {
      ...
      if (log.isDebugEnabled()) {
        log.debug(
          "Failed to deserialize Throwable object from JSON object",
          ex
        );
      }
    }
  ...
  public JSONObject serialize(Throwable object) {
    ...
    try {
      ...
      if (AlfrescoRuntimeException.class.isAssignableFrom(object.getClass())) {
        ...
        List<Object> params = msgParams == null
