...
public class SolrFacetComparator implements Comparator<SolrFacetProperties> {
    ...
    /**
     * Get the positional indices of the provided {@link SolrFacetProperties} in the {@link
     * #sortedIDs}.
     */
    private Pair<Integer, Integer> find(SolrFacetProperties facet1, SolrFacetProperties facet2) {
        return new Pair<>(
                sortedIDs.indexOf(facet1.getFilterID()), sortedIDs.indexOf(facet2.getFilterID()));
    }
