...
public class FileFolderServiceImpl
  ...
  public FileFolderServiceImpl() {
    ...
    fileFolderTrait =
      new ExtendedTrait<FileFolderServiceTrait>(
        AJProxyTrait.create(
          createFileFolderTrait(),
          FileFolderServiceTrait.class
        )
      );
  }
  ...
  private FileInfo toFileInfo(NodeRef nodeRef, boolean addTranslations)
    ...
    if (
      hiddenAspect.getVisibility(client, nodeRef) == Visibility.HiddenAttribute
    ) {
      isHidden = true;
    }
  ...
  public PagingResults<FileInfo> list(
    ...
    // execute query
    final CannedQueryResults<NodeRef> results = listImpl(
      contextNodeRef,
      null,
      searchTypeQNames,
      ignoreAspectQNames,
  ...
  public PagingResults<FileInfo> list(
    ...
    CannedQueryResults<NodeRef> results = listImpl(
      rootNodeRef,
      null,
      searchTypeQNames,
      ignoreAspectQNames,
  ...
  private CannedQueryResults<NodeRef> listImpl(
    ...
    Set<QName> searchTypeQNames = buildSearchTypesAndIgnoreAspects(
      files,
      folders,
      null
    )
  ...
  public List<FileInfo> listDeepFolders(
    ...
    List<NodeRef> nodeRefs = listSimpleDeep(
      contextNodeRef,
      false,
      true,
      filter
  ...
  public NodeRef getLocalizedSibling(NodeRef nodeRef) {
    ...
    List<Locale> candidateLocales = resourceHelper.getCandidateLocales(
      base,
      userLocale
    );
    for (Locale candidateLocale : candidateLocales) {
      String filename =
        resourceHelper.toBundleName(base, candidateLocale) + "." + ext;
  ...
  public List<FileInfo> search(
    ...
    List<NodeRef> nodeRefs = searchInternal(
      contextNodeRef,
      namePattern,
      fileSearch,
      folderSearch,
  ...
  private List<NodeRef> searchInternal(
    ...
    if (anyName) {
      ...
      if (includeSubFolders) {
        nodeRefs =
          listSimpleDeep(contextNodeRef, fileSearch, folderSearch, null);
      } else {
  ...
  private List<FileInfo> listSimple(
    NodeRef contextNodeRef,
    boolean files,
    boolean folders
  ) throws InvalidTypeException {
  ...
  private Pair<Set<QName>, Set<QName>> buildSearchTypesAndIgnoreAspects(
    ...
    if (ignoreQNameTypes != null) {
      Set<QName> ignoreQNamesNotSearchTypes = new HashSet<QName>(
        ignoreQNameTypes
      );
    ...
    return new Pair<Set<QName>, Set<QName>>(
      searchTypeQNames,
      ignoreAspectQNames
    );
  }
  ...
  private List<NodeRef> listSimpleDeep(
    ...
    Set<QName> fileTypeQNames =
      (files ? buildFileTypes() : new HashSet<QName>(0));
    ...
    while (!toSearch.empty()) {
      ...
      List<ChildAssociationRef> folderAssocRefs = nodeService.getChildAssocs(
        currentDir,
        folderTypeQNames
      );
      ...
      if (files) {
        ...
        List<ChildAssociationRef> fileAssocRefs = nodeService.getChildAssocs(
          currentDir,
          fileTypeQNames
        );
  ...
  private FileInfo moveOrCopy(
    ...
    AssociationCopyInfo targetInfo = getAssociationCopyInfo(
      nodeService,
      sourceNodeRef,
      sourceParentRef,
      newName,
    ...
    if (nameChanged && move) {
      ...
      if (
        dictionaryService.isSubClass(targetParentType, ContentModel.TYPE_FOLDER)
      ) {
    ...
    if (
      ...
      (
        move ||
        !nodeService.hasAspect(sourceNodeRef, ContentModel.ASPECT_WORKING_COPY)
      )
    ) {
      try {
        ...
        String oldExt = getExtension(beforeFileInfo.getName(), true)
          .getSecond();
        ...
        if (
          ...
          final ContentReader reader = contentService.getReader(
            targetNodeRef,
            ContentModel.PROP_CONTENT
          );
  ...
  public List<FileInfo> getNamePath(NodeRef rootNodeRef, NodeRef nodeRef)
    ...
    try {
      ...
      for (Path.Element element : path) {
        ...
        FileInfo pathInfo = AuthenticationUtil.runAs(
   ...
   */
  @Override
  public List<String> getNameOnlyPath(
    NodeRef rootNodeRef,
  ...
  public void setHidden(NodeRef nodeRef, boolean isHidden) {
    ...
    Visibility webDavVisibility = isHidden
      ? Visibility.NotVisible
      : Visibility.Visible;
    for (Client client : hiddenAspect.getClients()) {
      Visibility clientVisibility = client == FileFilterMode.getClient()
        ? webDavVisibility
  ...
  public boolean isHidden(NodeRef nodeRef) {
    return (
      hiddenAspect.getVisibility(FileFilterMode.getClient(), nodeRef) !=
      Visibility.Visible
    );
  }
  ...
  public static class FileFolderServiceTraitImpl
    ...
    public FileFolderServiceTraitImpl(
      FileFolderServiceImpl fileFolderServiceImpl
    ) {
    ...
    public Pair<Set<QName>, Set<QName>> buildSearchTypesAndIgnoreAspects(
      ...
      return thisService.buildSearchTypesAndIgnoreAspects(
        files,
        folders,
        ignoreQNameTypes
      );
