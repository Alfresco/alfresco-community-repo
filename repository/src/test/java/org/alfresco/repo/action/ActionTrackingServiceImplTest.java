...
public class ActionTrackingServiceImplTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        this.executingActionsCache =
                (SimpleCache<String, ExecutionDetails>) ctx.getBean("executingActionsCache");
    ...
    public void testWorkingActions() throws Exception {
        ...
        asyncOccurs.awaitExecution(
                null, sleepActionExec.getExecutingThread(), action.getActionDefinitionName());
    ...
    private Action performFailingActionImpl(boolean fatalFailure, String actionId)
            throws Exception {
        final SleepActionExecuter sleepActionExec =
                (SleepActionExecuter) ctx.getBean(SleepActionExecuter.NAME);
        sleepActionExec.setSleepMs(10000);
    ...
    public void testListings() throws Exception {
        ...
        assertEquals(
                0,
                actionTrackingService.getExecutingActions(createWorkingSleepAction(null)).size());
    ...
    public void testCancellation() throws Exception {
        ...
        CancellableSleepAction sleepAction1 =
                (CancellableSleepAction) createWorkingSleepAction(null);
        CancellableSleepAction sleepAction2 =
                (CancellableSleepAction) createWorkingSleepAction(null);
        actionTrackingService.recordActionExecuting(sleepAction1);
        actionTrackingService.recordActionExecuting(sleepAction2);
        ...
        CancellableSleepAction sleepAction3 =
                (CancellableSleepAction) createWorkingSleepAction(null);
    ...
    /**
     * Tests that when we run an action, either synchronously or asynchronously, with it working or
     * failing, that the action execution service correctly sets the flags
     */
