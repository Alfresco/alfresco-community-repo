...
public class SavedSearchDetailsCompatibility implements RecordsManagementModel {
  ...
  public static RecordsManagementSearchParameters createSearchParameters(
    ...
    for (String value : values) {
      ...
      if ("records".equals(paramName)) {
        ...
        "categories".equals(paramName) && Boolean.parseBoolean(paramValue)
      ) {
  ...
  public String getSort() {
    ...
    for (SortItem entry : this.savedSearchDetails.getSearchParameters()
      .getSortOrder()) {
      if (builder.length() != 0) {
        builder.append(",");
      }
      ...
      builder
        .append(entry.property.toPrefixString(this.namespaceService))
        .append("/")
        .append(order);
    }
  ...
  public String getParams() {
    ...
    builder
      ...
      .append("undeclared=")
      .append(
        this.savedSearchDetails.getSearchParameters()
          .isIncludeUndeclaredRecords()
      )
      .append("&")
      .append("vital=")
      .append(
        this.savedSearchDetails.getSearchParameters().isIncludeVitalRecords()
      )
      .append("&")
      .append("folders=")
      .append(
        this.savedSearchDetails.getSearchParameters().isIncludeRecordFolders()
      )
      .append("&")
      .append("frozen=")
  ...
  public String getQuery() {
    return searchService.buildQueryString(
      this.savedSearchDetails.getSearch(),
      this.savedSearchDetails.getSearchParameters()
    );
  }
}
