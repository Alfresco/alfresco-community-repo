...
public class SiteGroupsRelation
     ...
     *
     * <p>Adds groups to site
     *
     * <p>If group does not exist throws NotFoundException (status 404).
     *
    ...
    public List<SiteGroup> create(
            String siteId, List<SiteGroup> siteMembers, Parameters parameters) {
        return siteMembers.stream()
     ...
     *
     * <p>GET sites/<siteId>/group-members/<groupId>
     */
    @Override
     ...
     *
     * <p>Updates the membership of group in the site.
     */
    @Override
