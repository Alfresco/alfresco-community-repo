...
public class ScriptTransferService extends BaseScopableProcessorExtension {
     ...
     *
     * <p>Nodes are to be locked read only on target.
     *
     * @param targetName the name of the target to transfer to
     * @param nodesToTransfer the nodes to transfer - Java Script Array of either ScriptNodes,
     *     NodeRef or String
    ...
    public ScriptNode transferReadOnly(String targetName, Object nodesToTransfer) {
        ...
        if (nodesObject instanceof Collection) {
            for (Object value : (Collection) nodesObject) {
                if (value instanceof NodeRef) {
                    ...
                    throw new IllegalArgumentException(
                            "transfer: unknown type in collection: " + value.getClass().getName());
                }
            }
            ...
            throw new IllegalArgumentException(
                    "transfer: unexpected type for nodes :" + nodesObject.getClass().getName());
        }
     ...
     * Transfer a set of nodes, with no callback
     *
     * <p>Nodes are not locked on the target.
     *
     * @param targetName the name of the target to transfer to
     * @param nodesToTransfer the nodes to transfer - Java Script Array of either ScriptNodes,
     *     NodeRef or String
     ...
     *
     * @param targetName the name of the target to transfer to
     * @param nodesToRemove the nodes to transfer - Java Script Array of either ScriptNodes, NodeRef
     *     or String
     * @return node ref of transfer report.
     */
    @SuppressWarnings("unchecked")
