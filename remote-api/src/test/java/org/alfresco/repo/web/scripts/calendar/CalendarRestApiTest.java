...
public class CalendarRestApiTest extends BaseWebScriptTest {
  ...
  private static final String SITE_SHORT_NAME_CALENDAR =
    "CalendarSiteShortNameTest";
  ...
  protected void setUp() throws Exception {
    ...
    if (
      !siteService.hasContainer(
        SITE_SHORT_NAME_CALENDAR,
        CalendarServiceImpl.CALENDAR_COMPONENT
      )
    ) {
  ...
  private JSONObject getEntry(String name, int expectedStatus)
    throws Exception {
    Response response = sendRequest(
      new GetRequest(URL_EVENT_BASE + name),
      expectedStatus
    );
  ...
  public void testCreateEditDeleteEntry() throws Exception {
    ...
    assertEquals(
      "2011-06-29",
      entry.getJSONObject("startAt").getString("legacyDate")
    ); // Different format!
    assertEquals(
      "2011-06-29",
      entry.getJSONObject("endAt").getString("legacyDate")
    ); // Different format!
    assertEquals(
      "12:00",
      entry.getJSONObject("startAt").getString("legacyTime")
    );
    ...
    assertEquals(
      ...
      entry.getJSONObject("startAt").get("iso8601")
    );
    ...
    assertEquals(
      ...
      entry.getJSONObject("endAt").get("iso8601")
    );
    ...
    assertEquals(
      "2011-06-28T11:30",
      entry.getJSONObject("startAt").getString("legacyDateTime")
    );
    assertEquals(
      "2011-06-28T13:30",
      entry.getJSONObject("endAt").getString("legacyDateTime")
    );
    assertEquals("false", entry.getString("allday"));
    // No isoutlook on create/edit
    ...
    // Delete
    sendRequest(
      new DeleteRequest(URL_EVENT_BASE + name),
    ...
    sendRequest(
      new PutRequest(URL_EVENT_BASE + name, "{}", "application/json"),
      Status.STATUS_OK
    );
    assertEquals(true, entry.has("error"));
  }
  ...
  public void testCreateAllDayEntry() throws Exception {
    ...
    entry =
      createAllDayEntry(EVENT_TITLE_ONE, "Where", "Thing", Status.STATUS_OK);
    name = getNameFromEntry(entry);
  ...
  public void testPermissions() throws Exception {
    ...
    NodeRef calendarNodeRef = siteService.getContainer(
      SITE_SHORT_NAME_CALENDAR,
      CalendarServiceImpl.CALENDAR_COMPONENT
    );
  ...
  public void testDifferentDateStyles() throws Exception {
    ...
    json.put("end", "12:00");
    entry =
      createEntry(EVENT_TITLE_ONE, "Where", "Thing", json, Status.STATUS_OK);
    ...
    assertEquals(
      "2011-06-21T12:45:25.000+01:00",
      entry.getJSONObject("endAt").getString("iso8601")
    );
  ...
  public void testOverallListing() throws Exception {
    ...
    assertTrue(
      "Title not found:\n" + ical,
      ical.contains("SUMMARY:" + EVENT_TITLE_ONE)
    );
    assertTrue(
      "Title not found:\n" + ical,
      ical.contains("SUMMARY:" + EVENT_TITLE_TWO)
    );
    assertTrue(
      "Title not found:\n" + ical,
      ical.contains("SUMMARY:" + EVENT_TITLE_THREE)
    );
  }
  ...
  public void testUserListing() throws Exception {
    ...
    assertEquals(
      SITE_SHORT_NAME_CALENDAR,
      events.getJSONObject(0).getString("site")
    );
    assertEquals(
      SITE_SHORT_NAME_CALENDAR,
      events.getJSONObject(1).getString("site")
    );
    assertEquals(
      SITE_SHORT_NAME_CALENDAR,
      events.getJSONObject(2).getString("site")
    );
    ...
    Response response = sendRequest(
      new GetRequest(URL_USER_EVENTS_LIST + "?from=2000/01/01"),
      200
    );
  ...
  public void testRepeatingEventsInListings() throws Exception {
    ...
    JSONObject entry1 = createEntry(
      EVENT_TITLE_ONE,
      "Somewhere",
      "Thing 1",
      Status.STATUS_OK
    );
    JSONObject entry2 = createEntry(
      EVENT_TITLE_TWO,
      "Somewhere",
      "Thing 2",
      Status.STATUS_OK
    ...
    assertEquals(
      EVENT_TITLE_TWO + " (Repeating)",
      events.getJSONObject(0).getString("title")
    );
    assertEquals(EVENT_TITLE_ONE, events.getJSONObject(1).getString("title"));
    ...
    assertEquals(
      EVENT_TITLE_TWO + " (Repeating)",
      events.getJSONObject(0).getString("name")
    );
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("6/28/2011").getJSONObject(0).get("name")
    );
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("6/29/2011").getJSONObject(0).get("name")
    );
    assertEquals(
      EVENT_TITLE_ONE,
      result.getJSONArray("6/29/2011").getJSONObject(1).get("name")
    );
    // 1st repeat Friday
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("7/1/2011").getJSONObject(0).get("name")
    );
    // 2nd repeat Wednesday
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("7/13/2011").getJSONObject(0).get("name")
    );
    // 2nd repeat Friday
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("7/15/2011").getJSONObject(0).get("name")
    );
    // 3rd repeat Wednesday
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("7/27/2011").getJSONObject(0).get("name")
    );
    // 3rd repeat Friday
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("7/29/2011").getJSONObject(0).get("name")
    );
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("8/24/2011").getJSONObject(0).get("name")
    );
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("8/26/2011").getJSONObject(0).get("name")
    );
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("9/7/2011").getJSONObject(0).get("name")
    );
    ...
    assertEquals(
      EVENT_TITLE_TWO,
      result.getJSONArray("9/9/2011").getJSONObject(0).get("name")
    );
  }
}
