...
public class ActionImpl extends ParameterizedItemImpl implements Action {
    ...
    /**
     * When there is more than one instance of the action executing, both with the same ID, which
     * one is this? This crops up most often with persisted actions, with two copies running, one on
    ...
    /**
     * Records the date when the action began execution, normally called by the {@link
     * org.alfresco.service.cmr.action.ActionService} when it starts running the action.
     */
    ...
    /**
     * Records the date when the action finished execution, normally called by the {@link
     * org.alfresco.service.cmr.action.ActionService} when the action completes or fails.
     */
    ...
    /**
     * Updates the current execution status. This is normally called by the {@link
     * org.alfresco.service.cmr.action.ActionService} as it progresses the Action's execution.
     */
