...
public class DbToXML {
    ...
    /**
     * Constructor. Allows specification of a name prefix, e.g. "jpbm_", that will be used during
     * the export.
     */
    ...
    private void writeToFile(String content) {
        PrintWriter pw =
                printWriter(outputFile, SchemaComparator.CHAR_SET, SchemaComparator.LINE_SEPARATOR);
