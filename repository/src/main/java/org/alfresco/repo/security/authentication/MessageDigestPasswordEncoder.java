 ...
 *
 * <p>This class can be used stand-alone, or one of the subclasses can be used for compatiblity and
 * convenience. When using this class directly you must specify a <a href=
 * "http://java.sun.com/j2se/1.4.2/docs/guide/security/CryptoSpec.html#AppA"> Message Digest
 * Algorithm</a> to use as a constructor arg
 *
 * <p>The encoded password hash is normally returned as Hex (32 char) version of the hash bytes.
 * Setting the <tt>encodeHashAsBase64</tt> property to <tt>true</tt> will cause the encoded pass to
 * be returned as Base64 text, which will consume 24 characters. See {@link
 * BaseDigestPasswordEncoder#setEncodeHashAsBase64(boolean)}
 *
 * <p>This PasswordEncoder can be used directly as in the following example:<br>
 *
 * <pre>
...
public class MessageDigestPasswordEncoder extends BaseDigestPasswordEncoder {
     ...
     * "http://java.sun.com/j2se/1.4.2/docs/guide/security/CryptoSpec.html#AppA" > Message Digest
     * Algorithms</a> in the Java environment.
     *
