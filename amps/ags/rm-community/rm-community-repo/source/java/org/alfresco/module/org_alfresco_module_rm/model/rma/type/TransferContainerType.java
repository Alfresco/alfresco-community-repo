...
public class TransferContainerType
  ...
  private static final String BEHAVIOUR_NAME =
    "onCreateChildAssocsForTransferContainer";
  private static final String DELETE_BEHAVIOUR_NAME =
    "onDeleteTransferContainer";
  ...
  public void onCreateChildAssociation(
    ...
    throw new IntegrityException(
      I18NUtil.getMessage(MSG_ERROR_ADD_CHILD_TO_TRANSFER_CONTAINER),
      null
    );
  }
  ...
  public void onDeleteNode(
    ...
    throw new IntegrityException(
      "Operation failed. Deletion of Transfer Container is not allowed.",
      null
    );
  }
}
