...
public interface RemoteConnectorService
{
     ...
     * 
     * @throws IOException
     *             If there was a problem with the communication to the server
     * @throws AuthenticationException
     *             If the authentication details supplied were not accepted
     * @throws RemoteConnectorClientException
     *             If the server indicates the client request was invalid
     * @throws RemoteConnectorServerException
     *             If the server was itself unable to perform the request
     */
