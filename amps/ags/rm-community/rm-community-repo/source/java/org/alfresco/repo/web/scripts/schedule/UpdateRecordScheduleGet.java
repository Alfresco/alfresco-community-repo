    ...
    protected Map<String, Object> buildModel(WebScriptRequest req, WebScriptResponse res)
        ...
        if (recordFolder != null) {
            ...
            for (Long i = 0L; i < maxNodeId; i += queryBatchSize) {
                List<NodeRef> folders =
                        recordsManagementQueryDAO.getRecordFoldersWithSchedules(
                                i, i + queryBatchSize);
            ...
            message =
                    MessageFormat.format(
                            MESSAGE_ALL_TEMPLATE, processedRecords, processedRecordFolders);
        }
                            ...
                            public Integer execute() throws Throwable {
                                ...
                                try {
                                    ...
                                    nodeService.addAspect(
                                            recordFolder, ASPECT_DISPOSITION_PROCESSED, null);
                                } finally {
