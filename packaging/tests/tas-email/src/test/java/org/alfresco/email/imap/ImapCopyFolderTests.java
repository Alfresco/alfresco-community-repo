...
public class ImapCopyFolderTests extends EmailTest {
  ...
  public void adminShouldCopyNonEmptyFolder() throws Exception {
    ...
    FolderModel copyFolder = dataContent
      .usingAdmin()
      .usingSite(adminSite)
      .createFolder();
  ...
  public void siteManagerShouldNotCopyFolderThatHasBeenDeleted()
    throws Exception {
    testFolder =
      dataContent.usingUser(testUser).usingSite(testSite).createFolder();
  ...
  public void userCopyFolderToALocationThatHeDoesNotHaveAccess()
    throws Exception {
