...
public class SolrFacetServiceImplTest {
  ...
  private static final Log logger = LogFactory.getLog(
    SolrFacetServiceImplTest.class
  );
  ...
  public static void initStaticData() throws Exception {
    SOLR_FACET_SERVICE =
      APP_CONTEXT_INIT
        ...
        .getBean("solrFacetService", SolrFacetService.class);
    TRANSACTION_HELPER =
      APP_CONTEXT_INIT
        .getApplicationContext()
  ...
  public void updateFacet() {
    ...
    final SolrFacetProperties facetProps = new SolrFacetProperties.Builder()
      .filterID(filterName)
      .facetQName(
        QName.createQName("{http://www.alfresco.org/model/content/1.0}test")
      )
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        @Override
        public Void execute() throws Throwable {
          SolrFacetProperties updatedFacetProps = new SolrFacetProperties.Builder(
            facetProps
          )
            .maxFilters(10)
            .build();
          ...
          assertEquals(
            ...
            updatedFacetProps.getFacetQName().toString()
          );
          assertEquals(
            "faceted-search.facet-menu.facet.test",
            updatedFacetProps.getDisplayName()
          );
          assertEquals(
            "alfresco/search/FacetFilters",
            updatedFacetProps.getDisplayControl()
          );
  ...
  public void deleteDefaultFacet() {
    ...
    final String defaultFilterName = TRANSACTION_HELPER.doInTransaction(
  ...
  public void deleteFacet() {
    ...
    final SolrFacetProperties facetProps = new SolrFacetProperties.Builder()
      .filterID(filterName)
      .facetQName(
        QName.createQName("{http://www.alfresco.org/model/content/1.0}test2")
      )
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          SolrFacetProperties solrFacetProperties = SOLR_FACET_SERVICE.getFacet(
            filterName
          );
  ...
  public void createFacet() {
    ...
    final SolrFacetProperties facetProps = new SolrFacetProperties.Builder()
      .filterID(filterName)
      .facetQName(
        QName.createQName("{http://www.alfresco.org/model/content/1.0}test3")
      )
    ...
    SolrFacetProperties facetProperties = SOLR_FACET_SERVICE.getFacet(
      filterName
    );
    ...
    try {
      facetProperties =
        new SolrFacetProperties.Builder().filterID(filterName).build();
  ...
  private List<String> getExistingFacetIds() {
    ...
    final List<String> facetIds = CollectionUtils.transform(
      facetProps,
