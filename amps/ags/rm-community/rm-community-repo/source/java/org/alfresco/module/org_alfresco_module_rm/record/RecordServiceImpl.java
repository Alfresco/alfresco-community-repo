...
public class RecordServiceImpl extends BaseBehaviourBean
    ...
    private static final QName[] ALWAYS_EDIT_PROPERTIES =
            new QName[] {ContentModel.PROP_LAST_THUMBNAIL_MODIFICATION_DATA};
    ...
    private static final String[] NON_RECORD_MODEL_URIS =
            new String[] {
    ...
    public void setRecordsManagementContainerType(
            RecordsManagementContainerType recordsManagementContainerType) {
    ...
    /**
     * @param checkMandatoryPropertiesEnabled true if check mandatory properties is enabled, false
     *     otherwise
     */
    ...
    public void init() {
        ...
        beforeRecordDeclarationDelegate =
                policyComponent.registerClassPolicy(BeforeRecordDeclaration.class);
        onRecordDeclarationDelegate =
                policyComponent.registerClassPolicy(OnRecordDeclaration.class);
        beforeRecordRejectionDelegate =
                policyComponent.registerClassPolicy(BeforeRecordRejection.class);
    ...
    /**
     * @see
     *     org.alfresco.repo.node.NodeServicePolicies.OnRemoveAspectPolicy#onRemoveAspect(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.namespace.QName)
     */
    @Override
     ...
     */
    @Override
    @Behaviour(kind = ASSOCIATION, type = "rma:recordFolder", notificationFrequency = FIRST_EVENT)
                        ...
                        try {
                            ...
                            if (nodeService.exists(nodeRef)
                                    && !nodeService.hasAspect(
                                            nodeRef, ContentModel.ASPECT_TEMPORARY)
                                ...
                                if (bNew) {
                                    Set<NodeRef> newRecords =
                                            transactionalResourceHelper.getSet(KEY_NEW_RECORDS);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#disablePropertyEditableCheck()
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#disablePropertyEditableCheck(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#enablePropertyEditableCheck()
     */
    @Override
     ...
     *
     * @return {@link Map}&lt;{@link QName}, {@link Set}&lt;{@link QName} &gt;&gt; map containing
     ...
     *
     * <p>This is here to support backwards compatibility in case an existing customization (pre
     * 2.2) is still using the record meta-data aspect.
     *
     * @since 2.2
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#registerRecordMetadataAspect(org.alfresco.service.namespace.QName,
     *     org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#isRecordMetadataAspect(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#isRecordMetadataProperty(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#getRecordMetadataAspects(NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#getRecordMetadataAspects(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#createRecord(org.alfresco.service.cmr.repository.NodeRef,
    ...
    public void createRecord(
            final NodeRef filePlan, final NodeRef nodeRef, final boolean isLinked) {
    ...
    @Override
    public void createRecord(
            final NodeRef filePlan, final NodeRef nodeRef, final NodeRef destinationNodeRef) {
    ...
    public void createRecord(
        ...
        final NodeRef newRecordContainer =
                recordCreationSanityCheckOnDestinationNode(destinationNodeRef, filePlan);
                        ...
                        if (!nodeService.hasAspect(nodeRef, ASPECT_RECORD)) {
                            ...
                            try {
                                ...
                                Pair<Set<String>, Set<String>> readersAndWriters =
                                        extendedPermissionService.getReadersAndWriters(nodeRef);
                                ...
                                aspectProperties.put(
                                        PROP_RECORD_ORIGINATING_CREATION_DATE, new Date());
                                nodeService.addAspect(
                                        nodeRef,
                                        ASPECT_RECORD_ORIGINATING_DETAILS,
                                        aspectProperties);
                                ...
                                if (latestVersionRecord != null) {
                                    ...
                                    versionRecordProps.put(
                                            RecordableVersionModel.PROP_VERSION_LABEL,
                                            I18NUtil.getMessage(FINAL_VERSION));
                                    versionRecordProps.put(
                                            RecordableVersionModel.PROP_VERSION_DESCRIPTION,
                                            I18NUtil.getMessage(FINAL_DESCRIPTION));
                                    nodeService.addAspect(
                                            nodeRef,
                                            RecordableVersionModel.ASPECT_VERSION_RECORD,
                                            versionRecordProps);
    ...
    /**
     * Helper method to check the given file plan before trying to determine the unfiled records
     * container.
     *
    ...
    private NodeRef recordCreationSanityCheckOnFilePlan(NodeRef filePlan) {
        ...
        if (filePlan == null) {
            ...
            if (result == null) {
                String msg =
                        "Cannot create record, because the default file plan cannot be determined."
                                + " Make sure at least one file plan has been created.";
                LOGGER.debug(msg);
            ...
            if (!filePlanService.isFilePlan(filePlan)) {
                String msg =
                        "Cannot create record, because the provided file plan node reference is not"
                                + " a file plan.";
                LOGGER.debug(msg);
                throw new RecordCreationException(msg);
            }
     ...
     * @param filePlan The reference of the file plan node
     */
    private NodeRef recordCreationSanityCheckOnDestinationNode(
            NodeRef destinationNodeRef, final NodeRef filePlan) {
        ...
        if (newRecordContainer == null) {
            ...
            newRecordContainer =
                    AuthenticationUtil.runAsSystem(
                            () -> filePlanService.getUnfiledContainer(checkedFilePlan));

            if (newRecordContainer == null) {
                throw new AlfrescoRuntimeException(
                        "Unable to create record, because record container could not be found.");
            }
        }
        // if optional location supplied, check that it is a valid record folder, unfiled record
        // container or folder
        else {
            ...
            if (!(nodeType.equals(RecordsManagementModel.TYPE_RECORD_FOLDER)
                ...
                throw new AlfrescoRuntimeException(
                        "Unable to create record, because container is not a valid type for new"
                                + " record.");
            }

            Boolean isClosed =
                    (Boolean) nodeService.getProperty(newRecordContainer, PROP_IS_CLOSED);
            ...
            if (extendedPermissionService.hasPermission(
                            newRecordContainer, RMPermissionModel.FILING)
                    == AccessStatus.DENIED) {
            ...
            if (freezeService.isFrozen(newRecordContainer)) {
                throw new IntegrityException(
                        I18NUtil.getMessage("rm.service.add-children-to-frozen-record-folder"),
                        null);
            }
        }
    ...
    private void recordCreationSanityCheckOnNode(NodeRef nodeRef) {
        // first we do a sanity check to ensure that the user has at least write permissions on the
        // document
        if (extendedPermissionService.hasPermission(nodeRef, PermissionService.WRITE)
                != AccessStatus.ALLOWED) {
            String msg =
                    "Cannot create record from document, because the user "
        ...
        // TODO eventually we should support other types .. either as record folders or as composite
        // records
        if (!dictionaryService.isSubClass(
                nodeService.getType(nodeRef), ContentModel.TYPE_CONTENT)) {
            String msg =
                    "Cannot create record, because "
                            + nodeRef.toString()
        ...
        if (nodeService.hasAspect(nodeRef, ASPECT_RECORD)) {
            String msg =
                    "Cannot create record, because " + nodeRef.toString() + " is already a record.";
            LOGGER.debug(msg);
            throw new RecordCreationException(msg);
        }
        ...
        if (nodeService.hasAspect(nodeRef, ContentModel.ASPECT_WORKING_COPY)) {
            String msg =
                    "Can node create record, because " + nodeRef.toString() + " is a working copy.";
            LOGGER.debug(msg);
            throw new RecordCreationException(msg);
        }
        ...
        if (nodeService.hasAspect(nodeRef, ASPECT_SYNCED)) {
            String msg =
                    "Can't declare as record, because "
                            + nodeRef.toString()
                            + " is synched content.";
            LOGGER.debug(msg);
            throw new RecordCreationException(msg);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#createRecordFromCopy(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
        ...
        return authenticationUtil.runAsSystem(
                new RunAsWork<NodeRef>() {
                    public NodeRef doWork() throws Exception {
                        ...
                        final NodeRef unfiledRecordFolder =
                        ...
                        try {
                            ...
                            if (nodeService.hasAspect(nodeRef, ContentModel.ASPECT_COPIEDFROM)) {
                                ...
                                originalAssocs =
                                        nodeService.getTargetAssocs(
                                                nodeRef, ContentModel.ASSOC_ORIGINAL);
                            }

                            recordsManagementContainerType.disable();
                            try {
                                // create a copy of the original state and add it to the unfiled
                                // record container
                                FileInfo recordInfo =
                                        fileFolderService.copy(nodeRef, unfiledRecordFolder, null);
                            ...
                            List<AssociationRef> recordAssocs =
                                    nodeService.getTargetAssocs(
                                            record, ContentModel.ASSOC_ORIGINAL);
                            ...
                            throw new AlfrescoRuntimeException(
                                    "Can't create recorded version, because copy fails.", e);
                        }
    ...
    private NodeRef getLatestVersionRecord(NodeRef nodeRef) {
        ...
        if (versionHistory != null) {
            ...
            for (Version previousVersion : previousVersions) {
                ...
                final NodeRef previousRecord =
                        recordableVersionService.getVersionRecord(previousVersion);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#createRecordFromContent(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String, org.alfresco.service.namespace.QName, java.util.Map,
     *     org.alfresco.service.cmr.repository.ContentReader)
     */
    @Override
    public NodeRef createRecordFromContent(
            NodeRef parent,
            String name,
            QName type,
        ...
        if (isFilePlan(parent)) {
            ...
            if (destination == null) {
                throw new AlfrescoRuntimeException(
                        "Unable to create record, because unfiled container could not be found.");
            }
        }
                                ...
                                public NodeRef doWork() throws Exception {
                                    ...
                                    if (!nodeService.hasAspect(record, ASPECT_RECORD)) {
                                        ...
                                        generateRecordIdentifier(
                                                nodeService, identifierService, record);
                                    }
        ...
        try {
            authenticationUtil.runAsSystem(
                    new RunAsWork<Void>() {
                        ...
                        public Void doWork() throws Exception {
                            nodeService.addAspect(
                                    document, RecordsManagementModel.ASPECT_RECORD, null);

                            // remove versionable aspect(s)
                            nodeService.removeAspect(
                                    document, RecordableVersionModel.ASPECT_VERSIONABLE);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#isFiled(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
                    ...
                    AuthenticationUtil.runAsSystem(
                            new RunAsWork<Boolean>() {
                                public Boolean doWork() throws Exception {
                                    return (null
                                            != nodeService.getProperty(nodeRef, PROP_DATE_FILED));
                                }
                            });
        }
     ...
     *
     * <p>TODO atm we only 'file' content as a record .. may need to consider other types if we are
     * to support the notion of composite records.
     *
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#rejectRecord(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    @Override
    public void rejectRecord(final NodeRef nodeRef, final String reason) {
        ...
        AuthenticationUtil.runAsSystem(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        try {
                            ...
                            final String documentOwner =
                                    (String) properties.get(PROP_RECORD_ORIGINATING_USER_ID);
                            final String originalName =
                                    (String) properties.get(PROP_ORIGIONAL_NAME);
                            final NodeRef originatingLocation =
                                    (NodeRef) properties.get(PROP_RECORD_ORIGINATING_LOCATION);
                            ...
                            if (originatingLocation != null) {
                                ...
                                final List<ChildAssociationRef> parentAssocs =
                                ...
                                final ChildAssociationRef parentAssoc =
                                        nodeService.getPrimaryParent(nodeRef);
                                ...
                                nodeService.addAspect(
                                        nodeRef, ASPECT_RECORD_REJECTION_DETAILS, aspectProperties);

                                // Restore the owner of the document
                                if (StringUtils.isBlank(documentOwner)) {
                                    throw new AlfrescoRuntimeException(
                                            "Unable to find the creator of document.");
                                }
                                ...
                                notificationHelper.recordRejectedEmailNotification(
                                        nodeRef, recordId, documentOwner);
                            }
                        } finally {
                            ruleService.enableRules();
                        }
                    ...
                    /**
                     * Removes all RM related aspects from the specified node and any rendition
                     * children.
                     */
                    private void removeRmAspectsFrom(NodeRef nodeRef) {
                        ...
                        for (ChildAssociationRef renditionAssoc :
                                renditionService.getRenditions(nodeRef)) {
                            final NodeRef renditionNode = renditionAssoc.getChildRef();

                            // Do not attempt to clean up rendition nodes which are not children of
                            // their source node.
                            final boolean renditionRequiresCleaning =
                                    nodeService.exists(renditionNode) && renditionAssoc.isPrimary();
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#isPropertyEditable(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.namespace.QName)
     */
    @Override
    public boolean isPropertyEditable(NodeRef record, QName property) {
        ...
        if (!isRecord(record)) {
            throw new AlfrescoRuntimeException(
                    "Cannot check if the property "
                            + property.toString()
                            + " is editable, because node reference is not a record.");
        }
        ...
        if (debugEnabled) {
            LOGGER.debug(
                    "Checking whether property "
                            + property.toString()
                            + " is editable for user "
                            + AuthenticationUtil.getRunAsUser());

            Set<Role> roles =
                    filePlanRoleService.getRolesByUser(filePlan, AuthenticationUtil.getRunAsUser());
                ...
                if ((perm.getPermission().contains(RMPermissionModel.EDIT_NON_RECORD_METADATA)
                    ...
                    LOGGER.debug(
                            "     ... "
                                    ...
                                    + perm.getPermission()
                                    + " - "
                                    + perm.getAccessStatus().toString());
                }
            }

            if (permissionService
                    .hasPermission(filePlan, RMPermissionModel.EDIT_NON_RECORD_METADATA)
                    .equals(AccessStatus.ALLOWED)) {
                LOGGER.debug(
                        " ... user has the edit non record metadata permission on the file plan");
            }
        }
        // END DEBUG ...
        ...
        if (result) {
            ...
            AccessStatus accessNonRecord =
                    capabilityService.getCapabilityAccessState(
                            record, RMPermissionModel.EDIT_NON_RECORD_METADATA);
            AccessStatus accessDeclaredRecord =
                    capabilityService.getCapabilityAccessState(
                            record, RMPermissionModel.EDIT_DECLARED_RECORD_METADATA);
            AccessStatus accessRecord =
                    capabilityService.getCapabilityAccessState(
                            record, RMPermissionModel.EDIT_RECORD_METADATA);
            ...
            if (allowNonRecordEdit && allowRecordEdit) {
                ...
                if (isRecordMetadata(filePlan, property)) {
                    ...
                    LOGGER.debug(
                            " ... property is not considered record metadata so not editable.");
                }
            }
    ...
    private boolean isRecordMetadata(NodeRef filePlan, QName property) {
        ...
        if (parent != null && TYPE_NON_ELECTRONIC_DOCUMENT.equals(parent.getName())) {
            ...
            if (!result
                    && !ArrayUtils.contains(NON_RECORD_MODEL_URIS, property.getNamespaceURI())) {
        ...
        if (recordFolderService.isRecordFolder(recordFolder)) {
            List<ChildAssociationRef> assocs =
                    nodeService.getChildAssocs(
                            recordFolder, ContentModel.ASSOC_CONTAINS, RegexQNamePattern.MATCH_ALL);
    ...
    /**
     * @see org.alfresco.module.org_alfresco_module_rm.record.RecordService#addRecordType(NodeRef,
     *     QName)
     */
    @Override
    public void addRecordType(NodeRef nodeRef, QName typeQName) {
        ...
        if (!nodeService.hasAspect(nodeRef, typeQName)) {
            ...
            LOGGER.info(
                    I18NUtil.getMessage(
                            MSG_NODE_HAS_ASPECT, nodeRef.toString(), typeQName.toString()));
        }
    }
            ...
            for (ChildAssociationRef parent : parents) {
                if (parent.getParentRef().equals(recordFolder)) {
                    ...
                    throw new RecordLinkRuntimeException(
                            "Cannot link a record to the same record folder more than once");
                }
            }
    ...
    private void validateLinkConditions(NodeRef record, NodeRef recordFolder) {
        ...
        DispositionSchedule recordDispositionSchedule =
                dispositionService.getOriginDispositionSchedule(record);
        ...
        if (recordDispositionSchedule != null) {
            ...
            if (recordFolderDispositionSchedule != null) {
                if (recordDispositionSchedule.isRecordLevelDisposition()
                        != recordFolderDispositionSchedule.isRecordLevelDisposition()) {
                    // we can't link a record to an incompatible disposition schedule
                    throw new RecordLinkRuntimeException(
                            "Cannot link a record to a record folder with an incompatible retention"
                                    + " schedule.  They must either both be record level or record"
                                    + " folder level retentions.");
                }
            }
        }
    }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.record.RecordService#unlink(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    public void unlink(NodeRef record, NodeRef recordFolder) {
        ...
        if (isRecord(record) && isRecordFolder(recordFolder)) {
            ...
            if (primaryParent.equals(recordFolder)) {
                throw new RecordLinkRuntimeException(
                        "Can't unlink a record from it's owning record folder.");
            }
    ...
    public void onContentUpdate(NodeRef nodeRef, boolean newContent) {
        if (nodeService.exists(nodeRef)
                && !nodeService.hasAspect(nodeRef, ContentModel.ASPECT_HIDDEN)
    ...
    private void validateForCompletion(NodeRef nodeRef) {
        ...
        // if the record is newly created make sure the record identifier is set before completing
        // the record
        Set<NodeRef> newRecords =
                transactionalResourceHelper.getSet(RecordServiceImpl.KEY_NEW_RECORDS);
        ...
        if (checkMandatoryPropertiesEnabled) {
            ...
            if (!missingProperties.isEmpty()) {
                ...
                throw new RecordMissingMetadataException(
                        "The record has missing mandatory properties.");
            }
        }
    }
    ...
    /**
     * Helper method to check whether all the definition mandatory properties of the node have been
     * set
     *
     ...
     * @param missingProperties the list of mandatory properties found to be missing (currently only
     *     the first one)
     * @return boolean true if all mandatory properties are set, false otherwise
     */
    private void checkDefinitionMandatoryPropsSet(
            final ClassDefinition classDef,
            final Map<QName, Serializable> nodeRefProps,
