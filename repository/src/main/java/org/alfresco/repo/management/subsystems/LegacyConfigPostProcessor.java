...
public class LegacyConfigPostProcessor
  ...
  private static final String BEAN_NAME_REPOSITORY_PROPERTIES =
    "repository-properties";

  /** The name of the bean that holds hibernate properties. These should now be overriden by global-properties. */
  private static final String BEAN_NAME_HIBERNATE_PROPERTIES =
  ...
  private static Log logger = LogFactory.getLog(
    LegacyConfigPostProcessor.class
  );
  ...
  public void postProcessBeanFactory(
    ...
    try {
      ...
      MutablePropertyValues globalProperties = beanFactory
        ...
        .getPropertyValues();
      PropertyValue pv = globalProperties.getPropertyValue(
        LegacyConfigPostProcessor.PROPERTY_LOCATIONS
      );
      ...
      MutablePropertyValues repositoryProperties = processLocations(
        beanFactory,
        globalPropertyLocations,
      ...
      MutablePropertyValues hibernateProperties = processLocations(
        beanFactory,
        globalPropertyLocations,
      ...
      // fix it up!
      PropertyPlaceholderConfigurer repositoryConfigurer = (PropertyPlaceholderConfigurer) beanFactory.getSingleton(
        LegacyConfigPostProcessor.BEAN_NAME_REPOSITORY_PROPERTIES
      );
  ...
  private MutablePropertyValues processLocations(
    ...
    MutablePropertyValues beanProperties = beanFactory
      .getBeanDefinition(beanName)
      .getPropertyValues();
    PropertyValue pv = beanProperties.getPropertyValue(
    ...
    if (
      ...
      pv =
        beanProperties.getPropertyValue(
          LegacyConfigPostProcessor.PROPERTY_LOCATIONS
        );
      if (
        pv != null &&
      ...
      if (newLocationList.size() > 0) {
        ...
        beanProperties.removePropertyValue(
          LegacyConfigPostProcessor.PROPERTY_LOCATIONS
        );
      }
    }
