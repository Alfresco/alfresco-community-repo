...
public class DeleteFavoriteSiteTests extends RestTest {
  ...
  public void managerUserRemovesFavoriteSiteWithSuccess() throws Exception {
    UserModel managerUser = usersWithRoles.getOneUserWithRole(
      UserRole.SiteManager
    );
    ...
    restClient
      ...
      .entriesListDoesNotContain(
        "visibility",
        siteModel1.getVisibility().toString()
      )
      .and()
  ...
  public void managerUserNotAuthorizedFailsToRemoveFavoriteSite()
    throws Exception {
    UserModel managerUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(userModel)
      .addUserToSite(managerUser, siteModel1, UserRole.SiteManager);
    dataSite.usingUser(managerUser).usingSite(siteModel1).addSiteToFavorites();
    dataSite.usingUser(managerUser).usingSite(siteModel2).addSiteToFavorites();
  ...
  public void collaboratorUserRemovesFavoriteSiteWithSuccess()
    throws Exception {
    UserModel collaboratorUser = usersWithRoles.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
    dataSite
  ...
  public void contributorUserRemovesFavoriteSiteWithSuccess() throws Exception {
    UserModel contributorUser = usersWithRoles.getOneUserWithRole(
      UserRole.SiteContributor
    );
    dataSite
  ...
  public void consumerUserRemovesFavoriteSiteWithSuccess() throws Exception {
    UserModel consumerUser = usersWithRoles.getOneUserWithRole(
      UserRole.SiteConsumer
    );
  ...
  public void uninvitedUserCanDeleteFavoriteModeratedSite() throws Exception {
    SiteModel moderatedSiteModel = dataSite
      .usingAdmin()
  ...
  public void userCanDeleteFavoritePrivateSite() throws Exception {
    SiteModel privateSiteModel = dataSite
      .usingUser(userModel)
  ...
  public void removeFavoriteSiteWithSuccessUsingMeAsPersonId()
    throws Exception {
  ...
  public void inexistentUserIsNotAbleToRemoveFavoriteSite() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "inexistenUser")
      );
  }
  ...
  public void userIsNotAbleToRemoveFavoriteSiteWithInexistentId()
    throws Exception {
  ...
  public void consumerUserRemovesDeletedFavoriteSite() throws Exception {
    SiteModel siteModel = dataSite
      .usingUser(userModel)
      .createPublicRandomSite();
    UserModel consumerUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(userModel)
      .addUserToSite(consumerUser, siteModel, UserRole.SiteConsumer);
  ...
  public void adminUserRemovesDeletedFavoriteSiteThatIsNotFavorite()
    throws Exception {
    SiteModel siteModel = dataSite
      .usingUser(userModel)
      .createPublicRandomSite();
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void siteMemberIsNotAbleToDeleteFavoritesOfAnotherSiteMember()
    throws Exception {
    UserModel siteCollaborator = usersWithRoles.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
    dataSite
