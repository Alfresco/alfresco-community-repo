...
public class RoleDeclarativeWebScript extends DeclarativeWebScript {
   ...
   * @return
   */
  protected Set<RoleItem> createRoleItems(
    NodeRef filePlan,
    Set<Role> roles,
    boolean showAuths
  ) {
  ...
  private Set<AuthorityItem> createAuthorityItems(Set<String> authorities) {
    ...
    for (String authority : authorities) {
      ...
      if (
        !AuthorityType.getAuthorityType(authority).equals(AuthorityType.USER)
      ) {
  ...
  public class RoleItem {
    ...
    public RoleItem(
      Role role,
      Set<AuthorityItem> assignedUsers,
      Set<AuthorityItem> assignedGroups
    ) {
      this.name = role.getName();
