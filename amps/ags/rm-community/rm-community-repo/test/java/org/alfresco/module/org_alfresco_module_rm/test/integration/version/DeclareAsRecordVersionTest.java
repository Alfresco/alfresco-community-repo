...
public class DeclareAsRecordVersionTest extends RecordableVersionsBaseTest {
    ...
    /**
     * Given versionable content with a non-recorded latest version When I declare a version record
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(dmCollaborator) {
                    ...
                    public void given() throws Exception {
                        ...
                        // remove the content property as ContentPropertyRestrictionInterceptor will
                        // not allow update of
    ...
    /**
     * Given versionable content with a recorded latest version When I declare a version record Then
     * nothing happens since the latest version is already recorded And a warning is logged
     */
                ...
                new BehaviourDrivenTest(dmCollaborator) {
                    ...
                    public void given() throws Exception {
                        ...
                        versionProperties.put(
                                RecordableVersionServiceImpl.KEY_RECORDABLE_VERSION, true);
    ...
    /**
     * Given that a document is a specialized type When version is declared as a record Then the
     * record is the same type as the source document
     *
    ...
    /**
     * Given versionable content with a recorded latest version and autoversion is true When I
     * declare this version record and contains local modifications Then a new minor version is
     * created for document
     *
                ...
                new BehaviourDrivenTest(dmCollaborator) {
                    ...
                    public void given() throws Exception {
                        ...
                        createdDate =
                                (Date)
                                        nodeService.getProperty(
                                                myDocument, ContentModel.PROP_CREATED);
                        modificationDate =
                                (Date)
                                        nodeService.getProperty(
                                                myDocument, ContentModel.PROP_MODIFIED);
                        assertTrue(
                        ...
                        nodeService.setProperty(
                                myDocument, ContentModel.PROP_DESCRIPTION, DESCRIPTION);
                    ...
                    public void when() {
                        ...
                        versionedRecord =
                                recordableVersionService.createRecordFromLatestVersion(
                                        filePlan, myDocument, autoVersion);
                    }
                    ...
                    public void then() {
                        ...
                        record_name =
                                (String)
                                        nodeService.getProperty(
                                                versionedRecord, ContentModel.PROP_NAME);
    ...
    /**
     * Given versionable content with a recorded latest version and autoversion is false When I
     * declare this version record and contains local modifications Then a record is created from
     * latest version
     *
     * @see https://issues.alfresco.com/jira/browse/RM-2368
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(dmCollaborator) {
                    ...
                    public void then() {
                        ...
                        // record is created based on existing frozen, which does not contain any
