...
public class ActionServiceImplTest extends BaseAlfrescoSpringTest {
  ...
  public void testGetActionDefinition() {
    ActionDefinition action = actionService.getActionDefinition(
  ...
  public void testGetActionDefinitions() {
    List<ActionDefinition> defintions =
      this.actionService.getActionDefinitions();
    ...
    List<ActionDefinition> definitions =
      this.actionService.getActionDefinitions(this.folder);
  ...
  public void testGetActionConditionDefinition() {
    ActionConditionDefinition condition =
      this.actionService.getActionConditionDefinition(
  ...
  public void testCreateCompositeActionCondition() {
    CompositeActionCondition action =
  ...
  public void testEvaluateActionCondition() {
    ...
    assertFalse(
      this.actionService.evaluateActionCondition(condition, this.nodeRef)
    );
    this.nodeService.setProperty(
        this.nodeRef,
        ContentModel.PROP_NAME,
  ...
  public void testEvaluateCompositeActionConditionWith1SubCondition() {
    ...
    assertTrue(
      this.actionService.evaluateActionCondition(
          compositeCondition,
          this.nodeRef
        )
    );
  ...
  public void testEvaluateCompositeActionConditionWith2SubConditions() {
    ...
    assertFalse(
      this.actionService.evaluateActionCondition(conditionTwo, this.nodeRef)
    );
  ...
  public void testExecuteAction() {
    assertFalse(
      this.nodeService.hasAspect(this.nodeRef, ContentModel.ASPECT_VERSIONABLE)
    );
    ...
    assertTrue(
      this.nodeService.hasAspect(this.nodeRef, ContentModel.ASPECT_LOCKABLE)
    );
    assertTrue(
      this.nodeService.hasAspect(this.nodeRef, ContentModel.ASPECT_VERSIONABLE)
    );
  ...
  public void testGetAndGetAllWithNoActions() {
    assertNull(
      this.actionService.getAction(this.nodeRef, AddFeaturesActionExecuter.NAME)
    );
  ...
  public void testSaveActionNoCondition() {
    ...
    assertEquals(
      action.getActionDefinitionName(),
      savedAction.getActionDefinitionName()
    );
    ...
    assertEquals(
      ContentModel.ASPECT_AUDITABLE,
      savedAction2.getParameterValue(
        AddFeaturesActionExecuter.PARAM_ASPECT_NAME
      )
    );
    ...
    assertEquals(
      AddFeaturesActionExecuter.NAME,
      savedCompensatingAction.getActionDefinitionName()
    );
    assertEquals(
      ContentModel.ASPECT_VERSIONABLE,
    ...
    assertEquals(
      AddFeaturesActionExecuter.NAME,
      savedCompensatingAction2.getActionDefinitionName()
    );
    assertEquals(
      ContentModel.ASPECT_CLASSIFIABLE,
  ...
  public void testSaveActionWithConditions() {
    ...
    // Check the properties
    assertEquals(
      action.getParameterValues().size(),
      savedAction.getParameterValues().size()
    );
    assertEquals(
      ContentModel.ASPECT_VERSIONABLE,
      savedAction.getParameterValue(AddFeaturesActionExecuter.PARAM_ASPECT_NAME)
    ...
    for (ActionCondition savedCondition : savedAction.getActionConditions()) {
      if (
        savedCondition
          ...
          .equals(NoConditionEvaluator.NAME) ==
        true
      ) {
    ...
    for (ActionCondition savedCondition : savedAction2.getActionConditions()) {
      if (
        savedCondition
          .getActionConditionDefinitionName()
          .equals(InCategoryEvaluator.NAME) ==
        true
      ) {
        assertEquals(1, savedCondition.getParameterValues().size());
        assertEquals(
  ...
  public void testSaveCompositeAction() {
    Action action1 =
      this.actionService.createAction(AddFeaturesActionExecuter.NAME);
    Action action2 =
      this.actionService.createAction(CheckInActionExecuter.NAME);

    CompositeAction compositeAction =
      this.actionService.createCompositeAction();
    ...
    CompositeAction savedCompositeAction = (CompositeAction) this.actionService.getAction(
        this.nodeRef,
        actionId
      );
    ...
    for (Action action : savedCompositeAction.getActions()) {
      if (
        action
          ...
          .equals(AddFeaturesActionExecuter.NAME) ==
        true
      ) {
        assertEquals(action, action1);
      } else if (
        action.getActionDefinitionName().equals(CheckInActionExecuter.NAME) ==
        true
      ) {
    ...
    Action action3 =
      this.actionService.createAction(CheckOutActionExecuter.NAME);
    ...
    this.actionService.saveAction(this.nodeRef, compositeAction);
    assertEquals(1, this.actionService.getActions(this.nodeRef).size());
    CompositeAction savedCompositeAction2 = (CompositeAction) this.actionService.getAction(
        this.nodeRef,
        actionId
      );
    ...
    for (Action action : savedCompositeAction2.getActions()) {
      if (
        action.getActionDefinitionName().equals(CheckOutActionExecuter.NAME) ==
        true
      ) {
  ...
  public void testActionOrder() {
    ...
    this.actionService.saveAction(this.nodeRef, action);
    CompositeAction savedAction = (CompositeAction) this.actionService.getAction(
        this.nodeRef,
        actionId
      );
    ...
    this.actionService.saveAction(this.nodeRef, savedAction);
    CompositeAction savedAction2 = (CompositeAction) this.actionService.getAction(
        this.nodeRef,
        actionId
      );
  ...
  public void offtestAsyncLongRunningActionsFilter() {
    ...
    final SleepActionExecuter sleepAction = (SleepActionExecuter) applicationContext.getBean(
      "sleep-action"
    );
  ...
  public void testAsyncExecuteAction() {
    ...
    postAsyncActionTest(
      ...
      new AsyncTest() {
        public String executeTest() {
          boolean result = finalNodeService.hasAspect(
            finalNodeRef,
            ContentModel.ASPECT_CLASSIFIABLE
          );
    ...
    try {
      ...
      if (errorMsg != null) {
        throw new RuntimeException(
          "Asynchronous action was not executed. " + errorMsg
        );
      }
  ...
  public void testCompensatingAction() {
    ...
    Action compensatingAction = actionService.createAction(
      AddFeaturesActionExecuter.NAME
    );
    compensatingAction.setParameterValue(
      AddFeaturesActionExecuter.PARAM_ASPECT_NAME,
    ...
    Action compensatingAction2 = actionService.createAction(
      AddFeaturesActionExecuter.NAME
    );
    ...
    postAsyncActionTest(
      ...
      new AsyncTest() {
        public String executeTest() {
          ...
          return (
            !fatalCompensatingActionRun || nonFatalCompensatingActionRun
              ? result.toString()
              : null
          );
        }
    ...
    compensatingAction.setParameterValue(
      AddFeaturesActionExecuter.PARAM_ASPECT_NAME,
      QName.createQName("{test}badAspect")
    );
          ...
          public Object execute() {
            try {
              ActionServiceImplTest.this.actionService.executeAction(
                  fatalAction,
                  ActionServiceImplTest.this.nodeRef
                );
            } catch (RuntimeException exception) {
  ...
  public void testALF5027() throws Exception {
    ...
    CheckOutCheckInService coci = (CheckOutCheckInService) applicationContext.getBean(
    ...
    assertFalse(
      nodeService.hasAspect(myNodeRef, ContentModel.ASPECT_DUBLINCORE)
    );
  ...
  protected Action createFailingMoveAction(boolean isFatal) {
    ...
    if (isFatal) {
      ...
      failingAction =
        this.actionService.createAction(TransientFailActionExecuter.NAME);
    }

    return failingAction;
  }

  protected Action createFailingSleepAction(String id, boolean isFatal)
    throws Exception {
  ...
  protected static Action createFailingSleepAction(
    ...
    failingAction.setParameterValue(
      SleepActionExecuter.FAIL_FATALLY,
      Boolean.valueOf(isFatal)
    );
    return failingAction;
  }
  ...
  public static class TransientFailActionExecuter
    ...
    public static void registerIfNeeded(ConfigurableApplicationContext ctx) {
      if (!ctx.containsBean(TransientFailActionExecuter.NAME)) {
        ...
        ctx
          .getBeanFactory()
          .registerSingleton(TransientFailActionExecuter.NAME, executor);
      }
    }
