...
/**
 * Collects differences so that tools can report on or respond to differences between database
 * schemas.
 *
 * @author Matt Ward
 */
public class Results implements Iterable<Result> {
    ...
    /**
     * Obtain an iterator for the top-level items held in this schema - since this is a hierarchical
     * model, deeper items are obtained by navigating through the top-level items.
     */
    @Override
