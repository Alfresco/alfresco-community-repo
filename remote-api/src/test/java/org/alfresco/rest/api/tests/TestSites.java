...
public class TestSites extends EnterpriseTestApi {
  ...
  private void initializeNetwork1() throws Exception {
    if (network1 == null) {
      network1 =
        getRepoService()
          .createNetwork(
            this.getClass().getName().toLowerCase() + "-1-" + RUNID,
            true
          );
      network1.create();
  ...
  private void initializeNetwork2WithSites() throws Exception {
    if (network2 == null) {
      network2 =
        getRepoService()
          .createNetwork(
            this.getClass().getName().toLowerCase() + "-2-" + RUNID,
            true
          );
      network2.create();
      ...
      publicApiClient.setRequestContext(
        new RequestContext(network2.getId(), person3Id)
      );
  ...
  private void initializeNetwork3WithSites() throws Exception {
    ...
    if (network3 == null) {
      network3 =
        getRepoService()
          .createNetwork(
            this.getClass().getName().toLowerCase() + "-3-" + RUNID,
            true
          );
      network3.create();
  ...
  public void testGetSiteAndListSites() throws Exception {
    ...
    List<TestSite> expectedSites = TenantUtil.runAsUserTenant(
  ...
  public void testUpdateSite() throws PublicApiException {
    ...
    // +ve test: simple happy path with successful update.
    {
      ...
      siteToCreate.setDescription(
        "This is the initial description for the site"
      );
      ...
      HttpResponse response = sitesProxy.update(
        "sites",
        site.getSiteId(),
        null,
        null,
      ...
      Site updatedSite = SiteImpl.parseSite(
    ...
    {
      Site site = sitesProxy.createSite(
        new SiteImpl(
          null,
          "NoDescriptionTest",
          "Initial description",
    ...
    {
      Site site = sitesProxy.createSite(
        new SiteImpl("SiteUpdate401", SiteVisibility.PRIVATE.toString()),
        201
      );
    ...
    {
      Site site = sitesProxy.createSite(
        new SiteImpl("SiteUpdate403", SiteVisibility.PUBLIC.toString()),
        201
      );
  ...
  private ListResponse<Site> listSites(
    final Paging paging,
    String sortColumn,
    boolean asc
  ) throws Exception {
  ...
  public void testListSitesWhereSiteVisibilityPublicAndSkipCount()
    throws Exception {
    // paging
    Integer skipCount = 1;
    int maxItems = 2;
  ...
  public void testListSitesWhereExpected() throws Exception {
    ...
    publicApiClient.setRequestContext(
      new RequestContext(network3.getId(), person4Id)
    );
  ...
  public static class SiteUpdateJSONSerializer implements JSONAble {
    ...
    public static SiteUpdate parseSiteUpdate(JSONObject jsonObject) {
      ...
      SiteVisibility visibility = SiteVisibility.valueOf(
        (String) jsonObject.get("visibility")
      );
