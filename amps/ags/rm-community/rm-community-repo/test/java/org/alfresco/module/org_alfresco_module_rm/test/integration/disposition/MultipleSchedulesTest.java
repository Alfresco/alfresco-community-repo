...
public class MultipleSchedulesTest extends BaseRMTestCase {
  ...
  private void setUpFilePlan() {
    ...
    DispositionSchedule dispSchedA = utils.createBasicDispositionSchedule(
      categoryA,
      "instructions",
      "authority",
      true,
    ...
    Map<QName, Serializable> cutOffParamsA = ImmutableMap.of(
    ...
    Map<QName, Serializable> destroyParamsA = ImmutableMap.of(
      PROP_DISPOSITION_ACTION_NAME,
      DestroyAction.NAME,
      PROP_DISPOSITION_DESCRIPTION,
      "description",
    ...
    DispositionSchedule dispSchedB = utils.createBasicDispositionSchedule(
      categoryB,
      "instructions",
      "authority",
      true,
    ...
    Map<QName, Serializable> cutOffParamsB = ImmutableMap.of(
      PROP_DISPOSITION_ACTION_NAME,
      CutOffAction.NAME,
      PROP_DISPOSITION_DESCRIPTION,
      "description",
    ...
    Map<QName, Serializable> destroyParamsB = ImmutableMap.of(
      PROP_DISPOSITION_ACTION_NAME,
      DestroyAction.NAME,
      PROP_DISPOSITION_DESCRIPTION,
      "description",
    ...
    DispositionSchedule dispSchedC = utils.createBasicDispositionSchedule(
      categoryC,
      "instructions",
      "authority",
      true,
    ...
    Map<QName, Serializable> cutOffParamsC = ImmutableMap.of(
      PROP_DISPOSITION_ACTION_NAME,
      CutOffAction.NAME,
      PROP_DISPOSITION_DESCRIPTION,
      "description",
    ...
    Map<QName, Serializable> destroyParamsC = ImmutableMap.of(
      PROP_DISPOSITION_ACTION_NAME,
      DestroyAction.NAME,
      PROP_DISPOSITION_DESCRIPTION,
      "description",
  ...
  public void testLinkedToLongerSchedule() {
    ...
    test()
      ...
      .because(
        "Record should follow largest rentention schedule period, which is one week."
      );
  }
  ...
  public void testRecalculateDispositionWhenUnlinking() {
    test()
      ...
      .because(
        "Destroy action shouldn't be available, as the record should follow disposition schedule from category C."
      );
  }
}
