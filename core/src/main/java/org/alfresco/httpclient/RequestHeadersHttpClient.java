...
/**
 * Since Apache HttpClient 3.1 doesn't support including custom headers by default, this class is
 * adding that custom headers every time a method is invoked.
 */
