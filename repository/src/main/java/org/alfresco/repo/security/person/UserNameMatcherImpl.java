...
public class UserNameMatcherImpl implements UserNameMatcher {
  ...
  public void setDomainNamesAreCaseSensitive(
    boolean domainNamesAreCaseSensitive
  ) {
  ...
  public boolean matches(String realUserName, String searchUserName) {
    ...
    Pair<String, String> search = splitByDomain(
      searchUserName,
      domainSeparator
    );
    ...
    return (
      (
        (
          ...
          (real.getFirst().equals(search.getFirst()))
        ) ||
        (
          !userNamesAreCaseSensitive &&
          (real.getFirst().equalsIgnoreCase(search.getFirst()))
        )
      ) &&
      (
        (
          domainNamesAreCaseSensitive &&
          (real.getSecond().equals(search.getSecond()))
        ) ||
        (
          !domainNamesAreCaseSensitive &&
          (real.getSecond().equalsIgnoreCase(search.getSecond()))
        )
      )
    );
  }
  ...
  private Pair<String, String> splitByDomain(
    String name,
