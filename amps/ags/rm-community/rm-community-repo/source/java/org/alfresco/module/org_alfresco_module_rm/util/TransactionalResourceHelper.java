...
public class TransactionalResourceHelper {
  ...
  public int getCount(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.getCount(
      resourceKey
    );
  }
  ...
  public void resetCount(Object resourceKey) {
    org.alfresco.repo.transaction.TransactionalResourceHelper.resetCount(
      resourceKey
    );
  }
  ...
  public int incrementCount(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.incrementCount(
      resourceKey
    );
  }
  ...
  public int decrementCount(Object resourceKey, boolean allowNegative) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.decrementCount(
      resourceKey,
      allowNegative
    );
  }
  ...
  public boolean isResourcePresent(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.isResourcePresent(
      resourceKey
    );
  }
  ...
  public <K, V> Map<K, V> getMap(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.getMap(
      resourceKey
    );
  }
  ...
  public <V> Set<V> getSet(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.getSet(
      resourceKey
    );
  }
  ...
  public <V> TreeSet<V> getTreeSet(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.getTreeSet(
      resourceKey
    );
  }
  ...
  public <V> List<V> getList(Object resourceKey) {
    return org.alfresco.repo.transaction.TransactionalResourceHelper.getList(
      resourceKey
    );
  }
}
