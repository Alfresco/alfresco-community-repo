...
public class TransformationOptions implements Cloneable {
  ...
  public void set(Map<String, Object> optionsMap) {
    ...
    this.sourceContentProperty =
      (QName) optionsMap.get(OPT_SOURCE_CONTENT_PROPERTY);
    this.targetNodeRef = (NodeRef) optionsMap.get(OPT_TARGET_NODEREF);
    this.targetContentProperty =
      (QName) optionsMap.get(OPT_TARGET_CONTENT_PROPERTY);
   ...
   */
  public void setSourceOptionsList(
  ...
  public void addSourceOptions(TransformationSourceOptions sourceOptions) {
    if (sourceOptionsMap == null) {
      sourceOptionsMap =
        new HashMap<Class<? extends TransformationSourceOptions>, TransformationSourceOptions>(
          1
        );
    }
    TransformationSourceOptions newOptions = sourceOptions;
    TransformationSourceOptions existingOptions = sourceOptionsMap.get(
      sourceOptions.getClass()
    );
  ...
  public <T extends TransformationSourceOptions> T getSourceOptions(
    Class<T> clazz
  ) {
    if (sourceOptionsMap == null) return null;
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((this.limits == null) ? 0 : this.limits.hashCode());
    result =
      prime *
      result +
      (
    ...
    result =
      prime *
      result +
      ((this.sourceNodeRef == null) ? 0 : this.sourceNodeRef.hashCode());
    result =
      prime *
      result +
      (
    ...
    result =
      prime *
      result +
      ((this.targetNodeRef == null) ? 0 : this.targetNodeRef.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (this.includeEmbedded == null) {
      ...
      !this.includeEmbedded.equals(other.includeEmbedded)
    ) return false;
    if (this.limits == null) {
    ...
    if (this.sourceContentProperty == null) {
      ...
      !this.sourceContentProperty.equals(other.sourceContentProperty)
    ) return false;
    ...
    if (this.targetContentProperty == null) {
      ...
      !this.targetContentProperty.equals(other.targetContentProperty)
    ) return false;
