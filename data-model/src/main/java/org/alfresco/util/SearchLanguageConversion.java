...
public class SearchLanguageConversion {
     ...
     * <ul>
     *   <li>Escape: \
     *   <li>Single char search: _
     *   <li>Multiple char search: %
     *   <li>Reserved: \%_
     * </ul>
     */
     ...
     * </ul>
     */
    public static LanguageDefinition DEF_XPATH_LIKE =
            new SimpleLanguageDef('\\', "%", "_", "\\%_[]");
     ...
     * <ul>
     *   <li>Escape: \
     *   <li>Single char search: .
     *   <li>Multiple char search: .*
     *   <li>Reserved: \*.+?^$(){}[]|
     * </ul>
     */
    public static LanguageDefinition DEF_REGEX =
            new SimpleLanguageDef('\\', ".*", ".", "\\*.+?^$(){}[]|");
     ...
     *
     * <ul>
     *   <li>Escape: \ (but not used)
     *   <li>Single char search: ?
     *   <li>Multiple char search: *
     *   <li>Reserved: "*\<>?/:|£%&+;
     * </ul>
     */
    public static LanguageDefinition DEF_CIFS =
            new SimpleLanguageDef('\\', "*", "?", "\"*\\<>?/:|£%&+;");
     ...
     * @return Returns a valid regular expression that is equivalent to the given <b>xpath</b> like
     *     clause.
     */
     ...
     *
     * @param xpathLikeClause String
     * @return Returns a valid <b>Lucene</b> expression that is equivalent to the given <b>xpath</b>
     *     like clause.
     */
     ...
     * @return Returns a valid <b>Lucene</b> expression that is equivalent to the given <b>sql</b>
     *     like clause.
     */
     ...
     *
     * @param sqlLikeClause String
     * @return Returns a valid regular expression that is equivalent to the given <b>sql</b> like
     *     clause.
     */
     ...
     * @return Returns a valid <b>Lucene</b> expression that is equivalent to the given CIFS name
     *     path
     */
        ...
        for (int i = 0; i < chars.length; i++) {
            ...
            } else if (chars[i] == from.escapeChar) // not escaping and have escape char
            {
                escaping = true;
                    ...
                    from.multiCharWildcard, i)) // not escaping but have multi-char wildcard
            {
    ...
    public abstract static class LanguageDefinition {
        ...
        public LanguageDefinition(
                char escapeChar, String multiCharWildcard, String singleCharWildcard) {
    ...
    private static class SimpleLanguageDef extends LanguageDefinition {
        ...
        public SimpleLanguageDef(
                char escapeChar,
                String multiCharWildcard,
    ...
    /**
     * We have to escape lucene query strings outside of lucene - as we do not depend on any given
     * version of lucene The escaping here is taken from lucene 4.9.0
     *
     * <p>The reserved (and escaped characters) are:
     *
     * <p>\ + - ! ( ) : ^ [ ] " { } ~ * ? | & /
     *
     * <p>The escape character is \
     *
     * @param query String
