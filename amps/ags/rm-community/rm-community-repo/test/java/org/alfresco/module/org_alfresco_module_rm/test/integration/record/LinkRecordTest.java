...
public class LinkRecordTest extends BaseRMTestCase {
    ...
    /**
     * Given source and destination disposition schedules are compatible When I link a record to the
     * record folder Then it is successful
     */
    ...
    /**
     * Given source and destination disposition schedules are incompatible When I link a record to
     * the record folder Then it is fails
     */
