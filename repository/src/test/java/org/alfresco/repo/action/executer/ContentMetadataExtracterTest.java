...
public class ContentMetadataExtracterTest extends BaseSpringTest {
  ...
  protected static final String QUICK_TITLE =
  ...
  public void before() throws Exception {
    ...
    registry =
      (MetadataExtracterRegistry) applicationContext.getBean(
    ...
    this.executer =
      (ContentMetadataExtracter) this.applicationContext.getBean(
          "extract-metadata"
        );
  }
  ...
  private static final QName PROP_UNKNOWN_1 = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "unkown1"
  );
  private static final QName PROP_UNKNOWN_2 = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "unkown2"
  );
  ...
  public void testNullExtractedValues_ALF1823() {
    ...
    Serializable descr = nodeService.getProperty(
      nodeRef,
      ContentModel.PROP_DESCRIPTION
    );
