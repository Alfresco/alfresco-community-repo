...
public class GetSiteContainerTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role gets site container and gets status code OK"
                            + " (200)")
    public void getSiteContainerWithManagerRole() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteContainer(siteContainerModel.onModel())
                .assertThat()
                .field("id")
                .is(siteContainerModel.onModel().getId())
                .and()
                .field("folderId")
                .is(siteContainerModel.onModel().getFolderId());
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role gets site container and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets site container and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets site container and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with admin user gets site container and gets status code OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request returns status code 400 when site doesn't"
                            + " exist")
    public void getContainerWithNonExistentSite() throws Exception {
        restClient
                ...
                .getSiteContainer(ContainerName.links.toString());
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request returns status code 400 when container item"
                            + " doesn't exist")
    public void getContainerWithNonExistentItem() throws Exception {
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteContainer("NonExistentFolder");
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user can get container for public site and request returns"
                            + " status 200")
    public void getContainerForPublicSite() throws Exception {
        restClient
                ...
                .assertThat()
                .field("folderId")
                .is(ContainerName.links.toString());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager is able to get container for his private site and request"
                            + " returns status 200")
    ...
    public void getContainerForModeratedSite() throws Exception {
        restClient
                ...
                .getSiteContainer(ContainerName.documentLibrary.toString())
                .assertThat()
                .field("folderId")
                .is(ContainerName.documentLibrary.toString());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request with properties parameter returns status code"
                            + " 200 and parameter is applied")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request for a container that does not belong to site"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request for empty siteId returns status code 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request for empty container returns status code 200"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container with name containing special chars returns status code"
                            + " 404")
    public void getContainerWithNameContainingSpecialChars() throws Exception {
        String containerSpecialName =
                RandomStringUtils.randomAlphabetic(2)
                        + "~!%40%23%24%25%5E%26*()_%2B%5B%5D%7B%7D%7C%5C%3B%27%3A%22%2C.%2F%3C%3E";

        restClient
                .authenticateUser(testUser)
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteContainer(containerSpecialName);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsErrorKey(RestErrorModel.RELATIONSHIP_NOT_FOUND_ERRORKEY)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if admin can get container request for a private site created by"
                            + " another user and status code is 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if user cannot get container request for a private site created by"
                            + " admin and status code is 404")
    public void userCannotGetContainerForPrivateSiteCreatedByAdmin() throws Exception {
        restClient
                .authenticateUser(testUser)
                .withCoreAPI()
                .usingSite(adminPrivateSiteModel)
                .getSiteContainer(ContainerName.links.toString());
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get container request for a deleted container returns status code is"
                            + " 404")
    public void getContainerThatWasDeleted() throws Exception {
        ...
        folder.setCmisLocation(
                String.format(
                        "/Sites/%s/%s", privateSiteModel.getId(), ContainerName.links.toString()));
