 ...
 *     &#64;Rule
 *     public final AlfrescoTenant tenant = new AlfrescoTenant(APP_CONTEXT_RULE, "testtenant");
 * 
 *     &#64;Test
...
public class AlfrescoTenant extends AbstractRule
{
    ...
    /**
     * Constructs the rule with a spring ApplicationContext. A GUID-generated tenant name will be used for the test tenant.
     * 
     * @param appContext
    ...
    /**
     * Constructs the rule with a reference to a {@link ApplicationContextInit rule} which can be used to retrieve the ApplicationContext. A GUID-generated tenant name will be used for the test user.
     * 
     ...
     *            the spring app context (needed to get at Alfresco services).
     * @param tenantName
     *            the tenantName for the person to be created.
     */
     ...
     *            a rule which can be used to retrieve the spring app context.
     * @param tenantName
     *            the name for the tenant to be created.
     */
     ...
     * 
     * @param runAsWork
     *            The work to be done as the system user of this tenant.
