...
public class XMLToSchema extends DefaultHandler {
  ...
  public void startElement(
    ...
    if (qName.equals(XML.EL_SCHEMA)) {
      ...
      boolean compareTableColOrder = attrTableColumnOrder != null
        ? Boolean.parseBoolean(attrTableColumnOrder)
        : true;
      ...
      if (
        stack.peek() instanceof PrimaryKey &&
        atts.getValue(XML.ATTR_ORDER) != null
      ) {
        PrimaryKey pk = (PrimaryKey) stack.peek();
      ...
      try {
        ...
        throw new RuntimeException(
          "Couldn't create validator, class: " + className,
          e
        );
      }
