...
/**
 * First case of this is Mac Mountain Lion Preview application. and then a new copy of the file put
 * into place.
 *
 * <p>a) DeleteOnClose fileA b) Close fileA c) Rename whatever fileA
 *
 * <p>a) Delete fileA b)Rename File~ to File
 *
 * <p>This rule will kick in and ...
 */
        ...
        switch (state) {
            case NONE:
                ...
                if (operation instanceof DeleteFileOperation) {
                    ...
                    ArrayList<Command> postErrorCommands = new ArrayList<Command>();
                    commands.add(
                            new DeleteFileCommand(c.getName(), c.getRootNodeRef(), c.getPath()));
                    postCommitCommands.add(newDeleteFileCallbackCommand());
                    return new CompoundCommand(commands, postCommitCommands, postErrorCommands);
                }
                break;
            ...
            case INITIALISED:
                ...
                if (operation instanceof RenameFileOperation) {
                    ...
                    if (name.equals(r.getTo())) {
                        ...
                        if (originalNodeRef != null) {
                            /**
                             * Shuffle is as follows a) Copy content from File to File~ b) Delete
                             * File c) Rename File~ to File
                             */
                            ArrayList<Command> commands = new ArrayList<Command>();
                            RestoreFileCommand r1 =
                            ...
                            DeleteFileCommand d1 =
                                    new DeleteFileCommand(
                                            r.getFrom(), r.getRootNodeRef(), r.getFromPath());
