    ...
    for (
      ...
      if (onString.equalsIgnoreCase(NODE_ENTRY)) {
        ...
        throw new PermissionModelException(
          "Required permission must specify parent or node for the on attribute."
        );
      }

      boolean implies = false;
      Attribute impliesAttribute = requiredPermissionElement.attribute(
        RP_IMPLIES
      );
      ...
      RequiredPermission rq = new RequiredPermission(
        qName,
        requiredName,
        on,
        implies
