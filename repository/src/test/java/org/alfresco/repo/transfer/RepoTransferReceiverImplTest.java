...
public class RepoTransferReceiverImplTest extends BaseAlfrescoSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.receiver =
                (RepoTransferReceiverImpl) this.applicationContext.getBean("transferReceiver");
    ...
    public void testDelete() {
                    ...
                    public TestContext execute() throws Throwable {
                        ...
                        tc.childAssoc =
                                nodeService.createNode(
                                        ...
                                        QName.createQName(NamespaceService.APP_MODEL_1_0_URI, uuid),
        ...
        RetryingTransactionCallback<Void> deleteCB =
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef archiveNodeRef =
                                new NodeRef(
                                        ...
                                        tc.childAssoc.getChildRef().getId());
                            ...
                            try {
                                receiver.end(
                                        new NodeRef(
                                                        ...
                                                        GUID.generate())
                                                .toString());
                                //                      fail("Successfully ended with transfer id
                                // that doesn't own lock.");
                            } catch (TransferException ex) {
                                // Expected
                            }
                        } finally {
     ...
     * Tests start and end with regard to locking.
     *
     * <p>Going to cut down the timeout to a very short period, the lock should expire
     *
     * @throws Exception
     */
    public void DISABLED_testLockTimeout() throws Exception {
        ...
        RetryingTransactionCallback<Void> startWithoutAnythingElse =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        log.debug("about to call start");
        ...
        RetryingTransactionCallback<Void> slowTransfer =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        log.debug("about to call start");
        ...
        try {
            ...
            /**
             * This test simulates a client that starts a transfer and then "goes away". We kludge
             * the timeouts to far shorter than normal to make the test run in a reasonable time.
             */
            for (int i = 0; i < 3; i++) {
                log.info("test iteration:" + i);
    ...
    public void testSaveContent() throws Exception {
        ...
        try {
            ...
            receiver.saveContent(
                    transferId, contentId, new ByteArrayInputStream(dummyContentBytes));
    ...
    public void testBasicCommit() throws Exception {
        ...
        RetryingTransactionCallback<Void> doPrepareCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        ...
                        receiver.saveSnapshot(
                                tc.transferId,
                                new ByteArrayInputStream(snapshot.getBytes("UTF-8")));
                        receiver.saveContent(
                                tc.transferId,
                                tc.node.getUuid(),
                                new ByteArrayInputStream(dummyContentBytes));

                        return null;
                    }
                };

        RetryingTransactionCallback<Void> doCommitCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        RetryingTransactionCallback<Void> doEndCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        RetryingTransactionCallback<Void> doValidateCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        RetryingTransactionCallback<Void> validateCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                nodeService
                                        .getAspects(tc.node1.getNodeRef())
                                        .contains(ContentModel.ASPECT_ATTACHABLE));
                        assertFalse(
                                nodeService
                                        .getSourceAssocs(
                                                tc.node2.getNodeRef(),
    ...
    public void testNodeDeleteAndRestore() throws Exception {
        ...
        RetryingTransactionCallback<Void> doFirstPrepareCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateFirstCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        ArgumentCaptor<String> transferIdCaptor =
                        ...
                        verify(mockedPolicyHandler, times(1))
                                .onEndInboundTransfer(
         ...
         *
         * <p>nodes 8, 2, and 11 (11 and 2 are parent/child)
         */
        reset(mockedPolicyHandler);

        logger.debug("part 2 - transfer some deleted nodes");

        RetryingTransactionCallback<Void> doSecondPrepareCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> validateSecondCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        ArgumentCaptor<String> transferIdCaptor =
                        ...
                        TransferProgress progress =
                                receiver.getProgressMonitor().getProgress(tc.transferId);
                        assertEquals(TransferProgress.Status.COMPLETE, progress.getStatus());

                        NodeRef archiveNode8 =
                                new NodeRef(
                                        StoreRef.STORE_REF_ARCHIVE_SPACESSTORE,
                                        tc.node8.getNodeRef().getId());
                        NodeRef archiveNode2 =
                                new NodeRef(
                                        StoreRef.STORE_REF_ARCHIVE_SPACESSTORE,
                                        tc.node2.getNodeRef().getId());
                        NodeRef archiveNode11 =
                                new NodeRef(
                                        StoreRef.STORE_REF_ARCHIVE_SPACESSTORE,
                                        tc.node11.getNodeRef().getId());

                        assertTrue(nodeService.exists(archiveNode8));
                        assertTrue(
                                nodeService.hasAspect(archiveNode8, ContentModel.ASPECT_ARCHIVED));
                        log.debug("Successfully tested existence of archive node: " + archiveNode8);

                        assertTrue(nodeService.exists(archiveNode2));
                        assertTrue(
                                nodeService.hasAspect(archiveNode2, ContentModel.ASPECT_ARCHIVED));
                        log.debug("Successfully tested existence of archive node: " + archiveNode2);

                        assertTrue(nodeService.exists(archiveNode11));
                        assertTrue(
                                nodeService.hasAspect(archiveNode11, ContentModel.ASPECT_ARCHIVED));
                        log.debug(
                                "Successfully tested existence of archive node: " + archiveNode11);
        ...
        RetryingTransactionCallback<Void> doThirdPrepareCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        String snapshot =
                                createSnapshot(
                                        Arrays.asList(new TransferManifestNode[] {tc.node2}));
                        log.debug(snapshot);
                        receiver.saveSnapshot(
                                tc.transferId,
                                new ByteArrayInputStream(snapshot.getBytes("UTF-8")));
        ...
        RetryingTransactionCallback<Void> doCommitExpectingFailCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        try {
                            ...
                            ArgumentCaptor<String> transferIdCaptor =
                                    ArgumentCaptor.forClass(String.class);
                            ArgumentCaptor<Set> createdNodesCaptor =
                                    ArgumentCaptor.forClass(Set.class);
                            ArgumentCaptor<Set> updatedNodesCaptor =
                                    ArgumentCaptor.forClass(Set.class);
                            ArgumentCaptor<Set> deletedNodesCaptor =
                                    ArgumentCaptor.forClass(Set.class);
        ...
        RetryingTransactionCallback<Void> validateThirdCB =
                new RetryingTransactionCallback<Void>() {
    ...
    /**
     * Test for fault raised as ALF-2772 (https://issues.alfresco.com/jira/browse/ALF-2772) When
     * transferring nodes it shouldn't matter the order in which they appear in the snapshot. That
     * is to say, it shouldn't matter if a child node is listed before its parent node.
     *
     * <p>Typically this is true, but in the special case where the parent node is being restored
     * from the target's archive store then there is a fault. The process should be:
     *
     * <p>1. Process child node 2. Fail to find parent node 3. Place child node in temporary
     * location and mark as an orphan 4. Process parent node 5. Create node to correspond to parent
     * node 6. "Re-parent" orphaned child node with parent node
     *
     * <p>However, in the case where the parent node is found in the target's archive store, the
     * process is actually:
     *
     * <p>1. Process child node 2. Fail to find parent node 3. Place child node in temporary
     * location and mark as an orphan 4. Process parent node 5. Find corresponding parent node in
     * archive store and restore it 6. Update corresponding parent node
     *
     * <p>Note that, in this case, we are not re-parenting the orphan as we should be.
     *
     * @throws Exception
     */
    @Test
    public void testJira_ALF_2772() throws Exception {
        ...
        RetryingTransactionCallback<Void> doFirstCB =
                new RetryingTransactionCallback<Void>() {
        ...
        RetryingTransactionCallback<Void> doSecondCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        String snapshot =
                                createSnapshot(
                                        Arrays.asList(
                                                new TransferManifestNode[] {tc.deletedNode11}));
                        log.debug(snapshot);
                        receiver.saveSnapshot(
                                tc.transferId,
                                new ByteArrayInputStream(snapshot.getBytes("UTF-8")));
        ...
        RetryingTransactionCallback<Void> doValidateSecondCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        TransferProgress progress =
                        ...
                        NodeRef archivedNodeRef =
                                new NodeRef(
                                        StoreRef.STORE_REF_ARCHIVE_SPACESSTORE,
                                        tc.deletedNode11.getNodeRef().getId());
                        assertTrue(nodeService.exists(archivedNodeRef));
                        assertTrue(
                                nodeService.hasAspect(
                                        archivedNodeRef, ContentModel.ASPECT_ARCHIVED));
                        log.debug(
                                "Successfully tested existence of archive node: "
                                        + tc.deletedNode11.getNodeRef());
        ...
        RetryingTransactionCallback<Void> doThirdCB =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        String snapshot =
                                createSnapshot(
                                        Arrays.asList(
                                                new TransferManifestNode[] {tc.node2, tc.node11}));
                        log.debug(snapshot);
                        receiver.saveSnapshot(
                                tc.transferId,
                                new ByteArrayInputStream(snapshot.getBytes("UTF-8")));
        ...
        RetryingTransactionCallback<Void> doValidateThirdCB =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
    ...
    /**
     * Test for fault raised as MNT-11057 (https://issues.alfresco.com/jira/browse/MNT-11057) Bug in
     * replication process on Aliens.
     *
     * @throws Exception
     */
    @Test
    public void testMNT11057() throws Exception {
        ...
        try {
            ...
            receiver.saveSnapshot(
                    transferIdA1, new ByteArrayInputStream(snapshot.getBytes("UTF-8")));

            for (TransferManifestNode node : nodesA1) {
                receiver.saveContent(
                        transferIdA1, node.getUuid(), new ByteArrayInputStream(dummyContentBytes));
            }
        ...
        try {
            ...
            log.debug(snapshot);
            receiver.saveSnapshot(
                    transferIdB1, new ByteArrayInputStream(snapshot.getBytes("UTF-8")));

            for (TransferManifestNode node : nodesB1) {
                receiver.saveContent(
                        transferIdB1, node.getUuid(), new ByteArrayInputStream(dummyContentBytes));
            }
        ...
        try {
            String transferId =
                    receiver.start("transferFromRepoA1Again", true, receiver.getVersion());
            String snapshot = createSnapshot(nodesA1, "repo A");
            log.debug(snapshot);
            receiver.saveSnapshot(transferId, new ByteArrayInputStream(snapshot.getBytes("UTF-8")));
    ...
    private String localTestAsyncCommit() throws Exception, InterruptedException {
        ...
        while (progress == null
                || !TransferProgress.getTerminalStatuses().contains(progress.getStatus())) {
            Thread.sleep(500);
            TestTransaction.start();
        ...
        try {
            assertTrue(
                    nodeService
                            .getAspects(node1.getNodeRef())
                            .contains(ContentModel.ASPECT_ATTACHABLE));
            assertFalse(
                    nodeService
                            .getSourceAssocs(node2.getNodeRef(), ContentModel.ASSOC_ATTACHMENTS)
                            .isEmpty());
            for (TransferManifestNode node : nodes) {
                assertTrue(nodeService.exists(node.getNodeRef()));
            }
    ...
    public void testAsyncCommitWithSummaryReport() throws Exception {
        ...
        try {
            ...
            assertTrue(
                    Boolean.parseBoolean(properties.getProperty(TransferCommons.TS_SIMPLE_REPORT)));
    ...
    private void localTestDestinationReports(boolean testAlsoForSummaryReport)
        ...
        assertTrue(
                nodeService
                        .getType(destinationReportNodeRef)
                        .equals(TransferModel.TYPE_TRANSFER_RECORD));

        String destinationReportName =
                (String)
                        nodeService
                                .getProperties(destinationReportNodeRef)
                                .get(ContentModel.PROP_NAME);
        String destinationReportWithoutExtension =
                destinationReportName.substring(0, destinationReportName.lastIndexOf("."));

        NodeRef summaryReportsParentFolder = null;
        String summaryReportsLocation =
                "/app:company_home/app:dictionary/app:transfers/app:inbound_transfer_records";
        // properties.getProperty("spaces.transfer_summary_report.location"); getting the property
        // from the properties bean does not work
    ...
    private NodeRef getSummaryReportsParentFolder(String transferSummaryReportLocation) {
        ...
        log.debug(
                "Trying to find transfer summary report records folder: "
                        + transferSummaryReportLocation);
        List<NodeRef> refs =
    ...
    private void moveNode(
            TransferManifestNormalNode childNode, TransferManifestNormalNode newParent) {
        ...
        for (ChildAssociationRef parent : currentParents) {
            if (!parent.isPrimary()) {
                ...
                ChildAssociationRef newPrimaryAssoc =
                        new ChildAssociationRef(
                                ContentModel.ASSOC_CONTAINS,
                                newParent.getNodeRef(),
                                parent.getQName(),
                                parent.getChildRef(),
                                true,
                                -1);
    ...
    private void associatePeers(
            TransferManifestNormalNode source, TransferManifestNormalNode target) {
    ...
    private String createSnapshot(List<TransferManifestNode> nodes, String repoID)
            throws Exception {
    ...
    private TransferManifestNormalNode createContentNode(/*String transferId*/ ) throws Exception {
        ...
        ContentData contentData =
                new ContentData("/" + uuid, "text/plain", dummyContent.length, "UTF-8");
