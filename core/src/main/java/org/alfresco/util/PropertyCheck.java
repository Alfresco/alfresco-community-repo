...
public class PropertyCheck
{
    ...
    /**
     * Dig out the property name from a placeholder-style property of form <b>${prop.name}</b>, which will yield <b>prop.name</b>. If the placeholders are not there, the value is returned directly. <tt>null</tt> values are not allowed, but empty strings are.
     * 
     * @param value
     *            The property with or without property placeholders
     * @return Returns the core property without the property placeholders <b>${</b> and <b>}</b>.
