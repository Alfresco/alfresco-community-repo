 ...
 *
 * <p><b>Same behaviour as {@link ModeratedActionReject}</b>
 *
 * @author Nick Smith
...
public class RejectModeratedInviteDelegate extends AbstractInvitationDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String reviewComments =
                (String) vars.get(WorkflowModelModeratedInvitation.wfVarReviewComments);

        invitationService.rejectModeratedInvitation(
                siteName, invitee, role, reviewer, resourceType, reviewComments);
    }
}
