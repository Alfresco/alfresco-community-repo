...
public class CreateDocumentTests extends CmisTest {
  ...
  public void siteManagerCannotCreateDocumentEndingWithPoint()
    throws Exception {
  ...
  public void adminCannotCreateDocumentWithInvalidCharacters()
    throws Exception {
    FileModel invalidCharDoc = new FileModel(
      "/.:?|\\`\\.txt",
      FileType.TEXT_PLAIN
    );
    cmisApi
  ...
  public void siteManagerCannotCreateDocWithInvalidObjectTypeId()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void siteManagerCanCreateDocumentWithValidSymbols() throws Exception {
    FileModel validSymbolsDoc = new FileModel(
      "!@#$%^&",
      FileType.TEXT_PLAIN,
      "content"
    );
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerShouldCreateDocumentWithMajorVersioningState()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerShouldCreateDocumentWithMinorVersioningState()
    throws Exception {
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerShouldCreateDocumentWithCheckedOutVersioningState()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void nonInvitedUserShouldNotCreateDocumentInPrivateSite()
    throws Exception {
  ...
  public void siteManagerCannotCreateDocumentWithNoProperties()
    throws Exception {
  ...
  public void managerIsAbleToCreateFileWithMultiByteName() throws Exception {
    testFile =
      new FileModel(
        RandomData.getRandomAlphanumeric() + "\ufeff\u6768\u6728\u91d1"
      );
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void siteManagerCannotCreateDocumentInDocumentLocation()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(testUser)
