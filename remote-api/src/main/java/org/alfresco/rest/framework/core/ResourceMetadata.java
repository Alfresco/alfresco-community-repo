...
/**
 * Describes a resource and its properties. Metadata about what functions the resource can perform
...
public class ResourceMetadata {
    ...
    @JsonIgnore private final Api api;
    ...
    public ResourceMetadata(
        ...
        this.operations =
                (List<ResourceOperation>)
                        (operations == null ? Collections.emptyList() : operations);
        this.api = api;
        this.apiDeleted =
                (Set<Class<? extends ResourceAction>>)
                        (apiDeleted == null ? Collections.emptySet() : apiDeleted);
        this.apiNoAuth =
                (Set<Class<? extends ResourceAction>>)
                        (apiNoAuth == null ? Collections.emptySet() : apiNoAuth);
        this.parentResource =
                parentResource != null
                        ? (parentResource.startsWith("/") ? parentResource : "/" + parentResource)
                        : null;
    }
    ...
    //
    //    /**
    //     * Gets the properties for the specified http method. That are available to be changed by
    // a url path.
