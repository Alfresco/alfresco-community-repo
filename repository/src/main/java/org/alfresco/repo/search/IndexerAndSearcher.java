...
public interface IndexerAndSearcher {
     ...
     *
     * @param storeRef StoreRef
     * @param searchDelta - serach the in progress transaction as well as the main index (this is
     *     ignored for searches that do full text)
     * @return SearchService
     * @throws SearcherException
     */
    public abstract SearchService getSearcher(StoreRef storeRef, boolean searchDelta)
            throws SearcherException;
