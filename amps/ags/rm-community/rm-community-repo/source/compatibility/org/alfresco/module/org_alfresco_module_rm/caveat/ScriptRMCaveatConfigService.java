...
public class ScriptRMCaveatConfigService
  ...
  public void setCaveatConfigService(
    RMCaveatConfigService rmCaveatConfigService
  ) {
  ...
  private ScriptConstraint[] getConstraints(boolean includeEmptyList) {
    ...
    for (RMConstraintInfo value : values) {
      ScriptConstraint c = new ScriptConstraint(
        value,
        caveatConfigService,
        getAuthorityService()
      );
   ...
   * Update value
   */
  public void updateConstraintValues(
    String listName,
    String authorityName,
    String[] values
  ) {
    List<String> vals = new ArrayList<>();
    caveatConfigService.updateRMConstraintListAuthority(
      listName,
      authorityName,
      vals
    );
   ...
   */
  public void deleteRMConstraintListAuthority(
    String listName,
    String authorityName
  ) {
    //TODO Temporary conversion
  ...
  public ScriptConstraint createConstraint(
    String listName,
    String title,
    ...
    RMConstraintInfo info = caveatConfigService.addRMConstraint(
      listName,
      title,
      allowedValues
    );
