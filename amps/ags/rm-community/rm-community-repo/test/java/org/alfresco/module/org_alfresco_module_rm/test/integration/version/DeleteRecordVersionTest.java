...
public class DeleteRecordVersionTest extends RecordableVersionsBaseTest {
    /**
     * Given that a document is created And the initial version is record When I delete the version
     * record Then the version is deleted And the version history is not deleted
     *
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() throws Exception {
                        ...
                        nodeService.addAspect(
                                myDocument, RecordableVersionModel.ASPECT_VERSIONABLE, props);
                    ...
                    public void when() {
                        ...
                        assertEquals(
                                ...
                                nodeService.getProperty(
                                        myDocument, ContentModel.PROP_VERSION_LABEL));
                        ...
                        VersionHistory recordVersionHistory =
                                versionService.getVersionHistory(record);
                    ...
                    public void then() {
                        ...
                        assertTrue(
                                nodeService.hasAspect(myDocument, ContentModel.ASPECT_VERSIONABLE));
                        ...
                        // check the recorded version is marked as destroyed and the record version
    ...
    /**
     * Given that a document is created And the initial version is record And the associated version
     * record is deleted When a new version is created Then a new associated version record is
     * created And the version is 1.1 (not 1.0 since this was deleted, but the version history
     * maintained)
     *
     * @see https://issues.alfresco.com/jira/browse/RM-2562
     */
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void then() {
                        ...
                        Set<Relationship> from =
                                relationshipService.getRelationshipsFrom(versionRecord);
                        assertTrue(from.isEmpty());

                        Set<Relationship> to =
                                relationshipService.getRelationshipsTo(versionRecord);
    ...
    /**
     * Given a chain of version records (1.0, 1.1, 1.2) which are all related When I delete version
     * record 1.0 Then 1.1 is the oldest version
     */
                    ...
                    public void then() {
                        ...
                        assertTrue(
                                relationshipService
                                        .getRelationshipsTo(
                                                recordVersion12,
                                                RelationshipService.RELATIONSHIP_VERSIONS)
                                        .isEmpty());

                        Set<Relationship> from12 =
                                relationshipService.getRelationshipsFrom(
                                        recordVersion12, RelationshipService.RELATIONSHIP_VERSIONS);
                        ...
                        Set<Relationship> to11 =
                                relationshipService.getRelationshipsTo(
                                        recordVersion11, RelationshipService.RELATIONSHIP_VERSIONS);
    ...
    /**
     * Given a chain of version records (1.0, 1.1, 1.2) which are all related When I delete version
     * record 1.1 Then 1.2 now 'versions' 1.0
     */
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void then() {
                        ...
                        Set<Relationship> to10 =
                                relationshipService.getRelationshipsTo(
                                        recordVersion10, RelationshipService.RELATIONSHIP_VERSIONS);
    ...
    /**
     * Given a chain of version records (1.0, 1.1, 1.2) which are all related When I delete version
     * record 1.2 Then 1.1 is the most recent version
     */
    ...
    /**
     * Given that a version record When the version record is destroyed whilst retaining the meta
     * data Then the version is marked as destroyed in the collab version history
     */
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() throws Exception {
                        ...
                        utils.createBasicDispositionSchedule(
                                myCategory, GUID.generate(), GUID.generate(), true, true);

                        NodeRef myRecordFolder =
                                recordFolderService.createRecordFolder(myCategory, GUID.generate());
                    ...
                    public void when() {
                        ...
                        rmActionService.executeRecordsManagementAction(
                                recordVersion11, CompleteEventAction.NAME, params);

                        rmActionService.executeRecordsManagementAction(
                                recordVersion11, CutOffAction.NAME);

                        rmActionService.executeRecordsManagementAction(
                                recordVersion11, DestroyAction.NAME);
                    }
