...
public class PersonFavouriteSitesRelation
     ...
     *
     * @see
     *     org.alfresco.rest.framework.resource.actions.interfaces.RelationshipResourceAction.Read#readAll(java.lang.String,
     *     org.alfresco.rest.framework.resource.parameters.Parameters)
     */
    @Override
    @WebApiDescription(
            title = "Get Person Favorite Sites",
            description = "Get a paged list of the person's favorite sites")
     ...
     *
     * @see
     *     org.alfresco.rest.framework.resource.actions.interfaces.RelationshipResourceAction.ReadById#readById(String,
     *     String, org.alfresco.rest.framework.resource.parameters.Parameters)
     */
    @Override
    @WebApiDescription(
            title = "Get Person Favorite Site",
            description = "Get information on a person's specific favorite site")
    ...
    public List<FavouriteSite> create(
            String personId, List<FavouriteSite> entity, Parameters parameters) {
