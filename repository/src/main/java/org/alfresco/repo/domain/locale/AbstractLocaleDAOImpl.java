 ...
 * CRUD operations.
 *
 * <p>Since locales are system-wide and immutable, we can cache lookups in both directions.
 *
 * @author janv
 * @since 3.4
 */
public abstract class AbstractLocaleDAOImpl implements LocaleDAO {
    ...
    public void setLocaleEntityCache(SimpleCache<Long, String> localeEntityCache) {
        this.localeEntityCache =
                new EntityLookupCache<Long, String, String>(
                        localeEntityCache, CACHE_REGION_LOCALE, new LocaleEntityCallbackDAO());
    }
    ...
    protected AbstractLocaleDAOImpl() {
        this.localeEntityCache =
                new EntityLookupCache<Long, String, String>(new LocaleEntityCallbackDAO());
    }
     ...
     *
     * @param locale the locale to get or <tt>null</tt> to indicate the {@link
     *     LocaleEntity#DEFAULT_LOCALE_SUBSTITUTE default locale}.
