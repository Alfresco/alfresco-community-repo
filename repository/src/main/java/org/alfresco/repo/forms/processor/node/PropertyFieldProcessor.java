            ...
            for (ConstraintDefinition constraintDef : constraints) {
                ...
                if (ListOfValuesConstraint.class.isAssignableFrom(constraint.getClass())) {
                    ...
                    for (String value : allowedValues) {
                        String displayLabel =
                                lovConstraint.getDisplayLabel(value, dictionaryService);
                        // Change the allowedValue entry to the format the FormsService expects for
                        // localised strings: "value|label"
                        // If there is no localisation defined for any value, then this will give us
                        // "value|value".
