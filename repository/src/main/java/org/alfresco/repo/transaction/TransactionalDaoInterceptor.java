...
/**
 * Utility class that ensures that a <tt>NodeDaoService</tt> has been registered with the current
 * transaction.
 *
 * <p>It is designed to act as a <b>postInterceptor</b> on the <tt>NodeDaoService</tt>'s {@link
