...
public interface MimetypeService {
    ...
    /**
     * Provides a non-null best guess of the appropriate mimetype given a filename, based entirely
     * on the file extension. Because file extensions can be wrong, you are strongly advised to use
     * {@link #guessMimetype(String, ContentReader)} instead.
     *
     * @param filename the name of the file with an optional file extension
     * @return Returns the best guess mimetype or the mimetype for straight binary files if no
    ...
    /**
     * Provides a non-null best guess of the appropriate mimetype for a given file. Uses a mixture
     * of file name and file content logic to identify the mimetype for the file, and will usually
    ...
    /**
     * Use detection heuristics to check if the mime type of the document really matches what it
     * claims to be. This is typically used when a transformation or metadata extractions fails, and
     * you want to know if someone has renamed a file and consequently it has the wrong mime type.
     *
     ...
     *
     * @return Returns a character set finder that can be used to decode streams in order to get the
     *     encoding.
     * @since 2.1
     */
    @NotAuditable
