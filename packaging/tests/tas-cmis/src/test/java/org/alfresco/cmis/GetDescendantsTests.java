...
public class GetDescendantsTests extends CmisTest {
  ...
  public void getDescendantsForDeletedParentFolderWithAtLeast2Children()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void siteCollaboratorCanGetDescendantsForValidFolderCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorCanGetDescendantsForValidFolderCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorCanGetDescendantsForValidFolderCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorCanGetDescendantsForValidFolderCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void nonSiteMemberCannotGetDescendantsAFolderFromAPrivateSite()
    throws Exception {
  ...
  public void nonSiteMemberCannotGetDescendantsAFolderFromAModeratedSite()
    throws Exception {
