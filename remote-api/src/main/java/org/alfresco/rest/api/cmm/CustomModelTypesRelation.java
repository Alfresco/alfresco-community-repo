...
public class CustomModelTypesRelation
  ...
  @Override
  @WebApiDescription(
    title = "Returns a paged list of all the custom model's types."
  )
  public CollectionWithPagingInfo<CustomType> readAll(
    String modelName,
  ...
  @Override
  @WebApiDescription(
    title = "Returns custom type information for the given 'typeName' in 'modelName'."
  )
  public CustomType readById(
    String modelName,
    String typeName,
    Parameters parameters
  ) {
  ...
  @Override
  @WebApiDescription(
    title = "Removes the custom type for the given 'typeName' in 'modelName'."
  )
  ...
  @Override
  @WebApiDescription(
    title = "Updates the custom type in the given 'modelName'."
  )
  public CustomType update(
    String modelName,
    CustomType type,
    Parameters parameters
  ) {
