...
public class RenditionServiceIntegrationTest extends BaseAlfrescoSpringTest {
  ...
  private static final QName REFORMAT_RENDER_DEFN_NAME = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    ReformatRenderingEngine.NAME + System.currentTimeMillis()
  );
  private static final QName RESCALE_RENDER_DEFN_NAME = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    ImageRenderingEngine.NAME + System.currentTimeMillis()
  );
  private static final String QUICK_CONTENT =
  ...
  private NodeRef createFreeMarkerNode(NodeRef companyHome) {
    NodeRef fmNode = createContentNode(
      companyHome,
      "testFreeMarkerNode-" + GUID.generate()
    );
    nodeService.setProperty(
      fmNode,
      ContentModel.PROP_CONTENT,
    ...
    ContentWriter fmWriter = contentService.getWriter(
      fmNode,
      ContentModel.PROP_CONTENT,
      true
    );
  ...
  public void testRenderFreeMarkerTemplate() throws Exception {
    final QName renditionName = QName.createQName(
      ...
      transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
          ...
          public NodeRef execute() throws Throwable {
            // create test model
            RenditionDefinition definition = renditionService.createRenditionDefinition(
              renditionName,
              FreemarkerRenderingEngine.NAME
            );
  ...
  public void testHTMLRenderFreeMarkerTemplate() throws Exception {
    ...
    this.renditionNode =
      transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
          ...
          public NodeRef execute() throws Throwable {
            // create test model
            RenditionDefinition htmlDefinition = renditionService.createRenditionDefinition(
              renditionName,
              FreemarkerRenderingEngine.NAME
            );
    ...
    assertEquals(
      numberOfItemsInTrashcanBeforeRendition,
      numberOfItemsInTrashcanAfterRendition
    );
  }
  ...
  private int getNumberOfItemsInTrashcan() {
    NodeRef archiveRootNodeRef = nodeService.getRootNode(
  ...
  public void testRenderFreemarkerTemplatePath() throws Exception {
    ...
    final QName renditionName1 = QName.createQName(
      NamespaceService.RENDITION_MODEL_1_0_URI,
      FreemarkerRenderingEngine.NAME + "_UpdateOnAnyPropChange"
    );
    final QName renditionName2 = QName.createQName(
      NamespaceService.RENDITION_MODEL_1_0_URI,
      FreemarkerRenderingEngine.NAME + "_UpdateOnContentPropChange"
    );

    final Pair<NodeRef, NodeRef> renditions = transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Pair<NodeRef, NodeRef>>() {
        public Pair<NodeRef, NodeRef> execute() throws Throwable {
          ...
          RenditionDefinition definition1 = renditionService.createRenditionDefinition(
            renditionName1,
            FreemarkerRenderingEngine.NAME
          );
          ...
          RenditionDefinition definition2 = renditionService.createRenditionDefinition(
            renditionName2,
            FreemarkerRenderingEngine.NAME
          );
          ...
          if (
            null == renditionService.loadRenditionDefinition(renditionName1)
          ) {
            renditionService.saveRenditionDefinition(definition1);
          }
          if (
            null == renditionService.loadRenditionDefinition(renditionName2)
          ) {
            renditionService.saveRenditionDefinition(definition2);
          }

          ChildAssociationRef renditionAssoc1 = renditionService.render(
            nodeWithDocContent,
            definition1
          );
          assertNotNull("The rendition association was null", renditionAssoc1);

          ChildAssociationRef renditionAssoc2 = renditionService.render(
            nodeWithDocContent,
            definition2
          );
          assertNotNull("The rendition association was null", renditionAssoc2);

          Pair<NodeRef, NodeRef> result = new Pair<NodeRef, NodeRef>(
  ...
  private void assertRenditionContainsTitle(
    ...
    int indexOfStartMarker = output.indexOf(
      beforeAfterMarker,
      indexOfTitleMarker
    );
    int indexOfEndMarker = output.indexOf(
      beforeAfterMarker,
      indexOfStartMarker + beforeAfterMarker.length()
    );
    final String titleAsTakenFromRendition = output.substring(
      indexOfStartMarker + beforeAfterMarker.length(),
      indexOfEndMarker
    );
        ...
        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Throwable {
            ...
            assertTrue(
              ...
              renditionService.getRenditions(nodeWithDocContent).isEmpty()
            );
            assertNull(
  ...
  protected void renderPdfDocumentLongRunningTest(
    AbstractNodeModifyingRunnable nodeModifyingRunnable,
    boolean joinNodeModifyingThread
  ) throws Exception {
  ...
  public void testRenderPdfDocumentLongRunningCheckout() throws Exception {
    try {
      ...
      renderPdfDocumentLongRunningTest(
        new CheckoutRunnable(nodeWithDocContent),
        true
      );
    } finally {
      transactionHelper.doInTransaction(
        () -> {
          ...
          NodeRef wc = checkOutCheckInService.getWorkingCopy(
            nodeWithDocContent
          );
          assertNotNull(wc);
  ...
  public void testRenderPdfDocumentLongRunningLock() throws Exception {
    class LockRunnable extends AbstractNodeModifyingRunnable {
      ...
      protected void modifyNode(NodeRef nodeRef) {
        AuthenticationUtil.setRunAsUserSystem();
        LockService lockService = (LockService) applicationContext.getBean(
          "lockService"
        );
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() { //
        public Void execute() throws Throwable {
          ...
          assertEquals(
            "There should only be one rendition",
            1,
            renditions.size()
          );
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          RenditionDefinition definition = makeReformatAction(
            ContentModel.TYPE_CONTENT,
            MimetypeMap.MIMETYPE_TEXT_PLAIN
          );
          Serializable targetFolderName = nodeService.getProperty(
            testTargetFolder,
  ...
  public void testRenderCropImage() throws Exception {
    ...
    final NodeRef newRenditionNode = performImageRendition(
      parameterValues,
      nodeWithImageContent
    );
        ...
        public Void execute() throws Throwable {
          ...
          List<ChildAssociationRef> children = nodeService.getChildAssocs(
            ...
            new RegexQNamePattern(
              getLongNameWithEscapedBraces(RenditionModel.ASSOC_RENDITION)
            ),
            new RegexQNamePattern(
              getLongNameWithEscapedBraces(RESCALE_RENDER_DEFN_NAME)
            )
          );
          ...
          ContentReader srcReader = contentService.getReader(
            nodeWithImageContent,
            ContentModel.PROP_CONTENT
          );
          BufferedImage srcImg = ImageIO.read(
            srcReader.getContentInputStream()
          );
    ...
    final NodeRef secondRenditionNode = performImageRendition(
      parameterValues,
      nodeWithImageContent
    );
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          // The lower right pixel of the image should be pure white
          int rgbAtBottomRight = img.getRGB(
            img.getWidth() - 1,
            img.getHeight() - 1
          );
          assertTrue(
        ...
        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Throwable {
            ...
            assertTrue(
              ...
              renditionService.getRenditions(nodeWithImageContent).isEmpty()
            );

            // Create 4 arbitrary rendition definitions
            QName rendName1 = QName.createQName(
              NamespaceService.CONTENT_MODEL_1_0_URI,
              "definition1" + System.currentTimeMillis()
            );
            RenditionDefinition action1 = renditionService.createRenditionDefinition(
              rendName1,
            ...
            QName rendName2 = QName.createQName(
              NamespaceService.CONTENT_MODEL_1_0_URI,
              "definition2" + System.currentTimeMillis()
            );
            RenditionDefinition action2 = renditionService.createRenditionDefinition(
              rendName2,
              ReformatRenderingEngine.NAME
            );
            ...
            QName rendName3 = QName.createQName(
              NamespaceService.CONTENT_MODEL_1_0_URI,
              "definition3" + System.currentTimeMillis()
            );
            RenditionDefinition action3 = renditionService.createRenditionDefinition(
              rendName3,
            ...
            RenditionDefinition action4 = renditionService.createRenditionDefinition(
              rendName4,
              ImageRenderingEngine.NAME
            );
            ...
            ChildAssociationRef createdRendition1 = renditionService.render(
              nodeWithImageContent,
              action1
            );
            ChildAssociationRef createdRendition2 = renditionService.render(
              nodeWithImageContent,
              action2
            );
            ChildAssociationRef createdRendition3 = renditionService.render(
              nodeWithImageContent,
              action3
            );
            ChildAssociationRef createdRendition4 = renditionService.render(
              nodeWithImageContent,
              action4
            );

            // Now validate the getRenditions methods
            List<ChildAssociationRef> allRenditions = renditionService.getRenditions(
              nodeWithImageContent
            );
  ...
  protected NodeRef performImageRendition(
    ...
    final NodeRef imageToRender
  ) {
    final NodeRef newRenditionNode = transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
    ...
    try {
      ...
      transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            assertTrue(
              "The rendering action space has not been created in the repository!", //
              nodeService.exists(
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          for (ChildAssociationRef chRef : nodeService.getChildAssocs(
            RenditionDefinitionPersisterImpl.RENDERING_ACTION_ROOT_NODE_REF
          )) {
            System.out.println(
          ...
          RenditionDefinition action = createAction(
            ImageRenderingEngine.NAME,
            "medium",
            parameterValues
          );
          ...
          action =
            createAction(ImageRenderingEngine.NAME, "doclib", parameterValues);
          renditionService.saveRenditionDefinition(action);
          ...
          action =
            createAction(ImageRenderingEngine.NAME, "avatar", parameterValues);
          renditionService.saveRenditionDefinition(action);
          return null;
        }
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          exportAction.setParameterValue(
            ExporterActionExecuter.PARAM_ENCODING,
            "UTF-8"
          );
          exportAction.setParameterValue(
          ...
          exportAction.setParameterValue(
            ExporterActionExecuter.PARAM_INCLUDE_SELF,
            true
          );
          exportAction.setParameterValue(
            ExporterActionExecuter.PARAM_INCLUDE_CHILDREN,
            true
          );
  ...
  public void testLoadRenderingAction() throws Exception {
    final RenditionDefinition reformatAction = makeReformatAction(
      null,
      MimetypeMap.MIMETYPE_TEXT_PLAIN
    );
      ...
      transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            RenditionDefinition result = renditionService.loadRenditionDefinition(
              renditionName
            );
            ...
            assertEquals(
              reformatAction.getModifiedDate(),
      ...
      transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            RenditionDefinition firstLoadedAction = renditionService.loadRenditionDefinition(
              reformatAction.getRenditionName()
            );
            RenditionDefinition secondLoadedAction = renditionService.loadRenditionDefinition(
      ...
      transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            assertEquals(
              compositeDefinition.getDescription(),
              result.getDescription()
            );
            assertEquals(
            ...
            assertEquals(
              compositeDefinition.getModifier(),
              result.getModifier()
            );
            ...
            if (result instanceof CompositeRenditionDefinition) {
              ...
              "The retrieved rendition should be a CompositeRenditionDefinition."
            );
            return null;
          }
        }
  ...
  public void testBuiltinRenditionDefinitions() throws Exception {
    final RenditionDefinition mediumRenditionDef = loadAndValidateRenditionDefinition(
      "medium"
    );
    final RenditionDefinition doclibRenditionDef = loadAndValidateRenditionDefinition(
      "doclib"
    );
    final RenditionDefinition imgpreviewRenditionDef = loadAndValidateRenditionDefinition(
      "imgpreview"
    );
    final RenditionDefinition webpreviewRenditionDef = loadAndValidateRenditionDefinition(
      "webpreview"
    );
    final RenditionDefinition avatarRenditionDef = loadAndValidateRenditionDefinition(
      "avatar"
    );

    assertEquals(
      MimetypeMap.MIMETYPE_IMAGE_JPEG,
      mediumRenditionDef.getParameterValue(
        AbstractRenderingEngine.PARAM_MIME_TYPE
      )
    );
    assertEquals(
      MimetypeMap.MIMETYPE_IMAGE_PNG,
      doclibRenditionDef.getParameterValue(
        AbstractRenderingEngine.PARAM_MIME_TYPE
      )
    );
    assertEquals(
      MimetypeMap.MIMETYPE_IMAGE_JPEG,
      imgpreviewRenditionDef.getParameterValue(
        AbstractRenderingEngine.PARAM_MIME_TYPE
      )
    );
    assertEquals(
      MimetypeMap.MIMETYPE_FLASH,
      webpreviewRenditionDef.getParameterValue(
        AbstractRenderingEngine.PARAM_MIME_TYPE
      )
    );
    assertEquals(
      MimetypeMap.MIMETYPE_IMAGE_PNG,
      avatarRenditionDef.getParameterValue(
        AbstractRenderingEngine.PARAM_MIME_TYPE
      )
    );
  }
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          RenditionDefinition doclib = loadAndValidateRenditionDefinition(
            "doclib"
          );
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          InputStream corruptIn = applicationContext
  ...
  public void testALF3733() throws Exception {
    ...
    // which is illegal.
    QName renditionDefName = QName.createQName(
      NamespaceService.CONTENT_MODEL_1_0_URI,
      "myDummyRendition"
    );
    ...
    ChildAssociationRef rendition = renditionService.render(
      this.nodeWithImageContent,
      renditionDef
    );
    ...
    assertTrue(
      nodeService.hasAspect(
        rendition.getChildRef(),
        RenditionModel.ASPECT_VISIBLE_RENDITION
      )
    );

    // The rendition should have 2 parents.
    List<ChildAssociationRef> allParents = nodeService.getParentAssocs(
      rendition.getChildRef()
    );
    assertEquals(2, allParents.size());

    // The rendition should be created under a new folder called 'resized'
    NodeRef primaryParent = nodeService
      .getPrimaryParent(rendition.getChildRef())
      .getParentRef();
    assertEquals(
      "resized",
      nodeService.getProperty(primaryParent, ContentModel.PROP_NAME)
    );
  ...
  public void testRenditionPlacements() throws Exception {
    ...
    ChildAssociationRef renditionAssoc = renditionService.getRenditionByName(
      nodeWithDocContent,
      plainQName
    );
    ...
    assertEquals(
      plainQName,
      nodeService.getChildAssocs(nodeWithDocContent).get(0).getQName()
    );
    ...
    assertEquals(1, nodeService.getChildAssocs(nodeWithDocContent).size());
    renditionAssoc =
      renditionService.getRenditionByName(nodeWithDocContent, compositeQName);
    assertNotNull(renditionAssoc);
    assertEquals(
      compositeQName,
      nodeService.getChildAssocs(nodeWithDocContent).get(0).getQName()
    ...
    QName expectedName = QName.createQName(
      NamespaceService.CONTENT_MODEL_1_0_URI,
      fileName
    );
  ...
  private RenditionDefinition loadAndValidateRenditionDefinition(
    String renditionLocalName
  ) {
    ...
    RenditionDefinition renditionDefinition = renditionService.loadRenditionDefinition(
      renditionQName
    );
    assertNotNull(
    ...
    assertEquals(
      "'" +
      renditionLocalName +
      "' renditionDefinition had wrong renditionName",
      renditionQName,
  ...
  private void validateRenderingActionDefinition(
    final String renderingEngineName
  ) {
    // Make sure we can get the action definition.
    RenderingEngineDefinition renderingActionDefn = renditionService.getRenderingEngineDefinition(
      renderingEngineName
    );
  ...
  private void validateRenditionAssociation(
    ...
    assertEquals(
      "The assoc name was wrong",
      renderingActionQName,
      chAssRef.getQName()
    );
    ...
    NodeRef renditionSource = renditionService
      .getSourceNode(newRenditionNodeRef)
      .getParentRef();
    NodeRef renditionPrimaryParent = nodeService
      .getPrimaryParent(newRenditionNodeRef)
      .getParentRef();
  ...
  private CompositeRenditionDefinition makeCompositeReformatAndResizeDefinition(
    ...
    CompositeRenditionDefinition compositeDefinition = renditionService.createCompositeRenditionDefinition(
      renditionName
    );
    RenditionDefinition reformatDefinition = makeReformatAction(
      null,
      MimetypeMap.MIMETYPE_IMAGE_JPEG
    );
    RenditionDefinition rescaleImageDefinition = makeRescaleImageAction();
    rescaleImageDefinition.setParameterValue(
      ImageRenderingEngine.PARAM_RESIZE_WIDTH,
      newX
    );
    rescaleImageDefinition.setParameterValue(
  ...
  public void testAutoRotateImage() throws Exception {
    ...
    final NodeRef newNodeForRotate = createNode(
      companyHome,
      "rotateImageNode",
      ContentModel.TYPE_CONTENT
    );
    ...
    //Test auto rotates
    final Map<String, Serializable> parameterValues = new HashMap<String, Serializable>();
    resizeImageAndCheckOrientation(
      newNodeForRotate,
      parameterValues,
      BLACK,
      WHITE
  ...
  private static File retrieveValidImageFile(String imageSource)
    throws IOException {
    URL url =
      RenditionServiceIntegrationTest.class.getClassLoader()
        .getResource(imageSource);
    File imageFile = new File(url.getFile());
  ...
  private static void checkTopLeftBottomRight(
    ...
    String rgbAtBottomRight = Integer.toHexString(
