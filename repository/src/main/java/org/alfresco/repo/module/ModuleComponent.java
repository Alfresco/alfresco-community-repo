 ...
 *
 * <p>Note that the execution order of these components is on the basis of dependencies only. The
 * version numbering determines only whether a component will be executed and doesn't imply any
 * ordering.
 *
 * <p>Equals and Hashcode method must be implemented.
 *
 * @author Derek Hulley
 * @since 2.0
 */
...
public interface ModuleComponent {
    ...
    /**
     * @return Returns the name of the component in the context of the module ID. It does not have
    ...
    /**
     * A list of module components that <b>must</b> be executed prior to this instance. This is the
     * only way to guarantee ordered execution. The dependencies may include components from other
     * modules, guaranteeing an early failure if a module is missing.
     *
    ...
    /**
     * Perform the actual component's work. Execution will be done within the context of a system
     * account with an enclosing transaction. Long-running processes should be spawned from the
     * calling thread, if required.
     *
     * <p>All failures should just be thrown out as runtime exceptions and will be dealt with by the
     * associated module infrastructure.
     */
    void execute();
