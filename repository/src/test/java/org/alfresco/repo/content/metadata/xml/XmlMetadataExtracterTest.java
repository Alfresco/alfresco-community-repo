...
public class XmlMetadataExtracterTest extends TestCase {
    ...
    private RootElementNameContentWorkerSelector<MetadataExtracter>
    ...
    public void setUp() throws Exception {
        ...
        alfrescoModelMetadataExtracter =
                (XPathMetadataExtracter)
                        ctx.getBean("extracter.xml.AlfrescoModelMetadataExtracter");
        eclipseProjectMetadataExtracter =
                (XPathMetadataExtracter)
                        ctx.getBean("extracter.xml.EclipseProjectMetadataExtracter");
        ditaConceptMetadataExtracter =
                (XPathMetadataExtracter) ctx.getBean("extracter.xml.DITAConceptMetadataExtracter");
        rootElementNameMetadataExtracterSelector =
                (RootElementNameContentWorkerSelector<MetadataExtracter>)
                        ctx.getBean("extracter.xml.selector.RootElementSelector");
        xpathMetadataExtracterSelector =
                (XPathContentWorkerSelector<MetadataExtracter>)
                        ctx.getBean("extracter.xml.selector.XPathSelector");
    ...
    public void testExtractAlfresocModel() throws Exception {
        ...
        assertEquals(
                "Forum Model", getPropertyValue(checkProperties, ContentModel.PROP_DESCRIPTION));
    }
    ...
    public void testExtractEclipseProject() throws Exception {
        ...
        assertEquals(
                "JavaCC Nature", getPropertyValue(checkProperties, ContentModel.PROP_DESCRIPTION));
    }
    ...
    public void testRootElementNameSelector() throws Exception {
        ...
        MetadataExtracter alfrescoModelExtracter =
                rootElementNameMetadataExtracterSelector.getWorker(alfrescoModelReader);
        ...
        MetadataExtracter eclipseProjectExtracter =
                rootElementNameMetadataExtracterSelector.getWorker(eclipseProjectReader);
    ...
    public void testXpathSelector() throws Exception {
        ...
        // Check with an alfresco model document
        MetadataExtracter alfrescoModelExtracter =
                xpathMetadataExtracterSelector.getWorker(alfrescoModelReader);
        assertNotNull("Failed to select correct extracter", alfrescoModelExtracter);
        assertTrue(
                "Incorrect extracter instance selected",
                alfrescoModelMetadataExtracter == alfrescoModelExtracter);
        ...
        // Check with an eclipse project document
        MetadataExtracter eclipseProjectExtracter =
                xpathMetadataExtracterSelector.getWorker(eclipseProjectReader);
        assertNotNull("Failed to select correct extracter", eclipseProjectExtracter);
        assertTrue(
                "Incorrect extracter instance selected",
                eclipseProjectMetadataExtracter == eclipseProjectExtracter);
    ...
    public void testXmlMetadataExtracter() throws Exception {
        ...
        assertEquals(
                "Forum Model",
                getPropertyValue(checkAlfrescoModelProperties, ContentModel.PROP_DESCRIPTION));
        ...
        assertEquals(
                "JavaCC Nature",
                getPropertyValue(checkEclipseProjectProperties, ContentModel.PROP_DESCRIPTION));
    }
    ...
    public void testLifecycleOfXmlMetadataExtraction() throws Exception {
        ...
        Action action =
                new ActionImpl(null, GUID.generate(), SetPropertyValueActionExecuter.NAME, null);
        ...
        NodeRef contentNodeRef =
                nodeService
                        .createNode(
                                ...
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, getName()),
        ...
        // Check the node's properties.  The EAGER overwrite policy should have replaced the
        // required
        // properties.
        String checkTitle =
                (String) nodeService.getProperty(contentNodeRef, ContentModel.PROP_TITLE);
        String checkDescription =
                (String) nodeService.getProperty(contentNodeRef, ContentModel.PROP_DESCRIPTION);
