...
public class IsLatestMajorVersionTests extends CmisTest {
  ...
  public void dataPreparation() throws Exception {
    minorVersionDoc =
      FileModel.getRandomFileModel(FileType.XML, documentContent);
    majorVersionDoc =
      FileModel.getRandomFileModel(FileType.XML, documentContent);
  ...
  public void verifyIsLatestMajorVersionFailsOnDeletedDocument()
    throws Exception {
    FileModel testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(managerUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void nonInvitedUserCanVerifyIsLatestMajorVersionInPublicSite()
    throws Exception {
    cmisApi
  ...
  public void nonInvitedUserCannotVerifyIsLatestMajorVersionInPrivateSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotVerifyIsLatestMajorVersionInModeratedSite()
    throws Exception {
