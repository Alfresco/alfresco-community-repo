...
public class SingletonExtensionFactory<E, S extends SingletonExtension<E, T>, T extends Trait>
  ...
  public SingletonExtensionFactory(S singleton, Class<E> extensionAPI)
  ...
  public <TO extends Trait> E createExtension(TO traitObject) {
    ...
    if (logger.isDebugEnabled()) {
      String traitTrace = traitObject != null
        ? traitObject.getClass().toString()
        : "<null> trait";
      logger.info(
        "Creating singleton extension " +
        singleton.getClass() +
        "<-" +
        traitTrace
      );
  ...
  public boolean canCreateExtensionFor(ExtensionPoint<?, ?> point) {
    return (
      point.getExtensionAPI().isAssignableFrom(singleton.getClass()) &&
