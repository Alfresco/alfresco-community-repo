...
public interface VersionService
{
     ...
     *            the version properties that are stored with the newly created version, or <tt>null</tt> if there are no relevant properties
     * @return the created version object
     * @throws ReservedVersionNameException
     *             thrown if a reserved property name is used int he version properties provided
     ...
     *            a node reference
     * @param versionProperties
     *            the version properties that are stored with the newly created version
     * @param versionChildren
     *            if true then the children of the referenced node are also versioned, false otherwise
     ...
     * @throws ReservedVersionNameException
     *             thrown if a reserved property name is used in the version properties provided
     * @throws AspectMissingException
     *             thrown if the version aspect is missing
     */
    @Auditable(parameters = {"nodeRef", "versionProperties"})
     ...
     * 
     * @param nodeRef
     *            the node reference of the 'live' node
     * @return the version object for the current version
     * @throws IllegalArgumentException
     *             if the nodeRef is not a reference to a 'live' node
     */
    @Auditable(parameters = {"nodeRef"})
     ...
     *            the node reference
     * @param deep
     *            true if a deep revert is to be performed, false otherwise
     */
     ...
     *            the version to revert to
     * @param deep
     *            true is a deep revert is to be performed, false otherwise.
     */
     ...
     * 
     * @param nodeRef
     *            the node reference to a node that no longer exists in the store
     * @param parentNodeRef
     *            the new parent of the restored node
     * @param assocTypeQName
     *            the assoc type qname
     * @param assocQName
     *            the assoc qname
     ...
     *            the assoc qname
     * @param deep
     *            true is a deep revert should be performed once the node has been restored, false otherwise
     * @return the newly restored node reference
     */
     ...
     *            the node reference
     * @param versionProperties
     *            the version properties to apply if versioning isn't currently enabled for the node
     */
    @Auditable(parameters = {"nodeRef"})
