...
public class ValueDataTypeValidatorImplTest {
    ...
    public static void initStaticData() throws Exception {
        validator =
                APP_CONTEXT_INIT
                        ...
                        .getBean("valueDataTypeValidator", ValueDataTypeValidator.class);
    }
    ...
    public void testValueTextDataType() throws Exception {
        // d:text tests
        {
            ...
            validate_invalid(
                    "unknownPrefix" + System.currentTimeMillis() + ":text",
                    "some text"); // prefix is not mapped to a namespace URI
        ...
        // d:mltext tests
        {
            ...
            validate_invalid(
                    "unknownPrefix" + System.currentTimeMillis() + ":mltext",
                    "some mltext"); // prefix is not mapped to a namespace URI
    ...
    public void testValueContentDataType() throws Exception {
        // d:content tests
        {
            ...
            validate_invalid(
                    "somePrefix:", "some very long text"); // invalid QName prefixed data type
            validate_invalid(
                    "unknownPrefix" + System.currentTimeMillis() + ":content",
                    "some text"); // prefix is not mapped to a namespace URI
