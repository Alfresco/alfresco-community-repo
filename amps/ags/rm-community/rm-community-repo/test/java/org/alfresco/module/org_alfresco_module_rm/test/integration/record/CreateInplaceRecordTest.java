...
public class CreateInplaceRecordTest extends BaseRMTestCase {
    ...
    /**
     * Given a document in a collaboration site When the document is declared by a site collaborator
     * Then the document becomes a record And the site users have the appropriate in-place
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    public void given() {
                        ...
                        assertFalse(
                                "The document should not be a record",
                    ...
                    public void then() {
                        ...
                        assertTrue(
                                "The document should now be a record",
                                recordService.isRecord(dmDocument));
                                    ...
                                    public Void doWork() throws Exception {
                                        assertEquals(
                                                ...
                                                permissionService.hasPermission(
                                                        dmDocument, RMPermissionModel.FILING));
                                        assertEquals(
                                                AccessStatus.ALLOWED,
                                                permissionService.hasPermission(
                                                        dmDocument,
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    public void given() {
                        ...
                        assertTrue(
                                "The document should be a record",
                                recordService.isRecord(dmDocument));
                        assertFalse(
                                "The record should not be filed",
                                recordService.isFiled(dmDocument));
                    }
    ...
    /**
     * Given a shared document in a collaboration site When the document is declared as record by a
     * site collaborator Then the document becomes a record and is not shared anymore
     */
                ...
                new BehaviourDrivenTest() {
                    public void given() {
                        ...
                        assertTrue(
                                ...
                                nodeService.hasAspect(dmDocument, QuickShareModel.ASPECT_QSHARE));
                    }
                    ...
                    public void then() {
                        ...
                        assertFalse(
                                "The document should not be shared anymore",
                                nodeService.hasAspect(dmDocument, QuickShareModel.ASPECT_QSHARE));
                    }
                });
    }
    ...
    /**
     * Given a document in a collaboration site declared as record When I try to share the document
     * Then it fails
     */
    public void testRecordsFromCollabSiteCannotBeShared() {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(IntegrityException.class) {
                    public void given() {
                        // Check that the document is not a record
                        assertFalse(
                                "The document should not be a record",
                    ...
                    public void after() {
                        ...
                        assertFalse(
                                "The document should not be shared",
                                nodeService.hasAspect(dmDocument, QuickShareModel.ASPECT_QSHARE));
                    }
                });
    }
