...
public class ExtendedActionServiceTest extends BaseRMTestCase {
  ...
  public static final String RECORD_AND_FOLDER_ONLY_ACTION =
    "recordandFolderOnlyAction";
  ...
  public void xtestAvailableActions() {
    doTestInTransaction(
      new Test<Void>() {
        public Void run() {
          List<ActionDefinition> result = actionService.getActionDefinitions(
            recordOne
          );
  ...
  public void testDelegateActions() {
     ...
     */
    assertTrue(
      inheritsAllParameterDefinitions("setPropertyValue", "set-property-value")
    );
   ...
   */
  private boolean inheritsAllParameterDefinitions(
    String rmAction,
    String delegateAction
  ) {
    /*
     * Get the parameter definition list for rmAction
     */
    ActionDefinition rmActionDefinition = actionService.getActionDefinition(
      rmAction
    );
     ...
     */
    ActionDefinition delegateActionDefinition = actionService.getActionDefinition(
      delegateAction
    );
