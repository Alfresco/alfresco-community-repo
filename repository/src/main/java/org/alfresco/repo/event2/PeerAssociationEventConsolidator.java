...
public class PeerAssociationEventConsolidator
   ...
   */
  public RepoEvent<DataAttributes<PeerAssociationResource>> getRepoEvent(
    EventInfo eventInfo
  ) {
    EventType eventType = getDerivedEvent();

    DataAttributes<PeerAssociationResource> eventData = buildEventData(
      eventInfo,
      resource
    );

    return RepoEvent
      .<DataAttributes<PeerAssociationResource>>builder()
  ...
  protected DataAttributes<PeerAssociationResource> buildEventData(
    ...
    return EventData
      .<PeerAssociationResource>builder()
  ...
  private PeerAssociationResource buildPeerAssociationResource(
    AssociationRef associationRef
  ) {
  ...
  public boolean isTemporaryPeerAssociation() {
    return (
      eventTypes.contains(EventType.PEER_ASSOC_CREATED) &&
