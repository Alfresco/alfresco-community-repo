...
public class ActivitiInvitationServiceImplTests
  ...
  public void testWorkflowTaskContainsProps() {
    ...
    NominatedInvitation nomInvite = invitationService.inviteNominated(
      USER_ONE,
      resourceType,
      resourceName,
      inviteeRole,
  ...
  public void before() throws Exception {
    ...
    this.workflowService =
      (WorkflowService) applicationContext.getBean("WorkflowService");

    // Enable Activiti
    workflowAdminService.setEnabledEngines(
  ...
  public void testAddExistingUser() throws Exception {
    ...
    List<WorkflowTask> initiatorTasks =
      this.workflowService.getAssignedTasks(
          USER_MANAGER,
