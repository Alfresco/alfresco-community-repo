...
public class EncryptorTest extends TestCase {
    ...
    public void testBasicBytes_NoKey() {
        ...
        byte[] decrypted =
                encryptor.decrypt("fluff", encryptedPair.getSecond(), encryptedPair.getFirst());
    ...
    public void testBasicBytes_WithKey() {
        ...
        byte[] decrypted =
                encryptor.decrypt("mykey1", encryptedPair.getSecond(), encryptedPair.getFirst());
        assertTrue("Encryption round trip failed. ", Arrays.equals(bytes, decrypted));
    }
    ...
    public void testBasicObject() {
        ...
        Pair<byte[], AlgorithmParameters> encryptedPair =
                encryptor.encryptObject("mykey2", null, testObject);
        Object output =
                encryptor.decryptObject(
                        "mykey2", encryptedPair.getSecond(), encryptedPair.getFirst());
