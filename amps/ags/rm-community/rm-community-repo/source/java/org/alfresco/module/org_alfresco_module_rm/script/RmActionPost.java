...
public class RmActionPost extends DeclarativeWebScript {
  ...
  public Map<String, Object> executeImpl(
    ...
    try {
      ...
      if (jsonObj.has(PARAM_PARAMS)) {
        ...
        for (Iterator<String> iter = paramsObj.keys(); iter.hasNext();) {
          ...
          if (
            (nextValue instanceof JSONObject) &&
            ((JSONObject) nextValue).has("iso8601")
          ) {
            String dateStringValue =
              ((JSONObject) nextValue).getString("iso8601");
    ...
    if (logger.isDebugEnabled()) {
      ...
      msg
        .append("Executing Record Action ")
        .append(actionName)
        .append(", (")
