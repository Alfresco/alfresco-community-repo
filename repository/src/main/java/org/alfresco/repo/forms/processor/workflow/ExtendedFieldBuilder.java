...
/**
 * A custom field-builder, which escapes multi-valued String-properties. The comma's in the values
 * are escaped using a '\' character. When the escape-chatacter is also used in the value, it's
 * escaped as '\\'.
 *
