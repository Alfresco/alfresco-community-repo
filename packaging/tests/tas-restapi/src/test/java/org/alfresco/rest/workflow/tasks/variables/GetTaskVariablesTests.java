...
public class GetTaskVariablesTests extends RestTest {
  ...
  public void getTaskVariablesAfterDeletingProcess() throws Exception {
    RestProcessModel addedProcess = restClient
      .authenticateUser(userWhoStartsTask)
      .withWorkflowAPI()
      .addProcess("activitiAdhoc", assignee, false, CMISUtil.Priority.Normal);
    RestTaskModel addedTask = restClient
      .withWorkflowAPI()
      .getTasks()
    ...
    variableModels =
      restClient.withWorkflowAPI().usingTask(addedTask).getTaskVariables();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    variableModels.assertThat().entriesListIsNotEmpty();
  }
  ...
  public void getTaskVariablesWithInvalidWhereClauseAsParameter()
    throws Exception {
    taskModel =
      dataWorkflow
        .usingUser(userWhoStartsTask)
