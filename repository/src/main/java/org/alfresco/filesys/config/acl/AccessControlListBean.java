...
public class AccessControlListBean {
  ...
  public void setDefaultAccessLevel(String defaultAccessLevel)
    ...
    if (defaultAccessLevel != null && defaultAccessLevel.length() > 0) {
      this.defaultAccessLevel =
        AccessControlParser.parseAccessTypeString(defaultAccessLevel);
    }
  }
   ...
   */
  public void setDomainAccessControls(
    List<DomainAccessControlBean> domainAccessControls
  ) {
   ...
   */
  public void setGidAccessControls(
    List<GidAccessControlBean> gidAccessControls
  ) {
   ...
   */
  public void setProtocolAccessControls(
    List<ProtocolAccessControlBean> protocolAccessControls
  ) {
   ...
   */
  public void setUidAccessControls(
    List<UidAccessControlBean> uidAccessControls
  ) {
   ...
   */
  public void setUserAccessControls(
    List<UserAccessControlBean> userAccessControls
  ) {
