...
/**
 * The {@link org.alfresco.service.cmr.search.ResultSetRow} implementation for Elasticsearch subsystem
 */
public class ElasticsearchResultSetRow extends AbstractResultSetRow
{

    public ElasticsearchResultSetRow(ResultSet resultSet, int index)
    {
