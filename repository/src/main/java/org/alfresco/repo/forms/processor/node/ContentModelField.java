...
public class ContentModelField implements Field {
    ...
    public ContentModelField(
            PropertyDefinition propertyDefinition, PropertyFieldDefinition fieldDef, Object value) {
    ...
    public ContentModelField(
            AssociationDefinition assocDefinition,
    ...
    /**
     * This constructor should only be used to create FieldInfo for transient properties such as
     * encoding, mimetype or size.
     *
