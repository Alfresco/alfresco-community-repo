...
public class InCategoryEvaluator extends ActionConditionEvaluatorAbstractBase {
    ...
    /**
     * @see
     *     org.alfresco.repo.action.evaluator.ActionConditionEvaluatorAbstractBase#evaluateImpl(ActionCondition,
     *     org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    protected boolean evaluateImpl(ActionCondition ruleCondition, NodeRef actionedUponNodeRef) {
        ...
        if (this.nodeService.exists(actionedUponNodeRef) == true) {
            ...
            if (this.dictionaryService.isSubClass(categoryAspect, ContentModel.ASPECT_CLASSIFIABLE)
                ...
                if (categoryProperty != null) {
                    // Check to see if the category value is in the list of currently set category
                    // values
                    Serializable value =
                            this.nodeService.getProperty(actionedUponNodeRef, categoryProperty);
                    if (value != null) {
                        Collection<NodeRef> actualCategories =
                                DefaultTypeConverter.INSTANCE.getCollection(NodeRef.class, value);
