...
public class VersionHistoryImplTest extends TestCase {
    ...
    public void testGetAllVersionsComparator() {
        ...
        Version predecessor;
        VersionHistoryImpl vh =
                new VersionHistoryImpl(
                        version, Collections.reverseOrder(new VersionLabelComparator()));
        while (itr.hasNext()) {
            predecessor = version;
            version = itr.next();
    ...
    public void testDeserializeV22SP4() throws Exception {
        String[] resourceLocations =
                new String[] {DESERIALIZE_V22SP4, DESERIALIZE_V310_DEV, DESERIALIZE_V310};
