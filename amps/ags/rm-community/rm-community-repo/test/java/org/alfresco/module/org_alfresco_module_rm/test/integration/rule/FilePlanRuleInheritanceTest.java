...
public class FilePlanRuleInheritanceTest extends BaseRMTestCase {
    ...
    /**
     * Given that a single rule is set on the parent folder of the file plan root And that it is
     * configured to apply to children When we ask for the rules on the file plan, including those
     * inherited Then it will not include those defined on the parent folder
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        Action completeRecordAction =
                                actionService.createAction(DeclareRecordAction.NAME);
                        rule = new Rule();
    ...
    /**
     * Given that a single rule is set on the file plan root And that it is configured to apply to
     * children When we ask for the rules on the unfiled record container including those inherited
     * Then it will not include those defined on the file plan root
     *
     * <p>See https://issues.alfresco.com/jira/browse/RM-3148
     */
    ...
    /**
     * Given that a single rule is set on the file plan root And that it is configured to apply to
     * children When we ask for the rules on the hold container including those inherited Then it
     * will not include those defined on the file plan root
     */
    ...
    /**
     * Given that a single rule is set on the file plan root And that it is configured to apply to
     * children When we ask for the rules on the transfer container including those inherited Then
     * it will not include those defined on the file plan root
     */
    ...
    /**
     * Given that a single rule is set on the file plan root And that it is configured to apply to
     * children When we ask for the rules on a record category including those inherited Then it
     * will include those defined on the file plan root
     */
