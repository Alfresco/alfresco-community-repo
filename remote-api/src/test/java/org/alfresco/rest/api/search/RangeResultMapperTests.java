...
public class RangeResultMapperTests {
    ...
    private GenericBucket queryWithInclude(String bucketPosition, String... includeParam) {
        ...
        if (includeParam != null && includeParam.length >= 1) {
            ...
            ranges.add(
                    new RangeParameters("test", "0", "10", "1", true, null, include, null, null));
        }
    ...
    private GenericBucket queryWithIncludeAndOther(
            String bucketPosition, String includeParam, String otherParam) {
        List<RangeParameters> ranges = new ArrayList<RangeParameters>();
        List<String> include = new ArrayList<String>();
        ...
        return RangeResultMapper.buildGenericBucketFromRange(
                "test", buildFaet(bucketPosition), ranges);
    }
