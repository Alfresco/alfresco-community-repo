...
public class SearchMapperTests {
  ...
  public void testMandatory() throws Exception {
    SearchRequestContext searchRequest = SearchRequestContext.from(
      SearchQuery.EMPTY
    );
    SearchParameters searchParameters = searchMapper.toSearchParameters(
  ...
  public void toSearchParameters() throws Exception {
    ...
    //Test defaults
    assertEquals(
      "There should be only 1 default store",
      1,
      searchParameters.getStores().size()
    );
    assertEquals(
  ...
  public void fromQuery() throws Exception {
    ...
    try {
      ...
      assertTrue(
        iae.getLocalizedMessage().contains("query is a mandatory parameter")
      );
    }
  ...
  public void fromSort() throws Exception {
    ...
    try {
      searchMapper.fromSort(
        searchParameters,
        Arrays.asList(new SortDef("wrongenum", null, false))
      );
      fail();
    } catch (InvalidArgumentException iae) {
    ...
    try {
      searchMapper.fromSort(
        searchParameters,
        Arrays.asList(new SortDef("FIELD", null, false))
      );
      fail();
    } catch (InvalidArgumentException iae) {
  ...
  public void fromDefaults() throws Exception {
    ...
    searchMapper.fromDefault(
      searchParameters,
      new Default(null, null, null, null, null)
    );

    searchMapper.fromDefault(
      searchParameters,
      new Default(null, "AND", null, null, null)
    );
    assertEquals("AND", searchParameters.getDefaultFTSOperator().toString());

    searchMapper.fromDefault(
      searchParameters,
      new Default(null, null, "or", null, null)
    );
    assertEquals(
      "OR",
      searchParameters.getDefaultFTSFieldOperator().toString()
    );

    try {
      searchMapper.fromDefault(
        searchParameters,
        new Default(null, null, "ELSE", null, null)
      );
      fail();
    } catch (IllegalArgumentException iae) {
      //ELSE is illegal
    ...
    searchMapper.fromDefault(
      searchParameters,
      new Default(null, null, null, "nspa", "dfn")
    );
  ...
  @Test
  public void searchParameterIncludesValidation_invalidInclude_shouldThrowInvalidArgumentException()
    throws Exception {
    try {
      searchMapper.validateInclude(
        Arrays.asList(
  ...
  public void fromFilterQuery() throws Exception {
    ...
    try {
      searchMapper.fromFilterQuery(
        searchParameters,
        Arrays.asList(new FilterQuery("hedgehog", null, null))
      );
      fail();
    } catch (InvalidArgumentException iae) {
    ...
    try {
      ...
      searchMapper.fromFilterQuery(
        searchParameters,
        Arrays.asList(new FilterQuery(null, null, null))
      );
      fail();
    } catch (IllegalArgumentException iae) {
      //You can't specify FilterQuery when using the CMIS language
    ...
    assertEquals(
      "{!afts tag=desc1 }description:xyz",
      searchParameters.getFilterQueries().get(1)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
        new FilterQuery("description:xyz", Arrays.asList("desc1"), null)
      )
    );
    assertEquals(
      "{!afts tag=desc1 }description:xyz",
      searchParameters.getFilterQueries().get(2)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
    ...
    assertEquals(
      "{!afts tag=desc1 } description:xyz",
      searchParameters.getFilterQueries().get(3)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
        new FilterQuery(
          " {!afts cake} description:xyz",
          Arrays.asList("desc1"),
          null
        )
      )
    ...
    assertEquals(
      "{!afts tag=desc1}description:xyz",
      searchParameters.getFilterQueries().get(5)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
        new FilterQuery("created:2011", Arrays.asList("desc1"), null)
      )
    );
    assertEquals(
      "{!afts tag=desc1 }created:2011",
      searchParameters.getFilterQueries().get(6)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
        new FilterQuery("=cm:name:cabbage", Arrays.asList("desc1"), null)
      )
    );
    assertEquals(
      "{!afts tag=desc1 }=cm:name:cabbage",
      searchParameters.getFilterQueries().get(7)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
    ...
    assertEquals(
      "cm:name:cabbage OR cm:creator:bob",
      searchParameters.getFilterQueries().get(13)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
        new FilterQuery(null, null, Arrays.asList("cm:name:cabbage"))
      )
    );
    assertEquals(
      "cm:name:cabbage",
      searchParameters.getFilterQueries().get(14)
    );
    searchMapper.fromFilterQuery(
      searchParameters,
      Arrays.asList(
  ...
  public void fromFacetQuery() throws Exception {
    ...
    searchMapper.fromFacetQuery(
      ...
      Arrays.asList(
        ...
        new FacetQuery("pong", "table", null)
      )
    );
    assertEquals(2, searchParameters.getFacetQueries().size());
    assertEquals(
      "{!afts key='ping'}ping",
      searchParameters.getFacetQueries().get(0)
    );
    assertEquals(
      "{!afts key='table'}pong",
      searchParameters.getFacetQueries().get(1)
    );
  ...
  public void fromScope() throws Exception {
    ...
    SearchRequestContext searchRequestContext = SearchRequestContext.from(
      minimalQuery()
    );
    ...
    try {
      searchMapper.fromScope(
        searchParameters,
        new Scope(Arrays.asList("nonsense")),
        searchRequestContext
      );
      fail();
    } catch (InvalidArgumentException iae) {
    ...
    searchMapper.fromScope(
      ...
      new Scope(
        Arrays.asList(
          StoreMapper.DELETED,
          StoreMapper.LIVE_NODES,
          StoreMapper.VERSIONS
        )
      ),
      searchRequestContext
    );
  ...
  public void fromTimezone() throws Exception {
    ...
    try {
      searchMapper.fromLocalization(
        searchParameters,
        new Localization("nonsense", null)
      );
      fail();
    } catch (IllegalArgumentException iae) {
    ...
    try {
      searchMapper.fromLocalization(
        searchParameters,
        new Localization("UTC+06:00", null)
      );
      fail();
    } catch (IllegalArgumentException iae) {
  ...
  public void fromLocales() throws Exception {
    ...
    try {
      searchMapper.fromLocalization(
        searchParameters,
        new Localization(null, testLocales)
      );
      fail();
    } catch (IllegalArgumentException iae) {
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("NOTTHIS"))
    );

    searchParameters = new SearchParameters();
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("fr"))
    );
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("fr_FR"))
    );
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("fr-FR"))
    );
    assertEquals(Locale.FRANCE, searchParameters.getLocales().get(0));
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("fr-ca"))
    );
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("fr_ca"))
    );
    assertEquals(Locale.CANADA_FRENCH, searchParameters.getSortLocale());
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("en-gb"))
    );
    ...
    searchMapper.fromLocalization(
      searchParameters,
      new Localization(null, Arrays.asList("en-us"))
    );
  ...
  public void fromHighlight() throws Exception {
    SearchParameters searchParameters = new SearchParameters();
    List<FieldHighlightParameters> fields = Arrays.asList(
  ...
  public void fromStats() throws Exception {
    ...
    try {
      ...
      assertTrue(
        iae.getLocalizedMessage().contains("field is a mandatory parameter")
      );
    }
    ...
    try {
      ...
      assertTrue(
        iae.getLocalizedMessage().contains("Invalid cardinality accuracy 12.0")
      );
    }
  ...
  public void fromPivot() throws Exception {
    ...
    try {
      searchMapper.fromPivot(
        ...
        ff,
        null,
        Arrays.asList(new Pivot(null, null)),
        null
      );
      fail();
    } catch (IllegalArgumentException iae) {
    ...
    StatsRequestParameters bobf = new StatsRequestParameters(
      "bob",
      null,
      null,
      null,
    ...
    StatsRequestParameters bobL = new StatsRequestParameters(
      "creator",
      "bob",
      null,
      null,
    ...
    searchMapper.fromPivot(
      ...
      null,
      Arrays.asList(
        new Pivot("yourfield", Arrays.asList(new Pivot("bob", null)))
      ),
      searchRequestContext
    );
  ...
  public void fromInterval() throws Exception {
    ...
    Set<IntervalSet> intervalSets = new HashSet(
      Arrays.asList(new IntervalSet(null, "1", null, null, null))
    );
    List<Interval> intervalList = Arrays.asList(
      new Interval(null, "bob", null)
    );
    ...
    intervalSets =
      new HashSet(Arrays.asList(new IntervalSet("1", null, null, null, true)));
    intervalParameters = new IntervalParameters(intervalSets, intervalList);
  ...
  public void facetRange() {
    ...
    List<RangeParameters> rangeParams = new ArrayList<RangeParameters>();
    rangeParams.add(
      new RangeParameters(null, null, null, null, false, null, null, null, null)
    );
    try {
