...
public abstract class DictionaryWebServiceBase extends DeclarativeWebScript
{
    ...
    /**
     * @param prefix
     *            prefix for classname as cm
     * @param shorname
     *            the short class name as person
     * @return String the full name in the following format {namespaceuri}shorname
     */
     ...
     * 
     * @param prefix
     *            - gets the prefix as input e.g cm
     * @param shorname
     *            - gets the short classname as input e.g person
     * @return true - if the class is valid , false - if the class is invalid
     */
     ...
     * @param classname
     *            String
     * @return the shortname from the classname of the format cm_person here person represents the shortname
     */
     ...
     * 
     * @param sortedClassDefs
     *            - list of sorted class definitions
     * @param dependent
     *            - collections that depend on class definitions
