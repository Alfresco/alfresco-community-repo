...
public class RepoUsage {
    ...
    /**
     * Get the server license mode. This is determined by (a) the build in use and (b) the installed
     * license.
     *
    ...
    /**
     * Get the server license expiry date. This is determined by the license and is <tt>null</tt> if
     * there is no expiry or if it is unknown.
     *
