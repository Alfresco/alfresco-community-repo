...
/**
 * The XMLTransferEventFormatterFactory returns formatters for the various client side
 * TransferEvents.
 *
 * <p>The main entry point for this class is the static method getFormatter();
 *
 * @author mrogers
 */
public class XMLTransferEventFormatterFactory {

    private static XMLTransferEventFormatter defaultFormatter =
            new XMLTransferEventFormatter() {
                ...
                public AttributesImpl getAttributes(TransferEvent event) {
                    ...
                    attributes.addAttribute(
                            ...
                            "date",
                            "dateTime",
                            ISO8601DateFormat.format(event.getTime()));
                    return attributes;
                }
    ...
    private static XMLTransferEventFormatter eventEnterStateFormatter =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventReportFormatter =
            new XMLTransferEventFormatter() {
                ...
                public AttributesImpl getAttributes(TransferEvent event) {
                    ...
                    attributes.addAttribute(
                            ...
                            "nodeRef",
                            "string",
                            s.getNodeRef().toString());
                    attributes.addAttribute(
                            TransferReportModel.TRANSFER_REPORT_MODEL_1_0_URI,
                            "reportType",
                            "reportType",
                            "string",
                            s.getReportType().toString());
                    return attributes;
                }
    ...
    private static XMLTransferEventFormatter eventSendingContentFormatter =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventSendingSnapshotFormatter =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventBeginFormatter =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventEndStateFormatter =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventCommittingStatus =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventCancelled =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventSuccess =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventSentContent =
            new XMLTransferEventFormatter() {
    ...
    private static XMLTransferEventFormatter eventError =
            new XMLTransferEventFormatter() {
