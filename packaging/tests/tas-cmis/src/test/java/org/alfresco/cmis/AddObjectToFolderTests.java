...
public class AddObjectToFolderTests extends CmisTest {
  ...
  public void siteManagerCannotAddDocumentToFolderWithFalseAllVersions()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanAddFileToFolderCreatedByHimself()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanAddFileToFolderCreatedByManager()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
