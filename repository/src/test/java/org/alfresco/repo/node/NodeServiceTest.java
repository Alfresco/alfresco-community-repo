...
public class NodeServiceTest {
    ...
    public static ApplicationContextInit APP_CONTEXT_INIT =
            ApplicationContextInit.createStandardContextWithOverrides(
    ...
    public static void setup() throws Exception {
        ...
        policyComponent =
                (PolicyComponent)
                        APP_CONTEXT_INIT.getApplicationContext().getBean("policyComponent");
        ...
        nodesCache =
                (SimpleCache<Serializable, ValueHolder<Serializable>>)
                        APP_CONTEXT_INIT.getApplicationContext().getBean("node.nodesSharedCache");
        propsCache =
                (SimpleCache<Serializable, ValueHolder<Serializable>>)
                        APP_CONTEXT_INIT
                                .getApplicationContext()
        ...
        aspectsCache =
                (SimpleCache<Serializable, ValueHolder<Serializable>>)
                        APP_CONTEXT_INIT.getApplicationContext().getBean("node.aspectsSharedCache");
        ...
        RetryingTransactionCallback<NodeRef> createStoreWork =
                new RetryingTransactionCallback<NodeRef>() {
                    public NodeRef execute() {
                        StoreRef storeRef =
                                nodeService.createStore(
                                        StoreRef.PROTOCOL_WORKSPACE, "Test_" + System.nanoTime());
                        return nodeService.getRootNode(storeRef);
                    }
                };
        rootNodeRef = txnService.getRetryingTransactionHelper().doInTransaction(createStoreWork);

        final QNameDAO qnameDAO =
                (QNameDAO) APP_CONTEXT_INIT.getApplicationContext().getBean("qnameDAO");
        deletedTypeQNameId =
                txnService
                        ...
                        .doInTransaction(
                                new RetryingTransactionCallback<Long>() {
                                    ...
                                    public Long execute() throws Throwable {
                                        return qnameDAO.getOrCreateQName(ContentModel.TYPE_DELETED)
                                                .getFirst();
                                    }
                                });
    }
    ...
    public void testLocaleSupport() throws Exception {
                ...
                nodeService
                        .createNode(
                                ...
                                Collections.singletonMap(
                                        ContentModel.PROP_LOCALE, (Serializable) Locale.GERMAN))
                        .getChildRef();
        assertTrue(
                "Every node must have sys:localized",
        ...
        try {
            MLText checkDescription =
                    (MLText) nodeService.getProperty(nodeRef2, ContentModel.PROP_DESCRIPTION);
        ...
        // Finally, ensure that setting Locale to 'null' is takes the node back to its original
        // locale
    ...
    private void buildNodeHierarchy(
            final NodeRef workspaceRootNodeRef, final NodeRef[] liveNodeRefs) {
    ...
    /**
     * Tests that two separate node trees can be deleted concurrently at the database level. This is
     * not a concurrent thread issue; instead we delete a hierarchy and hold the txn open while we
     * delete another in a new txn, thereby testing that DB locks don't prevent concurrent deletes.
     *
     * <p>See: <a href="https://issues.alfresco.com/jira/browse/ALF-5714">ALF-5714</a><br>
     * See: <a href="https://issues.alfresco.com/jira/browse/ALF-16888">ALF-16888</a> See: <a
     * href="https://issues.alfresco.com/jira/browse/REPO-2783">REPO-2783</a>
     *
     * <p>Note: if this test hangs for MySQL then check if 'innodb_locks_unsafe_for_binlog = true'
     * (and restart MySQL + test)
     */
    public void testConcurrentArchive() throws Exception {
        ...
        RetryingTransactionCallback<Void> outerCallback =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        ...
                        class InnerThread extends Thread {
                            ...
                            public void run() {
                                AuthenticationUtil.setRunAsUserSystem();
                                RetryingTransactionCallback<Void> innerCallback =
                                        new RetryingTransactionCallback<Void>() {
                                            @Override
                                            public Void execute() throws Throwable {
                                                try {
                                                    ...
                                                    // Wrap throwables so they pass straight through
                                                    // the retry mechanism
    ...
    /**
     * Tests archive and restore of simple hierarchy, checking that references and IDs are used
     * correctly.
     */
    @Test
    public void testArchiveAndRestore() {
        ...
        final NodeRef workspaceRootNodeRef =
                nodeService.getRootNode(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE);
        final NodeRef archiveRootNodeRef =
                nodeService.getRootNode(StoreRef.STORE_REF_ARCHIVE_SPACESSTORE);
        ...
        for (int i = 0; i < liveNodeRefs.length; i++) {
            ...
            assertFalse(
                    "'Archived' node " + i + " should be undeleted", archivedStatus.isDeleted());
        ...
        // Recheck the nodes and make sure that all the 'archived' nodes are deleted and the 'live'
        // nodes are back
    ...
    public void testDuplicateChildNodeName() {
        ...
        final String lastName =
                (String) nodeService.getProperty(liveNodeRefs[2], ContentModel.PROP_NAME);
        // Now create a node with the same name
        RetryingTransactionCallback<NodeRef> newNodeCallback =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
    ...
    public void testGetChildren_Limited() {
        ...
        for (int i = 1; i < liveNodeRefs.length; i++) {
            List<ChildAssociationRef> childAssocRefs =
                    nodeService.getChildAssocs(liveNodeRefs[0], null, null, i, true);
        ...
        for (int i = 1; i < liveNodeRefs.length; i++) {
            List<ChildAssociationRef> childAssocRefs =
                    nodeService.getChildAssocs(liveNodeRefs[0], null, null, i, false);
            assertEquals("Expected exact number of child assocs", i, childAssocRefs.size());
        }
    }
    ...
    private NodeRef setupTestGetChildren(
            final NodeRef workspaceRootNodeRef, final int numberOfReferences) {
        RetryingTransactionCallback<NodeRef> setupCallback =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
                    public NodeRef execute() throws Throwable {
    ...
    public void testCaches_RenameNode() {
        ...
        // Now query for it
        NodeRef nodeRefCheck =
                nodeService.getChildByName(nodeRefs[0], ContentModel.ASSOC_CONTAINS, name);
        ...
        NodeRef newChildNodeRef =
                nodeService
                        .createNode(
                                ...
                                ContentModel.TYPE_FOLDER,
                                Collections.singletonMap(
                                        ContentModel.PROP_NAME, (Serializable) name))
                        .getChildRef();
    ...
    private Object findCacheValue(
            SimpleCache<Serializable, ValueHolder<Serializable>> cache, Serializable key) {
    ...
    public void testCaches_ImmutableNodeCaches() throws Exception {
        ...
        Map<QName, Serializable> nodePropsOne =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyOne);
        ...
        Map<QName, Serializable> nodePropsOneCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyOne);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsTwo =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyTwo);
        ...
        // Get the values for the previous version
        Map<QName, Serializable> nodePropsTwoCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyTwo);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsThree =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyThree);
        ...
        // Get the values for the previous version
        Map<QName, Serializable> nodePropsThreeCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyThree);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsFour =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyFour);
        ...
        assertTrue(
                "Expected cm:titled aspect", nodeAspectsFour.contains(ContentModel.ASPECT_TITLED));

        // Remove an aspect
        nodeService.removeAspect(nodeRef, ContentModel.ASPECT_TITLED);

        // Get the values for the previous version
        Map<QName, Serializable> nodePropsFourCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyFour);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsFive =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyFive);
        ...
        RetryingTransactionCallback<Void> nodeSixWork =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        ...
                        nodeService.setProperty(
                                nodeRef, ContentModel.PROP_DESCRIPTION, "Some description");
        ...
        // Get the values for the previous version
        Map<QName, Serializable> nodePropsFiveCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyFive);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsSix =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeySix);
        ...
        assertTrue(
                "Expected cm:titled aspect ", nodeAspectsSix.contains(ContentModel.ASPECT_TITLED));

        // Remove an aspect, some properties and a secondary association
        RetryingTransactionCallback<Void> nodeSevenWork =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        nodeService.removeAspect(nodeRef, ContentModel.ASPECT_TITLED);
        ...
        // Get the values for the previous version
        Map<QName, Serializable> nodePropsSixCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeySix);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsSeven =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeySeven);
        ...
        // Modify cm:auditable
        RetryingTransactionCallback<Void> nodeEightWork =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        // Get the values for the previous version
        Map<QName, Serializable> nodePropsSevenCheck =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeySeven);
        ...
        // Get the node cached values
        Map<QName, Serializable> nodePropsEight =
                (Map<QName, Serializable>) findCacheValue(propsCache, nodeKeyEight);
    ...
    public void testCreateNodePolicies() {
        ...
        OnCreateNodePolicy onCreateNodePolicy =
                createClassPolicy(
                        OnCreateNodePolicy.class,
                        OnCreateNodePolicy.QNAME,
                        ContentModel.TYPE_CONTENT);

        BeforeCreateNodePolicy beforeCreateNodePolicy =
                createClassPolicy(
                        BeforeCreateNodePolicy.class,
                        BeforeCreateNodePolicy.QNAME,
                        ContentModel.TYPE_CONTENT);

        OnCreateChildAssociationPolicy onCreateChildAssociationPolicy =
                createAssocPolicy(
                        OnCreateChildAssociationPolicy.class,
                        OnCreateChildAssociationPolicy.QNAME,
                        ContentModel.TYPE_STOREROOT);

        OnUpdatePropertiesPolicy onUpdatePropertiesPolicy =
                createClassPolicy(
    ...
    public void testSetNodeTypePolicies() {
        ...
        verify(beforeSetNodeTypePolicy)
                .beforeSetNodeType(nodeRef, ContentModel.TYPE_CONTENT, ContentModel.TYPE_FOLDER);
        verify(onSetNodeTypePolicy)
                .onSetNodeType(nodeRef, ContentModel.TYPE_CONTENT, ContentModel.TYPE_FOLDER);
    }

    private <T extends Policy> T createClassPolicy(
            Class<T> policyInterface, QName policyQName, QName triggerOnClass) {
        T policy = mock(policyInterface);
        policyComponent.bindClassBehaviour(
                policyQName, triggerOnClass, new JavaBehaviour(policy, policyQName.getLocalName()));
        return policy;
    }
     ...
     *
     * <p>Conditions that <i>might</i> cause this are:<br>
     *
     * <ul>
     *   <li>Node created within a parent node that is being deleted
     *   <li>The node cache is temporarily incorrect when the association is made
     * </ul>
     *
     * <p><a href="https://issues.alfresco.com/jira/browse/ALF-12358">Concurrency: Possible to
     * create association references to deleted nodes</a>
     */
    @Test
    public void testConcurrentLinkToDeletedNode() throws Throwable {
        ...
        final RetryingTransactionCallback<NodeRef> createChildCallback =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
                    public NodeRef execute() throws Throwable {
                        ...
                        QName randomQName =
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, randomName);
                        Map<QName, Serializable> props = new HashMap<QName, Serializable>();
        ...
        final RetryingTransactionCallback<NodeRef> deleteWithNestedCallback =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
                    public NodeRef execute() throws Throwable {
                        ...
                        // add the Temporary aspect to make the deletion faster (it will not be
                        // moved to the archival store)
        ...
        final List<Long> attachedToDeletedIdsAfter =
                getChildNodesWithDeletedParentNode(params, attachedToDeletedIdsBefore.size());
        logger.debug(
                "Found child nodes with deleted parent node (after): " + attachedToDeletedIdsAfter);
        final List<Long> orphanedNodeIdsAfter =
                getChildNodesWithNoParentNode(params, orphanedNodeIdsBefore.size());
        ...
        // Find all 'at risk' nodes after the test
        final List<Long> attachedToDeletedIdsCleaned =
                getChildNodesWithDeletedParentNode(params, attachedToDeletedIdsBefore.size());
        logger.debug(
                "Found child nodes with deleted parent node (cleaned): "
                        + attachedToDeletedIdsAfter);
        final List<Long> orphanedNodeIdsCleaned =
                getChildNodesWithNoParentNode(params, orphanedNodeIdsBefore.size());
    ...
    /**
     * Test for MNT-8494 - we should be able to recover when indexing encounters a node with deleted
     * ancestors
     */
    @Test
    public void testLinkToDeletedNodeRecovery() throws Throwable {
        ...
        logger.debug(
                "Found child nodes with deleted parent node (before): " + nodesWithDeletedParents);
        ...
        for (int i = 0; i < cnt; i++) {
            ...
            QName randomQName =
                    QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, randomName);
            Map<QName, Serializable> props = new HashMap<QName, Serializable>();
            props.put(ContentModel.PROP_NAME, randomName);
                                ...
                                Long nodeId =
                                        (Long)
                                                nodeService.getProperty(
                                                        nodeRefs[0], ContentModel.PROP_NODE_DBID);
                                nodeDAO.updateNode(nodeId, ContentModel.TYPE_DELETED, null);
                                nodeDAO.removeNodeAspects(nodeId);
                                nodeDAO.removeNodeProperties(
                                        nodeId, nodeDAO.getNodeProperties(nodeId).keySet());
                                nodeId =
                                        (Long)
                                                nodeService.getProperty(
                                                        nodeRefs[2], ContentModel.PROP_NODE_DBID);
                                nodeDAO.updateNode(nodeId, ContentModel.TYPE_DELETED, null);
                                nodeDAO.removeNodeAspects(nodeId);
                                nodeDAO.removeNodeProperties(
                                        nodeId, nodeDAO.getNodeProperties(nodeId).keySet());
        ...
        final List<Long> childNodeIds =
                getChildNodesWithDeletedParentNode(params, nodesWithDeletedParents.size());
                    ...
                    .doInTransaction(
                            new RetryingTransactionCallback<Void>() {
                                ...
                                public Void execute() throws Throwable {
                                    if (nodeService.exists(nodeRef)) {
                                        try {
                                            for (ChildAssociationRef parentRef :
                                            ...
                                            throw new ConcurrencyFailureException(
                                                    "Deleted node - should be healed on retry", e);
                                        }
                                    }
                                    return null;
                                }
        ...
        // Let's fix up the deleted child nodes indexing might not spot, but hierarchy traversal
        // (e.g. getChildAssocs)
        // might
        for (final NodeRef nodeRef : allNodeRefs) {
            txnService
    ...
    public void testForceNonRootNodeWithNoParentNode() throws Throwable {
        ...
        for (int i = 0; i < cnt; i++) {
            ...
            final Long childNodeId =
                    (Long) nodeService.getProperty(childNodeRef, ContentModel.PROP_NODE_DBID);
            txnService
                    .getRetryingTransactionHelper()
                    .doInTransaction(
                            new RetryingTransactionCallback<Void>() {
                                @Override
                                public Void execute() throws Throwable {
                                    Pair<Long, ChildAssociationRef> assocPair =
                                            nodeDAO.getPrimaryParentAssoc(childNodeId);
        ...
        for (Long childNodeId : childNodeIds) {
            assertTrue(
                    "Not found: " + childNodeId,
                    lostAndFoundNodeIds.contains(childNodeId) || !nodeDAO.exists(childNodeId));
        }
    }
    ...
    private List<NodeRef> getLostAndFoundNodes() {
        ...
        if (childAssocRefs.size() > 0) {
            List<ChildAssociationRef> lostNodeChildAssocRefs =
                    nodeService.getChildAssocs(childAssocRefs.get(0).getChildRef());
    ...
    public void testNodeHierarchyWalker() throws Exception {
        ...
        nodeService.createAssociation(
                nodes[1], nodes[0], ContentModel.ASSOC_ORIGINAL); // Peer n1-n0
                                ...
                                new RetryingTransactionCallback<NodeHierarchyWalker>() {
                                    ...
                                    public NodeHierarchyWalker execute() throws Throwable {
                                        Pair<Long, NodeRef> parentNodePair =
                                                nodeDAO.getNodePair(nodes[0]);
                                        Pair<Long, ChildAssociationRef> parentAssocPair =
                                                nodeDAO.getPrimaryParentAssoc(
                                                        parentNodePair.getFirst());

                                        NodeHierarchyWalker walker =
                                                new NodeHierarchyWalker(nodeDAO);
        ...
        assertEquals(
                nodes[0],
                nodesParentFirst.get(2).secondaryParentAssocs.get(0).getSecond().getParentRef());
        ...
        assertEquals(
                nodes[2],
                nodesParentFirst.get(0).secondaryChildAssocs.get(0).getSecond().getChildRef());
        ...
        assertEquals(
                nodes[0], nodesParentFirst.get(1).targetAssocs.get(0).getSecond().getTargetRef());

        // Check source assocs
        assertEquals(1, nodesParentFirst.get(0).sourceAssocs.size());
        assertEquals(
                nodes[1], nodesParentFirst.get(0).sourceAssocs.get(0).getSecond().getSourceRef());
    ...
    public void testCascadeUpdate() {
        ...
        nodeService.moveNode(
                ...
                ContentModel.ASSOC_CHILDREN,
                QName.createQName(
                        NamespaceService.CONTENT_MODEL_1_0_URI, this.getClass().getName()));
        ...
        Long doubleLinkCRC =
                (Long) nodeService.getProperty(nodeRef7, ContentModel.PROP_CASCADE_CRC);
    ...
    public void testUpdateContentPermissionWithRestrictions() {
        ...
        permissionService.setPermission(
                folder1, userName1, PermissionService.ALL_PERMISSIONS, true);
        permissionService.setInheritParentPermissions(folder1, false);
        permissionService.setPermission(
                folder2, userName2, PermissionService.ALL_PERMISSIONS, true);
        permissionService.setInheritParentPermissions(folder2, false);

        ContentData contentProp1 =
                            ...
                            try {
                                AuthenticationUtil.runAs(
                                        () -> {
                                            ...
                                            fail(
                                                    "The content of node1 should not be readable by"
                                                            + " user 2");
                                            return null;
                                        },
                                        userName2);
        ...
        AuthenticationUtil.runAs(
                () -> {
                    ...
                    try {
                        ...
                        fail(
                                "Should not be possible to call setProperties directly to set"
                                        + " content");
                    } catch (InvalidTypeException ite) {
                        // expected
                    }
                    ...
                    try {
                        ...
                        fail(
                                "Should not be possible to call addProperties directly to set"
                                        + " content");
                    } catch (InvalidTypeException ite) {
                        // expected
                    }
                    ...
                    assertNull(
                            "The second node should not have any content (all attempts should"
                                    + " fail)",
                            contentReader);
                    return null;
                },
    ...
    public void testSetContentPropertyToNull() {
        NodeRef workspaceRootNodeRef =
                nodeService.getRootNode(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE);
        ContentData nullContentData =
                new ContentData(null, "text/plain", 0L, "UTF-8", Locale.ENGLISH);
        ContentData emptyContentData =
                new ContentData("", "text/plain", 0L, "UTF-8", Locale.ENGLISH);
        String userName1 = GUID.generate();
        HashMap<QName, Serializable> properties = new HashMap<>();
        properties.put(ContentModel.PROP_USERNAME, userName1);
        personService.createPerson(properties);
