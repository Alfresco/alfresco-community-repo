...
public class SiteMember
  implements Serializable, ExpectedComparison, Comparable<SiteMember> {
  ...
  public static SiteMember parseSiteMember(
    String siteId,
  ...
  public static ListResponse<SiteMember> parseSiteMembers(
    String siteId,
    JSONObject jsonObject
  ) {
    ...
    ListResponse<SiteMember> resp = new ListResponse<SiteMember>(
      paging,
      siteMembers
    );
    return resp;
