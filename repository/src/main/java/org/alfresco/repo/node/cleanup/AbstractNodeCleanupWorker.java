...
/**
 * Base class for Node cleaners. This class ensures calls through after having created a read-write
 * transaction that is authenticated as system.
 *
 * @author Derek Hulley
 * @since 2.2 SP2
 */
public abstract class AbstractNodeCleanupWorker implements NodeCleanupWorker {
    ...
    private static final QName LOCK =
            QName.createQName(NamespaceService.SYSTEM_MODEL_1_0_URI, "NodeCleanup");
    ...
    /**
     * Calls {@link #doCleanInternal()} in a System-user authenticated read-write transaction. This
     * method is non-blocking but passes all second and subsequent concurrent invocations straight
     * through.
     */
