...
public class SolrChildApplicationContextFactory
  ...
  private static final Log LOGGER = LogFactory.getLog(
    SolrChildApplicationContextFactory.class
  );
  ...
  protected static final String ALFRESCO_LAG_DURATION =
    "tracker.alfresco.lag.duration";
  protected static final String ALFRESCO_LAST_INDEXED_TXN =
    "tracker.alfresco.last.indexed.txn";
  protected static final String ALFRESCO_APPROX_TXNS_REMAINING =
    "tracker.alfresco.approx.txns.remaining";
  protected static final String ALFRESCO_APPROX_INDEXING_TIME_REMAINING =
    "tracker.alfresco.approx.indexing.time.remaining";
  ...
  protected static final String ARCHIVE_LAG_DURATION =
    "tracker.archive.lag.duration";
  protected static final String ARCHIVE_LAST_INDEXED_TXN =
    "tracker.archive.last.indexed.txn";
  protected static final String ARCHIVE_APPROX_TXNS_REMAINING =
    "tracker.archive.approx.txns.remaining";
  protected static final String ARCHIVE_APPROX_INDEXING_TIME_REMAINING =
    "tracker.archive.approx.indexing.time.remaining";
  ...
  private static final String SUMMARY_FIELD_TOTAL_SEARCHER_CACHE_GB =
    "Total Searcher Cache (GB)";
  private static final String SUMMARY_FIELD_ON_DISK_GB = "On disk (GB)";
  private static final String SUMMARY_FIELD_APPROX_TRANSACTION_INDEXING_TIME_REMAINING =
    "Approx transaction indexing time remaining";
  private static final String SUMMARY_FIELD_APPROX_TRANSACTIONS_REMAINING =
    "Approx transactions remaining";
  private static final String SUMMARY_FIELD_ID_FOR_LAST_TX_IN_INDEX =
  ...
  public SolrAdminHTTPClient getAdminClient() {
    if (adminClient == null) {
      ...
      adminClient =
        (SolrAdminHTTPClient) ctx.getBean("search.solrAdminHTTPCLient");
    }
    return adminClient;
  }
  ...
  public boolean isUpdateable(String name) {
    ...
    return (
      ...
      !name.equals(
        SolrChildApplicationContextFactory.ALFRESCO_LAST_INDEXED_TXN
      ) &&
      !name.equals(
        SolrChildApplicationContextFactory.ALFRESCO_APPROX_TXNS_REMAINING
      ) &&
      !name.equals(
        SolrChildApplicationContextFactory.ALFRESCO_APPROX_INDEXING_TIME_REMAINING
      ) &&
      ...
      !name.equals(
        SolrChildApplicationContextFactory.ARCHIVE_APPROX_TXNS_REMAINING
      ) &&
      !name.equals(
        SolrChildApplicationContextFactory.ARCHIVE_APPROX_INDEXING_TIME_REMAINING
      ) &&
      !name.equals(
        SolrChildApplicationContextFactory.ARCHIVE_LAST_INDEXED_TXN
      ) &&
  ...
  private String getPropertyValue(JSONObject core, String name) {
    switch (name) {
      ...
      case SolrChildApplicationContextFactory.ARCHIVE_APPROX_TXNS_REMAINING:
        return core
          .getNumber(SUMMARY_FIELD_APPROX_TRANSACTIONS_REMAINING)
          .toString();
      ...
      case SolrChildApplicationContextFactory.ARCHIVE_APPROX_INDEXING_TIME_REMAINING:
        return core.getString(
          SUMMARY_FIELD_APPROX_TRANSACTION_INDEXING_TIME_REMAINING
        );
  ...
  public String getProperty(String name) {
    ...
    if (
      false == isUpdateable(name) &&
      ((ApplicationContextState) getState(false)).getApplicationContext(
          false
        ) !=
      null
    ) {
  ...
  public void setProperty(String name, String value) {
    if (false == isUpdateable(name)) {
      throw new IllegalStateException(
        "Illegal write to property \"" + name + "\""
      );
    }
