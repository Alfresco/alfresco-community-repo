...
public class GetContentStreamTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to get a document content in DocumentLibrary with"
                            + " CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager is able to get empty document content in DocumentLibrary"
                            + " with CMIS")
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to get content from checked out document with"
                            + " CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to get content of file created by other user in"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to get content of file created by other user"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to get content of file created by self in"
                            + " DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to get content of file created by other user"
                            + " in DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to get content of file created by self in"
                            + " DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is able to get content of file created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthorized is not able to get content of file created in a private"
                            + " site with CMIS")
    @Test(
