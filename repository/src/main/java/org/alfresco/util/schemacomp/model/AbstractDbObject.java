...
public abstract class AbstractDbObject implements DbObject {
     ...
     * whilst this method handles the workflow required in most cases: set the path's prefix that
     * will be used to explain where differences occur; compare the name fields of the two objects;
     * delegate to the subclass specific diffing (if any); remove the last path addition ready for
     * the next object to perform its diff correctly.
     */
    @Override
    ...
    /**
     * If a ComparisonUtils other than the default is required, then this setter can be used. Useful
     * for testing, where a mock can be injected.
     *
