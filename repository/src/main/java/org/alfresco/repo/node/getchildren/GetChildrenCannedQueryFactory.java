...
public class GetChildrenCannedQueryFactory
  ...
  public CannedQuery<NodeRef> getCannedQuery(CannedQueryParameters parameters) {
    NodePropertyHelper nodePropertyHelper = new NodePropertyHelper(
      dictionaryService,
      qnameDAO,
      localeDAO,
      contentDataDAO
    ...
    return (CannedQuery<NodeRef>) new GetChildrenCannedQuery(
      nodeDAO,
      qnameDAO,
      cannedQueryDAO,
      nodePropertyHelper,
  ...
  public CannedQuery<NodeRef> getCannedQuery(
    ...
    GetChildrenCannedQueryParams paramBean = new GetChildrenCannedQueryParams(
    ...
    // page details
    CannedQueryPageDetails cqpd = new CannedQueryPageDetails(
