...
public class ValueConverter {
    ...
    public final Object convertValueForJava(Object value) {
        if (value == null) {
                ...
                if (TYPE_DATE.equals(((IdScriptableObject) value).getClassName())) {
                    ...
                    if (isArray(propIds) == true) {
                        ...
                        Map<Object, Object> propValues =
                                new HashMap<Object, Object>(propIds.length);
            ...
            // Rhino has some interesting internal classes such as ConsString which cannot be cast
            // to String
    ...
    /**
     * Look at the id's of a native array and try to determine whether it's actually an Array or a
     * Hashmap
     *
