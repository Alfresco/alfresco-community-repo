...
public class BlogServiceImplTest extends BaseSpringTest {
  ...
  public void before() throws Exception {
    ...
    BEHAVIOUR_FILTER =
      (BehaviourFilter) applicationContext.getBean("policyBehaviourFilter");
  ...
  public void createDraftBlogPostsAndGetPagedResults() throws Exception {
    ...
    final List<NodeRef> submittedBlogPosts = TRANSACTION_HELPER.doInTransaction(
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          List<BlogPostInfo> recoveredBlogPosts = new ArrayList<BlogPostInfo>(
          ...
          PagingResults<BlogPostInfo> pagedResults = BLOG_SERVICE.getDrafts(
            BLOG_CONTAINER_NODE,
            ADMIN_USER,
            pagingReq
          );
          ...
          while (pagedResults.hasMoreItems()) {
            ...
            pagingReq =
              new PagingRequest(
                pagingReq.getSkipCount() + pageSize,
                pageSize,
                null
              );
            pagedResults =
  ...
  private void assertNodeRefsAreSortedBy(
    List<BlogPostInfo> blogPosts,
    QName property,
    boolean ascendingOrder
  ) {
    final PropertyDefinition propertyDef = DICTIONARY_SERVICE.getProperty(
      property
    );
  ...
  public void createTaggedDraftBlogPost() throws Exception {
      ...
      new RetryingTransactionHelper.RetryingTransactionCallback<List<NodeRef>>() {
        ...
        public List<NodeRef> execute() throws Throwable {
          ...
          for (String tag : tags) {
            ...
            BlogPostInfo newBlogPost = BLOG_SERVICE.createBlogPost(
              BLOG_CONTAINER_NODE,
              blogTitle,
              "Hello world",
              true
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          PagingRequest pagingReq = new PagingRequest(0, 10, null);
          RangedDateProperty dates = new RangedDateProperty(
            null,
            null,
            ContentModel.PROP_CREATED
          );
          for (String tag : tags) {
            PagingResults<BlogPostInfo> pagedResults = BLOG_SERVICE.findBlogPosts(
              BLOG_CONTAINER_NODE,
              dates,
              tag,
              pagingReq
  ...
  public void findBlogPostsByPublishedDate() throws Exception {
    ...
    final Map<Integer, NodeRef> blogPosts = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Map<Integer, NodeRef>>() {
        @Override
        public Map<Integer, NodeRef> execute() throws Throwable {
          ...
          final BlogPostInfo blogPost1971 = BLOG_SERVICE.createBlogPost(
            BLOG_CONTAINER_NODE,
            "publishedPostWithTags1971",
            "Hello world",
            true
          );
          final BlogPostInfo blogPost1981 = BLOG_SERVICE.createBlogPost(
            BLOG_CONTAINER_NODE,
            "publishedPostWithTags1981",
            "Hello world",
            true
          );
          final BlogPostInfo blogPost1991 = BLOG_SERVICE.createBlogPost(
            BLOG_CONTAINER_NODE,
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          final RangedDateProperty publishedBefore1980 = new RangedDateProperty(
            null,
            _1980,
            ContentModel.PROP_PUBLISHED
          );
          final RangedDateProperty publishedAfter1980 = new RangedDateProperty(
            _1980,
            null,
            ContentModel.PROP_PUBLISHED
          );
          final RangedDateProperty publishedBetween1975And1985 = new RangedDateProperty(
            _1975,
            _1985,
            ContentModel.PROP_PUBLISHED
          );
      ...
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          for (int i = 0; i < testBlogCount; i++) {
            BlogPostInfo newDraft = BLOG_SERVICE.createBlogPost(
              BLOG_CONTAINER_NODE,
            ...
            BlogPostInfo newPublished = BLOG_SERVICE.createBlogPost(
              BLOG_CONTAINER_NODE,
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          // get DRAFTS
          PagingResults<BlogPostInfo> resultsPage = BLOG_SERVICE.getDrafts(
            BLOG_CONTAINER_NODE,
            currentUser,
            pagingReq
          );
  ...
  private void assertSortingIsCorrect(List<BlogPostInfo> blogPosts) {
    ...
    for (BlogPostInfo bpi : blogPosts) {
      System.out.println("  -----");
      Date published = (Date) NODE_SERVICE.getProperty(
        bpi.getNodeRef(),
        ContentModel.PROP_PUBLISHED
      );
      Date created = (Date) NODE_SERVICE.getProperty(
        bpi.getNodeRef(),
        ContentModel.PROP_CREATED
      );
      System.out.print(
    ...
    for (int i = 0; i < blogPosts.size() - 1; i++) { // We only want to iterate to the second-last item
      ...
      Date nextPublishedDate = (Date) NODE_SERVICE.getProperty(
        nextBPI.getNodeRef(),
        ContentModel.PROP_PUBLISHED
      );
      Date followingPublishedDate = (Date) NODE_SERVICE.getProperty(
        followingBPI.getNodeRef(),
        ContentModel.PROP_PUBLISHED
      );
      Date nextCreatedDate = (Date) NODE_SERVICE.getProperty(
        nextBPI.getNodeRef(),
        ContentModel.PROP_CREATED
      );
      Date followingCreatedDate = (Date) NODE_SERVICE.getProperty(
        followingBPI.getNodeRef(),
        ContentModel.PROP_CREATED
      );
  ...
  public void multipleUsersCreateDraftsAndPublishedPostsAndBrowse()
    ...
    final Pair<NodeRef, NodeRef> adminPosts = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Pair<NodeRef, NodeRef>>() {
        @Override
        public Pair<NodeRef, NodeRef> execute() throws Throwable {
          BlogPostInfo newDraftBlogPost = BLOG_SERVICE.createBlogPost(
            BLOG_CONTAINER_NODE,
            "adminDraft",
            "",
            true
          ...
          BlogPostInfo newPublishedBlogPost = BLOG_SERVICE.createBlogPost(
            BLOG_CONTAINER_NODE,
            "adminPublished",
            "",
            false
    ...
    AuthenticationUtil.setFullyAuthenticatedUser(TEST_USER);
    final Pair<NodeRef, NodeRef> userPosts = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Pair<NodeRef, NodeRef>>() {
        @Override
        public Pair<NodeRef, NodeRef> execute() throws Throwable {
          BlogPostInfo newDraftBlogPost = BLOG_SERVICE.createBlogPost(
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          PagingResults<BlogPostInfo> pagedDraftResults = BLOG_SERVICE.getDrafts(
            BLOG_CONTAINER_NODE,
            ADMIN_USER,
            pagingReq
          );
          ...
          assertEquals(
            "Incorrect admin draft NodeRef.",
            blogNode,
            adminPosts.getFirst()
          );

          PagingResults<BlogPostInfo> pagedPublishedResults = BLOG_SERVICE.getPublished(
            BLOG_CONTAINER_NODE,
            null,
            null,
            ADMIN_USER,
  ...
  public void getBlogPostsFilteredByDateRange() throws Exception {
    ...
    final List<NodeRef> posts = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<List<NodeRef>>() {
        @Override
        public List<NodeRef> execute() throws Throwable {
          List<NodeRef> results = new ArrayList<NodeRef>();
      ...
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          for (NodeRef nr : posts) {
            ...
            BEHAVIOUR_FILTER.disableBehaviour(
              nr,
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          PagingResults<BlogPostInfo> pagedResults = BLOG_SERVICE.getPublished(
            BLOG_CONTAINER_NODE,
            firstDec99,
            firstJan00,
            null,
