...
public class RemoveFeaturesActionExecuterTest extends BaseSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.executer =
                (RemoveFeaturesActionExecuter)
                        this.applicationContext.getBean(RemoveFeaturesActionExecuter.NAME);
    }
    ...
    public void testExecution() {
        ...
        action.setParameterValue(
                RemoveFeaturesActionExecuter.PARAM_ASPECT_NAME, ContentModel.ASPECT_CLASSIFIABLE);
        ...
        action2.setParameterValue(
                RemoveFeaturesActionExecuter.PARAM_ASPECT_NAME, ContentModel.ASPECT_VERSIONABLE);
