...
/**
 * Tests for {@link RemoteAlfrescoTicketServiceImpl}, which work by looping back to the local repo. Because this tests talks to local webscripts, it needs to be run in the Remote API package
 * 
