...
public class IsPrivateWorkingCopyTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to verify if checked out document is private"
                            + " working copy")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager is able to verify if pwc document is private working copy")
    @Test(groups = {TestGroup.SANITY, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is not able to verify if deleted document is private"
                            + " working copy")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to verify if checked out document is private"
                            + " working copy")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to verify if checked out document is private"
                            + " working copy")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is able to verify if checked out document is private"
                            + " working copy")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is able to verify if checked out document is private"
                            + " working copy in public site")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is not able to verify if checked out document is"
                            + " private working copy in private site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            description =
                    "Verify non invited user is not able to verify if checked out document is"
                            + " private working copy in moderated site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to verify if document created with CHECKEDOUT"
                            + " versioning state is private working copy")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void verifyIsPrivateWorkingCopyForDocumentWithCheckedOutVersioningState()
            throws Exception {
