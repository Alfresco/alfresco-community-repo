 ...
 *
 * <p>An explicit ApplicationContext or an ApplicationContextInit rule can be passed at construction
 * time. getApplicationContext will either return the instance passed in, or retrieve one from the
 * rule.
 *
 * @author Alex Miller
 */
public abstract class AbstractRule extends ExternalResource {
    ...
    /**
     * @param appContextRule {@link ApplicationContextInit} rule used to provide ApplicationContext
     *     to sub classes.
     */
    ...
    /**
     * This method provides the spring application context to subclasses. It either provides the
     * explicit ApplicationContext, passed in at construction time, or retrieves it from the {@link
     * ApplicationContextInit} rule, passed in the alternative constructor.
     *
     * @return the spring application context
     * @throws NullPointerException if the application context has not been initialised when
     *     requested.
     */
        ...
        // or is implicitly accessed via another rule:
            ...
            if (contextFromRule != null) {
                ...
                throw new NullPointerException(
                        "Cannot retrieve application context from provided rule.");
            }
        }
