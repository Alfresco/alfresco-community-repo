 ...
 * @author andyh
 */
public final class PermissionGroup extends AbstractPermissionReference
    ...
    private Set<PermissionReference> includedPermissionGroups =
            new HashSet<PermissionReference>(4, 1.0f);
    ...
    public void initialise(
        ...
        for (Iterator ipgit = element.elementIterator(INCLUDE_PERMISSION_GROUP);
                ipgit.hasNext(); /**/ ) {
            QName qName;
            ...
            PermissionReference permissionReference =
                    PermissionReferenceImpl.getPermissionReference(qName, refName);
