...
/**
 * Base class for Java backed webscripts that wish to generate an ACP and stream the contents back
 * to the caller.
 *
 * <p>The default implementation generates an ACP file containing the provided NodeRefs and all
...
public class StreamACP extends StreamContent {
    ...
    public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException {
        ...
        try {
            ...
            if (MULTIPART_FORMDATA.equals(contentType)) {
                ...
                nodeRefs =
                        getNodeRefs(new JSONObject(new JSONTokener(req.getContent().getContent())));
            }
    ...
    /**
     * Converts the given comma delimited string of NodeRefs to an array of NodeRefs. If the string
     * is null a WebScriptException is thrown.
     *
    ...
    /**
     * Attempts to retrieve and convert a JSON array of NodeRefs from the given JSON object. If the
     * nodeRefs property is not present a WebScriptException is thrown.
     *
     ...
     * @param keepFolderStructure Determines whether the folder structure is maintained for the
     *     content inside the ACP file
     * @return File object representing the created ACP
     */
    protected File createACP(
            ExporterCrawlerParameters params, String extension, boolean keepFolderStructure) {
        try {
            ...
            throw new WebScriptException(
                    HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Failed to create archive", fnfe);
        }
    }
}
