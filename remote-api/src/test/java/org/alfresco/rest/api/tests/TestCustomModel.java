...
public class TestCustomModel extends BaseCustomModelApiTest {
  ...
  public void testListBasicModels() throws Exception {
    ...
    // Create the model as a Model Administrator
    CustomModel customModel_1 = createCustomModel(
      modelName_1,
      getTestNamespaceUriPrefixPair(),
      ModelStatus.DRAFT
    );

    String modelName_2 = "testModel2" + System.currentTimeMillis();
    CustomModel customModel_2 = createCustomModel(
      modelName_2,
      getTestNamespaceUriPrefixPair(),
      ModelStatus.DRAFT
    );
    ...
    CustomModel customModel_3 = createCustomModel(
      modelName_3,
      getTestNamespaceUriPrefixPair(),
      ModelStatus.DRAFT
    );
    ...
    List<CustomModel> models = RestApiUtil.parseRestApiEntries(
      response.getJsonResponse(),
      CustomModel.class
    );
  ...
  public void testActivateCustomModel() throws Exception {
    ...
    Pair<String, String> namespacePair = getTestNamespaceUriPrefixPair();
    // Create the model as a Model Administrator
    CustomModel customModelOne = createCustomModel(
      modelNameOne,
      namespacePair,
      ModelStatus.DRAFT,
    ...
    Pair<String, String> namespacePairTwo = getTestNamespaceUriPrefixPair();
    CustomModel customModelTwo = createCustomModel(
      modelNameTwo,
      namespacePairTwo,
      ModelStatus.DRAFT,
      null,
  ...
  public void testDeactivateCustomModel() throws Exception {
    ...
    {
      // Create another Model
      final String modelNameTwo =
        "testDeactivateModelTwo" + System.currentTimeMillis();
      Pair<String, String> namespacePairTwo = getTestNamespaceUriPrefixPair();
      CustomModel customModelTwo = createCustomModel(
        modelNameTwo,
        namespacePairTwo,
  ...
  public void testUpdateModel_WithAspectsAndTypes() throws Exception {
    ...
    CustomType returnedChildType = RestApiUtil.parseRestApiEntry(
      response.getJsonResponse(),
      CustomType.class
    );
    final String newTypeParentName =
      modifiedPrefix + QName.NAMESPACE_PREFIX + typeBaseName;
    assertEquals(
    ...
    CustomAspect returnedChildAspect = RestApiUtil.parseRestApiEntry(
      response.getJsonResponse(),
      CustomAspect.class
    );
    final String newAspectParentName =
      modifiedPrefix + QName.NAMESPACE_PREFIX + aspectName;
    assertEquals(
      "The parent name prefix should have been updated.",
      newAspectParentName,
