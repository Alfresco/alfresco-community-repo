...
public class ResourceInspector {
  ...
  static {
    ...
    ALL_ENTITY_RESOURCE_INTERFACES.add(
      EntityResourceAction.CreateWithResponse.class
    );
    ALL_ENTITY_RESOURCE_INTERFACES.add(
      EntityResourceAction.ReadWithResponse.class
    );
    ALL_ENTITY_RESOURCE_INTERFACES.add(
      EntityResourceAction.ReadByIdWithResponse.class
    );
    ALL_ENTITY_RESOURCE_INTERFACES.add(
      EntityResourceAction.UpdateWithResponse.class
    );
    ALL_ENTITY_RESOURCE_INTERFACES.add(
      EntityResourceAction.DeleteWithResponse.class
    );
    ALL_ENTITY_RESOURCE_INTERFACES.add(
      EntityResourceAction.DeleteSetWithResponse.class
    );

    ALL_ENTITY_RESOURCE_INTERFACES.add(
      BinaryResourceAction.ReadWithResponse.class
    );

    ALL_ENTITY_RESOURCE_INTERFACES.add(MultiPartResourceAction.Create.class);

    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.Create.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.Read.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.ReadById.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.Update.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.Delete.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.DeleteSet.class
    );

    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.CreateWithResponse.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.ReadWithResponse.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.ReadByIdWithResponse.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.UpdateWithResponse.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.DeleteWithResponse.class
    );
    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      RelationshipResourceAction.DeleteSetWithResponse.class
    );

    ALL_RELATIONSHIP_RESOURCE_INTERFACES.add(
      MultiPartRelationshipResourceAction.Create.class
    );
    ...
    ALL_PROPERTY_RESOURCE_INTERFACES.add(
      BinaryResourceAction.ReadWithResponse.class
    );
    ALL_PROPERTY_RESOURCE_INTERFACES.add(
      BinaryResourceAction.DeleteWithResponse.class
    );
    ALL_PROPERTY_RESOURCE_INTERFACES.add(
      BinaryResourceAction.UpdateWithResponse.class
    );
  }
   ...
   */
  private static List<ResourceMetadata> inspectEntity(
    EntityResource annot,
    Class<?> resource
  ) {
    ...
    findOperation(
      EntityResourceAction.DeleteSet.class,
      HttpMethod.DELETE,
      helper
    );
    ...
    findOperation(
      MultiPartResourceAction.Create.class,
      HttpMethod.POST,
      helper
    );
    ...
    if (resource.isAnnotationPresent(WebApiDeleted.class)) {
      metainfo.add(
        new ResourceMetadata(
          ResourceDictionary.resourceKey(urlPath, null),
          RESOURCE_TYPE.ENTITY,
          null,
          api,
          ALL_ENTITY_RESOURCE_INTERFACES,
          apiNoAuth,
          null
        )
      );
  ...
  public static void inspectAddressedProperties(
    ...
    MetaHelperAddressable helperForAddressProps = new MetaHelperAddressable(
      resource,
      entityPath,
    ...
    findOperation(
      BinaryResourceAction.Read.class,
      HttpMethod.GET,
      helperForAddressProps
    );
    findOperation(
      BinaryResourceAction.Delete.class,
      HttpMethod.DELETE,
      helperForAddressProps
    );
    findOperation(
      BinaryResourceAction.Update.class,
      HttpMethod.PUT,
      helperForAddressProps
    );
    ...
    findOperation(
      RelationshipResourceBinaryAction.Read.class,
      HttpMethod.GET,
      helperForAddressProps
    );
    findOperation(
      RelationshipResourceBinaryAction.Delete.class,
      HttpMethod.DELETE,
      helperForAddressProps
    );
    findOperation(
      RelationshipResourceBinaryAction.Update.class,
      HttpMethod.PUT,
      helperForAddressProps
    );

    findOperation(
      RelationshipResourceBinaryAction.ReadWithResponse.class,
      HttpMethod.GET,
      helperForAddressProps
    );
    findOperation(
      RelationshipResourceBinaryAction.DeleteWithResponse.class,
      HttpMethod.DELETE,
      helperForAddressProps
    );
    findOperation(
      RelationshipResourceBinaryAction.UpdateWithResponse.class,
      HttpMethod.PUT,
      helperForAddressProps
    );
    ...
    Set<Class<? extends ResourceAction>> apiNoAuth =
      helperForAddressProps.apiNoAuth;

    if (resource.isAnnotationPresent(WebApiDeleted.class)) {
      metainfo.add(
        new ResourceMetadata(
          ResourceDictionary.propertyResourceKey(entityPath, "FIX_ME"),
   ...
   * @param resource Class<?>
   */
  private static List<ResourceMetadata> inspectRelationship(
    RelationshipResource annot,
    Class<?> resource
  ) {
    Map<String, Object> annotAttribs = AnnotationUtils.getAnnotationAttributes(
      annot
    );
    ...
    RelationshipResource relAnnot = AnnotationUtils.findAnnotation(
      entityResource,
      RelationshipResource.class
    );
    if (relAnnot != null) {
      Map<String, Object> relAnnotAttribs = AnnotationUtils.getAnnotationAttributes(
        relAnnot
      );
    ...
    String relationshipKey = ResourceDictionary.resourceKey(
      entityPath,
      urlPath
    );
    Api api = inspectApi(resource);
    ...
    if (resource.isAnnotationPresent(WebApiDeleted.class)) {
      metainfo.add(
        new ResourceMetadata(
          ...
          null,
          inspectApi(resource),
          ALL_RELATIONSHIP_RESOURCE_INTERFACES,
          apiNoAuth,
          entityPath
        )
      );
  ...
  private static void findOperation(
    Class<? extends ResourceAction> resourceInterfaceWithOneMethod,
    HttpMethod httpMethod,
    MetaHelperCallback helper
  ) {
    if (resourceInterfaceWithOneMethod.isAssignableFrom(helper.resource)) {
      Method aMethod = findMethod(
        resourceInterfaceWithOneMethod,
        helper.resource
      );
      ResourceOperation operation = inspectOperation(
        helper.resource,
        aMethod,
        httpMethod
      );
      ...
      if (isNoAuth(aMethod)) {
        if (
          ...
          throw new IllegalArgumentException(
            "@WebApiNoAuth should only be on GET or POST methods: " +
            operation.getTitle()
          );
        }
   ...
   */
  public static ResourceOperation inspectOperation(
    Class<?> resource,
    Method aMethod,
    HttpMethod httpMethod
  ) {
    Annotation annot = AnnotationUtils.findAnnotation(
      aMethod,
      WebApiDescription.class
    );
    ...
    if (annot != null) {
      ...
      return new ResourceOperation(
        ...
        "This method should be annotated with @WebApiDescription",
        parameters,
  ...
  private static List<ResourceParameter> inspectParameters(
    ...
    if (annot != null) {
      ...
      Annotation paramAnot = AnnotationUtils.findAnnotation(
        aMethod,
        WebApiParam.class
      );
      if (paramAnot != null) {
    ...
    switch (httpMethod) {
      case POST:
        ...
        break;
      case PUT:
        int urlPathForPut = paramsCount(
          params,
          ResourceParameter.KIND.URL_PATH
        );
        if (urlPathForPut == 0) {
          params.add(ResourceParameter.ENTITY_PARAM);
        }
        if (
          RelationshipResourceAction.Update.class.isAssignableFrom(resource) &&
          urlPathForPut < 2
        ) {
      ...
      case GET:
        ...
        if (
          ...
          RelationshipResourceAction.ReadById.class.isAssignableFrom(
              resource
            ) ||
          ...
          if (
            READ_BY_ID_METHODNAME.equals(aMethod.getName()) && urlPathForGet < 2
          ) {
            params.add(ResourceParameter.RELATIONSHIP_PARAM);
          }
        }
        ...
        break;
      case DELETE:
        int urlPathForDelete = paramsCount(
          params,
          ResourceParameter.KIND.URL_PATH
        );
        ...
        if (
          RelationshipResourceAction.Delete.class.isAssignableFrom(resource) &&
          urlPathForDelete < 2
        ) {
          params.add(ResourceParameter.RELATIONSHIP_PARAM);
        }
  ...
  private static void inspectBodyParamAndReturnType(
    Class<?> resource,
    Method aMethod,
  ...
  private static ResourceParameter findResourceParameter(
    ...
    ResourceParameter.KIND paramKind = (ResourceParameter.KIND) annotAttribs.get(
      "kind"
    );
  ...
  public static boolean isDeleted(Method method) {
    WebApiDeleted deleted = AnnotationUtils.getAnnotation(
      method,
      WebApiDeleted.class
    );
    return (deleted != null);
  ...
  public static boolean isNoAuth(Method method) {
    WebApiNoAuth noAuth = AnnotationUtils.getAnnotation(
      method,
      WebApiNoAuth.class
    );
    return (noAuth != null);
  ...
  public static Method findMethod(
    ...
    if (resourceMethods == null || resourceMethods.length != 1) {
      ...
      throw new IllegalArgumentException(
        resourceInterfaceWithOneMethod +
        " should be an interface with just one method."
      );
    }
    Method method = ReflectionUtils.findMethod(
      resource,
      resourceMethods[0].getName(),
      null
    );
    return method;
  }
   ...
   */
  protected static String findEntityNameByAnnotationAttributes(
    Map<String, Object> annotAttribs
  ) {
    Class<?> entityResourceRef = (Class<?>) annotAttribs.get("entityResource");
    EntityResource entityAnnot = AnnotationUtils.findAnnotation(
      entityResourceRef,
   ...
   */
  public static Map<String, Pair<String, Method>> findEmbeddedResources(
    Class<?> anyClass
  ) {
    Map<String, Pair<String, Method>> embeds = new HashMap<String, Pair<String, Method>>();
    List<Method> annotatedMethods = ResourceInspectorUtil.findMethodsByAnnotation(
      anyClass,
    ...
    if (annotatedMethods != null && !annotatedMethods.isEmpty()) {
      for (Method annotatedMethod : annotatedMethods) {
        ...
        if (annot != null) {
          ...
          String entityPath = findEntityNameByAnnotationAttributes(
            annotAttribs
          );
          String key = String.valueOf(annotAttribs.get("propertyName"));
          embeds.put(
            key,
            new Pair<String, Method>(entityPath, annotatedMethod)
          );
        }
      }
    }
   ...
   */
  public static void inspectOperations(
    Api api,
    Class<?> resource,
    final String entityPath,
    List<ResourceMetadata> metainfo
  ) {
    Map<String, Pair<ResourceOperation, Method>> operations = findOperations(
      entityPath,
      resource
    );
    if (operations != null && !operations.isEmpty()) {
      for (Entry<String, Pair<ResourceOperation, Method>> opera : operations.entrySet()) {
        ...
        if (isDeleted(annotatedMethod)) {
          metainfo.add(
            new OperationResourceMetaData(
              opera.getKey(),
              api,
              new HashSet(Arrays.asList(opera.getValue().getFirst())),
              isNoAuthRequired
            )
          );
        } else {
          metainfo.add(
            new OperationResourceMetaData(
              opera.getKey(),
              Arrays.asList(opera.getValue().getFirst()),
              api,
              annotatedMethod,
              isNoAuthRequired
            )
   ...
   */
  private static Map<String, Pair<ResourceOperation, Method>> findOperations(
    String entityPath,
    Class<?> anyClass
  ) {
    ...
    if (
      annotatedMethods != null && !annotatedMethods.isEmpty()
    ) for (Method annotatedMethod : annotatedMethods) {
      ...
      if (annot != null) {
        ...
        String actionPath = ResourceDictionary.propertyResourceKey(
          entityPath,
          actionName
        );
        ResourceOperation ro = inspectOperation(
          anyClass,
          annotatedMethod,
          HttpMethod.POST
        );
        embeds.put(
          actionPath,
          new Pair<ResourceOperation, Method>(ro, annotatedMethod)
        );
      }
    }
    return embeds;
  ...
  public static List<ResourceMetadata> inspect(Class resource) {
    EntityResource annot = AnnotationUtils.findAnnotation(
      resource,
      EntityResource.class
    );
    if (annot != null) {
  ...
  public static Method findUniqueIdMethod(Class<?> objClass)
    ...
    if (annotatedMethods != null && !annotatedMethods.isEmpty()) {
      if (annotatedMethods.size() != 1) {
        ...
        throw new IllegalArgumentException(
          "There should only ever be one UniqueId annotation on a class but " +
          objClass +
          " has " +
  ...
  private static class MetaHelperAddressable extends MetaHelperCallback {
    ...
    public MetaHelperAddressable(
      Class<?> resource,
      String entityPath,
      Map<String, List<ResourceOperation>> operationGroupedByProperty
    ) {
      super(resource);
    ...
    public void whenNewOperation(ResourceOperation operation, Method aMethod) {
      Annotation addressableProps = AnnotationUtils.findAnnotation(
        aMethod,
        BinaryProperties.class
      );
      if (addressableProps != null) {
        ...
        for (String property : props) {
          String propKey = ResourceDictionary.propertyResourceKey(
            entityPath,
            property
          );
          ...
          List<ResourceOperation> operations = operationGroupedByProperty.get(
            propKey
          );
        ...
        logger.warn(
          ...
          " should declare a @BinaryProperties annotation."
        );
      }
    }

    @Override
    public void whenOperationDeleted(
      Class<? extends ResourceAction> deleted,
      Method aMethod
    ) {}

    @Override
    public void whenOperationNoAuth(
      Class<? extends ResourceAction> noAuth,
      Method aMethod
    ) {
  ...
  private abstract static class MetaHelperCallback {
    ...
    public abstract void whenNewOperation(
      ResourceOperation operation,
      Method aMethod
    );

    public abstract void whenOperationDeleted(
      Class<? extends ResourceAction> deleted,
      Method aMethod
    );

    public abstract void whenOperationNoAuth(
      Class<? extends ResourceAction> noAuth,
      Method aMethod
    );
  }
