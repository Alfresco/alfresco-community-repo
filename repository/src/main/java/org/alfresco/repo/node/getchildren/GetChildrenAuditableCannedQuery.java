...
public class GetChildrenAuditableCannedQuery
    ...
    protected List<NodeBackedEntity> queryAndFilter(CannedQueryParameters parameters) {
        ...
        GetChildrenAuditableCannedQueryParams paramBean =
                (GetChildrenAuditableCannedQueryParams) paramBeanObj;
        ...
        boolean filterByCreatedDate =
                (paramBean.getCreatedBefore() != null && paramBean.getCreatedAfter() != null);
        boolean filterByModifiedDate =
                (paramBean.getModifiedBefore() != null && paramBean.getModifiedAfter() != null);

        // note: refer to SQL for specific DB filtering (eg.parent nodes etc)
        List<NodeBackedEntity> results =
        ...
        for (NodeBackedEntity result : results) {
            ...
            if (filterByCreatedDate || filterByModifiedDate) {
                ...
                Date modifiedDate =
                        DefaultTypeConverter.INSTANCE.convert(Date.class, result.getModifiedDate());
