...
public class NotificationServiceImplSystemTest extends BaseAlfrescoTestCase {
    ...
    private static final String BODY =
            "This is a test notification from"
                + " org.alfresco.repo.notification.NotificationServiceImplSystemTest.  Please do"
                + " not respond!";

    private static final String TEMPLATE =
            "<html>   <body bgcolour='#dddddd'>      <p>This is a test notification from"
                + " org.alfresco.repo.notification.NotificationServiceImplSystemTest.  Please do"
                + " not respond!</p>      <br>      Template context:<br><br>      userhome:"
                + " ${userhome}<br>      companyhome: ${companyhome}<br>      productname:"
                + " ${productName}<br>";
                    ...
                    public Void execute() throws Throwable {
                        ...
                        template =
                                fileFolderService
                                        .create(
                                                companyHome,
                                                "testTemplate" + GUID.generate() + ".ftl",
                ...
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() {
                        ...
                        notificationService.sendNotification(
                                EMailNotificationProvider.NAME, context);
    ...
    public void testTestNotificationProvider() throws Exception {
        ...
        assertTrue(
                notificationService
                        ...
                        .contains(TestNotificationProvider.NAME));
        NotificationContext context = new NotificationContext();
        ...
        assertTrue(
                "notification context did not contain correct 'to' entry",
                contextSentFromTest.getTo().contains(to));
    }
     ...
     * replacement for the {@link EMailNotificationProvider} for validation and/or to prevent emails
     * being sent from test code.
     *
    ...
    /**
     * Implementations of this interface can be injected into the {@link TestNotificationProvider}
     * in order to receive notifications.
     *
     * <p>Only intended for test code at this stage.
     *
     * @author Neil Mc Erlean
     * @since 4.0
     */
