...
public interface RenditionModel {
   ...
   */
  static final QName ASPECT_RENDITION2 = QName.createQName(
   ...
   */
  static final QName PROP_RENDITION_CONTENT_HASH_CODE = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "contentHashCode"
  );
   ...
   */
  @Deprecated
  static final QName ASPECT_RENDITION = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "rendition"
  );
   ...
   */
  @Deprecated
  static final QName ASPECT_HIDDEN_RENDITION = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "hiddenRendition"
  );
   ...
   */
  @Deprecated
  static final QName ASPECT_VISIBLE_RENDITION = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "visibleRendition"
  );

  static final QName ASPECT_RENDITIONED = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "renditioned"
  );
  static final QName ASSOC_RENDITION = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "rendition"
  );
   ...
   * @since 4.0.1
   */
  static final QName ASPECT_PREVENT_RENDITIONS = QName.createQName(
    NamespaceService.RENDITION_MODEL_1_0_URI,
    "preventRenditions"
  );
}
