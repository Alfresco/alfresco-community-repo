...
public interface CustomModelService
{
     ...
     *
     * @param name
     *            the name of the custom aspect to retrieve
     ...
     *
     * @param modelNodeRef
     *            the {@code NodeRef} of the custom model
     ...
     *
     * @param prefix
     *            the namespace prefix {@code String}
     * @throws CustomModelException
     ...
     *
     * @param modelNodeRef
     *            the nodeRef of the model whose namespace prefix is to be validated {@code NodeRef}
     * @throws CustomModelException
     *             if the namespace prefix is already in use by another model
     */
     ...
     *
     * @param name
     *            the name of the custom constraint to retrieve
     ...
     *
     * @param modelName
     *            the model name to be exported
     * @param withAssociatedForm
     *            whether Share extension module file should be included or not
