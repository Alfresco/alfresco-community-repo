...
public class PrimaryKeyTest extends DbObjectTestBase<PrimaryKey> {
    ...
    public void setUp() {
        ...
        thisPK =
                new PrimaryKey(
                        parent, "this_pk", columns("id", "name", "age"), columnOrders(2, 1, 3));
        thatPK = new PrimaryKey(parent, "that_pk", columns("a", "b"), columnOrders(1, 2));
    }
    ...
    public void sameAs() {
        ...
        assertTrue(
                "Primary keys should be logically equivalent",
                thisPK.sameAs(
                        new PrimaryKey(
                                parent,
                                "this_pk",
        ...
        // Other PK is null
        assertFalse(
                "PKs should not be considered the same (other PK is null)", thisPK.sameAs(null));
    }
