 ...
 *
 * <p>Values set here are mapped to ${valueName} style strings in the tranformer execution string.
 *
...
public class RuntimeExecutableContentTransformerOptions extends TransformationOptions {
    ...
    /**
     * Overrides the base class implementation to add all values set in {@link
    ...
    public boolean equals(Object o) {
        ...
        RuntimeExecutableContentTransformerOptions that =
                (RuntimeExecutableContentTransformerOptions) o;
