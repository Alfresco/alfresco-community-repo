...
public class GetSiteMembersTests extends RestTest {
  ...
  public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteMembers()
    throws Exception {
  ...
  public void getModeratedSiteMembersUsingPropertiesParameter()
    throws Exception {
    siteMembers =
      restClient
        .authenticateUser(siteCreator)
  ...
  public void getModeratedSiteMembersUsingSkipCountParameter()
    throws Exception {
    siteMembers =
      restClient
        .authenticateUser(siteCreator)
  ...
  public void getModeratedSiteMembersUsingHighSkipCountParameter()
    throws Exception {
    siteMembers =
      restClient
        .authenticateUser(siteCreator)
  ...
  public void getSiteMembersAfterRemovingASiteMember() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingSite(moderatedSite3)
      .deleteSiteMember(privateSiteConsumer);

    siteMembers =
      restClient.withCoreAPI().usingSite(moderatedSite3).getSiteMembers();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    siteMembers
      .assertThat()
  ...
  public void verifyIsMemberOfGroupProps() throws Exception {
    ...
    restClient
      ...
      .usingSite(moderatedSite4)
      .addSiteGroup(
        "GROUP_" + firstGroup.getGroupIdentifier(),
        UserRole.SiteCollaborator
      );

    siteMembers =
      restClient.withCoreAPI().usingSite(moderatedSite4).getSiteMembers();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    siteMembers.assertThat().entriesListCountIs(2);
    siteMembers
      .getEntryByIndex(0)
      .assertThat()
      .field("isMemberOfGroup")
      .isNotNull();
    siteMembers
      .getEntryByIndex(1)
      .assertThat()
