...
public interface TemplateService
{
     ...
     * 
     * @param template
     *            Template (qualified classpath name or noderef)
     * @param model
     ...
     *            Name of the template engine to use
     * @param templateRef
     *            Template ref (qualified classpath name or noderef)
     * @param model
     *            Object model to process template against
     * @param locale
     *            Locale to process the template as
     */
     ...
     * 
     * @param person
     *            the person node reference
     * @param companyHome
     *            the company home node refereence
     * @param userHome
     *            the user home node reference
     * @param template
     *            the node ref for the template (optional)
     * @param imageResolver
