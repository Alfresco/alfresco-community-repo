...
/**
 * This is the main Jackson configuration, it configures the Rest Json settings. It is possible to
 * add custom serializers and deserializers using the Spring bean config.
 *
 * @author Gethin James
 */
public class RestJsonModule extends SimpleModule implements InitializingBean {
    ...
    public void setJsonSerializers(
            @SuppressWarnings("rawtypes") List<JsonSerializer> jsonSerializers) {
        this.jsonSerializers = jsonSerializers;
    }

    public void setJsonDeserializers(
            @SuppressWarnings("rawtypes") Map<String, JsonDeserializer> jsonDeserializers) {
