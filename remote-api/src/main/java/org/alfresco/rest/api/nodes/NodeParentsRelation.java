...
public class NodeParentsRelation
  ...
  private static final Set<String> WHERE_PARAMS_PARENTS = new HashSet<>(
    Arrays.asList(
      new String[] { Nodes.PARAM_ASSOC_TYPE, Nodes.PARAM_ISPRIMARY }
    )
  );
  ...
  @Override
  @WebApiDescription(
    title = "Return a list of parent nodes based on child assocs"
  )
