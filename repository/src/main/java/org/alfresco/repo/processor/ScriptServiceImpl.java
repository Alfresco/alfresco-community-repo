...
public class ScriptServiceImpl implements ScriptService {
    ...
    public void registerScriptProcessor(ScriptProcessor scriptProcessor) {
        ...
        this.scriptProcessorNamesByExtension.put(
                scriptProcessor.getExtension(), scriptProcessor.getName());
    }
    ...
    /**
     * @see org.alfresco.service.cmr.repository.ScriptService#executeScript(java.lang.String,
     *     java.util.Map)
     */
    ...
    /**
     * @see
     *     org.alfresco.service.cmr.repository.ScriptService#executeScript(org.alfresco.service.cmr.repository.NodeRef,
    ...
    /**
     * @see
     *     org.alfresco.service.cmr.repository.ScriptService#executeScript(org.alfresco.service.cmr.repository.ScriptLocation,
     *     java.util.Map)
     */
    ...
    /**
     * @see org.alfresco.service.cmr.repository.ScriptService#executeScript(java.lang.String,
     *     org.alfresco.service.cmr.repository.ScriptLocation, java.util.Map)
     */
    ...
    /**
     * @see org.alfresco.service.cmr.repository.ScriptService#executeScriptString(java.lang.String,
     *     java.util.Map)
     */
    ...
    protected Object execute(
            ScriptProcessor processor, ScriptLocation location, Map<String, Object> model) {
        ParameterCheck.mandatory("location", location);
     ...
     */
    protected Object execute(
            ScriptProcessor processor, String location, Map<String, Object> model) {
     ...
     * @return Object the result of the script
     */
    protected Object executeString(
            ScriptProcessor processor, String script, Map<String, Object> model) {
    ...
    protected ScriptProcessor getScriptProcessor(NodeRef scriptNode) {
        String scriptName =
                (String) this.nodeService.getProperty(scriptNode, ContentModel.PROP_NAME);
    ...
    /**
     * @see
     *     org.alfresco.service.cmr.repository.ScriptService#buildDefaultModel(org.alfresco.service.cmr.repository.NodeRef,
