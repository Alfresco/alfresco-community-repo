...
public class ActionServiceImpl2Test {
    ...
    /**
     * This JUnit rule will allow us to create Share sites and users and have them automatically
     * cleaned up for us.
     */
    @Rule public TemporarySites temporarySites = new TemporarySites(APP_CONTEXT_INIT);

    @Rule public WellKnownNodes wellKnownNodes = new WellKnownNodes(APP_CONTEXT_INIT);

    @Rule public TemporaryNodes tempNodes = new TemporaryNodes(APP_CONTEXT_INIT);
    ...
    public static void initStaticData() throws Exception {
        ...
        actionService =
                (ActionService) APP_CONTEXT_INIT.getApplicationContext().getBean("actionService");
        contentService =
    ...
    public void initTestSiteAndUsersAndSomeContent() {
        final String siteShortName =
                ActionServiceImpl2Test.class.getSimpleName()
                        + "TestSite"
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        Action incrementAction =
                                actionService.createAction(CounterIncrementActionExecuter.NAME);
    ...
    public void testIncrementCounter() throws Exception {
        ...
        int beforeIncrement =
                (Integer) nodeService.getProperty(testNode, ContentModel.PROP_COUNTER);
    ...
    public void testTransform() throws Exception {
        final File file =
                loadAndAddQuickFileAsManager(
                        testNode, "quick.txt", MimetypeMap.MIMETYPE_TEXT_PLAIN);
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        map.put(
                                ...
                                nodeService.getPrimaryParent(testNode).getParentRef());
    ...
    public void testParameterConstraints() throws Exception {
        ...
        if (constraints.size() > 0) {
            ...
            ParameterConstraint pConstraintAgain =
                    actionService.getParameterConstraint(parameterConstraint.getName());
    ...
    public void testExecuteScript() throws Exception {
        final NodeRef scriptToBeExecuted =
                addTempScript(
                        "changeFileNameTest.js",
        ...
        final File file =
                loadAndAddQuickFileAsManager(testNode, "quick.pdf", MimetypeMap.MIMETYPE_PDF);
        assertNotNull("Failed to load required test file.", file);
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        action.setParameterValue(
                                ScriptActionExecuter.PARAM_SCRIPTREF, scriptToBeExecuted);
                        ...
                        assertTrue(
                                "The consumer shouldn't be able to change the name of the file.",
                                ("quick.pdf"
                                        .equals(
                                                nodeService.getProperty(
                                                        testNode, ContentModel.PROP_NAME))));
        ...
        NodeRef sharedFolderRef =
                nodeService.getChildByName(companyHomeRef, ContentModel.ASSOC_CONTAINS, "Shared");
        final NodeRef invalidScriptRef =
                addTempScript(
                        "changeFileNameTest.js",
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        Action action = actionService.createAction(ScriptActionExecuter.NAME);
                        action.setParameterValue(
                                ScriptActionExecuter.PARAM_SCRIPTREF, invalidScriptRef);
                        ...
                        assertFalse(
                                "Scripts outside of Data Dictionary Scripts folder should not be"
                                        + " executed",
                                ("Invalid_Change.pdf"
                                        .equals(
                                                nodeService.getProperty(
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        try {
                            ...
                            NodeRef script =
                                    addTempScript("test-action-result-script.js", "\"VALUE\";");
                            ...
                            // Get the result
                            String result =
                                    (String) action.getParameterValue(ActionExecuter.PARAM_RESULT);
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                "The consumer shouldn't be able to perform Extract Metadata.",
                ...
                new RetryingTransactionCallback<NodeRef>() {
                    public NodeRef execute() throws Throwable {
                        ...
                        ContentWriter contentWriter =
                                contentService.getWriter(script, ContentModel.PROP_CONTENT, true);
        ...
        return transactionHelper.doInTransaction(
                new RetryingTransactionCallback<NodeRef>() {
                    public NodeRef execute() throws Throwable {
                        ...
                        NodeRef scriptsRef =
                                nodeService.getChildByName(
                                        dataDictionaryRef, ContentModel.ASSOC_CONTAINS, "Scripts");
    ...
    private File loadAndAddQuickFileAsManager(
            final NodeRef nodeRef, final String quickFileName, final String mimeType)
            throws IOException {
