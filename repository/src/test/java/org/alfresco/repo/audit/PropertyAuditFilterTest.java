...
public class PropertyAuditFilterTest {
  ...
  public void testDefaultActionUsedAsFallback() {
    ...
    boolean actual = filter.accept(rootPath, auditMap);
    assertFalse(
      "The 'default' fallback action should have been used to " +
      "enable the filter and reject the value.",
      actual
    );
  }
  ...
  public void testRedirect() {
    ...
    boolean actual = filter.accept(rootPath, auditMap);
    assertFalse(
      "Redirected properties should have rejected the value.",
      actual
    );
  }
  ...
  public void testEscapedRedirect() {
    ...
    auditMap.put("name", "");
    assertTrue(
      "Should match only zero length values",
      filter.accept(rootPath, auditMap)
    );
  }
  ...
  public void testEscapedNot() {
    ...
    assertTrue(
      "Should match any value starting with '~'.",
      filter.accept(rootPath, auditMap)
    );
  }
}
