 ...
 * <p>
 * See {@link PagedSourceOptions} for an example implementation that describes the page number that should be used from the source content.
 * 
 * @author Ray Gauss II
 *
...
public interface TransformationSourceOptions
{
     ...
     * <p>
     * This is primarily used when interacting with the {@link RenditionService} with {@link AbstractRenderingEngine}'s RenderContext being an implementer of this interface.
     */
    @AlfrescoPublicApi
