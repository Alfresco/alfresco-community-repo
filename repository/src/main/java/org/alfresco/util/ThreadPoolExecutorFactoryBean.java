...
/**
 * Factory for {@link java.util.concurrent.ThreadPoolExecutor} instances, which cannot easily be
 * constructed using constructor injection. This instance also allows the setting of the
 * thread-specific properties that would otherwise require setting a <code>ThreadFactory</code>.
 *
 * <p>This factory provides the a singleton instance of the pool.
 *
 * <p>Defaults are:
 *
 * <ul>
 *   <li><b>{@link #setCorePoolSize(int) corePoolSize}: </b> 20
 *   <li><b>{@link #setMaximumPoolSize(int) maximumPoolSize}: </b> Equal to the {@link
 *       #setCorePoolSize(int)} at the time of instance creation
 *   <li><b>{@link #setKeepAliveTime(int) keepAliveTime}: </b> 90 seconds
 *   <li><b>{@link #setThreadPriority(int) threadPriority}: </b> 5 (NORM)
 *   <li><b>{@link #setThreadDaemon(boolean) threadDaemon}: </b> true
 *   <li><b>{@link #setWorkQueueSize(int) workQueueSize}: </b> -1 or less (No upper bound)
 *   <li><b>{@link #setRejectedExecutionHandler(RejectedExecutionHandler) rejectedExecutionHandler}:
 *       </b> <code>ThreadPoolExecutor.CallerRunsPolicy</code>
 * </ul>
 *
 * @author Derek Hulley
 */
public class ThreadPoolExecutorFactoryBean
    ...
    private static final int DEFAULT_MAXIMUM_POOL_SIZE =
            -1; // -1 is a sign that it must match the core pool size
    ...
    /**
     * The priority that all threads must have on the scale of 1 to 10, where 1 has the lowest
     * priority and 10 has the highest priority.
     *
     ...
     *
     * @param workQueueSize the queue size before blocks, or <b>-1</b> default to indicate no upper
     *     bound
     */
    ...
    /**
     * The optional handler for when tasks cannot be submitted to the queue. The default is the
     * <code>CallerRunsPolicy</code>.
     *
    ...
    public Object getObject() throws Exception {
        if (instance == null) {
            throw new AlfrescoRuntimeException(
                    "The ThreadPoolExecutor instance has not been created");
        }
        return instance;
    }
