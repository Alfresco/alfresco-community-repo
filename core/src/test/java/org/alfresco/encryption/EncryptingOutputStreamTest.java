...
public class EncryptingOutputStreamTest extends TestCase {
  ...
  public void testEncrypt() throws Exception {
    ...
    final OutputStream encrypting = new EncryptingOutputStream(
      buff,
      pair.getPublic(),
      random
    );
    ...
    final InputStream in = getClass()
      .getResourceAsStream(getClass().getSimpleName() + ".class");
    ...
    encrypting.close();
    plainText1.close();
    final InputStream decrypting = new DecryptingInputStream(
    ...
    assertTrue(
      Arrays.equals(plainText1.toByteArray(), plainText2.toByteArray())
    );
  }
}
