...
public class TransactionUtil {
     ...
     *
     * <p>This interface encapsulates a unit of work that should be done within a transaction.
     *
     * @deprecated
    ...
    public static <R> R executeInUserTransaction(
            TransactionService transactionService, TransactionWork<R> transactionWork) {
        return executeInTransaction(transactionService, transactionWork, false, false);
    }

    /**
     * Execute the transaction work in a user transaction. Any current transaction will be
     * continued.
     *
     * @param transactionService the transaction service
     * @param transactionWork the transaction work
    ...
    /**
     * Execute the transaction work in a <b>writable</b>, non-propagating user transaction. Any
     * current transaction will be suspended a new one started.
     *
     * @param transactionService the transaction service
     * @param transactionWork the transaction work
     * @throws java.lang.RuntimeException if the transaction was rolled back
    ...
    /**
     * Execute the transaction work in a non-propagating user transaction. Any current transaction
     * will be suspended a new one started.
     *
     * @param transactionService the transaction service
     * @param transactionWork the transaction work
     * @param readOnly true if the transaction should be read-only
     ...
     * @param transactionService the transaction service
     * @param transactionWork the transaction work
     * @param nonPropagatingUserTransaction indicates whether the transaction should be non
     *     propigating or not
     * @param readOnly true if the transaction should be read-only
     * @throws java.lang.RuntimeException if the transaction was rolled back
     */
