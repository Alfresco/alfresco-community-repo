...
/** @author andyh */
public class LuceneFunctionalConstraint<Q, S, E extends Throwable> extends BaseFunctionalConstraint
        ...
        if (function != null) {
            if (function instanceof LuceneQueryBuilderComponent) {
                ...
                LuceneQueryBuilderComponent<Q, S, E> luceneQueryBuilderComponent =
                        (LuceneQueryBuilderComponent<Q, S, E>) function;
                return luceneQueryBuilderComponent.addComponent(
                        selectors, getFunctionArguments(), luceneContext, functionContext);
            } else {
