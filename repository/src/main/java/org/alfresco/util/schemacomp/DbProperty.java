...
public class DbProperty {
  ...
  protected DbProperty(
    ...
    if (useSuppliedValue) {
      ...
      try {
        this.propertyValue =
          PropertyUtils.getProperty(dbObject, this.propertyName);
      } catch (Throwable error) {
        throw new IllegalArgumentException(
          "Cannot get value for property named \"" + propertyName + "\"",
          error
        );
      }
    } else {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((this.dbObject == null) ? 0 : this.dbObject.hashCode());
    result =
      prime *
      result +
