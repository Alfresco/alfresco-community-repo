...
public class ActivitiWorkflowRestApiTest extends AbstractWorkflowRestApiTest {
  ...
  private static final String ADHOC_WORKFLOW_DEFINITION_NAME =
    "activiti$activitiAdhoc";
  private static final String ADHOC_WORKFLOW_DEFINITION_TITLE = "New Task";
  private static final String ADHOC_WORKFLOW_DEFINITION_DESCRIPTION =
    "Assign a new task to yourself or a colleague";
  private static final String REVIEW_WORKFLOW_DEFINITION_NAME =
    "activiti$activitiReview";
  private static final String REVIEW_POOLED_WORKFLOW_DEFINITION_NAME =
