...
public abstract class AbstractBulkImportTests {
  ...
  public void setup() throws SystemException, NotSupportedException {
    try {
      ...
      bulkImporter =
        (MultiThreadedBulkFilesystemImporter) ctx.getBean(
      ...
      topLevelFolder =
        fileFolderService.create(top, s, ContentModel.TYPE_FOLDER);
  ...
  protected List<FileInfo> getFolders(NodeRef parent, String pattern) {
    PagingResults<FileInfo> page = fileFolderService.list(
      parent,
      false,
      true,
      pattern,
  ...
  protected void testCanVersionDocsWithoutSpecialInputFileNameExtension(
    ...
    throws IOException, SystemException, NotSupportedException, HeuristicRollbackException, HeuristicMixedException, RollbackException {
    txn = transactionService.getUserTransaction();
    txn.begin();
    ...
    bulkImportParameters.setExistingFileMode(
      BulkImportParameters.ExistingFileMode.ADD_VERSION
    );
  ...
  protected void checkFiles(
    ...
    int expectedFoldersLength = expectedFolders != null
      ...
      for (ExpectedFile expectedFile : expectedFiles) {
        ...
        if (
          fileInfo
            .getContentData()
            .getMimetype()
            .equals(MimetypeMap.MIMETYPE_TEXT_PLAIN) &&
