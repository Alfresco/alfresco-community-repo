...
/**
 * This class is an abstract base class for JUnit rules which manage the lifecycle of <code>
 * cm:person</code> nodes and authentication details for the transient users often required within
 * test code.
 *
...
public abstract class AbstractPersonRule extends AbstractRule {
    /**
     * Constructs a person rule with the specified spring context, which will be necessary to
     * actually create and delete the users.
     *
    ...
    /**
     * Constructs a person rule with a reference to an {@link ApplicationContextInit rule}. This
     * other rule will be used to access the application context and from there the necessary
     * services for the creation and deletion of users.
     *
    ...
    /**
     * This method creates a user with the specified username. If an authentication for this
     * username does not exist, it is created. If a cm:person for this username does not exist, it
     * is created. This method does not handle transactions.
     *
    ...
    protected NodeRef createPerson(final String userName) {
        ...
        final TestUserComponent testUserComponent =
                (TestUserComponent) ctxt.getBean("testUserComponent");
     ...
     * present in the system. This method does not handle transactions.
     *
