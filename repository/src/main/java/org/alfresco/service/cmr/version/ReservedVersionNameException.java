...
public class ReservedVersionNameException extends RuntimeException {
    ...
    private static final String MESSAGE =
            "The version property name {0} clashes with a reserved verison property name.";

    /**
     * Constructor
     *
     * @param propertyName the name of the property that clashes with a reserved property name
     */
