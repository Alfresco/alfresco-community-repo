...
public final class StoreRef implements EntityRef, Serializable {
    ...
    public static final StoreRef STORE_REF_ARCHIVE_SPACESSTORE =
            new StoreRef(PROTOCOL_ARCHIVE, "SpacesStore");
    ...
    /**
     * @param protocol well-known protocol for the store, e.g. <b>workspace</b> or
     *     <b>versionstore</b>
     * @param identifier the identifier, which may be specific to the protocol
     */
    ...
    public StoreRef(String string) {
        ...
        if (dividerPatternPosition == -1) {
            throw new AlfrescoRuntimeException(
                    "Invalid store ref: Does not contain " + URI_FILLER + "   " + string);
        }
