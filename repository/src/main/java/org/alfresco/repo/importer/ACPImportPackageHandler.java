                    ...
                    if (entryName.endsWith(".xml")
                        ...
                        if (xmlMetaDataEntry != null) {
                            throw new ImporterException(
                                    "Failed to find unique xml meta-data file within .acp package -"
                                            + " multiple xml meta-data files exist.");
                        }
    ...
    public void endImport() {
        if (zipFile != null) {
            try {
                ...
                throw new ImporterException(
                        "Failed to close zip package " + file.getAbsolutePath(), e);
            }
        }
    }
