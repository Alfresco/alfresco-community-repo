...
public class CompoundCopyBehaviourCallback
  ...
  private static Log logger = LogFactory.getLog(
    CompoundCopyBehaviourCallback.class
  );
  ...
  public Pair<AssocCopySourceAction, AssocCopyTargetAction> getAssociationCopyAction(
    ...
    AssocCopyTargetAction bestTargetAction =
      AssocCopyTargetAction.USE_ORIGINAL_TARGET;
    for (CopyBehaviourCallback callback : callbacks) {
    ...
    Pair<AssocCopySourceAction, AssocCopyTargetAction> bestAction = new Pair<AssocCopySourceAction, AssocCopyTargetAction>(
      bestSourceAction,
      bestTargetAction
    );
    // Done
  ...
  public ChildAssocRecurseAction getChildAssociationRecurseAction(
    ...
    ChildAssocRecurseAction bestAction =
  ...
  public Map<QName, Serializable> getCopyProperties(
    ...
    for (CopyBehaviourCallback callback : callbacks) {
      Map<QName, Serializable> propsToCopy = callback.getCopyProperties(
        classQName,
        copyDetails,
        copyProperties
      );
