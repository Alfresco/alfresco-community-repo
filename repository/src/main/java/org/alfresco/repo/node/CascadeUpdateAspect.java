...
public class CascadeUpdateAspect
        implements OnCreateChildAssociationPolicy,
    ...
    public void init() {
        ...
        // - only changing category structure requires a cascade not changing a node's on a
        // categories
    ...
    private void markCascadeUpdate(NodeRef nodeRef) {
        ...
        nodeService.setProperty(
                status.getNodeRef(), ContentModel.PROP_CASCADE_TX, status.getDbTxnId());
    }
}
