...
public abstract class AbstractLockStoreTxTest<T extends LockStore> {
  ...
  @Test
  public void testRepeatableReadsInTransaction()
    throws NotSupportedException, SystemException {
    final TransactionService txService = (TransactionService) ctx.getBean(
      "TransactionService"
    );
    ...
    final LockState lockState1 = LockState.createLock(
      nodeRef,
      LockType.WRITE_LOCK,
      "jbloggs",
      expires,
    ...
    try {
      ...
      final LockState lockState2 = LockState.createWithOwner(
        lockState1,
        "another"
      );
      ...
      final LockState lockState3 = LockState.createWithOwner(
        lockState2,
        "bsmith"
      );
      ...
      public void run() {
        ...
        try {
          ...
          try {
            ...
            final LockState newUserLockState = LockState.createLock(
              nodeRef,
              LockType.WRITE_LOCK,
              "new-user",
              expiresFuture,
  ...
  public void testOtherUserCanChangeLockInfoOnceExpired()
    ...
    try {
      ...
      Date expiresFuture = new Date(now.getTime() + 180000);
      final LockState lockState2 = LockState.createLock(
        nodeRef,
        LockType.WRITE_LOCK,
        "csmith",
        expiresFuture,
