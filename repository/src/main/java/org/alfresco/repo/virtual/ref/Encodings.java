...
public enum Encodings {
    /**
     * {@link Reference} string encoding that parses and produces reference string representations
    ...
    HASH(new Encoding('H', new HashReferenceParser(), new HashStringifier(), true));
