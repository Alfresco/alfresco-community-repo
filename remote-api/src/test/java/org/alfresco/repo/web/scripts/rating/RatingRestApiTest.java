...
public class RatingRestApiTest extends BaseWebScriptTest {
    ...
    /**
     * This test method applies ratings from multiple users in a single rating scheme to a single
     * test node. It then retrieves those ratings to ensure they were persisted correctly.
     */
    public void testApplyRatingsAsMultipleUsersAndRetrieve() throws Exception {
        ...
        assertEquals(
                userOneRatingValue + userTwoRatingValue, (float) dataObj.getDouble("ratingsTotal"));
        ...
        JSONObject secondRating =
                (JSONObject) userTwoRatings.getJSONObject(FIVE_STAR_RATING_SCHEME);
