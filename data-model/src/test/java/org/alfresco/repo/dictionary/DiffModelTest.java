...
public class DiffModelTest extends AbstractModelTest {
  ...
  public void testDeleteModel() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL1_XML.getBytes()
    );
    ...
    List<M2ModelDiff> modelDiffs = dictionaryDAO.diffModel(
      previousVersion,
      null
    );

    Map<Pair<String, String>, Integer> expected = Map.of(
      new Pair(TYPE_TYPE, DIFF_DELETED),
      3,
      new Pair(TYPE_ASPECT, DIFF_DELETED),
      3
    );
    assertEquals(
      "Unexpected set of diffs found.",
      expected,
      getAllDiffCounts(modelDiffs)
    );
  }
  ...
  public void testNoExistingModelToDelete() {
    try {
      ...
      assertTrue(
        "Should throw exeception that there is no previous version of the model to delete",
        true
      );
      ...
      assertTrue(
        ...
        e
          .getMessage()
          .equals("Invalid arguments - no previous version of model to delete")
      );
    }
  ...
  public void testNewModel() {
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      new Pair(TYPE_TYPE, DIFF_CREATED),
      3,
      new Pair(TYPE_ASPECT, DIFF_CREATED),
      3
    );
    assertEquals(
      "Unexpected set of diffs found.",
  ...
  public void testDuplicateModels() {
    ...
    ByteArrayInputStream byteArrayInputStream2 = new ByteArrayInputStream(
      MODEL1_DUPLICATED_XML.getBytes()
    );
  ...
  public void testNonIncUpdateModel() {
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL1_UPDATE1_XML.getBytes());
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      new Pair(TYPE_TYPE, DIFF_CREATED),
      1,
      new Pair(TYPE_TYPE, DIFF_UNCHANGED),
      2,
      new Pair(TYPE_TYPE, DIFF_DELETED),
      1,
      new Pair(TYPE_ASPECT, DIFF_CREATED),
      1,
      new Pair(TYPE_ASPECT, DIFF_UNCHANGED),
      2,
      new Pair(TYPE_ASPECT, DIFF_DELETED),
      1,
      new Pair(TYPE_PROPERTY, DIFF_UNCHANGED),
      6,
      new Pair(TYPE_PROPERTY, DIFF_UPDATED),
      1,
      new Pair(TYPE_PROPERTY, DIFF_DELETED),
      1
    );
    assertEquals(
      "Unexpected set of diffs found.",
  ...
  public void testIncUpdatePropertiesAdded() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL2_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(
        AbstractModelTest.MODEL2_EXTRA_PROPERTIES_XML.getBytes()
      );
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      ...
      new Pair(TYPE_PROPERTY, DIFF_UNCHANGED),
      4,
      new Pair(TYPE_PROPERTY, DIFF_CREATED),
      2
    );
    assertEquals(
      "Unexpected set of diffs found.",
  ...
  public void testIncUpdateTypesAndAspectsAdded() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL3_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(
        AbstractModelTest.MODEL3_EXTRA_TYPES_AND_ASPECTS_XML.getBytes()
      );
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
  ...
  public void testIncUpdateAssociationsAdded() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL5_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(
        AbstractModelTest.MODEL5_EXTRA_ASSOCIATIONS_XML.getBytes()
      );
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      new Pair(TYPE_TYPE, DIFF_UPDATED_INC),
      1,
      new Pair(TYPE_TYPE, DIFF_UNCHANGED),
      1,
      new Pair(TYPE_ASPECT, DIFF_UNCHANGED),
      ...
      new Pair(TYPE_PROPERTY, DIFF_UNCHANGED),
      6,
      new Pair(TYPE_ASSOCIATION, DIFF_CREATED),
      2
    );
    assertEquals(
      "Unexpected set of diffs found.",
  ...
  public void testIncUpdateTitleDescription() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL6_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL6_UPDATE1_XML.getBytes());
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      ...
      new Pair(TYPE_ASPECT, DIFF_UNCHANGED),
      1,
      new Pair(TYPE_PROPERTY, DIFF_UPDATED_INC),
      2
    );
    assertEquals(
      "Unexpected set of diffs found.",
  ...
  public void testNonIncUpdatePropertiesRemoved() {
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL2_XML.getBytes());
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
  ...
  public void testNonIncUpdateTypesAndAspectsRemoved() {
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL3_XML.getBytes());
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
  ...
  public void testNonIncUpdateDefaultAspectAdded() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL4_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(
        AbstractModelTest.MODEL4_EXTRA_DEFAULT_ASPECT_XML.getBytes()
      );
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      new Pair(TYPE_TYPE, DIFF_UPDATED),
      1,
      new Pair(TYPE_ASPECT, DIFF_UNCHANGED),
      1,
      new Pair(TYPE_PROPERTY, DIFF_UNCHANGED),
  ...
  public void testNonIncUpdateAssociationsRemoved() {
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL5_XML.getBytes());
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    Map<Pair<String, String>, Integer> expected = Map.of(
      ...
      new Pair(TYPE_PROPERTY, DIFF_UNCHANGED),
      6,
      new Pair(TYPE_ASSOCIATION, DIFF_DELETED),
      2
    );
    assertEquals(
      "Unexpected set of diffs found.",
  ...
  public void testIncUpdatePropertiesAddedToMandatoryAspect() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL7_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(
        AbstractModelTest.MODEL7_EXTRA_PROPERTIES_MANDATORY_ASPECTS_XML.getBytes()
      );
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
  ...
  public void testNonIncUpdatePropertiesRemovedFromMandatoryAspect() {
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL7_XML.getBytes());
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
  ...
  public void testIncChangeMandatoryProperties() {
    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(
      AbstractModelTest.MODEL8_XML.getBytes()
    );
    M2Model model = M2Model.createModel(byteArrayInputStream);
    QName modelName = dictionaryDAO.putModel(model);
    CompiledModel previousVersion = dictionaryDAO.getCompiledModel(modelName);
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(
        AbstractModelTest.MODEL8_CHANGE_MANDATORY_PROPERTIES_ASPECTS_XML.getBytes()
      );
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
  ...
  public void testNonIncChangeMandatoryProperties() {
    ...
    byteArrayInputStream =
      new ByteArrayInputStream(AbstractModelTest.MODEL8_XML.getBytes());
    model = M2Model.createModel(byteArrayInputStream);
    modelName = dictionaryDAO.putModel(model);
    CompiledModel newVersion = dictionaryDAO.getCompiledModel(modelName);
   ...
   */
  private Map<Pair<String, String>, Integer> getAllDiffCounts(
    List<M2ModelDiff> m2ModelDiffs
  ) {
    return m2ModelDiffs
      .stream()
      .map(modelDiff ->
        new Pair<>(modelDiff.getElementType(), modelDiff.getDiffType())
      )
