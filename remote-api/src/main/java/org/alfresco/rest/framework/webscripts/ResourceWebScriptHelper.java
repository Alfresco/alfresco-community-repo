...
public class ResourceWebScriptHelper {
  ...
  public static void setUniqueId(Object theObj, String uniqueId) {
    Method annotatedMethod = ResourceInspector.findUniqueIdMethod(
      theObj.getClass()
    );
    if (annotatedMethod != null) {
      PropertyDescriptor pDesc = BeanUtils.findPropertyForMethod(
        annotatedMethod
      );
      if (pDesc != null) {
  ...
  public Object processAdditionsToTheResponse(
    ...
    if (objectToWrap instanceof CollectionWithPagingInfo<?>) {
      ...
      Object sourceEntity = executeIncludedSource(
        api,
        params,
      ...
      Collection<Object> resultCollection = new ArrayList(
        collectionToWrap.getCollection().size()
      );
      ...
      if (
        BeanUtils.isSimpleProperty(objectToWrap.getClass()) ||
      ...
      final ExecutionResult execRes = new ExecutionResult(
        objectToWrap,
        params.getFilter()
      );

      Map<String, Pair<String, Method>> embeddded = ResourceInspector.findEmbeddedResources(
        objectToWrap.getClass()
      );
      if (embeddded != null && !embeddded.isEmpty()) {
        Map<String, Object> results = executeEmbeddedResources(
          api,
          params,
          objectToWrap,
          embeddded
      ...
      if (
        params.getRelationsFilter() != null &&
        !params.getRelationsFilter().isEmpty()
      ) {
        Map<String, ResourceWithMetadata> relationshipResources = locator.locateRelationResource(
          api,
          entityCollectionName,
        ...
        Map<String, Object> relatedResources = executeRelatedResources(
          api,
          params,
  ...
  private Object executeIncludedSource(
    ...
    if (params.includeSource()) {
      ...
      ResourceWithMetadata res = locator.locateEntityResource(
        api,
        entityCollectionName,
        HttpMethod.GET
      );
      if (res != null) {
        Object result = executeResource(
          api,
          params,
          params.getEntityId(),
          null,
        ...
        if (result != null && result instanceof ExecutionResult) return (
  ...
  private Map<String, Object> executeEmbeddedResources(
    ...
    for (Entry<String, Pair<String, Method>> embeddedEntry : embeddded.entrySet()) {
      ResourceWithMetadata res = locator.locateEntityResource(
        api,
        embeddedEntry.getValue().getFirst(),
        HttpMethod.GET
      );
      if (res != null) {
        Object id = ResourceInspectorUtil.invokeMethod(
          embeddedEntry.getValue().getSecond(),
          objectToWrap
        );
        if (id != null) {
          Object execEmbeddedResult = executeResource(
            api,
            params,
            String.valueOf(id),
  ...
  private Map<String, Object> executeRelatedResources(
    ...
    for (final Entry<String, ResourceWithMetadata> relation : relatedResources.entrySet()) {
      Object execResult = executeResource(
        api,
        params,
        uniqueEntityId,
        relation.getKey(),
  ...
  private Object executeResource(
    ...
    try {
      ...
      final Params executionParams = Params.valueOf(
        paramFilter,
        uniqueEntityId,
        params.getRequest()
      );
      ...
      Object result = executor.executeAction(
        resource,
        executionParams,
        callBack
      );
      return processAdditionsToTheResponse(
        null,
        api,
        null,
        executionParams,
      ...
      if (logger.isDebugEnabled()) {
        logger.debug(
          "Ignored error, cannot access the object so can't embed it ",
          e
        );
      }
