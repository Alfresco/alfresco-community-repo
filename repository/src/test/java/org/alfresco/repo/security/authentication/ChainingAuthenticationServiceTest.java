...
public class ChainingAuthenticationServiceTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    service1 =
      new TestAuthenticationServiceImpl(ALFRESCO, true, true, true, false);
    ...
    service4 =
      new TestAuthenticationServiceImpl(EMPTY, true, true, true, false);
    ...
    try {
      ...
      assertTrue(
        ae
          .getMessage()
          .contains(
            AbstractAuthenticationService.GUEST_AUTHENTICATION_NOT_SUPPORTED
          )
      );
    }
    assertNull(as.getCurrentUserName());
  ...
  public void testService_Domains() {
    ...
    assertTrue(
      as.getDomiansThatAllowUserPasswordChanges().equals(onlyAlfDomain)
    );
  }
