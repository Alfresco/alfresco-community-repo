...
public class GroupMembersRelation
  ...
  @Override
  @WebApiDescription(
    title = "A paged list of all the members of the group 'groupId'."
  )
  public CollectionWithPagingInfo<GroupMember> readAll(
    String groupId,
    Parameters params
  ) {
  ...
  @WebApiParam(
    name = "entity",
    title = "A single group member",
    description = "A single group member, multiple groups members are not supported.",
