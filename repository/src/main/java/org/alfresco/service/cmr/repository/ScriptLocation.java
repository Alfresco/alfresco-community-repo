...
public interface ScriptLocation {
    ...
    /**
     * Returns true if the script content is considered cachedable - i.e. classpath located or
     * similar. Else the content will be compiled/interpreted on every execution i.e. repo content.
     *
     ...
     * Secure scripts may access java.* libraries and instantiate pure Java objects directly.
     * Unsecure scripts only have access to pre-configure host objects and cannot access java.*
     * libs.
     *
