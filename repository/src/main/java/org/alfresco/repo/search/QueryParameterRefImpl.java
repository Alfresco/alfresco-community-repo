...
public class QueryParameterRefImpl implements NamedQueryParameterDefinition {
    ...
    public static NamedQueryParameterDefinition createParameterReference(
            Element element, DictionaryService dictionaryService, QueryCollection container) {
        ...
        if (element.getQName().getName().equals(ELEMENT_QNAME.getName())) {
            ...
            if (qNameElement != null) {
                qName =
                        QName.createQName(
                                qNameElement.getText(), container.getNamespacePrefixResolver());
            }
