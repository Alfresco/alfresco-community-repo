...
/**
 * Called by the NonTransactionalContentDiskDriver to advise of operations completed by the
 * ContentDiskInterface.
 */
public interface ContentDiskCallback {
    public void getFileInformation(
            SrvSession sess, TreeConnection tree, String path, FileInfo info);
    ...
    public void createFile(
            SrvSession sess, TreeConnection tree, FileOpenParams params, NetworkFile newFile);
    ...
    public void openFile(
            SrvSession sess, TreeConnection tree, FileOpenParams param, NetworkFile openFile);
    ...
    public void seekFile(SrvSession sess, TreeConnection tree, NetworkFile file, long pos, int typ)
            throws IOException;
