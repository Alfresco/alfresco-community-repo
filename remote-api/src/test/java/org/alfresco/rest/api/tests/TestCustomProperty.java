...
public class TestCustomProperty extends BaseCustomModelApiTest {
  ...
  public void testCreateProperties() throws Exception {
...

    {
      ...
      customModelProperty =
        getProperty(returnedType.getProperties(), typePropName2);
      ...
      assertEquals(
        namespacePair.getSecond() + QName.NAMESPACE_PREFIX + typePropName2,
        customModelProperty.getPrefixedName()
      );
      assertEquals("d:int", customModelProperty.getDataType());
      assertEquals(
        "property2 desciption",
        customModelProperty.getDescription()
      );
      assertFalse(customModelProperty.isMultiValued());
  ...
  public void testDeleteProperty() throws Exception {
    ...
    {
      final String deletePropOneAspectQS = getPropDeleteUpdateQS(
        aspectPropNameOne,
        true
      );
      ...
      put(
        "cmm/" + modelName + "/aspects",
        aspectName,
        RestApiUtil.toJsonAsString(deletePropAspectPayload),
        deletePropOneAspectQS,
        400
      ); // missing aspect name
      ...
      assertEquals(1, returnedAspect.getProperties().size());
      assertFalse(
        "Property one should have been deleted.",
        aspectPropNameOne.equals(
          returnedAspect.getProperties().get(0).getName()
        )
      );
    ...
    {
      final String deletePropTwoTypeQS = getPropDeleteUpdateQS(
        typePropNameTwo,
        true
      );
      ...
      put(
        "cmm/" + modelName + "/types",
        typeName,
        RestApiUtil.toJsonAsString(deletePropTypePayload),
        deletePropTwoTypeQS,
        400
      ); // missing type name
      ...
      assertEquals(1, returnedType.getProperties().size());
      assertFalse(
        "Property two should have been deleted.",
        typePropNameTwo.equals(returnedType.getProperties().get(0).getName())
      );
    ...
    {
      setRequestContext(customModelAdmin);
      final String deletePropTwoAspectQS = getPropDeleteUpdateQS(
        aspectPropNameTwo,
        true
      );
      CustomAspect deletePropAspectPayload = new CustomAspect();
      ...
      assertEquals(
        "Property two should have been deleted.",
        0,
        returnedAspect.getProperties().size()
      );
    ...
    {
      final String deletePropOneTypeQS = getPropDeleteUpdateQS(
        typePropNameOne,
        true
      );
  ...
  public void testUpdateProperty() throws Exception {
    ...
    {
      final String updatePropOneAspectQS = getPropDeleteUpdateQS(
        aspectPropName,
        false
      );
      ...
      put(
        "cmm/" + modelName + "/aspects",
        aspectName,
        RestApiUtil.toJsonAsString(updatePropAspectPayload),
        updatePropOneAspectQS,
        400
      ); // missing aspect name
      ...
      assertEquals(1, returnedAspect.getProperties().size());
      CustomModelProperty modifiedAspectProperty = returnedAspect
        .getProperties()
        .get(0);
      compareCustomModelProperties(
        propertyAspect,
        modifiedAspectProperty,
        "prefixedName",
    ...
    {
      final String updatePropTwoTypeQS = getPropDeleteUpdateQS(
        typePropName,
        false
      );
      ...
      put(
        "cmm/" + modelName + "/types",
        typeName,
        RestApiUtil.toJsonAsString(updatePropTypePayload),
        updatePropTwoTypeQS,
        403
      );
      ...
      assertEquals(1, returnedType.getProperties().size());
      CustomModelProperty modifiedTypeProperty = returnedType
        .getProperties()
        .get(0);
      ...
      assertEquals(
        "Shouldn't be able to change the data type of the property of an active model.",
        "d:int",
        modifiedTypeProperty.getDataType()
      );
      ...
      CustomModelConstraint modifiedConstraint = modifiedTypeProperty
        .getConstraints()
        .get(0);
      assertEquals("MINMAX", modifiedConstraint.getType());
      assertEquals(
        "120.0",
        getParameterSimpleValue(modifiedConstraint.getParameters(), "maxValue")
      );
      assertEquals(
        "20.0",
        getParameterSimpleValue(modifiedConstraint.getParameters(), "minValue")
      );
      ...
      propertyType.setConstraints(
        Collections.<CustomModelConstraint>emptyList()
      );
      put(
        "cmm/" + modelName + "/types",
        typeName,
  ...
  public void testValidatePropertyDefaultValue() throws Exception {
    ...
    final String updatePropAspectQS = getPropDeleteUpdateQS(
      aspectPropName,
      false
    );
