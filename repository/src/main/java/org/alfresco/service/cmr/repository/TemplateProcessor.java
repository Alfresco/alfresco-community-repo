...
/**
 * Interface to be implemented by template engine wrapper classes. The developer is responsible for
 * interfacing to an appropriate template engine, using the supplied data model as input to the
 * template and directing the output to the Writer stream.
 *
 * @author Kevin Roast
 */
