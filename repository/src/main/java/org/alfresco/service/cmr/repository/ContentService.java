 ...
 * <p>
 * Whereas the content stores have no knowledge of nodes other than their references, the <code>ContentService</code> <b>is</b> responsible for ensuring that all the relevant node-content relationships are maintained.
 * 
...
public interface ContentService
{
     ...
     * 
     * @return Returns the total, possibly approximate, size (in bytes) of of the store or <tt>-1</tt> if no size data is available.
     * 
     * @since 3.3.3
     */
     ...
     * 
     * @return Returns the total, possibly approximate, remaining space (in bytes) available to store content or <tt>-1</tt> if no size data is available.
     * 
     * @since 3.3.3
     */
     ...
     * <p>
     * <tt>null</tt> is never returned, but the reader should always be checked for {@link ContentReader#exists() existence}.
     * 
     * @param contentUrl
     *            a content store URL
     ...
     * <p>
     * If a content URL is present for the given node then a reader <b>must</b> be returned. The {@link ContentReader#exists() exists} method should then be used to detect 'missing' content.
     * 
     * @param nodeRef
    ...
    /**
     * Get a content reader for the given node property, optionally firing the
     * {@link org.alfresco.repo.content.ContentServicePolicies.OnContentDownloadPolicy}
     * if the content is being downloaded as an attachment.
     *
     ...
     * @param attachment    {@code true} if the content is being downloaded (attachment), fires OnContentDownloadPolicy
     ...
     *
     * @param nodeRef
     *            Node ref for which to obtain the direct access {@code URL}.
     * @param attachment
