...
/**
 * Interface for Audit data value generators.These are used to produce auditable data values extract
 * auditable values from nothing; typically these values are derived from the system state or from
 * the thread context.
 *
 * <p><tt>null</tt> values will be ignored by the audit framework.
 *
 * @author Derek Hulley
 * @since 3.2
 */
