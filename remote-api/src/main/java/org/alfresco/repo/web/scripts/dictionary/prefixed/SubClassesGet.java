...
public class SubClassesGet extends AbstractSubClassesGet {
  ...
  @Override
  protected Collection<QName> getQNameCollection(
    ...
    String shortClassName = req
      .getServiceMatch()
      .getTemplateVars()
      .get(DICTIONARY_CLASS_SHORTNAME);
    ...
    if (isValidClassname(prefix, shortClassName) == true) {
      classQName =
        QName.createQName(getFullNamespaceURI(prefix, shortClassName));
