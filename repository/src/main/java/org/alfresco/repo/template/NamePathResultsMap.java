...
public class NamePathResultsMap extends BasePathResultsMap {
    ...
    public Object get(Object key) {
        ...
        if (this.services
                ...
                .isSubClass(parent.getType(), org.alfresco.model.ContentModel.TYPE_FOLDER)) {
            NodeRef result =
            ...
            return (result != null
                    ? new TemplateNode(result, this.services, this.parent.getImageResolver())
                    : null);
        }
        ...
        while (t.hasMoreTokens()) {
            ...
            params[count++] =
                    new QueryParameterDefImpl(
                            QName.createQName(
                                    NamespaceService.CONTENT_MODEL_PREFIX, "name" + strCount, ns),
                            ddText,
                            true,
                            t.nextToken());
        }
