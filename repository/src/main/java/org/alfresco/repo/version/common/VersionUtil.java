...
public class VersionUtil {
    ...
    /**
     * Checks that the names of the additional version properties are valid and that they do not
     * clash with the reserved properties.
     *
    ...
    public static void convertFrozenToOriginalProps(Map<QName, Serializable> props)
