 ...
 *
 * <p>Currently supports one value or a cache per key (such as tenant.) Implementors just need to
 * provide buildCache(String key/tennnantId)
 *
 * @author Andy
 * @since 4.1.3
 * @author mrogers MER 17/04/2014 Refactored to core and generalised tennancy
 */
public abstract class AbstractAsynchronouslyRefreshedCache<T>
    ...
    /**
     * Build the cache entry for the specific key. This method is called in a thread-safe manner
