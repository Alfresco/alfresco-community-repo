...
public class GetTaskFormModelTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user gets all task form models with Rest API and response is"
                            + " successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user involved in task gets all the task form models with Rest API and"
    ...
    @TestRail(
            ...
            description =
                    "Verify that non involved user in task cannot get form models with Rest API and"
                            + " response is FORBIDDEN (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user involved in task cannot get task form models with invalid task id")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    public void getTaskFormModelsInvalidTaskId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, "0000"));
    }
    ...
    public void getTaskFormModelsForCompletedTask() throws Exception {
        ...
        taskModel =
                dataWorkflow
                        ...
                        .usingSite(siteModel)
                        .usingResource(fileModel)
                        .createNewTaskAndAssignTo(assignedUser);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user gets all task form models with properties parameter applied"
    ...
    public void adminGetsTaskFormModelsWithPropertiesParameter() throws Exception {
        ...
        returnedCollection =
                restClient
                        ...
                        .withParams("properties=qualifiedName,required")
                        .withWorkflowAPI()
                        .usingTask(taskModel)
                        .getTaskFormModel();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin gets task form model with valid skipCount parameter applied using"
                            + " REST API and status code is OK (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    public void getTaskFormModelWithValidSkipCount() throws Exception {
        ...
        RestFormModelsCollection formModelsWithSkipCount =
                restClient
        ...
        formModelsWithSkipCount
                .assertThat()
                .entriesListDoesNotContain("name", firstTaskFormModel.getName())
                .assertThat()
                .entriesListDoesNotContain("name", secondTaskFormModel.getName())
                .assertThat()
                .entriesListCountIs(returnedCollection.getEntries().size() - 2);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin doesn't get task form model with negative skipCount parameter"
                            + " applied using REST API")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin doesn't get task form model with non numeric skipCount parameter"
                            + " applied using REST API")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin gets task form model with valid maxItems parameter applied using"
                            + " REST API and status code is OK (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    public void getTaskFormModelWithValidMaxItems() throws Exception {
        ...
        RestFormModelsCollection formModelsWithMaxItems =
                restClient
        ...
        formModelsWithMaxItems
                .assertThat()
                .entriesListContains("name", firstTaskFormModel.getName())
                .assertThat()
                .entriesListContains("name", secondTaskFormModel.getName())
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin doesn't get task form model with negative maxItems parameter"
                            + " applied using REST API")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin doesn't get task form model with non numeric maxItems parameter"
                            + " applied using REST API")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
