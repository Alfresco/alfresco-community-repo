...
public class PublicApiClient {
    ...
    public CmisSession createPublicApiCMISSession(
            Binding binding, String version, String objectFactoryName) {
        ...
        if (userData != null) {
            ...
            if (binding == Binding.atom) {
                parameters.put(
                        ...
                        client.getPublicApiCmisUrl(networkId, binding, version, null));
    ...
    public CmisSession createCMISSession(String repositoryId, String username, String password) {
        ...
        parameters.put(
                SessionParameter.OBJECT_FACTORY_CLASS, AlfrescoObjectFactoryImpl.class.getName());
    ...
    public HttpResponse post(Binding cmisBinding, String version, String cmisOperation, String body)
            throws PublicApiException {
        try {
            HttpResponse response =
                    client.post(getRequestContext(), cmisBinding, version, cmisOperation, body);
    ...
    public HttpResponse put(Binding cmisBinding, String version, String cmisOperation, String body)
            throws PublicApiException {
        try {
            HttpResponse response =
                    client.put(getRequestContext(), cmisBinding, version, cmisOperation, body);
    ...
    public HttpResponse get(
            Binding cmisBinding,
            String version,
            String cmisOperation,
            Map<String, String> parameters)
            throws PublicApiException {
        try {
            HttpResponse response =
                    client.get(
                            getRequestContext(), cmisBinding, version, cmisOperation, parameters);
    ...
    public HttpResponse patch(
        ...
        try {
            HttpResponse response =
                    client.patch(getRequestContext(), cmisBinding, version, cmisOperation);
    ...
    public HttpResponse trace(
        ...
        try {
            HttpResponse response =
                    client.trace(getRequestContext(), cmisBinding, version, cmisOperation);
    ...
    public HttpResponse options(
        ...
        try {
            HttpResponse response =
                    client.options(getRequestContext(), cmisBinding, version, cmisOperation);
    ...
    public HttpResponse head(
        ...
        try {
            HttpResponse response =
                    client.head(getRequestContext(), cmisBinding, version, cmisOperation);
    ...
    public HttpResponse post(
            ...
            Object entityId,
            String relationCollectionName,
            Object relationshipEntityId,
            String body)
            throws IOException {
        HttpResponse response =
                client.post(
                        ...
                        relationshipEntityId != null ? relationshipEntityId.toString() : null,
                        body);
    ...
    public HttpResponse post(
            final Class<?> c, Object entityId, Object relationshipEntityId, String body)
            throws IOException {
        HttpResponse response =
                client.post(c, getRequestContext(), entityId, relationshipEntityId, body);
    ...
    public HttpResponse getWithPassword(
            String scope,
            String password,
            String entityCollectionName,
            Object entityId,
    ...
    public HttpResponse get(
            ...
            final Object relationshipEntityId,
            Map<String, String> params)
            throws IOException {
        HttpResponse response =
                client.get(c, getRequestContext(), entityId, relationshipEntityId, params);
    ...
    public HttpResponse put(
            ...
            throws IOException {
        HttpResponse response =
                client.put(c, getRequestContext(), entityId, relationshipEntityId, body);
    ...
    public HttpResponse put(final Class<?> c, Object entityId, Object relationshipEntityId)
            throws IOException {
        HttpResponse response =
                client.delete(c, getRequestContext(), entityId, relationshipEntityId);
    ...
    public List<String> getNetworkIds(String version) {
        ...
        parameters.put(
                SessionParameter.ATOMPUB_URL,
                client.getPublicApiCmisUrl(null, Binding.atom, version, null));
        parameters.put(SessionParameter.BINDING_TYPE, BindingType.ATOMPUB.value());
    ...
    public class AbstractProxy {
        ...
        public void checkStatus(String errorMessage, int expectedStatus, HttpResponse response)
                throws PublicApiException {
        ...
        public void checkErrorKeyResponse(
                String errorMessage, int expectedStatus, HttpResponse response)
                throws PublicApiException {
            ...
            if (errorKey != null && errorKey.contains("exception")) {
                ...
                List<RestErrorResponseDefault> httpErrorsFilteredByStatusCode =
                        Arrays.asList(RestErrorResponseDefault.values()).stream()
                                .filter(
                                        t ->
                                                t.getStatusCode() == expectedStatus
                                                        && t.getDefaultMessage() != null)
                                .collect(Collectors.toList());

                httpErrorsFilteredByStatusCode.add(RestErrorResponseDefault.DEFAULT_API_EXCEPTION);

                for (RestErrorResponseDefault errorResponseDefault :
                        httpErrorsFilteredByStatusCode) {
    ...
    public class Sites extends AbstractProxy {
        public ListResponse<Site> getSites(Map<String, String> params) throws PublicApiException {
            HttpResponse response =
                    getAll("sites", null, null, null, params, "Failed to get sites");
        ...
        public Site createSite(Site site, int expectedStatus) throws PublicApiException {
            HttpResponse response =
                    create(
                            ...
                            null,
                            null,
                            site.toJSON().toString(),
                            "Failed to create site " + site.getTitle(),
                            expectedStatus);
            return SiteImpl.parseSite((JSONObject) response.getJsonResponse().get("entry"));
        }
        ...
        public void removeSite(String siteId, boolean permanent, int expectedStatus)
                throws PublicApiException {
        ...
        public Site updateSite(String siteId, SiteUpdate update, int expectedStatus)
                throws PublicApiException {
            ...
            HttpResponse response =
                    update(
                            ...
                            null,
                            null,
                            jsonizer.toJSON().toString(),
                            null,
                            "Failed to update site " + update.getTitle(),
                            expectedStatus);
        ...
        public ListResponse<SiteContainer> getSiteContainers(
                String siteId, Map<String, String> params) throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "sites",
                            siteId,
                            ...
                            null,
                            params,
                            "Failed to get site containers");
            return SiteContainer.parseSiteContainers(response.getJsonResponse());
        }

        public SiteContainer getSingleSiteContainer(String siteId, String containerId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "sites",
                            ...
                            "containers",
                            containerId,
                            "Failed to get site container");
            SiteContainer siteContainer =
                    SiteContainer.parseSiteContainer(
                            siteId, (JSONObject) response.getJsonResponse().get("entry"));
            return siteContainer;
        }

        public SiteContainer updateSiteContainer(SiteContainer siteContainer)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "sites",
                            siteContainer.getSiteId(),
                            "containers",
                            siteContainer.getId(),
                            siteContainer.toJSON().toString(),
                            "Failed to update site container");
            SiteContainer retSiteContainer =
                    SiteContainer.parseSiteContainer(
                            siteContainer.getSiteId(),
                            (JSONObject) response.getJsonResponse().get("entry"));
            return retSiteContainer;
        }

        public SiteContainer createSiteContainer(SiteContainer siteContainer)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "sites",
                            ...
                            null,
                            siteContainer.toJSON().toString(),
                            "Failed to create site container");
            SiteContainer retSiteContainer =
                    SiteContainer.parseSiteContainer(
                            siteContainer.getSiteId(),
                            (JSONObject) response.getJsonResponse().get("entry"));
        ...
        public void removeSiteContainer(SiteContainer siteContainer) throws PublicApiException {
            remove(
                    ...
                    "containers",
                    siteContainer.getId(),
                    "Failed to remove site container");
        }

        public ListResponse<SiteMember> getSiteMembers(String siteId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "sites",
        ...
        public SiteMember getSingleSiteMember(String siteId, String personId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle("sites", siteId, "members", personId, "Failed to get site member");
            SiteMember retSiteMember =
                    SiteMember.parseSiteMember(
                            siteId, (JSONObject) response.getJsonResponse().get("entry"));
        ...
        public SiteMember updateSiteMember(String siteId, SiteMember siteMember)
            ...
            HttpResponse response =
                    update(
                            ...
                            siteId,
                            "members",
                            siteMember.getMemberId(),
                            siteMember.toJSON().toString(),
                            "Failed to update site member");
            SiteMember retSiteMember =
                    SiteMember.parseSiteMember(
                            siteMember.getSiteId(),
                            (JSONObject) response.getJsonResponse().get("entry"));
            return retSiteMember;
        }

        public SiteMember createSiteMember(String siteId, SiteMember siteMember)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "sites",
        ...
        public void removeSiteMember(String siteId, SiteMember siteMember)
                throws PublicApiException {
            remove(
                    "sites",
                    siteId,
                    "members",
                    siteMember.getMemberId(),
                    "Failed to remove site member");
        }

        public ListResponse<MemberOfSite> getPersonSites(
                String personId, Map<String, String> params) throws PublicApiException {
            HttpResponse response =
                    getAll("people", personId, "sites", null, params, "Failed to get person sites");
            return MemberOfSite.parseMemberOfSites(response.getJsonResponse());
        }

        public MemberOfSite getPersonSite(String personId, String siteId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "people",
                            ...
                            "sites",
                            siteId,
                            "Failed to get person site" + siteId);
            return MemberOfSite.parseMemberOfSite(
                    (JSONObject) response.getJsonResponse().get("entry"));
        }

        public MemberOfSite updatePersonSite(String personId, SiteMember siteMember)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "people",
                            ...
                            siteMember.getSiteId(),
                            siteMember.toJSON().toString(),
                            "Failed to update person site");
            MemberOfSite retSiteMember =
                    MemberOfSite.parseMemberOfSite(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return retSiteMember;
        }

        public MemberOfSite createPersonSite(String personId, SiteMember siteMember)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "people",
        ...
        public void removePersonSite(String personId, SiteMember siteMember)
                throws PublicApiException {
            remove(
                    "people",
                    personId,
                    "sites",
                    siteMember.getSiteId(),
                    "Failed to remove person site");
        }

        public ListResponse<FavouriteSite> getFavouriteSites(
                String personId, Map<String, String> params) throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "people",
                            ...
                            null,
                            params,
                            "Failed to get favourite sites");
            return FavouriteSite.parseFavouriteSites(response.getJsonResponse());
        }

        public FavouriteSite getSingleFavouriteSite(String personId, String siteId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "people",
                            ...
                            "favorite-sites",
                            siteId,
                            "Failed to get favourite site");
            FavouriteSite favouriteSite =
                    FavouriteSite.parseFavouriteSite(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return favouriteSite;
        }

        public FavouriteSite updateFavouriteSite(String personId, FavouriteSite site)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "people",
                            ...
                            site.getSiteId(),
                            site.toJSON().toString(),
                            "Failed to update favourite site");
            FavouriteSite favouriteSite =
                    FavouriteSite.parseFavouriteSite(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return favouriteSite;
        ...
        public FavouriteSite createFavouriteSite(String personId, FavouriteSite site)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "people",
                            ...
                            null,
                            site.toJSON().toString(),
                            "Failed to create favourite site");
            FavouriteSite favouriteSite =
                    FavouriteSite.parseFavouriteSite(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return favouriteSite;
        ...
        public void removeFavouriteSite(String personId, FavouriteSite site)
                throws PublicApiException {
            remove(
                    "people",
                    personId,
                    "favorite-sites",
                    site.getSiteId(),
                    "Failed to remove favourite site");
        }
        ...
        public SiteGroup addGroup(String siteId, SiteGroup group) throws PublicApiException {
            HttpResponse response =
                    create(
                            ...
                            "Failed to add site groups");
            return SiteGroup.parseSiteGroup(
                    siteId, (JSONObject) response.getJsonResponse().get("entry"));
        }

        public ListResponse<SiteGroup> getGroups(String siteId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "sites",
                            ...
                            null,
                            params,
                            "Failed to fetch all site groups");
    ...
    public class SiteMembershipRequests extends AbstractProxy {
        public SiteMembershipRequest getSiteMembershipRequest(String personId, String siteId)
            ...
            HttpResponse response =
                    getSingle(
                            ...
                            siteId,
                            "Failed to get siteMembershipRequest");
            return SiteMembershipRequest.parseSiteMembershipRequest(
                    (JSONObject) response.getJsonResponse().get("entry"));
        }

        public ListResponse<SiteMembershipRequest> getSiteMembershipRequests(
                String personId, Map<String, String> params)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll(
                            "people",
                            ...
                            null,
                            params,
                            "Failed to get siteMembershipRequests");
            return SiteMembershipRequest.parseSiteMembershipRequests(response.getJsonResponse());
        }

        public SiteMembershipRequest createSiteMembershipRequest(
                String personId, SiteMembershipRequest siteMembershipRequest)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    create(
                            "people",
                            ...
                            "site-membership-requests",
                            null,
                            siteMembershipRequest.toJSON().toString(),
                            "Failed to create siteMembershipRequest");
            SiteMembershipRequest ret =
                    SiteMembershipRequest.parseSiteMembershipRequest(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return ret;
        }

        public SiteMembershipRequest updateSiteMembershipRequest(
                String personId, SiteMembershipRequest siteMembershipRequest)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    update(
                            ...
                            siteMembershipRequest.toJSON().toString(),
                            "Failed to update siteMembershipRequest");
            SiteMembershipRequest ret =
                    SiteMembershipRequest.parseSiteMembershipRequest(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return ret;
        ...
        public void cancelSiteMembershipRequest(String personId, String siteMembershipRequestId)
                throws PublicApiException {
            remove(
                    "people",
                    personId,
                    "site-membership-requests",
                    siteMembershipRequestId,
                    "Failed to cancel siteMembershipRequest");
        }

        public ListResponse<SiteMembershipRequest> getSiteMembershipRequests(
                Map<String, String> params, String errorMessage, int expectedStatus)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll(
                            "site-membership-requests",
            ...
            if (response != null && response.getJsonResponse() != null) {
                ...
                if (jsonList != null) {
                    return SiteMembershipRequest.parseSiteMembershipRequests(
    ...
    public class Favourites extends AbstractProxy {
        public ListResponse<Favourite> getFavourites(String personId, Map<String, String> params)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll(
                            "people",
        ...
        public Favourite getFavourite(String personId, String favouriteId)
            ...
            HttpResponse response =
                    getSingle(
                            ...
                            "favorites",
                            favouriteId,
                            "Failed to get favourite " + favouriteId);
            return Favourite.parseFavourite((JSONObject) response.getJsonResponse().get("entry"));
        }

        public Favourite getFavourite(
                String personId, String favouriteId, Map<String, String> params)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getSingle(
                            "people",
        ...
        public Favourite createFavourite(String personId, Favourite favourite)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    create(
                            "people",
                            ...
                            "favorites",
                            null,
                            favourite.toJSON().toString(),
                            "Failed to create favourite");
            Favourite ret =
                    Favourite.parseFavourite((JSONObject) response.getJsonResponse().get("entry"));
            return ret;
        }

        public Favourite createFavourite(
                String personId, Favourite favourite, Map<String, String> params)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    create(
                            "people",
    ...
    public class People extends AbstractProxy {
        public ListResponse<Person> getPeople(Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("people", null, null, null, params, "Failed to get people");
        ...
        public Person getPerson(String personId, int expectedStatus) throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "people", personId, null, null, "Failed to get person", expectedStatus);
        ...
        public Person update(String personId, Person person, int expectedStatus)
                throws PublicApiException {
            return update(personId, person.toJSON(true).toString(), expectedStatus);
        }

        public Person update(String personId, String json, int expectedStatus)
                throws PublicApiException {
            return update(personId, json, null, expectedStatus);
        }

        public Person update(
                String personId, String json, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "people",
        ...
        public ListResponse<Preference> getPreferences(String personId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "people",
        ...
        public Preference getPreference(String personId, String preferenceId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "people",
                            ...
                            "preferences",
                            preferenceId,
                            "Failed to get person preference");
            Preference pref =
        ...
        public Person updatePreference(String personId, Preference preference)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "people",
        ...
        public Person createPreference(String personId, Preference preference)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "people",
                            ...
                            null,
                            preference.toJSON().toString(),
                            "Failed to create person preference");
            Person retSite =
                    Person.parsePerson((JSONObject) response.getJsonResponse().get("entry"));
            return retSite;
        }

        public void removePreference(String personId, Preference preference)
                throws PublicApiException {
            remove(
                    "people",
                    personId,
        ...
        public ListResponse<PersonNetwork> getNetworkMemberships(
                String personId, Map<String, String> params) throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "people",
                            ...
                            null,
                            params,
                            "Failed to get network members");
            return PersonNetwork.parseNetworkMembers(response.getJsonResponse());
        }

        public PersonNetwork getNetworkMembership(String personId, String networkId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "people",
                            ...
                            "networks",
                            networkId,
                            "Failed to get network member");
            PersonNetwork networkMember =
        ...
        public PersonNetwork updateNetworkMembership(String personId, PersonNetwork networkMember)
            ...
            HttpResponse response =
                    update(
                            ...
                            "networks",
                            networkMember.getId(),
                            networkMember.toJSON().toString(),
                            "Failed to update network member");
            PersonNetwork retNetwork =
                    PersonNetwork.parseNetworkMember(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return retNetwork;
        }

        public PersonNetwork createNetworkMembership(String personId, PersonNetwork network)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "people",
                            ...
                            "networks",
                            null,
                            network.toJSON().toString(),
                            "Failed to create network member");
            PersonNetwork retNetwork =
                    PersonNetwork.parseNetworkMember(
                            (JSONObject) response.getJsonResponse().get("entry"));
            return retNetwork;
        ...
        public void removeNetworkMembership(String personId, PersonNetwork networkMember)
                throws PublicApiException {
            remove(
                    "people",
                    personId,
                    "networks",
                    networkMember.getId(),
                    "Failed to remove network member");
        }

        public ListResponse<Activity> getActivities(String personId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "people",
        ...
        public Activity getSingleActivity(String personId, String activityId)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "people",
                            ...
                            "Failed to get activities");
            Activity activity =
                    Activity.parseActivity((JSONObject) response.getJsonResponse().get("entry"));
            return activity;
        }
        ...
        public HttpResponse getAvatar(String personId, boolean placeholder, int expectedStatus)
                throws PublicApiException, InterruptedException {
            return getAvatar(personId, null, placeholder, null, expectedStatus);
        }

        public HttpResponse getAvatar(String personId, String ifModifiedSince, int expectedStatus)
                throws PublicApiException, InterruptedException {
            return getAvatar(personId, null, false, ifModifiedSince, expectedStatus);
        }

        public HttpResponse getAvatar(
                String personId,
                Boolean attachment,
                boolean placeholder,
        ...
        public HttpResponse updateAvatar(String personId, File avatar, int expectedStatus)
                throws PublicApiException {
            try {
                Map<String, String> params = new HashMap<>();
        ...
        public void deleteAvatarImage(String personId, int expectedStatus)
                throws PublicApiException {
            remove(
                    "people",
                    personId,
                    ...
                    null,
                    null,
                    "Failed to remove avatar image",
                    expectedStatus);
        }
    }

    public class Comments extends AbstractProxy {
        public ListResponse<Comment> getTenantComments(Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("comments", null, null, null, params, "Failed to get comments");
        ...
        public Comment getTenantComment(String commentId) throws PublicApiException {
            HttpResponse response =
                    getSingle("comments", commentId, null, null, "Failed to get comment");
            Comment comment =
                    Comment.parseComment(
                            null, (JSONObject) response.getJsonResponse().get("entry"));
            return comment;
        }
        ...
        public ListResponse<Comment> getNodeComments(String nodeId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("nodes", nodeId, "comments", null, params, "Failed to get comments");
        ...
        public Comment getNodeComment(String nodeId) throws PublicApiException {
            ...
            Comment comment =
                    Comment.parseComment(
                            nodeId, (JSONObject) response.getJsonResponse().get("entry"));
            return comment;
        }

        public Comment updateNodeComment(String nodeId, String commentId, Comment comment)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "nodes",
    ...
    public class Tags extends AbstractProxy {
        ...
        //		{
        //			HttpResponse response = create("tags", tag.getTagId(), null, null,
        // tag.toJSON().toString(), "Failed to create tag");
        //			Tag retTag = Tag.parseTag(null, (JSONObject)response.getJsonResponse().get("entry"));
        //			return retTag;
        //		}
    ...
    public class Nodes extends AbstractProxy {
        public ListResponse<Tag> getNodeTags(String nodeId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("nodes", nodeId, "tags", null, params, "Failed to get node tags");
        ...
        public NodeRating getNodeRating(String nodeId, String ratingId) throws PublicApiException {
            HttpResponse response =
                    getSingle("nodes", nodeId, "ratings", ratingId, "Failed to get node ratings");
            return NodeRating.parseNodeRating(
                    nodeId, (JSONObject) response.getJsonResponse().get("entry"));
        }

        public ListResponse<NodeRating> getNodeRatings(String nodeId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("nodes", nodeId, "ratings", null, params, "Failed to get node ratings");
            return NodeRating.parseNodeRatings(nodeId, response.getJsonResponse());
        }

        public NodeRating updateNodeRating(String nodeId, NodeRating nodeRating)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "nodes",
                            ...
                            "ratings",
                            nodeRating.getId(),
                            nodeRating.toJSON().toString(),
                            "Failed to update node rating");
            NodeRating nodeRatingRet =
                    NodeRating.parseNodeRating(
                            nodeId, (JSONObject) response.getJsonResponse().get("entry"));
            return nodeRatingRet;
        }

        public NodeRating createNodeRating(String nodeId, NodeRating nodeRating)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "nodes",
    ...
    public class Aspects extends AbstractProxy {
        public PublicApiClient.ListResponse<Aspect> getAspects(Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("aspects", null, null, null, params, "Failed to get aspects");
            return Aspect.parseAspects(response.getJsonResponse());
        }

        public Aspect getAspect(String aspectId) throws PublicApiException {
            HttpResponse response =
                    getAll("aspects", aspectId, null, null, null, "Failed to get aspect");
            return Aspect.parseAspect((JSONObject) response.getJsonResponse().get("entry"));
        }
    }

    public class Types extends AbstractProxy {
        public PublicApiClient.ListResponse<Type> getTypes(Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll("types", null, null, null, params, "Failed to get types");
    ...
    public static class ExpectedPaging {
        ...
        public ExpectedPaging(
                int skipCount, int maxItems, Integer totalItems, boolean hasMoreItems, int count) {
            super();
        ...
        public boolean equals(Object obj) {
            ...
            if (totalItems == null) {
                if (other.totalItems != null) return false;
            } else if (!totalItems.equals(other.totalItems)) return false;
            return true;
        }
        ...
        public static ExpectedPaging getExpectedPaging(
                Integer skipCount, Integer maxItems, int total, Integer expectedTotal) {
            int skip =
                    skipCount != null
                            ? skipCount
            ...
            ExpectedPaging expectedPaging =
                    new ExpectedPaging(skip, max, expectedTotal, hasMore, expectedCount);
    ...
    public class CmisSession {
        ...
        public List<Folder> getObjectParents(String objectId) {
            ...
            if (o instanceof FileableCmisObject) {
                ...
                throw new IllegalArgumentException(
                        "Object does not exist or is not a fileable cmis object");
            }
        }
        ...
        public void putContent(
            ...
            if (o instanceof Document) {
                ...
                ContentStream contentStream =
                        new ContentStreamImpl(filename, length, mimetype, content);
                try {
        ...
        public ItemIterable<ObjectType> getTypeChildren(
                String typeId, boolean includePropertyDefinitions) {
            ItemIterable<ObjectType> res =
                    session.getTypeChildren(typeId, includePropertyDefinitions);
            return res;
        }

        public List<Tree<ObjectType>> getTypeDescendants(
                String typeId, int depth, boolean includePropertyDefinitions) {
            List<Tree<ObjectType>> res =
                    session.getTypeDescendants(typeId, depth, includePropertyDefinitions);
            return res;
        }
        ...
        public List<CMISNode> query(
                String query, boolean searchAllVersions, long skipCount, int maxItems) {
        ...
        public Folder createFolder(
                String folderId, String name, Map<String, Serializable> properties) {
    ...
    public static class Paging {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((skipCount == null) ? 0 : skipCount.hashCode());
            return result;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (skipCount == null) {
                if (other.skipCount != null) return false;
            } else if (!skipCount.equals(other.skipCount)) return false;
            return true;
        }
    ...
    public static class ExpectedErrorResponse {
        ...
        public String toString() {
            ...
            sb.append("ExpectedErrorResponse [errorKey='")
                    ...
                    .append(", stackTrace='")
                    .append(stackTrace)
                    .append(", additionalState=")
                    .append(additionalState)
                    .append(", descriptionURL='")
                    .append(descriptionURL)
                    .append(']');
            return sb.toString();
        }
    ...
    public class Groups extends AbstractProxy {
        ...
        public Group createGroup(Group group, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "groups",
                            ...
                            null,
                            group.toJSON().toString(),
                            "Failed to create group " + group.getId(),
                            expectedStatus,
                            params);
        ...
        public GroupMember createGroupMember(
                String groupId, GroupMember groupMember, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "groups",
        ...
        public Group updateGroup(
                String groupId, Group group, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "groups",
                            ...
                            group.toJSON().toString(),
                            params,
                            "Failed to update group " + group.getId(),
                            expectedStatus);
            return parseGroupEntity(response);
        }
        ...
        public Group getGroup(String groupId, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "groups",
        ...
        public void deleteGroup(String groupId, boolean cascade, int expectedStatus)
                throws PublicApiException {
            Map<String, String> params = null;
            if (cascade) {
        ...
        public void deleteGroupMembership(String groupId, String groupMemberId, int expectedStatus)
                throws PublicApiException {
            remove(
                    "groups",
                    groupId,
        ...
        public ListResponse<Group> getGroups(
                ...
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll("groups", null, null, null, params, errorMessage, expectedStatus);
        ...
        public ListResponse<GroupMember> getGroupMembers(String groupId, Map<String, String> params)
                throws PublicApiException, ParseException {
            return getGroupMembers(
                    groupId, params, "Failed to get groups", HttpServletResponse.SC_OK);
        }

        public ListResponse<GroupMember> getGroupMembers(
                String groupId, Map<String, String> params, String errorMessage, int expectedStatus)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll(
                            "groups",
        ...
        public ListResponse<Group> getGroupsByPersonId(
                String userId, Map<String, String> params, String errorMessage, int expectedStatus)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll("people", userId, "groups", null, params, errorMessage, expectedStatus);
    ...
    public class AuditApps extends AbstractProxy {
        ...
        public ListResponse<AuditApp> getAuditApps(
                Map<String, String> params, String errorMessage, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
        ...
        public AuditApp getAuditApp(String applicationId, int expectedStatus)
                throws PublicApiException {
            return getAuditApp(applicationId, null, expectedStatus);
        }

        public AuditApp getAuditApp(
                String applicationId, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "audit-applications",
                            ...
                            null,
                            params,
                            "Failed to get Audit Application " + applicationId,
                            expectedStatus);
        ...
        public AuditApp updateAuditApp(
        ...
        public ListResponse<AuditEntry> getAuditAppEntries(
                String applicationId, Map<String, String> params, int expectedStatus)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll(
                            ...
                            null,
                            params,
                            "Failed to get audit entries for " + applicationId,
                            expectedStatus);
        ...
        public AuditEntry getAuditEntry(
                String applicationId, String entryId, Map<String, String> param, int expectedStatus)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getSingle(
                            "audit-applications",
        ...
        public void deleteAuditEntries(
                String applicationId, Map<String, String> param, int expectedStatus)
                throws PublicApiException {
            remove(
                    "audit-applications",
                    applicationId,
                    ...
                    null,
                    param,
                    "Failed to delete entries for audit application " + applicationId,
                    expectedStatus);
        }

        public ListResponse<AuditEntry> getAuditAppEntriesByNodeRefId(
                String nodeId, Map<String, String> params, int expectedStatus)
                throws PublicApiException, ParseException {
            HttpResponse response =
                    getAll(
                            "nodes",
                            ...
                            null,
                            params,
                            "Failed to get audit entries for " + nodeId,
                            expectedStatus);
    ...
    public class Actions extends AbstractProxy {
        public ListResponse<ActionDefinition> getActionDefinitionsForNode(
                String nodeId, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
        ...
        public ListResponse<ActionDefinition> getActionDefinitions(
                Map<String, String> params, int expectedStatus) throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "action-definitions",
                            null,
        ...
        public Action executeAction(Action action, Map<String, String> params, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    create(
                            "action-executions",
                            ...
                            "Failed to create action for action def "
        ...
        public ActionDefinition getActionDefinition(String actionDefinitionId, int expectedStatus)
                throws PublicApiException {
            HttpResponse response =
                    getSingle(
                            "action-definitions",
