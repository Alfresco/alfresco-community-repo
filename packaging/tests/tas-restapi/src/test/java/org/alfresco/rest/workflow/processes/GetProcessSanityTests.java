...
public class GetProcessSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user is able to get the process started by him using REST API and"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user is able to get the process assigned to him using REST API and"
                            + " status code is OK (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.PROCESSES, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify admin is able to get any process using REST API and status code is OK"
                            + " (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.PROCESSES, TestGroup.SANITY})
