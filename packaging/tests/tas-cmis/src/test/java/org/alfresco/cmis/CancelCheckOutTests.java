...
public class CancelCheckOutTests extends CmisTest {
  ...
  public void cancelCheckOutOnDocWithVersioningStateCheckedOut()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void collaboratorCanCancelCheckInDocumentCreatedBySelf()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanCancelCheckInDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorCanCancelCheckInDocumentCreatedBySelf()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(
