...
public class PolicyComponentTest extends TestCase {
  ...
  public void testPropertyDelegate() {
    // Register Policy
    PropertyPolicyDelegate<TestPropertyPolicy> delegate = policyComponent.registerPropertyPolicy(
      TestPropertyPolicy.class
    );
    ...
    // Test NOOP Policy delegate
    Collection<TestPropertyPolicy> basePolicies = delegate.getList(
      BASE_TYPE,
      BASE_PROP_A
    );
    assertNotNull(basePolicies);
    ...
    // Test single Policy delegate
    Collection<TestPropertyPolicy> filePolicies = delegate.getList(
      FILE_TYPE,
      FILE_PROP_B
    );
    assertNotNull(filePolicies);
    ...
    // Test multi Policy delegate
    Collection<TestPropertyPolicy> file2Policies = delegate.getList(
      FILE_TYPE,
      FILE_PROP_B
    );
    assertNotNull(file2Policies);
  ...
  public void testAssociationDelegate() {
    // Register Policy
    AssociationPolicyDelegate<TestAssociationPolicy> delegate = policyComponent.registerAssociationPolicy(
      TestAssociationPolicy.class
    );
    ...
    // Test single Policy delegate
    Collection<TestAssociationPolicy> filePolicies = delegate.getList(
      FILE_TYPE,
      BASE_ASSOC_A
    );
    assertNotNull(filePolicies);
    ...
    // Test multi Policy delegate
    Collection<TestAssociationPolicy> file2Policies = delegate.getList(
      FILE_TYPE,
      BASE_ASSOC_A
    );
    assertNotNull(file2Policies);
