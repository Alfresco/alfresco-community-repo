...
public class RemoveObjectFromFolderTests extends CmisTest {
  ...
  public void siteManagerShouldNotRemoveInvalidFileFromFolder()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
  ...
  public void siteManagerShouldNotRemoveFileToInvalidFolder() throws Exception {
    ...
    cmisApi
      ...
      .existsInRepo()
      .when()
      .removeDocumentFromFolder(invalidFolder)
      .assertThat()
      .doesNotExistInRepo()
      .usingResource(testFile)
      .assertThat()
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorCanRemoveDocumentFromFolderCreatedBySelf()
    throws Exception {
    parentFolder =
      dataContent
  ...
  public void contributorCannotRemoveDocumentFromFolderCreatedByManager()
    throws Exception {
    parentFolder =
      dataContent.usingUser(siteManager).usingSite(publicSite).createFolder();
    testFolder =
      dataContent.usingUser(siteManager).usingSite(publicSite).createFolder();
    testFile =
      dataContent
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanRemoveDocumentFromFolderCreatedBySelf()
    throws Exception {
    parentFolder =
      dataContent
  ...
  public void collaboratorCannotRemoveDocumentFromFolderCreatedByManager()
    throws Exception {
    parentFolder =
      dataContent.usingUser(siteManager).usingSite(publicSite).createFolder();
    testFolder =
  ...
  public void unauthorizedUserCannotRemoveDocumentFromPrivateSite()
    throws Exception {
    SiteModel privateSite = dataSite
      .usingUser(siteManager)
      .createPrivateRandomSite();
    parentFolder =
      dataContent.usingUser(siteManager).usingSite(privateSite).createFolder();
    testFolder =
      dataContent.usingUser(siteManager).usingSite(privateSite).createFolder();
    testFile =
      dataContent
  ...
  public void unauthorizedUserCannotRemoveDocumentFromModeratedSite()
    throws Exception {
