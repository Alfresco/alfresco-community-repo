...
public class ReportServiceImplTest extends BaseRMTestCase implements ReportModel {
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        assertEquals(
                                TYPE_DESTRUCTION_REPORT,
                                nodeService.getType(destructionReportNodeRef));
                        ...
                        assertEquals(
                                TYPE_TRANSFER_REPORT, nodeService.getType(transferReportNodeRef));
    ...
    private NodeRef fileTransferReport() {
        Report transferReport =
                reportService.generateReport(
                        TYPE_TRANSFER_REPORT, getTransferObject(), MimetypeMap.MIMETYPE_HTML);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        rmActionService.executeRecordsManagementAction(
                                rmFolder, FileReportAction.NAME, fileReportParams);
                        return null;
                    }
                });
    }
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        RecordsManagementActionResult transferReportAction =
                                rmActionService.executeRecordsManagementAction(
                                        getTransferObject(), FileReportAction.NAME, params);
    ...
    private NodeRef getTransferObject() {
        ...
        NodeRef recordFolder =
                recordFolderService.createRecordFolder(recordCategory, GUID.generate());

        // Set the record folder identifier
        String identifier =
                identifierService.generateIdentifier(TYPE_RECORD_FOLDER, recordCategory);
        ...
        // Transfer folder
        RecordsManagementActionResult transferAction =
