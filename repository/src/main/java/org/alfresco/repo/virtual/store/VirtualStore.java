 ...
 *
 * <p>Handles most virtualized {@link Reference} meta-data interactions analogous to actual Alfresco
...
public interface VirtualStore {
    ...
    Collection<NodeRef> materializeIfPossible(Collection<NodeRef> nodeRefs)
    ...
    /**
     * @param reference
     * @return all virtual properties of the referred virtualized artefact keyed by their qualified
     *     name
     * @throws VirtualizationException
     */
    ...
    /**
     * Get the reference of the virtualized artefact with the given name within the virtual context
     * (only) of the parent reference.<br>
     ...
     * @param childName
     * @return the virtual child reference for the given name in the context of the given parent
     *     reference
     * @throws VirtualizationException
     * @see NodeService#getChildByName(org.alfresco.service.cmr.repository.NodeRef, QName, String)
     */
    Reference getChildByName(Reference parentReference, QName assocTypeQName, String childName)
            throws VirtualizationException;

    /**
     * Retrieve immediate children references of a given reference where the child nodes are in the
     * given inclusive list.
     *
     * @param parentReference the parent node - usually a <b>container</b>
     * @param childNodeTypeQNames the types that the children may be. Subtypes are not automatically
     *     calculated and the list must therefore be exhaustive.
     * @return Returns a list of <code>ChildAssociationRef</code> instances.
     */
    List<ChildAssociationRef> getChildAssocs(
            Reference parentReference, Set<QName> childNodeTypeQNames);

    /**
     * Gets all child references associations where the pattern of the association qualified name is
     * an exact match.
     *
     * @param parentReference the parent node - usually a <b>container</b>
     ...
     * children.
     *
     * <p>If the property to be searched is multi-valued then will match on any one values.
     *
     * <p>Please note, the following system maintained properties that cannot be used with this
     * method.
     *
     * <ul>
     *   <li>cm:name - use getChildByName instead
     *   <li>cm:created
     *   <li>cm:creator
     *   <li>cm:modified
     *   <li>cm:modifier
     *   <li>sys:node-uuid
     *   <li>sys:node-dbid
     *   <li>sys:store-identifier
     *   <li>sys:store-protocol
     * </ul>
     *
     ...
     * @param value the value to search for. Must be a simple type such as String, Number, Date or
     *     Boolean, it cannot be a collection, a content property, MLText or a float.
     * @return Returns a list of <code>ChildAssociationRef</code> instances.
     */
    List<ChildAssociationRef> getChildAssocsByPropertyValue(
            Reference parentReference, QName propertyQName, Serializable value);
     ...
     */
    Collection<ChildAssociationRef> getChildAssocsWithoutParentAssocsOfType(
            Reference parentReference, QName assocTypeQName);

    /**
     * Lists page of immediate children of the referred virtualized artefact with optional filtering
     * (exclusion of certain child file/folder subtypes, actual-virtual filtering) and sorting.<br>
    ...
    PagingResults<Reference> list(
            ...
            final Set<QName> searchTypeQNames,
            final Set<QName> ignoreTypeQNames,
            final Set<QName> ignoreAspectQNames,
     ...
     * Note: this could be a long list (and will be trimmed at a pre-configured maximum). You should
     * consider using a paging request.
     *
     * @param reference
     * @throws VirtualizationException
     */
    ...
    /**
     * Perform a search against the name of the files or folders within a virtualized artefact
     * {@link Reference} hierarchy. <br>
     * Wildcard characters are <b>*</b> and <b>?</b>. <br>
     * Warning: Please avoid using this method with any "namePattern" other than "*". Although it
     ...
     *     alignment : for shallow search use list, listFolders, listFiles, searchSimple. For deep
     *     listing use listDeepFolders. Avoid calling this method with any name pattern except for
     *     "*".
     */
    List<Reference> search(
            Reference reference,
            String namePattern,
            boolean fileSearch,
    ...
    /**
     * Check that the given authentication has a particular permission for the given virtualized
     * artefact. (The default behaviour is to inherit permissions)
     *
     * @param reference
     * @param perm
     ...
     * @throws VirtualizationException
     */
    AccessStatus hasPermission(Reference reference, PermissionReference perm)
            throws VirtualizationException;
