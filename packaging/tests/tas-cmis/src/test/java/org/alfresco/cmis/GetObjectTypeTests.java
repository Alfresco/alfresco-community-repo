...
public class GetObjectTypeTests extends CmisTest {
    ...
    public void verifyCmisDocumentType() throws Exception {
        cmisApi.authenticateUser(siteManager)
                ...
                .assertThat()
                .baseTypeIdIs(BaseTypeId.CMIS_DOCUMENT.value());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Non site member is not able to verify CMIS document type for a document from a"
                            + " private site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    public void nonSiteMemberCannotVerifyCmisObjectTypeForADocumentFromPrivateSite()
            throws Exception {
        ...
        cmisApi.authenticateUser(dataUser.getAdminUser())
                ...
                .createFile(privateSiteFile);

        cmisApi.authenticateUser(siteManager)
                .usingResource(privateSiteFile)
                .assertThat()
                .baseTypeIdIs(BaseTypeId.CMIS_DOCUMENT.value());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Non site member is not able to verify CMIS document type for a folder from a"
                            + " private site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    public void nonSiteMemberCannotVerifyCmisFolderTypeForAFolderFromPrivateSite()
            throws Exception {
        SiteModel privateSite = dataSite.usingAdmin().createPrivateRandomSite();
        ...
        cmisApi.authenticateUser(dataUser.getAdminUser())
                .usingSite(privateSite)
                .createFolder(privateSiteFolder);

        cmisApi.authenticateUser(siteManager)
                .usingResource(privateSiteFolder)
                .assertThat()
                .baseTypeIdIs(BaseTypeId.CMIS_FOLDER.value());
    }
    ...
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    public void nonSiteMemberCannotVerifyCmisObjectTypeForADocumentFromModeratedSite()
            throws Exception {
        ...
        cmisApi.authenticateUser(dataUser.getAdminUser())
                ...
                .createFile(moderatedSiteFile);

        cmisApi.authenticateUser(siteManager)
                .usingResource(moderatedSiteFile)
                .assertThat()
                .baseTypeIdIs(BaseTypeId.CMIS_DOCUMENT.value());
    }
    ...
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    public void nonSiteMemberCannotVerifyCmisObjectTypeForAFolderFromModeratedSite()
            throws Exception {
        SiteModel moderatedSite = dataSite.usingAdmin().createModeratedRandomSite();
        ...
        cmisApi.authenticateUser(dataUser.getAdminUser())
                .usingSite(moderatedSite)
                .createFolder(moderatedSiteFolder);

        cmisApi.authenticateUser(siteManager)
                .usingResource(moderatedSiteFolder)
                .assertThat()
                .baseTypeIdIs(BaseTypeId.CMIS_FOLDER.value());
    }
}
