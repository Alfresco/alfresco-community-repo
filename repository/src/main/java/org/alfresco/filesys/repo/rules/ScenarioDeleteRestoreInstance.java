 ...
 *
 * <p>Triggered by a delete of a file followed by a recreate of that same file.
 *
 * <p>First implemented for MacOS Lion Finder.
 *
 * <p>Sequence of operations. a) File Deleted b) File Created.
 */
public class ScenarioDeleteRestoreInstance implements ScenarioInstance {
    ...
    /**
     * Keep track of deletes that we substitute with a rename could be more than one if scenarios
     * overlap
     *
     * <p>From, TempFileName
     */
        ...
        switch (internalState) {
            case NONE:
                ...
                if (operation instanceof DeleteFileOperation) {
                    ...
                    commands.add(
                            new DeleteFileCommand(d.getName(), d.getRootNodeRef(), d.getPath()));
