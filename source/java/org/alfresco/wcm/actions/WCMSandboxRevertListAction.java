...
/**
 * WCM Revert List example action (supercedes AVMUndoSandboxListAction)
 * 
 * Undo (ie. throw away) list of changed assets in a user sandbox.
 * 
 * The actionedUponNodeRef is a dummy and can be null.
 * 
 * @author janv
 */
public class WCMSandboxRevertListAction extends ActionExecuterAbstractBase 
{
    public static final String NAME = "wcm-revert-list";
