...
public class SysAdminParamsImpl
        implements SysAdminParams, ApplicationContextAware, InitializingBean {
    ...
    private static final QName VETO =
            QName.createQName(NamespaceService.APP_MODEL_1_0_URI, "SysAdminParams");
    ...
    // The default is GROUP_EVERYONE, although this will likely be overridden by an injected value
    // from spring.
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // There is no need to attempt to check the dictionary or any other component as they will
        // handle
        // their own vetoes (MNT-14579)
        // No logging is required here: it is done in the TransactionService code, already
        TransactionServiceImpl transactionService =
                (TransactionServiceImpl) ctx.getBean("transactionService");
     ...
     *
     * @param allowedUsers a comma-separated list of users who are allowed to log in or <code>null
     *     </code> if all users are allowed to log in
     */
     ...
     *
     * @param maxUsers the maximum number of users who are allowed to log in
     */
     ...
     *
     * @param allowWrite <code>true</code> if we allow write operations by non-system users on the
     *     repository
     */
    ...
    /**
     * Expands the special ${localname} token within a host name using the resolved DNS name for the
     * local host.
     *
