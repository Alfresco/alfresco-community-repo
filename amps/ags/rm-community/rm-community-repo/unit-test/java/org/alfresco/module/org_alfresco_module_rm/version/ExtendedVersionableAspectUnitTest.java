...
public class ExtendedVersionableAspectUnitTest
  ...
  /** test data */
  private NodeRef nodeRef = new NodeRef(
    StoreRef.STORE_REF_WORKSPACE_SPACESSTORE,
    GUID.generate()
  );
  private NodeRef anotherNodeRef = new NodeRef(
    StoreRef.STORE_REF_WORKSPACE_SPACESSTORE,
    GUID.generate()
  );
  ...
  public void autoVersionOff() {
    ...
    verify(mockedVersionService, never())
      .createVersion(eq(nodeRef), any(Map.class));
  }
  ...
  public void autoVersionFalse() {
    ...
    verify(mockedNodeService)
      .hasAspect(nodeRef, ContentModel.ASPECT_VERSIONABLE);
    verify(mockedNodeService).hasAspect(nodeRef, ContentModel.ASPECT_TEMPORARY);
    verify(mockedAlfrescoTransactionSupport)
  ...
  public void createVersion() {
    ...
    verify(mockedNodeService)
      .hasAspect(nodeRef, ContentModel.ASPECT_VERSIONABLE);
    verify(mockedNodeService).hasAspect(nodeRef, ContentModel.ASPECT_TEMPORARY);
    verify(mockedAlfrescoTransactionSupport, times(2))
      .getResource(KEY_VERSIONED_NODEREFS);
    verify(mockedNodeService)
