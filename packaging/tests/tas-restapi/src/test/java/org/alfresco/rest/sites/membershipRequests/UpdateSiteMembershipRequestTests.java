...
public class UpdateSiteMembershipRequestTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is not able to update membership request of another user")
    //    @Bug(id = "MNT-16919", description = "Not a bug, The presence of the personId in the URL
    // does not mean it should be possible to act on any other users behalf.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is not able to update membership request of another"
                            + " user")
    //    @Bug(id = "MNT-16919", description = "Not a bug, The presence of the personId in the URL
    // does not mean it should be possible to act on any other users behalf.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to update membership request of another"
                            + " user")
    //    @Bug(id = "MNT-16919", description = "Not a bug, The presence of the personId in the URL
    // does not mean it should be possible to act on any other users behalf.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is not able to update membership request of another user")
    //    @Bug(id = "MNT-16919", description = "Not a bug, The presence of the personId in the URL
    // does not mean it should be possible to act on any other users behalf.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify one user is not able to update membership request of another user")
    //    @Bug(id = "MNT-16919", description = "Not a bug, The presence of the personId in the URL
    // does not mean it should be possible to act on any other users behalf.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthorized user is not able to update user site membership request")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to update its own site membership request using -me-")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify inexistent user is not able to update its own site membership request")
    public void inexistentUserCannotUpdateSiteMembershipRequest() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.ENTITY_NOT_FOUND, inexistentUser.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to update its own site membership request for"
                            + " inexistent site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able not to update its own site membership request for public"
                            + " site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to update its own site membership request for private"
                            + " site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to update its own site membership request with initial"
                            + " message")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to update its own site membership request with different"
                            + " message")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user update site membership request with no message then adds a new"
                            + " message")
    public void userUpdateSiteMembershipRequestWithNoMessageThenAddsNewMessage() throws Exception {
        ...
        requestUpdateModel =
                restClient.withCoreAPI().usingMe().updateSiteMembershipRequest(moderatedSite, "");
        restClient.assertStatusCodeIs(HttpStatus.OK);
        requestUpdateModel
                .assertThat()
                .field("id")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user updates site membership request and verifies 'ModifiedAt' field"
                            + " using GET")
    public void userUpdateSiteMembershipRequestAndCheckModifiedAtWithGet() throws Exception {
        ...
        requestUpdateModel =
                restClient
                        ...
                        .updateSiteMembershipRequest(moderatedSite, updatedMessage);
        requestGetModel =
                restClient.withCoreAPI().usingAuthUser().getSiteMembershipRequest(moderatedSite);
