...
public class VirtualHashStringifier extends ProtocolHashStringifier {
  ...
  public String stringify(Reference reference)
    ...
    if (!Protocols.VIRTUAL.protocol.equals(protocol)) {
      throw new ReferenceEncodingException(
        ...
        protocol +
        "." +
        Protocols.VIRTUAL.protocol.name +
        " exoected "
      );
    }
  ...
  protected String stringifyVirtualReference(Reference reference) {
    ...
    ResourceParameter actualNodeParameter = (ResourceParameter) parameters.get(
      VirtualProtocol.ACTUAL_NODE_LOCATION_PARAM_INDEX
    );
    ...
    templatePathParameter =
      (StringParameter) parameters.get(
        VirtualProtocol.TEMPLATE_PATH_PARAM_INDEX
      );
    ...
    String parametersString =
      actualNodeResourceString + "-" + stringifiedPath.toString();
