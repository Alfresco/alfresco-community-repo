...
public class ContentData implements Serializable {
     ...
     *
     * <p>This method only cares if there is a binary (content URL) and makes no assumptions about
     ...
     *
     * <p>In order to ensure data integrity, the {@link #getMimetype() mimetype} must be set if the
     * {@link #getContentUrl() content URL} is set.
     *
     * @param contentUrl the content URL. If this value is non-null, then the <b>mimetype</b> must
     *     be supplied.
     * @param mimetype the content mimetype. This is mandatory if the <b>contentUrl</b> is
     *     specified.
     * @param size the content size.
     * @param encoding the content encoding. This is mandatory if the <b>contentUrl</b> is
     *     specified.
     * @param locale the locale of the content (may be <tt>null</tt>). If <tt>null</tt>, the {@link
     *     I18NUtil#getLocale() default locale} will be used.
     */
    public ContentData(
            String contentUrl, String mimetype, long size, String encoding, Locale locale) {
    ...
    public boolean equals(Object obj) {
        ...
        else if (!(obj instanceof ContentData)) return false;
    ...
    /**
     * @return Returns a string of form: <code>
     *     contentUrl=xxx|mimetype=xxx|size=xxx|encoding=xxx|locale=xxx</code>
     */
    ...
    /**
     * @return Returns a URL containing information on the content including the mimetype, locale,
     *     encoding and size, the string is returned in the form: <code>
     *     contentUrl=xxx|mimetype=xxx|size=xxx|encoding=xxx|locale=xxx</code>
     */
    public String getInfoUrl() {
        StringBuilder sb = new StringBuilder(80);
        sb.append("contentUrl=")
                .append(contentUrl == null ? "" : contentUrl)
                .append("|mimetype=")
                .append(mimetype == null ? "" : mimetype)
                .append("|size=")
                .append(size)
                .append("|encoding=")
                .append(encoding == null ? "" : encoding)
                .append("|locale=")
                .append(
                        locale == null
                                ? ""
                                : DefaultTypeConverter.INSTANCE.convert(String.class, locale));
        return sb.toString();
    }

    /**
     * @return Returns a URL identifying the specific location of the content. The URL must
     *     identify, within the context of the originating content store, the exact location of the
     *     content.
    ...
    /**
     * Checks that the content URL is correct, and also that the mimetype is non-null if the URL is
     * present.
     *
     ...
     *
     * @return Returns a valid Java encoding, typically a character encoding, or null if the
     *     encoding is unkown
     */
