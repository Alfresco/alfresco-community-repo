...
public interface Groups {
   ...
   */
  Group getGroup(String groupId, Parameters parameters)
    throws EntityNotFoundException;
   ...
   * @return a paged list of {@code org.alfresco.rest.api.model.Group} objects
   */
  CollectionWithPagingInfo<Group> getGroupsByPersonId(
    String personId,
   ...
   */
  CollectionWithPagingInfo<GroupMember> getGroupMembers(
    String groupId,
    Parameters parameters
  );
