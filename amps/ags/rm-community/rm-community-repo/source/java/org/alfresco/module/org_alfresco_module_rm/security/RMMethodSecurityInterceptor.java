...
public class RMMethodSecurityInterceptor extends MethodSecurityInterceptor {
  ...
  protected static final Log LOGGER = LogFactory.getLog(
    RMMethodSecurityInterceptor.class
  );
  ...
  public String getFailureReport() {
    ...
    if (LOGGER.isDebugEnabled()) {
      Collection<CapabilityReport> capabilities = RMMethodSecurityInterceptor.CAPABILITIES
        .get()
        .values();
      ...
      if (LOGGER.isDebugEnabled()) {
        ...
        if (RMMethodSecurityInterceptor.IS_RM_SECURITY_CHECK.get()) {
          ...
          methodDetails.append(
            "Standard DM method security check was performed.\n"
          );
        }
        ...
        if (failureReport == null) {
          ...
          throw new AccessDeniedException(
            exception.getMessage() + methodDetails,
            exception
          );
        } else {
          // rethrow with additional information
          throw new AccessDeniedException(
            exception.getMessage() + methodDetails + getFailureReport(),
            exception
          );
        }
      } else {
