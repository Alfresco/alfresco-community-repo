...
public interface ScriptBundleExecutor {
     ...
     * @throws AlfrescoRuntimeException if a script fails and the <tt>logOnly</tt> flag is
     *     <tt>false</tt>
     */
    ...
    /**
     * Runs a bundle of scripts. If any script within the bundle fails, then the rest of the files
     * are not run, with the exception of postScript - which is always run (a clean-up script for
     * example).
     *
     * @param dir Directory where the script bundle may be found.
