...
public class QueryParserUtils implements QueryConstants {
  ...
  public static String expandQName(
    ...
    if (qnameString.charAt(0) != '{') {
      ...
      if (colonPosition == -1) {
        ...
        if (uri == null) {
          ...
          fieldName =
            "{" + uri + "}" + qnameString.substring(colonPosition + 1);
        }
      }
    }
    return fieldName;
  ...
  public static ClassDefinition matchClassDefinition(
    String defaultNameSpaceUri,
    NamespacePrefixResolver namespacePrefixResolver,
    ...
    QName search = QName.createQName(
      expandQName(defaultNameSpaceUri, namespacePrefixResolver, string)
    );
    ...
    if (classDefinition == null) {
      for (QName definition : dictionaryService.getAllTypes()) {
        if (
          definition
            .getNamespaceURI()
            .equalsIgnoreCase(search.getNamespaceURI())
        ) {
          if (
            definition.getLocalName().equalsIgnoreCase(search.getLocalName())
          ) {
            if (match == null) {
              match = definition;
            } else {
  ...
  public static AspectDefinition matchAspectDefinition(
    String defaultNameSpaceUri,
    NamespacePrefixResolver namespacePrefixResolver,
    DictionaryService dictionaryService,
    String string
    ...
    AspectDefinition aspectDefinition = dictionaryService.getAspect(
      QName.createQName(
        expandQName(defaultNameSpaceUri, namespacePrefixResolver, string)
      )
    );
  ...
  public static TypeDefinition matchTypeDefinition(
    String defaultNameSpaceUri,
    NamespacePrefixResolver namespacePrefixResolver,
    DictionaryService dictionaryService,
    String string
    ...
    TypeDefinition typeDefinition = dictionaryService.getType(
      QName.createQName(
        expandQName(defaultNameSpaceUri, namespacePrefixResolver, string)
      )
    );
  ...
  public static DataTypeDefinition matchDataTypeDefinition(
    String defaultNameSpaceUri,
    NamespacePrefixResolver namespacePrefixResolver,
    DictionaryService dictionaryService,
    String string
    ...
    QName search = QName.createQName(
      QueryParserUtils.expandQName(
        defaultNameSpaceUri,
        namespacePrefixResolver,
        string
      )
    );
    DataTypeDefinition dataTypeDefinition = dictionaryService.getDataType(
      QName.createQName(
        QueryParserUtils.expandQName(
          defaultNameSpaceUri,
          namespacePrefixResolver,
  ...
  public static PropertyDefinition matchPropertyDefinition(
    String defaultNameSpaceUri,
    NamespacePrefixResolver namespacePrefixResolver,
    DictionaryService dictionaryService,
    String string
  ...
  public static Pair<String, String> extractFieldNameAndEnding(String field) {
    ...
    if (field.endsWith(FIELD_MIMETYPE_SUFFIX)) {
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_MIMETYPE_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SIZE_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_LOCALE_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_ENCODING_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_CONTENT_DOC_ID_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_TRANSFORMATION_EXCEPTION_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_TRANSFORMATION_TIME_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_TRANSFORMATION_STATUS_SUFFIX.length()
        );
    ...
    // ordering matters .__.u before .u
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_NOLOCALE_UNTOKENISED_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_LOCALISED_UNTOKENISED_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_NOLOCALE_TOKENISED_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_SECOND_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_MINUTE_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_HOUR_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_DAY_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_DAY_OF_WEEK_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_DAY_OF_YEAR_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_MONTH_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_QUARTER_SUFFIX.length()
        );
      ...
      propertyFieldName =
        field.substring(
          field.startsWith("@") ? 1 : 0,
          field.length() - FIELD_SOLR_UNIT_OF_TIME_YEAR_SUFFIX.length()
        );
