 ...
 *
 * <p>Values here are either simple values that can be stored in a <code>long</code> or will be
 * references to data in other tables.
 *
 * @author Derek Hulley
 * @since 3.2
 */
public class PropertyValueEntity {
     ...
     *
     * <p>This enumeration is a helper for the default implementation of the {@link
     * PropertyTypeConverter} and should not be used in public interfaces.
     *
     * @author Derek Hulley
     * @since 3.2
     */
        ...
        NULL {
            ...
            public Class<?> getAssociatedClass() {
                throw new UnsupportedOperationException(
                        "NULL is a special case and has no associated class.");
            }
        },
        LONG {
            @Override
    ...
    static {
        ...
        PERSISTED_TYPE_NULL =
                new Pair<Short, Serializable>(PersistedType.NULL.getOrdinalNumber(), new Long(0));
    ...
    @Override
    public int hashCode() {
        return (actualTypeId == null ? 0 : actualTypeId.intValue())
                + (longValue == null ? 0 : longValue.intValue());
    }
    ...
    public Serializable getValue(Class<Serializable> actualType, PropertyTypeConverter converter) {
        switch (persistedTypeEnum) {
            ...
            case STRING:
                if (stringValue != null
                        && stringValue.equals(PropertyStringValueEntity.EMPTY_STRING_REPLACEMENT)) {
     ...
     */
    public static PersistedType getPersistedTypeEnum(
            Serializable value, PropertyTypeConverter converter) {
