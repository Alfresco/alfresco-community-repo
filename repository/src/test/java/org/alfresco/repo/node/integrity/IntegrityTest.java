 ...
 * <p>
 * The entire application context is loaded as is, but the integrity fail- mode is set to throw an exception.
 * 
...
public class IntegrityTest extends TestCase
{
     ...
     * 
     * @param failureMsg
     *            the fail message if an integrity exception doesn't occur
     * @param expectedCount
