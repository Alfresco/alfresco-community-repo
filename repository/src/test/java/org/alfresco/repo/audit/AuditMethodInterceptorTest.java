...
public class AuditMethodInterceptorTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    // Register the models
    URL modelUrlMnt11072 = ResourceUtils.getURL(
      "classpath:alfresco/testaudit/alfresco-audit-test-mnt-11072.xml"
    );
    URL modelUrlMnt16748 = ResourceUtils.getURL(
  ...
  public void testAuditInReadOnly_MNT11072() throws Exception {
    ...
    try {
      ...
      Map<QName, Serializable> props = transactionService
      ...
      assertTrue(
        "The requested nodeRef should be in the audit entry.",
  ...
  public void testAuditSearchServiceQuery() throws Exception {
    ...
    ResultSet rs = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<ResultSet>() {
          @Override
  ...
  private void checkAuditEntries(
    String applicationName,
    String language,
    String query,
    int resultsNumber
    ...
    assertEquals(
      "Incorrect number of audit entries",
      resultsNumber,
      rowCount.intValue()
    );
    assertTrue(
    ...
    assertTrue(
      "The used query should be in the audit entry.",
