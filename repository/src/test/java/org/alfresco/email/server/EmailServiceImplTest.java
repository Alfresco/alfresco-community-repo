...
public class EmailServiceImplTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    ChildApplicationContextFactory emailSubsystem = (ChildApplicationContextFactory) ctx.getBean(
      "InboundSMTP"
    );
  ...
  public void testFromName() throws Exception {
    ...
    Set<String> auths = authorityService.getContainedAuthorities(
      null,
    ...
    String testUserDBID =
      (
        (Long) nodeService.getProperty(person, ContentModel.PROP_NODE_DBID)
      ).toString() +
      "@Alfresco.com";
  ...
  public void testMultipleMessagesToFolder() throws Exception {
     ...
     */
    logger.debug(
      "Step 4: turn off Overwite Duplicates with long subject name with extension"
    );
     ...
     */
    logger.debug(
      "Step 5: turn off Overwite Duplicates and check concurrent deliver of the same message"
    );
    folderEmailMessageHandler.setOverwriteDuplicates(false);
    assocs =
      nodeService.getChildAssocs(
  ...
  public void testCaseSensitivity() throws Exception {
    ...
    QName safeQName = QName.createQNameWithValidLocalName(
      NamespaceService.CONTENT_MODEL_1_0_URI,
  ...
  public void testMessagesToDocument() throws Exception {
    ...
    properties.put(
      ...
      "bees - test doc for email tests"
    );
    ChildAssociationRef testDoc = nodeService.createNode(
      testUserHomeFolder,
      ContentModel.ASSOC_CONTAINS,
    ...
    assertTrue(
      nodeService.hasAspect(testDocNodeRef, ForumModel.ASPECT_DISCUSSABLE)
    );
