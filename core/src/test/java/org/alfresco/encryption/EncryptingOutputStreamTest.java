...
public class EncryptingOutputStreamTest extends TestCase {
    ...
    /**
     * Tests encryption / decryption by attempting to encrypt and decrypt the bytes forming this
     * class definition and comparing it with the unencrypted bytes.
     *
    ...
    public void testEncrypt() throws Exception {
        ...
        final InputStream in =
                getClass().getResourceAsStream(getClass().getSimpleName() + ".class");
        ...
        encrypting.close();
        plainText1.close();
        final InputStream decrypting =
                new DecryptingInputStream(
                        new ByteArrayInputStream(buff.toByteArray()), pair.getPrivate());
