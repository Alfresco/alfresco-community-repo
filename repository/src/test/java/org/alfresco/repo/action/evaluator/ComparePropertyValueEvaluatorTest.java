...
public class ComparePropertyValueEvaluatorTest extends BaseSpringTest {
    ...
    private static final QName PROP_DATETIME =
            QName.createQName(TEST_TYPE_NAMESPACE, "propDatetime");
    private static final QName PROP_NODEREF = QName.createQName(TEST_TYPE_NAMESPACE, "propNodeRef");
    private static final QName PROP_MULTI_VALUE =
            QName.createQName(TEST_TYPE_NAMESPACE, "propMultiValue");
    ...
    public void before() throws Exception {
        ...
        this.evaluator =
                (ComparePropertyValueEvaluator)
                        this.applicationContext.getBean(ComparePropertyValueEvaluator.NAME);
    }
    ...
    public void testCheckParamDefintionWithConstraint() {
        ...
        ParameterDefinition paramDef =
                def.getParameterDefintion(ComparePropertyValueEvaluator.PARAM_OPERATION);
    ...
    public void testNumericComparison() {
        ActionConditionImpl condition =
                new ActionConditionImpl(GUID.generate(), ComparePropertyValueEvaluator.NAME);
    ...
    public void testDateComparison() {
        ...
        condition.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_VALUE, this.beforeDateValue);
        assertTrue(this.evaluator.evaluate(condition, this.nodeRef));
    ...
    public void testOtherComparison() {
        ...
        condition.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_VALUE, "this isn't even the correct type!");
        assertFalse(this.evaluator.evaluate(condition, this.nodeRef));
    ...
    public void testContentPropertyComparisons() {
        ActionConditionImpl condition =
                new ActionConditionImpl(GUID.generate(), ComparePropertyValueEvaluator.NAME);
        condition.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_PROPERTY, ContentModel.PROP_CONTENT);
        ...
        condition.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_VALUE, MimetypeMap.MIMETYPE_TEXT_PLAIN);
        assertTrue(this.evaluator.evaluate(condition, this.nodeRef));
        condition.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_VALUE, MimetypeMap.MIMETYPE_HTML);
        assertFalse(this.evaluator.evaluate(condition, this.nodeRef));
