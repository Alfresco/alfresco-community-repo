...
public class NotificationServiceImplSystemTest extends BaseAlfrescoTestCase {
    ...
    retryingTransactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          toPerson1 =
            createPerson(TO_USER1, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL);
          toPerson2 =
            createPerson(TO_USER2, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL);
          toPerson3 =
            createPerson(TO_USER3, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL);
  ...
  public static class TestNotificationProvider implements NotificationProvider {
    ...
    public static final String NAME =
      TestNotificationProvider.class.getSimpleName();
