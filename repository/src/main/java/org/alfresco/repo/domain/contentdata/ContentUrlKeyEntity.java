...
public class ContentUrlKeyEntity implements Serializable {
  ...
  public void setEncryptedKey(EncryptedKey encryptedKey) {
    byte[] encryptedKeyAsBytes = new byte[encryptedKey
      .getByteBuffer()
      .remaining()];
  ...
  public static ContentUrlKeyEntity setEncryptedKey(
    ContentUrlKeyEntity existing,
    ...
    newContentUrlKeyEntity.setMasterKeystoreId(
      encryptedKey.getMasterKeystoreId()
    );
    newContentUrlKeyEntity.setContentUrlId(existing.getContentUrlId());
    newContentUrlKeyEntity.setUnencryptedFileSize(
      existing.getUnencryptedFileSize()
    );
  ...
  public EncryptedKey getEncryptedKey() throws DecoderException {
    EncryptedKey encryptedKey = new EncryptedKey(
      ...
      getMasterKeyAlias(),
      getAlgorithm(),
      ByteBuffer.wrap(this.encryptedKeyAsBytes)
    );
    return encryptedKey;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (masterKeyAlias == null) {
      if (other.masterKeyAlias != null) return false;
    } else if (!masterKeyAlias.equals(other.masterKeyAlias)) return false;
    if (masterKeystoreId == null) {
      if (other.masterKeystoreId != null) return false;
    } else if (!masterKeystoreId.equals(other.masterKeystoreId)) return false;
    return true;
  }
