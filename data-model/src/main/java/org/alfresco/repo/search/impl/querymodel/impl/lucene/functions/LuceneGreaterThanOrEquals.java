...
/** @author andyh */
public class LuceneGreaterThanOrEquals<Q, S, E extends Throwable> extends GreaterThanOrEquals
    ...
    public Q addComponent(
        ...
        Q query =
                functionContext.buildLuceneGreaterThanOrEquals(
                        lqpa,
                        getPropertyName(),
                        getStaticArgument().getValue(functionContext),
                        PredicateMode.ANY,
        ...
        if (query == null) {
            throw new QueryModelException(
                    "No query time mapping for property  "
                            + getPropertyArgument().getPropertyName()
