...
public class GetPeopleFullTests extends RestTest {
    ...
    public void checkResponseSchemaForGetPerson() throws Exception {
        RestPersonModel newUser =
                RestPersonModel.getRandomPersonModel(
                        "aspectNames",
                        "avatarId",
                        "statusUpdatedAt",
                        "displayName",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user gets a person with empty personId with Rest API and response is"
                            + " successful")
    public void userGetPersonWithEmptyPersonId() throws Exception {
        ...
        RestPersonModelsCollection persons =
                restClient.processModels(RestPersonModelsCollection.class, request);
        restClient.assertStatusCodeIs(HttpStatus.OK);
