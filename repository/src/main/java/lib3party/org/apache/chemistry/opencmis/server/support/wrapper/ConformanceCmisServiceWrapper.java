...
public class ConformanceCmisServiceWrapper extends AbstractCmisServiceWrapper {
  ...
  protected void checkProperty(
    ...
    if (properties.getProperties() == null) {
      throw new CmisInvalidArgumentException(
        "Property " + propertyId + " must be set!"
      );
    }
   ...
   * invalid.
   */
  protected void checkBulkUpdateList(
    List<BulkUpdateObjectIdAndChangeToken> list
  ) {
    if (list == null) {
    ...
    if (list.isEmpty()) {
      throw new CmisInvalidArgumentException(
        "Object Id list must not be empty!"
      );
    }
  ...
  public TypeDefinition getTypeDefinition(
    ...
    try {
      return getWrappedService()
        .getTypeDefinition(repositoryId, typeId, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public ObjectData getFolderParent(
    ...
    try {
      return getWrappedService()
        .getFolderParent(repositoryId, folderId, filter, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public void deleteContentStream(
    ...
    try {
      getWrappedService()
        .deleteContentStream(repositoryId, objectId, changeToken, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public AllowableActions getAllowableActions(
    ...
    try {
      return getWrappedService()
        .getAllowableActions(repositoryId, objectId, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public Properties getProperties(
    ...
    try {
      return getWrappedService()
        .getProperties(repositoryId, objectId, filter, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public void checkOut(
    ...
    try {
      getWrappedService()
        .checkOut(repositoryId, objectId, extension, contentCopied);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public void removeObjectFromFolder(
    ...
    try {
      getWrappedService()
        .removeObjectFromFolder(repositoryId, objectId, folderId, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public Acl applyAcl(
    ...
    try {
      return getWrappedService()
        .applyAcl(repositoryId, objectId, aces, aclPropagation);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public void applyPolicy(
    ...
    try {
      getWrappedService()
        .applyPolicy(repositoryId, policyId, objectId, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
  ...
  public void removePolicy(
    ...
    try {
      getWrappedService()
        .removePolicy(repositoryId, policyId, objectId, extension);
    } catch (Exception e) {
      throw createCmisException(e);
    }
  }
