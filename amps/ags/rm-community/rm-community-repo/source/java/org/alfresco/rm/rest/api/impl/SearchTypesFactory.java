...
public class SearchTypesFactory {
  ...
  public Set<QName> buildSearchTypesForUnfiledEndpoint(
    ...
    if (q != null) {
      ...
      Boolean isUnfiledRecordFolder = propertyWalker.getProperty(
        UnfiledChild.PARAM_IS_UNFILED_RECORD_FOLDER,
        WhereClauseParser.EQUALS,
        Boolean.class
      );
      Boolean isRecord = propertyWalker.getProperty(
      ...
      if (
        (
          isUnfiledRecordFolder != null && isUnfiledRecordFolder.booleanValue()
        ) ||
      ...
      String nodeTypeQNameStr = propertyWalker.getProperty(
        UnfiledChild.PARAM_NODE_TYPE,
        WhereClauseParser.EQUALS,
        String.class
      );
      ...
      if (nodeTypeQNameStr != null) {
        if ((isUnfiledRecordFolder != null) || (isRecord != null)) {
          throw new InvalidArgumentException(
            "Invalid filter - nodeType and isUnfiledRecordFolder/isRecord are mutually exclusive"
          );
        }
  ...
  public Set<QName> buildSearchTypesCategoriesEndpoint(
    ...
    if (q != null) {
      ...
      Boolean isRecordFolder = propertyWalker.getProperty(
        RecordCategoryChild.PARAM_IS_RECORD_FOLDER,
        WhereClauseParser.EQUALS,
        Boolean.class
      );
      Boolean isRecordCategory = propertyWalker.getProperty(
      ...
      if (
        (isRecordFolder != null && isRecordFolder.booleanValue()) ||
      ...
      if (nodeTypeQNameStr != null) {
        if ((isRecordFolder != null) || (isRecordCategory != null)) {
          throw new InvalidArgumentException(
            "Invalid filter - nodeType and isRecordFolder/isRecordCategory are mutually exclusive"
          );
        }
        ...
        filterNodeTypeQName = pair.getFirst();
        if (
          filterNodeTypeQName.equals(RecordsManagementModel.TYPE_RECORD_FOLDER)
        ) {
          includeRecordFolders = true;
        } else if (
          filterNodeTypeQName.equals(
  ...
  private Pair<QName, Boolean> parseNodeTypeFilter(String nodeTypeStr) {
    ...
    if (dictionaryService.getType(filterNodeTypeQName) == null) {
      throw new InvalidParameterException(
        "Filter nodeType: " + nodeTypeStr + " is invalid"
      );
    }
