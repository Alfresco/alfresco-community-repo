...
public abstract class AbstractPermissionTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    permissionServiceImpl =
      (PermissionServiceImpl) applicationContext.getBean(
        "permissionServiceImpl"
      );
    ...
    publicServiceAccessService =
      (PublicServiceAccessService) applicationContext.getBean(
        "publicServiceAccessService"
      );
    policyComponent =
