...
public class AuditDeleteHoldTests extends BaseRMRestTest
{
    ...
    /**
     * Given a hold is deleted When I view the audit log Then an entry has been created in the audit log which contains the following: name of the hold user who deleted the hold date the delete occurred
     */
    @Test
    ...
    /**
     * Given a hold is deleted with a reason When I view the audit log Then an entry has been created in the audit log which contains the following: name of the hold hold deletion reason user who deleted the hold date the delete occurred
     */
    @Test
    ...
    /**
     * Given an unsuccessful delete hold action When I view the audit log Then the delete hold event isn't audited
     */
    @Test
