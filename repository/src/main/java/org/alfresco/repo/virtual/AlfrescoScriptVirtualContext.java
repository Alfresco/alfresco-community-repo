...
public class AlfrescoScriptVirtualContext extends BaseScopableProcessorExtension {
    ...
    /**
     * @return an array containing the plain qname path at index 0 and the ISO9075 element-encoded
     *     qname path at index 1
     */
    ...
    public synchronized ScriptNode getActualNode() {
        return new ScriptNode(context.getActualNodeRef(), serviceRegistry, getScope());
    }
