 ...
 *
 * <p>a) Rename File to File~ b) Create File c) Delete File~
 *
 * <p>This rule will kick in and copy the content and then switch the two file over.
 */
            ...
            case LOOK_FOR_DELETE:
                if (operation instanceof DeleteFileOperation) {
                    ...
                    if (to.equals(d.getName())) {
                        ...
                        /**
                         * Shuffle is as follows a) Copy content from File to File~ b) Delete File
                        ...
                        DeleteFileCommand d1 =
                                new DeleteFileCommand(
                                        from, d.getRootNodeRef(), oldFolder + "\\" + from);
