...
public class LDAPAuthenticationComponentImpl extends AbstractAuthenticationComponent
    ...
    public void setUserNameFormat(String userNameFormat) {
        this.userNameFormat =
                userNameFormat == null || userNameFormat.length() == 0 ? null : userNameFormat;
    }
    ...
    protected void authenticateImpl(String userName, char[] password)
        ...
        // Otherwise, use the format, but disallow leading or trailing whitespace in the user ID as
        // this can result in
        ...
        try {
            ctx =
                    ldapInitialContextFactory.getInitialDirContext(
                            userDN, new String(password), diagnostic);
