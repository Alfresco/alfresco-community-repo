...
public interface SubscriptionService extends ActivateableBean {
     ...
     * @param pagingRequest paging details
     * @throws PrivateSubscriptionListException if the subscription list is private and the calling
     ...
     *
     * @param userId the id of the user
     * @param userToFollow the id of the user to follow
     */
     ...
     *
     * @param userId the id of the user
     * @param userToUnfollow the id of the user to unfollow
     */
     ...
     *
     * @param userId id of the user
     * @param userToFollow the id of the other user
     */
    @NotAuditable
     ...
     *
     * @param userId the id of the user
     * @param isPrivate <code>true</code> - set list private, <code>false</code> - set list public
     */
