...
public class GetFolderParentTests extends CmisTest {
  ...
  @TestRail(
    ...
    description = "Verify folder parent"
  )
  ...
  public void verifyFolderParent() throws Exception {
    cmisApi
      ...
      .then()
      .assertThat()
      .folderHasParent(testFolder);
  }

  @TestRail(
    section = { "cmis-api" },
    executionType = ExecutionType.REGRESSION,
    description = "Verify folder parent that was previously deleted"
  )
  @Test(
  ...
  public void siteContributorVerifyFolderParentCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorVerifyFolderParentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorVerifyFolderParentCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorVerifyFolderParentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
