...
/**
 * This class is the webscript implementation for the url api/bulkmetadata It returns basic metadata
 * such as title, parent noderef, name, ... for each noderef that is passed in
 *
 * @since 3.4
 */
        ...
        try {
            ...
            if (nodeRefsArray == null || nodeRefsArray.length() == 0) {
                throw new WebScriptException(
                        Status.STATUS_INTERNAL_SERVER_ERROR, "Must provide node refs");
            }
            ...
            res.setContentEncoding(
                    Charset.defaultCharset()
                            .displayName()); // TODO: Should be settable on JSONWriter
                    ...
                    jsonOut.startArray();
                    {
                        for (int i = 0; i < nodeRefsArray.length(); i++) {
                            ...
                            if (nodeService.exists(nodeRef)) {
                                ...
                                String shortType =
                                        type.toPrefixString(services.getNamespaceService());
                                ...
                                jsonOut.startObject();
                                {
                                    ...
                                    jsonOut.writeValue(
                                            "title",
                                            (String) properties.get(ContentModel.PROP_TITLE));
                                    jsonOut.writeValue(
                                            "mimeType",
                                            getMimeType(
                                                    (ContentData)
                                    ...
                                    jsonOut.writeValue(
                                            ...
                                            permissionService.hasPermission(
                                                            nodeRef, PermissionService.WRITE)
                                ...
                                jsonOut.startObject();
                                {
                                    ...
                                    jsonOut.writeValue(
                                            "errorText",
                                            I18NUtil.getMessage(
                                                    "msg.invalidNodeRef", nodeRef.toString()));
                                }
                                jsonOut.endObject();
                            }
                        }
