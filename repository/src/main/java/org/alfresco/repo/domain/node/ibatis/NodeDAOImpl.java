...
public class NodeDAOImpl extends AbstractNodeDAOImpl {
    ...
    protected void updatePrimaryChildrenSharedAclId(
            ...
            Long newSharedAlcId) {
        PrimaryChildrenAclUpdateEntity primaryChildrenAclUpdateEntity =
                new PrimaryChildrenAclUpdateEntity();
    ...
    private Map<NodeVersionKey, Map<NodePropertyKey, NodePropertyValue>>
            makePersistentPropertiesMap(List<NodePropertyEntity> rows) {
        Map<NodeVersionKey, Map<NodePropertyKey, NodePropertyValue>> results =
                new HashMap<NodeVersionKey, Map<NodePropertyKey, NodePropertyValue>>(3);
    ...
    private List<NodePropertyEntity> makePersistentRows(
            Long nodeId, Map<NodePropertyKey, NodePropertyValue> map) {
    ...
    protected Map<NodeVersionKey, Set<QName>> selectNodeAspects(Set<Long> nodeIds) {
        ...
        Map<NodeVersionKey, Set<QName>> results =
                new HashMap<NodeVersionKey, Set<QName>>(rows.size() * 2);
                ...
                new ResultHandler() {
                    public void handleResult(ResultContext context) {
                        ...
                        Pair<Long, NodeRef> nodePair =
                                new Pair<Long, NodeRef>(entity.getId(), entity.getNodeRef());
    ...
    protected List<ChildAssocEntity> selectChildNodeIds(
            Long nodeId, Boolean isPrimary, Long minChildNodeIdInclusive, int maxResults) {
        ChildAssocEntity assoc = new ChildAssocEntity();
        NodeEntity parentNode = new NodeEntity();
    ...
    private class ChildAssocResultHandler implements ResultHandler {
        ...
        private ChildAssocResultHandler(
                ChildAssocResultHandlerFilter filter, ChildAssocRefQueryCallback resultsCallback) {
            this.filter = filter;
    ...
    public void selectChildAssocs(
        ...
        RowBounds rowBounds = new RowBounds(0, maxResults);
        List<?> entities =
                template.selectList(SELECT_CHILD_ASSOCS_OF_PARENT_LIMITED, assoc, rowBounds);
        @SuppressWarnings("rawtypes")
    ...
    protected ChildAssocEntity selectChildAssoc(
        ...
        // Note: This single results was assumed from inception of the original method.  It's
        // correct.
    ...
    protected void selectChildAssocs(
        ...
        ChildAssocResultHandlerFilter filter =
                new ChildAssocResultHandlerFilter() {
        ...
        ChildAssocResultHandler resultHandler =
                new ChildAssocResultHandler(filter, resultsCallback);
    ...
    protected void selectChildAssocsWithoutParentAssocsOfType(
        ...
        template.select(
                SELECT_CHILD_ASSOCS_OF_PARENT_WITHOUT_PARENT_ASSOCS_OF_TYPE, assoc, resultHandler);
        resultsCallback.done();
    }

    @Override
    public List<Node> selectChildAssocsWithoutNodeAssocsOfTypes(
            Long parentNodeId, Long minNodeId, Long maxNodeId, Set<QName> assocTypeQNames) {
        IdsEntity idsEntity = new IdsEntity();
        ...
        return template.selectList(
                SELECT_CHILD_ASSOCS_OF_PARENT_WITHOUT_NODE_ASSOCS_OF_TYPE, idsEntity);
    }
    ...
    /**
     * The default implementation relies on <b>ON DELETE CASCADE</b> and the subscriptions avoiding
     * deleted nodes - NoOp.
     */
    @Override
     ...
     *
     * <p>WARNING: Experimental/unsupported - see MySQLClusterNDBDialect !
     *
     * @author janv
     */
    public static class MySQLClusterNDB extends MySQL {
        ...
        protected Long newChildAssocInsert(
                ChildAssocEntity assoc, QName assocTypeQName, String childNodeName) {
