...
/**
 * A Behaviour represents an encapsulated piece of logic (system or business) that may be bound to a Policy. The logic may be expressed in any language (java, script etc).
 *
 * Once bound to a Policy, the behaviour must be able to provide the interface declared by that policy.
 * 
...
public interface Behaviour
{
    ...
    {
        EVERY_EVENT, FIRST_EVENT, TRANSACTION_COMMIT
    }
