 ...
 *
 * <p>Please pardon the incorrect spelling of <i>extractor</i>.
 *
...
public interface MetadataExtracter extends ContentWorker {
    /**
     * A enumeration of functional property overwrite policies. These determine whether extracted
     * properties are written into the property map or not.
     *
     * @author Derek Hulley
     * @author Jesper Steen Møller
     */
    ...
    public enum OverwritePolicy {
         ...
         *
         * <ul>
         *   <li>the extracted property is not null
         * </ul>
         *
        ...
        EAGER {
            @Override
            public Map<QName, Serializable> applyProperties(
                    Map<QName, Serializable> extractedProperties,
         ...
         *   <li>either:
         *       <ul>
         *         <li>there is no target key for the property
         *         <li>the target value is null
         *         <li>the string representation of the target value is an empty string
         *       </ul>
         *       or:
         *       <ul>
         *         <li>the extracted property is a media related one (eg Image, Audio or Video)
         *       </ul>
         * </ul>
         *
         * <tt>null</tt> extracted values are return in the 'modified' map.
        ...
        /**
         * This policy only puts the extracted value if there is no value (null or otherwise) in the
         * properties map. It is assumed that the mere presence of a property key is enough to
         * inidicate that the target property is as intented. This policy puts the new value if:
         *
         * <ul>
         *   <li>the extracted property is not null
         *   <li>there is no target key for the property
         ...
         *
         * @return Returns a map of all properties that were applied to the target map as well as
         *     any null values that weren't applied but were present.
         */
        public Map<QName, Serializable> applyProperties(
                Map<QName, Serializable> extractedProperties,
                Map<QName, Serializable> targetProperties) {
    ...
    /**
     * Extracts the metadata values from the content provided by the reader and source mimetype to
     * the supplied map. The internal mapping and {@link OverwritePolicy overwrite policy} between
     * document metadata and system metadata will be used.
     *
     * <p>The extraction viability can be determined by an up front call to {@link
     * #isSupported(String)}.
     *
     * <p>The source mimetype <b>must</b> be available on the {@link
     * org.alfresco.service.cmr.repository.ContentAccessor#getMimetype()} method of the reader.
     *
     * @param reader the source of the content
     * @param destination the map of properties to populate (essentially a return value)
     * @return Returns a map of all properties on the destination map that were added or modified.
     *     If the return map is empty, then no properties were modified.
     ...
     *
     * @param reader the source of the content
     * @param overwritePolicy the policy stipulating how the system properties must be overwritten
     *     if present
     * @param destination the map of properties to populate (essentially a return value)
     * @return Returns a map of all properties on the destination map that were added or modified.
     *     If the return map is empty, then no properties were modified.
    ...
    /**
     * Extracts the metadata from the content provided by the reader and source mimetype to the
     * supplied map. The mapping from document metadata to system metadata is explicitly provided.
     * The {@link OverwritePolicy overwrite policy} is also explictly set.
     *
     * <p>The extraction viability can be determined by an up front call to {@link
     * #isSupported(String)}.
     *
    ...
    /**
     * Identical to {@link #extract(ContentReader, Map)} but with the addition of the {@code
     * NodeRef} being acted on. By default, the method without the {@code NodeRef} is called.
     *
    ...
    /**
     * Identical to {@link #extract(ContentReader, OverwritePolicy, Map, Map)} but with the addition
     * of the {@code NodeRef} being acted on. By default, the method without the {@code NodeRef} is
     * called.
     *
     * @param nodeRef the node being acted on.
     * @param reader the source of the content
