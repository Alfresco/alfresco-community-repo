...
public class SiteMembershipTest {
  ...
  public void testNullpersonInfo() throws Exception {
    try {
      siteMember =
        new SiteMembership(siteInfo, null, firstName, lastName, role);
  ...
  public void testNullRole() throws Exception {
    try {
      siteMember =
        new SiteMembership(siteInfo, personId, firstName, lastName, null);
    } catch (IllegalArgumentException e) {
  ...
  public void testNullFirstName() throws Exception {
    try {
      ...
      assertEquals(
        firstNameErrorMessage + siteInfo.getShortName(),
        e.getMessage()
      );
    }
  }
  ...
  public void testNullLastName() throws Exception {
    try {
      siteMember =
        new SiteMembership(siteInfo, personId, firstName, null, role);
    } catch (IllegalArgumentException e) {
      assertEquals(
        lastNameErrorMessage + siteInfo.getShortName(),
        e.getMessage()
      );
    }
  }
