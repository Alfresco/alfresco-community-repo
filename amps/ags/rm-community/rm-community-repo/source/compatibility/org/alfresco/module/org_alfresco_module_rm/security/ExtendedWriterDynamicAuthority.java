...
public class ExtendedWriterDynamicAuthority extends ExtendedSecurityBaseDynamicAuthority {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityBaseDynamicAuthority#getAuthorites(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    protected Set<String> getAuthorites(NodeRef nodeRef) {
        ...
        Map<String, Integer> map =
                (Map<String, Integer>) getNodeService().getProperty(nodeRef, PROP_WRITERS);
        if (map != null) {
            result = map.keySet();
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityBaseDynamicAuthority#getTransactionCacheName()
     */
    @Override
