...
public class VersionableAspect
  ...
  private static final String MSG_AUTO_VERSION_PROPS =
    "create_version.auto_version_props";
  ...
  public void setExcludedOnUpdateProps(List<String> excludedOnUpdateProps) {
    this.excludedOnUpdateProps =
      Collections.unmodifiableList(excludedOnUpdateProps);
  }
  ...
  private static class VersionableAspectCopyBehaviourCallback
    ...
    public Map<QName, Serializable> getCopyProperties(
      ...
      Serializable value2 = properties.get(
  ...
  public void onAddAspect(NodeRef nodeRef, QName aspectTypeQName) {
    if (
      ...
      Boolean value = (Boolean) this.nodeService.getProperty(
          nodeRef,
      ...
      if (initialVersion == true) {
        ...
        Map<NodeRef, NodeRef> versionedNodeRefs = (Map<NodeRef, NodeRef>) AlfrescoTransactionSupport.getResource(
          KEY_VERSIONED_NODEREFS
        );
        if (
          versionedNodeRefs == null ||
          versionedNodeRefs.containsKey(nodeRef) == false
        ) {
          ...
          String versionType = (String) nodeService.getProperty(
            nodeRef,
  ...
  public void onContentUpdate(NodeRef nodeRef, boolean newContent) {
    if (
      ...
      this.nodeService.hasAspect(nodeRef, ContentModel.ASPECT_VERSIONABLE) ==
      true &&
      this.nodeService.hasAspect(nodeRef, ContentModel.ASPECT_TEMPORARY) ==
      false
    ) {
      Map<NodeRef, NodeRef> versionedNodeRefs = (Map) AlfrescoTransactionSupport.getResource(
        KEY_VERSIONED_NODEREFS
      );
      if (
        versionedNodeRefs == null ||
        ...
        if (autoVersion == true) {
          ...
          versionProperties.put(
            Version.PROP_DESCRIPTION,
            I18NUtil.getMessage(MSG_AUTO_VERSION)
          );
          versionProperties.put(
            VersionModel.PROP_VERSION_TYPE,
            VersionType.MINOR
            ...
            if (excludedOnUpdatePropQNames.size() > 0) {
              ...
              if (propNames.size() > 0) {
                for (QName prop : propNames) {
                  ...
                  if (
                    EqualsHelper.nullSafeEquals(beforeValue, afterValue) != true
                  ) {
   ...
   */
  private void createVersionImpl(
    NodeRef nodeRef,
  ...
  public void afterDictionaryInit() {
    this.excludedOnUpdatePropQNames =
      new HashSet<QName>(this.excludedOnUpdateProps.size() * 2);
