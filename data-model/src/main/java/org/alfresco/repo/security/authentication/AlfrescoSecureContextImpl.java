...
public class AlfrescoSecureContextImpl implements AlfrescoSecureContext {
  ...
  public void setEffectiveAuthentication(
    Authentication effictiveAuthentication
  ) {
    if (logger.isTraceEnabled()) {
      logger.trace(
        "Setting effective authentication to: " +
        AuthenticationUtil.getMaskedUsername(effictiveAuthentication)
      );
    }
  ...
  public void setRealAuthentication(Authentication realAuthentication) {
    if (logger.isTraceEnabled()) {
      logger.trace(
        "Setting real authentication to: " +
        AuthenticationUtil.getMaskedUsername(realAuthentication)
      );
    }
  ...
  public int hashCode() {
    ...
    result =
      ...
      result +
      (
        (effectiveAuthentication == null)
          ? 0
          : effectiveAuthentication.hashCode()
      );
    result =
      PRIME *
      result +
      ((realAuthentication == null) ? 0 : realAuthentication.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (effectiveAuthentication == null) {
      if (other.effectiveAuthentication != null) return false;
    } else if (
      !effectiveAuthentication.equals(other.effectiveAuthentication)
    ) return false;
    if (realAuthentication == null) {
      if (other.realAuthentication != null) return false;
    } else if (
      !realAuthentication.equals(other.realAuthentication)
    ) return false;
    return true;
  }
  ...
  public String toString() {
    ...
    if (effectiveAuthentication == null) {
      ...
      builder.append(
        ...
        AuthenticationUtil.getMaskedUsername(effectiveAuthentication)
      );
    }
    builder.append(", ");
