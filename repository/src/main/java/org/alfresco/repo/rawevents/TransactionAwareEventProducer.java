...
public class TransactionAwareEventProducer extends AbstractEventProducer {
  ...
  private static Log logger = LogFactory.getLog(
    TransactionAwareEventProducer.class
  );
  ...
  public void send(
    ...
    List<PendingRequest> pendingRequests = AlfrescoTransactionSupport.getResource(
  ...
  private class PendingRequest {
    ...
    void send() {
      TransactionAwareEventProducer.super.send(
        endpointUri,
        exchangePattern,
        event,
        headers
  ...
  private class TransactionListener
    ...
    public void afterCommit() {
      for (TransactionAwareEventProducer.PendingRequest pendingRequest : (List<PendingRequest>) AlfrescoTransactionSupport.getResource(
        POST_TRANSACTION_PENDING_REQUESTS
      )) {
        try {
          pendingRequest.send();
