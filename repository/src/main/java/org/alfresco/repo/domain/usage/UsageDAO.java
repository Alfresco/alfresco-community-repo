...
public interface UsageDAO {
     ...
     * @param resultsCallback the callback to use while iterating over the content sizes (one row
     *     per user)
     */
     ...
     */
    public void getUsersWithoutUsage(StoreRef storeRef, MapHandler resultsCallback);
     ...
     * @param resultsCallback the callback to use while iterating over the people
     */
    public void getUsersWithUsage(StoreRef storeRef, MapHandler resultsCallback);
