...
public class UnlimitedQuotaStrategyTest {
  ...
  public void beforeWritingCacheFile() {
    ...
    assertTrue(
      "Should always allow caching",
      quota.beforeWritingCacheFile(Long.MAX_VALUE)
    );
  }
  ...
  public void afterWritingCacheFile() {
    assertTrue(
      "Should always allow cache file to remain",
      quota.afterWritingCacheFile(0)
    );
    assertTrue(
      "Should always allow cache file to remain",
      quota.afterWritingCacheFile(Long.MAX_VALUE)
    );
  }
}
