...
public class SendModeratedInviteDelegate extends AbstractInvitationDelegate {
    ...
    public static final String ENTERPRISE_EMAIL_TEMPLATE_PATH =
    ...
    private static final String EMAIL_TEMPLATE_REF =
            "alfresco/templates/workspace/invite-email-moderated.html.ftl";
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String clientName =
                (String) variables.get(WorkflowModelModeratedInvitation.wfVarClientName);
        ...
        if (clientName != null && clientAppConfig.getClient(clientName) != null) {
            ...
            final String templatePath =
                    emailHelper.getEmailTemplate(clientApp.getName(), path, EMAIL_TEMPLATE_REF);
            invitationService.sendModeratedInvitation(
                    invitationId, templatePath, EMAIL_SUBJECT_KEY, variables);
        } else {
            invitationService.sendModeratedInvitation(
                    invitationId, emailTemplatePath, EMAIL_SUBJECT_KEY, variables);
        }
    }
}
