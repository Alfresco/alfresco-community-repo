...
public abstract class AbstractWorkflowFormProcessor<ItemType, PersistType>
    ...
    protected List<Field> generateDefaultFields(
        ...
        if (extendedPropertyFieldProcessor != null) {
            ...
            ExtendedFieldBuilder fieldBuilder =
                    new ExtendedFieldBuilder(
                            data,
    ...
    /**
     * Returns an implementation of {@link ContentModelFormPersister} which is used to accumulate
     * all the changes specified in the {@link Form} and then persist them.
     *
     * @param item ItemType
     */
