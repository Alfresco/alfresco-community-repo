...
public class LockMethod extends WebDAVMethod {
  ...
  protected void parseRequestHeaders() throws WebDAVServerException {
    ...
    if (logger.isDebugEnabled()) logger.debug(
      "Timeout=" + getLockTimeout() + ", depth=" + getDepth()
    );
  }
  ...
  protected void parseRequestBody() throws WebDAVServerException {
    ...
    if (body != null) {
      OUTER:for (
        Node currentNode = body.getDocumentElement().getFirstChild();
        currentNode != null;
        ...
        if (
          ...
          for (
            Node propertiesNode = currentNode.getFirstChild();
            propertiesNode != null;
            propertiesNode = propertiesNode.getNextSibling()
          ) {
            if (
              propertiesNode instanceof Element &&
              WebDAV.DEFAULT_NAMESPACE_URI.equals(
  ...
  protected void attemptLock() throws WebDAVServerException, Exception {
    ...
    // Get the active user
    final String userName = getDAVHelper()
    ...
    try {
      ...
      if (
        ...
        getNodeService()
          .addAspect(nodeRef, ContentModel.ASPECT_WEBDAV_NO_CONTENT, null);
    ...
    if (hasLockToken()) {
      ...
      this.createExclusive =
        WebDAV.XML_EXCLUSIVE.equals(this.lockInfo.getScope());
   ...
   *
   */
  protected FileInfo createNode(
    NodeRef parentNodeRef,
    String name,
    QName typeQName
  ) {
    return getFileFolderService()
   ...
   */
  protected void generateResponse(FileInfo lockNodeInfo, String userName)
    throws Exception {
    String scope;
    String lt;
    String owner;
