...
public class StatsProcessorTest {
    ...
    public void testProcessMap() {
        ...
        assertEquals(
                ...
                statsResults
                        .get(1)
                        .getName()); // if it doesn't find the result then return the original
    ...
    public static class StatsResultSetImpl implements StatsResultSet {
        ...
        public StatsResultSetImpl(
                Long numberFound, Long sum, Long max, Long mean, List<StatsResultStat> stats) {
            super();
