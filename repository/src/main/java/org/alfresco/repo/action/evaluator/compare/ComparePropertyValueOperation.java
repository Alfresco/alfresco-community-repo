 ...
 *
 * <p>Contains the operations that can be used when evaluating whether the value of a property
 * matches the value set.
 *
 * <p>Some operations can only be used with specific types. If a mismatch is encountered an error
 * will be raised.
 */
