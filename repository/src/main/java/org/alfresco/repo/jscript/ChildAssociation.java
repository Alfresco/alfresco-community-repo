...
public class ChildAssociation implements Scopeable, Serializable {
    ...
    public ChildAssociation(
            ServiceRegistry services, ChildAssociationRef childAssocRef, Scriptable scope) {
        ...
        return (ScriptNode)
                new ValueConverter()
                        .convertValueForScript(
                                this.services, this.scope, null, childAssocRef.getParentRef());
    }
    ...
    public ScriptNode getChild() {
        return (ScriptNode)
                new ValueConverter()
                        .convertValueForScript(
                                this.services, this.scope, null, childAssocRef.getChildRef());
    }
