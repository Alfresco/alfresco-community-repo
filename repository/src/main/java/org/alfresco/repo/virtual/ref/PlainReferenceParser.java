 ...
 *
 * <p>For grammar examples see {@link Encodings#PLAIN} encoding definition.
 */
public class PlainReferenceParser implements ReferenceParser, PlainEncoding {
    ...
    public Reference parse(String referenceString) throws ReferenceParseException {
        ...
        final Cursor cursor = new Cursor(referenceTokens, 0);
    ...
    /**
     * Obtains a {@link Parameter} reference that is instance of {@link StringParameter} from the
     * cursor parameter
     *
     * @param cursor
     * @return a {@link Parameter} reference that is instance of {@link StringParameter} from the
     *     cursor parameter
     */
    ...
    /**
     * Obtains a {@link Parameter} reference that is instance of {@link ResourceParameter} from the
     * cursor parameter
     *
     * @param cursor
     * @return a {@link Parameter} reference that is instance of {@link ResourceParameter} from the
     *     cursor parameter
     * @throws ReferenceParseException
     */
    ...
    /**
     * Obtains {@link Resource} reference witch is an instance of {@link RepositoryResource} if
     * current token is {@link PlainEncoding#REPOSITORY} or an instance of {@link ClasspathResource}
     * if current token is {@link PlainEncoding#CLASSPATH}
     *
     * @param cursor
     * @return {@link Resource} reference witch an instance of {@link RepositoryResource} if current
     *     token is {@link PlainEncoding#REPOSITORY} or an instance of {@link ClasspathResource} if
     *     current token is {@link PlainEncoding#CLASSPATH}
     * @throws ReferenceParseException
     */
     ...
     * @throws ReferenceParseException
     */
    private RepositoryResource parseRepositoryResource(Cursor cursor)
            throws ReferenceParseException {
        return new RepositoryResource(parseRepositoryLocation(cursor));
    }

    /**
     * Obtains {@link RepositoryLocation} reference witch is an instance of {@link RepositoryPath}
     * if current token is {@link PlainEncoding#PATH} or an instance of {@link RepositoryNodeRef} if
     * current token is {@link PlainEncoding#NODE}
     *
     * @param cursor
     * @return A {@link RepositoryLocation} reference witch an instance of {@link RepositoryPath} if
     *     current token is {@link PlainEncoding#PATH} or an instance of {@link RepositoryNodeRef}
     *     if current token is {@link PlainEncoding#NODE}
     * @throws ReferenceParseException
     */
    private RepositoryLocation parseRepositoryLocation(Cursor cursor)
            throws ReferenceParseException {
    ...
    /**
     * Obtains {@link RepositoryNodeRef} reference from store protocol, store identifier and node id
     * obtained from cursor's tokens starting with current token of the cursor.
     *
     * @param cursor
     * @return A {@link RepositoryNodeRef} reference from store protocol, store identifier and node
     *     id obtained from cursor's tokens starting with current token of the cursor.
     */
    ...
    private ReferenceParameter parseReferenceParameter(Cursor cursor)
            throws ReferenceParseException {
