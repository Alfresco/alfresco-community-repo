...
public interface DataSetService {
    ...
    /**
     * Gets the details of all available data sets for a file plan depending on the parameter
     * "excludeLoaded".
     *
     * @param filePlan the file plan for which the details should be retrieved
     * @param excludeLoaded if true only data sets will be retrieved which has not been loaded
     * @return Map&lt;String, DataSet&gt; with details of the available data sets for a specified
     *     file plan depending on the parameter "excludeLoaded". The result could also be an empty
     *     map
     */
     ...
     *
     * @param filePlan the file plan for which the loaded data sets should be retrieved
     * @return Map&lt;String, DataSet&gt; details of all loaded data sets or an empty map if there
     *     has not been any data sets loaded for the specified file plan
     */
     ...
     * @param dataSetId the id of the data set which should be checked if it has been loaded to the
     *     file plan
     * @return true if the data set with the specified id has been loaded into the specified file
