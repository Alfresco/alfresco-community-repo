...
public class GetTaskVariablesTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that user that is not involved in the process gets task variables")
    ...
    @TestRail(
            ...
            description =
                    "Verify if get task variables request returns status code 404 when invalid"
                            + " taskId is used")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get task variables request returns status code 404 when empty taskId"
                            + " is used")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get task variables request returns status code 200 after the task is"
                            + " finished.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get task variables request returns status code 200 after the process"
                            + " is deleted (Task state is now completed.)")
    public void getTaskVariablesAfterDeletingProcess() throws Exception {
        ...
        RestTaskModel addedTask =
                restClient.withWorkflowAPI().getTasks().getTaskModelByProcess(addedProcess);
    ...
    public void getTaskVariablesWithWhereClauseAsParameter() throws Exception {
        ...
        variableModels
                ...
                .and()
                .entriesListDoesNotContain("scope", "global")
                .and()
        ...
        variableModels
                .assertThat()
                .entriesListContains("scope", "global")
                .and()
                .paginationField("totalItems")
                .is("30");
    }
    ...
    public void getTaskVariablesWithMaxItems() throws Exception {
        ...
        variableModels =
                restClient
                        ...
                        .getTaskVariables();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        variableModels.assertThat().entriesListIsNotEmpty().and().paginationField("count").is("2");
    }
    ...
    public void getTaskVariablesWithSkipCount() throws Exception {
        ...
        variableModels =
                restClient
                        .authenticateUser(userWhoStartsTask)
                        .withWorkflowAPI()
                        .usingParams("skipCount=10")
                        .usingTask(taskModel)
                        .getTaskVariables();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        variableModels.assertThat().entriesListIsNotEmpty().and().paginationField("count").is("20");
    }
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                ...
                                "Invalid value for 'scope' used in query: fake-where."))
    ...
    public void getTaskVariablesWithValidProperties() throws Exception {
        ...
        variableModels =
                restClient
                        .authenticateUser(userWhoStartsTask)
                        .withParams("properties=scope,name")
                        .withWorkflowAPI()
                        .usingTask(taskModel)
                        .getTaskVariables();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user cannot get tasks variables with invalid 'properties' parameter")
