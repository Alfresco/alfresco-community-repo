...
public class DeleteTreeTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to delete parent folder with multiple children in"
    ...
    @TestRail(
            ...
            description =
                    "Verify exception is thrown when deleting inexistent folder tree in"
                            + " DocumentLibrary with CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify inexistent user is NOT able to delete parent folder with multiple"
                            + " children in DocumentLibrary")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete parent folder with allVersions parameter"
                            + " set to true")
    ...
    public void siteManagerDeletesFolderTreeWithAllVersionsParamTrue() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .when()
                .usingResource(parentTestFolder)
                .deleteFolderTree(true, UnfileObject.DELETE, true)
                .and()
                .assertThat()
                .doesNotExistInRepo()
                .then()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Only allVersions=true is supported for delete parent folder tree,"
                            + " allVersions=true is not supported")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    public void deleteFolderTreeWithAllVersionsParamFalseNotSupported() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .when()
                .usingResource(parentTestFolder)
                .deleteFolderTree(false, UnfileObject.DELETE, true)
                .and()
                .assertThat()
                .doesNotExistInRepo()
                .then()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is NOT able to delete parent folder with unfile parameter"
                            + " set to DELETESINGLEFILED, using checked out document")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerDeletesFolderTreeWithDeleteSingleFieldWithCheckoutDoc()
            throws Exception {
        parentTestFolder = FolderModel.getRandomFolderModel();
        childTestFolder = FolderModel.getRandomFolderModel();
        testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
        cmisApi.authenticateUser(testUser)
                ...
                .when()
                .usingResource(parentTestFolder)
                .deleteFolderTree(true, UnfileObject.DELETESINGLEFILED, true)
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is NOT able to delete parent folder with unfile parameter"
                            + " set to DELETESINGLEFILED, using add object to folder")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerDeletesFolderTreeWithDeleteSingleFieldWithAddDocToFolder1()
            throws Exception {
        parentTestFolder = FolderModel.getRandomFolderModel();
        childTestFolder = FolderModel.getRandomFolderModel();
        testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
        cmisApi.authenticateUser(testUser)
                ...
                .existsInRepo()
                .usingResource(testFile)
                .addDocumentToFolder(childTestFolder, true)
                .then()
                .usingResource(childTestFolder)
                .deleteFolderTree(true, UnfileObject.DELETESINGLEFILED, true)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete parent folder with unfile parameter set"
                            + " to DELETESINGLEFILED, using add object to folder")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerDeletesFolderTreeWithDeleteSingleFieldWithAddDocToFolder2()
            throws Exception {
        parentTestFolder = FolderModel.getRandomFolderModel();
        childTestFolder = FolderModel.getRandomFolderModel();
        testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
    ...
    public void deleteFolderTreeWithUnfileNotSupported() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .when()
                .usingResource(parentTestFolder)
                .deleteFolderTree(true, UnfileObject.UNFILE, true)
                .and()
                .assertThat()
                .doesNotExistInRepo()
                .then()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete parent folder with continueOnFailure"
    ...
    public void siteManagerDeletesFolderTreeWithContinueOnFailureParamFalse() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .when()
                .usingResource(parentTestFolder)
                .deleteFolderTree(true, UnfileObject.DELETE, false)
                .and()
                .assertThat()
                .doesNotExistInRepo()
                .then()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to delete parent folder with multiple children"
                            + " created by himself")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to delete parent folder with multiple"
                            + " children created by manager")
    ...
    public void contributorCannotDeleteFolderTreeCreatedByManager() throws Exception {
        ...
        cmisApi.authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteContributor))
                ...
                .and()
                .assertThat()
                .hasFailedDeletedObject(parentTestFolder.getNodeRef())
                .and()
                .assertThat()
                .existsInRepo()
                .usingResource(childTestFolder)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is not able to delete parent folder with multiple"
                            + " children created by manager")
    @Test(groups = {"bug-atom-REPO-5390", TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to delete parent folder with multiple"
                            + " children created by himself")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is not able to delete parent folder with multiple"
                            + " children created by manager")
    @Test(groups = {"bug-atom-REPO-5390", TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is not able to delete parent folder with multiple"
                            + " children in private site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that only the parent folder is displayed in trash can after deleting"
                            + " it")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
