...
public class AlfrescoPerson extends AbstractPersonRule {
    ...
    /**
     * Constructs the rule with a spring ApplicationContext. A GUID-generated username will be used
     * for the test user.
     *
     ...
     * used to retrieve the ApplicationContext. A GUID-generated username will be used for the test
     * user.
     *
    ...
    protected void before() {
        ...
        RetryingTransactionHelper transactionHelper =
                (RetryingTransactionHelper) ctxt.getBean("retryingTransactionHelper");
