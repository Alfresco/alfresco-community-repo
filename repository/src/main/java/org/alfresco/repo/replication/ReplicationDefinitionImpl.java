...
public class ReplicationDefinitionImpl
   ...
   */
  public ReplicationDefinitionImpl(
    String id,
  ...
  public QName getReplicationQName() {
    Serializable parameterValue = getParameterValue(
  ...
  public NodeRef getLocalTransferReport() {
    return (NodeRef) getParameterValue(
  ...
  public void setScheduleIntervalCount(Integer count) {
    if (schedule == null) throw new IllegalStateException(
