...
public class AddProcessVariableCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variable is falling in case invalid type prefix is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variable is falling in case missing required variable body"
                            + " (name) is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variable is falling in case invalid variableBody (adding extra"
                            + " parameter in body) is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
