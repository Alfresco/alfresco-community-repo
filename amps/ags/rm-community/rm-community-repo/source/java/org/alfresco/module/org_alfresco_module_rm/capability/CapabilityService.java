...
public interface CapabilityService {
     ...
     *
     * @param includePrivate indicates that the private, or non-assignable capabilities are included
     *     in the result
    ...
    /**
     * Get all the capabilities access state based on the current user for the assignable
     * capabilities.
     *
     ...
     * @return
     */
    Map<Capability, AccessStatus> getCapabilitiesAccessState(
