...
public class ModelUsageDataCollector
  ...
  public List<HBData> collectData() {
    ...
    final CustomModelsInfo customModelsInfo = transactionService
    ...
    modelUsageValues.put(
      "numOfActiveModels",
      new Integer(customModelsInfo.getNumberOfActiveModels())
    );
    modelUsageValues.put(
      "numOfActiveTypes",
      new Integer(customModelsInfo.getNumberOfActiveTypes())
    );
    modelUsageValues.put(
      "numOfActiveAspects",
      new Integer(customModelsInfo.getNumberOfActiveAspects())
    );
