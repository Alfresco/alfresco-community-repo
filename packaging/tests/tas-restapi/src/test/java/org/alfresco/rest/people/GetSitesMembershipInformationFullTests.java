...
public class GetSitesMembershipInformationFullTests extends RestTest {
  ...
  public void getSiteMembershipInformationUsingPropertiesParameter()
    throws Exception {
    ...
    sitesMembershipInformation
      ...
      .and()
      .entriesListDoesNotContain("site")
      .and()
      .entriesListDoesNotContain("role")
      .and()
  ...
  public void getSiteMembershipInformationUsingOrderAscByParameter()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
  ...
  public void getSiteMembershipInformationUsingOrderDescByParameter()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
        .withParams("orderBy=id Desc")
        .withCoreAPI()
        .usingAuthUser()
        .getSitesMembershipInformation();
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void getSiteMembershipInformationUsingOrderByRoleParameter()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
        .withParams("orderBy=role")
        .withCoreAPI()
        .usingAuthUser()
        .getSitesMembershipInformation();
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void userCanGetSiteMembershipInformationOfAnotherUser()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
        .withCoreAPI()
        .usingUser(anotherUserModel)
        .getSitesMembershipInformation();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    sitesMembershipInformation
      .assertThat()
    ...
    sitesMembershipInformation
      ...
      .is(anotherUserSite.getVisibility().toString())
      .and()
      .field("site.guid")
      .is(anotherUserSite.getGuid())
      .and()
      .field("site.description")
      .is(anotherUserSite.getDescription())
      .and()
      .field("site.id")
      .is(anotherUserSite.getId())
      .and()
      .field("site.preset")
      .is("site-dashboard")
      .and()
      .field("site.title")
      .is(anotherUserSite.getTitle())
      .and()
      .field("id")
      .is(anotherUserSite.getId())
      .and()
      ...
      .and()
      .field("role")
      .is(UserRole.SiteCollaborator.toString());
  }
  ...
  public void getSiteMembershipInformationUsingRelationsParameter()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
        .withParams("relations=site-membership-requests")
        .withCoreAPI()
        .usingAuthUser()
        .getSitesMembershipInformation();
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void getSiteMembershipInformationWhenASiteRequestIsRejected()
    throws Exception {
    UserModel userWithRequests = dataUser.createRandomTestUser();

    restClient
      .authenticateUser(userWithRequests)
      .withCoreAPI()
      .usingAuthUser()
    ...
    RestTaskModel taskModel = restClient
      ...
      .withWorkflowAPI()
      .getTasks()
      .getTaskModelByDescription(moderatedSiteModel);
  ...
  public void getSiteMembershipInformationWhenASiteRequestIsAppropved()
    throws Exception {
    UserModel userWithRequests = dataUser.createRandomTestUser();
    ...
    sitesMembershipInformation
      ...
      .and()
      .entriesListContains("guid", moderatedSiteModel.getGuid())
      .and()
      .entriesListContains("id", moderatedSiteModel.getId())
      .and()
      .paginationField("count")
  ...
  public void getSiteMembershipInformationUsingMaxItemsParameter()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
  ...
  public void getSiteMembershipInformationUsingSkipCountParameter()
    throws Exception {
    sitesMembershipInformation =
      restClient
        .authenticateUser(userModel)
