...
public class ACLEntryVoterTest extends AbstractPermissionTest {
        ...
        Method method =
                o.getClass()
                        .getMethod(
                                "testManyNodeRef",
                                new Class[] {
                                    NodeRef.class, NodeRef.class, NodeRef.class, NodeRef.class
                                });
    ...
    public void testMultiChildAssocRefMethodsArg0() throws Exception {
        ...
        try {
            method.invoke(
                    proxy,
                    new Object[] {nodeService.getPrimaryParent(rootNodeRef), null, null, null});
            fail(SHOULD_FAIL_DENIED);
        } catch (InvocationTargetException e) {
            verifyAccessDenied(e);
        }
        ...
        permissionService.setPermission(
                new SimplePermissionEntry(
                        ...
                        AccessStatus.ALLOWED));
        method.invoke(
                proxy, new Object[] {nodeService.getPrimaryParent(rootNodeRef), null, null, null});
    }
    ...
    public void testMultiChildAssocRefMethodsArg1() throws Exception {
        ...
        try {
            method.invoke(
                    proxy,
                    new Object[] {null, nodeService.getPrimaryParent(rootNodeRef), null, null});
            fail(SHOULD_FAIL_DENIED);
        } catch (InvocationTargetException e) {
            verifyAccessDenied(e);
        }
        ...
        permissionService.setPermission(
                new SimplePermissionEntry(
                        ...
                        AccessStatus.ALLOWED));
        method.invoke(
                proxy, new Object[] {null, nodeService.getPrimaryParent(rootNodeRef), null, null});
    }
    ...
    public void testMultiChildAssocRefMethodsArg2() throws Exception {
        ...
        try {
            method.invoke(
                    proxy,
                    new Object[] {null, null, nodeService.getPrimaryParent(rootNodeRef), null});
            fail(SHOULD_FAIL_DENIED);
        } catch (InvocationTargetException e) {
            verifyAccessDenied(e);
        }
        ...
        permissionService.setPermission(
                new SimplePermissionEntry(
                        ...
                        AccessStatus.ALLOWED));
        method.invoke(
                proxy, new Object[] {null, null, nodeService.getPrimaryParent(rootNodeRef), null});
    }
    ...
    public void testMultiChildAssocRefMethodsArg3() throws Exception {
        ...
        try {
            method.invoke(
                    proxy,
                    new Object[] {null, null, null, nodeService.getPrimaryParent(rootNodeRef)});
            fail(SHOULD_FAIL_DENIED);
        } catch (InvocationTargetException e) {
            verifyAccessDenied(e);
        }
        ...
        permissionService.setPermission(
                new SimplePermissionEntry(
                        ...
                        AccessStatus.ALLOWED));
        method.invoke(
                proxy, new Object[] {null, null, null, nodeService.getPrimaryParent(rootNodeRef)});
    }
    ...
    public void testMethodACL4() throws Exception {
        ...
        ProxyFactory proxyFactory = new ProxyFactory();
        proxyFactory.addAdvisor(
                advisorAdapterRegistry.wrap(new Interceptor("ACL_METHOD.woof", "ACL_METHOD.BOO")));
        proxyFactory.setTargetSource(new SingletonTargetSource(o));
        Object proxy = proxyFactory.getProxy();
    ...
    public static class ClassWithMethods {
        ...
        public void testManyNodeRef(
                NodeRef nodeRef1, NodeRef nodeRef2, NodeRef nodeRef3, NodeRef nodeRef4) {}
