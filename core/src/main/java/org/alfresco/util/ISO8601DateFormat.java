 ...
 * where:
 * <ul>
 * <li>sYYYY Four-digit year with optional leading positive (<b>+</b>) or negative (<b>-</b>) sign. A negative sign indicates a year BCE. The absence of a sign or the presence of a positive sign indicates a year CE (for example, -0055 would indicate the year 55 BCE, while +1969 and 1969 indicate the year 1969 CE).</li>
...
public class ISO8601DateFormat
{
     ...
     * 
     * @param timezone
     *            timezone object to indicate the timezone to be used by the returned calendar object
     ...
     * 
     * @param isoDate
     * @return the ISO Zulu timezone formatted string e.g 2011-02-04T17:13:14.000+01:00 -> 2011-02-04T16:13:14.000Z
     */
     ...
     * 
     * @param isoDate
     *            the day (formatted sYYYY-MM-DD) or a full date (sYYYY-MM-DDThh:mm:ss.sssTZD)
     * @param timezone
     *            the timezone to use
