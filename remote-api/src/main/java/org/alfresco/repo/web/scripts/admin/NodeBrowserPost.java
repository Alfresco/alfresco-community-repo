...
public class NodeBrowserPost extends DeclarativeWebScript implements Serializable
{
    ...
    public class ChildAssocRefWrapper implements Serializable
    {
        ...
        {
            return typeqname != null ? typeqname : (typeqname = ref.getTypeQName() != null ? ref.getTypeQName().toPrefixString(getNamespaceService()) : "");
        }

        public String getQName()
        {
            return qname != null ? qname : (qname = ref.getQName() != null ? ref.getQName().toPrefixString(getNamespaceService()) : "");
        }
