...
public class DictionaryModelTypeTest extends BaseSpringTest {
  ...
  private static final QName TEST_MODEL_ONE = QName.createQName(
    "{http://www.alfresco.org/test/testmodel1/1.0}testModelOne"
  );
  private static final QName TEST_MODEL_TWO = QName.createQName(
    "{http://www.alfresco.org/test/testmodel2/1.0}testModelTwo"
  );
  private static final QName TEST_MODEL_THREE = QName.createQName(
    "{http://www.alfresco.org/test/testmodel3/1.0}testModelThree"
  );
  ...
  public void before() throws Exception {
    ...
    this.dictionaryDAO =
      (DictionaryDAO) this.applicationContext.getBean("dictionaryDAO");
    this.nodeService =
      (NodeService) this.applicationContext.getBean("NodeService");
    this.policyComponent =
      (PolicyComponent) this.applicationContext.getBean("policyComponent");

    TenantAdminService tenantAdminService = (TenantAdminService) this.applicationContext.getBean(
        "tenantAdminService"
      );
    MessageService messageService = (MessageService) this.applicationContext.getBean(
        "messageService"
      );
  ...
  public void testCreateAndUpdateDictionaryModelNodeContent() throws Exception {
    ...
    // Create a model node
    final NodeRef modelNode = transactionService
    ...
    final NodeRef workingCopy = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Exception {
            ...
            assertEquals(
              ...
              DictionaryModelTypeTest.this.nodeService.getProperty(
                  modelNode,
                  ContentModel.PROP_MODEL_DESCRIPTION
                )
            );
            assertEquals(
              "Alfresco",
            ...
            String uri2 =
              DictionaryModelTypeTest.this.namespaceService.getNamespaceURI(
                  "test1"
                );
            ...
            NodeRef workingCopy =
              DictionaryModelTypeTest.this.cociService.checkout(modelNode);
    ...
    final NodeRef node1 = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Exception {
  ...
  public void testUpdateDictionaryModelConstraintDelete() throws Exception {
      ...
      .doInTransaction(
        new RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Exception {
            ...
            Collection<ConstraintDefinition> constraints = dictionaryService.getConstraints(
              TEST_MODEL_TWO,
              true
            );
            ...
            assertEquals(
              "test2:con1",
              constraints.iterator().next().getName().getPrefixString()
            );
    ...
    try {
      ...
      assertTrue(
        are.getMessage().contains("Failed to validate constraint delete")
      );
    }
        ...
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            try {
              ...
              fail(
                "This model has not yet been loaded into the dictionary service"
              );
            } catch (DictionaryException exception) {
              // We expect this exception
            }
    ...
    try {
            ...
            public Void execute() throws Exception {
              ...
              contentWriter.putContent(
                Thread
                  ...
                  .getResourceAsStream("dictionary/testModel2.xml")
              );
              return null;
            }
          }
      ...
      assertTrue(
        e
          ...
          .getMessage()
          .contains(
            "URI mage.model cannot be imported as it is already contained in the model's namespaces"
          )
      );
  ...
  public void testImportingSameNamespaceFailsWithinSingleModel()
    throws Exception {
    // Create model
    PropertyMap properties = new PropertyMap(1);
    properties.put(ContentModel.PROP_MODEL_ACTIVE, true);
    ...
    try {
      ...
      assertTrue(
        e
          ...
          .getMessage()
          .contains(
            "URI http://www.alfresco.org/model/dictionary/1.0 cannot be imported as it is already contained in the model's namespaces"
          )
      );
      throw e;
    } finally { //delete model
  ...
  public void testCircularDependencyDetected() throws Exception {
    ...
    try {
      ...
      assertTrue(
        e
          .getMessage()
          .contains(
            "Failed to validate model update - found circular dependency. You can't set parent model-B as it's model already depends on prefixA:model-A"
          )
      );
    }
    ...
    } finally { //delete both created models
      transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<Object>() {
