...
public class EntityLookupCacheTest
  extends TestCase
  implements EntityLookupCallbackDAO<Long, Object, String> {
  ...
  protected void setUp() throws Exception {
    ...
    entityLookupCacheA =
      new EntityLookupCache<Long, Object, String>(cache, "A", this);
    entityLookupCacheB =
      new EntityLookupCache<Long, Object, String>(cache, "B", this);
    database = new TreeMap<Long, String>();

    controlDAO = Mockito.mock(ControlDAO.class);
    Mockito
      .when(controlDAO.createSavepoint(Mockito.anyString()))
      .thenReturn(Mockito.mock(Savepoint.class));
  }
  ...
  public void testLookupAgainstEmpty() throws Exception {
    ...
    assertTrue(
      "Database ID should have been created",
      database.containsKey(entityId)
    );
    ...
    assertTrue(
      "Looked-up type incorrect",
      entityPair.getSecond() instanceof TestValue
    );
    assertEquals(
      "Looked-up type value incorrect",
      value,
  ...
  public void testLookupAgainstExisting() throws Exception {
    ...
    // Look up by value
    Pair<Long, Object> entityPair = entityLookupCacheA.getByValue(
      new TestValue("AAA")
    );
  ...
  public void testRegions() throws Exception {
    ...
    Pair<Long, Object> entityPairAAA = entityLookupCacheA.getOrCreateByValue(
      valueAAA
    );
    ...
    Pair<Long, Object> entityPairBBB = entityLookupCacheB.getOrCreateByValue(
      valueBBB
    );
  ...
  public void testNullLookups() throws Exception {
    ...
    Pair<Long, Object> entityPairNull = entityLookupCacheA.getOrCreateByValue(
      valueNull
    );
    ...
    // Look it up again
    Pair<Long, Object> entityPairCheck = entityLookupCacheA.getOrCreateByValue(
      valueNull
    );
    assertNotNull(entityPairNull);
    assertTrue(database.containsKey(entityPairNull.getFirst()));
  ...
  public void testGetOrCreate() throws Exception {
    ...
    Pair<Long, Object> entityPairOne = entityLookupCacheA.getOrCreateByValue(
      valueOne
    );
    ...
    Pair<Long, Object> entityPairOneCheck = entityLookupCacheA.getOrCreateByValue(
      valueOne
    );
  ...
  public void testCreateOrGet() throws Exception {
    TestValue valueOne = new TestValue(getName() + "-ONE");
    Pair<Long, Object> entityPairOne = entityLookupCacheA.createOrGetByValue(
      valueOne,
      controlDAO
    );
    assertNotNull(entityPairOne);
    ...
    Pair<Long, Object> entityPairOneCheck = entityLookupCacheA.createOrGetByValue(
      valueOne,
      controlDAO
    );
    assertNotNull(entityPairOneCheck);
