...
public class FileTypeImageUtils {
    ...
    private static final String DEFAULT_FILE_IMAGE16 =
            IMAGE_PREFIX16 + "_default" + IMAGE_POSTFIX_GIF;
    private static final String DEFAULT_FILE_IMAGE32 =
            IMAGE_PREFIX32 + "_default" + IMAGE_POSTFIX_GIF;
    private static final String DEFAULT_FILE_IMAGE64 =
            IMAGE_PREFIX64 + "_default" + IMAGE_POSTFIX_PNG;

    private static final Map<String, String> s_fileExtensionMap =
            new HashMap<String, String>(89, 1.0f);
    ...
    public static String getFileTypeImage(ServletContext sc, String name, boolean small) {
        return getFileTypeImage(
                sc, name, (small ? FileTypeImageSize.Small : FileTypeImageSize.Medium));
    }
            ...
            synchronized (s_fileExtensionMap) {
                ...
                if (image == null) {
                    ...
                    if (size != FileTypeImageSize.Large) {
                        image =
                                (size == FileTypeImageSize.Small ? IMAGE_PREFIX16 : IMAGE_PREFIX32)
                                        + ext
                                        + IMAGE_POSTFIX_GIF;
                    } else {
