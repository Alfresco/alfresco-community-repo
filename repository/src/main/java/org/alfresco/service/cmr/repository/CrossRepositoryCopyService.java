...
public interface CrossRepositoryCopyService {
    /**
     * This copies recursively src, which may be a container or a content type to dst, which must be
     * a container. Copied nodes will have the copied from aspect applied to them.
     *
