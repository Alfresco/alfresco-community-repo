...
public class OptionsMethod extends WebDAVMethod {
  ...
  private static final String FILE_METHODS =
  ...
  protected void executeImpl() throws WebDAVServerException {
    ...
    m_response.addHeader(
      ALLOW_HEADER,
      isFolder ? COLLECTION_METHODS : FILE_METHODS
    );
  }
}
