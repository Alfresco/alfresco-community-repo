...
/**
 * An {@link JobHandler} which executes activiti jobs authenticated against Alfresco. The job is
 * executed as the process-initiator. If initiator is not available, system user is used.
 *
