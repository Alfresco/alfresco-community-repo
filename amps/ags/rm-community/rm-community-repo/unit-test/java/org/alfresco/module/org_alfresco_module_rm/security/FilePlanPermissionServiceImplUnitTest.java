 ...
 * <p>
 * Primarily tests the file plan permission service interaction with the permission service.
 * 
...
public class FilePlanPermissionServiceImplUnitTest extends BaseUnitTest
{
     ...
     *            child node
     * @param read
     *            verification mode relating to setting read on the child
     * @param filling
     *            verification mode relating to setting filling on the child
     */
