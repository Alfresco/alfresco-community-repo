...
public class WhereClauseParser extends Parser {
    ...
    // org/alfresco/rest/antlr/WhereClause.g:128:1: whereclause : ( WS )? LEFTPAREN ! ( WS )?
    // predicate RIGHTPAREN ! ( WS )? ;
    public final WhereClauseParser.whereclause_return whereclause() throws RecognitionException {
        ...
        try {
            // org/alfresco/rest/antlr/WhereClause.g:128:13: ( ( WS )? LEFTPAREN ! ( WS )? predicate
            // RIGHTPAREN ! ( WS )? )
            // org/alfresco/rest/antlr/WhereClause.g:128:15: ( WS )? LEFTPAREN ! ( WS )? predicate
            // RIGHTPAREN ! ( WS )?
            {
    ...
    // org/alfresco/rest/antlr/WhereClause.g:129:1: predicate : ( simplepredicate | simplepredicate
    // ( AND simplepredicate )+ -> ^( AND ( simplepredicate )+ ) | simplepredicate ( OR
    ...
    public final WhereClauseParser.predicate_return predicate() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_simplepredicate =
                new RewriteRuleSubtreeStream(adaptor, "rule simplepredicate");
        try {
            // org/alfresco/rest/antlr/WhereClause.g:129:11: ( simplepredicate | simplepredicate (
            // AND simplepredicate )+ -> ^( AND ( simplepredicate )+ ) | simplepredicate ( OR
            // simplepredicate )+ -> ^( OR ( simplepredicate )+ ) )
            int alt6 = 3;
            ...
            switch (alt6) {
                case 1:
                    ...
                    break;
                case 2:
                    // org/alfresco/rest/antlr/WhereClause.g:130:13: simplepredicate ( AND
                    // simplepredicate )+
                    {
                        ...
                        do {
                            ...
                            switch (alt4) {
                                case 1:
                                    // org/alfresco/rest/antlr/WhereClause.g:130:30: AND
                                    // simplepredicate
                                    {
                                        AND9 =
                                                (Token)
                        ...
                        {
                            // org/alfresco/rest/antlr/WhereClause.g:130:55: ^( AND (
                            // simplepredicate )+ )
                            {
                    ...
                    break;
                case 3:
                    // org/alfresco/rest/antlr/WhereClause.g:131:13: simplepredicate ( OR
                    // simplepredicate )+
                    {
                        ...
                        do {
                            ...
                            switch (alt5) {
                                case 1:
                                    // org/alfresco/rest/antlr/WhereClause.g:131:30: OR
                                    // simplepredicate
                                    {
    ...
    // org/alfresco/rest/antlr/WhereClause.g:132:1: simplepredicate : ( allowedpredicates ->
    // allowedpredicates | NEGATION allowedpredicates -> ^( NEGATION allowedpredicates ) );
    public final WhereClauseParser.simplepredicate_return simplepredicate()
            throws RecognitionException {
        WhereClauseParser.simplepredicate_return retval =
                new WhereClauseParser.simplepredicate_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleTokenStream stream_NEGATION =
                new RewriteRuleTokenStream(adaptor, "token NEGATION");
        RewriteRuleSubtreeStream stream_allowedpredicates =
                new RewriteRuleSubtreeStream(adaptor, "rule allowedpredicates");
        try {
            // org/alfresco/rest/antlr/WhereClause.g:132:17: ( allowedpredicates ->
            // allowedpredicates | NEGATION allowedpredicates -> ^( NEGATION allowedpredicates ) )
            int alt7 = 2;
            ...
            switch (alt7) {
                ...
                case 2:
                    // org/alfresco/rest/antlr/WhereClause.g:133:19: NEGATION allowedpredicates
                    {
                        ...
                        {
                            // org/alfresco/rest/antlr/WhereClause.g:133:49: ^( NEGATION
                            // allowedpredicates )
                            {
                                Object root_1 = (Object) adaptor.nil();
                                root_1 =
                                        (Object)
                                                adaptor.becomeRoot(
                                                        stream_NEGATION.nextNode(), root_1);
    ...
    // org/alfresco/rest/antlr/WhereClause.g:134:1: allowedpredicates : ( comparisonpredicate |
    // existspredicate | betweenpredicate | inpredicate | matchespredicate );
    public final WhereClauseParser.allowedpredicates_return allowedpredicates()
            throws RecognitionException {
        WhereClauseParser.allowedpredicates_return retval =
                new WhereClauseParser.allowedpredicates_return();
        retval.start = input.LT(1);
        ...
        try {
            // org/alfresco/rest/antlr/WhereClause.g:134:19: ( comparisonpredicate | existspredicate
            // | betweenpredicate | inpredicate | matchespredicate )
            int alt8 = 5;
    ...
    // org/alfresco/rest/antlr/WhereClause.g:135:1: comparisonpredicate : PROPERTYNAME
    // comparisonoperator value -> ^( comparisonoperator PROPERTYNAME value ) ;
    public final WhereClauseParser.comparisonpredicate_return comparisonpredicate()
            throws RecognitionException {
        WhereClauseParser.comparisonpredicate_return retval =
                new WhereClauseParser.comparisonpredicate_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleTokenStream stream_PROPERTYNAME =
                new RewriteRuleTokenStream(adaptor, "token PROPERTYNAME");
        RewriteRuleSubtreeStream stream_comparisonoperator =
                new RewriteRuleSubtreeStream(adaptor, "rule comparisonoperator");
        RewriteRuleSubtreeStream stream_value = new RewriteRuleSubtreeStream(adaptor, "rule value");
        try {
            // org/alfresco/rest/antlr/WhereClause.g:135:20: ( PROPERTYNAME comparisonoperator value
            // -> ^( comparisonoperator PROPERTYNAME value ) )
            // org/alfresco/rest/antlr/WhereClause.g:135:22: PROPERTYNAME comparisonoperator value
            {
                ...
                {
                    // org/alfresco/rest/antlr/WhereClause.g:135:63: ^( comparisonoperator
                    // PROPERTYNAME value )
                    {
                        Object root_1 = (Object) adaptor.nil();
                        root_1 =
                                (Object)
                                        adaptor.becomeRoot(
                                                stream_comparisonoperator.nextNode(), root_1);
    ...
    // org/alfresco/rest/antlr/WhereClause.g:136:1: comparisonoperator : ( EQUALS | LESSTHAN |
    ...
    public final WhereClauseParser.comparisonoperator_return comparisonoperator()
            throws RecognitionException {
        WhereClauseParser.comparisonoperator_return retval =
                new WhereClauseParser.comparisonoperator_return();
        retval.start = input.LT(1);
        ...
        try {
            // org/alfresco/rest/antlr/WhereClause.g:136:19: ( EQUALS | LESSTHAN | GREATERTHAN |
    ...
    // org/alfresco/rest/antlr/WhereClause.g:137:1: existspredicate : EXISTS LEFTPAREN ( WS )?
    // PROPERTYNAME RIGHTPAREN -> ^( EXISTS PROPERTYNAME ) ;
    public final WhereClauseParser.existspredicate_return existspredicate()
            throws RecognitionException {
        WhereClauseParser.existspredicate_return retval =
                new WhereClauseParser.existspredicate_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleTokenStream stream_LEFTPAREN =
                new RewriteRuleTokenStream(adaptor, "token LEFTPAREN");
        RewriteRuleTokenStream stream_PROPERTYNAME =
                new RewriteRuleTokenStream(adaptor, "token PROPERTYNAME");
        RewriteRuleTokenStream stream_EXISTS = new RewriteRuleTokenStream(adaptor, "token EXISTS");
        RewriteRuleTokenStream stream_RIGHTPAREN =
                new RewriteRuleTokenStream(adaptor, "token RIGHTPAREN");
        RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(adaptor, "token WS");

        try {
            // org/alfresco/rest/antlr/WhereClause.g:137:16: ( EXISTS LEFTPAREN ( WS )? PROPERTYNAME
            // RIGHTPAREN -> ^( EXISTS PROPERTYNAME ) )
            // org/alfresco/rest/antlr/WhereClause.g:137:18: EXISTS LEFTPAREN ( WS )? PROPERTYNAME
            // RIGHTPAREN
            {
                ...
                LEFTPAREN27 =
                        (Token) match(input, LEFTPAREN, FOLLOW_LEFTPAREN_in_existspredicate967);
                ...
                RIGHTPAREN30 =
                        (Token) match(input, RIGHTPAREN, FOLLOW_RIGHTPAREN_in_existspredicate974);
    ...
    // org/alfresco/rest/antlr/WhereClause.g:138:1: betweenpredicate : PROPERTYNAME BETWEEN
    // LEFTPAREN ( WS )? propertyvaluepair RIGHTPAREN -> ^( BETWEEN PROPERTYNAME propertyvaluepair )
    // ;
    public final WhereClauseParser.betweenpredicate_return betweenpredicate()
            throws RecognitionException {
        WhereClauseParser.betweenpredicate_return retval =
                new WhereClauseParser.betweenpredicate_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleTokenStream stream_RIGHTPAREN =
                new RewriteRuleTokenStream(adaptor, "token RIGHTPAREN");
        RewriteRuleTokenStream stream_BETWEEN =
                new RewriteRuleTokenStream(adaptor, "token BETWEEN");
        RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(adaptor, "token WS");
        RewriteRuleSubtreeStream stream_propertyvaluepair =
                new RewriteRuleSubtreeStream(adaptor, "rule propertyvaluepair");
        try {
            // org/alfresco/rest/antlr/WhereClause.g:138:17: ( PROPERTYNAME BETWEEN LEFTPAREN ( WS
            // )? propertyvaluepair RIGHTPAREN -> ^( BETWEEN PROPERTYNAME propertyvaluepair ) )
            // org/alfresco/rest/antlr/WhereClause.g:138:19: PROPERTYNAME BETWEEN LEFTPAREN ( WS )?
            // propertyvaluepair RIGHTPAREN
            {
                PROPERTYNAME31 =
                        (Token)
                                match(
                ...
                LEFTPAREN33 =
                        (Token) match(input, LEFTPAREN, FOLLOW_LEFTPAREN_in_betweenpredicate992);
                ...
                RIGHTPAREN36 =
                        (Token) match(input, RIGHTPAREN, FOLLOW_RIGHTPAREN_in_betweenpredicate999);
                ...
                {
                    // org/alfresco/rest/antlr/WhereClause.g:138:86: ^( BETWEEN PROPERTYNAME
                    // propertyvaluepair )
                    {
                        Object root_1 = (Object) adaptor.nil();
    ...
    // org/alfresco/rest/antlr/WhereClause.g:139:1: inpredicate : PROPERTYNAME IN LEFTPAREN ( WS )?
    // propertyvaluelist RIGHTPAREN -> ^( IN PROPERTYNAME propertyvaluelist ) ;
    public final WhereClauseParser.inpredicate_return inpredicate() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_RIGHTPAREN =
                new RewriteRuleTokenStream(adaptor, "token RIGHTPAREN");
        RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(adaptor, "token WS");
        RewriteRuleSubtreeStream stream_propertyvaluelist =
                new RewriteRuleSubtreeStream(adaptor, "rule propertyvaluelist");
        try {
            // org/alfresco/rest/antlr/WhereClause.g:139:12: ( PROPERTYNAME IN LEFTPAREN ( WS )?
            // propertyvaluelist RIGHTPAREN -> ^( IN PROPERTYNAME propertyvaluelist ) )
            // org/alfresco/rest/antlr/WhereClause.g:139:14: PROPERTYNAME IN LEFTPAREN ( WS )?
            // propertyvaluelist RIGHTPAREN
            {
                PROPERTYNAME37 =
                        (Token) match(input, PROPERTYNAME, FOLLOW_PROPERTYNAME_in_inpredicate1015);
                ...
                RIGHTPAREN42 =
                        (Token) match(input, RIGHTPAREN, FOLLOW_RIGHTPAREN_in_inpredicate1026);
                ...
                {
                    // org/alfresco/rest/antlr/WhereClause.g:139:76: ^( IN PROPERTYNAME
                    // propertyvaluelist )
                    {
                        Object root_1 = (Object) adaptor.nil();
    ...
    // org/alfresco/rest/antlr/WhereClause.g:140:1: matchespredicate : PROPERTYNAME MATCHES
    // LEFTPAREN ( WS )? value RIGHTPAREN -> ^( MATCHES PROPERTYNAME value ) ;
    public final WhereClauseParser.matchespredicate_return matchespredicate()
            throws RecognitionException {
        WhereClauseParser.matchespredicate_return retval =
                new WhereClauseParser.matchespredicate_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleTokenStream stream_RIGHTPAREN =
                new RewriteRuleTokenStream(adaptor, "token RIGHTPAREN");
        RewriteRuleTokenStream stream_MATCHES =
                new RewriteRuleTokenStream(adaptor, "token MATCHES");
        RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(adaptor, "token WS");
        RewriteRuleSubtreeStream stream_value = new RewriteRuleSubtreeStream(adaptor, "rule value");
        try {
            // org/alfresco/rest/antlr/WhereClause.g:140:17: ( PROPERTYNAME MATCHES LEFTPAREN ( WS
            // )? value RIGHTPAREN -> ^( MATCHES PROPERTYNAME value ) )
            // org/alfresco/rest/antlr/WhereClause.g:140:19: PROPERTYNAME MATCHES LEFTPAREN ( WS )?
            // value RIGHTPAREN
            {
                PROPERTYNAME43 =
                        (Token)
                ...
                LEFTPAREN45 =
                        (Token) match(input, LEFTPAREN, FOLLOW_LEFTPAREN_in_matchespredicate1046);
                ...
                RIGHTPAREN48 =
                        (Token) match(input, RIGHTPAREN, FOLLOW_RIGHTPAREN_in_matchespredicate1053);
                ...
                // 140:71: -> ^( MATCHES PROPERTYNAME value )
                {
                    ...
                    {
                        Object root_1 = (Object) adaptor.nil();
                        root_1 = (Object) adaptor.becomeRoot(stream_MATCHES.nextNode(), root_1);
    ...
    public final WhereClauseParser.propertyvaluepair_return propertyvaluepair()
            throws RecognitionException {
        WhereClauseParser.propertyvaluepair_return retval =
                new WhereClauseParser.propertyvaluepair_return();
        retval.start = input.LT(1);
    ...
    // org/alfresco/rest/antlr/WhereClause.g:142:1: propertyvaluelist : value ( COMMA value )* -> (
    // value )+ ;
    public final WhereClauseParser.propertyvaluelist_return propertyvaluelist()
            throws RecognitionException {
        WhereClauseParser.propertyvaluelist_return retval =
                new WhereClauseParser.propertyvaluelist_return();
        retval.start = input.LT(1);
    ...
    // $ANTLR start "value"
    // org/alfresco/rest/antlr/WhereClause.g:143:1: value : (a= PROPERTYVALUE -> ^(
    // PROPERTYVALUE[$a] ) |b= PROPERTYNAME -> ^( PROPERTYVALUE[$b] ) );
    public final WhereClauseParser.value_return value() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_PROPERTYVALUE =
                new RewriteRuleTokenStream(adaptor, "token PROPERTYVALUE");

        try {
            // org/alfresco/rest/antlr/WhereClause.g:143:6: (a= PROPERTYVALUE -> ^(
            // PROPERTYVALUE[$a] ) |b= PROPERTYNAME -> ^( PROPERTYVALUE[$b] ) )
            int alt14 = 2;
    ...
    // org/alfresco/rest/antlr/WhereClause.g:145:1: selectClause : PROPERTYNAME ( COMMA PROPERTYNAME
    // )* -> ( PROPERTYNAME )+ ;
    public final WhereClauseParser.selectClause_return selectClause() throws RecognitionException {
        ...
        try {
            // org/alfresco/rest/antlr/WhereClause.g:145:13: ( PROPERTYNAME ( COMMA PROPERTYNAME )*
            // -> ( PROPERTYNAME )+ )
            // org/alfresco/rest/antlr/WhereClause.g:145:16: PROPERTYNAME ( COMMA PROPERTYNAME )*
            {
                PROPERTYNAME55 =
                        (Token) match(input, PROPERTYNAME, FOLLOW_PROPERTYNAME_in_selectClause1140);
                                ...
                                COMMA56 =
                                        (Token)
                                                match(
                                                        input,
                                                        COMMA,
                                                        FOLLOW_COMMA_in_selectClause1143);
    ...
    class DFA6 extends DFA {
        ...
        public String getDescription() {
            return "129:1: predicate : ( simplepredicate | simplepredicate ( AND simplepredicate )+"
                    + " -> ^( AND ( simplepredicate )+ ) | simplepredicate ( OR simplepredicate"
                    + " )+ -> ^( OR ( simplepredicate )+ ) );";
        }
    }
    ...
    public static final BitSet FOLLOW_LEFTPAREN_in_whereclause782 =
            new BitSet(new long[] {0x0000000008A00200L});
    public static final BitSet FOLLOW_WS_in_whereclause785 =
            new BitSet(new long[] {0x0000000000A00200L});
    ...
    public static final BitSet FOLLOW_RIGHTPAREN_in_whereclause790 =
            new BitSet(new long[] {0x0000000008000002L});
    ...
    public static final BitSet FOLLOW_NEGATION_in_simplepredicate892 =
            new BitSet(new long[] {0x0000000000800200L});
    ...
    public static final BitSet FOLLOW_PROPERTYNAME_in_comparisonpredicate931 =
            new BitSet(new long[] {0x00000000000C0D00L});
    public static final BitSet FOLLOW_comparisonoperator_in_comparisonpredicate933 =
            new BitSet(new long[] {0x0000000001800000L});
    ...
    public static final BitSet FOLLOW_LEFTPAREN_in_existspredicate967 =
            new BitSet(new long[] {0x0000000008800000L});
    ...
    public static final BitSet FOLLOW_LEFTPAREN_in_betweenpredicate992 =
            new BitSet(new long[] {0x0000000009800000L});
