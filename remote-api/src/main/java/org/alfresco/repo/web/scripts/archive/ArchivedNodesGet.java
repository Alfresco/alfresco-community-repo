...
public class ArchivedNodesGet extends AbstractArchivedNodeWebScript {
    ...
    /**
     * This method is used to inject {@link
     * org.alfresco.repo.web.scripts.archive.ArchivedNodesFilter node filters} on this GET call.
     */
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        ScriptPagingDetails paging =
                new ScriptPagingDetails(
                        getIntParameter(req, MAX_ITEMS, DEFAULT_MAX_ITEMS_PER_PAGE),
                        getIntParameter(req, SKIP_COUNT, 0));

        PagingResults<NodeRef> result =
                getArchivedNodesFrom(storeRef, paging, req.getParameter(NAME_FILTER));
