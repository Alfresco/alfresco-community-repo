...
public class OAuth2CredentialsStoreServiceImpl implements OAuth2CredentialsStoreService {
    ...
    public OAuth2CredentialsInfo storePersonalOAuth2Credentials(
        ...
        OAuth2CredentialsInfo credentials =
                buildPersonalOAuth2CredentialsInfo(
                        remoteSystemId, accessToken, refreshToken, expiresAt, issuedAt);
    ...
    public OAuth2CredentialsInfo storeSharedOAuth2Credentials(
            ...
            throws NoSuchSystemException {
        OAuth2CredentialsInfo credentials =
                buildSharedOAuth2CredentialsInfo(
                        remoteSystemId, accessToken, refreshToken, expiresAt, issuedAt);
    ...
    private OAuth2CredentialsInfo buildPersonalOAuth2CredentialsInfo(
        ...
        OAuth2CredentialsInfoImpl existing =
                (OAuth2CredentialsInfoImpl) getPersonalOAuth2Credentials(remoteSystemId);
        if (existing != null) {
    ...
    public List<OAuth2CredentialsInfo> listSharedOAuth2Credentials(String remoteSystemId)
        ...
        PagingResults<OAuth2CredentialsInfo> pagingResults =
                (PagingResults<OAuth2CredentialsInfo>)
    ...
    public boolean deleteSharedOAuth2Credentials(
            String remoteSystemId, OAuth2CredentialsInfo credentials) throws NoSuchSystemException {
        List<OAuth2CredentialsInfo> shared = listSharedOAuth2Credentials(remoteSystemId);
