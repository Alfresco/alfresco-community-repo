...
public class RecordsManagementPermissionPostProcessor
  ...
  public AccessStatus process(
    ...
    if (
      AccessStatus.DENIED.equals(accessStatus) &&
   ...
   */
  private boolean isPermissionContained(
    String perm,
    ...
    for (String configuredPermission : configuredPermissions) {
      ...
      PermissionReference permissionReference = permissionModel.getPermissionReference(
        null,
        configuredPermission
      );
      for (PermissionReference granteePermission : permissionModel.getGranteePermissions(
        permissionReference
      )) {
