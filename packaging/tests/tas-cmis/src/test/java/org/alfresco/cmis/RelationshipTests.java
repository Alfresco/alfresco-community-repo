...
public class RelationshipTests extends CmisTest {
  ...
  public void siteManagerCanCreateRelWithCheckedOutSourceDocument()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    targetFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void adminCreatesRelBetweenSourceFolderAndTargetFile()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    targetFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
  ...
  public void siteManagerCannotCreateRelationshipPWCSourceFile()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    targetFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanCreateRelWithCheckedOutTargetDocument()
    throws Exception {
    sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    targetFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
