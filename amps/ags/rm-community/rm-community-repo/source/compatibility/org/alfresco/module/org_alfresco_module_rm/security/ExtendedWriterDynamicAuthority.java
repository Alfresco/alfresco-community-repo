 ...
 */
@Deprecated
public class ExtendedWriterDynamicAuthority
  extends ExtendedSecurityBaseDynamicAuthority {
  ...
  public Set<PermissionReference> requiredFor() {
    if (requiredFor == null) {
      ...
      Collections.addAll(
        requiredFor,
        getModelDAO()
          .getPermissionReference(null, RMPermissionModel.READ_RECORDS),
        getModelDAO().getPermissionReference(null, RMPermissionModel.FILING),
        getModelDAO()
          .getPermissionReference(null, RMPermissionModel.FILE_RECORDS)
      );
    }
  ...
  protected Set<String> getAuthorites(NodeRef nodeRef) {
    ...
    Map<String, Integer> map = (Map<String, Integer>) getNodeService()
      .getProperty(nodeRef, PROP_WRITERS);
    if (map != null) {
      result = map.keySet();
    }
