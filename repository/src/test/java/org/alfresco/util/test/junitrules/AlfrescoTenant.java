 ...
 *
 * @author Alex Miller
 * @see AlfrescoPerson Consider using {@link AlfrescoPerson} instead, which will create tenants as
 *     needed when run in a Cloud build.
 */
public class AlfrescoTenant extends AbstractRule {
    ...
    /**
     * Constructs the rule with a spring ApplicationContext. A GUID-generated tenant name will be
     * used for the test tenant.
     *
     ...
     * used to retrieve the ApplicationContext. A GUID-generated tenant name will be used for the
     * test user.
     *
    ...
    protected void before() throws Throwable {
        ...
        RetryingTransactionHelper transactionHelper =
                appCtx.getBean("retryingTransactionHelper", RetryingTransactionHelper.class);
        final TenantAdminService tenantAdminService =
                appCtx.getBean("tenantAdminService", TenantAdminService.class);
