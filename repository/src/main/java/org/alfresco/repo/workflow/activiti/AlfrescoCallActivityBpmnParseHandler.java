 ...
 * @author Nick Smith
 */
public class AlfrescoCallActivityBpmnParseHandler
  extends AbstractBpmnParseHandler<CallActivity> {
  ...
  protected void executeParse(BpmnParse bpmnParse, CallActivity callActivity) {
    if (multiTenancyEnabled && tenantService.isEnabled()) {
      ...
      if (activityBehavior instanceof CallActivityBehavior) {
        ...
        callActivityBehavior.setProcessDefinitonKey(
          tenantService.getName(callActivityBehavior.getProcessDefinitonKey())
        );
      }
    }
  }
