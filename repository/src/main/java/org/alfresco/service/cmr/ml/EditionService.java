...
{
    /**
     * Create a new edition of an existing <b>cm:mlContainer</b> using any one of the associated <b>cm:mlDocument</b> transalations.
     *
     * If startingTranslationNodeRef is multilingual, it will be copied. The copy will become the pivot translation of the new Edition of the <b>cm:mlContainer</b>. The reference of the copy will be returned.
     *
     * @param translationNodeRef
     *            The specific <b>cm:mlDocument</b> to use as the starting point of the new edition. All other translations will be removed.
     */
     ...
     *
     * @param mlContainer
     *            An existing <b>cm:mlContainer</b>
    ...
    /**
     * Get the the versioned metadata of a specific <b>cm:mlDocument</b> transalation version or a specific <b>cm:mlContainer</b> version
     *
     * @param version
     *            An existing version of a <b>cm:mlDocument</b> translation version or an existing version of a <b>cm:mlContainer</b> version.
