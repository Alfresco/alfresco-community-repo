...
public class SiteEntityResource
  ...
  @Override
  @WebApiDescription(
    title = "A paged list of visible sites in the network.",
    description = "A site is visible if it is public or if the person is a member"
  )
  ...
  @WebApiDescription(
    title = "Delete Site",
    description = "Delete the site. This will cascade delete"
  )
  ...
  @WebApiDescription(
    title = "Create site",
    description = "Create the default/functional Share site"
  )
  @WebApiParam(
    name = "entity",
    title = "A single site",
    description = "A single site, multiple sites are not supported.",
  ...
  @WebApiDescription(
    title = "Update site",
    description = "Update the Share site"
  )
  ...
  protected SiteUpdate convert(Site site) {
    ...
    if (site.wasSet(Site.ID)) {
      throw new InvalidArgumentException(
        "Site update does not support field: id"
      );
    }
    if (site.wasSet(Site.GUID)) {
      throw new InvalidArgumentException(
        "Site update does not support field: guid"
      );
    }
    if (site.wasSet(Site.ROLE)) {
      throw new InvalidArgumentException(
        "Site update does not support field: role"
      );
    }
    if (site.wasSet(Site.PRESET)) {
      throw new InvalidArgumentException(
        "Site update does not support field: preset"
      );
    }
