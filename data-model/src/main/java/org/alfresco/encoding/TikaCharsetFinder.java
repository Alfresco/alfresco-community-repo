...
public class TikaCharsetFinder extends AbstractCharactersetFinder {
    ...
    /**
     * Return the matching threshold before we decide that what we detected is a good match. In the
     * range 0-100.
     */
    ...
    /**
     * At what point do we decide our match is good enough? In the range 0-100. If we don't reach
     * the threshold, we'll decline, and either another finder will work on it or the fallback
