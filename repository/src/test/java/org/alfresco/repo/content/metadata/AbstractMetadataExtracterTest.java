...
public abstract class AbstractMetadataExtracterTest extends TestCase {
  ...
  public static final String QUICK_TITLE =
    "The quick brown fox jumps over the lazy dog";
  public static final String QUICK_DESCRIPTION =
  ...
  protected Map<QName, Serializable> extractFromMimetype(String mimetype)
    throws Exception {
    ...
    if (sourceFile == null) {
      throw new FileNotFoundException(
        "No quick." + ext + " file found for test"
      );
    }
    return extractFromFile(sourceFile, mimetype);
  }

  protected Map<QName, Serializable> extractFromFile(
    File sourceFile,
    String mimetype
  ) throws Exception {
   ...
   *  data in it.
   */
  protected void testCommonMetadata(
    String mimetype,
  ...
  public void testZeroLengthFile() throws Exception {
    ...
    for (String mimetype : mimetypes) {
      ...
      assertEquals(
        "There should not be any new properties",
        0,
        properties.size()
      );
    }
