...
public class AclTests extends CmisTest {
  ...
  public void siteManagerCanAddAclWithRepositoryDeterminedPropagation()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
    ...
    cmisApi
      ...
      .then()
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteContributor);
  }
  ...
  public void siteManagerCanAddAclWithPropagate() throws Exception {
    ...
    cmisApi
      ...
      .addAcl(inviteUser, UserRole.SiteConsumer, AclPropagation.PROPAGATE)
      .then()
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteConsumer);
  }
  ...
  public void siteManagerCanAddAclWithObjectOnlyPropagation() throws Exception {
    ...
    cmisApi
      .usingResource(testFolder)
      .addAcl(inviteUser, UserRole.SiteCollaborator, AclPropagation.OBJECTONLY)
      .then()
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteCollaborator);
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanApplyAclWithObjectOnlyPropagation()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(testUser)
    ...
    cmisApi
      ...
      .and()
      .assertThat()
      .permissionIsNotSetForUser(inviteUser, UserRole.SiteCollaborator);
  }
  ...
  @Test(
    groups = { "bug-atom-REPO-5383", TestGroup.REGRESSION, TestGroup.CMIS },
  ...
  public void siteManagerCanApplyAclWithPropagate() throws Exception {
    ...
    cmisApi
      ...
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteManager)
      .and()
      .assertThat()
      .permissionIsNotSetForUser(inviteUser, UserRole.SiteConsumer);
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanApplyAclWithRepositoryDeterminedPropagation()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.PDF);
    cmisApi
      .authenticateUser(testUser)
      ...
      .createFile(testFile)
      .and()
      .addAcl(inviteUser, UserRole.SiteConsumer, AclPropagation.OBJECTONLY)
      .when()
      .applyAcl(
        inviteUser,
        UserRole.SiteManager,
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanRemoveAclWithRepositoryDeterminedPropagation()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.PDF);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void siteManagerCanRemoveAclWithPropagate() throws Exception {
    ...
    cmisApi
      ...
      .createFile(testFile)
      .and()
      .addAcl(inviteUser, UserRole.SiteManager, AclPropagation.OBJECTONLY)
      .when()
      .removeAcl(inviteUser, UserRole.SiteManager, AclPropagation.PROPAGATE)
      .and()
      .assertThat()
      .permissionIsNotSetForUser(inviteUser, UserRole.SiteManager);
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanRemoveAclWithObjectOnlyPropagation()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.PDF);
    cmisApi
      .authenticateUser(testUser)
      ...
      .createFile(testFile)
      .and()
      .addAcl(inviteUser, UserRole.SiteContributor, AclPropagation.OBJECTONLY)
      .when()
      .removeAcl(
        inviteUser,
        UserRole.SiteContributor,
      ...
      .and()
      .assertThat()
      .permissionIsNotSetForUser(inviteUser, UserRole.SiteContributor);
  }
  ...
  public void siteManagerCannotRemoveInvalidAcl() throws Exception {
    ...
    cmisApi
      ...
      .addAcl(inviteUser, UserRole.SiteContributor, AclPropagation.OBJECTONLY)
      .when()
      .removeAcl(inviteUser, UserRole.SiteManager, AclPropagation.OBJECTONLY);
  }
  ...
  public void siteManagerCanAddAclWithNullPropagation() throws Exception {
    ...
    cmisApi
      ...
      .createFile(testFile)
      .and()
      .addAcl(inviteUser, UserRole.SiteContributor, null)
      .then()
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteContributor);
  }
  ...
  public void siteManagerCannotGetAclForPwcDocument() throws Exception {
    ...
    cmisApi
      ...
      .usingPWCDocument()
      .addAcl(inviteUser, UserRole.SiteContributor, AclPropagation.PROPAGATE)
      .then()
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteContributor);
  }
  ...
  public void siteManagerCanApplyAclWithNullPropagation() throws Exception {
    ...
    cmisApi
      ...
      .addAcl(inviteUser, UserRole.SiteConsumer, AclPropagation.OBJECTONLY)
      .when()
      .applyAcl(inviteUser, UserRole.SiteManager, UserRole.SiteConsumer, null)
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteManager)
      .and()
      .assertThat()
  ...
  public void siteManagerCannotGetAclForAppliedAclForPWC() throws Exception {
    ...
    cmisApi
      ...
      .usingPWCDocument()
      .applyAcl(inviteUser, UserRole.SiteManager, UserRole.SiteConsumer)
      .assertThat()
      .permissionIsSetForUser(inviteUser, UserRole.SiteManager);
  }
  ...
  public void applyAclByUnauthorizedUser() throws Exception {
    ...
    cmisApi
      ...
      .createFile(testFile)
      .and()
      .addAcl(inviteUser, UserRole.SiteConsumer)
      .when()
      .authenticateUser(unauthorizedUser)
      .and()
      .applyAcl(inviteUser, UserRole.SiteManager, UserRole.SiteConsumer);
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanAddAclForDocumentCreatedByHimself()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(
  ...
  public void collaboratorCannotAddAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanGetAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void collaboratorCannotApplyAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void collaboratorCannotRemoveAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorCanAddAclForDocumentCreatedByHimself()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(
  ...
  public void contributorCannotAddAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorCanGetAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void contributorCannotApplyAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void contributorCannotRemoveAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void consumerCannotAddAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void consumerCannotApplyAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void consumerCannotRemoveAclForDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void siteManagerCanAddAclWithPermissionMapping() throws Exception {
    ...
    cmisApi
      ...
      .existsInRepo()
      .then()
      .addAcl(inviteUser, PermissionMapping.CAN_UPDATE_PROPERTIES_OBJECT)
      .assertThat()
      ...
      .then()
      .addAcl(inviteUser, PermissionMapping.CAN_DELETE_OBJECT)
      .and()
      .assertThat()
      .permissionIsSetForUser(
        inviteUser,
  ...
  public void siteManagerCanApplyAclWithPermissionMapping() throws Exception {
    ...
    cmisApi
      ...
      .and()
      .assertThat()
      .permissionIsSetForUser(inviteUser, EnumBasicPermissions.CMIS_ALL.value())
      .then()
      .applyAcl(
        inviteUser,
  ...
  public void siteManagerCanRemoveAclWithPermissionMapping() throws Exception {
    ...
    cmisApi
      ...
      .permissionIsSetForUser(inviteUser, EnumBasicPermissions.CMIS_ALL.value())
      .then()
      .removeAcl(inviteUser, PermissionMapping.CAN_DELETE_OBJECT)
      .and()
      .assertThat()
      .permissionIsNotSetForUser(
        inviteUser,
  ...
  public void siteManagerCannotRemoveInvalidAclWithPermissionMapping()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
      ...
      .then()
      .removeAcl(inviteUser, PermissionMapping.CAN_CHECKIN_DOCUMENT);
  }
  ...
  public void siteManagerCannotApplyInvalidAclWithPermissionMapping()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
