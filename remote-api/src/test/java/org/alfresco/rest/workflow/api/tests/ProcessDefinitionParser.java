...
public class ProcessDefinitionParser extends ListParser<ProcessDefinition> {
  ...
  public ProcessDefinition parseEntry(JSONObject entry) {
    ...
    processDefinition.setStartFormResourceKey(
      (String) entry.get("startFormResourceKey")
    );
    processDefinition.setGraphicNotationDefined(
      (Boolean) entry.get("graphicNotationDefined")
    );
