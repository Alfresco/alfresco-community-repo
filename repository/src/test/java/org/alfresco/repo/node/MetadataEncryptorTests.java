...
public class MetadataEncryptorTests extends TestCase {
    ...
    private static QName ENCRYPTED_TYPE_QNAME =
            QName.createQName("http://www.alfresco.org/test/encryptedPropModel/1.0", "encrypted");
    private static QName ENCRYPTED_PROP_QNAME =
            QName.createQName("http://www.alfresco.org/test/encryptedPropModel/1.0", "prop1");
    ...
    public void setUp() throws Exception {
        ...
        rootNodeRef =
                transactionService.getRetryingTransactionHelper().doInTransaction(createStoreWork);
    }
    ...
    //    {
    //        DictionaryDAO dictionaryDao = (DictionaryDAO)
    // applicationContext.getBean("dictionaryDAO");
    ...
    public void testWithoutEncryption() {
        RetryingTransactionCallback<Void> encryptionWork =
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() {
                        ...
                        try {
                            ...
                            Serializable encryptedPropertyValue =
                                    nodeService.getProperty(nodeRef2, ENCRYPTED_PROP_QNAME);
                            Serializable decryptedPropertyValue =
                                    metadataEncryptor.decrypt(
                                            ENCRYPTED_PROP_QNAME, encryptedPropertyValue);
