...
/**
 * Records management action condition who's implementation is delegated to an existing action
 * condition.
 *
 * <p>Useful for creating a RM version of an existing action condition implementation.
 *
