...
public class AddProcessItemSanityTests extends RestTest {
  ...
  public void addProcessItem()
    ...
    document2 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "This is a test file");
    ...
    processItem
      ...
      .and()
      .field("size")
      .is(document2.getContent().length())
      .and()
      .field("createdBy")
    ...
    restClient
      ...
      .getProcessItems()
      .assertThat()
      .entriesListContains("id", processItem.getId());
  }
  ...
  public void addMultipleProcessItem()
    throws JsonToModelConversionException, Exception {
    document2 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "This is a test file");
    dataContent.usingSite(siteModel).createContent(document2);
    ...
    restClient
      ...
      .entriesListContains(
        "id",
        processItems.getEntries().get(0).onModel().getId()
      )
      .assertThat()
      .entriesListContains(
        "id",
        processItems.getEntries().get(1).onModel().getId()
      );
  }
  ...
  public void addProcessItemThatAlreadyExists()
    throws JsonToModelConversionException, Exception {
    document2 =
    ...
    restClient
      ...
      .entriesListContains("id", processItem.getId())
      .and()
      .entriesListContains("name", document2.getName());
    restClient
      .withWorkflowAPI()
      .usingProcess(processModel)
      .addProcessItem(document2);
  ...
  public void addMultipleProcessItemThatAlreadyExists()
    throws JsonToModelConversionException, Exception {
    document2 =
      dataContent.usingSite(siteModel).createContent(DocumentType.XML);
