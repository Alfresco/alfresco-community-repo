...
public abstract class BaseRMTestCase
  ...
  protected QName ASPECT_RECORD_META_DATA = QName.createQName(
    URI,
    "recordMetaData"
  );
  ...
  protected void initServices() {
    ...
    authorityService =
      (AuthorityService) this.applicationContext.getBean("AuthorityService");
    ...
    documentLinkService =
      (DocumentLinkService) applicationContext.getBean("DocumentLinkService");
    repositoryHelper =
    ...
    rmEventService =
      (RecordsManagementEventService) applicationContext.getBean(
        "RecordsManagementEventService"
      );
    rmAdminService =
      (RecordsManagementAdminService) applicationContext.getBean(
        "RecordsManagementAdminService"
      );
    rmActionService =
      (RecordsManagementActionService) this.applicationContext.getBean(
          "RecordsManagementActionService"
        );
    rmSearchService =
      (RecordsManagementSearchService) this.applicationContext.getBean(
          "RecordsManagementSearchService"
        );
    filePlanRoleService =
      (FilePlanRoleService) this.applicationContext.getBean(
          "FilePlanRoleService"
        );
    filePlanPermissionService =
      (FilePlanPermissionService) this.applicationContext.getBean(
          "FilePlanPermissionService"
        );
    capabilityService =
      (CapabilityService) this.applicationContext.getBean("CapabilityService");
    vitalRecordService =
      (VitalRecordService) this.applicationContext.getBean(
          "VitalRecordService"
        );
    dataSetService =
      (DataSetService) applicationContext.getBean("DataSetService");
    ...
    rmAuditService =
      (RecordsManagementAuditService) applicationContext.getBean(
        "RecordsManagementAuditService"
      );
    identifierService =
      (IdentifierService) applicationContext.getBean(
        "recordsManagementIdentifierService"
      );
    holdService = (HoldService) applicationContext.getBean("HoldService");
    inplaceRecordService =
      (InplaceRecordService) applicationContext.getBean("InplaceRecordService");
    relationshipService =
      (RelationshipService) applicationContext.getBean("RelationshipService");

    // RM Container Cache Manager
    rmContainerCacheManager =
      (RMContainerCacheManager) applicationContext.getBean(
        "rmContainerCacheManager"
      );
  }
  ...
  protected void tearDownImpl() {
    BehaviourFilter filter = (BehaviourFilter) applicationContext.getBean(
    ...
    try {
      ...
      if (
        isCollaborationSiteTest() && siteService.getSite(collabSiteId) != null
      ) {
  ...
  protected void setupTestDataImpl() {
    ...
    if (isRMSiteTest()) {
      ...
      assertNotNull(
        "Site document library container was not created successfully.",
        filePlan
      );

      // Create RM container
      rmContainer =
        filePlanService.createRecordCategory(filePlan, "rmContainer");
      assertNotNull("Could not create rm container", rmContainer);

      rm_Container =
        filePlanService.createRecordCategory(filePlan, "rm Container");
      ...
      // Create RM folder
      rmFolder =
        recordFolderService.createRecordFolder(rmContainer, "rmFolder");
      assertNotNull("Could not create rm folder", rmFolder);

      rm_Folder =
        recordFolderService.createRecordFolder(rm_Container, "rm Folder");
  ...
  protected void setupMultiHierarchyTestDataImpl() {
    ...
    // Level 1
    mhContainer11 =
      filePlanService.createRecordCategory(mhContainer, "mhContainer11");
    ...
    mhContainer12 =
      filePlanService.createRecordCategory(mhContainer, "mhContainer12");
    ...
    // Level 2
    mhContainer21 =
      filePlanService.createRecordCategory(mhContainer11, "mhContainer21");
    mhContainer22 =
      filePlanService.createRecordCategory(mhContainer12, "mhContainer22");
    mhContainer23 =
      filePlanService.createRecordCategory(mhContainer12, "mhContainer23");
    ...
    // Level 3
    mhContainer31 =
      filePlanService.createRecordCategory(mhContainer21, "mhContainer31");
    mhContainer32 =
      filePlanService.createRecordCategory(mhContainer22, "mhContainer32");
    mhContainer33 =
      filePlanService.createRecordCategory(mhContainer22, "mhContainer33");
    ...
    mhContainer34 =
      filePlanService.createRecordCategory(mhContainer23, "mhContainer34");
    mhContainer35 =
      filePlanService.createRecordCategory(mhContainer23, "mhContainer35");
    ...
    // Record folders
    mhRecordFolder41 =
      recordFolderService.createRecordFolder(mhContainer31, "mhFolder41");
    mhRecordFolder42 =
      recordFolderService.createRecordFolder(mhContainer32, "mhFolder42");
    mhRecordFolder43 =
      recordFolderService.createRecordFolder(mhContainer33, "mhFolder43");
    mhRecordFolder44 =
      recordFolderService.createRecordFolder(mhContainer34, "mhFolder44");
    mhRecordFolder45 =
      recordFolderService.createRecordFolder(mhContainer35, "mhFolder45");
  }
  ...
  protected void setupCollaborationSiteTestDataImpl() {
    ...
    dmFolder =
      fileFolderService
        .create(documentLibrary, "collabFolder", ContentModel.TYPE_FOLDER)
        .getNodeRef();
    dmDocument =
      fileFolderService
        .create(dmFolder, NAME_DM_DOCUMENT, ContentModel.TYPE_CONTENT)
        .getNodeRef();
    dmFolder1 =
      fileFolderService
        .create(documentLibrary, "collabFolder1", ContentModel.TYPE_FOLDER)
        .getNodeRef();
    dmDocument1 =
      fileFolderService
        .create(dmFolder1, NAME_DM_DOCUMENT1, ContentModel.TYPE_CONTENT)
        .getNodeRef();
  ...
  protected <A> A doTestInTransaction(Test<A> test) {
    return super.doTestInTransaction(
      test,
      AuthenticationUtil.getAdminUserName()
    );
  }
    ...
    public void run() throws Exception {
      try {
        ...
        if (expectedException == null) {
          ...
          doTestInTransaction(
            new FailureTest(expectedException) {
              @Override
              public void run() throws Exception {
                when();
              }
