...
public class RM3993Test extends BaseRMTestCase {
    ...
    /**
     * Given that I have auto declare configured And that I have auto file configured to a path
     * where only the record folder needs to be created When I add lots of documents in the same
     * transaction Then the rules should fire And the documents should be filed in the new record
     * folder
     */
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        nodeRefCategory1 =
                                filePlanService.createRecordCategory(filePlan, "category1");
                        ...
                        fileAction.setParameterValue(
                                FileToAction.PARAM_PATH, "/category1/{node.cm:description}");
                        ...
                        ruleService.saveRule(
                                filePlanService.getUnfiledContainer(filePlan), fileRule);
                ...
                AuthenticationUtil.runAsSystem(
                        new RunAsWork<Integer>() {
                            ...
                            public Integer doWork() throws Exception {
                                List<NodeRef> containedRecordFolders =
                                        filePlanService.getContainedRecordFolders(nodeRefCategory1);
                                int numberOfRecords = 0;
                                for (NodeRef recordFolder : containedRecordFolders) {
                                    numberOfRecords =
                                            numberOfRecords
                                                    + fileFolderService.list(recordFolder).size();
                                }
    ...
    private NodeRef createFile(
            NodeRef parentNodeRef, String name, String descrption, QName typeQName) {
