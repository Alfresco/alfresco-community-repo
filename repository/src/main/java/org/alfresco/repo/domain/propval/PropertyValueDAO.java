...
public interface PropertyValueDAO {
     ...
     * <b>FOR INTERNAL USE ONLY</b>: Do not use directly; see interface comments.
     *
     * <p><b>alf_prop_date_value</b> accessor
     *
     * @param id the ID (may not be <tt>null</tt>)
     */
     ...
     * <b>FOR INTERNAL USE ONLY</b>: Do not use directly; see interface comments.
     *
     * <p><b>alf_prop_string_value</b> accessor
     *
     * @param id the ID (may not be <tt>null</tt>)
     */
     ...
     * <b>FOR INTERNAL USE ONLY</b>: Do not use directly; see interface comments.
     *
     * <p><b>alf_prop_double_value</b> accessor
     *
     * @param id the ID (may not be <tt>null</tt>)
     */
     ...
     * <b>FOR INTERNAL USE ONLY</b>: Do not use directly; see interface comments.
     *
     * <p><b>alf_prop_serializable_value</b> accessor
     *
     * @param id the ID (may not be <tt>null</tt>)
     */
     ...
     *
     * <p><b>alf_prop_value</b> accessor: get a property based on the database ID
     *
     * @param id the ID (may not be <tt>null</tt>)
     */
     ...
     * Use for accessing unique properties; see interface comments.
     *
     * <p><b>alf_prop_value</b> accessor: find a property based on the value
     *
     ...
     * Use for accessing unique properties; see interface comments.
     *
     * <p><b>alf_prop_value</b> accessor: find or create a property based on the value. <b>Note:</b>
     * This method will not recurse into maps or collections. Use the dedicated methods if you want
     * recursion; otherwise maps and collections will be serialized and probably stored as BLOB
     * values.
     *
     * <p>All collections and maps will be opened up to any depth.
     *
     * @param value the value to find the ID for (may be <tt>null</tt>)
     */
     ...
     *
     * <p><b>alf_prop_root</b> accessor: get a property based on the database ID
     *
     * @param id the ID (may not be <tt>null</tt>)
     ...
     * Use for accessing non-unique, exploded properties; see interface comments.
     *
     * <p><b>alf_prop_root</b> accessor: get all properties based on the database IDs
     *
     ...
     * Use for accessing non-unique, exploded properties; see interface comments.
     *
     * <p><b>alf_prop_root</b> accessor: find or create a property based on the value.
     *
     * <p>All collections and maps will be opened up to any depth.
     *
     ...
     * Use for accessing non-unique, exploded properties; see interface comments.
     *
     * <p><b>alf_prop_root</b> accessor: update the property root to contain a new value.
     *
     ...
     * Use for accessing non-unique, exploded properties; see interface comments.
     *
     * <p><b>alf_prop_root</b> accessor: delete a property root completely
     *
    ...
    // ================================
    /**
     * <b>alf_prop_unique_ctx</b> accessor: create a unique context with an optional associated
     * value.
     *
     * <p>The DAO ensures that the region-context-value combination will be globally unique.
     *
    ...
    /**
     * Get the unique context ID and associated shared property ID, or <tt>null</tt> if no such
     * context exists. The associated property may be <tt>null</tt> even if the unique context
     * exists.
     *
     * @param value1 first value
     * @param value2 second value
     * @param value3 third value
     * @return Returns the ID-valueId pair or <tt>null</tt> if the context doesn't exist.
     * @see #createPropertyUniqueContext(Serializable, Serializable, Serializable, Serializable)
     */
    Pair<Long, Long> getPropertyUniqueContext(
    ...
    /**
     * Get unique contexts (unique context ID and associated shared property ID), if any, based on
     * one, two or three context values. The associated property may be <tt>null</tt> even if the
     * unique context exists.
     *
    ...
    /**
     * Update the property associated with a unique context (based on one, two or three context
     * values).
     *
     * @see #createPropertyUniqueContext(Serializable, Serializable, Serializable, Serializable)
     */
    ...
    // ================================
    /**
     * Utility method to convert property query results into the original value. Note that the rows
     * must all share the same root property ID.
     *
     * <p>If the rows passed in don't constitute a valid, full property - they don't contain all the
     * link entities for the property - then the result may be <tt>null</tt>.
     *
     * @param rows the search results for a single root property
     * @return Returns the root property as originally persisted, or <tt>null</tt> if the rows don't
     *     represent a complete property
