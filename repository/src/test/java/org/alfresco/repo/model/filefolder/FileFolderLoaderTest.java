...
public class FileFolderLoaderTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    RunAsWork<Void> setUpWork = new RunAsWork<Void>() {
      ...
      public Void doWork() throws Exception {
        ...
        NodeRef companyHomeNodeRef = fileFolderLoader
          .getRepository()
          .getCompanyHome();
        NodeRef sharedHomeNodeRef = fileFolderLoader
          .getRepository()
          .getSharedHome();
        List<FileInfo> sharedHomeFileInfos = fileFolderService.getNamePath(
          companyHomeNodeRef,
          sharedHomeNodeRef
        );
        ...
        FileInfo hiddenFolderInfo = fileFolderService.create(
          sharedHomeNodeRef,
          "HideThis",
        ...
        FileInfo readOnlyFolderInfo = fileFolderService.create(
          sharedHomeNodeRef,
          "ReadOnlyThis",
          ContentModel.TYPE_FOLDER
        );
        ...
        FileInfo writeFolderInfo = fileFolderService.create(
          sharedHomeNodeRef,
          "WriteThis",
          ContentModel.TYPE_FOLDER
        );
    ...
    try {
      ...
      RetryingTransactionCallback<Void> checkCallback = new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          MLText descriptions = (MLText) nodeService.getProperty(
            fileNodeRef,
      ...
      transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(checkCallback, true);
    } finally {
      AuthenticationUtil.popAuthentication();
    }
  }
  ...
  public void testLoad_03() throws Exception {
    try {
      ...
      // Check the files
      List<FileInfo> fileInfos = fileFolderService.listFiles(
        writeFolderNodeRef
      );
      ...
      for (FileInfo fileInfo : fileInfos) {
        ...
        if (lastText == null) {
          ...
          assertNotEquals(
            "All text must differ due to varying seed. ",
            lastText,
            currentStr
          );
          lastText = currentStr;
        ...
        if (lastDescr == null) {
          ...
          String currentDescr = DefaultTypeConverter.INSTANCE.convert(
            String.class,
            nodeService.getProperty(fileNodeRef, ContentModel.PROP_DESCRIPTION)
          );
          assertNotEquals(
    ...
    try {
      ...
      for (FileInfo fileInfo : fileInfos) {
        ...
        if (lastText == null) {
          ...
          String currentStr = reader.getContentString();
          assertEquals(
            "All text must be identical due to same seed. ",
            lastText,
            currentStr
          );
          lastText = currentStr;
