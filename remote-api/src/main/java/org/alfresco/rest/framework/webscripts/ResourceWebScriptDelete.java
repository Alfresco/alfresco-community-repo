...
public class ResourceWebScriptDelete
    ...
    switch (resourceMeta.getType()) {
      ...
      default:
        throw new UnsupportedResourceOperationException(
          "DELETE not supported for Actions"
        );
    }
  }
    ...
    switch (resource.getMetaData().getType()) {
      case ENTITY:
        if (StringUtils.isNotBlank(params.getEntityId())) {
          if (
            EntityResourceAction.DeleteWithResponse.class.isAssignableFrom(
          ...
          if (
            EntityResourceAction.Delete.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
      ...
      case RELATIONSHIP:
        if (StringUtils.isNotBlank(params.getRelationshipId())) {
          if (
            RelationshipResourceAction.DeleteWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
          ...
          if (
            RelationshipResourceAction.Delete.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
          ...
          if (
            RelationshipResourceAction.DeleteSetWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
          ...
          if (
            RelationshipResourceAction.DeleteSet.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
      ...
      case PROPERTY:
        if (
          BinaryResourceAction.DeleteWithResponse.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
        ...
        if (
          BinaryResourceAction.Delete.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
            resource.getMetaData().isDeleted(BinaryResourceAction.Delete.class)
          ) {
            throw new DeletedResourceException(
              "(DELETE) " + resource.getMetaData().getUniqueId()
            );
        ...
        if (
          RelationshipResourceBinaryAction.DeleteWithResponse.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
        ...
        if (
          RelationshipResourceBinaryAction.Delete.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
  ...
  public Void execute(
    ...
    final ResourceOperation operation = resource
      .getMetaData()
      .getOperation(HttpMethod.DELETE);
