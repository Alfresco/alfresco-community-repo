...
public class ValueDataTypeValidatorImpl implements ValueDataTypeValidator {
  ...
  /** Messages */
  private static final String MSG_DATA_TYPE_UNKNOWN =
    "cmm.value_datatype_validator.unknown_datatype";
  private static final String MSG_INVALID_VALUE =
    "cmm.value_datatype_validator.invalid_value";
  private static final String MSG_INVALID_DATE =
    "cmm.value_datatype_validator.invalid_date";
  private static final String MSG_INVALID_DATETIME =
    "cmm.value_datatype_validator.invalid_datetime";
  private static final String MSG_INVALID_BOOLEAN_VALUE =
    "cmm.value_datatype_validator.invalid_boolean_value";
  ...
  public void validateValue(String dataType, String value) {
    ...
    if (typeDef == null) {
      throw new AlfrescoRuntimeException(
        ...
        new Object[] { typeQName.toPrefixString() }
      );
    }
    ...
    if (DataTypeDefinition.BOOLEAN.equals(typeQName)) {
      ...
      try {
        ...
        throw new AlfrescoRuntimeException(
          MSG_INVALID_VALUE,
          new Object[] { value, typeQName.toPrefixString() }
        );
      }
    }
  }
