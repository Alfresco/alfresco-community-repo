...
public class GetProcessDefinitionStartFormModelCoreTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        allProcessDefinitions =
                restClient.authenticateUser(adminUser).withWorkflowAPI().getAllProcessDefinitions();
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify any user gets a model of the start form type definition for non-network"
    ...
    public void nonNetworkUserGetsStartFormModel() throws Exception {
        ...
        restClient
                .authenticateUser(nonNetworkUser)
                .withWorkflowAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get request returns status code 404 when invalid processDefinitionId"
                            + " is used")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getStartFormModelUsingInvalidProcessDefinitionId() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                "no deployed process definition found with id '%s'", "invalidID"))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get request returns status code 404 when empty processDefinitionId"
                            + " is used")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getStartFormModelUsingEmptyProcessDefinitionId() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary("no deployed process definition found with id ''");
    }
}
