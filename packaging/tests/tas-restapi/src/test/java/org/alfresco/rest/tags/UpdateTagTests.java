...
public class UpdateTagTests extends TagsDataPrep {
  ...
  public void addTagToDocument() throws Exception {
    ...
    oldTag =
      restClient
        ...
        .addTag(RandomData.getRandomName("old"));
  ...
  @TestRail(
    ...
    description = "Verify Admin user updates tags and status code is 200"
  )
  @Bug(id = "REPO-1828")
  ...
  @TestRail(
    ...
    description = "Verify Manager user can't update tags with Rest API and status code is 403"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Collaborator user can't update tags with Rest API and status code is 403"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Contributor user can't update tags with Rest API and status code is 403"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.SANITY,
    description = "Verify Consumer user can't update tags with Rest API and status code is 403"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify admin is not able to update tag with invalid id"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  public void adminIsNotAbleToUpdateTagWithInvalidId() throws Exception {
    String invalidTagId = "invalid-id";
    RestTagModel tag = restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
      .usingResource(document)
      .addTag(RandomData.getRandomName("tag"));
    tag.setId(invalidTagId);
    restClient
      .withCoreAPI()
      .usingTag(tag)
      .update(RandomData.getRandomName("tag"));
    restClient
      .assertStatusCodeIs(HttpStatus.NOT_FOUND)
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, invalidTagId)
      );
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify admin is not able to update tag with empty id"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify admin is not able to update tag with invalid body"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  public void adminIsNotAbleToUpdateTagWithEmptyBody() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(RestErrorModel.EMPTY_TAG);
  }
    ...
    Utility.sleep(
      ...
      () -> {
        ...
        restClient
          ...
          .assertLastError()
          .containsSummary(
            String.format(RestErrorModel.INVALID_TAG, invalidTagBody)
          );
      }
    );
  }
  ...
  public void adminIsAbleToUpdateTagsProvideLargeStringTag() throws Exception {
    ...
    restClient.authenticateUser(adminUserModel);
    returnedModel =
      restClient.withCoreAPI().usingTag(oldTag).update(largeStringTag);
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void adminIsAbleToUpdateTagsProvideShortStringTag() throws Exception {
    ...
    restClient.authenticateUser(adminUserModel);
    returnedModel =
      restClient.withCoreAPI().usingTag(oldTag).update(shortStringTag);
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void adminIsAbleToUpdateTagsProvideSpecialCharsStringTag()
    ...
    restClient.authenticateUser(adminUserModel);
    returnedModel =
      restClient.withCoreAPI().usingTag(oldTag).update(specialCharsString);
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void adminIsAbleToUpdateTagsProvideExistingTag() throws Exception {
    ...
    RestTagModel oldExistingTag = restClient
    ...
    restClient.authenticateUser(adminUserModel);
    returnedModel =
      restClient.withCoreAPI().usingTag(oldExistingTag).update(existingTag);
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void adminDeleteTagAddTagUpdateTag() throws Exception {
    ...
    RestTagModel newTagModel = restClient
      .withCoreAPI()
      .usingResource(document)
      .addTag(newTag);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
    ...
    returnedModel =
      restClient.withCoreAPI().usingTag(newTagModel).update(newTag);
    restClient.assertStatusCodeIs(HttpStatus.OK);
