...
public class CreateFolderTests extends CmisTest {
  ...
  public void siteManagerCannotCreateFolderWithInvalidObjectTypeId()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(testUser)
  ...
  public void siteManagerCannotCreateFolderWithDocumentTypeId()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    cmisApi
      .authenticateUser(testUser)
  ...
  public void siteManagerCannotCreateFolderWithNoParamenters()
    throws Exception {
  ...
  public void siteManagerCannotCreateFolderWithDocumentParamenters()
    throws Exception {
    testFolder = FolderModel.getRandomFolderModel();
    Map<String, Object> properties = new HashMap<String, Object>();
