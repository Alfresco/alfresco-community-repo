...
/**
 * Used to send transform response messages to remote transform clients. The response is identical
 * to that produced by the Alfresco Transform Service (ATS).
 *
 * <p>Not currently supported in community edition.
 */
