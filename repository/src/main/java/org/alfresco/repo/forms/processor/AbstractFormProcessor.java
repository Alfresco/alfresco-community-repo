...
/**
 * Abstract base class for all FormProcessor implementations provides a regex pattern match to test
 * for processor applicability
 *
...
public abstract class AbstractFormProcessor implements FormProcessor {
    ...
    public void register() {
        if (this.processorRegistry == null) {
            if (logger.isWarnEnabled())
                logger.warn(
                        "Property 'processorRegistry' has not been set.  Ignoring auto-registration"
                                + " of processor: "
                                + this);
        ...
        if (this.matchPattern == null) {
            if (logger.isWarnEnabled())
                logger.warn(
                        "Property 'matchPattern' has not been set.  Ignoring auto-registration of"
                                + " processor: "
                                + this);
    ...
    /**
     * Gets the Item from the <code>form</code> parameter and sets its type field to <code>type
     * </code>.
     *
     * @param form Form
     * @param type String
