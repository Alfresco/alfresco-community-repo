...
public class RepoTransferProgressMonitorImpl
  ...
  public TransferProgress getProgressInternal(final String transferId) {
    ...
    progress.setError(
      (Throwable) nodeService.getProperty(
        nodeRef,
  ...
  private void testCancelled(NodeRef transferRecord)
    throws TransferFatalException {
    ...
    if (Status.CANCELLED.equals(currentStatus)) {
      throw new TransferFatalException(
        ...
        new Object[] { transferRecord.toString() }
      );
    }
  }

  private NodeRef getTransferRecord(String transferId)
