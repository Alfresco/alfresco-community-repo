 ...
 *
 * <p>It should be ok to set these variables multiple times but only the latest values are used.
 *
 * @author Gethin James
 */
public class WithResponse {
    ...
    /**
     * Set a response header with the given name and value. If the header has already been set, the
    ...
    /**
     * Adds a response header with the given name and value. This method allows a response header to
