...
public class CopyServiceImplTest extends TestCase {
  ...
  private static final QName PROP1_QNAME_MANDATORY = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "prop1Mandatory"
  );
  private static final QName PROP2_QNAME_OPTIONAL = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "prop2Optional"
  );

  private static final QName TEST_ASPECT_QNAME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "testAspect"
  );
  private static final QName PROP3_QNAME_MANDATORY = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "prop3Mandatory"
  );
  private static final QName PROP4_QNAME_OPTIONAL = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "prop4Optional"
  );

  private static final QName PROP_QNAME_MY_NODE_REF = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "myNodeRef"
  );
  private static final QName PROP_QNAME_MY_ANY = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "myAny"
  );

  private static final QName PROP_QNAME_RESIDUAL_NODE_REF = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "residualNodeRef"
  );
  private static final QName PROP_QNAME_RESIDUAL_ANY = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "residualAny"
  );

  private static final QName TEST_MANDATORY_ASPECT_QNAME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "testMandatoryAspect"
  );
  private static final QName PROP5_QNAME_MANDATORY = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "prop5Mandatory"
  );
  ...
  private static final QName TEST_CHILD_ASSOC_TYPE_QNAME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "contains"
  );
  private static final QName TEST_CHILD_ASSOC_QNAME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "testChildAssocName"
  );
  private static final QName TEST_ASSOC_TYPE_QNAME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "testAssocName"
  );
  private static final QName TEST_CHILD_ASSOC_QNAME2 = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "testChildAssocName2"
  );

  private static final ContentData CONTENT_DATA_TEXT = new ContentData(
    null,
    "text/plain",
    0L,
    "UTF-8"
  ...
  private static final QName TYPE_CUSTOM_CMIS_DOCUMENT = QName.createQName(
    "{http://www.alfresco.org/model/cmis/custom}document"
  );
  private static final QName PROP_CUSTOM_STRING = QName.createQName(
    "{http://www.alfresco.org/model/cmis/custom}docprop_string"
  );
  ...
  private void createTestModel() {
    ...
    M2Property prop1 = testType.createProperty(
      "test:" + PROP1_QNAME_MANDATORY.getLocalName()
    );
    ...
    M2Property prop2 = testType.createProperty(
      "test:" + PROP2_QNAME_OPTIONAL.getLocalName()
    );
    prop2.setMandatory(false);
    prop2.setType("d:" + DataTypeDefinition.TEXT.getLocalName());
    prop2.setMandatory(false);

    M2Property propNodeRef = testType.createProperty(
      "test:" + PROP_QNAME_MY_NODE_REF.getLocalName()
    );
    propNodeRef.setMandatory(false);
    propNodeRef.setType("d:" + DataTypeDefinition.NODE_REF.getLocalName());
    propNodeRef.setMandatory(false);

    M2Property propAnyNodeRef = testType.createProperty(
      "test:" + PROP_QNAME_MY_ANY.getLocalName()
    );
    propAnyNodeRef.setMandatory(false);
    propAnyNodeRef.setType("d:" + DataTypeDefinition.ANY.getLocalName());
    propAnyNodeRef.setMandatory(false);

    M2ChildAssociation childAssoc = testType.createChildAssociation(
      "test:" + TEST_CHILD_ASSOC_TYPE_QNAME.getLocalName()
    );
    childAssoc.setTargetClassName("sys:base");
    childAssoc.setTargetMandatory(false);

    M2Association assoc = testType.createAssociation(
      "test:" + TEST_ASSOC_TYPE_QNAME.getLocalName()
    );
    assoc.setTargetClassName("sys:base");
    assoc.setTargetMandatory(false);

    M2Aspect testAspect = model.createAspect(
      "test:" + TEST_ASPECT_QNAME.getLocalName()
    );

    M2Property prop3 = testAspect.createProperty(
      "test:" + PROP3_QNAME_MANDATORY.getLocalName()
    );
    prop3.setMandatory(true);
    prop3.setType("d:" + DataTypeDefinition.TEXT.getLocalName());
    prop3.setMultiValued(false);

    M2Property prop4 = testAspect.createProperty(
      "test:" + PROP4_QNAME_OPTIONAL.getLocalName()
    );
    prop4.setMandatory(false);
    prop4.setType("d:" + DataTypeDefinition.TEXT.getLocalName());
    prop4.setMultiValued(false);

    M2Aspect testMandatoryAspect = model.createAspect(
      "test:" + TEST_MANDATORY_ASPECT_QNAME.getLocalName()
    );
    M2Property prop5 = testMandatoryAspect.createProperty(
      "test:" + PROP5_QNAME_MANDATORY.getLocalName()
    );
    prop5.setType("d:" + DataTypeDefinition.TEXT.getLocalName());
    prop5.setMandatory(true);

    testType.addMandatoryAspect(
      "test:" + TEST_MANDATORY_ASPECT_QNAME.getLocalName()
    );
  ...
  public void testCopyToNewNodeWithPermissions() {
    ...
    assertEquals(
      3,
      permissionService.getAllSetPermissions(sourceNodeRef).size()
    );
  ...
  public void testCopyOfCopyOfCopy() {
    ...
    for (int i = 1; i <= 5; i++) {
      ...
      assertEquals(
        "Incorrect number of copies on iteration " + i,
        1,
        copies.getPage().size()
      );
  ...
  public void testCopyResidualProperties() throws Exception {
    ...
    Serializable propNodeRef = nodeService.getProperty(
      nodeOneCopy,
      PROP_QNAME_RESIDUAL_NODE_REF
    );
    assertEquals("Residual d:noderef not copied", nodeOne, propNodeRef);

    // Check the any property
    Serializable propAny = nodeService.getProperty(
      nodeOneCopy,
      PROP_QNAME_RESIDUAL_ANY
    );
  ...
  public void testRelativeLinks() {
    ...
    NodeRef nodeNotCopied = nodeService
      .createNode(
        rootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        nodeOneAssocName,
    ...
    List<ChildAssociationRef> nodeOneCopyChildren = nodeService.getChildAssocs(
      nodeOneCopy
    );
    ...
    for (ChildAssociationRef nodeOneCopyChild : nodeOneCopyChildren) {
      if (nodeOneCopyChild.getQName().equals(nodeTwoAssocName) == true) {
        ...
        List<ChildAssociationRef> nodeTwoCopyChildren = nodeService.getChildAssocs(
          nodeTwoCopy
        );
        ...
        nodeOneCopyChild.getQName().equals(nodeFourAssocName) == true
      ) {
    ...
    NodeRef value = (NodeRef) ruleAction.getParameterValue(
  ...
  public void testCopyAndRename() {
    ...
    checkCopiedNode(sourceNodeRef, copy, true, true, false);
    assertTrue(
      TEST_NAME.equals(nodeService.getProperty(copy, ContentModel.PROP_NAME))
    );
    ...
    NodeRef folderNode = nodeService
      .createNode(
        rootNodeRef,
        ContentModel.ASSOC_CHILDREN,
    ...
    NodeRef contentNode = nodeService
      .createNode(
        folderNode,
    ...
    NodeRef contentCopy = copyService.copy(
      contentNode,
      folderNode,
      ContentModel.ASSOC_CONTAINS,
    ...
    assertFalse(
      TEST_NAME.equals(
        nodeService.getProperty(contentCopy, ContentModel.PROP_NAME)
      )
    );
  }
  ...
  public void testETWOONE_244() {
    ...
    NodeRef folderNode = nodeService
      .createNode(
        rootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "tempFolder"),
        ContentModel.TYPE_FOLDER,
        propsFolder
      )
      .getChildRef();
    ...
    QName copyQName = QName.createQName(
      NamespaceService.CONTENT_MODEL_1_0_URI,
      "Copy of myDoc.txt"
    );
  ...
  public void testCopyMLText() {
    ...
    Serializable desc = nodeService.getProperty(
      copy,
    ...
    if (desc instanceof MLText) {
      ...
      assertEquals(
        ...
        FRENCH_DESCRIPTION,
        value.get(Locale.FRANCE)
      );
      assertEquals(
        "German description is wrong",
        GERMAN_DESCRIPTION,
        value.get(Locale.GERMAN)
      );
    } else {
  ...
  public void testCopyUserPermissions() throws Exception {
    ...
    NodeRef copied = copyService.copy(
      toCopy,
      targetNodeRef,
      ContentModel.ASSOC_CONTAINS,
      QName.createQName("NewCopy")
    ...
    assertEquals(
      USER_1,
      nodeService.getProperty(toCopy, ContentModel.PROP_CREATOR)
    );
    assertEquals(
      USER_1,
      nodeService.getProperty(toCopy, ContentModel.PROP_MODIFIER)
    );
    assertEquals(
      USER_2,
      nodeService.getProperty(copied, ContentModel.PROP_CREATOR)
    );
    assertEquals(
      USER_2,
      nodeService.getProperty(copied, ContentModel.PROP_MODIFIER)
    );
  ...
  private void checkCopiedNode(
    ...
    if (newCopy == true) {
      if (sameStore == true) {
        ...
        boolean hasCopyAspect = nodeService.hasAspect(
          destinationNodeRef,
          ContentModel.ASPECT_COPIEDFROM
        );
        assertTrue(
          "Missing aspect: " + ContentModel.ASPECT_COPIEDFROM,
          hasCopyAspect
        );
        List<AssociationRef> assocs = nodeService.getTargetAssocs(
          destinationNodeRef,
        ...
        assertEquals(
          "Expectd exactly one reference back to original",
          1,
          assocs.size()
        );
    ...
    boolean hasTestAspect = nodeService.hasAspect(
      destinationNodeRef,
      TEST_ASPECT_QNAME
    );
    ...
    Map<QName, Serializable> destinationProperties = nodeService.getProperties(
      destinationNodeRef
    );
    ...
    List<AssociationRef> destinationTargets = nodeService.getTargetAssocs(
      destinationNodeRef,
      TEST_ASSOC_TYPE_QNAME
    );
    ...
    if (
      nodeService.hasAspect(destinationNodeRef, RuleModel.ASPECT_RULES) == true
    ) {
  ...
  public void testCopyNullPropertyForAlf10712() throws Exception {
    ...
    Serializable customPropValue = nodeService.getProperty(
      sourceNodeRef,
      PROP_CUSTOM_STRING
    );
    assertNull(
    ...
    Serializable customProp = nodeService.getProperty(
      targetNodeRef,
      PROP_CUSTOM_STRING
    );
    assertEquals(
    ...
    Serializable updatedCustomProp = nodeService.getProperty(
      targetNodeRef,
      PROP_CUSTOM_STRING
    );
    assertNull(
  ...
  public void testALF17549() throws Exception {
    ...
    List<ChildAssociationRef> childAssoc = nodeService.getChildAssocs(
      targetNodeRef,
      ContentModel.ASSOC_CONTAINS,
    ...
    Action action =
      this.actionService.createAction(TransformActionExecuter.NAME);
  ...
  public void testCopyWorkingCopyForAlf8863() throws Exception {
    ...
    String newNameAfterCopy = copyService.getTopLevelNodeNewName(
      sourceNodeRef,
      rootNodeRef,
      ContentModel.ASSOC_CHILDREN,
      assocRef.getQName()
    ...
    ChildAssociationRef assocWCRef = nodeService.getPrimaryParent(
      workingCopyRef
    );
    newNameAfterCopy =
    ...
    NodeRef copyRef = copyService.copyAndRename(
      workingCopyRef,
      rootNodeRef,
      ContentModel.ASSOC_CHILDREN,
      null,
    ...
    String copyofWCName = (String) nodeService.getProperty(
      copyRef,
