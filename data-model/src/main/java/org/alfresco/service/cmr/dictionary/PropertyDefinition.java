...
public interface PropertyDefinition extends ClassAttributeDefinition {
    ...
    /**
     * @return IndexTokenisationMode.TREU => tokenised when it is indexed (the stored value will not
     *     be tokenised)
     */
     ...
     *
     * @return true => The attribute must be indexed in the commit of the transaction. false => the
     *     indexing will be done in the background and may be out of date.
     */
