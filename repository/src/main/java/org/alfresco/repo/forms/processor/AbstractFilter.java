 ...
 */
public abstract class AbstractFilter<ItemType, PersistType>
  implements Filter<ItemType, PersistType> {
  ...
  public void register() {
    if (filterRegistry == null) {
      if (logger.isWarnEnabled()) logger.warn(
        "Property 'filterRegistry' has not been set. Ignoring auto-registration of filter: " +
        this
      );
