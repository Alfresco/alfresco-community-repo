...
public class RM1887Test extends BaseRMTestCase {
    ...
    /**
     * Given that a record is unfiled And an unfiled folder has been created When I move the unfiled
     * record into the unfiled folder Then the filed date of the unfiled record remains unset
     */
                    ...
                    public void given() throws Exception {
                        ...
                        unfiledRecord =
                                recordService.createRecordFromContent(
                                        filePlan, "test.txt", TYPE_CONTENT, null, null);
