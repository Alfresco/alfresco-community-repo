...
public class XSLTRenderingEngineTest extends BaseAlfrescoSpringTest {
  ...
  public void testSimplestStringTemplate() throws Exception {
    try {
      ...
      RenditionDefinition def = renditionService.createRenditionDefinition(
        ...
        XSLTRenderingEngine.NAME
      );
      def.setParameterValue(
        XSLTRenderingEngine.PARAM_TEMPLATE_NODE,
        xslFile.getNodeRef()
      );
  ...
  public void testSimplestTemplateWithTargetPath() throws Exception {
    ...
    try {
      ...
      assertEquals(
        2,
        nodeService.getParentAssocs(rendition.getChildRef()).size()
      );
  ...
  public void testParseXMLDocuments() throws Exception {
    try {
      ...
      FileInfo folder = FileFolderServiceImpl.makeFolders(
        fileFolderService,
        companyHome,
        pathElements,
  ...
  public void testImportXMLDocument() throws Exception {
    try {
      ...
      FileInfo testImportTable = createXmlFile(
        companyHome,
        "TestImportTableXML.xml",
        testImportTableXml
      );
