...
public class AttributeServiceTest extends TestCase {
    ...
    /**
     * Checks that {@link AttributeService#getAttributes(AttributeQueryCallback, Serializable...)
     * AttributeService.getAttributes} works. This includes coverage of <a
     * href=https://issues.alfresco.com/jira/browse/MNT-9112>MNT-9112</a>.
     */
    ...
    public void testKeySegmentsGuaranteeUniqueness() {
        ...
        final NodeRef KEY_NODEREF =
                new NodeRef("workspace://SpacesStore/5980bbdb-8a31-437e-95c8-d5092c3c58fc");
        final TestIdentifier KEY_SERIALIZABLE = new TestIdentifier(KEY_STR_2);

        try {
            // check integer keys
            assertEquals(
                    PropertyValueEntity.getPersistedTypeEnum(KEY_INT_2, converter),
                    PersistedType.LONG);
            ...
            // check noderef keys
            assertEquals(
                    PropertyValueEntity.getPersistedTypeEnum(KEY_NODEREF, converter),
            ...
            // check enum keys
            assertEquals(
                    PropertyValueEntity.getPersistedTypeEnum(KEY_ENUM, converter),
                    PersistedType.ENUM);
            ...
            assertEquals(
                    PropertyValueEntity.getPersistedTypeEnum(KEY_MAP, converter),
            ...
            // check string keys
            assertEquals(
                    PropertyValueEntity.getPersistedTypeEnum(KEY_STR_2, converter),
                    PersistedType.STRING);
            ...
            assertEquals(
                    PropertyValueEntity.getPersistedTypeEnum(KEY_SERIALIZABLE, converter),
                    PersistedType.SERIALIZABLE);
            try {
                attributeService.createAttribute(VAL1, KEY_STR_1, KEY_SERIALIZABLE);
                fail(
                        "Keys of SERIALIZABLE persisted type are not allowed because it cannot"
    ...
    public void testUpdateOrCreateAttribute() {
        ...
        try {
            attributeService.updateOrCreateAttribute(
                    KEY_RND_STR_2, null, null, KEY_RND_STR_1, null, null);
            try {
                attributeService.updateOrCreateAttribute(
                        KEY_RND_STR_2, null, null, KEY_RND_STR_1, null, null);
                fail("Duplicate attribute creation should not be allowed");
            ...
            attributeService.updateOrCreateAttribute(
                    KEY_RND_STR_1, null, null, KEY_RND_STR_2, null, null);
            attributeService.updateOrCreateAttribute(
                    KEY_RND_STR_2, null, null, KEY_RND_STR_2, null, null);
        } finally {
