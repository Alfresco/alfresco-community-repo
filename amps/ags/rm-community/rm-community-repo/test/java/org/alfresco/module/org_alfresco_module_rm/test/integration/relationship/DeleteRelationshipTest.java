                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        relationshipService.addRelationship(
                                associationName, sourceNode, targetNode);
                    }
                    ...
                    public void then() {
                        ...
                        Set<Relationship> relationships =
                                relationshipService.getRelationshipsFrom(sourceNode);
                        for (Relationship r : relationships) {
                            assertFalse(
                                    r.getTarget().equals(targetNode)
                                            && r.getUniqueName().equals(associationName));
                        }
                    }
                });
    }
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void then() throws Exception {
                        ...
                        assertEquals(
                                0, relationshipService.getRelationshipsFrom(sourceRecord).size());
                        assertEquals(
                                0, relationshipService.getRelationshipsTo(sourceRecord).size());
                        assertEquals(
                                0, relationshipService.getRelationshipsFrom(targetRecord).size());
                        assertEquals(
                                0, relationshipService.getRelationshipsTo(targetRecord).size());
                    }
                });
    }
}
