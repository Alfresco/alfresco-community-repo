...
public class ResetPasswordServiceImplTest {
    ...
    @Rule
    public final RunAsFullyAuthenticatedRule runAsRule =
            new RunAsFullyAuthenticatedRule(AuthenticationUtil.getSystemUserName());
    ...
    public void testResetPassword() throws Exception {
        ...
        String emailSubjectKey =
                getDeclaredField(SendResetPasswordEmailDelegate.class, "EMAIL_SUBJECT_KEY");
        ...
        ResetPasswordDetails passwordDetails =
        ...
        emailSubjectKey =
                getDeclaredField(
                        SendResetPasswordConfirmationEmailDelegate.class, "EMAIL_SUBJECT_KEY");
        assertNotNull(emailSubjectKey);
        assertEquals(msg.getSubject(), I18NUtil.getMessage(emailSubjectKey));
    ...
    public void testRequestResetPasswordInvalid() throws Exception {
        ...
        TestHelper.assertThrows(
                () ->
                        resetPasswordService.requestReset(
                                testPerson.userName, "TestClient" + System.currentTimeMillis()),
        ...
        TestHelper.assertThrows(
                () ->
                        resetPasswordService.requestReset(
                                "NoUser" + System.currentTimeMillis(), "share"),
    ...
    public void testResetPasswordInvalid() throws Exception {
        ...
        TestHelper.assertThrows(
                () -> resetPasswordService.initiateResetPassword(passwordDetails),
                InvalidResetPasswordWorkflowException.class,
                "The given user id does not match the person's user id who requested the password"
                        + " reset.");
    ...
    public void testResetPasswordEndTimer() throws Exception {
        ...
        try {
            ...
            boolean active =
                    TestHelper.waitBeforeRetry(() -> isActive(pair.getFirst()), false, 10, 1000);
    ...
    public static Pair<String, String> getWorkflowIdAndKeyFromUrl(String url) {
        // url example:
        // http://localhost:8081/share/page/reset-password?key=164e37bf-2590-414e-94db-8b8cfe5be790&id=activiti$156
        assertNotNull(url);
    ...
    private static void createUser(TestPerson testPerson) {
        ...
        authenticationService.createAuthentication(
                testPerson.userName, testPerson.password.toCharArray());
