...
/**
 * Class holding properties associated with the <b>sys:localized</b> aspect. This aspect is common
 * enough to warrant direct inclusion on the <b>Node</b> entity.
 *
 * @author Derek Hulley
 * @since 4.0
 */
public class LocalizedPropertiesEntity {
    ...
    public static void addLocalizedProperties(
            LocaleDAO localeDAO, Node node, Map<QName, Serializable> properties) {
