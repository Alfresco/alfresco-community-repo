...
public abstract class BaseRMTestCase extends RetryingTransactionHelperTestCase
     ...
     *
     * <p>|--rmRootContainer | |--mhContainer | |--mhContainer-1-1 (has schedule - folder level) | |
     * | |--mhContainer-2-1 | | | |--mhContainer-3-1 | |--mhContainer-1-2 (has schedule - folder
     * level) | |--mhContainer-2-2 | | | |--mhContainer-3-2 | | | |--mhContainer-3-3 (has schedule -
     * record level) | |--mhContainer-2-3 (has schedule - folder level) | |--mhContainer-3-4 |
    ...
    /**
     * Indicates whether this is a RM site test or not. If true then the test RM site is created
     * along with a basic file plan structure, otherwise not.
     */
    ...
    /**
     * Indicates whether this is a multi-hierarchy test or not. If it is then the multi-hierarchy
     * record taxonomy test data is loaded.
     */
    ...
    /**
     * Indicates whether the test users should have filling on the file plan structure by default or
     * not.
     */
    ...
    protected void initServices() {
        ...
        rmSearchService =
                (RecordsManagementSearchService)
                        this.applicationContext.getBean("RecordsManagementSearchService");
        filePlanRoleService =
                (FilePlanRoleService) this.applicationContext.getBean("FilePlanRoleService");
        filePlanPermissionService =
                (FilePlanPermissionService)
                        this.applicationContext.getBean("FilePlanPermissionService");
        capabilityService =
                (CapabilityService) this.applicationContext.getBean("CapabilityService");
        vitalRecordService =
                (VitalRecordService) this.applicationContext.getBean("VitalRecordService");
        ...
        extendedSecurityService =
                (ExtendedSecurityService) applicationContext.getBean("ExtendedSecurityService");
        ...
        identifierService =
                (IdentifierService)
                        applicationContext.getBean("recordsManagementIdentifierService");
        ...
        rmContainerCacheManager =
                (RMContainerCacheManager) applicationContext.getBean("rmContainerCacheManager");
    }
    ...
    protected void setupTestDataImpl() {
        ...
        if (isRMSiteTest()) {
            ...
            assertNotNull(
                    "Site document library container was not created successfully.", filePlan);
    ...
    protected abstract class BehaviourDrivenTest {
        ...
        public BehaviourDrivenTest(
                Class<?> expectedException, String runAsUser, boolean runInTransactionTests) {
            this.expectedException = expectedException;
            this.runAsUser = runAsUser;
            this.runInTransactionTests = runInTransactionTests;
        }
