...
/**
 * A helper class to convert {@link ThumbnailDefinition thumbnail definition} and {@link
 * TransformationOptions transformationOptions} (thumbnail-specific classes) to rendition-specific
 * parameters and vice versa.
 *
 * <p>The Thumbnail Service exposes parameters as simple data types on its various method
 * signatures. See for example ThumbnailDefinition.createThumbnail(...) or updateThumbnail(...). The
 * RenditionService replaces this approach with one based on the ActionService where parameters are
 * added as a Map on the Action/RenditionDefinition object.
 *
 * @see ThumbnailService#createThumbnail(org.alfresco.service.cmr.repository.NodeRef, QName, String,
 *     TransformationOptions, String)
 * @see ThumbnailService#createThumbnail(org.alfresco.service.cmr.repository.NodeRef, QName, String,
 *     TransformationOptions, String, ThumbnailParentAssociationDetails)
 * @see ThumbnailService#updateThumbnail(org.alfresco.service.cmr.repository.NodeRef,
...
public class ThumbnailRenditionConvertor {
    ...
    /**
     * Given the specified {@link ThumbnailDefinition thumbnailDefinition} and {@link
     * ThumbnailParentAssociationDetails assocDetails}, create and return an equivalent {@link
     * RenditionDefinition} object.
     *
     ...
     */
    public RenditionDefinition convert(
        ...
        if (thumbnailDefinition == null
                || thumbnailDefinition.getName() == null
                || thumbnailDefinition.getName().trim().length() == 0) {
            throw new IllegalArgumentException(
                    "Thumbnail Definition and Name must be non-null and non-empty.");
        }
        ...
        putParameterIfNotNull(
                AbstractRenderingEngine.PARAM_MIME_TYPE,
                thumbnailDefinition.getMimetype(),
                parameters);
        putParameterIfNotNull(
                AbstractRenderingEngine.PARAM_PLACEHOLDER_RESOURCE_PATH,
                thumbnailDefinition.getPlaceHolderResourcePath(),
                parameters);
        putParameterIfNotNull(
                AbstractRenderingEngine.PARAM_RUN_AS, thumbnailDefinition.getRunAs(), parameters);

        QName namespacedRenditionName =
                QName.createQName(
                        NamespaceService.CONTENT_MODEL_1_0_URI, thumbnailDefinition.getName());
        ...
        String renderingEngineName =
                isImageThumbnail ? ImageRenderingEngine.NAME : ReformatRenderingEngine.NAME;

        RenditionDefinition renditionDef =
                renditionService.createRenditionDefinition(
                        namespacedRenditionName, renderingEngineName);
    ...
    /**
     * This method examines the various data values on the thumbnail definition and works out if it
     * is an 'image' rendition or a 'reformat' rendition
     *
     * @param thumbnailDefinition ThumbnailDefinition
    ...
    private boolean isImageBasedRendition(ThumbnailDefinition thumbnailDefinition) {
        ...
        return transformationOptions != null
                && transformationOptions instanceof ImageTransformationOptions;
    }

    /**
     * Given the specified {@link TransformationOptions transformationOptions} and {@link
     * ThumbnailParentAssociationDetails assocDetails}, create and return a parameter Map which
     * contains the equivalent {@link RenditionDefinition} configuration.
     *
     * @param transformationOptions TransformationOptions
     * @param assocDetails ThumbnailParentAssociationDetails
     * @return Map
     */
    public Map<String, Serializable> convert(
            TransformationOptions transformationOptions,
            ThumbnailParentAssociationDetails assocDetails) {
        ...
        putParameterIfNotNull(
                AbstractRenderingEngine.PARAM_SOURCE_CONTENT_PROPERTY,
                transformationOptions.getSourceContentProperty(),
                parameters);
        putParameterIfNotNull(
                AbstractRenderingEngine.PARAM_TARGET_CONTENT_PROPERTY,
                transformationOptions.getTargetContentProperty(),
                parameters);
        putParameterIfNotNull(
        ...
        //        putParameterIfNotNull(ImageRenderingEngine.PARAM_ASSOC_NAME,
        // assocDetails.getAssociationName(), parameters);
        //        putParameterIfNotNull(ImageRenderingEngine.PARAM_ASSOC_TYPE,
        // assocDetails.getAssociationType(), parameters);

        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_TIMEOUT_MS,
                transformationOptions.getTimeoutMs(),
                parameters);
        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_READ_LIMIT_TIME_MS,
                transformationOptions.getReadLimitTimeMs(),
                parameters);
        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_MAX_SOURCE_SIZE_K_BYTES,
                transformationOptions.getMaxSourceSizeKBytes(),
                parameters);
        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_READ_LIMIT_K_BYTES,
                transformationOptions.getReadLimitKBytes(),
                parameters);
        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_MAX_PAGES,
                transformationOptions.getMaxPages(),
                parameters);
        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_PAGE_LIMIT,
                transformationOptions.getPageLimit(),
                parameters);

        putParameterIfNotNull(
                AbstractTransformationRenderingEngine.PARAM_USE,
                transformationOptions.getUse(),
                parameters);

        if (transformationOptions instanceof SWFTransformationOptions) {
            SWFTransformationOptions swfTransformationOptions =
                    (SWFTransformationOptions) transformationOptions;
            putParameterIfNotNull(
                    ReformatRenderingEngine.PARAM_FLASH_VERSION,
                    swfTransformationOptions.getFlashVersion(),
                    parameters);
        } else if (transformationOptions instanceof ImageTransformationOptions) {
            ImageTransformationOptions imTransformationOptions =
                    (ImageTransformationOptions) transformationOptions;
            putParameterIfNotNull(
                    ImageRenderingEngine.PARAM_COMMAND_OPTIONS,
                    imTransformationOptions.getCommandOptions(),
                    parameters);
            putParameterIfNotNull(
                    ImageRenderingEngine.PARAM_AUTO_ORIENTATION,
                    imTransformationOptions.isAutoOrient(),
                    parameters);
            ...
            if (imgResizeOptions != null) {
                ...
                parameters.put(
                        ImageRenderingEngine.PARAM_MAINTAIN_ASPECT_RATIO, maintainAspectRatio);
        ...
        if (transformationOptions.getSourceOptionsList() != null) {
            for (TransformationSourceOptions sourceOptions :
    ...
    private void putParameterIfNotNull(
            String paramName, Serializable paramValue, Map<String, Serializable> params) {
        if (paramValue != null) {
    ...
    public ThumbnailDefinition convert(RenditionDefinition renditionDefinition) {
        ...
        Serializable placeHolderResourcePathParam =
                params.get(AbstractRenderingEngine.PARAM_PLACEHOLDER_RESOURCE_PATH);
        ...
        Serializable flashVersion =
                renditionDefinition.getParameterValue(ReformatRenderingEngine.PARAM_FLASH_VERSION);
        if (flashVersion != null) {
            ...
            ImageTransformationOptions imgTrOpts =
                    (ImageTransformationOptions) transformationOptions;

            ImageResizeOptions resizeOptions = new ImageResizeOptions();
            Serializable xsize =
                    renditionDefinition.getParameterValue(ImageRenderingEngine.PARAM_RESIZE_WIDTH);
            if (xsize != null) {
                resizeOptions.setWidth(((Integer) xsize).intValue());
            }

            Serializable ysize =
                    renditionDefinition.getParameterValue(ImageRenderingEngine.PARAM_RESIZE_HEIGHT);
            if (ysize != null) {
            ...
            Serializable resizeToThumbnail =
                    renditionDefinition.getParameterValue(
                            ImageRenderingEngine.PARAM_RESIZE_TO_THUMBNAIL);
            ...
            Serializable allowEnlargement =
                    renditionDefinition.getParameterValue(
                            ImageRenderingEngine.PARAM_ALLOW_ENLARGEMENT);
