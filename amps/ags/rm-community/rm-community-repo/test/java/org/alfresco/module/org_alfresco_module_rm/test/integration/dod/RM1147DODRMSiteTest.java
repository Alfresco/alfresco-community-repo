...
/**
 * Integration test for RM1147 - A user can create a 'vanilla' or DOD compliant records management
 * site.
 *
        ...
        doTestInTransaction(
                new Test<NodeRef>() {
                    ...
                    public NodeRef run() throws Exception {
                        return filePlanService.createFilePlan(
                                folder, "myDODfileplan", TYPE_DOD_5015_FILE_PLAN);
                    }
        ...
        doTestInTransaction(
                new Test<SiteInfo>() {
                    ...
                    public void test(SiteInfo siteInfo) throws Exception {
                        ...
                        assertEquals(
                                TYPE_DOD_5015_SITE, nodeService.getType(siteInfo.getNodeRef()));
                ...
                new Test<NodeRef>() {
                    ...
                    public NodeRef run() throws Exception {
                        ...
                        NodeRef recordCategory =
                                filePlanService.createRecordCategory(filePlan, "testOne");
                        NodeRef recordFolder =
                                recordFolderService.createRecordFolder(recordCategory, "testOne");
                        NodeRef record =
                                utils.createRecord(recordFolder, "testOne.txt", "Test One");
