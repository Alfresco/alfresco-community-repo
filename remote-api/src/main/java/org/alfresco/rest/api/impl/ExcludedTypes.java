...
/**
 * Stores a set of excluded types, by full type name. The localName can be a wildcard (*) to
 * indicate that the whole namespace should be excluded.
 *
 * @author steveglover
 */
                    ...
                    TenantUtil.runAsSystemTenant(
                            new TenantRunAsWork<Boolean>() {
                                ...
                                public Boolean doWork() throws Exception {
                                    ...
                                    // the node is a content node. Make sure it doesn't have an
                                    // aspect in the excluded list.
                                    Set<QName> aspects =
                                            new HashSet<QName>(nodeService.getAspects(nodeRef));
