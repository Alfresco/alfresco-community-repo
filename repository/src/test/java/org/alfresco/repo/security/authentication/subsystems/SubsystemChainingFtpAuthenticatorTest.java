...
public class SubsystemChainingFtpAuthenticatorTest extends BaseSpringTest {
  ...
  public void testNumberOfAuthenticatorsInChain() {
    ...
    assertTrue(
      "The context configuration was created for 3 test FTP authenticators with 1 disabled.",
    ...
    assertTrue(
      "The context configuration was created for 2 test FTP authenticators - all disabled.",
  ...
  private void setContextForSubsystem(String beanName) {
    ...
    ChildApplicationContextManager applicationContextManager = (ChildApplicationContextManager) applicationContext.getBean(
      beanName
    );
    chainingAuthenticator.setApplicationContextManager(
