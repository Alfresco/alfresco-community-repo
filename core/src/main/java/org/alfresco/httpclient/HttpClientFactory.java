...
public class HttpClientFactory {
  ...
  public static final String DEFAULT_SHAREDSECRET_HEADER =
  ...
  public void init() {
    this.sslKeyStore =
      new AlfrescoKeyStoreImpl(
        sslEncryptionParameters.getKeyStoreParameters(),
        keyResourceLoader
      );
    this.sslTrustStore =
      new AlfrescoKeyStoreImpl(
        sslEncryptionParameters.getTrustStoreParameters(),
        keyResourceLoader
      );
  ...
  public void setSSLEncryptionParameters(
    SSLEncryptionParameters sslEncryptionParameters
  ) {
    this.sslEncryptionParameters = sslEncryptionParameters;
  }
  ...
  protected RequestHeadersHttpClient constructHttpClient() {
    ...
    RequestHeadersHttpClient httpClient = new RequestHeadersHttpClient(
      connectionManager
    );
    ...
    HttpConnectionManagerParams connectionManagerParams = httpClient
  ...
  protected RequestHeadersHttpClient getHttpsClient(
    ...
    HttpHostFactory hostFactory = new HttpHostFactory(
      new Protocol("https", sslSocketFactory, HttpsURL.DEFAULT_PORT)
    );
    httpClient.setHostConfiguration(
      new HostConfigurationWithHostFactory(hostFactory)
    );
    ...
    switch (secureCommsType) {
      ...
      default:
        throw new AlfrescoRuntimeException(
          "Invalid Solr secure communications type configured in [solr|alfresco].secureComms, should be 'ssl', 'none' or 'secret'"
        );
    }
  }
  ...
  public static class NonBlockingHttpParamsFactory
    ...
    protected HttpParams createParams() {
      ...
      params.setParameter(
        ...
        "Spring Surf via Apache HttpClient/3.1"
      );
