...
public abstract class AbstractForumEmailMessageHandler
  ...
  protected NodeRef addPostNode(NodeRef nodeRef, EmailMessage message) {
    ...
    NodeRef postNodeRef = nodeService.getChildByName(
      nodeRef,
  ...
  protected NodeRef getTopicNode(NodeRef nodeRef, String name) {
    ...
    NodeRef ret = getNodeService()
      .getChildByName(nodeRef, ContentModel.ASSOC_CONTAINS, workingName);
    return ret;
  }
  ...
  protected NodeRef addTopicNode(NodeRef parentNode, String name) {
    ...
    NodeRef topicNode = nodeService.getChildByName(
      parentNode,
      ContentModel.ASSOC_CONTAINS,
      workingName
    );
    ...
    getNodeService()
      .addAspect(topicNode, ApplicationModel.ASPECT_UIFACETS, properties);
