...
public class GetProcessDefinitionStartFormModelCoreTests extends RestTest {
  ...
  public void nonNetworkUserGetsStartFormModel() throws Exception {
    ...
    randomProcessDefinition =
      allProcessDefinitions.getOneRandomEntry().onModel();
    restClient
  ...
  public void getStartFormModelUsingInvalidProcessDefinitionId()
    throws Exception {
    randomProcessDefinition =
      allProcessDefinitions.getOneRandomEntry().onModel();
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          "no deployed process definition found with id '%s'",
          "invalidID"
        )
      )
  ...
  public void getStartFormModelUsingEmptyProcessDefinitionId()
    throws Exception {
    randomProcessDefinition =
      allProcessDefinitions.getOneRandomEntry().onModel();
