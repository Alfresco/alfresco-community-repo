...
public class GetProcessDefinitionStartFormModelFullTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin gets a model of the start form type definition for specific"
                            + " process definition using REST API and status code is OK (200)")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void adminGetsStartFormModelForActivitiAdhocProcessDefinition() throws Exception {
        returnedResponse =
                restClient
                        .authenticateUser(adminUser)
                        .withWorkflowAPI()
                        .usingProcessDefinitions(activitiAdhoc)
        ...
        returnedResponse
                .getStartFormModelByQualifiedName(
                ...
                .and()
                .field("name")
                .is("bpm_workflowPriority")
                .and()
                .field("title")
                .is("Workflow Priority")
                .and()
                .field("required")
                .is("false")
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin gets a model of the start form type definition with properties"
                            + " parameter applied using REST API and status code is OK (200)")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void adminGetsStartFormModelWithPropertiesParameterApplied() throws Exception {
        returnedResponse =
                restClient
                        .authenticateUser(adminUser)
                        .withParams("properties=qualifiedName,dataType,title")
                        .withWorkflowAPI()
                        .usingProcessDefinitions(activitiAdhoc)
                        .getProcessDefinitionStartFormModel();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        ...
        returnedResponse
                ...
                .and()
                .field("qualifiedName")
                .is("{http://www.alfresco.org/model/bpm/1.0}workflowPriority")
                .and()
                .field("defaultValue")
                .isNull()
                .and()
