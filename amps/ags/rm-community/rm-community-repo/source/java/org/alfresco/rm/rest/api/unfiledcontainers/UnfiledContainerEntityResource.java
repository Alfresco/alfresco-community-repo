...
public class UnfiledContainerEntityResource
  implements
    EntityResourceAction.ReadById<UnfiledContainer>,
  ...
  public UnfiledContainer readById(
    ...
    return nodesModelFactory.createUnfiledContainer(
      info,
      parameters,
      null,
      false
  ...
  public UnfiledContainer update(
    ...
    apiUtils.postActivity(
      info,
      unfiledContainerInfo.getParentId(),
