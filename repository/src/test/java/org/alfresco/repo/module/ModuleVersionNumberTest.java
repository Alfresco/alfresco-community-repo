...
public class ModuleVersionNumberTest extends TestCase {
  ...
  public void testCreate() {
    ...
    ModuleVersionNumber versionMixed = new ModuleVersionNumber(
  ...
  public void testCompare() {
    ...
    ModuleVersionNumber version1point4snapshot = new ModuleVersionNumber(
      "1.4-SNAPSHOT"
    );
    ...
    assertEquals(
      1,
      ModuleVersionNumber.VERSION_BIG.compareTo(version1point4snapshot)
    );
  ...
  public void testSerialize() throws IOException, ClassNotFoundException {
    ...
    ModuleVersionNumber versionsnapBefore = new ModuleVersionNumber(
      "1.0-SNAPSHOT"
    );
  ...
  private ModuleVersionNumber writeAndRead(ModuleVersionNumber versionNumber)
  ...
  public void testInternalVersionsAreUpgrades() {
    for (String[] pair : new String[][] { // same base version with an optional special suffix (-A9, -M9, -RC9)
      ...
      if ("downgrade".equals(expected)) {
        ...
        assertTrue(
          "Expected " +
          thisVersion +
          " to be the same base version as " +
          thatVersion +
          " (" +
          actual +
          ")",
