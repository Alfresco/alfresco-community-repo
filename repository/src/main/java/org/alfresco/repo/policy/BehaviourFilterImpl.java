...
/**
 * Implementation of Behaviour Filter. All methods operate on transactionally-bound resources.
 * Behaviour will therefore never span transactions; the filter state has the same lifespan as the
 * transaction in which it was created.
 *
 * <p><b>Multitenancy and disabling by <tt>NodeRef</tt>:</b><br>
...
public class BehaviourFilterImpl implements BehaviourFilter, Extensible {
    ...
    public BehaviourFilterImpl() {
        ...
        this.behaviourFilterTrait =
                new ExtendedTrait<>(AJProxyTrait.create(this, BehaviourFilterTrait.class));
    }
    ...
    public void disableBehaviour(QName className, boolean includeSubClasses) {
        ...
        Map<ClassFilter, MutableInt> classFilters =
                TransactionalResourceHelper.getMap(KEY_CLASS_FILTERS);
    ...
    public void disableBehaviour(NodeRef nodeRef, QName className) {
        ...
        Map<NodeRef, Map<QName, MutableInt>> instanceClassFilters =
                TransactionalResourceHelper.getMap(KEY_INSTANCE_CLASS_FILTERS);
    ...
    public void disableBehaviour(NodeRef nodeRef) {
        ...
        Map<NodeRef, MutableInt> instanceFilters =
                TransactionalResourceHelper.getMap(KEY_INSTANCE_FILTERS);
