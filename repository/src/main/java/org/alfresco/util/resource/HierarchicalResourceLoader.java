 ...
 * {@link #DEFAULT_DIALECT_PLACEHOLDER} is replaced with successive class names starting from the
 * {@link #setDialectClass(String) dialect class} and progressing up the hierarchy until the {@link
 * #setDialectBaseClass(String) base class} is reached. A full resource search using Spring's {@link
 * DefaultResourceLoader} is done at each point until the resource is found or the base of the class
 * hierarchy is reached.
 *
 * <p>For example assume classpath resources:<br>
 *
 * <pre>
