...
public class NodeDAOImpl extends AbstractNodeDAOImpl {
  ...
  private static final String INSERT_TRANSACTION =
    "alfresco.node.insert.insert_Transaction";
  private static final String UPDATE_TRANSACTION_COMMIT_TIME =
    "alfresco.node.update_TransactionCommitTime";
  private static final String DELETE_TRANSACTION_BY_ID =
    "alfresco.node.delete_TransactionById";
  private static final String INSERT_STORE =
    "alfresco.node.insert.insert_Store";
  private static final String UPDATE_STORE_ROOT =
    "alfresco.node.update_StoreRoot";
  private static final String UPDATE_STORE = "alfresco.node.update_Store";
  private static final String UPDATE_NODES_IN_STORE =
    "alfresco.node.update_NodesInStore";
  private static final String SELECT_STORE_ALL =
    "alfresco.node.select_StoreAll";
  private static final String SELECT_STORE_BY_REF =
    "alfresco.node.select_StoreByRef";
  private static final String SELECT_STORE_ROOT_NODE_BY_REF =
    "alfresco.node.select_StoreRootNodeByRef";
  ...
  private static final String UPDATE_NODE_BULK_TOUCH =
    "alfresco.node.update_NodeBulkTouch";
  private static final String DELETE_NODE_BY_ID =
    "alfresco.node.delete_NodeById";
  private static final String DELETE_NODES_BY_TXN_COMMIT_TIME =
    "alfresco.node.delete.delete_NodesByTxnCommitTime";
  private static final String DELETE_NODE_PROPS_BY_TXN_COMMIT_TIME =
    "alfresco.node.delete.delete_NodePropsByTxnCommitTime";
  private static final String SELECT_NODE_BY_ID =
    "alfresco.node.select_NodeById";
  private static final String SELECT_NODE_BY_NODEREF =
    "alfresco.node.select_NodeByNodeRef";
  private static final String SELECT_NODES_BY_UUIDS =
    "alfresco.node.select_NodesByUuids";
  private static final String SELECT_NODES_BY_IDS =
    "alfresco.node.select_NodesByIds";
  private static final String SELECT_NODE_PROPERTIES =
    "alfresco.node.select_NodeProperties";
  private static final String SELECT_PROPERTIES_BY_TYPES =
    "alfresco.node.select_PropertiesByTypes";
  private static final String SELECT_PROPERTIES_BY_ACTUAL_TYPE =
    "alfresco.node.select_PropertiesByActualType";
  private static final String SELECT_NODE_ASPECTS =
    "alfresco.node.select_NodeAspects";
  private static final String INSERT_NODE_PROPERTY =
    "alfresco.node.insert_NodeProperty";
  private static final String UPDATE_PRIMARY_CHILDREN_SHARED_ACL =
    "alfresco.node.update.update_PrimaryChildrenSharedAcl";
  private static final String INSERT_NODE_ASPECT =
    "alfresco.node.insert_NodeAspect";
  private static final String DELETE_NODE_ASPECTS =
    "alfresco.node.delete_NodeAspects";
  private static final String DELETE_NODE_PROPERTIES =
    "alfresco.node.delete_NodeProperties";
  private static final String SELECT_NODE_MIN_ID =
    "alfresco.node.select_NodeMinId";
  private static final String SELECT_NODE_MAX_ID =
    "alfresco.node.select_NodeMaxId";
  private static final String SELECT_NODE_INTERVAL_BY_TYPE =
    "alfresco.node.select_MinMaxNodeIdForNodeType";
  private static final String SELECT_NODES_WITH_ASPECT_IDS =
    "alfresco.node.select_NodesWithAspectIds";
  private static final String INSERT_NODE_ASSOC =
    "alfresco.node.insert.insert_NodeAssoc";
  private static final String UPDATE_NODE_ASSOC =
    "alfresco.node.update_NodeAssoc";
  private static final String DELETE_NODE_ASSOC =
    "alfresco.node.delete_NodeAssoc";
  private static final String DELETE_NODE_ASSOCS =
    "alfresco.node.delete_NodeAssocs";
  private static final String SELECT_NODE_ASSOCS =
    "alfresco.node.select_NodeAssocs";
  private static final String SELECT_NODE_ASSOCS_BY_SOURCE_AND_PROPERTY_VALUE =
    "alfresco.node.select_NodeAssocsBySourceAndPropertyValue";
  private static final String SELECT_NODE_ASSOCS_BY_TARGET =
    "alfresco.node.select_NodeAssocsByTarget";
  private static final String SELECT_NODE_ASSOC_BY_ID =
    "alfresco.node.select_NodeAssocById";
  private static final String SELECT_NODE_ASSOCS_MAX_INDEX =
    "alfresco.node.select_NodeAssocsMaxId";
  private static final String SELECT_CHILD_NODE_IDS =
    "alfresco.node.select.children.select_ChildNodeIds_Limited";
  private static final String SELECT_NODE_PRIMARY_CHILD_ACLS =
    "alfresco.node.select_NodePrimaryChildAcls";
  private static final String INSERT_CHILD_ASSOC =
    "alfresco.node.insert.insert_ChildAssoc";
  private static final String DELETE_CHILD_ASSOCS =
    "alfresco.node.delete_ChildAssocs";
  private static final String UPDATE_CHILD_ASSOCS_INDEX =
    "alfresco.node.update_ChildAssocsIndex";
  private static final String UPDATE_CHILD_ASSOC_UNIQUE_NAME =
    "alfresco.node.update_ChildAssocUniqueName";
  private static final String SELECT_CHILD_ASSOC_BY_ID =
    "alfresco.node.select_ChildAssocById";
  private static final String COUNT_CHILD_ASSOC_BY_PARENT_ID =
    "alfresco.node.count_ChildAssocByParentId";
  private static final String SELECT_CHILD_ASSOCS_BY_PROPERTY_VALUE =
    "alfresco.node.select_ChildAssocsByPropertyValue";
  private static final String SELECT_CHILD_ASSOCS_OF_PARENT =
    "alfresco.node.select_ChildAssocsOfParent";
  private static final String SELECT_CHILD_ASSOCS_OF_PARENT_LIMITED =
    "alfresco.node.select.children.select_ChildAssocsOfParent_Limited";
  private static final String SELECT_CHILD_ASSOC_OF_PARENT_BY_NAME =
  ...
  private static final String SELECT_PARENT_ASSOCS_OF_CHILD =
    "alfresco.node.select_ParentAssocsOfChild";
  private static final String UPDATE_PARENT_ASSOCS_OF_CHILD =
    "alfresco.node.update_ParentAssocsOfChild";
  private static final String DELETE_SUBSCRIPTIONS =
    "alfresco.node.delete_NodeSubscriptions";

  private static final String UPDATE_MOVE_PARENT_ASSOCS =
    "alfresco.node.update_MoveParentAssocs";
  private static final String UPDATE_MOVE_CHILD_ASSOCS =
    "alfresco.node.update_MoveChildAssocs";
  private static final String UPDATE_MOVE_SOURCE_ASSOCS =
    "alfresco.node.update_MoveSourceAssocs";
  private static final String UPDATE_MOVE_TARGET_ASSOCS =
    "alfresco.node.update_MoveTargetAssocs";
  private static final String UPDATE_MOVE_PROPERTIES =
    "alfresco.node.update_MoveProperties";
  private static final String UPDATE_MOVE_ASPECTS =
    "alfresco.node.update_MoveAspects";

  private static final String SELECT_TXN_LAST = "alfresco.node.select_TxnLast";
  private static final String SELECT_TXN_NODES =
    "alfresco.node.select_TxnNodes";
  private static final String SELECT_TXNS = "alfresco.node.select_Txns";
  private static final String SELECT_TXN_COUNT =
    "alfresco.node.select_TxnCount";
  private static final String SELECT_TXNS_UNUSED =
    "alfresco.node.select_TxnsUnused";
  private static final String DELETE_TXNS_UNUSED =
    "alfresco.node.delete_Txns_Unused";
  private static final String SELECT_TXN_MIN_COMMIT_TIME =
    "alfresco.node.select_TxnMinCommitTime";
  private static final String SELECT_TXN_MAX_COMMIT_TIME =
    "alfresco.node.select_TxnMaxCommitTime";
  private static final String SELECT_TXN_MIN_COMMIT_TIME_FOR_NODE_TYPE =
    "alfresco.node.select_TxnMinCommitTimeForNodeType";
  private static final String SELECT_TXN_MIN_ID =
    "alfresco.node.select_TxnMinId";
  private static final String SELECT_TXN_MAX_ID =
    "alfresco.node.select_TxnMaxId";
  private static final String SELECT_TXN_UNUSED_MIN_COMMIT_TIME =
    "alfresco.node.select_TxnMinUnusedCommitTime";
  private static final String SELECT_ONE_TXNS_BY_COMMIT_TIME_DESC =
    "alfresco.node.select_OneTxnsByCommitTimeDescending";
  private static final String SELECT_TXN_MIN_TX_ID_IN_NODE_IDRANGE =
    "alfresco.node.select_TxnMinTxIdInNodeIdRange";
  private static final String SELECT_TXN_MAX_TX_ID_IN_NODE_IDRANGE =
    "alfresco.node.select_TxnMaxTxIdInNodeIdRange";
  private static final String SELECT_TXN_NEXT_TXN_COMMIT_TIME =
    "select_TxnNextTxnCommitTime";
  ...
  public Pair<Long, Long> getNodeIdsIntervalForType(
    QName type,
    Long startTxnTime,
    Long endTxnTime
  ) {
    final Pair<Long, Long> intervalPair = new Pair<Long, Long>(
      LONG_ZERO,
      LONG_ZERO
    );
  ...
  protected void updatePrimaryChildrenSharedAclId(
    ...
    primaryChildrenAclUpdateEntity.setOptionalOldSharedAclIdInAdditionToNull(
      optionalOldSharedAlcIdInAdditionToNull
    );
    primaryChildrenAclUpdateEntity.setNewSharedAclId(newSharedAlcId);

    template.update(
      UPDATE_PRIMARY_CHILDREN_SHARED_ACL,
  ...
  @Override
  protected int deleteNodesByCommitTime(
    long fromTxnCommitTimeMs,
    long toTxnCommitTimeMs
  ) {
    // Get the deleted nodes
    Pair<Long, QName> deletedTypePair = qnameDAO.getQName(
  ...
  @Override
  protected List<Node> selectNodesByUuids(
    Long storeId,
    ...
    for (NodePropertyEntity row : rows) {
      ...
      if (nodeId == null || nodeVersion == null) {
        throw new RuntimeException(
          "Expect results with a Node and Version: " + row
        );
      }
   ...
   */
  private List<NodePropertyEntity> makePersistentRows(
    Long nodeId,
    Map<NodePropertyKey, NodePropertyValue> map
  ) {
    List<NodePropertyEntity> rows = new ArrayList<NodePropertyEntity>(
      map.size()
    );
  ...
  @Override
  protected Map<NodeVersionKey, Map<NodePropertyKey, NodePropertyValue>> selectNodeProperties(
    Set<Long> nodeIds
  ) {
    if (nodeIds.size() == 0) {
    ...
    List<NodePropertyEntity> rows = template.selectList(
  ...
  public List<NodePropertyEntity> selectNodePropertiesByDataType(
    ...
    template.select(
      SELECT_PROPERTIES_BY_ACTUAL_TYPE,
      ids,
      new ResultHandler() {
        @Override
        public void handleResult(ResultContext context) {
  ...
  @Override
  protected int deleteNodeProperties(
    Long nodeId,
  ...
  @Override
  protected void insertNodeProperties(
    Long nodeId,
    ...
    List<NodePropertyEntity> rows = makePersistentRows(
      nodeId,
      persistableProps
    );
  ...
  @Override
  protected Map<NodeVersionKey, Set<QName>> selectNodeAspects(
    Set<Long> nodeIds
  ) {
    if (nodeIds.size() == 0) {
      return Collections.emptyMap();
    ...
    List<NodeAspectsEntity> rows = template.selectList(
      SELECT_NODE_ASPECTS,
      aspects
    );

    Map<NodeVersionKey, Set<QName>> results = new HashMap<NodeVersionKey, Set<QName>>(
      rows.size() * 2
    );
    for (NodeAspectsEntity nodeAspectsEntity : rows) {
      ...
      if (results.containsKey(nodeVersionKey)) {
        throw new IllegalStateException(
          "Found existing key while querying for node aspects: " + nodeIds
        );
      }
      Set<Long> aspectIds = new HashSet<Long>(
        nodeAspectsEntity.getAspectQNameIds()
      );
  ...
  protected void selectNodesWithAspects(
    ...
    ResultHandler resultHandler = new ResultHandler() {
      public void handleResult(ResultContext context) {
        ...
        Pair<Long, NodeRef> nodePair = new Pair<Long, NodeRef>(
          entity.getId(),
          entity.getNodeRef()
        );
  ...
  @Override
  protected Long insertNodeAssoc(
    Long sourceNodeId,
    Long targetNodeId,
  ...
  @Override
  protected List<NodeAssocEntity> selectNodeAssocsBySource(
    Long sourceNodeId,
    Long typeQNameId
  ) {
    return selectNodeAssocsBySourceAndPropertyValue(
      sourceNodeId,
      typeQNameId,
      null,
      null
  ...
  @Override
  protected List<NodeAssocEntity> selectNodeAssocsBySourceAndPropertyValue(
    Long sourceNodeId,
    Long typeQNameId,
    ...
    return template.selectList(
      SELECT_NODE_ASSOCS_BY_SOURCE_AND_PROPERTY_VALUE,
      assoc
    );
  }

  @Override
  protected List<NodeAssocEntity> selectNodeAssocsByTarget(
    Long targetNodeId,
    Long typeQNameId
  ) {
    NodeAssocEntity assoc = new NodeAssocEntity();
  ...
  @Override
  protected int selectNodeAssocMaxIndex(
    Long sourceNodeId,
    Long assocTypeQNameId
  ) {
    NodeAssocEntity assoc = new NodeAssocEntity();
  ...
  private class ChildAssocResultHandler implements ResultHandler {
    ...
    private ChildAssocResultHandler(
    ...
    private ChildAssocResultHandler(
      ChildAssocResultHandlerFilter filter,
      ChildAssocRefQueryCallback resultsCallback
    ) {
      this.filter = filter;
    ...
    public void handleResult(ResultContext context) {
      ...
      // Call back
      boolean more = resultsCallback.handle(
        childAssocPair,
        parentNodePair,
        childNodePair
      );
  ...
  protected void selectChildAssocs(
    ...
    ChildAssocResultHandler resultHandler = new ChildAssocResultHandler(
      resultsCallback
    );
  ...
  public void selectChildAssocs(
    ...
    RowBounds rowBounds = new RowBounds(0, maxResults);
    List<?> entities = template.selectList(
      SELECT_CHILD_ASSOCS_OF_PARENT_LIMITED,
      assoc,
      rowBounds
    );
    @SuppressWarnings("rawtypes")
  ...
  protected void selectChildAssocs(
    ...
    assoc.setParentNode(parentNode);
    // Type QNames
    Set<Long> assocTypeQNameIds = qnameDAO.convertQNamesToIds(
      assocTypeQNames,
      false
    );
  ...
  @Override
  protected ChildAssocEntity selectChildAssoc(
    Long parentNodeId,
    QName assocTypeQName,
    String childName
  ) {
  ...
  protected void selectChildAssocs(
    ...
    if (childNames.size() == 0) {
      ...
      throw new IllegalArgumentException(
        "Unable to process more than 1000 child names in getChildAssocs"
      );
    }
    ...
    for (String childName : childNames) {
      ...
      String childNameShort = ChildAssocEntity.getChildNodeNameShort(
        childNameLower
      );
  ...
  protected void selectChildAssocsByPropertyValue(
    ...
    template.select(
      SELECT_CHILD_ASSOCS_BY_PROPERTY_VALUE,
      assocProp,
      resultHandler
    );
    resultsCallback.done();
  ...
  protected void selectChildAssocsByChildTypes(
    ...
    Set<Long> childNodeTypeQNameIds = qnameDAO.convertQNamesToIds(
      childNodeTypeQNames,
      false
    );
  ...
  protected void selectChildAssocsWithoutParentAssocsOfType(
    ...
    template.select(
      SELECT_CHILD_ASSOCS_OF_PARENT_WITHOUT_PARENT_ASSOCS_OF_TYPE,
      assoc,
      resultHandler
    );
    resultsCallback.done();
  ...
  public List<Node> selectChildAssocsWithoutNodeAssocsOfTypes(
    ...
    return template.selectList(
      SELECT_CHILD_ASSOCS_OF_PARENT_WITHOUT_NODE_ASSOCS_OF_TYPE,
      idsEntity
    );
  }
  ...
  protected Transaction selectLastTxnBeforeCommitTime(Long maxCommitTime) {
    ...
    List<Transaction> txns = template.selectList(
      SELECT_TXN_LAST,
      query,
      new RowBounds(0, 1)
    );
  ...
  @Override
  protected List<Long> selectTxnsUnused(
    Long minTxnId,
    Long maxCommitTime,
    Integer count
  ) {
  ...
  protected Long selectMinTxnCommitTimeForDeletedNodes() {
    ...
    return (Long) template.selectOne(
      SELECT_TXN_MIN_COMMIT_TIME_FOR_NODE_TYPE,
      txnQuery
    );
  }
  ...
  protected Long selectMinTxInNodeIdRange(Long fromNodeId, Long toNodeId) {
    ...
    return template.selectOne(
      SELECT_TXN_MIN_TX_ID_IN_NODE_IDRANGE,
      nodeRangeEntity
    );
  }
  ...
  protected Long selectMaxTxInNodeIdRange(Long fromNodeId, Long toNodeId) {
    ...
    return template.selectOne(
      SELECT_TXN_MAX_TX_ID_IN_NODE_IDRANGE,
      nodeRangeEntity
    );
  }
  ...
  public Long selectNextTxCommitTime(Long fromCommitTime) {
    ...
    return template.selectOne(
      SELECT_TXN_NEXT_TXN_COMMIT_TIME,
      fromCommitTimeEntity
    );
  }
  ...
  public static class MySQL extends NodeDAOImpl {
    ...
    private static final String DELETE_TXNS_UNUSED_MYSQL =
      "alfresco.node.delete_Txns_Unused_MySQL";
