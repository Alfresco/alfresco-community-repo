...
public class TransferServiceImplTest extends BaseAlfrescoSpringTest {
  ...
  public void before() throws Exception {
    ...
    this.taggingService =
      ((TaggingService) this.applicationContext.getBean("TaggingService"));
    this.categoryService =
      (CategoryService) this.applicationContext.getBean("CategoryService");
  ...
  public void testCreateTarget() throws Exception {
     ...
     */
    TransferTarget ret = transferService.createAndSaveTransferTarget(
      name,
      title,
      description,
      endpointProtocol,
    ...
    // endpoint
    assertEquals(
      "endpointProtocol not equal",
      ret.getEndpointProtocol(),
      endpointProtocol
    );
    ...
    for (int i = 0; i < password.length; i++) {
      if (password[i] != password2[i]) {
        fail(
          "password not equal:" + new String(password) + new String(password2)
        );
      }
    }
  ...
  public void testGetTransferTargets() throws Exception {
     ...
     * Now go ahead and create our first transfer target
     */
    TransferTarget targetA = transferService.createAndSaveTransferTarget(
      nameA,
      title,
      description,
      endpointProtocol,
    ...
    TransferTarget targetB = transferService.createAndSaveTransferTarget(
      nameB,
      title,
      description,
      endpointProtocol,
  ...
  public void testALF6565() throws Exception {
    ...
    assertEquals(
      targetA.getNodeRef(),
      transferService.getTransferTarget(nameA).getNodeRef()
    );
    assertEquals(
      targetB.getNodeRef(),
      transferService.getTransferTarget(nameB).getNodeRef()
    );
  }
  ...
  public void testUpdateTransferTarget() throws Exception {
    ...
    assertEquals(
      "endpointProtocol not equal",
      update1.getEndpointProtocol(),
      endpointProtocol
    );
    assertEquals(
      "endpointHost not equal",
      update1.getEndpointHost(),
      endpointHost
    );
    assertEquals(
      "endpointPort not equal",
      update1.getEndpointPort(),
      endpointPort
    );
    assertEquals(
      "endpointPath not equal",
      update1.getEndpointPath(),
      endpointPath
    );
    ...
    assertEquals(
      "endpointProtocol not equal",
      update2.getEndpointProtocol(),
      endpointProtocol2
    );
    assertEquals(
      "endpointHost not equal",
      update2.getEndpointHost(),
      endpointHost2
    );
    assertEquals(
      "endpointPort not equal",
      update2.getEndpointPort(),
      endpointPort2
    );
    assertEquals(
      "endpointPath not equal",
      update2.getEndpointPath(),
      endpointPath2
    );
  ...
  public void testTransferOneNode() throws Exception {
    ...
    RetryingTransactionCallback<Void> validateStep1CB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertFalse(
          ...
          testContext.destNodeRef.equals(testContext.transferMe.getNodeRef())
        );
        assertTrue(
        ...
        Date destModifiedDate = (Date) nodeService.getProperty(
          testContext.destNodeRef,
          ContentModel.PROP_MODIFIED
        );
        Date srcModifiedDate = (Date) nodeService.getProperty(
        ...
        Date destCreatedDate = (Date) nodeService.getProperty(
          testContext.destNodeRef,
          ContentModel.PROP_CREATED
        );
        Date srcCreatedDate = (Date) nodeService.getProperty(
          testContext.contentNodeRef,
          ContentModel.PROP_CREATED
        );
     ...
     */
    logger.debug(
      "Transfer again - to delete a node through transferring an archive node"
    );
    ...
    RetryingTransactionCallback<Void> transferDeletedCB = new RetryingTransactionCallback<Void>() {
      @Override
      public Void execute() throws Throwable {
        NodeRef deletedContentNodeRef = new NodeRef(
  ...
  public void testMoveNode() throws Exception {
    ...
    RetryingTransactionCallback<TestContext> setupCB = new RetryingTransactionCallback<TestContext>() {
      ...
      public TestContext execute() throws Throwable {
        ...
        ChildAssociationRef newParent = nodeService.createNode(
          guestHome,
          ContentModel.ASSOC_CONTAINS,
          QName.createQName(name),
        ...
        ChildAssociationRef moveTo = nodeService.createNode(
          ctx.parentNodeRef,
          ContentModel.ASSOC_CONTAINS,
    ...
    RetryingTransactionCallback<Void> validateTransferCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        // Now validate that the target node exists and has similar properties to the source
        NodeRef destNodeRef = testNodeFactory.getMappedNodeRef(
          testContext.contentNodeRef
        );
        NodeRef destParentNodeRef = testNodeFactory.getMappedNodeRef(
          testContext.parentNodeRef
        );

        ChildAssociationRef destParent = nodeService.getPrimaryParent(
          destNodeRef
        );
        assertEquals(
  ...
  public void testManyNodes() throws Exception {
    ...
    RetryingTransactionCallback<Void> checkTransferCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertTrue(
          "dest node ref A does not exist",
          nodeService.exists(destNodeA)
        );
        assertEquals(
          "title is wrong",
          (String) nodeService.getProperty(destNodeA, ContentModel.PROP_TITLE),
          "TestNodeA"
        );
        assertEquals(
          "type is wrong",
        ...
        assertTrue(
          "dest node AA ref does not exist",
          nodeService.exists(destNodeAA)
        );

        destNodeAB = testNodeFactory.getMappedNodeRef(testContext.nodeAB);
        assertTrue(
          "dest node AB ref does not exist",
          nodeService.exists(destNodeAB)
        );
  ...
  public void testPathBasedUpdate() throws Exception {
    ...
    RetryingTransactionCallback<Void> transfer1CB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertTrue(
          "dest node ref does not exist",
          nodeService.exists(destNodeRef)
        );
        assertEquals(
          "title is wrong",
          (String) nodeService.getProperty(
    ...
    RetryingTransactionCallback<Void> validateStep1CB = new RetryingTransactionCallback<Void>() {
      @Override
      public Void execute() throws Throwable {
        NodeRef oldDestNodeRef = testNodeFactory.getMappedNodeRef(
          testContext.contentNodeRef
        );
        NodeRef newDestNodeRef = testNodeFactory.getMappedNodeRef(
          testContext.newContentNodeRef
        );
        ...
        assertFalse(
          "new dest node ref exists",
          nodeService.exists(newDestNodeRef)
        );
        assertTrue(
  ...
  public void testAsyncCallback() throws Exception {
    ...
    assertTrue(
      ...
      transferReport
        .get(0)
        .getTransferState()
        .equals(TransferEvent.TransferState.START)
    );
  ...
  public void testAsyncCancel() throws Exception {
    ...
    final TestContext testContext = transactionService
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(transferAsyncCB);
    /**
     * Now validate the transferReport
     */
    ...
    if (runTest || logger.isDebugEnabled()) {
        ...
        public TestContext execute() throws Throwable {
          ...
          if (ctx.contentNodeRef == null) {
            ...
            for (int i = 0; i < 100000000; i++) {
              fw.write(
                "hello world this is my text, I wonder how much text I can transfer?" +
                i
              );
            }
      ...
      RetryingTransactionCallback<Void> finishCB = new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          ContentReader source = contentService.getReader(
            testContext.contentNodeRef,
            ContentModel.PROP_CONTENT
          );
          ContentReader destination = contentService.getReader(
            oldDestNodeRef,
            ContentModel.PROP_CONTENT
          );
  ...
  public void testEmptyContent() throws Exception {
     ...
     */
    logger.debug(
      "testEmptyContent : First transfer - create new node (empty content)"
    );
    ...
    RetryingTransactionCallback<Void> validateStep1CB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NodeRef destinationNodeRef = testNodeFactory.getMappedNodeRef(
          testContext.contentNodeRef
        );
  ...
  public void testRepeatUpdateOfContent() throws Exception {
     ...
     *  Fake Repository Id
     */
    final TransferTransmitter transmitter = new UnitTestInProcessTransmitterImpl(
      receiver,
      contentService,
      transactionService
    );
    ...
    for (int i = 0; i < 6; i++) {
      ...
      transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(updateContentCB);
      transactionService
        .getRetryingTransactionHelper()
  ...
  public void testReplaceNode() throws Exception {
    ...
    RetryingTransactionCallback<TestContext> setupCB = new RetryingTransactionCallback<TestContext>() {
      ...
      public TestContext execute() throws Throwable {
        ...
        ChildAssociationRef child2 = nodeService.createNode(
          testContext.parentNodeRef,
          ContentModel.ASSOC_CONTAINS,
        ...
        ChildAssociationRef child3 = nodeService.createNode(
          testContext.middleNodeRef,
          ContentModel.ASSOC_CONTAINS,
          testContext.childName,
          ContentModel.TYPE_CONTENT
  ...
  public void testPeerAssocs() throws Exception {
    ...
    RetryingTransactionCallback<List<AssociationRef>> readAssocsCB = new RetryingTransactionCallback<List<AssociationRef>>() {
      ...
      public List<AssociationRef> execute() throws Throwable {
        List<AssociationRef> source = nodeService.getSourceAssocs(
          testContext.sourceNodeRef,
          RegexQNamePattern.MATCH_ALL
        );
        List<AssociationRef> target = nodeService.getTargetAssocs(
          testContext.sourceNodeRef,
          RegexQNamePattern.MATCH_ALL
        );

        NodeRef destNode = testNodeFactory.getMappedNodeRef(
          testContext.sourceNodeRef
        );
        List<AssociationRef> destSource = nodeService.getSourceAssocs(
          destNode,
          RegexQNamePattern.MATCH_ALL
        );
        List<AssociationRef> destTarget = nodeService.getTargetAssocs(
          destNode,
          RegexQNamePattern.MATCH_ALL
        );

        assertEquals(
          "source peers different sizes",
          destSource.size(),
          source.size()
        );
        assertEquals(
          "target peers different sizes",
          destTarget.size(),
          target.size()
        );
        ...
        if (destSource.size() == 1) {
          assertEquals(
            destSource.get(0).getTypeQName(),
            source.get(0).getTypeQName()
          );
        }

        if (destTarget.size() == 1) {
          assertEquals(
            destTarget.get(0).getTypeQName(),
            target.get(0).getTypeQName()
          );
        }
  ...
  public void testCategoriesAndTags() throws Exception {
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(validateStep1CB);
    /**
     * Step 2:
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(validateStep2CB);
    ...
    final QName ASPECT_GENERAL_CLASSIFIABLE =
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(validateStep3CB);
    ...
    RetryingTransactionCallback<Void> step4WriteContentCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        ChildAssociationRef categoryRef = categoryService.getCategory(
          languageCategory,
          ASPECT_GENERAL_CLASSIFIABLE,
          "English"
        );
    ...
    RetryingTransactionCallback<Void> validateStep4CB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        Serializable categories = nodeService.getProperty(
          testContext.destNodeRef,
          ContentModel.PROP_CATEGORIES
        );
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(validateStep4CB);
