...
public abstract class AbstractPropertyValueDAOImpl implements PropertyValueDAO {
  ...
  private static final String CACHE_REGION_PROPERTY_DATE_VALUE =
    "PropertyDateValue";
  private static final String CACHE_REGION_PROPERTY_STRING_VALUE =
    "PropertyStringValue";
  private static final String CACHE_REGION_PROPERTY_DOUBLE_VALUE =
    "PropertyDoubleValue";
  private static final String CACHE_REGION_PROPERTY_SERIALIZABLE_VALUE =
    "PropertySerializableValue";
   ...
   */
  public void setPropertyUniqueContextCache(
    SimpleCache<CachePucKey, PropertyUniqueContextEntity> propertyUniqueContextCache
  ) {
  ...
  public AbstractPropertyValueDAOImpl() {
    ...
    this.propertySerializableValueCallback =
      new PropertySerializableValueCallbackDAO();
    this.propertyValueCallback = new PropertyValueCallbackDAO();
    this.propertyCallback = new PropertyCallbackDAO();

    this.propertyClassCache =
      new EntityLookupCache<Long, Class<?>, String>(propertyClassDaoCallback);
    this.propertyDateValueCache =
      new EntityLookupCache<Long, Date, Date>(propertyDateValueCallback);
    this.propertyStringValueCache =
      new EntityLookupCache<Long, String, Pair<String, Long>>(
        propertyStringValueCallback
      );
    this.propertyDoubleValueCache =
      new EntityLookupCache<Long, Double, Double>(propertyDoubleValueCallback);
    this.propertySerializableValueCache =
      new EntityLookupCache<Long, Serializable, Serializable>(
    ...
    this.propertyCache =
      new EntityLookupCache<Long, Serializable, Serializable>(propertyCallback);

    this.propertyUniqueContextCache =
      (SimpleCache<CachePucKey, PropertyUniqueContextEntity>) new NullCache();
  }
   ...
   */
  public void setPropertyClassCache(
    SimpleCache<Serializable, Object> propertyClassCache
  ) {
    this.propertyClassCache =
      new EntityLookupCache<Long, Class<?>, String>(
        propertyClassCache,
   ...
   */
  public void setPropertyDateValueCache(
    SimpleCache<Serializable, Object> propertyDateValueCache
  ) {
    this.propertyDateValueCache =
      new EntityLookupCache<Long, Date, Date>(
   ...
   */
  public void setPropertyStringValueCache(
    SimpleCache<Serializable, Object> propertyStringValueCache
  ) {
    this.propertyStringValueCache =
      new EntityLookupCache<Long, String, Pair<String, Long>>(
   ...
   */
  public void setPropertyDoubleValueCache(
    SimpleCache<Serializable, Object> propertyDoubleValueCache
  ) {
    this.propertyDoubleValueCache =
      new EntityLookupCache<Long, Double, Double>(
   ...
   */
  public void setPropertySerializableValueCache(
    SimpleCache<Serializable, Object> propertySerializableValueCache
  ) {
    this.propertySerializableValueCache =
      new EntityLookupCache<Long, Serializable, Serializable>(
   ...
   */
  public void setPropertyValueCache(
    SimpleCache<Serializable, Object> propertyValueCache
  ) {
    this.propertyValueCache =
      new EntityLookupCache<Long, Serializable, Serializable>(
        propertyValueCache,
   ...
   */
  public void setPropertyCache(
    SimpleCache<Serializable, Object> propertyCache
  ) {
    this.propertyCache =
      new EntityLookupCache<Long, Serializable, Serializable>(
        propertyCache,
  ...
  public Pair<Long, Class<?>> getPropertyClassById(Long id) {
    ...
    if (entityPair == null) {
      throw new DataIntegrityViolationException(
        "No property class exists for ID " + id
      );
    }
    return entityPair;
  }
  ...
  public Pair<Long, Class<?>> getOrCreatePropertyClass(Class<?> value) {
    ...
    Pair<Long, Class<?>> entityPair = propertyClassCache.getOrCreateByValue(
      value
    );
    return entityPair;
  }
  ...
  private class PropertyClassCallbackDAO
    extends EntityLookupCallbackDAOAdaptor<Long, Class<?>, String> {

    private final Pair<Long, Class<?>> convertEntityToPair(
      PropertyClassEntity entity
    ) {
      if (entity == null) {
        return null;
      } else {
  ...
  public Pair<Long, Date> getPropertyDateValueById(Long id) {
    ...
    if (entityPair == null) {
      throw new DataIntegrityViolationException(
        "No property date value exists for ID " + id
      );
    }
    return entityPair;
  }
  ...
  public Pair<Long, Date> getPropertyDateValue(Date value) {
    if (value == null) {
      throw new IllegalArgumentException(
        "Persisted date values cannot be null"
      );
    }
  ...
  public Pair<Long, Date> getOrCreatePropertyDateValue(Date value) {
    ...
    value = PropertyDateValueEntity.truncateDate(value);
    Pair<Long, Date> entityPair = propertyDateValueCache.getOrCreateByValue(
      value
    );
  ...
  private class PropertyDateValueCallbackDAO
    extends EntityLookupCallbackDAOAdaptor<Long, Date, Date> {

    private final Pair<Long, Date> convertEntityToPair(
      PropertyDateValueEntity entity
    ) {
      if (entity == null) {
        return null;
      } else {
  ...
  public Pair<String, Long> getPropertyStringCaseSensitiveSearchParameters(
    String value
  ) {
  ...
  public Pair<Long, String> getPropertyStringValueById(Long id) {
    ...
    if (entityPair == null) {
      throw new DataIntegrityViolationException(
        "No property string value exists for ID " + id
      );
    }
    return entityPair;
  }
  ...
  public Pair<Long, String> getPropertyStringValue(String value) {
    if (value == null) {
      throw new IllegalArgumentException(
        "Persisted string values cannot be null"
      );
    }
  ...
  public Pair<Long, String> getOrCreatePropertyStringValue(String value) {
    ...
    if (value.length() > maxStringLen) {
      throw new IllegalArgumentException(
        ...
        maxStringLen +
        " characters.  Increase the string column sizes and set property " +
        "'system.maximumStringLength' accordingly."
      );
    }
    Pair<Long, String> entityPair = propertyStringValueCache.getOrCreateByValue(
      value
    );
    return entityPair;
  }
  ...
  private class PropertyStringValueCallbackDAO
    extends EntityLookupCallbackDAOAdaptor<Long, String, Pair<String, Long>> {
  ...
  public Pair<Long, Double> getPropertyDoubleValueById(Long id) {
    ...
    if (entityPair == null) {
      throw new DataIntegrityViolationException(
        "No property double value exists for ID " + id
      );
    }
    return entityPair;
  }
  ...
  public Pair<Long, Double> getPropertyDoubleValue(Double value) {
    if (value == null) {
      throw new IllegalArgumentException(
        "Persisted double values cannot be null"
      );
    }
  ...
  public Pair<Long, Double> getOrCreatePropertyDoubleValue(Double value) {
    ...
    Pair<Long, Double> entityPair = propertyDoubleValueCache.getOrCreateByValue(
      value
    );
  ...
  private class PropertyDoubleValueCallbackDAO
    extends EntityLookupCallbackDAOAdaptor<Long, Double, Double> {

    private final Pair<Long, Double> convertEntityToPair(
      PropertyDoubleValueEntity entity
    ) {
      if (entity == null) {
        return null;
      } else {
  ...
  protected abstract PropertyDoubleValueEntity findDoubleValueByValue(
    Double value
  );
  ...
  public Pair<Long, Serializable> getPropertySerializableValueById(Long id) {
    ...
    Pair<Long, Serializable> entityPair = propertySerializableValueCache.getByKey(
      id
    );
    if (entityPair == null) {
      throw new DataIntegrityViolationException(
        "No property serializable value exists for ID " + id
      );
    }
    return entityPair;
  }

  public Pair<Long, Serializable> createPropertySerializableValue(
    Serializable value
  ) {
    if (value == null) {
      throw new IllegalArgumentException(
        "Persisted serializable values cannot be null"
      );
    }
    Pair<Long, Serializable> entityPair = propertySerializableValueCache.getOrCreateByValue(
      value
    );
  ...
  private class PropertySerializableValueCallbackDAO
    extends EntityLookupCallbackDAOAdaptor<Long, Serializable, Serializable> {

    private final Pair<Long, Serializable> convertEntityToPair(
      PropertySerializableValueEntity entity
    ) {
      if (entity == null) {
        return null;
      } else {
  ...
  protected abstract PropertySerializableValueEntity findSerializableValueById(
    Long id
  );

  protected abstract PropertySerializableValueEntity createSerializableValue(
    Serializable value
  );
  ...
  public Pair<Long, Serializable> getPropertyValueById(Long id) {
    ...
    if (entityPair == null) {
      throw new DataIntegrityViolationException(
        "No property value exists for ID " + id
      );
    }
    return entityPair;
  }
  ...
  public Pair<Long, Serializable> getOrCreatePropertyValue(Serializable value) {
    Pair<Long, Serializable> entityPair = propertyValueCache.getOrCreateByValue(
      value
    );
    return (Pair<Long, Serializable>) entityPair;
  }
  ...
  private class PropertyValueCallbackDAO
    ...
    private final Serializable convertToValue(PropertyValueEntity entity) {
      ...
      final Class<Serializable> actualType = (Class<Serializable>) getPropertyClassById(
        actualTypeId
      )
        .getSecond();
    ...
    public Serializable getValueKey(Serializable value) {
      PersistedType persistedType = PropertyValueEntity.getPersistedTypeEnum(
        value,
        converter
      );
  ...
  protected abstract PropertyValueEntity findPropertyValueByValue(
    Serializable value
  );

  protected abstract PropertyValueEntity createPropertyValue(
    Serializable value
  );
  ...
  public void getPropertiesByIds(
    List<Long> ids,
    PropertyFinderCallback callback
  ) {
  ...
  public Long createProperty(Serializable value) {
    Pair<Long, Serializable> entityPair = propertyCache.getOrCreateByValue(
      value
    );
  ...
  private class PropertyCallbackDAO
    ...
    public int updateValue(Long key, Serializable value) {
      ...
      if (entity == null) {
        throw new DataIntegrityViolationException(
          "No property root exists for ID " + key
        );
      }
  ...
  protected Serializable constructEmptyContainer(Class<?> clazz) {
    ...
    if (Map.class.isAssignableFrom(clazz)) {
      ...
      logger.warn(
        "Unable to find suitable container type with default constructor: " +
        clazz
      );
      return null;
    }
  ...
  protected abstract void findPropertiesByIds(
    List<Long> ids,
    PropertyFinderCallback callback
  );
  ...
  protected abstract PropertyRootEntity updatePropertyRoot(
    PropertyRootEntity entity
  );
  ...
  public static class CachePucKey implements Serializable {
    ...
    public boolean equals(Object obj) {
      ...
      return (
        EqualsHelper.nullSafeEquals(this.key1, that.key1) &&
  ...
  public Pair<Long, Long> createPropertyUniqueContext(
    ...
    try {
      PropertyUniqueContextEntity entity = createPropertyUniqueContext(
        id1,
        id2,
        id3,
        property1Id
  ...
  public Pair<Long, Long> getPropertyUniqueContext(
    ...
    return entity == null
      ? null
      : new Pair<Long, Long>(entity.getId(), entity.getPropertyId());
  }

  public void getPropertyUniqueContext(
    PropertyUniqueContextCallback callback,
    Serializable... values
  ) {
    if (values.length < 1 || values.length > 3) {
      throw new IllegalArgumentException(
        "Get of unique property sets must have 1, 2 or 3 values"
      );
    }
   ...
   *
   */
  public void updatePropertyUniqueContextKeys(
    Long id,
    Serializable value1,
    Serializable value2,
    Serializable value3
    ...
    try {
      ...
      if (entity == null) {
        ...
        throw new DataIntegrityViolationException(
          "No unique property context exists for id: " + id
        );
      }
   ...
   */
  public void updatePropertyUniqueContext(
    Serializable value1,
    Serializable value2,
    Serializable value3,
    ...
    try {
      Pair<Long, Long> entityPair = getPropertyUniqueContext(
        value1,
        value2,
        value3
      );
      if (entityPair == null) {
        throw new DataIntegrityViolationException(
          "No unique property context exists for values: " +
          value1 +
          "-" +
          value2 +
          "-" +
  ...
  public int deletePropertyUniqueContext(Serializable... values) {
    if (values.length < 1 || values.length > 3) {
      throw new IllegalArgumentException(
        "Deletion of unique property sets must have 1, 2 or 3 values"
      );
    }
    Long[] valueIds = new Long[values.length];
    for (int i = 0; i < values.length; i++) {
    ...
    CachePucKey pucKey = getPucKey(
      valueIds[0],
      (values.length > 1 ? valueIds[1] : null),
      (values.length > 2 ? valueIds[2] : null)
    );
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
        "Deleted " +
        deleted +
        " unique property contexts: \n" +
        "   Values: " +
        Arrays.toString(values) +
        "\n" +
        "   IDs:    " +
        Arrays.toString(valueIds)
      );
    }
    return deleted;
  }

  protected abstract PropertyUniqueContextEntity createPropertyUniqueContext(
    Long valueId1,
    Long valueId2,
    Long valueId3,
    Long propertyId
  ...
  protected abstract PropertyUniqueContextEntity getPropertyUniqueContextById(
    Long id
  );

  protected abstract PropertyUniqueContextEntity getPropertyUniqueContextByValues(
    Long valueId1,
    Long valueId2,
    Long valueId3
  );

  protected abstract void getPropertyUniqueContextByValues(
    PropertyUniqueContextCallback callback,
    Long... valueIds
  );

  protected abstract PropertyUniqueContextEntity updatePropertyUniqueContext(
  ...
  @SuppressWarnings("unchecked")
  public Serializable convertPropertyIdSearchRows(
    List<PropertyIdSearchRow> rows
  ) {
     ...
     */
    Map<Long, Serializable> valuesByPropIndex = new HashMap<Long, Serializable>(
      7
    );
    ...
    for (Map.Entry<Long, PropertyLinkEntity> entry : linkEntitiesByPropIndex.entrySet()) {
      ...
      if (propIndex.equals(containedIn)) {
        ...
        if (container == null) {
          logger.error(
            "Found container ID that doesn't have a value: " + linkEntity
          );
          ...
          logger.error(
            "Found container ID that is not a map or collection: " + linkEntity
          );
        }
      }
    }
