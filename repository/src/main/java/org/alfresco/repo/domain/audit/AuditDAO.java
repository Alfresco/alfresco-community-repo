 ...
 *
 * <p>The older methods are supported by a different implementation and will eventually be
...
public interface AuditDAO {
     ...
     * @return Returns the ID of the config matching the input stream and the content storage
     *     details
     * @since 3.2
     */
    ...
    /**
     * Update the audit application to refer to a new model. If the model did not change, then
    ...
    /**
     * Update the audit application to hold a new set of disabled paths. If the value did not
     * change, then nothing will be done.
     *
     * @param id the ID of the audit application
    ...
    /**
     * Delete a discrete list of audit entries. Duplicate entries are collapsed and the number of
     * entries deleted will match the count of unique IDs in the list; otherwise a concurrency
     * condition has occured and an exception will be generated.
     *
