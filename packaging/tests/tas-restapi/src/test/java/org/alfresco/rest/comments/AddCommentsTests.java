...
public class AddCommentsTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user adds multiple comments with Rest API and status code is 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user gets status code 401 on post multiple comments"
                            + " call")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            description =
                    "Verify Manager user adds multiple comments with Rest API and status code is"
                            + " 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user adds multiple comments with Rest API and status code"
                            + " is 201")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator user adds multiple comments with Rest API and status code"
                            + " is 201")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user adds multiple comments with Rest API and status code is"
                            + " 201")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify User can not add comments to a not joined private site. Status code"
                            + " returned is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify User can't add comments to a node with ID that does not exist and"
                            + " status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify User can't add comments to a node that exists but is not a document or"
                            + " a folder and status code is 405")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    @Bug(id = "MNT-16904")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify User can add comments with the same content as one existing comment")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify add comments from node with invalid network id returns status code 401")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify add comments from node with empty network id returns status code 401")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    */
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Using Manager user verify that you can provide a large string for one comment")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Using Manager user verify that you can provide a short string for one comment")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Using Collaborator user verify that you can provide a string with special"
                            + " characters for one comment")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Using Manager user verify that you can not provide an empty string for one"
                            + " comment")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Using Collaborator user verify that you can provide several comments in one"
                            + " request")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Provide invalid request body parameter and check default error model schema")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void invalidRequestBodyParameterCheckErrorModelSchema() throws Exception {
        ...
        restClient
                .assertLastError()
                .containsErrorKey(String.format(RestErrorModel.UNRECOGNIZED_FIELD, "content2"));
        restClient
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNRECOGNIZED_FIELD, "content2"));
