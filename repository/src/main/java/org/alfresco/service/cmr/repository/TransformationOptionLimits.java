...
public class TransformationOptionLimits implements Serializable {
  ...
  public static final String PAGES_MESSAGE =
    "Both maxPages and pageLimit should not be set.";
  ...
  private TransformationOptionLimits(
    TransformationOptionLimits a,
    TransformationOptionLimits b,
    boolean lower
  ) {
    if (lower) {
  ...
  public static Map<String, Object> removeFromMap(
   ...
   */
  public TransformationOptionLimits combine(
    final TransformationOptionLimits that
  ) {
   ...
   */
  public TransformationOptionLimits combineUpper(
    final TransformationOptionLimits that
  ) {
