...
/**
 * It returns an {@link InputStream} for the vanilla-virtual folder template resource indicated by
 * the given vanilla protocol reference.
 *
 * @author Bogdan Horje
 */
public class GetVanillaScriptInputStreamMethod extends AbstractProtocolMethod<InputStream> {
    ...
    @Override
    public InputStream execute(VanillaProtocol vanillaProtocol, Reference reference)
