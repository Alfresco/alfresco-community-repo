...
public class DataLoadSystemTest {
    ...
    AuthenticationUtil.runAs(
      new RunAsWork<Void>() {
        public Void doWork() throws Exception {
          ...
          final NodeRef filePlan = filePlanService.getFilePlanBySiteId(
            ...
            new RunAsWork<Void>() {
              public Void doWork() throws Exception {
                ...
                NodeRef document = fileFolderService
                  .create(docLib, GUID.generate(), ContentModel.TYPE_CONTENT)
                  .getNodeRef();
  ...
  private void repeatInTransactionBatches(
