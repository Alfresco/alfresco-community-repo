...
public class AddProcessItemCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process item is falling in case of invalid process id is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void failedAddingProcessItemIfInvalidProcessIdIsProvided() throws Exception {
        RestProcessModelsCollection processes =
                restClient
                        ...
                        .getProcesses();
        processModel =
                processes.assertThat().entriesListIsNotEmpty().when().getOneRandomEntry().onModel();
        FileModel testDocument =
                dataContent
                        .usingAdmin()
                        .usingSite(siteModel)
                        .createContent(DocumentType.TEXT_PLAIN);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple process items is falling in case of invalid process id is"
                            + " provided")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple process items is falling in case of empty body item value is"
                            + " provided")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process item is falling in case of incomplete body (empty) is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void failedAddingProcessItemIfIncompleteBodyIsProvided() throws Exception {
        ...
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST, "{}", "processes/{processId}/items", processModel.getId());
