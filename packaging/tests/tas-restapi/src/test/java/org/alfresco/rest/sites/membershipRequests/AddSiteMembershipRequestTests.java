...
public class AddSiteMembershipRequestTests extends RestTest {
  ...
  public void contributorCreatesNewSiteMembershipRequestForSelf()
    throws Exception {
    siteMembershipRequest =
      restClient
        .authenticateUser(
  ...
  public void collaboratorCreatesNewSiteMembershipRequestForSelf()
    throws Exception {
    siteMembershipRequest =
      restClient
        .authenticateUser(
  ...
  public void consumerCreatesNewSiteMembershipRequestForSelf()
    throws Exception {
    siteMembershipRequest =
      restClient
        .authenticateUser(
  ...
  public void addSiteMembershipRequestStatusCodeIs404ReceivedForAUserThatDoesNotExist()
    ...
    restClient
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "invalidUser")
      );
  }
  ...
  public void addSiteMembershipRequestStatusCodeIs400ForEmptyRequestBody()
    throws Exception {
    UserModel newMember = dataUser.createRandomTestUser();
    restClient
      .authenticateUser(newMember)
  ...
  public void addSiteMembershipRequestStatusCodeIs201ForRequestWithEmptyTitle()
    throws Exception {
    UserModel newMember = dataUser.createRandomTestUser();
    siteMembershipRequest =
      restClient
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site manager is not able to create new site membership request for other user"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site collaborator is not able to create new site membership request for other user"
  )
  public void collaboratorIsNotAbleToCreateSiteMembershipRequestForOtherUser()
    throws Exception {
    restClient
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site contributor is not able to create new site membership request for other user"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site consumer is not able to create new site membership request for other user"
  )
  public void consumerIsNotAbleToCreateSiteMembershipRequestForOtherUser()
    throws Exception {
    restClient
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteConsumer)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify admin user is not able to create new site membership request for other user"
  )
  public void adminIsNotAbleToCreateSiteMembershipRequestForOtherUser()
    throws Exception {
    restClient
      .authenticateUser(adminUser)
      .withCoreAPI()
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify addSiteMembershipRequest Rest API status code is 400 for an invalid user id"
  )
  public void addSiteMembershipRequestReturns400ForEmptyUserId()
    throws Exception {
    restClient
      .authenticateUser(adminUser)
      .withCoreAPI()
  ...
  public void userIsAbleToRequestMembershipOfPublicSite() throws Exception {
    ...
    siteMembershipRequest
      ...
      .field("site")
      .isNotEmpty();
    RestSiteEntry siteEntry = restClient
      .withCoreAPI()
      .usingAuthUser()
      .getSiteMembership(publicSite);
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify regular user is not able to create new site membership request for other user"
  )
  ...
  public void siteCreatorRequestsMembershipOfHisModeratedSite()
    throws Exception {
    restClient
      .authenticateUser(adminUser)
      .withCoreAPI()
  ...
  public void adminIsAbleToRequestMembershipOfModeratedSite() throws Exception {
    ...
    siteMembershipRequests
      .assertThat()
      .entriesListContains("id", anotherModeratedSite.getId());
  }
  ...
  public void siteMembershipRequestIsRejectedWhenSiteIsSwitchedFromModeratedToPrivate()
    throws Exception {
    regularUser = dataUser.createRandomTestUser();
    SiteModel moderatedThenPrivateSite = dataSite
      .usingUser(adminUser)
      .createModeratedRandomSite();
    siteMembershipRequest =
      restClient
    ...
    dataSite
      ...
      .updateSiteVisibility(
        moderatedThenPrivateSite,
        SiteService.Visibility.PRIVATE
      );
