...
public class PatchTest extends TestCase {
    ...
    public void testApplyOutstandingPatch() throws Exception {
        ...
        // check that the patch application was recorded
        assertTrue(
                "Patch info didn't indicate success: " + appliedPatch, appliedPatch.getSucceeded());
    }
    ...
    public void testGetPatchesByDate() throws Exception {
        ...
        List<AppliedPatch> appliedPatchesFutureDates =
                patchService.getPatches(new Date(), new Date());
        assertEquals(
