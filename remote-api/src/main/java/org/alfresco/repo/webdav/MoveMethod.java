...
public class MoveMethod extends HierarchicalMethod {
  ...
  protected final void executeImpl() throws WebDAVServerException, Exception {
    ...
    FileInfo sourceParentInfo = getDAVHelper()
      .getParentNodeForPath(rootNodeRef, sourcePath);
    ...
    try {
      ...
      destParentInfo =
        getDAVHelper().getParentNodeForPath(rootNodeRef, destPath);
    } catch (FileNotFoundException e) {
      if (logger.isDebugEnabled()) {
  ...
  protected void moveOrCopy(
    ...
    try {
      ...
      sourceFileInfo =
        fileFolderService.resolveNamePath(rootNodeRef, sourcePathElements);
      destFileInfo =
        fileFolderService.resolveNamePath(rootNodeRef, destPathElements);
    } catch (FileNotFoundException e) {
