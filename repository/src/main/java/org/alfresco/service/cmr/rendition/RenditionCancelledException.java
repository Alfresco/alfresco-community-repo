...
public class RenditionCancelledException extends RenditionServiceException {
    ...
    /**
     * Constructs a Rendition Cancelled Exception with the specified message and {@link
     * RenditionDefinition}.
     *
     * @param message the message string.
    ...
    /**
     * Constructs a Rendition Cancelled Exception with the specified message, {@link
     * RenditionDefinition} and source exception .
     *
     * @param message the message string.
     * @param renditionDefinition the rendition definition.
     * @param source the source exception.
     * @since 3.5.0
     */
    public RenditionCancelledException(
            String message, RenditionDefinition renditionDefinition, Throwable source) {
        super(message, source);
    }
}
