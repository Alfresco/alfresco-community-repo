...
public class VirtualStoreImpl
  ...
  private static final String VIRTUAL_FOLDER_DEFINITION =
    "virtualfolder.definition";
  ...
  public boolean isVirtual(NodeRef nodeRef) throws VirtualizationException {
    ...
    if (reference != null) {
      ...
      return (
        Protocols.VIRTUAL.protocol.equals(protocol) ||
        Protocols.VANILLA.protocol.equals(protocol)
      );
    } else {
      return false;
    }
  ...
  public boolean canVirtualize(NodeRef nodeRef) throws VirtualizationException {
    ...
    if (runAsUser == null) {
      if (logger.isTraceEnabled()) {
        RuntimeException stackTracingException = new RuntimeException(
          "Stack trace."
        );
        logger.trace(
          "Virtualization check call in unauthenticated-context - stack trace follows:",
  ...
  @Override
  public boolean canMaterialize(Reference reference)
  ...
  public Reference virtualize(NodeRef nodeRef) throws VirtualizationException {
    ...
    if (isVirtual(nodeRef)) {
      ...
      for (VirtualizationMethod vMethod : virtualizationMethods) {
        if (vMethod.canVirtualize(environment, theNodeRef)) {
          reference = vMethod.virtualize(environment, theNodeRef);
        }
      }
      ...
      if (reference == null) {
        ...
        if (reference == null) {
          throw new VirtualizationException(
            "No virtualization method for " + nodeRef
          );
        }
      }
    }
  ...
  @Override
  public NodeRef materialize(Reference reference)
    throws VirtualizationException {
    return reference.execute(new GetActualNodeRefMethod(environment));
  }

  @Override
  public Collection<NodeRef> materializeIfPossible(
  ...
  @Override
  public NodeRef materializeIfPossible(NodeRef nodeRef)
    throws VirtualizationException {
  ...
  public List<ChildAssociationRef> getChildAssocs(
    ...
    List<ChildAssociationRef> allAssociations = getChildAssocs(
      parentReference,
  ...
  public List<ChildAssociationRef> getChildAssocsByPropertyValue(
    ...
    for (ChildAssociationRef childAssociationRef : allAssociations) {
      Serializable propertyValue = environment.getProperty(
  ...
  @Override
  public Reference getChildByName(
    Reference reference,
    QName assocTypeQName,
    String childName
  ) throws VirtualizationException {
    VirtualFolderDefinition structure = resolveVirtualFolderDefinition(
      reference
    );
    ...
    if (theChild != null) {
      ...
      if (query != null) {
        PropertyValueConstraint constraint = new PropertyValueConstraint(
          new FilesFoldersConstraint(BasicConstraint.INSTANCE, true, true),
          ContentModel.PROP_NAME,
          childName,
          environment.getNamespacePrefixResolver()
        );
        PagingResults<Reference> result = query.perform(
          environment,
          constraint,
          null,
          reference
  ...
  private List<Reference> createChildReferences(
    Reference parent,
    VirtualFolderDefinition structure
    ...
    for (VirtualFolderDefinition child : structureChildren) {
      childReferences.add(
        parent.execute(new GetChildByIdMethod(child.getId()))
      );
    }
  ...
  public VirtualFolderDefinition resolveVirtualFolderDefinition(
    final Reference reference
  ) throws VirtualizationException {
    ServiceRegistry serviceRegistry =
      ((AlfrescoEnviroment) environment).getServiceRegistry();
    ...
    return transactionHelper.doInTransaction(
      new RetryingTransactionCallback<VirtualFolderDefinition>() {
        @Override
        public VirtualFolderDefinition execute() throws Throwable {
          NodeRef key = reference.toNodeRef();

          Map<NodeRef, VirtualFolderDefinition> definitionsCache = TransactionalResourceHelper.getMap(
            VIRTUAL_FOLDER_DEFINITION
          );

          VirtualFolderDefinition virtualFolderDefinition = definitionsCache.get(
            key
          );

          if (virtualFolderDefinition == null) {
            virtualFolderDefinition =
              reference.execute(new ApplyTemplateMethod(environment));
  ...
  @Override
  public PagingResults<Reference> list(
    final Reference ref,
    boolean actual,
    boolean virtual,
    final boolean files,
    ...
    if (actual) {
      ...
      if (query != null) {
        ...
        PagingResultsSource<Reference> querySourc = new PagingResultsSource<Reference>() {
          @Override
          public PagingResults<Reference> retrieve(PagingRequest pr)
        ...
        try {
          return collator.collate(
            ...
            querySourc,
            pagingRequest,
            new ReferenceComparator(this, sortProps)
          );
  ...
  @Override
  public List<Reference> list(Reference reference)
    throws VirtualizationException {
    VirtualFolderDefinition structure = resolveVirtualFolderDefinition(
      reference
    );
    ...
    final VirtualQuery query = structure.getQuery();
    if (query != null) {
      PagingResults<Reference> queryNodes = query.perform(
        environment,
        new FilesFoldersConstraint(BasicConstraint.INSTANCE, true, true),
        null,
        reference
  ...
  public List<Reference> search(
    ...
    List<Reference> childReferences = createChildReferences(
      reference,
      structure
    );
    if (folderSearch) {
    ...
    if (includeSubFolders) {
      for (Reference childRef : childReferences) {
        List<Reference> childResults = search(
          childRef,
          namePattern,
          fileSearch,
          folderSearch,
    ...
    if (fileSearch) {
      ...
      if (query != null) {
        ...
        if (namePattern == null) {
          ...
          vqConstraint =
            new NamePatternPropertyValueConstraint(
              new FilesFoldersConstraint(BasicConstraint.INSTANCE, true, true),
              ContentModel.PROP_NAME,
              namePattern,
              environment.getNamespacePrefixResolver()
  ...
  @Override
  public Map<QName, Serializable> getProperties(Reference reference)
    throws VirtualizationException {
    ...
    if (
      ...
      VirtualFolderDefinition folderDefinition = resolveVirtualFolderDefinition(
        reference
      );
  ...
  @Override
  public FilingData createFilingData(
    Reference parentReference,
    QName assocTypeQName,
    QName assocQName,
    QName nodeTypeQName,
  ...
  @Override
  public AccessStatus hasPermission(Reference reference, String perm)
    throws VirtualizationException {
    return reference.execute(
      new HasPermissionMethod(this, userPermissions, perm)
    );
  }
  ...
  public AccessStatus hasPermission(
    ...
    return hasPermission(reference, perm.getName());
  }
  ...
  @Override
  public NodePermissionEntry getSetPermissions(Reference reference)
    throws VirtualizationException {
    return reference.execute(
      new GetSetPermissionsMethod(
        this,
        userPermissions,
  ...
  public Set<AccessPermission> getAllSetPermissions(Reference reference) {
    return reference.execute(
      new GetAllSetPermissionsMethod(
        this,
        userPermissions,
        PermissionService.ALL_AUTHORITIES
      )
  ...
  public Path getPath(Reference reference) throws VirtualizationException {
    ...
    Reference virtualPathParent = reference.execute(
    ...
    while (virtualPathElement != null && virtualPathParent != null) {
      ...
      String templatePath = virtualPathElement
        .execute(new GetTemplatePathMethod())
        .trim();
      ...
      if (child == null) {
        throw new VirtualizationException(
          "Invalid reference: " + reference.encode()
        );
      }
      ...
      virtualPathParent =
        virtualPathParent.execute(new GetParentReferenceMethod());
    }
  ...
  @Override
  public NodeRef adhere(Reference reference, int mode)
    throws VirtualizationException {
    switch (mode) {
      ...
      case FILING_OR_MATERIAL_ADHERENCE:
        {
          VirtualFolderDefinition vfDefinition = resolveVirtualFolderDefinition(
            reference
          );
