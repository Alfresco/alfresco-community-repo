...
/**
 * A {@link SpringBeanExtension}s collection that get registered on the {@link Extender}'s registry
 * on {@link #afterPropertiesSet()}.<br>
 * Works in conjunction with {@link SpringBeanExtension}s and {@link SpringExtensionPoint}s to
 * define and start spring based {@link ExtensionBundle}s of {@link SingletonExtension}s.<br>
...
public class SpringExtensionBundle implements InitializingBean {
    ...
    /**
     * @param enabled <code>true</code> if the current bundle should be registered.<br>
    ...
    /**
     * Creates a {@link RegistryExtensionBundle} and registers all contained {@link
     * SpringBeanExtension}s with it.<br>
     * When all extension have successfully registered it starts the {@link
     * RegistryExtensionBundle}.<br>
     * The previously created {@link RegistryExtensionBundle} is stored for later start or {@link
     * #stop()} operations.
     *
