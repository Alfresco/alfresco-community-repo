...
public interface TransferTransmitter
{
    ...
    /**
     * @param manifest
     *            the transfer manifest file
     * @param transfer
     *            the transfer object returned by an earlier call to begin
     * @param results
     *            - where to write the results, probably a temporary file the output steam should be open and will be closed before the method returns.
     * @throws TransferException
     */
