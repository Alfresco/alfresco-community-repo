...
public abstract class AbstractConstraint implements Constraint {
    ...
    public static final String ERR_EVALUATE_EXCEPTION =
            "d_dictionary.constraint.err.evaluate_exception";
    ...
    /**
     * Sets the constraint name. Automatically called after construction. Please excuse the strange
     * method name as we want the property name to begin with an underscore to avoid property name
     * clashes.
     *
    ...
    /**
     * Optionally specify the registry that will be used to register the constraint. This is used
     * when instantiating constraints outside the dictionary.
     *
     ...
     * {@inheritDoc}
     *
     * <p>Registers the constraint with the registry, if present. Call this method if you want the
     * constraint to be auto-registered.
     */
    ...
    protected void checkPropertyNotNull(String name, Object value) {
        if (value == null) {
            throw new DictionaryException(
                    AbstractConstraint.ERR_PROP_NOT_SET, name, getShortName());
        }
    }
        ...
        try {
            ...
            if (DefaultTypeConverter.INSTANCE.isMultiValued(value)) {
                Collection collection =
                        DefaultTypeConverter.INSTANCE.getCollection(Object.class, value);
            ...
            throw new DictionaryException(
                    AbstractConstraint.ERR_EVALUATE_EXCEPTION, this, e.getMessage());
        }
    }
    ...
    /**
     * Support for evaluation of properties. The value passed in will never be a <tt>Collection</tt>
     * and will never be <tt>null</tt>.
     *
