 ...
 *
 * <p>That is, only maps types to one of root Document, Folder, Relationship and Policy.
 *
 * <p>And Item which is pretty much anything that is not a Document, Folder, Relationship or Policy.
 *
 * @author steveglover
 * @author davidc
 * @author mrogers
...
public class CMISStrictDictionaryService extends CMISAbstractDictionaryService {
                ...
                new DictionaryInitializer() {
                    ...
                    public Collection<AbstractTypeDefinitionWrapper> createDefinitions(
                        ...
                        ClassDefinition classDef =
                                dictionaryService.getClass(CMISMapping.RELATIONSHIP_QNAME);
                        ...
                        if (classDef == null) {
                            ...
                            RelationshipTypeDefintionWrapper objectTypeDef =
                        ...
                        ret.addAll(
                                createTypeDefs(
                                        cmisRegistry, dictionaryService.getAllAspects(true)));
                        return ret;
                    }

                    @Override
                    public Collection<AbstractTypeDefinitionWrapper> createDefinitions(
                            CMISDictionaryRegistry cmisRegistry, CompiledModel model) {
                        Collection<AbstractTypeDefinitionWrapper> ret = new LinkedList<>();
                        ...
                        for (AssociationDefinition assocDef : model.getAssociations()) {
                            ...
                            RelationshipTypeDefintionWrapper assocTypeDef =
                                    createAssocDef(classQName);
        ...
        this.tenantDictionaryInitializer =
                new DictionaryInitializer() {
                    ...
                    public Collection<AbstractTypeDefinitionWrapper> createDefinitions(
                        ...
                        ret.addAll(
                                createAssocDefs(
                                        cmisRegistry, dictionaryService.getAllAssociations(false)));
                        ret.addAll(
                                createTypeDefs(
                                        cmisRegistry, dictionaryService.getAllAspects(false)));
                        return ret;
                    }
            ...
            if (cmisMapping.isValidCmisDocument(classQName)) {
                ...
                objectTypeDef =
                        new FolderTypeDefintionWrapper(
                                ...
                                dictionaryService,
                                classDef);
            } else if (cmisMapping.getCmisVersion().equals(CmisVersion.CMIS_1_1)
    ...
    private Collection<AbstractTypeDefinitionWrapper> createTypeDefs(
            CMISDictionaryRegistry registry, Collection<QName> classQNames) {
        Collection<AbstractTypeDefinitionWrapper> ret = new LinkedList<>();
