...
public class TenantRoutingDataSource extends AbstractRoutingDataSource {
    ...
    protected Object determineCurrentLookupKey() {
        // return tenantService.getCurrentUserDomain(); // note: this is re-entrant if it checks
    ...
    public synchronized void addTenantDataSource(String tenantDomain, String dbUrl)
            throws SQLException {
