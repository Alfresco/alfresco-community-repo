  ...
  protected void executeImpl(
    ...
    if (
      ...
      if (isAcceptTransition == true) {
        destinationFolder =
          (NodeRef) props.get(ApplicationModel.PROP_APPROVE_FOLDER);
        isMove = (Boolean) props.get(ApplicationModel.PROP_APPROVE_MOVE);
      } else {
        destinationFolder =
          (NodeRef) props.get(ApplicationModel.PROP_REJECT_FOLDER);
      ...
      if (destinationFolder == null) {
        ...
        throw new AlfrescoRuntimeException(
          "No folder was specified for the simple workflow step."
        );
      }
      ...
      if (Boolean.TRUE.equals(isMove) == true) {
        ...
        ChildAssociationRef originalAssoc = nodeService.getPrimaryParent(
          actionedUponNodeRef
        );
