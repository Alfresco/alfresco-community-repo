...
/**
 * The Shutdown backstop is a spring bean that will ensure that shutdown completes within a given
 * time.
 *
 * <p>If alfresco is blocked - for example waiting for a remote resource or a long running
 * actionbackstop will wait for a timeout and then call System.exit()
 *
 * @author mrogers
 */
public class ShutdownBackstop extends AbstractLifecycleBean {
    /** How long to go before shutdown (in ms) Default 10 Seconds. */
    ...
    /**
     * This is a dangerous class! It will kill the JVM after sleeping for timeout ms.
     *
     * <p>It also dumps information to the system console prior to termination.
     */
    private class ShutdownBackstopThread extends Thread {
         ...
         * @throws IOException
         */
        private void printGroupInfo(ThreadGroup g, String indent, BufferedWriter w)
                throws IOException {
            if (g == null) {
                return;
            }
