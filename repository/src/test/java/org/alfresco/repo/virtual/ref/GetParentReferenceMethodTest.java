...
public class GetParentReferenceMethodTest extends TestCase {
  ...
  public void testSpacePath() throws Exception {
    ...
    assertEquals("/Media types", toParentPath(path));
  }
  ...
  public void testFirsLevelPath() throws Exception {
    ...
    assertEquals("/", toParentPath(path));
  }
  ...
  private String toParentPath(final String path)
    ...
    if (parent == null) {
      ...
      StringParameter parentPath = (StringParameter) parent
        .getParameters()
        .get(0);
