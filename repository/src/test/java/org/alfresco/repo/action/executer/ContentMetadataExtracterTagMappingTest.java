 ...
 */
@Category(
  { OwnJVMTestsCategory.class, LuceneTests.class, RedundantTests.class }
)
public class ContentMetadataExtracterTagMappingTest extends TestCase {
  ...
  protected void setUp() throws Exception {
        ...
        .doInTransaction(
          new RetryingTransactionCallback<Void>() {
            ...
            public Void execute() throws Throwable {
              ...
              MetadataExtracterRegistry registry = (MetadataExtracterRegistry) ctx.getBean(
    ...
    UpdateTagScopesActionExecuter updateTagsAction = (UpdateTagScopesActionExecuter) ctx.getBean(
      "update-tagscope"
    );
  ...
  protected void tearDown() throws Exception {
    if (
      ...
      fail(
        "Test is not transaction-safe.  Fix up transaction handling and re-test."
      );
    }
  }

  private NodeRef[] createTestFolderAndDocument(String filename)
    throws Exception {
        ...
        new RetryingTransactionCallback<NodeRef[]>() {
          ...
          public NodeRef[] execute() throws Throwable {
            ...
            try {
              ...
              cw.putContent(
                AbstractContentTransformerTest.loadNamedQuickTestFile(filename)
              );
            } catch (Exception e) {
              fail(e.getMessage());
            }
  ...
  private static class TagMappingMetadataExtracter
    ...
    public Map<String, Serializable> extractRaw(ContentReader reader)
      ...
      if (extractedKeywords != null && extractedKeywords instanceof String) {
        ...
        extractedKeywords != null && extractedKeywords instanceof Collection<?>
      ) {
    ...
    this.transactionService.getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          @Override
          public Void execute() throws Throwable {
            NodeRef existingTagNodeRef = taggingService.createTag(
              storeRef,
              TAG_1
            );
            ...
            assertTrue(
              "doc tags '" + tags + "' should contain '" + QUICK_KEYWORD + "'",
  ...
  public void testTagMappingSeparators() throws Exception {
    ...
    extractAndCheckTags(
      nodes[0],
      Arrays.asList("fox", "dog", "lazy", "jumping")
    );
    removeTestFolderAndDocument(nodes);
  ...
  private void extractAndCheckTags(
    NodeRef document,
