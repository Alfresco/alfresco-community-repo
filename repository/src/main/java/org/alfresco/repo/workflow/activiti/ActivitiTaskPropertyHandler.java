...
public abstract class ActivitiTaskPropertyHandler extends AbstractWorkflowPropertyHandler {
     ...
     * @return Object
     */
    private Object handleProcessPropert(
            Object process, TypeDefinition type, QName key, Serializable value) {
     ...
     * @return Object
     */
    protected abstract Object handleTaskProperty(
     ...
     * @return Object
     */
    protected abstract Object handleDelegateTaskProperty(
