 ...
 * @author andyh
 */
public abstract class AbstractNodePermissionEntry
  ...
  public String toString() {
    ...
    sb
      .append("NodePermissionEntry")
      .append("[ node=")
      .append(getNodeRef())
      .append(", entries=")
      .append(getPermissionEntries())
      .append(", inherits=")
      .append(inheritPermissions())
      .append("]");
    return sb.toString();
  }
  ...
  public boolean equals(Object o) {
    ...
    return (
      ...
      EqualsHelper.nullSafeEquals(
        this.getPermissionEntries(),
        other.getPermissionEntries()
      )
    );
  }
