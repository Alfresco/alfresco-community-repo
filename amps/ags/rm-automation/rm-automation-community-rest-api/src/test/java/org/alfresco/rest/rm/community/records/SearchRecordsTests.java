...
public class SearchRecordsTests extends BaseRMRestTest
{
    ...
    /**
     * Given I have created record category X which contains record folder Y which contains record Z And I have selected to display record category id in the search results When I issue a record search whose results will contain record X Then record X is displayed in the results And the record category X's ID is also displayed in search result meta-data for record X
     */
    @Test(priority = 1)
     ...
     * <p>
     * Given that I am a RM User I can see only the records in File Plan I have permission over and all in Unfiled Records
     */
    @Test(priority = 2)
     ...
     * <p>
     * Given that I am a RM Manager I can see only the records in File Plan I have permission over and all in Unfiled Records
     */
    @Test(priority = 4)
     ...
     *
     * Given that I am a RM Administrator I can see all the records in File Plan and Unfiled Records through RM Search and Advanced Search
     */
    @Test(priority = 5)
