...
public class IntegrationFullTestsBulk3 extends IntegrationTest {
  ...
  public void fileHandlingWithCollaboratorRole() throws Exception {
    ...
    publicSite = dataSite.usingUser(testUser1).createPublicRandomSite();
    usersWithRoles =
      dataUser.addUsersWithRolesToSite(publicSite, UserRole.SiteCollaborator);
  ...
  public void fileHandlingWithContributorRole() throws Exception {
    ...
    publicSite = dataSite.usingUser(testUser1).createPublicRandomSite();
    usersWithRoles =
      dataUser.addUsersWithRolesToSite(publicSite, UserRole.SiteContributor);
    wordFile = FileModel.getRandomFileModel(FileType.MSWORD2007, "tasTesting");
    ...
    STEP(
      "6. Delete content that Manager added using Contributor role with CMIS"
    );
    cmisAPI
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteContributor)
  ...
  public void negativeScenarioWithComments() throws Exception {
    ...
    String newComment =
      "This is a new comment added by " + testUser1.getUsername();
    restAPI
      .authenticateUser(testUser1)
      .withCoreAPI()
    ...
    String newContent =
      "This is new content added by " + testUser1.getUsername();
    webDavProtocol
      .authenticateUser(testUser1)
      .usingResource(testFile1)
      .update(newContent)
  ...
  public void addCollaboratorPermissionToADocumentFromPublicSite()
    throws Exception {
    STEP("* 1. Using CMIS create two users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void addContributorPermissionToADocumentFromPublicSite()
    throws Exception {
    STEP("* 1. Using CMIS create two users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void addConsumerPermissionToADocumentFromPublicSite()
    throws Exception {
    STEP("* 1. Using CMIS create two users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void addManagerPermissionToADocumentFromModeratedSite()
    throws Exception {
    STEP("* 1. Using CMIS create two users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void addManagerPermissionToADocumentFromPrivateSite()
    throws Exception {
    STEP("* 1. Using CMIS create two users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void manageModificationTimeOfFile() throws Exception {
    ...
    Assert.assertNotEquals(
      modifiedDate1,
      modifiedDate2,
      "Updated and modified dates are equal"
    );
    Assert.assertNotEquals(
      modifiedDate2,
      updatedDate2,
      "Modified and updated dates are equal"
    );
  }
}
