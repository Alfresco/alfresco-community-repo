...
public class QNameTest extends TestCase {
  ...
  public void testCommonTypes() {
    QName qname3 = QName.createQName(
    ...
    QName qname4 = QName.createQName(
      "{http://www.alfresco.org/model/content/1.0}creator.__"
    );
    assertEquals(
      "{http://www.alfresco.org/model/content/1.0}creator.__",
      qname4.toString()
    ...
    QName qname5 = QName.createQName(
  ...
  public void testPrefix() {
    try {
      QName noResolver = QName.createQName(
    ...
    QName qname1 = QName.createQName(
      NamespaceService.ALFRESCO_PREFIX,
      "alfresco prefix",
      mockResolver
    );
