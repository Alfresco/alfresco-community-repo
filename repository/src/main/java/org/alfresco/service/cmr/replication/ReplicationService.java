...
public interface ReplicationService extends ReplicationDefinitionPersister {
    /**
     * Creates a new {@link ReplicationDefinition} and sets the replication name and description to
    ...
    /**
     * Turns on scheduling for the specified replication. You can then set the scheduling details on
     * the definition.
     */
    @NotAuditable
