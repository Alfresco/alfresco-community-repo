...
/**
 * JSON API Results factory SOLR JSON responses are parsed according to required Action, Command or
 * Handler
 *
 * @author aborroy
 * @since 6.2
            ...
            default:
                {
                    throw new AlfrescoRuntimeException(
                            "Action "
                                    + action
                                    + " is not supported when invoking to SOLR REST API, available"
                                    + " actions: "
