...
public class ActivityFeedEntity {
  ...
  public static final String KEY_ACTIVITY_FEED_POST_USER_AVATAR_NODE =
    "postUserAvatar";
  ...
  public String getJSONString() throws JSONException {
    ...
    if (postUserAvatarNodeRef != null) {
      jo.put(
        KEY_ACTIVITY_FEED_POST_USER_AVATAR_NODE,
        postUserAvatarNodeRef.toString()
      );
    }
  ...
  public Map<String, Object> getModel() throws JSONException {
    ...
    if (getActivitySummary() != null) {
      map.put(
        KEY_ACTIVITY_FEED_SUMMARY,
        JSONtoFmModel.convertJSONObjectToMap(getActivitySummary())
      );
    } else {
