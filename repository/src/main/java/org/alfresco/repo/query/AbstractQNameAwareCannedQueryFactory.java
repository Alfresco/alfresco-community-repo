...
/**
 * An intermediate {@link AbstractCannedQueryFactory} layer, for various implementations that need
 * to know about QName IDs and similar
 *
 * @author Nick Burch
 * @since 4.0
 */
public abstract class AbstractQNameAwareCannedQueryFactory<R>
    ...
    /**
     * Creates a Canned Query sort details, for the given list of properties and if they should be
     * Ascending or Descending
     */
    protected CannedQuerySortDetails createCQSortDetails(List<Pair<QName, Boolean>> sort) {
        List<Pair<? extends Object, SortOrder>> details =
            ...
            if (logger.isTraceEnabled()) {
                logger.trace(
                        "QName does not exist: "
                                + qname); // possible ... eg. blg:blogPost if a blog has never been
                // posted externally
            }
            return -1L;
        }
    ...
    /**
     * Utility class to sort Entities on the basis of a Comparable property. Comparisons of two null
     * properties are considered 'equal' by this comparator. Comparisons involving one null and one
     * non-null property will return the null property as being 'before' the non-null property.
     *
     ...
     */
    public abstract static class PropertyBasedComparator<R> implements Comparator<R> {
