...
public class ACLEntryVoter implements AccessDecisionVoter, InitializingBean
{
    ...
    public int vote(Authentication authentication, Object object, ConfigAttributeDefinition config)
    {
        ...
        for (ConfigAttributeDefintion cad : supportedDefinitions)
        {
                ...
                if (List.class.isAssignableFrom(params[cad.parameter[0]]))
                {
                    ...
                    if (listArgument != null)
                    {
                        ...
                        for (Object listElement : listArgument)
                        {
                            ...
                            Integer currentValue = shouldAbstainOrDeny(cad.required.toString(), testNodeRef, abstainForClassQNames, nodeService, permissionService);
            ...
            Integer accessAbstainOrDeny = shouldAbstainOrDeny(cad.required.toString(), testNodeRef, abstainForClassQNames, nodeService, permissionService);
            if (accessAbstainOrDeny != null)
            {
                return accessAbstainOrDeny;
            }
