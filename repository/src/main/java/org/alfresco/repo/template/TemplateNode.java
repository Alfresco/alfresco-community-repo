...
public class TemplateNode
  ...
  public boolean getIsCategory() {
    if (isCategory == null) {
      ...
      isCategory =
        Boolean.valueOf(dd.isSubClass(getType(), ContentModel.TYPE_CATEGORY));
    }
  ...
  public ChildAssociationRef getPrimaryParentAssoc() {
    if (primaryParentAssoc == null) {
      primaryParentAssoc =
        this.services.getNodeService().getPrimaryParent(nodeRef);
    }
    ...
    if (this.getAspects().contains(ContentModel.ASPECT_VERSIONABLE)) {
      ...
      if (history != null) {
        ...
        for (Version version : history.getAllVersions()) {
          ...
          VersionHistoryNode record = new VersionHistoryNode(
            version,
            this,
            this.services
          );
  ...
  public String getShareUrl() {
    ...
    String siteShortName = services
      .getSiteService()
      .getSiteShortName(getNodeRef());
