...
public interface ContentServicePolicies {
     ...
     * changed; the specific properties are irrelevant. This is primarily useful to determine when a
     * new file is introduced into the system.
     */
    @AlfrescoPublicApi
    ...
    /**
     * Policy that is raised for each content property change. Any policy implementations must be
     * aware that the transaction in which this is called could still roll back; no filesystem
     * changes should occur against the source content until after the transaction has
     * <u>successfully</u> completed.
     *
     * @since 3.2
     */
    @AlfrescoPublicApi
    public interface OnContentPropertyUpdatePolicy extends ClassPolicy {
         ...
         * @param beforeValue the value of the content data prior to the change. Note that this
         *     value may be <tt>null</tt> or any of it's member values may be <tt>null</tt>
         *     according to the contract of the {@link ContentData} class.
     ...
     *
     * <p>This policy is fired when a content reader is requested for a node that has content.
     */
    @AlfrescoPublicApi
