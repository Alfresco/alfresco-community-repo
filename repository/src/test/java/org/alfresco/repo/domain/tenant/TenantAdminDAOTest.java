...
public class TenantAdminDAOTest extends TestCase {
  ...
  private void updateTenant(final TenantUpdateEntity tenantUpdateEntity)
    throws Exception {
    RetryingTransactionCallback<Void> callback = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
  ...
  private TenantUpdateEntity getTenantForUpdate(final String tenantDomain)
    throws Exception {
  ...
  private List<TenantEntity> listTenants(final boolean enabledOnly)
    throws Exception {
  ...
  public void testUpdateTenant() throws Exception {
    ...
    assertEquals(
      createTenantEntity.getTenantDomain(),
      tenantUpdateEntity.getTenantDomain()
    );
    assertEquals(
      createTenantEntity.getEnabled(),
      tenantUpdateEntity.getEnabled()
    );
    assertEquals(
      createTenantEntity.getTenantName(),
      tenantUpdateEntity.getTenantName()
    );
    assertEquals(
      createTenantEntity.getContentRoot(),
      tenantUpdateEntity.getContentRoot()
    );
  ...
  public void testListTenants() throws Exception {
    final String tenantDomainPrefix =
    ...
    for (int i = 1; i <= cnt; i++) {
      ...
      assertEquals(
        "Tenant enabled/disabled count incorrect.",
        enabledCnt,
        listTenants(true).size()
      );
