...
public class MoveRecordTest extends BaseRMTestCase {
    ...
    /**
     * Given a record is filed in a event disposition and moved then the record no longer has any
     * disposition.
     *
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        utils.createBasicDispositionSchedule(
                                sourceCategory, GUID.generate(), GUID.generate(), true, true);
                        sourceRecordFolder =
                        ...
                        assertFalse(
                                nodeService.hasAspect(
                                        sourceRecordFolder, ASPECT_DISPOSITION_LIFECYCLE));
                    ...
                    public void when() throws Exception {
                        ...
                        assertTrue(
                                ((List<String>)
                                        ...
                                        .contains(CommonRMTestUtils.DEFAULT_EVENT_NAME));
    ...
    /**
     * Given a record in a event disposition, when it moved to another event disposition then the
     * record should have the new events, rather than the old ones.
     */
    ...
    /**
     * Given a record in a event disposition, when it moved to a time disposition then the record
     * should have the correct as of date and no longer have the events.
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void then() {
                        ...
                        // check the disposition action details
                        DispositionAction dispositionAction =
                                dispositionService.getNextDispositionAction(dmDocument);
                        assertNotNull(dispositionAction);
                        assertNotNull(CutOffAction.NAME, dispositionAction.getName());
                        assertNotNull(dispositionAction.getAsOfDate());
                        ...
                        assertEquals(
                                CutOffAction.NAME,
                                nodeService.getProperty(
                                        dmDocument, PROP_RS_DISPOSITION_ACTION_NAME));
                        assertNotNull(
                                nodeService.getProperty(
                                        dmDocument, PROP_RS_DISPOSITION_ACTION_AS_OF));
                        assertNull(
                                ((List<String>)
                                        nodeService.getProperty(
                                                dmDocument, PROP_RS_DISPOSITION_EVENTS)));
                        assertNotNull(
                                nodeService.getProperty(
                                        dmDocument, PROP_RS_DISPOITION_INSTRUCTIONS));
                        assertNotNull(
                                nodeService.getProperty(dmDocument, PROP_RS_DISPOITION_AUTHORITY));
                        assertTrue(
                                (Boolean)
                                        nodeService.getProperty(
                                                dmDocument, PROP_RS_HAS_DISPOITION_SCHEDULE));
                    }
                });
    }
