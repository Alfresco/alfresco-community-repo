...
public class ImapCreateFolderTests extends EmailTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user can create a folder in Afresco IMAP root folder, but it is not"
                            + " displayed in Alfresco Repository")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify admin can create a folder in Sites folder and it will be displayed in"
                            + " Alfresco Repository/Sites")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            description =
                    "Verify manager can create a folder  with spaces in name in IMAP Site >"
                            + " documentLibrary")
    ...
    public void collaboratorCanCreateFolderInImapSite() throws Exception {
        ...
        dataUser.usingUser(testUser)
                .addUserToSite(collaboratorUser, imapSite, UserRole.SiteCollaborator);
        FolderModel folderToCreate = FolderModel.getRandomFolderModel();
    ...
    public void contributorCanCreateFolderInImapSite() throws Exception {
        ...
        dataUser.usingUser(testUser)
                .addUserToSite(contributorUser, imapSite, UserRole.SiteCollaborator);
        FolderModel folderToCreate = FolderModel.getRandomFolderModel();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can create folder successfully with name that contains special"
                            + " characters")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can create folder successfully with name that contains symbols")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify create folder using an user and check folder can be view by another"
                            + " user with access to the same location/site")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL})
