 ...
 * <p>
 * 1) open (readWrite) 2) open (readOnly) - file already open for read/write 3) close 4) close
 * 
 */
    ...
    public Command evaluate(Operation operation)
    {
        ...
        case OPENING:
            ...
            if (operation instanceof OpenFileOperation)
            {
                ...
                {
                    /**
                     * TODO What to do here - one thread is in the middle of opening a file while another tries to open the same file sleep for a bit? then check state again? What happens if file closes while sleeping. For now log an error.
                     */
