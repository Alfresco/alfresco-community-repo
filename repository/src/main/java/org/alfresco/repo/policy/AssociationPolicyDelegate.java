...
public class AssociationPolicyDelegate<P extends AssociationPolicy> {
    ...
    /*package*/ AssociationPolicyDelegate(
    ...
    public P get(NodeRef nodeRef, QName classQName, QName assocTypeQName) {
        ...
        return factory.create(
                new ClassFeatureBehaviourBinding(dictionary, nodeRef, classQName, assocTypeQName));
    }
            ...
            P policy =
                    factory.create(
                            new ClassFeatureBehaviourBinding(
                                    dictionary, nodeRef, classQName, assocTypeQName));
