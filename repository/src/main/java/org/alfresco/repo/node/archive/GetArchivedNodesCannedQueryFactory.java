...
public class GetArchivedNodesCannedQueryFactory
    ...
    public CannedQuery<ArchivedNodeEntity> getCannedQuery(CannedQueryParameters parameters) {
        return (CannedQuery<ArchivedNodeEntity>)
                new GetArchivedNodesCannedQuery(
                        cannedQueryDAO, nodeDAO, methodSecurity, parameters);
    }
     ...
     */
    public CannedQuery<ArchivedNodeEntity> getCannedQuery(
        ...
        GetArchivedNodesCannedQueryParams paramBean =
                new GetArchivedNodesCannedQueryParams(
                        nodeId,
                        qnameId,
                        filter,
                        filterIgnoreCase,
