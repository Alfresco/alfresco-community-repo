...
public class FormServiceImplTest extends BaseAlfrescoSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.personManager =
                new TestPersonManager(mutableAuthenticationService, personService, nodeService);
        ...
        ContentWriter writer =
                this.contentService.getWriter(this.document, ContentModel.PROP_CONTENT, true);
        writer.setMimetype(VALUE_MIMETYPE);
        writer.setEncoding(VALUE_ENCODING);
        writer.putContent(VALUE_CONTENT);

        ContentWriter writer2 =
                this.contentService.getWriter(this.associatedDoc, ContentModel.PROP_CONTENT, true);
        ...
        this.nodeService.createAssociation(
                this.document, this.associatedDoc, ContentModel.ASSOC_REFERENCES);
    }
    ...
    public void testGetAllDocForm() throws Exception {
        Form form =
                this.formService.getForm(new Item(NODE_FORM_ITEM_KIND, this.document.toString()));
        ...
        PropertyFieldDefinition descField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:description");
        PropertyFieldDefinition mimetypeField =
                (PropertyFieldDefinition) fieldDefMap.get("mimetype");
        PropertyFieldDefinition encodingField =
                (PropertyFieldDefinition) fieldDefMap.get("encoding");
        PropertyFieldDefinition sizeField = (PropertyFieldDefinition) fieldDefMap.get("size");
        PropertyFieldDefinition originatorField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:originator");
        PropertyFieldDefinition addresseeField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:addressee");
        PropertyFieldDefinition addresseesField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:addressees");
        PropertyFieldDefinition subjectField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:subjectline");
        PropertyFieldDefinition sentDateField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:sentdate");
        AssociationFieldDefinition referencesField =
                (AssociationFieldDefinition) fieldDefMap.get("cm:references");
        ...
        assertEquals(
                "Expecting cm:name label to be " + LABEL_NAME, LABEL_NAME, nameField.getLabel());
        assertEquals(
        ...
        assertNotNull(
                "Expecting an 'requiresMatch' constraint parameter", params.get("requiresMatch"));

        // check details of the addressees field
        assertEquals(
                "Expecting cm:addressees type to be text", "text", addresseesField.getDataType());
        ...
        assertEquals(
                VALUE_ORIGINATOR, data.getFieldData(originatorField.getDataKeyName()).getValue());
        assertEquals(
                VALUE_ADDRESSEE, data.getFieldData(addresseeField.getDataKeyName()).getValue());
        assertEquals(VALUE_SUBJECT, data.getFieldData(subjectField.getDataKeyName()).getValue());
        assertTrue(
                "Expecting size to be > 0",
                ((Long) data.getFieldData(sizeField.getDataKeyName()).getValue()).longValue() > 0);
        ...
        List<String> targets =
                (List<String>) data.getFieldData(referencesField.getDataKeyName()).getValue();
    ...
    public void testGetSelectedFieldsDocForm() throws Exception {
        ...
        Form form =
                this.formService.getForm(
                        new Item(NODE_FORM_ITEM_KIND, this.document.toString()), fields);
        ...
        assertNotNull("Expecting to find fields", fieldDefs);
        assertEquals(
                "Expecting to find " + fields.size() + " fields", fields.size(), fieldDefs.size());
        ...
        PropertyFieldDefinition mimetypeField =
                (PropertyFieldDefinition) fieldDefMap.get("mimetype");
        PropertyFieldDefinition modifiedField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:modified");
        PropertyFieldDefinition modifierField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:modifier");
        PropertyFieldDefinition subjectField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:subjectline");
        PropertyFieldDefinition sentDateField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:sentdate");
    ...
    public void testMissingFieldsDocForm() throws Exception {
        ...
        PropertyFieldDefinition nameField = (PropertyFieldDefinition) fieldDefMap.get("cm:name");
        PropertyFieldDefinition titleField = (PropertyFieldDefinition) fieldDefMap.get("cm:title");
        PropertyFieldDefinition authorField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:author");
    ...
    public void testForcedFieldsDocForm() throws Exception {
        ...
        PropertyFieldDefinition wrongField =
                (PropertyFieldDefinition) fieldDefMap.get("wrong-name");
    ...
    public void testGetAllFolderForm() throws Exception {
        ...
        // find the fields
        PropertyFieldDefinition nameField = (PropertyFieldDefinition) fieldDefMap.get("cm:name");
        AssociationFieldDefinition containsField =
                (AssociationFieldDefinition) fieldDefMap.get("cm:contains");
        ...
        assertTrue(
                "Expecting cm:contains endpoint to be 1 to many", containsField.isEndpointMany());
        ...
        List<String> children =
                (List<String>) data.getFieldData(containsField.getDataKeyName()).getValue();
    ...
    public void testSaveNodeForm() throws Exception {
        ...
        // add an association to the child doc (as an attachment which is defined on an aspect not
        // applied)
        ...
        List<String> updatedAddressees =
                (List<String>) updatedProps.get(ContentModel.PROP_ADDRESSEES);
        String wrong =
                (String) updatedProps.get(QName.createQName("cm", "wrong", this.namespaceService));
    ...
    public void testGetAllCreateForm() throws Exception {
        ...
        // find the fields
        PropertyFieldDefinition nameField = (PropertyFieldDefinition) fieldDefMap.get("cm:name");
        PropertyFieldDefinition createdField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:created");
        PropertyFieldDefinition creatorField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:creator");
        PropertyFieldDefinition modifiedField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:modified");
        PropertyFieldDefinition modifierField =
                (PropertyFieldDefinition) fieldDefMap.get("cm:modifier");
    ...
    public void testGetSelectedFieldsCreateForm() throws Exception {
        ...
        form =
                this.formService.getForm(
                        new Item(TYPE_FORM_ITEM_KIND, "cm:content"), fields, forcedFields);
        ...
        NodeRef newNode =
                (NodeRef)
                        this.formService.saveForm(
                                new Item(TYPE_FORM_ITEM_KIND, "cm:content"), data);
    ...
    public void testContentForms() throws Exception {
        ...
        Form form =
                this.formService.getForm(new Item(NODE_FORM_ITEM_KIND, newNode.toString()), fields);
        assertNotNull(form);
        assertEquals(name, form.getFormData().getFieldData("prop_cm_name").getValue().toString());
        String contentUrl =
                form.getFormData().getFieldData("prop_cm_content").getValue().toString();
        assertTrue(
    ...
    private FormData createContentFormData(
            String name, String title, String mimetype, String content) {
        FormData data = new FormData();
    ...
    private void checkContentDetails(
        ...
        ContentData contentData =
                (ContentData) this.nodeService.getProperty(node, ContentModel.PROP_CONTENT);
    ...
    public void disabledTestFDKModel() throws Exception {
        ...
        try {
            ...
            fail(
                    "FDK namespace is missing, ensure you've made the 'Forms Development Kit'"
                            + " project a dependency of the 'Repository' project when enabling this"
                            + " test!");
        }
        ...
        Form form =
                this.formService.getForm(
                        new Item(NODE_FORM_ITEM_KIND, everythingNode.toString()), fields);
        ...
        assertEquals(
                underscoreValue, values.getFieldData(underscoreField.getDataKeyName()).getValue());
        ...
        data.addFieldData(
                duplicateAssocField.getDataKeyName() + "_added", this.document.toString());
        ...
        form =
                this.formService.getForm(
                        new Item(TYPE_FORM_ITEM_KIND, "fdk:with_underscore"), fields);
        assertNotNull(form);
        ...
        NodeRef newNode =
                (NodeRef)
                        this.formService.saveForm(
                                new Item(TYPE_FORM_ITEM_KIND, "fdk:with_underscore"), data);
        ...
        form =
                this.formService.getForm(
                        new Item(TYPE_FORM_ITEM_KIND, "my-fdk:namespace-with-dash"), fields);
        assertNotNull(form);
        ...
        newNode =
                (NodeRef)
                        this.formService.saveForm(
                                new Item(TYPE_FORM_ITEM_KIND, "my-fdk_namespace-with-dash"), data);
        assertNotNull(newNode);
        ...
        assertEquals(
                ...
                (String)
                        props.get(
                                QName.createQName(
                                        "http://www.alfresco.org/model/my-fdk/1.0", "more_text")));
    }
    ...
    public void testTransitionActivitiTask() throws Exception {
        checkTransitionTask(
                "activiti$activitiReview", ActivitiConstants.DEFAULT_TRANSITION_NAME, "Approve");
    }
    ...
    private void checkWorkflowForms(String workflowDefName, String transitionLabels)
            throws Exception {
        ...
        String workflowDescName =
                WorkflowModel.PROP_WORKFLOW_DESCRIPTION.toPrefixString(namespaceService);
        ...
        Form form =
                this.formService.getForm(
                        new Item(WORKFLOW_FORM_ITEM_KIND, workflowDefName), fields);
        ...
        PropertyFieldDefinition descriptionField =
                (PropertyFieldDefinition) fieldDefMap.get(workflowDescName);
        PropertyFieldDefinition dueDateField =
                (PropertyFieldDefinition) fieldDefMap.get(workflowDueDateName);
        AssociationFieldDefinition packageItemsField =
                (AssociationFieldDefinition) fieldDefMap.get(packageItemsName);
    ...
    public void testNoForm() throws Exception {
        ...
        try {
            ...
            data.addFieldData("prop_bpm_workflowDescription", "This is a new adhoc task");
            data.addFieldData(
                    "assoc_bpm_assignee_added", this.personManager.get(USER_ONE).toString());
            ...
            this.formService.saveForm(
                    ...
                    data); // correct name would be "activiti$activitiAdhoc"
    ...
    public void testFormData() throws Exception {
        ...
        assertEquals(
                "Expecting value of 'one'", "one", formData.getFieldData("singleValue").getValue());
    ...
    public void testFormContext() throws Exception {
        ...
        Form form =
                this.formService.getForm(
                        new Item(NODE_FORM_ITEM_KIND, this.document.toString()), context);
        assertNotNull(form);
    }
    ...
    public void testNonContentNode() throws Exception {
        ...
        Form form =
                this.formService.getForm(new Item(NODE_FORM_ITEM_KIND, node.toString()), fields);
    ...
    public void testMNT_10969() throws Exception {
        ...
        List<String> savedValue =
                (List<String>) updatedProps.get(ContentModel.PROP_DEAD_PROPERTIES);
    ...
    public void testJavascriptAPI() throws Exception {
        ...
        ScriptLocation location =
                new ClasspathScriptLocation("org/alfresco/repo/forms/script/test_formService.js");
