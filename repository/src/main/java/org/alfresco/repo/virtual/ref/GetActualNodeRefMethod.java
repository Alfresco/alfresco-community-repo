 ...
 * Actual {@link NodeRef} are node references of content elements found in the Alfresco repository
 * that are subjected to a virtualization process.
 *
 * @author Bogdan Horje
 */
public class GetActualNodeRefMethod extends AbstractProtocolMethod<NodeRef> {
    ...
    @Override
    public NodeRef execute(VirtualProtocol virtualProtocol, Reference reference)
    ...
    @Override
    public NodeRef execute(NodeProtocol protocol, Reference reference)
            throws ProtocolMethodException {
