    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest(AccessDeniedException.class) {
        ...
        public void given() throws Exception {
          ...
          sourceRecord =
            utils.createRecord(sourceRecordFolder, GUID.generate());
          ...
          targetRecord =
            utils.createRecord(targetRecordFolder, GUID.generate());
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() throws Exception {
          ...
          assertEquals(
            1,
            relationshipService.getRelationshipsFrom(sourceRecord).size()
          );
          assertEquals(
            0,
            relationshipService.getRelationshipsTo(sourceRecord).size()
          );
          assertEquals(
            0,
            relationshipService.getRelationshipsFrom(targetRecord).size()
          );
          assertEquals(
            1,
            relationshipService.getRelationshipsTo(targetRecord).size()
          );
        }
      }
    );
