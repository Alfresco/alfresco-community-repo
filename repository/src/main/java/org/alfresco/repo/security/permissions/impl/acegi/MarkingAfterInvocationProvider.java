...
/**
 * Invocation provider that can be used to mark entries that have been permission checked. Use an
 * instance of this class at the end of the 'after' invocations.
 *
 * @author Derek Hulley
 * @since 4.0
 */
