...
public class GetChildAssocsMethod
  ...
  @Override
  public List<ChildAssociationRef> execute(
    ...
    if (typeQNamePattern.isMatch(ContentModel.ASSOC_CONTAINS)) {
      ...
      for (Reference child : children) {
        ...
        Serializable childName = environment.getProperty(
          childNodeRef,
  ...
  public List<ChildAssociationRef> execute(
    ...
    if (
      !environment.isSubClass(
        environment.getType(nodeRefReference),
        ContentModel.TYPE_FOLDER
      )
    ) {
      List<ChildAssociationRef> actualAssociations = environment.getChildAssocs(
        actualNodeRef,
        typeQNamePattern,
        qnamePattern,
        maxResults,
      ...
      for (ChildAssociationRef actualAssoc : actualAssociations) {
        ChildAssociationRef referenceChildAssocRef = new ChildAssociationRef(
