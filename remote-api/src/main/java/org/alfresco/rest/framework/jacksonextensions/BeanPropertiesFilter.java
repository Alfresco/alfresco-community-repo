 ...
 *
 * <p>It's based on Jackson's BeanPropertyFilter but uses slightly different method signatures
 *
 * @author Gethin James
 */
public class BeanPropertiesFilter {
    ...
    public String toString() {
        ...
        builder.append("BeanPropertiesFilter [filteredProperties=")
                .append(this.filteredProperties)
                .append("]");
