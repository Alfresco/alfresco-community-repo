...
public class DictionaryRestApiTest extends BaseWebScriptTest {
    ...
    private void validateAssociation(JSONObject result) throws Exception {
        ...
        assertEquals(
                "/api/classes/cm_checkedOut/association/cm_workingcopylink", result.get("url"));
    }
    ...
    private void validateTypeClass(JSONObject result) throws Exception {
        ...
        // assertEquals("/api/classes/cm_cmobject/property/cm_name",
    ...
    public void testGetPropertyDef() throws Exception {
        Response response =
                sendRequest(new GetRequest("/api/classes/cm_auditable/property/cm_created"), 200);
        ...
        // cm_auditable
        response =
                sendRequest(new GetRequest("/api/classes/cm_auditable/property/cm_welcome"), 200);
    ...
    public void testGetAssociationDefs() throws Exception {
        ...
        // cm:authorityContainer has a child_assoc relation with cm:member , but ask for general
        ...
        // cm:copiedFrom has a general association relation with cm:object , but ask for child
        // association, this then returns a null array
        arguments.clear();
        arguments.put("af", "child");
        arguments.put("nsp", "cm");
