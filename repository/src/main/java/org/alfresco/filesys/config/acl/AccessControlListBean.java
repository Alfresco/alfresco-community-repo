...
/**
 * Simple description of a JLAN Access Control List that can be configured via JMX or a Spring bean
 * definition. The lists are partitioned by type to aid in the UI mapping.
 */
public class AccessControlListBean {
     ...
     *
     * @param defaultAccessLevel the new default access level
     ...
     *
     * @param domainAccessControls the new domain access controls
     */
     ...
     *
     * @param gidAccessControls the new gid access controls
     */
     ...
     *
     * @param ipAddressAccessControls the new ip address access controls
     */
    public void setIpAddressAccessControls(
            List<IpAddressAccessControlBean> ipAddressAccessControls) {
     ...
     *
     * @param protocolAccessControls the new protocol access controls
     */
     ...
     *
     * @param uidAccessControls the new uid access controls
     */
     ...
     *
     * @param userAccessControls the new user access controls
     */
     ...
     *
     * @param secConfig the security config
     * @return the access control list
     * @throws InvalidConfigurationException
     */
    public AccessControlList toAccessControlList(SecurityConfigSection secConfig)
            throws InvalidConfigurationException {
        ...
        if (acls.numberOfControls() == 0) {
            if (defaultAccessLevel == AccessControl.Default) {
                ...
                throw new AlfrescoRuntimeException(
                        "Empty access control list and default access 'None' not allowed");
            }
        }
