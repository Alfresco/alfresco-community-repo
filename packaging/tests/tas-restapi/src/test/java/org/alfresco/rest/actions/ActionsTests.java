...
public class ActionsTests extends RestTest {
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.ACTIONS},
    ...
    public void testActionDefinitions() throws Exception {
        ...
        RestActionDefinitionModelsCollection restActionDefinitions =
                restClient.withCoreAPI().usingActions().listActionDefinitions();
        ...
        restActionDefinitions
                ...
                .and()
                .entriesListContains("name", "move")
                .and()
                .entriesListContains("name", "check-out")
                .and()
    ...
    public void testActionDefinitionsNegative() throws Exception {
        ...
        {
            restClient
                    .authenticateUser(dataContent.getAdminUser())
                    .
                    // invalid skipCount
        ...
        // Unauthorized -> 401
        {
            ...
            restClient
                    .authenticateUser(userUnauthorized)
                    .withCoreAPI()
                    .usingActions()
                    .listActionDefinitions();
        ...
        JSONObject response =
                restClient
                        ...
                        .executeAction(
                                "add-features",
                                document,
                                ImmutableMap.of("aspect-name", "cm:versionable"));
    ...
    public void executeActionWithoutParam() throws Exception {
        JSONObject response =
                restClient
                        ...
                        .withCoreAPI()
                        .usingActions()
                        .executeAction("check-out", document);
        restClient.assertStatusCodeIs(HttpStatus.ACCEPTED);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Sanity test for ACTIONS endpoint GET action-definitions/{actionDefinitionId}")
    @Test(groups = {TestGroup.REST_API, TestGroup.ACTIONS, TestGroup.SANITY})
    public void testGetActionDefinitionById() throws Exception {
        restClient.authenticateUser(dataContent.getAdminUser());

        RestActionDefinitionModel restActionDefinition =
                restClient.withCoreAPI().usingActions().getActionDefinitionById("add-features");
        ...
        restActionDefinition
                .getDescription()
                .equals("This will add an aspect to the matched item.");
