...
public interface NamespaceService extends NamespacePrefixResolver {
  ...
  static final String DICTIONARY_MODEL_1_0_URI =
  ...
  /** System Model URI */
  static final String SYSTEM_MODEL_1_0_URI =
  ...
  /** Content Model URI */
  static final String CONTENT_MODEL_1_0_URI =
  ...
  static final String APP_MODEL_1_0_URI =
  ...
  /** Audio Model URI */
  static final String AUDIO_MODEL_1_0_URI =
    "http://www.alfresco.org/model/audio/1.0";

  /** Audio Model Prefix */
  static final String AUDIO_MODEL_PREFIX = "audio";

  /** EXIF Model URI */
  static final String EXIF_MODEL_1_0_URI =
    "http://www.alfresco.org/model/exif/1.0";

  /** WebDAV Model Prefix */
  static final String WEBDAV_MODEL_PREFIX = "webdav";

  /** WebDAV Model URI */
  static final String WEBDAV_MODEL_1_0_URI =
    "http://www.alfresco.org/model/webdav/1.0";

  /** EXIF Model Prefix */
  static final String EXIF_MODEL_PREFIX = "exif";

  /** DataList Model URI */
  static final String DATALIST_MODEL_1_0_URI =
  ...
  static final String BPM_MODEL_1_0_URI =
  ...
  /** Workflow Model URI */
  static final String WORKFLOW_MODEL_1_0_URI =
  ...
  /** Alfresco Forums URI */
  static final String FORUMS_MODEL_1_0_URI =
  ...
  /** Alfresco Links URI */
  static final String LINKS_MODEL_1_0_URI =
    "http://www.alfresco.org/model/linksmodel/1.0";

  /** Alfresco Links Prefix */
  static final String LINKS_MODEL_PREFIX = "lnk";

  /** Rendition Model URI */
  static final String RENDITION_MODEL_1_0_URI =
  ...
  static final String REPOSITORY_VIEW_1_0_URI =
    "http://www.alfresco.org/view/repository/1.0";

  /** Alfresco View Namespace Prefix */
  static final String REPOSITORY_VIEW_PREFIX = "view";

  /** Alfresco security URI */
  static final String SECURITY_MODEL_1_0_URI =
  ...
  static final String EMAILSERVER_MODEL_URI =
    "http://www.alfresco.org/model/emailserver/1.0";
