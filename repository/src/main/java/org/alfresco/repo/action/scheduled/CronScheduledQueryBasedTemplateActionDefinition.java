...
public class CronScheduledQueryBasedTemplateActionDefinition
  ...
  public Trigger getTrigger() {
    try {
      return TriggerBuilder
        ...
        .build();
    } catch (final RuntimeException e) { // CronScheduleBuilder is throwing RuntimeException which is wrapping ParseException
      throw new InvalidCronExpression(
        "Invalid chron expression: n" + getCronExpression()
      );
    }
  }
  ...
  public List<NodeRef> getNodes() {
    ...
    String query = templateService.processTemplateString(
      getTemplateActionModelFactory().getTemplateEngine(),
      queryTemplate,
      getTemplateActionModelFactory().getModel()
    );
