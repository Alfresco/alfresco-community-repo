...
/**
 * Test of the ActionExecuter for extracting metadata, specifically for the mapping to cm:taggable
 * tags which requires different transaction mechanisms than the existing {@link
 * ContentMetadataExtracterTest}.
 *
...
public class ContentMetadataExtracterTagMappingTest extends TestCase {
    ...
    protected static final String QUICK_FILENAME =
            "quickIPTC.jpg"; // Keywords separated with comma (,)
    protected static final String QUICK_FILENAME2 =
            "quickIPTC2.jpg"; // Keywords separated with pipe (|)
    protected static final String QUICK_FILENAME3 =
            "quickIPTC3.jpg"; // Keywords separated with semi-colon (;)
    ...
    protected static final String TAG_NONEXISTENT_NODEREF =
            "workspace://SpacesStore/cb725c1f-4f7a-4232-8870-6c95b65407e1";
    ...
    protected void setUp() throws Exception {
        ...
        this.metadataExtracterRegistry =
                (MetadataExtracterRegistry) ctx.getBean("metadataExtracterRegistry");
                    ...
                    .doInTransaction(
                            new RetryingTransactionCallback<Void>() {
                                ...
                                public Void execute() throws Throwable {
                                    ...
                                    ContentMetadataExtracterTagMappingTest.storeRef =
                                    ...
                                    MetadataExtracterRegistry registry =
                                            (MetadataExtracterRegistry)
                                                    ctx.getBean("metadataExtracterRegistry");
        ...
        ((PolicyComponent) ctx.getBean("policyComponent"))
                .bindClassBehaviour(
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<NodeRef[]>() {
                            ...
                            public NodeRef[] execute() throws Throwable {
                                ...
                                // Create a folder
                                Map<QName, Serializable> folderProps =
                                ...
                                // Create a node
                                Map<QName, Serializable> docProps =
                                        new HashMap<QName, Serializable>(1);
                                docProps.put(
                                        ContentModel.PROP_NAME, "testDocument" + guid + ".jpg");
                                NodeRef document =
                                        nodeService
                                                .createNode(
                                                        folder,
        ...
        public Map<String, Serializable> extractRaw(ContentReader reader) throws Throwable {
            ...
            List<String> keywords =
                    new ArrayList<String>(
                            Arrays.asList(
                                    new String[] {
                                        existingTagNodeRef, TAG_2, TAG_3, TAG_NONEXISTENT_NODEREF
                                    }));
        ...
        this.transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            @Override
                            public Void execute() throws Throwable {
                                NodeRef existingTagNodeRef =
                                        taggingService.createTag(storeRef, TAG_1);
                                ...
                                assertEquals(
                                        ContentMetadataExtracterTest.QUICK_DESCRIPTION,
                                        nodeService.getProperty(
                                                document, ContentModel.PROP_DESCRIPTION));
                                ...
                                assertTrue(
                                        "doc tags '" + tags + "' should contain '" + TAG_2 + "'",
                                        tags.contains(TAG_2));
                                ...
                                assertTrue(
                                        "doc tags '" + tags + "' should contain '" + TAG_1 + "'",
                                        tags.contains(TAG_1));

                                // Test that there are no extra tags created by the non-existent
                                // nodeRef
                                assertEquals(
                                        "Unexpected number of doc tags '" + tags + "'",
                                        7,
                                        tags.size());
    ...
    /**
     * Test to validate that we ignore invalid tag names when running with "enableStringTagging"
     * option (aka "addTags")
     *
     * <p>eg. "java.lang.IllegalArgumentException: Tag name must not contain | char sequence"
     */
    ...
    public void testTagMappingSeparators() throws Exception {
        ...
        extractAndCheckTags(
                nodes[0], Arrays.asList("keyword1", "keyword2", "keyword3", "keyword4"));
        removeTestFolderAndDocument(nodes);
    }
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                for (String expectedTag : expectedTags) {
                                    assertTrue(
                                            "Expected tag '" + expectedTag + "' not in " + tags,
