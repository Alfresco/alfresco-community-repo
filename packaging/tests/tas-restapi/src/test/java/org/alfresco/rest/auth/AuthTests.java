...
public class AuthTests extends RestTest {
  ...
  private RestWrapper addRestRequestAuthorization(RestTicketModel ticketModel) {
    restClient
      ...
      .addHeader("Authorization", "Basic " + encodeB64(ticketModel.getId()));
    return restClient;
  }

  @TestRail(
    section = { TestGroup.REST_API, TestGroup.AUTH },
    executionType = ExecutionType.SANITY,
    description = "Verify HttpMethod.POST tickets"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.SANITY, TestGroup.AUTH })
  public void adminShouldGetTicketBody()
    ...
    RestTicketModel ticketReturned = restClient
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.AUTH },
    executionType = ExecutionType.SANITY,
    description = "Verify HttpMethod.GET tickets/-me-"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.SANITY, TestGroup.AUTH })
  public void randomUserGetTicket() throws Exception {
    ...
    RestTicketModel ticketCreated = restClient
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.AUTH },
    executionType = ExecutionType.SANITY,
    description = "Verify HttpMethod.REMOVE tickets/-me-"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.SANITY, TestGroup.AUTH })
  public void randomUserRemoveTicket() throws Exception {
    ...
    restClient
      .assertLastError()
      .containsErrorKey("Ticket base authentication required.");
  }
