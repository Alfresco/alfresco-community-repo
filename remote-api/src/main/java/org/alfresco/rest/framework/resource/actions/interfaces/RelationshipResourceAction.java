...
/**
 * Permissible actions for an Relationship Resources Based around CRUD - Create, ReadAll, ReadById,
 * Update, Delete, DeleteSet
 *
 * @author Gethin James
 */
public interface RelationshipResourceAction {
    ...
    public static interface Read<E> extends ResourceAction {
        /**
         * Reads set the relationship entities from the collection using the related
         * entityResourceId.
         *
         * <p>Paging information is provided.
         *
    ...
    public static interface ReadWithResponse<E> extends ResourceAction {
        /**
         * Reads all the relationship entities from the collection using the related
         * entityResourceId.
         *
         * <p>Paging information is provided.
         *
         * @param entityResourceId Entity resource context for this relationship
         * @param params will never be null and will have the PAGING default values, implementation
         *     may choose to filter the set based on params (ie. not necessarily "all")
         */
        public CollectionWithPagingInfo<E> readAll(
                String entityResourceId, Parameters params, WithResponse withResponse);
    }

    /** HTTP GET - Retrieve a relation by its unique id & entity context */
    public static interface ReadById<E> extends ResourceAction {
        public E readById(String entityResourceId, String id, Parameters parameters)
    ...
    public static interface DeleteSet extends ResourceAction {
         ...
         *
         * @param entityResourceId Entity resource context for this relationship
         * @param params implementation may choose to restrict the set to be be deleted based on
         *     params (ie. not necessarily "all")
         */
