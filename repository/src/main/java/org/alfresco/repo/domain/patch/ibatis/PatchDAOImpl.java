...
public class PatchDAOImpl extends AbstractPatchDAOImpl {
    ...
    public int updatePersonSizeCurrentType() {
        ...
        Long sizeCurrentPropQNameId =
                qnameDAO.getOrCreateQName(ContentModel.PROP_SIZE_CURRENT).getFirst();
    ...
    public List<Long> getNodesByContentPropertyMimetypeId(
            Long mimetypeId, Long minNodeId, Long maxNodeId) {
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public List<Long> getNodesByTypeQNameAndAspectQNameId(
            long typeQNameId, long aspectQNameId, long minNodeId, long maxNodeId) {
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public List<NodeRef> getChildrenOfTheSharedSurfConfigFolder(Long minNodeId, Long maxNodeId) {
        ...
        // Get qname CRC
        Long qnameCrcSites =
                ChildAssocEntity.getQNameCrc(QName.createQName(SiteModel.SITE_MODEL_URL, "sites"));
        Long qnameCrcSurfConfig =
                ChildAssocEntity.getQNameCrc(
