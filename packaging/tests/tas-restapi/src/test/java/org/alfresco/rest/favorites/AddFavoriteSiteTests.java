...
public class AddFavoriteSiteTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    folder =
      dataContent.usingSite(publicSite).usingUser(adminUser).createFolder();
  }
  ...
  @TestRail(
    ...
    description = "Verify manager user add a favorite site with Rest API and response is successful (201)"
  )
  public void managerUserAddFavoriteSiteWithSuccess() throws Exception {
    UserModel managerUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(userModel)
      .addUserToSite(managerUser, publicSite, UserRole.SiteManager);
  ...
  public void managerUserNotAuthorizedFailsToAddFavoriteSite()
    throws Exception {
    UserModel managerUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(userModel)
  ...
  @TestRail(
    ...
    description = "Verify collaborator user add a favorite site with Rest API and response is successful (201)"
  )
  ...
  public void managerUserAddFavoriteSiteAlreadyAFavoriteSite()
    throws Exception {
    publicSite = dataSite.usingUser(userModel).createPublicRandomSite();
    UserModel managerUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
  ...
  public void managerAddsPrivateSiteAsFavorite() throws Exception {
    ...
    dataUser
      .usingUser(userModel)
      .addUserToSite(managerUser, privateSite, UserRole.SiteManager);
    ...
    RestPersonFavoritesModelsCollection favorites = restClient
      .withCoreAPI()
      .usingAuthUser()
      .getFavorites();
    favorites
  ...
  public void emptyUserIsNotAbleToRemoveFavoriteSite() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "emptyUser")
      );
  }
  ...
  public void userAddFavoriteSiteUserNotMemberOfModeratedSite()
    throws Exception {
    UserModel user = dataUser.usingAdmin().createRandomTestUser();
    restClient
      .authenticateUser(user)
