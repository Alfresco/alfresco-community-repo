...
public class JscriptWorkflowNode implements Serializable {
    ...
    /**
     * Constructor to create a new instance of this class from an existing instance of WorkflowNode
     * from the CMR workflow object model
     *
     * @param workflowNode CMR workflow node object to create new <code>JscriptWorkflowNode</code>
     *     from
     * @param scope root scripting scope for this newly instantiated object
     * @param serviceRegistry service registry object
     */
    public JscriptWorkflowNode(
            WorkflowNode workflowNode, Scriptable scope, ServiceRegistry serviceRegistry) {
    ...
    public Scriptable getTransitions() {
        Scriptable transitionsScriptable =
                (Scriptable)
                        new ValueConverter()
