...
/**
 * A JUnit rule designed to help with finding well known nodes in the system. It provides functionality similar to {@link Repository}, but with extra nodes needed for testing
 * 
 * @author Nick Burch
 * @since Odin
 */
