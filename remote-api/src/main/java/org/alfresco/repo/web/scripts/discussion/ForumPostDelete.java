...
public class ForumPostDelete extends AbstractDiscussionWebScript {
    ...
    /**
     * We can't just delete posts with replies attached to them, as that breaks the reply threading.
     * For that reason, we mark deleted posts with a special text contents. TODO If a post has no
     * replies, then delete it fully
     */
