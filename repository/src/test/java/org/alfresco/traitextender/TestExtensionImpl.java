...
public class TestExtensionImpl extends InstanceExtension<TestExtension, TestTrait>
    ...
    public String privateServiceMethod1(String s) {
        return trait.traitImplOf_privateServiceMethod1(s)
    ...
    public String publicServiceMethod2(String s) {
        return trait.traitImplOf_publicServiceMethod2(s)
                + " TestExtensionImpl.privateServiceMethod1("
                + s
                + ")";
    }
    ...
    public String publicServiceMethod3(String s) {
        return "EX"
                + trait.publicServiceMethod3("TestExtensionImpl.publicServiceMethod3(" + s + ")");
    }
