...
public class XMLTransferManifestReader
  ...
  private static final String MSG_UNABLE_DESERIALIZE =
    "transfer_service.unable_to_deserialise";
  ...
  public XMLTransferManifestReader(
    TransferManifestProcessor snapshotProcessor
  ) {
  ...
  public void startElement(
    ...
    if (elementQName.getNamespaceURI().equals(TRANSFER_URI));
    {
      ...
      if (elementName.equals(ManifestModel.LOCALNAME_TRANSFER_MAINIFEST)) {
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_DELETED_NODE)
      ) {
        ...
        node.setNodeRef(nodeRef);
        node.setType(type);
        QName ancestorType = QName.createQName(
          atts.getValue("", "ancestorType")
        );
        node.setAncestorType(ancestorType);
        props.put("node", node);
      } else if (elementName.equals(ManifestModel.LOCALNAME_ELEMENT_ASPECTS)) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_PROPERTIES)
      ) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_HEADER_CREATED_DATE)
      ) {
        buffer = new StringBuffer();
      } else if (
        elementName.equals(ManifestModel.LOCALNAME_HEADER_NODE_COUNT)
      ) {
        buffer = new StringBuffer();
      } else if (
        elementName.equals(ManifestModel.LOCALNAME_HEADER_REPOSITORY_ID)
      ) {
        buffer = new StringBuffer();
      } else if (
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_PARENT_ASSOCS)
      ) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_CHILD_ASSOCS)
      ) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_CHILD_ASSOC)
      ) {
        buffer = new StringBuffer();
        NodeRef to = new NodeRef(atts.getValue("", "to"));
        QName type = QName.createQName(atts.getValue("", "type"));
        Boolean isPrimary = Boolean.parseBoolean(
          atts.getValue("", "isPrimary")
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_PARENT_ASSOC)
      ) {
        buffer = new StringBuffer();
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_TARGET_ASSOCS)
      ) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_SOURCE_ASSOCS)
      ) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_PRIMARY_PARENT)
      ) {
        buffer = new StringBuffer();
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_VALUE_STRING)
      ) {
        props.put("className", atts.getValue("", "className"));
        buffer = new StringBuffer();
      } else if (
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_VALUE_NULL)
      ) {} else if (
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_VALUE_SERIALIZED)
      ) {
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_CONTENT_HEADER)
      ) {
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_ACL_PERMISSION)
      ) {
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_CATEGORIES)
      ) {
  ...
  public void endElement(String uri, String localName, String prefixName)
    ...
    if (elementQName.getNamespaceURI().equals(TRANSFER_URI));
    {
      ...
      if (
        elementName.equals(ManifestModel.LOCALNAME_TRANSFER_MAINIFEST)
      ) {} else if (
        elementName.equals(ManifestModel.LOCALNAME_TRANSFER_HEADER)
      ) {
        TransferManifestHeader header = (TransferManifestHeader) props.get(
          "header"
        );
        ...
        TransferManifestDeletedNode node = (TransferManifestDeletedNode) props.get(
          "node"
        );
        processor.processTransferManifestNode(node);
      } else if (
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_ASPECTS)
      ) {} else if (
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_ASPECT)
      ) {
        TransferManifestNormalNode node = (TransferManifestNormalNode) props.get(
          "node"
        );
        ...
        ChildAssociationRef childAssociationRef = new ChildAssociationRef(
          type,
          node.getNodeRef(),
          name,
          to,
        ...
        List<ChildAssociationRef> parentAssocs = (List<ChildAssociationRef>) props.get(
          "parentAssocs"
        );
        ChildAssociationRef childAssociationRef = new ChildAssociationRef(
          type,
        ...
        QName type = (QName) props.get("type");
        List<AssociationRef> assocs = (List<AssociationRef>) props.get(
          "assocs"
        );
        ...
        elementName.equals(ManifestModel.LOCALNAME_ELEMENT_PRIMARY_PATH)
      ) {
        TransferManifestNode node = (TransferManifestNode) props.get("node");
        String value = buffer.toString();
        ...
        Collection<Serializable> values = (Collection<Serializable>) props.get(
          "values"
        );
        ...
        ManifestAccessControl acl = (ManifestAccessControl) props.get("acl");
        ManifestPermission permission = (ManifestPermission) props.get(
          "permission"
        );
        ...
        Map<NodeRef, ManifestCategory> categories = (Map<NodeRef, ManifestCategory>) props.get(
          "categories"
        );
