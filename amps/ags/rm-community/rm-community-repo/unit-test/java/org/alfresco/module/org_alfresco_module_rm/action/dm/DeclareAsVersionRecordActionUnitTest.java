...
public class DeclareAsVersionRecordActionUnitTest extends BaseActionUnitTest {
    ...
    /**
     * Given that the actioned upon node reference doesn't exist When I execute the action Then
     * nothing happens
     */
    @Test
    public void actionedUponNodeRefDoesntExist() {
        ...
        verify(mockedRecordableVersionService, never())
                .createRecordFromLatestVersion(filePlan, actionedUponNodeRef);
    }

    /**
     * Given that the actioned upon node reference isn't a subtype of cm:content When I execute the
    ...
    public void aciontedUponNodeRefIsntSubTypeOfCmContent() {
        ...
        doReturn(false)
                .when(mockedDictionaryService)
                .isSubClass(any(QName.class), eq(ContentModel.TYPE_CONTENT));
        declareAsVersionRecordAction.executeImpl(mock(Action.class), actionedUponNodeRef);
        verify(mockedRecordableVersionService, never())
                .createRecordFromLatestVersion(filePlan, actionedUponNodeRef);
    }
    ...
    /**
     * Given that the actioned upon node reference doesn't have the versionable aspect applied When
     * I executed the action Then nothing happens
     */
    @Test
    public void actionedUponNodeRefDoesntHaveVersionableApplied() {
        ...
        doReturn(false)
                ...
                .hasAspect(actionedUponNodeRef, ContentModel.ASPECT_VERSIONABLE);
        declareAsVersionRecordAction.executeImpl(mock(Action.class), actionedUponNodeRef);
        verify(mockedRecordableVersionService, never())
                .createRecordFromLatestVersion(filePlan, actionedUponNodeRef);
    }
    ...
    /**
     * Given that the actioned upon node reference is already an record When I execute the action
    ...
    /**
     * Given that the actioned upon node reference is a working copy When I execute the action Then
     * nothing happens
     */
    @Test
    public void actionedUponNodeRefWorkingCopy() {
        ...
        doReturn(true)
                .when(mockedNodeService)
                .hasAspect(actionedUponNodeRef, ContentModel.ASPECT_WORKING_COPY);
        declareAsVersionRecordAction.executeImpl(mock(Action.class), actionedUponNodeRef);
        verify(mockedRecordableVersionService, never())
                .createRecordFromLatestVersion(filePlan, actionedUponNodeRef);
    }
    ...
    /**
     * Given that the actioned upon node reference is a rejected record When I execute the action
     * Then nothing happens
     */
    @Test
    public void actionedUponNodeRefRejectedRecord() {
        ...
        doReturn(true)
                .when(mockedNodeService)
                .hasAspect(actionedUponNodeRef, ASPECT_RECORD_REJECTION_DETAILS);
        declareAsVersionRecordAction.executeImpl(mock(Action.class), actionedUponNodeRef);
        verify(mockedRecordableVersionService, never())
                .createRecordFromLatestVersion(filePlan, actionedUponNodeRef);
    }
    ...
    /**
     * Given that the actioned upon node reference is synced to the cloud When I execute the action
     * Then nothing happens
     */
    @Test
    ...
    /**
     * Given that no file plan is provided And no default file plan exists When I execute the action
    ...
    /**
     * Given that no file plan is provided And a default file plan exists When I execute the action
    ...
    public void noFilePlanParameterDefaultFilePlan() {
        ...
        // execute action
        declareAsVersionRecordAction.executeImpl(mock(Action.class), actionedUponNodeRef);
        verify(mockedRecordableVersionService, times(1))
                .createRecordFromLatestVersion(filePlan, actionedUponNodeRef);
    }

    /**
     * Given that a file plan is provided And it isn't a file plan When I execute the action Then an
     * exception is thrown
     */
    @Test
    ...
    /**
     * Given that a file plan is provided And it is a file plan When I execute the action Then a
     * version record is declared
     */
    @Test
    public void validFilePlanParameter() {
        ...
        declareAsVersionRecordAction.executeImpl(getMockedAction(), actionedUponNodeRef);
        verify(mockedRecordableVersionService, times(1))
                .createRecordFromLatestVersion(myFilePlan, actionedUponNodeRef);
    }

    /**
     * Given that a valid location is provided When I execute the action Then a version record is
     * declared in the provided location
     */
    @Test
    public void validDestinationRecordFolderProvided() {
        ...
        // provided location
        doReturn(destinationRecordFolderNodeRef)
                .when(mockedNodeService)
                .getChildByName(filePlan, ContentModel.ASSOC_CONTAINS, pathParameter);
        doReturn(TYPE_RECORD_FOLDER)
                .when(mockedNodeService)
                .getType(destinationRecordFolderNodeRef);

        // capability check
        doReturn(true)
                .when(mockedCapabilityService)
                .hasCapability(destinationRecordFolderNodeRef, "FileVersionRecords");
        ...
        declareAsVersionRecordAction.executeImpl(getMockedAction(), actionedUponNodeRef);
        verify(mockedRecordableVersionService, times(1))
                .createRecordFromLatestVersion(destinationRecordFolderNodeRef, actionedUponNodeRef);
    }

    /**
     * Given that an invalid location is provided When I execute the action Then an exception is
     * thrown
     */
    @Test
    public void invalidDestinationRecordFolderProvided() {
        ...
        doReturn(destinationRecordFolderNodeRef)
                .when(mockedNodeService)
                .getChildByName(parentDestinationNodeRef, ContentModel.ASSOC_CONTAINS, childName);
        doReturn(TYPE_RECORD_FOLDER)
                .when(mockedNodeService)
                .getType(destinationRecordFolderNodeRef);
        ...
        doReturn(false)
                .when(mockedCapabilityService)
                .hasCapability(destinationRecordFolderNodeRef, "EditRecordMetadata");
