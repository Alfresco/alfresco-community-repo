...
public class SecondLevelRelationshipTests {
    @Autowired ResourceLookupDictionary locator;
    ...
    public void setUp() throws Exception {
        Map<String, Object> entityResourceBeans =
                applicationContext.getBeansWithAnnotation(EntityResource.class);
        Map<String, Object> relationResourceBeans =
                applicationContext.getBeansWithAnnotation(RelationshipResource.class);
        locator.setDictionary(
                ResourceDictionaryBuilder.build(
                        entityResourceBeans.values(), relationResourceBeans.values()));
    }
    ...
    public void testLocateRelationResource() {
        ...
        ResourceWithMetadata collResource =
                locator.locateResource(api, templateVars, HttpMethod.GET);
        ...
        Map<String, ResourceWithMetadata> embeds =
                locator.locateRelationResource(api, "type-a1", relKeys, HttpMethod.GET);
