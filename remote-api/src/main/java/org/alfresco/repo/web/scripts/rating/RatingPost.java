        ...
        try {
            ...
            if (json.has(RATING) == false) {
                throw new WebScriptException(
                        Status.STATUS_BAD_REQUEST, "rating parameter missing when applying rating");
            }
            ...
            if (scheme == null) {
                throw new WebScriptException(
                        Status.STATUS_BAD_REQUEST, "Unknown scheme name: " + schemeName);
            }
            ...
            String ratedNodeUrl =
                    MessageFormat.format(NODE_RATINGS_URL_FORMAT, ratedNodeUrlFragment);
