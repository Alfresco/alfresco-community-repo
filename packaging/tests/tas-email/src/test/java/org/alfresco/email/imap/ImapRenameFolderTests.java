...
public class ImapRenameFolderTests extends EmailTest {
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE })
  public void collaboratorShouldNotRenameFolderCreatedByOtherUser()
    throws Exception {
    UserModel collaboratorUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(testUser)
  ...
  public void contributorShouldRenameFolderCreatedBySelf() throws Exception {
    ...
    testFolder =
      dataContent.usingUser(contributorUser).usingSite(testSite).createFolder();
    String newFolderName = RandomData.getRandomName("Folder");
    imapProtocol
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE })
  public void contributorShouldNotRenameFolderCreatedByOtherUser()
    throws Exception {
    UserModel contributorUser = dataUser.usingAdmin().createRandomTestUser();
    dataUser
      .usingUser(testUser)
    ...
    FolderModel testFolder = dataContent
      .usingUser(testUser)
      .usingSite(testSite)
      .createFolder();
    String newFolderName = RandomData.getRandomName("Folder");
  ...
  public void consumerShouldNotRenameFolderCreatedByOtherUser()
    throws Exception {
    UserModel consumer = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(consumer, testSite, UserRole.SiteConsumer);
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL })
  public void userCanRenameFolderToAFolderThatContainsWhiteSpaces()
    throws Exception {
    FolderModel testFolder = FolderModel.getRandomFolderModel();
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL })
  public void userCannotRenameFolderWithNameThatContainsRestrictedCharacters()
    throws Exception {
    FolderModel testFolder = FolderModel.getRandomFolderModel();
