...
public class CustomModelServiceImpl implements CustomModelService {
  ...
  private static final Log logger = LogFactory.getLog(
    CustomModelServiceImpl.class
  );

  public static final String DEFAULT_CUSTOM_MODEL_ASPECT =
    "hasAspect('cmm:customModelManagement')";

  public static final QName ASPECT_CUSTOM_MODEL = QName.createQName(
    "http://www.alfresco.org/model/custommodelmanagement/1.0",
    "customModelManagement"
  );
  ...
  public static final String GROUP_ALFRESCO_MODEL_ADMINISTRATORS_AUTHORITY =
    PermissionService.GROUP_PREFIX + ALFRESCO_MODEL_ADMINISTRATORS_AUTHORITY;

  public static final String SHARE_EXT_MODULE_SUFFIX = "_module.xml";

  /** Messages */
  private static final String MSG_NAME_ALREADY_IN_USE =
    "cmm.service.name_already_in_use";
  private static final String MSG_CREATE_MODEL_ERR =
    "cmm.service.create_model_err";
  private static final String MSG_UPDATE_MODEL_ERR =
    "cmm.service.update_model_err";
  private static final String MSG_MULTIPLE_MODELS =
    "cmm.service.multiple_models";
  private static final String MSG_RETRIEVE_MODEL = "cmm.service.retrieve_model";
  private static final String MSG_MODEL_NOT_EXISTS =
    "cmm.service.model_not_exists";
  private static final String MSG_NAMESPACE_NOT_EXISTS =
    "cmm.service.namespace_not_exists";
  private static final String MSG_NAMESPACE_MANY_EXIST =
    "cmm.service.namespace_many_exist";
  private static final String MSG_NAMESPACE_URI_ALREADY_IN_USE =
    "cmm.service.namespace_uri_already_in_use";
  private static final String MSG_NAMESPACE_PREFIX_ALREADY_IN_USE =
    "cmm.service.namespace_prefix_already_in_use";
  private static final String MSG_UNABLE_DELETE_ACTIVE_MODEL =
    "cmm.service.unable_delete_active_model";
  private static final String MSG_UNABLE_MODEL_DELETE =
    "cmm.service.unable_model_delete";
  private static final String MSG_UNABLE_MODEL_DEACTIVATE =
    "cmm.service.unable_model_deactivate";
  private static final String MSG_UNABLE_MODEL_ACTIVATE =
    "cmm.service.unable_model_activate";
  private static final String MSG_INVALID_MODEL = "cmm.service.invalid_model";
  private static final String MSG_NAMESPACE_ACTIVE_MODEL =
    "cmm.service.namespace_active_model";
  private static final String MSG_FAILED_DEACTIVATION_TYPE_DEPENDENCY =
    "cmm.service.failed.deactivation.type.dependency";
  private static final String MSG_FAILED_DEACTIVATION_ASPECT_DEPENDENCY =
    "cmm.service.failed.deactivation.aspect.dependency";
  private static final String MSG_DOWNLOAD_COPY_MODEL_ERR =
    "cmm.service.download.create_model_copy_err";
  private static final String MSG_DOWNLOAD_CREATE_SHARE_EXT_ERR =
    "cmm.service.download.create_share_ext_err";
  ...
  public void setRepositoryModelsLocation(
    RepositoryLocation repoModelsLocation
  ) {
  ...
  public NodeRef getModelNodeRef(String modelName) {
    ...
    builder
      .append(repoModelsLocation.getPath())
      .append("//.[@cm:name='")
      .append(modelName)
      .append("' and ")
      .append(RepoAdminServiceImpl.defaultSubtypeOfDictionaryModel)
      .append(']');
  ...
  public CustomModelDefinition getCustomModel(String modelName) {
    ...
    Pair<CompiledModel, Boolean> compiledModelPair = getCustomCompiledModel(
      modelName
    );
    CustomModelDefinition result = (compiledModelPair == null)
      ? null
      : new CustomModelDefinitionImpl(
        compiledModelPair.getFirst(),
        compiledModelPair.getSecond(),
        dictionaryService
      );
  ...
  private CompiledModel getModelByUri(String uri) {
    for (CompiledModel model : getAllCustomM2Models(false)) {
      if (
        uri.equals(getModelNamespaceUriPrefix(model.getM2Model()).getFirst())
      ) {
        return model;
      }
    }
   ...
   */
  protected Pair<CompiledModel, Boolean> getCustomCompiledModel(
    String modelName
  ) {
    ParameterCheck.mandatoryString("modelName", modelName);
    ...
    M2Model model = null;
    final boolean isActive = Boolean.TRUE.equals(
      nodeService.getProperty(modelNodeRef, ContentModel.PROP_MODEL_ACTIVE)
    );
    if (isActive) {
      QName modelQName = (QName) nodeService.getProperty(
        modelNodeRef,
      ...
      try {
        CompiledModel compiledModel = dictionaryDAO.getCompiledModel(
          modelQName
        );
    ...
    Pair<CompiledModel, Boolean> result = (model == null)
      ? null
      : new Pair<>(compileModel(model), isActive);

    return result;
  }

  @Override
  public PagingResults<CustomModelDefinition> getCustomModels(
    ...
    return result.isEmpty()
      ? new EmptyPagingResults<CustomModelDefinition>()
  ...
  protected List<CustomModelDefinition> getAllCustomModels() {
    ...
    if (compiledModels.size() > 0) {
      for (CompiledModel model : compiledModels) {
        ...
        result.add(
          new CustomModelDefinitionImpl(model, isActive, dictionaryService)
        );
      }
    }
  ...
  private List<CompiledModel> getAllCustomM2Models(boolean onlyInactiveModels) {
    ...
    builder
      .append(repoModelsLocation.getPath())
      .append(RepoAdminServiceImpl.CRITERIA_ALL)
      .append("[(")
      .append(RepoAdminServiceImpl.defaultSubtypeOfDictionaryModel)
      .append(" and ")
  ...
  @Override
  public PagingResults<AspectDefinition> getAllCustomAspects(
    PagingRequest pagingRequest
  ) {
    ParameterCheck.mandatory("pagingRequest", pagingRequest);
  ...
  @Override
  public PagingResults<TypeDefinition> getAllCustomTypes(
    PagingRequest pagingRequest
  ) {
    ParameterCheck.mandatory("pagingRequest", pagingRequest);
  ...
  @Override
  public CustomModelDefinition createCustomModel(
    M2Model m2Model,
    boolean activate
  ) {
    ...
    final String modelFileName = (colonIndex == -1)
      ? modelName
      : modelName.substring(colonIndex + 1);

    if (isModelExists(modelFileName)) {
      throw new CustomModelException.ModelExistsException(
        MSG_NAME_ALREADY_IN_USE,
    ...
    validateModelNamespacePrefix(
      getModelNamespaceUriPrefix(m2Model).getSecond()
    );

    // Return the created model definition
    CompiledModel compiledModel = createUpdateModel(
      modelFileName,
      m2Model,
      activate,
      MSG_CREATE_MODEL_ERR,
      false
    );
    CustomModelDefinition modelDef = new CustomModelDefinitionImpl(
      compiledModel,
      activate,
      dictionaryService
    );
  ...
  public CustomModelDefinition updateCustomModel(
    ...
    if (existingModelNodeRef == null) {
      throw new CustomModelException.ModelDoesNotExistException(
        MSG_MODEL_NOT_EXISTS,
        new Object[] { modelFileName }
      );
    }
    ...
    final boolean isActive = Boolean.TRUE.equals(
      nodeService.getProperty(
        existingModelNodeRef,
        ContentModel.PROP_MODEL_ACTIVE
      )
    );
    final M2Model existingModel = getM2Model(existingModelNodeRef);
    final Pair<String, String> existingNamespacePair = getModelNamespaceUriPrefix(
      existingModel
    );
    // New model namespace uri-prefix pair
    final Pair<String, String> newNamespacePair = getModelNamespaceUriPrefix(
      m2Model
    );

    if (isActive && !(existingNamespacePair.equals(newNamespacePair))) {
      throw new CustomModelException.ActiveModelConstraintException(
        MSG_NAMESPACE_ACTIVE_MODEL
      );
    }

    // if the prefix has changed, then check the new prefix is not in use.
    if (
      !existingNamespacePair.getSecond().equals(newNamespacePair.getSecond())
    ) {
  ...
  private CompiledModel createUpdateModel(
    final String modelFileName,
    final M2Model m2Model,
    ...
    NodeRef nodeRef = doInTransaction(
      errMsgId,
      requiresNewTx,
      new RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Exception {
          return repoAdminService.deployModel(
            modelStream,
            modelFileName,
            activate
          );
  ...
  private void validatePropsDefaultValues(CompiledModel compiledModel) {
    for (PropertyDefinition propertyDef : compiledModel.getProperties()) {
      if (
        propertyDef.getDefaultValue() != null &&
        propertyDef.getConstraints().size() > 0
      ) {
        for (ConstraintDefinition constraintDef : propertyDef.getConstraints()) {
          ...
          try {
            ...
            String message = getRootCauseMsg(
              ex,
              false,
  ...
  public CompiledModel compileModel(M2Model m2Model) {
    try {
      ...
      if (cause instanceof DuplicateDefinitionException) {
        ...
        throw new CustomModelException.InvalidCustomModelException(
          MSG_INVALID_MODEL,
          new Object[] { message },
          ex
        );
  ...
  protected <T> PagingResults<T> wrapResult(
    PagingRequest pagingRequest,
    List<T> result
  ) {
  ...
  public boolean isModelAdmin(String userName) {
    ...
    return (
      ...
      this.authorityService.getAuthoritiesForUser(userName)
        .contains(GROUP_ALFRESCO_MODEL_ADMINISTRATORS_AUTHORITY)
    );
  }
    ...
    for (CompiledModel cm : getAllCustomM2Models(false)) {
      ...
      if (
        !customModelDefinition
          .getName()
          .equals(cm.getModelDefinition().getName())
      ) {
  ...
  private void validateTypeAspectDependency(
    Collection<? extends ClassDefinition> parentDefs,
      ...
      for (ClassDefinition childClassDef : childDefs) {
        if (parentClassDef.getName().equals(childClassDef.getParentName())) {
          Object[] msgParams = new Object[] {
            parentClassDef.getName().toPrefixString(),
          ...
          if (parentClassDef instanceof TypeDefinition) {
            throw new CustomModelException.CustomModelConstraintException(
              MSG_FAILED_DEACTIVATION_TYPE_DEPENDENCY,
              msgParams
            );
          } else {
            throw new CustomModelException.CustomModelConstraintException(
              MSG_FAILED_DEACTIVATION_ASPECT_DEPENDENCY,
              msgParams
            );
          }
        }
  ...
  public void deleteCustomModel(String modelName) {
    ...
    final boolean isActive = Boolean.TRUE.equals(
      nodeService.getProperty(nodeRef, ContentModel.PROP_MODEL_ACTIVE)
    );
    if (isActive) {
      throw new CustomModelException.ActiveModelConstraintException(
        MSG_UNABLE_DELETE_ACTIVE_MODEL
      );
    }
    try {
  ...
  public boolean isNamespaceUriExists(String modelNamespaceUri) {
    ...
    for (CompiledModel model : getAllCustomM2Models(false)) {
      if (
        modelNamespaceUri.equals(
          getModelNamespaceUriPrefix(model.getM2Model()).getFirst()
        )
      ) {
        return true;
      }
  ...
  public boolean isNamespacePrefixExists(String modelNamespacePrefix) {
    ...
    for (CompiledModel model : getAllCustomM2Models(false)) {
      if (
        modelNamespacePrefix.equals(
          getModelNamespaceUriPrefix(model.getM2Model()).getSecond()
        )
      ) {
        return true;
      }
  ...
  public boolean isNamespacePrefixExists(NodeRef modelNodeRef) {
    ...
    String modelNamespacePrefix = getModelNamespaceUriPrefix(m2Model)
      .getSecond();
    ...
    for (CompiledModel model : getAllCustomM2Models(false)) {
      ...
      String existingPrefix = getModelNamespaceUriPrefix(existingModel)
        .getSecond();
      if (modelNamespacePrefix.equals(existingPrefix)) {
        ...
        NodeRef existingModelNodeRef = getModelNodeRef(
          model.getModelDefinition().getName().getLocalName()
        );
  ...
  public Pair<String, String> getModelNamespaceUriPrefix(M2Model model) {
    ...
    if (namespaces.isEmpty()) {
      throw new CustomModelException.InvalidNamespaceException(
        MSG_NAMESPACE_NOT_EXISTS,
        new Object[] { model.getName() }
      );
    }
    if (namespaces.size() > 1) {
      throw new CustomModelException.InvalidNamespaceException(
        MSG_NAMESPACE_MANY_EXIST,
        new Object[] { model.getName() }
      );
    }
  ...
  private void validateModelNamespaceUri(String uri) {
    if (isNamespaceUriExists(uri)) {
      throw new CustomModelException.NamespaceConstraintException(
        MSG_NAMESPACE_URI_ALREADY_IN_USE,
        new Object[] { uri }
      );
    }
  }
  ...
  public void validateModelNamespacePrefix(String prefix) {
    if (isNamespacePrefixExists(prefix)) {
      throw new CustomModelException.NamespaceConstraintException(
        MSG_NAMESPACE_PREFIX_ALREADY_IN_USE,
        new Object[] { prefix }
      );
    }
  }
   ...
   */
  private <R> R doInTransaction(
    String errMsgId,
    boolean requiresNewTx,
    RetryingTransactionCallback<R> cb
  ) {
    try {
  ...
  private static String getRootCauseMsg(
    Throwable cause,
    boolean withAlfLogNum,
    String defaultMsg
  ) {
    if (defaultMsg == null) {
      defaultMsg = "";
    ...
    if (message == null) {
      ...
      return (
        (withAlfLogNum) ? message : message.replaceFirst("\\d+", "").trim()
      );
    }
  }

  @Override
  public NodeRef createDownloadNode(
    final String modelFileName,
    ...
    if (withAssociatedForm) {
      ...
      try {
        ...
        StringBuilder msg = new StringBuilder();
        msg
          .append("Constructing CMM zip file containing only the model [")
          .append(modelFileName)
          .append(
            ".xml] without its associated share extension module, because: "
          )
      ...
      if (logger.isDebugEnabled()) {
        StringBuilder msg = new StringBuilder();
        msg
          .append("Temp node created for download: Custom model nodeRef [")
          .append(customModelNodeRef)
          .append(']');
        logger.debug(msg.toString());
      }
    ...
    try {
      NodeRef archiveNodeRef = downloadService.createDownload(
        nodesToBeDownloaded.toArray(new NodeRef[nodesToBeDownloaded.size()]),
        false
      );
      ...
      if (logger.isDebugEnabled()) {
        StringBuilder msg = new StringBuilder();
        msg
          .append("Created download nodeRef [")
          .append(archiveNodeRef)
          .append(']');
        logger.debug(msg.toString());
      }
  ...
  protected NodeRef createCustomModelShareExtModuleRef(final String modelName) {
    ...
    if (reader == null) {
      throw new CustomModelException(
        "cmm.service.download.share_ext_node_read_err"
      );
    }
    ...
    try {
      ...
      final String xpathQuery =
        "/extension//modules//module//id[.= '" + moduleId + "']";

      XPath xPath = XPathFactory.newInstance().newXPath();
      XPathExpression expression = xPath.compile(xpathQuery);

      moduleIdXmlNode =
        (Node) expression.evaluate(document, XPathConstants.NODE);
    } catch (Exception ex) {
      throw new CustomModelException(
        "cmm.service.download.share_ext_file_parse_err",
        ex
      );
    }
    ...
    if (moduleIdXmlNode == null) {
      throw new CustomModelException(
        "cmm.service.download.share_ext_module_not_found",
        new Object[] { moduleId }
      );
    }
    ...
    try {
      ...
      throw new CustomModelException(
        "cmm.service.download.share_ext_write_err",
        new Object[] { moduleId },
        error
      );
    }
    ...
    return doInTransaction(
      MSG_DOWNLOAD_CREATE_SHARE_EXT_ERR,
      true,
      new RetryingTransactionCallback<NodeRef>() {
        @Override
        public NodeRef execute() throws Exception {
          final NodeRef nodeRef = createDownloadTypeNode(
            moduleId + SHARE_EXT_MODULE_SUFFIX
          );
  ...
  protected NodeRef getShareExtModule() {
    ...
    if (results.isEmpty()) {
      throw new CustomModelException(
        "cmm.service.download.share_ext_file_not_found"
      );
    }
   ...
   * @return the created nodeRef
   */
  protected NodeRef createCustomModelCopy(
    final String newName,
    final NodeRef modelNodeRef
  ) {
    return doInTransaction(
  ...
  private NodeRef createDownloadTypeNode(final String name) {
    final NodeRef newNodeRef = nodeService
      .createNode(
    ...
    nodeService.addAspect(
      newNodeRef,
      ContentModel.ASPECT_INDEX_CONTROL,
      aspectProperties
    );
  ...
  public CustomModelsInfo getCustomModelsInfo() {
    List<CustomModelDefinition> page = getCustomModels(
