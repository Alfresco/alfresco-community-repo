...
public class SiteServiceImplMoreTest {
  ...
  public static TemporarySites STATIC_TEST_SITES = new TemporarySites(
    APP_CONTEXT_INIT
  );

  // Tie them together in a static Rule Chain
  @ClassRule
  public static RuleChain staticRuleChain = RuleChain
    .outerRule(APP_CONTEXT_INIT)
    .around(STATIC_TEST_SITES);

  public RunAsFullyAuthenticatedRule runAllTestsAsAdmin = new RunAsFullyAuthenticatedRule(
    AuthenticationUtil.getAdminUserName()
  );
  public TemporarySites perMethodTestSites = new TemporarySites(
    APP_CONTEXT_INIT
  );
  ...
  public static void initStaticData() throws Exception {
    ...
    LOCK_SERVICE =
      APP_CONTEXT_INIT
        .getApplicationContext()
        .getBean("lockService", LockService.class);
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          PagingResults<SiteInfo> sites = SITE_SERVICE.listSites(
            null,
            null,
            new PagingRequest(0, 1024)
          );
          ...
          assertNotNull(
            "subtype of st:site missing.",
            sitesByName.get(TEST_SUB_SITE_NAME)
          );
  ...
  public void deleteSiteDeleteAuthoritiesAndRestoreEnsuringSiteGroupsWasRecreated()
    ...
    final Map<String, String> membersBefore = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Map<String, String>>() {
        public Map<String, String> execute() throws Throwable {
          ...
          Map<String, String> membersBefore = SITE_SERVICE.listMembers(
            siteShortName,
            null,
            null,
            0,
          ...
          // delete authorities
          Set<String> permissions = PERMISSION_SERVICE.getSettablePermissions(
            SiteModel.TYPE_SITE
          );
          for (String permission : permissions) {
            String prefixSiteRoleGroup = siteServiceImpl.getSiteRoleGroup(
              siteShortName,
              permission,
              true
            );

            Set<String> groupUsers = AUTHORITY_SERVICE.getContainedAuthorities(
              null,
              prefixSiteRoleGroup,
              true
            );
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          for (String permission : permissions) {
            String permissionGroupShortName = siteServiceImpl.getSiteRoleGroup(
              siteShortName,
              permission,
              false
            );
            String authorityName = AUTHORITY_SERVICE.getName(
              AuthorityType.GROUP,
          ...
          final NodeRef archivedSiteNode = NODE_ARCHIVE_SERVICE.getArchivedNode(
            testSiteAndMemberInfo.siteInfo.getNodeRef()
          );
          RestoreNodeReport report = NODE_ARCHIVE_SERVICE.restoreArchivedNode(
            archivedSiteNode
          );
          // ...which should work
          assertEquals(
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Map<String, String>>() {
        public Map<String, String> execute() throws Throwable {
          ...
          Map<String, String> members = SITE_SERVICE.listMembers(
            siteShortName,
            null,
            null,
            0,
          ...
          for (Map.Entry<String, String> entry : SITE_SERVICE
          ...
          for (String role : SITE_SERVICE.getSiteRoles()) {
            final String siteGroup = SITE_SERVICE.getSiteRoleGroup(
              siteShortName,
              role
            );
            assertTrue(
          ...
          Set<String> currentManagers = AUTHORITY_SERVICE.getContainedAuthorities(
            AuthorityType.USER,
   ...
   */
  @Test
  public void deleteSiteDeleteAuthoritiesAndRestoreEnsuringLocksAreRestored()
    throws Exception {
    ...
    NodeRef siteContainer = SITE_SERVICE.createContainer(
      siteShortName,
      componentId,
    ...
    ContentWriter writer2 = FILE_FOLDER_SERVICE.getWriter(
      fileInfo2.getNodeRef()
    );
    ...
    ContentWriter writer3 = FILE_FOLDER_SERVICE.getWriter(
      fileInfo3.getNodeRef()
    );
    ...
    assertEquals(
      LockStatus.NO_LOCK,
      LOCK_SERVICE.getLockStatus(fileInfo.getNodeRef())
    );
    ...
    checkThatNonMembersCanNotCreateFiles(
      userCollaborator,
      fileFolderPrefix,
      folder2Info
    );
    ...
    ContentWriter writer4 = FILE_FOLDER_SERVICE.getWriter(
      fileInfoForCollaboratorUser.getNodeRef()
    );
    ...
    ContentWriter writerEO = FILE_FOLDER_SERVICE.getWriter(
      fileEditOffline.getNodeRef()
    );
    ...
    assertEquals(
      LockStatus.NO_LOCK,
      LOCK_SERVICE.getLockStatus(fileEditOffline.getNodeRef())
    );
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          NodeRef workingCopy = COCI_SERVICE.checkout(
            fileEditOffline.getNodeRef()
          );
  ...
  private void checkThatNonMembersCanNotCreateFiles(
    ...
    try {
      ...
      ContentWriter writer3_user2 = FILE_FOLDER_SERVICE.getWriter(
        fileInfoForTestNewFileAsAnotherUser.getNodeRef()
      );
      writer3_user2.putContent(
        "Just some old content that doesn't mean anything"
      );
   ...
   */
  @Test
  public void deleteSiteAndRestoreEnsuringSiteGroupsAreRecovered()
    throws Exception {
    ...
    final TestData testData = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<TestData>() {
        public TestData execute() throws Throwable {
          ...
          ChildAssociationRef testDoc = NODE_SERVICE.createNode(
          ...
          assertTrue(
            ...
            PERMISSION_SERVICE.getAllSetPermissions(testDocNodeRef).isEmpty()
          );
          ...
          for (String permission : permissions) {
            String siteRoleGroup = SITE_SERVICE.getSiteRoleGroup(
              siteShortName,
              permission
            );
          ...
          for (String role : SITE_SERVICE.getSiteRoles()) {
            ...
            userNameToRoleMap.putAll(
              SITE_SERVICE.listMembers(siteShortName, null, role, 0, true)
            );
          }

          // Some sanity checking before we delete the site
          final String siteContributorGroup = SITE_SERVICE.getSiteRoleGroup(
            siteShortName,
            "SiteContributor"
          );
          assertTrue(
          ...
          assertEquals(
            "Site contributor user did not have expected Contributor role",
    ...
    final Map<String, String> associatedGroups = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Map<String, String>>() {
        public Map<String, String> execute() throws Throwable {
          // The site itself should have been restored, of course...
          assertTrue(
          ...
          Set<AccessPermission> accessPermissions = PERMISSION_SERVICE.getAllSetPermissions(
          ...
          for (String permission : permissions) {
            ...
            assertTrue(
              "all groups should have the permissions from a contributor on test content",
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          List<Pair<SiteService.SortFields, Boolean>> sortProps = new ArrayList<Pair<SiteService.SortFields, Boolean>>(
            1
          );
          sortProps.add(
            new Pair<SiteService.SortFields, Boolean>(
              SiteService.SortFields.FirstName,
              true
            )
          );
          PagingResults<SiteMembership> pagedMembers = SITE_SERVICE.listMembersPaged(
            siteShortName,
            true,
            sortProps,
  ...
  public void testSiteGroupsPaged() {
    ...
    TRANSACTION_HELPER.doInTransaction(() -> {
      ...
      sortProps.add(
        new Pair<SiteService.SortFields, Boolean>(
          SiteService.SortFields.DisplayName,
          true
        )
      );
      PagingResults<SiteGroupMembership> pagedMembers = SITE_SERVICE.listGroupMembersPaged(
        siteShortName,
        sortProps,
        new PagingRequest(5)
      );
  ...
  public void testSiteMembersPagedV2() {
    ...
    TRANSACTION_HELPER.doInTransaction(() -> {
      ...
      List<SiteMembership> users = pagedMembers
        .getPage()
        .stream()
        .filter(member -> !member.isMemberOfGroup())
        .collect(Collectors.toList());
      List<SiteMembership> groupsUsers = pagedMembers
        .getPage()
        .stream()
  ...
  public void testSiteRolesPermissionsToDeleteWorkingCopy() throws Exception {
    ...
    final String siteShortName =
      userPrefix + "Site" + System.currentTimeMillis();
    ...
    final FileInfo fileInfo1 = FILE_FOLDER_SERVICE.create(
      siteContainer,
      "fileInfo1.txt",
      ContentModel.TYPE_CONTENT
    );
    ContentWriter writer1 = FILE_FOLDER_SERVICE.getWriter(
      fileInfo1.getNodeRef()
    );
    writer1.putContent(dummyContent);

    final FileInfo fileInfo2 = FILE_FOLDER_SERVICE.create(
      siteContainer,
      "fileInfo2.txt",
      ContentModel.TYPE_CONTENT
    );
    ...
    final FileInfo fileInfo3 = FILE_FOLDER_SERVICE.create(
      siteContainer,
      "fileInfo3.txt",
      ContentModel.TYPE_CONTENT
    );
  ...
  public void deleteSiteRestoreSiteWithLocks() throws Exception {
    ...
    PolicyComponent policyComponent = (PolicyComponent) APP_CONTEXT_INIT
      .getApplicationContext()
  ...
  private void assertThatArchivedNodeExists(
    NodeRef originalNodeRef,
    String failureMsg
  ) {
    final NodeRef archivedNodeRef = NODE_ARCHIVE_SERVICE.getArchivedNode(
      originalNodeRef
    );
  ...
  public static class TestData {
    ...
    public TestData(
      Map<String, String> userNameToRoleMap,
      NodeRef testDocNodeRef
    ) {
  ...
  public void testListMembershipOnSitesDifferentCase() throws Exception {
    ...
    final String secondSiteShortName =
      "testsite2-" + System.currentTimeMillis();

    log.debug(
      "Creating test sites called: " + siteShortName + " " + secondSiteShortName
    );
    ...
    List<SiteMembership> members = SITE_SERVICE.listSiteMemberships(
      userSiteCollaborator,
      0
    );
    ...
    assertEquals(
      secondSiteShortName,
      members.get(0).getSiteInfo().getShortName()
    );
