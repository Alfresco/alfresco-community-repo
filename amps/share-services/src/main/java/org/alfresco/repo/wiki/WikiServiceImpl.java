...
public class WikiServiceImpl implements WikiService {
    ...
    private WikiPageInfo buildPage(
            NodeRef nodeRef, NodeRef container, String name, String preLoadedContents) {
    ...
    public WikiPageInfo updateWikiPage(WikiPageInfo page) {
        ...
        if (page.getNodeRef() == null) {
            throw new IllegalArgumentException(
                    "Can't update a page that was never persisted, call create instead");
        }
        ...
        if (!nodeService.getProperty(nodeRef, ContentModel.PROP_TITLE).equals(page.getTitle())) {
            try {
                ...
                throw new AlfrescoRuntimeException(
                        "Invalid node state - wiki page no longer found");
            }
    ...
    @Override
    public PagingResults<WikiPageInfo> listWikiPagesByModified(
            String siteShortName, Date from, Date to, PagingRequest paging) {
    ...
    public PagingResults<WikiPageInfo> listWikiPages(
        ...
        CannedQuerySortDetails sorting =
    ...
    /** Our class to wrap up paged results of NodeBackedEntities as WikiPageInfo instances */
    private PagingResults<WikiPageInfo> wrap(
