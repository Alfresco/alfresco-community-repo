...
public class GetChildrenTests extends CmisTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non site member cannot get children for a folder from a private site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non site member cannot get children for a folder from a moderated site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
