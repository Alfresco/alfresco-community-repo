...
public class ExtendedSecurityServiceImplUnitTest
{
    ...
    public void before()
    {
        ...
        Stream
                ...
                .forEach((a) -> when(mockedAuthorityService.authorityExists(a))
                        .thenReturn(true));
    ...
    /**
     * Given that there is no IPR read group has read on a node When checking for the existence of extended permissions on that node Then it will be denied
     */
    @Test
    ...
    /**
     * Given that there is no IPR write group has read on a node When checking for the existence of extended permissions on that node Then it will be denied
     */
    @Test
    ...
    /**
     * Given a node with no previous IPR groups assigned And no IPR group matching authorities When I add some read and write authorities Then new IPR groups are created And they are assigned to the node And they are added to the RM roles
     */
    @Test
    ...
    /**
     * Given a node with no previous IPR groups assigned And existing IPR groups matching When I add some read and write authorities Then the existing IPR groups are used And they are assigned to the node And do not not need to be re-added to the RM roles
     */
    @Test
    ...
    /**
     * Given a node with no previous IPR groups assigned And existing IPR groups matches existing has, but not exact match When I add some read and write authorities Then new groups are created And they are assigned to the node And added to the RM roles
     */
    @Test
    ...
    /**
     * Given a node with no previous IPR groups assigned And existing IPR groups matching, but found on second page of find results When I add some read and write authorities Then the existing IPR groups are used And they are assigned to the node And do not not need to be re-added to the RM roles
     */
    @Test
    ...
    /**
     * Given that a node already has extended security When I add extended security Then the existing extended security is replaced with the new extended security
     */
    @Test
    ...
    /**
     * Given that a node has renditions When I add extended security Then they are applied to the renditions
     */
    @Test
    ...
    /**
     * Given that a node has extended security When I remove the extended security Then the inplace groups permissions are removed
     */
    @Test
    ...
    /**
     * Given that node has renditions When I remove the extended security for a node Then the extended security is also removed from the renditions
     */
    @Test
