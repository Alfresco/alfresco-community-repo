...
/**
 * Content URL provider for file stores which allows routing content from a store to a selection of
 * filesystem volumes. Content is randomly distributed on configured volumes. Content URL format is
 * <b>store://volume/year/month/day/hour/minute/GUID.bin</b>, As {@link
 * TimeBasedFileContentUrlProvider TimeBasedFileContentUrlProvider} can be configured to include
 * provision for splitting data into buckets within <b>minute</b> range
 *
