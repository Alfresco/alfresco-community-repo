...
public class DeleteProcessFullTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user is NOT able to delete process started by him twice using REST API"
    ...
    public void deleteProcessByUserWhoStartedProcessTwice() throws Exception {
        process =
                restClient
                        .authenticateUser(userWhoAddsProcess)
                        .withWorkflowAPI()
        ...
        restClient
                ...
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_WAS_NOT_FOUND, process.getId()))
