...
public class AbstractCacheFactoryTest {
    ...
    public void nullPropertyYieldsDefault() {
        ...
        assertEquals(
                "non-empty-default",
                cacheFactory.getProperty("the.cache.name", "noProperty", "non-empty-default"));
    }
    ...
    public void emptyPropertyYieldsDefault() {
        ...
        assertEquals(
                "non-empty-default",
                cacheFactory.getProperty("the.cache.name", "emptyProperty", "non-empty-default"));

        // Empty/whitespace property
        properties.setProperty("the.cache.name.emptyProperty", "  \t  ");
        assertEquals(
                "default", cacheFactory.getProperty("the.cache.name", "emptyProperty", "default"));
    }
