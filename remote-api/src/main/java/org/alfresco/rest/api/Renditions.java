...
public interface Renditions {
    ...
    /**
     * Lists all available renditions includes those that have been created and those that are yet
     * to be created.
     *
     ...
     * @return the rendition results
     */
    CollectionWithPagingInfo<Rendition> getRenditions(
            NodeRef nodeRef, String versionId, Parameters parameters);

    /**
     * Gets information about a rendition of a node in the repository. If there is no rendition,
     * then returns the available/registered rendition.
     *
    ...
    Rendition getRendition(
            NodeRef nodeRef, String versionId, String renditionId, Parameters parameters);
    ...
    void createRendition(
            NodeRef nodeRef, Rendition rendition, boolean executeAsync, Parameters parameters);
     ...
     * @throws ConstraintViolatedException if all of the renditions already exist.
     */
    void createRenditions(
            NodeRef nodeRef, String versionId, List<Rendition> renditions, Parameters parameters)
            throws NotFoundException, ConstraintViolatedException;
     ...
     * @return the rendition stream
     */
    BinaryResource getContentNoValidation(
            NodeRef nodeRef, String renditionId, Parameters parameters);
    ...
    default DirectAccessUrl requestContentDirectUrl(
            String nodeId, String versionId, String renditionId, boolean attachment) {
     ...
     */
    default DirectAccessUrl requestContentDirectUrl(
            NodeRef nodeRef, String versionId, String renditionId, boolean attachment) {
     ...
     * @return a direct access {@code URL} object for the content.
     */
    DirectAccessUrl requestContentDirectUrl(
            NodeRef nodeRef,
            String versionId,
            String renditionId,
            boolean attachment,
