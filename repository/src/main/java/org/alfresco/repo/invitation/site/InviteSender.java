...
public abstract class InviteSender {
  ...
  protected abstract Map<String, Serializable> buildMailTextModel(
    Map<String, String> properties
  );
  ...
  protected void checkProperties(Map<String, String> properties) {
    ...
    if (!keys.containsAll(getRequiredProperties())) {
      LinkedList<String> missingProperties = new LinkedList<String>(
  ...
  protected String getSiteName(Map<String, String> properties) {
    ...
    if (site == null) throw new InvitationException(
      "The site " + siteFullName + " could not be found."
    );
