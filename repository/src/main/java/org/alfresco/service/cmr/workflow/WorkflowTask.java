 ...
 *
 * <p>Represents a human-oriented task within an "in-flight" workflow instance
 *
 * @author davidc
 */
@AlfrescoPublicApi
public class WorkflowTask {
    ...
    /** Task State */
    @Deprecated public WorkflowTaskState state;

    /** Workflow path this Task is associated with */
    @Deprecated public WorkflowPath path;

    /** Task Definition */
    @Deprecated public WorkflowTaskDefinition definition;

    /** Task Properties as described by Task Definition */
    @Deprecated public Map<QName, Serializable> properties;
