...
public class JavaBehaviour extends BaseBehaviour {
   ...
   */
  <T> InvocationHandler getInvocationHandler(
    Object instance,
    String method,
    Class<T> policyIF
  ) {
    ...
    try {
      ...
      Method delegateMethod = instanceClass.getMethod(
        method,
        (Class[]) policyIFMethods[0].getParameterTypes()
      );
  ...
  private static class JavaMethodInvocationHandler
     ...
     */
    private JavaMethodInvocationHandler(
      JavaBehaviour behaviour,
    ...
    public boolean equals(Object obj) {
      ...
      return (
        behaviour.instance.equals(other.behaviour.instance) &&
        delegateMethod.equals(other.delegateMethod)
      );
    }
    ...
    public String toString() {
      return (
        "JavaBehaviour[instance=" +
        behaviour.instance.hashCode() +
        ", method=" +
        delegateMethod.toString() +
        "]"
      );
    }
  }
