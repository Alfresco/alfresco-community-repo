...
/**
 * Default Content URL provider for file stores. Content URL format is
 * <b>store://year/month/day/hour/minute/GUID.bin</b>, but can be configured to include provision
 * for splitting data into buckets within <b>minute</b> range through bucketsPerMinute property :
 ...
 *   <li><b>bucket</b>: 0-based bucket depending second of minute
