...
public class UpdateSiteMemberTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify that collaborator is not able to update site member and gets status"
                            + " code FORBIDDEN (403)")
    public void collaboratorIsNotAbleToUpdateSiteMember() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                "The current user does not have permissions to modify the"
                                        + " membership details of the site %s.",
                                publicSite.getTitle()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that contributor is not able to update site member and gets status code"
                            + " FORBIDDEN (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that consumer is not able to update site member and gets status code"
                            + " FORBIDDEN (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin is able to update site member and gets status code OK (200)")
    public void adminIsAbleToUpdateSiteMember() throws Exception {
        ...
        restClient
                ...
                .updateSiteMember(userToBeUpdated)
                .assertThat()
                .field("id")
                .is(userToBeUpdated.getUsername())
                .and()
                .field("role")
                .is(userToBeUpdated.getUserRole());
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site member request returns status code 404 when nonexistent"
                            + " siteId is used")
    public void updateSiteMemberOfNonexistentSite() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(deletedSite)
                .updateSiteMember(regularUser);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, deletedSite.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site member request returns status code 400 when personId is"
    ...
    public void updateNotASiteMember() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary("User is not a member of the site");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site member request returns status code 404 when personId"
                            + " does not exist")
    public void updateNonexistentSiteMember() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSite)
                .updateSiteMember(nonexistentUser);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(
                                RestErrorModel.ENTITY_NOT_FOUND, nonexistentUser.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if a manager is able to downgrade to contributor using -me- string in"
                            + " place of personId.")
    public void updateSiteManagerToSiteContributorUsingMe() throws Exception {
        ...
        updatedMember =
                restClient
                        .authenticateUser(meManager)
                        .withCoreAPI()
                        .usingSite(publicSite)
                        .updateSiteMember(meUser);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        updatedMember
                .assertThat()
                .field("id")
                .is(meManager.getUsername())
                .and()
                .field("role")
                .is(meUser.getUserRole());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site member request returns status code 404 when empty siteId"
                            + " is used")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site member request returns status code 405 when empty"
                            + " personId is used")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if update site member request returns status code 400 when invalid role"
                            + " is used")
    public void updateSiteMemberUsingInvalidRole() throws Exception {
        ...
        RestRequest request =
                RestRequest.requestWithBody(
                        ...
                        publicSite.getId(),
                        siteConsumer.getUsername());
        restClient.processModel(RestSiteMemberModel.class, request);
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNKNOWN_ROLE, "invalidRole"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update another site manager to site collaborator")
    public void managerUpdateSiteManagerToSiteCollaborator() throws Exception {
        ...
        updatedMember =
                restClient
                        ...
                        .withCoreAPI()
                        .usingSite(publicSite)
                        .updateSiteMember(siteManager);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        updatedMember
                .assertThat()
                .field("id")
                .is(siteManager.getUsername())
                .and()
                .field("role")
                .is(siteManager.getUserRole());
    }
    ...
    public void managerUpdateSiteContributorToSiteManager() throws Exception {
        ...
        updatedMember =
                restClient
                        ...
                        .withCoreAPI()
                        .usingSite(publicSite)
                        .updateSiteMember(siteContributor);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        updatedMember
                .assertThat()
                .field("id")
                .is(siteContributor.getUsername())
                .and()
                .field("role")
                .is(siteContributor.getUserRole());
    }
    ...
    public void managerUpdateSiteCollaboratorToSiteManager() throws Exception {
        ...
        updatedMember =
                restClient
                        ...
                        .withCoreAPI()
                        .usingSite(publicSite)
                        .updateSiteMember(siteCollaborator);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        updatedMember
                .assertThat()
                .field("id")
                .is(siteCollaborator.getUsername())
                .and()
                .field("role")
                .is(siteCollaborator.getUserRole());
    }
    ...
    public void managerUpdateSiteConsumerToSiteManager() throws Exception {
        ...
        updatedMember =
                restClient
                        ...
                        .withCoreAPI()
                        .usingSite(publicSite)
                        .updateSiteMember(siteConsumer);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        updatedMember
                .assertThat()
                .field("id")
                .is(siteConsumer.getUsername())
                .and()
                .field("role")
                .is(siteConsumer.getUserRole());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update another site manager to site contributor")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update another site manager to site consumer")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update site contributor to site collaborator")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update site collaborator to site contributor")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update another site manager to site manager")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update site collaborator to site collaborator")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update site contributor to site contributor")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify the response of updating a site member with empty body at request")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if manager is able to update a user that has created a site membership"
                            + " request, but it's not a member of the site yet")
