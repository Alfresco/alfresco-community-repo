...
public class ActionImplTest extends BaseParameterizedItemImplTest {
  ...
  public void testSimpleProperties() {
    ...
    Action compensatingAction = new ActionImpl(
      null,
      GUID.generate(),
      "actionDefintionName",
      null
  ...
  public void testActionConditions() {
    ActionCondition cond1 = new ActionConditionImpl(
      ID_COND1,
      NAME_COND1,
      this.paramValues
    );
    ActionCondition cond2 = new ActionConditionImpl(
      ID_COND2,
      NAME_COND2,
      this.paramValues
    );
    ActionCondition cond3 = new ActionConditionImpl(
      ID_COND3,
      NAME_COND3,
      this.paramValues
    );
