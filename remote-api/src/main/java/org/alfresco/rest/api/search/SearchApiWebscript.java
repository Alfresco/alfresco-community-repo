...
public class SearchApiWebscript
  ...
  public void execute(
    ...
    try {
      ...
      SearchQuery searchQuery = extractJsonContent(
        webScriptRequest,
      ...
      SearchParameters searchParams = searchMapper.toSearchParameters(
        params,
        searchQuery,
      ...
      CollectionWithPagingInfo<Node> resultJson = resultMapper.toCollectionWithPagingInfo(
        params,
        searchRequestContext,
        searchQuery,
        results
      ...
      Object toRender = helper.processAdditionsToTheResponse(
        null,
        null,
        null,
        params,
