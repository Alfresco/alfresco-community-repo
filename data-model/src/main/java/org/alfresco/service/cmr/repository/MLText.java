 ...
 *
 * <p>The language codes used should conform to the <a
 * href="http://www.loc.gov/standards/iso639-2/php/English_list.php">ISO639-2</a> language code
 * standard, although there is no enforcement of the standard in this class.
 *
 * <p>This is a simple extension of a <code>HashMap</code> with a few convenience methods.
 *
...
public class MLText extends HashMap<Locale, String> {
     ...
     *
     * <ul>
     *   <li>An exact locale match
     *   <li>A match of locale ISO language codes
     *   <li>The value for the locale provided in the {@link MLText#MLText(Locale, String)
     *       constructor}
     *   <li>An arbitrary value
     *   <li><tt>null</tt>
     * </ul>
     *
     * @param locale the locale to use as the starting point of the value search
     * @return Returns a default <tt>String</tt> value or null if one isn't available. <tt>null</tt>
     *     will only be returned if there are no values associated with this instance. With or
     *     without a match, the return value may be <tt>null</tt>, depending on the values
     *     associated with the locales.
     */
