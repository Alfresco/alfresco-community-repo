...
public abstract class BaseWebScriptUnitTest extends BaseUnitTest {
   ...
   * @throws Exception
   */
  protected JSONObject executeJSONWebScript(Map<String, String> parameters)
    throws Exception {
   ...
   */
  protected JSONObject executeJSONWebScript(
   ...
   * @throws Exception
   */
  protected String executeWebScript(Map<String, String> parameters)
    throws Exception {
   ...
   */
  protected String executeWebScript(
    Map<String, String> parameters,
    String content
  ) throws Exception {
    ...
    webScript.execute(
      getMockedWebScriptRequest(webScript, parameters, content),
      mockedResponse
    );
  ...
  protected WebScriptRequest getMockedWebScriptRequest(
    AbstractWebScript webScript,
    final Map<String, String> parameters,
    String content
  ) throws Exception {
    Match match = new Match(null, parameters, null, webScript);
    org.springframework.extensions.webscripts.Runtime mockedRuntime = mock(
      org.springframework.extensions.webscripts.Runtime.class
    );
    ...
    String[] paramNames = (String[]) parameters
      .keySet()
  ...
  protected Container getMockedContainer(String template) throws Exception {
    ...
    ScriptProcessorRegistry mockedScriptProcessorRegistry = mock(
      ScriptProcessorRegistry.class
    );
    doReturn(null)
      .when(mockedScriptProcessorRegistry)
      .findValidScriptPath(anyString());

    TemplateProcessorRegistry mockedTemplateProcessorRegistry = mock(
      TemplateProcessorRegistry.class
    );
    doReturn(template)
      .when(mockedTemplateProcessorRegistry)
      .findValidTemplatePath(anyString());
    ...
    doReturn(mockedScriptProcessorRegistry)
    ...
    doReturn(mock(RequiredCache.class))
      .when(mockDescription)
      .getRequiredCache();
  ...
  protected People getMockedPeopleObject() {
    ...
    getMockedPeople()
      .forEach((name, person) -> when(p.getPerson(eq(name))).thenReturn(person)
      );
    return p;
  }
