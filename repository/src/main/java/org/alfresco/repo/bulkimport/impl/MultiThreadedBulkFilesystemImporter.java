...
public abstract class MultiThreadedBulkFilesystemImporter
  ...
  protected BatchProcessor.BatchProcessWorker<ImportableItem> getWorker(
    ...
    final int batchSize = bulkImportParameters.getBatchSize() != null
      ? bulkImportParameters.getBatchSize()
      : defaultBatchSize;
    ...
    BatchProcessor.BatchProcessWorker<ImportableItem> worker = new BatchProcessor.BatchProcessWorker<ImportableItem>() {
      ...
      public void process(final ImportableItem importableItem)
        throws Throwable {
          ...
          new TenantRunAsWork<Void>() {
            ...
            public Void doWork() throws Exception {
              try {
                ...
                NodeRef nodeRef = nodeImporter.importImportableItem(
                  importableItem,
                  bulkImportParameters.getExistingFileMode()
                );
