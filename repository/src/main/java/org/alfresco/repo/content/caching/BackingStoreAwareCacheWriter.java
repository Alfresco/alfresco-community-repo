...
/**
 * Wrapper for cache writer that is aware of backing store writer and calls backing store for
 * getSize and getContentData in case if cache file was deleted
 *
