...
public class SurfConfigTest extends AbstractSiteServiceTest {
    ...
    public void testSurfConfigPermissions() throws Exception {
        ...
        String owner =
                (String) nodeService.getProperty(surfConfigFolderRef, ContentModel.PROP_OWNER);
        ...
        Set<AccessPermission> permissions =
                permissionService.getAllSetPermissions(surfConfigFolderRef);
        ...
        PagingResults<FileInfo> pageResults =
        ...
        try {
            fileFolderService.list(
                    ...
                    new PagingRequest(CannedQueryPageDetails.DEFAULT_PAGE_SIZE));
            fail(
                    "USER_ONE is not the owner and he is no longer a site manager, so does not have"
