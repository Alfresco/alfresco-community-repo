...
public class GetAllVersionsTests extends CmisTest {
  ...
  public void siteManagerShouldGetAllVersionsForAValidDocument()
    throws Exception {
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void siteManagerShouldNotGetAllVersionsForADeletedDocument()
    throws Exception {
  ...
  public void siteManagerShouldGetAllVersionsWithOperationContextForADocument()
    throws Exception {
    ...
    cmisApi
      ...
      .usingResource(managerFile)
      .usingVersion()
      .getAllDocumentVersionsBy(context)
      .assertHasVersionsInOrder(2.0, 1.1, 1.0);
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerShouldGetAllVersionsForCheckedOutDocument()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void siteManagerShouldGetAllVersionsForPWCDocument() throws Exception {
    ...
    cmisApi
      ...
      .usingVersion()
      .getAllDocumentVersions()
      .assertHasVersions(1.1, 1.0, "pwc")
      .usingVersion()
      .getAllDocumentVersionsBy(context)
      .assertHasVersionsInOrder("pwc", 1.1, 1.0);
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanGetAllVersionsForDocumentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorCanGetAllVersionsForDocumentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void consumerCanGetAllVersionsForDocumentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void nonInvitedUserCannotGetAllVersionsForDocumentFromPublicSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotGetAllVersionsForDocumentFromPrivateSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotGetAllVersionsForDocumentFromModeratedSite()
    throws Exception {
    SiteModel moderated = dataSite
      .usingUser(siteManager)
      .createPrivateRandomSite();
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, documentContent);
