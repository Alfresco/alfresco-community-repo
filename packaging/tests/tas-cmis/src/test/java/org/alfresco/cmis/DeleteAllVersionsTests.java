...
public class DeleteAllVersionsTests extends CmisTest {
  ...
  public void siteManagerCannotDeleteAllVersionsOfInexistentFile()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
  ...
  public void siteManagerCanDeletePWCFileWithDeleteAllVersionsTrue()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void siteManagerCanDeletePWCFileWithDeleteAllVersionsFalse()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp = "^Could not delete/cancel checkout on the original checked out document$"
  )
  public void siteManagerCannotDeleteOriginalFileMultipleVersionWhenCheckedOut()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void contributorCannotDeleteDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void collaboratorCannotDeleteDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  public void collaboratorCannotDeleteFolderCreatedByManager()
    throws Exception {
    testFolder = new FolderModel(RandomData.getRandomName("Folder"));
    cmisApi
      .authenticateUser(testUser)
  ...
  public void unauthorizedUserCannotDeleteDocumentFromPrivateSite()
    throws Exception {
  ...
  public void unauthorizedUserCannotDeleteFolderFromPrivateSite()
    throws Exception {
    SiteModel privateSite = dataSite
      .usingUser(testUser)
      .createPrivateRandomSite();
  ...
  public void unauthorizedUserCannotDeleteDocumentFromModeratedSite()
    throws Exception {
  ...
  public void unauthorizedUserCannotDeleteFolderFromModeratedSite()
    throws Exception {
    SiteModel moderatedSite = dataSite
      .usingUser(testUser)
      .createModeratedRandomSite();
