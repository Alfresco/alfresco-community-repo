...
public class NodePermissionAssessorLimitsTest {
  ...
  @Test
  public void shouldNotAssessPermissionsWhenMaxPermissionCheckTimeIsUp()
    throws Exception {
  ...
  @Test
  public void shouldAssessPermissionsWhenMaxPermissionCheckTimeIsNotUp()
    throws Exception {
  ...
  private NodePermissionAssessor createAssessor() {
    ...
    NodePermissionAssessor assessor = spy(
