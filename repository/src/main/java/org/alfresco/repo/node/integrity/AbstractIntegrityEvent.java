...
public abstract class AbstractIntegrityEvent implements IntegrityEvent {
    ...
    /**
     * Compares based on the class of this instance and the incoming instance, before comparing
     * based on all the internal data. If derived classes store additional data for their
     * functionality, then they should override this.
     */
    @Override
    ...
    public String toString() {
        ...
        if (nodeRef != null) sb.append(", nodeRef=").append(nodeRef);
        if (typeQName != null) sb.append(", typeQName=").append(typeQName);
        if (qname != null) sb.append(", qname=").append(qname);
        sb.append("]");
        // done
        return sb.toString();
    }
    ...
    /**
     * Gets the association definition from the dictionary. If the source node type is provided then
     * the association particular to the subtype is attempted.
     *
     ...
     */
    protected AssociationDefinition getAssocDef(
            List<IntegrityRecord> eventResults, QName assocTypeQName) {
