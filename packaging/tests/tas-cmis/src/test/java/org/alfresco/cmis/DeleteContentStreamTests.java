...
public class DeleteContentStreamTests extends CmisTest {
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerCanDeleteDocContentWithRefreshFalse()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.HTML, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerDeletesContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorDeletesContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void contributorCannotDeleteContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void consumerCannotDeleteContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void unauthorizedUserCannotDeleteContentOfFileFromPrivateSite()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
    cmisApi
      .authenticateUser(siteManager)
