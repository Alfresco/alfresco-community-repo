...
public class RMCaveatConfigComponentImpl
  ...
  private static Log logger = LogFactory.getLog(
    RMCaveatConfigComponentImpl.class
  );
  ...
  public void setCaveatConfig(
    SimpleCache<String, Map<String, List<String>>> caveatConfig
  ) {
    ...
    if (cr != null) {
      ...
      if (caveatConfigData != null) {
        ...
        try {
          ...
          Map<String, Object> caveatConfigMap = JSONtoFmModel.convertJSONObjectToMap(
            caveatConfigData
          );
          ...
          throw new AlfrescoRuntimeException(
            "Invalid caveat config syntax: " + e
          );
        }
      }
    }
  ...
  private NodeRef getOrCreateCaveatConfig() {
    ...
    if (caveatConfig == null) {
      ...
      nodeService.addAspect(
        rootNode,
        VersionModel.ASPECT_VERSION_STORE_ROOT,
        null
      );
  ...
  public List<String> getRMAllowedValues(String constraintName) {
    ...
    if (
      ...
      Set<String> userGroupFullNames = authorityService.getAuthoritiesForUser(
        userName
      );
      allowedValues =
        getRMAllowedValues(userName, userGroupFullNames, constraintName);
    }
            ...
            if (
              ...
              for (ConstraintDefinition conDef : conDefs) {
                ...
                if (con instanceof RMListOfValuesConstraint) {
                  ...
                  Map<String, List<String>> caveatConstraintDef = caveatConfig.get(
                    conName
                  );
                  if (caveatConstraintDef == null) {
                    continue;
                  } else {
                    Set<String> userGroupNames = authorityService.getAuthoritiesForUser(
                      userName
                    );
                    List<String> allowedValues = getRMAllowedValues(
                      userName,
                      userGroupNames,
                      conName
                    );
                    ...
                    if (
                      propValues != null &&
                      !isAllowed(propValues, allowedValues, matchLogic)
                    ) {
   ...
   */
  public void addRMConstraintListValue(
    String listName,
   ...
   * @param authorityName
   */
  public void removeRMConstraintListAuthority(
    String listName,
    String authorityName
  ) {
    Map<String, List<String>> members = null;
  ...
  private String convertToJSONString(
    SimpleCache<String, Map<String, List<String>>> config
  ) {
  ...
  public RMConstraintInfo getRMConstraint(QName listQName) {
    ConstraintDefinition dictionaryDef = dictionaryService.getConstraint(
      listQName
    );
    if (dictionaryDef != null) {
      ...
      if (con instanceof RMListOfValuesConstraint) {
        ...
        List<String> allowedValues = AuthenticationUtil.runAs(
          new RunAsWork<List<String>>() {
            public List<String> doWork() {
