...
public class HttpAlfrescoContentReader extends AbstractContentReader {
    ...
    /**
     * Helper class to wrap the ticket creation in order to force propagation of the authentication
     * ticket around the cluster.
     *
     * @since 2.1
     * @author Derek Hulley
     */
    ...
    private void getInfoImpl() {
        ...
        try {
            ...
            String url =
                    HttpAlfrescoContentReader.generateURL(baseHttpUrl, contentUrl, ticket, true);
            ...
            if (statusCode == HttpServletResponse.SC_OK) {
                ...
                String responseLastModified =
                        method.getResponseHeader("alfresco.dr.lastModified").getValue();
                String responseMimetype =
                        method.getResponseHeader("alfresco.dr.mimetype").getValue();
                String responseEncoding =
                        method.getResponseHeader("alfresco.dr.encoding").getValue();
                ...
                if (statusCode == HttpServletResponse.SC_NO_CONTENT) {
                    ...
                    logger.error(
                            I18NUtil.getMessage(
                                    ERR_UNRECOGNIZED, baseHttpUrl, contentUrl, statusCode));
                    logger.error(I18NUtil.getMessage(ERR_CHECK_CLUSTER));
                }
                // Done
                if (logger.isDebugEnabled()) {
    ...
    protected ContentReader createReader() throws ContentIOException {
        return new HttpAlfrescoContentReader(
                transactionService, authenticationService, baseHttpUrl, getContentUrl());
    }

    @Override
    protected ReadableByteChannel getDirectReadableChannel() throws ContentIOException {
        RunAsWork<ReadableByteChannel> getChannelRunAs =
                new RunAsWork<ReadableByteChannel>() {
        ...
        try {
            ...
            String ticket =
                    transactionService
                            ...
                            .doInTransaction(ticketCallback, false, true);
            String url =
                    HttpAlfrescoContentReader.generateURL(baseHttpUrl, contentUrl, ticket, false);
    ...
    /**
     * A listener to ensure that the HTTP method gets closed when the content stream it is serving
     * to the reader is closed.
     *
     * @since 2.1
     * @author Derek Hulley
     */
    ...
    public static final String generateURL(
            String baseHttpUrl, String contentUrl, String ticket, boolean infoOnly) {
