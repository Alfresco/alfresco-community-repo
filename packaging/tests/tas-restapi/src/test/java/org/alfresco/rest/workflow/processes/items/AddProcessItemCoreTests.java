...
public class AddProcessItemCoreTests extends RestTest {
  ...
  public void addProcessItemByUserThatStartedTheProcess() throws Exception {
    ...
    processItem
      ...
      .and()
      .field("modifiedBy")
      .is(userWhoStartsProcess.getUsername())
      .and()
      .field("id")
      .isNotEmpty()
      .and()
      .field("mimeType")
      .is(document.getFileType().mimeType);
  }
  ...
  public void addMultipleProcessItemsByUserThatStartedTheProcess()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(userWhoStartsProcess)
    ...
    processItems =
      restClient
        .withWorkflowAPI()
        .usingProcess(processModel)
        .addProcessItems(document, document2);
    ...
    processItems
      ...
      .and()
      .field("mimeType")
      .is(document2.getFileType().mimeType);
  }
  ...
  public void addProcessItemByAnyUser() throws Exception {
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          RestErrorModel.ACCESS_INFORMATION_NOT_ALLOWED,
          processModel.getId()
        )
      );
  }
  ...
  public void failedAddingProcessItemIfInvalidProcessIdIsProvided()
    throws Exception {
    RestProcessModelsCollection processes = restClient
      .authenticateUser(adminUser)
      .withParams("maxItems=1")
      .withWorkflowAPI()
      .getProcesses();
    processModel =
      processes
        ...
        .getOneRandomEntry()
        .onModel();
    FileModel testDocument = dataContent
      .usingAdmin()
      .usingSite(siteModel)
      .createContent(DocumentType.TEXT_PLAIN);
  ...
  public void failedAddingMultipleProcessItemsIfInvalidProcessIdIsProvided()
    throws Exception {
    RestProcessModelsCollection processes = restClient
      .authenticateUser(adminUser)
      .withParams("maxItems=1")
    ...
    processItems =
      restClient
        .withWorkflowAPI()
        .usingProcess(processModel)
        .addProcessItems(testDocument, document);
    restClient
      .assertStatusCodeIs(HttpStatus.NOT_FOUND)
      .assertLastError()
      .containsSummary(
  ...
  public void failedAddingProcessItemIfInvalidItemBodyIsProvided()
    throws Exception {
  ...
  public void failedAddingMultipleProcessItemIfEmptyItemBodyIsProvided()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void failedAddingProcessItemIfIncompleteBodyIsProvided()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
