...
/**
 * Repository project tests using the main context alfresco/application-context.xml PLUS some
 * additional context. Tests marked as DBTests are automatically excluded and are run as part of
 * {@link AllDBTestsTestSuite}.
 */
@RunWith(Categories.class)
@Categories.ExcludeCategory({DBTests.class, NonBuildTests.class})
@Suite.SuiteClasses({
    // ----------------------------------------------------------------------
    // globalIntegrationTestContext [classpath:alfresco/application-context.xml,
    ...
    // ----------------------------------------------------------------------
    // virtualizationTestContext [classpath:**/virtualization-test-context.xml,
    // classpath:alfresco/application-context.xml]
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    // testSubscriptionsContext  [classpath:alfresco/application-context.xml,
    ...
    // ----------------------------------------------------------------------
    // openCmisContext [classpath:alfresco/application-context.xml,
    // classpath:opencmis/opencmistest-context.xml]
    // ----------------------------------------------------------------------
    org.alfresco.opencmis.OpenCmisLocalTest.class,

    // ----------------------------------------------------------------------
    // cacheTestContext [classpath:alfresco/application-context.xml,
