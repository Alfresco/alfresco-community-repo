...
public class ApplicationContextInitTest {
  ...
  public static final String[] dummySpringContexts = new String[] {
  ...
  public void ensureSpringContextWasInitedWithOverrides() throws Exception {
    ...
    assertNotNull(
      "Spring context did not contain expected bean.",
      APP_CONTEXT_INIT
    ...
    assertEquals(
      "Value from dummy1-context.xml",
      APP_CONTEXT_INIT
        .getApplicationContext()
        .getBean("testBean1", String.class)
    );

    // Bean from the second override context
    assertEquals(
      "Value from dummy2-context.xml",
      APP_CONTEXT_INIT
        .getApplicationContext()
        .getBean("testBean2", String.class)
    );
    ...
    assertEquals(
      ...
      APP_CONTEXT_INIT
        .getApplicationContext()
        .getBean("testBean1and2", String.class)
    );
  }
}
