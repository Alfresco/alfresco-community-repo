...
/**
 * Transfer Target. Definition of a remote target to transfer to, contains details such as its name
 * and address.
 *
 * @author Mark Rogers
 */
public interface TransferTarget {
    ...
    /**
     * The location of the transfer service on the target endpoint host Defaults to
     * "/alfresco/service/api/transfer", and this shouldn't typically need to change
     *
     * @return String
     */
