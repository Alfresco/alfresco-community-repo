...
public class ReferenceComparatorTest extends TestCase {
    ...
    private static final Reference TEST_REFERENCE_1 =
            new Reference(
                    Encodings.PLAIN.encoding,
                    Protocols.VIRTUAL.protocol,
                    new ClasspathResource("/some/class/path.js"));

    private static final Reference TEST_REFERENCE_2 =
            new Reference(
                    Encodings.PLAIN.encoding,
                    Protocols.VIRTUAL.protocol,
                    new ClasspathResource("/some/other/class/path.js"));

    private static final Reference TEST_REFERENCE_3 =
            new Reference(
                    Encodings.PLAIN.encoding,
                    Protocols.VIRTUAL.protocol,
