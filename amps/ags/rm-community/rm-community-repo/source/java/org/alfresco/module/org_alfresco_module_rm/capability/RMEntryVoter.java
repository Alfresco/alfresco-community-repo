...
public class RMEntryVoter extends RMSecurityCommon
    ...
    public void setAlfrescoTransactionSupport(
            AlfrescoTransactionSupport alfrescoTransactionSupport) {
    ...
    /**
     * @see
     *     net.sf.acegisecurity.vote.AccessDecisionVoter#supports(net.sf.acegisecurity.ConfigAttribute)
     */
    @Override
    ...
    /**
     * @see net.sf.acegisecurity.vote.AccessDecisionVoter#vote(net.sf.acegisecurity.Authentication,
    ...
    public int vote(
        ...
        try {
            ...
            List<ConfigAttributeDefinition> supportedDefinitions =
            ...
            if (!(object instanceof MethodInvocation)) {
                ...
                throw new AlfrescoRuntimeException(
                        "Passed object is not an instance of MethodInvocation as expected.");
            }
            ...
            // All present must vote to allow unless an explicit direction comes first (e.g.
            // RM_ALLOW)
            ...
            for (ConfigAttributeDefinition cad : supportedDefinitions) {
                ...
                if (cad.getTypeString().equals(ConfigAttributeDefinition.RM_DENY)) {
                    // log message
                    RMMethodSecurityInterceptor.addMessage(
                            "RM_DENY: check that a security policy has been set for this method");
                ...
                // RM_QUERY is a special case - the entry is allowed and filtering sorts out the
                // results
                // It is distinguished from RM_ALLOW so query may have additional behaviour in the
                // future
                ...
                else if (((cad.getParameters().get(0) != null)
                                && (cad.getParameters().get(0) >= invocation.getArguments().length))
                        || ((cad.getParameters().get(1) != null)
                        ...
                        case AccessDecisionVoter.ACCESS_DENIED:
                            {
                                // log message
                                RMMethodSecurityInterceptor.addMessage(
                                        "Policy " + cad.getPolicyName() + " denied.");
     ...
     */
    @SuppressWarnings("rawtypes")
    private List<ConfigAttributeDefinition> extractSupportedDefinitions(
            net.sf.acegisecurity.ConfigAttributeDefinition config) {
