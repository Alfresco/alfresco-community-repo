...
public class DispositionActionDefinitionDelete extends DispositionAbstractBase {
     ...
     */
    private void removeDispositionActionDefinitions(
            DispositionSchedule schedule, DispositionActionDefinition actionDef) {
        int index = actionDef.getIndex();
        List<DispositionActionDefinition> dispositionActionDefinitions =
                schedule.getDispositionActionDefinitions();
        for (DispositionActionDefinition dispositionActionDefinition :
            ...
            if (dispositionActionDefinition.getIndex() >= index) {
                getDispositionService()
                        .removeDispositionActionDefinition(schedule, dispositionActionDefinition);
            }
        }
    }
}
