 ...
 *
 * <p>A null content store produces ficticious content URLs. The DB is loaded with ficticious URLs.
...
public class ContentStoreCleanerScalabilityRunner extends Repository {
    private VmShutdownListener vmShutdownListener =
            new VmShutdownListener("ContentStoreCleanerScalabilityRunner");
    ...
    protected synchronized int execute() throws ToolException {
        ...
        System.out.println();
        System.out.println(
                String.format("Cleaning took %3f per 1000 content URLs in DB", aveClean));
    ...
    private class NullContentStore extends AbstractContentStore {
        ...
        /**
         * Returns a writer to a thread-unique file. It's always the same file per thread so you
         * must use and close the writer before getting another.
         */
        @Override
