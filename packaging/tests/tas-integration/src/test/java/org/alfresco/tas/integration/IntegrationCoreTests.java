...
public class IntegrationCoreTests extends IntegrationTest {
  ...
  public void moveFolderWithFileToPublicSiteByUninvitedUser() throws Exception {
    ...
    testFile1 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file1 content");
    webDavProtocol
    ...
    STEP(
      "4. U1 tries to move his folder to U2 public site using IMAP. 5. Verify folder with file is not moved. U1 is not authorized to access the U2 public site"
    );
    FolderModel destination = new FolderModel(
  ...
  public void deleteFolderWithChildrenUsingCMIS() throws Exception {
    ...
    STEP(
      "6. Delete parentFolder using CMIS 7. Verify folder is deleted along with all its children"
    );
    cmisAPI
      .usingResource(parentFolder)
      .deleteFolderTree()
  ...
  public void deleteFolderWithChildrenUsingWebDAV() throws Exception {
    ...
    STEP(
      "6. Delete parentFolder using WebDAV 7. Verify folder is deleted along with all its children"
    );
    webDavProtocol
      .usingResource(parentFolder)
      .delete()
  ...
  public void deleteFolderWithChildrenUsingFTP() throws Exception {
    ...
    STEP(
      "2. U1 creates a public test site using CMIS and adds u2 as manager to his site using REST"
    );
    testSitePublic = dataSite.usingUser(testUser1).createPublicRandomSite();
    dataUser
      .usingUser(testUser1)
  ...
  public void deleteParentFolderWithCheckoutFileInUsingCMIS() throws Exception {
    ...
    FileModel cmisTestFile = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      "file 1 content"
    );
    FileModel webdavTestFile = FileModel.getRandomFileModel(
      FileType.HTML,
      "file 2 content"
    );
    FileModel ftpTestFile = FileModel.getRandomFileModel(
      FileType.MSWORD,
      "file 4 content"
    );
    ...
    cmisAPI
      ...
      .doesNotExistInRepo();
    STEP(
      "Step 6. Using WebDAV, U1 verifies that parent folder and all children are not present"
    );
    webDavProtocol
      .usingResource(testFolder1)
      .assertThat()
  ...
  public void deleteParentFolderWithCheckoutFileInUsingWebDAV()
    throws Exception {
    STEP("1. Using CMIS create one test user: U1");
    testUser1 = dataUser.createRandomTestUser();
    ...
    STEP(
      "Step 7. Using FTP, U1 verifies that parent folder and all children are not present"
    );
    ftpProtocol
      .usingResource(testFolder1)
      .assertThat()
  ...
  public void usersCanUpdateDocumentContentInsideAPublicSite()
    throws Exception {
  ...
  @Test(
    groups = { TestGroup.INTEGRATION, TestGroup.CORE },
    expectedExceptions = {
      CmisPermissionDeniedException.class, CmisUnauthorizedException.class,
    }
  )
  @TestRail(
    section = { TestGroup.INTEGRATION, TestGroup.CONTENT },
  ...
  public void usersCanLikeADocumentInPublicSite() throws Exception {
    ...
    RestRatingModel returnedRatingModel = restAPI
      .authenticateUser(testUser2)
      .withCoreAPI()
      .usingResource(testFile1)
      .likeDocument();
    ...
    RestPersonFavoritesModel restPersonFavoritesModel = restAPI
      .authenticateUser(testUser2)
      .withCoreAPI()
      .usingAuthUser()
    ...
    RestPersonFavoritesModelsCollection userFavorites = restAPI
      .withCoreAPI()
      .usingAuthUser()
      .getFavorites();
    ...
    STEP(
      "11. Using CMIS U2 delete the folder. With Contributor role, U2 does not have permission to delete files/folders created by others."
    );
    cmisAPI
      .authenticateUser(testUser2)
      .usingResource(testFolder1)
  ...
  public void usersCanRateADocumentInPublicSite() throws Exception {
    ...
    returnedRatingModel =
      restAPI.withCoreAPI().usingResource(testFile2).getFiveStarRating();
    restAPI.assertStatusCodeIs(HttpStatus.OK);
    returnedRatingModel
      .getAggregate()
      .assertThat()
  ...
  public void fileHandlingCreateUpdateContentDeleteLikeAndRate()
    throws Exception {
    ...
    FileModel file1 = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      "file 1 content"
    );
    cmisAPI
    ...
    FileModel file2 = FileModel.getRandomFileModel(
      FileType.HTML,
      "file 2 content"
    );
    webDavProtocol
    ...
    FileModel file3 = FileModel.getRandomFileModel(
      FileType.MSWORD,
      "file 3 content"
    );
    ftpProtocol
    ...
    RestCommentModel commentModel = restAPI
      .authenticateUser(testUser1)
      .withCoreAPI()
      .usingResource(file3)
      .addComment(comment);
  ...
  public void fileHandlingCopyMoveAddUpdateContentFavoritesLikeAndRate()
    throws Exception {
    ...
    ftpProtocol
      ...
      .existsInRepo();
    Assert.assertTrue(
      ftpProtocol.usingResource(folder1).getFiles().size() == 1
    );
  ...
  public void verifyIncreasedVersionAndNewContentOfCheckInDocument()
    throws Exception {
    ...
    STEP(
      "Step 5: Using CMIS, check out the document and verify document version"
    );
    cmisAPI
      .authenticateUser(testUser1)
      .usingResource(file)
    ...
    cmisAPI
      .usingResource(folder)
      .assertThat()
      .folderHasCheckedOutDocument(file);
    cmisAPI
      .usingResource(file)
  ...
  public void verifyVersionAndContentOfACanceledCheckoutDocument()
    throws Exception {
    STEP("Step 1. Using CMIS create test user: U1");
    testUser1 = dataUser.createRandomTestUser();
  ...
  public void checkRelationshipBetween2Files() throws Exception {
    ...
    FileModel sourceFile = FileModel.getRandomFileModel(
      FileType.PDF,
      "file content"
    );
    webDavProtocol
    ...
    FileModel targetFile = FileModel.getRandomFileModel(
      FileType.PDF,
      "file content"
    );
    webDavProtocol
    ...
    STEP(
      "5. Using CMIS U1 creates a relationship between documents. 6. Verify if relationship is created"
    );
    cmisAPI
      .authenticateUser(testUser1)
  ...
  public void addAndRemoveDocumentFromFolders() throws Exception {
    ...
    testFile1 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file content");
    webDavProtocol
      .authenticateUser(testUser1)
      .usingResource(parentFolder)
      .createFile(testFile1)
    ...
    FileModel fileAddedInCMISFolder = new FileModel(
      testFile1.getName(),
      testFile1.getTitle(),
    ...
    FileModel fileAddedInSubFolder = new FileModel(
      testFile1.getName(),
      testFile1.getTitle(),
      testFile1.getDescription(),
      testFile1.getFileType(),
    ...
    FileModel fileAddedInWebDAVFolder = new FileModel(
      testFile1.getName(),
      testFile1.getTitle(),
      testFile1.getDescription(),
      testFile1.getFileType(),
  ...
  @TestRail(
    section = { TestGroup.INTEGRATION, TestGroup.CONTENT },
    executionType = ExecutionType.REGRESSION,
    description = "Verify user is able to move a non empty folder to another folder from the same site."
  )
  public void moveFolderInAnotherFolder() throws Exception {
    ...
    FolderModel newTestFolder1 = new FolderModel(
      testFolder1.getName(),
    ...
    FileModel newTestFile1 = new FileModel(
      testFile1.getName(),
      testFile1.getTitle(),
      testFile1.getDescription(),
      testFile1.getFileType(),
  ...
  @TestRail(
    section = { TestGroup.INTEGRATION, TestGroup.CONTENT },
    executionType = ExecutionType.REGRESSION,
    description = "Verify user is able to copy non empty folder to another folder in the same site."
  )
  ...
  public void renameSite() throws Exception {
    ...
    testSiteModerated =
      dataSite.usingUser(testUser1).createModeratedRandomSite();
    ...
    STEP(
      "4. Using CMIS U1 tries to rename site 5. Verify that a site cannot be renamed"
    );
    FolderModel siteFolder = new FolderModel(
      String.format("/Sites/%s", testSiteModerated.getId())
    );
    cmisAPI
      .authenticateUser(testUser1)
      .usingResource(siteFolder)
      .rename("renamedSite");
  }
}
