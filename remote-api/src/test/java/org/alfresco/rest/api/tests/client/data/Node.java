 ...
 *
 * <p>TODO push null check down into AssertUtil (making sure that no other existing tests break)
 *
 * @author janv
 */
public class Node {
    ...
    public void expected(Object o) {
        ...
        if (modifiedAt != null) {
            assertTrue(
                    modifiedAt.before(other.getModifiedAt())
                            || modifiedAt.equals(other.getModifiedAt()));
        } else {
        ...
        if (aspectNames != null) {
            ...
            assertEquals(
                    "Expected: " + aspectNames + ", actual: " + other.getAspectNames(),
                    aspectNames.size(),
                    other.getAspectNames().size());
        ...
        if (allowableOperations != null) {
            ...
            assertEquals(
                    "Expected: "
                            + allowableOperations
                            + ", actual: "
                            + other.getAllowableOperations(),
                    allowableOperations.size(),
                    other.getAllowableOperations().size());
