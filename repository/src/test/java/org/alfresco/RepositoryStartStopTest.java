...
public class RepositoryStartStopTest extends TestCase {
  ...
  public static void assertNoCachedApplicationContext() throws Exception {
    Field instanceF =
      BaseApplicationContextHelper.class.getDeclaredField("instance");
  ...
  public void doTestBasicWriteOperations(ApplicationContext ctx)
    throws Exception {
    ...
    assertTrue(
      "The Node Write didn't occur or failed with an error",
      writeTestWorked
    );
  }
}
