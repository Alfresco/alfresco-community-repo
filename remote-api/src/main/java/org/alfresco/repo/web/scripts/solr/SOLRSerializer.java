...
/* package */class SOLRSerializer {
  ...
  public String serializeToJSONString(Serializable value) {
    if (
      value != null &&
      typeConverter.INSTANCE.getConverter(value.getClass(), String.class) ==
      null
    ) {
  ...
  public PropertyValue serialize(QName propName, Serializable value)
    ...
    if (propertyDef.isMultiValued()) {
      if (!(value instanceof Collection)) {
        throw new IllegalArgumentException(
          "Multi value: expected a collection, got " +
      ...
      for (Serializable o : c) {
        if (dataTypeName.equals(DataTypeDefinition.MLTEXT)) {
          ...
          throw new RuntimeException(
            "Multi-valued content properties are not supported"
          );
        } else {
  ...
  static class SOLRTypeConverter {
    ...
    SOLRTypeConverter(NamespaceService namespaceService) {
          ...
          public String convert(MLText source) {
            try {
              ...
              throw new AlfrescoRuntimeException(
                "Unable to serialize content data to JSON",
                e
              );
            }
          }
      ...
      // content
      INSTANCE.addConverter(
        ContentDataWithId.class,
        String.class,
        new TypeConverter.Converter<ContentDataWithId, String>() {
          public String convert(ContentDataWithId source) {
            JSONObject json = new JSONObject();
            try {
              json.put("contentId", String.valueOf(source.getId()));
              String locale = INSTANCE.convert(
                String.class,
                source.getLocale()
              );
              ...
              json.put(
                "encoding",
                encoding == null ? JSONObject.NULL : encoding
              );
              String mimetype = source.getMimetype();
              json.put(
                "mimetype",
                mimetype == null ? JSONObject.NULL : mimetype
              );
      ...
      INSTANCE.addConverter(
        NodeRef.class,
        String.class,
        new TypeConverter.Converter<NodeRef, String>() {
      ...
      INSTANCE.addConverter(
        ...
        String.class,
        new TypeConverter.Converter<AttributeElement, String>() {
      ...
      INSTANCE.addConverter(
        ChildAssocElement.class,
        String.class,
        new TypeConverter.Converter<ChildAssocElement, String>() {
      ...
      INSTANCE.addConverter(
        Path.DescendentOrSelfElement.class,
        String.class,
        new TypeConverter.Converter<Path.DescendentOrSelfElement, String>() {
      ...
      INSTANCE.addConverter(
        Path.ParentElement.class,
        String.class,
        new TypeConverter.Converter<Path.ParentElement, String>() {
      ...
      INSTANCE.addConverter(
        Path.SelfElement.class,
        String.class,
        new TypeConverter.Converter<Path.SelfElement, String>() {
      ...
      INSTANCE.addConverter(
        String.class,
        AttributeElement.class,
        new TypeConverter.Converter<String, AttributeElement>() {
      ...
      INSTANCE.addConverter(
        String.class,
        ChildAssocElement.class,
        new TypeConverter.Converter<String, ChildAssocElement>() {
          public ChildAssocElement convert(String source) {
            return new Path.ChildAssocElement(
              INSTANCE.convert(ChildAssociationRef.class, source)
            );
          }
        }
      );
      ...
      INSTANCE.addConverter(
        String.class,
        Path.DescendentOrSelfElement.class,
        new TypeConverter.Converter<String, Path.DescendentOrSelfElement>() {
      ...
      INSTANCE.addConverter(
        String.class,
        Path.ParentElement.class,
        new TypeConverter.Converter<String, Path.ParentElement>() {
      ...
      INSTANCE.addConverter(
        String.class,
        Path.SelfElement.class,
        new TypeConverter.Converter<String, Path.SelfElement>() {
      ...
      INSTANCE.addConverter(
        Path.class,
        List.class,
        new TypeConverter.Converter<Path, List>() {
      ...
      INSTANCE.addConverter(
        ...
        String.class,
        new TypeConverter.Converter<ChildAssociationRef, String>() {
      ...
      INSTANCE.addConverter(
        ...
        String.class,
        new TypeConverter.Converter<AssociationRef, String>() {
