...
public class RecordComponentIdentifierAspect extends BaseBehaviourBean
    ...
    /**
     * Ensures that the {@link RecordsManagementModel#PROP_IDENTIFIER rma:identifier} property
     * remains unique within the context of the parent node.
     *
     * @see
                        ...
                        if (newIdValue != null) {
                            ...
                            if (oldIdValue != null && !oldIdValue.equals(newIdValue)) {
                                throw new IntegrityException(
                                        I18NUtil.getMessage(MSG_SET_ID, nodeRef.toString()), null);
                            }
    ...
    /**
     * Cleans up the {@link RecordsManagementModel#PROP_IDENTIFIER rma:identifier} property unique
     * triplet.
     *
     * @see
    ...
    public void beforeDeleteNode(final NodeRef nodeRef) {
        AuthenticationUtil.runAs(
                new RunAsWork<Object>() {
                    public Object doWork() {
                        String beforeId =
                                (String) nodeService.getProperty(nodeRef, PROP_IDENTIFIER);
