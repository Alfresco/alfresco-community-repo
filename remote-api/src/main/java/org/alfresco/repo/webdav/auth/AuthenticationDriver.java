...
/**
 * A general interface for servlet-based authentication. Allows code to be shared by Web Client,
 * WebDAV and Sharepoint authentication classes.
 *
 * @author dward
 */
public interface AuthenticationDriver {
    ...
    /**
     * Authenticate user based on information in http request such as Authorization header or cached
     * session information.
     *
