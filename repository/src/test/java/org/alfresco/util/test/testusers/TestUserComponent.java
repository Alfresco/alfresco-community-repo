...
/**
 * This interface defines a software test component, which is responsible for the creation and deletion of Alfresco users - to be used when running integration tests.
 * 
