...
public class RecordsManagementAdminServiceImpl extends RecordsManagementAdminBase
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(RecordsManagementAdminServiceImpl.class);
    ...
    private static final String MSG_UNEXPECTED_TYPE_CONSTRAINT =
            "rm.admin.unexpected_type_constraint";
    private static final String MSG_ERROR_CLIENT_ID = "rm.admin.error-client-id";

    /** Constants */
    private static final String CUSTOM_CONSTRAINT_TYPE =
            org.alfresco.module.org_alfresco_module_rm.caveat.RMListOfValuesConstraint.class
                    .getName();

    private static final String CAPABILITY_CUSTOM_CONSTRAINT_TYPE =
            org.alfresco.module.org_alfresco_module_dod5015.caveat.RMListOfValuesConstraint.class
                    .getName();
    ...
    private static final QName LOCK_QNAME =
            QName.createQName(
                    NamespaceService.SYSTEM_MODEL_1_0_URI, "RecordsManagementAdminServiceImpl");
    ...
    /**
     * Indicate that this application content listener must be executed with the lowest precedence.
     * (ie last)
     *
                    ...
                    new RunAsWork<Void>() {
                        ...
                        public Void doWork() {
                            if (getDictionaryService()
                                    .getAllModels()
                                    .contains(RecordsManagementCustomModel.RM_CUSTOM_MODEL)) {
                                ...
                                while (type != null && !ContentModel.TYPE_CMOBJECT.equals(type)) {
                                    if (isCustomisable(type)) {
                                        ...
                                        getNodeService()
                                                .addAspect(nodeRef, customPropertyAspect, null);
                                    }
    ...
    /**
     * @param customisableTypes list of string representations of the type qnames that are
     *     customisable
     */
    public void setCustomisableTypes(List<String> customisableTypes) {
        ...
        for (String customisableType : customisableTypes) {
            pendingCustomisableTypes.add(
                    QName.createQName(customisableType, getNamespaceService()));
        }
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#getCustomisable()
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#getCustomisable(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
        ...
        for (QName aspect : aspects) {
            ...
            if (name.endsWith("Properties")) {
                ...
                if (prefixString == null) {
                    ...
                    } else if (CompatibilityModel.NAME_CUSTOM_RECORD_FOLDER_PROPERTIES.equals(
                            name)) {
                        type = RecordsManagementModel.TYPE_RECORD_FOLDER;
                    } else if (CompatibilityModel.NAME_CUSTOM_RECORD_CATEGORY_PROPERTIES.equals(
                            name)) {
                ...
                if (type != null) {
                    ...
                    if (pendingCustomisableTypes != null
                            && pendingCustomisableTypes.contains(type)) {
        ...
        if (pendingCustomisableTypes != null && pendingCustomisableTypes.size() != 0) {
            ...
            try {
                for (QName customisableType : pendingCustomisableTypes) {
                    ...
                    M2Aspect aspect =
                            model.createAspect(customAspect.toPrefixString(getNamespaceService()));
    ...
    private Map<QName, QName> getCustomisableMap() {
        if (customisableTypes == null) {
            throw AlfrescoRuntimeException.create(
                    "Customisable map has not been initialised correctly.");
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#isCustomisable(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#makeCustomisable(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#unmakeCustomisable(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#existsCustomProperty(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#getCustomPropertyDefinitions()
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#getCustomPropertyDefinitions(QName)
     */
     ...
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#addCustomPropertyDefinition(org.alfresco.service.namespace.QName,
    ...
    public QName addCustomPropertyDefinition(
            ...
            String description)
            throws CustomMetadataException {
        return addCustomPropertyDefinition(
                propId,
                aspectName,
                label,
                dataType,
     ...
     *     org.alfresco.service.namespace.QName, java.lang.String,
     *     org.alfresco.service.namespace.QName, java.lang.String, java.lang.String,
     *     java.lang.String, boolean, boolean, boolean, org.alfresco.service.namespace.QName)
     */
    public QName addCustomPropertyDefinition(
            QName propId,
            QName aspectName,
        ...
        if (!isCustomisable(aspectName)) {
            throw new NotCustomisableMetadataException(
                    aspectName.toPrefixString(getNamespaceService()));
        }
        ...
        M2Aspect customPropsAspect =
                deserializedModel.getAspect(customAspect.toPrefixString(getNamespaceService()));

        if (customPropsAspect == null) {
            throw new InvalidCustomAspectMetadataException(
                    customAspect, aspectName.toPrefixString(getNamespaceService()));
        }
        ...
        if (lovConstraint != null) {
            if (!dataType.equals(DataTypeDefinition.TEXT)) {
                throw new CannotApplyConstraintMetadataException(
                        lovConstraint, propIdAsString, dataType);
            }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#updateCustomPropertyDefinitionName(org.alfresco.service.namespace.QName,
     *     java.lang.String)
     */
    public QName updateCustomPropertyDefinitionName(QName propQName, String newName)
            throws CustomMetadataException {
        ...
        targetProperty.setName(
                new StringBuilder()
                        .append(RecordsManagementCustomModel.RM_CUSTOM_PREFIX)
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#setCustomPropertyDefinitionLabel(org.alfresco.service.namespace.QName,
     *     java.lang.String)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#setCustomPropertyDefinitionConstraint(org.alfresco.service.namespace.QName,
     *     org.alfresco.service.namespace.QName)
     */
    public QName setCustomPropertyDefinitionConstraint(QName propQName, QName newLovConstraint) {
        ...
        if (!dataType.equals(DataTypeDefinition.TEXT.toPrefixString(getNamespaceService()))) {
            ...
            throw new AlfrescoRuntimeException(
                    I18NUtil.getMessage(
                            CannotApplyConstraintMetadataException.MSG_CANNOT_APPLY_CONSTRAINT,
                            newLovConstraint,
                            targetProp.getName(),
                            dataType));
        }
        ...
        String refOfExistingConstraint =
                (targetProp.getConstraints().isEmpty()
                        ? null
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#removeCustomPropertyDefinitionConstraints(org.alfresco.service.namespace.QName)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#removeCustomPropertyDefinition(org.alfresco.service.namespace.QName)
     */
    public void removeCustomPropertyDefinition(QName propQName) {
        ...
        for (QName customisableType : getCustomisable()) {
            ...
            if (customPropsAspect == null) {
                throw new AlfrescoRuntimeException(
                        I18NUtil.getMessage(MSG_UNKNOWN_ASPECT, aspectName));
            }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#getCustomReferenceDefinitions()
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.RecordsManagementAdminService#addCustomReference(org.alfresco.service.cmr.repository.NodeRef,
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#removeCustomReference(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.cmr.repository.NodeRef, org.alfresco.service.namespace.QName)
     */
    public void removeCustomReference(
            final NodeRef fromNode, final NodeRef toNode, final QName assocId) {
        mandatory("fromNode", fromNode);
        mandatory("toNode", toNode);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getCustomReferencesFrom(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getCustomChildReferences(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getCustomReferencesTo(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getCustomParentReferences(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#addCustomAssocDefinition(java.lang.String)
     *     <p>note: currently RMC custom assocs only
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#addCustomChildAssocDefinition(java.lang.String,
     *     java.lang.String)
     *     <p>note: currently RMC custom assocs only
     */
    public QName addCustomChildAssocDefinition(String source, String target) {
        ...
        return QName.createQName(
                RM_CUSTOM_PREFIX, relationshipDefinition.getUniqueName(), getNamespaceService());
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#updateCustomChildAssocDefinition(org.alfresco.service.namespace.QName,
     *     java.lang.String, java.lang.String)
     *     <p>note: currently RMC custom assocs only
     */
    public QName updateCustomChildAssocDefinition(
            QName refQName, String newSource, String newTarget) {
        ...
        RelationshipDefinition relationshipDefinition =
                getRelationshipService().updateRelationshipDefinition(localName, displayName);
        return QName.createQName(
                RM_CUSTOM_PREFIX, relationshipDefinition.getUniqueName(), getNamespaceService());
    }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#updateCustomAssocDefinition(org.alfresco.service.namespace.QName,
     *     java.lang.String)
     *     <p>note: currently RMC custom assocs only
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#addCustomConstraintDefinition(org.alfresco.service.namespace.QName,
     ...
     */
    public void addCustomConstraintDefinition(
        ...
        M2Constraint customConstraint =
                deserializedModel.getConstraint(constraintNameAsPrefixString);
        if (customConstraint != null) {
            throw new AlfrescoRuntimeException(
                    I18NUtil.getMessage(MSG_CONSTRAINT_EXISTS, constraintNameAsPrefixString));
        }

        M2Constraint newCon =
                deserializedModel.createConstraint(
                        constraintNameAsPrefixString, CUSTOM_CONSTRAINT_TYPE);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#changeCustomConstraintValues(org.alfresco.service.namespace.QName,
     *     java.util.List)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#changeCustomConstraintTitle(org.alfresco.service.namespace.QName,
     *     java.lang.String)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getCustomConstraintDefinitions(org.alfresco.service.namespace.QName)
     */
    public List<ConstraintDefinition> getCustomConstraintDefinitions(QName modelQName) {
        mandatory("modelQName", modelQName);

        Collection<ConstraintDefinition> conDefs =
                getDictionaryService().getConstraints(modelQName, true);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#removeCustomConstraintDefinition(org.alfresco.service.namespace.QName)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getQNameForClientId(java.lang.String)
     */
    public QName getQNameForClientId(String localName) {
        ...
        // property, constraints definitions with the same names, which is technically allowed by
        // Alfresco.
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#splitSourceTargetId(java.lang.String)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.admin.RecordsManagementAdminService#getCompoundIdFor(java.lang.String,
     *     java.lang.String)
     */
