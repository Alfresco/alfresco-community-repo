...
public interface SiteMembershipRequests {
     ...
     */
    SiteMembershipRequest createSiteMembershipRequest(
            String inviteeId, final SiteMembershipRequest siteInvite);
     ...
     */
    SiteMembershipRequest createSiteMembershipRequest(
            String inviteeId, final SiteMembershipRequest siteInvite, final String client);
     ...
     */
    SiteMembershipRequest updateSiteMembershipRequest(
            String inviteeId, final SiteMembershipRequest siteInvite);
     ...
     */
    CollectionWithPagingInfo<SiteMembershipRequest> getPagedSiteMembershipRequests(
            String inviteeId, Paging paging);

    CollectionWithPagingInfo<SiteMembershipRequest> getPagedSiteMembershipRequests(
            final Parameters parameters);

    void approveSiteMembershipRequest(
            String siteId, String inviteeId, SiteMembershipApproval siteMembershipApproval);

    void rejectSiteMembershipRequest(
            String siteId, String inviteeId, SiteMembershipRejection siteMembershipRejection);
}
