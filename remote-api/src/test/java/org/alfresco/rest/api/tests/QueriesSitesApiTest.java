...
public class QueriesSitesApiTest extends AbstractSingleNetworkSiteTest {
  ...
  private void checkApiCall(
    ...
    if (expectedStatus == 200) {
      ...
      List<Site> sites = RestApiUtil.parseRestApiEntries(
  ...
  public void testLiveSearchSites() throws Exception {
    ...
    try {
      ...
      for (int i = 1; i <= sCount; i++) {
        ...
        // create site
        String createdSiteId = createSite(
          siteId,
          siteTitle,
          siteDescrip,
      ...
      // basic search tests
      {
        ...
        checkApiCall(
          siteT + String.format("%05d", 2) + siteT,
          null,
          paging,
          200,
          null,
        ...
        checkApiCall(
          siteD + String.format("%05d", 3) + siteD,
          null,
          paging,
          200,
          null,
