...
public interface Resource {
    ...
    /**
     * Processes the Resource with a {@link ResourceProcessor}. This method has the role of the
     * accept method in the Visitor pattern, in this case the Visitor being the {@link
     * ResourceProcessor} and the Element - the Resource.
     *
     * @param processor
     * @return
