...
public class ContentStoreCleaner {
   ...
   */
  public void setDeletionFailureAction(
    DeleteFailureAction deletionFailureAction
  ) {
  ...
  private void executeInternal() {
    final long maxOrphanTime =
      System.currentTimeMillis() - (protectDays * 24 * 3600 * 1000L);
    ...
    while (true) {
      Long lastProcessedOrphanId = transactionService
