...
public class ScriptBehaviourTest extends BaseSpringTest {
  ...
  public void test1EnableDisableBehaviour() {
    ...
    ScriptLocation location = new ClasspathScriptLocation(
      "org/alfresco/repo/jscript/test_onCreateNode_cmContent.js"
    );
    ...
    this.policyComponent.bindClassBehaviour(
        QName.createQName(
          NodeServicePolicies.OnCreateNodePolicy.NAMESPACE,
          "onCreateNode"
        ),
    ...
    ChildAssociationRef childAssoc2 =
      this.nodeService.createNode(
          this.folderNodeRef,
          ContentModel.ASSOC_CONTAINS,
          QName.createQName(
  ...
  public void test3SpringConfiguredBehaviour() {
    ...
    assertTrue(
      this.nodeService.hasAspect(this.folderNodeRef, ContentModel.ASPECT_TITLED)
    );
    ...
    this.nodeService.addChild(
        ...
        childAssoc.getChildRef(),
        ContentModel.ASSOC_CONTAINS,
        QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "linked")
      );
    assertTrue(
      this.nodeService.hasAspect(
          childAssoc.getChildRef(),
