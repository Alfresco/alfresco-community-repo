...
public abstract class AbstractModuleComponent
  implements ModuleComponent, BeanNameAware {

  private static final String ERR_ALREADY_EXECUTED =
    "module.err.already_executed";
  private static final String ERR_EXECUTION_FAILED =
    "module.err.execution_failed";
  ...
  public boolean equals(Object obj) {
    ...
    return (
      EqualsHelper.nullSafeEquals(this.moduleId, that.getModuleId()) &&
