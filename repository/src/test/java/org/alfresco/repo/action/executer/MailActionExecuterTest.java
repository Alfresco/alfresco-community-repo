...
/**
 * Provides tests for the MailActionExecuter class. The logic is now in
 * AbstractMailActionExecuterTest. See the Javadoc for AbstractMailActionExecuterTest. The
 * setupRuleChain() method is very important as it really setup the class including creating the
 * users.
 */
