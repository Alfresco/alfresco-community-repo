...
public abstract class AbstractExportTester {
    ...
    /**
     * Common checks that do not need to be coded into every test implementation. May be overridden
     * if required.
     */
    ...
    /**
     * Check that all top level database objects are prefixed as expected (no other objects should
     * have been retrieved)
     *
     * @param schema Schema
     * @param prefix String
