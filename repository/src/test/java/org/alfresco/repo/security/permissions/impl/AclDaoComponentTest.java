...
public class AclDaoComponentTest extends TestCase {
    ...
    public void testCreateShared() {
        ...
        AccessControlListProperties sharedProps =
                aclDaoComponent.getAccessControlListProperties(shared);
    ...
    public void testSimpleInheritFromDefining() {
        ...
        AccessControlListProperties sharedProps =
                aclDaoComponent.getAccessControlListProperties(sharedId);
        assertEquals(sharedProps.getAclType(), ACLType.SHARED);
        assertEquals(sharedProps.getAclVersion(), Long.valueOf(1l));
        assertEquals(sharedProps.getInherits(), Boolean.TRUE);
    ...
    public void testSimpleCow() throws Exception {
        ...
        AccessControlListProperties aclPropsBefore =
                aclDaoComponent.getAccessControlListProperties(id);
        ...
        AccessControlListProperties aclPropsAfter =
                aclDaoComponent.getAccessControlListProperties(changes.get(0).getAfter());
        assertEquals(aclPropsAfter.getAclType(), aclPropsBefore.getAclType());
        assertEquals(
                aclPropsAfter.getAclVersion(), Long.valueOf(aclPropsBefore.getAclVersion() + 1));
        ...
        assertEquals(
                ...
                0);
        assertEquals(
                aclDaoComponent.getAccessControlList(changes.get(0).getAfter()).getEntries().size(),
                1);
        assertTrue(
                hasAce(
                        aclDaoComponent
