...
public abstract class BaseApplicationContextHelper {
  ...
  public static synchronized ApplicationContext getApplicationContext(
    ...
    if (configLocations == null) {
      throw new IllegalArgumentException(
        "configLocations argument is mandatory."
      );
    }
    if (
    ...
    if (useLazyLoading || noAutoStart) {
      instance =
        new VariableFeatureClassPathXmlApplicationContext(configLocations);
    } else {
   ...
   * @throws IOException
   */
  public static ClassLoader buildClassLoader(String[] classLocations)
    throws IOException {
  ...
  protected static class VariableFeatureClassPathXmlApplicationContext
    ...
    protected VariableFeatureClassPathXmlApplicationContext(
      String[] configLocations
    ...
    protected void initBeanDefinitionReader(XmlBeanDefinitionReader reader) {
      ...
      if (noAutoStart) {
        NoAutoStartClassPathXmlApplicationContext.postInitBeanDefinitionReader(
          reader
        );
      }
    }
  ...
  public static class ResourceFinder
     ...
     */
    public Resource[] getResources(String... locationPatterns)
      throws IOException {
