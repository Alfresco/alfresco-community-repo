...
public class DownloadRestApiTest extends BaseWebScriptTest {
  ...
  public static final String URL_DOWNLOAD_STATUS =
    "/api/internal/downloads/{0}/{1}/{2}/status";
  ...
  public void setUp() {
    ...
    if (
      this.authenticationService.authenticationExists(TEST_USERNAME) == false
    ) {
      // create user
  ...
  public void testCreateAndGetDownload()
    ...
    Response response = sendRequest(
      new PostRequest(URL_DOWNLOADS, postData, "application/json"),
      200
    );
    ...
    // Get the status
    String statusUrl = MessageFormat.format(
      URL_DOWNLOAD_STATUS,
