...
public class GetRenditionTests extends RestTest {
    ...
    public void verifyPreviewOfZipFile() throws Exception {
        ...
        restClient
                ...
                .addMultiPart("filedata", Utility.getResourceTestDataFile("content-zip-test.zip"));

        RestNodeModel fileNode =
                restClient.authenticateUser(user).withCoreAPI().usingNode(folder).createNode();
        ...
        RestRenditionInfoModel renditionInfo =
                restClient.withCoreAPI().usingNode(file).getNodeRenditionUntilIsCreated("pdf");
    ...
    public void verifyThumbnailOfZipFile() throws Exception {
        ...
        RestRenditionInfoModel renditionInfo =
                restClient.withCoreAPI().usingNode(file).getNodeRenditionUntilIsCreated("doclib");
        restClient.assertStatusCodeIs(HttpStatus.OK);
        renditionInfo.assertThat().field("status").is("CREATED");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that the rendition content can be downloaded using GET"
    ...
    public void getRenditionContent() throws Exception {
        ...
        RestResponse restResponse =
                restClient
                        .withCoreAPI()
                        .usingNode(file)
                        .getNodeRenditionContentUntilIsCreated("doclib");
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify the Range request header using GET"
                            + " /nodes/{nodeId}/renditions/{renditionId}/content")
