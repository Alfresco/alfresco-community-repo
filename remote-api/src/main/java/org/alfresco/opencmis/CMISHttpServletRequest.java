...
public class CMISHttpServletRequest implements HttpServletRequest {
  ...
  public CMISHttpServletRequest(
    ...
    if (
      !pathInfo.startsWith("/cmis") &&
      (baseReq instanceof TenantWebScriptServletRequest)
    ) {
    ...
    HttpServletRequest httpReq = WebScriptServletRuntime.getHttpServletRequest(
      req
    );
  ...
  public String getRequestURI() {
    String requestURI = baseUrlGenerator.getRequestURI(
      httpReq,
      networkId,
      operation,
      id
