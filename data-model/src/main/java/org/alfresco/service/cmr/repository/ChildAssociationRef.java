 ...
 *
 * <p>So it requires the parent node ref, the child node ref and the name of the child within the
 * particular parent.
 *
 * <p>This combination is not a unique identifier for the relationship with regard to structure. In
 * use this does not matter as we have no concept of order, particularly in the index.
 *
 * @author andyh
 */
@AlfrescoPublicApi
public class ChildAssociationRef
     ...
     *
     * @see ChildAssociationRef#ChildAssociationRef(org.alfresco.service.namespace.QName, NodeRef,
     *     org.alfresco.service.namespace.QName, NodeRef)
     */
    public ChildAssociationRef(
            QName assocTypeQName, NodeRef parentRef, QName childQName, NodeRef childRef) {
        this(assocTypeQName, parentRef, childQName, childRef, false, -1);
    }

    /**
     * @param childAssocRefStr a string of the form
     *     <b>parentNodeRef|childNodeRef|assocTypeQName|assocQName|isPrimary|nthSibling</b>
     */
    public ChildAssociationRef(String childAssocRefStr) {
        ...
        if (tokenizer.countTokens() != 6) {
            throw new AlfrescoRuntimeException(
                    "Unable to parse child association string: " + childAssocRefStr);
        }
     ...
     *
     * @return Returns the qualified name of the parent-child association type as defined in the
     *     data dictionary. It may be null if this is the imaginary association to the root node.
     */
     ...
     *
     * @return Returns the qualified name of the parent-child association. It may be null if this is
     *     the imaginary association to a root node.
     */
    ...
    /**
     * Allows post-creation setting of the ordering index. This is a helper so that sorted sets and
     * lists can be easily sorted.
     *
     * <p>This index is <b>in no way absolute</b> and should change depending on the results that
     * appear around this instance. Therefore, the sibling number cannot be used to construct, say,
     * sibling number 5. Sibling number 5 will exist only in results where there are siblings 1 - 4.
     *
