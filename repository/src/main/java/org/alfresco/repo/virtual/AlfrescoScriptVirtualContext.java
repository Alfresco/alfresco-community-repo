...
public class AlfrescoScriptVirtualContext
  ...
  public AlfrescoScriptVirtualContext(
  ...
  private String[] createQNamePaths() {
    ...
    final Path path = serviceRegistry
      .getNodeService()
      .getPath(context.getActualNodeRef());
