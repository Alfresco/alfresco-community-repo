...
public class AlfrescoEnviroment implements ActualEnvironment {
  ...
  public Object executeScript(String classpath, Map<String, Object> model) {
    return apiFacet
      .getScriptService()
      .executeScript(
        new ClasspathScriptLocation(classpath.substring(1)),
        model
      );
  }
  ...
  public Object executeScript(
    ...
    return apiFacet
      .getScriptService()
      .executeScript(templateNodeRef, null, model);
  }
  ...
  public NodeRef getTargetAssocs(NodeRef nodeRef, QName associationQName) {
    List<AssociationRef> assocs = apiFacet
      .getNodeService()
      .getTargetAssocs(nodeRef, associationQName);
  ...
  @Override
  public InputStream openContentStream(NodeRef nodeRef)
    throws ActualEnvironmentException {
    ContentReader contentReader = apiFacet
      .getContentService()
  ...
  @Override
  public InputStream openContentStream(String classpath)
    throws ActualEnvironmentException {
  ...
  public NodeRef getChildByName(
    ...
    return apiFacet
      .getNodeService()
      .getChildByName(nodeRef, assocTypeQName, childName);
  }
  ...
  public FileInfo create(NodeRef parentNodeRef, String name, QName typeQName)
    ...
    return apiFacet
      ...
      .create(parentNodeRef, name, typeQName);
  }
  ...
  public ContentWriter getWriter(
    ...
    return apiFacet
      .getContentService()
      .getWriter(nodeRef, propertyQName, update);
  }
  ...
  public void addAspect(
    ...
    apiFacet
      .getNodeService()
      .addAspect(nodeRef, aspectTypeQName, aspectProperties);
  }
