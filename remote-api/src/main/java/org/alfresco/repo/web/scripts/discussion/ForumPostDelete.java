...
public class ForumPostDelete extends AbstractDiscussionWebScript {
  ...
  private static final String MSG_NODE_MARKED_REMOVED =
    "forum-post.msg.marked.removed";
  ...
  protected Map<String, Object> executeImpl(
    ...
    if (post != null) {
      ...
      String error =
        "Node was of the wrong type, only Topic and Post are supported";
