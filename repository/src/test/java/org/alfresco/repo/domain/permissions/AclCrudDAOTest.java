...
public class AclCrudDAOTest extends TestCase {
    ...
    private AclChangeSet getAclChangeSet(final long aclChangeSetId) throws Exception {
        RetryingTransactionCallback<AclChangeSet> callback =
                new RetryingTransactionCallback<AclChangeSet>() {
    ...
    private Authority createAuth(final String authName) throws Exception {
        RetryingTransactionCallback<Authority> callback =
                new RetryingTransactionCallback<Authority>() {
    ...
    private Permission createPermission(final PermissionReference permissionReference)
            throws Exception {
        RetryingTransactionCallback<Permission> callback =
                new RetryingTransactionCallback<Permission>() {
    ...
    private Permission getPermission(final PermissionReference permissionReference)
            throws Exception {
        RetryingTransactionCallback<Permission> callback =
                new RetryingTransactionCallback<Permission>() {
                    public Permission execute() throws Throwable {
    ...
    public void testCreateAndDeletePermission() throws Exception {
        ...
        final SimplePermissionReference permRef =
                SimplePermissionReference.getPermissionReference(
                        QName.createQName("cm:cmobject"), name);
