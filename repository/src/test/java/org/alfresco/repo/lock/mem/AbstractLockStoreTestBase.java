...
public abstract class AbstractLockStoreTestBase<T extends LockStore> {
  ...
  public void testContains() {
    ...
    LockState lock1 = LockState.createLock(
      nodeRef1,
      LockType.NODE_LOCK,
      "owner",
      null,
    ...
    LockState lock2 = LockState.createLock(
      nodeRef2,
      LockType.NODE_LOCK,
      "owner",
      null,
  ...
  public void testGetNodes() {
    ...
    LockState lock3 = LockState.createLock(
      nodeRef3,
      LockType.NODE_LOCK,
      "owner",
      null,
    ...
    LockState lock4 = LockState.createLock(
      nodeRef4,
      LockType.NODE_LOCK,
      "owner",
      null,
    ...
    Set<NodeRef> nodes = new TreeSet<NodeRef>(
