...
public class NodesMetaDataGet extends DeclarativeWebScript {
            ...
            searchTrackingComponent.getNodesMetadata(
                    ...
                    new NodeMetaDataQueryCallback() {
                        ...
                        public boolean handleNodeMetaData(NodeMetaData nodeMetaData) {
                            // need to perform data structure conversions that are compatible with
                            // Freemarker
                            // e.g. Serializable -> String, QName -> String (because map keys must
                            // be string, number)
                            try {
                                FreemarkerNodeMetaData fNodeMetaData =
                                        new FreemarkerNodeMetaData(solrSerializer, nodeMetaData);
    ...
    public static class FreemarkerNodeMetaData {
        ...
        public FreemarkerNodeMetaData(
                final SOLRSerializer solrSerializer, final NodeMetaData nodeMetaData)
            ...
            if (props != null) {
                final Map<String, PropertyValue> properties =
                        new HashMap<String, PropertyValue>(props.size());
