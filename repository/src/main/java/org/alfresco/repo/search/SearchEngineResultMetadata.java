...
/**
 * Additional metadata ops available for {@link org.alfresco.service.cmr.search.ResultSet} coming
...
public interface SearchEngineResultMetadata {
    /**
     * Returns the query execution time, or put in other words, the amount of time the search engine
     * spent for processing the request.
     *
