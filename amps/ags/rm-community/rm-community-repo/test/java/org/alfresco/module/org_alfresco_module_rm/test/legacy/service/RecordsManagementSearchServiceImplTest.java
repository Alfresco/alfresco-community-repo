...
public class RecordsManagementSearchServiceImplTest extends BaseRMTestCase {
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          List<SavedSearchDetails> searches = rmSearchService.getSavedSearches(
            siteId
          );
  ...
  public void testSaveSearch() {
    ...
    doTestInTransaction(
      new Test<Void>() {
        @Override
        public Void run() {
          SavedSearchDetails details1 = rmSearchService.saveSearch(
            siteId,
            SEARCH1,
            "description1",
            "query1",
          ...
          SavedSearchDetails details2 = rmSearchService.saveSearch(
            siteId,
            SEARCH2,
            "description2",
            "query2",
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          SavedSearchDetails search1 = rmSearchService.getSavedSearch(
            siteId,
            SEARCH1
          );
          ...
          SavedSearchDetails search2 = rmSearchService.getSavedSearch(
            siteId,
            SEARCH2
          );
          ...
          SavedSearchDetails search3 = rmSearchService.getSavedSearch(
            siteId,
            SEARCH3
          );
          assertNull(search3);

          SavedSearchDetails search4 = rmSearchService.getSavedSearch(
            siteId,
            SEARCH4
          );
          assertNull(search4);
  ...
  private void checkSearchDetails(
    ...
    assertEquals(
      searchParameters.getMaxItems(),
      details.getSearchParameters().getMaxItems()
    );
    assertEquals(
      searchParameters.isIncludeRecords(),
      details.getSearchParameters().isIncludeRecords()
    );
    assertEquals(
      searchParameters.isIncludeUndeclaredRecords(),
      details.getSearchParameters().isIncludeUndeclaredRecords()
    );
    assertEquals(
      searchParameters.isIncludeVitalRecords(),
      details.getSearchParameters().isIncludeVitalRecords()
    );
    assertEquals(
      searchParameters.isIncludeRecordFolders(),
      details.getSearchParameters().isIncludeRecordFolders()
    );
    assertEquals(
      searchParameters.isIncludeFrozen(),
      details.getSearchParameters().isIncludeFrozen()
    );
    assertEquals(
      searchParameters.isIncludeCutoff(),
      details.getSearchParameters().isIncludeCutoff()
    );
