 ...
 * placeholder {@link #DEFAULT_DIALECT_PLACEHOLDER} is replaced with successive class names starting
 * from the {@link #setDialectClass(String) dialect class} and progressing up the hierarchy until
 * the {@link #setDialectBaseClass(String) base class} is reached. The bean is looked up in the
 * context at each point until the bean is found or the base of the class hierarchy is reached.
 *
 * <p>For example assume bean names:<br>
 *
 * <pre>
...
public class HierarchicalBeanLoader
    ...
    /**
     * @param targetBeanName the name of the target bean to return, including the {@link
     *     #DEFAULT_DIALECT_PLACEHOLDER} where the specific dialect must be replaced.
     */
    ...
    public Object getObject() throws Exception {
        ...
        // If a property value has not been substituted, extract the property name and load from
        // system
