...
public class SiteMembership extends AbstractSiteMembership {
    ...
    public SiteMembership(
            SiteInfo siteInfo, String id, String firstName, String lastName, String role) {
    ...
    public String toString() {
        return "SiteMembership [siteInfo="
                + getSiteInfo()
                + ", id="
                + id
                + ", firstName="
    ...
    static int compareTo(
        ...
        return SiteMembershipComparator.compareSiteMembersBody(
                sortPairs, personId1, personId2, lastName1, lastName2, siteRole1, siteRole2,
                personId, firstName, lastName, siteRole, 0);
    }
