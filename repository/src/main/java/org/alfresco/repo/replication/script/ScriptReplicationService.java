...
public class ScriptReplicationService extends BaseScopableProcessorExtension {
  ...
  public ScriptReplicationDefinition createReplicationDefinition(
    ...
    if (logger.isDebugEnabled()) {
      ...
      msg
        .append("Creating ScriptReplicationDefinition [")
    ...
    ReplicationDefinition replicationDefinition = replicationService.createReplicationDefinition(
      replicationName,
      description
    );
  ...
  public void saveReplicationDefinition(
    ScriptReplicationDefinition definition
  ) {
    if (logger.isDebugEnabled()) {
      StringBuilder msg = new StringBuilder();
      msg
        .append("Saving ScriptReplicationDefinition [")
  ...
  public ScriptReplicationDefinition loadReplicationDefinition(
    String replicationName
  ) {
    ReplicationDefinition replicationDefinition = replicationService.loadReplicationDefinition(
      replicationName
    );
