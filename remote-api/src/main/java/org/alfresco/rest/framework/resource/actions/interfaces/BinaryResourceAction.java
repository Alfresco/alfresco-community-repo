 ...
 *
 * <p>Supports full CRUD (Read, Update, Delete)
 *
 * @author Gethin James
 */
public interface BinaryResourceAction {
    ...
    public static interface Read extends ResourceAction {
        /**
         * Retrieves a binary property by returning a BinaryResource object. The specific property
         * is specified in the {@link Parameters} object. See {@link
         * Parameters#hasBinaryProperty(String)} or {@link Parameters#getBinaryProperty()}
         *
    ...
    public static interface ReadWithResponse extends ResourceAction {
        ...
        public BinaryResource readProperty(
                String entityId, Parameters parameters, WithResponse withResponse)
                throws EntityNotFoundException;
    }
    ...
    public static interface Delete extends ResourceAction {
        ...
        /**
         * Deletes a binary property. The specific property is specified in the {@link Parameters}
         * object. See {@link Parameters#hasBinaryProperty(String)} or {@link
         * Parameters#getBinaryProperty()}
         *
         * @param entityId unique id
         * @param parameters {@link Parameters}
         */
    ...
    public static interface Update<E> extends ResourceAction {
        ...
        /**
         * Updates a binary property. The specific property is specified in the {@link Parameters}
         * object. See {@link Parameters#hasBinaryProperty(String)} or {@link
         * Parameters#getBinaryProperty()}
         *
         * @param entityId unique id
