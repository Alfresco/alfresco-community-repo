 ...
 * 
 * Note that source filters can be "chained", in which case each source filter effectively has "veto" power - if any single filter requests that a given importable item be filtered, it <strong>will</strong> be filtered.
 *
 * @since 4.0
 */
