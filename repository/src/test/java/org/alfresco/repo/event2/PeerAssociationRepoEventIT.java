...
public class PeerAssociationRepoEventIT extends AbstractContextAwareRepoEvent {
    ...
    public void testAddPeerAssociation() {
        ...
        retryingTransactionHelper.doInTransaction(
                () ->
                        nodeService.createAssociation(
                                content1NodeRef, content2NodeRef, ContentModel.ASSOC_ORIGINAL));

        List<AssociationRef> peerAssociationRefs =
                retryingTransactionHelper.doInTransaction(
                        () ->
                                nodeService.getSourceAssocs(
                                        content2NodeRef, ContentModel.ASSOC_ORIGINAL));
        assertEquals(1, peerAssociationRefs.size());

        checkNumOfEvents(4);

        final RepoEvent<EventData<PeerAssociationResource>> peerAssocRepoEvent =
                getFilteredEvent(EventType.PEER_ASSOC_CREATED, 0);
        ...
        assertEquals(
                EventJSONSchema.PEER_ASSOC_CREATED_V1.getSchema(),
                peerAssocRepoEvent.getDataschema());

        final EventData<PeerAssociationResource> nodeResourceEventData =
                getEventData(peerAssocRepoEvent);
        ...
        final PeerAssociationResource peerAssociationResource =
    ...
    public void testAddMultiplePeerAssociationSameTransaction() {
        ...
        retryingTransactionHelper.doInTransaction(
                () -> {
                    ...
                    nodeService.createAssociation(
                            content3NodeRef, content2NodeRef, ContentModel.ASSOC_ORIGINAL);
                    return null;
                });
        ...
        List<RepoEvent<EventData<PeerAssociationResource>>> peerAssocRepoEvent =
                getFilteredEvents(EventType.PEER_ASSOC_CREATED);
    ...
    public void testRemovePeerAssociation() {
        ...
        final RepoEvent<EventData<PeerAssociationResource>> peerAssocRepoEvent2 =
                getFilteredEvent(EventType.PEER_ASSOC_DELETED, 0);
        ...
        assertEquals(
                EventJSONSchema.PEER_ASSOC_DELETED_V1.getSchema(),
                peerAssocRepoEvent2.getDataschema());

        final EventData<PeerAssociationResource> nodeResourceEventData2 =
                getEventData(peerAssocRepoEvent2);
        // EventData attributes
        assertNotNull(
                "Event data group ID is not available. ", nodeResourceEventData2.getEventGroupId());
        assertNull(
                "resourceBefore property is not available",
                nodeResourceEventData2.getResourceBefore());

        final PeerAssociationResource peerAssociationResource2 =
                getPeerAssocResource(peerAssocRepoEvent2);
        assertEquals(
                "Wrong source",
                content1NodeRef.getId(),
