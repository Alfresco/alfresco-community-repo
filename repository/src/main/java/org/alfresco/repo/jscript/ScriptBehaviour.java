...
public class ScriptBehaviour extends BaseBehaviour {
  ...
  private static class JavaScriptInvocationHandler
    ...
    private Object invokeScript(Method method, Object[] args) {
      ...
      model.put(
        "behaviour",
        new org.alfresco.repo.jscript.Behaviour(
          this.behaviour.serviceRegistry,
          method.getName(),
          args
        )
      );
      ...
      // Execute the script
      return this.behaviour.serviceRegistry.getScriptService()
        .executeScript(this.behaviour.location, model);
    }
    ...
    public String toString() {
      return (
        "JavaScriptBehaviour[location=" + behaviour.location.toString() + "]"
      );
    }
  }
}
