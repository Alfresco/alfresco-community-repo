...
public interface CalendarService {
    /**
     * Stores a new {@link CalendarEntry} into the given site. The concrete class {@link
     * CalendarEntryDTO} can be used to create a {@link CalendarEntry} instance for this.
     *
    ...
    /** Retrieves all {@link CalendarEntry} instances in the repository for the given site. */
    @NotAuditable
    PagingResults<CalendarEntry> listCalendarEntries(String siteShortName, PagingRequest paging);

    /** Retrieves all {@link CalendarEntry} instances in the repository for the given sites. */
    @NotAuditable
    PagingResults<CalendarEntry> listCalendarEntries(String[] siteShortNames, PagingRequest paging);

    /**
     * Retrieves all {@link CalendarEntry} instances in the repository for the given sites, between
    ...
    /**
     * Retrieves all Outlook based {@link CalendarEntry} instances in the repository for the given
     * site, optionally filtered by the Outlook Event UID.
     */
    @NotAuditable
    PagingResults<CalendarEntry> listOutlookCalendarEntries(
