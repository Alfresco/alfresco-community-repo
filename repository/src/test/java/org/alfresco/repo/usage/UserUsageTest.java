...
public class UserUsageTest extends TestCase {
    ...
    private static final QName customType =
            QName.createQName("{my.new.model}sop"); // from exampleModel.xml
    ...
    protected void setUp() throws Exception {
        ...
        InputStream modelStream =
                getClass().getClassLoader().getResourceAsStream("tenant/exampleModel.xml");
                            ...
                            public Void execute() throws Throwable {
                                for (NodeRef nodeRef : nodesToDelete) {
                                    nodeService.addAspect(
                                            nodeRef, ContentModel.ASPECT_TEMPORARY, null);
    ...
    public void testCreateUpdateDeleteInTx() throws Exception {
        ...
        NodeRef content1 =
                addTextContent(
                        folder, "text1.txt", "The quick brown fox jumps over the lazy dog"); // + 43
        ...
        NodeRef content3 =
                addTextContent(
                        folder,
                        "text3.txt",
                        "All questions asked by five watch experts amazed the judge"); // + 58
        ...
        updateTextContent(
                content1,
                "Few black taxis drive up major roads on quiet hazy nights"); // -43 + 57 = +14
    ...
    public void testCreateUpdateDeleteAcrossTx() throws Exception {
        ...
        NodeRef content1 =
                addTextContent(
                        folder, "tqbfjotld.txt", "The quick brown fox jumps over the lazy dog");
        assertEquals(43, contentUsageImpl.getUserUsage(TEST_USER));

        NodeRef content2 =
                addTextContent(
                        folder, "afdpj.txt", "Amazingly few discotheques provide jukeboxes", true);
        assertEquals(87, contentUsageImpl.getUserUsage(TEST_USER));
    ...
    public void testCreateCopyDeleteFolderWithContentInTx() throws Exception {
        ...
        addTextContent(
                folder1, "text2.txt", "Amazingly few discotheques provide jukeboxes", true); // + 44
        assertEquals(87, contentUsageImpl.getUserUsage(TEST_USER));
    ...
    private NodeRef addTextContent(
            NodeRef folderRef, String name, String textData, boolean custom) {
    ...
    private void restore(NodeRef origfolderOrContentRef) {
        ...
        NodeRef archiveNodeRef =
                new NodeRef(archiveRootNode.getStoreRef(), origfolderOrContentRef.getId());
        nodeService.restoreNode(archiveNodeRef, null, null, null);
    }

    private NodeRef copy(NodeRef sourceFolderOrContentRef, NodeRef targetFolderRef, String newName)
