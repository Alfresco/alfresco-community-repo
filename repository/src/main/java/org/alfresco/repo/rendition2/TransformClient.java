...
public interface TransformClient {
     ...
     * @return and object that contains information that will be passed to {@link
     *     #transform(NodeRef, RenditionDefinition2, String, int)} as the {@code transformInfo}
     *     parameter to avoid having to work it out again.
    ...
    /**
     * Requests an asynchronous transform and the subsequent linkage of that transform as a
     * rendition. The call to this method <b>MUST</b> be proceeded by a successful call to {@link
     * #checkSupported(NodeRef, RenditionDefinition2, String, long, String)} in the <b>SAME</b>
     * Thread.
     *
     * @param sourceNodeRef the source node
     * @param renditionDefinition which rendition to perform
     * @param user that requested the transform.
     * @param sourceContentHashCode the hash code of the source node's content URL. Used to check
     ...
     *     because an intermediate conversion is too big.
