...
public class TransferReportGenerator extends DeclarativeReportGenerator {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.report.generator.DeclarativeReportGenerator#generateReportTemplateContext(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    private Map<String, Serializable> getTransferNodeProperties(NodeRef childRef) {
        ...
        boolean isFolder =
                dictionaryService.isSubClass(
                        nodeService.getType(childRef), ContentModel.TYPE_FOLDER);
    ...
    private List<TransferNode> getRecords(NodeRef childRef) {
        ...
        List<ChildAssociationRef> assocs =
                nodeService.getChildAssocs(
                        childRef, ContentModel.ASSOC_CONTAINS, RegexQNamePattern.MATCH_ALL);
    ...
    private Map<String, Serializable> getRecordProperties(NodeRef record) {
        ...
        boolean isDeclared =
                nodeService.hasAspect(record, RecordsManagementModel.ASPECT_DECLARED_RECORD);
