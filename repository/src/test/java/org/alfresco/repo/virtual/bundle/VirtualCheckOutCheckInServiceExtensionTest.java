...
public class VirtualCheckOutCheckInServiceExtensionTest
  ...
  public void testCheckOut() throws Exception {
    ...
    assertEquals(
      checkOutCheckInService.getWorkingCopy(originalContentNodeRef),
      workingCopy
    );
    ...
    NodeRef workingCopy1 = checkOutCheckInService.checkout(
      originalContentNodeRef,
    ...
    assertEquals(
      checkOutCheckInService.getWorkingCopy(physicalFileNodeRef),
      workingCopy1
    );
  ...
  public void testCheckIn() throws Exception {
    ...
    NodeRef origNodeRef = checkOutCheckInService.checkin(
  ...
  public void testGetWorkingCopy() throws Exception {
    NodeRef checkedOut = checkOutCheckInService.checkout(
      originalContentNodeRef
    );

    NodeRef workingCopy = checkOutCheckInService.getWorkingCopy(
      originalContentNodeRef
    );
    assertNotNull(workingCopy);
  ...
  public void testGetCheckedOut() throws Exception {
    ...
    NodeRef checkedOut = checkOutCheckInService.getCheckedOut(
      workingCopyVirtualContext
    );
    ...
    NodeRef checkedOut2 = checkOutCheckInService.getCheckedOut(
      originalContentNodeRef
    );
  ...
  public void testIsCheckedOut() throws Exception {
    ...
    boolean checkedOut = checkOutCheckInService.isCheckedOut(
      originalContentNodeRef
    );
  ...
  public void test_ACE_4699() throws Exception {
    ...
    assertNotNull(workingCopyVirtualContext);
    NodeRef cancelCheckoutNodeRef = checkOutCheckInService.cancelCheckout(
      workingCopyVirtualContext
    );
