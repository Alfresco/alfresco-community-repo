...
public class SiteServiceImplTest extends BaseAlfrescoSpringTest {
  ...
  private static final String TEST_DESCRIPTION =
    "DescriptionTest This is my description";
  ...
  private static final String USER_SITE_ADMIN =
    "UserSiteAdmin_SiteServiceImplTest";
  ...
  private static final String GROUP_ONE_DISPLAY =
    "DisplayOfGrpOne-SiteServiceImplTest";
  private static final String GROUP_TWO_DISPLAY =
    "DisplayOfGrpTwo-SiteServiceImplTest";
  ...
  public void before() throws Exception {
    ...
    RetryingTransactionCallback<Object> work = new RetryingTransactionCallback<Object>() {
      ...
      public Object execute() throws Throwable {
        ...
        actionService =
          (ActionService) applicationContext.getBean("actionService");
        transactionService =
          (TransactionService) applicationContext.getBean(
        ...
        scriptService =
          (ScriptService) applicationContext.getBean("ScriptService");
        nodeService = (NodeService) applicationContext.getBean("NodeService");
        authenticationComponent =
          (AuthenticationComponent) applicationContext.getBean(
            "authenticationComponent"
        ...
        siteServiceImpl =
          (SiteServiceImpl) applicationContext.getBean("siteService"); // Small 's'
        sysAdminParams =
        ...
        if (IS_FIRST_SETUP) {
          ...
          groupThree =
            authorityService.createAuthority(AuthorityType.GROUP, GROUP_THREE);
          authorityService.addAuthority(groupThree, USER_TWO);
          authorityService.addAuthority(groupThree, USER_THREE);

          groupFour =
            authorityService.createAuthority(AuthorityType.GROUP, GROUP_FOUR);
          ...
          groupThree =
            authorityService.getName(AuthorityType.GROUP, GROUP_THREE);
    ...
    transactionService
      ...
      .doInTransaction(work, false, true);
  }
  ...
  public void testCreateSite() throws Exception {
    ...
    assertEquals(
      ...
      this.siteService.getSiteShortName(siteNodeRef)
    );
  ...
  public void testConfigurableSitePublicGroup() throws Exception {
    ...
    ChildApplicationContextFactory sysAdminSubsystem = (ChildApplicationContextFactory) applicationContext.getBean(
      "sysAdmin"
    );
    ...
    try {
      ...
      SiteInfo unconfiguredSite = siteService.createSite(
        TEST_SITE_PRESET,
        "unconfigured",
        TEST_TITLE,
        TEST_DESCRIPTION,
      ...
      assertTrue(
        containsConsumerPermission(originalSitePublicGroup, unconfiguredSite)
      );
      ...
      String prefixedNewGroupName =
        PermissionService.GROUP_PREFIX + newGroupName;

      sysAdminSubsystem.stop();
      sysAdminSubsystem.setProperty(
        sitePublicGroupPropName,
        prefixedNewGroupName
      );
      ...
      if (!expectedExceptionThrown) {
        fail(
          "Expected exception on createSite with non-existent group was not thrown."
        );
      }
      ...
      SiteInfo configuredSite = siteService.createSite(
        TEST_SITE_PRESET,
        "configured",
        TEST_TITLE,
        TEST_DESCRIPTION,
  ...
  public void testListSites() throws Exception {
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites named 'mySiteO*'",
      1,
      sites.size()
    );
    ...
    assertEquals(
      "Matched wrong number of sites named 'One'",
      1,
      sitesFromFind.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites named 'description'",
      5,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites with PRESET_2",
      3,
      sites.size()
    );
      ...
      public Object execute() throws Throwable {
        ...
        try {
          ...
          for (String role : roleList) {
            ...
            List<String> list = siteServiceImpl.getMembersRoles(
              siteName,
              USER_ONE
            );
  ...
  public void testfindSitesWithWildcardTitles() throws Exception {
    ...
    assertEquals(
      "Matched wrong number of sites with title equal to 'asterix'",
      2,
      sites.size()
    );
  ...
  public void testfindSitesForLiveSearchWithWildcardTitles() throws Exception {
    ...
    // As the name & description do not contain "asterix", this will become a search for sites whose titles match "asterix"
    assertEquals(
      "Matched wrong number of sites with title equal to 'getafix'",
      2,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for tokenized search",
      1,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for super product",
      1,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for super launch",
      1,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for super exciting",
      2,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for amazing sales 54",
      1,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for wonderfulsupport32",
      1,
      sites.size()
    );
    ...
    assertNotNull(sites);
    assertEquals(
      "Matched wrong number of sites for great89service",
      1,
      sites.size()
    );
  ...
  public void testGetSite() {
    ...
    NodeRef siteContainer = siteServiceImpl.getSiteContainer(
      siteInfo.getShortName(),
      "folder.component",
      false,
      siteService,
    ...
    PagingResults<FileInfo> containers = siteService.listContainers(
      siteInfo.getShortName(),
  ...
  public void testMoveFolderStructureWithNonInheritedPermission() {
    ...
    NodeRef documentLibraryTest1Site = siteService.getContainer(
      test1SiteShortName,
      SiteService.DOCUMENT_LIBRARY
    );
    ...
    String test1SiteGroupPrefix = siteServiceImpl.getSiteGroup(
      test1SiteShortName,
      true
    );
    String test1SiteManagerAuthority =
      test1SiteGroupPrefix + "_" + SiteModel.SITE_MANAGER;
    permissionService.setPermission(
      fol2,
      test1SiteManagerAuthority,
      SiteModel.SITE_MANAGER,
      true
    );
    ...
    assertTrue(
      "Folder name should start with fol1",
      getFirstName(childAssocs).startsWith("fol1")
    );
    childAssocs = nodeService.getChildAssocs(childAssocs.get(0).getChildRef());
    assertEquals("Size should be 1", 1, childAssocs.size());
    assertTrue(
      "Folder name should start with fol2",
      getFirstName(childAssocs).startsWith("fol2")
    );
    childAssocs = nodeService.getChildAssocs(childAssocs.get(0).getChildRef());
    assertEquals("Size should be 1", 1, childAssocs.size());
    assertTrue(
      "Folder name should start with fol3",
      getFirstName(childAssocs).startsWith("fol3")
    );

    NodeRef documentLibraryTest2Site = siteService.getContainer(
      test2SiteShortName,
      SiteService.DOCUMENT_LIBRARY
    );
    ...
    ChildAssociationRef childAssociationRef = nodeService.moveNode(
      fol1,
    ...
    assertTrue(
      "test1Site document library should be empty.",
      childAssocs.isEmpty()
    );
  ...
  public void testDeleteSite() {
    @SuppressWarnings("deprecation")
    SiteService smallSiteService = (SiteService) this.applicationContext.getBean(
        "siteService"
      );
    // Create a test group
    ...
    for (String permission : permissions) {
      String siteRoleGroup =
        ((SiteServiceImpl) smallSiteService).getSiteRoleGroup(
            siteShortName,
            permission,
            true
          );
    ...
    RetryingTransactionCallback<Object> work = new RetryingTransactionCallback<Object>() {
      ...
      public Object execute() throws Throwable {
        ...
        try {
          ...
          fail(
            "A member who isn't a manager shouldnt be able to set memberships"
          );
        } catch (AlfrescoRuntimeException e) {
          // As expected
        }
  ...
  public void testListSiteMemberships() {
    RetryingTransactionCallback<Object> work = new RetryingTransactionCallback<Object>() {
      ...
      public Object execute() throws Throwable {
        ...
        // Get the members of the site and check that user one is a manager
        List<SiteMembership> members = siteService.listSiteMemberships(
          USER_ONE,
          0
        );
        assertNotNull(members);
        ...
        authenticationComponent.setCurrentUser(USER_ONE);
        PagingResults<SiteMembership> siteM = siteService.listSitesPaged(
          USER_ONE,
          null,
          new PagingRequest(1000)
        );
        ...
        assertEquals(
          moderatedSite,
          members.get(2).getSiteInfo().getShortName()
        );
  ...
  public void testJoinLeave() {
    RetryingTransactionCallback<Object> work = new RetryingTransactionCallback<Object>() {
      @Override
      public Object execute() throws Throwable {
        String testMembershipPublic =
          "testMembershipPublic" + UUID.randomUUID();
        String testMembershipPrivate =
          "testMembershipPrivate" + UUID.randomUUID();
        // Create a site as user one
        siteService.createSite(
          TEST_SITE_PRESET,
        ...
        try {
          ...
          fail(
            "This should have failed because you can't do this to a private site unless you are site manager"
          );
        } catch (AlfrescoRuntimeException exception) {
          // Ignore because as expected
        }
        ...
        try {
          ...
          fail(
            "This should have failed because you can't add another user as a consumer of a public site"
          );
        } catch (AlfrescoRuntimeException exception) {
          // Ignore because as expected
        }
  ...
  public void testContainer() {
    ...
    boolean hasContainer =
      this.siteService.hasContainer(
          siteInfo.getShortName(),
          "folder.component"
        );
    assertFalse(hasContainer);
    NodeRef container1 =
      this.siteService.getContainer(
          siteInfo.getShortName(),
          "folder.component"
        );
  ...
  public void testCustomSiteProperties() {
    QName additionalInformationQName = QName.createQName(
      SiteModel.SITE_CUSTOM_PROPERTY_URL,
    ...
    assertEquals(
      "information",
      siteInfo.getCustomProperty(additionalInformationQName)
    );
    assertNotNull(siteInfo.getCustomProperties());
    ...
    assertEquals(
      "information",
      siteInfo.getCustomProperties().get(additionalInformationQName)
    );
  }
  ...
  public void testCustomSiteType() {
    ...
    DictionaryDAO dictionaryDAO = (DictionaryDAO) this.applicationContext.getBean(
        "dictionaryDAO"
      );
    ...
    final QName customTypeQ = QName.createQName(
      "cs",
      "customSite",
      namespaceService
    );
    ...
    PermissionService testPermissionService = spy(
      (PermissionService) this.applicationContext.getBean(
    ...
    SiteServiceImpl siteServiceImpl = (SiteServiceImpl) this.applicationContext.getBean(
        "siteService"
      );
  ...
  public void testGroupMembership() {
    RetryingTransactionCallback<Object> work = new RetryingTransactionCallback<Object>() {
      ...
      public Object execute() throws Throwable {
        ...
        members =
          siteService.listMembers(testGroupMembership, null, null, 0, true);
        assertNotNull(members);
        assertEquals(3, members.size());
        assertTrue(members.containsKey(USER_ONE));
        assertEquals(SiteModel.SITE_MANAGER, members.get(USER_ONE));
  ...
  public void testSiteVisibility() {
    RetryingTransactionCallback<Object> work = new RetryingTransactionCallback<Object>() {
      ...
      public Object execute() throws Throwable {
        // Create a public site
        SiteInfo siteInfo = createTestSiteWithContent(
        ...
        SiteInfo changeSite = createTestSiteWithContent(
  ...
  private Map<String, Set<String>> getAllowedPermissionsMap(NodeRef nodeRef) {
    ...
    for (AccessPermission ap : permissionService.getAllSetPermissions(
      nodeRef
    )) {
  ...
  public void testNonDefaultPublicGroupPermissions() throws Exception {
    ...
    assertEquals(
      ...
      sysAdminParams.getSitePublicGroup()
    );
    ...
    assertTrue(
      getAllowedPermissionsMap(s2)
        .get(groupFour)
        .contains(SiteModel.SITE_CONSUMER)
    );
    assertTrue(
      getAllowedPermissionsMap(s3)
        .get(groupFour)
    ...
    assertEquals(
      SiteModel.SITE_MANAGER,
      siteService.getMembersRole(s1.getShortName(), USER_ONE)
    );
    assertEquals(
      SiteModel.SITE_MANAGER,
      siteService.getMembersRole(s2.getShortName(), USER_ONE)
    );
    assertEquals(
      SiteModel.SITE_MANAGER,
      siteService.getMembersRole(s3.getShortName(), USER_ONE)
    );
  ...
  private SiteInfo createTestSiteWithContent(
    ...
    return this.createTestSiteWithContent(
        siteShortName,
        componentId,
        visibility,
        ""
  ...
  private SiteInfo createTestSiteWithContent(
    ...
    ContentWriter writer =
      this.fileFolderService.getWriter(fileInfo.getNodeRef());
    ...
    ContentWriter writer2 =
      this.fileFolderService.getWriter(fileInfo2.getNodeRef());
    ...
    ContentWriter writer3 =
      this.fileFolderService.getWriter(fileInfo3.getNodeRef());
  ...
  public void testALFCOM_3109() {
    ...
    Map<String, String> members =
      this.siteService.listMembers(siteName, null, null, 0);
  ...
  public void testALF_3200() throws Exception {
    ...
    assertEquals(
      TEST_TITLE,
      nodeService.getProperty(siteNodeRef, ContentModel.PROP_TITLE)
    );
  ...
  private void alf8036Impl(boolean copyNotMove) {
    ...
    SiteInfo fromSite =
      this.createTestSiteWithContent(
          "fromSite",
          "doclib",
          SiteVisibility.PUBLIC,
          "FROM"
    ...
    NodeRef fromDoclibContainer = nodeService.getChildByName(
      fromSite.getNodeRef(),
      ContentModel.ASSOC_CONTAINS,
      "doclib"
    );
    assertNotNull(fromDoclibContainer);
    NodeRef fromFolder = nodeService.getChildByName(
      fromDoclibContainer,
      ContentModel.ASSOC_CONTAINS,
      "FROMfolder"
    );
    assertNotNull(fromFolder);
    NodeRef fromSubFolder = nodeService.getChildByName(
      fromFolder,
      ContentModel.ASSOC_CONTAINS,
      "FROMsubfolder"
    );
    ...
    NodeRef toDoclibContainer = nodeService.getChildByName(
      toSite.getNodeRef(),
      ContentModel.ASSOC_CONTAINS,
      "doclib"
    );
    assertNotNull(toDoclibContainer);
    NodeRef toFolder = nodeService.getChildByName(
      toDoclibContainer,
      ContentModel.ASSOC_CONTAINS,
      "TOfolder"
    );
    ...
    validatePermissionsOnRelocatedNode(
      fromSite,
      toSite,
      relocatedNode,
      expectedPermissions
    ...
    NodeRef copyOfSubFolder = nodeService.getChildByName(
      relocatedNode,
      ContentModel.ASSOC_CONTAINS,
      "FROMsubfolder"
    );
  ...
  public void testALF_1017_nonSitesInSitesSpace() throws Exception {
    ...
    final NodeRef folder = AuthenticationUtil.runAsSystem(
    ...
    final NodeRef document = AuthenticationUtil.runAsSystem(
      new RunAsWork<NodeRef>() {
        @Override
        public NodeRef doWork() throws Exception {
          return nodeService
  ...
  private void validatePermissionsOnRelocatedNode(
    ...
    for (String sitePermission : SiteModel.STANDARD_PERMISSIONS) {
      String siteRoleGroup = siteServiceImpl.getSiteRoleGroup(
        fromSite.getShortName(),
        sitePermission,
        true
      );
      ...
      assertNull(
        "Permission " + siteRoleGroup + " was unexpectedly present",
        ap
      );
    }
  ...
  public void testJSAPI() throws Exception {
    ...
    ScriptLocation location = new ClasspathScriptLocation(
      "org/alfresco/repo/site/script/test_siteService.js"
    );
  ...
  public void testListMembersInfo() {
    ...
    members =
      this.siteService.listMembersInfo(siteShortName, null, null, 0, true);
    assertNotNull(members);
  ...
  private SiteMemberInfo lookupMemberInfoByUserName(
    List<SiteMemberInfo> members,
    String name
  ) {
  ...
  public void testPrivateSite() throws Exception {
    ...
    NodeRef container =
      this.siteService.getContainer(siteInfo.getShortName(), "doclib");
  ...
  public void testDeleteSiteAsAdministrator() throws Exception {
    ...
    try {
      ...
      fail(
        "We should not reach this point. the user that tries to run this code, add the file, is not yet a member of the site"
      );
