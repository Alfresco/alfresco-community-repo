...
public class PermissionServiceTest extends AbstractPermissionTest {
  ...
  public void testAnyDenyDeniesAndRead() {
    ...
    try {
      ...
      assertTrue(
        permissionService.hasReadPermission(one) == AccessStatus.ALLOWED
      );
      assertTrue(
        permissionService.hasReadPermission(two) == AccessStatus.ALLOWED
      );
      assertTrue(
        permissionService.hasReadPermission(three) == AccessStatus.ALLOWED
      );
      assertTrue(
        permissionService.hasReadPermission(four) == AccessStatus.ALLOWED
      );
    ...
    assertTrue(
      permissionService.hasReadPermission(three) == AccessStatus.DENIED
    );
    assertTrue(
      permissionService.hasReadPermission(four) == AccessStatus.DENIED
    );
  ...
  public void testDelete() {
    if (
      aclDaoComponent.getDefaultProperties().getAclType() == ACLType.DEFINING
    ) {
  ...
  public void testGetAllSetPermissions() {
    ...
    while (current != null) {
      Set<AccessPermission> morePermissions = permissionService.getAllSetPermissions(
        current
      );
  ...
  public void testSetInheritFalse() {
    ...
    assertFalse(
      permissionService.getSetPermissions(rootNodeRef).inheritPermissions()
    );
    assertEquals(
      rootNodeRef,
      permissionService.getSetPermissions(rootNodeRef).getNodeRef()
    );
    assertEquals(
      0,
      permissionService
  ...
  public void testSetInheritTrue() {
    ...
    permissionService.deletePermissions(
      permissionService.getSetPermissions(rootNodeRef)
    );
  }
  ...
  private void printPermissions(NodeRef nodeRef, String path) {
    ...
    for (AccessControlEntry entry : aclDaoComponent
      .getAccessControlList(id)
      .getEntries()) {
  ...
  public void testSetNodePermissionEntry() {
    ...
    SimpleNodePermissionEntry entry = new SimpleNodePermissionEntry(
      rootNodeRef,
      false,
      entries
    );
  ...
  public void testSetPermissionEntryElements() {
    ...
    for (PermissionEntry pe : permissionService
      .getSetPermissions(rootNodeRef)
      .getPermissionEntries()) {
  ...
  public void testGetSettablePermissionsForType() {
    Set<String> answer = permissionService.getSettablePermissions(
  ...
  public void testSimplePermissionOnStore() {
    ...
    NodePermissionEntry entry = permissionService.getSetPermissions(
      testStoreRef
    );
    assertNotNull(entry);
    ...
    assertEquals(
      0,
      permissionService.getAllSetPermissions(testStoreRef).size()
    );
  ...
  public void testSimplePermissionOnRoot() {
    ...
    assertEquals(
      0,
      countGranted(permissionService.getPermissions(rootNodeRef))
    );
  ...
  public void testPerformance() throws Exception {
    ...
    System.out.println(
      "Can per second " + (1 / ((end - start) / 1e9f / 10000))
    );
  }
  ...
  public void testChildrenRequirements() {
    ...
    assertFalse(
      permissionService.hasPermission(
        rootNodeRef,
        getPermission(PermissionService.DELETE_CHILDREN)
      ) ==
      AccessStatus.ALLOWED
    );
    assertFalse(
      permissionService.hasPermission(
        rootNodeRef,
        getPermission(PermissionService.DELETE_NODE)
      ) ==
      AccessStatus.ALLOWED
    );
    runAs("lemur");
  ...
  public void testPreserveAuditableData() {
    ADMAccessControlListDAO accessControlListDao = (ADMAccessControlListDAO) applicationContext.getBean(
      "admNodeACLDAO"
    );
    ...
    try {
      ...
      assertEquals(
        "admin",
        nodeService.getProperty(content1, ContentModel.PROP_MODIFIER)
      );
      ...
      assertEquals(
        "andy",
        nodeService.getProperty(content2, ContentModel.PROP_MODIFIER)
      );
    } finally {
  ...
  public void xtestFindNodesByPermission() {
    ...
    personService.getPerson("andy");
    String groupAuth = authorityService.createAuthority(
      AuthorityType.GROUP,
      "G"
    );
  ...
  public void testPermissionPolicies() {
    ...
    OnGrantLocalPermission onGrantLocalPermission = createClassPolicy(
    ...
    OnRevokeLocalPermission onRevokeLocalPermission = createClassPolicy(
    ...
    verify(onRevokeLocalPermission)
      .onRevokeLocalPermission(rootNodeRef, null, null);

    //test that OnInheritPermissionsEnabled is invoked when permission inheritance is disabled
    OnInheritPermissionsDisabled onInheritPermissionsDisabled = createClassPolicy(
    ...
    verify(onInheritPermissionsDisabled)
      .onInheritPermissionsDisabled(rootNodeRef, false);
    ...
    OnInheritPermissionsEnabled onInheritPermissionsEnabled = createClassPolicy(
    ...
    verify(onInheritPermissionsEnabled)
      .onInheritPermissionsEnabled(rootNodeRef);
  }
  ...
  public void testDeletePermissions() {
    ...
    verify(onRevokeLocalPermission)
      .onRevokeLocalPermission(siteInfo.getNodeRef(), null, null);
  }
