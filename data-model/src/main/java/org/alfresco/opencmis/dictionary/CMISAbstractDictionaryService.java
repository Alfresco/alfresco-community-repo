 ...
 */
public abstract class CMISAbstractDictionaryService extends AbstractLifecycleBean
    ...
    protected CMISDictionaryRegistry createCoreDictionaryRegistry() {
        CMISDictionaryRegistryImpl cmisRegistry =
                new CMISDictionaryRegistryImpl(
                        this, cmisMapping, dictionaryService, getCoreDictionaryInitializer());
        cmisRegistry.init();
        return cmisRegistry;
    }
    ...
    public List<TypeDefinitionWrapper> getAllTypes(boolean includeParent) {
        // TODO is there a way of not having to reconstruct this every time?
        return Collections.unmodifiableList(
                new ArrayList<TypeDefinitionWrapper>(getRegistry().getTypeDefs(includeParent)));
    }
