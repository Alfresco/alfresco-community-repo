...
/**
 * Process related Rest api tests using http client to communicate with the rest apis in the
 * repository.
 *
...
public class ProcessWorkflowApiTest extends EnterpriseWorkflowTestApi {
    ...
    public void testCreateProcessInstanceWithId() throws Exception {
        ...
        assertEquals(
                processInstance.getProcessDefinitionId(), processRest.getProcessDefinitionId());
        ...
        Map<String, Object> variables =
                activitiProcessEngine.getRuntimeService().getVariables(processRest.getId());
    ...
    public void testMethodNotAllowedURIs() throws Exception {
        ...
        try {
            response =
                    publicApiClient.get(
                            "public", "processes", processInfo.getId(), null, null, null);
            assertEquals(200, response.getStatusCode());
            response =
            ...
            response =
                    publicApiClient.put(
                            "public", "processes", processInfo.getId(), null, null, null, null);
            assertEquals(405, response.getStatusCode());

            response =
                    publicApiClient.get(
                            "public", "processes", processInfo.getId(), "activities", null, null);
            assertEquals(200, response.getStatusCode());
            response =
                    publicApiClient.post(
                            "public", "processes", processInfo.getId(), "activities", null, null);
            ...
            response =
                    publicApiClient.delete(
                            "public", "processes", processInfo.getId(), "activities", null);
            assertEquals(405, response.getStatusCode());
            response =
                    publicApiClient.put(
                            "public",
            ...
            response =
                    publicApiClient.get(
                            "public", "processes", processInfo.getId(), "tasks", null, null);
            assertEquals(200, response.getStatusCode());
            response =
                    publicApiClient.post(
                            "public", "processes", processInfo.getId(), "tasks", null, null);
            ...
            response =
                    publicApiClient.delete(
                            "public", "processes", processInfo.getId(), "tasks", null);
            assertEquals(405, response.getStatusCode());
            response =
                    publicApiClient.put(
                            "public", "processes", processInfo.getId(), "tasks", null, null, null);
            assertEquals(405, response.getStatusCode());
        } finally {
    ...
    public void testCreateProcessInstanceWithItems() throws Exception {
        ...
        final Map<String, Object> variables =
                activitiProcessEngine.getRuntimeService().getVariables(processRest.getId());
        assertEquals(1, variables.get("bpm_priority"));
        final ActivitiScriptNode packageScriptNode =
                (ActivitiScriptNode) variables.get("bpm_package");
        ...
        TenantUtil.runAsUserTenant(
                new TenantRunAsWork<Void>() {
                    @Override
                    public Void doWork() throws Exception {
                        List<ChildAssociationRef> documentList =
                                nodeService.getChildAssocs(packageScriptNode.getNodeRef());
                        for (ChildAssociationRef childAssociationRef : documentList) {
                            FavouriteDocument doc =
                                    getTestFixture()
                                            .getRepoService()
                                            .getDocument(
                                                    requestContext.getNetworkId(),
    ...
    public void testGetProcessInstanceById() throws Exception {
        ...
        try {
            ...
            final Map<String, Object> variables =
                    activitiProcessEngine.getRuntimeService().getVariables(processInfo.getId());
            assertEquals(1, variables.get("bpm_priority"));
            ...
            assertEquals(
                    processInstance.getProcessDefinitionId(), processInfo.getProcessDefinitionId());
            ...
            TenantUtil.runAsUserTenant(
                    new TenantRunAsWork<Void>() {
                        @Override
                        public Void doWork() throws Exception {
                            // now complete the process and see if ending info is available in the
                            // REST response
                            Task task =
                                    activitiProcessEngine
                                            .getTaskService()
    ...
    public void testDeleteProcessInstanceById() throws Exception {
        ...
        String tenantAdmin =
                AuthenticationUtil.getAdminUserName() + "@" + requestContext.getNetworkId();
        final RequestContext adminContext =
                new RequestContext(requestContext.getNetworkId(), tenantAdmin);
    ...
    public void testGetProcessInstancesWithPaging() throws Exception {
        ...
        try {
            ...
            // Repository must answer 'false' for 'hasMoreItems' since the total number of items is
            // 3, 2 items are requested and 1 is skipped
            assertEquals(false, paginationJSON.get("hasMoreItems"));
            jsonEntries = (JSONArray) processListJSONObject.get("entries");
            assertEquals(2, jsonEntries.size());
    ...
    public void testGetProcessTasks() throws Exception {
        ...
        String otherPerson =
                getOtherPersonInNetwork(
                        ...
                        .getId();
        RequestContext otherPersonContext =
        ...
        try {
            ...
            assertEquals(
                    process1.getProcessDefinitionId(), taskJSONObject.get("processDefinitionId"));
            ...
            try {
                ...
                assertErrorSummary(
                        "The entity with id: fakeid was not found", expected.getHttpResponse());
            }
    ...
    public void testMNT12382() throws Exception {
        ...
        RequestContext requestContext =
                new RequestContext(currentNetwork.getId(), initiator.getId());
        publicApiClient.setRequestContext(requestContext);
        ...
        final MemberOfSite memberOfSite =
                currentNetwork.getSiteMemberships(initiator.getId()).get(0);
    ...
    public void testGetProcessItem() throws Exception {
        ...
        ProcessesClient processesClient = publicApiClient.processesClient();
        JSONObject itemJSON =
                processesClient.findProcessItem(newProcessInstanceId, docNodeRefs[0].getId());
        ...
        try {
            ...
            try {
                processesClient.addProcessItem(
                        newProcessInstanceId, createItemObject.toJSONString());
    ...
    public void testGetProcessVariables() throws Exception {
        ...
        try {
            ...
            JSONObject processvariables =
                    publicApiClient.processesClient().getProcessvariables(processInstanceId);
    ...
    public void testDeleteProcessVariable() throws Exception {
        ...
        try {
            ...
            assertFalse(
                    activitiProcessEngine.getRuntimeService().hasVariable(processId, "deleteMe"));
            ...
            try {
                ...
                assertEquals(
                        HttpStatus.NOT_FOUND.value(), expected.getHttpResponse().getStatusCode());
                assertErrorSummary(
                        "The entity with id: deleteMe was not found", expected.getHttpResponse());
            }
        } finally {
            cleanupProcessInstance(processRest.getId());
        }
