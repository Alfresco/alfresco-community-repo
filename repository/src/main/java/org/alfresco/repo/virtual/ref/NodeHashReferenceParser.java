...
public class NodeHashReferenceParser extends ProtocolHashParser {
    ...
    public NodeHashReferenceParser(
            HashStore classpathHashStore, HashReferenceParser referenceParser) {
    ...
    public Reference parse(Cursor cursor) throws ReferenceParseException {
        ...
        return NodeProtocol.newReference(Encodings.HASH.encoding, resource, parentReference);
    }
}
