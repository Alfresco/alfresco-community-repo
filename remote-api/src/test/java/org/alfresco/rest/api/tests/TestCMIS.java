...
public class TestCMIS extends EnterpriseTestApi {
  ...
  private static final String DOCUMENT_LIBRARY_CONTAINER_NAME =
    "documentLibrary";
  ...
  private static final String TEST_DOCUMENT_NAME_PATTERN =
    "testDocument-%s.txt";
  ...
  public void before() throws Exception {
    ...
    this.fileFolderService =
      (FileFolderService) ctx.getBean("FileFolderService");
    this.contentService =
  ...
  private NodeRef makeRenditionNode(
    NodeRef parent,
    String title,
    String name,
    String mimetype
  ...
  private String getTestFileIdWithTwoRenditionsOneSourceAndTwoTargetAssociations()
    ...
    if (testFileIdWithTwoRenditions == null) {
      ...
      NodeRef fileNode = TenantUtil.runAsUserTenant(
        new TenantRunAsWork<NodeRef>() {
          @Override
          public NodeRef doWork() throws Exception {
            NodeRef documentLibrary = testSite.getContainerNodeRef(
              "documentLibrary"
            );
            NodeRef folder = repoService.createFolder(
              documentLibrary,
              "myFoder"
            );
            NodeRef testFile1 = repoService.createDocument(
              folder,
              "testdoc1.txt",
              "Test title 1",
              "Test description 1",
            ...
            NodeRef testFile0 = repoService.createDocument(
              folder,
              "testdoc0.txt",
              "Test title 0",
              "Test description 0",
            ...
            NodeRef testFile2 = repoService.createDocument(
              folder,
              "testdoc2.txt",
              "Test title 2",
              "Test description 2",
            ...
            NodeRef testFile3 = repoService.createDocument(
              folder,
              "testdoc3.txt",
              "Test title 3",
              "Test description 3",
  ...
  private void assertGetIdFilterParams(
    ...
    publicApiClient.setRequestContext(
      new RequestContext(testNetwork.getId(), testPersonId)
    );
    HttpResponse resp = publicApiClient.get(
      Binding.atom,
      CMIS_VERSION_11,
      "id",
      reqParams
    ...
    if (expectedProperties >= 0) {
      String fragment = assertSubstring(
        "Properties",
        xml,
        expectedProperties,
        "cmisra:object"
  ...
  private String assertSubstring(
    String message,
    String string,
    int expected,
    String tag
  ...
  public void testBrowserBindingRoot() throws Exception {
    ...
    publicApiClient.setRequestContext(
      new RequestContext(network1.getId(), personId)
    );

    HttpResponse response = publicApiClient.get(
      network1.getId() + "/public/cmis/versions/1.1/browser/root",
      null
    );
  ...
  public void testBrowserDisabledJSONPCallback() throws Exception {
    ...
    final PublicApiBrowserCMISDispatcher dispatcher = ctx.getBean(
      PublicApiBrowserCMISDispatcher.class
    );
    ...
    String exceptionMessage = I18NUtil.getMessage(
      JsonpCallbackNotAllowedException.DEFAULT_MESSAGE_ID,
      params
    );
  ...
  public void testSetMaxContentSize() throws Exception {
    ...
    CmisSession cmisSessionAtom = publicApiClient.createPublicApiCMISSession(
      Binding.atom,
      CMIS_VERSION_11,
      AlfrescoObjectFactoryImpl.class.getName()
    );
    CmisSession cmisSessionBrowser = publicApiClient.createPublicApiCMISSession(
      Binding.browser,
      CMIS_VERSION_11,
      AlfrescoObjectFactoryImpl.class.getName()
    );
    Folder documentLibrary = (Folder) cmisSessionAtom.getObjectByPath(
    ...
    PublicApiAlfrescoCmisServiceFactory publicApiAlfrescoCmisServiceFactory = (PublicApiAlfrescoCmisServiceFactory) ctx.getBean(
      "publicApiCMISServiceFactory"
    );
    ...
    // for atom
    fc.position(0);
    Document result = cmisSessionAtom.createDocument(
      documentLibrary.getId(),
      fileName,
      properties,
      contentStream,
  ...
  public void testCMIS() throws Exception {
    ...
    CmisSession cmisSession = publicApiClient.createPublicApiCMISSession(
      Binding.atom,
      CMIS_VERSION_10,
      AlfrescoObjectFactoryImpl.class.getName()
    );
    ...
    Document doc = null;
    Folder documentLibrary = (Folder) cmisSession.getObjectByPath(
      "/Sites/" + site.getSiteId() + "/documentLibrary"
    );
    FolderNode expectedDocumentLibrary = (FolderNode) CMISNode.createNode(
      documentLibrary
    );
    ...
    // try to add and remove ratings, comments, tags to folders created by CMIS
    {
      ...
      NodeRating rating = nodesProxy.createNodeRating(
        testFolder.getId(),
        expectedNodeRating
      );
      ...
      Comment comment = commentsProxy.createNodeComment(
        testFolder.getId(),
        expectedComment
      );
    ...
    // descendants
    {
      List<Tree<FileableCmisObject>> descendants = documentLibrary.getDescendants(
        4
      );
    ...
    // upload/setContent
    {
      ...
      ContentReader reader = TenantUtil.runAsUserTenant(
        new TenantRunAsWork<ContentReader>() {
          @Override
          public ContentReader doWork() throws Exception {
            ContentReader reader = repoService.getContent(
              nodeRef,
              ContentModel.PROP_CONTENT
            );
            return reader;
    ...
    // versioning
    {
      ...
      Boolean isCheckedOut = TenantUtil.runAsUserTenant(
      ...
      ObjectId checkinId = pwc.checkIn(
        true,
...

    {
...

      {
        ...
        Document autoVersionedDoc = documentLibrary.createDocument(
          fileProps,
          fileContent,
          VersioningState.MAJOR
        );
        ...
        Boolean autoVersion = TenantUtil.runAsUserTenant(
          new TenantRunAsWork<Boolean>() {
            @Override
            public Boolean doWork() throws Exception {
              Boolean autoVersion = (Boolean) repoService.getProperty(
                nodeRef,
  ...
  public void testInvalidMethods() throws Exception {
    ...
    try {
      publicApiClient.setRequestContext(
        new RequestContext(network1.getId(), person)
      );
  ...
  public void testPublicApi110() throws Exception {
    ...
    TenantUtil.runAsUserTenant(
      new TenantRunAsWork<Void>() {
        ...
        public Void doWork() throws Exception {
          ...
          SiteInformation siteInfo2 = new SiteInformation(
            siteName2,
            siteName2,
            siteName2,
            SiteVisibility.PRIVATE
          ...
          NodeRef nodeRef1 = repoService.createDocument(
          ...
          nodes.add(nodeRef1);
          NodeRef nodeRef2 = repoService.createDocument(
            site1.getContainerNodeRef(DOCUMENT_LIBRARY_CONTAINER_NAME),
            "Test Doc2",
            "Test Doc2 Title",
          ...
          nodes.add(nodeRef2);
          NodeRef nodeRef3 = repoService.createDocument(
...

    {
      ...
      cmisOperationCtxOverride.setIncludeRelationships(
      ...
      String sourceVersionSeriesId = (String) source
        .getProperty(PropertyIds.VERSION_SERIES_ID)
        .getFirstValue();
      String targetVersionSeriesId = (String) target
        .getProperty(PropertyIds.VERSION_SERIES_ID)
        .getFirstValue();
  ...
  public void testObjectIds() throws Exception {
    ...
    AuthenticationUtil.runAs(
      new RunAsWork<Void>() {
        ...
        public Void doWork() throws Exception {
          ...
          NodeRef folderNodeRef = repoService.createFolder(
          ...
          name = GUID.generate();
          NodeRef docNodeRef = repoService.createDocument(
            folderNodeRef,
            name,
            "test content"
          );
    ...
    CmisSession cmisSession = publicApiClient.getCMISSession(
      repositories.get(0)
    );
    ...
    // query
    {
      ...
      // NodeRef input
      List<CMISNode> results = cmisSession.query(
      ...
      for (CMISNode node : results) {
        String objectId = stripCMISSuffix(
          (String) node.getProperties().get(PropertyIds.OBJECT_ID)
        );
    ...
    publicApiClient.setRequestContext(
      new RequestContext(network1.getId(), person1Id)
    );
  ...
  @Test
  @Ignore(
    "Quarantined since 24 Sep 2018. TestCMIS.testAspects:1546->checkSecondaryTypes:492 Missing secondary types: [P:cm:titled, P:sys:localized]"
  )
  public void testAspects() throws Exception {
    ...
    CmisSession atomCmisSession10 = publicApiClient.createPublicApiCMISSession(
      Binding.atom,
      CMIS_VERSION_10,
      AlfrescoObjectFactoryImpl.class.getName()
    );
    CmisSession atomCmisSession11 = publicApiClient.createPublicApiCMISSession(
      Binding.atom,
      CMIS_VERSION_11
    );
    CmisSession browserCmisSession11 = publicApiClient.createPublicApiCMISSession(
      Binding.browser,
      CMIS_VERSION_11
    );
    ...
    // 1.0
    {
      AlfrescoDocument doc = (AlfrescoDocument) atomCmisSession10.getObject(
        doc1NodeRef.getId()
      );
    ...
    {
      final Document doc = (Document) atomCmisSession11.getObject(
        doc2NodeRef.getId()
      );
      ...
      checkSecondaryTypes(
        ...
        new HashSet<String>(
          Arrays.asList(
            new String[] { "P:sys:temporary", "P:cm:titled", "P:cm:author" }
          )
        ),
        null
      );
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Void>() {
          ...
          public Void doWork() throws Exception {
            Set<QName> aspects = repoService.getAspects(doc2NodeRef);
            String title = (String) repoService.getProperty(
              doc2NodeRef,
    ...
    {
      Document doc = (Document) browserCmisSession11.getObject(
        doc3NodeRef.getId()
      );
      final List<SecondaryType> secondaryTypesList = doc.getSecondaryTypes();
      final List<String> secondaryTypes = new ArrayList<String>();
  ...
  public void testTypeFiltering() throws Exception {
    ...
    QName type = QName.createQName(
      "{http://www.alfresco.org/test/testCMIS}type1"
    );
  ...
  public void testCreationDate() throws Exception {
    ...
    TenantUtil.runAsUserTenant(
      new TenantRunAsWork<NodeRef>() {
        ...
        public NodeRef doWork() throws Exception {
          ...
          final NodeRef resNode = repoService.createDocument(
    ...
    AlfrescoFolder docLibrary = (AlfrescoFolder) cmisSession.getObjectByPath(
    ...
    Document autoVersionedDoc = docLibrary.createDocument(
      properties,
      fileContent,
      VersioningState.MAJOR
    );
    ...
    GregorianCalendar cDateFirst = cmisSession
      .getAllVersions(bareObjectId)
      .get(0)
      .getCreationDate();
    GregorianCalendar cDateSecond = cmisSession
      .getAllVersions(bareObjectId)
      .get(2)
      .getCreationDate();
  ...
  public void testVersioning() throws Exception {
    ...
    AlfrescoDocument doc = (AlfrescoDocument) docLibrary.createDocument(
      properties,
      fileContent,
      VersioningState.MAJOR
    );
    ...
    assertTrue(
      Float.parseFloat(versionLabel) < Float.parseFloat(versionLabel1)
    );
    ...
    AlfrescoDocument doc2 = (AlfrescoDocument) doc1.getObjectOfLatestVersion(
      false
    );
  ...
  public void testVersioningUsingUpdateProperties() throws Exception {
    ...
    String nodeRefStr = doc
      .getPropertyValue(NodeRefProperty.NodeRefPropertyId)
      .toString();
    ...
    AlfrescoDocument doc1 = (AlfrescoDocument) doc
    ...
    assertTrue(
      Double.parseDouble(versionLabel) < Double.parseDouble(versionLabel1)
    );
    ...
    assertTrue(
      "It should be latest version : " + versionLabel2,
      doc2.isLatestVersion()
    );

    doc2.deleteContentStream();
    AlfrescoDocument doc3 = (AlfrescoDocument) doc2.getObjectOfLatestVersion(
      false
    );
    ...
    assertTrue(
      "It should be latest version : " + versionLabel3,
      doc3.isLatestVersion()
    );
  }
    ...
    NodeRef fileNode = TenantUtil.runAsUserTenant(
      new TenantRunAsWork<NodeRef>() {
        ...
        public NodeRef doWork() throws Exception {
          ...
          NodeRef resNode = repoService.createDocument(
            site.getContainerNodeRef("documentLibrary"),
            "testdoc \u0010.txt",
            "Test Doc1 Title \u0010",
            "d\u0010",
  ...
  public void testGetXmlWithCorrectCurrencySymbols() throws Exception {
    ...
    String description = (String) doc
      .getProperty("cm:description")
      .getFirstValue();
  ...
  public void testALF19320() throws Exception {
    ...
    Map<String, String> properties = new HashMap<String, String>();
    {
      ...
      properties.put(
        ...
        "cmis:document,P:cm:titled,P:cm:author"
      );
      properties.put(PropertyIds.NAME, "mydoc-" + GUID.generate() + ".txt");
    }
    ContentStreamImpl fileContent = new ContentStreamImpl();
    ...
    AlfrescoDocument doc1 = (AlfrescoDocument) doc.getObjectOfLatestVersion(
      false
    );
    String versionLabel1 = doc1.getVersionLabel();
  ...
  public void testAppendContentVersioning() throws Exception {
    ...
    Folder docLibrary = (Folder) cmisSession.getObjectByPath(
      "/Sites/" + siteName + "/documentLibrary"
    );
    ...
    Document doc = docLibrary.createDocument(
      properties,
      fileContent,
      VersioningState.MAJOR
    );
    String versionLabel1 = doc
      .getObjectOfLatestVersion(false)
      .getVersionLabel();
  ...
  public void testAppendContentStream() throws Exception {
    ...
    assertEquals(
      "Ipsum and so onIpsum and so onIpsum and so onIpsum and so onIpsum and so onIpsum and so onIpsum and so on",
      content
    );
  }
  ...
  public void testSecondaryTypes() throws Exception {
...

    {
      // check that the secondary types and properties are present
      {
        checkSecondaryTypes(
          doc,
          Collections.singleton("P:cm:summarizable"),
          null
        );
      ...
      {
        doc =
          (Document) cmisSession.getObjectByPath(
  ...
  public void testMNT_10161() throws Exception {
    ...
    Document doc = (Document) cmisSession.getObjectByPath(
      "/Sites/" + siteName + "/documentLibrary/" + nodeName + "/" + nodeName
    );
  ...
  public void testMNT_10687() throws Exception {
    ...
    ContentStream contentStream = doc
      .getObjectOfLatestVersion(false)
      .getContentStream();
    InputStream in = contentStream.getStream();
    StringWriter writer = new StringWriter();
  ...
  public void testMNT_13057() throws Exception {
    ...
    HttpResponse response = publicApiClient.get(
      network1.getId() +
      "/public/cmis/versions/1.1/atom/content/" +
      urlFileName,
      null
    );
    assertEquals(200, response.getStatusCode());
  ...
  public void testMNT10430() throws Exception {
    ...
    List<String> mandatoryAspects =
      ((AlfrescoType) objectType).getMandatoryAspects();
  ...
  public void testContentDisposition_MNT_17477() throws Exception {
    ...
    assertEquals(200, response.getStatusCode());
    assertTrue(
      response.getHeaders().get("Content-Disposition").startsWith("inline")
    );
    ...
    assertEquals(200, response.getStatusCode());
    assertTrue(
      response.getHeaders().get("Content-Disposition").startsWith("attachment")
    );
  ...
  public void testDeleteNonCurrentVersion() throws Exception {
    ...
    Folder homeFolder = (Folder) cmisSession.getObjectByPath(
      "/User Homes/" + personId
    );
    ...
    ByteArrayInputStream stream = new ByteArrayInputStream(
      GUID.generate().getBytes()
    );
    fileContent.setMimeType(MimetypeMap.MIMETYPE_TEXT_PLAIN);
    fileContent.setStream(stream);

    Document doc = homeFolder.createDocument(
      properties,
      fileContent,
      VersioningState.MAJOR
    );
    ...
    PersonInfo person2Info = new PersonInfo(
      username2,
      username2,
      username2,
      TEST_PASSWORD,
    ...
    publicApiClient.setRequestContext(
      new RequestContext(network1.getId(), person2Id)
    );
    CmisSession cmisSession2 = publicApiClient.createPublicApiCMISSession(
      Binding.browser,
      CMIS_VERSION_11,
      AlfrescoObjectFactoryImpl.class.getName()
    );

    CmisObject docVersionToDeleteBy2 = cmisSession2.getObject(
      docVersionToDelete.getId()
    );
  ...
  public void testMnt11631() throws Exception {
    ...
    final String siteName = String.format(
      TEST_SITE_NAME_PATTERN,
      System.currentTimeMillis()
    );
    ...
    publicApiClient.setRequestContext(
      new RequestContext(network.getId(), personId)
    );
    CmisSession cmisSession = publicApiClient.createPublicApiCMISSession(
      Binding.atom,
      CMIS_VERSION_11
    ...
    cmisSession =
      publicApiClient.createPublicApiCMISSession(Binding.atom, CMIS_VERSION_10);
  ...
  private void testCanConnectCMISUsingDefaultTenantImpl(
    ...
    String url = httpClient.getPublicApiCmisUrl(
  ...
  public void testACE3433() throws Exception {
    ...
    NodeRef rootNodeRef = TenantUtil.runAsSystemTenant(
      new TenantRunAsWork<NodeRef>() {
        @Override
        public NodeRef doWork() throws Exception {
          NodeRef rootNodeRef = repoService
            .getNodeService()
            .getRootNode(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE);
          List<ChildAssociationRef> childAssocs = repoService
            .getNodeService()
  ...
  public void testMNT12956QueryingCMIS11UsesDictionary11() throws Exception {
    ...
    // query
    {
      ...
      // NodeRef input
      List<CMISNode> results = atomCmisSession11.query(
        "SELECT cmis:objectId,cmis:name,cmis:secondaryObjectTypeIds FROM cmis:document WHERE cmis:name LIKE '" +
        filename +
        "'",
        false,
        0,
  ...
  public void testGetIdParamsProperties() throws Exception {
    ...
    assertGetIdFilterParams(
      ...
      0,
      "filter",
      "cmis:isMajorVersion,cmis:isPrivateWorkingCopy"
    );
   ...
   */
  @Test
  public void aPrivateCopyShouldAllowTheAdditionOfAspects_CMIS_1_1_Version()
    throws Exception {
    ...
    final ContentStream cs = new ContentStreamImpl(
      fileName,
      "text/plain",
      "This is just a test"
    );

    final Document document = folder.createDocument(
      props,
      cs,
      VersioningState.MAJOR
    );
    ...
    List<Object> aspects = pwc
      .getProperty(PropertyIds.SECONDARY_OBJECT_TYPE_IDS)
      .getValues();
    ...
    List<String> secondaryTypeIds = checkedInDocument.getPropertyValue(
    ...
    assertEquals(
      checkedInDocument.getPropertyValue(propertyName),
      propertyValue
    );
  }
}
