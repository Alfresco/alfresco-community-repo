...
public interface ExtensionFactory<E>
{
    ...
    /**
     * @param point
     * @return <code>true</code> if the given extensio-point API elements are compatible with the returned extension (i.e. the given extension API is assignable form the type of the extension created by this factory and the {@link Trait} accepted as aparameter in {@link #createExtension(Trait)} is assignable from the type of the given trait API).
     */
