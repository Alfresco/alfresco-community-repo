...
public interface TaskComponent {
     ...
     */
    public List<WorkflowTask> getAssignedTasks(
            String authority, WorkflowTaskState state, boolean lazyInitialization);
    ...
    /**
     * @deprecated Use overloaded method with the {@code sameSession} parameter (this method
     *     defaults the parameter to {@code false}).
     */
     ...
     * Query for tasks
     *
     * <p>Hint: use {@link WorkflowTaskQuery} setLimit() method to limit the number of processed
     * items if you don't really need to go through all of them
     *
     ...
     *     the same session. If {@code true}, the returned List will be a lazy loaded list providing
     *     greater performance.
     ...
     */
    public WorkflowTask updateTask(
            String taskId,
     ...
     *
     * <p>Note: this is an optional task operation. It may be used to track when work started on a
     * task as well as resume a suspended task.
     *
     ...
     * @param transitionId the task transition id to take on completion (or null, for the default
     *     transition)
     * @return the updated task
     */
     ...
     */
    public List<WorkflowTask> getStartTasks(
            final List<String> workflowInstanceIds, final boolean sameSession);
}
