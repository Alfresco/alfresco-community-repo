...
public class VolumeAwareFileContentStoreTest extends FileContentStoreTest {
  ...
  public void before() throws Exception {
    ...
    VolumeAwareContentUrlProvider volumeAwareContentUrlProvider = new VolumeAwareContentUrlProvider(
      VOLUMES
    );
  ...
  public void testVolumeCreation() throws IOException {
    ...
    assertTrue(
      "Not all configured volumes were created",
      folders.length == volumesNumber
    );
  }
}
