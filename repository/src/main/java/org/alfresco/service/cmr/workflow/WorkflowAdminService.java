...
/**
 * Client facing API for providing administration information about the {@link WorkflowService}.
 *
...
public interface WorkflowAdminService {
     ...
     *
     * <p>NOTE: Workflow definitions can always be retrieved directly i.e. via name or id
     *
     * @param engineId The id of a workflow engine
