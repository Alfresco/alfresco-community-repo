...
public class RecordsManagementSearchServiceImpl implements RecordsManagementSearchService {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (!report.has(SavedSearchDetails.NAME)) {
                    throw new AlfrescoRuntimeException(
                            "Unable to load report details because name has not been specified. \n"
                                    + reportsJSON);
                }
                ...
                if (!report.has(SavedSearchDetails.SEARCH)) {
                    throw new AlfrescoRuntimeException(
                            "Unable to load report details because search has not been specified"
                                    + " for report "
                                    + name
                                    + ". \n"
                                    + reportsJSON);
                ...
                if (report.has("searchparams")) {
                    recordsManagementSearchParameters =
                            RecordsManagementSearchParameters.createFromJSON(
                                    report.getJSONObject("searchparams"), namespaceService);
                }

                // Create the report details and add to list
                ReportDetails reportDetails =
                        new ReportDetails(
                                name, description, query, recordsManagementSearchParameters);
     ...
     */
    public void setRecordsManagementSearchParameters(
            RecordsManagementSearchParameters recordsManagementSearchParameters) {
        this.recordsManagementSearchParameters = recordsManagementSearchParameters;
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#search(java.lang.String,
     *     java.lang.String,
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchParameters)
     */
    @Override
    public List<Pair<NodeRef, NodeRef>> search(
            String siteId, String query, RecordsManagementSearchParameters rmSearchParameters) {
     ...
     * @return
     */
    /*package*/ String buildQueryString(
            String queryTerm, RecordsManagementSearchParameters searchParameters) {
     ...
     * @param postfix
     */
    private void appendWithJoin(
            StringBuilder sb, String withJoin, String prefix, String value, String postfix) {
        if (sb.length() != 0) {
            sb.append(withJoin);
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#getSavedSearches(java.lang.String)
     */
    @Override
    ...
    private void addSearchDetailsToList(List<SavedSearchDetails> searches, NodeRef searchNode) {
        ...
        SavedSearchDetails savedSearchDetails =
                SavedSearchDetails.createFromJSON(jsonString, namespaceService, this, searchNode);
        searches.add(savedSearchDetails);
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#getSavedSearch(java.lang.String,
     *     java.lang.String)
     */
    @Override
    public SavedSearchDetails getSavedSearch(String siteId, String name) {
        ...
        if (searchNode != null) {
            ...
            result =
                    SavedSearchDetails.createFromJSON(
                            jsonString, namespaceService, this, searchNode);
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#saveSearch(String,
     *     String, String, String, RecordsManagementSearchParameters, boolean)
     */
    @Override
    public SavedSearchDetails saveSearch(
            String siteId,
            String name,
            String description,
            String query,
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#saveSearch(org.alfresco.module.org_alfresco_module_rm.search.SavedSearchDetails)
     */
    @Override
    public SavedSearchDetails saveSearch(final SavedSearchDetails savedSearchDetails) {
                            ...
                            new RunAsWork<NodeRef>() {
                                ...
                                public NodeRef doWork() {
                                    return siteService.createContainer(
                                            siteId, SEARCH_CONTAINER, null, null);
                                }
                            },
        ...
        // Get the saved search node
        NodeRef searchNode =
                fileFolderService.searchSimple(container, savedSearchDetails.getName());
        if (searchNode == null) {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#deleteSavedSearch(java.lang.String,
     *     java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#deleteSavedSearch(org.alfresco.module.org_alfresco_module_rm.search.SavedSearchDetails)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.search.RecordsManagementSearchService#addReports(java.lang.String)
     */
    @Override
