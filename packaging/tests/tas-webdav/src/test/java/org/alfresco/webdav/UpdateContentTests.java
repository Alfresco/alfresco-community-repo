...
public class UpdateContentTests extends WebDavTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify that admin user can update the content of a file created by self.")
    public void adminShouldEditContentFile() throws Exception {
        ...
        webDavProtocol
                ...
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_NO_CONTENT)
                .and()
                .assertThat()
                .contentIs(content + "-update");
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify that SiteManager user can update the content of a file created by"
                            + " self.")
    public void siteManagerShouldEditContentFile() throws Exception {
        ...
        webDavProtocol
                ...
                .existsInRepo()
                .then()
                .update(content + "-update " + UserRole.SiteManager)
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_NO_CONTENT)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that SiteCollaborator user can update the content of a file created by"
                            + " other user.")
    public void siteCollaboratorShouldEditContentFileCreatedByOtherUser() throws Exception {
        ...
        dataUser.usingUser(managerUser)
                .addUserToSite(collaborator, testSite, UserRole.SiteCollaborator);
        ...
        webDavProtocol
                ...
                .update(content + "-update " + UserRole.SiteCollaborator)
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_NO_CONTENT)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that SiteContributor user cannot update inline the content of a file"
    ...
    public void siteContributorShouldNotEditContentFileCreatedByOtherUser() throws Exception {
        ...
        dataUser.usingUser(managerUser)
                .addUserToSite(contributor, testSite, UserRole.SiteContributor);
        ...
        webDavProtocol
                ...
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_FORBIDDEN)
                .and()
                .assertThat()
                .contentIs(content);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that SiteContributor user can update the content of a file created by"
                            + " self.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that SiteConsumer user cannot update the content of a file created by"
                            + " other user.")
    public void siteConsumerShouldNotEditContentFileCreatedByOtherUser() throws Exception {
        ...
        webDavProtocol
                ...
                .usingResource(testFile)
                .update(content + "-update " + UserRole.SiteConsumer)
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_FORBIDDEN)
                .and()
    ...
    public void unauthenticatedUserShouldNotEditContentFile() throws Exception {
        ...
        webDavProtocol
                ...
                .disconnect()
                .usingResource(testFile)
                .update(content + "-update " + "unauthenticated")
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_UNAUTHORIZED);
    }
    ...
    public void siteManagerShouldNotEditFolderContent() throws Exception {
        ...
        webDavProtocol
                ...
                .update(content + "-update ")
                .assertThat()
                .hasStatus(HttpStatus.SC_BAD_REQUEST);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that SiteManager user cannot update the content of an inexisting file.")
    public void editContentFileForNonExistingFile() throws Exception {
        ...
        webDavProtocol
                ...
                .update(content + "-update")
                .assertThat()
                .hasStatus(HttpStatus.SC_NOT_FOUND);
    }
    ...
    public void siteManagerCannotEditContentOfLockedFile() throws Exception {
        ...
        webDavProtocol
                ...
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_LOCKED)
                .and()
                .assertThat()
                .contentIs(content);
    }
    ...
    public void userCanUpdateFileSmallerThanQuotaLimit() throws Exception {
        ...
        //            throw new SkipException("Skipping this test because user quotas are not
        // enabled. Please add " +
        //                    "system.usages.enabled=true to alfresco-global.properties, restart
        // Alfresco and run the test again.");
        ...
        webDavProtocol
                ...
                .existsInRepo()
                .then()
                .update(quotaFile.getContent())
                .and()
                .assertThat()
                .contentIs(quotaFile.getContent());
    }

    //    @Test(groups = { TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.FULL })
    //    @TestRail(section = { TestGroup.PROTOCOLS, TestGroup.WEBDAV }, executionType =
    // ExecutionType.REGRESSION,
    //            description = "Verify user cannot update file with a size bigger than the quota
    // limit")
    //    public void userCannotUpdateFileBiggerThanQuotaLimit() throws Exception
    //    {
    //        if (!webDavProtocol.withJMX().getSystemUsagesConfigurationStatus())
    //            throw new SkipException("Skipping this test because user quotas are not enabled.
    // Please add " +
    //                    "system.usages.enabled=true to alfresco-global.properties, restart
    // Alfresco and run the test again.");
    //
