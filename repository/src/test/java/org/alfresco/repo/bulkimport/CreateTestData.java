...
public class CreateTestData {
  ...
  private void createFile(File sourceFile, File targetFolder)
    throws IOException {
    File f = new File(targetFolder, GUID.generate() + ".bin");
    FileUtils.copyFile(sourceFile, f);
  }

  private void createDirectory(File sourceFolder, File targetFolder)
    throws IOException {
  ...
  public void createTestData(File sourceFolder, File targetFolder)
    throws IOException {
  ...
  public void execute(String sourceFolderPath, String targetFolderPath)
    throws IOException {
