...
public class RMv2FilePlanNodeRefPatch
  ...
  protected void executePatch() {
    Pair<Long, QName> aspectPair = qnameDAO.getQName(
      RecordsManagementModel.ASPECT_FILE_PLAN_COMPONENT
    );
    if (aspectPair != null) {
      List<Long> filePlanComponents = patchDAO.getNodesByAspectQNameId(
        aspectPair.getFirst(),
        0L,
      ...
      for (Long filePlanComponent : filePlanComponents) {
        ...
        NodeRef filePlan = filePlanService.getFilePlan(
        ...
        if (filePlan != null) {
          ...
          if (
            FilePlanComponentKind.RECORD_CATEGORY.equals(kind) ||
            ...
            Role adminRole = filePlanRoleService.getRole(
              filePlan,
              "Administrator"
            );
            if (adminRole != null) {
            ...
            Serializable vitalRecordIndicator = nodeService.getProperty(
              filePlanComponentNodeRef,
            ...
            Serializable reviewPeriod = nodeService.getProperty(
              filePlanComponentNodeRef,
              PROP_REVIEW_PERIOD
            );
          ...
          if (LOGGER.isWarnEnabled()) {
            LOGGER.warn(
              ...
              " was skiped, beacuse there was no associated file plan."
            );
          }
        }
      }
