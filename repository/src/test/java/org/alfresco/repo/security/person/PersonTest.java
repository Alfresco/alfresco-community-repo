...
public class PersonTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    RepoUsageComponentImpl repoUsageComponent = (RepoUsageComponentImpl) ctx.getBean(
      "repoUsageComponent"
    );
    ...
    for (NodeRef nodeRef : personService.getAllPeople()) {
      ...
      if (
        !uid.equals(AuthenticationUtil.getAdminUserName()) &&
  ...
  private int getPeopleCount() {
    ...
    int count = personService
      .getPeople(null, null, null, pagingRequest)
      .getPage()
      .size();
    ...
    PagingResults<PersonInfo> ppr = personService.getPeople(
      null,
      null,
      null,
      pagingRequest
  ...
  public void xtestLazyHomeFolderCreation() throws Exception {
    ...
    NodeRef homeFolder = DefaultTypeConverter.INSTANCE.convert(
      NodeRef.class,
      nodeService.getProperty(madePerson, ContentModel.PROP_HOMEFOLDER)
    );
    if (homeFolder != null) {
  ...
  public void testZones() {
    ...
    newZones.add("One");
    personService.createPerson(
      createDefaultProperties("1", "1", "1", "1", "1", rootNodeRef),
      newZones
    );
    ...
    newZones.add("Two");
    personService.createPerson(
      createDefaultProperties("2", "2", "2", "2", "2", rootNodeRef),
      newZones
    );
    ...
    newZones.add("Three");
    personService.createPerson(
      createDefaultProperties("3", "3", "3", "3", "3", rootNodeRef),
      newZones
    );
    ...
    assertEquals(
      3,
      authorityService.getAllAuthoritiesInZone("One", null).size()
    );
    assertEquals(
      2,
      authorityService.getAllAuthoritiesInZone("Two", null).size()
    );
    assertEquals(
      1,
      authorityService.getAllAuthoritiesInZone("Three", null).size()
    );
  }
  ...
  public void xtestPerformance() {
    ...
    for (int i = 0; i < 10000; i++) {
      ...
      personService.createPerson(
        createDefaultProperties(id, id, id, id, id, rootNodeRef)
      );
      end = System.nanoTime();
      create += (end - start);
      ...
      if ((i > 0) && (i % 100 == 0)) {
        ...
        System.out.println(
          "Size (" + size + ") : " + ((end - start) / 1000000.0f)
        );
      }
    }
  }
  ...
  public void testDeletePerson() throws Exception {
    ...
    NodeRef n1 = nodeService
      .createNode(
        rootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        QName.createQName("{namespace}one"),
        ContentModel.TYPE_FOLDER
      )
      .getChildRef();
    NodeRef n2 = nodeService
      .createNode(
        rootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        QName.createQName("{namespace}two"),
        ContentModel.TYPE_FOLDER
      )
      .getChildRef();
  ...
  public void testCreateAndThenDeleteWithNoderef() {
    ...
    NodeRef andyRef = personService.createPerson(
      createDefaultProperties(
        "andreas",
        "andreas",
        "Hind",
  ...
  public void testPersonServiceImpl() {
    ...
    assertTrue(
      "Tests the impl method. We should have at least 1 person.",
      theImpl.countPeople() > 0
    );
  }
  ...
  public void testCreatePersonWithIllegalCharacters() throws Exception {
    ...
    for (char illegalCharacter : illegalCharacters) {
      ...
      try {
        ...
        fail(
          "IllegalArgumentException not caught for illegalCharacter: " +
          personName.charAt(personName.indexOf(illegalCharacter))
        );
  ...
  public void testMutableProperties() {
    ...
    assertTrue(
      personService
        ...
        .contains(ContentModel.PROP_HOMEFOLDER)
    );
    assertTrue(
      personService.getMutableProperties().contains(ContentModel.PROP_FIRSTNAME)
    );
    assertTrue(
      personService.getMutableProperties().contains(ContentModel.PROP_LASTNAME)
    );
    assertTrue(
      personService.getMutableProperties().contains(ContentModel.PROP_EMAIL)
    );
    assertTrue(
      personService.getMutableProperties().contains(ContentModel.PROP_ORGID)
    );
  }
  ...
  public void testPersonCRUD2() {
    ...
    assertEquals(
      1,
      personService
        .getPeopleFilteredByProperty(ContentModel.PROP_USERNAME, "derek", 10)
        .size()
    );
    assertEquals(
      1,
      personService
        .getPeopleFilteredByProperty(ContentModel.PROP_EMAIL, "dh@dh", 10)
        .size()
    );
    assertEquals(
      1,
      personService
        .getPeopleFilteredByProperty(ContentModel.PROP_ORGID, "alfresco", 10)
        .size()
    );
    assertEquals(
      0,
      personService
        .getPeopleFilteredByProperty(ContentModel.PROP_USERNAME, "glen", 10)
        .size()
    );
    assertEquals(
      0,
    ...
    assertEquals(
      0,
      personService
        .getPeopleFilteredByProperty(ContentModel.PROP_ORGID, "microsoft", 10)
        .size()
    );

    try {
      personService.getPeopleFilteredByProperty(
    ...
    try {
      ...
      fail(
        "Should throw AlfrescoRuntimeException,property must be in 'cm:person'"
      );
  ...
  public void testPersonCRUD() {
    ...
    assertEquals(
      personService.personExists("derek"),
      EqualsHelper.nullSafeEquals(
        personService.getUserIdentifier("derek"),
        "Derek"
      )
    );
    assertEquals(
  ...
  public void testPeopleFiltering() {
    ...
    personService.createPerson(
      createDefaultProperties("bc", "c", "C", "bc@bc", "alfresco", rootNodeRef)
    );
    personService.createPerson(
      createDefaultProperties("yy", "B", "D", "yy@yy", "alfresco", rootNodeRef)
    );
    personService.createPerson(
      createDefaultProperties("Yz", "yz", "B", "yz@yz", "alfresco", rootNodeRef)
    );
    ...
    PagingResults<PersonInfo> people = personService.getPeople(
      null,
      null,
      null,
      null,
    ...
    assertEquals(
      2,
      personService.getPeople("y", filters, null, pr).getPage().size()
    );
    ...
    assertEquals(
      3,
      personService.getPeople("b", filters, null, pr).getPage().size()
    );
    ...
    assertEquals(
      2,
      personService.getPeople("A", filters, null, pr).getPage().size()
    ); // includes "admin"
    ...
    assertEquals(
      5,
      personService.getPeople("*", filters, null, pr).getPage().size()
    );
  }
  ...
  public void testPeopleSortingPaging() {
    ...
    NodeRef p3 = personService.createPerson(
      createDefaultProperties(
        "aa",
        "Aa",
        "Aa",
    ...
    NodeRef p4 = personService.createPerson(
      createDefaultProperties(
        "cc",
        "Cc",
        "Cc",
    ...
    NodeRef p5 = personService.createPerson(
      createDefaultProperties(
        "hh",
        "Hh",
        "Hh",
    ...
    NodeRef p6 = personService.createPerson(
      createDefaultProperties(
        "bb",
        "Bb",
        "Bb",
    ...
    NodeRef p7 = personService.createPerson(
      createDefaultProperties(
        "dd",
        "Dd",
        "Dd",
    ...
    Pair<Integer, Integer> expectedResultCount = new Pair<Integer, Integer>(
      expectedTotalCount,
      expectedTotalCount
    );
  ...
  private void testProperties(
    ...
    assertNotNull(
      nodeService.getProperty(nodeRef, ContentModel.PROP_HOMEFOLDER)
    );
    assertEquals(
      firstName,
      DefaultTypeConverter.INSTANCE.convert(
    ...
    assertEquals(
      ...
      DefaultTypeConverter.INSTANCE.convert(
        String.class,
        nodeService.getProperty(nodeRef, ContentModel.PROP_EMAIL)
      )
    );
    assertEquals(
      orgId,
      DefaultTypeConverter.INSTANCE.convert(
        String.class,
        nodeService.getProperty(nodeRef, ContentModel.PROP_ORGID)
      )
    );
  }
  ...
  public void testReadOnlyTransactionHandling() throws Exception {
    ...
    assertTrue(
      "Default should be to create missing people",
      createMissingPeople
    );
    ...
    transactionService
      ...
      .doInTransaction(deletePersonWork, false, true);
    ...
    try {
      transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(getMissingPersonWork, true, true);
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(getMissingPersonWork, false, true);
    ...
    for (int i = 0; i < 100; i++) { // Bump this number up to 1000 for 'real' testing
      try {
        ...
        throw new RuntimeException(
          "Failed on iteration " + i + " of forcing split person.",
          e
        );
      }
    }
  ...
  private void forceSplitPersonCleanup() throws Exception {
    ...
    final Map<String, NodeRef> cleanableNodeRefs = new ConcurrentHashMap<String, NodeRef>(
      17
    );
    Runnable createPersonRunnable = new Runnable() {
      public void run() {
        ...
        try {
          NodeRef nodeRef = transactionService
            .getRetryingTransactionHelper()
            .doInTransaction(createPersonWork, false, true);
    ...
    final NodeRef remainingNodeRef = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(getPersonWork, false, true);
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
          ...
          public Object execute() throws Throwable {
            ...
            for (NodeRef nodeRef : cleanableNodeRefs.values()) {
              ...
              if (nodeService.exists(nodeRef)) {
                fail(
                  "Expected unused person noderef to have been cleaned up: " +
                  nodeRef
                );
              }
            }
  ...
  private void testProcessDuplicates(final boolean split) throws Exception {
    ...
    ((PersonServiceImpl) personService).setDuplicateMode(
        split ? "SPLIT" : "DELETE"
      );

    final String duplicateUserName = GUID.generate();
    final NodeRef[] duplicates = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<NodeRef[]>() {
          public NodeRef[] execute() throws Throwable {
            ...
            ChildAssociationRef container = nodeService.getPrimaryParent(
              duplicates[0]
            );
            List<ChildAssociationRef> parents = nodeService.getParentAssocs(
              duplicates[0]
            );
            ...
            try {
              ...
              for (int i = 1; i < duplicates.length; i++) {
                ...
                duplicates[i] =
                  nodeService
                    .createNode(
                      container.getParentRef(),
                      container.getTypeQName(),
                      container.getQName(),
            ...
            assertEquals(
              ...
              personService.getPerson(duplicateUserName)
            );
            return duplicates;
          }
        },
        ...
        new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            for (int i = 0; i < duplicates.length - 1; i++) {
              if (split) {
                String newUserName = (String) nodeService.getProperty(
                  duplicates[i],
                  ContentModel.PROP_USERNAME
                );
  ...
  public void testCheckForDuplicateCaseInsensitive() {
    ...
    try {
      ...
      fail(
        "Shouldn't be able to create person node directly (within people container) - use createPerson instead"
      );
  ...
  public void testCheckForIndirectUsage() throws Exception {
    ...
    try {
      ...
      fail(
        "Shouldn't be able to delete person node directly (within people container) - use deletePerson instead"
      );
    } catch (AlfrescoRuntimeException are) {
      if (!are.getMessage().contains("use PersonService")) {
        throw are;
  ...
  public void testDisableEnablePerson() {
    ...
    assertTrue(
      "Person should be enabled.",
      authenticationDAO.getEnabled(userName)
    );
    assertFalse(
      "Person should not be disabled.",
      nodeService.hasAspect(personNodeRef, ContentModel.ASPECT_PERSON_DISABLED)
    );
    ...
    assertFalse(
      "Person should be disabled.",
      authenticationDAO.getEnabled(userName)
    );
    assertFalse(
      "Person should be disabled.",
      personService.isEnabled(userName)
    );
    assertTrue(
      "Person should be disabled.",
      nodeService.hasAspect(personNodeRef, ContentModel.ASPECT_PERSON_DISABLED)
  ...
  public void testDisableEnableAdmin() {
    ...
    assertTrue(
      "Admin must STILL be enabled",
      authenticationDAO.getEnabled(admin)
    );
    ...
    assertFalse(
      "Admin must STILL be enabled",
      authenticationDAO.getLocked(admin)
    );

    assertFalse(
      "Admin account does not expire",
      authenticationDAO.getAccountExpires(admin)
    );
    ...
    assertFalse(
      "Admin account STILL does not expire",
      authenticationDAO.getAccountExpires(admin)
    );
  }
  ...
  public void testRenameUser() throws Exception {
    ...
    // Create a person
    final NodeRef person = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Throwable {
            ...
            assertFalse(
              ...
              personService.personExists(newUsername)
            );
            return person;
          }
        },
    ...
    renameUser.start(
      new String[] { "-user", username, oldUsername, newUsername }
    );
        ...
        new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            assertFalse(
              ...
              personService.personExists(oldUsername)
            );
  ...
  public void testPreventCreationOfBuiltInAuthorities() {
    try {
      ...
      systemProps.put(
        ContentModel.PROP_EMAIL,
        "myFirstName.myLastName@email.com"
      );
      ...
      fail(
        "case fail creating SystemUserName: " +
        AuthenticationUtil.getSystemUserName()
      );
    ...
    try {
      ...
      fail(
        "case fail creating GuestUserName: " +
        AuthenticationUtil.getGuestUserName()
      );
    } catch (AlfrescoRuntimeException e) {
      // expect to go here
  ...
  public void testUserShouldBeAbleToUpdateTheProfile() {
    ...
    NodeRef personRef = personService.createPerson(
      createDefaultProperties(
        USERNAME,
        "Aa",
        "Aa",
  ...
  public void testPreventChangesToOtherUsersPropertiesWithoutHavingAdminRights() {
    try {
      ...
      NodeRef user2 = personService.createPerson(
        createDefaultProperties(
          USERNAME_2,
          "Bb",
          "Bb",
  ...
  public void testBuitInSystemUser() {
    AuthenticationUtil.runAsSystem(
      new RunAsWork<Void>() {
        ...
        public Void doWork() {
          try {
            NodeRef person = personService.getPerson(
              AuthenticationUtil.SYSTEM_USER_NAME
            );
            fail(
              "A NoSuchPersonException should have been thrown for " +
              AuthenticationUtil.SYSTEM_USER_NAME +
              " but " +
              person +
              " was returned"
