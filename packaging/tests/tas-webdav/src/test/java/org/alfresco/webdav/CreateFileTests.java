...
public class CreateFileTests extends WebDavTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager cannot create file in site with symbols in name")
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.CORE, TestGroup.OS_LINUX},
    ...
    //            description ="Verify user cannot create file with a size bigger than the quota
    // limit")
