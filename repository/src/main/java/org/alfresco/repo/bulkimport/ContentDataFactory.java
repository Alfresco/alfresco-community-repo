...
public interface ContentDataFactory {
    /**
     * Create a {@link ContentData} by combining the given {@link ContentStore}'s root location and
     * the {@link File}'s path within that store. The given file must therefore be accessible within
     * the content store's configured root location. The encoding and mimetype will be guessed from
     * the given file.
     *
