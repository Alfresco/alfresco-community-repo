...
public class ActionFormProcessorTest extends BaseAlfrescoSpringTest {
  ...
  public void before() throws Exception {
    ...
    this.formService =
      (FormService) this.applicationContext.getBean("FormService");
    ...
    this.transactionHelper =
      (RetryingTransactionHelper) this.applicationContext.getBean(
  ...
  protected NodeRef createNode(NodeRef parentNode, String name, QName type) {
    ...
    QName docContentQName = QName.createQName(
  ...
  public void testRequestFormForNonExistentAction() throws Exception {
    try {
      this.formService.getForm(
          new Item(ActionFormProcessor.ITEM_KIND, "noSuchActionBean")
        );
        ...
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            Form form = formService.getForm(
              new Item(ActionFormProcessor.ITEM_KIND, "extract-metadata")
            );
            ...
            Map<String, FieldDefinition> fieldDefMap = new HashMap<String, FieldDefinition>(
              fieldDefs.size()
            );
  ...
  public void testGenerateDefaultFormForActionWithNodeRefParam()
    ...
    this.transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            Form form = formService.getForm(
              new Item(ActionFormProcessor.ITEM_KIND, "script")
            );
            ...
            PropertyFieldDefinition scriptRef = (PropertyFieldDefinition) fieldDefMap.get(
              "script-ref"
            );
  ...
  private void validateExecuteAsynchronouslyField(
    Map<String, FieldDefinition> fieldDefMap
  ) {
    // executeAsynchronously
    PropertyFieldDefinition execAsync = (PropertyFieldDefinition) fieldDefMap.get(
      "executeAsynchronously"
    );
    assertNotNull("'executeAsynchronously' field defn was missing.", execAsync);
    assertEquals(
      "'executeAsynchronously' name was wrong",
      "executeAsynchronously",
      execAsync.getName()
    );
    assertEquals(
      "'executeAsynchronously' label was wrong",
      "executeAsynchronously",
      execAsync.getLabel()
    );
    assertNull(
      "'executeAsynchronously' description was wrong",
      execAsync.getDescription()
    );
    assertEquals(
      "'executeAsynchronously' datatype was wrong",
      "boolean",
      execAsync.getDataType()
    );
  }
  ...
  public void testGenerateFormWithSpecificLocale() {
    ...
    try {
      ...
      transactionHelper.doInTransaction(() -> {
        Form form = formService.getForm(
          new Item(ActionFormProcessor.ITEM_KIND, "transform")
        );
        // Field definitions keyed by name.
        Map<String, FieldDefinition> fieldDefMap = form
          .getFieldDefinitions()
          .stream()
          .collect(
            Collectors.toMap(FieldDefinition::getName, Function.identity())
          );

        assertEquals(
          "Zielordner",
          fieldDefMap
            .get(TransformActionExecuter.PARAM_DESTINATION_FOLDER)
            .getLabel()
        );
        assertEquals(
          "MIME-Type",
          fieldDefMap.get(TransformActionExecuter.PARAM_MIME_TYPE).getLabel()
        );
        return null;
      });
    } finally {
    ...
    this.transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            Form form = formService.getForm(
              new Item(ActionFormProcessor.ITEM_KIND, "move"),
              fields
            );
            ...
            AssociationFieldDefinition destFolderField = (AssociationFieldDefinition) fieldDefMap.get(
              MoveActionExecuter.PARAM_DESTINATION_FOLDER
            );
            assertNotNull(destFolderField);
            PropertyFieldDefinition execAsyncField = (PropertyFieldDefinition) fieldDefMap.get(
              ActionFormProcessor.EXECUTE_ASYNCHRONOUSLY
            );
    ...
    this.transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            form.addData(
              AbstractFormProcessor.DESTINATION,
              testNode.toString()
            );
            ...
            form.addData(
              ...
              repositoryHelper.getCompanyHome().toString()
            );
            form.addData(
              FormFieldConstants.PROP_DATA_PREFIX +
              TransformActionExecuter.PARAM_ASSOC_TYPE_QNAME,
              ContentModel.ASSOC_CONTAINS.toPrefixString(namespaceService)
            );
            form.addData(
              FormFieldConstants.PROP_DATA_PREFIX +
            ...
            for (ChildAssociationRef chAssRef : nodeService.getChildAssocs(
              repositoryHelper.getCompanyHome()
            )) {
              System.err.println(
                nodeService.getProperty(
                  chAssRef.getChildRef(),
                  ContentModel.PROP_NAME
                )
              );
            }

            Serializable cmName = nodeService.getProperty(
              testNode,
              ContentModel.PROP_NAME
            );
            String transformedNodeName =
              ((String) cmName).replace(".txt", ".xml");

            NodeRef expectedTransformedNode = nodeService.getChildByName(
              repositoryHelper.getCompanyHome(),
              ContentModel.ASSOC_CONTAINS,
              transformedNodeName
            );
            assertNotNull(
              "transformed node was missing",
              expectedTransformedNode
            );
    ...
    this.transactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            Form form = formService.getForm(
              new Item(
                ActionFormProcessor.ITEM_KIND,
                "actionFormProcessorTestActionExecuter"
              )
            );
            ...
            form.addData(
              FormFieldConstants.PROP_DATA_PREFIX + "check",
              Boolean.TRUE
            );
            form.addData(
              FormFieldConstants.PROP_DATA_PREFIX + "date",
              new Date()
            );
            ...
            form.addData(
              FormFieldConstants.PROP_DATA_PREFIX + "qname",
              qnameList
            );
            ...
            form.addData(
              FormFieldConstants.PROP_DATA_PREFIX + "nodeRefs",
              nodeRefList
            );
  ...
  public static class ActionFormProcessorTestActionExecuter
    ...
    protected void addParameterDefinitions(
      List<ParameterDefinition> paramList
    ) {
      paramList.add(
    ...
    protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
      ...
      assertEquals(
        "Parameter value should be Boolean",
        checkValue.getClass(),
        Boolean.class
      );
      ...
      assertEquals(
        "Parameter value should be Date",
        dateValue.getClass(),
        Date.class
      );
      ...
      assertEquals(
        "Parameter value should be ArrayList",
        qnameValue.getClass(),
        ArrayList.class
      );
      for (QName qname : (ArrayList<QName>) qnameValue) {
        assertEquals(
          "The item value should be QName",
          qname.getClass(),
          QName.class
        );
      }
      ...
      assertEquals(
        "Parameter value should be ArrayList",
        nodeRefsValue.getClass(),
        ArrayList.class
      );
      for (NodeRef nodeRef : (ArrayList<NodeRef>) nodeRefsValue) {
        assertEquals(
          "The item value should be NodeRef",
          nodeRef.getClass(),
          NodeRef.class
        );
      }
