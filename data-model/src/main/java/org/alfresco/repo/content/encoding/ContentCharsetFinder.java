...
public class ContentCharsetFinder {
    ...
    /**
     * Override the system default charset. Where the characterset cannot be determined for a
     * mimetype and input stream, this mimetype will be used. The default is 'UTF-8'.
     *
    ...
    /**
     * Set the mimetype service that will help determine if a particular mimetype can be treated as
     * encoded text or not.
     */
    ...
    /**
     * Gets the characterset from the stream, if the mimetype is text and the text has enough
     * information to give the encoding away. Otherwise, the default is returned.
     *
     * @param is a stream that will not be affected by the call, but must support marking
