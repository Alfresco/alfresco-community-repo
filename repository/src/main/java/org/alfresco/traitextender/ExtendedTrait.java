 ...
 * Keeps track of extension references for one extensible and allows the collection of those
 * extensions when the extensible is collected.
 *
 * @author Bogdan Horje
 */
public class ExtendedTrait<T extends Trait> {
    private ConcurrentHashMap<Class<?>, Object> extensions =
