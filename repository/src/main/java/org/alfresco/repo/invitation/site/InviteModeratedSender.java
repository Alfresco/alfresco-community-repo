...
/**
 * This class is responsible for sending email notifications to site managers informing about users
 * requesting access.
 *
...
public class InviteModeratedSender extends InviteSender {
    ...
    private static final List<String> INVITE_MODERATED_EXPECTED_PROPERTIES =
            Arrays.asList(
    ...
    public void sendMail(
            String emailTemplatePath, String emailSubjectKey, Map<String, String> properties) {
        ...
        mail.setParameterValue(
                MailActionExecuter.PARAM_SUBJECT_PARAMS, new Object[] {getSiteName(properties)});
        mail.setParameterValue(
                MailActionExecuter.PARAM_TEMPLATE, getEmailTemplate(emailTemplatePath));
        mail.setParameterValue(
    ...
    protected Map<String, Serializable> buildMailTextModel(Map<String, String> properties) {
        ...
        model.put(
                "inviteeName",
                StringUtils.join(
                        new String[] {inviteePerson.getFirstName(), inviteePerson.getLastName()},
                        " "));
