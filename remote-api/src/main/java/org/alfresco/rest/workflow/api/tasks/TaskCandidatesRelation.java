...
public class TaskCandidatesRelation
  ...
  @Override
  @WebApiDescription(
    title = "Get Task Candidate Users and Groups",
    description = "Get a paged list of the the task candidate users and groups"
  )
  public CollectionWithPagingInfo<TaskCandidate> readAll(
    String taskId,
