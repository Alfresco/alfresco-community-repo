...
public class VersionImplTest extends TestCase {
  ...
  private static final String VALUE_DESCRIPTION =
    "This string describes the version details.";
  ...
  protected void setUp() throws Exception {
    ...
    this.nodeRef =
      new NodeRef(
        new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "testWS"),
        "testID"
      );
  ...
  public void testNoNodeRefOnVersionCreate() {
    try {
      ...
      fail(
        "It is invalid to create a version object without a node ref specified."
      );
