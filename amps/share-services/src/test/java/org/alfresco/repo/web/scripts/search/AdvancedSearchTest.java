...
@Ignore(
  "This test doesn't pass on HEAD-BUG-FIX and isn't included in a test suite."
)
public class AdvancedSearchTest extends BaseWebScriptTest {
  ...
  private static final String TEST_FOLDER =
    "test_folder-" + System.currentTimeMillis();
  ...
  protected void setUp() throws Exception {
    ...
    this.searchService =
      (SearchService) getServer()
        .getApplicationContext()
        .getBean("SearchService");
    this.namespaceService =
      (NamespaceService) getServer()
        .getApplicationContext()
  ...
  protected void tearDown() throws Exception {
    ...
    this.transactionService.getRetryingTransactionHelper()
      .doInTransaction(deleteCallback);
  ...
  public void testSearchInSites() throws IOException, JSONException {
    ...
    if (results.size() == 0) {
      throw new AlfrescoRuntimeException(
        "Can't find /app:company_home/st:sites"
      );
    }
    ...
    NodeRef sitefolderNodeRef = fileFolderService
