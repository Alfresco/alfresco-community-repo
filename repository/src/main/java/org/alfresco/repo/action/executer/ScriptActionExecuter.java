...
/**
 * Action to execute a JavaScript. The script has access to the default model. The
...
public class ScriptActionExecuter extends ActionExecuterAbstractBase {
        ...
        if (nodeService.exists(actionedUponNodeRef)) {
            ...
            if (this.scriptLocation != null
                ...
                ScriptAction scriptAction =
                        new ScriptAction(this.serviceRegistry, action, this.actionDefinition);
    ...
    private NodeRef getCompanyHome() {
        ...
        if (refs.size() != 1) {
            throw new IllegalStateException(
                    "Invalid company home path: " + companyHomePath + " - found: " + refs.size());
        }
    ...
    private boolean isValidScriptRef(Action action) {
        ...
        ActionDefinition actDef =
                actionService.getActionDefinition(action.getActionDefinitionName());
