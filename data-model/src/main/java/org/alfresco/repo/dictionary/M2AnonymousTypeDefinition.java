...
/*package*/ class M2AnonymousTypeDefinition implements TypeDefinition {
    ...
    private Map<QName, ChildAssociationDefinition> childassociations =
     ...
     */
    /*package*/ M2AnonymousTypeDefinition(
            TypeDefinition type, Collection<AspectDefinition> aspects) {
        this.type = type;
    ...
    public QName getName() {
        return QName.createQName(
                ...
                "anonymous#" + type.getName().getLocalName());
    }
