                ...
                if (Type.SITE.toString().equals(fieldname.toUpperCase())) {
                    ...
                    try {
                        ...
                        BeanProperty p =
                                new BeanProperty.Std(
                                        new PropertyName(""), t, null, null, null, null);
                        JsonDeserializer<?> siteDeserializer =
                                ctxt.findContextualValueDeserializer(t, p);
                    ...
                    try {
                        ...
                        BeanProperty p =
                                new BeanProperty.Std(
                                        new PropertyName(""), t, null, null, null, null);
                        JsonDeserializer<?> documentDeserializer =
                                ctxt.findContextualValueDeserializer(t, p);
                    ...
                    try {
                        ...
                        BeanProperty p =
                                new BeanProperty.Std(
                                        new PropertyName(""), t, null, null, null, null);
                        JsonDeserializer<?> folderDeserializer =
                                ctxt.findContextualValueDeserializer(t, p);
