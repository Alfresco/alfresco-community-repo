...
public class RecordsManagementAdminServiceImplTest extends BaseRMTestCase
     ...
     * @see RecordsManagementAdminService#addCustomPropertyDefinition(QName, QName, String, QName,
     *     String, String, String, boolean, boolean, boolean, QName)
     * @see RecordsManagementAdminService#addCustomPropertyDefinition(QName, QName, String, QName,
     *     String, String)
     */
    public void testAddCustomPropertyDefinition() throws Exception {
                    ...
                    public void test(QName result) throws Exception {
                        try {
                            ...
                            Map<QName, PropertyDefinition> propDefs =
                                    rmAdminService.getCustomPropertyDefinitions(ASPECT_RECORD);
        ...
        doTestInTransaction(
                new FailureTest(
                        "Can not add a custom property to a type that isn't registered as"
                                + " customisable",
                        CustomMetadataException.class) {
                    @Override
                    public void run() throws Exception {
        ...
        doTestInTransaction(
                new Test<QName>() {
                    ...
                    public void test(QName result) throws Exception {
                        ...
                        // Check that property is available as a custom property
                        Map<QName, PropertyDefinition> propDefs =
                                rmAdminService.getCustomPropertyDefinitions(TYPE_CUSTOM_TYPE);
                        assertNotNull(propDefs);
        ...
        doTestInTransaction(
                new Test<QName>() {
                    ...
                    public void test(QName result) throws Exception {
                        ...
                        // Check that property is available as a custom property
                        Map<QName, PropertyDefinition> propDefs =
                                rmAdminService.getCustomPropertyDefinitions(ASPECT_CUSTOM_ASPECT);
                        assertNotNull(propDefs);
                        assertEquals(1, propDefs.size());
                        assertTrue(propDefs.containsKey(result));
                    ...
                    public QName run() throws Exception {
                        ...
                        assertTrue(
                                nodeService.hasAspect(
                                        customInstance1,
                                        QName.createQName(
                                                RM_CUSTOM_URI, "rmtcustomTypeCustomProperties")));
                        assertTrue(
                                nodeService.hasAspect(
                                        customInstance2,
                                        QName.createQName(
                                                RM_CUSTOM_URI, "rmtcustomAspectCustomProperties")));
    ...
    public void testCreateAndUseCustomChildReference() throws Exception {
        ...
        createAndUseCustomReference(
                RelationshipType.PARENTCHILD, null, "superseded" + now, "superseding" + now);
    }
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<QName>() {
                            public QName execute() throws Throwable {
                                ...
                                RelationshipDefinition relationshipDefinition =
                                        relationshipService.createRelationshipDefinition(
                                                displayName);
        ...
        retryingTransactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        RelationshipDefinition relationshipDefinition =
                                relationshipService.getRelationshipDefinition(
                        ...
                        if (RelationshipType.PARENTCHILD.equals(refType)) {
                            nodeService.addChild(
                                    testRecord1, testRecord2, generatedQName, generatedQName);
                        } else {
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        List<ChildAssociationRef> childAssocs =
                                nodeService.getChildAssocs(testRecord1);
                        List<AssociationRef> retrievedAssocs =
                                nodeService.getTargetAssocs(
                                        testRecord1, RegexQNamePattern.MATCH_ALL);
                        ...
                        if (RelationshipType.PARENTCHILD.equals(refType)) {
                            assertNotNull(
                                    "The customReference is not returned from the"
                                            + " dictionaryService.",
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        Map<QName, PropertyDefinition> props =
                                rmAdminService.getCustomPropertyDefinitions();
        ...
        retryingTransactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        for (RelationshipDefinition relationshipDefinition :
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        List<ConstraintDefinition> constraints =
                                rmAdminService.getCustomConstraintDefinitions(
    ...
    public void testCreateReference() throws Exception {
        ...
        try {
            ...
            final Pair<NodeRef, NodeRef> testRecords =
                    retryingTransactionHelper.doInTransaction(
                    ...
                    new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                        public Void execute() throws Throwable {
                            ...
                            relationshipService.addRelationship(
                                    CUSTOM_REF_VERSIONS.getLocalName(), testRecord1, testRecord2);
                ...
                retryingTransactionHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<Integer>() {
                            public Integer execute() throws Throwable {
                                List<ConstraintDefinition> result =
                                        rmAdminService.getCustomConstraintDefinitions(
                                                RecordsManagementCustomModel.RM_CUSTOM_MODEL);
                                assertNotNull(result);
                                return result.size();
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<QName>() {
                            public QName execute() throws Throwable {
                                ...
                                rmAdminService.addCustomConstraintDefinition(
                                        result, conTitle, true, allowedValues, MatchLogic.AND);
                                return result;
                            }
                        });

        // Set the current security context as System - to see allowed values (unless caveat config
        // is also updated for admin)
        AuthenticationUtil.setFullyAuthenticatedUser(AuthenticationUtil.getSystemUserName());

        retryingTransactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        List<ConstraintDefinition> customConstraintDefs =
                                rmAdminService.getCustomConstraintDefinitions(
                                        RecordsManagementCustomModel.RM_CUSTOM_MODEL);
