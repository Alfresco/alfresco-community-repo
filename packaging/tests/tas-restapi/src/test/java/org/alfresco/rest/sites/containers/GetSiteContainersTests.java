...
public class GetSiteContainersTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        publicSiteWithContainersUsers =
                dataUser.addUsersWithRolesToSite(
                        publicSiteWithContainers,
                        UserRole.SiteManager,
                        UserRole.SiteCollaborator,
                        UserRole.SiteConsumer,
                        UserRole.SiteContributor);
        ...
        restSiteContainers =
                restClient
                        .authenticateUser(
                                publicSiteWithContainersUsers.getOneUserWithRole(
                                        UserRole.SiteManager))
                        .withCoreAPI()
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role gets site containers and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role gets site containers and gets status code"
                            + " OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets site containers and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets site containers and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Admin user gets site containers information and gets status"
                            + " code OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Failed authentication get site containers call returns status code 401 with"
                            + " Manager role")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site container request returns status code 200 with valid"
                            + " maxItems parameter")
    public void getContainersWithValidMaxItems() throws Exception {
        restClient
                .authenticateUser(
                        publicSiteWithContainersUsers.getOneUserWithRole(UserRole.SiteManager))
                .withParams("maxItems=5")
                .withCoreAPI()
                .usingSite(publicSiteWithContainers)
                .getSiteContainers()
                .assertThat()
                .entriesListCountIs(2)
                .and()
                .entriesListContains("folderId", ContainerName.documentLibrary.toString())
                .and()
                .entriesListContains("folderId", ContainerName.links.toString());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site container request returns status code 400 when invalid"
                            + " maxItems parameter is used")
    public void getContainersWithMaxItemsZero() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteManager))
    ...
    public void getContainersWithMaxItemsCharacter() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator))
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_MAXITEMS, "test"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site container request returns status code 200 when maxItems"
                            + " parameter starts with multiple zero")
    public void getContainersWithMaxItemsMultipleZero() throws Exception {
        restClient
                .authenticateUser(
                        publicSiteWithContainersUsers.getOneUserWithRole(UserRole.SiteCollaborator))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request returns status code 200 when valid"
                            + " skipCount parameter is used")
    public void getSiteContainersWithValidSkipCount() throws Exception {
        ...
        restClient
                .authenticateUser(
                        publicSiteWithContainersUsers.getOneUserWithRole(UserRole.SiteConsumer))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request returns status code 400 when invalid"
                            + " skipCount parameter is used")
    public void getSiteContainersWithSkipCountCharacter() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator))
                .withParams("skipCount=abc")
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .getSiteContainers();
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request returns status code 200 when skipCount"
                            + " parameter starts with multiple zero")
    public void getSiteContainersWithSkipCountMultipleZero() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator))
                .withParams("skipCount=00002")
                .withCoreAPI()
                .usingSite(publicSiteWithContainers)
                .getSiteContainers()
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request returns status code 400 when site"
                            + " doesn't exist")
    public void getSiteContainersWithNonExistentSite() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator))
                .withCoreAPI()
                .usingSite("NonExistentSiteId")
                .getSiteContainers();
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, "NonExistentSiteId"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site containers request returns status 200 for moderated site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site containers request returns status 200 for several containers")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site container request with properties parameter applied returns"
                            + " status code 200")
    public void getSiteContainersUsingPropertiesParameter() throws Exception {
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteWithContainers)
                .usingParams("properties=folderId")
                .getSiteContainers()
                .assertThat()
                .entriesListCountIs(2)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site container request for a container that is not empty returns"
                            + " status code 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request returns status code 200 when first"
    ...
    public void getSiteContainersAndSkipFirst() throws Exception {
        restClient
                ...
                .entriesListDoesNotContain(
                        "folderId", restSiteContainers.getEntries().get(0).onModel().getFolderId())
                .and()
                .entriesListContains(
                        "folderId", restSiteContainers.getEntries().get(1).onModel().getFolderId());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request and get last container returns status"
                            + " code 200")
    public void getLastSiteContainer() throws Exception {
        restClient
                .authenticateUser(
                        publicSiteWithContainersUsers.getOneUserWithRole(UserRole.SiteCollaborator))
                .withParams("skipCount=" + String.valueOf(totalItems - 1))
                .withCoreAPI()
                .usingSite(publicSiteWithContainers)
                .getSiteContainers()
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site containers request returns status code 200 when high"
                            + " skipCount parameter is used")
    public void getSiteContainersWithHighSkipCount() throws Exception {
        restClient
                .authenticateUser(
                        publicSiteWithContainersUsers.getOneUserWithRole(UserRole.SiteCollaborator))
                .withParams("skipCount=999999")
                .withCoreAPI()
                .usingSite(publicSiteWithContainers)
                .getSiteContainers()
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get site container request for an empty siteId returns status code"
                            + " 404")
