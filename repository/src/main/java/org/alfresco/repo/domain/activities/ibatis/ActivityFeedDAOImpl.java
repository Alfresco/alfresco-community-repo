...
public class ActivityFeedDAOImpl extends ActivitiesDAOImpl implements ActivityFeedDAO {
    ...
    public int deleteFeedEntries(Date keepDate) throws SQLException {
        return template.delete(
                "alfresco.activities.delete_activity_feed_entries_older_than_date", keepDate);
    }
    ...
    public int deleteUserFeedEntries(String feedUserId) throws SQLException {
        ...
        return template.delete(
                "alfresco.activities.delete_activity_feed_for_feeduser_entries", params);
    }
    ...
    public List<ActivityFeedEntity> selectUserFeedsToClean(int maxFeedSize) throws SQLException {
        ...
        return template.selectList(
                "alfresco.activities.select_activity_user_feeds_greater_than_max", params);
    }
        ...
        if (siteId != null) {
            ...
            if ((!excludeThisUser) && (!excludeOtherUsers)) {
                ...
                return template.selectOne(
                        "alfresco.activities.count_activity_feed_for_feeduser_and_site", params);
                ...
                return template.selectOne(
                        "alfresco.activities.count_activity_feed_for_feeduser_me_and_site", params);
            }
        } else {
            // all sites
            ...
            if (!excludeThisUser && !excludeOtherUsers) {
                // no excludes => everyone => where feed user is me
                return template.selectOne(
                        "alfresco.activities.count_activity_feed_for_feeduser", params);
            } else if (excludeThisUser) {
                // exclude feed user => others => where feed user is me and post user is not me
                return template.selectOne(
                        "alfresco.activities.count_activity_feed_for_feeduser_others", params);
            } else if (excludeOtherUsers) {
                // exclude others => me => where feed user is me and post user is me
                return template.selectOne(
                        "alfresco.activities.count_activity_feed_for_feeduser_me", params);
            }
        }
    ...
    public List<ActivityFeedEntity> selectSiteFeedsToClean(int maxFeedSize) throws SQLException {
        ...
        return template.selectList(
                "alfresco.activities.select_activity_site_feeds_greater_than_max", params);
    }
    ...
    private PagingResults<ActivityFeedEntity> getPagingResults(
            PagingRequest pagingRequest, final List<ActivityFeedEntity> feedEntries) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<ActivityFeedEntity> selectSiteFeedEntries(String siteId, int maxFeedSize)
            throws SQLException {
        ActivityFeedQueryEntity params = new ActivityFeedQueryEntity();
        params.setSiteNetwork(siteId);
        ...
        // for given site
        return template.selectList(
                "alfresco.activities.select.select_activity_feed_for_site", params, rowBounds);
    }
}
