...
public class KeyStoreTests {
    ...
    protected TestAlfrescoKeyStore getKeyStore(
            String name,
            String type,
            final Map<String, String> passwords,
            final Map<String, String> encodedKeyData,
            String keyStoreLocation,
            String backupKeyStoreLocation) {
        KeyResourceLoader testKeyResourceLoader =
                new KeyResourceLoader() {
                    @Override
        ...
        KeyStoreParameters keyStoreParameters =
                new KeyStoreParameters(name, type, null, "", keyStoreLocation);
        KeyStoreParameters backupKeyStoreParameters =
                new KeyStoreParameters(name + ".backup", type, null, "", backupKeyStoreLocation);
    ...
    @Test
    public void test1() {
        // missing keystore, missing backup keystore, no registered keys -> create key store with
        // metadata key and register key

        TestAlfrescoKeyStore missingMainKeyStore =
                getKeyStore(
                        "main",
                        "JCEKS",
                        Collections.singletonMap(KeyProvider.ALIAS_METADATA, "metadata"),
                        Collections.singletonMap(KeyProvider.ALIAS_METADATA, generateEncodedKey()),
        ...
        assertTrue(
                ...
                encryptionKeysRegistry
                        .getRegisteredKeys(missingMainKeyStore.getKeyAliases())
    ...
    @Test
    public void test2() {
        // missing main keystore, missing backup keystore, metadata registered key -> error,
        // re-instate the keystore
        TestAlfrescoKeyStore missingMainKeyStore =
                getKeyStore(
                        "main",
                        "JCEKS",
    ...
    public void test3() {
        ...
        TestAlfrescoKeyStore mainKeyStore =
                getKeyStore(
                        "main",
                        "JCEKS",
                        Collections.singletonMap(KeyProvider.ALIAS_METADATA, "metadata"),
    ...
    public void test4() {
        ...
        //		TestAlfrescoKeyStore changedMainKeyStore = getKeyStore("main", "JCEKS",
        // Collections.singletonMap(KeyProvider.ALIAS_METADATA, "metadata"),
    ...
    @Test
    public void test5() {
        // create main keystore, backup main keystore, change main keystore -> check that backup
        // keystore key is ok, re-register new main key
        ...
        // check that the new metadata key has been successfully re-registered by encrypting and
        // decrypting some content with it
        assertTrue(
                "",
                EncryptionKeysRegistry.KEY_STATUS.OK
                        == encryptionKeysRegistry.checkKey(
