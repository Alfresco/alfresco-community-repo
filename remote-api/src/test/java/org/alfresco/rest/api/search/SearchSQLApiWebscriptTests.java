...
public class SearchSQLApiWebscriptTests {
  ...
  public void testSearchQueryParams() throws Exception {
    ...
    SearchSQLQuery searchQuery = new SearchSQLQuery(
      query,
      "solr",
      emptyList(),
      1000,
  ...
  public void testSearchQueryParamsFormatNull() throws Exception {
    ...
    searchQuery =
      new SearchSQLQuery(query, null, emptyList(), 1000, true, "", emptyList());
  ...
  public void testSearchQueryNullStmt() throws Exception {
    ...
    try {
      ...
      assertEquals(
        true,
        e.getMessage().contains("Required stmt parameter is missing.")
      );
    }
  }
}
