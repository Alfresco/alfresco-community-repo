...
/**
 * Web script 'type' that can be used when the binary data of a content property needs to be
 * streamed back to the client as the result of executing the web script.
 *
 * <p>Many of these methods have been moved into the ContentStreamer class so they can be reused by
 * other webscripts.
 *
...
public class StreamContent extends AbstractWebScript {
        ...
        try {
            ...
            if (executeScript != null) {
                if (logger.isDebugEnabled())
                    logger.debug(
                            "Executing script " + executeScript.getContent().getPathDescription());

                Map<String, Object> scriptModel =
                        createScriptParameters(req, res, executeScript, model);
                ...
                mergeScriptModelIntoTemplateModel(
                        executeScript.getContent().getPath(), returnModel, model);
            }
                ...
                if (contentPath == null) {
                    ...
                    if (nodeRef == null) {
                        throw new WebScriptException(
                                "The content node was not specified so the content cannot be"
     ...
     * @throws IOException
     */
    protected void streamContent(WebScriptRequest req, WebScriptResponse res, File file)
            throws IOException {
     ...
     */
    private final void mergeScriptModelIntoTemplateModel(
            String scriptPath, Map<String, Object> scriptModel, Map<String, Object> templateModel) {
        ...
        if (i != -1) {
            ...
            ScriptProcessor processor =
                    getContainer()
                            ...
                            .getScriptProcessorByExtension(extension);
            if (processor != null) {
     ...
     */
    protected final void renderFormatTemplate(
            String format, Map<String, Object> model, Writer writer) {
    ...
    protected ObjectReference createObjectReferenceFromUrl(
            Map<String, String> args, Map<String, String> templateArgs) {
