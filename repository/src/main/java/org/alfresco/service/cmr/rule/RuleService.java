...
public interface RuleService
{
     ...
     *            indicates whether the inherited rules should be included in the result list or not
     * @return a list of the rules associated with the node
     */
     ...
     *            indicates whether the inherited rules should be included in the result list or not
     * @param ruleTypeName
     *            the name of the rule type, if null is passed all rule types are returned
     * @return a list of the rules associated with the node
     */
     ...
     *
     * @param nodeRef
     *            The starting node ref.
     * @return A list of node refs, starting with the first parent of the first parent of ... and ending with the object generated by the given node ref.
     */
    @Auditable(parameters = {"nodeRef"})
    @Experimental
     ...
     * @param ruleSet
     *            The rule set node.
     * @param maxFoldersToReturn
     *            A limit on the number of folders to return (since otherwise this could traverse a very large proportion of the repository).
     ...
     *            The rule set node.
     * @param maxFoldersToReturn
     *            A limit on the number of folders to return.
    ...
    /**
     * Returns the owning node reference for an action. Returns null for an unsaved action or one that is not parented by a rule.
     * 
