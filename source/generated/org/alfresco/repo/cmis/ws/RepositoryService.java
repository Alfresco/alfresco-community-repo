...
public class RepositoryService extends Service {
    ...
    public final static QName SERVICE = new QName("http://docs.oasis-open.org/ns/cmis/ws/200901", "RepositoryService");
    public final static QName RepositoryServicePort = new QName("http://docs.oasis-open.org/ns/cmis/ws/200901", "RepositoryServicePort");
    static {
        URL url = null;
        try {
