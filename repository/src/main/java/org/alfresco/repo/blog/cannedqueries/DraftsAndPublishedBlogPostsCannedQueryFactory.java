...
public class DraftsAndPublishedBlogPostsCannedQueryFactory
    ...
    public CannedQuery<BlogEntity> getCannedQuery(CannedQueryParameters parameters) {
        final DraftsAndPublishedBlogPostsCannedQuery cq =
                new DraftsAndPublishedBlogPostsCannedQuery(
    ...
    public CannedQuery<BlogEntity> getCannedQuery(
        ...
        DraftsAndPublishedBlogPostsCannedQueryParams paramBean =
                new DraftsAndPublishedBlogPostsCannedQueryParams(
        ...
        // Sort by created then published. We want a list of all published (most recently published
        // first),
