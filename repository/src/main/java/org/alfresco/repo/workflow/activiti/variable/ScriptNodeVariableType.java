...
/**
 * Custom {@link VariableType} that allows storing {@link ActivitiScriptNode} as a process variable
 * in activiti, allowing node properties being used in scripts.
 *
        ...
        if (value != null) {
            if (!(value instanceof ActivitiScriptNode)) {
                throw new ActivitiException(
                        "Passed value is not an instance of ActivitiScriptNode, cannot set variable"
                                + " value.");
            }
