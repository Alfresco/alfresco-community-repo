...
public interface ContentDataDAO {
    ...
    void getContentUrlsOrphaned(
            ContentUrlHandler contentUrlHandler, Long maxOrphanTimeExclusive, int maxResults);
     ...
     * @param maxResults the maximum number of results (1 or greater)
     */
    void getContentUrlsKeepOrphaned(ContentUrlHandler contentUrlHandler, int maxResults);
