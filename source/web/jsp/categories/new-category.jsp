...
<r:page titleId="title_create_category">
...
<script language="JavaScript1.2">
   ...
   function checkButtonState()
   {
      ...
      {
         document.getElementById("new-category:ok-button").disabled = true;
      }
      else
      {
         document.getElementById("new-category:ok-button").disabled = false;
      }
   }
