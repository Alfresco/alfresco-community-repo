...
public class ActionServiceImplTest extends BaseAlfrescoSpringTest {
    ...
    public void testGetActionDefinition() {
        ...
        ActionConditionDefinition nullCondition =
                this.actionService.getActionConditionDefinition(BAD_NAME);
    ...
    public void testGetActionDefinitions() {
        ...
        // Get the action defintions for a folder type (there should be less than the total
        // available)
    ...
    public void testGetActionConditionDefinition() {
        ActionConditionDefinition condition =
                this.actionService.getActionConditionDefinition(NoConditionEvaluator.NAME);
    ...
    public void testGetActionConditionDefinitions() {
        List<ActionConditionDefinition> defintions =
                this.actionService.getActionConditionDefinitions();
        assertNotNull(defintions);
        assertFalse(defintions.isEmpty());
    ...
    public void testCreateActionCondition() {
        ActionCondition condition =
                this.actionService.createActionCondition(NoConditionEvaluator.NAME);
        assertNotNull(condition);
    ...
    public void testCreateCompositeActionCondition() {
        ...
        assertEquals(
                ...
                action.getActionConditionDefinitionName());
    }
    ...
    public void testEvaluateAction() {
        ...
        ActionCondition condition =
                this.actionService.createActionCondition(ComparePropertyValueEvaluator.NAME);
    ...
    public void testEvaluateCompositeActionConditionWith1SubCondition() {
        CompositeActionCondition compositeCondition =
                this.actionService.createCompositeActionCondition();
    ...
    public void testEvaluateCompositeActionConditionWith2SubConditions() {
        ...
        ActionCondition conditionTwo =
                this.actionService.createActionCondition("compare-text-property");
        conditionTwo.setParameterValue(ComparePropertyValueEvaluator.PARAM_VALUE, "Doc");
        conditionTwo.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_PROPERTY, QName.createQName(null, "name"));
        conditionTwo.setParameterValue(
    ...
    public void testExecuteAction() {
        ...
        action1.setParameterValue(
                AddFeaturesActionExecuter.PARAM_ASPECT_NAME, ContentModel.ASPECT_LOCKABLE);
    ...
    /**
     * Test saving an action with no conditions. Includes testing storage and retrieval of
    ...
    public void testSaveActionNoCondition() {
        ...
        assertEquals(
                ...
                savedAction.getParameterValue(AddFeaturesActionExecuter.PARAM_ASPECT_NAME));
        ...
        assertEquals(
                ...
                savedAction2.getParameterValue(AddFeaturesActionExecuter.PARAM_ASPECT_NAME));
        ...
        assertEquals(
                AddFeaturesActionExecuter.NAME, savedCompensatingAction.getActionDefinitionName());
        assertEquals(
                ContentModel.ASPECT_VERSIONABLE,
                savedCompensatingAction.getParameterValue(
        ...
        assertEquals(
                AddFeaturesActionExecuter.NAME, savedCompensatingAction2.getActionDefinitionName());
        assertEquals(
                ContentModel.ASPECT_CLASSIFIABLE,
                savedCompensatingAction2.getParameterValue(
                        AddFeaturesActionExecuter.PARAM_ASPECT_NAME));
    ...
    public void testSaveActionWithConditions() {
        ...
        ActionCondition actionCondition2 =
                this.actionService.createActionCondition(ComparePropertyValueEvaluator.NAME);
        ...
        ActionCondition actionCondition3 =
                this.actionService.createActionCondition(InCategoryEvaluator.NAME);
        actionCondition3.setParameterValue(
                InCategoryEvaluator.PARAM_CATEGORY_ASPECT, ContentModel.ASPECT_OWNABLE);
        ...
        actionCondition2.setParameterValue(
                ComparePropertyValueEvaluator.PARAM_OPERATION,
                ComparePropertyValueOperation.EQUALS);
        ...
        for (ActionCondition savedCondition : savedAction2.getActionConditions()) {
            if (savedCondition.getActionConditionDefinitionName().equals(InCategoryEvaluator.NAME)
                    == true) {
                assertEquals(1, savedCondition.getParameterValues().size());
                assertEquals(
    ...
    public void testSaveCompositeAction() {
        ...
        CompositeAction savedCompositeAction =
                (CompositeAction) this.actionService.getAction(this.nodeRef, actionId);
        ...
        this.actionService.saveAction(this.nodeRef, compositeAction);
        assertEquals(1, this.actionService.getActions(this.nodeRef).size());
        CompositeAction savedCompositeAction2 =
                (CompositeAction) this.actionService.getAction(this.nodeRef, actionId);
        ...
        for (Action action : savedCompositeAction2.getActions()) {
            if (action.getActionDefinitionName().equals(CheckOutActionExecuter.NAME) == true) {
                ...
                assertEquals(
                        "description",
                        action2.getParameterValue(CheckInActionExecuter.PARAM_DESCRIPTION));
            } else {
                fail("We have an action here we are not expecting.");
            }
        }
    ...
    public void testConditionOrder() {
        ...
        ActionCondition condition3 =
                this.actionService.createActionCondition(NoConditionEvaluator.NAME);
        ActionCondition condition4 =
                this.actionService.createActionCondition(NoConditionEvaluator.NAME);
    ...
    public void offtestAsyncLongRunningActionsFilter() {
        ...
        final SleepActionExecuter sleepAction =
                (SleepActionExecuter) applicationContext.getBean("sleep-action");
        ...
        try {
            Thread.sleep(
                    sleepAction.getSleepMs() * actionSubmissonCount
                            + 1000); // Enough time for all actions and an extra second for luck.
        ...
        try {
            Thread.sleep(
                    sleepAction.getSleepMs()
                            + 2000); // Enough time for latest action and an extra 2 seconds for
            // luck.
        } catch (InterruptedException ignored) {
            // intentionally empty
        }
    ...
    public void testAsyncExecuteAction() {
        ...
        postAsyncActionTest(
                ...
                new AsyncTest() {
                    public String executeTest() {
                        boolean result =
                                finalNodeService.hasAspect(
                                        finalNodeRef, ContentModel.ASPECT_CLASSIFIABLE);
        ...
        postAsyncActionTest(
                ...
                new AsyncTest() {
                    public String executeTest() {
                        boolean result =
                                finalNodeService.hasAspect(
                                                finalNodeRef, ContentModel.ASPECT_VERSIONABLE)
                                        && finalNodeService.hasAspect(
                                                finalNodeRef, ContentModel.ASPECT_LOCKABLE);
    ...
    public static void postAsyncActionTest(
        ...
        try {
            ...
            fail(
                    "An exception was encountered whilst checking the async action was executed: "
    ...
    public interface AsyncTest {
        /**
         * @return <code>null</code> if the test succeeded, else an error message for use in JUnit
         *     report.
         */
        String executeTest();
    }
    ...
    public void testSyncFailureBehaviour() {
        ...
        // Test what happens when a element of a composite action fails (should raise and bubble up
        // to parent bahviour)
        // Create the composite action
        Action action1 = this.actionService.createAction(AddFeaturesActionExecuter.NAME);
        action1.setParameterValue(
        ...
        action2.setParameterValue(
                AddFeaturesActionExecuter.PARAM_ASPECT_NAME,
                QName.createQName("{test}badDogAspect"));
        CompositeAction compAction = this.actionService.createCompositeAction();
        compAction.setTitle("title");
        compAction.setDescription("description");
        compAction.addAction(action1);
    ...
    public void testCompensatingAction() {
        ...
        compensatingAction2.setParameterValue(
                AddFeaturesActionExecuter.PARAM_ASPECT_NAME, ContentModel.ASPECT_TEMPORARY);
        ...
        postAsyncActionTest(
                ...
                new AsyncTest() {
                    public String executeTest() {
                        boolean fatalCompensatingActionRun =
                                ActionServiceImplTest.this.nodeService.hasAspect(
                                        nodeRef, ContentModel.ASPECT_CLASSIFIABLE);

                        boolean nonFatalCompensatingActionRun =
                                ActionServiceImplTest.this.nodeService.hasAspect(
                        ...
                        return (!fatalCompensatingActionRun || nonFatalCompensatingActionRun
                                ? result.toString()
                                : null);
                    }
                    ;
        ...
        compensatingAction.setParameterValue(
                AddFeaturesActionExecuter.PARAM_ASPECT_NAME, QName.createQName("{test}badAspect"));
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() {
                                try {
                                    ActionServiceImplTest.this.actionService.executeAction(
                                            fatalAction, ActionServiceImplTest.this.nodeRef);
                                } catch (RuntimeException exception) {
                                    // The exception should have been ignored and execution
                                    // continued
                                    exception.printStackTrace();
    ...
    public void testALF5027() throws Exception {
        ...
        Action action1 = this.actionService.createAction(AddFeaturesActionExecuter.NAME);
        action1.setParameterValue(
                AddFeaturesActionExecuter.PARAM_ASPECT_NAME, ContentModel.ASPECT_DUBLINCORE);
    ...
    /**
     * Tests that we can read, save, load etc the various execution related details such as started
     * at, ended at, status and exception
     */
    @Test
     ...
     *
     * @param isFatal if <code>false</code> this will give an action which throws a {@link
     *     ActionServiceTransientException non-fatal action exception}.
     */
    protected Action createFailingMoveAction(boolean isFatal) {
        ...
        if (isFatal) {
            ...
            failingAction.setParameterValue(
                    MoveActionExecuter.PARAM_DESTINATION_FOLDER, badNodeRef);
        } else {
    ...
    protected static Action createFailingSleepAction(
            String id, boolean isFatal, ActionService actionService) throws Exception {
    ...
    protected static Action createWorkingSleepAction(String id, ActionService actionService)
            throws Exception {
        Action workingAction =
                new CancellableSleepAction(actionService.createAction(SleepActionExecuter.NAME));
    ...
    public static class SleepActionExecuter extends ActionExecuterAbstractBase {
        ...
        public static void registerIfNeeded(ApplicationContext ctx) {
            if (!ctx.containsBean(SleepActionExecuter.NAME)) {
                ...
                executor.actionTrackingService =
                        (ActionTrackingService) ctx.getBean("actionTrackingService");
                // Register
                ((ConfigurableApplicationContext) ctx)
                        .getBeanFactory()
                        .registerSingleton(SleepActionExecuter.NAME, executor);
            }
        }
        ...
        protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
            ...
            if (action instanceof CancellableSleepAction) {
                ...
                if (cancelled) throw new ActionCancelledException(ca);
            }
        }
    }
    ...
    public static class TransientFailActionExecuter extends ActionExecuterAbstractBase {
        ...
        protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
            ...
            throw new ActionServiceTransientException(
                    "action failed intentionally in "
                            + TransientFailActionExecuter.class.getSimpleName());
        }
    }
