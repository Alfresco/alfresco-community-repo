...
public class GetFolderTreeTests extends CmisTest {
  ...
  public void getFolderTreeForDeletedParentFolderWithChildren()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void siteCollaboratorCanGetFolderTreeForValidParentFolder()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorCanGetFolderTreeForValidParentFolder()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteConsumerCanGetFolderTreeForValidParentFolder()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void nonSiteMemberCannotGetFolderTreeForAFolderFromAPrivateSite()
    throws Exception {
  ...
  public void nonSiteMemberCannotGetFolderTreeForAFolderFromAModeratedSite()
    throws Exception {
