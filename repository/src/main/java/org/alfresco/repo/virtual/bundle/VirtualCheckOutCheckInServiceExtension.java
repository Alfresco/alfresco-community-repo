...
public class VirtualCheckOutCheckInServiceExtension
    ...
    public NodeRef checkout(
        ...
        if (parentReference != null) {
            Reference workingCopyReference =
                    NodeProtocol.newReference(workingCopy, parentReference);
    ...
    public NodeRef checkout(NodeRef nodeRef) {
        ...
        return virtualizeOriginalIfNeeded(nodeRef, workingCopy);
    }
    ...
    public NodeRef checkin(
        ...
        NodeRef materialOriginalNode =
                theTrait.checkin(
                        materialWorkingCopy, versionProperties, contentUrl, keepCheckedOut);
    ...
    public NodeRef checkin(
        ...
        NodeRef materialWorkingCopy = smartStore.materializeIfPossible(workingCopyNodeRef);
        NodeRef materialOriginalNode =
                theTrait.checkin(materialWorkingCopy, versionProperties, contentUrl);

        return virtualizeOriginalIfNeeded(workingCopyNodeRef, materialOriginalNode);
    }

    private NodeRef virtualizeOriginalIfNeeded(
            NodeRef workingCopyNodeRef, NodeRef materialOriginalNode) {
        ...
        if ((materialOriginalNode != null) && (workingCopyReference != null)) {
            Reference parentReference =
                    workingCopyReference.execute(new GetParentReferenceMethod());
            Reference originalReference =
                    NodeProtocol.newReference(materialOriginalNode, parentReference);
    ...
    public NodeRef cancelCheckout(NodeRef workingCopyNodeRef) {
        NodeRef materialOriginalNode =
                getTrait().cancelCheckout(smartStore.materializeIfPossible(workingCopyNodeRef));
    ...
    public NodeRef getWorkingCopy(NodeRef nodeRef) {
        CheckOutCheckInServiceTrait theTrait = getTrait();
        NodeRef materialWorkingCopy =
                theTrait.getWorkingCopy(smartStore.materializeIfPossible(nodeRef));

        return virtualizeVersionIfNeeded(nodeRef, materialWorkingCopy);
    }
    ...
    private NodeRef virtualizeVersionIfNeeded(NodeRef originalNodeRef, NodeRef materialVersion) {
        ...
        if ((materialVersion != null)
            ...
            Reference workingCopyReference =
                    NodeProtocol.newReference(materialVersion, parentReference);
    ...
    public NodeRef getCheckedOut(NodeRef nodeRef) {
        CheckOutCheckInServiceTrait theTrait = getTrait();
        NodeRef materialChekedOut =
                theTrait.getCheckedOut(smartStore.materializeIfPossible(nodeRef));
        return virtualizeVersionIfNeeded(nodeRef, materialChekedOut);
    }
