...
public class GetSiteMemberTests extends RestTest {
  ...
  public void regularUserIsNotAbleToGetSiteMemberOfPrivateSite()
    throws Exception {
  ...
  public void regularUserIsAbleToGetSiteMemberOfModeratedSite()
    throws Exception {
    UserModel regularUser = dataUser.createRandomTestUser();
