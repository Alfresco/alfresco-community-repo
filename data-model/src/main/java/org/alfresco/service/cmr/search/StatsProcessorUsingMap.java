...
/**
 * Post-Processors the results of a Stats query using a Map of values. Looks up the value by Map.key
 * and replaces it with Map.value
 *
 * <p>If its not found then returns the existing value.
 *
 * @author Gethin James
 * @since 5.0
 */
