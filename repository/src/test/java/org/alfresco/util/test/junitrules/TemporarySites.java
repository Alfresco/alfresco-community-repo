...
public class TemporarySites extends AbstractPersonRule {
  ...
  protected void after() {
    final RetryingTransactionHelper transactionHelper = (RetryingTransactionHelper) appContextRule
      .getApplicationContext()
      .getBean("retryingTransactionHelper");
    final SiteService siteService = appContextRule
      .getApplicationContext()
      .getBean("siteService", SiteService.class);
    final ActivityPostDAO postDAO = appContextRule
      .getApplicationContext()
      .getBean("postDAO", ActivityPostDAO.class);
    final NodeArchiveService nodeArchiveService = (NodeArchiveService) appContextRule
      .getApplicationContext()
  ...
  public SiteInfo createSite(
    ...
    final RetryingTransactionHelper transactionHelper = appContextRule
      .getApplicationContext()
    ...
    SiteInfo newSite = transactionHelper.doInTransaction(
      new RetryingTransactionCallback<SiteInfo>() {
        public SiteInfo execute() throws Throwable {
          ...
          SiteInfo newSite = siteService.createSite(
            sitePreset,
            siteShortName,
            siteTitle,
            siteDescription,
          ...
          NodeRef docLibFolder = siteService.getContainer(
            siteShortName,
  ...
  public TestSiteAndMemberInfo createTestSiteWithUserPerRole(
    ...
    List<String> userNames = transactionHelper.doInTransaction(
    ...
    NodeRef doclibFolder = transactionHelper.doInTransaction(
  ...
  public List<String> createTestSiteWithGroups(
    ...
    final SiteService siteService = appContextRule
      .getApplicationContext()
      .getBean("siteService", SiteService.class);
    final AuthorityService authorityService = appContextRule
      .getApplicationContext()
      .getBean("authorityService", AuthorityService.class);
    final PersonService personService = appContextRule
      .getApplicationContext()
    ...
    List<String> groupIds = transactionHelper.doInTransaction(
      new RetryingTransactionCallback<List<String>>() {
        public List<String> execute() throws Throwable {
          ...
          for (int i = 0; i < noOfGroups; i++) {
            ...
            properties.put(
              ...
              GUID.generate() + "@test.com"
            );
            personService.createPerson(properties);

            log.debug("Creating temporary site group " + groupName);
            final String groupId = authorityService.createAuthority(
              AuthorityType.GROUP,
              groupName
            );
