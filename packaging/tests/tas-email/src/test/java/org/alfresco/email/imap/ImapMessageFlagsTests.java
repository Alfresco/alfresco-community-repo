...
public class ImapMessageFlagsTests extends EmailTest {
    @TestRail(
            ...
            description =
                    "Verify site manager can set flags action to a content(message) through IMAP"
                            + " Client")
    ...
    public void siteManagerShouldSetFlagsToAContent() throws Exception {
        ...
        imapProtocol
                ...
                .then()
                .assertThat()
                .messageContainsFlags(Flags.Flag.ANSWERED, Flags.Flag.SEEN);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager can set flags to a content(message) through IMAP Client")
    ...
    public void siteManagerShouldSetFlagsToContent() throws Exception {
        ...
        imapProtocol
                ...
                .and()
                .withMessage()
                .setFlags(Flags.Flag.ANSWERED, Flags.Flag.SEEN)
                .updateFlags()
                .then()
                .assertThat()
                .messageContainsFlags(Flags.Flag.ANSWERED, Flags.Flag.SEEN);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can remove flags from a content(message) through IMAP"
                            + " Client")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    public void siteManagerShouldRemoveFlagsFromContent() throws Exception {
        ...
        imapProtocol
                ...
                .and()
                .withMessage()
                .removeFlags(Flags.Flag.ANSWERED, Flags.Flag.SEEN)
                .updateFlags()
                .then()
                .assertThat()
                .messageDoesNotContainFlags(Flags.Flag.ANSWERED, Flags.Flag.SEEN);
    }
}
