...
public class SolrSearchContextTest {
    ...
    /**
     * This test just starts up the application context with the solr-search-context.xml and
     * common-search-scheduler-context.xml and the required property files
     */
    @Test
