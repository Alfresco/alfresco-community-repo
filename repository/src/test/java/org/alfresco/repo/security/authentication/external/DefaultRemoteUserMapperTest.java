...
public class DefaultRemoteUserMapperTest extends AbstractChainedSubsystemTest {
    ...
    protected void setUp() throws Exception {
        ...
        childApplicationContextFactory =
                getChildApplicationContextFactory(childApplicationContextManager, "external1");
    }
    ...
    public void testProxiedHeader() throws Exception {
        ...
        childApplicationContextFactory.setProperty(
                "external.authentication.userIdPattern", "abc-(.*)-999");
    ...
    /**
     * MNT-13989 Test simulates the extraction of subject distinguished name from a client SSL
     * certificate
     *
     * @throws Exception
     */
    public void testRemoteUserFromCert() throws Exception {
        childApplicationContextFactory.stop();
        childApplicationContextFactory.setProperty(
                "external.authentication.proxyUserName", "CN=alfresco-system");
        childApplicationContextFactory.setProperty(
