...
public interface RepoServerMgmtMBean
{
     ...
     * 
     * If number of non-expired logins is greater or equal to the limit then further logins will be prevented otherwise valid login attempt will be permitted. However, single-user mode will take precedence.
     * 
     * Max users = 0 prevents further logins Max users = -1 allow logins (without a max limit)
     */
