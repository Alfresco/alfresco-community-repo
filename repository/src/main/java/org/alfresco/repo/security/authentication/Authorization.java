 ...
 *
 * <p>Identifies whether username / password is a ticket.
 *
 * <p>Is ticket, if one of the following is true:
 *
 * <p>a) Username == "ROLE_TICKET" (in any case) b) Username is not specified (i.e. null) c)
...
public class Authorization {
    ...
    public Authorization(String authorization) {
        ...
        if (authorization.length() == 0) {
            throw new IllegalArgumentException(
                    "authorization does not consist of username and password");
        }
    ...
    private void setUser(String username, String password) {
        ...
        if (username == null
                || username.length() == 0
                || username.equalsIgnoreCase(TICKET_USERID)) {
