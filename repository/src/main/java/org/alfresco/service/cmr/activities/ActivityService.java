...
public interface ActivityService extends ActivityPostService {
     ...
     *
     * <p>Will return activities for all users across all sites, or optionally for all users for
     * specified site.
     *
     ...
     *
     * <p>Will return activities for users across all sites, or optionally for users for specified
     * site.
     *
     * <p>User filters are: - all user activities (excludeThisUser = false, excludeOtherUsers =
     * false) - other user activities (excludeThisUser = true, excludeOtherUsers = false) - my user
     * activities (excludeThisUser = false, excludeOtherUsers = true) note: if both excludes are
     * true then no activities will be returned.
     *
     * @param userId - required
     * @param siteId - optional, if set then will filter by given siteId else return all sites
     * @param excludeThisUser - if TRUE then will exclude activities for this user (hence returning
     *     other users only)
     * @param excludeOtherUsers - if TRUE then will exclude activities for other users (hence
     *     returning this user only)
     * @return list of JSON feed entries
     */
    @NotAuditable
    public List<String> getUserFeedEntries(
            String userId, String siteId, boolean excludeThisUser, boolean excludeOtherUsers);
    ...
    /**
     * Retrieve user feed with optional site filter and optional user filters and optional min feed
     * DB id
     *
     * <p>Will return activities for users across all sites, or optionally for users for specified
     * site.
