...
/**
 * The authentication service defines the API for managing authentication information against a user
 * id.
 *
 * @author Andy Hind
 */
...
public interface AuthenticationService {
    ...
    /**
     * Carry out an authentication attempt. If successful the user is set to the current user. The
     * current user is a part of the thread context.
     *
