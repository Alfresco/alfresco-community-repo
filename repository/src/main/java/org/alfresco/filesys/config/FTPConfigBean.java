...
public class FTPConfigBean {
     ...
     *
     * @param serverEnabled the new server enabled
     */
     ...
     *
     * @param allowAnonymous the new allow anonymous
     */
     ...
     *
     * @param anonymousAccount the new anonymous account
     */
