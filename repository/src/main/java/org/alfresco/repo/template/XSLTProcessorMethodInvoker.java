...
public class XSLTProcessorMethodInvoker {
  ...
  private static final Log log = LogFactory.getLog(
    XSLTProcessorMethodInvoker.class
  );
    ...
    for (int i = 0; i < arguments.length; i++) {
      ...
      if (
        ...
        throw new IllegalArgumentException(
          "unable to convert argument " + arguments[i]
        );
      }
    }
  ...
  public Object invokeMethod(final String id, Object[] arguments)
    ...
    if (result == null) {
      ...
      return new NodeIterator() {
        ...
        public Node nextNode() throws DOMException {
          if (log.isDebugEnabled()) log.debug(
            "NodeIterator.nextNode(" + index + ")"
          );
          if (this.detached) throw new DOMException(
        ...
        public Node previousNode() throws DOMException {
          if (log.isDebugEnabled()) log.debug(
            "NodeIterator.previousNode(" + index + ")"
          );
          if (this.detached) throw new DOMException(
            DOMException.INVALID_STATE_ERR,
            null
      ...
      throw new IllegalArgumentException(
        "unable to convert " + result.getClass().getName()
      );
    }
  }
}
