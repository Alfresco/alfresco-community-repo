...
public class EncryptorTest extends TestCase {
  ...
  public void testBasicBytes_NoKey() {
    ...
    Pair<byte[], AlgorithmParameters> encryptedPair = encryptor.encrypt(
      "fluff",
      null,
      bytes
    );
  ...
  public void testBasicObject() {
    ...
    Pair<byte[], AlgorithmParameters> encryptedPair = encryptor.encryptObject(
      "mykey2",
      null,
      testObject
    );
  ...
  public void testSealedObject() {
    ...
    Serializable sealedObject = encryptor.sealObject(
      "mykey2",
      null,
      testObject
    );
