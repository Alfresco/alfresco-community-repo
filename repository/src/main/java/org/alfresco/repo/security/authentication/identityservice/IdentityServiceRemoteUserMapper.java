...
/**
 * A {@link RemoteUserMapper} implementation that detects and validates JWTs issued by the Alfresco
 * Identity Service.
 *
...
public class IdentityServiceRemoteUserMapper implements RemoteUserMapper, ActivateableBean {
    ...
    /**
     * Normalizes a user id, taking into account existing user accounts and case sensitivity
     * settings.
     *
