...
public class MLAnaysisModeExpansionTest extends TestCase {
  ...
  public void testIdentity() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(MLAnalysisMode.LOCALE_ONLY, locale, false)
    );
  ...
  public void testIdentityAndAll() {
    ...
    HashSet<Locale> locales = new HashSet<Locale>();
    locales.addAll(
      MLAnalysisMode.getLocales(MLAnalysisMode.LOCALE_AND_ALL, locale, false)
    );
  ...
  public void testAll() {
    ...
    HashSet<Locale> locales = new HashSet<Locale>();
    locales.addAll(
      MLAnalysisMode.getLocales(MLAnalysisMode.ALL_ONLY, locale, false)
    );
    assertEquals(1, locales.size());
    assertTrue(locales.contains(new Locale("", "", "")));
  }
  ...
  public void testContaining() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(
        MLAnalysisMode.LOCALE_AND_ALL_CONTAINING_LOCALES,
        locale,
        false
      )
    );
  ...
  public void testContainingAndAll() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(
        MLAnalysisMode.LOCALE_AND_ALL_CONTAINING_LOCALES_AND_ALL,
        locale,
        false
      )
    );
  ...
  public void testLang() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(
        MLAnalysisMode.ALL_LANGUAGES_AND_ALL,
        new Locale("en", "GB", ""),
        false
      )
    );
  ...
  public void testExactLang() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(
        MLAnalysisMode.EXACT_LANGUAGE_AND_ALL,
        new Locale("en", "GB", ""),
        false
      )
    );
  ...
  public void testCountry() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(
        MLAnalysisMode.ALL_COUNTRIES_AND_ALL,
        new Locale("en", "", ""),
        false
      )
    );
  ...
  public void testExactCountry() {
    ...
    locales.addAll(
      MLAnalysisMode.getLocales(
        MLAnalysisMode.EXACT_COUNTRY_AND_ALL,
        new Locale("en", "GB", ""),
        false
      )
    );
  ...
  public void testIdentityWC() {
    ...
    HashSet<Locale> locales = new HashSet<Locale>();
    locales.addAll(
      MLAnalysisMode.getLocales(MLAnalysisMode.LOCALE_ONLY, locale, true)
    );
    assertEquals(1, locales.size());
    assertTrue(locales.contains(locale));
  }
  ...
  public void testIdentityAndAllWC() {
    ...
    HashSet<Locale> locales = new HashSet<Locale>();
    locales.addAll(
      MLAnalysisMode.getLocales(MLAnalysisMode.LOCALE_AND_ALL, locale, true)
    );
    assertEquals(3, locales.size());
    assertTrue(locales.contains(locale));
    assertTrue(locales.contains(new Locale("", "", "")));
  ...
  public void testAllWC() {
    ...
    HashSet<Locale> locales = new HashSet<Locale>();
    locales.addAll(
      MLAnalysisMode.getLocales(MLAnalysisMode.ALL_ONLY, locale, true)
    );
    assertEquals(2, locales.size());
    assertTrue(locales.contains(new Locale("", "", "")));
    assertTrue(locales.contains(new Locale("*", "", "")));
