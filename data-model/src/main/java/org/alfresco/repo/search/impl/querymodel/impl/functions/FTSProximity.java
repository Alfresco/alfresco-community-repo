...
public class FTSProximity extends BaseFunction {
    public static final String NAME = "FTSProximity";
    ...
    static {
        ...
        args.put(
                ARG_FIRST,
                new BaseArgumentDefinition(
                        Multiplicity.SINGLE_VALUED, ARG_FIRST, DataTypeDefinition.ANY, true));
        args.put(
                ARG_LAST,
                new BaseArgumentDefinition(
                        Multiplicity.SINGLE_VALUED, ARG_LAST, DataTypeDefinition.ANY, true));
        args.put(
                ARG_PROPERTY,
                new BaseArgumentDefinition(
                        Multiplicity.SINGLE_VALUED, ARG_PROPERTY, DataTypeDefinition.ANY, false));
        args.put(
                ARG_SLOP,
                new BaseArgumentDefinition(
                        Multiplicity.SINGLE_VALUED, ARG_SLOP, DataTypeDefinition.INT, false));
    }
