...
public interface RequestReader {
     ...
     */
    default <T> T extractJsonContent(
            WebScriptRequest req, JacksonHelper jsonHelper, Class<T> requiredType) {
        Reader reader;
        try {
    ...
    /**
     * Extracts the body contents from the request as a List, the JSON can be an array or just a
     ...
     */
    default <T> List<T> extractJsonContentAsList(
            WebScriptRequest req, JacksonHelper jsonHelper, Class<T> requiredType) {
        Reader reader;
        try {
            reader = req.getContent().getReader();
