...
public class DeleteFavoriteTests extends RestTest {
  ...
  public void managerIsAbleToDeleteFavorites() throws Exception {
    ...
    restClient
      ...
      .entriesListDoesNotContain(
        "visibility",
        siteModel.getVisibility().toString()
      )
      .and()
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.SANITY })
  public void userIsNotAbleToDeleteFavoritesIfAuthenticationFails()
    throws Exception {
    UserModel siteManager = usersWithRoles.getOneUserWithRole(
      UserRole.SiteManager
    );
  ...
  public void contributorIsAbleToDeleteFavorites() throws Exception {
    UserModel siteContributor = usersWithRoles.getOneUserWithRole(
      UserRole.SiteContributor
    );
    restClient
  ...
  public void consumerIsAbleToDeleteFavorites() throws Exception {
    UserModel siteConsumer = usersWithRoles.getOneUserWithRole(
      UserRole.SiteConsumer
    );
    restClient
  ...
  public void adminIsAbleToDeleteFavoriteFile() throws Exception {
    ...
    restClient
      ...
      .entriesListDoesNotContain(
        "targetGuid",
        fileModel.getNodeRefWithoutVersion()
      );
  }
  ...
  public void deleteFavoriteSiteWithSuccessUsingMeAsPersonId()
    throws Exception {
    siteModel.setGuid(
      restClient
        .authenticateUser(adminUserModel)
  ...
  public void consumerIsNotAbleToDeleteFavoritesOfAnotherUser()
    throws Exception {
    restClient
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator)
  ...
  public void collaboratorIsNotAbleToDeleteFavoriteOfAnotherUser()
    throws Exception {
    restClient
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteConsumer)
  ...
  public void contributorIsNotAbleToDeleteFavoriteOfAnotherUser()
    throws Exception {
    restClient
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator)
  ...
  public void deleteFavoriteFileIfFavoriteIdIsIncorrect() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "wrongFavoriteId")
      );
  }
  ...
  public void userIsNotAbleToDeleteFavoriteSiteWithInvalidNetworkID()
    throws Exception {
