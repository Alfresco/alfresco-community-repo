...
public interface NodeRefResolver {
    ...
    /**
     * Path type reference create if absent. Fail substitute for {@link
     * Repository#findNodeRef(String, String[])}.
     *
     * @param reference path element names array
     * @return reference array of reference segments
     * @throws AlfrescoRuntimeException if an unimplemented or invalid reference type is provided
     * @see Repository#findNodeRef(String, String[])
     */
    NodeRef createNamePath(String[] reference);

    /**
     * QName type reference create if absent.Fail safe substitute for {@link
     * Repository#findNodeRef(String, String[])}.
     *
     * @param reference path element qnames array
     * @param names names to be used when creating the given path. If less than reference elements
     *     they will be matched from the end of the reference path.
     * @return reference array of reference segments
     * @throws AlfrescoRuntimeException if an unimplemented or invalid reference type is provided
     * @see Repository#findNodeRef(String, String[])
     */
