...
public class Params implements Parameters {
  ...
  //Constants
  private static final RecognizedParams NULL_PARAMS = new RecognizedParams(
    null,
    null,
    null,
    null,
  ...
  private static final BasicContentInfo DEFAULT_CONTENT_INFO = new ContentInfoImpl(
  ...
  public static Params valueOf(
    BeanPropertiesFilter paramFilter,
    String entityId,
    WebScriptRequest request
  ) {
    return new Params(
  ...
  public String getParameter(String parameterName) {
    if (
      recognizedParams.requestParameters != null &&
  ...
  @Override
  public T getParameter(String parameterName, Class<T> clazz)
  ...
  public boolean hasBinaryProperty(String propertyName) {
    return (
      addressedProperty != null && addressedProperty.equals(propertyName)
    );
  }
  ...
  public static class RecognizedParams {
    ...
    public RecognizedParams(
      ...
      this.include =
        (List<String>) (include == null ? Collections.emptyList() : include);
      this.select =
        (List<String>) (select == null ? Collections.emptyList() : select);

      this.sorting =
        (List<SortColumn>) (
          sorting == null ? Collections.emptyList() : sorting
        );
