...
@RelationshipResource(
        ...
        title = "The items attached to a process instance")
public class ProcessItemsRelation
    ...
    @Override
    public Item readById(String processId, String id, Parameters parameters)
    ...
    @Override
    @WebApiDescription(
            title = "Get the attached items of a Process Instance",
            description = "Get a paged list of all the possible items")
