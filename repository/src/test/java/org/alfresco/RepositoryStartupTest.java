...
/**
 * A unit test that provides a first-pass check on whether the Alfresco repository is starting. This
 * test can be run in hard-failure mode to elicit quick failures if there are build-box or other
 * fundamental problems with the repository.
 *
 * @author Derek Hulley
 */
