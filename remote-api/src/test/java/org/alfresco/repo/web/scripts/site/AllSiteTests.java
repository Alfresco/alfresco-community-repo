...
/**
 * This class is a holder for the various test classes associated with the {@link SiteService}. It is not (at the time of writing) intended to be incorporated into the automatic build which will find the various test classes and run them individually.
 * 
