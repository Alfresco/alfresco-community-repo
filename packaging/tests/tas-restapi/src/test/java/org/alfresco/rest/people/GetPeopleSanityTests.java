...
public class GetPeopleSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user gets a person with Rest API and response is successful")
    public void managerUserChecksIfPersonIsPresent() throws Exception {
        ...
        personModel
                .assertThat()
                .field("id")
                .is(searchedUser.getUsername())
                .and()
                .field("firstName")
                .is("FN-" + searchedUser.getUsername())
                .and()
                .field("email")
                .is(searchedUser.getUsername() + domain)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify collaborator user gets a person with Rest API and response is"
                            + " successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify contributor user gets a person with Rest API and response is"
                            + " successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify consumer user gets a person with Rest API and response is successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify admin user gets a person with Rest API and response is successful")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify manager user gets a non existing person with Rest API and person is not"
                            + " found")
