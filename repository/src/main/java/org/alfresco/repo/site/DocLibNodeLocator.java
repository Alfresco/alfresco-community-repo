...
/**
 * This {@link NodeLocator} identifies the site in which the source node resides and returns the
 * Document Library container for that site. If no site can be found or the site does not have a
 * Document Library then the Company Home is returned.
 *
 * @author Nick Smith
 * @since 4.0
 */
public class DocLibNodeLocator extends AbstractNodeLocator {
    ...
    /**
     * Finds the site in which the source {@link NodeRef} resides and returns the Document Library
     * container for that site. If no site can be found or the site does not have a Document Library
     * then the Company Home is returned.
     *
