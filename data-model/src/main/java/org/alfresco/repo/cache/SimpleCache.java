 ...
 *
 * <p>All implementations <b>must</b> be thread-safe. Additionally, the use of the
 ...
 *
 * <p>All implementations must support <tt>null</tt> values. It therefore follows that
 *
 * <pre>
...
public interface SimpleCache<K extends Serializable, V extends Object> {
     ...
     *
     * <p>Be sure to use {@link #remove(Serializable) remove} if cache entries need to be removed as
     * the cache implementations must treat a <tt>null</tt> value as a first class object in exactly
     * the same way as a {@link Map} will allow storage and retrieval of <tt>null</tt> values.
     *
