...
public class M2Model {
  ...
  private static final String ERR_PARSE_FAILURE =
    "d_dictionary.model.err.parse.failure";
  private static final String ERR_CREATE_M2MODEL_FAILURE =
    "d_dictionary.model.err.create_m2model.failure";
  ...
  public void toXML(
    ModelDefinition.XMLBindingType bindingType,
    OutputStream xml
  ) {
    try {
      if (bindingType == null) {
      ...
      IBindingFactory factory = (bindingName != null)
        ? BindingDirectory.getFactory(bindingName, M2Model.class)
