...
public abstract class AbstractChainedSubsystemTest extends TestCase {
  ...
  public ChildApplicationContextFactory getChildApplicationContextFactory(
    ...
    try {
      DefaultChildApplicationContextManager.ApplicationContextManagerState state = (DefaultChildApplicationContextManager.ApplicationContextManagerState) childApplicationContextManager.getState(
        true
      );
