...
public class InviteByTicket extends DeclarativeWebScript {
  ...
  protected Map<String, Object> executeImpl(
    ...
    // run as system user
    String mtAwareSystemUser = tenantService.getDomainUser(
      AuthenticationUtil.getSystemUserName(),
      tenantDomain
    );

    Map<String, Object> ret = TenantUtil.runAsSystemTenant(
  ...
  private InviteInfo toInviteInfo(NominatedInvitation invitation) {
    ...
    NodeRef inviterRef = personService.getPerson(
    ...
    NodeRef inviteeRef = personService.getPerson(
  ...
  private String getInvitationStatus(NominatedInvitation invitation) {
    ...
    boolean isUserMember = serviceRegistry
      .getSiteService()
      .isMember(site, invitee);
    ...
    List<WorkflowTask> pendingInvitationTasks = serviceRegistry
      .getWorkflowService()
