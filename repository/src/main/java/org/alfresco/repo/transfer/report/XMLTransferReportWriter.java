...
public class XMLTransferReportWriter {
  ...
  public void startTransferReport(String encoding, Writer writer)
    ...
    this.writer.startPrefixMapping(
        PREFIX,
        TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI
      );
  ...
  public void writeTarget(TransferTarget target) throws SAXException {
    ...
    attributes.addAttribute(
      ...
      "endpointPort",
      "int",
      String.valueOf(target.getEndpointPort())
    );

    writer.startElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
      TransferReportModel.LOCALNAME_TRANSFER_TARGET,
      PREFIX + ":" + TransferReportModel.LOCALNAME_TRANSFER_TARGET,
      attributes
    );
    writer.endElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
  ...
  public void writeDefinition(TransferDefinition definition)
    ...
    attributes.addAttribute(
      ...
      "isReadOnly",
      "boolean",
      definition.isReadOnly() ? "true" : "false"
    );
    attributes.addAttribute(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
      "isSync",
    ...
    if (definition.getNodes() != null) {
      attributes.addAttribute(
        ...
        "numberOfNodes",
        "string",
        String.valueOf(definition.getNodes().size())
      );
    }
  ...
  public void writeException(Exception e) throws SAXException {
    ...
    writer.startElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
      TransferReportModel.LOCALNAME_EXCEPTION,
      PREFIX + ":" + TransferReportModel.LOCALNAME_EXCEPTION,
      attributes
    );
    writer.endElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
   ...
   */
  public void writeTransferEvents(List<TransferEvent> events)
    throws SAXException {
    writer.startElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
      TransferReportModel.LOCALNAME_TRANSFER_EVENTS,
      PREFIX + ":" + TransferReportModel.LOCALNAME_TRANSFER_EVENTS,
      EMPTY_ATTRIBUTES
    );
  ...
  private void writePrimaryParent(
    ...
    writer.startElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
      TransferReportModel.LOCALNAME_TRANSFER_PRIMARY_PARENT,
      PREFIX + ":" + TransferReportModel.LOCALNAME_TRANSFER_PRIMARY_PARENT,
      EMPTY_ATTRIBUTES
    );
    ...
    writer.startElement(
      TransferReportModel2.TRANSFER_REPORT_MODEL_2_0_URI,
      TransferReportModel.LOCALNAME_TRANSFER_PRIMARY_PATH,
      PREFIX + ":" + TransferReportModel.LOCALNAME_TRANSFER_PRIMARY_PATH,
      EMPTY_ATTRIBUTES
    );
    if (parentPath != null) {
  ...
  public void writeTransferEvent(TransferEvent event) throws SAXException {
    XMLTransferEventFormatter formatter = XMLTransferEventFormatterFactory.getFormatter(
      event
    );
