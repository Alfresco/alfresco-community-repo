...
public class FilePlanChildrenRelation
  implements
    RelationshipResourceAction.Read<RecordCategory>,
  ...
  @Override
  @WebApiDescription(
    title = "Return a paged list of file plan children (record categories) for the container identified by 'filePlanId'"
  )
  public CollectionWithPagingInfo<RecordCategory> readAll(
    ...
    if (parameters.includeSource()) {
      ...
      sourceEntity =
        nodesModelFactory.createFilePlan(info, parameters, mapUserInfo, true);
    }
  ...
  @Override
  @WebApiDescription(
    title = "Create one (or more) record categories as children of container identified by 'filePlanId'"
  )
  ...
  public RecordCategory create(
    ...
    throw new IntegrityException(
      "Uploading records into file plan root is not allowed.",
      null
    );
  }
}
