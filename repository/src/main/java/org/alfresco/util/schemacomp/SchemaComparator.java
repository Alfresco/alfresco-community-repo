...
/**
 * Compares two abstract database schemas, a reference schema and a target schema (the schema to
 * check for validity). The reference schema is the primary schema and all objects in the right
 * schema are judged relative to it.
 *
 * @author Matt Ward
 */
public class SchemaComparator {
    ...
    /**
     * Construct a comparator to compare a target schema against a reference schema. Validators
     * supplied by the reference schema will be used to validate the target schema.
     *
    ...
    /**
     * Validate the target schema against the reference schema using the reference schema's
     * validators.
     */
