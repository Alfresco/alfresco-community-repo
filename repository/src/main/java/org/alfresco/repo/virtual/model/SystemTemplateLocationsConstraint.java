...
public class SystemTemplateLocationsConstraint extends ListOfValuesConstraint {
  ...
  public void setTemplatesParentRepositoryPath(
    NodeRefExpression templatesParentRepositoryPath
  ) {
  ...
  public List<String> getRawAllowedValues() {
    ...
    List<String> repositoryTemplates = loadRepositoryTemplates(
  ...
  private List<String> loadClasspathTemplates(
    String templatesParentClasspath,
    String... extensions
  ) throws IOException {
    ...
    Resource[] resources = resolver.getResources(
      "classpath*:" + templatesParentClasspath + "/*"
    );
  ...
  private List<String> loadRepositoryTemplates(
    NodeRefExpression templatesParentRepositoryPath
  ) {
    ...
    if (findNodeRef != null) {
      final QName repositoryTemplateTypeQName = QName.createQName(
        repositoryTemplateTypeName,
