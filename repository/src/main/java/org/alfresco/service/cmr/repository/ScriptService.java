...
public interface ScriptService
{
     ...
     *            Script location as qualified classpath name
     * @param model
     ...
     * 
     * @param scriptRef
     *            Script NodeRef location
     * @param contentProp
     *            QName of the property on the node that contains the content, null can be passed to indicate the default property of 'cm:content'
     * @param model
     *            Object model to process script against
     * 
     * @return output of the script (may be null or any valid wrapped JavaScript object)
     ...
     *            object representing the script location
     * @param model
     *            Object model to process script against
     * 
     ...
     *            Object model to process script against
     * @param secure
     *            A flag indicating if string script is considered secure (e.g., if it comes from the classpath) If true it will have access to the full execution context, if false the script will be executed in a sandbox context (more restricted)
     * @return output of the script (may be null or any valid wrapped JavaScript object)
     *
     * @throws ScriptException
     */
     ...
     *            Object model to process script against
     * @param secure
     *            A flag indicating if string script is considered secure
     *
     * @return output of the script (may be null or any valid wrapped JavaScript object)
     *
     * @throws ScriptException
     ...
     * 
     * @param inputMap
     *            initial Map of global scope scriptable Node objects
     */
     ...
     * @param document
     *            Optional ref to a document Node
     * @param space
