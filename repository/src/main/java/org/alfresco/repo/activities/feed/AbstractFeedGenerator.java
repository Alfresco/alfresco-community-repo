...
/**
 * Implementations of the abstract feed generator component are responsible for generating activity
 * feed entries
 */
public abstract class AbstractFeedGenerator implements FeedGenerator {
    ...
    /**
     * The name of the lock used to ensure that feed generator does not run on more than one node at
     * the same time
     */
    private static final QName LOCK_QNAME =
            QName.createQName(NamespaceService.SYSTEM_MODEL_1_0_URI, "FeedGenerator");
    ...
    private static VmShutdownListener vmShutdownListener =
            new VmShutdownListener(AbstractFeedGenerator.class.getName());
    ...
    public void execute() throws JobExecutionException {
        ...
        // MNT-12145 : BM-0013 Soak test: Exception during generation of feeds
                    ...
                    public Void execute() throws Throwable {
                        ...
                        try {
                            ...
                            if (logger.isDebugEnabled()) {
                                logger.debug(
                                        "Activities feed generator already underway: "
                                                + LOCK_QNAME);
                            }
                        } catch (Throwable e) {
