...
public class QuickShareLinksImpl
   ...
   */
  public QuickShareLink readById(
    ...
    try {
      Pair<String, NodeRef> pair = quickShareService.getTenantNodeRefFromSharedId(
        sharedId
      );
  ...
  public void delete(String sharedId, Parameters parameters) {
    ...
    try {
      ...
      String sharedByUserId = (String) nodeService.getProperty(
        nodeRef,
        QuickShareModel.PROP_QSHARE_SHAREDBY
      );
  ...
  public List<QuickShareLink> create(
    ...
    List<String> includeParam = parameters != null
    ...
    for (QuickShareLink qs : nodeIds) {
      ...
      if (nodeId == null) {
        throw new InvalidArgumentException(
          "A valid nodeId must be specified !"
        );
      }
      ...
      try {
        ...
        try {
          QuickShareDTO qsDto = quickShareService.shareContent(
            nodeRef,
            qs.getExpiresAt()
          );
  ...
  public void emailSharedLink(
    ...
    try {
      NodeRef nodeRef = quickShareService
        .getTenantNodeRefFromSharedId(sharedId)
        .getSecond();
      String sharedNodeName = (String) nodeService.getProperty(
        nodeRef,
  ...
  private Parameters getParamsWithCreatedStatus() {
    ...
    Params.RecognizedParams recParams = new Params.RecognizedParams(
      null,
      null,
      null,
      null,
  ...
  private static final Set<String> FIND_SHARED_LINKS_QUERY_PROPERTIES = new HashSet<>(
    Arrays.asList(new String[] { PARAM_SHAREDBY })
  );

  public CollectionWithPagingInfo<QuickShareLink> findLinks(
    Parameters parameters
  ) {
    checkEnabled();
    ...
    if (q != null) {
      ...
      MapBasedQueryWalker propertyWalker = new MapBasedQueryWalker(
        FIND_SHARED_LINKS_QUERY_PROPERTIES,
        null
      );
      QueryHelper.walk(q, propertyWalker);

      String sharedByUserId = propertyWalker.getProperty(
        PARAM_SHAREDBY,
      ...
      if (sharedByUserId != null) {
        ...
        QueryParameterDefinition qpd = new QueryParameterDefImpl(
          QuickShareModel.PROP_QSHARE_SHAREDBY,
        ...
        String qsharedBy = QuickShareModel.PROP_QSHARE_SHAREDBY.toPrefixString(
          namespaceService
        );
        queryString +=
          " +@" +
  ...
  private QuickShareLink getQuickShareInfo(
    ...
    Map<String, Object> map = (Map<String, Object>) quickShareService
      .getMetaData(sharedId)
      .get("item");
  ...
  private QuickShareLink getQuickShareInfo(
    ...
    try {
      ...
      String mimeTypeName = mimeTypeService
      ...
      UserInfo modifiedByUser = Node.lookupUserInfo(
      ...
      String sharedByUserId = (String) nodeProps.get(
        QuickShareModel.PROP_QSHARE_SHAREDBY
      );
      UserInfo sharedByUser = Node.lookupUserInfo(
        sharedByUserId,
        mapUserInfo,
        personService,
        displayNameOnly
      ...
      if (!noAuth) {
        ...
        if (includeParam.contains(PARAM_INCLUDE_ALLOWABLEOPERATIONS)) {
          if (quickShareService.canDeleteSharedLink(nodeRef, sharedByUserId)) {
            ...
            qs.setAllowableOperations(
              Collections.singletonList(Nodes.OP_DELETE)
            );
          }
        ...
        if (includeParam.contains(PARAM_INCLUDE_PROPERTIES)) {
          ...
          Map<String, Object> filteredNodeProperties = filterProps(
            doc.getProperties(),
            EXCLUDED_PROPS
          );
  ...
  private Map<String, Object> filterProps(
    Map<String, Object> properties,
    List<QName> toRemove
  ) {
    Map<String, Object> filteredProps = properties == null
      ? new HashMap<>()
      : new HashMap<>(properties);
    List<String> propsToRemove = toRemove
      .stream()
  ...
  private void validateEmailRequest(QuickShareLinkEmailRequest emailRequest) {
    ...
    if (
      emailRequest.getRecipientEmails() == null ||
      emailRequest.getRecipientEmails().isEmpty()
    ) {
      throw new InvalidArgumentException(
        "A valid recipientEmail must be specified."
      );
    }
  }
}
