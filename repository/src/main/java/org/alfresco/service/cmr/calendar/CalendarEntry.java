...
public interface CalendarEntry extends Serializable, PermissionCheckValue {
    ...
    /**
     * Gets the event recurrence rule. This needs to be in the SharePoint/Outlook format of
    ...
    /**
     * Gets the date of the last instance of this recurring event, i.e. the last date up until which
     * recurrances will occur.
     */
