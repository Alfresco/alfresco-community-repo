...
public class FilePlanComponentsUtil {
    ...
    /**
     * Creates a non-electronic unfiled container child model with a random name (with "Record "
     * prefix)
     *
    ...
    public static UnfiledContainerChild createElectronicUnfiledContainerChildModel() {
        return createUnfiledContainerChildRecordModel(
                "Record " + getRandomAlphanumeric(), CONTENT_TYPE);
    }

    /**
     * Creates an electronic unfiled container child model with a random name (with "Record "
     * prefix)
     *
     * @return The electronic record as {@link UnfiledContainerChild}
     */
    public static UnfiledContainerChild createNonElectronicUnfiledContainerChildModel() {
        return createUnfiledContainerChildRecordModel(
                "Record " + getRandomAlphanumeric(), NON_ELECTRONIC_RECORD_TYPE);
    }
    ...
    /**
     * Creates a nonElectronic container child record model with all available properties for the
    ...
    /**
     * Creates a non-electronic record model with with all available properties for the non
     * electronic records
     *
     * @return The non-electronic record as {@link Record}
     */
    ...
    public static Record createRecordModel(String name, String description, String title) {
        return Record.builder()
                .name(name)
                .properties(
                        RecordProperties.builder().description(description).title(title).build())
                .build();
    }
    ...
    public static RecordCategoryChild createRecordCategoryChildModel(String name, String nodeType) {
        return RecordCategoryChild.builder()
                ...
                .nodeType(nodeType)
                .properties(
                        RecordCategoryChildProperties.builder().title(TITLE_PREFIX + name).build())
                .build();
    }
        ...
        try {
            ...
            try (OutputStreamWriter writer =
                    new OutputStreamWriter(
                            new FileOutputStream(file), forName("UTF-8").newEncoder())) {
