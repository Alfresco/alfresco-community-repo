...
public class RemoveSiteGroupTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager can delete site group and gets status code 204, 'No Content'")
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator cannot delete site group and gets status code 403,"
                            + " 'Forbidden'")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor cannot delete site group and gets status code 403,"
                            + " 'Forbidden'")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer cannot delete site member and gets status code 403,"
                            + " 'Forbidden'")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager can NOT delete site group for an inexistent user and gets"
    ...
    public void managerIsNotAbleToDeleteInexistentSiteGroup() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format("An authority was not found for %s", getId(inexistentUser)));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager can NOT delete site group for a non site group and gets status"
    ...
    public void managerIsNotAbleToDeleteNotSiteGroup() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format("Given authority is not a member of the site"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can NOT delete site group for an invalid site and gets"
                            + " status code 404, 'Not Found'")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    public void managerIsNotAbleToDeleteSiteMemberOfInvalidSite() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_WAS_NOT_FOUND, "invalidSite"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete a site group of private site and gets status code"
                            + " 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can not delete a site group twice and gets status code 404"
