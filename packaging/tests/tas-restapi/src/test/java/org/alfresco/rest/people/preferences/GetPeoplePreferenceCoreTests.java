...
public class GetPeoplePreferenceCoreTests extends RestTest {
  ...
  public void userDoesNotHaveAccessToFavoriteSitesOfAnotherUser()
    throws Exception {
  ...
  public void statusNotFoundIsReturnedForAPersonIDThatDoesNotExist()
    throws Exception {
    restClient
  ...
  public void statusNotFoundIsReturnedForAPreferenceNameThatDoesNotExist()
    throws Exception {
    restClient
      .authenticateUser(userModel)
      .withCoreAPI()
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          ...
          " entity with id: %s and a relationship id of invalidPreferenceName",
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.PREFERENCES },
    executionType = ExecutionType.REGRESSION,
    description = "Verify manager fails to get a specific preference for  removed preference with Rest API and response is 404"
  )
  public void statusNotFoundIsReturnedForAPreferenceNameThatHasBeenRemoved()
    throws Exception {
