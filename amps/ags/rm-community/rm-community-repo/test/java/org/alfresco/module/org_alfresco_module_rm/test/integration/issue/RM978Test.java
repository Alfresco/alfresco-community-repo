...
public class RM978Test extends BaseRMTestCase {
    ...
    protected void setupCollaborationSiteTestDataImpl() {
        ...
        filePlanRoleService.assignRoleToAuthority(
                filePlan, FilePlanRoleService.ROLE_POWER_USER, user);
    }

    public void testMoveDocumentToFolderInCollabSite() {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(user) {
                    ...
                    public void given() {
                        ...
                        document1 =
                                fileFolderService
                                        .create(folder1, document1Name, ContentModel.TYPE_CONTENT)
                                        .getNodeRef();
                        folder2 =
                                fileFolderService
                                        .create(
                    ...
                    public void then() {
                        List<ChildAssociationRef> folder1ChildAssocs =
                                nodeService.getChildAssocs(folder1);
                        assertEquals(0, folder1ChildAssocs.size());

                        List<ChildAssociationRef> folder2ChildAssocs =
                                nodeService.getChildAssocs(folder2);
                        ...
                        String movedDocumentName =
                                (String)
                                        nodeService.getProperty(
                                                movedDocument, ContentModel.PROP_NAME);
                ...
                new BehaviourDrivenTest(user) {
                    ...
                    public void then() {
                        ...
                        List<ChildAssociationRef> childAssocs =
                                nodeService.getChildAssocs(documentLibrary);
                ...
                new BehaviourDrivenTest(user) {
                    ...
                    public void then() {
                        ...
                        String movedDocumentName =
                                (String)
                                        nodeService.getProperty(
                                                movedFolder, ContentModel.PROP_NAME);
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(user) {
                    ...
                    public void then() {
                        ...
                        List<ChildAssociationRef> childAssocs =
                                nodeService.getChildAssocs(documentLibrary2);
                        assertNotNull(childAssocs);
    ...
    public void testMoveDocumentInFilePlanInRmSite() {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(AlfrescoRuntimeException.class, user) {
                    private NodeRef folder1;
                    private NodeRef document1;
                    ...
                    public void given() {
                        ...
                        document1 =
                                fileFolderService
                                        .create(folder1, GUID.generate(), ContentModel.TYPE_CONTENT)
                                        .getNodeRef();
                    }
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(user) {
                                ...
                                new RunAsWork<Void>() {
                                    public Void doWork() throws Exception {
                                        filePlanPermissionService.setPermission(
                                                rmFolder, user, RMPermissionModel.FILING);
                    ...
                    public void then() {
                        ...
                        List<ChildAssociationRef> rmFolderChildAssocs =
                                nodeService.getChildAssocs(rmFolder);
                        ...
                        String movedDocumentName =
                                (String)
                                        nodeService.getProperty(
                                                movedDocument, ContentModel.PROP_NAME);
                        assertEquals(
                                document1Name + " (" + recordIdentifier + ")", movedDocumentName);
                    }
                });
    }
