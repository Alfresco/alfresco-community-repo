...
public class ActivitiWorkflowManagerFactory implements FactoryBean<ActivitiWorkflowManager> {
    ...
    public ActivitiWorkflowManager getObject() throws Exception {
        ...
        DefaultWorkflowPropertyHandler defaultPropertyHandler =
                new DefaultWorkflowPropertyHandler();
        ...
        WorkflowPropertyHandlerRegistry handlerRegistry =
                new WorkflowPropertyHandlerRegistry(defaultPropertyHandler, qNameConverter);
        ...
        ActivitiUtil activitiUtil =
                new ActivitiUtil(
                        processEngine, deployWorkflowsInTenant, retentionHistoricProcessInstance);
        ...
        ActivitiTypeConverter typeConverter =
                new ActivitiTypeConverter(
                        processEngine, factory, propertyConverter, deployWorkflowsInTenant);
        ...
        return new ActivitiWorkflowManager(
                workflowEngine,
                propertyConverter,
                handlerRegistry,
                nodeConverter,
    ...
    /** @param retentionHistoricProcessInstance whether or not to retain the process instance */
