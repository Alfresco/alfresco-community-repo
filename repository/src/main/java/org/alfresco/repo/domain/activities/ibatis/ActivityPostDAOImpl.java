...
public class ActivityPostDAOImpl extends ActivitiesDAOImpl implements ActivityPostDAO {
    ...
    public List<ActivityPostEntity> selectPosts(ActivityPostEntity activityPost, int maxItems)
        ...
        if ((activityPost.getJobTaskNode() != -1)
            ...
            return template.selectList(
                    "alfresco.activities.select_activity_posts_by_params", activityPost, rowBounds);
        } else if (activityPost.getStatus() != null) {
            return template.selectList(
                    "alfresco.activities.select_activity_posts_by_status", activityPost, rowBounds);
        } else {
    ...
    public int updatePost(
            long id, String siteNetwork, String activityData, ActivityPostEntity.STATUS status)
            throws SQLException {
