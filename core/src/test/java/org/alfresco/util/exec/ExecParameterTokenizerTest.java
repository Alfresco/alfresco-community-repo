...
public class ExecParameterTokenizerTest {
    ...
    public void tokenizeSimpleParameterString() {
        ...
        List<String> expectedTokens =
                Arrays.asList(new String[] {"-font", "Helvetica", "-pointsize", "50"});
    ...
    public void tokenizeParameterStringWithQuotedParam_MixedQuotes() {
        ...
        List<String> expectedTokens =
                Arrays.asList(new String[] {"Hello world", "middle", "Goodbye world"});
    ...
    public void tokenizeParameterStringWithQuotedParamContainingQuotes() {
        final String str1 =
                "-font Helvetica -pointsize 50 -draw \"gravity south fill black text 0,12"
                        + " 'CopyRight'\"";
        final String str2 =
                "-font Helvetica -pointsize 50 -draw 'gravity south fill black text 0,12"
                        + " \"CopyRight\"'";

        List<String> expectedTokens1 =
                Arrays.asList(
                        new String[] {
                            "-font",
                            "Helvetica",
