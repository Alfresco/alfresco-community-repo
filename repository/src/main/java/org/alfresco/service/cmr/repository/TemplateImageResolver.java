...
/**
 * Interface contract for the conversion of file name to a fully qualified icon image path for use
 * by templating and scripting engines executing within the repository context.
 *
 * <p>Generally this contract will be implemented by classes that have access to say the webserver
