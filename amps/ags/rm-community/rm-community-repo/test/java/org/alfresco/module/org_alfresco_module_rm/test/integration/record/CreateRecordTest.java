...
public class CreateRecordTest extends BaseRMTestCase {
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void when() {
                        ...
                        filePlanPermissionService.setPermission(
                                recordFolder, user, RMPermissionModel.FILING);
                                    ...
                                    public Void doWork() throws Exception {
                                        ...
                                        ContentWriter writer =
                                                contentService.getWriter(
                                                        record, ContentModel.TYPE_CONTENT, true);
    ...
    /**
     * unit test for RM1649 fix test if a user with create record permissions and without file
     * record permission is able to create a record within unfiled record container
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        filePlanPermissionService.setPermission(
                                unfiledContainer, user, RMPermissionModel.FILING);
                    }
    ...
    /**
     * Given I have ViewRecord and CreateRecord capabilities And I have filling on a record folder
     * When I create content via ScriptNode (simulated) Then the record is successfully created
     *
