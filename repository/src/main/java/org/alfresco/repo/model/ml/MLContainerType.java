...
/**
 * Class containing behaviour for the multilingual multilingual container type. A multilingual
 * container type is fonctionally named '<b>Logical Document</b>'. It links each translation of a
 * semantical message together
 *
 * <p>{@link ContentModel#TYPE_MULTILINGUAL_CONTAINER multilingual container type}
 *
...
public class MLContainerType implements NodeServicePolicies.OnUpdatePropertiesPolicy {
     ...
     *
     * <p>Ensures that the {@link ContentModel#ASPECT_MULTILINGUAL_EMPTY_TRANSLATION ml empty
     * document aspect}
     */
    public void init() {
    ...
    /**
     * The property <b>locale</b> of a <b>cm:mlContainer</b> represents the locale of the pivot
     * translation.
     *
     * <p>Since the pivot must be an existing translation and the pivot can t be empty, some tests
     * must be performed when the locale of the mlContainer is updated.
     */
        ...
        if (localeBefore != null && !localeAfter.equals(localeBefore)) {
            ...
            if (pivot == null) {
                throw new IllegalArgumentException(
                        "The pivot translation must be an existing translation");
            } else if (nodeService.hasAspect(
                    pivot, ContentModel.ASPECT_MULTILINGUAL_EMPTY_TRANSLATION)) {
                throw new IllegalArgumentException(
                        "The pivot translation can't be an empty translation");
            }
        }
    }
}
