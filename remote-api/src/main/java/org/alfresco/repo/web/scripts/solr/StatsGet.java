...
public class StatsGet extends DeclarativeWebScript
{
     ...
     * 
     * @param start
     *            If start is null then defaults to 1 month
     * @param end
     ...
     * @param facetType
     *            e.g. {http://www.alfresco.org/model/content/1.0}content.mimetype
     */
