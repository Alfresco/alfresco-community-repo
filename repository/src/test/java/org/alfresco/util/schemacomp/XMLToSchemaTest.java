...
public class XMLToSchemaTest {
  ...
  public void setUp() throws Exception {
    Resource testFileResource = new ClassPathResource(
      "schemacomp/xml_to_schema_test.xml"
    );
  ...
  public void canReadSchemaXML() {
    ...
    assertSame(
      "Wrong or no parent set",
      table,
      table.getColumns().get(0).getParent()
    );
    ...
    assertSame(
      "Wrong or no parent set",
      table,
      table.getColumns().get(1).getParent()
    );
    ...
    assertSame(
      "Wrong or no parent set",
      table,
      table.getColumns().get(2).getParent()
    );
    ...
    assertSame(
      "Wrong or no parent set",
      table,
      table.getForeignKeys().get(0).getParent()
    );
