                ...
                new VoidTest() {
                    public void runImpl() throws Exception {
                        ...
                        siteService.createSite(
                                "anything", siteId, "title", "descrition", SiteVisibility.PUBLIC);
                ...
                new FailureTest() {
                    ...
                    public void run() {
                        filePlanService.createRecordCategory(
                                filePlan, GUID.generate(), TYPE_FOLDER);
                    }
                });
    }
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        NodeRef series =
                                filePlanService.createRecordCategory(rmContainer, "rmSeries");
                        NodeRef seriesChildFolder =
                                recordFolderService.createRecordFolder(
                                        series, "seriesRecordFolder");
                        NodeRef seriesChildContainer =
                                filePlanService.createRecordCategory(series, "childContainer");
    ...
    public void testGetContainedRecordCategories() throws Exception {
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public void test(Void result) throws Exception {
                        List<NodeRef> nodes =
                                filePlanService.getContainedRecordCategories(rmContainer);
                        assertNotNull(nodes);
    ...
    public void testGetContainedRecordFolders() throws Exception {
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public void test(Void result) throws Exception {
                        List<NodeRef> nodes =
                                filePlanService.getContainedRecordFolders(rmContainer);
                        assertNotNull(nodes);
                        assertEquals(1, nodes.size());
                        assertTrue(nodes.contains(rmFolder));
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        NodeRef levelThreeRecordFolder =
                                setNodeRef(
                                        "recordFolder3",
                                        recordFolderService.createRecordFolder(
                                                levelThree, "recordFolder3"));
                    ...
                    public void test(Void result) {
                        ...
                        basicRMContainerCheck(
                                getNodeRef("container1"), "container1", TYPE_RECORD_CATEGORY);
                        basicRMContainerCheck(
                                getNodeRef("container2"), "container2", TYPE_RECORD_CATEGORY);
                        basicRMContainerCheck(
                                getNodeRef("container3"), "container3", TYPE_RECORD_CATEGORY);
                        basicRMContainerCheck(
                                getNodeRef("recordFolder3"), "recordFolder3", TYPE_RECORD_FOLDER);

                        // TODO need to check that the parents and children can be retrieved
                        // correctly
                    }
                });
    }
