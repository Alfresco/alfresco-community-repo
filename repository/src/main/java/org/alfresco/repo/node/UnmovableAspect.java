 ...
 *
 * <p>Deletions of nodes with the {@link ContentModel#ASPECT_UNMOVABLE} are not allowed by default.
 * This class registers the behaviour that prevents the move.
 *
 * <p>This aspect/behaviour combination allows for detailed application control of when node
 * deletion is allowed or disallowed for particular nodes. It is not related to the normal
 * permissions controls, which of course apply.
 *
 * <p>
 *
...
public class UnmovableAspect implements NodeServicePolicies.BeforeMoveNodePolicy {
    ...
    public void init() {
        this.policyComponent.bindClassBehaviour(
                ...
                new JavaBehaviour(
                        this, "beforeMoveNode", Behaviour.NotificationFrequency.EVERY_EVENT));
    }
    ...
    public void beforeMoveNode(ChildAssociationRef oldChildAssocRef, NodeRef newParentRef) {
        ...
        throw new AlfrescoRuntimeException(
                nodeType.toPrefixString()
                        + " move is not allowed. Attempted to move "
                        + oldChildAssocRef.getChildRef());
    }
}
