...
/**
 * Class to contain details regarding a lock. A lock is specific to a given qualified name. For any
 * given lock, there may exist an <b>EXCLUSIVE</b> lock <u>or</u> several <b>SHARED</b> locks.
 *
 * @author Derek Hulley
 * @since 3.2
 */
public class LockDetails {
    ...
    public enum LockType {
        /**
         * A lock held by a specific transaction. No other (exclusive or shared) locks may be held
         * for the same qualified name.
         */
        EXCLUSIVE,
        /**
         * A lock that may be held by several transactions when no exclusive lock is held for the
         * same qualified name.
         */
        SHARED;
    }
