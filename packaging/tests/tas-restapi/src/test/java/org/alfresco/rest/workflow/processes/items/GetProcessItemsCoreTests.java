...
public class GetProcessItemsCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify that admin calling getProcessItems can see anything with REST API and"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify getProcessItems for invalid processId with REST API and status code is"
                            + " NOT_FOUND (404)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify getProcessItems for empty processId with REST API and status code is"
                            + " NOT_FOUND (404)")
    @Test(
            groups = {
                TestGroup.REST_API,
