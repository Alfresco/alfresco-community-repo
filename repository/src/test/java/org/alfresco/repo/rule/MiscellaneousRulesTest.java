...
/**
 * Integration tests for Alfresco Rules. This class does not test the internals of the {@link RuleService} but rather sets up and runs common or previously problematic rules use cases and ensures they are correct.
 * 
...
public class MiscellaneousRulesTest
{
    ...
    @ClassRule
    public static RuleChain STATIC_RULE_CHAIN = RuleChain.outerRule(APP_CTXT_INIT)
            .around(TEST_USER);
    ...
    /**
     * ALF-14568 doesn't explicitly say so, but there is a related problem on top of the 'creating cm:original assoc triggers rule' bug. It is the related 'deleting cm:original assoc triggers rule' bug. This test case validates the fix for that issue.
     */
    @Test
