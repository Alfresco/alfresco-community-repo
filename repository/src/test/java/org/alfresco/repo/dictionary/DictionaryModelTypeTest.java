...
public class DictionaryModelTypeTest extends BaseSpringTest {
    ...
    private static final QName TEST_MODEL_ONE =
            QName.createQName("{http://www.alfresco.org/test/testmodel1/1.0}testModelOne");

    private static final QName TEST_MODEL_TWO =
            QName.createQName("{http://www.alfresco.org/test/testmodel2/1.0}testModelTwo");
    private static final QName TEST_MODEL_THREE =
            QName.createQName("{http://www.alfresco.org/test/testmodel3/1.0}testModelThree");

    /** Test model XMLs */
    public static final String MODEL_ONE_XML =
            "<model name='test1:testModelOne' xmlns='http://www.alfresco.org/model/dictionary/1.0'>"
                + "   <description>Test model one</description>   <author>Alfresco</author>  "
                + " <published>2005-05-30</published>   <version>1.0</version>   <imports>     "
                + " <import uri='http://www.alfresco.org/model/dictionary/1.0' prefix='d'/>     "
                + " <import uri='http://www.alfresco.org/model/content/1.0' prefix='cm'/>  "
                + " </imports>   <namespaces>      <namespace"
                + " uri='http://www.alfresco.org/test/testmodel1/1.0' prefix='test1'/>  "
                + " </namespaces>   <types>      <type name='test1:base'>       "
                + " <title>Base</title>        <description>The Base Type</description>       "
                + " <parent>cm:content</parent>        <properties>           <property"
                + " name='test1:prop1'>              <type>d:text</type>           </property>     "
    ...
    public static final String MODEL_ONE_MODIFIED_XML =
            "<model name='test1:testModelOne' xmlns='http://www.alfresco.org/model/dictionary/1.0'>"
                ...
                + " <author>Alfresco</author>   <published>2005-05-30</published>  "
                + " <version>1.1</version>   <imports>      <import"
                + " uri='http://www.alfresco.org/model/dictionary/1.0' prefix='d'/>      <import"
                + " uri='http://www.alfresco.org/model/content/1.0' prefix='cm'/>   </imports>  "
                + " <namespaces>      <namespace uri='http://www.alfresco.org/test/testmodel1/1.0'"
                + " prefix='test1'/>   </namespaces>   <types>      <type name='test1:base'>       "
                + " <title>Base</title>        <description>The Base Type</description>       "
                + " <parent>cm:content</parent>        <properties>           <property"
                + " name='test1:prop1'>              <type>d:text</type>           </property>     "
                + "      <property name='test1:prop2'>              <type>d:boolean</type>         "
    ...
    public static final String MODEL_ONE_MODIFIED2_XML =
            "<model name='test1:testModelOne' xmlns='http://www.alfresco.org/model/dictionary/1.0'>"
                ...
                + " <author>Alfresco</author>   <published>2005-05-30</published>  "
                + " <version>1.2</version>   <imports>      <import"
                + " uri='http://www.alfresco.org/model/dictionary/1.0' prefix='d'/>      <import"
                + " uri='http://www.alfresco.org/model/content/1.0' prefix='cm'/>   </imports>  "
                + " <namespaces>      <namespace uri='http://www.alfresco.org/test/testmodel1/1.0'"
                + " prefix='test1'/>   </namespaces>   <types>      <type name='test1:base'>       "
                ...
                + " <parent>cm:content</parent>        <properties>           <property"
                + " name='test1:prop1'>              <type>d:text</type>           </property>     "
                + "      <property name='test1:prop99'>              <type>d:text</type>          "
                + " </property>        </properties>      </type>   </types></model>";

    public static final String MODEL_TWO_XML =
            "<model name='test2:testModelTwo' xmlns='http://www.alfresco.org/model/dictionary/1.0'>"
                + "   <description>Test model two</description>   <author>Alfresco</author>  "
                + " <published>2010-01-13</published>   <version>1.0</version>   <imports>     "
                + " <import uri='http://www.alfresco.org/model/dictionary/1.0' prefix='d'/>     "
                + " <import uri='http://www.alfresco.org/model/content/1.0' prefix='cm'/>  "
                + " </imports>   <namespaces>      <namespace"
                + " uri='http://www.alfresco.org/test/testmodel2/1.0' prefix='test2'/>  "
                + " </namespaces>   <constraints>      <constraint name='test2:con1' type='LIST'>  "
                + "       <parameter name='allowedValues'>            <list>              "
                + " <value>alfresco</value>               <value>file</value>            </list>   "
                + "      </parameter>      </constraint>   </constraints>   <types>      <type"
                + " name='test2:base'>        <title>Base</title>        <description>The Base"
                + " Type</description>        <parent>cm:content</parent>        <properties>      "
                + "     <property name='test2:prop2'>              <type>d:text</type>             "
                + " <constraints>                 <constraint ref='test2:con1'/>             "
                + " </constraints>           </property>        </properties>      </type>  "
                + " </types></model>";

    public static final String MODEL_TWO_INVALID_XML =
            "<model name='test2:testModelTwo' xmlns='http://www.alfresco.org/model/dictionary/1.0'>"
                + "   <description>Test model two</description>   <author>Alfresco</author>  "
                + " <published>2010-01-14</published>   <version>1.1</version>   <imports>     "
                + " <import uri='http://www.alfresco.org/model/dictionary/1.0' prefix='d'/>     "
                + " <import uri='http://www.alfresco.org/model/content/1.0' prefix='cm'/>  "
                + " </imports>   <namespaces>      <namespace"
                + " uri='http://www.alfresco.org/test/testmodel2/1.0' prefix='test2'/>  "
                + " </namespaces>   <types>      <type name='test2:base'>       "
                + " <title>Base</title>        <description>The Base Type</description>       "
                + " <parent>cm:content</parent>        <properties>           <property"
                + " name='test2:prop2'>              <type>d:text</type>              <constraints>"
                + "                 <constraint ref='test2:con1'/>              </constraints>     "
                + "      </property>        </properties>      </type>   </types></model>";

    public static final String MODEL_TWO_MODIFIED_XML =
            "<model name='test2:testModelTwo' xmlns='http://www.alfresco.org/model/dictionary/1.0'>"
                + "   <description>Test model two - modified</description>   <author>Alfresco -"
                + " modified</author>   <published>2010-01-14</published>   <version>1.1</version> "
                + "  <imports>      <import uri='http://www.alfresco.org/model/dictionary/1.0'"
                + " prefix='d'/>      <import uri='http://www.alfresco.org/model/content/1.0'"
                + " prefix='cm'/>   </imports>   <namespaces>      <namespace"
                + " uri='http://www.alfresco.org/test/testmodel2/1.0' prefix='test2'/>  "
                + " </namespaces>   <types>      <type name='test2:base'>       "
                + " <title>Base</title>        <description>The Base Type</description>       "
                + " <parent>cm:content</parent>        <properties>           <property"
                + " name='test2:prop2'>              <type>d:text</type>           </property>     "
                + "   </properties>      </type>   </types></model>";

    public static final String MODEL_THREE_XML =
            "<model name='test3:testModelThree'"
                + " xmlns='http://www.alfresco.org/model/dictionary/1.0'>   <description>Test model"
                + " three</description>   <author>Alfresco</author>  "
                + " <published>2005-05-30</published>   <version>1.0</version>   <imports>     "
                + " <import uri='http://www.alfresco.org/model/dictionary/1.0' prefix='d'/>     "
                + " <import uri='http://www.alfresco.org/model/content/1.0' prefix='cm'/>  "
                + " </imports>   <namespaces>      <namespace"
                + " uri='http://www.alfresco.org/test/testmodel3/1.0' prefix='test3'/>  "
                + " </namespaces>   <types>      <type name='test3:base'>       "
                + " <title>Base</title>        <description>The Base Type</description>       "
                + " <parent>cm:content</parent>        <properties>           <property"
                + " name='test3:prop1'>              <type>d:text</type>              <mandatory"
                + " enforced='false'>true</mandatory>           </property>        </properties>   "
                + "   </type>      <type name='test3:base-override'>        <title>Base</title>    "
                + "    <description>The Base Type</description>        <parent>test3:base</parent> "
                + "       <overrides>           <property name='test3:prop1'>             "
                + " <mandatory enforced='true'>true</mandatory>           </property>       "
                + " </overrides>      </type>   </types></model>";
    ...
    public void before() throws Exception {
        ...
        this.dictionaryService =
                (DictionaryService) this.applicationContext.getBean("dictionaryService");
        this.namespaceService =
                (NamespaceService) this.applicationContext.getBean("namespaceService");
        this.cociService =
        ...
        TenantAdminService tenantAdminService =
                (TenantAdminService) this.applicationContext.getBean("tenantAdminService");
        MessageService messageService =
                (MessageService) this.applicationContext.getBean("messageService");
        ...
        // NOTE: we are not setting the path for now .. in doing so we are searching the root node
        // only
                                ...
                                () -> {
                                    ...
                                    ContentWriter contentWriter =
                                            this.contentService.getWriter(
                                                    model, ContentModel.PROP_CONTENT, true);
                        ...
                        .doInTransaction(
                                new RetryingTransactionCallback<NodeRef>() {
                                    public NodeRef execute() throws Exception {
                                        ...
                                        // Check that the meta data has been extracted from the
                                        // model
                                        assertEquals(
                                                QName.createQName(
                                                        "{http://www.alfresco.org/test/testmodel1/1.0}testModelOne"),
                                                DictionaryModelTypeTest.this.nodeService
                                                        .getProperty(
                                                                modelNode,
                                        ...
                                        assertEquals(
                                                ...
                                                DictionaryModelTypeTest.this.nodeService
                                                        .getProperty(
                                                                modelNode,
                                                                ContentModel.PROP_MODEL_AUTHOR));
                                        ...
                                        assertEquals(
                                                ...
                                                DictionaryModelTypeTest.this.nodeService
                                                        .getProperty(
                                                                modelNode,
                                                                ContentModel.PROP_MODEL_VERSION));

                                        // Check that the model is now available from the dictionary
                                        ModelDefinition modelDefinition2 =
                                                DictionaryModelTypeTest.this.dictionaryService
                                                        .getModel(TEST_MODEL_ONE);
                                        assertNotNull(modelDefinition2);
                                        assertEquals(
                                                "Test model one",
                                                modelDefinition2.getDescription(
                                                        DictionaryModelTypeTest.this
                                                                .dictionaryService));

                                        // Check that the namespace has been added to the namespace
                                        // service
                                        String uri2 =
                                                DictionaryModelTypeTest.this.namespaceService
                                                        .getNamespaceURI("test1");
                                        assertEquals(
                                                uri2,
                                                "http://www.alfresco.org/test/testmodel1/1.0");

                                        // Lets check the node out and update the content
                                        NodeRef workingCopy =
                                                DictionaryModelTypeTest.this.cociService.checkout(
                                                        modelNode);
                                        ContentWriter contentWriter2 =
                                                DictionaryModelTypeTest.this.contentService
                                                        .getWriter(
                                                                workingCopy,
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                // Check that the policy has not been fired since we have updated a
                                // working copy
                                assertEquals(
                                        "1.0",
                                        DictionaryModelTypeTest.this.nodeService.getProperty(
                                                workingCopy, ContentModel.PROP_MODEL_VERSION));
                        ...
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                assertEquals(
                                        "1.1",
                                        DictionaryModelTypeTest.this.nodeService.getProperty(
                                                modelNode, ContentModel.PROP_MODEL_VERSION));
                                return null;
                            }
                        },
                        false,
    ...
    public void testUpdateDictionaryModelPropertyDelete() throws Exception {
        ...
        final NodeRef modelNode =
                this.nodeService
                        .createNode(
                                ...
                                ContentModel.ASSOC_CHILDREN,
                                QName.createQName(
                                        NamespaceService.ALFRESCO_URI, "dictionaryModels"),
                                ContentModel.TYPE_DICTIONARY_MODEL,
                                properties)
                        .getChildRef();
        ...
        // Add the model content to the model node
        ContentWriter contentWriter =
                this.contentService.getWriter(modelNode, ContentModel.PROP_CONTENT, true);
        contentWriter.setEncoding("UTF-8");
        contentWriter.setMimetype(MimetypeMap.MIMETYPE_XML);
        ...
        try {
            transactionService
                    ...
                    .doInTransaction(
                            new RetryingTransactionCallback<Object>() {
                                public Object execute() throws Exception {
                                    // Check that the policy has not been fired since we have
                                    // updated a working copy
                                    assertEquals(
                                            "1.1",
                                            DictionaryModelTypeTest.this.nodeService.getProperty(
                                                    workingCopy, ContentModel.PROP_MODEL_VERSION));
                                    ...
                                    // Check-in the model change
                                    DictionaryModelTypeTest.this.cociService.checkin(
                                            workingCopy, null);
                                    return null;
                                }
                            });
    ...
    public void testUpdateDictionaryModelConstraintDelete() throws Exception {
                                ...
                                new RetryingTransactionCallback<NodeRef>() {
                                    public NodeRef execute() throws Exception {
                                        ...
                                        Collection<ConstraintDefinition> constraints =
                                                dictionaryService.getConstraints(
                                                        TEST_MODEL_TWO, true);
        ...
        transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                // Check that the policy has not been fired since the previous
                                // update was invalid
                                assertEquals(
                                        "1.0",
                                        DictionaryModelTypeTest.this.nodeService.getProperty(
                                ...
                                // Update model
                                ContentWriter contentWriter2 =
                                        DictionaryModelTypeTest.this.contentService.getWriter(
                                                workingCopy, ContentModel.PROP_CONTENT, true);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                Collection<ConstraintDefinition> constraints =
                                        dictionaryService.getConstraints(TEST_MODEL_TWO, true);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                try {
                                    // Check that the model has not yet been loaded into the
                                    // dictionary
                                    DictionaryModelTypeTest.this.dictionaryService.getModel(
                                            TEST_MODEL_ONE);
                                    fail(
                                            "This model has not yet been loaded into the dictionary"
                                                    + " service");
                                } catch (DictionaryException exception) {
                                    // We expect this exception
                                }
                                ...
                                DictionaryModelTypeTest.this.nodeService.setProperty(
                                        modelNode, ContentModel.PROP_MODEL_ACTIVE, true);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                // Set the isActive flag
                                DictionaryModelTypeTest.this.nodeService.setProperty(
                                        modelNode, ContentModel.PROP_MODEL_ACTIVE, false);
                        ...
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                ContentReader reader =
                                        DictionaryModelTypeTest.this.contentService.getReader(
                                                modelNode, ContentModel.PROP_CONTENT);
                                ...
                                final String schemaLocation =
                                        "classpath:alfresco/model/modelSchema.xsd";
                        ...
                        .doInTransaction(
                                new RetryingTransactionCallback<NodeRef>() {
                                    public NodeRef execute() throws Exception {
                                        ...
                                        properties.put(
                                                QName.createQName(
                                                        "http://www.alfresco.org/test/testmodel3/1.0",
                                                        "prop1"),
                                                "testvalue");
                                        NodeRef node =
                                                nodeService
        ...
        try {
                    ...
                    .doInTransaction(
                            new RetryingTransactionCallback<Void>() {
                                public Void execute() throws Exception {
                                    ContentWriter contentWriter =
                                            DictionaryModelTypeTest.this.contentService.getWriter(
                                                    modelNode2, ContentModel.PROP_CONTENT, true);
                                    contentWriter.putContent(
                                            Thread.currentThread()
                                                    .getContextClassLoader()
                                                    .getResourceAsStream(
                                                            "dictionary/testModel2.xml"));
                                    return null;
                                }
                            });
            ...
            assertTrue(
                    e.getCause()
                            .getMessage()
                            .contains(
                                    "URI mage.model cannot be imported as it is already contained"
                                            + " in the model's namespaces"));
        }
        ...
        try {
                        ...
                        public Void execute() throws Exception {
                            ...
                            ContentWriter contentWriter =
                                    contentService.getWriter(
                                            modelNode, ContentModel.PROP_CONTENT, true);
                            contentWriter.setEncoding("UTF-8");
                            contentWriter.setMimetype(MimetypeMap.MIMETYPE_XML);
                            contentWriter.putContent(
                                    Thread.currentThread()
                                            .getContextClassLoader()
                                            .getResourceAsStream(
                                                    "dictionary/modelWithCurrentNamespaceImported.xml"));
                            return null;
                        }
                    },
                    false,
            ...
            assertTrue(
                    e.getCause()
                            .getMessage()
                            .contains(
                                    "URI http://www.alfresco.org/model/dictionary/1.0 cannot be"
                                            + " imported as it is already contained in the model's"
                                            + " namespaces"));
            throw e;
        }
            ...
            txnHelper.doInTransaction(
                    new RetryingTransactionCallback<Void>() {
                        public Void execute() throws Exception {
                            ContentWriter contentWriter =
                                    DictionaryModelTypeTest.this.contentService.getWriter(
                                            modelANode, ContentModel.PROP_CONTENT, true);
                            contentWriter.putContent(
                                    Thread.currentThread()
                                            .getContextClassLoader()
                                            .getResourceAsStream("dictionary/modelAupdated.xml"));
                            return null;
                        }
                    });
            fail("Validation should fail as a circular dependency was introduced");
                    ...
                    e.getMessage()
                            .contains(
                                    "Failed to validate model update - found circular dependency."
                                            + " You can't set parent model-B as it's model already"
                                            + " depends on prefixA:model-A"));
        }
                        ...
                        public Void execute() throws Exception {
                            ...
                            contentWriter.putContent(
                                    Thread.currentThread()
                                            .getContextClassLoader()
                                            .getResourceAsStream(
                                                    "dictionary/modelAupdatedWithSecondNamespace.xml"));
                            return null;
                        }
                    });
            fail("Validation should fail as a circular dependency was introduced");
    ...
    private NodeRef createActiveModel(String contentFile) {
        ...
        contentWriter.setMimetype(MimetypeMap.MIMETYPE_XML);
        contentWriter.putContent(
                Thread.currentThread().getContextClassLoader().getResourceAsStream(contentFile));
        return modelNode;
    }
}
