...
public abstract class AbstractGetBlogWebScript extends AbstractBlogWebScript {
    ...
    protected Map<String, Object> executeImpl(
        ...
        if (this.getClass().equals(BlogPostsNewGet.class)) {
            ...
            if (numDays != null) {
                ...
                fromDate =
                        new Date(System.currentTimeMillis() - (numDaysInt * oneDayInMilliseconds));
            }
        }
    ...
    protected void createFtlModel(
        ...
        List<Map<String, Object>> blogPostDataSets =
                new ArrayList<Map<String, Object>>(blogPostList.getPage().size());
        for (BlogPostInfo postInfo : blogPostList.getPage()) {
            Map<String, Object> data =
                    BlogPostLibJs.getBlogPostData(postInfo.getNodeRef(), services);
    ...
    private PagingResults<BlogPostInfo> getBlogPostList(
        ...
        if (tag == null || tag.trim().isEmpty()) {
            ...
            RangedDateProperty dateRange =
                    new RangedDateProperty(fromDate, toDate, ContentModel.PROP_CREATED);
            if (site != null) {
