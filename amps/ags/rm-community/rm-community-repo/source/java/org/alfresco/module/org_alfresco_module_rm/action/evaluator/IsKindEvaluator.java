...
public class IsKindEvaluator
  ...
  protected boolean evaluateImpl(
    ...
    String kind =
      ((QName) actionCondition.getParameterValue(PARAM_KIND)).getLocalName();

    FilePlanComponentKind filePlanComponentKind = getFilePlanService()
      .getFilePlanComponentKind(actionedUponNodeRef);

    if (
      filePlanComponentKind != null &&
  ...
  protected void addParameterDefinitions(List<ParameterDefinition> paramList) {
    paramList.add(
      new ParameterDefinitionImpl(
        ...
        true,
        getParamDisplayLabel(PARAM_KIND),
        false,
        "rm-ac-is-kind-kinds"
      )
    );
