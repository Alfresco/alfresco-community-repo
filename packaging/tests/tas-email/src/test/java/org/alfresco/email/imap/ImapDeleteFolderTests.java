...
public class ImapDeleteFolderTests extends EmailTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager can delete a folder that contains collaborator user"
                            + " messages")
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE},
            enabled = false) // disable since it's failing intermitent
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager can delete a folder that contains contributor user"
                            + " messages")
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE},
            enabled = false) // disable since it's failing intermitent
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager can delete a folder that contains consumer user"
                            + " messages")
