...
public class JscriptWorkflowInstance implements Serializable {
    ...
    /**
     * Creates a new instance of <code>WorkflowInstance</code> from scratch
     *
     ...
     */
    public JscriptWorkflowInstance(
            final String id,
    ...
    /**
     * Create a new instance of <code>WorkflowInstance</code> from a WorkflowInstance object from
     ...
     */
    public JscriptWorkflowInstance(
            final WorkflowInstance cmrWorkflowInstance,
            final ServiceRegistry serviceRegistry,
            final Scriptable scope) {
                ...
                (Scriptable)
                        new ValueConverter()
                                .convertValueForScript(
                                        this.serviceRegistry, this.scope, null, paths);
     ...
     *
     * @deprecated as 'delete' is a JavaScript reserved word and so is unusable. Use {@link
     *     #remove()} instead.
     */
    public void delete() {
        this.remove();
