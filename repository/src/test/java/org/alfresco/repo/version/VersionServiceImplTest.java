...
public class VersionServiceImplTest extends BaseVersionStoreTest {
    ...
    private void createAndEnableBehaviours() {
        ...
        policyComponent.bindClassBehaviour(
                BeforeCreateVersionPolicy.QNAME,
                TEST_TYPE_QNAME,
                new JavaBehaviour(versionBehavior, "beforeCreateVersion"));
        policyComponent.bindClassBehaviour(
                AfterCreateVersionPolicy.QNAME,
                TEST_TYPE_QNAME,
                new JavaBehaviour(versionBehavior, "afterCreateVersion"));
        policyComponent.bindClassBehaviour(
                OnCreateVersionPolicy.QNAME,
                TEST_TYPE_QNAME,
                new JavaBehaviour(versionBehavior, "onCreateVersion"));
        policyComponent.bindClassBehaviour(
                AfterVersionRevertPolicy.QNAME,
                TEST_TYPE_QNAME,
                new JavaBehaviour(versionBehavior, "afterVersionRevert"));
        policyComponent.bindClassBehaviour(
                OnRevertVersionPolicy.QNAME,
                TEST_TYPE_QNAME,
                new JavaBehaviour(versionBehavior, "getRevertVersionCallback"));
    }
     ...
     *
     * <p>Test scenarios: 1) Create three versions with comments. Then revert to v1. All comments
     * must be exist. 2) Create three versions. Add comment to the latest two versions (v2 and v3).
     * Then revert to v1. Comments must be exist.
     */
    @Test
    ...
    private NodeRef addComment(NodeRef nr, String comment, boolean suppressRollups) {
        ...
        // This is what happens within e.g. comment.put.json.js when comments are submitted via the
        // REST API.
        ...
        NodeRef forumNode =
                nodeService
                        .getChildAssocs(
                                ...
                                QName.createQName(
                                        NamespaceService.FORUMS_MODEL_1_0_URI, "discussion"))
                        .get(0)
                        .getChildRef();

        final List<ChildAssociationRef> existingTopics =
                nodeService.getChildAssocs(
                        forumNode,
                        ContentModel.ASSOC_CONTAINS,
                        QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "Comments"));
            ...
            topicNode =
                    nodeService
                            .createNode(
                                    ...
                                    ContentModel.ASSOC_CONTAINS,
                                    QName.createQName(
                                            NamespaceService.CONTENT_MODEL_1_0_URI, "Comments"),
        ...
        NodeRef postNode =
                nodeService
                        .createNode(
                                topicNode,
                                ContentModel.ASSOC_CONTAINS,
                                QName.createQName("comment" + System.currentTimeMillis()),
    ...
    private boolean isCommentExist(NodeRef nr, String commentForCheck) {
        ...
        Collection<ChildAssociationRef> comments =
                nodeService.getChildAssocsWithoutParentAssocsOfType(
                        topicNode, ContentModel.ASSOC_CONTAINS);
    ...
    public void testCommentsCountProperty() {
        ...
        assertEquals(
                "Incorrect comments count:",
                2,
                nodeService.getProperty(versionableNode, ForumModel.PROP_COMMENT_COUNT));
    }
    ...
    public void testGetCurrentVersion() {
        ...
        try {
            // Get current version from the version node (frozen state version node) - not allowed
            // (MNT-15447)
            node = version.getFrozenStateNodeRef();
            currentVersion = versionService.getCurrentVersion(node);
            fail(
                    "Getting the current version is only allowed on live nodes, not on version"
                            + " nodes.");
    ...
    public void testVersioningChildren() {
        ...
        long beforeVersionTime =
                ((Date) nodeService.getProperty(versionableNode, ContentModel.PROP_CREATED))
                        .getTime();

        // Version the node and its children
        Collection<Version> versions =
                this.versionService.createVersion(versionableNode, this.versionProperties, true);
    ...
    public void testVersioningManyNodes() {
        ...
        Collection<Version> versions =
                this.versionService.createVersion(
                        this.versionableNodes.values(), this.versionProperties);
     ...
     */
    private void CheckVersionCollection(
            String expectedVersionLabel, long beforeVersionTime, Collection<Version> versions) {
        for (Version version : versions) {
            ...
            if (versionService
                ...
                frozenNodeId =
                        ((NodeRef) version.getVersionProperty(Version2Model.PROP_FROZEN_NODE_REF))
                                .getId();
            } else if (versionService
                    .getVersionStoreReference()
                    .getIdentifier()
                    .equals(VersionModel.STORE_ID)) {
                // Deprecated V1 version store (eg. workspace://lightWeightVersionStore)
                frozenNodeId =
                        (String) version.getVersionProperty(VersionModel.PROP_FROZEN_NODE_ID);
            }

            assertNotNull(
                    "Unable to retrieve the frozen node id from the created version.",
                    frozenNodeId);

            // Get the origional node ref (based on the forzen node)
            NodeRef originalNodeRef = this.versionableNodes.get(frozenNodeId);
            assertNotNull(
                    "The versionable node ref that relates to the frozen node id can not be found.",
                    originalNodeRef);
    ...
    private void CheckVersionHistory(VersionHistory vh, List<Version> expectedVersions) {
        if (vh == null) {
            ...
            for (Version version : vh.getAllVersions()) {
                ...
                assertEquals(
                        version.getFrozenStateNodeRef(), expectedVersion.getFrozenStateNodeRef());
            }
    ...
    /**
     * Tests getVersionHistory when all the entries in the version history are from the same
     * workspace.
     */
    @Test
    ...
    /**
     * Same as testGetVersionHistorySameWorkspace except that the order of of db ids is mixed up and
     * a comparator is need to fix it (MNT-226).
     */
    @Test
    ...
    /**
     * Sets the versionService to be one that has is db ids out of order so would normally have
     * versions displayed in the wrong order.
     *
    ...
    private void setOutOfOrderIdsVersionService(String versionComparatorClass) {
        Version2ServiceImpl versionService =
                new Version2ServiceImpl() {
                    @Override
    ...
    private Version addToVersionHistory(NodeRef versionableNode, Version parentVersion) {
        ...
        VersionHistory vh = this.versionService.getVersionHistory(versionableNode);
        assertNotNull(
                "The version history should not be null since we know we have versioned this node.",
                vh);
        ...
        if (parentVersion == null) {
            ...
            assertNotNull(
                    "The root version should never be null, since every version history ust have a"
                            + " root version.",
                    root);
    ...
    public void testRevert() {
        ...
        assertEquals(
                version1.getVersionedNodeRef(), history.getHeadVersion().getVersionedNodeRef());
        ...
        assertEquals(
                "0.1", nodeService.getProperty(versionableNode, ContentModel.PROP_VERSION_LABEL));
        ...
        ContentWriter contentWriter =
                this.contentService.getWriter(versionableNode, ContentModel.PROP_CONTENT, true);
        assertNotNull(contentWriter);
        contentWriter.putContent(UPDATED_CONTENT_1);

        // Change the aspects on the node
        this.dbNodeService.addAspect(
                versionableNode, ApplicationModel.ASPECT_SIMPLE_WORKFLOW, null);
        ...
        assertEquals(
                version2.getVersionedNodeRef(), history.getHeadVersion().getVersionedNodeRef());
        ...
        assertEquals(
                "0.2", nodeService.getProperty(versionableNode, ContentModel.PROP_VERSION_LABEL));
        ...
        String versionLabel =
                (String)
                        this.dbNodeService.getProperty(
                                versionableNode, ContentModel.PROP_VERSION_LABEL);
        ...
        assertEquals(
                versionLabel,
                this.dbNodeService.getProperty(versionableNode, ContentModel.PROP_VERSION_LABEL));
        ...
        ContentReader contentReader1 =
                this.contentService.getReader(versionableNode, ContentModel.PROP_CONTENT);
        ...
        // assertEquals("0.1", nodeService.getProperty(versionableNode,
    ...
    public void testRevertWithComments() {
        ...
        this.versionService.revert(versionableNode, version1);
        assertEquals(
                "I am before version", this.dbNodeService.getProperty(versionableNode, PROP_1));
        ...
        assertTrue(
                "fm:discussion association must exist",
                nodeService
                                .getChildAssocs(
                                        versionableNode,
                                        ForumModel.ASSOC_DISCUSSION,
                        ...
                        > 0);
        assertEquals(
                1, this.dbNodeService.getProperty(versionableNode, ForumModel.PROP_COMMENT_COUNT));
        ...
        assertEquals(
                2, this.dbNodeService.getProperty(versionableNode, ForumModel.PROP_COMMENT_COUNT));
        ...
        // Test reverting from version with comments to another version with comments, but with
        // another 'forum' node
    ...
    public void testAssociationIsPresentAfterRevert() {
        // Create Order
        NodeRef orderNodeRef =
                this.dbNodeService
                        .createNode(
                                rootNodeRef,
                                ContentModel.ASSOC_CHILDREN,
                                QName.createQName("{test}MyVersionableOrder"),
                                TEST_ATS_PARENT_TYPE_QNAME,
                                this.nodeProperties)
                        .getChildRef();
        this.dbNodeService.addAspect(
                orderNodeRef, ContentModel.ASPECT_VERSIONABLE, new HashMap<QName, Serializable>());
        ...
        NodeRef productNodeRef =
                this.dbNodeService
                        .createNode(
                                rootNodeRef,
                                ContentModel.ASSOC_CHILDREN,
                                QName.createQName("{test}MyProduct1"),
                                TEST_ATS_CHILD_TYPE_QNAME,
                                this.nodeProperties)
                        .getChildRef();
        this.dbNodeService.setProperty(orderNodeRef, PROP_ATS_CHILD_ID, 1);

        ChildAssociationRef childAssoc =
                this.dbNodeService.addChild(
                        orderNodeRef,
                        productNodeRef,
                        TEST_ATS_RELATED_CHILDREN_QNAME,
                        TEST_ATS_RELATED_CHILDREN_QNAME);
        assertFalse(
                "Order-product child association should not be primary", childAssoc.isPrimary());
        ...
        assertEquals(
                ...
                2,
                this.dbNodeService.getProperty(orderNodeRef, PROP_ATS_PARENT_ID));

        List<ChildAssociationRef> childAssocs =
                nodeService.getChildAssocs(
                        orderNodeRef, TEST_ATS_RELATED_CHILDREN_QNAME, RegexQNamePattern.MATCH_ALL);
        ...
        assertEquals(
                "Old property should restore after revert",
                1,
                this.dbNodeService.getProperty(orderNodeRef, PROP_ATS_PARENT_ID));
        ...
        assertTrue(
                "Order-Product association should remain the same",
                childAssocs.contains(childAssoc));
    }

    /**
     * This method was taken from the CommmentServiceImpl on the cloud branch
     *
     * <p>TODO: When this is merged to HEAD, please remove this method and use the one in
     * CommmentServiceImpl
     */
    private NodeRef createComment(
            final NodeRef discussableNode, String title, String comment, boolean suppressRollups) {
        if (comment == null) {
    ...
    public void testScriptNodeRevert() {
        ...
        ContentWriter contentWriter =
                this.contentService.getWriter(checkedOut, ContentModel.PROP_CONTENT, true);
        assertNotNull(contentWriter);
        contentWriter.putContent(UPDATED_CONTENT_1);
        ...
        assertEquals(
                version3.getVersionedNodeRef(), history.getHeadVersion().getVersionedNodeRef());
        ...
        assertEquals(
                "0.3",
                nodeService.getProperty(scriptNode.getNodeRef(), ContentModel.PROP_VERSION_LABEL));
        ...
        ContentReader contentReader =
                this.contentService.getReader(newNode.getNodeRef(), ContentModel.PROP_CONTENT);
        ...
        assertEquals(
                "0.4",
                nodeService.getProperty(newNode.getNodeRef(), ContentModel.PROP_VERSION_LABEL));
    ...
    /**
     * Test reverting from Share with changing type see MNT-14688
     * <li>
     *
     *     <ul>
    ...
    public void testScriptNodeRevertWithChangeType() {
        ...
        assertEquals(
                ...
                nodeService.getProperty(scriptNode.getNodeRef(), ContentModel.PROP_VERSION_LABEL));
        assertEquals(
                TEST_TYPE_WITH_MANDATORY_ASPECT_QNAME,
                nodeService.getType(scriptNode.getNodeRef()));
    ...
    public void testRestore() {
        ...
        try {
            this.versionService.restore(
                    ...
                    QName.createQName("{test}MyVersionableNode"));
            fail(
                    "An exception should have been raised since this node exists and you can't"
                            + " restore a node that exists.");
        } catch (VersionServiceException exception) {
            // We where expecting this exception
        }
        ...
        // Check that the content is correct
        ContentReader contentReader2 =
                this.contentService.getReader(restoredNode, ContentModel.PROP_CONTENT);
        assertNotNull(contentReader2);
        assertEquals(TEST_CONTENT, contentReader2.getContentString());
        ...
        String versionLabel =
                (String)
                        this.dbNodeService.getProperty(
                                restoredNode, ContentModel.PROP_VERSION_LABEL);
        ...
        assertEquals(
                VersionService.VERSION_STORE_PROTOCOL,
                versions[0].getFrozenStateNodeRef().getStoreRef().getProtocol());
        assertEquals(
                VersionService.VERSION_STORE_PROTOCOL,
                versions[1].getFrozenStateNodeRef().getStoreRef().getProtocol());
    }
    ...
    /** Test testDeleteLastVersion MNT-13097. Revert content if the last version was chosen. */
    @Test
    public void testDeleteLastVersion() {
        ...
        String name3 =
                (String) this.nodeService.getProperty(versionableNode, ContentModel.PROP_NAME);
        assertEquals(UPDATED_NAME_3, name3);
        String title3 =
                (String) this.nodeService.getProperty(versionableNode, ContentModel.PROP_TITLE);
    ...
    public void testAutoVersionOnInitialVersionOn() {
                        ...
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                VersionHistory versionHistory =
                                        versionService.getVersionHistory(versionableNode);
                                ...
                                ContentWriter contentWriter =
                                        contentService.getWriter(
                                                versionableNode, ContentModel.PROP_CONTENT, true);
                                assertNotNull(contentWriter);
                                contentWriter.putContent(UPDATED_CONTENT_1);
        ...
        // Now lets have a look and make sure we have the correct number of entries in the version
        // history
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                dbNodeService.removeAspect(
                                        nodeRef, ContentModel.ASPECT_VERSIONABLE);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                dbNodeService.addAspect(
                                        nodeRef, ContentModel.ASPECT_VERSIONABLE, null);
                        ...
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                NodeRef archivedNodeRef =
                                        nodeArchiveService.getArchivedNode(nodeRef);

                                // The archived noderef should still have a link to the version
                                // history
                                VersionHistory versionHistory =
                                        versionService.getVersionHistory(archivedNodeRef);
                                assertNotNull(versionHistory);
                                assertEquals(1, versionHistory.getAllVersions().size());
        ...
        txnHelper.doInTransaction(
                new RetryingTransactionCallback<Object>() {
                    public Object execute() throws Exception {
                        ...
                        VersionHistory versionHistory23 =
                                versionService.getVersionHistory(archivedNodeRef);
    ...
    public void testAutoVersionOnUpdatePropsOnly() {
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                nodeService.setProperty(
                                        versionableNode, ContentModel.PROP_AUTHOR, "ano author 1");
        ...
        // Checking whether VersionModel.PROP_VERSION_TYPE set to MINOR type after update node
        // properties
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(
        ...
        this.dbNodeService.setProperty(
                versionableNode2, ContentModel.PROP_AUTO_VERSION_PROPS, false);
        TestTransaction.flagForCommit();
        TestTransaction.end();
        ...
        transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                VersionHistory versionHistory =
                                        versionService.getVersionHistory(versionableNode2);
                                assertNotNull(versionHistory);
                                assertEquals(1, versionHistory.getAllVersions().size());

                                nodeService.setProperty(
                                        versionableNode2, ContentModel.PROP_AUTHOR, "ano author 2");
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                Version[] versions =
                                        versionHistory.getAllVersions().toArray(new Version[2]);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                nodeService.setProperty(
                                        versionableNode, ContentModel.PROP_AUTHOR, "ano author 2");
                                nodeService.setProperty(
                                        versionableNode,
                                        ContentModel.PROP_DESCRIPTION,
                                        "description 2");
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                // Check the versions,
                                Version[] versions =
                                        versionHistory.getAllVersions().toArray(new Version[3]);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                // Check the version
                                Version[] versions =
                                        versionHistory.getAllVersions().toArray(new Version[1]);
    ...
    public void testAutoVersionWithPropsOnRevert() {
        ...
        // Check it's 2.0
        assertEquals(
                "2.0", nodeService.getProperty(versionableNode, ContentModel.PROP_VERSION_LABEL));
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                assertEquals(
                                        "2.0", versionHistory.getHeadVersion().getVersionLabel());
                                assertEquals(
                                        "2.0",
        ...
        transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                nodeService.setProperty(
                                        versionableNode, ContentModel.PROP_AUTHOR, "ano author 3");
                                nodeService.setProperty(
                                        versionableNode,
                                        ContentModel.PROP_DESCRIPTION,
                                        "description 3");
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                assertEquals(
                                        "2.2", versionHistory.getHeadVersion().getVersionLabel());
                                assertEquals(
                                        "2.2",
                                        nodeService.getProperty(
                                                versionableNode, ContentModel.PROP_VERSION_LABEL));
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                // assertEquals("2.0", nodeService.getProperty(versionableNode,
                                // ContentModel.PROP_VERSION_LABEL));
                                assertEquals(
                                        "2.2",
                                        nodeService.getProperty(
                                ...
                                assertEquals(
                                        VALUE_1, nodeService.getProperty(versionableNode, PROP_1));
                                assertEquals(
                                        "description 0",
                                        nodeService.getProperty(
                                                versionableNode, ContentModel.PROP_DESCRIPTION));
                                return null;
                            }
                        });
    }
    ...
    public void testAR807() {
        QName prop =
                QName.createQName(
                        "http://www.alfresco.org/test/versionstorebasetest/1.0", "intProp");
        ...
        ChildAssociationRef childAssociation =
                nodeService.createNode(
                        ...
                        ContentModel.ASSOC_CHILDREN,
                        QName.createQName(
                                "http://www.alfresco.org/test/versionstorebasetest/1.0",
                                "integerTest"),
                        TEST_TYPE_QNAME);
    ...
    public void testVersionTypeIsSet() {
        ChildAssociationRef childAssociation =
                nodeService.createNode(
                        ...
                        ContentModel.ASSOC_CHILDREN,
                        QName.createQName(
                                "http://www.alfresco.org/test/versiontypeissettest/1.0",
                                "versionTypeIsSetTest"),
                        TEST_TYPE_QNAME);
        ...
        Serializable versionTypeProperty =
                nodeService.getProperty(newNode, ContentModel.PROP_VERSION_TYPE);
    ...
    public void testHasPermission() {
        ...
        permissionService.setPermission(
                rootNodeRef, PermissionService.ALL_AUTHORITIES, PermissionService.READ, true);
        ...
        assertEquals(
                ...
                permissionService.hasPermission(versionNodeRef, PermissionService.READ));
    ...
    /**
     * Check permissions for the frozen node if the store protocol is swapped from "version" to
     * "workspace" MNT-6877
     */
    @Test
    public void testHasPermissionSwappedProtocol() {
        ...
        assertEquals(
                AccessStatus.ALLOWED,
                permissionService.hasPermission(versionNodeRefSwapped, PermissionService.READ));
    ...
    public void testALF_3962() {
        ...
        this.dbNodeService.setProperty(
                versionNodeRef, Version2Model.PROP_QNAME_FROZEN_MODIFIED, frozenModifiedDate);
        ...
        // corrupt versions
        Collection<Version> versions =
                versionService.getVersionHistory(versionableNode).getAllVersions();
        ...
        for (Version version : versions) {
            ...
            this.dbNodeService.setProperty(
                    versionNodeRef, Version2Model.PROP_QNAME_VERSION_LABEL, "0");
        ...
        for (int i = 0; i < oldVersions.size(); i++) {
            ...
            assertEquals(
                    oldVersion.getVersionProperty(nodeDbidKey),
                    newVersion.getVersionProperty(nodeDbidKey));
            String nodeUuidKey = ContentModel.PROP_NODE_UUID.getLocalName();
            assertEquals(
                    oldVersion.getVersionProperty(nodeUuidKey),
                    newVersion.getVersionProperty(nodeUuidKey));
        }
    }

    /**
     * Ensure that versioning actions don't alter the auditable aspect properties on the original
     * nodes
     */
    @Test
    ...
    public void testEnsureVersioningEnabled() throws Exception {
        ...
        assertEquals(
                Boolean.TRUE, nodeService.getProperty(none, ContentModel.PROP_AUTO_VERSION_PROPS));
        assertEquals(null, nodeService.getProperty(none, ContentModel.PROP_TITLE));

        // Aspect won't have altered it's props
        assertEquals(true, nodeService.hasAspect(aspect, ContentModel.ASPECT_VERSIONABLE));
        assertEquals(
                Boolean.FALSE, nodeService.getProperty(aspect, ContentModel.PROP_AUTO_VERSION));
        assertEquals(
                Boolean.TRUE,
                nodeService.getProperty(aspect, ContentModel.PROP_AUTO_VERSION_PROPS));
        assertEquals(null, nodeService.getProperty(aspect, ContentModel.PROP_TITLE));

        // Versioned won't have altered it's props
        assertEquals(true, nodeService.hasAspect(versioned, ContentModel.ASPECT_VERSIONABLE));
        assertEquals(
                Boolean.TRUE, nodeService.getProperty(versioned, ContentModel.PROP_AUTO_VERSION));
        assertEquals(
                Boolean.FALSE,
                nodeService.getProperty(versioned, ContentModel.PROP_AUTO_VERSION_PROPS));
                            ...
                            public Object execute() throws Exception {
                                ...
                                assertEquals(
                                        ...
                                        nodeService.hasAspect(
                                                versionableNode, ContentModel.ASPECT_VERSIONABLE));
                                ...
                                assertEquals(
                                        true,
                                        nodeService.hasAspect(
                                                versionableNode, ContentModel.ASPECT_LOCKABLE));
    ...
    private static void doMain(String... args) {
        ...
        // Create a new store
        StoreRef storeRef =
                new StoreRef("test", "VersionServiceImplTest-main-" + System.currentTimeMillis());
    ...
    public void test_MNT10404() {
        ...
        try {
            ...
            contentService
                    ...
                    .putContent(theFirstContent);

            // add write permission
            permissionService.setPermission(
                    document, test_user, PermissionService.WRITE_CONTENT, true);

            // add versionable aspect as system user
            final NodeRef doc = document;

            RunAsWork<Void> getWork =
                    new RunAsWork<Void>() {
                        @Override
                        public Void doWork() throws Exception {
                            ...
                            versionProperties.put(
                                    ContentModel.PROP_VERSION_TYPE, VersionType.MINOR);
                            nodeService.addAspect(
                                    doc, ContentModel.ASPECT_VERSIONABLE, versionProperties);
                            return null;
                        }
                    };
            ...
            RunAsWork<Void> getWorkSetContent =
                    new RunAsWork<Void>() {
                        @Override
                        public Void doWork() throws Exception {
                            contentService
                                    .getWriter(doc, ContentModel.PROP_CONTENT, true)
                                    .putContent(theSecondContent);
                            return null;
                        }
                    };
            ...
            assertTrue(
                    theSecondContent.equals(
                            contentService
                                    .getReader(document, ContentModel.PROP_CONTENT)
                                    .getContentString()));
        } finally {
            // delete user
            if (personService.personExists(test_user)) {
    ...
    private void assertBehaviourCreateVersionDisable() {
        assertFalse(
                "Behavior should not be executed",
                versionBehavior.isExecuted(BeforeCreateVersionPolicy.QNAME));
    ...
    private void behaviourVersionTestWork(
            boolean revert, boolean disableBehaviour, boolean disableBehaviourNode)
            throws Exception {
    ...
    public class TestVersionPolicy
            implements BeforeCreateVersionPolicy,
        ...
        @Override
        public VersionRevertCallback getRevertVersionCallback(
                QName classRef, VersionRevertDetails copyDetails) {
