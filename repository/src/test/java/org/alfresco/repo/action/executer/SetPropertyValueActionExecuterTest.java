...
public class SetPropertyValueActionExecuterTest extends BaseSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.executer =
                (SetPropertyValueActionExecuter)
                        this.applicationContext.getBean(SetPropertyValueActionExecuter.NAME);
    }
    ...
    public void testExecution() {
        ...
        action.setParameterValue(
                SetPropertyValueActionExecuter.PARAM_PROPERTY, ContentModel.PROP_NAME);
        ...
        assertEquals(
                TEST_VALUE, this.nodeService.getProperty(this.nodeRef, ContentModel.PROP_NAME));
