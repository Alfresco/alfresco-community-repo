...
public class Node implements Comparable<Node> {
    ...
    protected void mapMinimalInfo(
        ...
        this.createdByUser =
                lookupUserInfo(
                        (String) nodeProps.get(ContentModel.PROP_CREATOR),
                        mapUserInfo,
                        personService);
        ...
        this.modifiedByUser =
                lookupUserInfo(
                        (String) nodeProps.get(ContentModel.PROP_MODIFIER),
                        mapUserInfo,
                        personService);
    }

    public static UserInfo lookupUserInfo(
            String userName, Map<String, UserInfo> mapUserInfo, PersonService personService) {
    ...
    // here to allow POST /nodes/{id}/children when creating empty file with specified
    // content.mimeType
    ...
    // TODO for backwards compat' - set explicitly when needed (ie. favourites) (note: we could
    // choose to have separate old Node/NodeImpl etc)
