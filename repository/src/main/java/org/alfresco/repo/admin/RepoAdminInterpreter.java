    ...
    if (command[0].equals("help")) {
      ...
      if (command.length < 2) {
        ...
        if (resources != null) {
          for (int i = 0; i < resources.length; i++) {
            ...
            if (!names.contains(filename)) {
              out.println(
                "resource: " + filename + ", url: " + resources[i].getURL()
              );
              names.add(filename);
            }
          }
        ...
        if ((models != null) && (models.size() > 0)) {
          ...
          out.println(
            "No additional models have been deployed to the Alfresco Repository"
          );
        }
        ...
        if ((messageResources != null) && (messageResources.size() > 0)) {
          ...
          out.println(
            "No additional messages resource bundles have been deployed to the Alfresco Repository"
          );
        }
      } else {
      ...
      if (command[1].equals("model")) {
        ...
        String bundleBaseName = repoAdminService.deployMessageBundle(
          bundleBasePath
        );
      ...
      if (command.length != 3) {
        ...
        out.println(
          "Model activated: " + modelFileName + " [" + modelQName + "]"
        );
      }
      ...
      if (command.length != 3) {
        ...
        out.println(
          "Model deactivated: " + modelFileName + " [" + modelQName + "]"
        );
      }
      ...
      if (command[1].equals("model")) {
        ...
        out.println(
          "Model undeployed: " + modelFileName + " [" + modelQName + "]"
        );
