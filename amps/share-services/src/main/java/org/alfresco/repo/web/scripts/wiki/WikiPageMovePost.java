 ...
 *
 * <p>TODO Track links to pages, so we can avoid creating the "This page has been moved" stubs as
 * now, for cases where nothing links to the page being renamed. (ALF-3844)
 *
 * @author Nick Burch
 * @since 4.0
 */
public class WikiPageMovePost extends AbstractWikiWebScript {
    ...
    // The 'custom0' key here refers to the org.alfresco.wiki.page-renamed {2} in
    // activity-list.get.properties
