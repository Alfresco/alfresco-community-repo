...
public class KeyStoreKeyProviderTest extends TestCase {
     ...
     *
     * <p>TODO: Allow the required aliases and key types to be specified and generate a keystore on
     * the fly
     */
    /* package */ static KeystoreKeyProvider getTestKeyStoreProvider() {
        ...
        KeyStoreParameters encryptionParameters =
                new KeyStoreParameters("test", "JCEKS", "SunJCE", null, FILE_TWO);
        KeystoreKeyProvider keyProvider =
                new KeystoreKeyProvider(encryptionParameters, getKeyStoreLoader(passwords));
        //                FILE_TWO,
        //                getKeyStoreLoader(),
        //                "SunJCE",
        //                "JCEKS",
    ...
    /* package */ static KeystoreKeyProvider getTestKeyStoreProvider(
            String keyStoreLocation, Map<String, String> passwords) {
        //        Map<String, String> passwords = new HashMap<String, String>(5);
        //        passwords.put(KeyStoreManager.KEY_KEYSTORE_PASSWORD, "ksPwd2");
        //        passwords.put(ALIAS_ONE, "aliasPwd1");
        //        passwords.put(ALIAS_TWO, "aliasPwd2");
        KeyStoreParameters encryptionParameters =
                new KeyStoreParameters("test", "JCEKS", "SunJCE", null, keyStoreLocation);
        KeystoreKeyProvider keyProvider =
                new KeystoreKeyProvider(encryptionParameters, getKeyStoreLoader(passwords));
        //                FILE_TWO,
        //                getKeyStoreLoader(),
    ...
    public void testNoKeyStorePasswords() throws Exception {
        KeystoreKeyProvider keyProvider =
                getTestKeyStoreProvider(FILE_ONE, Collections.<String, String>emptyMap());
    ...
    public void testKeyStoreWithOnlyAliasPasswords() throws Exception {
        KeystoreKeyProvider keyProvider =
                getTestKeyStoreProvider(FILE_ONE, Collections.singletonMap(ALIAS_ONE, "aliasPwd1"));
        ...
        // This has succeeded because we have not attempted to access it
        assertNotNull(
                "Should be able to key alias with same password", keyProvider.getKey(ALIAS_ONE));
    }
