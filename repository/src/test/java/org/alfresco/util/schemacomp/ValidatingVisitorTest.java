...
public class ValidatingVisitorTest {
  ...
  public void setUp() throws Exception {
    ...
    targetIndex1 =
      new Index(targetTable, "index_name", Arrays.asList("a", "b", "c"));
    targetIndex2 =
      new Index(targetTable, "another_index", Arrays.asList("a", "b", "c"));
    targetIndex3 =
      new Index(targetTable, "index_name", Arrays.asList("e", "f"));
  ...
  public void canValidate() {
    Mockito
      .when(comparisonUtils.findEquivalentObjects(refSchema, refIndex))
      .thenReturn(
        Arrays.asList((DbObject) targetIndex1, targetIndex2, targetIndex3)
      );
  ...
  public void redundantDbObjectsAreNoticed() {
    ...
    assertEquals(
      ...
      ctx.getComparisonResults().get(0).getClass()
    );
  }
