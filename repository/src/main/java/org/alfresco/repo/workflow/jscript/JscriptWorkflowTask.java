...
public class JscriptWorkflowTask extends BaseScopableProcessorExtension implements Serializable {
    ...
    /**
     * Creates a new instance of a workflow task from a WorkflowTask from the CMR workflow object
     * model
     *
     * @param task an instance of WorkflowTask from CMR workflow object model
     * @param serviceRegistry Service Registry object
     */
    public JscriptWorkflowTask(
            WorkflowTask task, ServiceRegistry serviceRegistry, Scriptable scope) {
        this.serviceRegistry = serviceRegistry;
        this.namespaceProvider =
                new DefaultNamespaceProvider(serviceRegistry.getNamespaceService());
    ...
    public Scriptable getProperties() {
        ...
        ScriptableQNameMap<String, Serializable> properties =
                new ScriptableQNameMap<String, Serializable>(namespaceProvider);
     ...
     * End the task
     *
     * @param transitionId transition to end the task for
     */
