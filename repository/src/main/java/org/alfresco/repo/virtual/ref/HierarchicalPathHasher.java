    ...
    while (hash == null) {
      ...
      if (lastSeparator < 0) {
        String code = new String(
          Base64.encodeBase64(normalClasspath.getBytes(), false)
        );
      ...
      if (notFoundPath != null) {
        notFoundPath =
          searchedClasspath.substring(lastSeparator + 1) + "/" + notFoundPath;
      } else {
      ...
      if (hash != null) {
        String notFoundClasspathBase64 = new String(
          Base64.encodeBase64(notFoundPath.getBytes(), false)
        );
