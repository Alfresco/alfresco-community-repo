 ...
 * 
 * This replaces the Goat Entity resource for version 1. Instead of returning a Goat it now returns a Slim Goat with only 2 properties instead of the original 5
 * 
 * @author Gethin James
 */
