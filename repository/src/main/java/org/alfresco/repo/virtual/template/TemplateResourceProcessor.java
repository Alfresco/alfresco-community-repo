...
public class TemplateResourceProcessor
  ...
  @Override
  public VirtualFolderDefinition process(Resource resource)
    ...
    if (resource instanceof ClasspathResource) {
      ...
      throw new ResourceProcessingError(
        "Unsupported resource class " + resource.getClass()
      );
    }
  }
  ...
  public VirtualFolderDefinition process(RepositoryResource repositoryResource)
    ...
    Object result;
    try {
      NodeRef templateNodeRef = repositoryResource
        .getLocation()
        .asNodeRef(context.getActualEnviroment());
      result =
        context
          .getActualEnviroment()
  ...
  protected Map<String, Object> createScriptParameters(VirtualContext context)
    ...
    Object scriptContext = context
      .getActualEnviroment()
      .createScriptVirtualContext(context);
  ...
  protected FilingRule asFilingRule(VirtualContext context, Object filing)
    ...
    Map<String, Object> classificationMap = (Map<String, Object>) filingMap.get(
      CLASSIFICATION_KEY
    );
    ...
    Map<String, String> properties = (Map<String, String>) filingMap.get(
      PROPERTIES_KEY
    );
    if (properties == null) {
    ...
    if (
      path == null && type == null && aspects.isEmpty() && properties.isEmpty()
    ) {
   ...
   * @throws ResourceProcessingError
   */
  protected VirtualQuery asVirtualQuery(
  ...
  protected VirtualFolderDefinition asVirtualStructure(
    ...
    try {
      ...
      @SuppressWarnings("unchecked")
      VirtualQuery virtualQuery = asVirtualQuery(
        context,
      ...
      @SuppressWarnings("unchecked")
      Map<String, String> properties = (Map<String, String>) mapResult.get(
        PROPERTIES_KEY
      );
      if (properties == null) {
        properties = Collections.emptyMap();
      ...
      @SuppressWarnings("unchecked")
      List<Map<String, Object>> nodes = (List<Map<String, Object>>) mapResult.get(
        NODES_KEY
      );
