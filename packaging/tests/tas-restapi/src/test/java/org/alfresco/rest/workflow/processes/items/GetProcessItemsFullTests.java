...
public class GetProcessItemsFullTests extends RestTest {
  ...
  public void getProcessItemsWithValidSkipCount() throws Exception {
    ...
    items
      ...
      .assertThat()
      .entriesListDoesNotContain("name", document1.getName())
      .assertThat()
  ...
  public void getProcessItemsWithValidMaxItems() throws Exception {
    ...
    items
      .assertThat()
      .entriesListDoesNotContain("name", document3.getName())
      .assertThat()
  ...
  public void getProcessItemsWithPropertiesParameter() throws Exception {
    ...
    items =
      restClient
        .authenticateUser(assignee)
        .withParams("properties=createdBy,name,mimeType,size")
        .withWorkflowAPI()
        .usingProcess(processModel)
        .getProcessItems();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    items
      .getProcessItemByName(document1.getName())
      .assertThat()
      .field("createdBy")
      .is(userWhoStartsTask.getUsername())
      .assertThat()
      .field("name")
      .is(document1.getName())
      .assertThat()
      .field("mimeType")
      .is(document1.getFileType().mimeType)
      .assertThat()
      .field("size")
      .isNotNull()
      .assertThat()
  ...
  public void getProcessItemsAfterDeletingProcess() throws Exception {
    ...
    items
      ...
      .assertThat()
      .field("id")
      .is(document1.getNodeRefWithoutVersion())
      .assertThat()
      .field("createdAt ")
      .isNotNull();
  }
