...
/**
 * Represents maximum values (that result in exceptions if exceeded) or limits on values (that
 * result in EOF (End Of File) being returned early). The current options are elapsed time, document
 * size and concurrent extractions limit.
 *
 * @author Ray Gauss II
 */
@AlfrescoPublicApi
