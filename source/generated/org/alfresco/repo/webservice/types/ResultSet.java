...
public class ResultSet  implements java.io.Serializable {
     ...
     * @return rows
     */
    public org.alfresco.repo.webservice.types.ResultSetRow[] getRows() {
        return rows;
    }
     ...
     * @param rows
     */
    public void setRows(org.alfresco.repo.webservice.types.ResultSetRow[] rows) {
        this.rows = rows;
    }

    public org.alfresco.repo.webservice.types.ResultSetRow getRows(int i) {
        return this.rows[i];
    }

    public void setRows(int i, org.alfresco.repo.webservice.types.ResultSetRow _value) {
        this.rows[i] = _value;
    }
     ...
     * @return metaData
     */
    public org.alfresco.repo.webservice.types.ResultSetMetaData getMetaData() {
        return metaData;
    }
     ...
     * @param metaData
     */
    public void setMetaData(org.alfresco.repo.webservice.types.ResultSetMetaData metaData) {
        this.metaData = metaData;
    }
