...
public class RuleServiceIntegrationTest
{
    ...
    /**
     * Test that inherited rules with inverted actions behave correctly. Specifically that the VERSIONABLE aspect is correctly removed after being adding by an inherited parent rule.
     */
    @Test
    ...
    /**
     * ALF-18488 Rules: Send Email action is not working Tests deletion of node triggers outbound rule and fires the MailAction
     */
    @Test
