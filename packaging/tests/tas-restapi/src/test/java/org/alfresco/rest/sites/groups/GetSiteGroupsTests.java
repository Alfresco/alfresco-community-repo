...
public class GetSiteGroupsTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    RestSiteGroupModelsCollection siteGroups = restClient
  ...
  public void getSiteGroupsWithManagerRole() throws Exception {
    restClient
      .authenticateUser(
        publicSiteUsers.getOneUserWithRole(UserRole.SiteManager)
      )
      .withCoreAPI()
  ...
  public void getSiteGroupsWithCollaboratorRole() throws Exception {
    restClient
      .authenticateUser(
        publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator)
      )
      .withCoreAPI()
      .usingSite(publicSite)
      .getSiteGroups()
  ...
  public void getSiteGroupsWithContributorRole() throws Exception {
    restClient
      .authenticateUser(
        publicSiteUsers.getOneUserWithRole(UserRole.SiteContributor)
      )
      .withCoreAPI()
      .usingSite(publicSite)
      .getSiteGroups()
  ...
  public void getSiteGroupsWithConsumerRole() throws Exception {
    restClient
      .authenticateUser(
        publicSiteUsers.getOneUserWithRole(UserRole.SiteConsumer)
      )
      .withCoreAPI()
      .usingSite(publicSite)
      .getSiteGroups()
  ...
  public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteGroups()
    throws Exception {
  ...
  public void checkStatusCodeForNonExistentSiteId() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format("Site %s does not exist", "NonExistentSiteId")
      );
  }
  ...
  public void getModeratedSiteGroupsUsingPropertiesParameter()
    throws Exception {
    RestSiteGroupModelsCollection siteGroups = restClient
      .authenticateUser(siteCreator)
      .withCoreAPI()
  ...
  public void getModeratedSiteGroupsUsingHighSkipCountParameter()
    throws Exception {
    RestSiteGroupModelsCollection siteGroups = restClient
      .authenticateUser(siteCreator)
      .withCoreAPI()
