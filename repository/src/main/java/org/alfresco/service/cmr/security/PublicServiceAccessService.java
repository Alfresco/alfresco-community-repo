...
/**
 * Evaluate public service entry conditions as defined in the security interceptors. Decouples any
 * understanding of the security model from asking can I invoke the method and expect it to work.
 *
 * @author andyh
 */
