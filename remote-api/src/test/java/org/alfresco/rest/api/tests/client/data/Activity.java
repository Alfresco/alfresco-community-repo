...
public class Activity implements Serializable, ExpectedComparison {
  ...
  public void expected(Object o) {
    ...
    AssertUtil.assertEquals(
      "feedPersonId",
      feedPersonId,
      other.getFeedPersonId()
    );
    AssertUtil.assertEquals(
      "postPersonId",
      postPersonId,
      other.getPostPersonId()
    );
    ...
    if (activityType.equals("org.alfresco.documentlibrary.file-added")) {
      ...
      if (NodeRef.isNodeRef(nodeRefStr)) {
        ...
        throw new RuntimeException(
          "nodeRef " + nodeRefStr + " in activity feed is not a valid NodeRef"
        );
      }
      String parentNodeRefStr = (String) activitySummary.remove(
        "parentNodeRef"
      );
      if (NodeRef.isNodeRef(parentNodeRefStr)) {
        ...
        throw new RuntimeException(
          "parentNodeRef " +
          parentNodeRefStr +
          " in activity feed is not a valid NodeRef"
        );
      }
