...
public class PersonTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        RepoUsageComponentImpl repoUsageComponent =
                (RepoUsageComponentImpl) ctx.getBean("repoUsageComponent");
    ...
    private int getPeopleCount() {
        ...
        PagingRequest pagingRequest =
                new PagingRequest(20000, null); // note: people (up to max of 20000)
        ...
        pagingRequest.setRequestTotalCountMax(
                20000); // note: request total people count (up to max of 20000)
                        ...
                        NodeRef homeFolder =
                                DefaultTypeConverter.INSTANCE.convert(
                                        ...
                                        nodeService.getProperty(
                                                madePerson, ContentModel.PROP_HOMEFOLDER));
                        if (homeFolder == null) {
    ...
    public void testZones() {
        ...
        personService.createPerson(
                createDefaultProperties(
                        "derek", "Derek", "Hulley", "dh@dh", "alfresco", rootNodeRef));
        ...
        personService.createPerson(
                createDefaultProperties("null", "null", "null", "null", "null", rootNodeRef),
                newZones);
        assertEquals(0, authorityService.getAuthorityZones("null").size());

        newZones = new HashSet<String>();
        personService.createPerson(
                createDefaultProperties("empty", "empty", "empty", "empty", "empty", rootNodeRef),
                newZones);
        assertEquals(0, authorityService.getAuthorityZones("empty").size());

        newZones.add("One");
        personService.createPerson(
                createDefaultProperties("1", "1", "1", "1", "1", rootNodeRef), newZones);
        assertEquals(1, authorityService.getAuthorityZones("1").size());

        newZones.add("Two");
        personService.createPerson(
                createDefaultProperties("2", "2", "2", "2", "2", rootNodeRef), newZones);
        assertEquals(2, authorityService.getAuthorityZones("2").size());

        newZones.add("Three");
        personService.createPerson(
                createDefaultProperties("3", "3", "3", "3", "3", rootNodeRef), newZones);
    ...
    public void testCreateAndThenDelete() {
        ...
        personService.createPerson(
                createDefaultProperties(
                        "andy", "Andy", "Hind", "andy@hind", "alfresco", rootNodeRef));
        personService.getPerson("andy");
    ...
    public void testCreateMissingPeople() {
        ...
        personService.setPersonProperties(
                ...
                createDefaultProperties(
                        "derek", "Derek", "Hulley", "dh@dh", "alfresco", rootNodeRef));
        testProperties(
                personService.getPerson("derek"), "derek", "Derek", "Hulley", "dh@dh", "alfresco");
    ...
    public void testPersonCRUD2() {
        ...
        personService.setPersonProperties(
                "derek",
                createDefaultProperties(
                        "derek", "Derek_", "Hulley_", "dh@dh_", "alfresco_", rootNodeRef));
        ...
        assertEquals(
                0,
                personService
                        .getPeopleFilteredByProperty(ContentModel.PROP_EMAIL, "gj@email.com", 10)
                        .size());
        assertEquals(
                0,
                personService
    ...
    public void testPersonCRUD() {
        ...
        personService.setPersonProperties(
                "Derek",
                createDefaultProperties(
                        "notderek", "Derek_", "Hulley_", "dh@dh_", "alfresco_", rootNodeRef));
        ...
        personService.setPersonProperties(
                "Derek",
                createDefaultProperties(
                        "notderek", "Derek", "Hulley", "dh@dh", "alfresco", rootNodeRef));
        ...
        assertEquals(
                ...
                EqualsHelper.nullSafeEquals(personService.getUserIdentifier("derek"), "Derek"));
        assertEquals(
                personService.personExists("dEREK"),
                EqualsHelper.nullSafeEquals(personService.getUserIdentifier("dEREK"), "Derek"));
        assertEquals(
    ...
    public void testPeopleFiltering() {
        ...
        personService.createPerson(
                createDefaultProperties("aa", "Aa", "Aa", "aa@aa", "alfresco", rootNodeRef));
        personService.createPerson(
        ...
        PagingResults<PersonInfo> people =
                personService.getPeople(null, null, null, null, false, null, pr);
    ...
    public void testPeopleSortingPaging() {
        ...
        NodeRef p1 =
                personService.getPerson(
                        AuthenticationUtil.getAdminUserName()); // admin - by default
        NodeRef p2 =
                personService.getPerson(
                        AuthenticationUtil.getGuestUserName()); // guest - by default

        NodeRef p3 =
                personService.createPerson(
                        createDefaultProperties(
                                "aa", "Aa", "Aa", "aa@aa", "alfresco", rootNodeRef));
        NodeRef p4 =
                personService.createPerson(
                        createDefaultProperties(
                                "cc", "Cc", "Cc", "cc@cc", "alfresco", rootNodeRef));
        NodeRef p5 =
                personService.createPerson(
                        createDefaultProperties(
                                "hh", "Hh", "Hh", "hh@hh", "alfresco", rootNodeRef));
        NodeRef p6 =
                personService.createPerson(
                        createDefaultProperties(
                                "bb", "Bb", "Bb", "bb@bb", "alfresco", rootNodeRef));
        NodeRef p7 =
                personService.createPerson(
                        createDefaultProperties(
                                "dd", "Dd", "Dd", "dd@dd", "alfresco", rootNodeRef));

        int expectedTotalCount = 7;
        assertEquals(expectedTotalCount, getPeopleCount());

        Pair<Integer, Integer> expectedResultCount =
                new Pair<Integer, Integer>(expectedTotalCount, expectedTotalCount);
    ...
    public void testPeopleSortingPaging_NoAdmin() {
        ...
        Pair<Integer, Integer> expectedResultCount =
                new Pair<Integer, Integer>(
                        expectedTotalCountWithAdmin, expectedTotalCountWithAdmin);
        ...
        // page 1
        PagingRequest pr = new PagingRequest(0, 2, null);
        PagingResults<PersonInfo> ppr =
                personService.getPeople(null, null, null, null, false, sort, pr);
        List<PersonInfo> results = ppr.getPage();
        assertEquals(2, results.size());
        assertEquals(p3, results.get(0).getNodeRef());
    ...
    private void testProperties(
        ...
        assertEquals(
                orgId,
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeService.getProperty(nodeRef, ContentModel.PROP_ORGID)));
    }
    ...
    public void testReadOnlyTransactionHandling() throws Exception {
        ...
        RetryingTransactionCallback<Object> deletePersonWork =
        ...
        RetryingTransactionCallback<NodeRef> getMissingPersonWork =
    ...
    /**
     * Disabled due to time constraints. This <i>does</i> highlight a problem, but one that won't
     * manifest itself critically in the product.
     */
        ...
        for (int i = 0; i < 100; i++) // Bump this number up to 1000 for 'real' testing
        {
            try {
                ...
                throw new RuntimeException(
                        "Failed on iteration " + i + " of forcing split person.", e);
            }
        }
    }
    ...
    private void forceSplitPersonCleanup() throws Exception {
        ...
        Runnable createPersonRunnable =
                new Runnable() {
                    public void run() {
                        final RetryingTransactionCallback<NodeRef> createPersonWork =
                                new RetryingTransactionCallback<NodeRef>() {
                                    public NodeRef execute() throws Throwable {
        ...
        RetryingTransactionCallback<NodeRef> getPersonWork =
                new RetryingTransactionCallback<NodeRef>() {
                    public NodeRef execute() throws Throwable {
                        return personService.getPerson(duplicateUsername);
                    }
                };
        final NodeRef remainingNodeRef =
                transactionService
                        .getRetryingTransactionHelper()
                            ...
                            public Object execute() throws Throwable {
                                ...
                                for (NodeRef nodeRef : cleanableNodeRefs.values()) {
                                    ...
                                    if (nodeService.exists(nodeRef)) {
                                        fail(
                                                "Expected unused person noderef to have been"
                                                        + " cleaned up: "
                                                        + nodeRef);
                                    }
                                }
                        ...
                        .doInTransaction(
                                new RetryingTransactionCallback<NodeRef[]>() {
                                    public NodeRef[] execute() throws Throwable {
                                        ...
                                        ChildAssociationRef container =
                                                nodeService.getPrimaryParent(duplicates[0]);
                                        List<ChildAssociationRef> parents =
                                                nodeService.getParentAssocs(duplicates[0]);
                                        ...
                                        // With the default settings, the last created node should
    ...
    public void testCheckForDuplicateCaseInsensitive() {
        ...
        try {
            ...
            fail(
                    "Shouldn't be able to create person node directly (within people container) -"
                            + " use createPerson instead");
    ...
    public void testUpdateUserNameCase() {
        ...
        RetryingTransactionCallback<Void> callback2 =
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        nodeService.setProperty(
                                personRef, ContentModel.PROP_USERNAME, TEST_PERSON_UPPER);
    ...
    public void testCheckForIndirectUsage() throws Exception {
        ...
        try {
            ...
            fail(
                    "Shouldn't be able to delete person node directly (within people container) -"
                            + " use deletePerson instead");
        } catch (AlfrescoRuntimeException are) {
            if (!are.getMessage().contains("use PersonService")) {
                throw are;
            }
    ...
    public void testDisableEnablePerson() {
        ...
        Map<QName, Serializable> properties =
                createDefaultProperties(
                        userName, "firstName", "lastName", "email@orgId", "orgId", null);
    ...
    public void testDisableEnableAdmin() {
        ...
        assertFalse(
                "Admin account STILL does not expire", authenticationDAO.getAccountExpires(admin));
    }
    ...
    public void testUserShouldBeAbleToUpdateTheProfile() {
        ...
        NodeRef personRef =
                personService.createPerson(
                        createDefaultProperties(
                                USERNAME, "Aa", "Aa", "aa@aa", "alfresco", rootNodeRef));
    ...
    public void testPreventChangesToOtherUsersPropertiesWithoutHavingAdminRights() {
        try {
            ...
            personService.createPerson(
                    createDefaultProperties(
                            USERNAME_1, "Aa", "Aa", "aa@aa", "alfresco", rootNodeRef));
            NodeRef user2 =
                    personService.createPerson(
                            createDefaultProperties(
                                    USERNAME_2, "Bb", "Bb", "bb@bb", "alfresco", rootNodeRef));
