...
public class RoleDefinition  implements java.io.Serializable {
    ...
    public RoleDefinition(
           ...
           org.alfresco.repo.webservice.types.Cardinality cardinality) {
           this.name = name;
     ...
     * @return cardinality
     */
    public org.alfresco.repo.webservice.types.Cardinality getCardinality() {
        return cardinality;
    }
     ...
     * @param cardinality
     */
    public void setCardinality(org.alfresco.repo.webservice.types.Cardinality cardinality) {
        this.cardinality = cardinality;
    }
