...
public class NodeLocatorWebScriptTest extends BaseWebScriptTest {
        ...
        try {
            ...
            site =
                    siteService.createSite(
                            "", siteName, "Title", "Description", SiteVisibility.PUBLIC);
    ...
    public void testAncestorOfTypeNodeLocator() throws Exception {
        ...
        try {
            ...
            String encodedContentType =
                    URLEncoder.encode(ContentModel.TYPE_CONTENT.toPrefixString(namespaceService));
            ...
            String encodedFOlderType =
                    URLEncoder.encode(ContentModel.TYPE_FOLDER.toPrefixString(namespaceService));
    ...
    private String makeUrl(NodeRef node, String locatorName) {
        ...
        url.append(storeRef.getProtocol())
                .append("/")
