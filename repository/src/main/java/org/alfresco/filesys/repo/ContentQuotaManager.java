 ...
 *
 * <p>Keeps an in memory quota for each active user. After a configurable length of time quotas are
 * removed from memory.
 *
 * @author gkspencer
 */
                ...
                if (m_liveUsage != null && m_liveUsage.size() > 0) {
                    try {
                        ...
                        while (userNames.hasNext()) {
                            ...
                            // Get the user quota details and check if it has been inactive in the
                            // last check interval
