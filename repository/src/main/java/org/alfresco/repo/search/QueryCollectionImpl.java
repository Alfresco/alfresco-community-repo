...
public class QueryCollectionImpl implements QueryCollection {
  ...
  private static final org.dom4j.QName NAME = new org.dom4j.QName(
    "name",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName NAMESPACES = new org.dom4j.QName(
    "namespaces",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName NAMESPACE = new org.dom4j.QName(
    "namespace",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName PREFIX = new org.dom4j.QName(
    "prefix",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName URI = new org.dom4j.QName(
    "uri",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  public QueryCollectionImpl(
    String name,
    Map<QName, QueryParameterDefinition> parameters,
    NamespacePrefixResolver namespacePrefixResolver
  ) {
    super();
    this.name = name;
  ...
  public static QueryCollection createQueryCollection(
    Element element,
    DictionaryService dictionaryService,
    NamespacePrefixResolver nspr
  ) {
    DynamicNamespacePrefixResolver dnpr = new DynamicNamespacePrefixResolver(
      nspr
    );
    if (element.getName().equals(ELEMENT_QNAME.getName())) {
      ...
      if (nameSpaces != null) {
        ...
        for (Iterator it = ns.iterator(); it.hasNext();/**/) {
          ...
          if ((prefixElement != null) && (nsElement != null)) {
            dnpr.registerNamespace(
              prefixElement.getText(),
              uriElement.getText()
            );
          }
        }
      ...
      List list = element.elements(
        QueryParameterDefImpl.getElementQName().getName()
      );
      for (Iterator it = list.iterator(); it.hasNext();/**/) {
        Element defElement = (Element) it.next();
        QueryParameterDefinition paramDef = QueryParameterDefImpl.createParameterDefinition(
          defElement,
          dictionaryService,
          nspr
        );
      ...
      QueryCollectionImpl collection = new QueryCollectionImpl(
        name,
        parameters,
        dnpr
      );
      ...
      for (Iterator it = list.iterator(); it.hasNext();/**/) {
        Element defElement = (Element) it.next();
        CannedQueryDefImpl queryDef = CannedQueryDefImpl.createCannedQuery(
          defElement,
          dictionaryService,
          collection,
          nspr
