...
public class UpdateDispositionScheduleTest extends BaseRMTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        dispositionActionDefinitionPublishExecutor =
                applicationContext.getBean(DispositionActionDefinitionPublishExecutor.class);
    ...
    public void testUpdatePeriod() {
        test().given(
                        () -> {
                            ...
                            // Create a disposition schedule for the category (Cut off immediately,
                            // then Destroy 1 year after the creation date).
                            DispositionSchedule dispSched =
                                    utils.createBasicDispositionSchedule(
                                            category, "instructions", "authority", true, false);
                            Map<QName, Serializable> cutOffParams =
                                    ImmutableMap.of(
                            ...
                            dispositionService.addDispositionActionDefinition(
                                    dispSched, cutOffParams);
                            Map<QName, Serializable> destroyParams =
                                    ImmutableMap.of(
                                            PROP_DISPOSITION_ACTION_NAME,
                                            DestroyAction.NAME,
                                            PROP_DISPOSITION_DESCRIPTION,
                            ...
                            originalAsOfDate =
                                    dispositionService
                                            .getNextDispositionAction(record)
                                            .getAsOfDate();
                        })
                .when(
                        () -> {
                            ...
                            DispositionSchedule dispSched =
                                    dispositionService.getDispositionSchedule(category);
                            DispositionActionDefinition destroy =
                                    dispSched.getDispositionActionDefinitionByName(
                                            DestroyAction.NAME);
                            Map<QName, Serializable> destroyParams =
                                    ImmutableMap.of(
                                            PROP_DISPOSITION_ACTION_NAME,
                        ...
                        () ->
                                aboutTwoYearsApart(
                                        ...
                                        dispositionService
                                                ...
                                                .getAsOfDate()))
                .because(
                        "Increasing the destroy period by two years should increase the 'as of'"
                                + " date by two years.");
    }
     ...
     *
     * <p>This actually just checks that they're more than one and less than three years apart,
     * because leap years make things hard to calculate.
     *
