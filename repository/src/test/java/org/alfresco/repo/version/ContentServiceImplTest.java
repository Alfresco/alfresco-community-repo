...
public class ContentServiceImplTest extends BaseVersionStoreTest {
  ...
  private static final String UPDATED_CONTENT =
    "This content has been updated with a new value.";
  ...
  public void before() throws Exception {
    ...
    this.contentStore =
      (ContentStore) ReflectionTestUtils.getField(contentService, "store");
  }
  ...
  public void testGetReader() {
    ...
    ContentReader contentReader2 =
      this.contentService.getReader(version2NodeRef, ContentModel.PROP_CONTENT);
  ...
  public void testWhenRequestContentDirectUrlIsNotSupported() {
    ...
    when(mockSystemWideDirectUrlConfig.getDefaultExpiryTimeInSec())
      .thenReturn(30L);
    when(mockSystemWideDirectUrlConfig.getMaxExpiryTimeInSec())
      .thenReturn(300L);
    ...
    try {
      ...
      NodeRef nodeRef =
        this.dbNodeService.createNode(
            ...
            QName.createQName("{test}MyNoContentNode"),
            TEST_TYPE_QNAME,
            this.nodeProperties
          )
          .getChildRef();
      ...
      assertNull(
        contentService.requestContentDirectUrl(nodeRef, true, validFor)
      );
