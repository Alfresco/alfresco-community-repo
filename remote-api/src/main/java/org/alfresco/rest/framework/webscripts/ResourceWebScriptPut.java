...
public class ResourceWebScriptPut
    ...
    switch (resourceMeta.getType()) {
      case ENTITY:
        if (StringUtils.isBlank(entityId)) {
          ...
          Object putEnt = extractJsonContent(
            req,
      ...
      case RELATIONSHIP:
        if (StringUtils.isBlank(relationshipId)) {
          ...
          Object putRel = extractJsonContent(
            req,
            assistant.getJsonHelper(),
            resourceMeta.getObjectType(operation)
          );
      ...
      case PROPERTY:
        final String resourceName = resourceVars.get(
        ...
        if (
          ...
          StringUtils.isNotBlank(resourceName)
        ) {
  ...
  public Object executeAction(
    ...
    switch (resource.getMetaData().getType()) {
      case ENTITY:
        if (
          EntityResourceAction.Update.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
            resource.getMetaData().isDeleted(EntityResourceAction.Update.class)
          ) {
          ...
          Object result = updateEnt.update(
            params.getEntityId(),
            params.getPassedIn(),
            params
          );
      ...
      case RELATIONSHIP:
        if (
          RelationshipResourceAction.UpdateWithResponse.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
          ...
          Object relResult = relationUpdater.update(
            params.getEntityId(),
            params.getPassedIn(),
            params,
            withResponse
          ...
          if (
            resource
              .getMetaData()
              .isDeleted(RelationshipResourceAction.Update.class)
          ) {
            throw new DeletedResourceException(
              "(UPDATE) " + resource.getMetaData().getUniqueId()
            );
      ...
      case PROPERTY:
        if (
          BinaryResourceAction.Update.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
            resource.getMetaData().isDeleted(BinaryResourceAction.Update.class)
          ) {
            throw new DeletedResourceException(
              "(UPDATE) " + resource.getMetaData().getUniqueId()
            );
        ...
        if (
          BinaryResourceAction.UpdateWithResponse.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
        ...
        if (
          RelationshipResourceBinaryAction.Update.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
        ...
        if (
          RelationshipResourceBinaryAction.UpdateWithResponse.class.isAssignableFrom(
              resource.getResource().getClass()
            )
        ) {
          if (
