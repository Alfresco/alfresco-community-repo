...
/**
 * Class to contain details regarding a lock. A lock is specific to a given qualified name. For any given lock, there may exist an <b>EXCLUSIVE</b> lock <u>or</u> several <b>SHARED</b> locks.
 * 
 * @author Derek Hulley
 * @since 3.2
 */
