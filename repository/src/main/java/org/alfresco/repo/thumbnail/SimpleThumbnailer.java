...
public class SimpleThumbnailer
  ...
  public void onContentUpdate(NodeRef nodeRef, boolean newContent) {
    if (
      !this.nodeService.getType(nodeRef).equals(ContentModel.TYPE_THUMBNAIL) &&
                ...
                new RetryingTransactionCallback<Object>() {
                  public Object execute() throws Throwable {
                    if (existingThumbnail == null) {
                      ...
                      SimpleThumbnailer.this.thumbnailService.createThumbnail(
                          nodeRef,
                          ContentModel.PROP_CONTENT,
                      ...
                      SimpleThumbnailer.this.thumbnailService.updateThumbnail(
                          existingThumbnail,
                          thumbnailDefinition.getTransformationOptions()
                        );
                    }
  ...
  private Set<NodeRef> getPostTxnNodesToThumbnail() {
    ...
    Set<NodeRef> nodesToThumbnail = (Set<NodeRef>) AlfrescoTransactionSupport.getResource(
      SimpleThumbnailer.KEY_POST_TXN_NODES_TO_THUMBNAIL
    );
