...
public class TemplateServiceImpl implements TemplateService {
  ...
  private Map<String, TemplateProcessor> processors = new HashMap<String, TemplateProcessor>(
    5
  );
  private Map<String, String> processorNamesByExtension = new HashMap<String, String>(
    5
  );
  ...
  public void registerTemplateProcessor(TemplateProcessor templateProcessor) {
    ...
    this.processorNamesByExtension.put(
        templateProcessor.getExtension(),
        templateProcessor.getName()
      );
  }
  ...
  private String getTemplateProcessorName(String template) {
    ...
    try {
      ...
      String templateName = (String) this.nodeService.getProperty(
          templateNodeRef,
