...
/**
 * Parent class of Canned Query Entities which are a {@link NodeEntity} with additional properties
 *
 * @author Nick Burch
 * @since 4.0
 */
public class NodeWithTargetsEntity extends NodeBackedEntity {
    ...
    /** Query constructor */
    public NodeWithTargetsEntity(
            Long parentNodeId, Long nameQNameId, Long contentTypeQNameId, Long assocTypeId) {
