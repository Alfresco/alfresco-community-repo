...
public class IntegrationWithAosTests extends IntegrationTest {
    ...
    @TestRail(
            ...
            description =
                    "Security check for AOS Protocol with External Authentification - MNT-17474")
    public void aosCSRFVulnerabilityInSSOEnvironment() throws Exception {
        ...
        String authCookie =
                String.format("%s:%s", adminUser.getUsername(), adminUser.getPassword());
        ...
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST, postBody.toString(), "_vti_bin/_vti_aut/author.dll");
    ...
    public void nonDomainKerberosUserCanLoginSuccessfulInAos() throws Exception {
        ...
        RestHtmlResponse response =
                restAPI.authenticateUser(dataUser.getAdminUser()).processHtmlResponse(request);
        ...
        response.assertPathInHtmlBodyEquals(
                "html.body.table.tr[2].td[0].text()", "Imap Attachments");
    }
    ...
    public void nonDomainKerberosUserCanLoginSuccessfulInWebDav() throws Exception {
        ...
        restAPI.assertStatusCodeIs(HttpStatus.OK);
        response.assertPathInHtmlBodyEquals(
                "html.body.table.tr.td[0].text()", "Directory listing for /");
        response.assertPathInHtmlBodyEquals(
                "html.body.table.tr.td.find{it.@class=='textData'}[0].text()", "Shared");
    }
}
