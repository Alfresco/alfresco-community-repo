...
public class ScriptPagingDetails extends PagingRequest {
   ...
   */
  public ScriptPagingDetails(WebScriptRequest req, int maxResultCount)
   ...
   * @param maxResultCount The maximum results count if none is specified
   */
  public static PagingRequest buildPagingRequest(
    ...
    if (pageSizeS != null) {
      try {
        ...
        throw new WebScriptException(
          ...
          "Paging size parameters invalid"
        );
      }
    }
    ...
    paging.setRequestTotalCountMax(
      Math.max(10 * pageSize, startIndex + 2 * pageSize)
    );
