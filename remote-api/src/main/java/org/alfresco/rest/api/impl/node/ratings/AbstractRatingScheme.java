...
public abstract class AbstractRatingScheme
  implements RatingScheme, InitializingBean {
  ...
  public void setNodeRatingSchemeRegistry(
    NamedObjectRegistry<RatingScheme> nodeRatingSchemeRegistry
  ) {
  ...
  protected abstract DocumentRatingSummary getDocumentRatingSummary(
    NodeRef nodeRef
  );
  ...
  public NodeRating getNodeRating(NodeRef nodeRef) {
    Rating ratingByCurrentUser = ratingService.getRatingByCurrentUser(
      nodeRef,
      ratingSchemeName
    );
    Float rating = null;
    ...
    DocumentRatingSummary documentRatingSummary = getDocumentRatingSummary(
      nodeRef
    );
