 ...
 *
 * <p>Provides access to invitations from outside the context of a web project or a web site
 *
 * @author Mark Rogers
 */
public class ScriptInvitationService extends BaseScopableProcessorExtension
     ...
     *
     * <p>By default, if no "resultsLimit" property is specified in the props argument, this method
     * will return a maximum of DEFAULT_MAX_LIST_INVITATIONS_RETURN_SIZE (200) results
     *
