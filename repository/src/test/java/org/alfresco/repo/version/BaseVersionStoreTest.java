...
public abstract class BaseVersionStoreTest extends BaseSpringTest {
  ...
  protected static final QName TEST_TYPE_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "testtype"
  );
  protected static final QName TEST_TYPE_WITH_MANDATORY_ASPECT_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "contentWithMandatoryAspect"
  );
  protected static final QName TEST_MANDATORY_ASPECT_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "mandatoryAspect"
  );
  protected static final QName TEST_MARKER_ASPECT_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "markerAspect"
  );
  protected static final QName TEST_ASPECT_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "testaspect"
  );
  protected static final QName PROP_1 = QName.createQName(
    TEST_NAMESPACE,
    "prop1"
  );
  protected static final QName PROP_2 = QName.createQName(
    TEST_NAMESPACE,
    "prop2"
  );
  protected static final QName PROP_3 = QName.createQName(
    TEST_NAMESPACE,
    "prop3"
  );
  protected static final QName MULTI_PROP = QName.createQName(
    TEST_NAMESPACE,
    "multiProp"
  );
  ...
  protected static final QName TEST_CHILD_ASSOC_1 = QName.createQName(
    TEST_NAMESPACE,
    "childassoc1"
  );
  protected static final QName TEST_CHILD_ASSOC_2 = QName.createQName(
    TEST_NAMESPACE,
    "childassoc2"
  );
  protected static final QName TEST_ASSOC = QName.createQName(
    TEST_NAMESPACE,
    "assoc1"
  );
  protected static final QName TEST_ATS_PARENT_TYPE_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "atsParent"
  );
  protected static final QName TEST_ATS_CHILD_TYPE_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "atsChild"
  );
  protected static final QName TEST_ATS_RELATED_CHILDREN_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "atsRelatedChildren"
  );
  protected static final QName PROP_ATS_PARENT_ID = QName.createQName(
    TEST_NAMESPACE,
    "atsParentID"
  );
  protected static final QName PROP_ATS_CHILD_ID = QName.createQName(
    TEST_NAMESPACE,
    "atsChildID"
  );
  ...
  protected static final QName MLTEXT_PROP = QName.createQName(
    TEST_NAMESPACE,
    "propMl"
  );
  ...
  protected static final String TEST_CONTENT =
    "This is the versioned test content.";
  ...
  public void before() throws Exception {
    ...
    this.dbNodeService =
      (NodeService) applicationContext.getBean("dbNodeService");
    this.contentService =
    ...
    this.policyBehaviourFilter =
      (BehaviourFilter) this.applicationContext.getBean(
    ...
    this.nodeProperties.put(
        ...
        new ContentData(null, "text/plain", 0L, "UTF-8")
      );
    ...
    StoreArchiveMap archiveMap = (StoreArchiveMap) applicationContext.getBean(
      "storeArchiveMap"
    );
  ...
  private void createTestModel() {
    ...
    bootstrapModels.add(
      "org/alfresco/repo/version/VersionStoreBaseTest_model.xml"
    );
  ...
  protected Version createVersion(
    ...
    String nextVersionLabel = peekNextVersionLabel(
      versionableNode,
      versionProperties
    );
  ...
  protected Collection<Version> createVersion(
    ...
    Collection<Version> versions = versionService.createVersion(
      versionableNode,
      this.versionProperties,
      versionChildren
    );
  ...
  protected String peekNextVersionLabel(
    ...
    return policy.calculateVersionLabel(
  ...
  protected void checkVersion(
    ...
    assertNotNull(
      "The version properties collection should not be null.",
      props
    );
