...
/** @author andyh */
public class LuceneDescendant<Q, S, E extends Throwable> extends Descendant
    ...
    private StoreRef getStore(QueryBuilderContext<Q, S, E> luceneContext) {
        ArrayList<StoreRef> stores =
                luceneContext.getLuceneQueryParserAdaptor().getSearchParameters().getStores();
        if (stores.size() < 1) {
            // default
