...
/**
 * A {@link CannedQueryFactory} for various queries relating to getting {@link NodeBackedEntity}
 * entires filtering by auditable properties.
 *
 * @author Nick Burch
 * @since 4.0
 */
public class GetChildrenAuditableCannedQueryFactory
        extends AbstractQNameAwareCannedQueryFactory<NodeBackedEntity> {
    @Override
    ...
    public CannedQuery<NodeBackedEntity> getCannedQuery(CannedQueryParameters parameters) {
        final GetChildrenAuditableCannedQuery cq =
                new GetChildrenAuditableCannedQuery(cannedQueryDAO, methodSecurity, parameters);

        return (CannedQuery<NodeBackedEntity>) cq;
    }

    public CannedQuery<NodeBackedEntity> getCannedQuery(
        ...
        GetChildrenAuditableCannedQueryParams paramBean =
                new GetChildrenAuditableCannedQueryParams(
