...
public abstract class AbstractClassGet extends DictionaryWebServiceBase {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status) {
        ...
        propdef.put(
                classQname, this.dictionaryservice.getClass(classQname).getProperties().values());
        assocdef.put(
                classQname, this.dictionaryservice.getClass(classQname).getAssociations().values());
