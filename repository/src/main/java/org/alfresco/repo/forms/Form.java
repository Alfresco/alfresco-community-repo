...
public class Form {
     ...
     *
     * <p>NOTE: Multiple fields with the same name can be added to the list, it is therefore the
     * form processor and the client of the FormService responsibility to differentiate the fields
     * in some way i.e. by type, property vs. association.
     *
    ...
    /**
     * Sets the collection of FieldGroup objects representing the groups of fields the form should
     ...
     *
     * @return FormData object holding the data of the form or null if there is no data i.e. for a
     *     create form
     */
    ...
    /**
     * Returns <code>true</code> if the Form contains {@link FieldData} for the specified <code>
     * dataKey</code>.
     *
    ...
    /**
     * Adds a {@link Collection} of {@link Field Fields} to the form by adding the {@link
     * FieldDefinition FieldDefinitions} and the values if any.
     */
