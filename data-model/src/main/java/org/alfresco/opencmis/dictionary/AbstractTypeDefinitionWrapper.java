...
public abstract class AbstractTypeDefinitionWrapper implements TypeDefinitionWrapper, Serializable {
    ...
    protected Map<String, PropertyDefinitionWrapper> propertiesById =
            new HashMap<String, PropertyDefinitionWrapper>();
    ...
    protected Map<QName, PropertyDefinitionWrapper> propertiesByQName =
            new HashMap<QName, PropertyDefinitionWrapper>();
    ...
    protected void setTypeDefinition(
            AbstractTypeDefinition typeDef, AbstractTypeDefinition typeDefInclProperties) {
    ...
    public void updateTypeDefInclProperties() {
        for (PropertyDefinition<?> property :
                typeDefInclProperties.getPropertyDefinitions().values()) {
    ...
    public void assertComplete() {
        ...
        if (alfrescoName == null) throw new IllegalStateException("alfrescoName is not set");
        if (alfrescoClass == null) throw new IllegalStateException("alfrescoClass is not set");
        if (propertiesById == null) throw new IllegalStateException("propertiesById is not set");
    ...
    protected void createOwningPropertyDefinitions(
        ...
        for (org.alfresco.service.cmr.dictionary.PropertyDefinition alfrescoPropDef :
                cmisClassDef.getProperties().values()) {
            if (!isBaseType()) {
            ...
            if (propertyId.equals("cmis:secondaryObjectTypeIds")
                    ...
                    if (propertyAccessor == null) {
                        propertyAccessor =
                                propertyAccessorMapping.createDirectPropertyAccessor(
                                        propertyId, alfrescoPropDef.getName());
                    }
                }
    ...
    protected void registerProperty(PropertyDefinitionWrapper propDefWrapper) {
        ...
        propertiesByQueryName.put(
                propDefWrapper.getPropertyDefinition().getQueryName(), propDefWrapper);
        ...
        if (result instanceof PropertyIntegerDefinitionImpl) {
            if (propDef.getDataType().getName().equals(DataTypeDefinition.INT)) {
                ((PropertyIntegerDefinitionImpl) result)
                        .setMinValue(BigInteger.valueOf(Integer.MIN_VALUE));
                ((PropertyIntegerDefinitionImpl) result)
                        .setMaxValue(BigInteger.valueOf(Integer.MAX_VALUE));
            }
            if (propDef.getDataType().getName().equals(DataTypeDefinition.LONG)) {
                ((PropertyIntegerDefinitionImpl) result)
                        .setMinValue(BigInteger.valueOf(Long.MIN_VALUE));
                ((PropertyIntegerDefinitionImpl) result)
                        .setMaxValue(BigInteger.valueOf(Long.MAX_VALUE));
            }
        }
        // end MNT-9089
        ...
        for (ConstraintDefinition constraintDef : propDef.getConstraints()) {
            ...
            if ((constraint instanceof StringLengthConstraint)
                ...
                ((PropertyStringDefinitionImpl) result)
                        .setMaxLength(BigInteger.valueOf(slc.getMaxLength()));
            }
            ...
            if (constraint instanceof NumericRangeConstraint) {
                ...
                if (result instanceof PropertyDecimalDefinitionImpl) {
                    ((PropertyDecimalDefinitionImpl) result)
                            .setMinValue(BigDecimal.valueOf(nrc.getMinValue()));
                    ((PropertyDecimalDefinitionImpl) result)
                            .setMaxValue(BigDecimal.valueOf(nrc.getMaxValue()));
                }
            }
        }
    ...
    protected void createActionEvaluators(
            PropertyAccessorMapping propertyAccessorMapping, BaseTypeId baseTypeId) {
        if (propertyAccessorMapping != null) {
    ...
    private void addDefaultValue(String value, PropertyDefinition<?> propDef) {
        ...
        if (propDef instanceof PropertyBooleanDefinitionImpl) {
            ...
            propDefImpl.setDefaultValue(
                    Collections.singletonList(
                            (GregorianCalendar)
                                    convertValueFromString(value, PropertyType.DATETIME)));
        ...
        if (propDef instanceof PropertyBooleanDefinitionImpl) {
            ...
            for (String allowed : lovc.getAllowedValues()) {
                ...
                choice.setValue(
                        Collections.singletonList(
                                (GregorianCalendar)
                                        convertValueFromString(allowed, PropertyType.DATETIME)));
            ...
            for (String allowed : lovc.getAllowedValues()) {
                ...
                choice.setValue(
                        Collections.singletonList(
                                (BigDecimal)
                                        convertValueFromString(allowed, PropertyType.DECIMAL)));
            ...
            for (String allowed : lovc.getAllowedValues()) {
                ...
                choice.setValue(
                        Collections.singletonList(
                                (BigInteger)
                                        convertValueFromString(allowed, PropertyType.INTEGER)));
