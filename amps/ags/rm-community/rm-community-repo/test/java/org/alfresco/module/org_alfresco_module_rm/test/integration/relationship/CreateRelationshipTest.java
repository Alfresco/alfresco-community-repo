        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(AccessDeniedException.class) {
                    ...
                    public void given() throws Exception {
                        ...
                        capabilities.add(
                                capabilityService.getCapability("ChangeOrDeleteReferences"));
                    ...
                    public void when() {
                        ...
                        filePlanPermissionService.setPermission(
                                sourceRecord, user, RMPermissionModel.READ_RECORDS);
                        filePlanPermissionService.setPermission(
                                targetRecord, user, RMPermissionModel.FILING);

                        AuthenticationUtil.runAs(
                                new AuthenticationUtil.RunAsWork<Void>() {
                                    public Void doWork() throws Exception {
                                        relationshipService.addRelationship(
                                                "crossreference", sourceRecord, targetRecord);
                                        return null;
                                    }
                                },
                                user);
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(AccessDeniedException.class) {
                    ...
                    public void when() {
                        // assign permissions
                        filePlanPermissionService.setPermission(
                                sourceRecord, user, RMPermissionModel.FILING);
                        filePlanPermissionService.setPermission(
                                targetRecord, user, RMPermissionModel.READ_RECORDS);
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void when() {
                        // assign permissions
                        filePlanPermissionService.setPermission(
                                sourceRecordCategory, user, RMPermissionModel.FILING);
                        filePlanPermissionService.setPermission(
                                targetRecordCategory, user, RMPermissionModel.FILING);
                    ...
                    public void then() throws Exception {
                        ...
                        assertEquals(
                                1, relationshipService.getRelationshipsFrom(sourceRecord).size());
                        assertEquals(
                                0, relationshipService.getRelationshipsTo(sourceRecord).size());
                        assertEquals(
                                0, relationshipService.getRelationshipsFrom(targetRecord).size());
                        assertEquals(
                                1, relationshipService.getRelationshipsTo(targetRecord).size());
                    }
                });
    }
}
