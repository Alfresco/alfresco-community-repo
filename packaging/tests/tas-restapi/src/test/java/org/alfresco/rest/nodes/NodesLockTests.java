...
public class NodesLockTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify Collaborator can not lock PERSISTENT after EPHEMERAL lock made by"
                            + " different user")
    public void lockEphemeralAndRelockPersistentDifferentUser() throws Exception {
        ...
        STEP(
                "3. Lock the file using mode EPHEMERAL for 20 seconds with user1 (POST"
                        + " nodes/{nodeId}/lock).");
        ...
        STEP(
                "5. Cannot lock the file using mode PERSISTENT with user2 while the file is still"
                        + " locked");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can not lock EPHEMERAL after EPHEMERAL lock made by"
                            + " different user")
    public void lockEphemeralAndRelockEphemeralDifferentUser() throws Exception {
        ...
        STEP(
                "5. Cannot lock the file using mode EPHEMERAL with user2 while the file is still"
                        + " locked");
        RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock EPHEMERAL after EPHEMERAL lock made by same user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock PERSISTENT after EPHEMERAL lock made by same"
                            + " user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can not lock EPHEMERAL after PERSISTENT lock made by"
                            + " different user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can not lock PERSISTENT after PERSISTENT lock made by"
                            + " different user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock EPHEMERAL after PERSISTENT lock made by different"
                            + " user is expired")
    ...
    //  TODO: uncomment this:  @Bug(id = "MNT-17612", status = Status.FIXED, description =
    // "AccessDeniedException in AOS Edit Offline Upload New Version")
    @Bug(id = "REPO-4790")
    @Test(groups = {TestGroup.REST_API, TestGroup.NODES, TestGroup.REGRESSION})
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.NODES},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock PERSISTENT after EPHEMERAL lock made by another"
                            + " user is expired")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock EPHEMERAL after EPHEMERAL lock made by another"
                            + " user is expired")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock PERSISTENT after PERSISTENT lock made by"
                            + " different user is expired")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock PERSISTENT after PERSISTENT lock made by same"
                            + " user is expired")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock EPHEMERAL after PERSISTENT lock made by same user"
                            + " is expired")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock PERSISTENT after EPHEMERAL lock made by same user"
                            + " is expired")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator can lock EPHERMERAL after PERSISTENT lock made by same"
                            + " user")
    ...
    public void testLockUnlockParentChild() throws Exception {
        ...
        FolderModel parentNode =
                dataContent.usingUser(adminUser).usingSite(siteLock).createFolder();
        FileModel childNode1 =
                dataContent
                        .usingUser(adminUser)
                        .usingSite(siteLock)
                        .usingResource(parentNode)
                        .createContent(DocumentType.TEXT_PLAIN);
        FileModel childNode2 =
                dataContent
                        .usingUser(adminUser)
                        .usingSite(siteLock)
                        .usingResource(parentNode)
        ...
        STEP("2. Verify with admin that the file is not locked.");
        RestNodeModel restNodeResponse =
                restClient
                        .authenticateUser(adminUser)
                        .withCoreAPI()
        ...
        STEP(
                "3. Lock  childNode1 using mode PERSISTENT with adminUser (POST"
                        + " nodes/{nodeId}/lock).");
        RestNodeLockBodyModel lockBodyModel = new RestNodeLockBodyModel();
        lockBodyModel.setLifetime("PERSISTENT");
        ...
        Utility.sleep(
                ...
                () -> {
                    ...
                    restClient.assertStatusCodeIs(HttpStatus.OK);
                    response.assertThat()
                            .entriesListDoesNotContain("id", childNode1.getNodeRefWithoutVersion());
                    response.assertThat()
                            .entriesListDoesNotContain("id", childNode2.getNodeRefWithoutVersion());
                });
    }
