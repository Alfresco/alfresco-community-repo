...
public interface ActivityPostDAO extends ActivitiesDAO {
    ...
    public List<ActivityPostEntity> selectPosts(ActivityPostEntity activityPost, int maxItems)
            throws SQLException;
    ...
    public int updatePost(
            long id, String network, String activityData, ActivityPostEntity.STATUS status)
            throws SQLException;
