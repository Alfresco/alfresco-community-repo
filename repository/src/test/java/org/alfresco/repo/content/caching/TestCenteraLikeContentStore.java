...
public class TestCenteraLikeContentStore extends FileContentStore {
  ...
  public TestCenteraLikeContentStore(
  ...
  public ContentWriter getWriterInternal(
    ...
    FileContentWriter fileContentWriter = (FileContentWriter) super.getWriterInternal(
      existingContentReader,
      newContentUrl
    );

    return new TestCenteraLikeContentWriter(
      fileContentWriter.getFile(),
      fileContentWriter.getContentUrl(),
      existingContentReader
    );
  }
}
