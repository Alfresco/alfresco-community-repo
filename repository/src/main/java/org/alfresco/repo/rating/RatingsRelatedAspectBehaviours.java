...
public class RatingsRelatedAspectBehaviours implements CopyServicePolicies.OnCopyNodePolicy {
    ...
    /**
     * This method returns the default list of ratings-related aspects which should not be copied
     * when a rated node is copied.
     *
    ...
    private static class RatingRelatedAspectsCopyBehaviourCallback
        ...
        private static final CopyBehaviourCallback INSTANCE =
                new RatingRelatedAspectsCopyBehaviourCallback();
