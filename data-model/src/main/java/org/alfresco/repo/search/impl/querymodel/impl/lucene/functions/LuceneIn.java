...
/** @author andyh */
public class LuceneIn<Q, S, E extends Throwable> extends In
    ...
    public Q addComponent(
        ...
        String modeString =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, modeArgument.getValue(functionContext));
        ...
        Q query =
                functionContext.buildLuceneIn(
                        lqpa, propertyArgument.getPropertyName(), collection, not, mode);
