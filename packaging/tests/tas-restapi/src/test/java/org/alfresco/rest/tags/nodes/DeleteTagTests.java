...
public class DeleteTagTests extends TagsDataPrep {
    ...
    public void adminIsAbleToDeleteTags() throws Exception {
        ...
        restClient
                ...
                .getNodeTags()
                .assertThat()
                .entriesListDoesNotContain("tag", tag.getTag());
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify Manager user deletes tags created by admin user with Rest API and"
                            + " status code is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator user deletes tags created by admin user with Rest API and"
                            + " status code is 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user can't delete tags created by admin user with Rest API"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user deletes tags created by him with Rest API and status"
                            + " code is 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user can't delete tags created by admin user with Rest API and"
                            + " status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that if user has no permission to remove tag returned status code is"
                            + " 403. Check default error model schema")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TAGS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify Manager user can't delete deleted tag.")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    @Bug(id = "ACE-5455")
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TAGS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify Collaborator user can delete long tag.")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TAGS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify Manager user can delete short tag.")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TAGS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify Admin can delete tag then add it again.")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TAGS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify Manager user can delete tag added by another user.")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    public void managerCanDeleteTagAddedByAnotherUser() throws Exception {
        tag =
                restClient
                        ...
                        .withCoreAPI()
                        .usingResource(document)
                        .addTag(RandomStringUtils.randomAlphanumeric(10));
