...
public class IntegrationCoreTests extends IntegrationTest {
    ...
    /**
     * Scenario 22 1. Using CMIS create 2 test users: u1 and u2 2. U1 creates a public test site and
     * U2 a public test site using CMIS 3. U1 creates a folder with a file in his public site's
     * document library using WebDav 4. U1 tries to move his folder to U2 public site using IMAP 5.
     * Verify folder with file is not moved. U1 is not authorized to access the public site
     */
    @Test(
            groups = {TestGroup.INTEGRATION, TestGroup.CORE},
            expectedExceptions = FolderNotFoundException.class)
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to move a folder with a file to a public site if he is"
    ...
    public void moveFolderWithFileToPublicSiteByUninvitedUser() throws Exception {
        ...
        webDavProtocol
                .authenticateUser(testUser1)
                .usingSite(testSitePublic)
        ...
        STEP(
                "4. U1 tries to move his folder to U2 public site using IMAP. 5. Verify folder with"
                        + " file is not moved. U1 is not authorized to access the U2 public site");
        FolderModel destination =
                new FolderModel(
                        Utility.buildPath("Sites", secondPublicSite.getId(), "documentLibrary"));
        destination.setProtocolLocation(
                imapProtocol
                        .authenticateUser(testUser2)
                        .usingSite(secondPublicSite)
    ...
    /**
     * Scenario 23 1. Using CMIS create 1 test user: u1 2. U1 creates a public test site 3. U1
     * creates a folder (parentFolder) inside public site's document library using WebDav 4. Inside
     * parentFolder create 4 files using CMIS, WebDAV, FTP 5. Inside parentFolder create 1 subfolder
     * using IMAP 6. Delete parentFolder using CMIS 7. Verify folder is deleted along with all its
     * children
     */
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to delete parent folder along with all its children using"
                            + " CMIS.")
    public void deleteFolderWithChildrenUsingCMIS() throws Exception {
        ...
        STEP(
                "3. U1 creates a folder (parentFolder) inside public site's document library using"
                        + " WebDav");
        ...
        STEP(
                "6. Delete parentFolder using CMIS 7. Verify folder is deleted along with all its"
                        + " children");
        cmisAPI.usingResource(parentFolder)
                .deleteFolderTree()
                .and()
                .assertThat()
                .doesNotExistInRepo()
                ...
                .assertThat()
                .doesNotExistInRepo()
                .usingResource(testFile4)
                .assertThat()
                .doesNotExistInRepo();
    }

    /**
     * Scenario 24 1. Using CMIS create 1 test user: u1 2. U1 creates a public test site 3. U1
     * creates a folder (parentFolder) inside public site's document library using IMAP 4. Inside
     * parentFolder create 4 files using CMIS, WebDAV, FTP 5. Inside parentFolder create 1 subfolder
     * using WebDAV 6. Delete parentFolder using WebDAV
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
    ...
    public void deleteFolderWithChildrenUsingWebDAV() throws Exception {
        ...
        STEP(
                "6. Delete parentFolder using WebDAV 7. Verify folder is deleted along with all its"
                        + " children");
        webDavProtocol
                .usingResource(parentFolder)
                .delete()
    ...
    /**
     * Scenario 25 1. Using CMIS create 2 test users: u1 and u2 2. U1 creates a public test site and
     * adds u2 as manager to his site using CMIS 3. U1 creates a folder (parentFolder) inside public
     * site's document library using CMIS 4. U1 creates a subfolder1 and a file1 inside parentFolder
     * using FTP 5. U1 creates a subfolder2 and a file2 inside subfolder1 using CMIS 6. U2 creates a
     * subfolder3 and a file3 using WebDAV 7. U2 deletes parentFolder using FTP 8. Verify folder is
     * deleted along with all its children
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
    ...
    public void deleteFolderWithChildrenUsingFTP() throws Exception {
        ...
        STEP(
                "2. U1 creates a public test site using CMIS and adds u2 as manager to his site"
                        + " using REST");
        testSitePublic = dataSite.usingUser(testUser1).createPublicRandomSite();
        dataUser.usingUser(testUser1)
                .addUserToSite(testUser2, testSitePublic, UserRole.SiteManager);
    ...
    /**
     * Scenario 28 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a public test
     * site 3. Using CMIS, WebDAV and FTP U1 creates multiple files and folders in parent folder 4.
     * Using CMIS, U1 checks out a document from parent folder 5. Using CMIS, U1 deletes parent
     * folder (deleteTree) 6. Using WebDAV, U1 verifies that parent folder and all children are NOT
     * present in Repo and WebDAV
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify deletion of a parentFolder with checkedout file using CMIS.")
    public void deleteParentFolderWithCheckoutFileInUsingCMIS() throws Exception {
        ...
        STEP(
                "3. Using CMIS, WebDAV and FTP U1 creates multiple files and folders in parent"
                        + " folder");
        FileModel cmisTestFile =
                FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file 1 content");
        ...
        cmisAPI.authenticateUser(testUser1)
                .usingResource(testFolder1)
                .createFile(cmisTestFile)
                .assertThat()
                .existsInRepo();
        webDavProtocol
                .authenticateUser(testUser1)
                .usingResource(testFolder1)
                .createFile(webdavTestFile)
                .assertThat()
                .existsInWebdav()
                .assertThat()
                .existsInRepo();
        ...
        cmisAPI.usingResource(testFolder1).createFolder(cmisTestFolder).assertThat().existsInRepo();
        webDavProtocol
                .usingResource(testFolder1)
                .createFolder(webdavTestFolder)
                .assertThat()
                .existsInWebdav()
                .assertThat()
                .existsInRepo();
        ftpProtocol
                .usingResource(testFolder1)
                .createFolder(ftpTestFolder)
                .assertThat()
                .existsInFtp()
                .assertThat()
                .existsInRepo();

        cmisAPI.usingResource(testFolder1)
                .assertThat()
                .hasChildren(
                        cmisTestFile,
                        webdavTestFile,
        ...
        cmisAPI.usingResource(testFolder1).deleteFolderTree().assertThat().doesNotExistInRepo();
        STEP(
                "Step 6. Using WebDAV, U1 verifies that parent folder and all children are not"
                        + " present");
        webDavProtocol
                .usingResource(testFolder1)
                .assertThat()
                ...
                .and()
                .usingResource(cmisTestFile)
                .assertThat()
                .doesNotExistInRepo()
                .assertThat()
                .doesNotExistInWebdav()
                .and()
                .usingResource(webdavTestFile)
                .assertThat()
                .doesNotExistInRepo()
                .assertThat()
                .doesNotExistInWebdav()
                .and()
                .usingResource(ftpTestFile)
                .assertThat()
                .doesNotExistInRepo()
                .assertThat()
                .doesNotExistInWebdav()
                .and()
                .usingResource(cmisTestFolder)
                .assertThat()
                .doesNotExistInRepo()
                .assertThat()
                .doesNotExistInWebdav()
                .and()
                .usingResource(webdavTestFolder)
                .assertThat()
                .doesNotExistInRepo()
                .assertThat()
                .doesNotExistInWebdav()
                .and()
                .usingResource(ftpTestFolder)
                .assertThat()
                .doesNotExistInRepo()
                .assertThat()
                .doesNotExistInWebdav();
    ...
    /**
     * Scenario 29 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a public test
     * site 3. Using FTP U1 creates a parent folder in public site's document library 4. Using CMIS,
     * WebDAV and FTP U1 creates multiple files and folders in parent folder 5. Using CMIS, U1
     * checks out a document from parent folder 6. Using WebDAV, U1 deletes parent folder
     * (deleteFolder) 7. Using FTP, U1 verifies that parent folder and all children are NOT present
     * in Repo and FTP
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify deletion of a parentFolder with checkedout file using WebDAV.")
    public void deleteParentFolderWithCheckoutFileInUsingWebDAV() throws Exception {
        ...
        STEP(
                "4. Using CMIS, WebDAV and FTP U1 creates multiple files and folders in parent"
                        + " folder");
        FileModel cmisTestFile =
                FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file 1 content");
        FileModel webdavTestFile = FileModel.getRandomFileModel(FileType.HTML, "file 2 content");
        ...
        webDavProtocol
                ...
                .and()
                .assertThat()
                .hasFiles(cmisTestFile, webdavTestFile, ftpTestFile)
                .and()
                .assertThat()
                .hasFolders(cmisTestFolder, webdavTestFolder)
                .then()
                .usingResource(testFolder1)
                .delete()
                .assertThat()
    ...
    /**
     * Scenario 30 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a public test
     * site 3. Using WebDAV U1 creates a parent folder in public site's document library 4. Using
     * CMIS, WebDAV and FTP U1 creates multiple files and folders in parent folder 5. Using CMIS, U1
     * checks out a document from parent folder 6. Using FTP, U1 deletes parent folder
     * (deleteDirectory)
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify deletion of a parentFolder with checkedout file using FTP.")
     ...
     *
     * <p>1. Using CMIS create 2 test users: U1 and U2 2. Using CMIS and RestAPI U1 creates a public
     * test site and U2 user is added with collaborator role 3. Using WebDAV U1 creates a folder in
     * his public site's document library 4. Using WebDAV U1 creates a document inside the above
     * folder 5. Using RestAPI U2 adds the document to favorites 6. Using CMIS U1 adds content to
     * document 7. Using WebDAV U2 validates document's content 8. Using WebDAV U2 updates content
     * from document 9. Using CMIS U2 validates document's content 10. Using WebDAV U1 deletes the
     * file 11. Using RestAPI U1 deletes the folder
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with collaborator role can update document content in a public"
                            + " site.")
    public void usersCanUpdateDocumentContentInsideAPublicSite() throws Exception {
        ...
        STEP(
                "2. Using CMIS and RestAPI U1 creates a public test site and U2 user is added with"
                        + " collaborator role");
        testSitePublic = dataSite.usingUser(testUser1).createPublicRandomSite();
        ...
        restAPI.authenticateUser(testUser2)
                .withCoreAPI()
                .usingAuthUser()
                .addFolderToFavorites(testFolder1);
     ...
     *
     * <p>1. Using CMIS create 2 test users: U1 and U2 2. Using RestAPI U1 creates a public test
     * site and U2 user is added with contributor role 3. Using WebDAV U1 creates a folder in his
     * public site's document library 4. Using WebDAV U1 creates a document1 inside the above folder
     * 5. Using WebDAV U2 creates a document2 inside folder 6. Using RestAPI U2 likes document1 7.
     * Using RestAPI U1 likes document2 8. Using RestAPI U1 dislikes document2 9. Using RestAPI U2
     * add to favorites document1 10. Using CMIS U1 delete document1 11. Using CMIS U2 delete the
     * folder
     */
    @Test(
            groups = {TestGroup.INTEGRATION, TestGroup.CORE},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with contributor role can like/favorite a document in a public"
                            + " site.")
    public void usersCanLikeADocumentInPublicSite() throws Exception {
        ...
        STEP(
                "2. Using RestAPI U1 creates a public test site and U2 user is added with"
                        + " contributor role");
        testSitePublic = dataSite.usingUser(testUser1).createPublicRandomSite();
        ...
        RestPersonFavoritesModel restPersonFavoritesModel =
                restAPI.authenticateUser(testUser2)
                        .withCoreAPI()
                        .usingAuthUser()
                        .addFileToFavorites(testFile1);
        restAPI.assertStatusCodeIs(HttpStatus.CREATED);

        restPersonFavoritesModel
                .assertThat()
                .field("targetGuid")
                .is(testFile1.getNodeRefWithoutVersion());
        ...
        restAPI.assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, testFile1.getNodeRef()));

        RestPersonFavoritesModelsCollection userFavorites =
        ...
        STEP(
                "11. Using CMIS U2 delete the folder. With Contributor role, U2 does not have"
                        + " permission to delete files/folders created by others.");
        cmisAPI.authenticateUser(testUser2)
                .usingResource(testFolder1)
                .assertThat()
                .doesNotHaveFile(testFile1)
                .and()
                .assertThat()
                .hasFiles(testFile2)
                .and()
     ...
     *
     * <p>1. Using CMIS create 2 test users: U1 and U2 2. Using RestAPI U1 creates a public test
     * site and U2 user is added with collaborator role 3. Using CMIS U1 creates a new folder in
     * site 4. Using WebDAV U2 creates file1 in public site document library 5. Using WebDAV U1
     * creates a file2 in public site document library 6. Using RestAPI U2 rates with 5 stars file2
     * 7. Using RestAPI U1 rates with 1 star file1 8. Using RestAPI U2 likes file1 9. Using RestAPI
     * U2 removes the rating of 5 stars for file2 10. Using WebDAV U1 delete file1. Using RestAPI
     * get ratings of file1. 11. Using WebDAV U1 delete the folder
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with collaborator role can rate a document in a public site.")
    ...
    /**
     * Scenario 35 1. Using CMIS create 2 test user: U1 and U2 2. Using CMIS U1 creates a public
     * test site 3. Using FTP U1 creates a folder in public site's document library: folder1 4.
     * Using WebDAV U1 creates inside folder1 a new folder: folder2 5. Using WebDAV U1 creates
     * inside folder2 a new folder: folder3 6. Using CMIS U1 creates inside folder1 a new file:
     * file1 7. Using WebDAV U1 creates inside folder2 a new file: file2 8. Using FTP U1 creates
     * inside folder3 a new file: file3 9. Using WebDAV U1 deletes file1 10. Using IMAP U1 deletes
     * file2 11. Using WebDAV U1 updates content of file3 12. Using RestAPI U1 adds a comment to
     * file3 13. Using RestAPI U1 likes file3 and user U2 rates file3 14. Using CMIS U1 deletes
     * file3
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "File handling - perform actions: create, delete, add comment, like and rate,"
                            + " update file content ")
    public void fileHandlingCreateUpdateContentDeleteLikeAndRate() throws Exception {
        ...
        file3.setNodeRef(
                dataContent
                        ...
                        .usingResource(file3)
                        .getNodeRef());
        RestCommentModel commentModel =
                restAPI.authenticateUser(testUser1)
                        .withCoreAPI()
                        .usingResource(file3)
                        .addComment(comment);
        restAPI.assertStatusCodeIs(HttpStatus.CREATED);
        commentModel.assertThat().field("content").isNotEmpty().and().field("content").is(comment);
    ...
    /**
     * Scenario 37 1. Using CMIS creates 2 users: U1 and U 2. U1 creates a public test site using
     * CMIS 3. Using CMIS U1 creates folder: folder1 4. Using WebDAV U1 creates folder2 and folder3
     * inside folder1 5. Using FTP U1 creates file1 inside folder1 6. Using CMIS U1 copies file1 to
     * folder2 7. Using WebDAV U1 update content of file1 from folder2 8. Using FTP U1 tries to move
     * file1 from folder2 to folder1 9. Using WebDAV U1 updates content of file1 from folder1 10.
     * Using RestAPI U1 adds file1 to favorites 11. Using RestAPI U1 likes file1 and U2 user rates
     * file1 12. Using CMIS U1 moves file1 from folder1 to folder3 13. Using CMIS/RestAPI U1 checks
     * that content, favorites and ratings are kept
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "File handling - perform actions: copy, move, add/update content, favorites,"
                            + " like and rate")
    public void fileHandlingCopyMoveAddUpdateContentFavoritesLikeAndRate() throws Exception {
        ...
        webDavProtocol
                .usingResource(file1)
                .update("content folder1")
                .assertThat()
                .contentIs("content folder1");
        ...
        cmisAPI.usingSite(testSitePublic)
                .usingResource(file1)
                .moveTo(folder3)
                .and()
                .assertThat()
    ...
    /**
     * Scenario 38 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a new document in
     * Share 3. Using WebDAV U1 creates a new document in User Home 4. Using WebDAV U1 updates both
     * documents 5. Verify if only first document's version is increased using CMIS 6. Verify if
     * content is updated using WebDav 7. Verify if the size of the document is increased
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify document versioning after appending content using WebDAV.")
    public void checkDocumentVersionAfterAppendingContent() throws Exception {
        ...
        FileModel webDAVTestFile =
                FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file 2 content");
        webDavProtocol
                .authenticateUser(testUser1)
                .usingUserHome()
                .createFile(webDAVTestFile)
        ...
        webDavProtocol
                .usingResource(cmisTestFile)
                .update("cmis file content")
                .usingResource(webDAVTestFile)
                .update("WebDAV file content");

        STEP("5. Verify if only first document's version is increased using CMIS");
        cmisAPI.usingResource(cmisTestFile)
                .assertThat()
                .documentHasVersion(1.1)
                .usingResource(webDAVTestFile)
                .assertThat()
                .documentHasVersion(1.0);
        ...
        webDavProtocol
                ...
                .usingResource(cmisTestFile)
                .assertThat()
                .contentIs("cmis file content")
                .usingResource(webDAVTestFile)
                .assertThat()
                .contentIs("WebDAV file content");
    ...
    /**
     * Scenario 40 1. Using CMIS create test user: U1 2. U1 creates a private test site using CMIS
     * 3. Using WebDAV U1 creates a folder 4. Using WebDAV U1 creates a file inside the folder 5.
     * Using CMIS, check out the document 6. Using CMIS verify if PWC is created 7. Using CMIS check
     * in document with content 8. Using CMIS verify that version does not increase 9. Using CMIS
     * verify new content is added to document
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify increased version and new content of a file that was check out then"
                            + " check in.")
    ...
    /**
     * Scenario 41 1. Using CMIS create test user: U1 2. U1 creates a private test site using CMIS
     * 3. Using WebDAV U1 creates a folder 4. Using WebDAV U1 creates a file inside the folder 5.
     * Using CMIS, check out the document 6. Using CMIS verify if PWC is created 7. Using CMIS,
     * cancel check out 8. Using CMIS, verify original document has version 1.0 9. Using CMIS,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that version and the content of a file are not changed if the checkout"
                            + " is canceled.")
    public void verifyVersionAndContentOfACanceledCheckoutDocument() throws Exception {
        ...
        cmisAPI.usingResource(file).cancelCheckOut().then().assertThat().documentIsNotCheckedOut();
    ...
    /**
     * Scenario 42 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a file: file 3.
     * Using WebDAV U1 renames file and verify if the new document exists 4. Using FTP verify old
    ...
    public void renameDocument() throws Exception {
        ...
        webDavProtocol
                .authenticateUser(testUser1)
                .usingResource(file)
                .rename(renamePrefix + file.getName())
                .and()
                .assertThat()
                .existsInRepo()
                .and()
    ...
    /**
     * Scenario 43 1. Using CMIS create test user: U1 2. Using WebDAV U1 creates a file using shared
     * 3. Using webDAV append content to document 4. Using CMIS, verify original document has
     * version 1.0 5. Using CMIS delete document 6. Using WebDAV, verify document is deleted
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
    ...
    public void deleteDocumentAfterAppendContent() throws Exception {
        ...
        webDavProtocol
                ...
                .usingResource(file)
                .assertThat()
                .contentIs("file content")
                .then()
                .update(file.getContent() + newContentToAppend)
                .assertThat()
                .contentIs(file.getContent() + newContentToAppend);
    ...
    /**
     * Scenario 44 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a public test
     * site 3. Using WebDAV U1 creates a new file in User Home 4. Using WebDAV U1 creates another
     * file in public site document library. 5. Using CMIS U1 creates a relationship between
     * documents 6. Verify if relationship is created
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify if relationship is created between 2 items using CMIS.")
    public void checkRelationshipBetween2Files() throws Exception {
        ...
        STEP(
                "5. Using CMIS U1 creates a relationship between documents. 6. Verify if"
                        + " relationship is created");
        cmisAPI.authenticateUser(testUser1)
                .usingResource(sourceFile)
                .createRelationshipWith(targetFile)
                .assertThat()
                .objectHasRelationshipWith(targetFile);
    }

    /**
     * Scenario 46 1. Using CMIS create one test user: U1 2. Using CMIS U1 creates an imap test site
     * 3. Using CMIS U1 creates cmisFolder in Shared 4. Using IMAP U1 creates parentFolder in
     * private site document library. 5. Using FTP U1 creates a subfolder in parentFolder 6. Using
     * WebDAV U1 creates a webdavFolder in User Home 7. Using WebDAV U1 creates a document in
     * parentFolder 8. Using CMIS U1 adds document to cmisFolder, subfolder, webdavFolder 9. Using
     * WebDAV verify document is present in all folders 10. Using CMIS U1 removes document from
     * subFolder 11. Using WebDAV verify document is not present in subFolder 12. Using FTP U1
     * deletes original document from parentFolder 13. Using CMIS verify document does not exist
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify parents list for an object using CMIS.")
    public void addAndRemoveDocumentFromFolders() throws Exception {
        ...
        cmisAPI.usingResource(testFile1)
                .addDocumentToFolder(cmisFolder, true)
                .assertThat()
                .hasParents(parentFolder.getName(), cmisFolder.getName())
                .addDocumentToFolder(subFolder, true)
                .assertThat()
                .hasParents(parentFolder.getName(), cmisFolder.getName(), subFolder.getName())
                .addDocumentToFolder(webdavFolder, true)
                .assertThat()
                .hasParents(
        ...
        FileModel fileAddedInCMISFolder =
                new FileModel(
                        testFile1.getName(),
                        testFile1.getTitle(),
                        testFile1.getDescription(),
                        testFile1.getFileType(),
                        testFile1.getContent());
        fileAddedInCMISFolder.setCmisLocation(
                Utility.buildPath(cmisFolder.getCmisLocation(), testFile1.getName()));

        FileModel fileAddedInSubFolder =
                new FileModel(
                        testFile1.getName(),
                        testFile1.getTitle(),
                        testFile1.getDescription(),
                        testFile1.getFileType(),
                        testFile1.getContent());
        fileAddedInSubFolder.setCmisLocation(
                Utility.buildPath(subFolder.getCmisLocation(), testFile1.getName()));

        FileModel fileAddedInWebDAVFolder =
                new FileModel(
                        testFile1.getName(),
                        testFile1.getTitle(),
                        testFile1.getDescription(),
                        testFile1.getFileType(),
                        testFile1.getContent());
        fileAddedInWebDAVFolder.setCmisLocation(
                Utility.buildPath(webdavFolder.getCmisLocation(), testFile1.getName()));

        webDavProtocol
                .usingResource(fileAddedInCMISFolder)
                .assertThat()
                .existsInWebdav()
                .usingResource(fileAddedInSubFolder)
                .assertThat()
                .existsInWebdav()
                .usingResource(fileAddedInWebDAVFolder)
                .assertThat()
                .existsInWebdav();

        STEP("10. Using CMIS U1 removes document from subFolder");
        cmisAPI.usingResource(testFile1)
                .removeDocumentFromFolder(subFolder)
                .assertThat()
                .hasParents(parentFolder.getName(), cmisFolder.getName(), webdavFolder.getName());
        ...
        cmisAPI.usingResource(fileAddedInCMISFolder)
                .assertThat()
                .doesNotExistInRepo()
                .usingResource(fileAddedInWebDAVFolder)
                .assertThat()
     ...
     *
     * <p>1. Using CMIS create test user: U1 2. Using CMIS U1 creates a public test site 3. Using
     * CMIS and WebDAV U1 creates parentFolder1, doc1 and doc2 in document library 4. Using WebDAV
     * and FTP U1 creates inside parentFolder1: childDoc1 to childDoc5 5. Using IMAP bulk delete
     * doc1 and doc2 6. Using CMIS verify that doc1 and doc2 are deleted 7. Using IMAP delete
     * childDoc1 to childDoc4 8. Using WebDAV and FTP verify if docs are deleted from their folders
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify users can delete many documents in a public site using different"
                            + " protocols.")
    public void usersCanDeleteManyDocuments() throws Exception {
        ...
        STEP(
                "3. Using CMIS and WebDAV U1 creates parentFolder1, doc1 and doc2 in document"
                        + " library");
        cmisAPI.authenticateUser(testUser1)
                .usingSite(testSitePublic)
                .createFolder(parentFolder1)
                .and()
                .assertThat()
                .existsInRepo();
        ...
        webDavProtocol
                .authenticateUser(testUser1)
                .usingResource(parentFolder1)
                .createFile(childDoc1)
                .and()
                .createFile(childDoc2);

        ftpProtocol
                .authenticateUser(testUser1)
                .usingResource(parentFolder1)
                .createFile(childDoc3)
                .and()
                .createFile(childDoc4)
                .and()
                .createFile(childDoc5);

        STEP("5. Using IMAP bulk delete doc1 and doc2");
        imapProtocol
                .authenticateUser(testUser1)
                .usingSite(testSitePublic)
                .deleteMessage(testFile1.getName(), testFile2.getName())
                .assertThat()
                .doesNotContainMessages(testFile1, testFile2);
        ...
        imapProtocol
                ...
                .deleteMessage(
                        ...
                        childDoc4.getName())
                .assertThat()
                .doesNotContainMessages(childDoc1, childDoc2, childDoc3, childDoc4);
        ...
        Utility.sleep(
                ...
                () ->
                        webDavProtocol
                                ...
                                .hasFiles(childDoc5)
                                .and()
                                .usingResource(childDoc1)
                                .assertThat()
                                .doesNotExistInRepo()
                                .and()
                                .usingResource(childDoc2)
                                .assertThat()
                                .doesNotExistInRepo());

        ftpProtocol
                .authenticateUser(testUser1)
                .usingResource(childDoc3)
                .assertThat()
                .doesNotExistInRepo()
                .and()
                .usingResource(childDoc4)
                .assertThat()
                .doesNotExistInRepo();
    }
     ...
     *
     * <p>1. Using CMIS create user u1 and public site 2. Using WebDAV U1 creates folder1 and
     * folder2 3. Using WebDAV U1 creates doc1 in folder1 4. Using FTP U1 moves folder1 in folder2
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to move a non empty folder to another folder from the same"
                            + " site.")
    public void moveFolderInAnotherFolder() throws Exception {
        ...
        STEP(
                "5. Using WebDAV verify that folder1 is not in the original location and is present"
                        + " in folder2");
        webDavProtocol
                .authenticateUser(testUser1)
                .usingResource(testFolder1)
                ...
                .doesNotExistInRepo()
                .and()
                .usingResource(testFolder2)
                .assertThat()
                .hasFolders(testFolder1);

        STEP("6. Using CMIS verify if doc1 is still present in folder1");
        FolderModel newTestFolder1 =
                new FolderModel(
                        testFolder1.getName(),
                        testFolder1.getTitle(),
                        testFolder1.getDescription());
        newTestFolder1.setCmisLocation(
                Utility.buildPath(testFolder2.getCmisLocation(), testFolder1.getName()));

        FileModel newTestFile1 =
                new FileModel(
                        testFile1.getName(),
                        testFile1.getTitle(),
                        testFile1.getDescription(),
                        testFile1.getFileType(),
                        testFile1.getContent());
        newTestFile1.setCmisLocation(
                Utility.buildPath(newTestFolder1.getCmisLocation(), testFile1.getName()));

        cmisAPI.authenticateUser(testUser1)
                .usingResource(newTestFolder1)
                .assertThat()
                .existsInRepo()
                .assertThat()
                .hasFiles(newTestFile1);
    }

    /**
     * Scenario 49 - Copy folder in another folder
     *
     * <p>1. Using CMIS create user u1 and public site 2. Using CMIS U1 creates folder1 and folder2
     * 3. Using WebDAV U1 creates doc1 in folder1 4. Using WebDAV U1 copies folder1 in folder2 5.
     * Using FTP verify that folder1 is in the original location and contains doc1 6. Using WebDAV
     * verify that folder1 is in folder2 and contains doc1
     */
    @Test(groups = {TestGroup.INTEGRATION, TestGroup.CORE})
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to copy non empty folder to another folder in the same"
                            + " site.")
    public void copyFolderInAnotherFolder() throws Exception {
        ...
        testFolder2.setProtocolLocation(
                webDavProtocol.getPrefixSpace() + testFolder2.getCmisLocation());
        webDavProtocol
                .authenticateUser(testUser1)
                .usingResource(testFolder1)
                .copyTo(testFolder2)
     ...
     *
     * <p>1. Using CMIS create one test user: U1 2. Using CMIS U1 creates a moderated site 3. Using
     * WebDAV U1 creates a folder in the moderated site document library 4. Using CMIS U1 tries to
     * rename site 5. Verify that a site cannot be renamed
     */
    @Test(
            groups = {TestGroup.INTEGRATION, TestGroup.CORE},
            expectedExceptions = CmisRuntimeException.class,
            expectedExceptionsMessageRegExp = "^.*Sites can not be renamed.$")
    @TestRail(
            section = {TestGroup.INTEGRATION, TestGroup.CONTENT},
            executionType = ExecutionType.REGRESSION,
            description = "Verify sites cannot be renamed using CMIS.")
    public void renameSite() throws Exception {
        ...
        FolderModel siteFolder =
                new FolderModel(String.format("/Sites/%s", testSiteModerated.getId()));
