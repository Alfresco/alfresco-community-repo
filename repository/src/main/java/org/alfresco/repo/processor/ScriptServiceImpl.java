...
public class ScriptServiceImpl implements ScriptService {
  ...
  private Map<String, String> scriptProcessorNamesByExtension = new HashMap<String, String>(
    8
  );
  ...
  public void registerScriptProcessor(ScriptProcessor scriptProcessor) {
    ...
    this.scriptProcessorNamesByExtension.put(
        scriptProcessor.getExtension(),
        scriptProcessor.getName()
      );
  }
  ...
  protected ScriptException translateProcessingException(
    String scriptInfo,
    Throwable err
  ) {
    ScriptException result = null;
    String msg =
      "Failed to execute script " + (scriptInfo == null ? "" : scriptInfo);
  ...
  protected ScriptProcessor lookupScriptProcessor(String name) {
    ScriptProcessor scriptProcessor =
      (name == null ? null : this.scriptProcessors.get(name));
  ...
  protected ScriptProcessor getScriptProcessor(NodeRef scriptNode) {
    String scriptName = (String) this.nodeService.getProperty(
        scriptNode,
