...
public class LuceneUtils {
     ...
     * @since 4.0
     */
    private static final SimpleDateFormat LUCENE_DATETIME_FORMAT =
    ...
    public static String createDateRangeQuery(
        ...
        if (propDef == null) {
            ...
            if (!DataTypeDefinition.DATE.equals(propDefType)
                ...
                throw new IllegalArgumentException(
                        "Illegal property type '" + dateProperty + "' [" + propDefType + "]");
            }
        }
        ...
        final String prefix =
                shortFormQName.substring(0, shortFormQName.indexOf(QName.NAMESPACE_PREFIX));
        final String localName = propertyName.getLocalName();

        // I can see potential issues with using 1970 and 3000 as default dates, but this is what
        // the previous
