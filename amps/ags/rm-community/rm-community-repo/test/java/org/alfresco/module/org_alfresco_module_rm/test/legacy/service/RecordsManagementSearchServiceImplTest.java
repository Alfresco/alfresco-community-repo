                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        List<SavedSearchDetails> searches =
                                rmSearchService.getSavedSearches(siteId);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        SavedSearchDetails search1 =
                                rmSearchService.getSavedSearch(siteId, SEARCH1);
                        ...
                        SavedSearchDetails search2 =
                                rmSearchService.getSavedSearch(siteId, SEARCH2);
                        ...
                        SavedSearchDetails search3 =
                                rmSearchService.getSavedSearch(siteId, SEARCH3);
                        assertNull(search3);

                        SavedSearchDetails search4 =
                                rmSearchService.getSavedSearch(siteId, SEARCH4);
                        assertNull(search4);
