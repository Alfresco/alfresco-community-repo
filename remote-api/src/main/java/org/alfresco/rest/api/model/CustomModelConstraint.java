...
public class CustomModelConstraint extends AbstractCommonDetails {
  ...
  public CustomModelConstraint(
    ...
    this.parameters =
      convertToNamedValue(constraintDefinition.getConstraint().getParameters());
  }

  private List<CustomModelNamedValue> convertToNamedValue(
  ...
  public String toString() {
    ...
    builder
      .append("CustomModelConstraint [name=")
      .append(this.name)
      .append(", prefixedName=")
