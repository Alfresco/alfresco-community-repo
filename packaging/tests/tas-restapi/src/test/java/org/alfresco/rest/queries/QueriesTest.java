...
public class QueriesTest extends RestTest {
        ...
        RetryOperation op =
                new RetryOperation() {
                    public void execute() throws Exception {
                        RestSiteModelsCollection restSiteModels =
                                restClient
                                        .withCoreAPI()
                                        .usingQueries()
    ...
    public void getQueriesPeople() throws Exception {
        ...
        RetryOperation op =
                new RetryOperation() {
                    public void execute() throws Exception {
                        RestPersonModelsCollection restPersonModels =
                                restClient
                                        .withCoreAPI()
                                        .usingQueries()
    ...
    public void testSearchTermWhiteSpace() throws Exception {
        ...
        RetryOperation op =
                new RetryOperation() {
                    public void execute() throws Exception {
                        RestNodeModelsCollection nodesChildTerm =
                                restClient
                                        .withCoreAPI()
                                        .usingQueries()
                        ...
                        RestNodeModelsCollection nodesChildTermWS =
                                restClient
                                        .withCoreAPI()
                                        .usingQueries()
