...
public class CalfRelationshipResource
        implements RelationshipResourceAction.ReadByIdWithResponse<Goat>,
    ...
    public BinaryResource readProperty(
            String entityId, String id, Parameters parameters, WithResponse withResponse)
