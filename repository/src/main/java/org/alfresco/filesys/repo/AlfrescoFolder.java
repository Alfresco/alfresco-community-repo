...
public class AlfrescoFolder extends NetworkFile implements NetworkFileStateInterface {
    public AlfrescoFolder(String path, FileInfo fileInfo, boolean readOnly) {
        ...
        if (fileInfo.hasCreationDateTime()) setCreationDate(fileInfo.getCreationDateTime());

        if (fileInfo.hasModifyDateTime()) setModifyDate(fileInfo.getModifyDateTime());

        if (fileInfo.hasAccessDateTime()) setAccessDate(fileInfo.getAccessDateTime());
