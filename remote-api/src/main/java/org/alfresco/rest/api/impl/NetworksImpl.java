...
public class NetworksImpl implements Networks {
    ...
    public PersonNetwork getNetwork(String personId, String networkId) {
        ...
        org.alfresco.repo.tenant.Network tenantNetwork =
                networksService.getNetwork(network.getId());
    ...
    public CollectionWithPagingInfo<PersonNetwork> getNetworks(String personId, Paging paging) {
        ...
        PagingResults<org.alfresco.repo.tenant.Network> networks =
                networksService.getNetworks(Util.getPagingRequest(paging));
        ...
        return CollectionWithPagingInfo.asPaged(
                paging, ret, networks.hasMoreItems(), networks.getTotalResultCount().getFirst());
    }
}
