...
public class SetContentTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to set content to a valid document in"
    ...
    @TestRail(
            ...
            description =
                    "Verify if exception is thrown when user tries to set content to an invalid"
                            + " document in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that inexistent user is not able to set content to a document with"
                            + " CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to set content to a document with no content with"
                            + " overwrite parameter set to false with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to set content to a document with content with"
                            + " overwrite parameter set to false with CMIS")
    public void siteManagerCanSetContentWithFalseOverwriteToDocWithContent() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager)
                ...
                .contentIs(someContent)
                .then()
                .setContent(secondContent, false);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager is able to set file content  for a file created by other"
                            + " user with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to set content to a document created by"
                            + " other user with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to set content to a document created by self"
                            + " with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to set content to a document created by other"
                            + " user with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to set content to a document created by self"
                            + " with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to set content to a checked out document with"
                            + " CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to set content to PWC document version with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized user is not able to set content to a document from a"
                            + " private site")
