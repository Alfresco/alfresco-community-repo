...
public class GetPeopleCannedQueryTest extends BaseSpringTest {
  ...
  private CannedQueryResults<NodeRef> executeGetPeopleQuery(
    ...
    final GetPeopleCannedQuery cq = (GetPeopleCannedQuery) getPeopleCannedQueryFactory.getCannedQuery(
  ...
  public void testPeopleFiltering() {
    ...
    NodeRef person1 = personService.createPerson(
      createDefaultProperties("aa", "Aa", "Aa", "aa@aa", "alfresco1")
    );
    personService.createPerson(
      createDefaultProperties("bc", "c", "C", "bc@bc", "alfresco2")
    );
    personService.createPerson(
      createDefaultProperties("yy", "B", "D", "yy@yy", "alfresco3")
    );
    personService.createPerson(
      createDefaultProperties("Yz", "yz", "B", "yz@yz", "alfresco4")
    );
    personService.createPerson(
    ...
    CannedQueryResults<NodeRef> people = executeGetPeopleQuery(
      pagingRequest,
      null,
      null,
      false,
    ...
    assertEquals(
      "Administrators not filtered",
      newPeopleNumber - 1,
      people.getPagedResultCount()
    );
  ...
  public void testPeopleSortingPaging() {
    ...
    PagingResults<NodeRef> ppr = executeGetPeopleQuery(
      pr,
      null,
      null,
      true,
