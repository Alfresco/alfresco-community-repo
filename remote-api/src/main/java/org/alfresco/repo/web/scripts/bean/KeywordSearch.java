...
public class KeywordSearch extends DeclarativeWebScript {
  ...
  protected static final StoreRef SEARCH_STORE = new StoreRef(
  ...
  private SearchResult search(
    ...
    try {
      ...
      if (totalResults == 0) {
        ...
        searchResult.setTotalPageItems(
          Math.min(
            itemsPerPage,
  ...
  public class SearchTemplateNode extends TemplateNode {
    ...
    public SearchTemplateNode(NodeRef nodeRef, float score) {
      super(
        nodeRef,
        serviceRegistry,
        KeywordSearch.this.imageResolver.getImageResolver()
      );
      this.score = score;
    }
