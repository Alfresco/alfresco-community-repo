...
public interface AccessPermission {
    ...
    /**
     * At what position in the inheritance chain for permissions is this permission set? = 0 -> Set
     * direct on the object. > 0 -> Inherited < 0 -> We don't know and are using this object for
     * reporting (e.g. the actual permissions that apply to a node for the current user)
     *
     * @return int
     */
