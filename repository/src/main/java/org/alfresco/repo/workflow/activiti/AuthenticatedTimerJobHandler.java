...
public class AuthenticatedTimerJobHandler implements JobHandler {
   ...
   */
  public AuthenticatedTimerJobHandler(
    JobHandler jobHandler,
    NodeService nodeService
  ) {
    if (jobHandler == null) {
      throw new IllegalArgumentException(
        "JobHandler to delegate to is required"
      );
    }
    if (nodeService == null) {
  ...
  public void execute(
    ...
    String tenantToRunIn = (String) execution.getVariable(
    ...
    final ActivitiScriptNode initiatorNode = (ActivitiScriptNode) execution.getVariable(
    ...
    if (userName == null) {
      ...
      if (targetActivity != null) {
        ...
        String activityType = (String) targetActivity.getProperty(
          ActivitiConstants.NODE_TYPE
        );
  ...
  protected String getInitiator(ActivitiScriptNode initiatorNode) {
    if (initiatorNode != null) {
      ...
      if (unprotectedNodeService.exists(ref)) {
        return (String) unprotectedNodeService.getProperty(
          ref,
