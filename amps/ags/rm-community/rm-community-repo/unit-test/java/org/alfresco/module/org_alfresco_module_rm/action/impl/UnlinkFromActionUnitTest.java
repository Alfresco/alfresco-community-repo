...
public class UnlinkFromActionUnitTest extends BaseActionUnitTest {
    ...
    @InjectMocks private UnlinkFromAction action;
    ...
    /**
     * Given the actioned upon node does not exist When the action is executed Then nothing happens
     */
    @Test
    ...
    /**
     * Given the actioned upon node is pending delete When the action is executed Then nothing
     * happens
     */
    @Test
    ...
    /**
     * Given that actioned upon node is not a record When the action is executed Then nothing
     * happens
     */
    @Test
    ...
    /**
     * Given that the record folder parameter is not provided When the action is executed Then an
     * exception is thrown
     */
    ...
    /**
     * Given that a valid record folder is provided When the action is executed Then the record is
     * unlinked from the record folder
     */
    @Test
