...
public class RMv22RemoveInPlaceRolesFromAllPatchUnitTest extends BaseUnitTest
{
    ...
    /**
     * Given that there is one file plan whose 'all roles' group does not contain the in-place roles the 'all roles' groups should not be changed.
     */
    @Test
    ...
    /**
     * Given that there is one file plan whose 'all roles' group contains the in-place roles then they should be revoved.
     */
    @Test
