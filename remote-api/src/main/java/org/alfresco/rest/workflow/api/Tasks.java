...
public interface Tasks {
  ...
  CollectionWithPagingInfo<Task> getTasks(
    String processId,
  ...
  CollectionWithPagingInfo<TaskCandidate> getTaskCandidates(
    String taskId,
    Paging paging
  );
  ...
  CollectionWithPagingInfo<FormModelElement> getTaskFormModel(
    String entityResourceId,
    Paging paging
  );

  // task variables
  CollectionWithPagingInfo<TaskVariable> getTaskVariables(
    String taskId,
    Paging paging,
    VariableScope scope
  );
  ...
  List<TaskVariable> updateTaskVariables(
    String taskId,
