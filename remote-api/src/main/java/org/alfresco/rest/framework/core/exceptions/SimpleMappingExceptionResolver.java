...
/**
 * Exception Resolver that uses a simple Map to resolve the Status codes and error responses for
 * exceptions
 *
 * @author Gethin James
 */
public class SimpleMappingExceptionResolver implements ExceptionResolver<Exception> {
    ...
    private ErrorResponse findMatchingException(
            Map<String, Integer> exceptionMappings, Exception ex) {
