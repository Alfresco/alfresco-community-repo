...
public class ConformanceCmisServiceWrapper extends AbstractCmisServiceWrapper {
     ...
     *
     * @param service the {@link CmisService} object, not {@code null}
     */
     ...
     * @param service the {@link CmisService} object, not {@code null}
     */
    public ConformanceCmisServiceWrapper(
            CmisService service,
    ...
    protected void checkProperty(Properties properties, String propertyId, Class<?> clazz) {
        ...
        if (value == null) {
            throw new CmisInvalidArgumentException(
                    "Property " + propertyId + " must have a value!");
        }

        if (!clazz.isAssignableFrom(value.getClass())) {
            throw new CmisInvalidArgumentException(
                    "Property " + propertyId + " has the wrong type!");
        }
    }
    ...
    protected void checkBulkUpdateList(List<BulkUpdateObjectIdAndChangeToken> list) {
        ...
        for (BulkUpdateObjectIdAndChangeToken entry : list) {
            ...
            if (entry.getId() == null) {
                throw new CmisInvalidArgumentException(
                        "Object Id list contains an entry without ID!");
            }

            if (entry.getId().length() == 0) {
                throw new CmisInvalidArgumentException(
                        "Object Id list contains an entry with an empty ID!");
            }
        }
    }
    ...
    /**
     * Returns the default maxItems if {@code maxItems} == {@code null}, throws an exception if
     * {@code maxItems} &lt; 0, returns {@code maxItems} otherwise.
     */
    ...
    /**
     * Checks the depth parameter if it complies with CMIS specification and returns the default
     * value if {@code depth} is {@code null}.
     */
    ...
    /**
     * Returns 0 if {@code skipCount} == {@code null}, throws an exception if {@code skipCount} &lt;
     * 0, returns {@code skipCount} otherwise.
     */
    ...
    public List<TypeDefinitionContainer> getTypeDescendants(
        ...
        try {
            return getWrappedService()
                    .getTypeDescendants(
                            repositoryId, typeId, depth, includePropertyDefinitions, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    @Override
    public TypeDefinition createType(
    ...
    public ObjectData getFolderParent(
            String repositoryId, String folderId, String filter, ExtensionsData extension) {
        checkRepositoryId(repositoryId);
        checkId("Folder Id", folderId);
    ...
    public void deleteObject(
            String repositoryId, String objectId, Boolean allVersions, ExtensionsData extension) {
        checkRepositoryId(repositoryId);
        checkId("Object Id", objectId);
    ...
    public ContentStream getContentStream(
        ...
        try {
            return getWrappedService()
                    .getContentStream(repositoryId, objectId, streamId, offset, length, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    public void moveObject(
        ...
        try {
            getWrappedService()
                    .moveObject(repositoryId, objectId, targetFolderId, sourceFolderId, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    public void updateProperties(
        ...
        try {
            getWrappedService()
                    .updateProperties(repositoryId, objectId, changeToken, properties, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
        ...
        try {
            return getWrappedService()
                    .getPropertiesOfLatestVersion(
                            repositoryId, objectId, versionSeriesId, major, filter, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    public void addObjectToFolder(
        ...
        try {
            getWrappedService()
                    .addObjectToFolder(repositoryId, objectId, folderId, allVersions, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    public Acl applyAcl(
        ...
        try {
            return getWrappedService()
                    .applyAcl(
                            repositoryId, objectId, addAces, removeAces, aclPropagation, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    public Acl getAcl(
        ...
        try {
            return getWrappedService()
                    .getAcl(repositoryId, objectId, onlyBasicPermissions, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
    ...
    public List<ObjectData> getAppliedPolicies(
        ...
        try {
            return getWrappedService()
                    .getAppliedPolicies(repositoryId, objectId, filter, extension);
        } catch (Exception e) {
            throw createCmisException(e);
        }
    }
