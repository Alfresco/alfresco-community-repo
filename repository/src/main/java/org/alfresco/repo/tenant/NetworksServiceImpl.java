...
public class NetworksServiceImpl implements NetworksService {
    public static final Network DEFAULT_NETWORK =
            new Network(TenantUtil.DEFAULT_TENANT, true, null, null);
    ...
    private boolean hasAccess(String networkId) {
        ...
        // check that the currently authenticated user is in the same network as that being
        // requested.
    ...
    public Network getNetwork(String networkId) {
        ...
        if (networkId.equals(TenantUtil.SYSTEM_TENANT)
