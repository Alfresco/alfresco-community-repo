...
public class AddObjectToFolderTests extends CmisTest {
    ...
    public void siteManagerShouldAddFileToFolder() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .and()
                .assertThat()
                .objectIdIs(sourceFile.getNodeRef());
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is not able to add folder object to folder with CMIS")
    @Test(
    ...
    public void siteManagerShouldNotAddFolderToFolder() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFolder(folderToAdd)
                .assertThat()
                .existsInRepo()
                .then()
                .addDocumentToFolder(folderToAdd, true);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to add file a document object in more than one"
                            + " folder in DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    public void siteManagerShouldNotAddInvalidFolderToFolder() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .existsInRepo()
                .then()
                .addDocumentToFolder(randomFolder, true);
    }
    ...
    public void siteManagerCanAddDocumentWithVersionsToFolderWithTrueAllVersions()
            throws Exception {
        sourceFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
    ...
    @Test(
            groups = {
                ...
                TestGroup.CMIS,
                TestGroup.NOT_SUPPORTED_ON_CMIS_WS
            },
            expectedExceptions = CmisInvalidArgumentException.class,
    ...
    public void siteManagerCannotAddDocumentToFolderWithFalseAllVersions() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .then()
                .addDocumentToFolder(destinationFolder, false);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to add document object created by manager to"
                            + " folder")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to add document object created by manager to"
                            + " folder")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is able to add document object created by manager to"
                            + " folder")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
