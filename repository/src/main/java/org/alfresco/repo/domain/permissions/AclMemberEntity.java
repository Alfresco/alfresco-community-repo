 ...
 *
 * <p>Relates an ACE to an ACL with a position
 *
 * @author janv
 * @since 3.4
 */
public class AclMemberEntity implements AclMember {
     ...
     *
     * <p>0 - implies the ACE is on the object >0 - that it is inherited in some way
     *
     * <p>The lower values are checked first so take precedence.
     *
