...
public abstract class AbstractModulePatch implements ModulePatch, BeanNameAware {
    ...
    public void apply() {
        ...
        transactionService
                ...
                .doInTransaction(new ApplyCallback(), txnReadOnly, txnRequiresNew);

        long elapsedTime = System.nanoTime() - startTime;

        if (LOGGER.isInfoEnabled()) {
            LOGGER.info(
                    "   ... module patch applied in "
    ...
    private class ApplyCallback implements RetryingTransactionCallback<Void> {
        /**
         * @see
         *     org.alfresco.repo.transaction.RetryingTransactionHelper.RetryingTransactionCallback#execute()
         */
        @Override
        public Void execute() {
            applyInternal();
