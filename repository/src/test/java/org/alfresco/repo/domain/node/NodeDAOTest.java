...
public class NodeDAOTest extends TestCase {
    ...
    public void setUp() {
        ...
        rootNodesCache =
                (SimpleCache<Serializable, ValueHolder<Node>>)
                        ctx.getBean("node.rootNodesSharedCache");
    }
    ...
    public void testSelectNodePropertiesByTypes() throws Exception {
        ...
        RetryingTransactionCallback<List<NodePropertyEntity>> callback =
                new RetryingTransactionCallback<List<NodePropertyEntity>>() {
    ...
    private Pair<Long, Long> getNodeIdsInterval(final Long minTxnTime, final Long maxTxnTime) {
        RetryingTransactionCallback<Pair<Long, Long>> callback =
                new RetryingTransactionCallback<Pair<Long, Long>>() {
                    public Pair<Long, Long> execute() throws Throwable {
                        return nodeDAO.getNodeIdsIntervalForType(
                                ContentModel.TYPE_FOLDER, minTxnTime, maxTxnTime);
                    }
                };
    ...
    public void testSelectChildAssocsWithoutNodeAssocsOfTypes() {
        ...
        RetryingTransactionCallback<List<Node>> callback =
    ...
    public void testGetNodesWithAspects() throws Throwable {
        final NodeRefQueryCallback callback =
     ...
     *
     * <p>ACE-987: NPE in NodeEntity during post-commit write through to shared cache
     */
    public void testRootNodeCacheEntries() throws Throwable {
        ...
        for (Serializable key : keys) {
            NodeEntity node =
                    (NodeEntity) TransactionalCache.getSharedCacheValue(rootNodesCache, key);
