...
/**
 * An exception thrown when the remote server indicates that it has encountered a problem with the
 * request, and cannot process it. This typically means a 5xx response.
 *
 * @author Nick Burch
 * @since 4.0.3
 */
