 ...
 *
 * <p>There are conditions under which code that expects to be caching, should not be. Using this
 * cache, it becomes possible to configure a valid cache in whilst still ensuring that the actual
...
public class NullCache<K extends Serializable, V extends Object> implements SimpleCache<K, V> {
    ...
    private static final NullCache<Serializable, Object> INSTANCE =
            new NullCache<Serializable, Object>();
