...
/**
 * Tests for GET /people/{personId}/site-membership-requests GET /site-membership-requests POST
...
public class GetSiteMembershipRequestsTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingAuthUser()
                .addSiteMembershipRequest(moderatedSite1);
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user gets all site membership requests of a specific person"
                            + " with Rest API and response is successful (200)")
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator user fails to get all site membership requests of another"
                            + " user with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user fails to get all site membership requests of another"
                            + " user with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user fails to get all site membership requests of another user"
                            + " with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user gets all site membership requests of a specific person with"
                            + " Rest API and response is successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify manager user fails to get all site membership requests of a specific"
                            + " person with Rest API when the authentication fails (401)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify a user gets all its own site membership requests with Rest API and"
    ...
    public void oneUserGetsItsOwnSiteMembershipRequestsWithSuccess() throws Exception {
        ...
        siteMembershipRequests
                .assertThat()
                .entriesListContains("id", moderatedSite1.getId())
                .assertThat()
                .entriesListContains("message", "Please accept me")
                .assertThat()
        ...
        if (firstSite.getId().equals(moderatedSite1.getId())) {
            firstSite
                    .assertThat()
                    .field("visibility")
                    .is(moderatedSite1.getVisibility())
                    .assertThat()
                    .field("guid")
                    .is(moderatedSite1.getGuid())
                    .assertThat()
                    .field("description")
                    .is(moderatedSite1.getDescription())
                    .assertThat()
                    .field("id")
                    .is(moderatedSite1.getId())
                    .assertThat()
                    .field("title")
                    .is(moderatedSite1.getTitle());
        } else {
            firstSite
                    .assertThat()
                    .field("visibility")
                    .is(moderatedSite2.getVisibility())
                    .assertThat()
                    .field("guid")
                    .is(moderatedSite2.getGuid())
                    .assertThat()
                    .field("description")
                    .is(moderatedSite2.getDescription())
                    .assertThat()
                    .field("id")
                    .is(moderatedSite2.getId())
                    .assertThat()
                    .field("title")
                    .is(moderatedSite2.getTitle());
        }
    }
    ...
    public void checkInvalidMaxItemsStatusCode() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_MAXITEMS, "AB"));
    ...
    public void checkInvalidSkipCountStatusCode() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_SKIPCOUNT, "AB"));
    ...
    public void ifPersonIdDoesNotExist() throws Exception {
        ...
        restClient
                .authenticateUser(adminUser)
                .withCoreAPI()
                .usingUser(nonexistentUser)
                .getSiteMembershipRequests();
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, "nonexistent"))
    ...
    public void useEmptyPersonId() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.ENTITY_NOT_FOUND, emptyNameMember.getUsername()));
    }
    ...
    public void approveRequestThenGetRequests() throws Exception {
        ...
        workflow.approveSiteMembershipRequest(
                siteManager.getUsername(),
                siteManager.getPassword(),
                taskModel.getId(),
                true,
                "Approve");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user gets all its own site membership requests with Rest API and"
                            + " response is successful (200)")
    public void adminGetsItsOwnSiteMembershipRequestsWithSuccess() throws Exception {
        ...
        siteMembershipRequests
                ...
                .entriesListContains("id", moderatedSite1.getId())
                .assertThat()
                .entriesListContains("id", moderatedSite2.getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user fails to get all site membership requests of another user"
                            + " with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user fails to get all site membership requests of admin with"
                            + " Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is able to get his site membership requests with, but skip"
                            + " the first one")
    public void getSiteMembershipRequestsButSkipTheFirstOne() throws Exception {
        siteMembershipRequests =
                restClient
                        .authenticateUser(newMember)
                        .withParams("orderBy=id ASC")
                        .withCoreAPI()
                        .usingMe()
                        .getSiteMembershipRequests();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        ...
        RestSiteMembershipRequestModel firstSiteMembershipRequest =
                siteMembershipRequests.getEntries().get(0).onModel();
        RestSiteMembershipRequestModel secondSiteMembershipRequest =
                siteMembershipRequests.getEntries().get(1).onModel();

        siteMembershipRequests =
                restClient
                        .authenticateUser(newMember)
                        .withParams("orderBy=id ASC&skipCount=1")
                        .withCoreAPI()
                        .usingMe()
                        .getSiteMembershipRequests();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        siteMembershipRequests
                .assertThat()
                .entriesListDoesNotContain("id", firstSiteMembershipRequest.getId())
                .assertThat()
                .entriesListContains("id", secondSiteMembershipRequest.getId())
                .assertThat()
                .entriesListContains("id", secondSiteMembershipRequest.getSite().getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is able to get his site membership requests with higher"
                            + " skipCount than number of requests")
    public void getSiteMembershipRequestsWithHighSkipCount() throws Exception {
        siteMembershipRequests =
                restClient
                        .authenticateUser(newMember)
                        .withParams("skipCount=3")
                        .withCoreAPI()
                        .usingMe()
                        .getSiteMembershipRequests();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site membership requests returns an empty list where there are no"
                            + " requests")
    ...
    public void rejectRequestThenGetSiteMembershipRequests() throws Exception {
        ...
        RestTaskModel taskModel =
                restClient
                        ...
                        .withWorkflowAPI()
                        .getTasks()
                        .getTaskModelByDescription(moderatedSite1);
        workflow.approveSiteMembershipRequest(
                siteManager.getUsername(),
                siteManager.getPassword(),
                taskModel.getId(),
        ...
        siteMembershipRequests
                .assertThat()
                .entriesListDoesNotContain("id", moderatedSite1.getId())
                .assertThat()
                .entriesListContains("id", moderatedSite2.getId());
    }
    ...
    public void getSiteMembershipRequestsWithProperties() throws Exception {
        ...
        siteMembershipRequests
                ...
                .assertThat()
                .entriesListContains("id", moderatedSite2.getId());
        RestSiteMembershipRequestModel siteMembershipRequest =
                siteMembershipRequests.getOneRandomEntry().onModel();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Sanity test for endpoints: GET /site-membership-requests, POST"
                            + " /sites/{siteId}/site-membership-requests/{inviteeId}/approve, POST"
                            + " /sites/{siteId}/site-membership-requests/{inviteeId}/reject")
    public void approveRejectSiteMembership() throws Exception {
        ...
        RestSitePersonMembershipRequestModelsCollection membership =
                restClient
                        ...
                        .withParams(
                                "where=(personId='"
                                        ...
                                        + "' AND siteId='"
                                        + moderatedSite1.getId()
                                        + "')")
                        .withCoreAPI()
                        .usingSite(moderatedSite1)
                        .getSiteMemberships();
        ...
        STEP(
                "3. Approve site membership for one of the users. Check that the user is now a"
                        + " member of the site");
        restClient
                .authenticateUser(siteManager)
                .withCoreAPI()
                .usingSite(moderatedSite1)
                .approveSiteMembership(testUser);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        restClient
                .withCoreAPI()
                .usingSite(moderatedSite1)
                .getSiteMember(testUser)
                .assertThat()
                .field("id")
                .is(testUser.getUsername())
                .and()
        ...
        STEP(
                "4. Reject site membership for the second user. Check that the user is not a member"
                        + " of the site");
        restClient
                .authenticateUser(siteManager)
                .withCoreAPI()
                .usingSite(moderatedSite1)
                .rejectSiteMembership(testUser1);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        RestSiteMemberModelsCollection memberList =
                restClient.withCoreAPI().usingSite(moderatedSite1).getSiteMembers();
