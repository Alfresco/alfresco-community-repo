...
public class IndexColumnsValidatorTest {
  ...
  public void testAllOk() {
    ...
    validator.validate(
      indexForColumns("SYS_NC234234", "SYS_NC654123"),
      indexForColumns("SYS_NC123123", "SYS_NC225588"),
      ctx
    );
  ...
  public void testNotValid() {
    ...
    assertEquals(
      "MY_INDEX",
      ((ValidationResult) validationResults.get(1)).getValue()
    );
    assertEquals(
      target.getColumnNames(),
      ((ValidationResult) validationResults.get(2)).getValue()
    );
  }
