...
{
    public ContentStreamLengthProperty(ServiceRegistry serviceRegistry, CMISFacade cmisFacade)
    {
        super(serviceRegistry, cmisFacade, PropertyIds.CONTENT_STREAM_LENGTH);
    }
