...
/**
 * Constraint implementation that ensures that the value is a numeric value bewteen a given minimum
 * and maximum value. If a minimum or maximum value are not provided, then the JAVA Double's {@link
 * Double#MIN_VALUE minimum value} or {@link Double#MAX_VALUE maximum value} are assumed.
 *
...
public class NumericRangeConstraint extends AbstractConstraint {
    private static final String ERR_INVALID_MIN_VALUE =
            "d_dictionary.constraint.numeric_range.invalid_min_value";
    private static final String ERR_INVALID_MAX_VALUE =
            "d_dictionary.constraint.numeric_range.invalid_max_value";
    private static final String ERR_NON_NUMERIC =
            "d_dictionary.constraint.numeric_range.non_numeric";
    private static final String ERR_OUT_OF_RANGE =
            "d_dictionary.constraint.numeric_range.out_of_range";
    ...
    /**
     * Set the minimum value allowed, which can be any value between {@link Double#MIN_VALUE} and
    ...
    /**
     * Set the maximum value allowed, which can be any value between {@link Double#MIN_VALUE} and
     * {@link Double#MAX_VALUE}.
     *
