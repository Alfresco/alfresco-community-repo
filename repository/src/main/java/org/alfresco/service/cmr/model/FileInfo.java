...
/**
 * Common file information. The implementations may store the properties for the lifetime of this
 * instance; i.e. the values are transient and can be used as read-only values for a short time
 * only.
 *
 * @author Derek Hulley
 */
