          ...
          public Object invoke(MethodInvocation mi) throws Throwable {
            ...
            try {
              for (String instance : applicationContextManager.getInstanceIds()) {
                ...
                try {
                  context =
                    ChainingSubsystemProxyFactory.this.applicationContextManager.getApplicationContext(
                        instance
                      );
                ...
                if (ChainingSubsystemProxyFactory.this.sourceBeanName == null) {
                  Map<?, ?> beans = context.getBeansOfType(
                  ...
                  for (Object bean : beans.values()) {
                    ...
                    if (
                      !(bean instanceof ActivateableBean) ||
                      ...
                      if (activeBean == null) {
                        ...
                        throw new RuntimeException(
                          "Don't know where to route call to method " +
                          method +
                          ": multiple active beans in context " +
                          instance
                        );
                      }
                    }
