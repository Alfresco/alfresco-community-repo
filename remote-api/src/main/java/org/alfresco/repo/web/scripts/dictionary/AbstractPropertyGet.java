...
public abstract class AbstractPropertyGet extends DictionaryWebServiceBase {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        if (this.dictionaryservice.getClass(classQname).getProperties().get(propertyQname)
                != null) {
            model.put(
                    MODEL_PROP_KEY_PROPERTY_DETAILS,
                    this.dictionaryservice.getClass(classQname).getProperties().get(propertyQname));
