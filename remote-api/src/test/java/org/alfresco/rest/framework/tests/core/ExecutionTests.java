...
public class ExecutionTests extends AbstractContextTest implements ResponseWriter {
    ...
    @Autowired SimpleMappingExceptionResolver simpleMappingExceptionResolver;

    @Test
    public void testInvokeGet() throws IOException {
        ResourceWithMetadata entityResource =
                locator.locateEntityResource(api, "sheep", HttpMethod.GET);
        AbstractResourceWebScript executor = getExecutor();
        Object result =
                executor.execute(
                        entityResource,
                        Params.valueOf((String) null, null, mock(WebScriptRequest.class)),
        ...
        result =
                executor.execute(
                        entityResource,
                        Params.valueOf("543", null, mock(WebScriptRequest.class)),
                        response,
                        true);
        assertNotNull(result);
        verify(response, times(1)).setCache((Cache) CowEntityResource.CACHE_COW);

        ResourceWithMetadata baa =
                locator.locateRelationResource(api, "sheep", "baaahh", HttpMethod.GET);
        result =
                executor.execute(
                        baa,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
                        mock(WebScriptResponse.class),
                        true);
        assertNotNull(result);
        ...
        executor.execute(
                baa,
                Params.valueOf("4", "45", mock(WebScriptRequest.class)),
                mock(WebScriptResponse.class),
                true);
        assertNotNull(result);

        ResourceWithMetadata cowResource =
                locator.locateRelationResource(api, "cow", "photo", HttpMethod.GET);
        result =
                executor.execute(
                        cowResource,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata calf =
                locator.locateRelationResource(api, "cow", "calf", HttpMethod.GET);
        result =
                executor.execute(
                        calf,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata baaPhoto =
                locator.locateRelationResource(
                        api, "sheep/{entityId}/baaahh", "photo", HttpMethod.GET);
        executor.execute(
                baaPhoto,
                Params.valueOf("4", "45", mock(WebScriptRequest.class)),
                mock(WebScriptResponse.class),
    ...
    public void testInvokePost() throws IOException {
        ...
        ResourceWithMetadata resource =
                locator.locateRelationResource(api, "sheep", "blacksheep", HttpMethod.POST);
        ...
        ResourceWithMetadata grassResource =
                locator.locateEntityResource(api, "grass", HttpMethod.POST);
        ...
        ResourceWithMetadata cowresource =
                locator.locateEntityResource(api, "cow", HttpMethod.POST);
        WebScriptResponse response = mock(WebScriptResponse.class);
        result =
                executor.execute(
                        cowresource,
        ...
        ResourceWithMetadata entityResource =
                locator.locateRelationResource(api, "grass", "grow", HttpMethod.POST);
        result =
                executor.execute(
                        entityResource,
                        Params.valueOf("654", null, NULL_PARAMS, grr, mock(WebScriptRequest.class)),
                        mock(WebScriptResponse.class),
                        false);
        assertEquals("Growing well", result);

        ResourceWithMetadata calfResource =
                locator.locateRelationResource(api, "cow", "calf", HttpMethod.POST);
        result =
                executor.execute(
                        calfResource,
                        Params.valueOf(
        ...
        ResourceWithMetadata collResource =
                locator.locateResource(api, templateVars, HttpMethod.POST);
        result =
                executor.execute(
                        collResource,
                        Params.valueOf(
                                "654", "345", NULL_PARAMS, null, mock(WebScriptRequest.class)),
                        mock(WebScriptResponse.class),
                        false);
    ...
    public void testInvokeDelete() throws IOException {
        ResourceWithMetadata grassResource =
                locator.locateEntityResource(api, "grass", HttpMethod.DELETE);
        ...
        ResourceWithMetadata cowResource =
                locator.locateEntityResource(api, "cow", HttpMethod.DELETE);
        result =
                executor.execute(
                        cowResource,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata resource =
                locator.locateRelationResource(api, "sheep", "blacksheep", HttpMethod.DELETE);
        result =
                executor.execute(
                        resource,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata calf =
                locator.locateRelationResource(api, "cow", "calf", HttpMethod.DELETE);
        result =
                executor.execute(
                        calf,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata flockEntityResource =
                locator.locateRelationResource(api3, "flock", "photo", HttpMethod.DELETE);
        result =
                executor.execute(
                        flockEntityResource,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        calf =
                locator.locateRelationResource(
                        api, "cow/{entityId}/calf", "photo", HttpMethod.DELETE);
        result =
                executor.execute(
                        calf,
                        Params.valueOf("4", null, mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata goatDelete =
                locator.locateRelationResource(
                        api3, "goat/{entityId}/herd", "content", HttpMethod.DELETE);
        result =
                executor.execute(
                        goatDelete,
                        Params.valueOf("4", "56", mock(WebScriptRequest.class)),
                        mock(WebScriptResponse.class),
                        false);
        assertNull(result);
    }
    ...
    public void testInvokePut() throws IOException {
        ResourceWithMetadata entityResource =
                locator.locateEntityResource(api, "sheep", HttpMethod.PUT);
        ...
        Object result =
                executor.execute(
                        entityResource,
                        Params.valueOf(
                                "654", null, NULL_PARAMS, aSheep, mock(WebScriptRequest.class)),
                        mock(WebScriptResponse.class),
                        false);
        assertNotNull(result);
        assertEquals(aSheep, ((ExecutionResult) result).getRoot());
        ...
        result =
                executor.execute(
                        cowResource,
                        Params.valueOf(
                                "654", null, NULL_PARAMS, goat, mock(WebScriptRequest.class)),
                        mock(WebScriptResponse.class),
                        false);
        assertNotNull(result);
        assertEquals(goat, ((ExecutionResult) result).getRoot());
        ...
        ResourceWithMetadata resource =
                locator.locateRelationResource(api, "sheep", "blacksheep", HttpMethod.PUT);
        result =
                executor.execute(
                        resource,
                        Params.valueOf(
        ...
        ResourceWithMetadata baaPhoto =
                locator.locateRelationResource(
                        api, "sheep/{entityId}/baaahh", "photo", HttpMethod.PUT);
        result =
                executor.execute(
                        baaPhoto,
                        Params.valueOf("4", "56", mock(WebScriptRequest.class)),
        ...
        ResourceWithMetadata flockEntityResource =
                locator.locateRelationResource(api3, "flock", "photo", HttpMethod.PUT);
        result =
                executor.execute(
                        flockEntityResource,
                        Params.valueOf(
        ...
        ResourceWithMetadata calf =
                locator.locateRelationResource(api, "cow", "calf", HttpMethod.PUT);
        result =
                executor.execute(
                        calf,
                        Params.valueOf(
    ...
    public void testInvokeAbstract() throws IOException {
        ...
        templateVars.put(ResourceLocator.COLLECTION_RESOURCE, "sheep");
        executor.execute(
                ApiAssistant.determineApi(templateVars),
                mockRequest(templateVars, new HashMap<String, List<String>>(1)),
                mock(WebScriptResponse.class));

        WebScriptResponse response = mockResponse();
        templateVars.put(ResourceLocator.COLLECTION_RESOURCE, "bad");
        executor.execute(
                api, mockRequest(templateVars, new HashMap<String, List<String>>(1)), response);
    ...
    public void testRenderError() throws IOException {
        ...
        ErrorResponse defaultError =
                new DefaultExceptionResolver().resolveException(new NullPointerException());
        ...
        assertTrue(
                errorMessage.contains(
                        "\"stackTrace\":\"For security reasons the stack trace is no longer"
                                + " displayed"));
        assertTrue(
                errorMessage.contains(
                        "\"descriptionURL\":\"" + DefaultExceptionResolver.ERROR_URL + "\""));

        ErrorResponse anError =
                simpleMappingExceptionResolver.resolveException(new ApiException("nothing"));
        ...
        assertFalse(
                "Only 500 errors should have a logId", errorMessage.contains("\"logId\":\" \""));
    }
    ...
    private WebScriptResponse mockResponse(ByteArrayOutputStream byteArrayOutputStream)
            throws IOException {
    ...
    private WebScriptRequest mockRequest(
            Map<String, String> templateVars, final Map<String, List<String>> params) {
        ...
        when(request.getParameterValues(anyString()))
                .thenAnswer(
                        new Answer<String[]>() {
                            @Override
