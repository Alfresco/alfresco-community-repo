...
public class GetDeploymentSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user gets a non-network deployment using REST API and status code"
                            + " is OK (200)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify non admin user is forbidden to get a non-network deployment using REST"
                            + " API (403)")
    @Test(
            groups = {
                TestGroup.REST_API,
