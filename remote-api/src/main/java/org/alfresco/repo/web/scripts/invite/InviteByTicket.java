 ...
 *
 * <p>Note: This Web Script is accessible without authentication.
 *
...
public class InviteByTicket extends DeclarativeWebScript {
    ...
    private String getInvitationStatus(NominatedInvitation invitation) {
        ...
        List<WorkflowTask> pendingInvitationTasks =
                serviceRegistry.getWorkflowService().queryTasks(query, false);
