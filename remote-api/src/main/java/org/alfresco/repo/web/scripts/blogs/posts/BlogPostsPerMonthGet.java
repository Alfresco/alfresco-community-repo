...
public class BlogPostsPerMonthGet extends AbstractGetBlogWebScript {
  ...
  private Date getEndOfMonthDate(Date date) {
    ...
    int lastDayOfSpecifiedMonth = calendar.getActualMaximum(
      Calendar.DAY_OF_MONTH
    );
    calendar.set(
      date.getYear(),
      date.getMonth(),
      lastDayOfSpecifiedMonth,
      23,
      59,
      59
    );
   ...
   */
  @SuppressWarnings("deprecation")
  private List<Map<String, Object>> getBlogPostMonths(
    PagingResults<BlogPostInfo> nodes
  ) {
