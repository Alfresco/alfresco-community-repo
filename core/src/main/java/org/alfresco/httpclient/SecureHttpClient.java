...
public class SecureHttpClient // extends AbstractHttpClient
 {
    ...
    //     */
    //    public SecureHttpClient(HttpClientFactory httpClientFactory, String host, int port,
    ...
    //    }
    //
    //    public SecureHttpClient(HttpClientFactory httpClientFactory, KeyResourceLoader
    // keyResourceLoader, String host, int port,
    //            EncryptionParameters encryptionParameters)
    //    {
    //        super(httpClientFactory, host, port);
    //        this.encryptionParameters = encryptionParameters;
    //        this.encryptionService = new EncryptionService(alfrescoHost, alfrescoPort,
    ...
    //            message = req.getBody();
    //            // encrypt body
    //            Pair<byte[], AlgorithmParameters> encrypted =
    // encryptor.encrypt(KeyProvider.ALIAS_SOLR, null, message);
    //            encryptionUtils.setRequestAlgorithmParameters(method, encrypted.getSecond());
    //
    //            ByteArrayRequestEntity requestEntity = new
    // ByteArrayRequestEntity(encrypted.getFirst(), "application/octet-stream");
    ...
    //    }
    //
    //    protected HttpMethod sendRemoteRequest(Request req) throws AuthenticationException,
    // IOException
    //    {
    ...
    //    {
    //        HttpMethod method = super.sendRemoteRequest(req);
    //        return new SecureHttpMethodResponse(method, httpClient.getHostConfiguration(),
    // encryptionUtils);
    //    }
    //
    ...
    //        {
    //            return encryptionUtils.authenticateResponse(method, hostConfig.getHost(),
    // decryptedBody);
    //        }
    //
