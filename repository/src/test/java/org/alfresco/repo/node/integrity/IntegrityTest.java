...
public class IntegrityTest extends TestCase {
  ...
  public static final String NAMESPACE =
    "http://www.alfresco.org/test/IntegrityTest";
  public static final String TEST_PREFIX = "integrity-test";

  public static final QName TEST_TYPE_WITHOUT_ANYTHING = QName.createQName(
    NAMESPACE,
    "typeWithoutAnything"
  );
  public static final QName TEST_TYPE_WITH_ASPECT = QName.createQName(
    NAMESPACE,
    "typeWithAspect"
  );
  public static final QName TEST_TYPE_WITH_PROPERTIES = QName.createQName(
    NAMESPACE,
    "typeWithProperties"
  );
  public static final QName TEST_TYPE_WITH_ENCRYPTED_PROPERTIES = QName.createQName(
    NAMESPACE,
    "typeWithEncryptedProperties"
  );
  public static final QName TEST_TYPE_WITH_ASSOCS = QName.createQName(
    NAMESPACE,
    "typeWithAssocs"
  );
  public static final QName TEST_TYPE_WITH_CHILD_ASSOCS = QName.createQName(
    NAMESPACE,
    "typeWithChildAssocs"
  );
  public static final QName TEST_TYPE_WITH_NON_ENFORCED_CHILD_ASSOCS = QName.createQName(
    NAMESPACE,
    "typeWithNonEnforcedChildAssocs"
  );
  public static final QName TEST_TYPE_WITH_NON_ENFORCED_TARGET_ASSOCS = QName.createQName(
    NAMESPACE,
    "typeWithNonEnforcedTargetAssocs"
  );

  public static final QName TEST_ASSOC_NODE_ZEROMANY_ZEROMANY = QName.createQName(
    NAMESPACE,
    "assoc-0to* - 0to*"
  );
  public static final QName TEST_ASSOC_CHILD_ZEROMANY_ZEROMANY = QName.createQName(
    NAMESPACE,
    "child-0to* - 0to*"
  );
  public static final QName TEST_ASSOC_NODE_ONE_ONE = QName.createQName(
    NAMESPACE,
    "assoc-1to1 - 1to1"
  );
  public static final QName TEST_ASSOC_NODE_ONE_MANY = QName.createQName(
    NAMESPACE,
    "assoc-1to1 - 0to*"
  );
  public static final QName TEST_ASSOC_CHILD_ONE_ONE = QName.createQName(
    NAMESPACE,
    "child-1to1 - 1to1"
  );
  public static final QName TEST_ASSOC_ASPECT_ONE_ONE = QName.createQName(
    NAMESPACE,
    "aspect-assoc-1to1 - 1to1"
  );
  public static final QName TEST_ASSOC_CHILD_NON_ENFORCED = QName.createQName(
    NAMESPACE,
    "child-non-enforced"
  );
  public static final QName TEST_ASSOC_TARGET_NON_ENFORCED = QName.createQName(
    NAMESPACE,
    "target-non-enforced"
  );

  public static final QName TEST_ASPECT_WITH_PROPERTIES = QName.createQName(
    NAMESPACE,
    "aspectWithProperties"
  );
  public static final QName TEST_ASPECT_WITH_ASSOC = QName.createQName(
    NAMESPACE,
    "aspectWithAssoc"
  );
  public static final QName TEST_ASPECT_WITH_ASPECT = QName.createQName(
    NAMESPACE,
    "aspectWithAspect"
  );

  public static final QName TEST_PROP_TEXT_A = QName.createQName(
    NAMESPACE,
    "prop-text-a"
  );
  public static final QName TEST_PROP_TEXT_B = QName.createQName(
    NAMESPACE,
    "prop-text-b"
  );
  public static final QName TEST_PROP_TEXT_C = QName.createQName(
    NAMESPACE,
    "prop-text-c"
  );
  public static final QName TEST_PROP_TEXT_D = QName.createQName(
    NAMESPACE,
    "prop-text-d"
  );
  public static final QName TEST_PROP_INT_A = QName.createQName(
    NAMESPACE,
    "prop-int-a"
  );
  public static final QName TEST_PROP_INT_B = QName.createQName(
    NAMESPACE,
    "prop-int-b"
  );
  public static final QName TEST_PROP_INT_C = QName.createQName(
    NAMESPACE,
    "prop-int-c"
  );
  public static final QName TEST_PROP_ENCRYPTED_A = QName.createQName(
    NAMESPACE,
    "prop-encrypted-a"
  );
  public static final QName TEST_PROP_ENCRYPTED_B = QName.createQName(
    NAMESPACE,
    "prop-encrypted-b"
  );
  public static final QName TEST_PROP_ENCRYPTED_C = QName.createQName(
    NAMESPACE,
    "prop-encrypted-c"
  );
  ...
  public void setUp() throws Exception {
    ...
    InputStream modelStream = cl.getResourceAsStream(
      "org/alfresco/repo/node/integrity/IntegrityTest_model.xml"
    );
    ...
    MetadataEncryptor encryptor = (MetadataEncryptor) ctx.getBean(
      "metadataEncryptor"
    );
   ...
   */
  private void checkIntegrityExpectFailure(
    String failureMsg,
    int expectedCount
  ) {
    try {
  ...
  public void testCreateWithNullMandatoryProperty() throws Exception {
    ...
    checkIntegrityExpectFailure(
      "Failed to detect null mandatory properties",
      1
    );
  }
  ...
  public void testCreateWithIncorrectListValue() throws Exception {
    ...
    checkIntegrityExpectFailure(
      "Failed to detect incorrect LoV without trailing space",
      1
    );
  }
  ...
  public void testMandatoryPropertiesRemoved() throws Exception {
    ...
    checkIntegrityExpectFailure(
      "Failed to detect missing removed properties",
      1
    );
  }
  ...
  public void testCreateWithoutEncryption() throws Exception {
    ...
    try {
      ...
      fail(
        "Current detection of unencrypted properties is done by NodeService."
      );
    } catch (Throwable e) {
      // Expected
    }
  ...
  public void testCreateWithoutPropertiesForAspect() throws Exception {
    ...
    checkIntegrityExpectFailure(
      "Failed to detect missing properties for aspect",
      1
    );
  }
  ...
  public void testCreateWithAspectForAspect() throws Exception {
    ...
    nodeService.removeAspect(nodeRef, TEST_ASPECT_WITH_PROPERTIES);
    checkIntegrityExpectFailure(
      "Failed to detect missing aspect for aspect",
      1
    );
  }
  ...
  public void testCreateTargetOfAssocsWithMandatorySourcesPresent()
    ...
    NodeRef targetAndChild = createNode(
      "targetAndChild",
  ...
  public void testCreateTargetOfAssocsWithMandatorySourcesMissing()
    ...
    logger.error(
      "Method commented out: testCreateTargetOfAssocsWithMandatorySourcesMissing"
    );
  }
  ...
  public void testCreateSourceOfAssocsWithMandatoryTargetsPresent()
    ...
    NodeRef aspectSource = createNode(
      "aspectSource",
      TEST_TYPE_WITHOUT_ANYTHING,
      null
    );
    nodeService.addAspect(aspectSource, TEST_ASPECT_WITH_ASSOC, null);
    NodeRef aspectTarget = createNode(
      "aspectTarget",
      TEST_TYPE_WITHOUT_ANYTHING,
      null
    );
  ...
  public void testRemoveTargetsOfMandatoryAssocs() throws Exception {
    ...
    checkIntegrityExpectFailure(
      "Failed to detect removal of mandatory assoc targets",
      3
    );
  }
  ...
  public void testExcessTargetsOfOneToOneAssocs() throws Exception {
    ...
    nodeService.addAspect(aspectSource, TEST_ASPECT_WITH_ASSOC, null);
    NodeRef aspectTarget1 = createNode(
      "aspectTarget1",
      TEST_TYPE_WITHOUT_ANYTHING,
      null
    );
    NodeRef aspectTarget2 = createNode(
      "aspectTarget2",
      TEST_TYPE_WITHOUT_ANYTHING,
      null
    );
    ...
    checkIntegrityExpectFailure(
      "Failed to detect excess target cardinality for one-to-one assocs",
      3
    );
  }
  ...
  public void testExcessTargetsOfOneToManyAssocs() throws Exception {
    ...
    checkIntegrityExpectFailure(
      "Failed to detect excess source cardinality for one-to-many assocs",
      1
    );
  }
