...
public class GetSiteMembershipCoreTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        dataUser.usingAdmin()
                .addUserToSite(moderatedSiteManager, moderatedSite, UserRole.SiteManager);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify get site membership for a site returns status 404 when personId does"
                            + " not exist.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site membership for a site returns status 404 when siteId does not"
                            + " exist.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site membership for a site returns status 404 when personId is not"
                            + " a site member.")
    public void getSiteMembershipForPersonThatIsNotSiteMember() throws Exception {
        restClient
                .authenticateUser(publicSiteManager)
                .withCoreAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is not able to retrieve site membership information of a"
                            + " private site member.")
    public void regularUserIsNotAbleToRetrieveSiteMembershipForPrivateSiteManager()
            throws Exception {
        restClient
                .authenticateUser(regularUser)
                .withCoreAPI()
                .usingUser(privateSiteManager)
                .getSiteMembership(privateSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(
                                RestErrorModel.RELATIONSHIP_NOT_FOUND,
                                privateSiteManager.getUsername(),
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is able to retrieve site membership information of a"
                            + " moderated site member.")
    public void regularUserGetsSiteMembershipForModeratedSiteMember() throws Exception {
        restSiteEntry =
                restClient
                        .authenticateUser(regularUser)
                        .withCoreAPI()
                        .usingUser(moderatedSiteManager)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if Admin user is able to retrieve site membership information of him.")
    ...
    public void getSiteMembershipAfterRemovingASiteMember() throws Exception {
        ...
        restClient
                ...
                .deleteSiteMember(publicSiteConsumer);
        restClient
                .authenticateUser(publicSiteManager)
                .withCoreAPI()
                .usingUser(publicSiteConsumer)
                .getSiteMembership(publicSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(
                                RestErrorModel.RELATIONSHIP_NOT_FOUND,
                                publicSiteConsumer.getUsername(),
                                publicSite.getTitle()));
    }
}
