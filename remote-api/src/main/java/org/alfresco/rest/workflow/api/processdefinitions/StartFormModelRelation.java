...
@RelationshipResource(
  name = "start-form-model",
  entityResource = ProcessDefinitionsRestEntityResource.class,
  title = "Start form model of a process definition"
)
public class StartFormModelRelation
  ...
  @Override
  @WebApiDescription(
    title = "Get Start Form Model of a Process Definition",
    description = "Get a paged list of the start form model of a process definition"
  )
  public CollectionWithPagingInfo<FormModelElement> readAll(
    String definitionId,
    Parameters parameters
  ) {
    return processDefinitions.getStartFormModel(
      definitionId,
