 ...
 *
 * <p>Results are {@link #skipResults skipped}, chopped into pages of {@link #pageSize appropriate
 * size} before the {@link #pageCount start page} and {@link #pageNumber number} are returned.
 *
 * @author Derek Hulley
 * @since 4.0
 */
public class CannedQueryPageDetails {
     ...
     *
     * <ul>
     *   <li><b>skipResults:</b> {@link #DEFAULT_SKIP_RESULTS}
     *   <li><b>pageSize:</b> {@link #DEFAULT_PAGE_SIZE}
     *   <li><b>pageNumber:</b> {@link #DEFAULT_PAGE_NUMBER}
     *   <li><b>pageCount:</b> {@link #DEFAULT_PAGE_COUNT}
     * </ul>
     */
     ...
     * </ul>
     *
     * @param skipResults results to skip before <i>page one</i> (default <b>{@link
     *     #DEFAULT_SKIP_RESULTS}</b>)
     * @param pageSize the size of each page (default <b>{@link #DEFAULT_PAGE_SIZE}</b>)
     */
     ...
     *     #DEFAULT_SKIP_RESULTS}</b>)
     * @param pageSize the size of each page (default <b>{@link #DEFAULT_PAGE_SIZE}</b>)
     * @param pageNumber the first page number to return (default <b>{@link
     *     #DEFAULT_PAGE_NUMBER}</b>)
     * @param pageCount the number of pages to return (default <b>{@link #DEFAULT_PAGE_COUNT}</b>)
     */
    ...
    /**
     * Calculate the number of results that would be required to satisy this paging request. Note
     * that the skip size can significantly increase this number even if the page sizes are small.
     *
