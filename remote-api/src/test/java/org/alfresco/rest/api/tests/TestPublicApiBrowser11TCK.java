 ...
 *
 */
public class TestPublicApiBrowser11TCK
  extends AbstractEnterpriseOpenCMIS11TCKTest {

  private static final String CMIS_URL =
    "http://{0}:{1}/{2}/api/{3}/{4}/cmis/versions/1.1/browser";
  ...
  public void before() throws Exception {
    ...
    clientContext =
      new OpenCMISClientContext(
        ...
        "admin",
        cmisParameters,
        getTestFixture().getJettyComponent().getApplicationContext()
      );
    overrideVersionableAspectProperties(
      getTestFixture().getJettyComponent().getApplicationContext()
    );
  }
}
