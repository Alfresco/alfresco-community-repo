...
public class RecordsManagementAdminServiceImplTest
  ...
  implements RecordsManagementModel, BeforeCreateReference, OnCreateReference {
      ...
      new RetryingTransactionCallback<Object>() {
        ...
        public Object execute() throws Throwable {
          ...
          for (QName createdCustomProperty : createdCustomProperties) {
            rmAdminService.removeCustomPropertyDefinition(
              createdCustomProperty
            );
          }
    ...
    doTestInTransaction(
      new Test<QName>() {
        ...
        public QName run() throws Exception {
          ...
          assertFalse(
            rmAdminService.existsCustomProperty(
              QName.createQName(
        ...
        public void test(QName result) throws Exception {
          try {
            ...
            Map<QName, PropertyDefinition> propDefs = rmAdminService.getCustomPropertyDefinitions(
              ASPECT_RECORD
            );
  ...
  public void testUseCustomProperty() throws Exception {
    ...
    doTestInTransaction(
      new Test<QName>() {
        @Override
        public QName run() throws Exception {
          NodeRef customInstance1 = nodeService
            .createNode(
              folder,
              ASSOC_CONTAINS,
              QName.createQName(
            ...
            .getChildRef();
          NodeRef customInstance2 = nodeService
            .createNode(
              folder,
              ASSOC_CONTAINS,
              QName.createQName(
          ...
          assertTrue(
            nodeService.hasAspect(
              customInstance1,
              QName.createQName(RM_CUSTOM_URI, "rmtcustomTypeCustomProperties")
            )
          );
          assertTrue(
            nodeService.hasAspect(
              ...
              QName.createQName(
                RM_CUSTOM_URI,
                "rmtcustomAspectCustomProperties"
              )
            )
          );
  ...
  private void createAndUseCustomReference(
    final RelationshipType refType,
    final String label,
    final String source,
    final String target
  ) throws Exception {
    final NodeRef testRecord1 = retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
          NodeRef result = utils.createRecord(
            rmFolder,
            "testRecordA" + System.currentTimeMillis()
          );
          return result;
        }
      }
    );
    final NodeRef testRecord2 = retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
          NodeRef result = utils.createRecord(
            rmFolder,
            "testRecordB" + System.currentTimeMillis()
          );
          return result;
        }
      }
    ...
    final QName generatedQName = retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<QName>() {
        public QName execute() throws Throwable {
          ...
          RelationshipDefinition relationshipDefinition = relationshipService.createRelationshipDefinition(
            displayName
          );

          // Get the qualified name
          QName qNameResult = QName.createQName(
            RM_CUSTOM_PREFIX,
          ...
          System.out.println(
            "Creating new " + refType + " reference definition: " + qNameResult
          );
          System.out.println(
            "  params- label: '" +
            label +
    ...
    retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          RelationshipDefinition relationshipDefinition = relationshipService.getRelationshipDefinition(
            generatedQName.getLocalName()
          );
          assertNotNull(
            "Relationship definition from relationshipService was null.",
    ...
    retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          List<AssociationRef> retrievedAssocs = nodeService.getTargetAssocs(
            testRecord1,
          ...
          if (RelationshipType.PARENTCHILD.equals(refType)) {
            for (ChildAssociationRef caRef : childAssocs) {
              ...
              if (generatedQName.equals(refInstanceQName)) newlyAddedRef =
                caRef;
            }
          } else {
          ...
          if (RelationshipType.PARENTCHILD.equals(refType)) {
            assertNotNull(
              "The customReference is not returned from the dictionaryService.",
      ...
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          List<ConstraintDefinition> constraints = rmAdminService.getCustomConstraintDefinitions(
            RecordsManagementCustomModel.RM_CUSTOM_MODEL
          );
          for (ConstraintDefinition constraint : constraints) {
            System.out.println("   - " + constraint.getName());
            System.out.println(
              "       " + constraint.getTitle(dictionaryService)
            );
          }
          return null;
        }
  ...
  public void testCreateReference() throws Exception {
    ...
    try {
      ...
      final Pair<NodeRef, NodeRef> testRecords = retryingTransactionHelper.doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Pair<NodeRef, NodeRef>>() {
          public Pair<NodeRef, NodeRef> execute() throws Throwable {
            NodeRef rec1 = utils.createRecord(
              rmFolder,
              "testRecordA" + System.currentTimeMillis()
            );
            NodeRef rec2 = utils.createRecord(
              rmFolder,
              "testRecordB" + System.currentTimeMillis()
            );
        ...
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            policyComponent.bindClassBehaviour(
              ...
              this,
              new JavaBehaviour(
                RecordsManagementAdminServiceImplTest.this,
  ...
  public void beforeCreateReference(
    NodeRef fromNodeRef,
    NodeRef toNodeRef,
    QName reference
  ) {
  ...
  public void testCreateCustomConstraints() throws Exception {
    final int beforeCnt = retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Integer>() {
    ...
    final QName testCon = retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<QName>() {
        public QName execute() throws Throwable {
          String conLocalName = "test-" + testRunID;

          final QName result = QName.createQName(
            RecordsManagementCustomModel.RM_CUSTOM_URI,
            conLocalName
          );

          rmAdminService.addCustomConstraintDefinition(
            result,
            conTitle,
            true,
            allowedValues,
        ...
        public Void execute() throws Throwable {
          ...
          for (ConstraintDefinition conDef : customConstraintDefs) {
            if (conDef.getName().equals(testCon)) {
              ...
              assertEquals(
                3,
                ((RMListOfValuesConstraint) con).getAllowedValues().size()
              );
    ...
    retryingTransactionHelper.doInTransaction(
      new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          QName propName = rmAdminService.addCustomPropertyDefinition(
            null,
            ASPECT_RECORD,
            propLocalName,
            dataType,
