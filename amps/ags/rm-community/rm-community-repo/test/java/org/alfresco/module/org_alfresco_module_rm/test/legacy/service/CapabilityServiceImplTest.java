        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        List<Capability> recordCapabilities =
                                capabilityService.getCapabilitiesByGroup(recordsGroup);
                        ...
                        List<Capability> ruleCapabilities =
                                capabilityService.getCapabilitiesByGroupId(rulesGroup.getId());
