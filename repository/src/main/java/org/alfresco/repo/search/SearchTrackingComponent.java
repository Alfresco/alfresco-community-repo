...
public interface SearchTrackingComponent {
    ...
    /**
     * Returns a list of diffs representing differences between the current Repository models and
     * those passed in the models parameter.
     *
     * @param models a set of mappings of model names to checksums
     * @return a list of diffs between those in the repository and those passed in the models
     *     parameter
     */
