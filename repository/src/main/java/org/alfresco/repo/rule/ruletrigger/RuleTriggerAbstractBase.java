...
public abstract class RuleTriggerAbstractBase implements RuleTrigger {
    ...
    /**
     * Helper method to allow triggers to check if rules are enabled or disabled (ALF-10839:
     * Eliminate rule discovery overhead on property update when rules have been disabled)
     *
    ...
    public void setIgnoredAspectsStr(List<String> ignoredAspects) {
        ...
        // If afterDictionaryInit#DictionaryListener is used for setting up ignored Aspects from
        // Spring context the
        // registerRuleTrigger#CreateNodeRuleTrigger is initialized before
        // afterDictionaryInit#DictionaryListener
