 ...
 * @since 4.2.1
 */
public class SubsystemChainingFtpAuthenticator
  extends AbstractChainingFtpAuthenticator {
  ...
  protected List<FTPAuthenticatorBase> getUsableFtpAuthenticators() {
    ...
    for (String instance : this.applicationContextManager.getInstanceIds()) {
      try {
        ...
        FTPAuthenticatorBase authenticator = (FTPAuthenticatorBase) context.getBean(
          sourceBeanName
        );
        ...
        if (
          !(authenticator instanceof ActivateableBean) ||
