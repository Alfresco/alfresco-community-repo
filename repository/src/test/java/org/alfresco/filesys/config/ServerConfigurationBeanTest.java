...
public class ServerConfigurationBeanTest {
  ...
  public void testDestroyWhenThreadPoolIsNull() throws Exception {
    ...
    Field threadPoolField = serverConf
      .getClass()
      .getDeclaredField("threadPool");
    threadPoolField.setAccessible(true);
    threadPoolField.set(serverConf, null);
    assertNull(
      "Test precondition failure - threadPool is not null",
      threadPoolField.get(serverConf)
    );
    ...
    try {
      ...
      fail(
        "Unable to cleanly destroy " +
        serverConf.getClass().getSimpleName() +
        " instance."
      );
    }
  }
