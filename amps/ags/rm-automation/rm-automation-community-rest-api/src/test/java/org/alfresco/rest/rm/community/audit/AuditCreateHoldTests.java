...
public class AuditCreateHoldTests extends BaseRMRestTest {
    ...
    /**
     * Given a new hold is created When I view the audit log Then an entry has been created in the
     * audit log which contains the following: name of the hold reason for hold user who created the
     * hold date the creation occurred
     */
    @Test
    ...
    /**
     * Given an unsuccessful create hold action When I view the audit log Then the create hold event
     * isn't audited
     */
    @Test
    ...
    /**
     * Given a new hold is created and then deleted When I view the audit log Then the create hold
     * entry still contains the initial details
     */
    @Test
    public void createHoldAuditEntryIsNotLost() {
        ...
        List<AuditEntry> auditEntries =
                rmAuditService.getAuditEntriesFilteredByEvent(getAdminUser(), CREATE_HOLD);
        ...
        List<AuditEntry> auditEntriesAfterDelete =
                rmAuditService.getAuditEntriesFilteredByEvent(getAdminUser(), CREATE_HOLD);
    ...
    /**
     * Given a new hold is created When I view the audit log as an user with no Read permissions
     * over the created hold Then the create hold entry isn't visible
     */
    @Test
    public void createHoldAuditEntryNotVisible() {
        ...
        STEP(
                "Check that an user with no Read permissions over the hold can't see the entry for"
                        + " the create hold event");
        assertTrue(
                "The list of events should not contain Create Hold entry ",
