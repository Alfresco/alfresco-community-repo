...
public class StartWorkflowActionExecuter extends ActionExecuterAbstractBase {
  ...
  public static final String PARAM_START_TASK_TRANSITION =
    "startTaskTransition";
  ...
  protected void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
    ...
    String workflowName = (String) ruleAction.getParameterValue(
      PARAM_WORKFLOW_NAME
    );
    ...
    Boolean endStartTask = (Boolean) ruleAction.getParameterValue(
      PARAM_END_START_TASK
    );
    String startTaskTransition = (String) ruleAction.getParameterValue(
      PARAM_START_TASK_TRANSITION
    );
