...
public class InMemoryTicketComponentTest {
  ...
  private void checkEqualsAndHashCode(
    ...
    InMemoryTicketComponentImpl.Ticket ticket1 = new InMemoryTicketComponentImpl.Ticket(
      expireMode,
      someDate,
      randomUserName,
      validDuration
    );
    InMemoryTicketComponentImpl.Ticket ticket2 = new InMemoryTicketComponentImpl.Ticket(
      expireMode,
      someDate,
      randomUserName,
      validDuration
    ...
    for (int i = 0; i < 100000; ++i) {
      InMemoryTicketComponentImpl.Ticket ticket = new InMemoryTicketComponentImpl.Ticket(
        expireMode,
        someDate,
        randomUserName,
        validDuration
  ...
  private void checkInvalidExpireDateParameter(
    ...
    try {
      ...
      fail(
        "expire date should not be allowed as null in this  expireMode case"
      );
