...
@XmlType(
        name = "Audit",
        propOrder = {"dataExtractors", "dataGenerators", "pathMappings", "application"})
public class Audit {
     ...
     *
     * @param value allowed object is {@link DataExtractors }
     */
     ...
     *
     * @param value allowed object is {@link DataGenerators }
     */
     ...
     *
     * @param value allowed object is {@link PathMappings }
     */
     ...
     * why there is not a <CODE>set</CODE> method for the application property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link Application }
     */
