...
public class CmisFunctionEvaluationContext
  ...
  public static BaseTypeId[] STRICT_SCOPES = new BaseTypeId[] {
    BaseTypeId.CMIS_DOCUMENT,
    BaseTypeId.CMIS_FOLDER,
  };

  public static BaseTypeId[] ALFRESCO_SCOPES = new BaseTypeId[] {
    BaseTypeId.CMIS_DOCUMENT,
    BaseTypeId.CMIS_FOLDER,
  ...
  static {
    ...
    EXPOSED_FIELDS.add(
      "d:" + DataTypeDefinition.CHILD_ASSOC_REF.getLocalName()
    );
  ...
  public Serializable getProperty(NodeRef nodeRef, String propertyName) {
    PropertyDefinitionWrapper propertyDef = cmisDictionaryService.findProperty(
      propertyName
    );
  ...
  public <Q, S, E extends Throwable> Q buildLuceneEquality(
    ...
    return propertyDef
      ...
      .buildLuceneEquality(lqpa, value, mode, luceneFunction);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneGreaterThan(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneGreaterThan(lqpa, value, mode, luceneFunction);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneGreaterThanOrEquals(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneGreaterThanOrEquals(lqpa, value, mode, luceneFunction);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneIn(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneIn(lqpa, values, not, mode);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneInequality(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneInequality(lqpa, value, mode, luceneFunction);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneLessThan(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneLessThan(lqpa, value, mode, luceneFunction);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneLessThanOrEquals(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneLessThanOrEquals(lqpa, value, mode, luceneFunction);
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneLike(
    ...
    return propertyDef
      .getPropertyLuceneBuilder()
      .buildLuceneLike(lqpa, value, not);
  }
  ...
  public void checkFieldApplies(Selector selector, String propertyName) {
    PropertyDefinitionWrapper propDef = cmisDictionaryService.findPropertyByQueryName(
      propertyName
    );
    if (propDef == null) {
      if (EXPOSED_FIELDS.contains(propertyName)) {
        ...
        throw new CmisInvalidArgumentException(
          "Unknown column/property " + propertyName
        );
      }
    }

    TypeDefinitionWrapper typeDef = cmisDictionaryService.findTypeForClass(
      selector.getType(),
      validScopes
    );
    if (typeDef == null) {
      throw new CmisInvalidArgumentException(
        "Type unsupported in CMIS queries: " + selector.getAlias()
      );
    }
    ...
    if (typeDef.getPropertyById(propDef.getPropertyId()) == null) {
      throw new CmisInvalidArgumentException(
        "Invalid column for " +
        typeDef.getTypeDefinition(false).getQueryName() +
        "." +
        propertyName
      );
    }
