...
public class DownloadPost extends AbstractDownloadWebscript {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        if (MimetypeMap.MIMETYPE_JSON.equals(contentType)) {
            ...
            try {
                ...
                throw new WebScriptException(
                        Status.STATUS_INTERNAL_SERVER_ERROR, "Unexpected IOException", io);
            } catch (org.json.simple.parser.ParseException je) {
                throw new WebScriptException(
                        Status.STATUS_BAD_REQUEST, "Unexpected ParseException", je);
            }
        }
        ...
        NodeRef downloadNode =
                downloadService.createDownload(nodes.toArray(new NodeRef[nodes.size()]), true);
