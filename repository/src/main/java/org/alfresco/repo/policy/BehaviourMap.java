...
/*package*/ class BehaviourMap<B extends BehaviourBinding> {
    ...
    private Map<B, List<BehaviourDefinition<B>>> index =
            new HashMap<B, List<BehaviourDefinition<B>>>();

    /** The list of registered observers */
    private List<BehaviourChangeObserver<B>> observers =
            new ArrayList<BehaviourChangeObserver<B>>();
