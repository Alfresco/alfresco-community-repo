...
public interface QueryParserAdaptor<Q, S, E extends Throwable> {
   ...
   * @return Q
   */
  Q getLikeQuery(String field, String sqlLikeClause, AnalysisMode analysisMode)
    throws E;
   ...
   * @throws E
   */
  S buildSort(List<Ordering> list, FunctionEvaluationContext functionContext)
    throws E;
   ...
   * @throws E
   */
  Q getFuzzyQuery(String luceneFieldName, String term, Float minSimilarity)
    throws E;
   ...
   * @return Q
   */
  Q getWildcardQuery(String luceneFieldName, String term, AnalysisMode mode)
    throws E;
