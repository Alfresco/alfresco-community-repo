 ...
 *
 * <p>Persists the download reqest and then uses a local action service to execute the {@link
...
public class DownloadServiceImpl implements DownloadService {
    ...
    public NodeRef createDownload(final NodeRef[] requestedNodes, final boolean recursive) {
        ...
        // This is done in a new transaction to avoid node not found errors when the zip creation
        // occurs
                ...
                transactionHelper.doInTransaction(
                        new RetryingTransactionCallback<NodeRef>() {
                            ...
                            public NodeRef execute() throws Throwable {
                                ...
                                NodeRef downloadNode =
                                        downloadStorage.createDownloadNode(recursive);
    ...
    public void deleteDownloads(Date before, int batchSize, boolean cleanAllSysDownloadFolders) {
        List<List<DownloadEntity>> downloadPages =
                downloadStorage.getDownloadsCreatedBefore(
                        before, batchSize, cleanAllSysDownloadFolders);
