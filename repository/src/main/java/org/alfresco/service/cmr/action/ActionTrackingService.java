...
public interface ActionTrackingService {
    /**
     * Record that an action has been scheduled for asynchronous execution, and is pending being
     * executed.
     *
    ...
    /**
     * Record that an action against a <code>NodeRef</code> has been scheduled for asynchronous
     * execution, and is pending being executed.
     *
     * @param action the action that has been scheduled
     ...
     * Cancellable actions periodically check to see if a cancel has been requested, and will take
     ...
     * Requests that the specified Action cancel itself and aborts execution, as soon as possible.
     * Cancellable actions periodically check to see if a cancel has been requested, and will take
     * note of the cancel request once seen. If the specified action is not a cancellable action,
     * nothing will happen.
     *
    ...
    /**
     * Has cancellation been requested for the given action? This method is most commonly called by
     * the action in question, to check to see if someone has called {@link
     * #requestActionCancellation(CancellableAction)} for them.
     *
    ...
    /**
     * Retrieves the execution details on the given executing action, such as when it started, and
     * what machine it is executing on.
     *
    ...
    /**
     * Retrieve summary details of all instances of the specified action that are currently
     * executing.
     *
     * @return the execution summaries
     */
    ...
    /**
     * Retrieve summary details of all the actions of the given type acting on the given <code>
     * NodeRef</code> that are currently executing.
     *
     * @param type the action type
