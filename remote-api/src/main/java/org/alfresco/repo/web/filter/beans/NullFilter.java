...
/**
 * A Benign filter that does nothing more than invoke the filter chain. Allows strategic points of
 * the filter chain to be configured in and out according to the authentication subsystem in use.
 *
 * @author dward
 */
