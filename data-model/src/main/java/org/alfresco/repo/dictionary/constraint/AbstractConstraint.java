...
public abstract class AbstractConstraint implements Constraint {
  ...
  public static final String ERR_PROP_NOT_SET =
    "d_dictionary.constraint.err.property_not_set";
  ...
  public final void evaluate(Object value) {
    ...
    try {
      ...
      if (DefaultTypeConverter.INSTANCE.isMultiValued(value)) {
        Collection collection = DefaultTypeConverter.INSTANCE.getCollection(
          Object.class,
          value
        );
      ...
      throw new DictionaryException(
        AbstractConstraint.ERR_EVALUATE_EXCEPTION,
        this,
        e.getMessage()
      );
    }
