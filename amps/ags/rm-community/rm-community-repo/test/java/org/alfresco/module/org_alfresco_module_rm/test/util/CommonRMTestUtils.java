...
public class CommonRMTestUtils implements RecordsManagementModel {
   ...
   * test values
   */
  public static final String DEFAULT_DISPOSITION_AUTHORITY =
    "disposition authority";
  public static final String DEFAULT_DISPOSITION_INSTRUCTIONS =
    "disposition instructions";
  public static final String DEFAULT_DISPOSITION_DESCRIPTION =
  ...
  public CommonRMTestUtils(ApplicationContext applicationContext) {
    ...
    actionService =
      (RecordsManagementActionService) applicationContext.getBean(
        "RecordsManagementActionService"
      );
    modelSecurityService =
      (ModelSecurityService) applicationContext.getBean("ModelSecurityService");
    filePlanRoleService =
      (FilePlanRoleService) applicationContext.getBean("FilePlanRoleService");
    capabilityService =
      (CapabilityService) applicationContext.getBean("CapabilityService");
  ...
  public DispositionSchedule createBasicDispositionSchedule(NodeRef container) {
    return createBasicDispositionSchedule(
      container,
  ...
  public DispositionSchedule createDispositionSchedule(
    ...
    DispositionSchedule dispositionSchedule = dispositionService.createDispositionSchedule(
      container,
      dsProps
    );
   ...
   */
  private NodeRef createRecordImpl(
    NodeRef recordFolder,
    String name,
    Map<QName, Serializable> properties
  ) {
   ...
   */
  public NodeRef createNonElectronicRecord(
    NodeRef recordFolder,
    String name,
    String title
  ) {
        ...
        public Void doWork() throws Exception {
          ...
          try {
            nodeService.setProperty(
              record,
              RecordsManagementModel.PROP_DATE_FILED,
              new Date()
            );
            nodeService.setProperty(
              record,
            ...
            actionService.executeRecordsManagementAction(
              record,
              "declareRecord"
            );
          } finally {
  ...
  public Role createRole(
    ...
    return filePlanRoleService.createRole(
      filePlan,
      roleName,
      roleName,
      capabilities
  ...
  public void removeItemsFromHolds(
    List<NodeRef> holdNodeRefs,
    List<NodeRef> contentNodeRef
  ) {
