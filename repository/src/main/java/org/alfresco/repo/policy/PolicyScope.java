 ...
 * Policy scope.
 *
 * <p>Helper often used by policies which require information about a node to be gathered, for
 * example onCopy or onCreateVersion.
 *
...
public class PolicyScope extends AspectDetails {
    ...
    public void addChildAssociation(
            QName classRef, ChildAssociationRef childAssocRef, boolean alwaysTraverseAssociation) {
        if (classRef.equals(this.classRef) == true) {
    ...
    public boolean isChildAssociationRefAlwaysTraversed(
            QName classRef, ChildAssociationRef childAssocRef) {
 ...
 *
 * <p>Contains the details of an aspect this can be used for copying or versioning.
 *
 * @author Roy Wetherall
 */
/*package*/ class AspectDetails {
    ...
    protected Map<ChildAssociationRef, ChildAssociationRef> alwaysTraverseMap =
            new HashMap<ChildAssociationRef, ChildAssociationRef>();
     ...
     */
    protected void addChildAssociation(
            ChildAssociationRef childAssocRef, boolean alwaysTraverseAssociation) {
        addChildAssociation(childAssocRef);
