...
/**
 * I took the existing @see VersionNumberTest class and added some additional tests for
 * ModuleVersionNumber.
 *
 * @author Gethin James
 */
public class ModuleVersionNumberTest extends TestCase {
    ...
    // Tests that we can strip the suffixes such as "-M2", "-A12" or "-RC2" from versions
    // "7.0.0-M2", "6.2.2-A12", "7.1.0-RC2"
    ...
    public void testInternalVersionsAreUpgrades() {
        for (String[] pair : new String[][]
                // same base version with an optional special suffix (-A9, -M9, -RC9)
                {
                    ...
                    // standard maven compare - note sure these even make sense as these are not
                    // maven format versions!
