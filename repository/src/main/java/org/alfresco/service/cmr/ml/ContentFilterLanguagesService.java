...
public interface ContentFilterLanguagesService {
    ...
    /**
     * Get the the odered filter which results form an extract of availableLanguages on the
     * filterLanguages
     *
    ...
    /**
     * Since <code>java.util.Locale</code> uses and returns <b>old</b> ISO code and the
     * content-filter-lang.xml respects the <b>new ones</b>. This method convert new codes into old
     * codes:
     *
     * <p>(he, yi, and id) new codes to (iw, ji, and in) old codes
     *
    ...
    /**
     * Since <code>java.util.Locale</code> uses and returns <b>old</b> ISO code and the
     * content-filter-lang.xml respects the <b>new ones</b>. This method convert old codes into new
     * codes:
     *
     * <p>(iw, ji, and in) old codes to (he, yi, and id) new codes
     *
     * @param code the ISO language code to convert
