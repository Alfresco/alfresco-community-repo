...
public class ImapRenameMessagesTests extends EmailTest {
  ...
  public void siteManagerShouldVerifyFileContentForRenamedFileViaImap()
    throws Exception {
    testFile =
      dataContent
        .usingUser(testUser)
    ...
    renamedFile.setName(
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN).getName()
    );
    imapProtocol
      ...
      .existsInImap()
      .then()
      .renameMessageTo(renamedFile)
      .assertThat()
      .messageContentMatchesFileModelData(testFile);
  }
}
