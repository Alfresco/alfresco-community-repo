 ...
 * manifest to the specified TransferManifestProcessor
 *
 * @author Mark Rogers
 */
public class XMLTransferManifestReader extends DefaultHandler
            ...
            ;
        {
            ...
            if (elementName.equals(ManifestModel.LOCALNAME_TRANSFER_MAINIFEST)) {
                ...
                ContentData contentHeader =
                        new ContentData(contentURL, mimetype, size.longValue(), encoding, locale);
            ...
            ;
        {
            ...
            if (elementName.equals(ManifestModel.LOCALNAME_TRANSFER_MAINIFEST)) {
                ...
                ChildAssociationRef childAssociationRef =
                        new ChildAssociationRef(type, node.getNodeRef(), name, to, isPrimary, -1);
                ...
                List<ChildAssociationRef> parentAssocs =
                        (List<ChildAssociationRef>) props.get("parentAssocs");
                ChildAssociationRef childAssociationRef =
                        new ChildAssociationRef(type, from, name, node.getNodeRef(), isPrimary, -1);
                ...
                TransferManifestNormalNode node = (TransferManifestNormalNode) props.get("node");
                Map<NodeRef, ManifestCategory> categories =
                        (Map<NodeRef, ManifestCategory>) props.get("categories");
