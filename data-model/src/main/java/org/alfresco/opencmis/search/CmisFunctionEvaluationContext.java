...
public class CmisFunctionEvaluationContext implements FunctionEvaluationContext {
    ...
    public static BaseTypeId[] STRICT_SCOPES =
            new BaseTypeId[] {BaseTypeId.CMIS_DOCUMENT, BaseTypeId.CMIS_FOLDER};

    public static BaseTypeId[] ALFRESCO_SCOPES =
            new BaseTypeId[] {
    ...
    /** @param validScopes the valid scopes to set */
    ...
    public void checkFieldApplies(Selector selector, String propertyName) {
        PropertyDefinitionWrapper propDef =
                cmisDictionaryService.findPropertyByQueryName(propertyName);
        if (propDef == null) {
        ...
        TypeDefinitionWrapper typeDef =
                cmisDictionaryService.findTypeForClass(selector.getType(), validScopes);
        if (typeDef == null) {
