...
public class WithResponseTest {
  ...
  public void testDefaults() throws Exception {
    WithResponse callBack = new WithResponse(
      Status.STATUS_OK,
  ...
  public void testSetters() throws Exception {
    ...
    ContentInfo myContent = new ContentInfoImpl(
      Format.HTML.mimetype(),
      "UTF-16",
      12,
      Locale.FRENCH
    );
  ...
  public void testSetResponse() throws Exception {
    ...
    WithResponse wr = new WithResponse(
      Status.STATUS_OK,
      ResponseWriter.DEFAULT_JSON_CONTENT,
      ResponseWriter.CACHE_NEVER
    );
