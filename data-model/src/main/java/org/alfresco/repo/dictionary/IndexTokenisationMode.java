...
public enum IndexTokenisationMode {
    /**
     * Tokenise the property. If the analyser supported ordering then the field supports ordering
     * FTS is supported via analysis.
     */
    TRUE,
    ...
    public static IndexTokenisationMode deserializer(String value) {
        if (value == null) {
            ...
            throw new IllegalArgumentException("Invalid IndexTokenisationMode: " + value);
        }
    }
}
