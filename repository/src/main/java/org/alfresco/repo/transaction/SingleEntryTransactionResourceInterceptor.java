...
public class SingleEntryTransactionResourceInterceptor
   ...
   */
  public void setMethodResourceManagers(
    List<MethodResourceManager> methodResourceManagers
  ) {
   ...
   */
  public void setElapsedTimeBeforeActivationMillis(
    long elapsedTimeBeforeActivationMillis
  ) {
   ...
   */
  public void setResourceManagerCallFrequencyMillis(
    long resourceManagerCallFrequencyMillis
  ) {
    this.resourceManagerCallFrequencyMillis =
  ...
  public Object invoke(MethodInvocation invocation) throws Throwable {
    if (threadLocalReentryCheck.get() == Boolean.TRUE) {
      ...
      methodResourceManagers == null || methodResourceManagers.size() == 0
    ) {
  ...
  private Object invokeInternal(MethodInvocation invocation) throws Throwable {
    ...
    Map<Method, MethodStatistics> methodStatsByMethod = (Map<Method, MethodStatistics>) AlfrescoTransactionSupport.getResource(
      resourceKey
    );
