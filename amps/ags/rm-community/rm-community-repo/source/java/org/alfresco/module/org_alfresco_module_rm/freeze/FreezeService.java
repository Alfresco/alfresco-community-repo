...
public interface FreezeService
{
     ...
     *
     * @param nodeRef
     *            The nodeRef for which will be checked if it has frozen children
     ...
     *
     * @param nodeRef
     *            The nodeRef for which the date check will be performed
     ...
     *
     * @param nodeRef
     *            The nodeRef for which the initiator check will be performed
    ...
    /**
     * @deprecated as of 2.2, use {@link HoldService#createHold(NodeRef, String, String, String)} and {@link HoldService#addToHold(NodeRef, List)} instead.
     */
    @Deprecated
    ...
    /**
     * Check given node or its children are frozen The node should be record or record folder for retention schedule
     *
     * @param nodeRef
     */
