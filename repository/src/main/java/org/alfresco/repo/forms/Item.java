 ...
 *
 * <p>This class can be augmented with the item's type and a representational URL by the form
 * processor used to process the item.
 *
...
public class Item {
    ...
    /**
     * Returns the type of the item the form is for, could be a content model type, a workflow task
     * type, an XML schema etc.
     *
