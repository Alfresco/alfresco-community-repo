...
public final class SimplePermissionReference extends AbstractPermissionReference {
    ...
    // Use thread-safe map initiallized with a slightly larger capacity to reduce the posibility of
    // two or more threads attempting to resize at the same time
    private static ConcurrentMap<Pair<QName, String>, SimplePermissionReference> instances =
