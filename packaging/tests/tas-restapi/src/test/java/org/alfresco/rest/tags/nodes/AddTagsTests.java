...
public class AddTagsTests extends TagsDataPrep {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user adds multiple tags with Rest API and status code is 201")
    ...
    public void adminIsAbleToAddTags() throws Exception {
        ...
        returnedCollection
                .assertThat()
                .entriesListContains("tag", tag1)
                .and()
                .entriesListContains("tag", tag2);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify Manager user adds multiple tags with Rest API and status code is 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify Collaborator user adds multiple tags with Rest API and status code is"
                            + " 201")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user doesn't have permission to add multiple tags with Rest"
                            + " API and status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user adds multiple tags to his content with Rest API and"
                            + " status code is 201")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    public void contributorIsAbleToAddTagsToHisContent() throws Exception {
        ...
        returnedCollection =
                restClient.withCoreAPI().usingResource(contributorDoc).addTags(tag1, tag2);
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        returnedCollection
                .assertThat()
                .entriesListContains("tag", tag1)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user doesn't have permission to add multiple tags with Rest"
                            + " API and status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TAGS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify include count parameter")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    public void getTagsUsingCountParam() throws Exception {
        ...
        RestTagModelsCollection tagsWithIncludeParamCount =
                restClient.withParams("include=count").withCoreAPI().getTags();
