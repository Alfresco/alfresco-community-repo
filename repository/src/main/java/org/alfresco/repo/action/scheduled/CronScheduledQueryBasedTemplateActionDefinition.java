...
/**
 * A scheduled action for which the trigger is defined in the standard cron format and the nodes to
 * which the action should be run is defined from the nodes selected by query.
 *
 * @author Andy Hind
 */
