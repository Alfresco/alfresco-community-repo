...
public class GetPeoplePreferencesSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user gets its preferences with Rest API and response is"
                            + " successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify collaborator user gets its preferences with Rest API and response is"
                            + " successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify contributor user gets its preferences with Rest API and response is"
                            + " successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify consumer user gets its preferences with Rest API and response is"
                            + " successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify admin user gets another user preferences with Rest API and response is"
                            + " successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify manager user is NOT Authorized to gets its preferences with Rest API"
