 ...
 * declarations in the document. The net result is the same, i.e. given an XML document, a worker is
 * provided to the caller.
 *
 * @since 2.1
 * @author Derek Hulley
 */
public class RootElementNameContentWorkerSelector<W extends ContentWorker> extends DefaultHandler
    ...
    public String toString() {
        ...
        sb.append("RootElementNameContentWorkerSelector")
                .append("[ workers=")
                .append(workersByRootElementName)
                .append("]");
        return sb.toString();
    }

    /**
     * Optionally set the mimetypes supported. They must be XML formats that the chosen parser will
     * be able to handle.
     *
     ...
     *
     * @param workers a map of {@linkplain ContentWorker} instances keyed by root element name
     */
