    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          EventCompletionDetails eventDetails = dispositionAction.getEventCompletionDetails(
            CommonRMTestUtils.DEFAULT_EVENT_NAME
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() {
          ...
          // create disposition schedule
          DispositionSchedule mySchedule = utils.createBasicDispositionSchedule(
            recordCategory,
            "instructions",
            "authority",
            false,
        ...
        public void then() {
          ...
          eventDetails =
            dispositionAction.getEventCompletionDetails(ANOTHER_EVENT);
          assertNotNull(eventDetails);
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() {
          ...
          NodeRef recordCategory2 = filePlanService.createRecordCategory(
            filePlan,
            GUID.generate()
          );
          ...
          NodeRef recordFolder2 = recordFolderService.createRecordFolder(
            recordCategory2,
            GUID.generate()
          );
