...
public class GroupsTests extends RestTest {
    ...
    public void createListUpdateAndDeleteGroup() throws Exception {
        ...
        JsonObject groupBody =
                Json.createObjectBuilder()
                        .add("id", groupName)
                        .add("displayName", groupName)
                        .build();
        ...
        restClient
                ...
                .withCoreAPI()
                .usingGroups()
                .createGroup(groupBodyCreate);
        restClient.assertStatusCodeIs(HttpStatus.FORBIDDEN);
        // +ve
        restClient
                .authenticateUser(adminUser)
                .withCoreAPI()
                .usingParams("include=zones")
                .usingGroups()
                .createGroup(groupBodyCreate)
                .assertThat()
                .field("zones")
                .contains("APP.DEFAULT")
                .and()
                .field("isRoot")
                .is(true)
                .and()
        ...
        restClient
                .withCoreAPI()
                .usingParams("orderBy=displayName DESC&maxItems=10")
                .usingGroups()
                .listGroups()
                .assertThat()
                .entriesListContains("id", "GROUP_" + groupName)
                .and()
                .entriesListDoesNotContain("zones")
                .and()
        ...
        restClient
                .withCoreAPI()
                .usingGroups()
                .updateGroupDetails("GROUP_" + groupName, groupBodyUpdate)
                .assertThat()
                .field("displayName")
                .is("Z" + groupName)
                .and()
        ...
        restClient
                ...
                .usingParams("include=zones")
                .usingGroups()
                .getGroupDetail("GROUP_" + groupName)
                .assertThat()
                .field("id")
                .is("GROUP_" + groupName)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify creation, listing(only for person) and deletion of group memberships. ")
    public void createListDeleteGroupMembership() throws Exception {
        ...
        JsonObject groupMembershipBody =
                Json.createObjectBuilder()
                        .add("id", userModel.getUsername())
                        .add("memberType", "PERSON")
                        .build();
        ...
        restClient
                ...
                .withCoreAPI()
                .usingGroups()
                .createGroupMembership("GROUP_" + groupName, groupMembershipBodyCreate);
        restClient.assertStatusCodeIs(HttpStatus.FORBIDDEN);
        // +ve
        restClient
                .authenticateUser(adminUser)
        ...
        restClient
                .withCoreAPI()
                .usingGroups()
                .deleteGroupMembership("GROUP_" + groupName, userModel.getUsername());
        restClient.assertStatusCodeIs(HttpStatus.FORBIDDEN);
        // +ve
        restClient
                .authenticateUser(adminUser)
        ...
        restClient
                ...
                .listGroupMemberships()
                .assertThat()
                .entriesListDoesNotContain("id", "GROUP_" + groupName);
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
                ...
                new RetryOperation() {
                    public void execute() throws Exception {
                        restClient
                                .withCoreAPI()
                                .usingGroups()
                                .listGroupMemberships("GROUP_" + groupName)
                                .assertThat()
                                .entriesListContains("id", userModel.getUsername());
                        restClient.assertStatusCodeIs(HttpStatus.OK);
                    }
                };
