...
public class DeleteSiteMemberCoreTests extends RestTest {
  ...
  public void userIsNotAbleToRemoveMembershipOfInexistentSite()
    throws Exception {
  ...
  public void adminIsAbleToRemoveRegularUserSiteMembershipFromModeratedSite()
    throws Exception {
    restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
  ...
  public void adminIsAbleToRemoveRegularUserSiteMembershipFromPrivateSite()
    throws Exception {
    restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
  ...
  public void regularUserIsNotAbleToRemoveAdminSiteMembershipFromPublicSite()
    throws Exception {
    restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
  ...
  public void regularUserIsNotAbleToRemoveAdminSiteMembershipFromPrivateSite()
    throws Exception {
    restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
  ...
  public void adminIsAbleToRemoveManagerSiteMembershipOfPublicSite()
    throws Exception {
  ...
  public void adminIsAbleToRemoveManagerSiteMembershipOfModeratedSite()
    throws Exception {
    UserModel secondManager = dataUser.createRandomTestUser();
    secondManager.setUserRole(UserRole.SiteManager);
    restClient
  ...
  public void adminIsAbleToRemoveManagerSiteMembershipOfPrivateSite()
    throws Exception {
    UserModel secondManager = dataUser.createRandomTestUser();
    secondManager.setUserRole(UserRole.SiteManager);
    restClient
  ...
  public void userIsNotAbleToRemoveManagerSiteMembershipOfPublicSite()
    throws Exception {
    UserModel secondManager = dataUser.createRandomTestUser();
    secondManager.setUserRole(UserRole.SiteManager);
    restClient
  ...
  public void userIsNotAbleToRemoveManagerSiteMembershipOfModeratedSite()
    throws Exception {
    UserModel secondManager = dataUser.createRandomTestUser();
    secondManager.setUserRole(UserRole.SiteManager);
    restClient
  ...
  public void userIsNotAbleToRemoveManagerSiteMembershipOfPrivateSite()
    throws Exception {
    UserModel secondManager = dataUser.createRandomTestUser();
    secondManager.setUserRole(UserRole.SiteManager);
    restClient
