...
public interface ContentReader extends ContentAccessor {
     ...
     *
     * @return Returns the last modification time using the standard <tt>long</tt> time, or <code>0L
     *     </code> if the content doesn't {@link #exists() exist}.
     * @see System#currentTimeMillis()
     */
    public long getLastModified();

    /**
     * Convenience method to find out if this reader has been closed. Once closed, the content can
     * no longer be read. This method could be used to wait for a particular read operation to
     * complete, for example.
     *
     * @return Return true if the content input stream has been used and closed otherwise false.
     */
     ...
     *
     * <p>Once the stream is provided to a client it should remain active (subject to any timeouts)
    ...
    /**
     * Provides read-only, random-access to the underlying content. In general, this method should
     ...
     *
     * <p>Care must be taken that the bytes read from the stream are properly decoded according to
     * the {@link ContentAccessor#getEncoding() encoding} property.
     *
     ...
     * otherwise the default system <tt>byte[]</tt> to <tt>String</tt> conversion will be used.
     *
     * <p>All resources will be closed automatically.
     *
     * <p><b>WARNING: </b> This should only be used when the size of the content is known in
     * advance.
     *
    ...
    /**
     * Gets content from the repository direct to <code>String</code>, but limiting the string size
     ...
     * @throws ContentIOException
     * @throws java.lang.IllegalArgumentException if the length is < 0 or > {@link
     *     Integer#MAX_VALUE}
