...
public class NumericEncodingTest extends TestCase {
    ...
    public void testLongEncoding() {
        ...
        assertEquals(
                NumericEncoder.decodeLong(NumericEncoder.encode(Long.MIN_VALUE)), Long.MIN_VALUE);
        assertEquals(
        ...
        assertEquals(
                ...
                Long.MAX_VALUE - 1);
        assertEquals(
                NumericEncoder.decodeLong(NumericEncoder.encode(Long.MAX_VALUE)), Long.MAX_VALUE);
    }
