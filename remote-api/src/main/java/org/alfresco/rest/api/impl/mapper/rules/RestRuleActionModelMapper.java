...
{
    @Override
    public Action toRestModel(org.alfresco.service.cmr.action.Action serviceModel)
    {
        return null;
    }

    @Override
    public org.alfresco.service.cmr.action.Action toServiceModel(Action restModel)
    {
        return null;
    }
}
