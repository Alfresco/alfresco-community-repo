...
public abstract class TransactionalResourceHelper {
  ...
  public static final int getCount(Object resourceKey) {
    MutableInt counter = (MutableInt) AlfrescoTransactionSupport.getResource(
      resourceKey
    );
   ...
   */
  public static final int decrementCount(
    Object resourceKey,
  ...
  public static final <K, V> Map<K, V> getMap(Object resourceKey) {
    Map<K, V> map = AlfrescoTransactionSupport.<Map<K, V>>getResource(
      resourceKey
    );
    if (map == null) {
  ...
  public static final <V> TreeSet<V> getTreeSet(Object resourceKey) {
    TreeSet<V> set = AlfrescoTransactionSupport.<TreeSet<V>>getResource(
      resourceKey
    );
    if (set == null) {
      set = new TreeSet<V>();
