...
public class SearchLanguageConversion {
   ...
   * </ul>
   */
  public static LanguageDefinition DEF_SQL_LIKE = new SimpleLanguageDef(
    '\\',
    "%",
    "_",
    "\\%_[]"
   ...
   * </ul>
   */
  public static LanguageDefinition DEF_XPATH_LIKE = new SimpleLanguageDef(
    '\\',
    "%",
    "_",
    "\\%_[]"
  ...
  public static LanguageDefinition DEF_LUCENE_INTERNAL = new LuceneLanguageDef(
    false
  );
  ...
  public static String convert(
    LanguageDefinition from,
    LanguageDefinition to,
    String query
  ) {
