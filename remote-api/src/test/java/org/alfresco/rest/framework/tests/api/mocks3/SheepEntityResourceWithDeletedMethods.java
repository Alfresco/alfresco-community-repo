 ...
 *
 * <p>The original SheepEntityResource has actions: update, readById, readAll, delete, deleteSet
 * update, delete and deleteSet methods are marked as deleted readAll is untouched - (only present
 * in SheepEntityResource); readById is overridden.
 *
 * @author Gethin James
 */
public class SheepEntityResourceWithDeletedMethods extends SheepEntityResource {
    /**
     * @see org.alfresco.rest.framework.tests.api.mocks.SheepEntityResource#update(java.lang.String,
     *     org.alfresco.rest.framework.tests.api.mocks.Sheep)
     */
    @Override
    @WebApiDeleted
    ...
    /**
     * @see
     *     org.alfresco.rest.framework.tests.api.mocks.SheepEntityResource#readById(java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.rest.framework.tests.api.mocks.SheepEntityResource#deleteSet(java.lang.String)
     */
    @Override
    @WebApiDeleted
