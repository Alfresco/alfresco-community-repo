...
/**
 * Tests for {@link FileContentStore} that uses {@link VolumeAwareContentUrlProvider} to route
 * content from a store to a selection of filesystem volumes
 *
...
public class VolumeAwareFileContentStoreTest extends FileContentStoreTest {
    ...
    public void before() throws Exception {
        ...
        VolumeAwareContentUrlProvider volumeAwareContentUrlProvider =
                new VolumeAwareContentUrlProvider(VOLUMES);
