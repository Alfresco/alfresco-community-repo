...
public class SystemPropertiesSetterBeanTest extends TestCase {
  ...
  private static final String KEY_EXISTING =
    "SystemPropertiesSetterBeanTest.EXISTING ";
  private static final String KEY_PLACEHOLDER =
    "SystemPropertiesSetterBeanTest.PLACEHOLDER";
  private static final String KEY_EMPTY_STRING =
    "SystemPropertiesSetterBeanTest.EMPTY_STRING";
  ...
  public void setUp() throws Exception {
    ...
    propertyMap.put(
      KEY_EXISTING,
      "SHOULD NOT HAVE OVERRIDDEN EXISTING PROPERTY"
    );
  ...
  public void testSettingOfSystemProperties() {
    ...
    assertEquals(VALUE_EXISTING, System.getProperty(KEY_EXISTING));
    assertNull(
      "Property placeholder not detected",
      System.getProperty(KEY_PLACEHOLDER)
    );
    assertNull(
      "Empty string not detected",
      System.getProperty(KEY_EMPTY_STRING)
    );
