...
public interface FilePlanService
{
     ...
     *
     * @param type
     *            qualified name of content type
     ...
     *            file plan name
     * @param type
     *            type, must be rma:filePlan or sub-type of
    ...
    /**
     * Gets the <b>NodeRef</b> sequence from the {@link #getFilePlan(NodeRef) root} down to the fileplan component given. The array will start with the <b>NodeRef</b> of the root and end with the name of the fileplan component node given.
     *
     * @param nodeRef
     ...
     * @param deep
     *            if true then return all children including sub-categories and their children in turn, if false then just return the immediate children
     ...
     *            container node reference
     * @param deep
     *            if true then return all children including sub-containers and their children in turn, if false then just return the immediate children
     ...
     *
     * @param parent
     *            parent node reference, must be a record category or file plan.
     * @param name
     *            name of the new record category
     * @param type
     *            type of container to create, must be a sub-type of rm:recordCategory
