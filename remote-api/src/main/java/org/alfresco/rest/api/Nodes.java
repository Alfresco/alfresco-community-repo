...
public interface Nodes {
     ...
     *
     * @param parentFolderNodeId String id of parent folder node or well-known alias, eg. "-root-"
     *     or "-my-"
     * @param parameters the {@link Parameters} object to get the parameters passed into the request
     *     including: - filter, sort & paging params (where, orderBy, skipCount, maxItems) -
     ...
     *
     * <p>Note: may create a new version, depending on versioning behaviour.
     *
     * @param fileNodeId
     * @param contentInfo
     * @param stream
     ...
     * @return true if the type of the given nodeRef is a sub-class of another class, otherwise
     *     false
     */
     ...
     * @param attachment {@code true} if an attachment {@code URL} is requested, {@code false} for
     *     an embedded {@code URL}.
     ...
     * @return A direct access {@code URL} object for the content.
     */
    default DirectAccessUrl requestContentDirectUrl(
            String nodeId, boolean attachment, Long validFor) {
    ...
    /**
     * Convert from node properties (map of QName to Serializable) retrieved from the respository to
     * a map of String to Object that can be formatted/expressed as required by the API JSON
     * response for get nodes, get person etc.
     *
     * <p>Returns null if there are no properties to return, rather than an empty map.
     *
     * @param nodeProps
     * @param selectParam
     * @param mapUserInfo
     ...
     */
    Map<String, Object> mapFromNodeProperties(
    ...
    /**
     * Map from the JSON API format of properties (String to Object) to the typical node properties
     * map used by the repository (QName to Serializable).
     *
     * @param props
     * @return
     */
    ...
    /**
     * Returns the path to the given nodeRef {@code nodeRefIn} or the archived nodeRef {@code
     * archivedParentAssoc}.
     *
    ...
    /**
     * Map from a String representation of aspect names to a set of QName objects, as used by the
     * repository.
     *
     * @param aspectNames
     * @return
    ...
    /**
     * Map from aspects (Set of QName) retrieved from the repository to a map List of String
     * required that can be formatted/expressed as required by the API JSON response for get nodes,
     * get person etc.
     *
     * <p>Returns null if there are no aspect names to return, rather than an empty list.
     *
     * @param nodeAspects
     * @param excludedNS
     ...
     */
    List<String> mapFromNodeAspects(
            Set<QName> nodeAspects, List<String> excludedNS, List<QName> excludedAspects);

    /**
     * Add aspects to the specified NodeRef. Aspects that appear in the exclusions list will be
     * ignored.
     *
     * @param nodeRef
     * @param aspectNames
    ...
    /**
     * Update aspects for the specified NodeRef. An empty list will result in aspects being
    ...
    void validateAspects(
            List<String> aspectNames, List<String> excludedNS, List<QName> excludedAspects);

    void validateProperties(
            Map<String, Object> properties,
            List<String> excludedNS,
            List<QName> excludedProperties);
