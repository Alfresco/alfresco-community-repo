 ...
 *
 * <p>Manage secondary child associations (sometimes also known as multi-filing)
 *
 * <p>Please note, if you wish to manage primary child associations then please refer to other
 * endpoints, for example:
 *
 * <p>- to create primary child, use POST /nodes/{parentId}/children - to delete node (ie. primary
 * child), use DELETE /nodes/{nodeId} - to move a node from one primary parent to another, use POST
 * /nodes/{nodeId}/copy
 *
 * @author janv
 */
...
public class NodeSecondaryChildrenRelation extends AbstractNodeRelation
        ...
        if (assocTypeQNameParam.equals(RegexQNamePattern.MATCH_ALL)) {
            ...
            childAssocRefs =
                    nodeService.getChildAssocs(
                            parentNodeRef, assocTypeQNameParam, RegexQNamePattern.MATCH_ALL);
        }
