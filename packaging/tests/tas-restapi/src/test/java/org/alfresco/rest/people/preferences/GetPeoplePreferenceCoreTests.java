...
public class GetPeoplePreferenceCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user is Forbidden to get a specific preference for another user with"
                            + " Rest API and response is 403")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager fails to get a specific preference for an invalid user with"
                            + " Rest API and response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager fails to get a specific preference for an invalid preference"
                            + " with Rest API and response is 404")
                ...
                .containsSummary(
                        String.format(
                                "The relationship resource was not found for the entity with id: %s"
                                        + " and a relationship id of invalidPreferenceName",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager fails to get a specific preference for  removed preference with"
                            + " Rest API and response is 404")
