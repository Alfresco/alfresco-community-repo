 ...
 *
 * <p>Can be optionally filtered/sorted by (up to) three properties - note: sort applied in same
 * order as filter properties (if sort order is not null for given property)
 *
 * @author janv
 * @since 4.1.2
 */
