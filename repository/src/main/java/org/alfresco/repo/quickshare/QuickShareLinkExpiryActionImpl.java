 ...
 */
public class QuickShareLinkExpiryActionImpl extends ActionImpl
    ...
    public static final String QUICK_SHARE_LINK_EXPIRY_ACTION_NAME =
            "quickShareLinkExpiryActionName";
    ...
    public void setScheduleIntervalPeriod(IntervalPeriod period) {
        if (schedule == null) throw new IllegalStateException("Scheduling is not enabled.");
