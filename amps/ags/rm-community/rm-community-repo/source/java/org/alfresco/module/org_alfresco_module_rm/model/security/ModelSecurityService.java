...
public interface ModelSecurityService
{
     ...
     *
     * @param name
     *            name of the protected property
     ...
     * @return boolean true if the current user can edit the protected property or the property is not protected, false otherwise
     */
     ...
     *            node reference
     * @param aspect
     *            name of the of aspect
     * @return boolean true if the current user can edit the protected aspect or the the aspect is not protected, false otherwise
     */
