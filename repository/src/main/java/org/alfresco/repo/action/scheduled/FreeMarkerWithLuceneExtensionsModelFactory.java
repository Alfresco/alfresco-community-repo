...
public class FreeMarkerWithLuceneExtensionsModelFactory
  ...
  public Map<String, Object> getModel(NodeRef nodeRef) {
    ...
    TemplateNode companyRootNode = new TemplateNode(
      nodeRef,
      serviceRegistry,
      null
    );
  ...
  private static class LuceneDateRangeFunction
    ...
    public Object exec(List args) throws TemplateModelException {
      if (args.size() == 2) {
        ...
        builder.append("[");
        builder.append(
          DefaultTypeConverter.INSTANCE.convert(String.class, startDate)
        );
        builder.append(" TO ");
        builder.append(
          DefaultTypeConverter.INSTANCE.convert(String.class, endDate)
        );
        builder.append("]");
