...
public class FrozenCapabilityConditionUnitTest extends BaseUnitTest {
    ...
    public void frozenDontCheckChildren() {
        ...
        // is frozen
        when(mockedFreezeService.isFrozen(nodeRef)).thenReturn(true);
    ...
    public void notFrozenCheckChildrenNotFrozen() {
        ...
        // children not frozen
        when(mockedFreezeService.hasFrozenChildren(nodeRef)).thenReturn(false);
    ...
    public void notFrozenCheckChildrenFrozen() {
        ...
        // children frozen
        when(mockedFreezeService.hasFrozenChildren(nodeRef)).thenReturn(true);
