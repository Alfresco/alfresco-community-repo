...
public abstract class DialectUtil {
    /**
     * The placeholder for the configured <code>Dialect</code> class name:
     * <b>${db.script.dialect}</b>
     */
    public static final String PLACEHOLDER_DIALECT = "\\$\\{db\\.script\\.dialect\\}";

    /**
     * Replaces the dialect placeholder in the resource URL and attempts to find a file for it. If
     * not found, the dialect hierarchy will be walked until a compatible resource is found. This
    ...
    /**
     * Takes resource URL containing the {@link DialectUtil#PLACEHOLDER_DIALECT dialect placeholder
     * text} and substitutes the placeholder with the name of the given dialect's class.
     *
     * <p>For example:
     *
     * <pre>
