...
public class PropertyValueEntity {
  ...
  static {
    ...
    PERSISTED_TYPE_NULL =
      new Pair<Short, Serializable>(
        PersistedType.NULL.getOrdinalNumber(),
        new Long(0)
      );
    // Create the map of ordinal-type
    Map<Short, PersistedType> mapOrdinal = new HashMap<Short, PersistedType>(
      15
    );
  ...
  public int hashCode() {
    return (
      (actualTypeId == null ? 0 : actualTypeId.intValue()) +
  ...
  public boolean equals(Object obj) {
    if (this == obj) {
      ...
      return (
        EqualsHelper.nullSafeEquals(this.actualTypeId, that.actualTypeId) &&
    ...
    switch (persistedTypeEnum) {
      ...
      case STRING:
        if (
          ...
          return converter.convert(
            actualType,
            PropertyStringValueEntity.EMPTY_STRING
          );
        } else {
      ...
      default:
        throw new IllegalStateException(
          "Should not be able to get through switch"
        );
    }
  }
