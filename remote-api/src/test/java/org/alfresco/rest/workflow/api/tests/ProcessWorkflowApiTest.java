...
public class ProcessWorkflowApiTest extends EnterpriseWorkflowTestApi {
  ...
  public void testCreateProcessInstanceWithId() throws Exception {
    ...
    org.activiti.engine.repository.ProcessDefinition processDefinition = activitiProcessEngine
      ...
      .processDefinitionKey(
        "@" + requestContext.getNetworkId() + "@activitiAdhoc"
      )
      .singleResult();
    ...
    ProcessInfo processRest = processesClient.createProcess(
      createProcessObject.toJSONString()
    );
    ...
    Map<String, Object> variables = activitiProcessEngine
      .getRuntimeService()
      .getVariables(processRest.getId());
    ...
    try {
      ...
      assertErrorSummary(
        "No workflow definition could be found with id 'unexisting'.",
        e.getHttpResponse()
      );
    }
  }
  ...
  public void testCreateProcessInstanceWithKey() throws Exception {
    ...
    try {
      ...
      assertErrorSummary(
        "No workflow definition could be found with key 'activitiAdhoc2'.",
        e.getHttpResponse()
      );
    }
  }
  ...
  public void testMethodNotAllowedURIs() throws Exception {
    ...
    response =
      publicApiClient.put("public", "processes", null, null, null, null, null);
  ...
  public void testCreateProcessInstanceWithItems() throws Exception {
    ...
    final ProcessInfo processRest = startAdhocProcess(
      requestContext,
      docNodeRefs
    );
    assertNotNull(processRest);

    final Map<String, Object> variables = activitiProcessEngine
      .getRuntimeService()
      .getVariables(processRest.getId());
    assertEquals(1, variables.get("bpm_priority"));
    final ActivitiScriptNode packageScriptNode = (ActivitiScriptNode) variables.get(
      "bpm_package"
    );
    ...
    TenantUtil.runAsUserTenant(
      new TenantRunAsWork<Void>() {
        @Override
        public Void doWork() throws Exception {
          List<ChildAssociationRef> documentList = nodeService.getChildAssocs(
            packageScriptNode.getNodeRef()
          );
          for (ChildAssociationRef childAssociationRef : documentList) {
            FavouriteDocument doc = getTestFixture()
              .getRepoService()
              .getDocument(
                requestContext.getNetworkId(),
          ...
          final Task task2 = activitiProcessEngine
            .getTaskService()
            .createTaskQuery()
            .processInstanceId(processRest.getId())
            .singleResult();
  ...
  public void testGetProcessInstanceById() throws Exception {
    ...
    try {
      ProcessInfo processInfo = processesClient.findProcessById(
        process.getId()
      );
      assertNotNull(processInfo);
      ...
      final Map<String, Object> variables = activitiProcessEngine
        .getRuntimeService()
        .getVariables(processInfo.getId());
      assertEquals(1, variables.get("bpm_priority"));
      ...
      assertEquals(
        processInstance.getStartActivityId(),
        processInfo.getStartActivityId()
      );
      assertNotNull(processInfo.getStartUserId());
      assertEquals(
        processInstance.getStartUserId(),
        processInfo.getStartUserId()
      );
      ...
      assertEquals(
        processInstance.getProcessDefinitionId(),
        processInfo.getProcessDefinitionId()
      );
  ...
  public void testDeleteProcessInstanceById() throws Exception {
    ...
    String tenantAdmin =
      ...
      "@" +
      requestContext.getNetworkId();
    final RequestContext adminContext = new RequestContext(
      requestContext.getNetworkId(),
      tenantAdmin
    );
    ...
    tenantAdmin =
      AuthenticationUtil.getAdminUserName() + "@" + anotherNetwork.getId();
    final RequestContext otherContext = new RequestContext(
      anotherNetwork.getId(),
      tenantAdmin
    );
    ...
    try {
      ...
      HistoricProcessInstance deletedInstance = activitiProcessEngine
        .getHistoryService()
        .createHistoricProcessInstanceQuery()
        .processInstanceId(process.getId())
        .singleResult();
      ...
      assertEquals(
        "deleted through REST API call",
        deletedInstance.getDeleteReason()
      );
  ...
  public void testGetProcessInstances() throws Exception {
    ...
    try {
      ...
      ListResponse<ProcessInfo> processList = processesClient.getProcesses(
        paramMap
      );
      ...
      activitiProcessEngine
        .getRuntimeService()
        .setVariables(process1.getId(), variablesToSet);
      paramMap = new HashMap<String, String>();
      paramMap.put(
        "where",
        "(variables/testVarDate = 'd_datetime " +
        ISO8601DateFormat.format(dateCal.getTime()) +
        "')"
      );
      processList = processesClient.getProcesses(paramMap);
      assertNotNull(processList);
      ...
      paramMap.put(
        "where",
        "(processDefinitionKey = 'activitiAdhoc' AND includeVariables = true)"
      );
      paramMap.put("maxItems", "1");
      paramMap.put("skipCount", "0");
      processList = processesClient.getProcesses(paramMap);
  ...
  @Test
  public void testGetProcessInstancesWithDifferentProcessDefs()
    throws Exception {
    final RequestContext requestContext = initApiClientWithTestUser();
  ...
  public void testGetProcessInstancesWithPaging() throws Exception {
    ...
    try {
      ...
      JSONObject processListJSONObject = processesClient.getProcessesJSON(
        params
      );
      assertNotNull(processListJSONObject);
      JSONObject paginationJSON = (JSONObject) processListJSONObject.get(
        "pagination"
      );
  ...
  public void testGetProcessInstancesWithSorting() throws Exception {
    ...
    final ProcessInfo process1 = startAdhocProcess(
      requestContext,
      null,
      "akey"
    );
    final ProcessInfo process2 = startAdhocProcess(
      requestContext,
      null,
      "bkey"
    );
    final ProcessInfo process3 = startAdhocProcess(
      requestContext,
      null,
      "aakey"
    );
  ...
  public void testGetProcessTasks() throws Exception {
    ...
    String otherPerson = getOtherPersonInNetwork(
      ...
      .getId();
    RequestContext otherPersonContext = new RequestContext(
      requestContext.getNetworkId(),
      otherPerson
    );
    ...
    try {
      ProcessesClient processesClient = publicApiClient.processesClient();
      Map<String, String> paramMap = new HashMap<String, String>();
      JSONObject tasksJSON = processesClient.getTasks(
        process1.getId(),
        paramMap
      );
      ...
      try {
        ...
        assertErrorSummary(
          "The entity with id: fakeid was not found",
          expected.getHttpResponse()
        );
      }
      ...
      activitiProcessEngine
        .getTaskService()
        .addCandidateUser(task.getId(), otherPersonContext.getRunAsUser());
  ...
  public void testGetProcessActivities() throws Exception {
    ...
    try {
      ProcessesClient processesClient = publicApiClient.processesClient();
      Map<String, String> paramMap = new HashMap<String, String>();
      JSONObject activitiesJSON = processesClient.getActivities(
        process1.getId(),
        paramMap
      );
      ...
      for (Object entry : entriesJSON) {
        ...
        activitiesMap.put(
          (String) activityJSONObject.get("activityDefinitionId"),
          activityJSONObject
        );
      }
      ...
      assertEquals(
        "startEvent",
        activityJSONObject.get("activityDefinitionType")
      );
      ...
      assertEquals(
        "Adhoc Task",
        activityJSONObject.get("activityDefinitionName")
      );
      assertEquals(
        "userTask",
        activityJSONObject.get("activityDefinitionType")
  ...
  public void getProcessImage() throws Exception {
    ...
    HttpResponse response = publicApiClient
      .processesClient()
      .getImage(processRest.getId());
    assertEquals(200, response.getStatusCode());
    cleanupProcessInstance(processRest.getId());
    try {
  ...
  public void testMNT12382() throws Exception {
    ...
    final MemberOfSite memberOfSite = currentNetwork
      .getSiteMemberships(initiator.getId())
      .get(0);
    ...
    requestContext =
      new RequestContext(currentNetwork.getId(), persons.get(0).getId());
    publicApiClient.setRequestContext(requestContext);
    ...
    requestContext =
      new RequestContext(currentNetwork.getId(), persons.get(2).getId());
    publicApiClient.setRequestContext(requestContext);
    try {
    ...
    requestContext =
      new RequestContext(currentNetwork.getId(), assignee.getId());
    publicApiClient.setRequestContext(requestContext);
  ...
  public void testGetProcessItems() throws Exception {
    ...
    ProcessesClient processesClient = publicApiClient.processesClient();
    JSONObject itemsJSON = processesClient.findProcessItems(
  ...
  public void testGetProcessItem() throws Exception {
    ...
    final String newProcessInstanceId = processRest.getId();
    ProcessesClient processesClient = publicApiClient.processesClient();
    JSONObject itemJSON = processesClient.findProcessItem(
      newProcessInstanceId,
      docNodeRefs[0].getId()
    );
  ...
  public void testAddProcessItem() throws Exception {
    ...
    try {
      ...
      // Add the item
      processesClient.addProcessItem(
        newProcessInstanceId,
        createItemObject.toJSONString()
      );

      // Fetching the item
      JSONObject itemJSON = publicApiClient
        .processesClient()
        .findProcessItem(newProcessInstanceId, docNodeRefs[0].getId());
      assertEquals(docNodeRefs[0].getId(), itemJSON.get("id"));
      assertEquals("Test Doc1", itemJSON.get("name"));
      assertEquals("Test Doc1 Title", itemJSON.get("title"));
      assertEquals("Test Doc1 Description", itemJSON.get("description"));
  ...
  public void testDeleteProcessItem() throws Exception {
    ...
    try {
      ...
      // Delete the item
      processesClient.deleteProcessItem(
        newProcessInstanceId,
        docNodeRefs[0].getId()
      );
      ...
      try {
        ...
        assertErrorSummary(
          "The entity with id: " + docNodeRefs[0].getId() + " was not found",
          expected.getHttpResponse()
        );
      }
  ...
  public void testDeleteProcessItemWithAdmin() throws Exception {
    ...
    final ProcessInfo processRestDefaultUser = startAdhocProcess(
      requestContext,
      docNodeRefs
    );
    try {
  ...
  public void testGetProcessVariables() throws Exception {
    ...
    try {
      ...
      JSONObject processvariables = publicApiClient
        .processesClient()
      ...
      try {
        processvariables =
          publicApiClient.processesClient().getProcessvariables("fakeid");
        fail("not found expected");
      } catch (PublicApiException e) {
        assertEquals(
          HttpStatus.NOT_FOUND.value(),
  ...
  protected void validateVariablesResponse(
    JSONObject processvariables,
    String user
  ) {
  ...
  public void testCreateVariablesPresentInModel() throws Exception {
    ...
    try {
      ...
      JSONObject result = publicApiClient
        .processesClient()
        .createVariables(processInstance.getId(), variablesArray);
      ...
      assertEquals(
        ...
        activitiProcessEngine
          .getRuntimeService()
          .getVariable(processInstance.getId(), "bpm_workflowPriority")
      );
    } finally {
  ...
  public void testUpdateProcessVariables() throws Exception {
    ...
    try {
      ...
      JSONObject resultEntry = publicApiClient
        .processesClient()
        .updateVariable(processId, "newVariable", variableJson);
      ...
      assertEquals(
        ...
        activitiProcessEngine
          .getRuntimeService()
          .getVariable(processId, "newVariable")
      );
      ...
      resultEntry =
        publicApiClient
          .processesClient()
          .updateVariable(processId, "stringVariable", variableJson);
      assertNotNull(resultEntry);
      ...
      assertEquals(
        ...
        activitiProcessEngine
          .getRuntimeService()
          .getVariable(processId, "stringVariable")
      );
      ...
      try {
        publicApiClient
          .processesClient()
          .updateVariable(processId, "newLongVariable", variableJson);
      ...
      resultEntry =
        publicApiClient
          .processesClient()
          .updateVariable(processId, "newNoValueVariable", variableJson);
      assertNotNull(resultEntry);
      result = (JSONObject) resultEntry.get("entry");
      ...
      assertNotNull(
        activitiProcessEngine
          .getRuntimeService()
          .getVariable(processId, "newNoValueVariable")
      );
  ...
  public void testUpdateInitiatorAndGetProcessVariables() throws Exception {
    ...
    try {
      ...
      NodeRef personRef = TenantUtil.runAsUserTenant(
        ...
        adminContext.getRunAsUser(),
        adminContext.getNetworkId()
      );

      JSONObject resultEntry = publicApiClient
        .processesClient()
        .updateVariable(processId, "initiator", variableJson);
      assertNotNull(resultEntry);
      final JSONObject updateInitiatorResult = (JSONObject) resultEntry.get(
        "entry"
      );
      ...
      assertNotNull(
        "Variable value should be returned",
        updateInitiatorResult.get("value")
      );
      ...
      publicApiClient.setRequestContext(adminContext);
      resultEntry =
        publicApiClient.processesClient().getProcessvariables(processId);
      assertNotNull(resultEntry);
  ...
  protected void validateVariableField(
    JSONObject processvariables,
    String name,
    String value
  ) {
  ...
  public void testUpdateProcessVariableWithWrongType() throws Exception {
    ...
    try {
      ...
      try {
        publicApiClient
          .processesClient()
          .updateVariable(processId, "wf_requiredApprovePercent", variableJson);
        fail("Exception expected");
      } catch (PublicApiException e) {
        assertEquals(
          HttpStatus.BAD_REQUEST.value(),
      ...
      assertEquals(
        ...
        activitiProcessEngine
          .getRuntimeService()
          .getVariable(processId, "wf_requiredApprovePercent")
      );
      ...
      resultEntry =
        publicApiClient
          .processesClient()
          .updateVariable(processId, "testVariable", variableJson);
      assertNotNull(resultEntry);
      result = (JSONObject) resultEntry.get("entry");
      ...
      assertEquals(
        ...
        activitiProcessEngine
          .getRuntimeService()
          .getVariable(processId, "testVariable")
      );
      ...
      resultEntry =
        publicApiClient
          .processesClient()
          .updateVariable(processId, "bpm_assignees", updateAssigneesJson);
      assertNotNull(resultEntry);
      ...
      try {
        publicApiClient
          .processesClient()
          .updateVariable(processId, "bpm_assignees", updateAssigneeJson);
        fail("Exception expected");
      } catch (PublicApiException e) {
        assertEquals(
          HttpStatus.BAD_REQUEST.value(),
      ...
      try {
        publicApiClient
          .processesClient()
          .updateVariable(processId, "bpm_assignees", variableJson);
        fail("Exception expected");
      } catch (PublicApiException e) {
        assertEquals(
          HttpStatus.BAD_REQUEST.value(),
  ...
  public void testDeleteProcessVariable() throws Exception {
    ...
    try {
      ...
      activitiProcessEngine
        .getRuntimeService()
        .setVariable(processId, "deleteMe", "This is a string");
      ...
      assertFalse(
        activitiProcessEngine
          .getRuntimeService()
          .hasVariable(processId, "deleteMe")
      );
      ...
      try {
        ...
        assertErrorSummary(
          "The entity with id: deleteMe was not found",
          expected.getHttpResponse()
        );
      }
    } finally {
  ...
  public void testDeleteProcessVariableUnexistingProcess() throws Exception {
    ...
    try {
      publicApiClient
        .processesClient()
        .deleteVariable("unexisting", "deleteMe");
      fail("Exception expected");
    } catch (PublicApiException expected) {
      assertEquals(
        HttpStatus.NOT_FOUND.value(),
  ...
  protected void completeAdhocTasks(
    String instanceId,
    ...
    try {
      for (String processInstanceId : processInstances) {
        ...
        try {
          activitiProcessEngine
            .getRuntimeService()
            .deleteProcessInstance(processInstanceId, null);
        } catch (Exception e) {
