...
/**
 * A simple pojo to hold data related to a {@link ContentModel#TYPE_FAILED_THUMBNAIL failed
 * thumbnail attempt}. A failed thumbnail attempt is when {@link CreateThumbnailActionExecuter
 * create-thumbnail} has been used to produce a thumbnail for content and that action has thrown an
 * exception. If a thumbnail was not attempted (e.g. due to unavailability of transformers) this is
 * not a failure in this context.
 *
...
public class FailedThumbnailInfo {
    ...
    public FailedThumbnailInfo(
            String thumbnailDefinitionName,
            Date failureDate,
            int failureCount,
            NodeRef failedThumbnailNode) {
    ...
    /**
     * Get the {@link NodeRef} of the {@link ContentModel#TYPE_FAILED_THUMBNAIL failedThumbnail}
     * node. Note that this is not the NodeRef which was not thumbnailed - that will be the primary
     * parent of this node.
     */
    ...
    public String toString() {
        return "FailedThumbnailInfo [thumbnailDefinitionName="
