...
public interface TransferDestinationReportModel extends TransferModel {
  static final String LOCALNAME_TRANSFER_DEST_REPORT =
    "transferDestinationReport";
  ...
  static final String TRANSFER_REPORT_MODEL_1_0_URI =
    "http://www.alfresco.org/model/transferDestinationReport/1.0";
}
