...
public abstract class AbstractQNameAwareCannedQueryFactory<R>
  ...
  protected CannedQueryPageDetails createCQPageDetails(
  ...
  protected Long getNodeId(NodeRef nodeRef) {
    ...
    if (nodePair == null) {
      throw new InvalidNodeRefException(
        "Node ref does not exist: " + nodeRef,
        nodeRef
      );
    }
   ...
   */
  public abstract static class PropertyBasedComparator<R>
