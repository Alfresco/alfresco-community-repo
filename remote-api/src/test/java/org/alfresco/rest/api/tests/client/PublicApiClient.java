...
public class PublicApiClient {
    ...
    if (userData != null) {
      ...
      if (binding == Binding.atom) {
        ...
        parameters.put(
          ...
          binding.getOpenCmisBinding().value()
        );
      ...
      if (objectFactoryName != null) {
        parameters.put(
          SessionParameter.OBJECT_FACTORY_CLASS,
          objectFactoryName
        );
      }
   ...
   * @return CmisSession
   */
  public CmisSession createCMISSession(
    String repositoryId,
    String username,
    String password
  ) {
    ...
    parameters.put(
      SessionParameter.ATOMPUB_URL,
      client.getCmisUrl(repositoryId, null)
    );
  ...
  public HttpResponse patch(
    ...
    try {
      HttpResponse response = client.patch(
        getRequestContext(),
        cmisBinding,
        version,
        cmisOperation
  ...
  public HttpResponse trace(
    ...
    try {
      HttpResponse response = client.trace(
        getRequestContext(),
        cmisBinding,
        version,
        cmisOperation
  ...
  public HttpResponse options(
    ...
    try {
      HttpResponse response = client.options(
        getRequestContext(),
        cmisBinding,
        version,
        cmisOperation
  ...
  public HttpResponse putBinary(
    ...
    HttpResponse response = client.putBinary(
      getRequestContext(),
      scope,
      version,
      entityCollectionName,
  ...
  public HttpResponse execute(RequestBuilder requestBuilder)
    throws IOException {
  ...
  public class AbstractProxy {
    ...
    public void checkErrorKeyResponse(
      ...
      if (errorKey != null && errorKey.contains("exception")) {
        ...
        List<RestErrorResponseDefault> httpErrorsFilteredByStatusCode = Arrays
          .asList(RestErrorResponseDefault.values())
          .stream()
          .filter(t ->
            t.getStatusCode() == expectedStatus && t.getDefaultMessage() != null
          )
          .collect(Collectors.toList());

        httpErrorsFilteredByStatusCode.add(
          RestErrorResponseDefault.DEFAULT_API_EXCEPTION
        );
  ...
  public class Sites extends AbstractProxy {
    ...
    public ListResponse<Site> getSites(Map<String, String> params)
      throws PublicApiException {
    ...
    public Site getSite(String siteId, int expectedStatus)
      throws PublicApiException {
    ...
    public Site createSite(Site site, int expectedStatus)
      throws PublicApiException {
    ...
    public SiteContainer getSingleSiteContainer(
      String siteId,
      String containerId
    ) throws PublicApiException {
      HttpResponse response = getSingle(
      ...
      SiteContainer siteContainer = SiteContainer.parseSiteContainer(
        siteId,
        (JSONObject) response.getJsonResponse().get("entry")
      );
    ...
    public SiteContainer updateSiteContainer(SiteContainer siteContainer)
      ...
      SiteContainer retSiteContainer = SiteContainer.parseSiteContainer(
        siteContainer.getSiteId(),
        (JSONObject) response.getJsonResponse().get("entry")
      );
    ...
    public void removeSiteContainer(SiteContainer siteContainer)
      throws PublicApiException {
      remove(
        "sites",
        siteContainer.getSiteId(),
    ...
    public ListResponse<SiteMember> getSiteMembers(
      String siteId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
    ...
    public SiteMember getSingleSiteMember(String siteId, String personId)
      ...
      HttpResponse response = getSingle(
        ...
        "members",
        personId,
        "Failed to get site member"
      );
      SiteMember retSiteMember = SiteMember.parseSiteMember(
        siteId,
        (JSONObject) response.getJsonResponse().get("entry")
      );
    ...
    public MemberOfSite updatePersonSite(
      String personId,
      ...
      MemberOfSite retSiteMember = MemberOfSite.parseMemberOfSite(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return retSiteMember;
    }

    public MemberOfSite createPersonSite(
      String personId,
      SiteMember siteMember
    ) throws PublicApiException {
      HttpResponse response = create(
    ...
    public FavouriteSite getSingleFavouriteSite(String personId, String siteId)
      ...
      FavouriteSite favouriteSite = FavouriteSite.parseFavouriteSite(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return favouriteSite;
    }

    public FavouriteSite updateFavouriteSite(
      String personId,
      FavouriteSite site
    ) throws PublicApiException {
      HttpResponse response = update(
    ...
    public FavouriteSite createFavouriteSite(
      String personId,
      FavouriteSite site
    ) throws PublicApiException {
      HttpResponse response = create(
    ...
    public ListResponse<SiteGroup> getGroups(
      String siteId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
      ...
      return SiteGroup.parseGroupMemberOfSites(
        siteId,
  ...
  public class SiteMembershipRequests extends AbstractProxy {
    ...
    public SiteMembershipRequest getSiteMembershipRequest(
      String personId,
      String siteId
    ...
    public SiteMembershipRequest createSiteMembershipRequest(
      ...
      SiteMembershipRequest ret = SiteMembershipRequest.parseSiteMembershipRequest(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return ret;
    }
    ...
    public void cancelSiteMembershipRequest(
      String personId,
      String siteMembershipRequestId
    ) throws PublicApiException {
      remove(
        "people",
        personId,
    ...
    public ListResponse<SiteMembershipRequest> getSiteMembershipRequests(
      ...
      if (response != null && response.getJsonResponse() != null) {
        JSONObject jsonList = (JSONObject) response
          .getJsonResponse()
          .get("list");
        if (jsonList != null) {
          return SiteMembershipRequest.parseSiteMembershipRequests(
  ...
  public class Favourites extends AbstractProxy {
    ...
    public ListResponse<Favourite> getFavourites(
      String personId,
      Map<String, String> params
    ) throws PublicApiException, ParseException {
      HttpResponse response = getAll(
    ...
    public Favourite getFavourite(String personId, String favouriteId)
      ...
      return Favourite.parseFavourite(
        (JSONObject) response.getJsonResponse().get("entry")
      );
    }
    ...
    public Favourite createFavourite(String personId, Favourite favourite)
      ...
      Favourite ret = Favourite.parseFavourite(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return ret;
    }
    ...
    public void removeFavourite(String personId, String favouriteId)
      throws PublicApiException {
      remove(
        "people",
        personId,
  ...
  public class People extends AbstractProxy {
    ...
    public Person getPerson(String personId, int expectedStatus)
      throws PublicApiException {
      HttpResponse response = getSingle(
        "people",
        personId,
    ...
    public Person create(Person person, int expectedStatus)
      throws PublicApiException {
      TestPeople.PersonJSONSerializer jsonizer = new TestPeople.PersonJSONSerializer(
        person
      );
      HttpResponse response = create(
        "people",
    ...
    public ListResponse<Preference> getPreferences(
      String personId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
    ...
    public Preference getPreference(String personId, String preferenceId)
      ...
      Preference pref = Preference.parsePreference(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return pref;
    }
    ...
    public Person updatePreference(String personId, Preference preference)
      ...
      Person retSite = Person.parsePerson(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return retSite;
    }
    ...
    public PersonNetwork getNetworkMembership(
      String personId,
      String networkId
    ) throws PublicApiException {
      HttpResponse response = getSingle(
      ...
      PersonNetwork networkMember = PersonNetwork.parseNetworkMember(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return networkMember;
    }

    public PersonNetwork updateNetworkMembership(
      String personId,
      ...
      PersonNetwork retNetwork = PersonNetwork.parseNetworkMember(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return retNetwork;
    }

    public PersonNetwork createNetworkMembership(
      String personId,
      PersonNetwork network
    ) throws PublicApiException {
      HttpResponse response = create(
        "people",
        personId,
    ...
    public void removeNetworkMembership(
      String personId,
      PersonNetwork networkMember
    ) throws PublicApiException {
      remove(
    ...
    public ListResponse<Activity> getActivities(
      String personId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
    ...
    public Activity getSingleActivity(String personId, String activityId)
      ...
      Activity activity = Activity.parseActivity(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return activity;
    }

    public Activity update(String personId, Activity activity)
      throws PublicApiException {
      HttpResponse response = update(
        "people",
        personId,
      ...
      Activity retActivity = Activity.parseActivity(
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return retActivity;
    }

    public Activity create(String personId, Activity activity)
      throws PublicApiException {
      HttpResponse response = create(
        "people",
        personId,
    ...
    public void remove(String personId, Activity activity)
      throws PublicApiException {
      remove(
        "people",
        personId,
    ...
    public HttpResponse getAvatar(
      ...
      HttpResponse response = getSingleWithDelayRetry(
        "people",
        personId,
        "avatar",
        null,
  ...
  public class Comments extends AbstractProxy {
    ...
    public Comment getTenantComment(String commentId)
      throws PublicApiException {
      HttpResponse response = getSingle(
        "comments",
        commentId,
      ...
      Comment comment = Comment.parseComment(
        null,
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return comment;
    ...
    public Comment updateTenantComment(Comment comment)
      throws PublicApiException {
      HttpResponse response = update(
        "comments",
        comment.getId(),
      ...
      Comment retComment = Comment.parseComment(
        null,
        (JSONObject) response.getJsonResponse().get("entry")
      );
      return retComment;
    ...
    public Comment createTenantComment(Comment comment)
      throws PublicApiException {
      HttpResponse response = create(
        "comments",
        null,
    ...
    public ListResponse<Comment> getNodeComments(
      String nodeId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
    ...
    public Comment updateNodeComment(
      String nodeId,
      String commentId,
      Comment comment
    ) throws PublicApiException {
    ...
    public Comment createNodeComment(String nodeId, Comment comment)
      throws PublicApiException {
      HttpResponse response = create(
        "nodes",
        nodeId,
    ...
    public void removeNodeComment(String nodeId, String commentId)
      throws PublicApiException {
      remove(
        "nodes",
        nodeId,
  ...
  public class Tags extends AbstractProxy {
    ...
    public ListResponse<Tag> getTags(Map<String, String> params)
      throws PublicApiException {
      HttpResponse response = getAll(
        "tags",
        null,
  ...
  public class Nodes extends AbstractProxy {
    ...
    public ListResponse<Tag> getNodeTags(
      String nodeId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
        ...
        null,
        params,
        "Failed to get node tags"
      );
      return Tag.parseTags(nodeId, response.getJsonResponse());
    }

    public void removeNodeTag(String nodeId, String tagId)
      throws PublicApiException {
    ...
    public NodeRating getNodeRating(String nodeId, String ratingId)
      throws PublicApiException {
      HttpResponse response = getSingle(
        "nodes",
        nodeId,
    ...
    public ListResponse<NodeRating> getNodeRatings(
      String nodeId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
    ...
    public NodeRating updateNodeRating(String nodeId, NodeRating nodeRating)
      ...
      NodeRating nodeRatingRet = NodeRating.parseNodeRating(
        nodeId,
        (JSONObject) response.getJsonResponse().get("entry")
      );
    ...
    public void removeNodeRating(String nodeId, NodeRating rating)
      throws PublicApiException {
      remove(
        "nodes",
        nodeId,
  ...
  public class Aspects extends AbstractProxy {
    ...
    public PublicApiClient.ListResponse<Aspect> getAspects(
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
        "aspects",
    ...
    public Aspect getAspect(String aspectId) throws PublicApiException {
      HttpResponse response = getAll(
        ...
        null,
        null,
        "Failed to get aspect"
      );
      return Aspect.parseAspect(
        (JSONObject) response.getJsonResponse().get("entry")
      );
    }
  }
  ...
  public class Types extends AbstractProxy {
    ...
    public PublicApiClient.ListResponse<Type> getTypes(
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
        "types",
  ...
  public static class ExpectedPaging {
    ...
    public int hashCode() {
      ...
      result =
        prime * result + ((totalItems == null) ? 0 : totalItems.hashCode());
      return result;
    }
    ...
    public static ExpectedPaging getExpectedPaging(
      ...
      int skip = skipCount != null
        ? skipCount
        : org.alfresco.rest.framework.resource.parameters.Paging.DEFAULT_SKIP_COUNT;
      int max = maxItems != null
        ? maxItems
        : org.alfresco.rest.framework.resource.parameters.Paging.DEFAULT_MAX_ITEMS;
      int expectedCount = -1;
      int end = skip + max;
      if (end < 0 || end > total) {
  ...
  public class CmisSession {
    ...
    public void deleteContent(String objectId, boolean refresh) {
      ...
      if (o instanceof Document) {
        ...
        throw new IllegalArgumentException(
          "Object does not exists or is not a document"
        );
      }
    }
    ...
    public ContentData getContent(String objectId) throws IOException {
      ...
      if (o instanceof Document) {
        ...
        throw new IllegalArgumentException(
          "Object does not exist or is not a document"
        );
      }
    }
    ...
    public ItemIterable<ObjectType> getTypeChildren(
      ...
      ItemIterable<ObjectType> res = session.getTypeChildren(
        typeId,
    ...
    public List<Tree<ObjectType>> getTypeDescendants(
      ...
      List<Tree<ObjectType>> res = session.getTypeDescendants(
        typeId,
        depth,
        includePropertyDefinitions
      );
    ...
    public List<CMISNode> query(
      ...
      ItemIterable<QueryResult> res = session.query(
        query,
        searchAllVersions,
        ctx
      );
      ...
      List<CMISNode> results = new ArrayList<CMISNode>(
        (int) res.getPageNumItems()
      );
    ...
    public List<Tree<FileableCmisObject>> getFolderTree(
      String folderId,
      int depth
    ) {
      CmisObject o = session.getObject(folderId);
    ...
    public Document createDocument(
      ...
      if (o instanceof Folder) {
        ...
        String objectTypeId = (String) properties.get(
        ...
        throw new IllegalArgumentException(
          "Parent does not exists or is not a folder"
        );
      }
    }
  ...
  public static class Paging {
    ...
    public int hashCode() {
      ...
      result =
        prime * result + ((skipCount == null) ? 0 : skipCount.hashCode());
      return result;
    }
  ...
  public static class ExpectedErrorResponse {
    ...
    public ExpectedErrorResponse setAdditionalState(
      Map<String, Object> additionalState
    ) {
      this.additionalState = additionalState;
      return this;
    ...
    public String toString() {
      ...
      sb
        .append("ExpectedErrorResponse [errorKey='")
        .append(errorKey)
        .append(", statusCode=")
        .append(statusCode)
        .append(", briefSummary='")
  ...
  public class Groups extends AbstractProxy {
    ...
    public GroupMember createGroupMember(
      ...
      if (response != null && response.getJsonResponse() != null) {
        JSONObject jsonEntity = (JSONObject) response
          .getJsonResponse()
          .get("entry");
        if (jsonEntity != null) {
    ...
    public Group getGroup(String groupId, int expectedStatus)
      throws PublicApiException {
  ...
  public class AuditApps extends AbstractProxy {
    ...
    public AuditApp getAuditApp(String applicationId)
      throws PublicApiException {
    ...
    public AuditApp getAuditApp(
      ...
      if (response != null && response.getJsonResponse() != null) {
        JSONObject jsonEntry = (JSONObject) response
          .getJsonResponse()
          .get("entry");
        if (jsonEntry != null) {
  ...
  public class Actions extends AbstractProxy {
    ...
    private ListResponse<ActionDefinition> parseActionDefinitions(
