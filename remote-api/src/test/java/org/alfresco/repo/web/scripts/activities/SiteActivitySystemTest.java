...
/**
 * Simple Activity Service system test (requires remote repo to be running) using site (membership)
 * activities
 *
 * @author janv
 */
...
public class SiteActivitySystemTest extends TestCase {
    ...
    public void test04GetSiteFeedsBefore() throws Exception {
        ...
        try {
            getSiteFeed(
                    site2, ticket,
                    0); // site 2 is private, hence only accessible to members or admins
        ...
        try {
            getSiteFeed(
                    site3, ticket,
                    0); // site 3 is private, hence only accessible to members or admins
    ...
    protected void getSiteFeed(String siteId, String ticket, int expectedCount) throws Exception {
        String url =
                WEBSCRIPT_ENDPOINT + URL_ACTIVITIES + URL_SITE_FEED + "/" + siteId + "?format=json";
    ...
    protected void getUserFeed(String userId, String ticket, boolean isAdmin, int expectedCount)
            throws Exception {
    ...
    protected void getUserFeed(
        ...
        sb.append(WEBSCRIPT_ENDPOINT)
                ...
                .append(isAdmin ? "/" + userId : "")
                . // optional
                append("?")
                .append(
                        (siteId != null)
                                ? UserFeedRetrieverWebScript.PARAM_SITE_ID + "=" + siteId + "&"
                                : "")
                . // optional
                append(
                        excludeThisUser
                                ? UserFeedRetrieverWebScript.PARAM_EXCLUDE_THIS_USER + "=true&"
                                : "")
                . // optional
                append(
                        excludeOtherUsers
                                ? UserFeedRetrieverWebScript.PARAM_EXCLUDE_OTHER_USERS + "=true&"
                                : "")
                . // optional
                append("format=json");
    ...
    public void test07AddAndUpdateMembershipsWithPause() throws Exception {
        if (!membersAddedUpdated) {
            ...
            // add pause - otherwise, activity service will not generate feed entries (since they
            // will have already left the site)
    ...
    protected void addAndUpdateMemberships(String siteId, String ticket, boolean includeUser4)
            throws Exception {
        ...
        if (includeUser4) {
            addMembership(siteId, user4, ticket, SiteModel.SITE_CONSUMER);
        }
        ...
        if (includeUser4) {
            updateMembership(siteId, user4, ticket, SiteModel.SITE_COLLABORATOR);
        }
    }

    protected void removeMemberships(String siteId, String ticket, boolean includeUser4)
            throws Exception {
        ...
        if (includeUser4) {
            removeMembership(siteId, user4, ticket);
        }
    }
    ...
    public void test10GetSiteFeedsAfterRemoveMemberships() throws Exception {
        ...
        getSiteFeed(
                site3, ticket,
                9); //  9 = 3 users, each with 1 join, 1 role change, 1 leave (not user 4)
    ...
    public void test11GetUserFeedsAfter() throws Exception {
        ...
        getUserFeed(
                user3, ticket, true,
                16); // 16 = (25 - 9) due to feed control - exclude site membership activities for
        // site 1
    ...
    private void addMembership(String siteId, String userName, String ticket, String role)
            throws Exception {
    ...
    private void updateMembership(String siteId, String userName, String ticket, String role)
            throws Exception {
        // Build the JSON membership object
        JSONObject membership = new JSONObject();
        membership.put("role", role);
    ...
    private void removeMembership(String siteId, String userName, String ticket) throws Exception {
        String url =
                WEBSCRIPT_ENDPOINT + URL_SITES + "/" + siteId + URL_MEMBERSHIPS + "/" + userName;
    ...
    private void addFeedControl(String userName, String siteId, String appToolId, String ticket)
            throws Exception {
    ...
    protected String callGetWebScript(String urlString, String ticket)
            throws MalformedURLException, URISyntaxException, IOException {
        return callOutWebScript(urlString, "GET", ticket);
    }

    protected String callDeleteWebScript(String urlString, String ticket)
            throws MalformedURLException, URISyntaxException, IOException {
        return callOutWebScript(urlString, "DELETE", ticket);
    }

    protected String callPostWebScript(String urlString, String ticket, String data)
            throws MalformedURLException, URISyntaxException, IOException {
        return callInOutWebScript(urlString, "POST", ticket, data);
    }

    protected String callPutWebScript(String urlString, String ticket, String data)
            throws MalformedURLException, URISyntaxException, IOException {
        return callInOutWebScript(urlString, "PUT", ticket, data);
    }

    private String callOutWebScript(String urlString, String method, String ticket)
            throws MalformedURLException, URISyntaxException, IOException {
    ...
    private String callInOutWebScript(String urlString, String method, String ticket, String data)
            throws MalformedURLException, URISyntaxException, IOException {
        return callInOutWeb(urlString, method, ticket, data, "application/json", null);
    }

    private String callInOutWeb(
            String urlString,
            String method,
            String ticket,
            String data,
    ...
    protected String callLoginWebScript(String serviceUrl, String username, String password)
            throws MalformedURLException, URISyntaxException, IOException {
    ...
    protected void createUser(String ticket, String username, String password)
