...
public abstract class AbstractMailActionExecuterTest {
  ...
  public static void setupTests(ApplicationContext appCtx) {
    TRANSACTION_SERVICE =
      appCtx.getBean("TransactionService", TransactionService.class);
    ACTION_SERVICE = appCtx.getBean("ActionService", ActionService.class);
    ACTION_EXECUTER =
      appCtx
        .getBean("OutboundSMTP", ApplicationContextFactory.class)
        .getApplicationContext()
        .getBean("mail", MailActionExecuter.class);
    PREFERENCE_SERVICE =
      appCtx.getBean("PreferenceService", PreferenceService.class);
    PERSON_SERVICE = appCtx.getBean("PersonService", PersonService.class);
    NODE_SERVICE = appCtx.getBean("NodeService", NodeService.class);
    AUTHORITY_SERVICE =
      appCtx.getBean("AuthorityService", AuthorityService.class);
    PERMISSION_SERVICE =
      appCtx.getBean("PermissionService", PermissionService.class);
    ...
    TenantUtil.runAsSystemTenant(
      new TenantRunAsWork<Object>() {
        ...
        public Object doWork() throws Exception {
          ...
          PREFERENCE_SERVICE.setPreferences(
            FRENCH_USER.getUsername(),
            preferences
          );
  ...
  private static String getUsersHomeTenant(String userName) {
    ...
    try {
      thisIsCloud =
        (
          Class.forName(
            "org.alfresco.module.org_alfresco_module_cloud.registration.RegistrationService"
          ) !=
          null
        );
  ...
  @Test
  public void testUnknownRecipientUnknownSender()
  ...
  @Test
  public void testUnknownRecipientUnknownSender_ToMany()
    throws IOException, MessagingException {
    ...
    mailAction.setParameterValue(
      MailActionExecuter.PARAM_TO_MANY,
      "some.bodyelse@example.com"
    );
  ...
  public void testFrenchRecipient() throws IOException, MessagingException {
    ...
    Serializable recipients = (Serializable) Arrays.asList(
      FRENCH_USER.getUsername()
    );
    String subject = "";
  ...
  protected MimeMessage sendMessage(
    String from,
    Serializable recipients,
    String subject,
    String template
  ) {
    Action mailAction = ACTION_SERVICE.createAction(MailActionExecuter.NAME);
   ...
   */
  @Test
  public void testSendMailActionForUserNameAsRecipient()
    throws IOException, MessagingException {
  ...
  @Test
  public void testUnknowRecipientAustralianSender()
    throws IOException, MessagingException {
  ...
  public void testSendingTestMessageWithNoCurrentUser() {
    try {
      ...
      final Action mailAction = ACTION_SERVICE.createAction(
        MailActionExecuter.NAME
      );
      mailAction.setParameterValue(
        MailActionExecuter.PARAM_TO,
        "some.body@eaxmple.com"
      );
      mailAction.setParameterValue(MailActionExecuter.PARAM_SUBJECT, "Testing");
      mailAction.setParameterValue(
  ...
  public void testPrepareEmailForDisabledUsers() throws MessagingException {
    ...
    try {
      ...
      groupName =
        AUTHORITY_SERVICE.createAuthority(AuthorityType.GROUP, "testgroup1");
      ...
      MimeMessage mm = txHelper.doInTransaction(
        new RetryingTransactionCallback<MimeMessage>() {
          @Override
          public MimeMessage execute() throws Throwable {
            return ACTION_EXECUTER
              .prepareEmail(mailAction, null, null, null)
              .getMimeMessage();
          }
        },
        true
  ...
  public void testPrepareEmailSubjectParams() {
    ...
    Pair<String, Locale> recipient = new Pair<String, Locale>(
      "test",
      Locale.ENGLISH
    );
    ...
    mailAction.setParameterValue(
      ...
      new Object[] { "Test", "Subject", "Params", "Object", "Array" }
    );
    Assert.assertNotNull(
      "We should support Object[] value for PARAM_SUBJECT_PARAMS",
      ACTION_EXECUTER.prepareEmail(mailAction, null, recipient, null)
    );
    ...
    Assert.assertNotNull(
      "We should support List<Object> value for PARAM_SUBJECT_PARAMS",
      ACTION_EXECUTER.prepareEmail(mailAction, null, recipient, null)
    );

    mailAction.setParameterValue(
      MailActionExecuter.PARAM_SUBJECT_PARAMS,
      "Test Subject Params Single String"
    );
    Assert.assertNotNull(
      "We should support String value for PARAM_SUBJECT_PARAMS",
      ACTION_EXECUTER.prepareEmail(mailAction, null, recipient, null)
    );

    mailAction.setParameterValue(MailActionExecuter.PARAM_SUBJECT_PARAMS, null);
    Assert.assertNotNull(
      "We should support null value for PARAM_SUBJECT_PARAMS",
      ACTION_EXECUTER.prepareEmail(mailAction, null, recipient, null)
    );
  }
  ...
  public void testUserWithNonExistingTenant() throws Exception {
    final String USER_WITH_NON_EXISTING_TENANT =
      "test_user_non_tenant@non_existing_tenant.com";
   ...
   */
  @Test
  public void testSendingToMultipleUsers()
    throws IOException, MessagingException {
    final String USER_1 = "recipient1";
    final String USER_2 = "recipient2";
    final String[] recipientsArray = {
      USER_1 + "@email.com",
      USER_2 + "@email.com",
    };
    final List<String> recipientsResult = new ArrayList<String>(
      Arrays.asList(recipientsArray)
    );
    ...
    try {
      ...
      Assert.assertEquals(
        ...
        1,
        ACTION_EXECUTER.getTestSentCount()
      );
      Assert.assertEquals(
        "All recipients should receive single message",
        2,
      ...
      Assert.assertTrue(
        "Both users should receive message",
        recipientsResult.contains(
          ((InternetAddress) message.getAllRecipients()[1]).getAddress()
        )
      );
    } finally {
      // tidy up
  ...
  public void testSendingToCarbonCopy() throws IOException, MessagingException {
    ...
    mailAction.setParameterValue(
      MailActionExecuter.PARAM_CC,
      "some.carbon@example.com"
    );
    mailAction.setParameterValue(
      MailActionExecuter.PARAM_BCC,
      "some.blindcarbon@example.com"
    );
   ...
   */
  @Test
  public void testSendingToUserWithMailAlikeName()
    throws IOException, MessagingException {
  ...
  public void testMultipleIdenticalEmailsToUser() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(
        "Must be received one letter on each recipient",
        users.length,
        ACTION_EXECUTER.getTestSentCount()
      );
      ...
      Assert.assertEquals(
        "One additional user was created, quantity of recipients GROUP_EVERYONE must be +1 user",
        1,
        after - before
      );
    } finally {
   ...
   */
  @Test
  public void testSendEmailByExternalUser()
    throws IOException, MessagingException {
    final Serializable recipients = (Serializable) Arrays.asList(
      BRITISH_USER.getUsername()
    );
    ...
    try {
      ...
      message =
        TenantUtil.runAsTenant(
          new TenantRunAsWork<MimeMessage>() {
            @Override
   ...
   */
  @Test
  public void testGetToUsersWhenSendingToGroup()
    throws IOException, MessagingException {
    String groupName = null;
    final String USER1 = "test_user1";
    final String USER2 = "test_user2";
    try {
      ...
      Assert.assertNotNull(message);
      Assert.assertEquals(
        "This email was sent to " + recipients,
   ...
   */
  @Test
  public void testSendingToArrayOfCarbonCopyAndBlindCarbonCopyUsers()
    throws MessagingException {
    Map<String, Serializable> params = new HashMap<String, Serializable>();
    String[] ccArray = { "cc_user1@example.com", "cc_user2@example.com" };
    String[] bccArray = {
      "bcc_user3@example.com",
      "bcc_user4@example.com",
      "bcc_user5@example.com",
    };
    ...
    Action mailAction = ACTION_SERVICE.createAction(
      MailActionExecuter.NAME,
      params
    );
    ACTION_EXECUTER.resetTestSentCount();
    ...
    Assert.assertTrue(
      ccs[0].toString().contains("cc_user1") &&
      ccs[1].toString().contains("cc_user2")
    );
    Assert.assertTrue(
      bccs[0].toString().contains("bcc_user3") &&
      bccs[1].toString().contains("bcc_user4") &&
   ...
   */
  @Test
  public void testSendingToListOfCarbonCopyAndBlindCarbonCopyUsers()
    throws MessagingException {
