...
public class RemoteCredentialsServiceImpl implements RemoteCredentialsService {
  ...
  private static Log logger = LogFactory.getLog(
    RemoteCredentialsServiceImpl.class
  );
   ...
   */
  private static String SHARED_CREDENTIALS_CONTAINER_NAME =
    "remote_credentials";
   ...
   */
  public void setCredentialsFactories(
    Map<String, RemoteCredentialsInfoFactory> factories
  ) {
  ...
  public void registerCredentialsFactory(
    ...
    if (logger.isDebugEnabled()) logger.debug(
      "Registering credentials factory for " +
      credentialsType +
      " of " +
      factory
    );
  ...
  private static QName SHARED_CREDENTIALS_CONTAINER_QNAME = QName.createQName(
  ...
  protected NodeRef getSharedContainerNodeRef(boolean required) {
    ...
    NodeRef container = SystemNodeUtils.getSystemChildContainer(
  ...
  private BaseCredentialsInfo createCredentials(
    ...
    RemoteCredentialsInfoFactory factory = credentialsFactories.get(
    ...
    Map<QName, Serializable> properties = RemoteCredentialsInfoFactory.FactoryHelper.getCoreCredentials(
      credentials
    );
  ...
  public BaseCredentialsInfo getPersonCredentials(String remoteSystem) {
    ...
    // Grab the children
    List<ChildAssociationRef> credentials = nodeService.getChildAssocs(
      personContainer,
      RemoteCredentialsModel.ASSOC_CREDENTIALS,
  ...
  @Override
  public BaseCredentialsInfo updateCredentials(
    BaseCredentialsInfo credentials
  ) {
    if (credentials.getNodeRef() == null) {
      throw new IllegalArgumentException(
    ...
    Map<QName, Serializable> oldProps = nodeService.getProperties(
  ...
  private PagingResults<? extends BaseCredentialsInfo> listCredentials(
    ...
    if (credentialsType != null) {
      types =
        new HashSet<QName>(
          dictionaryService.getSubTypes(credentialsType, true)
        );
    ...
    // Wrap and return
    return new CredentialsPagingResults(
      wanted,
      credentials.size(),
      hasMore,
      remoteSystem
  ...
  protected static void setSharedCredentialsSystemContainerName(
    String container
  ) {
