...
public class PolicyComponentTransactionTest extends TestCase {
  ...
  private static ClassPolicyDelegate<SideEffectTestPolicy> sideEffectDelegate =
    null;
  ...
  protected void setUp() throws Exception {
    ...
    if (sideEffectDelegate == null) {
      sideEffectDelegate =
        policyComponent.registerClassPolicy(SideEffectTestPolicy.class);

      // Bind Behaviour to side effect policy
      QName policyName = QName.createQName(TEST_NAMESPACE, "sideEffect");
      Behaviour baseBehaviour = new JavaBehaviour(
        this,
        "sideEffectTest",
  ...
  private void createAndEnableBehaviours() {
    ...
    policyComponent.bindClassBehaviour(
      ...
      A_TYPE,
      new JavaBehaviour(aTypeBehavior, "onCreateNode")
    );
    policyComponent.bindClassBehaviour(
      OnUpdateNodePolicy.QNAME,
      A_TYPE,
      new JavaBehaviour(aTypeUpdateBehavior, "onUpdateNode")
    );
    // bind custom behavior for "middle" type
    policyComponent.bindClassBehaviour(
      OnCreateNodePolicy.QNAME,
      B_TYPE,
      new JavaBehaviour(bTypeBehavior, "onCreateNode")
    );
    policyComponent.bindClassBehaviour(
      OnUpdateNodePolicy.QNAME,
      B_TYPE,
      new JavaBehaviour(bTypeUpdateBehavior, "onUpdateNode")
    );
    // bind custom behavior for sub type
    policyComponent.bindClassBehaviour(
      OnCreateNodePolicy.QNAME,
      C_TYPE,
      new JavaBehaviour(cTypeBehavior, "onCreateNode")
    );
    policyComponent.bindClassBehaviour(
      OnUpdateNodePolicy.QNAME,
      C_TYPE,
      new JavaBehaviour(cTypeUpdateBehavior, "onUpdateNode")
    );
  ...
  public void testStartTransactionPolicy() throws Exception {
    ClassPolicyDelegate<StartTestPolicy> startDelegate = policyComponent.registerClassPolicy(
      StartTestPolicy.class
    );

    // Register Policy
    QName policyName = QName.createQName(TEST_NAMESPACE, "start");
    PolicyDefinition<Policy> definition = policyComponent.getRegisteredPolicy(
      PolicyType.Class,
      policyName
    );
    ...
    try {
      ...
      String baseResult1 = basePolicy.start(
        "1",
        "2",
        "value1a",
        "value2a",
      ...
      String baseResult2 = basePolicy.start(
        "2",
        "1",
        "value1b",
        "value2b",
      ...
      String baseResult3 = basePolicy.start(
        "1",
        "2",
        "value1c",
        "value2c",
  ...
  public void testEndTransactionPolicy() throws Exception {
    ClassPolicyDelegate<EndTestPolicy> endDelegate = policyComponent.registerClassPolicy(
      EndTestPolicy.class
    );
    ...
    try {
      ...
      String baseResult1 = basePolicy.end(
        "1",
        "2",
        "value1a",
        "value2a",
      ...
      String baseResult2 = basePolicy.end(
        "2",
        "1",
        "value1b",
        "value2b",
      ...
      assertEquals(0, results.size());
      String baseResult3 = basePolicy.end(
        "1",
        "2",
        "value1a",
        "value2c",
  ...
  public void behaviourHierarchyNodeTestWork(
    QName createDocType,
    QName... disableTypes
  ) throws Exception {
    UserTransaction transaction = trxService.getUserTransaction();
  ...
  public void testBehaviourHierarchyEnableAll1() throws Exception {
    ...
    assertTrue(
      "Behavior should be executed for a_type.",
      aTypeBehavior.isExecuted()
    );
    assertEquals(1, aTypeBehavior.getExecutionCount());
    assertFalse(
      "Behavior should not be executed for b_type.",
      bTypeBehavior.isExecuted()
    );
    assertEquals(0, bTypeBehavior.getExecutionCount());
    assertFalse(
      "Behavior should not be executed for c_type.",
      cTypeBehavior.isExecuted()
    );
  ...
  public void testBehaviourHierarchyNodeEnableAll1() throws Exception {
    ...
    assertTrue(
      "Behavior should be executed for a type.",
      aTypeUpdateBehavior.isExecuted()
    );
    assertEquals(1, aTypeUpdateBehavior.getExecutionCount());
    assertFalse(
      "Behavior should not be executed for b_type.",
      bTypeUpdateBehavior.isExecuted()
    );
    assertEquals(0, bTypeUpdateBehavior.getExecutionCount());
    assertFalse(
      "Behavior should not be executed for c_type.",
      cTypeUpdateBehavior.isExecuted()
    );
  ...
  public void testBehaviourHierarchyEnableAll2() throws Exception {
    ...
    assertEquals(1, aTypeBehavior.getExecutionCount());
    assertTrue(
      "Behavior should be executed for b_type.",
      bTypeBehavior.isExecuted()
    );
  ...
  public void testBehaviourHierarchyNodeEnableAll2() throws Exception {
    ...
    assertEquals(1, aTypeUpdateBehavior.getExecutionCount());
    assertTrue(
      "Behavior should be executed for b type.",
      bTypeUpdateBehavior.isExecuted()
    );
  ...
  public void testBehaviourHierarchyEnableAll3() throws Exception {
    ...
    assertEquals(1, bTypeBehavior.getExecutionCount());
    assertTrue(
      "Behavior should be executed for c_type.",
      cTypeBehavior.isExecuted()
    );
  ...
  public void testBehaviourHierarchyNodeEnableAll3() throws Exception {
    ...
    assertEquals(1, bTypeUpdateBehavior.getExecutionCount());
    assertTrue(
      "Behavior should be executed for c type.",
      cTypeUpdateBehavior.isExecuted()
    );
  ...
  public void testBehaviourHierarchyDisableAllUpHierarchy1() throws Exception {
    ...
    assertFalse(
      "Behavior should not be executed for a_type.",
      aTypeBehavior.isExecuted()
    );
   ...
   * @throws Exception
   */
  public void testBehaviourHierarchyDisableAllDownHierarchy1()
    throws Exception {
    behaviourHierarchyTestWork(
      A_TYPE,
   ...
   * @throws Exception
   */
  public void testBehaviourHierarchyDisableAllDownHierarchy2()
    throws Exception {
    behaviourHierarchyTestWork(
      B_TYPE,
      new ClassFilter(A_TYPE, true),
   ...
   * @throws Exception
   */
  public void testBehaviourHierarchyDisableAllDownHierarchy3()
    throws Exception {
    behaviourHierarchyTestWork(
      C_TYPE,
      new ClassFilter(A_TYPE, true),
  ...
  public void testBehaviourHierarchyDisableMiddle5() throws Exception {
    ...
    assertFalse(
      "Behavior should notbe executed for a_type.",
      aTypeBehavior.isExecuted()
    );
    assertEquals(0, aTypeBehavior.getExecutionCount());
    assertFalse(
    ...
    assertEquals(0, bTypeBehavior.getExecutionCount());
    assertFalse(
      "Behavior not should be executed for c_type.",
      cTypeBehavior.isExecuted()
    );
    assertEquals(0, cTypeBehavior.getExecutionCount());
  }
  ...
  public void testIsEnabled1() throws Exception {
    ...
    try {
      ...
      try {
        assertEquals(
          "Incorrect behaviour state: global: ",
          true,
          behaviourFilter.isEnabled()
        );
        // A_TYPE
        assertEquals(
          "Incorrect behaviour state: class: ",
          true,
          behaviourFilter.isEnabled(A_TYPE)
        );
        assertEquals(
          "Incorrect behaviour state: classAndInstance",
          true,
          behaviourFilter.isEnabled(companyHome, A_TYPE)
        );
        assertEquals(
          "Incorrect behaviour state: instance",
          true,
          behaviourFilter.isEnabled(companyHome)
        );
        // B_TYPE
        assertEquals(
          "Incorrect behaviour state: class: ",
          false,
          behaviourFilter.isEnabled(B_TYPE)
        );
        assertEquals(
          "Incorrect behaviour state: classAndInstance",
          false,
          behaviourFilter.isEnabled(companyHome, B_TYPE)
        );
        assertEquals(
          "Incorrect behaviour state: instance",
          true,
        ...
        assertEquals(
          "Incorrect behaviour state: class: ",
          false,
          behaviourFilter.isEnabled(C_TYPE)
        );
        assertEquals(
          "Incorrect behaviour state: classAndInstance",
          false,
          behaviourFilter.isEnabled(companyHome, C_TYPE)
        );
        assertEquals(
          "Incorrect behaviour state: instance",
          true,
  ...
  private void checkBehaviour(
    ...
    assertEquals(
      "Incorrect behaviour state: class: ",
      classEnabled,
      behaviourFilter.isEnabled(className)
    );
    assertEquals(
      "Incorrect behaviour state: classAndInstance",
      classInstanceEnabled,
      behaviourFilter.isEnabled(nodeRef, className)
    );
    assertEquals(
      "Incorrect behaviour state: instance",
      instanceEnabled,
      behaviourFilter.isEnabled(nodeRef)
    );
    assertEquals(
      "'Active' flag incorrect: ",
      !(
  ...
  public String startTransactionTest(
    String key1,
    String key2,
    String arg1,
    String arg2,
  ...
  public String endTransactionTest(
    String key1,
    String key2,
    String arg1,
    String arg2,
