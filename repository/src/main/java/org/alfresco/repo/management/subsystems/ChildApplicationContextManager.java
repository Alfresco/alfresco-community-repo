...
/**
 * A <code>ChildApplicationContextManager</code> manages a 'chain' of child application contexts,
 * perhaps corresponding to the components of a chained subsystem such as authentication. A <code>
 * ChildApplicationContextManager</code> may also support the dynamic modification of its chain.
 *
 * @author dward
 */
public interface ChildApplicationContextManager {
     ...
     *
     * @param id the identifier of the application context to retrieve
