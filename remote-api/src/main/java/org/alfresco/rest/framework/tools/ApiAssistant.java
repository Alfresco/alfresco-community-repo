...
public class ApiAssistant {
  ...
  public ErrorResponse resolveException(Exception ex) {
    ...
    if (ex instanceof WebScriptException) {
      error =
        webScriptExceptionResolver.resolveException((WebScriptException) ex);
    } else if (ex instanceof QueryParserException) {
      error =
        queryParserExceptionResolver.resolveException(
          (QueryParserException) ex
        );
    } else {
  ...
  public void setRestMetricsReporter(
    RestMetricsReporter restMetricsReporterImpl
  ) {
