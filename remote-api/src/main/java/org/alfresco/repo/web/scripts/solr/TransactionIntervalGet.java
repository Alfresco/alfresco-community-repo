...
public class TransactionIntervalGet extends DeclarativeWebScript {
  ...
  protected Map<String, Object> executeImpl(
    ...
    model.put(
      "minTransactionCommitTimeMs",
      nodeDAO.getMinTxInNodeIdRange(fromNodeId, toNodeId)
    );
    model.put(
      "maxTransactionCommitTimeMs",
      nodeDAO.getMaxTxInNodeIdRange(fromNodeId, toNodeId)
    );
    return model;
  }
