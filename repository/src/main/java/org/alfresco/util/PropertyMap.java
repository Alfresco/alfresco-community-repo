 ...
 *
 * <p>This class can be used as a short hand when a class of type Map&lt;QName, Serializable&gt; is
 * required.
 *
...
public class PropertyMap extends HashMap<QName, Serializable> {
     ...
     * @return Return a map of values that <b>changed</b> from before to after. The before value is
     *     first and the after value is second.
     * @since 3.2
     */
    public static Pair<Map<QName, Serializable>, Map<QName, Serializable>>
     ...
     * @since Odin
     */
    public static Map<QName, Serializable> getAddedProperties(
            Map<QName, Serializable> before, Map<QName, Serializable> after) {
     ...
     * @since Odin
     */
    public static Map<QName, Serializable> getRemovedProperties(
            Map<QName, Serializable> before, Map<QName, Serializable> after) {
        Map<QName, Serializable> result = new HashMap<QName, Serializable>();
    ...
    /**
     * Utility method to get properties which were changed (but not added or removed) as part of a
     * change.
     *
     * @param before the properties before (may be <code>null</code>).
     * @param after the properties after (may be <code>null</code>).
     ...
     * @since Odin
     */
    public static Map<QName, Serializable> getChangedProperties(
            Map<QName, Serializable> before, Map<QName, Serializable> after) {
        Map<QName, Serializable> result = new HashMap<QName, Serializable>();
        ...
        if (before != null && after != null) {
            ...
            for (Entry<QName, Serializable> entry : intersection.entrySet()) {
                if (!EqualsHelper.nullSafeEquals(
                        before.get(entry.getKey()), after.get(entry.getKey()))) {
     ...
     * @since Odin
     */
    public static Map<QName, Serializable> getUnchangedProperties(
            Map<QName, Serializable> before, Map<QName, Serializable> after) {
        Map<QName, Serializable> result = new HashMap<QName, Serializable>();
