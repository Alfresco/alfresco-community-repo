...
/**
 * Component API for searching. Delegates to the real {@link
 * org.alfresco.service.cmr.search.SearchService searcher} from the {@link
 * #indexerAndSearcherFactory}.
 *
 * <p>Transactional support is free.
 *
 * @author andyh
 */
public class SearcherComponent extends AbstractSearcherComponent {
    ...
    public ResultSet query(SearchParameters searchParameters) {
        ...
        SearchService searcher =
                indexerAndSearcherFactory.getSearcher(
                        storeRef, !searchParameters.excludeDataInTheCurrentTransaction());
    ...
    public List<NodeRef> selectNodes(
        ...
        SearchService searcher =
                indexerAndSearcherFactory.getSearcher(contextNodeRef.getStoreRef(), true);
        return searcher.selectNodes(
                contextNodeRef,
                xpath,
                parameters,
    ...
    public List<Serializable> selectProperties(
        ...
        SearchService searcher =
                indexerAndSearcherFactory.getSearcher(contextNodeRef.getStoreRef(), true);
        return searcher.selectProperties(
                contextNodeRef,
                xpath,
                parameters,
                namespacePrefixResolver,
