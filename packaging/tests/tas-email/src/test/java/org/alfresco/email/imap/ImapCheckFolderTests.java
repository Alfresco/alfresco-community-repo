...
public class ImapCheckFolderTests extends EmailTest {
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY })
  public void userShouldFindAllIMAPSitesFoldersInAlfrescoIMAPFolder()
    throws Exception {
    testUser = dataUser.createRandomTestUser();
  ...
  public void collaboratorShouldGetCurrentWorkingDirectory() throws Exception {
    ...
    FolderModel testFolder1 = dataContent
      .usingUser(managerUser)
      .usingSite(managerTestSite)
      .usingResource(testFolder)
      .createFolder();
    FolderModel testFolder2 = dataContent
      .usingUser(managerUser)
      .usingSite(managerTestSite)
      .usingResource(testFolder)
      .createFolder();
  ...
  public void unAuthorizedUserCannotAccessPublicImapSiteDocumentLibrary()
    throws Exception {
    testUser = dataUser.createRandomTestUser();
    UserModel unauthorizedUser = dataUser.createRandomTestUser();
    SiteModel publicImapSite = dataSite
      .usingUser(testUser)
      .createPublicRandomSite();
    dataSite
      .usingUser(unauthorizedUser)
  ...
  public void unAuthorizedUserCannotAccessModeratedImapSiteDocumentLibrary()
    throws Exception {
    testUser = dataUser.createRandomTestUser();
    UserModel unauthorizedUser = dataUser.createRandomTestUser();
    SiteModel moderatedImapSite = dataSite
      .usingUser(testUser)
  ...
  public void unAuthorizedUserCannotAccessPrivateImapSiteDocumentLibrary()
    throws Exception {
    testUser = dataUser.createRandomTestUser();
    UserModel unauthorizedUser = dataUser.createRandomTestUser();
    SiteModel privateImapSite = dataSite
      .usingUser(testUser)
