...
public class RepoAdminServiceImplTest extends TestCase {
    ...
    public void testConsequentDeploy() throws Exception {
        ...
        final QName typeName =
                QName.createQName("{http://www.alfresco.org/test/testmodel" + X + "/1.0}base");
    ...
    public void testSimpleDynamicModelViaNodeService() throws Exception {
        ...
        try {
            ...
            ContentWriter writer =
                    contentService.getWriter(model1, ContentModel.PROP_CONTENT, true);
            ...
            NodeRef node1 =
                    nodeService
                            .createNode(
                                    ...
                                    QName.createQName(
                                            "http://www.alfresco.org/model/system/1.0", "node1"),
                                    typeName,
                                    null)
                            .getChildRef();
    ...
    public void testSimpleDynamicModelViaRepoAdminService() throws Exception {
        ...
        try {
            ...
            // can re-deploy a deployed model (note: re-deploying the same model is a valid
            // incremental update)
                                    ...
                                    public Object execute() throws Throwable {
                                        if (opType == 1) {
                                            ...
                                            repoAdminService.deployModel(
                                                    modelStream, modelPrefix + i);

                                            logger.info(
                                                    "["
                                                            + i
                                                            + "] Deploying - test model: "
                                                            + modelPrefix
                                                            + i);
                                        } else if (opType == 2) {
                                            // Undeploy model
