...
public class Encoding implements Serializable {
    ...
    /**
     * String encoding token - signals the beginning of a reference encoded with this encoding in
     * given String.
     */
    ...
    public Encoding(
            Character token, ReferenceParser parser, Stringifier stringifier, boolean urlNative) {
        super();
        this.token = token;
        this.parser = parser;
