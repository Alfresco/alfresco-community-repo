...
public class TextPropertyValueComparator implements PropertyValueComparator {
    ...
    private static final String MSGID_INVALID_OPERATION =
            "text_property_value_comparator.invalid_operation";
    ...
    public boolean compare(
        ...
        if (operation == null) {
            // Check for a trailing or leading star since it implies special behaviour when no
            // default operation is specified
