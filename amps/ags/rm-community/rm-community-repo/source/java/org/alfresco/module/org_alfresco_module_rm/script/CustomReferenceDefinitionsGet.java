...
public class CustomReferenceDefinitionsGet
  ...
  protected Map<String, Object> executeImpl(
    ...
    Set<RelationshipDefinition> relationshipDefinitions = getRelationshipDefinitons(
      uniqueName
    );
    List<Map<String, String>> relationshipDefinitionData = createRelationshipDefinitionData(
   ...
   */
  private Set<RelationshipDefinition> getRelationshipDefinitons(
    String uniqueName
  ) {
    Set<RelationshipDefinition> relationshipDefinitions = new HashSet<>();

    if (isBlank(uniqueName)) {
      relationshipDefinitions.addAll(
