...
public class FavouriteDocument extends FavouriteNode implements ExpectedComparison, JSONAble {
    ...
    public static FavouriteDocument getDocument(String id, String guid, Properties props) {
        ...
        document.setTitle(
                (String) properties.get(ContentModel.PROP_TITLE.toString()).getFirstValue());
        ...
        GregorianCalendar modifiedAt =
                (GregorianCalendar)
                        properties.get(PropertyIds.LAST_MODIFICATION_DATE).getFirstValue();
        ...
        document.setMimeType(
                (String) properties.get(PropertyIds.CONTENT_STREAM_MIME_TYPE).getFirstValue());
        document.setSizeInBytes(
                (BigInteger) properties.get(PropertyIds.CONTENT_STREAM_LENGTH).getFirstValue());
    ...
    public static FavouriteDocument parseDocument(JSONObject jsonObject) throws ParseException {
        ...
        Date createdAt =
                PublicApiDateFormat.getDateFormat().parse((String) jsonObject.get("createdAt"));
        Date modifiedAt =
                PublicApiDateFormat.getDateFormat().parse((String) jsonObject.get("modifiedAt"));
    ...
    public String toString() {
        ...
        sb.append("FavouriteDocument [nodeId=")
                .append(nodeId)
                .append(", guid=")
                .append(guid)
                .append(", name=")
