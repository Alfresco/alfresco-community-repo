...
public interface RMPermissionModel {
  ...
  String ROLE_ADMINISTRATOR = SimplePermissionReference
  ...
  String CREATE_MODIFY_RECORDS_IN_CUTOFF_FOLDERS =
  ...
  String DESTROY_RECORDS_SCHEDULED_FOR_DESTRUCTION =
    "DestroyRecordsScheduledForDestruction";
  String DESTROY_RECORDS = "DestroyRecords";
  String UPDATE_VITAL_RECORD_CYCLE_INFORMATION =
  ...
  String CREATE_MODIFY_DESTROY_FILEPLAN_METADATA =
    "CreateModifyDestroyFileplanMetadata";
  String CREATE_AND_ASSOCIATE_SELECTION_LISTS =
    "CreateAndAssociateSelectionLists";
  String ATTACH_RULES_TO_METADATA_PROPERTIES =
    "AttachRulesToMetadataProperties";
  String CREATE_MODIFY_DESTROY_FILEPLAN_TYPES =
  ...
  String CREATE_MODIFY_DESTROY_USERS_AND_GROUPS =
  ...
  String CREATE_MODIFY_DESTROY_REFERENCE_TYPES =
    "CreateModifyDestroyReferenceTypes";
  String UPDATE_CLASSIFICATION_DATES = "UpdateClassificationDates";
  String CREATE_MODIFY_DESTROY_CLASSIFICATION_GUIDES =
    "CreateModifyDestroyClassificationGuides";
  String UPGRADE_DOWNGRADE_AND_DECLASSIFY_RECORDS =
