 ...
 * It is not (at the time of writing) intended to be incorporated into the automatic build which
 * will find the various test classes and run them individually.
 *
 * @author Nick Burch
 * @since 4.0
 */
