...
public interface BulkFilesystemImporter {
    /**
     * Initiates a bulk filesystem import. Note: getStatus().inProgress() must be false prior to
     * calling this method or an Exception will be thrown.
     *
    ...
    /**
     * Initiates a bulk filesystem import asynchronously i.e. in a background thread. Note:
     * getStatus().inProgress() must be false prior to calling this method or an Exception will be
     * thrown.
     *
     * @param bulkImportParameters The target bulk import parameters.
     * @param nodeImporter The node importer.
