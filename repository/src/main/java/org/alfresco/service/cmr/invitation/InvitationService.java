...
/**
 * The invitation service provides the ability to invite people to resources. For example adding a
 * user to a shared web site. It manages the relationship between person, resource and requestType
 * and may also pass along information such as who is to approve or the expected role of the user.
 *
 * @author mrogers
 */
public interface InvitationService {
     ...
     * Alfresco User Name The server path is calculated based on the sysAdmin parameters
     *
     ...
     * @param acceptUrl
     * @param rejectUrl
     * @return the nominated invitation which will contain the invitationId and ticket which will
     *     uniqely identify this invitation for the rest of the workflow.
    ...
    /**
     * Start the invitation process for a NominatedInvitation for a user who does not yet have an
     * Alfresco User NameA new user name will be generated as part of the invitation process. The
     * server path is calculated based on the sysAdmin parameters
     *
     ...
     * @param rejectUrl
     * @return the nominated invitation which will contain the invitationId and ticket which will
     *     uniquely identify this invitation.
     * @throws InvitationException
     * @throws InvitationExceptionUserError
     * @throws InvitationExceptionForbidden
     */
    ...
    ModeratedInvitation updateModeratedInvitation(
            String inviteeId, String siteShortName, String inviteeComments);
    ...
    public void acceptNominatedInvitation(
            String siteName, String invitee, String role, String inviter);
    ...
    public void approveModeratedInvitation(
            String siteName, String invitee, String role, String reviewer);
    ...
    public void rejectModeratedInvitation(
            String siteName,
            String invitee,
            String role,
            String reviewer,
    ...
    public void cancelInvitation(
            String siteName, String invitee, String inviteId, String currentInviteId);
    ...
    /**
     * Clean up invitee user account and person node when no longer in use. They are deemed to no
     * longer be in use when the invitee user account is still disabled and there are no outstanding
     * pending invites for that invitee.
     *
     * @param invitee
     * @param currentInviteId
     */
     ...
     */
    @Auditable(parameters = {"inviteId"})
    public void sendNominatedInvitation(
            String inviteId,
    ...
    @NotAuditable
    public List<Invitation> listPendingInvitationsForInvitee(
            String invitee, Invitation.ResourceType resourceType);
    ...
    /**
     * This is the general search invitation method returning {@link Invitation} This method has a
     * hardcoded limit of 200 invitations to return. It has been deprecated and it is recommended to
     * use the overloaded version for which you can specify an appropriate limit depending on the
     * needs
     *
     * @param criteria InvitationSearchCriteria search criteria
    ...
    /**
     * This is the general search invitation method returning {@link Invitation} This is the
     * recommended method to use for searching invitations; Consider that the performance of the
     * method will be greatly influenced by the limit specified
     *
    ...
    /**
     * Sends the site join request notification email using the given template, subject localization
     * key, and variables.
     *
     * @param invitationId
     ...
     */
    @Auditable(parameters = {"inviteId"})
    public void sendModeratedInvitation(
            String invitationId,
            String emailTemplateXpath,
            String emailSubjectKey,
