...
public class RecordsManagementServiceImpl
  ...
  public NodeRef createRecordCategory(
    ...
    return getFilePlanService()
      .createRecordCategory(parent, name, type, properties);
  }
  ...
  public NodeRef createRecordFolder(
    ...
    return getRecordFolderService()
      .createRecordFolder(rmContainer, name, type, properties);
  }
  ...
  public NodeRef createRecordFolder(
    ...
    return getRecordFolderService()
      .createRecordFolder(parent, name, properties);
  }
