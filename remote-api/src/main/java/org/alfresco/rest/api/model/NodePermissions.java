...
public class NodePermissions {
    ...
    public String toString() {
        ...
        sb.append("PathInfo [isInheritanceEnabled=")
                .append(inherit)
                .append(", inherited=")
                .append(getInherited())
                .append(", locallySet=")
                .append(getLocallySet())
                .append(", settable=")
                .append(getSettable())
                .append(']');
        return sb.toString();
    ...
    public static class NodePermission {
        ...
        public NodePermission(String authorityId, String name, String accessStatus) {
            ...
            this.name = name;
            this.accessStatus =
                    accessStatus != null ? accessStatus : AccessStatus.ALLOWED.toString();
        }
        ...
        public String toString() {
            ...
            sb.append("NodePermission [authorityId=")
                    .append(authorityId)
                    .append(", name=")
                    .append(name)
                    .append(", accessStatus=")
        ...
        public boolean equals(Object o) {
            ...
            if (authorityId != null
                    ...
                    : that.authorityId != null) return false;
