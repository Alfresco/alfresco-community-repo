...
public interface ContentModel
{
    ...
    /**
     * Aspects marking nodes that are pending deletion. This aspect is applied to all nodes that are about to be deleted within a transaction. The aspect survives only for the duration of calls to delete nodes and their children.
     */
    ...
    // Thumbnailed Aspect
    /**
     * This aspect type has been deprecated. From Alfresco 3.3 the {@link RenditionModel#ASPECT_RENDITIONED rn:renditioned} (which is a child of cm:thumbnailed) should be used instead.
     */
    @Deprecated
    static final QName ASPECT_THUMBNAILED = QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "thumbnailed");
    /**
     * This association type has been deprecated. From Alfresco 3.3 this association no longer exists and has been replaced with {@link RenditionModel#ASSOC_RENDITION rn:rendition} association. From Alfresco 3.3 onwards a patch is executed at startup which renames the cm:thumbnails QName to rn:rendition in the database.
     * <P/>
     * This field has been updated to point to that association and references to this field should be updated to use the new field.
     */
    @Deprecated
