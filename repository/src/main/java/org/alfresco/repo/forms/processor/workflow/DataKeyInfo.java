...
public class DataKeyInfo {
  ...
  public static DataKeyInfo makeAssociationDataKeyInfo(
    String dataKey,
    QName qName,
    boolean isAdd
  ) {
  ...
  public static DataKeyInfo makePropertyDataKeyInfo(
    String dataKey,
    QName qName
  ) {
  ...
  public static DataKeyInfo makeTransientAssociationDataKeyInfo(
    String dataKey,
    boolean isAdd
  ) {
    return new DataKeyInfo(
      dataKey,
      null,
      FieldType.TRANSIENT_ASSOCIATION,
      isAdd
    );
  }
