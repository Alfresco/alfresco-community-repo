...
public class ColumnTest extends DbObjectTestBase<Column> {
  ...
  protected void doDiffTests() {
    ...
    inOrder
      ...
      .compareSimple(thisTypeProp, thatTypeProp, ctx);
    ...
    inOrder
      .verify(comparisonUtils)
      .compareSimple(thisAutoIncProp, thatAutoIncProp, ctx);
  }
  ...
  public void sameAs() {
    ...
    Column anotherColumn = new Column(
      anotherTable,
      "this_column",
      "VARCHAR2(100)",
      false
    ...
    assertTrue(
      "Column should always be the same as itself",
      thisColumn.sameAs(thisColumn)
    );
    assertTrue(
      "Columns should be the same due to same parent table names",
      thisColumn.sameAs(thatColumn)
    );
    assertFalse(
      "Should NOT be the same due to different parent table names",
      thisColumn.sameAs(anotherColumn)
    );
  }
}
