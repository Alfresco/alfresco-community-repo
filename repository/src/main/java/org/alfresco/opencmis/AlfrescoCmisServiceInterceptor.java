...
/**
 * Interceptor to manage threads and perform other menial jobs that are common to all calls made to
 * the service. It also provides detailed logging of values passing in and out of the service.
 *
 * <p><b>DEBUG</b> shows authentication and inbound arguments. <b>TRACE</b> shows full return
 * results as well.
 *
 * @author Derek Hulley
 * @since 4.0
