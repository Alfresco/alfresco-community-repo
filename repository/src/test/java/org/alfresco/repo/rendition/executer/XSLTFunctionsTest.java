...
public class XSLTFunctionsTest extends BaseAlfrescoSpringTest {
  ...
  private static final Log log = LogFactory.getLog(XSLTFunctionsTest.class);
  ...
  public void before() throws Exception {
    super.before();
    this.xsltFunctions =
      (XSLTFunctions) this.applicationContext.getBean("xsltFunctions");
    this.nodeService =
  ...
  public void testSimplestParseXMLDocument() {
    ...
    try {
      Document doc = xsltFunctions.parseXMLDocument(
        companyHome,
        file.getName()
      );
  ...
  public void testParseXMLDocuments() {
    ...
    try {
      Map<String, Document> xmlFileMap = xsltFunctions.parseXMLDocuments(
        "cm:content",
        companyHome,
        "/" + path
      );
