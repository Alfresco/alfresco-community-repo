...
public class ContentDataDAOImpl extends AbstractContentDataDAOImpl {
  ...
  private static final String SELECT_CONTENT_URL_BY_ID =
    "alfresco.content.select_ContentUrlById";
  private static final String SELECT_CONTENT_URL_BY_KEY =
    "alfresco.content.select_ContentUrlByKey";
  private static final String SELECT_CONTENT_URL_BY_KEY_UNREFERENCED =
    "alfresco.content.select_ContentUrlByKeyUnreferenced";
  private static final String SELECT_CONTENT_URLS_ORPHANED =
    "alfresco.content.select.select_ContentUrlsOrphaned";
  private static final String SELECT_CONTENT_URLS_KEEP_ORPHANED =
    "alfresco.content.select_ContentUrlsKeepOrphaned";
  private static final String SELECT_CONTENT_DATA_BY_ID =
    "alfresco.content.select_ContentDataById";
  private static final String SELECT_CONTENT_DATA_BY_NODE_AND_QNAME =
    "alfresco.content.select_ContentDataByNodeAndQName";
  private static final String SELECT_CONTENT_DATA_BY_NODE_IDS =
    "alfresco.content.select_ContentDataByNodeIds";
  private static final String INSERT_CONTENT_URL =
    "alfresco.content.insert.insert_ContentUrl";
  private static final String INSERT_CONTENT_DATA =
    "alfresco.content.insert.insert_ContentData";
  private static final String UPDATE_CONTENT_URL_ORPHAN_TIME =
    "alfresco.content.update_ContentUrlOrphanTime";
  private static final String UPDATE_CONTENT_DATA =
    "alfresco.content.update_ContentData";
  private static final String DELETE_CONTENT_DATA =
    "alfresco.content.delete_ContentData";
  private static final String DELETE_CONTENT_URLS =
    "alfresco.content.delete_ContentUrls";
  private static final String DELETE_CONTENT_URL_KEYS =
    "alfresco.content.delete_ContentUrlKeys";
  private static final String DELETE_SYMMETRIC_KEY =
    "alfresco.content.delete_KeyData";
  private static final String UPDATE_SYMMETRIC_KEY =
    "alfresco.content.update_KeyData";
  private static final String INSERT_SYMMETRIC_KEY =
    "alfresco.content.insert.insert_KeyData";
  private static final String SELECT_SYMMETRIC_KEYS_BY_MASTER_KEY =
    "alfresco.content.select_SymmetricKeysByMasterKey";
  private static final String COUNT_SYMMETRIC_KEYS_BY_MASTER_KEY =
    "alfresco.content.select_CountSymmetricKeysByMasterKey";
  private static final String COUNT_SYMMETRIC_KEYS_FOR_MASTER_KEYS =
    "alfresco.content.select_CountSymmetricKeysForAllMasterKeys";
  ...
  @Override
  public Pair<Long, String> createContentUrlOrphaned(
    String contentUrl,
    Date orphanTime
  ) {
    ...
    contentUrlEntity.setOrphanTime(
      orphanTime == null ? System.currentTimeMillis() : orphanTime.getTime()
    );
  ...
  @Override
  protected ContentUrlEntity createContentUrlEntity(
    String contentUrl,
    long size,
  ...
  protected ContentUrlEntity getContentUrlEntity(Long id) {
    ...
    contentUrlEntity.setId(id);
    contentUrlEntity =
      (ContentUrlEntity) template.selectOne(
        SELECT_CONTENT_URL_BY_ID,
        contentUrlEntity
      );
    // Done
    return contentUrlEntity;
  ...
  public ContentUrlEntity getContentUrlEntity(String contentUrl) {
    ...
    if (contentUrlEntity.getContentUrlShort() != null) {
      contentUrlEntity.setContentUrlShort(
        contentUrlEntity.getContentUrlShort().toLowerCase()
      );
    }
    contentUrlEntity =
      template.selectOne(SELECT_CONTENT_URL_BY_KEY, contentUrlEntity);
    // Done
    return contentUrlEntity;
  }
  ...
  public void getContentUrlsOrphaned(
    ...
    List<ContentUrlEntity> results = template.selectList(
  ...
  public void getContentUrlsKeepOrphaned(
    ...
    List<ContentUrlEntity> results = template.selectList(
      SELECT_CONTENT_URLS_KEEP_ORPHANED,
      new RowBounds(0, maxResults)
    );
    // Pass the result to the callback
    for (ContentUrlEntity result : results) {
  ...
  @Override
  public int updateContentUrlOrphanTime(
    Long id,
    Long orphanTime,
    Long oldOrphanTime
  ) {
    ...
    return template.update(
      UPDATE_CONTENT_URL_ORPHAN_TIME,
  ...
  @Override
  protected ContentUrlEntity getContentUrlEntityUnreferenced(
    String contentUrl
  ) {
    ContentUrlEntity contentUrlEntity = new ContentUrlEntity();
    contentUrlEntity.setContentUrl(contentUrl);
  ...
  protected ContentDataEntity createContentDataEntity(
    ...
    try {
      ...
      throw new AlfrescoRuntimeException(
        "Failed to insert ContentData: " + contentDataEntity,
        e
      );
    }
    // Done
  ...
  protected ContentDataEntity getContentDataEntity(Long id) {
    ...
    params.put("id", id);
    ContentDataEntity contentDataEntity = (ContentDataEntity) template.selectOne(
      SELECT_CONTENT_DATA_BY_ID,
      params
    );
    // Done
    return contentDataEntity;
  ...
  @Override
  protected List<ContentDataEntity> getContentDataEntitiesForNodes(
    Set<Long> nodeIds
  ) {
    if (nodeIds.size() == 0) {
  ...
  public void deleteContentDataForNode(Long nodeId, Set<Long> qnameIds) {
    ...
    List<Long> ids = template.selectList(
  ...
  @Override
  protected int updateContentUrlEntity(
    ...
    if (existingContentUrlKey == null) {
      ...
      !EqualsHelper.nullSafeEquals(existingContentUrlKey, contentUrlKey)
    ) {
  ...
  public List<ContentUrlKeyEntity> getSymmetricKeysByMasterKeyAlias(
    ...
    entity.setId(fromId);
    List<ContentUrlKeyEntity> results = template.selectList(
      SELECT_SYMMETRIC_KEYS_BY_MASTER_KEY,
      entity,
      new RowBounds(0, maxResults)
    );
    return results;
  ...
  public Map<String, Integer> countSymmetricKeysForMasterKeys() {
    ...
    List<SymmetricKeyCount> res = template.selectList(
      COUNT_SYMMETRIC_KEYS_FOR_MASTER_KEYS
    );
  ...
  public int countSymmetricKeysForMasterKeyAlias(String masterKeyAlias) {
    return (Integer) template.selectOne(
      COUNT_SYMMETRIC_KEYS_BY_MASTER_KEY,
      masterKeyAlias
    );
  }
}
