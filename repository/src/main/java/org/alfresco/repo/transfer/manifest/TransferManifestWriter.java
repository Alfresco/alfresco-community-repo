 ...
 *
 * <p>This class formats the transfer manifest and prints it to the specified writer
 *
 * <p>It is a statefull object and writes one manifest at a time.
 *
 * <p>Call start once, then write the header, then one or more nodes, then end.
 */
