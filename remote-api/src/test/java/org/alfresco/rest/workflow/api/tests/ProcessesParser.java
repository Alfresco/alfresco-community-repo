...
public class ProcessesParser extends ListParser<ProcessInfo> {
  ...
  public ProcessInfo parseEntry(JSONObject entry) {
    ...
    processesRest.setProcessDefinitionId(
      (String) entry.get("processDefinitionId")
    );
    processesRest.setProcessDefinitionKey(
      (String) entry.get("processDefinitionKey")
    );
    ...
    processesRest.setSuperProcessInstanceId(
      (String) entry.get("superProcessInstanceId")
    );
