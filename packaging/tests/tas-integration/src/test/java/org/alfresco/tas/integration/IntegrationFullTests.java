...
public class IntegrationFullTests extends IntegrationTest {
  ...
  public void verifyFileCannotBeRenamedInRepoIfItWasAlreadyDeletedViaIMAP()
    throws Exception {
  ...
  public void userShouldUploadFileInPrivateSite() throws Exception {
    ...
    File fileForUpload = Utility.getTestResourceFile(
      "shared-resources/testdata/flower.jpg"
    );
    ftpProtocol
      .authenticateUser(testUser1)
  ...
  public void assigneeCantAccessFilesFromPrivateSiteIfHeIsNotAMember()
    throws Exception {
    ...
    processModel =
      restAPI
        ...
        .addProcess(
          ...
          testUser2,
          false,
          CMISUtil.Priority.Normal
        );
    restAPI
      .withWorkflowAPI()
      .usingProcess(processModel)
      .addProcessItem(testFile1);
    restAPI.assertStatusCodeIs(HttpStatus.CREATED);
    restAPI
      .withWorkflowAPI()
      .usingProcess(processModel)
      .addProcessItem(testFile2);
    restAPI.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void assigneeCantAccessFilesFromModeratedSiteIfHeIsNotAMember()
    throws Exception {
    STEP("1. Using CMIS create 2 test users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void assigneeCanAccessFilesFromPublicSiteIfHeIsNotAMember()
    throws Exception {
    STEP("1. Using CMIS create 2 test users: u1 and u2");
    testUser1 = dataUser.createRandomTestUser();
    testUser2 = dataUser.createRandomTestUser();
  ...
  public void getCommentAfterItIsDeleted() throws Exception {
    ...
    RestCommentModel user1Comment = restAPI
      .authenticateUser(testUser1)
      .withCoreAPI()
      .usingResource(testFile1)
  ...
  public void moveRenamedFileUsingInitialFilename() throws Exception {
    ...
    FolderModel destination = new FolderModel(
      Utility.buildPath("Sites", publicSite.getId(), "documentLibrary")
    );
  ...
  public void findFilesAndFlagFiles() throws Exception {
    ...
    FileModel file12 = dataContent
      .usingUser(testUser)
      .usingSite(testSitePublic)
      .usingResource(folder1)
      .createContent(
        new FileModel("childDoc11", FileType.TEXT_PLAIN, "content")
      );
    FileModel file13 = dataContent
      .usingUser(testUser)
      .usingSite(testSitePublic)
      .usingResource(folder1)
    ...
    FileModel file22 = dataContent
      .usingUser(testUser)
      .usingSite(testSitePublic)
      .usingResource(folder2)
      .createContent(
        new FileModel("childDoc2", FileType.TEXT_PLAIN, "content")
      );
    FileModel file23 = dataContent
      .usingUser(testUser)
      .usingSite(testSitePublic)
      .usingResource(folder2)
  ...
  public void assignerIsAbleToAddAndRemoveItemsFromTask() throws Exception {
    ...
    testFile2 =
      dataContent
        .usingSite(publicSite)
        .createContent(CMISUtil.DocumentType.HTML);
    FileModel testFile3 = dataContent
      .usingSite(publicSite)
      .createContent(CMISUtil.DocumentType.PDF);
    taskItems =
      restAPI
        .authenticateUser(testUser1)
        .withWorkflowAPI()
  ...
  public void assignerIsAbleToUpdateTask() throws Exception {
    ...
    JsonObject inputJson = JsonBodyGenerator
      .defineJSON()
      .add("state", "delegated")
  ...
  public void userIsAbleToDoCRUDActionsOnFileWithSpecialName()
    throws Exception {
  ...
  public void updateFileByRegularUserAndSiteMemberWhenSiteVisibilityIsChanged()
    throws Exception {
    ...
    dataSite
      .usingUser(testUser1)
      .updateSiteVisibility(publicSite, Visibility.MODERATED);
    ...
    dataSite
      .usingUser(testUser1)
      .updateSiteVisibility(publicSite, Visibility.PRIVATE);
  ...
  public void createUserMakeUnathorizedAction() throws Exception {
    ...
    STEP(
      "2. Using FTP create file in unauthorized folder (Data Dictionary). 3. Verify that document is not created"
    );
    testFile1 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file1 content");
  ...
  public void createWorkflowProcessWithNewProcessVariable() throws Exception {
    ...
    RestProcessDefinitionModelsCollection procDefinitions = restAPI
      .authenticateUser(testUser1)
      .withWorkflowAPI()
    ...
    RestProcessVariableModel processVariable = restAPI
      .withWorkflowAPI()
      .usingProcess(processModel)
    ...
    RestProcessVariableCollection processVariables = restAPI
      .authenticateUser(testUser2)
      .withWorkflowAPI()
      .usingProcess(processModel)
      .getProcessVariables();
    ...
    RestTaskModel processTask = restAPI
      .withWorkflowAPI()
      .usingProcess(processModel)
      .getProcessTasks()
  ...
  public void createWorkflowProcessAndDeleteProcessVariable() throws Exception {
    ...
    STEP(
      "4. U1 creates a workflow of type 'activitiParallelGroupReview' with the documents created above and assign it to u2 using REST"
    );
    processModel =
      restAPI
        .authenticateUser(testUser1)
  ...
  public void getUserPreferencesForSitesAndFiles() throws Exception {
    ...
    SiteModel testSitePublic1 = dataSite
      .usingUser(testUser1)
      .createPublicRandomSite();
    SiteModel testSitePublic2 = dataSite
      .usingUser(testUser1)
      .createPublicRandomSite();
    ...
    ftpProtocol
      .authenticateUser(testUser2)
      .usingSite(testSitePublic2)
      .createFile(file2);
    restAPI
      .authenticateUser(testUser2)
      .withCoreAPI()
      .usingAuthUser()
      .addFileToFavorites(file2);
    restAPI.assertStatusCodeIs(HttpStatus.CREATED);
    ...
    restPreferenceModelsCollection
      ...
      .entriesListContains(
        "value",
        "workspace://SpacesStore/" + file1.getNodeRef()
      )
      .and()
      .entriesListContains("value", "true");
    ...
    restPreferenceModelsCollection
      ...
      .entriesListContains(
        "value",
        "workspace://SpacesStore/" + file2.getNodeRef()
      )
      .and()
      .entriesListContains("value", "true");
  ...
  public void getPreferenceForSiteAndFiles() throws Exception {
    ...
    SiteModel testSitePublic = dataSite
      .usingUser(testUser1)
      .createPublicRandomSite();
    ...
    STEP(
      "8. U2 creates file1 in test site's document library using FTP and adds it to favorites using RestAPI"
    );
    FileModel file1 = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    ftpProtocol
      .authenticateUser(testUser2)
    ...
    RestPreferenceModel preference = restAPI
      .authenticateUser(testUser2)
      .withCoreAPI()
      .usingAuthUser()
      .getPersonPreferenceInformation(
    ...
    STEP(
      "12. U2 adds file1 to favorites using RestAPI and renames file1 to file-updated with WebDAV"
    );
    restAPI
      .authenticateUser(testUser2)
      .withCoreAPI()
    ...
    STEP(
      "14. U2 adds file1 to favorites using RestAPI and deletes file-updated with CMIS"
    );
    restAPI
      .authenticateUser(testUser2)
      .withCoreAPI()
  ...
  @TestRail(
    ...
    executionType = ExecutionType.REGRESSION,
    description = "Verify that the version of a new file uploaded through WebDAV is 1.0 with the real content size."
  )
  public void uploadedFileThroughWebdavHasFirstVersion() throws Exception {
    UserModel managerUser = dataUser.createRandomTestUser();
    SiteModel testSite = dataSite
      .usingUser(managerUser)
      .createPublicRandomSite();

    STEP(
      "0. Verify versionable aspect is set for all contents using webscript"
    );
    ...
    FolderModel folder = dataContent
      ...
      .usingSite(testSite)
      .createFolder();
    File fileToUpload = Utility.getTestResourceFile(
      "shared-resources/testdata/nonemptyupload.txt"
    );
    webDavProtocol
    ...
    STEP(
      "2. Verify version is exactly 1.0 and the size is the same as the local file"
    );
