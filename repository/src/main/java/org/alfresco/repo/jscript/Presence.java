...
public final class Presence extends BaseScopableProcessorExtension {
    ...
    public boolean hasPresence(ScriptNode person) {
        ...
        String presenceProvider =
                (String) person.getProperties().get(ContentModel.PROP_PRESENCEPROVIDER);
        String presenceUsername =
                (String) person.getProperties().get(ContentModel.PROP_PRESENCEUSERNAME);
