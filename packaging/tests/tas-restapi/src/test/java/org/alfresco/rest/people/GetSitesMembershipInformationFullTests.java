...
public class GetSitesMembershipInformationFullTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if user gets site membership information of another user successfully")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site membership information request when a site membership request"
                            + " is rejected")
