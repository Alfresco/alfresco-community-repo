...
<r:page titleId="title_delete_user">
                  ...
                  <td bgcolor="#dfe6ed">
                     ...
                     <table cellspacing="4" cellpadding="0" width="100%">
                        <tr>
                           ...
                           <td>
                              <div class="mainTitle"><h:outputText value="#{msg.delete_user}" /> '<h:outputText value="#{UsersBean.person.properties.userName}" />'</div>
                              <div class="mainSubText"><h:outputText value="#{msg.delete_user_info}" /></div>
                           </td>
                        </tr>
                     </table>
                                 ...
                                 <tr>
                                    <td class="mainSubTitle">
                                       <h:outputFormat value="#{msg.delete_user_confirm}">
                                          <f:param value="#{UsersBean.person.properties.userName}"/>
                                       </h:outputFormat>
                                    </td>
                                 </tr>
                                 <tr>
