...
public class XMLTransferManifestWriter implements TransferManifestWriter {
  ...
  public void writeTransferManifestHeader(TransferManifestHeader header)
    ...
    if (header.getCreatedDate() != null) {
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_TRANSFER_HEADER,
        EMPTY_ATTRIBUTES
      );
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_HEADER_CREATED_DATE,
        EMPTY_ATTRIBUTES
      );
    ...
    if (header.getNodeCount() > 0) {
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_HEADER_NODE_COUNT,
        EMPTY_ATTRIBUTES
      );
      char[] nodeCountChars = Integer
        .toString(header.getNodeCount())
        .toCharArray();
    ...
    if (header.isSync()) {
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_HEADER_SYNC,
        EMPTY_ATTRIBUTES
      );
      writer.endElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
    ...
    if (header.isReadOnly()) {
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_HEADER_RONLY,
        EMPTY_ATTRIBUTES
      );
      writer.endElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
    ...
    if (version != null) {
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_HEADER_VERSION,
        attributes
      );
  ...
  public void writeTransferManifestNode(TransferManifestDeletedNode node)
    ...
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_DELETED_NODE,
      attributes
    );
  ...
  public void writeTransferManifestNode(TransferManifestNode node)
    ...
    if (node instanceof TransferManifestDeletedNode) {
      ...
      throw new IllegalArgumentException(
        "Unexpected type" + node.getClass().getName()
      );
    }
  }
  ...
  public void writeTransferManifestNode(TransferManifestNormalNode node)
    ...
    writer.startElement(
      TransferModel.TRANSFER_MODEL_1_0_URI,
      ManifestModel.LOCALNAME_ELEMENT_NODE,
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_NODE,
      attributes
    );
  ...
  private void writeCategories(Map<NodeRef, ManifestCategory> categories)
    throws SAXException {
    writer.startElement(
      TransferModel.TRANSFER_MODEL_1_0_URI,
      ManifestModel.LOCALNAME_ELEMENT_PROPERTIES,
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_CATEGORIES,
      EMPTY_ATTRIBUTES
    );
    if (categories != null) {
  ...
  private void writeCategory(NodeRef nodeRef, ManifestCategory value)
    throws SAXException {
    AttributesImpl attributes = new AttributesImpl();
    attributes.addAttribute(
      TransferModel.TRANSFER_MODEL_1_0_URI,
    ...
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_CATEGORY,
      attributes
    );
    writeValue(nodeRef);
  ...
  private void writeProperties(Map<QName, Serializable> properties)
    throws SAXException {
    writer.startElement(
      TransferModel.TRANSFER_MODEL_1_0_URI,
      ManifestModel.LOCALNAME_ELEMENT_PROPERTIES,
  ...
  @SuppressWarnings("unchecked")
  private void writeProperty(QName propertyName, Serializable value)
    throws SAXException {
    {
      AttributesImpl attributes = new AttributesImpl();
      attributes.addAttribute(
    ...
    if (value == null) {
      ...
      dataAttributes.addAttribute(
        ...
        "locale",
        "String",
        data.getLocale().toString()
      );
      writer.startElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
        ManifestModel.LOCALNAME_ELEMENT_CONTENT_HEADER,
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_CONTENT_HEADER,
        dataAttributes
      );
      writer.endElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_VALUES,
        EMPTY_ATTRIBUTES
      );
      int index = 0;
  ...
  private void writeValue(Serializable value) throws SAXException {
    try {
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_VALUE_STRING,
        valueAttributes
      );
      ...
      try {
        ...
        writer.startElement(
          ...
          PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_VALUE_SERIALIZED,
          attributes
        );
  ...
  private void writeNullValue() throws SAXException {
    ...
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_VALUE_NULL,
      attributes
    );
    writer.endElement(
      TransferModel.TRANSFER_MODEL_1_0_URI,
  ...
  private void writeMLValue(Locale locale, Serializable value)
    throws SAXException {
    AttributesImpl attributes = new AttributesImpl();
    attributes.addAttribute(
      TransferModel.TRANSFER_MODEL_1_0_URI,
    ...
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_MLVALUE,
      attributes
    );
    if (value != null) {
      String strValue = (String) DefaultTypeConverter.INSTANCE.convert(
  ...
  private void writeAspects(Set<QName> aspects) throws SAXException {
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_ASPECTS,
      EMPTY_ATTRIBUTES
    );
  ...
  private void writeAspect(QName aspect) throws SAXException {
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_ASPECT,
      EMPTY_ATTRIBUTES
    );
  ...
  private void writePrimaryParent(
    ...
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_PRIMARY_PATH,
      EMPTY_ATTRIBUTES
    );
    if (parentPath != null) {
  ...
  private void writeParentAssocs(List<ChildAssociationRef> refs)
    throws SAXException {
    if (refs != null) {
      writer.startElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
        ManifestModel.LOCALNAME_ELEMENT_PARENT_ASSOCS,
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_PARENT_ASSOCS,
        EMPTY_ATTRIBUTES
      );
  ...
  private void writeChildAssocs(List<ChildAssociationRef> refs)
    throws SAXException {
    if (refs != null) {
      writer.startElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
  ...
  private void writeTargetAssocs(List<AssociationRef> refs)
    throws SAXException {
    if (refs != null) {
      writer.startElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
        ManifestModel.LOCALNAME_ELEMENT_TARGET_ASSOCS,
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_TARGET_ASSOCS,
        EMPTY_ATTRIBUTES
      );
  ...
  private void writeSourceAssocs(List<AssociationRef> refs)
    throws SAXException {
    if (refs != null) {
      writer.startElement(
        TransferModel.TRANSFER_MODEL_1_0_URI,
        ManifestModel.LOCALNAME_ELEMENT_SOURCE_ASSOCS,
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_SOURCE_ASSOCS,
        EMPTY_ATTRIBUTES
      );
  ...
  private void writeAccessControl(ManifestAccessControl acl)
    throws SAXException {
    if (acl != null) {
      AttributesImpl attributes = new AttributesImpl();
      attributes.addAttribute(
      ...
      writer.startElement(
        ...
        PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_ACL,
        attributes
      );
  ...
  private void writePermission(ManifestPermission permission)
    throws SAXException {
    AttributesImpl attributes = new AttributesImpl();
    attributes.addAttribute(
      TransferModel.TRANSFER_MODEL_1_0_URI,
    ...
    writer.startElement(
      ...
      PREFIX + ":" + ManifestModel.LOCALNAME_ELEMENT_ACL_PERMISSION,
      attributes
    );
