...
public interface PolicyComponent
{
     ...
     * 
     * @param policy
     *            the fully qualified policy name
     * @param className
     *            the qualified name of a type or aspect that the policy is bound to
     * @param behaviour
     ...
     *            the fully qualified policy name
     * @param className
     *            the qualified name of the class (type or aspect) to bind against
     * @param propertyName
     *            the name of the property to bind against
     * @param behaviour
     *            the behaviour. What gets executed by the policy
     * @return the registered behaviour definition
     */
     ...
     *            the fully qualified policy name
     * @param className
     *            the name of the class (type or aspect) to bind against
     * @param behaviour
     *            the behaviour, what gets executed by the policy
     * @return the registered behaviour definition
     */
