...
public class FreeMarkerProcessor
  ...
  public void process(String template, Object model, Writer out) {
    ...
    try {
      ...
      if (logger.isDebugEnabled()) {
        ...
        logger.debug(
          "Time to execute template: " + (endTime - startTime) + "ms"
        );
      }
    } catch (IOException ioerr) {
      throw new TemplateException(
        MSG_ERROR_TEMPLATE_IO,
        new Object[] { template },
        ioerr
      );
    }
  ...
  private Object convertToFreeMarkerModel(Object model) {
    ...
    if (model instanceof Map) {
      ...
      TemplateImageResolver imageResolver = (TemplateImageResolver) (
        (Map) model
      ).get(TemplateService.KEY_IMAGE_RESOLVER);
      ...
      for (ProcessorExtension ext : this.processorExtensions.values()) {
        if (ext instanceof TemplateProcessorExtension) {
          ((TemplateProcessorExtension) ext).setTemplateImageResolver(
              imageResolver
            );
        }
      ...
      Map<String, Object> value = (Map<String, Object>) convertValue(
        model,
        imageResolver
      );
  ...
  public Object convertValue(
    ...
    if (value instanceof NodeRef) {
      ...
      return new TemplateAssociation(
