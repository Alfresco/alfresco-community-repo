...
public class MultiUserRenditionTest {
    ...
    /**
     * This test method ensures that users who cause renditions (thumbnails) to be created on nodes
     * are not made the modifier of the source node.
     */
    @Test
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                ...
                                nodeService.getProperty(
                                        nonAdminPdfNode, ContentModel.PROP_MODIFIER));
                        return null;
                    }
                });
    ...
    public void testRenditionOwnerHasChangedAfterSourceOwnerChange() {
        ...
        final NodeRef nonAdminPdfNode =
                txnHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            public NodeRef execute() throws Throwable {
                                NodeRef nonAdminPdfNode =
                                        createPdfDocumentAsCurrentlyAuthenticatedUser(
                                                NON_ADMIN_USER + "_content");
                                return nonAdminPdfNode;
                            }
                        });

        final Pair<NodeRef, NodeRef> nonAdminNodes =
                txnHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<
                            ...
                            public Pair<NodeRef, NodeRef> execute() throws Throwable {
                                ...
                                return new Pair<NodeRef, NodeRef>(
                                        nonAdminPdfNode, nonAdminRenditionNode);
                            }
                        });
