...
public interface WebDavService {
    ...
    /**
     * Determines whether activity post generation is enabled for WebDAV. When enabled, file
     * creation, modification and deletion will create activities that can be viewed in the Share
     * web client.
     *
