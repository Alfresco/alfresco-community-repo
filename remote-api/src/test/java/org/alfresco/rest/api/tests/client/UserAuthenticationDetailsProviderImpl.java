...
public class UserAuthenticationDetailsProviderImpl implements AuthenticationDetailsProvider {
    ...
    public UserAuthenticationDetailsProviderImpl(
            UserDataService userDataService, String adminUserName, String adminPassword) {
    ...
    @Override
    public void updateTicketForUser(String userName, String ticket)
