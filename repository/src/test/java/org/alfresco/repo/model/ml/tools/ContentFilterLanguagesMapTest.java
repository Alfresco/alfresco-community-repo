...
public class ContentFilterLanguagesMapTest extends AbstractMultilingualTestCases {
    ...
    public void testGetFilterLanguages() throws Exception {
        ...
        try {
            lggs.add("NEW LOCALE");
            assertTrue(
                    "Add a value to the content filter language list is not permit, this list would"
                            + " be read only",
                    false);
        } catch (Exception e) {
            // test case ok
        ...
        try {
            lggs.remove(0);
            assertTrue(
                    "Remove a value to the content filter language list is not permit, this list"
                            + " would be read only",
                    false);
        } catch (Exception e) {
            // test case ok
    ...
    public void testGetMissingLanguages() throws Exception {
        ...
        List<String> missingLggsEmpty =
                contentFilterLanguagesService.getMissingLanguages(Collections.EMPTY_LIST);
