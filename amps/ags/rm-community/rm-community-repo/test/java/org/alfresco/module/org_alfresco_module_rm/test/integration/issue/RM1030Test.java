...
/**
 * Unit test for RM-1030 .. can't freeze a record folder that already has a frozen record contained
 * within
 *
...
public class RM1030Test extends BaseRMTestCase {
    ...
    public void testRM1030() throws Exception {
                            ...
                            public NodeRef run() {
                                Set<String> auths =
                                        filePlanRoleService.getAllAssignedToRole(
                                                filePlan, FilePlanRoleService.ROLE_ADMIN);
        ...
        final NodeRef recordFolderHold =
                doTestInTransaction(
                        new Test<NodeRef>() {
                            @Override
                            public NodeRef run() {
