...
/**
 * A collector of data related the <code>Runtime</code> data of the system. Every Java application
 * has a single instance of class <code>Runtime</code> that allows the application to interface with
 * the environment in which the application is running.
 *
 * <ul>
 *   <li>Collector ID: <b>acs.repository.usage.system</b>
 *   <li>Data:
 *       <ul>
 *         <li><b>mem: Object which contains memory information:</b>
 *             <ul>
 *               <li><b>free:</b> Long - The amount of free memory in the Java Virtual Machine.
 *                   {@link Runtime#freeMemory()}
 *               <li><b>max:</b> Long -T he maximum amount of memory that the Java virtual machine
 *                   will attempt to use. {@link Runtime#maxMemory()}
 *               <li><b>total:</b> Long - The total amount of memory in the Java virtual machine.
 *                   {@link Runtime#totalMemory()}
 *             </ul>
 *         <li><b>openFileDescriptorCount:</b> Long - The number of open file descriptors. {@link
 *             UnixOperatingSystemMXBean#getOpenFileDescriptorCount()}
 *         <li><b>cpu: Object which contains processor information:</b>
 *             <ul>
 *               <li>percentageProcessLoad: Integer - The "recent cpu usage" for the JVM process (as
 *                   a percentage). {@link OperatingSystemMXBean#getProcessCpuLoad()}
 *               <li>percentageSystemLoad: Integer - The "recent cpu usage" for the whole system (as
 *                   a percentage). {@link OperatingSystemMXBean#getSystemCpuLoad()}
 *               <li>systemLoadAverage: Double - The system load average as returned by {@link
 *                   OperatingSystemMXBean#getSystemLoadAverage()}
 *               <li>availableProcessors: Integer - The number of available processors. {@link
 *                   Runtime#availableProcessors()}
 *             </ul>
 *         <li><b>db: Object which contains database usage information:</b>
 *             <ul>
 *               <li>idleConnections: Integer - The number of idle connections. {@link
 *                   BasicDataSource#getNumIdle()}
 *               <li>activeConnections: Integer - The number of active connections. {@link
