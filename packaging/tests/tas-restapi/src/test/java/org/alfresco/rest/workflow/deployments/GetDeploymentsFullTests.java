...
public class GetDeploymentsFullTests extends RestTest {
  ...
  public void getNonNetworkDeploymentsWithValidSkipCount()
    ...
    RestDeploymentModel firstDeployment = deployments
      .getEntries()
      .get(0)
      .onModel();
    RestDeploymentModel secondDeployment = deployments
      .getEntries()
      .get(1)
      .onModel();
    RestDeploymentModelsCollection deploymentsWithSkipCount = restClient
  ...
  public void getNonNetworkDeploymentsWithValidMaxItems()
    ...
    RestDeploymentModel secondDeployment = deployments
      ...
      .get(1)
      .onModel();
    RestDeploymentModelsCollection deploymentsWithMaxItems = restClient
