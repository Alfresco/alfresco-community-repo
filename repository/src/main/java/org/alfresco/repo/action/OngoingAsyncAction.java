...
public class OngoingAsyncAction {
  ...
  public boolean equals(Object otherObj) {
    ...
    return (
      EqualsHelper.nullSafeEquals(this.node, otherNodeBeingActioned.node) &&
      EqualsHelper.nullSafeEquals(
        this.action.getActionDefinitionName(),
        otherNodeBeingActioned.action.getActionDefinitionName()
      )
    );
  }
  ...
  public int hashCode() {
    return (
      this.node.hashCode() +
      7 *
      this.action.getActionDefinitionName().hashCode()
    );
  }
