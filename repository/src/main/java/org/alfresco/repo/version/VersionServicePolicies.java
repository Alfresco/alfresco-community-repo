...
public interface VersionServicePolicies {
    ...
    public interface OnCreateVersionPolicy extends ClassPolicy {
         ...
         * perticular type may be. WARNING: implementing behaviour for this policy effects the
         * versioning behaviour of the type the behaviour is registered against.
         *
    ...
    public interface OnRevertVersionPolicy extends ClassPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "getRevertVersionCallback");
         ...
         * @since V4.2
         */
        VersionRevertCallback getRevertVersionCallback(
    ...
    public interface AfterVersionRevertPolicy extends ClassPolicy {
        public static final QName QNAME =
                QName.createQName(NamespaceService.ALFRESCO_URI, "afterVersionRevert");
        /**
