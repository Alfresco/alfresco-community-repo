 ...
 * 
 * To retrieve either the Primary Post, or all Posts, use {@link DiscussionService#getPrimaryPost(TopicInfo)} and {@link DiscussionService#listPostReplies(TopicInfo, int)}
 *
 * @author Nick Burch
 * @since 4.0
 */
