 ...
 *     <p>Perform a test to see how two dates compare, optionally offset by a specified number of
 *     milliseconds.
 *     <p>Usage: dateCompare(dateA, dateB) - 1 if dateA if greater than dateB dateCompare(dateA,
 *     dateB, millis) - 1 if dateA is greater than dateB by at least millis, else 0
 *     dateCompare(dateA, dateB, millis, test) - same as above, but the 'test' variable is one of
 *     the following strings ">", "<", "==" - greater than, less than or equal - as the test to
 *     perform.
 */
public class DateCompareMethod extends BaseTemplateProcessorExtension
