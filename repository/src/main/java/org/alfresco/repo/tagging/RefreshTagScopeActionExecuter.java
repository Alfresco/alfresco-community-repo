 ...
 *
 * <p>NOTE: This action is used to facilitate the async refresh of a tag scope. It is not intended
 * for general usage.
 *
...
public class RefreshTagScopeActionExecuter extends ActionExecuterAbstractBase {
    ...
    protected void executeImpl(final Action action, final NodeRef actionedUponNodeRef) {
        if (this.nodeService.exists(actionedUponNodeRef) == true
                && this.nodeService.hasAspect(actionedUponNodeRef, ContentModel.ASPECT_TAGSCOPE)
                        == true) {
