                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        TestPublicApi128.this.mixedCaseNetwork =
                                repoService.createNetwork(TestPublicApi128.this.networkId, true);
    ...
    public void testPublicApi128() throws Exception {
        ...
        // try to get person activities given a mixture of cases for networkId and user id
        {
            publicApiClient.setRequestContext(
                    new RequestContext(
                            networkId, getUserName("BOB.JONES", networkPrefix, networkDomain)));
            ...
            publicApiClient.setRequestContext(
                    new RequestContext(networkId, getUserName("BOB.JONES", "MIXEDCASE", "COM")));
            ...
            publicApiClient.setRequestContext(
                    new RequestContext(
                            networkId.toUpperCase(), getUserName("BOB.JONES", "MIXEDCASE", "COM")));
            ...
            peopleProxy.getActivities(
                    getUserName("BOB.JONES", networkPrefix, networkDomain),
            ...
            paging = getPaging(skipCount, maxItems);
            peopleProxy.getActivities(
                    getUserName("BOB.JONES", "MIXEDCASE", "CoM"), createParams(paging, null));
            ...
            paging = getPaging(skipCount, maxItems);
            peopleProxy.getActivities(
                    getUserName("BOB.joNES", networkPrefix, "cOM"), createParams(paging, null));
        }
    }
}
