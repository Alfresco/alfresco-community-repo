...
/**
 * NominatedInvitationImpl is a basic Nominated Invitation Request that is processed by the
 * InvitationService.
 *
 * @see org.alfresco.service.cmr.invitation.NominatedInvitation
 */
/*package scope */ class NominatedInvitationImpl extends InvitationImpl
        implements NominatedInvitation, Serializable {
    ...
    public NominatedInvitationImpl(
            String inviteId, Date inviteDate, Map<QName, Serializable> props) {
