...
public class GetChildByIdMethodTest extends TestCase {
  ...
  private String toChildPath(final String parentPath, String childName)
    ...
    assertEquals(ref.getResource(), childRef.getResource());
    assertEquals(ref.getProtocol(), childRef.getProtocol());
  ...
  public void testExecute() throws Exception {
    ...
    String childPath = toChildPath(parentPath, childName);

    assertEquals(parentPath + "/" + childName, childPath);
  }

  @Test
  public void testTrailingPath() throws Exception {
    String childPath = toChildPath("  /root/   ", "child");

    assertEquals("/root/child", childPath);
  }
}
