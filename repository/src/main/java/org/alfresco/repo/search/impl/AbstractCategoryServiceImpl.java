...
public abstract class AbstractCategoryServiceImpl implements CategoryService {
    ...
    public Collection<ChildAssociationRef> getChildren(
            NodeRef categoryRef, Mode mode, Depth depth, String filter) {
    ...
    private Collection<ChildAssociationRef> getChildren(
        ...
        try {
            ...
            SearchService searcher =
                    indexerAndSearcher.getSearcher(categoryRef.getStoreRef(), true);

            // Perform the search
            SearchParameters searchParameters = new SearchParameters();
            resultSet =
                    searcher.query(
                            categoryRef.getStoreRef(), "lucene", luceneQuery.toString(), null);
    ...
    public ChildAssociationRef getCategory(NodeRef parent, QName aspectName, String name) {
        ...
        Collection<ChildAssociationRef> assocs =
    ...
    private ChildAssociationRef createCategoryInternal(NodeRef parent, String name) {
        ...
        String uri = nodeService.getPrimaryParent(parent).getQName().getNamespaceURI();
        String validLocalName = QName.createValidLocalName(name);
        ChildAssociationRef newCategory =
                publicNodeService.createNode(
                        parent,
                        ContentModel.ASSOC_SUBCATEGORIES,
                        QName.createQName(uri, validLocalName),
