...
public interface ControlDAO
{
    ...
    /**
     * Create a "Save Point" in the current transaction, for later selective rollback. Creation <b>must</b> be accompanied by a matching {@link #rollbackToSavepoint(Savepoint)} or {@link #releaseSavepoint(Savepoint)}. <code><pre>
     ...
     * @return Returns the handle to the savepoint or <tt>null</tt> if the implementation does not support it
     */
     ...
     * <p/>
     * <b>Note:</b> The isolation level should not - and for some DBs, cannot - be changed except at the very start of the transaction
     * 
