...
public class TraitExtenderIntegrationTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        extensionBundle.register(
                new ExtensionPoint<TestExtension, TestTrait>(TestExtension.class, TestTrait.class),
                new InstanceExtensionFactory<TestExtensionImpl, TestTrait, TestExtension>(
                        TestExtensionImpl.class, TestTrait.class, TestExtension.class));
        ...
        singletonExtensionBundle.register(
                ...
                new SingletonExtensionFactory<TestExtension, TestSingletonExtensionImpl, TestTrait>(
                        sigletonExtension, TestExtension.class));
        ...
        publicExtensionBundle.register(
                new ExtensionPoint<TestPublicExtension, TestPublicTrait>(
                        TestPublicExtension.class, TestPublicTrait.class),
                new InstanceExtensionFactory<
                        TestPublicExtensionImpl, TestPublicTrait, TestPublicExtension>(
    ...
    public void testIntegration() {
        ...
        assertEquals(
                "TestService.privateServiceMethod1(testIntegration)"
                        + " TestExtensionImpl.privateServiceMethod1(testIntegration)",
    ...
    public void testIntegration_publicTrait() {
        ...
        assertEquals(
                "EPM1PM1testIntegration", new TestPublicService().publicMethod1("testIntegration"));

        assertEquals(
                "EPM2PM2testIntegration", new TestPublicService().publicMethod2("testIntegration"));
    }
    ...
    public void testIntegration_bypass() {
        ...
        assertEquals(
                "PSM3TestService.privateServiceMethod1(bypass)"
                        + " TestSingletonExtensionImpl.privateServiceMethod1(bypass)@s1"
                        + " TestSingletonExtensionImpl.publicServiceMethod3(bypass)@s1",
