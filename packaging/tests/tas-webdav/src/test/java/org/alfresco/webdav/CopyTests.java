...
public class CopyTests extends WebDavTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify that an user with site manager role can copy an empty folder with"
                            + " content in site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that an user with site manager role can copy folder with content in"
                            + " site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user with collaborator role can copy an empty folder in site"
                            + " folder")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that user with collaborator role can copy folder with content in site"
                            + " folder")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user with contribuitor role can copy an empty folder in site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that user with contributor role can copy folder with content in site"
                            + " folder")
    ...
    public void siteContributorShouldCopyFileAddedByOtherUser() throws Exception {
        UserModel contributor = dataUser.createRandomTestUser();
        dataUser.usingUser(managerUser)
                .addUserToSite(contributor, testSite, UserRole.SiteCollaborator);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that user with consumer role cannot copy folder with content in site"
                            + " folder")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager can copy an empty folder twice in same location")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager can copy a folder with content twice in same"
                            + " location")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager cannot copy nonexistent folder with content from"
                            + " site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that unauthenticated user cannot copy a folder with content from site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that nonnexistent user cannot copy a folder with content from site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that unauthorized user cannot copy a folder with content from site")
