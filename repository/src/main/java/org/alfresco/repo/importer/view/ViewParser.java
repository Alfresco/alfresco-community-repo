...
public class ViewParser implements Parser {
  ...
  private static final QName VIEW_METADATA = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "metadata"
  );
  private static final QName VIEW_VALUE_QNAME = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "value"
  );
  private static final QName VIEW_VALUES_QNAME = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "values"
  );
  private static final QName VIEW_ASPECTS = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "aspects"
  );
  private static final QName VIEW_PROPERTIES = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "properties"
  );
  private static final QName VIEW_ASSOCIATIONS = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "associations"
  );
  private static final QName VIEW_ACL = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "acl"
  );
  private static final QName VIEW_ACE = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "ace"
  );
  private static final QName VIEW_AUTHORITY = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "authority"
  );
  private static final QName VIEW_PERMISSION = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "permission"
  );
  private static final QName VIEW_REFERENCE = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "reference"
  );
  private static final QName VIEW_ML_VALUE = QName.createQName(
    NamespaceService.REPOSITORY_VIEW_1_0_URI,
    "mlvalue"
  );
    ...
    if (defName.equals(VIEW_METADATA)) {
      ...
      if (element instanceof MetaDataContext) {
        ...
        if (def instanceof AspectDefinition) {
          ...
          processProperty(
            xpp,
            ((PropertyDefinition) def).getName(),
            parserContext
          );
          return;
        ...
        if (itemName.equals(VIEW_ASPECTS)) {
          ...
          AssociationDefinition def = (AssociationDefinition) node.determineAssociation(
            defName
          );
          if (def == null) {
            throw new ImporterException(
  ...
  private void processRoot(XmlPullParser xpp, ParserContext parserContext)
    ...
    ParentContext parent = new ParentContext(
      getName(xpp),
      parserContext.dictionaryService,
      parserContext.importer
    );
    parserContext.elementStack.push(parent);

    if (logger.isDebugEnabled()) logger.debug(
      indentLog("Pushed " + parent, parserContext.elementStack.size() - 1)
    );
  }
  ...
  private void processStartType(
    ...
    String childName = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
      VIEW_CHILD_NAME_ATTR
    );
    ...
    String importId = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
      VIEW_ID_ATTR
    );
    ...
    if (logger.isDebugEnabled()) logger.debug(
      indentLog("Pushed " + node, parserContext.elementStack.size() - 1)
    );
  }
  ...
  private void processStartReference(
    ...
    String idRefAttr = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
      VIEW_IDREF_ATTR
    );
    String pathRefAttr = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
      VIEW_PATHREF_ATTR
    );
    String nodeRefAttr = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
      VIEW_NODEREF_ATTR
    );
    if (
      (idRefAttr != null && idRefAttr.length() > 0) &&
    ...
    if (nodeRefAttr != null) {
      ...
      if (nodeRef == null) {
        throw new ImporterException(
          "Cannot find node referenced by id " + idRefAttr
        );
      }
      ...
      if (nodeRef == null) {
        throw new ImporterException(
          "Cannot find node referenced by path " + pathRefAttr
        );
      }
    }
  ...
  private void processACL(XmlPullParser xpp, ParserContext parserContext) {
    ...
    String strInherit = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
   ...
   * @throws IOException
   */
  private void processAccessControlEntry(
    XmlPullParser xpp,
    ParserContext parserContext
  ) throws XmlPullParserException, IOException {
    NodeContext node = peekNodeContext(parserContext.elementStack);
    ...
    String access = xpp.getAttributeValue(
      NamespaceService.REPOSITORY_VIEW_1_0_URI,
      VIEW_ACCESS_STATUS_ATTR
    );
    AccessStatus accessStatus = (access == null)
  ...
  private void processProperty(
    ...
    if (eventType == XmlPullParser.END_TAG) {
      ...
      if (isMLProperty) {
        ...
        node.addDatatype(
          propertyName,
          dictionaryService.getDataType(DataTypeDefinition.MLTEXT)
        );
      ...
      while (eventType == XmlPullParser.START_TAG) {
        ...
        if (eventType == XmlPullParser.END_TAG) {
          ...
          if (datatype != null) {
            node.addDatatype(
              propertyName,
              dictionaryService.getDataType(datatype)
            );
          }
        } else {
          throw new ImporterException(
  ...
  private void processEndElement(
    ...
    if (
      element.getElementName().getLocalName().equals(xpp.getName()) &&
      element.getElementName().getNamespaceURI().equals(xpp.getNamespace())
    ) {
      element = parserContext.elementStack.pop();

      if (logger.isDebugEnabled()) logger.debug(
        indentLog("Popped " + element, parserContext.elementStack.size())
      );
   ...
   */
  private void processEndMetaData(
    ParserContext parserContext,
   ...
   */
  private NodeRef getImportReference(
    ParserContext parserContext,
    String importId
  ) {
  ...
  private NodeContext peekNodeContext(Stack<ElementContext> contextStack) {
    ...
    throw new ImporterException(
      "Internal error: Failed to retrieve node context"
    );
  }
