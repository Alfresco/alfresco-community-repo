...
public abstract class AbstractReadPermissionTest extends TestCase {
  ...
  protected String[] webAuthorities = new String[] {
    "Web1",
    "Web2",
    "Web3",
    "Web4",
  ...
  protected String[] authorities = new String[] {
    "Dynamic",
    "1000",
    "1001",
    "Y",
  ...
  protected NodeRef[] build1000Nodes(
    final String authority,
    final int returnNodes,
    final boolean inherit
  ) {
    return build1000Nodes(
      authority,
  ...
  protected NodeRef[] buildOwnedNodes(
    final String authority,
    final int returnNodes
  ) {
    runAs("admin");
    ...
    RetryingTransactionCallback<Void> cb = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
        ...
        NodeRef folder = fileFolderService
          .create(rootNodeRef, namePrefix, ContentModel.TYPE_FOLDER)
          .getNodeRef();

        NodeRef folder_1000 = fileFolderService
          .create(folder, namePrefix + "-1000-", ContentModel.TYPE_FOLDER)
          .getNodeRef();
        ...
        for (int j = 0; j < 1000; j++) {
          NodeRef file = fileFolderService
            .create(
              folder_1000,
              namePrefix + "-1000-" + j,
  ...
  protected void buildNodes(
    ...
    RetryingTransactionCallback<Void> cb = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
        ...
        NodeRef folder_n = fileFolderService
          .create(folder, namePrefix + "-n", ContentModel.TYPE_FOLDER)
          .getNodeRef();
        ...
        for (int j = 0; j < n; j++) {
          NodeRef file = fileFolderService
            .create(folder_n, namePrefix + "-n-" + j, ContentModel.TYPE_CONTENT)
            .getNodeRef();
          if (!inherit) {
  ...
  protected void build1000NodesReadDenied(final String authority) {
    ...
    RetryingTransactionCallback<Void> cb = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
        ...
        NodeRef folder = fileFolderService
          .create(rootNodeRef, name, ContentModel.TYPE_FOLDER)
          .getNodeRef();

        NodeRef folder_1001 = fileFolderService
          .create(folder, name + "-1001", ContentModel.TYPE_FOLDER)
          .getNodeRef();
        permissionService.setPermission(
          folder_1001,
          authority,
        ...
        for (int j = 0; j < 1000; j++) {
          NodeRef file = fileFolderService
            .create(folder_1001, name + "-1001-" + j, ContentModel.TYPE_CONTENT)
            .getNodeRef();
          permissionService.setInheritParentPermissions(file, false);
          permissionService.setPermission(
            file,
  ...
  protected void buildNodes() {
    ...
    for (int ii = 0; ii < COUNT; ii++) {
      ...
      RetryingTransactionCallback<Void> cb = new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          NodeRef folder = fileFolderService
            .create(rootNodeRef, namePrefix + i, ContentModel.TYPE_FOLDER)
            .getNodeRef();

          NodeRef folder_1000 = fileFolderService
            .create(folder, namePrefix + "1000-" + i, ContentModel.TYPE_FOLDER)
            .getNodeRef();
          permissionService.setPermission(
            folder_1000,
            "1000",
          ...
          NodeRef folder_100 = fileFolderService
            .create(folder, namePrefix + "100-" + i, ContentModel.TYPE_FOLDER)
            .getNodeRef();
          permissionService.setPermission(
            folder_100,
            "100",
          ...
          NodeRef folder_10 = fileFolderService
            .create(folder, namePrefix + "10-" + i, ContentModel.TYPE_FOLDER)
            .getNodeRef();
          permissionService.setPermission(
            folder_10,
            "10",
          ...
          NodeRef folder_10_1 = fileFolderService
            .create(folder, namePrefix + "10_1-" + i, ContentModel.TYPE_FOLDER)
            .getNodeRef();
          permissionService.setPermission(
            folder_10_1,
            "GROUP_X",
          ...
          NodeRef folder_1 = fileFolderService
            .create(folder, namePrefix + "1" + i, ContentModel.TYPE_FOLDER)
            .getNodeRef();
          permissionService.setPermission(
            folder_1,
            "1",
          ...
          NodeRef file = fileFolderService
            .create(folder_1, namePrefix + "1-1-1", ContentModel.TYPE_CONTENT)
            .getNodeRef();

          double rn = random.nextDouble();

          if (rn < 0.1) {
            NodeRef rf = fileFolderService
              .create(folder, namePrefix + "0.1", ContentModel.TYPE_CONTENT)
              .getNodeRef();
          ...
          if (rn < 0.01) {
            NodeRef rf = fileFolderService
              .create(folder, namePrefix + "0.01", ContentModel.TYPE_CONTENT)
              .getNodeRef();
          ...
          if (rn < 0.001) {
            NodeRef rf = fileFolderService
              .create(folder, namePrefix + "0.001", ContentModel.TYPE_CONTENT)
              .getNodeRef();
  ...
  public void setUp() throws Exception {
    ...
    accessControlListDao =
      (AccessControlListDAO) applicationContext.getBean("admNodeACLDAO");
    fileFolderService =
    ...
    ownableService =
      (OwnableService) applicationContext.getBean("ownableService");
    ...
    fIndexerAndSearcher =
      (IndexerAndSearcher) applicationContext.getBean(
    ...
    authorityService.addAuthority(
      authorityService.getName(AuthorityType.GROUP, "X"),
      "10_1"
    );
