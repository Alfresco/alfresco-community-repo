...
public class CustomReferenceDefinitionsGet extends CustomReferenceDefinitionBase {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        List<Map<String, String>> relationshipDefinitionData =
                createRelationshipDefinitionData(relationshipDefinitions);
    ...
    /**
     * Gets the relationship definition for the unique name. If the unique name is blank all
     * relationship definitions will be retrieved
     *
     * @param uniqueName The unique name of the relationship definition
     * @return Relationship definition for the given unique name or all relationship definitions if
     *     unique name is blank
     */
     ...
     */
    private List<Map<String, String>> createRelationshipDefinitionData(
