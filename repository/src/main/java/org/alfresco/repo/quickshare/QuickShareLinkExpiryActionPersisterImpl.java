...
public class QuickShareLinkExpiryActionPersisterImpl
  ...
  protected static final NodeRef QUICK_SHARE_LINK_EXPIRY_ACTIONS_ROOT = new NodeRef(
  ...
  @Override
  public void saveQuickShareLinkExpiryAction(
  ...
  public QuickShareLinkExpiryAction loadQuickShareLinkExpiryAction(
    QName linkExpiryActionName
  ) {
    NodeRef actionNode = getQuickShareLinkExpiryActionNode(
      linkExpiryActionName
    );
  ...
  @Override
  public void deleteQuickShareLinkExpiryAction(
    QuickShareLinkExpiryAction linkExpiryAction
  ) {
    ParameterCheck.mandatory("linkExpiryAction", linkExpiryAction);
