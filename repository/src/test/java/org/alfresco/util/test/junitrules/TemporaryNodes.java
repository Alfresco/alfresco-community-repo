...
/**
 * A JUnit rule designed to help with the automatic cleanup of temporary test nodes and to ake it easier to create common test content with JUnit code.
 * 
...
public class TemporaryNodes extends ExternalResource
{
    ...
    /**
     * This method creates a NodeRef and adds it to the internal list of NodeRefs to be tidied up by the rule. This method will be run in its own transaction and will be run with the specified user as the fully authenticated user, thus ensuring the named user is the cm:creator of the new node.
     * 
     * @param parentNode
     *            the parent node
     * @param nodeCmName
     *            the cm:name of the new node
     * @param nodeType
    ...
    /**
     * This method creates a NodeRef with some text/plain, UTF-8 content and adds it to the internal list of NodeRefs to be tidied up by the rule. This method will be run in its own transaction and will be run with the specified user as the fully authenticated user, thus ensuring the named user is the cm:creator of the new node.
     * 
     * @param parentNode
     *            the parent node
     * @param nodeCmName
    ...
    /**
     * This method creates a cm:folder NodeRef and adds it to the internal list of NodeRefs to be tidied up by the rule. This method will be run in its own transaction and will be run with the specified user as the fully authenticated user, thus ensuring the named user is the cm:creator of the new node.
     * 
     * @param parentNode
     *            the parent node
     * @param nodeCmName
    ...
    /**
     * This method creates a cm:content NodeRef whose content is taken from an Alfresco 'quick' file and adds it to the internal list of NodeRefs to be tidied up by the rule. This method will be run in its own transaction and will be run with the specified user as the fully authenticated user, thus ensuring the named user is the cm:creator of the new node.
     * 
     * @param mimetype
     *            the MimeType of the content to put in the new node.
     * @param parentNode
     *            the parent node
     * @param nodeCmName
     *            the cm:name of the new node
     ...
     *            the username of the person who will create the node
     * @param isVersionable
     *            should the new node be {@link ContentModel#ASPECT_VERSIONABLE versionable}?
     * @return the newly created NodeRef.
     */
    ...
    /**
     * This method creates a cm:content NodeRef whose content is taken from the named Alfresco 'quick' file and adds it to the internal list of NodeRefs to be tidied up by the rule. This method will be run in its own transaction and will be run with the specified user as the fully authenticated user, thus ensuring the named user is the cm:creator of the new node.
     *
     * @param quickFileName
     *            the file name of the quick file - will also be the cm:name of the new node.
     * @param parentNode
     *            the parent node
     * @param nodeCreator
     *            the username of the person who will create the node
     ...
     * 
     * @param mimetype
     *            the MIME type e.g. {@link MimetypeMap#MIMETYPE_IMAGE_JPEG}
