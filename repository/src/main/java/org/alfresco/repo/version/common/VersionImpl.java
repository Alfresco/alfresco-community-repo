 ...
 *
 * <p>Used to represent the data about a version stored in a version store.
 *
...
public class VersionImpl implements Version {
    ...
    public VersionType getVersionType() {
        return DefaultTypeConverter.INSTANCE.convert(
                VersionType.class, this.versionProperties.get(VersionBaseModel.PROP_VERSION_TYPE));
    }
    ...
    public NodeRef getVersionedNodeRef() {
        ...
        if (nodeRef.getStoreRef().getIdentifier().equals(Version2Model.STORE_ID)) {
            ...
            versionedNodeRef =
                    (NodeRef) this.versionProperties.get(Version2Model.PROP_FROZEN_NODE_REF);
            ...
            String storeProtocol =
                    (String)
                            this.versionProperties.get(
                                    VersionModel.PROP_FROZEN_NODE_STORE_PROTOCOL);
            String storeId =
                    (String) this.versionProperties.get(VersionModel.PROP_FROZEN_NODE_STORE_ID);
