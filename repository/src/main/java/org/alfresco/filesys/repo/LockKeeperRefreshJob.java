...
public class LockKeeperRefreshJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        final LockKeeper lockKeeper =
                getRequiredQuartzJobParameter(context, "alfrescoLockKeeper", LockKeeper.class);

        lockKeeper.refreshAllLocks();
    }

    private <T> T getRequiredQuartzJobParameter(
            JobExecutionContext context, String dataKey, Class<T> requiredClass)
