...
public class ImapDeleteMessagesTests extends EmailTest {
    ...
    public void siteManagerShouldDeleteMessage() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(testSite)
                .assertThat()
                .containsMessages(testFile)
                .deleteMessage(testFile.getName())
                .and()
                .assertThat()
                .doesNotContainMessages(testFile);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify message has been deleted via REPOSITORU by user with MANAGER role")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify deleting message via IMAP client by user with CONSUMER role is not"
                            + " permitted")
    @Test(
