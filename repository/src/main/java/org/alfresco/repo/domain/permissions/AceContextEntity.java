...
public class AceContextEntity implements AceContext {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      PRIME * result + ((classContext == null) ? 0 : classContext.hashCode());
    result =
      PRIME * result + ((kvpContext == null) ? 0 : kvpContext.hashCode());
    result =
      PRIME *
      result +
      ((propertyContext == null) ? 0 : propertyContext.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (classContext == null) {
      if (other.classContext != null) return false;
