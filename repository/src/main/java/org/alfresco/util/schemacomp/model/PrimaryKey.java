...
public class PrimaryKey extends AbstractDbObject {
     ...
     */
    public PrimaryKey(
            Table table, String name, List<String> columnNames, List<Integer> columnOrders) {
        super(table, name);
    ...
    /**
     * Ensure that if columnOrders are being used, there are as many of them as there are column
     * names.
     */
    ...
    protected void doDiff(DbObject right, DiffContext ctx) {
        ...
        comparisonUtils.compareSimpleOrderedLists(
                new DbProperty(this, "columnNames"), new DbProperty(rightPK, "columnNames"), ctx);
        comparisonUtils.compareSimpleOrderedLists(
                new DbProperty(this, "columnOrders"), new DbProperty(rightPK, "columnOrders"), ctx);
    }
