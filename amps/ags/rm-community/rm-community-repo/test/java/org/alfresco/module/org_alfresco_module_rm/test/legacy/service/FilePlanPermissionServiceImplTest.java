...
public class FilePlanPermissionServiceImplTest extends BaseRMTestCase {
  ...
  public void testMoveRecord() throws Exception {
    ...
    final NodeRef otherFolder = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
        public NodeRef run() {
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          assertEquals(
            accessStatus[1],
            permissionService.hasPermission(filePlan, RMPermissionModel.FILING)
          );
          ...
          assertEquals(
            accessStatus[5],
            permissionService.hasPermission(rmFolder, RMPermissionModel.FILING)
          );
          ...
          assertEquals(
            accessStatus[7],
            permissionService.hasPermission(recordOne, RMPermissionModel.FILING)
          );
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          assertFalse(
            permissionService.getInheritParentPermissions(rmContainer)
          );
          assertTrue(
            permissionService.getInheritParentPermissions(
              recordFolderService.createRecordFolder(rmContainer, "subCategory")
            )
          );
  ...
  public void testRolesSetByDefault() {
    NodeRef subCategory = filePlanService.createRecordCategory(
      rmContainer,
      "subCategory1"
    );
    NodeRef folder = recordFolderService.createRecordFolder(
      subCategory,
      "rmFolder1"
    );
  ...
  public void testAccessPermissionOnSingleRecordWithSeveralUsers() {
    final NodeRef subCategory = filePlanService.createRecordCategory(
      rmContainer,
      "subCategory3"
    );
    final NodeRef folder = recordFolderService.createRecordFolder(
      subCategory,
      "rmFolder3"
    );
  ...
  public void testMoveRootCategoryIntoAnotherRootCategory() {
    final NodeRef category5 = filePlanService.createRecordCategory(
      filePlan,
      "category5"
    );
    final NodeRef category6 = filePlanService.createRecordCategory(
      filePlan,
      "category6"
    );
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          assertEquals(
            AccessStatus.DENIED,
            permissionService.hasPermission(category5, RMPermissionModel.FILING)
          );
          assertEquals(
            AccessStatus.DENIED,
            permissionService.hasPermission(
          ...
          assertEquals(
            AccessStatus.DENIED,
            permissionService.hasPermission(category6, RMPermissionModel.FILING)
          );
    ...
    final NodeRef movedCategory5 = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
  ...
  public void testPermissionsForMovedRecord() {
    final NodeRef category7 = filePlanService.createRecordCategory(
      filePlan,
      "category7"
    );
    final NodeRef folder7 = recordFolderService.createRecordFolder(
      category7,
      "rmFolder7"
    );
    final NodeRef record7 = utils.createRecord(folder7, "record7.txt");

    final NodeRef category8 = filePlanService.createRecordCategory(
      filePlan,
      "category8"
    );
    final NodeRef folder8 = recordFolderService.createRecordFolder(
      category8,
      "rmFolder8"
    );
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          assertEquals(
            AccessStatus.DENIED,
            permissionService.hasPermission(category7, RMPermissionModel.FILING)
          );
          assertEquals(
            AccessStatus.ALLOWED,
            permissionService.hasPermission(
          ...
          assertEquals(
            AccessStatus.DENIED,
            permissionService.hasPermission(category8, RMPermissionModel.FILING)
          );
          assertEquals(
            AccessStatus.DENIED,
            permissionService.hasPermission(
    ...
    final NodeRef movedRecord8 = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
        public NodeRef run() throws Exception {
  ...
  public void testSpecialRoles() {
    final NodeRef category9 = filePlanService.createRecordCategory(
      filePlan,
      "category9"
    );
    final NodeRef subCategory9 = filePlanService.createRecordCategory(
      category9,
      "subCategory9"
    );
    final NodeRef folder9 = recordFolderService.createRecordFolder(
      subCategory9,
      "rmFolder9"
    );
  ...
  private void assertExistenceOfSpecialRolesAndPermissions(NodeRef node) {
    ...
    for (AccessPermission permission : permissions) {
      accessPermissions.put(
        permission.getAuthority(),
        permission.getPermission()
      );
    }

    String adminRole = authorityService.getName(
      AuthorityType.GROUP,
  ...
  public void testMoveSubCategoryIntoFilePlan() {
    final NodeRef rootCategory = filePlanService.createRecordCategory(
      filePlan,
      GUID.generate()
    );
    final NodeRef subCategory = filePlanService.createRecordCategory(
    ...
    final NodeRef movedSubCategory = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
        public NodeRef run() throws Exception {
          return fileFolderService
    ...
    assertFalse(permissionService.getInheritParentPermissions(rootCategory));
    assertFalse(
      permissionService.getInheritParentPermissions(movedSubCategory)
    );
  }
}
