...
public class ApplyTemplateMethod
  ...
  public VirtualFolderDefinition execute(
    ...
    try {
      VirtualFolderDefinition theStructure = resource.processWith(
        new TemplateResourceProcessor(context)
      );
  ...
  public VirtualFolderDefinition execute(
    ...
    InputStream vanillaIS = reference.execute(
      new GetVanillaScriptInputStreamMethod(environment)
    );
    try {
