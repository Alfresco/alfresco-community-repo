 ...
 *
 * <p>Depending on the parameters provided, this class may choose to pick up existing results and
 * re-use them for later page requests; the client will not have knowledge of the shortcuts.
 *
 * <p>TODO: This is work-in-progress
 *
 * @author Derek Hulley
 * @since 4.0
 */
public abstract class AbstractCachingCannedQueryFactory<R> extends AbstractCannedQueryFactory<R> {
    ...
    private class CannedQueryCacheFacade<R> extends AbstractCannedQuery<R> {
        ...
        private CannedQueryCacheFacade(
                CannedQueryParameters params, AbstractCannedQuery<R> delegate) {
            super(params);
