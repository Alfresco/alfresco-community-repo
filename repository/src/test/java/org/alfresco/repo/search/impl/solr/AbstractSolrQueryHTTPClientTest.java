...
public class AbstractSolrQueryHTTPClientTest {
  ...
  private AbstractSolrQueryHTTPClient abstractSolrQueryHTTPClient = spy(
  ...
  public void setUp() throws Exception {
    ...
    doReturn(postMethod)
      .when(abstractSolrQueryHTTPClient)
      .createNewPostMethod(URL);
  ...
  public void testPostQuery_success() throws Exception {
    ...
    when(postMethod.getResponseBodyAsStream())
      .thenReturn(convertStringToInputStream("{}"));

    JSONObject response = abstractSolrQueryHTTPClient.postQuery(
      httpClient,
      URL,
      body
    );
    ...
    assertEquals(
      "Unexpected JSON response received.",
      "{}",
      response.toString()
    );
  }
  ...
  public void testPostQuery_failure() throws Exception {
    String failureMessage =
      "{\"error\": {\"trace\": \"ExceptionClass: Stacktrace\"}}";

    when(body.toString()).thenReturn("Example body");
    when(postMethod.getStatusCode())
      .thenReturn(HttpServletResponse.SC_NOT_FOUND);
    when(postMethod.getResponseBodyAsStream())
      .thenReturn(convertStringToInputStream(failureMessage));
  ...
  public void testPostQuery_unsupportedOperation() throws Exception {
    String failureMessage =
      "{\"error\": {\"trace\": \"java.lang.UnsupportedOperationException: Stacktrace\"}}";
  ...
  public void testPostQuery_moved() throws Exception {
    ...
    when(postMethod.getStatusCode())
      .thenReturn(HttpServletResponse.SC_MOVED_PERMANENTLY)
