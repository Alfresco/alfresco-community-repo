...
public class NodeServiceTest
{
     ...
     * 
     * @param workspaceRootNodeRef
     *            the store to use
     * @param liveNodeRefs
     *            the node array to fill
     */
    ...
    /**
     * Tests that two separate node trees can be deleted concurrently at the database level. This is not a concurrent thread issue; instead we delete a hierarchy and hold the txn open while we delete another in a new txn, thereby testing that DB locks don't prevent concurrent deletes.
     * <p/>
     * See: <a href="https://issues.alfresco.com/jira/browse/ALF-5714">ALF-5714</a><br/>
     * See: <a href="https://issues.alfresco.com/jira/browse/ALF-16888">ALF-16888</a> See: <a href="https://issues.alfresco.com/jira/browse/REPO-2783">REPO-2783</a>
     * <p/>
