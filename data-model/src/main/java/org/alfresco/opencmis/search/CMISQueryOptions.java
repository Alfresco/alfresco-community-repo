...
public class CMISQueryOptions extends QueryOptions {
  ...
  public static CMISQueryOptions create(SearchParameters searchParameters) {
    ...
    options.setIncludeInTransactionData(
      !searchParameters.excludeDataInTheCurrentTransaction()
    );
    ...
    options.setMaxPermissionCheckTimeMillis(
      searchParameters.getMaxPermissionCheckTimeMillis()
    );
    ...
    options.setQueryParameterDefinitions(
  ...
  public SearchParameters getAsSearchParmeters() {
    ...
    searchParameters.setMaxPermissionCheckTimeMillis(
      this.getMaxPermissionCheckTimeMillis()
    );
