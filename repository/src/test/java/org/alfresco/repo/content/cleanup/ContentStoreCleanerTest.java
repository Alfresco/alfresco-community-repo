...
public class ContentStoreCleanerTest extends TestCase {
    ...
    public void testEagerCleanupOnCommit() throws Exception {
                    ...
                    public NodeRef execute() throws Throwable {
                        ...
                        StoreRef storeRef =
                                nodeService.createStore(
                                        "test", "testEagerCleanupOnCommit-" + GUID.generate());
                        NodeRef rootNodeRef = nodeService.getRootNode(storeRef);
                        Map<QName, Serializable> properties =
                                Collections.singletonMap(
                                        ContentModel.PROP_NAME, (Serializable) "test.txt");
        ...
        final NodeRef contentNodeRef =
                transactionService
                        ...
                        .doInTransaction(makeContentCallback);
        ...
        RetryingTransactionCallback<ContentData> pointlessUpdateCallback =
                new RetryingTransactionCallback<ContentData>() {
                    public ContentData execute() throws Throwable {
                        ...
                        nodeService.setProperty(
                                contentNodeRef, ContentModel.PROP_CONTENT, contentData);
                        // Done
                        return contentData;
                    }
                };
    ...
    public void testEagerCleanupDereferencing() throws Exception {
        ...
        try {
            ...
            final StoreRef storeRef =
                    nodeService.createStore("test", getName() + "-" + GUID.generate());
            RetryingTransactionCallback<ContentData> testCallback =
                    new RetryingTransactionCallback<ContentData>() {
                        public ContentData execute() throws Throwable {
                            ...
                            assertTrue(
                                    "Content was cleaned before end of transaction",
                                    reader.exists());
            ...
            assertNotNull(reader);
            assertTrue(
                    "Content was cleaned despite being re-referenced in the transaction",
                    reader.exists());
        } finally {
            contentPropertyRestrictionInterceptor.setGlobalContentPropertyRestrictionWhiteList("");
        }
     ...
     *
     * <p>There is no validation that the file is affected. It's an example of how to wire different
     * listeners together to do neat things to the files before deletion.
     */
    public void testForcedImmediateShredding() throws Exception {
        ...
        final EagerContentStoreCleaner wipingEagerCleaner =
                new EagerContentStoreCleaner() {
                    final FileWipingContentCleanerListener fileWiper =
                            new FileWipingContentCleanerListener();
        ...
        final StoreRef storeRef =
                nodeService.createStore("test", getName() + "-" + GUID.generate());
        RetryingTransactionCallback<NodeRef> testCallback =
                new RetryingTransactionCallback<NodeRef>() {
                    public NodeRef execute() throws Throwable {
                        // Create some content
                        NodeRef rootNodeRef = nodeService.getRootNode(storeRef);
        ...
        RetryingTransactionCallback<String> deleteCallback =
                new RetryingTransactionCallback<String>() {
                    public String execute() throws Throwable {
    ...
    public void testMNT_12150() {
        ...
        final StoreRef storeRef =
                nodeService.createStore("test", getName() + "-" + GUID.generate());
        RetryingTransactionCallback<ContentData> prepareCallback =
                new RetryingTransactionCallback<ContentData>() {
                    public ContentData execute() throws Throwable {
                        // Create some content
                        NodeRef rootNodeRef = nodeService.getRootNode(storeRef);
        ...
        ContentData contentData =
                transactionService.getRetryingTransactionHelper().doInTransaction(prepareCallback);
        ...
        stores.add(
                new FileContentStore(ctx, store.getRootLocation()) {
                    @Override
