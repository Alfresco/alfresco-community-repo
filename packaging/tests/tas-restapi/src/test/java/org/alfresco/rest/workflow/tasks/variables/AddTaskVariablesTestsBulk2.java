...
public class AddTaskVariablesTestsBulk2 extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Adding task variable is falling in case invalid variableBody is provided")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task variable is falling in case invalid variableBody is"
                            + " provided")
    ...
    public void failedAddingTaskVariableIfEmptyBodyIsProvided() throws Exception {
        RestVariableModel invalidVariableModel =
                RestVariableModel.getRandomTaskVariableModel("", "");
        restClient.withWorkflowAPI().usingTask(taskModel).addTaskVariable(invalidVariableModel);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task variable is falling in case empty body type is provided")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding task variable is falling in case incomplete body type is provided")
    public void failedAddingTaskVariableIfIncompleteBodyIsProvided() throws Exception {
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST,
                        "{\"name\": \"missingVariableScope\",\"value\": \"test\",\"type\":"
                                + " \"d:text\"}",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding task variable is falling in case incomplete body - missing required:"
                            + " name type is provided")
    public void failedAddingTaskVariableIfIncompleteRequiredBodyIsProvided() throws Exception {
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST,
                        "{\"scope\": \"local\",\"value\": \"missingVariableName\",\"type\":"
                                + " \"d:text\"}",
                        "tasks/{taskId}/variables",
                        taskId);
        restClient.processModel(RestVariableModel.class, request);
    ...
    public void failedAddingTaskVariableIfInvalidTypeIsProvided() throws Exception {
        RestVariableModel invalidVariableModel =
                RestVariableModel.getRandomTaskVariableModel("local", "d:char");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task variable is falling in case invalid type is provided")
    ...
    public void failedAddingTaskVariableIfInvalidTypePrefixIsProvided() throws Exception {
        RestVariableModel invalidVariableModel =
                RestVariableModel.getRandomTaskVariableModel("local", "ddm:text");
        taskModel.setId(taskId);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task variable is falling in case invalid type prefix is"
                            + " provided")
    ...
    public void failedAddingTaskVariableIfInvalidScopeIsProvided() throws Exception {
        RestVariableModel invalidVariableModel =
                RestVariableModel.getRandomTaskVariableModel("instance", "d:text");
        taskModel.setId(taskId);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task variable is falling in case invalid scope is provided")
    ...
    public void failedAddingTaskVariableIfInvalidTaskIdIsProvided() throws Exception {
        RestVariableModel variableModel =
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task variable is falling in case invalid task id is provided")
