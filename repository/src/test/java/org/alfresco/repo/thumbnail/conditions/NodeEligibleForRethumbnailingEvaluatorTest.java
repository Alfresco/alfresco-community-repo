...
public class NodeEligibleForRethumbnailingEvaluatorTest extends BaseSpringTest {
  ...
  private final QName thumbnailDef1 = QName.createQName(
  ...
  public void before() throws Exception {
    ...
    NodeRef thumbDef1FailureNode = nodeService
      .createNode(
        recentlyFailedNodeRef,
  ...
  public void testNodeWithNoFailedThumbnails() {
    ...
    NodeEligibleForRethumbnailingEvaluator evaluator = (NodeEligibleForRethumbnailingEvaluator) this.applicationContext.getBean(
        NodeEligibleForRethumbnailingEvaluator.NAME
      );
  ...
  public void testNodeWithFailedThumbnails() {
    ...
    final long timeBeforeTheLimit = new Date().getTime() -
    (failureHandlingOptions.getRetryPeriod() * 1000l) -
    5000l;
    nodeService.setProperty(
    ...
    final long timeBeforeTheLongLimit = new Date().getTime() -
    (failureHandlingOptions.getQuietPeriod() * 1000l) -
    5000l;
    nodeService.setProperty(
      failedThumbnailInfo.getFailedThumbnailNode(),
      ContentModel.PROP_FAILED_THUMBNAIL_TIME,
