...
public class VirtualFileFolderServiceExtensionTest
  ...
  public void testListNonVirtualizable() throws Exception {
    NodeRef nv = createVirtualizedFolder(
  ...
  public void testSearch() throws Exception {
    ...
    List<FileInfo> search = fileAndFolderService.search(
      virtualFolder1NodeRef,
      "testfile.txt",
      true,
      false,
  ...
  public void testListVirtualizedVirtualChild() throws Exception {
    ...
    NodeRef virtulizedFolder = createVirtualizedFolder(
      vf,
    ...
    NodeRef vfchildvf = nodeService.getChildByName(
      node1,
      ContentModel.ASSOC_CHILDREN,
      virtualizedChildFolderName
    );
    ...
    {
      PagingResults<FileInfo> vfchildvfResults = fileAndFolderService.list(
        vfchildvf,
        null,
        null,
        null,
  ...
  public void testListFileFolderDisjunction() throws Exception {
    ...
    try {
      PagingResults<FileInfo> folderChildren = fileAndFolderService.list(
        node2,
        false,
        true,
        "*",
    ...
    prepareMocks(
      "Node2",
      smartStore.materializeIfPossible(createContent.getChildRef())
    );
    try {
      PagingResults<FileInfo> contentChildren = fileAndFolderService.list(
        node2,
        true,
        false,
        "*",
  ...
  public void testListWithIgnores() throws Exception {
    ...
    CheckOutCheckInService checkOutCheckInService = ctx.getBean(
    ...
    Set<QName> ignoreAspectQNames = Collections.singleton(
    ...
    PagingResults<FileInfo> node2List = fileAndFolderService.list(
      node2,
      searchTypeQNames,
      ignoreAspectQNames,
      sortProps,
  ...
  public void testCreateTempFile() throws Exception {
    ...
    NodeRef childByName = nodeService.getChildByName(
      node2,
      ContentModel.ASSOC_CHILDREN,
      contentName
    );
  ...
  public void testRename() throws Exception {
    ...
    FileInfo renamedFileInfo = fileAndFolderService.rename(
      childByName,
      NEW_FILE_NAME_1
    );
    ...
    assertEquals(
      NEW_FILE_NAME_1,
      nodeService.getProperty(childByName, ContentModel.PROP_NAME)
    );
    assertNull(
    ...
    assertNull(
      nodeService.getChildByName(vf, ContentModel.ASSOC_CONTAINS, contentName)
    );
    assertNotNull(
      nodeService.getChildByName(
        node2,
  ...
  public void testListNamePattern() throws Exception {
    ...
    ChildAssociationRef createContent = createContent(
      node1,
      name,
      "0",
    ...
    ChildAssociationRef createContent1 = createContent(
      node1,
      name1,
      "01",
      MimetypeMap.MIMETYPE_TEXT_PLAIN,
    ...
    querySolution.add(
      smartStore.materializeIfPossible(createContent1.getChildRef())
    );
    querySolution.add(
      smartStore.materializeIfPossible(createContent.getChildRef())
    );
    ...
    try {
      PagingResults<FileInfo> results = fileAndFolderService.list(
        node1,
        true,
        false,
        namePattern,
  ...
  public void testLastDuplicate() throws Exception {
    ...
    NodeRef aNameNodeRef = nodeService.getChildByName(
      node1,
      ContentModel.ASSOC_CHILDREN,
      name
    );
    ...
    NodeRef nameAfterNodeRef = nodeService.getChildByName(
      node1,
      ContentModel.ASSOC_CHILDREN,
      nameAfter
    );

    String namePattern = addWildCardInName(
      name,
    ...
    prepareMocks(
      "=cm:name:AName",
      smartStore.materializeIfPossible(aNameNodeRef)
    );
    try {
      PagingResults<FileInfo> results = fileAndFolderService.list(
  ...
  private String addWildCardInName(String name, String mimetype) {
    MimetypeService mimetypeService = ctx.getBean(
      "mimetypeService",
      MimetypeService.class
    );
    String extension = mimetypeService.getExtension(mimetype);
    return name
      .substring(0, name.length() - (extension.length() + 1))
      .concat("*." + extension);
  }
