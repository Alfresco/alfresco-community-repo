...
public class BlogPostsPost extends AbstractBlogWebScript {
    ...
    protected Map<String, Object> executeImpl(
        ...
        Map<String, Object> blogPostData =
                BlogPostLibJs.getBlogPostData(post.getNodeRef(), services);
    ...
    private BlogPostInfo createBlogPost(JsonParams jsonParams, SiteInfo site, NodeRef blogNode) {
        ...
        if (site != null) {
            ...
            newPostNode =
                    blogService.createBlogPost(blogNode, titleParam, contentParam, isDraftParam);
        }
