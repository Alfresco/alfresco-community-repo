...
public abstract class SystemNodeUtils {
    ...
    public static NodeRef getSystemContainer(
     ...
     * if found
     */
    public static NodeRef getSystemChildContainer(
            final QName childName,
            final NodeService nodeService,
            final Repository repositoryHelper) {
        List<ChildAssociationRef> containerRefs =
                getChildAssociationRefs(childName, nodeService, repositoryHelper);
     ...
     *
     * <p>Returns the list with all the NodeRef of a given Child Container within the current
     * Tenant's System Container, if found
     */
    public static List<NodeRef> getSystemChildContainers(
            final QName childName,
            final NodeService nodeService,
            final Repository repositoryHelper) {
    ...
    private static List<ChildAssociationRef> getChildAssociationRefs(
            final QName childName,
            final NodeService nodeService,
            final Repository repositoryHelper) {
    ...
    /**
     * Returns the NodeRef of a given Child Container within the current Tenant's System Container,
     * creating the Container as System if required. The calling code should handle retries, locking
     * etc.
     *
