...
public class NodePropertyHelperTest extends TestCase {
  ...
  public void setUp() {
    ...
    ContentDataDAO contentDataDAO = (ContentDataDAO) ctx.getBean(
      "contentDataDAO"
    );
   ...
   */
  private void marshallAndUnmarshall(
    final Map<QName, Serializable> in,
    final boolean exact
  ) throws Throwable {
    RetryingTransactionCallback<Void> txnCallback = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
        ...
        Map<NodePropertyKey, NodePropertyValue> rawProps1 = helper.convertToPersistentProperties(
          in
        );
        Map<QName, Serializable> props1 = helper.convertToPublicProperties(
          rawProps1
        );
        ...
        Map<NodePropertyKey, NodePropertyValue> rawProps2 = helper.convertToPersistentProperties(
          in
        );
        ...
        Map<QName, Serializable> props2 = helper.convertToPublicProperties(
          rawProps2
        );
  ...
  public void testSimpleKnownValues() throws Throwable {
    ...
    in.put(
      ...
      new NodeRef("protocol://identifier/six")
    );
  ...
  public void testSimpleMultiValue() throws Throwable {
    ...
    in.put(
      ...
      (Serializable) Arrays.<String>asList()
    );
    marshallAndUnmarshall(in, true);

    in.put(
      ContentModel.PROP_ADDRESSEES,
      (Serializable) Arrays.<String>asList("A")
    );
    marshallAndUnmarshall(in, true);

    in.put(
      ContentModel.PROP_ADDRESSEES,
      (Serializable) Arrays.<String>asList("A", "B")
    );
    marshallAndUnmarshall(in, true);
  }
  ...
  public void testResidualMultiValue() throws Throwable {
    ...
    in.put(
      QN_ANY,
      (Serializable) Arrays.<Serializable>asList(arrayListVal, hashSetVal)
    );
    marshallAndUnmarshall(in, true);
  }
}
