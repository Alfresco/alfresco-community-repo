...
public class RecordMetadataBootstrap {
   ...
   */
  public void setRecordMetadataAspects(
    Map<String, String> recordMetadataAspects
  ) {
  ...
  public void init() {
    ...
    if (recordMetadataAspects != null) {
      for (Map.Entry<String, String> entry : recordMetadataAspects.entrySet()) {
        // convert to qname's
        QName recordMetadataAspect = QName.createQName(
          entry.getKey(),
          namespaceService
        );
        QName filePlanType = QName.createQName(
          entry.getValue(),
          namespaceService
        );
