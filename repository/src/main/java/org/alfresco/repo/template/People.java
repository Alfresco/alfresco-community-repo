...
public class People extends BaseTemplateProcessorExtension implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        Map<String, ValueDeriver<TemplateNode, Boolean>> capabilityTesters =
                new HashMap<String, ValueDeriver<TemplateNode, Boolean>>(5);
        capabilityTesters.put(
                "isAdmin",
                new ValueDeriver<TemplateNode, Boolean>() {
        ...
        this.valueDerivingMapFactory =
                new ValueDerivingMapFactory<TemplateNode, String, Boolean>(capabilityTesters);
    }
    ...
    public boolean isAccountEnabled(TemplateNode person) {
        ...
        if (this.authorityService.isAdminAuthority(
            ...
            return this.authenticationService.getAuthenticationEnabled(
                    (String) person.getProperties().get(ContentModel.PROP_USERNAME));
        }
        return true;
    }
     ...
     */
    private List<TemplateNode> getContainedAuthorities(
            TemplateNode container, AuthorityType type, boolean recurse) {
