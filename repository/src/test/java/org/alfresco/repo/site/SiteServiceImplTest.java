...
public class SiteServiceImplTest extends BaseAlfrescoSpringTest {
        ...
        RetryingTransactionCallback<Object> work =
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        transactionService =
                                (TransactionService)
                                        applicationContext.getBean("transactionComponent");

                        // Authenticate as the system user
                        authenticationComponent =
                                (AuthenticationComponent)
                                        applicationContext.getBean("authenticationComponent");
                        ...
                        nodeArchiveService =
                                (NodeArchiveService)
                                        applicationContext.getBean("nodeArchiveService");
                        permissionService =
                        ...
                        siteService =
                                (SiteService) applicationContext.getBean("SiteService"); // Big 'S'
                        siteServiceImpl =
                                (SiteServiceImpl)
                                        applicationContext.getBean("siteService"); // Small 's'
                        sysAdminParams =
                                (SysAdminParams) applicationContext.getBean("sysAdminParams");
                        userNameMatcherImpl =
                                (UserNameMatcherImpl) applicationContext.getBean("userNameMatcher");
                        ...
                        if (IS_FIRST_SETUP) {
                            ...
                            authorityService.addAuthority(
                                    "GROUP_SITE_ADMINISTRATORS", USER_SITE_ADMIN);
    ...
    /**
     * This test method ensures that public sites can be created and that their site info is
     * correct. It also tests that a duplicate site cannot be created.
     */
    @Test
    public void testCreateSite() throws Exception {
        ...
        siteInfo =
                this.siteService.createSite(
                        TEST_SITE_PRESET, name, TEST_TITLE, TEST_DESCRIPTION, true);
        checkSiteInfo(
                siteInfo,
                TEST_SITE_PRESET,
                name,
        ...
        try {
            ...
            nodeService.setProperty(
                    siteNodeRef, ContentModel.PROP_DESCRIPTION, "Localized-description");
        ...
        RetryingTransactionCallback<Object> work =
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        // ensure USER_TWO has correct visibility - can "get" public site but not a
                        // private one, can "has" exist check both
                        authenticationComponent.setCurrentUser(USER_TWO);
                        assertTrue(siteService.getSite(publicsite1) != null);
                        assertTrue(
                                siteService.getSite(privatesite1)
                                        == null); // should not be visible to get()
                        assertTrue(siteService.hasSite(publicsite1));
                        assertTrue(
                                siteService.hasSite(
                                        privatesite1)); // should be visible to has() exist check
    ...
    /**
     * This method tests https://issues.alfresco.com/jira/browse/ALF-3785 which allows 'public'
     * sites to be only visible to members of a configured group, by default EVERYONE. <br>
     * <br>
    ...
    public void testConfigurableSitePublicGroup() throws Exception {
        ...
        ChildApplicationContextFactory sysAdminSubsystem =
                (ChildApplicationContextFactory) applicationContext.getBean("sysAdmin");
        ...
        try {
            ...
            assertEquals(
                    sitePublicGroupPropName + " was not the pristine value",
            ...
            // Now create a site as before. It should fail as we're using a group that doesn't
            // exist.
            ...
            assertTrue(
                    "The configured site should not have "
                            + originalSitePublicGroup
                            + " as SiteContributor",
                    !containsConsumerPermission(originalSitePublicGroup, configuredSite));
            assertTrue(
                    "The configured site should have (newGroupName) as SiteContributor",
    ...
    private boolean containsConsumerPermission(final String groupName, SiteInfo unconfiguredSite) {
        ...
        Set<AccessPermission> perms =
                permissionService.getAllSetPermissions(unconfiguredSite.getNodeRef());
    ...
    /**
     * This method tests that admin and system users can set site membership for a site of which
     * they are not SiteManagers.
     */
    @Test
                ...
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        siteService.setMembership(
                                siteInfo.getShortName(), USER_TWO, SiteModel.SITE_MANAGER);

                        authenticationComponent.setCurrentUser(USER_TWO);
                        siteService.setMembership(
                                siteInfo.getShortName(), USER_THREE, SiteModel.SITE_CONTRIBUTOR);
                        ...
                        try {
                            siteService.setMembership(
                                    siteInfo.getShortName(), USER_TWO, SiteModel.SITE_CONTRIBUTOR);
     ...
     *
     * <p>Note that {@link SiteService#findSites(String, int)} offers eventually consistent results
     * and therefore may exhibit changed behaviour if Lucene is switched off or is replaced by SOLR.
     * {@link SiteService#listSites(List, List, org.alfresco.query.PagingRequest)} and the other
     * listSites methods should offer consistent, accurate result sets.
     */
    @Category(RedundantTests.class)
    @Test
    public void testListSites() throws Exception {
        // We'll match against the first few letter of TEST_TITLE in various listSites() tests
        // below.
        ...
        // Create some sites
        this.siteService.createSite(
                TEST_SITE_PRESET, "mySiteOne", TEST_TITLE, TEST_DESCRIPTION, SiteVisibility.PUBLIC);
        this.siteService.createSite(
                TEST_SITE_PRESET,
                "mySiteTwo",
                TEST_TITLE,
        ...
        assertEquals(
                "SiteService.findSites did not limit results",
                (sites.isEmpty() ? 0 : 1),
                siteFromFind.size());
        ...
        filterProps.add(
                new FilterPropString(
                        ...
                        "mySiteO",
                        FilterPropString.FilterTypeString.STARTSWITH_IGNORECASE));
        PagingResults<SiteInfo> pageSite =
                this.siteService.listSites(filterProps, null, new PagingRequest(100));
        ...
        assertNotNull(sites);
        assertEquals(
                "Matched wrong number of sites starting with '" + testTitlePrefix + "'",
                5,
                sites.size());
        sitesFromFind = this.siteService.findSites("title", null, 100);
        assertEquals(
                "Matched wrong number of sites containing 'title'\n" + sitesFromFind,
                5,
                sitesFromFind.size());
        ...
        /**
         * As User Two Search for partial match on more titles - matches word "Site" - should not
         * find private sites
         */
        sitesFromFind = this.siteService.findSites("ite", null, 100);
        ...
        authenticationComponent.setCurrentUser(USER_THREE);
        /**
         * As User Three Search for partial match on more titles - matches word "Site" - should not
         * find private and moderated sites
         */
        sitesFromFind = this.siteService.findSites("ite", null, 100);
                    ...
                    public Object execute() throws Throwable {
                        ...
                        try {
                            ...
                            for (String role : roleList) {
                                ...
                                List<String> list =
                                        siteServiceImpl.getMembersRoles(siteName, USER_ONE);
    ...
    public void testListSitesCaseSensitivity() throws Exception {
        ...
        try {
            ...
            assertTrue(
                    "Case Sensitive - non matching case",
                    (siteService.listSites(USER_ONE.toLowerCase())).size() == 0); // odd one out
            assertTrue(
                    "Case Sensitive - matching case", (siteService.listSites(USER_ONE)).size() > 0);

            userNameMatcherImpl.setUserNamesAreCaseSensitive(false);
            assertTrue(
                    "Not Case Sensitive - non matching case",
                    (siteService.listSites(USER_ONE.toLowerCase())).size() > 0);
            assertTrue(
                    "Not Case Sensitive - matching case",
                    (siteService.listSites(USER_ONE)).size() > 0);
    ...
    public void testfindSitesWithWildcardTitles() throws Exception {
        ...
        this.siteService.createSite(
                TEST_SITE_PRESET, "siteAlpha", "asterix", TEST_DESCRIPTION, SiteVisibility.PUBLIC);
        this.siteService.createSite(
                TEST_SITE_PRESET,
                "siteBeta",
                "asterix*obelix",
        ...
        assertNotNull(sites);
        // As the name & description do not contain "asterix", this will become a search for sites
        // whose titles match "asterix"
        assertEquals(
                "Matched wrong number of sites with title equal to 'asterix'", 2, sites.size());

        // This means 'find all'
        sites = this.siteService.findSites("*", null, 0);
        assertNotNull(sites);
        assertEquals(
                "Matched wrong number of sites using '*'", preexistingSitesCount + 2, sites.size());
    ...
    public void testfindSitesForLiveSearchWithWildcardTitles() throws Exception {
        ...
        // Note that the shortName can't contain an asterisk but the title can.
        this.siteService.createSite(
                TEST_SITE_PRESET, "siteLiveA", "getafix", TEST_DESCRIPTION, SiteVisibility.PUBLIC);
        this.siteService.createSite(
                TEST_SITE_PRESET,
                "siteLiveB",
                "getafix1vitalstatistix",
                TEST_DESCRIPTION,
                SiteVisibility.PUBLIC);
        this.siteService.createSite(
                TEST_SITE_PRESET,
                "siteLiveC",
                "Armorican Gaul France",
                TEST_DESCRIPTION,
                SiteVisibility.PUBLIC);
        ...
        this.siteService.createSite(
                TEST_SITE_PRESET,
                "siteLiveD",
                "n3w s1t3 creat3ed 88",
                TEST_DESCRIPTION,
                SiteVisibility.PUBLIC);
        this.siteService.createSite(
                TEST_SITE_PRESET,
                "siteLiveE",
                "n3w s1t3 creat3ed 99",
                TEST_DESCRIPTION,
                SiteVisibility.PUBLIC);
        ...
        // whose titles match "asterix"
        assertEquals(
                "Matched wrong number of sites with title equal to 'getafix'", 2, sites.size());

        // This means 'find all'
        sites = this.siteService.findSites("*", 0);
        assertNotNull(sites);
        assertEquals(
                "Matched wrong number of sites using '*'",
                preexistingSitesCount + 11,
                sites.size());
    ...
    public void testGetSite() {
        ...
        PagingResults<FileInfo> containers =
                siteService.listContainers(siteInfo.getShortName(), new PagingRequest(1000));
    ...
    public void testMoveSite_ViaNodeService() {
        ...
        try {
            nodeService.moveNode(
                    siteInfo1.getNodeRef(),
                    siteInfo2.getNodeRef(),
                    ContentModel.ASSOC_CONTAINS,
    ...
    public void testMoveFolderStructureWithNonInheritedPermission() {
        ...
        NodeRef documentLibraryTest1Site =
                siteService.getContainer(test1SiteShortName, SiteService.DOCUMENT_LIBRARY);
        assertNotNull(documentLibraryTest1Site);
        NodeRef fol1 =
                this.fileFolderService
                        .create(
                                documentLibraryTest1Site,
                                "fol1-" + GUID.generate(),
                                ContentModel.TYPE_FOLDER)
                        .getNodeRef();
        NodeRef fol2 =
                this.fileFolderService
                        .create(fol1, "fol2-" + GUID.generate(), ContentModel.TYPE_FOLDER)
                        .getNodeRef();
        NodeRef fol3 =
                this.fileFolderService
                        .create(fol2, "fol3-" + GUID.generate(), ContentModel.TYPE_FOLDER)
                        .getNodeRef();
        ...
        permissionService.setPermission(
                fol2, test1SiteManagerAuthority, SiteModel.SITE_MANAGER, true);
        ...
        List<ChildAssociationRef> childAssocs =
                nodeService.getChildAssocs(documentLibraryTest1Site);
        assertEquals("Size should be 1", 1, childAssocs.size());
        assertTrue(
                "Folder name should start with fol1", getFirstName(childAssocs).startsWith("fol1"));
        childAssocs = nodeService.getChildAssocs(childAssocs.get(0).getChildRef());
        assertEquals("Size should be 1", 1, childAssocs.size());
        assertTrue(
                "Folder name should start with fol2", getFirstName(childAssocs).startsWith("fol2"));
        childAssocs = nodeService.getChildAssocs(childAssocs.get(0).getChildRef());
        assertEquals("Size should be 1", 1, childAssocs.size());
        assertTrue(
                "Folder name should start with fol3", getFirstName(childAssocs).startsWith("fol3"));

        NodeRef documentLibraryTest2Site =
                siteService.getContainer(test2SiteShortName, SiteService.DOCUMENT_LIBRARY);
        ...
        assertFalse(
                "After the move the folder should keep the inherit permission value(false).",
    ...
    private String getFirstName(List<ChildAssociationRef> childAssocs) {
        return nodeService
                .getProperties(childAssocs.get(0).getChildRef())
    ...
    public void testDeleteSite() {
                ...
                AuthenticationUtil.runAs(
                        new AuthenticationUtil.RunAsWork<String>() {
                            public String doWork() throws Exception {
                                return authorityService.createAuthority(
                                        AuthorityType.GROUP, testGroupName);
                            }
                        },
                        AuthenticationUtil.getAdminUserName());
        ...
        assertTrue(
                "Deleted sites can be recovered from the Trash.",
                nodeService.exists(archivedNodeRef));

        // related site groups should remain after site delete but should be deleted on site purge
        // from trashcan.
        // Such case is tested in
        // SiteServiceImplMoreTest.deleteSiteAndRestoreEnsuringSiteGroupsAreRecovered
        assertTrue(
                authorityService.authorityExists(
                        ((SiteServiceImpl) smallSiteService).getSiteGroup(siteShortName, true)));
        assertTrue(
                authorityService.authorityExists(
                        ((SiteServiceImpl) smallSiteService).getSiteGroup(siteShortName)));
        Set<String> permissions = permissionService.getSettablePermissions(SiteModel.TYPE_SITE);
        for (String permission : permissions) {
            String siteRoleGroup =
                    ((SiteServiceImpl) smallSiteService)
                            .getSiteRoleGroup(siteShortName, permission, true);
        ...
        RetryingTransactionCallback<Object> work =
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        // TestWithUserUtils.authenticateUser(USER_ONE, "PWD",
                        // this.authenticationService, this.authenticationComponent);
                        authenticationComponent.setCurrentUser(USER_ONE);
                ...
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        Map<String, String> members =
                                siteService.listMembers(siteShortName, null, null, 0);
                        ...
                        siteService.setMembership(
                                siteShortName, USER_THREE, SiteModel.SITE_COLLABORATOR);
                        ...
                        members =
                                siteService.listMembers(
                                        siteShortName, null, SiteModel.SITE_MANAGER, 0);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(USER_ONE));
                        assertEquals(SiteModel.SITE_MANAGER, members.get(USER_ONE));
                        ...
                        siteService.setMembership(
                                siteShortName, USER_TWO, SiteModel.SITE_COLLABORATOR);
                        ...
                        siteService.listMembers(
                                ...
                                null,
                                false,
                                new SiteService.SiteMembersCallback() {
                                    List<String> USERS =
                                            Arrays.asList(USER_ONE, USER_TWO, USER_THREE);
                                    int userCount = 0;
                        ...
                        try {
                            siteService.setMembership(
                                    siteShortName, USER_TWO, SiteModel.SITE_COLLABORATOR);
                            fail(
                                    "A member who isn't a manager shouldnt be able to set"
                                            + " memberships");
                        } catch (AlfrescoRuntimeException e) {
                            // As expected
                        }
                        ...
                        try {
                            siteService.setMembership(
                                    siteShortName, USER_ONE, SiteModel.SITE_COLLABORATOR);
                ...
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        siteService.createSite(
                                ...
                                SiteVisibility.MODERATED);
                        siteService.setMembership(
                                moderatedSite, USER_ONE, SiteModel.SITE_CONTRIBUTOR);

                        authenticationComponent.setCurrentUser(USER_ONE);
                        PagingResults<SiteMembership> siteM =
                                siteService.listSitesPaged(USER_ONE, null, new PagingRequest(1000));
                        assertNotNull(siteM);
                        ...
                        authenticationComponent.setCurrentUser(USER_TWO);
                        // (MNT-19035) USER_TWO list sites membership for USER_ONE - only sites that
                        // are public should be visible
                        members = siteService.listSiteMemberships(USER_ONE, 0);
                        assertNotNull(members);
                        // Even though USER_ONE is part of 3 private sites, 1 moderated and 1 public
                        // site, only the non-private sites are visible to USER_TWO
        ...
        RetryingTransactionCallback<Object> work =
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        siteService.createSite(
                                TEST_SITE_PRESET,
                                testMembershipPublic,
                                TEST_TITLE,
                                TEST_DESCRIPTION,
                                SiteVisibility.PUBLIC);
                        siteService.createSite(
                                TEST_SITE_PRESET,
                                testMembershipPrivate,
                                TEST_TITLE,
                                TEST_DESCRIPTION,
                                SiteVisibility.PRIVATE);

                        // Become user two
                        // TestWithUserUtils.authenticateUser(USER_TWO, "PWD",
                        // this.authenticationService, this.authenticationComponent);
                        authenticationComponent.setCurrentUser(USER_TWO);
                        ...
                        try {
                            siteService.setMembership(
                                    testMembershipPublic, USER_TWO, SiteModel.SITE_COLLABORATOR);
                        ...
                        siteService.setMembership(
                                testMembershipPublic, USER_TWO, SiteModel.SITE_CONSUMER);

                        // As user two try and add self as consumer to private site
                        try {
                            siteService.setMembership(
                                    testMembershipPrivate, USER_TWO, SiteModel.SITE_CONSUMER);
                            fail(
                                    "This should have failed because you can't do this to a private"
                                            + " site unless you are site manager");
                        } catch (AlfrescoRuntimeException exception) {
                            // Ignore because as expected
                        }
                        ...
                        try {
                            siteService.setMembership(
                                    testMembershipPublic, USER_THREE, SiteModel.SITE_CONSUMER);
                            fail(
                                    "This should have failed because you can't add another user as"
                                            + " a consumer of a public site");
                        } catch (AlfrescoRuntimeException exception) {
                            // Ignore because as expected
                        }
                        ...
                        authenticationComponent.setCurrentUser(USER_ONE);
                        siteService.setMembership(
                                testMembershipPublic, USER_THREE, SiteModel.SITE_COLLABORATOR);
                        siteService.setMembership(
                                testMembershipPrivate, USER_TWO, SiteModel.SITE_CONSUMER);
                        authenticationComponent.setCurrentUser(USER_TWO);
    ...
    public void testContainer() {
        ...
        boolean hasContainer =
                this.siteService.hasContainer(siteInfo.getShortName(), "folder.component");
        assertFalse(hasContainer);
        NodeRef container1 =
                this.siteService.getContainer(siteInfo.getShortName(), "folder.component");
        assertNull(container1);
        container1 =
                this.siteService.createContainer(
                        siteInfo.getShortName(), "folder.component", null, null);
        ...
        boolean hasContainer3 =
                this.siteService.hasContainer(siteInfo.getShortName(), "folder.component2");
        assertFalse(hasContainer3);

        NodeRef container3 =
                this.siteService.getContainer(siteInfo.getShortName(), "folder.component2");
        assertNull(container3);
        container3 =
                this.siteService.createContainer(
                        siteInfo.getShortName(), "folder.component2", null, null);
        assertNotNull(container3);
        assertTrue(this.taggingService.isTagScope(container3));
        assertFalse(container1.equals(container3));

        boolean hasContainer4 =
                this.siteService.hasContainer(siteInfo.getShortName(), "folder.component2");
        assertTrue(hasContainer4);
        boolean hasContainer5 =
                this.siteService.hasContainer(siteInfo.getShortName(), "folder.component3");
        assertFalse(hasContainer5);
        NodeRef container5 =
                this.siteService.getContainer(siteInfo.getShortName(), "folder.component3");
        ...
        container6 =
                this.siteService.createContainer(
                        siteInfo.getShortName(), "folder.component3", null, null);
        assertNotNull(container6);
        ...
        container7 =
                this.siteService.createContainer(
                        siteInfo.getShortName(), "folder.component3", ForumModel.TYPE_FORUM, null);
        assertNotNull(container7);
        assertTrue(container5.equals(container7));
        assertEquals(ContentModel.TYPE_FOLDER, nodeService.getType(container7));
        NodeRef container8 =
                this.siteService.getContainer(siteInfo.getShortName(), "folder.component4");
        assertNull(container8);
        container8 =
                this.siteService.createContainer(
                        siteInfo.getShortName(), "folder.component4", ForumModel.TYPE_FORUM, null);
    ...
    public void testSiteGetRoles() {
        ...
        // By default there are just the 4 roles, but in
        // classpath:org/alfresco/repo/site/site-custom-context.xml there are 7
    ...
    public void testCustomSiteProperties() {
        QName additionalInformationQName =
        ...
        this.nodeService.addAspect(
                siteNodeRef,
                QName.createQName(SiteModel.SITE_MODEL_URL, "customSiteProperties"),
                properties);
    ...
    public void testCustomSiteType() {
        ...
        customType.setParentName(
                SiteModel.SITE_MODEL_PREFIX + ":" + SiteModel.TYPE_SITE.getLocalName());
        ...
        SiteInfo site =
                siteService.createSite(
                        "custom", "custom", "Custom", "Custom", SiteVisibility.PUBLIC);
        ...
        PermissionService testPermissionService =
                spy((PermissionService) this.applicationContext.getBean("permissionServiceImpl"));
        ...
        SiteServiceImpl siteServiceImpl =
                (SiteServiceImpl) this.applicationContext.getBean("siteService");
        ...
        RetryingTransactionCallback<Object> work =
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        ...
                        // Get the members of the site and check that user one is a manager
                        Map<String, String> members =
                                siteService.listMembers(testGroupMembership, null, null, 0);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(USER_ONE));
                        assertEquals(SiteModel.SITE_MANAGER, members.get(USER_ONE));
                        ...
                        siteService.setMembership(
                                testGroupMembership, groupTwo, SiteModel.SITE_CONSUMER);
                        ...
                        assertEquals(
                                ...
                                siteService.getMembersRole(testGroupMembership, USER_ONE));
                        assertEquals(
                                SiteModel.SITE_CONSUMER,
                                siteService.getMembersRole(testGroupMembership, USER_TWO));
                        assertEquals(
                                SiteModel.SITE_CONSUMER,
                                siteService.getMembersRole(testGroupMembership, USER_THREE));
                        assertEquals(
                                SiteModel.SITE_CONSUMER,
                                siteService.getMembersRole(testGroupMembership, groupTwo));

                        // Uses Members role info
                        assertEquals(
                                SiteModel.SITE_MANAGER,
                                siteService
                                        .getMembersRoleInfo(testGroupMembership, USER_ONE)
                                        .getMemberRole());
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, null, SiteModel.SITE_MANAGER, 0, true);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(USER_ONE));
                        assertEquals(SiteModel.SITE_MANAGER, members.get(USER_ONE));
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, "UserOne*", null, 0, true);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(USER_ONE));
                        assertEquals(SiteModel.SITE_MANAGER, members.get(USER_ONE));
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, "UserTwo*", null, 0, true);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(USER_TWO));
                        assertEquals(SiteModel.SITE_CONSUMER, members.get(USER_TWO));
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, "UserTwo*", null, 0, false);
                        assertNotNull(members);
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, GROUP_TWO, null, 0, false);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(groupTwo));
                        assertEquals(SiteModel.SITE_CONSUMER, members.get(groupTwo));
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, GROUP_TWO_DISPLAY, null, 0, false);
                        assertNotNull(members);
                        assertEquals(1, members.size());
                        assertTrue(members.containsKey(groupTwo));
                        assertEquals(SiteModel.SITE_CONSUMER, members.get(groupTwo));
                        ...
                        members =
                                siteService.listMembers(
                                        testGroupMembership, GROUP_TWO, null, 0, true);
                        assertNotNull(members);
                        assertEquals(0, members.size());

                        /** Add a group member (USER_THREE) as an explicit member */
                        siteService.setMembership(
                                testGroupMembership, USER_THREE, SiteModel.SITE_COLLABORATOR);
                        ...
                        siteService.setMembership(
                                testGroupMembership, USER_THREE, SiteModel.SITE_CONTRIBUTOR);

                        /**
                         * Add other group (GROUP_3) with higher (MANAGER) role
                         *
                         * <p>- is group in list? - is new user a member? - does redefined user have
                         * highest role? USER_TWO should be Manager from group 3 having higher
                         * priority than group 2 USER_THREE should still be Contributor from
                         * explicit membership. USER_FOUR should be Manager - from group 4 sub-group
                         */
                        siteService.setMembership(
                                testGroupMembership, groupThree, SiteModel.SITE_MANAGER);
                        ...
                        assertEquals(
                                SiteModel.SITE_MANAGER,
                                siteService.getMembersRole(testGroupMembership, groupThree));

                        // From sub group four
                        assertEquals(
                                SiteModel.SITE_MANAGER,
                                siteService.getMembersRole(testGroupMembership, USER_FOUR));
    ...
    public void testUserRoleInGroups() {
        ...
        // Create a site as user one
        this.siteService.createSite(
                TEST_SITE_PRESET, sitName, TEST_TITLE, TEST_DESCRIPTION, SiteVisibility.PUBLIC);
        ...
        List<SiteMemberInfo> roles =
                this.siteService.listMembersInfo(sitName, USER_TWO, null, 0, true);
     ...
     *
     * <p>See https://issues.alfresco.com/jira/browse/JAWS-291
     */
    @Test
        ...
        RetryingTransactionCallback<Object> work =
                new RetryingTransactionCallback<Object>() {
                    ...
                    public Object execute() throws Throwable {
                        // Create a public site
                        SiteInfo siteInfo =
                                createTestSiteWithContent(
                                        "testSiteVisibilityPublicSite",
                                        "testComp",
                                        SiteVisibility.PUBLIC);
                        ...
                        assertEquals(
                                ...
                                nodeService.getProperty(
                                        siteInfo.getNodeRef(), SiteModel.PROP_SITE_VISIBILITY));
                        ...
                        testVisibilityPermissions(
                                "Testing visibility of public site",
                                USER_TWO,
                                siteInfo,
                                true,
                                true);
                        ...
                        siteInfo =
                                createTestSiteWithContent(
                                        "testSiteVisibilityModeratedSite",
                                        "testComp",
                                        SiteVisibility.MODERATED);
                        // - is the value on the site nodeRef correct?
                        assertEquals(
                                SiteVisibility.MODERATED.toString(),
                                nodeService.getProperty(
                                        siteInfo.getNodeRef(), SiteModel.PROP_SITE_VISIBILITY));
                        // - is the site info correct?
                        checkSiteInfo(
                        ...
                        // - are the permissions correct for non-members?
                        testVisibilityPermissions(
                                "Testing visibility of moderated site",
                                USER_TWO,
                                siteInfo,
                                true,
                                false);
                        ...
                        // - are the permissions correct for non-members?
                        testVisibilityPermissions(
                                "Testing visibility of private site",
                                USER_TWO,
                                siteInfo,
                                false,
                                false);
    ...
    /**
     * ALF-10343 - When the default public group for sites isn't EVERYBODY, check that creating and
     * altering sites results in the correct permissions
     */
    @Test
    public void testNonDefaultPublicGroupPermissions() throws Exception {
        ...
        SiteInfo s1 =
                this.siteService.createSite(
                        TEST_SITE_PRESET, "SiteTest_priv", "priv", "priv", SiteVisibility.PRIVATE);
        SiteInfo s2 =
                this.siteService.createSite(
                        TEST_SITE_PRESET, "SiteTest_mod", "mod", "mod", SiteVisibility.MODERATED);
        SiteInfo s3 =
                this.siteService.createSite(
                        TEST_SITE_PRESET, "SiteTest_pub", "pub", "pub", SiteVisibility.PUBLIC);

        // Check the permissions on them
        // Everyone has read permissions only, not Consumer
        assertTrue(
                getAllowedPermissionsMap(s1)
                        .get(PermissionService.ALL_AUTHORITIES)
                        .contains("ReadPermissions"));
        assertTrue(
                getAllowedPermissionsMap(s2)
                        .get(PermissionService.ALL_AUTHORITIES)
                        .contains("ReadPermissions"));
        assertTrue(
                getAllowedPermissionsMap(s3)
                        .get(PermissionService.ALL_AUTHORITIES)
                        .contains("ReadPermissions"));
        ...
        assertEquals(
                SiteModel.SITE_MANAGER, siteService.getMembersRole(s1.getShortName(), USER_ONE));
        assertEquals(
                SiteModel.SITE_MANAGER, siteService.getMembersRole(s2.getShortName(), USER_ONE));
        assertEquals(
                SiteModel.SITE_MANAGER, siteService.getMembersRole(s3.getShortName(), USER_ONE));
    ...
    private SiteInfo createTestSiteWithContent(
            String siteShortName, String componentId, SiteVisibility visibility) {
    ...
    private SiteInfo createTestSiteWithContent(
        ...
        SiteInfo siteInfo =
                this.siteService.createSite(
                        TEST_SITE_PRESET, siteShortName, TEST_TITLE, TEST_DESCRIPTION, visibility);

        NodeRef siteContainer =
                this.siteService.createContainer(
                        siteShortName, componentId, ContentModel.TYPE_FOLDER, null);
        FileInfo fileInfo =
                this.fileFolderService.create(
                        siteContainer, fileFolderPrefix + "file.txt", ContentModel.TYPE_CONTENT);
        ...
        FileInfo folder1Info =
                this.fileFolderService.create(
                        siteContainer, fileFolderPrefix + "folder", ContentModel.TYPE_FOLDER);
    ...
    private void testVisibilityPermissions(
            String message,
            String userName,
            SiteInfo siteInfo,
            boolean listSite,
        ...
        try {
            ...
            if (listSite == true && siteInList == false) {
                fail(
                        message
                                + ":  The site '"
                                + siteInfo.getShortName()
                                + "' was expected in the list of sites for user '"
                                + userName
                                + "'");
                ...
                fail(
                        message
                                + ":  The site '"
                                + siteInfo.getShortName()
                                + "' was NOT expected in the list of sites for user '"
                                + userName
                                + "'");
            }
            ...
            if (siteInList == true) {
                try {
                    ...
                    NodeRef folder =
                            this.siteService.getContainer(siteInfo.getShortName(), "testComp");
                    ...
                    if (readSite == false) {
                        fail(
                                message
                                        + ":  Content of the site '"
                                        + siteInfo.getShortName()
                                        + "' was NOT expected to be read by user '"
                                        + userName
                                        + "'");
                    }
                } catch (Exception exception) {
                    if (readSite == true) {
                        fail(
                                message
                                        + ":  Content of the site '"
                                        + siteInfo.getShortName()
                                        + "' was expected to be read by user '"
                                        + userName
                                        + "'");
                    }
                }
     ...
     *
     * <p>Lower User membership - should be O.K. because of Group Membership Lower Group membership
     * - should be prevented (last manager)
     *
     * <p>Reset User membership to Manager
     *
     * <p>Lower Group membership - should be O.K. because of User Membership Lower User membership -
     * should be prevented (last manager)
     */
    @Test
     ...
     * Create a site with a USER manager. Add Group manager membership.
     *
     * <p>Remove User membership - should be O.K. because of Group Membership Remove Group
     * membership - should be prevented (last manager)
     *
     * <p>Add User membership to Manager
     *
     * <p>Remove Group membership - should be O.K. because of User Membership Remove User membership
     * - should be prevented (last manager)
     */
    @Test
     ...
     * Create a private site.
     *
     * <p>Attempt to access a private site by someone that is not a consumer of that site.
     */
    @Test
    ...
    /**
     * ALF-3200 You shouldn't be able to rename a Site using the normal node service type
     * operations, because the relationship between a site and its authorities is based on a pattern
     * that uses the site name. However, you are free to change a site's display name.
     */
    @Test
    ...
    private void alf8036Impl(boolean copyNotMove) {
        ...
        SiteInfo fromSite =
                this.createTestSiteWithContent("fromSite", "doclib", SiteVisibility.PUBLIC, "FROM");
        SiteInfo toSite =
                this.createTestSiteWithContent("toSite", "doclib", SiteVisibility.PUBLIC, "TO");

        // Find the folder to be copied/moved.
        NodeRef fromDoclibContainer =
                nodeService.getChildByName(
                        fromSite.getNodeRef(), ContentModel.ASSOC_CONTAINS, "doclib");
        assertNotNull(fromDoclibContainer);
        NodeRef fromFolder =
                nodeService.getChildByName(
                        fromDoclibContainer, ContentModel.ASSOC_CONTAINS, "FROMfolder");
        assertNotNull(fromFolder);
        NodeRef fromSubFolder =
                nodeService.getChildByName(
                        fromFolder, ContentModel.ASSOC_CONTAINS, "FROMsubfolder");
        ...
        permissionService.setPermission(
                fromFolder,
                siteServiceImpl.getSiteRoleGroup(
                        fromSite.getShortName(), SiteModel.SITE_CONTRIBUTOR, true),
                SiteModel.SITE_CONSUMER,
                false);
        ...
        permissionService.setPermission(
                fromSubFolder,
                siteServiceImpl.getSiteRoleGroup(
                        fromSite.getShortName(), SiteModel.SITE_COLLABORATOR, true),
                SiteModel.SITE_CONSUMER,
                false);

        // Find the folder to copy/move it to.
        NodeRef toDoclibContainer =
                nodeService.getChildByName(
                        toSite.getNodeRef(), ContentModel.ASSOC_CONTAINS, "doclib");
        assertNotNull(toDoclibContainer);
        NodeRef toFolder =
                nodeService.getChildByName(
                        toDoclibContainer, ContentModel.ASSOC_CONTAINS, "TOfolder");
        ...
        // Ensure the permissions on the copied/moved node are those of the target site and not
        // those of the source site.
        Map<String, String> expectedPermissions = new HashMap<String, String>();
        expectedPermissions.put(
                siteService.getSiteRoleGroup(toSite.getShortName(), SiteModel.SITE_MANAGER),
                SiteModel.SITE_MANAGER);
        expectedPermissions.put(
                siteService.getSiteRoleGroup(toSite.getShortName(), SiteModel.SITE_COLLABORATOR),
                SiteModel.SITE_COLLABORATOR);
        expectedPermissions.put(
                siteService.getSiteRoleGroup(toSite.getShortName(), SiteModel.SITE_CONTRIBUTOR),
                SiteModel.SITE_CONTRIBUTOR);
        expectedPermissions.put(
                siteService.getSiteRoleGroup(toSite.getShortName(), SiteModel.SITE_CONSUMER),
                SiteModel.SITE_CONSUMER);
        ...
        NodeRef copyOfSubFolder =
                nodeService.getChildByName(
                        relocatedNode, ContentModel.ASSOC_CONTAINS, "FROMsubfolder");
    ...
    public void testALF_1017_nonSitesInSitesSpace() throws Exception {
        ...
        final NodeRef sitesSpace =
                this.nodeService.getPrimaryParent(site1.getNodeRef()).getParentRef();
    ...
    private void validatePermissionsOnRelocatedNode(
            SiteInfo fromSite,
            SiteInfo toSite,
            NodeRef relocatedNode,
            Map<String, String> expectedPermissions) {
        ...
        for (String sitePermission : SiteModel.STANDARD_PERMISSIONS) {
            String siteRoleGroup =
                    siteServiceImpl.getSiteRoleGroup(fromSite.getShortName(), sitePermission, true);
        ...
        for (String authority : expectedPermissions.keySet()) {
            ...
            assertEquals(
                    ...
                    expectedPermissions.get(authority),
                    ap.getPermission());
    ...
    public void testJSAPI() throws Exception {
        ...
        ScriptLocation location =
                new ClasspathScriptLocation("org/alfresco/repo/site/script/test_siteService.js");
    ...
    public void testListMembersInfo() {
        ...
        // Get the members of the site and check that user one is a manager
        List<SiteMemberInfo> members =
                this.siteService.listMembersInfo(siteShortName, null, null, 0, false);
        assertNotNull(members);
        assertEquals(1, members.size());
    ...
    /**
     * From CLOUD-957, insure that GROUP_EVERYONE does not have read access to private sites'
     * containers.
     */
    @Test
    public void testPrivateSite() throws Exception {
        ...
        assertNull(
                "GROUP_EVERYONE shouldn't have any permissions on a private site's containers",
                getAllowedPermissionsMap(container).get(PermissionService.ALL_AUTHORITIES));
    }

    /**
     * From CLOUD-957, insure that GROUP_EVERYONE does not have read access to moderated sites'
     * containers.
     */
    @Test
    public void testModeratedSite() throws Exception {
        ...
        assertNull(
                "GROUP_EVERYONE shouldn't have any permissions on a moderated site's containers",
                getAllowedPermissionsMap(container).get(PermissionService.ALL_AUTHORITIES));
    }
    ...
    public void testChangeSiteVisibility() {
        ...
        assertTrue(
                getAllowedPermissionsMap(container)
                        .get(PermissionService.ALL_AUTHORITIES)
                        .contains("ReadPermissions"));
    ...
    public void testDeleteSiteAsAdministrator() throws Exception {
        ...
        try {
            ...
            fail(
                    "We should not reach this point. the user that tries to run this code, add the"
                            + " file, is not yet a member of the site");
