...
public class AssocTargetRoleIntegrityEvent extends AbstractIntegrityEvent {
  ...
  public void checkIntegrity(List<IntegrityRecord> eventResults) {
    ...
    if (assocQName == null) {
      throw new IllegalArgumentException(
        "The association qualified name must be supplied"
      );
    }
    if (!assocDef.isChild()) {
  ...
  protected void checkAssocQNameRegex(
    ...
    if (assocRoleQName != null) {
      ...
      RegexQNamePattern rolePattern = new RegexQNamePattern(
        assocRoleQName.getNamespaceURI(),
        assocRoleQName.getLocalName()
      );
