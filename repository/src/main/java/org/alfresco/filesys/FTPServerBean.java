...
public class FTPServerBean extends AbstractLifecycleBean {
  ...
  public final void startServer() throws SocketException, IOException {
    try {
      ...
      m_ftpConfig =
        (FTPConfigSection) filesysConfig.getConfigSection(
      ...
      if (ftpServer != null) {
        ...
        if (logger.isInfoEnabled()) logger.info(
          "Starting server " + ftpServer.getProtocolName() + " ..."
        );
  ...
  public final void stopServer() {
    ...
    if (ftpServer != null) {
      if (logger.isInfoEnabled()) logger.info(
        "Shutting server " + ftpServer.getProtocolName() + " ..."
      );
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ctx =
        new ClassPathXmlApplicationContext("alfresco/application-context.xml");
      ...
      if (server == null) {
        throw new AlfrescoRuntimeException(
          "Server bean 'ftpServer' not defined"
        );
      }
      ...
      if (
        server.getConfiguration().hasConfigSection(FTPConfigSection.SectionName)
      ) {
