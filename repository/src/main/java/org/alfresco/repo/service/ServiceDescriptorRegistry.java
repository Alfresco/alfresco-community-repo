...
public class ServiceDescriptorRegistry
  ...
  public SynchronousTransformClient getSynchronousTransformClient() {
    return (SynchronousTransformClient) getService(
  ...
  public RetryingTransactionHelper getRetryingTransactionHelper() {
    TransactionService txnService = (TransactionService) getService(
      TRANSACTION_SERVICE
    );
  ...
  public ContentFilterLanguagesService getContentFilterLanguagesService() {
    return (ContentFilterLanguagesService) getService(
  ...
  public MultilingualContentService getMultilingualContentService() {
    return (MultilingualContentService) getService(
  ...
  public PublicServiceAccessService getPublicServiceAccessService() {
    return (PublicServiceAccessService) getService(
  ...
  public PolicyComponent getPolicyComponent() {
    return (PolicyComponent) beanFactory.getBean(
      POLICY_COMPONENT.getLocalName()
    );
  }
