...
public abstract class AbstractBlogPostsCannedQueryFactory
    ...
    protected CannedQuerySortDetails createCQSortDetails(QName sortProp, SortOrder sortOrder) {
        List<Pair<? extends Object, SortOrder>> singlePair =
     ...
     * Comparisons of two null properties are considered 'equal' by this comparator. Comparisons
     * involving one null and one non-null property will return the null property as being 'before'
     * the non-null property.
     *
     * <p>Note that it is the responsibility of the calling code to ensure that the specified
        ...
        protected Comparable getProperty(BlogEntity entity) {
            if (comparableProperty.equals(ContentModel.PROP_PUBLISHED)) {
                ...
                throw new IllegalArgumentException(
                        "Unsupported blog sort property: " + comparableProperty);
            }
        }
    }
}
