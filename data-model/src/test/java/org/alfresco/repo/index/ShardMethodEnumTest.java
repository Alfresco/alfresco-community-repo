...
public class ShardMethodEnumTest {
  ...
  public void testTypeACLLegacy() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("MOD_ACL_ID")
    );
  }
  ...
  public void testDBIDRange() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("DB_ID_RANGE")
    );
  }
  ...
  public void testTypeACLBasedOnMurmurHash() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("ACL_ID")
    );
  }
  ...
  public void testTypeDBID() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("DB_ID")
    );
  }
  ...
  public void testTypeEXPLICITID() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("EXPLICIT_ID")
    );
    Assert.assertEquals(
      ShardMethodEnum.EXPLICIT_ID,
      ShardMethodEnum.getShardMethod("EXPLICIT_ID_FALLBACK_DBID")
    );
  }
  ...
  public void testTypeLRIS() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("LRIS")
    );
    Assert.assertEquals(
      ShardMethodEnum.LAST_REGISTERED_INDEXING_SHARD,
      ShardMethodEnum.getShardMethod("LAST_REGISTERED_INDEXING_SHARD")
    );
  }
  ...
  public void testTypeEXPLICIT_ID_FALLBACK_LRIS() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("EXPLICIT_ID_FALLBACK_LRIS")
    );
  }
  ...
  public void testTypeDateTimeStamp() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("DATE")
    );
  }
  ...
  public void testTypeProperty() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("PROPERTY")
    );
  }
  ...
  public void testUnknown() {
    Assert.assertEquals(
      ...
      ShardMethodEnum.getShardMethod("UNKOWN")
    );
    Assert.assertEquals(
      ShardMethodEnum.UNKOWN,
      ShardMethodEnum.getShardMethod("Some else unknown value")
    );
  }
  ...
  public void testNull() {
    Assert.assertEquals(
      ShardMethodEnum.UNKOWN,
      ShardMethodEnum.getShardMethod(null)
    );
  }
  ...
  public void matchIsCaseInsensitive() {
    ...
    Assert.assertEquals(
      ShardMethodEnum.UNKOWN,
      ShardMethodEnum.getShardMethod("Unknown")
    );
  }
}
