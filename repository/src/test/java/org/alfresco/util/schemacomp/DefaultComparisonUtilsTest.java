...
public class DefaultComparisonUtilsTest {
  ...
  public void compareSimple() {
    ...
    verify(differences)
      .add(Where.IN_BOTH_NO_DIFFERENCE, prop(null), prop(null));

    comparisonUtils.compareSimple(
      prop("not_null_string"),
      prop("not_null_string"),
      ctx
    );
    verify(differences)
    ...
    verify(differences)
      .add(Where.IN_BOTH_BUT_DIFFERENCE, prop("left"), prop("right"));
  ...
  public void propertyIsNotComparedWhenValidatorTakesResponsibility() {
    ...
    verify(differences, never())
      .add(Where.IN_BOTH_BUT_DIFFERENCE, db1NameProp, db2NameProp);
  }
  ...
  public void collectionPropertyIsNotComparedWhenValidatorTakesResponsibility() {
    ...
    DbObject targetDbObj = new DbObjectWithCollection(
      "right",
      targetCollection
    );
  ...
  public void objectIsNotComparedWhenValidatorTakesResponsibility() {
    ...
    verify(differences, never())
      .add(Where.ONLY_IN_REFERENCE, new DbProperty(db1), null);
    verify(differences, never())
      .add(Where.ONLY_IN_TARGET, null, new DbProperty(db2));
  ...
  public void compareSimpleCollections() {
    ...
    Collection<Object> subCollectionRight = new ArrayList<Object>(
      subCollectionLeft
    );
  ...
  private DbProperty dbPropForValue(
    DbObject obj,
    String propName,
    Object propValue
  ) {
  ...
  public static class DatabaseObject extends AbstractDbObject {
    ...
    protected void doDiff(DbObject right, DiffContext ctx) {
      ...
      ctx
        ...
        .add(Where.IN_BOTH_BUT_DIFFERENCE, leftProp, rightProp);
    }
