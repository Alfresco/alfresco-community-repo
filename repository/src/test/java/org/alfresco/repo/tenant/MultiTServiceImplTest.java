...
public class MultiTServiceImplTest extends BaseSpringTest {
    ...
    public void setUp() throws Exception {
        ...
        tenantAdminService =
                applicationContext.getBean("tenantAdminService", TenantAdminService.class);
        ...
        TENANT_STORE =
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, addDomainToId("SpacesStore", DOMAIN));
    ...
    public void testIsTenantUser() {
        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                    ...
                    public Void execute() throws Throwable {
                        ...
                        result =
                                TenantUtil.runAsUserTenant(
                                        work, USER2, TenantService.DEFAULT_DOMAIN);
                        assertEquals(
                                "The domains do not match.", TenantService.DEFAULT_DOMAIN, result);
                        return null;
                    }
                };
        transactionService.getRetryingTransactionHelper().doInTransaction(work);
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef result =
                                TenantUtil.runAsUserTenant(
                                        work1, USER1, TenantService.DEFAULT_DOMAIN);
                        ...
                        TenantRunAsWork<StoreRef> work2 =
                                new TenantRunAsWork<StoreRef>() {
                                    @Override
                        ...
                        assertEquals(
                                "The StoreRef should contain domain.", TENANT_STORE_REF, result2);

                        TenantRunAsWork<ChildAssociationRef> work3 =
                                new TenantRunAsWork<ChildAssociationRef>() {
                                    @Override
                                    public ChildAssociationRef doWork() throws Exception {
                                        return tenantService.getName(childAssocRef);
                                    }
                                };
                        ChildAssociationRef result3 =
                                TenantUtil.runAsUserTenant(work3, USER2, DOMAIN);
                        assertEquals(
                                "The ChildAssociationRef should contain domain.",
                                tenantChildAssocRef,
                                result3);

                        TenantRunAsWork<AssociationRef> work4 =
                                new TenantRunAsWork<AssociationRef>() {
                                    @Override
                        ...
                        TenantRunAsWork<StoreRef> work5 =
                                new TenantRunAsWork<StoreRef>() {
                                    @Override
                                    public StoreRef doWork() throws Exception {
                        ...
                        assertEquals(
                                "The StoreRef should contain domain.", TENANT_STORE_REF, result5);

                        TenantRunAsWork<QName> work6 =
                                new TenantRunAsWork<QName>() {
                                    @Override
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        AssociationRef result4 = TenantUtil.runAsUserTenant(work4, USER2, DOMAIN);
                        assertEquals(
                                "The AssociationRef should not contain domain.", assocRef, result4);

                        TenantRunAsWork<QName> work5 =
                                new TenantRunAsWork<QName>() {
                                    @Override
                                    public QName doWork() throws Exception {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        try {
                            checkDomainWork(
                                    ...
                                    USER1);
                            fail(
                                    "The string has a domain, which should not match the default"
                                            + " one.");
                        } catch (Exception e) {
                            // Expected
                        }
                        ...
                        try {
                            ...
                            fail(
                                    "The string has a tenant domain and should match the execution"
                                            + " context tenant.");
                        }
                        ...
                        try {
                            ...
                            fail(
                                    "The string has a domain, which should not match the execution"
                                            + " context tenant.");
                        } catch (Exception e) {
                            // Expected
                        }
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertNull(
                                "The primary domain should be null for a non tenant user without a"
                                        + " tenant in name.",
                                result);

                        result = tenantService.getPrimaryDomain(USER2_WITH_DOMAIN);
                        assertNull(
                                "The primary domain should be null for a tenant user if multi"
                        ...
                        assertTrue(
                                "The primary domain should be the default one (empty string) for a"
                                        + " non tenant user without a tenant in name.",
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        createUser(USER1, TenantService.DEFAULT_DOMAIN, PASS);
                        String result =
                                getDomainWork(STRING, TenantService.DEFAULT_DOMAIN, USER1, false);
                        assertEquals(
                        ...
                        assertEquals(
                                "The domain should be reported as default as the tenant was not"
                                        + " created yet.",
                                TenantService.DEFAULT_DOMAIN,
                                result);
                        ...
                        assertEquals(
                                "The USER2 domain should be reported as " + DOMAIN, DOMAIN, result);
                        ...
                        try {
                            result =
                                    getDomainWork(
                                            ...
                                            true);
                            assertEquals(
                                    "The domain should be reported as " + DOMAIN, DOMAIN, result);
                        } catch (Exception e) {
                        ...
                        try {
                            result =
                                    getDomainWork(
                                            STRING_WITH_NONEXITENT_DOMAIN, DOMAIN, USER2, true);
        ...
        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                "The user domain should be the default one for a non tenant user"
                                        + " without a tenant in name.",
                                TenantService.DEFAULT_DOMAIN,
                                result);

                        result = tenantService.getUserDomain(USER2_WITH_DOMAIN);
                        assertEquals(
                                "The user domain should be the default one for a user with email"
                                        + " like name if multi tenancy is not enabled.",
                                TenantService.DEFAULT_DOMAIN,
                                result);
                        ...
                        assertTrue(
                                "The user domain should be the default one (empty string) for a non"
                                        + " tenant user without a tenant in name.",
                                result.equals(TenantService.DEFAULT_DOMAIN));
                        return null;
                    }
                };
     ...
     * @throws Exception
     */
    private void checkDomainWork(final String string, String domain, String runAsUsername)
            throws Exception {
        TenantRunAsWork<Void> work =
     ...
     * @throws Exception
     */
    private void checkDomainUserWork(final String username, String domain, String runAsUsername)
            throws Exception {
        TenantRunAsWork<Void> work =
                new TenantRunAsWork<Void>() {
                    @Override
                        ...
                        RetryingTransactionHelper.RetryingTransactionCallback<Void> work =
                                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                                    public Void execute() throws Throwable {
                                        ...
                                        if (tenantAdminService.existsTenant(tenantDomain)) {
                                            // TODO: WARNING: HACK for ALF-19155: MT deleteTenant
                                            // does not work
                                            //       PersonService prevents 'guest' authorities from
                                            // being deleted
                                            {
