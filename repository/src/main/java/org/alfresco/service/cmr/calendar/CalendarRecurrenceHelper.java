...
public class CalendarRecurrenceHelper {
  ...
  protected static final Map<String, Integer> d2cd = Collections.unmodifiableMap(
   ...
   */
  public static final Map<String, Integer> DAY_NAMES_TO_CALENDAR_DAYS = Collections.unmodifiableMap(
    d2cd
  );
   ...
   */
  public static Map<String, String> buildLocalRecurrenceDaysOfTheWeek(
    Locale locale
  ) {
  ...
  @SuppressWarnings("serial")
  protected static final Map<Integer, String> WEEK_NUMBER_TO_WEEK_NAME = Collections.unmodifiableMap(
   ...
   */
  public static Map<Integer, String> buildLocalRecurrenceWeekNames(
    Locale locale
  ) {
   ...
   *  a real object in the near future
   */
  private static Map<String, String> extractRecurrenceRule(
    ...
    for (String rule : recurrenceRule.split(";")) {
      ...
      if (parts.length != 2) {
        logger.warn(
          "Invalid rule '" + rule + "' in recurrence: " + recurrenceRule
        );
      } else {
  ...
  protected static Map<String, String> fixOutlookRecurrenceQuirks(
    ...
    if (params.containsKey("FREQ")) {
      // Is it really yearly?
      if (
        "MONTHLY".equals(params.get("FREQ")) && params.get("BYMONTH") != null
      ) {
      ...
      // MNT-10006 fix. Added the support for recurrences rule "WEEKDAY", "WEEKEND DAY"
        ...
        "MONTHLY".equals(params.get("FREQ")) &&
  ...
  public static List<Date> getRecurrencesOnOrAfter(
    ...
    if (params.containsKey("FREQ")) {
      ...
      logger.warn(
        "No frequency found, possible invalid rule? " + recurrenceRule
      );
      return null;
    }
  }
  ...
  protected static void buildWeeklyRecurrences(
    ...
    while (going) {
      ...
      for (int day : daysOfWeek) {
        ...
        if (!valid) {
          Date currentEventEnd = new Date(
            currentDate.getTimeInMillis() + duration
          );
  ...
  protected static void buildMonthlyRecurrences(
    ...
    // MNT-10006 fix. Added the support for recurrences rule "WEEKDAY", "WEEKEND DAY"
    if (
      params.get("BYWEEKDAY") != null ||
      params.get("BYWEEKENDDAY") != null ||
      params.get("BYANYDAY") != null
    ) {
      buildWeekdayAndWeekEndRecurence(
        currentDate,
        dates,
        params,
        until,
   ...
   */
  private static List<Integer> getDaysOfWeek(
    Map<String, String> params,
    String dayWeekType
  ) {
  ...
  protected static void buildYearlyRecurrences(
    ...
    if (params.get("BYMONTHDAY") != null) {
      ...
      if (
        ...
        currentDate.set(
          Calendar.YEAR,
          currentDate.get(Calendar.YEAR) + interval
        );
        currentDate.set(Calendar.MONTH, month);
        currentDate.set(Calendar.DAY_OF_MONTH, dayOfMonth);
      }
  ...
  private static void addMonthToDayOfMonth(
    Calendar c,
    int dayOfMonth,
    int monthInterval
  ) {
  ...
  private static void addMonthToFirstDayOfWeek(
    Calendar c,
    int dayOfWeek,
    int monthInterval
  ) {
   ...
   */
  private static void toDayOfWeekInMonth(
    Calendar c,
    int dayOfWeek,
    int weekInMonth
  ) {
