...
public class ImapReadMessagesTests extends EmailTest {
  ...
  public void adminShouldGetFoldersCreatedInRepositoryViaImap()
    throws Exception {
  ...
  public void fileWithSpacesInNameIsDisplayedInImap() throws Exception {
    testFile =
      dataContent
        ...
        .usingSite(testSite)
        .createContent(
          new FileModel("name with spaces.txt", FileType.TEXT_PLAIN)
        );
    imapProtocol
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void userCanViewFileWithSpecialCharactersInNameViaIMAP()
    throws Exception {
    testFile =
      dataContent
        .usingUser(testUser)
  ...
  public void userCanViewFileWithSymbolsInNameViaIMAP() throws Exception {
    testFile =
      dataContent
        ...
        .usingSite(testSite)
        .createContent(
          new FileModel("a£¥€$♊♎♏♐♑♒♓Ω.txt", FileType.TEXT_PLAIN)
        );
    imapProtocol
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void siteManagerCannotReadFileInImapIfItWasDeletedFromRepository()
    throws Exception {
    testFile =
      dataContent
        .usingUser(testUser)
        .usingSite(testSite)
        .createContent(
          new FileModel(RandomData.getRandomName("File"), FileType.TEXT_PLAIN)
        );
    dataContent
      .usingUser(testUser)
      .usingSite(testSite)
