...
public interface ThumbnailService
{
     ...
     * 
     * The mimetype and transformation options are used to determine the content transformer that will be best suited to create the thumbnail.
     * 
     * The thumbnail name is optional, but is usually set to provide an easy way to identify a particular 'type' of thumbnail.
     * 
     * Once created the source node will have the 'rn:renditioned' aspect applied and an association to the thumbnail node (of type 'rn:rendition') will be created.
     * 
     * The returned node reference is to the 'rn:rendition' content node that contains the thumbnail content in the standard 'cm:content' property.
     * 
     ...
     * @param mimetype
     *            the thumbnail mimetype
     * @param transformationOptions
     *            the thumbnail transformation options
     * @param name
     ...
     * 
     * The original thumbnail content is updated from the source content using the transformation options provided. The mimetype and name of the thumbnail remain unchanged.
     * 
     ...
     *            the thumbnail node
     * @param transformationOptions
     *            the transformation options used when updating the thumbnail
     */
     ...
     * 
     * Both mimetype and transformation options are optional parameters. If only one or other is specified the only the other is considered during. If neither are provided all thumbnails for that content property are returned.
     * 
    ...
    /**
     * This method returns a {@link Map} of {@link FailedThumbnailInfo failed thumbnails} for the specified source node. The map is keyed by {@link ThumbnailDefinition#getName() thumbnail definition name} and the values are the {@link FailedThumbnailInfo failed thumbnails}.
     * 
     * @param sourceNode
     *            the node whose thumbnails are to be checked.
     * @return a Map of failed thumbnails, if any. If there are no such failures, an empty Map will be returned.
     * @since 3.5.0
     */
     ...
     * 
     * @param thumbnailsEnabled
     *            <code>true</code> to enable all thumbnail creation (the default setting), or <code>false</code> to disable.
     * @since 4.1.7
     */
