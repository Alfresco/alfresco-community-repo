...
public class RMv22RemoveInPlaceRolesFromAllPatch extends AbstractModulePatch {
    ...
    public void applyInternal() {
        ...
        for (NodeRef filePlan : filePlans) {
            Role extendedReaders =
                    filePlanRoleService.getRole(
                            filePlan, FilePlanRoleService.ROLE_EXTENDED_READERS);
            Role extendedWriters =
                    filePlanRoleService.getRole(
                            filePlan, FilePlanRoleService.ROLE_EXTENDED_WRITERS);
            ...
            Set<String> members =
                    authorityService.getContainedAuthorities(null, allRolesGroup, true);
