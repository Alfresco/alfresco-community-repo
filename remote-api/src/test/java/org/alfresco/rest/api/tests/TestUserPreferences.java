...
public class TestUserPreferences extends EnterpriseTestApi {
  ...
  public void testUserPreferences() throws Exception {
    ...
    expectedPreferences.add(
      new Preference(
        "org.alfresco.share.documentList.testPreference2",
        String.valueOf(true)
      )
    );
    expectedPreferences.add(
      new Preference(
        "org.alfresco.share.documentList.testPreference1",
        String.valueOf(true)
      )
    );
    expectedPreferences.add(
      new Preference(
        "org.alfresco.share.documentList.sortAscending",
        String.valueOf(true)
      )
    );
    expectedPreferences.add(
      new Preference(
        "org.alfresco.share.documentList.testPreference3",
        String.valueOf(true)
      )
    );
    ...
    // test paging
    {
      ...
      ListResponse<Preference> resp = peopleProxy.getPreferences(
        person1.getId(),
