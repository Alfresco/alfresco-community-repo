...
public class CreateFolderTests extends WebDavTest {
    ...
    @TestRail(
            ...
            description = "Verify that admin user can create folder")
    ...
    public void adminShouldCreateFolder() throws Exception {
        ...
        webDavProtocol
                ...
                .and()
                .assertThat()
                .hasStatus(HttpStatus.SC_OK);
    }

    @TestRail(
            section = {TestGroup.PROTOCOLS, TestGroup.WEBDAV},
            executionType = ExecutionType.SANITY,
            description = "Verify that site manager can create folder")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY})
    ...
    @TestRail(
            section = {TestGroup.PROTOCOLS, TestGroup.WEBDAV},
            executionType = ExecutionType.SANITY,
            description = "Verify that user with contributor role can create folder")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY})
    ...
    @TestRail(
            section = {TestGroup.PROTOCOLS, TestGroup.WEBDAV},
            executionType = ExecutionType.SANITY,
            description = "Verify that user with collaborator role can create folder")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY})
    ...
    @TestRail(
            section = {TestGroup.PROTOCOLS, TestGroup.WEBDAV},
            executionType = ExecutionType.SANITY,
            description = "Verify that user with consumer role cannot create folder")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that user with manager role can create folder with spaces in name")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            description =
                    "Verify that user with manager role cannot create folder with special"
                            + " characters in name")
    @Test(
    ...
    public void siteManageShouldNotCreateFolderWithSpecialChars() throws Exception {
        ...
        webDavProtocol.authenticateUser(managerUser).usingSite(testSite).createFolder(testFolder);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager cannot create folder twice in the same location")
    ...
    public void siteManagerShouldNotCreateFolderTwice() throws Exception {
        ...
        webDavProtocol
                ...
                .createFolder(testFolder)
                .assertThat()
                .hasStatus(HttpStatus.SC_METHOD_NOT_ALLOWED);
    }

    @TestRail(
            section = {TestGroup.PROTOCOLS, TestGroup.WEBDAV},
            executionType = ExecutionType.REGRESSION,
            description = "Verify that inexistent user cannot create folder")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.CORE})
