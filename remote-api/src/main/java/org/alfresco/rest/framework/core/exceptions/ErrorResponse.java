...
public class ErrorResponse {
    ...
    public ErrorResponse(
        ...
        this.additionalState =
                additionalState == null ? null : Collections.unmodifiableMap(additionalState);
    ...
    public String toString() {
        ...
        builder.append("ErrorResponse [errorKey=")
                .append(this.errorKey)
                .append(", statusCode=")
                .append(this.statusCode)
                .append(", briefSummary=")
                .append(this.briefSummary)
                .append(", descriptionURL=")
                .append(this.descriptionURL)
                .append(", logId=")
                .append(this.logId)
                .append(", stackTrace=")
                .append(this.stackTrace)
                .append(", additionalState=")
                .append(this.additionalState)
                .append("]");
