...
public class PagingRequest {
    ...
    private int requestTotalCountMax =
            0; // request total count up to a given max (0 => do not request total count)
    ...
    /**
     * Results to skip before retrieving the page. Usually a multiple of page size (ie. page size *
     * num pages to skip). Default is 0.
     *
    ...
    /**
     * Set request total count (up to a given maximum). Default is 0 => do not request total count
     * (which allows possible query optimisation).
     *
