...
public class CMISHttpServletResponse implements HttpServletResponse {
  ...
  public CMISHttpServletResponse(
    WebScriptResponse res,
    Set<String> nonAttachContentTypes
  ) {
  ...
  public void setHeader(String name, String value) {
    httpResp.setHeader(
      name,
      getStringHeaderValue(name, value, httpResp.getContentType())
    );
  }
  ...
  private String getStringHeaderValue(
    String name,
    String value,
    String contentType
  ) {
