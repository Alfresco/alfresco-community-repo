...
public class BlogLibJs {
   ...
   */
  public static Map<QName, Serializable> getBlogPropertiesArray(
    JSONObject json
  ) {
    ...
    putJSONEntryInMap(
      ...
      arr,
      "blogType",
      BlogIntegrationModel.PROP_BLOG_IMPLEMENTATION
    );
    ...
    putJSONEntryInMap(
      ...
      arr,
      "blogDescription",
      BlogIntegrationModel.PROP_DESCRIPTION
    );
    ...
    putJSONEntryInMap(
      ...
      arr,
      "username",
      BlogIntegrationModel.PROP_USER_NAME
    );
    putJSONEntryInMap(
      json,
      arr,
      "password",
      BlogIntegrationModel.PROP_PASSWORD
    );
    return arr;
  }

  private static void putJSONEntryInMap(
    JSONObject json,
    Map<QName, Serializable> arr,
    String jsonKey,
    QName mapKey
  ) {
