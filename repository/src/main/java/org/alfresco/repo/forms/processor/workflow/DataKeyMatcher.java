...
public class DataKeyMatcher {
     ...
     */
    private static final Pattern associationNamePattern =
            Pattern.compile("(^[a-zA-Z0-9-]+)_([a-zA-Z0-9_]+)(_[a-zA-Z]+$)");

    private static final Pattern transientAssociationPattern =
    ...
    /**
     * Attempts to match the <code>dataKey</code> to either a property or association pattern. If no
     * match can be found then returns <code>null</code>.
     *
