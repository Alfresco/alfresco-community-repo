...
public class CombinedConfig extends CombinedTransformConfig {
    ...
    configFileFinder =
      new ConfigFileFinder(jsonObjectMapper) {
        ...
        protected void readJson(
          ...
          TransformConfig transformConfig = jsonObjectMapper.convertValue(
            jsonNode,
  ...
  private boolean addRemoteConfig(String baseUrl, String remoteType) {
    String url =
      baseUrl + (baseUrl.endsWith("/") ? "" : "/") + "transform/config";
    ...
    try {
      try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
        ...
        throw new AlfrescoRuntimeException(
          remoteType + " on " + url + " failed to create an HttpClient",
          e
        );
      }
