...
/**
 * Enum to specify how multi-lingual properties should be treate for indexing and search. Note that
 * locale new Locale ("", "", "") is used to indicate all locales.
 *
 * @author andyh
 */
public enum MLAnalysisMode {
    ...
    /**
     * Expand the locale to include all the locales that contain it. So "en_GB" would be "en_GB",
     * "en", but not all languages "".
     */
    ...
    /**
     * Expand the locale to include all the locales that contain it. "en_GB" would be "en_GB", "en",
     * and all "".
     */
    ...
    /**
     * Expand to all the locales that are contained by this. "en" would expand to "en", "en_GB",
     * "en_US", ....
     */
                        ...
                        if (withWildcards) {
                            ...
                            for (Locale toAdd : Locale.getAvailableLocales()) {
                                if (locale.getLanguage().equals("")
                                        || locale.getLanguage().equals(toAdd.getLanguage())) {
                                    locales.add(toAdd);
                                }
                            }
                        }
