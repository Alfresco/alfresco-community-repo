...
public class RelationshipTypeDefintionWrapper
  ...
  public RelationshipTypeDefintionWrapper(
  ...
  public RelationshipTypeDefintionWrapper(
    ...
    String sourceTypeId = cmisMapping.getCmisTypeId(
      cmisMapping.getCmisType(cmisAssocDef.getSourceClass().getName())
    );
    ...
    String targetTypeId = cmisMapping.getCmisTypeId(
      cmisMapping.getCmisType(cmisAssocDef.getTargetClass().getName())
    );
