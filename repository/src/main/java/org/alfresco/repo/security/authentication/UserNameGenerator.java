...
public interface UserNameGenerator {
     ...
     *
     * <p>A seed value of 0 means first attempt. A non zero seed value indicates that the obvious
     * user name is already taken and that some random element needs to be added to make a unique
     * user id.
     *
    ...
    public String generateUserName(
            String firstName, String lastName, String emailAddress, int seed);
}
