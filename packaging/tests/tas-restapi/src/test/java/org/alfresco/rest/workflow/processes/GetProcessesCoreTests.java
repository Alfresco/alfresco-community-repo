...
public class GetProcessesCoreTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        activitiReviewProcessDefinition =
                restClient
                        ...
                        .withWorkflowAPI()
                        .getAllProcessDefinitions()
                        .getProcessDefinitionByKey("activitiReview");
    }
    ...
    public void getProcessesWithWhereClauseAsParameter()
            throws JsonToModelConversionException, Exception {
        RestProcessModelsCollection processes =
                restClient
                        .authenticateUser(userWhoStartsTask)
                        .where("processDefinitionKey='activitiReview'")
                        .withWorkflowAPI()
                        .getProcesses();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        ...
        processes
                ...
                .and()
                .entriesListContains("processDefinitionId", activitiReviewProcessDefinition.getId())
                .and()
                .entriesListDoesNotContain("processDefinitionId", adhocProcessDefinition.getId());
    }
}
