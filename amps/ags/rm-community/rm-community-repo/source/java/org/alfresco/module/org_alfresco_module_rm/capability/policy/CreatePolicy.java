...
public class CreatePolicy extends AbstractBasePolicy {
  ...
  public int evaluate(
    ...
    NodeRef destination = getTestNode(
      invocation,
      params,
      cad.getParameters().get(0),
      cad.isParent()
    );
    ...
    return (
      (CreateCapability) getCapabilityService().getCapability("Create")
    ).evaluate(destination, linkee, assocType);
  }
}
