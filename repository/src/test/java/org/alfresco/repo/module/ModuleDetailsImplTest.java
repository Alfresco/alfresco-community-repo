...
public class ModuleDetailsImplTest extends TestCase {
    ...
    static {
        ...
        DEFAULT_PROPS.setProperty(
                ModuleDetails.PROP_REPO_VERSION_MIN, new VersionNumber("1.2").toString());
        DEFAULT_PROPS.setProperty(
                ModuleDetails.PROP_REPO_VERSION_MAX, new VersionNumber("1.4.3").toString());
        ...
        DEFAULT_PROPS.setProperty(
                ModuleDetails.PROP_INSTALL_STATE, ModuleInstallState.INSTALLED.toString());
    }
    ...
    public void testInvalidIds() throws Exception {
        ...
        String[] invalidIds =
                new String[] {
                    "", " ", "$", "module$Test", "module.Test$", "org alfresco module Test"
                };
    ...
    public void testValidIds() throws Exception {
        ...
        props.putAll(DEFAULT_PROPS);
        String[] validIds =
                new String[] {"abc123", " abc123 ", "a-b-c", "a.b.c", "a_b_c", "A.1.2.3"};
