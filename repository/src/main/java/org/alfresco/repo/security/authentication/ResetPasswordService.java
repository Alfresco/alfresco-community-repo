...
public interface ResetPasswordService {
     ...
     * @param clientName the client app name (used to lookup the client that is registered to send
     *     emails so that client's specific configuration could be used.)
     */
     ...
     *
     * @param execution the {@code DelegateExecution} object (is provided when a user requests
     *     password reset)
     * @param fallbackEmailTemplatePath the class path of the fallback email template (request reset
     *     password email)
     ...
     *
     * @param execution the {@code DelegateExecution} object
     * @param fallbackEmailTemplatePath the class path of the fallback email template (confirmation
     *     email)
     * @param emailSubject the email subject key
     */
    void sendResetPasswordConfirmationEmail(
            DelegateExecution execution, String fallbackEmailTemplatePath, String emailSubject);
