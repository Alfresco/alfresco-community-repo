...
public class GetFavoriteSitesTests extends RestTest {
  ...
  public void managerUserFailsToGetAnUserFavoriteSites() throws Exception {
    ...
    dataUser
      .usingUser(userModel)
      .addUserToSite(managerUser, siteModel, UserRole.SiteManager);
  ...
  public void unauthenticatedUserIsNotAuthorizedToGetFavoriteSites()
    throws Exception {
    UserModel anyUser = dataUser.usingAdmin().createRandomTestUser();
    dataSite.usingUser(anyUser).usingSite(siteModel).addSiteToFavorites();
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void getFavoriteSitesReturns404ForAPersonIdThatDoesNotExist()
    throws Exception {
    UserModel invalidUser = new UserModel(
      RandomData.getRandomName("User"),
      DataUser.PASSWORD
    );
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void userGetsFavoriteSiteWithSuccessUsingMEForRequest()
    throws Exception {
    restSiteModelsCollection =
      restClient
        .authenticateUser(testUser1)
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void getFavoriteSiteRequestForUserWithNoFavoriteSitesIsSuccessful()
    throws Exception {
    UserModel randomTestUser = dataUser.createRandomTestUser();
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void getFavoriteSitesRequestWithValidPropertiesParam()
    throws Exception {
    RestSiteModel restSiteModel = restClient
      .authenticateUser(testUser1)
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void getFavoriteSitesRequestWithInvalidPropertiesParam()
    throws Exception {
    restClient
      .authenticateUser(testUser1)
