...
public class ActivitiesImpl extends WorkflowRestImpl implements Activities {
    ...
    @Override
    public CollectionWithPagingInfo<Activity> getActivities(
            String processId, Parameters parameters) {
        ...
        HistoricActivityInstanceQuery query =
                activitiProcessEngine.getHistoryService().createHistoricActivityInstanceQuery();
        ...
        List<HistoricActivityInstance> activities =
                query.listPage(paging.getSkipCount(), paging.getMaxItems());
