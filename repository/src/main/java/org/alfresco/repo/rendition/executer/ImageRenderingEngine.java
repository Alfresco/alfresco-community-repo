...
public class ImageRenderingEngine
   ...
   */
  @Override
  protected TransformationOptions getTransformOptions(
  ...
  protected TransformationOptions getTransformOptionsImpl(
    ...
    String commandOptions = context.getCheckedParam(
      PARAM_COMMAND_OPTIONS,
      String.class
    );
    ImageResizeOptions imageResizeOptions = getImageResizeOptions(context);

    boolean autoOrient = context.getParamWithDefault(
  ...
  private ImageResizeOptions getImageResizeOptions(RenderingContext context) {
    ...
    boolean isPercentResize = context.getParamWithDefault(
      PARAM_IS_PERCENT_RESIZE,
      false
    );
    boolean maintainAspectRatio = context.getParamWithDefault(
      PARAM_MAINTAIN_ASPECT_RATIO,
      false
    );
    boolean allowEnlargement = context.getParamWithDefault(
  ...
  protected void checkParameterValues(Action action) {
    ...
    checkNumericalParameterIsPositive(
      action,
   ...
   */
  private void checkNumericalParameterIsPositive(
    Action action,
    String numericalParamName
  ) {
  ...
  private void checkTargetMimeType(RenderingContext context) {
    ...
    if (targetMimeType == null || !targetMimeType.startsWith("image")) {
      StringBuilder msg = new StringBuilder();
      msg
        .append("Target has illegal non-image MIME type: ")
