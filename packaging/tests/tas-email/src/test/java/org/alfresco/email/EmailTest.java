  ...
  public void checkServerHealth() throws Exception {
    ...
    if (emailProperties.getUseJolokiaAgent()) {
      ...
      ServerConfiguration.save(
        smtpProtocol.withJMX(),
        smtpProtocol.emailProperties
      );
    } else {
      LOG.warn(
        "*** Jolokia is not used! To use jolokia, please add next system property when running the tests: jmx.useJolokiaAgent=true ***"
      );
    }
  }
