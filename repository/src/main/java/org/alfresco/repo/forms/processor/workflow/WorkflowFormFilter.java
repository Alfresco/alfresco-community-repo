...
public class WorkflowFormFilter<ItemType, PersistType>
  ...
  public void setMaxLengthBpmCommentProperty_oldPropertyName(
    int maxLengthBpmCommentProperty_oldPropertyName
  ) {
    this.maxLengthBpmCommentProperty_oldPropertyName =
      maxLengthBpmCommentProperty_oldPropertyName;
  }
  ...
  public void afterPropertiesSet() throws Exception {
    if (maxLengthBpmCommentProperty_oldPropertyName != -1) {
      LOGGER.warn(
        "Config property system.workflow.jbpm.comment.property.max.length is deprecated. Please use system.workflow.comment.property.max.length instead."
      );
