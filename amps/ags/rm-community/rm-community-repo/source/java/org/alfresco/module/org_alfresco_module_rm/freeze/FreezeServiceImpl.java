...
public class FreezeServiceImpl extends ServiceBaseImpl
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#isFrozen(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#getFrozen(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#freeze(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#unFreeze(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#relinquish(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#getReason(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#updateReason(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#hasFrozenChildren(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    public boolean hasFrozenChildren(final NodeRef nodeRef) {
        ...
        if (isRecordFolder(nodeRef)
                || (instanceOf(nodeRef, TYPE_FOLDER)
                        && !nodeService.hasAspect(nodeRef, ASPECT_SITE_CONTAINER))) {
            int heldCount = 0;
                ...
                heldCount =
                        (Integer)
                                getInternalNodeService()
                                        .getProperty(nodeRef, PROP_HELD_CHILDREN_COUNT);
            } else {
                                                ...
                                                .doInTransaction(
                                                        new RetryingTransactionCallback<Integer>() {
                                                            public Integer execute()
                                                                ...
                                                                // NOTE: this process remains to
                                                                // 'patch' older systems to improve
                                                                ...
                                                                if (childAssocs != null
                                                                        && !childAssocs.isEmpty()) {
                                                                    for (ChildAssociationRef
                                                                            childAssociationRef :
                                                                                    childAssocs) {
                                                                        final NodeRef childRef =
                                                                                childAssociationRef
                                                                                        .getChildRef();
                                                                        if (childAssociationRef
                                                                                        .isPrimary()
                                                                                && isFrozen(
                                                                                        childRef)) {
                                                                            heldCount++;
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#getFreezeDate(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.freeze.FreezeService#getFreezeInitiator(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    private NodeRef createHold(NodeRef nodeRef, String reason) {
        ...
        String holdName =
                I18NUtil.getMessage(MSG_HOLD_NAME)
                        + " "
     ...
     * @return <code>true</code> if the node is frozen or has frozen children, <code>false</code>
     *     otherwise
     */
    @Override
