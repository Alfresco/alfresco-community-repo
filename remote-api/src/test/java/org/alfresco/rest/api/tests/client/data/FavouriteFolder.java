...
public class FavouriteFolder
  ...
  public static FavouriteFolder getFolder(
    String id,
    String guid,
    Properties props
  ) {
  ...
  public static FavouriteFolder parseFolder(JSONObject jsonObject)
