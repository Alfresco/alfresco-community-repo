...
public class ModuleComponentHelper
{
    ...
    /**
     * Add a managed module component to the registry of components. These will be controlled by the {@link #startModules()} method.
     * 
     * @param component
    ...
    /**
     * @return Returns the map of components keyed by name. The map could be empty but will never be <tt>null</tt>.
     */
    ...
    /**
     * Copies, where necessary, the module registry details from the alias details and removes the alias details.
     */
    ...
    /**
     * Does the actual work without fussing about transactions and authentication. Module dependencies will be started first, but a module will only be started once.
     * 
     * @param module
     *            the module to start
     * @param startedModules
     *            the IDs of modules that have already started
     * @param executedComponents
    ...
    protected ModuleVersionNumber getModuleVersionNumber(Serializable moduleVersion)
    {
        ...
        if (moduleVersion instanceof String)
            return new ModuleVersionNumber((String) moduleVersion);
