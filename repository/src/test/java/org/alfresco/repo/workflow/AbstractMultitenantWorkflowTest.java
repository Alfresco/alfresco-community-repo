...
public abstract class AbstractMultitenantWorkflowTest extends BaseSpringTest {
  ...
  private static final QName ADHOC_TASK = QName.createQName(
  ...
  public void xtestDeployWorkflow() throws Exception {
    ...
    // Deploy to tenant1.
    WorkflowDefinition definition = workflowService.getDefinitionByName(
      definitionKey
    );
    ...
    WorkflowDefinition definitionByName = workflowService.getDefinitionByName(
      definitionKey
    );
  ...
  public void testQueryTasks() throws Exception {
    ...
    WorkflowDefinition adhocDef1 = workflowService.getDefinitionByName(
      adhocKey
    );
    ...
    WorkflowDefinition adhocDef2 = workflowService.getDefinitionByName(
      adhocKey
    );
    ...
    WorkflowPath path2 = workflowService.startWorkflow(
      adhocDef2.getId(),
      parameters2
    );
        ...
        public String doWork() throws Exception {
          if (!tenantAdminService.existsTenant(tenantDomain)) {
            tenantAdminService.createTenant(
              tenantDomain,
              (DEFAULT_ADMIN_PW + " " + tenantDomain).toCharArray(),
              null
