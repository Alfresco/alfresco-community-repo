...
public class AuditDeleteParameters {
  ...
  public String toString() {
    ...
    sb
      .append("AuditDeleteParameters")
      .append("[ auditApplicationId=")
      .append(auditApplicationId)
      .append(", auditFromTime")
      .append(auditFromTime == null ? null : new Date(auditFromTime))
      .append(", auditToTime")
      .append(auditToTime == null ? null : new Date(auditToTime))
      .append(", auditFromId")
      .append(auditFromId)
      .append(", auditToId")
      .append(auditToId)
      .append(", auditEntryIds")
      .append(auditEntryIds == null ? null : auditEntryIds.size())
      .append("]");
    return sb.toString();
  }
