...
/**
 * A {@link NodeCleanupWorker worker} that aggregates any number of {@link
 * #register(NodeCleanupWorker) registered} workers.
 *
 * @author Derek Hulley
 * @since 2.2 SP2
 */
public class NodeCleanupRegistry implements NodeCleanupWorker {
    ...
    /**
     * Calls all registered cleaners in order, without transactions or authentication. The return
