...
public class DiscussionServiceImplTest {
    ...
    private static final String TENANT_DOMAIN =
            (DiscussionServiceImplTest.class.getSimpleName() + "Tenant").toLowerCase();

    private static final String TEST_USER =
            DiscussionServiceImplTest.class.getSimpleName() + "_testuser@" + TENANT_DOMAIN;
    ...
    public void before() {
        ...
        ((DiscussionServiceImpl) testContext.getBean("discussionService"))
    ...
    public void createNewTopic() throws Exception {
        ...
        PagingResults<TopicInfo> results =
                DISCUSSION_SERVICE.listTopics(
                        DISCUSSION_SITE.getShortName(), true, new PagingRequest(10));
        ...
        NodeRef container =
                PUBLIC_NODE_SERVICE.getPrimaryParent(siteTopic.getNodeRef()).getParentRef();
        ...
        siteTopic =
                DISCUSSION_SERVICE.getTopic(
                        DISCUSSION_SITE.getShortName(), siteTopic.getSystemName());
        assertEquals("Site Title", siteTopic.getTitle());
        assertEquals(ADMIN_USER, siteTopic.getCreator());
        assertEquals(0, siteTopic.getTags().size());
        ...
        assertEquals(
                FORUM_NODE,
                PUBLIC_NODE_SERVICE.getPrimaryParent(nodeTopic.getNodeRef()).getParentRef());
    ...
    public void createNewTopicAndPostAndReply() throws Exception {
        ...
        for (TopicInfo topic : new TopicInfo[] {siteTopic, nodeTopic}) {
            ...
            assertEquals(
                    post.getNodeRef(), DISCUSSION_SERVICE.getMostRecentPost(topic).getNodeRef());
            ...
            assertNotNull(DISCUSSION_SERVICE.getMostRecentPost(topic));
            assertEquals(
                    reply2.getNodeRef(), DISCUSSION_SERVICE.getMostRecentPost(topic).getNodeRef());
    ...
    public void basicListings() throws Exception {
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        DISCUSSION_SITE.getShortName(), false, new PagingRequest(10));
        assertEquals(2, topics.getPage().size());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        DISCUSSION_SITE.getShortName(), ADMIN_USER, true, new PagingRequest(10));
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        DISCUSSION_SITE.getShortName(), TEST_USER, true, new PagingRequest(10));
        assertEquals(1, topics.getPage().size());
        assertEquals("ST2", topics.getPage().get(0).getTitle());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        DISCUSSION_SITE.getShortName(), ADMIN_USER, false, new PagingRequest(10));
        assertEquals(1, topics.getPage().size());
        assertEquals("ST1", topics.getPage().get(0).getTitle());

        topics =
                DISCUSSION_SERVICE.listTopics(FORUM_NODE, ADMIN_USER, false, new PagingRequest(10));
        assertEquals(2, topics.getPage().size());
        assertEquals("NT3", topics.getPage().get(0).getTitle());
        assertEquals("NT2", topics.getPage().get(1).getTitle());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        DISCUSSION_SITE.getShortName(), TEST_USER, false, new PagingRequest(10));
        assertEquals(1, topics.getPage().size());
        assertEquals("ST2", topics.getPage().get(0).getTitle());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        FORUM_NODE, yesterday, tomorrow, true, new PagingRequest(10));
        assertEquals(3, topics.getPage().size());
        assertEquals("NT1", topics.getPage().get(0).getTitle());
        assertEquals("NT2", topics.getPage().get(1).getTitle());
        assertEquals("NT3", topics.getPage().get(2).getTitle());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        FORUM_NODE, fourDaysAgo, yesterday, true, new PagingRequest(10));
        assertEquals(0, topics.getPage().size());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        FORUM_NODE, tomorrow, future, true, new PagingRequest(10));
        assertEquals(0, topics.getPage().size());
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        FORUM_NODE, yesterday, tomorrow, false, new PagingRequest(10));
        assertEquals(3, topics.getPage().size());
        assertEquals("NT3", topics.getPage().get(0).getTitle());
        assertEquals("NT2", topics.getPage().get(1).getTitle());
        assertEquals("NT1", topics.getPage().get(2).getTitle());
        ...
        //       // Find without tags
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), null, null,
        // true, new PagingRequest(10));
        //       assertEquals(2, topics.getPage().size());
        //       assertEquals("ST1", topics.getPage().get(0).getTitle());
        //       assertEquals("ST2", topics.getPage().get(1).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, null, null, true, new
        // PagingRequest(10));
        //       assertEquals(3, topics.getPage().size());
        //       assertEquals("NT1", topics.getPage().get(0).getTitle());
        //       assertEquals("NT2", topics.getPage().get(1).getTitle());
        ...
        //
        //       // Find with tags
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), null, TAG_1,
        // true, new PagingRequest(10));
        //       assertEquals(1, topics.getPage().size());
        //       assertEquals("ST2", topics.getPage().get(0).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, null, TAG_1, true, new
        // PagingRequest(10));
        //       assertEquals(2, topics.getPage().size());
        //       assertEquals("NT2", topics.getPage().get(0).getTitle());
        //       assertEquals("NT3", topics.getPage().get(1).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), null, TAG_2,
        // true, new PagingRequest(10));
        //       assertEquals(0, topics.getPage().size());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, null, TAG_2, true, new
        // PagingRequest(10));
        //       assertEquals(1, topics.getPage().size());
        //       assertEquals("NT2", topics.getPage().get(0).getTitle());
        //
        ...
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), ADMIN_USER,
        // null, true, new PagingRequest(10));
        //       assertEquals(1, topics.getPage().size());
        //       assertEquals("ST1", topics.getPage().get(0).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, ADMIN_USER, null, true, new
        // PagingRequest(10));
        //       assertEquals(2, topics.getPage().size());
        //       assertEquals("NT2", topics.getPage().get(0).getTitle());
        //       assertEquals("NT3", topics.getPage().get(1).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), TEST_USER,
        // null, true, new PagingRequest(10));
        //       assertEquals(1, topics.getPage().size());
        //       assertEquals("ST2", topics.getPage().get(0).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, TEST_USER, null, true, new
        // PagingRequest(10));
        //       assertEquals(1, topics.getPage().size());
        //       assertEquals("NT1", topics.getPage().get(0).getTitle());
        //
        ...
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), ADMIN_USER,
        // TAG_1, true, new PagingRequest(10));
        //       assertEquals(0, topics.getPage().size());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(DISCUSSION_SITE.getShortName(), TEST_USER,
        // TAG_1, true, new PagingRequest(10));
        ...
        //       assertEquals("ST2", topics.getPage().get(0).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, ADMIN_USER, TAG_2, true, new
        // PagingRequest(10));
        //       assertEquals(1, topics.getPage().size());
        //       assertEquals("NT2", topics.getPage().get(0).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, TEST_USER, TAG_2, true, new
        // PagingRequest(10));
        //       assertEquals(0, topics.getPage().size());
        //
        //
        ...
        //       assertEquals("NT3", topics.getPage().get(1).getTitle());
        //
        //       topics = DISCUSSION_SERVICE.findTopics(FORUM_NODE, ADMIN_USER, null, false, new
        // PagingRequest(10));
        //       assertEquals(2, topics.getPage().size());
        //       assertEquals("NT3", topics.getPage().get(0).getTitle());
        //       assertEquals("NT2", topics.getPage().get(1).getTitle());
        ...
        for (TopicInfo topic : new TopicInfo[] {siteT1, nodeT1}) {
            ...
            assertEquals(
                    reply2.getNodeRef(), DISCUSSION_SERVICE.getPrimaryPost(topic).getNodeRef());
    ...
    public void replyListing() throws Exception {
        ...
        for (TopicInfo topic : new TopicInfo[] {siteT1, nodeT1}) {
            ...
            assertEquals(
                    reply1_1.getNodeRef(), pr.getReplies().get(0).getReplies().get(0).getNodeRef());
            assertEquals(
                    reply1_2.getNodeRef(), pr.getReplies().get(0).getReplies().get(1).getNodeRef());
            assertEquals(
                    reply1_3.getNodeRef(), pr.getReplies().get(0).getReplies().get(2).getNodeRef());
            ...
            assertEquals(
                    reply1_2_1.getNodeRef(),
                    pr1.getReplies().get(1).getReplies().get(0).getNodeRef());
            assertEquals(
                    reply1_2_2.getNodeRef(),
                    pr1.getReplies().get(1).getReplies().get(1).getNodeRef());
            assertEquals(
                    reply1_3_1.getNodeRef(),
                    pr1.getReplies().get(2).getReplies().get(0).getNodeRef());
            ...
            assertEquals(
                    reply1_3_1_1_1.getNodeRef(),
                    rp1_3_1.getReplies().get(0).getReplies().get(0).getNodeRef());
            ...
            assertEquals(
                    reply1_3_1_1_1.getNodeRef(),
                    pr.getReplies().get(0).getReplies().get(0).getNodeRef());
            assertEquals(0, pr.getReplies().get(0).getReplies().get(0).getReplies().size());
        }
    }
                    ...
                    public Void execute() throws Throwable {
                        ...
                        NodeRef container =
                                SITE_SERVICE.getContainer(
                                        TEST_SITE_NAME, DiscussionServiceImpl.DISCUSSION_COMPONENT);
    ...
    public void tagging() throws Exception {
        ...
        // Check
        when(TAGGING_SERVICE.getTags(topic.getNodeRef()))
    ...
    public void discussionsHotTopicsListing() throws Exception {
        ...
        topics =
                DISCUSSION_SERVICE.listHotTopics(
                        DISCUSSION_SITE.getShortName(), fourDaysAgo, paging);
        assertEquals(0, topics.getPage().size());
        ...
        // Create some topics
        TopicInfo topicSA =
                DISCUSSION_SERVICE.createTopic(DISCUSSION_SITE.getShortName(), "Title1A");
        TopicInfo topicSB =
                DISCUSSION_SERVICE.createTopic(DISCUSSION_SITE.getShortName(), "Title1B");
        ...
        topics =
                DISCUSSION_SERVICE.listHotTopics(DISCUSSION_SITE.getShortName(), yesterday, paging);
        assertEquals(1, topics.getPage().size());
        assertEquals(topicSA.getTitle(), topics.getPage().get(0).getFirst().getTitle());
        assertEquals(1, topics.getPage().get(0).getSecond().intValue());
    ...
    /**
     * Checks that the correct permission checking occurs on fetching topic and post listings (which
     * go through canned queries)
     */
    @Test
    public void discussionsListingPermissionsChecking() throws Exception {
        ...
        topics =
                DISCUSSION_SERVICE.listTopics(
                        ALTERNATE_DISCUSSION_SITE.getShortName(), true, paging);
        assertEquals(0, topics.getPage().size());
        ...
        assertEquals(
                false, SITE_SERVICE.isMember(ALTERNATE_DISCUSSION_SITE.getShortName(), TEST_USER));
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        SITE_SERVICE.setMembership(
                                ALTERNATE_DISCUSSION_SITE.getShortName(),
                                TEST_USER,
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        SITE_SERVICE.removeMembership(
                                ALTERNATE_DISCUSSION_SITE.getShortName(), TEST_USER);
                        AuthenticationUtil.setFullyAuthenticatedUser(TEST_USER);
                        return null;
                    }
                });
    ...
    public void alf_9460() {
        ...
        for (TopicInfo topic : new TopicInfo[] {siteTopic, nodeTopic}) {
            ...
            List<AssociationRef> assocs =
                    PUBLIC_NODE_SERVICE.getTargetAssocs(
                            reply.getNodeRef(), ContentModel.ASSOC_REFERENCES);
    ...
    private void pushAuditableDatesBack(
            final Object thing, final int createdDaysAgo, final int modifiedDaysAgo)
            throws Exception {
        NodeRef tmpNodeRef;
        ...
        final Date created =
                (Date) PUBLIC_NODE_SERVICE.getProperty(node, ContentModel.PROP_CREATED);
        final Date newCreated = new Date(created.getTime() - createdDaysAgo * ONE_DAY_MS);
        final Date modified =
                (Date) PUBLIC_NODE_SERVICE.getProperty(node, ContentModel.PROP_MODIFIED);
        ...
        TRANSACTION_HELPER.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                newModified,
                                NODE_SERVICE.getProperty(node, ContentModel.PROP_MODIFIED));
                        assertEquals(
                                newModified,
                                PUBLIC_NODE_SERVICE.getProperty(node, ContentModel.PROP_MODIFIED));
                        return null;
                    }
                },
                false,
    ...
    private static void createTestSites() throws Exception {
        final DiscussionServiceImpl privateDiscussionService =
                (DiscussionServiceImpl) testContext.getBean("discussionService");
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<SiteInfo>() {
                            ...
                            public SiteInfo execute() throws Throwable {
                                SiteInfo site =
                                        SITE_SERVICE.createSite(
                                                TEST_SITE_PREFIX,
                                                DiscussionServiceImplTest.class.getSimpleName()
                                                        + "_testSite"
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            ...
                            public NodeRef execute() throws Throwable {
                                NodeRef node =
                                        NODE_SERVICE
                                                .createNode(
                                                        DISCUSSION_SITE.getNodeRef(),
                                                                ForumModel.ASSOC_DISCUSSION,
                                                        QName.createQName("Forum"),
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        if (!TENANT_ADMIN_SERVICE.existsTenant(TENANT_DOMAIN)) {
                            TENANT_ADMIN_SERVICE.createTenant(
                                    TENANT_DOMAIN, "password".toCharArray());
                        }
                        return null;
                    }
                });
