...
public class ActivityPostServiceImpl implements ActivityPostService {
  ...
  public void setIgnoredActivityTypes(String ignoredActivityTypes) {
    if (ignoredActivityTypes != null && ignoredActivityTypes.length() > 0) {
      this.ignoredActivityTypes =
        Arrays.asList(ignoredActivityTypes.split(","));
    }
  }
  ...
  private void postActivity(
    ...
    try {
      ...
      if (
        ignoredActivityTypes != null &&
        ignoredActivityTypes.contains(activityType)
      ) {
      ...
      eventPublisher.publishEvent(
        new EventPreparator() {
          ...
          public Event prepareEvent(
            ...
            String filename = null, nodeType = null, mime = null, encoding =
              null;
            long size = 0l;
            ...
            if (fileInfo != null) {
              if (logger.isDebugEnabled()) {
                logger.debug(
                  "Enhancing the Activity Event with fileInfo provided for node " +
                  nodeId
                );
              }
