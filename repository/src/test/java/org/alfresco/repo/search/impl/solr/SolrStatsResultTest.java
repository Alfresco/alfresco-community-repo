...
public class SolrStatsResultTest {
  ...
  public void testSolrStatsResultDateFormat() throws JSONException {
    ...
    assertEquals(
      "2011-03-03",
      SolrStatsResult.formatAsDate("2011-03-03T10:34:53.551Z")
    );
    assertEquals(
      "2014-05-12",
      SolrStatsResult.formatAsDate("2014-05-12T16:26:53.292Z")
    );
  }

  private SolrStatsResult testProcessing(
    String testData,
    long queryTime,
    int statsSize,
    long numberFound
