...
public class RecordsEntityResource
  ...
  @WebApiDescription(
    title = "File record",
    description = "File a record into fileplan."
  )
  public Record fileRecord(
    ...
    NodeRef record = apiUtils.validateRecord(recordId);
    NodeRef targetRecordFolder = apiUtils.lookupAndValidateNodeType(
    ...
    if (
      RecordsManagementModel.TYPE_RECORD_FOLDER.equals(
        nodeService.getType(primaryParent)
      )
    ) {
      ...
      try {
        ...
        throw new ConcurrencyFailureException(
          "The record was deleted while filing it",
          e
        );
      }
    }
  ...
  @WebApiDescription(
    title = "Update record",
    description = "Updates a record with id 'recordId'"
  )
  ...
  @WebApiDescription(
    title = "Delete record",
    description = "Deletes a record with id 'recordId'"
  )
