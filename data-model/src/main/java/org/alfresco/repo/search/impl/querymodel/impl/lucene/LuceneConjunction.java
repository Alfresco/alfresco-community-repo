...
/** @author andyh */
public class LuceneConjunction<Q, S, E extends Throwable> extends BaseConjunction
    ...
    public Q addComponent(
        ...
        QueryParserExpressionAdaptor<Q, E> expressionAdaptor =
            ...
            if (constraint instanceof LuceneQueryBuilderComponent) {
                ...
                Q constraintQuery =
                        luceneQueryBuilderComponent.addComponent(
                                selectors, functionArgs, luceneContext, functionContext);
