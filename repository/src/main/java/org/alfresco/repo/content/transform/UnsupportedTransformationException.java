 ...
 * Normally the transformer is a component of a pipeline transformer and has been asked to transform
 * a file that is too large as the size of the intermediate file is unknown at the start.
 *
 * @author Alan Davis
 */
