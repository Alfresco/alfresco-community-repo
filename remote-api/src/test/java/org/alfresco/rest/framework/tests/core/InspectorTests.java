...
public class InspectorTests {
  ...
  public void testInspectEntity() {
    ...
    assertTrue(
      "SheepNoActionEntityResource has no actions.",
      metainfo.isEmpty()
    );
    ...
    assertNotNull(metaData);
    assertNotNull(
      "GoatEntityResource supports GET",
      metaData.getOperation(HttpMethod.GET)
    );
    ...
    assertNotNull(metaData);
    assertNotNull(
      "FlockEntityResource supports GET",
      metaData.getOperation(HttpMethod.GET)
    );
    assertNotNull(
      "FlockEntityResource supports PUT",
      metaData.getOperation(HttpMethod.PUT)
    );
    assertNotNull(
      "FlockEntityResource supports DELETE",
      metaData.getOperation(HttpMethod.DELETE)
    );
    assertNull(
    ...
    assertNotNull(metaData);
    assertNotNull(
      "MultiPartTestEntityResource support POST",
      metaData.getOperation(HttpMethod.POST)
    );
    assertNull(
  ...
  public void testInspectRelationship() {
    ...
    assertNotNull(metaData);
    assertNotNull(
      "SheepBlackSheepResource supports GET",
      metaData.getOperation(HttpMethod.GET)
    );
    ResourceOperation op = metaData.getOperation(HttpMethod.GET);
    List<ResourceParameter> params = op.getParameters();
    assertTrue(
      "readAll method should have 1 url param and 3 query params",
      params.size() == 4
    );
    assertNotNull(
      "SheepBlackSheepResource supports PUT",
      metaData.getOperation(HttpMethod.PUT)
    );
    op = metaData.getOperation(HttpMethod.PUT);
    ...
    assertNotNull(
      "SheepBlackSheepResource supports POST",
      metaData.getOperation(HttpMethod.POST)
    );
    op = metaData.getOperation(HttpMethod.POST);
    params = op.getParameters();
    ...
    params = op.getParameters();
    assertTrue(
      "DELETE method on a relations should have 2 url params.",
      params.size() == 2
    );

    metainfo =
      ResourceInspector.inspect(MultiPartTestRelationshipResource.class);
    assertTrue("Must be one ResourceMetadata", metainfo.size() == 1);
    metaData = metainfo.get(0);
    assertNotNull(metaData);
    assertNotNull(
  ...
  public void testEmbeddedAnnotation() {
    Map<String, Pair<String, Method>> embeds = ResourceInspector.findEmbeddedResources(
      Farmer.class
    );
  ...
  public void testWebDeletedAnnotationOnMethods() {
    ...
    assertNotNull(
      "This method is overriden but not deleted so should be found.",
      aMethod
    );
  ...
  public void testInspectOperation() {
    ...
    assertNotNull(op);
    assertTrue(
      op.getTitle().startsWith("Missing @WebApiDescription annotation")
    );
    ...
    assertTrue(
      "readById method should have 1 url param",
      op.getParameters().size() == 1
    );
    ResourceParameter singleParam = op.getParameters().get(0);
    assertTrue(
      ResourceParameter.KIND.URL_PATH.equals(singleParam.getParamType())
    );
    assertFalse(
  ...
  public void testInspectOperations()
    ...
    for (ResourceMetadata resourceMetadata : metainfo) {
      assertEquals(
        ResourceMetadata.RESOURCE_TYPE.OPERATION,
      ...
      String result = null;
      final WithResponse wr = new WithResponse(
        Status.STATUS_OK,
      ...
      switch (resourceMetadata.getUniqueId()) {
        case "/-root-/{id}/grow":
          ...
          result =
            (String) ResourceInspectorUtil.invokeMethod(
              actionMethod,
              grassEntityResource,
              "xyz",
              paramObj,
              Params.valueOf("notUsed", null, mock(WebScriptRequest.class)),
              wr
            );
  ...
  public void testInspectRelationshipProperties() {
    List<ResourceMetadata> metainfo = ResourceInspector.inspect(
      GoatRelationshipResource.class
    );
    ...
    for (ResourceMetadata resourceMetadata : metainfo) {
      ...
      if ("/myroot/{id}/photo".equals(resourceMetadata.getUniqueId())) {
        ...
        if ("/myroot/{id}/album".equals(resourceMetadata.getUniqueId())) {
          ...
          if (
            "/myroot/{id}/madeUpProp".equals(resourceMetadata.getUniqueId())
          ) {
            assertNotNull(
              "FlocketEntityResource supports GET",
              resourceMetadata.getOperation(HttpMethod.GET)
  ...
  public void testWebDeletedAnnotationOnClass() {
    List<ResourceMetadata> metainfo = ResourceInspector.inspect(
      GrassEntityResourceNowDeleted.class
    );
  ...
  public void testValidSuccessCode() {
    ...
    assertEquals(
      ...
      ResourceInspector.validSuccessCode(
        HttpMethod.GET,
        ResourceOperation.UNSET_STATUS
      )
    );
    assertEquals(
