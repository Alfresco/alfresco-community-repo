...
public class AdHocRecordableVersionsTest extends RecordableVersionsBaseTest {
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(dmCollaborator) {
                    ...
                    public void given() throws Exception {
                        ...
                        versionProperties.put(VersionModel.PROP_VERSION_TYPE, VersionType.MINOR);
                        versionProperties.put(
                                RecordableVersionServiceImpl.KEY_RECORDABLE_VERSION, false);
                        versionProperties.put(RecordableVersionServiceImpl.KEY_FILE_PLAN, filePlan);
                    }
    ...
    public void testNoFilePlan() {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(AlfrescoRuntimeException.class, dmCollaborator) {
                    private Map<String, Serializable> versionProperties;
    ...
    /**
     * Test recorded version with record metadata aspect (want to ensure additional non-rm URI
     * properties and aspects don't find their way into the frozen state)
     */
                        ...
                        AuthenticationUtil.runAs(
                                new RunAsWork<Void>() {
                                    public Void doWork() throws Exception {
                                        ...
                                        NodeRef record =
                                                recordableVersionService.getVersionRecord(version);
                                        assertNotNull(record);
                                        recordService.addRecordType(
                                                record, TestModel.ASPECT_RECORD_METADATA);
                                        nodeService.setProperty(
                                                record,
                                                TestModel.PROPERTY_RECORD_METADATA,
                                                "Peter Wetherall");
