...
public class FieldProcessorRegistry {
    ...
    /**
     * Attempts to build a {@link Field}. The method first tries to derive a key from the fieldname,
     * then uses this key to look up a {@link FieldProcessor}. This {@link FieldProcessor} is then
     * used to generate a {@link Field}.
     *
     ...
     * @return The FieldProcessor implementation for the field or null if there isn't one
     *     regsitered.
     */
     ...
     *
     * @param fieldName String
     * @return <code>true</code> if the defaultProcessor should be used, otherwise <code>false
     *     </code>.
     */
