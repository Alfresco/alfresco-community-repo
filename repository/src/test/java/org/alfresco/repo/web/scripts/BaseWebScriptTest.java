...
public abstract class BaseWebScriptTest extends TestCase {
    ...
    public static class BaseWebScriptTestListener extends ResultPrinter
        ...
        public void startTest(Test test) {
            ...
            getWriter()
                    .println(
                            "*** Test started: "
                                    + ((BaseWebScriptTest) test).getName()
                                    + " (remote: "
                                    + (((BaseWebScriptTest) test).getRemoteServer() != null));
        }
    ...
    /**
     * Returns the custom {@link ServletAuthenticatorFactory} which is injected into an {@link
     * TestWebScriptServer} instances that are returned, if any. Default is not to alter the {@link
    ...
    /**
     * Sets that a custom {@link ServletAuthenticatorFactory} should be injected into instances of
     * {@link TestWebScriptServer} returned from {@link #getServer()}
     */
    public void setCustomAuthenticatorFactory(
            ServletAuthenticatorFactory customAuthenticatorFactory) {
    ...
    protected void setUp() throws Exception {
        ...
        if (remoteServer != null) {
            ...
            httpClient
                    .getParams()
                    .setBooleanParameter(HttpClientParams.PREEMPTIVE_AUTHENTICATION, true);
                ...
                httpClient
                        ...
                        .setCredentials(
                                ...
                                new UsernamePasswordCredentials(
                                        remoteServer.username, remoteServer.password));
            }
        }
    }
