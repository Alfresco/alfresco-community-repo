...
public class SolrFacetConfigAdminPut extends AbstractSolrFacetConfigAdminWebScript {
    ...
    protected Map<String, Object> unprotectedExecuteImpl(
        ...
        try {
            if (relativePosString != null) {
                ...
                if (filterId == null) {
                    throw new WebScriptException(
                            Status.STATUS_BAD_REQUEST, "Illegal null filterId");
                }
                ...
                try {
                    ...
                    List<String> reorderedIDs =
                            CollectionUtils.moveRight(relativePos, filterId, facetIDs);
                    ...
                    throw new WebScriptException(
                            Status.STATUS_NOT_FOUND, "Unrecognised filter ID: " + ufi.getFacetId());
                }
            }
            ...
            throw new WebScriptException(
                    Status.STATUS_BAD_REQUEST, "Could not update the facet configuration.", t);
        }
    ...
    private SolrFacetProperties parseRequestForFacetProperties(WebScriptRequest req) {
        ...
        try {
            ...
            final String displayControl =
                    getValue(String.class, json.opt(PARAM_DISPLAY_CONTROL), null);
            ...
            final int minFilterValueLength =
                    getValue(Integer.class, json.opt(PARAM_MIN_FILTER_VALUE_LENGTH), -1);
