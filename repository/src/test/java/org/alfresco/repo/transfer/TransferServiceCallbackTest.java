...
public class TransferServiceCallbackTest extends TestCase {
    ...
    public void testCompleteSuccess() {
        ...
        TransferProgress[] statuses =
                new TransferProgress[] {status0, status1, status2, status3, status4};
    ...
    public void testSendContentFailed() {
        ...
        doThrow(new TransferException("Simulate failure to write content"))
                ...
                .sendManifest(any(Transfer.class), any(File.class), any(OutputStream.class));
        ...
        doAnswer(
                        new Answer<Object>() {
                            ...
                            public Object answer(InvocationOnMock invocation) throws Throwable {
                                ...
                                XMLTransferRequsiteWriter requisiteWriter =
                                        new XMLTransferRequsiteWriter(writer);
        ...
        doAnswer(
                        new Answer<Object>() {
                            ...
                            public Object answer(InvocationOnMock invocation) throws Throwable {
                                ...
                                Writer writer = new OutputStreamWriter(os);
                                XMLTransferDestinationReportWriter reportWriter =
                                        new XMLTransferDestinationReportWriter();
