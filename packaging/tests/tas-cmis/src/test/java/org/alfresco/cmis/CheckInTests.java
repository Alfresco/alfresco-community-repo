...
public class CheckInTests extends CmisTest {
  ...
  public void checkInDocumentWithMajorVersionAndWithContent() throws Exception {
    ...
    cmisApi
      ...
      .assertThat()
      .documentHasVersion(2.0);
    Utility.sleep(100, 5000, () -> cmisApi.assertThat().contentIs(newContent));
  }
  ...
  @Test(
    ...
    expectedExceptions = CmisVersioningException.class
  )
  ...
  public void getCheckInCommentForDocMajorVersion() throws Exception {
    ...
    cmisApi
      ...
      .contentIs(newContent)
      .assertThat()
      .hasCheckInCommentLastVersion(comment);
  }
  ...
  public void getCheckInCommentForDocWithMultipleVersions() throws Exception {
    ...
    cmisApi
      ...
      .and()
      .assertThat()
      .hasCheckInCommentForVersion(1.1, minorComment)
      .then()
      .checkOut()
      .prepareDocumentForCheckIn()
      .withMajorVersion()
      ...
      .and()
      .assertThat()
      .hasCheckInCommentForVersion(2.0, majorComment);
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void checkInDocumentCreatedWithVersioningStateCheckedOut()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void checkInDocumentWithProperties() throws Exception {
    ...
    cmisApi
      ...
      .and()
      .assertThat()
      .contentPropertyHasValue("cmis:description", "description after checkout")
      .assertThat()
      .contentPropertyHasValue("cmis:name", testFile.getName() + "-edit")
      .assertThat()
      .contentPropertyHasValue("cm:title", testFile.getName() + "-title");
  }
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanCheckInDocumentCreatedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, fileContent);
    cmisApi
      .authenticateUser(siteManager)
