 ...
 *
 */
public class ChildAssocRefResultSetRowIterator
  extends AbstractResultSetRowIterator {
  ...
  public ResultSetRow next() {
    return new ChildAssocRefResultSetRow(
      (ChildAssocRefResultSet) getResultSet(),
      moveToNextPosition()
    );
  }
