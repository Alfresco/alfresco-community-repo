 ...
 *
 * <p>The shared link id provides a short id that can be part of a short app url that is easy to
 * copy/paste/send (via email or other).
 *
 * <p>As of now, these shared links are public in that they provide unauthenticated access to the
 * node's content and limited metadata info, such as file name and last modifier/modification.
 *
 * <p>In the future, the QuickShareService *could* be enhanced to provide additional features, such
 * as link expiry &/or "password" protection, etc.
 *
 * @author janv
 */
