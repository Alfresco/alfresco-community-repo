...
public class SiteContainer
  implements Serializable, ExpectedComparison, Comparable<SiteContainer> {
  ...
  public static SiteContainer parseSiteContainer(
    String siteId,
    JSONObject json
  ) {
  ...
  public static ListResponse<SiteContainer> parseSiteContainers(
    ...
    ListResponse<SiteContainer> resp = new ListResponse<SiteContainer>(
      paging,
      siteContainers
    );
    return resp;
