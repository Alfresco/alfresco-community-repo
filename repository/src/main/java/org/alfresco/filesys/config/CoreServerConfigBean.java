...
public class CoreServerConfigBean {
     ...
     *
     * @param threadPoolInit the new thread pool init
     */
     ...
     *
     * @param threadPoolMax the new thread pool max
     */
     ...
     *
     * @param threadPoolDebug the new thread pool debug
     */
     ...
     *
     * @param memoryPacketSizes the new memory packet sizes
     */
