...
/**
 * A {@link CannedQueryFactory} for various queries relating to getting Topics with some information
 * on their Posts
 *
 * @author Nick Burch
 * @since 4.0
...
public class GetDiscussionTopcisWithPostsCannedQueryFactory
    ...
    public CannedQuery<NodeWithChildrenEntity> getCannedQuery(CannedQueryParameters parameters) {
        final GetDiscussionTopcisWithPostsCannedQuery cq =
                new GetDiscussionTopcisWithPostsCannedQuery(
