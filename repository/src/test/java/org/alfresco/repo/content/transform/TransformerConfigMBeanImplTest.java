...
public class TransformerConfigMBeanImplTest {
  ...
  public static void mockMimetypes(
    ...
    when(mimetypeService.getMimetypes())
      .thenReturn(new ArrayList<String>(allMimetypes));
  }
  ...
  public void getExtensionsAndMimetypesTest() {
    when(mimetypeService.getMimetypes(null))
      .thenReturn(
        Arrays.asList(new String[] { "application/pdf", "image/png" })
      );
  ...
  public void getTransformationsByExtensionTest() {
    ...
    assertEquals(
      "One result",
      mbean.getTransformationsByExtension("pdf", "png")
    );
  }
  ...
  public void getTransformationsByExtensionNullSourceTest() {
    setupForGetTransformationsByExtension();
    assertEquals(
      "Lots of results to png",
      mbean.getTransformationsByExtension(null, "PNG")
    );
  }
  ...
  public void getTransformationsByExtensionNullTargetTest() {
    setupForGetTransformationsByExtension();
    assertEquals(
      "Lots of results from pdf",
      mbean.getTransformationsByExtension("pdf", null)
    );
  }
  ...
  public void getTransformationLogZeroTest() {
    assertArrayEquals(
      new String[] { "No transformations to report" },
      mbean.getTransformationLog(5)
    );
  }
  ...
  public void testTransformAnyTransformerTest() {
    when(transformerDebug.testTransform("pdf", "png"))
      .thenReturn("debug output");
  ...
  public void testTransformAnyTransformerBadExtensionTest() {
    ...
    assertEquals(
      "Unknown source extension: bad",
      mbean.testTransform("bad", "png")
    );
  }
}
