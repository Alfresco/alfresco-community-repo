...
public class RuntimeExecBeansTest extends TestCase {
  ...
  public void testDeprecatedSetCommandMap() throws Exception {
    ...
    try {
      RuntimeExec deprecatedExec = (RuntimeExec) ctx.getBean(
        "commandCheckDeprecatedSetCommandMap"
      );
    ...
    logger.warn(
      "There should be a warning re. the use of deprecated 'setCommandMap'."
    );
  }
  ...
  public void testSplitArguments() throws Exception {
    ...
    try {
      RuntimeExec splitExec = (RuntimeExec) ctx.getBean(
        "commandSplitArguments"
      );
  ...
  public void testSplitArgumentsAsSingleValue() throws Exception {
    ...
    try {
      RuntimeExec splitExec = (RuntimeExec) ctx.getBean(
        "commandSplitArgumentsAsSingleValue"
      );
      assertNotNull(splitExec);
      String[] splitCommand = splitExec.getCommand();
      assertTrue(
  ...
  public void testFailureModeOfMissingCommand() {
    ...
    try {
      RuntimeExec failureExec = (RuntimeExec) ctx.getBean(
        "commandFailureGuaranteed"
      );
      assertNotNull(failureExec);
      // Execute it
      ExecutionResult result = failureExec.execute();
      assertEquals(
        "Expected first error code in list",
        666,
        result.getExitValue()
      );
    } finally {
