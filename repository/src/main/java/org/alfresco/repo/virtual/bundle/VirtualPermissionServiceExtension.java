...
public class VirtualPermissionServiceExtension
    ...
    public NodePermissionEntry getSetPermissions(NodeRef nodeRef) {
        ...
        if (reference == null) {
            ...
            if (nodeToAdhereTo != null) {
                NodePermissionEntry actualSetPermissions =
                        theTrait.getSetPermissions(nodeToAdhereTo);
            ...
            List<? extends PermissionEntry> virtualPermissionEntries =
                    virtualSetPermissions.getPermissionEntries();
            ...
            for (PermissionEntry permissionEntry : actualPermissionEntries) {
                if (!overridenPermissions.contains(
    ...
    private NodeRef establishPermisisonAdherence(Reference reference) {
        NodeRef nodeToAdhereTo =
                smartStore.adhere(reference, VirtualStore.FILING_OR_MATERIAL_ADHERENCE);
    ...
    public NodePermissionEntry explainPermission(NodeRef nodeRef, PermissionReference perm) {
        return getTrait().explainPermission(smartStore.materializeIfPossible(nodeRef), perm);
    }
    ...
    public Set<AccessPermission> getPermissions(NodeRef nodeRef) {
        ...
        if (reference == null) {
            ...
            Set<AccessPermission> virtualSetPermissions =
            ...
            if (nodeToAdhereTo != null) {
                Set<AccessPermission> actualSetPermissions =
                        theTrait.getPermissions(nodeToAdhereTo);
