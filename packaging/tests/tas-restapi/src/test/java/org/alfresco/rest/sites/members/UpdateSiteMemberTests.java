...
public class UpdateSiteMemberTests extends RestTest {
  ...
  public void collaboratorIsNotAbleToUpdateSiteMember() throws Exception {
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          "The current user does not have permissions to modify the membership details of the site %s.",
          publicSite.getTitle()
        )
      );
  }
  ...
  public void collaboratorIsNotAbleToUpdateSiteMemberWithTheSameRole()
    throws Exception {
    userToBeUpdated = dataUser.createRandomTestUser();
    dataUser.addUserToSite(userToBeUpdated, publicSite, UserRole.SiteConsumer);
  ...
  public void unauthenticatedUserIsNotAuthorizedToUpdateSiteMmeber()
    throws Exception {
    userToBeUpdated = dataUser.createRandomTestUser();
    dataUser.addUserToSite(userToBeUpdated, publicSite, UserRole.SiteConsumer);
    userToBeUpdated.setUserRole(UserRole.SiteCollaborator);
  ...
  public void updateSiteMemberOfNonexistentSite() throws Exception {
    SiteModel deletedSite = dataSite
      .usingUser(adminUser)
  ...
  public void updateSiteMemberUsingInvalidRole() throws Exception {
    ...
    UserModel siteConsumer = publicSiteUsers.getOneUserWithRole(
      UserRole.SiteConsumer
    );
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.UNKNOWN_ROLE, "invalidRole")
      );
  }
  ...
  public void managerUpdateSiteContributorToSiteManager() throws Exception {
    UserModel siteContributor = publicSiteUsers.getOneUserWithRole(
      UserRole.SiteContributor
    );
  ...
  public void managerUpdateSiteCollaboratorToSiteManager() throws Exception {
    UserModel siteCollaborator = publicSiteUsers.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
  ...
  public void publicSiteManagerDowngradesRole() throws Exception {
    UserModel siteManager = publicSiteUsers.getOneUserWithRole(
      UserRole.SiteManager
    );
  ...
  public void managerUpdateSiteContributorToSiteCollaborator()
    throws Exception {
  ...
  public void managerUpdateSiteCollaboratorToSiteContributor()
    throws Exception {
  ...
  public void managerUpdateSiteCollaboratorToSiteCollaborator()
    throws Exception {
    UserModel siteCollaborator = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      siteCollaborator,
  ...
  public void managerCanNotUpdateUserWithSiteMembershipRequest()
    throws Exception {
    UserModel siteConsumer = dataUser.createRandomTestUser();
    siteConsumer.setUserRole(UserRole.SiteConsumer);
    restClient
