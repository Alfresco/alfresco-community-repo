 ...
 *
 * <p>A valid version number string can be made up of any number of numberical parts all delimited
 * by '.'.
 *
...
public final class VersionNumber implements Comparable<VersionNumber>, Serializable {
     ...
     *
     * <p>A AlfrescoRuntimeException will be throw if an invalid version is encountered.
     *
    ...
    /**
     * Compares the passed version to this. Determines whether they are equal, greater or less than
     * this version.
     *
     * @param obj the other version number
     * @return -1 if the passed version is less that this, 0 if they are equal, 1 if the passed
     *     version is greater
     */
    ...
    /**
     * Helper method to the the part based on the index, if an invalid index is supplied 0 is
     * returned.
     *
