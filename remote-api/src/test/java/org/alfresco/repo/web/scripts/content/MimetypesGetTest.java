...
public class MimetypesGetTest extends BaseWebScriptTest {
    ...
    protected void setUp() throws Exception {
        ...
        localTransformServiceRegistry =
                (LocalTransformServiceRegistry) ctx.getBean("localTransformServiceRegistry");
    }

    /**
     * Tests the <code>mimetypesGet.getTransformer</code> method directly for varefication of label
     * text
     *
     * @throws Exception
     */
    public void testGetTransformer() throws Exception {
        ...
        String transformerName =
                mimetypesGet.getTransformer(
                        MimetypeMap.MIMETYPE_PDF, 1000, MimetypeMap.MIMETYPE_PDF);
        assertEquals("PassThrough", transformerName);

        transformerName =
                mimetypesGet.getTransformer(
                        MimetypeMap.MIMETYPE_PDF, 1000, MimetypeMap.MIMETYPE_TEXT_PLAIN);
