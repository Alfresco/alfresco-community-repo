...
/*package*/class ClassBehaviourIndex<B extends ClassBehaviourBinding>
    ...
    this.serviceMap.addChangeObserver(
        new BehaviourChangeObserver<ServiceBehaviourBinding>() {
          public void addition(
            ServiceBehaviourBinding binding,
            Behaviour behaviour
          ) {
            for (BehaviourChangeObserver<B> listener : observers) {
  ...
  public Collection<BehaviourDefinition> getAll() {
    ...
    try {
      List<BehaviourDefinition> all = new ArrayList<BehaviourDefinition>(
        classMap.size() + serviceMap.size()
      );
   ...
   */
  public void putServiceBehaviour(
    BehaviourDefinition<ServiceBehaviourBinding> behaviour
  ) {
    LockHelper.tryLock(
      lock.writeLock(),
      tryLockTimeout,
