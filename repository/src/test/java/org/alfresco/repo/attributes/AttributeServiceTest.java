...
public class AttributeServiceTest extends TestCase {
  ...
  private static final Serializable[] KEY_AAA = new Serializable[] {
    "a",
    "a",
    "a",
  };
  private static final Serializable[] KEY_AAB = new Serializable[] {
    "a",
    "a",
    "b",
  };
  private static final Serializable[] KEY_AAC = new Serializable[] {
    "a",
    "a",
    "c",
  };
  ...
  public void testKeySegmentsGuaranteeUniqueness() {
    ...
    final NodeRef KEY_NODEREF = new NodeRef(
      "workspace://SpacesStore/5980bbdb-8a31-437e-95c8-d5092c3c58fc"
    );
    ...
    try {
      ...
      try {
        ...
        fail(
          "Keys of SERIALIZABLE persisted type are not allowed because it cannot guarantee uniqueness"
        );
      } catch (IllegalArgumentException expected) {}
    } finally {
