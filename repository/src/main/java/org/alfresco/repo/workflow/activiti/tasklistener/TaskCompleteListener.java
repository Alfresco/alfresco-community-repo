 ...
 *
 * <p>This will set a few properties on the task, indicating it is complete and preparing it for
 * historic usage.
 *
...
public class TaskCompleteListener implements TaskListener {
    ...
    private void addPooledActorsAsVariable(DelegateTask task, Map<String, Object> variables) {
        ...
        if (links.size() > 0) {
            ...
            List<NodeRef> pooledActorRefs =
                    propertyConverter.getPooledActorsReference(identityLinks);
