...
public class FileImporterTest extends TestCase {
  ...
  public static final void main(String[] args) throws Exception {
    ...
    Boolean txnPerFile = args.length > 5
      ...
      try {
        ...
        if (!test.nodeService.exists(spacesStore)) {
          test.nodeService.createStore(
            spacesStore.getProtocol(),
            spacesStore.getIdentifier()
          );
        }
        ...
        System.out.println(
          "Committed in: " + ((end - start) / 1000000.0) + "ms"
        );
        double total = ((first + second) / 1000000.0);
        System.out.println("Grand Total: " + grandTotal);
        System.out.println(
          "Imported: " + importCount + " files or directories"
        );
        System.out.println(
