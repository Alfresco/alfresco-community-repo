 ...
 * @since Odin
 */
public class OAuth2CredentialsInfoImpl extends AbstractCredentialsImpl
        implements OAuth2CredentialsInfo {
    ...
    public OAuth2CredentialsInfoImpl(
            NodeRef nodeRef, String remoteSystemName, NodeRef remoteSystemContainerNodeRef) {
