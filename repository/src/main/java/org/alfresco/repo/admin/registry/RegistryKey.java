...
public class RegistryKey implements Serializable {
  ...
  static final String REGISTRY_1_0_URI =
    "http://www.alfresco.org/system/registry/1.0";
    ...
    for (String element : elements) {
      if (element == null || element.length() == 0) {
        throw new IllegalArgumentException(
          "Key elements may not be empty or null"
        );
      }
  ...
  public RegistryKey(String namespaceUri, String... key) {
    ...
    if (length == 0) {
      throw new IllegalArgumentException(
        "No value supplied for the RegistryKey property"
      );
    }
  ...
  public RegistryKey(String namespaceUri, String[] path, String property) {
    ...
    if ((path == null || path.length == 0) && property == null) {
      throw new IllegalArgumentException(
        "No path or property supplied for the RegistryKey"
      );
    }
  ...
  public String toString() {
    ...
    sb
      .append("RegistryKey")
      .append("[ ")
      .append(RegistryKey.buildPathString(path))
      .append("/")
      .append(property)
      .append(" ]");
    return sb.toString();
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((namespaceUri == null) ? 0 : namespaceUri.hashCode());
