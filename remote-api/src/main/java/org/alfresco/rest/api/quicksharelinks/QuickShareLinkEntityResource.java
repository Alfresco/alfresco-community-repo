...
public class QuickShareLinkEntityResource
  ...
  @Override
  @WebApiDescription(
    title = "Get shared link info",
    description = "Return limited metadata for shared link"
  )
  @WebApiNoAuth
  ...
  @Override
  @WebApiDescription(
    title = "Download shared link content",
    description = "Download content for shared link"
  )
  @WebApiNoAuth
  @BinaryProperties({ "content" })
  public BinaryResource readProperty(String sharedId, Parameters parameters)
    throws EntityNotFoundException {
  ...
  @WebApiDescription(
    ...
    description = "Delete the shared link"
  )
  ...
  @WebApiDescription(
    ...
    description = "Create a new unique system-generated shared (link) id"
  )
  public List<QuickShareLink> create(
    List<QuickShareLink> nodeIds,
  ...
  @Override
  @WebApiDescription(
    title = "Find shared links",
    description = "Find ('search') & return result set of shared links"
  )
  public CollectionWithPagingInfo<QuickShareLink> readAll(
    Parameters parameters
  ) {
