...
public interface QueryCollection {
    ...
    /**
     * Return the mechanism that this query definition uses to map namespace prefixes to URIs. A
     * query may use a predefined set of prefixes for known URIs. I would be unwise to rely on the
     * defaults.
     *
