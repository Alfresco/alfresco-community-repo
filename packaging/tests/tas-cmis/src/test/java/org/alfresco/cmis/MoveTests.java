...
public class MoveTests extends CmisTest {
  ...
  public void siteManagerMovesFolderStructure() throws Exception {
    ...
    cmisApi
      ...
      .assertThat()
      .existsInRepo()
      .createFolder(sourceParentFolder)
      .and()
      .assertThat()
      .existsInRepo()
      .then()
      .usingResource(sourceParentFolder)
      .createFile(sourceFile)
      .and()
      .assertThat()
      .existsInRepo()
      ...
      .and()
      .assertThat()
      .hasChildren(sourceFile, subFolder);
  }
  ...
  public void contributorCanMoveFolderCreatedBySelf() throws Exception {
    ...
    cmisApi
      ...
      .usingSite(publicSite)
      .assertThat()
      .doesNotHaveFolder(sourceFolder);
  }
  ...
  public void collaboratorCannotMoveDocumentCreatedByManager()
    throws Exception {
    sourceFile =
      dataContent
        .usingUser(siteManager)
  ...
  public void unauthorizedUserCannotMoveDocumentFromPrivateSite()
    throws Exception {
  ...
  public void unauthorizedUserCannotMoveFolderFromPrivateSite()
    throws Exception {
    SiteModel privateSite = dataSite
      .usingUser(siteManager)
      .createPrivateRandomSite();
  ...
  public void unauthorizedUserCannotMoveDocumentFromModeratedSite()
    throws Exception {
  ...
  public void unauthorizedUserCannotMoveFolderFromModeratedSite()
    throws Exception {
    SiteModel moderatedSite = dataSite
      .usingUser(siteManager)
      .createModeratedRandomSite();
