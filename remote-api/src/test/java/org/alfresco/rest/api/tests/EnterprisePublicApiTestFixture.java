...
public class EnterprisePublicApiTestFixture extends EnterpriseTestFixture {
  ...
  public static final String[] CLASS_LOCATIONS = new String[] {
    "classpath*:/publicapi/lucene/",
  };
   ...
   */
  public static synchronized EnterprisePublicApiTestFixture getInstance(
  ...
  protected JettyComponent makeJettyComponent() {
    JettyComponent jettyComponent = new EnterpriseJettyComponent(
      getPort(),
      getContextPath(),
      getConfigLocations(),
      getClassLocations()
