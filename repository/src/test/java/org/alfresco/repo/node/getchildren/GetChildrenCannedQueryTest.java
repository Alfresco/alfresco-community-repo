...
public class GetChildrenCannedQueryTest extends TestCase {
  ...
  private static QName TEST_CONTENT_SUBTYPE = QName.createQName(
  ...
  private static final String CQ_FACTORY_NAME =
    "fileFolderGetChildrenCannedQueryFactory";
  ...
  public void setUp() throws Exception {
    ...
    getChildrenCannedQueryFactory.setBeanName(
      "fileFolderGetChildrenCannedQueryFactory"
    );
    ...
    getChildrenCannedQueryFactory.setLocaleDAO(
      (LocaleDAO) ctx.getBean("localeDAO")
    );
    ...
    getChildrenCannedQueryFactory.setQnameDAO(
      (QNameDAO) ctx.getBean("qnameDAO")
    );
    getChildrenCannedQueryFactory.setHiddenAspect(
      (HiddenAspect) ctx.getBean("hiddenAspect")
    );

    getChildrenCannedQueryFactory.setMethodSecurity(
      (MethodSecurityBean<NodeRef>) ctx.getBean(
        "FileFolderService_security_list"
      )
    );
    ...
    fiveStarRatingScheme =
      ratingService.getRatingScheme("fiveStarRatingScheme");
    ...
    if (!setupTestData) {
      ...
      NodeRef testParentFolder = getOrCreateParentTestFolder(
        "GetChildrenCannedQueryTest-" + TEST_RUN_ID
      );
    ...
    NodeRef testFolder = createFolder(
      repositoryHelper.getCompanyHome(),
      "GetChildrenCannedQueryTest-testFolder-" + TEST_RUN_ID,
      QName.createQName(
        "http://www.alfresco.org/test/getchildrentest/1.0",
        "folder"
      )
    );
  ...
  private NodeRef getOrCreateParentTestFolder(String name) throws Exception {
    NodeRef testFolder = nodeService.getChildByName(
      repositoryHelper.getCompanyHome(),
  ...
  public void testSetup() throws Exception {
    NodeRef parentNodeRef = getOrCreateParentTestFolder(
      "GetChildrenCannedQueryTest-" + TEST_RUN_ID
    );
  ...
  public void testMaxItems() throws Exception {
    ...
    for (int i = 1; i <= totalCnt; i++) {
      ...
      if (logger.isInfoEnabled()) {
        logger.info(
          "testSimpleMaxItems: [itemCnt=" + i + ",hasMore=" + hasMore + "]"
        );
      }
    }
  }
  ...
  public void testTypeFiltering() throws Exception {
    ...
    PagingResults<NodeRef> results = list(
      parentNodeRef,
      -1,
      -1,
      0,
  ...
  public void testPrimaryVsSecondary() throws Exception {
    ...
    NodeRef parentNodeRef1 = createFolder(
      userHomeRef,
    ...
    NodeRef folder1Ref = createFolder(
      parentNodeRef1,
      FOLDER_1,
      ContentModel.TYPE_FOLDER
    );
    NodeRef folder2Ref = createFolder(
      parentNodeRef1,
      FOLDER_2,
      ContentModel.TYPE_FOLDER
    );
    ...
    NodeRef parentNodeRef2 = getOrCreateParentTestFolder(
      "GetChildrenCannedQueryTest-2-" + TEST_RUN_ID
    );

    NodeRef folder3Ref = createFolder(
      parentNodeRef2,
      FOLDER_3,
      ContentModel.TYPE_FOLDER
    );
  ...
  public void testPropertySorting() throws Exception {
    ...
    try {
      nodeRef1 =
        createContent(parentNodeRef, "rating1", ContentModel.TYPE_CONTENT);
      nodeRef2 =
        createContent(parentNodeRef, "rating2", ContentModel.TYPE_CONTENT);
      nodeRef3 =
        createContent(parentNodeRef, "rating3", ContentModel.TYPE_CONTENT);
      nodeRef4 =
        createContent(parentNodeRef, "rating4", ContentModel.TYPE_CONTENT);
      nodeRef5 =
        createContent(parentNodeRef, "rating5", ContentModel.TYPE_CONTENT);

      nodeRef6 =
        createContent(parentNodeRef, "rating6", ContentModel.TYPE_CONTENT);
      nodeRef7 =
        createContent(parentNodeRef, "rating7", ContentModel.TYPE_CONTENT);
      nodeRef8 =
        createContent(parentNodeRef, "rating8", ContentModel.TYPE_CONTENT);
      nodeRef9 =
        createContent(parentNodeRef, "rating9", ContentModel.TYPE_CONTENT);
      nodeRef10 =
        createContent(parentNodeRef, "rating10", ContentModel.TYPE_CONTENT);
    } finally {
    ...
    sortQNames.add(
      QName.createQName(
        NamespaceService.CONTENT_MODEL_1_0_URI,
        "fiveStarRatingSchemeCount"
      )
    );
    sortQNames.add(
      QName.createQName(
        NamespaceService.CONTENT_MODEL_1_0_URI,
        "likesRatingSchemeCount"
      )
    );
    ...
    List<Pair<QName, Boolean>> sortPairs = new ArrayList<Pair<QName, Boolean>>(
      3
    );
    ...
    try {
      ...
      sortPairs.add(
        new Pair<QName, Boolean>(ContentModel.PROP_DESCRIPTION, true)
      );
  ...
  public void testPatterns() throws Exception {
    ...
    NodeRef nodeRef4 = createContent(
      parentNodeRef,
      "page.component-1-4.user~admin~panel.xml",
      ContentModel.TYPE_CONTENT
    );
    NodeRef nodeRef5 = createContent(
      parentNodeRef,
      "page.component-1-4.user~admin~%dashboard.xml",
      ContentModel.TYPE_CONTENT
    );
  ...
  public void testRestrictByAssocType() throws Exception {
    ...
    childTypeQNames.clear();
    childTypeQNames.add(ContentModel.TYPE_CONTENT);
    List<NodeRef> children = filterByAssocTypeAndCheck(
      parentNodeRef,
      assocTypeQNames,
      childTypeQNames
    );
  ...
  public void testAspectFiltering() throws Exception {
    ...
    try {
      nodeRef1 =
        createContent(parentNodeRef, "node1", ContentModel.TYPE_CONTENT);
      nodeRef2 =
        createContent(parentNodeRef, "node2", ContentModel.TYPE_CONTENT);
      nodeRef3 =
        createContent(parentNodeRef, "node3", ContentModel.TYPE_CONTENT);
      nodeRef4 =
        createContent(parentNodeRef, "node4", ContentModel.TYPE_CONTENT);
      nodeRef5 =
        createContent(parentNodeRef, "node5", ContentModel.TYPE_CONTENT);

      nodeRef6 =
        createContent(parentNodeRef, "node6", ContentModel.TYPE_CONTENT);
      nodeRef7 =
        createContent(parentNodeRef, "node7", ContentModel.TYPE_CONTENT);
      nodeRef8 =
        createContent(parentNodeRef, "node8", ContentModel.TYPE_CONTENT);
      nodeRef9 =
        createContent(parentNodeRef, "node9", ContentModel.TYPE_CONTENT);
      nodeRef10 =
        createContent(parentNodeRef, "node10", ContentModel.TYPE_CONTENT);
    ...
    Set<QName> includedAspects = new HashSet<QName>(
      Arrays.asList(new QName[] { ContentModel.ASPECT_CLASSIFIABLE })
    );
    results = list(parentNodeRef, includedAspects, null, -1, -1, 0);
    assertEquals(3, results.getPage().size());

    Set<QName> excludedAspects = new HashSet<QName>(
      Arrays.asList(new QName[] { RenditionModel.ASPECT_RENDITION })
    );
    results = list(parentNodeRef, null, excludedAspects, -1, -1, 0);
    for (NodeRef result : results.getPage()) {
      assertFalse(
        nodeService.getAspects(result).contains(RenditionModel.ASPECT_RENDITION)
      );
    }
  ...
  private PagingResults<NodeRef> list(
    ...
    final GetChildrenCannedQuery cq = (GetChildrenCannedQuery) getChildrenCannedQueryFactory.getCannedQuery(
      parentNodeRef,
      pattern,
      null,
      null,
    ...
    CannedQueryResults<NodeRef> results = transactionService
    ...
    return new PagingNodeRefResultsImpl(
      nodeRefs,
  ...
  private void filterByTypeAndCheck(
    ...
    PagingResults<NodeRef> antiResults = list(
      parentNodeRef,
      -1,
      -1,
      0,
  ...
  private void filterByPropAndCheck(
    ...
    FilterProp filter = new FilterPropString(
      filterPropQName,
      filterVal,
      filterType
    );
  ...
  private void sortAndCheck(
    ...
    Collator collator = AlfrescoCollator.getInstance(
    ...
    for (NodeRef nodeRef : results.getPage()) {
      ...
      if (
        sortPropQName.equals(GetChildrenCannedQuery.SORT_QNAME_CONTENT_SIZE) ||
        ...
        sortPropQName.equals(GetChildrenCannedQuery.SORT_QNAME_NODE_TYPE)
      ) {
        val = nodeService.getType(nodeRef);
      } else if (
        sortPropQName.equals(GetChildrenCannedQuery.SORT_QNAME_NODE_IS_FOLDER)
      ) {
        val =
      ...
      if (prevVal == null) {
        ...
        String prevName = (String) nodeService.getProperty(
          prevNodeRef,
          ContentModel.PROP_NAME
        );
        String currName = (String) nodeService.getProperty(
          nodeRef,
          ContentModel.PROP_NAME
        );
  ...
  private class PagingNodeRefResultsImpl implements PagingResults<NodeRef> {
    ...
    public Pair<Integer, Integer> getTotalResultCount() {
      return new Pair<Integer, Integer>(
        totalResultCount,
        (isTotalResultCountCutoff ? null : totalResultCount)
      );
    }
  ...
  public void testPagingGetChildrenCannedQueryWithoutProps() throws Exception {
    try {
      ...
      System.out.println(
        "Test time: " + (System.currentTimeMillis() - startTime) + " ms"
      );
    } finally {
