...
public class NodeProtocol extends Protocol {
  ...
  @Override
  public Reference propagateNodeRefMutations(
    ...
    if (
      Version2Model.STORE_ID.equals(storeId) ||
      VersionModel.STORE_ID.equals(storeId) ||
      ...
      if (resource instanceof RepositoryResource) {
        ...
        if (location instanceof RepositoryNodeRef) {
          ...
          NodeRef nodeRefPropagation = new NodeRef(
            mutatedNodeRef.getStoreRef(),
            nodeRef.getId()
          );
          Resource resourcePropagation = new RepositoryResource(
            new RepositoryNodeRef(nodeRefPropagation)
          );
