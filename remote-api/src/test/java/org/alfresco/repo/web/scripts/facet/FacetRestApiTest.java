...
public class FacetRestApiTest extends BaseWebScriptTest {
    ...
    protected void setUp() throws Exception {
        ...
        personService =
                getServer().getApplicationContext().getBean("PersonService", PersonService.class);
        transactionHelper =
                getServer()
                        .getApplicationContext()
                    ...
                    public Void doWork() throws Exception {
                        ...
                        if (!authorityService
                                .getContainingAuthorities(
                                        AuthorityType.GROUP, SEARCH_ADMIN_USER, true)
                                .contains(
        ...
        AuthenticationUtil.runAs(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        sendRequest(
                                new PostRequest(
                                        POST_FACETS_URL, filter.toString(), "application/json"),
                                403);
                        return null;
                    }
                },
        ...
        AuthenticationUtil.runAs(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        sendRequest(
                                new PutRequest(
                                        PUT_FACETS_URL, jsonRsp.toString(), "application/json"),
                                403);
        ...
        AuthenticationUtil.runAs(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        // Note here that the last Facet JSON object *is* moved one place up the
                        // list.
                        assertEquals(
        ...
        AuthenticationUtil.runAs(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        response =
                                sendRequest(
                                        new GetRequest(GET_FACETS_URL + "/" + filterNameOne), 200);
                        JSONObject jsonRsp =
                                new JSONObject(new JSONTokener(response.getContentAsString()));
                        ...
                        List<String> expectedValues =
                                Arrays.asList(new String[] {"sit1", "site2", "site3"});
                        ...
                        response =
                                sendRequest(
                                        new GetRequest(GET_FACETS_URL + "/" + filterNameTwo), 200);
    ...
    /**
     * The REST API should accept both 'cm:name' and
     * '{http://www.alfresco.org/model/content/1.0}name' forms of filter IDs.
     */
        ...
        AuthenticationUtil.runAs(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        assertEquals(
                                "facet-menu.facet.modifiedValue", jsonRsp.getString("displayName"));
                        assertFalse(jsonRsp.getBoolean("isEnabled"));
                        ...
                        JSONObject retrievedBlockIncludeRequest =
                                retrievedCustomProp.getJSONObject("blockIncludeFacetRequest");
                        assertEquals(
                                "{http://www.alfresco.org/model/solrfacetcustomproperty/1.0}blockIncludeFacetRequest",
    ...
    public void testGetAllFacetableProperties() throws Exception {
        AuthenticationUtil.runAs(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        final Response rsp =
                                sendRequest(new GetRequest(GET_ALL_FACETABLE_PROPERTIES_URL), 200);

                        // For now, we'll only perform limited testing of the response as we
                        // primarily
                        ...
                        JSONArray properties =
                                data.getJSONArray(FacetablePropertiesGet.PROPERTIES_KEY);
