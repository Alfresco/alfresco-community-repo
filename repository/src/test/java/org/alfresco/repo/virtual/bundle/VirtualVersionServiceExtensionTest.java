...
public class VirtualVersionServiceExtensionTest extends VirtualizationIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        node2_1 = nodeService.getChildByName(node2, ContentModel.ASSOC_CONTAINS, "Node2_1");
    }

    @Test
    public void testGetCurrentVersion() throws Exception {
        ChildAssociationRef contentWithVersionsAssocRef =
                createContent(node2_1, "ContentWithVersions");
    ...
    public void testCreateVersion() throws Exception {
        ...
        VersionHistory versionHistory =
                versionService.getVersionHistory(contentWithVersionsNodeRef);
        assertNull(versionHistory);
        VersionHistory actualVersionHistory =
                versionService.getVersionHistory(actualContentWithVersionsNodeRef);
    ...
    public void testRevert() throws Exception {
        ...
        Version version1 = versionService.createVersion(versionableNode, null);
        ...
        Version version2 = versionService.createVersion(versionableNode, null);
        ...
        assertEquals("0.1", history.getHeadVersion().getVersionLabel());
    }
}
