 ...
 * HTTP Proxy Servlet
 *
 * <p>Provides the ability to submit a URL request via the Alfresco Server i.e. the Alfresco server
 * acts as a proxy.
 *
 * <p>This servlet accepts:
 *
 * <p>/proxy?endpoint=<endpointUrl>[&<argName>=<argValue>]*
 *
 * <p>Where:
 *
 * <p>- endpointUrl is the URL to make a request against - argName is the name of a URL argument to
 * append to the request - argValue is the value of URL argument
 *
 * <p>E.g.:
 *
 * <p>/proxy?endpoint=http://www.alfresco.com&arg1=value1&arg2=value2
 *
 * @author davidc
 */
public class HTTPProxyServlet extends HttpServlet {
     ...
     *
     * <p>Note: the "proxied" URL is a relative url - it is assumed that the servlet path is /proxy
     *
    ...
    public static String createProxyUrl(String url) {
        ...
        if (url != null && url.length() > 0) {
            ...
            if (argIndex == -1) {
                ...
                proxy +=
                        "?endpoint="
                                + url.substring(0, argIndex)
                                + "&"
                                + url.substring(argIndex + 1);
            }
        }
