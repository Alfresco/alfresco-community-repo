...
public class FavouriteDocument
  ...
  implements ExpectedComparison, JSONAble {
  ...
  public static FavouriteDocument getDocument(
    String id,
    String guid,
    Properties props
  ) {
    ...
    document.setModifiedBy(
      (String) properties.get(PropertyIds.LAST_MODIFIED_BY).getFirstValue()
    );
    GregorianCalendar modifiedAt = (GregorianCalendar) properties
      .get(PropertyIds.LAST_MODIFICATION_DATE)
      .getFirstValue();
    document.setModifiedAt(modifiedAt.getTime());
    GregorianCalendar createdAt = (GregorianCalendar) properties
    ...
    document.setMimeType(
      (String) properties
        .get(PropertyIds.CONTENT_STREAM_MIME_TYPE)
        .getFirstValue()
    );
    document.setSizeInBytes(
      (BigInteger) properties
        .get(PropertyIds.CONTENT_STREAM_LENGTH)
        .getFirstValue()
    );
    document.setVersionLabel(
      (String) properties.get(PropertyIds.VERSION_LABEL).getFirstValue()
    );
    return document;
  }
  ...
  public void expected(Object o) {
    ...
    AssertUtil.assertEquals(
      "versionLabel",
      versionLabel,
      other.getVersionLabel()
    );
  }

  public static FavouriteDocument parseDocument(JSONObject jsonObject)
    ...
    Date createdAt = PublicApiDateFormat
      .getDateFormat()
      .parse((String) jsonObject.get("createdAt"));
    Date modifiedAt = PublicApiDateFormat
      .getDateFormat()
      .parse((String) jsonObject.get("modifiedAt"));
  ...
  public String toString() {
    ...
    sb
      .append("FavouriteDocument [nodeId=")
      .append(nodeId)
      .append(", guid=")
      .append(guid)
      .append(", name=")
