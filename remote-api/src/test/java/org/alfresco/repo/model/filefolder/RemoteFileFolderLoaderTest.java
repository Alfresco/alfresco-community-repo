...
public class RemoteFileFolderLoaderTest extends BaseWebScriptTest {
    ...
    protected void setUp() throws Exception {
        ...
        RetryingTransactionCallback<NodeRef> createFolderWork =
                    ...
                    public NodeRef execute() throws Throwable {
                        ...
                        FileInfo folderInfo =
                                fileFolderService.create(
                                        sharedHomeNodeRef, folderName, ContentModel.TYPE_FOLDER);
        ...
        loadHomeNodeRef =
                transactionService.getRetryingTransactionHelper().doInTransaction(createFolderWork);
    }

    @Override
    protected void tearDown() throws Exception {
        RetryingTransactionCallback<Void> deleteFolderWork =
    ...
    public void testLoad_15_default() throws Exception {
        ...
        for (FileInfo fileInfo : fileInfos) {
            ...
            // Check creator
            assertEquals(
                    "hhoudini", nodeService.getProperty(fileNodeRef, ContentModel.PROP_CREATOR));
            // We also expect the default language description to be present
            String description =
                    (String) nodeService.getProperty(fileNodeRef, ContentModel.PROP_DESCRIPTION);
            assertNotNull("No description", description);
            assertEquals(
                    "Description length incorrect: \"" + description + "\"",
                    128L,
                    description.getBytes("UTF-8").length);
        }
    }
