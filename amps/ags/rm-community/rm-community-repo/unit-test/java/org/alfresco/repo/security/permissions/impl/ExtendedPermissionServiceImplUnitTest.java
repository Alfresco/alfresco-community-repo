...
public class ExtendedPermissionServiceImplUnitTest extends BaseUnitTest
{
    ...
    /**
     * Given a permission pre-processor has been registered And does not DENY When hasPermission is called Then the pre-processor is executed And the ACL's are evaluated as normal
     */
    @Test
    ...
    /**
     * Given a permission pre-processor has been registered And DENY's When hasPermission is called Then the pre-processor is executed And the remaining permission evaluations do not take place
     */
    @Test
    ...
    /**
     * Given a permission post-processor has been registered When hasPermission is called Then the permission post-processor is called
     */
    @Test
    ...
    /**
     * Given a node with no owner aspect When we ask for the readers and writers Then the owner isn't included in the result
     */
    @Test
    ...
    /**
     * Given a node with no owner set When we ask for the readers and writers Then the owner isn't included in the result
     */
    @Test
    ...
    /**
     * Given a node with NO_OWNER value set When we ask for the readers and writers Then the owner isn't included in the result
     */
    @Test
    ...
    /**
     * Given a node with an owner When we ask for the readers and writers Then the owner is included in the writers set
     */
    @Test
