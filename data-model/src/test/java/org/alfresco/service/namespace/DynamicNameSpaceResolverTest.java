...
public class DynamicNameSpaceResolverTest extends TestCase {
  ...
  public void testTwo() {
    DynamicNamespacePrefixResolver dnpr1 = new DynamicNamespacePrefixResolver(
      null
    );
    ...
    DynamicNamespacePrefixResolver dnpr2 = new DynamicNamespacePrefixResolver(
      dnpr1
    );
  ...
  public void testGetters() {
    DynamicNamespacePrefixResolver dnpr = new DynamicNamespacePrefixResolver(
      new QNameTest.MockNamespacePrefixResolver()
    );
