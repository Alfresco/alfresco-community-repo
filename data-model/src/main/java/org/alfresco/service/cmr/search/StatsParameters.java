...
public class StatsParameters implements BasicSearchParameters {
    ...
    public StatsParameters(
            String language, String query, String filterQuery, boolean isDateSearch) {
        super();
    ...
    public void addStore(StoreRef store) {
        if (stores.size() != 0) {
            throw new IllegalStateException(
                    "At the moment, there can only be one stats store set for the search");
        }
        stores.add(store);
    }
    ...
    public String toString() {
        ...
        builder.append("StatsParameters [query=")
                .append(this.query)
                .append(", filterquery=")
                .append(this.filterQuery)
                .append(", language=")
                ...
                .append(", statsParameters=")
                .append(this.statsParameters)
                .append(", isDateSearch=")
                .append(this.dateSearch)
                .append("]");
