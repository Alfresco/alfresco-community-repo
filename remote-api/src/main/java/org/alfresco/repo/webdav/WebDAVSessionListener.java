...
/**
 * WebDAVSessionListener is used to forcibly unlock documents that were persistently locked during
 * user's session and were not unlocked because of some extraordinary situations such as network
 * connection lost. Was introduced in ALF-11777 jira issue.
 *
...
public class WebDAVSessionListener implements HttpSessionListener, ServletContextListener {
    ...
    /** @param webDAVLockService the webDAVLockService to set */
