...
public class JSONtoFmModelTest extends TestCase
{
    ...
    public void testUtil()
    {
        ...
        String test2_expected_out = "glossary:class java.util.HashMap\n" +
        ...
        String test3_expected_out = "doc:class java.util.HashMap\n" +
        ...
        String test4_expected_out = "glossary:class java.util.HashMap\n" +
