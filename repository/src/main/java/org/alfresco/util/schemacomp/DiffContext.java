...
/**
 * A context made available to schema differencing and validation operations. It supplies
 * information about the {@link Dialect database dialect} that should be used when validating
 * database properties and the {@link Results} object that should be populated with schema
 * differences and validation errors.
 *
 * @author Matt Ward
 */
public class DiffContext {
     ...
     */
    public DiffContext(
            Dialect dialect, Results results, Schema referenceSchema, Schema targetSchema) {
