...
public class MultilingualDocumentAspect
  ...
  public void onUpdateProperties(
    ...
    if (objLocaleAfter != null) {
      localeAfter =
        DefaultTypeConverter.INSTANCE.convert(Locale.class, objLocaleAfter);
    }
    ...
    if (localeBefore == null || !localeBefore.equals(localeAfter)) {
      ...
      int transSize = multilingualContentService
        .getTranslations(mlContainer)
        .size();
      int childSize = nodeService
        .getChildAssocs(
          mlContainer,
          ContentModel.ASSOC_MULTILINGUAL_CHILD,
