...
/**
 * Checks that the behaviour of the {@link ContentModel#ASPECT_AUDITABLE auditable aspect} is correct.
 * 
 * @author Derek Hulley
 */
...
public class AuditableAspectTest extends TestCase
{
     ...
     * ALF-4117: NodeDAO: Allow cm:auditable to be set ALF-3569: Alfresco repository CIFS driver not setting timestamps
     */
