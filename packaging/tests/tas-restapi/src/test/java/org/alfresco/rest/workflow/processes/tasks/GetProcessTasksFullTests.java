...
public class GetProcessTasksFullTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user is able to getProcessTasks even if he wasn't involved in"
                            + " process. Check status code is OK")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getProcessTasksWithAdmin() throws Exception {
        processTasks =
                restClient
                        ...
                        .withWorkflowAPI()
                        .usingProcess(processWithSingleTask)
                        .getProcessTasks();
    ...
    public void getProcessTasksWithValidSkipCount() throws Exception {
        processTasks =
                restClient
                        ...
                        .withParams("orderBy=assignee ASC&skipCount=2")
                        .withWorkflowAPI()
                        .usingProcess(processWithMultipleTasks)
                        .getProcessTasks();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        processTasks
                .assertThat()
                ...
                .assertThat()
                .entriesListDoesNotContain("assignee", assignee1.getUsername())
                .assertThat()
                .entriesListDoesNotContain("assignee", assignee2.getUsername())
                .assertThat()
                .entriesListCountIs(1)
                .assertThat()
    ...
    public void getProcessTasksWithValidMaxItems() throws Exception {
        processTasks =
                restClient
                        .authenticateUser(userWhoStartsProcess)
                        .withParams("orderBy=assignee ASC&maxItems=2")
                        .withWorkflowAPI()
                        .usingProcess(processWithMultipleTasks)
                        .getProcessTasks();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        processTasks
                .assertThat()
                .entriesListDoesNotContain("assignee", assignee3.getUsername())
                .assertThat()
                .entriesListContains("assignee", assignee1.getUsername())
                .assertThat()
    ...
    public void getProcessTasksWithPropertiesParameter() throws Exception {
        processTasks =
                restClient
                        .authenticateUser(adminUser)
                        .withParams("properties=name,assignee,state")
                        .withWorkflowAPI()
                        .usingProcess(processWithSingleTask)
                        .getProcessTasks();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        ...
        processTasks
                ...
                .isNull()
                .and()
                .field("activityDefinitionId")
                .isNull()
                .and()
                .field("priority")
                .isNull()
                .and()
                .field("formResourceKey")
                .isNull()
                .and()
                .field("name")
                .is("Review Task")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin gets Process Tasks ordered by assignee ascendant using REST API"
    ...
    public void getProcessTasksOrderedByMultipleFields() throws Exception {
        restClient
                .authenticateUser(adminUser)
                .withParams("orderBy=assignee,state")
                .withWorkflowAPI()
                .usingProcess(processWithMultipleTasks)
                .getProcessTasks();
        restClient
