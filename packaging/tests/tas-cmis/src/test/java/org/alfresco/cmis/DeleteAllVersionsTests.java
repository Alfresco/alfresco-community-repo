...
public class DeleteAllVersionsTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to delete all document versions in DocumentLibrary"
                            + " with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager is able to delete only latest document version in"
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is NOT able to delete all versions of inexistent file with"
                            + " CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete PWC file version of a file with multiple"
                            + " versions with CMIS")
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to delete PWC file version of a file with multiple"
                            + " versions set to false with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_WS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is NOT able to delete file original multiple version which"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor cannot delete object Document created by site manager")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_WS},
            expectedExceptions = CmisPermissionDeniedException.class)
