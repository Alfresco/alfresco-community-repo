...
public class QNameTypeEditorTest {
    ...
    private static final String[] CONFIG_LOCATIONS =
            ArrayUtils.add(ApplicationContextHelper.CONFIG_LOCATIONS, TEST_CONFIG_LOCATION);
    ...
    public void testPopulateBeanWithNamespace() throws Exception {
        QNameContainer qNameContainer =
                (QNameContainer) applicationContext.getBean("qNameContainerWithNamespace");

        QName expectedQName =
                QName.createQName("http://www.alfresco.org/model/content/1.0", "namespacedName");
    ...
    public void testPopulateBeanWithoutNamespace() throws Exception {
        QNameContainer qNameContainer =
                (QNameContainer) applicationContext.getBean("qNameContainerNoNamespace");
    ...
    /**
     * Clear up after all the tests have finished and dereference the application context to allow
