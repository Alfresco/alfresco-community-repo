...
public class DispositionServiceImplTest extends BaseRMTestCase {
    ...
    public void testGetDispositionProperties() throws Exception {
        doTestInTransaction(
                new Test<Void>() {
                    public Void run() {
                        Collection<DispositionProperty> properties =
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        DispositionSchedule ds =
                                dispositionService.getDispositionSchedule(rmContainer);
                        assertNotNull(ds);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    private void doCheck(
                        ...
                        DispositionSchedule ds =
                                dispositionService.getDispositionSchedule(container);
                        assertNotNull(ds);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        // Get the containers disposition schedule
                        DispositionSchedule ds =
                                dispositionService.getAssociatedDispositionSchedule(rmContainer);
                        assertNotNull(ds);
                        checkDispositionSchedule(ds, false);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    private void doCheck(
                            ...
                            boolean isRecordLevel) {
                        DispositionSchedule ds =
                                dispositionService.getAssociatedDispositionSchedule(container);
                        assertNotNull(ds);
                        checkDispositionSchedule(
                                ds,
                                dispositionInstructions,
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        List<NodeRef> nodeRefs =
                                dispositionService.getDisposableItems(dispositionSchedule);
    ...
    public void testGetDisposableItemsMultiHier() throws Exception {
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        List<NodeRef> nodeRefs =
                                dispositionService.getDisposableItems(mhDispositionSchedule11);
                        assertNotNull(nodeRefs);
                        assertEquals(1, nodeRefs.size());
    ...
    public void testCreateDispositionSchedule() throws Exception {
        ...
        doTestInTransaction(
                new Test<NodeRef>() {
                    ...
                    public NodeRef run() {
                        ...
                        NodeRef container =
                                filePlanService.createRecordCategory(
                                        filePlan, "testCreateDispositionSchedule");
                    ...
                    public void test(NodeRef result) throws Exception {
                        ...
                        DispositionSchedule ds =
                                dispositionService.getAssociatedDispositionSchedule(result);
                        assertNotNull(ds);
        ...
        doTestInTransaction(
                new FailureTest(
                        "Can not create a disposition schedule on a container with an existing"
    ...
    public void testCreateDispositionScheduleMultiHier() throws Exception {
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public void test(Void result) throws Exception {
                        // Get the created disposition schedule
                        DispositionSchedule testA =
                                dispositionService.getAssociatedDispositionSchedule(
                                        getNodeRef("testA"));
                        assertNotNull(testA);
                        DispositionSchedule testB =
                                dispositionService.getAssociatedDispositionSchedule(
                                        getNodeRef("testB"));
                        assertNotNull(testB);
        ...
        doTestInTransaction(
                new FailureTest(
                        "Can not create a disposition schedule on container with an existing"
                                + " disposition schedule") {
                    @Override
                    public void run() {
        ...
        // Failure: create disposition schedule on a container where there are disposable items
        // under management
        doTestInTransaction(
                new FailureTest(
                        "Can not create a disposition schedule on a container where there are"
                                + " already disposable items under management") {
                    @Override
                    public void run() {
    ...
    private void publishDispositionActionDefinitionChange(DispositionActionDefinition dad) {
        PublishExecutorRegistry reg =
                (PublishExecutorRegistry) applicationContext.getBean("publishExecutorRegistry");
        PublishExecutor pub =
                reg.get(RecordsManagementModel.UPDATE_TO_DISPOSITION_ACTION_DEFINITION);
        assertNotNull(pub);
    ...
    private void updateDispositionScheduleOnContainer(NodeRef nodeRef) {
        ...
        updateProps.put(
                ...
                (Serializable) Arrays.asList(CommonRMTestUtils.DEFAULT_EVENT_NAME, "abolished"));
    ...
    private void checkDispositionAction(
            DispositionAction da, String name, String[] arrEventNames, String strPeriod) {
        assertNotNull(da);
                ...
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        testRM263DispositionSchedule =
                                utils.createBasicDispositionSchedule(
                                        testRM263RecordCategory, "test", "test", true, false);
                        ...
                        dispositionService.addDispositionActionDefinition(
                                testRM263DispositionSchedule, adParams);

                        NodeRef recordFolder =
                                recordFolderService.createRecordFolder(
                                        testRM263RecordCategory, "testRM263RecordFolder");
                        testRM263Record =
                                utils.createRecord(
                                        recordFolder, "testRM263Record", "testRM263Record");
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        assertNull(pubDate);
                        Date asOfDate =
                                (Date) nodeService.getProperty(testRM263Record, PROP_SEARCH_ASOF);
                        assertNull(asOfDate);

                        DispositionAction da =
                                dispositionService.getNextDispositionAction(testRM263Record);
                        assertNotNull(da);
                        assertNull(da.getAsOfDate());

                        // rma:recordSearchDispositionActionAsOf"
                        nodeService.setProperty(
                                testRM263Record, DOD5015Model.PROP_PUBLICATION_DATE, new Date());
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        NodeRef recordFolder =
                                recordFolderService.createRecordFolder(
                                        testRM386RecordCategory, "testRM386RecordFolder");
                        testRM386Record =
                                utils.createRecord(
                                        recordFolder, "testRM386Record", "testRM386Record");
                    ...
                    public void test(Void result) throws Exception {
                        ...
                        Map<QName, Serializable> properties =
                                nodeService.getProperties(testRM386Record);
                        ...
                        List<String> events =
                                (List<String>) properties.get(PROP_RS_DISPOSITION_EVENTS);
                        assertNotNull(events);
                        assertEquals(1, events.size());
                        assertEquals(CommonRMTestUtils.DEFAULT_EVENT_NAME, events.get(0));
                        assertEquals(
                                Boolean.FALSE, properties.get(PROP_RS_DISPOSITION_EVENTS_ELIGIBLE));
                ...
                new Test<DispositionActionDefinition>() {
                    ...
                    public DispositionActionDefinition run() throws Exception {
                        DispositionActionDefinition actionDefinition =
                                testRM386DispositionSchedule.getDispositionActionDefinitionByName(
                                        "cutoff");
                    ...
                    public void test(DispositionActionDefinition result) throws Exception {
                        ...
                        assertTrue(
                                nodeService.hasAspect(
                                        actionDefinition.getNodeRef(), ASPECT_UNPUBLISHED_UPDATE));

                        // Publish the updates
                        PublishUpdatesJobExecuter updater =
                                (PublishUpdatesJobExecuter)
                                        applicationContext.getBean("publishUpdatesJobExecuter");
                        updater.executeImpl();
                        ...
                        DispositionAction dispositionAction =
                                dispositionService.getNextDispositionAction(testRM386Record);
