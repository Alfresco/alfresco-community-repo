...
public class TransferReportPost extends BaseTransferWebScript {
  ...
  protected File executeTransfer(
    ...
    try {
      ...
      if (logger.isDebugEnabled()) {
        logger.debug(
          "Filing transfer report as record in record folder: " + destination
        );
      }
  ...
  File generateHTMLTransferReport(NodeRef transferNode) throws IOException {
    ...
    try (
      ...
      Boolean isAccession = (Boolean) this.nodeService.getProperty(
          transferNode,
      ...
      Date transferDate = (Date) this.nodeService.getProperty(
          transferNode,
   ...
   * @throws IOException
   */
  protected void generateTransferItemsHTML(
    Writer writer,
  ...
  protected void generateTransferRecordHTML(Writer writer, NodeRef recordNode)
    ...
    if (
      ...
      Date declaredOn = (Date) this.nodeService.getProperty(
          recordNode,
