...
public abstract class AbstractMultitenantWorkflowTest extends BaseSpringTest {
    ...
    private static final QName ADHOC_TASK =
            QName.createQName(NamespaceService.WORKFLOW_MODEL_1_0_URI, "adhocTask");
                    ...
                    public String doWork() throws Exception {
                        if (!tenantAdminService.existsTenant(tenantDomain)) {
                            tenantAdminService.createTenant(
                                    ...
                                    null); // use default root dir
                        }
                        return tenantService.getDomainUser(
                                AuthenticationUtil.getAdminUserName(), tenantDomain);
                    }
                });
    }
