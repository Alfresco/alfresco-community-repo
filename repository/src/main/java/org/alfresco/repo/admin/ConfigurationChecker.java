...
public class ConfigurationChecker extends AbstractLifecycleBean {
  ...
  private static final String WARN_RELATIVE_DIR_ROOT =
    "system.config_check.warn.dir_root";
  private static final String MSG_DIR_ROOT = "system.config_check.msg.dir_root";
  private static final String ERR_MISSING_CONTENT =
    "system.config_check.err.missing_content";
  static final String ERR_FIX_DIR_ROOT = "system.config_check.err.fix_dir_root";
  static final String WARN_STARTING_WITH_ERRORS =
    "system.config_check.warn.starting_with_errors";
  ...
  public NodeRef getSystemDescriptor() {
    ...
    if (nodeService.exists(systemStoreRef)) {
      ...
      String path = systemProperties.getProperty(
