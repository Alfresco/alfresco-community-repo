...
public class LockMethodTest {
    ...
    public void setUp() throws Exception {
        ...
        RetryingTransactionCallback<Void> createTestFileCallback =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        TestWithUserUtils.createUser(
                                userName, PWD, rootNodeRef, nodeService, authenticationService);
                        permissionService.setPermission(
                                rootNodeRef, userName, PermissionService.ALL_PERMISSIONS, true);
                        TestWithUserUtils.authenticateUser(
                                userName, PWD, rootNodeRef, authenticationService);
                                ...
                                nodeService
                                        .createNode(
                                                ...
                                                Collections.<QName, Serializable>singletonMap(
                                                        ContentModel.PROP_NAME, TEST_FOLDER_NAME))
                                        .getChildRef();
                        fileNodeRef =
                                nodeService
                                        .createNode(
                                                ...
                                                Collections.<QName, Serializable>singletonMap(
                                                        ContentModel.PROP_NAME, TEST_FILE_NAME))
                                        .getChildRef();
                        ContentWriter contentWriter =
                                contentService.getWriter(
                                        fileNodeRef, ContentModel.PROP_CONTENT, true);
        ...
        this.transactionService
                ...
                .doInTransaction(createTestFileCallback);
    }
    ...
    public void tearDown() {
        ...
        this.authenticationComponent.setSystemUserAsCurrentUser();
        RetryingTransactionCallback<Void> deleteTestFolderCallback =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        this.transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(deleteTestFolderCallback);
    }
    ...
    public void testRefreshLock() throws Exception {
        ...
        String content =
                "<?xml version=\"1.0\" encoding=\"utf-8\" ?><D:lockinfo"
                        + " xmlns:D=\"DAV:\"><D:lockscope xmlns:D=\"DAV:\"><D:exclusive"
                        + " xmlns:D=\"DAV:\"/></D:lockscope><D:locktype xmlns:D=\"DAV:\"><D:write"
                        + " xmlns:D=\"DAV:\"/></D:locktype><D:owner xmlns:D=\"DAV:\">"
                        + userName
                        + "</D:owner></D:lockinfo>";
        ...
        RetryingTransactionCallback<Void> lockExecuteImplCallBack =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        RetryingTransactionCallback<LockInfo> getNodeLockInfoCallBack =
                new RetryingTransactionCallback<LockInfo>() {
                    @Override
                    public LockInfo execute() throws Throwable {
                        return lockMethod.getNodeLockInfo(
                                fileFolderService.getFileInfo(fileNodeRef));
                    }
                };
        ...
        assertEquals(
                "Lock owner should not change after lock refresh.",
                lockInfo.getOwner(),
                updatedLockInfo.getOwner());
        assertEquals(
                "Lock token should not change after lock refresh.",
                lockInfo.getExclusiveLockToken(),
                updatedLockInfo.getExclusiveLockToken());

        assertFalse(
                "Expires was not updated.",
                lockInfo.getExpires().equals(updatedLockInfo.getExpires()));
        assertTrue(
                "Expires was updated incorrectly.",
                lockInfo.getExpires().before(updatedLockInfo.getExpires()));
        ...
        content =
                "<?xml version=\"1.0\" encoding=\"utf-8\" ?><D:propfind"
                    + " xmlns:D=\"DAV:\"><D:prop><D:getlastmodified/>"
        ...
        RetryingTransactionCallback<Void> propfindExecuteImplCallBack =
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
        ...
        this.transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(propfindExecuteImplCallBack);

        String response = propfindResponse.getContentAsString();

        assertFalse(
                "Propfind response should contain lock informarion.",
                response.indexOf("lockdiscovery") == -1);
        ...
        assertTrue(
                "Propfind response should not conatain information about expired lock",
                response.indexOf("lockdiscovery") == -1);
    }
    ...
    public void testMNT_10873() throws Exception {
        ...
        RetryingTransactionCallback<NodeRef> getNodeRefCallback =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
                    public NodeRef execute() throws Throwable {
                        return lockMethod
                                .getNodeForPath(folderNodeRef, lockRequest.getRequestURI())
                                .getNodeRef();
                    }
                };
        ...
        NodeRef nodeRef =
                this.transactionService
                        .getRetryingTransactionHelper()
                        .doInTransaction(getNodeRefCallback);

        assertTrue("NodeRef should exists.", nodeService.exists(nodeRef));
        assertTrue(
                "sys:webdavNoContent aspect should be applied on node.",
                nodeService.hasAspect(nodeRef, ContentModel.ASPECT_WEBDAV_NO_CONTENT));
        ...
        assertFalse(
                "File should note exist in trashcan.",
                nodeService.exists(
                        new NodeRef(StoreRef.STORE_REF_ARCHIVE_SPACESSTORE, nodeRef.getId())));
    }
    ...
    public void testMNT_11990() throws Exception {
        ...
        lockRequest.addHeader(
                WebDAV.HEADER_IF, "(<" + WebDAV.makeLockToken(fileNodeRef, userName) + ">)");
        lockRequest.setRequestURI("/" + TEST_FILE_NAME);
