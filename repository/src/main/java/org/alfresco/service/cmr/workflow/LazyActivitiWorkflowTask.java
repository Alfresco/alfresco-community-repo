...
public class LazyActivitiWorkflowTask extends WorkflowTask {
  ...
  public LazyActivitiWorkflowTask(
    ...
    WorkflowTaskDefinition taskDefinition = activitiTypeConverter.getTaskDefinition(
      task
    );

    WorkflowTask partiallyInitialized = typeConverter
  ...
  public WorkflowPath getPath() {
    if (path == null) {
      if (task != null) {
        this.path =
          activitiTypeConverter.getWorkflowPath(task.getExecutionId(), true);
      } else {
    ...
    public Serializable get(Object key) {
      if (WorkflowModel.PROP_DUE_DATE.equals(key)) {
        ...
        if (task != null) {
          ...
          return (
              historicTask.getDescription() != null &&
        ...
        ContentModel.PROP_CREATED.equals(key) ||
