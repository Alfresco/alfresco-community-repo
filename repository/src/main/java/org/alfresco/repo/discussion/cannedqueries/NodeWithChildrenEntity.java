...
/**
 * An extension of a {@link NodeEntity} which has the name of all children of it, used with the
 * discussions canned queries. As well as the name comes some auditable information, but not full
 * nodes as we don't do permissions checking on the children.
 *
 * @author Nick Burch
 * @since 4.0
 */
