...
public class AlfrescoRpcAuthenticator implements RpcAuthenticator, InitializingBean {
    ...
    public Object authenticateRpcClient(int authType, RpcPacket rpc)
        ...
        if (sessKey == null)
            throw new RpcAuthenticationException(
                    Rpc.AuthBadCred, "Unsupported auth type, " + authType);
                    ...
                    new RetryingTransactionCallback<Void>() {
                        ...
                        public Void execute() throws Throwable {
                            ...
                            if (client == null
                                ...
                                // Clear the authentication, null user should not be allowed to do
                                // any service calls
                                ...
                                if (!alfClient.hasAuthenticationTicket()) {
                                    // ALF-9793: It's possible that the user we're about to accept
                                    // doesn't even exist, yet we
                                    // are using alfresco authentication. In such cases we must
                                    // automatically create
                                    // authentication (using a randomized password) in order to
    ...
    /**
     * Does work in a transaction. This will be a writeable transaction unless the system is in
     * read-only mode.
     *
