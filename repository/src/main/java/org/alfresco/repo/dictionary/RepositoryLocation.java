...
/**
 * Repository location object - defines a location in the repository (can also be used for classpath
 * location)
 */
public class RepositoryLocation {
    ...
    public static final String LANGUAGE_PATH =
            "path"; // lookup directly using node (prefix qname) path
     ...
     * Set the path
     *
     * <p>Example path: /app:company_home/app:dictionary/app:models
     *
     * @param path the path
     */
    ...
    public String getXPathQueryStatement(QName prefixResolvedContentModelType) {
        String result =
                "/*[subtypeOf('"
                        + prefixResolvedContentModelType.toPrefixString()
