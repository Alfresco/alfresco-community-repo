...
public class RecordsManagementAuditServiceImplTest
  ...
  private static final QName HOLD_NAME = QName.createQName(
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          ...
          List<RecordsManagementAuditEntry> entries = getAuditTrail(
            5,
            ADMIN_USER
          );
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          ...
          Serializable value =
            ((Map<Locale, Serializable>) after.get(PROP_TITLE)).get(
                Locale.ENGLISH
              );
  ...
  public void xtestAuditAuthentication() {
    ...
    assertFalse(
      "No audit results were generated for the failed login.",
      result1.isEmpty()
    );
    boolean found = false;
    ...
    assertTrue(
      "Expected to hit successful login attempt for Charles Dickons (cdickons)",
      found
    );
  }
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void when() throws Exception {
          ...
          RecordsManagementAuditQueryParameters params = createAuditQueryParameters(
        ...
        public void then() throws Exception {
          ...
          assertEquals(
            "Unexpected nr of properties audited for cm:person type when deleting a user.",
            1,
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() {
          rmAuditService.clearAuditLog(filePlan);
          hold =
            utils.createHold(filePlan, holdName, "Reason " + GUID.generate());
        }
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          String contentName = (String) nodeService.getProperty(
            dmDocument,
            PROP_NAME
          );
          assertEquals(
  ...
  public void testAuditForRemoveContentFromHold() {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        @Override
        public void then() {
          Map<QName, Serializable> auditEventProperties = getAuditEntry(
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() {
          ...
          hold1 =
            utils.createHold(filePlan, holdName1, "Reason " + GUID.generate());
          hold2 =
        ...
        public void when() {
          utils.removeItemsFromHolds(
            Arrays.asList(hold1, hold2),
            Arrays.asList(dmDocument)
          );
        }

        @Override
        public void then() {
          List<RecordsManagementAuditEntry> auditEntries = getAuditEntries(
            REMOVE_FROM_HOLD_AUDIT_EVENT
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void when() {
          utils.removeItemsFromHolds(
            Arrays.asList(hold),
            Arrays.asList(dmDocument, dmDocument1)
          );
        }
  ...
  private List<RecordsManagementAuditEntry> getAuditTrail(
    ...
    return getAuditTrail(
      new RecordsManagementAuditQueryParameters(),
      expectedCount,
      asUser
    );
  }
  ...
  private List<RecordsManagementAuditEntry> getAuditTrail(
    ...
    return doTestInTransaction(
      new Test<List<RecordsManagementAuditEntry>>() {
        ...
        @Override
        public void test(List<RecordsManagementAuditEntry> result)
          throws Exception {
  ...
  private RecordsManagementAuditEntry getAuditEntry(String auditEvent) {
    ...
    List<RecordsManagementAuditEntry> auditEntries = getAuditEntryAssertOnlyOne(
      params
    );
    ...
    assertEquals(
      auditEvent + " event is not audited.",
      auditEvent,
      auditEntry.getEvent()
    );
  ...
  private RecordsManagementAuditQueryParameters createAuditQueryParameters(
    String auditEvent
  ) {
    RecordsManagementAuditQueryParameters params = new RecordsManagementAuditQueryParameters();
