...
/**
 * Abstract base class for testing {@link LockStore} implementations. Subclasses must implement the
 * createLockStore method and will inherit a set of suitable tests.
 *
 * @author Matt Ward
 */
public abstract class AbstractLockStoreTestBase<T extends LockStore> {
    ...
    public void testContains() {
        ...
        LockState lock1 =
                LockState.createLock(
                        nodeRef1, LockType.NODE_LOCK, "owner", null, Lifetime.EPHEMERAL, null);

        NodeRef nodeRef2 = new NodeRef("workspace://SpacesStore/5838743");
        LockState lock2 =
                LockState.createLock(
                        nodeRef2, LockType.NODE_LOCK, "owner", null, Lifetime.PERSISTENT, null);
    ...
    public void testGetNodes() {
        ...
        LockState lock3 =
                LockState.createLock(
                        nodeRef3, LockType.NODE_LOCK, "owner", null, Lifetime.EPHEMERAL, null);

        NodeRef nodeRef4 = new NodeRef("workspace://SpacesStore/4");
        LockState lock4 =
                LockState.createLock(
                        nodeRef4, LockType.NODE_LOCK, "owner", null, Lifetime.PERSISTENT, null);
