...
/** InvitationRequestImpl is a basic InvitationRequest that is processed by the InvitationService */
/*package scope */ class ModeratedInvitationImpl extends InvitationImpl
        implements ModeratedInvitation, Serializable {
    private static final long serialVersionUID = -5557544865169876451L;

    private final String inviteeComments;

    public static ModeratedInvitation getModeratedInvitationImpl(
    ...
    private static Map<String, Serializable> getConstructorProps(
            String inviteId, Map<QName, Serializable> props) {
