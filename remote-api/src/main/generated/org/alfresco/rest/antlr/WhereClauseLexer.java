...
public class WhereClauseLexer extends Lexer {
    ...
    public final void mPROPERTYVALUE() throws RecognitionException {
        try {
            ...
            // SINGLEQUOTE )* SINGLEQUOTE ) | ( IDENTIFIERDIGIT )+ )
            int alt20 = 2;
            ...
            switch (alt20) {
                case 1:
                    // org/alfresco/rest/antlr/WhereClause.g:89:16: ( SINGLEQUOTE (~ SINGLEQUOTE |
                    // '\\\\' SINGLEQUOTE )* SINGLEQUOTE )
                    {
                        ...
                        // '\\\\' SINGLEQUOTE )* SINGLEQUOTE
                        {
                            ...
                            // org/alfresco/rest/antlr/WhereClause.g:89:29: (~ SINGLEQUOTE | '\\\\'
                            // SINGLEQUOTE )*
                            loop18:
                            do {
                                int alt18 = 3;
                                ...
                                switch (alt18) {
                                    case 1:
                                        // org/alfresco/rest/antlr/WhereClause.g:89:30: ~
                                        // SINGLEQUOTE
                                        {
                                        ...
                                        break;
                                    case 2:
                                        // org/alfresco/rest/antlr/WhereClause.g:89:43: '\\\\'
                                        // SINGLEQUOTE
                                        {
                                            match('\\');
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            // org/alfresco/rest/antlr/WhereClause.g:92:21: ( ( IDENTIFIERLETTER ( (
            // IDENTIFIERLETTERORDIGIT )* | ( ( IDENTIFIERLETTERORDIGIT )* COLON (
            // IDENTIFIERLETTERORDIGIT )* ) ) ) )
            // org/alfresco/rest/antlr/WhereClause.g:92:23: ( IDENTIFIERLETTER ( (
            // IDENTIFIERLETTERORDIGIT )* | ( ( IDENTIFIERLETTERORDIGIT )* COLON (
            // IDENTIFIERLETTERORDIGIT )* ) ) )
            {
                // org/alfresco/rest/antlr/WhereClause.g:92:23: ( IDENTIFIERLETTER ( (
                // IDENTIFIERLETTERORDIGIT )* | ( ( IDENTIFIERLETTERORDIGIT )* COLON (
                // IDENTIFIERLETTERORDIGIT )* ) ) )
                // org/alfresco/rest/antlr/WhereClause.g:92:24: IDENTIFIERLETTER ( (
                // IDENTIFIERLETTERORDIGIT )* | ( ( IDENTIFIERLETTERORDIGIT )* COLON (
                // IDENTIFIERLETTERORDIGIT )* ) )
                {
                    mIDENTIFIERLETTER();

                    // org/alfresco/rest/antlr/WhereClause.g:92:41: ( ( IDENTIFIERLETTERORDIGIT )* |
                    // ( ( IDENTIFIERLETTERORDIGIT )* COLON ( IDENTIFIERLETTERORDIGIT )* ) )
                    int alt26 = 2;
                    alt26 = dfa26.predict(input);
                    switch (alt26) {
                        case 1:
                            // org/alfresco/rest/antlr/WhereClause.g:92:42: (
                            // IDENTIFIERLETTERORDIGIT )*
                            {
                                // org/alfresco/rest/antlr/WhereClause.g:92:42: (
                                // IDENTIFIERLETTERORDIGIT )*
                            ...
                            break;
                        case 2:
                            // org/alfresco/rest/antlr/WhereClause.g:92:69: ( (
                            // IDENTIFIERLETTERORDIGIT )* COLON ( IDENTIFIERLETTERORDIGIT )* )
                            {
                                // org/alfresco/rest/antlr/WhereClause.g:92:69: ( (
                                // IDENTIFIERLETTERORDIGIT )* COLON ( IDENTIFIERLETTERORDIGIT )* )
                                // org/alfresco/rest/antlr/WhereClause.g:92:70: (
                                // IDENTIFIERLETTERORDIGIT )* COLON ( IDENTIFIERLETTERORDIGIT )*
                                {
                                    // org/alfresco/rest/antlr/WhereClause.g:92:70: (
                                    // IDENTIFIERLETTERORDIGIT )*
                                    ...
                                    // org/alfresco/rest/antlr/WhereClause.g:92:101: (
                                    // IDENTIFIERLETTERORDIGIT )*
                                    loop25:
                                    do {
                                        int alt25 = 2;
    ...
    public final void mIDENTIFIERLETTER() throws RecognitionException {
        try {
            // org/alfresco/rest/antlr/WhereClause.g:96:5: ( '\\u0041' .. '\\u005a' | '\\u005f' |
            // '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8'
            // .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' ..
            // '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff'
            // )
    ...
    public final void mIDENTIFIERDIGIT() throws RecognitionException {
        try {
            // org/alfresco/rest/antlr/WhereClause.g:110:5: ( '\\u0030' .. '\\u0039' | '\\u0660' ..
            // '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef'
            // | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' |
            // '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66'
            // .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' ..
    ...
    public void mTokens() throws RecognitionException {
        // org/alfresco/rest/antlr/WhereClause.g:1:8: ( NEGATION | EXISTS | IN | MATCHES | BETWEEN |
        // OR | AND | EQUALS | LESSTHAN | GREATERTHAN | LESSTHANOREQUALS | GREATERTHANOREQUALS |
        // LEFTPAREN | RIGHTPAREN | COMMA | COLON | SINGLEQUOTE | PROPERTYVALUE | PROPERTYNAME | WS
        // )
        int alt28 = 20;
    ...
    static final String DFA26_eotS = "\2\2\2\uffff";
    static final String DFA26_eofS = "\4\uffff";
    static final String DFA26_minS = "\2\60\2\uffff";
    static final String DFA26_maxS = "\2\ufaff\2\uffff";
    static final String DFA26_acceptS = "\2\uffff\1\1\1\2";
    static final String DFA26_specialS = "\4\uffff}>";
    ...
    class DFA26 extends DFA {
        ...
        public String getDescription() {
            return "92:41: ( ( IDENTIFIERLETTERORDIGIT )* | ( ( IDENTIFIERLETTERORDIGIT )* COLON ("
                    + " IDENTIFIERLETTERORDIGIT )* ) )";
        }
    }
    ...
    static final String DFA28_eofS = "\55\uffff";
    ...
    static final String DFA28_acceptS =
            "\6\uffff\1\10\2\uffff\1\15\1\16\1\17\1\20\2\uffff\1\23\1\22\4\uffff"
                    ...
                    + "\uffff\1\2";
    static final String DFA28_specialS = "\15\uffff\1\0\37\uffff}>";
    ...
    class DFA28 extends DFA {
        ...
        public String getDescription() {
            return "1:1: Tokens : ( NEGATION | EXISTS | IN | MATCHES | BETWEEN | OR | AND | EQUALS"
                    + " | LESSTHAN | GREATERTHAN | LESSTHANOREQUALS | GREATERTHANOREQUALS |"
                    + " LEFTPAREN | RIGHTPAREN | COMMA | COLON | SINGLEQUOTE | PROPERTYVALUE |"
                    + " PROPERTYNAME | WS );";
        }
