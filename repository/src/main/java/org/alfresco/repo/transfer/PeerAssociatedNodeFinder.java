...
/**
 * This class can be used to find nodes that are associated with peer associations (as opposed to
 * child associations).
 *
 * @author brian
 * @since 3.3
...
public class PeerAssociatedNodeFinder extends AbstractNodeFinder {
    ...
    /**
     * @param exclude Set to true to exclude the specified association types, and false to include
     *     only the specified association types.
     */
    ...
    private Set<NodeRef> processExcludedSet(NodeRef thisNode) {
        ...
        List<AssociationRef> targets =
                nodeService.getTargetAssocs(thisNode, RegexQNamePattern.MATCH_ALL);
