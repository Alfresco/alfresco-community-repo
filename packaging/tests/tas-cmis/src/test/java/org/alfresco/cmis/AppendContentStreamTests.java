...
public class AppendContentStreamTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to append content to a not empty file in"
    ...
    public void siteManagerShouldAppendContentToNotEmptyFile() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager)
                ...
                .and()
                .assertThat()
                .contentIs(initialContent)
                .then()
                .update(textToAppend)
                .assertThat()
                .contentIs(initialContent + textToAppend);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify user is not able to append content to a non existent Document in"
                            + " DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to append content to an empty file with version"
                            + " with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to append content to an empty file with no version"
                            + " in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to append content with last chunk parameter set to"
                            + " FALSE with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to append content to a file created by other user in"
                            + " DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to append content to a file created by other user"
                            + " in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to append content to a file created by self in"
                            + " DocumentLibrary with CMIS")
    ...
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_WS},
            expectedExceptions = CmisPermissionDeniedException.class)
    @TestRail(
            section = {"cmis-api"},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to append content to a file created by"
                            + " other user in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to append content to a file created by other"
                            + " user in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to append content to a file created by self"
                            + " in DocumentLibrary with CMIS")
    ...
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_WS},
            expectedExceptions = CmisUpdateConflictException.class,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to append content to a checked out file with"
                            + " CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized user is not able to append content to a file created in a"
                            + " private site with CMIS")
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp = "^Content at.*is not a file$")
