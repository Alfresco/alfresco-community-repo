...
public class CustomModelDefinitionImpl implements CustomModelDefinition {
    ...
    /* package */ CustomModelDefinitionImpl(
            CompiledModel compiledModel, boolean active, MessageLookup messageLookup) {
    ...
    /**
     * Removes the inline constraints (i.e. defined within the property) from all constraints. The
     * result will be constraints that have been defined within the model (Top level) itself.
     *
