 ...
 * {@link ChildApplicationContextFactory} making it configurable, either through
 * alfresco-global.properties or a JMX console.
 *
...
public class CompositeDataBean extends AbstractPropertyBackedBean {
     ...
     * @param type the class of Java bean to be wrapped
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public CompositeDataBean(
    ...
    public void afterPropertiesSet() throws Exception {
        // Derive a default and instance key prefix of the form "<parent>.default." and
        // "<parent>.value.<this>."
    ...
    protected String resolveDefault(String name) {
        // Because we may have multiple instances, we try an instance-specific default before
        // falling back to a general
    ...
    protected void stop(boolean broadcast) {
        ...
        // Ensure any edits to child composites cause the parent to be shut down and subsequently
        // re-initialized
        if (broadcast) {
