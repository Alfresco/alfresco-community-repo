...
public class AlfrescoJavaMailSender extends JavaMailSenderImpl {
  ...
  private static class PooledTransportWrapper extends Transport {
    ...
    public synchronized void close() throws MessagingException {
      ...
      try {
        ...
        throw new MessagingException(
          "Unexpected exception returning transport to pool",
          error
        );
      } finally {
        super.close();
    ...
    protected boolean protocolConnect(
      ...
      try {
        ...
        throw new MessagingException(
          "Unexpected exception borrowing connection from pool",
          ex
        );
      }
    }
  ...
  private GenericKeyedObjectPool transportPool = new GenericKeyedObjectPool(
  ...
  public AlfrescoJavaMailSender() {
    ...
    transportPool.setTimeBetweenEvictionRunsMillis(
      DEAFULT_TIME_BETWEEN_EVICTION_RUNS
    );
    transportPool.setMinEvictableIdleTimeMillis(
      DEAFULT_TIME_BETWEEN_EVICTION_RUNS
    );
  }
