 ...
 *
 * <p>The primary purpose of this component is to allow clustered content sharing without having to
 * have shared access to the binary data on the various machines.
 *
 * @since 2.1
 * @author Derek Hulley
...
public class HttpAlfrescoStore extends AbstractContentStore {
     ...
     * For example:
     *
     * <pre>http://192.168.1.66:8080/alfresco</pre>
     *
     * .
     *
    ...
    public ContentReader getReader(String contentUrl) {
        ContentReader reader =
                new HttpAlfrescoContentReader(
                        transactionService, authenticationService, baseHttpUrl, contentUrl);
        return reader;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(
                    "Starting test of "
                            + HttpAlfrescoStore.class.getName()
                            + " using server "
                            + baseUrl
                            + ".");
    ...
    private static void doTest(ApplicationContext ctx, String baseUrl, String contentUrl)
            throws Exception {
