...
public class EventRestApiTest
  ...
  protected static final String GET_EVENTTYPES_URL =
  ...
  public void testPostEvents() throws Exception {
    ...
    Response rsp = sendRequest(
      new PostRequest(GET_EVENTS_URL, obj.toString(), APPLICATION_JSON),
      200
    );
    try {
      String rspContent = rsp.getContentAsString();
  ...
  public void testGetRole() throws Exception {
    ...
    try {
      // Get the roles
      Response rsp = sendRequest(
        new GetRequest(GET_EVENTS_URL + "/" + eventName),
        200
      );
      String rspContent = rsp.getContentAsString();
