...
/* package */ class SOLRSerializer {
    ...
    public String serializeToJSONString(Serializable value) {
        if (value != null
                && typeConverter.INSTANCE.getConverter(value.getClass(), String.class) == null) {
        ...
        if (propertyDef.isMultiValued()) {
            if (!(value instanceof Collection)) {
                throw new IllegalArgumentException(
                        "Multi value: expected a collection, got " + value.getClass().getName());
            }
    ...
    static class SOLRTypeConverter {
        ...
        SOLRTypeConverter(NamespaceService namespaceService) {
            ...
            Map<Class<?>, Map<Class<?>, Converter<?, ?>>> converters =
                    DefaultTypeConverter.INSTANCE.getConverters();
                        ...
                        public String convert(MLText source) {
                            try {
                                ...
                                throw new AlfrescoRuntimeException(
                                        "Unable to serialize content data to JSON", e);
                            }
                        }
                    });
