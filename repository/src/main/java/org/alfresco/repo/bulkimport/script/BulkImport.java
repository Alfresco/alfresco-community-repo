...
/**
 * Custom javascript root object to provide access to the {@link
 * org.alfresco.repo.bulkimport.BulkFilesystemImporter} from scripts.
 *
 * @since 4.0
 */
public class BulkImport extends BaseProcessorExtension {
    ...
    /**
     * Get a list of the currently registered content stores, from the configured {@link
    ...
    public List<String> getStoreNames() {
        if (storeNamesList == null) {
            synchronized (this) {
                ...
                if (storeNamesList == null)
                    storeNamesList =
                            Collections.unmodifiableList(new ArrayList<String>(storeNamesSet));
            }
        }
