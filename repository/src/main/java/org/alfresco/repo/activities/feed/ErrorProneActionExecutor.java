...
public class ErrorProneActionExecutor
  ...
  protected void executeImpl(
    ...
    NodeRef failingPersonNodeRef = (NodeRef) ruleAction.getParameterValue(
      PARAM_FAILING_PERSON_NODEREF
    );
    NodeRef personNodeRef = (NodeRef) ruleAction.getParameterValue(
