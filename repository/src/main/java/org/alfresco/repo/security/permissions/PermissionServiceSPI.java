 ...
 *
 * <p>The implementation may be changed in the application configuration
 *
 * @author Andy Hind
 */
public interface PermissionServiceSPI extends PermissionService {
    ...
    /**
     * Get the permissions that have been set on the given node (it knows nothing of the parent
     * permissions)
     *
     * @param nodeRef NodeRef
    ...
    /**
     * Where is the permission set that controls the behaviour for the given permission for the
     * given authentication to access the specified name.
     *
     * @param nodeRef NodeRef
     * @param perm PermissionReference
     * @return the node permission entry
