...
public class RuntimePropertyAccessorMapping
  implements PropertyAccessorMapping, InitializingBean {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    registerPropertyAccessor(
      new ObjectIdProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new NodeRefProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new ObjectTypeIdProperty(
        serviceRegistry,
        cmisConnector,
    ...
    registerPropertyAccessor(
      new BaseTypeIdProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new DirectProperty(
        serviceRegistry,
    ...
    registerPropertyAccessor(
      new CreationDateProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new DirectProperty(
        serviceRegistry,
    ...
    registerPropertyAccessor(
      new ModificationDateProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
    ...
    registerPropertyAccessor(
      new IsImmutableProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new IsLatestVersionProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new IsMajorVersionProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new IsLatestMajorVersionProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new VersionLabelProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new VersionSeriesIdProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
    ...
    registerPropertyAccessor(
      new CheckinCommentProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new ContentStreamLengthProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new ContentStreamMimetypeProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new ContentStreamIdProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new ContentStreamFileNameProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new ParentProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(new PathProperty(serviceRegistry, cmisConnector));
    registerPropertyAccessor(
      new AllowedChildObjectTypeIdsProperty(
        serviceRegistry,
        cmisConnector,
        cmisMapping
      )
    ...
    registerPropertyAccessor(
      new SourceIdProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new TargetIdProperty(serviceRegistry, cmisConnector)
    );
    registerPropertyAccessor(
      new DescriptionProperty(serviceRegistry, cmisConnector)
    );
    if (cmisMapping.getCmisVersion().equals(CmisVersion.CMIS_1_1)) {
      ...
      registerPropertyAccessor(
        new IsPrivateWorkingCopy(serviceRegistry, cmisConnector)
      );
    }
    ...
    registerEvaluator(
      ...
      new CanDeleteDocumentEvaluator(serviceRegistry)
    );
    registerEvaluator(
      BaseTypeId.CMIS_DOCUMENT,
    ...
    registerEvaluator(
      ...
      new FixedValueActionEvaluator(
        serviceRegistry,
        Action.CAN_GET_OBJECT_RELATIONSHIPS,
        true
      )
    );
    registerEvaluator(
    ...
    registerEvaluator(
      ...
      new CurrentVersionEvaluator(
        serviceRegistry,
        new CanCheckOutActionEvaluator(serviceRegistry),
        false
      )
    );
    registerEvaluator(
      BaseTypeId.CMIS_DOCUMENT,
      new CanCancelCheckOutActionEvaluator(serviceRegistry)
    );
    registerEvaluator(
      BaseTypeId.CMIS_DOCUMENT,
      new CanCheckInActionEvaluator(serviceRegistry)
    );
    registerEvaluator(
      BaseTypeId.CMIS_DOCUMENT,
      new CurrentVersionEvaluator(
    ...
    registerEvaluator(
      ...
      new FixedValueActionEvaluator(
        serviceRegistry,
        Action.CAN_GET_APPLIED_POLICIES,
        true
      )
    );
    registerEvaluator(
