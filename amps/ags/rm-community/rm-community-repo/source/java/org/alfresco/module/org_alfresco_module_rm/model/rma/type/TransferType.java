...
public class TransferType
  ...
  private static final String CREATE_CHILD_BEHAVIOUR_NAME =
    "onCreateChildAssocsForTransferType";
  private static final String EDIT_PROPERTIES_BEHAVIOUR_NAME =
    "onEditTransferProperties";
  ...
  public void onCreateChildAssociation(
    ...
    throw new IntegrityException(
      I18NUtil.getMessage(MSG_ERROR_ADD_CHILD_TO_TRANSFER),
      null
    );
  }
  ...
  public void onUpdateProperties(
    ...
    if (!authenticationUtil.isRunAsUserTheSystemUser()) {
      throw new IntegrityException(
        I18NUtil.getMessage(MSG_ERROR_EDIT_TRANSFER_PROPERTIES),
        null
      );
    }
  }
