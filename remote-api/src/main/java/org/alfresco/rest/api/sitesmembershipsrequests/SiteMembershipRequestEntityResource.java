...
@EntityResource(
  ...
  title = "Site Membership Request"
)
public class SiteMembershipRequestEntityResource
  implements
    EntityResourceAction.Read<SiteMembershipRequest>, InitializingBean {
  ...
  @Override
  @WebApiDescription(
    title = "A paged list of visible site membership requests in the network."
  )
