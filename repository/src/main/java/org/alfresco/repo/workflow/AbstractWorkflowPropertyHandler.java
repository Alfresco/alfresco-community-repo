...
public abstract class AbstractWorkflowPropertyHandler
   ...
   */
  protected Object handleAssociation(
    Serializable value,
   ...
   * @return Object
   */
  protected Object handleProperty(
    Serializable value,
  ...
  protected Object convertPropertyValue(
    ...
    if (value instanceof Collection<?>) {
      ...
      newValue =
        typeConverter.convert(propDef.getDataType(), (Collection<?>) value);
    } else {
  ...
  protected Object convertAssociationValue(
    AssociationDefinition assocDef,
    Serializable value
  ) {
  ...
  protected WorkflowException getInvalidPropertyValueException(
    QName key,
    Object value
  ) {
  ...
  protected Object handleDefaultProperty(
    Object task,
    TypeDefinition type,
    QName key,
    Serializable value
