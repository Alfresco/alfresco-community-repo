 ...
 *
 * <p>This patch is run per tenant (that's the default for AbstractPatch)
 *
 * @author Gethin James
 */
        ...
        if (authenticationDao != null) {
            ...
            if (userNodeRef != null) {
                ...
                if (DEFAULT_SHA.equals(sha256)) {
                    // I am not going to disable any behaviours because
                    // authenticationDao.onUpdateUserProperties fires
