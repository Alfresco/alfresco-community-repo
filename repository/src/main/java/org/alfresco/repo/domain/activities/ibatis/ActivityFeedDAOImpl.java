...
public class ActivityFeedDAOImpl
  ...
  public long insertFeedEntry(ActivityFeedEntity activityFeed)
    throws SQLException {
    template.insert(
      "alfresco.activities.insert.insert_activity_feed",
      activityFeed
    );
  ...
  public int deleteFeedEntries(Integer maxIdRange) throws SQLException {
    // Get the largest ID
    Long maxId = template.selectOne(
      "alfresco.activities.select_activity_feed_entries_max_id"
    );
    if (maxId == null) {
    ...
    return template.delete(
      "alfresco.activities.delete_activity_feed_entries_before_id",
      minId
    );
  }
  ...
  public int deleteFeedEntries(Date keepDate) throws SQLException {
    return template.delete(
      "alfresco.activities.delete_activity_feed_entries_older_than_date",
      keepDate
    );
  }
  ...
  public int deleteSiteFeedEntries(String siteId) throws SQLException {
    ...
    return template.delete(
      "alfresco.activities.delete_activity_feed_for_site_entries",
      params
    );
  }

  @Override
  public int deleteSiteFeedEntries(String siteId, Date keepDate)
    throws SQLException {
    ActivityFeedEntity params = new ActivityFeedEntity();
    params.setSiteNetwork(siteId);
    ...
    return template.delete(
      "alfresco.activities.delete_activity_feed_for_site_entries_older_than_date",
      params
    );
  }

  @Override
  public int deleteUserFeedEntries(String feedUserId, Date keepDate)
    throws SQLException {
    ActivityFeedEntity params = new ActivityFeedEntity();
    ...
    return template.delete(
      "alfresco.activities.delete_activity_feed_for_feeduser_entries_older_than_date",
      params
    );
  }
  ...
  public int deleteUserFeedEntries(String feedUserId) throws SQLException {
    ...
    return template.delete(
      "alfresco.activities.delete_activity_feed_for_feeduser_entries",
      params
    );
  }
  ...
  @Override
  public List<ActivityFeedEntity> selectUserFeedsToClean(int maxFeedSize)
    throws SQLException {
    ActivityFeedQueryEntity params = new ActivityFeedQueryEntity();
    params.setMaxFeedSize(maxFeedSize);

    return template.selectList(
      "alfresco.activities.select_activity_user_feeds_greater_than_max",
      params
    );
  }

  @Override
  public Long countUserFeedEntries(
    String feedUserId,
    String siteId,
    ...
    if (siteId != null) {
      ...
      if (!excludeThisUser && !excludeOtherUsers) {
        // no excludes => everyone => where feed user is me
        return template.selectOne(
          "alfresco.activities.count_activity_feed_for_feeduser",
          params
        );
      } else if (excludeThisUser) {
        // exclude feed user => others => where feed user is me and post user is not me
        return template.selectOne(
          "alfresco.activities.count_activity_feed_for_feeduser_others",
          params
        );
      } else if (excludeOtherUsers) {
        // exclude others => me => where feed user is me and post user is me
        return template.selectOne(
          "alfresco.activities.count_activity_feed_for_feeduser_me",
          params
        );
      }
    }
  ...
  @SuppressWarnings("unchecked")
  @Override
  public List<ActivityFeedEntity> selectSiteFeedsToClean(int maxFeedSize)
    throws SQLException {
    ActivityFeedQueryEntity params = new ActivityFeedQueryEntity();
    params.setMaxFeedSize(maxFeedSize);

    return template.selectList(
      "alfresco.activities.select_activity_site_feeds_greater_than_max",
      params
    );
  }
  ...
  public List<ActivityFeedEntity> selectUserFeedEntries(
    ...
    if (siteId != null) {
      ...
      if ((!excludeThisUser) && (!excludeOtherUsers)) {
        // no excludes => everyone => where feed user is me
        return template.selectList(
          "alfresco.activities.select.select_activity_feed_for_feeduser_and_site",
          params,
          rowBounds
        );
      } else if ((excludeThisUser) && (!excludeOtherUsers)) {
        // exclude feed user => others => where feed user is me and post user is not me
        return template.selectList(
          "alfresco.activities.select.select_activity_feed_for_feeduser_others_and_site",
          params,
          rowBounds
        );
      } else if ((excludeOtherUsers) && (!excludeThisUser)) {
        // exclude others => me => where feed user is me and post user is me
        return template.selectList(
          "alfresco.activities.select.select_activity_feed_for_feeduser_me_and_site",
          params,
          rowBounds
        );
      }
      ...
      if (!excludeThisUser && !excludeOtherUsers) {
        // no excludes => everyone => where feed user is me
        return template.selectList(
          "alfresco.activities.select.select_activity_feed_for_feeduser",
          params,
          rowBounds
        );
      } else if (excludeThisUser) {
        // exclude feed user => others => where feed user is me and post user is not me
        return template.selectList(
          "alfresco.activities.select.select_activity_feed_for_feeduser_others",
          params,
          rowBounds
        );
      } else if (excludeOtherUsers) {
        // exclude others => me => where feed user is me and post user is me
        return template.selectList(
          "alfresco.activities.select.select_activity_feed_for_feeduser_me",
          params,
          rowBounds
        );
      }
  ...
  private PagingResults<ActivityFeedEntity> getPagingResults(
    PagingRequest pagingRequest,
    final List<ActivityFeedEntity> feedEntries
  ) {
   ...
   */
  @SuppressWarnings("unchecked")
  private List<ActivityFeedEntity> filterByNetwork(
    String networkId,
    String siteId,
    String sql,
    ActivityFeedQueryEntity params,
    PagingRequest pagingRequest
  ) {
    ...
    int expectedMaxItems =
      (
        pagingRequest.getMaxItems() == CannedQueryPageDetails.DEFAULT_PAGE_SIZE
    ...
    do {
      ...
      while (feedEntriesIt.hasNext() && numAddedItems < expectedMaxItems) {
        ...
        if (siteId == null) {
          ...
          if (
            !networkId.equals(
              tenantService.getDomain(activityFeedEntry.getSiteNetwork())
            )
          ) {
            continue;
          }
      ...
      feedEntries != null &&
      feedEntries.size() > 0 &&
      numAddedItems < expectedMaxItems
    );
  ...
  @Override
  public PagingResults<ActivityFeedEntity> selectPagedUserFeedEntries(
    String feedUserId,
    String networkId,
    String siteId,
    boolean excludeThisUser,
  ...
  @Override
  public Long countSiteFeedEntries(String siteId, int maxFeedSize)
    throws SQLException {
    ActivityFeedQueryEntity params = new ActivityFeedQueryEntity();
    params.setSiteNetwork(siteId);
    ...
    // for given site
    return template.selectOne(
      "alfresco.activities.count_activity_feed_for_site",
      params
    );
  }
  ...
  @SuppressWarnings("unchecked")
  @Override
  public List<ActivityFeedEntity> selectSiteFeedEntries(
    String siteId,
    int maxFeedSize
  ) throws SQLException {
    ActivityFeedQueryEntity params = new ActivityFeedQueryEntity();
    ...
    // for given site
    return template.selectList(
      "alfresco.activities.select.select_activity_feed_for_site",
      params,
      rowBounds
    );
  }
