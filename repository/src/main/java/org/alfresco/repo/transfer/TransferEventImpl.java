...
/**
 * An abstract implementation of TransferEvent. Also implements the operations required by
 * RangedTransferEvent.
 *
 * @see TransferEvent
...
public abstract class TransferEventImpl implements TransferEvent {
    ...
    /**
     * A simple human readable summary of this event, the format of this string is not guaranteed
