...
public class UnitTestTransferManifestNodeFactory
   ...
   * @param realFactory
   */
  public UnitTestTransferManifestNodeFactory(
    TransferManifestNodeFactory realFactory
  ) {
  ...
  public TransferManifestNode createTransferManifestNode(
    ...
    TransferManifestNode newNode = realFactory.createTransferManifestNode(
      nodeRef,
      definition,
      transferContext
    );
    ...
    if (newNode instanceof TransferManifestNormalNode) {
      ...
      for (ChildAssociationRef assoc : assocs) {
        ChildAssociationRef replace = new ChildAssociationRef(
          assoc.getTypeQName(),
          mappedParentNodeRef,
          assoc.getQName(),
          mappedNodeRef,
