...
/**
 * Low-level interface allowing control and retrieval of the authentication information held for the
 * current thread.
 *
 * @author dward
 */
public interface AuthenticationContext {
    ...
    /**
     * Explicitly set the current suthentication. If the authentication is <tt>null</tt> the the
     * current authentication is {@link #clearCurrentSecurityContext() cleared}.
     *
