...
public class RecordableVersionServiceImpl extends Version2ServiceImpl
    ...
    /** I18N */
    private static final String AUTO_VERSION_ON_RECORD_CREATION =
            "rm.service.enable-autoversion-on-record-creation";
    ...
    private static final String[] VERSION_PROPERTY_NAMES =
            new String[] {
    ...
    /**
     * @see
     *     org.alfresco.repo.version.Version2ServiceImpl#createVersion(org.alfresco.service.cmr.repository.NodeRef,
     *     java.util.Map, int)
     */
    @Override
    protected Version createVersion(
        ...
        // only need to check the recordable version policy when the recordable version indicator is
        // missing from the version properties
        if (!origVersionProperties.containsKey(KEY_RECORDABLE_VERSION)) {
            // get the version type
            VersionType versionType = null;
            if (origVersionProperties != null) {
                versionType =
                        (VersionType) origVersionProperties.get(VersionModel.PROP_VERSION_TYPE);
            }
                    ...
                    public NodeRef doWork() throws Exception {
                        ...
                        if (filePlan == null) {
                            throw new AlfrescoRuntimeException(
                                    "Can't create a recorded version, because there is no file"
                                            + " plan.");
                        }
                        return filePlan;
                    }
    ...
    private boolean isCreateRecordedVersion(NodeRef nodeRef, VersionType versionType) {
        ...
        if (nodeService.hasAspect(nodeRef, RecordableVersionModel.ASPECT_VERSIONABLE)) {
            String policyString =
                    (String) nodeService.getProperty(nodeRef, PROP_RECORDABLE_VERSION_POLICY);
            if (policyString != null) {
                RecordableVersionPolicy policy =
                        RecordableVersionPolicy.valueOf(policyString.toUpperCase());
    ...
    /**
     * @see
     *     org.alfresco.repo.version.Version2ServiceImpl#createNewVersion(org.alfresco.service.namespace.QName,
     *     org.alfresco.service.cmr.repository.NodeRef, java.util.Map, java.util.Map, int,
     ...
     */
    protected NodeRef createNewRecordedVersion(
            QName sourceTypeRef,
            NodeRef versionHistoryRef,
            Map<QName, Serializable> standardVersionProperties,
            Map<String, Serializable> versionProperties,
        ...
        try {
            ...
            if (filePlan == null) {
                throw new AlfrescoRuntimeException(
                        "Can't create a new recorded version, because no file plan has been"
                                + " specified in the version properties.");
            }

            // create a copy of the source node and place in the file plan
            final NodeRef nodeRef =
                    (NodeRef)
                            standardVersionProperties.get(Version2Model.PROP_QNAME_FROZEN_NODE_REF);
            ...
            try {
                        ...
                        new RunAsWork<Void>() {
                            ...
                            public Void doWork() throws Exception {
                                nodeService.addAspect(
                                        record, ASPECT_VERSION_RECORD, versionRecordProps);
                                return null;
                            }
                        });
                ...
                nodeService.addAspect(
                        versionNodeRef,
                        ASPECT_RECORDED_VERSION,
                        Collections.singletonMap(PROP_RECORD_NODE_REF, (Serializable) record));
        ...
        if (logger.isTraceEnabled()) {
            logger.trace(
                    "createNewRecordedVersion created (" + versionNumber + ") " + versionNodeRef);
        }
        ...
        if (versionHistory != null) {
            ...
            for (Version previousVersion : previousVersions) {
                ...
                final NodeRef previousRecord =
                        (NodeRef) previousVersion.getVersionProperties().get(PROP_VERSION_RECORD);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#getRecordedVersion(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
        ...
        NodeRef versionedNodeRef =
                (NodeRef)
                        nodeService.getProperty(
                                versionRecord, RecordableVersionModel.PROP_VERSIONED_NODEREF);
        if (versionedNodeRef != null) {
            String versionLabel =
                    (String)
                            nodeService.getProperty(
                                    versionRecord, RecordableVersionModel.PROP_VERSION_LABEL);
    ...
    private void freezeAuditableAspect(NodeRef nodeRef, NodeRef versionNodeRef) {
        if (nodeService.hasAspect(nodeRef, ContentModel.ASPECT_AUDITABLE)) {
            ...
            if (properties.get(ContentModel.PROP_OWNER) != null) {
                dbNodeService.setProperty(
                        versionNodeRef, PROP_FROZEN_OWNER, properties.get(ContentModel.PROP_OWNER));
            }
        }
    }
    ...
    /**
     * @see
     *     org.alfresco.repo.version.Version2ServiceImpl#getVersion(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.repo.version.Version2ServiceImpl#revert(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.cmr.version.Version, boolean)
     */
    @Override
    public void revert(NodeRef nodeRef, Version version, boolean deep) {
        String versionPolicy =
                (String) dbNodeService.getProperty(nodeRef, PROP_RECORDABLE_VERSION_POLICY);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#isCurrentVersionRecorded(NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#isRecordedVersion(org.alfresco.service.cmr.version.Version)
     */
    @Override
    public boolean isRecordedVersion(Version version) {
        NodeRef versionNodeRef = getVersionNodeRef(version);
        return dbNodeService.hasAspect(
                versionNodeRef, RecordableVersionModel.ASPECT_RECORDED_VERSION);
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#getVersionRecord(org.alfresco.service.cmr.version.Version)
     */
    @Override
    public NodeRef getVersionRecord(Version version) {
        NodeRef result = null;
        NodeRef versionNodeRef = getVersionNodeRef(version);
        if (dbNodeService.hasAspect(
                versionNodeRef, RecordableVersionModel.ASPECT_RECORDED_VERSION)) {
            // get the version record
            result =
                    (NodeRef)
                            dbNodeService.getProperty(
            ...
            if (result != null && !dbNodeService.exists(result)) {
                throw new AlfrescoRuntimeException(
                        "Version record node doesn't exist.  Indicates version has not been updated"
                                + " when associated version record was deleted. (nodeRef="
                                + result.toString()
                                + ")");
            }
        }
    ...
    /**
     * Convert the incomming node ref (with the version store protocol specified) to the internal
     * representation with the workspace protocol.
     *
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#createRecordFromLatestVersion(NodeRef,
     *     NodeRef, boolean autoVersion)
     */
    @Override
    public NodeRef createRecordFromLatestVersion(
            final NodeRef filePlan,
            final NodeRef nodeRef,
            final boolean isEnableAutoVersionOnRecordCreation) {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#createRecordFromLatestVersion(org.alfresco.service.cmr.repository.NodeRef,
        ...
        if (nodeService.hasAspect(nodeRef, ContentModel.ASPECT_VERSIONABLE)) {
            ...
            if (currentVersion != null && !isRecordedVersion(currentVersion)) {
                                ...
                                new RunAsWork<NodeRef>() {
                                    public NodeRef doWork() throws Exception {
                                        ...
                                        Pair<Set<String>, Set<String>> readersAndWriters =
                                                extendedPermissionService.getReadersAndWriters(
                                                        nodeRef);

                                        // grab the frozen state
                                        NodeRef currentFrozenState =
                                        ...
                                        Map<QName, Serializable> properties =
                                                nodeService.getProperties(currentFrozenState);

                                        // grab all the aspects
                                        Set<QName> aspects =
                                                nodeService.getAspects(currentFrozenState);
                ...
                Map<QName, Serializable> versionProperties =
                        getVersionAspectProperties(currentVersion);
                ...
                this.dbNodeService.deleteNode(
                        convertNodeRef(currentVersion.getFrozenStateNodeRef()));
                ...
                // add aspect with the standard version properties to the 'version' node
                nodeService.addAspect(
                        versionNodeRef, Version2Model.ASPECT_VERSION, versionProperties);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#isRecordedVersionDestroyed(org.alfresco.service.cmr.version.Version)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.version.RecordableVersionService#destroyRecordedVersion(org.alfresco.service.cmr.version.Version)
     */
    @Override
    public void destroyRecordedVersion(Version version) {
        ...
        if (dbNodeService.hasAspect(versionNodeRef, ASPECT_RECORDED_VERSION)) {
            ...
            dbNodeService.setProperty(
                    versionNodeRef, RecordableVersionModel.PROP_RECORD_NODE_REF, null);
        }
    }

    /**
     * Helper method to get the version number of a given version by inspecting the name of the
     * parent association.
     *
    ...
    public boolean isCurrentVersionDirty(NodeRef nodeRef) {
        ...
        Date frozenModificationDate =
                (Date) nodeService.getProperty(currentFrozenState, ContentModel.PROP_MODIFIED);

        boolean versionStoreOutdated =
                ((frozenModificationDate != null)
                        && (modificationDate.getTime() > frozenModificationDate.getTime()));
    ...
    public void createSnapshotVersion(NodeRef nodeRef) {
        ...
        if (autoVersion && isCurrentVersionDirty(nodeRef)) {
            ...
            autoVersionProperties.put(
                    VersionModel.PROP_DESCRIPTION,
                    I18NUtil.getMessage(AUTO_VERSION_ON_RECORD_CREATION));
