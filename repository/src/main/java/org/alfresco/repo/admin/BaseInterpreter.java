...
public abstract class BaseInterpreter extends AbstractLifecycleBean {
  ...
  public static BaseInterpreter getConsoleBean(
  ...
  protected boolean hasAuthority(String username) {
    if (authorityService == null) {
      ...
      authorityService =
        (AuthorityService) getApplicationContext().getBean("AuthorityService");
    }

    return (
      (username != null) && (authorityService.isAdminAuthority(username))
    );
  }
