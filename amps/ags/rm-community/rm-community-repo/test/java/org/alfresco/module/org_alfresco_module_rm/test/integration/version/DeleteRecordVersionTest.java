    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void when() {
          ...
          assertEquals(
            "1.0",
            nodeService.getProperty(myDocument, ContentModel.PROP_VERSION_LABEL)
          );
          ...
          assertNotNull(head);
          assertFalse(
            recordableVersionService.isRecordedVersionDestroyed(head)
          );
          ...
          assertFalse(
            nodeService.hasAspect(record, ContentModel.ASPECT_VERSIONABLE)
          );
          VersionHistory recordVersionHistory = versionService.getVersionHistory(
            record
          );
        ...
        public void then() {
          ...
          assertTrue(
            recordableVersionService.isRecordedVersionDestroyed(version)
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          assertTrue(
            recordableVersionService.isRecordedVersionDestroyed(destroyed)
          );
          assertNull(recordableVersionService.getVersionRecord(destroyed));

          // get the version record for the current version
          NodeRef versionRecord = recordableVersionService.getVersionRecord(
            head
          );
          assertNotNull(versionRecord);
          assertTrue(nodeService.exists(versionRecord));

          Set<Relationship> from = relationshipService.getRelationshipsFrom(
            versionRecord
          );
          assertTrue(from.isEmpty());

          Set<Relationship> to = relationshipService.getRelationshipsTo(
            versionRecord
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          assertTrue(
            recordableVersionService.isRecordedVersionDestroyed(version10)
          );
          NodeRef recordVersion10 = recordableVersionService.getVersionRecord(
            version10
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          assertTrue(
            recordableVersionService.isRecordedVersionDestroyed(version11)
          );
          NodeRef recordVersion11 = recordableVersionService.getVersionRecord(
            version11
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void then() {
          ...
          assertTrue(
            recordableVersionService.isRecordedVersionDestroyed(version12)
          );
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() throws Exception {
          ...
          NodeRef myCategory = filePlanService.createRecordCategory(
            filePlan,
            GUID.generate()
          );
          ...
          NodeRef myRecordFolder = recordFolderService.createRecordFolder(
            myCategory,
            GUID.generate()
          );
