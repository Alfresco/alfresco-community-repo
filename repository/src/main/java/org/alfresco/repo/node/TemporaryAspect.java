...
/**
 * Registers and contains the behaviour specific to the {@link org.alfresco.model.ContentModel#ASPECT_TEMPORARY temporary aspect}.
 * 
 * @author gavinc
 */
public class TemporaryAspect implements CopyServicePolicies.OnCopyNodePolicy
{
     ...
     * <p>
     * Ensures that the {@link ContentModel#ASPECT_TEMPORARY temporary aspect} copy behaviour is disabled when update copies are performed.
     */
    public void init()
    {
    ...
    /**
     * The {@link ContentModel#ASPECT_TEMPORARY <b>sys:temporary</b>} aspect is only copied if the copy is clean i.e. not to an existing node.
     */
