...
public class RestApiUtil {
   ...
   * @throws Exception
   */
  public static <T> List<T> parseRestApiEntries(
   ...
   * @throws Exception
   */
  public static <T> T parseRestApiEntry(JSONObject jsonObject, Class<T> clazz)
    throws Exception {
   ...
   * @throws Exception
   */
  public static PublicApiClient.ExpectedPaging parsePaging(
    JSONObject jsonObject
  ) throws Exception {
    assertNotNull(jsonObject);
    JSONObject jsonList = (JSONObject) jsonObject.get("list");
    ...
    return parsePojo(
      "pagination",
      jsonList,
      PublicApiClient.ExpectedPaging.class
    );
  }
   ...
   * @throws Exception
   */
  public static PublicApiClient.ExpectedErrorResponse parseErrorResponse(
    JSONObject jsonObject
  ) throws Exception {
    return parsePojo(
      "error",
      jsonObject,
      PublicApiClient.ExpectedErrorResponse.class
    );
  }
  ...
  public static String toJsonAsStringNonNull(Object object) throws IOException {
    ...
    om
      .configOverride(java.util.Map.class)
