...
public class GetProcessesSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify User gets all processes started by him using REST API and status code"
                            + " is OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify User gets all processes assigned to him using REST API and status code"
                            + " is OK (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.PROCESSES, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify User that is not involved in a process can not get that process using"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify Admin gets all processes, even if he isn't involved in a process, using"
                            + " REST API and status code is OK (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.PROCESSES, TestGroup.SANITY})
