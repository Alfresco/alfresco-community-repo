...
public class SlingshotContentGetTest extends BaseWebScriptTest {
  ...
  private JSONObject createSite(
    ...
    TestWebScriptServer.Response response = sendRequest(
  ...
  protected void tearDown() throws Exception {
    ...
    for (String shortName : this.createdSites) {
      sendRequest(
        new TestWebScriptServer.DeleteRequest(URL_SITES + "/" + shortName),
        0
      );
    }
    // Clear the list
  ...
  public void testDownloadBySiteMemberFromPrivateSite() throws Exception {
    ...
    NodeRef docLib = siteService.createContainer(
      shortName,
  ...
  public void testRelativePath() throws Exception {
    Repository repositoryHelper = (Repository) getServer()
      .getApplicationContext()
      .getBean("repositoryHelper");
    NodeRef companyHome = repositoryHelper.getCompanyHome();

    NodeRef rootFolder = createNode(
      companyHome,
      "rootFolder",
      ContentModel.TYPE_FOLDER
    );

    NodeRef doc1 = createNodeWithTextContent(
      rootFolder,
      "doc1",
      ContentModel.TYPE_CONTENT,
      "doc1 file content"
    ...
    NodeRef doc2 = createNodeWithTextContent(
      folderZ,
      "doc2",
      ContentModel.TYPE_CONTENT,
      "doc2 file content"
