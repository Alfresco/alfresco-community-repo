...
public class TransformerDebugLogTest
{
    ...
    private void assertEntriesEquals(String[] expected, String[] actual)
    {
    ...
    public void nullEntryTest()
    {
        ...
        assertEntriesEquals(new String[] {}, log.getEntries(10));
    }
    ...
    public void zeroLengthIdEntryTest()
    {
        ...
        assertEntriesEquals(new String[] {"one\n             <<-- INCOMPLETE -->>"}, log.getEntries(10));
    }
    ...
    public void twoAndAHalfTest()
    {
        ...
        assertEntriesEquals(new String[]
                {
                 "58 one\n58 two\n             <<-- INCOMPLETE -->>",
