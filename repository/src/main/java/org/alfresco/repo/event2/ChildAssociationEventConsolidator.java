...
public class ChildAssociationEventConsolidator implements ChildAssociationEventSupportedPolicies {
    ...
    public ChildAssociationEventConsolidator(
            ChildAssociationRef childAssociationRef, NodeResourceHelper helper) {
    ...
    protected DataAttributes<ChildAssociationResource> buildEventData(
            EventInfo eventInfo, ChildAssociationResource resource) {
    ...
    /**
     * Whether or not the child association has been created and then deleted, i.e. a temporary
     * child association.
     *
     * @return {@code true} if the child association has been created and then deleted, otherwise
     *     false
     */
    public boolean isTemporaryChildAssociation() {
        return eventTypes.contains(EventType.CHILD_ASSOC_CREATED)
