...
/**
 * Base Version Model interface containing the common local names (and other constants) used by the
 * lightWeightVersionStore and version2Store implementations
 *
