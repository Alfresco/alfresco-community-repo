...
public class NodeVersionRenditionsApiTest
  ...
  private static final List<String> DEFAULT_RENDITIONS_FOR_TXT = new ArrayList<>(
    List.of("avatar", "avatar32", "doclib", "imgpreview", "medium", "pdf")
  );
  ...
  public void testUpFileVersionRenditions() throws Exception {
    ...
    try {
      ...
      // create a new file
      Document documentResp = createTextFile(
        f1Id,
        contentName,
        content,
        "UTF-8",
  ...
  public void testNegative() throws Exception {
    ...
    getSingle(
      getNodeVersionRenditionsUrl("dummy", "1.0"),
      ("doclib"),
      null,
      401
    );
    ...
    try {
      ...
      renditionRequest.setId("doclib");
      post(
        getNodeVersionRenditionsUrl(docId, "1.0"),
        toJsonAsString(renditionRequest),
        409
      );
      ...
      getSingle(
        getNodeVersionRenditionsUrl(docId, "4.0"),
        ("doclib"),
        null,
        404
      );
  ...
  private void checkCreateAndGetVersionRendition(
    String docId,
    String versionId,
    String renditionId
  ) throws Exception {
    ...
    for (Rendition rendition : renditions) {
      assertEquals(
        Rendition.RenditionStatus.NOT_CREATED,
        rendition.getStatus()
      );
    ...
    response =
      getSingle(getRenditionsUrl, (renditionId + "/content"), params, 200);
  ...
  private void checkAndGetVersionRendition(
    String docId,
    String versionId,
    String renditionId
  ) throws Exception {
