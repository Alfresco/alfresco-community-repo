...
public final class SimplePermissionReference
  ...
  private static ConcurrentMap<Pair<QName, String>, SimplePermissionReference> instances = new ConcurrentHashMap<>(
    100,
    0.9f,
    2
  );
   ...
   */
  public static SimplePermissionReference getPermissionReference(
    QName qName,
    String name
  ) {
