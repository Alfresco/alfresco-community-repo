...
public class PropertyBackedBeanUnregisteredEvent extends PropertyBackedBeanEvent {
     ...
     *
     * @return <code>true</code> if the bean is being destroyed forever. On server shutdown, this
     *     value would be <code>false</code>, whereas on the removal of a dynamically created
     *     instance, this value would be <code>true</code>.
     */
