...
public class TenantWebScriptServlet extends WebScriptServlet {
    ...
    protected WebScriptServletRuntime getRuntime(HttpServletRequest req, HttpServletResponse res) {
        WebScriptServletRuntime runtime =
                new TenantWebScriptServletRuntime(
                        container, authenticatorFactory, req, res, serverProperties);
        return runtime;
    }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (e.getMessage()
                    .contains("getOutputStream() has already been called for this response")) {
                if (logger.isDebugEnabled()) {
