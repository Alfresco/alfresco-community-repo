    ...
    public void testMNT13938() throws Exception {
        ...
        // make a request to any API (we'll get our own profile)
        {
            ...
            HttpResponse response =
                    publicApiClient.get("public", "people", person1, null, null, null);
            ...
            assertTrue(
                    "Cache-Control header should be set to no-cache but it was: "
                            + cacheControlHeader,
            ...
            assertTrue(
                    "Pragma header should be set to no-cache but it was: " + pragmaHeader,
