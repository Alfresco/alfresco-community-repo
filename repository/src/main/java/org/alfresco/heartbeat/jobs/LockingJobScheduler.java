...
/**
 * The scheduler is responsible for the scheduling and unscheduling of locking jobs {@link
 * LockingJob}. Only one repository node in a cluster will collect data for collectors with this
 * type of job.
 */
