...
public class RemoveSiteMemberTests extends RestTest {
  ...
  public void dataPreparation() throws DataPreparationException {
    ...
    moderatedSiteModel =
      dataSite.usingUser(siteCreator).createModeratedRandomSite();
    privateSiteModel =
  ...
  public void siteManagerIsAbleToDeleteSiteMemberWithConsumerRole()
    throws Exception {
  ...
  public void siteCollaboratorIsNotAbleToDeleteSiteMemberWithConsumerRole()
    throws Exception {
    UserModel testUserModel = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      testUserModel,
  ...
  public void siteContributorIsNotAbleToDeleteSiteMemberWithConsumerRole()
    throws Exception {
    UserModel testUserModel = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      testUserModel,
  ...
  public void siteConsumerIsNotAbleToDeleteSiteMemberWithConsumerRole()
    throws Exception {
    UserModel testUserModel = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      testUserModel,
  ...
  public void unauthenticatedUserIsNotAuthorizedToDeleteSiteMember()
    throws Exception {
    UserModel testUserModel = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      testUserModel,
  ...
  public void managerIsNotAbleToDeleteInexistentSiteMember() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingSite(publicSiteModel)
      .deleteSiteMember(inexistentUser);
    restClient
  ...
  public void managerIsNotAbleToDeleteNotSiteMember() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingSite(publicSiteModel)
      .deleteSiteMember(nonMember);
    restClient
      .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_ARGUMENT, "argument")
      );
  }
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteManagerIsAbleToDeleteSiteMemberWithManagerRole()
    throws Exception {
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteCollaboratorIsNotAbleToDeleteSiteMemberWithManagerRole()
    throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingSite(publicSiteModel)
      .deleteSiteMember(managerForDelete);
    restClient
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteContributorIsNotAbleToDeleteSiteMemberWithManagerRole()
    throws Exception {
    UserModel managerForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      managerForDelete,
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteConsumerIsNotAbleToDeleteSiteMemberWithManagerRole()
    throws Exception {
    UserModel managerForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      managerForDelete,
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteCollaboratorIsNotAbleToDeleteSiteMemberWithContributorRole()
    throws Exception {
    UserModel contributorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      contributorForDelete,
      publicSiteModel,
      UserRole.SiteContributor
    );
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteContributorIsNotAbleToDeleteSiteMemberWithContributorRole()
    throws Exception {
    UserModel contributorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      contributorForDelete,
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteConsumerIsNotAbleToDeleteSiteMemberWithContributorRole()
    throws Exception {
    UserModel contributorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      contributorForDelete,
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteManagerIsAbleToDeleteSiteMemberWithContributorRole()
    throws Exception {
    UserModel contributorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      contributorForDelete,
    ...
    Utility.sleep(
      ...
      () ->
        restClient
          ...
          .getSiteMembers()
          .assertThat()
          .entriesListDoesNotContain("id", contributorForDelete.getUsername())
    );
  }
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteCollaboratorIsNotAbleToDeleteSiteMemberWithCollaboratorRole()
    throws Exception {
    UserModel collaboratorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      collaboratorForDelete,
      publicSiteModel,
      UserRole.SiteCollaborator
    );
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteContributorIsNotAbleToDeleteSiteMemberWithCollaboratorRole()
    throws Exception {
    UserModel collaboratorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      collaboratorForDelete,
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteConsumerIsNotAbleToDeleteSiteMemberWithCollaboratorRole()
    throws Exception {
    UserModel collaboratorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      collaboratorForDelete,
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void siteManagerIsAbleToDeleteSiteMemberWithCollaboratorRole()
    throws Exception {
    UserModel collaboratorForDelete = dataUser.createRandomTestUser();
    dataUser.addUserToSite(
      collaboratorForDelete,
    ...
    Utility.sleep(
      ...
      () ->
        restClient
          ...
          .getSiteMembers()
          .assertThat()
          .entriesListDoesNotContain("id", collaboratorForDelete.getUsername())
    );
  }
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void adminIsAbleToDeleteSiteMemberWithContributorRole()
    throws Exception {
    restClient
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION })
  public void adminIsAbleToDeleteSiteMemberWithCollaboratorRole()
    throws Exception {
    restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
