...
public class HoldsAPI extends BaseAPI
{
     ...
     *            the user's password
     * @param holdName
     *            the hold name to be created
     * @param reason
     *            reason of the hold to be created
     * @param description
     *            hold description
     ...
     *
     * @param user
     *            the user who adds the item to the hold
     * @param password
     *            the user's password
     * @param itemNodeRef
     *            the nodeRef of the item to be added to hold
     * @param holdName
     *            the hold name
     * @return The HTTP response
     */
     ...
     *
     * @param user
     *            the user who adds the items to the holds
     * @param password
     *            the user's password
     * @param itemNodeRefs
     *            the list of items nodeRefs to be added to holds
     * @param holdNames
     *            the list of holds
     * @return The HTTP response
     */
     ...
     *
     * @param items
     *            list of items node refs to be added to holds
     * @param holdNodeRefs
     *            list of hold node refs for add/remove items
     ...
     *
     * @param user
     *            the user who removes the item from the hold
     * @param password
     *            the user's password
     * @param itemNodeRef
     *            the nodeRef of the item to be removed from hold
     * @param holdName
     *            the hold name
     * @return The HTTP response
     */
     ...
     *            the user's password
     * @param itemNodeRefs
     *            the list of items nodeRefs to be removed from hold
     * @param holdNames
     *            the list of hold names
     * @return The HTTP response
     */
     ...
     *            https status code expected
     * @param itemNodeRefs
     *            the list of items nodeRefs to be removed from hold
     * @param holdNodeRefs
     *            the list of hold node refs
     * @return The HTTP response
     */
     ...
     *
     * @param user
     *            the user who removes the item from hold
     * @param password
     *            the user's password
     * @param itemNodeRef
     *            the nodeRef of the item to be removed from hold
     ...
     * @param itemNodeRef
     *            The item node reference
     * @param includedInHold
     *            True to retrieve the holds which have the item node reference
     * @param fileOnly
     *            True if only files should be return
