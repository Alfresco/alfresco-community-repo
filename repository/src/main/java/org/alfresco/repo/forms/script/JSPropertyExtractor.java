...
public class JSPropertyExtractor {
  ...
  private Method resolveMethod(String propertyName, Object jsObject) {
    StringBuilder capitalisedPropertyName = getCapitalisedPropertyName(
      propertyName
    );
    String nameOfPotentialGetMethod = new StringBuilder("get")
      .append(capitalisedPropertyName)
      .toString();
    String nameOfPotentialIsMethod = new StringBuilder("is")
      .append(capitalisedPropertyName)
      .toString();
    ...
    for (Method method : availableMethods) {
      ...
      if (
        resolvedMethod == null &&
        nameOfPotentialIsMethod.equals(method.getName()) &&
      ...
      if (
        nameOfPotentialGetMethod.equals(method.getName()) &&
        method.getParameterTypes().length == 0
      ) {
        resolvedMethod = method;
        break;
