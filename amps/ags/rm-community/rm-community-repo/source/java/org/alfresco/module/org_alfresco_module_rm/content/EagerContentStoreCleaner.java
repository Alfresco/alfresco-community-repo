...
public class EagerContentStoreCleaner
    ...
    public void registerOrphanedContentUrlForCleansing(String contentUrl) {
        ...
        Set<String> cleansingUrls =
                transactionalResourceHelper.getSet(KEY_POST_COMMIT_CLEANSING_URLS);
    ...
    /**
     * @see
     *     org.alfresco.repo.content.cleanup.EagerContentStoreCleaner#deleteFromStore(java.lang.String,
