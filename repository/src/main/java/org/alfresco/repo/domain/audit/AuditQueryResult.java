...
public class AuditQueryResult {
  ...
  public String toString() {
    ...
    sb
      .append("AuditEntryResult")
      .append("[ auditEntryId=")
      .append(auditEntryId)
      .append(", auditAppNameId=")
      .append(auditAppNameId)
      .append(", auditUserId=")
      .append(auditUserId)
      .append(", auditTime")
      .append(new Date(auditTime))
      .append(", auditValuesId=")
      .append(auditValuesId)
      .append(", auditValueRows=")
      .append(auditValueRows == null ? null : auditValueRows.size())
      .append(", auditValue=")
      .append(auditValue)
      .append("]");
    return sb.toString();
