...
public class QueryParameterDefImpl implements QueryParameterDefinition {
  ...
  private static final org.dom4j.QName ELEMENT_QNAME = new org.dom4j.QName(
  ...
  private static final org.dom4j.QName DEF_QNAME = new org.dom4j.QName(
    "qname",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName PROPERTY_QNAME = new org.dom4j.QName(
    "property",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName PROPERTY_TYPE_QNAME = new org.dom4j.QName(
    "type",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  private static final org.dom4j.QName DEFAULT_VALUE = new org.dom4j.QName(
    "default-value",
    new Namespace(
      NamespaceService.ALFRESCO_PREFIX,
      NamespaceService.ALFRESCO_URI
  ...
  public static QueryParameterDefinition createParameterDefinition(
    ...
    if (element.getQName().getName().equals(ELEMENT_QNAME.getName())) {
      ...
      if (propDef != null) {
        return new QueryParameterDefImpl(
          qName,
          propDef,
          hasDefault,
          defaultValue
