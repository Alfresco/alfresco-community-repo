...
public class AddSiteMemberTests extends RestTest {
  ...
  public void unauthenticatedUserIsNotAuthorizedToAddSiteMmeber()
    throws Exception {
    UserModel testUser = dataUser.createRandomTestUser("testUser");
    testUser.setUserRole(UserRole.SiteConsumer);
  ...
  public void addUserByCollaboratorToModeratedSite() throws Exception {
    ...
    restClient
      .authenticateUser(
        moderatedSiteUsersWithRoles.getOneUserWithRole(
          UserRole.SiteCollaborator
        )
      )
      .withCoreAPI()
  ...
  public void canNotAddUserWithInexistentRoleToSite() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.UNKNOWN_ROLE, "inexistentRole")
      );
  }
  ...
  public void userIsNotAbleToAddEmptyUserIdToSite() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.NO_CONTENT, testUser.getUsername())
      );
  }
  ...
  public void userIsNotAbleToAddUserThatIsAlreadyAMember() throws Exception {
    UserModel collaborator = moderatedSiteUsersWithRoles.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
    restClient
      .authenticateUser(adminUserModel)
  ...
  public void addSeveralUsersThatAreAlreadyAddedToASite() throws Exception {
    ...
    UserModel consumer = moderatedSiteUsersWithRoles.getOneUserWithRole(
      UserRole.SiteConsumer
    );
    restClient.authenticateUser(adminUserModel).withCoreAPI();
    String json = String.format(
  ...
  public void checkLowerUpperCaseLettersForRole() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.UNKNOWN_ROLE, "SITEMANAGER")
      )
      .containsErrorKey(
        String.format(RestErrorModel.UNKNOWN_ROLE, "SITEMANAGER")
      )
  ...
  public void adminCannotBeAddedToPrivateSiteBySiteCollaborator()
    throws Exception {
    UserModel testUser = dataUser.createRandomTestUser();
    SiteModel privateSite = dataSite
      .usingUser(testUser)
