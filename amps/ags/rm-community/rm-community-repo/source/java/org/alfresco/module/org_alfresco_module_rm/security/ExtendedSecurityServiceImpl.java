...
public class ExtendedSecurityServiceImpl extends ServiceBaseImpl
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityService#hasExtendedSecurity(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityService#getReaders(org.alfresco.service.cmr.repository.NodeRef)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityService#getWriters(org.alfresco.service.cmr.repository.NodeRef)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityService#set(org.alfresco.service.cmr.repository.NodeRef,
    ...
    public void set(NodeRef nodeRef, Set<String> readers, Set<String> writers) {
        ...
        filePlanRoleService.assignRoleToAuthority(
                filePlan, FilePlanRoleService.ROLE_EXTENDED_READERS, iprGroups.getFirst());
        filePlanRoleService.assignRoleToAuthority(
                filePlan, FilePlanRoleService.ROLE_EXTENDED_WRITERS, iprGroups.getSecond());
        ...
        if (isRecord(nodeRef)) {
            List<ChildAssociationRef> assocs =
                    nodeService.getChildAssocs(
                            nodeRef, RenditionModel.ASSOC_RENDITION, RegexQNamePattern.MATCH_ALL);
     ...
     *
     * <p>Return null if none found.
     *
     * @param nodeRef node reference
     * @return Pair<String, String> where first is the read group and second if the write group,
     *     null if none found
     */
     ...
     *
     * <p>The IPR groups are named with hashes of the authority lists in order to reduce the set of
     * groups that require exact match. A further index is used to handle a situation where there is
     * a hash clash, but a difference in the authority lists.
     *
     * <p>When no match is found the groups are created. Once created
     *
     * @param filePlan file plan
     * @param readers authorities with read
     * @param writers authorities with write
     * @return Pair<String, String> where first is the full name of the read group and second is the
     *     full name of the write group
     */
     ...
     *
     * <p>If the group does not exist then the group returned is null and the index shows the next
     * available group index for creation.
     *
     * @param groupPrefix group name prefix
     * @param authorities authorities
     * @return Pair<String, Integer> where first is the name of the found group, null if none found
     *     and second if the next available create index
     */
    ...
    private boolean isIPRGroupTrueMatch(String group, Set<String> authorities) {
        // Remove GROUP_EVERYONE for proper comparison as GROUP_EVERYONE is never included in an IPR
        // group
     ...
     *
     * <p>'package' scope to help testing.
     *
     * @param prefix prefix
     * @param authorities authorities
    ...
    /*package*/ String getIPRGroupPrefixShortName(String prefix, Set<String> authorities) {
        StringBuilder builder =
                new StringBuilder(128).append(prefix).append(getAuthoritySetHashCode(authorities));
     ...
     *
     * <p>Note this excludes the "GROUP_" prefix.
     *
     * <p>'package' scope to help testing.
     *
     * @param prefix prefix
    ...
    private void assignIPRGroupsToNode(Pair<String, String> iprGroups, NodeRef nodeRef) {
        permissionService.setPermission(
                nodeRef, iprGroups.getFirst(), RMPermissionModel.READ_RECORDS, true);
        permissionService.setPermission(
                nodeRef, iprGroups.getSecond(), RMPermissionModel.FILING, true);
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.ExtendedSecurityService#remove(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.DeprecatedExtendedSecurityService#getExtendedReaders(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.DeprecatedExtendedSecurityService#getExtendedWriters(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.DeprecatedExtendedSecurityService#addExtendedSecurity(org.alfresco.service.cmr.repository.NodeRef,
     *     java.util.Set, java.util.Set)
     */
    @Override
    @Deprecated
     ...
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.DeprecatedExtendedSecurityService#addExtendedSecurity(org.alfresco.service.cmr.repository.NodeRef,
     *     java.util.Set, java.util.Set, boolean)
     */
    @Override
    @Deprecated
    public void addExtendedSecurity(
            NodeRef nodeRef, Set<String> readers, Set<String> writers, boolean applyToParents) {
        set(nodeRef, readers, writers);
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.DeprecatedExtendedSecurityService#removeAllExtendedSecurity(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
    @Deprecated
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.DeprecatedExtendedSecurityService#removeExtendedSecurity(org.alfresco.service.cmr.repository.NodeRef,
     *     java.util.Set, java.util.Set)
     */
    @Override
    @Deprecated
    ...
    @Override
    @Deprecated
    public void removeExtendedSecurity(
            NodeRef nodeRef, Set<String> readers, Set<String> writers, boolean applyToParents) {
        remove(nodeRef);
    }
