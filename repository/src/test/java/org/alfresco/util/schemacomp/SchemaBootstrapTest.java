...
public class SchemaBootstrapTest {
    ...
    private static final List<String> TEST_SCHEMA_REFERENCE_URLS =
            Arrays.asList(
    ...
    private static ApplicationContextInit APP_CONTEXT_INIT =
            ApplicationContextInit.createStandardContextWithOverrides(BOOTSTRAP_TEST_CONTEXT);
    ...
    public static void beforeClass() throws Exception {
        ResourcePatternResolver rpr =
                new PathMatchingResourcePatternResolver(SchemaBootstrapTest.class.getClassLoader());
    ...
    public void setUp() throws Exception {
        schemaBootstrap =
                (SchemaBootstrap)
                        APP_CONTEXT_INIT.getApplicationContext().getBean("schemaBootstrap");
        schemaBootstrap.setSchemaReferenceUrls(TEST_SCHEMA_REFERENCE_URLS);
        optionalPatch =
                (SchemaUpgradeScriptPatch)
                        APP_CONTEXT_INIT.getApplicationContext().getBean("patchDbVOAddIndexTest");
    }
    ...
    private static void updateTestSchemaReferenceFile(Resource testSchemaRef, Document newDoc)
            throws Exception {
