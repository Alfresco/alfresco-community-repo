...
public class FileContentStore
  ...
  /*package*/File createNewFile(String newContentUrl) throws IOException {
    if (readOnly) {
      throw new UnsupportedOperationException(
        "This store is currently read-only: " + this
      );
    }
  ...
  private synchronized void makeDirectory(File dir) throws IOException {
    ...
    throw new ContentIOException(
      "Failed to create directory for file storage: " + dir
    );
  }
  ...
  /*package*/File makeFile(String contentUrl) {
    ...
    if (!protocol.equals(FileContentStore.STORE_PROTOCOL)) {
      throw new UnsupportedContentUrlException(
        this,
        protocol + PROTOCOL_DELIMITER + relativePath
      );
    }
    // get the file
  ...
  private void publishEvent(
    ...
    context.publishEvent(
      new ContentStoreCreatedEvent(this, extendedEventParams)
    );
  }
  ...
  private void ensureFileInContentStore(File file) {
    String fileNormalizedAbsoultePath = FilenameUtils.normalize(
      file.getAbsolutePath()
    );
    String rootNormalizedAbsolutePath = FilenameUtils.normalize(
      rootAbsolutePath
    );
