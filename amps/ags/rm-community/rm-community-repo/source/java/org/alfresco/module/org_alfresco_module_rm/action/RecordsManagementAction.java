...
public interface RecordsManagementAction {
    ...
    /**
     * Some admin-related rmActions execute against a target nodeRef which is not provided by the
     * calling code, but is instead an implementation detail of the action.
     *
