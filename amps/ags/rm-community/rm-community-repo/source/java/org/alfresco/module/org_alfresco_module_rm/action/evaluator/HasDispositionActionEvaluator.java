...
public class HasDispositionActionEvaluator
  ...
  protected boolean evaluateImpl(
    ...
    String position =
      (
        (QName) actionCondition.getParameterValue(
    ...
    if (dispositionService.isDisposableItem(actionedUponNodeRef)) {
      if (position.equals(DispositionActionRelativePositions.ANY.toString())) {
        ...
        position.equals(DispositionActionRelativePositions.NEXT.toString())
      ) {
        ...
        position.equals(DispositionActionRelativePositions.PREVIOUS.toString())
      ) {
        DispositionAction lastCompletedDispositionAction = dispositionService.getLastCompletedDispostionAction(
          actionedUponNodeRef
        );
