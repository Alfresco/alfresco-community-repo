...
public class SchemaBootstrapRegistration {
    ...
    /**
     * @param updateActivitiScriptPatches a list of schema upgade script patches for Activiti tables
     *     to execute
     * @see
    ...
    public void setUpdateActivitiScriptPatches(
            List<SchemaUpgradeScriptPatch> updateActivitiScriptPatches) {
        this.updateActivitiScriptPatches = updateActivitiScriptPatches;
    }

    /**
     * @param preUpdateScriptPatches a list of schema upgade script patches to execute before
     *     Hibernate patching
     * @see
    ...
    /**
     * @param postUpdateScriptPatches a list of schema upgade script patches to execute after
     *     Hibernate patching
     * @see
