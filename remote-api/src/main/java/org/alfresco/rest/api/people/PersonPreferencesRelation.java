...
public class PersonPreferencesRelation
  ...
  private static final Log logger = LogFactory.getLog(
    PersonPreferencesRelation.class
  );
  ...
  public CollectionWithPagingInfo<Preference> readAll(
    String personId,
  ...
  @Override
  @WebApiDescription(
    title = "Preference value for preference 'preferenceName' for person 'personId'."
  )
  public Preference readById(
    String personId,
