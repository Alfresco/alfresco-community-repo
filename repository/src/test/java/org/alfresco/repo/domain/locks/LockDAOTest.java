...
public class LockDAOTest extends TestCase {
  ...
  public static final String NAMESPACE =
    "http://www.alfresco.org/test/LockDAOTest";
  ...
  public void testLockTableScaling() throws Exception {
    ...
    for (int i = 1; i <= count; i++) {
      QName lockName = QName.createQName(
        lockAAA.getNamespaceURI(),
        lockAAA.getLocalName() + "-" + i
      );
  ...
  public void testReleaseLockRepeated() throws Exception {
    ...
    try {
      boolean released = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
