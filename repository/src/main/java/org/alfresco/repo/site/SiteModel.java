...
public interface SiteModel {
    ...
    public static final QName PROP_SITE_VISIBILITY =
            QName.createQName(SITE_MODEL_URL, "siteVisibility");

    /** Site Container */
    public static final QName ASPECT_SITE_CONTAINER =
            QName.createQName(SITE_MODEL_URL, "siteContainer");
    ...
    public static final List<String> STANDARD_PERMISSIONS =
            Collections.unmodifiableList(
                    Arrays.asList(
                            new String[] {
                                SITE_MANAGER, SITE_COLLABORATOR, SITE_CONTRIBUTOR, SITE_CONSUMER
                            }));
}
