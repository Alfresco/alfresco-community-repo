...
public class RepoServerMgmt implements RepoServerMgmtMBean {
    ...
    public int getTicketCountNonExpired() {
        return useManagedResourceClassloader(
                new Work<Integer>() {
                    @Override
                    Integer doWork() {
    ...
    // Note: implement operations without boolean/Boolean parameter, due to problem with some JMX
    // consoles (e.g. MC4J
    // 1.9 Beta)
     ...
     * in the enterprise repository. Review whether this code should be factored out somewhere
     * common.
     *
     * <p>This method allows a unit of work to be executed under the same class loader used to load
     * this managed reosource.
     *
