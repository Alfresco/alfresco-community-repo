...
public class FacetQNameUtilsTest {
    ...
    private final NamespacePrefixResolver resolver =
            new NamespacePrefixResolver() {
                private final List<String> uris =
                        Arrays.asList(new String[] {"http://www.alfresco.org/model/foo/1.0"});
    ...
    public void canCreateFromShortForm() throws Exception {
        assertEquals(
                QName.createQName("http://www.alfresco.org/model/foo/1.0", "localName"),
    ...
    public void canCreateFromLongForm() throws Exception {
        assertEquals(
                QName.createQName("http://www.alfresco.org/model/foo/1.0", "localName"),
                FacetQNameUtils.createQName(
                        "{http://www.alfresco.org/model/foo/1.0}localName", resolver));
    }
    ...
    public void canCreateFromShortFormWithNoPrefix() throws Exception {
        ...
        // But this is what we must do to support 'QName' strings like "Site" or "Tag" in the REST
        // API.
        assertEquals(
                QName.createQName(null, "localName"),
    ...
    public void canCreateLongFormQnameWithUnrecognisedUri() throws Exception {
        ...
        assertEquals(
                QName.createQName("http://www.alfresco.org/model/illegal/1.0", "localName"),
                FacetQNameUtils.createQName(
                        "{http://www.alfresco.org/model/illegal/1.0}localName", resolver));
    }
