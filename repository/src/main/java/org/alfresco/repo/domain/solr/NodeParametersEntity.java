...
public class NodeParametersEntity extends NodeParameters {
  ...
  public NodeParametersEntity(QNameDAO qnameDAO) {
    ...
    this.setOriginalIdPropQNameId(
        qnamePair == null ? Long.valueOf(-1) : qnamePair.getFirst()
      );
  }
  ...
  public boolean isIncludeNodesTable() {
    return (
      getFromNodeId() != null ||
      getToNodeId() != null ||
      getIncludeTypeIds() != null ||
      getExcludeTypeIds() != null ||
      getIncludeAspectIds() != null ||
      getExcludeAspectIds() != null
    );
  }
