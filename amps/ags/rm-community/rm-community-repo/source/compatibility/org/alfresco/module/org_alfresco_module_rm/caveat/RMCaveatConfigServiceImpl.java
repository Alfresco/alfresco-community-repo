...
public class RMCaveatConfigServiceImpl implements RMCaveatConfigService {
  ...
  private static Log logger = LogFactory.getLog(
    RMCaveatConfigServiceImpl.class
  );
  ...
  public RMConstraintInfo addRMConstraint(
    ...
    try {
      ...
      if (e.getMessage().contains("Constraint already exists")) {
        ...
        recordsManagementAdminService.changeCustomConstraintTitle(
          listQName,
          title
        );
      }
  ...
  public void addRMConstraintListValue(
    ...
    rmCaveatConfigComponent.addRMConstraintListValue(
      listName,
      authorityName,
      value
    );
  ...
  public void updateRMConstraintListAuthority(
    ...
    rmCaveatConfigComponent.updateRMConstraintListAuthority(
      listName,
      authorityName,
      values
    );
  ...
  public void updateRMConstraintListValue(
    ...
    rmCaveatConfigComponent.updateRMConstraintListValue(
      listName,
      valueName,
      authorities
    );
  ...
  public void removeRMConstraintListAuthority(
    ...
    rmCaveatConfigComponent.removeRMConstraintListAuthority(
      listName,
      authorityName
    );
  }
  ...
  public Set<RMConstraintInfo> getAllRMConstraints() {
    ...
    for (QName caveatModelQName : rmCaveatConfigComponent.getRMCaveatModels()) {
      defs.addAll(
        recordsManagementAdminService.getCustomConstraintDefinitions(
          caveatModelQName
        )
      );
    }
  ...
  public RMConstraintInfo updateRMConstraintAllowedValues(
    ...
    if (allowedValues != null) {
      ...
      if (con instanceof RMListOfValuesConstraint) {
        final RMListOfValuesConstraint def = (RMListOfValuesConstraint) con;
        List<String> oldAllowedValues = AuthenticationUtil.runAs(
          new RunAsWork<List<String>>() {
            public List<String> doWork() {
              return def.getAllowedValues();
            }
        ...
        for (String oldValue : oldAllowedValues) {
          if (!allowedValueList.contains(oldValue)) {
            ...
            if (logger.isDebugEnabled()) {
              logger.debug(
                "value removed from list:" + listQName + ":" + oldValue
              );
            }
   ...
   */
  public RMConstraintInfo updateRMConstraintTitle(
    String listName,
    String newTitle
  ) {
    QName listQName = QName.createQName(listName, namespaceService);
