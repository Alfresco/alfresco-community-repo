...
public class NumericPropertyValueComparator implements PropertyValueComparator {
    ...
    private static final String MSGID_INVALID_OPERATION =
            "numeric_property_value_comparator.invalid_operation";

    /**
     * @see
     *     org.alfresco.repo.action.evaluator.compare.PropertyValueComparator#compare(java.io.Serializable,
            ...
            default:
                {
                    ...
                    throw new ActionServiceException(
                            MSGID_INVALID_OPERATION, new Object[] {operation.toString()});
                }
        }
    ...
    /**
     * @see
     *     org.alfresco.repo.action.evaluator.compare.PropertyValueComparator#registerComparator(org.alfresco.repo.action.evaluator.ComparePropertyValueEvaluator)
     */
