...
public class VirtualVersionServiceExtension
    ...
    public class VirtualVersionHistory implements VersionHistory {
        ...
        public Version getRootVersion() {
            ...
            return VirtualVersionServiceExtension.this.virtualizeVersion(
                    versionedReference, actualRootVersion);
        }
        ...
        public Version getHeadVersion() {
            ...
            return VirtualVersionServiceExtension.this.virtualizeVersion(
                    versionedReference, actualHeadVersion);
        }

        @Override
        public Collection<Version> getAllVersions() {
            Collection<Version> allActualVersions = actualHistory.getAllVersions();
            return VirtualVersionServiceExtension.this.virtualizeVersions(
                    versionedReference, allActualVersions);
        }

        @Override
        public Version getPredecessor(Version version) {
            Version actualVersion =
                    VirtualVersionServiceExtension.this.materializeVersionIfReference(version);
            Version actualPredecesor = actualHistory.getPredecessor(actualVersion);

            return VirtualVersionServiceExtension.this.virtualizeVersion(
                    versionedReference, actualPredecesor);
        }
        ...
        public Collection<Version> getSuccessors(Version version) {
            ...
            return VirtualVersionServiceExtension.this.virtualizeVersions(
                    versionedReference, actualSuccessors);
        }
        ...
        public Version getVersion(String versionLabel) {
            ...
            return VirtualVersionServiceExtension.this.virtualizeVersion(
                    versionedReference, actualVersion);
        }
    }
    ...
    private Version materializeVersionIfReference(Version virtualVersion) {
        ...
        if (frozenStoreRef.getIdentifier().equals(Version2Model.STORE_ID)) {
            ...
            String frozenNodeStoreProtocol =
                    (String) virtualProperties.get(VersionModel.PROP_FROZEN_NODE_STORE_PROTOCOL);
            String frozenNodeStoreId =
                    (String) virtualProperties.get(VersionModel.PROP_FROZEN_NODE_STORE_ID);
            String frozenNodeId = (String) virtualProperties.get(VersionModel.PROP_FROZEN_NODE_ID);

            NodeRef propFrozenNode =
                    new NodeRef(frozenNodeStoreProtocol, frozenNodeStoreId, frozenNodeId);
            NodeRef propActualFrozenNode = propFrozenNode;
            Reference propFrozenReference = Reference.fromNodeRef(propFrozenNode);
            if (propFrozenReference != null) {
                propActualFrozenNode = smartStore.materialize(propFrozenReference);
            ...
            actualProperties.put(
                    VersionModel.PROP_FROZEN_NODE_STORE_PROTOCOL, propActualStoreRef.getProtocol());
            actualProperties.put(
                    VersionModel.PROP_FROZEN_NODE_STORE_ID, propActualStoreRef.getIdentifier());
    ...
    private Version virtualizeVersion(Reference versionedReference, Version actualVersion) {
        ...
        Reference virtualFrozenReference =
                NodeProtocol.newReference(frozenStateNodeRef, parentReference);
        ...
        if (frozenStoreRef.getIdentifier().equals(Version2Model.STORE_ID)) {
            // V2 version store (eg. workspace://version2Store)
            NodeRef propFrozenNodeRef =
                    (NodeRef) virtualProperties.get(Version2Model.PROP_FROZEN_NODE_REF);
            Reference virtualPropFrozenReference =
                    NodeProtocol.newReference(propFrozenNodeRef, parentReference);
            virtualProperties.put(
            ...
            Reference virtualPropFrozenReference =
                    NodeProtocol.newReference(propFrozenNode, parentReference);
            NodeRef virtualPropFrozenNodeRef =
                    virtualPropFrozenReference.toNodeRef(propFrozenStoreRef);

            virtualProperties.put(
                    VersionModel.PROP_FROZEN_NODE_STORE_PROTOCOL, propFrozenStoreRef.getProtocol());
            virtualProperties.put(
                    VersionModel.PROP_FROZEN_NODE_STORE_ID, propFrozenStoreRef.getIdentifier());
            virtualProperties.put(
                    VersionModel.PROP_FROZEN_NODE_ID, virtualPropFrozenNodeRef.getId());
        }
    ...
    private Collection<Version> virtualizeVersions(
            Reference versionedReference, Collection<Version> actualVersions) {
        Collection<Version> virtualizedVersions = new LinkedList<>();

        for (Version actualVersion : actualVersions) {
            Version virtualizedVersion = virtualizeVersion(versionedReference, actualVersion);
    ...
    public Collection<Version> createVersion(
        ...
        if (reference == null) {
            ...
            NodeRef materialNode = smartStore.materializeIfPossible(nodeRef);
            Collection<Version> actualVersions =
                    theTrait.createVersion(materialNode, versionProperties, versionChildren);
    ...
    public void registerVersionLabelPolicy(QName typeQName, CalculateVersionLabelPolicy policy) {
        getTrait().registerVersionLabelPolicy(typeQName, policy);
    }
}
