 ...
 * @author Andy
 */
public class DBGreaterThanOrEquals
  ...
  public void prepare(
    ...
    if (getPropertyName().equals(PropertyIds.CONTENT_STREAM_MIME_TYPE)) {
      ...
      QName basePropertyQName = QName.createQName(
        DBQuery.expandQName(
          functionContext.getAlfrescoPropertyName(getPropertyName()),
          namespaceService
        )
      );
      ...
      propertySupport.setCommandType(
        getStaticPosition().equals(ARG_RHS)
          ? DBQueryBuilderPredicatePartCommandType.GTE
          : DBQueryBuilderPredicatePartCommandType.GTE.propertyAndValueReversed()
      );
      propertySupport.setLuceneFunction(
        functionContext.getLuceneFunction(getFunctionArgument())
      );
