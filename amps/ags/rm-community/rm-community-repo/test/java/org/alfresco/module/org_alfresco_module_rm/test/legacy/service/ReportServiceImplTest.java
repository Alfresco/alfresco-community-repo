...
public class ReportServiceImplTest
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          ...
          // Transfer Report
          Report transferReport = reportService.generateReport(
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          ...
          assertEquals(
            TYPE_TRANSFER_REPORT,
            nodeService.getType(transferReportNodeRef)
          );
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          ...
          RecordsManagementActionResult transferReportAction = rmActionService.executeRecordsManagementAction(
            getTransferObject(),
            FileReportAction.NAME,
            params
          );
  ...
  private NodeRef getTransferObject() {
    ...
    // Transfer folder
    RecordsManagementActionResult transferAction = rmActionService.executeRecordsManagementAction(
      recordFolder,
      TransferAction.NAME
    );
