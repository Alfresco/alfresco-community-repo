...
public class TableTest extends DbObjectTestBase<Table> {
  ...
  public void setUp() throws Exception {
    ...
    table =
      new Table(null, "the_table", columns, primaryKey, foreignKeys, indexes);
    otherTable =
      new Table(
        null,
        "the_other_table",
  ...
  public void doDiffTests() {
    // Check columns
    inOrder
      .verify(comparisonUtils)
      .compareCollections(table.getColumns(), otherTable.getColumns(), ctx);
    ...
    inOrder
      .verify(comparisonUtils)
      .compareCollections(table.getIndexes(), otherTable.getIndexes(), ctx);
  }
