...
public class AlfrescoSecureContextImpl implements AlfrescoSecureContext {
    ...
    public int hashCode() {
        ...
        result =
                PRIME * result + ((realAuthentication == null) ? 0 : realAuthentication.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        } else if (!effectiveAuthentication.equals(other.effectiveAuthentication)) return false;
        if (realAuthentication == null) {
            if (other.realAuthentication != null) return false;
        } else if (!realAuthentication.equals(other.realAuthentication)) return false;
        return true;
    }
