...
public interface QNameDAO {
    ...
    /**
     * Get an existing instance matching the URI or create one if necessary. Note that this method
     * should be treated as a write method and should not be used in the context of read-only or
     * query methods.
     *
    ...
    /**
     * Modifies an existing namespace URI. If the new URI already exists, then no new entity is
     * created.
     *
    ...
    /**
     * Get an existing instance matching the QName or create one if necessary. Note that this method
     * should be treated as a write method and should not be used in the context of read-only or
     * query methods.
     *
     * @param qname the QName to query for
    ...
    /**
     * Modify an existing QName. The ID of the new QName will be the same as the old one i.e. the
     * old QName will cease to exist and will become the new QName. This allows QName modification
     * without affecting tables that reference the old QName.
     *
    ...
    /**
     * Bulk-convert QNames into QName IDs. This is primarily used for generating SQL <tt>IN</tt>
     * clause lists for other DAO queries.
     *
