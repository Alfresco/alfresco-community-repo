...
public class ActivityServiceImplTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        authenticationService.authenticate(
                AuthenticationUtil.getAdminUserName(), ADMIN_PW.toCharArray());
    }
    ...
    public void testPostValidActivities() throws Exception {
        ...
        activityService.postActivity(
                "org.alfresco.testActivityType3", "site1", "appToolA", "{ \"var1\" : \"val1\" }");

        // ignore posting this type even though its valid
        activityService.postActivity(
                "file-previewed", "site1", "appToolA", "{ \"var1\" : \"val1\" }");
    }
    ...
    public void testPostInvalidActivities() throws Exception {
        ...
        try {
            activityService.postActivity(
                    "org.alfresco.testActivityType1", "", "", "{ \"nodeRef\" : \"notfound\" }");
    ...
    public void testGetEmptySiteFeed() throws Exception {
        ...
        RetryingTransactionCallback<List<String>> getEntriesCallback =
        ...
        List<String> siteFeedEntries =
                transactionService
                        .getRetryingTransactionHelper()
                        .doInTransaction(getEntriesCallback);
    ...
    public void testGetEmptyUserFeed() throws Exception {
        ...
        userFeedEntries =
                activityService.getUserFeedEntries(
                        "unknown user", "some site", true, false, null, null);
        ...
        userFeedEntries =
                activityService.getUserFeedEntries(
                        "unknown user", "some site", false, true, null, null);
        ...
        userFeedEntries =
                activityService.getUserFeedEntries(
                        "unknown user", "some site", true, true, null, null);
    ...
    public void testJSAPI() throws Exception {
        ...
        String result =
                (String) this.scriptService.executeScript(location, new HashMap<String, Object>(0));
    ...
    public void testLongName_ALF_10362() throws Exception {
        ...
        activityService.postActivity(
                "org.alfresco.testActivityType4",
                "site2",
                "appToolA",
                "{\"title\":\"" + new String(namePattern, "UTF-8") + "\"}");
