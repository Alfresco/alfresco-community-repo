...
public class CropSourceOptions extends AbstractTransformationSourceOptions
{
    ...
    /**
     * Gets the height of the cropped image. By default this is in pixels but if <code>isPercentageCrop</code> is set to true then it changes to percentage.
     * 
     * @return the height
     */
    ...
    /**
     * Sets the height of the cropped image. By default this is in pixels but if <code>isPercentageCrop</code> is set to true then it changes to percentage.
     * 
     * @param height
     *            the height to set
     */
    ...
    /**
     * Sets the width of the cropped image. By default this is in pixels but if <code>isPercentageCrop</code> is set to true then it changes to percentage.
     * 
     * @return the width
     */
    public int getWidth()
    ...
    /**
     * Gets the horizontal offset. By default this starts fromt he top-left corner of the image and moves right, however the <code>gravity</code> property can change this.
     * 
     * @return the xOffset
     */
    ...
    /**
     * Sets the horizontal offset. By default this starts fromt he top-left corner of the image and moves right, however the <code>gravity</code> property can change this.
     * 
     * @param xOffset
     *            the xOffset to set
     */
    ...
    /**
     * Gets the vertical offset. By default this starts fromt he top-left corner of the image and moves down, however the <code>gravity</code> property can change this.
     * 
     * @return the yOffset
     */
    ...
    /**
     * Sets the vertical offset. By default this starts fromt he top-left corner of the image and moves down, however the <code>gravity</code> property can change this.
     * 
     * @param yOffset
     *            the yOffset to set
     */
    ...
    /**
     * @param isPercentageCrop
     *            the isPercentageCrop to set
     */
    ...
    public class CropSourceOptionsSerializer implements TransformationSourceOptionsSerializer
    {
        ...
        // Crop params
        /**
         * This optional {@link Integer} or {@link Float} parameter specifies the width of the image after cropping. This may be expressed as pixels or it may represent a percentage of the original image width, depending on the value of the PARAM_IS_PERCENT_CROP parameter. <br>
        ...
        /**
         * This optional {@link Integer} or {@link Float} parameter specifies the height of the image after cropping. This may be expressed as pixels or it may represent a percentage of the original image width, depending on the value of the PARAM_IS_PERCENT_CROP parameter. <br>
         * If no value is specified for this parameter then the width of the image will be unchanged. <br>
         * If an image is being cropped and resized then the cropping happens first, followed by resizing of the cropped image.
         */
        ...
        /**
         * This optional {@link Integer} parameter specifies the horizontal position of the start point of the area to be cropped. By default this parameter sets the distance, in pixels, from the left-hand edge of the image to the start position of the crop area. By default a positive value will shift the start-position to the right, while a negative value will shift the start position to the left. Setting the PARAM_CROP_GRAVITY parameter may change this, however.<br>
         * If this parameter is not set it is assumed to be 0.
         */
        public static final String PARAM_CROP_X_OFFSET = "crop_x";

        /**
         * This optional {@link Integer} parameter specifies the vertical position of the start point of the area to be cropped. By default this parameter sets the distance, in pixels, from the top edge of the image to the start position of the crop area. By default a positive value will shift the start-position downwards, while a negative value will shift the start position upwards. Setting the PARAM_CROP_GRAVITY parameter may change this, however.<br>
         * If this parameter is not set it is assumed to be 0.
         */
        public static final String PARAM_CROP_Y_OFFSET = "crop_y";

        /**
         * This optional {@link String} parameter determines the 'zero' position from which offsets are measured and also determines the direction of offsets. The allowed values of gravity are the four cardinal points (North, East, etc.), the four ordinal points (NorhtWest, SouthEast, etc) and Center. By default NorthWest gravity is used.
         * <p>
         * 
