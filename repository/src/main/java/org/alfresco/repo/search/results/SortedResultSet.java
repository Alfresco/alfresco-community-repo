...
public class SortedResultSet implements ResultSet {
                ...
                case FIELD:
                    ...
                    if (field.startsWith("@")) {
                        if (field.endsWith(".size")) {
                            ...
                            if (qname != null) {
                                ...
                                if ((propDef != null)
                                    ...
                                    order.add(
                                            new ContentSizeOrder(
                                                    qname, sd.isAscending(), nodeService));
                                }
                            }
                        }
                        ...
                        if (field.equals("ID")) {
                            ...
                            // SKIP UNKNOWN throw new AlfrescoRuntimeException("Property is not
                            // orderable: "+field);
                        }
                    }
                    break;
    ...
    private QName expandAttributeFieldName(
            String field, NamespacePrefixResolver namespacePrefixResolver) {
        QName qname;
            ...
            if (o1 == null) {
                ...
                if (o2 == null) {
                    ...
                    PropertyDefinition propertyDefinition =
                            dictionaryService.getProperty(attribute);
    ...
    private static class ContentMimetypeOrder implements OrderDefinition {
        ...
        ContentMimetypeOrder(
                QName attribute, boolean ascending, NodeService nodeService, Collator collator) {
            this.attribute = attribute;
            this.ascending = ascending;
            this.nodeService = nodeService;
            this.collator = collator;
