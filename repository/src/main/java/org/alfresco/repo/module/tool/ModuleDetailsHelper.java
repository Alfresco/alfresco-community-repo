...
public class ModuleDetailsHelper {
     ...
     */
    public static ModuleDetails createModuleDetailsFromPropertiesStream(InputStream is)
            throws IOException {
     ...
     * @return Returns the initialized module details
     */
    public static ModuleDetails createModuleDetailsFromPropertiesStream(
            InputStream is, LogOutput log) throws IOException {
        try {
     ...
     * @throws IOException
     */
    public static ModuleDetails createModuleDetailsFromPropertyLocation(
            String location, LogOutput log) throws IOException {
        ...
        try {
            ...
            throw new ModuleManagementToolException(
                    "Unable to load module details from property file. File Not Found, "
                            + error.getMessage(),
                    error);
        }
        ...
        try {
            ...
            throw new ModuleManagementToolException(
                    "Unable to load module details from property file." + exception.getMessage(),
                    exception);
        } finally {
     ...
     * @return Returns the module details for the given module ID as it occurs in the WAR, or
     *     <tt>null</tt> if there are no module details available.
     * @throws IOException
     */
    public static ModuleDetails createModuleDetailsFromWarAndId(String warLocation, String moduleId)
            throws IOException {
        String modulePropertiesFileLocation =
                ModuleDetailsHelper.getModulePropertiesFileLocation(warLocation, moduleId);
        return ModuleDetailsHelper.createModuleDetailsFromPropertyLocation(
                modulePropertiesFileLocation);
    }

    /**
     * @param warLocation the location of the WAR file
     * @param moduleId the module ID within the WAR
     * @return Returns a file handle to the module properties file within the given WAR. The file
    ...
    public static void saveModuleDetails(String warLocation, ModuleDetails moduleDetails) {
        ...
        try {
            String modulePropertiesFileLocation =
                    getModulePropertiesFileLocation(warLocation, moduleId);
