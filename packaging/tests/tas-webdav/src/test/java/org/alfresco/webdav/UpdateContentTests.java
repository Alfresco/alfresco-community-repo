...
public class UpdateContentTests extends WebDavTest {
  ...
  public void siteCollaboratorShouldEditContentFileCreatedBySelf()
    throws Exception {
    UserModel collaborator = dataUser.createRandomTestUser();
    dataUser
      .usingUser(managerUser)
  ...
  public void siteContributorShouldNotEditContentFileCreatedByOtherUser()
    throws Exception {
  ...
  public void siteContributorShouldEditContentFileCreatedBySelf()
    throws Exception {
    UserModel contributor = dataUser.createRandomTestUser();
    dataUser
      .usingUser(managerUser)
      .addUserToSite(contributor, testSite, UserRole.SiteManager);
