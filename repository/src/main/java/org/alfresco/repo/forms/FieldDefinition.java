...
public abstract class FieldDefinition {
    ...
    /**
     * Returns the binding for the field, this is used by some FormModelProcessor implementations to
     * generate an alternative representation of the data
     *
    ...
    /**
     * Sets the binding to use for the field, this is used by some FormModelProcessor
     * implementations to generate an alternative representation of the data
     *
    ...
    /**
     * Determines whether the field is protected i.e. it should be rendered as read-only in any
     * client displaying the field
     *
    ...
    /**
     * Sets whether the field is protected i.e. it should be rendered as read-only in any client
