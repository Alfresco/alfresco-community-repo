 ...
 * 
 * Note - this test will largely use a test shared credentials container, but one test puts things into the real credentials folder
 * 
 * @author Nick Burch
 * @since Odin
 */
...
public class RemoteCredentialsServicesTest
{
    ...
    /**
     * Tests that read only methods don't create the shared credentials container, but that write ones will do.
     */
    @Test
    ...
    /**
     * Creating shared and personal credentials, then checking how this affects the listing of Remote Systems
     */
    @Test
    ...
    /**
     * Most of the shared credentials container tests work on the test one, so that things are in a known and empty state. We have this one test that uses the real shared container, just to check that it's correctly setup and available
     */
    @Test
