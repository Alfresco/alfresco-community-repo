...
public class WikiServiceImpl implements WikiService {
  ...
  protected static final String CANNED_QUERY_GET_CHILDREN =
    "wikiGetChildrenCannedQueryFactory";
   ...
   */
  protected NodeRef getSiteWikiContainer(
  ...
  private WikiPageInfo buildPage(
    ...
    // Now the wiki ones
    page.setTitle(
      ((String) props.get(ContentModel.PROP_TITLE)).replaceAll(" ", "_")
    );
  ...
  @Override
  public WikiPageInfo createWikiPage(
  ...
  public void deleteWikiPage(WikiPageInfo page) {
    if (page.getNodeRef() == null) {
      throw new IllegalArgumentException(
        "Can't delete a wiki page that was never persisted"
      );
    }
