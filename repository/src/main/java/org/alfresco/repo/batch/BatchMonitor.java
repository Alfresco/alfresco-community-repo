...
/**
 * An interface that allows the monitoring of metrics relating to a potentially long-running batch
 * process.
 *
 * @author dward
 */
public interface BatchMonitor {
    ...
    public default long getSuccessfullyProcessedEntriesLong() {
        throw new UnsupportedOperationException(
                "getSuccessfullyProcessedEntriesLong need to be implemented");
    }
}
