...
public class SwitchableApplicationContextFactory
  ...
  protected class SwitchableState implements PropertyBackedBeanState {
    ...
    public String getProperty(String name) {
      if (
        !name.equals(SwitchableApplicationContextFactory.SOURCE_BEAN_PROPERTY)
      ) {
        return null;
      }
    ...
    public Set<String> getPropertyNames() {
      return Collections.singleton(
        SwitchableApplicationContextFactory.SOURCE_BEAN_PROPERTY
      );
    }
    ...
    public void setProperty(String name, String value) {
      ...
      if (!getParent().containsBean(value)) {
        throw new IllegalStateException(
          "\"" + value + "\" is not a valid bean name"
        );
      }
      if (this.sourceApplicationContextFactory != null) {
        stop();
