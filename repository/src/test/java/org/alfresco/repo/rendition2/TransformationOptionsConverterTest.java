...
public class TransformationOptionsConverterTest {
    /**
     * The toString of a basic TransformationOptions. Used in testing where the conversion back to
     * the original does not result in the same Java sub class, as there are no meaningful
     * properties set.
     */
    private static final String TO_STRING_OF_UNSET_TRANSFORMATION_OPTIONS =
            "{maxSourceSizeKBytes=-1, pageLimit=-1, use=null, timeoutMs=-1, maxPages=-1,"
                + " contentReaderNodeRef=null, sourceContentProperty=null, readLimitKBytes=-1,"
                + " contentWriterNodeRef=null, targetContentProperty=null, includeEmbedded=null,"
                + " readLimitTimeMs=-1}";

    private TransformationOptionsConverter converter;

    private static final String[] DISCARD_OPTIONS =
            new String[] {
                "autoOrient", "false",
    ...
    private void assertConverterToMapAndBack(
            TransformationOptions oldOptions,
            String sourceMimetype,
            String targetMimetype,
            String expectedOldOptionsToString,
            String expectedArgs) {
        String sortedOldOptions = getSortedOptions(oldOptions, sourceMimetype, targetMimetype);
        assertEquals(
                "oldOptions was not set up correctly",
                expectedOldOptionsToString,
                oldOptions.toString());

        Map<String, String> newOptions =
                converter.getOptions(oldOptions, sourceMimetype, targetMimetype);
        ...
        TransformationOptions backToOldOptions =
                converter.getTransformationOptions("null", newOptions);
        String sortedBackToOldOptions =
                getSortedOptions(backToOldOptions, sourceMimetype, targetMimetype);

        assertEquals(
                "Having converted twice the toString is different",
                expectedOldOptionsToString,
                backToOldOptions.toString());
        assertEquals(
                "Having converted twice the map is different",
                sortedOldOptions,
                sortedBackToOldOptions);
    }

    private String getSortedOptions(
    ...
    public void testCompositeReformatAndResizeRendition() {
        ...
        assertConverterToMapAndBack(
                oldOptions,
                MIMETYPE_IMAGE_JPEG,
                MIMETYPE_IMAGE_JPEG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=20, height=30, maintainAspectRatio=true, percentResize=false,"
    ...
    public void testImageTransformationOptions() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_JPEG,
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=null,"
                        + " autoOrient=true]]",
                "autoOrient=true " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsCrop() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=null,"
                        + " autoOrient=false], sourceOptions={ CropSourceOptionsCropSourceOptions"
                        + " [height=-1, width=-1, xOffset=0, yOffset=0, isPercentageCrop=false,"
                        + " gravity=null]} ]",
                "cropXOffset=0 " + "cropYOffset=0 " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsCropGravity() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=null,"
                        ...
                        + " [height=-1, width=-1, xOffset=0, yOffset=0, isPercentageCrop=false,"
                        + " gravity=North]} ]",
                "cropGravity=North " + "cropXOffset=0 " + "cropYOffset=0 " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsCropWidthHeight() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=null,"
                        + " autoOrient=false], sourceOptions={ CropSourceOptionsCropSourceOptions"
                        + " [height=48, width=30, xOffset=0, yOffset=0, isPercentageCrop=false,"
                        + " gravity=null]} ]",
                "cropHeight=48 "
                        + "cropWidth=30 "
                        + "cropXOffset=0 "
    ...
    public void testImageTransformationOptionsCropPercentage() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=null,"
                        + " autoOrient=false], sourceOptions={ CropSourceOptionsCropSourceOptions"
                        + " [height=-1, width=-1, xOffset=0, yOffset=0, isPercentageCrop=true,"
                        + " gravity=null]} ]",
                "cropPercentage=true " + "cropXOffset=0 " + "cropYOffset=0 " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsCropOffset() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=null,"
                        + " autoOrient=false], sourceOptions={ CropSourceOptionsCropSourceOptions"
                        + " [height=-1, width=-1, xOffset=20, yOffset=59, isPercentageCrop=false,"
                        + " gravity=null]} ]",
                "cropXOffset=20 " + "cropYOffset=59 " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsResize() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=-1, height=-1, maintainAspectRatio=true, percentResize=false,"
                        + " resizeToThumbnail=false, allowEnlargement=true], autoOrient=false]]",
                "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsResizeNoEnlargement() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=-1, height=-1, maintainAspectRatio=true, percentResize=false,"
                        + " resizeToThumbnail=false, allowEnlargement=false], autoOrient=false]]",
                "allowEnlargement=false " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsResizeNoAspectRatio() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=-1, height=-1, maintainAspectRatio=false, percentResize=false,"
                        + " resizeToThumbnail=false, allowEnlargement=true], autoOrient=false]]",
                "maintainAspectRatio=false " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsResizeNoEnlargementOrAspectRatio() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=-1, height=-1, maintainAspectRatio=false, percentResize=false,"
                        + " resizeToThumbnail=false, allowEnlargement=false], autoOrient=false]]",
                "allowEnlargement=false " + "maintainAspectRatio=false " + "timeout=-1 ");
    }
    ...
    public void testImageTransformationOptionsResizeThumbnnail() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=-1, height=-1, maintainAspectRatio=false, percentResize=false,"
                        + " resizeToThumbnail=true, allowEnlargement=false], autoOrient=false]]",
    ...
    public void testImageTransformationOptionsResizeWidthHeight() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=18, height=15, maintainAspectRatio=false, percentResize=false,"
                        + " resizeToThumbnail=false, allowEnlargement=false], autoOrient=false]]",
                "allowEnlargement=false "
                        + "maintainAspectRatio=false "
                        + "resizeHeight=15 "
    ...
    public void testImageTransformationOptionsResizePercent() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=-1, height=-1, maintainAspectRatio=false, percentResize=true,"
                        + " resizeToThumbnail=false, allowEnlargement=false], autoOrient=false]]",
                "allowEnlargement=false "
                        + "maintainAspectRatio=false "
    ...
    public void testImageTransformationOptionsPage() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, "
                        ...
                        + "sourceOptions={ PagedSourceOptionsPagedSourceOptions {1, 1}} ]",
                "endPage=0 startPage=0 " + "timeout=-1 ");
    }

    @Test
    // The converter does handle SWFTransformationOptions, but the only use of these is the
    // webpreview rendition that
    ...
    public void testSWFTransformationOptionsPage() {
        ...
        assertConverterToMapAndBack(
                ...
                "{maxSourceSizeKBytes=-1, use=null, contentReaderNodeRef=null, readLimitKBytes=-1,"
                        + " contentWriterNodeRef=null, pageLimit=-1, flashVersion=9, timeoutMs=-1,"
                        + " maxPages=-1, sourceContentProperty=null, targetContentProperty=null,"
                        + " includeEmbedded=null, readLimitTimeMs=-1}",
                "flashVersion=9 " + "timeout=-1 "); // SWFTransformationOptions are not used by
    ...
    public void testRenditionImagepreview() {
        ...
        if (sortedOldOptions.endsWith("timeout=-1 ")) {
            sortedOldOptions =
                    sortedOldOptions.substring(
                            0, sortedOldOptions.length() - "timeout=-1 ".length());
        }

        assertEquals("Maps are different", sortedNewOptions, sortedOldOptions);
    }

    // ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions [width=20,
    // height=30, maintainAspectRatio=true, percentResize=false,
    //                            resizeToThumbnail=false, allowEnlargement=true], autoOrient=true],
    // sourceOptions={ PagedSourceOptionsPagedSourceOptions {1, 1}} ]
    @Test
    public void testResize() {
        ...
        assertConverterToMapAndBack(
                ...
                "ImageTransformationOptions [commandOptions=, resizeOptions=ImageResizeOptions"
                        + " [width=20, height=30, maintainAspectRatio=true, percentResize=false,"
                        + " resizeToThumbnail=false, allowEnlargement=false], autoOrient=true],"
                        + " sourceOptions={ PagedSourceOptionsPagedSourceOptions {1, 1}} ]",
                "allowEnlargement=false "
                        + "autoOrient=true "
                        + "endPage=0 "
    ...
    public void testCommandOptionsFromOldOptions() {
        ...
        assertConverterToMapAndBack(
                ...
                MIMETYPE_IMAGE_JPEG,
                MIMETYPE_IMAGE_PNG,
                "ImageTransformationOptions [commandOptions=-resize 350x50> -background none"
                        + " -gravity center, resizeOptions=null, autoOrient=true]]",
                "autoOrient=true "
                        + // this is a default - so is also set when uploading a logo
