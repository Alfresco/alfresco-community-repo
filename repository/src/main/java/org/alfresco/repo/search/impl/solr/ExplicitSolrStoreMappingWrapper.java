...
public class ExplicitSolrStoreMappingWrapper implements SolrStoreMappingWrapper {
    ...
    private LinkedHashSet<HttpClientAndBaseUrl> httpClientsAndBaseURLs =
            new LinkedHashSet<HttpClientAndBaseUrl>();
    ...
    public void init() {
        ...
        if ((wrapped.getNodes() == null) || (wrapped.getNodes().length == 0)) {
            ...
            // httpClient.getState().setCredentials(new AuthScope(AuthScope.ANY_HOST,
                    ...
                    httpClientsAndBaseURLs.add(
                            new HttpClientAndBaseUrl(
                                    httpClientFactory.getHttpClient(
                                            nodeHost, httpClientFactory.getPort()),
                                    nodeBaseUrl));
                }
            }
        }
    ...
    private String getShards2() {
        try {
            ...
            for (int shard = 0; shard < wrapped.getNumShards(); shard++) {
                ...
                HttpClientAndBaseUrl httpClientAndBaseUrl =
                        httpClientsAndBaseURLs.toArray(new HttpClientAndBaseUrl[0])[nodeId - 1];
    ...
    private static class HttpClientAndBaseUrl {
        ...
        public boolean equals(Object obj) {
            ...
            } else if (!getHost().equals(other.getHost())) return false;
            else if (getPort() != other.getPort()) return false;
            return true;
        }
        ...
        public String toString() {
            return "HttpClientAndBaseUrl [getBaseUrl()="
                    + getBaseUrl()
                    + ", getHost()="
                    + getHost()
                    + ", getPort()="
