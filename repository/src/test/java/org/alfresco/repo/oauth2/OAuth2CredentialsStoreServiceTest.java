...
public class OAuth2CredentialsStoreServiceTest extends BaseSpringTest {
  ...
  private static String TEST_USER_ONE =
    OAuth2CredentialsStoreService.class.getSimpleName() + GUID.generate();
  ...
  public void setUp() throws Exception {
    ...
    oauth2CredentialsStoreService =
      (OAuth2CredentialsStoreService) applicationContext.getBean(
        "oauth2CredentialsStoreService"
      );
  ...
  public void testStorePersonalOAuth2Credentials() {
    ...
    oauth2CredentialsStoreService.storePersonalOAuth2Credentials(
      RemoteSystemId,
      AccessToken,
      RefreshToken,
      ExpiresAt,
    ...
    OAuth2CredentialsInfo oAuth2CredentialsInfo = oauth2CredentialsStoreService.getPersonalOAuth2Credentials(
      RemoteSystemId
    );
    ...
    assertEquals(
      ...
      AccessToken,
      oAuth2CredentialsInfo.getOAuthAccessToken()
    );
    assertEquals(
      "Expect the refresh token will match",
      RefreshToken,
      oAuth2CredentialsInfo.getOAuthRefreshToken()
    );
    assertEquals(
      "Expect that the expiration date will match",
      ExpiresAt,
      oAuth2CredentialsInfo.getOAuthTicketExpiresAt()
    );
    assertEquals(
      "Expect that the issued date will match",
      IssuedAt,
      oAuth2CredentialsInfo.getOAuthTicketIssuedAt()
    );
    ...
    OAuth2CredentialsInfo _oAuth2CredentialsInfo = oauth2CredentialsStoreService.getPersonalOAuth2Credentials(
      RemoteSystemId
    );
    ...
    assertEquals(
      "Expect that access tokens will match",
      UpdatedAccessToken,
      _oAuth2CredentialsInfo.getOAuthAccessToken()
    );
    assertEquals(
      "Expect the refresh token will match",
      UpdatedRefreshToken,
      _oAuth2CredentialsInfo.getOAuthRefreshToken()
    );
    assertEquals(
      "Expect that the expiration date will match",
      UpdatedExpiresAt,
      _oAuth2CredentialsInfo.getOAuthTicketExpiresAt()
    );
    assertEquals(
      "Expect that the issued date will match",
      UpdatedIssuedAt,
      _oAuth2CredentialsInfo.getOAuthTicketIssuedAt()
    );
  }
  ...
  public void testStoreSharedOAuth2Credentials() {
    AuthenticationUtil.setFullyAuthenticatedUser(TEST_USER_ONE);
    //Store new credentials
    oauth2CredentialsStoreService.storeSharedOAuth2Credentials(
      RemoteSystemId,
      AccessToken,
      RefreshToken,
      ExpiresAt,
    ...
    List<OAuth2CredentialsInfo> sharedCredentials = oauth2CredentialsStoreService.listSharedOAuth2Credentials(
      RemoteSystemId
    );
  ...
  public void testSecureUpdateSharedOAuth2Credentials() {
    ...
    OAuth2CredentialsInfo oAuth2CredentialsInfo = sharedCredentials.get(0);
    oauth2CredentialsStoreService.updateSharedOAuth2Credentials(
  ...
  public void testUpdateSharedOAuth2CredentialsTestDeletePesonalOAuth2Credentials() {
    {
      ...
      OAuth2CredentialsInfo oAuth2CredentialsInfo = sharedCredentials.get(0);
      OAuth2CredentialsInfo _oAuth2CredentialsInfo = oauth2CredentialsStoreService.updateSharedOAuth2Credentials(
        oAuth2CredentialsInfo,
        RemoteSystemId,
        UpdatedAccessToken,
        UpdatedRefreshToken,
    ...
    {
      AuthenticationUtil.setFullyAuthenticatedUser(TEST_USER_ONE);
      boolean deleted = oauth2CredentialsStoreService.deletePersonalOAuth2Credentials(
        RemoteSystemId
      );
      ...
      AuthenticationUtil.setFullyAuthenticatedUser(TEST_USER_TWO);
      boolean _deleted = oauth2CredentialsStoreService.deletePersonalOAuth2Credentials(
        RemoteSystemId
      );
  ...
  public void testSecureDeleteSharedOAuth2CredentialsTestDeleteSharedOAuth2Credentials() {
    {
      ...
      OAuth2CredentialsInfo oAuth2CredentialsInfo = sharedCredentials.get(0);
      oauth2CredentialsStoreService.deleteSharedOAuth2Credentials(
        RemoteSystemId,
        oAuth2CredentialsInfo
      );
    }
    ...
    //public void testDeleteSharedOAuth2Credentials()
    {
      ...
      OAuth2CredentialsInfo oAuth2CredentialsInfo = sharedCredentials.get(0);
      boolean deleted = oauth2CredentialsStoreService.deleteSharedOAuth2Credentials(
        RemoteSystemId,
        oAuth2CredentialsInfo
      );
