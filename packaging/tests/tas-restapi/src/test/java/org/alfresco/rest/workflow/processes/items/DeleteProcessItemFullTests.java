...
public class DeleteProcessItemFullTests extends RestTest {
  ...
  public void deleteProcessItemUsingEmptyProcessId() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "The entity with id: ")
      )
  ...
  public void deleteProcessItemByAnyUser() throws Exception {
    ...
    document2 =
      dataContent
        .usingAdmin()
        .usingSite(siteModel)
        .createContent(DocumentType.HTML);
    processItem =
      restClient
        .withWorkflowAPI()
        .usingProcess(processModel)
  ...
  public void deleteProcessItemsForDeletedProcess() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, processModel.getId())
      )
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .containsErrorKey(RestErrorModel.ENTITY_NOT_FOUND_ERRORKEY)
      .stackTraceIs(RestErrorModel.STACKTRACE);
