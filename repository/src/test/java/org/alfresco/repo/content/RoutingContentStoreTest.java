...
public class RoutingContentStoreTest extends AbstractWritableContentStoreTest {
  ...
  public void before() throws Exception {
    ...
    routingStore =
      new RandomRoutingContentStore(storeA, storeB, storeC, storeD);
  }
  ...
  public void testMissingUrl() {
    ...
    assertFalse(
      "Empty reader should say content doesn't exist.",
      reader.exists()
    );
    try {
  ...
  private static class RandomRoutingContentStore
    ...
    protected ContentStore selectWriteStore(ContentContext ctx) {
      ...
      // Nothing found
      fail(
        "A request came for a writer when there is no writable store to choose from"
      );
      return null;
    }
  }
