...
/**
 * An extractor that supports all values and does not conversion. This implementation can be used as
 * a base class, although there is little abstraction necessary for the converters in general.
 *
 * @author Derek Hulley
 * @since 3.2
 */
