...
public class ClearSecurityContextFilter implements Filter {
  ...
  private void logClearContextInfo(ServletRequest servletRequest) {
    ...
    try {
      ...
      sb.append(
        "There was some information still present in the security context for this thread: "
      );
      ...
      sb.append(
        "Other information about leaking ticket and tenant information may follow in the log, " +
      ...
      logger.debug(
        "Error building proper logging message:" + e.getMessage(),
        e
      );
    }
  }
