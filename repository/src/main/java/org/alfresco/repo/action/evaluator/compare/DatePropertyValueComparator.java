...
public class DatePropertyValueComparator implements PropertyValueComparator {
  ...
  private static final String MSGID_INVALID_OPERATION =
    "date_property_value_comparator.invalid_operation";
      ...
      case LESS_THAN_EQUAL:
        {
          result =
            (
              propertyDate.equals(compareDate) ||
              propertyDate.before(compareDate)
            );
          break;
        }
      case GREATER_THAN:
      ...
      case GREATER_THAN_EQUAL:
        {
          result =
            (
              propertyDate.equals(compareDate) ||
              propertyDate.after(compareDate)
            );
          break;
        }
      default:
  ...
  private Date getDate(Serializable value) {
    ...
    throw new AlfrescoRuntimeException(
      "Parameter 'compareValue' must be of type java.util.Date!"
    );
  }
