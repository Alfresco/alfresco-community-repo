...
public class AppendContentStreamTests extends CmisTest {
  ...
  public void siteManagerCanAppendContentToEmptyFileWithVersion()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void siteManagerCanAppendContentToEmptyFileWithNoVersion()
    throws Exception {
  ...
  public void siteManagerCanAppendContentWithLastChunkSetToFalse()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void adminShouldAppendContentToFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void siteManagerShouldAppendContentToFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void contributorShouldAppendContentToFileCreatedBySelf()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(
  ...
  public void contributorCannotAppendContentToFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void collaboratorShouldAppendContentToFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
  ...
  public void collaboratorShouldAppendContentToFileCreatedBySelf()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp = "^.*Cannot perform operation since the node.*is locked.$"
  )
  @TestRail(
    section = { "cmis-api" },
    executionType = ExecutionType.REGRESSION,
  ...
  public void unauthorizedUserCannotAppendContentToFileFromPrivateSite()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, initialContent);
    cmisApi
      .authenticateUser(siteManager)
