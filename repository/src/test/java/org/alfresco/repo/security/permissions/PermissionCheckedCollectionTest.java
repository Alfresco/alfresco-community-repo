...
public class PermissionCheckedCollectionTest extends TestCase {
    ...
    public void testBasicWrapping() throws Exception {
        ...
        Collection<Integer> proxiedList =
                PermissionCheckedCollectionMixin.create(
        ...
        assertTrue(
                "Proxied object must also be a PermissionCheckedCollection",
                proxiedList instanceof PermissionCheckedCollection);
        @SuppressWarnings("unchecked")
        PermissionCheckedCollection<String> proxiedPermissionCheckedCollection =
                (PermissionCheckedCollection<String>) proxiedList;
        assertEquals(
                "cutOff value incorrect", isCutOff, proxiedPermissionCheckedCollection.isCutOff());
        assertEquals(
                "sizeUnchecked value incorrect",
                sizeUnchecked,
                proxiedPermissionCheckedCollection.sizeUnchecked());
        assertEquals(
                "sizeOriginal value incorrect",
                sizeOriginal,
                proxiedPermissionCheckedCollection.sizeOriginal());
    }
