...
public interface MetadataExtracter extends ContentWorker
{
    ...
    public enum OverwritePolicy
    {
         ...
         * 
         * @return Returns a map of all properties that were applied to the target map as well as any null values that weren't applied but were present.
         */
        public Map<QName, Serializable> applyProperties(Map<QName, Serializable> extractedProperties, Map<QName, Serializable> targetProperties)
        {
    ...
    /**
     * Extracts the metadata values from the content provided by the reader and source mimetype to the supplied map. The internal mapping and {@link OverwritePolicy overwrite policy} between document metadata and system metadata will be used.
     * <p>
     * The extraction viability can be determined by an up front call to {@link #isSupported(String)}.
     * <p>
     * The source mimetype <b>must</b> be available on the {@link org.alfresco.service.cmr.repository.ContentAccessor#getMimetype()} method of the reader.
     * 
     * @param reader
     ...
     *            the policy stipulating how the system properties must be overwritten if present
     * @param destination
     *            the map of properties to populate (essentially a return value)
     * @return Returns a map of all properties on the destination map that were added or modified. If the return map is empty, then no properties were modified.
     * @throws ContentIOException
    ...
    /**
     * Extracts the metadata from the content provided by the reader and source mimetype to the supplied map. The mapping from document metadata to system metadata is explicitly provided. The {@link OverwritePolicy overwrite policy} is also explictly set.
     * <p>
     * The extraction viability can be determined by an up front call to {@link #isSupported(String)}.
     * <p>
     * The source mimetype <b>must</b> be available on the {@link org.alfresco.service.cmr.repository.ContentAccessor#getMimetype()} method of the reader.
    ...
    /**
     * Identical to {@link #extract(ContentReader, Map)} but with the addition of the {@code NodeRef} being acted on. By default, the method without the {@code NodeRef} is called.
     *
     * @param nodeRef
