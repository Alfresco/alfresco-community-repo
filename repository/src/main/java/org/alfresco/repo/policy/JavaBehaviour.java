 ...
 *
 * <p>A behavior acts like a delegate (a method pointer). The pointer is represented by an instance
...
public class JavaBehaviour extends BaseBehaviour {
        ...
        try {
            ...
            Method delegateMethod =
                    instanceClass.getMethod(
                            method, (Class[]) policyIFMethods[0].getParameterTypes());
            return new JavaMethodInvocationHandler(this, delegateMethod);
        } catch (NoSuchMethodException e) {
            throw new PolicyException(
                    "Method " + method + " not found or accessible on " + instance.getClass(), e);
        }
    }
    ...
    private static class JavaMethodInvocationHandler implements InvocationHandler {
        ...
        public boolean equals(Object obj) {
            ...
            return behaviour.instance.equals(other.behaviour.instance)
