...
public class AddTaskItemTestsBulk2 extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task item, is falling in case invalid itemBody is provided")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding multiple task item is falling in case empty item body is provided")
    ...
    public void failedAddingTaskVariableIfIncompleteBodyIsProvided() throws Exception {
        RestRequest request =
                RestRequest.requestWithBody(HttpMethod.POST, "{}", "tasks/{taskId}/items", taskId);
