...
public class ComponentsTest extends TestCase {
  ...
  private static ApplicationContext ctx = ApplicationContextHelper.getApplicationContext(
    new String[] { "classpath:module/module-component-test-beans.xml" }
  );
  ...
  public void testImporterModuleComponent() throws Exception {
    ...
    ImporterModuleComponent component = (ImporterModuleComponent) ctx.getBean(
      "module.test.importerComponent"
    );
    // Execute it
    component.execute();
