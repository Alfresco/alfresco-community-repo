...
/**
 * This class is the implementation of the {@link RenditionService}'s "reformat" action/rendering.
 * This action renders a piece of content in the specified target MIME type. This is achieved using
 * one of the standard transformers within the {@link ContentService}.
 *
 * <p>Reformatting in this way is a simple conversion of one MIME type to another MIME type, without
 * any other changes to the content. Therefore there is no support within this action for altering
 * the content e.g. image cropping/resizing.
 *
...
public class ReformatRenderingEngine extends AbstractTransformationRenderingEngine {
    ...
    /**
     * This optional {@link String} parameter is only necessary when converting from pdf to Flash
     * and is used to specify which Flash version to convert to.
     */
    ...
    protected String getTargetMimeType(RenderingContext context) {
        ...
        if (targetMimeType == null) {
            String msg =
                    "The parameter: "
                            + PARAM_MIME_TYPE
                            + " must be explicitly set for this rendering engine!";
            logger.warn(msg);
