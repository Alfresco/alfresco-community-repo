...
public class AlfrescoFunctionEvaluationContext
  ...
  public <Q, S, E extends Throwable> String getLuceneSortField(
    ...
    if (field.startsWith(QueryConstants.PROPERTY_FIELD_PREFIX)) {
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        QName.createQName(field.substring(1))
      );
      ...
      if (propertyDef == null) {
          ...
          propertyDef =
            dictionaryService.getProperty(
              QName.createQName(
                field.substring(
                  1,
                  field.length() - QueryConstants.FIELD_SIZE_SUFFIX.length()
                )
              )
            );
          if (
          ...
          propertyDef =
            dictionaryService.getProperty(
              QName.createQName(
                field.substring(
                  1,
                  field.length() - QueryConstants.FIELD_MIMETYPE_SUFFIX.length()
                )
              )
            );
          if (
        ...
        if (
          ...
          if (
            propertyDef.getIndexTokenisationMode() ==
  ...
  public String getLuceneFieldName(String propertyName) {
    ...
    if (propertyName.startsWith("{")) {
      ...
      if (dictionaryService.getProperty(propertyQName) != null) {
        ...
        throw new FTSQueryException(
          "Unknown property: " + fullQName.toString()
        );
      }
    }
  ...
  public QName stripSuffixes(QName qname) {
    ...
    if (field.endsWith(QueryConstants.FIELD_SIZE_SUFFIX)) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() - QueryConstants.FIELD_SIZE_SUFFIX.length()
        )
      ...
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() - QueryConstants.FIELD_ENCODING_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_TRANSFORMATION_EXCEPTION_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_TRANSFORMATION_EXCEPTION_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_TRANSFORMATION_STATUS_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_TRANSFORMATION_STATUS_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_TRANSFORMATION_TIME_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_TRANSFORMATION_TIME_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_SECOND_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_SECOND_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_MINUTE_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_MINUTE_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_HOUR_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_HOUR_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_DAY_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_DAY_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_DAY_OF_WEEK_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_DAY_OF_WEEK_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_DAY_OF_YEAR_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_DAY_OF_YEAR_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_MONTH_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_MONTH_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_QUARTER_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_QUARTER_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
      ...
      field.endsWith(QueryConstants.FIELD_SOLR_UNIT_OF_TIME_YEAR_SUFFIX)
    ) {
      QName propertyField = QName.createQName(
        field.substring(
          0,
          field.length() -
          QueryConstants.FIELD_SOLR_UNIT_OF_TIME_YEAR_SUFFIX.length()
        )
      );
      PropertyDefinition propertyDef = dictionaryService.getProperty(
        propertyField
