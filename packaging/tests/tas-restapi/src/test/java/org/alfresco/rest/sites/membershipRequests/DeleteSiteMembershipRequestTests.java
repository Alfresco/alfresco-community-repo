...
public class DeleteSiteMembershipRequestTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        moderatedSite =
                dataSite.usingUser(siteCreator)
                        .createSite(
                                new SiteModel(
                                        Visibility.MODERATED, siteId, siteId, siteId, siteId));
        usersWithRoles =
    ...
    public void userCanDeleteHisOwnSiteMembershipRequest() throws Exception {
        restClient
                .authenticateUser(secondSiteCreator)
                .withCoreAPI()
                .usingAuthUser()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to remove his own site memebership request using '-me-' in"
                            + " place of personId and response is successful (204)")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a site memebership request of an inexistent"
                            + " user and response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a site memebership request to an inexistent"
                            + " site and response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    public void adminIsNotAbleToDeleteSiteMembershipRequestToAnInexistentSite() throws Exception {
        ...
        restClient
                ...
                .deleteSiteMembershipRequest(inexistentSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a site memebership request to an empty site"
                            + " id and response is 405")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user is not able to remove a site memebership request of"
                            + " admin to a moderated site and response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    public void contributorIsNotAbleToDeleteSiteMembershipRequestOfAdminToAModeratedSite()
            throws Exception {
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager is able to remove a site memebership request of admin to a"
                            + " moderated site and response is 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    public void managerUserIsAbleToDeleteSiteMembershipRequestOfAdminToAModeratedSite()
            throws Exception {
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
                .usingAuthUser()
                .addSiteMembershipRequest(secondModeratedSite);
        restClient
                .authenticateUser(secondSiteCreator)
                .withCoreAPI()
                .usingUser(adminUserModel)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager is not able to remove a site memebership request if it was"
                            + " already approved and response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    public void managerUserIsNotAbleToDeleteASiteMembershipRequestIfItWasAlreadyApproved()
            throws Exception {
        ...
        workflow.approveSiteMembershipRequest(
                secondSiteCreator.getUsername(),
                secondSiteCreator.getPassword(),
                taskModel.getId(),
                true,
                "Approve");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager is not able to remove an inexitent site memebership request and"
                            + " response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator user is not able to remove a site memebership request of"
                            + " admin to a public site and response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    public void collaboratorIsNotAbleToDeleteSiteMembershipRequestOfAdminToAPublicSite()
            throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingUser(adminUserModel)
                .deleteSiteMembershipRequest(publicSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsErrorKey(RestErrorModel.RELATIONSHIP_NOT_FOUND_ERRORKEY)
    ...
    public void deleteARejectedSiteMembershipRequest() throws Exception {
        ...
        siteMembershipRequests
                .assertThat()
                .entriesListDoesNotContain("id", secondModeratedSite.getId());

        restClient
                .authenticateUser(secondSiteCreator)
                .withCoreAPI()
                .usingUser(userWithRejectedRequests)
                .deleteSiteMembershipRequest(secondModeratedSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a site memebership request-  empty person id"
                            + " and response is 400")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager removes/cancel twice same site memebership request and response"
                            + " is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
