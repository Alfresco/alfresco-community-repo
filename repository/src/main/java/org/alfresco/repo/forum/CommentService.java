...
public interface CommentService {
    /**
     * Thi method retrieves the ancestor in the repository containment hierarchy having the {@link
     * ForumModel#ASPECT_DISCUSSABLE fm:discussable} aspect.
     *
    ...
    /**
     * This method retrieves the {@link ForumModel#TYPE_TOPIC fm:topic} NodeRef which holds the
     * Share comments for the specified {@link ForumModel#ASPECT_DISCUSSABLE fm:discussable} node.
     *
     ...
     */
    NodeRef createComment(
            NodeRef discussableNode, String title, String comment, boolean suppressRollups);
