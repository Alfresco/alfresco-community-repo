...
public class GetAllVersionsTests extends CmisTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        usersWithRoles =
                dataUser.usingUser(siteManager)
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager can not get all versions for a document that was deleted")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can get all versions for a document using"
                            + " OperationContext: OrderBy")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerShouldGetAllVersionsWithOperationContextForADocument() throws Exception {
        OperationContext context =
                cmisApi.authenticateUser(siteManager).getSession().createOperationContext();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can get all versions for a valid checked out document")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator can get all versions for a document created by"
                            + " manager")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer can get all versions for a document created by manager")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user can get all versions for a document in public site")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user cannot get all versions for a document in private"
                            + " site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user cannot get all versions for a document in moderated"
                            + " site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
