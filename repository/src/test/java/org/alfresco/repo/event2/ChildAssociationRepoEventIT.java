...
public class ChildAssociationRepoEventIT extends AbstractContextAwareRepoEvent {
  ...
  public void testAddChildAssociation() {
    ...
    RepoEvent<EventData<NodeResource>> resultRepoEvent = getRepoEventWithoutWait(
      1
    );
    assertEquals(
      "Wrong repo event type.",
    ...
    final RepoEvent<EventData<ChildAssociationResource>> childAssocRepoEvent = getRepoEventWithoutWait(
      3
    );
    ...
    assertNotNull(
      "Repo event ID is not available.",
      childAssocRepoEvent.getId()
    );
    ...
    assertNotNull(
      ...
      childAssocRepoEvent.getTime()
    );
    assertEquals(
      "Invalid repo event datacontenttype",
      "application/json",
      childAssocRepoEvent.getDatacontenttype()
    );
    assertNotNull(childAssocRepoEvent.getDataschema());
    assertEquals(
      EventJSONSchema.CHILD_ASSOC_CREATED_V1.getSchema(),
      childAssocRepoEvent.getDataschema()
    );

    final EventData<ChildAssociationResource> nodeResourceEventData = getEventData(
      childAssocRepoEvent
    );
    ...
    assertEquals(
      "Wrong assoc name",
      "ce:" + assocLocalName,
      childAssociationResource.getAssocQName()
    );
  }
  ...
  public void testRemoveChildAssociation() {
    ...
    checkNumOfEvents(2);
    RepoEvent<EventData<NodeResource>> parentRepoEvent = getRepoEventWithoutWait(
      1
    );
    assertEquals(
      "Wrong repo event type.",
    ...
    RepoEvent<EventData<NodeResource>> childRepoEvent = getRepoEventWithoutWait(
      2
    );
    assertEquals(
      "Wrong repo event type.",
    ...
    assertNotNull(childAssocRepoEvent.getDataschema());
    assertEquals(
      EventJSONSchema.CHILD_ASSOC_DELETED_V1.getSchema(),
      childAssocRepoEvent.getDataschema()
    );
  ...
  public void testOneChildListOfParentsAssociations() {
    ...
    List<NodeRef> parents = Arrays.asList(
      parent1NodeRef,
      parent2NodeRef,
      parent3NodeRef
    );
    ...
    List<RepoEvent<EventData<ChildAssociationResource>>> childAssocEvents = getFilteredEvents(
      EventType.CHILD_ASSOC_CREATED
    );
  ...
  public void testOneChildMultipleParentsSameTransaction() {
    ...
    String assocEventGroupID1 = getEventData(childAssocEvents.get(0))
      .getEventGroupId();
    String assocEventGroupID2 = getEventData(childAssocEvents.get(1))
      .getEventGroupId();
    String assocEventGroupID3 = getEventData(childAssocEvents.get(2))
      .getEventGroupId();
  ...
  public void testOneChildMultipleParentsDifferentTransaction() {
    ...
    assertEquals(
      parent1NodeRef.getId(),
      getChildAssocResource(childAssocEvents.get(0)).getParent().getId()
    );
    assertEquals(
      childNodeRef.getId(),
      getChildAssocResource(childAssocEvents.get(0)).getChild().getId()
    );
    assertEquals(
      "cm:contains",
      getChildAssocResource(childAssocEvents.get(0)).getAssocType()
    );

    assertEquals(
      parent2NodeRef.getId(),
      getChildAssocResource(childAssocEvents.get(1)).getParent().getId()
    );
    assertEquals(
      childNodeRef.getId(),
      getChildAssocResource(childAssocEvents.get(1)).getChild().getId()
    );
    assertEquals(
      "cm:contains",
      getChildAssocResource(childAssocEvents.get(1)).getAssocType()
    );

    assertEquals(
      parent3NodeRef.getId(),
      getChildAssocResource(childAssocEvents.get(2)).getParent().getId()
    );
    assertEquals(
      childNodeRef.getId(),
      getChildAssocResource(childAssocEvents.get(2)).getChild().getId()
    );
    assertEquals(
      "cm:contains",
      getChildAssocResource(childAssocEvents.get(2)).getAssocType()
    );
  }
  ...
  public void testOneParentMultipleChildrenSameTransaction() {
    ...
    List<NodeRef> children = Arrays.asList(
      child1NodeRef,
      child2NodeRef,
      child3NodeRef
    );
    ...
    retryingTransactionHelper.doInTransaction(() -> {
      List<ChildAssociationRef> childAssocParent = nodeService.getChildAssocs(
        parentNodeRef
      );
  ...
  public void testDeleteAssociationsOneChildMultipleParentsSameTransaction() {
    ...
    List<ChildAssociationRef> listChildAssociationRefs = retryingTransactionHelper.doInTransaction(() -> {
        ...
        return Arrays.asList(
          childAssocParent1.get(0),
          childAssocParent2.get(0),
  ...
  public void testUpdateNodeAddChildAssociationNodeEventsFirst() {
    ...
    assertEquals(
      ...
      repoEvents.get(0).getType()
    );
    assertEquals(
      "org.alfresco.event.node.Created",
      repoEvents.get(1).getType()
    );
    assertEquals(
      "org.alfresco.event.node.Updated",
      repoEvents.get(2).getType()
    );
    assertEquals(
      "org.alfresco.event.assoc.child.Created",
      repoEvents.get(3).getType()
    );
  }
}
