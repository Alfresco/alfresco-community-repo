...
/**
 * Provides a default {@link java.util.Map} of registered content stores. Use when the Content Store
 * Selector is not available (e.g on community releases).
 *
 * @since 4.0
 */
public class DefaultContentStoreMapProvider extends AbstractContentStoreMapProvider {
    /**
     * the default store name, should match the default store defined by the content store selector
     * aspect.
     */
