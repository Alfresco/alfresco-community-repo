...
public class RemoteConnectorRequestImpl implements RemoteConnectorRequest {
    ...
    protected static HttpMethodBase buildHttpClientMethod(
            String url, Class<? extends HttpMethodBase> method) {
    ...
    /**
     * An HttpClient Method implementation for the method "TESTING", which we use in certain unit
     * tests
     */
