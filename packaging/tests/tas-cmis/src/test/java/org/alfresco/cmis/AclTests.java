...
public class AclTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Add Acl for valid document with AclPropagation set to REPOSITORYDETERMINED")
    ...
    public void siteManagerCanAddAclWithRepositoryDeterminedPropagation() throws Exception {
        ...
        cmisApi.usingResource(testFile)
                .addAcl(inviteUser, UserRole.SiteContributor, AclPropagation.REPOSITORYDETERMINED)
                .then()
                .assertThat()
    ...
    public void siteManagerCanAddAclWithPropagate() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .assertThat()
                .existsInRepo();
        cmisApi.usingResource(testFolder)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Apply Acl for valid folder with AclPropagation set to REPOSITORYDETERMINED")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Remove Acl for valid folder with AclPropagation set to REPOSITORYDETERMINED")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerCanRemoveAclWithRepositoryDeterminedPropagation() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .addAcl(inviteUser, UserRole.SiteConsumer, AclPropagation.OBJECTONLY)
                .when()
                .removeAcl(inviteUser, UserRole.SiteConsumer, AclPropagation.REPOSITORYDETERMINED)
                .and()
                .assertThat()
                .permissionIsNotSetForUser(inviteUser, UserRole.SiteConsumer);
    }
    ...
    public void siteManagerCanRemoveAclWithObjectOnlyPropagation() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .when()
                .removeAcl(inviteUser, UserRole.SiteContributor, AclPropagation.OBJECTONLY)
                .and()
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Apply Acl by user with collaborator role for document created by manager")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    public void siteManagerCanAddAclWithPermissionMapping() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .assertThat()
                .permissionIsSetForUser(inviteUser, EnumBasicPermissions.CMIS_WRITE.value())
                .then()
    ...
    public void siteManagerCanApplyAclWithPermissionMapping() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .and()
                .assertThat()
                .permissionIsNotSetForUser(inviteUser, EnumBasicPermissions.CMIS_ALL.value());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Remove invalid Acl(that was not set) for valid document with"
                            + " PermissionMapping")
    @Test(
            groups = {"bug-atom-REPO-5383", TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisConstraintException.class,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Apply invalid Acl(that was not set) for valid document with PermissionMapping")
    @Test(
            groups = {"bug-atom-REPO-5383", TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisConstraintException.class,
            expectedExceptionsMessageRegExp = "No matching ACE found to remove!*")
