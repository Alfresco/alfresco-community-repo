...
public class SecondaryTypeDefinitionWrapper
  ...
  protected static final Log logger = LogFactory.getLog(
    SecondaryTypeDefinitionWrapper.class
  );
  ...
  public SecondaryTypeDefinitionWrapper(
    ...
    if (BaseTypeId.CMIS_SECONDARY.value().equals(typeId)) {
      ...
      if (parentQName == null) {
        typeDef.setParentTypeId(
          cmisMapping.getCmisTypeId(CMISMapping.SECONDARY_TYPES_QNAME)
        );
      } else if (cmisMapping.isValidCmisSecondaryType(parentQName)) {
        typeDef.setParentTypeId(
          cmisMapping.getCmisTypeId(BaseTypeId.CMIS_SECONDARY, parentQName)
        );
      } else {
