...
public class RenameFolderTests extends WebDavTest {
  ...
  @TestRail(
    ...
    description = "Verify that admin user can rename folder"
  )
  public void adminShouldRenameFolder() throws Exception {
    ...
    webDavProtocol
      ...
      .then()
      .usingSite(testSite)
      .usingResource(originalFolderModel)
      .assertThat()
      .doesNotExistInRepo();
  }
  ...
  @TestRail(
    section = { TestGroup.PROTOCOLS, TestGroup.WEBDAV },
    executionType = ExecutionType.SANITY,
    description = "Verify that site manager can rename folder"
  )
  ...
  @TestRail(
    section = { TestGroup.PROTOCOLS, TestGroup.WEBDAV },
    executionType = ExecutionType.SANITY,
    description = "Verify that user with contributor role cannot rename folder"
  )
  ...
  @TestRail(
    section = { TestGroup.PROTOCOLS, TestGroup.WEBDAV },
    executionType = ExecutionType.SANITY,
    description = "Verify that user with collaborator role can rename folder"
  )
