...
public abstract class AbstractContentStreamListener implements ContentStreamListener {
     ...
     *
     * <p>The method will be executed inside a retrying transaction helper if one is set. Listeners
     * will not generally require this unless they write to the database.
     *
