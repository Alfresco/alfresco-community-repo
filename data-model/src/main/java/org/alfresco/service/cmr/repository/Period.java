...
/**
 * Implementation for the period data type "d:period" A period is specified by the period type and
 * an optional expression. The string value is periodType|expression Examples are: none day - one
 * day day|3 - 3 days week - one week week|1 - one week week|2 - two weeks month year monthend
 * quarterend The period type specifies a period implementation. This is registered with this class
 * and is used to when adding the period to a date, handles any processing of the expression,
 * reports if the expression is not required, optional or mandatory. The period data type can be
 * also passed as a Map of keys: periodType and expression.
 *
 * @author andyh
 */
...
public class Period implements Serializable {
    ...
    private static transient ConcurrentHashMap<String, PeriodProvider> providers =
            new ConcurrentHashMap<String, PeriodProvider>();
    ...
    public Date getNextDate(Date date) {
        ...
        return provider.getNextDate(
                date, expression != null ? expression : provider.getDefaultExpression());
    }
    ...
    public boolean equals(Object obj) {
        ...
        } else if (!periodType.equals(other.periodType)) return false;
        return true;
    }
