                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() throws Exception {
                        ...
                        Capability capability =
                                capabilityService.getCapability("FileUnfiledRecords");
                    ...
                    public void when() throws Exception {
                        ...
                        rmActionService.executeRecordsManagementAction(
                                dmDocument, FileToAction.NAME, params);
                    }
                    ...
                    public void test(Void result) throws Exception {
                        AuthenticationUtil.runAs(
                                () -> {
                                    ...
                                    assertEquals(
                                            filePlanService.getUnfiledContainer(filePlan), parent);
