...
public class DeleteSiteMemberCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user removes a site member using '-me-' in place of personId and"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can't remove a site membership of an inexistent uer and response"
                            + " is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a member of an inexistent site and response"
                            + " is 404")
    public void userIsNotAbleToRemoveMembershipOfInexistentSite() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingUser(userModel)
                .deleteSiteMember(inexistentSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a member of an empty site id and response is"
                            + " 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a regular member a moderated site and"
                            + " response is 422")
    public void regularUserIsNotAbleToRemoveRegularUserSiteMembershipFromModeratedSite()
            throws Exception {
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addPerson(secondUserModel);
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
                ...
                .addPerson(userModel);
        restClient
                .authenticateUser(secondUserModel)
                .withCoreAPI()
                .usingUser(userModel)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove a regular member of a private site and"
                            + " response is 422")
    public void regularUserIsNotAbleToRemoveRegularUserSiteMembershipFromPrivateSite()
            throws Exception {
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to remove a regular member of a moderated site and"
                            + " response is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to remove a regular member of a private site and response"
                            + " is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove admin membership from public site and"
                            + " response is 422")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove admin membership from moderated site and"
                            + " response is 422")
    public void regularUserIsNotAbleToRemoveAdminSiteMembershipFromModeratedSite()
            throws Exception {
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove admin membership from private site and"
                            + " response is 422")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to remove the membership of a manager from a public site"
                            + " and response is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to remove the membership of a manager from a moderated"
                            + " site and response is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to remove the membership of a manager from a private site"
                            + " and response is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator is not able to remove the membership of a manager from a"
                            + " public site and response is 204")
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator is not able to remove the membership of a manager from a"
                            + " moderated site and response is 204")
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator is not able to remove the membership of a manager from a"
                            + " private site and response is 204")
