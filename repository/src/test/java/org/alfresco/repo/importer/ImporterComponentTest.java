...
public class ImporterComponentTest extends BaseSpringTest {
    ...
    public void before() throws Exception {
        ...
        importerService =
                (ImporterService)
                        applicationContext.getBean(ServiceRegistry.IMPORTER_SERVICE.getLocalName());
    ...
    public void testImportWithAuditableProperties() throws Exception {
        ...
        List<ChildAssociationRef> childAssocs =
                nodeService.getChildAssocs(
                        ...
                        new RegexQNamePattern(
                                NamespaceService.CONTENT_MODEL_1_0_URI, "SpaceWith.*"));
        ...
        String createdDate =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeProps.get(ContentModel.PROP_CREATED));
        String creator =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeProps.get(ContentModel.PROP_CREATOR));
        String modifiedDate =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeProps.get(ContentModel.PROP_MODIFIED));
        String modifier =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeProps.get(ContentModel.PROP_MODIFIER));
        // Check that the cm:auditable properties are correct
        assertEquals(
                "cm:created not preserved during import",
                ISO8601DateFormat.format(ISO8601DateFormat.parse("2009-04-30T23:00:00.000Z")),
                createdDate);
        assertEquals("cm:creator not preserved during import", "Import Creator", creator);
        assertEquals(
                "cm:modified not preserved during import",
                ISO8601DateFormat.format(ISO8601DateFormat.parse("2009-05-01T23:00:00.000Z")),
                modifiedDate);
    ...
    public void testImportWithVersioning() throws Exception {
        ...
        childAssocs =
                nodeService.getChildAssocs(
                        ...
                        RegexQNamePattern.MATCH_ALL,
                        new RegexQNamePattern(
                                NamespaceService.CONTENT_MODEL_1_0_URI, "Versioned Node"));
    ...
    public void testBootstrap() {
        StoreRef bootstrapStoreRef =
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "Test_" + System.currentTimeMillis());
    ...
    public void testImportFoldersUuidBindingNullUuidNullLocationPath() throws Exception {
        ...
        List<ChildAssociationRef> childAssocs =
                nodeService.getChildAssocs(
                        ...
                        RegexQNamePattern.MATCH_ALL,
                        new RegexQNamePattern(
                                NamespaceService.CONTENT_MODEL_1_0_URI, "main folder"));
        ...
        childAssocs =
                nodeService.getChildAssocs(
                        ...
                        RegexQNamePattern.MATCH_ALL,
                        new RegexQNamePattern(
                                NamespaceService.CONTENT_MODEL_1_0_URI, "ArchiveFolder"));
