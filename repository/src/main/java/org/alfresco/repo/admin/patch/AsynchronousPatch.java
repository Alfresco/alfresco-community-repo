...
public abstract class AsynchronousPatch extends AbstractPatch {
  ...
  private static final String MSG_NO_PATCHES_REQUIRED =
    "patch.executer.no_patches_required";
  private static final String MSG_SYSTEM_READ_ONLY =
    "patch.executer.system_readonly";
  ...
  public static class AsynchronousPatchJob implements Job {
    ...
    public void execute(JobExecutionContext context)
      ...
      if (
        asyncPatchObj == null || !(asyncPatchObj instanceof AsynchronousPatch)
      ) {
