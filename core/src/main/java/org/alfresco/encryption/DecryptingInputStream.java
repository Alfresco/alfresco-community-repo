...
public class DecryptingInputStream extends InputStream {
  ...
  public DecryptingInputStream(
    ...
    throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, NoSuchProviderException {
  ...
  public DecryptingInputStream(
    ...
    final SecretKey symKey = new SecretKeySpec(
      rsa.doFinal(readBlock()),
      algorithm
    );
    ...
    final SecretKey macKey = new SecretKeySpec(
      this.inputCipher.doFinal(readBlock()),
      "HMACSHA1"
    );
