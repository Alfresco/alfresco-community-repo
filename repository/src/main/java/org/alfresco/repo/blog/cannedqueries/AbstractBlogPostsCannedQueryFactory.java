...
public abstract class AbstractBlogPostsCannedQueryFactory
  ...
  protected CannedQuerySortDetails createCQSortDetails(
    ...
    List<Pair<? extends Object, SortOrder>> singlePair = new ArrayList<Pair<? extends Object, SortOrder>>(
      1
    );
   ...
   */
  protected static class BlogEntityComparator
    extends PropertyBasedComparator<BlogEntity> {
