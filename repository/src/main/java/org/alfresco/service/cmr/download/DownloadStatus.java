 ...
 *
 * <p>Provides the current status and an indication of the progress. Prgress is measured by
 * comparing done against total. Total gives an indication of the total work, while done indicates
