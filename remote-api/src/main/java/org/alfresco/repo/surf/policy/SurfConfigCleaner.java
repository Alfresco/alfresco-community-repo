...
public class SurfConfigCleaner extends ADMRemoteStore implements BeforeDeleteNodePolicy {
    ...
    public void beforeDeleteNode(NodeRef nodeRef) {
        ...
        // Remove the user Surf config folder, contains dynamic page definitions such as
        // dashboard.xml
        ...
        if (usersFolderRef != null) {
            NodeRef userFolderNodeRef =
                    nodeService.getChildByName(
                            usersFolderRef, ContentModel.ASSOC_CONTAINS, encodePath(userName));
        ...
        // Remove each component Surf config file related to the user, such as the dashboard dashlet
