...
public class GetTaskCandidatesSanityTests extends RestTest {
    ...
    public void getTaskCandidatesByAdmin() throws Exception {
        ...
        candidateModels
                .assertThat()
                .entriesListContains("candidateType", "group")
                .and()
                .entriesListContains(
                        "candidateId", String.format("GROUP_%s", group.getGroupIdentifier()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that user from the assighed group to the process gets task candidates")
    public void getTaskCandidatesByCandidateUser() throws Exception {
        candidateModels =
                restClient
                        .authenticateUser(userModel1)
                        .withWorkflowAPI()
                        .usingTask(taskModel)
                        .getTaskCandidates();
        restClient.assertStatusCodeIs(HttpStatus.OK);
