...
public class DbNodeServiceImplPropagationTest extends BaseSpringTest {
    ...
    /**
     * Tests that the auditable modification details (modified by, modified at) get correctly
     * propagated to the parent, where appropriate, when children are added or removed.
     */
    ...
    public void testAuditablePropagation() throws Exception {
        ...
        assertEquals(
                modified.getTime(),
                ((Date) nodeDAO.getNodeProperty(n2Id, ContentModel.PROP_MODIFIED)).getTime());
        ...
        assertEquals(
                fullyAuthenticatedUser, nodeService.getProperty(n2Ref, ContentModel.PROP_MODIFIER));
        ...
        assertEquals(
                fullyAuthenticatedUser, nodeService.getProperty(n2Ref, ContentModel.PROP_MODIFIER));
        assertEquals(
                fullyAuthenticatedUser, nodeService.getProperty(ac1, ContentModel.PROP_MODIFIER));
        assertEquals(
                fullyAuthenticatedUser, nodeService.getProperty(ac2, ContentModel.PROP_MODIFIER));
        ...
        assertEquals(
                "TestModifierPrnt", nodeService.getProperty(n2Ref, ContentModel.PROP_MODIFIER));
        assertEquals(
                fullyAuthenticatedUser, nodeService.getProperty(ac3, ContentModel.PROP_MODIFIER));
        ...
        assertEquals("TestModifier", nodeService.getProperty(n2Ref, ContentModel.PROP_MODIFIER));
        assertEquals(
                fullyAuthenticatedUser, nodeService.getProperty(ac4, ContentModel.PROP_MODIFIER));
