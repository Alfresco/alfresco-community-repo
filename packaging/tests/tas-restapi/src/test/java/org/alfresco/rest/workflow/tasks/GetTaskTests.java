...
public class GetTaskTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user gets any existing task with Rest API and response is"
                            + " successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify assignee user gets its assigned task with Rest API and response is"
                            + " successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user that started the task gets the started task with Rest API and"
    ...
    @TestRail(
            ...
            description =
                    "Verify any user with no relation to task id forbidden to get other task with"
                            + " Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify candidate user gets its specific task and no other user claimed the"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify involved user in a task without claim it gets the task with Rest API"
                            + " and response is successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user who started a task gets the task with empty taskId with Rest API")
    public void starterUserGetsTaskWithEmptyTaskId() throws Exception {
        ...
        RestTaskModelsCollection tasks =
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user who started a task gets the task with properties parameter with"
                            + " Rest API")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user who started a task gets the task after it is deleted with Rest"
                            + " API")
