...
public class SearcherComponentTest extends BaseSpringTest {
  ...
  private static String COMPLEX_LOCAL_NAME =
    "\u0020\u0060\u00ac\u00a6\u0021\"\u00a3\u0024\u0025\u005e\u0026\u002a\u0028\u0029\u002d\u005f\u003d\u002b\t\n\\\u0000\u005b\u005d\u007b\u007d\u003b\u0027\u0023\u003a\u0040\u007e\u002c\u002e\u002f\u003c\u003e\u003f\\u007c\u005f\u0078\u0054\u0036\u0035\u0041\u005f";

  private static String COMPLEX_LOCAL_NAME_NO_U0000 =
    "\u0020\u0060\u00ac\u00a6\u0021\"\u00a3\u0024\u0025\u005e\u0026\u002a\u0028\u0029\u002d\u005f\u003d\u002b\t\n\\\u005b\u005d\u007b\u007d\u003b\u0027\u0023\u003a\u0040\u007e\u002c\u002e\u002f\u003c\u003e\u003f\\u007c\u005f\u0078\u0054\u0036\u0035\u0041\u005f";
  ...
  public void testNodeXPath() throws Exception {
    Map<QName, ChildAssociationRef> assocRefs = BaseNodeServiceTest.buildNodeGraph(
      nodeService,
      rootNodeRef
    );
    ...
    properties.put(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, COMPLEX_LOCAL_NAME),
      "monkey"
    );
    QName qnamerequiringescaping = QName.createQName(
    ...
    namespacePrefixResolver.registerNamespace(
      BaseNodeServiceTest.TEST_PREFIX,
      BaseNodeServiceTest.NAMESPACE
    );
    ...
    list =
      xpath.selectNodes(new ChildAssociationRef(null, null, null, rootNodeRef));
    ...
    xpath =
      new NodeServiceXPath(
        "/test:" + ISO9075.encode(COMPLEX_LOCAL_NAME),
        documentNavigator,
        null
      );
    list =
    ...
    xpathStr =
      "deref(/test:root_p_n1/test:n1_p_n3/@test:reference, 'test:root_p_n1')";
    xpath = new NodeServiceXPath(xpathStr, documentNavigator, null);
    xpath.addNamespace(
      BaseNodeServiceTest.TEST_PREFIX,
      BaseNodeServiceTest.NAMESPACE
    ...
    xpathStr =
      "deref(/test:root_p_n1/test:n1_p_n3/@test:reference, 'test:root_p_n2')";
    xpath = new NodeServiceXPath(xpathStr, documentNavigator, null);
    xpath.addNamespace(
      BaseNodeServiceTest.TEST_PREFIX,
      BaseNodeServiceTest.NAMESPACE
    ...
    paramDef =
      new QueryParameterDefImpl(
        ...
        true,
        BaseNodeServiceTest.TYPE_QNAME_TEST_CONTENT.toPrefixString(
          namespacePrefixResolver
        )
      );
  ...
  public void testSelectAPI() throws Exception {
    ...
    List<Serializable> attributes = searcher.selectProperties(
      rootNodeRef,
      "//@test:animal",
      null,
      namespacePrefixResolver,
    ...
    NodeRef n1 = assocRefs
      .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n1"))
      .getChildRef();
    NodeRef n2 = assocRefs
      .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n2"))
      .getChildRef();

    answer =
      searcher.selectNodes(
        rootNodeRef,
        "test:root_p_n1 | test:root_p_n2",
        null,
        namespacePrefixResolver,
        false
      );
    ...
    QName qname = QName.createQName(
      BaseNodeServiceTest.NAMESPACE,
      "my@test_with_at_sign"
    );

    Map<QName, Serializable> properties = new HashMap<QName, Serializable>();
    properties.put(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "mytest"),
      "my@test_value_with_at_sign"
    );
    ...
    StringBuffer path = new StringBuffer()
      .append("test:root_p_n1/")
      .append(ISO9075.getXPathName(qname, namespacePrefixResolver));
    answer =
      searcher.selectNodes(
        rootNodeRef,
        path.toString(),
  ...
  public void xtestLikeAndContains() throws Exception {
    ...
    for (
      int i = 0;
      i < COMPLEX_LOCAL_NAME.length() && 1 < roundTrip.length();
      i++
    ) {
      System.out.println(
        "Char at " +
        i +
        " = " +
        Integer.toHexString(COMPLEX_LOCAL_NAME.charAt(i)) +
        "   ...    " +
        Integer.toHexString(roundTrip.charAt(i))
      );
    }
    ...
    assertEquals(1, answer.size());
    assertFalse(
      "Incorrect result: search root node pulled back",
      answer.contains(n1Ref)
    );
    assertTrue(
      "Incorrect result: incorrect node retrieved",
      answer.contains(n3Ref)
    );
  }
