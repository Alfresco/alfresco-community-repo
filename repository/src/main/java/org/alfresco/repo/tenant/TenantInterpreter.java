...
public class TenantInterpreter extends BaseInterpreter
    ...
    public String executeCommand(String line) throws IOException {
        ...
        // TODO - not fully working yet
            ...
            final String tenantAdminUsername =
                    tenantService.getDomainUser(getBaseAdminUsername(), tenantDomain);

            AuthenticationUtil.runAs(
                    new RunAsWork<Object>() {
                        public Object doWork() throws Exception {
                            authenticationService.setAuthentication(
                                    tenantAdminUsername, newPassword.toCharArray());
                            return null;
                        }
                    },
                    tenantAdminUsername);
