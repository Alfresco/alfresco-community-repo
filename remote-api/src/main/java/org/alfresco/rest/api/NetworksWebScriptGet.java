 ...
 *
 */
public class NetworksWebScriptGet
  extends ApiWebScript
  implements RecognizedParamsExtractor, ResponseWriter {
                ...
                .withWriter(
                  ...
                  new Writer() {
                    ...
                    public void writeContents(
                      ...
                      CollectionWithPagingInfo<PersonNetwork> networkMemberships = networks.getNetworks(
                        personId,
                        paging
                      );
                      for (PersonNetwork networkMember : networkMemberships.getCollection()) {
                        ...
                        Object wrapped = helper.processAdditionsToTheResponse(
                          res,
                          Api.ALFRESCO_PUBLIC,
                          NetworksEntityResource.NAME,
                          Params.valueOf(personId, null, req),
                          networkMember
                        );
                      ...
                      objectMapper.writeValue(
                        generator,
                        CollectionWithPagingInfo.asPaged(paging, entities)
                      );
                    }
                  }
                );
