...
public class AuditAppTest extends AbstractSingleNetworkSiteTest {
    ...
    public void setup() throws Exception {
        ...
        AuditModelRegistryImpl auditModelRegistry =
                (AuditModelRegistryImpl) applicationContext.getBean("auditModel.modelRegistry");

        // Register the test model
        URL testModelUrl =
                ResourceUtils.getURL("classpath:alfresco/audit/alfresco-audit-access.xml");
    ...
    public void testGetAuditApp() throws Exception {
...

        {
            ...
            auditApp =
                    auditAppsProxy.getAuditApp(auditApp.getId(), params, HttpServletResponse.SC_OK);
    ...
    private ListResponse<AuditApp> getAuditApps(
            final PublicApiClient.Paging paging, String errorMessage, int expectedStatus)
            throws Exception {
        final AuditApps auditAppsProxy = publicApiClient.auditApps();
        return auditAppsProxy.getAuditApps(createParams(paging), errorMessage, expectedStatus);
    }

    private ListResponse<AuditApp> getAuditApps(final PublicApiClient.Paging paging)
            throws Exception {
    ...
    private String getFirstAuditAppId() throws PublicApiException {
        ...
        // in the system )
        ListResponse<AuditApp> apps =
                publicApiClient
                        .auditApps()
                        .getAuditApps(null, "Getting audit apps error ", HttpServletResponse.SC_OK);
    ...
    public void testEnableDisableAuditApplication() throws Exception {
        ...
        responseAuditApp =
                publicApiClient
                        .auditApps()
                        .updateAuditApp(appId, requestAuditApp, null, HttpServletResponse.SC_OK);
        assertFalse(
                "Wrong response for request to disable audit app.",
                responseAuditApp.getIsEnabled());
        assertFalse(
                "Disable audit app test failed.",
                publicApiClient.auditApps().getAuditApp(appId).getIsEnabled());
        ...
        responseAuditApp =
                publicApiClient
                        ...
                        .updateAuditApp(appId, requestAuditApp, null, HttpServletResponse.SC_OK);
        assertTrue(
                "Wrong response for request to enable audit app.", responseAuditApp.getIsEnabled());
        assertTrue(
                "Enable audit app test failed.",
                publicApiClient.auditApps().getAuditApp(appId).getIsEnabled());
        ...
        publicApiClient
                ...
                .update(
                        ...
                        "badBody",
                        null,
                        "Was expecting error 400",
                        HttpServletResponse.SC_BAD_REQUEST);
        // 401
        setRequestContext(networkOne.getId(), networkAdmin, "fakepswd");
        publicApiClient
                .auditApps()
                .updateAuditApp(appId, requestAuditApp, null, HttpServletResponse.SC_UNAUTHORIZED);
        // 403
        setRequestContext(networkOne.getId(), user1, null);
        publicApiClient
                .auditApps()
                .updateAuditApp(appId, requestAuditApp, null, HttpServletResponse.SC_FORBIDDEN);
        // 404
        setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
        publicApiClient
                .auditApps()
                .updateAuditApp("fakeid", requestAuditApp, null, HttpServletResponse.SC_NOT_FOUND);
        // 501
        AuthenticationUtil.setFullyAuthenticatedUser(networkAdmin);
        disableSystemAudit();
        publicApiClient
                .auditApps()
                .updateAuditApp(
                        appId, requestAuditApp, null, HttpServletResponse.SC_NOT_IMPLEMENTED);
        enableSystemAudit();
    }
    ...
    private void testGetAuditEntries(AuditApps auditAppsProxy, AuditApp auditApp) throws Exception {
        // Positive tests
        ListResponse<AuditEntry> auditEntries =
                auditAppsProxy.getAuditAppEntries(
                        auditApp.getId(), null, HttpServletResponse.SC_OK);
        ...
        auditEntries =
                auditAppsProxy.getAuditAppEntries(
                        auditApp.getId(), params, HttpServletResponse.SC_OK);
        ...
        // When totalItems are retrieved using getAuditEntriesCountByApp() method that was
        // introduced in MNT-21936
        ...
        auditAppsProxy.getAuditAppEntries(
                auditApp.getId(), null, HttpServletResponse.SC_UNAUTHORIZED);
        // 403
        setRequestContext(networkOne.getId(), user1, null);
    ...
    private void testAuditEntriesSorting(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        // paging
        ...
        assertTrue(
                "auditEntries order not valid",
                auditEntries
                        .getList()
                        .get(0)
                        .getCreatedAt()
                        .before(auditEntries.getList().get(1).getCreatedAt()));
    }

    private void testAuditEntriesWhereDate(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        // paging
        Paging paging = getPaging(0, 10);
        ...
        otherParams.put(
                "where",
                "("
                        + org.alfresco.rest.api.Audit.CREATED_AT
                        + " between ("
                        + "\'"
                        + dateBeforeWhere
                        + "\'"
        ...
        //
        // note: sanity test parsing of a few ISO8601 formats (non-exhaustive) - eg. +01:00, +0000,
        // Z
        //
        ...
        otherParams.put(
                ...
                "("
                        ...
                        + "))");
        auditAppsProxy.getAuditAppEntries(
                auditApp.getId(), createParams(paging, otherParams), HttpServletResponse.SC_OK);
    ...
    private void testAuditEntriesWhereId(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        // paging
        Paging paging = getPaging(0, 10);
        ...
        otherParams.put(
                "where",
                "(" + org.alfresco.rest.api.Audit.ID + " between (" + "\'1\' , \'10\'" + "))");
    ...
    private void testAuditEntriesWithInclude(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        Paging paging = getPaging(0, 10);
        Map<String, String> otherParams = new HashMap<>();
        ListResponse<AuditEntry> auditEntriesWithoutValues =
                auditAppsProxy.getAuditAppEntries(
                        auditApp.getId(),
                        createParams(paging, otherParams),
                        HttpServletResponse.SC_OK);
        ...
        ListResponse<AuditEntry> auditEntriesWithValues =
                auditAppsProxy.getAuditAppEntries(
                        auditApp.getId(),
                        createParams(paging, otherParams),
                        HttpServletResponse.SC_OK);
    ...
    private void testAuditEntriesSkipCount(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        int skipCount = 0;
        int maxItems = 4;
        Paging paging = getPaging(skipCount, maxItems);
        ...
        ListResponse<AuditEntry> sublistResponse =
                auditAppsProxy.getAuditAppEntries(
                        auditApp.getId(),
                        createParams(paging, otherParams),
                        HttpServletResponse.SC_OK);
    ...
    private void testRetrieveAuditEntry(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        int skipCount = 0;
        int maxItems = 4;
        Paging paging = getPaging(skipCount, maxItems);
        ...
        // Positive tests
        // 200
        AuditEntry entryResp =
                auditAppsProxy.getAuditEntry(auditApp.getId(), id, null, HttpServletResponse.SC_OK);
        validateAuditEntryFields(entryResp, auditApp);
        assertNotNull(entryResp.getValues());

        // Negative tests
        // 400
        auditAppsProxy.getAuditEntry(
                auditApp.getId(), id + "invalidIdText", null, HttpServletResponse.SC_BAD_REQUEST);
        // 401
        setRequestContext(networkOne.getId(), networkAdmin, "wrongPassword");
        auditAppsProxy.getAuditEntry(
                auditApp.getId(), id, null, HttpServletResponse.SC_UNAUTHORIZED);
        // 403
        setRequestContext(networkOne.getId(), user1, null);
        ...
        disableSystemAudit();
        auditAppsProxy.getAuditEntry(
                auditApp.getId(), id, null, HttpServletResponse.SC_NOT_IMPLEMENTED);
        enableSystemAudit();
    }

    private void testDeleteAuditEntry(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        int skipCount = 0;
        int maxItems = 4;
        Paging paging = getPaging(skipCount, maxItems);
        ...
        // 401
        setRequestContext(networkOne.getId(), networkAdmin, "wrongPassword");
        auditAppsProxy.deleteAuditEntry(
                auditApp.getId(), id, null, HttpServletResponse.SC_UNAUTHORIZED);
        // 403
        setRequestContext(networkOne.getId(), user1, null);
        auditAppsProxy.deleteAuditEntry(
                auditApp.getId(), id, null, HttpServletResponse.SC_FORBIDDEN);
        // 404
        setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
        auditAppsProxy.deleteAuditEntry(
                auditApp.getId(),
        ...
        // 204
        auditAppsProxy.deleteAuditEntry(
                auditApp.getId(), id, null, HttpServletResponse.SC_NO_CONTENT);
    }

    private void testDeleteAuditEntries(AuditApps auditAppsProxy, AuditApp auditApp)
            throws Exception {
        int skipCount = 0;
        int maxItems = 4;
        Paging paging = getPaging(skipCount, maxItems);
        ...
        otherParams.put(
                ...
                "("
                        ...
                        + "\'"
                        + "))");
        auditAppsProxy.deleteAuditEntries(
                auditApp.getId(), otherParams, HttpServletResponse.SC_BAD_REQUEST);

        otherParams.put(
                "where",
                "("
                        + org.alfresco.rest.api.Audit.ID
                        + " between ("
                        + "\'"
                        + lastDeleteEntryId
                        + "\'"
        ...
        setRequestContext(networkOne.getId(), networkAdmin, "wrongPassword");
        auditAppsProxy.deleteAuditEntries(
                auditApp.getId(), otherParams, HttpServletResponse.SC_UNAUTHORIZED);
        // 403
        setRequestContext(networkOne.getId(), user1, null);
        auditAppsProxy.deleteAuditEntries(
                auditApp.getId(), otherParams, HttpServletResponse.SC_FORBIDDEN);
        // 404
        setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
        auditAppsProxy.deleteAuditEntries(
                "invalidAppId", otherParams, HttpServletResponse.SC_NOT_FOUND);
        // 501
        setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
        AuthenticationUtil.setFullyAuthenticatedUser(networkAdmin);
        disableSystemAudit();
        auditAppsProxy.deleteAuditEntries(
                auditApp.getId(), otherParams, HttpServletResponse.SC_NOT_IMPLEMENTED);
        ;
        enableSystemAudit();
        ...
        // 200
        auditAppsProxy.deleteAuditEntries(
                auditApp.getId(), otherParams, HttpServletResponse.SC_NO_CONTENT);
        ...
        resp =
                auditAppsProxy.getAuditAppEntries(
                        auditApp.getId(),
                        createParams(paging, new HashMap<>()),
                        HttpServletResponse.SC_OK);
    ...
    public void testAuditEntriesByNodeId() throws Exception {
        ...
        setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
        String adminNodeId =
                createFolderInPrivateSite("testSiteAdmin" + RUNID, "testFolderAdmin" + RUNID);
        ...
        String nodeId =
                createFolderInPrivateSite("testSiteUser" + RUNID, "testFolderUser1" + RUNID);
    ...
    private void testAuditEntriesSkipCountByNodeId(AuditApps auditAppsProxy, String nodeId)
            throws Exception {
        setRequestContext(user1);
        ...
        ListResponse<AuditEntry> resp =
                auditAppsProxy.getAuditAppEntriesByNodeRefId(
                        nodeId, params, HttpServletResponse.SC_OK);
    ...
    private void testAuditEntriesWithIncludeByNodeId(
            AuditApps auditAppsProxy, String nodeId, AuditApp alfAccessAuditApp) throws Exception {
        setRequestContext(user1);
    ...
    private void testAuditEntriesWhereDateByNodeId(AuditApps auditAppsProxy, String nodeId)
            throws Exception {
        setRequestContext(user1);
        ...
        params = createParams(paging, otherParams);
        auditAppsProxy.getAuditAppEntriesByNodeRefId(
                nodeId, params, HttpServletResponse.SC_BAD_REQUEST);
    }

    private void testAuditEntriesWhereUserByNodeId(
            AuditApps auditAppsProxy, String nodeId, AuditApp alfAccessAuditApp) throws Exception {
        setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
        ...
        otherParams.put(
                "where",
                "("
                        + org.alfresco.rest.api.Audit.CREATED_BY_USER
                        + "="
                        + "'"
                        + networkAdmin
                        + "'"
        ...
        otherParams.put(
                "where",
                "(" + org.alfresco.rest.api.Audit.CREATED_BY_USER + "=" + "'" + "-me-" + "'" + ")");
        params = createParams(paging, otherParams);
        auditEntries =
                auditAppsProxy.getAuditAppEntriesByNodeRefId(
                        nodeId, params, HttpServletResponse.SC_OK);
        ...
        assertTrue(
                "The number of entries should be the same in both GET calls",
                countEntries == auditEntries.getList().size());
        assertNotNull(auditEntries);
        for (AuditEntry ae : auditEntries.getList()) {
            validateAuditEntryFields(ae, alfAccessAuditApp);
    ...
    private void testGetAuditEntriesByNodeId(
            AuditApps auditAppsProxy, String nodeId, AuditApp alfAccessAuditApp) throws Exception {
        setRequestContext(user1);

        ListResponse<AuditEntry> auditEntries =
                auditAppsProxy.getAuditAppEntriesByNodeRefId(
                        nodeId, null, HttpServletResponse.SC_OK);
    ...
    private void testAuditEntriesSortingByNodeId(AuditApps auditAppsProxy, String nodeId)
            throws Exception {
        setRequestContext(user1);
