...
public class NetworkImpl implements Network, Serializable, ExpectedComparison {
  ...
  public static NetworkImpl parseNetwork(JSONObject jsonObject) {
    ...
    List<org.alfresco.rest.api.tests.client.data.Quota> quotas = new ArrayList<org.alfresco.rest.api.tests.client.data.Quota>(
      quotasJSON.size()
    );
    Iterator it = quotasJSON.iterator();
    while (it.hasNext()) {
      JSONObject quotaJSON = (JSONObject) it.next();
      org.alfresco.rest.api.tests.client.data.Quota quota = org.alfresco.rest.api.tests.client.data.Quota.parseQuota(
        quotaJSON
      );
      quotas.add(quota);
    }
  ...
  public void expected(Object o) {
    ...
    if (createdAt != null) {
      try {
        ...
        assertTrue(
          otherCreatedAt.after(created) || otherCreatedAt.equals(created)
        );
