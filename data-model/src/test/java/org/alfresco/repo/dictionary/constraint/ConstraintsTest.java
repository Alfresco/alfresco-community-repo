...
public class ConstraintsTest extends TestCase {
  ...
  public void testCollections() throws Exception {
    ...
    assertEquals(
      "DummyConstraint type should be 'org.alfresco.repo.dictionary.constraint.ConstraintsTest$DummyConstraint'",
      "org.alfresco.repo.dictionary.constraint.ConstraintsTest$DummyConstraint",
      constraint.getType()
    );
    assertNotNull(
      "DummyConstraint should not have empty parameters",
  ...
  private void checkI18NofExceptionMessage(Throwable e) {
    ...
    assertFalse(
      "I18N of constraint message failed",
      msg.startsWith("d_dictionary.constraint")
    );
  }
  ...
  public void testStringLengthConstraint() throws Exception {
    ...
    assertEquals(
      "StringLengthConstraint type should be 'LENGTH'",
      "LENGTH",
      constraint.getType()
    );
    assertNotNull(
      "StringLengthConstraint should have parameters",
      constraint.getParameters()
    );
    assertEquals(
      "StringLengthConstraint should have 2 parameters",
      2,
      constraint.getParameters().size()
    );
    assertEquals(
  ...
  public void testListOfValuesConstraint() throws Exception {
    ...
    assertEquals(
      "ListOfValuesConstraint type should be 'LIST'",
      "LIST",
      constraint.getType()
    );
    assertNotNull(
      "ListOfValuesConstraint should have parameters",
      constraint.getParameters()
    );
    assertEquals(
      "ListOfValuesConstraint should have 3 parameters",
      3,
      constraint.getParameters().size()
    );
    assertEquals(
    ...
    List<String> allowedValuesParam = (List<String>) constraint
      .getParameters()
      .get("allowedValues");
    assertEquals("Should be 4 allowable values", 4, allowedValuesParam.size());
    assertEquals(
      "First allowable value should be 'abc'",
      "abc",
      allowedValuesParam.get(0)
    );
    assertEquals(
      "First allowable value should be 'def'",
      "def",
      allowedValuesParam.get(1)
    );
    assertEquals(
      "First allowable value should be 'ghi'",
      "ghi",
      allowedValuesParam.get(2)
    );
    assertEquals(
      "First allowable value should be ' jkl '",
      " jkl ",
      allowedValuesParam.get(3)
    );
  ...
  public void testNumericRangeConstraint() throws Exception {
    ...
    assertEquals(
      "NumericRangeConstraint type should be 'MINMAX'",
      "MINMAX",
      constraint.getType()
    );
    assertNotNull(
      "NumericRangeConstraint should have parameters",
      constraint.getParameters()
    );
    assertEquals(
      "NumericRangeConstraint should have 2 parameters",
      2,
      constraint.getParameters().size()
    );
    ...
    assertEquals(
      "minValue should be -5",
      -5.0D,
      constraint.getParameters().get("minValue")
    );
    assertEquals(
      "maxValue should be 5",
      5.0D,
      constraint.getParameters().get("maxValue")
    );
  ...
  public void testRegexConstraint() throws Exception {
    ...
    assertEquals(
      "RegexConstraint type should be 'REGEX'",
      "REGEX",
      constraint.getType()
    );
    assertNotNull(
      "RegexConstraint should have parameters",
      constraint.getParameters()
    );
    assertEquals(
      "RegexConstraint should have 2 parameters",
      2,
      constraint.getParameters().size()
    );
    assertEquals(
      "requiresMatch should be true",
      Boolean.TRUE,
      constraint.getParameters().get("requiresMatch")
    );
    assertEquals(
      "expression should be [A-Z]*",
      "[A-Z]*",
