...
/**
 * A helper class for updating and transitioning {@link WorkflowTask WorkflowTasks}. This is a
 * stateful object that accumulates a set of updates to a task and then commits all the updates when
 * either the update() or transition() method is called.
 *
 * @since 3.4
 * @author Nick Smith
 */
