...
public class TestActivities extends EnterpriseTestApi {
  ...
  public void setup() throws Exception {
    ...
    this.network1 =
      repoService.createNetworkWithAlias("activitiesNetwork1", true);
    this.network2 =
      repoService.createNetworkWithAlias("activitiesNetwork2", true);
    this.defaultNetwork =
      repoService.createNetwork(TenantService.DEFAULT_DOMAIN, true);
  ...
  public void testPersonActivities() throws Exception {
    ...
    {
      List<Activity> expectedActivities = TenantUtil.runAsUserTenant(
        new TenantRunAsWork<List<Activity>>() {
          @Override
          public List<Activity> doWork() throws Exception {
            List<Activity> activities = repoService.getActivities(
              person5.getId(),
              null,
              false,
              true
...

      {
        ...
        ListResponse<Activity> response = peopleProxy.getActivities(
          person5.getId(),
          params
        );
        checkList(
    ...
    try {
      List<Activity> activities = TenantUtil.runAsUserTenant(
        new TenantRunAsWork<List<Activity>>() {
          @Override
          public List<Activity> doWork() throws Exception {
            List<Activity> activities = repoService.getActivities(
    ...
    // other user activities
    {
      List<Activity> expectedActivities = TenantUtil.runAsUserTenant(
        new TenantRunAsWork<List<Activity>>() {
          @Override
          public List<Activity> doWork() throws Exception {
            List<Activity> expectedActivities = repoService.getActivities(
              person1.getId(),
              null,
              true,
              false
