...
public class CalendarRecurrenceHelperTest {
  ...
  public void fixOutlookRecurrenceQuirks_GenuineMonthlyRecurrenceParamsLeftAsIs() {
    ...
    Map<String, String> out = CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(
      Params.fromMap(in)
    );
  ...
  public void fixOutLookRecurrenceQuirks_weekdayRecurrenceRule() {
    Map<String, String> recurrenceRule = Params.fromKVPs(
      "FREQ=MONTHLY",
      "BYDAY=MO,TU,WE,TH,FR",
      "INTERVAL=1",
      "BYSETPOS=1"
    );
    Map<String, String> fixedRecurrenceRule = CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(
      Params.fromMap(recurrenceRule)
    );
