...
public class ImapDeleteFolderTests extends EmailTest {
  ...
  @Test(
    groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE },
    enabled = false
  ) //disable since it's failing intermitent
  public void siteManagerShouldDeleteFolderWithCollaboratorMessages()
    throws Exception {
    UserModel collaboratorUser = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(collaboratorUser, testSite, UserRole.SiteCollaborator);
    testFolder = FolderModel.getRandomFolderModel();
    imapProtocol
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void siteManagerShouldDeleteFolderWithContributorMessages()
    throws Exception {
    UserModel contributorUser = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(contributorUser, testSite, UserRole.SiteContributor);
    testFolder = FolderModel.getRandomFolderModel();
    imapProtocol
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void siteManagerShouldDeleteFolderWithConsumerMessages()
    throws Exception {
    UserModel consumerUser = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(consumerUser, testSite, UserRole.SiteContributor);
    testFolder = FolderModel.getRandomFolderModel();
    imapProtocol
      .authenticateUser(testUser)
      .usingSite(testSite)
    ...
    dataUser
      .usingUser(testUser)
      .addUserToSite(consumerUser, testSite, UserRole.SiteConsumer);
    imapProtocol
      .authenticateUser(testUser)
      .usingSite(testSite)
      .usingResource(testFolder)
  ...
  @Test(
    groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL },
    expectedExceptions = FolderNotFoundException.class
  )
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL })
  public void collaboratorTriesToDeleteFolderContainingMessagesByCollaborator()
    throws Exception {
    UserModel collaboratorUser1 = dataUser.createRandomTestUser();
    UserModel collaboratorUser2 = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(collaboratorUser1, testSite, UserRole.SiteCollaborator);
    dataUser
      .usingUser(testUser)
      .addUserToSite(collaboratorUser2, testSite, UserRole.SiteCollaborator);
    testFolder = FolderModel.getRandomFolderModel();

    dataSite.usingUser(collaboratorUser1).usingSite(testSite).setIMAPFavorite();
    imapProtocol
      .authenticateUser(collaboratorUser1)
      .usingSite(testSite)
      .createFolder(testFolder)
      .assertThat()
      .existsInImap()
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL })
  public void contributorTriesToDeleteFolderContainingMessagesByContributor()
    throws Exception {
    UserModel contributorUser1 = dataUser.createRandomTestUser();
    UserModel contributorUser2 = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(contributorUser1, testSite, UserRole.SiteContributor);
    dataUser
      .usingUser(testUser)
      .addUserToSite(contributorUser2, testSite, UserRole.SiteContributor);
    testFolder = FolderModel.getRandomFolderModel();

    dataSite.usingUser(contributorUser1).usingSite(testSite).setIMAPFavorite();
    imapProtocol
      .authenticateUser(contributorUser1)
      .usingSite(testSite)
      .createFolder(testFolder)
      .assertThat()
      .existsInImap()
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL })
  public void consumerTriesToDeleteFolderContainingMessagesByConsumer()
    throws Exception {
    UserModel consumerUser1 = dataUser.createRandomTestUser();
    UserModel consumerUser2 = dataUser.createRandomTestUser();
    dataUser
      .usingUser(testUser)
      .addUserToSite(consumerUser1, testSite, UserRole.SiteCollaborator);
    dataUser
      .usingUser(testUser)
      .addUserToSite(consumerUser2, testSite, UserRole.SiteConsumer);
    testFolder = FolderModel.getRandomFolderModel();

    dataSite.usingUser(consumerUser1).usingSite(testSite).setIMAPFavorite();
    imapProtocol
      .authenticateUser(consumerUser1)
      .usingSite(testSite)
      .createFolder(testFolder)
      .assertThat()
      .existsInImap()
    ...
    dataUser
      .usingUser(testUser)
      .addUserToSite(consumerUser1, testSite, UserRole.SiteConsumer);
    dataSite.usingUser(consumerUser2).usingSite(testSite).setIMAPFavorite();
    imapProtocol
      .authenticateUser(consumerUser2)
      .usingSite(testSite)
      .usingResource(testFolder)
      .delete()
      .assertThat()
  ...
  public void userTriesToDeleteFolderFromALocationToWhichHeDoesNotHavePermissionToDelete()
    throws Exception {
