...
/**
 * {@link WebCredentials} class for holding information related to authentication when using the
 * public API..
 *
 * @author Alex Miller
 */
public class PublicApiCredentials implements WebCredentials {
     ...
     */
    public PublicApiCredentials(
            String authenticatorKey, String user, Map<String, String[]> outboundHeaders) {
