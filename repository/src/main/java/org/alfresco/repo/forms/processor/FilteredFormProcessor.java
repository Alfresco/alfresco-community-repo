...
public abstract class FilteredFormProcessor<ItemType, PersistType>
   ...
   */
  public void setFilterRegistry(
    FilterRegistry<ItemType, PersistType> filterRegistry
  ) {
    this.filterRegistry = filterRegistry;

    if (logger.isDebugEnabled()) logger.debug(
      "Set filter registry: " + this.filterRegistry + " for processor: " + this
    );
  }
  ...
  protected void internalGenerate(
    ...
    FormCreationData data = new FormCreationDataImpl(
      itemData,
      forcedFields,
      context
    );
    populateForm(form, fields, data);
    if (log.isDebugEnabled()) log.debug("Generated form: " + form); //
  }
   ...
   */
  public void setFieldProcessorRegistry(
