        ...
        doTestInTransaction(
                new Test<Void>() {
                    public Void run() {
                        ...
                        Set<Role> rolesIncludingSystemRoles =
                                filePlanRoleService.getRoles(filePlan, true);
                        assertNotNull(rolesIncludingSystemRoles);
                        assertTrue(roles.size() != 0);
                        assertTrue(roles.size() == rolesIncludingSystemRoles.size());

                        Set<Role> rolesWithoutSystemRoles =
                                filePlanRoleService.getRoles(filePlan, false);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    public Void run() {
                        ...
                        Set<Role> rolesIncludingSystemRoles =
                                filePlanRoleService.getRolesByUser(filePlan, rmUserName, true);
                        assertNotNull(rolesIncludingSystemRoles);
                    ...
                    public Void run() {
                        Role role =
                                filePlanRoleService.getRole(
                                        filePlan, FilePlanRoleService.ROLE_POWER_USER);
                        assertNotNull(role);
                    ...
                    public Void run() {
                        ...
                        Role role =
                                filePlanRoleService.createRole(
                                        filePlan, "Michelle Holt", "Michelle Holt", caps);
                        assertNotNull(role);
                        ...
                        role =
                                filePlanRoleService.updateRole(
                                        filePlan, "Michelle Holt", "Michelle Wetherall", caps);
                        assertNotNull(role);
                        assertEquals("Michelle Holt", role.getName());
                ...
                new Test<Void>() {
                    public Void run() {
                        ...
                        filePlanRoleService.assignRoleToAuthority(
                                filePlan, FilePlanRoleService.ROLE_RECORDS_MANAGER, rmUserName);
