...
public class ApplicationContextInit extends ExternalResource {
    public static final String GLOBAL_INTEGRATION_TEST_CONFIG =
    ...
    /**
     * Construct a JUnit rule which will bring up a spring ApplicationContext based on the default
     * Alfresco spring context.
     */
    ...
    /**
     * Construct a JUnit rule which will bring up an ApplicationContext based on the specified
     * spring contexts.
     *
    ...
    public ApplicationContextInit(String... configLocations) {
        ...
        // Yes, this will mean that devs cannot override that context file, but it's almost empty
        // anyway.
    ...
    /**
     * This factory method constructs a JUnit rule which will bring up an ApplicationContext
     * consisting of the default Alfresco context with any additionConfigLocations appended. It is a
     * convenient way to specify override contexts in test code.
     *
     * @param additionalConfigLocations addition config locations containing additional or
     *     overriding beans.
     */
    public static ApplicationContextInit createStandardContextWithOverrides(
    ...
    protected void before() {
        log.debug(
                "Initialising custom Spring Configuration: "
                        + Arrays.asList(configLocations).toString());
