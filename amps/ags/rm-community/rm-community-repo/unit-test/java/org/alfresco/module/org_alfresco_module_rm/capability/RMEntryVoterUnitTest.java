...
public class RMEntryVoterUnitTest extends BaseUnitTest {
  ...
  public void alreadyVoting() throws Exception {
    ...
    MethodInvocation mockedMethodInvocation = createMethodInvoation(
      "myTestMethod",
      NodeRef.class
    );
    net.sf.acegisecurity.ConfigAttributeDefinition mockedConfigDef = createConfigDefinition(
      "RM.invalid"
    );
  ...
  private net.sf.acegisecurity.ConfigAttributeDefinition createConfigDefinition(
    String value
  ) {
    net.sf.acegisecurity.ConfigAttributeDefinition mockedConfig = mock(
      net.sf.acegisecurity.ConfigAttributeDefinition.class
    );
   ...
   */
  private MethodInvocation createMethodInvoation(
    String methodName,
    ...
    Method method =
      RMEntryVoterUnitTest.class.getMethod(methodName, parameterTypes);
