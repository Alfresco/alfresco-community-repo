...
public interface ContentAccessor {
     ...
     *
     * <p>This method can only be used before the content stream has been retrieved.
     *
     * <p>When the stream has been closed, all listeners will be called. The listener is responsible
     * for using a retrying transaction to protect the implementation of the callback when required.
     *
     * @param listener a listener that will be called for output stream event notification
     */
     ...
     *
     * <p>The content {@link #setMimetype(String) mimetype } must be set before this method is
     * called as the content data requires a mimetype whenever the content URL is specified.
     *
     ...
     *
     * <p>When dealing with a {@link ContentWriter}, you may wish to use {@link
     * ContentWriter#guessMimetype(String)} to have this set for you based on the filename and
     * contents.
     *
     ...
     *
     * <p>When dealing with a {@link ContentWriter}, you may wish to use {@link
     * ContentWriter#guessMimetype(String)} to have this set for you based on the contents.
     *
