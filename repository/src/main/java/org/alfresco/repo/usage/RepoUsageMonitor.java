...
public class RepoUsageMonitor
  ...
  public static final QName LOCK_USAGE = QName.createQName(
  ...
  public void checkUsages() {
    final RetryingTransactionCallback<Void> checkWork = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        if (
          restrictions.getUsers() == null && restrictions.getDocuments() == null
        ) {
    ...
    try {
      ...
      if (lockToken != null) {
        try {
          ...
          logger.debug(
            "Failed to release lock for usage monitor: " + e.getMessage()
          );
        }
      }
    }
  ...
  public static class RepoUsageMonitorJob implements Job {
    ...
    public void execute(final JobExecutionContext context)
      ...
      final RepoUsageMonitor repoUsageMonitor = (RepoUsageMonitor) jdm.get(
        "RepoUsageMonitor"
      );
