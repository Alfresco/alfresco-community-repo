...
/**
 * Utility class containing some useful methods to help when writing tests that require
 * authenticated users
 *
...
public abstract class TestWithUserUtils {
    ...
    /**
     * Authenticate as the given user. If the user does not exist, then authenticate as the system
     * user and create the authentication first.
     */
    public static void authenticateUser(
            String userName,
            String password,
