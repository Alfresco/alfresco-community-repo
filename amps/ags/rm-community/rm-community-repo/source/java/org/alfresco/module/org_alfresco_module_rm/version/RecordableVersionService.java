...
public interface RecordableVersionService {
     ...
     *
     * <p>Returns false if not versionable or no version.
     *
     ...
     *
     * <p>Does not create a record if the node is not versionable or the latest version is already
     * recorded.
     *
     * @param nodeRef node reference
     ...
     * @param nodeRef node reference
     * @param autoVersion true, create new record version from latest version, false creates a
     *     record from the latest frozen version
     * @return NodeRef node reference to the created record.
     */
     ...
     *
     * <p>Note this method does not destroy the associated record, instead it marks the version as
     * destroyed.
     *
     * @param version version
     */
     ...
     *
     * @return boolean true to auto-version on record creation, false to use latest versioned
     *     version
     */
