    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        public void given() {
          ...
          DispositionSchedule dispositionSchedule1 = dispositionService.createDispositionSchedule(
            category1,
            dsProps
          );
          ...
          // applied on Record
          DispositionSchedule dispositionSchedule2 = dispositionService.createDispositionSchedule(
            category2,
            dsProps
          );
          ...
          NodeRef folder2 = recordFolderService.createRecordFolder(
            category2,
            GUID.generate()
          );
          NodeRef record2 = recordService.createRecordFromContent(
            folder2,
            GUID.generate(),
            TYPE_CONTENT,
            null,
          ...
          relationshipService.addRelationship(
            CUSTOM_REF_CROSSREFERENCE.getLocalName(),
            record1,
            record2
          );
          ...
          transferFolder =
            (NodeRef) rmActionService
              .executeRecordsManagementAction(record2, TransferAction.NAME)
              .getValue();
        }
        ...
        public void then() {
          // 9. Verify Record1
          assertTrue(
            dispositionService.isNextDispositionActionEligible(record1)
          );
        }
      }
    );
