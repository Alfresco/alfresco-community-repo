...
public class OAuth2CredentialsStoreServiceImpl
   ...
   */
  @Override
  public OAuth2CredentialsInfo storePersonalOAuth2Credentials(
    ...
    OAuth2CredentialsInfo credentials = buildPersonalOAuth2CredentialsInfo(
      remoteSystemId,
      accessToken,
      refreshToken,
      expiresAt,
    ...
    if (credentials.getNodeRef() != null) {
      return (OAuth2CredentialsInfo) remoteCredentialsService.updateCredentials(
        credentials
      );
    } else {
   ...
   */
  @Override
  public OAuth2CredentialsInfo storeSharedOAuth2Credentials(
    String remoteSystemId,
    String accessToken,
    String refreshToken,
    Date expiresAt,
    ...
    OAuth2CredentialsInfo credentials = buildSharedOAuth2CredentialsInfo(
      remoteSystemId,
      accessToken,
      refreshToken,
      expiresAt,
  ...
  public OAuth2CredentialsInfo updateSharedOAuth2Credentials(
    ...
    List<OAuth2CredentialsInfo> shared = listSharedOAuth2Credentials(
      remoteSystemId
    );
   ...
   * @return OAuth2CredentialsInfo
   */
  private OAuth2CredentialsInfo buildPersonalOAuth2CredentialsInfo(
    String remoteSystemId,
    String accessToken,
    String refreshToken,
    Date expiresAt,
    ...
    OAuth2CredentialsInfoImpl existing = (OAuth2CredentialsInfoImpl) getPersonalOAuth2Credentials(
      remoteSystemId
    );
    if (existing != null) {
   ...
   * @return OAuth2CredentialsInfo
   */
  private OAuth2CredentialsInfo buildSharedOAuth2CredentialsInfo(
    String remoteSystemId,
    String accessToken,
    String refreshToken,
    Date expiresAt,
   ...
   */
  @Override
  public OAuth2CredentialsInfo getPersonalOAuth2Credentials(
    String remoteSystemId
  ) throws NoSuchSystemException {
    return (OAuth2CredentialsInfo) remoteCredentialsService.getPersonCredentials(
      remoteSystemId
    );
  }
   ...
   */
  @Override
  public List<OAuth2CredentialsInfo> listSharedOAuth2Credentials(
    String remoteSystemId
  ) throws NoSuchSystemException {
    ...
    PagingResults<OAuth2CredentialsInfo> pagingResults = (PagingResults<OAuth2CredentialsInfo>) remoteCredentialsService.listSharedCredentials(
      remoteSystemId,
  ...
  public boolean deletePersonalOAuth2Credentials(String remoteSystemId)
    throws NoSuchSystemException {
    OAuth2CredentialsInfo credentials = getPersonalOAuth2Credentials(
      remoteSystemId
    );
  ...
  @Override
  public boolean deleteSharedOAuth2Credentials(
    String remoteSystemId,
   ...
   */
  @Override
  public OAuth2CredentialsInfo updateCredentialsAuthenticationSucceeded(
    boolean succeeded,
    OAuth2CredentialsInfo credentials
  ) {
    return (OAuth2CredentialsInfo) remoteCredentialsService.updateCredentialsAuthenticationSucceeded(
      succeeded,
      credentials
    );
  }
