...
/**
 * Provides matching between {@link org.alfresco.service.namespace.QName qnames} using regular
 * expression matching.
 *
 * <p>A simple {@link #MATCH_ALL convenience} pattern matcher is also provided that will match any
 * qname.
 *
...
public class RegexQNamePattern implements QNamePattern {
    ...
    /**
     * @param combinedPattern a regex pattern that will be applied to the full qname string
     *     representation
     * @see QName#toString()
     */
    ...
    public boolean isMatch(QName qname) {
        ...
        if (combinedPattern != null) {
            ...
            match =
                    (qname.getNamespaceURI().matches(namespaceUriPattern)
