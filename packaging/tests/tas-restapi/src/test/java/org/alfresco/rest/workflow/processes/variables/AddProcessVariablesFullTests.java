...
public class AddProcessVariablesFullTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variables is falling in case invalid type prefix is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variables is falling in case invalid variableBody (adding extra"
                            + " parameter in body:scope) is provided")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void failedAddingProcessVariableIfInvalidBodyIsProvided() throws Exception {
        ...
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST,
                        "{\"name\": \"variableName\",\"scope\": \"local\",\"value\":"
                                + " \"testing\",\"type\": \"d:text\"}",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variables is falling in case invalid name is provided: ony"
                            + " white spaces")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Adding process variables is falling in case invalid name is provided: symbols")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void failedAddingMultipleProcessVariablesInvalidType() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNSUPPORTED_TYPE, "d:string"))
