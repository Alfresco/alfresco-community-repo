...
public abstract class AbstractInvitationServiceImplTest extends BaseAlfrescoSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.workflowAdminService =
                (WorkflowAdminServiceImpl)
                        applicationContext.getBean(WorkflowAdminServiceImpl.NAME);
        ...
        mailService =
                (MailActionExecuter)
                        ((ApplicationContextFactory)
                                        this.applicationContext.getBean("OutboundSMTP"))
        ...
        createPerson(
                USER_TWO, USER_TWO + "@alfrescotesting.com", PERSON_FIRSTNAME, PERSON_LASTNAME);
        createPerson(
                USER_EVE, USER_EVE + "@alfrescotesting.com", PERSON_FIRSTNAME, PERSON_LASTNAME);
    ...
    /**
     * MNT-9101 An internal user account (disabled) should not be deleted if an associated nominated
    ...
    public void testInternalUserNotDeletedAfterInviteCancelled() throws Exception {
        ...
        try {
            ...
            assertTrue(
                    "Incorrect exception was thrown", ex instanceof InvitationExceptionUserError);
        }
    ...
    public void testExternalUserDeletedAfterInviteCancelled() throws Exception {
        ...
        NominatedInvitation nominatedInvitation =
                invitationService.inviteNominated(
                        inviteeFirstName,
                        inviteeLastName,
                        inviteeEmail,
    ...
    public void testNominatedInvitationNewUser() throws Exception {
        ...
        assertEquals(
                "first name wrong", inviteeFirstName, nominatedInvitation.getInviteeFirstName());
        ...
        assertEquals(
                "resource type name wrong", resourceType, nominatedInvitation.getResourceType());
        ...
        /** Check the email itself, and check it is as we would expect it to be */
        {
        ...
        List<Invitation> invitations =
                invitationService.listPendingInvitationsForResource(resourceType, resourceName);
        ...
        NominatedInvitation acceptedInvitation =
                (NominatedInvitation)
                        invitationService.accept(
                                firstInvite.getInviteId(), firstInvite.getTicket());
        assertEquals(
                "invite id wrong", firstInvite.getInviteId(), acceptedInvitation.getInviteId());
        assertEquals(
                "first name wrong", inviteeFirstName, acceptedInvitation.getInviteeFirstName());
        ...
        NominatedInvitation acceptedInvitation2 =
                (NominatedInvitation) invitationService.getInvitation(firstInvite.getInviteId());
        ...
        /** Check that system generated invitations can work as well */
        {
            ...
            // Check invitiation
            NominatedInvitation nominatedInvitation2 =
                    invitationService.inviteNominated(
                            inviteeFirstName,
                            inviteeLastName,
                            USER_TWO_EMAIL,
            ...
            assertEquals(
                    "last name wrong", inviteeLastName, nominatedInvitation2.getInviteeLastName());
            assertEquals(
                    "email name wrong", USER_TWO_EMAIL, nominatedInvitation2.getInviteeEmail());
    ...
    public void testNominatedInvitationNewUserReject() throws Exception {
        ...
        NominatedInvitation rejectedInvitation =
                (NominatedInvitation)
                        invitationService.reject(nominatedInvitation.getInviteId(), "dont want it");
        assertEquals(
                "invite id wrong",
                nominatedInvitation.getInviteId(),
                rejectedInvitation.getInviteId());
        assertEquals(
                "first name wrong", inviteeFirstName, rejectedInvitation.getInviteeFirstName());
    ...
    public void testNominatedInvitationNewUserSameEmails() throws Exception {
        ...
        NominatedInvitation nominatedInvitationA =
                invitationService.inviteNominated(
                        inviteeAFirstName,
                        inviteeALastName,
                        inviteeEmail,
        ...
        assertEquals(
                "first name wrong", inviteeAFirstName, nominatedInvitationA.getInviteeFirstName());
        assertEquals(
                "last name wrong", inviteeALastName, nominatedInvitationA.getInviteeLastName());
        ...
        NominatedInvitation nominatedInvitationB =
                invitationService.inviteNominated(
                        inviteeBFirstName,
                        inviteeBLastName,
                        inviteeEmail,
        ...
        assertEquals(
                "first name wrong", inviteeBFirstName, nominatedInvitationB.getInviteeFirstName());
        assertEquals(
                "last name wrong", inviteeBLastName, nominatedInvitationB.getInviteeLastName());
        ...
        NominatedInvitation acceptedInvitationA =
                (NominatedInvitation)
                        invitationService.accept(inviteAId, nominatedInvitationA.getTicket());
        assertEquals("invite id wrong", inviteAId, acceptedInvitationA.getInviteId());
        assertEquals(
                "first name wrong", inviteeAFirstName, acceptedInvitationA.getInviteeFirstName());
        ...
        NominatedInvitation acceptedInvitationB =
                (NominatedInvitation)
                        invitationService.accept(inviteBId, nominatedInvitationB.getTicket());
        assertEquals("invite id wrong", inviteBId, acceptedInvitationB.getInviteId());
        assertEquals(
                "first name wrong", inviteeBFirstName, acceptedInvitationB.getInviteeFirstName());
    ...
    public void testMNT11775() throws Exception {
        ...
        ModeratedInvitation invitation =
                invitationService.inviteModerated(
                        comments, inviteeUserName, resourceType, resourceName, inviteeRole);
        ...
        try {
            ...
            assertTrue(
                    "Email message doesn't contain review comment", emailMsg.contains("Go away!"));
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public void test_MNT15614() throws Exception {
        ...
        for (String siteName : siteNames) {
            ...
            assertEquals(
                    ...
                    siteService.getMembersRole(siteName, AuthenticationUtil.getAdminUserName()));
    ...
    public void testNominatedInvitationNewUserWhitespace() throws Exception {
        ...
        NominatedInvitation acceptedInvitation =
                (NominatedInvitation)
                        invitationService.accept(invitation.getInviteId(), invitation.getTicket());
     ...
     *
     * <p>A1. Create a Nominated Invitation (for existing user, USER_ONE) A2. Read it A3. Search for
     * it. A4. Cancel it A5. Search for it again (and fail to find it)
     *
     * <p>B1. Create a Nominated Invitation B2. Read it B3. Search for it B4. Reject it
     *
     * <p>C1. Create a Nominated Invitation C2. Read it C3. Accept it C4. Verify ACL
     *
    ...
    protected void testNominatedInvitationExistingUser(boolean requireAcceptance) throws Exception {
        ...
        if (requireAcceptance) {
            ...
            String inviteId = nominatedInvitation.getInviteId();
            assertEquals(
                    "user name wrong", inviteeUserName, nominatedInvitation.getInviteeUserName());
            assertEquals(
                    "resource type name wrong",
                    resourceType,
                    nominatedInvitation.getResourceType());
            assertEquals(
                    "resource name wrong", resourceName, nominatedInvitation.getResourceName());
            assertEquals("role  name wrong", inviteeRole, nominatedInvitation.getRoleName());
            assertEquals("server path wrong", serverPath, nominatedInvitation.getServerPath());
            assertEquals("accept URL wrong", acceptUrl, nominatedInvitation.getAcceptUrl());
            assertEquals("reject URL wrong", rejectUrl, nominatedInvitation.getRejectUrl());
            ...
            assertEquals(
                    "last name wrong", inviteeLastName, nominatedInvitation.getInviteeLastName());
            assertEquals("email name wrong", inviteeEmail, nominatedInvitation.getInviteeEmail());
            ...
            NominatedInvitation canceledInvitation =
                    (NominatedInvitation) invitationService.cancel(inviteId);
            assertEquals("invite id wrong", inviteId, canceledInvitation.getInviteId());
            assertEquals(
                    "first name wrong", inviteeFirstName, canceledInvitation.getInviteeFirstName());
            assertEquals(
                    "last name wrong", inviteeLastName, canceledInvitation.getInviteeLastName());
            assertEquals(
                    "user name wrong", inviteeUserName, canceledInvitation.getInviteeUserName());
            ...
            NominatedInvitation secondInvite =
                    invitationService.inviteNominated(
                            inviteeUserName,
                            resourceType,
                            resourceName,
            ...
            NominatedInvitation rejectedInvitation =
                    (NominatedInvitation) invitationService.cancel(secondInvite.getInviteId());
            assertEquals(
                    "invite id wrong",
                    secondInvite.getInviteId(),
                    rejectedInvitation.getInviteId());
            assertEquals(
                    "user name wrong", inviteeUserName, rejectedInvitation.getInviteeUserName());
        ...
        NominatedInvitation thirdInvite =
                invitationService.inviteNominated(
                        inviteeUserName,
                        resourceType,
                        resourceName,
        ...
        if (requireAcceptance) {
            NominatedInvitation acceptedInvitation =
                    (NominatedInvitation)
                            invitationService.accept(
                                    thirdInvite.getInviteId(), thirdInvite.getTicket());
            assertEquals(
                    "invite id wrong", thirdInvite.getInviteId(), acceptedInvitation.getInviteId());
            assertEquals(
                    "first name wrong", inviteeFirstName, acceptedInvitation.getInviteeFirstName());
            assertEquals(
                    "last name wrong", inviteeLastName, acceptedInvitation.getInviteeLastName());
            assertEquals(
                    "user name wrong", inviteeUserName, acceptedInvitation.getInviteeUserName());
        }
    ...
    /**
     * Create a moderated invitation Get it Search for it Cancel it Create a moderated invitation
     * Reject the invitation Create a moderated invitation Approve the invitation
     */
    @Test
    ...
    public void testModeratedApprove() {
        ...
        /** Negative test attempt to approve an invitation that has aready been approved */
        try {
    ...
    public void testSearchInvitation() {
        /**
         * Make up a tree of invitations and then search Resource, User, Workflow 1) RED, One,
         * Moderated 2) RED, One, Nominated 3) BLUE, One, Nominated 4) RED, Two, Moderated
         */
        Invitation.ResourceType resourceType = Invitation.ResourceType.WEB_SITE;
        String inviteeRole = SiteModel.SITE_COLLABORATOR;
        String comments = "please sir, let me in!";
        ...
        this.authenticationComponent.setCurrentUser(USER_MANAGER);
        invitationService.inviteModerated(
                comments, USER_ONE, resourceType, SITE_SHORT_NAME_RED, inviteeRole);
        ...
        NominatedInvitation invitationThree =
                invitationService.inviteNominated(
                        USER_ONE,
                        resourceType,
                        SITE_SHORT_NAME_BLUE,
        ...
        invitationService.inviteModerated(
                comments, USER_TWO, resourceType, SITE_SHORT_NAME_RED, inviteeRole);

        /**
         * Search for invitations for BLUE - no pending invite since the user is added directly
         * without waiting for the user to accept it
         */
        List<Invitation> resOne =
                invitationService.listPendingInvitationsForResource(
                        ResourceType.WEB_SITE, SITE_SHORT_NAME_BLUE);
        assertEquals("blue invites not 0", 0, resOne.size());

        /**
         * Search for invitations for RED - no pending nominated invites since the user is added
         * directly without waiting for the user to accept it
         */
        List<Invitation> resTwo =
                invitationService.listPendingInvitationsForResource(
                        ResourceType.WEB_SITE, SITE_SHORT_NAME_RED);
    ...
    public void testSearchInvitationWithLimit() throws Exception {
        ...
        // Invite USER_TWO
        NominatedInvitation inviteForUserTwo =
                invitationService.inviteNominated(
                        USER_TWO,
                        resourceType,
                        resourceName,
    ...
    /**
     * MNT-17341 : External users with Manager role cannot invite other external users to the site
     * because site invitation accept fails
     */
    @Test
    public void testExternalUserManagerInvitingAnotherExternalUser() throws Exception {
        ...
        invitationService.accept(
                nominatedInvitation.getInviteId(), nominatedInvitation.getTicket());
        ...
        assertNotNull("nominated invitation is null", nominatedInvitation2);
        assertEquals(
                "first name wrong", inviteeFirstName2, nominatedInvitation2.getInviteeFirstName());
        assertEquals(
                "last name wrong", inviteeLastName2, nominatedInvitation2.getInviteeLastName());
        ...
        assertTrue(
                "user should have the ASPECT_ANULLABLE aspect since the invitation hasn't been"
                        + " accepted yet",
                nodeService.hasAspect(person, ContentModel.ASPECT_ANULLABLE));

        // authenticated as external user 2 accept the invitation
        Invitation acceptedNominatedInvitation2 =
                invitationService.accept(
                        nominatedInvitation2.getInviteId(), nominatedInvitation2.getTicket());
        ...
        Invitation invitation =
                invitationService.getInvitation(acceptedNominatedInvitation2.getInviteId());
        assertEquals(
