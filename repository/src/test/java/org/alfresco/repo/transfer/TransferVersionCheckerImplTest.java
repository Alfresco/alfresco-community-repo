  ...
  public void testTransferVersionCheckerImpl() {
    ...
    assertTrue(
      ...
      checker.checkTransferVersions(
        e,
        new TransferVersionImpl("3", "3", "1", EDITION)
      )
    );
    assertTrue(
      "not equals",
      checker.checkTransferVersions(
        e,
        new TransferVersionImpl("3", "3", "2", EDITION)
      )
    );
    ...
    assertTrue(
      ...
      checker.checkTransferVersions(
        e,
        new TransferVersionImpl("3", "4", "0", EDITION)
      )
    );
    assertFalse(
      ...
      checker.checkTransferVersions(
        e,
        new TransferVersionImpl("4", "3", "0", EDITION)
      )
    );
    assertTrue(
      ...
      checker.checkTransferVersions(
        e,
        new TransferVersionImpl("3", "3", "0", "Whatever")
      )
    );
    assertTrue(
      ...
      checker.checkTransferVersions(
        e,
        new TransferVersionImpl("3", "3", "0", null)
      )
    );
  }
}
