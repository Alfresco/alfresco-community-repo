...
public interface NodeService {
  ...
  @Auditable(
    parameters = {
      "parentRef", "assocTypeQName", "assocQName", "nodeTypeQName",
    }
  )
  ...
  @Auditable(
    parameters = {
      "nodeToMoveRef", "newParentRef", "assocTypeQName", "assocQName",
    }
  )
   ...
   */
  @Auditable(
    parameters = { "parentRef", "childRef", "assocTypeQName", "qname" }
  )
   ...
   */
  @Auditable(
    parameters = { "parentRefs", "childRef", "assocTypeQName", "qname" }
  )
