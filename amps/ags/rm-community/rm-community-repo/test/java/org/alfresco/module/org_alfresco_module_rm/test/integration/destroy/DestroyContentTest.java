...
public class DestroyContentTest extends BaseRMTestCase {
  ...
  private static final String BEAN_NAME_CONTENT_CLEANSER =
    "contentCleanser.test";
  ...
  protected void initServices() {
    super.initServices();
    contentStore =
      (ContentStore) applicationContext.getBean("fileContentStore");
    contentCleanser =
      (TestContentCleanser) applicationContext.getBean(
        BEAN_NAME_CONTENT_CLEANSER
      );
    eagerContentStoreCleaner =
      (EagerContentStoreCleaner) applicationContext.getBean(
        "eagerContentStoreCleaner"
      );
    contentDestructionComponent =
      (ContentDestructionComponent) applicationContext.getBean(
        "contentDestructionComponent"
      );
    renditionService =
