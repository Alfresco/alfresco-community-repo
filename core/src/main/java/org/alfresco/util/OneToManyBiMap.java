...
/**
 * An extension of <code>org.alfresco.util.OneToManyMap</code> that stores the inverse mapping from a value to its key.
 * 
 * @author Nick Smith
 */
public interface OneToManyBiMap<K, V> extends OneToManyMap<K, V>
{
    ...
    /**
     * Returns the key, if any, for the specified <code>value</code>. If the specified value does not exist within the map then this method returns <code>null</code>.
     * 
     * @param value
