 ...
 *
 * <p>Note that a failed thumbnail creation is not the same as a creation which was not attempted
 * for lack of transformers.
 *
 * @author Neil Mc Erlean
 * @since 3.5.0
 * @see NodeEligibleForRethumbnailingEvaluator for a description of how these configuration
 *     parameters are used.
...
public class FailureHandlingOptions {
    ...
    /**
     * The minimum amount of time (in seconds) before a 'difficult' piece of content should be
     * reattempted.
     */
    private long quietPeriod = DEFAULT_PERIOD;

    /**
     * The minimum amount of time (in seconds) before a {@link ThumbnailDefinition} should be
     * initially reattempted.
     */
