...
/**
 * @author brian
 *     <p>This is a factory class for the processors of the transfer manifest file.
 */
public interface ManifestProcessorFactory {
     ...
     */
    TransferManifestProcessor getRequsiteProcessor(
     ...
     */
    List<TransferManifestProcessor> getCommitProcessors(
