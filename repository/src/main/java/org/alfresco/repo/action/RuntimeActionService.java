...
public interface RuntimeActionService {
    ...
    /**
     * Optional logging of errors callback for the action executer for the cases when the error
     * might be ignored or shown in a different manner for the action
     *
     * @param action the action
