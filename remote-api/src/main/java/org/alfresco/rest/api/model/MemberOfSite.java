...
public class MemberOfSite implements Comparable<MemberOfSite> {
    ...
    public static MemberOfSite getMemberOfSite(SiteInfo siteInfo, String siteRole) {
        MemberOfSite memberOfSite =
                new MemberOfSite(siteInfo.getShortName(), siteInfo.getNodeRef(), siteRole);
        return memberOfSite;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((siteShortName == null) ? 0 : siteShortName.hashCode());
        return result;
    }
