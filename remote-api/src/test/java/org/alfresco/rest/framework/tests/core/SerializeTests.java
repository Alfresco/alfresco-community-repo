...
public class SerializeTests extends AbstractContextTest implements RecognizedParamsExtractor {
    ...
    public void testInvokeMultiPartEntity() throws IOException {
        ResourceWithMetadata entityResource =
                locator.locateEntityResource(api, "multiparttest", HttpMethod.POST);
        assertNotNull(entityResource);
        MultiPartResourceAction.Create<?> resource =
                (MultiPartResourceAction.Create<?>) entityResource.getResource();
    ...
    public void testSerializeResponse() throws IOException {
        ResourceWithMetadata relationResource =
                locator.locateRelationResource(api, "sheep", "baaahh", HttpMethod.GET);
        assertNotNull(relationResource);
        RelationshipResourceAction.Read<?> getter =
                (RelationshipResourceAction.Read<?>) relationResource.getResource();
        CollectionWithPagingInfo<?> resources =
                getter.readAll("123", Params.valueOf("", null, null));
        String out =
                writeResponse(
                        helper.processAdditionsToTheResponse(
                                mock(WebScriptResponse.class),
        ...
        Object resultCollection =
                helper.processAdditionsToTheResponse(
                        ...
                        CollectionWithPagingInfo.asPaged(
                                pageRequest,
                                Arrays.asList(
                                        new Farmer("180"), new Farmer("190"), new Farmer("280"))));
    ...
    public void testIncludeSource() throws IOException {
        ...
        CollectionWithPagingInfo<ExecutionResult> coll =
                CollectionWithPagingInfo.asPaged(null, Arrays.asList(exec1, exec2));
        ...
        assertTrue(
                ...
                StringUtils.contains(
                        out, "\"source\":{\"name\":\"Dolly\",\"age\":3,\"sheepGuid\":\"1\"}"));
        ...
        coll =
                CollectionWithPagingInfo.asPaged(
                        null, Arrays.asList(exec1, exec2), false, 2, new Sheep("barbie"));
        resultCollection =
                helper.processAdditionsToTheResponse(
                        mock(WebScriptResponse.class),
                        api,
        ...
        assertTrue(
                "There must 'source' json output",
                StringUtils.contains(
                        out, "\"source\":{\"name\":\"Dolly\",\"age\":3,\"sheepGuid\":\"barbie\""));
    }
    ...
    public void testExpandRecursiveRelations() throws IOException {
        ...
        assertTrue("There must be json output", StringUtils.isNotBlank(out));
        assertFalse(
                "collections should be serialized correctly.  There may be a problem with this"
                        + " one.",
    ...
    public void testSerializeListOfSimpleType() throws IOException {
        assertNotNull(helper);
        CollectionWithPagingInfo<String> pString =
                CollectionWithPagingInfo.asPaged(null, Arrays.asList("goat", "sheep", "horse"));
        Object res =
                helper.processAdditionsToTheResponse(
                        mock(WebScriptResponse.class),
                        api,
        ...
        String out = writeResponse(res);
        assertTrue("There must be json output", StringUtils.isNotBlank(out));
        CollectionWithPagingInfo<Integer> pInts =
                CollectionWithPagingInfo.asPaged(null, Arrays.asList(234, 45, 890, 3456));
        res =
                helper.processAdditionsToTheResponse(
                        mock(WebScriptResponse.class),
                        api,
    ...
    public void testInvokeProperty() throws IOException {
        ...
        ResourceWithMetadata propResource =
                locator.locateRelationResource(api3, "flock", "photo", HttpMethod.GET);
    ...
    public void testInvokeVersions() throws IOException {
        ...
        ResourceWithMetadata entityResource =
                locator.locateEntityResource(api, "goat", HttpMethod.GET);
        assertNotNull(entityResource);
        EntityResourceAction.ReadById<?> getter = (ReadById<?>) entityResource.getResource();
    ...
    public void testFilter() throws IOException, JSONException {
        ...
        jsonRsp = new JSONObject(new JSONTokener(out));
        entry =
                jsonRsp.getJSONObject("relations")
                        .getJSONObject("herd")
                        .getJSONObject("list")
