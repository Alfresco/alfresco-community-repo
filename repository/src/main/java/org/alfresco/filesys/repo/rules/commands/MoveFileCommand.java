...
public class MoveFileCommand implements Command {
    ...
    public MoveFileCommand(
            String from, String to, NodeRef rootNode, String fromPath, String toPath) {
        this.from = from;
        this.to = to;
    ...
    // ALF-16257: in shuffle scenarios if user has insufficient permissions rename should be done as
    // System
    public MoveFileCommand(
            String from,
            String to,
