 ...
 *
 * <p>ContentSearchContext with DotDot methods.
 */
public class DotDotContentSearchContext extends ContentSearchContext {
    ...
    protected void setDotInfo(FileInfo finfo) {
        m_dotInfo = finfo;
        if (m_dotInfo != null) m_dotInfo.setFileName(".");
    }
    ...
    protected void setDotDotInfo(FileInfo finfo) {
        m_dotDotInfo = finfo;
        if (m_dotDotInfo != null) m_dotDotInfo.setFileName("..");
    }
    ...
    public String toString() {
        ...
        if (m_dotInfo != null) sb.append(",Dot");
        if (m_dotDotInfo != null) sb.append(",DotDot");
        sb.append("]");
