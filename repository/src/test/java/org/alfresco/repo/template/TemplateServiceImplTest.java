...
public class TemplateServiceImplTest extends BaseSpringTest {
  ...
  private static final String TEMPLATE_1 =
    "org/alfresco/repo/template/test_template1.ftl";
  ...
  public void setUp() throws Exception {
    ...
    templateService =
      (TemplateService) applicationContext.getBean("templateService");
    serviceRegistry =
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          ...
          public Object execute() throws Exception {
            StoreRef store = nodeService.createStore(
            ...
            NodeRef subFolderRef = nodeService
              .createNode(
                root_node,
                ContentModel.ASSOC_CHILDREN,
                QName.createQName(
                  NamespaceService.CONTENT_MODEL_1_0_URI,
                  QName.createValidLocalName("subFolder")
                ),
            ...
            properties.put(
              ...
              (Serializable) "subSubFolder"
            );
            NodeRef subSubFolderRef = nodeService
              .createNode(
                subFolderRef,
                ContentModel.ASSOC_CONTAINS,
                QName.createQName(
                  NamespaceService.CONTENT_MODEL_1_0_URI,
                  QName.createValidLocalName("subSubFolder")
                ),
                ContentModel.TYPE_FOLDER,
                properties
              )
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          ...
          public Object execute() throws Exception {
            ...
            String output = templateService.processTemplate(
              "freemarker",
              TEMPLATE_1,
              model
            );
