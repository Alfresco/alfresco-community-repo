 ...
 * This is typically used with Scripts and WebScripts, and feeds into the Repository level paging
 * support. This class is typically used with {@link ModelUtil}. Note that {@link
 * org.alfresco.repo.web.util.paging.Paging} provides an alternate solution for other paging use
 * cases.
 *
 * <p>TODO Set a value for {@link #setRequestTotalCountMax(int)}
 */
public class ScriptPagingDetails extends PagingRequest {
    ...
    /**
     * Creates a new {@link PagingRequest} object (in the form of {@link ScriptPagingDetails}),
     * based on the standard URL parameters for webscript paging.
     *
    ...
    /**
     * Creates a new {@link PagingRequest} object, based on the standard URL parameters for
     * webscript paging.
     *
     * @param req The request object to extract parameters from
     * @param maxResultCount The maximum results count if none is specified
     */
    public static PagingRequest buildPagingRequest(WebScriptRequest req, int maxResultCount)
        ...
        if (pageSizeS != null) {
            try {
                ...
                throw new WebScriptException(
                        Status.STATUS_BAD_REQUEST, "Paging size parameters invalid");
            }
        }
    ...
    /**
     * Get the total number of items. See {@link #getConfidence()} for an idea of the
     * accuracy/confidence on this value.
     */
    ...
    /**
     * Records the total number of items that were found. If the value is -1, then the confidence is
     * set to {@link ItemsSizeConfidence#UNKNOWN}, otherwise the confidence is {@link
     * ItemsSizeConfidence#EXACT}
     *
    ...
    /**
     * Records the total number of results found, and the confidence in this, from the Paging
     * Results
     *
    ...
    /**
     * Where the confidence is {@link ItemsSizeConfidence#RANGE}, returns the upper bound of the
     * range.
     */
