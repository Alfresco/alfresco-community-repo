 ...
 *
 * <p>Additional conversions may be added. Basic inter-operability supported.
 *
 * <p>Direct conversion and two stage conversions via Number are supported. We do not support
 * conversion by any route at the moment
 *
 * <p>TODO: Add support for Path
 *
 * <p>TODO: Add support for lucene
 *
 * <p>TODO: Add suport to check of a type is convertable
 *
 * <p>TODO: Support for dynamically managing conversions
 *
 * @author andyh
 */
@AlfrescoPublicApi
public class DefaultTypeConverter extends TypeConverter {
    ...
    private DefaultTypeConverter() {
        ...
        addConverter(
                String.class,
                Class.class,
                new TypeConverter.Converter<String, Class>() {
                    public Class convert(String source) {
                        try {
                            return Class.forName(source);
                        } catch (ClassNotFoundException e) {
                            throw new TypeConversionException(
                                    "Failed to convert string to class: " + source, e);
                        }
                    }
                });
        addConverter(
        ...
        addConverter(
                String.class,
                Character.class,
                new TypeConverter.Converter<String, Character>() {
        ...
        addConverter(
                String.class,
                Number.class,
                new TypeConverter.Converter<String, Number>() {
                    public Number convert(String source) {
                        try {
                            return DecimalFormat.getNumberInstance().parse(source);
                        } catch (ParseException e) {
                            throw new TypeConversionException(
                                    "Failed to parse number " + source, e);
                        }
                    }
                });
        addConverter(
                String.class,
                Byte.class,
                new TypeConverter.Converter<String, Byte>() {
        ...
        addConverter(
                String.class,
                Short.class,
                new TypeConverter.Converter<String, Short>() {
        ...
        addConverter(
                String.class,
                Integer.class,
                new TypeConverter.Converter<String, Integer>() {
        ...
        addConverter(
                String.class,
                Long.class,
                new TypeConverter.Converter<String, Long>() {
        ...
        addConverter(
                String.class,
                Float.class,
                new TypeConverter.Converter<String, Float>() {
        ...
        addConverter(
                String.class,
                Double.class,
                new TypeConverter.Converter<String, Double>() {
        ...
        addConverter(
                String.class,
                BigInteger.class,
                new TypeConverter.Converter<String, BigInteger>() {
        ...
        addConverter(
                String.class,
                BigDecimal.class,
                new TypeConverter.Converter<String, BigDecimal>() {
        ...
        addConverter(
                String.class,
                Date.class,
                new TypeConverter.Converter<String, Date>() {
        ...
        addConverter(
                String.class,
                Duration.class,
                new TypeConverter.Converter<String, Duration>() {
        ...
        addConverter(
                String.class,
                QName.class,
                new TypeConverter.Converter<String, QName>() {
        ...
        addConverter(
                String.class,
                ContentData.class,
                new TypeConverter.Converter<String, ContentData>() {
        ...
        addConverter(
                String.class,
                NodeRef.class,
                new TypeConverter.Converter<String, NodeRef>() {
        ...
        addConverter(
                String.class,
                StoreRef.class,
                new TypeConverter.Converter<String, StoreRef>() {
        ...
        addConverter(
                String.class,
                AssociationRef.class,
                new TypeConverter.Converter<String, AssociationRef>() {
        ...
        addConverter(
                String.class,
                InputStream.class,
                new TypeConverter.Converter<String, InputStream>() {
        ...
        addConverter(
                String.class,
                MLText.class,
                new TypeConverter.Converter<String, MLText>() {
        ...
        addConverter(
                String.class,
                Locale.class,
                new TypeConverter.Converter<String, Locale>() {
        ...
        addConverter(
                String.class,
                Period.class,
                new TypeConverter.Converter<String, Period>() {
        ...
        addConverter(
                Map.class,
                Period.class,
                new TypeConverter.Converter<Map, Period>() {
        ...
        addConverter(
                String.class,
                VersionNumber.class,
                new TypeConverter.Converter<String, VersionNumber>() {
        ...
        addConverter(
                Locale.class,
                String.class,
                new TypeConverter.Converter<Locale, String>() {
        ...
        addConverter(
                VersionNumber.class,
                String.class,
                new TypeConverter.Converter<VersionNumber, String>() {
        ...
        addConverter(
                MLText.class,
                String.class,
                new TypeConverter.Converter<MLText, String>() {
        ...
        addConverter(
                Enum.class,
                String.class,
                new TypeConverter.Converter<Enum, String>() {
        ...
        addConverter(
                Period.class,
                String.class,
                new TypeConverter.Converter<Period, String>() {
        ...
        addConverter(
                Class.class,
                String.class,
                new TypeConverter.Converter<Class, String>() {
        ...
        addConverter(
                Number.class,
                Boolean.class,
                new TypeConverter.Converter<Number, Boolean>() {
        ...
        addConverter(
                Number.class,
                Byte.class,
                new TypeConverter.Converter<Number, Byte>() {
        ...
        addConverter(
                Number.class,
                Short.class,
                new TypeConverter.Converter<Number, Short>() {
        ...
        addConverter(
                Number.class,
                Integer.class,
                new TypeConverter.Converter<Number, Integer>() {
        ...
        addConverter(
                Number.class,
                Long.class,
                new TypeConverter.Converter<Number, Long>() {
        ...
        addConverter(
                Number.class,
                Float.class,
                new TypeConverter.Converter<Number, Float>() {
        ...
        addConverter(
                Number.class,
                Double.class,
                new TypeConverter.Converter<Number, Double>() {
        ...
        addConverter(
                Number.class,
                Date.class,
                new TypeConverter.Converter<Number, Date>() {
        ...
        addConverter(
                Number.class,
                String.class,
                new TypeConverter.Converter<Number, String>() {
        ...
        addConverter(
                Number.class,
                BigInteger.class,
                new TypeConverter.Converter<Number, BigInteger>() {
        ...
        addConverter(
                Number.class,
                BigDecimal.class,
                new TypeConverter.Converter<Number, BigDecimal>() {
        ...
        addConverter(
                Timestamp.class,
                Date.class,
                new TypeConverter.Converter<Timestamp, Date>() {
        ...
        addConverter(
                Date.class,
                Number.class,
                new TypeConverter.Converter<Date, Number>() {
        ...
        addConverter(
                Date.class,
                String.class,
                new TypeConverter.Converter<Date, String>() {
        ...
        addConverter(
                Date.class,
                Calendar.class,
                new TypeConverter.Converter<Date, Calendar>() {
        ...
        addConverter(
                ...
                new TypeConverter.Converter<Date, GregorianCalendar>() {
        ...
        addConverter(
                Boolean.class,
                Long.class,
                new TypeConverter.Converter<Boolean, Long>() {
        ...
        addConverter(
                Boolean.class,
                String.class,
                new TypeConverter.Converter<Boolean, String>() {
        ...
        addConverter(
                Character.class,
                String.class,
                new TypeConverter.Converter<Character, String>() {
        ...
        addConverter(
                Duration.class,
                String.class,
                new TypeConverter.Converter<Duration, String>() {
        ...
        addConverter(
                Byte.class,
                String.class,
                new TypeConverter.Converter<Byte, String>() {
        ...
        addConverter(
                Short.class,
                String.class,
                new TypeConverter.Converter<Short, String>() {
        ...
        addConverter(
                Integer.class,
                String.class,
                new TypeConverter.Converter<Integer, String>() {
        ...
        addConverter(
                Long.class,
                String.class,
                new TypeConverter.Converter<Long, String>() {
        ...
        addConverter(
                Float.class,
                String.class,
                new TypeConverter.Converter<Float, String>() {
        ...
        addConverter(
                Double.class,
                String.class,
                new TypeConverter.Converter<Double, String>() {
        ...
        addConverter(
                BigInteger.class,
                String.class,
                new TypeConverter.Converter<BigInteger, String>() {
        ...
        addConverter(
                Calendar.class,
                Date.class,
                new TypeConverter.Converter<Calendar, Date>() {
        ...
        addConverter(
                Calendar.class,
                String.class,
                new TypeConverter.Converter<Calendar, String>() {
        ...
        addConverter(
                BigDecimal.class,
                String.class,
                new TypeConverter.Converter<BigDecimal, String>() {
        ...
        addConverter(
                QName.class,
                String.class,
                new TypeConverter.Converter<QName, String>() {
        ...
        addConverter(
                EntityRef.class,
                String.class,
                new TypeConverter.Converter<EntityRef, String>() {
        ...
        addConverter(
                ContentData.class,
                String.class,
                new TypeConverter.Converter<ContentData, String>() {
        ...
        addConverter(
                Path.class,
                String.class,
                new TypeConverter.Converter<Path, String>() {
        ...
        addConverter(
                ContentReader.class,
                String.class,
                new TypeConverter.Converter<ContentReader, String>() {
        ...
        addConverter(
                ContentWriter.class,
                String.class,
                new TypeConverter.Converter<ContentWriter, String>() {
        ...
        addConverter(
                InputStream.class,
                String.class,
                new TypeConverter.Converter<InputStream, String>() {
        ...
        addConverter(
                CMISQueryOptions.class,
                String.class,
                new TypeConverter.Converter<CMISQueryOptions, String>() {
