...
public interface TransferTransmitter {
    ...
    /**
     * Begin a transfer, the transfer object returned will be used by subsequent calls to the
     * transfer service.
     *
     ...
     * @throws TransferException
     */
    Transfer begin(TransferTarget target, String fromRepositoryId, TransferVersion fromVersion)
            throws TransferException;

    /**
     * @param manifest the transfer manifest file
     * @param transfer the transfer object returned by an earlier call to begin
     * @param results - where to write the results, probably a temporary file the output steam
     *     should be open and will be closed before the method returns.
     * @throws TransferException
     */
    void sendManifest(Transfer transfer, File manifest, OutputStream results)
            throws TransferException;
    ...
    /**
     * Get the destination side transfer report from the destination and write it to the specified
     * output stream.
     *
     * <p>The result stream will be closed.
     *
     * @param transfer the transfer object returned by an earlier call to begin
