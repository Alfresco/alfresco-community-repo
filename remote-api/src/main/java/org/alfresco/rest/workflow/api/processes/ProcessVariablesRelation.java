...
public class ProcessVariablesRelation
    ...
    @WebApiDescription(
            ...
            description = "Get a paged list of the task variables")
    ...
    /**
     * Creates or updates multiple variables. If the variable name doesn't exist yet it will be
     * created
     */
    @Override
    @WebApiDescription(
            title = "Create or Update Variables",
            description = "Create or update multiple variable")
    public List<Variable> create(
            String processId, List<Variable> variables, Parameters parameters) {
