...
/**
 * The Rule Evaluator evaluates the operation and returns details of the commands to implement those
 * operations.
 *
 * <p>It is configured with a list of scenarios which act as factories for scenario instances.
 */
public class RuleEvaluatorImpl implements RuleEvaluator {
    ...
    public Command evaluate(EvaluatorContext context, Operation operation) {
        ...
        /**
         * For each scenario, do we need to create a new scenario instance for the specified
         * operation ?
         */
        ...
        synchronized (context.getScenarioInstances()) {
            ...
            while (i.hasNext()) {
                ...
                if (scenario instanceof ScenarioInstanceRenameAware) {
                    ScenarioInstanceRenameAware awareScenario =
                            (ScenarioInstanceRenameAware) scenario;
