...
/**
 * Exception thrown when an operation that requires two things to be in the same tenant domain
 * discovers that they belong to different ones.
 */
    ...
    public TenantDomainMismatchException(String tenantA, String tenantB) {
        super(
                "domain mismatch: expected = "
                        + renderTenent(tenantA)
                        + ", actual = "
                        + renderTenent(tenantB));
