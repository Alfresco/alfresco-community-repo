...
/**
 * This class provides support for several {@link CannedQuery canned queries} used by the {@link
 * BlogService}.
 *
...
public class GetBlogPostsCannedQuery extends AbstractCannedQueryPermissions<BlogEntity> {
    ...
    protected List<BlogEntity> queryAndFilter(CannedQueryParameters parameters) {
        ...
        for (BlogEntity result : results) {
            ...
            // Only return blog-posts whose cm:published status matches that requested (ie. a blog
            // "is published" when published date is not null)
            ...
            if (requestedCreator != null) {
                ...
                if ((auditProps == null)
                        || (!requestedCreator.equals(auditProps.getAuditCreator()))) {
                    nextNodeIsAcceptable = false;
                }
            }
            ...
            if ((publishedFromDate != null) || (publishedToDate != null)) {
                if (actualPublishedDate != null) {
                    if (publishedFromDate != null
                            && actualPublishedDate.before(publishedFromDate)) {
                        nextNodeIsAcceptable = false;
                    }
