 ...
 *
 * <p>Additional conversions may be added.
 *
...
public class TypeConverter {
    ...
    public final <F, T> void addConverter(
            Class<F> source, Class<T> destination, Converter<F, T> converter) {
    ...
    public final <F, I, T> Converter<F, T> addDynamicTwoStageConverter(
            Class<F> source, Class<I> intermediate, Class<T> destination) {
        Converter<F, T> converter =
                new TypeConverter.DynamicTwoStageConverter<F, I, T>(
     ...
     *
     * <p>Note: Takes into account the class of the object and any interfaces it may also support.
     */
    ...
    /** Map of conversion */
    private Map<Class<?>, Map<Class<?>, Converter<?, ?>>> conversions =
