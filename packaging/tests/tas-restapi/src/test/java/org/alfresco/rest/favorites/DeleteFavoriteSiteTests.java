...
public class DeleteFavoriteSiteTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user removes a site from its favorite sites list with Rest API"
                            + " and response is successful (204)")
    public void managerUserRemovesFavoriteSiteWithSuccess() throws Exception {
        ...
        restClient
                ...
                .and()
                .entriesListDoesNotContain("id", siteModel1.getId())
                .and()
                .entriesListDoesNotContain("description", siteModel1.getDescription())
                .and()
                .entriesListDoesNotContain("visibility", siteModel1.getVisibility().toString())
                .and()
                .entriesListDoesNotContain("title", siteModel1.getTitle());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify manager user is NOT Authorized to remove a site from its favorite sites"
                            + " list with Rest API when authentication fails (401)")
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator user removes a site from its favorite sites list with Rest"
                            + " API and response is successful (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user removes a site from its favorite sites list with Rest"
                            + " API and response is successful (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user removes a site from its favorite sites list with Rest API"
                            + " and response is successful (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user removes a site from any user's favorite sites list with Rest"
                            + " API and response is successful (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify a user removes a site from another user's favorite sites list with Rest"
                            + " API and response is permission denied (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify uninvited user can delete favorite public site and response is 204")
    public void uninvitedUserCanDeleteFavoritePublicSite() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingUser(userModel)
                .addFavoriteSite(publicSiteModel);
        ...
        restClient
                ...
                .getFavoriteSites()
                .assertThat()
                .entriesListDoesNotContain("id", publicSiteModel.getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify uninvited user can delete favorite moderated site and response is 204")
    public void uninvitedUserCanDeleteFavoriteModeratedSite() throws Exception {
        ...
        restClient
                ...
                .getFavoriteSites()
                .assertThat()
                .entriesListDoesNotContain("id", moderatedSiteModel.getId());
    }
    ...
    public void userCanDeleteFavoritePrivateSite() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingUser(userModel)
                .addFavoriteSite(privateSiteModel);
        ...
        restClient
                ...
                .getFavoriteSites()
                .assertThat()
                .entriesListDoesNotContain("id", privateSiteModel.getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager user removes a site from its favorites and adds it again and"
                            + " response is successful (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user removes a site from favorites using '-me-' in place of personId"
                            + " with Rest API and response is successful (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify inexistent user is not able to remove a site from favorites and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to remove from favorites a site with inexistent id and"
                            + " response is 404")
    ...
    public void managerUserRemovesDeletedFavoriteSite() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.NOT_FAVOURITE_SITE, siteModel1.getTitle()));
    }
    ...
    public void adminUserRemovesDeletedFavoriteSiteThatIsNotFavorite() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.NOT_FAVOURITE_SITE, siteModel.getTitle()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user doesn't have permission to delete favorites of another user with"
                            + " Rest API and status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
