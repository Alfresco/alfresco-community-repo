...
public abstract class AbstractCopyBehaviourCallback implements CopyBehaviourCallback {
    private static final String KEY_NODEREF_REPOINTING_PREFIX =
            "recordNodeRefPropertiesForRepointing-";

    /**
     * @return Returns {@link AssocCopySourceAction#COPY_REMOVE_EXISTING} and {@link
    ...
    protected void throwExceptionForUnexpectedBehaviour(
            CopyDetails copyDetails, String... otherDetails) {
    ...
    /**
     * Helper method to transactionally record <code>NodeRef</code> properties so that they can
     * later be fixed up to point to the relative, after-copy locations.
     *
     ...
     * NodeRef</code> properties readjusted to reflect the copied node hierarchy. Only use this
     * method if it a requirement for the particular type or aspect that you are coding for.
     *
