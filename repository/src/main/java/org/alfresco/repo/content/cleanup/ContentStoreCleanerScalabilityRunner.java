...
public class ContentStoreCleanerScalabilityRunner extends Repository {
  ...
  private VmShutdownListener vmShutdownListener = new VmShutdownListener(
  ...
  protected synchronized int execute() throws ToolException {
    ...
    double aveClean = (double) (afterClean - beforeClean) /
    (double) orphanCount /
    1000D;
  ...
  private void clean() {
    ...
    EagerContentStoreCleaner eagerCleaner = (EagerContentStoreCleaner) ctx.getBean(
