...
/**
 * Constraint implementation that defers to constraints registered with the static instance of the
 * {@link ConstraintRegistry}.
 *
 * @author Derek Hulley
 */
public final class RegisteredConstraint implements Constraint {
    private static final String ERR_NAME_NOT_REGISTERED =
            "d_dictionary.constraint.registered.not_registered";
    ...
    public String toString() {
        ...
        sb.append("RegisteredConstraint")
                ...
                .append(registeredName)
                .append(", constraint=")
                .append(ConstraintRegistry.getInstance().getConstraint(registeredName))
                .append("]");
        return sb.toString();
    }
    ...
    /**
     * Set the name of the constraint that will be used to look up the constraint that will be
     * delegated to.
     */
