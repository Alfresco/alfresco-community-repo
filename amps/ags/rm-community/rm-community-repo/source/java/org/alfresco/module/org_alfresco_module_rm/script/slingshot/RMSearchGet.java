...
public class RMSearchGet extends DeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            // Execute search
            List<Pair<NodeRef, NodeRef>> results =
                    recordsManagementSearchService.search(siteId, query, searchParameters);
        ...
        public Item(NodeRef parent, NodeRef nodeRef) {
            ...
            if (isContainer) {
                ...
                if (pathElements.length >= 5) {
                    ...
                    pathElements =
                            (String[]) ArrayUtils.subarray(pathElements, 5, pathElements.length);
                    ...
                    try {
                        this.browseUrl =
                                "documentlibrary?path="
                                        + URLEncoder.encode(relPath.toString(), "UTF-8")
                                                .replaceAll("\\+", "%20");
                ...
                ContentData contentData =
                        (ContentData) nodeProperties.get(ContentModel.PROP_CONTENT);
                this.size = 0;
                if (contentData != null) {
        ...
        private String getDisplayName(String userName) {
            ...
            if (result == null) {
                ...
                if (person != null) {
                    ...
                    displayName
                            .append(nodeService.getProperty(person, ContentModel.PROP_FIRSTNAME))
                            .append(" ")
