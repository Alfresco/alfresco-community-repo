...
public class QueriesTest extends RestTest {
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.QUERIES },
    executionType = ExecutionType.SANITY,
    description = "Check basic functionality of GET queries/sites"
  )
  ...
  public void getQueriesSites() throws Exception {
    ...
    RetryOperation op = new RetryOperation() {
      public void execute() throws Exception {
        RestSiteModelsCollection restSiteModels = restClient
          .withCoreAPI()
          .usingQueries()
          .usingParams("term=" + createdSite.getTitle())
          .findSites();
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.QUERIES },
    executionType = ExecutionType.SANITY,
    description = "Check basic functionality of GET queries/people"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.CORE })
  public void getQueriesPeople() throws Exception {
    ...
    RetryOperation op = new RetryOperation() {
      public void execute() throws Exception {
        RestPersonModelsCollection restPersonModels = restClient
          .withCoreAPI()
          .usingQueries()
          .usingParams("term=" + userModel.getUsername())
          .findPeople();
  ...
  @TestRail(
    ...
    description = "Check basic functionality of GET queries/nodes"
  )
  @Test(
  ...
  public void getOnQueriesNodesRoute() throws Exception {
    ...
    restClient.withCoreAPI().usingQueries().usingParams("term=ab").findNodes();
    restClient.assertStatusCodeIs(HttpStatus.BAD_REQUEST);
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.QUERIES },
    executionType = ExecutionType.REGRESSION,
    description = "Verify GET queries on queries/nodes return success status code"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.CORE })
