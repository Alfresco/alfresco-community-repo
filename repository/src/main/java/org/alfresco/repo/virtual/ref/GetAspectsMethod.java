...
public class GetAspectsMethod extends AbstractProtocolMethod<Set<QName>> {
  ...
  public GetAspectsMethod(
    NodeServiceTrait nodeServiceTrait,
  ...
  @Override
  public Set<QName> execute(NodeProtocol protocol, Reference reference)
  ...
  public Set<QName> execute(
    ...
    try {
      ...
      if (PATH_SEPARATOR.equals(path.trim())) {
        ...
        nodeRef =
          virtualProtocol
            .getActualNodeLocation(reference)
            .asNodeRef(environment);
