...
public class NotificationContext {
    ...
    /**
     * The body template is a node re or classpath ref to a template that can be executed with the
     * given template arguments to produce the body of the notification.
     *
    ...
    /**
     * The template arguments are used as context for the body template when it is executed. Any
     * values placed in this map will be available in the template from the root object 'args'. For
     * example '${args.workflowDescription}'.
     *
    ...
    /**
     * Document that the notification relates to. This does not have to be set. Will be used to
     * populate the 'document' root object accessable within the body template if set.
     *
