...
public class ComparePropertyValueEvaluator extends ActionConditionEvaluatorAbstractBase {
    ...
    private Map<QName, PropertyValueComparator> comparators =
            new HashMap<QName, PropertyValueComparator>();
    ...
    public boolean evaluateImpl(ActionCondition ruleCondition, NodeRef actionedUponNodeRef) {
        ...
        if (this.nodeService.exists(actionedUponNodeRef) == true) {
            ...
            if (DataTypeDefinition.CONTENT.equals(propertyTypeQName) == true) {
                ...
                String contentPropertyString =
                        (String) ruleCondition.getParameterValue(PARAM_CONTENT_PROPERTY);
                ...
                if (propertyValue != null) {
                    ContentData contentData =
                            DefaultTypeConverter.INSTANCE.convert(ContentData.class, propertyValue);
            ...
            if (propertyValue != null) {
                ...
                if (comparator != null) {
                    // Figure out if property is multivalued, compare all of the entries till
                    // finding a match
                    ...
                    // The default behaviour is to assume the property can only be compared using
                    // equals
