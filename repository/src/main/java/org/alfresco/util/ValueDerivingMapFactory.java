...
public class ValueDerivingMapFactory<O, K, V> {
     ...
     *
     * @param valueDerivers a map of value derivers that derive the value of each entry from a given
     *     source
     */
    ...
    public Map<K, V> getMap(final O source) {
        return new AbstractMap<K, V>() {
            ...
            public V get(Object key) {
                ValueDeriver<O, V> valueDeriver =
                        ValueDerivingMapFactory.this.valueDerivers.get(key);
            ...
            public Set<Map.Entry<K, V>> entrySet() {
                final Set<Map.Entry<K, ValueDeriver<O, V>>> entries =
                        ValueDerivingMapFactory.this.valueDerivers.entrySet();
