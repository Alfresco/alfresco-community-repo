...
public abstract class AbstractStreamAwareProxy {
    ...
    /**
     * @return {@link Boolean} value which determines whether stream can (<code>true</code>) or
     *     cannot ((<code>false</code>)) be closed
     */
    protected abstract boolean canBeClosed();

    /**
     * Encapsulates the logic of releasing the captured stream or channel. It is expected that each
     * resource object shares the same channel
     */
    public void release() {
