...
public class AddActiveContentToHoldTest extends BaseRMTestCase
{
    ...
    /**
     * Given active content And file permission on the hold And the appropriate capability to add to hold When I try to add the active content to the hold Then the active content is frozen And the active content is contained within the hold
     */
    ...
    /**
     * Given active content And a non rm user with write permission on active content When user tries to add the active content to hold Then AccessDeniedException is thrown
     */
    ...
    /**
     * Given active content And a rm user with Filing permission on hold and Add to Hold Capability, but only read permission on active content When user tries to add the active content to hold Then an exception is thrown
     */
    ...
    /**
     * Given active content And a rm user with Add to Hold Capability, write permission on active content and only Read permission on hold When user tries to add the active content to hold Then AccessDeniedException is thrown
     */
    ...
    /**
     * Given active content And a rm user with write permission on active content and Filing permission on hold, but no Add to Hold Capability When user tries to add the active content to hold Then AccessDeniedException is thrown
     */
    ...
    /**
     * Given active content on hold When I try to add content to another hold And I have file permission on the other hold And I have the appropriate capability to add to hold Then the active content is contained within both holds And the active content remains frozen
     */
