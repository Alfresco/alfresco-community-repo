 ...
 *
 * <p>Currently supports favouriting of sites, files and folders.
 *
 * @author steveglover
 */
public interface FavouritesService {
    ...
    public static List<Pair<FavouritesService.SortFields, Boolean>> DEFAULT_SORT_PROPS =
            Arrays.asList(
                    new Pair<FavouritesService.SortFields, Boolean>(
                            FavouritesService.SortFields.username, Boolean.TRUE),
                    new Pair<FavouritesService.SortFields, Boolean>(
                            FavouritesService.SortFields.type, Boolean.TRUE),
                    new Pair<FavouritesService.SortFields, Boolean>(
                            FavouritesService.SortFields.createdAt, Boolean.FALSE));
     ...
     *
     * <p>If the nodeRef is already favourited, the favourite entity is returned. No information
     * regarding the favourite e.g. createdAt is updated.
     *
    ...
    PagingResults<PersonFavourite> getPagedFavourites(
            String userName,
            Set<Type> types,
