...
/**
 * Records management IsKind evaluator that evaluates according to the file plan component kind
 * passed in.
 *
 * @author Craig Tan
 * @since 2.1
...
public class IsKindEvaluator extends RecordsManagementActionConditionEvaluatorAbstractBase {
    ...
    protected boolean evaluateImpl(ActionCondition actionCondition, NodeRef actionedUponNodeRef) {
        ...
        FilePlanComponentKind filePlanComponentKind =
                getFilePlanService().getFilePlanComponentKind(actionedUponNodeRef);
