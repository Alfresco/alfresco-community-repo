...
/**
 * Tests for {@link FileContentStore FileContentStore} which uses {@link
 * TimeBasedFileContentUrlProvider TimeBasedFileContentUrlProvider} configured for provisioning
 * splitting data into buckets within the <b>minute</b> range
 *
...
public class BucketAwareFileContentStoreTest extends FileContentStoreTest {
    ...
    public void before() throws Exception {
        ...
        TimeBasedFileContentUrlProvider fileContentUrlProvider =
                new TimeBasedFileContentUrlProvider();
