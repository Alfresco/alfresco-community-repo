...
public class GetCheckedOutDocumentsTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to get checked out documents from a valid folder")
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager CANNOT get checked out documents from inexistent folder")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user is not able to get checked out documents from session created"
                            + " by admin in root")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to get checked out documents created by"
                            + " manager")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to get checked out documents created by"
                            + " manager")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager user is able to get checked out documents from folder with"
                            + " operation context")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerCanGetCheckedOutDocumentsFromFolderWithOperationContext()
            throws Exception {
        OperationContext context =
                cmisApi.authenticateUser(testUser).getSession().createOperationContext();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is able to get checked out documents from session with operation"
                            + " context")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerCanGetCheckedOutDocumentsFromSessionWithOperationContext()
        ...
        OperationContext context =
                cmisApi.authenticateUser(user).getSession().createOperationContext();
        context.setOrderBy(PropertyIds.NAME + " DESC");
        FileModel doc1 = new FileModel("a-file.txt", FileType.TEXT_PLAIN, documentContent);
        FileModel doc2 = new FileModel("b-file.txt", FileType.TEXT_PLAIN, documentContent);
        FileModel doc3 = new FileModel("c-file.txt", FileType.TEXT_PLAIN, documentContent);
