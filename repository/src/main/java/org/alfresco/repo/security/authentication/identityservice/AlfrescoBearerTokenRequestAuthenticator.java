...
/**
 * Extends the Keycloak BearerTokenRequestAuthenticator class to capture the error description when
 * token valiation fails.
 *
...
public class AlfrescoBearerTokenRequestAuthenticator extends BearerTokenRequestAuthenticator {
    ...
    @Override
    protected AuthChallenge challengeResponse(
            HttpFacade facade, Reason reason, String error, String description) {
