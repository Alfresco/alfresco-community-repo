...
public class TaskVariablesRelation
        implements RelationshipResourceAction.Read<TaskVariable>,
                RelationshipResourceAction.Create<TaskVariable>,
                RelationshipResourceAction.Update<TaskVariable>,
    ...
    /**
     * Creates or updates multiple task variables. If the variable name doesn't exist yet it will be
     * created
     */
    @Override
    @WebApiDescription(
    ...
    public List<TaskVariable> create(
            String taskId, List<TaskVariable> variables, Parameters parameters) {
    ...
    /**
     * Delete a task variable. If the variable name doesn't exist the delete call throws an
     * exception.
     */
    @Override
