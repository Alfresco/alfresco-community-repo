...
public class TransferSummaryReportImpl implements TransferSummaryReport {
  ...
  private static final String MSG_INBOUND_TRANSFER_FOLDER_NOT_FOUND =
    "receiver.record_folder_not_found_for_summary_report";

  private static final Log log = LogFactory.getLog(
    TransferSummaryReportImpl.class
  );
  ...
  @Override
  public void logSummaryException(final Object obj, final Throwable ex)
  ...
  @Override
  public void logSummaryUpdateStatus(final Status status)
    throws TransferException {
    TransferDestinationReportWriter writer = getLogWriter(transferId);
  ...
  private NodeRef getParentFolder() {
    ...
    if (refs.size() > 0) {
      ...
      throw new TransferException(
        ...
        new Object[] { transferSummaryReportLocation }
      );
    }
    return reportParentFolder;
  }

  public void setTransferSummaryReportLocation(
