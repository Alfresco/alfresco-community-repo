...
public class CommonRMTestUtils implements RecordsManagementModel {
    ...
    public DispositionSchedule createDispositionSchedule(
        ...
        DispositionSchedule dispositionSchedule =
                dispositionService.createDispositionSchedule(container, dsProps);
    ...
    private NodeRef createRecordImpl(
            NodeRef recordFolder, String name, Map<QName, Serializable> properties) {
        // Create the document
        if (properties == null) {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        try {
                            nodeService.setProperty(
                                    record, RecordsManagementModel.PROP_DATE_FILED, new Date());
                    ...
                    public Void doWork() throws Exception {
                        ...
                        try {
                            actionService.executeRecordsManagementAction(
                                    recordFolder, "closeRecordFolder");
                        } finally {
                            modelSecurityService.setEnabled(true);
                        }
                        return null;
    ...
    public void completeEvent(NodeRef disposableItem, String eventName) {
        ...
        // complete event
        actionService.executeRecordsManagementAction(
                disposableItem, CompleteEventAction.NAME, params);
    }
