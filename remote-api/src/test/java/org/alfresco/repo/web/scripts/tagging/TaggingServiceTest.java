...
public class TaggingServiceTest extends BaseWebScriptTest {
    ...
    protected void setUp() throws Exception {
        ...
        this.taggingService =
                (TaggingService) getServer().getApplicationContext().getBean("TaggingService");
        ...
        this.taggingService.createTag(
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "SpacesStore"), TAG_1);
        this.taggingService.createTag(
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "SpacesStore"), TAG_2);
        this.taggingService.createTag(
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "SpacesStore"), TAG_3);
        this.taggingService.createTag(
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "SpacesStore"), TAG_4);
        this.taggingService.createTag(
                new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "SpacesStore"), TAG_5);
        ...
        this.nodeOne =
                this.fileFolderService
                        .create(testRoot, "test_doc1" + guid + ".txt", ContentModel.TYPE_CONTENT)
                        .getNodeRef();
        this.nodeTwo =
                this.fileFolderService
                        .create(testRoot, "test_dco2" + guid + ".txt", ContentModel.TYPE_CONTENT)
                        .getNodeRef();
    ...
    public void testGetTags() throws Exception {
        Response response =
                sendRequest(
                        new GetRequest("/api/tags/" + StoreRef.PROTOCOL_WORKSPACE + "/SpacesStore"),
                        200);
        ...
        response =
                sendRequest(
                        new GetRequest(
                                "/api/tags/" + StoreRef.PROTOCOL_WORKSPACE + "/SpacesStore?tf=one"),
                        200);
