...
public class ActivitiWorkflowManagerFactory
  ...
  public ActivitiWorkflowManager getObject() throws Exception {
    ...
    ActivitiNodeConverter nodeConverter = new ActivitiNodeConverter(
      serviceRegistry
    );
    ...
    WorkflowPropertyHandlerRegistry handlerRegistry = new WorkflowPropertyHandlerRegistry(
      defaultPropertyHandler,
      qNameConverter
    );

    WorkflowAuthorityManager authorityManager = new WorkflowAuthorityManager(
      authorityDAO
    );
    ...
    ActivitiUtil activitiUtil = new ActivitiUtil(
      ...
      retentionHistoricProcessInstance
    );
    ActivitiPropertyConverter propertyConverter = new ActivitiPropertyConverter(
      activitiUtil,
      factory,
      handlerRegistry,
      authorityManager,
    ...
    ActivitiTypeConverter typeConverter = new ActivitiTypeConverter(
      processEngine,
      factory,
      propertyConverter,
      deployWorkflowsInTenant
   ...
   */
  public void setRetentionHistoricProcessInstance(
