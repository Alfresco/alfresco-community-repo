...
/**
 * Factory that creates a JSR-160 <code>JMXConnectorServer</code>, optionally registers it with the
 * <code>MBeanServer</code> and then starts it.
 *
...
public class ConnectorServerFactory extends ConnectorServerFactoryBean {
    ...
    /**
     * Enables JMX connectivity during initialization, see {@link
     * ConnectorServerFactory#afterPropertiesSet()}
     *
    ...
    /**
     * Wraps original initialization method to log errors, rather than having exceptions occur
     * within the Spring framework itself (this would cause the entire webapp to fail)
     *
