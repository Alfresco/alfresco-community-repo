...
public class GetSitesTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    siteModel =
      new SiteModel(
        RandomData.getRandomName("0-PrivateSite"),
    ...
    lastPublicSite =
      dataSite
        .usingAdmin()
        .createSite(
          new SiteModel(SiteService.Visibility.PUBLIC, "guid", name, name, name)
        );
    lastPrivateSite =
      dataSite
        .usingAdmin()
  ...
  public void unauthenticatedUserIsNotAuthorizedToRetrieveSites()
    throws Exception {
  ...
  public void getSitesOrderedByTitleASC() throws Exception {
    ...
    sitesList
      ...
      .assertThat()
      .field("title")
      .is(firstPrivateSite.getTitle());
    sitesList
      .get(2)
      .onModel()
      .assertThat()
      .field("title")
      .is(firstPublicSite.getTitle());
  }
  ...
  public void checkDeletedSiteIsNotRetrieved() throws Exception {
    ...
    sites
      .assertThat()
      .entriesListDoesNotContain("title", deletedSite.getTitle());
  }
  ...
  public void getSitesOrderedByTitleDESC() throws Exception {
    ...
    sitesList
      ...
      .assertThat()
      .field("title")
      .is(lastPublicSite.getTitle());
    sitesList
      .get(1)
      .onModel()
      .assertThat()
      .field("title")
      .is(lastPrivateSite.getTitle());
    sitesList
      .get(2)
      .onModel()
      .assertThat()
      .field("title")
      .is(lastModeratedSite.getTitle());
    sitesList
  ...
  public void getSitesUsingHighSkipCount() throws Exception {
    RestSiteModelsCollection allSites = restClient
      .authenticateUser(regularUser)
      .withCoreAPI()
      .getSites();
    ...
    if (allSites.getPagination().getTotalItems() > 100) sites
      .assertThat()
      .entriesListIsNotEmpty(); else sites.assertThat().entriesListIsEmpty();
  }
  ...
  public void getSitesOrderedByTitleASCAndVisibilityASC() throws Exception {
    SiteModel secondPublicSite = dataSite
      .usingAdmin()
      .createSite(
        new SiteModel(
    ...
    SiteModel thirdPublicSite = dataSite
      .usingAdmin()
      .createSite(
        new SiteModel(
          SiteService.Visibility.PUBLIC,
  ...
  public void checkThatRelationsParameterIsAppliedForContainers()
    throws Exception {
    List<List<Object>> jsonObjects = restClient
      .authenticateUser(adminUser)
    ...
    for (int i = 0; i < containerObjects.size(); i++) {
      RestSiteContainerModelsCollection containers = (RestSiteContainerModelsCollection) containerObjects.get(
        i
      );
      containers
        .assertThat()
  ...
  public void checkThatRelationsParameterIsAppliedForMembers()
    throws Exception {
    List<List<Object>> jsonObjects = restClient
      .authenticateUser(adminUser)
    ...
    for (int i = 0; i < memberObjects.size(); i++) {
      RestSiteMemberModelsCollection siteMembers = (RestSiteMemberModelsCollection) memberObjects.get(
        i
      );
      siteMembers
        .assertThat()
  ...
  public void checkThatRelationsParameterIsAppliedForMembersAndContainers()
    throws Exception {
    List<List<Object>> jsonObjects = restClient
      .authenticateUser(adminUser)
