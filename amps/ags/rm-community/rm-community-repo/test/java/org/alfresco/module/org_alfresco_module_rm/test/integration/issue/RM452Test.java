 ...
 *
 * <p>See alfresco.extension.rm-method-security.properties
 *
...
public class RM452Test extends BaseRMTestCase {
    ...
    public void testRM452() throws Exception {
        ...
        doTestInTransaction(
                new FailureTest(
                        "Shouldn't be able to call testMethodTwo on TestService, because override"
                                + " RM security for method is not configred.",
