...
public interface MetadataEmbedder extends ContentWorker {
     ...
     *
     * <p>The embedding viability can be determined by an up front call to {@link
     * #isEmbeddingSupported(String)}.
     *
     * <p>The source mimetype <b>must</b> be available on the {@link
     * org.alfresco.service.cmr.repository.ContentAccessor#getMimetype()} method of the writer.
     *
