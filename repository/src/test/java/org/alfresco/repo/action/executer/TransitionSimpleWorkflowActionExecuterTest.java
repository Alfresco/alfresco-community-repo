...
public class TransitionSimpleWorkflowActionExecuterTest
  ...
  public void before() throws Exception {
    ...
    this.acceptExecuter =
      (TransitionSimpleWorkflowActionExecuter) this.applicationContext.getBean(
          "accept-simpleworkflow"
        );
    this.rejectExecuter =
      (TransitionSimpleWorkflowActionExecuter) this.applicationContext.getBean(
          "reject-simpleworkflow"
        );
  }
  ...
  public void testExecutionApprove() {
    ...
    assertTrue(
      nodeService.hasAspect(node, ApplicationModel.ASPECT_SIMPLE_WORKFLOW)
    );
  ...
  private void addWorkflowAspect(
    ...
    Boolean moveOnApprove,
    Boolean moveOnReject
  ) {
    // Set up workflow details on the node
    Map<QName, Serializable> propertyValues = createWorkflowProperties(
      destinationFolder,
      moveOnApprove,
      moveOnReject
    );
