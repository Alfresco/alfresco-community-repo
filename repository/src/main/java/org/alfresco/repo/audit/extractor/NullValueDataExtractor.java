...
/**
 * An extractor that merely records a null value. This enables configuration such that the
 * <i>presence</i> of a data path can be recorded when the actual value is of no interest.
 *
 * @author Derek Hulley
 * @since 3.2
 */
