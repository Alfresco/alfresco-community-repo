...
public class ReplicationRestApiTest extends BaseWebScriptTest {
  ...
  private static final String URL_REPLICATION_SERVICE_STATUS =
    "/api/replication-service-status";
  ...
  public void testReplicationServiceIsEnabled() throws Exception {
    ...
    Response response = sendRequest(
      new GetRequest(URL_REPLICATION_SERVICE_STATUS),
      200
    );
    ...
    assertNotNull(data);
    assertTrue(
      "ReplicationService was unexpectedly disabled.",
      data.getBoolean(ReplicationServiceStatusGet.ENABLED)
    );
  }
  ...
  public void testReplicationDefinitionsGet() throws Exception {
    ...
    response =
      sendRequest(new GetRequest(URL_DEFINITIONS), Status.STATUS_UNAUTHORIZED);
    ...
    assertEquals(JSONObject.NULL, jsonRD.get("startedAt"));
    assertEquals(
      "/api/replication-definition/AnotherTest",
      jsonRD.get("details")
    );
    ...
    // Sort by status
    response =
      sendRequest(new GetRequest(URL_DEFINITIONS + "?sort=status"), 200);
    assertEquals(Status.STATUS_OK, response.getStatus());
    ...
    // By last run
    response =
      sendRequest(new GetRequest(URL_DEFINITIONS + "?sort=lastRun"), 200);
    assertEquals(Status.STATUS_OK, response.getStatus());
  ...
  public void testReplicationDefinitionGet() throws Exception {
    ...
    response =
      sendRequest(
        new GetRequest(URL_DEFINITION + "madeup"),
    ...
    for (int i = 0; i < keys.length(); i++) {
      ...
      if (
        ...
        key.equals("startedAt") ||
        key.equals("endedAt") ||
        key.equals("failureMessage") ||
        key.equals("executionDetails") ||
        key.equals("payload") ||
        key.equals("transferLocalReport") ||
        key.equals("transferRemoteReport") ||
        key.equals("enabled") ||
        key.equals("targetName") ||
        key.equals("schedule")
      ) {
        // All good
      } else {
    ...
    replicationService.saveReplicationDefinition(rd);
    actionTrackingService.recordActionExecuting(rd);
    actionTrackingService.recordActionFailure(
      rd,
    ...
    assertEquals(JSONObject.NULL, json.get("executionDetails"));
    assertEquals(
      repositoryHelper.getRootHome().toString(),
      json.get("transferLocalReport")
    );
    assertEquals(
      repositoryHelper.getCompanyHome().toString(),
      json.get("transferRemoteReport")
    );
  ...
  public void testReplicationDefinitionsPost() throws Exception {
    ...
    response =
      sendRequest(
        new PostRequest(URL_DEFINITIONS, "", JSON),
        Status.STATUS_UNAUTHORIZED
      );
    assertEquals(Status.STATUS_UNAUTHORIZED, response.getStatus());
    ...
    response =
      sendRequest(
        new PostRequest(URL_DEFINITIONS, json.toString(), JSON),
    ...
    ReplicationDefinition rd = replicationService.loadReplicationDefinition(
      "New Definition"
    );
  ...
  public void testReplicationDefinitionPut() throws Exception {
    ...
    response =
      sendRequest(
        new PutRequest(URL_DEFINITION + "MadeUp", "", JSON),
        Status.STATUS_UNAUTHORIZED
      );
    assertEquals(Status.STATUS_UNAUTHORIZED, response.getStatus());
    ...
    response =
      sendRequest(
        new PutRequest(URL_DEFINITION + "Test", "{}", JSON),
        Status.STATUS_OK
      );
    assertEquals(Status.STATUS_OK, response.getStatus());
    ...
    response =
      sendRequest(
        new PutRequest(URL_DEFINITION + "Test", json.toString(), JSON),
        Status.STATUS_OK
      );
    assertEquals(Status.STATUS_OK, response.getStatus());
    ...
    response =
      sendRequest(
        new PutRequest(URL_DEFINITION + "Test2", json.toString(), JSON),
        Status.STATUS_OK
      );
    assertEquals(Status.STATUS_OK, response.getStatus());
    ...
    response =
      sendRequest(
        new PutRequest(URL_DEFINITION + "Renamed", json.toString(), JSON),
        Status.STATUS_OK
      );
    assertEquals(Status.STATUS_OK, response.getStatus());
  ...
  public void testReplicationDefinitionDelete() throws Exception {
    ...
    response =
      sendRequest(
        new DeleteRequest(URL_DEFINITION + "MadeUp"),
        Status.STATUS_UNAUTHORIZED
      );
    assertEquals(Status.STATUS_UNAUTHORIZED, response.getStatus());
    ...
    response =
      sendRequest(
        new DeleteRequest(URL_DEFINITION + "Test"),
    ...
    response =
      sendRequest(
        new GetRequest(URL_DEFINITION + "Test"),
        Status.STATUS_NOT_FOUND
      );
    assertEquals(Status.STATUS_NOT_FOUND, response.getStatus());
    ...
    response =
      sendRequest(
        new DeleteRequest(URL_DEFINITION + "Test 3"),
        Status.STATUS_NO_CONTENT
      );
    assertEquals(Status.STATUS_NO_CONTENT, response.getStatus());
  ...
  public void testReplicationDefinitionsNastyNames() throws Exception {
    ...
    response =
      sendRequest(
        new DeleteRequest(URL_DEFINITION + nastyNameURL),
        Status.STATUS_NO_CONTENT
      );
    assertEquals(Status.STATUS_NO_CONTENT, response.getStatus());
    ...
    response =
      sendRequest(
        new GetRequest(URL_DEFINITION + nastyNameURL),
        Status.STATUS_NOT_FOUND
      );
    assertEquals(Status.STATUS_NOT_FOUND, response.getStatus());
