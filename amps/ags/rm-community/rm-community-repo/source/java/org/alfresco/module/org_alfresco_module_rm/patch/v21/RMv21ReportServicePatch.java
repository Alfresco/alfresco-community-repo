...
public class RMv21ReportServicePatch
  ...
  private static final NodeRef TEMPLATE_ROOT = new NodeRef(
    StoreRef.STORE_REF_WORKSPACE_SPACESSTORE,
    "rm_report_templates"
  );
  private static final NodeRef RM_CONFIG_FOLDER = new NodeRef(
    StoreRef.STORE_REF_WORKSPACE_SPACESSTORE,
    "rm_config_folder"
  );
  ...
  protected void executePatch() {
    ...
    if (
      nodeService.exists(RM_CONFIG_FOLDER) && !nodeService.exists(TEMPLATE_ROOT)
    ) {
      ...
      InputStream is = getClass()
        .getClassLoader()
        .getResourceAsStream(PATH_DESTRUCTION_TEMPLATE);
