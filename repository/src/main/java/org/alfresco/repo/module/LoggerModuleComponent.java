...
/**
 * Module component that logs a message on startup. The log category used will be the ID of the
 * module that contains the component and the name of the component itself. For example:
 *
 * <pre>
...
public class LoggerModuleComponent extends AbstractModuleComponent {
     ...
     *
     * @param logLevel One of the {@code LogLevel} values. The default is {@code LogLevel#INFO}.
     */
    ...
    /**
     * Set the message that must be logged. This can be a message string or an ID of an
