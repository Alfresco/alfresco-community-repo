...
public class NodeChangeTest {
  ...
  public final void testGetAuditDataTrueSubAction() {
    ...
    assertFalse(
      "'user' should not exist in a subAction",
      auditMap.keySet().contains("user")
    );
    assertFalse(
    ...
    assertFalse(
      "'node' should not exist in a subAction",
      auditMap.keySet().contains("node")
    );
    assertFalse(
      "'path' should not exist in a subAction",
      auditMap.keySet().contains("path")
    );
    assertFalse(
      "'type' should not exist in a subAction",
      auditMap.keySet().contains("type")
    );
  }
  ...
  public final void testGetAuditDataFalseTopLevelAction() {
    ...
    assertTrue(
      "'user' should exist if not a subAction",
      auditMap.keySet().contains("user")
    );
    assertTrue(
    ...
    assertTrue(
      "'node' should exist if not a subAction",
      auditMap.keySet().contains("node")
    );
    assertTrue(
      "'path' should exist if not a subAction",
      auditMap.keySet().contains("path")
    );
    assertTrue(
      "'type' should exist if not a subAction",
      auditMap.keySet().contains("type")
    );
  }
  ...
  public final void testSetAuditSubActionsTrue() {
    ...
    assertEquals(
      "subAction audit should exist",
      "createNode",
      auditMap.get("sub-action/0/action")
    );
    assertEquals(
      "subAction audit should exist",
      "deleteNode",
      auditMap.get("sub-action/1/action")
    );
  }
  ...
  public final void testOnMoveNode() {
    ...
    when(fromChildAssocRef.getQName())
      .thenReturn(QName.createQName("URI", "content1"));
    ...
    assertEquals(
      "/cm:homeFolder/cm:folder2/cm:content1",
      auditMap.get("move/from/path")
    );
  ...
  public final void testOnCopyComplete() {
    ...
    assertEquals(
      "/cm:homeFolder/cm:folder2/cm:content2",
      auditMap.get("copy/from/path")
    );
  ...
  public final void testOnUpdateProperties() {
    ...
    assertEquals(
      "location",
      ((Map<?, ?>) auditMap.get("properties/from")).get(
    ...
    assertEquals(
      "LOCATION",
      ((Map<?, ?>) auditMap.get("properties/to")).get(
          ContentModel.PROP_LOCATION
        )
    );
    ...
    assertEquals(
      "ADDRESSEE",
      ((Map<?, ?>) auditMap.get("properties/add")).get(
    ...
    assertEquals(
      "created",
      ((Map<?, ?>) auditMap.get("properties/delete")).get(
  ...
  public final void testReplaceInvalidPathChars() {
    ...
    assertEquals(
      "/&\u3001",
      ((Map<?, ?>) auditMap.get("properties/delete")).get(qName)
    );
  ...
  public final void testOnRemoveAspect() {
    ...
    assertStandardData(
      auditMap,
      "deleteNodeAspect",
      "deleteNodeAspect addNodeAspect"
    );

    assertEquals(3, ((Set<?>) auditMap.get("aspects/delete")).size());
    assertTrue(
      "Grouped cm:archived aspect missing",
      ((Set<?>) auditMap.get("aspects/delete")).contains(
          ContentModel.ASPECT_ARCHIVED
        )
    );
    assertTrue(
  ...
  public final void testOnCreateVersion() {
    ...
    assertEquals(
      ...
      "This is a test",
      ((Map<?, ?>) auditMap.get("version-properties")).get(
