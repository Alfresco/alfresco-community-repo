 ...
 *
 * <p>Index of CMIS Type Definitions
 *
 * @author sglover
 */
public class CMISDictionaryRegistryImpl implements CMISDictionaryRegistry {
    ...
    private Map<String, List<TypeDefinitionWrapper>> children =
            new HashMap<String, List<TypeDefinitionWrapper>>();
            ...
            if (defaultAspects != null && defaultAspects.size() > 0) {
                ...
                for (AspectDefinition aspectDef : defaultAspects) {
                    ...
                    TypeDefinitionWrapper aspectType =
                            getTypeDefByQName(cmisMapping.getCmisType(aspectQName));
                    if (aspectType == null) {
                        continue;
                    }
    ...
    public void addModel(CompiledModel model) {
        Collection<AbstractTypeDefinitionWrapper> types =
                dictionaryInitializer.createDefinitions(this, model);
        addTypes(types);
    ...
    private void addTypes(Collection<AbstractTypeDefinitionWrapper> types) {
        ...
        for (AbstractTypeDefinitionWrapper objectTypeDef : types) {
            List<TypeDefinitionWrapper> children =
                    objectTypeDef.connectParentAndSubTypes(cmisMapping, this, dictionaryService);
    ...
    public void init() {
        ...
        Collection<AbstractTypeDefinitionWrapper> types =
                dictionaryInitializer.createDefinitions(this);
        addTypes(types);
    ...
    public void registerTypeDefinition(AbstractTypeDefinitionWrapper typeDef) {
        ...
        if (existingTypeDef != null) {
            //            throw new AlfrescoRuntimeException("Type " + typeDef.getTypeId() + "
            // already registered");
