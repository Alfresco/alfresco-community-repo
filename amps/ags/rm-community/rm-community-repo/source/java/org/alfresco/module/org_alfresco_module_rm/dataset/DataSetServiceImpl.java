...
public class DataSetServiceImpl
  implements DataSetService, RecordsManagementModel {
  ...
  public void loadDataSet(NodeRef filePlan, String dataSetId) {
    ...
    try {
      ...
      throw new AlfrescoRuntimeException(
        "Unexpected exception thrown. Please refer to the log files for details.",
        ex
      );
    } finally {
      if (is != null) {
  ...
  public Map<String, DataSet> getLoadedDataSets(NodeRef filePlan) {
    ...
    Serializable dataSetIds = nodeService.getProperty(
      filePlan,
    ...
    if (dataSetIds != null) {
      ...
      Iterator<Map.Entry<String, DataSet>> iterator = availableDataSets
        .entrySet()
        .iterator();
  ...
  private void setDataSetIdIntoFilePlan(String dataSetId, NodeRef filePlan) {
    ...
    if (dataSetIds == null) {
      ...
      loadedDataSetIds =
        (ArrayList<String>) nodeService.getProperty(
          filePlan,
          PROP_LOADED_DATA_SET_IDS
        );
    } else {
