 ...
 *
 * <p>The node returned can be of a specific <code>type</code> and/or have a specific <code>aspect
 * </code> applied.
 *
 * <p>If no parameters are passed the immediate primary parent is returned.
 *
 * @author Nick Smith
 * @since 4.0
 */
public class AncestorNodeLocator extends AbstractNodeLocator {
    ...
    public List<ParameterDefinition> getParameterDefinitions() {
        ...
        paramDefs.add(
                new ParameterDefinitionImpl(TYPE_KEY, DataTypeDefinition.QNAME, false, "Type"));
        paramDefs.add(
                new ParameterDefinitionImpl(ASPECT_KEY, DataTypeDefinition.QNAME, false, "Aspect"));
        return paramDefs;
    }
