...
/**
 * An {@link MBeanExporter} that allows individual MBeans to be registered and unregistered over
 * time.
 */
public class DynamicMBeanExporter extends MBeanExporter implements DynamicMBeanExportOperations {
    private static ThreadLocal<MBeanServer> threadServer = new ThreadLocal<MBeanServer>();
