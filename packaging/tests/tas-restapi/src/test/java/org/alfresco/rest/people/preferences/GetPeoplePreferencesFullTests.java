...
public class GetPeoplePreferencesFullTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user gets its preferences with skipCount parameter applied with Rest"
                            + " API and response is successful")
        ...
        restPreferenceModelsCollection
                ...
                .entriesListDoesNotContain(
                        ...
                        String.format(
                                ...
                                siteModel.getId()))
                .and()
                .entriesListContains("id", PreferenceName.FOLDERS_FAVORITES_PREFIX.toString())
                .and()
                .entriesListContains("value", "workspace://SpacesStore/" + folderModel.getNodeRef())
                .and()
                .entriesListContains(
                        "id",
                        String.format(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user gets its preferences with maxItems parameter applied with Rest API"
        ...
        restPreferenceModelsCollection
                ...
                .entriesListDoesNotContain(
                        ...
                        String.format(
                                ...
                                siteModel.getId()))
                .and()
                .entriesListDoesNotContain("id", PreferenceName.FOLDERS_FAVORITES_PREFIX.toString())
                .and()
                .entriesListDoesNotContain(
                        "value", "workspace://SpacesStore/" + folderModel.getNodeRef())
                .and()
                .entriesListDoesNotContain(
                        "id",
                        String.format(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user gets admin preferences with Rest API and response is permission"
                            + " denied")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user gets its preferences with skipCount parameter higher then no of"
                            + " entries with Rest API and response is empty")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user cannot get preferences for empty user with Rest API and response"
                            + " is 400")
