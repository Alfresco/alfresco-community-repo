...
public class KeyStoreTests {
  ...
  public void setup() throws SystemException, NotSupportedException {
    ...
    encryptionKeysRegistry =
      (EncryptionKeysRegistry) ctx.getBean("encryptionKeysRegistry");
    keyResourceLoader =
      (KeyResourceLoader) ctx.getBean("springKeyResourceLoader");
  ...
  protected TestAlfrescoKeyStore getKeyStore(
    ...
    KeyStoreParameters backupKeyStoreParameters = new KeyStoreParameters(
      name + ".backup",
      type,
      null,
      "",
  ...
  public void test1() {
    ...
    TestAlfrescoKeyStore missingMainKeyStore = getKeyStore(
      "main",
      "JCEKS",
    ...
    missingMainKeyStore.setKeysToValidate(
      new HashSet<>(Collections.singletonList("metadata"))
    );
    ...
    assertTrue(
      "",
      missingMainKeyStore.getKey(KeyProvider.ALIAS_METADATA) != null
    );
  }
  ...
  public void test3() {
    ...
    TestAlfrescoKeyStore mainKeyStore = getKeyStore(
      "main",
      "JCEKS",
      Collections.singletonMap(KeyProvider.ALIAS_METADATA, "metadata"),
      null,
    ...
    mainKeyStore.setKeysToValidate(
      new HashSet<>(Collections.singletonList("metadata"))
    );
  ...
  public void test4() {
    ...
    TestAlfrescoKeyStore keyStore = getKeyStore(
      "main",
      "JCEKS",
      Collections.singletonMap(KeyProvider.ALIAS_METADATA, "metadata"),
      null,
