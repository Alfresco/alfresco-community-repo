...
public class GetTypeDescendantsTests extends CmisTest
{
    ...
    /**
     * Get type descendants for a valid type id and includePropertyDefinitions set to true and depth set to -1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    ...
    /**
     * Get type descendants for a valid type id and includePropertyDefinitions set to false and depth set to 1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @Test(groups = {TestGroup.CMIS, TestGroup.REGRESSION})
    @TestRail(section = {"cmis-api"}, executionType = ExecutionType.REGRESSION,
    ...
    /**
     * Get type descendantes for a valid type id and includePropertyDefinitions set to false and depth set to -1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @Test(groups = {TestGroup.CMIS, TestGroup.REGRESSION})
    @TestRail(section = {"cmis-api"}, executionType = ExecutionType.REGRESSION,
    ...
    /**
     * Get type descendantes for an invalid type id and includePropertyDefinitions set to false and depth set to -1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    ...
    /**
     * Get type descendantes for a valid type id and includePropertyDefinitions set to false and incorrect depth set to -2 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
