...
public class PeriodDataTypeParameters implements DataTypeParameters, Serializable {
    ...
    /**
     * Retrieves a List of PeriodProvider objects representing the valid period options for the
     * property
     *
     ...
     * @return A JSONArray object holding JSONObject's representing the period definitions
     */
        ...
        try {
            for (PeriodProvider pp : this.providers) {
                boolean hasExpression =
                        !(pp.getExpressionMutiplicity()
                                .equals(PeriodProvider.ExpressionMutiplicity.NONE));
                ...
                if (hasExpression) {
                    period.put(
                            "expressionMandatory",
                            pp.getExpressionMutiplicity()
                                    .equals(PeriodProvider.ExpressionMutiplicity.MANDATORY));
