...
public class AbstractCacheFactoryTest {
  ...
  public void emptyPropertyYieldsDefault() {
    ...
    assertEquals(
      "",
      cacheFactory.getProperty("the.cache.name", "emptyProperty", "")
    );
    ...
    assertEquals(
      null,
      cacheFactory.getProperty("the.cache.name", "emptyProperty", null)
    );
    ...
    assertEquals(
      "default",
      cacheFactory.getProperty("the.cache.name", "emptyProperty", "default")
    );
  }
  ...
  public void nonEmptyPropertyIsReturned() {
    ...
    properties.setProperty(
      "the.cache.name.nonEmpty",
      "this has a non-empty value"
    );
    assertEquals(
      "this has a non-empty value",
      cacheFactory.getProperty("the.cache.name", "nonEmpty", "default")
    );
  }
