...
public class QueriesPeopleApiTest extends AbstractSingleNetworkSiteTest {
  ...
  private static String TEST_TERM_PREFIX = Long.toString(
  ...
  private void createTestUsers()
    throws IllegalArgumentException, SystemException, NotSupportedException, HeuristicRollbackException, HeuristicMixedException, RollbackException {
  ...
  private static PersonInfo newPersonInfo(String... properties)
    throws IllegalArgumentException {
    int l = properties.length;
    if (l > 17) {
      throw new IllegalArgumentException(
        "Too many properties supplied for " + properties
      );
    }
    return new PersonInfo(
      ...
      (l <= 3 || properties[3] == null ? "password" : properties[3]), // password
      (
        l <= 4
          ? null
          : new Company(
  ...
  public void testFieldsFirstLast() throws Exception {
    ...
    List<String> expectedPeople = Arrays.asList(
      "Person [" +
      "lastName=LastA, company=Company [address1=null, address2=null, address3=null, postcode=null, telephone=null, fax=null, email=null], ]", // USER4
      "Person [" +
      "firstName=FirstA, lastName=LastA, company=Company [address1=null, address2=null, address3=null, postcode=null, telephone=null, fax=null, email=null], ]", // USER0
      "Person [" +
      "firstName=FirstB, lastName=LastA, company=Company [address1=null, address2=null, address3=null, postcode=null, telephone=null, fax=null, email=null], ]" // USER2
    );
  ...
  public void testFieldsId() throws Exception {
    ...
    List<String> expectedPeople = Arrays.asList(
      "Person [id=user4" +
      tenantSuffix +
      ", company=Company [address1=null, address2=null, address3=null, postcode=null, telephone=null, fax=null, email=null], ]", // USER4
      "Person [id=user0" +
      tenantSuffix +
      ", company=Company [address1=null, address2=null, address3=null, postcode=null, telephone=null, fax=null, email=null], ]", // USER0
      "Person [id=user2" +
      tenantSuffix +
      ", company=Company [address1=null, address2=null, address3=null, postcode=null, telephone=null, fax=null, email=null], ]" // USER2
    );
