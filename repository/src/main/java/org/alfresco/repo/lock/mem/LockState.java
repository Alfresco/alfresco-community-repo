...
public final class LockState implements Serializable {
  ...
  public static LockState createWithLockType(
    LockState lockState,
    LockType lockType
  ) {
    return new LockState(
  ...
  public static LockState createWithLifetime(
    LockState lockState,
    Lifetime lifetime
  ) {
    return new LockState(
  ...
  public static LockState createWithAdditionalInfo(
    LockState lockState,
    String additionalInfo
  ) {
    return new LockState(
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((this.expires == null) ? 0 : this.expires.hashCode());
    result =
      prime * result + ((this.lifetime == null) ? 0 : this.lifetime.hashCode());
    result =
      prime * result + ((this.lockType == null) ? 0 : this.lockType.hashCode());
    result =
      prime * result + ((this.nodeRef == null) ? 0 : this.nodeRef.hashCode());
    result =
