...
public class Role extends org.alfresco.module.org_alfresco_module_rm.role.Role {
    ...
    /** Compatibility method */
    public static Set<Role> toRoleSet(
            Set<org.alfresco.module.org_alfresco_module_rm.role.Role> roles) {
    ...
    @Deprecated
    public Role(
            String name, String displayLabel, Set<Capability> capabilities, String roleGroupName) {
