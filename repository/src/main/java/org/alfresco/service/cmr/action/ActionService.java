...
public interface ActionService {
    ...
    /**
     * Get all the action definitions that are applicable for the given node, based on its type and
     * aspects.
     *
     ...
     *
     * <p>If specified that the conditions should be checked then any conditions set on the action
     * are evaluated.
     *
     * <p>If the conditions fail then the action is not executed.
     *
     * <p>If an action has no conditions then the action will always be executed.
     *
     * <p>If the conditions are not checked then the action will always be executed.
     *
     * @param action the action
     * @param actionedUponNodeRef the actioned upon node reference
     * @param checkConditions indicates whether the conditions should be checked before executing
     *     the action
     * @param executeAsynchronously indicates whether the action should be executed asychronously or
     *     not, this value overrides the value set on the action its self
     */
    @Auditable(
            parameters = {
                "action",
     ...
     *
     * <p>Returns true if the action has no conditions.
     *
     * <p>If the action has more than one condition their results are combined using the 'AND'
     * logical operator.
     *
     * @param action the action
     * @param actionedUponNodeRef the actioned upon node reference
     ...
     *
     * <p>The node will be made configurable if it is not already.
     *
     * <p>If the action already exists then its details will be updated.
     *
     * @param nodeRef the node reference
     * @param action the action
     */
     ...
     *
     * <p>Returns null if the action can not be found.
     *
     * @param nodeRef the node reference
