...
public class InplaceRecordSearchTests extends BaseRMRestTest
{
    ...
    /**
     * Given a RM site And a private collaboration site And a site collaborator And a site consumer And a user who is not a member of the site And a document that isn't a record When the collaborator declares it as a record Then the collaborator can browse to the record in the document library And can find the record using live search And can find the record using advanced search And the consumer can browse to the record in the document library And can find the record using live search And can find the record using advanced search And the user who is not a member of the site can't find the record using live search And can't find the record using advanced search
     */
    @Test
    ...
    /**
     * Given @see {@link #searchForInplaceRecord()} When the collaboration user hides the record in the collaboration site Then the collaborator can not browse to the record in the document library And can't find the record using live search And can't find the record using advanced search
     */
