...
/**
 * Custom stringifier for hash encoded strings of {@link Reference}s having the protocol set to
 * {@link VirtualProtocol}.
 */
public class VirtualHashStringifier extends ProtocolHashStringifier {
    ...
    protected String stringifyVirtualReference(Reference reference) {
        ...
        ResourceParameter actualNodeParameter =
                (ResourceParameter)
                        parameters.get(VirtualProtocol.ACTUAL_NODE_LOCATION_PARAM_INDEX);
        ...
        templatePathParameter =
                (StringParameter) parameters.get(VirtualProtocol.TEMPLATE_PATH_PARAM_INDEX);
