...
public class GetSiteMembershipRequestsTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    moderatedSite1 =
      dataSite.usingUser(siteManager).createModeratedRandomSite();
    moderatedSite2 =
      dataSite.usingUser(siteManager).createModeratedRandomSite();
    ...
    restClient
      .withCoreAPI()
      .usingAuthUser()
      .addSiteMembershipRequest(moderatedSite2);
    restClient.assertStatusCodeIs(HttpStatus.CREATED);
  ...
  public void managerUserGetsSiteMembershipRequestsWithSuccess()
    throws Exception {
  ...
  public void collaboratorUserFailsToGetSiteMembershipRequestsOfAnotherUser()
    throws Exception {
    restClient
      .authenticateUser(
  ...
  public void contributorUserFailsToGetSiteMembershipRequestsOfAnotherUser()
    throws Exception {
    restClient
      .authenticateUser(
  ...
  public void consumerUserFailsToGetSiteMembershipRequestsOfAnotherUser()
    throws Exception {
    restClient
      .authenticateUser(
  ...
  public void adminGetsSiteMembershipRequestsOfanotherUserWithSuccess()
    throws Exception {
    siteMembershipRequests =
      restClient
  ...
  public void unauthorizedUserFailsToGetSiteMembershipRequests()
    throws Exception {
    restClient
  ...
  public void oneUserGetsItsOwnSiteMembershipRequestsWithSuccess()
    throws Exception {
    siteMembershipRequests =
      restClient
        .authenticateUser(newMember)
    ...
    RestSiteModel firstSite = siteMembershipRequests
      .getEntries()
      .get(0)
      .onModel()
      .getSite();
  ...
  public void ifPersonIdDoesNotExist() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "nonexistent")
      )
  ...
  public void getRequestsToPublicSite() throws Exception {
    ...
    siteMembershipRequests
      .assertThat()
      .entriesListDoesNotContain("id", publicSite.getId());
  }
  ...
  public void adminGetsItsOwnSiteMembershipRequestsWithSuccess()
    throws Exception {
    siteMembershipRequests =
      restClient
        .authenticateUser(adminUser)
  ...
  public void regularUserFailsToGetSiteMembershipRequestsOfAnotherUser()
    throws Exception {
    restClient
  ...
  public void regularUserFailsToGetSiteMembershipRequestsOfAdmin()
    throws Exception {
    restClient
      .authenticateUser(regularUser)
      .withCoreAPI()
  ...
  public void getSiteMembershipRequestsButSkipTheFirstOne() throws Exception {
    ...
    RestSiteMembershipRequestModel firstSiteMembershipRequest = siteMembershipRequests
      .getEntries()
      .get(0)
      .onModel();
    RestSiteMembershipRequestModel secondSiteMembershipRequest = siteMembershipRequests
      .getEntries()
      .get(1)
      .onModel();
  ...
  public void getSiteMembershipRequestsWhereThereAreNoRequests()
    throws Exception {
    siteMembershipRequests =
      restClient
        .authenticateUser(regularUser)
  ...
  public void getSiteMembershipRequestsWithProperties() throws Exception {
    ...
    siteMembershipRequests
      ...
      .assertThat()
      .entriesListContains("id", moderatedSite2.getId());
    RestSiteMembershipRequestModel siteMembershipRequest = siteMembershipRequests
      .getOneRandomEntry()
      .onModel();
  ...
  @TestRail(
    ...
    executionType = ExecutionType.SANITY,
    description = "Sanity test for endpoints: GET /site-membership-requests, POST /sites/{siteId}/site-membership-requests/{inviteeId}/approve, POST /sites/{siteId}/site-membership-requests/{inviteeId}/reject"
  )
  public void approveRejectSiteMembership() throws Exception {
    ...
    RestSitePersonMembershipRequestModelsCollection membership = restClient
    ...
    STEP(
      "3. Approve site membership for one of the users. Check that the user is now a member of the site"
    );
    restClient
      .authenticateUser(siteManager)
      .withCoreAPI()
    ...
    STEP(
      "4. Reject site membership for the second user. Check that the user is not a member of the site"
    );
    restClient
      .authenticateUser(siteManager)
      .withCoreAPI()
    ...
    restClient.assertStatusCodeIs(HttpStatus.OK);
    RestSiteMemberModelsCollection memberList = restClient
      .withCoreAPI()
      .usingSite(moderatedSite1)
      .getSiteMembers();
    memberList
      .assertThat()
      .entriesListDoesNotContain("id", testUser1.getUsername());
  }
}
