...
public class AddSiteMemberTests extends RestTest {
    ...
    private ListUserWithRoles publicSiteUsersWithRoles,
            moderatedSiteUsersWithRoles,
            privateSiteUsersWithRoles;
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.SITES},
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that manager is able to add site member and gets status code CREATED"
                            + " (201)")
    public void managerIsAbleToAddSiteMember() throws Exception {
        ...
        restClient.authenticateUser(
                publicSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteManager));
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addPerson(testUser)
                .assertThat()
                .field("id")
    ...
    @TestRail(
            ...
            description =
                    "Verify that site collaborator is not able to add site member and gets status"
                            + " code FORBIDDEN (403)")
    public void collaboratorIsNotAbleToAddSiteMember() throws Exception {
        ...
        restClient
                .authenticateUser(
                        publicSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator))
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addPerson(testUser);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site contributor is not able to add site member and gets status"
                            + " code FORBIDDEN (403)")
    public void contributorIsNotAbleToAddSiteMember() throws Exception {
        ...
        restClient
                .authenticateUser(
                        publicSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteContributor))
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addPerson(testUser);
        restClient.assertLastError().containsSummary("Permission was denied");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site consumer is not able to add site member and gets status code"
                            + " FORBIDDEN (403)")
    public void consumerIsNotAbleToAddSiteMember() throws Exception {
        ...
        restClient
                .authenticateUser(
                        publicSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteConsumer))
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addPerson(testUser);
        restClient.assertLastError().containsSummary("Permission was denied");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that admin user is able to add site member and gets status code CREATED"
                            + " (201)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can add another user as manager to a public site and gets"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can add another user as manager to a moderated site and"
                            + " gets status code CREATED (201)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can add another user as manager to a private site and gets"
                            + " status code CREATED (201)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that consumer role is not able to add another user to a moderated site"
                            + " and gets status code 403")
    public void addUserByConsumerToModeratedSite() throws Exception {
        UserModel testUser = dataUser.createRandomTestUser("testUser");
        testUser.setUserRole(UserRole.SiteConsumer);
        restClient
                .authenticateUser(
                        moderatedSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteConsumer))
                .withCoreAPI()
                .usingSite(moderatedSiteModel)
                .addPerson(testUser);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that consumer role is not able to add another user to a private site"
                            + " and gets status code 403")
    public void addUserByConsumerToPrivateSite() throws Exception {
        ...
        restClient
                .authenticateUser(
                        privateSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteConsumer))
                .withCoreAPI()
                .usingSite(privateSiteModel)
                .addPerson(testUser);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that collaborator role is not able to add another user to a moderated"
                            + " site and gets status code 403")
    public void addUserByCollaboratorToModeratedSite() throws Exception {
        UserModel testUser = dataUser.createRandomTestUser("testUser");
        testUser.setUserRole(UserRole.SiteConsumer);
        restClient
                .authenticateUser(
                        moderatedSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator))
                .withCoreAPI()
                .usingSite(moderatedSiteModel)
                .addPerson(testUser);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that collaborator role is not able to add another user to a private"
                            + " site and gets status code 403")
    public void addUserByCollaboratorToPrivateSite() throws Exception {
        ...
        restClient
                .authenticateUser(
                        privateSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator))
                .withCoreAPI()
                .usingSite(privateSiteModel)
                .addPerson(testUser);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that contributor role is not able to add another user to a moderated"
                            + " site and gets status code 403")
    public void addUserByContributorToModeratedSite() throws Exception {
        ...
        restClient
                .authenticateUser(
                        moderatedSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteContributor))
                .withCoreAPI()
                .usingSite(moderatedSiteModel)
                .addPerson(testUser);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that contributor role is not able to add another user to a private site"
                            + " and gets status code 403")
    public void addUserByContributorToPrivateSite() throws Exception {
        ...
        restClient
                .authenticateUser(
                        privateSiteUsersWithRoles.getOneUserWithRole(UserRole.SiteContributor))
                .withCoreAPI()
                .usingSite(privateSiteModel)
                .addPerson(testUser);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that a user without specified role can not be added to a site and gets"
                            + " status code 400")
    public void canNotAddUserWithoutSpecifyingRoleToSite() throws Exception {
        ...
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST,
                        json,
                        "sites/{siteId}/members?{parameters}",
                        publicSiteModel.getId(),
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that a user with inexistent role can not be added to a site and gets"
                            + " status code 400")
    public void canNotAddUserWithInexistentRoleToSite() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNKNOWN_ROLE, "inexistentRole"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not add himself as a manager to a public site and gets"
                            + " status code 403")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not add himself as a manager to a moderated site and gets"
                            + " status code 403")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not add himself as a manager to a private site and gets"
                            + " status code 404")
    public void userAddHimselfAsManagerToPrivateSite() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, privateSiteModel.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not be added to an inexistent site and gets status code"
                            + " 404")
    public void userIsNotAbleToAddUserToAnInexistentSite() throws Exception {
        ...
        restClient
                .authenticateUser(adminUserModel)
                .withCoreAPI()
                .usingSite(inexistentSite)
                .addPerson(testUser);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, inexistentSite.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not be added to a site if an empty site id is provided"
                            + " and gets status code 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that inexistent user can not be added to site and gets status code 404")
    public void userIsNotAbleToAddInexistentUserToSite() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, testUser.getUsername()))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that empty username can not be added to site and gets status code 400")
    public void userIsNotAbleToAddEmptyUserIdToSite() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.NO_CONTENT, testUser.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not add another user that is already a memeber and gets"
                            + " status code 409")
    public void userIsNotAbleToAddUserThatIsAlreadyAMember() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.CONFLICT)
                .assertLastError()
                .containsSummary(
                        String.format(
                                RestErrorModel.ALREADY_Site_MEMBER,
                                collaborator.getUsername(),
                                moderatedSiteModel.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that several users with different roles can be added once in a row to a"
                            + " site and gets status code 201")
    public void addSeveralUsersWithDifferentRolesToASite() throws Exception {
        ...
        String json =
                String.format(
                        addMembersJson,
                        firstUser.getUserRole(),
                        firstUser.getUsername(),
                        secondUser.getUserRole(),
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that several users with same roles can be added once in a row to a site"
                            + " and gets status code 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that several users that are already added to the site can not be added"
                            + " once in a row and gets status code 400")
    public void addSeveralUsersThatAreAlreadyAddedToASite() throws Exception {
        ...
        String json =
                String.format(
                        addMembersJson,
                        collaborator.getUserRole(),
                        collaborator.getUsername(),
                        consumer.getUserRole(),
    ...
    public void addSiteMemberUsingEmptyBody() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.NO_CONTENT, "No content to map due to end-of-input"))
                .containsErrorKey(
                        String.format(
                                RestErrorModel.NO_CONTENT, "No content to map due to end-of-input"))
                .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
    ...
    public void adminCanBeAddedToPrivateSiteBySiteManager() throws Exception {
        ...
        memberModel =
                restClient
                        ...
                        .addPerson(adminUserModel);
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        memberModel
                .assertThat()
                .field("id")
                .is(adminUserModel.getUsername())
                .and()
                .field("role")
                .is(adminUserModel.getUserRole());
    }
    ...
    public void adminCannotBeAddedToPrivateSiteBySiteCollaborator() throws Exception {
        ...
        memberModel =
                restClient
                        .authenticateUser(siteCollaborator)
                        .withCoreAPI()
                        .usingSite(privateSite)
                        .addPerson(adminUserModel);
        restClient
