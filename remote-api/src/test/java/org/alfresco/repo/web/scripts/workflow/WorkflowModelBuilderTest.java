...
public class WorkflowModelBuilderTest extends TestCase {
    ...
    private static final NodeRef person =
            new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, userName);
    private static final NodeRef workflowPackage =
            new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "workflowPackage");
    ...
    public void testBuildWorkflowTask() throws Exception {
        ...
        Map<String, Object> owner =
                (Map<String, Object>) model.get(WorkflowModelBuilder.TASK_OWNER);
        ...
        Map<String, Object> workflowInstance =
                (Map<String, Object>) model.get(WorkflowModelBuilder.TASK_WORKFLOW_INSTANCE);
        ...
        assertEquals(
                instance.isActive(),
                workflowInstance.get(WorkflowModelBuilder.TASK_WORKFLOW_INSTANCE_IS_ACTIVE));
        String startDateStr = ISO8601DateFormat.format(instance.getStartDate());
        String workFlowStartDateStr =
                (String)
    ...
    public void testBuildWorkflowTaskDetailed() throws Exception {
        ...
        assertEquals(
                workflowTask.getDescription(), model.get(WorkflowModelBuilder.TASK_DESCRIPTION));
        ...
        assertEquals(
                ...
                workflowInstance.get(WorkflowModelBuilder.TASK_WORKFLOW_INSTANCE_IS_ACTIVE));
        String startDateStr = ISO8601DateFormat.format(instance.getStartDate());
        String startDateBuilderStr =
                ISO8601DateFormat.formatToZulu(
                        (String)
                                workflowInstance.get(
                                        WorkflowModelBuilder.TASK_WORKFLOW_INSTANCE_START_DATE));
        ...
        Map<String, Object> actualDefinition =
                (Map<String, Object>) model.get(WorkflowModelBuilder.TASK_DEFINITION);
        WorkflowTaskDefinition taskDef = workflowTask.getDefinition();
        assertEquals(
                taskDef.getId(), actualDefinition.get(WorkflowModelBuilder.TASK_DEFINITION_ID));

        Map<String, Object> actualType =
                (Map<String, Object>)
                        actualDefinition.get(WorkflowModelBuilder.TASK_DEFINITION_TYPE);
        ...
        Map<String, Object> actualNode =
                (Map<String, Object>)
                        actualDefinition.get(WorkflowModelBuilder.TASK_DEFINITION_NODE);
        ...
        List<Map<String, Object>> transitions =
                (List<Map<String, Object>>)
                        actualNode.get(WorkflowModelBuilder.WORKFLOW_NODE_TRANSITIONS);
        ...
        for (Map<String, Object> transition : transitions) {
            ...
            assertEquals(
                    ...
                    transition.get(WorkflowModelBuilder.WORKFLOW_NODE_TRANSITION_DESCRIPTION));
            assertEquals(
                    workflowTransition.isDefault(),
                    transition.get(WorkflowModelBuilder.WORKFLOW_NODE_TRANSITION_IS_DEFAULT));
            assertEquals(
                    false, transition.get(WorkflowModelBuilder.WORKFLOW_NODE_TRANSITION_IS_HIDDEN));
            i++;
        }
    }
    ...
    public void testBuildWorkflowDefinition() throws Exception {
        ...
        assertEquals(
                workflowDefinition.getId(), model.get(WorkflowModelBuilder.WORKFLOW_DEFINITION_ID));
        assertEquals(
    ...
    public void testBuildWorkflowInstance() throws Exception {
        ...
        Map<String, Object> initiator =
                (Map<String, Object>)
                        model.get(WorkflowModelBuilder.TASK_WORKFLOW_INSTANCE_INITIATOR);
        if (initiator != null) {
    ...
    public void testBuildWorkflowInstanceDetailed() throws Exception {
        ...
        Map<String, Object> taskInstanceModel =
                (Map<String, Object>)
                        model.get(WorkflowModelBuilder.TASK_WORKFLOW_INSTANCE_DEFINITION);

        assertEquals(
                workflowInstance.getDefinition().getVersion(),
                taskInstanceModel.get(WorkflowModelBuilder.WORKFLOW_DEFINITION_VERSION));
        assertEquals(
                workflowInstance.getDefinition().getStartTaskDefinition().getMetadata().getName(),
    ...
    private WorkflowPath makePath() {
        ...
        WorkflowInstance instance =
                new WorkflowInstance(
                        "", definition, null, null, null, workflowPackage, true, startDate, null);
