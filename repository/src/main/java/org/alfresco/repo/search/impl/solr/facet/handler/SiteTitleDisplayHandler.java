...
public class SiteTitleDisplayHandler extends AbstractFacetLabelDisplayHandler {
    ...
    public SiteTitleDisplayHandler(
            Set<String> supportedFieldFacets, Map<String, String> nonSiteLocationsLabels) {
        ...
        this.nonSiteLocationsLabels =
                nonSiteLocationsLabels == null
