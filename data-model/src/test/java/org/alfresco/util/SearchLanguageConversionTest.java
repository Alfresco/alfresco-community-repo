...
public class SearchLanguageConversionTest extends TestCase {
  ...
  public void testSqlToLucene() {
    ...
    String lucene = "AB*?\\*\\?%_";
    String converted = SearchLanguageConversion.convert(
      SearchLanguageConversion.DEF_SQL_LIKE,
