...
public class RenditionServiceIntegrationTest extends BaseAlfrescoSpringTest {
    ...
    private static final QName REFORMAT_RENDER_DEFN_NAME =
            QName.createQName(
                    NamespaceService.CONTENT_MODEL_1_0_URI,
                    ReformatRenderingEngine.NAME + System.currentTimeMillis());
    private static final QName RESCALE_RENDER_DEFN_NAME =
            QName.createQName(
                    NamespaceService.CONTENT_MODEL_1_0_URI,
    ...
    private static final String FM_TEMPLATE =
            "/org/alfresco/repo/rendition/renditionTestTemplate.ftl";
    ...
    public void before() throws Exception {
        ...
        this.testTargetFolder =
                createNode(companyHome, "testFolder-" + GUID.generate(), ContentModel.TYPE_FOLDER);

        // Create the node used as a content supplier for tests
        this.nodeWithDocContent =
                createContentNode(companyHome, "testDocContent-" + GUID.generate());
        ...
        ContentWriter writer =
                contentService.getWriter(nodeWithDocContent, ContentModel.PROP_CONTENT, true);
        ...
        // Create a test image
        this.nodeWithImageContent =
                createContentNode(companyHome, "testImageNode-" + GUID.generate());
        // Stream some well-known image content into the node.
        URL url =
                RenditionServiceIntegrationTest.class
                        .getClassLoader()
                        .getResource("images/gray21.512.png");
    ...
    private void setImageContentOnNode(
            NodeRef nodeWithImage, String mimetypeImage, File imageFile) {
        assertTrue(imageFile.exists());
        nodeService.setProperty(
                nodeWithImage,
                ContentModel.PROP_CONTENT,
                new ContentData(null, mimetypeImage, 0L, null));
        ContentWriter writer =
                contentService.getWriter(nodeWithImage, ContentModel.PROP_CONTENT, true);
    ...
    public void testRenderFreeMarkerTemplate() throws Exception {
        final QName renditionName =
                QName.createQName(
                        NamespaceService.RENDITION_MODEL_1_0_URI, FreemarkerRenderingEngine.NAME);
                            ...
                            public NodeRef execute() throws Throwable {
                                ...
                                RenditionDefinition definition =
                                        renditionService.createRenditionDefinition(
                                                renditionName, FreemarkerRenderingEngine.NAME);
                                definition.setParameterValue(
                                        FreemarkerRenderingEngine.PARAM_TEMPLATE_NODE,
                                        nodeWithFreeMarkerContent);
                                ChildAssociationRef renditionAssoc =
                                        renditionService.render(nodeWithDocContent, definition);
    ...
    public void testHTMLRenderFreeMarkerTemplate() throws Exception {
        final QName renditionName =
                QName.createQName(
                        NamespaceService.RENDITION_MODEL_1_0_URI, "htmlRenderingDefinition");
        ...
        this.renditionNode =
                transactionHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            ...
                            public NodeRef execute() throws Throwable {
                                // create test model
                                RenditionDefinition htmlDefinition =
                                        renditionService.createRenditionDefinition(
                                                renditionName, FreemarkerRenderingEngine.NAME);
                                ...
                                htmlDefinition.setParameterValue(
                                        ...
                                        nodeWithFreeMarkerContent);
                                htmlDefinition.setParameterValue(
                                        FreemarkerRenderingEngine.PARAM_MIME_TYPE,
                                ...
                                htmlDefinition.setParameterValue(
                                        FreemarkerRenderingEngine.PARAM_MODEL,
                                        (Serializable) paramMap);

                                ChildAssociationRef renditionAssoc =
                                        renditionService.render(nodeWithDocContent, htmlDefinition);
                                assertNotNull("The rendition association was null", renditionAssoc);
                                return renditionAssoc.getChildRef();
                            }
                        });
    ...
    public void testRenderFreemarkerTemplatePath() throws Exception {
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<
                            ...
                            public Pair<NodeRef, NodeRef> execute() throws Throwable {
                                ChildAssociationRef parentAssoc =
                                        nodeService.getPrimaryParent(nodeWithFreeMarkerContent);
                                QName assocName = parentAssoc.getQName();
                                String templatePath =
                                        "/app:company_home/"
                                                + assocName.toPrefixString(namespaceService);

                                // create test model 1 - rendition to update on any property change
                                RenditionDefinition definition1 =
                                        renditionService.createRenditionDefinition(
                                                renditionName1, FreemarkerRenderingEngine.NAME);
                                definition1.setParameterValue(
                                        FreemarkerRenderingEngine.PARAM_TEMPLATE_PATH,
                                        templatePath);
                                definition1.setParameterValue(
                                ...
                                // create test model 2 - rendition to update on content property
                                // change
                                RenditionDefinition definition2 =
                                        renditionService.createRenditionDefinition(
                                                renditionName2, FreemarkerRenderingEngine.NAME);
                                definition2.setParameterValue(
                                        FreemarkerRenderingEngine.PARAM_TEMPLATE_PATH,
                                        templatePath);
                                definition2.setParameterValue(
                                        AbstractRenderingEngine
                                ...
                                if (null
                                        == renditionService.loadRenditionDefinition(
                                                renditionName1)) {
                                ...
                                ChildAssociationRef renditionAssoc1 =
                                        renditionService.render(nodeWithDocContent, definition1);
                                assertNotNull(
                                        "The rendition association was null", renditionAssoc1);

                                ChildAssociationRef renditionAssoc2 =
                                        renditionService.render(nodeWithDocContent, definition2);
                                assertNotNull(
                                        "The rendition association was null", renditionAssoc2);

                                Pair<NodeRef, NodeRef> result =
                                        new Pair<NodeRef, NodeRef>(
                                                renditionAssoc1.getChildRef(),
                                                renditionAssoc2.getChildRef());
                                return result;
                            }
                        });
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        assertEquals(
                                "The source node should have title " + titleInitialValue,
                                titleInitialValue,
                                nodeService.getProperty(
                                        nodeWithDocContent, ContentModel.PROP_TITLE));
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        nodeService.setProperty(
                                nodeWithDocContent, ContentModel.PROP_TITLE, updatedTitle);
                        return null;
                    }
                });

        RetryingTransactionCallback<Void> checkRenditionCallback =
                        ...
                        renditionService.render(
                                ...
                                new RenderCallback() {
                                    ...
                                    public void handleSuccessfulRendition(
                                        ...
                                        assertNotNull(
                                                "The rendition association was null",
    ...
    private void assertRenditionContainsTitle(final String titleValue, String output) {
        ...
        int indexOfEndMarker =
                output.indexOf(beforeAfterMarker, indexOfStartMarker + beforeAfterMarker.length());
        final String titleAsTakenFromRendition =
                output.substring(indexOfStartMarker + beforeAfterMarker.length(), indexOfEndMarker);

        assertEquals(
                "The rendition should contain title " + titleValue,
                titleValue,
                titleAsTakenFromRendition);
    }

    /**
     * This test method uses the RenditionService to render a test document (of type PDF) into a
     * different format (of type plain_text) and place the rendition under the source node.
     */
    @Test
                ...
                transactionHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            public NodeRef execute() throws Throwable {
                                ...
                                assertFalse(
                                        "Source node has unexpected renditioned aspect.",
                                        nodeService.hasAspect(
                                                nodeWithDocContent,
                                                RenditionModel.ASPECT_RENDITIONED));
                                // and no renditions
                                assertTrue(
                                        "Renditions should have been empty",
                                        renditionService
                                                .getRenditions(nodeWithDocContent)
                                                .isEmpty());
                                assertNull(
                                        "Renditions should have been null",
                                        renditionService.getRenditionByName(
                                ...
                                RenditionDefinition action =
                                        makeReformatAction(null, MimetypeMap.MIMETYPE_TEXT_PLAIN);

                                // Render the content and put the result underneath
                                // the content node
                                ChildAssociationRef renditionAssoc =
                                        renditionService.render(nodeWithDocContent, action);
                                NodeRef rendition = renditionAssoc.getChildRef();
                                assertEquals(
                                        "The parent node was not correct",
                                        nodeWithDocContent,
                                        renditionAssoc.getParentRef());
                                validateRenditionAssociation(
                                        renditionAssoc, REFORMAT_RENDER_DEFN_NAME);

                                // The rendition node should have no other
                                // parent-associations - in this case
                                assertEquals(
                                        "Wrong value for rendition node parent count.",
                                        1,
                                        nodeService.getParentAssocs(rendition).size());

                                // Now the source content node should have the
                                // renditioned aspect
                                assertTrue(
                                        "Source node is missing renditioned aspect.",
                                        nodeService.hasAspect(
                                                nodeWithDocContent,
                                                RenditionModel.ASPECT_RENDITIONED));
                                // and one rendition
                                ...
                                assertEquals(
                                        "Renditions size wrong",
                                        1,
                                        renditionService.getRenditions(nodeWithDocContent).size());
                                assertNotNull(
                                        "Renditions should not have been null",
                                        renditionService.getRenditionByName(
                                                nodeWithDocContent, REFORMAT_RENDER_DEFN_NAME));
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        assertTrue(
                                "Wrong content in rendition",
                                contentAsString.contains(QUICK_CONTENT));
                        return null;
                    }
                });
    }
    ...
    /**
     * Abstract base implementation of <code>Runnable</code> which sleeps for a short time to allow
     * transformations to start then attempts some modification of the node provided by a concrete
     * implementation and records whether or not the modification thread was blocked.
     *
    ...
    protected abstract class AbstractNodeModifyingRunnable implements Runnable {
        ...
        public void run() {
            ...
            //           We have to give the transaction reties a chance i.e. DO NOT ABSORB
            // EXCEPTIONS inside transaction.
            //           Retrying is standard behaviour so absorbing the exception but still testing
            // for it is guaranteeing failure.
            try {
    ...
    /**
     * Utility method which executes the given <code>nodeModifyingRunnable</code> in a new thread
     * then starts a long-running transformation rendition which blocks modification of the node
     * unless cancelled.
     *
     * @see <a href="https://issues.alfresco.com/jira/browse/MNT-9094">MNT-9094</a>
     ...
     * @throws Exception
     */
    protected void renderPdfDocumentLongRunningTest(
            AbstractNodeModifyingRunnable nodeModifyingRunnable) throws Exception {
        renderPdfDocumentLongRunningTest(nodeModifyingRunnable, false);
    }

    protected void renderPdfDocumentLongRunningTest(
            AbstractNodeModifyingRunnable nodeModifyingRunnable, boolean joinNodeModifyingThread)
            throws Exception {
                    ...
                    transactionHelper.doInTransaction(
                            new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                                public NodeRef execute() throws Throwable {
                                    ...
                                    RenditionDefinition action =
                                            makeReformatAction(null, TEST_LONG_RUNNING_MIME_TYPE);

                                    // Cancellation is only possible with tracking enabled
                                    action.setTrackStatus(true);

                                    // Render the content and put the result underneath the content
                                    // node
                                    ChildAssociationRef renditionAssoc =
                                            renditionService.render(nodeWithDocContent, action);

                                    // Now the source content node should have the renditioned
                                    // aspect
                                    assertTrue(
                                            "Source node is missing renditioned aspect.",
                                            nodeService.hasAspect(
                ...
                protected void modifyNode(NodeRef nodeRef) {
                    ...
                    CheckOutCheckInService checkOutCheckInService =
                            (CheckOutCheckInService)
                                    applicationContext.getBean("checkOutCheckInService");
    ...
    public void testCompositeReformatAndResizeRendition() throws Exception {
        final QName renditionName =
                QName.createQName(NamespaceService.RENDITION_MODEL_1_0_URI, "composite");
        final int newX = 20;
        final int newY = 30;
                        ...
                        new RetryingTransactionHelper. //
                            ...
                            public NodeRef execute() throws Throwable {
                                CompositeRenditionDefinition compositeDefinition =
                                        makeCompositeReformatAndResizeDefinition(
                                                renditionName, newX, newY);
                                ChildAssociationRef renditionAssoc =
                                        renditionService.render(
                                                nodeWithDocContent, compositeDefinition);
                ...
                new RetryingTransactionHelper. //
                    ...
                    public Void execute() throws Throwable {
                        List<ChildAssociationRef> renditions =
                                renditionService.getRenditions(nodeWithDocContent);
                        assertEquals("There should only be one rendition", 1, renditions.size());

                        ChildAssociationRef renditionAssoc = renditions.get(0);
                        assertEquals(
                                "The association name should match the composite rendition name",
                                renditionName,
                                renditionAssoc.getQName());

                        NodeRef rendition = renditionAssoc.getChildRef();
                        ContentReader reader =
                                contentService.getReader(rendition, ContentModel.PROP_CONTENT);
                        assertEquals(
                                "The mimetype is wrong",
    ...
    /**
     * This test method used the RenditionService to render a test document (of type PDF) into a
     * different format (of type plain_text) and place the rendition under the specified folder.
     */
    @Test
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        RenditionDefinition definition =
                                makeReformatAction(
                                        ContentModel.TYPE_CONTENT, MimetypeMap.MIMETYPE_TEXT_PLAIN);
                        Serializable targetFolderName =
                                nodeService.getProperty(testTargetFolder, ContentModel.PROP_NAME);
                        ...
                        List<ChildAssociationRef> parentAssocs =
                                nodeService.getParentAssocs(rendition);
                        assertEquals(
                                "Wrong value for rendition node parent count.",
                                2,
                                parentAssocs.size());
                        ...
                        assertTrue(
                                "Missing containing folder as parent",
                                parents.contains(testTargetFolder));
                        assertTrue(
                                "Missing source node as parent",
                                parents.contains(nodeWithDocContent));
    ...
    /**
     * This test method used the RenditionService to render a test image (of type PNG) as a cropped
    ...
    public void testRenderCropImage() throws Exception {
        ...
        final NodeRef newRenditionNode =
                performImageRendition(parameterValues, nodeWithImageContent);
                    ...
                    public Void execute() throws Throwable {
                        ...
                        List<ChildAssociationRef> children =
                                nodeService.getChildAssocs(
                                        nodeWithImageContent,
                                        new RegexQNamePattern(
                                                getLongNameWithEscapedBraces(
                                                        RenditionModel.ASSOC_RENDITION)),
                                        new RegexQNamePattern(
                                                getLongNameWithEscapedBraces(
                                                        RESCALE_RENDER_DEFN_NAME)));
                        ...
                        ContentReader reader =
                                contentService.getReader(
                                        newImageRendition, ContentModel.PROP_CONTENT);
                        assertNotNull("Reader to rendered image was null", reader);
                        BufferedImage img = ImageIO.read(reader.getContentInputStream());

                        assertEquals(
                                "Rendered image had wrong height", imageNewYSize, img.getHeight());
                        assertEquals(
                                "Rendered image had wrong width", imageNewXSize, img.getWidth());

                        ContentReader srcReader =
                                contentService.getReader(
                                        nodeWithImageContent, ContentModel.PROP_CONTENT);
                        ...
                        assertEquals(
                                "Incorrect image content.", expRgbAtBottomRight, rgbAtBottomRight);
        ...
        final NodeRef secondRenditionNode =
                performImageRendition(parameterValues, nodeWithImageContent);
    ...
    /**
     * This test method used the RenditionService to render a test image (of type PNG) as a rescaled
     * image of the same type.
     */
    @Test
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                "Rendered image had wrong height",
                                imageNewYSize,
                                new Integer(img.getHeight()));
                        assertEquals(
                                "Rendered image had wrong width",
                                imageNewXSize,
                                new Integer(img.getWidth()));

                        // The upper left pixel of the image should be pure black.
                        int rgbAtTopLeft = img.getRGB(1, 1);
                        assertTrue(
                                "Incorrect image content.",
                                Integer.toHexString(rgbAtTopLeft).endsWith(BLACK));

                        // The lower right pixel of the image should be pure white
                        int rgbAtBottomRight = img.getRGB(img.getWidth() - 1, img.getHeight() - 1);
                        assertTrue(
                                "Incorrect image content.",
                                Integer.toHexString(rgbAtBottomRight).endsWith(WHITE));
                ...
                transactionHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            public NodeRef execute() throws Throwable {
                                ...
                                ChildAssociationRef renditionAssoc =
                                        renditionService.render(nodeWithImageContent, action);
                                return renditionAssoc.getChildRef();
                            }
                        });
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ContentReader reader =
                                contentService.getReader(renditionNode, ContentModel.PROP_CONTENT);
                        assertNotNull("Reader to rendered image was null", reader);
                        ...
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            public NodeRef execute() throws Throwable {
                                ...
                                nodeService.addAspect(
                                        nodeWithImageContent,
                                        RenditionModel.ASPECT_PREVENT_RENDITIONS,
                                        null);
    ...
    public void testFailedAsynchronousRendition() throws Exception {
        ...
        assertEquals(
                "Expected a UnimportantTransformException",
                UnimportantTransformException.class,
                results.getThrowable().getClass());
    }

    /**
     * This method performs an asynchronous rendition and calls back the result to the provided
     * callback object. It uses the provided latch to coordinate the JUnit and the asynchronous
     * action thread and uses the provided MutableString to send back any error messages for JUnit
     * reporting.
     *
     * <p>This method blocks until the action service thread either completes its work or times out.
     *
     * @param callback
     * @param latch
     ...
     */
    private void performAsyncRendition(
            final NodeRef nodeToRender,
            final RenderCallback callback,
            CountDownLatch latch,
            final AsyncResultsHolder failureMessage)
            throws InterruptedException {
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
    ...
    /**
     * A simple struct class to allow the return of failure messages, exception objects and
     * ChildAssociationRef results from asynchronous calls.
     */
                ...
                transactionHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            public NodeRef execute() throws Throwable {
                                ...
                                assertTrue(
                                        "Test node should have no renditions initially",
                                        renditionService
                                ...
                                QName rendName1 =
                                        QName.createQName(
                                                NamespaceService.CONTENT_MODEL_1_0_URI,
                                                "definition1" + System.currentTimeMillis());
                                RenditionDefinition action1 =
                                        renditionService.createRenditionDefinition(
                                                rendName1, ReformatRenderingEngine.NAME);
                                ...
                                QName rendName2 =
                                        QName.createQName(
                                                NamespaceService.CONTENT_MODEL_1_0_URI,
                                                "definition2" + System.currentTimeMillis());
                                RenditionDefinition action2 =
                                        renditionService.createRenditionDefinition(
                                                rendName2, ReformatRenderingEngine.NAME);
                                ...
                                QName rendName3 =
                                        QName.createQName(
                                                NamespaceService.CONTENT_MODEL_1_0_URI,
                                                "definition3" + System.currentTimeMillis());
                                RenditionDefinition action3 =
                                        renditionService.createRenditionDefinition(
                                                rendName3, ImageRenderingEngine.NAME);
                                action3.setParameterValue(
                                        ImageRenderingEngine.PARAM_RESIZE_WIDTH, 64);
                                action3.setParameterValue(
                                        ImageRenderingEngine.PARAM_RESIZE_HEIGHT, 64);
                                action3.setParameterValue(
                                        AbstractRenderingEngine.PARAM_MIME_TYPE,
                                ...
                                RenditionDefinition action4 =
                                        renditionService.createRenditionDefinition(
                                                rendName4, ImageRenderingEngine.NAME);
                                action4.setParameterValue(
                                        ImageRenderingEngine.PARAM_RESIZE_WIDTH, 128);
                                action4.setParameterValue(
                                        ImageRenderingEngine.PARAM_RESIZE_HEIGHT, 128);
                                action4.setParameterValue(
                                        AbstractRenderingEngine.PARAM_MIME_TYPE,
                                        MimetypeMap.MIMETYPE_IMAGE_PNG);

                                // Execute the 4 renditions.
                                ChildAssociationRef createdRendition1 =
                                        renditionService.render(nodeWithImageContent, action1);
                                ChildAssociationRef createdRendition2 =
                                        renditionService.render(nodeWithImageContent, action2);
                                ChildAssociationRef createdRendition3 =
                                        renditionService.render(nodeWithImageContent, action3);
                                ChildAssociationRef createdRendition4 =
                                        renditionService.render(nodeWithImageContent, action4);

                                // Now validate the getRenditions methods
                                List<ChildAssociationRef> allRenditions =
                                        renditionService.getRenditions(nodeWithImageContent);
                                ChildAssociationRef retrievedRendition1 =
                                        renditionService.getRenditionByName(
                                                nodeWithImageContent, rendName1);
                                ChildAssociationRef retrievedRendition2 =
                                        renditionService.getRenditionByName(
                                                nodeWithImageContent, rendName2);
                                ChildAssociationRef retrievedRendition3 =
                                        renditionService.getRenditionByName(
                                                nodeWithImageContent, rendName3);
                                ChildAssociationRef retrievedRendition4 =
                                        renditionService.getRenditionByName(
                                ...
                                List<ChildAssociationRef> imageRenditions =
                                        renditionService.getRenditions(
                                                nodeWithImageContent, "image");
                                assertEquals(3, imageRenditions.size());

                                List<ChildAssociationRef> imageSlashJRenditions =
                                        renditionService.getRenditions(
    ...
    protected NodeRef performImageRendition(
            final Map<String, Serializable> parameterValues, final NodeRef imageToRender) {
        final NodeRef newRenditionNode =
                transactionHelper.doInTransaction(
                        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
                            public NodeRef execute() throws Throwable {
                                ...
                                ChildAssociationRef renditionAssoc =
                                        renditionService.render(imageToRender, action);

                                validateRenditionAssociation(
                                        renditionAssoc, RESCALE_RENDER_DEFN_NAME);
    ...
    public void testSaveRenderingAction() throws Exception {
        final List<RenditionDefinition> savedRenditionsToDelete =
        ...
        try {
            ...
            transactionHelper.doInTransaction(
                    new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                        public Void execute() throws Throwable {
                            assertTrue(
                                    "The rendering action space has not been created in the"
                                            + " repository!", //
                                    nodeService.exists(
                            ...
                            List<ChildAssociationRef> childAssocs =
                                    nodeService.getChildAssocs( //
                                            ...
                                            REFORMAT_RENDER_DEFN_NAME);
                            assertTrue(
                                    "There should be no persisted rendering actions of name: "
                                            + REFORMAT_RENDER_DEFN_NAME
                            ...
                            List<ChildAssociationRef> results =
                                    nodeService.getChildAssocs( //
                                            ...
                                            REFORMAT_RENDER_DEFN_NAME);
                            assertEquals(
                                    "There should be one persisted rendering action of name: "
                                            + REFORMAT_RENDER_DEFN_NAME, //
                                    1,
                                    results.size());
                            return null;
                    ...
                    new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                        public Void execute() throws Throwable {
                            ...
                            assertEquals(
                                    ...
                                    results.size());
                            assertEquals(
                                    "The node in which the action is stored should be the same.", //
                                    actionNode,
    ...
    /**
     * This is not a real test method. It is used to create the ACP file that we have added to the
     * RenditionService for importing at startup. This method should remain here as it will be
     * needed if we need to change the contents of the ACP.
     *
     * @throws Exception
     * @deprecated
     */
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        for (ChildAssociationRef chRef :
                                nodeService.getChildAssocs(
                                        RenditionDefinitionPersisterImpl
                                                .RENDERING_ACTION_ROOT_NODE_REF)) {
                            System.out.println(
                                    "Deleting rendition Definition "
                                            + nodeService.getProperty(
                                                    chRef.getChildRef(), ContentModel.PROP_NAME));
                        ...
                        RenditionDefinition action =
                                createAction(ImageRenderingEngine.NAME, "medium", parameterValues);
                        renditionService.saveRenditionDefinition(action);
                        ...
                        action =
                                createAction(
                                        ImageRenderingEngine.NAME, "imgpreview", parameterValues);
                        renditionService.saveRenditionDefinition(action);
                    ...
                    private RenditionDefinition createAction(
                            String renderingEngineName,
                            String renditionLocalName,
                            Map<String, Serializable> parameterValues) {
                        QName renditionName =
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, renditionLocalName);
                        RenditionDefinition action =
                                renditionService.createRenditionDefinition(
                                        renditionName, renderingEngineName);
        ...
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        exportAction.setParameterValue(
                                ExporterActionExecuter.PARAM_STORE,
                                StoreRef.STORE_REF_WORKSPACE_SPACESSTORE.toString());
                        exportAction.setParameterValue(
                                ExporterActionExecuter.PARAM_PACKAGE_NAME,
                                "systemRenditionDefinitions");
                        exportAction.setParameterValue(
                                ExporterActionExecuter.PARAM_ENCODING, "UTF-8");
                        exportAction.setParameterValue(
                                ExporterActionExecuter.PARAM_DESTINATION_FOLDER,
                                RenditionDefinitionPersisterImpl.RENDERING_ACTION_ROOT_NODE_REF);
                        exportAction.setParameterValue(
                                ExporterActionExecuter.PARAM_INCLUDE_SELF, true);
                        exportAction.setParameterValue(
                                ExporterActionExecuter.PARAM_INCLUDE_CHILDREN, true);
                        ...
                        for (ChildAssociationRef car : children) {
                            System.err.println(
                                    car.getChildRef()
                                            + "  "
                                            + nodeService.getProperty(
                                                    car.getChildRef(), ContentModel.PROP_NAME));
                        }
    ...
    /**
     * This test method saves one RenderingAction to the repository and loads it back up asserting
     * that it is equivalent to the original. It then saves some further RenderingActions, loads
     * them back with a RenderingEngine filter and asserts that the results are correct.
     *
     * @throws Exception
     */
    @Test
    public void testLoadRenderingAction() throws Exception {
        final RenditionDefinition reformatAction =
                makeReformatAction(null, MimetypeMap.MIMETYPE_TEXT_PLAIN);
        final RenditionDefinition rescaleAction = makeRescaleImageAction();

        final List<RenditionDefinition> savedRenditionDefinitions =
                new ArrayList<RenditionDefinition>();
        try {
            ...
            transactionHelper.doInTransaction(
                    new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                        public Void execute() throws Throwable {
                            ...
                            RenditionDefinition result =
                                    renditionService.loadRenditionDefinition(renditionName);
                            assertEquals(renditionName, result.getRenditionName());
                            assertEquals(
                                    reformatAction.getActionDefinitionName(),
                                    result.getActionDefinitionName());
                            assertEquals(
                                    reformatAction.getCompensatingAction(),
                                    result.getCompensatingAction());
                            assertEquals(reformatAction.getDescription(), result.getDescription());
                            assertEquals(
                                    reformatAction.getExecuteAsychronously(),
                                    result.getExecuteAsychronously());
                            assertEquals(
                                    reformatAction.getModifiedDate(), result.getModifiedDate());
            ...
            transactionHelper.doInTransaction(
                    new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                        public Void execute() throws Throwable {
                            ...
                            RenditionDefinition firstLoadedAction =
                                    renditionService.loadRenditionDefinition(
                                            reformatAction.getRenditionName());
                            RenditionDefinition secondLoadedAction =
                                    renditionService.loadRenditionDefinition(
                                            rescaleAction.getRenditionName());
                            ...
                            assertEquals(
                                    reformatAction.getRenditionName(),
                                    firstLoadedAction.getRenditionName());
                            assertEquals(
                                    rescaleAction.getRenditionName(),
                                    secondLoadedAction.getRenditionName());
    ...
    public void testSaveAndLoadCompositeRenditionDefinition() throws Exception {
        final QName renditionName =
                QName.createQName(NamespaceService.RENDITION_MODEL_1_0_URI, "composite");
        final CompositeRenditionDefinition compositeDefinition =
                makeCompositeReformatAndResizeDefinition(renditionName, 20, 30);
        final List<RenditionDefinition> savedRenditionDefinitions =
                new ArrayList<RenditionDefinition>();
            ...
            transactionHelper.doInTransaction(
                    new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                        public Void execute() throws Throwable {
                            ...
                            assertEquals(renditionName, result.getRenditionName());
                            assertEquals(
                                    compositeDefinition.getActionDefinitionName(),
                                    result.getActionDefinitionName());
                            assertEquals(
                                    compositeDefinition.getCompensatingAction(),
                                    result.getCompensatingAction());
                            assertEquals(
                                    compositeDefinition.getDescription(), result.getDescription());
                            assertEquals(
                                    compositeDefinition.getExecuteAsychronously(),
                                    result.getExecuteAsychronously());
                            assertEquals(
                                    compositeDefinition.getModifiedDate(),
                            ...
                            if (result instanceof CompositeRenditionDefinition) {
                                CompositeRenditionDefinition compositeResult =
                                        (CompositeRenditionDefinition) result;
                                savedRenditionDefinitions.add(compositeResult);

                                List<RenditionDefinition> subDefinitions =
                                        compositeResult.getActions();
                                ...
                                assertEquals(
                                        ...
                                        firstDef.getActionDefinitionName());

                                // Check the second sub-definition is correct.
                                RenditionDefinition secondDef = subDefinitions.get(1);
                                assertEquals(
                                        ImageRenderingEngine.NAME,
                                        secondDef.getActionDefinitionName());
                            } else
                                fail(
                                        "The retrieved rendition should be a"
    ...
    private void cleanUpPersistedActions(
            final List<RenditionDefinition> savedRenditionDefinitions) {
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        for (RenditionDefinition savedRenditionDefinition :
                                savedRenditionDefinitions) {
    ...
    /**
     * This test method ensures that all the 'built-in' renditionDefinitions are available after
     * startup and that their configuration is correct.
     *
     * @throws Exception
     */
    @Test
    public void testBuiltinRenditionDefinitions() throws Exception {
        ...
        final RenditionDefinition imgpreviewRenditionDef =
                loadAndValidateRenditionDefinition("imgpreview");
        final RenditionDefinition webpreviewRenditionDef =
                loadAndValidateRenditionDefinition("webpreview");
        final RenditionDefinition avatarRenditionDef = loadAndValidateRenditionDefinition("avatar");

        assertEquals(
                MimetypeMap.MIMETYPE_IMAGE_JPEG,
                mediumRenditionDef.getParameterValue(AbstractRenderingEngine.PARAM_MIME_TYPE));
        assertEquals(
                MimetypeMap.MIMETYPE_IMAGE_PNG,
                doclibRenditionDef.getParameterValue(AbstractRenderingEngine.PARAM_MIME_TYPE));
        assertEquals(
                MimetypeMap.MIMETYPE_IMAGE_JPEG,
                imgpreviewRenditionDef.getParameterValue(AbstractRenderingEngine.PARAM_MIME_TYPE));
        assertEquals(
                MimetypeMap.MIMETYPE_FLASH,
                webpreviewRenditionDef.getParameterValue(AbstractRenderingEngine.PARAM_MIME_TYPE));
        assertEquals(
                MimetypeMap.MIMETYPE_IMAGE_PNG,
                avatarRenditionDef.getParameterValue(AbstractRenderingEngine.PARAM_MIME_TYPE));
    }

    /**
     * This test checks that for a node with an existing rendition, that if you update its content
     * with content that cannot be renditioned (thumbnailed), that existing rendition nodes for
     * failed re-renditions are removed. See ALF-6730.
     *
     * @since 3.4.2
     */
    @Test
    public void testRenderValidContentThenUpdateToInvalidContent() throws Exception {
        transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        // Need to use one of the standard, persisted rendition definitions, as
                        // non-persisted rendition definitions
                        // do not get automatcially updated.
                        RenditionDefinition doclib = loadAndValidateRenditionDefinition("doclib");

                        // We want the rendition to be asynchronous, but we don't care about
                        // called-back data.
                        RenderCallback dummyCallback =
                                new RenderCallback() {
                                    @Override
                                    public void handleFailedRendition(Throwable t) {}
                    ...
                    public Void execute() throws Throwable {
                        ContentWriter writer =
                                contentService.getWriter(
                                        nodeWithDocContent, ContentModel.PROP_CONTENT, true);
                        writer.setMimetype(MimetypeMap.MIMETYPE_PDF);
                        writer.setEncoding("UTF-8");

                        InputStream corruptIn =
                                applicationContext
                                        .getResource("classpath:/quick/quickCorrupt.pdf")
                                        .getInputStream();
    ...
    public void testALF3733() throws Exception {
        // ALF-3733 was caused by ${cwd} evaluating to the empty string and a path
        // "//sourceNodeName"
        // being passed to the FileFolderService for creation. This then splits the string using '/'
        // as
        // a delimiter which leads to the attempted creation of nodes with the empty string as a
        // name,
        // which is illegal.
        QName renditionDefName =
                QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "myDummyRendition");
        String renderingEngineName = "imageRenderingEngine";

        RenditionDefinition renditionDef =
                renditionService.createRenditionDefinition(renditionDefName, renderingEngineName);
        ...
        params.put(
                ...
                "${cwd}/resized/${name}_Thumb.${extension}");
        renditionDef.addParameterValues(params);

        ChildAssociationRef rendition =
                renditionService.render(this.nodeWithImageContent, renditionDef);

        assertNotNull("rendition was null.", rendition);
        assertTrue(
                nodeService.hasAspect(
                        rendition.getChildRef(), RenditionModel.ASPECT_VISIBLE_RENDITION));
        ...
        NodeRef primaryParent =
                nodeService.getPrimaryParent(rendition.getChildRef()).getParentRef();
    ...
    /**
     * If we're using path based renditions, it's allowed for two source nodes to end up rendering
     * into folder with the same name as each other. One case is /images/world/logo.png ->
     * /smaller/logo.png /images/europe/logo.png -> /smaller/logo.png Clearly this isn't a great
     * situation to be in, since the two source nodes are fighting over the rendered node! However,
     * people will sometimes end up doing this, so we need to ensure that the last rendered version
     * wins, and the previous rendered version is fully gone. We mustn't end up with both source
     * nodes thinking they have the same rendition node, because it'd only be one of theirs!
     */
    @Test
    public void testPathBasedRenditionOverwrite() throws Exception {}

    /**
     * Using a dummy rendition engine, perform a number of renditions, both single and composite, to
     * check that the renditions always end up as they should do.
     */
    @Test
    public void testRenditionPlacements() throws Exception {
        QName plainQName = QName.createQName("Plain");
        RenditionDefinition rdPlain =
                renditionService.createRenditionDefinition(
                        plainQName, DummyHelloWorldRenditionEngine.ENGINE_NAME);

        QName compositeQName = QName.createQName("Composite");
        CompositeRenditionDefinition rdComposite =
                renditionService.createCompositeRenditionDefinition(compositeQName);
        rdComposite.addAction(
                renditionService.createRenditionDefinition(
                        QName.createQName("CompositePart1"),
                        DummyHelloWorldRenditionEngine.ENGINE_NAME));
        rdComposite.addAction(
                renditionService.createRenditionDefinition(
                        QName.createQName("CompositePart2"),
                        DummyHelloWorldRenditionEngine.ENGINE_NAME));
        ...
        ChildAssociationRef renditionAssoc =
                renditionService.getRenditionByName(nodeWithDocContent, plainQName);
        ...
        assertNotNull(renditionAssoc);
        assertEquals(
                compositeQName, nodeService.getChildAssocs(nodeWithDocContent).get(0).getQName());
        ...
        String path =
                "/"
                        + (String)
                                nodeService.getProperty(
                                        repositoryHelper.getCompanyHome(), ContentModel.PROP_NAME)
                        + "/"
        ...
        assertNotNull(nodeWithDocContent);
        assertEquals(0, renditionService.getRenditions(nodeWithDocContent).size());
        // FIXME There is a bug in the NodeService whereby associations to children in the archive
        // store
        //       i.e. deleted children, are included in the results to the getChildAssocs call.
        //       Therefore, pending a fix to that, we need to suppress this check and similar checks
        // below.
        // assertEquals(0, nodeService.getChildAssocs(nodeWithDocContent).size());
        ...
        // Currently, there is only one scenario in which it is legal for a rendition to overwrite
        // an existing
        // node. That is when the rendition is an update of the source node i.e. the rendition node
        // is already
        // linked to its source node by a rn:rendition association of the same name as the new
        // rendition.
        try {
            renditionService.render(nodeWithDocContent, rdPlain);
    ...
    private RenditionDefinition loadAndValidateRenditionDefinition(String renditionLocalName) {
        QName renditionQName =
                QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, renditionLocalName);
        RenditionDefinition renditionDefinition =
                renditionService.loadRenditionDefinition(renditionQName);
        assertNotNull(
                "'" + renditionLocalName + "' rendition definition was missing.",
                renditionDefinition);
        assertEquals(
                "'" + renditionLocalName + "' renditionDefinition had wrong renditionName",
                renditionQName,
    ...
    /**
     * Creates a RenderingAction (RenditionDefinition) for the ReformatActionExecutor, setting the
     * mimetype parameter value to plain text.
     *
     * @param renditionObjectType requested node type of the rendition object
     * @param targetMimetype
     * @return A new RenderingAction.
     */
    private RenditionDefinition makeReformatAction(
            QName renditionObjectType, String targetMimetype) {
        // Create the rendering action.
        RenditionDefinition action =
                renditionService.createRenditionDefinition(
                        REFORMAT_RENDER_DEFN_NAME, ReformatRenderingEngine.NAME);
        action.setParameterValue(AbstractRenderingEngine.PARAM_MIME_TYPE, targetMimetype);
        if (renditionObjectType != null) {
            action.setParameterValue(
                    RenditionService.PARAM_RENDITION_NODETYPE, renditionObjectType);
        }
        return action;
    }

    /**
     * Creates a RenderingAction (RenditionDefinition) for the RescaleImageActionExecutor.
     *
     * @return A new RenderingAction.
     */
    ...
    private void validateRenderingActionDefinition(final String renderingEngineName) {
        ...
        RenderingEngineDefinition renderingActionDefn =
                renditionService.getRenderingEngineDefinition(renderingEngineName);
        assertNotNull("renderingActionDefn was null", renderingActionDefn);
        assertEquals(
                "Incorrect renderingActionDefn name",
                renderingEngineName,
                renderingActionDefn.getName());
    }

    private void validateRenditionAssociation(
            ChildAssociationRef chAssRef, QName renderingActionQName) {
        assertEquals(
                "The assoc type name was wrong",
                RenditionModel.ASSOC_RENDITION,
                chAssRef.getTypeQName());
        assertEquals("The assoc name was wrong", renderingActionQName, chAssRef.getQName());

        assertTrue(
                "The source node should have the rn:renditioned aspect applied",
                nodeService.hasAspect(chAssRef.getParentRef(), RenditionModel.ASPECT_RENDITIONED));

        final NodeRef newRenditionNodeRef = chAssRef.getChildRef();
        assertTrue(
                "The new rendition node was not a rendition.",
                renditionService.isRendition(newRenditionNodeRef));

        // If the source node for the rendition equals the primary parent
        NodeRef renditionSource =
                renditionService.getSourceNode(newRenditionNodeRef).getParentRef();
        NodeRef renditionPrimaryParent =
                nodeService.getPrimaryParent(newRenditionNodeRef).getParentRef();
        if (renditionSource.equals(renditionPrimaryParent)) {
            assertTrue(
                    "Rendition node was missing the hiddenRendition aspect",
                    nodeService.hasAspect(
                            newRenditionNodeRef, RenditionModel.ASPECT_HIDDEN_RENDITION));
        } else {
            assertTrue(
                    "Rendition node was missing the visibleRendition aspect",
                    nodeService.hasAspect(
        ...
        assertEquals(
                ContentModel.PROP_CONTENT,
                nodeService.getProperty(
                        newRenditionNodeRef, ContentModel.PROP_CONTENT_PROPERTY_NAME));
    }

    /** Given a QName this method returns the long-form String with the braces escaped. */
    ...
    private CompositeRenditionDefinition makeCompositeReformatAndResizeDefinition(
            final QName renditionName, final int newX, final int newY) {
        CompositeRenditionDefinition compositeDefinition =
                renditionService.createCompositeRenditionDefinition(renditionName);
        RenditionDefinition reformatDefinition =
                makeReformatAction(null, MimetypeMap.MIMETYPE_IMAGE_JPEG);
    ...
    public void testJavascriptAPI() throws Exception {
        ...
        ScriptLocation location =
                new ClasspathScriptLocation(
                        "org/alfresco/repo/rendition/script/test_renditionService.js");
        this.scriptService.executeScript(location, model);
    }

    /**
     * This test method takes an image with Exif Orientation information and checks if it is
     * automatially rotated.
     */
    @Test
    public void testAutoRotateImage() throws Exception {
        ...
        final NodeRef newNodeForRotate =
                createNode(companyHome, "rotateImageNode", ContentModel.TYPE_CONTENT);
    ...
    private void resizeImageAndCheckOrientation(
            final NodeRef nodeToResize,
            final Map<String, Serializable> parameterValues,
    ...
    private static void checkTopLeftBottomRight(
            BufferedImage img, String topLeft, String bottomRight, String srcImage) {
        String rgbAtTopLeft = Integer.toHexString(img.getRGB(1, 1));
        assertTrue(
                "upper left " + rgbAtTopLeft + " should end with " + topLeft + " " + srcImage,
                rgbAtTopLeft.endsWith(topLeft));
        String rgbAtBottomRight =
                Integer.toHexString(img.getRGB(img.getWidth() - 1, img.getHeight() - 1));
        assertTrue(
                "lower right "
                        + rgbAtBottomRight
                        + " should end with "
                        ...
                        + " "
                        + srcImage,
                rgbAtBottomRight.endsWith(bottomRight));
    }
        ...
        public static void registerIfNeeded(ApplicationContext ctx) {
            if (!ctx.containsBean(ENGINE_NAME)) {
                ...
                ((ConfigurableApplicationContext) ctx)
                        .getBeanFactory()
                        .registerSingleton(ENGINE_NAME, hw);
                hw.init();
            }
        }
