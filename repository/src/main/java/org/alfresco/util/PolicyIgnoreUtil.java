...
/**
 * Utility class which checks whether a node is in a store on which policies should not be
 * applied(e.g. archive://SpacesStore)
 *
 * @author cpopa
 */
public class PolicyIgnoreUtil {
     ...
     *
     * @param nodeRef node to check if the policy can be run or not
     * @return true if the nodeRef is part of a store which should be ignored when invoking
     *     policies(e.g. archive://SpacesStore)
     */
