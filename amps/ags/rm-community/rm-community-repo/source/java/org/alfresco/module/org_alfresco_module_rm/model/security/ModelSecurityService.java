...
public interface ModelSecurityService {
    ...
    /**
     * Indicates whether the current user can edit a protected property in the context of a given
     * node.
     *
     * <p>If the property is not protected then returns true.
     *
     * @param nodeRef node reference
     * @param property name of the property
     * @return boolean true if the current user can edit the protected property or the property is
     *     not protected, false otherwise
     */
    ...
    /**
     * Indicates whether the current user can edit (ie add or remove) a protected aspect in the
     * context of a given node.
     *
     * <p>If the aspect is not protected then returns true.
     *
     * @param nodeRef node reference
     * @param aspect name of the of aspect
     * @return boolean true if the current user can edit the protected aspect or the the aspect is
     *     not protected, false otherwise
     */
