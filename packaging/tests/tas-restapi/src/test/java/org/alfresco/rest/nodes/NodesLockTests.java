...
public class NodesLockTests extends RestTest {
  ...
  public void lockEphemeralAndRelockPersistentDifferentUser() throws Exception {
    ...
    STEP(
      "3. Lock the file using mode EPHEMERAL for 20 seconds with user1 (POST nodes/{nodeId}/lock)."
    );
    ...
    file1Model2
      ...
      .assertThat()
      .field("properties")
      .contains("lockLifetime=EPHEMERAL")
      .assertThat()
      .field("properties")
      .contains("lockType=READ_ONLY_LOCK");

    STEP(
      "5. Cannot lock the file using mode PERSISTENT with user2 while the file is still locked"
    );
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          RestErrorModel.LOCKED_NODE_SUMMARY,
  ...
  public void lockEphemeralAndRelockEphemeralDifferentUser() throws Exception {
    ...
    STEP(
      "5. Cannot lock the file using mode EPHEMERAL with user2 while the file is still locked"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
  ...
  public void lockEphemeralAndRelockEphemeralSameUser() throws Exception {
    ...
    STEP(
      "5. Lock the file using mode EPHEMERAL with user1 while the file is still locked"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("EPHEMERAL");
    lockBodyModel2.setTimeToExpire(20);
  ...
  @Bug(
    id = "MNT-17612",
    status = Status.FIXED,
    description = "AccessDeniedException in AOS Edit Offline Upload New Version"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.NODES, TestGroup.REGRESSION })
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.NODES },
  ...
  public void lockEphemeralAndRelockPersistentSameUser() throws Exception {
    ...
    STEP(
      "5. Lock the file using mode PERSISTENT with user1 while the file is still locked"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("PERSISTENT");
    lockBodyModel2.setTimeToExpire(20);
    ...
    STEP(
      "6. Verify that the file is locked PERSISTENT only after EPHEMERAL lock has expired"
    );
    Utility.sleep(
      500,
      5000,
      () -> {
        RestNodeModel file1Model4 = restClient
          .authenticateUser(user1)
          .withCoreAPI()
          .usingNode(file1)
          .usingParams("include=isLocked")
        ...
        file1Model4
          ...
          .assertThat()
          .field("properties")
          .contains("lockLifetime=PERSISTENT")
          .assertThat()
          .field("properties")
  ...
  public void lockPersistentAndRelockPersistentDifferentUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
  ...
  public void lockPersistentAndRelockEphemeralAfterExpiredLockDifferentUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
    ...
    STEP(
      "5. Lock the file using mode EPHEMERAL with user2 while the first lock has expired"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("EPHEMERAL");
    lockBodyModel2.setTimeToExpire(20);
  ...
  public void lockEphemeralAndRelockPersistentAfterExpiredLockDifferentUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
    ...
    STEP(
      "5. Lock the file using mode PERSISTENT with user2 after the first lock has expired"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("PERSISTENT");
    lockBodyModel2.setTimeToExpire(20);
  ...
  public void lockEphemeralAndRelockEphemeralAfterExpiredLockDifferentUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
  ...
  public void lockPersistentAndRelockPersistentAfterExpiredLockDifferentUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
  ...
  public void lockEphemeralAndRelockEphemeralAfterExpiredLockSameUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
    ...
    STEP(
      "5. Lock the file using mode EPHEMERAL with user1 after the first lock has expired"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("EPHEMERAL");
    lockBodyModel2.setTimeToExpire(20);
  ...
  public void lockPersistentAndRelockPersistentAfterExpiredLockSameUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
    ...
    STEP(
      "5. Lock the file using mode PERSISTENT with user1 while the first lock has expired"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("PERSISTENT");
    lockBodyModel2.setTimeToExpire(20);
  ...
  public void lockPersistentAndRelockEphemeralAfterExpiredLockSameUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
    ...
    STEP(
      "5. Lock the file using mode EPHEMERAL with user1 while the first lock has expired"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("EPHEMERAL");
    lockBodyModel2.setTimeToExpire(20);
  ...
  public void lockEphemeralAndRelockPersistentAfterExpiredLockSameUser()
    throws Exception {
    STEP("1. Adds a file in the site by administrator.");
    file1 =
      dataContent
  ...
  public void lockPersistentAndRelockEphemeralSameUser() throws Exception {
    ...
    STEP(
      "5. Lock the file using mode EPHERMERAL with user1 while the file is still locked"
    );
    RestNodeLockBodyModel lockBodyModel2 = new RestNodeLockBodyModel();
    lockBodyModel2.setLifetime("EPHEMERAL");
    lockBodyModel2.setTimeToExpire(20);
  ...
  public void testLockUnlockParentChild() throws Exception {
    ...
    FolderModel parentNode = dataContent
      .usingUser(adminUser)
      .usingSite(siteLock)
      .createFolder();
    FileModel childNode1 = dataContent
      .usingUser(adminUser)
      .usingSite(siteLock)
      .usingResource(parentNode)
      .createContent(DocumentType.TEXT_PLAIN);
    FileModel childNode2 = dataContent
      .usingUser(adminUser)
      .usingSite(siteLock)
      .usingResource(parentNode)
      .createContent(DocumentType.TEXT_PLAIN);
    ...
    STEP("2. Verify with admin that the file is not locked.");
    RestNodeModel restNodeResponse = restClient
      .authenticateUser(adminUser)
      .withCoreAPI()
      .usingNode(parentNode)
      .usingParams("include=isLocked")
      .getNode();
    ...
    restNodeResponse =
      restClient
        .withCoreAPI()
        .usingNode(childNode2)
        .usingParams("include=isLocked")
        .getNode();
    restNodeResponse.assertThat().field("isLocked").is(false);

    STEP(
      "3. Lock  childNode1 using mode PERSISTENT with adminUser (POST nodes/{nodeId}/lock)."
    );
    RestNodeLockBodyModel lockBodyModel = new RestNodeLockBodyModel();
    lockBodyModel.setLifetime("PERSISTENT");
    ...
    STEP(
      "4. Lock childNode2 using mode PERSISTENT with adminUser (POST nodes/{nodeId}/lock)."
    );
    ...
    Utility.sleep(
      ...
      () -> {
        ...
        response
          .assertThat()
          .entriesListContains("id", childNode1.getNodeRefWithoutVersion());
        response
          .assertThat()
          .entriesListContains("id", childNode2.getNodeRefWithoutVersion());
      }
    );
    ...
    STEP(
      "7. Verify that childNode1 and childNode2 are not found in the query results."
    );
    // Allow indexing to complete.
    Utility.sleep(
      500,
      ...
      () -> {
        ...
        response
          ...
          .entriesListDoesNotContain(
            "id",
            childNode1.getNodeRefWithoutVersion()
          );
        response
          .assertThat()
          .entriesListDoesNotContain(
            "id",
            childNode2.getNodeRefWithoutVersion()
          );
      }
    );
  }
