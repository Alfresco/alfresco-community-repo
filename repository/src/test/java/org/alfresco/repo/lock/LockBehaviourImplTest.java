...
public class LockBehaviourImplTest extends BaseSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.nodeService.addAspect(
                this.nodeRef, ContentModel.ASPECT_LOCKABLE, new HashMap<QName, Serializable>());
        ...
        TestWithUserUtils.authenticateUser(
                BAD_USER_WITH_ALL_PERMS_NAME, PWD, rootNodeRef, this.authenticationService);
        ...
        permissionService.setPermission(
                rootNodeRef, BAD_USER_WITH_ALL_PERMS_NAME, PermissionService.ALL_PERMISSIONS, true);

        permissionService.setPermission(
                inSpaceStoreNode, GOOD_USER_NAME, PermissionService.ALL_PERMISSIONS, true);
        permissionService.setPermission(
                inSpaceStoreNode,
                BAD_USER_WITH_ALL_PERMS_NAME,
    ...
    public void testVersionServiceLockBehaviour02() {
        ...
        try {
            ...
            this.versionService.createVersion(this.nodeRef, new HashMap<String, Serializable>());
            fail(
                    "Should have failed since this node has been locked by another user with a"
                            + " write lock.");
    ...
    public void testNodeServiceLockBehaviour() {
        ...
        this.lockService.lock(this.nodeRef, LockType.WRITE_LOCK);
        ChildAssociationRef childAssocRef2 =
                this.nodeService.createNode(
                        this.nodeRef,
                        ContentModel.ASSOC_CONTAINS,
                        QName.createQName("{test}nodeServiceLockTest"),
    ...
    public void testCanMoveCopyDeleteWithLockOwner() {
        ...
        NodeRef archivingBehaviorNodeRef =
                nodeService
                        .createNode(
                                this.inSpaceStoreNode,
                                ContentModel.ASSOC_CONTAINS,
    ...
    private void checkForLockForBadAndGoodUsers(NodeRef nodeToCheck) {
        ...
        TestWithUserUtils.authenticateUser(
                currentUserName, PWD, rootNodeRef, this.authenticationService);
    }
}
