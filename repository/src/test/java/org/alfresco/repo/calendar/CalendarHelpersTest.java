...
public class CalendarHelpersTest {
  ...
  private static SimpleDateFormat fullDayFmt = new SimpleDateFormat(
    "EEEE",
    Locale.ENGLISH
  );
  ...
  public void monthlyRecurrenceByFirstDayOfEveryFirstMonth() {
    ...
    Map<String, String> paramsFixed = RecurrenceHelper.fixOutlookRecurrenceQuirks(
      params
    );
  ...
  public void simpleTimeZoneNoDST() {
    ...
    assertEquals(
      10 * 60 * 60 * 1000,
      tz.getOffset(date(2011, 11, 1).getTime())
    );
  }
  ...
  public void simpleTimeZoneNorthern() {
    ...
    assertEquals(
      1 * 60 * 60 * 1000,
      tz.getOffset(date(2003, 10, 25).getTime())
    );
    ...
    assertEquals(
      1 * 60 * 60 * 1000,
      tz.getOffset(date(2007, 10, 27).getTime())
    );
    assertEquals(
      0 * 60 * 60 * 1000,
      tz.getOffset(date(2007, 10, 29).getTime())
    );
    ...
    assertEquals(
      1 * 60 * 60 * 1000,
      tz.getOffset(date(2011, 10, 25).getTime())
    );
  ...
  public void simpleTimeZoneSouthern() {
    ...
    assertEquals(
      10 * 60 * 60 * 1000,
      tz.getOffset(date(2008, 10, 1).getTime())
    );
    assertEquals(
      11 * 60 * 60 * 1000,
      tz.getOffset(date(2008, 10, 6).getTime())
    );
    assertEquals(
      11 * 60 * 60 * 1000,
      tz.getOffset(date(2008, 12, 1).getTime())
    );
    ...
    assertEquals(
      10 * 60 * 60 * 1000,
      tz.getOffset(date(2009, 10, 1).getTime())
    );
    assertEquals(
      11 * 60 * 60 * 1000,
      tz.getOffset(date(2009, 10, 6).getTime())
    );
    assertEquals(
      11 * 60 * 60 * 1000,
      tz.getOffset(date(2009, 12, 1).getTime())
    );
    ...
    assertEquals(
      10 * 60 * 60 * 1000,
      tz.getOffset(date(2010, 10, 1).getTime())
    );
    assertEquals(
      11 * 60 * 60 * 1000,
      tz.getOffset(date(2010, 10, 6).getTime())
    );
    assertEquals(
      11 * 60 * 60 * 1000,
      tz.getOffset(date(2010, 12, 1).getTime())
    );
