 ...
 *
 * <p>The KIND is one of : QUERY_STRING - A query string parameter as part of the URL
 * HTTP_BODY_OBJECT - A JSON object specified in a HTTP_BODY used by either a POST or PUT URL_PATH -
 * Included as part of the actual url, e.g. entity id. (Does not support multiple values)
...
public class ResourceParameter {
    ...
    public static final ResourceParameter ENTITY_PARAM =
            new ResourceParameter(
                    ...
                    "The unique id must be a String. It is returned as an 'id' from the entity",
                    true,
                    String.class,
                    KIND.URL_PATH,
                    false);
    ...
    public static final ResourceParameter RELATIONSHIP_PARAM =
            new ResourceParameter(
                    ...
                    "The unique id must be a String. It is only valid in the scope of the"
                            + " relationship",
                    true,
                    String.class,
                    KIND.URL_PATH,
    ...
    public static final ResourceParameter PROPS_PARAM =
            new ResourceParameter(
                    ...
                    "The properties parameter is a comma-separated list of property names. You can"
                            + " use the properties parameter to restrict the returned properties.",
                    false,
                    Integer.class,
                    KIND.QUERY_STRING,
                    false);
    public static final ResourceParameter RELATIONS_PARAM =
            new ResourceParameter(
                    "relations",
                    "Use the relations parameter to include one or more child entities in a single"
                            + " response. ",
                    "You can reduce network traffic by using the relations parameter to include one"
                            + " or more child entities in a single response.",
                    false,
                    Integer.class,
                    KIND.QUERY_STRING,
                    false);
    ...
    private ResourceParameter(
        ...
        this.kind = kind;
        if (KIND.URL_PATH.equals(kind))
            allowMultiple = false; // URL paths can never have multiple values
     ...
     */
    protected static ResourceParameter valueOf(
            String name,
            String title,
            String description,
            boolean required,
        ...
        return new ResourceParameter(
                name, title, description, required, dataType, kind, allowMultiple);
    }
