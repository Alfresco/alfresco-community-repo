...
public class DeleteRatingTests extends RestTest {
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
  ...
  public void managerIsAbleToDeleteItsOwnRatings() throws Exception {
    FolderModel folderModel = dataContent
      .usingUser(adminUser)
      .usingSite(siteModel)
      .createFolder();
  ...
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  public void unauthenticatedUserIsNotAbleToDeleteRatings() throws Exception {
    ...
    restClient.authenticateUser(
      new UserModel("random user", "random password")
    );
  ...
  public void deleteInvalidRating() throws Exception {
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(document)
      .deleteInvalidRating("random_rating");
    restClient
      .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_RATING, "random_rating")
      )
      .containsErrorKey(
        String.format(RestErrorModel.INVALID_RATING, "random_rating")
      )
  ...
  public void deleteRatingUsingInvalidDocument() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "random_value")
      );
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site manager is not able to remove rating added by another user"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site contributor is not able to remove rating added by another user"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  @Bug(id = "ACE-5459")
  public void contributorIsNotAbleToDeleteRatingsOfAnotherUser()
    throws Exception {
    FolderModel folderModel = dataContent
      .usingUser(adminUser)
      .usingSite(siteModel)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site collaborator is not able to remove rating added by another user"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  @Bug(id = "ACE-5459")
  public void collaboratorIsNotAbleToDeleteRatingsOfAnotherUser()
    throws Exception {
    FolderModel folderModel = dataContent
      .usingUser(adminUser)
      .usingSite(siteModel)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site consumer is not able to remove rating added by another user"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Delete rating stars twice"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Delete like rating twice"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Delete like for a folder then add it again"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  public void likeFolderAfterLikeRatingIsDeleted() throws Exception {
    ...
    returnedRatingModel =
      restClient.withCoreAPI().usingResource(folderModel).likeDocument();
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Delete stars for a folder then add them again"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Delete like for a site then add it again"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Delete stars for a site then add them again"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify user with Manager role is able to remove one star rating of a document"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
