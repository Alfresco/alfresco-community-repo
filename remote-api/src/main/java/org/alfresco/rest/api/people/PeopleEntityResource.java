...
public class PeopleEntityResource
     ...
     *
     * @see
     *     org.alfresco.rest.framework.resource.actions.interfaces.EntityResourceAction.ReadById#readById(String,
    ...
    @WebApiParam(
            ...
            description = "A single person, multiple people are not supported.",
    ...
    /**
     * Explicitly test for the presence of system-maintained (derived) fields that are settable on
     * Person (see also REPO-110).
     *
     * @param person
     */
    ...
    public void requestPasswordReset(
            String personId, Client client, Parameters parameters, WithResponse withResponse) {
    ...
    @WebApiDescription(
            ...
            description = "Performs password reset",
            successStatus = HttpServletResponse.SC_ACCEPTED)
    @WebApiNoAuth
    ...
    public BinaryResource readProperty(String personId, Parameters parameters)
            throws EntityNotFoundException {
