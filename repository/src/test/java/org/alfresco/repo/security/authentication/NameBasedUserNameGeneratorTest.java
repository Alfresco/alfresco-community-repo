...
public class NameBasedUserNameGeneratorTest extends TestCase {
  ...
  public void testGenerate() {
    ...
    assertEquals(
      "",
      (firstName + "_" + lastName).toLowerCase().substring(0, 7),
      userName.substring(0, 7)
    );
    assertTrue(
      "",
      !(firstName + "_" + lastName).toLowerCase().equals(userName)
    );
  ...
  public void testGenerateWhitespaceNames() throws Exception {
    ...
    assertEquals(
      "f_oo_bar",
      generator.generateUserName(" f oo ", lastName, "", 0)
    );
    assertEquals(
      "f_o_o_bar",
      generator.generateUserName("f o  o", lastName, "", 0)
    );
    assertEquals(
      "f_o_o_bar",
      generator.generateUserName("f\to\t o", lastName, "", 0)
    ...
    assertEquals(
      "f_o_o_bar",
      generator.generateUserName("f\no \no", lastName, "", 0)
    );
    assertEquals(
      "f_o_o_bar",
      generator.generateUserName("f\ro\r\no", lastName, "", 0)
    );
  }
