...
public class TypeVirtualizationMethodUnitTest {
  ...
  private static Log logger = LogFactory.getLog(
    TypeVirtualizationMethodUnitTest.class
  );
  ...
  static NamespacePrefixResolver mockNamespacePrefixResolver() {
    NamespacePrefixResolver mockNamespacePrefixResolver = Mockito.mock(
      NamespacePrefixResolver.class,
    ...
    Mockito
      .doReturn(SiteModel.SITE_MODEL_URL)
      .when(mockNamespacePrefixResolver)
    ...
    Mockito
      .doReturn(NamespaceService.CONTENT_MODEL_1_0_URI)
      .when(mockNamespacePrefixResolver)
      .getNamespaceURI(NamespaceService.CONTENT_MODEL_PREFIX);

    Mockito
      .doReturn(
        "mock(NamespacePrefixResolver)@" +
        TypeVirtualizationMethod.class.toString()
      )
      .when(mockNamespacePrefixResolver)
      .toString();
