...
public interface KeyResourceLoader {
    /**
     * Loads and returns an InputStream of the key store at the configured location. If the file
     ...
     *
     * <p>Note that the passwords are not cached locally. If the file cannot be found this method
     * returns null.
     *
     * @return Properties
     * @throws IOException
