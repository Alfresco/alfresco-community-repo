...
public interface Action extends ParameterizedItem
{
    ...
    /**
     * @return <tt>true</tt> if the action must be tracked by the {@link ActionTrackingService}, <tt>false</tt> if it must NOT be tracked or <tt>null</tt> to use the action definition's default.
     */
     ...
     * <p/>
     * The option of tracking can be <tt>null</tt> i.e. unset, indicating that the defaults of the action definition should be used. This is to allow manual overriding of the property when it becomes supported by the UI.
     * 
     * @param trackStatus
     *            <tt>true</tt> if the action must be tracked by the {@link ActionTrackingService}, <tt>false</tt> if it must NOT be tracked or <tt>null</tt> to use the action definition's default.
     */
