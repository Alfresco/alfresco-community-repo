...
public class ActivitiUtil {
  ...
  public ActivitiUtil(
    ...
    boolean retentionHistoricProcessInstance
  ) {
    this.repoService = engine.getRepositoryService();
    this.runtimeService = engine.getRuntimeService();
    this.taskService = engine.getTaskService();
  ...
  public ProcessDefinition getProcessDefinitionForDeployment(
    String deploymentId
  ) {
    return repoService
      .createProcessDefinitionQuery()
  ...
  public Task getTaskInstance(String taskId) {
    ...
    if (!deployWorkflowsInTenant) {
      taskQuery.processVariableValueEquals(
  ...
  public ReadOnlyProcessDefinition getDeployedProcessDefinition(
    String processDefinitionId
  ) {
    // Currently, getDeployedProcessDefinition is still experimental and not exposed on
    // RepositoryService interface
    return ((RepositoryServiceImpl) repoService).getDeployedProcessDefinition(
        processDefinitionId
      );
  }

  public String getStartFormKey(String processDefinitionId) {
    ProcessDefinitionEntity procDef = (ProcessDefinitionEntity) getDeployedProcessDefinition(
      processDefinitionId
    );
