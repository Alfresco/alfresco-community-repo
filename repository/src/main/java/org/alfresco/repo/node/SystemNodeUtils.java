...
public abstract class SystemNodeUtils {
  ...
  private static QName SYSTEM_FOLDER_QNAME = QName.createQName(
  ...
  public static NodeRef getSystemContainer(
    ...
    if (sysRefs.size() != 1) {
      throw new IllegalStateException(
        "System folder missing / duplicated! Found " + sysRefs
      );
    }
  ...
  public static NodeRef getSystemChildContainer(
    ...
    List<ChildAssociationRef> containerRefs = getChildAssociationRefs(
      childName,
      nodeService,
      repositoryHelper
    );
  ...
  private static void warnIfDuplicates(
  ...
  private static List<ChildAssociationRef> getChildAssociationRefs(
    ...
    List<ChildAssociationRef> containerRefs = AuthenticationUtil.runAsSystem(
  ...
  public static Pair<NodeRef, Boolean> getOrCreateSystemChildContainer(
    ...
    NodeRef container = getSystemChildContainer(
      childName,
      nodeService,
      repositoryHelper
    );
