...
public class InspectorTests {
    ...
    public void testInspectEntity() {
        ...
        assertNotNull(
                "SheepEntityResource supports DELETE", metaData.getOperation(HttpMethod.DELETE));
        assertNull(
                "SheepEntityResource does not support POST",
                metaData.getOperation(HttpMethod.POST));
        ResourceOperation op = metaData.getOperation(HttpMethod.GET);
        assertEquals(
                "Sheep ReadALL should return ACCEPTED",
                Status.STATUS_ACCEPTED,
                op.getSuccessStatus());
        op = metaData.getOperation(HttpMethod.PUT);
        assertTrue(
                "SheepEntityResource must support Sheep",
                Sheep.class.equals(metaData.getObjectType(op)));
        ...
        assertNotNull(
                "FlockEntityResource supports DELETE", metaData.getOperation(HttpMethod.DELETE));
        assertNull(
                "FlockEntityResource does not support POST",
                metaData.getOperation(HttpMethod.POST));
        ...
        assertNotNull(metaData);
        assertNotNull(
                "MultiPartTestEntityResource support POST", metaData.getOperation(HttpMethod.POST));
        assertNull(
                "MultiPartTestEntityResource does not supports GET",
                metaData.getOperation(HttpMethod.GET));
        assertNull(
                "MultiPartTestEntityResource does not supports PUT",
                metaData.getOperation(HttpMethod.PUT));
        assertNull(
                "MultiPartTestEntityResource does not supports DELETE",
                metaData.getOperation(HttpMethod.DELETE));
        op = metaData.getOperation(HttpMethod.POST);
        assertTrue(
                "MultiPartTestEntityResource must support MultiPartTestResponse",
                MultiPartTestResponse.class.equals(metaData.getObjectType(op)));
        assertEquals(
                "MultiPartTestEntityResource should return ACCEPTED",
                Status.STATUS_ACCEPTED,
                op.getSuccessStatus());
    }
    ...
    public void testInspectRelationship() {
        ...
        assertNotNull(metaData);
        assertNotNull(
                "SheepBlackSheepResource supports GET", metaData.getOperation(HttpMethod.GET));
        ResourceOperation op = metaData.getOperation(HttpMethod.GET);
        List<ResourceParameter> params = op.getParameters();
        assertTrue("readAll method should have 1 url param and 3 query params", params.size() == 4);
        assertNotNull(
                "SheepBlackSheepResource supports PUT", metaData.getOperation(HttpMethod.PUT));
        op = metaData.getOperation(HttpMethod.PUT);
        params = op.getParameters();
        assertTrue(
                "update method should have 2 url params and 1 HTTP_OBJECT param ",
                params.size() == 3);
        assertNotNull(
                "SheepBlackSheepResource supports POST", metaData.getOperation(HttpMethod.POST));
        op = metaData.getOperation(HttpMethod.POST);
        params = op.getParameters();
        assertTrue(
                "SheepBlackSheepResource must support Sheep",
                Sheep.class.equals(metaData.getObjectType(op)));
        assertTrue(
                "create method should have 1 url param and 1 HTTP_OBJECT param ",
                params.size() == 2);
        ...
        assertNotNull(
                "SheepBlackSheepResource supports DELETE",
                metaData.getOperation(HttpMethod.DELETE));
        op = metaData.getOperation(HttpMethod.DELETE);
        assertEquals(
                "SheepBlackSheepResource should return STATUS_CONFLICT",
        ...
        assertNotNull(metaData);
        assertNotNull(
                "MultiPartTestRelationshipResource support POST",
                metaData.getOperation(HttpMethod.POST));
        assertNull(
                "MultiPartTestRelationshipResource does not supports GET",
                metaData.getOperation(HttpMethod.GET));
        assertNull(
                "MultiPartTestRelationshipResource does not supports PUT",
                metaData.getOperation(HttpMethod.PUT));
        assertNull(
                "MultiPartTestRelationshipResource does not supports DELETE",
                metaData.getOperation(HttpMethod.DELETE));
        op = metaData.getOperation(HttpMethod.POST);
        assertTrue(
                "MultiPartTestRelationshipResource must support MultiPartTestResponse",
                MultiPartTestResponse.class.equals(metaData.getObjectType(op)));
    }
    ...
    public void testNodesCommentsRelation() {
        ...
        assertTrue(
                "NodeCommentsRelation must support Comment",
                Comment.class.equals(metaData.getObjectType(op)));
    }
    ...
    public void testUniqueIdAnnotation() {
        ...
        // inherited classes are ok (with overidden unique id method but @UniqueId annotation not
        // specified)
    ...
    public void testEmbeddedAnnotation() {
        Map<String, Pair<String, Method>> embeds =
                ResourceInspector.findEmbeddedResources(Farmer.class);
    ...
    public void testWebDeletedAnnotationOnMethods() {
        Method aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.Read.class,
                        SheepEntityResourceWithDeletedMethods.class);
        assertNotNull("This method is untouched so should be found.", aMethod);
        assertTrue("readAll".equals(aMethod.getName()));

        aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.ReadById.class,
                        SheepEntityResourceWithDeletedMethods.class);
        ...
        aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.Update.class,
                        SheepEntityResourceWithDeletedMethods.class);
        assertTrue(
                "Update method has been marketed as deleted.",
                ResourceInspector.isDeleted(aMethod));

        aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.Delete.class,
                        SheepEntityResourceWithDeletedMethods.class);
        assertTrue(
                "Delete method has been marketed as deleted.",
                ResourceInspector.isDeleted(aMethod));
    ...
    public void testInspectOperation() {
        Method aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.Read.class, SheepEntityResource.class);
        ResourceOperation op =
                ResourceInspector.inspectOperation(
                        SheepEntityResource.class, aMethod, HttpMethod.GET);
        assertNotNull(op);
        ...
        aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.ReadById.class, SheepEntityResource.class);
        ...
        aMethod =
                ResourceInspector.findMethod(
                        EntityResourceAction.ReadById.class, GrassEntityResource.class);
        ...
        assertFalse(
                "URL paths can never suport multiple params, its always FALSE",
        ...
        aMethod =
                ResourceInspector.findMethod(
                        BinaryResourceAction.Read.class, FlockEntityResource.class);
        ...
        aMethod =
                ResourceInspector.findMethod(
                        BinaryResourceAction.Delete.class, FlockEntityResource.class);
        op =
                ResourceInspector.inspectOperation(
                        FlockEntityResource.class, aMethod, HttpMethod.DELETE);
        assertNotNull(op);
        assertTrue(op.getTitle().startsWith("Deletes a photo"));

        aMethod =
                ResourceInspector.findMethod(
                        BinaryResourceAction.Update.class, FlockEntityResource.class);
        ...
        aMethod =
                ResourceInspector.findMethod(
                        BinaryResourceAction.Read.class, SheepBaaaahResource.class);
        ...
        aMethod =
                ResourceInspector.findMethod(
                        BinaryResourceAction.Delete.class, SheepBaaaahResource.class);
        op =
                ResourceInspector.inspectOperation(
                        SheepBaaaahResource.class, aMethod, HttpMethod.DELETE);
        assertNotNull(op);
        assertTrue(op.getTitle().startsWith("Deletes a photo"));

        aMethod =
                ResourceInspector.findMethod(
                        BinaryResourceAction.Update.class, SheepBaaaahResource.class);
    ...
    public void testInspectBodyParam() {
        ...
        ResourceOperation op =
                ResourceInspector.inspectOperation(
                        FlockEntityResource.class, aMethod, HttpMethod.PUT);
        assertNotNull(op);
        List<ResourceParameter> params = op.getParameters();
        ...
        aMethod =
                ResourceInspector.findMethod(
                        RelationshipResourceAction.Create.class, SheepBlackSheepResource.class);
        op =
                ResourceInspector.inspectOperation(
                        SheepBlackSheepResource.class, aMethod, HttpMethod.POST);
        assertNotNull(op);
        params = op.getParameters();
        assertTrue(params.size() == 2);
        for (ResourceParameter param : params) {
        ...
        op =
                ResourceInspector.inspectOperation(
                        SheepEntityResourceWithDeletedMethods.class, aMethod, HttpMethod.POST);
        assertNotNull(op);
        params = op.getParameters();
        assertNotNull(params);
        for (ResourceParameter param : params) {
    ...
    @Test
    public void testInspectOperations()
            throws IllegalAccessException, InstantiationException, Throwable {
        ...
        for (ResourceMetadata resourceMetadata : metainfo) {
            ...
            switch (resourceMetadata.getUniqueId()) {
                case "/-root-/{id}/grow":
                    assertNotNull(
                            "GrassEntityResource supports POST",
                            resourceMetadata.getOperation(HttpMethod.POST));
                    assertNull(
                            "GrassEntityResource does not support DELETE",
                            resourceMetadata.getOperation(HttpMethod.DELETE));
                    ResourceOperation op = resourceMetadata.getOperation(HttpMethod.POST);
                    assertEquals(
                            "grow should return ACCEPTED",
                            Status.STATUS_ACCEPTED,
                            op.getSuccessStatus());
                    ...
                    result =
                            (String)
                                    ResourceInspectorUtil.invokeMethod(
                                            ...
                                            paramObj,
                                            Params.valueOf(
                                                    "notUsed", null, mock(WebScriptRequest.class)),
                                            wr);
                ...
                case "/-root-/{id}/cut":
                    assertNotNull(
                            ...
                            resourceMetadata.getOperation(HttpMethod.POST));
                    assertNull(
                            "GrassEntityResource does not support GET",
                            resourceMetadata.getOperation(HttpMethod.GET));
                    op = resourceMetadata.getOperation(HttpMethod.POST);
                    assertNull(resourceMetadata.getObjectType(op));
                    assertEquals(
                            "cut should return ACCEPTED",
        ...
        for (ResourceMetadata resourceMetadata : metainfo) {
            switch (resourceMetadata.getUniqueId()) {
                case "/goat/{entityId}/herd":
                    assertNotNull(
                            "GoatRelationshipResource supports GET",
                            resourceMetadata.getOperation(HttpMethod.GET));
                    break;
    ...
    public void testInspectAddressedProperties() {
        ...
        ResourceInspector.inspectAddressedProperties(
                api, FlockEntityResource.class, "myroot", metainfo);
        ...
        metainfo.clear();
        ResourceInspector.inspectAddressedProperties(
                api, FlocketEntityResource.class, "myroot", metainfo);
        assertTrue(metainfo.size() == 3);
        for (ResourceMetadata resourceMetadata : metainfo) {
            // If this code is running on a Java 7 or above then please use the switch statement
            // instead of an if.
            //            switch (resourceMetadata.getUniqueId())
            //            {
            //                case "/myroot/photo":
            //                    assertTrue("FlocketEntityResource supports GET",
            // resourcemetaData.getOperation(HttpMethod.GET));
            //                    assertTrue("FlocketEntityResource supports PUT",
            // resourcemetaData.getOperation(HttpMethod.PUT));
            //                    assertTrue("FlocketEntityResource supports DELETE",
            // resourcemetaData.getOperation(HttpMethod.DELETE));
            //                    break;
            //                case "/myroot/album":
            //                    assertTrue("FlocketEntityResource supports GET",
            ...
            //                    assertTrue("FlocketEntityResource supports PUT",
            // resourcemetaData.getOperation(HttpMethod.PUT));
            //                    assertTrue("FlocketEntityResource does not support DELETE",
            // !resourcemetaData.getOperation(HttpMethod.DELETE));
            //                    break;
            //                case "/myroot/madeUpProp":
            //                    assertTrue("FlocketEntityResource supports GET",
            // resourcemetaData.getOperation(HttpMethod.GET));
            //                    assertTrue("FlocketEntityResource does not supports PUT",
            // !resourcemetaData.getOperation(HttpMethod.PUT));
            //                    assertTrue("FlocketEntityResource does not support DELETE",
            // !resourcemetaData.getOperation(HttpMethod.DELETE));
            //                    break;
            ...
            if ("/myroot/{id}/photo".equals(resourceMetadata.getUniqueId())) {
                assertNotNull(
                        "FlocketEntityResource supports GET",
                        resourceMetadata.getOperation(HttpMethod.GET));
                assertNotNull(
                        "FlocketEntityResource supports PUT",
                        resourceMetadata.getOperation(HttpMethod.PUT));
                assertNotNull(
                        "FlocketEntityResource supports DELETE",
                        resourceMetadata.getOperation(HttpMethod.DELETE));
            } else {
                if ("/myroot/{id}/album".equals(resourceMetadata.getUniqueId())) {
                    ...
                    assertNotNull(
                            ...
                            resourceMetadata.getOperation(HttpMethod.PUT));
                    assertNull(
                            "FlocketEntityResource does not support DELETE",
                            resourceMetadata.getOperation(HttpMethod.DELETE));
                } else {
                    if ("/myroot/{id}/madeUpProp".equals(resourceMetadata.getUniqueId())) {
                        assertNotNull(
                                ...
                                resourceMetadata.getOperation(HttpMethod.GET));
                        assertNull(
                                "FlocketEntityResource does not supports PUT",
                                resourceMetadata.getOperation(HttpMethod.PUT));
                        assertNull(
                                "FlocketEntityResource does not support DELETE",
                                resourceMetadata.getOperation(HttpMethod.DELETE));
    ...
    public void testWebDeletedAnnotationOnClass() {
        List<ResourceMetadata> metainfo =
                ResourceInspector.inspect(GrassEntityResourceNowDeleted.class);
        assertTrue("Must be at least one ResourceMetadata", metainfo.size() > 0);
        ResourceMetadata metaData = metainfo.get(0);
        assertNotNull(metaData);
        assertNull(
                "GrassEntityResourceNowDeleted all methods deleted",
                metaData.getOperation(HttpMethod.GET));
        assertNull(
                "GrassEntityResourceNowDeleted all methods deleted",
                metaData.getOperation(HttpMethod.PUT));
        ...
        assertNotNull(metaData);
        assertNull(
                "SheepBlackSheepResourceIsNoMore all methods deleted",
                metaData.getOperation(HttpMethod.GET));
        assertNull(
                "SheepBlackSheepResourceIsNoMore all methods deleted",
                metaData.getOperation(HttpMethod.PUT));
    ...
    public void testValidSuccessCode() {
        ...
        assertEquals(
                Status.STATUS_OK,
                ResourceInspector.validSuccessCode(HttpMethod.GET, ResourceOperation.UNSET_STATUS));
        assertEquals(
                Status.STATUS_CREATED,
                ResourceInspector.validSuccessCode(
                        HttpMethod.POST, ResourceOperation.UNSET_STATUS));
        assertEquals(
                Status.STATUS_OK,
                ResourceInspector.validSuccessCode(HttpMethod.PUT, ResourceOperation.UNSET_STATUS));
        assertEquals(
                Status.STATUS_NO_CONTENT,
                ResourceInspector.validSuccessCode(
                        HttpMethod.DELETE, ResourceOperation.UNSET_STATUS));

        // Test custom values
        assertEquals(
                Status.STATUS_ACCEPTED,
                ResourceInspector.validSuccessCode(HttpMethod.GET, Status.STATUS_ACCEPTED));
        assertEquals(
                Status.STATUS_FOUND,
                ResourceInspector.validSuccessCode(HttpMethod.POST, Status.STATUS_FOUND));
        assertEquals(
                Status.STATUS_ACCEPTED,
                ResourceInspector.validSuccessCode(HttpMethod.PUT, Status.STATUS_ACCEPTED));
        assertEquals(
                Status.STATUS_NOT_MODIFIED,
                ResourceInspector.validSuccessCode(HttpMethod.DELETE, Status.STATUS_NOT_MODIFIED));
    }
}
