...
/**
 * Custom implementation of the Activiti {@link StringType}, which allows string-values to be larger
 * than the database-restriction of the TEXT_ column, by using binary storage in case the string
