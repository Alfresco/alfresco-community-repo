 ...
 *
 */
public class LuceneDescendant<Q, S, E extends Throwable>
  extends Descendant
  ...
  private StoreRef getStore(QueryBuilderContext<Q, S, E> luceneContext) {
    ArrayList<StoreRef> stores = luceneContext
  ...
  public Q addComponent(
    ...
    if (functionContext.getNodeService() != null) {
      ...
      StringBuilder builder = new StringBuilder(
        path.toPrefixString(luceneContext.getNamespacePrefixResolver())
      );
      builder.append("//*");
      Q query = lqpa.getFieldQuery(
        QueryConstants.FIELD_PATH,
        builder.toString()
      );
      return query;
    }
