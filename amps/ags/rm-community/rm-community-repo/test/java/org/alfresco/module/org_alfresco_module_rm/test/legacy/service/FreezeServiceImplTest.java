                    ...
                    public Void run() throws Exception {
                        ...
                        NodeRef hold101 =
                                holdService.createHold(
                                        filePlan, "freezename 101", "FreezeReason", null);
                        ...
                        NodeRef newHold =
                                holdService.createHold(
                                        filePlan, "Hold 102", "Freeze a set of nodes", null);
                        ...
                        for (NodeRef hold : holdAssocs) {
                            ...
                            if (reason.equals("Freeze a set of nodes")) {
                                ...
                                throw new AlfrescoRuntimeException(
                                        "The reason '"
                                                + reason
                                                + "' was not found in the existing holds.");
                            }
                        }

                        // Check the nodes are frozen
                        final List<NodeRef> testRecords =
                                Arrays.asList(new NodeRef[] {recordOne, recordTwo, recordThree});
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        ...
                        NodeRef hold =
                                holdService.createHold(
                                        filePlan, "hold 1", "AnotherFreezeReason", "description");
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        NodeRef hold101 =
                                holdService.createHold(
                                        filePlan, "freezename 103", "FreezeReason", null);
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() throws Exception {
                        NodeRef hold101 =
                                holdService.createHold(
                                        filePlan, "freezename 104", "FreezeReason", null);
