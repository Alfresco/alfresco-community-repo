...
/**
 * An implementation of {@link org.alfresco.service.cmr.remoteticket.RemoteAlfrescoTicketInfo} which
...
public class GuestRemoteAlfrescoTicketImpl extends AbstractRemoteAlfrescoTicketImpl {
    ...
    /**
     * Returns the Ticket as a URL Escaped Parameter fragment, which is the same as the un-escaped
     * due to the format of Alfresco Tickets
     */
    ...
    /**
     * Returns the Ticket in the form of a pseudo username and password. The Username is a special
     * ticket identifier, and the password is the ticket
     */
