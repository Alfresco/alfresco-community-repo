...
public class GetSiteContainerTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    moderatedSiteModel =
      dataSite.usingUser(testUser).createModeratedRandomSite();
  ...
  public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteContainer()
    throws Exception {
    restClient.authenticateUser(
      usersWithRoles.getOneUserWithRole(UserRole.SiteManager)
    );
  ...
  public void adminCanGetContainerForPrivateSiteCreatedByUser()
    throws Exception {
    restClient
  ...
  public void userCannotGetContainerForPrivateSiteCreatedByAdmin()
    throws Exception {
    restClient
      .authenticateUser(testUser)
      .withCoreAPI()
