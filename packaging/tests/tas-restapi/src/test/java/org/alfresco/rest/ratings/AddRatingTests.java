...
public class AddRatingTests extends RestTest {
  ...
  public void unauthenticatedUserIsNotAbleToRateStarsToDocument()
    throws Exception {
    FolderModel folderModel = dataContent
      .usingUser(userModel)
      .usingSite(siteModel)
  ...
  public void unknownRatingSchemeReturnsBadRequest() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_RATING, "invalidRate")
      )
      .containsErrorKey(
        String.format(RestErrorModel.INVALID_RATING, "invalidRate")
      )
  ...
  public void addRateUsingInvalidValueForIdCaseSensitive() throws Exception {
    ...
    restClient
      ...
      .containsErrorKey(
        String.format(RestErrorModel.INVALID_RATING, "FiveStar")
      )
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .stackTraceIs(RestErrorModel.STACKTRACE);
  }
  ...
  public void collaboratorIsNotAbleToAddANegativeRatingToAFile()
    throws Exception {
    FolderModel folderModel = dataContent
      .usingUser(userModel)
      .usingSite(siteModel)
