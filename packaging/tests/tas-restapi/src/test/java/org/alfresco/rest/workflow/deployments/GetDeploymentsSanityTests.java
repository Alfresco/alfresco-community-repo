...
public class GetDeploymentsSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify Admin user gets non-network deployments using REST API and status code"
                            + " is OK (200)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getNonNetworkDeploymentsWithAdmin()
        ...
        deployments =
                restClient.authenticateUser(adminUserModel).withWorkflowAPI().getDeployments();
