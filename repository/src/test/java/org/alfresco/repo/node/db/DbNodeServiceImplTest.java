...
public class DbNodeServiceImplTest extends BaseNodeServiceTest {
    ...
    protected NodeService getNodeService() {
        // Force cascading
        DbNodeServiceImpl dbNodeServiceImpl =
                (DbNodeServiceImpl) applicationContext.getBean("dbNodeServiceImpl");
    ...
    public void testNodeCleanupRegistry() throws Exception {
        ...
        NodeCleanupRegistry cleanupRegistry =
                (NodeCleanupRegistry) applicationContext.getBean("nodeCleanupRegistry");
    ...
    private class TestTxnCommitTimeTxnListener extends TransactionListenerAdapter {
        ...
        public long getTxnCommitTime(String txnId, long fromTime) {
            List<Transaction> startTxns =
                    ((NodeDAOImpl) nodeDAO)
                            .selectTxns(fromTime, null, Integer.MAX_VALUE, null, null, true);
            long time = 0L;
    ...
    /**
     * Deletes a child node and then iterates over the children of the parent node, getting the
     * QName. This caused some issues after we did some optimization using lazy loading of the
     * associations.
     */
    ...
    public void testNodeStatus() throws Throwable {
        ...
        RetryingTransactionCallback<Object> changePropertiesWork =
        ...
        // add an aspect
        RetryingTransactionCallback<Object> addAspectWork =
                new RetryingTransactionCallback<Object>() {
                    public Object execute() {
        ...
        // remove an aspect
        RetryingTransactionCallback<Object> removeAspectWork =
                new RetryingTransactionCallback<Object>() {
                    public Object execute() {
        ...
        // move the node
        RetryingTransactionCallback<Object> moveNodeWork =
                new RetryingTransactionCallback<Object>() {
                    public Object execute() {
        ...
        // delete the node
        RetryingTransactionCallback<Object> deleteNodeWork =
                new RetryingTransactionCallback<Object>() {
                    public Object execute() {
        ...
        RetryingTransactionCallback<Object> checkCascadeCallback =
                new RetryingTransactionCallback<Object>() {
                    public Object execute() {
                        // check n6
                        ...
                        if (!n8Status.isDeleted()) {
                            throw new RuntimeException(
                                    "Cascade-deleted node does not have deleted status");
                        }
                        return null;
                    }
                };
        ...
        RetryingTransactionCallback<Object> checkRecreateCallback =
                new RetryingTransactionCallback<Object>() {
                    public Object execute() {
                        properties.put(
    ...
    private void executeAndCheck(NodeRef nodeRef, RetryingTransactionCallback<Object> callback)
            throws Throwable {
        ...
        try {
            ...
            nodeDAO.getParentAssocs(
                    nodeId, null, null, null, new DummyChildAssocRefQueryCallback());
    ...
    public void testMLTextValues() throws Exception {
        ...
        nodeService.setProperty(
                rootNodeRef, BaseNodeServiceTest.PROP_QNAME_ML_TEXT_VALUE, mlTextProperty);

        // Check unfiltered property retrieval
        Serializable textValueDirect =
                nodeService.getProperty(rootNodeRef, BaseNodeServiceTest.PROP_QNAME_ML_TEXT_VALUE);
    ...
    public void testStringIntoMLTextProperty() throws Exception {
        ...
        assertTrue(
                "Plain string insertion should be returned as MLText",
                mlTextCheck instanceof MLText);
        ...
        Serializable nullValueCheck =
                nodeService.getProperty(rootNodeRef, PROP_QNAME_ML_TEXT_VALUE);
    ...
    public void testSingleStringMLTextProperty() throws Exception {
        ...
        // Get it back and check
        MLText mlTextCheck =
                (MLText) nodeService.getProperty(rootNodeRef, PROP_QNAME_ML_TEXT_VALUE);
        assertEquals("Setting of MLText over String failed.", mlText, mlTextCheck);
    }

    /**
     * It would appear that an issue has arisen with creating and deleting nodes in the same
     * transaction.
     */
    ...
    public void testAspectRemovalWithCommit() throws Throwable {
        ...
        try {
            ...
            assertEquals("Expected exactly one less aspect", noAspectsBefore - 1, aspects.size());
    ...
    public void testGetChildAssocsByPropertyValue() throws Exception {
        ...
        ChildAssociationRef rootRef =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root"));
        ChildAssociationRef n1Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n1"));
        ChildAssociationRef n2Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n2"));

        /**
         * Positive test - get n1 and n2 by the value of a text property in this case PROP_SUBJECT
         ...
         */
        {
            ...
            List<ChildAssociationRef> refs =
                    nodeService.getChildAssocsByPropertyValue(
                            parentNodeRef, ContentModel.PROP_SUBJECT, subject);
        ...
        /** Positive tests of various types that should be accepted by the query */
        {
            ...
            List<ChildAssociationRef> refs =
                    nodeService.getChildAssocsByPropertyValue(
                            parentNodeRef, ContentModel.PROP_COUNTER, count);
            assertTrue("failed to read one assoc", refs.size() == 1);
            assertTrue("content not correct", refs.contains(n1Ref));
            ...
            refs =
                    nodeService.getChildAssocsByPropertyValue(
                            parentNodeRef, ContentModel.PROP_LATITUDE, alfLat);
            assertTrue("failed to read one assoc", refs.size() == 1);
            assertTrue("content not correct", refs.contains(n1Ref));
            ...
            // refs = nodeService.getChildAssocsByPropertyValue(parentNodeRef,
            // ContentModel.PROP_RATING_SCORE, score);
            // assertTrue("failed to read one assoc", refs.size() == 1);
            // assertTrue("content not correct", refs.contains(n1Ref));
            ...
            assertTrue(
                    (Boolean)
                            nodeService.getProperty(
                                    n1Ref.getChildRef(), ContentModel.PROP_ENABLED));
            refs =
                    nodeService.getChildAssocsByPropertyValue(
                            parentNodeRef, ContentModel.PROP_ENABLED, beauty);
            assertTrue("failed to read one assoc", refs.size() == 1);
            assertTrue("content not correct", refs.contains(n1Ref));
        ...
        try {
            List<ChildAssociationRef> refs =
                    nodeService.getChildAssocsByPropertyValue(
                            n1Ref.getParentRef(), ContentModel.PROP_NODE_DBID, "Fail");
        ...
        try {
            Serializable title =
                    (String) nodeService.getProperty(n1Ref.getChildRef(), ContentModel.PROP_TITLE);
            List<ChildAssociationRef> refs =
                    nodeService.getChildAssocsByPropertyValue(
                            n1Ref.getParentRef(), ContentModel.PROP_NAME, title);
    ...
    /**
     * Check that the maximum string lengths can be adjusted up and down. Note that this test ONLY
     * works for MySQL because the other databases cannot support more than 1024 characters in the
     * string_value column and the value may not be set to less than 1024.
     *
    ...
    public void testMySQLInnoDBNodeStringLengthWorker() throws Exception {
        ...
        if ((dialect instanceof MySQLClusterNDBDialect)
                || (!(dialect instanceof MySQLInnoDBDialect))) {
            return;
        }
        SchemaBootstrap schemaBootstrap =
                (SchemaBootstrap) applicationContext.getBean("schemaBootstrap");
        assertEquals(
                "Expected max string length to be MAX",
                Integer.MAX_VALUE,
                SchemaBootstrap.getMaxStringLength());

        NodeStringLengthWorker worker =
                (NodeStringLengthWorker) applicationContext.getBean("nodeStringLengthWorker");
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                nodeService.setProperty(
                                        rootNodeRef, PROP_QNAME_STRING_VALUE, longString);
                                return null;
                            }
                        });
        ...
        // Put the limit back to the MySQL default and all the large values should go back into
        // MySQL's TEXT field
        schemaBootstrap.setMaximumStringLength(Integer.MAX_VALUE);
        schemaBootstrap.onApplicationEvent(new ContextRefreshedEvent(applicationContext));
        result = worker.execute();
                        ...
                        .doInTransaction(
                                new RetryingTransactionCallback<String>() {
                                    ...
                                    public String execute() throws Throwable {
                                        return (String)
                                                nodeService.getProperty(
                                                        rootNodeRef, PROP_QNAME_STRING_VALUE);
                                    }
                                });
        assertEquals(
                "String manipulation corrupted the long string value. ",
                longString,
                checkLongString);
    }
