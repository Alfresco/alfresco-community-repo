 ...
 *
 * <p>Relates to: - https://issues.alfresco.com/jira/browse/RM-1341
 *
...
public class CompleteEventsTest extends BaseRMTestCase {
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        utils.createBasicDispositionSchedule(
                                recordCategory, "instructions", "authority", true, true);
                    ...
                    public void when() {
                        ...
                        rmActionService.executeRecordsManagementAction(
                                record, CompleteEventAction.NAME, params);
                    }
                    ...
                    public void then() {
                        ...
                        EventCompletionDetails eventDetails =
                                dispositionAction.getEventCompletionDetails(
                                        CommonRMTestUtils.DEFAULT_EVENT_NAME);
                        assertNotNull(eventDetails);
                        assertEquals(
                                CommonRMTestUtils.DEFAULT_EVENT_NAME, eventDetails.getEventName());
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        // create disposition schedule
                        utils.createBasicDispositionSchedule(
                                recordCategory, "instructions", "authority", false, true);
                    ...
                    public void when() {
                        ...
                        // complete event
                        rmActionService.executeRecordsManagementAction(
                                recordFolder, CompleteEventAction.NAME, params);
                    }

                    public void then() {
                        // check that the record is now eligible for the next disposition action
                        assertTrue(
                                dispositionService.isNextDispositionActionEligible(recordFolder));
    ...
    /**
     * test complete event given at least one event is needed for the disposition action to be
     * eligible
     */
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        // create disposition schedule
                        DispositionSchedule mySchedule =
                                utils.createBasicDispositionSchedule(
                                        recordCategory, "instructions", "authority", false, false);
                        ...
                        adParams.put(
                                ...
                                CommonRMTestUtils.DEFAULT_DISPOSITION_DESCRIPTION);
    ...
    /**
     * test that disposition action is not eligible given all events need to be completed and only
     * has been
     */
    ...
    /**
     * test event complete makes disposition eligible given that all events are complete and
     * required
     */
                ...
                new BehaviourDrivenTest() {
                    ...
                    public void given() {
                        ...
                        nodeService.addChild(
                                ...
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, recordName));
                    }
