...
public abstract class FacetablePropertyFTL<T> implements Comparable<T> {
    ...
    public static class StandardFacetablePropertyFTL
        ...
        public String getShortQname() {
            return propDef.getName().getPrefixString();
        }
        ...
        public QName getContainerClassType() {
            return propDef.getContainerClass().getName();
        }
        ...
        public QName getModelQname() {
            return propDef.getModel().getName();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (localisedTitle == null) {
                if (other.localisedTitle != null) return false;
            } else if (!localisedTitle.equals(other.localisedTitle)) return false;
            if (propDef == null) {
                if (other.propDef != null) return false;
            } else if (!propDef.equals(other.propDef)) return false;
            return true;
        }
        ...
        public int compareTo(StandardFacetablePropertyFTL that) {
            final int modelComparison =
                    this.propDef.getModel().getName().compareTo(that.propDef.getModel().getName());
            final int classComparison =
                    this.propDef
                            .getContainerClass()
                            .getName()
                            .compareTo(that.propDef.getContainerClass().getName());
            final int propComparison = this.propDef.getName().compareTo(that.propDef.getName());

            final int result;
            if (modelComparison != 0) {
                result = modelComparison;
            } else if (classComparison != 0) {
                result = classComparison;
            } else {
                result = propComparison;
            }
    ...
    /**
     * This class represents a facetable property, which is not actually an Alfresco content
     * property, but is closely associated with one. Examples are the {@code size} and {@code MIME
     * type} fields within the {@code cm:content} property type.
     */
    public static class SyntheticFacetablePropertyFTL
         ...
         */
        public SyntheticFacetablePropertyFTL(
                PropertyDefinition containingPropDef,
        ...
        public QName getQname() {
            ...
            return QName.createQName(
                    containingPropQName.getNamespaceURI(),
        ...
        @Override
        public QName getContainerClassType() {
            return containingPropDef.getContainerClass().getName();
        }
        ;

        @Override
        public QName getModelQname() {
            return containingPropDef.getModel().getName();
        }
        ...
        public int compareTo(SyntheticFacetablePropertyFTL that) {
            final int modelComparison =
                    this.containingPropDef
                            .getModel()
                            .getName()
                            .compareTo(that.containingPropDef.getModel().getName());
            final int classComparison =
                    this.containingPropDef
                            .getContainerClass()
                            .getName()
                            .compareTo(that.containingPropDef.getContainerClass().getName());
            final int propComparison =
                    this.containingPropDef.getName().compareTo(that.containingPropDef.getName());
            ...
            if (modelComparison != 0) {
                ...
                result = classComparison;
            } else if (propComparison != 0) {
                result = propComparison;
            } else {
                result = displayNameComparison;
            }
        ...
        public int hashCode() {
            ...
            result =
                    prime * result
                            + ((containingPropDef == null) ? 0 : containingPropDef.hashCode());
            result = prime * result + ((datatype == null) ? 0 : datatype.hashCode());
            result = prime * result + ((displayName == null) ? 0 : displayName.hashCode());
            result =
                    prime * result
                            + ((syntheticPropertyName == null)
                                    ? 0
        ...
        public boolean equals(Object obj) {
            ...
            if (containingPropDef == null) {
                if (other.containingPropDef != null) return false;
            } else if (!containingPropDef.equals(other.containingPropDef)) return false;
            if (datatype == null) {
            ...
            if (syntheticPropertyName == null) {
                if (other.syntheticPropertyName != null) return false;
            } else if (!syntheticPropertyName.equals(other.syntheticPropertyName)) return false;
            return true;
        }
    }
     ...
     * and yet it is something that Alfresco and SOLR can use for facetting. Examples are the {@code
     * TAG} and {@code SITE} facets.
     */
    ...
    /**
     * In order to give deterministic responses when getting facetable properties, all {@link
     * FacetablePropertyFTL} instances are sorted. This comparator provides the sorting
     * implementation.
     */
    public static class FacetablePropertyFTLComparator
        ...
        private final List<Class<?>> typeOrder =
                Arrays.asList(
                        new Class<?>[] {
                            SpecialFacetablePropertyFTL.class,
        ...
        public int compare(FacetablePropertyFTL left, FacetablePropertyFTL right) {
            ...
            if (!left.getClass().equals(right.getClass())) {
                return typeOrder.indexOf(left.getClass()) - typeOrder.indexOf(right.getClass());
            } else {
