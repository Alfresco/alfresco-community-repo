...
/**
 * Ensures that the routing of URLs based on context is working. A combination of fully featured and
 * incompletely featured stores is used to ensure that all routing scenarios are handled.
 *
...
public class RoutingContentStoreTest extends AbstractWritableContentStoreTest {
    ...
    public void testGeneralUse() {
        for (int i = 0; i < 20; i++) {
            ...
            // Now go direct to the routing store and check that it is able to find the appropriate
            // URLs
    ...
    /**
     * A test routing store that directs content writes to a randomly-chosen store. Matching of
     * content URLs back to the stores is handled by the base class.
     *
     * @author Derek Hulley
     */
    private static class RandomRoutingContentStore extends AbstractRoutingContentStore {
        ...
        public RandomRoutingContentStore(ContentStore... stores) {
            ...
            SimpleCache<Pair<String, String>, ContentStore> cache =
                    new DefaultSimpleCache<Pair<String, String>, ContentStore>(
                            11, getClass().getName());
