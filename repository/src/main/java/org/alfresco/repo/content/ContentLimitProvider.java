 ...
 *
 * <ul>
 *   <li>{@link NoLimitProvider} which provides a value indicating no limit.
 *   <li>{@link SimpleFixedLimitProvider} which provides a fixed numerical limit value.
 * </ul>
 *
...
public interface ContentLimitProvider {
    /**
     * A {@link ContentLimitProvider#getSizeLimit() limit} having this value is deemed not to be a
     * limit.
     */
    ...
    public static class SimpleFixedLimitProvider implements ContentLimitProvider {
        ...
        /**
         * This method sets a value for the limit. If the string does not {@link
         * Long#parseLong(String) parse} to a java long, the {@link ContentLimitProvider#NO_LIMIT
        ...
        public void setSizeLimitString(String limit) {
            // A string parameter is used here in order to not to require end users to provide a
            // value for the limit in a property
