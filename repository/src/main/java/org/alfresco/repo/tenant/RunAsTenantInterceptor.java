...
public class RunAsTenantInterceptor implements MethodInterceptor {
    ...
    public Object invoke(final MethodInvocation mi) throws Throwable {
                    ...
                    public Object doWork() throws Exception {
                        try {
                            ...
                            throw new RuntimeException(
                                    "Failed to execute in RunAsTenant context", e);
                        }
                    }
                };
        ...
        if (tenantType == TENANT_TYPE.Default) {
            ...
            // run as tenant using current tenant context (if no tenant context then it is implied
            // as the primary tenant, based on username)
            return TenantUtil.runAsTenant(
                    runAs,
                    AuthenticationUtil.getUserTenant(AuthenticationUtil.getFullyAuthenticatedUser())
                            .getSecond());
        }
    }
}
