...
public class AuthenticationServiceImplTest {
    ...
    public void testAuthChainWorksIfFirstAuthFails() throws Exception {
        ...
        assertNotNull(
                "The user should not be removed from the cache for the corresponding authorization"
                        + " service after a failed login.",
                cache.get(authenticationChain[0].getProtectedUserKey(USERNAME)));
        assertNull(
                "The user should be removed from the cache for the corresponding authorization"
                        + " service after successful login.",
