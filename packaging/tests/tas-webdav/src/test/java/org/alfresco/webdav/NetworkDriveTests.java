...
public class NetworkDriveTests extends WebDavTest {
    ...
    public void dataPreparation() throws Exception {
        if (SystemUtils.IS_OS_WINDOWS) webDavProtocol.unmountNetworkDrive();
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager can create folder with name that contains spaces on mapped"
                            + " drive")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can create folder with name that contains special"
                            + " characters on mapped drive")
    public void siteManagerCanCreateFolderWithSpecialCharactersInNameOnMappedDrive()
            throws Exception {
    ...
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.FULL, TestGroup.OS_WIN},
            expectedExceptions = FileAlreadyExistsException.class)
    @TestRail(
            section = {TestGroup.PROTOCOLS, TestGroup.WEBDAV},
            executionType = ExecutionType.REGRESSION,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager can create folder inside another folder on mapped drive")
    public void siteManagerCanCreateFolderInFolderOnMappedDrive() throws Exception {
        FolderModel parentFolder =
                dataContent.usingUser(siteManager).usingSite(testSite).createFolder();
        folderModel = FolderModel.getRandomFolderModel();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager can create folder with name prefixed by dot on mapped"
                            + " drive")
    ...
    public void siteManagerCanCopyFileOnMappedDrive() throws Exception {
        ...
        copiedFile.setCmisLocation(
                fileModel.getCmisLocation().replace(fileModel.getName(), copiedFile.getName()));
    ...
    public void siteManagerCanCopyFolderOnMappedDrive() throws Exception {
        ...
        copiedFolder.setCmisLocation(
                folderModel
                        .getCmisLocation()
                        .replace(folderModel.getName(), copiedFolder.getName()));
    ...
    public void siteManagerCanMoveFileOnMappedDrive() throws Exception {
        ...
        movedFile.setCmisLocation(
                fileModel.getCmisLocation().replace(fileModel.getName(), movedFile.getName()));
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager cannot update content for a deleted file on mapped drive")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that file version is incremented after file is edited on mapped drive")
