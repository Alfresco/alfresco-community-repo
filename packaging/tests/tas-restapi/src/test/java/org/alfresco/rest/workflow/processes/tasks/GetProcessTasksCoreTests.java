...
public class GetProcessTasksCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "getProcessTasks with user that is candidate with REST API and status code is"
                            + " OK (200)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getProcessTasksWithUserThatIsCandidate() throws Exception {
        ...
        restClient
                ...
                .and()
                .entriesListContains("assignee", candidate.getUsername());
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "getProcessTasks for invalid processId with REST API and status code is"
                            + " NOT_FOUND (404)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "getProcessTasks for empty processId with REST API and status code is NOT_FOUND"
                            + " (404)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "User completes task then getProcessTasks with REST API and status code is OK"
                            + " (200)")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void completeTaskThenGetProcessTasks() throws Exception {
        ...
        RestTaskModel restTaskModel =
                restClient
                        .authenticateUser(anotherAssignee)
                        .withWorkflowAPI()
                        .usingProcess(processModel)
                        .getProcessTasks()
                        .assertThat()
