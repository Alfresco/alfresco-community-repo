...
public class CreateThumbnailActionExecuter extends ActionExecuterAbstractBase {
  ...
  private static Log logger = LogFactory.getLog(
    CreateThumbnailActionExecuter.class
  );
  ...
  protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
    ...
    if (this.nodeService.exists(actionedUponNodeRef) == true) {
      ...
      String thumbnailName = (String) action.getParameterValue(
      ...
      try {
        ...
        final String msg =
          "Creation of thumbnail '" + details.getName() + "' failed";
        logger.info(msg);
  ...
  protected void addParameterDefinitions(List<ParameterDefinition> paramList) {
    paramList.add(
      new ParameterDefinitionImpl(
        ...
        true,
        getParamDisplayLabel(PARAM_THUMBANIL_NAME)
      )
    );
    paramList.add(
      new ParameterDefinitionImpl(
