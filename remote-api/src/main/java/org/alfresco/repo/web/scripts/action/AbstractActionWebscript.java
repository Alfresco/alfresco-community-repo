...
public abstract class AbstractActionWebscript extends DeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        RunningActionModelBuilder modelBuilder =
                new RunningActionModelBuilder(nodeService, actionService, actionTrackingService);
    ...
    /**
     * Takes a running action ID, and returns an ExecutionSummary object for it. Note - doesn't
     * check to see if the object exists in the cache though!
     */
    ...
    /**
     * Returns the ExecutionSummary for the given action if it is currently executing, or null if it
     * isn't
     */
    ...
    /**
     * So we can get at protected methods, which we need as we use the same naming scheme as the
     * cache in the interests of simplicity.
     */
