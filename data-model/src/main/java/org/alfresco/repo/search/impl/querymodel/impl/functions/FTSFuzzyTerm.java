...
public class FTSFuzzyTerm extends BaseFunction {
    public static final String NAME = "FTSFuzzyTerm";

    public static final String ARG_TERM = "Term";

    public static final String ARG_PROPERTY = "Property";

    public static final String ARG_MIN_SIMILARITY = "MinSimilarity";
    ...
    static {
        ...
        args.put(
                ...
                new BaseArgumentDefinition(
                        Multiplicity.SINGLE_VALUED, ARG_TERM, DataTypeDefinition.ANY, true));
        args.put(
                ARG_PROPERTY,
                new BaseArgumentDefinition(
