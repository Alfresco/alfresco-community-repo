...
public class GetRatingTests extends RestTest {
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Check that using invalid ratingId for get rating call returns status code 400."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  public void checkInvalidRatingIdStatusCode() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_RATING, "invalid ratingId")
      );
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Check that using invalid node ID for get rating call returns status code 404."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get rating of a file that has only likes."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get rating of a file that has only stars."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get rating of a file that has likes and stars."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get rating of a folder that has only likes."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  public void getRatingOfFolderThatHasOnlyLikes() throws Exception {
    FolderModel firstFolderModel = dataContent
      .usingUser(adminUser)
      .usingSite(siteModel)
      .createFolder();
    restClient
    ...
    restRatingModel =
      restClient.withCoreAPI().usingResource(firstFolderModel).getLikeRating();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    restRatingModel
      .assertThat()
      .field("id")
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get rating of a file that has no ratings."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Check default error schema"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  public void checkDefaultErrorSchema() throws Exception {
    ...
    restClient
      ...
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, randomNodeRef)
      )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get five star rating"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.RATINGS },
    executionType = ExecutionType.REGRESSION,
    description = "Get one star rating"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION }
  )
