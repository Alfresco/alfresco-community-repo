...
public interface TransferProgressMonitor {
   ...
   * @throws TransferException
   */
  void logException(String transferId, Object obj, Throwable ex)
    throws TransferException;
   ...
   * @throws TransferException
   */
  void updateProgress(String transferId, int currPos, int endPos)
    throws TransferException;
   ...
   * @throws TransferException
   */
  void updateStatus(String transferId, TransferProgress.Status status)
    throws TransferException;
