...
public class SOLRAdminClient
  ...
  implements
    ApplicationEventPublisherAware, DisposableBean, SolrAdminClientInterface {
  ...
  public JSONAPIResult executeAction(
    ...
    try {
      return JSONAPIResultFactory.buildActionResult(
        action,
        getOperation(httpClient, url.toString())
      );
    } catch (IOException e) {
  ...
  public JSONAPIResult executeCommand(
    ...
    try {
      JSONAPIResult response = new SolrCommandBackupResult(
        getOperation(httpClient, url.toString())
      );
  ...
  class SolrTracker {
    ...
    protected void pingSolr() {
      SolrActionStatusResult result = (SolrActionStatusResult) executeAction(
        null,
        JSONAPIResultFactory.ACTION.STATUS,
        JSON_PARAM
      );
    ...
    protected void setupTimer() {
      try {
        ...
        throw new AlfrescoRuntimeException(
          "Unable to set up SOLRTracker timer",
          e
        );
      }
    }
