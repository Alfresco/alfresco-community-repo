...
public class JscriptWorkflowTransition implements Serializable {
    ...
    /**
     * Constructor to create a new instance of this class from an existing instance of
     * WorkflowTransition from the CMR workflow object model
     *
     * @param transition CMR WorkflowTransition object from which to create a new instance of this
     *     class
     */
    ...
    public String toString() {
        return "JscriptWorkflowTransition[id="
                + id
                + ",title="
                + title
                + ",description="
