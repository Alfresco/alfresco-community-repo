...
public class ObjectIdLuceneBuilder extends BaseLuceneBuilder {
  ...
  private <Q, S, E extends Throwable> StoreRef getStore(
  ...
  private <Q, S, E extends Throwable> String getValueAsString(
    ...
    Object converted = DefaultTypeConverter.INSTANCE.convert(
      dictionaryService.getDataType(DataTypeDefinition.NODE_REF),
      nodeRefStr
    );
    String asString = DefaultTypeConverter.INSTANCE.convert(
      String.class,
      converted
    );
    return asString;
  ...
  public <Q, S, E extends Throwable> Q buildLuceneEquality(
    ...
    return lqpa.getIdentifierQuery(
      field,
      stringValue,
  ...
  public <Q, S, E extends Throwable> Q buildLuceneGreaterThan(
    ...
    throw new CmisInvalidArgumentException(
      ...
      " can not be used in a 'greater than' comparison"
    );
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneLessThan(
    ...
    throw new CmisInvalidArgumentException(
      "Property " +
      PropertyIds.OBJECT_ID +
      " can not be used in a 'less than' comparison"
    );
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneLessThanOrEquals(
    ...
    throw new CmisInvalidArgumentException(
      "Property " +
      PropertyIds.OBJECT_ID +
      " can not be used in a 'less than or equals' comparison"
    );
  }
  ...
  public <Q, S, E extends Throwable> Q buildLuceneLike(
    ...
    Q q = lqpa.getIdentifieLikeQuery(
      field,
      stringValue,
      AnalysisMode.IDENTIFIER
    );
