...
public class ProtocolTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    parameters = Arrays.asList(p1, p2);
    r =
      new Reference(
  ...
  public void testGetParameter() throws Exception {
    Parameter tp1 = protocol.getParameter(r, 0);
    assertEquals(p1, tp1);
    Parameter tp2 = protocol.getParameter(r, 1);
    assertEquals(p2, tp2);

    try {
      protocol.getParameter(r, -1);
      fail("Out of bounds!");
  ...
  public void testReplaceParameter() throws Exception {
    ...
    Reference rr1 = protocol.replaceParameter(r, 0, newParameter);
    assertEquals(newParameter, protocol.getParameter(rr1, 0));

    try {
      protocol.replaceParameter(r, 2, newParameter);
      fail("Out of bounds!");
    } catch (IndexOutOfBoundsException e) {
      e.printStackTrace();
    }
  ...
  public void testAddParameter() throws Exception {
    final StringParameter newParameter = new StringParameter("rep1");
    Reference rr1 = protocol.addParameter(r, newParameter);
    assertEquals(newParameter, protocol.getParameter(rr1, 2));
  }

  @Test
  public void testDispatch() throws Exception {
    boolean sccess = protocol.dispatch(
