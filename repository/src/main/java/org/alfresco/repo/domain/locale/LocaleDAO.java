...
public interface LocaleDAO {
    ...
    /**
     * @return the locale pair for the default locale. Although the <tt>Locale</tt> object will be
     *     populated, the ID will point to an instance that generically refers to the system's
     *     default locale i.e. the value returned can vary depending on the executing thread's
     *     default locale.
     */
