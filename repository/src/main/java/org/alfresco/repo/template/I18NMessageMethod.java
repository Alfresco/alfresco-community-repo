 ...
 *     <p>Returns an I18N message resolved for the current locale and specified message ID.
 *     <p>Usage: message(String id)
 */
public class I18NMessageMethod extends BaseTemplateProcessorExtension
