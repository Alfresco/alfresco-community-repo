...
public class SheepEntityResource
  implements
    EntityResourceAction.Read<Sheep>,
    EntityResourceAction.ReadById<Sheep>,
    EntityResourceAction.Update<Sheep>,
  ...
  @WebApiParameters(
    {
      ...
      @WebApiParam(
        name = "who",
        title = "Who",
        kind = ResourceParameter.KIND.HTTP_HEADER
      ),
      @WebApiParam(
        name = "body",
        title = "aintnobody",
