...
public abstract class VirtualSpringBeanExtension<E, T extends Trait>
        extends SpringBeanExtension<E, T> {
    ...
    public boolean isVirtualContextFolder(NodeRef nodeRef, ActualEnvironment environment) {
        ...
        boolean isFolder =
                environment.isSubClass(environment.getType(nodeRef), ContentModel.TYPE_FOLDER);
        boolean virtualContext =
                environment.hasAspect(nodeRef, VirtualContentModel.ASPECT_VIRTUAL_DOCUMENT);
