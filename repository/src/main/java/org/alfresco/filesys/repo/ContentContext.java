...
public class ContentContext extends AlfrescoContext {
  ...
  private Pattern renameShufflePattern = Pattern.compile(
  ...
  public void startFilesystem(DiskSharedDevice share)
    ...
    CoreServerConfigSection coreConfig = (CoreServerConfigSection) share
      .getConfiguration()
    ...
    if (getLockManager() != null) {
      ...
      m_lockManager.startLockManager(
        "OplockExpire_" + share.getName(),
        m_threadPool
      );
    }
