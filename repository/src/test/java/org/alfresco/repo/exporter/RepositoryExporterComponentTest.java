...
public class RepositoryExporterComponentTest extends BaseSpringTest {
  ...
  public void before() throws Exception {
    ...
    this.fileFolderService =
      (FileFolderService) applicationContext.getBean(
        ServiceRegistry.FILE_FOLDER_SERVICE.getLocalName()
      );
    this.repositoryService =
      (RepositoryExporterService) applicationContext.getBean(
  ...
  public void testRepositoryExport() {
    ...
    FileInfo container = fileFolderService.create(
      rootNode,
      "export",
    ...
    // Export stores
    RepositoryExportHandle[] handles = repositoryService.export(
