...
public class AddRatingTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role is able to post like rating to a document")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role is able to post like rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role is able to post like rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user is not able to post like rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user with Manager role is able to post stars rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Collaborator role is able to post stars rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role is able to post stars rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role is able to post stars rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.REGRESSION},
            executionType = ExecutionType.SANITY,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user is not able to post stars rating to a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    ...
    public void unknownRatingSchemeReturnsBadRequest() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"invalidRate\"}");
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that if nodeId provided cannot be rated 405 status code is returned")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.RATINGS},
            executionType = ExecutionType.SANITY,
            description = "Verify that manager is able to like a site")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    public void managerIsAbleToLikeASite() throws Exception {
        ...
        restClient.withCoreAPI().usingResource(folderModel).getRatings().assertNodeIsLiked();
    }
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.SANITY},
            executionType = ExecutionType.REGRESSION,
            description = "Verify that manager is able to rate a site")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    ...
    public void addRateUsingEmptyValueForId() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                // The message is shortened for comparison as there is a Java object id in the
                // message (random)
    ...
    public void addRateUsingEmptyValueForMyRating() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"likes\", \"myRating\":\"\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"fiveStar\", \"myRating\":\"\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    public void addRateUsingInvalidValueForMyRating() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"likes\", \"myRating\":\"skiped\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.NULL_LIKE_RATING));
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"fiveStar\", \"myRating\":\"string\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.NULL_FIVESTAR_RATING));
    ...
    public void addRateUsingBooleanValueForMyRating() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"fiveStar\", \"myRating\":\"true\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    public void addLikeUsingIntegerValueForMyRating() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"id\":\"likes\", \"myRating\":\"2\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    //    @Bug(id = "MNT-17375", description = "Won't Fix, the error message is not ideal and a
    // little cryptic but it does provide the reason i.e. ratingSchemeId is null.")
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.RATINGS},
            executionType = ExecutionType.REGRESSION,
    ...
    public void notProvideIdLikeFile() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(document)
                .addInvalidRating("{\"myRating\":\"true\"}");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
