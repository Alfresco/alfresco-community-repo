...
public interface RecordsManagementModel extends RecordsManagementCustomModel {
  ...
  QName ASPECT_CAVEAT_CONFIG_ROOT = QName.createQName(
    RM_URI,
    "caveatConfigRoot"
  );
  ...
  QName TYPE_RECORDS_MANAGEMENT_CONTAINER = QName.createQName(
    RM_URI,
  ...
  QName TYPE_UNFILED_RECORD_CONTAINER = QName.createQName(
    RM_URI,
    "unfiledRecordContainer"
  );

  // Unfiled record folder
  QName TYPE_UNFILED_RECORD_FOLDER = QName.createQName(
    RM_URI,
    "unfiledRecordFolder"
  );
  ...
  // Transfer container
  QName TYPE_TRANSFER_CONTAINER = QName.createQName(
    RM_URI,
    "transferContainer"
  );
  ...
  QName ASSOC_DISPOSITION_SCHEDULE = QName.createQName(
    RM_URI,
    "dispositionSchedule"
  );

  // Disposition definition type
  QName TYPE_DISPOSITION_SCHEDULE = QName.createQName(
    RM_URI,
    "dispositionSchedule"
  );
  QName PROP_DISPOSITION_AUTHORITY = QName.createQName(
    RM_URI,
    "dispositionAuthority"
  );
  QName PROP_DISPOSITION_INSTRUCTIONS = QName.createQName(
    RM_URI,
    "dispositionInstructions"
  );
  QName PROP_RECORD_LEVEL_DISPOSITION = QName.createQName(
    RM_URI,
    "recordLevelDisposition"
  );
  QName ASSOC_DISPOSITION_ACTION_DEFINITIONS = QName.createQName(
    RM_URI,
    "dispositionActionDefinitions"
  );

  // Disposition action type
  QName TYPE_DISPOSITION_ACTION_DEFINITION = QName.createQName(
    RM_URI,
    "dispositionActionDefinition"
  );
  QName PROP_DISPOSITION_ACTION_NAME = QName.createQName(
    RM_URI,
    "dispositionActionName"
  );
  QName PROP_DISPOSITION_DESCRIPTION = QName.createQName(
    RM_URI,
    "dispositionDescription"
  );
  QName PROP_DISPOSITION_PERIOD = QName.createQName(
    RM_URI,
    "dispositionPeriod"
  );
  QName PROP_DISPOSITION_PERIOD_PROPERTY = QName.createQName(
    RM_URI,
    "dispositionPeriodProperty"
  );
  QName PROP_DISPOSITION_EVENT = QName.createQName(RM_URI, "dispositionEvent");
  QName PROP_DISPOSITION_EVENT_COMBINATION = QName.createQName(
    RM_URI,
    "dispositionEventCombination"
  );
  QName PROP_COMBINE_DISPOSITION_STEP_CONDITIONS = QName.createQName(
    RM_URI,
    "combineDispositionStepConditions"
  );
  QName PROP_DISPOSITION_LOCATION = QName.createQName(
    RM_URI,
    "dispositionLocation"
  );
  QName PROP_DISPOSITION_ACTION_GHOST_ON_DESTROY = QName.createQName(
    RM_URI,
    "dispositionActionGhostOnDestroy"
  );
  ...
  QName ASPECT_COMMON_RECORD_DETAILS = QName.createQName(
    RM_URI,
    "commonRecordDetails"
  );
  ...
  QName ASPECT_RECORD_COMPONENT_ID = QName.createQName(
    RM_URI,
    "recordComponentIdentifier"
  );
  ...
  QName ASPECT_VITAL_RECORD_DEFINITION = QName.createQName(
    RM_URI,
    "vitalRecordDefinition"
  );
  QName PROP_VITAL_RECORD_INDICATOR = QName.createQName(
    RM_URI,
  ...
  QName ASPECT_DISPOSITION_LIFECYCLE = QName.createQName(
    RM_URI,
    "dispositionLifecycle"
  );
  QName ASSOC_NEXT_DISPOSITION_ACTION = QName.createQName(
    RM_URI,
    "nextDispositionAction"
  );
  QName ASSOC_DISPOSITION_ACTION_HISTORY = QName.createQName(
    RM_URI,
    "dispositionActionHistory"
  );

  // Disposition action type
  QName TYPE_DISPOSITION_ACTION = QName.createQName(
    RM_URI,
    "dispositionAction"
  );
  QName PROP_DISPOSITION_ACTION_ID = QName.createQName(
    RM_URI,
    "dispositionActionId"
  );
  QName PROP_DISPOSITION_ACTION = QName.createQName(
    RM_URI,
    "dispositionAction"
  );
  ...
  QName PROP_DISPOSITION_EVENTS_ELIGIBLE = QName.createQName(
    RM_URI,
    "dispositionEventsEligible"
  );
  QName PROP_DISPOSITION_ACTION_STARTED_AT = QName.createQName(
    RM_URI,
    "dispositionActionStartedAt"
  );
  QName PROP_DISPOSITION_ACTION_STARTED_BY = QName.createQName(
    RM_URI,
    "dispositionActionStartedBy"
  );
  QName PROP_DISPOSITION_ACTION_COMPLETED_AT = QName.createQName(
    RM_URI,
    "dispositionActionCompletedAt"
  );
  QName PROP_DISPOSITION_ACTION_COMPLETED_BY = QName.createQName(
    RM_URI,
    "dispositionActionCompletedBy"
  );
  ...
  QName PROP_EVENT_EXECUTION_NAME = QName.createQName(
    RM_URI,
    "eventExecutionName"
  );
  QName PROP_EVENT_EXECUTION_AUTOMATIC = QName.createQName(
    RM_URI,
    "eventExecutionAutomatic"
  );
  QName PROP_EVENT_EXECUTION_COMPLETE = QName.createQName(
    RM_URI,
    "eventExecutionComplete"
  );
  QName PROP_EVENT_EXECUTION_COMPLETED_BY = QName.createQName(
    RM_URI,
    "eventExecutionCompletedBy"
  );
  QName PROP_EVENT_EXECUTION_COMPLETED_AT = QName.createQName(
    RM_URI,
    "eventExecutionCompletedAt"
  );
  ...
  QName ASPECT_FILE_PLAN_COMPONENT = QName.createQName(
    RM_URI,
    "filePlanComponent"
  );
  ...
  QName TYPE_NON_ELECTRONIC_DOCUMENT = QName.createQName(
    RM_URI,
    "nonElectronicDocument"
  );

  // Records management root aspect
  QName ASPECT_RECORDS_MANAGEMENT_ROOT = QName.createQName(
    RM_URI,
    "recordsManagementRoot"
  );
  ...
  QName PROP_TRANSFER_ACCESSION_INDICATOR = QName.createQName(
    RM_URI,
    "transferAccessionIndicator"
  );
  QName PROP_TRANSFER_PDF_INDICATOR = QName.createQName(
    RM_URI,
  ...
  QName ASPECT_UNPUBLISHED_UPDATE = QName.createQName(
    RM_URI,
    "unpublishedUpdate"
  );
  QName PROP_UNPUBLISHED_UPDATE = QName.createQName(
    RM_URI,
    "unpublishedUpdate"
  );
  QName PROP_UPDATE_TO = QName.createQName(RM_URI, "updateTo");
  QName PROP_UPDATED_PROPERTIES = QName.createQName(
    RM_URI,
    "updatedProperties"
  );
  QName PROP_PUBLISH_IN_PROGRESS = QName.createQName(
    RM_URI,
    "publishInProgress"
  );
  String UPDATE_TO_DISPOSITION_ACTION_DEFINITION =
    "dispositionActionDefinition";
  ...
  QName PROP_RS_DISPOSITION_ACTION_NAME = QName.createQName(
    RM_URI,
    "recordSearchDispositionActionName"
  );
  QName PROP_RS_DISPOSITION_ACTION_AS_OF = QName.createQName(
    RM_URI,
    "recordSearchDispositionActionAsOf"
  );
  QName PROP_RS_DISPOSITION_EVENTS_ELIGIBLE = QName.createQName(
    RM_URI,
    "recordSearchDispositionEventsEligible"
  );
  QName PROP_RS_DISPOSITION_EVENTS = QName.createQName(
    RM_URI,
    "recordSearchDispositionEvents"
  );
  QName PROP_RS_VITAL_RECORD_REVIEW_PERIOD = QName.createQName(
    RM_URI,
    "recordSearchVitalRecordReviewPeriod"
  );
  QName PROP_RS_VITAL_RECORD_REVIEW_PERIOD_EXPRESSION = QName.createQName(
    RM_URI,
    "recordSearchVitalRecordReviewPeriodExpression"
  );
  QName PROP_RS_DISPOSITION_PERIOD = QName.createQName(
    RM_URI,
    "recordSearchDispositionPeriod"
  );
  QName PROP_RS_DISPOSITION_PERIOD_EXPRESSION = QName.createQName(
    RM_URI,
    "recordSearchDispositionPeriodExpression"
  );
  QName PROP_RS_HAS_DISPOITION_SCHEDULE = QName.createQName(
    RM_URI,
    "recordSearchHasDispositionSchedule"
  );
  QName PROP_RS_DISPOITION_INSTRUCTIONS = QName.createQName(
    RM_URI,
    "recordSearchDispositionInstructions"
  );
  QName PROP_RS_DISPOITION_AUTHORITY = QName.createQName(
    RM_URI,
    "recordSearchDispositionAuthority"
  );
  QName PROP_RS_DECLASSIFICATION_REVIEW_COMPLETED_AT = QName.createQName(
    RM_URI,
    "declassificationReviewCompletedAt"
  );
  QName PROP_RS_DECLASSIFICATION_REVIEW_COMPLETED_BY = QName.createQName(
    RM_URI,
    "declassificationReviewCompletedBy"
  );

  /** @depreacted as of 2.2, because disposable items can now be in multiple holds */
  @Deprecated
  QName PROP_RS_HOLD_REASON = QName.createQName(
    RM_URI,
    "recordSearchHoldReason"
  );

  // Loaded Data Set Ids
  QName ASPECT_LOADED_DATA_SET_ID = QName.createQName(
    RM_URI,
    "loadedDataSetId"
  );
  QName PROP_LOADED_DATA_SET_IDS = QName.createQName(
    RM_URI,
    "loadedDataSetIds"
  );
  ...
  @Deprecated
  QName ASPECT_EXTENDED_SECURITY = QName.createQName(
    RM_URI,
    "extendedSecurity"
  );
  ...
  QName ASPECT_RECORD_ORIGINATING_DETAILS = QName.createQName(
    RM_URI,
    "recordOriginatingDetails"
  );
  QName PROP_RECORD_ORIGINATING_USER_ID = QName.createQName(
    RM_URI,
    "recordOriginatingUserId"
  );
  QName PROP_RECORD_ORIGINATING_CREATION_DATE = QName.createQName(
    RM_URI,
    "recordOriginatingCreationDate"
  );
  QName PROP_RECORD_ORIGINATING_LOCATION = QName.createQName(
    RM_URI,
    "recordOriginatingLocation"
  );

  // Rejection details of a record
  QName ASPECT_RECORD_REJECTION_DETAILS = QName.createQName(
    RM_URI,
    "recordRejectionDetails"
  );
  QName PROP_RECORD_REJECTION_USER_ID = QName.createQName(
    RM_URI,
    "recordRejectionUserId"
  );
  QName PROP_RECORD_REJECTION_DATE = QName.createQName(
    RM_URI,
    "recordRejectionDate"
  );
  QName PROP_RECORD_REJECTION_REASON = QName.createQName(
    RM_URI,
  ...
  QName PROP_HELD_CHILDREN_COUNT = QName.createQName(
    RM_URI,
    "heldChildrenCount"
  );
  ...
  QName ASPECT_DISPOSITION_PROCESSED = QName.createQName(
    RM_URI,
    "dispositionProcessed"
  );
}
