...
public class AddFailedThumbnailActionExecuter
  ...
  private static Log log = LogFactory.getLog(
    AddFailedThumbnailActionExecuter.class
  );
      ...
      RunAsWork<Void> runAsWork = new RunAsWork<Void>() {
        ...
        public Void doWork() throws Exception {
          ...
          if (nodeExists) {
            ...
            final String thumbDefName = (String) paramValues.get(
              PARAM_THUMBNAIL_DEFINITION_NAME
            );
            final Date failureDateTime = (Date) paramValues.get(
              PARAM_FAILURE_DATETIME
            );

            final QName thumbDefQName = QName.createQName(
              NamespaceService.CONTENT_MODEL_1_0_URI,
              thumbDefName
            );

            NodeRef existingThumbnail = thumbnailService.getThumbnailByName(
              actionedUponNodeRef,
            ...
            if (log.isDebugEnabled()) {
              ...
              msg
                .append("  failed thumbnail definition is ")
                .append(thumbDefName);
              log.debug(msg.toString());
            ...
            List<ChildAssociationRef> failedChildren = nodeService.getChildAssocs(
              actionedUponNodeRef,
              ContentModel.ASSOC_FAILED_THUMBNAIL,
              thumbDefQName
            );
            NodeRef childNode = failedChildren.isEmpty()
              ? null
            ...
            if (childNode == null) {
              ...
              try {
                ...
                NodeRef thumbnailNodeRef = nodeService
                  .createNode(
                    actionedUponNodeRef,
                    ContentModel.ASSOC_FAILED_THUMBNAIL,
                    thumbDefQName,
              ...
              int currentFailureCount = (Integer) nodeService.getProperty(
                childNode,
