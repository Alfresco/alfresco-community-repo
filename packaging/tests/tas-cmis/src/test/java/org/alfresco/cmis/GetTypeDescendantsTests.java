...
public class GetTypeDescendantsTests extends CmisTest {
    ...
    /**
     * Get type descendants for a valid type id and includePropertyDefinitions set to true and depth
     * set to -1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    ...
    @TestRail(
            ...
            description =
                    "Verify admin can get type descendantes for valid type id and"
                            + " includePropertyDefinitions = true  and depth = -1")
    public void adminShouldGetTypeDescendantsValidInputCase1() {
        cmisApi.usingObjectType(BaseTypeId.CMIS_DOCUMENT.value())
                ...
                .hasDescendantType(-1, "D:cm:dictionaryModel", "D:trx:transferLock");
    }
    ...
    /**
     * Get type descendants for a valid type id and includePropertyDefinitions set to false and
     * depth set to 1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @Test(groups = {TestGroup.CMIS, TestGroup.REGRESSION})
    @TestRail(
            section = {"cmis-api"},
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin can get type descendants for valid type id and"
                            + " includePropertyDefinitions = false  and depth = 1")
    ...
    /**
     * Get type descendantes for a valid type id and includePropertyDefinitions set to false and
     * depth set to -1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @Test(groups = {TestGroup.CMIS, TestGroup.REGRESSION})
    @TestRail(
    ...
    /**
     * Get type descendantes for an invalid type id and includePropertyDefinitions set to false and
     * depth set to -1 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @Test(
            groups = {TestGroup.CMIS, TestGroup.REGRESSION},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin cannot get type descendantes for invalid type id and"
                            + " includePropertyDefinitions = false  and depth = -1")
    ...
    /**
     * Get type descendantes for a valid type id and includePropertyDefinitions set to false and
     * incorrect depth set to -2 (verify that Map<String, PropertyDefinition<?>> is not empty)
     */
    @Test(
            groups = {TestGroup.CMIS, TestGroup.REGRESSION},
    ...
    @TestRail(
            ...
            description =
                    "Verify admin can get type descendantes for valid type id and"
                            + " includePropertyDefinitions = false  and incorrect depth = -2")
    public void adminShouldGetTypeDescendantsValidTypeWithIncorrectDepth() {
        cmisApi.usingObjectType(BaseTypeId.CMIS_DOCUMENT.value())
                .withoutPropertyDefinitions()
                .hasDescendantType(-2, "D:cm:dictionaryModel", "D:trx:transferLock");
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify random user can get type descendantes for valid type id and"
                            + " includePropertyDefinitions = false  and depth = 1")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify deleted user cannot get type descendantes for valid type id and"
                            + " includePropertyDefinitions = false  and depth = 1")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify disabled user cannot get type descendantes for valid type id and"
                            + " includePropertyDefinitions = false  and depth = 1")
