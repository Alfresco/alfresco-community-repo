...
public class GetSiteContainersTests extends RestTest {
  ...
  public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteContainers()
    throws Exception {
  ...
  public void getContainersWithValidMaxItems() throws Exception {
    ...
    restClient
      ...
      .entriesListContains(
        "folderId",
        ContainerName.documentLibrary.toString()
      );
    restClient.assertStatusCodeIs(HttpStatus.OK);
  }
  ...
  public void getSiteContainersAndSkipFirst() throws Exception {
    restClient
      ...
      .entriesListDoesNotContain(
        "folderId",
        restSiteContainers.getEntries().get(0).onModel().getFolderId()
      )
      .and()
      .entriesListContains(
        "folderId",
        restSiteContainers.getEntries().get(1).onModel().getFolderId()
      );
    restClient.assertStatusCodeIs(HttpStatus.OK);
  }
