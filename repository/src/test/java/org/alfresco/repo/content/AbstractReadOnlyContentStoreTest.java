...
public abstract class AbstractReadOnlyContentStoreTest {
     ...
     *
     * <p>Usually tests will construct a static instance of the store to use throughout all the
     * tests.
     *
    ...
    /**
     * Helper to ensure that illegal content URLs are flagged for <b>getReader()</b> and
     * <b>exists()</b> requests.
     */
