...
public class RemoveSiteMemberTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify that site manager can delete site member and gets status code 204, 'No"
                            + " Content'")
        ...
        Utility.sleep(
                ...
                () ->
                        restClient
                                ...
                                .getSiteMembers()
                                .assertThat()
                                .entriesListDoesNotContain("id", testUserModel.getUsername()));
    ...
    @TestRail(
            ...
            description =
                    "Verify that site collaborator cannot delete site member and gets status code"
                            + " 403, 'Forbidden'")
        ...
        Utility.sleep(
                ...
                () ->
                        restClient
                                ...
                                .getSiteMembers()
                                .assertThat()
                                .entriesListContains("id", testUserModel.getUsername()));
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site contributor cannot delete site member and gets status code"
                            + " 403, 'Forbidden'")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site consumer cannot delete site member and gets status code 403,"
                            + " 'Forbidden'")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can NOT delete site member for an inexistent user and gets"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can NOT delete site member for a non site member and gets"
    ...
    public void managerIsNotAbleToDeleteNotSiteMember() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_ARGUMENT, "argument"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can NOT delete site member for an invalid site and gets"
                            + " status code 404, 'Not Found'")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    public void siteManagerIsAbleToDeleteSiteMemberWithManagerRole() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .deleteSiteMember(anothermanager);
        restClient.assertStatusCodeIs(HttpStatus.NO_CONTENT);
        ...
        Utility.sleep(
                ...
                () ->
                        restClient
                                ...
                                .getSiteMembers()
                                .assertThat()
                                .entriesListDoesNotContain("id", anothermanager.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager can delete site member using \"-me-\" in place of"
                            + " personId")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
        ...
        Utility.sleep(
                ...
                () ->
                        restClient
                                ...
                                .getSiteMembers()
                                .assertThat()
                                .entriesListDoesNotContain("id", manager.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site collaborator cannot delete a site member with Manager role"
                            + " and gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site contributor cannot delete site member with Manager role and"
                            + " gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site consumer cannot delete site member with Manager role and gets"
                            + " status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site collaborator cannot delete a site member with Contributor"
                            + " role and gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site contributor cannot delete site member with Contributor role"
                            + " and gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site consumer cannot delete site member with Contributor role and"
                            + " gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    public void siteManagerIsAbleToDeleteSiteMemberWithContributorRole() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .deleteSiteMember(contributorForDelete);
        restClient.assertStatusCodeIs(HttpStatus.NO_CONTENT);
                ...
                () ->
                        restClient
                                ...
                                .entriesListDoesNotContain(
                                        "id", contributorForDelete.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site collaborator cannot delete a site member with Collaborator"
                            + " role and gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site contributor cannot delete site member with Collaborator role"
                            + " and gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site consumer cannot delete site member with Collaborator role and"
                            + " gets status code 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    public void siteManagerIsAbleToDeleteSiteMemberWithCollaboratorRole() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .deleteSiteMember(collaboratorForDelete);
        restClient.assertStatusCodeIs(HttpStatus.NO_CONTENT);
        ...
        Utility.sleep(
                ...
                () ->
                        restClient
                                ...
                                .assertThat()
                                .entriesListDoesNotContain(
                                        "id", collaboratorForDelete.getUsername()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete a site member with Contributor role and gets"
                            + " status code 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete site member with Manager role and gets status"
                            + " code 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete site member with Consumer role and gets status"
                            + " code 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete a site member with Collaborator role and gets"
                            + " status code 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete a site member of moderated site and gets status"
                            + " code 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can delete a site member of private site and gets status"
                            + " code 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.SITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin can not delete a site member twice and gets status code 404"
    ...
    public void adminIsNotAbleToRemoveFromSiteANonExistingMember() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingAuthUser()
                .addSiteMembershipRequest(publicSiteModel);
