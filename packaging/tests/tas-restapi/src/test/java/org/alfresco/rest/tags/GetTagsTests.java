...
public class GetTagsTests extends TagsDataPrep {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role gets tags using REST API and status code is OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role gets tags using REST API and status code is"
                            + " OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets tags using REST API and status code is"
                            + " OK (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets tags using REST API and status code is OK"
                            + " (200)")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Failed authentication get tags call returns status code 401 with Manager role")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site Manager is able to get tags using properties parameter."
    ...
    public void useSkipCountCheckPagination() throws Exception {
        ...
        RestTagModelsCollection tagsWithSkipCount =
                restClient.withParams("skipCount=2").withCoreAPI().getTags();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    public void useMaxItemsParameterCheckPagination() throws Exception {
        ...
        RestTagModel firstTag = returnedCollection.getEntries().get(0).onModel();
        RestTagModel secondTag = returnedCollection.getEntries().get(1).onModel();
        RestTagModelsCollection tagsWithMaxItems =
                restClient.withParams("maxItems=2").withCoreAPI().getTags();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "With manager get tags and use high skipCount parameter. Check pagination")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "With Collaborator user get tags and use maxItems with value zero. Check"
                            + " default error model schema")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
