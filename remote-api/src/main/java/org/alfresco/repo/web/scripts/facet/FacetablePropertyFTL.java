 ...
 * 
 * @param <T>a
 *            type to ensure that the comparator is implemented in a typesafe way.
 * @since 5.0
 */
public abstract class FacetablePropertyFTL<T> implements Comparable<T>
{
    ...
    /**
     * This class represents a facetable property, which is not actually an Alfresco content property, but is closely associated with one. Examples are the {@code size} and {@code MIME type} fields within the {@code cm:content} property type.
     */
    public static class SyntheticFacetablePropertyFTL extends FacetablePropertyFTL<SyntheticFacetablePropertyFTL>
    {
        ...
        /**
         * @param containingPropDef
         *            The {@link PropertyDefinition}.
         * @param localisedTitle
         *            The localised title of this synthetic property e.g. "taille".
         * @param syntheticPropertyName
         *            The synthetic property name e.g. "size".
         * @param datatype
    ...
    /**
     * This class represents a hard-coded facetable pseudo-property. It is not an Alfresco property and yet it is something that Alfresco and SOLR can use for facetting. Examples are the {@code TAG} and {@code SITE} facets.
     */
    ...
    /**
     * In order to give deterministic responses when getting facetable properties, all {@link FacetablePropertyFTL} instances are sorted. This comparator provides the sorting implementation.
     */
    public static class FacetablePropertyFTLComparator implements Comparator<FacetablePropertyFTL<?>>
    {
        ...
        public int compare(FacetablePropertyFTL left, FacetablePropertyFTL right)
        {
            ...
            {
                return typeOrder.indexOf(left.getClass()) -
