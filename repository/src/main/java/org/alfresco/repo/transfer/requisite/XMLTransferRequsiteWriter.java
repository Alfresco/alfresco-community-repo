 ...
 *
 * <p>XMLTransferRequsiteWriter is a statefull object used for writing out a single transfer
 * requsite file in XML format to the writer passed in via startTransferRequsite.
 *
 * @author Mark Rogers
 */
    ...
    public void startTransferRequsite() {
        try {
            ...
            this.writer.startElement(
                    ...
                    PREFIX + ":" + RequsiteModel.LOCALNAME_TRANSFER_REQUSITE,
                    EMPTY_ATTRIBUTES);
