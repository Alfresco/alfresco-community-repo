...
public class Api implements Comparable<Api> {
  ...
  public static final Api ALFRESCO_PUBLIC = new Api(
    "alfresco",
    SCOPE.PUBLIC,
    1
  );
   ...
   * @return Api
   */
  public static Api valueOf(String apiName, String apiScope, String apiVersion)
    ...
    try {
      if (
        !StringUtils.isAllLowerCase(apiName)
      ...
      logger.debug(
        "Invalid API definition: " + apiName + " " + apiScope + " " + apiVersion
      );
      throw new InvalidArgumentException(
        "Invalid API definition:" + error.getMessage()
      );
    }
