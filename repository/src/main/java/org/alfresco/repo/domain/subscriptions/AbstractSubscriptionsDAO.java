...
public abstract class AbstractSubscriptionsDAO implements SubscriptionsDAO {
    ...
    @Override
    public abstract PagingSubscriptionResults selectSubscriptions(
    ...
    @Override
    public abstract PagingFollowingResults selectFollowers(
            String userId, PagingRequest pagingRequest);
