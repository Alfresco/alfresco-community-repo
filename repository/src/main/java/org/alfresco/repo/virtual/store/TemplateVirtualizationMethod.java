...
public abstract class TemplateVirtualizationMethod
  ...
  protected Reference newVirtualReference(
    ...
    if (!templateName.isEmpty()) {
      ...
      throw new VirtualizationException(
        "Invalid virtualization : missing template name for " +
        templateSystemPath
      );
    }
  }
   ...
   *             plain encoded references
   */
  private String retrieveTemplateContentName(
    ActualEnvironment env,
    String sysPath
  ) throws ActualEnvironmentException {
  ...
  private String retrieveTemplateContentName(
    ...
    String templateName = (String) env.getProperty(
      templateRef,
  ...
  private final Protocol protocolFormName(String name)
    throws VirtualizationException {
