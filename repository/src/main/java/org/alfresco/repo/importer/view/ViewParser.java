...
public class ViewParser implements Parser {
    ...
    private static final QName VIEW_METADATA =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "metadata");
    private static final QName VIEW_VALUE_QNAME =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "value");
    private static final QName VIEW_VALUES_QNAME =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "values");
    private static final QName VIEW_ASPECTS =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "aspects");
    private static final QName VIEW_PROPERTIES =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "properties");
    private static final QName VIEW_ASSOCIATIONS =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "associations");
    private static final QName VIEW_ACL =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "acl");
    private static final QName VIEW_ACE =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "ace");
    private static final QName VIEW_AUTHORITY =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "authority");
    private static final QName VIEW_PERMISSION =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "permission");
    private static final QName VIEW_REFERENCE =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "reference");
    private static final QName VIEW_ML_VALUE =
            QName.createQName(NamespaceService.REPOSITORY_VIEW_1_0_URI, "mlvalue");
        ...
        try {
            ...
            try {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug(
                            "Failed to import package at line "
                                    + xpp.getLineNumber()
                                    + "; column "
                                    + xpp.getColumnNumber()
                                    + " due to error: ",
    ...
    private void processStartElement(XmlPullParser xpp, ParserContext parserContext)
        ...
        if (defName.equals(VIEW_METADATA)) {
            MetaDataContext metaDataContext =
                    new MetaDataContext(defName, (ElementContext) element);
            parserContext.elementStack.push(metaDataContext);

            if (logger.isDebugEnabled())
                logger.debug(
                        indentLog(
                                "Pushed " + metaDataContext,
                                parserContext.elementStack.size() - 1));
        } else if (defName.equals(VIEW_ASPECTS)
                || defName.equals(VIEW_PROPERTIES)
                || defName.equals(VIEW_ASSOCIATIONS)
                || defName.equals(VIEW_ACL)) {
            ...
            if (!(element instanceof NodeContext)) {
                throw new ImporterException(
                        "Element " + defName + " can only be declared within a node");
            }
            ...
            if (element instanceof MetaDataContext) {
                ...
                if (defName.equals(VIEW_REFERENCE)) {
                    ...
                    if (typeDef == null) {
                        throw new ImporterException(
                                "Type "
                                        + defName
                                        + " has not been defined in the Repository dictionary");
                    }
                ...
                if (itemName.equals(VIEW_ASPECTS)) {
                    ...
                    AssociationDefinition def =
                            (AssociationDefinition) node.determineAssociation(defName);
                    if (def == null) {
                        throw new ImporterException(
                                "Association name "
                                        + defName
    ...
    private void processRoot(XmlPullParser xpp, ParserContext parserContext)
        ...
        ParentContext parent =
                new ParentContext(
                        getName(xpp), parserContext.dictionaryService, parserContext.importer);
    ...
    private void processMetaData(XmlPullParser xpp, QName metaDataName, ParserContext parserContext)
        ...
        if (eventType != XmlPullParser.END_TAG) {
            throw new ImporterException(
                    "Meta data element " + metaDataName + " is missing end tag");
        }
    ...
    private void processStartType(
            XmlPullParser xpp, TypeDefinition typeDef, ParserContext parserContext)
            throws XmlPullParserException, IOException {
        ...
        String childName =
                xpp.getAttributeValue(
                        NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_CHILD_NAME_ATTR);
        ...
        String importId =
                xpp.getAttributeValue(NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_ID_ATTR);
     ...
     * @throws IOException
     */
    private void processStartReference(
            XmlPullParser xpp, QName refName, ParserContext parserContext)
            throws XmlPullParserException, IOException {
        ParentContext parent = (ParentContext) parserContext.elementStack.peek();
        ...
        String idRefAttr =
                xpp.getAttributeValue(NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_IDREF_ATTR);
        String pathRefAttr =
                xpp.getAttributeValue(NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_PATHREF_ATTR);
        String nodeRefAttr =
                xpp.getAttributeValue(NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_NODEREF_ATTR);
        if ((idRefAttr != null && idRefAttr.length() > 0)
                && (pathRefAttr != null && pathRefAttr.length() > 0)
        ...
        if (logger.isDebugEnabled())
            logger.debug(
                    indentLog("Pushed Reference " + node, parserContext.elementStack.size() - 1));
    }
    ...
    private void processAspect(
            XmlPullParser xpp, AspectDefinition aspectDef, ParserContext parserContext)
            throws XmlPullParserException, IOException {
        ...
        if (logger.isDebugEnabled())
            logger.debug(
                    indentLog(
                            "Processed aspect " + aspectDef.getName(),
                            parserContext.elementStack.size()));
    }
    ...
    private void processACL(XmlPullParser xpp, ParserContext parserContext) {
        ...
        String strInherit =
                xpp.getAttributeValue(
                        NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_INHERIT_PERMISSIONS_ATTR);
        if (strInherit != null) {
    ...
    private void processAccessControlEntry(XmlPullParser xpp, ParserContext parserContext)
        ...
        String access =
                xpp.getAttributeValue(
                        NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_ACCESS_STATUS_ATTR);
        ...
        if (accessStatus == null) {
            throw new ImporterException(
                    "Permission access status '" + access + "' is not recognised.");
        }
        ...
        while (eventType != XmlPullParser.END_TAG) {
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (defName.equals(VIEW_AUTHORITY)) {
                    ...
                    if (eventType != XmlPullParser.TEXT) {
                        throw new ImporterException(
                                "Element " + VIEW_AUTHORITY + " must have a value");
                    }
                    ...
                    if (eventType != XmlPullParser.TEXT) {
                        throw new ImporterException(
                                "Element " + VIEW_PERMISSION + " must have a value");
                    }
    ...
    private void processProperty(XmlPullParser xpp, QName propertyName, ParserContext parserContext)
        ...
        propertyName =
                QName.createQName(
                        ...
                        ISO9075.decode(propertyName.getLocalName()));
        ...
        if (eventType == XmlPullParser.END_TAG) {
            ...
            if (isMLProperty) {
                ...
                String locale = "";
                node.addDatatype(
                        propertyName, dictionaryService.getDataType(DataTypeDefinition.MLTEXT));
                ...
                while (isMLProperty) {
                    ...
                    locale =
                            xpp.getAttributeValue(
                                    NamespaceService.REPOSITORY_VIEW_1_0_URI, VIEW_LOCALE_ATTR);
                    Boolean isNull =
                            Boolean.valueOf(
                                    xpp.getAttributeValue(
                    ...
                    if (eventType == XmlPullParser.END_TAG) {
                        ...
                        mlText.addValue(
                                DefaultTypeConverter.INSTANCE.convert(Locale.class, locale),
                                decoratedValue);
            ...
            while (eventType == XmlPullParser.START_TAG) {
                ...
                if (!name.equals(VIEW_VALUE_QNAME)) {
                    throw new ImporterException(
                            "Invalid view structure - expected element "
                                    + VIEW_VALUE_QNAME
                                    + " for property "
                                    + propertyName);
                }
            ...
            if (eventType != XmlPullParser.END_TAG) {
                throw new ImporterException(
                        "Invalid view structure - property "
                                + propertyName
        ...
        if (logger.isDebugEnabled())
            logger.debug(
                    indentLog(
                            "Processed property " + propertyName,
                            parserContext.elementStack.size()));
    }
     ...
     * @throws IOException
     */
    private void processStartAssoc(
            XmlPullParser xpp, AssociationDefinition assocDef, ParserContext parserContext)
            throws XmlPullParserException, IOException {
        NodeContext node = peekNodeContext(parserContext.elementStack);
     ...
     */
    private void createImportReference(
            ParserContext parserContext, String importId, NodeRef nodeRef) {
