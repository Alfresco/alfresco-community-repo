...
public class GetSitesMembershipInformationCoreTests extends RestTest {
  ...
  public void dataPreparation() throws DataPreparationException {
    ...
    moderatedSiteModel =
      dataSite.usingUser(userModel).createModeratedRandomSite();
  ...
  public void siteManagerCantRetrieveSiteMembershipInformationForAPersonIdThatDoesNotExist()
    ...
    restClient
      ...
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "invalidPersonId")
      )
  ...
  public void siteManagerCheckThatModeratedSitesAreRetrieved()
    throws Exception {
    restClient
      .authenticateUser(userModel)
      .withCoreAPI()
