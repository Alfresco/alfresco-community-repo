...
public class AddSiteMembershipRequestTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to create new site membership request for himself"
    ...
    public void managerCreatesNewSiteMembershipRequestForSelf() throws Exception {
        siteMembershipRequest =
                restClient
                        ...
                        .withCoreAPI()
                        .usingAuthUser()
                        .addSiteMembershipRequest(anotherPublicSite);
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        siteMembershipRequest
                .assertThat()
                .field("id")
                .is(anotherPublicSite.getId())
                .assertThat()
                .field("site")
                .isNotEmpty();
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify site contributor is able to create new site membership request for"
                            + " himself and status code is 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to create new site membership request for"
                            + " himself and status code is 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is able to create new site membership request for himself"
                            + " and status code is 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to create new site membership request for himself and"
                            + " status code is 201")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user is not able to create new site membership request")
    public void unauthenticatedUserIsNotAbleToCreateSiteMembershipRequest() throws Exception {
        restClient
                .authenticateUser(new UserModel("random user", "random password"))
                .withCoreAPI()
                .usingAuthUser()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify addSiteMembershipRequest Rest API status code is 400 for a user that"
                            + " has already been invited")
    public void addSiteMembershipRequestStatusCodeIs400ReceivedForAUserThatIsAlreadyInvited()
            throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.ALREADY_Site_MEMBER,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify addSiteMembershipRequest Rest API status code is 404 for a user that"
                            + " does not exist")
    public void addSiteMembershipRequestStatusCodeIs404ReceivedForAUserThatDoesNotExist()
            throws Exception {
        UserModel newMember = dataUser.createRandomTestUser();
        restClient
                .authenticateUser(newMember)
                .withCoreAPI()
                .usingUser(new UserModel("invalidUser", "password"))
                .addSiteMembershipRequest(moderatedSite);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify addSiteMembershipRequest Rest API status code is 404 for a site that"
                            + " does not exist")
    public void addSiteMembershipRequestStatusCodeIs404ReceivedForASiteThatDoesNotExist()
            throws Exception {
        UserModel newMember = dataUser.createRandomTestUser();
        restClient
                .authenticateUser(newMember)
                .withCoreAPI()
                .usingMe()
                .addSiteMembershipRequest(new SiteModel("invalidSiteID"));
        restClient.assertStatusCodeIs(HttpStatus.NOT_FOUND);
        restClient
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify addSiteMembershipRequest Rest API status code is 400 for empty request"
                            + " body")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify addSiteMembershipRequest Rest API status code is 201 for request with"
                            + " empty message")
    public void addSiteMembershipRequestStatusCodeIs201ForRequestWithEmptyMessage()
            throws Exception {
        UserModel newMember = dataUser.createRandomTestUser();
        siteMembershipRequest =
                restClient
                        ...
                        .withCoreAPI()
                        .usingMe()
                        .addSiteMembershipRequest("", moderatedSite, "New request");
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        siteMembershipRequest
                .assertThat()
                .field("id")
    ...
    public void addSiteMembershipRequestStatusCodeIs201ForRequestWithEmptyTitle() throws Exception {
        ...
        siteMembershipRequest =
                restClient
                        ...
                        .withCoreAPI()
                        .usingMe()
                        .addSiteMembershipRequest("Please accept me", moderatedSite, "");
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        siteMembershipRequest
                .assertThat()
                .field("id")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to create new site membership request for"
                            + " other user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is not able to create new site membership request for"
                            + " other user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to create new site membership request for"
                            + " other user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is not able to create new site membership request for"
                            + " other user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user is not able to create new site membership request for other"
                            + " user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify addSiteMembershipRequest Rest API status code is 400 for an invalid"
                            + " user id")
    public void addSiteMembershipRequestReturns400ForEmptyUserId() throws Exception {
        restClient
                .authenticateUser(adminUser)
                .withCoreAPI()
                .usingUser(new UserModel("", "password"))
                .addSiteMembershipRequest(publicSite);
        restClient.assertStatusCodeIs(HttpStatus.BAD_REQUEST);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is able to create new public site membership request for"
                            + " himself. Check that user joins immediately as consumer.")
    public void userIsAbleToRequestMembershipOfPublicSite() throws Exception {
        ...
        siteMembershipRequest
                ...
                .field("site")
                .isNotEmpty();
        RestSiteEntry siteEntry =
                restClient.withCoreAPI().usingAuthUser().getSiteMembership(publicSite);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        siteEntry
                .assertThat()
                .field("role")
                .is(UserRole.SiteConsumer)
                .and()
                .field("id")
                .is(publicSite.getId());
        siteMembershipRequests =
                restClient.withCoreAPI().usingAuthUser().getSiteMembershipRequests();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is able to create new moderated site membership request"
                            + " for himself. Check that the request is added to the site membership"
                            + " request list.")
    public void userIsAbleToRequestMembershipOfModeratedSite() throws Exception {
        ...
        siteMembershipRequests
                .assertThat()
                .entriesListContains("id", moderatedSite.getId())
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is not able to request membership of a private site.")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify regular user is not able to create new site membership request for"
                            + " other user")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify create public site membership request returns status code 400 when the"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify create moderated site membership request returns status code 400 when"
    ...
    public void userRequestsTwiceMembershipOfModeratedSite() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.ALREADY_INVITED,
                                regularUser.getUsername(),
                                moderatedSite.getId()));
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify create private site membership request returns status code 404 when"
                            + " request is made with the user who created the site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to create new moderated site membership request for"
                        + " himself. Check that the request is added to the site membership request"
                        + " list.")
    public void adminIsAbleToRequestMembershipOfModeratedSite() throws Exception {
        regularUser = dataUser.createRandomTestUser();
        SiteModel anotherModeratedSite =
                dataSite.usingUser(regularUser).createModeratedRandomSite();
        siteMembershipRequest =
                restClient
                        .authenticateUser(adminUser)
                        .withCoreAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site membership request is automatically rejected when a site is"
                            + " switched from moderated to private")
    public void siteMembershipRequestIsRejectedWhenSiteIsSwitchedFromModeratedToPrivate()
            throws Exception {
        regularUser = dataUser.createRandomTestUser();
        SiteModel moderatedThenPrivateSite =
                dataSite.usingUser(adminUser).createModeratedRandomSite();
        siteMembershipRequest =
                restClient
                        .authenticateUser(regularUser)
                        .withCoreAPI()
                        .usingMe()
                        .addSiteMembershipRequest(moderatedThenPrivateSite);
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        siteMembershipRequest
                .assertThat()
                .field("id")
                .is(moderatedThenPrivateSite.getId())
                .assertThat()
                .field("site")
                .isNotEmpty();

        dataSite.usingUser(adminUser)
                .updateSiteVisibility(moderatedThenPrivateSite, SiteService.Visibility.PRIVATE);
