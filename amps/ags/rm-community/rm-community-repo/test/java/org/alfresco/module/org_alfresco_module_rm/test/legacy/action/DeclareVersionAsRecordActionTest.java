    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest(dmContributor) {
        ...
        public void given() {
          ...
          ruleFile =
            fileFolderService
              .create(documentLibrary, "mytestfile", ContentModel.TYPE_CONTENT)
              .getNodeRef();

          Action action = actionService.createAction(
            DeclareAsVersionRecordAction.NAME
          );
        ...
        public void then() throws Exception {
          NodeRef recordedVersionNodeRef = (NodeRef) recordedVersion
            .getVersionProperties()
            .get(RecordableVersionModel.PROP_RECORD_NODE_REF.getLocalName());
          assertNotNull(
            "Recorded version shouldn't be null.",
