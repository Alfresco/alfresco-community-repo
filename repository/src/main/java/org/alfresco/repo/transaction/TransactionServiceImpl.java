...
public class TransactionServiceImpl implements TransactionService {
  ...
  private static VmShutdownListener shutdownListener = new VmShutdownListener(
    "TransactionService"
  );
  ...
  private final QName generalVetoName = QName.createQName(
  ...
  public void setAllowWrite(boolean allowWrite, QName nameOfVeto) {
    if (logger.isDebugEnabled()) {
      logger.debug(
        "setAllowWrite:" + allowWrite + ". Name of veto:" + nameOfVeto
      );
    }
    vetoWriteLock.lock();
    try {
