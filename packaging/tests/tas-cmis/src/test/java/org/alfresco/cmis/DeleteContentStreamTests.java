...
public class DeleteContentStreamTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to delete content of a not empty document in"
    ...
    @TestRail(
            ...
            description =
                    "Verify user is not able to delete content of a nonexistent document in"
                            + " DocumentLibrary with CMIS")
    @Test(
    ...
    public void userCantDeleteContentFromNonexistentFile() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager).usingResource(testFile).deleteContent();
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete content of a empty document in"
                            + " DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify nonexistent user is not able to delete content of a document with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete content of a not empty document with"
                            + " refresh set to TRUE with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to delete content of a not empty document with"
                            + " refresh set to FALSE with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to delete content of a not empty document created by"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete content of a not empty document created"
                            + " by other user in DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to delete content of a not empty document"
                            + " created by other user in DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            description =
                    "Verify site collaborator is able to delete content of a not empty document"
                            + " created by self in DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to delete content of a not empty document"
                            + " created by other user in DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to delete content of a not empty document"
                            + " created by self in DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is not able to delete content of a not empty document in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to delete content of a checked out file with"
                            + " CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized user is not able to delete content of a file created in a"
