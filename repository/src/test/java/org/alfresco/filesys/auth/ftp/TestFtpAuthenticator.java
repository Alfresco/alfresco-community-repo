...
/**
 * Test FTP Authenticator class. Will be created as several beans in test auth context. Will authenticate the user as the flag {@link TestFtpAuthenticator#authenticateAs} is set, default is true.
 *
 * @author alex.mukha
 * @since 4.2.1
 */
