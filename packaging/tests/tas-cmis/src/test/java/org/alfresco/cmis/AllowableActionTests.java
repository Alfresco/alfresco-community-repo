...
public class AllowableActionTests extends CmisTest {
    ...
    public void verifyValidDocumentHasAllowableActionCanCheckOut() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .assertThat()
                .hasAllowableActions(Action.CAN_CHECK_OUT)
                .then()
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify valid folder has allowable action CAN_GET_CHILDREN, CAN_CREATE_FOLDER")
    @Test(groups = {TestGroup.SANITY, TestGroup.CMIS})
    public void verifyValidFolderHasAllowableAction() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .assertThat()
                .hasAllowableActions(Action.CAN_GET_CHILDREN, Action.CAN_CREATE_FOLDER);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify pwc document has allowable action CAN_CHECK_IN, CAN_CANCEL_CHECK_OUT"
                            + " and CAN_MOVE_OBJECT")
    ...
    public void verifyPWCDocumentHasAllowable() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .assertThat()
                .hasAllowableActions(
                        Action.CAN_CHECK_IN, Action.CAN_MOVE_OBJECT, Action.CAN_CANCEL_CHECK_OUT)
                .and()
                .assertThat()
                .isAllowableActionInList(
                        Action.CAN_CHECK_IN,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify valid folder does not have allowable action CAN_CHECK_IN,"
                            + " CAN_CHECK_OUT, CAN_CANCEL_CHECK_OUT")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void verifyFolderDoesNotHaveCanCheckInAction() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .doesNotHaveAllowableActions(
                        Action.CAN_CHECK_IN, Action.CAN_CHECK_OUT, Action.CAN_CANCEL_CHECK_OUT);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify checked out document does not have allowable action CAN_CHECK_IN,"
    ...
    public void verifyCheckedOutDocumentHasAllowable() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .and()
                .assertThat()
                .doesNotHaveAllowableActions(Action.CAN_CHECK_IN, Action.CAN_CANCEL_CHECK_OUT);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor can get allowable and not allowable actions for content"
                            + " created by mananger")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void contributorGetAllowableActionForContentCreatedByManager() throws Exception {
        cmisApi.authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteContributor))
                ...
                .assertThat()
                .doesNotHaveAllowableActions(
                        Action.CAN_DELETE_OBJECT, Action.CAN_DELETE_TREE, Action.CAN_MOVE_OBJECT)
                .assertThat()
                .isAllowableActionInList(
                        Action.CAN_GET_FOLDER_PARENT,
                        Action.CAN_GET_FOLDER_TREE,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator can get allowable and not allowable actions for content"
                            + " created by mananger")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void collaboratorGetAllowableActionForContentCreatedByManager() throws Exception {
        cmisApi.authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator))
                ...
                .assertThat()
                .doesNotHaveAllowableActions(Action.CAN_DELETE_OBJECT, Action.CAN_MOVE_OBJECT)
                .assertThat()
                .isAllowableActionInList(
                        Action.CAN_GET_PROPERTIES,
                        Action.CAN_GET_ACL,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer can get allowable and not allowable actions for content"
                            + " created by mananger")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void consumerGetAllowableActionForContentCreatedByManager() throws Exception {
        cmisApi.authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteConsumer))
                ...
                .assertThat()
                .doesNotHaveAllowableActions(
                        Action.CAN_DELETE_OBJECT, Action.CAN_MOVE_OBJECT, Action.CAN_CHECK_OUT)
                .assertThat()
                .isAllowableActionInList(
                        Action.CAN_GET_PROPERTIES,
                        Action.CAN_GET_ACL,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is not able to get allowable actions from private"
                            + " site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    public void nonInvitedUserOnPrivateSiteCannotGetAllowableActions() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .usingResource(testFile)
                .assertThat()
                .hasAllowableActions(Action.CAN_GET_PROPERTIES);
    }
