...
/**
 * An object that tracks the initialization and destruction of {@link PropertyBackedBean} instances.
 * A <code>PropertyBackedBean</code> should call {@link #register(PropertyBackedBean)} after
 * initialization and {@link #deregister(PropertyBackedBean, boolean)} when discarded. Other classes
 * may register for notification of these events by calling {@link
