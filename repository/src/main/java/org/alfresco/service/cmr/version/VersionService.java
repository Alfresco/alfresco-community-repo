...
public interface VersionService {
     ...
     *
     * <p>If the node has not previously been versioned then a version history and initial version
     * will be created.
     *
     * <p>If the node referenced does not or can not have the version aspect applied to it then an
     * exception will be raised.
     *
     * <p>The version properties are stored as version meta-data against the newly created version.
     *
     ...
     * @throws ReservedVersionNameException thrown if a reserved property name is used int he
     *     version properties provided
     ...
     * @param versionProperties the version properties that are stored with the newly created
     *     version
     * @param versionChildren if true then the children of the referenced node are also versioned,
     *     false otherwise
     ...
     * @throws ReservedVersionNameException thrown if a reserved property name is used in the
     *     version properties provided
     * @throws AspectMissingException thrown if the version aspect is missing
     */
    @Auditable(parameters = {"nodeRef", "versionProperties"})
     ...
     *
     * <p>If the node has not been versioned then null is returned.
     *
     * <p>If the node referenced does not or can not have the version aspect applied to it then an
     * exception will be raised.
     *
     ...
     *
     * <p>Returns <code>null</code> if the node is not versionable or has not been versioned.
     *
     ...
     *
     * <p>The node reference will be reverted to the current version.
     *
     * <p>A deep revert will be performed.
     *
     ...
     * Revert the state of the node to the current version.
     *
     * <p>The node will be reverted to the current version.
     *
     * @see VersionService#revert(NodeRef, Version, boolean)
     * @param nodeRef the node reference
     ...
     *
     * <p>A deep revert will take place by default.
     *
     * @see VersionService#revert(NodeRef, Version, boolean)
     * @param nodeRef the node reference
     ...
     * Revert the state of the node to the specified version.
     *
     * <p>Any changes made to the node will be lost and the state of the node will reflect that of
     * the version specified.
     *
     * <p>The version label property on the node reference will remain unchanged.
     *
     * <p>If the node is further versioned then the new version will be created at the head of the
     * version history graph. A branch will not be created.
     *
     * <p>If a deep revert is to be performed then any child nodes that are no longer present will
     ...
     *
     * @see org.alfresco.service.cmr.version.VersionService#restore(NodeRef, NodeRef, QName, QName,
     *     boolean)
     ...
     *
     * <p>The restored node will be at the head (most resent version).
     *
     * <p>Restoration will fail if there is no version history for the specified node id in the
     * specified store.
     *
     * <p>If the node already exists in the store then an exception will be raised.
     *
     * <p>Once the node is restored it is reverted to the head version in the appropriate version
     * history tree. If deep is set to true then this will be a deep revert, false otherwise.
     *
     * @param nodeRef the node reference to a node that no longer exists in the store
     * @param parentNodeRef the new parent of the restored node
     * @param assocTypeQName the assoc type qname
     * @param assocQName the assoc qname
     * @param deep true is a deep revert should be performed once the node has been restored, false
     *     otherwise
     * @return the newly restored node reference
     */
     ...
     *
     * <p>This operation is permanent, all versions in the version history are deleted and cannot be
     * retrieved.
     *
     * <p>The current version label for the node reference is reset and any subsequent versions of
     * the node will result in a new version history being created.
     *
     * @param nodeRef the node reference
     * @throws AspectMissingException thrown if the version aspect is missing
     */
     ...
     *
     * <p>This operation is permanent, the specific version in the version history is deleted and
     * cannot be retrieved.
     *
     * <p>If this is the last version, then the current version label for the node reference is
     * reset and any subsequent versions of the node will result in a new version history being
     * created.
     *
     * @param nodeRef the node reference
    ...
    /**
     * Ensures that a node has the versionable aspect applied to it, and has at least an initial
     * entry in the version store. If any of these requirements are missing, then they will be
     * fixed.
     *
     * @param nodeRef the node reference
     * @param versionProperties the version properties to apply if versioning isn't currently
