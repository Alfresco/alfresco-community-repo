...
public interface QNameDAO
{
     ...
     *            the old namespace URI
     * @param newNamespaceUri
     *            the new namespace URI
     * @throws AlfrescoRuntimeException
     *             if the new namespace is in use
     */
     ...
     * 
     * @param qnameOld
     *            the old QName, which must exist
     * @param qnameNew
    ...
    /**
     * Bulk-convert QNames into QName IDs. This is primarily used for generating SQL <tt>IN</tt> clause lists for other DAO queries.
     * 
     * @param qnames
     *            the QNames to convert
     * @param create
     *            <tt>true</tt> to create any missing QName entities
