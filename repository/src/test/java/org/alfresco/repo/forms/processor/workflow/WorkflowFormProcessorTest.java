...
public class WorkflowFormProcessorTest extends FormProcessorTest {
    ...
    public void testGenerateDefaultForm() throws Exception {
        ...
        assertFalse(
                fieldDefs.contains(WorkflowModel.PROP_DUE_DATE.toPrefixString(namespaceService)));
        assertFalse(
                fieldDefs.contains(WorkflowModel.PROP_PRIORITY.toPrefixString(namespaceService)));
        assertFalse(
                fieldDefs.contains(WorkflowModel.PROP_TASK_ID.toPrefixString(namespaceService)));
    ...
    protected void setUp() throws Exception {
        ...
        super.processor =
                makeWorkflowFormProcessor(
                        dictionaryService, fieldProcessorRegistry, defaultProcessor);
    }
    ...
    private Map<QName, PropertyDefinition> makeTaskPropertyDefs() {
        ...
        MockClassAttributeDefinition priorityDef =
                MockClassAttributeDefinition.mockPropertyDefinition(PRIORITY_NAME, intType, "2");
        ...
        PropertyDefinition pckgAction =
                MockClassAttributeDefinition.mockPropertyDefinition(
                        pckgActionGroup, textType, "add_package_item_actions");
        ...
        PropertyDefinition pckgItemAction =
                MockClassAttributeDefinition.mockPropertyDefinition(
                        pckgItemActionGroup, textType, "start_package_item_actions");
    ...
    private WorkflowService makeWorkflowService() {
        ...
        newInstance =
                new WorkflowInstance(
                        instanceId, definition, null, null, null, null, true, null, null);
        WorkflowTask startTask =
                new WorkflowTask("foo$taskId", null, null, null, null, null, null, null);
