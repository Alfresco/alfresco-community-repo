 ...
 * @since 2.1
 */
public class RecordsManagementQueryDAOImplTest extends BaseRMTestCase
    ...
    protected void initServices() {
        ...
        queryDAO =
                (RecordsManagementQueryDAO) applicationContext.getBean("recordsManagementQueryDAO");
    }
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        String existingID =
                                (String) nodeService.getProperty(recordOne, PROP_IDENTIFIER);
    ...
    /**
     * Given a folder containing 3 files with distinct descriptions set When I get the children
     * property values Then the answer contains all distinct property values set
     */
    @org.junit.Test
        ...
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void when() throws Exception {
                        propertyValues =
                                queryDAO.getChildrenStringPropertyValues(
                                        parentFolder, PROP_DESCRIPTION);
                    }

                    @Override
                    public void then() throws Exception {
                        Set<String> expectedValues =
                                ImmutableSet.of(propValue1, propValue2, propValue3);
    ...
    /**
     * Given a folder containing 3 files only some have description set When I get the children
     * property values Then the answer contains only the descriptions set
     */
    @org.junit.Test
    ...
    /**
     * Given a folder containing 3 files with the descriptions unset When I get the children
     * property values Then empty list is returned
     */
    @org.junit.Test
    ...
    /**
     * Given a folder with no children but the property set on itself When get the children property
     * values Then the list is empty
     */
    @org.junit.Test
    public void testGetChildrenWithPropertyValues_noChildren() throws Exception {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest() {
                    ...
                    public void when() throws Exception {
                        propertyValues =
                                queryDAO.getChildrenStringPropertyValues(folder, PROP_DESCRIPTION);
                    }
    ...
    /**
     * Given a folder with children and an unused property When I get the property values for the
     * unused property Then empty list is returned
     */
    @org.junit.Test
                    ...
                    public void given() throws Exception {
                        ...
                        parentFolder =
                                fileFolderService
                                        ...
                                        .getNodeRef();
                        fileFolderService
                                .create(parentFolder, GUID.generate(), ContentModel.TYPE_FOLDER)
                                .getNodeRef();
                        fileFolderService
                                .create(parentFolder, GUID.generate(), ContentModel.TYPE_FOLDER)
                                .getNodeRef();
