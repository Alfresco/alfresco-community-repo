...
public class CMISMapping implements InitializingBean {
  ...
  public static String CMIS_EXT_URI =
    "http://www.alfresco.org/model/cmis/1.0/cs01ext";
   ...
   */
  public static QName CMIS_MODEL_QNAME = QName.createQName(
    CMIS_MODEL_URI,
    CMIS_MODEL_NAME
  );

  // CMIS Data Types
  public static QName CMIS_DATATYPE_ID = QName.createQName(
    CMIS_MODEL_URI,
    "id"
  );
  public static QName CMIS_DATATYPE_URI = QName.createQName(
    CMIS_MODEL_URI,
    "uri"
  );
  public static QName CMIS_DATATYPE_XML = QName.createQName(
    CMIS_MODEL_URI,
    "xml"
  );
  public static QName CMIS_DATATYPE_HTML = QName.createQName(
    CMIS_MODEL_URI,
    "html"
  );
  ...
  public static QName DOCUMENT_QNAME = QName.createQName(
    CMIS_MODEL_URI,
    "document"
  );
  public static QName FOLDER_QNAME = QName.createQName(
    CMIS_MODEL_URI,
    "folder"
  );
  public static QName RELATIONSHIP_QNAME = QName.createQName(
    CMIS_MODEL_URI,
    "relationship"
  );
  public static QName POLICY_QNAME = QName.createQName(
    CMIS_MODEL_URI,
    "policy"
  );
  public static QName SECONDARY_TYPES_QNAME = QName.createQName(
    CMIS_MODEL_URI,
    "secondary"
  ); // cmis 1.1
  public static QName ASPECTS_QNAME = QName.createQName(
    CMIS_EXT_URI,
    "aspects"
  ); // cmis 1.0
  ...
  public String getCmisTypeId(QName classQName) {
    ...
    if (
      cmisVersion.equals(CmisVersion.CMIS_1_1) &&
      isValidCmisSecondaryType(classQName)
    ) {
      return getCmisTypeId(BaseTypeId.CMIS_SECONDARY, classQName);
    }
    if (
      cmisVersion.equals(CmisVersion.CMIS_1_1) && isValidCmisItem(classQName)
    ) {
      return getCmisTypeId(BaseTypeId.CMIS_ITEM, classQName);
    }
    if (
      cmisVersion.equals(CmisVersion.CMIS_1_0) && isValidCmisPolicy(classQName)
    ) {
      return getCmisTypeId(BaseTypeId.CMIS_POLICY, classQName);
    }
  ...
  public boolean isValidCmisRelationship(QName associationQName) {
    ...
    if (
      !isValidCmisRelationshipEndPoint(
        associationDefinition.getTargetClass().getName()
      )
    ) {
      return false;
    }
    if (
      !isValidCmisRelationshipEndPoint(
        associationDefinition.getSourceClass().getName()
      )
    ) {
      return false;
    }
  ...
  public Collection<Pair<String, Boolean>> getReportedPermissions(
    String permission,
    ...
    ArrayList<Pair<String, Boolean>> answer = new ArrayList<Pair<String, Boolean>>(
      20
    );
    // indirect
