...
/**
 * A repository context in which a {@link NodeRefPathExpression} should resolve to a {@link NodeRef}
 * using a relative name or qname path.
 */
public interface NodeRefContext {
     ...
     * @param qNamePath
     * @param resolver
     * @return the {@link NodeRef} the given {@link QName} prefixed string path resolves to using
