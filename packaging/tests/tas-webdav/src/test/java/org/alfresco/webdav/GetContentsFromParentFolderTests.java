...
public class GetContentsFromParentFolderTests extends WebDavTest {
  ...
  public void siteManagerShouldGetContentsFromParent() throws Exception {
    ...
    webDavProtocol
      ...
      .usingResource(parentFolder)
      .assertThat()
      .hasChildren(subFolder1, subFolder2, subFile1, subFile2)
      .and()
      .assertThat()
      .hasFolders(subFolder1, subFolder2)
      .assertThat()
      .hasFiles(subFile1, subFile2)
      .then()
      .usingResource(subFolder1)
      .assertThat()
      .hasChildren(subFolder3, subFile3)
      .and()
      .assertThat()
      .hasFolders(subFolder3)
      .assertThat()
      .hasFiles(subFile3)
      .then()
      .usingSite(testSite)
      .assertThat()
      .hasChildren(parentFolder);
  }
}
