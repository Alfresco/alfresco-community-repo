 ...
 *
 * <p>This file contains a number of helpers to reduce the duplication in tests.
 *
...
public abstract class BaseRuleTest extends BaseSpringTest {
    ...
    protected void checkRule(Rule rule) {
        ...
        assertEquals(CONDITION_DEF_NAME, ruleConditions.get(0).getActionConditionDefinitionName());
