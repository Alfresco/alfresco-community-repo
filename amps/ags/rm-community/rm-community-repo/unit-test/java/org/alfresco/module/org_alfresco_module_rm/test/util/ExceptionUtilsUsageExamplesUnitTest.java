...
public class ExceptionUtilsUsageExamplesUnitTest {
    ...
    public void examineTheExpectedException() {
        UnsupportedOperationException e =
                expectedException(UnsupportedOperationException.class, () -> badMethod2());
    ...
    // If you use lambdas that return void, then they cannot be lambda expressions. They must be
    // blocks.
    @Test
