...
public class WarHelperImplTest extends WarHelperImpl {
  ...
  public void testCheckCompatibleVersion() {
    ...
    ModuleDetails installingModuleDetails = new ModuleDetailsImpl(
      "test_it",
      new ModuleVersionNumber("9999"),
      "Test Mod",
      "Testing module"
    );
    ...
    try {
      ...
      assertTrue(
        exception
          .getMessage()
          .contains(
            "must be installed on a war version equal to or greater than 10.1"
          )
      );
    }
    ...
    try {
      ...
      this.checkCompatibleVersion(theWar, installingModuleDetails); //does not throw exception
      fail(
        "Should not pass as current version is 4.1.0 and the max value is 4.0.999"
  ...
  public void testCheckCompatibleVersionUsingManifest() throws IOException {
    ...
    try {
      ...
      this.checkCompatibleVersionUsingManifest(theWar, installingModuleDetails); //does not throw exception
      fail(
        "Should not pass as current version is 3.4.11 and the max value is 3.4.10"
      ); //should never get here
    } catch (ModuleManagementToolException exception) {
      assertTrue(
        exception
  ...
  public void testCheckCompatibleEdition() {
    ...
    try {
      ...
      assertTrue(
        exception
          .getMessage()
          .endsWith(
            "can only be installed in one of the following editions[CommuniT]"
          )
      );
    }
    ...
    props.setProperty(
      ModuleDetails.PROP_EDITIONS,
      ("enterprise,community,bob")
    ); //should ignore case
    installingModuleDetails = new ModuleDetailsImpl(props);
    this.checkCompatibleEdition(theWar, installingModuleDetails); //does not throw exception
  ...
  public void testCheckCompatibleEditionUsingManifest() throws IOException {
    ...
    try {
      ...
      assertTrue(
        exception
          .getMessage()
          .endsWith(
            "can only be installed in one of the following editions[Community]"
          )
      );
    }
    ...
    String propertiesLocation =
      getFile(".amp", "module/test_v5.amp") + "/module.properties";
    installingModuleDetails =
    ...
    try {
      ...
      assertTrue(
        exception
          .getMessage()
          .endsWith(
            "can only be installed in one of the following editions[Enterprise]"
          )
      );
    }
  ...
  public void testfindManifest() throws Exception {
    ...
    assertEquals(
      "3.4.11",
      manifest.getMainAttributes().getValue(MANIFEST_SPECIFICATION_VERSION)
    );
  ...
  private Properties dummyModuleProperties() {
    ...
    props.setProperty(
      ModuleDetails.PROP_DESCRIPTION,
      "Test for Compatible Editions"
    );
    return props;
  }
