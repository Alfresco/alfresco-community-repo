...
public class ModuleDetailsHelper {
   ...
   * @throws IOException
   */
  public static ModuleDetails createModuleDetailsFromWarAndId(
    String warLocation,
    String moduleId
  ) throws IOException {
    String modulePropertiesFileLocation = ModuleDetailsHelper.getModulePropertiesFileLocation(
      warLocation,
      moduleId
    );
   ...
   */
  public static TFile getModuleDetailsFileFromWarAndId(
    String warLocation,
    String moduleId
  ) {
    String location = ModuleDetailsHelper.getModulePropertiesFileLocation(
      warLocation,
      moduleId
    );
   ...
   */
  public static String getModulePropertiesFileLocation(
    String warLocation,
    String moduleId
  ) {
  ...
  public static String getModulePropertiesFilePathInWar(String moduleId) {
    return (
      WarHelper.MODULE_NAMESPACE_DIR +
      "/" +
      moduleId +
      WarHelper.MODULE_CONFIG_IN_WAR
    );
  }
   ...
   */
  public static void saveModuleDetails(
    String warLocation,
    ...
    try {
      String modulePropertiesFileLocation = getModulePropertiesFileLocation(
        warLocation,
        moduleId
      );
