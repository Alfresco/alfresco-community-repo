...
public class TestCustomModel extends BaseCustomModelApiTest {
    ...
    public void testCreateBasicModel_Invalid() throws Exception {
        ...
        // Test invalid inputs
        {
            ...
            post(
                    ...
                    400); // Invalid name. Contains space
            ...
            post(
                    "cmm",
                    RestApiUtil.toJsonAsString(customModel),
                    400); // Invalid URI. Contains space
        ...
        // Test mandatory properties of the model
        {
            ...
            post(
                    "cmm",
                    RestApiUtil.toJsonAsString(customModel),
                    400); // namespacePrefix is mandatory
        }
    ...
    public void testListBasicModels() throws Exception {
        ...
        // Create the model as a Model Administrator
        CustomModel customModel_1 =
                createCustomModel(modelName_1, getTestNamespaceUriPrefixPair(), ModelStatus.DRAFT);

        String modelName_2 = "testModel2" + System.currentTimeMillis();
        CustomModel customModel_2 =
                createCustomModel(modelName_2, getTestNamespaceUriPrefixPair(), ModelStatus.DRAFT);

        String modelName_3 = "testModel3" + System.currentTimeMillis();
        CustomModel customModel_3 =
                createCustomModel(modelName_3, getTestNamespaceUriPrefixPair(), ModelStatus.DRAFT);

        Paging paging = getPaging(0, Integer.MAX_VALUE);
        HttpResponse response = getAll("cmm", paging, 200);
        List<CustomModel> models =
                RestApiUtil.parseRestApiEntries(response.getJsonResponse(), CustomModel.class);
    ...
    public void testActivateCustomModel() throws Exception {
        ...
        Pair<String, String> namespacePairTwo = getTestNamespaceUriPrefixPair();
        CustomModel customModelTwo =
                createCustomModel(
                        modelNameTwo, namespacePairTwo, ModelStatus.DRAFT, null, "John Doe");
    ...
    public void testDeactivateCustomModel() throws Exception {
        ...
        CustomModel customModelOne =
                createCustomModel(
                        modelNameOne, namespacePair, ModelStatus.ACTIVE, null, "Mark Moe");
        ...
        // Activate/Deactivate a model with an aspect
        {
            ...
            CustomModel customModelTwo =
                    createCustomModel(
                            modelNameTwo, namespacePairTwo, ModelStatus.DRAFT, null, "Mark Moe");
            ...
            put(
                    "cmm",
                    modelNameTwo,
                    RestApiUtil.toJsonAsString(customModelTwo),
                    SELECT_STATUS_QS,
                    200);
    ...
    public void testUpdateBasicModel() throws Exception {
        ...
        // Create the model as a Model Administrator
        createCustomModel(
                modelName, namespacePair, ModelStatus.DRAFT, "Test model description", null);
        ...
        put(
                ...
                RestApiUtil.toJsonAsString(updatePayload),
                null,
                400); // Cannot update the model name
        ...
        put(
                ...
                RestApiUtil.toJsonAsString(updatePayload),
                null,
                409); // The namespace uri has already been used
        ...
        put(
                ...
                RestApiUtil.toJsonAsString(updatePayload),
                null,
                409); // The namespace prefix has already been used
        ...
        put(
                ...
                RestApiUtil.toJsonAsString(updatePayload),
                null,
                400); // The namespace prefix is mandatory
        ...
        put(
                ...
                RestApiUtil.toJsonAsString(updatePayload),
                null,
                400); // The namespce uri is mandatory
        ...
        assertEquals(
                "The model status should only be updated via '?select=status' request.",
                ModelStatus.DRAFT,
                returnedModel.getStatus());
    ...
    public void testUpdateModel_WithAspectsAndTypes() throws Exception {
        ...
        assertEquals(
                "The parent name prefix should have been updated.",
                newTypeParentName,
                returnedChildType.getParentName());

        // Retrieve the child aspect
        response = getSingle("cmm/" + modelName + "/aspects", childAspectName, 200);
        CustomAspect returnedChildAspect =
        ...
        assertEquals(
                "The parent name prefix should have been updated.",
                newAspectParentName,
                returnedChildAspect.getParentName());
    }
    ...
    public void testModelsCircularDependency() throws Exception {
        ...
        final String typeA_M1_WithPrefix =
                namespacePairOne.getSecond() + QName.NAMESPACE_PREFIX + typeA_M1;
        createTypeAspect(
                CustomType.class,
                modelNameOne,
                typeA_M1,
        ...
        final String typeB_M1_WithPrefix =
                namespacePairOne.getSecond() + QName.NAMESPACE_PREFIX + typeB_M1;
        createTypeAspect(
                CustomType.class,
                modelNameOne,
                typeB_M1,
        ...
        final String type1_M2_WithPrefix =
                namespacePairTwo.getSecond() + QName.NAMESPACE_PREFIX + type1_M2;
        createTypeAspect(
                CustomType.class,
                modelNameTwo,
                type1_M2,
        ...
        // Test that the API can handle "circular dependency" - (modelOne depends on modelTwo)
        {
            ...
            post(
                    "cmm/" + modelNameOne + "/types",
                    RestApiUtil.toJsonAsString(typeC_M1_Payload),
        ...
        final String type1_M3_WithPrefix =
                namespacePairThree.getSecond() + QName.NAMESPACE_PREFIX + type1_M3;
        createTypeAspect(
                CustomType.class,
                modelNameThree,
                type1_M3,
        ...
        put(
                "cmm",
                modelNameThree,
                RestApiUtil.toJsonAsString(modelThreeStatusPayload),
                SELECT_STATUS_QS,
                200);
        ...
        final String type1_M4_WithPrefix =
                namespacePairFour.getSecond() + QName.NAMESPACE_PREFIX + type1_M4;
        createTypeAspect(
                CustomType.class,
                modelNameFour,
                type1_M4,
        ...
        put(
                "cmm",
                modelNameFour,
                RestApiUtil.toJsonAsString(modelFourStatusPayload),
                SELECT_STATUS_QS,
                200);
        ...
        // Test that the API can handle "circular dependency" - (modelTwo depends on modelFour)
        {
            ...
            post(
                    "cmm/" + modelNameTwo + "/types",
                    RestApiUtil.toJsonAsString(type2_M2_Payload),
                    409); // Constraint violation
        }
    }
}
