...
public class DispositionLifecycleGet extends DispositionAbstractBase {
  ...
  protected Map<String, Object> executeImpl(
    ...
    DispositionAction nextAction = getDispositionService()
    ...
    if (nextAction == null) {
      ...
      if (nextAction.getAsOfDate() != null) {
        nextActionModel.put(
          "asOf",
          ISO8601DateFormat.format(nextAction.getAsOfDate())
        );
      }
      ...
      if (nextAction.getStartedAt() != null) {
        nextActionModel.put(
          "startedAt",
          ISO8601DateFormat.format(nextAction.getStartedAt())
        );
      }
      ...
      if (nextAction.getCompletedAt() != null) {
        nextActionModel.put(
          "completedAt",
          ISO8601DateFormat.format(nextAction.getCompletedAt())
        );
      }
  ...
  protected Map<String, Object> createEventModel(EventCompletionDetails event) {
    ...
    if (event.getEventCompletedAt() != null) {
      model.put(
        "completedAt",
        ISO8601DateFormat.format(event.getEventCompletedAt())
      );
    }
