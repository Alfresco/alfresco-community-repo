...
public class ActionConditionImpl extends ParameterizedItemImpl
    ...
    /**
     * Indicates whether the result of the condition should have the NOT logical operator applied to
     * it.
     */
