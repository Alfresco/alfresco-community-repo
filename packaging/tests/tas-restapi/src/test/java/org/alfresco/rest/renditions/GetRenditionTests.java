...
public class GetRenditionTests extends RestTest {
  ...
  public void verifyPreviewOfZipFile() throws Exception {
    ...
    restClient
      ...
      .addMultiPart(
        "filedata",
        Utility.getResourceTestDataFile("content-zip-test.zip")
      );
    ...
    RestRenditionInfoModel renditionInfo = restClient
      .withCoreAPI()
      .usingNode(file)
  ...
  public void verifyThumbnailOfZipFile() throws Exception {
    ...
    STEP(
      "4. Verify thumbnail of ZIP file is created and has content using RESTAPI"
    );
    RestRenditionInfoModel renditionInfo = restClient
      .withCoreAPI()
      .usingNode(file)
  ...
  public void getRenditionContent() throws Exception {
    ...
    STEP(
      "4. Verify thumbnail of txt file is created and has content using RESTAPI"
    );
