...
public class TempFileProviderTest extends TestCase {
    ...
    public void testTempDir() throws Exception {
        ...
        assertEquals(
                "Our temp dir not subdirectory system temp directory",
                tempFileParent,
                tempDirParent);
    }
     ...
     *
     * <p>create another file with the same prefix and suffix.
     *
     * @throws Exception
     */
    public void testTempFile() throws Exception {
        ...
        File tempFileParent = tempFile.getParentFile();
        File tempDir = TempFileProvider.getTempDir();
        assertEquals("Temp file not located in our temp directory", tempDir, tempFileParent);
