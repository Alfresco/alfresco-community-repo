...
public class RetryingTransactionInterceptor extends TransactionAspectSupport
    ...
    public Object invoke(final MethodInvocation invocation) throws Throwable {
        if ((null != invocation)
                && (null != invocation.getThis())
                && (null != invocation.getMethod())) {
            final Method method = invocation.getMethod();
            final TransactionAttribute txnAttr =
                    getTransactionAttributeSource()
                            .getTransactionAttribute(method, invocation.getThis().getClass());
            ...
            final String joinpointIdentification =
                    methodIdentification(invocation.getMethod(), invocation.getThis().getClass());
            final int propagationBehaviour = txnAttr.getPropagationBehavior();
            try {
                if (null != txnAttr
                        && propagationBehaviour != TransactionAttribute.PROPAGATION_SUPPORTS) {
