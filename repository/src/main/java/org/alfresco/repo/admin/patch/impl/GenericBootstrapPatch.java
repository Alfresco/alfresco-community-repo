...
public class GenericBootstrapPatch extends AbstractPatch {
  ...
  protected static final String MSG_EXISTS =
    "patch.genericBootstrap.result.exists";
  protected static final String MSG_CREATED =
    "patch.genericBootstrap.result.created";
  ...
  protected static final String ERR_MULTIPLE_FOUND =
    "patch.genericBootstrap.err.multiple_found";
