    ...
    protected String applyInternal() throws Exception {
        BatchProcessWorkProvider<NodeRef> workProvider =
                new BatchProcessWorkProvider<NodeRef>() {
                    ...
                    Pair<Long, QName> val =
                            getQnameDAO().getQName(EmailServerModel.ASPECT_ALIASABLE);
        ...
        BatchProcessWorker<NodeRef> worker =
                new BatchProcessWorker<NodeRef>() {
                    ...
                    public void process(NodeRef entry) throws Throwable {
                        String alias =
                                (String)
                                        nodeService.getProperty(entry, EmailServerModel.PROP_ALIAS);
                        if (alias != null) {
                            NodeRef existing =
                                    (NodeRef)
                                            getAttributeService()
                            ...
                            if (existing != null) {
                                if (!existing.equals(entry)) {
                                    ...
                                    if (logger.isWarnEnabled()) {
                                        logger.warn(
                                                "Email alias is not unique, alias:"
                                                        + alias
                                                        + " nodeRef:"
                                                        + entry);
                                    }
                                    ...
                                    try {
                                        ...
                                        nodeService.removeAspect(
                                                entry, EmailServerModel.ASPECT_ALIASABLE);
