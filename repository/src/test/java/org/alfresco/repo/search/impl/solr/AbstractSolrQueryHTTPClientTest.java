...
public class AbstractSolrQueryHTTPClientTest {
    ...
    private AbstractSolrQueryHTTPClient abstractSolrQueryHTTPClient =
            spy(AbstractSolrQueryHTTPClient.class);
    ...
    /**
     * Check that the status code is replaced with "Not Implemented" for an unsupported query
     * option.
     */
    @Test
