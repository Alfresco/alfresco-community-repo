...
public class AddTaskItemTestsBulk2 extends RestTest {
  ...
  public void failedAddingTaskItemIfInvalidItemBodyIsProvided()
    throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "invalidNodeRef")
      )
  ...
  public void failedAddingMultipleTaskItemIfInvalidItemBodyIsProvided()
    throws Exception {
    fileModel.setNodeRef("invalidNodeRef");
    restClient
      .authenticateUser(userModel)
  ...
  public void failedAddingMultipleTaskItemIfEmptyItemBodyIsProvided()
    throws Exception {
    fileModel.setNodeRef("");
    restClient
      .authenticateUser(userModel)
  ...
  public void failedAddingMultipleTaskItemIfInvalidTaskIdIsProvided()
    throws Exception {
    taskModel.setId("invalidTaskId");
    restClient
      .authenticateUser(userModel)
