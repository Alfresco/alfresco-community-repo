...
public abstract class AbstractSiteActivityTest {
    ...
    private static final String TEST_TEMPLATES_LOCATION =
            "activities"; // assumes test-resources is on classpath
    ...
    public void testGetSiteFeedsBefore() throws Exception {
        ...
        getSiteFeed(
                site1,
                0); // site 1 is public, hence site feed is accessible to any user of the system
    ...
    protected void getUserFeed(
        ...
        assertEquals(
                ...
                activityService
                        .getUserFeedEntries(
                                userId, siteId, excludeThisUser, excludeOtherUsers, null, null)
                        .size());
    }
    ...
    public void testGetSiteFeedsAfterRemoveMemberships() throws Exception {
        ...
        getSiteFeed(
                site3, 9); //  9 = 3 users, each with 1 join, 1 role change, 1 leave (not user 4)
    ...
    public void testGetUserFeedsAfter() throws Exception {
        ...
        getUserFeed(
                user2, true,
                0); // 0 = due to feed control - exclude site membership activities (across all
        // sites)
        getUserFeed(
                user3, true,
                14); // 14 = (22 - 8) due to feed control - exclude site membership activities for
        // site 1
