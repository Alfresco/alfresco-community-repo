...
public class NodeContentGet extends StreamContent {
  ...
  private static final String TRANSFORM_STATUS_HEADER =
    "X-Alfresco-transformStatus";
  private static final String TRANSFORM_EXCEPTION_HEADER =
    "X-Alfresco-transformException";
  private static final String TRANSFORM_DURATION_HEADER =
  ...
  public void execute(WebScriptRequest req, WebScriptResponse res)
    ...
    if (nodeIDString == null) {
      throw new WebScriptException(
        "nodeID parameter is required for GetNodeContent"
      );
    }
    ...
    try {
      ...
      res.setHeader(
        TRANSFORM_DURATION_HEADER,
        String.valueOf(transformDuration)
      );
    ...
    if (transformException != null) {
      ...
      streamContentImpl(
        ...
        false,
        modified,
        String.valueOf(modified.getTime()),
        null,
        null
      );
    }
