 ...
 *
 * <p>Note: The attributes/operations below can be clustered (ie. when configured all servers in the
 * cluster will be affected)
 */
public interface RepoServerMgmtMBean {
     ...
     *
     * <p>This may be higher than the user count, since a user can have more than one ticket/session
     *
     ...
     *
     * <p>This may be lower than the ticket count, since a user can have more than one
     * ticket/session
     *
     ...
     *
     * <p>Note: This operation can be clustered (ie. all servers in the cluster will be affected)
     *
     ...
     *
     * <p>If number of non-expired logins is greater or equal to the limit then further logins will
     * be prevented otherwise valid login attempt will be permitted. However, single-user mode will
     * take precedence.
     *
     * <p>Max users = 0 prevents further logins Max users = -1 allow logins (without a max limit)
     */
