...
public class SerializerOfCollectionWithPaging
  ...
  public void serialize(
    SerializablePagedCollection pagedCol,
    JsonGenerator jgen,
  ...
  private void serializeIncludedSource(
    SerializablePagedCollection pagedCol,
    JsonGenerator jgen
  ...
  private void serializePagination(
    SerializablePagedCollection pagedCol,
    JsonGenerator jgen
  ) throws IOException, JsonProcessingException {
    ...
    if (pagedCol.getPaging() != null) {
      ...
      jgen.writeNumberField(
        RecognizedParamsExtractor.PARAM_PAGING_MAX,
        pagedCol.getPaging().getMaxItems()
      );
    }
    jgen.writeEndObject();
  }
