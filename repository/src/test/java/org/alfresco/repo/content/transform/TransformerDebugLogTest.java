...
public class TransformerDebugLogTest {
  ...
  public void noEntriesDisabledTest() {
    assertStringArrayEquals(
      new String[] {
        "No entries are available. transformer.debug.entries must be set to a number between 1 and 100",
      },
      log.getEntries(10)
    );
  }

  private static void assertStringArrayEquals(
    String[] expected,
    String[] actual
  ) {
