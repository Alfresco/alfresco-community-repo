...
public abstract class NodeUtils {
  ...
  public static List<NodeRef> toChildRefs(
  ...
  public static List<NodeRef> toParentRefs(
    Collection<ChildAssociationRef> assocRefs
  ) {
  ...
  public static NodeRef getSingleChildAssocNode(
  ...
  public static NodeRef getSingleAssocNode(
    Collection<AssociationRef> assocs,
    boolean getTarget
  ) {
    if (assocs != null && assocs.size() == 1) {
  ...
  public List<NodeRef> sortByCreationDate(
  ...
  public Comparator<NodeRef> getNodeCreationDateComparator(
    ...
    return new Comparator<NodeRef>() {
      ...
      private long getDate(NodeRef node) {
        ...
        if (date == null) {
          Date dateObj = (Date) nodeService.getProperty(
            node,
