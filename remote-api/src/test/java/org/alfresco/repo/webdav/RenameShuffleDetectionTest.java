...
public class RenameShuffleDetectionTest {
    ...
    public static Collection<Object[]> data() {
        Object[][] data =
                new Object[][] {
                    ...
                    {
                        "/some/parent/junk_backup_morejunk.docxm", true
                    }, // MW: is this an intentional match?
                    {"/some/parent/junk_backup_morejunk.dotx", true},
                    {"/some/parent/junk_backup_morejunk.dotm", true},
                    {
                        "/some/parent/junk_backup_morejunk.dotxm", true
                    }, // MW: is this an intentional match?
                    ...
                    {"abcdef01", true},
                    {
                        "1234567890.txt.sb-764f0c5c-JUoEKy", true
                    }, // MNT-10373 test for TextEdit shuffle
                    // Photoshop (MNT-8971)
                    {"/psC1DA.tmp", true},
    ...
    public void testIsRenameShuffle() {
        assertEquals(
                "Incorrect result for path: " + path,
                expectedResult,
                davHelper.isRenameShuffle(path));
    }
}
