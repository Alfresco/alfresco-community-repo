...
/**
 * FormProcessor implementation that can generate and persist Form objects for types in the Alfresco
 * content model.
 *
...
public class TypeFormProcessor extends ContentModelFormProcessor<TypeDefinition, NodeRef> {
        ...
        try {
            ...
            if (typeDef == null) {
                throw new FormNotFoundException(
                        item, new IllegalArgumentException("Type does not exist: " + item.getId()));
            }
     ...
     *
     * <p>If the form data has the name property present it is used as the name of the node.
     *
     * <p>The new node is placed in the location defined by the "destination" data item in the form
     * data (this will usually be a hidden field), this will also be the NodeRef representation of
