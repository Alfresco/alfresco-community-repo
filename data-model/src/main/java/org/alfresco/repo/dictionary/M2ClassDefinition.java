...
/*package*/ class M2ClassDefinition implements ClassDefinition {
    private static final String ERR_CLASS_NOT_DEFINED_NAMESPACE =
            "d_dictionary.class_definition.class.namespace_not_defined";
    private static final String ERR_PROPERTY_NOT_DEFINED_NAMESPACE =
            "d_dictionary.class_definition.property.namespace_not_defined";
    private static final String ERR_DUPLICATE_PROPERTY_DEFINITION =
            "d_dictionary.class_definition.duplicate.property_definition";
    private static final String ERR_DUPLICATE_PROPERTY_EXISTING_DEF =
            "d_dictionary.class_definition.duplicate.property_existing_def";
    private static final String ERR_ASSOCIATION_NOT_DEFINED_NAMESPACE =
            "d_dictionary.class_definition.association.namespace_not_defined";
    private static final String ERR_DUPLICATE_ASSOCIATION_DEFINITION =
            "d_dictionary.class_definition.duplicate.association_definition";
    private static final String ERR_DUPLICATE_ASSOCIATION_EXISTING_DEF =
            "d_dictionary.class_definition.duplicate.association_existing_def";
    private static final String ERR_DUPLICATE_PROPERTY_AND_PROPERTY_OVERRIDE =
            "d_dictionary.class_definition.duplicate.property_and_property_override";
    private static final String ERR_DUPLICATE_PROPERTY_OVERRIDE =
            "d_dictionary.class_definition.duplicate.property_override_definition";
    private static final String ERR_PARENT_NOT_FOUND =
            "d_dictionary.class_definition.class.parent_not_found";
    private static final String ERR_PROPERTY_NOT_EXIST =
            "d_dictionary.class_definition.property_not_exist";
    private static final String ERR_MANDATORY_ASPECT_NOT_FOUND =
            "d_dictionary.class_definition.mandatory_aspect_not_found";
    private static final String ERR_DUPLICATE_PROPERTY_IN_CLASS_HIERARCHY =
            "d_dictionary.class_definition.duplicate.property_in_class_hierarchy";
    private static final String ERR_DUPLICATE_ASSOCIATION_IN_CLASS_HIERARCHY =
            "d_dictionary.class_definition.duplicate.association_in_class_hierarchy";
    ...
    private Map<QName, M2PropertyOverride> propertyOverrides =
            new HashMap<QName, M2PropertyOverride>();
    private Map<QName, PropertyDefinition> properties = new HashMap<QName, PropertyDefinition>();
    private Map<QName, PropertyDefinition> inheritedProperties =
            new HashMap<QName, PropertyDefinition>();
    private Map<QName, AssociationDefinition> associations =
            new HashMap<QName, AssociationDefinition>();
    private Map<QName, AssociationDefinition> inheritedAssociations =
            new HashMap<QName, AssociationDefinition>();
    private Map<QName, ChildAssociationDefinition> inheritedChildAssociations =
            new HashMap<QName, ChildAssociationDefinition>();
     ...
     */
    /*package*/ M2ClassDefinition(
            ModelDefinition model,
            M2Class m2Class,
            NamespacePrefixResolver resolver,
            Map<QName, PropertyDefinition> modelProperties,
            Map<QName, AssociationDefinition> modelAssociations) {
        this.model = model;
        ...
        if (!model.isNamespaceDefined(name.getNamespaceURI())) {
            throw new DictionaryException(
                    ERR_CLASS_NOT_DEFINED_NAMESPACE,
                    name.toPrefixString(),
                    name.getNamespaceURI(),
                    model.getName().toPrefixString());
        }
        ...
        for (M2Property property : m2Class.getProperties()) {
            ...
            if (!model.isNamespaceDefined(def.getName().getNamespaceURI())
                ...
                throw new DictionaryException(
                        ERR_PROPERTY_NOT_DEFINED_NAMESPACE,
                        def.getName().toPrefixString(),
                        def.getName().getNamespaceURI(),
                        model.getName().toPrefixString());
            }
            ...
            if (existingDef != null) {
                ...
                throw new DuplicateDefinitionException(
                        ...
                        def.getName().toPrefixString(),
                        name.toPrefixString(),
                        existingDef.getContainerClass().getName().toPrefixString());
            }
        ...
        for (M2ClassAssociation assoc : m2Class.getAssociations()) {
            ...
            if (associations.containsKey(def.getName())) {
                throw new DuplicateDefinitionException(
                        ERR_DUPLICATE_ASSOCIATION_DEFINITION,
                        def.getName().toPrefixString(),
                        name.toPrefixString());
            }
            ...
            if (existingDef != null) {
                ...
                throw new DuplicateDefinitionException(
                        ...
                        def.getName().toPrefixString(),
                        name.toPrefixString(),
                        existingDef.getSourceClass().getName().toPrefixString());
            }
        ...
        for (M2PropertyOverride override : m2Class.getPropertyOverrides()) {
            ...
            if (properties.containsKey(overrideName)) {
                throw new DuplicateDefinitionException(
                        ERR_DUPLICATE_PROPERTY_AND_PROPERTY_OVERRIDE,
                        overrideName.toPrefixString(),
                        name.toPrefixString());
            }
            if (propertyOverrides.containsKey(overrideName)) {
                throw new DuplicateDefinitionException(
                        ERR_DUPLICATE_PROPERTY_OVERRIDE,
                        overrideName.toPrefixString(),
                        name.toPrefixString());
            }
    ...
    public String toString() {
        ...
        sb.append("ClassDef").append("[name=").append(name).append("]");
        return sb.toString();
    }
    ...
    /*package*/ void resolveDependencies(
        ...
        if (parentName != null) {
            ...
            if (parent == null) {
                throw new DictionaryException(
                        ERR_PARENT_NOT_FOUND, parentName.toPrefixString(), name.toPrefixString());
            }
            parentClassDefinition = parent;
        }

        for (PropertyDefinition def : properties.values()) {
            ((M2PropertyDefinition) def)
                    .resolveDependencies(query, prefixResolver, modelConstraints);
        }
        ...
        for (Map.Entry<QName, M2PropertyOverride> override : propertyOverrides.entrySet()) {
            ...
            if (propDef == null) {
                throw new DictionaryException(
                        ERR_PROPERTY_NOT_EXIST,
                        name.toPrefixString(),
                        override.getKey().toPrefixString());
            }
        }
        ...
        for (QName aspectName : defaultAspectNames) {
            ...
            if (aspect == null) {
                throw new DictionaryException(
                        ERR_MANDATORY_ASPECT_NOT_FOUND,
                        aspectName.toPrefixString(),
                        name.toPrefixString());
            }
    ...
    /*package*/ void resolveInheritance(
        ...
        for (AssociationDefinition def : associations.values()) {
            if (inheritedAssociations.containsKey(def.getName())) {
                throw new DuplicateDefinitionException(
                        ERR_DUPLICATE_ASSOCIATION_IN_CLASS_HIERARCHY,
                        def.getName().toPrefixString(),
                        name.toPrefixString());
            }
        ...
        if (parentClass != null && includedInSuperTypeQuery == null) {
            // archive not explicitly set on this class and there is a parent class
            inheritedIncludedInSuperTypeQuery =
                    ((M2ClassDefinition) parentClass).getIncludedInSuperTypeQuery();
        }
    }
     ...
     *
     * <p>note: - checks properties for incremental updates, but does not include the diffs - checks
     * assocs & child assocs for incremental updates, but does not include the diffs - incremental
     * updates include changes in title/description, property default value, etc
     */
    /* package */ List<M2ModelDiff> diffClass(ClassDefinition classDef) {
        ...
        if (!EqualsHelper.nullSafeEquals(
                getDescription(null), classDef.getDescription(null), false)) {
            isUpdatedIncrementally = true;
        }
        ...
        if (isContainer() != classDef.isContainer()) {
            if (isContainer()) {
                // updated (non-incrementally) if class was a container and now is not a container -
                // ie. all child associations removed
                isUpdated = true;
            }

            if (classDef.isContainer()) {
                // updated incrementally if class was not a container and now is a container - ie.
                // some child associations added
                isUpdatedIncrementally = true;
            }
        }

        // check all properties (including inherited properties)
        Collection<M2ModelDiff> propertyDiffs =
                M2PropertyDefinition.diffPropertyLists(
                        getProperties().values(), classDef.getProperties().values());

        modelDiffs.addAll(propertyDiffs);

        // check all associations (including inherited associations, child associations and
        // inherited child associations)
        Collection<M2ModelDiff> assocDiffs =
                M2AssociationDefinition.diffAssocLists(
                        getAssociations().values(), classDef.getAssociations().values());
        ...
        if (getArchive() == null) {
            ...
            if (classArchive == null
                    || classArchive.booleanValue() != getArchive().booleanValue()) {
                isUpdatedIncrementally = true;
            }
        }
        ...
        if (getIncludedInSuperTypeQuery() == null) {
            ...
            if (classIncludedInSuperTypeQuery == null
                    || classIncludedInSuperTypeQuery.booleanValue()
                            != getIncludedInSuperTypeQuery().booleanValue()) {
                isUpdatedIncrementally = true;
            }
        }
    ...
    /*package*/ static List<M2ModelDiff> diffClassLists(
            Collection<ClassDefinition> previousClasses,
            Collection<ClassDefinition> newClasses,
            String M2ModelDiffType) {
        List<M2ModelDiff> modelDiffs = new ArrayList<M2ModelDiff>();
        ...
        for (ClassDefinition newClass : newClasses) {
            ...
            if (!found) {
                modelDiffs.add(
                        new M2ModelDiff(
                                newClass.getName(), M2ModelDiffType, M2ModelDiff.DIFF_CREATED));
            }
        }
