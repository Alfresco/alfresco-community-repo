...
public class GetSiteGroupsTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        RestSiteGroupModelsCollection siteGroups =
                restClient
                        .authenticateUser(siteCreator)
                        .withCoreAPI()
                        .usingSite(moderatedSite)
                        .usingParams("properties=role,id")
                        .getSiteGroups();
    }
    ...
    public void getSiteGroupsWithManagerRole() throws Exception {
        restClient
                ...
                .and()
                .entriesListContains("role", UserRole.SiteManager.name())
                .and()
                .entriesListContains("id", getId(publicSiteGroups.get(1)))
                .and()
                .entriesListContains("role", UserRole.SiteCollaborator.name())
                .and()
                .entriesListContains("id", getId(publicSiteGroups.get(2)))
                .and()
                .entriesListContains("role", UserRole.SiteConsumer.name())
                .and()
                .entriesListContains("id", getId(publicSiteGroups.get(3)))
                .and()
                .entriesListContains("role", UserRole.SiteContributor.name());
    ...
    public void getSiteGroupsWithContributorRole() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteContributor))
                .withCoreAPI()
                .usingSite(publicSite)
                .getSiteGroups()
                .assertThat()
    ...
    public void getSiteGroupsWithConsumerRole() throws Exception {
        restClient
                .authenticateUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteConsumer))
                .withCoreAPI()
                .usingSite(publicSite)
                .getSiteGroups()
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site members call returns status code 404 if siteId does not exist")
    public void checkStatusCodeForNonExistentSiteId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format("Site %s does not exist", "NonExistentSiteId"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site groups call returns status code 400 for invalid maxItems")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site groups call returns status code 400 for invalid skipCount ")
    public void checkStatusCodeForInvalidSkipCount() throws Exception {
        restClient
                .authenticateUser(regularUser)
                .withParams("skipCount=A")
                .withCoreAPI()
                .usingSite(publicSite)
                .getSiteGroups();
        restClient
        ...
        restClient.withParams("skipCount=-1").withCoreAPI().usingSite(publicSite).getSiteGroups();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    public void getModeratedSiteGroups() throws Exception {
        ...
        siteGroups
                ...
                .entriesListCountIs(4)
                .assertThat()
                .entriesListContains("id", getId(moderatedSiteGroups.get(0)))
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(1)))
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(2)))
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(3)))
                .and()
                .paginationField("count")
                .is("4");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site groups with properties parameter"
                            + " applied and status code is 200")
    public void getModeratedSiteGroupsUsingPropertiesParameter() throws Exception {
        ...
        siteGroups
                ...
                .entriesListCountIs(4)
                .and()
                .entriesListDoesNotContain("person")
                .and()
                .entriesListContains("role", UserRole.SiteManager.toString())
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(0)))
                .and()
                .entriesListContains("role", UserRole.SiteContributor.toString())
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(1)))
                .and()
                .entriesListContains("role", UserRole.SiteCollaborator.toString())
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(2)))
                .and()
                .entriesListContains("role", UserRole.SiteConsumer.toString())
                .and()
                .entriesListContains("id", getId(moderatedSiteGroups.get(3)));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site groups with skipCount parameter"
                            + " applied")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site groups with high skipCount parameter"
                            + " applied")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site groups with maxItems parameter applied"
                            + " and check all pagination fields")
