...
public class RemoveTaskItemTests extends RestTest {
  ...
  public void deleteTaskItem() throws Exception {
    ...
    document2 =
      dataContent.usingSite(siteModel).createContent(DocumentType.XML);

    taskItem =
      restClient.withWorkflowAPI().usingTask(taskModel).addTaskItem(document2);
    ...
    restClient
      ...
      .getTaskItems()
      .assertThat()
      .entriesListDoesNotContain("id", taskItem.getId())
      .and()
  ...
  public void deleteTaskItemUsingInvalidTaskId() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "invalidTaskId")
      );
  }
  ...
  public void deleteTaskItemUsingInvalidItemId() throws Exception {
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          RestErrorModel.PROCESS_ENTITY_NOT_FOUND,
          "incorrectItemId"
        )
      );
  }
  ...
  public void deleteTaskItemForCompletedTask() throws Exception {
    TaskModel completedTask = dataWorkflow
      .usingUser(userWhoStartsTask)
      .usingSite(siteModel)
      .usingResource(fileModel)
      .createNewTaskAndAssignTo(assigneeUser);
    ...
    document2 =
      dataContent
        .usingUser(userWhoStartsTask)
        .usingSite(siteModel)
        .createContent(DocumentType.XML);
    taskItem =
      restClient
        .withWorkflowAPI()
        .usingTask(completedTask)
        .addTaskItem(document2);
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, completedTask.getId())
      );
  }
  ...
  public void deleteTaskItemWithCandidateUser() throws Exception {
    ...
    TaskModel groupTask = dataWorkflow
      .usingUser(userWhoStartsTask)
      .usingSite(siteModel)
      .usingResource(fileModel)
    ...
    document2 =
      dataContent
        ...
        .createContent(DocumentType.XML);
    taskItem =
      restClient.withWorkflowAPI().usingTask(groupTask).addTaskItem(document2);
    restClient
      .authenticateUser(assigneeUser)
      .withWorkflowAPI()
      .usingTask(groupTask)
      .deleteTaskItem(taskItem);
    restClient.assertStatusCodeIs(HttpStatus.NO_CONTENT);
  ...
  public void deleteTaskItemFromDeletedProcess() throws Exception {
    ProcessModel deletedProcess = dataWorkflow
      .usingUser(userWhoStartsTask)
      .usingSite(siteModel)
      .usingResource(fileModel)
      .createMoreReviewersWorkflowAndAssignTo(assigneeUser);
    TaskModel task = restClient
      .authenticateUser(userWhoStartsTask)
      .withWorkflowAPI()
      .usingProcess(deletedProcess)
      .getProcessTasks()
      .getEntries()
      .get(0)
      .onModel();
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, task.getId())
      );
  }
  ...
  public void deleteTaskItemTwice() throws Exception {
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          RestErrorModel.PROCESS_ENTITY_NOT_FOUND,
          document2.getNodeRefWithoutVersion()
        )
      )
  ...
  public void deleteTaskItemWithLockedDocument() throws Exception {
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          RestErrorModel.LOCKED_NODE_OPERATION,
          document2.getNodeRefWithoutVersion()
        )
      )
