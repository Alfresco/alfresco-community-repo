...
public class NodeChildrenRelation
  ...
  @Override
  @WebApiDescription(
    title = "Return a paged list of nodes for the document/folder identified by parentFolderNodeId"
  )
  ...
  @Override
  @WebApiDescription(
    title = "Create one (or more) nodes as children of folder identified by parentFolderNodeId"
  )
