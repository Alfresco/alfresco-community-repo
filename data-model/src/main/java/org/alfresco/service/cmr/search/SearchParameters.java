...
public class SearchParameters implements BasicSearchParameters {
  ...
  public static final SortDefinition SORT_IN_DOCUMENT_ORDER_ASCENDING = new SortDefinition(
    SortDefinition.SortType.DOCUMENT,
    null,
    true
  );
  ...
  private ArrayList<QueryParameterDefinition> queryParameterDefinitions = new ArrayList<QueryParameterDefinition>(
    1
  );
  ...
  private PermissionEvaluationMode permissionEvaluation =
  ...
  public SearchParameters copy() {
    ...
    sp.excludeDataInTheCurrentTransaction =
    ...
    sp.maxRawResultSetSizeForInMemorySort =
      this.maxRawResultSetSizeForInMemorySort;
   ...
   */
  public void addQueryParameterDefinition(
   ...
   */
  public void excludeDataInTheCurrentTransaction(
  ...
  public void addSort(String field, boolean ascending) {
    addSort(
      new SortDefinition(SortDefinition.SortType.FIELD, field, ascending)
    );
  }
   ...
   */
  public void setPermissionEvaluation(
    PermissionEvaluationMode permissionEvaluation
  ) {
   ...
   */
  public void setMaxRawResultSetSizeForInMemorySort(
    Integer maxRawResultSetSizeForInMemorySort
  ) {
    this.maxRawResultSetSizeForInMemorySort =
  ...
  public Locale getSortLocale() {
    ...
    if (locales.size() > 1) {
      throw new AlfrescoRuntimeException(
        "Order on text/mltext properties with more than one locale is not curently supported"
      );
    }
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((allAttributes == null) ? 0 : allAttributes.hashCode());
    result =
      prime *
      result +
      (
    ...
    result =
      prime *
      result +
      ((defaultFTSOperator == null) ? 0 : defaultFTSOperator.hashCode());
    result =
      prime *
      result +
      ((defaultFieldName == null) ? 0 : defaultFieldName.hashCode());
    result =
      prime * result + (excludeDataInTheCurrentTransaction ? 1231 : 1237);
    result = prime * result + (excludeTenantFilter ? 1231 : 1237);
    result =
      prime * result + ((fieldFacets == null) ? 0 : fieldFacets.hashCode());
    ...
    result =
      ...
      result +
      (int) (
        maxPermissionCheckTimeMillis ^ (maxPermissionCheckTimeMillis >>> 32)
      );
    ...
    result =
      prime *
      result +
      ((mlAnalaysisMode == null) ? 0 : mlAnalaysisMode.hashCode());
    ...
    result =
      prime *
      result +
      ((queryConsistency == null) ? 0 : queryConsistency.hashCode());
    result =
      prime *
      result +
      (
    ...
    result =
      prime *
      result +
      ((queryTemplates == null) ? 0 : queryTemplates.hashCode());
    result = prime * result + skipCount;
    result =
      prime *
      result +
      ((sortDefinitions == null) ? 0 : sortDefinitions.hashCode());
    result = prime * result + ((stores == null) ? 0 : stores.hashCode());
    result =
      prime *
      result +
      ((textAttributes == null) ? 0 : textAttributes.hashCode());
    result =
      prime *
      result +
      ((useInMemorySort == null) ? 0 : useInMemorySort.hashCode());
    result = prime * result + ((sinceTxId == null) ? 0 : sinceTxId.hashCode());
    result =
      prime * result + ((facetQueries.isEmpty()) ? 0 : facetQueries.hashCode());
    result =
      prime *
      result +
      ((filterQueries.isEmpty()) ? 0 : filterQueries.hashCode());
    result = prime * result + ((pivots.isEmpty()) ? 0 : pivots.hashCode());
    result = prime * result + ((ranges == null) ? 0 : ranges.hashCode());
    result =
      prime * result + ((searchTerm == null) ? 0 : searchTerm.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (
      maxPermissionCheckTimeMillis != other.maxPermissionCheckTimeMillis
    ) return false;
    ...
    if (maxRawResultSetSizeForInMemorySort == null) {
      ...
      !maxRawResultSetSizeForInMemorySort.equals(
        other.maxRawResultSetSizeForInMemorySort
      )
    ) return false;
    ...
    if (queryParameterDefinitions == null) {
      ...
      !queryParameterDefinitions.equals(other.queryParameterDefinitions)
    ) return false;
  ...
  public String toString() {
    ...
    builder
      .append("SearchParameters [language=")
  ...
  public static class FieldFacet {
    ...
    public void setCountDocsMissingFacetField(
      boolean countDocsMissingFacetField
    ) {
    ...
    public boolean equals(Object o) {
      ...
      if (
        countDocsMissingFacetField != that.countDocsMissingFacetField
      ) return false;
    ...
    public int hashCode() {
      ...
      result =
        31 * result + (excludeFilters != null ? excludeFilters.hashCode() : 0);
  ...
  public boolean usePostSort(
    ...
    boolean use = (useInMemorySort == null)
      ? useInMemorySortDefault
      : useInMemorySort.booleanValue();
    int max = (maxRawResultSetSizeForInMemorySort == null)
