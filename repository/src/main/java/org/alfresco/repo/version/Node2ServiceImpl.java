...
public class Node2ServiceImpl
  ...
  public QName getType(NodeRef nodeRef) throws InvalidNodeRefException {
    ...
    return (QName) this.dbNodeService.getType(
  ...
  public Set<QName> getAspects(NodeRef nodeRef) throws InvalidNodeRefException {
    Set<QName> aspects =
      this.dbNodeService.getAspects(VersionUtil.convertNodeRef(nodeRef));
  ...
  public Map<QName, Serializable> getProperties(NodeRef nodeRef)
    ...
    Map<QName, Serializable> props = dbNodeService.getProperties(
      VersionUtil.convertNodeRef(nodeRef)
    );
  ...
  public List<ChildAssociationRef> getChildAssocs(
    ...
    for (ChildAssociationRef childAssocRef : childAssocRefs) {
      if (
        !childAssocRef
          .getTypeQName()
          .equals(Version2Model.CHILD_QNAME_VERSIONED_ASSOCS)
      ) {
  ...
  public List<AssociationRef> getTargetAssocs(
    ...
    for (ChildAssociationRef childAssocRef : childAssocRefs) {
      ...
      if (this.dbNodeService.exists(referencedNode)) {
        Long assocDbId = (Long) this.dbNodeService.getProperty(
            childRef,
