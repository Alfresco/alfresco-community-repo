...
public interface TicketComponent {
     ...
     *
     * @param userName String
     * @param autoCreate should we create one automatically if there isn't one?
     * @return - the ticket
     */
     ...
     *
     * <p>Tickets may be rejected because:
     *
     * <ol>
    ...
    /**
     * Does this ticket component support a single ticket per user or one ticket for each time they
     * login?
     *
     * @return boolean
     */
