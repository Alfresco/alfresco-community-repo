 ...
 * Template Service.
 *
 * <p>Provides an interface to services for executing template engine against a template file and
 * data model.
 *
 * <p>The service provides a configured list of available template engines. The template file can
 * either be in the repository (passed as NodeRef string) or on the classpath. Also a template can
 * be passed directly as a String using the processTemplateString() methods.
 *
 * <p>The data model is specified to the template engine. The FreeMarker template engine is used by
 * default.
 *
 * @author Kevin Roast
 */
...
public interface TemplateService {
     ...
     *
     * <p>The template engine used will be determined by the extension of the template.
     *
    ...
    /**
     * Process a template using the supplied locale against the supplied data model and write to the
     * out.
     *
     * @param engine Name of the template engine to use
    ...
    /**
     * Process a given template, provided as a string, against the supplied data model and return
    ...
    /**
     * Process a given template, provided as a string, against the supplied data model and report
     * the result back in the provided writer.
     *
     * @param engine Name of the template engine to use
     * @param template Template string
     * @param model Object model to process template against
    ...
    /**
     * Return a TemplateProcessor instance for the specified engine name. Note that the processor
