...
public class VirtualPreferenceServiceExtension
  ...
  private String getExtPreferenceKey(Map<String, Serializable> preferences) {
    String extKey = null;
    if (
      !preferences.containsKey(DOCUMENTS_FAVOURITES_KEY) &&
    ...
    while (iterator.hasNext()) {
      ...
      if (
        key.startsWith(EXT_DOCUMENTS_FAVOURITES) ||
      ...
      if (m.find()) {
        ...
        if (documentNodeRefStr != null && !documentNodeRefStr.isEmpty()) {
          ...
          if (reference != null) {
            ...
            String actualExtPreference =
              extFavKey + actualNodeRefStr + CREATED_AT;
            List<String> elements = new ArrayList<String>(
              Arrays.asList(favorites.split(comma))
            );
            ...
            if (favorites.contains(documentNodeRefStr)) { // add favorite
              ...
              if (!favorites.contains(actualNodeRefStr)) {
                favorites =
                  favorites.replace(documentNodeRefStr, actualNodeRefStr);
              } else {
