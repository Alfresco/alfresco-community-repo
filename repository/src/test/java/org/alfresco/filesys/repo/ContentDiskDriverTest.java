...
public class ContentDiskDriverTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    ApplicationContextFactory fileServers = (ApplicationContextFactory) this.applicationContext.getBean(
        "fileServers"
      );
    cifsHelper =
      (CifsHelper) fileServers.getApplicationContext().getBean("cifsHelper");
    driver =
      (ExtendedDiskInterface) this.applicationContext.getBean(
          "contentDiskDriver"
        );
    mlAwareNodeService =
      (NodeService) this.applicationContext.getBean("mlAwareNodeService");
    ...
    ownableService =
      (OwnableService) this.applicationContext.getBean("ownableService");
    fileFolderService =
      (FileFolderService) this.applicationContext.getBean("fileFolderService");
    checkOutCheckInService =
      (CheckOutCheckInService) this.applicationContext.getBean(
          "checkOutCheckInService"
        );
    ...
    RetryingTransactionCallback<Void> removeRootCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NodeRef rootNode = nodeService.getChildByName(
          companyHome,
  ...
  public void testGetFileInformation() throws Exception {
    ...
    final SrvSession testSession = new TestSrvSession(
      666,
      testServer,
      "test",
      "remoteName"
  ...
  public void testCreateFile() throws Exception {
    ...
    final NetworkFile file = driver.createFile(
      testSession,
      testConnection,
      params
    );
    ...
    RetryingTransactionCallback<Void> validateCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        NodeRef companyHome = repositoryHelper.getCompanyHome();
        NodeRef newNode = nodeService.getChildByName(
          companyHome,
          ContentModel.ASSOC_CONTAINS,
          FILE_NAME
        );
    ...
    FileInfo info = driver.getFileInformation(
      testSession,
      testConnection,
      FILE_PATH
    );
    ...
    assertEquals(
      "get Node For Path returned different node",
    ...
    FileOpenParams dirParams = new FileOpenParams(
      TEST_ROOT_DOS_PATH,
      openAction,
      AccessMode.ReadOnly,
    ...
    FileOpenParams file2Params = new FileOpenParams(
      FILE2_PATH,
      openAction,
      AccessMode.ReadOnly,
      FileAttribute.NTNormal,
    ...
    NetworkFile file2 = driver.createFile(
      testSession,
      testConnection,
      file2Params
    );
  ...
  public void testDeleteFile() throws Exception {
    ...
    ServerConfiguration scfg = new ServerConfiguration("testServer");
    TestServer testServer = new TestServer("testServer", scfg);
    SrvSession testSession = new TestSrvSession(
      666,
      testServer,
      "test",
      "remoteName"
  ...
  public void testSetFileInfo() throws Exception {
    ...
    final FileOpenParams params = new FileOpenParams(
      FILE_PATH,
      openAction,
      AccessMode.ReadWrite,
      FileAttribute.NTNormal,
  ...
  public void testOpenFile() throws Exception {
    ...
    testContext.testDirNodeRef =
      getNodeForPath(testConnection, TEST_ROOT_DOS_PATH);
    ...
    FileOpenParams rootParams = new FileOpenParams(
      "\\",
      FileAction.CreateNotExist,
      AccessMode.ReadWrite,
      FileAttribute.NTNormal,
    ...
    NetworkFile file3 = driver.openFile(
      testSession,
      testConnection,
      rootParams
    );
  ...
  public void testRenameFile() throws Exception {
    ...
    FileOpenParams params1 = new FileOpenParams(
      FILE_PATH1,
      0,
      AccessMode.ReadWrite,
      FileAttribute.NTNormal,
    ...
    final NetworkFile file1 = driver.createFile(
      testSession,
      testConnection,
      params1
    );

    FileOpenParams params3 = new FileOpenParams(
      FILE_PATH3,
      0,
      AccessMode.ReadWrite,
      FileAttribute.NTNormal,
    ...
    final NetworkFile file3 = driver.createFile(
      testSession,
      testConnection,
      params3
    );
    ...
    RetryingTransactionCallback<Void> validateCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        ChildAssociationRef parentRef = nodeService.getPrimaryParent(
          file2NodeRef
        );
        assertTrue(
    ...
    FileOpenParams params5 = new FileOpenParams(
      DIR_NEW_PATH,
      0,
      AccessMode.ReadWrite,
      FileAttribute.NTNormal,
    ...
    RetryingTransactionCallback<Void> validateStep5CB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        ChildAssociationRef parentRef5 = nodeService.getPrimaryParent(
          file5NodeRef
        );
  ...
  public void testScenarioRenameVersionableFile() throws Exception {
    ...
    RetryingTransactionCallback<Void> makeVersionableCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        ContentWriter contentWriter2 = contentService.getWriter(
          file1NodeRef,
          ContentModel.PROP_CONTENT,
          true
        );
        ...
        nodeService.setProperty(
          file1NodeRef,
          TransferModel.PROP_ENDPOINT_PROTOCOL,
          "http"
        );
  ...
  public void testScenarioMSWord2003SaveShuffle() throws Exception {
    ...
    final String FILE_DESCRIPTION =
      "This is a test document to test CIFS shuffle";
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSWord2003SaveShuffle";
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
         ...
         */
        FileOpenParams createRootDirParams = new FileOpenParams(
          TEST_ROOT_DOS_PATH,
          0,
          AccessMode.ReadWrite,
          FileAttribute.NTNormal,
        ...
        FileOpenParams createDirParams = new FileOpenParams(
          TEST_DIR,
          0,
          AccessMode.ReadWrite,
          FileAttribute.NTNormal,
         ...
         */
        FileOpenParams createFileParams = new FileOpenParams(
          TEST_DIR + "\\" + FILE_NAME,
          0,
          AccessMode.ReadWrite,
          FileAttribute.NTNormal,
    ...
    RetryingTransactionCallback<Void> writeFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        MLText multi = (MLText) mlAwareNodeService.getProperty(
          testContext.testNodeRef,
          RESIDUAL_MTTEXT
        );
        multi.getValues();
    ...
    RetryingTransactionCallback<Void> validateCB = new RetryingTransactionCallback<Void>() {
      @Override
      public Void execute() throws Throwable {
        NodeRef shuffledNodeRef = getNodeForPath(
          testConnection,
          TEST_DIR + "\\" + FILE_NAME
        );

        Map<QName, Serializable> props = nodeService.getProperties(
          shuffledNodeRef
        );
        ...
        Map<QName, Serializable> mlProps = mlAwareNodeService.getProperties(
          shuffledNodeRef
        );
        ...
        assertEquals(
          ...
          (
            (java.util.Date) nodeService.getProperty(
              shuffledNodeRef,
              ContentModel.PROP_CREATED
            )
          ).getTime()
  ...
  public void testScenarioMSWord2007Save() throws Exception {
    ...
    final String TEST_DIR =
      "\\ContentDiskDriverTest\\testScenarioMSWord2007Save";
    ServerConfiguration scfg = new ServerConfiguration("testServer");
    TestServer testServer = new TestServer("testServer", scfg);
    final SrvSession testSession = new TestSrvSession(
      666,
  ...
  public void testMetadataExtraction() throws Exception {
    ...
    RetryingTransactionCallback<Void> createRuleCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        Action extractAction = actionService.createAction(
          "extract-metadata",
          props
        );

        ActionCondition noCondition1 = actionService.createActionCondition(
          NoConditionEvaluator.NAME
        );
        extractAction.addActionCondition(noCondition1);

        ActionCondition noCondition2 = actionService.createActionCondition(
          NoConditionEvaluator.NAME
        );
        CompositeAction compAction = actionService.createCompositeAction();
        compAction.setTitle("Extract Metadata");
        compAction.setDescription(
          "Content Disk Driver Test - Extract Metadata"
        );
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        testContext.testNodeRef =
          getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME);
        assertNotNull(
          "testContext.testNodeRef is null",
          testContext.testNodeRef
        );
    ...
    RetryingTransactionCallback<Void> writeFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ClassPathResource fileResource = new ClassPathResource(
          "filesys/ContentDiskDriverTest1.docx"
        );
        assertNotNull(
    ...
    transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(writeFileCB, false, true);
      ...
      .doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            ContentData data = (ContentData) props.get(
              ContentModel.PROP_CONTENT
            );
     ...
     */
    logger.debug(
      "Step d: create update file in test directory " + FILE_NEW_TEMP
    );
    ...
    RetryingTransactionCallback<Void> writeFile2CB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ClassPathResource fileResource = new ClassPathResource(
          "filesys/ContentDiskDriverTest2.docx"
        );
        assertNotNull(
  ...
  public void testMetadataExtractionForMac() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testMetadataExtractionForMac";
  ...
  public void testDirListing() throws Exception {
    ...
    final String HIDDEN_FOLDER_NAME =
      "hiddenFolder" + System.currentTimeMillis();
    RetryingTransactionCallback<NodeRef> createNodesCB = new RetryingTransactionCallback<NodeRef>() {
      @Override
      public NodeRef execute() throws Throwable {
        NodeRef companyHome = repositoryHelper.getCompanyHome();
        NodeRef parentNode = nodeService
          .createNode(
            companyHome,
            ContentModel.ASSOC_CONTAINS,
            QName.createQName(
        ...
        NodeRef hiddenNode = nodeService
          .createNode(
            parentNode,
            ContentModel.ASSOC_CONTAINS,
            QName.createQName(
    ...
    SearchContext result = driver.startSearch(
      testSession,
      testConnection,
      "\\" + FOLDER_NAME + "\\*",
      0
  ...
  public void testFileInformationUpdatingByEditorUserForAlf8808()
    ...
    ServerConfiguration config = new ServerConfiguration(
      ContentDiskDriverTest.TEST_SERVER_NAME
    );
    ...
    final SrvSession session = new TestSrvSession(
      13,
      server,
        ...
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            try {
              ...
              testFile.value =
                getOrCreateNode(rootNode, "Test.txt", ContentModel.TYPE_CONTENT)
                  .getFirst();
  ...
  private Pair<org.alfresco.service.cmr.model.FileInfo, Boolean> getOrCreateNode(
    ...
    NodeRef result = nodeService.getChildByName(
      parentRef,
      ContentModel.ASSOC_CONTAINS,
      name
    );
    ...
    return new Pair<org.alfresco.service.cmr.model.FileInfo, Boolean>(
      fileFolderService.getFileInfo(result),
      created
    );
  }
  ...
  private void createUser(String name, String password, NodeRef parentNodeRef) {
    ...
    Pair<org.alfresco.service.cmr.model.FileInfo, Boolean> userHome = getOrCreateNode(
      parentNodeRef,
      name,
      ContentModel.TYPE_FOLDER
    );
  ...
  public void testExcel2003SaveShuffle() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSExcel2003SaveShuffle";
  ...
  public void testExcel2013SaveShuffle() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSExcel2013SaveShuffle";
    ...
    RetryingTransactionCallback<Void> createUsedTempFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NetworkFile fileHandle = driver.createFile(
          testSession,
          testConnection,
          createFileParams
        );
        ...
        String testContent =
          "MS Word 2013 shuffle test. This is used file content";
        byte[] testContentBytes = testContent.getBytes();
        fileHandle.writeFile(testContentBytes, testContentBytes.length, 0, 0);
        fileHandle.close();

        NodeRef usedRef = getNodeForPath(
          testConnection,
          TEST_DIR + "\\" + FILE_USED_TEMP
        );
    ...
    RetryingTransactionCallback<Void> createUnusedTempFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NetworkFile unusedFile = driver.createFile(
          testSession,
          testConnection,
          createFileParams
        );
        ...
        NodeRef unusedNodeRef = getNodeForPath(
          testConnection,
          TEST_DIR + "\\" + FILE_UNUSED_TEMP
        );
        nodeService.addAspect(
  ...
  public void testCSVExcel2003SaveShuffle() throws Exception {
    ...
    RetryingTransactionCallback<Void> createTestFileOneMore = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NetworkFile file = driver.createFile(
          testSession,
          testConnection,
          params
        );
  ...
  public void testScenarioMSWord2003SaveAsShuffle() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSWord2003SaveAsShuffle";
    ...
    RetryingTransactionCallback<Void> writeFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        ClassPathResource fileResource = new ClassPathResource(
          "filesys/ContentDiskDriverTest3.doc"
        );
        assertNotNull(
  ...
  public void testScenarioOpenCloseFile() throws Exception {
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NetworkFile dummy = driver.createFile(
          testSession,
          testConnection,
          createFileParams
        );
    ...
    FileOpenParams openRO = new FileOpenParams(
      FILE_PATH,
      FileAction.CreateNotExist,
      AccessMode.ReadOnly,
      FileAttribute.NTNormal,
    ...
    FileOpenParams openRW = new FileOpenParams(
      FILE_PATH,
      FileAction.CreateNotExist,
      AccessMode.ReadWrite,
      FileAttribute.NTNormal,
  ...
  public void testScenarioFrameMakerShuffle() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioFramemakerShuffle";
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertNotNull(
          "unable to find test resource filesys/X1.fm",
          fileResource
        );
        writeResourceToNetworkFile(fileResource, testContext.firstFileHandle);
        driver.closeFile(
        ...
        NodeRef file1NodeRef = getNodeForPath(
          testConnection,
          TEST_DIR + "\\" + FILE_NAME
        );
        nodeService.addAspect(
    ...
    RetryingTransactionCallback<Void> writeFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertNotNull(
          "unable to find test resource filesys/X2.fm",
          fileResource
        );
        writeResourceToNetworkFile(fileResource, testContext.firstFileHandle);
        driver.closeFile(
  ...
  public void testZeroByteRules() throws Exception {
    ...
    RetryingTransactionCallback<Void> createRuleCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        Action addVersionable = actionService.createAction(
          "add-features",
          props
        );
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
         ...
         */
        FileOpenParams createFileParams2 = new FileOpenParams(
        ...
        testContext.testNonZeroNodeRef =
          getNodeForPath(testConnection, TEST_DIR + "\\" + FILE_NAME_NON_ZERO);
        assertNotNull(
          "testContext.testNodeRef is null",
          testContext.testNonZeroNodeRef
        );
  ...
  public void testScenarioMSWord2003SaveAsShuffleCheckedOutFile()
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSWord2003ShuffleLockedFile";
  ...
  public void testScenarioMacLionTextEdit() throws Exception {
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        FileOpenParams createTempDirParams = new FileOpenParams(
          TEST_TEMP_DIR,
          0,
          AccessMode.ReadWrite,
          FileAttribute.NTNormal,
         ...
         */
        FileOpenParams createTempFileParams = new FileOpenParams(
        ...
        testContext.tempFileHandle =
          driver.createFile(testSession, testConnection, createTempFileParams);
  ...
  public void testScenarioMSPowerpoint2011MacSaveShuffle() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSPowerpoint2011MacSaveShuffle";
  ...
  public void testScenarioMSExcel2011MacSaveShuffle() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMSExcel2011MacSaveShuffle";
  ...
  public void testScenarioMSWord20011MacSaveWithBackup() throws Exception {
    ...
    final String TEST_DIR =
      "\\ContentDiskDriverTest\\testScenarioMSWord20011MacSaveWithBackup";
    final String TEST_TEMP_DIR =
      "\\ContentDiskDriverTest\\testScenarioMSWord20011MacSaveWithBackup\\.Temporary Items";
    ServerConfiguration scfg = new ServerConfiguration("testServer");
  ...
  public void testMacDragAndDrop() throws Exception {
    ...
    final TestContext testContext = tran.doInTransaction(
      createFileCB,
      false,
      true
    );
    ...
    RetryingTransactionCallback<Void> validateCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertEquals(
          "Node ref has changed",
          shuffledNodeRef,
          testContext.file1NodeRef
        );
        return null;
      }
    };
  ...
  public void testScenarioMountainLionWord2011() throws Exception {
    ...
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testScenarioMountainLionWord2011";
  ...
  public void testScenarioMacMountainLionPreview() throws Exception {
    ...
    final String TEST_DIR =
      "\\ContentDiskDriverTest\\testScenarioMountainLionPreview";
    final String TEST_TEMP_DIR =
  ...
  public void testScenarioMacMountainLionPreview_MNT_317() throws Exception {
    ...
    RetryingTransactionCallback<Void> renameFileCB = new RetryingTransactionCallback<Void>() {
      @Override
      public Void execute() throws Throwable {
        FileOpenParams openFileParams = new FileOpenParams(
          TEST_DIR + "\\" + FILE_NAME,
          0,
          AccessMode.ReadWrite,
          FileAttribute.NTNormal,
  ...
  public void testScenarioMacMountainLionKeynote_MNT_8558() throws Exception {
    ...
    final String TEST_DIR =
      "\\ContentDiskDriverTest\\testScenarioMountainLionKeynote";
    final String TEST_TEMP_DIR =
  ...
  public void testWindows7Explorer() throws Exception {
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertNotNull(
          "unable to find test resource filesys/ContentDiskDriverTestMark.jpg",
          fileResource
        );
        writeResourceToNetworkFile(fileResource, testContext.firstFileHandle);
        driver.closeFile(
    ...
    RetryingTransactionCallback<Void> writeFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertNotNull(
          "unable to find test resource filesys/ContentDiskDriverTestMark2.jpg",
          fileResource
        );
  ...
  private void doTransactionWorkAsEditor(
    final RunAsWork<Void> work,
    RetryingTransactionHelper tran
  ) {
  ...
  public void testScenarioMacLionTextEditByEditor_ALF_16257() throws Exception {
    logger.debug(
      "test Collaborator/editor edit txt file on Mac Os Mountain Lion : Alf16257"
    );
    final String FILE_NAME = "test.txt";
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        String testContent =
          "CIFS: Collaborator/editor could not edit file on Mac Os Mountain Lion";
        byte[] testContentBytes = testContent.getBytes();
        testContext.firstFileHandle.writeFile(
          testContentBytes,
          testContentBytes.length,
    ...
    RunAsWork<Void> saveNewFileCB = new RunAsWork<Void>() {
      ...
      public Void doWork() throws Exception {
        ...
        NodeRef tempNodeRef = getNodeForPath(
          testConnection,
          TEST_TEMP_DIR + "\\" + FILE_NEW_TEMP
        );
        ContentReader reader = contentService.getReader(
   ...
   */
  public void testScenarioMountainLionWord2011EditByEditor_ALF_16257()
    throws Exception {
    ...
    tran.doInTransaction(validateCB, true, true);
    logger.debug(
      "end testScenarioMountainLionWord2011 Edit By Editor ALF-16257"
    );
  ...
  public void testMimetypeWithSufficientData() throws Exception {
    ...
    final TestContext testContext = new TestContext();
    final String TEST_DIR =
      TEST_ROOT_DOS_PATH + "\\testMimetypeWithSufficientData";
    ...
    RetryingTransactionCallback<Void> createFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        ClassPathResource fileResource = new ClassPathResource(
          "filesys/ContentDiskDriverTestTxt1.txt"
        );
    ...
    RetryingTransactionCallback<Void> updateFileCB = new RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Exception {
        ...
        NetworkFile file = driver.openFile(
          testSession,
          testConnection,
          createFileParams
        );
   ...
   * @throws IOException
   */
  private void writeResourceToNetworkFile(
