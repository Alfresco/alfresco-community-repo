...
public class HasAspectEvaluatorTest extends BaseSpringTest {
  ...
  public void before() throws Exception {
    ...
    this.evaluator =
      (HasAspectEvaluator) this.applicationContext.getBean(
          HasAspectEvaluator.NAME
        );
  }

  @Test
  public void testMandatoryParamsMissing() {
    ActionCondition condition = new ActionConditionImpl(
      ID,
      HasAspectEvaluator.NAME,
      null
    );
    ...
    try {
      ...
      fail(
        "The fact that a mandatory parameter has not been set should have been detected."
      );
  ...
  public void testPass() {
    ...
    condition.setParameterValue(
      HasAspectEvaluator.PARAM_ASPECT,
      ContentModel.ASPECT_VERSIONABLE
    );
