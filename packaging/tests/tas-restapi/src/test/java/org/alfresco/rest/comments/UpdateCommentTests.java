...
public class UpdateCommentTests extends RestTest {
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.COMMENTS},
            executionType = ExecutionType.SANITY,
            description = "Verify Admin user updates comments and status code is 200")
    ...
    public void adminIsAbleToUpdateHisComment() throws Exception {
        ...
        commentModel =
                restClient
                        ...
                        .addComment("This is a new comment added by admin");
        String updatedContent = "This is the updated comment with admin user";
        restClient
                .withCoreAPI()
                .usingResource(document)
                .updateComment(commentModel, updatedContent)
                .assertThat()
                .field("content")
                .isNotEmpty()
                .and()
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.COMMENTS},
            executionType = ExecutionType.SANITY,
            description = "Verify unauthenticated user gets status code 401 on update comment call")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.SANITY})
    ...
    public void unauthenticatedUserIsNotAbleToUpdateComment() throws Exception {
        ...
        commentModel =
                restClient
                        .withCoreAPI()
                        .usingResource(document)
                        .addComment("To be updated by unauthenticated user.");
        UserModel incorrectUserModel = new UserModel("userName", "password");
        restClient
                .authenticateUser(incorrectUserModel)
                .withCoreAPI()
                .usingResource(document)
                .updateComment(commentModel, "try to update");
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.COMMENTS},
            executionType = ExecutionType.SANITY,
            description = "Verify entry content in response")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.SANITY})
    public void checkEntryContentInResponse() throws Exception {
        ...
        commentModel =
                restClient
                        .withCoreAPI()
                        .usingResource(document)
                        .updateComment(commentModel, "This is the updated comment with admin user");
        restClient.assertStatusCodeIs(HttpStatus.OK);
        commentModel
                .assertThat()
                .field("content")
                .is("This is the updated comment with admin user");
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify Manager user updates comments created by admin user and status code is"
                            + " 200")
    ...
    public void managerIsAbleToUpdateHisComment() throws Exception {
        ...
        commentModel =
                restClient
                        .withCoreAPI()
                        .usingResource(document)
                        .addComment("This is a new comment added by manager");
        restClient
                .withCoreAPI()
                .usingResource(document)
                .updateComment(commentModel, "This is the updated comment with Manager user")
                .and()
                .field("content")
                .is("This is the updated comment with Manager user")
                .and()
                .field("canEdit")
                .is(true)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user can update his own comment and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void contributorIsAbleToUpdateHisComment() throws Exception {
        ...
        commentModel =
                restClient
                        .withCoreAPI()
                        .usingResource(document)
                        .addComment("This is a new comment added by contributor");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user can not update comments created by admin user and status"
                            + " code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void consumerIsNotAbleToUpdateComment() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingResource(document)
                .updateComment(commentModel, "This is the updated comment with Consumer user");
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator user can update his own comment and status code is 200")
    //    @Bug(id="REPO-1011")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void collaboratorIsAbleToUpdateHisComment() throws Exception {
        ...
        commentModel =
                restClient
                        .withCoreAPI()
                        .usingResource(document)
                        .addComment("This is a new comment added by collaborator");
        restClient
                .withCoreAPI()
                .usingResource(document)
                .updateComment(commentModel, "This is the updated comment with Collaborator user");
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator user can not update comments of another user and status"
                            + " code is 200")
    //  @Bug(id="MNT-2502",description="seems it's one old issue: also logged as MNT-2502,
    // MNT-2346")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.COMMENTS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify update comment with inexistent nodeId returns status code 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void canNotUpdateCommentIfNodeIdIsNotSet() throws Exception {
        ...
        restClient
                ...
                .updateComment(commentModel, "This is the updated comment.");
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary("node ref that does not exist was not found");
    }
    ...
    public void canNotUpdateCommentIfCommentIdIsNotSet() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingResource(document)
                .updateComment(comment, "This is the updated comment.");
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, id));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify can not update comment if NodeId is neither document or folder and"
    ...
    public void canNotUpdateCommentIfNodeIdIsNeitherDocumentOrFolder() throws Exception {
        ...
        restClient.authenticateUser(adminUserModel);
        commentModel =
                restClient.withCoreAPI().usingResource(content).addComment("This is a new comment");

        LinkModel link = dataLink.usingAdmin().usingSite(siteModel).createRandomLink();
        content.setNodeRef(
                link.getNodeRef()
                        .replace("workspace://SpacesStore/", "workspace%3A%2F%2FSpacesStore%2F"));
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, content.getNodeRef()))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user is not able to update with empty comment body and status"
                            + " code is 400")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void adminIsNotAbleToUpdateWithEmptyCommentBody() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary("An invalid argument was received");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify updated comment by Manager is listed when calling getComments and"
                            + " status code is 200")
    //    @Bug(id="REPO-1011")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void updatedCommentByManagerIsListed() throws Exception {
        ...
        restClient.assertStatusCodeIs(HttpStatus.OK);
        comments.assertThat()
                .entriesListContains("content", "This is the updated comment with Manager user");
    }
    ...
    public void managerIsAbleToUpdateACommentWithALargeString() throws Exception {
        ...
        returnedCommentModel =
                restClient
                        .authenticateUser(usersWithRoles.getOneUserWithRole(UserRole.SiteManager))
                        .withCoreAPI()
                        .usingResource(file)
                        .updateComment(commentModel, longString);
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    public void managerIsAbleToUpdateACommentWithAShortString() throws Exception {
        ...
        returnedCommentModel =
                restClient
                        ...
                        .withCoreAPI()
                        .usingResource(file)
                        .updateComment(commentModel, shortString);
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    public void collaboratorIsAbleToUpdateACommentThatContainsSpecialChars() throws Exception {
        ...
        returnedCommentModel =
                restClient
                        ...
                        .withCoreAPI()
                        .usingResource(file)
                        .updateComment(commentModel, specialChars);
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that you cannot update comment with Consumer then call getComments and"
                            + " check new comment is not listed")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void cannotUpdateCommentWithConsumerCallGetComments() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingResource(file)
                .updateComment(commentModel, updatedComment);
        restClient
                .assertStatusCodeIs(HttpStatus.FORBIDDEN)
                .assertLastError()
                .containsSummary(RestErrorModel.PERMISSION_WAS_DENIED);
        ...
        restClient.assertStatusCodeIs(HttpStatus.OK);
        comments.assertThat()
                .entriesListContains("content", firstComment)
                .and()
                .entriesListDoesNotContain("content", updatedComment)
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Update comment with Contributor then call getComments and check new comment is"
                            + " listed")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    @Bug(id = "ACE-4614")
    public void updateCommentWithContributorCallGetComments() throws Exception {
        ...
        restClient.assertStatusCodeIs(HttpStatus.OK);
        comments.assertThat()
                .entriesListContains("content", updatedComment)
                .and()
                .entriesListDoesNotContain("content", firstComment)
                .and()
                .paginationField("totalItems")
                .is("1");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Update comment with Collaborator then call getComments and check new comment"
                            + " is listed")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Update comment with Manager then check modified by information in response")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    public void managerIsAbleToUpdateACommentWithMultiByteContent() throws Exception {
        ...
        returnedCommentModel =
                restClient
                        ...
                        .withCoreAPI()
                        .usingResource(file)
                        .updateComment(commentModel, multiByte);
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    public void adminIsAbleToUpdateACommentWithPropertiesParameter() throws Exception {
        ...
        returnedCommentModel =
                restClient
                        .authenticateUser(manager)
                        .withParams("properties=createdBy,modifiedBy,canEdit,canDelete")
                        .withCoreAPI()
                        .usingResource(file)
                        .updateComment(commentModel, updatedComment);
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify update comment from node with invalid network id returns status code"
                            + " 401")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void updateCommentWithInvalidNetworkId() throws Exception {
        ...
        restClient
                .authenticateUser(networkUserModel)
                .withCoreAPI()
                .usingResource(file)
                .updateComment(commentModel, updatedComment);
        restClient.assertStatusCodeIs(HttpStatus.UNAUTHORIZED);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify User can not update comment to a not joined private site. Status code"
                            + " returned is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    public void userCanNotUpdateCommentToANotJoinedPrivateSiteDefaultErrorModelSchema()
            throws Exception {
