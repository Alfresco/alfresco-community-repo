...
public class OAuth1CredentialsStoreServiceImpl
  ...
  public OAuth1CredentialsInfo storePersonalOAuth1Credentials(
    ...
    OAuth1CredentialsInfo credentials = buildPersonalOAuth1CredentialsInfo(
      remoteSystemId,
      token,
      secret
    );
    ...
    if (credentials.getNodeRef() != null) {
      return (OAuth1CredentialsInfo) remoteCredentialsService.updateCredentials(
        credentials
      );
    } else {
  ...
  public OAuth1CredentialsInfo storeSharedOAuth1Credentials(
    ...
    OAuth1CredentialsInfo credentials = buildSharedOAuth1CredentialsInfo(
      remoteSystemId,
      token,
      secret
    );
  ...
  public OAuth1CredentialsInfo updateSharedOAuth1Credentials(
    ...
    List<OAuth1CredentialsInfo> shared = listSharedOAuth1Credentials(
      remoteSystemId
    );
   ...
   */
  @Override
  public OAuth1CredentialsInfo getPersonalOAuth1Credentials(
    String remoteSystemId
  ) throws NoSuchSystemException {
    return (OAuth1CredentialsInfo) remoteCredentialsService.getPersonCredentials(
      remoteSystemId
    );
  }
   ...
   */
  @Override
  public List<OAuth1CredentialsInfo> listSharedOAuth1Credentials(
    String remoteSystemId
  ) throws NoSuchSystemException {
    ...
    PagingResults<OAuth1CredentialsInfo> pagingResults = (PagingResults<OAuth1CredentialsInfo>) remoteCredentialsService.listSharedCredentials(
      remoteSystemId,
  ...
  public boolean deletePersonalOAuth1Credentials(String remoteSystemId)
    throws NoSuchSystemException {
    OAuth1CredentialsInfo credentials = getPersonalOAuth1Credentials(
      remoteSystemId
    );
  ...
  public OAuth1CredentialsInfo updateCredentialsAuthenticationSucceeded(
    ...
    return (OAuth1CredentialsInfo) remoteCredentialsService.updateCredentialsAuthenticationSucceeded(
      succeeded,
      credentials
    );
  }
