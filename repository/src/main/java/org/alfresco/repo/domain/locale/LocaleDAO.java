...
public interface LocaleDAO
{
    ...
    /**
     * @param locale
     *            the locale to fetch or <tt>null</tt> to get the default locale
     * @return the locale or <tt>null</tt> if no such locale exists
     */
    Pair<Long, Locale> getLocalePair(Locale locale);

    /**
     * @return the locale pair for the default locale. Although the <tt>Locale</tt> object will be populated, the ID will point to an instance that generically refers to the system's default locale i.e. the value returned can vary depending on the executing thread's default locale.
     */
     ...
     * 
     * @param locale
     *            the locale to fetch or <tt>null</tt> to get or create the default locale.
