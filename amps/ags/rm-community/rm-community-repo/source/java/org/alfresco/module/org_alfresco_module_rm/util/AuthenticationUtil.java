...
public class AuthenticationUtil {
  ...
  public <R> R runAsSystem(RunAsWork<R> runAsWork) {
    return org.alfresco.repo.security.authentication.AuthenticationUtil.runAsSystem(
      runAsWork
    );
  }
  ...
  public <R> R runAs(RunAsWork<R> runAsWork, String uid) {
    return org.alfresco.repo.security.authentication.AuthenticationUtil.runAs(
      runAsWork,
      uid
    );
  }
