...
public class WorkflowDefinitionGet extends AbstractWorkflowWebscript {
  ...
  private static final String PARAM_WORKFLOW_DEFINITION_ID =
  ...
  protected Map<String, Object> buildModel(
    ...
    WorkflowDefinition workflowDefinition = workflowService.getDefinitionById(
      workflowDefinitionId
    );
    ...
    model.put(
      "workflowDefinition",
      modelBuilder.buildDetailed(workflowDefinition)
    );
    return model;
  }
}
