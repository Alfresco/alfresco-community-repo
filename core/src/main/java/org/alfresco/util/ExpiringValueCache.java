 ...
 *
 * <p>The object placed in the cache will automatically be discarded after a timeout value.
 *
 * @author Kevin Roast
 */
public class ExpiringValueCache<T> implements Serializable {
    ...
    private static final long TIMEOUT_DEFAULT = 1000L * 60L;
     ...
     * Default constructor.
     *
     * <p>Uses the default timeout of 1 minute.
     */
    ...
    /**
     * Put a value into the cache. The item will be return from the associated get() method until
     * the timeout expires then null will be returned.
     *
    ...
    /**
     * Get the cached object. The set item will be returned until it expires, then null will be
     * returned.
     *
