...
/**
 * This {@link NodeLocator} identifies a node from an XPath provided via the <code>xpath</code>
 * parameter.
 *
 * @author Nick Smith
 * @since 4.0
...
public class XPathNodeLocator extends AbstractNodeLocator {
    ...
    public List<ParameterDefinition> getParameterDefinitions() {
        ...
        paramDefs.add(
                new ParameterDefinitionImpl(QUERY_KEY, DataTypeDefinition.TEXT, true, "Query"));
        paramDefs.add(
                new ParameterDefinitionImpl(
                        STORE_TYPE_KEY, DataTypeDefinition.TEXT, false, "Store Type"));
        paramDefs.add(
                new ParameterDefinitionImpl(
                        STORE_ID_KEY, DataTypeDefinition.TEXT, false, "Store Id"));
        return paramDefs;
    }
