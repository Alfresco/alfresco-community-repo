...
public class UpgradePasswordHashTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        SimpleCache<String, RepositoryAuthenticationDao.CacheEntry> authenticationCache =
                (SimpleCache<String, RepositoryAuthenticationDao.CacheEntry>)
                        ctx.getBean("authenticationCache");
        SimpleCache<String, NodeRef> immutableSingletonCache =
