 ...
 *
 * <p>NOTE: this could be removed, but is being kept as a place holder for future development
 *
...
public class ScriptRecordsManagmentNode extends ScriptNode {
    ...
    public ScriptRecordsManagmentNode(
            NodeRef nodeRef, RecordsManagementServiceRegistry services, Scriptable scope) {
    ...
    public boolean hasCapability(String capabilityName) {
        ...
        if (capability != null) {
            Map<Capability, AccessStatus> map =
                    capabilityService.getCapabilitiesAccessState(
                            nodeRef, Collections.singletonList(capabilityName));
