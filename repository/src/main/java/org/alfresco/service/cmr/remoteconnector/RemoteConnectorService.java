 ...
 *
 * <p>The default implementation of the service works with HttpClient internally, but other
 * implementations (such as testing loopback) can be used.
 *
 * @author Nick Burch
 * @since 4.0.2
 */
public interface RemoteConnectorService {
     ...
     */
    RemoteConnectorResponse executeRequest(RemoteConnectorRequest request)
     ...
     */
    JSONObject executeJSONRequest(RemoteConnectorRequest request)
