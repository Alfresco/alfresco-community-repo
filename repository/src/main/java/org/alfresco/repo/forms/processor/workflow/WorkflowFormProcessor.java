...
public class WorkflowFormProcessor
   ...
   */
  @Override
  protected Map<QName, Serializable> getAssociationValues(
   ...
   */
  @Override
  protected Map<QName, Serializable> getPropertyValues(
    WorkflowDefinition item
  ) {
    return null;
  }
  ...
  protected Map<String, Object> getTransientValues(WorkflowDefinition item) {
    return Collections.<String, Object>singletonMap(
      PackageItemsFieldProcessor.KEY,
   ...
   */
  @Override
  protected ContentModelFormPersister<WorkflowInstance> makeFormPersister(
    WorkflowDefinition item
  ) {
    ContentModelItemData<WorkflowDefinition> itemData = makeItemData(item);
    return new WorkflowFormPersister(
      itemData,
      namespaceService,
      dictionaryService,
      workflowService,
