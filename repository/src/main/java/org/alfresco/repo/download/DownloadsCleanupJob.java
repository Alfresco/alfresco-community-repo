...
public class DownloadsCleanupJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        final TenantAdminService tenantAdminService =
                (TenantAdminService) jobData.get(KEY_TENANT_ADMIN_SERVICE);
        ...
        final boolean cleanAllSysDownloadFolders =
                Boolean.parseBoolean((String) jobData.get(CLEAN_All_SYS_DOWNLOAD_FOLDERS));
                ...
                new RunAsWork<Object>() {
                    public Object doWork() throws Exception {
                        downloadService.deleteDownloads(
                                before.toDate(), batchSize, cleanAllSysDownloadFolders);
                        return null;
                    }
                },
