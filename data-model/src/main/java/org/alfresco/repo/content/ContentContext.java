 ...
 * a content writer is the content URL and any previous content that may have logically existed.
 *
 * <p>Although this class is doesn't enforce any conditions on the context, derived instances may
 * have relationships that need to be maintained between various context values.
 *
 * @author Derek Hulley
 */
