...
/**
 * Tests for /api-explorer/#!/trashcan/listDeletedNodes /api-explorer/#!/trashcan/deleteDeletedNode
 * /api-explorer/#!/trashcan/getDeletedNode /api-explorer/#!/trashcan/restoreDeletedNode
 *
 * @author jcule
 */
public class GetDeletedNodesTests extends RestTest {
    ...
    public void testDeletedNodesBiggerThanMaxCount() throws Exception {
        ...
        String hasMoreItemsMaxItem =
                Boolean.toString(deletedNodesMaxItem.getPagination().isHasMoreItems());
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Sanity tests for DELETE /deleted-nodes/{nodeId} and POST"
    ...
    public void testDeleteAndRestoreNodeFromTrashcan() throws Exception {
        ...
        deleteNodesFolder5 =
                dataContent
                        ...
                        .usingSite(deleteNodesSiteModel)
                        .createFolder();
        String docLibNodeRef =
                dataContent.usingUser(adminUserModel).usingSite(deleteNodesSiteModel).getNodeRef();
        file1 =
                dataContent
                        .usingUser(adminUserModel)
                        .usingSite(deleteNodesSiteModel)
    ...
    @Bug(id = "REPO-4484")
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.TRASHCAN, TestGroup.REQUIRE_SOLR},
            executionType = ExecutionType.SANITY,
            description =
                    "Sanity tests for GET /deleted-nodes/{nodeId}/renditions, GET"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Sanity test to verify Range request header on GET"
                            + " /deleted-nodes/{nodeId}/renditions/{renditionId}/content endpoint")
    @Test(groups = {TestGroup.REST_API, TestGroup.TRASHCAN, TestGroup.SANITY, TestGroup.RENDITIONS})
