...
public class PersonPropertyLookup implements PropertyLookup<String> {
    ...
    public String lookup(String propertyValue) {
        Map<String, UserInfo> mapUserInfo =
                TransactionalResourceHelper.getMap("PERSON_PROPERTY_LOOKUP_USER_INFO_CACHE");
        UserInfo user =
                Node.lookupUserInfo(propertyValue, mapUserInfo, serviceRegistry.getPersonService());
