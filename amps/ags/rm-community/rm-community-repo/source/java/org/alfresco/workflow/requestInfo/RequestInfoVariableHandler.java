...
/**
 * A variable handler for saving the task variables to the execution context. Some of the
 * information will be needed in other tasks (e.g. "rmwf_message"). This variable handler saves the
 * local task variable to the execution context.
 *
 * @author Tuna Aksoy
 * @since 2.1
 */
