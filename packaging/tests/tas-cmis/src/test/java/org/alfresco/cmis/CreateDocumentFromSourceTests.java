...
public class CreateDocumentFromSourceTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to create file from source in DocumentLibrary with"
                            + " CMIS")
    ...
    @TestRail(
            ...
            description =
                    "Verify inexistent user isn't able to create file from source in"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthorized user isn't able to create file from source in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.SANITY, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager user is not able to create document from source twice in"
                            + " the same location with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin user is not able to create document from source with invalid"
                            + " source with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager user is not able to create document from source with"
                            + " invalid characters with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM},
    ...
    public void siteManagerCannotCreateDocFromSourceWithInvalidChars() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager)
                .usingSite(publicSite)
                .createFileFromSource(invalidCharDoc, sourceFile);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin user is not able to create document from source at invalid"
                            + " location with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisObjectNotFoundException.class)
    ...
    @TestRail(
            ...
            description =
                    "Verify that manager user is not able to create document from source with"
                            + " invalid base type id with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM},
            expectedExceptions = CmisContentAlreadyExistsException.class)
    public void siteManagerCannotCreateDocFromSourceWithInvalidBaseTypeId() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager)
                ...
                .then()
                .usingSite(publicSite)
                .createFileFromSource(newFile, sourceFile, "cmis:fakeType");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager user is not able to create an unnamed document from source"
                            + " with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to create file from source added by another user"
                            + " with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to create file from source added by another"
                            + " user with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to create file from source added by another"
                            + " user with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to create file from source with versioning state"
                            + " set to Minor with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin user is not able to create document from null source with"
                            + " CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager is able to create document from a source that is checked"
                            + " out with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager is able to create document from a source from his private"
                            + " site with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that an user is not able to create document from a source from a"
