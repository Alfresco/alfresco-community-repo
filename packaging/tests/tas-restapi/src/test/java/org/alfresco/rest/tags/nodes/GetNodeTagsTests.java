...
public class GetNodeTagsTests extends TagsDataPrep {
  ...
  @TestRail(
    ...
    description = "Verify site Manager is able to get node tags"
  )
  ...
  @TestRail(
    ...
    description = "Verify site Collaborator is able to get node tags"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site Contributor is able to get node tags"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify site Consumer is able to get node tags"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify admin is able to get node tags"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.SANITY,
    description = "Verify unauthenticated user is not able to get node tags"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.SANITY })
  //    @Bug(id = "MNT-16904", description = "fails only on environment with tenants")
  public void unauthenticatedUserIsNotAbleToRetrieveNodeTags()
    throws Exception {
    restClient.authenticateUser(
  ...
  public void userWithoutPermissionsTest() throws Exception {
    ...
    FileModel moderatedDocument = dataContent
      .usingSite(moderatedSite)
      .usingUser(adminUserModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);

    restClient
      .authenticateUser(dataUser.createRandomTestUser())
      .withCoreAPI()
      .usingResource(moderatedDocument)
      .getNodeTags();
    restClient
  ...
  public void nonexistentNodeTest() throws Exception {
    FileModel badDocument = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);
    ...
    restClient
      ...
      .withCoreAPI()
      .usingResource(badDocument)
      .getNodeTags();
    restClient
      .assertStatusCodeIs(HttpStatus.NOT_FOUND)
      .assertLastError()
      .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, nodeRef));
  }
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  public void siteManagerIsAbleToRetrieveNodeTagsWithPropertiesParameter()
    throws Exception {
    returnedCollection =
      restClient
        .authenticateUser(
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  public void collaboratorGetNodeTagsUseSiteIdInsteadOfNodeId()
    throws Exception {
  ...
  public void adminUserGetLast2TagsAndSkipFirst2Tags() throws Exception {
    ...
    returnedCollection
      .assertThat()
      .entriesListContains("tag", thirdTag.toLowerCase())
      .and()
      .entriesListContains("tag", fourthTag.toLowerCase());
    returnedCollection
      .getPagination()
      .assertThat()
      .field("maxItems")
