...
public class UnfiledRecordFolderEntityResource
    ...
    @WebApiDescription(
            ...
            description =
                    "Gets information for an unfiled record folder with id 'unfiledRecordFolderId'")
    ...
    public UnfiledRecordFolder update(
        ...
        NodeRef nodeRef =
                apiUtils.lookupAndValidateNodeType(
                        unfiledRecordFolderId, RecordsManagementModel.TYPE_UNFILED_RECORD_FOLDER);
        ...
        apiUtils.postActivity(
                info, unfiledRecordFolderInfo.getParentId(), ActivityType.FILE_UPDATED);
        return nodesModelFactory.createUnfiledRecordFolder(info, parameters, null, false);
    }
