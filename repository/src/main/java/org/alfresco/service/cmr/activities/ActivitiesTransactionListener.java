...
/**
 * A Transaction Listener to post activities once the transaction has been committed, or at the end
 * of a read-only transaction.
 *
 * @author Gethin James
 */
public class ActivitiesTransactionListener implements TransactionListener {
    ...
    public ActivitiesTransactionListener(
            String activityType,
