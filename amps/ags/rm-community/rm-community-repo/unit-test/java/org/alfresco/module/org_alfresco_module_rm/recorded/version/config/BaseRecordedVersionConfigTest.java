 ...
 * @since 2.3
 */
public abstract class BaseRecordedVersionConfigTest
  extends BaseWebScriptUnitTest
  implements RecordableVersionModel {

  /** Recorded version config web script root folder */
  protected static final String RECORDED_VERSION_CONFIG_WEBSCRIPT_ROOT =
    "alfresco/templates/webscripts/org/alfresco/slingshot/documentlibrary/action/";
  ...
  protected Map<String, String> buildParameters() {
    ...
    return buildParameters(
      "store_type",
      testdoc.getStoreRef().getProtocol(),
      "store_id",
      testdoc.getStoreRef().getIdentifier(),
      "id",
      testdoc.getId()
    );
  }
