...
/**
 * A repository context in which a {@link NodeRefPathExpression} should resolve to a {@link NodeRef} using a relative name or qname path.
 */
public interface NodeRefContext
{
     ...
     * @param namePath
     * @param resolver
     * @return the {@link NodeRef} the given name path resolves to using the supplied resolver.
     */
     ...
     * @param qNamePath
     * @param resolver
     * @return the {@link NodeRef} the given {@link QName} prefixed string path resolves to using the supplied resolver.
     */
