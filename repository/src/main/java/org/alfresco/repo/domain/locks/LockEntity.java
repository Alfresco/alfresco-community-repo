 ...
 *
 * <p>These are unique (see {@link #equals(Object) equals} and {@link #hashCode() hashCode}) based
...
public class LockEntity {
        ...
        if (this == obj) {
            ...
            return EqualsHelper.nullSafeEquals(this.sharedResourceId, that.sharedResourceId)
                    && EqualsHelper.nullSafeEquals(
                            this.exclusiveResourceId, that.exclusiveResourceId);
        } else {
            return false;
        }
    }
    ...
    /**
     * Determine if the lock is logically exclusive. A lock is <b>exclusive</b> if the shared lock
     * resource matches the exclusive lock resource.
     *
