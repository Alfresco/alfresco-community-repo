...
public abstract class QueryHelper {
  ...
  public static class WalkerCallbackAdapter implements WalkerCallback {
    ...
    protected static final InvalidQueryException UNSUPPORTED = new InvalidQueryException(
      UNSUPPORTED_TEXT
    );
   ...
   */
  protected static void callbackTree(
    Tree tree,
    ...
    if (tree != null) {
      switch (tree.getType()) {
        ...
        case WhereClauseParser.GREATERTHANOREQUALS:
          if (
            WhereClauseParser.PROPERTYNAME == tree.getChild(0).getType() &&
  ...
  public static String stripQuotes(String toBeStripped) {
    if (
      StringUtils.isNotEmpty(toBeStripped) &&
