...
public interface TemplatePermissions extends TemplateNodeRef {
    /**
     * @return List of permissions applied to this Node. Strings returned are of the format
     *     [ALLOWED|DENIED];[USERNAME|GROUPNAME];PERMISSION for example ALLOWED;kevinr;Consumer so
     *     can be easily tokenized on the ';' character.
     */
