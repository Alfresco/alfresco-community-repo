...
public class MultiTDemoTest extends TestCase {
  ...
  private static Set<StoreRef> DEFAULT_STORES = new HashSet<StoreRef>(
    Arrays.asList(
      new StoreRef[] {
              ...
              new TenantRunAsWork<Object>() {
                public Object doWork() throws Exception {
                  if (tenantAdminService.existsTenant(tenantDomain)) {
                    ...
                    {
                      BehaviourFilter behaviourFilter = (BehaviourFilter) ctx.getBean(
  ...
  private void createUsers() {
    for (final String tenantDomain : tenants) {
      String tenantAdminName = tenantService.getDomainUser(
        AuthenticationUtil.getAdminUserName(),
        tenantDomain
      );
  ...
  public void test01CreateTenants() throws Throwable {
    ...
    List<PersonInfo> persons = personService
      .getPeople(
        null,
        true,
        null,
    ...
    TenantUtil.runAsUserTenant(
      new TenantRunAsWork<Object>() {
        public Object doWork() throws Exception {
          ...
          Set<String> auths = authorityService.getAllAuthorities(
            AuthorityType.GROUP
          );
  ...
  private void createGroup(String shortName, String parentShortName) {
    ...
    String groupName =
      this.authorityService.getName(AuthorityType.GROUP, shortName);
  ...
  private NodeRef createUser(
    ...
    if (!this.authenticationService.authenticationExists(userName)) {
      ...
      personProperties.put(
        ...
        baseUserName + "-" + tenantDomain
      ); // add domain suffix here for demo only
      ...
      NodeRef checkHomeSpaceRef = (NodeRef) nodeService.getProperty(
        personNodeRef,
        ContentModel.PROP_HOMEFOLDER
      );
  ...
  private NodeRef getWebClientExtensionNodeRef(StoreRef storeRef) {
    ...
    return findFolderNodeRef(
      storeRef,
      "/app:company_home/app:dictionary/app:webclient_extension"
    );
  }
  ...
  private NodeRef findFolderNodeRef(StoreRef storeRef, String folderXPath) {
    ...
    if (nodeRefs.size() != 1) {
      throw new AlfrescoRuntimeException(
        "Cannot find folder location: " + folderXPath
      );
    } else {
  ...
  private void setupHomeSpacePermissions(
  ...
  private SiteInfo createSite(String siteId) {
    ...
    NodeRef result = siteService.getContainer(
      siteId,
  ...
  public void test02NonSharedGroupDeletion() {
    ...
    try {
      ...
      final String tenantAdminName1 = tenantService.getDomainUser(
        AuthenticationUtil.getAdminUserName(),
        tenantDomain1
      );
      final String tenantAdminName2 = tenantService.getDomainUser(
        AuthenticationUtil.getAdminUserName(),
        tenantDomain2
      );
      ...
      clearUsage(tenantDomain1);
      checkTestAuthoritiesPresence(
        tenantUniqueGroupNames,
        tenantAdminName1,
        true
      );
  ...
  public void test03SharedGroupDeletion() {
    ...
    try {
      ...
      clearUsage(tenantDomain1);
      createTestAuthoritiesForTenant(
        commonTenantUniqueGroupNames,
        tenantAdminName1
      );
      ...
      // Delete tenant1's authorities
      clearUsage(tenantDomain1);
      deleteTestAuthoritiesForTenant(
        commonTenantUniqueGroupNames,
        tenantAdminName1
      );
          ...
          new TenantRunAsWork<Object>() {
            public Object doWork() throws Exception {
              ...
              for (PersonInfo person : persons) {
                ...
                logger.info(
                  "Validate users: get all people - found user: " + userName
                );
  ...
  public void test09CreateGroups() {
    ...
    final int rootGrpsOrigCnt = TenantUtil.runAsUserTenant(
    ...
    for (final String tenantDomain : tenants) {
      final String tenantAdminName = tenantService.getDomainUser(
        AuthenticationUtil.getAdminUserName(),
        tenantDomain
      );
    ...
    for (final String tenantDomain : tenants) {
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            Set<String> rootGrps = authorityService.getAllRootAuthorities(
              AuthorityType.GROUP
            );
  ...
  private void createCategoriesImpl(String tenantDomain) {
    if (tenantDomain.equals(TenantService.DEFAULT_DOMAIN)) {
      Collection<ChildAssociationRef> childAssocs = categoryService.getRootCategories(
        SPACES_STORE,
        ContentModel.ASPECT_GEN_CLASSIFIABLE
      );
    ...
    NodeRef homeSpaceRef = getHomeSpaceFolderNode(
      AuthenticationUtil.getRunAsUser()
    );
    NodeRef contentRef = addContent(
      homeSpaceRef,
      "tqbfjotld.txt",
      "The quick brown fox jumps over the lazy dog (tenant " +
      tenantDomain +
      ")",
    ...
    assertFalse(
      nodeService.hasAspect(contentRef, ContentModel.ASPECT_GEN_CLASSIFIABLE)
    );
  ...
  public void test11CreateFolders() {
    ...
    for (final String tenantDomain : tenants) {
      for (String baseUserName : users) {
        if (
          (!baseUserName.equals(TEST_USER3)) ||
          (tenantDomain.equals(TEST_TENANT_DOMAIN2))
        ) {
          final String tenantUserName = tenantService.getDomainUser(
            baseUserName,
            tenantDomain
          );
                ...
                if (tenantDomain.equals(TEST_TENANT_DOMAIN2)) {
                  contentRef =
                    addContent(
                      ...
                      "The quick brown fox jumps over the lazy dog ANO (tenant " +
                      tenantDomain +
                      ")",
                      MimetypeMap.MIMETYPE_TEXT_PLAIN
                    );
  ...
  public void test14GetProperty() {
    ...
    for (final String tenantDomain : tenants) {
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            NodeRef personNodeRef = createUser(
              TEST_USER4,
              tenantDomain,
            ...
            NodeRef homeFolderNodeRef = (NodeRef) nodeService.getProperty(
              personNodeRef,
              ContentModel.PROP_HOMEFOLDER
            );
            ...
            assertFalse(
              props
                .get(ContentModel.PROP_HOMEFOLDER)
                .toString()
                .contains(tenantDomain)
            );

            // Test "store-identifier" property
            String storeId = (String) nodeService.getProperty(
              personNodeRef,
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            ...
            String query =
              "+PATH:\"/app:company_home/app:dictionary/app:email_templates/app:invite_email_templates/*\" +TEXT:\"" +
              origText +
              "\"";
            ResultSet resultSet = searchService.query(
              SPACES_STORE,
    ...
    AuthenticationUtil.runAs(
      new RunAsWork<Void>() {
        public Void doWork() throws Exception {
          ...
          deleteArchiveAndRestoreContent(
            superAdmin,
            TenantService.DEFAULT_DOMAIN
          );
          return null;
  ...
  private void deleteArchiveAndRestoreContent(
    ...
    NodeRef storeArchiveNode = nodeService.getStoreArchiveNode(
      contentRef.getStoreRef()
    );
    ...
    NodeRef archivedContentRef = new NodeRef(
      archiveStoreRef,
      contentRef.getId()
    );
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            ...
            assertEquals(
              defaultModelCnt,
              dictionaryService.getAllModels().size()
            );
            assertNull(
              dictionaryService.getClass(QName.createQName("{my.new.model}sop"))
            );
            ...
            ClassDefinition myType = dictionaryService.getClass(
  ...
  public void test18AddCustomWebClient() {
    ...
    for (final String tenantDomain : tenants) {
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            NodeRef webClientExtFolder = getWebClientExtensionNodeRef(
              SPACES_STORE
            );
            ...
            is =
              getClass()
                .getClassLoader()
                .getResourceAsStream("tenant/web-client-config-custom.xml");
            addContent(
              webClientExtFolder,
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            ...
            NodeRef ddRef = fileFolderService
      ...
      TenantUtil.runAsUserTenant(
        new TenantRunAsWork<Object>() {
          public Object doWork() throws Exception {
            ...
            NodeRef docLib1Ref = siteService.getContainer(
              "site1",
              SiteService.DOCUMENT_LIBRARY
            );
            NodeRef contentRef = addContent(
            ...
            NodeRef docLib2Ref = siteService.getContainer(
              "site2",
              SiteService.DOCUMENT_LIBRARY
            );
  ...
  private int searchForDataDictionary(
