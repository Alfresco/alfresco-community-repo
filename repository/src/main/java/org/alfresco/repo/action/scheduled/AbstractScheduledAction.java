...
public abstract class AbstractScheduledAction
  ...
  public enum TransactionMode {
    ...
    public static TransactionMode getTransactionMode(
      ...
      if (transactionModeString.equalsIgnoreCase("ISOLATED_TRANSACTIONS")) {
        ...
        transactionModeString.equalsIgnoreCase("UNTIL_FIRST_FAILURE")
      ) {
  ...
  public enum CompensatingActionMode {
    ...
    public static CompensatingActionMode getCompensatingActionMode(
      ...
      if (
        compensatingActionModeString.equalsIgnoreCase(
          "RUN_COMPENSATING_ACTIONS_ON_FAILURE"
        )
      ) {
        compensatingActionMode =
          CompensatingActionMode.RUN_COMPENSATING_ACTIONS_ON_FAILURE;
   ...
   */
  private CompensatingActionMode compensatingActionMode =
  ...
  public void setCompensatingActionMode(String compensatingActionModeString) {
    this.compensatingActionMode =
      CompensatingActionMode.getCompensatingActionMode(
  ...
  public void setTransactionMode(String transactionModeString) {
    this.transactionMode =
      TransactionMode.getTransactionMode(transactionModeString);
  }
   ...
   */
  public void setTemplateActionDefinition(
  ...
  public static class JobDefinition implements Job {
    ...
    public void execute(JobExecutionContext ctx) throws JobExecutionException {
      final AbstractScheduledAction abstractScheduledAction = (AbstractScheduledAction) ctx
        .getJobDetail()
        .getJobDataMap()
        .get(ACTION_JOB_DATA_MAP_KEY);
        ...
        new AuthenticationUtil.RunAsWork<Object>() {
                ...
                .doInTransaction(
                  new RetryingTransactionCallback<Object>() {
                    public Object execute() throws Exception {
                      ...
                      for (NodeRef nodeRef : nodes) {
                        Action action = abstractScheduledAction.getAction(
                          nodeRef
                        );
          ...
          private void doCompensation(
            ...
            if (
              ...
              for (Pair<Action, NodeRef> pair : cae.getCompensatingActions()) if (
                (pair != null) &&
                (pair.getFirst() != null) &&
                (pair.getSecond() != null)
              ) {
                      ...
                      try {
                        ...
                        if (compensatingAction != null) {
                          throw new CompensatingActionException(
                            "Requires compensating action",
                            t,
                            Collections.<Pair<Action, NodeRef>>singletonList(
                              new Pair<Action, NodeRef>(
                  ...
                  new RetryingTransactionCallback<Object>() {
                    public Object execute() throws Exception {
                      try {
                        abstractScheduledAction
                          .getActionService()
                          .executeAction(pair.getFirst(), pair.getSecond());
                        return null;
                      } catch (Throwable t) {
                        List<Pair<Action, NodeRef>> compensatingActions = new ArrayList<Pair<Action, NodeRef>>(
                          1
                        ...
                        if (pair.getFirst().getCompensatingAction() != null) {
                          compensatingActions.add(
                            new Pair<Action, NodeRef>(
                              pair.getFirst().getCompensatingAction(),
                              pair.getSecond()
                            )
                          );
                        }
