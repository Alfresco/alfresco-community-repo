...
public class ImapSearchMessagesTests extends EmailTest {
    @TestRail(
            ...
            description =
                    "Verify that no results are returned when searching for a message name term"
                            + " with no match")
    ...
    public void noResultsReturnedWhenSearchingForNotExistingMessage() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(testSite)
                .usingResource(testFolder)
                .searchSubjectFor("new")
                .assertThat()
                .resultsContainMessage(fileModel1)
                .assertThat()
                .resultsDoNotContainMessage(fileModel2);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that searched message is returned when searching for full message name")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY})
    public void searchedMessageIsReturnedWhenSearchingForFullMessageName() throws Exception {
        ...
        imapProtocol
                ...
                .usingSite(testSite)
                .usingResource(testFolder)
                .searchSubjectFor("File2")
                .assertThat()
                .resultsContainMessage(fileModel2)
                .assertThat()
                .resultsDoNotContainMessage(fileModel1);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify that search results are returned for search term containing white"
                            + " spaces")
    ...
    public void siteManagerVerifySearchResultsForWhiteSpaces() throws Exception {
        ...
        imapProtocol
                .authenticateUser(testUser)
                .usingSite(testSite)
                .searchSubjectFor("File new")
                .assertThat()
                .resultsContainMessage(fileModel1, fileModel2);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that search results are returned for search term containing wildcards")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    public void siteManagerVerifySearchResultsForWildcards() throws Exception {
        ...
        imapProtocol
                .authenticateUser(testUser)
                .usingSite(testSite)
                .searchSubjectWithWildcardsFor("File.*1.*")
                .assertThat()
                .resultsContainMessage(fileModel1)
                .assertThat()
                .resultsDoNotContainMessage(fileModel2);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that search results are returned for search term containing special"
                            + " characters")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
