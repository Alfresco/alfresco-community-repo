...
public class GetCommentsTests extends RestTest {
  ...
  public void managerIsNotAbleToRetrieveCommentIfAuthenticationFails()
    throws Exception {
    UserModel nonexistentModel = new UserModel(
      "nonexistentUser",
      "nonexistentPassword"
    );
    restClient
  ...
  public void managerIsAbleToRetrieveCommentsCreatedByAnotherUser()
    throws Exception {
    userModel = usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator);
    String contentManager =
      "This is a new comment added by " + userModel.getUsername();
    restClient
  ...
  public void adminIsAbleToRetrieveCommentsCreatedByAnotherUser()
    throws Exception {
    userModel = usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator);
    String contentCollaborator =
      "This is a new comment added by " + userModel.getUsername();
    restClient
      .authenticateUser(userModel)
      .withCoreAPI()
  ...
  public void addCommentWithManagerAndCheckThatCommentIsReturned()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addCommentWithCollaboratorAndCheckThatCommentIsReturned()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  @Bug(id = "ACE-4614")
  public void addCommentWithContributorAndCheckThatCommentIsReturned()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addCommentWithConsumerAndCheckThatCommentIsNotReturned()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addCommentWithManagerCheckReturnedPersonIsTheRightOne()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addCommentWithCollaboratorCheckReturnedCompanyDetails()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addTwoCommentsWithAdminCollaboratorVerifyMaxItemsParamIsApplied()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addTwoCommentsWithAdminManagerVerifyPropertiesParamIsApplied()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
  ...
  public void addTwoCommentsWithManagerCheckDefaultErrorModelSchema()
    throws Exception {
    file =
      dataContent
        .usingSite(siteModel)
