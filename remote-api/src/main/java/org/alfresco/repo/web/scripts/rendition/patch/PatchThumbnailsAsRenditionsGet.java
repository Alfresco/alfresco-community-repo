...
public class PatchThumbnailsAsRenditionsGet extends DeclarativeWebScript {
  ...
  private static Log logger = LogFactory.getLog(
    PatchThumbnailsAsRenditionsGet.class
  );
  ...
  private static final String QUERY =
    ...
    "\" AND NOT ASPECT:\"" +
    RenditionModel.ASPECT_VISIBLE_RENDITION +
    "\" AND NOT ASPECT:\"" +
    RenditionModel.ASPECT_HIDDEN_RENDITION +
    "\"";
  ...
  public Map<String, Object> executeImpl(
    ...
    if (logger.isInfoEnabled()) {
      logger.debug(
        "Patching legacy thumbnails by applying appropriate rendition aspect"
      );
    }
    ...
    try {
      types =
        searchService.query(SPACES_STORE, SearchService.LANGUAGE_LUCENE, QUERY);
