...
public abstract class EmailServer extends AbstractLifecycleBean {
    ...
    /**
     * Set the blocked senders as a comma separated list. The entries will be trimmed of all
     * whitespace.
     *
    ...
    /**
     * Set the allowed senders as a comma separated list. The entries will be trimmed of all
     * whitespace.
     *
     ...
     * @throws EmailMessageException if the e-mail is rejected accordingly with blocked and allowed
     *     lists
     */
    ...
    private static void usage() {
        ...
        System.err.println(
                "\t configLocation - spring xml configs with EmailServer related beans"
                        + " (emailServer, emailServerConfiguration, emailService)");
    }
