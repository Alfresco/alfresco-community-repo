...
public class MimetypeDAOTest extends TestCase {
    ...
    try {
      ...
      if (expectSuccess) {
        ...
        throw new RuntimeException(
          "Expected to get mimetype '" + mimetype + "'.",
          e
        );
      } else {
        return null;
  ...
  private Pair<Long, String> update(
    final String oldMimetype,
  ...
  public void testCreateWithCommit() throws Exception {
    ...
    Pair<Long, String> mimetypePairCheck = get(
      mimetypePair.getSecond(),
      false,
      true
    );
    assertEquals(
      "Mimetype ID changed",
      mimetypePair.getFirst(),
      mimetypePairCheck.getFirst()
    );
  }
  ...
  public void testUpdate() throws Exception {
    ...
    Pair<Long, String> newMimetypePair = txnHelper.doInTransaction(
      callback,
      false,
      false
    );
    // Check
    assertEquals(
      "ID should remain the same if the old mimetype existed",
      oldMimetypePair.getFirst(),
      newMimetypePair.getFirst()
    );
