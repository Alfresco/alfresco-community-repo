...
public class NodeBrowserPost
  ...
  public NodeRef getPrimaryParent(NodeRef nodeRef) {
    ...
    NodeRef parentRef =
      ((Path.ChildAssocElement) element).getRef().getParentRef();
    return parentRef;
  }
  ...
  public List<ChildAssociation> getParents(NodeRef nodeRef) {
    List<ChildAssociationRef> parents = getNodeService()
      .getParentAssocs(nodeRef);
    List<ChildAssociation> assocs = new ArrayList<ChildAssociation>(
      parents.size()
    );
  ...
  public List<Property> getProperties(NodeRef nodeRef) {
    Map<QName, Serializable> propertyValues = getNodeService()
    ...
    for (Map.Entry<QName, Serializable> property : propertyValues.entrySet()) {
      properties.add(
        new Property(property.getKey(), property.getValue(), nodeRef)
      );
    }
    return properties;
  }
  ...
  public List<Permission> getPermissions(NodeRef nodeRef) {
    ...
    if (readPermissions.equals(AccessStatus.ALLOWED)) {
      ...
      for (
        Iterator<AccessPermission> iterator = getPermissionService()
  ...
  protected Map<String, Object> executeImpl(
        ...
        case "search":
          {
            if (query != null && query.trim().length() != 0) {
              switch (searcher) {
                ...
                case "selectnodes":
                  {
                    List<NodeRef> nodes = getSearchService()
                      .selectNodes(
                        getNodeService().getRootNode(storeRef),
                        query,
                        null,
                        getNamespaceService(),
                        false
    ...
    if (currentNode != null) {
      ...
      ChildAssociationRef parent = getNodeService()
    ...
    HttpServletRequest request =
      ((WebScriptServletRequest) req).getHttpServletRequest();
  ...
  public class Node implements Serializable {
    ...
    public Node(NodeRef nodeRef) {
      ...
      this.childAssoc =
        ref.getQName() != null ? new QNameBean(ref.getQName()) : null;
  ...
  public class ChildAssociation extends Association implements Serializable {
    ...
    public ChildAssociation(ChildAssociationRef ref) {
      ...
      if (childRef != null) this.childType =
        new QNameBean(getNodeType(childRef));
      if (parentRef != null) this.parentType =
        new QNameBean(getNodeType(parentRef));
  ...
  public class ChildAssocRefWrapper implements Serializable {
    ...
    public boolean isChildLocked() {
      return (
        lockService != null &&
        lockService.getLockType(ref.getChildRef()) != null
      );
    }
  }
  ...
  public class PeerAssociation extends Association implements Serializable {
    ...
    public PeerAssociation(
      ...
      if (sourceRef != null) this.sourceType =
        new QNameBean(getNodeType(sourceRef));
      if (targetRef != null) this.targetType =
        new QNameBean(getNodeType(targetRef));
    }
  ...
  public class Property implements Serializable {
    ...
    public Property(QName qname, Serializable value, NodeRef nodeRef) {
      ...
      if (propDef != null) {
        ...
        typeName =
          qn != null ? new QNameBean(propDef.getDataType().getName()) : null;
        ...
        if (propDef.getContainerClass().isAspect()) {
          ...
          ClassDefinition classDef = getDictionaryService()
            .getClass(getNodeService().getType(nodeRef));
          boolean found = false;
      ...
      if (value instanceof Collection) {
        ...
        values =
          Collections.singletonList(
            new Value(
              value instanceof QName ? new QNameBean((QName) value) : value
            )
          );
      }
      this.values = values;
    ...
    private boolean searchInClassDefinition(
      QName qname,
    ...
    public class Value implements Serializable {
      ...
      public String getDataType() {
        ...
        if (
          datatype == null || datatype.equals(DataTypeDefinition.ANY.toString())
        ) {
          if (value != null) {
            DataTypeDefinition dataTypeDefinition = getDictionaryService()
