...
public class WorkflowApiClient extends PublicApiClient {
    ...
    public class DeploymentsClient extends AbstractProxy {
        ...
        public Deployment findDeploymentById(String deploymentId) throws PublicApiException {
            HttpResponse response =
                    getSingle("deployments", deploymentId, null, null, "Failed to get deployment");
    ...
    public class ProcessDefinitionsClient extends AbstractProxy {
        public ListResponse<ProcessDefinition> getProcessDefinitions(Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "process-definitions",
        ...
        public JSONObject getProcessDefinitionsWithRawResponse(Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "process-definitions",
    ...
    public class ProcessesClient extends AbstractProxy {
        ...
        public JSONObject getTasks(String processInstanceId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "processes",
                            ...
                            null,
                            params,
                            "Failed to get task instances of processInstanceId "
                                    + processInstanceId);
            JSONObject list = (JSONObject) response.getJsonResponse().get("list");
            return list;
        }

        public JSONObject getActivities(String processInstanceId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "processes",
        ...
        public JSONObject updateVariable(String processId, String variableName, JSONObject variable)
                throws PublicApiException {
            HttpResponse response =
                    update(
                            "processes",
    ...
    public class TasksClient extends AbstractProxy {
        ...
        public JSONObject updateTask(String taskId, JSONObject task, List<String> selectedFields)
                throws PublicApiException {
        ...
        public JSONObject findTasks(Map<String, String> params) throws PublicApiException {
            HttpResponse response =
                    getAll("tasks", null, null, null, params, "Failed to get all tasks");
            JSONObject list = (JSONObject) response.getJsonResponse().get("list");
            return list;
        }
        ...
        public JSONObject findTaskVariables(String taskId, Map<String, String> params)
                throws PublicApiException {
            HttpResponse response =
                    getAll(
                            "tasks",
        ...
        public JSONObject updateTaskVariable(
                String taskId, String variableName, JSONObject variable) throws PublicApiException {
            HttpResponse response =
                    update(
                            "tasks",
                            taskId,
        ...
        public JSONObject addTaskItem(String taskId, String body) throws PublicApiException {
            HttpResponse response =
                    create("tasks", taskId, "items", null, body, "Failed to add item");
            JSONObject entry = (JSONObject) response.getJsonResponse().get("entry");
            return entry;
        }
