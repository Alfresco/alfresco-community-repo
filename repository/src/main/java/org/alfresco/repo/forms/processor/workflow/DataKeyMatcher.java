...
public class DataKeyMatcher {
   ...
   */
  private static final Pattern propertyNamePattern = Pattern.compile(
   ...
   * parts.
   */
  private static final Pattern associationNamePattern = Pattern.compile(
    "(^[a-zA-Z0-9-]+)_([a-zA-Z0-9_]+)(_[a-zA-Z]+$)"
  );

  private static final Pattern transientAssociationPattern = Pattern.compile(
    "(^[a-zA-Z0-9]+)(_[a-zA-Z]+$)"
  );
