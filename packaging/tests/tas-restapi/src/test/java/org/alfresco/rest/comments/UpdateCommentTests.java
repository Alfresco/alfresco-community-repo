...
public class UpdateCommentTests extends RestTest {
  ...
  public void checkEntryContentInResponse() throws Exception {
    ...
    commentModel =
      restClient
        ...
        .updateComment(
          commentModel,
          "This is the updated comment with admin user"
        );
    restClient.assertStatusCodeIs(HttpStatus.OK);
    commentModel
      .assertThat()
  ...
  @TestRail(
    ...
    description = "Verify Manager user updates comments created by admin user and status code is 200"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void managerIsAbleToUpdateHisComment() throws Exception {
    restClient.authenticateUser(
      usersWithRoles.getOneUserWithRole(UserRole.SiteManager)
    );
    commentModel =
      restClient
        .withCoreAPI()
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Contributor user can update his own comment and status code is 200"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Consumer user can not update comments created by admin user and status code is 403"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void consumerIsNotAbleToUpdateComment() throws Exception {
    ...
    restClient
      ...
      .updateComment(
        commentModel,
        "This is the updated comment with Consumer user"
      );
    restClient
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Collaborator user can update his own comment and status code is 200"
  )
  //    @Bug(id="REPO-1011")
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Collaborator user can not update comments of another user and status code is 200"
  )
  //  @Bug(id="MNT-2502",description="seems it's one old issue: also logged as MNT-2502, MNT-2346")
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void collaboratorIsNotAbleToUpdateCommentOfAnotherUser()
    throws Exception {
    restClient.authenticateUser(adminUserModel);
    commentModel =
      restClient
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify can not update comment if NodeId is neither document or folder and returns status code 405"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void canNotUpdateCommentIfNodeIdIsNeitherDocumentOrFolder()
    throws Exception {
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Admin user is not able to update with empty comment body and status code is 400"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify updated comment by Manager is listed when calling getComments and status code is 200"
  )
  //    @Bug(id="REPO-1011")
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  ...
  public void collaboratorIsAbleToUpdateACommentThatContainsSpecialChars()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
  ...
  public void cannotUpdateCommentWithConsumerCallGetComments()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
  ...
  public void managerIsAbleToUpdateACommentWithMultiByteContent()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
  ...
  public void adminIsAbleToUpdateACommentWithPropertiesParameter()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
  ...
  public void updateCommentUsingInvalidNodeId() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, file.getNodeRef())
      );
  }
