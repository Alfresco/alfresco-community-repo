...
public class GetProcessDefinitionsFullTests extends RestTest {
  ...
  public void getProcessDefinitionsWithValidSkipCount() throws Exception {
    ...
    RestProcessDefinitionModel firstProcessDefinition = processDefinitions
      .getEntries()
      .get(0)
      .onModel();
    RestProcessDefinitionModel secondProcessDefinition = processDefinitions
      .getEntries()
      .get(1)
      .onModel();

    RestProcessDefinitionModelsCollection procDefWithSkipCount = restClient
  ...
  public void getProcessDefinitionsWithValidMaxItems() throws Exception {
    ...
    RestProcessDefinitionModelsCollection procDefWithMaxItems = restClient
