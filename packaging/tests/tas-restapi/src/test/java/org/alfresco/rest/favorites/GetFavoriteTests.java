...
public class GetFavoriteTests extends RestTest {
  ...
  public void managerIsAbleToRetrieveFavoriteSite() throws Exception {
    ...
    RestPersonFavoritesModel favSite = restClient
      .withCoreAPI()
      .usingAuthUser()
  ...
  public void managerIsAbleToRetrieveFavoriteFolder() throws Exception {
    ...
    RestPersonFavoritesModel favoriteFolder = restClient
      .withCoreAPI()
      .usingAuthUser()
  ...
  public void managerIsAbleToRetrieveFavoriteFile() throws Exception {
    ...
    RestPersonFavoritesModel favoriteFile = restClient
      .withCoreAPI()
      .usingAuthUser()
  ...
  public void userIsNotAbleToRetrieveFavoriteSiteIfAuthenticationFails()
    throws Exception {
    UserModel siteManager = usersWithRoles.getOneUserWithRole(
      UserRole.SiteManager
    );
  ...
  @Test(
    groups = { TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION }
  )
  public void adminIsAbleToRetrieveFavoritesSite() throws Exception {
    ...
    RestPersonFavoritesModel favoriteSite = restClient
      .withCoreAPI()
      .usingUser(adminUserModel)
      .getFavorite(siteModel.getGuid());
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void userIsNotAbleToRetrieveFavoriteSiteOfAnotherSiteMember()
    throws Exception {
    restClient.authenticateUser(
      usersWithRoles.getOneUserWithRole(UserRole.SiteConsumer)
    );
    ...
    restClient
      ...
      .containsSummary(
        String.format(
          ...
          usersWithRoles.getOneUserWithRole(UserRole.SiteManager).getUsername(),
          siteModel.getGuid()
        )
      )
  ...
  public void getFavoriteSiteWhenFavoriteIdNotExist() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "invalidId")
      )
      .statusCodeIs(HttpStatus.NOT_FOUND)
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .stackTraceIs(RestErrorModel.STACKTRACE)
  ...
  public void verifyRequestForGetFavoriteSiteWithProperties() throws Exception {
    UserModel collaborator = usersWithRoles.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
    restClient.authenticateUser(collaborator);
    restClient
      .withCoreAPI()
      .usingUser(collaborator)
      .addSiteToFavorites(siteModel);
  ...
  public void verifyRequestForGetFavoriteSiteWithInvalidProperties()
    throws Exception {
    UserModel collaborator = usersWithRoles.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
  ...
  public void verifyRequestFieldsForGetFavoriteFile() throws Exception {
    UserModel contributor = usersWithRoles.getOneUserWithRole(
      UserRole.SiteContributor
    );
    restClient.authenticateUser(contributor);
    restClient
      .withCoreAPI()
      .usingUser(contributor)
      .addFileToFavorites(fileModel);
