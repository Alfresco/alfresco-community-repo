...
public abstract class BaseReportGenerator implements ReportGenerator {
  ...
  public Report generateReport(NodeRef reportedUponNodeRef, String mimetype) {
    ...
    Map<QName, Serializable> reportProperties = generateReportMetadata(
      reportedUponNodeRef
    );

    // generate the report content
    ContentReader contentReader = generateReportContent(
      reportedUponNodeRef,
      mimetype,
   ...
   * Generate the report name
   */
  protected abstract String generateReportName(
   ...
   */
  protected abstract Map<QName, Serializable> generateReportMetadata(
    NodeRef reportedUponNodeRef
  );
