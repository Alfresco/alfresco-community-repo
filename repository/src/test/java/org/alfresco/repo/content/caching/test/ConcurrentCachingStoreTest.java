...
public class ConcurrentCachingStoreTest {
    ...
    // NUM_THREADS must be at least 2 x NUM_URLS to ensure each URLs is accessed by more than one
    // thread.
    ...
    public void concurrentReadsWillReadCacheOncePerURL() throws InterruptedException {
        ...
        if (failedURLs > 0) Assert.fail(failedURLs + " URLs were requested more than once.");
    }
