...
public class HttpClientTransmitterImplTest extends TestCase {
    ...
    public void testSuccessfulVerifyTargetOverHttp() throws Exception {
        ...
        when(mockedHttpClient.executeMethod(
                        any(HostConfiguration.class), any(HttpMethod.class), any(HttpState.class)))
                .thenReturn(200);

        // Call verifyTarget
        transmitter.verifyTarget(target);

        ArgumentCaptor<HostConfiguration> hostConfig =
                ArgumentCaptor.forClass(HostConfiguration.class);
        ...
        verify(mockedHttpClient)
                .executeMethod(hostConfig.capture(), httpMethod.capture(), httpState.capture());
    ...
    public void testSuccessfulVerifyTargetOverHttps() throws Exception {
        ...
        assertTrue(
                "socket factory",
                hostConfig.getValue().getProtocol().getSocketFactory()
                        instanceof SecureProtocolSocketFactory);
        assertEquals(
                "protocol",
    ...
    public void testGetStatusErrorRehydration() throws Exception {
        ...
        final TransferException expectedException =
                new TransferException("my message id", new Object[] {"param1", "param2"});
        when(mockedHttpClient.executeMethod(
                        any(HostConfiguration.class), any(HttpMethod.class), any(HttpState.class)))
                .thenReturn(200);
        doAnswer(
                        new Answer<String>() {
                            ...
                            public String answer(InvocationOnMock invocation) throws Throwable {
                                ...
                                JSONObject errorObject =
                                        errorSerializer.serialize(expectedException);
