...
public class LoginTest extends BaseWebScriptTest {
    ...
    /**
     * Positive test - login and retrieve a ticket via get - return xml, - via get method validate
     * ticket logout fail to validate ticket fail to get ticket
     */
    public void testAuthentication() throws Exception {
        ...
        /**
         * Negative test - validate as AuthenticationUtil.getAdminUserName() - should fail with a
         * 404
         */
    ...
    public void testPostLogin() throws Exception {
        ...
        /** logon via POST and JSON */
        {
            ...
            Response response =
                    sendRequest(
                            new PostRequest(loginURL, req.toString(), "application/json"),
                            Status.STATUS_OK);
