...
public class FilePlanComponentAspect
  ...
  private NodeRef scriptsFolderNodeRef = new NodeRef(
    "workspace",
    "SpacesStore",
    "rm_behavior_scripts"
  );
  ...
  private List<NodeRef> lookupScripts(
    ...
    Map<QName, Serializable> changedProps = PropertyMap.getChangedProperties(
      oldProps,
      newProps
    );
    for (QName propQName : changedProps.keySet()) {
      ...
      String[] splitQName = QName.splitPrefixedQName(
        prefixedQName.toPrefixString()
      );
      ...
      NodeRef nextElement = nodeService.getChildByName(
  ...
  public CopyBehaviourCallback getCopyCallback(
    ...
    return new AbstractCopyBehaviourCallback() {
      ...
      public Map<QName, Serializable> getCopyProperties(
        ...
        NodeRef root = filePlanService.getFilePlan(
          copyDetails.getTargetParentNodeRef()
        );
        if (root != null) {
