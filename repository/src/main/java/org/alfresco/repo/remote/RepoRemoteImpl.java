...
public class RepoRemoteImpl implements RepoRemote {
    ...
    public OutputStream createFile(NodeRef base, String path) {
        return new RepoRemoteOutputStream(
                fTransport.createFile(fTicketHolder.getTicket(), base, path),
                fTransport,
                fTicketHolder);
    }
    ...
    public InputStream readFile(NodeRef fileRef) {
        return new RepoRemoteInputStream(
                fTransport.readFile(fTicketHolder.getTicket(), fileRef), fTransport, fTicketHolder);
    }
    ...
    public InputStream readFile(NodeRef base, String path) {
        return new RepoRemoteInputStream(
                fTransport.readFile(fTicketHolder.getTicket(), base, path),
                fTransport,
                fTicketHolder);
    }
    ...
    public OutputStream writeFile(NodeRef base, String path) {
        return new RepoRemoteOutputStream(
                fTransport.writeFile(fTicketHolder.getTicket(), base, path),
                fTransport,
                fTicketHolder);
    }
}
