...
public class PatchDAOImpl extends AbstractPatchDAOImpl {
  ...
  private static final String SELECT_ADM_MAX_NODE_ID =
    "alfresco.patch.select_admMaxNodeId";
  private static final String SELECT_NODES_BY_TYPE_AND_NAME_PATTERN =
    "alfresco.patch.select_nodesByTypeAndNamePattern";

  private static final String UPDATE_CONTENT_MIMETYPE_ID =
    "alfresco.patch.update_contentMimetypeId";
  private static final String UPDATE_PERSON_SIZECURRENT_TYPE =
    "alfresco.patch.update_fixSizeCurrentType";

  private static final String SELECT_COUNT_NODES_WITH_ASPECTS =
    "alfresco.patch.select_CountNodesWithAspectIds";

  private static final String SELECT_NODES_BY_TYPE_QNAME =
    "alfresco.patch.select_NodesByTypeQName";
  private static final String SELECT_NODES_BY_TYPE_URI =
    "alfresco.patch.select_NodesByTypeUriId";
  private static final String SELECT_NODES_BY_ASPECT_QNAME =
    "alfresco.patch.select_NodesByAspectQName";
  private static final String SELECT_NODES_BY_TYPE_AND_ASPECT_QNAME =
    "alfresco.patch.select_NodesByTypeAndAspectQNameQName";
  private static final String SELECT_NODES_BY_CONTENT_MIMETYPE =
    "alfresco.patch.select_NodesByContentMimetype";

  private static final String SELECT_COUNT_NODES_WITH_TYPE_ID =
    "alfresco.patch.select_CountNodesWithTypeId";
  private static final String SELECT_CHILDREN_OF_THE_SHARED_SURFCONFIG_FOLDER =
    "alfresco.patch.select_ChildrenOfTheSharedSurfConfigFolder";
  ...
  public int updatePersonSizeCurrentType() {
    ...
    Long sizeCurrentPropQNameId = qnameDAO
      .getOrCreateQName(ContentModel.PROP_SIZE_CURRENT)
      .getFirst();
  ...
  @Override
  public List<Pair<NodeRef, String>> getNodesOfTypeWithNamePattern(
    QName typeQName,
    String namePattern
  ) {
    ...
    final List<Pair<NodeRef, String>> results = new ArrayList<Pair<NodeRef, String>>(
      500
    );
    ...
    template.select(
      SELECT_NODES_BY_TYPE_AND_NAME_PATTERN,
      params,
      resultHandler
    );
    return results;
  ...
  @Override
  public List<Long> getNodesByTypeQNameId(
    Long typeQNameId,
    Long minNodeId,
    Long maxNodeId
  ) {
  ...
  @Override
  public List<Long> getNodesByTypeUriId(
    Long nsId,
    Long minNodeId,
    Long maxNodeId
  ) {
  ...
  @Override
  public List<Long> getNodesByAspectQNameId(
    Long aspectQNameId,
    Long minNodeId,
    Long maxNodeId
  ) {
  ...
  @Override
  public List<Long> getNodesByContentPropertyMimetypeId(
    Long mimetypeId,
    Long minNodeId,
    Long maxNodeId
  ) {
  ...
  @SuppressWarnings("unchecked")
  @Override
  public List<Long> getNodesByTypeQNameAndAspectQNameId(
    long typeQNameId,
    long aspectQNameId,
    long minNodeId,
    long maxNodeId
  ...
  public long getCountNodesWithTypId(QName typeQName) {
    ...
    Long count = (Long) template.selectOne(
  ...
  @Override
  public List<NodeRef> getChildrenOfTheSharedSurfConfigFolder(
    Long minNodeId,
    Long maxNodeId
  ) {
    Pair<Long, QName> containsAssocQNamePair = qnameDAO.getQName(
    ...
    // Get qname CRC
    Long qnameCrcSites = ChildAssocEntity.getQNameCrc(
      QName.createQName(SiteModel.SITE_MODEL_URL, "sites")
    );
    Long qnameCrcSurfConfig = ChildAssocEntity.getQNameCrc(
      QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "surf-config")
    );
    Long qnameCrcPages = ChildAssocEntity.getQNameCrc(
      QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "pages")
    );
    Long qnameCrcUser = ChildAssocEntity.getQNameCrc(
      QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "user")
    );
    ...
    template.select(
      SELECT_CHILDREN_OF_THE_SHARED_SURFCONFIG_FOLDER,
      params,
      resultHandler
    );
    return results;
