...
public class LuceneQueryParser extends QueryParser
{
    ...
    public Query getFieldQuery(String field, String queryText, boolean quoted)
    {
        ...
        if (isSysNodeUuidProperty(fieldName))
        {
    ...
    private boolean isSysNodeUuidProperty(String fieldName)
    {
        return ofNullable(fieldName)
                ...
                .filter(ContentModel.PROP_NODE_UUID::equals)
                .isPresent();
    }
    ...
    {
        if (isSysNodeUuidProperty(field))
        {
