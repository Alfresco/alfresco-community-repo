...
public class PermissionActionEvaluator extends AbstractActionEvaluator {
     ...
     */
    protected PermissionActionEvaluator(
            ServiceRegistry serviceRegistry, Action action, String... permission) {
    ...
    public boolean isAllowed(CMISNodeInfo nodeInfo) {
        for (String permission : permissions) {
            if (permissionService.hasPermission(nodeInfo.getNodeRef(), permission)
                    == AccessStatus.DENIED) {
                return false;
            }
        }
