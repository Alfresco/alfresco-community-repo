 ...
 *
 * <p>To get paged list of nodes with the specified aspects.
 *
 * @author Nick Burch
 * @since 4.1
 */
public class GetNodesWithAspectCannedQuery extends AbstractCannedQueryPermissions<NodeRef> {
    ...
    protected List<NodeRef> queryAndFilter(CannedQueryParameters parameters) {
        ...
        // Get parameters
        GetNodesWithAspectCannedQueryParams paramBean =
                (GetNodesWithAspectCannedQueryParams) parameters.getParameterBean();
