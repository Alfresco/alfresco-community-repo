...
public class GetProcessVariablesFullTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify get all process variables call using admin user. Admin can see the"
                            + " process even if he isn't involved in it.")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getProcessVariablesUsingAdmin() throws Exception {
        ...
        variables
                ...
                .assertThat()
                .field("value")
                .is(assignee.getUsername());
        variables
                .getProcessVariableByName("bpm_sendEMailNotifications")
                .assertThat()
                .field("name")
                .is("bpm_sendEMailNotifications")
                .assertThat()
                .field("type")
                .is("d:boolean")
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get all process variables with valid skip count parameter applied.")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getProcessVariablesWithValidSkipCount() throws Exception {
        ...
        RestProcessVariableCollection variablesSkipped =
                restClient
                        .authenticateUser(admin)
        ...
        variablesSkipped
                ...
                .entriesListDoesNotContain(
                        "name", variables.getEntries().get(0).onModel().getName())
                .assertThat()
                .entriesListDoesNotContain(
                        "name", variables.getEntries().get(1).onModel().getName())
                .assertThat()
                .entriesListCountIs(variables.getEntries().size() - 2)
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get all process variables with negative skip count parameter applied.")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get all process variables with not numeric skip count parameter"
                            + " applied.")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getProcessVariablesWithValidMaxItems() throws Exception {
        ...
        variablesSkipped
                .assertThat()
                .entriesListContains("name", variables.getEntries().get(0).onModel().getName())
                .assertThat()
                .entriesListContains("name", variables.getEntries().get(1).onModel().getName())
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get all process variables with negative maxItems parameter applied.")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get all process variables with not numeric maxItems parameter applied.")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
