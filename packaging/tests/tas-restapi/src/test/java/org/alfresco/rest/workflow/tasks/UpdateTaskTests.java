...
public class UpdateTaskTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        activitiReviewProcessDefinition =
                restClient
                        .authenticateUser(adminUser)
                        .withWorkflowAPI()
                        .getAllProcessDefinitions()
                        .getProcessDefinitionByKey("activitiReviewPooled");
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user updates task with Rest API and response is successfull"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify assignee user updates its assigned task with Rest API and response is"
                            + " successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user that started the task updates the started task with Rest API and"
                            + " response is successfull (200)")
    ...
    @TestRail(
            ...
            description =
                    "Verify any user with no relation to task is forbidden to update other task"
                            + " with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify candidate user updates its specific task and no other user claimed the"
                            + " task with Rest API and response is successfull (200)")
    public void candidateUserUpdatesItsTasks() throws Exception {
        ...
        restTaskModel
                ...
                .is(activitiReviewProcessDefinition.getId())
                .and()
                .field("processId")
                .is(taskModel.getProcessId())
                .and()
                .field("name")
                .is("Review Task")
                .and()
                ...
                .and()
                .field("priority")
                .is(taskModel.getPriority().getLevel())
                .and()
                .field("formResourceKey")
                .is("wf:activitiReviewTask");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner can update twice task with status resolve successfully"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task asignee cannot update twice task with status resolve - Forbidden"
                            + " (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task cannot be update using a invalid json body property - Bad Request"
                            + " (400)")
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                ...
                                "Unrecognized field \"" + invalidJsonProperty + "\""));
    }
    ...
    public void taskCanNotBeUpdatedWithInvalidState() throws Exception {
        restTaskModel =
                restClient
                        ...
                        .withWorkflowAPI()
                        .usingTask(taskModel)
                        .updateTask("continued");
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.INVALID_VALUE, "task state", "continued"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task cannot be update using a invalid property - Bad Request (400)")
    public void taskCanNotBeUpdatedWithInvalidSelectProperty() throws Exception {
        String invalidProperty = "states";
        restClient
                .authenticateUser(assigneeUser)
                .withParams("select=" + invalidProperty)
                .withWorkflowAPI()
                .usingTask(taskModel);
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.PROPERTY_DOES_NOT_EXIST, invalidProperty));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task can be update using multiple select values successfully (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot complete task with invalid name - Bad Request(400))")
    public void taskOwnerCannotCompleteTaskWithInvalidName() throws Exception {
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON()
                        ...
                        .add(
                                "variables",
                                JsonBodyGenerator.defineJSONArray()
                                        .add(
                                                JsonBodyGenerator.defineJSON()
        ...
        restTaskModel =
                restClient
                        .authenticateUser(owner)
                        .withParams("select=state,variables")
                        .withWorkflowAPI()
                        .usingTask(taskModel)
                        .updateTask(inputJson);
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNSUPPORTED_TYPE, "bpm_priorityx"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot complete task with invalid Type - Bad Request(400))")
    public void taskOwnerCannotCompleteTaskWithInvalidType() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNSUPPORTED_TYPE, "d_int"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot complete task with invalid value - Bad Request(400))")
    public void taskOwnerCannotCompleteTaskWithInvalidValue() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNSUPPORTED_TYPE, "text"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot complete task with invalid scope - Bad Request(400))")
    public void taskOwnerCannotCompleteTaskWithInvalidScope() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ILLEGAL_SCOPE, "globalscope"));
    }
    ...
    public void taskAssigneeCanDelegateTask() throws Exception {
        ...
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON()
                        .add("state", "delegated")
                        .add("assignee", delagateToUser.getUsername())
                        .build();
    ...
    public void taskOwnerCanDelegateTaskToSameAssignee() throws Exception {
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON()
                        .add("state", "delegated")
                        .add("assignee", assigneeUser.getUsername())
                        .build();
    ...
    public void taskAssigneeCannotDelegateTaskToInvalidAssignee() throws Exception {
        ...
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON()
                        .add("state", "delegated")
                        .add("assignee", invalidAssignee.getUsername())
                        .build();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can not update task from completed to claimed and response is"
                            + " 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    public void taskOwnerCanNotUpdateTaskFromCompletedToClaimed() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.TASK_ALREADY_COMPLETED, taskModel.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can not update task from completed to unclaimed and response is"
                            + " 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can not update task from completed to completed and response is"
                            + " 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can update task from claimed to completed and response is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS},
            executionType = ExecutionType.REGRESSION,
            description = "Verify user can update task from claimed to claimed and response is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can update task from unclaimed to completed and response is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can not update task from unclaimed to unclaimed and response is"
                            + " 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can not update task from delegated to completed and response is"
                            + " 422")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can not update task from delegated to delegated and response is"
                            + " 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can update task from resolved to completed and response is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner cannot update task from status completed to delegated and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee cannot update task from status completed to delegated and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner cannot update task from status completed to resolved and response"
                            + " is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee cannot update task from status completed to resolved and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner cannot update task from status completed to completed and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee cannot update task from status completed to completed and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can update task from status claimed to unclaimed and response is"
                            + " 200")
    public void ownerCanUpdateTaskFromClaimedToUnclaimed() throws Exception {
        restTaskModel =
                restClient.authenticateUser(owner).withWorkflowAPI().usingTask(taskModel).getTask();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        restTaskModel
                .assertThat()
                .field("id")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee can update task from status claimed to unclaimed and response"
                            + " is 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can update task from status claimed to delegated and response is"
                            + " 200")
    public void ownerCanUpdateTaskFromClaimedToDelegated() throws Exception {
        ...
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON()
                        .add("state", "delegated")
                        .add("assignee", newAssignee.getUsername())
                        .build();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee can update task from status claimed to delegated and response"
                            + " is 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can update task from status claimed to resolved and response is"
                            + " 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee can update task from status claimed to resolved and response"
                            + " is 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner cannot update task from status claimed to claimed and response is"
                            + " 409")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify assignee can update task from status claimed to claimed and response is"
                            + " 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner can complete task with valid variables and response is 200")
    public void taskOwnerCanCompleteTaskWithValidVariables() throws Exception {
        ...
        restTaskModel
                ...
                .and()
                .field("assignee")
                .is(taskModel.getAssignee());
        RestVariableModelsCollection variables =
                restClient
                        .authenticateUser(owner)
                        .withWorkflowAPI()
        ...
        restClient.assertStatusCodeIs(HttpStatus.OK);
        variables
                .getVariableByName("bpm_priority")
                .assertThat()
                .field("scope")
                .is("global")
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot complete task with empty variables array and response"
                            + " is 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot complete task with empty variables json body and"
                            + " response is 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify any user with no relation to task is forbidden to delegate other task"
                            + " with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify any user with no relation to task is forbidden to resolve other task"
                            + " with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify any user with no relation to task is forbidden to claim other task with"
                            + " Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify any user with no relation to task is forbidden to unclaim other task"
                            + " with Rest API (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user cannot delegate task with emty assignee name and response is 400")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner can resolve task when assignee is the owner and response is 200")
    public void taskOwnerUpdateTaskResolveStateAndOwnerAssignee() throws Exception {
        ...
        restTaskModel =
                restClient
                        ...
                        .updateTask(inputJson);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        restTaskModel.assertThat().field("state").is("resolved").and().field("assignee").isNull();
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify owner cannot update task after it was deleted and response is 404")
    public void updateTaskAfterItWasDeleted() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_WAS_NOT_FOUND, taskModel.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify task owner cannot update task with empty input body and response is"
                            + " 400")
    ...
    public void anyUserCannotUpdateTaskUsingAnotherName() throws Exception {
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON().add("name", "Review Task-updated").build();
    ...
    public void anyUserCannotUpdateTaskUsingAnotherDescription() throws Exception {
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON().add("description", "description updated").build();
    ...
    public void anyUserCannotUpdateTaskUsingAnotherDueAt() throws Exception {
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON().add("dueAt", "2025-01-01T11:57:32.000+0000").build();

        restClient
                .authenticateUser(anyUser)
                .withParams("select=dueAt")
                .withWorkflowAPI()
                .usingTask(taskModel)
                .updateTask(inputJson);
        restClient
    ...
    public void anyUserCannotUpdateTaskUsingAnotherOwner() throws Exception {
        UserModel newOwner = dataUser.createRandomTestUser();
        JsonObject inputJson =
                JsonBodyGenerator.defineJSON().add("owner", newOwner.getUsername()).build();
    ...
    public void anyUserCannotUpdateTaskUsingInvalidName() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsErrorKey(
                        String.format(RestErrorModel.NO_CONTENT, "Unexpected character ('a'"))
                .containsSummary(
                        String.format(RestErrorModel.NO_CONTENT, "Unexpected character ('a'"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from unclaimed to claimed by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task cannot be updated from unclaimed to claimed by a regular user"
                            + " not connected to the task")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from unclaimed to delegated by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task cannot be updated from unclaimed to delegated by a regular"
                            + " user not connected to the task")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from unclaimed to resolved by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from unclaimed to resolved by a regular user"
                            + " not connected to the task")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from unclaimed to unclaimed by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from unclaimed to unclaimed by a regular user"
                            + " not connected to the task")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from delegated to unclaimed by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from delegated to unclaimed by task assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task cannot be updated from delegated to claimed since it is"
                            + " already claimed by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from delegated to claimed since it is already"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from delegated to completed by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from delegated to completed by task assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from delegated to resolved by task assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from resolved to unclaimed by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task cannot be updated from resolved to unclaimed by task"
                            + " assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task cannot be updated from resolved to claimed by task owner")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task cannot be updated from resolved to claimed by task assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from resolved to delegated by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from resolved to delegated by task assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from resolved to resolved by task creator")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that task can be updated from resolved to resolved by task assignee")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
