...
/**
 * Contract for managing Workflow Packages. A package is a container of Content that's routed
 * through a Workflow.
 *
 * @author davidc
 */
public interface WorkflowPackageComponent {
     ...
     *
     * <p>If an existing container is supplied, it's supplemented with the workflow package aspect.
     *
     * @param container (optional) a pre-created container (e.g. folder, versioned folder or layered
     *     folder)
     ...
     *
     * <p>The workflow package aspect is removed, and if the container was previously created by the
     * workflow service (i.e. not provided from elsewhere), it will be deleted.
     *
    ...
    /**
     * Initialises the workflow package node on the {@link WorkflowInstance}, adding the appropriate
     * aspect and setting the appropriate properties to mark it as a package for the given {@link
     * WorkflowInstance}.
     *
     * @param instance the workflow instance to which the package belongs.
