 ...
 *     <p>Method returns whether the current user is granted a particular permission a the
 *     TemplateNode.
 *     <p>Usage: hasPermission(TemplateNode node, String permission) - 1 on true, 0 on false
 */
public class HasPermissionMethod extends BaseTemplateProcessorExtension
