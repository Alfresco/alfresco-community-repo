...
/**
 * Used to log relevant changes to transfered files into a summary report of the entire replication
 * job;
 *
 * <p>It should log: created files, deleted, moved, *modified files and relevant errors while
 * handling the files;
 *
 * <p>*modified: each implementation would chose the definition of modified(actual content
 * modification/ new version/ some properties updated)
 */
