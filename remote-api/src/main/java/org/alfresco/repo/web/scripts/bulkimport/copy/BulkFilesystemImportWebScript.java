...
public class BulkFilesystemImportWebScript
  ...
  public void setBulkImporter(
    MultiThreadedBulkFilesystemImporter bulkImporter
  ) {
    this.bulkImporter = bulkImporter;
  }

  public void setNodeImporterFactory(
    StreamingNodeImporterFactory nodeImporterFactory
  ) {
  ...
  protected Map<String, Object> executeImpl(
    ...
    final MultithreadedImportWebScriptLogic importLogic = new MultithreadedImportWebScriptLogic(
      bulkImporter,
      () -> createNodeImporter(request),
      request,
      status,
      cache
    );
  ...
  private NodeImporter createNodeImporter(WebScriptRequest request) {
    final String sourceDirectoryStr = request.getParameter(
