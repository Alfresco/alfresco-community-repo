...
/**
 * A consolidated services for posting file folder activities. Some code was moved from
 * webdav.ActivityPosterImpl and opencmis.ActivityPosterImpl.
 *
 * @author Gethin James
 */
public class FileFolderActivityPosterImpl implements ActivityPoster {
    ...
    public void postFileFolderActivity(
        ...
        activityService.postActivity(
                activityType, siteId, appTool, json.toString(), client, fileInfo);
    }
