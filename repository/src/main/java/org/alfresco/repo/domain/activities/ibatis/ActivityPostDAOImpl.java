...
public class ActivityPostDAOImpl
  ...
  public Long getMaxActivitySeq() throws SQLException {
    return template.selectOne(
      "alfresco.activities.select_activity_post_max_seq"
    );
  }

  public Long getMinActivitySeq() throws SQLException {
    return template.selectOne(
      "alfresco.activities.select_activity_post_min_seq"
    );
  }

  public Integer getMaxNodeHash() throws SQLException {
    return template.selectOne(
      "alfresco.activities.select_activity_post_max_jobtasknode"
    );
  }
  ...
  public int updatePost(
    ...
    return template.update(
      "alfresco.activities.update_activity_post_data",
      post
    );
  }
  ...
  public int updatePostStatus(long id, ActivityPostEntity.STATUS status)
    ...
    return template.update(
      "alfresco.activities.update_activity_post_status",
      post
    );
  }
  ...
  public int deletePosts(Date keepDate, ActivityPostEntity.STATUS status)
    ...
    return template.delete(
      "alfresco.activities.delete_activity_posts_older_than_date",
      params
    );
  }
  ...
  public long insertPost(ActivityPostEntity activityPost) throws SQLException {
    template.insert(
      "alfresco.activities.insert.insert_activity_post",
      activityPost
    );
