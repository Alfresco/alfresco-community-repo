...
public class VirtualLockServiceExtension
  ...
  public void lock(NodeRef nodeRef, LockType lockType, int timeToExpire)
    throws UnableToAquireLockException {
    getTrait()
      .lock(smartStore.materializeIfPossible(nodeRef), lockType, timeToExpire);
  }
  ...
  public void lock(
    ...
    getTrait()
      .lock(smartStore.materializeIfPossible(nodeRefs), lockType, timeToExpire);
  }
  ...
  public LockStatus getLockStatus(NodeRef nodeRef, String userName) {
    return getTrait()
      .getLockStatus(smartStore.materializeIfPossible(nodeRef), userName);
  }
  ...
  public String getAdditionalInfo(NodeRef nodeRef) {
    return getTrait()
      .getAdditionalInfo(smartStore.materializeIfPossible(nodeRef));
  }
  ...
  public boolean isLockedAndReadOnly(NodeRef nodeRef) {
    return getTrait()
      .isLockedAndReadOnly(smartStore.materializeIfPossible(nodeRef));
  }
}
