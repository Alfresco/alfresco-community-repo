...
public class DeclareVersionAsRecordActionTest extends BaseRMTestCase {
    ...
    /**
     * Given a node set to auto-declare documents as records for minor and major versions When I try
     * to upload a minor or major version Then the version record aspect is added
     */
    public void testUpdateNextDispositionAction_RM3060() throws Exception {
        doBehaviourDrivenTest(
                new BehaviourDrivenTest(dmContributor) {
                    ...
                    public void given() {
                        ...
                        Action action =
                                actionService.createAction(DeclareAsVersionRecordAction.NAME);
                    ...
                    public void then() throws Exception {
                        NodeRef recordedVersionNodeRef =
                                (NodeRef)
                                        recordedVersion
                                                ...
                                                .get(
                                                        RecordableVersionModel.PROP_RECORD_NODE_REF
                                                                .getLocalName());
                        assertNotNull(
                                "Recorded version shouldn't be null.", recordedVersionNodeRef);
                        assertTrue(
                                nodeService.hasAspect(
                                        recordedVersionNodeRef,
