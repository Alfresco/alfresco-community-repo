...
public class HttpRangeProcessorTest {
  ...
  public void setUp() throws Exception {
    ...
    when(reader.getContentInputStream())
      .thenReturn(this.getClass().getResourceAsStream("/test.jpg"));
  }
  ...
  protected void testRange(String range, int expectedStatus)
    throws IOException {
    MockHttpServletResponse response = new MockHttpServletResponse();

    boolean result = httpRangeProcessor.processRange(
      response,
      reader,
      range,
      null,
