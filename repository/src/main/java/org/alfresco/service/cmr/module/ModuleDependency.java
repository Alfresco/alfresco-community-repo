...
public interface ModuleDependency extends Serializable {
    /**
     * Get the ID of the module that this dependency describes. The dependency may be upon specific
     * versions or a range of versions. Nevertheless, the module given by the returned ID will be
     * required in one version or another.
     *
     ...
     *
     * @param moduleDetails the module details of the dependency. This must be the details of the
     *     module with the correct {@link #getDependencyId() ID}. This may be <tt>null</tt> in which
     *     case <tt>false</tt> will always be returned.
     * @return Returns true if the module satisfies the dependency requirements.
     */
