...
public class DBQueryTest implements DictionaryListener
{
    ...
    /**
     * Test that when a query is performed with a limit parameter, the number of results in the resultset is influenced by limit while the numberOfFound value is not.
     */
    @Test
     ...
     * @param query
     * @param limit
     *            limits the result set to a maximum number.
     * @return
     */
