...
public class PeopleTest extends TestCase {
    ...
    public void testGetPeople() {
        // 1 Get people with multi-part firstNames. Users 0 & 2 both have 'john junior' as their
        // firstName, but the query shouldn't select user 3
        assertPeopleImpl(
                "john junior",
                "There are two users who have \"john junior\" as their first name.",
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                    + " (firstName:\"*john*\" \"*junior*\" OR lastName:\"*john*\" \"*junior*\")",
                0,
                2);
        ...
        assertPeopleImpl(
                ...
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                        + " (firstName:\"*john*\" \"*junior*\"\"*lewis*\"\"*sec*\" OR"
                        + " lastName:\"*john*\" \"*junior*\"\"*lewis*\"\"*sec*\")",
                0);
        ...
        assertPeopleImpl(
                ...
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                    + " (firstName:\"*john*\" \"*senior*\" OR lastName:\"*john*\" \"*senior*\")",
                1);
        ...
        // 5 Get people with multi-part lastNames. Users 2 & 3 both have 'lewis third' as their
        // lastName
        assertPeopleImpl(
                "lewis third",
                "There are two users who have \"lewis third\" as their last name.",
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                    + " (firstName:\"*lewis*\" \"*third*\" OR lastName:\"*lewis*\" \"*third*\")",
                2,
                3);
        ...
        assertPeopleImpl(
                ...
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                        + " (firstName:\"*doe*\" \"*fi*\" OR lastName:\"*doe*\" \"*fi*\")",
                4,
                5);
        ...
        assertPeopleImpl(
                ...
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                        + " (firstName:\"*sam*\" \"*doe*\"\"*first*\" OR lastName:\"*sam*\""
                        + " \"*doe*\"\"*first*\")",
                5);
        ...
        assertPeopleImpl(
                ...
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                        + " (firstName:\"*sara*\" \"*jones*\"\"*doe*\" OR lastName:\"*sara*\""
                        + " \"*jones*\"\"*doe*\")",
                6);
        ...
        assertPeopleImpl(
                ...
                "TYPE:\"{http://www.alfresco.org/model/content/1.0}person\" AND"
                        + " (firstName:\"*sara*\" \"*doe*\" OR lastName:\"*sara*\" \"*doe*\")",
                6,
                7);
    }

    private void assertPeopleImpl(
            String filter, String sizeMessage, String expectedQuery, int... userIds) {
        String expectedSort = "[]";
        ...
        for (int i : userIds) {
            ...
            assertEquals(
                    "PeopleTestUser " + i + " firstName ",
                    userInfo.getFirstName(),
                    persons.get(n).getFirstName());
            assertEquals(
                    "PeopleTestUser " + i + " lastName ",
                    userInfo.getLastName(),
                    persons.get(n).getLastName());
            n++;
        }
    }
    ...
    @Category(
            RedundantTests
                    .class) // This test is checking that canned queries and Solr searches return
    // the same. We no longer test SOLR.
    public void testGetPeopleByPatternIndexedAndCQ() throws Exception {
        ScriptPagingDetails paging = new ScriptPagingDetails(0, 0);
        List<PersonInfo> unsortedPeople =
                people.getPeopleImpl(CQ_SIMPLE_FILTER, paging, null, null);
        ...
        List<PersonInfo> sortedPeople =
                people.getPeopleImpl(SIMPLE_FILTER, paging, DEFAULT_SORT_BY_FIELD, null);
        ...
        for (PersonInfo person : sortedPeople) {
            assertTrue(
                    ("Unexpected person: '"
                            ...
                            + person.getNodeRef()
                            + "]'"),
                    expectedUsers.contains(person.getNodeRef()));
        }
    }
    ...
    private void createUsers()
        ...
        for (UserInfo user : userInfos) {
            ...
            //            System.out.println((create ? "create" : "existing")+" user " + username +
            // " nodeRef=" + nodeRef);
        }
        txn.commit();
    }
    ...
    static class UserInfo {
        ...
        public String toString() {
            return "PeopleTestUserInfo [userName="
                    + this.userName
                    + ", firstName="
                    + this.firstName
                    + ", lastName="
