...
@EntityResource(
  name = BadEntityResource.ENTITY_KEY,
  title = "bad resource that does bad things"
)
public class BadEntityResource
  implements
    EntityResourceAction.Read<Sheep>, EntityResourceAction.ReadById<Sheep> {
