...
public class DeclareInPlaceRecordsTestLevel2 extends BaseRMRestTest
{
    ...
    /**
     * Given that a user is the owner of a document And that user has been deleted When admin tries to declare the document as a record Then the document becomes an inplace record
     */
    @Test
