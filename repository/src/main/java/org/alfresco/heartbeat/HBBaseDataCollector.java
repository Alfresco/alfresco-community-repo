...
/**
 * This class is to be extended by HeartBeat data collectors. Every new collector needs to provide
 * details of the data it collects. As an example use one of the existing collectors {@link
 * AuthoritiesDataCollector}, {@link ConfigurationDataCollector}, {@link InfoDataCollector}, {@link
 * ModelUsageDataCollector}, {@link SystemUsageDataCollector}.
 *
 * <p>Each collector provides a reference to a {@link HeartBeatJobScheduler} which is then used by
 * the {@link HBDataCollectorService} to schedule and unschedule jobs for this collector. Example
 * Javadoc for implementations:
 *
 * <ul>
 *   <li>Collector ID: <b>a.collector.id</b>
 *   <li>Data:
 *       <ul>
 *         <li><b>dataP1:</b> data type - description
 *         <li><b>dataP2:</b> data type - description ...
 *       </ul>
 * </ul>
 *
 * @author eknizat
...
public abstract class HBBaseDataCollector {
     ...
     * @param cronExpression Cron expression that will be used to schedule jobs for this collector.
     *     e.g.: "0 0 0 ? * SUN" (Weekly)
     * @param hbJobScheduler Scheduler that will be used to schedule jobs for this collector.
     */
    public HBBaseDataCollector(
            String collectorId,
    ...
    /**
     * This method is called by Spring at initialisation and will register this collector with the
     * provided {@link HBDataCollectorService}
     */
    public void register() {
        if (hbDataCollectorService == null) {
            throw new IllegalStateException(
                    "HbDataCollectorService needs to be set before calling this method.");
        }
        hbDataCollectorService.registerCollector(this);
    }

    /**
     * This method is called by Spring at initialisation and will deregister this collector with the
     * provided {@link HBDataCollectorService}
     */
