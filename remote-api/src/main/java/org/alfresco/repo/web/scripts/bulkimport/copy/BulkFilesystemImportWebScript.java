...
public class BulkFilesystemImportWebScript extends AbstractBulkFileSystemImportWebScript {
    ...
    protected Map<String, Object> executeImpl(
            final WebScriptRequest request, final Status status, final Cache cache) {
        final MultithreadedImportWebScriptLogic importLogic =
                new MultithreadedImportWebScriptLogic(
                        bulkImporter, () -> createNodeImporter(request), request, status, cache);
