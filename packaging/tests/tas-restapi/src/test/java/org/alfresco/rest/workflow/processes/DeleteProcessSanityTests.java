...
public class DeleteProcessSanityTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify User is able to delete process started by him using REST API and status"
                            + " code is OK (204)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify User is able to delete process assigned to him using REST API and"
                            + " status code is OK (204)")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.PROCESSES, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify User that is not involved in a process is not authorized to delete it"
                            + " using REST API and status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.PROCESSES, TestGroup.SANITY})
    public void deleteProcessByAnotherUser() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary("user is not allowed to access information about process");
    }
}
