...
public interface ExporterService
{
     ...
     * 
     * All repository information is exported to the single output stream. This means that any content properties are base64 encoded.
     * 
     * @param viewWriter
     ...
     * 
     * @param exportHandler
     *            the custom export handler for content properties
     * @param parameters
     *            export parameters
     * @param progress
     *            exporter callback for tracking progress of export
