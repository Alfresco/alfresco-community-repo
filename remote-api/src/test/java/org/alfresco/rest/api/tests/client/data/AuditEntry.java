 ...
 */
public class AuditEntry extends org.alfresco.rest.api.model.AuditEntry
    ...
    public AuditEntry(
            ...
            org.alfresco.rest.api.model.UserInfo createdByUser,
            Date createdAt,
    ...
    public void expected(Object o) {
        ...
        AssertUtil.assertEquals(
                "auditApplicationId", getAuditApplicationId(), other.getAuditApplicationId());
        AssertUtil.assertEquals("values", getValues(), other.getValues());
        AssertUtil.assertEquals(
                "createdByUser", getCreatedByUser().getId(), other.getCreatedByUser().getId());
    ...
    public JSONObject toJSON() {
        ...
        if (createdByUser != null) {
            auditEntryJson.put(
                    "createdByUser",
                    new UserInfo(createdByUser.getId(), createdByUser.getDisplayName()).toJSON());
        }
    ...
    public static AuditEntry parseAuditEntry(JSONObject jsonObject) {
        ...
        if (createdByUserJson != null) {
            ...
            createdByUser =
                    new org.alfresco.rest.api.model.UserInfo(userId, displayName, displayName);
        }
        Date createdAt = ISO8601DateFormat.parse((String) jsonObject.get("createdAt"));

        AuditEntry auditEntry =
                new AuditEntry(id, auditApplicationId, createdByUser, createdAt, values);
        return auditEntry;
    }
