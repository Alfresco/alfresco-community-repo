...
public class BlogLibJs {
    /**
     * Fetches the blog properties from the json object and adds them to an array using the correct
     * property names as indexes.
     */
    ...
    private static void putJSONEntryInMap(
            JSONObject json, Map<QName, Serializable> arr, String jsonKey, QName mapKey) {
