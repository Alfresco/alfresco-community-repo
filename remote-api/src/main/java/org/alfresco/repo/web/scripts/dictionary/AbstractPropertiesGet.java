...
public abstract class AbstractPropertiesGet extends DictionaryWebServiceBase {
    ...
    /**
     * This request parameter can be passed to filter the propertes based on type. More than one
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        if (filterTypes != null && filterTypes.length > 0) {
            List<PropertyDefinition> typeFilteredProps =
                    new ArrayList<PropertyDefinition>(props.size());
