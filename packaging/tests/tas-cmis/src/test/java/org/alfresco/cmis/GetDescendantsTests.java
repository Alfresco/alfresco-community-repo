...
public class GetDescendantsTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager can get descendants for valid parent folder with at least"
                            + " 3 children and depth set to >=1")
    @Test(groups = {TestGroup.SANITY, TestGroup.CMIS})
    public void getDescendantsForValidParentFolderWithAtLeast3ChildrenAndDepthGreaterThan1()
            throws Exception {
        cmisApi.authenticateUser(testUser)
                ...
                .usingResource(testFolder)
                .assertThat()
                .hasDescendants(1, folderModel, fileModel, testFile);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager can get descendants for valid parent folder with at least"
                            + " 3 children and depth set to -1")
    @Test(groups = {TestGroup.SANITY, TestGroup.CMIS})
    public void getDescendantsForValidParentFolderWithAtLeast3ChildrenAndDepthSetToMinus1()
            throws Exception {
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFolder(testFolder)
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager CANNOT get descendants for valid parent folder with at"
                            + " least 2 children and depth set to 0")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = {CmisInvalidArgumentException.class})
    public void getDescendantsForValidParentFolderWithAtLeast2ChildrenAndDepthSetTo0()
            throws Exception {
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFolder(testFolder)
                ...
                .usingResource(testFolder)
                .assertThat()
                .hasDescendants(0, folderModel, testFile);
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager CANNOT get descendants for valid parent folder with at"
                            + " least 2 children and depth set to -2")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = {CmisInvalidArgumentException.class})
    public void getDescendantsForValidParentFolderWithAtLeast2ChildrenAndDepthSetToMinus2()
            throws Exception {
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFolder(testFolder)
                ...
                .usingResource(testFolder)
                .assertThat()
                .hasDescendants(-2, folderModel, testFile);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager CANNOT get descendants for parent folder with at least 2"
                            + " children that was previously deleted")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    public void getDescendantsForDeletedParentFolderWithAtLeast2Children() throws Exception {
        cmisApi.authenticateUser(testUser)
                ...
                .usingResource(testFolder)
                .assertThat()
                .hasDescendants(1, folderModel, testFile);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that non site member cannot get descendants for a folder from a private"
                            + " site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that non site member cannot get descendants for a folder from a"
                            + " moderated site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
