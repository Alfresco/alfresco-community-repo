...
public class PropertyTypeConverterTest {
    ...
    public void testGetPersistentTypeForStrings() {
        DefaultPropertyTypeConverter defaultPropertyTypeConverter =
                new DefaultPropertyTypeConverter();

        // Check string.
        PropertyValueEntity.PersistedType persistedType =
                PropertyValueEntity.getPersistedTypeEnum("test", defaultPropertyTypeConverter);
        ...
        persistedType =
                PropertyValueEntity.getPersistedTypeEnum(stringValue, defaultPropertyTypeConverter);
