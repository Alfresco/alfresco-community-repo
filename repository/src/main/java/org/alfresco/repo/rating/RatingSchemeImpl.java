...
public class RatingSchemeImpl
  implements RatingScheme, BeanNameAware, InitializingBean {
  ...
  public void setPropertyRollups(
    List<AbstractRatingRollupAlgorithm> rollupAlgorithms
  ) {
  ...
  public void afterPropertiesSet() throws Exception {
    if (this.minRating > this.maxRating) {
      ...
      msg
        .append("Illegal rating limits for ")
        .append(name)
        .append(". Min > Max. ")
        .append(minRating)
        .append(" > ")
  ...
  public String toString() {
    ...
    msg.append(" <");
    for (
      Iterator<AbstractRatingRollupAlgorithm> iter = propertyRollups.iterator();
      iter.hasNext();
    ) {
