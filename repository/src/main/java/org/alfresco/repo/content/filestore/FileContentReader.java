 ...
 *
 * <p>This class does not provide remote access to the file.
 *
 * @author Derek Hulley
 */
@AlfrescoPublicApi
public class FileContentReader extends AbstractContentReader
     ...
     *
     * <ul>
     *   <li>{@link org.alfresco.service.cmr.repository.NodeRef NodeRef}
     *   <li>{@link ContentReader ContentReader}
     * </ul>
     */
    ...
    /**
     * Checks the existing reader provided and replaces it with a reader onto some fake content if
     * required. If the existing reader is invalid, an debug message will be logged under this
     * classname category.
     *
     * <p>It is a convenience method that clients can use to cheaply get a reader that is valid,
     * regardless of whether the initial reader is valid.
     *
     * @param existingReader a potentially invalid reader or null
     * @param msgTemplate the template message that will used to format the final <i>fake</i>
     *     content
     ...
     */
    public static ContentReader getSafeContentReader(
            ContentReader existingReader, String msgTemplate, Object... args) {
     ...
     *
     * @param file the file for reading. This will most likely be directly related to the content
     *     URL.
     */
    ...
    /**
     * The URL of the write is known from the start and this method contract states that no
     * consideration needs to be taken w.r.t. the stream state.
     */
    @Override
        ...
        try {
            ...
            if (allowRandomAccess) {
                RandomAccessFile randomAccessFile =
                        new RandomAccessFile(file, "r"); // won't create it
     ...
     * @deprecated Since 5.1. This method has no value: a file reader can never write (DH:
     *     2015/02/17)
     */
    @Deprecated
