...
public class GetSiteMembershipFullTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that regular user is able to retrieve site membership details for a"
                            + " Collaborator role.")
    public void getSiteMembershipDetailsForACollaboratorRole() throws Exception {
        restSiteEntry =
                restClient
                        .authenticateUser(regularUser)
                        .withCoreAPI()
                        .usingUser(publicSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator))
                        .getSiteMembership(publicSite);
        restClient.assertStatusCodeIs(HttpStatus.OK);
        restSiteEntry
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "As regular user make a request to join a moderated site."
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "As Collaborator user leave site and perform get call."
