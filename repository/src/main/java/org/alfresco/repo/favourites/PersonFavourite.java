...
public class PersonFavourite {
    ...
    private Type
            type; // using a type rather then subclassing to make sorting of PersonFavourites easier
    // TODO
    ...
    public static class PersonFavouriteKey {
        ...
        public PersonFavouriteKey(
                String userName, String title, Type type, NodeRef nodeRef, Date createdAt) {
            super();
            this.userName = userName;
            this.type = type;
            this.nodeRef = nodeRef;
        ...
        public String toString() {
            return "PersonFavouriteKey [userName=" + userName + ", nodeRef=" + nodeRef + "]";
        }
    }
    ...
    public PersonFavourite(
            String userName, NodeRef nodeRef, Type type, String title, Date createdAt) {
        super();
        if (userName == null) {
            throw new IllegalArgumentException("Must provide a userName");
        }
    ...
    //	PersonFavourite(String userName, NodeRef nodeRef, Type type, String title, Date createdAt,
    // boolean exists)
    //	{
    ...
    public PersonFavouriteKey getKey() {
        PersonFavouriteKey key =
                new PersonFavouriteKey(
                        getUserName(), getTitle(), getType(), getNodeRef(), getCreatedAt());
        return key;
    }
    ...
    @Override
    public String toString() {
        return "PersonFavourite [userName="
                + userName
                + ", name="
                + title
                + ", type="
