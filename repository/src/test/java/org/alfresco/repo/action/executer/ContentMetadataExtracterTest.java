...
public class ContentMetadataExtracterTest extends BaseSpringTest {
    ...
    protected static final String QUICK_DESCRIPTION =
    ...
    public void before() throws Exception {
        ...
        registry =
                (MetadataExtracterRegistry) applicationContext.getBean("metadataExtracterRegistry");
        transactionService =
        ...
        this.executer =
                (ContentMetadataExtracter) this.applicationContext.getBean("extract-metadata");
    }
                            ...
                            public Void execute() throws Throwable {
                                ...
                                assertEquals(
                                        ...
                                        nodeService.getProperty(
                                                nodeRef, ContentModel.PROP_DESCRIPTION));
                                assertEquals(
                                        QUICK_CREATOR,
                                        nodeService.getProperty(nodeRef, ContentModel.PROP_AUTHOR));
                                return null;
                            }
                        });
    }

    private static final QName PROP_UNKNOWN_1 =
            QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "unkown1");
    private static final QName PROP_UNKNOWN_2 =
            QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "unkown2");
    ...
    /**
     * Ensure that missing raw values result in node properties being removed when running with
     * {@link ContentMetadataExtracter#setCarryAspectProperties(boolean)} set to <tt>false</tt>.
     */
    @Test
