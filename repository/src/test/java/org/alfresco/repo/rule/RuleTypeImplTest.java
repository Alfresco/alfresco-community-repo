...
public class RuleTypeImplTest extends BaseSpringTest {
  ...
  public void testMockInboundRuleType() {
    ...
    triggers.add(
      (RuleTrigger) this.applicationContext.getBean("on-content-create-trigger")
    );
    triggers.add(
      (RuleTrigger) this.applicationContext.getBean("on-create-node-trigger")
    );
    triggers.add(
      (RuleTrigger) this.applicationContext.getBean(
