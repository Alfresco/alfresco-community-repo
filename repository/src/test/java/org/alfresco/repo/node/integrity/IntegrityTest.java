 ...
 *
 * <p>The entire application context is loaded as is, but the integrity fail- mode is set to throw
 * an exception.
 *
 * <p>TODO: Role name restrictions must be checked
 *
 * @author Derek Hulley
 */
...
public class IntegrityTest extends TestCase {
    ...
    public static final QName TEST_TYPE_WITHOUT_ANYTHING =
            QName.createQName(NAMESPACE, "typeWithoutAnything");
    public static final QName TEST_TYPE_WITH_ASPECT =
            QName.createQName(NAMESPACE, "typeWithAspect");
    public static final QName TEST_TYPE_WITH_PROPERTIES =
            QName.createQName(NAMESPACE, "typeWithProperties");
    public static final QName TEST_TYPE_WITH_ENCRYPTED_PROPERTIES =
            QName.createQName(NAMESPACE, "typeWithEncryptedProperties");
    public static final QName TEST_TYPE_WITH_ASSOCS =
            QName.createQName(NAMESPACE, "typeWithAssocs");
    public static final QName TEST_TYPE_WITH_CHILD_ASSOCS =
            QName.createQName(NAMESPACE, "typeWithChildAssocs");
    public static final QName TEST_TYPE_WITH_NON_ENFORCED_CHILD_ASSOCS =
            QName.createQName(NAMESPACE, "typeWithNonEnforcedChildAssocs");
    public static final QName TEST_TYPE_WITH_NON_ENFORCED_TARGET_ASSOCS =
            QName.createQName(NAMESPACE, "typeWithNonEnforcedTargetAssocs");

    public static final QName TEST_ASSOC_NODE_ZEROMANY_ZEROMANY =
            QName.createQName(NAMESPACE, "assoc-0to* - 0to*");
    public static final QName TEST_ASSOC_CHILD_ZEROMANY_ZEROMANY =
            QName.createQName(NAMESPACE, "child-0to* - 0to*");
    public static final QName TEST_ASSOC_NODE_ONE_ONE =
            QName.createQName(NAMESPACE, "assoc-1to1 - 1to1");
    public static final QName TEST_ASSOC_NODE_ONE_MANY =
            QName.createQName(NAMESPACE, "assoc-1to1 - 0to*");
    public static final QName TEST_ASSOC_CHILD_ONE_ONE =
            QName.createQName(NAMESPACE, "child-1to1 - 1to1");
    public static final QName TEST_ASSOC_ASPECT_ONE_ONE =
            QName.createQName(NAMESPACE, "aspect-assoc-1to1 - 1to1");
    public static final QName TEST_ASSOC_CHILD_NON_ENFORCED =
            QName.createQName(NAMESPACE, "child-non-enforced");
    public static final QName TEST_ASSOC_TARGET_NON_ENFORCED =
            QName.createQName(NAMESPACE, "target-non-enforced");

    public static final QName TEST_ASPECT_WITH_PROPERTIES =
            QName.createQName(NAMESPACE, "aspectWithProperties");
    public static final QName TEST_ASPECT_WITH_ASSOC =
            QName.createQName(NAMESPACE, "aspectWithAssoc");
    public static final QName TEST_ASPECT_WITH_ASPECT =
            QName.createQName(NAMESPACE, "aspectWithAspect");
    ...
    public static final QName TEST_PROP_ENCRYPTED_A =
            QName.createQName(NAMESPACE, "prop-encrypted-a");
    public static final QName TEST_PROP_ENCRYPTED_B =
            QName.createQName(NAMESPACE, "prop-encrypted-b");
    public static final QName TEST_PROP_ENCRYPTED_C =
            QName.createQName(NAMESPACE, "prop-encrypted-c");
    ...
    public void setUp() throws Exception {
        ...
        InputStream modelStream =
                cl.getResourceAsStream("org/alfresco/repo/node/integrity/IntegrityTest_model.xml");
        ...
        integrityChecker.setMaxErrorsPerTransaction(
                100); // we want to count the correct number of errors
    ...
    private void checkIntegrityExpectFailure(String failureMsg, int expectedCount) {
        try {
            ...
            if (expectedCount >= 0) {
                assertEquals(
                        "Incorrect number of integrity records generated",
                        expectedCount,
                        e.getRecords().size());
            }
        }
    ...
    public void testTemporaryDowngrading() throws Exception {
        assertEquals(
                "Per-transaction override not correct",
                false,
                IntegrityChecker.isWarnInTransaction());
        // create bad node
    ...
    public void testCreateWithAspectForAspect() throws Exception {
        ...
        assertTrue(
                "Mandatory aspect missing",
                nodeService.hasAspect(nodeRef, TEST_ASPECT_WITH_PROPERTIES));
        checkIntegrityNoFailure();
    ...
    public void testCreateTargetOfAssocsWithMandatorySourcesPresent() throws Exception {
        ...
        nodeService.addChild(
                ...
                QName.createQName(NAMESPACE, "mandatoryChild"));
    ...
    /**
     * TODO: The dictionary support for the reverse lookup of mandatory associations will allow this
     * method to go in
     *
     * <p><b>Does nothing</b>.
     */
    public void testCreateTargetOfAssocsWithMandatorySourcesMissing() throws Exception {
        ...
        //
        //        checkIntegrityExpectFailure("Failed to detect missing mandatory assoc sources",
        // 3);
    ...
    public void testRemoveSourcesOfMandatoryAssocs() throws Exception {
        //        // this is the target of 3 assoc types where the source cardinality is 1..1
        //        NodeRef targetAndChild = createNode("targetAndChild", TEST_TYPE_WITHOUT_ANYTHING,
        // null);
        //
        //        NodeRef source = createNode("source", TEST_TYPE_WITH_ASSOCS, null);
        //        nodeService.createAssociation(source, targetAndChild, TEST_ASSOC_NODE_ONE_ONE);
        //
        //        NodeRef parent = createNode("parent", TEST_TYPE_WITH_CHILD_ASSOCS, null);
        //        nodeService.addChild(parent, targetAndChild, TEST_ASSOC_CHILD_ONE_ONE,
        // QName.createQName(NAMESPACE, "mandatoryChild"));
        //
        //        NodeRef aspectSource = createNode("aspectSource", TEST_TYPE_WITHOUT_ANYTHING,
        // null);
        //        nodeService.addAspect(aspectSource, TEST_ASPECT_WITH_ASSOC, null);
        //        nodeService.createAssociation(aspectSource, targetAndChild,
        ...
        //
        //        checkIntegrityExpectFailure("Failed to detect removal of mandatory assoc sources",
        // 3);
    ...
    public void testCreateSourceOfAssocsWithMandatoryTargetsPresent() throws Exception {
        ...
        nodeService.addChild(
                ...
                child,
                TEST_ASSOC_CHILD_ONE_ONE,
                QName.createQName(NAMESPACE, "one-to-one"));
    ...
    public void testExcessTargetsOfOneToOneAssocs() throws Exception {
        ...
        nodeService.addChild(
                ...
                child1,
                TEST_ASSOC_CHILD_ONE_ONE,
                QName.createQName(NAMESPACE, "one-to-one-first"));
        nodeService.addChild(
                parent,
                child2,
                TEST_ASSOC_CHILD_ONE_ONE,
                QName.createQName(NAMESPACE, "one-to-one-second"));
        ...
        checkIntegrityExpectFailure(
                "Failed to detect excess target cardinality for one-to-one assocs", 3);
    }
    ...
    public void testExcessTargetsOfOneToManyAssocs() throws Exception {
        ...
        checkIntegrityExpectFailure(
                "Failed to detect excess source cardinality for one-to-many assocs", 1);
    }
    ...
    public void testRelaxedMandatoryAssociation() throws Exception {
        ...
        // create node
        NodeRef nodeRef =
                createNode("relaxedAssocNode", TEST_TYPE_WITH_NON_ENFORCED_TARGET_ASSOCS, null);
        checkIntegrityNoFailure();
    }
}
