 ...
 * Virtualization is the process of converting {@link NodeRef}s into {@link Reference}s in the
 * context of given {@link ActualEnvironment} .
 *
 * @author Bogdan Horje
 */
public interface VirtualizationMethod {
    /**
     * Determines if a given {@link NodeRef} can be virtualized by this virtualization method.
     *
