 ...
 *
 * <p>GET web script to get limited metadata (including thumbnail defs) => authenticated web script
 * (using a nodeRef)
 *
 * <p>Note: authenticated web script (equivalent to unauthenticated version - see
    ...
    protected Map<String, Object> executeImpl(
        ...
        try {
            ...
            throw new WebScriptException(
                    ...
                    "Unable to find nodeRef: " + inre.getNodeRef());
        }
    }
}
