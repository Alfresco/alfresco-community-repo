...
public class CreateDocumentTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to create files in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            description =
                    "Verify inexistent user isn't able to create files in DocumentLibrary with"
                            + " CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthorized user isn't able to create files in DocumentLibrary with"
                            + " CMIS")
    @Test(
    ...
    public void unauthorizedUserShouldNotCreateDocument() throws Exception {
        ...
        testFile = FileModel.getRandomFileModel(FileType.MSWORD);
        cmisApi.authenticateUser(unauthorizedUser).usingSite(testSite).createFile(testFile);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager user is not able to create document twice in the same"
                            + " location with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisContentAlreadyExistsException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin user is not able to create document in invalid location with"
                            + " CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that admin user is not able to create document with invalid characters"
                            + " in name with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisConstraintException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to create document with invalid base type id"
                            + " with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisObjectNotFoundException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to create document with cmis:folder base type"
                            + " id with CMIS")
    @Test(
            groups = {"bug-atom-REPO-5389", TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisConstraintException.class,
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager user is able to create document with valid symbols in"
                            + " name")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    public void siteManagerCanCreateDocumentWithValidSymbols() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFile(validSymbolsDoc)
                .and()
                .assertThat()
                .existsInRepo();
        Assert.assertNotNull(
                cmisApi.withCMISUtil().getCmisObject(validSymbolsDoc.getCmisLocation()));
    }
    ...
    public void siteManagerShouldCreateDocumentWithMajorVersioningState() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFile(testFile, VersioningState.MAJOR)
                .and()
                .assertThat()
                .existsInRepo()
                .and()
    ...
    public void siteManagerShouldCreateDocumentWithMinorVersioningState() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                .usingSite(testSite)
                .createFile(testFile, VersioningState.MINOR)
                .and()
                .assertThat()
                .existsInRepo()
                .and()
                .assertThat()
                .documentHasVersion(0.1)
                .assertThat()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to create file with CHECKEDOUT versioning state")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    public void nonInvitedUserShouldNotCreateDocumentInSite() throws Exception {
        ...
        testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
        cmisApi.authenticateUser(outsider).usingSite(testSite).createFile(testFile);
    }
    ...
    public void disabledUserShouldNotCreateDocument() throws Exception {
        ...
        cmisApi.usingShared().createFile(testFile);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to create file with a name containing multi byte"
                            + " characters.")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that manager user is not able to create document at document location")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = InvalidCmisObjectException.class)
