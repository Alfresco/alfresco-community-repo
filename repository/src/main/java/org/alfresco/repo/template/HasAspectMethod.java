...
/**
 * @author Kevin Roast
 *     <p>Custom FreeMarker Template language method.
 *     <p>Method returns whether a TemplateNode has a particular aspect applied to it. The aspect
 *     name can be either the fully qualified QName or the short prefixed name string.
 *     <p>Usage: hasAspect(TemplateNode node, String aspect) - 1 on true, 0 on false
 */
public class HasAspectMethod extends BaseTemplateProcessorExtension
