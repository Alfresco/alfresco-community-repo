...
/**
 * SAX XML Content Handler to read a transfer manifest XML Stream and delegate processing of the
 * manifest to the specified TransferRequsiteProcessor
 *
 * @author Mark Rogers
 */
public class XMLTransferRequsiteReader extends DefaultHandler
        implements ContentHandler, NamespacePrefixResolver {
    private TransferRequsiteProcessor processor;

    /**
     * These are the namespaces used within the document - there may be a different mapping to the
     * namespaces of the Data Dictionary.
     */
