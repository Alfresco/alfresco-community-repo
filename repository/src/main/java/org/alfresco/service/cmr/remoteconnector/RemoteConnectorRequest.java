...
/**
 * Helper wrapper around a Remote Request, to be performed by the {@link RemoteConnectorService}. To have one of these created for you, use {@link RemoteConnectorService#buildRequest(String, String)}
 * 
 * @author Nick Burch
 * @since 4.0.2
 */
public interface RemoteConnectorRequest
{
    ...
    /**
     * Returns the Request Body, for use by the {@link RemoteConnectorService} which created this
     */
