...
public class RMv22ReportTemplatePatch extends AbstractModulePatch {
    ...
    public void applyInternal() {
        NodeRef transferReport =
                new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, TRANSFER_REPORT);
        NodeRef destructionReport =
                new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, DESTRUCTION_REPORT);
