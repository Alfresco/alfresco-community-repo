...
public class SubscriptionDAOTest extends TestCase {
  ...
  protected void insert(final String userId, final NodeRef node)
    throws Exception {
  ...
  protected void delete(final String userId, final NodeRef node)
    throws Exception {
    RetryingTransactionCallback<Object> callback = new RetryingTransactionCallback<Object>() {
      public Object execute() throws Throwable {
  ...
  protected boolean hasSubscribed(final String userId, final NodeRef node)
    throws Exception {
  ...
  protected PagingSubscriptionResults select(final String userId)
    throws Exception {
  ...
  protected PagingFollowingResults selectFollowing(final String userId)
    throws Exception {
  ...
  protected PagingFollowingResults selectFollowers(final String userId)
    throws Exception {
    RetryingTransactionCallback<PagingFollowingResults> callback = new RetryingTransactionCallback<PagingFollowingResults>() {
      public PagingFollowingResults execute() throws Throwable {
