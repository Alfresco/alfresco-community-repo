...
public interface PermissionsDaoComponent {
    ...
    /**
     * Delete as single permission entry, if a match is found. This deleted one permission on the
     * node. It does not affect the persistence of any other permissions.
     *
    ...
    /**
     * Set a permission on a node. If the node has no permissions set then a default node permission
     * (allowing inheritance) will be created to contain the permission entry.
     */
    public void setPermission(
            NodeRef nodeRef, String authority, PermissionReference perm, boolean allow);
