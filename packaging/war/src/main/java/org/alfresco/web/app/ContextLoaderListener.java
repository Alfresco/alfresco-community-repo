...
/**
 * A specialised {@link org.springframework.web.context.ContextLoaderListener} that can be disabled by a boolean <code>java:comp/env/properties/startup.enable</code> JNDI entry. If <code>startup.enable</code> is configured as false then the Spring Application Context is not created, allowing further configuration changes to be made after initial deployment.
 * 
 * @author dward
 */
