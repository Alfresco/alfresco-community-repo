...
public interface CannedQueryResults<R> extends PagingResults<R> {
    ...
    /**
     * Get the total number of results available within the pages of this result. The count excludes
     * results chopped out by the paging process i.e. it is only the count of results physically
     * obtainable through this instance.
     *
