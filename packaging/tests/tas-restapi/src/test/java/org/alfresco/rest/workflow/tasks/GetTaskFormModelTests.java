...
public class GetTaskFormModelTests extends RestTest {
  ...
  @TestRail(
    ...
    description = "Verify admin user gets all task form models with Rest API and response is successful (200)"
  )
  public void adminGetsTaskFormModels() throws Exception {
    ...
    for (String formQualifiedName : qualifiedNames) {
      returnedCollection
        .assertThat()
        .entriesListContains("qualifiedName", formQualifiedName);
    }
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.SANITY,
    description = "Verify user involved in task gets all the task form models with Rest API and response is successful (200)"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify admin user gets all task form models with properties parameter applied and response is successful (200)"
  )
  public void adminGetsTaskFormModelsWithPropertiesParameter()
    throws Exception {
    taskModel =
      dataWorkflow
        .usingUser(userModel)
  ...
  public void getTaskFormModelWithValidSkipCount() throws Exception {
    ...
    returnedCollection =
      restClient
        ...
        .getTaskFormModel();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    RestFormModel firstTaskFormModel = returnedCollection
      .getEntries()
      .get(0)
      .onModel();
    RestFormModel secondTaskFormModel = returnedCollection
      .getEntries()
      .get(1)
      .onModel();

    RestFormModelsCollection formModelsWithSkipCount = restClient
  ...
  public void getTaskFormModelWithValidMaxItems() throws Exception {
    ...
    RestFormModelsCollection formModelsWithMaxItems = restClient
