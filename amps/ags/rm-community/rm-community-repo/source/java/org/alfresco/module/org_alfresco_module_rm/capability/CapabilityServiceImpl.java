...
public class CapabilityServiceImpl implements CapabilityService {
   ...
   */
  @Override
  public AccessStatus getCapabilityAccessState(
    NodeRef nodeRef,
    ...
    if (capability != null) {
      ...
      Map<Capability, AccessStatus> map = getCapabilitiesAccessState(
        nodeRef,
        list
      );
  ...
  public boolean hasCapability(NodeRef nodeRef, String capabilityName) {
    Capability capability = getCapability(capabilityName);
    if (capability != null) {
      AccessStatus accessStatus = getCapabilityAccessState(
        nodeRef,
        capabilityName
      );
