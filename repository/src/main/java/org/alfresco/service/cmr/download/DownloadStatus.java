 ...
 * 
 * Provides the current status and an indication of the progress. Prgress is measured by comparing done against total. Total gives an indication of the total work, while done indicates how much has been completed.
 *
 * @author amiller
 */
public class DownloadStatus implements Serializable
{
    ...
    public enum Status
    {
        PENDING, IN_PROGRESS, DONE, MAX_CONTENT_SIZE_EXCEEDED, CANCELLED
    }
     ...
     * @param totalFiles
     *            The number of files that will eventually be added to the archive
     */
