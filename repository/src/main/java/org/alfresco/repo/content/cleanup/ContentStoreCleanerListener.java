...
/**
 * A listener that can be plugged into a {@link org.alfresco.repo.content.cleanup.ContentStoreCleaner cleaner} to move pre-process any content that is about to be deleted from a store.
 * <p>
...
public interface ContentStoreCleanerListener
{
     ...
     * 
     * @param sourceStore
     *            the store from which the content will be deleted
     * @param contentUrl
