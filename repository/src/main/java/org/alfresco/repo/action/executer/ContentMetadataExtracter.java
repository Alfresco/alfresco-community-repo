...
public class ContentMetadataExtracter extends ActionExecuterAbstractBase {
        ...
        if (singleValue instanceof String) {
          if (NodeRef.isNodeRef((String) singleValue)) {
            ...
            try {
              ...
              String tagName = (String) nodeService.getProperty(
                nodeRef,
            ...
            tags.addAll(
              splitTag((String) singleValue, stringTaggingSeparators)
            );
          }
  ...
  private static List<String> splitTag(
    String str,
    List<String> stringTaggingSeparators
  ) {
  ...
  public boolean isExecuteAsynchronously(NodeRef actionedUponNodeRef) {
    ...
    MetadataExtracter extracter = metadataExtracterRegistry.getExtractor(
      mimetype,
      sourceSizeInBytes
    );
  ...
  public void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
    ...
    if (
      enableStringTagging &&
      (extracter instanceof AbstractMappingMetadataExtracter)
    ) {
      ((AbstractMappingMetadataExtracter) extracter).setEnableStringTagging(
          enableStringTagging
        );
    }
    ...
    for (QName propertyQName : modifiedProperties.keySet()) {
      ...
      if (propertyContainerDef.isAspect()) {
        if (
          ...
          Set<QName> aspectProperties = propertyContainerDef
            .getProperties()
            .keySet();
