...
public interface DownloadModel {
    ...
    static final QName PROP_SEQUENCE_NUMBER =
            QName.createQName(DOWNLOAD_MODEL_1_0_URI, "sequenceNumber");
    ...
    // Associations
    static final QName ASSOC_REQUESTED_NODES =
            QName.createQName(DOWNLOAD_MODEL_1_0_URI, "requestedNodes");
}
