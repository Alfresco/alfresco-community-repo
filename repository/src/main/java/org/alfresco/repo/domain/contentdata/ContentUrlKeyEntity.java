...
public class ContentUrlKeyEntity implements Serializable {
    ...
    public static ContentUrlKeyEntity setEncryptedKey(
            ContentUrlKeyEntity existing, EncryptedKey encryptedKey) {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((masterKeyAlias == null) ? 0 : masterKeyAlias.hashCode());
        result = prime * result + ((masterKeystoreId == null) ? 0 : masterKeystoreId.hashCode());
        return result;
    }
