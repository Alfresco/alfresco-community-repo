...
public class InvitationServiceImpl
  ...
  private static final String MSG_NOT_SITE_MANAGER =
    "invitation.cancel.not_site_manager";
  private static final List<String> SEND_INVITE_NOMINATED_PROP_NAMES = Arrays.asList(
   ...
   */
  public void setNominatedInvitationWorkflowId(
  ...
  public void setNominatedInvitationExternalWorkflowId(
    ...
    this.nominatedInvitationExternalWorkflowId =
   ...
   */
  public void setModeratedInvitationWorkflowId(
  ...
  public void init() {
    ...
    this.inviteNominatedSender =
      new InviteNominatedSender(
        serviceRegistry,
        repositoryHelper,
        messageService
      );
    this.inviteModeratedSender =
      new InviteModeratedSender(
        serviceRegistry,
        repositoryHelper,
        messageService
      );
  ...
  public NominatedInvitation inviteNominated(
    ...
    Serializable emailVal =
      this.getNodeService().getProperty(person, ContentModel.PROP_EMAIL);
  ...
  public Invitation accept(String invitationId, String ticket) {
    ...
    if (invitation.getTicket().equals(ticket) == false) {
      //TODO localise msg
      String msg =
        "Response to invite has supplied an invalid ticket. The response to the invitation could thus not be processed";
  ...
  private void endInvitation(
    ...
    if (
      ...
      throw new InvitationExceptionUserError(
        "invitation.invite.already_finished",
        objs
      );
    }
  }
  ...
  public Invitation approve(String invitationId, String reason) {
    ...
    if (invitation == null) {
      String msg =
        "State error, can only call approve on a Moderated invitation.";
      throw new InvitationException(msg);
    }
    ...
    wfReviewProps.put(
      WorkflowModelModeratedInvitation.WF_PROP_REVIEW_COMMENTS,
      reason
    );
    endInvitation(
      startTask,
  ...
  public Invitation reject(String invitationId, String reason) {
    WorkflowTask startTask = getStartTask(invitationId);
    if (
      taskTypeMatches(startTask, WorkflowModelModeratedInvitation.WF_START_TASK)
    ) {
  ...
  private Invitation rejectModeratedInvitation(
    WorkflowTask startTask,
    String reason
  ) {
    ModeratedInvitation invitation = getModeratedInvitation(
      startTask.getPath().getId()
    );
  ...
  public Invitation cancel(String invitationId) {
    try {
      ...
      if (
        taskTypeMatches(
          startTask,
          WorkflowModelModeratedInvitation.WF_START_TASK
        )
      ) {
  ...
  private Map<String, WorkflowTask> getInvitationTasks(
    ...
    List<WorkflowTask> inviteStartTasks = workflowService.getStartTasks(
      invitationIds,
      true
    );
    ...
    Map<String, WorkflowTask> result = new HashMap<String, WorkflowTask>(
      inviteStartTasks.size() * 2
    );
  ...
  private NominatedInvitation getNominatedInvitation(WorkflowTask startTask) {
    ...
    if (
      taskTypeMatches(
        startTask,
        WorkflowModelNominatedInvitation.WF_TASK_INVITE_TO_SITE
      )
    ) {
  ...
  public List<Invitation> listPendingInvitationsForResource(
    ...
    InvitationSearchCriteriaImpl criteria = getPendingInvitationCriteriaForResource(
      resourceType,
      resourceName
    );
  ...
  public List<Invitation> searchInvitation(
    final InvitationSearchCriteria criteria
  ) {
  ...
  private List<Invitation> searchInvitation(
    ...
    final Map<String, WorkflowTask> taskCache = getInvitationTasks(
      invitationIds
    );
  ...
  private List<String> searchInvitationsForIds(
    ...
    if (
      (limit <= 0 || invitationIds.size() < limit) &&
      (
        toSearch == InvitationSearchCriteria.InvitationType.ALL ||
   ...
   * @return boolean
   */
  private boolean invitationMatches(
  ...
  private List<WorkflowTask> searchModeratedInvitations(
    ...
    if (workflowAdminService.isEngineEnabled(ActivitiConstants.ENGINE_ID)) {
      ...
      List<WorkflowTask> activitiTasks =
        this.workflowService.queryTasks(query, true);
  ...
  private String createInviteePerson(
    ...
    do {
      ...
      this.personService.personExists(inviteeUserName) &&
  ...
  private String createInviteeDisabledAccount(String inviteeUserName) {
    ...
    char[] generatedPassword = passwordGenerator
      .generatePassword()
      .toCharArray();
  ...
  private ModeratedInvitation startModeratedInvite(
    ...
    if (siteService.isMember(resourceName, inviteeUserName)) {
      if (logger.isDebugEnabled()) logger.debug(
        "Failed - invitee user is already a member of the site."
      );

      Object objs[] = { inviteeUserName, "", resourceName };
      throw new InvitationExceptionUserError(
        "invitation.invite.already_member",
        objs
      );
    }

    String roleGroup = siteService.getSiteRoleGroup(
      resourceName,
      SiteModel.SITE_MANAGER
    );

    // get the workflow description
    String workflowDescription = generateWorkflowDescription(
      siteInfo,
      "invitation.moderated.workflow.description"
    );
    ...
    WorkflowDefinition wfDefinition = getWorkflowDefinition(
      InvitationWorkflowType.MODERATED
    );
  ...
  private NominatedInvitation startNominatedInvite(
    ...
    if (inviteeUserName == null || inviteeUserName.trim().length() == 0) {
      ...
      Set<NodeRef> peopleWithInviteeEmail = personService.getPeopleFilteredByProperty(
        ...
        for (NodeRef personRef : peopleWithInviteeEmail) {
          ...
          if (
            ...
            if (
              ...
              if (logger.isDebugEnabled()) {
                logger.debug(
                  "not explictly passed username - found matching email, resolved inviteeUserName=" +
                  inviteeUserName
                );
              }
            }
      ...
      if (inviteeUserName == null) {
        ...
        if (!authenticationService.isAuthenticationCreationAllowed()) {
          throw new InvitationException(
            "invitation.invite.authentication_chain"
          );
        }
    ...
    if (!personService.isEnabled(inviteeUserName)) {
      if (logger.isDebugEnabled()) logger.debug(
        "Failed - invitee user is disabled."
      );

      Object objs[] = { inviteeUserName, inviteeEmail, siteShortName };
      throw new InvitationExceptionUserError(
        "invitation.invite.user_disabled",
        objs
      );
    }
    ...
    String inviteePassword = created
      ? AuthenticationUtil.runAs(
    ...
    InvitationWorkflowType type = created
    ...
    String workflowDescription = generateWorkflowDescription(
      siteInfo,
      "invitation.nominated.workflow.description"
    );
    ...
    workflowProps.put(
      WorkflowModelNominatedInvitation.WF_PROP_RESOURCE_TITLE,
      siteInfo.getTitle()
    );
    workflowProps.put(
      WorkflowModelNominatedInvitation.WF_PROP_RESOURCE_DESCRIPTION,
      siteDescription
    );
    workflowProps.put(
  ...
  public ModeratedInvitation updateModeratedInvitation(
    ...
    WorkflowTask reviewTask = getModeratedInvitationReviewTask(
      inviteeId,
      siteShortName
    );
    if (reviewTask == null) {
      Object objs[] = { siteShortName, inviteeId };
      throw new InvitationExceptionNotFound(
        "invitation.error.not_found_by_invitee",
        objs
      );
    } else {
      ...
      if (inviteeComments != null) {
        ...
        Date time = new Date();
        properties.put(
          WorkflowModelModeratedInvitation.WF_PROP_MODIFIED_AT,
          time
        );
        reviewTask =
  ...
  private Invitation startWorkflow(
    ...
    Map<QName, Serializable> workflowProps
  ) {
    ...
    if (logger.isDebugEnabled()) logger.debug(
      "Starting Invite workflow task by attaching empty package..."
    );

    if (logger.isDebugEnabled()) logger.debug(
      "Transitioning Invite workflow task..."
    );
    try {
      if (
        startTask != null && startTask.getState() != WorkflowTaskState.COMPLETED
      ) {
  ...
  private String getNominatedDefinitionName() {
    ...
    throw new IllegalStateException(
      "None of the Workflow engines supported by the InvitationService are currently enabled!"
    );
  }
  ...
  private void checkManagerRole(
    ...
    if (
      ...
      throw new InvitationExceptionForbidden(
        "invitation.invite.not_site_manager",
        objs
      );
    }
  }
      ...
      new AuthenticationUtil.RunAsWork<Object>() {
        ...
        public Object doWork() throws Exception {
          ...
          if (dictionaryService.isSubClass(type, SiteModel.TYPE_SITE)) {
            ...
            String siteName = (String) nodeService.getProperty(
              siteRef,
            ...
            if (siteName != null) {
              ...
              List<String> invitationIds = searchInvitationsForIds(
                criteria,
                -1
              );
            ...
            dictionaryService.isSubClass(type, ContentModel.TYPE_PERSON)
          ) {
  ...
  private void invalidateTasksByUser(String userName)
    throws AuthenticationException {
    List<Invitation> listForInvitee = listPendingInvitationsForInvitee(
      userName
    );
   ...
   */
  protected String generateWorkflowDescription(
    SiteInfo siteInfo,
    String messageId
  ) {
    ...
    Locale locale = (Locale) this.nodeService.getProperty(
        siteInfo.getNodeRef(),
    ...
    return I18NUtil.getMessage(
      messageId,
      locale == null ? I18NUtil.getLocale() : locale,
      siteTitle
    );
  }
    ...
    try {
      ...
      emailAction.setParameterValue(
        ...
        nodeService.getProperty(
          personService.getPerson(invitee),
          ContentModel.PROP_EMAIL
        )
      );
      emailAction.setParameterValue(
        ...
        nodeService.getProperty(
          personService.getPerson(reviewer),
          ContentModel.PROP_EMAIL
        )
      );
      // TODO Localize this.
    ...
    AuthenticationUtil.runAs(
      new RunAsWork<Object>() {
        public Object doWork() throws Exception {
          ...
          List<Invitation> pendingInvites = listPendingInvitationsForInvitee(
            invitee
          );
          boolean invitesPending =
            CollectionUtils.isEmpty(pendingInvites) == false;
  ...
  private String getPackageRef(Map<String, Object> executionVariables) {
    String packageName = WorkflowModel.ASSOC_PACKAGE
  ...
  public void cancelInvitation(
    ...
    if (!AuthenticationUtil.isRunAsUserTheSystemUser()) {
      ...
      String currentUserSiteRole = siteService.getMembersRole(
        siteName,
        currentUserName
      );
  ...
  private ModeratedInvitation startModeratedInvite(
    ...
    workflowProps.put(
      WorkflowModelModeratedInvitation.WF_PROP_CLIENT_NAME,
      clientName
    );
