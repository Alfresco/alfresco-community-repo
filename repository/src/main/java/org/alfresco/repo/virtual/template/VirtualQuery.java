...
public interface VirtualQuery {
     ...
     * @deprecated will be replaced by {@link #perform(ActualEnvironment,
     *     VirtualQueryConstraint,Reference)} once complex constrains are implemented
     */
    PagingResults<Reference> perform(
