...
public class MethodSecurityBean<R> implements InitializingBean {
  ...
  public String toString() {
    return (
      "MethodSecurityBean [serviceInterface=" +
      service.getName() +
      ", methodName=" +
      methodName +
      "]"
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    if (!(methodInterceptor instanceof MethodSecurityInterceptor)) {
      ...
      if (logger.isTraceEnabled()) {
        logger.trace(
          "Method interceptor doesn't apply security: " +
          methodSecurityInterceptor
        );
      }
    } else {
      this.methodSecurityInterceptor =
        (MethodSecurityInterceptor) this.methodInterceptor;
      this.cad =
        methodSecurityInterceptor
  ...
  public Collection<R> applyPermissions(
    ...
    Collection<R> ret = (Collection<R>) methodSecurityInterceptor
