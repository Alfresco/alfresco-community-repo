...
public class PropertyMapTest {
  ...
  public void propertiesAdded() throws Exception {
    ...
    assertEquals(
      expected,
      PropertyMap.getAddedProperties(beforeTestMap, afterTestMap)
    );
  }
  ...
  public void propertiesChanged() throws Exception {
    ...
    assertEquals(
      expected,
      PropertyMap.getChangedProperties(beforeTestMap, afterTestMap)
    );
  }
  ...
  public void propertiesRemoved() throws Exception {
    ...
    assertEquals(
      expected,
      PropertyMap.getRemovedProperties(beforeTestMap, afterTestMap)
    );
  }
  ...
  public void propertiesUnchanged() throws Exception {
    ...
    assertEquals(
      expected,
      PropertyMap.getUnchangedProperties(beforeTestMap, afterTestMap)
    );
  }
  ...
  public void nullMapsShouldntCauseExceptions() throws Exception {
    assertEquals(
      ...
      PropertyMap.getAddedProperties(null, null)
    );
    assertEquals(
      Collections.emptyMap(),
      PropertyMap.getRemovedProperties(null, null)
    );
    assertEquals(
      Collections.emptyMap(),
      PropertyMap.getChangedProperties(null, null)
    );
    assertEquals(
      Collections.emptyMap(),
      PropertyMap.getUnchangedProperties(null, null)
    );
  }
}
