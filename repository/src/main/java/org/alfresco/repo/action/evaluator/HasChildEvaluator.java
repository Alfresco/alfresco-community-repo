...
/**
 * This {@link ActionConditionEvaluator} determines whether an actionedUponNodeRef has a child
 * {@link NodeRef} with the specified assoc-name or assoc-type.
 *
    ...
    public boolean evaluateImpl(ActionCondition ruleCondition, NodeRef actionedUponNodeRef) {
        ...
        if (this.nodeService.exists(actionedUponNodeRef) == true) {
            ...
            List<ChildAssociationRef> children =
                    nodeService.getChildAssocs(actionedUponNodeRef, assocType, assocName);
    ...
    protected void addParameterDefinitions(List<ParameterDefinition> paramList) {
        paramList.add(
                new ParameterDefinitionImpl(
                        ...
                        false,
                        getParamDisplayLabel(PARAM_ASSOC_TYPE),
                        false));
        paramList.add(
                new ParameterDefinitionImpl(
                        PARAM_ASSOC_NAME,
                        DataTypeDefinition.QNAME,
                        false,
                        getParamDisplayLabel(PARAM_ASSOC_NAME),
                        false));
    }
}
