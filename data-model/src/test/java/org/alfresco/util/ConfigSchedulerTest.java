...
public class ConfigSchedulerTest extends TestCase {
  ...
  public TestRegistry.Data assertDataChanged(
    TestRegistry.Data prevData,
    String msg
  ) {
  ...
  public TestRegistry.Data assertDataUnchanged(
    TestRegistry.Data prevData,
    String msg
  ) {
    // If the data changes, there has been a read
  ...
  public void testSwitchingOfSchedule() throws Exception {
    ...
    data =
      assertDataChanged(data, "There should have been a read after 18 seconds");
  }
}
