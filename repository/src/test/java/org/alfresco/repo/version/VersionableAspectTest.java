...
public class VersionableAspectTest extends TestCase {
                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                if (!nodeService.hasAspect(
                                        document, ContentModel.ASPECT_VERSIONABLE)) {
        ...
        transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                Map<QName, Serializable> properties =
                                        getAndAssertProperties(document, "0.1");
        ...
        transactionService
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                Map<QName, Serializable> properties =
                                        getAndAssertProperties(document, "0.2");
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                assertEquals(
                                        LockStatus.LOCK_OWNER, lockService.getLockStatus(document));
    ...
    private void assertDocumentVersionAndName(
            final String versionLabel, final String name, final VersionType versionType) {
        transactionService
                .getRetryingTransactionHelper()
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                                ...
                                if (versionType != null) {
                                    Serializable versionTypeProperty =
                                            nodeService.getProperty(
                                                    document, ContentModel.PROP_VERSION_TYPE);
                                    assertNotNull(versionTypeProperty);
                                    assertTrue(
                                            versionTypeProperty
                                                    .toString()
                                                    .equals(versionType.toString()));
                                }
    ...
    private String generateDocumentName(String namePattern, String versionLabel) {
        ...
        StringBuilder result =
                new StringBuilder(nameAndExt[i++])
                        .append(versionLabel)
