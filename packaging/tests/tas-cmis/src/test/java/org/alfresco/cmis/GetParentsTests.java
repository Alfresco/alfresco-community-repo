...
public class GetParentsTests extends CmisTest {
    ...
    public void siteManagerGetsFileParents() throws Exception {
        cmisApi.authenticateUser(testUser)
                ...
                .then()
                .assertThat()
                .hasParents(testFolder.getName(), parentFolder.getName());
    }
    ...
    public void siteManagerGetsFolderParents() throws Exception {
        cmisApi.authenticateUser(testUser)
                ...
                .then()
                .assertThat()
                .hasParents(parentFolder.getName());
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is NOT able to get parents for an inexistent folder with"
                            + " CMIS")
    @Test(
    ...
    public void siteManagerCannotGetInexistentFolderParents() throws Exception {
        ...
        cmisApi.authenticateUser(testUser)
                ...
                .existsInRepo()
                .and()
                .usingResource(inexistentFolder)
                .assertThat()
                .hasParents(parentFolder.getName());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non site member for a private site is not able to get folder parents"
                            + " with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non site member for a private site is not able to get file parents with"
                            + " CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non site member for a moderated site is not able to get folder parents"
                            + " with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non site member for a moderated site is not able to get file parents"
                            + " with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
