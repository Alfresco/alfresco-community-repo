...
public class MultiTServiceImplTest extends BaseSpringTest {
  ...
  private static final StoreRef DEFAULT_STORE =
  ...
  private static final QName QNAME = QName.createQName(
    NAMESPACE_URI,
    LOCAL_NAME
  );
  private static final AssociationRef assocRef = new AssociationRef(
    NODE_REF,
    QNAME,
    NODE_REF
  );
  ...
  public void setUp() throws Exception {
    multiTServiceImpl =
      applicationContext.getBean("tenantService", MultiTServiceImpl.class);
    tenantAdminService =
    ...
    tenantService =
      applicationContext.getBean("tenantService", TenantService.class);
    ...
    searchService =
      applicationContext.getBean("SearchService", SearchService.class);
    namespaceService =
      applicationContext.getBean("NamespaceService", NamespaceService.class);
    ...
    STRING_WITH_EXISTENT_DOMAIN =
      TenantService.SEPARATOR + DOMAIN + TenantService.SEPARATOR;
    STRING_WITH_NONEXITENT_DOMAIN =
      TenantService.SEPARATOR + STRING + TenantService.SEPARATOR;
    TENANT_STORE =
      new StoreRef(
        StoreRef.PROTOCOL_WORKSPACE,
        addDomainToId("SpacesStore", DOMAIN)
      );
    TENANT_NODE_REF =
      new NodeRef(PROTOCOL, addDomainToId(IDENTIFIER, DOMAIN), ID);
    TENANT_STORE_REF =
      new StoreRef(PROTOCOL, addDomainToId(IDENTIFIER, DOMAIN));
    TENANT_QNAME =
      QName.createQName(addDomainToId(NAMESPACE_URI, DOMAIN), LOCAL_NAME);
    tenantAssocRef =
      new AssociationRef(TENANT_NODE_REF, QNAME, TENANT_NODE_REF);
    childAssocRef = new ChildAssociationRef(QNAME, NODE_REF, QNAME, NODE_REF);
    tenantChildAssocRef =
      new ChildAssociationRef(QNAME, TENANT_NODE_REF, QNAME, TENANT_NODE_REF);
  ...
  public void testIsTenantUser() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NodeRef userNodeRef = createUser(
          USER1,
        ...
        assertFalse(
          "The user is not from a tenant, but was reported otherwise.",
          multiTServiceImpl.isTenantUser(USER1)
        );

        // Create a user with a name as an email, but not from tenant
        userNodeRef =
          createUser(USER2_WITH_DOMAIN, TenantService.DEFAULT_DOMAIN, PASS);
        assertNotNull("The user was not created.", userNodeRef);
        assertFalse(
          "The user is not from a tenant, but was reported otherwise.",
          multiTServiceImpl.isTenantUser(USER2_WITH_DOMAIN)
        );
        ...
        assertNotNull("The user was not created.", userNodeRef);
        assertTrue(
          "The user is from a tenant, but was reported otherwise.",
          multiTServiceImpl.isTenantUser(
            USER3 + MultiTServiceImpl.SEPARATOR + DOMAIN
          )
        );
        return null;
      }
  ...
  public void testGetCurrentUserDomain() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        result =
          TenantUtil.runAsUserTenant(work, USER2, TenantService.DEFAULT_DOMAIN);
        assertEquals(
    ...
    assertEquals(
      "fred",
      multiTServiceImpl.getMultiTenantDomainName("@fred@bloggs")
    );
  }
  ...
  public void testGetName() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NodeRef result = TenantUtil.runAsUserTenant(
          work1,
          USER1,
          TenantService.DEFAULT_DOMAIN
        );
        ...
        assertEquals(
          "The NodeRef should contain domain.",
          TENANT_NODE_REF,
          result
        );
        ...
        assertEquals(
          "The StoreRef should contain domain.",
          TENANT_STORE_REF,
          result2
        );
        ...
        ChildAssociationRef result3 = TenantUtil.runAsUserTenant(
          work3,
          USER2,
          DOMAIN
        );
        assertEquals(
          "The ChildAssociationRef should contain domain.",
          tenantChildAssocRef,
          result3
        );
        ...
        AssociationRef result4 = TenantUtil.runAsUserTenant(
          work4,
          USER2,
          DOMAIN
        );
        assertEquals(
          "The AssociationRef should contain domain.",
          tenantAssocRef,
          result4
        );
        ...
        assertEquals(
          "The String should contain domain.",
          TENANT_STRING,
          result8
        );
        return null;
  ...
  public void testGetBaseName() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertEquals(
          "The NodeRef should not contain domain.",
          NODE_REF,
          result
        );
        ...
        StoreRef result2 = TenantUtil.runAsUserTenant(work2, USER2, DOMAIN);
        assertEquals(
          "The StoreRef should not contain domain.",
          STORE_REF,
          result2
        );
        ...
        assertEquals(
          "The ChildAssociationRef not should contain domain.",
          childAssocRef,
          result3
        );
        ...
        assertEquals(
          "The AssociationRef should not contain domain.",
          assocRef,
          result4
        );
  ...
  public void testCheckDomainUser() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        String username3WithDomain =
          USER3 + TenantService.SEPARATOR + nonExistentDomain;
        try {
    ...
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        try {
          ...
          fail(
            "The string has a domain, which should not match the default one."
          );
        } catch (Exception e) {
          // Expected
        }
        ...
        try {
          ...
          fail(
            "The string has a tenant domain and should match the execution context tenant."
          );
        }
        ...
        try {
          ...
          fail(
            "The string has a domain, which should not match the execution context tenant."
          );
        } catch (Exception e) {
          // Expected
        }
  ...
  public void testGetRootNode() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        NodeRef nodeRef = tenantService.getRootNode(
          nodeService,
          searchService,
          namespaceService,
          ROOT_PATH,
        ...
        assertEquals(
          "The reported rootNodeRef for the default domain is not correct.",
          rootNodeRefDefault,
          nodeRef
        );
        ...
        assertEquals(
          "The reported rootNodeRef for the tenant domain is not correct.",
          rootNodeRefDefault,
          nodeRef
        );
        return null;
  ...
  public void testGetPrimaryDomain() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertNull(
          "The primary domain should be null for a non tenant user without a tenant in name.",
          result
        );

        result = tenantService.getPrimaryDomain(USER2_WITH_DOMAIN);
        assertNull(
          "The primary domain should be null for a tenant user if multi tenancy is not enabled.",
          result
        );
        ...
        result = tenantService.getPrimaryDomain(USER2_WITH_DOMAIN);
        assertEquals(
          "The primary domain of the USER2 should be " +
          DOMAIN +
          ", but was reported as " +
          result,
          DOMAIN,
        ...
        assertTrue(
          "The primary domain should be the default one (empty string) for a non tenant user without a tenant in name.",
          result.equals(TenantService.DEFAULT_DOMAIN)
        );
        return null;
      }
    };
  ...
  public void testGetDomain() throws Exception {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertEquals(
          "The domain should be reported as default.",
          TenantService.DEFAULT_DOMAIN,
          result
        );
        ...
        createUser(USER2, DOMAIN, PASS);
        result =
          getDomainWork(STRING, TenantService.DEFAULT_DOMAIN, USER2, false);
        assertEquals(
          "The domain should be reported as default as the tenant was not created yet.",
          TenantService.DEFAULT_DOMAIN,
          result
        );
        ...
        createTenant(DOMAIN);
        result =
          getDomainWork(STRING_WITH_EXISTENT_DOMAIN, DOMAIN, USER2, false);
        assertEquals(
          "The USER2 domain should be reported as " + DOMAIN,
          DOMAIN,
          result
        );
        ...
        try {
          ...
          assertEquals(
            "The domain should be reported as " + DOMAIN,
            DOMAIN,
            result
          );
        } catch (Exception e) {
        ...
        try {
          result =
            getDomainWork(STRING_WITH_NONEXITENT_DOMAIN, DOMAIN, USER2, true);
  ...
  public void testGetTenant() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertTrue(
          "The tenant should have the correct domain.",
          DOMAIN.equals(tenant.getTenantDomain())
        );
  ...
  public void testGetUserDomain() {
    RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
      ...
      public Void execute() throws Throwable {
        ...
        assertEquals(
          "The user domain should be the default one for a non tenant user without a tenant in name.",
          TenantService.DEFAULT_DOMAIN,
          result
        );
        ...
        assertEquals(
          "The user domain should be the default one for a user with email like name if multi tenancy is not enabled.",
          TenantService.DEFAULT_DOMAIN,
          result
        );
        ...
        result = tenantService.getUserDomain(USER2_WITH_DOMAIN);
        assertEquals(
          "The user domain should be of the USER2 is " +
          DOMAIN +
          ", but was reported as " +
          result,
          DOMAIN,
        ...
        assertTrue(
          "The user domain should be the default one (empty string) for a non tenant user without a tenant in name.",
          result.equals(TenantService.DEFAULT_DOMAIN)
        );
        return null;
      }
   ...
   * @throws Exception
   */
  private String getDomainWork(
    final String user,
    String domain,
    String runAsUsername,
    final boolean checkCurrentDomain
  ) throws Exception {
    TenantRunAsWork<String> work = new TenantRunAsWork<String>() {
      @Override
      public String doWork() throws Exception {
   ...
   * @throws Exception
   */
  private void checkDomainUserWork(
          ...
          RetryingTransactionHelper.RetryingTransactionCallback<Void> work = new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
            public Void execute() throws Throwable {
              ...
              if (tenantAdminService.existsTenant(tenantDomain)) {
                ...
                {
                  BehaviourFilter behaviourFilter = (BehaviourFilter) applicationContext.getBean(
