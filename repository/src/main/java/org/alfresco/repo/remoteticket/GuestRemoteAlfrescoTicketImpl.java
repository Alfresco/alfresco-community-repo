...
/**
 * An implementation of {@link org.alfresco.service.cmr.remoteticket.RemoteAlfrescoTicketInfo} which authenticates as the Guest user
 * 
 * @author Nick Burch
 * @since 4.0.2
 */
public class GuestRemoteAlfrescoTicketImpl extends AbstractRemoteAlfrescoTicketImpl
{
    ...
    /**
     * Returns the Ticket in the form of a pseudo username and password. The Username is a special ticket identifier, and the password is the ticket
     */
