...
public interface AuditModelRegistry {
    ...
    public static final String AUDIT_SCHEMA_LOCATION =
    ...
    /**
     * Method to load audit models into memory. This method is also responsible for persisting the
     * audit models for later retrieval.
     *
     * <p>Note, the models are loaded in a new transaction, so this method can be called by any code
     * at any time.
     */
