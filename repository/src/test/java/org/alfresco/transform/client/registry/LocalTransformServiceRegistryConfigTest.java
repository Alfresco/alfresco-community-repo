...
public class LocalTransformServiceRegistryConfigTest
  ...
  private class TestLocalTransformServiceRegistry
    ...
    public synchronized void setMockSuccessReadingConfig(
      boolean mockSuccessReadingConfig
    ) {
      System.out.println(
        "\n" +
        getMs() +
    ...
    public Data assertDataChanged(Data prevData, String msg) {
      ...
      Data data = getData();
      assertNotEquals(
        "The configuration data should have changed: " + msg,
        data,
        prevData
      );
      return data;
    ...
    public Data assertDataUnchanged(Data data, String msg) {
      ...
      System.out.println(getMs() + msg);
      assertEquals(
        "The configuration data should be the same: " + msg,
        getData(),
        data
      );
      return getData();
  ...
  private static Log log = LogFactory.getLog(
    LocalTransformServiceRegistry.class
  );
  ...
  public void setUp() throws Exception {
    ...
    super.setUp();
    LogManager
      .getLogger(LocalTransformServiceRegistryConfigTest.class)
  ...
  private void initTestData() {
    // Add JVM properties
    System.setProperty(
      LOCAL_TRANSFORM + "pdfrenderer" + URL,
      "http://localhost:8090/"
    );
    System.setProperty(
      LOCAL_TRANSFORM + "imagemagick" + URL,
      "http://localhost:8091/"
    );
    System.setProperty(
      LOCAL_TRANSFORM + "libreoffice" + URL,
      "http://localhost:8092/"
    );
    System.setProperty(
      LOCAL_TRANSFORM + "tika" + URL,
      "http://localhost:8093/"
    );
  ...
  public void testJsonConfig() throws IOException {
    ...
    assertEquals(
      "The number of UNIQUE source to target mimetypes transforms has changed. Config change?",
      64,
      countSupportedTransforms(true)
    );
    assertEquals(
      "The number of source to target mimetypes transforms has changed. " +
    ...
    assertSupported(
      ...
      invalidPdfOptions,
      null,
      "Invalid as there is a extra option"
    );
  }
  ...
  public void testJsonPipeline() throws IOException {
    ...
    Map<String, List<SupportedTransform>> transformsToWord = registry
      .getData()
      .getTransforms()
      .get(DOC);
    ...
    Set<TransformOption> transformOptionsSet = supportedTransform
      .getTransformOptions()
      .getTransformOptions();
    ...
    TransformOptionValue alphaRemove = (TransformOptionValue) retrieveTransformOptionByPropertyName(
      imagemagick,
      "alphaRemove",
      "TransformOptionValue"
    );
    TransformOptionGroup crop = (TransformOptionGroup) retrieveTransformOptionByPropertyName(
      imagemagick,
      "crop",
      "TransformOptionGroup"
    );
    TransformOptionValue cropGravity = (TransformOptionValue) retrieveTransformOptionByPropertyName(
      crop,
      "cropGravity",
      "TransformOptionValue"
    );
    TransformOptionValue cropWidth = (TransformOptionValue) retrieveTransformOptionByPropertyName(
      crop,
      "cropWidth",
      "TransformOptionValue"
    );
    ...
    assertFalse(
      "imagemagick should be optional as it is not set",
      imagemagick.isRequired()
    );
    assertFalse(
      "pdf should be optional as required is not set",
      pdf.isRequired()
    );
    ...
    assertFalse(
      "alphaRemove should be optional as required is not set",
      alphaRemove.isRequired()
    );
    assertFalse(
      "crop should be optional as required is not set",
      crop.isRequired()
    );
    assertTrue(
      "cropGravity should be required as it is set",
      cropGravity.isRequired()
    );
    assertFalse(
      "cropWidth should be optional as required is not set",
      cropWidth.isRequired()
    );
  ...
  private TransformOption retrieveTransformOptionByPropertyName(
    ...
    Iterator<TransformOption> iterator = transformOptionGroup
      .getTransformOptions()
      .iterator();
    ...
    for (TransformOption t : transformOptionsList) {
      if (t instanceof TransformOptionValue) {
        ...
        if (propertyType.equalsIgnoreCase("TransformOptionValue")) {
          ...
          if (
            value.getName().contains(propertyName)
          ) return transformOptionGroup;
        }
      } else {
        TransformOption result = retrieveTransformOptionByPropertyName(
          (TransformOptionGroup) t,
          propertyName,
          propertyType
        );
  ...
  private int countSupportedTransforms(boolean unique) {
    int count = 0;
    int uniqueCount = 0;
    for (Map<String, List<SupportedTransform>> targetMap : registry
      .getData()
      .getTransforms()
      .values()) {
  ...
  public void testReadJsonConfig() {
    ...
    assertEquals(
      "Unexpected number of transformers retrieved",
      5,
    ...
    for (CombinedConfig.TransformAndItsOrigin t : transformerList) {
      assertTrue(
        ...
        listOfExpectedTransformersName.contains(
          t.transformer.getTransformerName()
        )
      );
  ...
  public void testReadTransformProperties() {
    ...
    for (CombinedConfig.TransformAndItsOrigin t : transformerList) {
      if (t.transformer.getTransformerPipeline() == null) {
        assertNotNull(
          t.transformer.getTransformerName() +
          " alfresco-global property not set.",
  ...
  public void testAdditionAndRemovalOfTEngines() throws Exception {
    ...
    try {
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 2 seconds that fails"
        );
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 4 seconds that fails"
        );
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 6 seconds that fails"
        );
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 8 seconds that succeeds"
        );
      ...
      data =
        registry.assertDataUnchanged(
          data,
          "There really should not have been a read until 12 seconds"
        );
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 12 seconds that succeeds"
        );
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 16 seconds that fails"
        );
      ...
      data =
        registry.assertDataChanged(
          data,
          "There should have been a read after 18 seconds"
        );
    } finally {
      registry.setMockSuccessReadingConfig(true);
      registry.setCronExpression(origCronExpression);
      registry.setInitialAndOnErrorCronExpression(
        origInitialAndOnErrorCronExpression
      );
  ...
  public void testStripExtraOptions() {
    ...
    LocalPipelineTransform officeToImageViaPdf = (LocalPipelineTransform) (
    ...
    AbstractLocalTransform libreoffice = (AbstractLocalTransform) officeToImageViaPdf.getIntermediateTransformer(
      0
    );
    assertEquals(
      "libreoffice options",
      0,
      libreoffice.getTransformsTransformOptionNames().size()
    );
    assertEquals(
    ...
    AbstractLocalTransform pdfrenderer = (AbstractLocalTransform) officeToImageViaPdf.getIntermediateTransformer(
      1
    );
    assertEquals(
      "pdfrenderer options",
      5,
      pdfrenderer.getTransformsTransformOptionNames().size()
    );
    assertEquals(
      "pdfrenderer actual options",
      2,
      pdfrenderer.getStrippedTransformOptions(actualOptions).size()
    ); // width, height

    AbstractLocalTransform imagemagick = (AbstractLocalTransform) officeToImageViaPdf.getIntermediateTransformer(
      2
    );
    assertEquals(
      "imagemagick options",
      16,
      imagemagick.getTransformsTransformOptionNames().size()
    );
    assertEquals(
      "imagemagick actual options",
      1,
      imagemagick.getStrippedTransformOptions(actualOptions).size()
    ); // autoOrient
  }
  ...
  public void testPriority() {
    ...
    assertEquals(
      "pdfrenderer",
      (
        (AbstractLocalTransform) registry.getLocalTransform(
          "source",
          -1,
          "target1",
  ...
  public void testNoName() {
    retrieveLocalTransformList(
      "alfresco/local-transform-service-config-no-name-test.json"
    );
    registry.assertErrorLogged(
      "Transformer names may not be null.*no-name-test.*"
    );
  }
  ...
  public void testPipelineAndFailover() {
    ...
    registry.assertErrorLogged(
      "Transformer .* cannot have pipeline and failover sections.*pipeline-and-failover.*"
    );
  }
  ...
  public void testTEngineDuplicateNames() {
    retrieveLocalTransformList(
      "alfresco/local-transform-service-config-dup-name-test.json"
    );
    registry.assertErrorLogged(
      "Transformer \"pdfrenderer\" must be a unique name.*dup-name.*"
    );
  }
  ...
  public void testTEngineNoBaseUrls() {
    ...
    retrieveLocalTransformList(
      "alfresco/local-transform-service-config-no-base-url-test.json"
    );
    registry.assertErrorLogged(
  ...
  public void testPipelineMissingStepTransform() {
    ...
    registry.assertErrorLogged(
      "Transformer \"missingPdfrenderer\" ignored as step transforms \\(\"pdfrenderer\"\\) do not exist.*pipeline-missing-step-test.*"
    );
  }
  ...
  public void testFailoverMissingStepTransform() {
    ...
    registry.assertErrorLogged(
      "Transformer \"missingPdfrenderer\" ignored as step transforms \\(\"pdfrenderer\"\\) do not exist.*failover-missing-step-test.*"
    );
  }
  ...
  public void testOverrideTEngine() {
    ...
    retrieveLocalTransformList(
      "alfresco/local-transform-service-config-override-test.json"
    );
    ...
    assertNotNull(
      "options2 should exist",
      mapOfTransformOptions.get("options2")
    );
    ...
    LocalTransformImpl localTransform = (LocalTransformImpl) registry.getLocalTransform(
      "text/csv",
      -1,
      "application/pdf",
      Collections.emptyMap(),
  ...
  public void testOverrideTEngineWithPipeline() {
    ...
    LocalPipelineTransform pipelineTransform = (LocalPipelineTransform) registry.getLocalTransform(
      "text/csv",
      -1,
      "image/png",
      Collections.emptyMap(),
