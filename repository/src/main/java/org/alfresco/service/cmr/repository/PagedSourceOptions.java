...
public class PagedSourceOptions extends AbstractTransformationSourceOptions {
  ...
  public TransformationSourceOptions mergedOptions(
    ...
    if (overridingOptions instanceof PagedSourceOptions) {
      PagedSourceOptions mergedOptions = (PagedSourceOptions) super.mergedOptions(
        overridingOptions
      );

      if (
        ((PagedSourceOptions) overridingOptions).getStartPageNumber() != null
      ) {
  ...
  public class PagedSourceOptionsSerializer
    ...
    public TransformationSourceOptions deserialize(
      ...
      int startPageNumber = serializedOptions.getIntegerParam(
        PARAM_SOURCE_START_PAGE,
        1
      );
      int endPageNumber = serializedOptions.getIntegerParam(
        PARAM_SOURCE_END_PAGE,
        1
      );
  ...
  public String toString() {
    return (
      "PagedSourceOptions {" + startPageNumber + ", " + endPageNumber + "}"
    );
  }
}
