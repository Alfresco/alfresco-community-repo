...
public class VirtualRatingServiceExtensionTest extends VirtualizationIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        ratingService = ctx.getBean("ratingService", RatingService.class);
    ...
    private void applyRatingAs(
        ...
        try {
            ...
            RunAsWork<Void> applyRatingsAsWork =
                    new RunAsWork<Void>() {

                        @Override
                        public Void doWork() throws Exception {
                            ratingService.applyRating(targetNode, rating, ratingSchemeName);
                            return null;
                        }
                    };
            AuthenticationUtil.runAs(applyRatingsAsWork, asUser);
        } finally {
    ...
    public void testApplyRatings() throws Exception {
        ...
        assertEquals(
                1f, ratingService.getAverageRating(virtualContent, LIKES_RATING_SCHEME), delta);
        ...
        assertEquals(
                2f, ratingService.getAverageRating(virtualContent, FIVE_STAR_RATING_SCHEME), delta);
        assertEquals(
                2f, ratingService.getAverageRating(actualNodeRef, FIVE_STAR_RATING_SCHEME), delta);
    }
}
