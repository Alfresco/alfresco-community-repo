 ...
 *
 * <p>Note: Dates depend on ISO8601DateFormat.parse which currently expects
    ...
    public void testUtil() {
        ...
        String test4_in =
                "{    \"glossary\": {        \"title\": \"example glossary\",        \"GlossDiv\":"
                    + " {            \"title\": \"S\",            \"GlossList\": {               "
                    + " \"GlossEntry\": {                   \"ID\": \"SGML\",                  "
                    + " \"SortAs\": \"SGML\",                   \"GlossTerm\": \"Standard"
                    + " Generalized Markup Language\",                    \"Acronym\": \"SGML\",   "
        ...
        String test4_expected_out =
                "glossary:class java.util.HashMap\n"
                    ...
                    + " as DocBook.:class java.lang.String\n"
                    + "\t\t\t\tGlossSee:markup:class java.lang.String\n"
                    + "\t\t\t\tGlossTerm:Standard Generalized Markup Language:class"
                    + " java.lang.String\n"
        ...
        try {
            ...
            cfg.setDirectoryForTemplateLoading(
                    new File(userDir + "/source/test-resources/JSONtoFmModel"));
