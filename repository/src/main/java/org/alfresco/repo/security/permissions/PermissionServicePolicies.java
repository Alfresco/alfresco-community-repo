...
public interface PermissionServicePolicies {
    ...
    /**
     * Policy invoked when permission inheritance is disabled for a specific node (sync or async
     * mode)
     */
    public interface OnInheritPermissionsDisabled extends ClassPolicy {
         ...
         * @param async whether the operation has been done in asynchronous mode, thus it may not be
         *     finished yet
         */
