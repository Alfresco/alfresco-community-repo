...
public class RuleServiceCoverageTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        RetryingTransactionCallback<Object> setUserCallback =
    ...
    private void createTestCategories() {
        ...
        model.createImport(
                NamespaceService.CONTENT_MODEL_1_0_URI, NamespaceService.CONTENT_MODEL_PREFIX);

        // Create the region category
        regionCategorisationQName = QName.createQName(TEST_NAMESPACE, "region");
        M2Aspect generalCategorisation =
                model.createAspect("test:" + regionCategorisationQName.getLocalName());
                                ...
                                new RetryingTransactionCallback<NodeRef>() {
                                    public NodeRef execute() {
                                        ...
                                        Map<String, Serializable> params =
                                                new HashMap<String, Serializable>(1);
                                        ...
                                        RuleServiceCoverageTest.this.ruleService.saveRule(
                                                RuleServiceCoverageTest.this.nodeRef, rule);

                                        NodeRef newNodeRef =
                                                RuleServiceCoverageTest.this
                                                        .nodeService
                                                        .createNode(
                                                                RuleServiceCoverageTest.this
                                                                        .nodeRef,
                    ...
                    public String executeTest() {
                        boolean result =
                                RuleServiceCoverageTest.this.nodeService.hasAspect(
                                        newNodeRef, ContentModel.ASPECT_VERSIONABLE);
    ...
    /**
     * Test: rule type: inbound condition: no-condition() action: add-features( aspect-name =
     * versionable)
     */
    public void testAddFeaturesAction() {
        ...
        assertTrue(
                this.nodeService.hasAspect(newNodeRef2, ApplicationModel.ASPECT_SIMPLE_WORKFLOW));
        assertEquals(
                "approveStep",
                this.nodeService.getProperty(newNodeRef2, ApplicationModel.PROP_APPROVE_STEP));
        assertEquals(
                false,
                this.nodeService.getProperty(newNodeRef2, ApplicationModel.PROP_APPROVE_MOVE));

        // System.out.println(NodeStoreInspector.dumpNodeStore(this.nodeService,
        // this.testStoreRef));
    }
    ...
    public void testCheckThatModifyNameDoesNotTriggerOutboundRule() throws Exception {
        ...
        contentProps.put(ContentModel.PROP_NAME, "myTestDocument.txt");
        NodeRef newNodeRef =
                fileFolderService.create(folder, "abc.txt", ContentModel.TYPE_CONTENT).getNodeRef();
        assertFalse(
    ...
    public void testCheckThatChildRuleFiresOnMove() throws Exception {
        ...
        NodeRef testFile =
                this.fileFolderService
                        .create(folderForMove, "testFile.txt", ContentModel.TYPE_CONTENT)
                        .getNodeRef();
     ...
     *
     * <ul>
     *   <li>When items are deleted, copy to another folder.
     *   <li>In addition, when items are updated, add an aspect (or any other rule).
     * </ul>
     *
    ...
    public void testUpdateAndMoveRuleOnSameFolder() throws Exception {
        ...
        assertEquals(
                "Node should have been copied to target folder", 1, targetFolderFileList.size());
        assertFalse(
                "The node copy should not be lockable",
                nodeService.hasAspect(
                        targetFolderFileList.get(0).getNodeRef(), ContentModel.ASPECT_LOCKABLE));
    }
    ...
    public void testSimpleWorkflowAction() {
        ...
        assertEquals(
                "approveStep",
                this.nodeService.getProperty(newNodeRef, ApplicationModel.PROP_APPROVE_STEP));
        assertEquals(
                this.rootNodeRef,
                this.nodeService.getProperty(newNodeRef, ApplicationModel.PROP_APPROVE_FOLDER));
        assertTrue(
                ((Boolean)
                                this.nodeService.getProperty(
                                        newNodeRef, ApplicationModel.PROP_APPROVE_MOVE))
                        .booleanValue());
        assertTrue(this.nodeService.hasAspect(newNodeRef, ApplicationModel.ASPECT_SIMPLE_WORKFLOW));
        assertEquals(
                "rejectStep",
                this.nodeService.getProperty(newNodeRef, ApplicationModel.PROP_REJECT_STEP));
        assertEquals(
                this.rootNodeRef,
                this.nodeService.getProperty(newNodeRef, ApplicationModel.PROP_REJECT_FOLDER));
        assertFalse(
                ((Boolean)
                                this.nodeService.getProperty(
                                        newNodeRef, ApplicationModel.PROP_REJECT_MOVE))
                        .booleanValue());
    ...
    public void testInCategoryCondition() {
        ...
        try {
            ...
            RetryingTransactionCallback<NodeRef> callback1 =
                    new RetryingTransactionCallback<NodeRef>() {
                            ...
                            NodeRef newNodeRef =
                                    nodeService
                                            .createNode(
                                                    ...
                                                    ContentModel.ASSOC_CHILDREN,
                                                    QName.createQName(
                                                            TEST_NAMESPACE, "hasAspectAndValue"),
                                                    ContentModel.TYPE_CONTENT,
                                                    getContentProperties())
                                            .getChildRef();
                            addContentToNode(newNodeRef);
            ...
            NodeRef newNodeRef =
                    transactionService.getRetryingTransactionHelper().doInTransaction(callback1);
            assertTrue(this.nodeService.hasAspect(newNodeRef, ContentModel.ASPECT_VERSIONABLE));

            // Check rule does not get fired when the node has the incorrect category value
            RetryingTransactionCallback<NodeRef> callback3 =
                    new RetryingTransactionCallback<NodeRef>() {
                        public NodeRef execute() throws Throwable {
                            NodeRef newNodeRef3 =
                                    nodeService
                            ...
                            nodeService.addAspect(
                                    newNodeRef3, regionCategorisationQName, catProps3);
                            return newNodeRef3;
                        }
                    };
            NodeRef newNodeRef3 =
                    transactionService.getRetryingTransactionHelper().doInTransaction(callback3);
    ...
    public void testLinkCategoryAction() {
        ...
        Map<String, Serializable> params = new HashMap<String, Serializable>(1);
        params.put(
                LinkCategoryActionExecuter.PARAM_CATEGORY_ASPECT, this.regionCategorisationQName);
        ...
        Collection<NodeRef> setValue =
                (Collection<NodeRef>) this.nodeService.getProperty(newNodeRef2, CAT_PROP_QNAME);
    ...
    public void testMailAction() throws MessagingException, IOException {
        ...
        MailActionExecuter mailService =
                (MailActionExecuter)
    ...
    public void testTransformAction() throws Throwable {
        ...
        ContentWriter contentWriter =
                this.contentService.getWriter(newNodeRef, ContentModel.PROP_CONTENT, true);
        ...
        ContentData contentData =
                (ContentData) nodeService.getProperty(copyNodeRef, ContentModel.PROP_CONTENT);
    ...
    public void testImageTransformAction() throws Throwable {
        ...
        params.put(
                ImageTransformActionExecuter.PARAM_ASSOC_TYPE_QNAME, ContentModel.ASSOC_CHILDREN);
    ...
    public void testCheckOutAction() {
        ...
        for (ChildAssociationRef child : children) {
            ...
            } else if (this.nodeService.hasAspect(childNodeRef, ContentModel.ASPECT_WORKING_COPY)
                    == true) {
                                    ...
                                    public List<NodeRef> execute() {
                                        ...
                                        NodeRef newNodeRef =
                                                RuleServiceCoverageTest.this
                                                        ...
                                                        .getChildRef();
                                        NodeRef workingCopy =
                                                RuleServiceCoverageTest.this.cociService.checkout(
                                                        newNodeRef);
    ...
    public void testRulesDisabled() {
        ...
        RetryingTransactionCallback<NodeRef> noRulesWork =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
                    public NodeRef execute() throws Throwable {
        ...
        NodeRef newNodeRef =
                transactionService.getRetryingTransactionHelper().doInTransaction(noRulesWork);
        assertFalse(nodeService.hasAspect(newNodeRef, ContentModel.ASPECT_VERSIONABLE));

        RetryingTransactionCallback<NodeRef> withRulesWork =
                new RetryingTransactionCallback<NodeRef>() {
                    @Override
                    public NodeRef execute() throws Throwable {
                        NodeRef newNodeRef2 =
        ...
        NodeRef newNodeRef2 =
                transactionService.getRetryingTransactionHelper().doInTransaction(withRulesWork);
     ...
     *
     * <p>Used to trigger rules of type of incomming.
     *
    ...
    public void testCheckMandatoryProperties() {
        ...
        try {
            ...
            addContentToNode(newNodeRef2);
            fail(
                    "An exception should have been thrown since a mandatory parameter was missing"
                            + " from the condition.");
    ...
    /**
     * Test: rule type: inbound condition: match-text( text = .doc, operation = CONTAINS) action:
     * add-features( aspect-name = versionable)
     */
    public void testContainsTextCondition() {
        ...
        ActionCondition condition1 =
                this.actionService.createActionCondition(
                        ComparePropertyValueEvaluator.NAME, condParamsBegins);
        ...
        ActionCondition condition2 =
                this.actionService.createActionCondition(
                        ComparePropertyValueEvaluator.NAME, condParamsEnds);
    ...
    public void testInboundRuleType() {
        ...
        // ALF-14744 / MNT-187: Create a content node - this time with 'empty content' in the same
        // transaction
        contentNodeRef =
                this.transactionService
                        .getRetryingTransactionHelper()
                                    ...
                                    public NodeRef execute() throws Throwable {
                                        NodeRef contentNodeRef =
                                                RuleServiceCoverageTest.this
                                                        ...
                                                        .getChildRef();
                                        ContentWriter contentWriter =
                                                RuleServiceCoverageTest.this.contentService
                                                        .getWriter(
                                                                contentNodeRef,
        ...
        // ALF-14744 / MNT-187: Create a content node - this time with the 'no content' aspect in
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                assertFalse(
                                        RuleServiceCoverageTest.this.nodeService.hasAspect(
                                                nodeRef3, ContentModel.ASPECT_VERSIONABLE));
                                RuleServiceCoverageTest.this.nodeService.setProperty(
                                        nodeRef3, ContentModel.PROP_NAME, "testName2");
                                assertFalse(
                                        RuleServiceCoverageTest.this.nodeService.hasAspect(
                                                nodeRef3, ContentModel.ASPECT_VERSIONABLE));
    ...
    public void testAssociationUpdateRule() {
        ...
        this.nodeService.createAssociation(
                testNodeOneRef, testNodeTwoRef, ContentModel.ASSOC_REFERENCES);
    ...
    /**
     * Test: rule type: outbound condition: no-condition() action: add-features( aspect-name =
     * versionable)
     */
