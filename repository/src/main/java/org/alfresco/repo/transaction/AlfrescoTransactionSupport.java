...
public abstract class AlfrescoTransactionSupport
  ...
  private static Log logger = LogFactory.getLog(
    AlfrescoTransactionSupport.class
  );
  ...
  public static void bindIntegrityChecker(IntegrityChecker integrityChecker) {
    // bind the service in
    boolean bound = bindListener(
      (TransactionListener) integrityChecker,
      COMMIT_ORDER_INTEGRITY
    );
  ...
  public static void bindListener(
    org.alfresco.repo.transaction.TransactionListener listener
  ) {
