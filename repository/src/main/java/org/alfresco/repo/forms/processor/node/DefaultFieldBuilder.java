...
/**
 * Helper class for building the default fields for a form where an explicit set of fields was not
 * provided.
 *
 * @since 3.4
 * @author Nick Smith
...
public class DefaultFieldBuilder {
    ...
    public Field buildTransientField(String name) {
        ...
        if (logger.isWarnEnabled())
            logger.warn(
                    "Could not build Transient Field: " + name + " as no FieldProcessor specified");
