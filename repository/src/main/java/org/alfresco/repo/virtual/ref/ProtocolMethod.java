...
public interface ProtocolMethod<R> {
  R execute(VanillaProtocol vanillaProtocol, Reference reference)
    throws ProtocolMethodException;

  R execute(VirtualProtocol virtualProtocol, Reference reference)
    throws ProtocolMethodException;

  R execute(NodeProtocol protocol, Reference reference)
    throws ProtocolMethodException;

  R execute(Protocol protocol, Reference reference)
    throws ProtocolMethodException;
}
