...
/**
 * This class extends {@link AuthorityDAOImpl}</br> and overrides two methods from the original
 * class</br> </br> addAuthorityNameIfMatches(Set<String> authorities, String authorityName,
 * AuthorityType type)</br> </br> and</br> </br> addAuthorityNameIfMatches(Set<String> authorities,
 * String authorityName, AuthorityType type, Pattern pattern)</br>
 */
