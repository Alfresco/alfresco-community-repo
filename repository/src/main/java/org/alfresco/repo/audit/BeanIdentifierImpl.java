 ...
 *
 * <p>Originally used to look up public services annotated with {@code @PublicService}, but has now
 * been relaxed to be any bean that uses a proxy. For the method to be audited it still needs to be
 * annotated with {@code @Auditable}.
 *
