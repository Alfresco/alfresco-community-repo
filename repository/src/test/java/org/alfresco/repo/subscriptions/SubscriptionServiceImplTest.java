...
public class SubscriptionServiceImplTest extends TestCase {
    ...
    public static final QName ASPECT_ARCHIVE =
            QName.createQName(
                    "http://www.alfresco.org/model/testsubscriptionsmodel/1.0", "archive");
    ...
    public void testFollow() throws Exception {
        ...
        PagingFollowingResults followers =
                subscriptionService.getFollowers(userId2, new PagingRequest(100000, null));
                    ...
                    public Object doWork() throws Exception {
                        assertNotNull(
                                subscriptionService.getFollowing(
                                        userId1, new PagingRequest(100000, null)));
                        return null;
                    }
                },
                userId1);
    ...
    public void testSubscriptionsRemovalOnArchivingNodesForAlf12358() throws Exception {
        ...
        int initialCount =
                subscriptionService.getSubscriptionCount(USER_TOM, SubscriptionItemTypeEnum.USER);
        ...
        try {
            ...
            assertEquals(
                    "Initial subscriptions count MUST BE lesser by 1 after adding new"
                            + " subscription!",
                    1,
                    (subscriptionService.getSubscriptionCount(
                                    USER_TOM, SubscriptionItemTypeEnum.USER)
                            - initialCount));

            nodeService.deleteNode(followed.getChildRef());
            assertEquals(
                    "Archiving of node MUST cause removal all the subscriptions created against"
                            + " it!",
                    initialCount,
                    subscriptionService.getSubscriptionCount(
                            USER_TOM, SubscriptionItemTypeEnum.USER));
