...
public class QNameDAOTest extends TestCase {
  ...
  public void testCreateNamespace() throws Exception {
    ...
    Pair<Long, String> namespacePairCheck = getNamespace(
      namespacePair.getSecond(),
      false,
      true
    );
    assertEquals(
      "Namespace ID changed",
      namespacePair.getFirst(),
      namespacePairCheck.getFirst()
    );
  ...
  public void testCreateQName() throws Exception {
    ...
    // Check that it can be retrieved
    Pair<Long, QName> qnamePairCheck = getQName(
      qnamePair.getSecond(),
      false,
      true
    );
