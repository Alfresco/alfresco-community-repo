...
/**
 * Class used purely to represent the result of an action being executed via the {@link
 * ActionFormProcessor}.
 *
 * <p>This class holds the {@link Action} executed and any optional results stored by the action.
 *
