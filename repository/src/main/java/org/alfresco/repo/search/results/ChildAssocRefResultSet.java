...
public class ChildAssocRefResultSet extends AbstractResultSet {
     ...
     */
    public ChildAssocRefResultSet(
            NodeService nodeService, List<NodeRef> nodeRefs, boolean resolveAllParents) {
        super();
        this.nodeService = nodeService;
    ...
    public ResultSetMetaData getResultSetMetaData() {
        return new SimpleResultSetMetaData(
                LimitBy.UNLIMITED, PermissionEvaluationMode.EAGER, new SearchParameters());
    }
