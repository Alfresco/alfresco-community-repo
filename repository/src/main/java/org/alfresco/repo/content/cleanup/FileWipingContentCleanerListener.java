 ...
 *
 * <p>Wire this into the {@link EagerContentStoreCleaner} as a listener and it will ensure that
 * files have their contents overwritten with zeros before deletion. Note that this process does not
 * affect the content lifecycyle in any way i.e. content will still follow the same orphan path as
 * before.
 *
 * <p>Clearly wiring this up with a {@link DeletedContentBackupCleanerListener} is pointless as you
 * will be making a copy of the before wiping it or end up copying a file full of zero depending on
...
public class FileWipingContentCleanerListener implements ContentStoreCleanerListener {
    ...
    public void beforeDelete(ContentStore sourceStore, String contentUrl)
    ...
    /**
     * Override to perform shredding on disparate forms of readers. This implementation will, by
     * default, identify more specific readers and make calls for those.
     *
    ...
    /**
     * Called by {@link #shred(ContentReader)} when the reader points to a physical file. The
     * default implementation simply overwrites the content with zeros.
     *
