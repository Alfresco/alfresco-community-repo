...
/**
 * This webscript patches the RM custom model as fix for MOB-1573. It is only necessary for
 * databases that had their RM amps initialised before the fix went in. There is no side-effect if
 * it is called when it is not needed or if it is called multiple times.
 *
 * <p>TODO This webscript should be removed after DOD certification.
 *
 * @author neilm
 */
@Deprecated
public class ApplyFixMob1573Get extends DeclarativeWebScript implements RecordsManagementModel {
    ...
    private M2Model readCustomContentModel() {
        ContentReader reader =
                contentService.getReader(RM_CUSTOM_MODEL_NODE_REF, ContentModel.TYPE_CONTENT);
    ...
    private void writeCustomContentModel(M2Model deserializedModel) {
        ContentWriter writer =
                contentService.getWriter(RM_CUSTOM_MODEL_NODE_REF, ContentModel.TYPE_CONTENT, true);
