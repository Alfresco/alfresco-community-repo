...
public class PersonFavouriteSitesRelation
  ...
  private static final Log logger = LogFactory.getLog(
    PersonFavouriteSitesRelation.class
  );
  ...
  public CollectionWithPagingInfo<FavouriteSite> readAll(
    String personId,
  ...
  @Override
  @WebApiDescription(
    title = "Add Person Favorite Site",
  ...
  @Override
  @WebApiDescription(
    title = "Remove Person Favorite Site",
    description = "Un-favorite a site"
  )
