...
public class ResetPasswordServiceImplTest {
  ...
  @Rule
  public final RunAsFullyAuthenticatedRule runAsRule = new RunAsFullyAuthenticatedRule(
  ...
  public static void initStaticData() throws Exception {
    resetPasswordService =
      APP_CONTEXT_INIT
        ...
        .getBean("resetPasswordService", ResetPasswordServiceImpl.class);
    ...
    globalProperties =
      APP_CONTEXT_INIT
        .getApplicationContext()
        .getBean("global-properties", Properties.class);
    workflowService =
      APP_CONTEXT_INIT
        .getApplicationContext()
  ...
  public static void cleanUp() {
    resetPasswordService.setSendEmailAsynchronously(
      Boolean.valueOf(
        globalProperties.getProperty(
          "system.reset-password.sendEmailAsynchronously"
        )
      )
    );
    resetPasswordService.setDefaultEmailSender(
      (String) globalProperties.get("system.email.sender.default")
    );
  ...
  public void testResetPassword() throws Exception {
    ...
    assertEquals(
      "A reset password email should have been sent.",
      1,
    ...
    assertEquals(
      "Should've been only one email recipient.",
      1,
    ...
    String emailSubjectKey = getDeclaredField(
      SendResetPasswordEmailDelegate.class,
      "EMAIL_SUBJECT_KEY"
    );
    ...
    String resetPasswordUrl = (String) emailUtil.getLastEmailTemplateModelValue(
      "reset_password_url"
    );
    ...
    emailSubjectKey =
      getDeclaredField(
        SendResetPasswordConfirmationEmailDelegate.class,
        "EMAIL_SUBJECT_KEY"
      );
    assertNotNull(emailSubjectKey);
    assertEquals(msg.getSubject(), I18NUtil.getMessage(emailSubjectKey));
  ...
  public void testRequestResetPasswordInvalid() throws Exception {
    // Request password reset
    TestHelper.assertThrows(
      () -> resetPasswordService.requestReset(testPerson.userName, null),
    ...
    TestHelper.assertThrows(
      () ->
        resetPasswordService.requestReset(
          testPerson.userName,
          "TestClient" + System.currentTimeMillis()
        ),
    ...
    // Request password reset
    TestHelper.assertThrows(
      () -> resetPasswordService.requestReset(null, "share"),
      IllegalArgumentException.class,
      "userId is mandatory."
    );
    assertEquals(
    ...
    TestHelper.assertThrows(
      () ->
        resetPasswordService.requestReset(
          "NoUser" + System.currentTimeMillis(),
          "share"
        ),
  ...
  public void testResetPasswordInvalid() throws Exception {
    ...
    TestHelper.assertThrows(
      () -> resetPasswordService.initiateResetPassword(null),
      IllegalArgumentException.class,
      "null parameter."
    );
    ...
    passwordDetails.setUserId(testPerson.userName).setPassword(null); // Password is not provided
    TestHelper.assertThrows(
      () -> resetPasswordService.initiateResetPassword(passwordDetails),
      IllegalArgumentException.class,
    ...
    passwordDetails.setPassword("newPassword").setWorkflowId(null); // Workflow id is not provided
    TestHelper.assertThrows(
      () -> resetPasswordService.initiateResetPassword(passwordDetails),
      IllegalArgumentException.class,
    ...
    passwordDetails.setWorkflowId(pair.getFirst()).setWorkflowKey(null); //Workflow key is not provided
    TestHelper.assertThrows(
      () -> resetPasswordService.initiateResetPassword(passwordDetails),
      IllegalArgumentException.class,
    ...
    passwordDetails
      .setWorkflowId("activiti$" + System.currentTimeMillis()) // Invalid Id
      .setWorkflowKey(pair.getSecond());
    TestHelper.assertThrows(
      () -> resetPasswordService.initiateResetPassword(passwordDetails),
  ...
  public void testResetPasswordEndTimer() throws Exception {
    String defaultTimer = globalProperties.getProperty(
      "system.reset-password.endTimer"
    );
    try {
      ...
      boolean active = TestHelper.waitBeforeRetry(
        () -> isActive(pair.getFirst()),
        false,
        10,
        1000
      );
  ...
  private static void createUser(TestPerson testPerson) {
    ...
    authenticationService.createAuthentication(
      testPerson.userName,
      testPerson.password.toCharArray()
    );
  ...
  private static String getDeclaredField(Class<?> clazz, String fieldName)
