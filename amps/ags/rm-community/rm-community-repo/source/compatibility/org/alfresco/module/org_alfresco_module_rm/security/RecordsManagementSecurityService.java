 ...
 * @deprecated As of release 2.1, replaced by {@link ModelSecurityService}, {@link
 *     FilePlanRoleService} and {@link FilePlanPermissionService}
 */
public interface RecordsManagementSecurityService {
     ...
     * @deprecated As of release 2.1, replaced by {@link
     *     FilePlanRoleService#getAllRolesContainerGroup(NodeRef)}
     */
    @Deprecated
     ...
     * @param user
     * @return
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#getRolesByUser(NodeRef,
     *     String)}
     */
    @Deprecated
     ...
     * @param role
     * @return
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#getRole(NodeRef,
     *     String)}
     */
    @Deprecated
     ...
     * @param role
     * @return
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#existsRole(NodeRef,
     *     String)}
     */
    @Deprecated
     ...
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#hasRMAdminRole(NodeRef,
     *     String)}
     */
    @Deprecated
     ...
     * @param capabilities
     * @return
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#createRole(NodeRef,
     *     String, String, Set)}
     */
    @Deprecated
    Role createRole(
            NodeRef rmRootNode, String role, String roleDisplayLabel, Set<Capability> capabilities);
     ...
     * @param capabilities
     * @return
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#updateRole(NodeRef,
     *     String, String, Set)}
     */
    @Deprecated
    Role updateRole(
     ...
     * @param rmRootNode
     * @param role
     * @deprecated As of release 2.1, replaced by {@link FilePlanRoleService#deleteRole(NodeRef,
     *     String)}
     */
    @Deprecated
     ...
     * @param role
     * @deprecated As of release 2.1, replaced by {@link
     *     FilePlanRoleService#assignRoleToAuthority(NodeRef, String, String)}
     */
    @Deprecated
    void assignRoleToAuthority(NodeRef rmRootNode, String role, String authorityName);

    /**
     * Sets a permission on a RM object. Assumes allow is true. Cascades permission down to record
     * folder. Cascades ReadRecord up to file plan.
     *
     ...
     * @param permission permission
     * @deprecated As of release 2.1, replaced by {@link
     *     FilePlanPermissionService#deletePermission(NodeRef, String, String)}
     */
    @Deprecated
