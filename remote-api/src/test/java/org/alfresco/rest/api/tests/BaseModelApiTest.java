...
public class BaseModelApiTest extends AbstractBaseApiTest {
  ...
  Aspect aspect = null, childAspect = null, smartFilterAspect =
    null, rescanAspect = null, testAspect = null, testAllAspect = null;

  PublicApiClient.ListResponse<Type> types = null;
  Type type = null, whitePaperType = null, docType = null, publishableType =
    null, apiBaseType = null, apiFileType = null, apiFileDerivedType =
    null, apiForcedType = null, apiFileDerivedNoArchiveType =
    null, apiFolderType = null, apiOverrideType = null, apiOverride2Type =
    null, apiOverride3Type = null, apiNamedPropConstraintType = null;
  ...
  public void setup() throws Exception {
    ...
    myCompanyModel.setNamespaceUri(
      "http://www.mycompany.com/model/finance/1.0"
    );
    ...
    AssociationSource testAllAspectSource = new AssociationSource(
      null,
      "test2:aspect-all",
      true,
      true,
    ...
    AssociationSource testAllAspectTarget = new AssociationSource(
      null,
      "api:referenceable",
      false,
      false,
    ...
    Association testAllAspectAssociation = new Association(
      "api:assoc-all",
      null,
      null,
      null,
    ...
    testAllAspect.setAssociations(
      Collections.singletonList(testAllAspectAssociation)
    );
    testAllAspect.setMandatoryAspects(
      Arrays.asList("test2:aspect-three", "api:aspect-one", "api:aspect-two")
    );

    AssociationSource apiBaseSource = new AssociationSource(
      null,
      "api:base",
      false,
      true,
    ...
    AssociationSource apiBaseTarget = new AssociationSource(
      null,
      "api:base",
      true,
      false,
    ...
    Association apiBaseAssociation = new Association(
      "api:assoc1",
      null,
      null,
      false,
    ...
    AssociationSource apiChildSource = new AssociationSource(
      null,
      "api:base",
      true,
      true,
    ...
    AssociationSource apiChildTarget = new AssociationSource(
      null,
      "api:referenceable",
      false,
      false,
    ...
    Association apiChildAssociation = new Association(
      "api:childassoc1",
      null,
      null,
      true,
    ...
    AssociationSource apiBaseSource2 = new AssociationSource(
      null,
      "api:base",
      true,
      true,
    ...
    AssociationSource apiBaseTarget2 = new AssociationSource(
      null,
      "api:referenceable",
      false,
      false,
    ...
    Association apiBaseAssociation2 = new Association(
      "api:assoc2",
      null,
      null,
      false,
    ...
    AssociationSource apiChildPropagateSource = new AssociationSource(
      null,
      "api:base",
      true,
      true,
    ...
    AssociationSource apiChildPropagateTarget = new AssociationSource(
      null,
      "api:referenceable",
      false,
      false,
    ...
    Association apiChildPropagateAssociation = new Association(
    ...
    apiBaseType.setMandatoryAspects(
    ...
    apiForcedType.setMandatoryAspects(
      Collections.singletonList("api:referenceable")
    );

    AssociationSource apiChildSource2 = new AssociationSource(
      null,
      "api:file",
      false,
      true,
    ...
    AssociationSource apiChildTarget2 = new AssociationSource(
      null,
      "api:referenceable",
      true,
      false,
    ...
    Association apiChildAssociation2 = new Association(
      "api:childassoc2",
      null,
      null,
      true,
    ...
    apiFileType.setMandatoryAspects(
      Collections.singletonList("api:referenceable")
    );
    ...
    apiFileDerivedType.setMandatoryAspects(
      Collections.singletonList("api:referenceable")
    );

    apiFileDerivedNoArchiveType =
      new org.alfresco.rest.api.tests.client.data.Type();
    ...
    apiFolderType.setMandatoryAspects(
      Collections.singletonList("api:referenceable")
    );
    ...
    apiNamedPropConstraintType.setTitle(
      "Type with named property-defined constraint."
    );
