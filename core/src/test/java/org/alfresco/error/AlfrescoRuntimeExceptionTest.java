...
public class AlfrescoRuntimeExceptionTest extends TestCase {
  ...
  private static final String BASE_RESOURCE_NAME =
    "org.alfresco.i18n.testMessages";
  ...
  private static final String VALUE_FR_ERROR =
  ...
  private static final String NON_I18NED_MSG =
    "This is a non i18ned error message.";
  ...
  public void testI18NBehaviour() {
    ...
    String baseResourceAsProperty =
      BASE_RESOURCE_NAME.replace('.', '/') + ".properties";
    URL baseResourceURL =
      AlfrescoRuntimeExceptionTest.class.getClassLoader()
        .getResource(baseResourceAsProperty);
    assertNotNull(baseResourceURL);

    baseResourceAsProperty =
      BASE_RESOURCE_NAME.replace('.', '/') + "_fr_FR" + ".properties";
    baseResourceURL =
      AlfrescoRuntimeExceptionTest.class.getClassLoader()
        .getResource(baseResourceAsProperty);
    assertNotNull(baseResourceURL);
    ...
    properties =
      ResourceBundle.getBundle(BASE_RESOURCE_NAME, new Locale("fr", "FR"));
    assertNotNull(properties);
    ...
    AlfrescoRuntimeException exception1 = new AlfrescoRuntimeException(
      MSG_PARAMS,
    ...
    AlfrescoRuntimeException exception2 = new AlfrescoRuntimeException(
      MSG_PARAMS,
      new Object[] { PARAM_VALUE }
    );
    assertTrue(exception2.getMessage().contains(VALUE_FR_PARAMS));
    AlfrescoRuntimeException exception4 = new AlfrescoRuntimeException(
      MSG_ERROR
    );
    assertTrue(exception4.getMessage().contains(VALUE_FR_ERROR));

    AlfrescoRuntimeException exception5 = new AlfrescoRuntimeException(
      NON_I18NED_MSG
    );
    ...
    AlfrescoRuntimeException exception6 = new AlfrescoRuntimeException(
      NON_EXISTING_MSG,
  ...
  public void testMakeRuntimeException() {
    ...
    assertTrue(
      "Expected an AlfrescoRuntimeException instance",
      ee instanceof AlfrescoRuntimeException
    );
  }
}
