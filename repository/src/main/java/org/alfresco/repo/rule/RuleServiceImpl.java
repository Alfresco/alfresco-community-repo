                ...
                NodeServicePolicies.OnAddAspectPolicy
{
    ...
    {
        return getNodesSupplyingRuleSets(nodeRef, new LinkedList<>());
    }
     ...
     * given node ref.
     */
    private List<NodeRef> getNodesSupplyingRuleSets(NodeRef nodeRef, LinkedList<NodeRef> visitedNodeRefs)
    {
