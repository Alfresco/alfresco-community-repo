...
public class FeedNotifierJobTest {
  ...
  public void setUp() throws Exception {
    ...
    EmailUserNotifier emailUserNotifier = (EmailUserNotifier) activitiesFeedCtx.getBean(
      "emailUserNotifier"
    );
    ...
    userNotifier.setExcludedEmailSuffixes(
      emailUserNotifier.getExcludedEmailSuffixes()
    );
  ...
  public void testAuthentication() throws Exception {
    ...
    assertNull(
      "The notification failed with error " + userNotifier.getError(),
      userNotifier.getError()
    );
  }
