...
public class UnfiledRecordContainerTypeUnitTest extends BaseUnitTest {
    @InjectMocks private UnfiledRecordContainerType unfiledRecordContainerType;

    /**
     * Given that we try to add a type that is not one of "rma:unfiledRecordFolder", "cm:content" or
     * "rma:nonElectronicDocument" types to unfiled record container, Then IntegrityException is
     * thrown.
     */
    ...
    /**
     * Given that we try to add "rma:unfiledRecordFolder" sub-type to unfiled record container, Then
    ...
    /**
     * Given that we try to add "cm:content" sub-type to unfiled record container, Then the
