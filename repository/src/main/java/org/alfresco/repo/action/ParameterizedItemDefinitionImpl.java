...
public abstract class ParameterizedItemDefinitionImpl
    ...
    private Map<Locale, List<ParameterDefinition>> parameterDefinitions =
    ...
    /** Error messages */
    private static final String ERR_NAME_DUPLICATION =
            "The names "
     ...
     */
    public void setLocalizedParameterDefinitions(
            Map<Locale, List<ParameterDefinition>> parameterDefinitions) {
    ...
    private void createParamDefinitionsByName() {
        ...
        for (Locale locale : this.parameterDefinitions.keySet()) {
            Map<String, ParameterDefinition> namedDefinitions =
    ...
    /**
     * @see
     *     org.alfresco.service.cmr.action.ParameterizedItemDefinition#getParameterDefintion(java.lang.String)
     */
    public ParameterDefinition getParameterDefintion(String name) {
        ...
        if (null != paramDefinitionsByName) {
            ...
            Locale match = I18NUtil.getNearestLocale(I18NUtil.getLocale(), locales);
            Map<String, ParameterDefinition> localizedDefinitionsByName =
                    paramDefinitionsByName.get(match);
            ...
            result =
                    (null == localizedDefinitionsByName)
                            ? (null)
                            : (localizedDefinitionsByName.get(name));
        }
