...
public class UnlockFileTests extends WebDavTest {
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY })
  public void siteCollaboratorCannotUnlockFileLockedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    webDavProtocol
      .authenticateUser(managerUser)
  ...
  @Test(groups = { TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.SANITY })
  public void siteContributorCannotUnlockFileLockedByManager()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    webDavProtocol
      .authenticateUser(managerUser)
  ...
  public void unauthorizedUserCannotUnlockFile() throws Exception {
    ...
    webDavProtocol
      ...
      .and()
      .assertThat()
      .hasStatus(HttpStatus.PRECONDITION_FAILED.value())
      .and()
      .assertThat()
      .isLocked();
  }
