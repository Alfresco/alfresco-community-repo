...
public class VersionHistoryImplTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    nodeRef =
      new NodeRef(new StoreRef(StoreRef.PROTOCOL_WORKSPACE, "test"), "test");
  ...
  public void testGetAllVersionsComparator() {
    ...
    Version predecessor;
    VersionHistoryImpl vh = new VersionHistoryImpl(
      version,
  ...
  public void testGetPredecessor() {
    ...
    assertEquals(
      ...
      this.rootVersion.getVersionLabel()
    );
  ...
  public void testGetVersion() {
    ...
    assertEquals(
      version2.getVersionLabel(),
      this.childVersion1.getVersionLabel()
    );

    Version version3 = vh.getVersion("3");
    assertEquals(
      version3.getVersionLabel(),
      this.childVersion2.getVersionLabel()
    );

    try {
      vh.getVersion("invalidLabel");
      fail(
        "An exception should have been thrown if the version can not be retrieved."
      );
  ...
  public static final String DESERIALIZE_V22SP4 =
    "classpath:version-history/VersionHistoryImplTest-testSerialize-V2.2.4.bin";
  public static final String DESERIALIZE_V310_DEV =
    "classpath:version-history/VersionHistoryImplTest-testSerialize-V3.1.0-dev.bin";
  public static final String DESERIALIZE_V310 =
    "classpath:version-history/VersionHistoryImplTest-testSerialize-V3.1.0.bin";
