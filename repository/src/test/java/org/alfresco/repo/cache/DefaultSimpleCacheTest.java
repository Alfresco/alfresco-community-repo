...
public class DefaultSimpleCacheTest
    ...
    public void defaultMaxItems() {
        // maxItems of 0 results in a capacity of Integer.MAX_VALUE - this is to match Hazelcast
        // cache behaviour.
    ...
    // TODO: Timer-based tests are not ideal. An alternative approach is to factor out the
    // CacheBuilder.newBuilder()
    // call to a protected method, override that in this test class to return a mock and use the
    // mock to check
    // that the Cache is being configured correctly, e.g. assert that expireAfterWrite(int,
    // TimeUnit) is called.
    @Test
