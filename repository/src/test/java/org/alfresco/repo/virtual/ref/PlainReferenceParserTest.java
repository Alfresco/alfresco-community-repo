...
public class PlainReferenceParserTest extends AbstractReferenceParserTest {
  ...
  public void testParseClasspathResource() throws Exception {
    {
      Reference pr = new PlainReferenceParser()
        .parse("virtual:classpath:/org/alfresco/");
    ...
    }
    {
      ...
      RepositoryResource rr21 = new RepositoryResource(
        new RepositoryNodeRef(
          new NodeRef("workspace://SpacesStore/0029-222-333-444")
        )
      );
      RepositoryResource rr22 = new RepositoryResource(
        new RepositoryPath("/Data Dictionary/Virtual Folders/claim.json")
      );
      List<Parameter> params2 = Arrays.<Parameter>asList(
        new ResourceParameter(rr21),
        new ResourceParameter(rr22)
      );
      Reference rp2 = new Reference(
        Encodings.PLAIN.encoding,
        Protocols.VIRTUAL.protocol,
        new ClasspathResource("/org/alfresco/"),
        params2
  ...
  public void testParseRepositoryPath() throws Exception {
    Reference reference = new PlainReferenceParser()
      .parse("virtual:repository:path:/Foo/Bar");
  ...
  public void testReferenceDelimiter() {
    Reference parsedRef = new PlainReferenceParser()
      .parse(
        "vanilla:repository:path:/Company Home/Data Dictionary/:ref:vanilla:classpath:/org/alfresco/repo/virtual/node/vanilla.js:s:/Images/ JPG images/:r:repository:node:workspace:SpacesStore:67c8f11d-0936-4295-88a0-12b85764c76f:r:repository:node:workspace:SpacesStore:6428d7cc-feaa-4e32-a983-0b357439a994:*"
      );
    List<Parameter> params = Arrays.<Parameter>asList(
    ...
    Reference parsedRef2 = new PlainReferenceParser()
      .parse(
        "virtual:classpath:/Company Home/:ref:vanilla:classpath:/org/alfresco/repo/virtual/node/vanilla.js:s:/My Documents/+=?Folder:r:repository:path:/this/ repo/ path/:r:classpath:/org/alfresco/repo/virtual/template.js:*:ref:vanilla:classpath:virtual.js:*"
      );
    List<Parameter> params2 = Arrays.<Parameter>asList(
    ...
    Reference innerRef3 = new Reference(
      Encodings.PLAIN.encoding,
      Protocols.VANILLA.protocol,
      new ClasspathResource("/org/alfresco/repo/virtual/node/vanilla.js"),
      params2
    );
    Reference innerRef4 = new Reference(
      Encodings.PLAIN.encoding,
      Protocols.VANILLA.protocol,
    ...
    List<Parameter> prms2 = Arrays.<Parameter>asList(
      new ReferenceParameter(innerRef3),
