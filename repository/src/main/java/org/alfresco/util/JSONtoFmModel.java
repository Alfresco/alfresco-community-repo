...
public final class JSONtoFmModel {
  ...
  public static Map<String, Object> convertJSONObjectToMap(JSONObject jo)
    throws JSONException {
   ...
   */
  public static List<Object> convertJSONArrayToList(JSONArray ja)
    throws JSONException {
  ...
  @SuppressWarnings("unchecked")
  private static StringBuffer toStringBuffer(
