...
public class ComparePropertyValueEvaluatorTest extends BaseSpringTest {
  ...
  private static final QName TEST_TYPE_QNAME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "testType"
  );
  private static final QName PROP_TEXT = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "propText"
  );
  private static final QName PROP_INT = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "propInt"
  );
  private static final QName PROP_DATETIME = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "propDatetime"
  );
  private static final QName PROP_NODEREF = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "propNodeRef"
  );
  private static final QName PROP_MULTI_VALUE = QName.createQName(
    TEST_TYPE_NAMESPACE,
    "propMultiValue"
  );
  ...
  public void before() throws Exception {
    ...
    this.evaluator =
      (ComparePropertyValueEvaluator) this.applicationContext.getBean(
  ...
  public void testCheckParamDefintionWithConstraint() {
    ...
    ParameterDefinition paramDef = def.getParameterDefintion(
      ComparePropertyValueEvaluator.PARAM_OPERATION
    );
    ...
    ParameterConstraint paramConstraint = actionService.getParameterConstraint(
      constraintName
    );
  ...
  public void testNumericComparison() {
    ActionConditionImpl condition = new ActionConditionImpl(
      GUID.generate(),
      ComparePropertyValueEvaluator.NAME
    );
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_PROPERTY,
      PROP_INT
    );
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_VALUE,
      INT_VALUE
    );
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_OPERATION,
      ComparePropertyValueOperation.GREATER_THAN.toString()
    );
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_OPERATION,
      ComparePropertyValueOperation.GREATER_THAN_EQUAL.toString()
    );
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_OPERATION,
      ComparePropertyValueOperation.LESS_THAN.toString()
    );
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_OPERATION,
      ComparePropertyValueOperation.LESS_THAN_EQUAL.toString()
    );
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_OPERATION,
      ComparePropertyValueOperation.CONTAINS.toString()
    );
    try {
      this.evaluator.evaluate(condition, this.nodeRef);
      fail("An exception should have been raised here.");
  ...
  public void testOtherComparison() {
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_VALUE,
      "this isn't even the correct type!"
    );
    assertFalse(this.evaluator.evaluate(condition, this.nodeRef));
  ...
  public void testContentPropertyComparisons() {
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_CONTENT_PROPERTY,
      ContentPropertyName.MIME_TYPE.toString()
    );
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_VALUE,
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_CONTENT_PROPERTY,
      ContentPropertyName.ENCODING.toString()
    );
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_VALUE,
      "UTF-8"
    ...
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_CONTENT_PROPERTY,
      ContentPropertyName.SIZE.toString()
    );
    condition.setParameterValue(
      ComparePropertyValueEvaluator.PARAM_OPERATION,
      ComparePropertyValueOperation.LESS_THAN.toString()
  ...
  private void createTestModel() {
    M2Model model = M2Model.createModel(
      "test:comparepropertyvalueevaluatortest"
    );
