...
public enum Encodings {
   ...
   */
  PLAIN(
    new Encoding('p', new PlainReferenceParser(), new PlainStringifier(), false)
  ),
   ...
   */
  ZERO(
    new Encoding('0', new ZeroReferenceParser(), new ZeroStringifier(), false)
  ),
   ...
   */
  HASH(
    new Encoding('H', new HashReferenceParser(), new HashStringifier(), true)
  );
