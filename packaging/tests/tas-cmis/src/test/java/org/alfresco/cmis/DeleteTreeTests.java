...
public class DeleteTreeTests extends CmisTest {
  ...
  public void siteManagerDeletesFolderTreeWithAllVersionsParamTrue()
    throws Exception {
    parentTestFolder = FolderModel.getRandomFolderModel();
    childTestFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
  ...
  public void deleteFolderTreeWithAllVersionsParamFalseNotSupported()
    throws Exception {
    parentTestFolder = FolderModel.getRandomFolderModel();
    childTestFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerDeletesFolderTreeWithContinueOnFailureParamFalse()
    throws Exception {
    parentTestFolder = FolderModel.getRandomFolderModel();
    childTestFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
  ...
  public void contributorCannotDeleteFolderTreeCreatedByManager()
    throws Exception {
    parentTestFolder = FolderModel.getRandomFolderModel();
    childTestFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
  ...
  @Test(groups = { "bug-atom-REPO-5390", TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCannotDeleteFolderTreeCreatedByManager()
    throws Exception {
    parentTestFolder = FolderModel.getRandomFolderModel();
    childTestFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
  ...
  @Test(groups = { "bug-atom-REPO-5390", TestGroup.REGRESSION, TestGroup.CMIS })
  public void consumerCannotDeleteFolderTreeCreatedByManager()
    throws Exception {
    parentTestFolder = FolderModel.getRandomFolderModel();
    childTestFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.MSWORD, content);
  ...
  public void nonInvitedUserCannotDeleteFolderTreeInPrivateSite()
    throws Exception {
