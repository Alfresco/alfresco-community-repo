...
public class GetContentStreamTests extends CmisTest {
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteManagerShouldGetContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorShouldGetContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorShouldGetContentOfFileCreatedBySelf()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorShouldGetContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorShouldGetContentOfFileCreatedBySelf()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void consumerShouldGetContentOfFileCreatedByOtherUser()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN, content);
    cmisApi
      .authenticateUser(siteManager)
