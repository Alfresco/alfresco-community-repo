...
public class CalendarRecurrenceHelperTest {
    ...
    public void fixOutlookRecurrenceQuirks_GenuineMonthlyRecurrenceParamsLeftAsIs() {
        ...
        Map<String, String> out =
                CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(Params.fromMap(in));
    ...
    public void fixOutlookRecurrenceQuirks_MonthlyRecurrenceThatShouldBeYearly() {
        Map<String, String> in =
                Params.fromKVPs("BYMONTHDAY=25", "FREQ=MONTHLY", "INTERVAL=24", "BYMONTH=7");
        Map<String, String> out =
                CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(Params.fromMap(in));
        ...
        assertEquals(
                Params.fromKVPs("BYMONTHDAY=25", "FREQ=YEARLY", "INTERVAL=2", "BYMONTH=7"), out);
    }

    @Test
    public void fixOutlookRecurrenceQuirks_YearlyRecurrenceParamsLeftAsIs() {
        Map<String, String> in =
                Params.fromKVPs("BYMONTHDAY=25", "FREQ=YEARLY", "INTERVAL=2", "BYMONTH=7");
        Map<String, String> out =
                CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(Params.fromMap(in));
    ...
    public void fixOutLookRecurrenceQuirks_weekdayRecurrenceRule() {
        Map<String, String> recurrenceRule =
                Params.fromKVPs("FREQ=MONTHLY", "BYDAY=MO,TU,WE,TH,FR", "INTERVAL=1", "BYSETPOS=1");
        Map<String, String> fixedRecurrenceRule =
                CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(Params.fromMap(recurrenceRule));
    ...
    public void fixOutLookRecurrenceQuirks_weekendDayRecurrenceRule() {
        Map<String, String> recurrenceRule =
                Params.fromKVPs("FREQ=MONTHLY", "BYDAY=SU,SA", "INTERVAL=1", "BYSETPOS=1");
        Map<String, String> fixedRecurrenceRule =
                CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(Params.fromMap(recurrenceRule));
    ...
    public void fixOutLookRecurrenceQuirks_dayRecurrenceRule() {
        Map<String, String> recurrenceRule =
                Params.fromKVPs(
                        "FREQ=MONTHLY", "BYDAY=SU,MO,TU,WE,TH,FR,SA", "INTERVAL=1", "BYSETPOS=1");
        Map<String, String> fixedRecurrenceRule =
                CalendarRecurrenceHelper.fixOutlookRecurrenceQuirks(Params.fromMap(recurrenceRule));
