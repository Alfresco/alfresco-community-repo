...
/**
 * Default {@link FieldProcessor} implementation, used when an explicit FieldProcessor can not be
 * located.
 *
 * @since 3.4
 * @author Nick Smith
 */
public class DefaultFieldProcessor extends QNameFieldProcessor<ClassAttributeDefinition>
     ...
     */
    @Override
    protected ClassAttributeDefinition getTypeDefinition(
            QName fullName, ContentModelItemData<?> itemData, boolean isForcedField) {
        throw new UnsupportedOperationException("This method should never be called!");
    }
