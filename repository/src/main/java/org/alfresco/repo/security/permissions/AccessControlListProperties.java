...
public interface AccessControlListProperties {
    ...
    /**
     * Is this ACL versioned - if not there will be no old versions of the ACL and the long id will
     * remain unchanged.
     *
     * <p>If an acl is versioned it can not be updated - a new copy has to be created,
     *
