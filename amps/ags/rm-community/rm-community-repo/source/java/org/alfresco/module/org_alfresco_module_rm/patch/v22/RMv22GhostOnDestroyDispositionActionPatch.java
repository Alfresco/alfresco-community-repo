...
public class RMv22GhostOnDestroyDispositionActionPatch
  ...
  private void getDispositionSchedules(
    NodeRef nodeRef,
    Set<DispositionSchedule> dispositionSchedules
  ) {
   ...
   */
  private void processDispositionSchedule(
    DispositionSchedule dispositionSchedule
  ) {
    ...
    for (DispositionActionDefinition actionDefinition : actionDefinitions) {
      String actionName = (String) nodeService.getProperty(
      ...
      if ("destroy".equals(actionName)) {
        ...
        String ghostOnDestroyValue = (String) nodeService.getProperty(
          actionDefinition.getNodeRef(),
