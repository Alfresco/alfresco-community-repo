...
public class TransformerConfigMBeanImpl implements TransformerConfigMBean {
  ...
  private static final String NO_TRANSFORMATIONS_TO_REPORT =
  ...
  public String[] getExtensionsAndMimetypes() {
    ...
    return extensionsAndMimetypes.toArray(
      new String[extensionsAndMimetypes.size()]
    );
  }

  @Override
  public String getTransformationsByExtension(
  ...
  private String nullDefaultParam(String parameter) {
    if (
      "String".equals(parameter) || "".equals(parameter) || parameter == null
    ) {
      parameter = null;
    }
    return parameter;
