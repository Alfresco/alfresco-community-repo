...
/**
 * Remove all duplicate users that have previously been split and had guids added to the uid. This
 * been should be wired up into a custom bootstrap process
 *
 * @author Andy Hind
 */
public class SplitPersonCleanupBootstrapBean extends AbstractLifecycleBean {
    ...
    protected int removePeopleWithGUIDBasedIds() {
        ...
        batchProcessor.process(
                new BatchProcessor.BatchProcessWorker<String>() {
    ...
    public static void main(String[] args) {
        ...
        String[] test =
                new String[] {
                    ...
                    "andy" + GUID.generate(),
                    "andy(" + GUID.generate() + ")",
                    GUID.generate() + "banana",
                    "andy" + GUID.generate() + "banana",
