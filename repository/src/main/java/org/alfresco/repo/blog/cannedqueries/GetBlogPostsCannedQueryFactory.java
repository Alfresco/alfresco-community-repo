...
public class GetBlogPostsCannedQueryFactory extends AbstractBlogPostsCannedQueryFactory {
    ...
    public CannedQuery<BlogEntity> getCannedQuery(CannedQueryParameters parameters) {
        final GetBlogPostsCannedQuery cq =
                new GetBlogPostsCannedQuery(cannedQueryDAO, methodSecurity, parameters);

        return (CannedQuery<BlogEntity>) cq;
    }

    public CannedQuery<BlogEntity> getGetDraftsCannedQuery(
        ...
        GetBlogPostsCannedQueryParams paramBean =
                new GetBlogPostsCannedQueryParams(
        ...
        CannedQuerySortDetails cqsd =
                createCQSortDetails(ContentModel.PROP_CREATED, SortOrder.DESCENDING);
        ...
        CannedQueryParameters params =
                new CannedQueryParameters(
                        ...
                        pagingReq.getQueryExecutionId());

        // return canned query instance
        return getCannedQuery(params);
    }

    public CannedQuery<BlogEntity> getGetPublishedCannedQuery(
        ...
        CannedQueryPageDetails cqpd = createCQPageDetails(pagingReq);
        CannedQuerySortDetails cqsd =
                createCQSortDetails(ContentModel.PROP_PUBLISHED, SortOrder.DESCENDING);
