...
public interface ModuleDependency extends Serializable
{
     ...
     * 
     * @param moduleDetails
     *            the module details of the dependency. This must be the details of the module with the correct {@link #getDependencyId() ID}. This may be <tt>null</tt> in which case <tt>false</tt> will always be returned.
