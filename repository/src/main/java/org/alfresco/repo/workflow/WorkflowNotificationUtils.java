...
public class WorkflowNotificationUtils {
    ...
    public static String WF_ASSIGNED_TEMPLATE =
            new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "wf-email-html-ftl").toString();
     ...
     */
    public void sendWorkflowAssignedNotificationEMail(
            String taskId, String taskType, String[] assignedAuthorites, boolean pooled) {
     ...
     */
    public void sendWorkflowAssignedNotificationEMail(
            String taskId, String taskType, String assignedAuthority, boolean pooled) {
        sendWorkflowAssignedNotificationEMail(
                taskId, taskType, new String[] {assignedAuthority}, pooled);
    }
}
