...
public class AvailableRenditionTests extends RenditionIntegrationTests {
  ...
  public void dataPreparation() throws Exception {
    ...
    for (String extensions : toTest) {
      ...
      renditionsForFiles.addAll(
        uploadFileAndGetAvailableRenditions(sourceFile)
      );
    }
   ...
   */
  private List<Object[]> uploadFileAndGetAvailableRenditions(String sourceFile)
    throws Exception {
    ...
    RestRenditionInfoModelCollection renditionsInfo = restClient
      .withCoreAPI()
      .usingNode(file)
  ...
  public void unsupportedRenditionTest(String sourceFile, String renditionId)
    throws Exception {
    RestNodeModel fileNode = uploadFile(sourceFile);
  ...
  protected Iterator<Object[]> unsupportedRenditionTestDataProvider()
    throws Exception {
