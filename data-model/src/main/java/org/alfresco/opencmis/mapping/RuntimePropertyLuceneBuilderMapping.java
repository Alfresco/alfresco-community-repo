...
public class RuntimePropertyLuceneBuilderMapping
  ...
  public void afterPropertiesSet() {
    registerPropertyLuceneBuilder(
      ...
      new ObjectIdLuceneBuilder(dictionaryService)
    );
    registerPropertyLuceneBuilder(
      PropertyIds.OBJECT_TYPE_ID,
      new ObjectTypeIdLuceneBuilder(cmisDictionaryService)
    );
    registerPropertyLuceneBuilder(
      PropertyIds.BASE_TYPE_ID,
      new BaseTypeIdLuceneBuilder(cmisDictionaryService)
    );
    registerPropertyLuceneBuilder(
    ...
    registerPropertyLuceneBuilder(
      ...
      new FixedValueLuceneBuilder(null)
    );
    registerPropertyLuceneBuilder(
      PropertyIds.NAME,
    ...
    registerPropertyLuceneBuilder(
      ...
      new ParentLuceneBuilder(dictionaryService)
    );
    registerPropertyLuceneBuilder(
      PropertyIds.PATH,
      new NotSupportedLuceneBuilder()
  ...
  @Override
  public CMISPropertyLuceneBuilder createDirectPropertyLuceneBuilder(
    QName propertyName
  ) {
