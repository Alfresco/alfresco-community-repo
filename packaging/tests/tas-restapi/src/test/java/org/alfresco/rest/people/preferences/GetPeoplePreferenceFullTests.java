...
public class GetPeoplePreferenceFullTests extends RestTest {
        ...
        restPreferenceModel
                ...
                .is(
                        Utility.removeLastSlash(
                                Utility.buildPath(
                                        "workspace://SpacesStore", folderFavorite.getNodeRef())));
    }
    ...
    public void validateIdElementInGetFilePreferenceResponse() throws Exception {
        ...
        fileFavorite =
                dataContent.usingUser(userModel).usingSite(siteModel).createContent(fileFavorite);
        dataContent
                .getContentActions()
                .setFileAsFavorite(
                        userModel.getUsername(),
    ...
    public void changePreferenceThenPerformGetPreferenceCall() throws Exception {
        ...
        dataContent
                ...
                .setFileAsFavorite(
                        ...
                        String.format(
                                "%s.%s",
                                fileFavorite.getName(), fileFavorite.getFileType().extension));
