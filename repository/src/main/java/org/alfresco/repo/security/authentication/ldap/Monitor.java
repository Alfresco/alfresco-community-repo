...
public class Monitor {
  ...
  public void setLDAPAuthenticationComponent(
    LDAPAuthenticationComponentImpl component
  ) {
    this.component = component;
  }

  public void setChainingUserRegistrySynchronizerStatus(
    ChainingUserRegistrySynchronizerStatus syncStatus
  ) {
  ...
  public CompositeData testAuthenticate(String userName, String credentials) {
    ...
    try {
      String[] key = { "id" };
      CompositeType sType = new CompositeType(
        "Authentication Step",
        "Step",
        stepKeys,
        stepDescriptions,
      ...
      TabularType tType = new TabularType(
        "Diagnostic",
