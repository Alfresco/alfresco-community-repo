...
public class NodeRating implements Serializable, Comparable<NodeRating>, ExpectedComparison {
    ...
    public String toString() {
        return "NodeRating [ratingScheme=" + ratingScheme + ", ratedAt=" + ratedAt + "]";
    }
    ...
    public static class Aggregate implements ExpectedComparison {
        ...
        @Override
        public String toString() {
            return "Aggregate [numberOfRatings=" + numberOfRatings + ", average=" + average + "]";
        }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((ratingScheme == null) ? 0 : ratingScheme.hashCode());
        return result;
    }
