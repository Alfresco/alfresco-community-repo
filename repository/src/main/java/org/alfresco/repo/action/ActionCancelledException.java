...
/**
 * The Exception thrown when a {@link CancellableAction} detects that a cancel was requested, and
 * needs the transaction it is in to be wound back as part of the cancellation.
 */
