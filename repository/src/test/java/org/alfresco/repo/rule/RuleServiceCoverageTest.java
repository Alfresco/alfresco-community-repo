...
public class RuleServiceCoverageTest extends TestCase {
  ...
  private static final String TEST_NAMESPACE =
    "http://www.alfresco.org/test/rulesystemtest";
  private static final QName CAT_PROP_QNAME = QName.createQName(
    TEST_NAMESPACE,
    "region"
  );
  ...
  protected void setUp() throws Exception {
    ...
    this.dictionaryDAO =
      (DictionaryDAO) applicationContext.getBean("dictionaryDAO");
    ...
    transactionService
      ...
      .doInTransaction(setUserCallback);
  ...
  private Rule createRule(
    ...
    ActionCondition condition =
      this.actionService.createActionCondition(conditionName, conditionParams);
  ...
  private void createTestCategories() {
    ...
    M2Aspect generalCategorisation = model.createAspect(
      "test:" + regionCategorisationQName.getLocalName()
    );
    generalCategorisation.setParentName(
      "cm:" + ContentModel.ASPECT_CLASSIFIABLE.getLocalName()
    );
    ...
    catContainer =
      nodeService
        .createNode(
          rootNodeRef,
          ContentModel.ASSOC_CHILDREN,
          QName.createQName(TEST_NAMESPACE, "categoryContainer"),
          ContentModel.TYPE_CONTAINER
        )
        .getChildRef();
    catRoot =
      nodeService
        .createNode(
          catContainer,
          ContentModel.ASSOC_CHILDREN,
          QName.createQName(TEST_NAMESPACE, "categoryRoot"),
    ...
    catRBase =
      nodeService
        .createNode(
          ...
          QName.createQName(TEST_NAMESPACE, "region"),
    ...
    catROne =
      nodeService
        .createNode(
          ...
          QName.createQName(TEST_NAMESPACE, "Europe"),
          ContentModel.TYPE_CATEGORY
        )
        .getChildRef();
    catRTwo =
      nodeService
        .createNode(
          catRBase,
          ContentModel.ASSOC_SUBCATEGORIES,
          QName.createQName(TEST_NAMESPACE, "RestOfWorld"),
          ContentModel.TYPE_CATEGORY
        )
        .getChildRef();
    catRThree =
      nodeService
        .createNode(
          catRTwo,
          ContentModel.ASSOC_SUBCATEGORIES,
          QName.createQName(TEST_NAMESPACE, "US"),
          ContentModel.TYPE_CATEGORY
        )
        .getChildRef();
  }
      ...
      .doInTransaction(
        new RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() {
            ...
            RuleServiceCoverageTest.this.ruleService.saveRule(
                RuleServiceCoverageTest.this.nodeRef,
                rule
              );

            NodeRef newNodeRef =
              RuleServiceCoverageTest.this.nodeService.createNode(
                  RuleServiceCoverageTest.this.nodeRef,
                  ContentModel.ASSOC_CHILDREN,
    ...
    ActionServiceImplTest.postAsyncActionTest(
      ...
      new AsyncTest() {
        public String executeTest() {
          boolean result =
            RuleServiceCoverageTest.this.nodeService.hasAspect(
                newNodeRef,
  ...
  public void testAddFeaturesAction() {
    ...
    addContentToNode(newNodeRef);
    assertTrue(
      this.nodeService.hasAspect(newNodeRef, ContentModel.ASPECT_VERSIONABLE)
    );
    ...
    Action action2 =
      this.actionService.createAction(AddFeaturesActionExecuter.NAME, params2);
    ...
    assertEquals(
      ...
      this.nodeService.getProperty(
          newNodeRef2,
          ApplicationModel.PROP_APPROVE_STEP
        )
    );
    assertEquals(
      false,
      this.nodeService.getProperty(
          newNodeRef2,
          ApplicationModel.PROP_APPROVE_MOVE
        )
    );
  ...
  public void testCheckThatModifyNameDoesNotTriggerOutboundRule()
    ...
    Map<QName, Serializable> contentProps = new HashMap<QName, Serializable>(1);
    contentProps.put(ContentModel.PROP_NAME, "myTestDocument.txt");
    NodeRef newNodeRef = fileFolderService
      .create(folder, "abc.txt", ContentModel.TYPE_CONTENT)
      .getNodeRef();
    assertFalse(
      "Should not be versionable",
      nodeService.hasAspect(newNodeRef, ContentModel.ASPECT_VERSIONABLE)
    );
  ...
  public void testCheckThatChildRuleFiresOnMove() throws Exception {
    ...
    assertTrue(
      ...
      nodeService.hasAspect(testFile, ContentModel.ASPECT_VERSIONABLE)
    );
  }
  ...
  public void testUpdateAndMoveRuleOnSameFolder() throws Exception {
    ...
    NodeRef testNodeOneRef = fileFolderService
      .create(sourceFolder, "one.txt", ContentModel.TYPE_CONTENT)
      .getNodeRef();
    assertFalse(
    ...
    NodeRef testNodeTwoRef = fileFolderService
      .create(sourceFolder, "two.txt", ContentModel.TYPE_CONTENT)
      .getNodeRef();
    assertFalse(
      "Node should not have lockable aspect",
    ...
    assertFalse(
      ...
      fileFolderService.exists(testNodeTwoRef)
    );
    assertEquals(
    ...
    List<FileInfo> targetFolderFileList = fileFolderService.listFiles(
      targetFolder
    );
    assertEquals(
    ...
    assertFalse(
      ...
      nodeService.hasAspect(
        targetFolderFileList.get(0).getNodeRef(),
        ContentModel.ASPECT_LOCKABLE
      )
    );
  }
  ...
  public void testDisableIndividualRules() {
    ...
    assertFalse(
      this.nodeService.hasAspect(
          newNodeRef,
          ApplicationModel.ASPECT_CONFIGURABLE
        )
    );
  ...
  public void testDisableRule() {
    ...
    addContentToNode(newNodeRef2);
    assertTrue(
      this.nodeService.hasAspect(newNodeRef2, ContentModel.ASPECT_VERSIONABLE)
    );
  }
  ...
  public void testAddFeaturesToAFolder() {
    ...
    assertTrue(
      this.nodeService.hasAspect(newNodeRef, ContentModel.ASPECT_TEMPLATABLE)
    );
    // System.out.println(NodeStoreInspector.dumpNodeStore(this.nodeService, this.testStoreRef));
  }
  ...
  public void testCopyFolderToTriggerRules() {
    ...
    params.put(
      AddFeaturesActionExecuter.PARAM_ASPECT_NAME,
      ContentModel.ASPECT_TEMPLATABLE
    );
    ...
    NodeRef copiedFolder =
      this.copyService.copy(
          folderToCopy,
          copyToFolder,
          ContentModel.ASSOC_CONTAINS,
          QName.createQName("{test}coppiedFolder"),
          true
        );
    ...
    assertTrue(
      this.nodeService.hasAspect(copiedFolder, ContentModel.ASPECT_TEMPLATABLE)
    );
    for (ChildAssociationRef childAssoc : this.nodeService.getChildAssocs(
        copiedFolder
      )) {
      assertTrue(
        this.nodeService.hasAspect(
  ...
  public void testSimpleWorkflowAction() {
    ...
    assertEquals(
      ...
      this.nodeService.getProperty(
          newNodeRef,
          ApplicationModel.PROP_APPROVE_FOLDER
        )
    );
    assertTrue(
      (
        (Boolean) this.nodeService.getProperty(
            newNodeRef,
            ApplicationModel.PROP_APPROVE_MOVE
          )
      ).booleanValue()
    ...
    assertEquals(
      ...
      this.nodeService.getProperty(
          newNodeRef,
          ApplicationModel.PROP_REJECT_STEP
        )
    );
    assertEquals(
      this.rootNodeRef,
      this.nodeService.getProperty(
          newNodeRef,
          ApplicationModel.PROP_REJECT_FOLDER
        )
    );
    assertFalse(
      (
        (Boolean) this.nodeService.getProperty(
            newNodeRef,
            ApplicationModel.PROP_REJECT_MOVE
          )
      ).booleanValue()
    );
    // System.out.println(NodeStoreInspector.dumpNodeStore(this.nodeService, this.testStoreRef));
  ...
  public void testInCategoryCondition() {
    ...
    try {
      Map<String, Serializable> params = new HashMap<String, Serializable>(1);
      params.put(
        InCategoryEvaluator.PARAM_CATEGORY_ASPECT,
        this.regionCategorisationQName
      );
      ...
      RetryingTransactionCallback<NodeRef> callback1 = new RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
          ...
          nodeService.addAspect(
            newNodeRef,
            regionCategorisationQName,
            catProps
          );
          return newNodeRef;
        }
      };
      NodeRef newNodeRef = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(callback1);
      assertTrue(
        this.nodeService.hasAspect(newNodeRef, ContentModel.ASPECT_VERSIONABLE)
      );
      ...
      RetryingTransactionCallback<NodeRef> callback3 = new RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
          NodeRef newNodeRef3 = nodeService
            .createNode(
              nodeRef,
              ContentModel.ASSOC_CHILDREN,
              QName.createQName(TEST_NAMESPACE, "hasAspectAndValue"),
      ...
      NodeRef newNodeRef3 = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(callback3);
      assertFalse(
        this.nodeService.hasAspect(newNodeRef3, ContentModel.ASPECT_VERSIONABLE)
      );
      //System.out.println(NodeStoreInspector.dumpNodeStore(this.nodeService, this.testStoreRef));
  ...
  public void testLinkCategoryAction() {
    ...
    Map<String, Serializable> params = new HashMap<String, Serializable>(1);
    params.put(
      LinkCategoryActionExecuter.PARAM_CATEGORY_ASPECT,
      this.regionCategorisationQName
    );
    ...
    PropertyDefinition catPropDef =
      this.dictionaryDAO.getProperty(CAT_PROP_QNAME);
    if (catPropDef == null) {
      // Why is it undefined?
    }
    ...
    Collection<NodeRef> setValue = (Collection<NodeRef>) this.nodeService.getProperty(
        newNodeRef2,
        CAT_PROP_QNAME
      );
  ...
  public void testMailAction() throws MessagingException, IOException {
    ...
    params.put(
      ...
      "This is a test to check that the mail action is working."
    );
    ...
    MailActionExecuter mailService = (MailActionExecuter) (
      (ApplicationContextFactory) applicationContext.getBean("OutboundSMTP")
  ...
  public void testMailNotSentIfRollback() {
    ...
    params.put(
      MailActionExecuter.PARAM_TEXT,
      "This email should NOT have been sent."
    );
  ...
  public void testCopyAction() {
    ...
    List<ChildAssociationRef> origRefs =
    ...
    List<ChildAssociationRef> copyChildAssocRefs =
      this.nodeService.getChildAssocs(
          this.rootNodeRef,
          RegexQNamePattern.MATCH_ALL,
          QName.createQName(TEST_NAMESPACE, localName)
    ...
    assertTrue(
      this.nodeService.hasAspect(copyNodeRef, ContentModel.ASPECT_COPIEDFROM)
    );
  ...
  public void testTransformAction() throws Throwable {
    Map<String, Serializable> params = new HashMap<String, Serializable>(1);
    params.put(
      TransformActionExecuter.PARAM_MIME_TYPE,
      MimetypeMap.MIMETYPE_TEXT_PLAIN
    );
    params.put(
      TransformActionExecuter.PARAM_DESTINATION_FOLDER,
      this.rootNodeRef
    );
    params.put(
      TransformActionExecuter.PARAM_ASSOC_TYPE_QNAME,
      ContentModel.ASSOC_CHILDREN
    );
    params.put(
      TransformActionExecuter.PARAM_ASSOC_QNAME,
    ...
    List<ChildAssociationRef> copyChildAssocRefs =
      this.nodeService.getChildAssocs(
          this.rootNodeRef,
          RegexQNamePattern.MATCH_ALL,
          QName.createQName(TEST_NAMESPACE, "test.txt")
        );
    assertNotNull(copyChildAssocRefs);
    assertEquals(1, copyChildAssocRefs.size());
    NodeRef copyNodeRef = copyChildAssocRefs.get(0).getChildRef();
  ...
  public void testImageTransformAction() throws Throwable {
    Map<String, Serializable> params = new HashMap<String, Serializable>(1);
    params.put(
      ImageTransformActionExecuter.PARAM_DESTINATION_FOLDER,
      this.rootNodeRef
    );
    params.put(
      ImageTransformActionExecuter.PARAM_ASSOC_TYPE_QNAME,
      ContentModel.ASSOC_CHILDREN
    );
    params.put(
      TransformActionExecuter.PARAM_MIME_TYPE,
    ...
    params.put(
      ImageTransformActionExecuter.PARAM_ASSOC_QNAME,
      QName.createQName(TEST_NAMESPACE, "transformed")
    );
    ...
    List<ChildAssociationRef> copyChildAssocRefs =
      this.nodeService.getChildAssocs(
          this.rootNodeRef,
          RegexQNamePattern.MATCH_ALL,
          QName.createQName(TEST_NAMESPACE, "test.jpg")
        );
    assertNotNull(copyChildAssocRefs);
    assertEquals(1, copyChildAssocRefs.size());
    NodeRef copyNodeRef = copyChildAssocRefs.get(0).getChildRef();
  ...
  public void testCheckInAction() {
    Map<String, Serializable> params = new HashMap<String, Serializable>(1);
    params.put(
      CheckInActionExecuter.PARAM_DESCRIPTION,
    ...
    List<NodeRef> list = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
          ...
          public List<NodeRef> execute() {
            ...
            NodeRef newNodeRef =
              RuleServiceCoverageTest.this.nodeService.createNode(
                ...
                .getChildRef();
            NodeRef workingCopy =
              RuleServiceCoverageTest.this.cociService.checkout(newNodeRef);
    ...
    assertEquals(
      LockStatus.NO_LOCK,
      this.lockService.getLockStatus(list.get(0))
    );
    //System.out.println(NodeStoreInspector.dumpNodeStore(this.nodeService, this.testStoreRef));
  }
  ...
  public void testRulesDisabled() {
    ...
    RetryingTransactionCallback<NodeRef> withRulesWork = new RetryingTransactionCallback<NodeRef>() {
      @Override
      public NodeRef execute() throws Throwable {
        NodeRef newNodeRef2 = nodeService
          .createNode(
            nodeRef,
            ContentModel.ASSOC_CHILDREN,
            QName.createQName(TEST_NAMESPACE, "children"),
    ...
    NodeRef newNodeRef2 = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(withRulesWork);
    assertTrue(
      nodeService.hasAspect(newNodeRef2, ContentModel.ASPECT_VERSIONABLE)
    );
  }
  ...
  private void addContentToNode(NodeRef nodeRef) {
    ...
    contentWriter.putContent(
      STANDARD_TEXT_CONTENT + System.currentTimeMillis()
    );
  }
  ...
  public void testCheckMandatoryProperties() {
    ...
    try {
      ...
      addContentToNode(newNodeRef2);
      fail(
        "An exception should have been thrown since a mandatory parameter was missing from the condition."
      );
  ...
  public void testContainsTextCondition() {
    ...
    // Test begins with
    Map<String, Serializable> condParamsBegins = new HashMap<String, Serializable>(
      1
    );
    condParamsBegins.put(ComparePropertyValueEvaluator.PARAM_VALUE, "bob*");
    rule.getAction().removeAllActionConditions();
    ActionCondition condition1 =
      this.actionService.createActionCondition(
          ComparePropertyValueEvaluator.NAME,
          condParamsBegins
        );
    ...
    assertFalse(
      this.nodeService.hasAspect(newNodeRefx, ContentModel.ASPECT_VERSIONABLE)
    );
    ...
    assertTrue(
      this.nodeService.hasAspect(newNodeRefy, ContentModel.ASPECT_VERSIONABLE)
    );

    // Test ends with
    Map<String, Serializable> condParamsEnds = new HashMap<String, Serializable>(
      1
    );
    condParamsEnds.put(ComparePropertyValueEvaluator.PARAM_VALUE, "*s.doc");
    rule.getAction().removeAllActionConditions();
    ActionCondition condition2 =
      this.actionService.createActionCondition(
          ComparePropertyValueEvaluator.NAME,
          condParamsEnds
        );
    ...
    assertFalse(
      this.nodeService.hasAspect(newNodeRefa, ContentModel.ASPECT_VERSIONABLE)
    );
    ...
    assertTrue(
      this.nodeService.hasAspect(newNodeRefb, ContentModel.ASPECT_VERSIONABLE)
    );
  }
  ...
  public void testInboundRuleType() {
            ...
            public NodeRef execute() throws Throwable {
              NodeRef contentNodeRef =
                RuleServiceCoverageTest.this.nodeService.createNode(
                  ...
                  .getChildRef();
              ContentWriter contentWriter =
                RuleServiceCoverageTest.this.contentService.getWriter(
                    contentNodeRef,
                    ContentModel.PROP_CONTENT,
                    true
                  );
    ...
    assertFalse(
      this.nodeService.hasAspect(moveNode, ContentModel.ASPECT_VERSIONABLE)
    );
  ...
  public void testUpdateRuleType() {
    ...
    assertFalse(
      this.nodeService.hasAspect(nodeRef2, ContentModel.ASPECT_VERSIONABLE)
    );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            RuleServiceCoverageTest.this.nodeService.setProperty(
                nodeRef3,
                ContentModel.PROP_NAME,
                "testName2"
              );
  ...
  public void xtestPerformanceOfRuleExecution() {
    try {
      ...
      UserTransaction userTransaction1 =
        this.transactionService.getUserTransaction();
      ...
      for (NodeRef ref : nodeRefs) {
        assertTrue(
          this.nodeService.hasAspect(ref, ContentModel.ASPECT_VERSIONABLE)
        );
      }
