...
public abstract class BasePermissionsNode extends BaseContentNode implements TemplatePermissions {
    ...
    /**
     * @return List of permissions applied to this Node, including inherited. Strings returned are
    ...
    /**
     * @return List of permissions applied to this Node (does not include inherited). Strings
     *     returned are of the format [ALLOWED|DENIED];[USERNAME|GROUPNAME];PERMISSION for example
     *     ALLOWED;kevinr;Consumer so can be easily tokenized on the ';' character.
     */
    ...
    /**
     * @return List of permissions applied to this Node, including inherited. Strings returned are
     *     of the format [ALLOWED|DENIED];[USERNAME|GROUPNAME];PERMISSION;[INHERITED|DIRECT] for
    ...
    public boolean hasPermission(String permission) {
        return (this.services.getPermissionService().hasPermission(getNodeRef(), permission)
