...
public class DeleteFavoriteTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify Manager user deletes site from favorites with Rest API and status code"
                            + " is 204")
    ...
    public void managerIsAbleToDeleteFavorites() throws Exception {
        ...
        restClient
                ...
                .and()
                .entriesListDoesNotContain("id", siteModel.getId())
                .and()
                .entriesListDoesNotContain("description", siteModel.getDescription())
                .and()
                .entriesListDoesNotContain("visibility", siteModel.getVisibility().toString())
                .and()
                .entriesListDoesNotContain("title", siteModel.getTitle());
    }
    ...
    @TestRail(
            ...
            description =
                    "Verify Collaborator user deletes site from favorites with Rest API and status"
                            + " code is 204")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user deletes site from favorites with Rest API and status"
                            + " code is 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user delets site from favorites with Rest API and status code"
                            + " is 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user deletes site from favorites with Rest API and status code is"
                            + " 204")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin deletes files from favorites with Rest API and status code is"
                            + " (204)")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin deletes folder from favorites with Rest API and status code is"
                            + " (204)")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    public void adminIsAbleToDeleteFavoriteFolder() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingAuthUser()
                .deleteFolderFromFavorites(folderModel)
                .assertStatusCodeIs(HttpStatus.NO_CONTENT);
        restClient
                .withCoreAPI()
                .usingAuthUser()
    ...
    @TestRail(
            ...
            description =
                    "Verify user doesn't have permission to delete favorites of admin user with"
                            + " Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user doesn't have permission to delete favorites of another user"
                            + " with Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user doesn't have permission to delete favorites of another"
                            + " user with Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user doesn't have permission to delete favorites of another"
                            + " user with Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that status code is 404 if PersonID is incorrect - favorite file.")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    public void deleteFavoriteIfPersonIdNotExists() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingUser(new UserModel("inexistent", "inexistent"))
                .deleteFileFromFavorites(fileModel)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that status code is 404 if FavoriteID is incorrect - favorite file.")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    public void deleteFavoriteFileIfFavoriteIdNotExists() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingAuthUser()
                .deleteFileFromFavorites(inexistentDocument)
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, "inexistent"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that status code is 404 if FavoriteID is incorrect - favorite site.")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that status code is 404 if FavoriteID is incorrect - favorite folder.")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is not able to deletes files from favorites that were already"
                            + " deleted with Rest API and status code is (404)")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    public void adminDeletesFavoriteForNotFavouriteFile() throws Exception {
        fileModel =
                dataContent.usingSite(siteModel).createContent(CMISUtil.DocumentType.TEXT_PLAIN);
