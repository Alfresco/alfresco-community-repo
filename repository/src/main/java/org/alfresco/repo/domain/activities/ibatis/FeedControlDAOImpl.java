...
public class FeedControlDAOImpl
  ...
  public long insertFeedControl(FeedControlEntity activityFeedControl)
    throws SQLException {
    template.insert(
      "alfresco.activities.insert.insert_activity_feedcontrol",
      activityFeedControl
    );
  ...
  public int deleteFeedControl(FeedControlEntity activityFeedControl)
    ...
    return template.delete(
      "alfresco.activities.delete_activity_feedcontrol",
      activityFeedControl
    );
  }

  @SuppressWarnings("unchecked")
  public List<FeedControlEntity> selectFeedControls(String feedUserId)
    throws SQLException {
    FeedControlEntity params = new FeedControlEntity(feedUserId);

    return template.selectList(
      "alfresco.activities.select_activity_feedcontrols_for_user",
      params
    );
  }
  ...
  public long selectFeedControl(FeedControlEntity activityFeedControl)
    throws SQLException {
    Long id = template.selectOne(
      "alfresco.activities.select_activity_feedcontrol",
      activityFeedControl
    );
    return (id != null ? id : -1);
  }
