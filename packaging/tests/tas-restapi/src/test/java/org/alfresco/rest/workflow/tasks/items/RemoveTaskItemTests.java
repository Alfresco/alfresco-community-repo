...
public class RemoveTaskItemTests extends RestTest {
    ...
    public void deleteTaskItemUsingInvalidItemId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.PROCESS_ENTITY_NOT_FOUND, "incorrectItemId"));
    }
    ...
    public void deleteTaskItemFromDeletedProcess() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, task.getId()));
    }
