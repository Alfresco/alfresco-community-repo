...
public interface RuleType {
     ...
     *
     * <p>The name is unique and is used to identify the rule type.
     *
     ...
     * @param executeRuleImmediately indicates whether the rule should be executed immediately or
     *     not
     */
    public void triggerRuleType(
            NodeRef nodeRef, NodeRef actionedUponNodeRef, boolean executeRuleImmediately);
}
