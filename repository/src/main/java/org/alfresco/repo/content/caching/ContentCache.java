...
public interface ContentCache
{
    ...
    /**
     * Remove a cached item from the in-memory lookup table. Implementation should not remove the actual cached content (file) - this should be left to the clean-up process or can be deleted with {@link #deleteFile(String)}.
     * 
     * @param contentUrl
     *            String
     */
    ...
    /**
     * Deletes the cached content file for the specified URL. To remove the item from the lookup table also, use {@link #remove(String)} after calling this method.
     * 
     * @param url
     *            String
     */
