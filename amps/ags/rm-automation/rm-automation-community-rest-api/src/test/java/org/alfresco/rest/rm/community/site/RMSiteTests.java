...
public class RMSiteTests extends BaseRMRestTest {
    ...
    public void createRMSiteAsAdminUser() {
        ...
        // Create the RM site
        RMSite rmSiteResponse = rmSiteAPI.createRMSite(
    ...
    public void createRMSiteWhenSiteExists() {
        ...
        // Create the RM site
        RMSite rmSiteModel = createRMSiteModel(
            STANDARD,
            newTitle,
            newDescription
        );
    ...
    public void createRMSiteAsAnotherAdminUser() {
        ...
        getRestAPIFactory()
            ...
            .createUser(
                ...
                TestData.DEFAULT_EMAIL
            );

        // Create the RM site
        RMSite rmSiteModel = getRestAPIFactory()
    ...
    public void updateRMSiteDetails() {
        ...
        String NEW_DESCRIPTION =
            RM_DESCRIPTION + RandomData.getRandomAlphanumeric();

        // Create the site if it does not exist
        createRMSiteIfNotExists();

        // Create RM site model
        RMSite rmSiteToUpdate = RMSite
            .builder()
            .title(NEW_TITLE)
