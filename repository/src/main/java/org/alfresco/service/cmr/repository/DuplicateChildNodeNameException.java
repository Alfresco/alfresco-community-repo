...
/**
 * Thrown when a child node <b>cm:name</b> property violates the data dictionary <b>duplicate</b>
 * child association constraint.
 *
 * <p>Note that this exception may be triggered by database constraints but must still NOT trigger
 * transaction retries.
 *
 * @author Derek Hulley
 */
public class DuplicateChildNodeNameException extends RuntimeException
    ...
    public DuplicateChildNodeNameException(
            NodeRef parentNodeRef, QName assocTypeQName, String name, Throwable e) {
