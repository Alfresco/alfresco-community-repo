...
/**
 * The default behaviour that a type of aspect implements if there is no associated <{@link
 * CopyBehaviourCallback behaviour}.
 *
 * <p>This implementation is {@link #getInstance() stateless} and therefore thread-safe.
 *
 * <p>The default behaviour is:
 *
 * <ul>
 *   <li><b>Must Copy:</b> YES
 *   <li><b>Must Cascade:</b> YES, if cascade is on
 *   <li><b>Properties to Copy:</b>ALL
 * </ul>
 *
 * @author Derek Hulley
 * @since 3.2
...
public class DefaultCopyBehaviourCallback extends AbstractCopyBehaviourCallback
    ...
    public DefaultCopyBehaviourCallback() {
        defaultCopyBehaviourCallbackTrait =
                new ExtendedTrait<DefaultCopyBehaviourCallbackTrait>(createTrait());
    }
     ...
     */
    @Extend(
            traitAPI = DefaultCopyBehaviourCallbackTrait.class,
            extensionAPI = DefaultCopyBehaviourCallbackExtension.class)
     ...
     *
     * @return Returns <tt>true</tt> if the association is primary and <code>copyChildren == true
     *     </code>
     */
        ...
        return new DefaultCopyBehaviourCallbackTrait() {
            ...
            public boolean getMustCopy(final QName classQName, final CopyDetails copyDetails) {
                return AJExtender.run(
                        new AJExtender.ExtensionBypass<Boolean>() {
                            @Override
                            public Boolean run() {
