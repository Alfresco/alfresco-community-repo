 ...
 *
 * <p>{@link org.alfresco.service.cmr.ml.ContentFilterLanguagesService Content Filter Languages
 * Service}
 *
...
public class ContentFilterLanguagesMap implements ContentFilterLanguagesService {
    ...
    public List<String> getMissingLanguages(List<String> availableLanguages) {
        ...
        List<String> returnList =
                new ArrayList<String>(orderedLangCodes.size() - availableLanguages.size());
    ...
    public void init() {
        ...
        if (configStandard != null
            ...
            logger.warn(
                    "No standard configured, use by default : " + DEFAULT_LANGUAGE_LIST_STANDARD);
        }
    ...
    public String convertToOldISOCode(String code) {
        if (code.equalsIgnoreCase("he")) code = "iw";
        else if (code.equalsIgnoreCase("id")) code = "in";
        else if (code.equalsIgnoreCase("yi")) code = "ji";
    ...
    public String convertToNewISOCode(String code) {
        ...
        if (code.equalsIgnoreCase("iw")) code = "he";
        else if (code.equalsIgnoreCase("in")) code = "id";
        else if (code.equalsIgnoreCase("ji")) code = "yi";
