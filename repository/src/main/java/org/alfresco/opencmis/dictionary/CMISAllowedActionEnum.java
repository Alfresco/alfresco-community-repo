...
public enum CMISAllowedActionEnum {
    ...
    CAN_GET_DESCENDANTS(
            ...
            "canGetDescendents.Folder",
            "{http://www.alfresco.org/model/system/1.0}base.ReadChildren"),
    // CAN_GET_FOLDER_TREE("canGetFolderTree", "canGetFolderTree.Folder", BasicPermissions.READ,
    // "canGetFolderTree.Folder", "{http://www.alfresco.org/model/system/1.0}base.ReadChildren"),
    CAN_GET_CHILDREN(
            "canGetChildren",
    ...
    CAN_GET_FOLDER_PARENT(
            ...
            BasicPermissions.READ,
            "canGetParents.Folder",
            "{http://www.alfresco.org/model/system/1.0}base.ReadProperties"),
    ...
    CAN_GET_PROPERTIES(
            ...
            "{http://www.alfresco.org/model/system/1.0}base.ReadProperties"),
    CAN_GET_RENDITIONS(
            "canGetRenditions" /*, "canGetRenditions.Object", BasicPermissions.READ, "canGetRenditions.Object", "{http://www.alfresco.org/model/system/1.0}base.ReadProperties"*/),
    CAN_GET_CONTENT_STREAM(
            "canGetContentStream",
            "canViewContent.Object",
            BasicPermissions.READ,
            "canViewContent.Object",
            "{http://www.alfresco.org/model/system/1.0}base.ReadContent"),
    CAN_UPDATE_PROPERTIES(
            "canUpdateProperties",
            "canUpdateProperties.Object",
            BasicPermissions.WRITE,
            "canUpdateProperties.Object",
            "{http://www.alfresco.org/model/system/1.0}base.WriteProperties"),
    CAN_MOVE_OBJECT(
            "canMoveObject",
            "canMove.Object",
            BasicPermissions.ALL,
    ...
    CAN_SET_CONTENT_STREAM(
            ...
            BasicPermissions.WRITE,
            "canSetContent.Document",
            "{http://www.alfresco.org/model/system/1.0}base.WriteContent"),
    ...
    CAN_CHECKOUT(
            ...
            BasicPermissions.ALL,
            "canCheckout.Document",
            "{http://www.alfresco.org/model/content/1.0}lockable.CheckOut"),
    CAN_CANCEL_CHECKOUT(
            "canCancelCheckOut",
            "canCancelCheckout.Document",
            BasicPermissions.ALL,
            "canCancelCheckout.Document",
            "{http://www.alfresco.org/model/content/1.0}lockable.CancelCheckOut"),
    CAN_CHECKIN(
            "canCheckIn",
            "canCheckin.Document",
            BasicPermissions.ALL,
    ...
    CAN_GET_ALL_VERSIONS(
            ...
            BasicPermissions.READ,
            "canGetAllVersions.VersionSeries",
            "{http://www.alfresco.org/model/system/1.0}base.Read"),
    ...
    CAN_APPLY_POLICY(
            ...
            BasicPermissions.READ,
            "canAddPolicy.Object",
            "{http://www.alfresco.org/model/system/1.0}base.Write"),
    CAN_REMOVE_POLICY(
            "canRemovePolicy",
    ...
    CAN_APPLY_ACL(
            ...
            BasicPermissions.ALL,
            "canApplyACL.Object",
            "{http://www.alfresco.org/model/system/1.0}base.ChangePermissions");
