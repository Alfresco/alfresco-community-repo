...
/**
 * The interface which controls how implementations of {@link BaseCredentialsInfo} are serialized
 *
 * @author Nick Burch
 * @since Odin
 */
public interface RemoteCredentialsInfoFactory {
    /**
     * Creates a new {@link BaseCredentialsInfo} object of the appropriate type, based on the
     * details of the underlying node.
     *
     ...
     */
    public BaseCredentialsInfo createCredentials(
            QName type,
            NodeRef nodeRef,
    ...
    public static class FactoryHelper {
        ...
        public static void setCoreCredentials(
                AbstractCredentialsImpl credentials, Map<QName, Serializable> properties) {
        ...
        public static Map<QName, Serializable> getCoreCredentials(BaseCredentialsInfo credentials) {
            ...
            properties.put(
                    RemoteCredentialsModel.PROP_REMOTE_USERNAME, credentials.getRemoteUsername());
            properties.put(
                    RemoteCredentialsModel.PROP_LAST_AUTHENTICATION_SUCCEEDED,
