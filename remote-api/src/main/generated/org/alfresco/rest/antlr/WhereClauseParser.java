...
public class WhereClauseParser extends Parser {
  ...
  public String[] getTokenNames() {
    return WhereClauseParser.tokenNames;
  }
  ...
  public final WhereClauseParser.whereclause_return whereclause()
    throws RecognitionException {
    ...
    try {
      ...
      // org/alfresco/rest/antlr/WhereClause.g:128:15: ( WS )? LEFTPAREN ! ( WS )? predicate RIGHTPAREN ! ( WS )?
      {
        ...
        LEFTPAREN2 =
          (Token) match(input, LEFTPAREN, FOLLOW_LEFTPAREN_in_whereclause782);
        ...
        RIGHTPAREN5 =
          (Token) match(input, RIGHTPAREN, FOLLOW_RIGHTPAREN_in_whereclause790);
  ...
  public final WhereClauseParser.predicate_return predicate()
    throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_simplepredicate = new RewriteRuleSubtreeStream(
      adaptor,
          ...
          // org/alfresco/rest/antlr/WhereClause.g:130:13: simplepredicate ( AND simplepredicate )+
          {
            ...
            loop4:do {
              ...
              switch (alt4) {
                case 1:
                  ...
                  {
                    AND9 =
                      (Token) match(input, AND, FOLLOW_AND_in_predicate818);
                    stream_AND.add(AND9);
            ...
            // 130:52: -> ^( AND ( simplepredicate )+ )
            {
              // org/alfresco/rest/antlr/WhereClause.g:130:55: ^( AND ( simplepredicate )+ )
              {
                ...
                root_1 =
                  (Object) adaptor.becomeRoot(stream_AND.nextNode(), root_1);
          ...
          // org/alfresco/rest/antlr/WhereClause.g:131:13: simplepredicate ( OR simplepredicate )+
          {
            ...
            // 131:51: -> ^( OR ( simplepredicate )+ )
            {
              // org/alfresco/rest/antlr/WhereClause.g:131:54: ^( OR ( simplepredicate )+ )
              {
                Object root_1 = (Object) adaptor.nil();
                root_1 =
                  (Object) adaptor.becomeRoot(stream_OR.nextNode(), root_1);
  ...
  public final WhereClauseParser.simplepredicate_return simplepredicate()
    throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_NEGATION = new RewriteRuleTokenStream(
      adaptor,
      "token NEGATION"
    );
    RewriteRuleSubtreeStream stream_allowedpredicates = new RewriteRuleSubtreeStream(
      adaptor,
      "rule allowedpredicates"
    );
    try {
          ...
          // org/alfresco/rest/antlr/WhereClause.g:133:19: NEGATION allowedpredicates
          {
            NEGATION15 =
              (Token) match(
                input,
                NEGATION,
                FOLLOW_NEGATION_in_simplepredicate892
              );
  ...
  public final WhereClauseParser.allowedpredicates_return allowedpredicates()
    throws RecognitionException {
  ...
  public final WhereClauseParser.comparisonpredicate_return comparisonpredicate()
    throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_PROPERTYNAME = new RewriteRuleTokenStream(
      adaptor,
      "token PROPERTYNAME"
    );
      ...
      // org/alfresco/rest/antlr/WhereClause.g:135:22: PROPERTYNAME comparisonoperator value
      {
        PROPERTYNAME22 =
          (Token) match(
            input,
            PROPERTYNAME,
            FOLLOW_PROPERTYNAME_in_comparisonpredicate931
          );
        ...
        // 135:60: -> ^( comparisonoperator PROPERTYNAME value )
        {
          // org/alfresco/rest/antlr/WhereClause.g:135:63: ^( comparisonoperator PROPERTYNAME value )
          {
            ...
            root_1 =
              (Object) adaptor.becomeRoot(
                stream_comparisonoperator.nextNode(),
                root_1
              );

            adaptor.addChild(root_1, stream_PROPERTYNAME.nextNode());
  ...
  public final WhereClauseParser.comparisonoperator_return comparisonoperator()
    throws RecognitionException {
  ...
  public final WhereClauseParser.existspredicate_return existspredicate()
    throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_LEFTPAREN = new RewriteRuleTokenStream(
      adaptor,
      "token LEFTPAREN"
    );
    RewriteRuleTokenStream stream_PROPERTYNAME = new RewriteRuleTokenStream(
    ...
    RewriteRuleTokenStream stream_RIGHTPAREN = new RewriteRuleTokenStream(
      adaptor,
      "token RIGHTPAREN"
    );
    RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(
      adaptor,
      "token WS"
    );
    ...
    try {
      ...
      {
        EXISTS26 =
          (Token) match(input, EXISTS, FOLLOW_EXISTS_in_existspredicate965);
        ...
        LEFTPAREN27 =
          (Token) match(
            input,
            LEFTPAREN,
            FOLLOW_LEFTPAREN_in_existspredicate967
          );
        ...
        PROPERTYNAME29 =
          (Token) match(
            input,
            PROPERTYNAME,
            FOLLOW_PROPERTYNAME_in_existspredicate972
          );
        ...
        RIGHTPAREN30 =
          (Token) match(
            input,
            RIGHTPAREN,
            FOLLOW_RIGHTPAREN_in_existspredicate974
          );
        ...
        // 137:63: -> ^( EXISTS PROPERTYNAME )
        {
          // org/alfresco/rest/antlr/WhereClause.g:137:66: ^( EXISTS PROPERTYNAME )
          {
            Object root_1 = (Object) adaptor.nil();
            root_1 =
              (Object) adaptor.becomeRoot(stream_EXISTS.nextNode(), root_1);
  ...
  public final WhereClauseParser.betweenpredicate_return betweenpredicate()
    throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_BETWEEN = new RewriteRuleTokenStream(
      adaptor,
      "token BETWEEN"
    );
    RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(
    ...
    RewriteRuleSubtreeStream stream_propertyvaluepair = new RewriteRuleSubtreeStream(
      adaptor,
      ...
      // org/alfresco/rest/antlr/WhereClause.g:138:19: PROPERTYNAME BETWEEN LEFTPAREN ( WS )? propertyvaluepair RIGHTPAREN
      {
        PROPERTYNAME31 =
          (Token) match(
            input,
            PROPERTYNAME,
            FOLLOW_PROPERTYNAME_in_betweenpredicate988
          );
        stream_PROPERTYNAME.add(PROPERTYNAME31);

        BETWEEN32 =
          (Token) match(input, BETWEEN, FOLLOW_BETWEEN_in_betweenpredicate990);
        ...
        LEFTPAREN33 =
          (Token) match(
            input,
            LEFTPAREN,
            FOLLOW_LEFTPAREN_in_betweenpredicate992
          );
        ...
        RIGHTPAREN36 =
          (Token) match(
            input,
            RIGHTPAREN,
            FOLLOW_RIGHTPAREN_in_betweenpredicate999
          );
        ...
        // 138:83: -> ^( BETWEEN PROPERTYNAME propertyvaluepair )
        {
          // org/alfresco/rest/antlr/WhereClause.g:138:86: ^( BETWEEN PROPERTYNAME propertyvaluepair )
          {
            Object root_1 = (Object) adaptor.nil();
            root_1 =
              (Object) adaptor.becomeRoot(stream_BETWEEN.nextNode(), root_1);
  ...
  public final WhereClauseParser.inpredicate_return inpredicate()
    throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_propertyvaluelist = new RewriteRuleSubtreeStream(
      adaptor,
      ...
      // org/alfresco/rest/antlr/WhereClause.g:139:14: PROPERTYNAME IN LEFTPAREN ( WS )? propertyvaluelist RIGHTPAREN
      {
        PROPERTYNAME37 =
          (Token) match(
            input,
            PROPERTYNAME,
            FOLLOW_PROPERTYNAME_in_inpredicate1015
          );
        ...
        LEFTPAREN39 =
          (Token) match(input, LEFTPAREN, FOLLOW_LEFTPAREN_in_inpredicate1019);
        ...
        RIGHTPAREN42 =
          (Token) match(
            input,
            RIGHTPAREN,
            FOLLOW_RIGHTPAREN_in_inpredicate1026
          );
  ...
  public final WhereClauseParser.matchespredicate_return matchespredicate()
    throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_MATCHES = new RewriteRuleTokenStream(
      adaptor,
      "token MATCHES"
    );
    RewriteRuleTokenStream stream_WS = new RewriteRuleTokenStream(
      ...
      // org/alfresco/rest/antlr/WhereClause.g:140:19: PROPERTYNAME MATCHES LEFTPAREN ( WS )? value RIGHTPAREN
      {
        PROPERTYNAME43 =
          (Token) match(
            input,
            PROPERTYNAME,
            FOLLOW_PROPERTYNAME_in_matchespredicate1042
          );
        stream_PROPERTYNAME.add(PROPERTYNAME43);

        MATCHES44 =
          (Token) match(input, MATCHES, FOLLOW_MATCHES_in_matchespredicate1044);
        ...
        LEFTPAREN45 =
          (Token) match(
            input,
            LEFTPAREN,
            FOLLOW_LEFTPAREN_in_matchespredicate1046
          );
        ...
        switch (alt12) {
          case 1:
            ...
            {
              WS46 =
                (Token) match(input, WS, FOLLOW_WS_in_matchespredicate1048);
              stream_WS.add(WS46);
            }
            break;
        }
        ...
        RIGHTPAREN48 =
          (Token) match(
            input,
            RIGHTPAREN,
            FOLLOW_RIGHTPAREN_in_matchespredicate1053
          );
        ...
        // 140:71: -> ^( MATCHES PROPERTYNAME value )
        {
          // org/alfresco/rest/antlr/WhereClause.g:140:74: ^( MATCHES PROPERTYNAME value )
          {
            Object root_1 = (Object) adaptor.nil();
            root_1 =
              (Object) adaptor.becomeRoot(stream_MATCHES.nextNode(), root_1);
  ...
  public final WhereClauseParser.propertyvaluepair_return propertyvaluepair()
    throws RecognitionException {
    ...
    try {
      ...
      // org/alfresco/rest/antlr/WhereClause.g:141:20: value COMMA value
      {
        ...
        COMMA50 =
          (Token) match(input, COMMA, FOLLOW_COMMA_in_propertyvaluepair1071);
  ...
  public final WhereClauseParser.propertyvaluelist_return propertyvaluelist()
    throws RecognitionException {
              ...
              // org/alfresco/rest/antlr/WhereClause.g:142:27: COMMA value
              {
                COMMA53 =
                  (Token) match(
                    input,
                    COMMA,
                    FOLLOW_COMMA_in_propertyvaluelist1087
                  );
  ...
  public final WhereClauseParser.value_return value()
    throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_PROPERTYVALUE = new RewriteRuleTokenStream(
      adaptor,
      "token PROPERTYVALUE"
    );
          ...
          // org/alfresco/rest/antlr/WhereClause.g:143:8: a= PROPERTYVALUE
          {
            a =
              (Token) match(
                input,
                PROPERTYVALUE,
                FOLLOW_PROPERTYVALUE_in_value1104
              );
          ...
          // org/alfresco/rest/antlr/WhereClause.g:144:9: b= PROPERTYNAME
          {
            b =
              (Token) match(
                input,
                PROPERTYNAME,
                FOLLOW_PROPERTYNAME_in_value1124
              );
  ...
  public final WhereClauseParser.selectClause_return selectClause()
    throws RecognitionException {
      ...
      // org/alfresco/rest/antlr/WhereClause.g:145:16: PROPERTYNAME ( COMMA PROPERTYNAME )*
      {
        PROPERTYNAME55 =
          (Token) match(
            input,
            PROPERTYNAME,
            FOLLOW_PROPERTYNAME_in_selectClause1140
          );
        ...
        loop15:do {
          ...
          switch (alt15) {
            case 1:
              ...
              {
                COMMA56 =
                  (Token) match(input, COMMA, FOLLOW_COMMA_in_selectClause1143);
                ...
                PROPERTYNAME57 =
                  (Token) match(
                    input,
                    PROPERTYNAME,
                    FOLLOW_PROPERTYNAME_in_selectClause1145
                  );
        ...
        // 145:51: -> ( PROPERTYNAME )+
        {
          ...
          while (stream_PROPERTYNAME.hasNext()) {
            adaptor.addChild(root_0, stream_PROPERTYNAME.nextNode());
          }
  ...
  static final String DFA6_eotS = "\107\uffff";
  static final String DFA6_eofS = "\107\uffff";
  ...
  static final String DFA6_acceptS = "\40\uffff\1\1\1\2\1\3\44\uffff";
  static final String DFA6_specialS = "\107\uffff}>";
  static final String[] DFA6_transitionS = {
    ...
    "\1\17\1\16",
    "\1\21\3\uffff\1\20",
    "\1\22\2\uffff\1\25\1\uffff\2\25\4\uffff\1\23\1\uffff\2\25\1" + "\24",
    "\1\26",
    "\1\31\1\30\2\uffff\1\27",
    "\1\34\1\33\2\uffff\1\32",
    "\1\37\1\36\2\uffff\1\35",
  ...
  static final char[] DFA6_min = DFA.unpackEncodedStringToUnsignedChars(
    DFA6_minS
  );
  static final char[] DFA6_max = DFA.unpackEncodedStringToUnsignedChars(
    DFA6_maxS
  );
  ...
  public static final BitSet FOLLOW_WS_in_whereclause779 = new BitSet(
    new long[] { 0x0000000000020000L }
  );
  public static final BitSet FOLLOW_LEFTPAREN_in_whereclause782 = new BitSet(
    new long[] { 0x0000000008A00200L }
  );
  public static final BitSet FOLLOW_WS_in_whereclause785 = new BitSet(
    new long[] { 0x0000000000A00200L }
  );
  public static final BitSet FOLLOW_predicate_in_whereclause788 = new BitSet(
    new long[] { 0x0000000002000000L }
  );
  public static final BitSet FOLLOW_RIGHTPAREN_in_whereclause790 = new BitSet(
    new long[] { 0x0000000008000002L }
  );
  public static final BitSet FOLLOW_WS_in_whereclause793 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_simplepredicate_in_predicate801 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_simplepredicate_in_predicate815 = new BitSet(
    new long[] { 0x0000000000000010L }
  );
  public static final BitSet FOLLOW_AND_in_predicate818 = new BitSet(
    new long[] { 0x0000000000A00200L }
  );
  public static final BitSet FOLLOW_simplepredicate_in_predicate820 = new BitSet(
    new long[] { 0x0000000000000012L }
  );
  public static final BitSet FOLLOW_simplepredicate_in_predicate845 = new BitSet(
    new long[] { 0x0000000000400000L }
  );
  public static final BitSet FOLLOW_OR_in_predicate848 = new BitSet(
    new long[] { 0x0000000000A00200L }
  );
  public static final BitSet FOLLOW_simplepredicate_in_predicate850 = new BitSet(
    new long[] { 0x0000000000400002L }
  );
  public static final BitSet FOLLOW_allowedpredicates_in_simplepredicate868 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_NEGATION_in_simplepredicate892 = new BitSet(
    new long[] { 0x0000000000800200L }
  );
  public static final BitSet FOLLOW_allowedpredicates_in_simplepredicate894 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_comparisonpredicate_in_allowedpredicates909 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_existspredicate_in_allowedpredicates913 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_betweenpredicate_in_allowedpredicates917 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_inpredicate_in_allowedpredicates921 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_matchespredicate_in_allowedpredicates925 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_comparisonpredicate931 = new BitSet(
    new long[] { 0x00000000000C0D00L }
  );
  public static final BitSet FOLLOW_comparisonoperator_in_comparisonpredicate933 = new BitSet(
    new long[] { 0x0000000001800000L }
  );
  public static final BitSet FOLLOW_value_in_comparisonpredicate935 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_EXISTS_in_existspredicate965 = new BitSet(
    new long[] { 0x0000000000020000L }
  );
  public static final BitSet FOLLOW_LEFTPAREN_in_existspredicate967 = new BitSet(
    new long[] { 0x0000000008800000L }
  );
  public static final BitSet FOLLOW_WS_in_existspredicate969 = new BitSet(
    new long[] { 0x0000000000800000L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_existspredicate972 = new BitSet(
    new long[] { 0x0000000002000000L }
  );
  public static final BitSet FOLLOW_RIGHTPAREN_in_existspredicate974 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_betweenpredicate988 = new BitSet(
    new long[] { 0x0000000000000020L }
  );
  public static final BitSet FOLLOW_BETWEEN_in_betweenpredicate990 = new BitSet(
    new long[] { 0x0000000000020000L }
  );
  public static final BitSet FOLLOW_LEFTPAREN_in_betweenpredicate992 = new BitSet(
    new long[] { 0x0000000009800000L }
  );
  public static final BitSet FOLLOW_WS_in_betweenpredicate994 = new BitSet(
    new long[] { 0x0000000001800000L }
  );
  public static final BitSet FOLLOW_propertyvaluepair_in_betweenpredicate997 = new BitSet(
    new long[] { 0x0000000002000000L }
  );
  public static final BitSet FOLLOW_RIGHTPAREN_in_betweenpredicate999 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_inpredicate1015 = new BitSet(
    new long[] { 0x0000000000010000L }
  );
  public static final BitSet FOLLOW_IN_in_inpredicate1017 = new BitSet(
    new long[] { 0x0000000000020000L }
  );
  public static final BitSet FOLLOW_LEFTPAREN_in_inpredicate1019 = new BitSet(
    new long[] { 0x0000000009800000L }
  );
  public static final BitSet FOLLOW_WS_in_inpredicate1021 = new BitSet(
    new long[] { 0x0000000001800000L }
  );
  public static final BitSet FOLLOW_propertyvaluelist_in_inpredicate1024 = new BitSet(
    new long[] { 0x0000000002000000L }
  );
  public static final BitSet FOLLOW_RIGHTPAREN_in_inpredicate1026 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_matchespredicate1042 = new BitSet(
    new long[] { 0x0000000000100000L }
  );
  public static final BitSet FOLLOW_MATCHES_in_matchespredicate1044 = new BitSet(
    new long[] { 0x0000000000020000L }
  );
  public static final BitSet FOLLOW_LEFTPAREN_in_matchespredicate1046 = new BitSet(
    new long[] { 0x0000000009800000L }
  );
  public static final BitSet FOLLOW_WS_in_matchespredicate1048 = new BitSet(
    new long[] { 0x0000000001800000L }
  );
  public static final BitSet FOLLOW_value_in_matchespredicate1051 = new BitSet(
    new long[] { 0x0000000002000000L }
  );
  public static final BitSet FOLLOW_RIGHTPAREN_in_matchespredicate1053 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_value_in_propertyvaluepair1069 = new BitSet(
    new long[] { 0x0000000000000080L }
  );
  public static final BitSet FOLLOW_COMMA_in_propertyvaluepair1071 = new BitSet(
    new long[] { 0x0000000001800000L }
  );
  public static final BitSet FOLLOW_value_in_propertyvaluepair1073 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_value_in_propertyvaluelist1084 = new BitSet(
    new long[] { 0x0000000000000082L }
  );
  public static final BitSet FOLLOW_COMMA_in_propertyvaluelist1087 = new BitSet(
    new long[] { 0x0000000001800000L }
  );
  public static final BitSet FOLLOW_value_in_propertyvaluelist1089 = new BitSet(
    new long[] { 0x0000000000000082L }
  );
  public static final BitSet FOLLOW_PROPERTYVALUE_in_value1104 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_value1124 = new BitSet(
    new long[] { 0x0000000000000002L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_selectClause1140 = new BitSet(
    new long[] { 0x0000000000000082L }
  );
  public static final BitSet FOLLOW_COMMA_in_selectClause1143 = new BitSet(
    new long[] { 0x0000000000800000L }
  );
  public static final BitSet FOLLOW_PROPERTYNAME_in_selectClause1145 = new BitSet(
    new long[] { 0x0000000000000082L }
  );
}
