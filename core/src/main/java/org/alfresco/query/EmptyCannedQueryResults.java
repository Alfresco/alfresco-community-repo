...
/**
 * An always empty {@link CannedQueryResults}, used when you know you can short circuit a query when
 * no results are found.
 *
 * @author Nick Burch
 * @since 4.0
 */
public class EmptyCannedQueryResults<R> extends EmptyPagingResults<R>
