...
/**
 * System test for RM-2072: Concurrency exceptions and deadlocks on Records Management "File to"
 * rule
 *
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        fileAction.setParameterValue(
                                FileToAction.PARAM_PATH,
                                "/A/B/C/{date.year.long}/{date.month.long}/{date.day.month}");
