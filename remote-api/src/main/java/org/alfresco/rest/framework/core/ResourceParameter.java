...
public class ResourceParameter {
  ...
  public static final ResourceParameter ENTITY_PARAM = new ResourceParameter(
    "entityId",
  ...
  public static final ResourceParameter RELATIONSHIP_PARAM = new ResourceParameter(
    "relationshipId",
    "The unique id of the entity relationship being addressed",
    "The unique id must be a String. It is only valid in the scope of the relationship",
    true,
    String.class,
    KIND.URL_PATH,
    false
  ...
  public static final ResourceParameter SKIP_PARAM = new ResourceParameter(
    "skipCount",
    "Skip count",
  ...
  public static final ResourceParameter MAX_ITEMS_PARAM = new ResourceParameter(
    "maxItems",
    "Maximum items",
  ...
  public static final ResourceParameter PROPS_PARAM = new ResourceParameter(
    "properties",
  ...
  public static final ResourceParameter RELATIONS_PARAM = new ResourceParameter(
    "relations",
  ...
  public static final ResourceParameter WHERE_PARAM = new ResourceParameter(
    "where",
