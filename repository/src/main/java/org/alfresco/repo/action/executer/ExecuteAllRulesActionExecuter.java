...
public class ExecuteAllRulesActionExecuter extends ActionExecuterAbstractBase {
  ...
  public static final String PARAM_EXECUTE_INHERITED_RULES =
    "execute-inherited-rules";
  public static final String PARAM_RUN_ALL_RULES_ON_CHILDREN =
    "run-all-rules-on-children";
  ...
  private void executeImpl(
    ...
    Boolean includeInheritedValue = (Boolean) ruleAction.getParameterValue(
    ...
    Boolean runAllChildrenValue = (Boolean) ruleAction.getParameterValue(
    ...
    List<Rule> currentNodeRules = ruleService.getRules(
      actionedUponNodeRef,
      includeInherited
    );
