...
public class FixedAclUpdaterTest extends TestCase {
  ...
  private static final int[] filesPerLevelMoreFolders = {
    5,
    1,
    1,
    1,
  ...
  private static String TEST_GROUP_NAME_FULL =
    PermissionService.GROUP_PREFIX + TEST_GROUP_NAME;
  ...
  public void testSyncNoTimeOut() {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testSyncNoTimeOutFolder"
    );
    ...
    try {
      ...
      assertEquals(
        "There are nodes pending",
        0,
        getNodesCountWithPendingFixedAclAspect()
      );
    } finally {
  ...
  public void testSyncTimeOut() {
    ...
    try {
      ...
      NodeRef folderWithPendingAcl = getFirstNodeWithAclPending(
        ContentModel.TYPE_FOLDER
      );
      ACLComparator aclComparatorForPending = new ACLComparator(
  ...
  public void testAsyncWithNodeCreation() {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithNodeCreationFolder"
    );
  ...
  public void testAsyncWithNodeDeletion() {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithNodeDeletionFolder"
    );
   ...
   */
  @Test
  public void testSyncCopyNoTimeOut()
    throws FileExistsException, FileNotFoundException {
    NodeRef originalRef = createFolderHierarchyInRootForFolderTests(
      "originFolder"
    );
    NodeRef targetRefBase = createFolderHierarchyInRootForFolderTests(
      "targetFolder"
    );
    ...
    try {
      ...
      NodeRef targetRef = nodeDAO
        .getNodePair(getChild(nodeDAO.getNodePair(targetRefBase).getFirst()))
        .getSecond();
      ...
      // Copy the nodes
      NodeRef copiedNode = fileFolderService
        .copy(originalRef, targetRef, null)
        .getNodeRef();
      ...
      assertTrue(
        ...
        aclComparatorCopied.hasPermission(
          TEST_GROUP_NAME_FULL,
          DEFAULT_PERMISSION
        )
      );
  ...
  public void testAsyncWithNodeCopy() {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithNodeCopyOriginFolder"
    );
    NodeRef targetRefBase = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithNodeCopyTargetFolder"
    );
    ...
    try {
      ...
      NodeRef copiedChild = fileFolderService.searchSimple(
        targetRef,
        "copyOfFolder"
      );
      ACLComparator aclComparatorCopiedPendingChild = new ACLComparator(
        copiedChild
      );
  ...
  public void testAsyncWithNodeCopyToPendingFolder() {
    ...
    try {
      ...
      NodeRef targetFolderWithPendingAcl = getFirstNodeWithAclPending(
        ContentModel.TYPE_FOLDER,
        targetRef
      );
      assertNotNull(
      ...
      ACLComparator aclComparatorTargetPendingChild = new ACLComparator(
        targetFolderWithPendingAcl
      );
      ...
      // Find a pending ACL folder to copy
      NodeRef originFolderWithPendingAcl = getFirstNodeWithAclPending(
        ContentModel.TYPE_FOLDER,
        folderRef
      );
      assertNotNull(
  ...
  public void testAsyncWithNodeCopyParentToChildPendingFolder() {
    ...
    try {
      ...
      NodeRef targetFolderWithPendingAclChild = nodeDAO
        .getNodePair(
          getChild(nodeDAO.getNodePair(targetFolderWithPendingAcl).getFirst())
        )
        .getSecond();
      ACLComparator aclComparatorTargetPendingChild = new ACLComparator(
      ...
      ACLComparator aclComparatorCopiedPendingParent = new ACLComparator(
        copiedChild
      );
      ...
      if (originFolderWithPendingAclParent.equals(folderRef)) {
        assertTrue(
          "Copied Parent (from original node where permissions were set) did not keep original permissions",
  ...
  public void testAsyncWithNodeMoveChildToChildPendingFolder() {
    ...
    try {
      ...
      // Get ACLS for later comparison
      ACLComparator aclComparatorTarget = new ACLComparator(
        targetFolderWithPendingAcl
      );
      aclComparatorTarget.setOriginalPermission(
        TEST_GROUP_NAME_FULL,
      ...
      NodeRef originFolderWithPendingAclChild = nodeDAO
        .getNodePair(
          getChild(nodeDAO.getNodePair(originFolderWithPendingAcl).getFirst())
        )
        .getSecond();

      // Get ACLS for later comparison
      ACLComparator aclComparatorMovedNode = new ACLComparator(
        originFolderWithPendingAclChild
      );
      aclComparatorMovedNode.setOriginalPermission(
        TEST_GROUP_NAME_FULL,
        DEFAULT_PERMISSION
      );
  ...
  public void testAsyncWithErrorsForceSharedACL() {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithErrorsForceSharedACL"
    );
    ...
    try {
      ...
      txnHelper.doInTransaction(
        (RetryingTransactionCallback<Void>) () -> {
          ...
          NodeRef tempNodeChild = createFile(
            fileFolderService,
            tempNode,
      ...
      ACLComparator aclComparator = new ACLComparator(
        originFolderWithPendingAclChild
      );
  ...
  public void testAsyncWithNodeMove() {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithNodeMoveOriginFolder"
    );
    NodeRef targetRefBase = createFolderHierarchyInRootForFolderTests(
      "testAsyncWithNodeMoveTargetFolder"
    );
    ...
    try {
      ...
      ACLComparator aclComparatorOriginPendingChild = new ACLComparator(
        folderWithPendingAcl
      );
      assertNotNull(
        "No children folders were found with pendingFixACl aspect",
  ...
  public void testAsyncWithNodeLock() {
    NodeRef folderRef = createFolderHierarchyInRootForFileTests(
      "testAsyncWithNodeLockFolder"
    );

    try {
      setPermissionsOnTree(folderRef, true, true);

      NodeRef nodeWithPendingAcl = getFirstNodeWithAclPending(
        ContentModel.TYPE_CONTENT
      );
      assertNotNull(
        "No children files were found with pendingFixACl aspect",
        nodeWithPendingAcl
      );
  ...
  public void testAsyncWithNodeCheckout() {
    NodeRef folderRef = createFolderHierarchyInRootForFileTests(
      "testAsyncWithNodeCheckoutFolder"
    );
    ...
    try {
      ...
      txnHelper.doInTransaction(
        (RetryingTransactionCallback<Void>) () -> {
          NodeRef workingCopy = checkOutCheckInService.checkout(
            nodeWithPendingAcl
          );
  ...
  public void testAsyncCascadeUpdatePermissions() {
    ...
    try {
      ...
      assertTrue(
        ...
        getNodesCountWithPendingFixedAclAspect() > 0
      );
  ...
  public void testAsyncWithNodeContentUpdate() {
    NodeRef folderRef = createFolderHierarchyInRootForFileTests(
      "testAsyncWithNodeContentUpdateFolder"
    );
  ...
  public void testAsyncConcurrentPermissionsUpdate() throws Throwable {
    ...
    try {
      txnHelper.doInTransaction(
        (RetryingTransactionCallback<Void>) () -> {
          ...
          for (int i = 0; i < concurrentUpdates; i++) {
            if (
              !authorityService.authorityExists(
      ...
      runnables[0] =
        createRunnableToSetPermissions(folderRef, group_prefix + 0, 0);
      ...
      for (int i = 1; i < runnables.length; i++) {
        ...
        runnables[i] =
          createRunnableToSetPermissions(nodeRef, group_prefix + i, i);
      ...
      assertTrue(
        "There were no concurrency errors",
        errors.entrySet().size() > 0
      );
  ...
  public void testAsyncConcurrentUpdateAndJob() throws Throwable {
    NodeRef folderRef = createFolderHierarchyInRootForFolderTests(
      "testAsyncConcurrentUpdateAndJobFolder"
    );
    List<FileInfo> subFolders = fileFolderService.listFolders(folderRef);
    String group_prefix = "TEST_";
    int concurrentUpdates = 5;
  ...
  private Long getChild(Long parentId) {
    List<FileInfo> children = fileFolderService.list(
      nodeDAO.getNodePair(parentId).getSecond()
    );
    if (children.size() > 0) {
  ...
  private void setFixedPermissionsForTestGroup(
    NodeRef folderRef,
    String authName,
    int thread
  ) {
  ...
  private Runnable createRunnableToSetPermissions(
    NodeRef folderRef,
    String authName,
    int thread
  ) throws Throwable {
  ...
  private static void setFixedAclMaxTransactionTime(
    ...
    if (permissionsDaoComponent instanceof ADMPermissionsDaoComponentImpl) {
      AccessControlListDAO acldao =
        ((ADMPermissionsDaoComponentImpl) permissionsDaoComponent).getACLDAO(
            folderNodeRef
          );
  ...
  private NodeRef createFolderHierarchyInRoot(
    String folderName,
    int[] filesPerLevel
  ) {
    return txnHelper.doInTransaction(
      (RetryingTransactionCallback<NodeRef>) () -> {
        NodeRef parent = createFile(
          fileFolderService,
          homeFolderNodeRef,
          folderName,
          ContentModel.TYPE_FOLDER
  ...
  private void setPermissionsOnTree(
    NodeRef folderRef,
    boolean asyncCall,
    boolean shouldHaveNodesPending
  ) {
    txnHelper.doInTransaction(
      (RetryingTransactionCallback<Void>) () -> {
  ...
  private NodeRef getFirstNodeWithAclPending(
    QName nodeType,
    NodeRef parentRef
  ) {
    return txnHelper.doInTransaction(
      (RetryingTransactionCallback<NodeRef>) () -> {
        ...
        for (int i = 0; i < nodesWithAclPendingAspect.size(); i++) {
          ...
          List<FileInfo> path = fileFolderService.getNamePath(
            homeFolderNodeRef,
            nodeRef
          );
          ...
          if (
            isDescendent &&
            nodeDAO
              .getNodeType(nodeDAO.getNodePair(nodeRef).getFirst())
              .equals(nodeType)
          ) {
      ...
      (RetryingTransactionCallback<Void>) () -> {
        if (nodeDAO.exists(folder)) {
          ...
          nodeDAO.addNodeAspects(
            nodeDAO.getNodePair(folder).getFirst(),
            aspect
          );
  ...
  private class ACLComparator {
    ...
    public void updateCurrentACLs() {
      ...
      if (
        nodeDAO.hasNodeAspect(parentId, ContentModel.ASPECT_PENDING_FIX_ACL)
      ) {
    ...
    public void compareACLs() {
      updateCurrentACLs();
      assertTrue(
        "Permissions were not changed on top folder",
        !oParentACL.equals(tParentACL)
      );
      assertTrue(
    ...
    public void setOriginalPermission(
    ...
    public boolean hasPermission(
      ...
      for (
        Iterator<AccessPermission> iterator = permissions.iterator();
        iterator.hasNext();
      ) {
        AccessPermission accessPermission = (AccessPermission) iterator.next();
        if (
          accessPermission.getPermission().equalsIgnoreCase(permission) &&
    ...
    public boolean firstChildHasPermission(
      String authority,
      String permission
    ) {
  ...
  private static class GetNodesCountWithAspectCallback
    implements NodeRefQueryCallback {
