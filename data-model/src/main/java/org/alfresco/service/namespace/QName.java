...
public final class QName
  ...
  public static QName createQName(String qname) throws InvalidQNameException {
    ...
    if (localName == null || localName.length() == 0) {
      throw new InvalidQNameException(
        "QName '" + qname + "' must consist of a local name"
      );
    }
   ...
   */
  public static QName createQNameWithValidLocalName(
   ...
   */
  public static QName resolveToQName(
    NamespacePrefixResolver prefixResolver,
    String str
  ) {
    QName qname = null;
   ...
   */
  public static String resolveToQNameString(
    NamespacePrefixResolver prefixResolver,
    String str
  ) {
    String result = str;
