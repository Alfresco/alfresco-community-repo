...
public class DiscussionRestApiTest extends BaseWebScriptTest
{
            ...
            FORUM_NODE = transactionService.getRetryingTransactionHelper().doInTransaction(new RetryingTransactionCallback<NodeRef>() {
                ...
                public NodeRef execute() throws Throwable
                {
                    ...
                    return nodeService.createNode(
                            ...
                            QName.createQName(forumNodeName), ForumModel.TYPE_FORUM, props).getChildRef();
                }
            });
        }
    ...
    /**
     * https://issues.alfresco.com/jira/browse/ALF-17443 reports that site contributors are unable to edit replies that they have made.
     */
