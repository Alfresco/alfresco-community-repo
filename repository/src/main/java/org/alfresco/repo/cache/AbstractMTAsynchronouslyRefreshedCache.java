...
/**
 * The base implementation for Multi-tenant asynchronously refreshed cache. Currently supports one
 * value per tenant.
 *
 * <p>Implementors just need to provide buildCache(String tennantId)
 *
 * @author Andy
 * @since 4.1.3
 */
public abstract class AbstractMTAsynchronouslyRefreshedCache<T>
    ...
    /**
     * Build the cache entry for the specific tenant. This method is called in a thread-safe manner
     * i.e. it is only ever called by a single thread.
     */
