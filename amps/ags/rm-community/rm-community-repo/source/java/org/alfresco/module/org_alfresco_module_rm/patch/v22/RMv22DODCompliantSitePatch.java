 ...
 *
 * <p>Makes all existing sites of type dod:site to preserve their DOD compliance status.
 *
        ...
        if (!convertToStandardFilePlan) {
            ...
            if (qnameDAO.getQName(RecordsManagementModel.TYPE_RM_SITE) != null
                ...
                qnameDAO.updateQName(
                        RecordsManagementModel.TYPE_RM_SITE, DOD5015Model.TYPE_DOD_5015_SITE);
            }
