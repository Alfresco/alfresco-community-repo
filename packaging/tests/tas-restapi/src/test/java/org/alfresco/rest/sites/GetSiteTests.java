...
public class GetSiteTests extends RestTest {
  ...
  public void checkStatusCodeForEmptySiteId() throws Exception {
    ...
    RestSiteModelsCollection sites = restClient.processModels(
      RestSiteModelsCollection.class,
      request
    );
    restClient.assertStatusCodeIs(HttpStatus.OK);
  ...
  public void checkThatPropertiesParameterIsAppliedPositiveTest()
    throws Exception {
    restSiteModel =
      restClient
        .authenticateUser(adminUserModel)
  ...
  public void deleteSiteThenGetSiteDetails() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, newSite.getId())
      )
      .containsErrorKey(RestErrorModel.ENTITY_NOT_FOUND_ERRORKEY)
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .stackTraceIs(RestErrorModel.STACKTRACE);
  ...
  public void checkThatRelationsParameterIsAppliedForContainers()
    throws Exception {
    List<Object> jsonObjects = restClient
      .authenticateUser(adminUserModel)
    ...
    RestSiteContainerModelsCollection containers = (RestSiteContainerModelsCollection) jsonObjects.get(
      1
    );
  ...
  public void checkThatRelationsParameterIsAppliedForMembers()
    throws Exception {
    SiteModel publicRandomSite = dataSite
    ...
    RestSiteModel siteModel = (RestSiteModel) jsonObjects.get(0);
    RestSiteMemberModelsCollection siteMembers = (RestSiteMemberModelsCollection) jsonObjects.get(
      1
    );
  ...
  public void checkThatRelationsParameterIsAppliedForMembersCustom() {
    ...
    response
      .assertThat()
      .body(
        "relations.members.list.entries.entry[0].role",
        equalTo("SiteManager")
      );
  }
  ...
  public void checkThatRelationsParameterIsAppliedForContainersAndMembers()
    throws Exception {
    SiteModel publicRandomSite = dataSite
      .usingUser(adminUserModel)
      .createPublicRandomSite();
