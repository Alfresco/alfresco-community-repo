...
public class GetRatingsTests extends RestTest {
  ...
  public void addLikeUsingInvalidNodeId() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, document.getNodeRef())
      );
  }
  ...
  public void checkRatingValueIsTrueForLikedDoc() throws Exception {
    ...
    restRatingModelsCollection
      .assertThat()
      .entriesListContains("myRating", "true")
      .assertThat()
      .entriesListContains("id", "likes");
  }
  ...
  public void checkRatingValueIsIntegerForStarsRating() throws Exception {
    ...
    restRatingModelsCollection
      .assertThat()
      .entriesListContains("myRating", "5")
      .assertThat()
      .entriesListContains("id", "fiveStar");
  }
  ...
  public void checkMaxItemsAndSkipCountParameters() throws Exception {
    ...
    restRatingModelsCollection =
      restClient
        .authenticateUser(adminUser)
        .withParams("maxItems=1", "skipCount=1")
        .withCoreAPI()
        .usingResource(document)
        .getRatings();
  ...
  public void userIsNotAbleToGetRatingsOfDocumentToWhichItHasNoAccess()
    throws Exception {
  ...
  public void getRatingsUsingSiteId() throws Exception {
    ...
    restClient
      ...
      .containsErrorKey(RestErrorModel.ENTITY_NOT_FOUND_ERRORKEY)
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, siteModel.getId())
      )
      .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
      .stackTraceIs(RestErrorModel.STACKTRACE);
  }
