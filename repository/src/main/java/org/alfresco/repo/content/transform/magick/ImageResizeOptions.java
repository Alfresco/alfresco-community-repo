...
public class ImageResizeOptions {
    ...
    /**
     * Indicates that scaling operations should scale up or down to the specified dimensions, as
     * requested. If this argument is false, only resizings that scale the image down will be
     * performed. Scaling up will result in an unchanged image.
     *
     * @since 4.0
     */
    ...
    public String toString() {
        ...
        builder.append("ImageResizeOptions [width=")
                .append(this.width)
                .append(", height=")
                .append(this.height)
                .append(", maintainAspectRatio=")
                .append(this.maintainAspectRatio)
                .append(", percentResize=")
                .append(this.percentResize)
                .append(", resizeToThumbnail=")
                .append(this.resizeToThumbnail)
                .append(", allowEnlargement=")
                .append(this.allowEnlargement)
                .append("]");
