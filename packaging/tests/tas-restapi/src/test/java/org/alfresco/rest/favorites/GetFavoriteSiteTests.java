...
public class GetFavoriteSiteTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user gets its specific favorite site with Rest API and response"
                            + " is successful (200)")
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator user gets its specific favorite site with Rest API and"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user gets its specific favorite site with Rest API and"
                            + " response is successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user gets its specific favorite site with Rest API and"
                            + " response is successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user gets specific favorite site of any user with Rest API and"
                            + " response is successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager user fails to get specific favorite site of another user with"
                            + " Rest API and response is successful (403)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify manager user is NOT Authorized gets its specific favorite site with"
                            + " Rest API when authentication fails (401)")
    ...
    public void getFavoriteSiteWithNonExistentPersonId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, "someUser"));
    }
    ...
    public void getFavoriteSiteWithNonExistentSiteId() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingAuthUser()
                .getFavoriteSite(nonExistentSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify User fails to get specific favorite site of admin with Rest API and"
                            + " response is 403")
    ...
    public void getFavoriteSiteWithEmptySiteId() throws Exception {
        ...
        RestRequest request =
                RestRequest.simpleRequest(
                        HttpMethod.GET,
                        "people/{personId}/favorite-sites/{siteId}?{parameters}",
                        userModel.getUsername(),
                        "",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify invalid request returns status 404 when another user get favorite site"
                            + " of an user")
    ...
    public void getFavoriteSiteUsingMe() throws Exception {
        ...
        restSiteModel
                ...
                .and()
                .field("title")
                .is(siteModel1.getTitle())
                .and()
                .field("role")
                .is(UserRole.SiteManager.toString())
                .and()
                .field("visibility")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify invalid request returns status 404 when providing folder name instead"
                            + " of site id")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify invalid request returns status 404 when providing file name instead of"
                            + " site id")
