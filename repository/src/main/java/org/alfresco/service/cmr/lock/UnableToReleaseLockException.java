...
public class UnableToReleaseLockException extends RuntimeException {
   ...
   * Error message
   */
  private static final String ERROR_MESSAGE_1 = I18NUtil.getMessage(
    "lock_service.insufficent_privileges"
  );
  ...
  public UnableToReleaseLockException(NodeRef nodeRef) {
    super(
      MessageFormat.format(ERROR_MESSAGE_1, new Object[] { nodeRef.getId() })
    );
  }
