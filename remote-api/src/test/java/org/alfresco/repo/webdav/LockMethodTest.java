...
public class LockMethodTest {
  ...
  private static final String TEST_NEW_FOLDER_NAME =
    "new_folder" + GUID.generate();
  ...
  public void testRefreshLock() throws Exception {
    ...
    String content =
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?><D:lockinfo xmlns:D=\"DAV:\"><D:lockscope xmlns:D=\"DAV:\">" +
    ...
    String lockToken =
      fileNodeRef.getId() + WebDAV.LOCK_TOKEN_SEPERATOR + this.userName;
    ...
    content =
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?><D:propfind xmlns:D=\"DAV:\"><D:prop><D:getlastmodified/>" +
  ...
  public void testMNT_10873() throws Exception {
    ...
    assertFalse(
      "File should note exist in repo any more.",
  ...
  public void testMNT_11990() throws Exception {
    ...
    lockRequest.addHeader(
      WebDAV.HEADER_IF,
      "(<" + WebDAV.makeLockToken(fileNodeRef, userName) + ">)"
    );
    lockRequest.setRequestURI("/" + TEST_FILE_NAME);
  ...
  public void testMNT_12425() throws Exception {
    ...
    lockRequest.setRequestURI(
      "/" + TEST_NEW_FOLDER_NAME + "/" + TEST_NEW_FILE_NAME
    );
