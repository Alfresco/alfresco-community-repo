...
public class ExtendedPermissionServiceImpl
  ...
  private static final String AUDIT_ENABLE_INHERIT_PERMISSION =
    "enable-inherit-permission";
  /** An audit key for the disable permission inheritance event. */
  private static final String AUDIT_DISABLE_INHERIT_PERMISSION =
   ...
   */
  public void setWritersCache(
    SimpleCache<Serializable, Set<String>> writersCache
  ) {
  ...
  public Set<String> getReaders(Long aclId) {
    ...
    for (String authority : assigned) {
      ...
      if (
        test.evaluate(authority, aclId) || rmTest.evaluate(authority, aclId)
      ) {
  ...
  public Set<String> getWriters(Long aclId) {
    ...
    Set<String> aclWriters = writersCache.get(
      (Serializable) acl.getProperties()
    );
    if (aclWriters != null) {
      return aclWriters;
    ...
    for (String authority : assigned) {
      UnconditionalAclTest test = new UnconditionalAclTest(
        getPermissionReference(PermissionService.WRITE)
      );
  ...
  public void setInheritParentPermissions(
    ...
    if (
      inheritParentPermissions != super.getInheritParentPermissions(nodeRef)
    ) {
