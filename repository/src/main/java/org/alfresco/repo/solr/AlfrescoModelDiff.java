...
/**
 * Represents a diff between the set of current repository Alfresco models and the set maintained in
 * SOLR. The diff can represent a new, changed or removed Alfresco model. For a new model the
...
public class AlfrescoModelDiff {
    ...
    /**
     * use full model name or it will be converted to the prefix form - as we are requesting the
     * model it may not be on the other side - so the namespace is unknown.
     *
