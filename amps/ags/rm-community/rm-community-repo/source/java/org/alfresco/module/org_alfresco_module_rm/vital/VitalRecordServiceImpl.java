...
public class VitalRecordServiceImpl
  ...
  public void setupVitalRecordDefinition(NodeRef nodeRef) {
    ...
    Period currentReviewPeriod = (Period) nodeService.getProperty(
      nodeRef,
      PROP_REVIEW_PERIOD
    );
    if (
      currentReviewPeriod == null || PERIOD_NONE.equals(currentReviewPeriod)
    ) {
      ...
      if (
        ...
        if (
          kind.equals(FilePlanComponentKind.RECORD_CATEGORY) ||
