...
{
    public VersionSeriesCheckedOutByProperty(ServiceRegistry serviceRegistry, CMISFacade cmisFacade)
    {
        super(serviceRegistry, cmisFacade, PropertyIds.VERSION_SERIES_CHECKED_OUT_BY);
    }
