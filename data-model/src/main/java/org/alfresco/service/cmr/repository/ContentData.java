...
public class ContentData implements Serializable {
  ...
  public static ContentData createContentProperty(String contentPropertyStr) {
    ...
    ContentData property = new ContentData(
      contentUrl,
      mimetype,
      size,
      encoding,
  ...
  public boolean equals(Object obj) {
    if (obj == this) return true; else if (obj == null) return false; else if (
      !(obj instanceof ContentData)
    ) return false;
