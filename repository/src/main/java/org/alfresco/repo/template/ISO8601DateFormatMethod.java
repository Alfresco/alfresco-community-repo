 ...
 *        xmldate(String date)
 */
public class ISO8601DateFormatMethod
  ...
  public Object exec(List args) throws TemplateModelException {
    ...
    if (args.size() == 1) {
      ...
      if (arg0 instanceof TemplateDateModel) {
        result =
          ISO8601DateFormat.format(((TemplateDateModel) arg0).getAsDate());
      } else if (arg0 instanceof TemplateScalarModel) {
        result =
          ISO8601DateFormat.parse(((TemplateScalarModel) arg0).getAsString());
      }
    }
