...
public class AclCrudDAOTest extends TestCase {
  ...
  private AclChangeSet getAclChangeSet(final long aclChangeSetId)
    throws Exception {
  ...
  private void updateAuth(final String before, final String after)
    throws Exception {
    RetryingTransactionCallback<Void> callback = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
  ...
  private Permission createPermission(
    final PermissionReference permissionReference
  ) throws Exception {
  ...
  public void testCreateAndDeletePermission() throws Exception {
    ...
    final SimplePermissionReference permRef = SimplePermissionReference.getPermissionReference(
      QName.createQName("cm:cmobject"),
      name
    );
