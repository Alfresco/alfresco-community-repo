...
/**
 * Set of tests that ensure GET REST APIs are run successfully in a read-only transaction
 * (ALF-10179).
 *
...
public class ReadOnlyTransactionInGetRestApiTest extends BaseWebScriptTest {
    ...
    private static final String URL_GET_SITE_FORUM_POSTS =
            "/api/forum/site/" + TEST_SITE_NAME + "/discussions/posts";
    private static final String URL_GET_SITE_BLOG = "/api/blog/site/" + TEST_SITE_NAME + "/blog";
    private static final String URL_GET_SITE_LINKS =
            "/api/links/site/" + TEST_SITE_NAME + "/links?page=1&pageSize=10";
    private static final String URL_GET_SITE_LINK =
            "/api/links/link/site/" + TEST_SITE_NAME + "/links/123456789";
    private static final String URL_GET_SITE_TAGS =
            "/api/tagscopes/site/" + TEST_SITE_NAME + "/tags";
