 ...
 *
 * <p>nodes Specifies which node to transfer
 *
 * <p>isSync specifies whether the list of nodes is to be sync'ed. If sync then the transfer
 * machinery can determine by the absence of a node or association in the transfer that the missing
 * nodes should be deleted on the destination. Else with a non sync transfer then the archive node
 * ref is required to remote a node on the destination.
 */
public class TransferDefinition implements Serializable {
     ...
     * machinery can determine by the absence of a node or association in the transfer that the
     * missing nodes should be deleted on the destination. Else with a non sync transfer then the
     * archive node ref is required to remote a node on the destination.
     */
    private boolean isSync = false;

    /**
     * isReadOnly specifies whether the transferred nodes should be editable on the destination
     * system.
     */
     ...
     * nodes should be deleted on the destination. Else with a non sync transfer then the archive
     * node ref is required to remote a node on the destination.
     *
