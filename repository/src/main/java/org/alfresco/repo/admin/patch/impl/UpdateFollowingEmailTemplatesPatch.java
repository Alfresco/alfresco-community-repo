 ...
 */
public class UpdateFollowingEmailTemplatesPatch
  extends GenericEMailTemplateUpdatePatch {

  private Repository repository;

  protected static final String[] LOCALES = new String[] {
    "de",
    "es",
    "fr",
    "it",
  ...
  protected NodeRef getBaseTemplate() {
    ...
    if (refs.size() != 1) {
      throw new AlfrescoRuntimeException(
        I18NUtil.getMessage("patch.updateFollowingEmailTemplatesPatch.error")
      );
    }
    return refs.get(0);
  }
  ...
  protected String applyInternal() throws Exception {
    ...
    return I18NUtil.getMessage(
      "patch.updateFollowingEmailTemplatesPatch.result"
    );
  }
}
