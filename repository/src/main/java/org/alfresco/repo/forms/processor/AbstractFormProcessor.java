  ...
  public void register() {
    if (this.processorRegistry == null) {
      if (logger.isWarnEnabled()) logger.warn(
        "Property 'processorRegistry' has not been set.  Ignoring auto-registration of processor: " +
        this
      );
    ...
    if (this.matchPattern == null) {
      if (logger.isWarnEnabled()) logger.warn(
        "Property 'matchPattern' has not been set.  Ignoring auto-registration of processor: " +
        this
      );
