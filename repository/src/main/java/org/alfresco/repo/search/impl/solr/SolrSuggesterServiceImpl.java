...
public class SolrSuggesterServiceImpl implements SuggesterService {
  ...
  @Override
  public SuggesterResult getSuggestions(
    ...
    try {
      ...
      String term = suggesterParameters.isTermIsCaseSensitive()
        ? suggesterParameters.getTerm()
        : suggesterParameters.getTerm().toLowerCase();
      ...
      JSONObject response =
        ((SolrQueryHTTPClient) solrQueryHTTPClient).execute(
