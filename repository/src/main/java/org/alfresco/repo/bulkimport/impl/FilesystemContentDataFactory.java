...
public class FilesystemContentDataFactory
  implements ContentDataFactory, InitializingBean {

  private static final Log logger = LogFactory.getLog(
    FilesystemContentDataFactory.class
  );
  ...
  public ContentData createContentData(ContentStore store, File contentFile) {
    try {
      String rootLocation = new File(store.getRootLocation())
        .getCanonicalPath();
      ...
      String relativeFilePath = contentLocation.substring(
        rootLocation.length() + File.separator.length()
      );
