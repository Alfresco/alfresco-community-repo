...
public class RMv22DODModelSeparationModulePatch extends AbstractModulePatch
    ...
    public void applyInternal() {
        if (!convertToStandardFilePlan) {
            ...
            long recordCount =
                    patchDAO.getCountNodesWithAspects(Collections.singleton(ASPECT_RECORD));
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug(
                        "   ... updating " + recordCount + " records in batches of " + BATCH_SIZE);
            }
