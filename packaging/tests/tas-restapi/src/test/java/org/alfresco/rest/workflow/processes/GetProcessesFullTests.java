...
public class GetProcessesFullTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        task2 =
                dataWorkflow
                        ...
                        .usingSite(siteModel)
                        .usingResource(document)
                        .createNewTaskAndAssignTo(adminUser);
        process3 =
                dataWorkflow
                        .usingUser(userWhoStartsTask)
                        .usingSite(siteModel)
    ...
    public void getProcessesWithSkipCountParameter() throws Exception {
        RestProcessModelsCollection processes =
                restClient.authenticateUser(userWhoStartsTask).withWorkflowAPI().getProcesses();
    ...
    public void getProcessesWithPropertiesParameter() throws Exception {
        ...
        processes
                ...
                .and()
                .entriesListContains("id", process3.getId())
                .and()
                .entriesListContains("id", task2.getProcessId())
                .and()
                .entriesListContains("id", task1.getProcessId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user cannot get processes when using an invalid orderBy parameter")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
    ...
    public void getProcessesWithInvalidOrderByParameter() throws Exception {
        ...
        restClient
                ...
                .containsErrorKey(
                        String.format(
                                RestErrorModel.INVALID_ORDERBY,
                                "test",
                                "processDefinitionId, startUserId, startActivityId,startedAt, id,"
                                        + " completed, processDefinitionKey"))
                .containsSummary(
                        String.format(
                                RestErrorModel.INVALID_ORDERBY,
                                "test",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user cannot get processes when using an invalid parameter in where"
                            + " clause")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getProcessesWithInvalidWhereParameter() throws Exception {
        restClient
                .authenticateUser(userWhoStartsTask)
                .where("startUserIdd='" + userWhoStartsTask.getUsername() + "'")
                .withWorkflowAPI()
                .getProcesses();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.PROPERTY_IS_NOT_SUPPORTED_EQUALS,
                                "startUserIdd",
                                userWhoStartsTask.getUsername()))
                .stackTraceIs(RestErrorModel.STACKTRACE)
                .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user cannot get processes when using an invalid where clause"
                            + " expression")
    @Test(
            groups = {
                TestGroup.REST_API,
    ...
    public void getProcessesWithInvalidWhereClauseExpression() throws Exception {
        restClient
                .authenticateUser(userWhoStartsTask)
                .where("startUserId AND '" + userWhoStartsTask.getUsername() + "'")
                .withWorkflowAPI()
                .getProcesses();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                ...
                .containsSummary(
                        String.format(
                                ...
                                "(startUserId AND '" + userWhoStartsTask.getUsername() + "')"))
                .stackTraceIs(RestErrorModel.STACKTRACE)
                .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER);
    }
}
