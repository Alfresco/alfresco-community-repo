 ...
 * CRUD operations for:
 *
 * <p><b>alf_access_control_list</b> <b>alf_acl_member</b> <b>alf_acl_change_set</b>
 * <b>alf_access_control_entry</b> <b>alf_permission</b> <b>alf_authority</b> <b/> Also, following
 * are currently unused:<b/> <b/> <b>alf_ace_context</b> <b>alf_authority_alias</b>
 *
 * @author janv
 * @since 3.4
 */
public abstract class AbstractAclCrudDAOImpl implements AclCrudDAO {
    ...
    public void setAclEntityCache(TransactionalCache<Serializable, Object> aclEntityCache) {
        this.aclEntityCache =
                new EntityLookupCache<Long, AclEntity, Serializable>(
                        aclEntityCache, CACHE_REGION_ACL, aclEntityDaoCallback);
    ...
    public void setAuthorityEntityCache(SimpleCache<Serializable, Object> authorityEntityCache) {
        this.authorityEntityCache =
                new EntityLookupCache<Long, AuthorityEntity, String>(
                        authorityEntityCache, CACHE_REGION_AUTHORITY, authorityEntityDaoCallback);
    }
    ...
    public AbstractAclCrudDAOImpl() {
        ...
        this.aclEntityCache =
                new EntityLookupCache<Long, AclEntity, Serializable>(aclEntityDaoCallback);

        this.authorityEntityDaoCallback = new AuthorityEntityCallbackDAO();
        this.authorityEntityCache =
                new EntityLookupCache<Long, AuthorityEntity, String>(authorityEntityDaoCallback);
    ...
    public Ace createAce(
            Permission permission, Authority authority, ACEType type, AccessStatus accessStatus) {
    ...
    public Permission createPermission(PermissionReference permissionReference) {
        ...
        if (qnamePair != null) {
            ...
            Pair<Long, PermissionEntity> entityPair =
                    permissionEntityCache.getOrCreateByValue(entity);
    ...
    private PermissionEntity getPermissionImpl(PermissionReference permissionReference) {
        ...
        if (qnamePair != null) {
            ...
            PermissionEntity permission =
                    new PermissionEntity(qnameId, permissionReference.getName());
    ...
    public void renamePermission(
            QName oldTypeQName, String oldName, QName newTypeQName, String newName) {
        ...
        SimplePermissionReference oldPermRef =
                SimplePermissionReference.getPermissionReference(oldTypeQName, oldName);
    ...
    private class PermissionEntityCallbackDAO
            implements EntityLookupCallbackDAO<Long, PermissionEntity, PermissionEntity> {
