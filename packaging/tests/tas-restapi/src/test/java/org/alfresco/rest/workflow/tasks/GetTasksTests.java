...
public class GetTasksTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user gets all existing tasks with Rest API and response is"
                            + " successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify asignee user gets its existing tasks with Rest API and response is"
                            + " successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify candidate user that claims the task gets its existing tasks with Rest"
                            + " API and response is successfull (200)")
    @Bug(id = "MNT-16967")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify candidate user without claim gets no tasks with Rest API and response"
                            + " is successfull (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that orderBy parameter is applied and supports only one parameter.")
    @Test(groups = {TestGroup.REST_API, TestGroup.WORKFLOW, TestGroup.TASKS, TestGroup.REGRESSION})
