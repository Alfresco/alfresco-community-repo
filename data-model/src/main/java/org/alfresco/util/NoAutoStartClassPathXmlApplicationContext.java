...
/**
 * A wrapper around {@link ClassPathXmlApplicationContext} which stops Alfresco Subsystem
 * (abstractPropertyBackedBean based) beans from being AutoStarted by tweaking their property
 * definitions. You shouldn't do this in production, but it can be handy with unit tests, as it
 * allows a quicker startup by preventing subsystems from starting up
 *
 * @author Nick Burch
 */
public class NoAutoStartClassPathXmlApplicationContext extends ClassPathXmlApplicationContext {
    ...
    /**
     * Does the work of disabling the autostart of the Subsystem (abstractPropertyBackedBean) beans
    ...
    protected static class NoAutoStartBeanDefinitionDocumentReader
        ...
        protected BeanDefinitionParserDelegate createDelegate(
            ...
            BeanDefinitionParserDelegate delegate =
                    new NoAutoStartBeanDefinitionParserDelegate(readerContext);
            delegate.initDefaults(root);
            return delegate;
        }
    }

    protected static class NoAutoStartBeanDefinitionParserDelegate
        ...
        public void parsePropertyElement(Element ele, BeanDefinition bd) {
            ...
            if ("autoStart".equals(propertyName)) {
                if ("abstractPropertyBackedBean".equals(bd.getParentName())) {
                    String id =
                            ele.getParentNode().getAttributes().getNamedItem("id").getTextContent();
