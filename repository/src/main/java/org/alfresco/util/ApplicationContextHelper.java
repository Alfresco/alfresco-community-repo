 ...
 *
 * <p><strong>Deprecated.</strong> It is better to use Spring annotations to define the application
 * context to use in tests, see {@code org.alfresco.util.BaseSpringTest}
 *
 * @author Derek Hulley
 */
@Deprecated
public class ApplicationContextHelper extends BaseApplicationContextHelper {
    ...
    /**
     * Provides a static, single instance of the default Alfresco application context. This method
    ...
    /**
     * Provides a static, single instance of an application context represented by the given array
     * of config locations. This method can be called repeatedly.
     *
     * <p>If the configuration requested differs from one used previously, then the
     * previously-created context is shut down.
     *
