...
/**
 * Provides a base set of tests of the various {@link
 * org.alfresco.service.cmr.repository.NodeService} implementations.
 *
 * <p>To test a specific incarnation of the service, the method {@link #getNodeService()} must be
 * implemented.
 *
 * @see #nodeService
 * @see #rootNodeRef
...
public abstract class BaseNodeServiceTest extends BaseSpringTest {
    ...
    public static final QName TYPE_QNAME_TEST_MANY_PROPERTIES =
            QName.createQName(NAMESPACE, "many-properties");
    public static final QName TYPE_QNAME_TEST_MAFullNodeServiceTestNY_PROPERTIES_ENCRYPTED =
            QName.createQName(NAMESPACE, "many-properties-encrypted");
    public static final QName TYPE_QNAME_TEST_MANY_ML_PROPERTIES =
            QName.createQName(NAMESPACE, "many-ml-properties");
    public static final QName TYPE_QNAME_EXTENDED_CONTENT =
            QName.createQName(NAMESPACE, "extendedcontent");
    ...
    public static final QName ASPECT_QNAME_MANDATORY =
            QName.createQName(NAMESPACE, "mandatoryaspect");
    public static final QName ASPECT_QNAME_WITH_DEFAULT_VALUE =
            QName.createQName(NAMESPACE, "withDefaultValue");
    public static final QName PROP_QNAME_TEST_TITLE = QName.createQName(NAMESPACE, "title");
    public static final QName PROP_QNAME_TEST_DESCRIPTION =
            QName.createQName(NAMESPACE, "description");
    public static final QName PROP_QNAME_TEST_CONTENT = QName.createQName(NAMESPACE, "content");
    public static final QName PROP_QNAME_BOOLEAN_VALUE =
            QName.createQName(NAMESPACE, "booleanValue");
    public static final QName PROP_QNAME_INTEGER_VALUE =
            QName.createQName(NAMESPACE, "integerValue");
    ...
    public static final QName PROP_QNAME_ML_TEXT_VALUE =
            QName.createQName(NAMESPACE, "mlTextValue");
    public static final QName PROP_QNAME_DATE_VALUE = QName.createQName(NAMESPACE, "dateValue");
    public static final QName PROP_QNAME_SERIALIZABLE_VALUE =
            QName.createQName(NAMESPACE, "serializableValue");
    public static final QName PROP_QNAME_NODEREF_VALUE =
            QName.createQName(NAMESPACE, "nodeRefValue");
    public static final QName PROP_QNAME_QNAME_VALUE = QName.createQName(NAMESPACE, "qnameValue");
    public static final QName PROP_QNAME_CONTENT_VALUE =
            QName.createQName(NAMESPACE, "contentValue");
    public static final QName PROP_QNAME_PATH_VALUE = QName.createQName(NAMESPACE, "pathValue");
    public static final QName PROP_QNAME_CATEGORY_VALUE =
            QName.createQName(NAMESPACE, "categoryValue");
    ...
    public static final QName PROP_QNAME_MULTI_ML_VALUE =
            QName.createQName(NAMESPACE, "multiMLValue");
    ...
    public static final QName PROP_QNAME_RESIDUAL_STRING =
            QName.createQName(NAMESPACE, "residualString");
    public static final QName PROP_QNAME_RESIDUAL_LONG =
            QName.createQName(NAMESPACE, "residualLong");

    public static final QName ASPECT_WITH_ASSOCIATIONS =
            QName.createQName(NAMESPACE, "withAssociations");
    public static final QName ASSOC_ASPECT_CHILD_ASSOC =
            QName.createQName(NAMESPACE, "aspect-child-assoc");
    public static final QName ASSOC_ASPECT_NORMAL_ASSOC =
            QName.createQName(NAMESPACE, "aspect-normal-assoc");

    public static final QName ASPECT_WITH_ASSOCIATIONS_EXTRA =
            QName.createQName(NAMESPACE, "withAssociationsExtra");
    public static final QName ASSOC_ASPECT_CHILD_ASSOC_01 =
            QName.createQName(NAMESPACE, "aspect-child-assoc-01");
    public static final QName ASSOC_ASPECT_CHILD_ASSOC_02 =
            QName.createQName(NAMESPACE, "aspect-child-assoc-02");
    public static final QName ASSOC_ASPECT_NORMAL_ASSOC_01 =
            QName.createQName(NAMESPACE, "aspect-normal-assoc-01");
    public static final QName ASSOC_ASPECT_NORMAL_ASSOC_02 =
            QName.createQName(NAMESPACE, "aspect-normal-assoc-02");

    public static final QName TYPE_QNAME_TEST_MULTIPLE_TESTER =
            QName.createQName(NAMESPACE, "multiple-tester");
    public static final QName PROP_QNAME_STRING_PROP_SINGLE =
            QName.createQName(NAMESPACE, "stringprop-single");
    public static final QName PROP_QNAME_STRING_PROP_MULTIPLE =
            QName.createQName(NAMESPACE, "stringprop-multiple");
    public static final QName PROP_QNAME_ANY_PROP_SINGLE =
            QName.createQName(NAMESPACE, "anyprop-single");
    public static final QName PROP_QNAME_ANY_PROP_MULTIPLE =
            QName.createQName(NAMESPACE, "anyprop-multiple");

    public static final QName ASPECT_WITH_ENCRYPTED = QName.createQName(NAMESPACE, "withEncrypted");
    public static final QName PROP_QNAME_ENCRYPTED_VALUE =
            QName.createQName(NAMESPACE, "encryptedValue");
    ...
    public void before() {
        ...
        StoreRef catStoreRef =
                nodeService.createStore(
                        StoreRef.PROTOCOL_WORKSPACE, "Test_cat_" + System.currentTimeMillis());
        ...
        cat =
                nodeService
                        .createNode(
                                ...
                                QName.createQName("{namespace}cat"),
     ...
     *
     * @return Returns the implementation of <code>NodeService</code> to be used for this test. It
     *     must have transaction demarcation.
     */
     ...
     *
     * <ul>
     *   <li>Apart from the root node having the root aspect, node 6 (<b>n6</b>) also has the root
     *       aspect.
     *   <li><b>n3</b> has properties <code>animal = monkey</code> and <code>
     *       reference = <b>n2</b>.toString()</code>.
     *   <li>All nodes are of type {@link ContentModel#TYPE_CONTAINER container} with the exception
     *       of <b>n8</b>, which is of type {@link #TYPE_QNAME_TEST_CONTENT test:content}
     * </ul>
     *
     * <p>The namespace URI for all associations is <b>{@link BaseNodeServiceTest#NAMESPACE}</b>.
     *
     * <p>The naming convention is:
     *
     * <pre>
     * n2_p_n5
     * n4_n5
     ...
     * </pre>
     *
     * <p>The session is flushed to ensure that persistence occurs correctly. It is cleared to
     * ensure that fetches against the created data are correct.
     *
    ...
    public static Map<QName, ChildAssociationRef> buildNodeGraph(
            NodeService nodeService, NodeRef rootNodeRef) throws Exception {
        ...
        assoc =
                nodeService.createNode(
                        n2, ASSOC_TYPE_QNAME_TEST_CHILDREN, qname, ContentModel.TYPE_CONTAINER);
        ret.put(qname, assoc);
        ...
        assoc =
                nodeService.createNode(
                        n3, ASSOC_TYPE_QNAME_TEST_CHILDREN, qname, ContentModel.TYPE_CONTAINER);
        ret.put(qname, assoc);
        NodeRef n6 = assoc.getChildRef();
        nodeService.addAspect(
                n6, ContentModel.ASPECT_ROOT, Collections.<QName, Serializable>emptyMap());
        ...
        assoc =
                nodeService.createNode(
                        n5, ASSOC_TYPE_QNAME_TEST_CHILDREN, qname, ContentModel.TYPE_CONTAINER);
        ret.put(qname, assoc);
    ...
    private StoreRef createStore() throws Exception {
        StoreRef storeRef =
                nodeService.createStore(
                        ...
                        getClass().getName() + "_" + System.nanoTime());
    ...
    public void testDeleteStore() throws Exception {
        ...
        BadOnDeleteNodePolicy policy =
                new BadOnDeleteNodePolicy(nodeService, beforeDeleteNodeRefs, onDeleteNodeRefs);
        policy.setOnDeleteCreateChild(false);
        policy.setBeforeDeleteCreateChild(false);
        policyComponent.bindClassBehaviour(
                OnDeleteNodePolicy.QNAME, policy, new JavaBehaviour(policy, "onDeleteNode"));
        policyComponent.bindClassBehaviour(
        ...
        assertFalse(
                "Deleted store should not present in list of stores", storeRefs.contains(storeRef));
        ...
        assertEquals(
                "Incorrect number of node beforeDelete notifications",
                1,
                beforeDeleteNodeRefs.size());
        assertEquals(
                "Incorrect node for beforeDelete callback", nodeRef, beforeDeleteNodeRefs.get(0));
        ...
        try {
            ChildAssociationRef assocRef =
                    nodeService.createNode(
                            ...
                            ASSOC_TYPE_QNAME_TEST_CHILDREN,
                            QName.createQName(
                                    "Recognize that VSEPR theory states that nonbonded electrons"
                                        + " (lone pairs) exert strong electrostatic repulsive"
                                        + " forces against the bonded pairs of electrons and, as a"
                                        + " result, the electron pairs arrange themselves as far"
                                        + " apart as possible in order to minimize the repulsive"
                                        + " forces"),
                            ContentModel.TYPE_CONTAINER);
    ...
    /**
     * Fills the given property map with some values according to the property definitions on the
     * given class
     */
    protected void fillProperties(QName qname, Map<QName, Serializable> properties) {
        ...
        for (Map.Entry<QName, PropertyDefinition> entry : propertyDefs.entrySet()) {
            ...
            } else if (propertyTypeQName.equals(DataTypeDefinition.CATEGORY)
                    || propertyTypeQName.equals(DataTypeDefinition.NODE_REF)) {
    ...
    /**
     * Checks that aspects can be added, removed and queried. Failure to detect inadequate
     * properties is also checked.
     */
    @Test
    public void testAspects() throws Exception {
        ...
        assertEquals(
                "Aspect properties not added", propertiesBefore.size() + 2, propertiesAfter.size());

        // check that we know that the aspect is present
        Set<QName> aspects = nodeService.getAspects(nodeRef);
        assertTrue(
                "Titled aspect not present",
        ...
        assertEquals(
                "Aspect properties not removed", propertiesBefore.size(), propertiesAfter.size());
    }
    ...
    public void testAspectsAddedAutomatically() throws Exception {
        ...
        assertTrue(
                "Aspect not automatically added during 'createNode'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_QNAME_TEST_TITLED));
        ...
        assertFalse(
                "test:titled properties not removed",
        ...
        assertTrue(
                "Aspect not automatically added during 'setProperties'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_QNAME_TEST_TITLED));
        ...
        assertTrue(
                "Aspect not automatically added during 'addProperties'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_QNAME_TEST_TITLED));

        // Remove the aspect and test using setProperty
        nodeService.removeAspect(nodeRef, BaseNodeServiceTest.ASPECT_QNAME_TEST_TITLED);
        nodeService.setProperty(
                nodeRef, BaseNodeServiceTest.PROP_QNAME_TEST_DESCRIPTION, "A description");
        assertTrue(
                "Aspect not automatically added during 'setProperty'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_QNAME_TEST_TITLED));

        // Check that aspects with further mandatory aspects are added properly
        nodeService.setProperty(
                nodeRef, BaseNodeServiceTest.PROP_QNAME_MARKER_PROP, "Marker value");
        assertTrue(
                "Aspect not automatically added during 'setProperty'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_QNAME_TEST_MARKER));
        assertTrue(
                "Aspect not automatically added during 'setProperty' (second-level)",
        ...
        NodeRef childNodeRef =
                nodeService
                        ...
                        .getChildRef();
        assertTrue(
                "Aspect not automatically added by child association during 'createNode'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_WITH_ASSOCIATIONS));
        assertFalse(
                "Unexpected 'aspect' added by child association during 'createNode'",
        ...
        nodeService.createAssociation(
                nodeRef, rootNodeRef, BaseNodeServiceTest.ASSOC_ASPECT_NORMAL_ASSOC);
        assertTrue(
                "Aspect not automatically added by peer association during 'createAssociation'",
                nodeService.hasAspect(nodeRef, BaseNodeServiceTest.ASPECT_WITH_ASSOCIATIONS));
        assertFalse(
                "Unexpected aspect added by peer association during 'createAssociation'",
    ...
    public void testAspectRemoval() throws Exception {
        ...
        NodeRef sourceNodeRef =
                nodeService
                        .createNode(
                                ...
                                ASSOC_TYPE_QNAME_TEST_CHILDREN,
                                QName.createQName(
                                        BaseNodeServiceTest.NAMESPACE, "testAspectRemoval-source"),
                                ContentModel.TYPE_CONTAINER)
                        .getChildRef();
        ...
        NodeRef targetNodeRef =
                nodeService
                        .createNode(
                                ...
                                ASSOC_TYPE_QNAME_TEST_CHILDREN,
                                QName.createQName(
                                        BaseNodeServiceTest.NAMESPACE, "testAspectRemoval-target"),
                                ContentModel.TYPE_CONTAINER)
                        .getChildRef();
        ...
        assertEquals(
                "Expected exactly one child", 1, nodeService.getChildAssocs(sourceNodeRef).size());
        assertEquals(
                "Expected exactly one target",
                1,
                nodeService.getTargetAssocs(sourceNodeRef, RegexQNamePattern.MATCH_ALL).size());
        ...
        assertEquals(
                "Expected exactly zero child", 0, nodeService.getChildAssocs(sourceNodeRef).size());
        assertEquals(
                "Expected exactly zero target",
                0,
                nodeService.getTargetAssocs(sourceNodeRef, RegexQNamePattern.MATCH_ALL).size());

        // Force different cleanup queries:
        //    ALF-5308: SQL error when changing name for record / folder with dispostion schedule
        // applied
     ...
     *
     * <p>Needs to be committed for good measure
     */
    @Commit
    @Test
    public void testAspectRemovalCascadeDelete() throws Exception {
        ...
        NodeRef sourceNodeRef =
                nodeService
                        .createNode(
                                ...
                                ASSOC_TYPE_QNAME_TEST_CHILDREN,
                                QName.createQName(
                                        BaseNodeServiceTest.NAMESPACE,
                                        "testAspectRemovalCascadeDelete"),
                                ContentModel.TYPE_CONTAINER)
                        .getChildRef();

        // Add the aspect to the source node and add a child using an association defined on the
        // aspect
        nodeService.addAspect(sourceNodeRef, ASPECT_WITH_ASSOCIATIONS, null);
        NodeRef targetNodeRef =
                nodeService
        ...
        // Now remove the aspect from the source node and check that the target node was
        // cascade-deleted
        nodeService.removeAspect(sourceNodeRef, ASPECT_WITH_ASSOCIATIONS);
        assertFalse("Child node must have been cascade-deleted", nodeService.exists(targetNodeRef));
    }

    private static final QName ASPECT_QNAME_TEST_RENDERED =
            QName.createQName(NAMESPACE, "rendered");
    private static final QName ASSOC_TYPE_QNAME_TEST_RENDITION =
            QName.createQName(NAMESPACE, "rendition-page");
    private static final QName TYPE_QNAME_TEST_RENDITION_PAGE =
            QName.createQName(NAMESPACE, "rendition-page");
    private static final QName PROP_QNAME_TEST_RENDITION_PAGE_CONTENT =
            QName.createQName(NAMESPACE, "rendition-page-content");
    ...
    public void testAspectWithChildAssociationsCreationAndRetrieval() throws Exception {
        ...
        NodeRef folderNodeRef =
                nodeService
                        .createNode(
                                ...
                                ContentModel.ASSOC_CHILDREN,
                                QName.createQName(
                                        BaseNodeServiceTest.NAMESPACE, "UserX-" + GUID.generate()),
        ...
        // This loop is where you will, outside of the transaction, push the page content into the
        // repo
        for (int i = 0; i < 100; i++) {
            ContentData contentData =
                    new ContentData(null, MimetypeMap.MIMETYPE_PDF, 10245, "UTF-8");
        ...
        for (int i = 0; i < 100; i++) {
            ...
            ContentWriter writer =
                    contentService.getWriter(nodeRef, PROP_QNAME_TEST_RENDITION_PAGE_CONTENT, true);
        ...
        List<ChildAssociationRef> fetchedRenditionChildAssocs =
                nodeService.getChildAssocs(
                        fileNodeRef, ASSOC_TYPE_QNAME_TEST_RENDITION, RegexQNamePattern.MATCH_ALL);
        assertEquals(
        ...
        List<ChildAssociationRef> fetchedRenditionChildAssocsPage5 =
                nodeService.getChildAssocs(
                        fileNodeRef, ASSOC_TYPE_QNAME_TEST_RENDITION, page5QName);
        assertEquals("Expected exactly one result", 1, fetchedRenditionChildAssocsPage5.size());
        assertEquals(
                "Targeted page retrieval was not correct",
                page5QName,
    ...
    private static QName makePageAssocName(int pageNumber) {
        if (pageNumber > MAX_RENDITION_PAGES) {
            throw new IllegalArgumentException(
                    "Rendition page number may not exceed " + MAX_RENDITION_PAGES);
        }
    ...
    public void testCascadeDelete() throws Exception {
        ...
        NodeRef n3Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_p_n3"))
                        .getChildRef();
        NodeRef n4Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n2_p_n4"))
                        .getChildRef();
        NodeRef n6Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n3_p_n6"))
                        .getChildRef();
        NodeRef n7Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n5_p_n7"))
                        .getChildRef();
        NodeRef n8Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n6_p_n8"))
                        .getChildRef();
        ...
        assertEquals(
                "n6 primary parent association not present on n3", 1, countChildrenOfNode(n3Ref));
        assertEquals(
                "n6 secondary parent association not present on n4", 1, countChildrenOfNode(n4Ref));
        assertEquals(
                "n8 secondary parent association not present on n7", 1, countChildrenOfNode(n7Ref));
        ...
        assertEquals(
                "n6 primary parent association not removed from n3", 0, countChildrenOfNode(n3Ref));
        assertEquals(
                "n6 secondary parent association not removed from n4",
                0,
                countChildrenOfNode(n4Ref));
        assertEquals(
                "n8 secondary parent association not removed from n7",
                0,
                countChildrenOfNode(n7Ref));
    }
    ...
    public void testDelete() throws Exception {
        ...
        BadOnDeleteNodePolicy nasty =
                new BadOnDeleteNodePolicy(nodeService, beforeDeleteNodeRefs, deletedNodeRefs);
        ...
        NodeRef n1Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n1"))
                        .getChildRef();
        NodeRef n3Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_p_n3"))
    ...
    /**
     * This test is similar to the test above but onDelete does nasty stuff such as creating
     * siblings of the soon to be deleted children.
     *
     * <p>In particular, it verifies that we don't get stuck in an infinite loop.
     */
    @Test
    ...
    /**
     * This test is similar to the test above but beforeDelete does nasty stuff such as creating
     * children of the soon to be deleted children.
     *
     * <p>In particular, it verifies that we don't get stuck in an infinite loop.
     */
    @Test
    ...
    public void testRemoveSpecificChild() throws Exception {
        ChildAssociationRef pathPrimaryRef =
                nodeService.createNode(
                        rootNodeRef,
                        ASSOC_TYPE_QNAME_TEST_CHILDREN,
        ...
        ChildAssociationRef pathARef =
                nodeService.createNode(
                        parentRef,
                        ASSOC_TYPE_QNAME_TEST_CHILDREN,
                        QName.createQName("pathA"),
                        ContentModel.TYPE_CONTAINER);
        ChildAssociationRef pathBRef =
                nodeService.addChild(
                        parentRef,
                        pathARef.getChildRef(),
                        ASSOC_TYPE_QNAME_TEST_CHILDREN,
                        QName.createQName("pathB"));
        ChildAssociationRef pathCRef =
                nodeService.addChild(
                        parentRef,
                        pathARef.getChildRef(),
                        ASSOC_TYPE_QNAME_TEST_CHILDREN,
    ...
    public void testRemoveChildPolicyFires() throws Exception {
        ...
        assertEquals(
                "The BeforeDeleteChildAssociationPolicy must fire on"
                        + " removeSecondaryChildAssociation",
                pathBRef,
                beforeDeletePolicy.childRef);

        removed = nodeService.removeChildAssociation(pathCRef);
        assertTrue("Association was removed", removed);
        assertEquals(
                "The BeforeDeleteChildAssociationPolicy must fire on removeChildAssociation",
                pathCRef,
                beforeDeletePolicy.childRef);
    }
    ...
    public void testRemoveChildByRef() throws Exception {
        ...
        AssociationRef pathDRef =
                nodeService.createAssociation(parentRef, childARef, ASSOC_TYPE_QNAME_TEST_NEXT);
        ...
        assertEquals(
                "Child assocs not removed",
                0,
                nodeService
                        .getChildAssocs(
                                parentRef,
                                ASSOC_TYPE_QNAME_TEST_CHILDREN,
                                new RegexQNamePattern(".*", "path*"))
                        .size());
        assertEquals(
                "Node assoc not removed",
                0,
                nodeService.getTargetAssocs(parentRef, RegexQNamePattern.MATCH_ALL).size());
    }
    ...
    public void testProperties() throws Exception {
        ...
        assertEquals(
                "Name property to set to ID of node",
                nodeRef.getId(),
                checkMap.get(ContentModel.PROP_NAME));
        ...
        assertEquals(
                "Enum property not retrieved", TestEnum.TEST_ONE, checkMap.get(qnameProperty4));
    ...
    public void testAddProperties() throws Exception {
        ...
        assertNull(
                "Expected null property",
                nodeService.getProperty(rootNodeRef, PROP_QNAME_TEST_TITLE));
        assertNull(
                "Expected null property",
                nodeService.getProperty(rootNodeRef, PROP_QNAME_TEST_DESCRIPTION));
    ...
    public void testDefaultPropertyOverride_AddAspect() throws Exception {
        ...
        Map<QName, Serializable> properties =
                Collections.singletonMap(PROP_QNAME_PROP2, (Serializable) valueOverride);
    ...
    public void testDefaultPropertyOverride_CreateNode() throws Exception {
        ...
        String valueOverride = "VALUE_OVERRIDE";
        Map<QName, Serializable> properties =
                Collections.singletonMap(PROP_QNAME_PROP1, (Serializable) valueOverride);
        nodeRef =
                nodeService
                        .createNode(
                                rootNodeRef,
    ...
    /**
     * Makes a read-only transaction and then looks for a property using a non-existent QName. The
     * QName persistence must not lazily create QNameEntity instances for queries.
     */
    @Test
    public void testGetUnknownProperty() throws Exception {
        ...
        RetryingTransactionCallback<NodeRef> createCallback =
        ...
        final NodeRef nodeRef =
                retryingTransactionHelper.doInTransaction(createCallback, false, true);

        RetryingTransactionCallback<Object> testCallback =
    ...
    public void testEncryptionAndDecryptionOfProperties() {
        ...
        Serializable encryptedProperty =
                metadataEncryptor.encrypt(PROP_QNAME_ENCRYPTED_VALUE, valueToEncrypt);
        assertTrue("Not a SealedObject", encryptedProperty instanceof SealedObject);
        Serializable encryptedPropertyAgain =
                metadataEncryptor.encrypt(PROP_QNAME_ENCRYPTED_VALUE, encryptedProperty);
        assertTrue("Re-encryption not expected", encryptedProperty == encryptedPropertyAgain);
        Serializable decryptedProperty =
                metadataEncryptor.decrypt(PROP_QNAME_ENCRYPTED_VALUE, encryptedProperty);
        ...
        assertTrue(
                "Not a SealedObject",
                encryptedProperties.get(PROP_QNAME_ENCRYPTED_VALUE) instanceof SealedObject);
        assertTrue(
                "Should not encrypt",
                encryptedProperties.get(PROP_QNAME_QNAME_VALUE) instanceof QName);
        Map<QName, Serializable> encryptedPropertiesAgain =
                metadataEncryptor.encrypt(encryptedProperties);
        assertTrue("Map should not change", encryptedProperties == encryptedPropertiesAgain);
        assertTrue(
                "Re-encryption not expected",
                encryptedProperties.get(PROP_QNAME_ENCRYPTED_VALUE)
                        == encryptedPropertiesAgain.get(PROP_QNAME_ENCRYPTED_VALUE));
        assertTrue(
                "Should not encrypt",
                encryptedProperties.get(PROP_QNAME_QNAME_VALUE) instanceof QName);
        Map<QName, Serializable> decryptedProperties =
                metadataEncryptor.decrypt(encryptedProperties);
        assertEquals(
                "Values not decrypted correctly",
                valueToEncrypt,
                decryptedProperties.get(PROP_QNAME_ENCRYPTED_VALUE));
        assertEquals(
                "Values not decrypted correctly",
                value,
                decryptedProperties.get(PROP_QNAME_QNAME_VALUE));
        ...
        Map<QName, Serializable> encryptedPropertiesNull =
                metadataEncryptor.encrypt(propertiesNull);
        ...
        Map<QName, Serializable> decryptedPropertiesNull =
    ...
    public void testEncryptedProperties() throws Exception {
        ...
        RetryingTransactionCallback<Void> setNullPropCallback =
        ...
        try {
            RetryingTransactionCallback<Void> setUnencryptedPropCallback =
                    new RetryingTransactionCallback<Void>() {
                        @Override
                        public Void execute() throws Throwable {
                            nodeService.setProperty(
                                    nodeRef, PROP_QNAME_ENCRYPTED_VALUE, "No encrypted");
                            return null;
                        }
                    };
    ...
    public void testMultiProp() throws Exception {
        ...
        TestTransaction.start();
        try {
            // this should fail as we are passing multiple values into a non-any that is
            // multiple=false
        ...
        try {
            ...
            List<Serializable> checkValues =
                    (List<Serializable>)
                            nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_ML_VALUE);
            ...
            // We put ArrayLists and HashSets into the Collection of d:any, so that is exactly what
            // should come out
            values.clear();
            ...
            checkValues =
                    (List<Serializable>)
                            nodeService.getProperty(nodeRef, PROP_QNAME_ANY_PROP_MULTIPLE);
            assertEquals("Expected 2 Collection values back", 2, checkValues.size());
            assertTrue(
                    "Incorrect type in collection",
                    checkValues.get(0) instanceof ArrayList); // ArrayList in - ArrayList out
            assertTrue(
                    "Incorrect type in collection",
                    checkValues.get(1) instanceof HashSet); // HashSet in - HashSet out

            // Check that multi-valued d:any properties can be collections of collections (with
            // values)
            // We put ArrayLists and HashSets into the Collection of d:any, so that is exactly what
            // should come out
            ...
            assertEquals(
                    "Second collection incorrect", 2, ((Collection) checkValues.get(1)).size());
        } catch (DictionaryException e) {
            // expected
        } finally {
            TestTransaction.flagForRollback();
    ...
    private void checkProperties(
            Map<QName, Serializable> checkProperties, Map<QName, Serializable> expectedProperties) {
    ...
    public void testPropertyTypes() throws Exception {
        ...
        pathProperty
                .append(new Path.SelfElement())
                .append(new Path.AttributeElement(TYPE_QNAME_TEST_CONTENT));
        ...
        properties.put(PROP_QNAME_STRING_VALUE, "123.0");
        properties.put(
                PROP_QNAME_ML_TEXT_VALUE, new MLText("This is ML text in the default language"));
        properties.put(PROP_QNAME_DATE_VALUE, new Date());
        properties.put(PROP_QNAME_SERIALIZABLE_VALUE, "456");
        properties.put(PROP_QNAME_NODEREF_VALUE, rootNodeRef);
        properties.put(PROP_QNAME_PATH_VALUE, pathProperty);
        ...
        assertTrue(
                "Collection doesn't contain value",
                ((Collection<?>) checkProperty).contains("GHI"));
    ...
    public void testPropertyLocaleBehaviour() throws Exception {
        ...
        I18NUtil.setLocale(Locale.US);
        nodeService.setProperty(
                nodeRef, PROP_QNAME_DATE_VALUE, properties.get(PROP_QNAME_DATE_VALUE));
    ...
    public void testEmptyCollections() throws Exception {
        ...
        List<String> checkFilledCollection =
                (List<String>) nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_VALUE);
        assertEquals(
                "Filled collection didn't come back with correct values",
                filledCollection,
                checkFilledCollection);

        nodeService.setProperty(nodeRef, PROP_QNAME_MULTI_VALUE, (Serializable) emptyCollection);
        List<String> checkEmptyCollection =
                (List<String>) nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_VALUE);
        assertEquals(
                "Empty collection didn't come back with correct values",
                emptyCollection,
        ...
        List<String> checkNullCollection =
                (List<String>) nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_VALUE);
    ...
    public void testBigCollections() throws Exception {
        ...
        for (int inc = 0; inc < 5; inc++) {
            ...
            nodeService.setProperty(
                    nodeRef, PROP_QNAME_MULTI_VALUE, (Serializable) largeCollection);
            double tDelta = (double) (System.nanoTime() - t1) / 1E6;
            System.out.println(
                    "Setting " + collectionSize + " multi-valued property took: " + tDelta + "ms");
            // Now get it back
            t1 = System.nanoTime();
            List<String> checkLargeCollection =
                    (List<String>) nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_VALUE);
            tDelta = (double) (System.nanoTime() - t1) / 1E6;
            System.out.println(
                    "First fetch of "
                            + collectionSize
                            + " multi-valued property took: "
                            + tDelta
                            + "ms");
            assertEquals(
                    "Large collection didn't come back with correct values",
                    largeCollection,
                    checkLargeCollection);
            ...
            nodeService.setProperty(
                    nodeRef, PROP_QNAME_MULTI_VALUE, (Serializable) emptyCollection);
            List<String> checkEmptyCollection =
                    (List<String>) nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_VALUE);
            assertEquals(
                    "Empty collection didn't come back with correct values",
    ...
    public void testMultiValueMLTextProperties() throws Exception {
        ...
        nodeService.setProperty(
                nodeRef, PROP_QNAME_MULTI_ML_VALUE, (Serializable) mlTextCollection);
        Collection<MLText> mlTextCollectionCheck =
                (Collection<MLText>) nodeService.getProperty(nodeRef, PROP_QNAME_MULTI_ML_VALUE);
        assertEquals(
                "MLText collection didn't come back correctly.",
                mlTextCollection,
    ...
    public void testGetReferencableProperties() throws Exception {
        ...
        Serializable wsProtocol =
                nodeService.getProperty(rootNodeRef, ContentModel.PROP_STORE_PROTOCOL);
        Serializable wsIdentifier =
                nodeService.getProperty(rootNodeRef, ContentModel.PROP_STORE_IDENTIFIER);
        ...
        assertEquals(
                "Workspace Protocol property incorrect",
                rootNodeRef.getStoreRef().getProtocol(),
                wsProtocol);
        assertEquals(
                "Workspace Identifier property incorrect",
                rootNodeRef.getStoreRef().getIdentifier(),
                wsIdentifier);
        ...
        Map<QName, Serializable> properties = nodeService.getProperties(rootNodeRef);
        assertTrue(
                "Workspace Protocol property not present in map",
                properties.containsKey(ContentModel.PROP_STORE_PROTOCOL));
        assertTrue(
                "Workspace Identifier property not present in map",
                properties.containsKey(ContentModel.PROP_STORE_IDENTIFIER));
        assertTrue(
                "Node UUID property not present in map",
                properties.containsKey(ContentModel.PROP_NODE_UUID));
        assertTrue(
                "Node DB ID property not present in map",
                properties.containsKey(ContentModel.PROP_NODE_DBID));
    }
    ...
    public void testReferencePropertySet() throws Exception {
        ...
        Serializable nodeDbIdCheck =
                nodeService.getProperty(rootNodeRef, ContentModel.PROP_NODE_DBID);
    ...
    public void testResidual() throws Exception {
        ...
        //        assertTrue("Expect residual aspect to be present.",
        // nodeService.hasAspect(rootNodeRef, ASPECT_RESIDUAL));
    }

    @Test
    public void testGetParentAssocs() throws Exception {
        Map<QName, ChildAssociationRef> assocRefs = buildNodeGraph();
        ChildAssociationRef n3pn6Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n3_p_n6"));
        ChildAssociationRef n5pn7Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n5_p_n7"));
        ChildAssociationRef n6pn8Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n6_p_n8"));
        ChildAssociationRef n7n8Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n7_n8"));
        ...
        assertNull(
                "Expected null primary parent for root node", rootNodePrimaryAssoc.getParentRef());

        // get the parent associations based on pattern
        List<ChildAssociationRef> parentAssocRefsByQName =
        ...
        List<ChildAssociationRef> childAssocRefsByTypeQName =
                nodeService.getChildAssocs(
                        n8Ref, ASSOC_TYPE_QNAME_TEST_CHILDREN, RegexQNamePattern.MATCH_ALL);
    }
    ...
    public void testGetChildAssocs() throws Exception {
        ...
        NodeRef n1Ref =
                assocRefs
                        .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n1"))
                        .getChildRef();
        ChildAssociationRef n1pn3Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_p_n3"));
        ChildAssociationRef n1n4Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_n4"));
        ChildAssociationRef n1n8Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_n8"));
        ...
        assertEquals(
                "First child added to n1 was primary to n3: Order of refs is wrong",
                n1pn3Ref,
                childAssocRefs.get(0));
        assertEquals(
                "Second child added to n1 was to n4: Order of refs is wrong",
                n1n4Ref,
                childAssocRefs.get(1));
        ...
        List<ChildAssociationRef> childAssocRefsByQName =
                nodeService.getChildAssocs(
                        n1Ref,
                        RegexQNamePattern.MATCH_ALL,
        ...
        List<ChildAssociationRef> childAssocRefsByTypeQName =
                nodeService.getChildAssocs(
                        n1Ref, ASSOC_TYPE_QNAME_TEST_CHILDREN, RegexQNamePattern.MATCH_ALL);
        ...
        childAssocRefsByTypeQName =
                nodeService.getChildAssocs(
                        ...
                        1,
                        false);
        assertEquals("Incorrect number of children", 1, childAssocRefsByTypeQName.size());
    }
    ...
    public void testDuplicateChildAssocCleanup() throws Exception {
        ...
        List<ChildAssociationRef> dupAssocs =
                nodeService.getChildAssocs(
                        n1pn3Ref.getParentRef(), n1pn3Ref.getTypeQName(), assocQName);
    ...
    public void testGetChildAssocsByChildType() throws Exception {
        ...
        List<ChildAssociationRef> childAssocRefsContainers =
                nodeService.getChildAssocs(
                        n1Ref, Collections.singleton(ContentModel.TYPE_CONTAINER));
        assertEquals(
                "Incorrect number of cm:container children", 2, childAssocRefsContainers.size());
        ...
        // Get N1's container children
        List<ChildAssociationRef> childAssocRefsFiles =
                nodeService.getChildAssocs(
                        n1Ref, Collections.singleton(BaseNodeServiceTest.TYPE_QNAME_TEST_CONTENT));
    ...
    public void testMoveNode() throws Exception {
        Map<QName, ChildAssociationRef> assocRefs = buildNodeGraph();
        ChildAssociationRef n2pn4Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n2_p_n4"));
        ChildAssociationRef n5pn7Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n5_p_n7"));
        ChildAssociationRef n6pn8Ref =
                assocRefs.get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "n6_p_n8"));
        ...
        List<ChildAssociationRef> n6ChildRefs =
                nodeService.getChildAssocs(
                        n6Ref,
                        RegexQNamePattern.MATCH_ALL,
    ...
    private AssociationRef createAssociation(NodeRef sourceRef) throws Exception {
        ...
        AssociationRef assocRef =
                nodeService.createAssociation(sourceRef, targetRef, ASSOC_TYPE_QNAME_TEST_NEXT);
        // done
        return assocRef;
    }
    ...
    public void testCreateAndRemoveAssociation() throws Exception {
        ...
        AssociationRef anotherAssocRef =
                nodeService.createAssociation(
                        sourceRef, anotherTargetRef, ASSOC_TYPE_QNAME_TEST_NEXT);
        ...
        List<AssociationRef> assocs =
                nodeService.getTargetAssocs(sourceRef, ASSOC_TYPE_QNAME_TEST_NEXT);
        for (AssociationRef assoc : assocs) {
            nodeService.removeAssociation(
                    assoc.getSourceRef(), assoc.getTargetRef(), assoc.getTypeQName());
        }
    }
    ...
    public void testTargetAssoc_Ordering() throws Exception {
        ...
        Comparator<AssociationRef> descendingId =
                new Comparator<AssociationRef>() {
                    @Override
    ...
    /**
     * Tests get target associations by property value. See <b>MNT-14504</b> for more details.
     *
     * @throws Exception
     */
    @Test
    public void testGetTargetAssocsByPropertyValue() throws Exception {
        ...
        List<AssociationRef> targetAssocs =
                nodeService.getTargetAssocsByPropertyValue(sourceRef, qname, null, null);
        ...
        for (QName propertyQName : checkProperties.keySet()) {
            ...
            targetAssocs =
                    nodeService.getTargetAssocsByPropertyValue(
                            sourceRef, qname, propertyQName, propertyValue);
            assertEquals("Incorrect number of targets", 1, targetAssocs.size());
            assertTrue("Target not found", targetAssocs.contains(assocRef));
            ...
            assertEquals(
                    ...
                    propertyValue,
                    this.nodeService.getProperty(targetRefFound, propertyQName));
        }
        ...
        try {
            targetAssocs =
                    nodeService.getTargetAssocsByPropertyValue(
                            sourceRef, qname, ContentModel.PROP_NODE_DBID, "Fail");
        ...
        try {
            Serializable title =
                    (String) nodeService.getProperty(sourceRef, ContentModel.PROP_TITLE);
            targetAssocs =
                    nodeService.getTargetAssocsByPropertyValue(
                            sourceRef, qname, ContentModel.PROP_NAME, title);
    ...
    public void testGetPaths() throws Exception {
        ...
        for (Path path : paths) {
            ...
            for (Path.Element element : path) {
                assertTrue(
                        "Path element of incorrect type",
                        element instanceof Path.ChildAssocElement);
        ...
        try {
            nodeService.addChild(
                    n6Ref, n1Ref, ASSOC_TYPE_QNAME_TEST_CHILDREN, QName.createQName("n6_n1"));
    ...
    private void reportFlushPerformance(
        ...
        System.out.println(
                "   total bytes: "
                        + diffBytes / 1024D / 1024D
                        + " MB \n"
                        + "   average: "
                        + (double) diffBytes / testCount / 1024D
                        + " kb/graph");
    ...
    public void testDuplicateCatch() throws Exception {
        ...
        ChildAssociationRef pathBDuplicateRef =
                nodeService.createNode(
                        parentRef,
                        ASSOC_TYPE_QNAME_TEST_CONTAINS,
                        QName.createQName("pathB"),
        ...
        ChildAssociationRef pathAbcRef =
                nodeService.createNode(
                        parentRef,
                        ASSOC_TYPE_QNAME_TEST_CONTAINS,
        ...
        try {
            ...
            props.put(ContentModel.PROP_NAME, "abc");
            ChildAssociationRef pathAbcDuplicateRef =
                    nodeService.createNode(
                            parentRef,
                            ASSOC_TYPE_QNAME_TEST_CONTAINS,
    ...
    /**
     * Create some nodes that have the same <b>cm:name</b> but use associations that don't enforce
     * uniqueness.
     */
    @Test
    public void testNonDuplicateAssocsWithSuppliedName() throws Throwable {
        Map<QName, Serializable> properties =
                Collections.singletonMap(
                        ContentModel.PROP_NAME, (Serializable) getClass().getName());
        NodeRef parentRef =
                nodeService
                        .createNode(
                                rootNodeRef,
    ...
    /**
     * Create some nodes that have the no <b>cm:name</b> and use associations that enforce
     * uniqueness.
     *
     * <p>ALF-5001: cm:name uniqueness check can fail if the property is not set
     */
    @Test
    ...
    public void testGetByName() throws Exception {
        ...
        ChildAssociationRef pathDefRef =
                nodeService.createNode(
                        abcRef,
                        ASSOC_TYPE_QNAME_TEST_CONTAINS,
        ...
        ChildAssociationRef pathKlmRef =
                nodeService.createNode(
                        abcRef,
                        ASSOC_TYPE_QNAME_TEST_CONTAINS,
        ...
        NodeRef checkAbcRef =
                nodeService.getChildByName(parentRef, ASSOC_TYPE_QNAME_TEST_CONTAINS, "abc");
        assertNotNull("Second level, named node 'ABC' not found", checkAbcRef);
        assertEquals(abcRef, checkAbcRef);
        NodeRef checkDefRef =
                nodeService.getChildByName(checkAbcRef, ASSOC_TYPE_QNAME_TEST_CONTAINS, "def");
        ...
        NodeRef checkHijRef =
                nodeService.getChildByName(checkAbcRef, ASSOC_TYPE_QNAME_TEST_CONTAINS, "hij");
        ...
        List<ChildAssociationRef> childAssocRefs =
                nodeService.getChildrenByName(
                        checkAbcRef, ASSOC_TYPE_QNAME_TEST_CONTAINS, namesList);
    ...
    public void testLocalizedAspect() throws Exception {
        nodeService.addAspect(
                ...
                Collections.<QName, Serializable>singletonMap(
                        ContentModel.PROP_LOCALE, Locale.CANADA_FRENCH));
        // commit to check
    }
    ...
    public void testAR1303() throws Exception {
        PolicyComponent policyComponent =
                (PolicyComponent) this.applicationContext.getBean("policyComponent");
    ...
    public void onUpdateProperties(
        ...
        assertFalse(
                "Should not be equal:\nbefore: "
                        + before.get(ContentModel.PROP_TITLE)
                        + "\nafter: "
                        + after.get(ContentModel.PROP_TITLE),
                String.valueOf(before.get(ContentModel.PROP_TITLE))
                        .equals(String.valueOf(after.get(ContentModel.PROP_TITLE))));
    }
