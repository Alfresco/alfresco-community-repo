...
public class VersionSeriesCheckedOutIdProperty extends AbstractProperty {
     ...
     */
    public VersionSeriesCheckedOutIdProperty(
            ServiceRegistry serviceRegistry, CMISConnector connector) {
    ...
    public Serializable getValueInternal(CMISNodeInfo nodeInfo) {
        ...
        return connector.constructObjectId(
                nodeInfo.getCurrentNodeId(), CMISConnector.PWC_VERSION_LABEL);
    }
}
