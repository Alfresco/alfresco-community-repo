...
/**
 * Class containing behaviour for the multilingual empty translation aspect. An empty translation is
 * a document's properties translation. This kind of node doesn't have a content.
 *
 * <p>{@link ContentModel#ASPECT_MULTILINGUAL_EMPTY_TRANSLATION ml empty document aspect}
 *
...
public class EmptyTranslationAspect
    ...
    /**
     * Extends the NO-OP copy behaviour to generate an exception if copied. In other words, the
     * presence of {@link ContentModel#ASPECT_MULTILINGUAL_EMPTY_TRANSLATION} should prevent a node
     * from being copied; if this is not done by the copy client, it is enforced here.
     *
     * @author Derek Hulley
     * @since 3.2
     */
    private static class EmptyTranslationAspectCopyBehaviourCallback
        ...
        private static final CopyBehaviourCallback INSTANCE =
                new EmptyTranslationAspectCopyBehaviourCallback();
