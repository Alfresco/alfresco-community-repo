...
public class LockServiceImplTest extends BaseSpringTest {
    ...
    private class LockServicePoliciesImpl
            implements LockServicePolicies.BeforeLock, LockServicePolicies.BeforeUnlock {
        @Override
    ...
    public void before() throws Exception {
        ...
        this.nodeService.addAspect(
                this.parentNode, ContentModel.ASPECT_LOCKABLE, new HashMap<QName, Serializable>());
        ...
        this.childNode1 =
                this.nodeService
                        ...
                        .getChildRef();
        this.nodeService.addAspect(
                this.childNode1, ContentModel.ASPECT_LOCKABLE, new HashMap<QName, Serializable>());
        ...
        this.childNode2 =
                this.nodeService
                        ...
                        .getChildRef();
        this.nodeService.addAspect(
                this.childNode2, ContentModel.ASPECT_LOCKABLE, new HashMap<QName, Serializable>());
        ...
        TestWithUserUtils.createUser(
                GOOD_USER_NAME, PWD, rootNodeRef, this.nodeService, this.authenticationService);
        TestWithUserUtils.createUser(
                BAD_USER_NAME, PWD, rootNodeRef, this.nodeService, this.authenticationService);

        this.permissionService.setPermission(
                rootNodeRef, GOOD_USER_NAME, PermissionService.ALL_PERMISSIONS, true);
        this.permissionService.setPermission(
                rootNodeRef, BAD_USER_NAME, PermissionService.CHECK_OUT, true);
        this.permissionService.setPermission(
                rootNodeRef, BAD_USER_NAME, PermissionService.WRITE, true);
        this.permissionService.setPermission(
                rootNodeRef, BAD_USER_NAME, PermissionService.READ, true);

        // Stash the user node ref's for later use
        TestWithUserUtils.authenticateUser(
                BAD_USER_NAME, PWD, rootNodeRef, this.authenticationService);
        TestWithUserUtils.authenticateUser(
                GOOD_USER_NAME, PWD, rootNodeRef, this.authenticationService);
    }
    ...
    public void testLock() {
        ...
        try {
            this.lockService.lock(this.parentNode, LockType.WRITE_LOCK);
            fail(
                    "The user should not be able to lock the node since it is already locked by"
                            + " another user.");
    ...
    public void testPersistentLockMayStoreAdditionalInfo() {
        lockService.lock(
                noAspectNode, LockType.NODE_LOCK, 0, Lifetime.PERSISTENT, "additional info");
    ...
    public void testEphemeralLock() {
        ...
        // Lock the node
        lockService.lock(
                noAspectNode, LockType.WRITE_LOCK, 86400, Lifetime.EPHEMERAL, "some extra data");
    ...
    public void testEphemeralLockIndexing() {
        ...
        IndexerAndSearcher indexerAndSearcher =
                (IndexerAndSearcher) applicationContext.getBean("indexerAndSearcherFactory");
        ...
        final String query =
                String.format(
                        "+@cm\\:lockOwner:\"%s\" +@cm\\:lockType:\"WRITE_LOCK\"", GOOD_USER_NAME);
    ...
    /**
     * Test that covers MNT-17612 - having an expired ephemeral lock and a persistent one on the
     * same node.
     */
    ...
    public void testLockRevertedOnRollback() throws NotSupportedException, SystemException {
        ...
        // Sometime later, a refresh occurs (so this should not be reverted to unlocked, but to this
        // state)
    ...
    public void testGetLockStatus() {
        ...
        // is necessary to ensure the work has been implemented correctly (despite being an odd
        // test)
        LockStore lockStore = (LockStore) applicationContext.getBean("lockStore");
        lockStore.clear();
    ...
    private void checkLifetimeForExpiry(
            Lifetime expectedLifetime, int expirySecs, Lifetime requestedLifetime) {
        ...
        // Check that for any timeouts we test, a request for a persistent lock always yields a
        // persistent lock.
        lockService.unlock(parentNode);
        assertNotEquals(LockStatus.LOCKED, lockService.getLockStatus(parentNode));
    ...
    /**
     * Unit test to validate the behaviour of creating children of locked nodes. No lock - can
     * create children READ_ONLY_LOCK - can't create children WRITE_LOCK - owner can create children
     * non owner can't create children NODE_LOCK non owner can create children owner can create
     * children
     */
