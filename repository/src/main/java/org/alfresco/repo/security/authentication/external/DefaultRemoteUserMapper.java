...
public class DefaultRemoteUserMapper
  ...
  public void setProxyUserName(String proxyUserName) {
    this.proxyUserName =
      proxyUserName == null || proxyUserName.length() == 0
        ? null
        : proxyUserName;
  }
  ...
  public void setProxyHeader(String proxyHeader) {
    this.proxyHeader =
      proxyHeader == null || proxyHeader.length() == 0 ? null : proxyHeader;
  }
  ...
  public String getRemoteUser(HttpServletRequest request) {
    ...
    if (this.proxyUserName == null) {
      ...
      String normalizedUserId = normalizeUserId(
        headerUserId != null ? headerUserId : remoteUserId
      );
      ...
      if (
        request.getScheme().toLowerCase().equals("https") &&
        certs != null &&
        certs.length > 0
      ) {
        if (logger.isTraceEnabled()) {
        ...
        for (int i = 0; i < certs.length; i++) {
          ...
          if (subjectDN.equals(this.proxyUserName)) {
            if (logger.isTraceEnabled()) {
              logger.trace(
                "The subject DN " + subjectDN + " matches " + this.proxyUserName
              );
            }
  ...
  private String extractUserFromProxyHeader(HttpServletRequest request) {
    ...
    try {
      if (userId != null && isEncode) {
        ...
        userId != null &&
        !org.apache.commons.codec.binary.Base64.isBase64(userId)
      ) {
