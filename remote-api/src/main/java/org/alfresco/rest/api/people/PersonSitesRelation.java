...
public class PersonSitesRelation
  ...
  public CollectionWithPagingInfo<MemberOfSite> readAll(
    String personId,
  ...
  @Override
  @WebApiDescription(
    title = "Site membership information for 'personId' in 'siteId'."
  )
  public MemberOfSite readById(
    String personId,
    String siteId,
    Parameters parameters
  ) {
