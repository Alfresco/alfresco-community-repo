...
public class TaskVariablesRelation
  implements
    RelationshipResourceAction.Read<TaskVariable>,
  ...
  public CollectionWithPagingInfo<TaskVariable> readAll(
    String taskId,
  ...
  @Override
  @WebApiDescription(
    title = "Update Task Variable",
    description = "Update a task variable"
  )
  public TaskVariable update(
    String taskId,
    TaskVariable entity,
    Parameters parameters
  ) {
  ...
  @WebApiDescription(
    ...
    description = "Delete a task variable"
  )
  public void delete(
