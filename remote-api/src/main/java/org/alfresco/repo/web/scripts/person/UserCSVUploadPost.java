...
public class UserCSVUploadPost extends DeclarativeWebScript
{
    ...
    /**
     * Builds user objects based on the supplied data. If a row is empty, then the child String array should be empty too. (Needs to be present so that the line number reporting works)
     */
