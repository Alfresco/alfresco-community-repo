...
public class LoadTester extends TestCase {
    ...
    // DH: Do not assume the presence of any specific user or password.  Create a new user for the
    // test.
    ...
    public void setUp() throws Exception {
        ...
        AlfrescoImapFolder folder =
                imapService.getOrCreateMailbox(user, TEST_FOLDER_NAME, false, true);
    ...
    public void testList() {
        ...
        long t = System.currentTimeMillis();
        List<AlfrescoImapFolder> list =
                imapService.listMailboxes(user, TEST_FOLDER_NAME + "*", false);
        t = System.currentTimeMillis() - t;
