...
public class DownloadsEntityResource
  ...
  @WebApiDescription(
    ...
    description = "Create a download node whose content will be a zip which is being created asynchronously.",
    successStatus = HttpServletResponse.SC_ACCEPTED
  )
  @WebApiParam(
    name = "entity",
    title = "Download request",
    description = "Download request which contains the node ids for the zip elements.",
  ...
  @Override
  @WebApiDescription(
    title = "Get download information",
    description = "Get information about the progress of the zip creation."
  )
  @WebApiParam(name = "nodeId", title = "Download nodeId")
  public Download readById(String nodeId, Parameters parameters)
  ...
  @WebApiDescription(
    ...
    description = "Stop the zip creation if still in progress.",
    successStatus = HttpServletResponse.SC_ACCEPTED
  )
  @Override
