...
public class RuleServiceIntegrationTest {
    ...
    public static void setupTest() throws Exception {
        ...
        TRANSACTION_HELPER =
                SERVICE_REGISTRY.getTransactionService().getRetryingTransactionHelper();
    ...
    /**
     * Test that inherited rules with inverted actions behave correctly. Specifically that the
     * VERSIONABLE aspect is correctly removed after being adding by an inherited parent rule.
     */
    @Test
    public void testInheritedInvertedRule() throws Exception {
        TRANSACTION_HELPER.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        org.alfresco.service.cmr.rule.Rule parentRule =
                        ...
                        org.alfresco.service.cmr.rule.Rule childRule =
                                new org.alfresco.service.cmr.rule.Rule();
                        ...
                        Action action2 =
                                ACTION_SERVICE.createAction(RemoveFeaturesActionExecuter.NAME);
                        action2.setParameterValue(
                                RemoveFeaturesActionExecuter.PARAM_ASPECT_NAME,
                                ContentModel.ASPECT_VERSIONABLE);
        ...
        // Aspect is removed
        assertTrue(
                "Versionable Aspect was not removed",
                !NODE_SERVICE.hasAspect(childContent, ContentModel.ASPECT_VERSIONABLE));
    }

    /**
     * ALF-18488 Rules: Send Email action is not working Tests deletion of node triggers outbound
     * rule and fires the MailAction
     */
    @Test
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        mailAction.setParameterValue(
                                MailActionExecuter.PARAM_FROM, "some.body@example.com");
                        mailAction.setParameterValue(
                                MailActionExecuter.PARAM_TO, "some.bodyelse@example.com");
    ...
    private void addContentToNode(NodeRef nodeRef) {
        ContentWriter contentWriter =
                CONTENT_SERVICE.getWriter(nodeRef, ContentModel.PROP_CONTENT, true);
