...
/**
 * Represents a single cache operation type's statistics. For example, the cummalative time spent
 * performing a cache's remove operation and the number of times that the remove was performed.
 *
