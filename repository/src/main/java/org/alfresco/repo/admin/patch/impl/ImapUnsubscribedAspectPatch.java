...
public class ImapUnsubscribedAspectPatch extends AbstractPatch {
    private static final String MSG_NONSUBSCRIBED_ASPECT_REMOVED =
            "patch.imapUnsubscribedAspect.result.removed";
    private static final QName ASPECT_NON_SUBSCRIBED =
            QName.createQName("{http://www.alfresco.org/model/imap/1.0}nonSubscribed");
    ...
    protected String applyInternal() throws Exception {
        final List<ChildAssociationRef> users =
        ...
        BatchProcessWorkProvider<NodeRef> workProvider =
                new BatchProcessWorkProvider<NodeRef>() {
                    ...
                    public Collection<NodeRef> getNextWork() {
                        ...
                        while (result.isEmpty() && minSearchNodeId < maxNodeId) {
                            nodeDAO.getNodesWithAspects(
                                    Collections.singleton(ASPECT_NON_SUBSCRIBED),
                                    minSearchNodeId,
                                    minSearchNodeId + count,
        ...
        BatchProcessor<NodeRef> batchProcessor =
                new BatchProcessor<NodeRef>(
        ...
        BatchProcessWorker<NodeRef> worker =
                new BatchProcessWorker<NodeRef>() {
