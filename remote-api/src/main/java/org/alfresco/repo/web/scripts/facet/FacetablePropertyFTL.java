...
public abstract class FacetablePropertyFTL<T> implements Comparable<T> {
  ...
  public static class StandardFacetablePropertyFTL
     ...
     */
    public StandardFacetablePropertyFTL(
    ...
    public int hashCode() {
      ...
      int result = 1;
      result =
        prime * result + ((displayName == null) ? 0 : displayName.hashCode());
      result =
        prime *
        result +
        ((localisedTitle == null) ? 0 : localisedTitle.hashCode());
    ...
    public int compareTo(StandardFacetablePropertyFTL that) {
      final int modelComparison =
        this.propDef.getModel()
          .getName()
          .compareTo(that.propDef.getModel().getName());
      final int classComparison =
        this.propDef.getContainerClass()
          .getName()
  ...
  public static class SyntheticFacetablePropertyFTL
    ...
    public String getShortQname() {
      return (
        containingPropDef.getName().getPrefixString() +
        "." +
    ...
    public int compareTo(SyntheticFacetablePropertyFTL that) {
      final int modelComparison =
        this.containingPropDef.getModel()
          .getName()
          .compareTo(that.containingPropDef.getModel().getName());
      final int classComparison =
        this.containingPropDef.getContainerClass()
          .getName()
          .compareTo(that.containingPropDef.getContainerClass().getName());
      final int propComparison =
        this.containingPropDef.getName()
          .compareTo(that.containingPropDef.getName());
      final int displayNameComparison =
        this.displayName.compareTo(that.displayName);
    ...
    public int hashCode() {
      ...
      result =
        ...
        result +
        (
          (syntheticPropertyName == null) ? 0 : syntheticPropertyName.hashCode()
        );
      return result;
    }
    ...
    public boolean equals(Object obj) {
      ...
      if (containingPropDef == null) {
        ...
        !containingPropDef.equals(other.containingPropDef)
      ) return false;
      if (datatype == null) {
      ...
      if (syntheticPropertyName == null) {
        ...
        !syntheticPropertyName.equals(other.syntheticPropertyName)
      ) return false;
      return true;
    }
  }
  ...
  public static class FacetablePropertyFTLComparator
    ...
    private final List<Class<?>> typeOrder = Arrays.asList(
      new Class<?>[] {
    ...
    public int compare(FacetablePropertyFTL left, FacetablePropertyFTL right) {
      ...
      if (!left.getClass().equals(right.getClass())) {
        return (
          typeOrder.indexOf(left.getClass()) -
