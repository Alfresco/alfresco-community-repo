...
public abstract class ParameterizedItemAbstractBase
   ...
   * Error messages
   */
  private static final String ERR_MAND_PROP =
    "A value for the mandatory parameter {0} has not been set on the rule item {1}";
  ...
  public String toString() {
    ...
    sb
      .append("ParameterizedItem")
      .append("[ title='")
      .append(getTitleKey())
      .append("'")
      .append(", description='")
      .append(getDescriptionKey())
      .append("'")
      .append("]");
    return sb.toString();
  }
   ...
   */
  protected abstract void addParameterDefinitions(
  ...
  protected Map<Locale, List<ParameterDefinition>> getLocalizedParameterDefinitions() {
    ...
    for (Locale locale : locales) {
      ...
      for (ParameterDefinition definition : paramList) {
        String paramDisplayLabel = getParamDisplayLabel(
          definition.getName(),
          locale
        );
        definitions.add(
  ...
  protected String getParamDisplayLabel(String paramName) {
    return I18NUtil.getMessage(
      this.name + "." + paramName + "." + DISPLAY_LABEL
    );
  }
