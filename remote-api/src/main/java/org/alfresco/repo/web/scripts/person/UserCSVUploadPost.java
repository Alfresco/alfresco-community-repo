...
public class UserCSVUploadPost extends DeclarativeWebScript {
    ...
    /**
     * @see
     *     DeclarativeWebScript#executeImpl(org.springframework.extensions.webscripts.WebScriptRequest,
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status) {
        ...
        if (form == null || !form.getIsMultiPart()) {
            throw new ResourceBundleWebScriptException(
                    Status.STATUS_BAD_REQUEST, rb, ERROR_BAD_FORM);
        }
        ...
        if (!processed) {
            throw new ResourceBundleWebScriptException(
                    Status.STATUS_BAD_REQUEST, rb, ERROR_NO_FILE);
        }
    ...
    protected void processUpload(
            InputStream input, String filename, List<Map<QName, String>> users) {
        try {
            ...
            throw new ResourceBundleWebScriptException(
                    Status.STATUS_OK, getResources(), ERROR_CORRUPT_FILE, e);
        }
    }
    ...
    /**
     * Builds user objects based on the supplied data. If a row is empty, then the child String
     * array should be empty too. (Needs to be present so that the line number reporting works)
     */
    ...
    protected static class ResourceBundleWebScriptException extends WebScriptException {
        ...
        public ResourceBundleWebScriptException(
                int status, ResourceBundle rb, String msgId, Object... args) {
