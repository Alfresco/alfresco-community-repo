...
public class ThumbnailServiceImplParameterTest {
  ...
  private RenditionService2Impl mockRenditionService2 = mock(
  ...
  private final NodeRef dummyNodeRef1 = new NodeRef(
    "workspace",
    "dummy",
    "dummyID_1"
  );
  private final NodeRef dummyNodeRef2 = new NodeRef(
    "workspace",
    "dummy",
    "dummyID_2"
  );
  private final NodeRef dummyNodeRef3 = new NodeRef(
    "workspace",
    "dummy",
    "dummyID_3"
  );
  ...
  public void initMockObjects() {
    ...
    when(mockRenditionService2.isCreatedByRenditionService2(any(), any()))
      .thenReturn(false);
  ...
  public void createThumbnailPassesParametersToActionService() {
    ...
    resizeOptions.setHeight(
      (Integer) parametersUnderTest.get(
        ImageRenderingEngine.PARAM_RESIZE_HEIGHT
      )
    );
    ...
    resizeOptions.setMaintainAspectRatio(
      (Boolean) parametersUnderTest.get(
        ImageRenderingEngine.PARAM_MAINTAIN_ASPECT_RATIO
      )
    );
    ...
    ThumbnailParentAssociationDetails assocDetails = new ThumbnailParentAssociationDetails(
      dummyNodeRef3,
    ...
    for (String s : parametersUnderTest.keySet()) {
      if (
        parameters.keySet().contains(s) == false ||
