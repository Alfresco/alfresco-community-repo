...
public class NodeRating
  implements Serializable, Comparable<NodeRating>, ExpectedComparison {
  ...
  public String toString() {
    return (
      "NodeRating [ratingScheme=" + ratingScheme + ", ratedAt=" + ratedAt + "]"
    );
  }

  public static NodeRating parseNodeRating(
    String nodeId,
    ...
    Aggregate aggregate = new Aggregate(
      numRatings != null ? numRatings.intValue() : null,
      average != null ? average.floatValue() : null
    );
    NodeRating nodeRating = new NodeRating(
      nodeId,
      ratingScheme,
      ratedAt,
      myRating,
  ...
  public static ListResponse<NodeRating> parseNodeRatings(
    String nodeId,
    JSONObject jsonObject
  ) {
    ...
    ListResponse<NodeRating> resp = new ListResponse<NodeRating>(
      paging,
      nodeRatings
    );
    return resp;
  ...
  public static class Aggregate implements ExpectedComparison {
    ...
    public boolean equals(Object obj) {
      ...
      if (average == null) {
        if (other.average != null) return false;
      } else if (!average.equals(other.average)) return false;
      if (numberOfRatings == null) {
        if (other.numberOfRatings != null) return false;
      } else if (!numberOfRatings.equals(other.numberOfRatings)) return false;
      return true;
    }
  }
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((ratingScheme == null) ? 0 : ratingScheme.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (ratingScheme == null) {
      if (other.ratingScheme != null) return false;
    } else if (!ratingScheme.equals(other.ratingScheme)) return false;
    return true;
  }
