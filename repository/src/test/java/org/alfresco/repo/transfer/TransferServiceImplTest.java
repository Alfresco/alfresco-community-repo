...
public class TransferServiceImplTest extends BaseAlfrescoSpringTest
{
    ...
    public void testALF6565() throws Exception
    {
        ...
        for (TransferTarget target : targets)
        {
            if (target.getName().equals(nameA))
                ++targetACount;
            if (target.getName().equals(nameB))
                ++targetBCount;
        }
     ...
     * 
     * Step 1: Create a new node (No content) transfer
     * 
     * Step 2: Update Node title property transfer
     * 
     * Step 3: Update Content property (add content) transfer
     * 
     * Step 4: Transfer again transfer (Should transfer but not request the content item)
     * 
     * Step 5: Update Content property (update content)
     * 
     * Step 6: Delete the node
     * 
     * Step 7: Negative test : transfer no nodes transfer (should throw exception)
     * 
     * Step 8: Negative test : transfer to a disabled transfer target transfer (should throw exception)
     * 
    ...
    public void testTransferOneNode() throws Exception
    {
        ...
        /**
         * Step 4: Now transfer nothing - content items do not need to be transferred since its already on the destination.
         */
        ...
        /**
         * Step 7: Negative test : transfer to a disabled transfer target transfer (should throw exception)
         */
        logger.debug("Transfer again - with no content - should throw exception");
        try
        {
     ...
     * 
     * Step 1. Move by changing the parent's node ref.
     * 
     * This is a unit test so it does some shenanigans to send to the same instance of alfresco.
     */
    @Test
    public void testMoveNode() throws Exception
    {
        ...
        /**
         * Step 1: Move a node through transfer Move the destination node transfer (Should transfer the destination node back)
         */
    ...
    public void testManyNodes() throws Exception
    {
        ...
        RetryingTransactionCallback<TestContext> setupCB = new RetryingTransactionCallback<TestContext>() {
            ...
            public TestContext execute() throws Throwable
            {
                ...
                /**
                 * Create a tree ManyNodesRoot AC (Content Node) A (Folder) --AA --AB (Folder) ----ABA (Folder) -------- 100+ nodes ----ABB ----ABC B
                 */
     ...
     * 
     * Step 1: Create a new parent node and child node transfer
     * 
     * Step 2: Delete the parent node transfer
     * 
     * Step 3: Create new parent child node with same names and assocs. transfer
     * 
     * This is a unit test so it does some shenanigans to send to the same instance of alfresco.
     */
    @Test
...
////                System.out.println("dest=" + dest);
     ...
     * 
     * Step 1 : Create 2 nodes Add a peer assoc Transfer
     * 
     * Step 2: Add another peer assoc Transfer
     * 
     * Step 3: Remove a peer assoc Transfer
     * 
     * Step 4: Remove a peer assoc Transfer
     * 
     * @throws Exception
     */
    @Test
     ...
     * 
     * Step 1: Create a new node with a tag transfer
     * 
     * Step 2: Add another tag transfer
     * 
     * Step 3: Delete a tag transfer
     * 
     * Step 4: Add a category transfer
     * 
     * Step 5: Add another category this one deep transfer
     * 
     * Step 6: Delete a category transfer
     * 
     * This is a unit test so it does some shenanigans to send to the same instance of alfresco.
     */
