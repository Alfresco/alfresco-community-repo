...
/**
 * Abstract class that implements {@link HomeFolderProvider2} which works with the {@link
 * PortableHomeFolderManager} (which performs most of the work) to create home folders in custom
 * locations.
 *
 * @author Alan Davis
 */
public abstract class AbstractHomeFolderProvider2
        implements HomeFolderProvider2, BeanNameAware, InitializingBean {
    /** The provider name */
    private String name;
