...
public interface RenditionService extends RenditionDefinitionPersister {
   ...
   */
  @NotAuditable
  RenditionDefinition createRenditionDefinition(
    QName renditionName,
   ...
   */
  @NotAuditable
  CompositeRenditionDefinition createCompositeRenditionDefinition(
    QName renditionName
  );
   ...
   */
  @NotAuditable
  boolean usingRenditionService2(
