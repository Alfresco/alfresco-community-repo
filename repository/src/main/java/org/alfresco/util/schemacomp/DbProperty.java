...
/**
 * A pointer to a specific DbObject property and its value (at time of creating the DbProperty
 * object).
 *
 * @author Matt Ward
 */
public class DbProperty {
     ...
     * colours[3]), whether the current value of the property should be retrieved automatically or
     * whether to use the supplied value (useful when performing comparisons - construct one with a
     * particular/expected value and construct another with the current value by reflection).
     *
     * <p>The public constructors provide a more usable API with select sets of arguments.
     *
    ...
    protected DbProperty(
        ...
        // Unfortunetely, this boolean is required, since we may want to set the property value to
        // null.
        if (useSuppliedValue) {
            ...
            try {
                ...
                throw new IllegalArgumentException(
                        "Cannot get value for property named \"" + propertyName + "\"", error);
            }
        } else {
    ...
    /**
     * Create a DbProperty by supplying the DbObject and the property name. The value at time of
     * creation will be populate automatically.
     *
     * @param dbObject DbObject
     * @param propertyName String
     */
    ...
    /**
     * Create a DbProperty with an indexed value, e.g. for propertyName "myCollection" and index 4,
     * the propertyName will be converted to "myCollection[4]" and the propertValue will be
     * populated with the value at index 4 of myCollection.
     *
     * @param dbObject DbObject
     * @param propertyName String
     * @param index int
    ...
    public int hashCode() {
        ...
        result =
                prime * result + ((this.propertyValue == null) ? 0 : this.propertyValue.hashCode());
        return result;
    }
     ...
     * following format:
     *
     * <p>root.child.grandchild[...].property
     *
     * <p>e.g. myschema.person.age.nullable
     *
     * <p>This isn't exactly the same as a FQ database object name, for example the property name
     * could be indexed:
     *
     * <p>e.g. myschema.person.pk_person.columnNames[2]
     *
     * <p>to reflect the third column name in the primary key named "pk_person" on the person table.
     *
     * @return String path
     */
    public String getPath() {
        ...
        for (DbObject pathElement = dbObject;
                pathElement != null;
