...
/**
 * Request info workflow notifier. After the pooled task has been finished the initiator of the
 * workflow will get a task to verify the information. The initiator will also receive an email.
 *
 * @author Tuna Aksoy
 * @since 2.1
 */
