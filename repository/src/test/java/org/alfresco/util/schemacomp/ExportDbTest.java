 ...
 *
 * <p>This test is DBMS specific, if the test is run on a system configured against MySQL for
 * example, it will run MySQL specific tests. If there is no test available for the configured DBMS
 * then the test will pass - this allows addition of new DBMS-specific tests when available.
 *
