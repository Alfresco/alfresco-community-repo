...
public interface PermissionEntry {
     ...
     *
     * <p>This may be null. Null implies that the settings apply to all permissions
     *
    ...
    /**
     * Get the authority to which this entry applies This could be the string value of a username,
     * group, role or any other authority assigned to the authorisation.
     *
     * <p>If null then this applies to all.
     *
     * @return String
     */
     ...
     *
     * <p>This can only be null for a global permission
     *
     * @return NodeRef
     */
