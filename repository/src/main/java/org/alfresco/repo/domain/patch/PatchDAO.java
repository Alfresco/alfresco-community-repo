...
public interface PatchDAO {
    ...
    /**
     * Update all <b>alf_node_properties</b> of 'sizeCurrent' name to have correct persisted type of
     * Long.
     *
     * @return the number of rows affected
     */
    ...
    /**
     * Query for a list of nodes that have a given type and share the same name pattern (SQL LIKE
     * syntax)
     *
     ...
     *
     * <ul>
     *   <li>company_home/sites/surf-config/components
     *   <li>company_home/sites/surf-config/pages
     *   <li>company_home/sites/surf-config/pages/user
     *   <li>company_home/sites/surf-config/pages/user{userId}
     * </ul>
     *
     * @param minNodeId - min node id in the result set - inclusive
     * @param maxNodeId - max node id in the result set - exclusive
