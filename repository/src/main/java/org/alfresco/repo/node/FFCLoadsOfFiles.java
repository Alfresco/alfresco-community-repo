 ...
 *
 * <p><a href="https://issues.alfresco.com/jira/browse/ETWOTWO-744">ETWOTWO-744</a>
 *
 * @author Derek Hulley
 * @author CACEIS
 * @since 2.2SP2
    ...
    public static void doExample(ServiceRegistry serviceRegistry) throws Exception {
        ...
        List<NodeRef> results =
                searchService.selectNodes(
                        rootNodeRef, "/app:company_home", null, namespaceService, false);
        if (results.size() == 0) {
        ...
        results =
                searchService.selectNodes(
                        companyHomeNodeRef, "./cm:LoadTest", null, namespaceService, false);
            ...
            loadTestHome =
                    nodeService
                            .createNode(
                                    ...
                                    QName.createQName(
                                            NamespaceService.CONTENT_MODEL_1_0_URI, "LoadTest"),
