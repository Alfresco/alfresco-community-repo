...
public class ModulePackagesEntityResource
  implements
    EntityResourceAction.Read<ModulePackage>,
  ...
  @Override
  @WebApiDescription(
    title = "Returns ModulePackage information for the given module."
  )
  public ModulePackage readById(String modelName, Parameters parameters)
  ...
  public CollectionWithPagingInfo<ModulePackage> readAll(
