...
public class AuditAppTest extends AbstractSingleNetworkSiteTest {
  ...
  public void setup() throws Exception {
    ...
    auditService =
      applicationContext.getBean("AuditService", AuditService.class);

    AuditModelRegistryImpl auditModelRegistry = (AuditModelRegistryImpl) applicationContext.getBean(
      "auditModel.modelRegistry"
    );

    // Register the test model
    URL testModelUrl = ResourceUtils.getURL(
      "classpath:alfresco/audit/alfresco-audit-access.xml"
    );
  ...
  private void testGetAuditAppsSkipPaging() throws Exception {
    // +ve: check skip count.
    {
      ...
      List<AuditApp> expectedSublist = sublist(
        resp.getList(),
        skipCount,
        maxItems
      );
  ...
  private ListResponse<AuditApp> getAuditApps(
    ...
    final AuditApps auditAppsProxy = publicApiClient.auditApps();
    return auditAppsProxy.getAuditApps(
      createParams(paging),
      errorMessage,
      expectedStatus
    );
  ...
  private ListResponse<AuditApp> getAuditApps(
    ...
    return getAuditApps(
      paging,
      "Failed to get audit applications",
      HttpServletResponse.SC_OK
    );
  }
  ...
  private void validateAuditApplicationFields(
    AuditApp auditApp,
  ...
  private void validateAuditEntryFields(
    ...
    if (auditApp.getId().equals(AUDIT_APP_ID)) {
      assertTrue(
        auditEntry.getAuditApplicationId().toString().equals(auditAppid)
      );
    }
  }
  ...
  private String getFirstAuditAppId() throws PublicApiException {
    ...
    // in the system )
    ListResponse<AuditApp> apps = publicApiClient
      .auditApps()
      .getAuditApps(
        null,
        "Getting audit apps error ",
        HttpServletResponse.SC_OK
      );
  ...
  public void testEnableDisableAuditApplication() throws Exception {
    ...
    assertTrue(
      "Wrong response for request to enable audit app.",
      responseAuditApp.getIsEnabled()
    );
    assertTrue(
  ...
  private void testGetAuditEntries(AuditApps auditAppsProxy, AuditApp auditApp)
    throws Exception {
    // Positive tests
    ListResponse<AuditEntry> auditEntries = auditAppsProxy.getAuditAppEntries(
      auditApp.getId(),
      null,
      HttpServletResponse.SC_OK
    );
    ...
    int AuditEntriesTotalItemsAfterLimit = auditEntries
      .getPaging()
      .getTotalItems();
  ...
  private void testAuditEntriesSorting(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    // paging
    ...
    assertTrue(
      "audit entry size more that 2",
      auditEntries.getList().size() > 1
    );
    assertTrue(
  ...
  private void testAuditEntriesWhereDate(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    // paging
  ...
  private void testAuditEntriesWhereId(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    // paging
  ...
  private void testAuditEntriesWithInclude(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    Paging paging = getPaging(0, 10);
    Map<String, String> otherParams = new HashMap<>();
    ListResponse<AuditEntry> auditEntriesWithoutValues = auditAppsProxy.getAuditAppEntries(
      auditApp.getId(),
      createParams(paging, otherParams),
      HttpServletResponse.SC_OK
    );
    ...
    otherParams.put(
      "include",
      org.alfresco.rest.api.Audit.PARAM_INCLUDE_VALUES
    );
    // list auditEntries with values
    ListResponse<AuditEntry> auditEntriesWithValues = auditAppsProxy.getAuditAppEntries(
      auditApp.getId(),
      createParams(paging, otherParams),
      HttpServletResponse.SC_OK
    );
  ...
  private void testAuditEntriesSkipCount(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    int skipCount = 0;
    ...
    Map<String, String> otherParams = new HashMap<>();
    ListResponse<AuditEntry> resp = auditAppsProxy.getAuditAppEntries(
      auditApp.getId(),
      createParams(paging, otherParams),
      HttpServletResponse.SC_OK
    );
    ...
    ListResponse<AuditEntry> sublistResponse = auditAppsProxy.getAuditAppEntries(
      auditApp.getId(),
      createParams(paging, otherParams),
      HttpServletResponse.SC_OK
    );
    List<AuditEntry> expectedSublist = sublist(
      resp.getList(),
      skipCount,
      maxItems
    );
  ...
  private void testRetrieveAuditEntry(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    int skipCount = 0;
    ...
    //Positive tests
    //200
    AuditEntry entryResp = auditAppsProxy.getAuditEntry(
      auditApp.getId(),
      id,
      null,
      HttpServletResponse.SC_OK
  ...
  private void testDeleteAuditEntry(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    int skipCount = 0;
  ...
  private void testDeleteAuditEntries(
    AuditApps auditAppsProxy,
    AuditApp auditApp
  ) throws Exception {
    int skipCount = 0;
    ...
    String dateBefore = ISO8601DateFormat.format(
      resp.getList().get(0).getCreatedAt()
    );
    String dateAfter = ISO8601DateFormat.format(
    ...
    assertTrue(
      ...
      resp.getList().get(0).getId() > lastDeleteEntryId
    );
  }
  ...
  private String createFolderInPrivateSite(String siteTitle, String folderName)
    throws Exception {
  ...
  public void testAuditEntriesByNodeId() throws Exception {
    ...
    setRequestContext(networkOne.getId(), networkAdmin, DEFAULT_ADMIN_PWD);
    String adminNodeId = createFolderInPrivateSite(
      "testSiteAdmin" + RUNID,
      "testFolderAdmin" + RUNID
    );
    ...
    String nodeId = createFolderInPrivateSite(
      "testSiteUser" + RUNID,
      "testFolderUser1" + RUNID
    );
    ...
    testAuditEntriesWithIncludeByNodeId(
      auditAppsProxy,
      nodeId,
      alfAccessAuditApp
    );
    ...
    testAuditEntriesWhereUserByNodeId(
      auditAppsProxy,
      adminNodeId,
      alfAccessAuditApp
    );
  ...
  private void testAuditEntriesSkipCountByNodeId(
    AuditApps auditAppsProxy,
    String nodeId
  ) throws Exception {
    setRequestContext(user1);
    ...
    ListResponse<AuditEntry> resp = auditAppsProxy.getAuditAppEntriesByNodeRefId(
      nodeId,
      params,
      HttpServletResponse.SC_OK
    );
    ...
    ListResponse<AuditEntry> sublistResponse = auditAppsProxy.getAuditAppEntriesByNodeRefId(
      nodeId,
      params,
      HttpServletResponse.SC_OK
    );
  ...
  private void testAuditEntriesWithIncludeByNodeId(
    ...
    ListResponse<AuditEntry> auditEntriesWithoutValues = auditAppsProxy.getAuditAppEntriesByNodeRefId(
      nodeId,
      params,
      HttpServletResponse.SC_OK
    );
    ...
    params = createParams(paging, otherParams);
    // list auditEntries with values
    ListResponse<AuditEntry> auditEntriesWithValues = auditAppsProxy.getAuditAppEntriesByNodeRefId(
      nodeId,
      params,
      HttpServletResponse.SC_OK
    );
  ...
  private void testAuditEntriesWhereDateByNodeId(
    AuditApps auditAppsProxy,
    String nodeId
  ) throws Exception {
    setRequestContext(user1);
  ...
  private void testAuditEntriesWhereUserByNodeId(
    ...
    params = createParams(paging, otherParams);
    ListResponse<AuditEntry> auditEntries = auditAppsProxy.getAuditAppEntriesByNodeRefId(
      nodeId,
      params,
      HttpServletResponse.SC_OK
    );
  ...
  private void testAuditEntriesSortingByNodeId(
    AuditApps auditAppsProxy,
    String nodeId
  ) throws Exception {
    setRequestContext(user1);
