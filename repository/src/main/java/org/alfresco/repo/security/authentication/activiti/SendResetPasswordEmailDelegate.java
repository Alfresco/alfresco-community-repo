 ...
 *     <p>This {@link JavaDelegate activiti delegate} is executed when a user request password
 *     reset.
...
public class SendResetPasswordEmailDelegate extends AbstractResetPasswordDelegate {
    ...
    private static final String EMAIL_TEMPLATE_PATH =
            "alfresco/templates/reset-password-email-templates/reset-password-email-template.ftl";

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        resetPasswordService.sendResetPasswordEmail(
                execution, EMAIL_TEMPLATE_PATH, EMAIL_SUBJECT_KEY);
    }
}
