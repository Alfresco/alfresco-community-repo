...
/**
 * Used to log relevant changes to transfered files into a summary report of the entire replication job;
 * 
 * It should log: created files, deleted, moved, *modified files and relevant errors while handling the files;
 * 
 * *modified: each implementation would chose the definition of modified(actual content modification/ new version/ some properties updated)
 * 
 */
