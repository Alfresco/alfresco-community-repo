...
public class People
  ...
  public void afterPropertiesSet() throws Exception {
    Map<String, ValueDeriver<TemplateNode, Boolean>> capabilityTesters = new HashMap<String, ValueDeriver<TemplateNode, Boolean>>(
      5
    );
    ...
    this.valueDerivingMapFactory =
      new ValueDerivingMapFactory<TemplateNode, String, Boolean>(
        capabilityTesters
      );
  }
  ...
  public TemplateNode getPerson(String username) {
    ...
    if (personService.personExists(username)) {
      ...
      person =
        new TemplateNode(personRef, services, getTemplateImageResolver());
    }
    return person;
  }
