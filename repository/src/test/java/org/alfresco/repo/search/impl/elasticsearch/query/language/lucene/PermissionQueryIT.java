...
public class PermissionQueryIT extends BasePermissionQueryIT
{
    ...
    public void whenSearchAsUser()
    {
        ...
        assertContainsOnly(AuthenticationUtil.runAs(() -> luceneSearch("taxi"), TEST_USER), myTaxi);
    }
    ...
    public void whenSearchAsUserBelongingsToAGroup()
    {
        ...
        assertContainsOnly(AuthenticationUtil.runAs(() -> luceneSearch("taxi"), USER_WITH_GROUPS), yellowTaxi, taxiYellow);
    }
    ...
    public void whenSearchAsOwner()
    {
        ...
        AuthenticationUtil.runAs(() -> {
            ...
            assertContainsOnly(luceneSearch("taxi"), myTaxi);
            return null;
        }, TEST_USER);
    }
    ...
    public void whenSearchAsAdmin()
    {
        ...
        assertContainsOnly(AuthenticationUtil.runAs(() -> luceneSearch("taxi"), "admin"), yellowTaxi, taxiYellow);
    }
    ...
    public void whenSearchAsSystemUser()
    {
        ...
        assertContainsOnly(AuthenticationUtil.runAsSystem(() -> luceneSearch("taxi")), yellowTaxi, taxiYellow);
    }
