...
public interface RuleModel {
    ...
    static final QName PROP_APPLY_TO_CHILDREN =
            QName.createQName(RULE_MODEL_URI, "applyToChildren");
    static final QName PROP_EXECUTE_ASYNC =
            QName.createQName(RULE_MODEL_URI, "executeAsynchronously");
    ...
    static final QName ASPECT_IGNORE_INHERITED_RULES =
            QName.createQName(RULE_MODEL_URI, "ignoreInheritedRules");
}
