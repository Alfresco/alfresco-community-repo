...
public class GetPeoplePreferencesCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user gets its preferences with invalid maxItems parameter with Rest API"
                            + " and response is 400")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user which doesn't have access to another user preferences fails to get"
                            + " its preferences with Rest API and response is permission denied")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user fails to get preferences for inexistent personId with Rest API and"
                            + " response is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user get preferences for a user with no preferences with Rest API and"
                            + " response is empty")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user fails to get preferences for a removed preference with Rest API"
                            + " and response is 404")
