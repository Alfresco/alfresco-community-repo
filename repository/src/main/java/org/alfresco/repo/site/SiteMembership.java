...
public class SiteMembership extends AbstractSiteMembership {
  ...
  public SiteMembership(
    ...
    if (firstName == null) {
      throw new java.lang.IllegalArgumentException(
        "FirstName required building site membership of " +
        siteInfo.getShortName()
      );
    }
    if (lastName == null) {
      throw new java.lang.IllegalArgumentException(
        "LastName required building site membership of " +
        siteInfo.getShortName()
      );
    }
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((getSiteInfo() == null) ? 0 : getSiteInfo().hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (isMemberOfGroup != other.isMemberOfGroup) return false;

    if (getSiteInfo() == null) {
      if (other.getSiteInfo() != null) return false;
    } else if (!getSiteInfo().equals(other.getSiteInfo())) return false;
    return true;
  }
  ...
  static int compareTo(
    List<Pair<? extends Object, CannedQuerySortDetails.SortOrder>> sortPairs,
    SiteMembership o1,
    SiteMembership o2
  ) {
    ...
    int firstName = SiteMembershipComparator.safeCompare(
      firstName1,
      firstName2
    );
    int siteShortName = SiteMembershipComparator.safeCompare(
      shortName1,
      shortName2
    );
    ...
    return SiteMembershipComparator.compareSiteMembersBody(
      sortPairs,
      personId1,
      personId2,
      lastName1,
  ...
  static Comparator<SiteMembership> getComparator(
    List<Pair<?, CannedQuerySortDetails.SortOrder>> sortPairs
  ) {
    return (SiteMembership o1, SiteMembership o2) ->
      compareTo(sortPairs, o1, o2);
  }
}
