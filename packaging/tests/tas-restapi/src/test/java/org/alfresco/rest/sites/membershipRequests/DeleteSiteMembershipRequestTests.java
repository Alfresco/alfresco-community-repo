...
public class DeleteSiteMembershipRequestTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    moderatedSite =
      dataSite
        ...
        .createSite(
          new SiteModel(Visibility.MODERATED, siteId, siteId, siteId, siteId)
        );
    usersWithRoles =
    ...
    secondModeratedSite =
      dataSite.usingUser(secondSiteCreator).createModeratedRandomSite();
  ...
  //    @Bug(id = "MNT-16904")
  public void unauthenticatedUserIsNotAuthorizedToDeleteSiteMmebershipRequest()
    throws Exception {
    restClient
      .authenticateUser(dataUser.createRandomTestUser())
      .withCoreAPI()
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void userCanDeleteHisOwnSiteMembershipRequestUsingMeAsPersonId()
    throws Exception {
    restClient
      .authenticateUser(secondSiteCreator)
      .withCoreAPI()
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void adminIsNotAbleToDeleteSiteMembershipRequestOfAnInexistentUser()
    throws Exception {
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void adminIsNotAbleToDeleteSiteMembershipRequestToAnInexistentSite()
    throws Exception {
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void adminIsNotAbleToDeleteSiteMembershipRequestWithEmptySiteId()
    throws Exception {
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify manager is not able to remove a site memebership request if it was already approved and response is 404"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.PEOPLE },
    executionType = ExecutionType.REGRESSION,
    description = "Verify manager is not able to remove an inexitent site memebership request and response is 404"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void managerUserIsNotAbleToDeleteAnInexistentSiteMembershipRequest()
    throws Exception {
    restClient
      .authenticateUser(secondSiteCreator)
      .withCoreAPI()
  ...
  public void collaboratorIsNotAbleToDeleteSiteMembershipRequestOfAdminToAPublicSite()
    throws Exception {
    UserModel userCollaborator = usersWithRoles.getOneUserWithRole(
      UserRole.SiteCollaborator
    );
    restClient
      .authenticateUser(siteMember)
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void adminIsNotAbleToDeleteSiteMembershipRequestEmptyPersonID()
    throws Exception {
  ...
  @Test(groups = { TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION })
  public void managerCancelsTwiceSiteMembershipRequestModeratedSite()
    throws Exception {
    siteMember = dataUser.createRandomTestUser();
    restClient
      .authenticateUser(siteMember)
