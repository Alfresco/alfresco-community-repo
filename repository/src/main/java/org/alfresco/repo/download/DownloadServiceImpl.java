...
public class DownloadServiceImpl implements DownloadService {
  ...
  @Override
  public NodeRef createDownload(
    final NodeRef[] requestedNodes,
    ...
    NodeRef downloadNode = transactionHelper.doInTransaction(
  ...
  public void deleteDownloads(
    ...
    List<List<DownloadEntity>> downloadPages = downloadStorage.getDownloadsCreatedBefore(
      before,
      batchSize,
