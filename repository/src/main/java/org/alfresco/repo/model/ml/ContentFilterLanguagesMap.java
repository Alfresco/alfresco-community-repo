...
public class ContentFilterLanguagesMap
  ...
  private static final String USED_STANDARD_CONFIG_CONDITION =
    "Standard In Use";
  ...
  private static final Log logger = LogFactory.getLog(
    ContentFilterLanguagesMap.class
  );
  ...
  public List<String> getMissingLanguages(List<String> availableLanguages) {
    ...
    List<String> returnList = new ArrayList<String>(
      orderedLangCodes.size() - availableLanguages.size()
    );
  ...
  public void init() {
    ...
    Config configStandard = configService.getConfig(
    ...
    if (
      ...
      standard =
        configStandard.getConfigElement(USED_STANDARD_ELEMENT).getValue();
    } else {
      logger.warn(
        "No standard configured, use by default : " +
        DEFAULT_LANGUAGE_LIST_STANDARD
      );
    }

    Config configConditions = configService.getConfig(
      CONFIG_CONDITION,
      clContext
    );
    ...
    // if the santard is not matched, get the first list
      ...
      logger.warn(
        "Ignoring prefered standard doesn't found, choose : " +
        configLanguages.getName()
      );
    }
  ...
  public String convertToOldISOCode(String code) {
    if (code.equalsIgnoreCase("he")) code = "iw"; else if (
      code.equalsIgnoreCase("id")
    ) code = "in"; else if (code.equalsIgnoreCase("yi")) code = "ji";
  ...
  public String convertToNewISOCode(String code) {
    if (code.equalsIgnoreCase("iw")) code = "he"; else if (
      code.equalsIgnoreCase("in")
    ) code = "id"; else if (code.equalsIgnoreCase("ji")) code = "yi";
