...
public class SolrFacetProperties implements Serializable {
  ...
  private SolrFacetProperties(Builder builder) {
    ...
    this.scopedSites =
      Collections.unmodifiableSet(new HashSet<String>(builder.scopedSites));
    this.customProperties =
      (builder.customProperties == null)
        ? null
        : Collections.unmodifiableSet(
          new HashSet<CustomProperties>(builder.customProperties)
        );
  }
  ...
  public Set<CustomProperties> getCustomProperties() {
    return (this.customProperties == null)
      ? null
      : Collections.unmodifiableSet(
        new HashSet<CustomProperties>(this.customProperties)
      );
  }
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((this.filterID == null) ? 0 : this.filterID.hashCode());
    return result;
  }
  ...
  public String toString() {
    ...
    sb
      ...
      .append(", facetQName=")
      .append(this.facetQName)
      .append(", displayName=")
      .append(this.displayName)
      .append(", displayControl=")
      .append(this.displayControl)
      .append(", maxFilters=")
      .append(this.maxFilters)
      .append(", hitThreshold=")
      .append(this.hitThreshold)
      .append(", minFilterValueLength=")
      .append(this.minFilterValueLength)
      .append(", sortBy=")
      .append(this.sortBy)
      .append(", scope=")
      .append(this.scope)
      .append(", scopedSites=")
      .append(this.scopedSites)
      .append(", isEnabled=")
      .append(this.isEnabled)
      .append(", isDefault=")
      .append(this.isDefault)
      .append(", customProperties=")
      .append(this.customProperties)
      .append("]");
    return sb.toString();
  }
