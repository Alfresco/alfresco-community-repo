...
public class GetFavoriteTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify Manager user gets favorite site with Rest API and status code is 200")
    ...
    public void managerIsAbleToRetrieveFavoriteSite() throws Exception {
        ...
        RestPersonFavoritesModel favSite =
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify Manager user gets favorite folder with Rest API and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.SANITY})
    public void managerIsAbleToRetrieveFavoriteFolder() throws Exception {
        ...
        RestPersonFavoritesModel favoriteFolder =
                restClient.withCoreAPI().usingAuthUser().getFavorite(folderModel.getNodeRef());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify Manager user gets favorite file with Rest API and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.SANITY})
    public void managerIsAbleToRetrieveFavoriteFile() throws Exception {
        ...
        RestPersonFavoritesModel favoriteFile =
                restClient
                        .withCoreAPI()
                        .usingAuthUser()
                        .getFavorite(fileModel.getNodeRefWithoutVersion());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    public void userIsNotAbleToRetrieveFavoriteSiteIfAuthenticationFails() throws Exception {
        ...
        restClient
                .authenticateUser(siteManager)
                .withCoreAPI()
                .usingUser(siteManager)
    ...
    @TestRail(
            ...
            description =
                    "Verify Admin user gets favorite site with Rest API and status code is 200")
    ...
    public void adminIsAbleToRetrieveFavoritesSite() throws Exception {
        ...
        RestPersonFavoritesModel favoriteSite =
                restClient.withCoreAPI().usingUser(adminUserModel).getFavorite(siteModel.getGuid());
        restClient.assertStatusCodeIs(HttpStatus.OK);
        favoriteSite.assertThat().field("targetGuid").is(siteModel.getGuid());
        favoriteSite.getTarget().getSite().assertThat().field("guid").is(siteModel.getGuid());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user gets favorite folder with Rest API and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    public void adminIsAbleToRetrieveFavoritesFolder() throws Exception {
        restClient
                ...
                .withCoreAPI()
                .usingUser(adminUserModel)
                .addFolderToFavorites(folderModel);

        RestPersonFavoritesModel favoriteFolder =
                restClient
                        .withCoreAPI()
                        .usingUser(adminUserModel)
                        .getFavorite(folderModel.getNodeRef());
        restClient.assertStatusCodeIs(HttpStatus.OK);
        favoriteFolder.assertThat().field("targetGuid").is(folderModel.getNodeRef());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user gets favorite file with Rest API and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator user gets favorite site with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator user gets favorite folder with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator user gets favorite file with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user gets favorite site with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user gets favorite folder with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user gets favorite file with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user gets favorite site with Rest API and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user gets favorite folder with Rest API and status code is"
                            + " 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user gets favorite file with Rest API and status code is 200")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user doesn't get favorite site of another user with Rest API and status"
                            + " code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user doesn't get favorite site of admin user with Rest API and status"
                            + " code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user doesn't get favorite site of another user with Rest API and"
                            + " status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.FAVORITES},
            executionType = ExecutionType.REGRESSION,
            description = "Verify get favorite user doesn't have any favorite site, file or folder")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.FAVORITES},
            executionType = ExecutionType.REGRESSION,
            description = "Verify get favorite site for -me-")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    public void getFavoriteSiteUsingMe() throws Exception {
        ...
        RestPersonFavoritesModel favoriteSite =
                restClient.withCoreAPI().usingMe().getFavorite(siteModel.getGuid());
        restClient.assertStatusCodeIs(HttpStatus.OK);
        favoriteSite.assertThat().field("targetGuid").is(siteModel.getGuid());
    }
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.FAVORITES},
            executionType = ExecutionType.REGRESSION,
            description = "Verify get favorite site when person id does't exist")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    public void getFavoriteSiteWhenPersonIdNotExist() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, someUser.getUsername()))
                .statusCodeIs(HttpStatus.NOT_FOUND)
                .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
                .stackTraceIs(RestErrorModel.STACKTRACE)
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.FAVORITES},
            executionType = ExecutionType.REGRESSION,
            description = "Verify get favorite site when person id is empty")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.FAVORITES},
            executionType = ExecutionType.REGRESSION,
            description = "Verify get favorite site when favorite id does't exist")
    @Test(groups = {TestGroup.REST_API, TestGroup.FAVORITES, TestGroup.REGRESSION})
    ...
    public void verifyRequestFieldsForGetFavoriteFile() throws Exception {
        ...
        favoriteFile
                .assertThat()
                .field("targetGuid")
                .is(fileModel.getNodeRefWithoutVersion())
                .and()
                .field("target.file.isFile")
                .is("true")
                .and()
                .field("target.file.mimeType")
                .is("text/plain")
                .and()
                .field("target.file.isFolder")
                .is("false")
                .and()
                .field("target.file.createdBy")
                .is(adminUserModel.getUsername())
                .and()
                .field("target.file.versionLabel")
                .is("1.0")
                .and()
                .field("target.file.name")
                .is(fileModel.getName())
                .and()
                .field("target.file.parentId")
                .is(folderModel.getNodeRef())
                .and()
                .field("target.file.guid")
                .is(fileModel.getNodeRefWithoutVersion())
                .and()
                .field("target.file.modifiedBy")
                .is(adminUserModel.getUsername())
                .and()
                .field("target.file.id")
                .is(fileModel.getNodeRefWithoutVersion());
    }
    ...
    public void verifyRequestFieldsForGetFavoriteSite() throws Exception {
        ...
        favoriteSite
                .assertThat()
                .field("targetGuid")
                .is(siteModel.getGuid())
                .and()
                .field("target.site.role")
                .is(UserRole.SiteContributor.toString())
                .and()
                .field("target.site.visibility")
                .is(SiteService.Visibility.PUBLIC.toString())
                .and()
                .field("target.site.guid")
                .is(siteModel.getGuid())
                .and()
                .field("target.site.description")
                .is(siteModel.getDescription())
                .and()
                .field("target.site.id")
                .is(siteModel.getId())
                .and()
                .field("target.site.preset")
                .is("site-dashboard")
                .and()
                .field("target.site.title")
                .is(siteModel.getTitle());
    }
    ...
    public void verifyRequestFieldsForGetFavoriteFolder() throws Exception {
        ...
        favoriteFolder
                ...
                .is(folderModel.getNodeRef())
                .and()
                .field("target.folder.isFile")
                .is("false")
                .and()
                .field("target.folder.isFolder")
                .is("true")
                .and()
                .field("target.folder.createdBy")
                .is(adminUserModel.getUsername())
                .and()
                .field("target.folder.name")
                .is(folderModel.getName())
                .and()
                .field("target.folder.guid")
                .is(folderModel.getNodeRef())
                .and()
                .field("target.folder.modifiedBy")
                .is(adminUserModel.getUsername())
                .and()
                .field("target.folder.id")
                .is(folderModel.getNodeRef());
    }
}
