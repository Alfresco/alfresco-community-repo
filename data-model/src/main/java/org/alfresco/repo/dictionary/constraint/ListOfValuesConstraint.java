...
/**
 * Constraint implementation that ensures the value is one of a constrained <i>list of values</i>.
 * By default, this constraint is case-sensitive.
 *
...
public class ListOfValuesConstraint extends AbstractConstraint {
    ...
    private static final String ERR_INVALID_VALUE =
            "d_dictionary.constraint.list_of_values.invalid_value";
    ...
    /**
     * Get the allowed values. Note that these are <tt>String</tt> instances, but may represent
     * non-<tt>String</tt> values. It is up to the caller to distinguish.
     *
     * <p>Sorts list if appropriate.
     *
    ...
    /**
     * Get the display label for the specified allowable value in this constraint. A key is
     ...
     * </pre>
     *
     * This key is then used to look up a properties bundle for the localised display label. Spaces
     * are allowed in the keys, but they should be escaped in the properties file as follows:
     *
     * <pre>
     ...
     *     If no localisation is defined, it will return the allowed value itself. If the specified
     *     allowable value is not in the model, returns <code>null</code>.
     * @since 4.0
     ...
     *
     * @param caseSensitive <tt>true</tt> if the constraint is case-sensitive (default), or
     *     <tt>false</tt> for case-insensitive.
     */
    ...
    /**
     * @see
     *     org.alfresco.repo.dictionary.constraint.AbstractConstraint#evaluateSingleValue(java.lang.Object)
     */
    @Override
