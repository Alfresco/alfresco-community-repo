...
public class SolrFacetServiceImplTest {
    ...
    public void updateFacet() {
        ...
        final SolrFacetProperties facetProps =
        ...
        TRANSACTION_HELPER.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    @Override
                    public Void execute() throws Throwable {
                        SolrFacetProperties updatedFacetProps =
                                new SolrFacetProperties.Builder(facetProps).maxFilters(10).build();
    ...
    public void deleteDefaultFacet() {
        ...
        final String defaultFilterName =
                TRANSACTION_HELPER.doInTransaction(
        ...
        TRANSACTION_HELPER.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        SolrFacetProperties solrFacetProperties =
                                SOLR_FACET_SERVICE.getFacet(filterName);
    ...
    public void createFacet() {
        ...
        final SolrFacetProperties facetProps =
                new SolrFacetProperties.Builder()
                        ...
                        .facetQName(
                                QName.createQName(
                                        "{http://www.alfresco.org/model/content/1.0}test3"))
