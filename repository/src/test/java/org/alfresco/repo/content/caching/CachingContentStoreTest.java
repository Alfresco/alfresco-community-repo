...
public class CachingContentStoreTest {
    ...
    @Mock private ContentStore backingStore;

    @Mock private ContentCache cache;
    ...
    public void getWriterWhenCacheOnInbound() throws ContentIOException, IOException {
        ...
        ArgumentCaptor<ContentStreamListener> arg =
                ArgumentCaptor.forClass(ContentStreamListener.class);
    ...
    public void getRequestContentDirectUrlUnsupported() {
        try {
            when(backingStore.requestContentDirectUrl(
