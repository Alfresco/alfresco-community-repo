...
/**
 * This class holds a registry of content class names (types and aspects) which if they are present
 * on a sourceNode will prevent any renditions from being created for that node.
 *
