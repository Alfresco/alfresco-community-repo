...
public class AccessAuditorTest {
        ...
        homeFolder =
                nodeService
                        .createNode(
                                ...
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, "homeFolder"),
                        ...
                        new Answer<Map<String, Serializable>>() {
                            public Map<String, Serializable> answer(InvocationOnMock invocation)
                                ...
                                Map<String, Serializable> auditMap =
                                        (Map<String, Serializable>) args[1];
    ...
    private void assertContains(String expected, Serializable actual) {
        ...
        if (actual == null || !actualString.contains(expected)) {
            throw new ComparisonFailure(
                    "Expected not contained in actual.", expected, actualString);
        }
    }
    ...
    public final void test07OnAddAspect() throws Exception {
        ...
        assertTrue(
                "Individual author aspect missing", auditMap.containsKey("aspects/add/cm:author"));
        assertTrue(
    ...
    public final void test11OnCreateVersion() throws Exception {
        ...
        assertTrue(
                ...
                ((Set<?>) auditMap.get("aspects/add")).contains(ContentModel.ASPECT_VERSIONABLE));
        assertTrue(
    ...
    public final void test12OnCheckOut() throws Exception {
        ...
        // createNode createContent readContent updateNodeProperties addNodeAspect copyNode checkOut
        // createVersion
