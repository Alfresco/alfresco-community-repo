...
public class TestTypes extends BaseModelApiTest {
  ...
  public void testAllTypes() throws PublicApiException {
    ...
    publicApiClient.setRequestContext(
      new RequestContext(networkOne.getId(), user1)
    );
  ...
  public void filterTypesByNamespace() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(namespaceUri matches('http://www.mycompany.com/model.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(not namespaceUri matches('http://www.mycompany.com/model.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
  ...
  public void filterTypesByParentId() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(parentId in ('cm:content') AND namespaceUri matches('http://www.mycompany.com/model.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    types.getList().get(0).expected(docType);
    types.getList().get(1).expected(whitePaperType);
    ...
    otherParams.put(
      "where",
      "(parentId in ('cm:content') AND not namespaceUri matches('http://www.mycompany.com/model.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(parentId in ('cm:content') AND namespaceUri matches('.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(parentId in ('cm:content') AND not namespaceUri matches('.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
  ...
  public void filterTypesByModelId() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model','test:scan') AND namespaceUri matches('http://www.mycompany.com/model.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    types.getList().get(0).expected(docType);
    types.getList().get(1).expected(whitePaperType);
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model','test:scan') AND not namespaceUri matches('http://www.mycompany.com/model.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    assertEquals(types.getPaging().getTotalItems(), Integer.valueOf(2));
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model','test:scan') AND namespaceUri matches('.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    assertEquals(types.getPaging().getTotalItems(), Integer.valueOf(4));
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model','test:scan') AND not namespaceUri matches('.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    assertEquals(types.getPaging().getTotalItems(), Integer.valueOf(0));
  }
  ...
  public void testIncludeMandatoryAspect() throws PublicApiException {
    ...
    for (int i = 0; i < types.getList().size(); i++) {
      ...
      type.expected(allTypes.get(i));
      assertEquals(
        type.getMandatoryAspects(),
        allTypes.get(i).getMandatoryAspects()
      );
    }
  }
  ...
  public void testSubTypes() throws PublicApiException {
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model INCLUDESUBTYPES'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model INCLUDESUBTYPES') AND namespaceUri matches('http://www.test.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    ...
    otherParams.put(
      "where",
      "(modelId in ('mycompany:model INCLUDESUBTYPES') AND not namespaceUri matches('http://www.test.*'))"
    );
    types = publicApiClient.types().getTypes(createParams(paging, otherParams));
    types.getList().get(0).expected(docType);
    types.getList().get(1).expected(whitePaperType);
