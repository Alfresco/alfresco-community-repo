...
/**
 * Notifies the user that the patch about to be run is no longer supported and an incremental
 * upgrade path must be followed.
 *
 * @author Derek Hulley
 * @since 2.1.5
 */
public class NoLongerSupportedPatch extends AbstractPatch {
    private static final String ERR_USE_INCREMENTAL_UPGRADE =
