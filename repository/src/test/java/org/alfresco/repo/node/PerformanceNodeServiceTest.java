...
public class PerformanceNodeServiceTest extends TestCase {
    ...
    public void testPerformanceNodeService() throws Exception {
        ...
        RetryingTransactionCallback<Object> buildChildrenWork =
            ...
            if (nodeCount % 100 == 0) {
                System.out.println(
                        "Interim summary: \n"
                                ...
                                + "\n"
                                + "   time: "
                                + (double) diffTime / 1000.0 / 60.0
                                + " minutes \n"
                                + "   average: "
                                + (double) nodeCount / (double) diffTime * 1000.0
                                + " nodes/s");
            }
