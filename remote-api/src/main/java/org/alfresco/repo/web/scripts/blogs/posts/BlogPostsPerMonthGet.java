...
public class BlogPostsPerMonthGet extends AbstractGetBlogWebScript {
    ...
    private Date getBeginOfMonthDate(Date date) {
        // TODO These date processing methods are copied almost verbatim from JavaScript to preserve
        // behaviour.
        // However they should be updated to use java.util.Calendar as the current implementation
    ...
    /**
     * Returns the date representing the last second of a month (23:59:59) Ported from
     * blog-posts-per-month.get.js
     */
    @SuppressWarnings("deprecation")
    ...
    /**
     * Create an object containing information about the month specified by date. Ported from
     * blog-posts-per-month.get.js
     */
    @SuppressWarnings("deprecation")
    ...
    /**
     * Fetches data for each month for which posts exist, plus the count of each. Note: If no posts
     * could be found, this method will return the current month but with a count of posts equals
     * zero. Ported from blog-posts-per-month.get.js
     */
    @SuppressWarnings("deprecation")
