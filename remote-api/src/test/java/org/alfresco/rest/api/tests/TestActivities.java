                                ...
                                return TenantUtil.runAsUserTenant(
                                        new TenantRunAsWork<TestSite>() {
                                            public TestSite doWork() throws Exception {
                                                ...
                                                site.inviteToSite(
                                                        person2.getId(), SiteRole.SiteCollaborator);
        ...
        TenantUtil.runAsUserTenant(
                new TenantRunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        activityData.put(
                                "nodeRef",
                                testSite.getContainerNodeRef("documentLibrary").toString());
                        repoService.postActivity(
                        ...
                        activityData.put(
                                "nodeRef",
                                testSite1.getContainerNodeRef("documentLibrary").toString());
                        repoService.postActivity(
                                "org.alfresco.documentlibrary.file-added",
                                testSite1.getSiteId(),
                                activityData);
        ...
        TenantUtil.runAsUserTenant(
                new TenantRunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        ...
                        activityData.put(
                                "nodeRef",
                                testSite2.getContainerNodeRef("documentLibrary").toString());
                        repoService.postActivity(
                                "org.alfresco.documentlibrary.file-added",
                                testSite2.getSiteId(),
                                activityData);
                ...
                new TenantRunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        siteService.setMembership(
                                testSite3.getSiteId(), person5.getId(), SiteModel.SITE_CONSUMER);
    ...
    public void testPersonActivities() throws Exception {
        ...
        // Test with default tenant domain. see ALF-20448
        {
            List<Activity> expectedActivities =
                    TenantUtil.runAsUserTenant(
                            new TenantRunAsWork<List<Activity>>() {
                                @Override
                                public List<Activity> doWork() throws Exception {
                                    List<Activity> activities =
                                            repoService.getActivities(
                                                    person5.getId(), null, false, true);
                                    return activities;
                                }
                            },
                            person5.getId(),
...

            {
                ...
                publicApiClient.setRequestContext(
                        new RequestContext(defaultNetwork.getId(), person5.getId()));
                ListResponse<Activity> response =
                        peopleProxy.getActivities(person5.getId(), params);
                checkList(
                        expectedActivities.subList(
            ...
            // "-me-" user
            {
                ...
                ListResponse<Activity> response =
                        peopleProxy.getActivities(
                                org.alfresco.rest.api.People.DEFAULT_USER, params);
                checkList(
                        expectedActivities.subList(
                                skipCount, skipCount + paging.getExpectedPaging().getCount()),
                        paging.getExpectedPaging(),
        ...
        //		try
        //		{
        //			publicApiClient.setRequestContext(new RequestContext(network1.getId(),
        // person1.getId()));
        //			peopleProxy.create("people", person1.getId(), "activities", null, null, "Unable to POST
        // to person activities");
        //			fail("");
        //		}
        //		catch(PublicApiException e)
        //		{
        ...
        //			publicApiClient.setRequestContext(new RequestContext(network1.getId(),
        // person1.getId()));
        //			peopleProxy.update("people", person1.getId(), "activities", null, null, "Unable to PUT
        // person activities");
        //			fail("");
        //		}
        //		catch(PublicApiException e)
        ...
        //			publicApiClient.setRequestContext(new RequestContext(network1.getId(),
        // person1.getId()));
        //			peopleProxy.remove("people", person1.getId(), "activities", null, "Unable to DELETE
        // person activities");
        //			fail("");
        //		}
        //		catch(PublicApiException e)
        ...
        //		try
        //		{
        //			List<Activity> activities = TenantUtil.runAsUserTenant(new
        // TenantRunAsWork<List<Activity>>()
        //			{
        //				@Override
        //				public List<Activity> doWork() throws Exception
        //				{
        //					List<Activity> activities = repoService.getActivities(person1.getId(), null, false,
        // true);
        //					return activities;
        //				}
        ...
        //			publicApiClient.setRequestContext(new RequestContext(network1.getId(),
        // person1.getId()));
        //			peopleProxy.create("people", person1.getId(), "activities",
        // String.valueOf(activity.getId()), null, "Unable to POST to a person activity");
        //			fail("");
        //		}
        //		catch(PublicApiException e)
        //		{
        ...
        //			publicApiClient.setRequestContext(new RequestContext(network1.getId(),
        // person1.getId()));
        //			peopleProxy.update("people", person1.getId(), "activities",
        // String.valueOf(activity.getId()), null, "Unable to PUT a person activity");
        //			fail("");
        //		}
        //		catch(PublicApiException e)
        //		{
                    ...
                    TenantUtil.runAsUserTenant(
                            new TenantRunAsWork<List<Activity>>() {
                                ...
                                public List<Activity> doWork() throws Exception {
                                    List<Activity> activities =
                                            repoService.getActivities(
                                                    person1.getId(), null, false, false);
                                    return activities;
                                }
                            },
                            person1.getId(),
    ...
    public void testPUBLICAPI23() throws Exception {
...

        {
            ...
            ListResponse<Activity> activities =
                    peopleProxy.getActivities(person2.getId(), createParams(paging, null));
