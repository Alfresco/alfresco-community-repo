...
public class FTSTest extends TestCase {
    ...
    public void testLexer() throws IOException, RecognitionException {
        ...
        InputStream modelStream =
                cl.getResourceAsStream("org/alfresco/repo/search/impl/parsers/fts_test.gunit");
                    ...
                    while (true) {
                        if (node.getChildCount() == 1) {
                            ...
                            if (node.getType() == FTSParser.TERM) {
                                assertEquals(
                                        "Lone star should be mapped to "
                                                + FTSQueryParser.VALUE_REPLACELONESTAR,
                                        node.getChildCount(),
                                        2);
