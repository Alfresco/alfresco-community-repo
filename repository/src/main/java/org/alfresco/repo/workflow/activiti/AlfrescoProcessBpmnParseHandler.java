...
/**
 * A {@link BpmnParseHandler} that adds a start listener to the process definition and makes the
 * process definition tenant aware.
 *
 * @author Joram Barrez
...
public class AlfrescoProcessBpmnParseHandler extends AbstractBpmnParseHandler<Process> {
    ...
    protected void executeParse(BpmnParse bpmnParse, Process process) {
        ...
        processDefinition.addExecutionListener(
                ExecutionListener.EVENTNAME_START, processCreateListener);
