...
public abstract class BaseContentNode implements TemplateContent {
  ...
  public boolean getIsDocument() {
    if (isDocument == null) {
      DictionaryService dd = this.services.getDictionaryService();
      isDocument =
        Boolean.valueOf(dd.isSubClass(getType(), ContentModel.TYPE_CONTENT));
    }
  ...
  public boolean getIsLinkToContainer() {
    if (isLinkToContainer == null) {
      ...
      isLinkToContainer =
        Boolean.valueOf(
          dd.isSubClass(getType(), ApplicationModel.TYPE_FOLDERLINK)
        );
    }
  ...
  public boolean getIsLinkToDocument() {
    if (isLinkToDocument == null) {
      ...
      isLinkToDocument =
        Boolean.valueOf(
          dd.isSubClass(getType(), ApplicationModel.TYPE_FILELINK)
        );
    }
  ...
  public String toString() {
    if (this.services.getNodeService().exists(getNodeRef())) {
      return (
        "Node Type: " + getType() + "\tNode Ref: " + getNodeRef().toString()
      );
    } else {
  ...
  public List<TemplateProperties> getChildren() {
    if (this.children == null) {
      ...
      for (ChildAssociationRef ref : childRefs) {
        ...
        TemplateNode child = new TemplateNode(
          ref.getChildRef(),
          this.services,
          this.imageResolver
        );
  ...
  public String getContent() {
    TemplateContentData content = (TemplateContentData) this.getProperties()
  ...
  public class TemplateContentData implements Serializable {
    ...
    public String getContentMaxLength(int length) {
      ...
      return (reader != null && reader.exists())
        ? reader.getContentString(length)
        : "";
    }
