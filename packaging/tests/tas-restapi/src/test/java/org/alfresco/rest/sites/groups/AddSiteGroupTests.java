...
public class AddSiteGroupTests extends RestTest {
    ...
    public void notAbleToAddGroupToAnInExistentSite() throws Exception {
        ...
        restClient
                ...
                .addSiteGroup(getId(group), UserRole.SiteManager);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that inexistent group can not be added to site and gets status code"
                            + " 404")
    public void notAbleToAddInExistentGroupToSite() throws Exception {
        ...
        restClient
                ...
                .addSiteGroup(group.getGroupIdentifier(), UserRole.SiteManager);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                ...
                .containsSummary(
                        String.format(
                                "An authority was not found for %s", group.getGroupIdentifier()))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user can not add group that is already present and gets status"
                            + " code 409")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that several groups with different roles can be added once in a row to"
                            + " a site and gets status code 201")
    public void addSeveralGroupsWithDifferentRolesToASite() throws Exception {
        ...
        RestRequest request =
                RestRequest.requestWithBody(
                        HttpMethod.POST,
                        json,
                        "sites/{siteId}/group-members?{parameters}",
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that several groups with same roles can be added once in a row to a"
    ...
    public void checkLowerUpperCaseLettersForRole() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                "An authority was not found for GROUP_site_%s_%s",
                                publicSiteModel.getId(), "SITEMANAGER"))
                .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
                .stackTraceIs(RestErrorModel.STACKTRACE);
    ...
    @TestRail(
            ...
            description =
                    "Verify that manager is able to add site group membership and gets status code"
                            + " CREATED (201)")
    public void managerIsAbleToAddSiteGroup() throws Exception {
        ...
        restClient
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addSiteGroup(getId(group), UserRole.SiteCollaborator)
                .assertThat()
                .field("id")
                .is(getId(group))
                .and()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site collaborator is not able to add site group membership and"
                            + " gets status code FORBIDDEN (403)")
    public void collaboratorIsNotAbleToAddSiteGroup() throws Exception {
        ...
        restClient
                .assertLastError()
                .containsSummary(
                        "The current user does not have permissions to modify the membership"
                                + " details of the site");
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site contributor is not able to add site group membership and gets"
    ...
    public void contributorIsNotAbleToAddSiteGroup() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addSiteGroup(getId(group), UserRole.SiteContributor);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site consumer is not able to add site group membership and gets"
                            + " status code FORBIDDEN (403)")
    public void consumerIsNotAbleToAddSiteGroup() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingSite(publicSiteModel)
                .addSiteGroup(getId(group), UserRole.SiteConsumer);
        ;
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that admin user is able to add site group membership and gets status"
                            + " code CREATED (201)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify that unauthenticated user is not able to add site group membership")
