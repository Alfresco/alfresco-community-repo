...
public class DifferenceTest {
  ...
  public void describe() {
    ...
    when(refDbProp.getPath())
      .thenReturn("alfresco.some_table.some_column.name");
    ...
    assertEquals(
      "Difference: expected column alfresco.some_table.some_column.name=\"node_ref\"" +
  ...
  public void describeRefOnly() {
    ...
    assertEquals(
      "Difference: missing column from database, expected at path: alfresco.some_table.some_column",
      diff.describe()
    );
  }
  ...
  public void describeTargetOnly() {
    ...
    assertEquals(
      "Difference: unexpected column found in database with path: alfresco.some_table.some_column",
      diff.describe()
    );
  }
}
