...
/**
 * Tests that exercise the CachingContentStore in conjunction with a backing store that runs
 * deliberately slowly.
 *
 * @author Matt Ward
 */
...
public class SlowContentStoreTest {
    ...
    public void readsAreFasterFromCache() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            assertEquals(
                    "This is the content for my slow ReadableByteChannel", storeReader.content);
        }
    }
