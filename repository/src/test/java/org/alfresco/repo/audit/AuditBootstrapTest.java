...
public class AuditBootstrapTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    URL testModelUrl = ResourceUtils.getURL(
      "classpath:alfresco/testaudit/alfresco-audit-test.xml"
    );
  ...
  public void testGetApplications() {
    ...
    assertTrue(
      "Application map not complete",
      apps.containsKey(APPLICATION_TEST)
    );
  }

  public void testGetApplicationByKey() {
    AuditApplication app = auditModelRegistry.getAuditApplicationByKey(
      KEY_TEST
    );
    assertNotNull(app);
  }
