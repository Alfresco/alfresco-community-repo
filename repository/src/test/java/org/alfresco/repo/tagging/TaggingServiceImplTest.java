...
public class TaggingServiceImplTest extends BaseSpringTest {
  ...
  public void setUp() throws Exception {
    ...
    this.siteService =
      applicationContext.getBean("SiteService", SiteService.class);
    ...
    AuditComponent auditComponent = (AuditComponent) applicationContext.getBean(
      "auditComponent"
    );
    auditComponent.setUserAuditFilter(userAuditFilter);
    AuditServiceImpl auditServiceImpl = (AuditServiceImpl) applicationContext.getBean(
      "auditService"
    );
    auditServiceImpl.setAuditComponent(auditComponent);
    this.auditService =
      (AuditService) applicationContext.getBean("auditService");
    this.scriptService =
      (ScriptService) applicationContext.getBean("scriptService");
    this.actionTrackingService =
      (ActionTrackingService) applicationContext.getBean(
    ...
    this.nodeRefPropInterceptor =
      (NodeRefPropertyMethodInterceptor) applicationContext.getBean(
          ...
          new RetryingTransactionCallback<Void>() {
            ...
            public Void execute() throws Throwable {
              ...
              TaggingServiceImplTest.rootNode =
                nodeService.getRootNode(TaggingServiceImplTest.storeRef);
    ...
    UpdateTagScopesActionExecuter updateTagsAction = (UpdateTagScopesActionExecuter) applicationContext.getBean(
      "update-tagscope"
    );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            Pair<List<String>, Integer> pagedTags = taggingService.getPagedTags(
              TaggingServiceImplTest.storeRef,
              "one",
              0,
              10
            ...
            tagPage =
              taggingService.getTags(TaggingServiceImplTest.storeRef, "one");
            assertNotNull(pagedTags);
            ...
            // Check isTag method
            assertFalse(
              taggingService.isTag(TaggingServiceImplTest.storeRef, TAG_2)
            );
            assertTrue(
              taggingService.isTag(TaggingServiceImplTest.storeRef, TAG_1)
            );
            assertTrue(
              taggingService.isTag(TaggingServiceImplTest.storeRef, UPPER_TAG)
            );
            assertTrue(
              taggingService.isTag(TaggingServiceImplTest.storeRef, LOWER_TAG)
            );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            assertNull(tagScope);
            List<TagScope> tagScopes = taggingService.findAllTagScopes(
              subDocument
            );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            Serializable summaryObj = nodeService.getProperty(
              folder,
              ContentModel.PROP_TAGSCOPE_SUMMARY
            );
            assertTrue(
              "TagScopeSummary value on main folder is not of correct class: " +
            ...
            Serializable summaryObj2 = nodeService.getProperty(
              folder,
              ContentModel.PROP_TAGSCOPE_SUMMARY
            );
            assertTrue(
              "TagScopeSummary value on main folder did not come from the cache",
            ...
            assertTrue(
              "TagScopeSummary value on subfolder is not of correct class: " +
              summaryObj.getClass().getName(),
              List.class.isAssignableFrom(summaryObj.getClass())
            );
            assertEquals(3, ((List) summaryObj).size());
            ...
            assertFalse(
              "Properties of subfolder should not contain tagScopeProperty",
              props.containsKey(ContentModel.PROP_TAGSCOPE_SUMMARY)
            );
            return null;
          }
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          testData.tagFoo1 =
            taggingService.createTag(folder.getStoreRef(), "Foo1");
          testData.tagFoo2 =
            taggingService.createTag(folder.getStoreRef(), "Foo2");
          testData.tagFoo3 =
            taggingService.createTag(folder.getStoreRef(), "Foo3");
          testData.tagBar =
            taggingService.createTag(folder.getStoreRef(), "Bar");

          List<NodeRef> tagsList = new ArrayList<NodeRef>();

          // Create two containers marked as tag scopes
          Map<QName, Serializable> container1Props = new HashMap<QName, Serializable>(
            1
          );
          ...
          assertEquals(
            0,
            nodeService.getChildAssocs(testData.container1).size()
          );

          Map<QName, Serializable> container2Props = new HashMap<QName, Serializable>(
            1
          );
          ...
          assertEquals(
            0,
            nodeService.getChildAssocs(testData.container2).size()
          );
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            Map<QName, Serializable> taggedFolderProps = new HashMap<QName, Serializable>(
              1
            );
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          assertEquals(
            "Unexpected tags " +
            taggingService.findTagScope(testData.container1).getTags(),
            2,
            taggingService.findTagScope(testData.container1).getTags().size()
          );
          assertEquals(
            "Unexpected tags " +
            taggingService.findTagScope(testData.container2).getTags(),
            0,
            taggingService.findTagScope(testData.container2).getTags().size()
          );
          ...
          Map<QName, Serializable> taggedDocProps = new HashMap<QName, Serializable>(
            1
          );
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          assertEquals(
            1,
            nodeService.getChildAssocs(testData.taggedFolder).size()
          );
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          assertEquals(
            1,
            nodeService.getChildAssocs(testData.taggedFolder2).size()
          );
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          // Create a user
          if (
            authenticationService.authenticationExists(USER_1)
          ) authenticationService.deleteAuthentication(USER_1);
          if (personService.personExists(USER_1)) personService.deletePerson(
            USER_1
          );
          ...
          NodeRef tn = taggingService.createTag(
            folder.getStoreRef(),
            "Testing"
          );
          ...
          assertEquals(
            "System",
            nodeService.getProperty(ts.getNodeRef(), ContentModel.PROP_MODIFIER)
          );
          return null;
        }
      }
  ...
  public void test93OnStartupJob() throws Exception {
    final UpdateTagScopesActionExecuter updateTagsAction = (UpdateTagScopesActionExecuter) applicationContext.getBean(
      "update-tagscope"
    );
    class TestData {
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          assertTrue(
            "Not found in " + pendingScopes,
            pendingScopes.contains(folder)
          );
          assertTrue(
            "Not found in " + pendingScopes,
            pendingScopes.contains(subFolder)
          );
      ...
      Thread t = new Thread(
        new Runnable() {
          ...
          public synchronized void run() {
            ...
            logger.debug(
              Thread.currentThread() + " - About to start tagging for " + tag
            );
      ...
      try {
        ...
        if (actionTrackingService.getAllExecutingActions().size() > 0) {
          if (i % 50 == 0) {
            ...
            logger.info(
              "Waiting on " + actions.size() + " actions: " + actions
            );
          }
          Thread.sleep(100);
          continue;
  ...
  public class AsyncOccurs implements OnAsyncActionExecute {
    ...
    private static final String ACTION_TYPE =
      UpdateTagScopesActionExecuter.NAME;
    ...
    public <T> T awaitExecution(RetryingTransactionCallback<T> callback)
      throws Exception {
      T returnVal = transactionService
        .getRetryingTransactionHelper()
      ...
      for (int i = 0; i < 100; i++) {
        if (
          actionTrackingService.getExecutingActions(ACTION_TYPE).size() == 0
        ) {
          break;
        }
        try {
      ...
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          for (int j = 0; j < 10; j++) {
            ...
            RetryingTransactionCallback<NodeRef> createFoldersAndTags = new RetryingTransactionCallback<NodeRef>() {
              ...
              public NodeRef execute() throws Throwable {
                NodeRef folder1 = fileFolderService
                  .create(folder, "Test1", ContentModel.TYPE_FOLDER)
                  .getNodeRef();
                NodeRef folder2 = fileFolderService
                  .create(folder, "Test2", ContentModel.TYPE_FOLDER)
                  .getNodeRef();
            ...
            NodeRef folder2 = transactionService
              .getRetryingTransactionHelper()
    ...
    asyncOccurs.awaitExecution(
      new RetryingTransactionCallback<Void>() {
        ...
        public Void execute() throws Throwable {
          ...
          // Check that the tag scopes got populated
          assertEquals(
            "Wrong tags on folder: " + ts1.getTags(),
            1,
            ts1.getTags().size()
          );
  ...
  public void testTagFileRead() throws UnsupportedEncodingException {
    List<TagDetails> tags = TaggingServiceImpl.readTagDetails(
  ...
  public void testPagedTags() throws UnsupportedEncodingException {
    authenticationComponent.setSystemUserAsCurrentUser();
    Pair<List<String>, Integer> tags = taggingService.getPagedTags(
      storeRef,
      1,
      10
    );
    assertNotNull(tags);
    PagingResults<Pair<NodeRef, String>> res = taggingService.getTags(
      storeRef,
        ...
        .doInTransaction(
          new RetryingTransactionCallback<Void>() {
            ...
            public Void execute() throws Throwable {
              ...
              List<NodeRef> taggableProperty = (List<NodeRef>) nodeService.getProperty(
                folder,
              ...
              // The deleteTag() should remove any reference to the deleted tag
              taggableProperty =
                (List<NodeRef>) nodeService.getProperty(
                  folder,
                  ContentModel.PROP_TAGS
                );
              assertTrue(
                "Our folder shouldn't have any references left to deleted tags.",
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            NodeRef documentLibraryOfSite = siteService.getContainer(
