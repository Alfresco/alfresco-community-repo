...
public class LoadTester extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    AlfrescoImapFolder testDataFolder = imapService.getOrCreateMailbox(
      user,
    ...
    logger.info(
      "Create time: " + t + " ms (" + t / 1000 + " s (" + t / 60000 + " min))"
    );
  ...
  public void testList() {
    ...
    long t = System.currentTimeMillis();
    List<AlfrescoImapFolder> list = imapService.listMailboxes(
      user,
      TEST_FOLDER_NAME + "*",
      false
    );
  ...
  private void importTestData(String acpName, NodeRef space)
    throws IOException {
