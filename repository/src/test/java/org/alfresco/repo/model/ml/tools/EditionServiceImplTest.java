...
public class EditionServiceImplTest extends AbstractMultilingualTestCases {
    ...
    public void testEditionLabels() {
        ...
        Version rootEdition =
                editionService.getEditions(mlContainerNodeRef).getAllVersions().iterator().next();
        // Ensure that the version label is 1.0
        assertTrue(
                "The edition label would be 1.0 and not " + rootEdition.getVersionLabel(),
                rootEdition.getVersionLabel().equals("1.0"));
        ...
        editions =
                new ArrayList<Version>(
                        editionService.getEditions(mlContainerNodeRef).getAllVersions());
        Version firstEdition = editions.get(0);
        // Ensure that the version label is 1.1
        assertTrue(
                "The edition label would be 1.1 and not " + firstEdition.getVersionLabel(),
                firstEdition.getVersionLabel().equals("1.1"));
        ...
        assertTrue(
                "The edition label would be 2.0 and not " + secondEdition.getVersionLabel(),
                secondEdition.getVersionLabel().equals("2.0"));
        ...
        assertTrue(
                "The edition label would be 2.1 and not " + thirdEdition.getVersionLabel(),
                thirdEdition.getVersionLabel().equals("2.1"));
    }
    ...
    public void testCreateEdition() throws Exception {
        ...
        NodeRef frenchContentNodeRef =
                multilingualContentService.getTranslationForLocale(
                        mlContainerNodeRef, Locale.FRENCH);
        ...
        assertTrue(
                "The edition history must contain two versions",
                editionHistory.getAllVersions().size() == 2);

        // Ensure that the locale of the container is changer
        assertTrue(
                "The locale of the conatiner should be changed",
                nodeService
                        .getProperty(mlContainerNodeRef, ContentModel.PROP_LOCALE)
        ...
        List<VersionHistory> rootVersionTranslations =
                editionService.getVersionedTranslations(rootEdition);
        ...
        assertNotNull(
                "The translations list of the root edition can't be null", rootVersionTranslations);

        // Ensure that the new starting document noderef is different that the initial one
        assertFalse(
                "The created starting document must be different that the starting document of the"
                        + " edition",
                frenchContentNodeRef.equals(newStartingPoint));
        // Ensure that the new starting document is the pivot of the current translation
        assertTrue(
                "The new pivot must be equal to the created starting document",
                newStartingPoint.equals(
                        multilingualContentService.getPivotTranslation(mlContainerNodeRef)));

        int numberOfTranslations;

        // Ensure that the current translations size is 1
        numberOfTranslations =
                multilingualContentService.getTranslations(mlContainerNodeRef).size();
        assertEquals(
                "The number of translations must be 1 and not " + numberOfTranslations,
                1,
                numberOfTranslations);
        ...
        assertEquals(
                "The number of translations must be 0 and not " + numberOfTranslations,
                0,
                numberOfTranslations);
        // Ensure that the number of translations of the root verions is 3
        numberOfTranslations = rootVersionTranslations.size();
        assertEquals(
                "The number of translations must be 3 and not " + numberOfTranslations,
                3,
                numberOfTranslations);
    }
    ...
    public void testEditionServiceWithContent() {
        ...
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.1" + "-" + "0.2");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.1" + "-" + "0.3");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.1" + "-" + "0.4");
        // checkContentVersionValuesForEditions(mlContainerNodeRef);
        frenchContentNodeRef =
                multilingualContentService.getTranslationForLocale(
                        mlContainerNodeRef, Locale.FRENCH);
        ...
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.2" + "-" + "0.2");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.2" + "-" + "0.3");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        NodeRef chineseContentNodeRef =
                createContent(CHINESE_CONTENT + "-" + Locale.CHINESE + "-" + "1.2" + "-1.0");
        multilingualContentService.addTranslation(
                chineseContentNodeRef, mlContainerNodeRef, Locale.CHINESE);
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        NodeRef japaneseContentNodeRef =
                createContent(JAPANESE_CONTENT + "-" + Locale.JAPANESE + "-" + "1.2" + "-1.0");
        multilingualContentService.addTranslation(
                japaneseContentNodeRef, mlContainerNodeRef, Locale.JAPANESE);
        checkContentVersionValuesForEditions(mlContainerNodeRef);

        japaneseContentNodeRef =
                multilingualContentService.getTranslationForLocale(
                        mlContainerNodeRef, Locale.JAPANESE);
        ...
        modifyContent(
                japaneseContentNodeRef,
                JAPANESE_CONTENT + "-" + Locale.JAPANESE + "-" + "1.3" + "-0.2");
        chineseContentNodeRef =
                createContent(CHINESE_CONTENT + "-" + Locale.CHINESE + "-" + "1.3" + "-1.0");

        multilingualContentService.addTranslation(
                chineseContentNodeRef, mlContainerNodeRef, Locale.CHINESE);
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        frenchContentNodeRef =
                createContent(FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.3" + "-1.0");
        multilingualContentService.addTranslation(
                frenchContentNodeRef, mlContainerNodeRef, Locale.FRENCH);
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        ...
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.4" + "-" + "0.2");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        ...
        versionProperties.put(VersionModel.PROP_VERSION_TYPE, VersionType.MAJOR);
        japaneseContentNodeRef =
                editionService.createEdition(japaneseContentNodeRef, versionProperties);

        Collection<Version> editions =
                editionService.getEditions(mlContainerNodeRef).getAllVersions();
        ...
        assertTrue(
                ...
                secondEdition.getVersionLabel().equals("2.0"));
        frenchContentNodeRef =
                createContent(FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.0" + "-1.0");
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "1.0" + "-" + "1.1");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
        ...
        versionProperties.put(VersionModel.PROP_VERSION_TYPE, VersionType.MAJOR);
        frenchContentNodeRef =
                editionService.createEdition(frenchContentNodeRef, versionProperties);
        ...
        assertTrue(
                "The edition label would be 3.0 and not " + secondEdition.getVersionLabel(),
                secondEdition.getVersionLabel().equals("3.0"));
        modifyContent(
                frenchContentNodeRef,
                FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + "3.0" + "-" + "0.2");
        checkContentVersionValuesForEditions(mlContainerNodeRef);
    }
    ...
    private void checkFirstVersion(NodeRef mlContainerNodeRef) {
        ...
        assertTrue(
                "The edition history must contain only one edition",
                editionHistory.getAllVersions().size() == 1);
        ...
        assertTrue(
                "The versioned mlContainer noderef of the editon must be the noderef of the created"
                        + " mlContainer",
                currentEdition.getVersionedNodeRef().equals(mlContainerNodeRef));
        ...
        assertTrue(
                "The translations list of the current edition would be empty",
                translations.size() == 0);
    }
    ...
    private NodeRef createMLContainerWithContent() {
        ...
        multilingualContentService.addTranslation(
                frenchContentNodeRef, chineseContentNodeRef, Locale.FRENCH);
        multilingualContentService.addTranslation(
                japaneseContentNodeRef, chineseContentNodeRef, Locale.JAPANESE);
        ...
        for (Version editionVersion : editionHistory.getAllVersions()) {
            ...
            if (editionHistory.getHeadVersion() == editionVersion) {
                ...
                Map<Locale, NodeRef> translations =
                        multilingualContentService.getTranslations(mlContainerNodeRef);
                Locale pivotLocale =
                        (Locale)
                                nodeService.getProperty(
                                        mlContainerNodeRef, ContentModel.PROP_LOCALE);
                ...
                for (Locale locale : keySet) {
                    ...
                    ContentReader reader =
                            contentService.getReader(translatedNode, ContentModel.PROP_CONTENT);
                    ...
                    VersionHistory versionHistory =
                            versionService.getVersionHistory(translatedNode);
                    for (Version version : versionHistory.getAllVersions()) {
                        ...
                        Locale versionLocale =
                                (Locale)
                                        nodeService.getProperty(
                                                frozenNodeRef, ContentModel.PROP_LOCALE);
                        // get content as string and compare
                        reader = contentService.getReader(frozenNodeRef, ContentModel.PROP_CONTENT);
                        String versionnedContent = reader.getContentString();
                        System.out.println(
                                "Individual version " + versionLabel + ":" + versionnedContent);
                        if (versionService
                                .getCurrentVersion(translatedNode)
                                .getFrozenStateNodeRef()
                                .equals(version.getFrozenStateNodeRef())) {
                            // this is the head version of the translation therefore content should
                            // be equal
                            assertTrue(
                                    "The content in head version should be equal to the content of"
                                            + " the translation:",
                                    versionnedContent.equals(liveContent));
                        }
                        // checking if content respects conventions
                        // XXX*locale*edition_version_*document_version
                        // the exception should be the version used to start the new edition with
                        // exception exist for root version because root version can be the first
                        // created
                        // and if is the pivot language then its content is a copy of the previous
                        // edition.
                        ...
                        if ((versionHistory
                            ...
                            System.out.println(
                                    "Some special on live version has to be done:"
                                            + versionnedContent);
                            // get previous edition
                            Version previousEditionVersion =
                                    editionHistory.getPredecessor(editionVersion);

                            if (previousEditionVersion != null) {
                                String previousEditionLabel =
                                        previousEditionVersion.getVersionLabel();
                                System.out.println(
                                        "Current edition Label:"
                                                + editionLabel
                                                + " Previous edition label:"
                                                + previousEditionLabel);
                                List<VersionHistory> versionTranslations =
                                        editionService.getVersionedTranslations(
                                                previousEditionVersion);
                                ...
                                for (VersionHistory versionTranslation : versionTranslations) {
                                    ...
                                    NodeRef newestVersionFrozenNodeRef =
                                            newestVersion.getFrozenStateNodeRef();
                                    String newestVersionVersionLabel =
                                            newestVersion.getVersionLabel();
                                    ContentReader readerContentWeStartedWith =
                                            contentService.getReader(
                                                    newestVersionFrozenNodeRef,
                                                    ContentModel.PROP_CONTENT);
                                    Locale oldestVersionLocale =
                                            (Locale)
                                                    nodeService.getProperty(
                                                            newestVersionFrozenNodeRef,
                                                            ContentModel.PROP_LOCALE);
                                    String contentWeStartedWith =
                                    ...
                                    if (versionLocale.equals(oldestVersionLocale)) {
                                        ...
                                        assertTrue(
                                                "The content in head version should be equal to the"
                ...
                Version nextEditionVersion =
                        editionHistory.getSuccessors(editionVersion).iterator().next();

                // get Next verion label
                String nextEditionLabel = nextEditionVersion.getVersionLabel();
                System.out.println(
                        "Edition:" + editionLabel + " Next edition label:" + nextEditionLabel);
                // get the translations of the version
                List<VersionHistory> versionTranslations =
                        editionService.getVersionedTranslations(editionVersion);
                // iterate on versionTranslations (all languages)

                // strange that we have to go to the next edition to find the current pivot
                // language.
                // maybe there is a reason for that but not logical logical
                dumpFrozenMetaData(editionVersion);
                Locale editionPivotlanguage =
                        (Locale)
                                (editionService
                                        .getVersionedMetadatas(editionVersion)
                                        .get(ContentModel.PROP_LOCALE));
                System.out.println(
                        "Edition:"
                                + editionLabel
                                + " Previous pivot language:"
                                + editionPivotlanguage
                                + " Current pivot language:"
                                + editionPivotlanguage);
                for (VersionHistory versionTranslation : versionTranslations) {
                    ...
                    for (Version version : versions) {
                        ...
                        Locale currentVersionLocale =
                                (Locale)
                                        nodeService.getProperty(
                                                frozenNodeRef, ContentModel.PROP_LOCALE);
                        System.out.println(
                                "Current version locale:"
                                        + currentVersionLocale
                                        + " Previous edition locale:"
                                        + editionPivotlanguage);
                        // get content as string and compare
                        ContentReader reader =
                                contentService.getReader(frozenNodeRef, ContentModel.PROP_CONTENT);
                        String content = reader.getContentString();
                        System.out.println("Content:" + content);
                        // checking content respects conventions
                        // XXX*locale*edition_version_*document_version
                        // the exception should be the version used to start the new edition with
                        Version initialVersion = versionTranslation.getRootVersion();
                        if (initialVersion.equals(version)
                                && currentVersionLocale.equals(editionPivotlanguage)) {
                            ...
                            if (previousEditionVersion != null) {
                                ...
                                System.out.println(
                                        "Current edition Label:"
                                                ...
                                                + " Previous edition label:"
                                                + previousEditionLabel);
                                List<VersionHistory> versionTranslations2 =
                                        editionService.getVersionedTranslations(
                                                previousEditionVersion);
                                // for all languages iterate to find the corresponding language
                                ...
                                assertTrue(
                                        testTriplet.locale.equals(currentVersionLocale.toString()));
    ...
    private NodeRef createMLContainerWithContent(String editionSuffix) {
        NodeRef chineseContentNodeRef =
                createContent(
                        CHINESE_CONTENT + "-" + Locale.CHINESE + "-" + editionSuffix + "-1.0");
        NodeRef frenchContentNodeRef =
                createContent(FRENCH_CONTENT + "-" + Locale.FRENCH + "-" + editionSuffix + "-1.0");
        NodeRef japaneseContentNodeRef =
                createContent(
                        JAPANESE_CONTENT + "-" + Locale.JAPANESE + "-" + editionSuffix + "-1.0");
    ...
    private void dumpFrozenMetaData(Version editionVersion) {
        ...
        System.out.println("---------------------------------------------------");
        // Map<QName,Serializable> mapOfFrozenProps =
        // editionService.getVersionedMetadatas(editionVersion);
        ...
        for (String q : mapOfFrozenProps.keySet()) {
            String val =
                    mapOfFrozenProps.get(q) == null ? "null" : mapOfFrozenProps.get(q).toString();
    ...
    protected NodeRef createContent(String name) {
        NodeRef contentNodeRef =
                fileFolderService
                        .create(folderNodeRef, name + ".txt", ContentModel.TYPE_CONTENT)
                        .getNodeRef();
        // add some content
