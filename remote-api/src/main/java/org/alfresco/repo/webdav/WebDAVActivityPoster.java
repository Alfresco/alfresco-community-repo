...
public interface WebDAVActivityPoster {
     ...
     */
    void postFileFolderAdded(String siteId, String tenantDomain, String path, FileInfo nodeInfo)
            throws WebDAVServerException;
     ...
     * @throws WebDAVServerException
     */
    void postFileFolderUpdated(String siteId, String tenantDomain, FileInfo nodeInfo)
            throws WebDAVServerException;
