...
public class GroupsTest extends AbstractSingleNetworkSiteTest {
  ...
  public void setup() throws Exception {
    ...
    AuthorityDAOImpl authorityDAOImpl = (AuthorityDAOImpl) applicationContext.getBean(
      "authorityDAO"
    );
  ...
  private void testGetGroupsSkipPaging() throws Exception {
    // +ve: check skip count.
    {
      ...
      List<Group> expectedSublist = sublist(
        resp.getList(),
        skipCount,
        maxItems
      );
  ...
  private void testGetGroupsSorting() throws Exception {
    // orderBy=sortColumn should be the same to orderBy=sortColumn ASC
    {
      ...
      assertTrue(
        "groups order not valid",
        groups.indexOf(groupA) < groups.indexOf(groupB)
      );
    ...
    // Sort by id.
    {
      ...
      assertTrue(
        "groups order not valid",
        groups.indexOf(groupB) < groups.indexOf(groupA)
      );
    }
...

    {
      ...
      try {
        ...
        ListResponse<Group> response = getGroups(
  ...
  private void testGetGroupsWithInclude() throws Exception {
    ...
    // Check include parent ids.
    {
      otherParams.put(
        "include",
        org.alfresco.rest.api.Groups.PARAM_INCLUDE_PARENT_IDS
      );
    ...
    // Check include zones.
    {
      otherParams.put(
        "include",
        org.alfresco.rest.api.Groups.PARAM_INCLUDE_ZONES
      );
  ...
  private void testGetGroupsWithZoneFilter() throws Exception {
    // Filter by zone
    {
      ...
      groups.forEach(group ->
        assertTrue(group.getZones().contains("APP.DEFAULT"))
      );
    }
    ...
    // Filter by zone - custom zones, "include" them in the response.
    {
      ...
      groups.forEach(group ->
        assertTrue(group.getZones().contains("APITEST.MYZONE"))
      );
    ...
    // Filter zones while using where isRoot=false
    {
      ...
      otherParams.put(
        "where",
        "(isRoot=false AND zones in ('APITEST.MYZONE'))"
      );
      ...
      otherParams.put(
        "where",
        "(isRoot=false AND zones in ('I.DO.NOT.EXIST'))"
      );
      response = getGroups(paging, otherParams, "Incorrect response", 200);
      groups = response.getList();
      assertTrue(groups.isEmpty());
    ...
    // -ve test: invalid zones clause
    {
      ...
      otherParams.put(
        "where",
        "(zones in ('', 'APP.DEFAULT', '', 'APITEST.MYZONE'))"
      );
      getGroups(paging, otherParams, "Incorrect response", 400);
  ...
  private void createAuthorityContext(String userName)
    ...
    if (!authorityService.authorityExists(rootGroupName)) {
      ...
      authorityService.addAuthorityToZones(
        rootGroupName,
        zoneSet("APITEST.MYZONE")
      );
      authorityService.setAuthorityDisplayName(rootGroupName, "Root Group");

      String groupBAuthorityName = authorityService.createAuthority(
        AuthorityType.GROUP,
        "Test_GroupB" + GUID.generate()
      );
      ...
      String groupAAuthorityName = authorityService.createAuthority(
        AuthorityType.GROUP,
        "Test_GroupA" + GUID.generate()
      );
      ...
      authorityService.addAuthorityToZones(
        groupAAuthorityName,
        zoneSet("APITEST.MYZONE", "APITEST.ANOTHER")
      );
  ...
  private void validateGroupDefaultFields(
    Group group,
    boolean ignoreOptionallyIncluded
  ) {
    assertNotNull(group);
  ...
  private void canGetGroupsForUserId() throws Exception {
    ...
    {
      ListResponse<Group> groups = groupsProxy.getGroupsByPersonId(
        personAlice.getId(),
        null,
        "Couldn't get user's groups",
        200
    ...
    // Filter by isRoot
    {
      ...
      ListResponse<Group> response = groupsProxy.getGroupsByPersonId(
        "-me-",
        params,
        "Couldn't get user's groups",
        200
    ...
    // +ve: check skip count.
    {
      ...
      ListResponse<Group> resp = getGroupsByPersonId(
        personAlice.getId(),
        paging,
        otherParams
      );
      ...
      ListResponse<Group> sublistResponse = getGroupsByPersonId(
        personAlice.getId(),
        paging,
        otherParams
      );
    ...
    // orderBy=sortColumn should be the same to orderBy=sortColumn ASC
    {
      ...
      ListResponse<Group> respOrderAsc = getGroupsByPersonId(
        personAlice.getId(),
        paging,
        otherParams
      );
    ...
    // or postprocessing).
    {
      ...
      // Get and sort groups using canned query.
      ListResponse<Group> respCannedQuery = getGroupsByPersonId(
        personAlice.getId(),
        paging,
        otherParams
      );
      ...
      // Get and sort groups using postprocessing.
      otherParams.put("where", "(isRoot=true)");
      ListResponse<Group> respPostProcess = getGroupsByPersonId(
        personAlice.getId(),
        paging,
        otherParams
      );
  ...
  private void testGetGroupMembersSorting() throws Exception {
    // orderBy=sortColumn should be the same to orderBy=sortColumn ASC
    {
      ...
      ListResponse<GroupMember> resp = getGroupMembers(
        rootGroupName,
        paging,
        otherParams
      );
      ...
      when(iterator.hasNext()).thenReturn(true, true, false);
      when(iterator.next()).thenReturn(groupBResultSetRow, groupAResultSetRow);
      ListResponse<GroupMember> respOrderAsc = getGroupMembers(
        rootGroupName,
        paging,
        otherParams
      );
  ...
  private void testGetGroupMembersSkipPaging() throws Exception {
    // +ve: check skip count.
    {
      ...
      when(iterator.hasNext()).thenReturn(true, true, false);
      when(iterator.next()).thenReturn(groupBResultSetRow, groupAResultSetRow);
      ListResponse<GroupMember> sublistResponse = getGroupMembers(
        rootGroupName,
        paging,
        otherParams
      );

      List<GroupMember> expectedSublist = sublist(
        resp.getList(),
        skipCount,
        maxItems
      );
  ...
  private void testGetGroupsByMemberType() throws Exception {
    testGetGroupsByMemberType(
      rootGroupName,
      org.alfresco.rest.api.Groups.PARAM_MEMBER_TYPE_GROUP
    );
    testGetGroupsByMemberType(
      groupB.getId(),
      org.alfresco.rest.api.Groups.PARAM_MEMBER_TYPE_PERSON
    );
  ...
  private void testGetGroupsByMemberType(String groupId, String memberType)
    throws Exception {
    // Sort params
    Map<String, String> otherParams = new HashMap<>();
  ...
  public void testGetGroup() throws Exception {
    ...
    try {
...

      {
        ...
        Group group = groupsProxy.getGroup(
          groupA.getId(),
          otherParams,
          HttpServletResponse.SC_OK
        );
  ...
  public void testCreateGroup() throws Exception {
    ...
    // Create group and subgroup.
    {
      ...
      Group createdGroup01 = groupsProxy.createGroup(
        group,
        null,
      ...
      Group createdSubGroup01 = groupsProxy.createGroup(
        subGroup01,
        otherParams,
        HttpServletResponse.SC_CREATED
      );
  ...
  public void testCreateGroupMembers() throws PublicApiException {
    ...
    try {
      ...
      // becomes a non-root group since it now has a parent.
      {
        ...
        Group groupRootCreated = groupsProxy.createGroup(
          groupRoot,
          null,
          HttpServletResponse.SC_CREATED
        );
        assertTrue(
          "Group was expected to be root.",
          groupRootCreated.getIsRoot()
        );
        ...
        assertFalse(
          "Group was expected to be sub-group.",
          subGroup.getIsRoot()
        );
      }
  ...
  public void testUpdateGroup() throws Exception {
    ...
    Group group = groupsProxy.createGroup(
      generateGroup(),
      null,
      HttpServletResponse.SC_CREATED
    );
    ...
    Group subGroup = groupsProxy.createGroup(
      generatedSubGroup,
      otherParams,
      HttpServletResponse.SC_CREATED
    );
    ...
    // Update group and subgroup.
    {
      ...
      Group updateGroup = groupsProxy.updateGroup(
        subGroup.getId(),
        mySubGroup,
        otherParams,
        HttpServletResponse.SC_OK
  ...
  public void testDeleteGroup() throws Exception {
    ...
    {
      Group groupLevel1 = groupsProxy.createGroup(
        generateGroup(),
        otherParams,
        HttpServletResponse.SC_CREATED
      );
      Group groupLevel2 = groupsProxy.createGroup(
        generateSubGroup(groupLevel1),
        otherParams,
        HttpServletResponse.SC_CREATED
      );
      Group groupLevel3 = groupsProxy.createGroup(
      ...
      groupLevel2 =
        groupsProxy.getGroup(groupLevel2.getId(), HttpServletResponse.SC_OK);
  ...
  public void testDeleteGroupMembership() throws Exception {
    ...
    try {
...

      {
        ...
        Group createdTestGroup = groupsProxy.createGroup(
          generateGroup(),
          null,
          HttpServletResponse.SC_CREATED
        );
  ...
  private Group generateSubGroup(Group parentGroup) {
    Set<String> subGroupParents = new HashSet<>();
    if (
      parentGroup.getParentIds() != null &&
      !parentGroup.getParentIds().isEmpty()
    ) {
  ...
  private void shouldFilterGroupByDisplayNameAndZone() throws Exception {
    ...
    otherParams.put(
      "where",
      "(zones in ('APITEST.MYZONE') AND displayName in ('A Group'))"
    );
  ...
  private void shouldFilterGroupByDisplayNameWhenGroupIsRoot()
    throws Exception {
    Paging paging = getPaging(0, Integer.MAX_VALUE);
    Map<String, String> otherParams = new HashMap<>();
  ...
  private void shouldFilterGroupByDisplayNameWhenIsRootIsFalse()
    throws Exception {
    Paging paging = getPaging(0, Integer.MAX_VALUE);
    Map<String, String> otherParams = new HashMap<>();
  ...
  private void shouldFilterGroupByDisplayNameAndZoneWhenGroupIsRoot()
    throws Exception {
    Paging paging = getPaging(0, Integer.MAX_VALUE);
    Map<String, String> otherParams = new HashMap<>();
    otherParams.put(
  ...
  private void shouldReturnBadRequestErrorWhenTooManyDisplayNames()
    throws Exception {
    Paging paging = getPaging(0, Integer.MAX_VALUE);
    Map<String, String> otherParams = new HashMap<>();
  ...
  private void shouldReturnBadRequestErrorWhenDisplayNameIsEmpty()
    throws Exception {
    Paging paging = getPaging(0, Integer.MAX_VALUE);
    Map<String, String> otherParams = new HashMap<>();
