...
public abstract class AbstractChainingAuthenticationComponent
   ...
   */
  protected abstract AuthenticationComponent getAuthenticationComponent(
    String name
  );
  ...
  public void testAuthenticate(
    ...
    Object[] args = { authenticatorName };
    diagnostic.addStep(
      AuthenticationDiagnostic.STEP_KEY_VALIDATION_AUTHENTICATOR_NOT_FOUND,
      false,
      args
    );
    throw new AuthenticationException(
      "authentication.err.validation.authenticator.notfound",
      args,
      diagnostic
    );
  }
  ...
  public Set<String> getDefaultAdministratorUserNames() {
    ...
    for (AuthenticationComponent authComponent : getUsableAuthenticationComponents()) {
      defaultAdministratorUserNames.addAll(
        authComponent.getDefaultAdministratorUserNames()
      );
    }
