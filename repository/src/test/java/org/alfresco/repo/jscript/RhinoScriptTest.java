                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                try {
                                    // The easiest way to embed Rhino is just to create a new scope
                                    // this way whenever
                                    // you need one. However, initStandardObjects is an expensive
                                    // method to call and it
                                    // allocates a fair amount of memory.
                                    Scriptable scope = cx.initStandardObjects();

                                    // Now we can evaluate a script. Let's create a new associative
                                    // array object
                                    ...
                                    // should resolve "obj.a == 1" - JavaScript objects come back as
                                    // Number
                                    assertEquals(new Double(1.0), obj.get("a", obj));

                                    // try another script eval - this time a function call returning
                                    // a result
                                    result =
                                            cx.evaluateString(
                                                    scope,
                            ...
                            public Object execute() throws Exception {
                                StoreRef store =
                                        nodeService.createStore(
                                                ...
                                                "rhino_" + System.currentTimeMillis());
                                ...
                                try {
                                    ...
                                    // add logger object so we can perform output from within
                                    // scripts
                                    ScriptableObject.putProperty(
                                            scope, "logger", new ScriptLogger());

                                    // wrap a simple NodeRef Java object
                                    // we can use Java style method calls within the script to
                                    // access it's properties
                                    List<ChildAssociationRef> childAssocs =
                                            nodeService.getChildAssocs(root);
                                    ...
                                    // wrap a scriptable Alfresco Node object - the Node object is a
                                    // wrapper like TemplateNode
                                    ...
                                    result =
                                            cx.evaluateString(
                                                    scope, TESTSCRIPT1, "TestJS4", 1, null);
                                } finally {
                                    Context.exit();
                                }
                        ...
                        new RetryingTransactionCallback<Object>() {
                            public Object execute() throws Exception {
                                ...
                                try {
                                    ...
                                    // concept
                                    ScriptNode rootNode =
                                            new ScriptNode(root, serviceRegistry, null);
                                    model.put("root", rootNode);

                                    // execute test scripts using the various entry points of the
                                    // ScriptService

                                    // test executing a script file via classpath lookup
                                    Object result =
                                            scriptService.executeScript(
                                                    TESTSCRIPT_CLASSPATH1, model);
                                    System.out.println(
                                    ...
                                    scriptService.executeScriptString(
                                            "javascript", TESTSCRIPT1, model);
                                } finally {
                                }
                                ...
                                try {
                                    ...
                                    try {
                                        scriptService.executeScript(
                                                ...
                                                model);
                                        fail(
                                                "execution of nonsecure script on nodeRef is not"
                                                        + " allowed.");
                                    } catch (AlfrescoRuntimeException ex) {
                                        // expected
                                    }

                                    ChildAssociationRef childRef1 =
                                            nodeService.createNode(
                                                    root,
                                                    BaseNodeServiceTest
                                                            .ASSOC_TYPE_QNAME_TEST_CHILDREN,
