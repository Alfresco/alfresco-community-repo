 ...
 *
 * <p>The metadata is embedded in the content from the current property values.
 *
...
public class ContentMetadataEmbedder extends ActionExecuterAbstractBase {
    ...
    public void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
        ...
        MetadataEmbedder embedder =
                metadataExtracterRegistry.getEmbedder(mimetype, sourceSizeInBytes);
        if (embedder == null) {
            if (logger.isDebugEnabled()) {
        ...
        ContentWriter writer =
                contentService.getWriter(actionedUponNodeRef, ContentModel.PROP_CONTENT, true);
