...
public class DeleteTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to delete files in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify site manager is able to delete empty folders in DocumentLibrary with"
                            + " CMIS")
    @Test(groups = {TestGroup.SANITY, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is NOT able to delete folders with chidren with CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete file with multiple versions with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is NOT able to delete file which is checked out with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisConstraintException.class,
    ...
    public void siteManagerCannotDeleteNonexistentFolder() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager).usingResource(testFolder).delete();
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to delete files created by another users in"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to delete content created by self in"
                            + " DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to delete file created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to delete folder created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to delete content created by self in"
                            + " DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is not able to delete file created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is not able to delete folder created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is not able to delete file created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site consumer is not able to delete folder created by other user in"
                            + " DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to delete files created by another users in"
                            + " DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized user is not able to delete file created inside a private"
                            + " site with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized user is not able to delete folder created inside a private"
                            + " site with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized user is not able to delete content created inside a"
