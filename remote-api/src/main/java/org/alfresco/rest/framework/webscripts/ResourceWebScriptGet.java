...
public class ResourceWebScriptGet
  ...
  public Params extractParams(
    ...
    final String relationship2Id = resourceVars.get(
      ResourceLocator.RELATIONSHIP2_ID
    );
  ...
  public Object executeAction(
    ...
    switch (resource.getMetaData().getType()) {
      case ENTITY:
        if (
          StringUtils.isBlank(params.getEntityId()) ||
          params.isCollectionResource()
        ) {
          // Get the collection
          if (
            EntityResourceAction.Read.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
              resource.getMetaData().isDeleted(EntityResourceAction.Read.class)
            ) {
            ...
            EntityResourceAction.ReadWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
            ...
            EntityResourceAction.DeleteSetWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
            ...
            EntityResourceAction.DeleteSet.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
              resource
                .getMetaData()
                .isDeleted(EntityResourceAction.Delete.class)
            ) {
              throw new DeletedResourceException(
                "(DELETE) " + resource.getMetaData().getUniqueId()
              );
          ...
          if (
            EntityResourceAction.ReadById.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
              resource
                .getMetaData()
                .isDeleted(EntityResourceAction.ReadById.class)
            ) {
              throw new DeletedResourceException(
            ...
            EntityResourceAction.ReadByIdWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
            ...
            Object result = entityGetter.readById(
              params.getEntityId(),
              params,
              withResponse
            );
      ...
      case RELATIONSHIP:
        if (
          StringUtils.isBlank(params.getRelationshipId()) ||
          (params.isCollectionResource())
        ) {
          // Get the collection
          if (
            RelationshipResourceAction.Read.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
            ...
            CollectionWithPagingInfo<?> relations = relationGetter.readAll(
              params.getEntityId(),
              params
            );
            return relations;
          ...
          if (
            ...
            Object result = relationGetter.readById(
              params.getEntityId(),
            ...
            RelationshipResourceAction.ReadByIdWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
      ...
      case PROPERTY:
        if (StringUtils.isNotBlank(params.getEntityId())) {
          if (
            ...
            if (
              resource.getMetaData().isDeleted(BinaryResourceAction.Read.class)
            ) {
              throw new DeletedResourceException(
                "(GET) " + resource.getMetaData().getUniqueId()
              );
            ...
            BinaryResource prop = getter.readProperty(
              params.getEntityId(),
              params
            );
            return prop;
          ...
          if (
            BinaryResourceAction.ReadWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
          ...
          if (
            RelationshipResourceBinaryAction.ReadWithResponse.class.isAssignableFrom(
                resource.getResource().getClass()
              )
          ) {
            if (
