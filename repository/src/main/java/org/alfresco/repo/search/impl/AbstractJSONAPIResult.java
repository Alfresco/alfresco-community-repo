...
public abstract class AbstractJSONAPIResult implements JSONAPIResult {
   ...
   * @throws JSONException
   */
  protected Map<String, Object> getPropertyValueMap(JSONObject json)
    throws JSONException {
   ...
   * @throws JSONException
   */
  protected abstract void processCoresInfoJson(JSONObject json)
    throws JSONException;
}
