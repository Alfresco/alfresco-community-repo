...
public class IsPrivateWorkingCopyTests extends CmisTest {
  ...
  public void siteManagerCannotVerifyIsPrivateWorkingCopyOnDeletedDoc()
    throws Exception {
    FileModel deletedDoc = FileModel.getRandomFileModel(
      FileType.TEXT_PLAIN,
      documentContent
    );
    cmisApi
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void nonInvitedUserCanVerifyIsPrivateWorkingCopyInPublicSite()
    throws Exception {
    cmisApi
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteConsumer)
  ...
  public void nonInvitedUserCannotVerifyIsPrivateWorkingCopyInPrivateSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotVerifyIsPrivateWorkingCopyInModeratedSite()
    throws Exception {
