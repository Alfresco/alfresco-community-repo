...
public class SolrFacetConfigTest {
    ...
    public void testDefault() throws Exception {
        ...
        String customValue =
                (String) contentSizeFP.getCustomProperties().iterator().next().getValue();
        ...
        // test SITE (solr special), loaded from
        // /facets/extension/facets-config-custom-sample.properties
        ...
        // test TAG (solr special), loaded from
        // /facets/extension/facets-config-custom-sample.properties
