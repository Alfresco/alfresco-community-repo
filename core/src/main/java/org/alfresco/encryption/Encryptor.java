...
public interface Encryptor
{
     ...
     * <p/>
     * Note that the original object may be returned directly if there is no key associated with the alias or if the input object is not a <code>SealedObject</code>.
     * 
     * @param keyAlias
     *            the encryption key alias
     * @param input
     ...
     *             if the key alias is not valid <b>and</b> the input is a <tt>SealedObject</tt>
     */
