...
public class TestCMIS extends EnterpriseTestApi
{
    ...
    /* This test requires lucene, and needs to probably be moved to the repository project or in a system test See REPO-2028 and follow up : REPO-3019 */
    @Test
    ...
    /**
     * MNT-12680 The creation date of version should be the same as creation date of the original node
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test that updating properties does not automatically create a new version. Test that updating content creates a new version automatically.
     * 
     */
    @Test
    ...
    /**
     * Test that updating properties does automatically create a new version if <b>autoVersion</b>, <b>initialVersion</b> and <b>autoVersionOnUpdateProps</b> are TRUE
     */
    @Test
    ...
    /**
     * 1) Creating a file with incorrect char in description property 2) Get xml with incorrect char in description 3) Check xml
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * 1) Creating a file with currency symbols in the name, title and description (MNT-15044) 2) Get the document with correct chars in the properties.
     * 
     * @throws Exception
     */
    @Test
     ...
     * </p>
     * <p>
     * A checkout should not lock the private working copy.
     * </p>
     * <p>
     * Adding aspects or properties to a pwc should remain possible after a checkout.
     * </p>
     * 
     * @throws Exception
     */
