...
public class NodeChangeTest {
    ...
    private void assertStandardData(
            Map<String, Serializable> auditMap, String expectedAction, String expectedSubActions) {
    ...
    public final void testGetAuditDataTrueSubAction() {
        ...
        assertFalse(
                "'sub-actions' should not exist in a subAction",
                auditMap.keySet().contains("sub-actions"));
    ...
    public final void testGetAuditDataFalseTopLevelAction() {
        ...
        assertTrue(
                "'sub-actions' should exist if not a subAction",
                auditMap.keySet().contains("sub-actions"));
    ...
    public final void testSetAuditSubActionsTrue() {
        ...
        assertEquals(
                "subAction audit should exist", "createNode", auditMap.get("sub-action/0/action"));
        assertEquals(
                "subAction audit should exist", "deleteNode", auditMap.get("sub-action/1/action"));
    }
    ...
    public final void testSetAuditSubActionsFalse() {
        ...
        assertFalse(
                "subAction audit should NOT exist",
                auditMap.keySet().contains("sub-action/0/action"));
        assertFalse(
                "subAction audit should NOT exist",
                auditMap.keySet().contains("sub-action/1/action"));
    }
    ...
    public final void testIsTemporaryNodeYes() {
        ...
        assertTrue(
                "A node was created and deleted so should have been temporary.",
    ...
    public final void testOnMoveNode() {
        ...
        when(fromChildAssocRef.getChildRef())
                .thenReturn(content1); // correct as the move has taken place
    ...
    public final void testOnUpdateProperties() {
        ...
        assertEquals(
                "location",
                ((Map<?, ?>) auditMap.get("properties/from")).get(ContentModel.PROP_LOCATION));
        assertEquals("location", auditMap.get("properties/from/cm:location"));

        assertEquals(1, ((Map<?, ?>) auditMap.get("properties/to")).size());
        assertEquals(
                "LOCATION",
                ((Map<?, ?>) auditMap.get("properties/to")).get(ContentModel.PROP_LOCATION));
        assertEquals("LOCATION", auditMap.get("properties/to/cm:location"));

        assertEquals(2, ((Map<?, ?>) auditMap.get("properties/add")).size());
        assertEquals(
                "AUTHOR",
                ((Map<?, ?>) auditMap.get("properties/add")).get(ContentModel.PROP_AUTHOR));
        assertEquals(
                "ADDRESSEE",
                ((Map<?, ?>) auditMap.get("properties/add")).get(ContentModel.PROP_ADDRESSEE));
        ...
        assertEquals(
                "created",
                ((Map<?, ?>) auditMap.get("properties/delete")).get(ContentModel.PROP_CREATED));
        assertEquals(
                "creator",
                ((Map<?, ?>) auditMap.get("properties/delete")).get(ContentModel.PROP_CREATOR));
        assertEquals(
                "content",
                ((Map<?, ?>) auditMap.get("properties/delete")).get(ContentModel.PROP_CONTENT));
    ...
    public final void testOnAddAspect() {
        ...
        assertTrue(
                "Grouped cm:archived aspect missing",
                ((Set<?>) auditMap.get("aspects/add")).contains(ContentModel.ASPECT_ARCHIVED));
        assertTrue(
                "Grouped cm:emailed aspect missing",
                ((Set<?>) auditMap.get("aspects/add")).contains(ContentModel.ASPECT_EMAILED));
        assertTrue(
                "Grouped cm:geographic aspect missing",
                ((Set<?>) auditMap.get("aspects/add")).contains(ContentModel.ASPECT_GEOGRAPHIC));
        assertTrue(
                "Individual cm:archived aspect missing",
                auditMap.containsKey("aspects/add/cm:archived"));
        assertTrue(
                "Individual cm:emailed aspect missing",
                auditMap.containsKey("aspects/add/cm:emailed"));
        assertTrue(
                "Individual cm:geographic aspect missing",
                auditMap.containsKey("aspects/add/cm:geographic"));
    }
    ...
    public final void testOnRemoveAspect() {
        ...
        assertTrue(
                "Grouped cm:archived aspect missing",
                ((Set<?>) auditMap.get("aspects/delete")).contains(ContentModel.ASPECT_ARCHIVED));
        assertTrue(
                "Grouped cm:emailed aspect missing",
                ((Set<?>) auditMap.get("aspects/delete")).contains(ContentModel.ASPECT_EMAILED));
        assertTrue(
                "Grouped cm:geographic aspect missing",
                ((Set<?>) auditMap.get("aspects/delete")).contains(ContentModel.ASPECT_GEOGRAPHIC));
        assertTrue(
                "Individual cm:archived aspect missing",
                auditMap.containsKey("aspects/delete/cm:archived"));
        assertTrue(
                "Individual cm:emailed aspect missing",
                auditMap.containsKey("aspects/delete/cm:emailed"));
        assertTrue(
                "Individual cm:geographic aspect missing",
                auditMap.containsKey("aspects/delete/cm:geographic"));
    }
    ...
    public final void testOnCreateVersion() {
        ...
        assertEquals(
                "Grouped description version-properties missing",
                "This is a test",
                ((Map<?, ?>) auditMap.get("version-properties")).get(Version.PROP_DESCRIPTION));
        assertEquals(
                "Individual description version-properties missing",
                "This is a test",
                auditMap.get("version-properties/description"));
    }
