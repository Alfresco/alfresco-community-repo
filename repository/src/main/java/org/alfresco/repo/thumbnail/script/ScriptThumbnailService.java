...
public class ScriptThumbnailService extends BaseScopableProcessorExtension {
  ...
  public boolean isThumbnailNameRegistered(String thumbnailName) {
    return (
      this.serviceRegistry.getThumbnailService()
  ...
  public String getMimeAwarePlaceHolderResourcePath(
    ...
    Map<String, String> extensionsByMimetype = serviceRegistry
      .getMimetypeService()
    ...
    if (extension != null) {
      ...
      ThumbnailDefinition details = serviceRegistry
        .getThumbnailService()
        .getThumbnailRegistry()
        .getThumbnailDefinition(thumbnailName);
      if (details != null) {
        ...
        if (resourcePath != null) {
          ...
          String formattedResourcePath = MessageFormat.format(
            resourcePath,
            mimeFragment
          );
          boolean iconResourceExists = classpathResourceExists(
