...
public class GetTypeTests extends RestTest {
    ...
    public void getInexistentType() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_WAS_NOT_FOUND, unknownType));
    }
    ...
    public void getType() throws Exception {
        ...
        type.assertThat()
                ...
                .isNotEmpty()
                .and()
                .field("includedInSupertypeQuery")
                .is(true)
                .and()
                .field("isArchive")
                .is(true)
                ...
                .is("Alfresco Content Domain Model")
                .and()
                .field("model.namespaceUri")
                .is("http://www.alfresco.org/model/content/1.0")
                .and()
                .field("model.namespacePrefix")
                .is("cm");
    }
}
