...
public class JscriptWorkflowDefinition implements Serializable {
    ...
    /**
     * Create a new instance of <code>WorkflowDefinition</code> from a CMR workflow object model
     * WorkflowDefinition instance
     *
     * @param cmrWorkflowDefinition an instance of WorkflowDefinition from the CMR workflow object
     *     model
     * @param serviceRegistry reference to the Service Registry
     * @param scope the root scripting scope for this object
     */
    public JscriptWorkflowDefinition(
            final WorkflowDefinition cmrWorkflowDefinition,
    ...
    /**
     * Start workflow instance from workflow definition without attaching any package node to the
     * workflow
     *
     * @param properties Associative array of properties used to populate the start task properties
     ...
     *
     * @param workflowPackage workflow package node to 'attach' to the new workflow instance
     * @param properties Associative array of properties used to populate the start task properties
     * @return the initial workflow path
     */
    @SuppressWarnings("unchecked")
    public JscriptWorkflowPath startWorkflow(ScriptNode workflowPackage, Object properties) {
        ...
        if (workflowPackage != null) {
            ...
            workflowParameters.put(
                    ...
                    getValueConverter().convertValueForRepo(workflowPackage));
        }
        ...
        for (WorkflowInstance cmrWorkflowInstance : cmrWorkflowInstances) {
            activeInstances.add(
                    new JscriptWorkflowInstance(
                            cmrWorkflowInstance, this.serviceRegistry, this.scope));
        }
                ...
                (Scriptable)
                        getValueConverter()
                                .convertValueForScript(
                                        this.serviceRegistry, this.scope, null, activeInstances);
    ...
    /**
     * Helper to extract a map of properties from a scriptable object (generally an associative
     * array)
     *
     ...
     */
    private void extractScriptablePropertiesToMap(
