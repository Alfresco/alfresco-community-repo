...
public class AlfrescoRuntimeException extends RuntimeException {
    ...
    /** Helper factory method making use of variable argument numbers */
    public static AlfrescoRuntimeException create(
            Throwable cause, String msgId, Object... objects) {
     ...
     */
    public static RuntimeException makeRuntimeException(
            Throwable e, String msgId, Object... objects) {
     ...
     *
     * <p>If a localised message can not be found then the message Id is returned.
     *
    ...
    /**
     * Generate an error log number - based on MMDDXXXX - where M is month, D is day and X is an
