...
public class AbstractRenderingEngineTest extends TestCase {
    ...
    public void testCreateRenditionNodeAssoc() throws Exception {
        ...
        when(nodeService.createNode(
                        eq(source), eq(assocType), any(QName.class), any(QName.class), anyMap()))
        ...
        definition.setParameterValue(
                AbstractRenderingEngine.PARAM_TARGET_CONTENT_PROPERTY, contentPropName);
        engine.execute(definition, source);
        verify(nodeService)
                .createNode(
                        eq(source),
    ...
    public void testCheckSourceNodeExists() {
        ...
        RenditionDefinitionImpl definition =
                new RenditionDefinitionImpl("id", null, TestRenderingEngine.NAME);
        try {
            ...
            assertTrue(
                    e.getMessage()
                            .endsWith(
                                    "Cannot execute action as node does not exist:"
                                            + " http://test/sourceId"));
        }
    }
    ...
    public void testGetParameterWithDefault() {
        ...
        try {
            ...
            assertTrue(
                    e.getMessage()
                            .endsWith(
                                    "The parameter: Some-param must be of type:"
                                        + " java.lang.Booleanbut was of type: java.lang.String"));
        }
    }
    ...
    private RenditionDefinition makeRenditionDefinition(ChildAssociationRef renditionAssoc) {
        ...
        RenditionDefinition definition =
                new RenditionDefinitionImpl(
                        id, renditionAssoc.getQName(), TestRenderingEngine.NAME);
    ...
    private static class TestRenderingEngine extends AbstractRenderingEngine {
        ...
        protected void switchToFinalRenditionNode(
                RenditionDefinition renditionDef, NodeRef actionedUponNodeRef) {
            // Do nothing!
        }
    }
}
