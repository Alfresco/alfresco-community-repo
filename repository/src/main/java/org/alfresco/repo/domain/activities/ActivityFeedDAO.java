...
public interface ActivityFeedDAO extends ActivitiesDAO {
    public static final int MAX_LEN_USER_ID =
            255; // needs to match schema: feed_user_id, post_user_id
    ...
    public static final int MAX_LEN_ACTIVITY_SUMMARY =
            4000; // needs to match schema: activity_summary
    ...
    public List<ActivityFeedEntity> selectSiteFeedEntries(String siteUserId, int maxFeedItems)
            throws SQLException;
