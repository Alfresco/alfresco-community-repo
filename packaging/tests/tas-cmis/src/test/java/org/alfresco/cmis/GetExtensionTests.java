...
public class GetExtensionTests extends CmisTest {
  ...
  public void siteManagerCanGetExtensionsForValidFolder() throws Exception {
    cmisApi
      ...
      .assertThat()
      .hasAspectExtension(titledAspect);
  }
  ...
  @Test(
    groups = { "bug-ws-REPO-5394", TestGroup.REGRESSION, TestGroup.CMIS },
    expectedExceptions = CmisObjectNotFoundException.class
  )
  public void siteManagerCannotGetExtensionsForInvalidDocument()
    throws Exception {
  ...
  public void siteManagerCanGetExtensionsForCheckedOutDocument()
    throws Exception {
  ...
  public void nonInvitedUserCannotGetExtensionsInPrivateSite()
    throws Exception {
  ...
  public void nonInvitedUserCannotGetExtensionsInModeratedSite()
    throws Exception {
