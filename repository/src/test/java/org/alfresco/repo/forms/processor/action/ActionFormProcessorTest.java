...
public class ActionFormProcessorTest extends BaseAlfrescoSpringTest {
    ...
    public void before() throws Exception {
        ...
        this.transactionHelper =
                (RetryingTransactionHelper)
                        this.applicationContext.getBean("retryingTransactionHelper");
    ...
    /**
     * Create a node of the specified content type, under the specified parent node with the
     * specified cm:name.
     */
                ...
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        Form form =
                                formService.getForm(
                                        new Item(
                                                ActionFormProcessor.ITEM_KIND, "extract-metadata"));
                        ...
                        Map<String, FieldDefinition> fieldDefMap =
                                new HashMap<String, FieldDefinition>(fieldDefs.size());
        ...
        this.transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        PropertyFieldDefinition scriptRef =
                                (PropertyFieldDefinition) fieldDefMap.get("script-ref");
    ...
    private void validateExecuteAsynchronouslyField(Map<String, FieldDefinition> fieldDefMap) {
        ...
        PropertyFieldDefinition execAsync =
                (PropertyFieldDefinition) fieldDefMap.get("executeAsynchronously");
        ...
        assertEquals(
                "'executeAsynchronously' datatype was wrong", "boolean", execAsync.getDataType());
    }

    /**
     * REPO-2253 Community: ALF-21854 Action parameter lookup for "de_DE" falls back to "root"
     * locale instead of "de"
     */
    @Test
        ...
        try {
            ...
            transactionHelper.doInTransaction(
                    () -> {
                        ...
                        Map<String, FieldDefinition> fieldDefMap =
                                form.getFieldDefinitions().stream()
                                        .collect(
                                                Collectors.toMap(
                        ...
                        assertEquals(
                                "MIME-Type",
                                fieldDefMap
                                        .get(TransformActionExecuter.PARAM_MIME_TYPE)
                                        .getLabel());
                        return null;
                    });
        } finally {
        ...
        this.transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        Form form =
                                formService.getForm(
                                        new Item(ActionFormProcessor.ITEM_KIND, "move"), fields);
                        ...
                        AssociationFieldDefinition destFolderField =
                                (AssociationFieldDefinition)
                                        fieldDefMap.get(
                                                MoveActionExecuter.PARAM_DESTINATION_FOLDER);
                        assertNotNull(destFolderField);
                        PropertyFieldDefinition execAsyncField =
                                (PropertyFieldDefinition)
                                        fieldDefMap.get(ActionFormProcessor.EXECUTE_ASYNCHRONOUSLY);
        ...
        this.transactionHelper.doInTransaction(
                new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        for (ChildAssociationRef chAssRef :
                                nodeService.getChildAssocs(repositoryHelper.getCompanyHome())) {
                            System.err.println(
                                    nodeService.getProperty(
                                            chAssRef.getChildRef(), ContentModel.PROP_NAME));
                        }

                        Serializable cmName =
                                nodeService.getProperty(testNode, ContentModel.PROP_NAME);
                        String transformedNodeName = ((String) cmName).replace(".txt", ".xml");

                        NodeRef expectedTransformedNode =
    ...
    public static class ActionFormProcessorTestActionExecuter extends ActionExecuterAbstractBase {
        ...
        protected void addParameterDefinitions(List<ParameterDefinition> paramList) {
            paramList.add(
                    new ParameterDefinitionImpl(
                            "check", DataTypeDefinition.BOOLEAN, false, "Check"));
            paramList.add(
                    new ParameterDefinitionImpl("date", DataTypeDefinition.DATE, false, "Date"));
            paramList.add(
                    new ParameterDefinitionImpl(
                            "qname", DataTypeDefinition.QNAME, false, "QName", true));
            paramList.add(
                    new ParameterDefinitionImpl(
                            "nodeRefs", DataTypeDefinition.NODE_REF, false, "NodeRefs", true));
        }
        ...
        protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
            ...
            assertEquals(
                    "Parameter value should be ArrayList", qnameValue.getClass(), ArrayList.class);
