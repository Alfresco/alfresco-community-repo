...
/**
 * A content service that determines at runtime the store that the content associated with a node
 * should be routed to.
 *
...
public class RoutingContentService extends ContentServiceImpl {
    ...
    public RoutingContentService() {
        logger.warn(
                "Class 'RoutingContentService' has been deprecated and replaced by"
                        + " 'ContentServiceImpl'.");
    }
}
