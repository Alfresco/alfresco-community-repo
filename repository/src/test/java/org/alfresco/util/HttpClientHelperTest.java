...
public class HttpClientHelperTest extends TestCase {
    ...
    public void testHTTPSProxySettings() {
        ...
        // Proxy hosts always use plain HTTP connection when communicating with clients (by
    ...
    private void setHTTPSystemProperties(
            String host, Integer port, String user, String password, String nonProxyHosts) {
        clearHTTPSystemProperties();
        if (host != null) {
    ...
    private void setHTTPSSystemProperties(
            String host, Integer port, String user, String password, String nonProxyHosts) {
        clearHTTPSystemProperties();
        if (host != null) {
