...
/**
 * Custom {@link VariableType} that allows storing a list of {@link ActivitiScriptNode}s as a
 * process variable in activiti.
 *
...
public class ScriptNodeListVariableType extends SerializableType {
        ...
        if (value != null) {
            if (!(value instanceof ActivitiScriptNodeList)) {
                throw new ActivitiException(
                        "Passed value is not an instance of ActivitiScriptNodeList, cannot set"
                                + " variable value.");
            }
    ...
    public Object getValue(ValueFields valueFields) {
        ...
        if (!(serializable instanceof List<?>)) {
            throw new ActivitiException(
                    "Serializable stored in variable is not instance of List<NodeRef>, cannot get"
                            + " value.");
        }
