 ...
 *
 * <p>which can be used to indicate that:
 *
 * <p>- input results should be optionally permission checked up to a given maximum number of items
 * (and then cutoff - ie. hasMoreItems = true) - have permission been applied to output results and
 * were the permission checks cut-off (ie. hasMoreItems = true) either due to max items or
 * system-wide time limit
 *
 * @author janv
 * @since 4.0
 */
