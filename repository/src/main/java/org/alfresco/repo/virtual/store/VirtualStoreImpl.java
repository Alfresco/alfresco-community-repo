...
public class VirtualStoreImpl implements VirtualStore, VirtualFolderDefinitionResolver {
    ...
    public boolean isVirtual(NodeRef nodeRef) throws VirtualizationException {
        ...
        if (reference != null) {
            ...
            return Protocols.VIRTUAL.protocol.equals(protocol)
    ...
    public boolean canVirtualize(NodeRef nodeRef) throws VirtualizationException {
        ...
        if (runAsUser == null) {
            if (logger.isTraceEnabled()) {
                ...
                logger.trace(
                        "Virtualization check call in unauthenticated-context - stack trace"
                                + " follows:",
    ...
    @Override
    public Collection<NodeRef> materializeIfPossible(Collection<NodeRef> nodeRefs)
    ...
    public List<ChildAssociationRef> getChildAssocsByPropertyValue(
        ...
        for (ChildAssociationRef childAssociationRef : allAssociations) {
            Serializable propertyValue =
                    environment.getProperty(childAssociationRef.getChildRef(), propertyQName);
    ...
    public Reference getChildByName(Reference reference, QName assocTypeQName, String childName)
        ...
        if (theChild != null) {
            ...
            if (query != null) {
                ...
                PagingResults<Reference> result =
                        query.perform(environment, constraint, null, reference);
    ...
    private List<Reference> createChildReferences(
            Reference parent, VirtualFolderDefinition structure) throws ProtocolMethodException {
        ...
        return transactionHelper.doInTransaction(
                new RetryingTransactionCallback<VirtualFolderDefinition>() {
                    ...
                    public VirtualFolderDefinition execute() throws Throwable {
                        ...
                        Map<NodeRef, VirtualFolderDefinition> definitionsCache =
                                TransactionalResourceHelper.getMap(VIRTUAL_FOLDER_DEFINITION);
    ...
    public PagingResults<Reference> list(
        ...
        if (actual) {
            ...
            if (query != null) {
                ...
                PagingResultsSource<Reference> querySourc =
                        new PagingResultsSource<Reference>() {
    ...
    public List<Reference> list(Reference reference) throws VirtualizationException {
        ...
        final VirtualQuery query = structure.getQuery();
        if (query != null) {
            PagingResults<Reference> queryNodes =
                    query.perform(
                            environment,
                            new FilesFoldersConstraint(BasicConstraint.INSTANCE, true, true),
                            null,
    ...
    public List<Reference> search(
        ...
        if (includeSubFolders) {
            for (Reference childRef : childReferences) {
                List<Reference> childResults =
                        search(childRef, namePattern, fileSearch, folderSearch, includeSubFolders);
                ...
                if (namePattern == null) {
                    ...
                    vqConstraint =
                            new NamePatternPropertyValueConstraint(
                                    new FilesFoldersConstraint(
                                            BasicConstraint.INSTANCE, true, true),
                                    ContentModel.PROP_NAME,
                                    namePattern,
                                    environment.getNamespacePrefixResolver());
                }
                PagingResults<Reference> queryNodes =
                        query.perform(environment, vqConstraint, null, reference);
                result.addAll(queryNodes.getPage());
            }
        }
        return result;
        ...
        if (Protocols.VIRTUAL.protocol.equals(protocol)
            ...
            if (nodeProperties != null) {
                ...
                for (Entry<String, String> propertyValueEntry : propertyEntries) {
                    QName propertyQName =
                            QName.createQName(propertyValueEntry.getKey(), nsPrefixResolver);
    ...
    public FilingData createFilingData(
        ...
        FilingParameters filingParameters =
                new FilingParameters(
                        parentReference, assocTypeQName, assocQName, nodeTypeQName, properties);
    ...
    public AccessStatus hasPermission(Reference reference, String perm)
            throws VirtualizationException {
        return reference.execute(new HasPermissionMethod(this, userPermissions, perm));
    }

    @Override
    public AccessStatus hasPermission(Reference reference, PermissionReference perm)
            throws VirtualizationException {
    ...
    public NodePermissionEntry getSetPermissions(Reference reference)
        ...
        return reference.execute(
                new GetSetPermissionsMethod(
                        this, userPermissions, PermissionService.ALL_AUTHORITIES));
    }
    ...
    public Path getPath(Reference reference) throws VirtualizationException {
        ...
        while (virtualPathElement != null && virtualPathParent != null) {
            ...
            QName childQName =
                    QName.createQName(VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, childName);
    ...
    public NodeRef adhere(Reference reference, int mode) throws VirtualizationException {
        switch (mode) {
            ...
            case FILING_OR_MATERIAL_ADHERENCE:
                {
                    VirtualFolderDefinition vfDefinition =
