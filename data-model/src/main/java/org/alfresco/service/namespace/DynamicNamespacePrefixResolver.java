...
/**
 * A delegating namespace prefix resolver which allows local over rides from the delegate. Allows
 * standard/default prefixes to be available but over ridden as required.
 *
 * @author andyh
 */
