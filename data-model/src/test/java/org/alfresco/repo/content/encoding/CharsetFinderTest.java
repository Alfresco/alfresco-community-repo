...
public class CharsetFinderTest extends TestCase {
  ...
  public void testPlainText() throws Exception {
    ...
    Charset charset = charsetFinder.getCharset(
      is,
    ...
    is =
      new BufferedInputStream(
        new ByteArrayInputStream(test.getBytes("UTF-16"))
      );
    ...
    is =
      new BufferedInputStream(
        new ByteArrayInputStream(test.getBytes("UnicodeBig"))
      );
    charset = charsetFinder.getCharset(is, MimetypeMap.MIMETYPE_TEXT_PLAIN);
    assertNotNull(charset);
    assertEquals("UTF-16BE", charset.displayName());
    ...
    is =
      new BufferedInputStream(
        new ByteArrayInputStream(test.getBytes("UnicodeLittle"))
      );
    charset = charsetFinder.getCharset(is, MimetypeMap.MIMETYPE_TEXT_PLAIN);
    assertNotNull(charset);
    ...
    is =
      new BufferedInputStream(
        new ByteArrayInputStream(test.getBytes("UTF-32"))
      );
    charset = charsetFinder.getCharset(is, MimetypeMap.MIMETYPE_TEXT_PLAIN);
    assertNotNull(charset);
  ...
  public void test8BitText() throws Exception {
    ...
    InputStream is = new BufferedInputStream(
      new ByteArrayInputStream(for_iso_8859_1.getBytes("ISO-8859-1"))
    );
    Charset charset = charsetFinder.getCharset(
      is,
      MimetypeMap.MIMETYPE_TEXT_PLAIN
    ...
    is =
      new BufferedInputStream(
        new ByteArrayInputStream(for_iso_8859_7.getBytes("ISO-8859-7"))
      );
    charset = charsetFinder.getCharset(is, MimetypeMap.MIMETYPE_TEXT_PLAIN);
    assertNotNull(charset);
    ...
    is =
      new BufferedInputStream(
        new ByteArrayInputStream(for_cp1251.getBytes("CP1251"))
      );
    charset = charsetFinder.getCharset(is, MimetypeMap.MIMETYPE_TEXT_PLAIN);
    assertNotNull(charset);
  ...
  public void testShiftJSHtml() throws Exception {
    ...
    InputStream is = new BufferedInputStream(
      new ByteArrayInputStream(for_shift_js.getBytes("Shift_JIS"))
    );
