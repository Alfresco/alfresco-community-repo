...
public class VirtualizationConfigTestBootstrap {
  ...
  public void setTypeTemplatesQNameFilter(
    String typeTemplatesQNameFilterRegexp
  ) {
  ...
  public void setDownloadAssocaiationsFolder(
    NodeRefExpression downloadAssocaiationsFolder
  ) {
