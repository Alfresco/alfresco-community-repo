...
public class UpdateRecordScheduleGet
  ...
  private static final String MESSAGE_ALL_TEMPLATE =
    "Updated {0} records from {1} folders with updated disposition instructions.";
  private static final String MESSAGE_FOLDER_TEMPLATE =
    "Updated records in folder {0} with updated disposition instructions.";
                ...
                AuthenticationUtil.runAsSystem(
                  new AuthenticationUtil.RunAsWork<Integer>() {
                    ...
                    public Integer doWork() throws Exception {
                      DispositionSchedule schedule = dispositionService.getDispositionSchedule(
                        recordFolder
                      );
                      int innerRecordCount = 0;
                      if (
                        schedule != null && schedule.isRecordLevelDisposition()
                      ) {
                        ...
                        for (NodeRef record : records) {
                          if (
                            ...
                            if (
                              ...
                              dispositionService.updateNextDispositionAction(
                                record,
                                schedule
                              );
                              recordsManagementSearchBehaviour.onAddDispositionLifecycleAspect(
                                record,
                                null
                              );
                              innerRecordCount++;
