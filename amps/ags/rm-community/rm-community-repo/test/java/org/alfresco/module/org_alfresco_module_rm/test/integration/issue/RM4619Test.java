...
public class RM4619Test extends BaseRMTestCase {
  ...
  public void testConvertFolderToCategory() throws Exception {
     ...
     */
    final NodeRef recordCategory = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
      ...
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          assertEquals(
            ...
            nodeService.getType(recordCategory)
          );
          assertNotNull(
            nodeService.getProperty(recordCategory, PROP_IDENTIFIER)
          );
          return null;
        }
      },
  ...
  public void testConvertFolderToUnfiledRecordFolder() throws Exception {
     ...
     */
    final NodeRef folder1 = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
        public NodeRef run() throws Exception {
     ...
     */
    final NodeRef folder2 = doTestInTransaction(
      new Test<NodeRef>() {
        @Override
        public NodeRef run() throws Exception {
          FileInfo folder = fileFolderService.create(
