...
public class ProcessesRestEntityResource
  ...
  @WebApiParameters(
    value = {
      @WebApiParam(
        ...
        title = "The process instance will be started in the given process definition",
        kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
      ),
      @WebApiParam(
        name = "processDefinitionKey",
        title = "The process instance will be started in the latest version of the process definition having the given key",
        kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
      ),
      @WebApiParam(
        name = "businessKey",
        title = "The business key is a unique, user defined reference to the newly created process instance that can be used in future queries",
        kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
      ),
      @WebApiParam(
        name = "variables",
        title = "A set of process instance variables that will be set on the new process instance",
        kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
      ),
      @WebApiParam(
        name = "items",
        title = "A list of nodes in the repository that will be associated with this process instance",
        kind = ResourceParameter.KIND.HTTP_BODY_OBJECT
      ),
    }
  )
  public List<ProcessInfo> create(
    List<ProcessInfo> entity,
  ...
  @WebApiDescription(
    ...
    description = "Get information for the process instances"
  )
  @WebApiParameters(
    value = {
      @WebApiParam(
        name = "where",
        title = "Where parameter to define the process query",
  ...
  @Override
  @WebApiDescription(
    title = "Get a process instance image",
    description = "Get a process instance image"
  )
  ...
  @Override
  public ProcessInfo readById(String id, Parameters parameters)
    throws EntityNotFoundException {
