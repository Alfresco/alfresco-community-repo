...
public class MapBasedQueryWalker extends WalkerCallbackAdapter {
  ...
  public MapBasedQueryWalker(
    Set<String> supportedEqualsParameters,
  ...
  public void setSupportedGreaterThanParameters(
    Set<String> supportedGreaterThanParameters
  ) {
  ...
  public void setSupportedGreaterThanOrEqualParameters(
    ...
    this.supportedGreaterThanOrEqualParameters =
      supportedGreaterThanOrEqualParameters;
    if (greaterThanOrEqualProperties == null) {
      greaterThanOrEqualProperties = new HashMap<String, String>();
    }
  }

  public void setSupportedLessThanParameters(
    Set<String> supportedLessThanParameters
  ) {
  ...
  public void setSupportedLessThanOrEqualParameters(
    ...
    this.supportedLessThanOrEqualParameters =
      supportedLessThanOrEqualParameters;
  ...
  public void comparison(
    ...
    if (type == WhereClauseParser.EQUALS) {
      ...
      if (
        supportedGreaterThanParameters != null &&
      ...
      if (
        supportedGreaterThanOrEqualParameters != null &&
      ...
      if (
        supportedLessThanParameters != null &&
      ...
      if (
        supportedLessThanOrEqualParameters != null &&
    ...
    if (throwError) {
      throw new InvalidArgumentException(
        ...
        new Object[] {
          propertyName,
          propertyValue,
          WhereClauseParser.tokenNames[type],
        }
      );
    } else if (negated) {
  ...
  public String getProperty(String propertyName, int type) {
    if (type == WhereClauseParser.EQUALS) {
      ...
      type == WhereClauseParser.GREATERTHAN && greaterThanProperties != null
    ) {
      return greaterThanProperties.get(propertyName);
    } else if (
      type == WhereClauseParser.GREATERTHANOREQUALS &&
      greaterThanOrEqualProperties != null
    ) {
      return greaterThanOrEqualProperties.get(propertyName);
    } else if (
      type == WhereClauseParser.LESSTHAN && lessThanProperties != null
    ) {
      return lessThanProperties.get(propertyName);
    } else if (
      type == WhereClauseParser.LESSTHANOREQUALS &&
  ...
  protected void processVariable(
    ...
    if (
      (propertyValue.contains("_") || propertyValue.contains(":")) &&
      propertyValue.contains(" ")
    ) {
      int indexOfSpace = propertyValue.indexOf(' ');
      if (
        (
          propertyValue.contains("_") &&
          indexOfSpace > propertyValue.indexOf("_")
        ) ||
        (
          propertyValue.contains(":") &&
          indexOfSpace > propertyValue.indexOf(":")
        )
      ) {
