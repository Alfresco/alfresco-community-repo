...
public class RenditionVersionTests extends RestTest {
    ...
    /**
     * Sanity test for the following endpoints: POST /nodes/{nodeId}/versions/{versionId}/rendition
     * GET /nodes/{nodeId}/versions/{versionId}/renditions GET
    ...
    @TestRail(
            ...
            description =
                    "Verify that the rendition  can be created using POST"
                            + " /nodes/{nodeId}/versions/{versionId}/rendition")
    public void testRenditionForNodeVersions() throws Exception {
        ...
        STEP(
                "1. Update the node content in order to increase version, PUT"
        ...
        RestRenditionInfoModelCollection renditionInfoModelCollection =
                restClient.withCoreAPI().usingNode(file).getNodeVersionRenditionsInfo("1.1");
        restClient.assertStatusCodeIs(HttpStatus.OK);
        for (RestRenditionInfoModel restRenditionInfoModel :
                renditionInfoModelCollection.getEntries()) {
