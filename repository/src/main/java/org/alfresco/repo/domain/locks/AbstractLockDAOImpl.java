...
public abstract class AbstractLockDAOImpl implements LockDAO
{
     ...
     * 
     * @param optimistic
     *            <tt>true</tt> if a mismatch in the number of locked rows should be ignored.
     * @return <tt>true</tt> if the lock was successfully and fully updated using the lock token provided
     * @throws LockAcquisitionException
     *             if the method is pessimistic and the number of rows does not correspond to the number expected
     */
     ...
     * 
     * @param qnameNamespaceId
     *            the namespace entity ID
     ...
     *            the shared lock resource ID
     * @param exclusiveResourceId
     ...
     * 
     * @param sharedResourceId
     *            the specific resource to lock
     * @param exclusiveResourceId
     *            the exclusive lock that is being sought
     * @param lockToken
     *            the lock token to assign
     * @param timeToLive
     *            the time, in milliseconds, for the lock to remain valid
     * @return Returns the new lock
     * @throws ConcurrencyFailureException
     *             if the lock was already taken at the time of creation
     */
    ...
    /**
     * @param exclusiveLockResourceId
     *            the exclusive resource ID being locks
     * @param oldLockToken
     *            the lock token to change from
     * @param newLockToken
     *            the new lock token
     * @param timeToLive
