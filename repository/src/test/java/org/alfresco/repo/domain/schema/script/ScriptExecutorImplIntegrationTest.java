...
public class ScriptExecutorImplIntegrationTest {
  ...
  private static final Log log = LogFactory.getLog(
    ScriptExecutorImplIntegrationTest.class
  );
  ...
  public void setUp() throws Exception {
    scriptExecutor =
      ctx.getBean("simpleScriptExecutor", ScriptExecutorImpl.class);
  ...
  public void canExecuteBasicScript() throws Exception {
    ...
    String select =
      "select textfield from alf_test_script_exec order by textfield asc";
  ...
  public void canExecuteGenericDialectScript() throws Exception {
    scriptExecutor.executeScriptUrl(
      "scriptexec/${db.script.dialect}/generic.sql"
    );
  ...
  public void canExecuteSpecificDialectScript() throws Exception {
    scriptExecutor.executeScriptUrl(
      "scriptexec/${db.script.dialect}/specific.sql"
    );
    ...
    if (dialect.getClass().equals(MySQLInnoDBDialect.class)) {
      ...
      log.warn(
        "No suitable dialect-specific DB script for test canExecuteSpecificDialectScript()"
      );
    }
  }
   ...
   */
  @Test
  public void canExecuteSpecificDialectOverridingGenericScript()
    throws Exception {
    scriptExecutor.executeScriptUrl(
      "scriptexec/${db.script.dialect}/override.sql"
    );
    ...
    if (dialect.getClass().equals(MySQLInnoDBDialect.class)) {
      ...
      log.warn(
        "No suitable dialect-specific DB script for test canExecuteSpecificDialectOverridingGenericScript()"
      );
    }
  }
  ...
  public void exceptionThrownWhenNoMatchingScriptFound() throws Exception {
    try {
      scriptExecutor.executeScriptUrl(
        "scriptexec/${db.script.dialect}/non-existent-file.sql"
      );
  ...
  public void emptyCustomDelimiter() throws Exception {
    try {
      scriptExecutor.executeScriptUrl(
        "scriptexec/${db.script.dialect}/empty-delimiter.sql"
      );
  ...
  public void wrongUsageCustomDelimiter() throws Exception {
    try {
      scriptExecutor.executeScriptUrl(
        "scriptexec/${db.script.dialect}/wrong-usage-delimiter.sql"
      );
      fail("Script execution should fail.");
    } catch (AlfrescoRuntimeException e) {
  ...
  public void unterminatedCustomDelimiter() throws Exception {
    try {
      scriptExecutor.executeScriptUrl(
        "scriptexec/${db.script.dialect}/unterminated-custom-delimiter.sql"
      );
      fail("Script execution should fail.");
    } catch (AlfrescoRuntimeException e) {
  ...
  public void customDelimiter() throws Exception {
    scriptExecutor.executeScriptUrl(
      "scriptexec/${db.script.dialect}/custom-delimiter.sql"
    );
  ...
  public void deleteNonExists() throws Exception {
    scriptExecutor.executeScriptUrl(
      "scriptexec/${db.script.dialect}/delete-not-exists.sql"
    );
