...
public class CMISTest {
  ...
  private static final QName TEST_START_TASK = QName.createQName(
    "http://www.alfresco.org/model/workflow/test/1.0",
    "startTaskVarScriptAssign"
  );
  private static final QName TEST_WORKFLOW_TASK = QName.createQName(
    "http://www.alfresco.org/model/workflow/test/1.0",
    "assignVarTask"
  );
  ...
  public void before() {
    ...
    this.factory =
      (AlfrescoCmisServiceFactory) ctx.getBean("CMISServiceFactory");
    this.versionService = (VersionService) ctx.getBean("versionService");
    ...
    this.workflowAdminService =
      (WorkflowAdminService) ctx.getBean("workflowAdminService");
    this.authenticationContext =
      (AuthenticationContext) ctx.getBean("authenticationContext");
    this.tenantAdminService =
      (TenantAdminService) ctx.getBean("tenantAdminService");
    ...
    this.globalProperties =
      (java.util.Properties) ctx.getBean("global-properties");
  ...
  public void testIsLatestMajorVersionMNT10868() {
    CallContext context = new SimpleCallContext(
      "admin",
      "admin",
  ...
  private PropertyData<?> getPropIsLatestMajorVersion(ObjectData objectData) {
    List<PropertyData<?>> properties = objectData
      .getProperties()
      .getPropertyList();
    boolean found = false;
    ...
    assertTrue(
      "The PropertyIds.IS_LATEST_MAJOR_VERSION property was not found",
      found
    );
    if (found) {
  ...
  public void testCheckIn() {
    ...
    final QName authorisedByQname = QName.createQName(
      customModel,
      "authorisedBy"
    );
    ...
    try {
      ...
      assertTrue(
        nodeService.getProperty(fileInfo.getNodeRef(), authorisedByQname) ==
        null
      );
    } finally {
  ...
  public void testModelAvailability() throws Exception {
    ...
    List<java.util.Properties> definitions = new ArrayList<java.util.Properties>(
      1
    );
    ...
    try {
      List<RepositoryInfo> repositories = service.getRepositoryInfos(null);
      assertTrue(repositories.size() > 0);
      List<TypeDefinitionContainer> container = service.getTypeDescendants(
  ...
  private FileInfo createContent(
    ...
    final FileInfo folderInfo = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<FileInfo>() {
          @Override
          public FileInfo execute() throws Throwable {
            ...
            if (isRule) {
              ...
              assertTrue(
                ruleService.getRules(folderInfo.getNodeRef()).size() > 0
              );
            }
  ...
  private Rule addRule(boolean isAppliedToChildren, String title) {
    ...
    // Create the action
    org.alfresco.service.cmr.action.Action action = actionService.createAction(
      title
    );
    action.setParameterValues(conditionProps);

    ActionCondition actionCondition = actionService.createActionCondition(
  ...
  public void testContentMimeTypeDetection() {
    ...
    AuthenticationComponent authenticationComponent = (AuthenticationComponent) ctx.getBean(
    ...
    // get repository id
    List<RepositoryInfo> repositories = withCmisService(
      new CmisServiceCallback<List<RepositoryInfo>>() {
        @Override
        public List<RepositoryInfo> execute(CmisService cmisService) {
          List<RepositoryInfo> repositories = cmisService.getRepositoryInfos(
            null
          );
          return repositories;
        }
    ...
    properties.addProperty(
      new PropertyIdImpl(PropertyIds.OBJECT_TYPE_ID, objectTypeId)
    );
    String fileName = "textFile" + GUID.generate();
    properties.addProperty(new PropertyStringImpl(PropertyIds.NAME, fileName));
    final ContentStreamImpl contentStream = new ContentStreamImpl(
      fileName,
      MimetypeMap.MIMETYPE_TEXT_PLAIN,
      "Simple text plain document"
    );

    String objectId = withCmisService(
      new CmisServiceCallback<String>() {
        @Override
        public String execute(CmisService cmisService) {
          String objectId = cmisService.create(
            repositoryId,
            properties,
    ...
    {
      final ContentStreamImpl contentStreamHTML = new ContentStreamImpl(
        null,
        null,
      ...
      // check mimetype
      ObjectData objectData = withCmisService(
      ...
      String contentType = withCmisService(
        new CmisServiceCallback<String>() {
          @Override
          public String execute(CmisService cmisService) {
            String contentType = cmisService
    ...
    {
      String mimeType =
        MimetypeMap.MIMETYPE_TEXT_PLAIN + "; charset=" + isoEncoding;
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          @Override
          public Void execute(CmisService cmisService) {
            Holder<String> latestObjectIdHolder = getHolderOfObjectOfLatestVersion(
              cmisService,
              repositoryId,
              objectIdHolder
            );
      ...
      // check mimetype
      final ObjectData objectData = withCmisService(
        new CmisServiceCallback<ObjectData>() {
          @Override
          public ObjectData execute(CmisService cmisService) {
            ObjectData objectData = cmisService.getObjectByPath(
    ...
    {
      String mimeType =
        MimetypeMap.MIMETYPE_TEXT_PLAIN + "; charset=" + utfEncoding;
      // NOTE that we intentionally specify the wrong charset here.
      ...
      final ContentStream contentStreamHTML = new ContentStreamImpl(
        null,
        BigInteger.valueOf(buf.length),
        mimeType,
        input
      );
      withCmisService(
    ...
    {
      ObjectData objectDa = withCmisService(
        new CmisServiceCallback<ObjectData>() {
          @Override
          public ObjectData execute(CmisService cmisService) {
            return cmisService.getObjectByPath(
  ...
  protected void checkEncoding(
    ...
    try {
      ...
      ContentDataWithId contentData = (ContentDataWithId) properties2.get(
        QName.createQName("{http://www.alfresco.org/model/content/1.0}content")
      );
  ...
  private Holder<String> getHolderOfObjectOfLatestVersion(
    ...
    ObjectData oData = cmisService.getObjectOfLatestVersion(
      repositoryId,
  ...
  public void testCancelCheckout() {
    ...
    try {
        ...
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            try {
              ...
              ObjectData originalDoc = cmisService.getObject(
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            Map<String, PropertyData<?>> properties = originalDoc
              .getProperties()
              .getProperties();
            PropertyData<Boolean> isVersionSeriesCheckedOutProp = (PropertyData<Boolean>) properties.get(
      ...
      List<FileInfo> children = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
  ...
  public void testDeleteTree() {
    ...
    try {
      ...
      final NodeRef childFolder2NodeRef = createContent(
        childFolder1,
        childFolder2Name,
        docName,
        false
      ...
      List<FileInfo> childFolder2FileList = fileFolderService.list(
        childFolder2NodeRef
      );
      final NodeRef childFolder2FileNodeRef = childFolder2FileList
        .get(0)
        .getNodeRef();
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            // CMIS delete tree:
            FailedToDeleteData failedItems = cmisService.deleteTree(
              repositoryId,
              parentFolderID,
              Boolean.TRUE,
              UnfileObject.DELETE,
            ...
            // Check parentFolder:
            NodeRef archivedParentFolderNodeRef = nodeArchiveService.getArchivedNode(
              parentFolderNodeRef
            );
            assertTrue(
              nodeService
            ...
            // Check childFolder1:
            NodeRef archivedChildFolder1NodeRef = nodeArchiveService.getArchivedNode(
              childFolder1NodeRef
            );
            assertTrue(
              nodeService
            ...
            // Check childFolder2:
            NodeRef archivedChildFolder2NodeRef = nodeArchiveService.getArchivedNode(
              childFolder2NodeRef
            );
            assertTrue(
              nodeService
            ...
            NodeRef archivedChildFolder2FileNodeRef = nodeArchiveService.getArchivedNode(
              childFolder2FileNodeRef
            );
            assertTrue(
              nodeService
      ...
      if (
        parentFolder != null &&
        fileFolderService.exists(parentFolder.getNodeRef())
      ) {
  ...
  public void testDeleteFolder() {
    ...
    final Map<FileInfo, Boolean> testFolderMap = new HashMap<FileInfo, Boolean>(
      4
    );
    ...
    try {
      ...
      FileInfo folderWithRule = createContent(
        folderNameRule,
        docNameRule,
        true
      );
      ...
      FileInfo folderEmptyWithRule = createContent(
        folderNameEmptyRule,
        null,
        true
      );
  ...
  public void testOrderByCreationAndModificationDate() {
    ...
    final List<FileInfo> expectedChildrenByCreationDate = new ArrayList<FileInfo>(
      10
    );
    final List<FileInfo> expectedChildrenByModificationDate = new ArrayList<FileInfo>(
      10
    );
    ...
    withCmisService(
      new CmisServiceCallback<Void>() {
        ...
        public Void execute(CmisService cmisService) {
          ...
          ObjectInFolderList children = cmisService.getChildren(
            repositoryId,
            folderId,
            null,
            orderBy,
          ...
          for (ObjectInFolderData child : children.getObjects()) {
            Map<String, PropertyData<?>> properties = child
              .getObject()
              .getProperties()
              .getProperties();

            PropertyData<?> pObjectId = properties.get(
              PropertyIds.VERSION_SERIES_ID
            );
            String actualObjectId = (String) pObjectId.getFirstValue();
            PropertyData<?> pCreationDate = properties.get(
          ...
          for (ObjectInFolderData child : children.getObjects()) {
            ...
            String actualObjectId = (String) pObjectId.getFirstValue();
            PropertyData<?> pModificationDate = properties.get(
            ...
            FileInfo expectedChild = expectedChildrenByModificationDate.get(
              i++
            );
            assertEquals(expectedChild.getNodeRef().toString(), actualObjectId);
            assertEquals(
  ...
  public void testSecondaryTypes() {
    ...
    // get repository id
    final String repositoryId = withCmisService(
      new CmisServiceCallback<String>() {
        @Override
        public String execute(CmisService cmisService) {
          List<RepositoryInfo> repositories = cmisService.getRepositoryInfos(
    ...
    final String objectId = withCmisService(
      new CmisServiceCallback<String>() {
        @Override
        public String execute(CmisService cmisService) {
          final PropertiesImpl properties = new PropertiesImpl();
    ...
    final Properties currentProperties = withCmisService(
      new CmisServiceCallback<Properties>() {
        @Override
        public Properties execute(CmisService cmisService) {
          Properties properties = cmisService.getProperties(
            repositoryId,
    ...
    List<String> secondaryTypeIds = (List<String>) currentProperties
      .getProperties()
    ...
    final Set<String> sysAspectsToAdd = new HashSet<>(
      Arrays.asList("P:sys:undeletable", "P:sys:hidden")
    );
    // Pre-condition of further test is that these aspects are not present
    assertEquals(
      0,
      secondaryTypeIds.stream().filter(sysAspectsToAdd::contains).count()
    );
    ...
    newProperties.replaceProperty(
      new PropertyStringImpl(PropertyIds.NAME, updatedName)
    );
    ...
    Properties currentProperties1 = withCmisService(
      new CmisServiceCallback<Properties>() {
        @Override
        public Properties execute(CmisService cmisService) {
          Holder<String> latestObjectIdHolder = getHolderOfObjectOfLatestVersion(
    ...
    secondaryTypeIds =
      (List<String>) currentProperties1
        .getProperties()
        .get(PropertyIds.SECONDARY_OBJECT_TYPE_IDS)
        .getValues();
        ...
        .doInTransaction(
          new RetryingTransactionCallback<FileInfo>() {
            ...
            public FileInfo execute() throws Throwable {
              ...
              QName testIntTypeQName = QName.createQName(
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            TypeDefinition typeDef = cmisService.getTypeDefinition(
              repositoryId,
              "D:tcim:testintegerstype",
              null
            );
            ...
            assertTrue(
              intWithBoundsTypeDef.getMaxValue().equals(BigInteger.valueOf(10L))
            );
  ...
  private void setProperiesToObject(
    ...
    PropertyIntegerImpl pd = (PropertyIntegerImpl) properties
      .getProperties()
      .get(propertyStr);
  ...
  public void testMNT9090() throws Exception {
    ...
    try {
        ...
        .doInTransaction(
          new RetryingTransactionCallback<FileInfo>() {
            ...
            public FileInfo execute() throws Throwable {
              ...
              QName ASPECT_AUDIO = QName.createQName(
      ...
      assertTrue(
        e.getMessage().startsWith("Value is out of range for property")
      );
      // ok
    } finally {
      AuthenticationUtil.popAuthentication();
  ...
  public void testGetContentChanges() {
    ...
    try {
       ...
       */
      ObjectList ol =
        this.cmisConnector.getContentChanges(
            changeLogToken,
            new BigInteger("2")
          );
       ...
       */
      Long latestToken = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
    ...
    withCmisService(
      new CmisServiceCallback<String>() {
        ...
        public String execute(CmisService cmisService) {
          ...
          ObjectData cmidDoc = cmisService.getObject(
            repositoryId,
            objectId,
            null,
            true,
          ...
          List<PropertyData<?>> properties = cmidDoc
            .getProperties()
            .getPropertyList();
          boolean found = false;
          PropertyData<?> propIsLatestMajorVersion = null;
          ...
          assertTrue(
            "The CMISDictionaryModel.PROP_IS_LATEST_MAJOR_VERSION property was not found",
            found
          );
          if (found) {
            assertFalse(
    ...
    withCmisService(
      new CmisServiceCallback<String>() {
        ...
        public String execute(CmisService cmisService) {
          ...
          TypeDefinition def = cmisService.getTypeDefinition(
            repositoryId,
            "cmis:item",
            null
          );
          ...
          @SuppressWarnings("unused")
          TypeDefinition p = cmisService.getTypeDefinition(
            repositoryId,
            "I:cm:person",
            null
          );
          ...
          ObjectList result = cmisService.query(
            repositoryId,
        ...
        .doInTransaction(
          new RetryingTransactionCallback<Void>() {
            ...
            public Void execute() throws Throwable {
              ...
              // and document
              FileInfo document = fileFolderService.create(
                folderInfo.getNodeRef(),
                DOCUMENT_NAME,
                ContentModel.TYPE_CONTENT
              );
      ...
      withCmisService(
        new CmisServiceCallback<String>() {
          ...
          public String execute(CmisService cmisService) {
            ...
            TypeDefinition tpdfn = cmisService.getTypeDefinition(
              repositoryId,
              "I:sctst:client",
              null
            );
            assertNotNull("the I:sctst:client type is not defined", tpdfn);
            TypeDefinition aspectDfn = cmisService.getTypeDefinition(
              repositoryId,
              "P:sctst:clientRelated",
              null
            );
            assertNotNull(
              "the P:sctst:clientRelated aspect is not defined",
              aspectDfn
            );
            TypeDefinition relDfn = cmisService.getTypeDefinition(
              repositoryId,
              "R:sctst:relatedClients",
              null
            );
            assertNotNull(
            ...
            properties.addProperty(
              new PropertyStringImpl("sctst:clientId", "id" + GUID.generate())
            );
            properties.addProperty(
              new PropertyStringImpl("sctst:clientName", CLIENT_NAME)
            );

            ObjectData folderData = cmisService.getObjectByPath(
              repositoryId,
              "/" + FOLDER_NAME,
              null,
              null,
            ...
            ObjectData contentData = cmisService.getObjectByPath(
              repositoryId,
            ...
            Properties props = cmisService.getProperties(
              repositoryId,
              contentData.getId(),
              null,
              null
            ...
            PropertyData<?> propAspects = props
              .getProperties()
              .get(PropertyIds.SECONDARY_OBJECT_TYPE_IDS);
            ...
            aspects =
              cmisService
                .getProperties(repositoryId, contentData.getId(), null, null)
                .getProperties()
                .get(PropertyIds.SECONDARY_OBJECT_TYPE_IDS)
                .getValues();
            assertTrue(
            ...
            ObjectData itemData = cmisService.getObjectByPath(
              repositoryId,
  ...
  public void testMNT10529() throws Exception {
    ...
    try {
      final Pair<FileInfo, FileInfo> folderAndDocument = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            String objectIdStr = folderAndDocument
              .getFirst()
              .getNodeRef()
              .toString();
          ...
          private void assertChildren(
            ...
            PropertyData<?> nameData = children
              .getObjects()
              .iterator()
              .next()
              .getObject()
  ...
  public void mnt10548test() throws Exception {
    ...
    ObjectData objData = withCmisService(
      new CmisServiceCallback<ObjectData>() {
        ...
        public ObjectData execute(CmisService cmisService) {
          ...
          ObjectData objData = cmisService.getObjectByPath(
            repositoryId,
            path,
            null,
            false,
    ...
    Map<String, PropertyData<?>> cmisProps = objData
      .getProperties()
      .getProperties();

    String taggable = ContentModel.ASPECT_TAGGABLE
    ...
    for (Object o : props) {
      assertTrue(
        o.getClass() + " found but String expected",
        o instanceof String
      );
    }
  }
  ...
  public void testMNT10021() throws Exception {
    ...
    try {
      ...
      List<CmisExtensionElement> propertyExtensionList = objectData
        .getProperties()
        .getExtensions();
      assertEquals(
      ...
      List<CmisExtensionElement> extensions = propertyExtensionList
        .iterator()
        .next()
        .getChildren();
    ...
    TenantUtil.runAsUserTenant(
      new TenantRunAsWork<Void>() {
        ...
        public Void doWork() throws Exception {
          ...
          TypeDefinitionWrapper td = cmisDictionaryService.findType(
            "D:daotest1:type1"
          );
          assertNotNull(td);
          return null;
  ...
  public void testMNT13529() throws Exception {
    ...
    try {
      ...
      final Long appId = auditSubsystem
        .getAuditApplicationByName("CMISChangeLog")
        .getApplicationId();
      ...
      transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(deletedCallback);

      // Retrieve initial latestChangeLogToken
      final String initialChangeLogToken = withCmisService(
        new CmisServiceCallback<String>() {
          @Override
          public String execute(CmisService cmisService) {
            List<RepositoryInfo> repositories = cmisService.getRepositoryInfos(
  ...
  public void testCMISChangeLogObjectIds() throws Exception {
    ...
    try {
      final String changeToken = withCmisService(
        new CmisServiceCallback<String>() {
          @Override
          public String execute(CmisService cmisService) {
            List<RepositoryInfo> repositories = cmisService.getRepositoryInfos(
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            ObjectList changes = cmisService.getContentChanges(
              repositoryId,
            ...
            for (ObjectData od : changes.getObjects()) {
              ...
              assertFalse(
                ...
                objectId
                  .toString()
                  .contains(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE.toString())
              );
            }
  ...
  public void testMoveRenameWithCMISshouldBeAuditedAsUPDATE() throws Exception {
    ...
    try {
      ...
      final String actualToken = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
      ...
      assertEquals(
        events.get(0).getChangeEventInfo().getChangeType(),
        ChangeType.CREATED
      );
      ...
      assertEquals(
        events.get(2).getChangeEventInfo().getChangeType(),
        ChangeType.UPDATED
      );

      // test rename
      final String actualToken2 = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<String>() {
            public String execute() throws Exception {
      ...
      FileInfo targetFolderInfo = fileFolderService.create(
        companyHomeNodeRef,
        targetFolder,
        ContentModel.TYPE_FOLDER
      );

      final String actualToken3 = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<String>() {
            public String execute() throws Exception {
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            TypeDefinition decimalTypeDef = cmisService.getTypeDefinition(
              repositoryId,
              "D:tcdm:testdecimalstype",
              null
            );
  ...
  public void testExtensionDataIsReturnedViaCmis1_1() throws Exception {
    ...
    final String FOLDER =
      "testExtensionDataIsReturnedViaCmis1_1-" + GUID.generate();
    ...
    try {
      ...
      List<CmisExtensionElement> extensions = objectData
        .getProperties()
        .getExtensions()
        .iterator()
        .next()
        ...
        if (CMISConnector.PROPERTIES.equals(extension.getName())) {
          ...
          for (CmisExtensionElement prop : propExtensions) {
            ...
            aspectProperties.add(
              cmisAspectProperty.get("propertyDefinitionId")
            );
          }
  ...
  public void testRemoveACL() throws Exception {
    ...
    try {
      ...
      final FileInfo document = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<FileInfo>() {
            @Override
    ...
    CmisServiceCallback<String> callback = new CmisServiceCallback<String>() {
      ...
      public String execute(CmisService cmisService) {
        ...
        for (int i = 0; i < types.length; i++) {
          ...
          for (PropertyDefinition<?> property : def
            .getPropertyDefinitions()
            .values()) {
            assertNotNull(
              "Property definition dispaly name is incorrect. Please, refer to ACE-2904.",
              property.getDisplayName()
            );
            assertNotNull(
              "Property definition description is incorrect. Please, refer to ACE-2904.",
    ...
    CmisServiceCallback<String> callback = new CmisServiceCallback<String>() {
      ...
      public String execute(CmisService cmisService) {
        for (int i = 0; i < types.length; i++) {
          ...
          List<TypeDefinitionWrapper> children = cmisDictionaryService.getChildren(
            types[i]
          );
          assertNotNull(children);
  ...
  public void testSetDeleteAppendContentStreamVersioning() throws Exception {
    ...
    try {
      final FileInfo doc = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<FileInfo>() {
            @Override
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            final String repositoryId = cmisService
              .getRepositoryInfos(null)
              .get(0)
              .getId();

            ObjectInfo objInfoInitialVersion = cmisService.getObjectInfo(
              repositoryId,
              documentNodeRefId
            );
            assertTrue(
            ...
            assertTrue(
              "The \"output\" parameter should returns the newly created version id: 1.1",
              objectIdHolder.getValue().endsWith("1.1")
            );
            // we can use this new version id to get information about the cmis object
            ObjectInfo objInfoAfterSetContentStream = cmisService.getObjectInfo(
              repositoryId,
              objectIdHolder.getValue()
            );
            assertTrue(
            ...
            assertTrue(
              "The \"output\" parameter should returns the newly created version id: 1.2",
            ...
            assertTrue(
              "The \"output\" parameter should returns the newly created version id: 1.3",
   ...
   */
  @Test
  public void testUpdatePropertiesSetDeleteContentVersioning()
    throws Exception {
    AuthenticationUtil.pushAuthentication();
    AuthenticationUtil.setFullyAuthenticatedUser(
      AuthenticationUtil.getAdminUserName()
    ...
    final String FOLDER =
      "testUpdatePropertiesSetDeleteContentVersioning-" + GUID.generate();
    final String DOC1 = "documentProperties1-" + GUID.generate();
    ...
    try {
      final List<FileInfo> docs = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<List<FileInfo>>() {
            @Override
        ...
        new CmisServiceCallback<String>() {
          ...
          public String execute(CmisService cmisService) {
            ...
            //This extra check was added due to MNT-16641.
            {
              ...
              Set<QName> existingAspects = nodeService.getAspects(
                docs.get(0).getNodeRef()
              );
              cmisService.updateProperties(
                repositoryId,
                new Holder<String>(docs.get(0).getNodeRef().toString()),
                null,
                properties,
                null
              );
              Set<QName> updatedAspects = nodeService.getAspects(
                docs.get(0).getNodeRef()
              );
    ...
    withCmisService(
      new CmisServiceCallback<Void>() {
        ...
        public Void execute(CmisService cmisService) {
          ...
          ObjectData data = cmisService.getObjectOfLatestVersion(
            repositoryId,
            nodeRef.toString(),
            null,
            Boolean.FALSE,
          ...
          PropertyData<?> prop = data
            .getProperties()
            .getProperties()
            .get(PropertyIds.VERSION_LABEL);
  ...
  public void testLastVersionOfVersionSeries() {
    ...
    final String FOLDER =
      "testUpdatePropertiesSetDeleteContentVersioning-" + GUID.generate(), DOC =
      "documentProperties-" + GUID.generate();

    try {
      final NodeRef nodeRef = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
      ...
      final String NEW_DOC_NAME = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<String>() {
            @Override
      ...
      List<ObjectData> versions = cmisService.getAllVersions(
        repositoryId,
        nodeRef.toString(),
        null,
        null,
      ...
      Object objectDescriptionString = object
        .getProperties()
        .getProperties()
        .get("cmis:name")
        .getValues()
        .get(0);
      Object latestVersionDescriptionString = latestVersion
        .getProperties()
        .getProperties()
        .get("cmis:name")
        .getValues()
      ...
      for (CmisExtensionElement cmisEE : object
        .getProperties()
        .getExtensions()
        .get(0)
        .getChildren()) {
      ...
      for (CmisExtensionElement cmisEE : latestVersion
        .getProperties()
        .getExtensions()
        .get(0)
        .getChildren()) {
  ...
  public void testVersioningPropertiesHaveDefaultValue() throws Exception {
    ...
    try {
      ...
      final NodeRef documentNodeRef = withCmisService(
        new CmisServiceCallback<NodeRef>() {
          ...
          public NodeRef execute(CmisService cmisService) {
            ...
            propsList.add(
              new PropertyIdImpl(PropertyIds.OBJECT_TYPE_ID, "cmis:folder")
            );

            String folderId = cmisService.createFolder(
              repositoryId,
            ...
            propsList.add(
              new PropertyIdImpl(PropertyIds.OBJECT_TYPE_ID, "cmis:document")
            );

            String nodeId = cmisService.createDocument(
              repositoryId,
              new PropertiesImpl(propsList),
              folderId,
              null,
          ...
          new RetryingTransactionCallback<List<Void>>() {
            ...
            public List<Void> execute() throws Throwable {
              ...
              for (QName qName : new QName[] {
                ...
                org.alfresco.service.cmr.dictionary.PropertyDefinition pd = properties.get(
                  qName
                );
      ...
      final NodeRef documentNodeRef = withCmisService(
        new CmisServiceCallback<NodeRef>() {
          ...
          public NodeRef execute(CmisService cmisService) {
            ...
            String nodeId = cmisService.create(
              repositoryId,
              properties,
              repositoryHelper.getCompanyHome().getId(),
              contentStream,
  ...
  public void testCMISGetObjectParents() throws Exception {
    ...
    try {
      final NodeRef folderWithTwoParents = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(
          new RetryingTransactionCallback<NodeRef>() {
            @Override
            public NodeRef execute() throws Throwable {
              ...
              FileInfo folderInfo1 = fileFolderService.create(
                companyHomeNodeRef,
                folder1,
                ContentModel.TYPE_FOLDER
              );
              ...
              FileInfo folderInfo2 = fileFolderService.create(
                companyHomeNodeRef,
                folder2,
                ContentModel.TYPE_FOLDER
              );
              ...
              FileInfo folderInfo11 = fileFolderService.create(
      ...
      withCmisService(
        new CmisServiceCallback<Void>() {
          ...
          public Void execute(CmisService cmisService) {
            ...
            List<ObjectParentData> parents = cmisService.getObjectParents(
              repositoryId,
  ...
  public void getAllVersionsWithNullObjectId() {
    ...
    List<ObjectData> versions = withCmisService(
    ...
    final Properties currentProperties = withCmisService(
      new CmisServiceCallback<Properties>() {
        ...
        public Properties execute(CmisService cmisService) {
          ...
          ObjectData pwc = cmisService.getObject(
            repositoryId,
            objectIdHolder.getValue(),
            null,
            null,
    ...
    final Properties currentProperties = withCmisService(
      new CmisServiceCallback<Properties>() {
        ...
        public Properties execute(CmisService cmisService) {
          ...
          Properties propertiesValues = cmisService.getProperties(
            repositoryId,
            objectIdHolder.getValue(),
            null,
            null
  ...
  public void testSearchPreviousDelete() {
    ...
    try {
      ...
      final NodeRef parentFolder = (NodeRef) transactionService
        .getRetryingTransactionHelper()
      ...
      withCmisService(
        new CmisServiceCallback<String>() {
          ...
          public String execute(CmisService cmisService) {
            ...
            // prepare cmis query
            String queryString =
              "SELECT cmis:name, cmis:objectId FROM cmis:folder WHERE IN_FOLDER('" +
              parentFolder +
              "')";
            cmisService.query(
              repositoryId,
  ...
  public void testMNT20006() throws Exception {
          ...
          .doInTransaction(
            new RetryingTransactionCallback<NodeRef>() {
              public NodeRef execute() throws Throwable {
                ...
                NodeRef siteDocLib = siteService.createContainer(
                  siteId,
    ...
    Boolean updated = withCmisService(
      nonMemberUsername,
      nonMemberPassword,
      new CmisServiceCallback<Boolean>() {
        ...
        public Boolean execute(CmisService cmisService) {
          ...
          try {
            ...
            // Id holder
            Holder<String> objectIdHolder = new Holder<String>(
              fileNode.toString()
            );
            ...
            newProperties.addProperty(
              new PropertyStringImpl(PropertyIds.DESCRIPTION, newDescription)
            );
            cmisService.updateProperties(
              repositoryId,
              objectIdHolder,
