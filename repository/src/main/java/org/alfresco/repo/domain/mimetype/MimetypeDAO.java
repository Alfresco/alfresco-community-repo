...
public interface MimetypeDAO {
    ...
    /**
     * Update a mimetype if it exists. This method does not do any conflict resolution i.e. it will
     * only succeed if the new mimetype does not exist already. Higher-level logic is required to
     * handle updates to dependent rows, etc.
     *
