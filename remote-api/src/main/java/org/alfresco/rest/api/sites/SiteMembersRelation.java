...
public class SiteMembersRelation
  ...
  @Override
  @WebApiDescription(
    title = "A paged list of all the members of the site 'siteId'."
  )
  public CollectionWithPagingInfo<SiteMember> readAll(
    String siteId,
  ...
  @Override
  @WebApiDescription(
    title = "Updates the membership of personId in the site (of which personId must be an existing member)."
  )
  public SiteMember update(
    String siteId,
  ...
  @Override
  @WebApiDescription(
    title = "Returns site membership information for personId in siteId."
  )
  public SiteMember readById(
    String siteId,
    String personId,
    Parameters parameters
  ) {
