...
public class AddFavoriteSiteTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify manager user add a favorite site with Rest API and response is"
                            + " successful (201)")
    public void managerUserAddFavoriteSiteWithSuccess() throws Exception {
        ...
        restClient
                .assertLastError()
                .containsSummary(
                        String.format("%s is already a favourite site", publicSite.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify a manager user is NOT Authorized to add a favorite site with Rest API"
    ...
    @TestRail(
            ...
            description =
                    "Verify collaborator user add a favorite site with Rest API and response is"
                            + " successful (201)")
    public void collaboratorUserAddFavoriteSiteWithSuccess() throws Exception {
        UserModel collaboratorUser = dataUser.usingAdmin().createRandomTestUser();
        dataUser.usingUser(userModel)
                .addUserToSite(collaboratorUser, publicSite, UserRole.SiteCollaborator);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor user add a favorite site with Rest API and response is"
                            + " successful (201)")
    public void contributorUserAddFavoriteSiteWithSuccess() throws Exception {
        UserModel contributorUser = dataUser.usingAdmin().createRandomTestUser();
        dataUser.usingUser(userModel)
                .addUserToSite(contributorUser, publicSite, UserRole.SiteContributor);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer user add a favorite site with Rest API and response is"
                            + " successful (201)")
    public void consumerUserAddFavoriteSiteWithSuccess() throws Exception {
        UserModel consumerUser = dataUser.usingAdmin().createRandomTestUser();
        dataUser.usingUser(userModel)
                .addUserToSite(consumerUser, publicSite, UserRole.SiteConsumer);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user add a favorite site with Rest API and response is successful"
                            + " (201)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify manager user is not able to add a favorite site when the site is"
                            + " already favorite - status code (409)")
    public void managerUserAddFavoriteSiteAlreadyAFavoriteSite() throws Exception {
        ...
        restClient
                ...
                .containsErrorKey(
                        String.format("Site %s is already a favourite site", publicSite.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user doesn't have permission to delete favorites of admin user with"
    ...
    public void managerAddsPrivateSiteAsFavorite() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingUser(managerUser)
                .addFavoriteSite(privateSite);
        restClient.assertStatusCodeIs(HttpStatus.CREATED);

        RestPersonFavoritesModelsCollection favorites =
                restClient.withCoreAPI().usingAuthUser().getFavorites();
        favorites
                .assertThat()
                .entriesListContains("targetGuid", privateSite.getGuidWithoutVersion())
                .and()
        ...
        favorites
                ...
                .assertThat()
                .field("description")
                .is(privateSite.getDescription())
                .and()
                .field("id")
                .is(privateSite.getId())
                .and()
                .field("visibility")
                .is(privateSite.getVisibility().toString())
                .and()
                .field("title")
                .is(privateSite.getTitle());
    }
    ...
    public void managerAddsModeratedSiteAsFavorite() throws Exception {
        UserModel managerUser = dataUser.usingAdmin().createRandomTestUser();
        dataUser.usingUser(userModel)
                .addUserToSite(managerUser, moderatedSite, UserRole.SiteManager);
        ...
        favorites
                .assertThat()
                .entriesListContains("targetGuid", moderatedSite.getGuidWithoutVersion())
                .and()
                .paginationField("totalItems")
                .is("1");
        favorites
                ...
                .and()
                .field("visibility")
                .is(moderatedSite.getVisibility().toString())
                .and()
                .field("title")
    ...
    @TestRail(
            ...
            description =
                    "Verify user removes a site from favorites using '-me-' in place of personId"
                            + " with Rest API and response is successful (201)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify empty user is not able to add a site from favorites and response is"
                            + " (400)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify inexistent user is not able to add a site from favorites and response"
                            + " is (404)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user is not able to add a favorite site when the 'id' is empty - status"
                            + " code (400)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user doesn't have permission to add a favorite site of another"
                            + " user with Rest API and status code is 403")
    ...
    public void addFavoriteSiteWithEmptyBody() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                RestErrorModel.NO_CONTENT, "Unrecognized field " + "\"ids\""));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non member user is not able to add a private favorite site - status"
                            + " code is 404")
    public void userAddFavoriteSiteUserNotMemberOfPrivateSite() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, privateSite.getId()))
                .containsErrorKey(RestErrorModel.ENTITY_NOT_FOUND_ERRORKEY)
                .descriptionURLIs(RestErrorModel.RESTAPIEXPLORER)
                .stackTraceIs(RestErrorModel.STACKTRACE);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that if user provides site in id but id is of a file status code is 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that if user provides site in id but id is of a folder status code is"
                            + " 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that if user provides site in id but id is of a comment status code is"
                            + " 404")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that if user provides site in id but id is of a tag status code is 404")
    public void addSiteFavoriteUsingTagId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, returnedModel.getId()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Check that if id does not describe a site, file, or folder status code is 400")
    public void addFavoriteUsingInvalidGuid() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, site.getId().split("/")[3]));
    }
}
