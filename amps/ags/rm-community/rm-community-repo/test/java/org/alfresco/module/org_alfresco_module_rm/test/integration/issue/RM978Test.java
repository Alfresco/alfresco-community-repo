  ...
  public void testMoveDocumentToFolderInCollabSite() {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest(user) {
        ...
        public void then() {
          List<ChildAssociationRef> folder1ChildAssocs = nodeService.getChildAssocs(
            folder1
          );
          assertEquals(0, folder1ChildAssocs.size());

          List<ChildAssociationRef> folder2ChildAssocs = nodeService.getChildAssocs(
            folder2
          );
          assertNotNull(folder2ChildAssocs);
          assertEquals(1, folder2ChildAssocs.size());
          NodeRef movedDocument = folder2ChildAssocs
            .iterator()
            .next()
            .getChildRef();
          String movedDocumentName = (String) nodeService.getProperty(
            movedDocument,
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest(user) {
        ...
        public void given() {
          folder1 =
            fileFolderService
              .create(documentLibrary, folder1Name, ContentModel.TYPE_FOLDER)
              .getNodeRef();
          folder2 =
            fileFolderService
              .create(
        ...
        public void then() {
          ...
          assertEquals(1, folder2ChildAssocs.size());
          NodeRef movedFolder = folder2ChildAssocs
            .iterator()
            .next()
            .getChildRef();
          String movedDocumentName = (String) nodeService.getProperty(
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest(user) {
        ...
        public void then() {
          ...
          List<ChildAssociationRef> rmFolderChildAssocs = nodeService.getChildAssocs(
            rmFolder
          );
          assertEquals(1, rmFolderChildAssocs.size());
          NodeRef movedDocument = rmFolderChildAssocs
            .iterator()
            .next()
            .getChildRef();
          String recordIdentifier = (String) nodeService.getProperty(
            movedDocument,
          ...
          assertEquals(
            document1Name + " (" + recordIdentifier + ")",
            movedDocumentName
          );
        }
      }
