	...
	<table cellpadding="2" cellspacing="2" border="0" width="100%">
		...
		<tr>
			...
			<td width="90%"></f:verbatim><h:inputText id="approve-step-name"
				value="#{EditSpaceSimpleWorkflowDialog.workflowProperties.approveStepName}"
			...
			<table cellpadding="2" cellspacing="2" border="0">
				<tr>
					<td valign="top"></f:verbatim><h:selectOneRadio
						value="#{EditSpaceSimpleWorkflowDialog.workflowProperties.approveAction}">
					...
					<table cellpadding="2" cellspacing="2" border="0">
						<tr>
							<td><nobr> </f:verbatim><h:outputText
								...
								id="reject-step-name"
								value="#{EditSpaceSimpleWorkflowDialog.workflowProperties.rejectStepName}"
						...
						<tr>
							...
							<table cellpadding="2" cellspacing="2" border="0">
								<tr>
									<td valign="top"></f:verbatim><h:selectOneRadio
										value="#{EditSpaceSimpleWorkflowDialog.workflowProperties.rejectAction}">
