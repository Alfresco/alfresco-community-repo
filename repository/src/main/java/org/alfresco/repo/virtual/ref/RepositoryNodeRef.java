...
public class RepositoryNodeRef implements RepositoryLocation {
  ...
  @Override
  public String stringify(Stringifier stringifier)
  ...
  @Override
  public InputStream openContentStream(ActualEnvironment environment)
    throws ActualEnvironmentException {
    return environment.openContentStream(nodeRef);
  }

  @Override
  public NodeRef asNodeRef(ActualEnvironment environment)
    throws ActualEnvironmentException {
    return getNodeRef();
  }
}
