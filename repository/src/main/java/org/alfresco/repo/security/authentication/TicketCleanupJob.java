...
public class TicketCleanupJob implements StatefulJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (abstractAuthenticationServiceRef == null
                || !(abstractAuthenticationServiceRef instanceof AbstractAuthenticationService)) {
        ...
        AbstractAuthenticationService abstractAuthenticationService =
                (AbstractAuthenticationService) abstractAuthenticationServiceRef;
