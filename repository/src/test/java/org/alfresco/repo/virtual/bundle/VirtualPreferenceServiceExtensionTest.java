...
public class VirtualPreferenceServiceExtensionTest
  ...
  private static final String EXT_DOCUMENTS_FAVOURITES =
    "org.alfresco.ext.documents.favourites.";

  private static final String FOLDERS_FAVOURITES_KEY =
    "org.alfresco.share.folders.favourites";

  private static final String EXT_FOLDERS_FAVOURITES =
    "org.alfresco.ext.folders.favourites.";
  ...
  public void setUp() throws Exception {
    super.setUp();
    preferenceService =
      ctx.getBean("preferenceService", PreferenceService.class);
  }
  ...
  public void testSetFavoritesPreferencesForDocuments() throws Exception {
    ...
    NodeRef testfile1 = nodeService.getChildByName(
      node2_1,
      ContentModel.ASSOC_CONTAINS,
      "testfile-1.txt"
    );
    NodeRef physicalTestfile1 = nodeService.getChildByName(
      virtualFolder1NodeRef,
      ContentModel.ASSOC_CONTAINS,
      "testfile-1.txt"
    );
    ...
    String preference = (String) preferenceService.getPreference(
      "admin",
    ...
    assertNull(
      (String) preferenceService.getPreference(
        "admin",
    ...
    assertNotNull(
      (String) preferenceService.getPreference(
        "admin",
        EXT_DOCUMENTS_FAVOURITES + physicalTestfile1.toString() + CREATED_AT
      )
    );
  ...
  public void testSetFavoritesPreferencesForFolders() throws Exception {
    ...
    try {
      ...
      assertFalse(
        preference.contains(physicalFolderInVirtualContext.toString())
      );
      ...
      assertNotNull(
        (String) preferenceService.getPreference(
          "admin",
          EXT_FOLDERS_FAVOURITES + physicalFolder.toString() + CREATED_AT
        )
      );
