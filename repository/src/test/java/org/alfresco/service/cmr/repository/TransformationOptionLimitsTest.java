...
public class TransformationOptionLimitsTest {
  ...
  public void testTimeException() throws Exception {
    ...
    assertEquals(
      ...
      TransformationOptionLimits.TIME_MESSAGE,
      message
    );
  }
  ...
  public void testKBytesException() throws Exception {
    ...
    assertEquals(
      "Wrong exception message",
      TransformationOptionLimits.KBYTES_MESSAGE,
      message
    );
  }
  ...
  public void testPageException() throws Exception {
    ...
    assertEquals(
      "Wrong exception message",
      TransformationOptionLimits.PAGES_MESSAGE,
      message
    );
  }
  ...
  public void testTimePair() throws Exception {
    ...
    assertEquals(
      "Returned TransformationOptionPair did not contain set value",
      value,
      actual
    );
  }
  ...
  public void testCombine() throws Exception {
    ...
    assertEquals(
      "Expected -1 as max is set",
      -1,
      combined.getReadLimitTimeMs()
    ); // max <
    assertEquals(
      "Expected -1 as limit is set",
      -1,
      combined.getMaxSourceSizeKBytes()
    ); // limit <
    assertEquals(
      "Expected -1 as limit is the same",
      -1,
      combined.getPageLimit()
    ); // max =
  }
  ...
  public void testCombineUpper() throws Exception {
    ...
    assertEquals(
      "Expected -1 as only one max value was set",
      -1,
      combined.getTimeoutMs()
    );
    assertEquals(
      "Expected -1 as only one max value was set",
      -1,
    ...
    assertEquals(
      "Expected -1 as only one max value was set",
      -1,
      combined.getMaxPages()
    );

    assertEquals(
      "Expected -1 as only one limit value was set",
      -1,
      combined.getReadLimitTimeMs()
    );
    assertEquals(
