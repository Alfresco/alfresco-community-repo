...
public class ActionsTests extends RestTest {
  ...
  @Test(
    groups = { TestGroup.REST_API, TestGroup.ACTIONS, TestGroup.REGRESSION }
  )
  public void testActionDefinitionsNegative() throws Exception {
    // Badly formed request -> 400
    {
      restClient
        ...
        .withParams("skipCount=-1") // invalid skipCount
        .withCoreAPI()
        .usingActions()
        .listActionDefinitions();
    ...
    // Unauthorized -> 401
    {
      UserModel userUnauthorized = new UserModel(
        "invalid-user",
        "invalid-pasword"
      );
      restClient
  ...
  public void executeAction() throws Exception {
    JSONObject response = restClient
    ...
    Utility.sleep(
      ...
      20000,
      () -> {
        RestNodeModel fileModel = restClient
          .authenticateUser(adminUser)
          .withCoreAPI()
          .usingNode(document)
          .getNode();
