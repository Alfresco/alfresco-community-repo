...
{
    /**
     * When external to persisted type mappings are not obvious, the persistence framework, before persisting as {@link PersistedType#SERIALIZABLE}, will give the converter a chance to choose how the value must be persisted:
     * <ul>
     ...
     * <p/>
     * If the converter can fully reconstruct an equal instance using just the name of the value's class, then {@link PersistedType#CONSTRUCTABLE} can be used.
     * 
     * @param value
     ...
     * 
     * @param targetClass
     *            the desired type to convert <i>to</i>
     * @param value
