...
public class InviteServiceTest extends BaseWebScriptTest {
  ...
  private static final String INVITER_EMAIL =
    "FirstName123.LastName123@email.com";
  private static final String INVITER_EMAIL_2 =
    "FirstNameabc.LastNameabc@email.com";
  ...
  protected void setUp() throws Exception {
    ...
    this.siteService =
      (SiteService) getServer().getApplicationContext().getBean("SiteService");
    this.nodeService =
      (NodeService) getServer().getApplicationContext().getBean("NodeService");
    this.workflowService =
      (WorkflowService) getServer()
        .getApplicationContext()
        .getBean("WorkflowService");
    this.mutableAuthenticationDao =
      (MutableAuthenticationDao) getServer()
        .getApplicationContext()
        .getBean("authenticationDao");
    this.transactionService =
      (TransactionService) getServer()
        .getApplicationContext()
        .getBean("TransactionService");
    this.nodeArchiveService =
      (NodeArchiveService) getServer()
        .getApplicationContext()
        .getBean("nodeArchiveService");
    this.invitationServiceImpl =
      (InvitationServiceImpl) getServer()
        .getApplicationContext()
        .getBean("invitationService");
    ScriptInvitationService scriptInvitationService = (ScriptInvitationService) getServer()
      .getApplicationContext()
      .getBean("invitationServiceScript");
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            assertNull(
              "Residual authentication on context-initiating thread (this thread):" +
            ...
            AuthenticationUtil.runAs(
              new RunAsWork<Object>() {
                public Object doWork() throws Exception {
                  ...
                  SiteInfo siteInfo = siteService.getSite(
                  ...
                  String inviterSiteRole = siteService.getMembersRole(
                    SITE_SHORT_NAME_INVITE_3,
                    USER_INVITER_2
                  );
                  if (
                    (inviterSiteRole == null) ||
                    (
                      inviterSiteRole.equals(SiteModel.SITE_COLLABORATOR) ==
                      false
                    )
                  ) {
   ...
   */
  public static void configureMailExecutorForTestMode(
    ...
    ChildApplicationContextFactory outboundSmptSubsystem = (ChildApplicationContextFactory) server
      .getApplicationContext()
      .getBean("OutboundSMTP");
    ApplicationContext childAppCtxt = outboundSmptSubsystem.getApplicationContext();
    MailActionExecuter mailActionExecutor = (MailActionExecuter) childAppCtxt.getBean(
      "mail"
    );
  ...
  protected void tearDown() throws Exception {
    ...
    final SiteInfo[] siteInfos = AuthenticationUtil.runAs(
      runAsWork,
      AuthenticationUtil.getSystemUserName()
    );
            ...
            RunAsWork<Object> runAsWork = new RunAsWork<Object>() {
              public Object doWork() throws Exception {
                ...
                for (String inviteeEmail : inviteeEmailAddrs) {
                  ...
                  Set<NodeRef> people = personService.getPeopleFilteredByProperty(
                  ...
                  for (NodeRef person : people) {
                    String userName = DefaultTypeConverter.INSTANCE.convert(
                      String.class,
                      InviteServiceTest.this.nodeService.getProperty(
                          person,
  ...
  private JSONObject startInvite(
    ...
    JSONObject result = createNominatedInvitation(
      siteShortName,
      inviteeFirstName,
      inviteeLastName,
      inviteeEmail,
  ...
  private JSONObject cancelInvite(
    String inviteId,
    String siteShortName,
    int expectedStatus
  ) throws Exception {
  ...
  private JSONObject rejectInvite(
    String inviteId,
    String inviteTicket,
    int expectedStatus
  ) throws Exception {
    // Invitee rejects invitation to a Site from Inviter
    String rejectInviteUrl =
      URL_INVITE + "/" + inviteId + "/" + inviteTicket + "/reject";
    Response response = sendRequest(
      new PutRequest(rejectInviteUrl, (byte[]) null, null),
      expectedStatus
    );
    JSONObject result = new JSONObject(response.getContentAsString());
    return result;
  ...
  private JSONObject getInvitesByInviterUserName(
  ...
  private JSONObject getInvitesByInviteeUserName(
    String inviteeUserName,
    int expectedStatus
  ) throws Exception {
    // construct get invites URL
  ...
  private JSONObject getInvitesBySiteShortName(
    String siteShortName,
    int expectedStatus
  ) throws Exception {
    // construct get invites URL
  ...
  private JSONObject getInviteInfo(
    String inviteId,
    String inviteTicket,
    String inviteeUid
  ) throws Exception {
  ...
  public void testAcceptInvite() throws Exception {
    ...
    sendRequest(
      new PutRequest(acceptInviteUrl, (byte[]) null, null),
      Status.STATUS_OK
    );
    ...
    JSONObject getInvitesResult = getInvitesByInviteId(
      inviteId,
      Status.STATUS_OK
    );
  ...
  public void testGetInvitationStatus() throws Exception {
    for (String invitationStatus : new String[] {
      ...
      if (invitationStatus.equals(InviteInfo.INVITATION_STATUS_REJECTED)) {
        ...
        invitationStatus.equals(InviteInfo.INVITATION_STATUS_ACCEPTED)
      ) {
        // Invitee accepts invitation to a Site from Inviter
        String acceptInviteUrl =
          URL_INVITE + "/" + inviteId + "/" + inviteTicket + "/accept";
  ...
  public void testGetInvitesByInviteId() throws Exception {
    ...
    JSONObject inviteJSONObj = getInvitesResult
      .getJSONArray("invites")
      .getJSONObject(0);
  ...
  public void testGetInvitesByInviterUserName() throws Exception {
    ...
    // above
    JSONObject getInvitesResult = getInvitesByInviterUserName(
      USER_INVITER,
      Status.STATUS_OK
    );
    ...
    assertEquals(
      USER_INVITER,
      inviteJSONObj.getJSONObject("inviter").get("userName")
    );
  }
  ...
  public void testGetInvitesByInviteeUserName() throws Exception {
    ...
    assertEquals(
      inviteeUserName,
      inviteJSONObj.getJSONObject("invitee").get("userName")
    );
  }
  ...
  public void testGetInvitesBySiteShortName() throws Exception {
    ...
    JSONObject getInvitesResult = getInvitesBySiteShortName(
      siteShortName,
      Status.STATUS_OK
    );
    ...
    assertEquals(
      siteShortName,
      inviteJSONObj.getJSONObject("site").get("shortName")
    );
  }
            ...
            .doInTransaction(
              new RetryingTransactionCallback<Void>() {
                public Void execute() throws Throwable {
                  assertEquals(
                    false,
                    mutableAuthenticationDao.userExists(inviteeUserName)
                  );
                  assertEquals(
                    false,
                    personService.personExists(inviteeUserName)
                  );
                  return null;
                }
              }
  ...
  public void testInviteeResourcesNotDeletedUponRejectWhenInvitesPending()
    ...
    boolean inviteeUserExists = AuthenticationUtil.runAs(
          ...
          Boolean result = tranHelper.doInTransaction(
            new RetryingTransactionCallback<Boolean>() {
              public Boolean execute() throws Throwable {
                Boolean result = mutableAuthenticationDao.userExists(
                  inviteeUserName
                );
                return result;
              }
    ...
    boolean inviteePersonExists = AuthenticationUtil.runAs(
      new RunAsWork<Boolean>() {
        public Boolean doWork() throws Exception {
  ...
  public void testMNT9905() throws Exception {
    ...
    try {
      ...
      JSONObject collInv = startInvite(
        collaborator,
        collaborator,
        SiteModel.SITE_COLLABORATOR,
        SITE_SHORT_NAME_INVITE_1,
      ...
      // get site member
      JSONObject userList = listInvitations(
        SITE_SHORT_NAME_INVITE_1,
        "user",
        Status.STATUS_OK
      );
      ...
      for (int i = 0; i < inviteJSONArr.length(); i++) {
        String userName = (String) inviteJSONArr
          .getJSONObject(i)
          .get("userName");
  ...
  public void testDontOwerrideModeratedSitePermissions() throws Exception {
    ...
    SiteInfo siteInfo =
      InviteServiceTest.this.siteService.getSite(MODERATED_SITE_NAME);
    if (siteInfo == null) {
      siteService.createSite(
        "InviteSitePreset",
        MODERATED_SITE_NAME,
    ...
    String inviteId = createModeratedInvitation(
      MODERATED_SITE_NAME,
      "",
      secondUser,
