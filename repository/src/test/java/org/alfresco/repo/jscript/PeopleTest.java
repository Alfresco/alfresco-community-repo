...
public class PeopleTest extends TestCase {
  ...
  private static final String CQ_SIMPLE_FILTER =
    SIMPLE_FILTER + " [hint:useCQ]";
  ...
  private void assertPeopleImpl(
    ...
    assertEquals(
      "Sort",
      expectedSort,
      parameters.getSortDefinitions().toString()
    );
  ...
  public void testGetPeopleByPatternIndexedAndCQ() throws Exception {
    ScriptPagingDetails paging = new ScriptPagingDetails(0, 0);
    List<PersonInfo> unsortedPeople = people.getPeopleImpl(
      CQ_SIMPLE_FILTER,
      paging,
      null,
      null
    ...
    List<PersonInfo> sortedPeople = people.getPeopleImpl(
      SIMPLE_FILTER,
      paging,
