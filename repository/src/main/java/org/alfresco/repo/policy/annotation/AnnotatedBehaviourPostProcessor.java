 ...
 *
 * <p>Registers the annotated methods on behaviour beans with the policy component.
 *
...
public class AnnotatedBehaviourPostProcessor implements BeanPostProcessor {
    ...
    private void registerBehaviour(
            BehaviourBean behaviourBean, Object bean, String beanName, Method method) {
        ...
        JavaBehaviour javaBehaviour =
                new JavaBehaviour(bean, method.getName(), behaviour.notificationFrequency());
        ...
        // deal with association behaviours
            ...
            if (!behaviour.isService()) {
                ...
                policyComponent.bindAssociationBehaviour(
                        policy, type, toQName(behaviour.assocType()), javaBehaviour);
            } else {
