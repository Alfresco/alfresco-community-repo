...
public interface LockingCache<K extends Serializable, V extends Object> extends SimpleCache<K, V> {
    /**
     * Determine if a value (addition, removal or update) has been locked for the remainer of the
     * transaction
     *
    ...
    /**
     * Prevent a key's value from being changed for the duriation of the transaction. By default,
     * further attempts to modify the associated value will be ignored; this includes add a value
     * back after removal.
     *
