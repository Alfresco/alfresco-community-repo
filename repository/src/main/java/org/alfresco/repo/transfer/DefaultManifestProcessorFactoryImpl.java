...
public class DefaultManifestProcessorFactoryImpl
  ...
  public List<TransferManifestProcessor> getCommitProcessors(
    ...
    if (isSimpleReportActive()) {
      TransferSummaryReportImpl summaryReport = new TransferSummaryReportImpl(
        transferId
      );
      ...
      summaryReport.setTransferSummaryReportLocation(
    ...
    RepoPrimaryManifestProcessorImpl primaryProcessor = new RepoPrimaryManifestProcessorImpl(
      receiver,
      transferId
    );
    ...
    RepoSecondaryManifestProcessorImpl secondaryProcessor = new RepoSecondaryManifestProcessorImpl(
      receiver,
      transferId
    );
    ...
    RepoTertiaryManifestProcessorImpl tertiaryProcessor = new RepoTertiaryManifestProcessorImpl(
      receiver,
      transferId
    );
   ...
   */
  public void setNodeResolverFactory(
    CorrespondingNodeResolverFactory nodeResolverFactory
  ) {
  ...
  public TransferManifestProcessor getRequsiteProcessor(
    ...
    RepoRequisiteManifestProcessorImpl processor = new RepoRequisiteManifestProcessorImpl(
      receiver,
      transferId,
      out
    );
