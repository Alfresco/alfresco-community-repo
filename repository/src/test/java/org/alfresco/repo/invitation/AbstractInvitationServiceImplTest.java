...
public abstract class AbstractInvitationServiceImplTest
  ...
  private static final Log logger = LogFactory.getLog(
    AbstractInvitationServiceImplTest.class
  );
  ...
  public static final String PERSON_FIRSTNAME_SPACES =
    "Invitation First\tName\n1\r2\r\n3";
  public static final String PERSON_LASTNAME = "InvitationLastName123";
  public static final String PERSON_LASTNAME_SPACES =
  ...
  public static final String USER_ONE_EMAIL = USER_ONE + "@alfrescotesting.com";
  public static final String USER_TWO_EMAIL = USER_TWO + "@alfrescotesting.com";
  ...
  public void before() throws Exception {
    ...
    this.invitationService =
      (InvitationService) this.applicationContext.getBean("InvitationService");
    this.siteService =
      (SiteService) this.applicationContext.getBean("SiteService");
    this.personService =
    ...
    this.invitationServiceImpl =
      (InvitationServiceImpl) applicationContext.getBean("invitationService");
    this.workflowAdminService =
      (WorkflowAdminServiceImpl) applicationContext.getBean(
        WorkflowAdminServiceImpl.NAME
      );

    this.templateService =
      (TemplateServiceImpl) applicationContext.getBean("templateService");
    ...
    mailService =
      (MailActionExecuter) (
        (ApplicationContextFactory) this.applicationContext.getBean(
            "OutboundSMTP"
          )
    ...
    createPerson(
      USER_MANAGER,
      USER_MANAGER + "@alfrescotesting.com",
      PERSON_FIRSTNAME,
      PERSON_LASTNAME
    );
    createPerson(
    ...
    createPerson(
      USER_TWO,
      USER_TWO + "@alfrescotesting.com",
      PERSON_FIRSTNAME,
      PERSON_LASTNAME
    );
    createPerson(
      USER_EVE,
      USER_EVE + "@alfrescotesting.com",
      PERSON_FIRSTNAME,
      PERSON_LASTNAME
    );
   ...
   */
  @Test
  public void testInternalUserNotDeletedAfterInviteCancelled()
    throws Exception {
    ...
    try {
      ...
      fail(
        ...
        InvitationExceptionUserError.class.getName() +
        " should be thrown"
      );
    } catch (Exception ex) {
      assertTrue(
        "Incorrect exception was thrown",
        ex instanceof InvitationExceptionUserError
      );
    }
    ...
    assertTrue(
      ...
      authenticationService.authenticationExists(USER_ONE)
    );
  }
  ...
  public void testExternalUserDeletedAfterInviteCancelled() throws Exception {
    ...
    assertNull(
      "Person deleted",
      personService.getPersonOrNull(inviteeUsername)
    );
    assertFalse(
  ...
  public void testNominatedInvitationNewUser() throws Exception {
    ...
    assertEquals(
      "first name wrong",
      inviteeFirstName,
      nominatedInvitation.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeLastName,
      nominatedInvitation.getInviteeLastName()
    );
    assertEquals(
      "email name wrong",
      inviteeEmail,
      nominatedInvitation.getInviteeEmail()
    );
    ...
    // sentInviteDate should be set to today
    {
      ...
      assertTrue(
        "sentDate wrong - too early. Start Date: " +
        startDate +
        "\nSent Date: " +
        sentDate,
      ...
      assertTrue(
        "sentDate wrong - too lateStart Date: " +
        startDate +
        "\nSent Date: " +
        sentDate,
    ...
    assertEquals(
      "resource type name wrong",
      resourceType,
      nominatedInvitation.getResourceType()
    );
    assertEquals(
      "resource name wrong",
      resourceName,
      nominatedInvitation.getResourceName()
    );
    assertEquals(
      "role  name wrong",
      inviteeRole,
      nominatedInvitation.getRoleName()
    );
    assertEquals(
      "server path wrong",
      serverPath,
      nominatedInvitation.getServerPath()
    );
    assertEquals(
      "accept URL wrong",
      acceptUrl,
      nominatedInvitation.getAcceptUrl()
    );
    assertEquals(
      "reject URL wrong",
      rejectUrl,
      nominatedInvitation.getRejectUrl()
    );
     ...
     */
    {
      NominatedInvitation invitation = (NominatedInvitation) invitationService.getInvitation(
        inviteId
      );
      ...
      assertEquals(
        "first name wrong",
        inviteeFirstName,
        invitation.getInviteeFirstName()
      );
      assertEquals(
        "last name wrong",
        inviteeLastName,
        invitation.getInviteeLastName()
      );
      assertEquals(
        "user name wrong",
        inviteeUserName,
     ...
     */
    {
      ...
      assertTrue(
        (msg.getSubject().indexOf("You have been invited to join the") != -1)
      );
    }
     ...
     */
    List<Invitation> invitations = invitationService.listPendingInvitationsForResource(
      resourceType,
      resourceName
    );
    ...
    assertEquals(
      "first name wrong",
      inviteeFirstName,
      firstInvite.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeLastName,
      firstInvite.getInviteeLastName()
    );
    assertEquals(
      "user name wrong",
      inviteeUserName,
      firstInvite.getInviteeUserName()
    );
    ...
    NominatedInvitation acceptedInvitation = (NominatedInvitation) invitationService.accept(
      firstInvite.getInviteId(),
      firstInvite.getTicket()
    );
    assertEquals(
      "invite id wrong",
      firstInvite.getInviteId(),
      acceptedInvitation.getInviteId()
    );
    assertEquals(
      "first name wrong",
      inviteeFirstName,
      acceptedInvitation.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeLastName,
      acceptedInvitation.getInviteeLastName()
    );
    assertEquals(
      "user name wrong",
      inviteeUserName,
    ...
    List<Invitation> it4 = invitationService.listPendingInvitationsForResource(
      resourceType,
      resourceName
    );
     ...
     */
    NominatedInvitation acceptedInvitation2 = (NominatedInvitation) invitationService.getInvitation(
      firstInvite.getInviteId()
    );
     ...
     */
    {
      ...
      if (mailService instanceof ExtendedMailActionExecutor) {
        faf =
          mailService
            .getClass()
            .getSuperclass()
            .getDeclaredField("fromDefaultAddress");
      } else {
        faf = mailService.getClass().getDeclaredField("fromDefaultAddress");
      }
      faf.setAccessible(true);
      String defaultFromAddress = (String) ReflectionUtils.getField(
        faf,
        mailService
      );
      ...
      // Check invitiation
      NominatedInvitation nominatedInvitation2 = invitationService.inviteNominated(
        inviteeFirstName,
        inviteeLastName,
        USER_TWO_EMAIL,
        resourceType,
      ...
      assertEquals(
        "first name wrong",
        inviteeFirstName,
        nominatedInvitation2.getInviteeFirstName()
      );
      assertEquals(
        "last name wrong",
        inviteeLastName,
        nominatedInvitation2.getInviteeLastName()
      );
      assertEquals(
        "email name wrong",
        USER_TWO_EMAIL,
        nominatedInvitation2.getInviteeEmail()
      );
  ...
  public void testNominatedInvitationNewUserReject() throws Exception {
    ...
    // sentInviteDate should be set to today
    {
      Date sentDate = nominatedInvitation.getSentInviteDate();
      assertTrue(
        "sentDate wrong - too earlyStart Date: " +
        startDate +
        "\nSent Date: " +
        sentDate,
        sentDate.after(startDate)
     ...
     */
    NominatedInvitation rejectedInvitation = (NominatedInvitation) invitationService.reject(
      nominatedInvitation.getInviteId(),
      "dont want it"
    );
    assertEquals(
      "invite id wrong",
      nominatedInvitation.getInviteId(),
      rejectedInvitation.getInviteId()
    );
    assertEquals(
      "first name wrong",
      inviteeFirstName,
      rejectedInvitation.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeLastName,
      rejectedInvitation.getInviteeLastName()
    );
    assertEquals(
      "user name wrong",
      inviteeUserName,
      rejectedInvitation.getInviteeUserName()
    );
  ...
  public void testNominatedInvitationNewUserSameEmails() throws Exception {
    ...
    assertEquals(
      "first name wrong",
      inviteeAFirstName,
      nominatedInvitationA.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeALastName,
      nominatedInvitationA.getInviteeLastName()
    );
    assertEquals(
      "email name wrong",
      inviteeEmail,
      nominatedInvitationA.getInviteeEmail()
    );
    ...
    assertEquals(
      "first name wrong",
      inviteeBFirstName,
      nominatedInvitationB.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeBLastName,
    ...
    assertEquals(
      "email name wrong",
      inviteeEmail,
      nominatedInvitationB.getInviteeEmail()
    );
    ...
    assertFalse(
      "generated user names are the same",
      inviteeAUserName.equals(inviteeBUserName)
    );
    ...
    AuthenticationUtil.setFullyAuthenticatedUser(
      nominatedInvitationA.getInviteeUserName()
    );
    NominatedInvitation acceptedInvitationA = (NominatedInvitation) invitationService.accept(
      inviteAId,
    ...
    assertEquals(
      "invite id wrong",
      inviteAId,
      acceptedInvitationA.getInviteId()
    );
    assertEquals(
      "first name wrong",
      inviteeAFirstName,
      acceptedInvitationA.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeALastName,
      acceptedInvitationA.getInviteeLastName()
    );
    assertEquals(
      "user name wrong",
      inviteeAUserName,
      acceptedInvitationA.getInviteeUserName()
    );

    AuthenticationUtil.setFullyAuthenticatedUser(
      nominatedInvitationB.getInviteeUserName()
    );
    NominatedInvitation acceptedInvitationB = (NominatedInvitation) invitationService.accept(
      inviteBId,
    ...
    assertEquals(
      "invite id wrong",
      inviteBId,
      acceptedInvitationB.getInviteId()
    );
    assertEquals(
      "first name wrong",
      inviteeBFirstName,
      acceptedInvitationB.getInviteeFirstName()
    );
    assertEquals(
      "last name wrong",
      inviteeBLastName,
      acceptedInvitationB.getInviteeLastName()
    );
    assertEquals(
      "user name wrong",
      inviteeBUserName,
      acceptedInvitationB.getInviteeUserName()
    );
    ...
    String roleNameA = siteService.getMembersRole(
      resourceName,
      inviteeAUserName
    );
    assertEquals("role name wrong", roleNameA, inviteeRole);
    String roleNameB = siteService.getMembersRole(
      resourceName,
      inviteeBUserName
    );
  ...
  public void testMNT11775() throws Exception {
    ...
    ModeratedInvitation invitation = invitationService.inviteModerated(
      comments,
      inviteeUserName,
      resourceType,
      resourceName,
    ...
    try {
      ...
      String emailMsg = templateService.processTemplate(
        "freemarker",
        "/alfresco/bootstrap/invite/moderated-reject-email.ftl",
        model
      );

      assertNotNull("Email message is null", emailMsg);
      assertTrue(
        "Email message doesn't contain review comment",
        emailMsg.contains("Go away!")
      );
    } catch (Exception ex) {
      ex.printStackTrace();
  ...
  public void testNominatedInvitationNewUserWhitespace() throws Exception {
    ...
    String expectedUserName =
      (inviteeFirstName + "_" + inviteeLastName).toLowerCase();
    ...
    assertEquals(
      "Wrong username!",
      expectedUserName,
      nominatedInvitation.getInviteeUserName()
    );
    ...
    // Now verify access control list
    String roleName = siteService.getMembersRole(
      resourceName,
      expectedUserName
    );
    assertEquals("role name wrong", roleName, inviteeRole);
   ...
   * @throws Exception
   */
  protected void testNominatedInvitationExistingUser(boolean requireAcceptance)
    throws Exception {
    String inviteeUserName = USER_ONE;
    ...
    if (requireAcceptance) {
      ...
      NominatedInvitation firstInvite = (NominatedInvitation) invitations.get(
        0
      );
      assertEquals("invite id wrong", inviteId, firstInvite.getInviteId());
      assertEquals(
       ...
       */
      NominatedInvitation canceledInvitation = (NominatedInvitation) invitationService.cancel(
        inviteId
      );
      assertEquals(
        "invite id wrong",
        inviteId,
        canceledInvitation.getInviteId()
      );
      assertEquals(
        "first name wrong",
        inviteeFirstName,
        canceledInvitation.getInviteeFirstName()
      );
      assertEquals(
        "last name wrong",
        inviteeLastName,
        canceledInvitation.getInviteeLastName()
      );
      assertEquals(
        "user name wrong",
        inviteeUserName,
        canceledInvitation.getInviteeUserName()
      );

      /**
       * Do the query again - should no longer find anything
       */
      List<Invitation> it2 = invitationService.listPendingInvitationsForResource(
        resourceType,
        resourceName
      );
      ...
      NominatedInvitation rejectedInvitation = (NominatedInvitation) invitationService.cancel(
        secondInvite.getInviteId()
      );
      assertEquals(
        "invite id wrong",
        secondInvite.getInviteId(),
      ...
      List<Invitation> it3 = invitationService.listPendingInvitationsForResource(
        resourceType,
        resourceName
      );
    ...
    if (requireAcceptance) {
      NominatedInvitation acceptedInvitation = (NominatedInvitation) invitationService.accept(
        thirdInvite.getInviteId(),
        thirdInvite.getTicket()
      );
      assertEquals(
        "invite id wrong",
        thirdInvite.getInviteId(),
  ...
  public void testModeratedInvitation() {
     ...
     * returned correctly.
     */
    ModeratedInvitation mi2 = (ModeratedInvitation) invitationService.getInvitation(
      inviteId
    );
     ...
     */
    ModeratedInvitation canceledInvitation = (ModeratedInvitation) invitationService.cancel(
      inviteId
    );
    ...
    assertEquals(
      "comments wrong",
      comments,
      canceledInvitation.getInviteeComments()
    );

    /**
     * Should now be no invitation
     */
    List<Invitation> inv2 = invitationService.listPendingInvitationsForResource(
      resourceType,
      resourceName
    );
     ...
     */
    this.authenticationComponent.setCurrentUser(USER_TWO);
    ModeratedInvitation invite2 = invitationService.inviteModerated(
      comments,
      inviteeUserName,
      resourceType,
      resourceName,
     ...
     */
    this.authenticationComponent.setCurrentUser(USER_TWO);
    ModeratedInvitation invite3 = invitationService.inviteModerated(
      comments,
      inviteeUserName,
      resourceType,
      resourceName,
  ...
  public void testSearchInvitation() {
     ...
     */
    List<Invitation> resOne = invitationService.listPendingInvitationsForResource(
     ...
     */
    List<Invitation> resTwo = invitationService.listPendingInvitationsForResource(
      ResourceType.WEB_SITE,
      SITE_SHORT_NAME_RED
    );
     ...
     */
    List<Invitation> resThree = invitationService.listPendingInvitationsForInvitee(
      USER_ONE
    );
     ...
     */
    List<Invitation> resFour = invitationService.listPendingInvitationsForInvitee(
      USER_TWO
    );
    ...
    assertEquals(
      "user one should not have any nominated invites",
      0,
      resFive.size()
    );
    ...
    List<Invitation> searchInvitation = invitationService.searchInvitation(
      crit2
    );
    assertTrue(
      "2 moderated invitations should be found",
      searchInvitation.size() == 2
    );

    // now search everything but limit the results to 3
    searchInvitation = invitationService.searchInvitation(crit2, 2);
    assertTrue(
      "search everything returned 0 or more than 2 elements",
      searchInvitation.size() > 0 && searchInvitation.size() <= 2
    );
  ...
  public void testSearchInvitationWithLimit() throws Exception {
    ...
    // Invite USER_TWO
    NominatedInvitation inviteForUserTwo = invitationService.inviteNominated(
      USER_TWO,
      resourceType,
      resourceName,
      inviteeRole,
   ...
   */
  @Test
  public void testExternalUserManagerInvitingAnotherExternalUser()
    throws Exception {
    String inviteeFirstName = PERSON_FIRSTNAME;
    String inviteeLastName = PERSON_LASTNAME;
    String inviteeEmail = "123@alfrescotesting.com";
    ...
    AuthenticationUtil.setFullyAuthenticatedUser(
      nominatedInvitation2.getInviteeUserName()
    );

    NodeRef person = personService.getPersonOrNull(
      nominatedInvitation2.getInviteeUserName()
    );
    assertTrue("user has not been created", person != null);
    assertTrue(
      "user should have the ASPECT_ANULLABLE aspect since the invitation hasn't been accepted yet",
      nodeService.hasAspect(person, ContentModel.ASPECT_ANULLABLE)
    );

    // authenticated as external user 2 accept the invitation
    Invitation acceptedNominatedInvitation2 = invitationService.accept(
      nominatedInvitation2.getInviteId(),
      nominatedInvitation2.getTicket()
    );

    assertNotNull(
      "accepted nominated invitation is null",
      acceptedNominatedInvitation2
    );
    assertEquals(
      "role is wrong",
      SiteModel.SITE_COLLABORATOR,
      acceptedNominatedInvitation2.getRoleName()
    );
    assertEquals(
      "user name wrong",
      inviteeFirstName2 + "_" + inviteeLastName2,
      acceptedNominatedInvitation2.getInviteeUserName()
    );

    person =
      personService.getPersonOrNull(
        acceptedNominatedInvitation2.getInviteeUserName()
      );
    assertTrue("user has not been created", person != null);
    assertTrue(
      "user should not have the ASPECT_ANULLABLE aspect anymore",
      !nodeService.hasAspect(person, ContentModel.ASPECT_ANULLABLE)
    );

    Invitation invitation = invitationService.getInvitation(
      acceptedNominatedInvitation2.getInviteId()
    );
    assertEquals(
      "invited user name is wrong",
      invitation.getInviteeUserName(),
      acceptedNominatedInvitation2.getInviteeUserName()
    );
    assertEquals(
    ...
    assertEquals(
      "invite resource name is wrong",
      invitation.getResourceName(),
      acceptedNominatedInvitation2.getResourceName()
    );
  }
  ...
  public void disabled_test100Invites() throws Exception {
    ...
    // Invite USER_TWO
    NominatedInvitation invite = invitationService.inviteNominated(
      USER_TWO,
      resourceType,
      resourceName,
      inviteeRole,
