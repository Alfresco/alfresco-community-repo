...
public class Favourite
  implements Serializable, ExpectedComparison, Comparable<Favourite> {
  ...
  private static Date getDate(String dateStr) throws ParseException {
    Date date =
      (
        dateStr != null
          ? PublicApiDateFormat.getDateFormat().parse(dateStr)
          : null
      );
    return date;
  }
  ...
  public static FavouritesTarget parseTarget(JSONObject jsonObject)
    throws ParseException {
    ...
    if (jsonObject.containsKey("site")) {
      ...
      FavouriteDocument document = FavouriteDocument.parseDocument(
        documentJSON
      );
  ...
  public static Favourite parseFavourite(JSONObject jsonObject)
    throws ParseException {
  ...
  public static ListResponse<Favourite> parseFavourites(JSONObject jsonObject)
    throws ParseException {
  ...
  public void expected(Object o) {
    ...
    if (createdAt != null) {
      assertTrue(
        other.getCreatedAt().equals(createdAt) ||
        other.getCreatedAt().after(createdAt)
      );
    }
    if (modifiedAt != null) {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((targetGuid == null) ? 0 : targetGuid.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (targetGuid == null) {
      if (other.targetGuid != null) return false;
    } else if (!targetGuid.equals(other.targetGuid)) return false;
    return true;
  }
