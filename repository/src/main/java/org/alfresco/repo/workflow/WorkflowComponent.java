...
public interface WorkflowComponent {
     ...
     * @since 4.0
     */
    public WorkflowDeployment deployDefinition(
            InputStream workflowDefinition, String mimetype, String name);

    /**
     * Is the specified Workflow Definition already deployed?
     *
     * <p>Note: the notion of "already deployed" may differ between bpm engines. For example,
     ...
     *
     * <p>TODO: Determine behaviour when "in-flight" workflow instances exist
     *
     ...
     */
    public WorkflowPath startWorkflow(
            String workflowDefinitionId, Map<QName, Serializable> parameters);
    ...
    /**
     * Gets all "in-flight" workflow instances (both active and completed) of the specified Workflow
     * Definition
     *
     * @param workflowDefinitionId the workflow definition id
     * @return the list of "in-flight" workflow instances
    ...
    /**
     * Gets all "in-flight" workflow instances according to the specified workflowInstanceQuery
     * parameter
     *
    ...
    /**
     * Gets maxItems "in-flight" workflow instances according to the specified workflowInstanceQuery
     * parameter
     *
     * @param workflowInstanceQuery WorkflowInstanceQuery
     * @param maxItems int
    ...
    public List<WorkflowInstance> getWorkflows(
            WorkflowInstanceQuery workflowInstanceQuery, int maxItems, int skipCount);
     ...
     *
     * @param workflowInstanceId the workflow instance id
     * @return image view of the workflow instance as an InputStream or null if a diagram is not
     *     available
     * @since 4.0
     */
