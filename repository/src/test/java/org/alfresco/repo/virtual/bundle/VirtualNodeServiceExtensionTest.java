...
public class VirtualNodeServiceExtensionTest
  ...
  public void testCreateNode_withFilingRuleAspects() throws Exception {
    NodeRef assocNode2 = nodeService.getChildByName(
      virtualFolder1NodeRef,
      ContentModel.ASSOC_CONTAINS,
      "Node2"
    );
    NodeRef assocNode2_1 = nodeService.getChildByName(
      assocNode2,
      ContentModel.ASSOC_CONTAINS,
      "Node2_1"
    );
    ChildAssociationRef childAssocRef = createContent(
      assocNode2_1,
      "ContentWithAspects"
    );
  ...
  public void testCreateNode_noFilingRule() throws Exception {
    NodeRef testTemplate2 = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
      "aVFTestTemplate2",
      TEST_TEMPLATE_2_JSON_SYS_PATH
    );
    NodeRef testTemplate2Node2 = nodeService.getChildByName(
      testTemplate2,
      ContentModel.ASSOC_CONTAINS,
      "Node2"
    );
  ...
  public void testCreate_NodeProtocolParent() throws Exception {
    ...
    NodeRef physicalRenditionNode = child.execute(
      new GetActualNodeRefMethod(environment)
    );
    NodeRef physicalRenditionParent = parent.execute(
      new GetActualNodeRefMethod(environment)
    );
    List<ChildAssociationRef> refs = nodeService.getChildAssocs(
      physicalRenditionParent
    );
    assertEquals(physicalRenditionNode, refs.get(0).getChildRef()); // the association exists for the physical nodes

    List<ChildAssociationRef> virtualRefs = nodeService.getChildAssocs(
      virtualRenditionParent
    );
  ...
  public void testCreateNode_CM_528_folder_filing_type() throws Exception {
    NodeRef testTemplate5 = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
      "aVFTestTemplate5",
      TEST_TEMPLATE_5_JSON_SYS_PATH
    );
    NodeRef folderFilingTypeNode = nodeService.getChildByName(
      testTemplate5,
      ContentModel.ASSOC_CONTAINS,
      "FolderFilingType"
    );

    ChildAssociationRef forcedCmContentAssocRef = createContent(
      folderFilingTypeNode,
      "forcedCmContent"
    );
  ...
  public void testCreateNode() throws Exception {
    ...
    Reference firstChild = smartStore.getChildByName(
      semiVirtualFolder,
      ContentModel.ASSOC_CONTAINS,
      "Node1"
    );
    ...
    Reference secondChild = smartStore.getChildByName(
      semiVirtualFolder,
      ContentModel.ASSOC_CONTAINS,
      "Node2"
    );
  ...
  public void ignore_testCreateFilingIrregularNode() throws Exception {
    NodeRef vf = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
      "testCreateFolderOnContentFilingRule",
      TEST_TEMPLATE_3_JSON_SYS_PATH
    );
    {
      NodeRef node1 = nodeService.getChildByName(
        vf,
      ...
      ChildAssociationRef folderChilAssoc = nodeService.createNode(
        node1,
        ContentModel.ASSOC_CONTAINS,
        assocQName,
      ...
      assertEquals(
        "Node1_content_FR",
        environment
          .getProperties(folderChildRef)
          .get(ContentModel.PROP_DESCRIPTION)
      );
    }

    {
      NodeRef node2 = nodeService.getChildByName(
        vf,
        ContentModel.ASSOC_CHILDREN,
        "Node2"
      );
  ...
  private void assertNewVirtualChildAssocRef(
    NodeRef nodeRef,
    ChildAssociationRef childAssocsRef
  ) {
  ...
  public void testNodeProtocolReferencePath() throws Exception {
    ...
    NodeRef childRef = nodeService.getChildByName(
      node2,
      ContentModel.ASSOC_CONTAINS,
      "testfile.txt"
    );
    ...
    NodeRef physicalNode = nodeService.getChildByName(
      virtualFolder1NodeRef,
      ContentModel.ASSOC_CONTAINS,
      "testfile.txt"
    );
    ...
    NodeRef node2_1 = nodeService.getChildByName(
      node2,
      ContentModel.ASSOC_CONTAINS,
      "Node2_1"
    );
    ...
    NodeRef childRef_1 = nodeService.getChildByName(
      node2_1,
      ContentModel.ASSOC_CONTAINS,
      "testfile-1.txt"
    );
  ...
  private void setUpTestAssociations(NodeRef actualNodeRef) {
    ...
    ChildAssociationRef node2ChildAssoc = createContent(
      node2,
    ...
    for (int i = 1; i <= 10; i++) {
      ChildAssociationRef childAssoc = createContent(
        node2_1,
        "test" + i + "_2_1.txt"
      );
  ...
  private ChildAssociationRef findActualAssocPeer(
    ChildAssociationRef virtualAssoc,
    NodeRef actualParentNodeRef
  ) {
    List<ChildAssociationRef> actualAssocs = nodeService.getChildAssocs(
      actualParentNodeRef
    );
      ...
      nodeService.getChildAssocs(
        ...
        new QNamePattern() {
          ...
          public boolean isMatch(QName qname) {
            return (
              qname.getLocalName().startsWith("test") &&
  ...
  public void testGetChildAssocs_3() throws Exception {
    ...
    List<ChildAssociationRef> folderAssocs = nodeService.getChildAssocs(
      virtualFolder1NodeRef,
    ...
    List<ChildAssociationRef> contentAssocs = nodeService.getChildAssocs(
      virtualFolder1NodeRef,
  ...
  public void testGetChildAssocsByPropertyValue() throws Exception {
    ...
    {
      List<ChildAssociationRef> children = nodeService.getChildAssocsByPropertyValue(
        node2,
        ContentModel.PROP_TITLE,
        NODE2TEST1_2_TXT
      );
  ...
  public void testGetProperties() throws Exception {
    NodeRef template2VF = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
  ...
  public void testGetParentAssocs() throws Exception {
    ...
    {
      List<ChildAssociationRef> node2Parents = nodeService.getParentAssocs(
        node2
      );
  ...
  public void testGetSourceAssocs_download() throws Exception {
    ...
    sourceAssocs =
      nodeService.getSourceAssocs(node2, RegexQNamePattern.MATCH_ALL);
    assertEquals(0, sourceAssocs.size());

    sourceAssocs =
      nodeService.getSourceAssocs(node2, DownloadModel.ASSOC_REQUESTED_NODES);
    assertEquals(0, sourceAssocs.size());
  ...
  public void testGetTargetAssocs_download() throws Exception {
    ...
    NodeRef tempDownloadSourceAssocs = nodeService.getChildByName(
  ...
  public void testGetChildByName() {
    NodeRef virtualFolder = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
      VIRTUAL_FOLDER_2_NAME,
    ...
    NodeRef virtualChild = nodeService.getChildByName(
    ...
    NodeRef phys1 = nodeService.getChildByName(
      virtualChild,
      ContentModel.ASSOC_CONTAINS,
      "Company Home"
    );
    ...
    NodeRef phys2 = nodeService.getChildByName(
      phys1,
      ContentModel.ASSOC_CONTAINS,
      "Data Dictionary"
    );
  ...
  public void testGetAssocs_CM_673() throws Exception {
    NodeRef createFolder = createFolder(testRootFolder.getNodeRef(), "FOLDER")
      .getChildRef();
    createContent(
      createFolder,
      "testFile1",
    ...
    try {
      NodeRef physicalFolderInVirtualContext = nodeService.getChildByName(
        node1,
        ContentModel.ASSOC_CONTAINS,
        "FOLDER"
      );
  ...
  public void testCopySemivirtualFolder() throws Exception {
    ...
    IntegrityChecker integrityChecker = (IntegrityChecker) ctx.getBean(
      "integrityChecker"
    );
    NodeRef childRef = createFolder(testRootFolder.getNodeRef(), "TT")
      .getChildRef();
    ...
    NodeRef copiedNodeRef = nodeService.getChildByName(
      childRef,
      ContentModel.ASSOC_CONTAINS,
  ...
  @Test
  public void testCreateFileAndFolderInFolderInVirtualContext()
    throws Exception {
    NodeRef physicalFolder = createFolder(testRootFolder.getNodeRef(), "FOLDER")
      .getChildRef();
    NodeRef virtualFolder = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
      VIRTUAL_FOLDER_2_NAME,
    ...
    try {
      ...
      NodeRef childFileNodeRef = nodeService.getChildByName(
        physicalFolderInVirtualContext,
        ContentModel.ASSOC_CONTAINS,
        "testFile1"
      );
  ...
  public void testHasAspect() throws Exception {
    ...
    assertNotNull(node1);
    assertTrue(
      nodeService.hasAspect(node1, VirtualContentModel.ASPECT_VIRTUAL)
    );
    assertFalse(
      nodeService.hasAspect(node1, VirtualContentModel.ASPECT_VIRTUAL_DOCUMENT)
    );

    // test for document in virtual context
    String filename = "testName.txt";
    NodeRef fileNodeRef = fileAndFolderService
      .create(node1, filename, ContentModel.TYPE_CONTENT)
      .getNodeRef();
    assertFalse(
      nodeService.hasAspect(fileNodeRef, VirtualContentModel.ASPECT_VIRTUAL)
    );
    assertTrue(
      nodeService.hasAspect(
        fileNodeRef,
    ...
    NodeRef realFolderNode = createFolder(testRootFolder.getNodeRef(), "FOLDER")
      .getChildRef();
    NodeRef virtualFolder = createVirtualizedFolder(
      testRootFolder.getNodeRef(),
      VIRTUAL_FOLDER_2_NAME,
    ...
    NodeRef node1_1 = nodeService.getChildByName(
      virtualFolder,
      ContentModel.ASSOC_CONTAINS,
      "Node1"
    );
