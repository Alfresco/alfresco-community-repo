...
/**
 * Test of the ActionExecuter for extracting metadata, specifically for the mapping to cm:taggable tags which requires different transaction mechanisms than the existing {@link ContentMetadataExtracterTest}.
 * 
