...
public class ISO9075Test extends TestCase {
  ...
  public void testEncoding() {
    ...
    assertEquals(
      ...
      ISO9075.encode("My_x0020_Documents")
    );
    assertEquals("_x005f_x0020_Documents", ISO9075.encode("_x0020_Documents"));
    assertEquals(
      "_x0040__x005f_x0020_Documents",
      ISO9075.encode("@_x0020_Documents")
    );
    assertEquals(
      "Andy_x0027_s_x0020_Bits_x0020__x0026__x0020_Bobs_x0020__xabcd__x005c_",
      ISO9075.encode("Andy's Bits & Bobs \uabcd\\")
    );
    assertEquals(
    ...
    assertEquals(
      "\u0123_x4567_\u8900_xabcd__xefff__xT65A_",
      ISO9075.encode("\u0123\u4567\u8900\uabcd\uefff_xT65A_")
    );
  ...
  public void testDeEncoding() {
    ...
    assertEquals(
      "My_x0020_Documents",
      ISO9075.decode("My_x005f_x0020_Documents")
    );
    assertEquals("_x0020_Documents", ISO9075.decode("_x005f_x0020_Documents"));
    assertEquals(
      "@_x0020_Documents",
      ISO9075.decode("_x0040__x005f_x0020_Documents")
    );
    assertEquals(
      "Andy's Bits & Bobs \uabcd",
      ISO9075.decode(
        "Andy_x0027_s_x0020_Bits_x0020__x0026__x0020_Bobs_x0020__xabcd_"
      )
    );
    assertEquals(
      "Andy's Bits & Bobs \uabcd\\",
    ...
    assertEquals(
      "\u0123\u4567\u8900\uabcd\uefff_xT65A_",
      ISO9075.decode("\u0123_x4567_\u8900_xabcd__xefff__xT65A_")
    );
  }
  ...
  public void testRoundTrip1() {
    ...
    assertEquals(
      "My_Documents",
      ISO9075.decode(ISO9075.encode("My_Documents"))
    );
    assertEquals(
      "My Documents",
      ISO9075.decode(ISO9075.encode("My Documents"))
    );
    assertEquals(
      "My_x0020Documents",
      ISO9075.decode(ISO9075.encode("My_x0020Documents"))
    );
    assertEquals(
      "My_x0020_Documents",
      ISO9075.decode(ISO9075.encode("My_x0020_Documents"))
    );
    assertEquals(
      "_x0020_Documents",
      ISO9075.decode(ISO9075.encode("_x0020_Documents"))
    );
    assertEquals(
      "@_x0020_Documents",
      ISO9075.decode(ISO9075.encode("@_x0020_Documents"))
    ...
    assertEquals(
      "Andy's Bits & Bobs \uabcd",
      ISO9075.decode(ISO9075.encode("Andy's Bits & Bobs \uabcd"))
    );
    assertEquals(
      "Andy's Bits & Bobs \uabcd\\",
      ISO9075.decode(ISO9075.encode("Andy's Bits & Bobs \uabcd\\"))
    ...
    assertEquals(
      "\u0123\u4567\u8900\uabcd\uefff_xT65A_",
      ISO9075.decode(ISO9075.encode("\u0123\u4567\u8900\uabcd\uefff_xT65A_"))
    );
  }
  ...
  public void testRoundTrip2() {
    ...
    assertEquals(
      "My_Documents",
      ISO9075.encode(ISO9075.decode("My_Documents"))
    );
    assertEquals(
      "My_x0020_Documents",
      ISO9075.encode(ISO9075.decode("My_x0020_Documents"))
    );
    assertEquals(
      "My_x0020Documents",
      ISO9075.encode(ISO9075.decode("My_x0020Documents"))
    );
    assertEquals(
      "My_x005f_x0020_Documents",
      ISO9075.encode(ISO9075.decode("My_x005f_x0020_Documents"))
    );
    assertEquals(
      "_x005f_x0020_Documents",
      ISO9075.encode(ISO9075.decode("_x005f_x0020_Documents"))
    );
    assertEquals(
      "_x0040__x005f_x0020_Documents",
      ISO9075.encode(ISO9075.decode("_x0040__x005f_x0020_Documents"))
    );
    assertEquals(
      "Andy_x0027_s_x0020_Bits_x0020__x0026__x0020_Bobs_x0020__xabcd_",
      ISO9075.encode(
    ...
    assertEquals(
      "\u0123_x4567_\u8900_xabcd__xefff__xT65A_",
      ISO9075.encode(ISO9075.decode("\u0123_x4567_\u8900_xabcd__xefff__xT65A_"))
    );
  }
  ...
  public void testEncodeSQL() {
    assertEquals(
      "vns10:individual_entity",
      ISO9075.encodeSQL("vns10:individual_entity")
    );
    assertEquals(
      "_vns10:individual_entity",
      ISO9075.encodeSQL("_vns10:individual_entity")
    );
    assertEquals(
      "_x0031_vns10:individual_entity",
      ISO9075.encodeSQL("1vns10:individual_entity")
    );
    assertEquals(
      "_x0031_vns10:individual_x002d_entity",
      ISO9075.encodeSQL("1vns10:individual-entity")
    );
  }
}
