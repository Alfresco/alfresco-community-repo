...
/**
 * Factory for {@link NodeInfo} objects. Avoids having to pass in {@link NodeService} and {@link
 * NamespaceService} each time a NodeInfo is created.
 *
 * <p>
 *
 * @author Alan Davis
...
public class NodeInfoFactory {
    ...
    public NodeInfo newNodeInfo(ChildAssociationRef childAssocRef) {
        ...
        String path =
                getPath(childAssocRef.getParentRef()) + '/' + getName(childAssocRef.getQName());
