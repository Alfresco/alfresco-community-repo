...
public abstract class ProtocolHashStringifier
  ...
  public ProtocolHashStringifier(
  ...
  public String stringifyRepositoryLocation(
    ...
    throw new ReferenceEncodingException(
      "Unknown repository location  " + repositoryLocation
    );
  }
  ...
  public String stringifyRepositoryLocation(
    ...
    return (
      REPOSITORY_NODEREF_RESOURCE_CODE +
      "-" +
      hash.getFirst() +
      hash.getSecond()
    );
  ...
  public String stringify(List<Parameter> parameters)
    throws ReferenceEncodingException {
    throw new ReferenceEncodingException(
      "Invalid stringifier cotext " + parameters
    );
  }
  ...
  public String stringify(Parameter parameter)
    throws ReferenceEncodingException {
    throw new ReferenceEncodingException(
      "Invalid stringifier cotext " + parameter
    );
  }
  ...
  public String stringifyParameter(ResourceParameter resourceParameter)
    throws ReferenceEncodingException {
    throw new ReferenceEncodingException(
      "Invalid stringifier cotext " + resourceParameter
    );
  }
  ...
  public String stringifyParameter(StringParameter stringParameter)
    throws ReferenceEncodingException {
    throw new ReferenceEncodingException(
      "Invalid stringifier cotext " + stringParameter
    );
  }
  ...
  public String stringifyParameter(ReferenceParameter referenceParameter)
    throws ReferenceEncodingException {
    throw new ReferenceEncodingException(
      "Invalid stringifier cotext " + referenceParameter
    );
  }
}
