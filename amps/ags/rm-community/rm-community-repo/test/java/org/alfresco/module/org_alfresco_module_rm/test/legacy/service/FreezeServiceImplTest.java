    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          ...
          // Freeze a record
          NodeRef hold101 = holdService.createHold(
            filePlan,
            "freezename 101",
            "FreezeReason",
            null
          ...
          assertEquals(
            "NewFreezeReason",
            holdService.getHoldReason(holdNodeRef)
          );
          ...
          // Check the nodes are frozen
          final List<NodeRef> testRecords = Arrays.asList(
            new NodeRef[] { recordOne, recordTwo, recordThree }
          );
