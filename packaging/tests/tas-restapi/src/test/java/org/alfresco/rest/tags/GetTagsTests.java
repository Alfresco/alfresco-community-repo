...
public class GetTagsTests extends TagsDataPrep {
  ...
  @TestRail(
    ...
    description = "Verify user with Manager role gets tags using REST API and status code is OK (200)"
  )
  ...
  @TestRail(
    ...
    description = "Verify user with Collaborator role gets tags using REST API and status code is OK (200)"
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify user with Contributor role gets tags using REST API and status code is OK (200)"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify user with Consumer role gets tags using REST API and status code is OK (200)"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION })
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TAGS },
    executionType = ExecutionType.SANITY,
    description = "Failed authentication get tags call returns status code 401 with Manager role"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TAGS, TestGroup.SANITY })
  ...
  public void siteManagerIsAbleToRetrieveTagsWithPropertiesParameter()
    ...
    returnedCollection =
      restClient
        ...
        .withParams("maxItems=5000&properties=tag")
        .withCoreAPI()
        .getTags();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    returnedCollection
  ...
  public void useSkipCountCheckPagination() throws Exception {
    returnedCollection =
      restClient.authenticateUser(adminUserModel).withCoreAPI().getTags();
    restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    RestTagModelsCollection tagsWithSkipCount = restClient
    ...
    tagsWithSkipCount
      .assertThat()
      .entriesListDoesNotContain("tag", firstTag.getTag())
      .assertThat()
      .entriesListDoesNotContain("tag", secondTag.getTag());
  ...
  public void useMaxItemsParameterCheckPagination() throws Exception {
    ...
    RestTagModel firstTag = returnedCollection.getEntries().get(0).onModel();
    RestTagModel secondTag = returnedCollection.getEntries().get(1).onModel();
    RestTagModelsCollection tagsWithMaxItems = restClient
    ...
    tagsWithMaxItems
      .assertThat()
      .entriesListContains("tag", firstTag.getTag())
      .assertThat()
      .entriesListContains("tag", secondTag.getTag())
      .assertThat()
  ...
  public void checkThatDeletedTagIsNotRetrievedAnymore() throws Exception {
    ...
    RestTagModel deletedTag = restClient
    ...
    returnedCollection
      ...
      .entriesListIsNotEmpty()
      .and()
      .entriesListDoesNotContain("tag", removedTag.toLowerCase());
  }
}
