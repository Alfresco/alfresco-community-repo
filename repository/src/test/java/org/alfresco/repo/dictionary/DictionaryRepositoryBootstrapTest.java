...
public class DictionaryRepositoryBootstrapTest extends BaseSpringTest {
    public static final String TEMPLATE_MODEL_XML =
            "<model name={0} xmlns=\"http://www.alfresco.org/model/dictionary/1.0\">  "
                + " <description>{1}</description>   <author>Alfresco</author>  "
                + " <published>2005-05-30</published>   <version>1.0</version>   <imports>     "
                + " <import uri=\"http://www.alfresco.org/model/dictionary/1.0\" prefix=\"d\"/>    "
                + "  {2}    </imports>   <namespaces>      <namespace uri={3} prefix={4}/>  "
                + " </namespaces>   <types>      <type name={5}>        <title>Base</title>       "
                + " <description>The Base Type</description>        <properties>          "
                + " <property name={6}>              <type>d:text</type>           </property>     "
    ...
    public void testBootstrap() throws Exception {
        ...
        createModelNode(
                ...
                "testModel2",
                " <import"
                    + " uri=\"http://www.alfresco.org/model/test1DictionaryBootstrapFromRepo/1.0\""
                    + " prefix=\"test1\"/> ",
                "Test model two",
                "base2",
                "prop2");
        ...
        ModelDefinition modelDefinition1 =
                this.dictionaryDAO.getModel(
                        QName.createQName(
                                "http://www.alfresco.org/model/test1DictionaryBootstrapFromRepo/1.0",
                                "testModel1"));
        ...
        ModelDefinition modelDefinition3 =
                this.dictionaryDAO.getModel(
                        QName.createQName(
                                "http://www.alfresco.org/model/test3DictionaryBootstrapFromRepo/1.0",
                                "testModel3"));
    ...
    private NodeRef createModelNode(
        ...
        NodeRef model =
                this.nodeService
                        ...
                        .getChildRef();
        ContentWriter contentWriter1 =
                this.contentService.getWriter(model, ContentModel.PROP_CONTENT, true);
