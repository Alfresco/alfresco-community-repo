...
public class JscriptWorkflowTask
  ...
  public Scriptable getProperties() {
    ...
    ScriptableQNameMap<String, Serializable> properties = new ScriptableQNameMap<String, Serializable>(
      namespaceProvider
    );
  ...
  public void setProperties(
    ...
    this.task =
      workflowService.updateTask(task.getId(), qNameProps, null, null);
  }
  ...
  public Scriptable getPackageResources() {
    ...
    return Context
      .getCurrentContext()
      .newArray(getScope(), resources.toArray());
  }
  ...
  private Collection<QName> getAllowedPackageResourceTypes() {
    ...
    Collection<QName> allowedTypes = dictionaryService.getSubTypes(
      ContentModel.TYPE_CONTENT,
      true
    );
    allowedTypes.addAll(
      dictionaryService.getSubTypes(ApplicationModel.TYPE_FILELINK, true)
    );
    return allowedTypes;
  }
