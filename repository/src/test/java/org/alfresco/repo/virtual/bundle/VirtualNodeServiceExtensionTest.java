...
public class VirtualNodeServiceExtensionTest extends VirtualizationIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        super.setUp();
        smartStore = ctx.getBean("smartStore", VirtualStore.class);
        downloadStorage = ctx.getBean("downloadStorage", DownloadStorage.class);
    }
    ...
    public void testCreateNode_withFilingRuleAspects() throws Exception {
        NodeRef assocNode2 =
                nodeService.getChildByName(
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "Node2");
        NodeRef assocNode2_1 =
                nodeService.getChildByName(assocNode2, ContentModel.ASSOC_CONTAINS, "Node2_1");
        ChildAssociationRef childAssocRef = createContent(assocNode2_1, "ContentWithAspects");
        assertNewVirtualChildAssocRef(assocNode2_1, childAssocRef);

        nodeService.hasAspect(childAssocRef.getChildRef(), ContentModel.ASPECT_AUTHOR);

        nodeService.hasAspect(childAssocRef.getChildRef(), ContentModel.ASPECT_DUBLINCORE);
    }

    @Test
    public void testCreateNode_noFilingRule() throws Exception {
        NodeRef testTemplate2 =
                createVirtualizedFolder(
                        testRootFolder.getNodeRef(),
                        "aVFTestTemplate2",
                        TEST_TEMPLATE_2_JSON_SYS_PATH);
        NodeRef testTemplate2Node2 =
                nodeService.getChildByName(testTemplate2, ContentModel.ASSOC_CONTAINS, "Node2");

        try {
            createContent(testTemplate2Node2, "shouldNotBeCreated");
    ...
    public void testCreate_NodeProtocolParent() throws Exception {
        ...
        QName assocQName =
                QName.createQName(
                        "cm", "contentThumbnail", environment.getNamespacePrefixResolver());
        QName assocTypeQName = RenditionModel.ASSOC_RENDITION;
        ChildAssociationRef assoc =
                nodeService.createNode(node, assocTypeQName, assocQName, nodeTypeQName);
        ...
        assertEquals(
                physicalRenditionNode,
                refs.get(0).getChildRef()); // the association exists for the physical nodes

        List<ChildAssociationRef> virtualRefs = nodeService.getChildAssocs(virtualRenditionParent);
        assertEquals(
                physicalRenditionNode,
                virtualRefs.get(0).getChildRef()); // the association exists for the virtual nodes
    }

    @Test
    public void testCreateNode_CM_528_folder_filing_type() throws Exception {
        NodeRef testTemplate5 =
                createVirtualizedFolder(
                        testRootFolder.getNodeRef(),
                        "aVFTestTemplate5",
                        TEST_TEMPLATE_5_JSON_SYS_PATH);
        NodeRef folderFilingTypeNode =
                nodeService.getChildByName(
                        testTemplate5, ContentModel.ASSOC_CONTAINS, "FolderFilingType");

        ChildAssociationRef forcedCmContentAssocRef =
                createContent(folderFilingTypeNode, "forcedCmContent");
    ...
    public void testCreateNode() throws Exception {
        ...
        Reference firstChild =
                smartStore.getChildByName(semiVirtualFolder, ContentModel.ASSOC_CONTAINS, "Node1");
        assertNotNull(firstChild);

        Reference secondChild =
                smartStore.getChildByName(semiVirtualFolder, ContentModel.ASSOC_CONTAINS, "Node2");
        ...
        assertNotNull(
                nodeService.getChildByName(
                        firstChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile.txt"));
        uploadNode(firstChild, fileName);
        assertNotNull(
                nodeService.getChildByName(
                        firstChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile-1.txt"));

        // add testfile.txt to second virtual child
        uploadNode(secondChild, fileName);
        assertNotNull(
                nodeService.getChildByName(
                        secondChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile-2.txt"));
        uploadNode(secondChild, fileName);
        assertNotNull(
                nodeService.getChildByName(
                        secondChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile-3.txt"));
        ...
        assertNotNull(
                nodeService.getChildByName(
                        firstChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile-4.txt"));
        ...
        assertNotNull(
                nodeService.getChildByName(
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "testfile-5.txt"));

        fileName = "testfile-6.txt";
        fileAndFolderService.create(virtualFolder1NodeRef, fileName, ContentModel.TYPE_CONTENT);
        assertNotNull(
                nodeService.getChildByName(
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "testfile-6.txt"));
        ...
        assertNotNull(
                nodeService.getChildByName(
                        secondChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile-7.txt"));
        ...
        assertNotNull(
                nodeService.getChildByName(
                        secondChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile1-1.txt"));
        fileAndFolderService.create(secondChild.toNodeRef(), fileName, ContentModel.TYPE_CONTENT);
        assertNotNull(
                nodeService.getChildByName(
                        secondChild.toNodeRef(), ContentModel.ASSOC_CONTAINS, "testfile1-1-1.txt"));
    }
    ...
    public void ignore_testCreateFilingIrregularNode() throws Exception {
        ...
        {
            NodeRef node1 = nodeService.getChildByName(vf, ContentModel.ASSOC_CHILDREN, "Node1");
            ...
            ChildAssociationRef folderChilAssoc =
            ...
            assertEquals(ContentModel.TYPE_FOLDER, environment.getType(folderChildRef));
            assertEquals(
                    "Node1_content_FR",
...

        {
            ...
            ChildAssociationRef folderChilAssoc =
                    nodeService.createNode(
                            ...
                            properties);
            NodeRef folderChildRef = folderChilAssoc.getChildRef();
            assertEquals(ContentModel.TYPE_CONTENT, environment.getType(folderChildRef));
            assertEquals(
                    "Node2_folder_FR",
                    environment.getProperties(folderChildRef).get(ContentModel.PROP_DESCRIPTION));
        }
    ...
    private void uploadNode(Reference reference, String name) {
        fileAndFolderService.create(reference.toNodeRef(), name, ContentModel.TYPE_CONTENT);
    }

    /**
     * Assets that the given {@link ChildAssociationRef} was created within the given virtualizable
     * nodeRef container reference.
     *
     * @param nodeRef
     * @param childAssocsRef
     */
    private void assertNewVirtualChildAssocRef(
            NodeRef nodeRef, ChildAssociationRef childAssocsRef) {
    ...
    /**
     * Assets that the given {@link ChildAssociationRef} was created within the given container
     * {@link Reference}.
     *
     * @param nodeRef
     * @param childAssocsRef
     */
    private void assertNewVirtualChildAssocRef(
            Reference reference, ChildAssociationRef childAssocsRef) {
    ...
    public void testGetPath() throws Exception {
        ...
        assertEquals(
                "/app:company_home/cm:TestFolder/cm:VirtualFolder1/smf:Node2",
    ...
    public void testNodeProtocolReferencePath() throws Exception {
        ...
        NodeRef childRef =
                nodeService.getChildByName(node2, ContentModel.ASSOC_CONTAINS, "testfile.txt");
        Path path = nodeService.getPath(childRef);
        assertEquals(
                "/app:company_home/cm:TestFolder/cm:VirtualFolder1/smf:Node2/cm:testfile.txt",
                path.toPrefixString(environment.getNamespacePrefixResolver()));

        NodeRef physicalNode =
                nodeService.getChildByName(
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "testfile.txt");
        assertNotNull(physicalNode);

        Path physicalPath = nodeService.getPath(physicalNode);

        assertEquals(
                "/app:company_home/cm:TestFolder/cm:VirtualFolder1/cm:testfile.txt",
        ...
        NodeRef childRef_1 =
                nodeService.getChildByName(node2_1, ContentModel.ASSOC_CONTAINS, "testfile-1.txt");
        Path path_1 = nodeService.getPath(childRef_1);
        assertEquals(
                "/app:company_home/cm:TestFolder/cm:VirtualFolder1/smf:Node2/smf:Node2_1/cm:testfile-1.txt",
    ...
    private void setUpTestAssociations(NodeRef actualNodeRef) {
        ...
        rootChildrenQNames[0] =
                QName.createQNameWithValidLocalName(
                        VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Node2");
        rootChildrenQNames[1] =
                QName.createQNameWithValidLocalName(
                        VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Node1");
        ...
        ChildAssociationRef node2ChildAssoc = createContent(node2, node2ChildNameString);
        node2Test1_2_TXTNodeRef = node2ChildAssoc.getChildRef();
        rootChildrenQNames[2] =
                QName.createQNameWithValidLocalName(
                        NamespaceService.CONTENT_MODEL_1_0_URI, node2ChildNameString);

        nodeService.setProperty(
                node2ChildAssoc.getChildRef(), ContentModel.PROP_TITLE, NODE2TEST1_2_TXT);

        node2ChildrenQNames = new QName[2];
        node2ChildrenQNames[0] =
                QName.createQNameWithValidLocalName(
                        VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Node2_1");
        ...
        for (int i = 1; i <= 10; i++) {
            ChildAssociationRef childAssoc = createContent(node2_1, "test" + i + "_2_1.txt");
            rootChildrenQNames[2 + i] =
                    QName.createQNameWithValidLocalName(
                            NamespaceService.CONTENT_MODEL_1_0_URI,
    ...
    private ChildAssociationRef findActualAssocPeer(
            ChildAssociationRef virtualAssoc, NodeRef actualParentNodeRef) {
        ...
        for (ChildAssociationRef actualAssocRef : actualAssocs) {
            if (materialNodeRef.equals(actualAssocRef.getChildRef())) {
                if (virtualAssoc
                                .getQName()
                                .getLocalName()
                                .equals(actualAssocRef.getQName().getLocalName())
    ...
    public void testRemoveChildAssoc_1() throws Exception {
        ...
        ChildAssociationRef node2ChildAssoc =
                createContent(node2, "TestPresentation4_pdf_removeAssoc");

        assertNotNull(findActualAssocPeer(node2ChildAssoc, virtualFolder1NodeRef));

        boolean removed = nodeService.removeChildAssociation(node2ChildAssoc);

        assertTrue("No association", removed);

        assertNull(findActualAssocPeer(node2ChildAssoc, virtualFolder1NodeRef));
    }
    ...
    public void testGetChildAssocs_1() throws Exception {
        ...
        assertAssocNames(childAssocs, rootChildrenQNames);
        ...
        assertAssocNames(childAssocs, node2_1ChildrenQNames);
    }
    ...
    protected void assertAssocNames(List<ChildAssociationRef> assocs, QName... expectedNames) {
        ...
        for (int i = 0; i < expectedNames.length; i++) {
            assertTrue(
                    expectedNames[i] + " assoc name was expected  within " + actualNames,
    ...
    public void testGetChildAssocs_2() throws Exception {
        ...
        childAssocs =
                nodeService.getChildAssocs(
                        node2, RegexQNamePattern.MATCH_ALL, RegexQNamePattern.MATCH_ALL, 7, true);
        assertEquals(2, childAssocs.size());
        ...
        childAssocs =
                nodeService.getChildAssocs(
                        node2, RegexQNamePattern.MATCH_ALL, RegexQNamePattern.MATCH_ALL, 2, true);
        if (logger.isDebugEnabled()) {
            logger.debug("Got children of node2 " + childAssocs);
        }
        assertEquals(2, childAssocs.size());
    ...
    public void testGetChildAssocs_3() throws Exception {
        ...
        List<ChildAssociationRef> folderAssocs =
                nodeService.getChildAssocs(
                        virtualFolder1NodeRef,
                        new HashSet<>(Arrays.asList(ContentModel.TYPE_FOLDER)));

        assertEquals(2, folderAssocs.size());

        List<ChildAssociationRef> contentAssocs =
                nodeService.getChildAssocs(
                        virtualFolder1NodeRef,
                        new HashSet<>(Arrays.asList(ContentModel.TYPE_CONTENT)));

        assertEquals(11, contentAssocs.size());
    }
    ...
    public void testGetChildAssocsByPropertyValue() throws Exception {
                        ...
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "Node2");
        {
            List<ChildAssociationRef> children =
                    nodeService.getChildAssocsByPropertyValue(
                            node2, ContentModel.PROP_TITLE, NODE2TEST1_2_TXT);
            assertNotNull(children);
            assertEquals(1, children.size());
            assertEquals(node2Test1_2_TXTNodeRef, children.get(0).getChildRef());
        }

        {
            List<ChildAssociationRef> children =
                    nodeService.getChildAssocsByPropertyValue(
                            node2, ContentModel.PROP_TITLE, "non" + NODE2TEST1_2_TXT);
    ...
    public void testGetProperties() throws Exception {
        ...
        nodeService.setProperty(template2VF, ContentModel.PROP_DESCRIPTION, expectedDescription);

        NodeRef node1 =
                nodeService.getChildByName(template2VF, ContentModel.ASSOC_CONTAINS, "Node1");

        assertVirtualNode(node1);

        NodeRef node2 =
                nodeService.getChildByName(template2VF, ContentModel.ASSOC_CONTAINS, "Node2");

        Map<QName, Serializable> expectedProperties = new HashMap<>();
        expectedProperties.put(ContentModel.PROP_DESCRIPTION, expectedDescription);
        assertVirtualNode(node2, expectedProperties);
    }
    ...
    public void testCreateAssociation() throws Exception {
        ...
        nodeService.createAssociation(
                createDownloadNode, node2, DownloadModel.ASSOC_REQUESTED_NODES);
    }
    ...
    public void testGetParentAssocs() throws Exception {
...

        {
            ...
            assertEquals(ContentModel.ASSOC_CONTAINS, firstAssoc.getTypeQName());
            assertEquals(node2, child);
            assertEquals(virtualFolder1NodeRef, parent);
        ...
        {
            List<ChildAssociationRef> node2Parents =
                    nodeService.getParentAssocs(
                            node2,
                            RegexQNamePattern.MATCH_ALL,
                            new RegexQNamePattern(
                                    VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Node."));
            assertNotNull(node2Parents);
            assertTrue(!node2Parents.isEmpty());
            ChildAssociationRef firstAssoc = node2Parents.get(0);
            NodeRef child = firstAssoc.getChildRef();
            ...
            assertNotNull(firstAssoc.getQName());
            assertEquals(
                    QName.createQName(VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Node2"),
                    firstAssoc.getQName());
        }

        {
            List<ChildAssociationRef> node2Parents =
                    nodeService.getParentAssocs(
                            ...
                            RegexQNamePattern.MATCH_ALL,
                            new RegexQNamePattern(
                                    VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Foo."));
            assertNotNull(node2Parents);
            assertTrue(node2Parents.isEmpty());
        }
    }
    ...
    public void testGetSourceAssocs_download() throws Exception {
        ...
        sourceAssocs = nodeService.getSourceAssocs(node2, RegexQNamePattern.MATCH_ALL);
        assertEquals(0, sourceAssocs.size());

        sourceAssocs = nodeService.getSourceAssocs(node2, DownloadModel.ASSOC_REQUESTED_NODES);
        assertEquals(0, sourceAssocs.size());
    ...
    public void testGetTargetAssocs_download() throws Exception {
        ...
        List<AssociationRef> targetAssocs =
                nodeService.getTargetAssocs(node2, DownloadModel.ASSOC_REQUESTED_NODES);
        ...
        targetAssocs =
                nodeService.getTargetAssocs(
                        createDownloadNode, DownloadModel.ASSOC_REQUESTED_NODES);
        ...
        nodeService.createAssociation(
                createDownloadNode, node2, DownloadModel.ASSOC_REQUESTED_NODES);
        nodeService.createAssociation(
                createDownloadNode, node2_1, DownloadModel.ASSOC_REQUESTED_NODES);
        targetAssocs = nodeService.getTargetAssocs(createDownloadNode, ContentModel.ASSOC_CONTAINS);
        assertEquals(0, targetAssocs.size());
        for (int i = 0; i < 2; i++) {
            targetAssocs =
        ...
        NodeRefExpression downloadAsocsFolderExpr =
                virtualizationConfigTestBootstrap.getDownloadAssocaiationsFolder();
        NodeRef downloadAssocsFolder = downloadAsocsFolderExpr.resolve();

        NodeRef tempDownloadSourceAssocs =
                nodeService.getChildByName(
        ...
        assertFalse(
                "Association information was not removed when removing the source.",
    ...
    public void testGetChildByName() {
        ...
        NodeRef virtualChild =
                nodeService.getChildByName(
                        semiVirtualFolder.toNodeRef(),
                        ContentModel.ASSOC_CONTAINS,
                        "All My Content");
        ...
        NodeRef phys1 =
                nodeService.getChildByName(
                        virtualChild, ContentModel.ASSOC_CONTAINS, "Company Home");
        assertNotNull(phys1);
        assertVirtualNode(virtualChild);

        // access physical child on second level
        NodeRef phys2 =
                nodeService.getChildByName(phys1, ContentModel.ASSOC_CONTAINS, "Data Dictionary");
        assertNotNull(phys2);
        assertVirtualNode(virtualChild);
    }
    ...
    public void testGetPrimaryParent() throws Exception {
        ...
        assertEquals(virtualFolder1NodeRef, parentRef);
        assertEquals(
                QName.createQNameWithValidLocalName(
                        VirtualContentModel.VIRTUAL_CONTENT_MODEL_1_0_URI, "Node2"),
        ...
        assertEquals(node2, parentRef);
    }

    @Test
    public void testGetAssocs_CM_673() throws Exception {
        NodeRef createFolder = createFolder(testRootFolder.getNodeRef(), "FOLDER").getChildRef();
        createContent(createFolder, "testFile1", "0", MimetypeMap.MIMETYPE_TEXT_PLAIN, "UTF-8");
        NodeRef virtualFolder =
                createVirtualizedFolder(
                        testRootFolder.getNodeRef(),
                        VIRTUAL_FOLDER_2_NAME,
        ...
        NodeRef node1 =
                nodeService.getChildByName(virtualFolder, ContentModel.ASSOC_CONTAINS, "Node1");
        assertNotNull(node1);

        prepareMocks("cm:TestFolder//cm:FOLDER", createFolder);
        try {
            NodeRef physicalFolderInVirtualContext =
                    nodeService.getChildByName(node1, ContentModel.ASSOC_CONTAINS, "FOLDER");
            assertNotNull(physicalFolderInVirtualContext);

            List<ChildAssociationRef> childAssocs =
                    nodeService.getChildAssocs(physicalFolderInVirtualContext);
            assertNotNull(childAssocs);
            assertEquals(1, childAssocs.size());
            assertEquals(
                    "testFile1",
                    nodeService.getProperty(
                            childAssocs.get(0).getChildRef(), ContentModel.PROP_NAME));
        } finally {
            resetMocks();
        }
    }
    ...
    public void testCopySemivirtualFolder() throws Exception {
        ...
        copyService.copyAndRename(
                virtualFolder1NodeRef, childRef, ContentModel.ASSOC_CONTAINS, null, true);
        NodeRef copiedNodeRef =
                nodeService.getChildByName(
                        childRef, ContentModel.ASSOC_CONTAINS, VIRTUAL_FOLDER_1_NAME);
        assertNotNull(copiedNodeRef);
        NodeRef node2 =
                nodeService.getChildByName(copiedNodeRef, ContentModel.ASSOC_CONTAINS, "Node2");
        assertNotNull(node2);
    ...
    public void testCreateFileAndFolderInFolderInVirtualContext() throws Exception {
        NodeRef physicalFolder = createFolder(testRootFolder.getNodeRef(), "FOLDER").getChildRef();
        NodeRef virtualFolder =
                createVirtualizedFolder(
                        testRootFolder.getNodeRef(),
                        VIRTUAL_FOLDER_2_NAME,
        ...
        try {
            ...
            childFileNodeRef =
                    nodeService.getChildByName(
                            physicalFolder, ContentModel.ASSOC_CONTAINS, "testFile1");
            assertNotNull(childFileNodeRef);

            createFolder(physicalFolderInVirtualContext, "testFolder1");

            NodeRef childFolderNodeRef =
                    nodeService.getChildByName(
                            physicalFolderInVirtualContext,
                            ContentModel.ASSOC_CONTAINS,
                            "testFolder1");
            ...
            childFolderNodeRef =
                    nodeService.getChildByName(
                            physicalFolder, ContentModel.ASSOC_CONTAINS, "testFolder1");
            assertNotNull(childFolderNodeRef);
        } finally {
            resetMocks();
        }
    ...
    public void testChildByName_ACE_4700() throws Exception {
        ...
        fileAndFolderService.create(node1, suportedCharsFileName, ContentModel.TYPE_CONTENT);
        fileAndFolderService.create(node1, suportedCharsFileName, ContentModel.TYPE_CONTENT);
        assertNotNull(
                nodeService.getChildByName(
                        node1, ContentModel.ASSOC_CONTAINS, suportedCharsFileName));
        assertNotNull(
                nodeService.getChildByName(
                        node1, ContentModel.ASSOC_CONTAINS, suportedCharsFileName1));
        assertNull(
                nodeService.getChildByName(
    ...
    public void testHasAspect() throws Exception {
        ...
        NodeRef node1 =
                nodeService.getChildByName(
                        virtualFolder1NodeRef, ContentModel.ASSOC_CONTAINS, "Node1");
        assertNotNull(node1);
        assertTrue(nodeService.hasAspect(node1, VirtualContentModel.ASPECT_VIRTUAL));
        assertFalse(nodeService.hasAspect(node1, VirtualContentModel.ASPECT_VIRTUAL_DOCUMENT));

        // test for document in virtual context
        String filename = "testName.txt";
        NodeRef fileNodeRef =
                fileAndFolderService
                        .create(node1, filename, ContentModel.TYPE_CONTENT)
                        .getNodeRef();
        assertFalse(nodeService.hasAspect(fileNodeRef, VirtualContentModel.ASPECT_VIRTUAL));
        assertTrue(nodeService.hasAspect(fileNodeRef, VirtualContentModel.ASPECT_VIRTUAL_DOCUMENT));

        // test for folder in virtual context
        NodeRef realFolderNode = createFolder(testRootFolder.getNodeRef(), "FOLDER").getChildRef();
        NodeRef virtualFolder =
                createVirtualizedFolder(
                        testRootFolder.getNodeRef(),
                        VIRTUAL_FOLDER_2_NAME,
        ...
        try {
            NodeRef physicalFolderInVirtualContext =
                    nodeService.getChildByName(node1_1, ContentModel.ASSOC_CONTAINS, "FOLDER");
            assertNotNull(physicalFolderInVirtualContext);

            assertFalse(
                    nodeService.hasAspect(
                            physicalFolderInVirtualContext, VirtualContentModel.ASPECT_VIRTUAL));
            assertTrue(
                    nodeService.hasAspect(
                            physicalFolderInVirtualContext,
            ...
            assertNotNull(childFileNodeRef);
            assertFalse(
                    nodeService.hasAspect(childFileNodeRef, VirtualContentModel.ASPECT_VIRTUAL));
            assertFalse(
                    nodeService.hasAspect(
                            childFileNodeRef, VirtualContentModel.ASPECT_VIRTUAL_DOCUMENT));
        } finally {
            resetMocks();
        }
    }
