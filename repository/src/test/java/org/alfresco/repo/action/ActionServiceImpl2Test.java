...
public class ActionServiceImpl2Test {
  ...
  public static void initStaticData() throws Exception {
    nodeService =
      (NodeService) APP_CONTEXT_INIT
        ...
        .getBean("nodeService");
    actionService =
      (ActionService) APP_CONTEXT_INIT
        .getApplicationContext()
  ...
  public void testIncrementCounterOnDeletedNode() throws Exception {
    final NodeRef deletedNode = transactionHelper.doInTransaction(
      new RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
          // get the Document Library NodeRef
          final NodeRef docLibNodeRef = testSiteAndMemberInfo.doclib;

          NodeRef result = nodeService
            .createNode(
              docLibNodeRef,
              ContentModel.ASSOC_CONTAINS,
              ContentModel.ASSOC_CONTAINS,
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          Action incrementAction = actionService.createAction(
            CounterIncrementActionExecuter.NAME
          );
  ...
  public void testIncrementCounter() throws Exception {
    ...
    AuthenticationUtil.setFullyAuthenticatedUser(
      testSiteAndMemberInfo.siteManager
    );
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
    ...
    int beforeIncrement = (Integer) nodeService.getProperty(
      testNode,
    ...
    AuthenticationUtil.setFullyAuthenticatedUser(
      testSiteAndMemberInfo.siteConsumer
    );
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
    ...
    int afterIncrement = (Integer) nodeService.getProperty(
      testNode,
      ContentModel.PROP_COUNTER
    );
  ...
  public void testTransform() throws Exception {
    final File file = loadAndAddQuickFileAsManager(
      testNode,
      "quick.txt",
  ...
  public void testParameterConstraints() throws Exception {
    ...
    if (constraints.size() > 0) {
      ...
      ParameterConstraint pConstraintAgain = actionService.getParameterConstraint(
  ...
  public void testExecuteScript() throws Exception {
    final NodeRef scriptToBeExecuted = addTempScript(
      ...
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          action.setParameterValue(
            ScriptActionExecuter.PARAM_SCRIPTREF,
            scriptToBeExecuted
          );
    ...
    NodeRef sharedFolderRef = nodeService.getChildByName(
      companyHomeRef,
      ContentModel.ASSOC_CONTAINS,
      "Shared"
    );
    final NodeRef invalidScriptRef = addTempScript(
      "changeFileNameTest.js",
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          assertFalse(
            "Scripts outside of Data Dictionary Scripts folder should not be executed",
            (
              "Invalid_Change.pdf".equals(
                  nodeService.getProperty(testNode, ContentModel.PROP_NAME)
                )
            )
          );
      ...
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          try {
            ...
            NodeRef script = addTempScript(
              "test-action-result-script.js",
              "\"VALUE\";"
            );

            // Create the action
            Action action = actionService.createAction(
              ScriptActionExecuter.NAME
            );
            action.setParameterValue(
              ScriptActionExecuter.PARAM_SCRIPTREF,
              script
            ...
            // Get the result
            String result = (String) action.getParameterValue(
  ...
  public void testExtractMetedata() throws Exception {
    ...
    AuthenticationUtil.setFullyAuthenticatedUser(
      testSiteAndMemberInfo.siteCollaborator
    );
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
  ...
  private File loadAndAddQuickFileAsManager(
    ...
    final File file = AbstractContentTransformerTest.loadNamedQuickTestFile(
      quickFileName
    );
