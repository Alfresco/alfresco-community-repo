 ...
 *
 * <p>XMLTransferManifestWriter is a statefull object used for writing out a single transfer
 * manifest file in XML format to the writer passed in via startTransferManifest.
 *
 * <p>Call startTransferManifest, writeTransferManifestHeader, writeTransferManifestNode (0 to
 * many), endTransferManifest.
 *
 * @author Mark Rogers
 */
public class XMLTransferManifestWriter implements TransferManifestWriter {
    ...
    public void writeTransferManifestHeader(TransferManifestHeader header) throws SAXException {
        ...
        if (version != null) {
            ...
            attributes.addAttribute(
                    "uri", "versionMajor", "versionMajor", "String", version.getVersionMajor());
            attributes.addAttribute(
                    "uri", "versionMinor", "versionMinor", "String", version.getVersionMinor());
            attributes.addAttribute(
                    "uri",
                    "versionRevision",
                    "versionRevision",
    ...
    public void writeTransferManifestNode(TransferManifestDeletedNode node) throws SAXException {
        AttributesImpl attributes = new AttributesImpl();
        attributes.addAttribute(
                "uri", "nodeRef", "nodeRef", "String", node.getNodeRef().toString());
    ...
    public void writeTransferManifestNode(TransferManifestNormalNode node) throws SAXException {
        ...
        attributes.addAttribute(
                "uri", "nodeRef", "nodeRef", "String", node.getNodeRef().toString());
        attributes.addAttribute(
                "uri", "nodeType", "nodeType", "String", formatQName(node.getType()));
    ...
    private void writeCategory(NodeRef nodeRef, ManifestCategory value) throws SAXException {
        ...
        AttributesImpl attributes = new AttributesImpl();
        attributes.addAttribute(
                TransferModel.TRANSFER_MODEL_1_0_URI, "path", "path", "String", value.getPath());
        writer.startElement(
                TransferModel.TRANSFER_MODEL_1_0_URI,
