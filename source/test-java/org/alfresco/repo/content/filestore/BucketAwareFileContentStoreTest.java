...
/**
 * Tests bucket provisioning for FileContentStore
 * 
 * @author Andreeea Dragoi
 * @since 5.1
 */
...
/**
 * Tests for {@link FileContentStore FileContentStore} which uses {@link TimeBasedFileContentUrlProvider TimeBasedFileContentUrlProvider} 
 * configured for provisioning splitting data into buckets within the <b>minute</b> range
...
{
    private static final int MINUTE_BUCKET_COUNT = 20;
    ...
    public void before() throws Exception
    {
        ...
        //configure url provider to create buckets on minute range on a interval of 3 seconds (60/MINUTE_BUCKET_COUNT)
        fileContentUrlProvider.setMinuteBucketCount(MINUTE_BUCKET_COUNT);
    ...
    public void testBucketCreation() throws Exception
    {
        ...
        //depending when the test is started files can be created on same minute or not
        ...
        //Interval of 15s + time for file creation, expecting (ITERATIONS + 1) buckets
