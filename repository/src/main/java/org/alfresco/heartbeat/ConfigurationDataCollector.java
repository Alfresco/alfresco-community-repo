...
public class ConfigurationDataCollector
  ...
  public void setReplicationSubsystem(
    ChildApplicationContextFactory replicationSubsystem
  ) {
  ...
  public void setFileServersSubsystem(
    ChildApplicationContextFactory fileServersSubsystem
  ) {
    this.fileServersSubsystem = fileServersSubsystem;
  }

  public void setActivitiesFeedSubsystem(
    ChildApplicationContextFactory activitiesFeedSubsystem
  ) {
    this.activitiesFeedSubsystem = activitiesFeedSubsystem;
  }

  public void setInboundSMTPSubsystem(
    ChildApplicationContextFactory inboundSMTPSubsystem
  ) {
  ...
  public List<HBData> collectData() {
    ...
    configurationValues.put(
      "smartFoldersEnabled",
      smartFoldersBundle.isEnabled()
    );
    boolean readOnly = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(() -> repoUsageComponent.getUsage().isReadOnly(), true);
    configurationValues.put("serverReadOnly", readOnly);
    configurationValues.put(
      "serverMode",
      serverModeProvider.getServerMode().toString()
    );
    boolean ftpEnabled = Boolean.valueOf(
      fileServersSubsystem.getProperty("ftp.enabled")
    );
    ...
    boolean activitiesFeedEnabled = Boolean.valueOf(
    ...
    boolean inboundEnabled = Boolean.valueOf(
      inboundSMTPSubsystem.getProperty("email.inbound.enabled")
    );
    boolean emailServerEnabled = Boolean.valueOf(
      inboundSMTPSubsystem.getProperty("email.server.enabled")
    );
    ...
    boolean imapEnabled = Boolean.valueOf(
      imapSubsystem.getProperty("imap.server.enabled")
    );
    ...
    replicationInfo.put(
      "enabled",
      replicationSubsystem.getProperty("replication.enabled")
    );
    replicationInfo.put(
      "readOnly",
      replicationSubsystem.getProperty("replication.transfer.readonly")
    );
    ...
    Map<String, AuditService.AuditApplication> rawAppList = transactionService
      .getRetryingTransactionHelper()
  ...
  private List<ModuleDetails> getMissingModules() {
    AuthenticationUtil.RunAsWork<List<ModuleDetails>> missingModulesWork = () -> {
      try {
        ...
        logger.warn(
          "Heartbeat failed to collect information about missing modules: " + e
        );
