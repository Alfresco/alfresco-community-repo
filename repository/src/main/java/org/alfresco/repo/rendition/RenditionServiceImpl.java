...
public class RenditionServiceImpl
  implements
    RenditionService, RenditionDefinitionPersister, BeforeCheckOut, BeforeLock {
  ...
  public void setRenditionPreventionRegistry(
    RenditionPreventionRegistry registry
  ) {
   ...
   * @since 4.1.6
   */
  public void setKnownCancellableActionTypes(
    List<String> knownCancellableActionTypes
  ) {
  ...
  public RenditionDefinition createRenditionDefinition(
    ...
    if (log.isDebugEnabled()) {
      ...
      msg
        .append("Creating rendition definition ")
   ...
   */
  public CompositeRenditionDefinition createCompositeRenditionDefinition(
    QName renditionName
  ) {
    if (log.isDebugEnabled()) {
      StringBuilder msg = new StringBuilder();
      msg
        .append("Creating composite rendition definition ")
   ...
   */
  public ChildAssociationRef render(
    NodeRef sourceNode,
    ...
    ChildAssociationRef result = executeRenditionAction(
      sourceNode,
      definition,
      false
    );
  ...
  public ChildAssociationRef render(
    NodeRef sourceNode,
    final QName renditionDefinitionQName
  ) {
    checkSourceNodeForPreventionClass(sourceNode);
  ...
  private ChildAssociationRef executeRenditionAction(
    ...
    ChildAssociationRef result = (ChildAssociationRef) definition.getParameterValue(
  ...
  public RenditionDefinition loadRenditionDefinition(
    ...
    return this.renditionDefinitionPersister.loadRenditionDefinition(
        renditionDefinitionName
      );
  }
   ...
   */
  public List<ChildAssociationRef> getRenditions(
    NodeRef node,
  ...
  public ChildAssociationRef getRenditionByName(
    ...
    if (
      nodeService.hasAspect(node, RenditionModel.ASPECT_RENDITIONED) == true
    ) {
    ...
    if (renditions.isEmpty()) {
      ...
      return !renditionService2.isRenditionAvailable(node, renditionNode)
        ? null
        : childAssoc;
    }
  }
  ...
  public boolean isRendition(NodeRef node) {
    ...
    for (QName nextAspect : existingAspects) {
      if (
        nextAspect.equals(aspectToCheckFor) ||
  ...
  @Override
  public boolean usingRenditionService2(
    ...
    RenditionDefinition2 renditionDefinition2 = getEquivalentRenditionDefinition2(
      rendDefn
    );
    boolean createdByRenditionService2 = renditionService2.isCreatedByRenditionService2(
      sourceNodeRef,
      renditionName
    );
    ...
    if (renditionService2.isEnabled()) {
        ...
        if (renditionDefinition2 != null) {
          ...
          if (log.isDebugEnabled()) {
            log.debug(
              ...
              "\", \"" +
              renditionName +
              "\" so we switch back to the original service, as the new service does not have the definition."
            );
          }
      ...
      if (log.isDebugEnabled()) {
        log.debug(
          ...
          "\", \"" +
          renditionName +
          "\" so we switch back to the original service, as the new service is disabled."
        );
      }
      renditionService2.deleteRendition(sourceNodeRef, renditionName);
    }
  ...
  private RenditionDefinition2 getEquivalentRenditionDefinition2(
    ...
    RenditionDefinition2 renditionDefinition2 = renditionDefinitionRegistry2.getRenditionDefinition(
      renditionName
    );
    RenditionDefinition2 equivalentRenditionDefinition2 = null;
    if (renditionDefinition2 != null) {
      String targetMimetype = (String) rendDefn.getParameterValue(
