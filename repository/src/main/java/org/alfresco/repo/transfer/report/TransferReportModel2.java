...
public interface TransferReportModel2 extends TransferReportModel {
  static final String TRANSFER_REPORT_MODEL_2_0_URI =
    "http://www.alfresco.org/model/transferReport/2.0";
  ...
  static final String LOCALNAME_TRANSFER_EVENT_SENDING_CONTENT =
    "eventSendContent";
  static final String LOCALNAME_TRANSFER_EVENT_SENDING_SNAPSHOT =
    "eventSendSnapshot";
  static final String LOCALNAME_TRANSFER_EVENT_BEGIN = "eventBegin";
  static final String LOCALNAME_TRANSFER_EVENT_COMMITTING_STATUS =
    "eventCommittingStatus";
  static final String LOCALNAME_TRANSFER_EVENT_SENT_CONTENT =
    "eventSentContent";
