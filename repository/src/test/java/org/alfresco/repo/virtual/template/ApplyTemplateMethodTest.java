...
public class ApplyTemplateMethodTest extends VirtualizationIntegrationTest {
    ...
    public void testExecute_vanillaISO9075ActualPath() throws Exception {
        ChildAssociationRef iso9075FolderAssoc =
                createFolder(testRootFolder.getNodeRef(), "Acutal ISO9075 Node");
        NodeRef iso9075Folder = iso9075FolderAssoc.getChildRef();

        NewVirtualReferenceMethod newVirtualReferenceMethod =
        ...
        assertEquals(
                "(PATH:'/app:company_home/cm:TestFolder/cm:Acutal_x0020_ISO9075_x0020_Node/cm:Space_x0020_Sub_x0020_Folder/*')"
                    + "  and =cm:description:'SpecialFilingPath_5'",
                query.getQueryString());

        ChildAssociationRef iso9075SubFolderAssoc = createFolder(iso9075Folder, "Space Sub Folder");

        ChildAssociationRef someContentAssoc =
                createContent(iso9075SubFolderAssoc.getChildRef(), "someContent");
    ...
    public void testExecute_virtualSysClasspath() throws Exception {
        ...
        NewVirtualReferenceMethod newVirtualReferenceMethod =
                new NewVirtualReferenceMethod(TEST_TEMPLATE_1_JS_SYS_PATH, "/", rootNodeRef, null);
    ...
    public void testExecute_vanillaRepositoryJSON() throws Exception {
        ChildAssociationRef templateAssoc =
                createContent(
