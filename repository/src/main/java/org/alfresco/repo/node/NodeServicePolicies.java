...
public interface NodeServicePolicies
{
    ...
    public interface BeforeCreateNodePolicy extends ClassPolicy
    {
         ...
         *            the association type qualified name
         * @param assocQName
         *            the association qualified name
         * @param nodeTypeQName
    ...
    public interface BeforeMoveNodePolicy extends ClassPolicy
    {
         ...
         *            the child association reference prior to the move
         * @param newParentRef
    ...
    public interface OnDeleteNodePolicy extends ClassPolicy
    {
         ...
         * 
         * @param childAssocRef
         *            the primary parent-child association of the deleted node
    ...
    public interface BeforeAddAspectPolicy extends ClassPolicy
    {
         ...
         * 
         * @param nodeRef
         *            the node to which the aspect will be added
    ...
    public interface OnAddAspectPolicy extends ClassPolicy
    {
         ...
         * 
         * @param nodeRef
         *            the node to which the aspect was added
         * @param aspectTypeQName
         *            the type of the aspect
         */
    ...
    public interface BeforeRemoveAspectPolicy extends ClassPolicy
    {
         ...
         * 
         * @param nodeRef
         *            the node from which the aspect will be removed
         * @param aspectTypeQName
         *            the type of the aspect
         */
    ...
    public interface OnCreateChildAssociationPolicy extends AssociationPolicy
    {
         ...
         * @param isNewNode
         *            <tt>true</tt> if the node is new or <tt>false</tt> if the node is being linked in
         */
    ...
    public interface BeforeSetNodeTypePolicy extends ClassPolicy
    {
         ...
         * 
         * @param nodeRef
         *            the node having its type set.
         * @param oldType
         *            the current type of the node.
         * @param newType
         *            the type the node will be given.
         */
    ...
    public interface OnSetNodeTypePolicy extends ClassPolicy
    {
         ...
         * 
         * @param nodeRef
         *            the node that has had its type set.
         * @param oldType
