...
public class ArchiveAndRestoreTest extends TestCase {
  ...
  private static final QName ASPECT_ATTACHABLE = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "attachable"
  );
  private static final QName ASSOC_ATTACHMENTS = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "attachments"
  );
  private static final QName QNAME_A = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "a"
  );
  private static final QName QNAME_B = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "b"
  );
  private static final QName QNAME_AA = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "aa"
  );
  private static final QName QNAME_BB = QName.createQName(
    NamespaceService.CONTENT_MODEL_1_0_URI,
    "bb"
  );
  private static final QName TYPE_QNAME_TEST_CONTENT = QName.createQName(
    "http://www.alfresco.org/test/nodearchive",
    "content"
  );
  ...
  public void setUp() throws Exception {
    ...
    InputStream modelStream = cl.getResourceAsStream(
      "org/alfresco/repo/node/archive/archiveTest_model.xml"
    );
    ...
    try {
      ...
      StoreArchiveMap archiveMap = (StoreArchiveMap) ctx.getBean(
        "storeArchiveMap"
      );
  ...
  private void verifyChildAssocExistence(
  ...
  private void verifyTargetAssocExistence(
    ...
    if (exists) {
      ...
      assertEquals(
        "Expected zero matches for target association: " + assocRef,
        0,
        assocs.size()
      );
    }
  ...
  private void verifyAspectExistence(
    NodeRef nodeRef,
    QName aspectQName,
    boolean exists
  ) {
  ...
  public void testUserTracking() {
    ...
    List<ChildAssociationRef> assocs = AuthenticationUtil.runAsSystem(
      getAssocsWork
    );
    assertEquals(
      "Expected exactly one child association for current user",
      1,
      assocs.size()
    );
  ...
  public void testArchiveAndRestoreNodeBB() throws Exception {
    ...
    ChildAssociationRef bb_originalParent = (ChildAssociationRef) bb_Properties.get(
  ...
  public void testArchiveVsDeletePerformance() throws Exception {
    ...
    double averageArchiveTimeMs = (double) cumulatedArchiveTimeNs /
    1E6 /
    (double) iterations;
    double averageRestoreTimeMs = (double) cumulatedRestoreTimeNs /
    1E6 /
    (double) iterations;
    ...
    double averageDeleteTimeMs = (double) cumulatedDeleteTimeNs /
    1E6 /
    (double) iterations;
    double averageCreateTimeMs = (double) cumulatedCreateTimeNs /
    1E6 /
    (double) iterations;
  ...
  public void testInTransactionRestore() throws Exception {
    ...
    assertEquals(
      "Expected failure",
      RestoreStatus.FAILURE_INVALID_ARCHIVE_NODE,
      report.getStatus()
    );
  ...
  public void testMassRestore() throws Exception {
    ...
    List<RestoreNodeReport> reports = nodeArchiveService.restoreArchivedNodes(
      nodesToRestore
    );
  ...
  public void testPermissionsForRestore() throws Exception {
    ...
    List<RestoreNodeReport> restoredByB = nodeArchiveService.restoreArchivedNodes(
      nodesToRestore
    );
  ...
  public void testAR1519ArchiveCleansDuplicateUuid() throws Exception {
    ...
    NodeRef aRecreated = nodeService
      .createNode(
        workStoreRootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        ContentModel.ASSOC_CHILDREN,
      ...
      .getChildRef();
    assertEquals(
      "NodeRef for recreated node should be the same as the original",
      a,
      aRecreated
    );
    props.put(ContentModel.PROP_NODE_UUID, b.getId());
    NodeRef bRecreated = nodeService
      .createNode(
        a,
        ContentModel.ASSOC_CHILDREN,
        ContentModel.ASSOC_CHILDREN,
   ...
   */
  public synchronized void testAR7889ArchiveAndRestoreMustNotModifyAuditable()
    throws Exception {
    ...
    String modifierOriginal = (String) nodeService.getProperty(
      b,
      ContentModel.PROP_MODIFIER
    );
    Date modifiedOriginal = (Date) nodeService.getProperty(
      b,
    ...
    String modifierArchived = (String) nodeService.getProperty(
      b_,
      ContentModel.PROP_MODIFIER
    );
    Date modifiedArchived = (Date) nodeService.getProperty(
      b_,
      ContentModel.PROP_MODIFIED
    );
    assertEquals(
      "cm:modifier should not have changed",
      modifierOriginal,
      modifierArchived
    );
    assertEquals(
      "cm:modified should not have changed",
      modifiedOriginal,
      modifiedArchived
    );
    ...
    // Check that the cm:auditable modified did not change
    String modifierRestored = (String) nodeService.getProperty(
      b,
      ContentModel.PROP_MODIFIER
    );
    Date modifiedRestored = (Date) nodeService.getProperty(
      b,
      ContentModel.PROP_MODIFIED
    );
    assertEquals(
   ...
   * @throws Exception
   */
  public synchronized void testMNT15211ArchiveAndRestoreNotAuditable()
    throws Exception {
    Map<QName, Serializable> properties = new HashMap<QName, Serializable>(1);

    properties.put(ContentModel.PROP_NODE_UUID, "r");
    NodeRef r = nodeService
      .createNode(
        workStoreRootNodeRef,
        ContentModel.ASSOC_CHILDREN,
        QNAME_A,
   ...
   */
  public void testMNT2715ArchiveAndRestoreWithOwnableAndWithout()
    throws Exception {
    ...
    assertNull(
      "The node should'n have the ownable aspect if it didn't has it before deleting/restoring",
  ...
  public void testListArchivedNodesPermissions() {
    ...
    assertEquals(
      "USER_B hasn't deleted anything yet.",
      0,
      result.getPage().size()
    );
    ...
    assertEquals(
      "USER_B deleted 1 item and USER_B can see it.",
      1,
      result.getPage().size()
    );
    ...
    // Create canned query
    queryBuilder =
      new ArchivedNodesCannedQueryBuilder.Builder(
        this.archiveStoreRootNodeRef,
        paging
      )
        .build();
    ...
    result = nodeArchiveService.listArchivedNodes(queryBuilder);
    assertEquals(
      "USER_A deleted 1 item and USER_A can see it.",
      1,
      result.getPage().size()
    );
  ...
  public void testListArchivedNodesSort() {
    ...
    // Query the DB
    PagingResults<NodeRef> result = nodeArchiveService.listArchivedNodes(
      queryBuilder
    );
    assertEquals(
      "There are 3 nodes deleted by the Admin.",
      3,
      result.getPage().size()
    );
  ...
  public void testListArchivedNodesFilter() {
    ...
    assertEquals(
      "There are 3 nodes that match 'picture*' pattern.",
      3,
      result.getPage().size()
    );
    ...
    result = nodeArchiveService.listArchivedNodes(queryBuilder);
    assertEquals(
      "There are 2 nodes that match '*Test.jpg' pattern.",
      2,
      result.getPage().size()
    );
    assertEquals(
    ...
    result = nodeArchiveService.listArchivedNodes(queryBuilder);
    assertEquals(
      "There are 2 nodes that matches '*test.jpg' pattern.",
      2,
      result.getPage().size()
    );
  }
