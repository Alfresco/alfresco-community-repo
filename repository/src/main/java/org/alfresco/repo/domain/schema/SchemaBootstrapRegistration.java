...
public class SchemaBootstrapRegistration {
   ...
   */
  public void setPreUpdateScriptPatches(
    List<SchemaUpgradeScriptPatch> preUpdateScriptPatches
  ) {
   ...
   */
  public void setPostUpdateScriptPatches(
    List<SchemaUpgradeScriptPatch> postUpdateScriptPatches
  ) {
