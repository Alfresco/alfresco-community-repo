...
public class GetProcessDefinitionsCoreTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify call to get process definitions with invalid orderBy parameter with"
                            + " REST API and status code is BAD_REQUEST (400)")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
        ...
        restClient
                ...
                .containsSummary(
                        String.format(
                                ...
                                "test",
                                "deploymentId, name, id, category, version, key"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify call to get process definitions with invalid where parameter with REST"
                            + " API and status code is BAD_REQUEST (400)")
    @Test(
            groups = {
                TestGroup.REST_API,
                TestGroup.WORKFLOW,
