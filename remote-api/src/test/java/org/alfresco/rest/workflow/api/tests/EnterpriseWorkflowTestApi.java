...
public class EnterpriseWorkflowTestApi extends EnterpriseTestApi {
    ...
    public void before() throws Exception {
        ...
        HttpClientProvider httpClientProvider =
                (HttpClientProvider) applicationContext.getBean("httpClientProvider");
        ...
        AuthenticationDetailsProvider authenticationDetailsProvider =
                new UserAuthenticationDetailsProviderImpl(userDataService, "admin", "admin");
        AuthenticatedHttp authenticatedHttp =
                new AuthenticatedHttp(httpClientProvider, authenticationDetailsProvider);
        this.httpClient =
    ...
    protected String deployProcessDefinition(String... artifacts) {
        DeploymentBuilder deploymentBuilder =
                activitiProcessEngine.getRepositoryService().createDeployment();
    ...
    protected TestPerson getOtherPersonInNetwork(String usedPerson, String networkId)
            throws Exception {
        ...
        if (dateText != null) {
            try {
                ...
                throw new RuntimeException(
                        "couldn't parse date " + dateText + ": " + e.getMessage(), e);
            }
        }
        return null;
    }
    ...
    protected ProcessInfo startAdhocProcess(
            final RequestContext requestContext, NodeRef[] documentRefs) throws PublicApiException {
    ...
    protected ProcessInfo startAdhocProcess(
            final RequestContext requestContext, NodeRef[] documentRefs, String businessKey)
    ...
    @SuppressWarnings("unchecked")
    protected ProcessInfo startReviewPooledProcess(final RequestContext requestContext)
            throws PublicApiException {
        org.activiti.engine.repository.ProcessDefinition processDefinition =
                activitiProcessEngine
                        .getRepositoryService()
    ...
    /** Start a review pooled process through the public REST-API. */
    @SuppressWarnings("unchecked")
    protected ProcessInfo startParallelReviewProcess(final RequestContext requestContext)
            throws PublicApiException {
        org.activiti.engine.repository.ProcessDefinition processDefinition =
                activitiProcessEngine
                        .getRepositoryService()
