...
public abstract class ApiWebScript extends AbstractWebScript {
    ...
    public void init() {
        ...
        streamFactory =
                TempOutputStream.factory(tempDirectory, memoryThreshold, maxContentSize, false);
    }
    ...
    public abstract void execute(final Api api, WebScriptRequest req, WebScriptResponse res)
            throws IOException;
}
