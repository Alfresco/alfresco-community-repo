...
public class AJExtensionsCompileTest extends TestCase {
  ...
  protected void compile(Class<? extends Extensible> extensible)
    throws Exception {
  ...
  protected void compile(Set<Class<? extends Extensible>> extensibles)
    throws Exception {
  ...
  public void testCompileExtendedServices() throws Exception {
    ...
    for (BeanDefinition component : components) {
      ...
      Class<? extends Extensible> extensibleClass = (Class<? extends Extensible>) Class.forName(
