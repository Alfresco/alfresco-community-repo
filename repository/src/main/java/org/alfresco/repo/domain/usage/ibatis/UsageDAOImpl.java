...
public class UsageDAOImpl extends AbstractUsageDAOImpl {
    ...
    protected void selectUsersWithoutUsage(StoreRef storeRef, MapHandler resultsCallback) {
        Pair<Long, ? extends Object> personTypeQNamePair =
                qnameDAO.getQName(ContentModel.TYPE_PERSON);
        Pair<Long, ? extends Object> usernamePropQNamePair =
                qnameDAO.getQName(ContentModel.PROP_USERNAME);
        Pair<Long, ? extends Object> sizeCurrentPropQNamePair =
                qnameDAO.getQName(ContentModel.PROP_SIZE_CURRENT);
    ...
    protected void selectUserContentSizesForStore(StoreRef storeRef, MapHandler resultsCallback) {
        Pair<Long, ? extends Object> contentTypeQNamePair =
                qnameDAO.getQName(ContentModel.TYPE_CONTENT);
        Pair<Long, ? extends Object> ownerPropQNamePair =
                qnameDAO.getQName(ContentModel.PROP_OWNER);
        Pair<Long, ? extends Object> contentPropQNamePair =
                qnameDAO.getQName(ContentModel.PROP_CONTENT);

        if (contentTypeQNamePair == null
