...
@RelationshipResource(
  ...
  title = "Activities for the current process"
)
public class ProcessActivitiesRelation
  implements RelationshipResourceAction.Read<Activity> {
  ...
  @WebApiDescription(
    ...
    description = "Get a paged list of the activities"
  )
