...
public class RmPropertiesGet
  ...
  protected Map<String, Object> executeImpl(
    ...
    return executeImpl(
      req,
      RmDictionaryWebServiceUtils.isRmSite(req, siteService)
    );
  }
  ...
  private Map<String, Object> executeImpl(WebScriptRequest req, boolean isRM) {
    ...
    Collections.sort(
      props,
      new DictionaryComparators.PropertyDefinitionComparator(dictionaryservice)
    );
