...
public interface ImapService {
  ...
  public static enum EmailBodyFormat {
    ALFRESCO_TEXT_PLAIN(
      AlfrescoImapConst.CLASSPATH_ALFRESCO_TEXT_PLAIN_TEMPLATE
    ),
    ...
    public String getSubtype() {
      return name()
        .toLowerCase()
        .substring(name().indexOf("_") + 2 + "TEXT".length());
    }
   ...
   * @return a message.
   */
  public SimpleStoredMessage getMessage(FileInfo messageFileInfo)
