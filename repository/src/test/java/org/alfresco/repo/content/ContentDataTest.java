...
public class ContentDataTest extends TestCase {
    ...
    public void testToAndFromString() throws Exception {
        ...
        assertEquals(
                "Null values not converted correctly",
        ...
        assertEquals(
                "Incorrect property string representation",
                "contentUrl=test://uuu|mimetype=mmm|size=123|encoding=eee|locale=" + localeStr,
                propertyStr);
    ...
    public void testEquals() {
        ContentData contentData1 =
                new ContentData(
                        "abc://xxx", MimetypeMap.MIMETYPE_BINARY, 600L, "UTF-8", Locale.ENGLISH);
        ...
        ContentData contentData5 =
                new ContentData(
                        "abc://xxx", MimetypeMap.MIMETYPE_BINARY, 500L, "UTF-8", Locale.ENGLISH);
        ContentData contentData6 =
                new ContentData(
                        "abc://xxx", MimetypeMap.MIMETYPE_BINARY, 600L, "UTF-16", Locale.ENGLISH);
        ContentData contentData7 =
                new ContentData(
                        "abc://xxx", MimetypeMap.MIMETYPE_BINARY, 600L, "UTF-8", Locale.CHINESE);
