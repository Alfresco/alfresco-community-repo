...
/**
 * Wraps an OpenCMIS HttpServletRequest, mapping urls and adding servlet attributes specific to the
 * Alfresco implementation of OpenCMIS.
 */
public class PublicApiCMISHttpServletRequest extends CMISHttpServletRequest {
    public PublicApiCMISHttpServletRequest(
