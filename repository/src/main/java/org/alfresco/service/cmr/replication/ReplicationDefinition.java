 ...
 * <P/>
 * Every ReplicationDefinition has a <code>replicationName</code> attribute which uniquely identifies it. It also has a single target.
 * 
 * @author Nick Burch
 */
public interface ReplicationDefinition extends CancellableAction, SchedulableAction, Serializable
{
    ...
    /**
     * Is scheduling currently enabled? See {@link ReplicationService#enableScheduling(ReplicationDefinition)} and {@link ReplicationService#disableScheduling(ReplicationDefinition)}
     */
