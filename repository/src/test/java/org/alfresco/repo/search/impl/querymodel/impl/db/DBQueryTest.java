...
public class DBQueryTest implements DictionaryListener {
    ...
    private static QName ASPECT_WITH_CHILDREN =
            QName.createQName(TEST_NAMESPACE, "aspectWithChildren");
    ...
    private static QName TEST_SUPER_CONTENT_TYPE =
            QName.createQName(TEST_NAMESPACE, "testSuperContentType");
    ...
    private static QName TEST_SUPER_FOLDER_TYPE =
            QName.createQName(TEST_NAMESPACE, "testSuperFolderType");
    ...
    protected void loadTestModel() {
        ...
        InputStream modelStream =
                cl.getResourceAsStream("org/alfresco/repo/search/impl/MetadataQueryTest_model.xml");
    ...
    protected void createTestData() throws Exception {
        ...
        testProperties.put(
                QName.createQName(TEST_NAMESPACE, "boolean-ista"), Boolean.valueOf(true));
        testProperties.put(
        ...
        testProperties.put(
                QName.createQName(TEST_NAMESPACE, "period-ista"), new Period("period|12"));
        ...
        midCreationDate =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeService.getProperty(n7, ContentModel.PROP_CREATED));
        midModificationDate =
                DefaultTypeConverter.INSTANCE.convert(
                        String.class, nodeService.getProperty(n7, ContentModel.PROP_MODIFIED));
    ...
    public Map<QName, Serializable> getOrderProperties() {
        ...
        testProperties.put(
                ORDER_TEXT, new String(new char[] {(char) ('a' + orderTextCount)}) + " cabbage");

        MLText mlText = new MLText();
        mlText.addValue(
                Locale.ENGLISH, new String(new char[] {(char) ('a' + orderTextCount)}) + " banana");
        mlText.addValue(
                Locale.FRENCH, new String(new char[] {(char) ('Z' - orderTextCount)}) + " banane");
        mlText.addValue(
                Locale.CHINESE, new String(new char[] {(char) ('香' + orderTextCount)}) + " 香蕉");
    ...
    public void testCmisSql() throws InterruptedException {
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:name IN ('Content 3', 'Content 4')", 2);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:name NOT IN ('Content 3', 'Content 4')", 6);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document d join test:testContentType a on d.cmis:objectId ="
                        + " a.cmis:objectId",
                1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document d join test:testSuperContentType a on d.cmis:objectId"
                        + " = a.cmis:objectId",
                7);

        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:creationDate = '" + midCreationDate + "'",
                1);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId",
                7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:createdDate = '"
                        + midOrderDate
                        + "'",
                1);
        ...
        try {
            sqlQueryWithCount(
                    "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                            + " a.cmis:objectId where a.test:orderDouble = -0.11",
                    1);
            fail();
        } catch (Exception e) {
        ...
        try {
            sqlQueryWithCount(
                    "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                            + " a.cmis:objectId where a.test:orderFloat = -3.5556",
                    1);
            fail();
        } catch (Exception e) {
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:orderLong = -1999999999999999",
                1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong = " + longValue, 1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong <>  " + longValue, 12);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong <  " + longValue, 6);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong <=  " + longValue, 7);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong >  " + longValue, 6);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong >=  " + longValue, 7);
        ...
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderLong is not null", 13);

        long intValue = -45764576 + (8576457 * 6);

        sqlQueryWithCount(
                "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:orderInt = -45764576",
                1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt = " + intValue, 1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt <>  " + intValue, 12);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt <  " + intValue, 6);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt <=  " + intValue, 7);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt >  " + intValue, 6);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt >=  " + intValue, 7);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt IN ( " + intValue + ")",
                1);
        sqlQueryWithCount(
        ...
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderInt is not null", 13);

        String stringValue = new String(new char[] {(char) ('a' + 6)}) + " cabbage";

        sqlQueryWithCount(
                "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:orderText = 'a cabbage'",
                1);
        sqlQueryWithCount(
        ...
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderText is not null", 13);

        // ML text is essentially multi-valued and gives unuusla results as ther is no locale
        // constraint
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:orderMLText = 'a banana'",
                1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderMLText = '"
                        ...
                        + "'",
                1);
        //        sqlQueryWithCount("SELECT * FROM test:testSuperAspect a where a.test:orderMLText
        // <>  '"+stringValue+"'", 12);
        //        sqlQueryWithCount("SELECT * FROM test:testSuperAspect a where a.test:orderMLText <
        //  '"+stringValue+"'", 6);
        //        sqlQueryWithCount("SELECT * FROM test:testSuperAspect a where a.test:orderMLText
        ...
        sqlQueryWithCount(
                ...
                1);
        //        sqlQueryWithCount("SELECT * FROM test:testSuperAspect a where a.test:orderMLText
        // NOT IN  ('"+stringValue+"')", 12);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderMLText is null", 1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderMLText is not null", 13);

        stringValue = new String(new char[] {(char) ('Z' - 6)}) + " banane";

        sqlQueryWithCount(
                "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:orderMLText = 'Z banane'",
                1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderMLText = '"
                        + stringValue
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:folder d join test:testSuperAspect a on d.cmis:objectId ="
                        + " a.cmis:objectId where a.test:orderMLText = '香 香蕉'",
                1);
        sqlQueryWithCount(
                "SELECT * FROM test:testSuperAspect a where a.test:orderMLText = '"
                        + stringValue
    ...
    public void testOrdering() {
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document order by cmis:contentStreamMimeType desc", 8);
    ...
    public void testOtherCMIS() {
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName = 'Content 3'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName < 'Content 3'", 3);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName <= 'Content 3'", 4);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName > 'Content 3'", 4);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName >= 'Content 3'", 5);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName <> 'Content 3'", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName IN ('Content 3',"
                        + " 'Content 4')",
                2);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName NOT IN ('Content 3',"
                        + " 'Content 4')",
                6);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName IS NULL", 0);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamFileName IS NOT NULL", 8);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType = 'text/plain'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType < 'text/plain'", 0);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType <= 'text/plain'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType > 'text/plain'", 0);
        ...
        sqlQueryWithCount(
                ...
                1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType NOT IN"
                        + " ('text/plain')",
                0);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType IS NULL", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType IS NOT NULL", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:contentStreamMimeType like 'text%'", 1);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:folder where cmis:objectTypeId IN ('cmis:folder')", 0);
        sqlQueryWithCount("SELECT * FROM cmis:folder where cmis:objectTypeId <> 'cmis:folder'", 6);
        sqlQueryWithCount(
                "SELECT * FROM cmis:folder where cmis:objectTypeId NOT IN ('cmis:folder')", 6);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:folder where cmis:baseTypeId NOT IN ('cmis:folder')", 0);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId NOT IN ('" + n3 + "')", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId = '" + n3.getId() + "'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId IN ('" + n3.getId() + "')", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId <> '" + n3.getId() + "'", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId NOT IN ('" + n3.getId() + "')", 7);

        sqlQueryWithCount("SELECT * FROM cmis:document where cmis:objectId = '" + n3 + ";1.0'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId IN ('" + n3 + ";1.0')", 1);
        sqlQueryWithCount("SELECT * FROM cmis:document where cmis:objectId <> '" + n3 + ";1.0'", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId NOT IN ('" + n3 + ";1.0')", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId = '" + n3.getId() + ";1.0'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId IN ('" + n3.getId() + ";1.0')", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId <> '" + n3.getId() + ";1.0'", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectId NOT IN ('" + n3.getId() + ";1.0')",
                7);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectTypeId = 'cmis:document'", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectTypeId IN ('cmis:document')", 1);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectTypeId <> 'cmis:document'", 7);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:objectTypeId NOT IN ('cmis:document')", 7);
        ...
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:baseTypeId IN ('cmis:document')", 8);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:baseTypeId <> 'cmis:document'", 0);
        sqlQueryWithCount(
                "SELECT * FROM cmis:document where cmis:baseTypeId NOT IN ('cmis:document')", 0);
    ...
    public void testAFTS() {
        ...
        aftsQueryWithCount(
                "=TYPE:\"cm:content\" AND =PARENT:\"" + n2 + "\" AND =name:\"Content 7\"", 1);
        aftsQueryWithCount(
                "=TYPE:\"cm:content\" AND =PARENT:\"" + n2 + "\" AND =name:\"Content 8\"", 1);
        aftsQueryWithCount(
                "=TYPE:\"cm:content\" AND =PARENT:\"" + n2 + "\" AND =name:\"Content 14\"", 1);
        aftsQueryWithCount(
                "=TYPE:\"cm:content\" AND =PARENT:\"" + n2 + "\" AND -=name:\"Content 8\"", 2);
        ...
        aftsQueryWithCount(
                "=TYPE:\"cm:folder\" AND =ASPECT:\"test:testSuperAspect\" AND"
                        + " =test:orderLong:\"-1999999999999999\"",
                1);
        aftsQueryWithCount(
                "=ASPECT:\"test:testSuperAspect\" AND =test:orderLong:\"" + longValue + "\"", 1);

        long intValue = -45764576 + (8576457 * 6);

        aftsQueryWithCount(
                "=TYPE:\"cm:folder\" AND =ASPECT:\"test:testSuperAspect\" AND"
                        + " =test:orderInt:\"-45764576\"",
                1);
        aftsQueryWithCount(
                "=ASPECT:\"test:testSuperAspect\" AND =test:orderInt:\"" + intValue + "\"", 1);

        String stringValue = new String(new char[] {(char) ('a' + 6)}) + " cabbage";

        aftsQueryWithCount(
                "=TYPE:\"cm:folder\" AND =ASPECT:\"test:testSuperAspect\" AND =test:orderText:\"a"
                        + " cabbage\"",
                1);
        aftsQueryWithCount(
                "=ASPECT:\"test:testSuperAspect\" AND =test:orderText:\"" + stringValue + "\"", 1);

        stringValue = new String(new char[] {(char) ('a' + 6)}) + " banana";

        aftsQueryWithCount(
                "=TYPE:\"cm:folder\" AND =ASPECT:\"test:testSuperAspect\" AND =test:orderMLText:\"a"
                        + " banana\"",
                1);
        aftsQueryWithCount(
                "=ASPECT:\"test:testSuperAspect\" AND =test:orderMLText:\"" + stringValue + "\"",
                1);

        stringValue = new String(new char[] {(char) ('Z' - 6)}) + " banane";

        aftsQueryWithCount(
                "=TYPE:\"cm:folder\" AND =ASPECT:\"test:testSuperAspect\" AND =test:orderMLText:\"Z"
                        + " banane\"",
                1);
        aftsQueryWithCount(
                "=ASPECT:\"test:testSuperAspect\" AND =test:orderMLText:\"" + stringValue + "\"",
        ...
        aftsQueryWithCount(
                "=TYPE:\"cm:folder\" AND =ASPECT:\"test:testSuperAspect\" AND =test:orderMLText:\"香"
                        + " 香蕉\"",
                1);
        aftsQueryWithCount(
                "=ASPECT:\"test:testSuperAspect\" AND =test:orderMLText:\"" + stringValue + "\"",
    ...
    /**
     * Test that when a query is performed with a limit parameter, the number of results in the
     * resultset is influenced by limit while the numberOfFound value is not.
     */
    @Test
    ...
    public void queryWithCount(
            String ql, String query, int count, QName property, Boolean ascending) {
        SearchParameters sp = new SearchParameters();
        sp.setLanguage(ql);
        sp.setQueryConsistency(QueryConsistency.TRANSACTIONAL);
        sp.setQuery(query);
        ...
        for (ResultSetRow row : results) {
            ...
            if (property != null) {
                Comparable current =
                        (Comparable) nodeService.getProperty(row.getNodeRef(), property);
                if (last != null) {
