...
public class GetParentsTests extends CmisTest {
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorGetsFolderParentsCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteContributorGetsFileParentsCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorGetsFolderParentsCreatedBySelf()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorGetsFolderParentsCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void siteCollaboratorGetsFileParentsCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(testUser)
      .usingSite(testSite)
  ...
  public void nonSiteMemberGetsFolderParentsFromModeratedSite()
    throws Exception {
