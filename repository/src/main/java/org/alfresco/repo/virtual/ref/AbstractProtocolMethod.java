...
public abstract class AbstractProtocolMethod<R> implements ProtocolMethod<R> {
  ...
  @Override
  public R execute(VanillaProtocol vanillaProtocol, Reference reference)
  ...
  @Override
  public R execute(VirtualProtocol virtualProtocol, Reference reference)
    throws ProtocolMethodException {
    return throwUnsupportedProtocolException(virtualProtocol);
  }

  @Override
  public R execute(NodeProtocol protocol, Reference reference)
    throws ProtocolMethodException {
    return throwUnsupportedProtocolException(protocol);
  }

  private R throwUnsupportedProtocolException(Protocol protocol)
    throws ProtocolMethodException {
    throw new ProtocolMethodException("Unsupported protocol " + protocol);
  }

  @Override
  public R execute(Protocol protocol, Reference reference)
    throws ProtocolMethodException {
    return throwUnsupportedProtocolException(protocol);
  }
}
