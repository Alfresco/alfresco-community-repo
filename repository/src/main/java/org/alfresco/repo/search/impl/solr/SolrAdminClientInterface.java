...
public interface SolrAdminClientInterface extends BeanFactoryAware, InitializingBean {
     ...
     *
     * @param core Name of the core to execute the command, when null the action is executed for all
     *     existing cores
     * @param action SOLR CoreAdmin API Action name
     * @param parameters Action parameters in pairs of key, value
     * @return
     */
    public JSONAPIResult executeAction(
            String core, JSONAPIResultFactory.ACTION action, Map<String, String> parameters);
     ...
     * @return
     */
    public JSONAPIResult executeCommand(
            String core,
