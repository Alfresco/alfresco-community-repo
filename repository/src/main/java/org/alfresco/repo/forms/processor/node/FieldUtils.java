...
/**
 * Utility class to assist in creating {@link Field Fields} which represent {@link
 * PropertyDefinition PropertyDefinitions} and {@link AssociationDefinition AssociationDefinitions}
 *
 * @since 3.4
 * @author Nick Smith
 */
public class FieldUtils {
    ...
    public static Field makePropertyField(
        ...
        PropertyFieldProcessor processor =
                new PropertyFieldProcessor(namespaceService, dictionaryService);
    ...
    public static List<Field> makePropertyFields(
            ...
            NamespaceService namespaceService,
            DictionaryService dictionaryService) {
        return makePropertyFields(
                propDefAndValue.keySet(),
                propDefAndValue,
                group,
                namespaceService,
                dictionaryService);
    ...
    public static Field makeAssociationField(
            ...
            NamespaceService namespaceService,
            DictionaryService dictionaryService) {
        AssociationFieldProcessor processor =
                new AssociationFieldProcessor(namespaceService, dictionaryService);
    ...
    public static List<Field> makeAssociationFields(
            ...
            NamespaceService namespaceService,
            DictionaryService dictionaryService) {
        return makeAssociationFields(
                assocDefAndValue.keySet(),
                assocDefAndValue,
                group,
                namespaceService,
                dictionaryService);
