...
public class ContentClassFilter extends AbstractNodeFilter {
    ...
    public boolean accept(NodeRef thisNode) {
        ...
        return (!exclude && (typeIsInSet || aspectIsInSet))
                || (exclude && (!typeIsInSet && !aspectIsInSet));
    }
     ...
     *
     * @param contentClasses the contentClasses to set
     */
     ...
     *
     * @param exclude If true then this filter will not accept content that is of any of the
     *     filtered classes of content. If false then this filter will only accept content that has
     *     one or more of the filtered classes of content. Defaults to false.
     */
    ...
    /**
     * Specify whether the filter should only test against the content classes that have been
     * supplied, or if it should also test against all subclasses of those classes. For example, if
     * "directOnly" is true and "cm:content" is in the set of content classes then a node of type
     * "cm:thumnail" will not be filtered.
     *
     * @param directOnly If true then the filter only filters specifically the specified content
