...
public abstract class AbstractLocaleDAOImpl implements LocaleDAO {
   ...
   */
  public void setLocaleEntityCache(
    SimpleCache<Long, String> localeEntityCache
  ) {
  ...
  private Pair<Long, Locale> getLocalePairImpl(Locale locale) {
    ...
    if (localeStr == null) {
      throw new IllegalArgumentException(
        "Cannot look up entity by null locale."
      );
    }
  ...
  private Pair<Long, Locale> getOrCreateLocalePairImpl(Locale locale) {
    ...
    Pair<Long, String> entityPair = localeEntityCache.getOrCreateByValue(
      localeStr
    );
    if (entityPair == null) {
