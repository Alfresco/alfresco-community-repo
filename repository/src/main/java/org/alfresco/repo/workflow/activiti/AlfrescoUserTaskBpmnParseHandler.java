 ...
 * @author Nick Smith
 */
public class AlfrescoUserTaskBpmnParseHandler
  extends AbstractBpmnParseHandler<UserTask> {
  ...
  protected void executeParse(BpmnParse bpmnParse, UserTask userTask) {
    ...
    if (activitybehaviour instanceof UserTaskActivityBehavior) {
      ...
      if (
        multiInstance.getInnerActivityBehavior() instanceof UserTaskActivityBehavior
      ) {
        addListeners(
          (UserTaskActivityBehavior) multiInstance.getInnerActivityBehavior()
        );
      }
    }
  }
  ...
  public void setNotificationTaskListener(
    TaskListener notificationTaskListener
  ) {
  ...
  protected List<TaskListener> getOrCreateListenerList(
    ...
    List<TaskListener> taskEventListeners = userTask
      .getTaskDefinition()
      .getTaskListeners()
      .get(eventName);
    if (taskEventListeners == null) {
      ...
      userTask
        .getTaskDefinition()
        .getTaskListeners()
        .put(eventName, taskEventListeners);
    }
