...
public class GetTaskCandidatesRegressionTests extends RestTest {
    ...
    public void getTaskCandidatesWithInvalidTaskId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, "invalid-id"))
    ...
    public void getTaskCandidatesWithSkipCount() throws Exception {
        ...
        candidateModels =
                restClient
                        ...
                        .getTaskCandidates();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        candidateModels.assertThat().entriesListIsNotEmpty().and().paginationField("count").is("0");
    }
    ...
    public void getTaskCandidatesWithMaxItems() throws Exception {
        ...
        candidateModels =
                restClient
                        ...
                        .getTaskCandidates();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        candidateModels.assertThat().entriesListIsNotEmpty().and().paginationField("count").is("1");
    }
    ...
    public void getTaskCandidatesWithProperties() throws Exception {
        ...
        candidateModels =
                restClient
                        .authenticateUser(userModel)
                        .withWorkflowAPI()
                        .usingParams("properties=candidateId")
                        .usingTask(taskModel)
                        .getTaskCandidates();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        candidateModels
                ...
                .assertThat()
                .field("candidateId")
                .contains(group.getGroupIdentifier())
                .and()
                .field("candidateType")
                .isNull();
    }
    ...
    public void getTaskCandidatesWithInvalidProperties() throws Exception {
        ...
        candidateModels =
                restClient
                        .authenticateUser(userModel)
                        .withWorkflowAPI()
                        .usingParams("properties=unknown-prop")
                        .usingTask(taskModel)
                        .getTaskCandidates();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        candidateModels.getEntries().get(0).onModel().assertThat().fieldsCount().is(0).and();
    }
    ...
    public void getTaskCandidatesByDeletedGroup() throws Exception {
        ...
        taskModel =
                dataWorkflow
                        ...
                        .usingSite(siteModel)
                        .usingResource(fileModel)
                        .createPooledReviewTaskAndAssignTo(deletedGroup);
        restClient
                .authenticateUser(newUser)
                .withWorkflowAPI()
                .usingTask(taskModel)
