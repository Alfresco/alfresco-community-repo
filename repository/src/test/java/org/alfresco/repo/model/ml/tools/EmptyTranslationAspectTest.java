...
public class EmptyTranslationAspectTest extends AbstractMultilingualTestCases {
  ...
  public void testCopy() throws Exception {
    ...
    assertTrue(
      "The copy of a translation must throws an exception",
      exceptionCatched
    );
  ...
  public void testGetContent() throws Exception {
    ...
    multilingualContentService.makeTranslation(pivot, Locale.FRENCH);
    NodeRef mlContainer = multilingualContentService.getTranslationContainer(
      pivot
    );
    ...
    String contentString = fileFolderService
      .getReader(pivot)
      .getContentString();
    ...
    assertEquals(
      "The content retourned of the empty translation must be the same that the content of the pivot",
    ...
    assertNotSame(
      "The content retourned of the empty translation must be different that the content of a non-pivot translation",
  ...
  public void testUpdateContent() throws Exception {
    ...
    assertNotSame(
      "The content of the (ex)empty translation is not updated and is the same as the content of the pivot",
      fileFolderService.getReader(empty).getContentString(),
      fileFolderService.getReader(pivot).getContentString()
    );
  }
