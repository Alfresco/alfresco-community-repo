 ...
 * Workflow Service.
 *
 * <p>Client facing API for interacting with Alfresco Workflows and Tasks.
 *
 * @author davidc
 */
@AlfrescoPublicApi
public interface WorkflowService {
     ...
     * Deploy a Workflow Definition to the Alfresco Repository
     *
     * <p>Note: The specified content object must be of type bpm:workflowdefinition. This type
     * describes for which BPM engine the definition is appropriate.
     *
     ...
     * The node must be of the Type as described in the Workflow Definition.
     *
     ...
     * parameter Get maxItems and skipCount parameters form request
     *
     * @param workflowInstanceQuery WorkflowInstanceQuery
     * @param maxItems int
     * @param skipCount int
    ...
    /**
     * Gets all Paths for the specified Workflow instance. NOTE: It only returns information for an
     ...
     *
     * <p>NOTE: This will force a delete, meaning that the workflow instance may not go through all
     * the appropriate cancel events.
     *
     * @param workflowId the workflow instance to cancel
     * @return an updated representation of the workflow instance
     */
     ...
     * @param lazyInitialization hint to the underlying workflow-engine to allow returning {@link
     *     WorkflowTask}s which aren't fully initialized but will be when the required values are
     *     required. If <code>true</code>, the returned enities should be used inside of the
     *     transaction-boundaries of this service-call. If <code>false</code>, fully initialized
     *     entities are returned, just as with {@link #getAssignedTasks(String, WorkflowTaskState)}.
     *     <br>
     *     It's a hint to the underlying workflow-engine and may be ignored by the actual
     *     implementation.
     ...
     *     required. If <code>true</code>, the returned enities should be used inside of the
     *     transaction-boundaries of this service-call. If <code>false</code>, fully initialized
     *     entities are returned, just as with {@link #getPooledTasks(String)}. <br>
     *     It's a hint to the underlying workflow-engine and may be ignored by the actual
     *     implementation.
     * @return the list of pooled tasks
     */
     ...
     * @param task The task to check
     * @param username The user to check
     * @param refreshTask Whether or not to refresh the {@link WorkflowTask} before check is
     *     perfromed
     * @return true if the user can edit the task
     * @since 4.1
     */
    ...
    /**
     * @return true, if all workflows (in workflowDeployers) have a copy deployed per tenant and
     *     workflows can be deployed in tenant. False when workflows are shared system-wide,
