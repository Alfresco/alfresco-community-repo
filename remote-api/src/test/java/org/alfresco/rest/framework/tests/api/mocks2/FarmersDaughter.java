...
/**
 * This inherits all Farmer's properties and ANNOTATIONS It adds a new embedded entity which is
 * fine, but it adds another @UniqueId annotation which is invalid because its already on Farmer
 *
 * @author Gethin James
 */
public class FarmersDaughter extends Farmer {
    ...
    @EmbeddedEntityResource(
            propertyName = "specialgrass",
            entityResource = GrassEntityResource.class)
