...
public class TransactionInvocationHandlerFactory {
    ...
    public <P extends Policy> InvocationHandler createHandler(
            Behaviour behaviour, PolicyDefinition<P> definition, P policyInterface) {
    ...
    private class TransactionHandler<P extends Policy> implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (behaviour.getNotificationFrequency().equals(NotificationFrequency.FIRST_EVENT)) {
                Map<ExecutionInstanceKey, Object> executedBehaviours =
                        (Map<ExecutionInstanceKey, Object>)
                                AlfrescoTransactionSupport.getResource(EXECUTED_KEY);
                ...
                throw new PolicyException(
                        "Invalid Notification frequency " + behaviour.getNotificationFrequency());
            }
