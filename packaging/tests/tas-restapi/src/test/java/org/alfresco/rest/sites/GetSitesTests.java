...
public class GetSitesTests extends RestTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        siteModel =
                new SiteModel(
                        RandomData.getRandomName("0-PrivateSite"), SiteService.Visibility.PRIVATE);
        firstPrivateSite = dataSite.usingAdmin().createSite(siteModel);
        siteModel =
                new SiteModel(
                        RandomData.getRandomName("0-ModeratedSite"),
                        SiteService.Visibility.MODERATED);
        ...
        lastPublicSite =
                dataSite.usingAdmin()
                        .createSite(
                                new SiteModel(
                                        SiteService.Visibility.PUBLIC, "guid", name, name, name));
        lastPrivateSite =
                dataSite.usingAdmin()
                        .createSite(
                                new SiteModel(
                                        RandomData.getRandomName("ZZZZZZZZZ-PrivateSite"),
                                        SiteService.Visibility.PRIVATE));
        lastModeratedSite =
                dataSite.usingAdmin()
                        .createSite(
                                new SiteModel(
                                        RandomData.getRandomName("ZZZZZZZZZ-ModeratedSite"),
                                        SiteService.Visibility.MODERATED));
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role gets sites information and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role gets sites information and gets status code"
                            + " OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets sites information and gets status code"
                            + " OK (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets sites information and gets status code OK"
                            + " (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Admin user gets sites information and gets status code OK"
                            + " (200)")
    ...
    public void unauthenticatedUserIsNotAuthorizedToRetrieveSites() throws Exception {
        ...
        restClient.authenticateUser(userModel).withParams("maxItems=1").withCoreAPI().getSites();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get sites request returns status code 400 when invalid maxItems"
                            + " parameter is used")
    public void getSitesWithInvalidMaxItems() throws Exception {
        restClient
                .authenticateUser(regularUser)
                .withParams("maxItems=0=09")
                .withCoreAPI()
                .getSites();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_MAXITEMS, "0=09"));

        restClient.withParams("maxItems=A").withCoreAPI().getSites();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_MAXITEMS, "A"));

        restClient.withParams("maxItems=0").withCoreAPI().getSites();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if get sites request returns status code 400 when invalid skipCount"
                            + " parameter is used")
    public void getSitesWithInvalidSkipCount() throws Exception {
        restClient.authenticateUser(regularUser).withParams("skipCount=A").withCoreAPI().getSites();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if User gets sites ordered by title ascending and status code is 200")
    public void getSitesOrderedByTitleASC() throws Exception {
        sites =
                restClient
                        .authenticateUser(privateSiteManager)
                        .withParams("orderBy=title ASC")
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if a regular user gets all public and moderated sites and status code"
                            + " is 200")
    public void regularUserGetsOnlyPublicAndModeratedSites() throws Exception {
        sites =
                restClient
                        .authenticateUser(regularUser)
                        .withParams("maxItems=5000")
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        sites.assertThat()
                .entriesListContains("title", firstPublicSite.getTitle())
                .and()
                .entriesListContains("title", firstModeratedSite.getTitle())
                .and()
                .entriesListDoesNotContain("title", firstPrivateSite.getTitle());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if a member of a private site gets the private site, all public sites"
                            + " and all moderated sites. Verify if status code is 200")
    public void privateSiteMemberGetsSitesVisibleForHim() throws Exception {
        sites =
                restClient
                        .authenticateUser(privateSiteConsumer)
                        .withParams("maxItems=5000")
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        sites.assertThat()
                ...
                .entriesListContains("title", firstModeratedSite.getTitle())
                .and()
                .entriesListContains("title", firstPrivateSite.getTitle());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if a site is not retrieved anymore after deletion and status code is"
                            + " 200")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if User gets sites ordered by title descending and status code is 200")
    public void getSitesOrderedByTitleDESC() throws Exception {
        int totalItems =
                restClient
                        .authenticateUser(lastPrivateSiteManager)
                        .withCoreAPI()
                        .getSites()
                        .getPagination()
                        .getTotalItems();
        sites =
                restClient
                        .authenticateUser(lastPrivateSiteManager)
                        .withParams(String.format("maxItems=%s&orderBy=title DESC", totalItems))
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        sites.assertThat().entriesListIsNotEmpty();
        ...
        sitesList
                .get(sitesList.size() - 1)
                .onModel()
                .assertThat()
                .field("title")
                .is(firstModeratedSite.getTitle());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if User gets sites ordered by id ascending and status code is 200")
    public void getSitesOrderedByIdASC() throws Exception {
        ...
        sites =
                restClient
                        .authenticateUser(lastPrivateSiteManager)
                        .withParams(String.format("maxItems=%s&orderBy=id ASC", totalItems))
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        sites.assertThat().entriesListIsNotEmpty();
        ...
        sitesList
                ...
                .assertThat()
                .field("id")
                .is(lastPublicSite.getId());
        sitesList
                .get(sitesList.size() - 2)
                .onModel()
                .assertThat()
                .field("id")
                .is(lastPrivateSite.getId());
        sitesList
                .get(sitesList.size() - 3)
                .onModel()
                .assertThat()
                .field("id")
                .is(lastModeratedSite.getId());
    ...
    public void checkPagination() throws Exception {
        ...
        sites.getPagination()
                ...
                .field("hasMoreItems")
                .is(
                        (sites.getPagination().getTotalItems()
                                        > sites.getPagination().getMaxItems())
                                ? "true"
                                : "false")
                .and()
                .field("skipCount")
                ...
                .field("count")
                .is(
                        (sites.getPagination().isHasMoreItems())
                                ? sites.getPagination().getMaxItems()
                                : sites.getPagination().getTotalItems());
    }
    ...
    public void getFirstTwoSites() throws Exception {
        sites =
                restClient
                        .authenticateUser(regularUser)
                        .withParams(String.format("maxItems=%s&orderBy=title ASC", 2))
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        ...
        sites.assertThat()
                ...
                .and()
                .entriesListDoesNotContain(firstPublicSite.getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can get sites using high skipCount parameter and status code is"
                            + " 200")
    public void getSitesUsingHighSkipCount() throws Exception {
        RestSiteModelsCollection allSites =
                restClient.authenticateUser(regularUser).withCoreAPI().getSites();
        ...
        if (allSites.getPagination().getTotalItems() > 100)
            sites.assertThat().entriesListIsNotEmpty();
        else sites.assertThat().entriesListIsEmpty();
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can not get sites using zero maxItems parameter and status code is"
                            + " 400")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that getSites request applies valid properties param and status code is"
                            + " 200")
    public void getSitesRequestWithValidPropertiesParam() throws Exception {
        ...
        restClient.assertStatusCodeIs(HttpStatus.OK);
        sites.assertThat()
                .entriesListDoesNotContain("description")
                .assertThat()
                .entriesListDoesNotContain("title")
                .assertThat()
                .entriesListDoesNotContain("visibility")
                .assertThat()
                .entriesListDoesNotContain("guid")
                .assertThat()
    ...
    public void checkPaginationWithSkipCountAndMaxItems() throws Exception {
        sites =
                restClient
                        .authenticateUser(regularUser)
                        .withParams("skipCount=10&maxItems=110")
                        .withCoreAPI()
                        .getSites();
        sites.getPagination()
                .assertThat()
                ...
                .is(
                        (sites.getPagination().getTotalItems()
                                                - sites.getPagination().getSkipCount()
                                        > sites.getPagination().getMaxItems())
                                ? "true"
                                : "false")
                .and()
    ...
    public void getSitesOrderedByTitleASCAndVisibilityASC() throws Exception {
        SiteModel secondPublicSite =
                dataSite.usingAdmin()
                        .createSite(
                                new SiteModel(
                                        SiteService.Visibility.PUBLIC,
                                        "guid",
                                        name + "A",
                                        name + "A",
                                        name));
        SiteModel thirdPublicSite =
                dataSite.usingAdmin()
                        .createSite(
                                new SiteModel(
                                        SiteService.Visibility.PUBLIC,
        ...
        sites =
                restClient
                        ...
                        .withParams(
                                String.format(
                                        "maxItems=%s&orderBy=title ASC&orderBy=description ASC",
                                        totalItems))
                        .withCoreAPI()
                        .getSites();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        ...
        sitesList
                ...
                .assertThat()
                .field("title")
                .is(thirdPublicSite.getTitle());
        sitesList
                .get(sitesList.size() - 2)
                .onModel()
                .assertThat()
                .field("title")
                .is(secondPublicSite.getTitle());
    ...
    public void checkThatRelationsParameterIsAppliedForContainers() throws Exception {
        List<List<Object>> jsonObjects =
                restClient
                        .authenticateUser(adminUser)
                        .withParams("relations=containers")
                        .withCoreAPI()
                        .usingSite(lastPublicSite)
        ...
        for (int i = 0; i < containerObjects.size(); i++) {
            RestSiteContainerModelsCollection containers =
                    (RestSiteContainerModelsCollection) containerObjects.get(i);
            containers
                    .assertThat()
                    .entriesListIsNotEmpty()
                    .and()
    ...
    public void checkThatRelationsParameterIsAppliedForMembers() throws Exception {
        ...
        for (int i = 0; i < memberObjects.size(); i++) {
            RestSiteMemberModelsCollection siteMembers =
                    (RestSiteMemberModelsCollection) memberObjects.get(i);
            siteMembers
                    .assertThat()
                    .entriesListIsNotEmpty()
                    .assertThat()
    ...
    public void checkThatRelationsParameterIsAppliedForMembersAndContainers() throws Exception {
        List<List<Object>> jsonObjects =
                restClient
                        .authenticateUser(adminUser)
                        .withParams("relations=containers,members")
                        .withCoreAPI()
                        .usingSite(lastPublicSite)
                        .getSitesWithRelations();
