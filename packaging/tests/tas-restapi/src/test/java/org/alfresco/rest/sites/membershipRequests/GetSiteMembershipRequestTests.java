...
public class GetSiteMembershipRequestTests extends RestTest {
    ...
    @TestRail(
            ...
            description = "Verify site manager is able to retrieve site membership request")
    public void siteManagerIsAbleToRetrieveSiteMembershipRequest() throws Exception {
        ...
        returnedModel
                ...
                .is(SiteService.Visibility.MODERATED.toString())
                .and()
                .field("site.guid")
                .isNotEmpty()
                .and()
    ...
    @TestRail(
            ...
            description = "Verify site collaborator is able to retrieve site membership request")
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.PEOPLE},
            executionType = ExecutionType.REGRESSION,
            description = "Verify site contributor is able to retrieve site membership request")
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.PEOPLE},
            executionType = ExecutionType.REGRESSION,
            description = "Verify site consumer is able to retrieve site membership request")
    ...
    @TestRail(
            section = {TestGroup.REST_API, TestGroup.PEOPLE},
            executionType = ExecutionType.REGRESSION,
            description = "Verify admin user is able to retrieve site membership request")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify user fails to get all site membership requests of a specific person"
                            + " with Rest API when the authentication fails (401)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify a user gets all its own site membership requests using '-me-' with Rest"
                            + " API and response is successful (200)")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can't get site membership requests for inexistent user and"
                            + " response is not found (404)")
    public void siteManagerCantGetSiteMembershipRequestsInexistentUser() throws Exception {
        restClient
                .authenticateUser(newMember)
                .withCoreAPI()
                .usingUser(UserModel.getRandomUserModel())
                .getSiteMembershipRequest(moderatedSite);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user can get site membership requests on site with no requests and"
    ...
    public void userWithNoRequestsCantGetSiteMembershipRequests() throws Exception {
        ...
        restClient
                .authenticateUser(noRequestUser)
                .withCoreAPI()
                .usingMe()
                .getSiteMembershipRequest(moderatedSite);
        restClient
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can't get site membership requests on public site and"
                            + " response is not found (404)")
    public void siteManagerCantGetPublicSiteMembershipRequests() throws Exception {
        ...
        restClient
                .authenticateUser(adminUser)
                .withCoreAPI()
                .usingUser(publicUser)
                .getSiteMembershipRequest(publicSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can't get site membership requests on private site and"
                            + " response is not found (404)")
    public void siteManagerCantGetPrivateSiteMembershipRequests() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingUser(privateUser)
                .getSiteMembershipRequest(privateSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager can't get site membership requests  for inexistent site"
    ...
    public void siteManagerCantGetSiteMembershipRequestsForInexistentSite() throws Exception {
        ...
        restClient
                ...
                .withCoreAPI()
                .usingMe()
                .getSiteMembershipRequest(inexistentSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
                .containsSummary(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if person ID field is empty user can't get site membership requests on"
                            + " moderated site and response is not found (400)")
    public void emptyPersonIdCantGetModeratedSiteMembershipRequests() throws Exception {
        ...
        restClient
                ...
                .containsSummary(
                        String.format("The entity with id: personId is null. was not found"))
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Approve site membership request then verify get site membership requests -"
                            + " response is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Reject site membership request then verify get site membership requests -"
                            + " response is 404")
    ...
    public void checkResponseSchemaForGetSiteMembershipRequest() throws Exception {
        dataUser.usingUser(siteCreator)
                .addUserToSite(newMember, moderatedSite, UserRole.SiteContributor);
        returnedModel =
                restClient
                        .authenticateUser(newMember)
                        .withCoreAPI()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that getFavoriteSites request returns status 200 when using valid"
                            + " parameters")
    public void getSiteMembershipRequestUsingParameters() throws Exception {
        RestSiteMembershipRequestModel returnedModel =
                restClient
                        .withParams("message=Please accept me")
                        .authenticateUser(newMember)
                        .withCoreAPI()
                        .usingMe()
                        .getSiteMembershipRequest(moderatedSite);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user doesn't have permission to get site membership request of admin"
                            + " without membership request with Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            description =
                    "Verify user doesn't have permission to get site membership request of admin"
                            + " with requests with Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin user doesn't have permission to get site membership request of"
                            + " another user with Rest API and status code is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.PEOPLE, TestGroup.REGRESSION})
    public void userIsNotAbleToGetSiteMembershipRequestOfAnotherUser() throws Exception {
        ...
        restClient
                .authenticateUser(userConsumer)
                .withCoreAPI()
                .usingAuthUser()
                .addSiteMembershipRequest(moderatedSite);
        dataUser.usingUser(siteCreator)
                .addUserToSite(userConsumer, moderatedSite, UserRole.SiteConsumer);
        restClient
                .authenticateUser(userCollaborator)
                .withCoreAPI()
                .usingAuthUser()
                .addSiteMembershipRequest(moderatedSite);
        dataUser.usingUser(siteCreator)
                .addUserToSite(userCollaborator, moderatedSite, UserRole.SiteCollaborator);

        returnedModel =
                restClient
                        .authenticateUser(userCollaborator)
                        .withCoreAPI()
                        .usingUser(userConsumer)
                        .getSiteMembershipRequest(moderatedSite);
        restClient
                .assertStatusCodeIs(HttpStatus.NOT_FOUND)
                .assertLastError()
