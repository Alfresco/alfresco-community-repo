...
public class NullFilingRule implements FilingRule {
  ...
  @Override
  public FilingData createFilingData(FilingParameters parameters)
    throws VirtualizationException {
    throw new VirtualizationException(
      "Can not create filing data for readonly filing rule."
    );
  }

  @Override
  public NodeRef filingNodeRefFor(FilingParameters parameters)
    throws VirtualizationException {
    throw new VirtualizationException(
      "Can not create parent readonly filing rule."
    );
  }
