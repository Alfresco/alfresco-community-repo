 ...
 */
@Category(
  { OwnJVMTestsCategory.class, LuceneTests.class, NeverRunsTests.class }
)
public class AbstractTenantRoutingContentStoreTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    fileContentStore =
      (AbstractTenantRoutingContentStore) ctx.getBean("fileContentStore");
  }
  ...
  public void testGetAllStores() throws Exception {
    final RetryingTransactionCallback<Object> txnWork = new RetryingTransactionCallback<Object>() {
      public Boolean execute() throws Exception {
        ...
        throw new AlfrescoRuntimeException(
          "Some error that causes RollBack. The transaction will be closed"
        );
      }
    };
    ...
    assertFalse(
      "getAllStores method returned the list with null entry",
      isNullEntry
    );
  }
  ...
  private NodeRef createContent(ServiceRegistry serviceRegistry)
    throws Exception {
    ...
    try {
      ...
      serviceRegistry
        ...
        .create(companyHome, "Test", ContentModel.TYPE_FOLDER);
      resultSet.close();
    } catch (Exception e) {}
