...
public interface RecordsManagementAdminService {
   ...
   * @return the propId.
   */
  QName setCustomPropertyDefinitionConstraint(
    QName propQName,
    QName newLovConstraint
  );
   ...
   */
  QName updateCustomChildAssocDefinition(
    QName refQName,
    String newSource,
    String newTarget
  );
   ...
   * @param newValues
   */
  void changeCustomConstraintValues(
    QName constraintName,
