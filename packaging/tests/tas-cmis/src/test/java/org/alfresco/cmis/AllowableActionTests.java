...
public class AllowableActionTests extends CmisTest {
  ...
  public void verifyValidDocumentHasAllowableActionCanCheckOut()
    throws Exception {
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorGetAllowableActionForContentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorGetAllowableActionForContentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void consumerGetAllowableActionForContentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void nonInvitedUserCanGetAllowableActionForContentCreatedByManager()
    throws Exception {
  ...
  public void nonInvitedUserOnPrivateSiteCannotGetAllowableActions()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
  ...
  public void nonInvitedUserOnModeratedSiteCannotGetAllowableActions()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
