...
public class CopyTests extends CmisTest {
  ...
  @Test(
    groups = {
      TestGroup.SANITY, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_ATOM,
    }
  )
  ...
  public void nonExistentUserIsNotAbleToCopyFile() throws Exception {
    ...
    cmisApi
      ...
      .assertThat()
      .existsInRepo();
    cmisApi.authenticateUser(inexistentUser).then().copyTo(targetFolder);
  }
  ...
  public void managerCopyPWCDocumentObject() throws Exception {
    ...
    FileModel pwcFile = cmisApi
      ...
      .getPWCFileModel();
    cmisApi
      .usingResource(pwcFile)
      .copyTo(targetFolder)
      .usingResource(targetFolder)
      .assertThat()
      .hasChildren(pwcFile);
  }
  ...
  public void unauthorizedUserCannotCopyDocumentFromPrivateSite()
    throws Exception {
    ...
    sourceFile =
      dataContent
        ...
        .createContent(FileModel.getRandomFileModel(FileType.TEXT_PLAIN));
    targetFolder =
      dataContent.usingUser(testUser).usingSite(privateSite).createFolder();
    cmisApi
  ...
  public void unauthorizedUserCannotCopyFolderFromPrivateSite()
    throws Exception {
    SiteModel privateSite = dataSite
      .usingUser(testUser)
      .createPrivateRandomSite();
  ...
  public void unauthorizedUserCannotCopyDocumentFromModeratedSite()
    throws Exception {
    ...
    sourceFile =
      dataContent
        ...
        .createContent(FileModel.getRandomFileModel(FileType.TEXT_PLAIN));
    targetFolder =
      dataContent.usingUser(testUser).usingSite(moderatedSite).createFolder();
    cmisApi
      .authenticateUser(unauthorizedUser)
      .usingResource(sourceFile)
      .copyTo(targetFolder);
  ...
  public void unauthorizedUserCannotCopyFolderFromModeratedSite()
    throws Exception {
    SiteModel moderatedSite = dataSite
      .usingUser(testUser)
      .createModeratedRandomSite();
