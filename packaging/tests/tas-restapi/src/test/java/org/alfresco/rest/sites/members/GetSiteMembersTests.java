...
public class GetSiteMembersTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role gets site members and gets status code OK (200)")
    public void getSiteMembersWithManagerRole() throws Exception {
        restClient
                ...
                .and()
                .entriesListContains(
                        "id", usersWithRoles.getOneUserWithRole(UserRole.SiteManager).getUsername())
                .and()
                .entriesListContains(
                        "role",
                        usersWithRoles
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role gets site members and gets status code OK"
                            + " (200)")
    public void getSiteMembersWithCollaboratorRole() throws Exception {
        restClient
                ...
                .entriesListContains(
                        "id",
                        usersWithRoles.getOneUserWithRole(UserRole.SiteCollaborator).getUsername())
                .and()
                .entriesListContains(
                        "role",
                        usersWithRoles
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role gets site members and gets status code OK"
                            + " (200)")
    public void getSiteMembersWithContributorRole() throws Exception {
        restClient
                ...
                .entriesListContains(
                        "id",
                        usersWithRoles.getOneUserWithRole(UserRole.SiteContributor).getUsername())
                .and()
                .entriesListContains(
                        "role",
                        usersWithRoles
                                .getOneUserWithRole(UserRole.SiteContributor)
                                .getUserRole()
                                .toString());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role gets site members and gets status code OK"
                            + " (200)")
    public void getSiteMembersWithConsumerRole() throws Exception {
        restClient
                ...
                .entriesListContains(
                        "id",
                        usersWithRoles.getOneUserWithRole(UserRole.SiteConsumer).getUsername())
                .and()
                .entriesListContains(
                        "role",
                        usersWithRoles
                                .getOneUserWithRole(UserRole.SiteConsumer)
                                .getUserRole()
                                .toString());
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with admin usere gets site members and gets status code OK (200)")
    public void getSiteMembersWithAdminUser() throws Exception {
        restClient
                ...
                .entriesListIsNotEmpty()
                .and()
                .entriesListContains("id", siteCreator.getUsername())
                .when()
                .assertThat()
                .entriesListContains("role", "SiteManager");
        restClient.assertStatusCodeIs(HttpStatus.OK);
    }
    ...
    public void unauthenticatedUserIsNotAuthorizedToRetrieveSiteMembers() throws Exception {
        ...
        restClient.authenticateUser(userModel).withCoreAPI().usingSite(publicSite).getSiteMembers();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site members call returns status code 400 for invalid maxItems")
    public void checkStatusCodeForInvalidMaxItems() throws Exception {
        ...
        restClient.withParams("maxItems=A").withCoreAPI().usingSite(publicSite).getSiteMembers();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify get site members call returns status code 400 for invalid skipCount ")
    public void checkStatusCodeForInvalidSkipCount() throws Exception {
        ...
        restClient.withParams("skipCount=-1").withCoreAPI().usingSite(publicSite).getSiteMembers();
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
    ...
    public void getModeratedSiteMembers() throws Exception {
        ...
        siteMembers
                ...
                .entriesListContains(
                        "id",
                        moderatedSiteUsers.getOneUserWithRole(UserRole.SiteConsumer).getUsername())
                .and()
                .paginationField("count")
                .is("4");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if user gets private site members if he is a member of that site and"
                            + " status code is 200")
    public void getPrivateSiteMembersByASiteMember() throws Exception {
        ...
        siteMembers
                ...
                .entriesListContains("id", siteCreator.getUsername())
                .and()
                .entriesListContains("id", privateSiteConsumer.getUsername())
                .and()
                .paginationField("count")
                .is("2");
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if user doesn't get private site members if he is not a member of that"
                            + " site and status code is 404")
    public void getPrivateSiteMembersByNotASiteMember() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, privateSite.getTitle()));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if user gets moderated site members after the adding of a new member"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site members with properties parameter"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site members with skipCount parameter"
                            + " applied")
    public void getModeratedSiteMembersUsingSkipCountParameter() throws Exception {
        ...
        siteMembers
                .assertThat()
                .entriesListDoesNotContain("id", firstSiteMember.getId())
                .and()
                .entriesListDoesNotContain("id", secondSiteMember.getId())
                .and()
                .entriesListContains("role", thirdSiteMember.getRole().toString())
                .and()
                .entriesListContains("id", thirdSiteMember.getId())
                .and()
                .entriesListContains("role", fourthSiteMember.getRole().toString())
                .and()
                .entriesListContains("id", fourthSiteMember.getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site members with high skipCount parameter"
                            + " applied")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets moderated site members with maxItems parameter applied"
    ...
    public void getModeratedSiteMembersUsingMaxItemsParameter() throws Exception {
        ...
        siteMembers
                .assertThat()
                .entriesListContains("id", firstSiteMember.getId())
                .and()
                .entriesListContains("role", firstSiteMember.getRole().toString())
                .and()
                .entriesListDoesNotContain("id", secondSiteMember.getId())
                .and()
                .entriesListDoesNotContain("id", thirdSiteMember.getId());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if user gets moderated site members with member not joined yet and"
                            + " status code is 200")
    public void getSiteMembersFromNotJoinedModeratedSite() throws Exception {
        ...
        restClient
                .authenticateUser(userNotJoined)
                .withCoreAPI()
                .usingAuthUser()
        ...
        siteMembers
                ...
                .entriesListContains("id", siteCreator.getUsername())
                .and()
                .entriesListDoesNotContain("id", userNotJoined.getUsername());
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify if any user gets site members after the member was removed from site"
                            + " and status code is 200")
    ...
    public void verifyIsMemberOfGroupProps() throws Exception {
        ...
        restClient
                ...
                .usingSite(moderatedSite4)
                .addSiteGroup(
                        "GROUP_" + firstGroup.getGroupIdentifier(), UserRole.SiteCollaborator);
        ...
        siteMembers =
                restClient
                        .withCoreAPI()
                        .usingSite(moderatedSite4)
                        .usingParams("where=(isMemberOfGroup=false)")
                        .getSiteMembers();
        restClient.assertStatusCodeIs(HttpStatus.OK);
        siteMembers.assertThat().entriesListCountIs(1);
