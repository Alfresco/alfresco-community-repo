...
public class CompositePasswordEncoderTest {
    ...
    private static final String SOURCE_PASSWORD =
            "SOURCE PASS Word $%%^ #';/,_+{+} like €this" + "\u4eca\u65e5\u306f\u4e16\u754c";
    ...
    public void testEncodeMD4() throws Exception {
        ...
        assertTrue(
                encoder.matchesPassword(
                        SOURCE_PASSWORD, sourceEncodedSaltFree, null, Arrays.asList("md4")));
        assertEquals(
    ...
    public void testEncodeSha256() throws Exception {
        ...
        assertTrue(
                encoder.matchesPassword(SOURCE_PASSWORD, encoded, salt, Arrays.asList("sha256")));
        assertEquals(
                sourceEncoded,
        ...
        assertTrue(
                encoder.matchesPassword(
                        SOURCE_PASSWORD, sourceEncodedSaltFree, null, Arrays.asList("sha256")));
        assertEquals(
                sourceEncodedSaltFree,
    ...
    public void testEncodeBcrypt() throws Exception {
        ...
        assertTrue(
                encoder.matchesPassword(SOURCE_PASSWORD, encoded, null, Arrays.asList("bcrypt10")));
