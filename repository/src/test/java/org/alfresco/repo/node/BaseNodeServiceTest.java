...
public abstract class BaseNodeServiceTest extends BaseSpringTest {
  ...
  public static final String NAMESPACE =
    "http://www.alfresco.org/test/BaseNodeServiceTest";
  public static final String TEST_PREFIX = "test";

  public static final String DEFAULT_VALUE = "defaultValue";
  public static final String NOT_DEFAULT_VALUE = "notDefaultValue";

  public static final QName TYPE_QNAME_TEST_CONTENT = QName.createQName(
    NAMESPACE,
    "content"
  );
  public static final QName TYPE_QNAME_TEST_MANY_PROPERTIES = QName.createQName(
    NAMESPACE,
    "many-properties"
  );
  public static final QName TYPE_QNAME_TEST_MAFullNodeServiceTestNY_PROPERTIES_ENCRYPTED = QName.createQName(
    NAMESPACE,
    "many-properties-encrypted"
  );
  public static final QName TYPE_QNAME_TEST_MANY_ML_PROPERTIES = QName.createQName(
    NAMESPACE,
    "many-ml-properties"
  );
  public static final QName TYPE_QNAME_EXTENDED_CONTENT = QName.createQName(
    NAMESPACE,
    "extendedcontent"
  );
  public static final QName ASPECT_QNAME_TEST_TITLED = QName.createQName(
    NAMESPACE,
    "titled"
  );
  public static final QName ASPECT_QNAME_TEST_MARKER = QName.createQName(
    NAMESPACE,
    "marker"
  );
  public static final QName ASPECT_QNAME_TEST_MARKER2 = QName.createQName(
    NAMESPACE,
    "marker2"
  );
  public static final QName ASPECT_QNAME_MANDATORY = QName.createQName(
    NAMESPACE,
    "mandatoryaspect"
  );
  public static final QName ASPECT_QNAME_WITH_DEFAULT_VALUE = QName.createQName(
    NAMESPACE,
    "withDefaultValue"
  );
  public static final QName PROP_QNAME_TEST_TITLE = QName.createQName(
    NAMESPACE,
    "title"
  );
  public static final QName PROP_QNAME_TEST_DESCRIPTION = QName.createQName(
    NAMESPACE,
    "description"
  );
  public static final QName PROP_QNAME_TEST_CONTENT = QName.createQName(
    NAMESPACE,
    "content"
  );
  public static final QName PROP_QNAME_BOOLEAN_VALUE = QName.createQName(
    NAMESPACE,
    "booleanValue"
  );
  public static final QName PROP_QNAME_INTEGER_VALUE = QName.createQName(
    NAMESPACE,
    "integerValue"
  );
  public static final QName PROP_QNAME_LONG_VALUE = QName.createQName(
    NAMESPACE,
    "longValue"
  );
  public static final QName PROP_QNAME_FLOAT_VALUE = QName.createQName(
    NAMESPACE,
    "floatValue"
  );
  public static final QName PROP_QNAME_DOUBLE_VALUE = QName.createQName(
    NAMESPACE,
    "doubleValue"
  );
  public static final QName PROP_QNAME_STRING_VALUE = QName.createQName(
    NAMESPACE,
    "stringValue"
  );
  public static final QName PROP_QNAME_ML_TEXT_VALUE = QName.createQName(
    NAMESPACE,
    "mlTextValue"
  );
  public static final QName PROP_QNAME_DATE_VALUE = QName.createQName(
    NAMESPACE,
    "dateValue"
  );
  public static final QName PROP_QNAME_SERIALIZABLE_VALUE = QName.createQName(
    NAMESPACE,
    "serializableValue"
  );
  public static final QName PROP_QNAME_NODEREF_VALUE = QName.createQName(
    NAMESPACE,
    "nodeRefValue"
  );
  public static final QName PROP_QNAME_QNAME_VALUE = QName.createQName(
    NAMESPACE,
    "qnameValue"
  );
  public static final QName PROP_QNAME_CONTENT_VALUE = QName.createQName(
    NAMESPACE,
    "contentValue"
  );
  public static final QName PROP_QNAME_PATH_VALUE = QName.createQName(
    NAMESPACE,
    "pathValue"
  );
  public static final QName PROP_QNAME_CATEGORY_VALUE = QName.createQName(
    NAMESPACE,
    "categoryValue"
  );
  public static final QName PROP_QNAME_LOCALE_VALUE = QName.createQName(
    NAMESPACE,
    "localeValue"
  );
  public static final QName PROP_QNAME_NULL_VALUE = QName.createQName(
    NAMESPACE,
    "nullValue"
  );
  public static final QName PROP_QNAME_MULTI_VALUE = QName.createQName(
    NAMESPACE,
    "multiValue"
  );
  public static final QName PROP_QNAME_PERIOD_VALUE = QName.createQName(
    NAMESPACE,
    "periodValue"
  );
  public static final QName PROP_QNAME_MULTI_ML_VALUE = QName.createQName(
    NAMESPACE,
    "multiMLValue"
  );
  public static final QName PROP_QNAME_MARKER_PROP = QName.createQName(
    NAMESPACE,
    "markerProp"
  );
  public static final QName PROP_QNAME_PROP1 = QName.createQName(
    NAMESPACE,
    "prop1"
  );
  public static final QName PROP_QNAME_PROP2 = QName.createQName(
    NAMESPACE,
    "prop2"
  );
  public static final QName ASSOC_TYPE_QNAME_TEST_CHILDREN =
    ContentModel.ASSOC_CHILDREN;
  public static final QName ASSOC_TYPE_QNAME_TEST_CONTAINS =
    ContentModel.ASSOC_CONTAINS;
  public static final QName ASSOC_TYPE_QNAME_TEST_NEXT = QName.createQName(
    NAMESPACE,
    "next"
  );

  public static final QName ASPECT_RESIDUAL = QName.createQName(
    NAMESPACE,
    "residual"
  );
  public static final QName PROP_QNAME_RESIDUAL_STRING = QName.createQName(
    NAMESPACE,
    "residualString"
  );
  public static final QName PROP_QNAME_RESIDUAL_LONG = QName.createQName(
    NAMESPACE,
    "residualLong"
  );

  public static final QName ASPECT_WITH_ASSOCIATIONS = QName.createQName(
    NAMESPACE,
    "withAssociations"
  );
  public static final QName ASSOC_ASPECT_CHILD_ASSOC = QName.createQName(
    NAMESPACE,
    "aspect-child-assoc"
  );
  public static final QName ASSOC_ASPECT_NORMAL_ASSOC = QName.createQName(
    NAMESPACE,
    "aspect-normal-assoc"
  );

  public static final QName ASPECT_WITH_ASSOCIATIONS_EXTRA = QName.createQName(
    NAMESPACE,
    "withAssociationsExtra"
  );
  public static final QName ASSOC_ASPECT_CHILD_ASSOC_01 = QName.createQName(
    NAMESPACE,
    "aspect-child-assoc-01"
  );
  public static final QName ASSOC_ASPECT_CHILD_ASSOC_02 = QName.createQName(
    NAMESPACE,
    "aspect-child-assoc-02"
  );
  public static final QName ASSOC_ASPECT_NORMAL_ASSOC_01 = QName.createQName(
    NAMESPACE,
    "aspect-normal-assoc-01"
  );
  public static final QName ASSOC_ASPECT_NORMAL_ASSOC_02 = QName.createQName(
    NAMESPACE,
    "aspect-normal-assoc-02"
  );

  public static final QName TYPE_QNAME_TEST_MULTIPLE_TESTER = QName.createQName(
    NAMESPACE,
    "multiple-tester"
  );
  public static final QName PROP_QNAME_STRING_PROP_SINGLE = QName.createQName(
    NAMESPACE,
    "stringprop-single"
  );
  public static final QName PROP_QNAME_STRING_PROP_MULTIPLE = QName.createQName(
    NAMESPACE,
    "stringprop-multiple"
  );
  public static final QName PROP_QNAME_ANY_PROP_SINGLE = QName.createQName(
    NAMESPACE,
    "anyprop-single"
  );
  public static final QName PROP_QNAME_ANY_PROP_MULTIPLE = QName.createQName(
    NAMESPACE,
    "anyprop-multiple"
  );

  public static final QName ASPECT_WITH_ENCRYPTED = QName.createQName(
    NAMESPACE,
    "withEncrypted"
  );
  public static final QName PROP_QNAME_ENCRYPTED_VALUE = QName.createQName(
    NAMESPACE,
    "encryptedValue"
  );
  ...
  public void before() {
    ...
    policyComponent =
      (PolicyComponent) applicationContext.getBean("policyComponent");
    ...
    DictionaryDAO dictionaryDao = (DictionaryDAO) applicationContext.getBean(
      "dictionaryDAO"
    );
    ...
    modelStream =
      cl.getResourceAsStream(
        "org/alfresco/repo/node/BaseNodeServiceTest_model.xml"
      );
    assertNotNull(modelStream);
   ...
   */
  public static DictionaryService loadModel(
  ...
  public static Map<QName, ChildAssociationRef> buildNodeGraph(
    ...
    Map<QName, ChildAssociationRef> ret = new HashMap<QName, ChildAssociationRef>(
      13
    );
  ...
  public void testCreateStore() throws Exception {
    ...
    assertTrue(
      "NodeService reports that store doesn't exist",
      nodeService.exists(storeRef)
    );

    // get the root node
    NodeRef storeRootNode = nodeService.getRootNode(storeRef);
    // make sure that it has the root aspect
    boolean isRoot = nodeService.hasAspect(
      storeRootNode,
      ContentModel.ASPECT_ROOT
    );
    ...
    assertEquals(
      "Store root node of incorrect type",
  ...
  public void testGetStores() throws Exception {
    ...
    assertTrue(
      "New store not present is list of stores",
      storeRefs.contains(storeRef)
    );
  }
  ...
  public void testDeleteStore() throws Exception {
    ...
    BadOnDeleteNodePolicy policy = new BadOnDeleteNodePolicy(
      nodeService,
      beforeDeleteNodeRefs,
      onDeleteNodeRefs
    );
    ...
    // check that the store ref is present
    assertTrue(
      "New store not present in list of stores",
      storeRefs.contains(storeRef)
    );
    // Get the root node
    ...
    assertFalse(
      "Deleted store should not present in list of stores",
      storeRefs.contains(storeRef)
    );
    ...
    for (StoreRef retrievedStoreRef : storeRefs) {
      if (retrievedStoreRef.getProtocol().equals(StoreRef.PROTOCOL_DELETED)) {
        fail(
          "NodeService should not have returned 'deleted' stores." + storeRefs
        );
      }
    }
    ...
    assertEquals(
      "Incorrect node for beforeDelete callback",
      nodeRef,
      beforeDeleteNodeRefs.get(0)
    );
    assertEquals(
      "Incorrect number of node onDelete notifications",
      1,
      onDeleteNodeRefs.size()
    );
    assertEquals(
      "Incorrect node for onDelete callback",
      nodeRef,
      onDeleteNodeRefs.get(0)
    );
  ...
  public void testGetRootNode() throws Exception {
    ...
    assertEquals(
      "Root nodes returned different refs",
      rootNodeRef,
      rootNodeRefCheck
    );
  }
  ...
  public void testCreateWithTooLongPathLocalname() throws Exception {
    try {
      ChildAssociationRef assocRef = nodeService.createNode(
        ...
        ASSOC_TYPE_QNAME_TEST_CHILDREN,
        QName.createQName(
          "Recognize that VSEPR theory states that nonbonded electrons (lone " +
      ...
      fail(
        "Expected too-long QName localname to have been kicked out as illegal argument."
      );
  ...
  public void testSetType() throws Exception {
    ...
    Serializable defaultValue =
      this.nodeService.getProperty(nodeRef, PROP_QNAME_PROP1);
  ...
  protected void fillProperties(
    ...
    for (Map.Entry<QName, PropertyDefinition> entry : propertyDefs.entrySet()) {
      ...
      if (propertyTypeQName.equals(DataTypeDefinition.CONTENT)) {
        ...
        propertyTypeQName.equals(DataTypeDefinition.CATEGORY) ||
  ...
  public void testAspects() throws Exception {
    ...
    Map<QName, Serializable> propertiesBefore = nodeService.getProperties(
      nodeRef
    );
    // add the aspect
    nodeService.addAspect(
    ...
    Map<QName, Serializable> propertiesAfter = nodeService.getProperties(
      nodeRef
    );
    assertEquals(
      "Aspect properties not added",
    ...
    boolean hasAspect = nodeService.hasAspect(
      nodeRef,
      BaseNodeServiceTest.ASPECT_QNAME_TEST_TITLED
    );
  ...
  public void testAspectsAddedAutomatically() throws Exception {
    ...
    properties.put(
      BaseNodeServiceTest.PROP_QNAME_TEST_DESCRIPTION,
      "A description"
    );
    ...
    nodeService.setProperty(
      nodeRef,
      BaseNodeServiceTest.PROP_QNAME_MARKER_PROP,
      "Marker value"
    );
    assertTrue(
      "Aspect not automatically added during 'setProperty'",
      nodeService.hasAspect(
        nodeRef,
        BaseNodeServiceTest.ASPECT_QNAME_TEST_MARKER
      )
    );
    assertTrue(
      ...
      nodeService.hasAspect(
        nodeRef,
        BaseNodeServiceTest.ASPECT_QNAME_TEST_MARKER2
      )
    );

    // Check that child association creation adds the aspect to the parent
    NodeRef childNodeRef = nodeService
      .createNode(
        nodeRef,
    ...
    assertTrue(
      ...
      nodeService.hasAspect(
        nodeRef,
        BaseNodeServiceTest.ASPECT_WITH_ASSOCIATIONS
      )
    );
    assertFalse(
    ...
    assertFalse(
      "Child node should have been deleted",
      nodeService.exists(childNodeRef)
    );
    ...
    nodeService.createAssociation(
      nodeRef,
      rootNodeRef,
      BaseNodeServiceTest.ASSOC_ASPECT_NORMAL_ASSOC
    );
    assertTrue(
  ...
  public void testAspectRemoval() throws Exception {
    ...
    NodeRef sourceNodeRef = nodeService
      .createNode(
        rootNodeRef,
        ASSOC_TYPE_QNAME_TEST_CHILDREN,
        QName.createQName(
          BaseNodeServiceTest.NAMESPACE,
          "testAspectRemoval-source"
        ),
        ContentModel.TYPE_CONTAINER
      )
      .getChildRef();
    ...
    NodeRef targetNodeRef = nodeService
      .createNode(
        rootNodeRef,
        ASSOC_TYPE_QNAME_TEST_CHILDREN,
        QName.createQName(
          BaseNodeServiceTest.NAMESPACE,
          "testAspectRemoval-target"
        ),
        ContentModel.TYPE_CONTAINER
      )
      .getChildRef();
    ...
    assertEquals(
      ...
      1,
      nodeService.getChildAssocs(sourceNodeRef).size()
    );
    assertEquals(
      "Expected exactly one target",
      1,
      nodeService
        .getTargetAssocs(sourceNodeRef, RegexQNamePattern.MATCH_ALL)
        .size()
    );
  ...
  public void testAspectRemovalCascadeDelete() throws Exception {
    ...
    nodeService.removeAspect(sourceNodeRef, ASPECT_WITH_ASSOCIATIONS);
    assertFalse(
      "Child node must have been cascade-deleted",
      nodeService.exists(targetNodeRef)
    );
  }

  private static final QName ASPECT_QNAME_TEST_RENDERED = QName.createQName(
    NAMESPACE,
    "rendered"
  );
  private static final QName ASSOC_TYPE_QNAME_TEST_RENDITION = QName.createQName(
    NAMESPACE,
    "rendition-page"
  );
  private static final QName TYPE_QNAME_TEST_RENDITION_PAGE = QName.createQName(
    NAMESPACE,
    "rendition-page"
  );
  private static final QName PROP_QNAME_TEST_RENDITION_PAGE_CONTENT = QName.createQName(
    NAMESPACE,
    "rendition-page-content"
  );
  ...
  public void testAspectWithChildAssociationsCreationAndRetrieval()
    ...
    NodeRef fileNodeRef = nodeService
      .createNode(
        folderNodeRef,
        ContentModel.ASSOC_CONTAINS,
    ...
    ChildAssociationRef fetchedRenditionChildAssoc5 = fetchedRenditionChildAssocs.get(
      4
    );
    ...
    assertEquals(
      ...
      1,
      fetchedRenditionChildAssocsPage5.size()
    );
    assertEquals(
  ...
  public void testCascadeDelete() throws Exception {
    ...
    assertEquals(
      "n6 primary parent association not present on n3",
      1,
      countChildrenOfNode(n3Ref)
    );
    assertEquals(
      "n6 secondary parent association not present on n4",
      1,
      countChildrenOfNode(n4Ref)
    );
    assertEquals(
      "n8 secondary parent association not present on n7",
      1,
    ...
    assertFalse(
      "n8 not cascade deleted in-transaction",
      nodeService.exists(n8Ref)
    );
    ...
    assertEquals(
      "n6 primary parent association not removed from n3",
      0,
      countChildrenOfNode(n3Ref)
    );
    assertEquals(
  ...
  public void testDelete() throws Exception {
    ...
    BadOnDeleteNodePolicy nasty = new BadOnDeleteNodePolicy(
      nodeService,
      beforeDeleteNodeRefs,
      deletedNodeRefs
    );
    ...
    assertTrue(
      "n1Ref before delete policy not called",
      beforeDeleteNodeRefs.contains(n1Ref)
    );
    assertTrue(
      "n3Ref before delete policy not called",
      beforeDeleteNodeRefs.contains(n3Ref)
    );
    assertTrue(
      "n6Ref before delete policy not called",
      beforeDeleteNodeRefs.contains(n6Ref)
    );
    assertTrue(
      "n8Ref before delete policy not called",
      beforeDeleteNodeRefs.contains(n8Ref)
    );

    // check delete policy has been called
    assertTrue(
      "n1Ref delete policy not called",
      deletedNodeRefs.contains(n1Ref)
    );
    assertTrue(
      "n3Ref delete policy not called",
      deletedNodeRefs.contains(n3Ref)
    );
    assertTrue(
      "n6Ref delete policy not called",
      deletedNodeRefs.contains(n6Ref)
    );
    assertTrue(
      "n8Ref delete policy not called",
      deletedNodeRefs.contains(n8Ref)
    );
  }
  ...
  public void testAddChild() throws Exception {
    NodeRef childNodeRef1 = nodeService
      .createNode(
        rootNodeRef,
        ASSOC_TYPE_QNAME_TEST_CHILDREN,
    ...
    NodeRef childNodeRef2 = nodeService
      .createNode(
        childNodeRef1,
        ASSOC_TYPE_QNAME_TEST_CHILDREN,
    ...
    try {
      ...
      fail(
        "Failed to detect cyclic child relationship during addition of child"
      );
  ...
  public void testRemoveChildPolicyFires() throws Exception {
    ...
    assertEquals(
      "The BeforeDeleteChildAssociationPolicy must fire on removeSecondaryChildAssociation",
      pathBRef,
  ...
  public void testProperties() throws Exception {
    ...
    assertNotNull(
      "Name property not set automatically",
    ...
    assertEquals(
      ...
      valueProperty1,
      checkMap.get(qnameProperty1)
    );
    assertEquals(
      "Property value incorrect",
      valueProperty2,
      checkMap.get(qnameProperty2)
    );
    assertTrue(
      "Null property not persisted",
      checkMap.containsKey(qnameProperty3)
    );
    assertNull(
      "Null value not persisted correctly",
      checkMap.get(qnameProperty3)
    );
    assertEquals(
      "Enum property not retrieved",
      TestEnum.TEST_ONE,
      checkMap.get(qnameProperty4)
    );
  ...
  public void testAddProperties() throws Exception {
    ...
    Map<QName, Serializable> addProperties = new HashMap<QName, Serializable>(
      11
    );
    ...
    // Check
    Map<QName, Serializable> checkProperties = nodeService.getProperties(
      rootNodeRef
    );
    assertEquals("Title", checkProperties.get(PROP_QNAME_TEST_TITLE));
    assertEquals(
      "Description",
      checkProperties.get(PROP_QNAME_TEST_DESCRIPTION)
    );
  }

  @Test
  public void testDefaultPropertyOverride_AddAspect() throws Exception {
    Serializable nullValue = nodeService.getProperty(
      rootNodeRef,
      PROP_QNAME_PROP2
    );
    ...
    Serializable checkValue = nodeService.getProperty(
      rootNodeRef,
      PROP_QNAME_PROP2
    );
  ...
  public void testDefaultPropertyOverride_SpecializeWithProperty()
    ...
    checkValue = nodeService.getProperty(nodeRef, PROP_QNAME_PROP1);
    assertEquals(
      "Property should *still* not be defaulted",
      valueOverride,
      checkValue
    );
  }
  ...
  public void testRemoveProperty() throws Exception {
    ...
    Serializable defaultValue = nodeService.getProperty(
      rootNodeRef,
      PROP_QNAME_PROP2
    );
    assertNotNull("No default property value assigned", defaultValue);
  ...
  public void testGetUnknownProperty() throws Exception {
    ...
    final NodeRef nodeRef = retryingTransactionHelper.doInTransaction(
      createCallback,
      false,
      true
    );
    ...
    RetryingTransactionCallback<Object> testCallback = new RetryingTransactionCallback<Object>() {
      public Object execute() throws Throwable {
        QName ficticiousQName = QName.createQName(
          GUID.generate(),
          GUID.generate()
        );
  ...
  public void testSerializableProperties() throws Exception {
    ...
    Serializable checkPropertyQname = checkProperties.get(
      PROP_QNAME_SERIALIZABLE_VALUE
    );
    assertTrue(
      "Serialization/deserialization failed",
      checkPropertyQname instanceof QName
    );
  }
  ...
  public void testEncryptionAndDecryptionOfProperties() {
    ...
    Serializable encryptedProperty = metadataEncryptor.encrypt(
      PROP_QNAME_ENCRYPTED_VALUE,
      valueToEncrypt
    );
    assertTrue("Not a SealedObject", encryptedProperty instanceof SealedObject);
    Serializable encryptedPropertyAgain = metadataEncryptor.encrypt(
      PROP_QNAME_ENCRYPTED_VALUE,
      encryptedProperty
    );
    assertTrue(
      "Re-encryption not expected",
      encryptedProperty == encryptedPropertyAgain
    );
    Serializable decryptedProperty = metadataEncryptor.decrypt(
      PROP_QNAME_ENCRYPTED_VALUE,
      encryptedProperty
    );
    assertEquals(
      "Value not decrypted correctly",
      valueToEncrypt,
      decryptedProperty
    );
    ...
    Map<QName, Serializable> encryptedProperties = metadataEncryptor.encrypt(
      properties
    );
    assertTrue(
      "Not a SealedObject",
      encryptedProperties.get(
        PROP_QNAME_ENCRYPTED_VALUE
      ) instanceof SealedObject
    );
    assertTrue(
      "Should not encrypt",
      encryptedProperties.get(PROP_QNAME_QNAME_VALUE) instanceof QName
    );
    Map<QName, Serializable> encryptedPropertiesAgain = metadataEncryptor.encrypt(
      encryptedProperties
    );
    assertTrue(
      "Map should not change",
      encryptedProperties == encryptedPropertiesAgain
    );
    assertTrue(
      "Re-encryption not expected",
    ...
    Map<QName, Serializable> decryptedProperties = metadataEncryptor.decrypt(
      encryptedProperties
    );
    assertEquals(
    ...
    Map<QName, Serializable> propertiesNull = new HashMap<QName, Serializable>(
      5
    );
    propertiesNull.put(PROP_QNAME_ENCRYPTED_VALUE, null);
    propertiesNull.put(PROP_QNAME_QNAME_VALUE, null);
    Map<QName, Serializable> encryptedPropertiesNull = metadataEncryptor.encrypt(
      propertiesNull
    );
    assertTrue(
      "Map should not change",
      encryptedPropertiesNull == propertiesNull
    );
    assertNull(
      "Null should remain",
      encryptedPropertiesNull.get(PROP_QNAME_ENCRYPTED_VALUE)
    );
    Map<QName, Serializable> decryptedPropertiesNull = metadataEncryptor.decrypt(
      encryptedPropertiesNull
    );
    assertTrue(
      "Map should not change",
      encryptedPropertiesNull == decryptedPropertiesNull
    );
    assertNull(
      "Null should remain",
      decryptedPropertiesNull.get(PROP_QNAME_ENCRYPTED_VALUE)
    );
  }
  ...
  public void testEncryptedProperties() throws Exception {
    ...
    assertTrue(
      ...
      checkProperty instanceof SealedObject
    );

    // create node
    final NodeRef nodeRef = nodeService
      .createNode(
        rootNodeRef,
        ASSOC_TYPE_QNAME_TEST_CHILDREN,
        QName.createQName("pathA"),
    ...
    assertTrue(
      "Encrypted property not persisted",
      checkProperty instanceof SealedObject
    );

    // Decrypt individual property
    checkProperty =
      metadataEncryptor.decrypt(PROP_QNAME_ENCRYPTED_VALUE, checkProperty);
  ...
  public void testMultiProp() throws Exception {
    QName undeclaredPropQName = QName.createQName(
      NAMESPACE,
      getClass().getName()
    );
    // create node
    ...
    try {
      ...
      assertTrue(
        ...
        checkValues.get(0) instanceof MLText
      );
      assertTrue(
        "Incorrect type in collection",
        checkValues.get(1) instanceof MLText
      );
      ...
      nodeService.setProperty(nodeRef, PROP_QNAME_ANY_PROP_MULTIPLE, values);
      checkValues =
        (List<Serializable>) nodeService.getProperty(
          nodeRef,
      ...
      assertTrue(
        "Incorrect type in collection",
        checkValues.get(0) instanceof ArrayList
      ); // ArrayList in - ArrayList out
      assertTrue(
        "Incorrect type in collection",
        checkValues.get(1) instanceof HashSet
      ); // HashSet in - HashSet out
      ...
      assertEquals(
        "First collection incorrect",
        2,
        ((Collection) checkValues.get(0)).size()
      );
      assertEquals(
        "Second collection incorrect",
        2,
        ((Collection) checkValues.get(1)).size()
      );
    } catch (DictionaryException e) {
      // expected
    } finally {
  ...
  /**
     ...
     */
  protected void getExpectedPropertyValues(
    Map<QName, Serializable> checkProperties
  ) {
  ...
  public void testPropertyTypes() throws Exception {
    ...
    properties.put(
      ...
      new MLText("This is ML text in the default language")
    );
    properties.put(PROP_QNAME_DATE_VALUE, new Date());
    properties.put(PROP_QNAME_SERIALIZABLE_VALUE, "456");
    properties.put(PROP_QNAME_NODEREF_VALUE, rootNodeRef);
    ...
    Map<QName, Serializable> expectedProperties = new HashMap<QName, Serializable>(
      properties
    );
    ...
    Serializable checkProperty = nodeService.getProperty(
      nodeRef,
      PROP_QNAME_MULTI_VALUE
    );
    assertTrue(
      "Property not converted to a Collection",
      checkProperty instanceof Collection
    );
    assertTrue(
  ...
  public void testPropertyLocaleBehaviour() throws Exception {
    ...
    nodeService.setProperty(
      ...
      properties.get(PROP_QNAME_DATE_VALUE)
    );
  ...
  public void testEmptyCollections() throws Exception {
    ...
    nodeService.setProperty(
      nodeRef,
      PROP_QNAME_MULTI_VALUE,
      (Serializable) filledCollection
    );
    List<String> checkFilledCollection = (List<String>) nodeService.getProperty(
      nodeRef,
      PROP_QNAME_MULTI_VALUE
    );
    assertEquals(
    ...
    nodeService.setProperty(
      nodeRef,
      PROP_QNAME_MULTI_VALUE,
      (Serializable) emptyCollection
    );
    List<String> checkEmptyCollection = (List<String>) nodeService.getProperty(
      nodeRef,
      PROP_QNAME_MULTI_VALUE
    );
    assertEquals(
    ...
    List<String> checkNullCollection = (List<String>) nodeService.getProperty(
      nodeRef,
      PROP_QNAME_MULTI_VALUE
    );
  ...
  public void testBigCollections() throws Exception {
    ...
    for (int inc = 0; inc < 5; inc++) {
      ...
      // Now get it back
      t1 = System.nanoTime();
      List<String> checkLargeCollection = (List<String>) nodeService.getProperty(
        nodeRef,
        PROP_QNAME_MULTI_VALUE
      );
  ...
  public void testMultiValueMLTextProperties() throws Exception {
    ...
    nodeService.setProperty(
      nodeRef,
      PROP_QNAME_MULTI_ML_VALUE,
      (Serializable) mlTextCollection
    );
    Collection<MLText> mlTextCollectionCheck = (Collection<MLText>) nodeService.getProperty(
      nodeRef,
      PROP_QNAME_MULTI_ML_VALUE
    );
    assertEquals(
  ...
  public void testGetReferencableProperties() throws Exception {
    ...
    Serializable wsProtocol = nodeService.getProperty(
      rootNodeRef,
      ContentModel.PROP_STORE_PROTOCOL
    );
    Serializable wsIdentifier = nodeService.getProperty(
      rootNodeRef,
      ContentModel.PROP_STORE_IDENTIFIER
    );
    Serializable nodeUuid = nodeService.getProperty(
      rootNodeRef,
      ContentModel.PROP_NODE_UUID
    );
    Serializable nodeDbId = nodeService.getProperty(
      rootNodeRef,
  ...
  public void testReferencePropertySet() throws Exception {
    ...
    Serializable nodeDbIdCheck = nodeService.getProperty(
      rootNodeRef,
      ContentModel.PROP_NODE_DBID
    );
  ...
  public void testGetParentAssocs() throws Exception {
    Map<QName, ChildAssociationRef> assocRefs = buildNodeGraph();
    ChildAssociationRef n3pn6Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n3_p_n6")
    );
    ChildAssociationRef n5pn7Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n5_p_n7")
    );
    ChildAssociationRef n6pn8Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n6_p_n8")
    );
    ChildAssociationRef n7n8Ref = assocRefs.get(
    ...
    ChildAssociationRef primaryParentAssocCheck = nodeService.getPrimaryParent(
      n8Ref
    );
    assertEquals(
      "Primary parent assoc not retrieved",
      n6pn8Ref,
      primaryParentAssocCheck
    );

    // check that the root node returns a null primary parent
    ChildAssociationRef rootNodePrimaryAssoc = nodeService.getPrimaryParent(
      rootNodeRef
    );
    assertNull(
      "Expected null primary parent for root node",
      rootNodePrimaryAssoc.getParentRef()
    );
    ...
    assertEquals(
      "Expected to get exactly one match",
      1,
      parentAssocRefsByQName.size()
    );
  ...
  public void testGetChildAssocs() throws Exception {
    ...
    NodeRef n1Ref = assocRefs
      .get(QName.createQName(BaseNodeServiceTest.NAMESPACE, "root_p_n1"))
      .getChildRef();
    ChildAssociationRef n1pn3Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_p_n3")
    );
    ChildAssociationRef n1n4Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_n4")
    );
    ChildAssociationRef n1n8Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n1_n8")
    );
    ...
    assertEquals(
      ...
      3,
      childAssocRefsByTypeQName.size()
    );
  ...
  public void testDuplicateChildAssocCleanup() throws Exception {
    ...
    List<ChildAssociationRef> dupAssocs = nodeService.getChildAssocs(
      n1pn3Ref.getParentRef(),
      n1pn3Ref.getTypeQName(),
      assocQName
    );
  ...
  public void testGetChildAssocsByChildType() throws Exception {
    ...
    assertEquals(
      "Incorrect number of cm:container children",
      2,
      childAssocRefsContainers.size()
    );
    assertTrue(
      "Expected assoc not found",
      childAssocRefsContainers.contains(n1pn3Ref)
    );
    assertTrue(
      "Expected assoc not found",
      childAssocRefsContainers.contains(n1n4Ref)
    );
    // Get N1's container children
    ...
    assertEquals(
      "Incorrect number of test:content children",
      1,
      childAssocRefsFiles.size()
    );
    assertTrue(
      "Expected assoc not found",
      childAssocRefsFiles.contains(n1n8Ref)
    );
  }
  ...
  public static class MovePolicyTester
    ...
    public List<ChildAssociationRef> policyAssocRefs = new ArrayList<ChildAssociationRef>(
      2
    );
  ...
  public void testMoveNode() throws Exception {
    Map<QName, ChildAssociationRef> assocRefs = buildNodeGraph();
    ChildAssociationRef n2pn4Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n2_p_n4")
    );
    ChildAssociationRef n5pn7Ref = assocRefs.get(
      QName.createQName(BaseNodeServiceTest.NAMESPACE, "n5_p_n7")
    );
  ...
  public void testCreateAndRemoveAssociation() throws Exception {
    ...
    assertEquals(
      "Assoc fetched by ID is incorrect.",
      anotherAssocRef,
      anotherAssocRefCheck
    );
  ...
  public void testGetTargetAssocsByPropertyValue() throws Exception {
    ...
    List<AssociationRef> targetAssocs = nodeService.getTargetAssocsByPropertyValue(
      sourceRef,
      qname,
      null,
      null
    ...
    try {
      Serializable title = (String) nodeService.getProperty(
        sourceRef,
  ...
  public void testGetSourceAssocs() throws Exception {
    ...
    List<AssociationRef> sourceAssocs = nodeService.getSourceAssocs(
      targetRef,
      qname
    );
  ...
  public void testGetPaths() throws Exception {
    ...
    assertEquals(
      "Root node path must have 1 element",
      rootPath.first(),
      rootPath.last()
    );
  ...
  public void testDefaultValues() throws Exception {
    ...
    assertEquals(
      NOT_DEFAULT_VALUE,
      this.nodeService.getProperty(nodeRef2, PROP_QNAME_PROP1)
    );
    ...
    assertEquals(
      NOT_DEFAULT_VALUE,
      this.nodeService.getProperty(nodeRef2, PROP_QNAME_PROP2)
    );
  }
  ...
  public void testDuplicateAssocsWithoutSuppliedName() throws Throwable {
    ...
    try {
      ...
      fail(
        "Re-added node to parent when cm:name was not set; it should have failed."
      );
    } catch (DuplicateChildNodeNameException e) {
      // Expected
    }
  ...
  public void testGetByName() throws Exception {
    ...
    NodeRef checkAbcRef = nodeService.getChildByName(
      parentRef,
      ASSOC_TYPE_QNAME_TEST_CONTAINS,
      "abc"
    );
    ...
    NodeRef checkDefRef = nodeService.getChildByName(
      checkAbcRef,
      ASSOC_TYPE_QNAME_TEST_CONTAINS,
      "def"
    );
    ...
    NodeRef checkHijRef = nodeService.getChildByName(
      checkAbcRef,
      ASSOC_TYPE_QNAME_TEST_CONTAINS,
      "hij"
    );
    assertNull(
      "Third level, named node 'HIJ' should not have been found",
      checkHijRef
    );

    // Now search for multiple names
    List<String> namesList = Arrays.asList("ABC", "DEF", "HIJ", "KLM");
    List<ChildAssociationRef> childAssocRefs = nodeService.getChildrenByName(
      checkAbcRef,
      ASSOC_TYPE_QNAME_TEST_CONTAINS,
      namesList
    );
    ...
    assertTrue(
      ...
      childAssocRefs.contains(pathDefRef)
    );
    assertTrue(
      "Expected result not included",
      childAssocRefs.contains(pathKlmRef)
    );
  }
  ...
  public void testAR1303() throws Exception {
    PolicyComponent policyComponent = (PolicyComponent) this.applicationContext.getBean(
        "policyComponent"
      );
    ...
    try {
      ...
      assertTrue(
        "The onUpdateProperties behaviour has not been fired.",
        behaviourExecuted
      );
    } finally {
  ...
  public void onUpdateProperties(
    ...
    assertFalse(
      ...
      String
        .valueOf(before.get(ContentModel.PROP_TITLE))
  ...
  public void testAR1414() throws Exception {
    ...
    blob.i = 100;
    // Get the property
    AR1414Blob checkBlob = (AR1414Blob) nodeService.getProperty(
      rootNodeRef,
      propertyQName
    );
  ...
  public void testGetNodeRefById() {
    Long nodeId = (Long) nodeService.getProperty(
      rootNodeRef,
      ContentModel.PROP_NODE_DBID
    );
    assertEquals(
      "Incorrect NodeRef back ",
      rootNodeRef,
      nodeService.getNodeRef(nodeId)
    );
  }
}
