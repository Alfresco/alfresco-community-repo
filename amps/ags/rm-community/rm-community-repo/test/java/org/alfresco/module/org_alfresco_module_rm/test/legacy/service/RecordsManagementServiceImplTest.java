    ...
    public void testIsFilePlan() throws Exception {
        doTestInTransaction(
                new Test<NodeRef>() {
                    ...
                    public NodeRef run() {
                        assertTrue(
                                "This is a records management root",
                                filePlanService.isFilePlan(filePlan));
                        assertFalse(
                                "This should not be a records management root",
                                filePlanService.isFilePlan(rmContainer));
                        assertFalse(
                                "This should not be a records management root",
                                filePlanService.isFilePlan(rmFolder));
    ...
    public void testIsRecordFolder() throws Exception {
        doTestInTransaction(
                new Test<NodeRef>() {
                    ...
                    public NodeRef run() {
                        assertFalse(
                                "This should not be a record folder",
                                recordFolderService.isRecordFolder(filePlan));
                        assertFalse(
                                "This should not be a record folder",
                                recordFolderService.isRecordFolder(rmContainer));
                        assertTrue(
                                "This should be a record folder",
                                recordFolderService.isRecordFolder(rmFolder));
