...
public class TestSiteContainers extends EnterpriseTestApi {
  ...
  public void testSiteContainers() throws Exception {
    ...
    List<SiteContainer> expectedSiteContainers = network1.getSiteContainers(
      site1.getSiteId(),
      person11
    );

    {
      ...
      ListResponse<SiteContainer> resp = sitesProxy.getSiteContainers(
        site1.getSiteId(),
...

    {
      ...
      SiteContainer expectedSiteContainer = new SiteContainer(
        site1.getSiteId(),
        "test2",
        null
      );
      SiteContainer sc = sitesProxy.getSingleSiteContainer(
        site1.getSiteId(),
        "test2"
      );
    ...
    // a user in the same network, not invited to the site
    {
      ...
      ListResponse<SiteContainer> ret = sitesProxy.getSiteContainers(
        site1.getSiteId(),
        createParams(paging, null)
      );
      checkList(
