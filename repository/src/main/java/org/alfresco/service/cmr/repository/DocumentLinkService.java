...
public interface DocumentLinkService {
     ...
     *
     * @param source Node to create a link for. Can be a file or a folder.
     * @param destination Destination to create the link in. Must be a folder.
     ...
     *
     * @param linkNodeRef The link node.
     ...
     *
     * @param document The destination of the links to be deleted.
     */
