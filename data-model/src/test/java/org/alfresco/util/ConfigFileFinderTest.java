...
/**
 * Test class created for MNT-21472 Space in Windows installation path for ACS 6.2 causes repeated
 * rendition exceptions in logs
 */
public class ConfigFileFinderTest extends TestCase {
    ...
    private static final String TEST_PATH_WITHOUT_SPACES =
            "org/alfresco/util/configfilefinder/folderwithoutspaces";
    private static final String TEST_PATH_WITH_SPACES =
            "org/alfresco/util/configfilefinder/folder with spaces";

    private final ObjectMapper jsonObjectMapper = new ObjectMapper();
    ConfigFileFinder fileFinder =
            new ConfigFileFinder(jsonObjectMapper) {
                @Override
                protected void readJson(JsonNode jsonNode, String readFromMessage, String baseUrl)
                        throws IOException {
