...
public class GetDeletedNodesTests extends RestTest {
  ...
  public void testDeletedNodesBiggerThanMaxCount() throws Exception {
    ...
    deleteNodesFolder1 =
      dataContent
        ...
        .usingSite(deleteNodesSiteModel)
        .createFolder();
    deleteNodesFolder2 =
      dataContent
        .usingUser(adminUserModel)
    ...
    dataContent
      .usingUser(adminUserModel)
      .usingResource(deleteNodesFolder1)
      .deleteContent();
    dataContent
      .usingUser(adminUserModel)
      .usingResource(deleteNodesFolder2)
      .deleteContent();
    dataContent
      .usingUser(adminUserModel)
      .usingResource(deleteNodesFolder3)
      .deleteContent();
    ...
    deletedNodesMaxItem =
      restClient
        .withCoreAPI()
        .usingTrashcan()
        .usingParams(String.format("maxItems=%s", maxItems))
        .findDeletedNodes();

    String countMaxItem = Integer.toString(maxItems);
    String totalItemsMaxItem = Integer.toString(totalItems + 3);
    String hasMoreItemsMaxItem = Boolean.toString(
      deletedNodesMaxItem.getPagination().isHasMoreItems()
    );
    String skipCount = Integer.toString(
      deletedNodesMaxItem.getPagination().getSkipCount()
    );
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TRASHCAN },
    executionType = ExecutionType.SANITY,
    description = "Sanity tests for GET /deleted-nodes and GET /deleted-nodes/{nodeId}"
  )
  ...
  public void testGetDeletedNodesFromTrashcan() throws Exception {
    ...
    dataContent
      .usingUser(adminUserModel)
      .usingResource(deleteNodesFolder4)
      .deleteContent();
    ...
    deletedNodes
      ...
      .and()
      .field("id")
      .is(file.getNodeRefWithoutVersion());
    deletedNodes
      .getEntryByIndex(1)
      .assertThat()
      .field("name")
      .is(deleteNodesFolder4.getName())
      .and()
      .field("id")
      .is(deleteNodesFolder4.getNodeRefWithoutVersion());
    ...
    node =
      restClient
        .withCoreAPI()
        .usingTrashcan()
        .findDeletedNode(deleteNodesFolder4);
    restClient.assertStatusCodeIs(HttpStatus.OK);
    node
      .assertThat()
      .field("name")
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TRASHCAN },
    executionType = ExecutionType.SANITY,
    description = "Sanity tests for DELETE /deleted-nodes/{nodeId} and POST /deleted-nodes/{nodeId}/restore"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TRASHCAN, TestGroup.SANITY })
  public void testDeleteAndRestoreNodeFromTrashcan() throws Exception {
    ...
    deleteNodesFolder5 =
      dataContent
        ...
        .usingSite(deleteNodesSiteModel)
        .createFolder();
    String docLibNodeRef = dataContent
      .usingUser(adminUserModel)
      .usingSite(deleteNodesSiteModel)
      .getNodeRef();
    file1 =
    ...
    dataContent
      .usingUser(adminUserModel)
      .usingResource(deleteNodesFolder5)
      .deleteContent();
    ...
    node =
      restClient
        .withCoreAPI()
        .usingTrashcan()
        .restoreNodeFromTrashcan(deleteNodesFolder5);
    restClient.assertStatusCodeIs(HttpStatus.OK);
    node
      .assertThat()
      .field("id")
      .is(deleteNodesFolder5.getNodeRefWithoutVersion())
      .and()
      .field("parentId")
      .is(docLibNodeRef);
    ...
    restClient
      .withCoreAPI()
      .usingTrashcan()
      .findDeletedNode(deleteNodesFolder5);
    restClient.assertStatusCodeIs(HttpStatus.NOT_FOUND);
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.TRASHCAN },
    executionType = ExecutionType.SANITY,
    description = "Sanity tests for GET /deleted-nodes/{nodeId}/content"
  )
  @Test(groups = { TestGroup.REST_API, TestGroup.TRASHCAN, TestGroup.SANITY })
  ...
  @TestRail(
    section = {
      TestGroup.REST_API, TestGroup.TRASHCAN, TestGroup.REQUIRE_SOLR,
    },
    executionType = ExecutionType.SANITY,
  ...
  public void testGetDeletedNodesRenditions() throws Exception {
    ...
    nodeRenditionInfo =
      restClient
        ...
        .withCoreAPI()
        .usingTrashcan()
        .getDeletedNodeRendition(file3, "pdf");
    restClient.assertStatusCodeIs(HttpStatus.OK);
    nodeRenditionInfo
      .assertThat()
      .field("id")
    ...
    restClient
      ...
      .withCoreAPI()
      .usingTrashcan()
      .getDeletedNodeRenditionContent(file3, "pdf");
    restClient.assertStatusCodeIs(HttpStatus.OK);
    restClient.assertHeaderValueContains(
      "Content-Type",
  ...
  public void testGetDeletedNodesRenditionsandVerifyRangeRequestheader()
    throws Exception {
    ...
    Utility.sleep(
      ...
      () -> {
        ...
        restClient
          ...
          .withCoreAPI()
          .usingTrashcan()
          .getDeletedNodeRenditionContent(file4, "pdf");
