...
public class AuthorityServiceTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    authorityBridgeTableCache =
      (AuthorityBridgeTableAsynchronouslyRefreshedCache) ctx.getBean(
        "authorityBridgeTableCache"
      );
    ...
    // cleanup trashcan
    nodeArchiveService.purgeAllArchivedNodes(
  ...
  public void testMNT10533() throws Exception {
    ...
    policyComponent.bindClassBehaviour(
      ...
      new JavaBehaviour(new GroupBehaviour(), "beforeDeleteNode")
    );
    ...
    for (char illegalCharacter : illegalCharacters) {
      ...
      try {
        ...
        fail(
          ...
          groupName.charAt(groupName.indexOf(illegalCharacter))
        );
  ...
  public class GroupBehaviour
    ...
    public void beforeDeleteNode(NodeRef nodeRef) {
      ...
      System.out.println(
        "removing " + authorityService.getAuthorityNodeRef(name)
      );
    }
  }
  ...
  public void testZones() {
    ...
    assertEquals(
      0,
      pubAuthorityService.getAuthorityZones("GROUP_DEFAULT").size()
    );
    ...
    pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "NULL",
      "NULL",
      newZones
    ...
    assertEquals(
      0,
      pubAuthorityService.getAuthorityZones("GROUP_EMPTY").size()
    );
    ...
    assertEquals(
      3,
      pubAuthorityService.getAllAuthoritiesInZone("One", null).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getAllAuthoritiesInZone("Two", null).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getAllAuthoritiesInZone("Three", null).size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getAllAuthoritiesInZone("One", AuthorityType.GROUP)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getAllAuthoritiesInZone("Two", AuthorityType.GROUP)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getAllAuthoritiesInZone("Three", AuthorityType.GROUP)
        .size()
    );

    assertEquals(
      3,
      pubAuthorityService.getAllRootAuthoritiesInZone("One", null).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getAllRootAuthoritiesInZone("Two", null).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getAllRootAuthoritiesInZone("Three", null).size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getAllRootAuthoritiesInZone("One", AuthorityType.GROUP)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getAllRootAuthoritiesInZone("Two", AuthorityType.GROUP)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getAllRootAuthoritiesInZone("Three", AuthorityType.GROUP)
        .size()
    );
  ...
  public void testGroupWildcards() {
    ...
    Set<String> matches = pubAuthorityService.findAuthorities(
      AuthorityType.GROUP,
      null,
      false,
      "__*__a*",
    ...
    before = System.nanoTime();
    matches =
      pubAuthorityService.findAuthorities(
        AuthorityType.GROUP,
        null,
        false,
        "__*__aa*",
    ...
    for (String zone : zones) {
      if (zone != null) {
        ...
        after = System.nanoTime();
        System.out.println(
          "GROUP___a* in " + ((after - before) / 1000000000.0f)
        );
        ...
        after = System.nanoTime();
        System.out.println(
          "GROUP___aa* in " + ((after - before) / 1000000000.0f)
        );
        ...
        after = System.nanoTime();
        System.out.println(
          "GROUP___*aa in " + ((after - before) / 1000000000.0f)
        );
        assertEquals(size, matches.size());
        before = System.nanoTime();
        ...
        after = System.nanoTime();
        System.out.println(
          "GROUP___*a in " + ((after - before) / 1000000000.0f)
        );
        assertEquals(size * size, matches.size());
      }
    }
  ...
  public void testAdminUser() {
    ...
    assertEquals(
      ...
      8 + (SITE_CNT * 2),
      authorityService.getAuthorities().size()
    );
  }
  ...
  public void testAuthorities() {
    ...
    assertTrue(
      getAllAuthorities(AuthorityType.ADMIN)
        .contains(PermissionService.ADMINISTRATOR_AUTHORITY)
    );
    assertEquals(1, getAllAuthorities(AuthorityType.EVERYONE).size());
    assertTrue(
      getAllAuthorities(AuthorityType.EVERYONE)
        .contains(PermissionService.ALL_AUTHORITIES)
    );
  ...
  public void testCreateRootAuth() {
    ...
    assertEquals(
      ROOT_GRP_CNT,
      pubAuthorityService.getAllRootAuthorities(AuthorityType.GROUP).size()
    );
    ...
    assertEquals(
      0,
      pubAuthorityService.getAllRootAuthorities(AuthorityType.ROLE).size()
    );
  ...
  public void testCreateAuth() throws Exception {
    ...
    assertFalse(
      pubAuthorityService.authorityExists(
        pubAuthorityService.getName(AuthorityType.GROUP, "one")
      )
    );
    assertEquals(GRP_CNT, getAllAuthorities(AuthorityType.GROUP).size());
    assertEquals(
    ...
    List<String> duplicatedGroupAuthorities = getAuthorityByTypeAndShortName(
      dublicatedAuthorityType,
      dublicatedAuthorityShortName
    );
    ...
    pubAuthorityService.createAuthority(
      dublicatedAuthorityType,
      differentCasesAuthorityShofrName
    );

    // delete created authorities
    pubAuthorityService.deleteAuthority("GROUP_DUPLICATEDGROUP");
    pubAuthorityService.deleteAuthority(
      pubAuthorityService.getName(
        AuthorityType.GROUP,
        differentCasesAuthorityShofrName
      )
    );
    ...
    List<String> duplicatedAuthoritiesAfterDelete = getAuthorityByTypeAndShortName(
      dublicatedAuthorityType,
      dublicatedAuthorityShortName
    );
   ...
   */
  private List<String> getAuthorityByTypeAndShortName(
    AuthorityType type,
    String shortName
  ) {
    return pubAuthorityService
      .getAuthorities(
        type,
        null,
        shortName,
  ...
  private void checkAuthorityCollectionSize(
    int expected,
    List<String> actual,
    AuthorityType type
  ) {
  ...
  public void testCreateAuthTree() {
    ...
    checkAuthorityCollectionSize(
      3,
      getAllAuthorities(AuthorityType.USER),
      AuthorityType.USER
    );
    ...
    assertEquals(
      2,
      pubAuthorityService.getContainingAuthorities(null, "andy", false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainingAuthorities(null, "andy", false)
        .contains(auth5)
    );
    assertTrue(
      pubAuthorityService
    ...
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth5, false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainingAuthorities(null, auth5, false)
        .contains(auth2)
    );

    assertEquals(
      2,
      pubAuthorityService.getContainedAuthorities(null, auth2, false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth2, false)
        .contains(auth5)
    );
    assertTrue(
      pubAuthorityService
    ...
    assertEquals(
      1,
      pubAuthorityService.getContainedAuthorities(null, auth5, false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth5, false)
        .contains("andy")
    );
  ...
  public void testCreateAuthNet() {
    ...
    assertEquals(
      3,
      pubAuthorityService.getContainedAuthorities(null, auth1, false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth1, false)
        .contains(auth3)
    );
    assertTrue(
      pubAuthorityService
  ...
  public void testGetAuthorityNodeRef() {
    ...
    int rootCount = pubAuthorityService
    ...
    Set<String> root = pubAuthorityService.getAllRootAuthorities(
      AuthorityType.GROUP
    );
    assertTrue(
    ...
    assertTrue("Association from child to parent group not found", found);
  }
  ...
  public void test_AR_1510() {
    ...
    String auth1 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "one"
    );
    pubAuthorityService.addAuthority(auth1, "andy1");
    String auth2 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "two"
    );
    ...
    String auth3 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "three"
    );
    pubAuthorityService.addAuthority(auth2, auth3);
    pubAuthorityService.addAuthority(auth3, "andy3");
    String auth4 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "four"
    );
    ...
    String auth5 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "five"
    );
    ...
    String auth6 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "six"
    );
    ...
    assertEquals(
      2,
      pubAuthorityService.getContainedAuthorities(null, auth1, true).size()
    );
    assertEquals(
      11,
      pubAuthorityService.getContainedAuthorities(null, auth1, false).size()
    ...
    assertEquals(
      3,
      pubAuthorityService.getContainedAuthorities(null, auth2, true).size()
    );
    assertEquals(
      10,
      pubAuthorityService.getContainedAuthorities(null, auth2, false).size()
    ...
    assertEquals(
      3,
      pubAuthorityService.getContainedAuthorities(null, auth3, true).size()
    );
    assertEquals(
      8,
      pubAuthorityService.getContainedAuthorities(null, auth3, false).size()
    );
    assertEquals(
      3,
      pubAuthorityService.getContainedAuthorities(null, auth4, true).size()
    );
    assertEquals(
      4,
      pubAuthorityService.getContainedAuthorities(null, auth4, false).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getContainedAuthorities(null, auth5, true).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getContainedAuthorities(null, auth5, false).size()
    ...
    assertEquals(
      3,
      pubAuthorityService.getContainedAuthorities(null, auth6, true).size()
    );
    assertEquals(
      3,
      pubAuthorityService.getContainedAuthorities(null, auth6, false).size()
    );

    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy1", true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy1", false).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy2", true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy2", false).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy3", true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy3", false).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy4", true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy4", false).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy5", true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy5", false).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy6", true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainedAuthorities(null, "andy6", false).size()
    );

    assertEquals(
      1,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth1, true)
        .size()
    );
    assertEquals(
      5,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth1, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth2, true)
        .size()
    );
    assertEquals(
      4,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth2, false)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth3, true)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth3, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth4, true)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth4, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth5, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth5, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth6, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth6, false)
        .size()
    );
    ...
    assertEquals(
      1,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth1, true)
        .size()
    );
    assertEquals(
      6,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth1, false)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth2, true)
        .size()
    );
    assertEquals(
      6,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth2, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth3, true)
        .size()
    );
    assertEquals(
      5,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth3, false)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth4, true)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth4, false)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth5, true)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth5, false)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth6, true)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.USER, auth6, false)
        .size()
    );
    ...
    assertEquals(
      0,
      pubAuthorityService.getContainingAuthorities(null, auth1, true).size()
    );
    assertEquals(
      0,
      pubAuthorityService.getContainingAuthorities(null, auth1, false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth2, true).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth2, false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth3, true).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getContainingAuthorities(null, auth3, false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth4, true).size()
    );
    assertEquals(
      3,
      pubAuthorityService.getContainingAuthorities(null, auth4, false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth5, true).size()
    );
    assertEquals(
      4,
      pubAuthorityService.getContainingAuthorities(null, auth5, false).size()
    ...
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, auth6, true).size()
    );
    assertEquals(
      3,
      pubAuthorityService.getContainingAuthorities(null, auth6, false).size()
    );

    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth1, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth1, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth2, true)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth2, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth3, true)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth3, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth4, true)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth4, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth5, true)
        .size()
    );
    assertEquals(
      4,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth5, false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth6, true)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, auth6, false)
        .size()
    );
    ...
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth1, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth1, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth2, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth2, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth3, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth3, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth4, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth4, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth5, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth5, false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth6, true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, auth6, false)
        .size()
    );

    assertEquals(
      5,
      pubAuthorityService.getContainingAuthorities(null, "andy1", true).size()
    );
    assertEquals(
      6,
      pubAuthorityService.getContainingAuthorities(null, "andy1", false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "andy2", true).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getContainingAuthorities(null, "andy2", false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "andy3", true).size()
    );
    assertEquals(
      3,
      pubAuthorityService.getContainingAuthorities(null, "andy3", false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "andy4", true).size()
    );
    assertEquals(
      4,
      pubAuthorityService.getContainingAuthorities(null, "andy4", false).size()
    );
    assertEquals(
      2,
      pubAuthorityService.getContainingAuthorities(null, "andy5", true).size()
    );
    assertEquals(
      6,
      pubAuthorityService.getContainingAuthorities(null, "andy5", false).size()
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "andy6", true).size()
    );
    assertEquals(
      4,
      pubAuthorityService.getContainingAuthorities(null, "andy6", false).size()
    );

    assertEquals(
      5,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy1", true)
        .size()
    );
    assertEquals(
      6,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy1", false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy2", true)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy2", false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy3", true)
        .size()
    );
    assertEquals(
      3,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy3", false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy4", true)
        .size()
    );
    assertEquals(
      4,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy4", false)
        .size()
    );
    assertEquals(
      2,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy5", true)
        .size()
    );
    assertEquals(
      6,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy5", false)
        .size()
    );
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy6", true)
        .size()
    );
    assertEquals(
      4,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.GROUP, "andy6", false)
        .size()
    );
    ...
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy1", true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy1", false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy2", true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy2", false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy3", true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy3", false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy4", true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy4", false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy5", true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy5", false)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy6", true)
        .size()
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainingAuthorities(AuthorityType.USER, "andy6", false)
        .size()
    );
  }
  ...
  public void test_AR_1517__AND__AR_1411() {
    ...
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth1, true)
        .contains("1234")
    );
    assertEquals(
      1,
    ...
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth2, true)
        .contains("andy")
    );
    assertEquals(
      1,
    ...
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth3, true)
        .contains("Novalike")
    );
    assertEquals(
      1,
    ...
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth4, true)
        .contains("1andy")
    );
    assertEquals(
      1,
    ...
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth5, true)
        .contains("andy2")
    );
    assertEquals(
      1,
    ...
    assertTrue(
      pubAuthorityService
        .getContainedAuthorities(null, auth6, true)
        .contains("an3dy")
    );

    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "1234", false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainingAuthorities(null, "1234", false)
        .contains(auth1)
    );
    assertEquals(
      1,
    ...
    assertEquals(
      1,
      pubAuthorityService
        .getContainingAuthorities(null, "Novalike", false)
        .size()
    );
    assertTrue(
      pubAuthorityService
    ...
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "1andy", false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainingAuthorities(null, "1andy", false)
        .contains(auth4)
    );
    assertEquals(
      1,
    ...
    assertTrue(
      pubAuthorityService
        .getContainingAuthorities(null, "andy2", false)
        .contains(auth5)
    );
    assertEquals(
      1,
      pubAuthorityService.getContainingAuthorities(null, "an3dy", false).size()
    );
    assertTrue(
      pubAuthorityService
        .getContainingAuthorities(null, "an3dy", false)
        .contains(auth6)
    );
  }
  ...
  public void testGroupNameTokenisation() {
    ...
    String auth1234 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "1234"
    );
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, auth1234, false)
        .size()
    );
    String authC1 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "circle"
    );
    ...
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, authC1, false)
        .size()
    );
    String authC2 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "bigCircle"
    );
    ...
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, authC2, false)
        .size()
    );
    String authStuff = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "|<>?~@:}{+_)(*&^%$£!¬`,.#';][=-0987654321 1234556678 '"
    );
    ...
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, authStuff, false)
        .size()
    );
    String authSpace = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "  Circles     "
    );
    ...
    assertEquals(
      0,
      pubAuthorityService
        .getContainedAuthorities(AuthorityType.GROUP, authSpace, false)
        .size()
    );
  ...
  public void testAdminGroup() {
    personService.getPerson("andy");
    String adminGroup = pubAuthorityService.getName(
      AuthorityType.GROUP,
  ...
  public void testAuthorityDisplayNames() {
    String authOne = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "One"
    );
    ...
    assertEquals(
      pubAuthorityService.getAuthorityDisplayName(authOne),
      "Selfish Crocodile"
    );

    String authTwo = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "Two",
      "Lamp posts",
    ...
    assertEquals(
      pubAuthorityService.getAuthorityDisplayName(authTwo),
      "Lamp posts"
    );
    ...
    assertEquals(
      pubAuthorityService.getAuthorityDisplayName("GROUP_Loon"),
      "Loon"
    );
    assertEquals(
      pubAuthorityService.getAuthorityDisplayName("ROLE_Gibbon"),
      "Gibbon"
    );
    assertEquals(
      pubAuthorityService.getAuthorityDisplayName("Monkey"),
      "Monkey"
    );
  ...
  public void testGetAuthoritiesFilteringSorting() {
    ...
    try {
      result =
        pubAuthorityService
          .getAuthorities(null, null, null, false, true, pr)
          .getPage();
    ...
    int origGroupCnt = pubAuthorityService
      .getAuthorities(AuthorityType.GROUP, null, null, false, true, pr)
      .getPage()
      .size();
    int origRoleCnt = pubAuthorityService
      .getAuthorities(AuthorityType.ROLE, null, null, false, true, pr)
      .getPage()
      .size();
    int origZoneCnt = pubAuthorityService
      .getAuthorities(
        null,
    ...
    String G1 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      TEST_RUN + "aabbg"
    );
    String G2 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      TEST_RUN + "abg"
    );
    String G3 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      TEST_RUN + "bcg"
    );
    String G4 = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      TEST_RUN + "bbccg"
    );
    ...
    String R1 = pubAuthorityService.createAuthority(
      AuthorityType.ROLE,
      TEST_RUN + "aabbr"
    );
    String R2 = pubAuthorityService.createAuthority(
      AuthorityType.ROLE,
      TEST_RUN + "abr"
    );
    String R3 = pubAuthorityService.createAuthority(
      AuthorityType.ROLE,
      TEST_RUN + "bcr"
    );
    String R4 = pubAuthorityService.createAuthority(
      AuthorityType.ROLE,
      TEST_RUN + "bbccr"
    );
    ...
    result =
      pubAuthorityService
        .getAuthorities(AuthorityType.GROUP, null, "*", false, true, pr)
        .getPage();
    ...
    result =
      pubAuthorityService
        .getAuthorities(AuthorityType.ROLE, null, "*", false, true, pr)
        .getPage();
    ...
    result =
      pubAuthorityService
        .getAuthorities(AuthorityType.GROUP, null, TEST_RUN, true, true, pr)
        .getPage();
    assertEquals(4, result.size());
    ...
    result =
      pubAuthorityService
        .getAuthorities(AuthorityType.GROUP, null, TEST_RUN, true, false, pr)
        .getPage();
    assertEquals(4, result.size());
  ...
  public void testIncrementAuthorityCounts() {
    ...
    pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "authority_test_" + System.currentTimeMillis()
    );
    long groupCountAfter = pubAuthorityService.countGroups();
    assertEquals(
      "Count of groups must increment",
      (groupCountBefore + 1),
      groupCountAfter
    );
  }
  ...
  public void testMNT16991() {
    ...
    try {
      assertFalse(
        pubAuthorityService
          .getContainingAuthorities(AuthorityType.GROUP, "andy", false)
          .contains(GROUP_FULL_NAME)
      );
      assertFalse(
        pubAuthorityService
          .getContainingAuthorities(AuthorityType.GROUP, "Andy", false)
  ...
  public void testGetAuthoritiesForZone() {
    String role = pubAuthorityService.createAuthority(
      AuthorityType.ROLE,
      "one"
    );
    String group = pubAuthorityService.createAuthority(
      AuthorityType.GROUP,
      "group1"
    );
    ...
    PagingResults<String> authorities = authorityService.getAuthorities(
      null,
      AuthorityService.ZONE_APP_DEFAULT,
      "*",
      false,
    ...
    PagingResults<String> groups = authorityService.getAuthorities(
      AuthorityType.GROUP,
      AuthorityService.ZONE_APP_DEFAULT,
      "*",
      false,
  ...
  public void testAuthorityPolicies() {
    String testGroup = authorityService.createAuthority(
      AuthorityType.GROUP,
      "testGroup"
    );
    String testSubGroup = authorityService.createAuthority(
      AuthorityType.GROUP,
      "testSubGroup"
    );

    String anotherTestGroup = authorityService.createAuthority(
      AuthorityType.GROUP,
      "testGroup2"
    );
    ...
    OnAuthorityAddedToGroup onAuthorityAddedToGroup = createClassPolicy(
      OnAuthorityAddedToGroup.class,
      OnAuthorityAddedToGroup.QNAME,
      ContentModel.TYPE_AUTHORITY
    );

    authorityService.addAuthority(testGroup, testUser);

    verify(onAuthorityAddedToGroup)
      .onAuthorityAddedToGroup(testGroup, testUser);

    //test that OnAuthorityAddedToGroup is invoked when an user is removed from a group
    OnAuthorityRemovedFromGroup onAuthorityRemovedFromGroup = createClassPolicy(
      OnAuthorityRemovedFromGroup.class,
      OnAuthorityRemovedFromGroup.QNAME,
      ContentModel.TYPE_AUTHORITY
    );

    authorityService.removeAuthority(testGroup, testUser);

    verify(onAuthorityRemovedFromGroup)
      .onAuthorityRemovedFromGroup(testGroup, testUser);
    ...
    verify(onAuthorityAddedToGroup)
      .onAuthorityAddedToGroup(testGroup, testSubGroup);

    //test that OnGroupDeleted is invoked when a group is deleted without the cascade flag
    OnGroupDeleted onGroupDeleted = createClassPolicy(
      OnGroupDeleted.class,
      OnGroupDeleted.QNAME,
      ContentModel.TYPE_AUTHORITY
    );
  ...
  public void testGetDoublePrefixedGroupAuth() {
    ...
    authorityDAO.createAuthority(
      "GROUP_" + oldPrefixedGroupName,
      "GROUP_MNT_17824_DISPLAY_NAME",
      defaultZones
    );

    // Now check that this group can be retrieved
    String auth = pubAuthorityService.getName(
      AuthorityType.GROUP,
      oldPrefixedGroupName
    );
    createdAuthNames.add(auth);
    assertTrue(
      "The group authority exists.",
      pubAuthorityService.authorityExists(auth)
    );
  ...
  public void testNonAdminCannotUpdateAuthorityNodes() {
    ...
    try {
      ...
      fail(
        "a non-admin user should not be allowed to update properties on nodes of type ContentModel.TYPE_AUTHORITY"
      );
  ...
  public void testIfGroupIsAdminAuthority() {
    ...
    assertFalse(
      pubAuthorityService.isAdminAuthority(
        pubAuthorityService.getName(AuthorityType.GROUP, parentGroup)
      )
    );
    assertFalse(
      pubAuthorityService.isAdminAuthority(
    ...
    pubAuthorityService.addAuthority(
      pubAuthorityService.getName(AuthorityType.GROUP, parentGroup),
      pubAuthorityService.getName(AuthorityType.GROUP, subGroup1)
    );
    assertFalse(
    ...
    assertFalse(
      pubAuthorityService.isAdminAuthority(
        pubAuthorityService.getName(AuthorityType.GROUP, username)
      )
    );
  ...
  public void testAdminHasSysAdminAuthority() {
    ...
    assertTrue(authorityService.hasAdminAuthority());
    assertTrue(
      "By default, Admin should be member of Alfresco_System_Administrators group.",
  ...
  public void testSysAdminGroup() {
    ...
    String adminGroup = authorityService.getName(
      AuthorityType.GROUP,
      "ALFRESCO_ADMINISTRATORS"
    );
    ...
    authenticationComponent.setCurrentUser("andy");
    assertFalse(
      "Andy hasn't been added to the Alfresco_System_Administrators group yet.",
      pubAuthorityService.hasSysAdminAuthority()
    );
    ...
    authenticationComponent.setCurrentUser("andy");
    assertTrue(
      "Andy is a member of the Alfresco_System_Administrators group",
      pubAuthorityService.hasSysAdminAuthority()
    );
    ...
    pubAuthorityService.removeAuthority(
      GROUP_ALFRESCO_SYSTEM_ADMINISTRATORS_AUTHORITY,
      "andy"
    );
    ...
    authenticationComponent.setCurrentUser("andy");
    assertFalse(
      "Andy has been removed from the Alfresco_System_Administrators group.",
      pubAuthorityService.hasSysAdminAuthority()
    );
  }
