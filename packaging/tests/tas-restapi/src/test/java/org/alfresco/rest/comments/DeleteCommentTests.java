...
public class DeleteCommentTests extends RestTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user can't delete comments created by admin user and status"
                            + " code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user can't delete comments with inexistent ID and status code is"
                            + " 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Admin user can't delete comments with inexistend NodeId and status code"
                            + " is 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Manager user deletes comment created by admin"
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Collaborator user can delete comment created by self"
                            + " and status code is 204. Check with getComments for validation")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user deletes comment created by self"
                            + " and status code is 204. Check with getComments for validation")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    @Bug(id = "ACE-4614")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user cannot delete comment created by admin and status code is"
                            + " 403. Check with getComments for validation and check default error"
                            + " model schema.")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Manager user cannot delete comment with invalid node "
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify deleteComment from node with invalid network id returns status code"
                            + " 401")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify deleteComment from node with empty network id returns status code 401")
    @Test(groups = {TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION})
