...
public class RecordFolderTests extends BaseRMRestTest {
    ...
    public void checkRecordFolderDetails() {
        ...
        RecordCategoryChild recordCategoryChild =
                createRecordFolder(rootCategory.getId(), RECORD_FOLDER_NAME);

        // Get the folder including extra information
        RecordFolder recordFolder =
                getRestAPIFactory()
                        .getRecordFolderAPI()
                        .getRecordFolder(recordCategoryChild.getId(), "include=" + IS_CLOSED);
    ...
    @Test(
            description =
                    "Update the details for other nodes than record folder with the request used"
                            + " for record-folders ",
    ...
    /**
     * Given that a record folder exists When the record folder is closed Then a request can be made
     * to reopen it
     */
    ...
    public void openClosedRecordFolder() {
        ...
        RecordFolder updatedRecordFolder =
                recordFolderAPI.updateRecordFolder(recordFolderModel, recordFolder.getId());
        ...
        recordFolderModel =
                RecordFolder.builder()
                        .properties(RecordFolderProperties.builder().isClosed(false).build())
                        .build();
    ...
    /**
     * Given a container that is a record folder When I try to list the records from the record
     * folder Then I receive a list of all the records contained within the record folder
     */
    @Test
    public void listRecordsFromRecordFolder() {
        ...
        RecordFolderCollection apiChildren =
                        ...
                        c -> {
                            ...
                            try {
                                ...
                                assertTrue(
                                        ...
                                        "Record Name"
                                                + createdComponent.getName()
                                                + " doesn't contain the record identifier in"
