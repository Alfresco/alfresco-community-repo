...
public interface TransferService2
{
     ...
     * @param definition
     *            - the definition of the transfer. Specifies which nodes to transfer. The following properties must be set, nodes
     * @param callback
    ...
    /**
     * Transfer nodes async with callback. The asynchronous version of the transfer method starts a transfer and returns as soon as possible.
     * 
     * The transfer callbacks will be called by a different thread to that used to call the transferAsync method so transaction context will be different to the calling context. The asychronous transfer does not have access to uncommitted data in the calling transaction.
     * 
     * @param targetName
     *            the name of the target to transfer to
     * @param definition
     ...
     * 
     * @param name
     *            the name of this transfer target, which must be unique
     * @param title
     *            the display name of this transfer target
     * @param description
     *            String
     ...
     * 
     * The following properties may be updated: endpointHost, endpointPort, endpointProtocol, endpointPath, username, password, title, description
     * 
     * The following properties may not be updated: name, must be specified. nodeRef, if specified will be ignored.
     * 
     * @param update
     *            TransferTarget
     */
     ...
     * 
     * Depending upon the state of the in-progress transfer, the transfer may still complete, despite calling this method, however in most cases the transfer will not complete.
     * 
     * Calling this method for a transfer that does not exist, possibly because it has already finished, has no effect and will not throw an exception.
     * 
     * The transfer identifier can be obtained from the TransferEventBegin event that is passed to registered callbacks when transfer starts.
     * 
     * @param transferId
