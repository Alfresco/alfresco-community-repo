...
/**
 * Service to process email messages. The incoming messages are treated as content that need to be
 * created or modified. The target node can be the address of the node:
 *
 * <pre>
...
public interface EmailService {
    /**
     * Processes an email message. The message's content is intended for a node found by examining
     * the email's target address.
     *
     * @param delivery instructions - who gets the message and who is it from
     * @param message the email message
     * @throws org.alfresco.service.cmr.email.EmailMessageException if the message is rejected for
     *     <b>any</b> reason
     */
