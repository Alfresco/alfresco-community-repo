...
/**
 * DictionaryNamespaceComponent and DictionaryComponent mostly delegate to other methods. This test
 * is really about exercising all of the public endpoints.
 *
 * @author Gethin James
 */
public class DictionaryComponentTest extends AbstractModelTest {
    ...
    public void testDCGetters() throws Exception {
        ...
        assertEquals(
                dataTypeDefinition,
                dc.getDataType(Class.forName(dataTypeDefinition.getJavaClassName())));
    }
