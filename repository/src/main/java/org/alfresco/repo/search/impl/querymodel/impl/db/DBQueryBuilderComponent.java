...
/**
 * Build the commands required to generate the dynamic SQL This is independent of the data base
 * schema.
 *
 * @author Andy
 */
public interface DBQueryBuilderComponent {
    ...
    /**
     * Use the dictionary to expand any terms, deal with multi-valued properties, etc Use the
     * QNameDAO to look up any ids
     *
    ...
    /**
     * Build the Set of required joins Assign join aliases and link them up to each component where
     * required
     */
