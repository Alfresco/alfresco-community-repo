...
public class SiteMembersRelation
     ...
     *
     * <p>If siteId does not exist, throws NotFoundException (status 404).
     *
     * <p>(non-Javadoc)
     *
     * @see
     *     org.alfresco.rest.framework.resource.actions.interfaces.EntityResourceAction.Read#readAll(org.alfresco.rest.framework.resource.parameters.Parameters)
     */
    @Override
     ...
     *
     * <p>Adds personId as a member of site siteId.
     *
     * <p>If personId does not exist throws NotFoundException (status 404). If siteMember. does not
     * exist throws NotFoundException (status 404).
     *
     * @see
     *     org.alfresco.rest.framework.resource.actions.interfaces.RelationshipResourceAction.Create#create(String,
     *     java.util.List, org.alfresco.rest.framework.resource.parameters.Parameters)
     */
    @Override
    @WebApiDescription(title = "Adds personId as a member of site siteId.")
    public List<SiteMember> create(
            String siteId, List<SiteMember> siteMembers, Parameters parameters) {
     ...
     *
     * <p>Removes personId as a member of site siteId.
     */
    @Override
     ...
     *
     * <p>Updates the membership of personId in the site (of which personId must be an existing
     * member).
     */
    @Override
    @WebApiDescription(
            title =
                    "Updates the membership of personId in the site (of which personId must be an"
                            + " existing member).")
     ...
     *
     * <p>GET sites/<siteId>/members/<personId>
     */
    @Override
