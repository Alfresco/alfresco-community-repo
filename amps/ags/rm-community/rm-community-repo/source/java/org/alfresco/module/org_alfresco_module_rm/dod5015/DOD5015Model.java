...
public interface DOD5015Model {
  ...
  QName PROP_ORIGINATING_ORGANIZATION = QName.createQName(
    DOD_URI,
  ...
  QName PROP_SCANNED_FORMAT_VERSION = QName.createQName(
    DOD_URI,
    "scannedFormatVersion"
  );
  ...
  QName PROP_PRODUCING_APPLICATION = QName.createQName(
    DOD_URI,
    "producingApplication"
  );
  QName PROP_PRODUCING_APPLICATION_VERSION = QName.createQName(
    DOD_URI,
    "producingApplicationVersion"
  );
  QName PROP_PDF_VERSION = QName.createQName(DOD_URI, "pdfVersion");
  QName PROP_CREATING_APPLICATION = QName.createQName(
    DOD_URI,
    "creatingApplication"
  );
  QName PROP_DOCUMENT_SECURITY_SETTINGS = QName.createQName(
    DOD_URI,
    "documentSecuritySettings"
  );

  // Digital Photograph Record
  QName ASPECT_DIGITAL_PHOTOGRAPH_RECORD = QName.createQName(
    DOD_URI,
  ...
  QName PROP_CONTENT_MANAGEMENT_SYSTEM = QName.createQName(
    DOD_URI,
