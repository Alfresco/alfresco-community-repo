...
public class HttpClientHelperTest extends TestCase {
  ...
  public void testHTTPProxySettings() {
    ...
    ProxyHost proxyHost = HttpClientHelper.createProxyHost(
      "http.proxyHost",
      "http.proxyPort",
      DEFAULT_HTTP_PORT
    );
    UsernamePasswordCredentials proxyCredentials = (UsernamePasswordCredentials) HttpClientHelper.createProxyCredentials(
      "http.proxyUser",
      "http.proxyPassword"
    );
    ...
    proxyCredentials =
      (UsernamePasswordCredentials) HttpClientHelper.createProxyCredentials(
        "http.proxyUser",
        "http.proxyPassword"
      );
