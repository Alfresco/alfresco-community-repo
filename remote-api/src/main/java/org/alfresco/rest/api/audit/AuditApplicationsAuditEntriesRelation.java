...
public class AuditApplicationsAuditEntriesRelation
    ...
    public AuditEntry readById(String auditAppId, String auditEntryId, Parameters parameters)
    ...
    public void delete(String auditAppId, String auditEntryId, Parameters parameters)
            throws RelationshipResourceNotFoundException {
    ...
    @Override
    @WebApiDescription(
            title = "Delete collection/set of audit entries for audit app id - based on params")
    public void deleteSet(String auditAppId, Parameters parameters)
            throws RelationshipResourceNotFoundException {
