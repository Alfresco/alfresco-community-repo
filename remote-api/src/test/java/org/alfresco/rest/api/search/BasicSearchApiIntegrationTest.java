...
public class BasicSearchApiIntegrationTest
  ...
  private static final String json =
    "{ \"query\": {\"query\": \"cm:name:king\",\"userQuery\": \"great\",\"language\": \"afts\"}, \"fields\" : [\"id\",\"name\", \"search\"]}";
  private static final String bad_json =
    "{ \"query\": {\"qu\": \"cm:some nonsense \",\"userQuery\": \"great\",\"language\": \"afts\"}}";
  ...
  public void testQuery() throws Exception {
    ...
    try {
      ...
      ExpectedPaging paging = RestApiUtil.parsePaging(
        response.getJsonResponse()
      );
