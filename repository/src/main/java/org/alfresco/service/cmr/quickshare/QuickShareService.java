 ...
 *
 * <p>Responsible for creating, updating and retrieving Quick share metadata,
 *
...
public interface QuickShareService {
     ...
     * @return QuickDTO with details of the share
     */
    QuickShareDTO shareContent(NodeRef nodeRef, Date expiryDate)
            throws QuickShareDisabledException, InvalidNodeRefException;
    ...
    public Map<String, Object> getMetaData(String shareId)
            throws QuickShareDisabledException, InvalidSharedIdException;
     ...
     * related schedule {@link org.alfresco.service.cmr.action.scheduled.ScheduledPersistedAction}
     * from the repository.
     *
