...
public class TransactionAwareSingleton<T> extends TransactionListenerAdapter {
  ...
  private Map<String, Object> tenantSingletonValue = new HashMap<String, Object>(
    1
  ); // tenant-aware
  ...
  public T get() {
    ...
    TransactionStorage storage = (TransactionStorage) AlfrescoTransactionSupport.getResource(
      txnKey
    );
    if (storage != null) {
