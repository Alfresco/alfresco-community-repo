...
public class ValueConverter {
  ...
  public Serializable convertValueForScript(
    ...
    if (value == null) {
      ...
      value =
        new ChildAssociation(services, (ChildAssociationRef) value, scope);
      ...
      try {
        ...
        value =
          (Serializable) Context.getCurrentContext().newArray(scope, array);
      } finally {
        Context.exit();
      }
    }
      ...
      if (value instanceof IdScriptableObject) {
        ...
        if (TYPE_DATE.equals(((IdScriptableObject) value).getClassName())) {
          ...
          if (isArray(propIds) == true) {
            ...
            Map<Object, Object> propValues = new HashMap<Object, Object>(
              propIds.length
            );
            for (Object propId : propIds) {
              ...
              propValues.put(
                convertValueForJava(propId),
                convertValueForJava(val)
              );
            }
