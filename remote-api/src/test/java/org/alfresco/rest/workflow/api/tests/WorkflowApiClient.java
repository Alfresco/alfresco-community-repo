...
public class WorkflowApiClient extends PublicApiClient {
  ...
  public static final DateFormat DATE_FORMAT_ISO8601 = new SimpleDateFormat(
  ...
  public class DeploymentsClient extends AbstractProxy {
    ...
    public ListResponse<Deployment> getDeployments(Map<String, String> params)
      ...
      HttpResponse response = getAll(
        ...
        null,
        params,
        "Failed to get deploymentsClient"
      );
      return DeploymentParser.INSTANCE.parseList(response.getJsonResponse());
    }

    public JSONObject getDeploymentsWithRawResponse(Map<String, String> params)
      throws PublicApiException {
      HttpResponse response = getAll(
        "deployments",
        null,
    ...
    public Deployment findDeploymentById(String deploymentId)
      throws PublicApiException {
  ...
  public class ProcessDefinitionsClient extends AbstractProxy {
    ...
    public ListResponse<ProcessDefinition> getProcessDefinitions(
      ...
      HttpResponse response = getAll(
        ...
        null,
        params,
        "Failed to get process definitions"
      );
      return ProcessDefinitionParser.INSTANCE.parseList(
        response.getJsonResponse()
      );
    }

    public JSONObject getProcessDefinitionsWithRawResponse(
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
        "process-definitions",
    ...
    public ProcessDefinition findProcessDefinitionById(
      ...
      HttpResponse response = getSingle(
        ...
        null,
        null,
        "Failed to get process definition"
      );
      JSONObject entry = (JSONObject) response.getJsonResponse().get("entry");
      return ProcessDefinitionParser.INSTANCE.parseEntry(entry);
    }

    public HttpResponse findImageById(String processDefinitionId)
      throws PublicApiException {
      return getSingle(
        "process-definitions",
        processDefinitionId,
    ...
    public JSONObject findStartFormModel(String processDefinitionId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "process-definitions",
        processDefinitionId,
  ...
  public class ProcessesClient extends AbstractProxy {
    ...
    public ProcessInfo createProcess(String body) throws PublicApiException {
      HttpResponse response = create(
        ...
        null,
        body,
        "Failed to start new process instance"
      );
      return ProcessesParser.INSTANCE.parseEntry(
        (JSONObject) response.getJsonResponse().get("entry")
      );
    }

    public ListResponse<ProcessInfo> getProcesses(Map<String, String> params)
      throws PublicApiException {
      HttpResponse response = getAll(
        "processes",
        null,
        ...
        null,
        params,
        "Failed to get process instances"
      );
      return ProcessesParser.INSTANCE.parseList(response.getJsonResponse());
    }

    public JSONObject getProcessesJSON(Map<String, String> params)
      throws PublicApiException {
      HttpResponse response = getAll(
        "processes",
        null,
    ...
    public ProcessInfo findProcessById(String processInstanceId)
      throws PublicApiException {
      HttpResponse response = getSingle(
        "processes",
        processInstanceId,
        null,
        null,
        "Failed to find process instance by id"
      );
      JSONObject entry = (JSONObject) response.getJsonResponse().get("entry");
    ...
    public JSONObject getTasks(
      ...
      HttpResponse response = getAll(
        ...
        null,
        params,
        "Failed to get task instances of processInstanceId " + processInstanceId
      );
      JSONObject list = (JSONObject) response.getJsonResponse().get("list");
      return list;
    }
    ...
    public JSONObject getActivities(
      ...
      HttpResponse response = getAll(
        ...
        null,
        params,
        "Failed to get activity instances of processInstanceId " +
        processInstanceId
      );
      JSONObject list = (JSONObject) response.getJsonResponse().get("list");
      return list;
    ...
    public HttpResponse getImage(String processInstanceId)
      throws PublicApiException {
      HttpResponse response = getSingle(
        "processes",
        processInstanceId,
        "image",
        null,
        "Failed to get image of processInstanceId " + processInstanceId
      );
      return response;
    }

    public JSONObject findProcessItems(String processInstanceId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "processes",
        processInstanceId,
    ...
    public JSONObject getProcessvariables(String processInstanceId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "processes",
        processInstanceId,
    ...
    public JSONObject createVariables(String processId, JSONArray variables)
      throws PublicApiException {
      HttpResponse response = create(
        "processes",
        processId,
    ...
    public JSONObject updateVariable(
      String processId,
      String variableName,
      JSONObject variable
    ) throws PublicApiException {
    ...
    public void addProcessItem(String processId, String body)
      throws PublicApiException {
    ...
    public JSONObject findProcessItem(String processInstanceId, String itemId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "processes",
        processInstanceId,
  ...
  public class TasksClient extends AbstractProxy {
    ...
    public JSONObject findTasks(Map<String, String> params)
      throws PublicApiException {
      HttpResponse response = getAll(
        "tasks",
        null,
    ...
    public JSONObject findTaskCandidates(String taskId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "tasks",
        taskId,
        ...
        null,
        null,
        "Failed to get task candidates"
      );
      return response.getJsonResponse();
    }

    public JSONObject findTaskVariables(
      String taskId,
      Map<String, String> params
    ) throws PublicApiException {
      HttpResponse response = getAll(
        ...
        null,
        params,
        "Failed to get task variables"
      );
      return response.getJsonResponse();
    }

    public JSONObject findTaskVariables(String taskId)
      throws PublicApiException {
      return findTaskVariables(taskId, null);
    }

    public JSONObject createTaskVariables(String taskId, JSONArray variables)
      throws PublicApiException {
      HttpResponse response = create(
        "tasks",
        taskId,
        ...
        null,
        variables.toJSONString(),
        "Failed to create task variables"
      );
      return response.getJsonResponse();
    }

    public JSONObject updateTaskVariable(
      String taskId,
      String variableName,
      JSONObject variable
    ) throws PublicApiException {
      HttpResponse response = update(
        ...
        variableName,
        variable.toJSONString(),
        "Failed to update task variable"
      );
      return response.getJsonResponse();
    }
    ...
    public void deleteTaskVariable(String taskId, String variableName)
      ...
      remove(
        ...
        "variables",
        variableName,
        "Failed to delete task variable"
      );
    }

    public JSONObject findTaskFormModel(String taskId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "tasks",
        taskId,
    ...
    public JSONObject addTaskItem(String taskId, String body)
      throws PublicApiException {
      HttpResponse response = create(
        "tasks",
        taskId,
    ...
    public JSONObject findTaskItem(String taskId, String itemId)
      throws PublicApiException {
      HttpResponse response = getAll(
        "tasks",
        taskId,
