 ...
 *
 * <p>The firstNamePattern is used when seed = 0. Then a random element is added and
 * randomNamePattern is used.
 */
public class NameBasedUserNameGenerator implements UserNameGenerator {
    ...
    /**
     * The pattern of the user name to generate e.g. %lastName%_%firstName% would generate
     * Fred_Bloggs
     *
     * <p>Patterns available: %lastName%, lower case last name %firstName%, lower case first name
     * %emailAddress% email address %i% lower case first name inital
     *
    ...
    public String generateUserName(
        ...
        if (seed > 0) {
            if (userName.length() < userNameLength + 3) {
                ...
                userName =
                        userName.substring(0, userNameLength - 3)
