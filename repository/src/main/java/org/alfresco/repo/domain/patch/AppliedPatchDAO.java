...
public interface AppliedPatchDAO
{
     ...
     * 
     * @param from
     *            the lower date limit or null to ignore
     * @param to
     *            the upper date limit or null to ignore
     * @return Returns applied patches for the date range, but also patches without a date
     */
