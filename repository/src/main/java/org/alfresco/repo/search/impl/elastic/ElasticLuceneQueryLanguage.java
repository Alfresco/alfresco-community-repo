...
public class ElasticLuceneQueryLanguage extends AbstractLuceneQueryLanguage
{
    ...
    private ElasticQueryHttpClient elasticQueryHttpClient;
    

    @Override
    public ResultSet executeQuery(SearchParameters searchParameters)
    {
        return elasticQueryHttpClient.executeQuery(searchParameters, getName());
    }


    public void setElasticQueryHttpClient(ElasticQueryHttpClient elasticQueryHttpClient)
    {
        this.elasticQueryHttpClient = elasticQueryHttpClient;
    }
