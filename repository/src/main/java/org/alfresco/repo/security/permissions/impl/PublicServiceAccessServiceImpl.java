...
public class PublicServiceAccessServiceImpl
  implements PublicServiceAccessService, BeanFactoryAware {

  private ListableBeanFactory beanFactory;

  public AccessStatus hasAccess(
    ...
    if (interceptor == null) {
      throw new UnsupportedOperationException(
        "Unknown public service security implementation " + publicService
      );
    }
    ...
    if (interceptor instanceof MethodSecurityInterceptor) {
      ...
      NEXT_METHOD:for (Method method : publicServiceImpl
        .getClass()
        .getMethods()) {
              ...
              if (args[parameterPosition] == null) {
                ...
                if (clazz.isPrimitive()) {
                  if (clazz.getName().equals("boolean")) {
                    if (
                      args[parameterPosition].getClass()
                        .getName()
                  ...
                  !(clazz.isAssignableFrom(args[parameterPosition].getClass()))
                ) {
                  continue NEXT_METHOD;
                }
              }
      ...
      if (methodInvocation == null) {
        throw new UnsupportedOperationException(
          "Unknown public service security implementation " +
          publicService +
          "." +
          methodName +
          " with arguments " +
    ...
    throw new UnsupportedOperationException(
      "Unknown security interceptor " + interceptor.getClass()
    );
  }
