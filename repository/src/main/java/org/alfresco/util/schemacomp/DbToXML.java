...
public class DbToXML {
  ...
  public void execute() {
    ...
    SchemaToXML schemaToXML = new SchemaToXML(
      schema,
  ...
  private void writeToFile(String content) {
    PrintWriter pw = printWriter(
      outputFile,
      SchemaComparator.CHAR_SET,
      SchemaComparator.LINE_SEPARATOR
    );
  ...
  private static PrintWriter printWriter(
    ...
    synchronized (props) {
      ...
      try {
        oldLineSep =
          (String) props.setProperty("line.separator", lineSeparator);
  ...
  public static void main(String[] args) {
    if (args.length != 2) {
      ...
      System.err.println(
        "java " + DbToXML.class.getName() + " <context.xml> <output.xml>"
      );
      System.exit(1);
    }
