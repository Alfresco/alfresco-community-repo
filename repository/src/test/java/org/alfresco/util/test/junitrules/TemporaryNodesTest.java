...
public class TemporaryNodesTest {
    ...
    public static void initStaticData() throws Exception {
        ...
        NODE_SERVICE =
                APP_CONTEXT_INIT.getApplicationContext().getBean("NodeService", NodeService.class);
        SITE_SERVICE =
                APP_CONTEXT_INIT.getApplicationContext().getBean("SiteService", SiteService.class);
        TRANSACTION_HELPER =
                APP_CONTEXT_INIT
                        .getApplicationContext()
    ...
    public void createTestContent() {
        ...
        testNode1 =
                testNodes.createNode(
                        COMPANY_HOME, "doc 1", ContentModel.TYPE_CONTENT, TEST_USER1.getUsername());
        testNode2 =
                ...
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        ContentReader reader =
                                CONTENT_SERVICE.getReader(testNode1, ContentModel.PROP_CONTENT);
    ...
    public void ensureCheckedOutNodesAreCleanedUp() throws Throwable {
        // Note that because we need to test that the Rule's 'after' behaviour has worked correctly,
        // we cannot
        // use the Rule that has been declared in the normal way - otherwise nothing would be
        // cleaned up until
    ...
    /**
     * This test ensures that any temporary nodes which are versioned, have all their various
     * versions cleaned up too.
     *
     * @since 4.1.7
     */
    @Test
    public void ensureVersionedNodesAreFullyCleanedUp() throws Throwable {
        ...
        final NodeRef versionedTempNode =
                myTemporaryNodes.createQuickFile(
                    ...
                    public Void execute() throws Throwable {
                        if (NODE_SERVICE.exists(siteNodeRef)) {
                            fail(
                                    "Node '"
                                            + NODE_SERVICE.getProperty(
                                                    siteNodeRef, ContentModel.PROP_NAME)
                                            + "' still exists.");
                        }
                        return null;
                    }
    ...
    public void testCreateFolderAndQuickFiles() throws Throwable {
        ...
        final NodeRef folder =
                myTemporaryNodes.createFolder(
                        COMPANY_HOME, "testFolder", AuthenticationUtil.getAdminUserName());

        // create a normal 'quick' node under it.
        final NodeRef quickTxt =
                myTemporaryNodes.createQuickFile(
                        MimetypeMap.MIMETYPE_TEXT_PLAIN,
                        folder,
                        "quickFile",
        ...
        final NodeRef namedQuickTxt =
                myTemporaryNodes.createQuickFileByName(
                        "quickCorrupt.jpg", folder, AuthenticationUtil.getAdminUserName());
        ...
        TRANSACTION_HELPER.doInTransaction(
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        assertEquals(
                                ContentModel.TYPE_CONTENT, NODE_SERVICE.getType(namedQuickTxt));
                        ...
                        ContentReader reader =
                                CONTENT_SERVICE.getReader(quickTxt, ContentModel.PROP_CONTENT);
                        ...
                        ContentReader reader2 =
                                CONTENT_SERVICE.getReader(namedQuickTxt, ContentModel.PROP_CONTENT);
