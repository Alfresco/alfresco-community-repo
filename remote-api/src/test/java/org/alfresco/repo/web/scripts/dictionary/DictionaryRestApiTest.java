...
public class DictionaryRestApiTest extends BaseWebScriptTest {
  ...
  private void validateChildAssociation(JSONObject result) throws Exception {
    ...
    assertEquals(
      ...
      result.getJSONObject("source").get("class")
    );
    ...
    assertTrue(
      result.get("url").toString().indexOf("/association/cm_member") > 0
    );
  }
  ...
  private void validateAssociation(JSONObject result) throws Exception {
    ...
    assertEquals(
      "/api/classes/cm_checkedOut/association/cm_workingcopylink",
      result.get("url")
    );
  }
  ...
  private void validateAssociationDef(JSONObject result) throws Exception {
    ...
    assertEquals(
      "/api/classes/cm_person/association/cm_avatar",
      result.get("url")
    );
  }
  ...
  private void validateTypeClass(JSONObject result) throws Exception {
    ...
    assertEquals(
      "/api/classes/cm_cmobject/property/sys_referenceable",
      result
        .getJSONObject("defaultAspects")
        .getJSONObject("sys:referenceable")
        .get("url")
    ...
    assertEquals(
      "/api/classes/cm_cmobject/property/cm_auditable",
      result
        .getJSONObject("defaultAspects")
        .getJSONObject("cm:auditable")
        .get("url")
  ...
  private void validateAspectClass(JSONObject result) throws Exception {
    ...
    if (result.getJSONObject("properties").has("cm:automaticUpdate") == true) {
      ...
      assertEquals(
        "/api/classes/cm_thumbnailed/property/cm_automaticUpdate",
        result
          .getJSONObject("properties")
          .getJSONObject("cm:automaticUpdate")
          .get("url")
  ...
  public void testGetPropertyDef() throws Exception {
    Response response = sendRequest(
      new GetRequest("/api/classes/cm_auditable/property/cm_created"),
      200
    );
    ...
    response =
      sendRequest(
        new GetRequest("/api/classes/cm_hi/property/cm_welcome"),
        404
      );
    ...
    response =
      sendRequest(
        new GetRequest("/api/classes/cm_auditable/property/cm_welcome"),
        200
      );
  ...
  public void testGetAssociationDef() throws Exception {
    GetRequest req = new GetRequest(
      URL_SITES + "/cm_person/association/cm_avatar"
    );
    Response response = sendRequest(req, 200);
    JSONObject result = new JSONObject(response.getContentAsString());
    assertEquals(200, response.getStatus());
    ...
    response =
      sendRequest(
        new GetRequest(URL_SITES + "/cm_personalbe/association/cms_avatarsara"),
        404
      );
    assertEquals(404, response.getStatus());
    ...
    response =
      sendRequest(
        new GetRequest(URL_SITES + "/cm_person/association/cm_atari"),
        200
      );
  ...
  public void testGetAssociationDefs() throws Exception {
    ...
    GetRequest req = new GetRequest(
      URL_SITES + "/cm_authorityContainer/associations"
    );
    Map<String, String> arguments = new HashMap<String, String>();
    ...
    response =
      sendRequest(
        new GetRequest(URL_SITES + "/cmsa_personalbe/associations"),
        404
      );
    assertEquals(404, response.getStatus());
