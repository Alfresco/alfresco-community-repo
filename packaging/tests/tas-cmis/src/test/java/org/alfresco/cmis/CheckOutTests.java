...
public class CheckOutTests extends CmisTest {
    ...
    public void dataPreparation() throws Exception {
        ...
        usersWithRoles =
                dataUser.addUsersWithRolesToSite(
                        testSite, UserRole.SiteContributor, UserRole.SiteConsumer);
    }
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp =
                    "^Check out failed.*This node is already checked out.$")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify private working copy does NOT exists for a document that was deleted")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that contributor user can NOT check out document created by manager")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that unauthorized user can NOT check out document from private site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that unauthorized user can NOT check out document from moderated site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
