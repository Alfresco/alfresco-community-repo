...
public class TransactionInvocationHandlerFactory {
  ...
  private static final String EXECUTED_KEY =
    TransactionHandler.class.getName() + ".executed";
   ...
   */
  public <P extends Policy> InvocationHandler createHandler(
    Behaviour behaviour,
   ...
   */
  private class TransactionHandler<P extends Policy>
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
      ...
      if (
        behaviour
          ...
          .equals(NotificationFrequency.FIRST_EVENT)
      ) {
        Map<ExecutionInstanceKey, Object> executedBehaviours = (Map<ExecutionInstanceKey, Object>) AlfrescoTransactionSupport.getResource(
          EXECUTED_KEY
        );
        ...
        ExecutionInstanceKey key = new ExecutionInstanceKey(
          behaviour,
        ...
        behaviour
          .getNotificationFrequency()
          .equals(NotificationFrequency.TRANSACTION_COMMIT)
      ) {
