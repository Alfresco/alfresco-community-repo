...
public class WebDAVonContentUpdateTest {
  ...
  public void setUp() throws Exception {
    ...
    InputStream davLockInfoIS = getClass()
      .getClassLoader()
      .getResourceAsStream(DAV_LOCK_INFO_XML);
   ...
   */
  @Test
  public void testUploadNewContentFiresContentUpdatePolicies()
    throws Exception {
    flag = false;
    counter = 0;
    ...
    assertEquals(
      "onContentUpdate policies should be triggered only once",
      counter,
      1
    );
