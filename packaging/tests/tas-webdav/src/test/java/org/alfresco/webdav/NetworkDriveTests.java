...
public class NetworkDriveTests extends WebDavTest {
  ...
  @Test(
    groups = {
      TestGroup.PROTOCOLS, TestGroup.WEBDAV, TestGroup.FULL, TestGroup.OS_WIN,
    }
  )
  @TestRail(
  ...
  public void siteManagerCanCreateFolderWithSpacesInNameOnMappedDrive()
    throws Exception {
  ...
  public void siteManagerCannotCreateFolderTwiceOnMappedDrive()
    throws Exception {
    folderModel = FolderModel.getRandomFolderModel();
  ...
  public void siteManagerCanCreateFolderInFolderOnMappedDrive()
    throws Exception {
    FolderModel parentFolder = dataContent
  ...
  public void siteManagerCanCreateFolderWithNamePrefixedByDotOnMappedDrive()
    throws Exception {
  ...
  public void siteManagerCanCreateFileWithContentOnMappedDrive()
    throws Exception {
  ...
  public void siteManagerCanCopyFileOnMappedDrive() throws Exception {
    ...
    copiedFile.setCmisLocation(
      fileModel
        .getCmisLocation()
        .replace(fileModel.getName(), copiedFile.getName())
    );
  ...
  public void siteManagerCanMoveFileOnMappedDrive() throws Exception {
    ...
    movedFile.setCmisLocation(
      fileModel
        .getCmisLocation()
        .replace(fileModel.getName(), movedFile.getName())
    );
  ...
  public void siteManagerCanMoveFolderOnMappedDrive() throws Exception {
    ...
    fileModel =
      dataContent
        ...
        .usingResource(folderModel)
        .createContent(FileModel.getRandomFileModel(FileType.TEXT_PLAIN));
    FolderModel moveFolder = dataContent
      .usingUser(siteManager)
      .usingSite(testSite)
      .createFolder();
  ...
  public void siteManagerCannotUpdateFileContentForADeletedFileOnMappedDrive()
    throws Exception {
    fileModel =
      dataContent
        .usingUser(siteManager)
  ...
  public void verifyFileVersionIsIncrementedAfterEditOnMappedDrive()
    throws Exception {
    fileModel =
      dataContent
        .usingUser(siteManager)
