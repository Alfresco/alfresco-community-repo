        ...
        try {
            ...
            workflowTask =
                    workflowService.updateTask(
                            taskId, parseTaskProperties(json, workflowTask), null, null);
                ...
                if (jsonValue.equals(JSONObject.NULL)) {
                    ...
                    if (prop != null) {
                        ...
                        if (jsonValue instanceof JSONArray) {
                            ...
                            // If the JSON returns an Object which is not a String, we use that
                            // type.
                            ...
                            if (jsonValue instanceof String) {
                                ...
                                if (existingValue != null) {
                                    try {
                                        value =
                                                DefaultTypeConverter.INSTANCE.convert(
                                                        existingValue.getClass(), jsonValue);
