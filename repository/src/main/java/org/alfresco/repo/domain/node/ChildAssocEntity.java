...
public class ChildAssocEntity implements Serializable {
    ...
    /**
     * Apply the <b>cm:name</b> to the child association. If the child name is <tt>null</tt> then a
     * GUID is generated as a substitute.
     *
     * <p>Unknown associations or associations that do not require unique name checking will use a
     * GUID for the child name and the CRC value used <b>will be negative</b>.
     *
     * @param childName the <b>cm:name</b> applying to the association.
     */
    public static Pair<String, Long> getChildNameUnique(
            DictionaryService dictionaryService, QName assocTypeQName, String childName) {
        if (childName == null) {
    ...
    public ChildAssociationRef getRef(QNameDAO qnameDAO) {
        ...
        QName qname =
                QName.createQName(
                        qnameDAO.getNamespace(qnameNamespaceId).getSecond(), qnameLocalName);
    ...
    /**
     * Helper method to set all values associated with the {@link #setChildNodeName(String) child
     * node name}.
     *
     * @param dictionaryService the service that determines how the CRC values are generated. If
     *     this is <tt>null</tt> then the CRC values are generated assuming that positive
     *     enforcement of the name constraint is required.
     * @param childNodeName the child node name
     */
    public void setChildNodeNameAll(
        ...
        if (dictionaryService != null) {
            ...
            Pair<String, Long> childNameUnique =
                    ChildAssocEntity.getChildNameUnique(
                            dictionaryService, typeQName, childNodeName);
