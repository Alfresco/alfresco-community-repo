...
public interface ModelValidator {
     ...
     *
     * <p>if new model then nothing to validate
     *
     * <p>else if an existing model then could be updated (or unchanged) so validate to currently
     * only allow incremental updates - addition of new types, aspects (except default aspects),
     * properties, associations - no deletion of types, aspects or properties or associations - no
     * addition, update or deletion of default/mandatory aspects
     *
