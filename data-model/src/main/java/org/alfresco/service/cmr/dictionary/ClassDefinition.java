...
public interface ClassDefinition {
    ...
    /**
     * @return Return <code>true</code> if the type should be archived on delete, <code>false</code>
     *     if it should be deleted or <code>null</code> if not defined.
     */
    public Boolean getArchive();

    /**
     * @return Return <code>true</code> if the type should be included in supertypes queries, <code>
     *     false</code> if not deleted or <code>null</code> if not defined.
     */
     ...
     *
     * @return all child associations applicable to this type, including those inherited from super
     *     types
     */
