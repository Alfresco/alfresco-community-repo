...
public class NotificationServiceImplSystemTest extends BaseAlfrescoTestCase
{
    ...
    /**
     * This {@link NotificationProvider} is intended for use in test code in order to validate the content/state of notifications. It could, for example, be used in a test context as a drop-in replacement for the {@link EMailNotificationProvider} for validation and/or to prevent emails being sent from test code.
     * 
