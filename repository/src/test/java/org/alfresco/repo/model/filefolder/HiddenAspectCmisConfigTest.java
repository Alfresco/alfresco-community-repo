...
public class HiddenAspectCmisConfigTest extends HiddenAspectTest {
    ...
    private void switchCmisHiddenConfig() {
        for (HiddenFileInfo hiddenFileInfo : hiddenAspect.getPatterns()) {
            if (FILENAME_LEADING_DOT_PATTERN.equals(hiddenFileInfo.getFilter())
                    && hiddenFileInfo instanceof ConfigurableHiddenFileInfo) {
                ConfigurableHiddenFileInfo configurableHiddenFileInfo =
                        (ConfigurableHiddenFileInfo) hiddenFileInfo;
                configurableHiddenFileInfo.setCmisDisableHideConfig(
                        !configurableHiddenFileInfo.isCmisDisableHideConfig());
