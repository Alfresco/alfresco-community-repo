...
/**
 * Thrown when an operation cannot be performed because the<b>child association</b> reference no
 * longer exists.
 *
 * @author Derek Hulley
 */
public class InvalidChildAssociationRefException extends RuntimeException {
    ...
    public InvalidChildAssociationRefException(
            String msg, ChildAssociationRef childAssociationRef) {
        super(msg);
