...
public class DataSetRestApiTest extends BaseRMWebScriptTestCase {
    ...
    /**
     * Test the REST API to retrieve details of available RM data sets and to import an RM data set
     * into a file plan
     *
     * @throws IOException
    ...
    public void testGetPostDataSetAction() throws IOException, JSONException {
        ...
        //            Response response = sendRequest(new PostRequest(url, new
        // JSONObject().toString(), APPLICATION_JSON), Status.STATUS_OK);
        //
        //            // Check the content from the response
        ...
        //            response = sendRequest(new PostRequest(url, new JSONObject().toString(),
        // APPLICATION_JSON), Status.STATUS_OK);
        //
        //            // Check the content from the response
