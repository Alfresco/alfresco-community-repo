...
/**
 * Helper class that will look up or create transactional resources. This shortcuts some of the
 * "<i>if not existing, then create</i>" code.
 *
 * @author Derek Hulley
 * @since 3.2
 */
public abstract class TransactionalResourceHelper {
    ...
    /**
     * Reset the current count value for a named key. After this operation, the effective value will
     * be 0.
     *
     * @param resourceKey the key to count against
     */
     ...
     * This method allows quick conditional checking of the key without building a new collection.
     *
    ...
    /**
     * Support method to retrieve or create and bind a <tt>ArrayList</tt> to the current
     * transaction.
     *
