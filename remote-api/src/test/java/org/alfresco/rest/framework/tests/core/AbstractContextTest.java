...
public abstract class AbstractContextTest {
  ...
  static Params NOT_USED = Params.valueOf(
    "notUsed",
    null,
    mock(WebScriptRequest.class)
  );
  static final Params.RecognizedParams NULL_PARAMS = new Params.RecognizedParams(
    null,
    null,
    null,
    null,
  ...
  static final WithResponse callBack = new WithResponse(
    Status.STATUS_OK,
  ...
  public void setUp() throws Exception {
    ...
    AbstractResourceWebScript executor = (AbstractResourceWebScript) applicationContext.getBean(
      "executorOfGets"
    );
    AbstractResourceWebScript postExecutor = (AbstractResourceWebScript) applicationContext.getBean(
      "executorOfPost"
    );
    AbstractResourceWebScript putExecutor = (AbstractResourceWebScript) applicationContext.getBean(
      "executorOfPut"
    );
    AbstractResourceWebScript deleteExecutor = (AbstractResourceWebScript) applicationContext.getBean(
      "executorOfDelete"
    );
