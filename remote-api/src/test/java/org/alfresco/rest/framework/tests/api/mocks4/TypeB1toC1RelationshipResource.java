 ...
 *
 * <p>note: with entityResource = TypeA1toB1RelationshipResource (rather than just
 * TypeBEntityResource)
 *
 * @author janv
 */
@RelationshipResource(
        name = "relation-b1-c1",
        entityResource = TypeA1toB1RelationshipResource.class,
        title = "Relation Type B1 to Type C1")
public class TypeB1toC1RelationshipResource implements RelationshipResourceAction.ReadById<TypeC1> {
    ...
    @Override
    public TypeC1 readById(
            String typeBEntityResourceId, String typeCEntityResourceId, Parameters parameters) {
