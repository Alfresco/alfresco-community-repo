...
/**
 * This command processor is used simply to check that the transfer receiver is enabled and that the
 * supplied credentials are correct and identify an admin user.
 *
 * @author brian
 */
public class TestCredentialsCommandProcessor implements CommandProcessor {
    ...
    public int process(WebScriptRequest req, WebScriptResponse resp) {
        // Since all the checks that are needed are actually carried out by the transfer web script,
        // this processor
