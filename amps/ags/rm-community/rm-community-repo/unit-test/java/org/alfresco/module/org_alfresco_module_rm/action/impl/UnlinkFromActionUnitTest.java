...
public class UnlinkFromActionUnitTest extends BaseActionUnitTest {
  ...
  public void nodeDoesNotExist() {
    ...
    verify(mockedRecordService, never())
      .unlink(any(NodeRef.class), any(NodeRef.class));
  }
  ...
  public void nodePendingDelete() {
    ...
    doReturn(true)
      ...
      .hasAspect(record, ASPECT_PENDING_DELETE);
    action.executeImpl(mock(Action.class), record);
    verify(mockedRecordService, never())
      .unlink(any(NodeRef.class), any(NodeRef.class));
  }
  ...
  public void nodeNotRecord() {
    ...
    doReturn(false)
      .when(mockedNodeService)
      .hasAspect(notRecord, ASPECT_PENDING_DELETE);
  ...
  public void validUnlink() {
    ...
    mockActionParameterValue(
      UnlinkFromAction.PARAM_RECORD_FOLDER,
