...
public interface BlogIntegrationModel {
  ...
  static final QName ASPECT_BLOG_DETAILS = QName.createQName(
    MODEL_URL,
    "blogDetails"
  );
  static final QName PROP_BLOG_IMPLEMENTATION = QName.createQName(
    MODEL_URL,
    "blogImplementation"
  );
  ...
  static final QName ASPECT_BLOG_POST = QName.createQName(
    MODEL_URL,
    "blogPost"
  );
  ...
  static final QName PROP_LAST_UPDATE = QName.createQName(
    MODEL_URL,
    "lastUpdate"
  );
  static final QName ASSOC_BLOG_DETAILS = QName.createQName(
    MODEL_URL,
    "blogDetails"
  );
}
