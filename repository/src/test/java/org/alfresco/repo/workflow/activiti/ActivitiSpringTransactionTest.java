...
public class ActivitiSpringTransactionTest extends TestCase {
        ...
        RetryingTransactionCallback<Void> callback =
                new RetryingTransactionCallback<Void>() {
                    public Void execute() throws Throwable {
                        ...
                        assertNotNull(
                                "Can't read process instance in same transaction!", instanceInDb);
                        RetryingTransactionCallback<Void> callbackInner =
                                new RetryingTransactionCallback<Void>() {
                                    public Void execute() throws Throwable {
                                        ProcessInstance instanceInDb = findProcessInstance(id);
                                        assertNull(
                                                "Should not be able to read process instance in"
                                                        + " inner transaction!",
                                                instanceInDb);
                                        return null;
                                    }
    ...
    private ProcessInstance findProcessInstance(String instanceId) {
        return runtime.createProcessInstanceQuery().processInstanceId(instanceId).singleResult();
    }
    ...
    protected void setUp() throws Exception {
        ...
        ServiceRegistry serviceRegistry =
                (ServiceRegistry) appContext.getBean(ServiceRegistry.SERVICE_REGISTRY);
