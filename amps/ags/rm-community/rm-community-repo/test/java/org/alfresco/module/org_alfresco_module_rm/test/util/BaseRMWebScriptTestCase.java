...
public class BaseRMWebScriptTestCase extends BaseWebScriptTest {
  ...
  protected void initServices() {
    ...
    rmSearchService =
      (RecordsManagementSearchService) applicationContext.getBean(
    ...
    filePlanPermissionService =
      (FilePlanPermissionService) applicationContext.getBean(
        "FilePlanPermissionService"
      );
    auditService =
    ...
    vitalRecordService =
      (VitalRecordService) applicationContext.getBean("VitalRecordService");
    filePlanService =
  ...
  protected void setupTestDataImpl() {
    ...
    recordSeries =
      filePlanService.createRecordCategory(filePlan, "recordSeries");
    assertNotNull(
      "Could not create record category with no disposition schedule",
      recordSeries
    );

    recordCategory =
      filePlanService.createRecordCategory(recordSeries, "rmContainer");
    ...
    // Create RM folder
    recordFolder =
      recordFolderService.createRecordFolder(recordCategory, "rmFolder");
    assertNotNull("Could not create rm folder", recordFolder);
    recordFolder2 =
      recordFolderService.createRecordFolder(recordCategory, "rmFolder2");
