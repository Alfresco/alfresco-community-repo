...
/**
 * A delegating implementation of the {@link TransferProgressMonitor} interface that keeps a record
 * of the nodes that have been changed during the course of processing an incoming transfer. Used by
 * the {@link RepoTransferReceiverImpl}.
 *
 * @author Brian
 * @since 3.4
 */
/*package*/ final class ChangeCapturingProgressMonitor implements TransferProgressMonitor {
    ...
    private final TreeMap<String, TransferChangesRecord> changeRecords =
            new TreeMap<String, TransferChangesRecord>();
    ...
    public void logDeleted(
            String transferId, NodeRef sourceNode, NodeRef destNode, String parentPath) {
    ...
    public void updateProgress(String transferId, int currPos, int endPos)
