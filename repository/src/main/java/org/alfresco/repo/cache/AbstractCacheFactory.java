...
/**
 * Abstract {@link CacheFactory} implementation containing common functionality such as cache
...
public abstract class AbstractCacheFactory<K extends Serializable, V>
    ...
    /**
     * Provide properties to parameterize cache creation. Cache properties are prefixed with the
     * cacheName supplied when invoking {@link DefaultCacheFactory#createCache(String)}. For
     * example, for a cache named cache.ticketsCache the property cache.ticketsCache.maxItems will
