 ...
 */
// $ANTLR 3.5.2
// W:\\alfresco\\HEAD-BUG-FIX\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS_FTS.g 2015-06-18 19:37:58
...
public class CMIS_FTSParser extends Parser {
    ...
    public String getGrammarFileName() {
        return "W:\\alfresco\\HEAD-BUG-FIX\\r"
                + "oot\\projects\\data-model\\source\\java\\org\\alfresco\\r"
                + "epo\\search\\impl\\parsers\\CMIS_FTS.g";
    }
    ...
    public final CMIS_FTSParser.cmisFtsQuery_return cmisFtsQuery() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_ftsCmisDisjunction =
                new RewriteRuleSubtreeStream(adaptor, "rule ftsCmisDisjunction");
    ...
    public final CMIS_FTSParser.ftsCmisDisjunction_return ftsCmisDisjunction()
            throws RecognitionException {
        CMIS_FTSParser.ftsCmisDisjunction_return retval =
                new CMIS_FTSParser.ftsCmisDisjunction_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleSubtreeStream stream_ftsCmisConjunction =
                new RewriteRuleSubtreeStream(adaptor, "rule ftsCmisConjunction");
    ...
    public final CMIS_FTSParser.ftsCmisConjunction_return ftsCmisConjunction()
            throws RecognitionException {
        CMIS_FTSParser.ftsCmisConjunction_return retval =
                new CMIS_FTSParser.ftsCmisConjunction_return();
        retval.start = input.LT(1);
        ...
        RewriteRuleSubtreeStream stream_ftsCmisPrefixed =
                new RewriteRuleSubtreeStream(adaptor, "rule ftsCmisPrefixed");
    ...
    public final CMIS_FTSParser.ftsCmisPrefixed_return ftsCmisPrefixed()
        ...
        RewriteRuleSubtreeStream stream_cmisTest =
                new RewriteRuleSubtreeStream(adaptor, "rule cmisTest");
    ...
    public final CMIS_FTSParser.cmisTest_return cmisTest() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_cmisPhrase =
                new RewriteRuleSubtreeStream(adaptor, "rule cmisPhrase");
        RewriteRuleSubtreeStream stream_cmisTerm =
                new RewriteRuleSubtreeStream(adaptor, "rule cmisTerm");
    ...
    public final CMIS_FTSParser.cmisTerm_return cmisTerm() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_FTSWORD =
                new RewriteRuleTokenStream(adaptor, "token FTSWORD");
    ...
    public final CMIS_FTSParser.cmisPhrase_return cmisPhrase() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_FTSPHRASE =
                new RewriteRuleTokenStream(adaptor, "token FTSPHRASE");
    ...
    public static final BitSet FOLLOW_ftsCmisDisjunction_in_cmisFtsQuery194 =
            new BitSet(new long[] {0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_cmisFtsQuery196 =
            new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_ftsCmisConjunction_in_ftsCmisDisjunction252 =
            new BitSet(new long[] {0x0000000000002002L});
    public static final BitSet FOLLOW_or_in_ftsCmisDisjunction255 =
            new BitSet(new long[] {0x0000000000001300L});
    public static final BitSet FOLLOW_ftsCmisConjunction_in_ftsCmisDisjunction257 =
            new BitSet(new long[] {0x0000000000002002L});
    public static final BitSet FOLLOW_ftsCmisPrefixed_in_ftsCmisConjunction341 =
            new BitSet(new long[] {0x0000000000001302L});
    public static final BitSet FOLLOW_cmisTest_in_ftsCmisPrefixed424 =
            new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_MINUS_in_ftsCmisPrefixed484 =
            new BitSet(new long[] {0x0000000000000300L});
    public static final BitSet FOLLOW_cmisTest_in_ftsCmisPrefixed486 =
            new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_cmisTerm_in_cmisTest567 =
            new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_cmisPhrase_in_cmisTest627 =
            new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_FTSWORD_in_cmisTerm717 =
            new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_FTSPHRASE_in_cmisPhrase770 =
            new BitSet(new long[] {0x0000000000000002L});
