...
public class SchemaComparatorTest {
    ...
    /**
     * Tests index of primary key validation, problem found when comparing DB2 schemas (now EOLed)
     * which has system generated indexes for primary keys, but might still be useful as a test.
     */
    @Test
