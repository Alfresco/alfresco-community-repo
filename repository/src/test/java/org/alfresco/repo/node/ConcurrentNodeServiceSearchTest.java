...
public class ConcurrentNodeServiceSearchTest extends TestCase {
  ...
  public static final QName PROP_QNAME_TEST_MIMETYPE = QName.createQName(
    NAMESPACE,
    "mimetype"
  );
  ...
  public void testConcurrent() throws Exception {
    ...
    SearchService searcher = (SearchService) ctx.getBean(
      ServiceRegistry.SEARCH_SERVICE.getLocalName()
    );
