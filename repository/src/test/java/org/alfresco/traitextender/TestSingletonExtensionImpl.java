...
public class TestSingletonExtensionImpl extends SingletonExtension<TestExtension, TestTrait>
    ...
    public String privateServiceMethod1(String s) {
        return getTrait().traitImplOf_privateServiceMethod1(s)
    ...
    public String publicServiceMethod2(String s) {
        return getTrait().traitImplOf_publicServiceMethod2(s)
    ...
    public String publicServiceMethod3(String s) {
        return getTrait().publicServiceMethod3(s)
