...
/**
 * Set of tests that ensure Slingshot GET APIs are run successfully in a read-only transaction (ALF-10179).
 * 
 * Some webscripts have a side effect of creating a "container" these tests are to ensure this is handled gracefully in a way that allows the main transaction to be declared as readonly for performance reasons.
 * 
