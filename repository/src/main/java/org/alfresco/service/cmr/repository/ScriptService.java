 ...
 * Script Service.
 *
 * <p>Provides an interface to services for executing a JavaScript engine script file against a Java
 * object based scripting data-model.
 *
 * <p>The script file can either be in the repository (passed as NodeRef string) or on the
 * classpath. Also a script String can be passed directly to the service via the
 * executeScriptString() methods. Java objects are passed into the scripting engine and methods can
 * be accessed directly from the script.
 *
 * <p>A script is executed within a single transaction, any modifications to nodes or properties
 * that fail and cause a rollback which will rollback all repository modifications made by the
 * script.
 *
 * @author Kevin Roast
 */
public interface ScriptService {
     ...
     *
     * <p>Uses the most approparite script engine or the default if none found.
     *
     ...
     * @param contentProp QName of the property on the node that contains the content, null can be
     *     passed to indicate the default property of 'cm:content'
     * @param model Object model to process script against
     * @return output of the script (may be null or any valid wrapped JavaScript object)
     * @throws ScriptException
     */
    ...
    public Object executeScript(
            String engine, NodeRef scriptRef, QName contentProp, Map<String, Object> model)
            throws ScriptException;
    ...
    public Object executeScript(
            String engine, ScriptLocation scriptLocation, Map<String, Object> model)
            throws ScriptException;
     ...
     *
     * <p>'companyhome' - the Company Home node<br>
