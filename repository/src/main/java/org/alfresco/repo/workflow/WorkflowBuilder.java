...
/**
 * A helper class used to start workflows. The builder is a stateful object that accumulates the
 * various parameters and package items used to start the workflow. The workflow is started when the
