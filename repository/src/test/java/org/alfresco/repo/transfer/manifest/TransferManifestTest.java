...
public class TransferManifestTest extends TestCase {
  ...
  public void testCreateAndReadSnapshot() throws Exception {
     ...
     */
    properties.put(
      QName.createQName("{gsxhjsx}", "cm:created"),
      new java.util.Date()
    );
     ...
     */
    properties.put(
      QName.createQName("{gsxhjsx}", "trx:enabled"),
      Boolean.FALSE
    );
     ...
     */
    properties.put(
      QName.createQName("{gsxhjsx}", "trx:password"),
     ...
     */
    properties.put(
      QName.createQName("{gsxhjsx}", "trx:nodeRef"),
    ...
    ChildAssociationRef primaryParent = new ChildAssociationRef(
      QName.createQName("{gsxhjsx}", "cm:contains"),
      new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "P1"),
    ...
    parents.add(
      new ChildAssociationRef(
        QName.createQName("{gsxhjsx}", "app:wibble"),
        new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "P1"),
    ...
    values.add("green");
    properties.put(
      QName.createQName("{gsxhjsx}", "xyz:colours"),
      (Serializable) values
    );

    ContentData contentHeader = new ContentData(
      "http://wibble",
      "mimeType",
      123,
      "utf-8",
    ...
    targetAssocs.add(
      new AssociationRef(
        null,
        new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "SA"),
        QName.createQName("{gsxhjsx}", "app:super"),
    ...
    sourceAssocs.add(
      new AssociationRef(
        null,
        new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "HH"),
        QName.createQName("{gsxhjsx}", "app:super"),
    ...
    node2.setNodeRef(
      new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "456")
    );
    ...
    node3.setNodeRef(
      new NodeRef(StoreRef.STORE_REF_ARCHIVE_SPACESSTORE, "567")
    );

    ChildAssociationRef origPrimaryParent = new ChildAssociationRef(
      QName.createQName("{gsxhjsx}", "cm:contains"),
      new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, "P1"),
    ...
    BufferedReader reader = new BufferedReader(
      new InputStreamReader(new FileInputStream(snapshotFile), "UTF-8")
    );
    ...
    TransferManifestNormalNode rxNodeA = (TransferManifestNormalNode) nodes.get(
      nodeRefA
    );
    ...
    System.out.println(
      rxNodeAProps.get(QName.createQName("{gsxhjsx}", "trx:password"))
    );
