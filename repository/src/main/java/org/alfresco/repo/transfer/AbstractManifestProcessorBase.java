...
public abstract class AbstractManifestProcessorBase
  ...
  private static final Log log = LogFactory.getLog(
    AbstractManifestProcessorBase.class
  );
  ...
  public AbstractManifestProcessorBase(
  ...
  public final void endTransferManifest() {
    receiver
      .getProgressMonitor()
      .updateProgress(transferId, this.targetEndProgress);
    try {
      endManifest();
    } catch (Throwable ex) {
  ...
  public final void processTransferManifestNode(
  ...
  public final void processTransferManifiestHeader(
  ...
  protected ChildAssociationRef getTemporaryLocation(NodeRef nodeRef) {
    ...
    QName parentAssocName = QName.createQName(
  ...
  private void handleException(TransferManifestNode node, Throwable ex) {
    try {
      ...
      log.warn(
        "Failed to mark transaction as rollback-only in response to an error",
        e
      );
    }
    ...
    try {
      ...
      //Nothing really to be done here
      log.warn(
        "Failed to record exception in transfer log due to an exception",
        t
      );
    }
  ...
  private void callLocalExceptionHandler(
    ...
    try {
      ...
      //Nothing really to be done here
      log.warn(
        "Caught and discarded exception thrown from custom exception handler",
        t
      );
    }
  }
  ...
  protected void logDeleted(
    ...
    receiver
      .getProgressMonitor()
      .logDeleted(transferId, sourceNode, destNode, parentPath);
  }
  ...
  protected void logUpdated(
    ...
    receiver
      .getProgressMonitor()
      .logUpdated(transferId, sourceNode, destNode, newPath);
  }
  ...
  public void setTransferSummaryReport(
  ...
  protected void logSummaryDeleted(
    NodeRef sourceNode,
    NodeRef destNode,
    String parentPath
  ) {
  ...
  protected void logSummaryUpdated(
    NodeRef sourceNode,
    NodeRef destNode,
    String newPath
  ) {
