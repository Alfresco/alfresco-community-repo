 ...
 *
 * <p>Service to process FreeMarker template files loaded from various sources including the
 * classpath, repository and directly from a String.
 *
 * <p>The template is processed against a data model generally consisting of a map of named objects.
 * FreeMarker can natively handle any POJO objects using standard bean notation syntax. It has
 * support for walking List objects. A 'standard' data model helper is provided to help generate an
 * object model containing well known objects such as the Company Home, User Home and current User
 * nodes. It also provides helpful util classes to process Date objects and repository specific
 * custom methods.
 *
 * @author Kevin Roast
 */
public class FreeMarkerProcessor extends BaseProcessor
    ...
    private static final boolean DEFAULT_LOCALIZED_LOOKUP_VALUE = false;
    ...
    /**
     * @see org.alfresco.service.cmr.repository.TemplateProcessor#process(java.lang.String,
            ...
            if (t != null) {
                try {
                    ...
                    throw new TemplateException(
                            MSG_ERROR_TEMPLATE_FAIL, new Object[] {err.getMessage()}, err);
                }
            } else {
    ...
    /**
     * @see org.alfresco.service.cmr.repository.TemplateProcessor#process(java.lang.String,
     *     java.lang.Object, java.io.Writer, java.util.Locale)
     */
    ...
    /**
     * @see org.alfresco.service.cmr.repository.TemplateProcessor#processString(java.lang.String,
     *     java.lang.Object, java.io.Writer)
     */
    ...
    private Object convertToFreeMarkerModel(Object model) {
        ...
        if (model instanceof Map) {
            ...
            TemplateImageResolver imageResolver =
                    (TemplateImageResolver) ((Map) model).get(TemplateService.KEY_IMAGE_RESOLVER);
