...
public class RepositoryInfoTests extends CmisTest {
    ...
    public void userCannotGetRepositoriesUsingWrongBrowserUrl() throws Exception {
        ...
        cmisApi.authUserUsingBrowserUrlAndBindingType(
                        testUser, wrongUrlPath, BindingType.BROWSER.value())
                .getRepositoryInfo();
    }

    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = {IllegalArgumentException.class, CmisRuntimeException.class},
