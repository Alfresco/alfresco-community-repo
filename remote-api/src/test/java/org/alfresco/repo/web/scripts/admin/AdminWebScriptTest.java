...
public class AdminWebScriptTest extends BaseWebScriptTest {
    ...
    public void testGetUsage() throws Exception {
        ...
        String licenseMode =
                json.isNull(AbstractAdminWebScript.JSON_KEY_LICENSE_MODE)
                        ? null
        ...
        Long licenseValidUntil =
                json.isNull(AbstractAdminWebScript.JSON_KEY_LICENSE_VALID_UNTIL)
                        ? null
        ...
        assertEquals(
                ...
                licenseValidUntil);
        Integer level =
                json.isNull(AbstractAdminWebScript.JSON_KEY_LEVEL)
                        ? null
    ...
    public void testSysAdminAccess_tenantConsole() throws Exception {
        ...
        TestWebScriptServer.GetRequest getReq =
                new TestWebScriptServer.GetRequest(tenantConsoleUrl);
        sendRequest(getReq, Status.STATUS_UNAUTHORIZED, user1_sysAdmin);
    ...
    public void testSysAdminAccess_workflowConsole() throws Exception {
        ...
        TestWebScriptServer.GetRequest getReq =
                new TestWebScriptServer.GetRequest(workflowConsoleUrl);
        sendRequest(getReq, Status.STATUS_UNAUTHORIZED, user1_sysAdmin);
