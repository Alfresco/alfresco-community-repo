...
public class SecondaryTypesTests extends CmisTest {
  ...
  public void dataPreparation() throws Exception {
    managerFile =
      FileModel.getRandomFileModel(FileType.MSWORD2007, documentContent);
  ...
  @Test(
    groups = {
      TestGroup.SANITY, TestGroup.CMIS, TestGroup.NOT_SUPPORTED_ON_CMIS_WS,
    }
  )
  @TestRail(
    section = { "cmis-api" },
  ...
  public void userCanGetSecondaryTypesForDocument() throws Exception {
    cmisApi
      ...
      .assertThat()
      .secondaryTypeIsAvailable(titledAspect);
  }
  ...
  public void invalidSecondaryTypeIsNotAvailableForFolder() throws Exception {
    ...
    cmisApi
      ...
      .and()
      .assertThat()
      .secondaryTypeIsNotAvailable(titledAspect + "-fake");
  }
  ...
  public void nonInvitedUserCanGetSecondaryTypesForContentInPublicSite()
    throws Exception {
    cmisApi
  ...
  public void nonInvitedUserCannotGetSecondaryTypesForContentInPrivateSite()
    throws Exception {
    SiteModel privateSite = dataSite
      .usingUser(testUser)
      .createPrivateRandomSite();
    FileModel privateDoc = FileModel.getRandomFileModel(
      FileType.MSPOWERPOINT2007
    );
    cmisApi
      .authenticateUser(testUser)
  ...
  public void nonInvitedUserCannotGetSecondaryTypesInModeratedSite()
    throws Exception {
    SiteModel privateSite = dataSite
      .usingUser(testUser)
  ...
  public void managerCanAddSecondaryTypesForDocument() throws Exception {
    cmisApi
      ...
      .assertThat()
      .secondaryTypeIsAvailable("P:cm:dublincore")
      .assertThat()
      .secondaryTypeIsAvailable(titledAspect)
      .then()
      .updateProperty("cm:subject", "TAS Subject")
      .updateProperty("cm:rights", "TAS Rights")
      .updateProperty("cm:publisher", "TAS Team")
      .then()
      .assertThat()
      .objectHasProperty("cm:subject", "TAS Subject")
      .assertThat()
      .objectHasProperty("cm:rights", "TAS Rights")
      .assertThat()
      .objectHasProperty("cm:publisher", "TAS Team");
  }
  ...
  public void managerCanAddSecondaryTypesForFolder() throws Exception {
    cmisApi
      ...
      .assertThat()
      .secondaryTypeIsAvailable("P:cm:geographic")
      .assertThat()
      .secondaryTypeIsAvailable(titledAspect)
      .then()
      .updateProperty("cm:longitude", 455.21)
      .updateProperty("cm:latitude", 101.32)
      .then()
      .assertThat()
      .objectHasProperty("cm:longitude", 455.21)
      .assertThat()
      .objectHasProperty("cm:latitude", 101.32);
  }
  ...
  public void collaboratorCanAddAspectForDocument() throws Exception {
    cmisApi
      ...
      .assertThat()
      .secondaryTypeIsAvailable("P:audio:audio")
      .assertThat()
      .secondaryTypeIsAvailable(titledAspect)
      .then()
      .updateProperty("audio:channelType", "TAS")
      .updateProperty("audio:trackNumber", 9)
      .updateProperty("audio:sampleType", "TAS Sample")
      .then()
      .assertThat()
      .objectHasProperty("audio:channelType", "TAS")
      .assertThat()
      .objectHasProperty("audio:trackNumber", 9)
      .assertThat()
      .objectHasProperty("audio:sampleType", "TAS Sample");
  }
  ...
  public void contributorCanAddAspectForDocument() throws Exception {
    cmisApi
      ...
      .assertThat()
      .secondaryTypeIsAvailable("P:dp:restrictable")
      .assertThat()
      .secondaryTypeIsAvailable(titledAspect)
      .then()
      .updateProperty("dp:offlineExpiresAfter", 2)
      .and()
      .assertThat()
      .objectHasProperty("dp:offlineExpiresAfter", 2);
  }
  ...
  public void managerCanAddDateProperty() throws Exception {
    ...
    cmisApi
      ...
      .assertThat()
      .secondaryTypeIsAvailable("P:cm:effectivity")
      .then()
      .updateProperty("cm:to", today)
      .updateProperty("cm:from", tomorrow)
      .and()
      .assertThat()
      .objectHasProperty("cm:to", today)
      .assertThat()
      .objectHasProperty("cm:from", tomorrow);
  }
  ...
  public void managerCannotUpdateFakePropertyFromAspect() throws Exception {
    cmisApi
      ...
      .secondaryTypeIsAvailable(titledAspect)
      .then()
      .updateProperty("cm:fake-prop", "fake-prop");
  }
}
