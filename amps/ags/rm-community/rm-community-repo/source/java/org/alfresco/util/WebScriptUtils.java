...
public final class WebScriptUtils {
  ...
  public static JSONObject getRequestContentAsJSONObject(WebScriptRequest req) {
    ...
    try {
      ...
      throw new WebScriptException(
        Status.STATUS_BAD_REQUEST,
        "Could not get content from the request.",
        error
      );
    }
   ...
   */
  public static void checkMandatoryJSONParam(
   ...
   */
  public static void checkMandatoryJSONParams(
    JSONObject jsonObject,
   ...
   */
  public static void putValueToJSONObject(
    JSONObject jsonObject,
    String key,
    Object value
  ) {
  ...
  public static Object getJSONArrayValue(JSONArray jsonArray, int index) {
    ...
    try {
      ...
      throw new WebScriptException(
        Status.STATUS_BAD_REQUEST,
        "Could not get value for the index '" +
        index +
        "' from the JSON Array.",
        error
      );
   ...
   */
  public static JSONArray getJSONArrayFromJSONObject(
    JSONObject jsonObject,
    String key
  ) {
    JSONArray jsonArray;
   ...
   */
  public static JSONObject getValueFromJSONObject(
    JSONObject jsonObject,
    String key
  ) {
    mandatory("jsonObject", jsonObject);
