...
public class InCategoryEvaluator extends ActionConditionEvaluatorAbstractBase {
  ...
  protected boolean evaluateImpl(
    ...
    if (this.nodeService.exists(actionedUponNodeRef) == true) {
      ...
      QName categoryAspect = (QName) ruleCondition.getParameterValue(
        PARAM_CATEGORY_ASPECT
      );
      NodeRef categoryValue = (NodeRef) ruleCondition.getParameterValue(
        PARAM_CATEGORY_VALUE
      );
      ...
      if (
        ...
        if (categoryProperty != null) {
          ...
          if (value != null) {
            Collection<NodeRef> actualCategories = DefaultTypeConverter.INSTANCE.getCollection(
              NodeRef.class,
              value
            );
