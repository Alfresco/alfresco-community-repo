...
public class TransferReporterImpl implements TransferReporter {
  ...
  public NodeRef createTransferReport(
    ...
    try {
      ...
      TransferManifestProcessor processor = new TransferManifestProcessor() {
        public void processTransferManifestNode(
        ...
        public void processTransferManifiestHeader(
      ...
      XMLTransferManifestReader reader = new XMLTransferManifestReader(
        processor
      );
  ...
  /*
   */
  public NodeRef writeDestinationReport(
    String transferName,
    TransferTarget target,
    File tempFile
  ) {
    ...
    String description =
      "Transfer Destination Report - target: " + target.getName();
