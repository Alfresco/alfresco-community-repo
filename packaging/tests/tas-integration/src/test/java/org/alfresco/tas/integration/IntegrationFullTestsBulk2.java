...
public class IntegrationFullTestsBulk2 extends IntegrationTest {
  ...
  public void updateFileUsingDifferentProtocolsWhileDocumentIsCheckedOut()
    throws Exception {
    ...
    FileModel wordFilePWC = cmisAPI
      .usingResource(wordFile)
      .withCMISUtil()
      .getPWCFileModel();

    STEP(
      "3. Try to edit document using Webdav while checked-out with CMIS - content should be updated"
    );
    webDavProtocol
      .authenticateUser(testUser1)
  ...
  public void updateCheckedOutFile() throws Exception {
    ...
    STEP(
      "5. Try to edit file while checked-out with ftp - content should not be updated since file is checked out"
    );
    ftpProtocol
      .usingResource(testFile)
      .update("ftpUpdate")
  ...
  public void updateFileWithDifferentRolesUsingDifferentProtocols()
    throws Exception {
    usersWithRoles =
