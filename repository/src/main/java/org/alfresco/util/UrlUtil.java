...
public class UrlUtil {
     ...
     *
     * @return Alfresco Url such as https://col.ab.or.ate/alfresco/ or
     ...
     * {@link SysAdminParams}.
     *
     * @return Rest-Api Url such as https://col.ab.or.ate/api-explorer/ or
     *     http://localhost:8082/api-explorer/
     */
    public static String getApiExplorerUrl(
            SysAdminParams sysAdminParams, String requestURL, String requestURI) {
     ...
     * @return if the given {@code value} contains share url placeholder, the placeholder is
     *     replaced with share url; otherwise, the given {@code value} is simply returned
     */
    public static String replaceShareUrlPlaceholder(String value, SysAdminParams sysAdminParams) {
        if (value != null) {
            return PATTERN.matcher(value).replaceAll(getShareUrl(sysAdminParams));
        }
        return value;
    }

    public static String replaceAlfrescoUrlPlaceholder(
            String value, SysAdminParams sysAdminParams) {
        if (value != null) {
