...
public class AddFavoritesTests extends RestTest {
  ...
  public void managerIsNotAbleToAddToFavoritesIfAuthenticationFails()
    throws Exception {
  ...
  public void managerIsAbleToAddFileToFavorites() throws Exception {
    ...
    RestFileModel restFileModel = restPersonFavoritesModel
      .getTarget()
      .getFile();
    restFileModel
      .assertThat()
  ...
  public void managerIsAbleToAddFolderToFavorites() throws Exception {
    ...
    RestFolderModel restFolderModel = restPersonFavoritesModel
      .getTarget()
      .getFolder();
    restFolderModel
      .assertThat()
  ...
  public void addFavoriteUsingInexistentUser() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "random_user")
      );
  }
  ...
  public void addFavoriteUsingInexistentGuid() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.ENTITY_NOT_FOUND, "random_guid")
      );
  }
  ...
  public void addFileFavoriteUsingCommentId() throws Exception {
    FileModel file = dataContent
      ...
      .usingUser(adminUserModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);
    RestCommentModel comment = restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
      .usingResource(file)
  ...
  public void addFileFavoriteUsingTagId() throws Exception {
    FileModel file = dataContent
      ...
      .usingUser(adminUserModel)
      .createContent(CMISUtil.DocumentType.TEXT_PLAIN);
    RestTagModel returnedModel = restClient
      .authenticateUser(adminUserModel)
      .withCoreAPI()
      .usingResource(file)
      .addTag("random_tag");
  ...
  public void addSiteToFavoritesUsingFolderId() throws Exception {
    SiteModel newSiteModel = dataSite
      .usingUser(adminUserModel)
      .createPublicRandomSite();
  ...
  public void addFolderToFavoritesUsingSiteId() throws Exception {
    FolderModel newFolder = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
      .createFolder();
  ...
  public void verifyFavoriteASiteIfTheUserDoesNotHavePermission()
    throws Exception {
