...
public class ContentModelItemData<ItemType> implements TransientValueGetter {
    ...
    /**
     * @return the property value associated with the <code>key</code> or <code>null</code> if none
     *     exists.
     */
    ...
    /**
     * @return the association value associated with the <code>key</code> or <code>null</code> if
     *     none exists.
     */
    ...
    /**
     * @return the value associated with the transient property specified by the fieldName or <code>
     *     null</code> if none exists.
     */
    ...
    /**
     * @return The PropertyDefinition associated with the <code>propName</code> or <code>null</code>
     *     if none exists.
     */
    ...
    /**
     * @return The AssociationDefinition associated with the <code>assocName</code> or <code>null
     *     </code> if none exists.
     */
    ...
    /**
     * @return Returns an unmodifiable Collection containing all the association definition {@link
     *     QName QNames} for the item.
     */
    ...
    /**
     * @return Returns an unmodifiable Collection containing all the property definitions for the
     *     item.
     */
