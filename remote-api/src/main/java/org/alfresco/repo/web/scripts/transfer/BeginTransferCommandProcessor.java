...
public class BeginTransferCommandProcessor implements CommandProcessor {
  ...
  private static final Log logger = LogFactory.getLog(
    BeginTransferCommandProcessor.class
  );
  ...
  public int process(WebScriptRequest req, WebScriptResponse resp) {
    ...
    try {
      String[] fromRepositoryIdValues = req.getParameterValues(
        TransferCommons.PARAM_FROM_REPOSITORYID
      );
      String[] transferToSelfValues = req.getParameterValues(
        TransferCommons.PARAM_ALLOW_TRANSFER_TO_SELF
      );
      String[] editionValues = req.getParameterValues(
        TransferCommons.PARAM_VERSION_EDITION
      );
      String[] majorValues = req.getParameterValues(
        TransferCommons.PARAM_VERSION_MAJOR
      );
      String[] minorValues = req.getParameterValues(
        TransferCommons.PARAM_VERSION_MINOR
      );
      String[] revisionValues = req.getParameterValues(
        TransferCommons.PARAM_VERSION_REVISION
      );
      String[] rootFileTransfer = req.getParameterValues(
      ...
      TransferVersion fromVersion = new TransferVersionImpl(
        major,
        minor,
        revision,
        edition
      ...
      transferId =
        receiver.start(fromRepositoryId, transferToSelf, fromVersion);
