...
public class NodePropertyValue implements Cloneable, Serializable {
    ...
    private static Log loggerOracle =
            LogFactory.getLog(NodePropertyValue.class.getName() + ".oracle");
    ...
    private static enum ValueType {
        ...
        STRING {
            ...
            /**
             * Strings longer than the maximum of {@link
             * org.alfresco.repo.domain.schema.SchemaBootstrap#DEFAULT_MAX_STRING_LENGTH} characters
             * will be serialized.
             */
            @Override
            protected ValueType getPersistedType(Serializable value) {
     ...
     * @param value the value to store. This will be converted into a format compatible with the
     *     type given
     * @throws java.lang.UnsupportedOperationException if the value cannot be converted to the type
     *     given
     */
        ...
        if (obj instanceof NodePropertyValue) {
            ...
            return (this.actualType.equals(that.actualType)
                    && EqualsHelper.nullSafeEquals(
                            this.getPersistedValue(), that.getPersistedValue()));
        } else {
            return false;
        }
    }
    ...
    private Serializable cloneSerializable(Serializable original) {
        ...
        try {
            ...
            throw new AlfrescoRuntimeException(
                    "Failed to clone serializable object: " + original, e);
        } finally {
            if (objectOut != null) {
                try {
                    objectOut.close();
     ...
     * @throws AlfrescoRuntimeException if the type given is not recognized
     * @throws org.alfresco.service.cmr.repository.datatype.TypeConversionException if the
     *     conversion to the required type fails
    ...
    public boolean getBooleanValue() {
        ...
        else return booleanValue.booleanValue();
    }
    ...
    public long getLongValue() {
        ...
        else return longValue.longValue();
    }
    ...
    public float getFloatValue() {
        if (floatValue == null) return 0.0F;
        else return floatValue.floatValue();
    }
    ...
    public double getDoubleValue() {
        ...
        else return doubleValue.doubleValue();
    }
