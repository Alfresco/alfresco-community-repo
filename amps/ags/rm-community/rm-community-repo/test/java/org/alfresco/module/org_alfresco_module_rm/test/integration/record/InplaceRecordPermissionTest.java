...
public class InplaceRecordPermissionTest extends BaseRMTestCase {
  ...
  public void testContributorThatIsntOwnerDeclareInPlaceRecord() {
    test()
      ...
      .from(() -> recordService.createRecord(filePlan, dmDocument))
      .because(
        "The contributor does not have write permission on the document."
      );
  }
  ...
  public void testCreateInplaceRecordFromCollabSite() {
    test()
      ...
      ) // edit record metadata capability
   ...
   */
  private void checkInPlaceAccess(
    NodeRef nodeRef,
    ...
    Map<Capability, AccessStatus> access = capabilityService.getCapabilitiesAccessState(
      nodeRef,
      CAPABILITIES
    );
    assertEquals(
  ...
  public void testCreateInplaceRecordFromCollabSiteWhenContribIsCreatorOfDocument() {
    test()
      ...
      .perform(() -> {
        contribDoc =
          fileFolderService
            .create(dmFolder, "contrib.txt", ContentModel.TYPE_CONTENT)
            .getNodeRef();
      ...
      .because(
        "As the creator of the document the contributor is also the owner"
      )
      .as(dmContributor)
      ...
      .because(
        "Contrib user has write permissions on created document as the owner."
      )
      // When it is declared as an inplace record
      .when()
      .as(dmContributor)
  ...
  public void testDestroyedRecordInplacePermissions() {
    test()
      ...
      .expect("destroy")
      .from(() ->
        dispositionService.getNextDispositionAction(dmDocument).getName()
      )
  ...
  public void testCmCreatorDeletedBeforeRecordDeclaration() {
    test()
      ...
      .perform(() -> {
        deleteUserDoc =
          fileFolderService
            .create(dmFolder, "deleteUserDoc.txt", ContentModel.TYPE_CONTENT)
            .getNodeRef();
        dbNodeService.addAspect(
          deleteUserDoc,
          ContentModel.ASPECT_AUDITABLE,
  ...
  public void testNoPermissionsOnCopy() {
    test()
      ...
      .perform(() -> {
        ...
        copiedDoc =
          fileFolderService
            .create(dmFolder, "copiedDoc.txt", ContentModel.TYPE_CONTENT)
            .getNodeRef();
  ...
  public void testGroupReuse() {
    test()
      ...
      .perform(
        50,
        () -> {
          NodeRef newDocument = fileFolderService
