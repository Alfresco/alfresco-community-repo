...
public class ReplicationDefinitionPersisterImpl implements ReplicationDefinitionPersister {
    ...
    protected static final NodeRef REPLICATION_ACTION_ROOT_NODE_REF =
            new NodeRef(SPACES_STORE, "replication_actions_space");
    protected static final Set<QName> ACTION_TYPES =
            new HashSet<QName>(Arrays.asList(new QName[] {ActionModel.TYPE_ACTION}));
    ...
    public List<ReplicationDefinition> loadReplicationDefinitions() {
        ...
        List<ChildAssociationRef> childAssocs =
                nodeService.getChildAssocs(REPLICATION_ACTION_ROOT_NODE_REF, ACTION_TYPES);

        List<ReplicationDefinition> replicationActions =
                new ArrayList<ReplicationDefinition>(childAssocs.size());
    ...
    public List<ReplicationDefinition> loadReplicationDefinitions(String targetName) {
        ...
        List<ReplicationDefinition> filteredReplicationDefinitions =
                new ArrayList<ReplicationDefinition>();
    ...
    public void renameReplicationDefinition(QName oldReplicationName, QName newReplicationName) {
        ...
        rd.setParameterValue(
                ReplicationDefinitionImpl.REPLICATION_DEFINITION_NAME, newReplicationName);
