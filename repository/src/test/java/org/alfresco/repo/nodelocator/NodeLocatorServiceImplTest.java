...
public class NodeLocatorServiceImplTest {
  ...
  private static final NodeRef companyHome = new NodeRef(
  ...
  public void testCompanyHomeNodeLocator() throws Exception {
    NodeRef result = nodeLocatorService.getNode(
      CompanyHomeNodeLocator.NAME,
      null,
      null
    );
