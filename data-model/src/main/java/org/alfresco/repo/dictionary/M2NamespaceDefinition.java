...
public class M2NamespaceDefinition implements NamespaceDefinition {
  ...
  static List<M2ModelDiff> diffNamespaceDefinitionLists(
    Collection<NamespaceDefinition> previousNamespaces,
    Collection<NamespaceDefinition> newNamespaces
  ) {
    ...
    for (NamespaceDefinition previousNamespace : previousNamespaces) {
      ...
      if (!found) {
        modelDiffs.add(
          new M2ModelDiff(
            previousNamespace.getModel().getName(),
            M2ModelDiff.TYPE_NAMESPACE,
