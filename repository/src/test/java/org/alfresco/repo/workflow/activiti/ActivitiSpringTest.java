...
public class ActivitiSpringTest extends TestCase {
  ...
  private static final String ACTIVITI_CONTEXT =
  ...
  public void testRollbackFromActiviti() {
    RetryingTransactionCallback<Void> callback = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
        ...
        assertTrue(
          "The node should have the aspect!",
          nodeService.hasAspect(workingNodeRef, ASPECT)
        );
        try {
    ...
    assertFalse(
      "The node should not have the aspect!",
      nodeService.hasAspect(workingNodeRef, ASPECT)
    );
  }
  ...
  public void testNestedWithoutPropogation() {
    RetryingTransactionCallback<Void> callback = new RetryingTransactionCallback<Void>() {
      public Void execute() throws Throwable {
        ...
        assertNotNull(
          "Can't read process instance in same transaction!",
          instanceInDb
        );
        RetryingTransactionCallback<Void> callbackInner = new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ProcessInstance instanceInDb = findProcessInstance(id);
            assertNull(
              "Should not be able to read process instance in inner transaction!",
              instanceInDb
            );
            return null;
          }
  ...
  protected void setUp() throws Exception {
    ...
    this.repo =
      (RepositoryService) appContext.getBean("activitiRepositoryService");
    this.runtime =
      (RuntimeService) appContext.getBean("activitiRuntimeService");

    ServiceRegistry serviceRegistry = (ServiceRegistry) appContext.getBean(
    ...
    this.deployment =
      repo.createDeployment().addInputStream(resource, input).deploy();
  }
