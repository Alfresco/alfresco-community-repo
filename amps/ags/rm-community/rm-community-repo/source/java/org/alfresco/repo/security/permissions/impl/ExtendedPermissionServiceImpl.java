 ...
 * permission.
 *
 * <p>This is required for SOLR support.
 *
...
public class ExtendedPermissionServiceImpl extends PermissionServiceImpl
     ...
     *
     * <p>This string comes from alfresco-global.properties and allows fine tuning of the how
     * permissions are mapped. This was added as a fix for MNT-16852 to enhance compatibility with
     * our Outlook Integration.
     */
    protected List<String> configuredReadPermissions;
    /**
     * Configured Permission mapping.
     *
     * <p>This string also comes from alfresco-global.properties.
     */
        ...
        AuthenticationUtil.runAsSystem(
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        recordsManagementAuditService.registerAuditEvent(
                                new AuditEvent(
                                        AUDIT_ENABLE_INHERIT_PERMISSION,
                                        "rm.audit.enable-inherit-permission"));
                        recordsManagementAuditService.registerAuditEvent(
                                new AuditEvent(
                                        AUDIT_DISABLE_INHERIT_PERMISSION,
                                        "rm.audit.disable-inherit-permission"));
                        return null;
                    }
                });
    }
    ...
    public void setPermissionProcessorRegistry(
            PermissionProcessorRegistry permissionProcessorRegistry) {
    ...
    /**
     * @see
     *     org.alfresco.repo.security.permissions.impl.PermissionServiceImpl#setAnyDenyDenies(boolean)
     */
    @Override
    ...
    /**
     * Maps the string from the properties file (rm.haspermissionmap.read) to the list used in the
    ...
    /**
     * Maps the string set in the properties file (rm.haspermissionmap.write) to the list used in
    ...
    /**
     * @see
     *     org.alfresco.repo.security.permissions.impl.PermissionServiceImpl#onBootstrap(org.springframework.context.ApplicationEvent)
     */
    @Override
    ...
    /**
     * Override to deal with the possibility of hard coded permission checks in core code. Note:
     * Eventually we need to merge the RM permission model into the core to make this more robust.
     *
     * @see
     *     org.alfresco.repo.security.permissions.impl.ExtendedPermissionService#hasPermission(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    @Override
    public AccessStatus hasPermission(NodeRef nodeRef, String perm) {
        ...
        if (nodeService.exists(nodeRef)) {
            ...
            List<PermissionPreProcessor> preProcessors =
                    permissionProcessorRegistry.getPermissionPreProcessors();
            ...
            List<PermissionPostProcessor> postProcessors =
                    permissionProcessorRegistry.getPermissionPostProcessors();
            for (PermissionPostProcessor postProcessor : postProcessors) {
                ...
                result =
                        postProcessor.process(
                                ...
                                this.configuredFilePermissions);
            }
        }
        return result;
    }
     ...
     *
     * <p>Separation also convenient for unit testing.
     *
    ...
    /**
     * @see
     *     org.alfresco.repo.security.permissions.impl.PermissionServiceImpl#canRead(java.lang.Long)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.repo.security.permissions.impl.PermissionServiceImpl#getReaders(java.lang.Long)
     */
    @Override
    public Set<String> getReaders(Long aclId) {
        ...
        for (String authority : assigned) {
            ...
            UnconditionalAclTest rmTest =
                    new UnconditionalAclTest(
    ...
    public Set<String> getReadersDenied(Long aclId) {
        ...
        for (String authority : assigned) {
            ...
            UnconditionalDeniedAclTest rmTest =
                    new UnconditionalDeniedAclTest(
                            getPermissionReference(RMPermissionModel.READ_RECORDS));
            if (test.evaluate(authority, aclId) || rmTest.evaluate(authority, aclId)) {
    ...
    public Set<String> getWriters(Long aclId) {
        ...
        for (String authority : assigned) {
            UnconditionalAclTest test =
                    new UnconditionalAclTest(getPermissionReference(PermissionService.WRITE));
    ...
    /**
     * @see
     *     org.alfresco.repo.security.permissions.impl.PermissionServiceImpl#setInheritParentPermissions(org.alfresco.service.cmr.repository.NodeRef,
     *     boolean)
     */
    @Override
    public void setInheritParentPermissions(
            final NodeRef nodeRef, boolean inheritParentPermissions) {
    ...
    /**
     * @see
     *     org.alfresco.repo.security.permissions.impl.ExtendedPermissionService#getReadersAndWriters(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
