...
public class ModuleManagementToolTest extends TestCase {
    ...
    private void installerSharedTests(
            String warLocation, String ampLocation, String ampV2Location) {
        ...
        try {
            ...
            // fail("The module is already installed so an exception should have been raised since
            // we are not forcing an overwite");
        ...
        try {
            this.manager.installModule(ampLocation, warLocation);
            // fail("A later version of this module is already installed so an exception should have
            // been raised since we are not forcing an overwite");
    ...
    public void testForcedInstall() throws Exception {
        ...
        String amp5Location =
                getFileLocation(
                        ".amp", "module/test_v7.amp"); // new amp that overides existing files
    ...
    public void testExistingFilesInWar() throws Exception {
        ...
        try {
            ...
            assertTrue(
                    exception.getMessage().contains("will overwrite an existing file in the war"));
        }
        ...
        this.manager.installModule(
                ampLocation, warLocation, false, true, false); // install it again
    }
    ...
    private String extractToDir(String extension, String location) {
        ...
        try {
            TFile zipFile =
                    new TFile(this.getClass().getClassLoader().getResource(location).getPath());
            TFile outDir =
                    new TFile(
