...
public interface DispositionAction {
    ...
    /**
     * @return true if the events are complete (ie: enough events have been completed to make the
     *     disposition action
     */
     ...
     * Complete an event.
     *
     * <p>If null is provided, the complete at date will be take as 'now' and the completed by user
     ...
     *
     * <p>Called when disposition action definition has changed.
     *
     * @since 2.2
     */
    void refreshEvents();
