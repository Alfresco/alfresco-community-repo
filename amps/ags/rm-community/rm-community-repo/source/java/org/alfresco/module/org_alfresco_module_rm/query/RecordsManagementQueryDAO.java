 ...
 *
 * <p>NOTE: a place holder that can be extended later when we want to enhance performance with
 * canned queries.
 *
...
public interface RecordsManagementQueryDAO {
     ...
     *
     * <p>Note: this is provided as an example and is not currently used
     *
    ...
    /**
     * Returns a number of nodeRefs for record folders in the system that have the property
     * recordSearchHasDispositionSchedule:true (used for MNT-20864)
     *
    ...
    /**
     * Returns whether a given node contains children with one of the given values for the given
     * property Returns distinct property values from children for the given property
     *
     ...
     *
     * @return PropertyStringValueEntity the property string value entity with the specified string
     *     value
     */
