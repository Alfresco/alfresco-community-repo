...
public class QNameDAOTest extends TestCase {
    ...
    private Pair<Long, String> getNamespace(
            final String uri, final boolean autoCreate, boolean expectSuccess) {
    ...
    private Pair<Long, QName> getQName(
            final QName qname, final boolean autoCreate, boolean expectSuccess) {
        RetryingTransactionCallback<Pair<Long, QName>> callback =
                new RetryingTransactionCallback<Pair<Long, QName>>() {
    ...
    public void testCreateNamespace() throws Exception {
        ...
        Pair<Long, String> namespacePairCheck =
                getNamespace(namespacePair.getSecond(), false, true);
        assertEquals(
                "Namespace ID changed", namespacePair.getFirst(), namespacePairCheck.getFirst());
    ...
    public void testUpdateNamespace() throws Exception {
        ...
        assertNotSame(
                "Should have a new namespace ID",
                namespacePair.getFirst(),
                namespacePairAgain.getFirst());
    }
    ...
    public void testUpdateQName() throws Exception {
        ...
        Pair<Long, QName> qnamePairNew =
                transactionService.getRetryingTransactionHelper().doInTransaction(callback);
        // The ID must be the same
        assertEquals("New QName is incorrect", qnameNew, qnamePairNew.getSecond());
        assertEquals(
                "ID did not remain the same", qnamePairOld.getFirst(), qnamePairNew.getFirst());
