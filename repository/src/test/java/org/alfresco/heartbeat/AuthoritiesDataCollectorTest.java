...
public class AuthoritiesDataCollectorTest {
  ...
  @Before
  public void setUp() {
    HBDataCollectorService mockCollectorService = mock(
      HBDataCollectorService.class
    );
  ...
  public void testAuthDataIsCollected() {
    HBData authorityInfo = grabDataByCollectorId(
      authorityDataCollector.getCollectorId()
    );
