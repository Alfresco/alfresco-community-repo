...
public class WebDAVServlet extends HttpServlet {
    ...
    public static class WebDAVInitParameters {
         ...
         * </pre>
         *
         * In the default set up this would be of the form /context-path/servlet-name e.g.
         * /alfresco/webdav:
         *
         * <pre>
         ...
         * </pre>
         *
         * however if using URL rewriting rules or a reverse proxy in front of the webdav server you
         * may choose to use, for example / for shorter URLs.
         *
         * <pre>
         *   http://server.name/path/to/file.txt
         * </pre>
         *
         * <p>Leaving this property blank will cause the prefix used to be
         * /context-path/servlet-name
         *
