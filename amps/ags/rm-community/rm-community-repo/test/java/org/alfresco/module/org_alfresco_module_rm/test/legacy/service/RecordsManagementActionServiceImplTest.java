...
public class RecordsManagementActionServiceImplTest
  ...
  private void getActionsImpl() {
    List<RecordsManagementAction> result =
      this.rmActionService.getRecordsManagementActions();
    ...
    RecordsManagementAction cutoff =
      this.rmActionService.getDispositionAction("cutoff");
    assertNotNull(cutoff);
    assertEquals("Cut Off", cutoff.getLabel());

    RecordsManagementAction freeze =
      this.rmActionService.getRecordsManagementAction("freeze");
