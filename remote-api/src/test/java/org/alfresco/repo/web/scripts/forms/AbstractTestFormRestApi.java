                        ...
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                NodeRef companyHomeNodeRef =
                                        AbstractTestFormRestApi.this.repositoryHelper
                                                .getCompanyHome();

                                String guid = GUID.generate();

                                // Create a test file (not a folder)
                                FileInfo referencingDoc =
                                        AbstractTestFormRestApi.this.fileFolderService.create(
                                                companyHomeNodeRef,
                                                "referencingDoc" + guid + ".txt",
                                                ContentModel.TYPE_CONTENT);
                                referencingDocNodeRef = referencingDoc.getNodeRef();

                                // Add an aspect.
                                Map<QName, Serializable> aspectProps =
                                        new HashMap<QName, Serializable>(2);
                                aspectProps.put(ContentModel.PROP_TITLE, TEST_FORM_TITLE);
                                aspectProps.put(
                                        ContentModel.PROP_DESCRIPTION, TEST_FORM_DESCRIPTION);
                                ...
                                ContentWriter contentWriter =
                                        AbstractTestFormRestApi.this.contentService.getWriter(
                                                referencingDoc.getNodeRef(),
                                ...
                                AbstractTestFormRestApi.this.associatedDoc_A =
                                        createTestNode("associatedDoc_A" + guid);
                                AbstractTestFormRestApi.this.associatedDoc_B =
                                        createTestNode("associatedDoc_B" + guid);
                                AbstractTestFormRestApi.this.associatedDoc_C =
                                        createTestNode("associatedDoc_C" + guid);
                                AbstractTestFormRestApi.this.associatedDoc_D =
                                        createTestNode("associatedDoc_D" + guid);
                                AbstractTestFormRestApi.this.associatedDoc_E =
                                        createTestNode("associatedDoc_E" + guid);

                                // Now create associations between the referencing and the two node
                                // refs.
                                aspectProps.clear();
                                AbstractTestFormRestApi.this.nodeService.addAspect(
                                        AbstractTestFormRestApi.this.referencingDocNodeRef,
                                        ContentModel.ASPECT_REFERENCING,
                                        aspectProps);
                                AbstractTestFormRestApi.this.nodeService.createAssociation(
                                        AbstractTestFormRestApi.this.referencingDocNodeRef,
                                        associatedDoc_A,
                                ...
                                AbstractTestFormRestApi.this.nodeService.createAssociation(
                                        ...
                                        associatedDoc_B,
                                        ContentModel.ASSOC_REFERENCES);
                                // Leave the 3rd, 4th and 5th nodes without associations as they may
                                // be created in
                                // other test code.

                                // Create a container for the children.
                                HashMap<QName, Serializable> containerProps =
                                        new HashMap<QName, Serializable>();
                                AbstractTestFormRestApi.this.containerNodeRef =
                                        nodeService
                                                .createNode(
                                                        companyHomeNodeRef,
                                ...
                                AbstractTestFormRestApi.this.childDoc_A =
                                        createTestNode("childDoc_A" + guid);
                                AbstractTestFormRestApi.this.childDoc_B =
                                        createTestNode("childDoc_B" + guid);
                                AbstractTestFormRestApi.this.childDoc_C =
                                        createTestNode("childDoc_C" + guid);
                                AbstractTestFormRestApi.this.childDoc_D =
                                        createTestNode("childDoc_D" + guid);
                                AbstractTestFormRestApi.this.childDoc_E =
                                        createTestNode("childDoc_E" + guid);

                                // Now create the pre-test child-associations.
                                AbstractTestFormRestApi.this.nodeService.addChild(
                                        containerNodeRef,
                                        childDoc_A,
                                ...
                                // The other childDoc nodes will be added as children over the REST
                                // API as part
                                // of later test code.

                                // Create and store the urls to the referencingNode
                                StringBuilder builder = new StringBuilder();
                                builder.append("/api/node/workspace/")
                                        .append(referencingDocNodeRef.getStoreRef().getIdentifier())
                                        .append("/")
                                        .append(referencingDocNodeRef.getId())
                                        .append("/formprocessor");
                                AbstractTestFormRestApi.this.referencingNodeUpdateUrl =
                                        builder.toString();

                                builder = new StringBuilder();
                                builder.append("/api/node/workspace/")
                                        .append(containerNodeRef.getStoreRef().getIdentifier())
                                        .append("/")
                                        .append(containerNodeRef.getId())
                                        .append("/formprocessor");
                                AbstractTestFormRestApi.this.containingNodeUpdateUrl =
                                        builder.toString();

                                // Store the original properties of this node
                                AbstractTestFormRestApi.this.refNodePropertiesAfterCreation =
                                        nodeService.getProperties(referencingDocNodeRef);
                ...
                .doInTransaction(
                        new RetryingTransactionCallback<Void>() {
                            ...
                            public Void execute() throws Throwable {
                                ...
                                nodeService.deleteNode(
                                        AbstractTestFormRestApi.this.testFolderNodeRef);
                                nodeService.deleteNode(
                                        AbstractTestFormRestApi.this.containerNodeRef);
                                return null;
                            }
    ...
    protected NodeRef createTestNode(String associatedDocName) {
        ...
        return this.nodeService
                .createNode(
                        ...
                        ContentModel.ASSOC_CONTAINS,
                        QName.createQName(
                                NamespaceService.CONTENT_MODEL_1_0_URI, associatedDocName + ".txt"),
                        ContentModel.TYPE_CONTENT,
                        docProps)
                .getChildRef();
    }
