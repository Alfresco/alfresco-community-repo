...
public class MiscellaneousRulesTest {
  ...
  public void alf14568() throws Exception {
    final NodeRef testSiteDocLib = TRANSACTION_HELPER.doInTransaction(
      ...
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          for (NodeRef folder : folders) {
            NodeRef child = NODE_SERVICE.getChildByName(
              folder,
  ...
  public void alf14568_supplementary() throws Exception {
    ...
    final NodeRef ruleFolder = testNodes.createFolder(
      testSiteDocLib,
      "ruleFolder",
      TEST_USER.getUsername()
    );
    ...
    final NodeRef originalContent = testNodes.createQuickFile(
      MimetypeMap.MIMETYPE_TEXT_PLAIN,
      testSiteDocLib,
      "original.txt",
      TEST_USER.getUsername()
    ...
    final NodeRef copyNode = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
    ...
    final QName exifAspectQName = QName.createQName(
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          Action addAspectAction = ACTION_SERVICE.createAction(
            "add-features",
            params
          );
  ...
  @Test
  public void alf13192_rulesFromFirstFolderMoveToSecondWhenDeleteFirstFolder()
    throws Exception {
    final NodeRef testSiteDocLib = TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<NodeRef>() {
        public NodeRef execute() throws Throwable {
    ...
    final NodeRef folder1 = testNodes.createFolder(
      testSiteDocLib,
      "folder 1",
      TEST_USER.getUsername()
    );
    final NodeRef folder2 = testNodes.createFolder(
      testSiteDocLib,
      "folder 2",
      TEST_USER.getUsername()
    );
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          List<ChildAssociationRef> ruleFolders = NODE_SERVICE.getChildAssocs(
            folder1,
