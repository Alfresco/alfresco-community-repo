...
public class DeletedNodesImpl
  implements DeletedNodes, RecognizedParamsExtractor {
  ...
  public CollectionWithPagingInfo<Node> listDeleted(Parameters parameters) {
    ...
    NodeRef archiveStoreRootNodeRef = nodeService.getStoreArchiveNode(
    ...
    for (NodeRef nRef : result.getPage()) {
      Node foundNode = nodes.getFolderOrDocument(
        nRef,
        null,
        null,
  ...
  public Node getDeletedNode(
    ...
    NodeRef validatedNodeRef = nodes.validateNode(
  ...
  @Override
  public Node restoreArchivedNode(
    String archivedId,
    ...
    if (nodeTargetAssoc != null) {
      NodeRef targetNodeRef = new NodeRef(
        StoreRef.STORE_REF_WORKSPACE_SPACESSTORE,
    ...
    switch (restored.getStatus()) {
      ...
      case FAILURE_INTEGRITY:
        throw new IntegrityException(
          "Restore failed due to an integrity error",
          null
        );
  ...
  @Override
  public BinaryResource getContent(
    String archivedId,
    String renditionId,
    Parameters parameters
  ) {
  ...
  public Rendition getRendition(
    ...
    Rendition rendition = renditions.getRendition(
      nodeRef,
      renditionId,
      parameters
    );
  ...
  public DirectAccessUrl requestContentDirectUrl(
    ...
    if (renditionId != null) {
      ...
      return nodes.requestContentDirectUrl(
        validatedNodeRef,
        attachment,
        validFor
      );
