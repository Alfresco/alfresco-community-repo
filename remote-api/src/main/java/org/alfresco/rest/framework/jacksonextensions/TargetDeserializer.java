  ...
  public Target deserialize(JsonParser jp, DeserializationContext ctxt)
    ...
    if (curr == JsonToken.START_OBJECT) {
      while (jp.nextToken() != JsonToken.END_OBJECT) {
        ...
        if (Type.SITE.toString().equals(fieldname.toUpperCase())) {
          ...
          try {
            ...
            BeanProperty p = new BeanProperty.Std(
              new PropertyName(""),
              t,
              null,
              null,
            ...
            JsonDeserializer<?> siteDeserializer = ctxt.findContextualValueDeserializer(
              t,
              p
            );
            ...
            throw new IllegalArgumentException(
              "Target body is invalid for target type"
            );
          }
          ...
          try {
            ...
            JsonDeserializer<?> documentDeserializer = ctxt.findContextualValueDeserializer(
              t,
              p
            );

            Document document = (Document) documentDeserializer.deserialize(
              jp,
              ctxt
            );
          ...
          try {
            ...
            JsonDeserializer<?> folderDeserializer = ctxt.findContextualValueDeserializer(
              t,
              p
            );
      ...
      throw new IOException(
        "Unable to deserialize favourite: " + curr.asString()
      );
    }
  }
}
