...
public class CopyTests extends WebDavTest {
  ...
  public void siteManagerUserShouldCopyEmptyFolder() throws Exception {
    ...
    dataUser
      ...
      .addUserToSite(managerUser, testSite, UserRole.SiteManager);
  ...
  public void siteCollaboratorShouldCopyEmptyFolderAddedByOtherUser()
    throws Exception {
  ...
  public void siteCollaboratorShouldCopyFolderWithContentAddedByOtherUser()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
    UserModel collaborator = dataUser.createRandomTestUser();
  ...
  public void siteCollaboratorShouldCopyFileAddedByOtherUser()
    throws Exception {
    UserModel collaborator = dataUser.createRandomTestUser();
    dataUser
      .usingUser(managerUser)
  ...
  public void siteContribuitorShouldCopyEmptyFolderAddedByOtherUser()
    throws Exception {
  ...
  public void siteContributorShouldCopyFolderWithContentAddedByOtherUser()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
    UserModel contributor = dataUser.createRandomTestUser();
  ...
  public void siteConsumerShouldNotCopyEmptyFolderAddedByOtherUser()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
  ...
  public void siteConsumerShouldNotCopyFolderWithContentAddedByOther()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
  ...
  public void siteManagerShouldCopyEmptyFolderTwiceInSameLocation()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
  ...
  public void siteManagerShouldCopyFolderWithContentTwiceInSameLocation()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.HTML);
  ...
  public void siteManagerShouldNotCopyNonexistentFolderWithContent()
    throws Exception {
    UserModel managerUser = dataUser.createRandomTestUser();
    dataUser
      .usingUser(managerUser)
  ...
  public void siteManagerShouldNotCopyNonexistentEmptyFolder()
    throws Exception {
    UserModel managerUser = dataUser.createRandomTestUser();
    dataUser
      .usingUser(managerUser)
  ...
  public void unauthenticatedUserShouldNotCopyFolderWithContent()
    throws Exception {
    sourceFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.HTML);
  ...
  public void unauthorizedUserShouldNotCopyFolderWithContent()
    throws Exception {
    UserModel unauthorizedUser = dataUser.createRandomTestUser();
    sourceFolder = FolderModel.getRandomFolderModel();
    testFile = FileModel.getRandomFileModel(FileType.HTML);
