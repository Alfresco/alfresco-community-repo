...
public class DeleteProcessItemCoreTests extends RestTest {
    ...
    public void deleteProcessItemWithInvalidItemId() throws Exception {
        ...
        RestItemModel processItem =
                restClient.withWorkflowAPI().usingProcess(processModel).addProcessItem(secondDoc);
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.PROCESS_ENTITY_NOT_FOUND, "invalid-id"));
    }
    ...
    public void deleteProcessItemTwice() throws Exception {
        ...
        restClient
                ...
                .deleteProcessItem(processItem.onModel());
