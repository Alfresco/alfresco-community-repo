...
public class TypeB1toC1RelationshipResource
  implements RelationshipResourceAction.ReadById<TypeC1> {

  // GET /type-a1/a1/type-b1/b1/relation-b1-c1/c1
  @Override
  public TypeC1 readById(
    String typeBEntityResourceId,
    String typeCEntityResourceId,
