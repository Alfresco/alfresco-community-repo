...
public class RecordCategoryType
   ...
   */
  public void setFilePlanPermissionService(
    FilePlanPermissionService filePlanPermissionService
  ) {
  ...
  public void onMoveNode(
    ...
    if (
      nodeService
        .getType(newChildAssocRef.getChildRef())
        .equals(TYPE_RECORD_CATEGORY) &&
      dispositionService.getDispositionSchedule(
   ...
   */
  private void reinitializeRecordFolders(
    ChildAssociationRef childAssociationRef
  ) {
    for (ChildAssociationRef newChildRef : nodeService.getChildAssocs(
      ...
      if (
        nodeService
          .getType(newChildRef.getChildRef())
          .equals(TYPE_RECORD_CATEGORY)
      ) {
        reinitializeRecordFolders(newChildRef);
      } else if (
        !nodeService.getType(newChildRef.getChildRef()).equals(TYPE_CONTENT)
      ) {
