...
public class MLContentInterceptor implements MethodInterceptor {
  ...
  public void setMultilingualContentService(
    MultilingualContentService directMultilingualContentService
  ) {
  ...
  public Object invoke(MethodInvocation invocation) throws Throwable {
    ...
    if (methodName.equals("getReader")) {
      ...
      if (
        !aspects.contains(ContentModel.ASPECT_MULTILINGUAL_DOCUMENT) ||
      ...
      if (pivotNodeRef == null) {
        ...
        ContentReader pivotContentReader = contentService.getReader(
          pivotNodeRef,
          propertyQName
        );
        // Done
