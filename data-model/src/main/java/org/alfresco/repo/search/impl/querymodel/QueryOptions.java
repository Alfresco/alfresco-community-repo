...
public class QueryOptions {
  ...
  private List<QueryParameterDefinition> queryParameterDefinitions = new ArrayList<QueryParameterDefinition>(
    4
  );
   ...
   */
  public void setDefaultFTSFieldConnective(
    Connective defaultFTSFieldConnective
  ) {
