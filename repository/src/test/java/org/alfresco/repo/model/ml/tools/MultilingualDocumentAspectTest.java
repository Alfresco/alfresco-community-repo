...
public class MultilingualDocumentAspectTest
  ...
  public void testCopy() throws Exception {
    ...
    NodeRef copy = fileFolderService
      .copy(
        original,
  ...
  public void testDeleteNode() throws Exception {
    ...
    NodeRef restoredNode = nodeArchiveService
  ...
  public void testDeletePivot() throws Exception {
    ...
    assertTrue(
      "The last translation would not be removed",
      nodeService.exists(trans1)
    );
  ...
  public void testUpdateRedundantLocale() throws Exception {
    ...
    assertTrue(
      "The modification of this locale must catch an exception because it is already in use in another translation",
      exceptionCatched
    );
    ...
    assertFalse(
      "The modification of the locale would not throws an exception",
      exceptionCatched
    );
