...
public class AddTagTests extends TagsDataPrep {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user doesn't have permission to add tags with Rest API and"
                            + " status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Contributor user adds tags to his content with Rest API and status code"
                            + " is 201")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    public void contributorIsAbleToAddTagToHisContent() throws Exception {
        ...
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        returnedModel.assertThat().field("id").isNotEmpty().and().field("tag").is(tagValue);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify Consumer user doesn't have permission to add tags with Rest API and"
                            + " status code is 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    public void emptyTagTest() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.NULL_ARGUMENT, "tag"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that adding tag with user that has no permissions returns status code"
                            + " 403")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that adding tag to a node that does not exist returns status code 404")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    public void addTagToATaggedFile() throws Exception {
        ...
        restClient
                ...
                .and()
                .entriesListContains("tag", "random_tag_value");
    }
    ...
    public void addInvalidTag() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.INVALID_TAG, "|"));
    }
    ...
    public void contributorIsAbleToTagAFolderCreatedBySelf() throws Exception {
        FolderModel folderModel =
                dataContent
                        .usingUser(usersWithRoles.getOneUserWithRole(UserRole.SiteContributor))
                        .usingSite(siteModel)
                        .createFolder();
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that consumer is not able to tag a folder. Check default error model"
                            + " schema.")
    @Test(groups = {TestGroup.REST_API, TestGroup.TAGS, TestGroup.REGRESSION})
    ...
    public void addTagToATaggedFolder() throws Exception {
        ...
        returnedModel =
                restClient.withCoreAPI().usingResource(folderModel).addTag("random_tag_value");
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        returnedModel
                .assertThat()
                .field("tag")
    ...
    public void provideMoreThanOneTagElement() throws Exception {
        ...
        returnedModelTags =
                restClient
                        .withCoreAPI()
                        .usingResource(folderModel)
                        .addTags(tagValue, tagValue1, tagValue2);
        restClient.assertStatusCodeIs(HttpStatus.CREATED);
        returnedModelTags
                .assertThat()
                .entriesListContains("tag", tagValue)
                .and()
                .entriesListContains("tag", tagValue1)
                .and()
                .entriesListContains("tag", tagValue2)
                .and()
    ...
    public void addTagToAComment() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(RestErrorModel.CANNOT_TAG);
    }
