...
public interface TaggingService {
     ...
     *
     * <p>Tags are created if they do not exist.
     *
     * @param nodeRef node reference
    ...
    /**
     * Sets the list of tags that are applied to a node, replaces any existing tags with those
     * provided.
     *
     * @param nodeRef node reference
     * @param tags list of tags
    ...
    /**
     * Refreshes the tag count of the passed tag scope by recounting all the tags of the children of
     * the scope.
     *
     ...
     *
     * <p>Note that any tag count information will be lost when the scope if removed.
     *
     * @param nodeRef node reference
     */
    @Auditable
     ...
     *
     * <p>The 'nearest' tag scope is discovered by walking up the primary parent path until a tag
     * scope is found or the root node is reached.
     *
     * <p>If no tag scope if found then a null value is returned.
     *
     * @param nodeRef node reference
     ...
     *
     * <p>The resulting list of tag scopes is ordered with the 'nearest' at the bedining of the
     * list.
     *
     * <p>If no tag scopes are found an empty list is returned.
     *
     * @param nodeRef node reference
    ...
    /**
     * Find all nodes that have been tagged with the specified tag and reside within the context of
     * the node reference provided.
     *
     * @param tag tag name
     ...
     */
    @NotAuditable
    Pair<List<String>, Integer> getPagedTags(
