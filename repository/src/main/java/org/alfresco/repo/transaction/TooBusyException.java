...
/**
 * An exception thrown by {@link RetryingTransactionHelper} when its maxExecutionMs property is set
 * and there isn't enough capacity to execute / retry the transaction.
 *
 * @author dward
 */
@AlfrescoPublicApi
