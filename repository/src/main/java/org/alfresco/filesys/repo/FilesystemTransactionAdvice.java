 ...
 *
 * <p>Needs to let the checked exceptions that are specified on the JLAN interfaces through. In
 * particular must avoid wrapping JLAN's checked exceptions with an AlfrescoRuntimeException (so
 * must throw IOException etc)
 *
 * <p>
 *
...
public class FilesystemTransactionAdvice implements MethodInterceptor {
    ...
    public Object invoke(final MethodInvocation methodInvocation)
            throws IOException, SMBException, Throwable {
