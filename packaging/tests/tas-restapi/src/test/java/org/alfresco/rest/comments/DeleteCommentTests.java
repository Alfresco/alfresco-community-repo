...
public class DeleteCommentTests extends RestTest {
  ...
  @TestRail(
    ...
    description = "Verify Admin user deletes comments with Rest API and status code is 204"
  )
  ...
  public void userIsNotAbleToDeleteCommentIfAuthenticationFails()
    throws Exception {
    restClient.authenticateUser(adminUserModel);
    commentModel =
      restClient
        .withCoreAPI()
        .usingResource(document)
        .addComment("New comment addded by admin");
  ...
  @TestRail(
    ...
    description = "Verify Manager user deletes own comments and status code is 204"
  )
  @Test(
  ...
  public void managerIsAbleToDeleteComments() throws Exception {
    ...
    commentModel =
      restClient
        .withCoreAPI()
        .usingResource(document)
        .addComment("New comment added by Manager");
    restClient
      .withCoreAPI()
      .usingResource(document)
      .deleteComment(commentModel);
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Collaborator user deletes own comments and status code is 204"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void collaboratorIsAbleToDeleteComments() throws Exception {
    ...
    commentModel =
      restClient
        .withCoreAPI()
        .usingResource(document)
        .addComment("New comment added by Collaborator");
    restClient
      .withCoreAPI()
      .usingResource(document)
      .deleteComment(commentModel);
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Contributor user deletes own comments and status code is 204"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void contributorIsAbleToDeleteComments() throws Exception {
    ...
    commentModel =
      restClient
        .withCoreAPI()
        .usingResource(document)
        .addComment("New comment added by Contributor");
    restClient
      .withCoreAPI()
      .usingResource(document)
      .deleteComment(commentModel);
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Consumer user can't delete comments created by admin user and status code is 403"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Admin user can't delete comments with inexistent ID and status code is 404"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Admin user can't delete comments with inexistend NodeId and status code is 404"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void userIsNotAbleToDeleteCommentWithInexistentNodeId()
    throws Exception {
    restClient.authenticateUser(adminUserModel);
    commentModel =
      restClient
    ...
    restClient
      .withCoreAPI()
      .usingResource(inexistentDocument)
      .deleteComment(commentModel);
    restClient.assertStatusCodeIs(HttpStatus.NOT_FOUND);
  }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Admin user can't delete deleted comments and status code is 404"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Manager user deletes comment created by admin" +
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Collaborator user can delete comment created by self" +
    " and status code is 204. Check with getComments for validation"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void collaboratorIsAbleToDeleteCommentCreatedBySelf()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Contributor user deletes comment created by self" +
    " and status code is 204. Check with getComments for validation"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Consumer user cannot delete comment created by admin" +
    " and status code is 403. Check with getComments for validation and check default error model schema."
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  public void consumerIsNotAbleToDeleteCommentCreatedByOthersDefaultErrorModelSchema()
    throws Exception {
    FileModel file = dataContent
      .usingSite(siteModel)
      .usingUser(adminUserModel)
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Manager can delete comment with version number"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify Manager user cannot delete comment with invalid node " +
  ...
  public void usingManagerDeleteCommentWithInvalidNode() throws Exception {
    ...
    restClient
      ...
      .assertLastError()
      .containsSummary(file.getNodeRef() + " was not found");
  ...
  @TestRail(
    section = { TestGroup.REST_API, TestGroup.COMMENTS },
    executionType = ExecutionType.REGRESSION,
    description = "Verify deleteComment from node with empty network id returns status code 401"
  )
  @Test(
    groups = { TestGroup.REST_API, TestGroup.COMMENTS, TestGroup.REGRESSION }
  )
