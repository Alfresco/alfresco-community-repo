...
public class ImapCheckFolderTests extends EmailTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify in IMAP client current directory/list of directories for site manager")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "User finds all its folders for IMAP Sites in Alfresco IMAP > Sites folder")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.SANITY})
    ...
    @TestRail(
            ...
            description =
                    "Verify in IMAP client current directory/list of directories for COLLABORATOR"
                            + " user - folder created by other user")
    ...
    public void collaboratorShouldGetCurrentWorkingDirectory() throws Exception {
        ...
        dataUser.usingUser(managerUser)
                .addUserToSite(collaborator, managerTestSite, UserRole.SiteCollaborator);
        ...
        imapProtocol
                ...
                .then()
                .assertThat()
                .contains(testFolder1, testFolder2);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify in IMAP client current directory/list of directories for CONTRIBUTOR"
                            + " user - folder created by other user")
    @Test(groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.CORE})
    public void contributorShouldGetCurrentWorkingDirectory() throws Exception {
        ...
        dataUser.usingUser(managerUser)
                .addUserToSite(contributor, managerTestSite, UserRole.SiteContributor);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify in IMAP client current directory/list of directories for CONSUMER user"
                            + " - folder created by other user")
    ...
    public void consumerShouldGetCurrentWorkingDirectory() throws Exception {
        ...
        dataUser.usingUser(managerUser)
                .addUserToSite(consumer, managerTestSite, UserRole.SiteConsumer);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized is not able to access document library section ( PUBLIC"
                            + " imap SITE)")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized is not able to access document library section ( Moderated"
                            + " imap SITE)")
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL},
            expectedExceptions = FolderNotFoundException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify unauthorized is not able to access document library section ( Private"
                            + " imap SITE)")
    @Test(
            groups = {TestGroup.PROTOCOLS, TestGroup.IMAP, TestGroup.FULL},
            expectedExceptions = MessagingException.class,
            expectedExceptionsMessageRegExp =
                    ".*Access Denied.*You do not have the appropriate permissions to perform this"
                            + " operation.*")
