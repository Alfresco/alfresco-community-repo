 ...
 * Node Targets
 *
 * <p>- list node (peer) associations - from source to target
 *
 * @author janv
 */
@RelationshipResource(
        ...
        title = "Node Targets")
public class NodeTargetsRelation extends AbstractNodeRelation
    ...
    public CollectionWithPagingInfo<Node> readAll(String sourceNodeId, Parameters parameters) {
        ...
        List<AssociationRef> assocRefs =
                nodeService.getTargetAssocs(sourceNodeRef, assocTypeQNameParam);
    ...
    public List<AssocTarget> create(
            String sourceNodeId, List<AssocTarget> entities, Parameters parameters) {
    ...
    public void delete(String sourceNodeId, String targetNodeId, Parameters parameters) {
        ...
        List<AssociationRef> assocRefs =
                nodeService.getTargetAssocs(
                        new NodeRef(StoreRef.STORE_REF_WORKSPACE_SPACESSTORE, sourceNodeId),
                        assocTypeQName);
