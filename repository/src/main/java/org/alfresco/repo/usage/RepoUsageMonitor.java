...
public class RepoUsageMonitor implements RepoUsageComponent.RestrictionObserver {
    ...
    public static final QName LOCK_USAGE =
            QName.createQName(NamespaceService.SYSTEM_MODEL_1_0_URI, "RepoUsageMonitor");
    ...
    private final QName vetoName =
            QName.createQName(NamespaceService.APP_MODEL_1_0_URI, "RepoUsageMonitor");
    ...
    public void setTransactionService(TransactionService transactionService) {
        try {
            ...
            throw new AlfrescoRuntimeException(
                    "The RepoUsageMonitor needs direct access to the TransactionServiceImpl");
        }
    }
    ...
    public void init() throws SchedulerException {
        ...
        final Trigger trigger =
                TriggerBuilder.newTrigger()
                        .withIdentity("rmt")
                        .withSchedule(
                                SimpleScheduleBuilder.repeatHourlyForever().withIntervalInHours(12))
    ...
    public void checkUsages() {
        final RetryingTransactionCallback<Void> checkWork =
                new RetryingTransactionCallback<Void>() {
                    ...
                    public Void execute() throws Throwable {
                        ...
                        if (restrictions.getUsers() == null
                                && restrictions.getDocuments() == null) {
                ...
                new RunAsWork<Void>() {
                    ...
                    public Void doWork() throws Exception {
                        transactionService
                                ...
                                .doInTransaction(checkWork, false);
                        return null;
                    }
                };
    ...
    public static class RepoUsageMonitorJob implements Job {
        public void execute(final JobExecutionContext context) throws JobExecutionException {
            ...
            final RepoUsageMonitor repoUsageMonitor =
                    (RepoUsageMonitor) jdm.get("RepoUsageMonitor");
