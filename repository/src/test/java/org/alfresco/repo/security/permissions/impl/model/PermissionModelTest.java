...
public class PermissionModelTest extends AbstractPermissionTest {
  ...
  public void testWoof() {
    ...
    PermissionReference ref = permissionModelDAO.getPermissionReference(
      null,
      "CheckOut"
    );
    Set<PermissionReference> answer = permissionModelDAO.getRequiredPermissions(
      ref,
      typeQname,
      aspectQNames,
      On.NODE
  ...
  public void testIncludePermissionGroups() {
    Set<PermissionReference> grantees = permissionModelDAO.getGranteePermissions(
  ...
  public void testGetGrantingPermissions() {
    Set<PermissionReference> granters = permissionModelDAO.getGrantingPermissions(
      SimplePermissionReference.getPermissionReference(
  ...
  public void testRequiredPermissions() {
    Set<PermissionReference> required = permissionModelDAO.getRequiredPermissions(
      SimplePermissionReference.getPermissionReference(
        QName.createQName("sys", "base", namespacePrefixResolver),
        "Read"
      ),
      ...
      try {
        ...
        RetryingTransactionCallback<Void> queryPermissionModel = new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            Set<PermissionReference> toTest = permissionModelDAO.getAllPermissions(
              QName.createQName("sys", "base", namespacePrefixResolver)
            );
        ...
        System.out.println(
          "End " + this.getName() + " with error " + e.getMessage()
        );
        e.printStackTrace();
      } finally {
