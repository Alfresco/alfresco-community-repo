...
// 2051 6 6 6 6 6 100
// /Users/steveglover/dev/mac/projects/HEAD/code/root/projects/repository/source/test-resources/quick /Users/steveglover/dev/mac/projects/HEAD/data/contentstore
/**
 * Creates content files in an existing content store.
 *
 * <p>Note: use with caution.
 *
 * @since 4.0
 */
                            ...
                            if (day.exists() || day.mkdir()) {
                                ...
                                for (int h = 1; h <= rand.nextInt(maxHours) + 1; h++) {
                                    ...
                                    if (hour.exists() || hour.mkdir()) {
                                        ...
                                        System.err.println(
                                                "Unable to create directory "
                                                        + hour.getAbsolutePath());
                                    }
                                }

                            } else {
                                System.err.println(
                                        "Unable to create directory " + day.getAbsolutePath());
                            }
                        }
