...
{
    /**
     * Creates a new {@link ReplicationDefinition} and sets the replication name and description to the specified values.
     * 
     * @param replicationName
     *            A unique identifier used to specify the created {@link ReplicationDefinition}
     * @param description
