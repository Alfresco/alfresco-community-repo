...
public interface People {
     ...
     *     <p>Request password reset (an email will be sent to the registered email of the given
     *     {@code userId}). The API returns a 202 response for a valid, as well as the invalid (does
     *     not exist or disabled) userId
