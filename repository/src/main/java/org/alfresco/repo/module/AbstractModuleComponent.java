...
/**
 * Implementation of a {@link org.alfresco.repo.module.ModuleComponent} to provide the basic
 * necessities.
 *
 * @see #executeInternal()
...
public abstract class AbstractModuleComponent implements ModuleComponent, BeanNameAware {
    ...
    public String toString() {
        ...
        sb.append("ModuleComponent")
                ...
                .append(sinceVersion)
                .append(", appliesFrom=")
                .append(appliesFromVersion)
                .append(", appliesTo=")
                .append(appliesToVersion)
                .append(", onceOnly=")
                .append(executeOnceOnly)
                .append("]");
        return sb.toString();
    }
    ...
    /**
     * Set the module service to register with. If not set, the component will not be automatically
     * started.
     *
    ...
    /**
     * Set the component name, which must be unique within the context of the module. If the is not
     * set, then the bean name will be used.
     *
     ...
     * {@link #setName(String) name} has been explicitly set.
     */
    ...
    /**
     * Set the component's description. This will automatically be I18N'ized, so it may just be a
     * resource bundle key.
     *
    ...
    /**
     * @param executeOnceOnly <tt>true</tt> to force execution of this component with each startup
     *     or <tt>false</tt> if it must only be executed once.
     */
    ...
    /**
     * The method that performs the actual work. For the most part, derived classes will only have
     * to override this method to be fully functional.
     *
