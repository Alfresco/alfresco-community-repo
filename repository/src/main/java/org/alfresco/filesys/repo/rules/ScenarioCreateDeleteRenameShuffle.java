 ...
 *
 * <p>a) New file created. b) Existing file deleted c) New file moved into place.
 */
        ...
        if (operation instanceof CreateFileOperation) {
            ...
            if (m.matches()) {
                if (logger.isDebugEnabled()) {
                    logger.debug(
                            "New Scenario Create Delete Rename Shuffle Instance pattern:"
                                    + strPattern);
                }

                ScenarioCreateDeleteRenameShuffleInstance instance =
                        new ScenarioCreateDeleteRenameShuffleInstance();
