...
public class CopyServiceImplTest extends TestCase {
    ...
    private static final QName PROP1_QNAME_MANDATORY =
            QName.createQName(TEST_TYPE_NAMESPACE, "prop1Mandatory");
    private static final QName PROP2_QNAME_OPTIONAL =
            QName.createQName(TEST_TYPE_NAMESPACE, "prop2Optional");

    private static final QName TEST_ASPECT_QNAME =
            QName.createQName(TEST_TYPE_NAMESPACE, "testAspect");
    private static final QName PROP3_QNAME_MANDATORY =
            QName.createQName(TEST_TYPE_NAMESPACE, "prop3Mandatory");
    private static final QName PROP4_QNAME_OPTIONAL =
            QName.createQName(TEST_TYPE_NAMESPACE, "prop4Optional");

    private static final QName PROP_QNAME_MY_NODE_REF =
            QName.createQName(TEST_TYPE_NAMESPACE, "myNodeRef");
    private static final QName PROP_QNAME_MY_ANY = QName.createQName(TEST_TYPE_NAMESPACE, "myAny");

    private static final QName PROP_QNAME_RESIDUAL_NODE_REF =
            QName.createQName(TEST_TYPE_NAMESPACE, "residualNodeRef");
    private static final QName PROP_QNAME_RESIDUAL_ANY =
            QName.createQName(TEST_TYPE_NAMESPACE, "residualAny");

    private static final QName TEST_MANDATORY_ASPECT_QNAME =
            QName.createQName(TEST_TYPE_NAMESPACE, "testMandatoryAspect");
    private static final QName PROP5_QNAME_MANDATORY =
            QName.createQName(TEST_TYPE_NAMESPACE, "prop5Mandatory");
    ...
    private static final QName TEST_CHILD_ASSOC_TYPE_QNAME =
            QName.createQName(TEST_TYPE_NAMESPACE, "contains");
    private static final QName TEST_CHILD_ASSOC_QNAME =
            QName.createQName(TEST_TYPE_NAMESPACE, "testChildAssocName");
    private static final QName TEST_ASSOC_TYPE_QNAME =
            QName.createQName(TEST_TYPE_NAMESPACE, "testAssocName");
    private static final QName TEST_CHILD_ASSOC_QNAME2 =
            QName.createQName(TEST_TYPE_NAMESPACE, "testChildAssocName2");

    private static final ContentData CONTENT_DATA_TEXT =
            new ContentData(null, "text/plain", 0L, "UTF-8");

    private static final String USER_1 = "User1";
    private static final String USER_2 = "User2";

    private static final QName TYPE_CUSTOM_CMIS_DOCUMENT =
            QName.createQName("{http://www.alfresco.org/model/cmis/custom}document");
    private static final QName PROP_CUSTOM_STRING =
            QName.createQName("{http://www.alfresco.org/model/cmis/custom}docprop_string");
    ...
    private void createTestModel() {
        ...
        M2Property propNodeRef =
                testType.createProperty("test:" + PROP_QNAME_MY_NODE_REF.getLocalName());
        propNodeRef.setMandatory(false);
        propNodeRef.setType("d:" + DataTypeDefinition.NODE_REF.getLocalName());
        propNodeRef.setMandatory(false);

        M2Property propAnyNodeRef =
                testType.createProperty("test:" + PROP_QNAME_MY_ANY.getLocalName());
        propAnyNodeRef.setMandatory(false);
        propAnyNodeRef.setType("d:" + DataTypeDefinition.ANY.getLocalName());
        propAnyNodeRef.setMandatory(false);

        M2ChildAssociation childAssoc =
                testType.createChildAssociation(
                        "test:" + TEST_CHILD_ASSOC_TYPE_QNAME.getLocalName());
        childAssoc.setTargetClassName("sys:base");
        childAssoc.setTargetMandatory(false);

        M2Association assoc =
                testType.createAssociation("test:" + TEST_ASSOC_TYPE_QNAME.getLocalName());
        ...
        M2Property prop3 =
                testAspect.createProperty("test:" + PROP3_QNAME_MANDATORY.getLocalName());
        ...
        M2Aspect testMandatoryAspect =
                model.createAspect("test:" + TEST_MANDATORY_ASPECT_QNAME.getLocalName());
        M2Property prop5 =
                testMandatoryAspect.createProperty("test:" + PROP5_QNAME_MANDATORY.getLocalName());
    ...
    public void testCopyToNewNodeWithPermissions() {
        permissionService.setPermission(
                sourceNodeRef, "Test", PermissionService.READ_PERMISSIONS, true);
        permissionService.setPermission(
                rootNodeRef, AuthenticationUtil.getGuestUserName(), PermissionService.READ, true);
        permissionService.setPermission(
                rootNodeRef,
    ...
    public void testCopyToNewNode() {
        ...
        ContentReader contentReader =
                contentService.getReader(copyWithContent, ContentModel.PROP_CONTENT);
    ...
    public void testCopiedFromAspect() {
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            assertEquals(
                    ...
                    new Pair<Integer, Integer>(i, i),
                    copies.getTotalResultCount());
            assertEquals("Incorrect number of copies", (i > 10 ? 10 : i), copies.getPage().size());

            // Since the results are paged, make sure that we have the correct results while we only
            // have a page
            ...
            copies =
                    copyService.getCopies(
                            nodeRef, sourceNodeRef, pageRequest); // Some arbitrary parent
        ...
        assertFalse(
                "Copy should not have cm:copiedfrom aspect. ",
                nodeService.hasAspect(firstCopy, ContentModel.ASPECT_COPIEDFROM));
    }

    /**
     * <a href="https://issues.alfresco.com/jira/browse/MNT-9580">MNT-9580: Daisy chained
     * cm:original associations are cascade-deleted when the first original is deleted </a>
     */
    public void testCopyOfCopyOfCopy() {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            assertEquals(
                    "Incorrect number of copies on iteration " + i, 1, copies.getPage().size());
    ...
    public void testCopyNodeWithRules() {
        ...
        assertEquals(
                rule.getAction().getActionDefinitionName(),
                copiedRule.getAction().getActionDefinitionName());
        ...
        // assertFalse(configurableService.getConfigurationFolder(sourceNodeRef) ==
        // configurableService.getConfigurationFolder(copy2));
        ...
        assertEquals(
                rule.getAction().getActionDefinitionName(),
                copiedRule2.getAction().getActionDefinitionName());
    }
    ...
    public void testRecursiveCopy() {
        ...
        copyService.copy(
                nodeOne, nodeThree, ContentModel.ASSOC_CHILDREN, ContentModel.ASSOC_CHILDREN, true);
    ...
    public void testALF11964_part1() {
        ...
        copyService.copy(
                nodeTwo, nodeOne, ContentModel.ASSOC_CHILDREN, ContentModel.ASSOC_CHILDREN, true);
    ...
    public void testCopyResidualProperties() throws Exception {
        ...
        Serializable propNodeRef =
                nodeService.getProperty(nodeOneCopy, PROP_QNAME_RESIDUAL_NODE_REF);
    ...
    public void testRelativeLinks() {
        ...
        NodeRef nodeFour =
                nodeService
                        ...
                        .getChildRef();
        nodeService.addChild(
                nodeFour, nodeThree, TEST_CHILD_ASSOC_TYPE_QNAME, TEST_CHILD_ASSOC_QNAME);
        ...
        for (ChildAssociationRef nodeOneCopyChild : nodeOneCopyChildren) {
            if (nodeOneCopyChild.getQName().equals(nodeTwoAssocName) == true) {
                ...
                List<ChildAssociationRef> nodeTwoCopyChildren =
                        nodeService.getChildAssocs(nodeTwoCopy);
        ...
        List<ChildAssociationRef> children =
                nodeService.getChildAssocs(
                        nodeFourCopy, RegexQNamePattern.MATCH_ALL, TEST_CHILD_ASSOC_QNAME);
        ...
        List<AssociationRef> assocs =
                nodeService.getTargetAssocs(nodeTwoCopy, TEST_ASSOC_TYPE_QNAME);
        assertNotNull(assocs);
        assertEquals(2, assocs.size());
        AssociationRef assoc0 = assocs.get(0);
        assertTrue(
                assoc0.getTargetRef().equals(nodeThreeCopy)
                        || assoc0.getTargetRef().equals(nodeNotCopied));
        AssociationRef assoc1 = assocs.get(1);
        assertTrue(
                assoc1.getTargetRef().equals(nodeThreeCopy)
                        || assoc1.getTargetRef().equals(nodeNotCopied));
        ...
        NodeRef value =
                (NodeRef) ruleAction.getParameterValue(MoveActionExecuter.PARAM_DESTINATION_FOLDER);
        assertNotNull(value);
    ...
    public void testCopyAndRename() {
        ...
        NodeRef folderNode =
                nodeService
                        .createNode(
                                rootNodeRef,
                                ContentModel.ASSOC_CHILDREN,
                                QName.createQName("{test}tempFolder"),
        ...
        NodeRef contentNode =
                nodeService
                        .createNode(
                                ...
                                QName.createQName("{test}renametest"),
                                ContentModel.TYPE_CONTENT,
                                props)
                        .getChildRef();
        ...
        NodeRef contentCopy =
                copyService.copy(
                        ...
                        folderNode,
                        ContentModel.ASSOC_CONTAINS,
                        QName.createQName("{test}bobbins"),
                        false);
    ...
    public void testETWOONE_244() {
        ...
        NodeRef folderNode =
                nodeService
                        .createNode(
                                ...
                                ContentModel.ASSOC_CHILDREN,
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, "tempFolder"),
                                ContentModel.TYPE_FOLDER,
                                propsFolder)
                        .getChildRef();
        Map<QName, Serializable> props = new HashMap<QName, Serializable>(1);
        ...
        NodeRef contentNode =
                nodeService
                        .createNode(
                                ...
                                ContentModel.ASSOC_CONTAINS,
                                QName.createQName(
                                        NamespaceService.CONTENT_MODEL_1_0_URI, "myDoc.txt"),
                                ContentModel.TYPE_CONTENT,
                                props)
                        .getChildRef();
        ...
        NodeRef copy =
                copyService.copyAndRename(
                        contentNode, folderNode, ContentModel.ASSOC_CONTAINS, null, false);
        assertEquals("Copy of myDoc.txt", nodeService.getProperty(copy, ContentModel.PROP_NAME));
        QName copyQName =
                QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, "Copy of myDoc.txt");
        ...
        copy =
                copyService.copyAndRename(
                        contentNode, folderNode, ContentModel.ASSOC_CONTAINS, null, false);
        assertEquals(
                "Copy of Copy of myDoc.txt", nodeService.getProperty(copy, ContentModel.PROP_NAME));
        copyQName =
                QName.createQName(
                        NamespaceService.CONTENT_MODEL_1_0_URI, "Copy of Copy of myDoc.txt");
        assertEquals(copyQName, nodeService.getPrimaryParent(copy).getQName());
        ...
        copy =
                copyService.copyAndRename(
                        contentNode, folderNode, ContentModel.ASSOC_CONTAINS, null, false);
        assertEquals(
                "Copy of Copy of Copy of myDoc.txt",
                nodeService.getProperty(copy, ContentModel.PROP_NAME));
        copyQName =
                QName.createQName(
     ...
     *
     * <p>Test copying of MLText values.
     */
    public void testCopyMLText() {
        ...
        if (desc instanceof MLText) {
            ...
            assertEquals(
                    "French description is wrong", FRENCH_DESCRIPTION, value.get(Locale.FRANCE));
            assertEquals(
                    "German description is wrong", GERMAN_DESCRIPTION, value.get(Locale.GERMAN));
        } else {
            I18NUtil.setLocale(Locale.FRANCE);
            assertEquals(
                    "French description is wrong",
                    FRENCH_DESCRIPTION,
                    nodeService.getProperty(copy, ContentModel.PROP_DESCRIPTION));

            I18NUtil.setLocale(Locale.GERMAN);
            assertEquals(
                    "German description is wrong",
                    GERMAN_DESCRIPTION,
                    nodeService.getProperty(copy, ContentModel.PROP_DESCRIPTION));
        }
    }
    ...
    /**
     * Creates some content as one user, then as another checks: * If you don't have read
     * permissions to the source you can't copy * If you don't have write permissions to the target
     * you can't copy * If you do, you can copy just fine
     */
    public void testCopyUserPermissions() throws Exception {
        ...
        permissionService.setPermission(
                targetNodeRef, USER_2, PermissionService.CONTRIBUTOR, false);
        AuthenticationUtil.setFullyAuthenticatedUser(USER_2);
        ...
        assertEquals(
                nodeTitle,
                ((MLText) nodeService.getProperty(copied, ContentModel.PROP_TITLE))
                        .getDefaultValue());
        ...
        assertEquals(
                description,
                ((MLText) nodeService.getProperty(copied, ContentModel.PROP_DESCRIPTION))
                        .getDefaultValue());
    }
    ...
    private void checkCopiedNode(
        ...
        if (newCopy == true) {
            if (sameStore == true) {
                ...
                boolean hasCopyAspect =
                        nodeService.hasAspect(destinationNodeRef, ContentModel.ASPECT_COPIEDFROM);
                assertTrue("Missing aspect: " + ContentModel.ASPECT_COPIEDFROM, hasCopyAspect);
                List<AssociationRef> assocs =
                        nodeService.getTargetAssocs(
                                destinationNodeRef, ContentModel.ASSOC_ORIGINAL);
                ...
                assertEquals(
                        "Copy refers to incorrect original source",
                        sourceNodeRef,
                        checkSourceNodeRef);
            } else {
        ...
        Map<QName, Serializable> destinationProperties =
        ...
        List<AssociationRef> destinationTargets =
                nodeService.getTargetAssocs(destinationNodeRef, TEST_ASSOC_TYPE_QNAME);
        ...
        for (ChildAssociationRef ref : childAssocRefs) {
            if (ref.getQName().equals(TEST_CHILD_ASSOC_QNAME2) == true) {
                // Since this child is non-primary in the source it will always be non-primary in
                // the destination
    ...
    public void testCopyNullPropertyForAlf10712() throws Exception {
        ...
        assertNull(
                (PROP_CUSTOM_STRING.toString()
                        + " property must be set to NULL on the source node!"),
                customPropValue);
        ...
        assertNull(
                (PROP_CUSTOM_STRING.toString()
                        + " property must be set to NULL on the target node after copying!"),
                updatedCustomProp);
    }
    ...
    public void testALF17549() throws Exception {
        ...
        NodeRef sourceNodeRef =
                nodeService
                        .createNode(
                                this.rootNodeRef,
                                ContentModel.ASSOC_CONTAINS,
                                QName.createQName("{test}" + sourceName),
                                ContentModel.TYPE_CONTENT,
                                props)
                        .getChildRef();
        ...
        NodeRef targetNodeRef =
                nodeService
                        .createNode(
                                this.rootNodeRef,
                                ContentModel.ASSOC_CONTAINS,
                                QName.createQName("{test}targetNode"),
                                ContentModel.TYPE_FOLDER)
                        .getChildRef();

        List<ChildAssociationRef> childAssoc =
                nodeService.getChildAssocs(
                        targetNodeRef,
                        ContentModel.ASSOC_CONTAINS,
                        QName.createQName("{test}sourceNode.html"));
        ...
        action.setParameterValue(
                TransformActionExecuter.PARAM_MIME_TYPE, MimetypeMap.MIMETYPE_HTML);
        ...
        action.setParameterValue(
                TransformActionExecuter.PARAM_ASSOC_TYPE_QNAME, ContentModel.ASSOC_CONTAINS);
    ...
    public void testCopyWorkingCopyForAlf8863() throws Exception {
        ...
        String newNameAfterCopy =
                copyService.getTopLevelNodeNewName(
                        sourceNodeRef,
                        rootNodeRef,
                        ContentModel.ASSOC_CHILDREN,
                        assocRef.getQName());
        ...
        NodeRef copyRef =
                copyService.copyAndRename(
                        workingCopyRef, rootNodeRef, ContentModel.ASSOC_CHILDREN, null, false);
