...
public class PersonNetwork
  implements Network, Comparable<PersonNetwork>, ExpectedComparison {
  ...
  public static PersonNetwork parseNetworkMember(JSONObject jsonObject) {
    ...
    PersonNetwork networkMember = new PersonNetwork(
      homeNetwork,
      NetworkImpl.parseNetwork(jsonObject)
    );
    return networkMember;
  }

  public static ListResponse<PersonNetwork> parseNetworkMembers(
    ...
    ListResponse<PersonNetwork> resp = new ListResponse<PersonNetwork>(
      paging,
      networkMembers
    );
    return resp;
