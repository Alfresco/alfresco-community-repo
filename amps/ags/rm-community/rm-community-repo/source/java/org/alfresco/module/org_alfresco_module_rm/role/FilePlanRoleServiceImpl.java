...
public class FilePlanRoleServiceImpl implements FilePlanRoleService, RecordsManagementModel {
    ...
    private static final String BOOTSTRAP_ROLE_JSON_LOCATION =
            "alfresco/module/org_alfresco_module_rm/security/rm-default-roles-bootstrap.json";
    ...
    public void setBootstrapImporterModuleComponent(
            BootstrapImporterModuleComponent bootstrapImporterModuleComponent) {
        this.bootstrapImporterModule = bootstrapImporterModuleComponent;
    }

    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#setupFilePlanRoles(NodeRef)
     */
    @Override
    public void setupFilePlanRoles(final NodeRef filePlan) {
        ...
        if (nodeService.exists(filePlan)) {
            List<NodeRef> systemContainers =
                    AuthenticationUtil.runAsSystem(
                            new AuthenticationUtil.RunAsWork<List<NodeRef>>() {
                                public List<NodeRef> doWork() {
                                    List<NodeRef> systemContainers = new ArrayList<>(3);

                                    // In a multi tenant store we need to initialize the rm config
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#tearDownFilePlanRoles(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
        ...
        AuthenticationUtil.runAsSystem(
                new AuthenticationUtil.RunAsWork<Object>() {
                    public Object doWork() {
                        ...
                        String allRolesGroup =
                                authorityService.getName(
                                        AuthorityType.GROUP, getAllRolesGroupShortName(filePlan));
                        Set<String> groups =
                                authorityService.getContainedAuthorities(
                                        AuthorityType.GROUP, allRolesGroup, true);
     ...
     */
    private void bootstrapDefaultRoles(
            final NodeRef filePlan, final List<NodeRef> systemContainers) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                InputStream is =
                                        getClass()
                                                .getClassLoader()
                                                .getResourceAsStream(BOOTSTRAP_ROLE_JSON_LOCATION);
                                if (is == null) {
                                    throw new AlfrescoRuntimeException(
                                            "Could not load default bootstrap roles configuration");
                                }
                                array = new JSONArray(FileUtils.convertStreamToString(is));
                            } catch (IOException ioe) {
                                throw new AlfrescoRuntimeException(
                                        "Unable to load rm-default-roles-bootstrap.json"
                                                + " configuration file.",
                                        ioe);
                            }
                                ...
                                if (object.has(JSON_NAME)) {
                                    ...
                                    if (existsRole(filePlan, name)) {
                                        throw new AlfrescoRuntimeException(
                                                "The bootstrap role "
                                                        + name
                                                        + " already exists on the rm root node "
                                                        + filePlan.toString());
                                    }
                                } else {
                                    throw new AlfrescoRuntimeException(
                                            "No name given to default bootstrap role.  Check json"
                                                    + " configuration file.");
                                }
                                ...
                                if (object.has(JSON_CAPABILITIES)) {
                                    ...
                                    for (int index = 0; index < arrCaps.length(); index++) {
                                        ...
                                        Capability capability =
                                                capabilityService.getCapability(capName);
                                        if (capability == null) {
                                            throw new AlfrescoRuntimeException(
                                                    "The capability '"
                                                            + capName
                                                            + "' configured for the deafult"
                                                            + " boostrap role '"
                                                            + name
                                                            + "' is invalid.");
                                        }
                            ...
                            throw new AlfrescoRuntimeException(
                                    "Error loading json configuration file"
                                            + " rm-default-roles-bootstrap.json",
                                    exception);
                        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.RecordsManagementSecurityService#getRolesByUser(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#getRolesByUser(NodeRef,
     *     String, boolean)
     */
    @Override
    public Set<Role> getRolesByUser(
            final NodeRef rmRootNode, final String user, final boolean includeSystemRoles) {
        return AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Set<Role>>() {
                    public Set<Role> doWork() {
                        Set<Role> result = new HashSet<>(13);
                        ...
                        for (String roleAuthority : roleAuthorities) {
                            Set<String> users =
                                    authorityService.getContainedAuthorities(
                                            AuthorityType.USER, roleAuthority, false);
                            if (users.contains(user)
                                    && (includeSystemRoles || !isSystemRole(roleAuthority))) {
                                String groupShortName =
                                        authorityService.getShortName(roleAuthority);
                                String name = getShortRoleName(groupShortName, rmRootNode);
                                String displayLabel =
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#getRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    public Role getRole(final NodeRef rmRootNode, final String role) {
        return AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Role>() {
                    public Role doWork() {
                        Role result = null;

                        String roleAuthority =
                                authorityService.getName(
                                        AuthorityType.GROUP, getFullRoleName(role, rmRootNode));
    ...
    /**
     * @see org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#existsRole(NodeRef,
     *     java.lang.String)
     */
                        ...
                        new AuthenticationUtil.RunAsWork<Boolean>() {
                            public Boolean doWork() {
                                String fullRoleName =
                                        authorityService.getName(
                                                AuthorityType.GROUP,
                                                getFullRoleName(role, rmRootNode));

                                String zone = getZoneName(rmRootNode);
                                Set<String> roles =
                                        authorityService.getAllAuthoritiesInZone(
                                                zone, AuthorityType.GROUP);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#hasRMAdminRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     *     <p>TODO .. change this to check a property of the role its self
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.RecordsManagementSecurityService#createRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String, java.lang.String, java.util.Set)
     */
    public Role createRole(
            final NodeRef filePlan,
            final String role,
            final String roleDisplayLabel,
                ...
                new AuthenticationUtil.RunAsWork<Role>() {
                    public Role doWork() {
                        ...
                        if (authorityService.authorityExists(
                                authorityService.getName(AuthorityType.GROUP, fullRoleName))) {
                            throw new AlfrescoRuntimeException(
                                    "The role "
                                            + role
                                            + " already exists for root rm node "
                                            + filePlan.getId());
                        }
                        ...
                        // TODO .. we should be creating a permission set containing all the
                        // capabilities and then assigning that
                        //         single permission group to the file plan .. would be tidier

                        // Assign the various capabilities to the group on the root records
                        // management node
                        if (capabilities != null) {
                            for (Capability capability : capabilities) {
                                permissionService.setPermission(
                                        filePlan, roleGroup, capability.getName(), true);
                            }
                        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.RecordsManagementSecurityService#updateRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String, java.lang.String, java.util.Set)
     */
    public Role updateRole(
            final NodeRef rmRootNode,
            final String role,
            final String roleDisplayLabel,
            final Set<Capability> capabilities) {
        return AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Role>() {
                    public Role doWork() {
                        ...
                        for (Capability capability : capabilities) {
                            permissionService.setPermission(
                                    rmRootNode, roleAuthority, capability.getName(), true);
                        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.RecordsManagementSecurityService#deleteRole(NodeRef,String)
     */
    public void deleteRole(final NodeRef rmRootNode, final String role) {
        ...
        if (ROLE_ADMIN.equals(role)) {
            throw new AlfrescoRuntimeException(
                    "Can not delete the records management administration role.");
        }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#getUsersAssignedToRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    @Override
    ...
    /**
     * Gets all the authorities of a given type directly assigned to the given role in the file
     * plan.
     *
     * @param filePlan file plan
     ...
     */
    private Set<String> getAuthoritiesAssignedToRole(
            final NodeRef filePlan, final String roleName, final AuthorityType authorityType) {
        return AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Set<String>>() {
                    public Set<String> doWork() {
                        ...
                        if (role == null) {
                            throw new AlfrescoRuntimeException(
                                    "Can not get authorities for role "
                                            + roleName
                                            + ", because it does not exist. (filePlan="
                                            + filePlan.toString()
                                            + ")");
                        }
                        return authorityService.getContainedAuthorities(
                                authorityType, role.getRoleGroupName(), true);
                    }
                },
                AuthenticationUtil.getSystemUserName());
    }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#getGroupsAssignedToRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#getAllAssignedToRole(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.RecordsManagementSecurityService#assignRoleToAuthority(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String, java.lang.String)
     */
    public void assignRoleToAuthority(
            final NodeRef filePlan, final String role, final String authorityName) {
        AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Void>() {
                    public Void doWork() {
                        if (authorityService.authorityExists(authorityName)
                            ...
                            String roleAuthority =
                                    authorityService.getName(
                                            AuthorityType.GROUP, getFullRoleName(role, filePlan));
                            try {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.role.FilePlanRoleService#unassignRoleFromAuthority(org.alfresco.service.cmr.repository.NodeRef,
     *     java.lang.String, java.lang.String)
     */
    @Override
    public void unassignRoleFromAuthority(
            final NodeRef filePlan, final String role, final String authorityName) {
        AuthenticationUtil.runAs(
                new AuthenticationUtil.RunAsWork<Void>() {
                    public Void doWork() {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.security.RecordsManagementSecurityService#getAllRolesContainerGroup(org.alfresco.service.cmr.repository.NodeRef)
     */
    @Override
