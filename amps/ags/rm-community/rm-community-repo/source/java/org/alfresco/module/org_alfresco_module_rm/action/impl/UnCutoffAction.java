    ...
    protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
        if (getNodeService().hasAspect(actionedUponNodeRef, ASPECT_DISPOSITION_LIFECYCLE)
            ...
            DispositionAction da =
                    getDispositionService().getLastCompletedDispostionAction(actionedUponNodeRef);
            ...
            getNodeService()
                    .setProperty(da.getNodeRef(), PROP_DISPOSITION_ACTION_COMPLETED_AT, null);
            getNodeService()
                    .setProperty(da.getNodeRef(), PROP_DISPOSITION_ACTION_COMPLETED_BY, null);
        }
    }
}
