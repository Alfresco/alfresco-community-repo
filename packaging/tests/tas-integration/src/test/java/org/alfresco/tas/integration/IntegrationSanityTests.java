...
public class IntegrationSanityTests extends IntegrationTest {
  ...
  public void usersAreAbleToManageFavorites() throws Exception {
    ...
    STEP(
      "* 7. U2 gets favorites using REST API. Assert that only the file is favorite."
    );
    restAPI
      .withCoreAPI()
      .usingAuthUser()
      ...
      .entriesListContains(
        "targetGuid",
        testFile1.getNodeRef().replace(";1.0", "")
      )
      .and()
  ...
  public void userIsAbleToManageFilesAndFolders() throws Exception {
    ...
    FolderModel renamedFolder = cmisAPI
      .usingResource(testFolder1)
      .getFolders()
      .get(0);
    Assert.assertEquals(
      renamedFolder.getName(),
      "F2 rename",
      "User2 is able to see the renamed folder"
    );
  }
  ...
  public void usersAreAbleToManageFavoriteFiles() throws Exception {
    ...
    testSitePublic = dataSite.usingUser(testUser1).createPublicRandomSite();
    restAPI.authenticateUser(dataUser.getAdminUser());
    testSitePublic.setGuid(
      restAPI.withCoreAPI().usingSite(testSitePublic).getSite().getGuid()
    );
    ...
    restAPI
      ...
      .entriesListContains(
        "targetGuid",
        testFile2.getNodeRef().replace(";1.0", "")
      )
      .and()
      .entriesListContains(
        "targetGuid",
        testFile4.getNodeRef().replace(";1.0", "")
      )
      .and()
      .paginationField("totalItems")
      .is("3");
  ...
  public void siteManagerIsAbleToManageTags() throws Exception {
    ...
    testFile1 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file1 content");
    testFile2 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file2 content");
    ftpProtocol
      .authenticateUser(testUser1)
      .usingSite(testSitePublic)
      .createFile(testFile1)
    ...
    testFile3 =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "file3 content");
    testFile4 = FileModel.getRandomFileModel(FileType.MSWORD, "file4 content");
    webDavProtocol
      .authenticateUser(testUser1)
      .usingResource(testFolder1)
  ...
  public void siteManagerIsAbleToManageSiteMembership() throws Exception {
    ...
    restAPI
      .withCoreAPI()
      .usingUser(testUser3)
      .deleteSiteMembershipRequest(testSiteModerated);
  ...
  public void userIsAbleToManageFavoriteSites() throws Exception {
    ...
    restAPI
      .withCoreAPI()
      .usingAuthUser()
      .deleteSiteFromFavorites(testSitePublic);
  ...
  public void siteManagerIsAbleToCancelSiteMembership() throws Exception {
    ...
    STEP(
      "* 7. Using REST API, check that u3 request isn't in site membership request list"
    );
    restAPI
      .withCoreAPI()
      .usingUser(testUser3)
    ...
    STEP(
      "* 9. Using REST API, check that u2 request isn't in site membership request list."
    );
    restAPI
      .withCoreAPI()
      .usingUser(testUser2)
  ...
  public void userIsAbleToCopyFileToAFolderFromAnotherSite() throws Exception {
    ...
    secondTestSitePublic =
      dataSite.usingUser(testUser1).createPublicRandomSite();

    STEP(
      "* 5. U1 creates a folder in second site's document library using FTP"
    );
    testFolder1 = FolderModel.getRandomFolderModel();
    ftpProtocol
      .authenticateUser(testUser1)
  ...
  public void userIsAbleToMoveFileToAFolderFromAnotherSite() throws Exception {
    ...
    STEP(
      "* 5. U1 creates a folder in second site's document library using WebDAV"
    );
    testFolder1 = FolderModel.getRandomFolderModel();
    webDavProtocol
      .authenticateUser(testUser1)
  ...
  public void userIsAbleToGetASiteMember() throws Exception {
    ...
    restAPI
      ...
      .containsSummary(
        String.format(
          "The relationship resource was not found for the entity with id: %s and a relationship id of %s",
          testUser2.getUsername(),
          testSitePublic.getId()
        )
      );
  }
  ...
  public void copyFolderToModeratedSiteByUninvitedUser() throws Exception {
    ...
    testSitePublic = dataSite.usingUser(testUser1).createPublicRandomSite();
    testSiteModerated =
      dataSite.usingUser(testUser2).createModeratedRandomSite();
  ...
  public void moveFileToPrivateSiteByUninvitedUser() throws Exception {
    ...
    STEP(
      "5. U1 tries to move his file to folder from U2 private site using IMAP. 6. Verify file is not moved. U1 is not authorized to access the private site "
    );
