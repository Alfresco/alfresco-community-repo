...
public class CowEntityResource
  implements
    EntityResourceAction.ReadByIdWithResponse<Goat>,
  ...
  public static final Cache CACHE_COW = new Cache(
  ...
  @Override
  public CollectionWithPagingInfo<Goat> readAll(
    Parameters params,
    WithResponse withResponse
  ) {
    return CollectionWithPagingInfo.asPaged(
      params.getPaging(),
      Arrays.asList(new Goat("Cow1"))
    );
  }
