...
public class VirtualVersionServiceExtensionTest
  ...
  public void setUp() throws Exception {
    ...
    node2_1 =
      nodeService.getChildByName(node2, ContentModel.ASSOC_CONTAINS, "Node2_1");
  }

  @Test
  public void testGetCurrentVersion() throws Exception {
    ChildAssociationRef contentWithVersionsAssocRef = createContent(
      node2_1,
      "ContentWithVersions"
    );
    ...
    Version newCurrentVersion = versionService.getCurrentVersion(
      contentWithVersionsNodeRef
    );
  ...
  private void assertSameVersion(
  ...
  public void testCreateVersion() throws Exception {
    ...
    NodeRef actualContentWithVersionsNodeRef = reference.execute(
    ...
    VersionHistory actualVersionHistory = versionService.getVersionHistory(
