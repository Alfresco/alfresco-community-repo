...
public class TestNetworks extends EnterpriseTestApi {
    ...
    public void testPersonNetworks() throws Exception {
        ...
        {
            /**
             * Test http://<host>:<port>/alfresco/a i.e. tenant servlet root - should return user's
             * networks
             */
            ...
            PublicApiClient.ExpectedErrorResponse errorResponse =
...

            {
                ...
                ListResponse<PersonNetwork> resp =
                        PersonNetwork.parseNetworkMembers(response.getJsonResponse());
