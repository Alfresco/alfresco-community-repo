 ...
 *
 * <p>Automatically cuts off eligible nodes.
 *
...
public class ScheduledDispositionJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        NodeService nodeService =
                (NodeService) context.getJobDetail().getJobDataMap().get("nodeService");
        ...
        String query =
                "+ASPECT:\"rma:record\" +ASPECT:\"rma:dispositionSchedule\""
                        + " +@rma\\:dispositionAsOf:"
                        + dateRange;

        SearchService search =
                (SearchService) context.getJobDetail().getJobDataMap().get("searchService");
        ResultSet results =
                search.query(
        ...
        for (NodeRef node : resultNodes) {
            String dispActionName =
                    (String)
                            nodeService.getProperty(
                                    node, RecordsManagementModel.PROP_DISPOSITION_ACTION_NAME);
