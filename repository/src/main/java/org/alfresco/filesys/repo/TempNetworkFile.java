...
public class TempNetworkFile
  ...
  implements NetworkFileStateInterface, NetworkFileLegacyReferenceCount {
  ...
  public String toString() {
    return (
      "TempNetworkFile:" + getFullName() + " path: " + m_file.getAbsolutePath()
    );
  }
  ...
  public void setModificationDateSetDirectly(
    boolean modificationDateSetDirectly
  ) {
