...
public class SetContentTests extends CmisTest {
  ...
  public void siteManagerSetFileContentForFileCreatedBySelf() throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "first content");
    cmisApi
  ...
  public void siteManagerCanSetContentWithFalseOverwriteToDocWithNoContent()
    throws Exception {
  ...
  public void siteManagerCanSetContentWithFalseOverwriteToDocWithContent()
    throws Exception {
  ...
  public void managerCanSetFileContentForFileCreatedByOtherUser()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "first content");
    cmisApi
  ...
  public void contributorCannotSetFileContentForFileCreatedByOtherUser()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "first content");
    cmisApi
  ...
  public void contributorCanSetFileContentForFileCreatedBySelf()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "first content");
    cmisApi
  ...
  public void collaboratorCanSetFileContentForFileCreatedByOtherUser()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "first content");
    cmisApi
  ...
  public void collaboratorCanSetFileContentForFileCreatedBySelf()
    throws Exception {
    testFile =
      FileModel.getRandomFileModel(FileType.TEXT_PLAIN, "first content");
    cmisApi
  ...
  public void unauthorizedUserCannotSetContentToPrivateSiteDoc()
    throws Exception {
