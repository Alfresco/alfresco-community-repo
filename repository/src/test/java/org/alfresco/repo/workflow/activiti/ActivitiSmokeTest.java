...
public class ActivitiSmokeTest extends TestCase {
  ...
  public void testDeploy() throws Exception {
    ...
    try {
      ...
      ProcessInstance instanceInDb = findProcessInstance(
        runtimeService,
        instanceId
      );
  ...
  private Deployment deployDefinition(RepositoryService repoService)
    throws IOException {
    ClassPathResource resource = new ClassPathResource(
      "org/alfresco/repo/workflow/activiti/testTransaction.bpmn20.xml"
    );
    Deployment deployment = repoService
      .createDeployment()
  ...
  private ProcessEngine buildProcessEngine() {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource(properties)
      .buildProcessEngine();
    return engine;
  }
  ...
  private ProcessInstance findProcessInstance(
    ...
    ProcessInstance instanceInDb = runtimeService
