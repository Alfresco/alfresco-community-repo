...
public class ThumbnailServiceImplTest extends BaseAlfrescoSpringTest {
  ...
  public void before() throws Exception {
    ...
    this.scriptThumbnailService =
      (ScriptThumbnailService) this.applicationContext.getBean(
          "thumbnailServiceScript"
        );
    this.mimetypeMap =
      (MimetypeMap) this.applicationContext.getBean("mimetypeService");
    this.scriptService =
      (ScriptService) this.applicationContext.getBean("ScriptService");
    this.services =
      (ServiceRegistry) this.applicationContext.getBean("ServiceRegistry");
    this.transactionService =
      (TransactionService) this.applicationContext.getBean(
          "transactionService"
        );
    this.failureHandlingOptions =
      (FailureHandlingOptions) this.applicationContext.getBean(
          "standardFailureOptions"
        );
    ...
    synchronousTransformClient =
      (SynchronousTransformClient) applicationContext.getBean(
        "synchronousTransformClient"
      );
    converter =
    ...
    this.folder =
      this.secureNodeService.createNode(
          this.rootNodeRef,
  ...
  public static void createTestThumbnail(ThumbnailRegistry thumbnailRegistry) {
    ...
    if (thumbnailRegistry.getThumbnailDefinition(TEST_THUMBNAIL) == null) {
      ThumbnailDefinition doclib = thumbnailRegistry.getThumbnailDefinition(
        "doclib"
      );
      ThumbnailDefinition testThumbnailDefinition = new ThumbnailDefinition(
        doclib.getMimetype(),
        doclib.getTransformationOptions(),
        TEST_THUMBNAIL
      );
      testThumbnailDefinition.setFailureHandlingOptions(
        doclib.getFailureHandlingOptions()
      );
      testThumbnailDefinition.setPlaceHolderResourcePath(
        doclib.getPlaceHolderResourcePath()
      );
  ...
  private void checkTransformer() {
    if (
      ...
      fail(
        "Image transformer is not working.  Please check your image conversion command setup."
      );
    }
  }
  ...
  public void testCreateRenditionThumbnailFromImage() throws Exception {
    ...
    ThumbnailDefinition details = thumbnailService
    ...
    NodeRef jpgOrig = createOriginalContent(
      this.folder,
      MimetypeMap.MIMETYPE_IMAGE_JPEG
    );
  ...
  public void testCreateRenditionThumbnailFromPdf() throws Exception {
    ...
    NodeRef pdfOrig = createOriginalContent(
      this.folder,
  ...
  public void testCreateRenditionThumbnailFromPdfPage2() throws Exception {
    ...
    thumbnailService
      .getThumbnailRegistry()
      .addThumbnailDefinition(thumbnailDefinition);
    ...
    ContentReader reader =
      this.contentService.getReader(thumbnail0, ContentModel.PROP_CONTENT);
  ...
  public void testCreateThumbnailFromImage() throws Exception {
    ...
    NodeRef gifOrig = createOriginalContent(
      this.folder,
      ...
      .doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ThumbnailDefinition thumbnailDef = thumbnailService
              .getThumbnailRegistry()
              .getThumbnailDefinition(TEST_THUMBNAIL);

            Action createThumbnailAction = ThumbnailHelper.createCreateThumbnailAction(
              thumbnailDef,
              services
            );
      ...
      .doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            Map<String, FailedThumbnailInfo> failedThumbnails = thumbnailService.getFailedThumbnails(
              corruptNode
            );
            assertEquals(
            ...
            final FailedThumbnailInfo doclibFailureInfo = failedThumbnails.get(
              TEST_THUMBNAIL
            );
  ...
  public void testRuleExecutionOnFailedThumbnailChild() throws Exception {
    ...
    Action action =
      this.actionService.createAction(AddFeaturesActionExecuter.NAME, params);
    ...
    final NodeRef corruptNode = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
    ...
    final NodeRef failedThumbnailNode = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>() {
          public NodeRef execute() throws Throwable {
  ...
  public void testCreateTransientlyFailingThumbnail() throws Exception {
    ...
    File testFile = AbstractContentTransformerTest.loadNamedQuickTestFile(
      "quick.pdf"
    );
    ...
    // It should not be renditioned and should not be marked as having any failed thumbnails.
    assertFalse(
      secureNodeService.hasAspect(testNode, RenditionModel.ASPECT_RENDITIONED)
    );
    assertFalse(
      secureNodeService.hasAspect(
        testNode,
  ...
  public void testThumbnailUpdate() throws Exception {
    ...
    assertEquals(
      ...
      secureNodeService.getType(thumbnail1)
    );

    // Update the thumbnail
    this.thumbnailService.updateThumbnail(
        thumbnail1,
        imageTransformationOptions
      );
      ...
      .doInTransaction(
        new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            TestNodeDeleterListener testNodeDeleterListener = new TestNodeDeleterListener(
              pdfOrig
            );
   ...
   */
  @Test
  public void testLastThumbnailModificationDataContentUpdates()
    throws Exception {
    final NodeRef pdfOrig = createOriginalContent(
      this.folder,
      MimetypeMap.MIMETYPE_PDF
    );
    QName qname = QName.createQName(
    ...
    String lastThumbnailDataV1 =
      (
        (List<String>) this.secureNodeService.getProperty(
            pdfOrig,
  ...
  public void testLastThumbnailModificationDataContentCopy() throws Exception {
    ...
    // Get initial value of property "Last thumbnail modification data"
    List<String> lastThumbnailData = (List<String>) this.secureNodeService.getProperty(
        pdfOrig,
        ContentModel.PROP_LAST_THUMBNAIL_MODIFICATION_DATA
      );
    ...
    final NodeRef pdfCopy = copyService.copy(
      pdfOrig,
      this.folder,
      ContentModel.ASSOC_CONTAINS,
      QName.createQName("copyOfOriginal")
    );
    List<String> lastThumbnailDataCopy = (List<String>) this.secureNodeService.getProperty(
        pdfCopy,
        ContentModel.PROP_LAST_THUMBNAIL_MODIFICATION_DATA
      );
  ...
  public void testLockedContent() throws Exception {
    ...
    ThumbnailDefinition details = thumbnailService
      .getThumbnailRegistry()
      .getThumbnailDefinition(qname.getLocalName());
    NodeRef thumbnail = thumbnailService.createThumbnail(
      pdfOrig,
      ContentModel.PROP_CONTENT,
      MimetypeMap.MIMETYPE_IMAGE_JPEG,
      details.getTransformationOptions(),
  ...
  private void setNewContent(
    NodeRef noderef,
    String quickFileName,
    String mimetype
  ) throws IOException {
    String ext = this.mimetypeMap.getExtension(mimetype);
    File origFile = AbstractContentTransformerTest.loadNamedQuickTestFile(
      quickFileName + ext
    );
  ...
  private static class ExpectedAssoc {
    ...
    public ExpectedAssoc(
      QNamePattern assocTypeQName,
      String assocName,
      int count
    ) {
      super();
  ...
  private void checkRenditioned(
    ...
    List<ExpectedAssoc> expectedAssocs
  ) {
    assertTrue(
    ...
    for (ExpectedAssoc expectedAssoc : expectedAssocs) {
      ...
      List<ChildAssociationRef> assocs =
        this.secureNodeService.getChildAssocs(
            contentNodeRef,
            expectedAssoc.getAssocTypeQName(),
            qNamePattern
          );
  ...
  private void checkRendition(String thumbnailName, NodeRef thumbnail) {
    ...
    assertTrue(
      "Thumbnail should have been a rendition",
    ...
    ContentData thumbnailData = (ContentData) secureNodeService.getProperty(
      thumbnail,
      ContentModel.PROP_CONTENT
    );
  ...
  private void outputThumbnailTempContentLocation(
    NodeRef thumbnail,
    String ext,
    String message
  ) throws IOException {
    ...
    ContentReader reader =
      this.contentService.getReader(thumbnail, ContentModel.PROP_CONTENT);
    reader.getContent(tempFile);
  ...
  private NodeRef createOriginalContent(
    ...
    ContentWriter writer =
      this.contentService.getWriter(node, ContentModel.PROP_CONTENT, true);
    writer.setMimetype(mimetype);
    writer.setEncoding("UTF-8");
    writer.putContent(origFile);
  ...
  private NodeRef createCorruptedContent(NodeRef parentFolder)
    throws IOException {
    // The below pdf file has been truncated such that it is identifiable as a PDF but otherwise corrupt.
    File corruptPdfFile = AbstractContentTransformerTest.loadNamedQuickTestFile(
      "quickCorrupt.pdf"
    );
  ...
  public void testAutoUpdate() throws Exception {
    ...
    final NodeRef jpgOrig = createOriginalContent(
      this.folder,
      MimetypeMap.MIMETYPE_IMAGE_JPEG
    );

    ThumbnailDefinition details =
      this.thumbnailService.getThumbnailRegistry()
        .getThumbnailDefinition("medium");
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            File origFile = AbstractContentTransformerTest.loadQuickTestFile(
              ext
            );
  ...
  public void testHTMLToImageAndSWF() throws Exception {
    NodeRef nodeRef = createOriginalContent(
      this.folder,
    ...
    Map<String, String> options = converter.getOptions(
      transformationOptions,
      MimetypeMap.MIMETYPE_HTML,
      def.getMimetype()
    );
    String targetMimetype = def.getMimetype();
    boolean supported = synchronousTransformClient.isSupported(
      MimetypeMap.MIMETYPE_HTML,
      -1,
      null,
      targetMimetype,
    ...
    if (supported) {
      ...
      assertNotNull(thumb);
      ContentReader reader =
        this.contentService.getReader(thumb, ContentModel.PROP_CONTENT);
    ...
    def =
      this.thumbnailService.getThumbnailRegistry()
        .getThumbnailDefinition("webpreview");
    if (supported) {
      NodeRef thumb =
        this.thumbnailService.createThumbnail(
            nodeRef,
  ...
  public void testThumbnailServiceCreateApi() throws Exception {
    ...
    outputThumbnailTempContentLocation(
      thumbnail1,
      "jpg",
      "smallJpeg - 64x64, marked as thumbnail"
    );
    ...
    outputThumbnailTempContentLocation(
      thumbnail1,
      "png",
      "smallPng - 64x64, marked as thumbnail"
    );
    ...
    ThumbnailParentAssociationDetails tpad = new ThumbnailParentAssociationDetails(
      otherFolder,
    ...
    outputThumbnailTempContentLocation(
      thumbnail1,
      "png",
      "targetDetails - 64x64, marked as thumbnail"
    );
    ...
    checkRenditioned(
      jpgOrig,
      Collections.singletonList(
        new ExpectedAssoc(RegexQNamePattern.MATCH_ALL, null, 4)
      )
    );
    ...
    outputThumbnailTempContentLocation(
      thumbnail1,
      "png",
      "'null' - 64x64, marked as thumbnail"
    );
  }
  ...
  public void testRegistry() {
    ThumbnailRegistry thumbnailRegistry =
      this.thumbnailService.getThumbnailRegistry();
    List<ThumbnailDefinition> defs = thumbnailRegistry.getThumbnailDefinitions(
      MimetypeMap.MIMETYPE_HTML,
      -1
    );
  ...
  public void testJSAPI() throws Exception {
    ...
    NodeRef docOrig = createOriginalContent(
      this.folder,
  ...
  public void testPlaceHoldersByMimeType() throws Exception {
    ...
    final String standardDoclibIcon =
      "alfresco/thumbnail/thumbnail_placeholder_doclib.png";

    // This used to be the cogs, but as of ALF-6566 is a generic document icon.
    String doclibIcon = scriptThumbnailService.getPlaceHolderResourcePath(
      "doclib"
    );
    ...
    String docxDoclibIcon = scriptThumbnailService.getMimeAwarePlaceHolderResourcePath(
      "doclib",
      MimetypeMap.MIMETYPE_WORD
    );
    assertEquals(
      "alfresco/thumbnail/thumbnail_placeholder_doclib_doc.png",
      docxDoclibIcon
    );

    // The icon for an unrecognised mime type.
    String fallbackDoclibIcon = scriptThumbnailService.getMimeAwarePlaceHolderResourcePath(
      "doclib",
      "application/wibble"
    );
    ...
    String mediumIcon = scriptThumbnailService.getPlaceHolderResourcePath(
      "medium"
    );
  ...
  protected void performLongRunningThumbnailTest(
    ...
    try {
      ...
      final NodeRef source = secureNodeService
        .createNode(
          folder,
          ContentModel.ASSOC_CONTAINS,
          QName.createQName(
      ...
      for (final ExpectedThumbnail expectedThumbnail : expectedThumbnails) {
        ...
        while (
          (endTime - startTime) < (TEST_LONG_RUNNING_TRANSFORM_TIME * multiples)
        ) {
          thumbnail =
            transactionService
              .getRetryingTransactionHelper()
          ...
          if (thumbnail == null) {
            ...
            logger.debug(
              ...
              (endTime - startTime) +
              " ms of " +
              TEST_LONG_RUNNING_TRANSFORM_TIME *
              multiples +
              " ms waiting for " +
              expectedThumbnail.getThumbnailName()
            );
          ...
          new RetryingTransactionHelper.RetryingTransactionCallback<Void>() {
            public Void execute() throws Throwable {
              ...
              for (final ExpectedThumbnail expectedThumbnail : expectedThumbnails) {
                ...
                NodeRef thumbnailNodeRef = thumbnailService.getThumbnailByName(
                  source,
                  ContentModel.PROP_CONTENT,
                  thumbnailName
                );
  ...
  public void testCreateMultipleLongRunningThumbnails() throws Exception {
    ...
    expectedAssocs.add(
      new ExpectedAssoc(RenditionModel.ASSOC_RENDITION, "imgpreview", 1)
    );
    expectedAssocs.add(
      new ExpectedAssoc(RenditionModel.ASSOC_RENDITION, "avatar", 1)
    );
  ...
  private boolean shouldTestBeSkippedForCurrentDB() {
    ...
    return (
      dialect instanceof Oracle9Dialect || dialect instanceof SQLServerDialect
    );
  }
}
