...
public class RhinoScriptTest extends TestCase {
        ...
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            try {
              ...
              result =
                cx.evaluateString(scope, TESTSCRIPT1, "TestJS4", 1, null);
            } finally {
              Context.exit();
            }
          ...
          public Object execute() throws Exception {
            ...
            try {
              ...
              Object result = scriptService.executeScript(
                TESTSCRIPT_CLASSPATH1,
                model
              );
              System.out.println(
                "Result from TESTSCRIPT_CLASSPATH1: " + result.toString()
              );
        ...
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            try {
              ...
              model.put(
                "doc",
                new ScriptNode(childRef.getChildRef(), serviceRegistry, null)
              );
              model.put("root", new ScriptNode(root, serviceRegistry, null));

              // execute to add aspect via action
              Object result = scriptService.executeScript(
                TESTSCRIPT_CLASSPATH2,
                model
              );
              System.out.println(
                "Result from TESTSCRIPT_CLASSPATH2: " + result.toString()
              );
              assertTrue((Boolean) result); // we know the result is a boolean
        ...
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Exception {
            ...
            try {
              ...
              // execute to add aspect via action
              Object result = scriptService.executeScript(
                TESTSCRIPT_CLASSPATH3,
                model
              );
              System.out.println(
                "Result from TESTSCRIPT_CLASSPATH3: " + result.toString()
              );
              assertTrue((Boolean) result); // we know the result is a boolean
            } finally {}
          ...
          public Object execute() throws Exception {
            ...
            try {
              ...
              try {
                ...
                fail(
                  "execution of nonsecure script on nodeRef is not allowed."
                );
              } catch (AlfrescoRuntimeException ex) {
                // expected
              }

              ChildAssociationRef childRef1 = nodeService.createNode(
                root,
                BaseNodeServiceTest.ASSOC_TYPE_QNAME_TEST_CHILDREN,
                QName.createQName(
                  BaseNodeServiceTest.NAMESPACE,
  ...
  private static final String TESTSCRIPT_CLASSPATH1 =
    "org/alfresco/repo/jscript/test_script1.js";
  private static final String TESTSCRIPT_CLASSPATH2 =
    "org/alfresco/repo/jscript/test_script2.js";
  private static final String TESTSCRIPT_CLASSPATH3 =
    "org/alfresco/repo/jscript/test_script3.js";
