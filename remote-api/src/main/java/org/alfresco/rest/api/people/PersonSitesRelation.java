...
public class PersonSitesRelation
     ...
     *
     * <p>THOR-1151: “F312: For a user, get the list of sites they are a member of”
     *
     * <p>If personId does not exist, NotFoundException (status 404).
     *
     * @param personId the id (email) of the person
     *     <p>(non-Javadoc)
     * @see
     *     org.alfresco.rest.framework.resource.actions.interfaces.RelationshipResourceAction.Read#readAll(String,
