...
/**
 * Interface for Audit data value extractors. These are used to extract auditable values from those
 * arguments, return values, exceptions and any other value passed into the audit components for
 * recording.
 *
 * <p>The framework will first determine if data passed into the instance is {@link
 * #isSupported(Serializable) supported} and will then pass it in for {@link
 * #extractData(Serializable) conversion} to the type that will be recorded.
 *
 * @author Derek Hulley
 * @since 3.2
 */
