...
public class SearchDAOTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    transactionService =
      (TransactionService) ctx.getBean("transactionComponent");
  ...
  private List<Acl> getAcls(
    final List<Long> aclChangeSetIds,
    final Long minAclId,
  ...
  public void testQueryChangeSets_Time() {
    ...
    List<AclChangeSet> results = getAclChangeSets(
      null,
      startTime,
      null,
      null,
  ...
  public void testQueryAcls_All() {
    ...
    List<AclChangeSet> aclChangeSets = getAclChangeSets(
      null,
      0L,
      null,
      null,
  ...
  public void testQueryTransactions_Time() {
    long startTime = System.currentTimeMillis() + (5 * 60000L); // The future
    List<Transaction> results = getTransactions(
      null,
      startTime,
      null,
      null,
  ...
  public void testGetNodesSimple() {
    ...
    nodeParameters.setStoreIdentifier(
  ...
  public void testInheritedAclIndexing() throws Exception {
    ...
    Long sharedAclId = transactionService
      .getRetryingTransactionHelper()
      .doInTransaction(
        new RetryingTransactionCallback<Long>() {
          ...
          public Long execute() throws Throwable {
            // Create a user
            if (
              authenticationService.authenticationExists(USER_MNT11107)
            ) authenticationService.deleteAuthentication(USER_MNT11107);
            if (
              personService.personExists(USER_MNT11107)
            ...
            NodeRef testUserHomeFolder = (NodeRef) nodeService.getProperty(
              person,
              ContentModel.PROP_HOMEFOLDER
            );
            assertNotNull("testUserHomeFolder is null", testUserHomeFolder);

            Long aclIdForUserHomeFolder = nodeService.getNodeAclId(
              testUserHomeFolder
            );
            Long inheritedAclId = aclDaoComponent.getInheritedAccessControlList(
    ...
    try {
      assertNotNull(
        "Acl for User Home folder should have inherited Acl",
        sharedAclId
      );
  ...
  public void testGetNodesFromTxnId() {
    final StoreRef storeRef = nodeService.createStore(
    ...
    try {
      ...
      Long txnId1 = transactionService
        .getRetryingTransactionHelper()
        .doInTransaction(createNodeWork1);
      Long txnId2 = transactionService
        .getRetryingTransactionHelper()
