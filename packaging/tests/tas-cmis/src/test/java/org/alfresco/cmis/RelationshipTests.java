...
public class RelationshipTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to create relationship between a source object and"
                            + " a target object in DocumentLibrary with CMIS")
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is not able to create relationship between a invalid"
                            + " sources with CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to create relationship with checkout source"
                            + " document with CMIS")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that inexistent user is not able to create relationship between"
                            + " documents with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that user that was deleted is not able to create relationship between"
                            + " documents with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisUnauthorizedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify that site manager is able to create relationship between documents with"
                            + " CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    public void siteManagerCannotGetRelWithInvalidObject() throws Exception {
        ...
        cmisApi.authenticateUser(siteManager)
                ...
                .objectHasRelationshipWith(targetFile)
                .assertThat()
                .objectHasRelationshipWith(invalidFile);
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify admin is able to create relationship between a source folder and a"
                            + " target file with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify contributor is not able to create relationship between a source object"
                            + " and a target object in DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify collaborator is able to create relationship between a source object and"
                            + " a target object in DocumentLibrary with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify consumer is not able to create relationship between a source object and"
                            + " a target object in DocumentLibrary with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthorized user is not able to create relationship between a source"
                            + " object and a target object from a private site with CMIS")
    @Test(
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthorized user is not able to get relationship between a source"
                            + " object and a target object from a private site with CMIS")
    @Test(
            groups = {TestGroup.SANITY, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to create relationship for PWC source document"
                            + " with CMIS")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is able to create relationship with checkout target"
                            + " document with CMIS")
    @Test(groups = {TestGroup.REGRESSION, TestGroup.CMIS})
