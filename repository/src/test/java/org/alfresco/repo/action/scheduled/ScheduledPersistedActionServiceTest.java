...
public class ScheduledPersistedActionServiceTest extends BaseSpringTest {
  ...
  public void setUp() throws Exception {
    ...
    service =
      (ScheduledPersistedActionService) applicationContext.getBean(
        "ScheduledPersistedActionService"
      );
    serviceImpl =
      (ScheduledPersistedActionServiceImpl) applicationContext.getBean(
        "scheduledPersistedActionService"
      );
    scheduler = (Scheduler) applicationContext.getBean("schedulerFactory");
    bootstrap =
      (ScheduledPersistedActionServiceBootstrap) applicationContext.getBean(
    ...
    testAction =
      new TestAction(actionService.createAction(SleepActionExecuter.NAME));
  ...
  public void testPersistedActionImpl() throws Exception {
    ScheduledPersistedActionImpl schedule = new ScheduledPersistedActionImpl(
      testAction
    );
    ScheduledPersistedActionImpl schedule3 = new ScheduledPersistedActionImpl(
      testAction3
    );
  ...
  public void testActionToTrigger() throws Exception {
    ...
    ScheduledPersistedActionImpl schedule = (ScheduledPersistedActionImpl) service.createSchedule(
      testAction
    );
    Trigger t;
    try {
  ...
  public void testCreation() {
    ...
    schedule.setScheduleIntervalPeriod(
      ScheduledPersistedAction.IntervalPeriod.Day
    );
    assertEquals(
      ScheduledPersistedAction.IntervalPeriod.Day,
      schedule.getScheduleIntervalPeriod()
    );
  }
  ...
  public void testCreateSaveLoad() throws Exception {
    ...
    ScheduledPersistedAction retrieved = serviceImpl.loadPersistentSchedule(
      ((ScheduledPersistedActionImpl) schedule).getPersistedAtNodeRef()
    );
    ...
    ScheduledPersistedAction second = serviceImpl.loadPersistentSchedule(
      ((ScheduledPersistedActionImpl) schedule).getPersistedAtNodeRef()
    );
    ...
    assertEquals(
      ScheduledPersistedAction.IntervalPeriod.Day,
      second.getScheduleIntervalPeriod()
    );
  ...
  public void testEditing() throws Exception {
    ...
    retrieved.setScheduleIntervalPeriod(
  ...
  public void testLoadList() throws Exception {
    ...
    assertEquals(
      ...
      service.listSchedules().get(0).getActionNodeRef()
    );
  ...
  public void testDeletion() throws Exception {
    ...
    assertEquals(
      1,
      nodeService
        .getTargetAssocs(schedule1NodeRef, RegexQNamePattern.MATCH_ALL)
        .size()
    );
    assertEquals(
      1,
      nodeService
        .getTargetAssocs(schedule2NodeRef, RegexQNamePattern.MATCH_ALL)
        .size()
    );
    assertEquals(
      1,
  ...
  public void testExecution() throws Exception {
    final SleepActionExecuter sleepActionExec = (SleepActionExecuter) applicationContext.getBean(
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            ScheduledPersistedAction schedule = service.createSchedule(
              testAction
            );
  ...
  public void testMultipleExecutions() throws Exception {
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ...
            ScheduledPersistedActionImpl scheduleA = (ScheduledPersistedActionImpl) service.createSchedule(
              testAction
            );
            ...
            ScheduledPersistedActionImpl scheduleB = (ScheduledPersistedActionImpl) service.createSchedule(
              testAction2
            );
    ...
    transactionService
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          public Void execute() throws Throwable {
            ScheduledPersistedAction scheduleA = service.getSchedule(
              testAction
            );
            ScheduledPersistedAction scheduleB = service.getSchedule(
              testAction2
            );
