...
public final class NodeRef implements EntityRef, Serializable {
    // Let's force introspection of this class straight away so that we don't get contention when
     ...
     *
     * <p>The string representation of a Node Reference is as follows:
     *
    ...
    public NodeRef(String nodeRef) {
        ...
        if (lastForwardSlash == -1) {
            throw new MalformedNodeRefException(
                    "Invalid node ref - does not contain forward slash: " + nodeRef);
        }
    ...
    /**
     * Hashes on ID alone. As the number of copies of a particular node will be minimal, this is
     * acceptable
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Converts a {@link String} containing a comma-separated list of {@link NodeRef} Ids into
     * NodeRefs. If a <code>logger</code> is supplied then invalid ids are logged as warnings.
     *
     * @param values the {@link String} of {@link NodeRef} ids.
     * @param logger Log
     * @return A {@link List} of {@link NodeRef NodeRefs}.
    ...
    public static class Status {
        ...
        public Status(
                Long dbId, NodeRef nodeRef, String changeTxnId, Long dbTxnId, boolean deleted) {
            this.dbId = dbId;
