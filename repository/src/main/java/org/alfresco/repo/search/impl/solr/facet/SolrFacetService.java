...
public interface SolrFacetService {
     ...
     * @return {@code SolrFacetProperties} object or <i>null</i> if there is no facet with the
     *     specified Id
     */
     ...
     *
     * <p>Note: The super/repo admin is considered to be a search-administrator too.
     *
    ...
    /**
     * This method offers a convenient access point for getting all Facetable content properties
    ...
    /**
     * This method offers a convenient access point for getting all Facetable content properties
     * defined on the specified content class (type or aspect) or any of its inherited properties.
     *
    ...
    /**
     * This method gets all synthetic, facetable properties across all content models in the
     * repository.
     */
    public List<SyntheticPropertyDefinition> getFacetableSyntheticProperties();

    /**
     * This method gets all synthetic, facetable properties defined on the specified content class
     * (type or aspect) or any of its inherited properties.
     *
     * @param contentClass the QName of an aspect or type, whose synthetic, facetable properties are
     *     sought.
     */
    public List<SyntheticPropertyDefinition> getFacetableSyntheticProperties(QName contentClass);

    /**
     * This class represents a special case of a property, examples being file size and MIME type,
     * which are not modelled as Alfresco content model properties, but are instead stored as
     * components within properties of type {@code cm:content}.
     */
    public class SyntheticPropertyDefinition {
        ...
        public SyntheticPropertyDefinition(
                PropertyDefinition containingPropertyDef,
