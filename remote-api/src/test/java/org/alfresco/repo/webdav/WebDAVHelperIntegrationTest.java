...
public class WebDAVHelperIntegrationTest {
  ...
  public void setUp() {
    ...
    StoreRef storeRef = nodeService.createStore(
      "workspace",
      "WebDAVHelperTest-" + UUID.randomUUID()
    );
  ...
  public void canGetNodeForPathWithCorrectCase() throws FileNotFoundException {
    ...
    FileInfo found = webDAVHelper.getNodeForPath(
      rootFolder,
  ...
  @Test
  public void cannotGetNodeForPathWithIncorrectCase()
  ...
  @Test
  public void cannotGetNodeForFolderPathWithIncorrectCase()
    throws FileNotFoundException {
    FileInfo folderInfo = fileFolderService.create(
      rootFolder,
      "my_folder",
