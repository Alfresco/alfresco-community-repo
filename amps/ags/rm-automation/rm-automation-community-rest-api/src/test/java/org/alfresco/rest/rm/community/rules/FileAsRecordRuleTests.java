...
public class FileAsRecordRuleTests extends BaseRMRestTest
{
    ...
    /**
     * Given I am a user that can create a rule on a folder in a collaboration site When I am creating the rule Then I have the option of adding a "Declare and File as Record" action to the rule
     * <p>
     ...
     * <p>
     * Given I am configuring a "Declare and File as Record" action within a rule And I have at least one records management role (eg RM User) When I am selecting the record folder location to file the declared record to Then I see the record folders in the file plan that I have file access to as the creator of the record
     **/
    @Test
    ...
    /**
     * Given I am configuring a "Declare and File as Record" action within a rule And I don't have a records management role When I am selecting the record folder location to file the declared record to Then I can see only the file plan
     */
    @Test
    ...
    /**
     * Given I have not selected a record folder location When the rule is triggered Then the file is declared as record to the UnFiled Records folder
     */
    @Test
