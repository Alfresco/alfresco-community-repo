                ...
                new RefreshableCacheListener() {
                    ...
                    public void onRefreshableCacheEvent(RefreshableCacheEvent event) {
                        ...
                        if (event instanceof RefreshableCacheRefreshedEvent
                            ...
                            // Note we do that here to ensure that the dictionary registry has been
                            // added to the cache,
                            // so that any dependencies (like the CMIS dictionary) will use the new
                            // dictionary.
                            for (DictionaryListener dictionaryListener :
                                    dictionaryDAO.getDictionaryListeners()) {
                                logger.debug(
                                        "Calling afterDIctionaryInit ["
                                                + event.getClass().getSimpleName()
                                                + ", cache="
                                                + event.getCacheId()
                                                + ", key="
