...
public class DeleteRatingTests extends RestTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Manager role is able to remove its own rating of a document")
    ...
    public void managerIsAbleToDeleteItsOwnRatings() throws Exception {
        FolderModel folderModel =
                dataContent.usingUser(adminUser).usingSite(siteModel).createFolder();
        FileModel document =
                dataContent
                        .usingUser(adminUser)
    ...
    @TestRail(
            ...
            description =
                    "Verify user with Collaborator role is able to remove its own rating of a"
                            + " document")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Contributor role is able to remove its own rating of a"
                            + " document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Consumer role is able to remove its own rating of a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    ...
    @TestRail(
            ...
            executionType = ExecutionType.SANITY,
            description =
                    "Verify unauthenticated user is not able to remove its own rating of a"
                            + " document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.SANITY})
    ...
    public void deleteRatingUsingInvalidDocument() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ENTITY_NOT_FOUND, "random_value"));
    }
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to remove rating added by another user")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    @Bug(id = "ACE-5459")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is not able to remove rating added by another user")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
    @Bug(id = "ACE-5459")
    ...
    public void addStarsToFolderAfterRatingIsDeleted() throws Exception {
        ...
        returnedRatingModel =
                restClient.withCoreAPI().usingResource(folderModel).rateStarsToDocument(5);
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify user with Manager role is able to remove one star rating of a document")
    @Test(groups = {TestGroup.REST_API, TestGroup.RATINGS, TestGroup.REGRESSION})
