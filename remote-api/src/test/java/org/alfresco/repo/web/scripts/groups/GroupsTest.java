...
public class GroupsTest extends BaseWebScriptTest {
  ...
  private synchronized String createTestTree() {
    if (rootGroupName == null) {
      rootGroupName =
        authorityService.getName(AuthorityType.GROUP, TEST_ROOTGROUP);
    }
    ...
    if (!authorityService.authorityExists(rootGroupName)) {
      ...
      rootGroupName =
        authorityService.createAuthority(
          AuthorityType.GROUP,
          TEST_ROOTGROUP,
          TEST_ROOTGROUP_DISPLAY_NAME,
          authorityService.getDefaultZones()
        );
      String groupA = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPA,
        TEST_GROUPA,
        authorityService.getDefaultZones()
      ...
      String groupB = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPB,
        TEST_GROUPB,
        authorityService.getDefaultZones()
      ...
      String groupD = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPD,
        TEST_GROUPD,
        authorityService.getDefaultZones()
      );
      String groupE = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPE,
        TEST_GROUPE,
        shareZones
      ...
      String groupF = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPF,
        TEST_GROUPF,
        authorityService.getDefaultZones()
      ...
      String groupG = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPG,
        TEST_GROUPG,
        authorityService.getDefaultZones()
      ...
      String groupC = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_GROUPC,
        TEST_GROUPC,
        authorityService.getDefaultZones()
      ...
      String link = authorityService.createAuthority(
        AuthorityType.GROUP,
        TEST_LINK,
        TEST_LINK,
        authorityService.getDefaultZones()
  ...
  public void testGetRootGroup() throws Exception {
      ...
      for (int i = 0; i < data.length(); i++) {
        ...
        if (rootGroup.getString("shortName").equals(TEST_ROOTGROUP)) {
          ...
          assertEquals(
            "shortName wrong",
            TEST_ROOTGROUP,
            rootGroup.getString("shortName")
          );
          assertEquals(
            "displayName wrong",
            TEST_ROOTGROUP_DISPLAY_NAME,
            rootGroup.getString("displayName")
          );
          assertEquals(
            "authorityType wrong",
            "GROUP",
            rootGroup.getString("authorityType")
          );
          gotRootGroup = true;
        }
    ...
    assertTrue(
      "root group is in APP.DEFAULT zone",
      zones.contains("APP.DEFAULT")
    );
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_ROOTGROUPS + "?zone=APP.DEFAULT"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_ROOTGROUPS + "?zone=AUTH.ALF"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_ROOTGROUPS + "?zone=WIBBLE"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
  ...
  public void testGetGroup() throws Exception {
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + ADMIN_GROUP),
        200
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      sendRequest(
        new GetRequest(URL_GROUPS + "/" + "crap"),
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + TEST_GROUPB),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + TEST_GROUPE),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
  ...
  public void testCreateRootGroup() throws Exception {
     ...
     */
    {
      ...
      sendRequest(
        new PostRequest(
          URL_ROOTGROUPS + "/" + myGroupName,
          newGroupJSON.toString(),
          "application/json"
        ),
    ...
    try {
       ...
       */
      sendRequest(
        new DeleteRequest(URL_ROOTGROUPS + "/" + myGroupName),
        Status.STATUS_OK
      );
  ...
  public void testLinkChild() throws Exception {
    ...
    try {
      ...
      {
        Response response = sendRequest(
          new GetRequest(URL_GROUPS + "/" + TEST_LINK),
          Status.STATUS_OK
        );
        JSONObject top = new JSONObject(response.getContentAsString());
        logger.debug(response.getContentAsString());
      ...
      this.authenticationComponent.setCurrentUser(USER_ONE);
      {
        ...
        sendRequest(
          new PostRequest(
            URL_GROUPS + "/" + myRootGroup + "/children/" + groupLinkFullName,
            newGroupJSON.toString(),
            "application/json"
          ),
          Status.STATUS_INTERNAL_SERVER_ERROR
       ...
       */
      {
        ...
        Response response = sendRequest(
          new GetRequest(
            URL_GROUPS + "/" + myRootGroup + "/children?authorityType=GROUP"
          ),
          Status.STATUS_OK
        );
        JSONObject top = new JSONObject(response.getContentAsString());
        ...
        assertEquals(
          "shortName wrong",
          TEST_LINK,
          subGroup.getString("shortName")
        );
        assertEquals(
          "authorityType wrong",
          "GROUP",
          subGroup.getString("authorityType")
        );
      }
       ...
       */
      {
        ...
        Response response = sendRequest(
          new PostRequest(
            URL_GROUPS + "/" + myRootGroup + "/children/" + userOneFullName,
            newGroupJSON.toString(),
            "application/json"
          ),
          Status.STATUS_OK
       ...
       */
      {
        ...
        Response response = sendRequest(
          new GetRequest(
            URL_GROUPS + "/" + myRootGroup + "/children?authorityType=USER"
          ),
          Status.STATUS_OK
        );
        JSONObject top = new JSONObject(response.getContentAsString());
      ...
      String myNewGroup = "GROUP_BUFFY";
      {
        ...
        Response response = sendRequest(
          new PostRequest(
            URL_GROUPS + "/" + myRootGroup + "/children/" + myNewGroup,
            newGroupJSON.toString(),
            "application/json"
          ),
          Status.STATUS_CREATED
  ...
  public void testUpdateGroup() throws Exception {
    ...
    try {
      ...
      {
        Response response = sendRequest(
          new GetRequest(URL_GROUPS + "/" + myGroupName),
          Status.STATUS_OK
        );
        JSONObject top = new JSONObject(response.getContentAsString());
        logger.debug(response.getContentAsString());
  ...
  public void testSearchGroups() throws Exception {
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "?shortNameFilter=" + "ALFRESCO_ADMIN*"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "?shortNameFilter=" + "ALFRE?CO_ADMIN*"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "?shortNameFilter=" + "XX?X"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "?shortNameFilter=" + ADMIN_GROUP),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "?shortNameFilter=" + TEST_GROUPD),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "?shortNameFilter=" + TEST_GROUPE),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
      ...
      assertEquals(
        "Group E not found",
        TEST_GROUPE,
        authority.getString("shortName")
      );

      // Double check group E is in the share zone
      Set<String> zones = authorityService.getAuthorityZones(
        authority.getString("fullName")
      );
    ...
    // Search for a group in a specifc non default zone
    {
      Response response = sendRequest(
        new GetRequest(
          ...
          TEST_GROUPE +
          "&zone=" +
          AuthorityService.ZONE_APP_SHARE
        ),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
  ...
  public void testSearchGroupsPaging() throws Exception {
    ...
    assertTrue(
      "There should be at least 6 groups in default zone!",
      defaultSize > 5
    );
    ...
    assertEquals(
      "The first group should be the same!!",
      firstGroup,
      data.get(0).toString()
    );
    ...
    assertEquals(
      "The number of groups returned is wrong!",
      defaultSize - 2,
      data.length()
    );
    assertFalse(
      "The first group should not be the same!!",
      firstGroup.equals(data.get(0).toString())
    );

    // Test maxItems and skipCount
    data =
      getDataArray(
        URL_GROUPS + "?shortNameFilter=*" + "&skipCount=2&maxItems=3"
      );
  ...
  public void testGetRootGroupsPaging() throws Exception {
    ...
    assertTrue(
      "There should be at least 3 groups in default zone!",
      defaultSize > 2
    );
    ...
    data =
      getDataArray(URL_ROOTGROUPS + "?skipCount=" + skipCount + "&maxItems=5");
  ...
  public void testGetChildGroupsPaging() throws Exception {
    ...
    // Test for immediate parents
    String baseUrl =
      URL_GROUPS + "/" + TEST_ROOTGROUP + "/children?authorityType=GROUP";
  ...
  public void testGetParents() throws Exception {
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + ADMIN_GROUP + "/parents"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + TEST_GROUPB + "/parents"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
    ...
    {
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + TEST_GROUPD + "/parents?level=ALL"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
     ...
     */
    {
      sendRequest(
        new GetRequest(
          URL_GROUPS + "/" + TEST_GROUPD + "/parents?level=rubbish"
        ),
        Status.STATUS_BAD_REQUEST
      );
    }
    ...
    {
      sendRequest(
        new GetRequest(URL_GROUPS + "/" + "rubbish" + "/parents?level=all"),
        Status.STATUS_NOT_FOUND
      );
    }
  }
  ...
  public void testGetChildren() throws Exception {
     ...
     */
    {
      ...
      Response response = sendRequest(
        new GetRequest(URL_GROUPS + "/" + TEST_GROUPB + "/children"),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      logger.debug(response.getContentAsString());
     ...
     */
    {
      ...
      Response response = sendRequest(
        new GetRequest(
          URL_GROUPS + "/" + TEST_GROUPB + "/children?authorityType=GROUP"
        ),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
      ...
      for (int i = 0; i < data.length(); i++) {
        ...
        if (authority.getString("shortName").equals(TEST_GROUPD)) {
          ...
          fail(
            "unexpected authority returned:" + authority.getString("shortName")
          );
        }
      }
      assertTrue("not got group D", gotGroupD);
      ...
      for (int i = 0; i < data.length(); i++) {
        ...
        assertEquals(
          "authorityType wrong",
          "GROUP",
          authority.getString("authorityType")
        );
      }
    }
     ...
     */
    {
      ...
      Response response = sendRequest(
        new GetRequest(
          URL_GROUPS + "/" + TEST_GROUPB + "/children?authorityType=USER"
        ),
        Status.STATUS_OK
      );
      JSONObject top = new JSONObject(response.getContentAsString());
     ...
     */
    {
      sendRequest(
        new GetRequest(
          URL_GROUPS + "/" + TEST_GROUPB + "/children?authorityType=XXX"
        ),
        Status.STATUS_BAD_REQUEST
      );
    }
    ...
    {
      sendRequest(
        new GetRequest(URL_GROUPS + "/" + "rubbish" + "/children"),
        Status.STATUS_NOT_FOUND
      );
    }
  }
