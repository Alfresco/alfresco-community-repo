...
/**
 * Holds all the details available to the {@link ActionTrackingService} on a currently executing
 * Action.
 *
 * @author Nick Burch
 */
public class ExecutionDetails implements Serializable {
    ...
    /**
     * Which instance of the action is this? Every time you start an action, it gets a new instance
     * ID, and this lets you tell the difference between two copies running in parallel.
     *
