...
public class FieldProcessorTest extends TestCase {
    ...
    public void testMakeAssociationFieldDefinition() throws Exception {
        ...
        AssociationFieldDefinition assocFieldDef =
                (AssociationFieldDefinition) field.getFieldDefinition();
    ...
    private ContentModelItemData<Void> makeItemData() {
        ...
        return new ContentModelItemData<Void>(
                null, propDefs, assocDefs, propValues, assocValues, transientValues);
    }

    private Map<QName, AssociationDefinition> makeAssociationDefs() {
        QName targetClass = QName.createQName(URI, "Target");
        AssociationDefinition assocDef1 =
                MockClassAttributeDefinition.mockAssociationDefinition(
                        qName1,
                        targetClass,
                        ...
                        false,
                        false);
        MockClassAttributeDefinition assocDef2 =
                MockClassAttributeDefinition.mockAssociationDefinition(
                        qName2, targetClass, TITLE, DESCRIPTION2, true, true, true);
    ...
    private Map<QName, PropertyDefinition> makePropertyDefs() {
        ...
        PropertyDefinition propDef2 =
                MockClassAttributeDefinition.mockPropertyDefinition(
                        qName2, dataTypeName, TITLE, DESCRIPTION2, true, "Default2", true, true);
