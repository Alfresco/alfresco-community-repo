 ...
 * thread group. All the groups that have been used can be fetched using {@link
 * #getActiveThreadGroups()}, allowing iteration of the the threads in the group.
 *
 * @since 2.1
 * @author Derek Hulley
 */
public class TraceableThreadFactory implements ThreadFactory {
    ...
    private static List<ThreadGroup> activeThreadGroups =
            Collections.synchronizedList(new ArrayList<ThreadGroup>(1));
