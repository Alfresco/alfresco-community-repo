...
public class TestPublicService implements Extensible {
  ...
  public TestPublicService() {
    this.testPublicTrait =
      new ExtendedTrait<TestPublicTrait>(
        AJProxyTrait.create(this, TestPublicTrait.class)
      );
  }

  @Extend(
    traitAPI = TestPublicTrait.class,
    extensionAPI = TestPublicExtension.class
  )
  ...
  public void publicMethod3(boolean throwException, boolean throwExException)
