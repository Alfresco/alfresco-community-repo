...
public class CompleteRecordTest extends BaseRMTestCase {
  ...
  private static final QName ASPECT_TEST = QName.createQName(
    "http://www.alfresco.org/model/rmtest/1.0",
    "recordMetaDataWithProperty"
  );
  private static final QName PROP_TEST = QName.createQName(
    "http://www.alfresco.org/model/rmtest/1.0",
    "customMandatoryProperty"
  );
  private static final QName CUSTOM_ELECTRONIC_TEST = QName.createQName(
    RecordsManagementCustomModel.RM_CUSTOM_URI,
    "rmarecordCustomProperties"
  );
  private static final QName CUSTOM_NON_ELECTRONIC_TEST = QName.createQName(
    RecordsManagementCustomModel.RM_CUSTOM_URI,
  ...
  protected void initServices() {
    ...
    recordServiceImpl =
      (RecordServiceImpl) applicationContext.getBean("recordService");
  }
    ...
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        ...
        public void given() throws Exception {
          ...
          record =
            utils.createRecord(rmFolder, "electronicRecord.txt", "title");
        }
   ...
   * And the record will not be complete
   */
  public void testCheckForCustomMandatoryValuesMissingInNonElectronicRecord()
    throws Exception {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
   ...
   * Then the record is completed
   */
  public void testCheckForCustomMandatoryValuePresentInNonElectronicRecord()
    throws Exception {
    doBehaviourDrivenTest(
      new BehaviourDrivenTest() {
        private NodeRef nonElectronicRecord;
   ...
   */
  private void defineCustomMetadata(
    QName propId,
    QName typeName,
    boolean mandatory
  ) throws Exception {
