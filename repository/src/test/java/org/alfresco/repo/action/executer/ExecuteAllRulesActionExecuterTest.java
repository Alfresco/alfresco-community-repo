...
public class ExecuteAllRulesActionExecuterTest extends BaseSpringTest {
  ...
  protected void before() throws Exception {
    ...
    this.ruleService =
      (RuleService) this.applicationContext.getBean("ruleService");
    this.actionService =
    ...
    this.executer =
      (ExecuteAllRulesActionExecuter) this.applicationContext.getBean(
  ...
  public void testRevertVersion() {
    ...
    Action addFeaturesAction =
      this.actionService.createAction(AddFeaturesActionExecuter.NAME);
    ...
    TestTransaction.end();
    assertTrue(
      this.nodeService.hasAspect(doc, ContentModel.ASPECT_CLASSIFIABLE)
    );
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Throwable {
          ...
          NodeRef original = checkOutCheckInService.checkin(
            workingCopyRef,
            props
          );
  ...
  public void testExecution() {
    ...
    assertFalse(
      this.nodeService.hasAspect(doc1, ContentModel.ASPECT_VERSIONABLE)
    );
    assertFalse(
      this.nodeService.hasAspect(doc1, ContentModel.ASPECT_CLASSIFIABLE)
    );
    assertFalse(this.nodeService.hasAspect(doc1, ContentModel.ASPECT_TITLED));
    assertFalse(
      this.nodeService.hasAspect(doc2, ContentModel.ASPECT_VERSIONABLE)
    );
    assertFalse(
      this.nodeService.hasAspect(doc2, ContentModel.ASPECT_CLASSIFIABLE)
    );
    ...
    transactionHelper.doInTransaction(
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Throwable {
          assertTrue(
            nodeService.hasAspect(doc1, ContentModel.ASPECT_VERSIONABLE)
          );
          assertTrue(
            nodeService.hasAspect(doc1, ContentModel.ASPECT_CLASSIFIABLE)
          );
          assertFalse(nodeService.hasAspect(doc2, ContentModel.ASPECT_TITLED));
          assertTrue(
            nodeService.hasAspect(doc2, ContentModel.ASPECT_VERSIONABLE)
          );
          assertTrue(
            nodeService.hasAspect(doc2, ContentModel.ASPECT_CLASSIFIABLE)
          );
          assertFalse(nodeService.hasAspect(doc2, ContentModel.ASPECT_TITLED));
          assertFalse(
            nodeService.hasAspect(doc3, ContentModel.ASPECT_VERSIONABLE)
          );
          assertFalse(
            nodeService.hasAspect(doc3, ContentModel.ASPECT_CLASSIFIABLE)
          );
          assertFalse(nodeService.hasAspect(doc3, ContentModel.ASPECT_TITLED));
  ...
  public void testRulesFireOnNonInheritedFolderUsingLinkedRuleSetInstead() {
    ...
    final NodeRef folderB = fileFolderService
      .create(folderA, "folderB", ContentModel.TYPE_FOLDER)
      .getNodeRef();
    ...
    transactionHelper.doInTransaction(() -> {
      assertFalse(
        nodeService.hasAspect(folderA, ContentModel.ASPECT_CLASSIFIABLE)
      );
      assertFalse(
        nodeService.hasAspect(fileA, ContentModel.ASPECT_CLASSIFIABLE)
      );
      assertFalse(
        nodeService.hasAspect(folderB, ContentModel.ASPECT_CLASSIFIABLE)
      );
      assertFalse(
        nodeService.hasAspect(fileB, ContentModel.ASPECT_CLASSIFIABLE)
      );
      return null;
    });
    ...
    transactionHelper.doInTransaction(() -> {
      ...
      Action rulesAction = actionService.createAction(
        ExecuteAllRulesActionExecuter.NAME,
        actionParams
      );
  ...
  private FileInfo createFile(NodeRef parent, String name) {
    FileInfo file = fileFolderService.create(
      parent,
      name,
      ContentModel.TYPE_CONTENT
    );
  ...
  public void testRuleAppliesToSubfoldersSuccessfully() {
    ...
    transactionHelper.doInTransaction(() -> {
      Rule rule1 = new Rule();
      rule1.setRuleType(RuleType.INBOUND);
      Action action1 = actionService.createAction(
