...
public class Tenant {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((tenantDomain == null) ? 0 : tenantDomain.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (tenantDomain == null) {
      if (other.tenantDomain != null) return false;
    } else if (!tenantDomain.equals(other.tenantDomain)) return false;
    return true;
  }
}
