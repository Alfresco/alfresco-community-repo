...
public class AddProcessItemFullTests extends RestTest {
  ...
  public void failedAddingMultipleProcessItemsIfEmptyProcessIdIsProvided()
    throws Exception {
    processModel =
      restClient
  ...
  public void failedAddingProcessItemsIfEmptyProcessIdIsProvided()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void failedAddingProcessItemIfEmptyItemBodyIsProvided()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void failedAddingMultipleProcessItemsIfEmptyItemBodyIsProvided()
    throws Exception {
    processModel =
      restClient
        .authenticateUser(adminUser)
  ...
  public void createDeleteCreateMultipleProcessItems() throws Exception {
    ...
    restClient
      .withWorkflowAPI()
      .usingProcess(processModel)
      .deleteProcessItem(processItems.getEntries().get(0).onModel());
    ...
    restClient
      ...
      .entriesListDoesNotContain(
        "name",
        processItems.getEntries().get(0).onModel().getName()
      );
  ...
  public void createDeleteCreateProcessItem() throws Exception {
    ...
    restClient
      ...
      .getProcessItems()
      .assertThat()
      .entriesListDoesNotContain("name", processItem.getName());
    ...
    restClient
      ...
      .getProcessItems()
      .assertThat()
      .entriesListContains("name", processItem.getName());
  }
}
