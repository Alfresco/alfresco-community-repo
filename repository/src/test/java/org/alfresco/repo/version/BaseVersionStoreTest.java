...
public abstract class BaseVersionStoreTest extends BaseSpringTest {
    ...
    protected static final QName TEST_TYPE_WITH_MANDATORY_ASPECT_QNAME =
            QName.createQName(TEST_NAMESPACE, "contentWithMandatoryAspect");
    protected static final QName TEST_MANDATORY_ASPECT_QNAME =
            QName.createQName(TEST_NAMESPACE, "mandatoryAspect");
    protected static final QName TEST_MARKER_ASPECT_QNAME =
            QName.createQName(TEST_NAMESPACE, "markerAspect");
    protected static final QName TEST_ASPECT_QNAME =
            QName.createQName(TEST_NAMESPACE, "testaspect");
    ...
    protected static final QName TEST_CHILD_ASSOC_1 =
            QName.createQName(TEST_NAMESPACE, "childassoc1");
    protected static final QName TEST_CHILD_ASSOC_2 =
            QName.createQName(TEST_NAMESPACE, "childassoc2");
    protected static final QName TEST_ASSOC = QName.createQName(TEST_NAMESPACE, "assoc1");
    protected static final QName TEST_ATS_PARENT_TYPE_QNAME =
            QName.createQName(TEST_NAMESPACE, "atsParent");
    protected static final QName TEST_ATS_CHILD_TYPE_QNAME =
            QName.createQName(TEST_NAMESPACE, "atsChild");
    protected static final QName TEST_ATS_RELATED_CHILDREN_QNAME =
            QName.createQName(TEST_NAMESPACE, "atsRelatedChildren");
    protected static final QName PROP_ATS_PARENT_ID =
            QName.createQName(TEST_NAMESPACE, "atsParentID");
    protected static final QName PROP_ATS_CHILD_ID =
            QName.createQName(TEST_NAMESPACE, "atsChildID");
    ...
    public void before() throws Exception {
        ...
        this.nodeProperties.put(
                ContentModel.PROP_CONTENT, new ContentData(null, "text/plain", 0L, "UTF-8"));
        ...
        // NodeService.
        StoreArchiveMap archiveMap =
                (StoreArchiveMap) applicationContext.getBean("storeArchiveMap");
        ...
        if (!authenticationDAO.userExists(AuthenticationUtil.getAdminUserName())) {
            authenticationService.createAuthentication(
                    AuthenticationUtil.getAdminUserName(), PWD.toCharArray());
        }
    ...
    protected NodeRef createNode(boolean versionable, QName nodeType) {
        ...
        if (versionable) {
            this.dbNodeService.addAspect(
                    nodeRef, ContentModel.ASPECT_VERSIONABLE, new HashMap<QName, Serializable>());
        }
        ...
        if (versionable) {
            this.dbNodeService.addAspect(
                    child1, ContentModel.ASPECT_VERSIONABLE, new HashMap<QName, Serializable>());
        }
        ...
        if (versionable) {
            this.dbNodeService.addAspect(
                    child2, ContentModel.ASPECT_VERSIONABLE, new HashMap<QName, Serializable>());
        }
     ...
     *
     * <p>The default test propreties are assigned to the version.
     *
    ...
    protected Version createVersion(
            NodeRef versionableNode, Map<String, Serializable> versionProperties) {
    ...
    protected Collection<Version> createVersion(
        ...
        Collection<Version> versions =
                versionService.createVersion(
                        versionableNode, this.versionProperties, versionChildren);
    ...
    protected String peekNextVersionLabel(
            NodeRef nodeRef, Map<String, Serializable> versionProperties) {
    ...
    protected void checkVersion(
        ...
        if (versionProperties != null) {
            ...
            for (String key : versionProperties.keySet()) {
                assertEquals(versionProperties.get(key), newVersion.getVersionProperty(key));
            }
        }
        ...
        if (versionService
            ...
            assertEquals(Version2Model.STORE_ID, nodeRef.getStoreRef().getIdentifier());
            assertEquals(Version2Model.STORE_PROTOCOL, nodeRef.getStoreRef().getProtocol());
            ...
            assertEquals(VersionModel.STORE_ID, nodeRef.getStoreRef().getIdentifier());
            assertEquals(VersionModel.STORE_PROTOCOL, nodeRef.getStoreRef().getProtocol());
            assertNotNull(nodeRef.getId());
        }
    }
