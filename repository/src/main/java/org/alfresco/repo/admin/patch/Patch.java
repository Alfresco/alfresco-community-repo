 ...
 *
 * <p>Auditing information is not maintained by the patch - rather it is solely responsible for the
 * execution of the processes necessary to apply the patch.
 *
 * <p>Patches must not be reappliable. It is up to the patch management systems to ensure that
 * patches are <b>never reapplied</b>.
 *
...
public interface Patch {
    ...
    /**
     * Apply the patch, regardless of the deferred flag. So if the patch has not run due to it being
     * deferred earlier then this will run it now. Also ignores the "applied" lock. So the patch can
