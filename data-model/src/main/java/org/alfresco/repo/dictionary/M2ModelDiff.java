...
public class M2ModelDiff {
  ...
  private static final String ERR_UNKNOWN_ELEMENT_TYPE =
    "d_dictionary.model_diff.element_type.unknown";
  private static final String ERR_UNKNOWN_DIFF_TYPE =
    "d_dictionary.model_diff.diff_type.unknown";
