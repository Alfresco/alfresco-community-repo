...
public class TakeOwnershipActionExecuterTest {
  ...
  public static TemporarySites TEMP_SITES = new TemporarySites(
    APP_CONTEXT_INIT
  );
  public static TemporaryNodes TEMP_NODES = new TemporaryNodes(
    APP_CONTEXT_INIT
  );
  ...
  public static void initStaticData() throws Exception {
    OWNABLE_SERVICE =
      APP_CONTEXT_INIT
        ...
        .getBean("OwnableService", OwnableService.class);
    TRANSACTION_HELPER =
      APP_CONTEXT_INIT
        .getApplicationContext()
    ...
    SITE_INFO =
      TEMP_SITES.createTestSiteWithUserPerRole(
        siteShortName,
        "sitePreset",
    ...
    TEST_DOC =
      TEMP_NODES.createNode(
        SITE_INFO.doclib,
        "userOnesDoc",
        ContentModel.TYPE_CONTENT,
        SITE_INFO.siteContributor
      );
  }
    ...
    TRANSACTION_HELPER.doInTransaction(
      new RetryingTransactionCallback<Void>() {
        public Void execute() throws Throwable {
          ...
          assertEquals(
            "Wrong owner at test start.",
            SITE_INFO.siteContributor,
            OWNABLE_SERVICE.getOwner(TEST_DOC)
          );
          ...
          TakeOwnershipActionExecuter executor = APP_CONTEXT_INIT
            .getApplicationContext()
            .getBean(
              TakeOwnershipActionExecuter.NAME,
