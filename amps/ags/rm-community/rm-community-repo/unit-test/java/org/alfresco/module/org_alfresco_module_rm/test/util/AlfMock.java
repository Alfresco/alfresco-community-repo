...
public class AlfMock {
     ...
     *
     * @return {@link NodeRef} node reference that behaves like a node that exists in the spaces
     *     store
     */
     ...
     * @return {@link NodeRef} node reference that behaves like a node that exists in the spaces
     *     store with the content type provided
     */
    ...
    /**
     * Helper method to generate a node reference of a particular type with a given existence
     * characteristic.
     *
     * @param type content type qualified name
     * @param exists indicates whether this node should behave like a node that exists or not
     * @return {@link NodeRef} node reference that behaves like a node that exists (or not) in the
     *     spaces store with the content type provided
     */
    public static NodeRef generateNodeRef(
            NodeService mockedNodeService, QName type, boolean exists) {
