...
public class TaggingServiceTest extends BaseWebScriptTest {
  ...
  protected void setUp() throws Exception {
    ...
    this.taggingService =
      (TaggingService) getServer()
        .getApplicationContext()
        .getBean("TaggingService");
  ...
  public void testGetTags() throws Exception {
    Response response = sendRequest(
      new GetRequest(
        "/api/tags/" + StoreRef.PROTOCOL_WORKSPACE + "/SpacesStore"
      ),
      200
    );
    ...
    response =
      sendRequest(
        new GetRequest(
          "/api/tags/" + StoreRef.PROTOCOL_WORKSPACE + "/SpacesStore?tf=none"
        ),
        200
      );
    jsonArray = new JSONArray(response.getContentAsString());
  ...
  public void testGetNodes() throws Exception {
    ...
    response =
      sendRequest(
        new GetRequest(
          "/api/tags/" + StoreRef.PROTOCOL_WORKSPACE + "/SpacesStore/jumk/nodes"
        ),
        200
      );
    jsonArray = new JSONArray(response.getContentAsString());
