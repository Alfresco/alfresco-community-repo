...
public class UpdateTaskVariableTestsBulk2 extends RestTest {
    ...
    public void updateTaskVariableByUserWhoStartedProcess() throws Exception {
        ...
        taskVariable.assertThat().field("value").is("new-value").and().field("name").is("new-name");
    }
    ...
    public void updateTaskVariableWithInvalidTaskId() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(
                        String.format(RestErrorModel.ENTITY_NOT_FOUND, invalidTask.getId()));
    }
    ...
    public void updateTaskVariableWithInvalidScope() throws Exception {
        ...
        restClient
                ...
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.ILLEGAL_SCOPE, "invalid-scope"));
    }
    ...
    public void updateTaskVariableWithInvalidType() throws Exception {
        ...
        restClient
                .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
                .assertLastError()
                .containsSummary(String.format(RestErrorModel.UNSUPPORTED_TYPE, "d:invalidType"));
    }
