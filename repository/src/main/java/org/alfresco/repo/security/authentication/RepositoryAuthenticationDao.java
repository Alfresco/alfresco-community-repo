...
public class RepositoryAuthenticationDao
  ...
  private static final StoreRef STOREREF_USERS = new StoreRef(
    "user",
    "alfrescoUserStore"
  );

  private static Log logger = LogFactory.getLog(
    RepositoryAuthenticationDao.class
  );
  ...
  public void setAuthenticationCache(
    SimpleCache<String, CacheEntry> authenticationCache
  ) {
  ...
  public void setCompositePasswordEncoder(
  ...
  public UserDetails loadUserByUsername(String incomingUserName)
    ...
    if (
      userEntry.credentialExpiryDate == null ||
   ...
   */
  private CacheEntry getUserEntryOrNull(
    final String caseSensitiveSearchUserName
  ) {
    try {
  ...
  private CacheEntry getUserEntryOrNullImpl(
    final String caseSensitiveSearchUserName
  ) {
    if (
      caseSensitiveSearchUserName == null ||
      caseSensitiveSearchUserName.length() == 0
    ) {
      return null;
    }

    class SearchUserNameCallback
      implements RetryingTransactionCallback<CacheEntry> {

      @Override
      public CacheEntry execute() throws Throwable {
        CacheEntry cacheEntry = authenticationCache.get(
        ...
        if (!results.isEmpty()) {
          ...
          Pair<List<String>, String> hashPassword = determinePasswordHash(
            properties
          );

          // Report back the user name as stored on the user
          String userName = DefaultTypeConverter.INSTANCE.convert(
            String.class,
          ...
          boolean isAdminAuthority = authorityService.isAdminAuthority(
            userName
          );

          Date credentialsExpiryDate = getCredentialsExpiryDate(
            userName,
            properties,
            isAdminAuthority
          );
  ...
  public static Pair<List<String>, String> determinePasswordHash(
    ...
    List<String> hashIndicator = (List<String>) properties.get(
    ...
    if (hashIndicator != null && hashIndicator.size() > 0) {
      ...
      return new Pair<>(
        ...
        DefaultTypeConverter.INSTANCE.convert(
          String.class,
          properties.get(ContentModel.PROP_PASSWORD_HASH)
        )
      );
    } else {
      String passHash = DefaultTypeConverter.INSTANCE.convert(
        String.class,
        properties.get(ContentModel.PROP_PASSWORD_SHA256)
      );
      if (passHash != null) {
  ...
  public void createUser(
    ...
    boolean emptyPassword = rawPassword != null
      ? "".equals(new String(rawPassword))
      : true;
  ...
  private NodeRef getUserFolderLocation(String caseSensitiveUserName) {
    ...
    NodeRef userNodeRef = singletonCache.get(
      userDomain + KEY_USERFOLDER_NODEREF
    );
    if (userNodeRef == null) {
      QName qnameAssocSystem = QName.createQName(
        "sys",
        "system",
        namespacePrefixResolver
      );
      QName qnameAssocUsers = QName.createQName(
        "sys",
        "people",
        namespacePrefixResolver
      );
      ...
      singletonCache.put(
        (
          tenantService.getUserDomain(caseSensitiveUserName) +
          KEY_USERFOLDER_NODEREF
        ),
        userNodeRef
      );
    }
  ...
  @Override
  public void updateUser(String userName, char[] rawPassword)
    throws AuthenticationException {
  ...
  public boolean getAccountExpires(String userName) {
    ...
    Serializable ser = nodeService.getProperty(
      userNode,
  ...
  public Date getAccountExpiryDate(String userName) {
    ...
    if (
      DefaultTypeConverter.INSTANCE.booleanValue(
  ...
  protected boolean getHasExpired(
    ...
    if (
      ...
      Date date = DefaultTypeConverter.INSTANCE.convert(
        Date.class,
        properties.get(ContentModel.PROP_ACCOUNT_EXPIRY_DATE)
      );
      if (date == null) {
        return false;
      } else {
   ...
   * @param properties        user properties or <tt>null</tt> to fetch them
   */
  protected boolean getCredentialsExpire(
    String userName,
    Map<QName, Serializable> properties
  ) {
    if (authorityService.isAdminAuthority(userName)) {
  ...
  private Date getCredentialsExpiryDate(
    ...
    if (
      ...
      return DefaultTypeConverter.INSTANCE.convert(
        Date.class,
        properties.get(ContentModel.PROP_CREDENTIALS_EXPIRY_DATE)
      );
    }
    return null;
  }
  ...
  public void onUpdateProperties(
    ...
    String uidBefore = DefaultTypeConverter.INSTANCE.convert(
      String.class,
      before.get(ContentModel.PROP_USERNAME)
    );
    String uidAfter = DefaultTypeConverter.INSTANCE.convert(
      String.class,
      after.get(ContentModel.PROP_USERNAME)
    );
    if (
      uidBefore != null && !EqualsHelper.nullSafeEquals(uidBefore, uidAfter)
    ) {
  ...
  public void onUpdateUserProperties(
    ...
    String uidBefore = DefaultTypeConverter.INSTANCE.convert(
      String.class,
      before.get(ContentModel.PROP_USER_USERNAME)
    );
    if (uidBefore != null) {
      removeAuthenticationFromCache(uidBefore);
    }
  ...
  static class CacheEntry implements Serializable {
    ...
    public String toString() {
      return (
        "CacheEntry [nodeRef=" + nodeRef + ", userDetails=" + userDetails + "]"
      );
    }
  }
}
