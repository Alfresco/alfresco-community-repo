...
public class ConcurrentNodeServiceSearchTest extends TestCase {
    ...
    public void testConcurrent() throws Exception {
        ...
        SearchService searcher =
                (SearchService) ctx.getBean(ServiceRegistry.SEARCH_SERVICE.getLocalName());
        ...
        assertEquals(
                2,
                searcher.selectNodes(rootNodeRef, "/*", null, getNamespacePrefixReolsver(""), false)
                        .size());
        ...
        public void run() {
            ...
            try {
                ...
                for (int i = 0; i < repeats; i++) {
                    ...
                    ResultSet results =
                            searcher.query(rootNodeRef.getStoreRef(), "lucene", "PATH:\"/*\"");
                    results.close();
                }
