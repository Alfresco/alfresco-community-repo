...
public class ConstraintsTest extends TestCase {
    ...
    public void testCollections() throws Exception {
        ...
        assertEquals(
                "DummyConstraint type should be"
                    + " 'org.alfresco.repo.dictionary.constraint.ConstraintsTest$DummyConstraint'",
                "org.alfresco.repo.dictionary.constraint.ConstraintsTest$DummyConstraint",
                constraint.getType());
        assertNotNull(
                "DummyConstraint should not have empty parameters", constraint.getParameters());
        assertEquals(
    ...
    private void evaluate(Constraint constraint, Object value, boolean expectFailure)
            throws Exception {
        try {
    ...
    public void testStringLengthConstraint() throws Exception {
        ...
        assertEquals(
                "StringLengthConstraint type should be 'LENGTH'", "LENGTH", constraint.getType());
        ...
        assertEquals(
                ...
                2,
                constraint.getParameters().size());
        assertEquals("minLength should be 3", 3, constraint.getParameters().get("minLength"));
        assertEquals("maxLength should be 6", 6, constraint.getParameters().get("maxLength"));
    ...
    public void testListOfValuesConstraint() throws Exception {
        ...
        assertEquals("ListOfValuesConstraint type should be 'LIST'", "LIST", constraint.getType());
        ...
        List<String> allowedValuesParam =
                (List<String>) constraint.getParameters().get("allowedValues");
    ...
    public void testNumericRangeConstraint() throws Exception {
        ...
        assertEquals(
                "NumericRangeConstraint type should be 'MINMAX'", "MINMAX", constraint.getType());
    ...
    public void testRegexConstraint() throws Exception {
        ...
        assertEquals("RegexConstraint type should be 'REGEX'", "REGEX", constraint.getType());
        assertNotNull("RegexConstraint should have parameters", constraint.getParameters());
        assertEquals(
                "RegexConstraint should have 2 parameters", 2, constraint.getParameters().size());
        assertEquals(
    ...
    private class DummyConstraint extends AbstractConstraint {
        ...
        /**
         * Fails on everything but String values, which pass. Null values cause runtime exceptions
         * and all other failures are by DictionaryException.
         */
        @Override
