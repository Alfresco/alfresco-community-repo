        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        assertEquals(
                                AccessStatus.ALLOWED, viewRecords.hasPermission(holdContainer));
                        assertEquals(
                                AccessStatus.ALLOWED, viewRecords.hasPermission(transferContainer));
                            ...
                            public NodeRef run() {
                                ...
                                NodeRef hold =
                                        holdService.createHold(
                                                filePlan, "my hold", "my reason", "my description");
        ...
        doTestInTransaction(
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        assertEquals(
                                AccessStatus.ALLOWED,
                                permissionService.hasPermission(hold, RMPermissionModel.FILING));
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        assertEquals(
                                AccessStatus.DENIED,
                                permissionService.hasPermission(
                                        hold, RMPermissionModel.READ_RECORDS));
                        assertEquals(
                                AccessStatus.DENIED,
                                permissionService.hasPermission(hold, RMPermissionModel.FILING));
                        ...
                        new Test<NodeRef>() {
                            ...
                            public NodeRef run() {
                                ...
                                return recordFolderService.createRecordFolder(
                                        transferCat, "transferFolder");
                            }
                        });

        final NodeRef transfer =
                doTestInTransaction(
                        new Test<NodeRef>() {
                            @Override
                            public NodeRef run() {
                                rmActionService.executeRecordsManagementAction(
                                        transferFolder, "cutoff");
                                rmActionService.executeRecordsManagementAction(
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        assertEquals(
                                AccessStatus.ALLOWED,
                                permissionService.hasPermission(
                                        transfer, RMPermissionModel.FILING));
                ...
                new Test<Void>() {
                    ...
                    public Void run() {
                        ...
                        assertEquals(
                                AccessStatus.DENIED,
                                permissionService.hasPermission(
                                        transfer, RMPermissionModel.READ_RECORDS));
                        assertEquals(
                                AccessStatus.DENIED,
                                permissionService.hasPermission(
                                        transfer, RMPermissionModel.FILING));
