...
public class GetProcessDefinitionFullTests extends RestTest {
  ...
  public void getProcessDefinitionUsingEmptyProcessDefinitionId()
    throws Exception {
    ...
    RestProcessDefinitionModelsCollection processDefinitions = restClient.processModels(
      RestProcessDefinitionModelsCollection.class,
      request
    );
