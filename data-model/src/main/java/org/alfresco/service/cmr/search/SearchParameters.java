...
/**
 * This class provides parameters to define a search. TODO - paging of results page number and page
 * size - paging isolation - REPEATABLE READ, READ COMMITTED, may SEE ONCE tracking node refs in
 * previous result sets - how long repeatable read may be held - limit by the number of permission
 * evaluations
 *
 * @author Andy Hind
 */
...
public class SearchParameters implements BasicSearchParameters {
    ...
    public static final SortDefinition SORT_IN_DOCUMENT_ORDER_ASCENDING =
            new SortDefinition(SortDefinition.SortType.DOCUMENT, null, true);

    /** Sort in the reverse order docs were added to the index - new/updateed docs first */
    public static final SortDefinition SORT_IN_DOCUMENT_ORDER_DESCENDING =
            new SortDefinition(SortDefinition.SortType.DOCUMENT, null, false);

    /** Sort in ascending score */
    public static final SortDefinition SORT_IN_SCORE_ORDER_ASCENDING =
            new SortDefinition(SortDefinition.SortType.SCORE, null, true);

    /** Sort in descending score order */
    public static final SortDefinition SORT_IN_SCORE_ORDER_DESCENDING =
            new SortDefinition(SortDefinition.SortType.SCORE, null, false);

    /**
     * An emum defining if the default action is to "and" or "or" unspecified components in the
     * query register. Not all search implementations will support this.
     */
    ...
    private ArrayList<QueryParameterDefinition> queryParameterDefinitions =
            new ArrayList<QueryParameterDefinition>(1);
    ...
    /**
     * Set the stores to be supported - currently there can be only one. Searching across multiple
     * stores is on the todo list.
     *
    ...
    /**
     * If true, any data in the current transaction will be ignored in the search. You will not see
     * anything you have added in the current transaction. By default you will see data in the
     * current transaction. This effectively gives read committed isolation. There is a performance
     * overhead for this, at least when using lucene. This flag may be set to avoid that performance
     * hit if you know you do not want to find results that are yet to be committed (this includes
    ...
    /**
     * Add a sort to the query (for those query languages that do not support it directly) The first
     * sort added is treated as primary, the second as secondary etc. A helper method to create
     * SortDefinitions.
     *
     * @param field - this is initially a direct attribute on a node not an attribute on the parent
     *     etc TODO: It could be a relative path at some time.
     ...
     *
     * @param sortDefinition - the sort definition to add. Use the static member variables for
     *     sorting in score and index order.
     */
    ...
    /**
     * The way in which multilingual fields are treated durig a search. By default, only the
     * specified locale is used and it must be an exact match.
     *
    ...
    /**
     * Set the way in which multilingual fields are treated durig a search. This controls in which
     * locales an multilingual fields will match.
     *
    ...
    /**
     * Add a locale to include for multi-lingual text searches. If non are set, the default is to
    ...
    /**
     * Set the max number of rows for the result set. A negative value implies unlimited 0 will
     * return no results.
     *
     ...
     * function.
     *
     * @param defaultFTSOperator the defaultFTSOperator to set
     */
     ...
     *
     * @param defaultFTSFieldOperator the defaultFTSFieldOperator to set
     */
    ...
    /**
     * A helper class for sort definition. Encapsulated using the lucene sortType, field name and a
    ...
    public Locale getSortLocale() {
        ...
        if (locales.size() > 1) {
            throw new AlfrescoRuntimeException(
                    "Order on text/mltext properties with more than one locale is not curently"
                            + " supported");
        }
    ...
    /**
     * If not null, then the search should only include results from transactions after {@code
     * sinceTxId}.
     *
     * @return sinceTxId
     */
    ...
    public int hashCode() {
        ...
        result =
                prime * result
                        + ((defaultFTSFieldOperator == null)
                                ? 0
                                : defaultFTSFieldOperator.hashCode());
        result =
                prime * result + ((defaultFTSOperator == null) ? 0 : defaultFTSOperator.hashCode());
                ...
                prime * result
                        + (int)
                                (maxPermissionCheckTimeMillis
                                        ^ (maxPermissionCheckTimeMillis >>> 32));
        result = prime * result + maxPermissionChecks;
        result =
                prime * result
                        + ((maxRawResultSetSizeForInMemorySort == null)
                                ? 0
                                : maxRawResultSetSizeForInMemorySort.hashCode());
        result = prime * result + ((mlAnalaysisMode == null) ? 0 : mlAnalaysisMode.hashCode());
        result = prime * result + ((namespace == null) ? 0 : namespace.hashCode());
        result =
                prime * result
                        + ((permissionEvaluation == null) ? 0 : permissionEvaluation.hashCode());
        result = prime * result + ((query == null) ? 0 : query.hashCode());
        result = prime * result + ((queryConsistency == null) ? 0 : queryConsistency.hashCode());
        result =
                prime * result
                        + ((queryParameterDefinitions == null)
                                ? 0
                                : queryParameterDefinitions.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (allAttributes == null) {
            if (other.allAttributes != null) return false;
        } else if (!allAttributes.equals(other.allAttributes)) return false;
        if (defaultFTSFieldOperator != other.defaultFTSFieldOperator) return false;
        if (defaultFTSOperator != other.defaultFTSOperator) return false;
        if (defaultFieldName == null) {
            if (other.defaultFieldName != null) return false;
        } else if (!defaultFieldName.equals(other.defaultFieldName)) return false;
        if (excludeDataInTheCurrentTransaction != other.excludeDataInTheCurrentTransaction)
            return false;
        if (excludeTenantFilter != other.excludeTenantFilter) return false;
        if (fieldFacets == null) {
            if (other.fieldFacets != null) return false;
        } else if (!fieldFacets.equals(other.fieldFacets)) return false;
        if (language == null) {
            if (other.language != null) return false;
        } else if (!language.equals(other.language)) return false;
        if (limit != other.limit) return false;
        if (limitBy != other.limitBy) return false;
        if (locales == null) {
            if (other.locales != null) return false;
        } else if (!locales.equals(other.locales)) return false;
        if (maxItems != other.maxItems) return false;
        if (maxPermissionCheckTimeMillis != other.maxPermissionCheckTimeMillis) return false;
        if (maxPermissionChecks != other.maxPermissionChecks) return false;
        if (maxRawResultSetSizeForInMemorySort == null) {
            if (other.maxRawResultSetSizeForInMemorySort != null) return false;
        } else if (!maxRawResultSetSizeForInMemorySort.equals(
                other.maxRawResultSetSizeForInMemorySort)) return false;
        if (mlAnalaysisMode != other.mlAnalaysisMode) return false;
        if (namespace == null) {
            if (other.namespace != null) return false;
        } else if (!namespace.equals(other.namespace)) return false;
        if (permissionEvaluation != other.permissionEvaluation) return false;
        if (query == null) {
            if (other.query != null) return false;
        } else if (!query.equals(other.query)) return false;
        if (queryConsistency != other.queryConsistency) return false;
        if (queryParameterDefinitions == null) {
            if (other.queryParameterDefinitions != null) return false;
        } else if (!queryParameterDefinitions.equals(other.queryParameterDefinitions)) return false;
        if (queryTemplates == null) {
            if (other.queryTemplates != null) return false;
        } else if (!queryTemplates.equals(other.queryTemplates)) return false;
        if (skipCount != other.skipCount) return false;
        if (sortDefinitions == null) {
            if (other.sortDefinitions != null) return false;
        } else if (!sortDefinitions.equals(other.sortDefinitions)) return false;
        if (stores == null) {
            if (other.stores != null) return false;
        } else if (!stores.equals(other.stores)) return false;
        if (textAttributes == null) {
            if (other.textAttributes != null) return false;
        } else if (!textAttributes.equals(other.textAttributes)) return false;
        if (useInMemorySort == null) {
            if (other.useInMemorySort != null) return false;
        } else if (!useInMemorySort.equals(other.useInMemorySort)) return false;
        if (sinceTxId == null) {
            if (other.sinceTxId != null) return false;
        } else if (!sinceTxId.equals(other.sinceTxId)) return false;
        if (!facetQueries.equals(other.facetQueries)) return false;
        if (!filterQueries.equals(other.filterQueries)) return false;
        if (!pivots.equals(other.pivots)) return false;
        if (searchTerm == null) {
            if (other.searchTerm != null) return false;
        } else if (!searchTerm.equals(other.searchTerm)) return false;
    ...
    public String toString() {
        ...
        builder.append("SearchParameters [language=")
                .append(this.language)
                .append(", query=")
                .append(this.query)
                .append(", stores=")
                .append(this.stores)
                .append(", queryParameterDefinitions=")
                .append(this.queryParameterDefinitions)
                .append(", excludeDataInTheCurrentTransaction=")
                .append(this.excludeDataInTheCurrentTransaction)
                .append(", sortDefinitions=")
                .append(this.sortDefinitions)
                .append(", locales=")
                .append(this.locales)
                .append(", mlAnalaysisMode=")
                .append(this.mlAnalaysisMode)
                .append(", limitBy=")
                .append(this.limitBy)
                .append(", permissionEvaluation=")
                .append(this.permissionEvaluation)
                .append(", limit=")
                .append(this.limit)
                .append(", allAttributes=")
                .append(this.allAttributes)
                .append(", textAttributes=")
                .append(this.textAttributes)
                .append(", maxItems=")
                .append(this.maxItems)
                .append(", skipCount=")
                .append(this.skipCount)
                .append(", defaultFTSOperator=")
                .append(this.defaultFTSOperator)
                .append(", defaultFTSFieldOperator=")
                .append(this.defaultFTSFieldOperator)
                .append(", queryTemplates=")
                .append(this.queryTemplates)
                .append(", namespace=")
                .append(this.namespace)
                .append(", maxPermissionChecks=")
                .append(this.maxPermissionChecks)
                .append(", maxPermissionCheckTimeMillis=")
                .append(this.maxPermissionCheckTimeMillis)
                .append(", defaultFieldName=")
                .append(this.defaultFieldName)
                .append(", fieldFacets=")
                .append(this.fieldFacets)
                .append(", facetQueries=")
                .append(this.facetQueries)
                ...
                .append(", stats=")
                .append(this.stats)
                .append(", useInMemorySort=")
                .append(this.useInMemorySort)
                .append(", maxRawResultSetSizeForInMemorySort=")
                .append(this.maxRawResultSetSizeForInMemorySort)
                .append(", extraParameters=")
                .append(this.extraParameters)
                .append(", excludeTenantFilter=")
                .append(this.excludeTenantFilter)
                .append(", isBulkFetchEnabled=")
                .append(this.isBulkFetchEnabled)
                .append(", queryConsistency=")
                .append(this.queryConsistency)
                .append(", sinceTxId=")
                .append(this.sinceTxId)
                .append(", searchTerm=")
                .append(this.searchTerm)
                .append(", highlight=")
    ...
    public static class FieldFacet {
        ...
        @Deprecated
        /**
         * Will return 100 as the old default but this is now defined in configuration and will be
         * wrong if no explicitly set
         *
         * @return
         */
        public int getLimit() {
        ...
        public boolean equals(Object o) {
            ...
            if (countDocsMissingFacetField != that.countDocsMissingFacetField) return false;
            if (enumMethodCacheMinDF != that.enumMethodCacheMinDF) return false;
            if (!field.equals(that.field)) return false;
            if (label != null ? !label.equals(that.label) : that.label != null) return false;
            if (excludeFilters != null
                    ? !excludeFilters.equals(that.excludeFilters)
                    : that.excludeFilters != null) return false;
            if (prefix != null ? !prefix.equals(that.prefix) : that.prefix != null) return false;
            if (sort != that.sort) return false;
            if (limitOrNull != null
                    ? !limitOrNull.equals(that.limitOrNull)
                    : that.limitOrNull != null) return false;
     ...
     * @return boolean
     */
    public boolean usePostSort(
            int length,
            boolean useInMemorySortDefault,
            int maxRawResultSetSizeForInMemorySortDefault) {
        boolean use =
                (useInMemorySort == null) ? useInMemorySortDefault : useInMemorySort.booleanValue();
        int max =
                (maxRawResultSetSizeForInMemorySort == null)
                        ? maxRawResultSetSizeForInMemorySortDefault
                        : maxRawResultSetSizeForInMemorySort.intValue();
