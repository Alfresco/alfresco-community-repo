...
public class UploadWebScriptTest extends BaseWebScriptTest {
  ...
  private static final String DOCUMENT_SITE_NAME =
    "docSiteWithVersionLabel-.txt";
  ...
  protected void setUp() throws Exception {
    ...
    this.checkOutCheckInService =
      (CheckOutCheckInService) getServer()
        .getApplicationContext()
        .getBean("checkOutCheckInService");
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          ...
          public Void execute() throws Throwable {
            ...
            Response response = uploadFileWs(
              file,
              fileName,
            ...
            JSONObject jsonRsp = (JSONObject) JSONValue.parse(
    ...
    transactionService
      ...
      .doInTransaction(
        new RetryingTransactionCallback<Void>() {
          @Override
          public Void execute() throws Throwable {
            NodeRef workingCopyDocSite = checkOutCheckInService.checkout(
              documentSite
            );
            contentService
              .getWriter(workingCopyDocSite, ContentModel.PROP_CONTENT, true)
  ...
  private Response uploadFileWs(
    File file,
    String filename,
    String siteId,
    String containerId
  ) throws IOException {
    PostRequest postRequest = buildMultipartPostRequest(
      file,
      filename,
      siteId,
      containerId
  ...
  private File getResourceFile(String fileName) throws FileNotFoundException {
    URL url =
      VersionableAspectTest.class.getClassLoader()
