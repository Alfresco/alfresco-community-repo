...
public class MultiTServiceImpl implements TenantService {
  ...
  public StoreRef getName(StoreRef storeRef) {
    ...
    return new StoreRef(
      ...
      getName(storeRef.getIdentifier())
    );
  }
  ...
  public StoreRef getName(String username, StoreRef storeRef) {
    ...
    if ((username != null) && (AuthenticationUtil.isMtEnabled())) {
      ...
      if ((idx > 0) && (idx < (username.length() - 1))) {
        ...
        return new StoreRef(
          storeRef.getProtocol(),
          getName(storeRef.getIdentifier(), tenantDomain)
        );
      }
    }
  ...
  public QName getBaseName(QName name, boolean forceForNonTenant) {
    String baseNamespaceURI = getBaseName(
  ...
  public StoreRef getBaseName(StoreRef storeRef) {
    ...
    return new StoreRef(
      storeRef.getProtocol(),
      getBaseName(storeRef.getIdentifier())
    );
  }
  ...
  public String getBaseName(String name, boolean forceForNonTenant) {
    ...
    if (idx1 == 0) {
      ...
      if (
        (!tenantDomain.equals(DEFAULT_DOMAIN)) &&
  ...
  public void checkDomainUser(String username) {
    ...
    if (!tenantDomain.equals(DEFAULT_DOMAIN)) {
      ...
      if ((idx2 > 0) && (idx2 < (username.length() - 1))) {
        ...
        if (
          (tenantUserDomain == null) ||
          (!tenantDomain.equalsIgnoreCase(tenantUserDomain))
        ) {
          throw new TenantDomainMismatchException(
            tenantDomain,
            tenantUserDomain
          );
        }
  ...
  public void checkDomain(String name) {
    ...
    if (
      ((nameDomain == null) && (!tenantDomain.equals(DEFAULT_DOMAIN))) ||
  ...
  public NodeRef getRootNode(
    ...
    AuthenticationUtil.RunAsWork<NodeRef> action = new GetRootNode(
      nodeService,
      searchService,
      namespaceService,
      rootPath,
  ...
  public String getDomainUser(String baseUsername, String tenantDomain) {
    ...
    if ((tenantDomain == null) || (tenantDomain.equals(DEFAULT_DOMAIN))) {
      ...
      if (baseUsername.contains(SEPARATOR)) {
        throw new AlfrescoRuntimeException(
          "Invalid base username: " + baseUsername
        );
      }
