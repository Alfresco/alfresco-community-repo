...
public class GetFavoritesTests extends RestTest {
  ...
  public void dataPreparation() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingUser(userModel)
      .addSiteToFavorites(secondSiteModel);
    restClient
      .withCoreAPI()
      .usingUser(userModel)
      .addSiteToFavorites(thirdSiteModel);
  }
  ...
  public void managerIsAbleToRetrieveFavorites() throws Exception {
    restClient.authenticateUser(
      firstSiteUsers.getOneUserWithRole(UserRole.SiteManager)
    );
  ...
  public void userIsNotAbleToRetrieveFavoritesIfAuthenticationFails()
    throws Exception {
    UserModel siteManager = firstSiteUsers.getOneUserWithRole(
      UserRole.SiteManager
    );
  ...
  public void adminIsAbleToRetrieveFavoritesFolders() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingUser(adminUserModel)
      .addFolderToFavorites(secondFolderModel);
  ...
  public void adminIsAbleToRetrieveFavoritesFiles() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingUser(adminUserModel)
      .addFileToFavorites(secondFileModel);
    ...
    userFavorites
      ...
      .entriesListContains(
        "targetGuid",
        firstFileModel.getNodeRefWithoutVersion()
      )
      .and()
      .entriesListContains(
        "targetGuid",
        secondFileModel.getNodeRefWithoutVersion()
      );
  }
  ...
  public void collaboratorIsAbleToRetrieveFavorites() throws Exception {
    restClient
      .authenticateUser(
        firstSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator)
      )
      .withCoreAPI()
      .usingAuthUser()
      .addSiteToFavorites(firstSiteModel);
  ...
  public void contributorIsAbleToRetrieveFavorites() throws Exception {
    restClient
      .authenticateUser(
        firstSiteUsers.getOneUserWithRole(UserRole.SiteContributor)
      )
      .withCoreAPI()
      .usingAuthUser()
      .addSiteToFavorites(firstSiteModel);
  ...
  public void consumerIsAbleToRetrieveFavorites() throws Exception {
    restClient
      .authenticateUser(
        firstSiteUsers.getOneUserWithRole(UserRole.SiteConsumer)
      )
      .withCoreAPI()
      .usingAuthUser()
      .addSiteToFavorites(firstSiteModel);
  ...
  public void userIsAbleToRetrieveOnlyFavoritesSites() throws Exception {
    restClient.authenticateUser(
      secondSiteUsers.getOneUserWithRole(UserRole.SiteManager)
    );
    restClient.withCoreAPI().usingAuthUser().addSiteToFavorites(firstSiteModel);
  ...
  public void userIsAbleToRetrieveAllFavorites() throws Exception {
    restClient.authenticateUser(
      secondSiteUsers.getOneUserWithRole(UserRole.SiteCollaborator)
    );
    restClient.withCoreAPI().usingAuthUser().addSiteToFavorites(firstSiteModel);
    restClient.withCoreAPI().usingAuthUser().addFileToFavorites(firstFileModel);
    restClient
  ...
  public void userHasNoFavorites() throws Exception {
    restClient.authenticateUser(
      secondSiteUsers.getOneUserWithRole(UserRole.SiteContributor)
    );
  ...
  public void getFavoritesUsingInvalidWhereParameter() throws Exception {
    ...
    userFavorites =
      restClient.withCoreAPI().usingAuthUser().where().or().getFavorites();
    restClient
      .assertStatusCodeIs(HttpStatus.BAD_REQUEST)
      .assertLastError()
      .containsSummary(
        String.format(RestErrorModel.INVALID_ARGUMENT, "WHERE query")
      );
  }
  ...
  public void checkFavoriteFolderIsRemoved() throws Exception {
    ...
    restClient
      .withCoreAPI()
      .usingAuthUser()
      .deleteFolderFromFavorites(firstFolderModel);
  ...
  public void userIsAbleToGetFavoritesWithPropertiesParamApplied()
    ...
    RestPersonFavoritesModel restPersonFavoritesModel = userFavorites
      .getEntries()
      .get(0)
      .onModel();
  ...
  public void checkResponseSchemaForGetFavorites() throws Exception {
    ...
    RestSiteModel restSiteModel = restPersonFavoritesModel
      .getTarget()
      .getSite();
    restSiteModel
      .assertThat()
