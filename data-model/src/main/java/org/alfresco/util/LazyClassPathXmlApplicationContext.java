...
public class LazyClassPathXmlApplicationContext
   ...
   */
  protected static void postInitBeanDefinitionReader(
    XmlBeanDefinitionReader reader
  ) {
    reader.setDocumentReaderClass(
      AlwaysLazyInitBeanDefinitionDocumentReader.class
    );
  }
  ...
  protected static class AlwaysLazyInitBeanDefinitionDocumentReader
    ...
    protected BeanDefinitionParserDelegate createDelegate(
      ...
      BeanDefinitionParserDelegate delegate = super.createDelegate(
        readerContext,
        root,
        parentDelegate
      );
