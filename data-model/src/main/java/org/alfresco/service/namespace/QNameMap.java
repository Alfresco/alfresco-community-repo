...
/**
 * A Map that holds as it's key a QName stored in it's internal String representation. Calls to get
 * and put automatically map the key to and from the QName representation.
 *
 * @author gavinc
 */
public class QNameMap<K, V> implements Map, Cloneable, Serializable {
    ...
    /**
     * Helper to return a NamespacePrefixResolver instance - should -always- be used rather than
     * holding onto a reference on the heap.
     *
    ...
    public boolean containsKey(Object key) {
        return (this.contents.containsKey(
                QName.resolveToQNameString(getResolver(), key.toString())));
    }
