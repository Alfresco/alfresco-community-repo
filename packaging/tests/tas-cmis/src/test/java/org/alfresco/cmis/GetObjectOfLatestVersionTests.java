...
public class GetObjectOfLatestVersionTests extends CmisTest {
  ...
  public void siteManagerCannotGetLastMajorVersionForInexistentDocument()
    throws Exception {
  ...
  public void siteManagerCanGetLastMajorVersionForCheckedOutDocument()
    throws Exception {
    testFile = FileModel.getRandomFileModel(FileType.TEXT_PLAIN);
    cmisApi
      .authenticateUser(testUser)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void collaboratorCanGetLastVersionsForDocumentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void contributorCanGetLastVersionsForDocumentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void consumerCanGetLastVersionsForDocumentCreatedByManager()
    throws Exception {
    cmisApi
      .authenticateUser(
        usersWithRoles.getOneUserWithRole(UserRole.SiteContributor)
  ...
  @Test(groups = { TestGroup.REGRESSION, TestGroup.CMIS })
  public void nonInvitedUserCanGetLastVersionsForDocumentInPublicSite()
    throws Exception {
    cmisApi
