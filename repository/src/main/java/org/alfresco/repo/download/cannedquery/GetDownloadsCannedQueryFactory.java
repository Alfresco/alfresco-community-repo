...
public class GetDownloadsCannedQueryFactory
    ...
    public CannedQuery<DownloadEntity> getDownloadsCannedQuery(NodeRef containerNode, Date before) {
        ...
        GetDownloadsCannedQueryParams parameterBean =
                new GetDownloadsCannedQueryParams(
        ...
        final GetDownloadsCannedQuery cq =
                new GetDownloadsCannedQuery(cannedQueryDAO, methodSecurity, params);
