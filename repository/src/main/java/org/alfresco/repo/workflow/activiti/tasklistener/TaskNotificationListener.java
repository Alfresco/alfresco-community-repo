...
public class TaskNotificationListener implements TaskListener {
  ...
  public void notify(DelegateTask task) {
    ...
    Boolean value = (Boolean) executionEntity.getVariable(
      WorkflowNotificationUtils.PROP_SEND_EMAIL_NOTIFICATIONS
    );
    if (Boolean.TRUE.equals(value) == true) {
      NodeRef workflowPackage = null;
      ActivitiScriptNode scriptNode = (ActivitiScriptNode) executionEntity.getVariable(
      ...
      if (task.getAssignee() == null) {
        ...
        List<IdentityLinkEntity> identities =
          ((TaskEntity) task).getIdentityLinks();
      ...
      if (taskFormKey != null) {
        ...
        String defName = propertyConverter
          .getWorkflowObjectFactory()
