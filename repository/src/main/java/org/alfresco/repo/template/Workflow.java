...
public class Workflow extends BaseTemplateProcessorExtension {
    ...
    public static class WorkflowTaskItem implements NamespacePrefixResolverProvider {
        ...
        public WorkflowTaskItem(
                ServiceRegistry services, TemplateImageResolver resolver, WorkflowTask task) {
            this.task = task;
            this.services = services;
        ...
        public TemplateNode getInitiator() {
            return new TemplateNode(
                    this.task.path.instance.initiator, this.services, this.resolver);
        }
        ...
        /**
         * @return A map of properties for the workflow task, includes all appropriate bpm model
         *     properties.
         */
