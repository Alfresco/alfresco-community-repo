...
public interface Encryptor {
     ...
     */
    Pair<byte[], AlgorithmParameters> encrypt(
     ...
     * @return the encrypted data and parameters used
     */
    Pair<byte[], AlgorithmParameters> encryptObject(
     ...
     *
     * <p>Note that the original object may be returned directly if there is no key associated with
     * the alias.
     *
     * @param keyAlias the encryption key alias
     ...
     *
     * <p>Note that the algorithm parameters not provided on the assumption that a symmetric key
