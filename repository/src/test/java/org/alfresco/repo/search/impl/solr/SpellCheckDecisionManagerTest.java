...
public class SpellCheckDecisionManagerTest {
  ...
  private static final String RESOURCE_PREFIX =
    "org/alfresco/repo/search/impl/spellcheck/";
  ...
  public void testCollation() throws Exception {
    ...
    SpellCheckDecisionManager manager = new SpellCheckDecisionManager(
      resultJson,
    ...
    assertEquals(
      "alfresco",
      searchedForJsonObject.getString("searchInsteadFor")
    );
  ...
  public void testCorrectlySpelledTerm() throws Exception {
    ...
    JSONObject resultJson = getSearchResponseAsJson(
      "correctlySpelledTermQuery.json"
    );
  ...
  public void testCorrectlySpelledTerm2() throws Exception {
    ...
    JSONObject resultJson = getSearchResponseAsJson(
      "correctlySpelledTermQuery2.json"
    );
  ...
  public JSONObject getSearchResponseAsJson(String jsonResponse)
    ...
    URL url =
      SpellCheckDecisionManagerTest.class.getClassLoader()
  ...
  public JSONObject createJsonSearchRequest(String searchTerm)
  ...
  private long getCollationHit(JSONObject resultJson) throws JSONException {
    ...
    for (
      int key = 0, value = 1, length = suggestions.length();
      value < length;
      key += 2, value += 2
    ) {
  ...
  private long getCollationHit2(JSONObject resultJson) throws JSONException {
    ...
    for (
      int key = 0, value = 1, length = collations.length();
      value < length;
      key += 2, value += 2
    ) {
