...
public interface SynchronousTransformClient {
     ...
     * target mimetype given a list of actual transform option names and values. Ideally, just call
     * the transform method and catch the UnsupportedTransformationException to avoid extra work.
     *
     ...
     *     Transform Service.
     * @param transformName (optional) name for the set of options and target mimetype. If supplied
