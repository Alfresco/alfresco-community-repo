...
public interface FileFolderServiceTrait extends Trait {
    ...
    Pair<Set<QName>, Set<QName>> buildSearchTypesAndIgnoreAspects(
            boolean files, boolean folders, Set<QName> ignoreQNameTypes);

    FileInfo rename(NodeRef sourceNodeRef, String newName)
