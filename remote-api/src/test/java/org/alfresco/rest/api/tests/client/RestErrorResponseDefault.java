...
public enum RestErrorResponseDefault {
  ...
  INVALID_QUERY_EXCEPTION(
    ...
    InvalidQueryException.DEFAULT_MESSAGE_ID
  ),
  INVALID_SELECT_EXCEPTION(
    "org.alfresco.rest.framework.core.exceptions.InvalidArgumentException",
    Status.STATUS_BAD_REQUEST,
    InvalidSelectException.DEFAULT_MESSAGE_ID
  ),
  ...
  NOT_FOUND_EXCEPTION(
    ...
    NotFoundException.DEFAULT_MESSAGE_ID
  ),
  ENTITY_NOT_FOUND_EXCEPTION(
    "org.alfresco.rest.framework.core.exceptions.EntityNotFoundException",
    Status.STATUS_NOT_FOUND,
    EntityNotFoundException.DEFAULT_MESSAGE_ID
  ),
  RELATIONSHIP_RESOURCE_NOT_FOUND_EXCEPTION(
    "org.alfresco.rest.framework.core.exceptions.RelationshipResourceNotFoundException",
    Status.STATUS_NOT_FOUND,
    RelationshipResourceNotFoundException.DEFAULT_MESSAGE_ID
  ),
  ...
  REQUEST_ENTITY_TOO_LARGE_EXCEPTION(
    ...
    RequestEntityTooLargeException.DEFAULT_MESSAGE_ID
  ),
  UNSUPPORTED_MEDIA_TYPE_EXCEPTION(
    ...
    UnsupportedMediaTypeException.DEFAULT_MESSAGE_ID
  ),
  SERVICE_UNAVAILABLE_EXCEPTION(
    "org.alfresco.rest.framework.core.exceptions.ServiceUnavailableException",
    Status.STATUS_SERVICE_UNAVAILABLE,
    ServiceUnavailableException.DEFAULT_MESSAGE_ID
  );
  ...
  private RestErrorResponseDefault(
