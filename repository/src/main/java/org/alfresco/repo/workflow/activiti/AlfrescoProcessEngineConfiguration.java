...
public class AlfrescoProcessEngineConfiguration extends SpringProcessEngineConfiguration {
    ...
    public AlfrescoProcessEngineConfiguration() {
        // Make sure the synchornizationAdapter is run before the AlfrescoTransactionSupport (and
        // also before the
        // myBatis synchonisation, which unbinds the neccesairy sqlSession used by the
        // JobFailedListener)
    ...
    protected void initJobExecutor() {
        ...
        JobHandler wrappingTimerJobHandler =
                new AuthenticatedTimerJobHandler(timerJobHandler, unprotectedNodeService);
        ...
        JobHandler intermediateJobHandler =
                jobHandlers.get(TimerCatchIntermediateEventJobHandler.TYPE);
        JobHandler wrappingIntermediateJobHandler =
                new AuthenticatedAsyncJobHandler(intermediateJobHandler);
