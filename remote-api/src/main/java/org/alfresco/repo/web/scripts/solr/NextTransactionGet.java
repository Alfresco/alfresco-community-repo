...
/**
 * Returns the next transaction commit time from a given commit time. This webscript is used to skip long periods where the repository is not ingesting new content.
 * 
 * @author aborroy
 *
 */
