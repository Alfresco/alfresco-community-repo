...
public class TraitExtenderIntegrationTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    extensionBundle.register(
      new ExtensionPoint<TestExtension, TestTrait>(
        TestExtension.class,
        TestTrait.class
      ),
      new InstanceExtensionFactory<TestExtensionImpl, TestTrait, TestExtension>(
    ...
    TestSingletonExtensionImpl sigletonExtension = new TestSingletonExtensionImpl(
      "s1"
    );

    singletonExtensionBundle =
      new RegistryExtensionBundle("singletonExtensionBundle");
    singletonExtensionBundle.register(
      new ExtensionPoint<TestExtension, TestTrait>(
        TestExtension.class,
        TestTrait.class
      ),
      new SingletonExtensionFactory<TestExtension, TestSingletonExtensionImpl, TestTrait>(
        sigletonExtension,
        TestExtension.class
      )
    );
    ...
    publicExtensionBundle =
      new RegistryExtensionBundle("publicExtensionBundle");
    publicExtensionBundle.register(
      new ExtensionPoint<TestPublicExtension, TestPublicTrait>(
        TestPublicExtension.class,
        TestPublicTrait.class
      ),
      new InstanceExtensionFactory<TestPublicExtensionImpl, TestPublicTrait, TestPublicExtension>(
        TestPublicExtensionImpl.class,
        TestPublicTrait.class,
        TestPublicExtension.class
      )
    );
  ...
  public void testIntegration() {
    ...
    assertEquals(
      "TestService.privateServiceMethod1(testIntegration) TestExtensionImpl.privateServiceMethod1(testIntegration)",
  ...
  public void testIntegration_overrideExtensible_1() {
    ...
    String expectedSuffix = new TestService("psm1")
      .publicServiceMethod3("testIntegration");
    assertEquals(
      "x" + expectedSuffix,
  ...
  public void testIntegration_stoppedBundle() {
    ...
    assertEquals(
      "TestService.privateServiceMethod1(testIntegration)",
  ...
  public void testIntegration_singletonExtension() {
    ...
    assertEquals(
      "psm1 TestSingletonExtensionImpl.publicServiceMethod2(testIntegration)@s1",
      new TestService("psm1").publicServiceMethod2("testIntegration")
    );

    assertEquals(
      "psm2 TestSingletonExtensionImpl.publicServiceMethod2(testIntegration)@s1",
  ...
  public void testIntegration_bypass() {
    ...
    assertEquals(
      "PSM3TestService.privateServiceMethod1(bypass) TestSingletonExtensionImpl.privateServiceMethod1(bypass)@s1 TestSingletonExtensionImpl.publicServiceMethod3(bypass)@s1",
  ...
  private void assertNoThreadTraitSideEffect() {
    ...
    assertEquals(6, traitIdentities.size());
    ...
    assertEquals(s2TraitId, traitIdentities.get(2));
    assertEquals(s2Id, traitIdentities.get(3));
    assertEquals(s1TraitId, traitIdentities.get(4));
    assertEquals(s1Id, traitIdentities.get(5));
  }
