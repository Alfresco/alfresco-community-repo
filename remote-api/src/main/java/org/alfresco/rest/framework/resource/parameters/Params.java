...
public class Params implements Parameters {
    ...
    // Constants
    private static final RecognizedParams NULL_PARAMS =
            new RecognizedParams(null, null, null, null, null, null, null, null, false);
    private static final BasicContentInfo DEFAULT_CONTENT_INFO =
            new ContentInfoImpl(MimetypeMap.MIMETYPE_BINARY, "UTF-8", -1, null);

    protected Params(
            Boolean isCollectionResource,
            String entityId,
            String relationshipId,
            String relationship2Id,
            Object passedIn,
            InputStream stream,
        ...
        super();
        this.isCollectionResource =
                (isCollectionResource != null ? isCollectionResource : (entityId == null));
    ...
    public static Params valueOf(
            BeanPropertiesFilter paramFilter, String entityId, WebScriptRequest request) {
        return new Params(
                null,
                entityId,
                null,
                ...
                null,
                null,
                new RecognizedParams(null, null, paramFilter, null, null, null, null, null, false),
                null,
                request);
    }
    ...
    public static Params valueOf(String entityId, String relationshipId, WebScriptRequest request) {
        return new Params(
                null, entityId, relationshipId, null, null, null, null, NULL_PARAMS, null, request);
    }
    ...
    public static Params valueOf(
            ...
            WebScriptRequest request) {
        return new Params(
                null, entityId, null, null, passedIn, null, null, recognizedParams, null, request);
    }
    ...
    public String getParameter(String parameterName) {
        if (recognizedParams.requestParameters != null
                && !recognizedParams.requestParameters.isEmpty()) {
    ...
    public T getParameter(String parameterName, Class<T> clazz) throws InvalidArgumentException {
        ...
        throw new InvalidArgumentException(
                InvalidArgumentException.DEFAULT_MESSAGE_ID, new Object[] {parameterName});
    }
    ...
    /**
     * A formal set of params that any rest service could potentially have passed in as request
     * params
     */
    public static class RecognizedParams {
        ...
        @Deprecated private final List<String> select; // see include

        private final List<SortColumn> sorting;
        private final boolean includeSource;

        @SuppressWarnings("unchecked")
        public RecognizedParams(
