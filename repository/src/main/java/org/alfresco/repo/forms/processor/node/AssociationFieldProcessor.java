...
public class AssociationFieldProcessor
  ...
  private static final Log logger = LogFactory.getLog(
    AssociationFieldProcessor.class
  );
  ...
  public Field makeField(
    ...
    AssociationFieldDefinition fieldDef = makeAssociationFieldDefinition(
      assocDef,
      group
    );
  ...
  public AssociationFieldDefinition makeAssociationFieldDefinition(
    final AssociationDefinition assocDef,
    FieldGroup group
  ) {
    String name = getPrefixedName(assocDef);
    String endpointType = assocDef
      .getTargetClass()
      .getName()
  ...
  protected AssociationDefinition getTypeDefinition(
    ...
    AssociationDefinition assocDefinition = itemData.getAssociationDefinition(
      fullName
    );
