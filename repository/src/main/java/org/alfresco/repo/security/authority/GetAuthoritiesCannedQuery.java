...
public class GetAuthoritiesCannedQuery
  ...
  private static final String QUERY_SELECT_GET_AUTHORITIES =
    "select_GetAuthoritiesCannedQuery";
  ...
  @Override
  protected List<AuthorityInfo> queryAndFilter(
  ...
  protected List<AuthorityInfo> applyPostQuerySorting(
    ...
    if (sortPairs.size() > 0) {
      ...
      Collections.sort(
        results,
        new AuthComparator(
          (String) sortPairs.get(0).getFirst(),
