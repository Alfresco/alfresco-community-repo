...
public class RenameTests extends CmisTest {
    ...
    @TestRail(
            ...
            description =
                    "Verify site manager is able to rename document and folder created by himself")
    ...
    @TestRail(
            ...
            description =
                    "Verify admin user is able to rename document and folder created by himself")
    ...
    public void siteManagerCanRenamePwcDocument() throws Exception {
        ...
        renamedPwc.setCmisLocation(
                testFile.getCmisLocation().replace(testFile.getName(), renamedPwc.getName()));
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is not able to rename document created by manager")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is not able to rename document in moderated site")
    @Test(
            groups = {TestGroup.REGRESSION, TestGroup.CMIS},
            expectedExceptions = CmisPermissionDeniedException.class)
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is not able to rename document with same name as another"
