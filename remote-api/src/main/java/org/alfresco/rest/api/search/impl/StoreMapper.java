...
public class StoreMapper {
  ...
  public static final StoreRef STORE_REF_VERSION2_SPACESSTORE = new StoreRef(
    "workspace",
    Version2Model.STORE_ID
  );
  public static final StoreRef STORE_REF_HISTORY = new StoreRef(
    "workspace",
    "history"
  );
  ...
  public String getStore(NodeRef nodeRef) {
    if (nodeRef != null) {
      ...
      if (
        StoreRef.STORE_REF_ARCHIVE_SPACESSTORE.equals(nodeRef.getStoreRef())
      ) {
        return DELETED;
      }
