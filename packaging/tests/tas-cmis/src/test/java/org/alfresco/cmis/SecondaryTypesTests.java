...
public class SecondaryTypesTests extends CmisTest {
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site manager is NOT able to get invalid secondary type for Folder")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is not able to get secondary types in private site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify non invited user is not able to get secondary types in moderated site")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site collaborator is able to add secondary types for document created"
                            + " by manager")
    ...
    @TestRail(
            ...
            executionType = ExecutionType.REGRESSION,
            description =
                    "Verify site contributor is able to add secondary types for document created by"
                            + " manager")
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp =
                    "Property 'cm:fake-prop' is not valid for this type or one of the secondary"
                            + " types!*")
    @TestRail(
            section = {"cmis-api"},
            executionType = ExecutionType.REGRESSION,
