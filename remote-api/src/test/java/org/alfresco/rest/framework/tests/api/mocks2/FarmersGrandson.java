 ...
 *
 * getSheepId is overidden but no annotation specified (OK) getGoatId is overidden, a new annotation key is specified (THIS IS NOT RECOMMENDED) getId is overidden but no annotation specified (OK)
 * 
 * @author Gethin James
 */
