...
public class ModelSecurityServiceImplTest extends BaseRMTestCase {
    private static final QName CUSTOM_ASPECT =
            QName.createQName("http://www.alfresco.org/model/rmtest/1.0", "customAspect");
    private static final QName CUSTOM_PROTECTED_ASPECT =
            QName.createQName("http://www.alfresco.org/model/rmtest/1.0", "customProtectedAspect");

    private static final QName CUSTOM_PROPERTY =
            QName.createQName("http://www.alfresco.org/model/rmtest/1.0", "customProperty");
    private static final QName CUSTOM_PROTECTED_PROPERTY =
            QName.createQName(
                    "http://www.alfresco.org/model/rmtest/1.0", "customProtectedProperty");
    ...
    public void testProtectedAspects() throws Exception {
        doTestInTransaction(
                new VoidTest() {
                    ...
                    public void runImpl() throws Exception {
                        ...
                        ProtectedAspect protectedAspect =
                                modelSecurityService.getProtectedAspect(CUSTOM_ASPECT);
                        assertNull(protectedAspect);
                        protectedAspect =
                                modelSecurityService.getProtectedAspect(CUSTOM_PROTECTED_ASPECT);
        ...
        doTestInTransaction(
                new VoidTest() {
                    ...
                    public void runImpl() throws Exception {
                        assertTrue(modelSecurityService.isProtectedAspect(CUSTOM_PROTECTED_ASPECT));
                        assertFalse(
                                modelSecurityService.canEditProtectedAspect(
                                        rmFolder, CUSTOM_PROTECTED_ASPECT));
                    }
                },
                powerUserName);
        ...
        doTestInTransaction(
                new FailureTest(
                        "Normal rm user should not have the permissions to add the protected"
                                + " aspect.",
        ...
        doTestInTransaction(
                new FailureTest(
                        "Normal rm user should not have the permissions to remove the custom"
                                + " aspect.",
                        ModelAccessDeniedException.class) {
                    @Override
                    public void run() throws Exception {
    ...
    public void testProtectedProperties() throws Exception {
        doTestInTransaction(
                new VoidTest() {
                    public void runImpl() {
                        ...
                        assertTrue(
                                modelSecurityService.isProtectedProperty(
                                        CUSTOM_PROTECTED_PROPERTY));
                        assertFalse(modelSecurityService.isProtectedProperty(CUSTOM_PROPERTY));

                        ProtectedProperty protectedProperty =
                                modelSecurityService.getProtectedProperty(CUSTOM_PROPERTY);
                        assertNull(protectedProperty);
                        protectedProperty =
                                modelSecurityService.getProtectedProperty(
                                        CUSTOM_PROTECTED_PROPERTY);
        ...
        doTestInTransaction(
                new VoidTest() {
                    ...
                    public void runImpl() throws Exception {
                        assertTrue(
                                modelSecurityService.canEditProtectedProperty(
                                        rmFolder, CUSTOM_PROTECTED_PROPERTY));
                    }
                },
                ADMIN_USER);
        ...
        doTestInTransaction(
                new VoidTest() {
                    ...
                    public void runImpl() throws Exception {
                        ...
                        assertEquals(
                                "hello",
                                nodeService.getProperty(rmFolder, CUSTOM_PROTECTED_PROPERTY));
                    }
                },
                ADMIN_USER);
    }
