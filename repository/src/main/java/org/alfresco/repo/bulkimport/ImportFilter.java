...
/**
 * Definition of a source filter - a class that filters out importable items idenfitied from the
 * source directory from the import.
 *
 * <p>Note that source filters can be "chained", in which case each source filter effectively has
...
public interface ImportFilter {
     ...
     *
     * @param importableItem The source importable item to check for filtering <i>(will not be
     *     null)</i>.
