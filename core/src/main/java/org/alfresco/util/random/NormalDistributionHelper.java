...
/**
 * Utility functions guided by the <a href="http://en.wikipedia.org/wiki/Normal_distribution">Normal
 * Distribution</a>.
 *
 * @author Derek Hulley
 * @since 5.1
...
public class NormalDistributionHelper {
    ...
    /**
     * Get a random long where a standard deviation of 1.0 corresponds to the min and max values
     * provided. The sampling is repeated until a value is found within the range given.
     */
