 ...
 *
 * <p>This service records the protected properties and aspects, ensuring that only those with the
 * appropriate capabilities can edit them.
 *
...
public class ModelSecurityServiceImpl extends BaseBehaviourBean
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#setEnabled(boolean)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#isEnabled()
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#register(org.alfresco.module.org_alfresco_module_rm.model.security.ProtectedModelArtifact)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#isProtectedProperty(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#getProtectedProperties()
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#getProtectedProperty(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#canEditProtectedProperty(org.alfresco.service.cmr.repository.NodeRef,
    ...
    /**
     * Indicates whether the current user can edit protected model artifact in the context of a
     * given node or not.
     *
     * @param nodeRef node reference
     * @param artifact protected model artifact
     * @return boolean true if the current user can edit the protected model artifact, false
     *     otherwise
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#isProtectedAspect(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#getProtectedAspects()
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#getProtectedAspect(org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.model.security.ModelSecurityService#canEditProtectedAspect(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.namespace.QName)
     */
    @Override
        ...
        if (enabled
            ...
            throw new ModelAccessDeniedException(
                    "The user "
                            ...
                            + " does not have the permission to add the protected aspect "
    ...
    /**
     * @see
     *     org.alfresco.repo.node.NodeServicePolicies.BeforeRemoveAspectPolicy#beforeRemoveAspect(org.alfresco.service.cmr.repository.NodeRef,
     *     org.alfresco.service.namespace.QName)
     */
    @Override
    ...
    public void beforeRemoveAspect(NodeRef nodeRef, QName aspect) {
        if (enabled
            ...
            throw new ModelAccessDeniedException(
                    "The user "
                            + AuthenticationUtil.getFullyAuthenticatedUser()
                            + " does not have the permission to remove the protected aspect "
                            + aspect.toPrefixString(namespaceService)
                            + " from the node "
                            + nodeRef.toString());
        }
                ...
                if (isProtectedProperty(property)) {
                    ...
                    if (!EqualsHelper.nullSafeEquals(before.get(property), entry.getValue())
                        ...
                        throw new ModelAccessDeniedException(
                                "The user "
                                        + AuthenticationUtil.getFullyAuthenticatedUser()
                                        + " does not have the permission to edit the protected"
                                        + " property "
                                        + property.toPrefixString(namespaceService)
                                        + " on the node "
                                        + nodeRef.toString());
                    }
                }
