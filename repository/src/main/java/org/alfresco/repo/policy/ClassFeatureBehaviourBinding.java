...
public class ClassFeatureBehaviourBinding extends ClassBehaviourBinding {
     ...
     */
    /*package*/ ClassFeatureBehaviourBinding(
            DictionaryService dictionary, NodeRef nodeRef, QName classQName, QName featureQName) {
     ...
     */
    /*package*/ ClassFeatureBehaviourBinding(
            DictionaryService dictionary, QName classQName, QName featureQName) {
    ...
    public boolean equals(Object obj) {
        ...
        return getClassQName().equals(((ClassFeatureBehaviourBinding) obj).getClassQName())
                && activeFeatureQName.equals(
                        ((ClassFeatureBehaviourBinding) obj).activeFeatureQName);
    }
    ...
    public String toString() {
        return "ClassFeatureBinding[class="
                + getClassQName()
                + ";feature="
                + activeFeatureQName
                + "]";
