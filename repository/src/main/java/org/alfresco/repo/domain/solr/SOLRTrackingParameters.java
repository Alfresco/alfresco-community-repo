...
public class SOLRTrackingParameters {
    ...
    public int hashCode() {
        ...
        result =
                prime * result + ((deletedTypeQNameId == null) ? 0 : deletedTypeQNameId.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return EqualsHelper.nullSafeEquals(
                        this.fromCommitTimeInclusive, other.fromCommitTimeInclusive)
                ...
                && EqualsHelper.nullSafeEquals(
                        this.toCommitTimeExclusive, other.toCommitTimeExclusive)
