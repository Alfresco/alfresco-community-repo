...
public class Deleter {
    ...
    /**
     * Recursively deletes the parents of the specified file stopping when <code>rootDir</code> is
     * reached. The file itself must have been deleted before calling this method - since only empty
     * directories can be deleted.
     *
     * <p>For example: <code>deleteEmptyParents(new File("/tmp/a/b/c/d.txt"), "/tmp/a")</code>
     *
     * <p>Will delete directories c and b assuming that they are both empty. It will leave /tmp/a
     * even if it is empty as this is the <code>rootDir</code>
     *
     * @param file The path of the file whose parent directories should be deleted.
     * @param rootDir Top level directory where deletion should stop. <strong>Must be the canonical
     *     path to ensure correct comparisons.</strong>
     */
    ...
    /**
     * Same behaviour as for {@link Deleter#deleteEmptyParents(File, String)} but with the <code>
     * rootDir</code> parameter specified as a {@link java.io.File} object.
     *
