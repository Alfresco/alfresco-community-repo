...
public class EmailServerTest extends TestCase {
  ...
  public void testDisallowedNulableFromUser() throws Exception {
    ...
    assertTrue(
      "Response should have error code",
      response[1].indexOf("5") == 0
    );
  }
  ...
  private String[] getMailFromNullableResponse(String host, int port)
    throws Exception {
  ...
  private String[] getResponse(String host, int port, String requestStrings[])
    throws Exception {
