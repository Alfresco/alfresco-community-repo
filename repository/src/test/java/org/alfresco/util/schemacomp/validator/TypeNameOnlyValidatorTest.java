...
public class TypeNameOnlyValidatorTest {
  ...
  public void setUp() throws Exception {
    ...
    ctx =
      new DiffContext(new SQLServerDialect(), validationResults, null, null);
  }
  ...
  public void validateOnlyColumnsTest() {
    try {
      validator.validate(
        null,
        new Index(null, null, new ArrayList<String>()),
        ctx
      );
  ...
  private void assertValidation(
    ...
    assertEquals(
      validationResults.size() - beforeValidationResultsSize,
      shouldFailInt
    );
  }
