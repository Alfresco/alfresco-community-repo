 ...
 *
 * <p>You can add this to your object to be serialized as a normal property.
 *
 * @author Gethin James
 */
public class BinaryProperty implements ContentInfo, Serializable {
    ...
    /**
     * This is the preferred constructor to use. Takes the properties from content reader that it
     * needs.
     *
    ...
    /**
     * Used for serialization. If the length is unknown then this method returns null and is
