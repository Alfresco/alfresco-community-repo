...
public interface LicenseService {
    ...
    /**
     * Begin the license verification loop. Throws an exception if a new .lic file has been supplied
     * that is invalid. Will quietly make the repository read only if there is no license and the
     * repository isn't eligible for the free trial period or the license has expired.
     *
     * @throws LicenseException if an invalid .lic file has been supplied
     */
    @NotAuditable
