...
public abstract class BaseComparison extends BaseFunction {
  ...
  public void setPropertyAndStaticArguments(
    ...
    if (lhs instanceof PropertyArgument) {
      if (
        (rhs instanceof PropertyArgument) || (rhs instanceof FunctionArgument)
      ) {
        ...
        throw new QueryModelException(
          "Argument of type " + rhs.getClass().getName() + " is not supported"
        );
      }
      ...
      if (
        (lhs instanceof PropertyArgument) || (lhs instanceof FunctionArgument)
      ) {
        throw new QueryModelException("Implicit join is not supported");
        ...
        throw new QueryModelException(
          "Argument of type " + lhs.getClass().getName() + " is not supported"
        );
      }
    ...
    if (propertyArgument != null) {
      ...
      if (functionName.equals(Upper.NAME)) {
        ...
        if (arg instanceof PropertyArgument) {
          ...
          throw new QueryModelException(
            "Upper must have a column argument " + arg
          );
        }
        ...
        if (arg instanceof PropertyArgument) {
          ...
          throw new QueryModelException(
            "Lower must have a column argument " + arg
          );
        }
      } else {
      ...
      throw new QueryModelException(
        "A property of function argument must be provided"
      );
    }
  }
}
