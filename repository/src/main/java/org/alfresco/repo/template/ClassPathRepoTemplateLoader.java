...
/**
 * Custom FreeMarker template loader to locate templates stored either from the ClassPath or in a
 * Alfresco Repository.
 *
 * <p>The template name should be supplied either as a NodeRef String or a ClassPath path String.
 *
 * @author Kevin Roast
 */
public class ClassPathRepoTemplateLoader implements TemplateLoader {
    ...
    public ClassPathRepoTemplateLoader(
            NodeService nodeService, ContentService contentService, String encoding) {
        if (nodeService == null) {
    ...
    class ClassPathTemplateSource extends BaseTemplateSource {
        ...
        ClassPathTemplateSource(ClassLoader classLoader, String name, String encoding)
                throws IOException {
    ...
    class RepoTemplateSource extends BaseTemplateSource {
        ...
        protected InputStream getRelativeResource(String name) {
            ...
            NodeRef child =
                    nodeService.getChildByName(parentRef, ContentModel.ASSOC_CONTAINS, name);
            if (child != null) {
                ContentReader contentReader =
                        contentService.getReader(child, ContentModel.PROP_CONTENT);
