...
public interface ContentUsageService {
     ...
     * Gets user quota
     *
     * <p>Note: -1 means no quota limit set
     *
     ...
     * Set user quota.
     *
     * <p>Note: It is possible to set a quota that is below the current usage. At this point the
     * user will be over quota until their usage is decreased.
     *
     * <p>Note: -1 means no quota limit set
     *
