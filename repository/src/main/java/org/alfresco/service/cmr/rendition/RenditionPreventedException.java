...
public class RenditionPreventedException extends RenditionServiceException {
    ...
    /**
     * Constructs a Rendition Service Exception with the specified message and {@link
     * RenditionDefinition}.
     *
     * @param message the message string.
    ...
    /**
     * Constructs a Rendition Service Exception with the specified message, {@link
     ...
     * @param source the source exception.
     */
    public RenditionPreventedException(
