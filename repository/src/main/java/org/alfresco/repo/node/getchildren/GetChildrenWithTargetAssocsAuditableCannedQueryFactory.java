...
/**
 * A {@link CannedQueryFactory} for various queries relating to getting {@link
 * NodeWithTargetsEntity} entires filtering by auditable properties.
 *
 * @author Nick Burch
 * @since 4.0
 */
public class GetChildrenWithTargetAssocsAuditableCannedQueryFactory
    ...
    public CannedQuery<NodeWithTargetsEntity> getCannedQuery(CannedQueryParameters parameters) {
        final GetChildrenWithTargetAssocsAuditableCannedQuery cq =
                new GetChildrenWithTargetAssocsAuditableCannedQuery(
                        cannedQueryDAO, methodSecurity, parameters);

        return (CannedQuery<NodeWithTargetsEntity>) cq;
    }

    public CannedQuery<NodeWithTargetsEntity> getCannedQuery(
        ...
        GetChildrenWithTargetAssocsAuditableCannedQueryParams paramBean =
                new GetChildrenWithTargetAssocsAuditableCannedQueryParams(
