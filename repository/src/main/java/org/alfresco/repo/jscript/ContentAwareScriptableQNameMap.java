...
/**
 * Specialised map class for supporting the initialisation of 'cm:content' properties for JavaScript
 * API objects. The JavaScript needs supporting objects to be initialised for certain data-types. If
 * the 'cm:content' property is not already initialised then it must be created on demand or it will
 * not be available to the users of the API. See AR-1673.
 *
 * @author Kevin Roast
 */
public class ContentAwareScriptableQNameMap<K, V> extends ScriptableQNameMap<K, V> {
    ...
    public ContentAwareScriptableQNameMap(
            final ScriptNode factory, final ServiceRegistry services) {
        super(
