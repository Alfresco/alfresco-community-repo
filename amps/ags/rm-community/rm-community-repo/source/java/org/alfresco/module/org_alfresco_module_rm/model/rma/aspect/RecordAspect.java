...
public class RecordAspect
  ...
  public void onMoveNode(
    ...
    if (
      !oldChildAssocRef
        .getParentRef()
        .equals(newChildAssocRef.getParentRef()) &&
   ...
   */
  private void executeReferenceScript(
    String policy,
    QName reference,
    NodeRef from,
    NodeRef to
  ...
  public void onContentPropertyUpdate(
    ...
    if (beforeValue != null) {
      throw new IntegrityException(
        I18NUtil.getMessage(MSG_CANNOT_UPDATE_RECORD_CONTENT),
        null
      );
    }
  }
