...
public class RecordsManagementEventServiceImpl implements RecordsManagementEventService {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#registerEventType(org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventType)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#getEventTypes()
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#getEvents()
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#getEvent(java.lang.String)
     */
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#existsEvent(java.lang.String)
     */
    ...
    /**
     * Indicates whether a particular event display label exists. Returns true if it does, false
     * otherwise.
     *
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#canCreateEvent(java.lang.String,
     *     java.lang.String)
     */
    ...
    public boolean canCreateEvent(String eventDisplayLabel, String eventName) {
        ...
        if (canCreateEvent) {
            for (Iterator iterator = getEventMap().values().iterator(); iterator.hasNext(); ) {
                RecordsManagementEvent recordsManagementEvent =
                        (RecordsManagementEvent) iterator.next();
                if (recordsManagementEvent.getDisplayLabel().equalsIgnoreCase(eventDisplayLabel)) {
                    canCreateEvent = false;
                    break;
                }
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#canEditEvent(java.lang.String,
            ...
            if (recordsManagementEvent.getDisplayLabel().equalsIgnoreCase(eventDisplayLabel)) {
                if (recordsManagementEvent.getName().equalsIgnoreCase(eventName)) {
                    ...
                    throw new AlfrescoRuntimeException(
                            "Cannot edit event. An event with the display label '"
                                    + eventDisplayLabel
                                    + "' already exist.");
                }
                break;
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#addEvent(java.lang.String,
     *     java.lang.String, java.lang.String)
     */
    public RecordsManagementEvent addEvent(
            String eventType, String eventName, String eventDisplayLabel) {
        ...
        RecordsManagementEvent event =
                new RecordsManagementEvent(eventTypes.get(eventType), eventName, eventDisplayLabel);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#removeEvent(java.lang.String)
     */
                    ...
                    public Object doWork() throws Exception {
                        ...
                        ContentReader reader =
                                contentService.getReader(
                                        CONFIG_NODE_REF, ContentModel.PROP_CONTENT);
                    ...
                    public Object doWork() throws Exception {
                        ...
                        ContentWriter contentWriter =
                                contentService.getWriter(
                                        CONFIG_NODE_REF, ContentModel.PROP_CONTENT, true);
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.event.RecordsManagementEventService#getEventType(java.lang.String)
     */
