...
public class DispositionServiceImplTest extends BaseRMTestCase {
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        private void doCheckFolder(
          ...
          if (!isRecordLevel) {
            assertNotNull(
              dispositionService.getNextDispositionAction(container)
            );
          }
        }
      }
   ...
   */
  private void checkDispositionSchedule(
    ...
    DispositionActionDefinition defCutoff = ds.getDispositionActionDefinitionByName(
      "cutoff"
    );
    assertNotNull(defCutoff);
    assertEquals("cutoff", defCutoff.getName());

    DispositionActionDefinition defDestroy = ds.getDispositionActionDefinitionByName(
      "destroy"
    );
  ...
  public void testGetAssociatedDispositionSchedule() throws Exception {
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          // Get the containers disposition schedule
          DispositionSchedule ds = dispositionService.getAssociatedDispositionSchedule(
            rmContainer
          );
          assertNotNull(ds);
          checkDispositionSchedule(ds, false);
          ...
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(filePlan)
          );
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(rmFolder)
          );
  ...
  public void testGetAssociatedDispositionScheduleMultiHier() throws Exception {
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(mhContainer)
          );
          ...
          // Level 2
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(mhContainer21)
          );
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(mhContainer22)
          );
          doCheck(mhContainer23, "ds23", false);

          // Level 3
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(mhContainer31)
          );
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(mhContainer32)
          );
          doCheck(mhContainer33, "ds33", true);
          assertNull(
            dispositionService.getAssociatedDispositionSchedule(mhContainer34)
          );
          doCheck(mhContainer35, "ds35", true);
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          NodeRef container = filePlanService.createRecordCategory(
            rmContainer,
            "hasDisposableTest"
          );
          DispositionSchedule ds = utils.createBasicDispositionSchedule(
            container
          );

          assertTrue(
            dispositionService.hasDisposableItems(dispositionSchedule)
          );
  ...
  public void testHasDisposableItemsMultiHier() throws Exception {
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          assertTrue(
            dispositionService.hasDisposableItems(mhDispositionSchedule11)
          );
          assertTrue(
            dispositionService.hasDisposableItems(mhDispositionSchedule12)
          );
          assertTrue(
            dispositionService.hasDisposableItems(mhDispositionSchedule23)
          );
          assertFalse(
            dispositionService.hasDisposableItems(mhDispositionSchedule33)
          );
          assertFalse(
            dispositionService.hasDisposableItems(mhDispositionSchedule35)
          );
  ...
  public void testGetDisposableItems() throws Exception {
    doTestInTransaction(
      new Test<Void>() {
        @Override
        public Void run() {
          List<NodeRef> nodeRefs = dispositionService.getDisposableItems(
            dispositionSchedule
          );
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          nodeRefs =
            dispositionService.getDisposableItems(mhDispositionSchedule12);
          assertNotNull(nodeRefs);
          assertEquals(1, nodeRefs.size());
          assertTrue(nodeRefs.contains(mhRecordFolder42));

          nodeRefs =
            dispositionService.getDisposableItems(mhDispositionSchedule23);
          assertNotNull(nodeRefs);
          assertEquals(1, nodeRefs.size());
          assertTrue(nodeRefs.contains(mhRecordFolder44));

          nodeRefs =
            dispositionService.getDisposableItems(mhDispositionSchedule33);
          assertNotNull(nodeRefs);
          assertEquals(0, nodeRefs.size());

          nodeRefs =
            dispositionService.getDisposableItems(mhDispositionSchedule35);
          assertNotNull(nodeRefs);
          assertEquals(0, nodeRefs.size());
    ...
    doTestInTransaction(
      new Test<Void>() {
        ...
        public Void run() {
          ...
          NodeRef testA = filePlanService.createRecordCategory(
            mhContainer,
            "testA"
          );
        ...
        public void test(Void result) throws Exception {
          // Get the created disposition schedule
          DispositionSchedule testA = dispositionService.getAssociatedDispositionSchedule(
            getNodeRef("testA")
          );
          assertNotNull(testA);
          DispositionSchedule testB = dispositionService.getAssociatedDispositionSchedule(
            getNodeRef("testB")
          );
          assertNotNull(testB);
  ...
  public void testGetAssociatedRecordsManagementContainer() throws Exception {
    doTestInTransaction(
      new Test<Void>() {
        @Override
        public Void run() {
          NodeRef nodeRef = dispositionService.getAssociatedRecordsManagementContainer(
            dispositionSchedule
          );
   ...
   * @see DispositionService#getAssociatedRecordsManagementContainer(DispositionSchedule)
   */
  public void testGetAssociatedRecordsManagementContainerMultiHier()
    throws Exception {
    doTestInTransaction(
      new Test<Void>() {
        @Override
        public Void run() {
          ...
          nodeRef =
            dispositionService.getAssociatedRecordsManagementContainer(
              mhDispositionSchedule12
            );
          assertNotNull(nodeRef);
  ...
  public void testUpdateDispositionActionDefinitionMultiHier()
    throws Exception {
    doTestInTransaction(
      new Test<Void>() {
        @Override
  ...
  private void publishDispositionActionDefinitionChange(
    DispositionActionDefinition dad
  ) {
    PublishExecutorRegistry reg = (PublishExecutorRegistry) applicationContext.getBean(
      "publishExecutorRegistry"
    );
    PublishExecutor pub = reg.get(
      RecordsManagementModel.UPDATE_TO_DISPOSITION_ACTION_DEFINITION
    );
    assertNotNull(pub);
  ...
  private void checkDisposableItemChanged(NodeRef recordFolder)
    throws Exception {
    checkDispositionAction(
      dispositionService.getNextDispositionAction(recordFolder),
      "cutoff",
  ...
  private void updateDispositionScheduleOnContainer(NodeRef nodeRef) {
    ...
    DispositionActionDefinition dad = ds.getDispositionActionDefinitionByName(
      "cutoff"
    );
   ...
   * @param strPeriod
   */
  private void checkDispositionAction(
    DispositionAction da,
    String name,
    String[] arrEventNames,
    String strPeriod
  ) {
    assertNotNull(da);
  ...
  public void testRM_263() throws Exception {
      ...
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          testRM263RecordCategory =
            filePlanService.createRecordCategory(rmContainer, "rm263");
          testRM263DispositionSchedule =
            utils.createBasicDispositionSchedule(
              testRM263RecordCategory,
              "test",
              "test",
          ...
          adParams.put(
            ...
            DOD5015Model.PROP_PUBLICATION_DATE.toString()
          );
    ...
    doTestInTransaction(
      new Test<Void>() {
        private final QName PROP_SEARCH_ASOF = QName.createQName(
          RM_URI,
        ...
        @Override
        public Void run() throws Exception {
          Date pubDate = (Date) nodeService.getProperty(
            testRM263Record,
            DOD5015Model.PROP_PUBLICATION_DATE
          );
          assertNull(pubDate);
          Date asOfDate = (Date) nodeService.getProperty(
            testRM263Record,
            PROP_SEARCH_ASOF
          );
          assertNull(asOfDate);
  ...
  public void testRM386() throws Exception {
      ...
      new Test<Void>() {
        ...
        public Void run() throws Exception {
          testRM386RecordCategory =
            filePlanService.createRecordCategory(rmContainer, "RM386");
          testRM386DispositionSchedule =
            utils.createBasicDispositionSchedule(
              testRM386RecordCategory,
        ...
        public void test(Void result) throws Exception {
          ...
          assertEquals(
            Boolean.TRUE,
            properties.get(PROP_RS_HAS_DISPOITION_SCHEDULE)
          );
          assertEquals(
            CommonRMTestUtils.DEFAULT_DISPOSITION_AUTHORITY,
            properties.get(PROP_RS_DISPOITION_AUTHORITY)
          );
          assertEquals(
            CommonRMTestUtils.DEFAULT_DISPOSITION_INSTRUCTIONS,
            properties.get(PROP_RS_DISPOITION_INSTRUCTIONS)
          );

          assertEquals("none", properties.get(PROP_RS_DISPOSITION_PERIOD));
          assertEquals(
            "0",
            properties.get(PROP_RS_DISPOSITION_PERIOD_EXPRESSION)
          );

          List<String> events = (List<String>) properties.get(
          ...
          assertEquals(
            Boolean.FALSE,
            properties.get(PROP_RS_DISPOSITION_EVENTS_ELIGIBLE)
          );

          assertEquals(
            "cutoff",
            properties.get(PROP_RS_DISPOSITION_ACTION_NAME)
          );
    ...
    doTestInTransaction(
      new Test<DispositionActionDefinition>() {
        @Override
        public DispositionActionDefinition run() throws Exception {
          DispositionActionDefinition actionDefinition = testRM386DispositionSchedule.getDispositionActionDefinitionByName(
            "cutoff"
          );
        ...
        public void test(DispositionActionDefinition result) throws Exception {
          ...
          assertTrue(
            nodeService.hasAspect(
              ...
              ASPECT_UNPUBLISHED_UPDATE
            )
          );

          // Publish the updates
          PublishUpdatesJobExecuter updater = (PublishUpdatesJobExecuter) applicationContext.getBean(
