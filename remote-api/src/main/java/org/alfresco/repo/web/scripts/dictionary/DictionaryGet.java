...
/**
 * WebScript implementation to retrieve a complete dictionary required to implement a lightweight
 * remote web-tier dictionary.
 *
 * @author Kevin Roast
 */
public class DictionaryGet extends DictionaryWebServiceBase {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status) {
        ...
        if (strModel != null && strModel.length() != 0) {
            ...
            QName modelQName =
                    (strModel.charAt(0) == QName.NAMESPACE_BEGIN
                            ? QName.createQName(strModel)
                            : QName.createQName(strModel, this.namespaceService));
