...
public class ReportServiceImpl extends ServiceBaseImpl implements ReportService {
    ...
    /**
     * @see
     *     org.alfresco.module.org_alfresco_module_rm.report.ReportService#registerReportGenerator(org.alfresco.module.org_alfresco_module_rm.report.ReportGenerator)
     */
    @Override
    ...
    /**
     * @see org.alfresco.module.org_alfresco_module_rm.report.ReportService#generateReport(QName,
     *     NodeRef)
     */
    @Override
    ...
    public Report generateReport(QName reportType, NodeRef reportedUponNodeRef, String mimetype) {
        ...
        if (generator == null) {
            throw new AlfrescoRuntimeException(
                    "Unable to generate report, because report type "
                            + reportType.toString()
                            + " does not correspond to a registered report type.");
        }
    ...
    /**
     * @see org.alfresco.module.org_alfresco_module_rm.report.ReportService#fileReport(NodeRef,
     *     org.alfresco.module.org_alfresco_module_rm.report.Report)
     */
    @Override
