...
public class TasksImpl extends WorkflowRestImpl implements Tasks {
    ...
    private static final List<String> TASK_READ_ONLY_PROPERTIES =
            Arrays.asList(
                    "id",
                    "processId",
                    "processDefinitionId",
    ...
    private static final Set<String> TASK_COLLECTION_MATCHES_QUERY_PROPERTIES =
            new HashSet<String>(
                    Arrays.asList(
                            "assignee",
                            "owner",
    ...
    private static final Set<String> TASK_COLLECTION_GREATERTHAN_QUERY_PROPERTIES =
            new HashSet<String>(Arrays.asList("startedAt", "endedAt", "dueAt"));

    private static final Set<String> TASK_COLLECTION_GREATERTHANOREQUAL_QUERY_PROPERTIES =
            new HashSet<String>(Arrays.asList("priority"));

    private static final Set<String> TASK_COLLECTION_LESSTHAN_QUERY_PROPERTIES =
            new HashSet<String>(Arrays.asList("startedAt", "endedAt", "dueAt"));

    private static final Set<String> TASK_COLLECTION_LESSTHANOREQUAL_QUERY_PROPERTIES =
            new HashSet<String>(Arrays.asList("priority"));

    private static final Set<String> TASK_COLLECTION_RUNNING_SORT_PROPERTIES =
            new HashSet<String>(
                    Arrays.asList(
                            "id",
                            "name",
    ...
    private static final Set<String> TASK_COLLECTION_HISTORY_SORT_PROPERTIES =
            new HashSet<String>(
                    Arrays.asList(
                            "id",
                            "name",
    ...
    public CollectionWithPagingInfo<Task> getTasks(Parameters parameters) {
        ...
        String candidateUser =
                propertyWalker.getProperty("candidateUser", WhereClauseParser.EQUALS);
        String candidateGroup =
                propertyWalker.getProperty("candidateGroup", WhereClauseParser.EQUALS);
        ...
        String descriptionLike =
                propertyWalker.getProperty("description", WhereClauseParser.MATCHES);
        Integer priority =
                propertyWalker.getProperty("priority", WhereClauseParser.EQUALS, Integer.class);
        Integer priorityGreaterThanOrEquals =
                propertyWalker.getProperty(
                        "priority", WhereClauseParser.GREATERTHANOREQUALS, Integer.class);
        Integer priorityLessThanOrEquals =
                propertyWalker.getProperty(
                        "priority", WhereClauseParser.LESSTHANOREQUALS, Integer.class);
        String processInstanceId =
                propertyWalker.getProperty("processId", WhereClauseParser.EQUALS);
        String processInstanceBusinessKey =
                propertyWalker.getProperty("processBusinessKey", WhereClauseParser.EQUALS);
        String processInstanceBusinessKeyLike =
                propertyWalker.getProperty("processBusinessKey", WhereClauseParser.MATCHES);
        String activityDefinitionId =
                propertyWalker.getProperty("activityDefinitionId", WhereClauseParser.EQUALS);
        String activityDefinitionIdLike =
                propertyWalker.getProperty("activityDefinitionId", WhereClauseParser.MATCHES);
        String processDefinitionId =
                propertyWalker.getProperty("processDefinitionId", WhereClauseParser.EQUALS);
        String processDefinitionKey =
                propertyWalker.getProperty("processDefinitionKey", WhereClauseParser.EQUALS);
        String processDefinitionKeyLike =
                propertyWalker.getProperty("processDefinitionKey", WhereClauseParser.MATCHES);
        String processDefinitionName =
                propertyWalker.getProperty("processDefinitionName", WhereClauseParser.EQUALS);
        String processDefinitionNameLike =
                propertyWalker.getProperty("processDefinitionName", WhereClauseParser.MATCHES);
        Date startedAt =
                propertyWalker.getProperty("startedAt", WhereClauseParser.EQUALS, Date.class);
        Date startedAtGreaterThan =
                propertyWalker.getProperty("startedAt", WhereClauseParser.GREATERTHAN, Date.class);
        Date startedAtLessThan =
                propertyWalker.getProperty("startedAt", WhereClauseParser.LESSTHAN, Date.class);
        Date endedAt = propertyWalker.getProperty("endedAt", WhereClauseParser.EQUALS, Date.class);
        Date endedAtGreaterThan =
                propertyWalker.getProperty("endedAt", WhereClauseParser.GREATERTHAN, Date.class);
        Date endedAtLessThan =
                propertyWalker.getProperty("endedAt", WhereClauseParser.LESSTHAN, Date.class);
        Date dueAt = propertyWalker.getProperty("dueAt", WhereClauseParser.EQUALS, Date.class);
        Date dueAtGreaterThan =
                propertyWalker.getProperty("dueAt", WhereClauseParser.GREATERTHAN, Date.class);
        Date dueAtLessThan =
                propertyWalker.getProperty("dueAt", WhereClauseParser.LESSTHAN, Date.class);
        Boolean includeProcessVariables =
                propertyWalker.getProperty(
                        "includeProcessVariables", WhereClauseParser.EQUALS, Boolean.class);
        Boolean includeTaskVariables =
                propertyWalker.getProperty(
                        "includeTaskVariables", WhereClauseParser.EQUALS, Boolean.class);
        ...
        if (status == null || STATUS_ACTIVE.equals(status)) {
            ...
            if (candidateUser != null) {
                Set<String> parents =
                        authorityService.getContainingAuthorities(
                                AuthorityType.GROUP, candidateUser, false);
                if (parents != null) {
                    List<String> authorities = new ArrayList<String>();
                    authorities.addAll(parents);

                    // there's a limitation in at least Oracle for using an IN statement with more
                    // than 1000 items
            ...
            HistoricTaskInstanceQuery query =
                    activitiProcessEngine.getHistoryService().createHistoricTaskInstanceQuery();
        ...
        return CollectionWithPagingInfo.asPaged(
                paging, page, (page.size() + paging.getSkipCount()) < totalCount, totalCount);
    }
    ...
    private void setQueryUsingVariables(
        ...
        if (variableProperties != null) {
            for (QueryVariableHolder queryVariableHolder : variableProperties) {
                if (queryVariableHolder.getOperator() == WhereClauseParser.EQUALS) {
                ...
                } else if (queryVariableHolder.getOperator()
                    ...
                    if (queryVariableHolder.getPropertyValue() instanceof String == false) {
                        throw new InvalidArgumentException(
                                "the matches operator can only be used with a String value for"
                                        + " property "
                                        + queryVariableHolder.getPropertyName());
                    }
    ...
    protected void addVariables(
        ...
        List<TaskVariable> variables =
                restVariableHelper.getTaskVariables(
                        taskVariables,
                        processVariables,
    ...
    public Task update(String taskId, Task task, Parameters parameters) {
        ...
        if (taskInstance == null) {
            // Check if task exists in history, to be able to return appropriate error when trying
            // to update an
            ...
            if (!authorized) {
                ...
                List<IdentityLink> linksForTask =
                        activitiProcessEngine.getTaskService().getIdentityLinksForTask(taskId);

                // In case the action is claim, we gather all candidate groups for this tasks, since
                // we already have
                // the identity-links, there is no reason why we should check candidate using a
                // DB-query
        ...
        if (taskAction == null) {
            ...
            if (taskAction != null) {
                ...
                if (selectedProperties.contains("variables")
                    ...
                    case DELEGATED:
                        if (selectedProperties.contains("assignee") && task.getAssignee() != null) {
                            if (taskInstance.getAssignee() == null
                                ...
                                // Alter assignee before delegating to preserve trail of who
                                // actually delegated
                                activitiProcessEngine
                                        .getTaskService()
                            ...
                            throw new InvalidArgumentException(
                                    "When delegating a task, assignee should be selected and"
        ...
        if (responseTask.getEndedAt() == null) {
            try {
                org.activiti.engine.task.Task runningTask =
                        activitiProcessEngine
                                .getTaskService()
                                .createTaskQuery()
                                .taskId(taskId)
    ...
    public CollectionWithPagingInfo<TaskVariable> getTaskVariables(
        ...
        if ((scope == VariableScope.ANY || scope == VariableScope.GLOBAL)
        ...
        TypeDefinition taskTypeDefinition =
                getWorkflowFactory().getTaskFullTypeDefinition(formKey, false);
        TypeDefinition startFormTypeDefinition = null;
        StartFormData startFormData =
                activitiProcessEngine
                        .getFormService()
    ...
    protected TaskVariable updateVariableInTask(
            org.activiti.engine.task.Task taskInstance, TaskVariable taskVariable) {
        taskVariable = convertToTypedVariable(taskVariable, taskInstance);
        ...
        if (VariableScope.LOCAL.equals(taskVariable.getVariableScope())) {
            activitiProcessEngine
                    .getTaskService()
                    .setVariableLocal(
                            taskInstance.getId(), taskVariable.getName(), taskVariable.getValue());
    ...
    protected TaskVariable convertToTypedVariable(
            TaskVariable taskVariable, org.activiti.engine.task.Task taskInstance) {
        if (taskVariable.getName() == null) {
            throw new InvalidArgumentException("Variable name is required.");
        }

        if (taskVariable.getVariableScope() == null
        ...
        if (taskVariable.getVariableScope() == VariableScope.GLOBAL) {
            ...
            try {
                ...
                // In case the property is not part of the model, it's possible that the
        ...
        if ("java.util.Date".equalsIgnoreCase(dataTypeDefinition.getJavaClassName())) {
            // fix for different ISO 8601 Date format classes in Alfresco (org.alfresco.util and
            // Spring Surf)
            ...
            if (context != null
                ...
                actualValue =
                        DefaultTypeConverter.INSTANCE.convert(
                                dataTypeDefinition, taskVariable.getValue());
            }
        }
     ...
     * in user is assignee/owner/involved with the task. In case true was passed for
     * "validIfClaimable", the task is also valid if the current logged in user is a candidate for
     * claiming the task.
     *
     * @throws EntityNotFoundException when the task was not found
     * @throws PermissionDeniedException when the current logged in user isn't allowed to access
     *     task.
     */
    protected HistoricTaskInstance getValidHistoricTask(String taskId) {
        ...
        if (taskInstance == null) {
            // Either the task doesn't exist or the user is not involved directly. We can
            // differentiate by
            ...
            if (taskInstance == null) {
                ...
                if (taskInstance.getEndTime() == null) {
                    // Task is not yet finished, so potentially claimable. If user is part of a
                    // "candidateGroup", the task is accessible to the
    ...
    /**
     * Get a valid {@link org.activiti.engine.task.Task} based on the given task id. Checks if
     * current logged in user is assignee/owner/involved with the task. In case true was passed for
     * "validIfClaimable", the task is also valid if the current logged in user is a candidate for
     * claiming the task.
     *
     * @throws EntityNotFoundException when the task was not found
    ...
    protected Object convertAssociationDefinitionValue(
            AssociationDefinition associationDef, String variableName, Object variableValue) {
        if (variableValue != null
            ...
            if (associationDef.isTargetMany()) {
                if (variableValue instanceof List<?>) {
                    ...
                    for (Object value : values) {
                        NodeRef authorityRef =
                                authorityService.getAuthorityNodeRef(value.toString());
                ...
                NodeRef authorityRef =
                        authorityService.getAuthorityNodeRef(variableValue.toString());
                if (authorityRef == null) {
                    throw new InvalidArgumentException(
