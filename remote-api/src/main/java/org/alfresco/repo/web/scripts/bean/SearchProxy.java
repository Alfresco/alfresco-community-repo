 ...
 *
 * <p>Provides the ability to submit a request to a registered search engine via the Alfresco
 * server.
 *
 * @author davidc
 */
public class SearchProxy extends AbstractWebScript implements InitializingBean {
    ...
    public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException {
        ...
        if (engineUrl == null) {
            throw new WebScriptException(
                    "Url mimetype '" + mimetype + "' does not exist for engine '" + engine + "'");
        }
        ...
        SearchEngineHttpProxy proxy =
                new SearchEngineHttpProxy(
     ...
     *
     * <p>This proxy remaps OpenSearch links (e.g. previous, next) found in search results.
     *
     * @author davidc
     */
    private class SearchEngineHttpProxy extends HTTPProxy {
        ...
        private static final String ATOM_LINK_XPATH =
                "atom:link[@rel=\"first\" or @rel=\"last\" or @rel=\"next\" or @rel=\"previous\" or"
                        + " @rel=\"self\" or @rel=\"alternate\"]";
