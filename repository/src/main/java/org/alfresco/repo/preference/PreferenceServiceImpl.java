...
public class PreferenceServiceImpl implements PreferenceService, Extensible {
  ...
  private static final String SHARE_SITES_PREFERENCE_KEY =
  ...
  private static final String EXT_SITES_PREFERENCE_KEY =
  ...
  public PreferenceServiceImpl() {
    preferenceServiceTrait =
      new ExtendedTrait<PreferenceServiceTrait>(createPreferenceServiceTrait());
  }
  ...
  private JSONObject getPreferencesObject(String userName)
    ...
    if (
      ...
      if (
        this.nodeService.hasAspect(
            personNodeRef,
            ContentModel.ASPECT_PREFERENCES
          ) ==
        true
      ) {
  ...
  public Serializable getPreference(String userName, String preferenceName) {
    ...
    try {
      ...
      throw new AlfrescoRuntimeException(
        ...
        userName +
        " because there was an error pasing the JSON data.",
        exception
      );
    }
  ...
  public Map<String, Serializable> getPreferences(
    ...
    try {
        ...
        while (keys.hasNext()) {
          ...
          if (key.startsWith(SHARE_SITES_PREFERENCE_KEY)) {
            ...
            if (key.endsWith(".favourited")) {
              ...
              String siteId = key.substring(
                SHARE_SITES_PREFERENCE_KEY_LEN,
                idx
              );
      ...
      throw new AlfrescoRuntimeException(
        "Can not get preferences for " +
        userName +
        " because there was an error parsing the JSON data.",
        exception
      );
    }
  ...
  public PagingResults<Pair<String, Serializable>> getPagedPreferences(
    ...
    final Map<String, Serializable> prefs = getPreferences(
      userName,
      preferenceFilter
    );
    ...
    int end = maxItems == CannedQueryPageDetails.DEFAULT_PAGE_SIZE
      ? totalSize
      : skipCount + maxItems;
    int pageSize =
      (
    ...
    final List<Pair<String, Serializable>> page = new ArrayList<Pair<String, Serializable>>(
      pageSize
    );
  ...
  @Extend(
    traitAPI = PreferenceServiceTrait.class,
    extensionAPI = PreferenceServiceExtension.class
  )
  public void setPreferences(
    ...
    if (userCanWritePreferences(userName, personNodeRef)) {
      AuthenticationUtil.runAs(
        new RunAsWork<Object>() {
          public Object doWork() throws Exception {
            ...
            if (
              PreferenceServiceImpl.this.nodeService.hasAspect(
                  personNodeRef,
                  ContentModel.ASPECT_PREFERENCES
                ) ==
              false
            ) {
              PreferenceServiceImpl.this.nodeService.addAspect(
                  personNodeRef,
                  ContentModel.ASPECT_PREFERENCES,
                  null
                );
            ...
            try {
              ...
              ContentReader reader =
                PreferenceServiceImpl.this.contentService.getReader(
                    personNodeRef,
                    ContentModel.PROP_PREFERENCE_VALUES
                  );
              if (reader != null) {
              ...
              ContentWriter contentWriter =
                PreferenceServiceImpl.this.contentService.getWriter(
                    personNodeRef,
                    ContentModel.PROP_PREFERENCE_VALUES,
                    true
                  );
              ...
              throw new AlfrescoRuntimeException(
                "Can not update preferences for " +
                userName +
                " because there was an error pasing the JSON data.",
                exception
              );
      ...
      throw new AccessDeniedException(
        ...
        " does not have sufficient permissions to update the preferences of the user " +
        userName
      );
    }
  }
          ...
          public Object doWork() throws Exception {
            if (
              ...
              try {
                JSONObject jsonPrefs = new JSONObject();
                if (
                  preferenceFilter != null && preferenceFilter.length() != 0
                ) {
                  // Get the current preferences
                  ContentReader reader =
                    PreferenceServiceImpl.this.contentService.getReader(
   ...
   */
  private boolean userCanWritePreferences(
    final String userName,
  ...
  public PreferenceServiceTrait createPreferenceServiceTrait() {
    return new PreferenceServiceTrait() {
      ...
      public void setPreferences(
        ...
        AJExtender.run(
          new AJExtender.ExtensionBypass<Void>() {
            @Override
            public Void run() {
