...
/**
 * WebScript aware Authentication Filter. Directly handles login script calls, allowing Surf to
 * establish a cookie for a manual login, rather than the usual stateless ticket based logins.
 *
 * <p>This functionality has been extracted from the WebScriptSSOAuthenticationFilter so that they
 * can work independently.
 *
 * @author Gethin James
 */
public class WebscriptCookieAuthenticationFilter extends BaseAuthenticationFilter
