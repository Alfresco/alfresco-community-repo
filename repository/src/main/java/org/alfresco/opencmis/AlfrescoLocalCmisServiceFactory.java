...
public class AlfrescoLocalCmisServiceFactory extends AbstractServiceFactory {
    private static ThreadLocal<ConformanceCmisServiceWrapper> THREAD_LOCAL_SERVICE =
            new ThreadLocal<ConformanceCmisServiceWrapper>();
        ...
        if (wrapperService == null) {
            ...
            wrapperService =
                    new ConformanceCmisServiceWrapper(
                            cmisService,
                            CMIS_CONNECTOR.getTypesDefaultMaxItems(),
                            CMIS_CONNECTOR.getTypesDefaultDepth(),
                            CMIS_CONNECTOR.getObjectsDefaultMaxItems(),
                            CMIS_CONNECTOR.getObjectsDefaultDepth());
